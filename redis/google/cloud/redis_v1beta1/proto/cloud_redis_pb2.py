...
Instance = _reflection.GeneratedProtocolMessageType('Instance', (_message.Message,), dict(
  ...
  Attributes:
      name:
          ...
          location\_id here refers to a GCP region; however, users get
          to choose which specific zone (or collection of zones for
          cross-zone instances) an instance should be provisioned in.
          Refer to [location\_id] and [alternative\_location\_id] fields
          for more details.
      display_name:
      ...
      current_location_id:
          ...
          placed. In single zone deployments, this will always be the
          same as [location\_id] provided by the user at creation time.
          In cross-zone instances (only applicable in STANDARD\_HA
          tier), this can be either [location\_id] or
          [alternative\_location\_id] and can change on a failover
          event.
      create_time:
...
UpdateInstanceRequest = _reflection.GeneratedProtocolMessageType('UpdateInstanceRequest', (_message.Message,), dict(
  ...
  Attributes:
      update_mask:
          ...
          [Instance][CloudRedis.Instance]: \* ``display_name`` \*
          ``labels`` \* ``memory_size_gb`` \* ``redis_config``
      instance:
...
_CLOUDREDIS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0024\0222/v1beta1/{parent=projects/*/locations/*}/instances'),
  ),
  _descriptor.MethodDescriptor(
    name='GetInstance',
    ...
    serialized_options=_b('\202\323\344\223\0024\0222/v1beta1/{name=projects/*/locations/*/instances/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateInstance',
    ...
    serialized_options=_b('\202\323\344\223\002>\"2/v1beta1/{parent=projects/*/locations/*}/instances:\010instance'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateInstance',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\002G2;/v1beta1/{instance.name=projects/*/locations/*/instances/*}:\010instance'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteInstance',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=_b('\202\323\344\223\0024*2/v1beta1/{name=projects/*/locations/*/instances/*}'),
  ),
])

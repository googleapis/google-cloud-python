...
Instance = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      redis_version:
          ...
          Redis 4.0 compatibility \* ``REDIS_3_2`` for Redis 3.2
          compatibility
      reserved_ip_range:

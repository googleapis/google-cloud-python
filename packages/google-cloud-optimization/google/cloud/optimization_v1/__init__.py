...
__lazy_modules__ = {
    "google.cloud.optimization_v1.services.fleet_routing",
    "google.cloud.optimization_v1.types.async_model",
    "google.cloud.optimization_v1.types.fleet_routing",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.optimization_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.optimization_v1")  # type: ignore

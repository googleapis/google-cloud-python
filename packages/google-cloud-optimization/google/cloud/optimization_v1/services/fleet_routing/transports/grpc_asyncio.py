...
class FleetRoutingGrpcAsyncIOTransport(FleetRoutingTransport):
    ...
    @property
    def optimize_tours(self) -> Callable[[fleet_routing.OptimizeToursRequest], Awaitable[fleet_routing.OptimizeToursResponse]]:
    ...
    @property
    def batch_optimize_tours(self) -> Callable[[fleet_routing.BatchOptimizeToursRequest], Awaitable[operations_pb2.Operation]]:

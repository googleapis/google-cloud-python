...
from google.cloud.securitycenter_v1beta1.services.security_center import SecurityCenterAsyncClient, SecurityCenterClient, pagers, transports
...
def test_update_organization_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{organization_settings.name=organizations/*/organizationSettings}" % client.transport._host, args[1]
        )
...
def test_update_organization_settings_rest_call_success(request_type):
    ...
    request_init["organization_settings"] = {
        ...
        "enable_asset_discovery": True,
        "asset_discovery_config": {"project_ids": ["project_ids_value1", "project_ids_value2"], "inclusion_mode": 1},
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

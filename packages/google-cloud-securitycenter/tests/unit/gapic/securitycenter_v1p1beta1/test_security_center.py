...
async def test_create_finding_async(request_type, transport: str = "grpc_asyncio"):
    client = SecurityCenterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_group_assets_async(request_type, transport: str = "grpc_asyncio"):
    client = SecurityCenterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_group_findings_async(request_type, transport: str = "grpc_asyncio"):
    client = SecurityCenterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_run_asset_discovery_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.run_asset_discovery] = (
            mock_rpc
        )
        request = {}
...
async def test_run_asset_discovery_async(request_type, transport: str = "grpc_asyncio"):
    client = SecurityCenterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_set_finding_state_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.set_finding_state] = (
            mock_rpc
        )
        request = {}
...
async def test_set_finding_state_async(request_type, transport: str = "grpc_asyncio"):
    client = SecurityCenterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_finding_async(request_type, transport: str = "grpc_asyncio"):
    client = SecurityCenterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_security_marks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_security_marks] = (
            mock_rpc
        )
        request = {}
...
def test_create_source_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSource,
...
def test_create_finding_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateFinding,
        "_BaseCreateFinding__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    assert not set(unset_fields) - set(("findingId",))
...
def test_create_notification_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateNotificationConfig,
        "_BaseCreateNotificationConfig__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("configId",))
...
def test_delete_notification_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteNotificationConfig,
        "_BaseDeleteNotificationConfig__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_notification_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetNotificationConfig,
        "_BaseGetNotificationConfig__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_organization_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetOrganizationSettings,
        "_BaseGetOrganizationSettings__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_source_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSource,
...
def test_group_assets_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGroupAssets,
        "_BaseGroupAssets__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_group_findings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGroupFindings,
        "_BaseGroupFindings__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_assets_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAssets,
...
def test_list_findings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListFindings,
...
def test_list_notification_configs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListNotificationConfigs,
        "_BaseListNotificationConfigs__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_sources_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSources,
...
def test_run_asset_discovery_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRunAssetDiscovery,
        "_BaseRunAssetDiscovery__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_set_finding_state_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetFindingState,
        "_BaseSetFindingState__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_finding_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateFinding,
        "_BaseUpdateFinding__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_notification_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateNotificationConfig,
        "_BaseUpdateNotificationConfig__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_organization_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateOrganizationSettings,
        "_BaseUpdateOrganizationSettings__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_source_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSource,
...
def test_update_security_marks_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSecurityMarks,
        "_BaseUpdateSecurityMarks__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_organization_settings_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SecurityCenterRestInterceptor,
            "post_update_organization_settings",
        ) as post,
        mock.patch.object(
            transports.SecurityCenterRestInterceptor,

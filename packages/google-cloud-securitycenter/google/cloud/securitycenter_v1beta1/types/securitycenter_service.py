...
class GroupAssetsRequest(proto.Message):
    ...
    compare_duration = proto.Field(proto.MESSAGE, number=4, message=duration.Duration,)
...
class GroupResult(proto.Message):
    ...
    properties = proto.MapField(
        proto.STRING, proto.MESSAGE, number=1, message=struct.Value,
    )
...
class ListAssetsRequest(proto.Message):
    ...
    compare_duration = proto.Field(proto.MESSAGE, number=5, message=duration.Duration,)

    field_mask = proto.Field(proto.MESSAGE, number=7, message=gp_field_mask.FieldMask,)
...
class ListFindingsRequest(proto.Message):
    ...
    field_mask = proto.Field(proto.MESSAGE, number=5, message=gp_field_mask.FieldMask,)

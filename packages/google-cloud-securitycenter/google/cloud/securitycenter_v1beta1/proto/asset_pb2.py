...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_security__marks__pb2.DESCRIPTOR,google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_ASSET.fields_by_name['security_marks'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_security__marks__pb2._SECURITYMARKS
...
Asset = _reflection.GeneratedProtocolMessageType('Asset', (_message.Message,), dict(
  ...
  SecurityCenterProperties = _reflection.GeneratedProtocolMessageType('SecurityCenterProperties', (_message.Message,), dict(
  ...
  ResourcePropertiesEntry = _reflection.GeneratedProtocolMessageType('ResourcePropertiesEntry', (_message.Message,), dict(
...
_ASSET_RESOURCEPROPERTIESENTRY.has_options = True
_ASSET_RESOURCEPROPERTIESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

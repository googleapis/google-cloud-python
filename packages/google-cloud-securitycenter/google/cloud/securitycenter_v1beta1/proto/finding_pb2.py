...
_FINDING_SOURCEPROPERTIESENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.securitycenter.v1beta1.Finding.SourcePropertiesEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.securitycenter.v1beta1.Finding.SourcePropertiesEntry.value', index=1,
...
_FINDING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.securitycenter.v1beta1.Finding.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.securitycenter.v1beta1.Finding.parent', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.cloud.securitycenter.v1beta1.Finding.resource_name', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.securitycenter.v1beta1.Finding.state', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='category', full_name='google.cloud.securitycenter.v1beta1.Finding.category', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_uri', full_name='google.cloud.securitycenter.v1beta1.Finding.external_uri', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_properties', full_name='google.cloud.securitycenter.v1beta1.Finding.source_properties', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='security_marks', full_name='google.cloud.securitycenter.v1beta1.Finding.security_marks', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='event_time', full_name='google.cloud.securitycenter.v1beta1.Finding.event_time', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.securitycenter.v1beta1.Finding.create_time', index=9,
...
_FINDING.fields_by_name['security_marks'].message_type = google_dot_cloud_dot_securitycenter__v1beta1_dot_proto_dot_security__marks__pb2._SECURITYMARKS
...
Finding = _reflection.GeneratedProtocolMessageType('Finding', (_message.Message,), dict(
  ...
  SourcePropertiesEntry = _reflection.GeneratedProtocolMessageType('SourcePropertiesEntry', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.securitycenter_v1beta1.proto.finding_pb2'
  ,
  __doc__ = """Security Center's finding.
  
  A finding is a record of assessment data (security, risk, health or
  privacy) ingested into Security Center for presentation, notification,
  analysis, policy testing and enforcement. For example, an XSS
  vulnerability in an AppEngine application is a finding.
  ...
  Attributes:
      ...
      resource_name:
          The full resource name of the Google Cloud Platform resource
          this finding is for. See: https://cloud.google.com/apis/design
          /resource\_names#full\_resource\_name This field is immutable
          after creation time.
      state:
      ...
      external_uri:
          ...
          Security Center where additional information about the finding
          can be found. This field is guaranteed to be either empty or a
          well formed url.
      source_properties:
          Source specific properties. These properties are managed by
          the source writing the finding.
      security_marks:
          Output only. User specified security marks. These marks are
          entirely managed by the user and come from the SecurityMarks
          resource belonging to the finding.
      event_time:
...
_FINDING_SOURCEPROPERTIESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

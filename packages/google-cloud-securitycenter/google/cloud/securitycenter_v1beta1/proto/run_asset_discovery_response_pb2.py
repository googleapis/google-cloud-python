...
# source: google/cloud/securitycenter_v1beta1/proto/run_asset_discovery_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/securitycenter_v1beta1/proto/run_asset_discovery_response.proto",
...
_RUNASSETDISCOVERYRESPONSE_STATE = _descriptor.EnumDescriptor(
    name="State",
    full_name="google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.State",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_RUNASSETDISCOVERYRESPONSE = _descriptor.Descriptor(
    ...
    full_name="google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="duration",
            full_name="google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.duration",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
RunAssetDiscoveryResponse = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="google.cloud.securitycenter_v1beta1.proto.run_asset_discovery_response_pb2",

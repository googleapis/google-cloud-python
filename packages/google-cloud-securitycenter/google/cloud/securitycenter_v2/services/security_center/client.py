...
class SecurityCenterClient(metaclass=SecurityCenterClientMeta):
    ...
    def parse_big_query_export_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/bigQueryExports/(?P<export>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_external_system_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/sources/(?P<source>.+?)/findings/(?P<finding>.+?)/externalSystems/(?P<externalsystem>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_notification_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/notificationConfigs/(?P<notification_config>.+?)$", path)
        return m.groupdict() if m else {}

...
from google.cloud.securitycenter_v1p1beta1.proto import asset_pb2
...
from google.cloud.securitycenter_v1p1beta1.proto import notification_message_pb2
from google.cloud.securitycenter_v1p1beta1.proto import organization_settings_pb2
from google.cloud.securitycenter_v1p1beta1.proto import resource_pb2
...
for module in _local_modules:
    for name, message in get_messages(module).items():
        message.__module__ = "google.cloud.securitycenter_v1p1beta1.types"
        setattr(sys.modules[__name__], name, message)
        names.append(name)

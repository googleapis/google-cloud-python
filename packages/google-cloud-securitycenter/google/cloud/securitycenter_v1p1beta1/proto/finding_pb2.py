...
# source: google/cloud/securitycenter_v1p1beta1/proto/finding.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/securitycenter_v1p1beta1/proto/finding.proto",
    ...
    dependencies=[
        ...
        google_dot_cloud_dot_securitycenter__v1p1beta1_dot_proto_dot_security__marks__pb2.DESCRIPTOR,
...
_FINDING_SOURCEPROPERTIESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.SourcePropertiesEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.SourcePropertiesEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FINDING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="parent",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.parent",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="resource_name",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.resource_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="category",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.category",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="external_uri",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.external_uri",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.source_properties",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="security_marks",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.security_marks",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="event_time",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.event_time",
            index=8,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="create_time",
            full_name="google.cloud.securitycenter.v1p1beta1.Finding.create_time",
            index=9,
            number=10,
            type=11,
            cpp_type=10,
    ...
    enum_types=[_FINDING_STATE, _FINDING_SEVERITY,],
...
_FINDING.fields_by_name[
    ...
    google_dot_cloud_dot_securitycenter__v1p1beta1_dot_proto_dot_security__marks__pb2._SECURITYMARKS
)
_FINDING.fields_by_name[
    "event_time"
    ...
    (_message.Message,),
    {
        "SourcePropertiesEntry": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "google.cloud.securitycenter_v1p1beta1.proto.finding_pb2"

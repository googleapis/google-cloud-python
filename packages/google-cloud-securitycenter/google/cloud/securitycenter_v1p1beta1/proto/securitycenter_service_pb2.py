...
from google.cloud.securitycenter_v1p1beta1.proto.run_asset_discovery_response_pb2 import *
...
ListFindingsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      compare_duration:
          ...
          read_time.
      field_mask:
          A field mask to specify the Finding fields to be listed in the

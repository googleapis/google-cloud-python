...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.securitycenter_v1p1beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.securitycenter_v1p1beta1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.securitycenter_v1p1beta1"

...
# source: google/cloud/securitycenter_v1/proto/notification_config.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/securitycenter_v1/proto/notification_config.proto",
...
_NOTIFICATIONCONFIG_STREAMINGCONFIG = _descriptor.Descriptor(
    ...
    full_name="google.cloud.securitycenter.v1.NotificationConfig.StreamingConfig",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="filter",
            full_name="google.cloud.securitycenter.v1.NotificationConfig.StreamingConfig.filter",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_NOTIFICATIONCONFIG = _descriptor.Descriptor(
    ...
    full_name="google.cloud.securitycenter.v1.NotificationConfig",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.securitycenter.v1.NotificationConfig.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="description",
            full_name="google.cloud.securitycenter.v1.NotificationConfig.description",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="pubsub_topic",
            full_name="google.cloud.securitycenter.v1.NotificationConfig.pubsub_topic",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.securitycenter.v1.NotificationConfig.service_account",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.securitycenter.v1.NotificationConfig.streaming_config",
            index=4,
            number=5,
            type=11,
            cpp_type=10,

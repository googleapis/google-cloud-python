...
# source: google/cloud/securitycenter_v1/proto/organization_settings.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/securitycenter_v1/proto/organization_settings.proto",
...
_ORGANIZATIONSETTINGS_ASSETDISCOVERYCONFIG_INCLUSIONMODE = _descriptor.EnumDescriptor(
    name="InclusionMode",
    full_name="google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig.InclusionMode",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_ORGANIZATIONSETTINGS_ASSETDISCOVERYCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="project_ids",
            full_name="google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig.project_ids",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="inclusion_mode",
            full_name="google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig.inclusion_mode",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
_ORGANIZATIONSETTINGS = _descriptor.Descriptor(
    ...
    full_name="google.cloud.securitycenter.v1.OrganizationSettings",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.securitycenter.v1.OrganizationSettings.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.securitycenter.v1.OrganizationSettings.enable_asset_discovery",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.securitycenter.v1.OrganizationSettings.asset_discovery_config",
            index=2,
            number=3,
            type=11,
            cpp_type=10,

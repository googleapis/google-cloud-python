...
- While logged into your GitHub account, navigate to the
  ``python-securitycenter`` `repo`_ on GitHub.

- Fork and clone the ``python-securitycenter`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-securitycenter`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-securitycenter``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-securitycenter.git hack-on-python-securitycenter
   $ cd hack-on-python-securitycenter
...
.. _repo: https://github.com/googleapis/python-securitycenter
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-securitycenter``. The

...
from google.developers_knowledge_v1.services.developer_knowledge import pagers
...
class DeveloperKnowledgeClient(metaclass=DeveloperKnowledgeClientMeta):
    ...
    def search_document_chunks(
        ...
        *,
        ...
        Args:
            request (Union[google.developers_knowledge_v1.types.SearchDocumentChunksRequest, dict]):
        ...
        Returns:
            google.developers_knowledge_v1.services.developer_knowledge.pagers.SearchDocumentChunksPager:
    ...
    def get_document(
        ...
        *,
        ...
        Args:
            request (Union[google.developers_knowledge_v1.types.GetDocumentRequest, dict]):
                The request object. Request message for
                [DeveloperKnowledge.GetDocument][google.developers.knowledge.v1.DeveloperKnowledge.GetDocument].
            name (str):
        ...
        Returns:
            google.developers_knowledge_v1.types.Document:
    ...
    def batch_get_documents(
        ...
        *,
        ...
        Args:
            request (Union[google.developers_knowledge_v1.types.BatchGetDocumentsRequest, dict]):
                The request object. Request message for
                [DeveloperKnowledge.BatchGetDocuments][google.developers.knowledge.v1.DeveloperKnowledge.BatchGetDocuments].
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.developers_knowledge_v1.types.BatchGetDocumentsResponse:
                Response message for
                   [DeveloperKnowledge.BatchGetDocuments][google.developers.knowledge.v1.DeveloperKnowledge.BatchGetDocuments].

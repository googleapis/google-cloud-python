...
class DeveloperKnowledgeGrpcTransport(DeveloperKnowledgeTransport):
    """gRPC backend transport for DeveloperKnowledge.
    ...
    def search_document_chunks(
        ...
        r"""Return a callable for the search document chunks method over gRPC.

        Searches for developer knowledge across Google's developer
        ...
        Returns:
            Callable[[~.SearchDocumentChunksRequest],
        ...
        if "search_document_chunks" not in self._stubs:
            self._stubs["search_document_chunks"] = self._logged_channel.unary_unary(
                "/google.developers.knowledge.v1.DeveloperKnowledge/SearchDocumentChunks",
                request_serializer=developerknowledge.SearchDocumentChunksRequest.serialize,
                response_deserializer=developerknowledge.SearchDocumentChunksResponse.deserialize,
            )
        return self._stubs["search_document_chunks"]
    ...
    def get_document(
        ...
        Retrieves a single document with its full Markdown
        content.
        ...
        if "get_document" not in self._stubs:
            self._stubs["get_document"] = self._logged_channel.unary_unary(
                ...
                request_serializer=developerknowledge.GetDocumentRequest.serialize,
                response_deserializer=developerknowledge.Document.deserialize,
            )
    ...
    def batch_get_documents(
        ...
        Retrieves multiple documents, each with its full
        Markdown content.
        ...
        if "batch_get_documents" not in self._stubs:
            self._stubs["batch_get_documents"] = self._logged_channel.unary_unary(
                "/google.developers.knowledge.v1.DeveloperKnowledge/BatchGetDocuments",
                request_serializer=developerknowledge.BatchGetDocumentsRequest.serialize,
                response_deserializer=developerknowledge.BatchGetDocumentsResponse.deserialize,
            )
...
__all__ = ("DeveloperKnowledgeGrpcTransport",)

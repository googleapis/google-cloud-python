...
from google.developers_knowledge_v1 import gapic_version as package_version
from google.developers_knowledge_v1.types import developerknowledge
...
class DeveloperKnowledgeTransport(abc.ABC):
    """Abstract transport class for DeveloperKnowledge."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "developerknowledge.googleapis.com"
    ...
    def get_document(
        ...
        Union[developerknowledge.Document, Awaitable[developerknowledge.Document]],
    ]:
        raise NotImplementedError()
...
__all__ = ("DeveloperKnowledgeTransport",)

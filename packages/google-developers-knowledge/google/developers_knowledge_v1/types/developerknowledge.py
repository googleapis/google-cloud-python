...
class Document(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            updated.
        view (google.developers_knowledge_v1.types.DocumentView):
...
class SearchDocumentChunksResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.developers_knowledge_v1.types.DocumentChunk]):
...
class BatchGetDocumentsResponse(proto.Message):
    ...
    Attributes:
        documents (MutableSequence[google.developers_knowledge_v1.types.Document]):
...
class DocumentChunk(proto.Message):
    ...
    Attributes:
        ...
        content (str):
            ...
            document chunk.
        document (google.developers_knowledge_v1.types.Document):

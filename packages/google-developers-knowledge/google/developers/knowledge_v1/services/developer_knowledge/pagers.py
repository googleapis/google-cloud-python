...
class SearchDocumentChunksPager:
    ...
    ``SearchDocumentChunks`` requests and continue to iterate
    ...
    def __init__(
        self,
        method: Callable[..., developerknowledge.SearchDocumentChunksResponse],
        ...
        *,
        ...
        """
        self._method = method
        self._request = developerknowledge.SearchDocumentChunksRequest(request)
    ...
    @property
    def pages(self) -> Iterator[developerknowledge.SearchDocumentChunksResponse]:
    ...
    def __iter__(self) -> Iterator[developerknowledge.DocumentChunk]:
...
class SearchDocumentChunksAsyncPager:
    """A pager for iterating through ``search_document_chunks`` requests.
    ...
    def __init__(
        self,
        method: Callable[
            ..., Awaitable[developerknowledge.SearchDocumentChunksResponse]
        ],
        request: developerknowledge.SearchDocumentChunksRequest,
        response: developerknowledge.SearchDocumentChunksResponse,
        *,
    ...
    async def pages(
        self,
    ) -> AsyncIterator[developerknowledge.SearchDocumentChunksResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
    ...
    def __aiter__(self) -> AsyncIterator[developerknowledge.DocumentChunk]:

...
from .transports.rest import DeveloperKnowledgeRestTransport


class DeveloperKnowledgeClientMeta(type):
    """Metaclass for the DeveloperKnowledge client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DeveloperKnowledgeTransport]]
    _transport_registry["grpc"] = DeveloperKnowledgeGrpcTransport
    _transport_registry["grpc_asyncio"] = DeveloperKnowledgeGrpcAsyncIOTransport
    _transport_registry["rest"] = DeveloperKnowledgeRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[DeveloperKnowledgeTransport]:
...
class DeveloperKnowledgeClient(metaclass=DeveloperKnowledgeClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "developerknowledge.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DeveloperKnowledgeClient: The constructed client.
        """
    ...
    def transport(self) -> DeveloperKnowledgeTransport:
        ...
        Returns:
            DeveloperKnowledgeTransport: The transport used by the client
                instance.
        """
    ...
    def document_path(
        ...
        return "documents/{document}".format(
            document=document,
        )
    ...
    def parse_document_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^documents/(?P<document>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = DeveloperKnowledgeClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DeveloperKnowledgeClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = DeveloperKnowledgeClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the developer knowledge client.
        ...
        self._client_cert_source = DeveloperKnowledgeClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DeveloperKnowledgeClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, DeveloperKnowledgeTransport)
        if transport_provided:
            # transport is a DeveloperKnowledgeTransport instance.
            ...
            self._transport = cast(DeveloperKnowledgeTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or DeveloperKnowledgeClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                DeveloperKnowledgeClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DeveloperKnowledgeTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.developers.knowledge_v1.DeveloperKnowledgeClient`.",
                    extra={
    ...
    def search_document_chunks(
        ...
        *,
    ...
    ) -> pagers.SearchDocumentChunksPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.search_document_chunks]
        ...
        response = pagers.SearchDocumentChunksPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

...
#
# Snippet for BatchGetDocuments
# NOTE: This snippet has been automatically generated for illustrative purposes only.
# It may require modifications to work in your environment.

# To install the latest published package dependency, execute the following:
#   python3 -m pip install google-developers-knowledge
...
from google import developers_knowledge_v1


async def sample_batch_get_documents():
    # Create a client
    client = developers_knowledge_v1.DeveloperKnowledgeAsyncClient()

    # Initialize request argument(s)
    request = developers_knowledge_v1.BatchGetDocumentsRequest(

...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-translate/samples
...
-  Read the `Client Library Documentation`_ for Cloud Translation
   to see other available methods on the client.
-  Read the `Cloud Translation Product documentation`_ to learn

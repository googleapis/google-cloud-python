...
def test_translate_text_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseTranslateText,
...
def test_detect_language_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDetectLanguage,
...
def test_get_supported_languages_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSupportedLanguages,
...
def test_translate_document_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseTranslateDocument,
...
def test_batch_translate_text_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchTranslateText,
...
def test_batch_translate_document_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchTranslateDocument,
...
def test_refine_text_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRefineText,

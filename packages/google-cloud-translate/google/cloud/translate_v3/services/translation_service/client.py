...
class TranslationServiceClient(metaclass=TranslationServiceClientMeta):
    ...
    def parse_adaptive_mt_file_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/adaptiveMtDatasets/(?P<dataset>.+?)/adaptiveMtFiles/(?P<file>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_glossary_entry_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/glossaries/(?P<glossary>.+?)/glossaryEntries/(?P<glossary_entry>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or TranslationServiceClient._get_api_endpoint(

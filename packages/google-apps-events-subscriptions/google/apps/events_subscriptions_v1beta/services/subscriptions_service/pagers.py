...
class ListSubscriptionsPager:
    ...
    :class:`google.apps.events_subscriptions_v1beta.types.ListSubscriptionsResponse` object, and
    ...
    All the usual :class:`google.apps.events_subscriptions_v1beta.types.ListSubscriptionsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.apps.events_subscriptions_v1beta.types.ListSubscriptionsRequest):
                The initial request object.
            response (google.apps.events_subscriptions_v1beta.types.ListSubscriptionsResponse):

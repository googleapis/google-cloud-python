...
class _BaseSubscriptionsServiceRestTransport(SubscriptionsServiceTransport):
    """Base REST backend transport for SubscriptionsService.
    ...
    class _BaseReactivateSubscription:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{name=subscriptions/*}:reactivate",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdateSubscription:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta/{subscription.name=subscriptions/*}",
                    "body": "subscription",
                },
            ]
            return http_options
...
__all__ = ("_BaseSubscriptionsServiceRestTransport",)

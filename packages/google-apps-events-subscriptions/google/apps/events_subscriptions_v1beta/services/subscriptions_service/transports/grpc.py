...
class SubscriptionsServiceGrpcTransport(SubscriptionsServiceTransport):
    """gRPC backend transport for SubscriptionsService.
...
__all__ = ("SubscriptionsServiceGrpcTransport",)

...
class Subscription(proto.Message):
    ...
    API
    overview <https://developers.google.com/workspace/events/guides>`__.
    ...
    Attributes:
        ...
        target_resource (str):
            ...
            learn about target resources, see `Supported Google
            Workspace
            resources <https://developers.google.com/workspace/events/guides#supported-resources>`__.
        ...
        event_types (MutableSequence[str]):
            ...
            For a list of supported event types, see the following
            documentation:

            -  `Google Chat
               events <https://developers.google.com/workspace/events/guides/events-chat>`__
            -  `Google Meet
               events <https://developers.google.com/workspace/events/guides/events-meet>`__

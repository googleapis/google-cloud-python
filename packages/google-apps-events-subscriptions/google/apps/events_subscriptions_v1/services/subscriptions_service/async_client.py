...
class SubscriptionsServiceAsyncClient:
    ...
    get_transport_class = functools.partial(
        type(SubscriptionsServiceClient).get_transport_class,
    ...
    async def list_subscriptions(
        ...
        *,
        ...
        Args:
            ...
            page_size (:class:`int`):
                Optional. The maximum number of subscriptions to return.
                The service might return fewer than this value.

                If unspecified or set to ``0``, up to 50 subscriptions
                are returned.

                The maximum value is 100. If you specify a value more
                than 100, the system only returns 100 subscriptions.
            ...
            page_token (:class:`str`):
                ...
                a previous list subscriptions call.
                Provide this parameter to retrieve the
                subsequent page.

                When paginating, the filter value should
                match the call that provided the page
                token. Passing a different value might

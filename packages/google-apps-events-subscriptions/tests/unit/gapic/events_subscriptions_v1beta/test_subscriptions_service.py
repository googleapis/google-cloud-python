...
def test_subscriptions_service_client_client_options_from_dict():
    with mock.patch(
        "google.apps.events_subscriptions_v1beta.services.subscriptions_service.transports.SubscriptionsServiceGrpcTransport.__init__"
    ) as grpc_transport:
    ...
    with mock.patch.object(
        ...
        client.create_subscription(
            subscription=subscription_resource.Subscription(
                drive_options=subscription_resource.Subscription.DriveOptions(
...
def test_create_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/subscriptions" % client.transport._host, args[1]
        )
...
def test_delete_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=subscriptions/*}" % client.transport._host, args[1]
        )
...
def test_update_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{subscription.name=subscriptions/*}" % client.transport._host,
            args[1],
        )
...
def test_reactivate_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=subscriptions/*}:reactivate" % client.transport._host,
            args[1],
        )
...
def test_create_subscription_rest_call_success(request_type):
    ...
    request_init["subscription"] = {
        "drive_options": {"include_descendants": True},
...
def test_subscriptions_service_base_transport():
    ...
    with mock.patch(
        "google.apps.events_subscriptions_v1beta.services.subscriptions_service.transports.SubscriptionsServiceTransport.__init__"
    ) as Transport:
...
def test_subscriptions_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.apps.events_subscriptions_v1beta.services.subscriptions_service.transports.SubscriptionsServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

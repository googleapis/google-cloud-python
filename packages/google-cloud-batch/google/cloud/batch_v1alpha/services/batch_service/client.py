...
from google.cloud.batch_v1alpha._compat import (
    get_api_endpoint,
...
class BatchServiceClient(metaclass=BatchServiceClientMeta):
    ...
    def parse_resource_allowance_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/resourceAllowances/(?P<resource_allowance>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=BatchServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def create_resource_allowance(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_resource_allowance
        ]
    ...
    def delete_resource_allowance(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_resource_allowance
        ]
    ...
    def update_resource_allowance(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_resource_allowance
        ]

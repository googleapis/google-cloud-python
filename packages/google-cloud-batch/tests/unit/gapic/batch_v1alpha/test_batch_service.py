...
from google.cloud.batch_v1alpha.services.batch_service import BatchServiceAsyncClient, BatchServiceClient, pagers, transports
        ...
        client.create_resource_allowance(
            ...
            resource_allowance=gcb_resource_allowance.ResourceAllowance(
                usage_resource_allowance=gcb_resource_allowance.UsageResourceAllowance(
                    spec=gcb_resource_allowance.UsageResourceAllowanceSpec(type_="type__value")
                )
            ),
            resource_allowance_id="resource_allowance_id_value",
        )
...
async def test_list_resource_allowances_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_resource_allowances), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            batch.ListResourceAllowancesResponse(
                resource_allowances=[
        ...
        assert len(responses) == 6
        assert all(isinstance(i, resource_allowance.ResourceAllowance) for i in responses)
...
async def test_list_resource_allowances_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_resource_allowances), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_resource_allowances(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_resource_allowance_rest_required_fields(request_type=batch.CreateResourceAllowanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_resource_allowance._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_resource_allowance_rest_required_fields(request_type=batch.GetResourceAllowanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource_allowance._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_resource_allowance_rest_required_fields(request_type=batch.DeleteResourceAllowanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_resource_allowance._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_resource_allowances_rest_required_fields(request_type=batch.ListResourceAllowancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resource_allowances._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_resource_allowance_rest_required_fields(request_type=batch.UpdateResourceAllowanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_resource_allowance._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_resource_allowance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{resource_allowance.name=projects/*/locations/*/resourceAllowances/*}" % client.transport._host, args[1]
        )
...
def test_create_job_rest_call_success(request_type):
    ...
    request_init["job"] = {
        ...
        "task_groups": [
            {
                ...
                "task_spec": {
                    ...
                    "compute_resource": {"cpu_milli": 958, "memory_mib": 1072, "gpu_count": 980, "boot_disk_mib": 1365},
                    "max_run_duration": {},
                    ...
                    "volumes": [
                        {
                            ...
                            "pd": {"disk": "disk_value", "device": "device_value", "existing": True},
                ...
                "allocation_policy": {
                    "location": {
                        "allowed_locations": ["allowed_locations_value1", "allowed_locations_value2"],
                        "denied_locations": ["denied_locations_value1", "denied_locations_value2"],
                    },
                    "instance": {
                        "allowed_machine_types": ["allowed_machine_types_value1", "allowed_machine_types_value2"],
                    ...
                    "instance_templates": ["instance_templates_value1", "instance_templates_value2"],
                    ...
                    "labels": {},
                    "network": {
                        "network_interfaces": [{"network": "network_value", "subnetwork": "subnetwork_value", "no_external_ip_address": True}]
                    },
            ...
            "status_events": [
                {
                    ...
                    "task_execution": {"exit_code": 948, "stderr_snippet": "stderr_snippet_value"},
                    "task_state": 1,
                }
            ],
            "task_groups": {},
        ...
        "notification": {"pubsub_topic": "pubsub_topic_value", "message": {"type_": 1, "new_job_state": 1, "new_task_state": 1}},
        "create_time": {},
        "update_time": {},
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchServiceRestInterceptor, "post_update_job") as post, mock.patch.object(
...
def test_create_resource_allowance_rest_call_success(request_type):
    ...
    request_init["resource_allowance"] = {
        "usage_resource_allowance": {
            "spec": {"type_": "type__value", "limit": {"calendar_period": 1, "limit": 0.543}},
            "status": {
                "state": 1,
                "limit_status": {
                    "consumption_interval": {"start_time": {"seconds": 751, "nanos": 543}, "end_time": {}},
                    "limit": 0.543,
                    "consumed": 0.862,
                },
...
def test_create_resource_allowance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchServiceRestInterceptor, "post_create_resource_allowance") as post, mock.patch.object(
        transports.BatchServiceRestInterceptor, "post_create_resource_allowance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_resource_allowance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchServiceRestInterceptor, "post_get_resource_allowance") as post, mock.patch.object(
        transports.BatchServiceRestInterceptor, "post_get_resource_allowance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_resource_allowance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.BatchServiceRestInterceptor, "post_delete_resource_allowance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_resource_allowances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchServiceRestInterceptor, "post_list_resource_allowances") as post, mock.patch.object(
        transports.BatchServiceRestInterceptor, "post_list_resource_allowances_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_resource_allowance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchServiceRestInterceptor, "post_update_resource_allowance") as post, mock.patch.object(
        transports.BatchServiceRestInterceptor, "post_update_resource_allowance_with_metadata"
    ) as post_with_metadata, mock.patch.object(

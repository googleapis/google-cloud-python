...
from google.shopping.merchant_notifications_v1beta._compat import (
    get_api_endpoint,
...
class NotificationsApiServiceClient(metaclass=NotificationsApiServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.notifications_v1beta.NotificationsApiServiceClient`.",
                    extra={
    ...
    def get_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1beta.types.GetNotificationSubscriptionRequest, dict]):
    ...
    def create_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1beta.types.CreateNotificationSubscriptionRequest, dict]):
                The request object. Request message for the
    ...
    def update_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1beta.types.UpdateNotificationSubscriptionRequest, dict]):
                The request object. Request message for the
    ...
    def delete_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1beta.types.DeleteNotificationSubscriptionRequest, dict]):
                The request object. Request message for the
    ...
    def list_notification_subscriptions(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1beta.types.ListNotificationSubscriptionsRequest, dict]):
                The request object. Request message for the

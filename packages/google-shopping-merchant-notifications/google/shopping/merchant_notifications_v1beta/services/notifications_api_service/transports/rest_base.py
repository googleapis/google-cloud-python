...
class _BaseNotificationsApiServiceRestTransport(NotificationsApiServiceTransport):
    """Base REST backend transport for NotificationsApiService.
    ...
    class _BaseDeleteNotificationSubscription:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseGetNotificationSubscription:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListNotificationSubscriptions:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateNotificationSubscription:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseNotificationsApiServiceRestTransport",)

...
from google.shopping.merchant_notifications_v1beta.services.notifications_api_service import pagers
...
class NotificationsApiServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NotificationsApiServiceAsyncClient: The constructed client.
        """
        return NotificationsApiServiceClient.from_service_account_info.__func__(NotificationsApiServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            NotificationsApiServiceAsyncClient: The constructed client.
        """
        return NotificationsApiServiceClient.from_service_account_file.__func__(NotificationsApiServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return NotificationsApiServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> NotificationsApiServiceTransport:
        ...
        Returns:
            NotificationsApiServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = NotificationsApiServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.notifications_v1beta.NotificationsApiServiceAsyncClient`.",
                extra={
    ...
    async def get_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_notifications_v1beta.types.GetNotificationSubscriptionRequest, dict]]):
    ...
    async def create_notification_subscription(
        ...
        *,
        ...
        r"""Creates a notification subscription for a merchant.
        We will allow the following types of notification
        subscriptions to exist together (per merchant as a
        ...
        we will not allow (per merchant as a subscriber per
        event type):
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_notifications_v1beta.types.CreateNotificationSubscriptionRequest, dict]]):
                The request object. Request message for the
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            notification_subscription (:class:`google.shopping.merchant_notifications_v1beta.types.NotificationSubscription`):
    ...
    async def update_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_notifications_v1beta.types.UpdateNotificationSubscriptionRequest, dict]]):
                The request object. Request message for the
    ...
    async def delete_notification_subscription(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_notifications_v1beta.types.DeleteNotificationSubscriptionRequest, dict]]):
                The request object. Request message for the
    ...
    async def list_notification_subscriptions(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListNotificationSubscriptionsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_notifications_v1beta.types.ListNotificationSubscriptionsRequest, dict]]):
                The request object. Request message for the
        ...
        response = pagers.ListNotificationSubscriptionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def __aenter__(self) -> "NotificationsApiServiceAsyncClient":
        return self
...
__all__ = ("NotificationsApiServiceAsyncClient",)

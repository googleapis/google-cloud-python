...
from google.shopping.merchant_notifications_v1._compat import (
    get_api_endpoint,
...
from .transports.grpc import NotificationsApiServiceGrpcTransport
from .transports.grpc_asyncio import NotificationsApiServiceGrpcAsyncIOTransport
from .transports.rest import NotificationsApiServiceRestTransport


class NotificationsApiServiceClientMeta(type):
    """Metaclass for the NotificationsApiService client.
...
class NotificationsApiServiceClient(metaclass=NotificationsApiServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NotificationsApiServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> NotificationsApiServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            NotificationsApiServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def notification_subscription_path(
        account: str,
        notification_subscription: str,
    ) -> str:
        """Returns a fully-qualified notification_subscription string."""
        return "accounts/{account}/notificationsubscriptions/{notification_subscription}".format(
            account=account,
    ...
    @staticmethod
    def notification_subscription_health_metrics_path(
        account: str,
        notification_subscription: str,
    ) -> str:
        """Returns a fully-qualified notification_subscription_health_metrics string."""
        return "accounts/{account}/notificationsubscriptions/{notification_subscription}".format(
            account=account,
            notification_subscription=notification_subscription,
        )
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(transport, NotificationsApiServiceTransport)
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=NotificationsApiServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get_notification_subscription(
        ...
        *,
        ...
        r"""Gets notification subscriptions for an account.
        ...
        .. code-block:: python
            ...
            from google.shopping import merchant_notifications_v1

            def sample_get_notification_subscription():
                # Create a client
                client = merchant_notifications_v1.NotificationsApiServiceClient()

                # Initialize request argument(s)
                request = merchant_notifications_v1.GetNotificationSubscriptionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1.types.GetNotificationSubscriptionRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_notifications_v1.types.NotificationSubscription:
    ...
    def create_notification_subscription(
        ...
        *,
        ...
        r"""Creates a notification subscription for a business.
        For standalone or subaccounts accounts, the business can
        create a subscription for self. For MCAs, the business
        can create a subscription for all managed accounts or
        for a specific subaccount.

        We will allow the following types of notification
        subscriptions to exist together (per business as a
        subscriber per event type):
        ...
        we will not allow (per business as a subscriber per
        event type):
        ...
        3. "All managed accounts" subscription and partial
        ...
        .. code-block:: python
            ...
            def sample_create_notification_subscription():
                ...
                # Initialize request argument(s)
                notification_subscription = merchant_notifications_v1.NotificationSubscription()
                notification_subscription.all_managed_accounts = True

                request = merchant_notifications_v1.CreateNotificationSubscriptionRequest(
                    parent="parent_value",
                    notification_subscription=notification_subscription,
                )
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1.types.CreateNotificationSubscriptionRequest, dict]):
                The request object. Request message for the
            ...
            notification_subscription (google.shopping.merchant_notifications_v1.types.NotificationSubscription):
                Required. The notification
                subscription to create.

                This corresponds to the ``notification_subscription`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        if not isinstance(
            ...
            if notification_subscription is not None:
                request.notification_subscription = notification_subscription
    ...
    def update_notification_subscription(
        ...
        *,
        ...
        r"""Updates an existing notification subscription for a
        merchant.
        ...
        .. code-block:: python
            ...
            def sample_update_notification_subscription():
                ...
                request = merchant_notifications_v1.UpdateNotificationSubscriptionRequest(
                    notification_subscription=notification_subscription,
                )
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1.types.UpdateNotificationSubscriptionRequest, dict]):
                The request object. Request message for the
                UpdateNotificationSubscription method.
            notification_subscription (google.shopping.merchant_notifications_v1.types.NotificationSubscription):
                Required. The new version of the
                notification subscription that should be
                updated.
    ...
    def delete_notification_subscription(
        ...
        *,
        ...
        r"""Deletes a notification subscription for a merchant.
        ...
        .. code-block:: python
            ...
            def sample_delete_notification_subscription():
                ...
                # Initialize request argument(s)
                request = merchant_notifications_v1.DeleteNotificationSubscriptionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1.types.DeleteNotificationSubscriptionRequest, dict]):
                The request object. Request message for the
    ...
    def list_notification_subscriptions(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListNotificationSubscriptionsPager:
        r"""Gets all the notification subscriptions for a
        merchant.
        ...
        .. code-block:: python
            ...
            def sample_list_notification_subscriptions():
                ...
                # Initialize request argument(s)
                request = merchant_notifications_v1.ListNotificationSubscriptionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.shopping.merchant_notifications_v1.types.ListNotificationSubscriptionsRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.shopping.merchant_notifications_v1.services.notifications_api_service.pagers.ListNotificationSubscriptionsPager:
        ...
        response = pagers.ListNotificationSubscriptionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_notification_subscription_health_metrics(
        ...
        *,
        ...
        r"""Retrieves notification subscription health metrics
        for a merchant. We recommend calling this periodically
        (hourly or daily) to monitor health of your callback
        endpoint.
        ...
        .. code-block:: python
            ...
            def sample_get_notification_subscription_health_metrics():
                # Create a client
                client = merchant_notifications_v1.NotificationsApiServiceClient()

                # Initialize request argument(s)
                request = merchant_notifications_v1.GetNotificationSubscriptionHealthMetricsRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_notification_subscription_health_metrics(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_notifications_v1.types.GetNotificationSubscriptionHealthMetricsRequest, dict]):
                The request object. Request for notification subscription
                health metrics.
            name (str):
                Required. The ``name`` of the notification subscription
                for which metrics are retrieved. Format:
        ...
        Returns:
            google.shopping.merchant_notifications_v1.types.NotificationSubscriptionHealthMetrics:
                Represents a notification
    ...
    def __enter__(self) -> "NotificationsApiServiceClient":
        return self

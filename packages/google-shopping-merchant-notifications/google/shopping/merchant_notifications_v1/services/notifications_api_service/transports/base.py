...
class NotificationsApiServiceTransport(abc.ABC):
    """Abstract transport class for NotificationsApiService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_notification_subscription: gapic_v1.method.wrap_method(
                self.get_notification_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_notification_subscription: gapic_v1.method.wrap_method(
                self.create_notification_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_notification_subscription: gapic_v1.method.wrap_method(
                self.update_notification_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_notification_subscription: gapic_v1.method.wrap_method(
                self.delete_notification_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_notification_subscriptions: gapic_v1.method.wrap_method(
                self.list_notification_subscriptions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_notification_subscription_health_metrics: gapic_v1.method.wrap_method(
                self.get_notification_subscription_health_metrics,
                default_timeout=None,
                client_info=client_info,
            ),
        }
...
__all__ = ("NotificationsApiServiceTransport",)

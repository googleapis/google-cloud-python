...
This package includes clients for multiple versions of Shopping Merchant Notifications.
...
For a list of all ``google-shopping-merchant-notifications`` releases:

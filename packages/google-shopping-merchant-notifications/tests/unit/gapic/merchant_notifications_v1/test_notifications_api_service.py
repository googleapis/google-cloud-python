...
def test_notifications_api_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_notification_subscription_health_metrics(request_type, transport: str = "grpc"):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.get_notification_subscription_health_metrics), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = notificationsapi.NotificationSubscriptionHealthMetrics(
            name="name_value",
            acknowledged_messages_count=2855,
            undelivered_messages_count=2774,
            oldest_unacknowledged_message_waiting_time=4441,
        )
        response = client.get_notification_subscription_health_metrics(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, notificationsapi.NotificationSubscriptionHealthMetrics)
    assert response.name == "name_value"
...
def test_get_notification_subscription_health_metrics_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.get_notification_subscription_health_metrics), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == notificationsapi.GetNotificationSubscriptionHealthMetricsRequest(
            name="name_value",
        )
...
def test_get_notification_subscription_health_metrics_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_notification_subscription_health_metrics in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_notification_subscription_health_metrics] = mock_rpc
        request = {}
        client.get_notification_subscription_health_metrics(request)
...
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotificationsApiServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_notification_subscription_health_metrics in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_notification_subscription_health_metrics] = mock_rpc

        request = {}
        await client.get_notification_subscription_health_metrics(request)
...
async def test_get_notification_subscription_health_metrics_async(
    transport: str = "grpc_asyncio", request_type=notificationsapi.GetNotificationSubscriptionHealthMetricsRequest
):
    client = NotificationsApiServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    ...
    with mock.patch.object(type(client.transport.get_notification_subscription_health_metrics), "__call__") as call:
        ...
        response = await client.get_notification_subscription_health_metrics(request)
...
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_field_headers_async():
    client = NotificationsApiServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_notification_subscription_health_metrics), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(notificationsapi.NotificationSubscriptionHealthMetrics())
        await client.get_notification_subscription_health_metrics(request)
...
def test_get_notification_subscription_health_metrics_flattened():
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_notification_subscription_health_metrics_flattened_error():
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_flattened_async():
    client = NotificationsApiServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_flattened_error_async():
    client = NotificationsApiServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_notification_subscription_health_metrics(
            notificationsapi.GetNotificationSubscriptionHealthMetricsRequest(),
            name="name_value",
        )
...
def test_get_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/notifications/v1/{name=accounts/*/notificationsubscriptions/*}" % client.transport._host, args[1])
...
def test_create_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/notifications/v1/{parent=accounts/*}/notificationsubscriptions" % client.transport._host, args[1])
...
def test_update_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/notifications/v1/{notification_subscription.name=accounts/*/notificationsubscriptions/*}" % client.transport._host, args[1]
        )
...
def test_get_notification_subscription_health_metrics_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotificationsApiServiceClient(
...
def test_get_notification_subscription_health_metrics_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_notification_subscription_health_metrics._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = notificationsapi.NotificationSubscriptionHealthMetrics()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = notificationsapi.NotificationSubscriptionHealthMetrics.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_notification_subscription_health_metrics_rest_unset_required_fields():
    transport = transports.NotificationsApiServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.get_notification_subscription_health_metrics._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name",)))


def test_get_notification_subscription_health_metrics_rest_flattened():
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_notification_subscription_health_metrics(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/notifications/v1/{name=accounts/*/notificationsubscriptions/*}:getHealth" % client.transport._host, args[1])


def test_get_notification_subscription_health_metrics_rest_flattened_error(transport: str = "rest"):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_notification_subscription_health_metrics_empty_call_grpc():
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_notification_subscription_health_metrics), "__call__") as call:
        call.return_value = notificationsapi.NotificationSubscriptionHealthMetrics()
        client.get_notification_subscription_health_metrics(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_empty_call_grpc_asyncio():
    client = NotificationsApiServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_notification_subscription_health_metrics), "__call__") as call:
        ...
        await client.get_notification_subscription_health_metrics(request=None)
...
def test_get_notification_subscription_health_metrics_rest_bad_request(request_type=notificationsapi.GetNotificationSubscriptionHealthMetricsRequest):
    client = NotificationsApiServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "accounts/sample1/notificationsubscriptions/sample2"}
    request = request_type(**request_init)
...
def test_get_notification_subscription_health_metrics_rest_call_success(request_type):
    client = NotificationsApiServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_notification_subscription_health_metrics_rest_interceptors(null_interceptor):
    transport = transports.NotificationsApiServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NotificationsApiServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotificationsApiServiceRestInterceptor, "post_get_notification_subscription_health_metrics"
    ) as post, mock.patch.object(
        transports.NotificationsApiServiceRestInterceptor, "post_get_notification_subscription_health_metrics_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotificationsApiServiceRestInterceptor, "pre_get_notification_subscription_health_metrics"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notificationsapi.GetNotificationSubscriptionHealthMetricsRequest.pb(
            notificationsapi.GetNotificationSubscriptionHealthMetricsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notificationsapi.NotificationSubscriptionHealthMetrics.to_json(notificationsapi.NotificationSubscriptionHealthMetrics())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = notificationsapi.NotificationSubscriptionHealthMetrics()
        post_with_metadata.return_value = notificationsapi.NotificationSubscriptionHealthMetrics(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_notification_subscription_health_metrics_empty_call_rest():
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_notifications_api_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceTransport.__init__"
    ) as Transport:
...
def test_notifications_api_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.shopping.merchant_notifications_v1.services.notifications_api_service.transports.NotificationsApiServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_notifications_api_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.get_notification_subscription_health_metrics._session
    session2 = client2.transport.get_notification_subscription_health_metrics._session
    assert session1 != session2
...
def test_notification_subscription_health_metrics_path():
    account = "oyster"
    notification_subscription = "nudibranch"
    expected = "accounts/{account}/notificationsubscriptions/{notification_subscription}".format(
        account=account,
        notification_subscription=notification_subscription,
    )
    actual = NotificationsApiServiceClient.notification_subscription_health_metrics_path(account, notification_subscription)
    assert expected == actual


def test_parse_notification_subscription_health_metrics_path():
    expected = {
        "account": "cuttlefish",
        "notification_subscription": "mussel",
    }
    path = NotificationsApiServiceClient.notification_subscription_health_metrics_path(**expected)

    # Check that the path construction is reversible.
    actual = NotificationsApiServiceClient.parse_notification_subscription_health_metrics_path(path)
    assert expected == actual

...
def test_get_notification_subscription_health_metrics(
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_notification_subscription_health_metrics), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_get_notification_subscription_health_metrics_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_notification_subscription_health_metrics
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_notification_subscription_health_metrics_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_notification_subscription_health_metrics
            in client._client._transport._wrapped_methods
        )
...
def test_get_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/notifications/v1/{name=accounts/*/notificationsubscriptions/*}"
...
def test_create_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/notifications/v1/{parent=accounts/*}/notificationsubscriptions"
            % client.transport._host,
            args[1],
        )
...
def test_update_notification_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/notifications/v1/{notification_subscription.name=accounts/*/notificationsubscriptions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_get_notification_subscription_health_metrics_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_notification_subscription_health_metrics._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = notificationsapi.NotificationSubscriptionHealthMetrics.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_notification_subscription_health_metrics_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/notifications/v1/{name=accounts/*/notificationsubscriptions/*}:getHealth"
            % client.transport._host,
            args[1],
        )


def test_get_notification_subscription_health_metrics_rest_flattened_error(
    transport: str = "rest",
):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_notification_subscription_health_metrics_rest_bad_request(
    request_type=notificationsapi.GetNotificationSubscriptionHealthMetricsRequest,
):
    client = NotificationsApiServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_notification_subscription_health_metrics_rest_interceptors(
    null_interceptor,
):
    transport = transports.NotificationsApiServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        transports.NotificationsApiServiceRestInterceptor,
        "post_get_notification_subscription_health_metrics",
    ) as post, mock.patch.object(
        transports.NotificationsApiServiceRestInterceptor,
        "post_get_notification_subscription_health_metrics_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.NotificationsApiServiceRestInterceptor,
        "pre_get_notification_subscription_health_metrics",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = (
            notificationsapi.GetNotificationSubscriptionHealthMetricsRequest.pb(
                notificationsapi.GetNotificationSubscriptionHealthMetricsRequest()
            )
        )
        transcode.return_value = {
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notificationsapi.NotificationSubscriptionHealthMetrics.to_json(
            notificationsapi.NotificationSubscriptionHealthMetrics()
        )
        req.return_value.content = return_value
...
def test_parse_notification_subscription_health_metrics_path():
    ...
    path = NotificationsApiServiceClient.notification_subscription_health_metrics_path(
        **expected
    )

    # Check that the path construction is reversible.
    actual = NotificationsApiServiceClient.parse_notification_subscription_health_metrics_path(
        path
    )
    assert expected == actual

Python Client for Assured Workloads API
=======================================

|stable| |pypi| |versions|

`Assured Workloads API`_:
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-assured-workloads.svg
   :target: https://pypi.org/project/google-cloud-assured-workloads/
.. _Assured Workloads API: https://cloud.google.com/assured-workloads/
...
.. _Enable the Assured Workloads API.:  https://cloud.google.com/assured-workloads/
...
.. _Assured Workloads API Product documentation:  https://cloud.google.com/assured-workloads/

...
def test_assured_workloads_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.assuredworkloads_v1.services.assured_workloads_service.transports.AssuredWorkloadsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_update_workload(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.update_workload), "__call__") as call:
        ...
        call.return_value = assuredworkloads.Workload(
            ...
            partner=assuredworkloads.Workload.Partner.LOCAL_CONTROLS_BY_S3NS,
        )
...
def test_list_violations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_violations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_violations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_violations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AssuredWorkloadsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_violations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_violations] = mock_rpc
...
def test_list_violations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_violations), "__call__") as call:
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.list_violations(request={}, retry=retry, timeout=timeout)
...
async def test_list_violations_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_violations), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async_pager = await client.list_violations(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
...
async def test_list_violations_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_violations), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_violations(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_violation(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_violation), "__call__") as call:
        ...
        call.return_value = assuredworkloads.Violation(
            ...
            state=assuredworkloads.Violation.State.RESOLVED,
            org_policy_constraint="org_policy_constraint_value",
...
def test_get_violation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_violation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_violation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_violation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AssuredWorkloadsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_violation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_violation] = mock_rpc

        request = {}
        await client.get_violation(request)
...
def test_acknowledge_violation_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_acknowledge_violation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.acknowledge_violation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.acknowledge_violation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_acknowledge_violation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AssuredWorkloadsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.acknowledge_violation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.acknowledge_violation] = mock_rpc

        request = {}
        await client.acknowledge_violation(request)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_acknowledge_violation_empty_call_grpc():
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.acknowledge_violation), "__call__") as call:
        call.return_value = assuredworkloads.AcknowledgeViolationResponse()
        client.acknowledge_violation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_acknowledge_violation_empty_call_grpc_asyncio():
    client = AssuredWorkloadsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.acknowledge_violation), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(assuredworkloads.AcknowledgeViolationResponse())
        await client.acknowledge_violation(request=None)
...
def test_create_workload_rest_call_success(request_type):
    ...
    request_init["workload"] = {
        ...
        "labels": {},
        "provisioned_resources_parent": "provisioned_resources_parent_value",
        "kms_settings": {"next_rotation_time": {}, "rotation_period": {"seconds": 751, "nanos": 543}},
...
def test_update_workload_rest_bad_request(request_type=assuredworkloads.UpdateWorkloadRequest):
    client = AssuredWorkloadsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_update_workload") as post, mock.patch.object(
        transports.AssuredWorkloadsServiceRestInterceptor, "post_update_workload_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = assuredworkloads.Workload.to_json(assuredworkloads.Workload())
        req.return_value.content = return_value
...
def test_get_workload_rest_bad_request(request_type=assuredworkloads.GetWorkloadRequest):
    client = AssuredWorkloadsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/workloads/sample3"}
    request = request_type(**request_init)
...
def test_get_workload_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_get_workload") as post, mock.patch.object(
        transports.AssuredWorkloadsServiceRestInterceptor, "post_get_workload_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_workloads_rest_bad_request(request_type=assuredworkloads.ListWorkloadsRequest):
    client = AssuredWorkloadsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "organizations/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssuredWorkloadsServiceRestInterceptor, "post_list_workloads") as post, mock.patch.object(
        transports.AssuredWorkloadsServiceRestInterceptor, "post_list_workloads_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = assuredworkloads.ListWorkloadsResponse.to_json(assuredworkloads.ListWorkloadsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = assuredworkloads.ListWorkloadsResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_acknowledge_violation_empty_call_rest():
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_assured_workloads_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.assuredworkloads_v1.services.assured_workloads_service.transports.AssuredWorkloadsServiceTransport.__init__"
    ) as Transport:
...
def test_violation_path():
    ...
    workload = "whelk"
    violation = "octopus"
    expected = "organizations/{organization}/locations/{location}/workloads/{workload}/violations/{violation}".format(

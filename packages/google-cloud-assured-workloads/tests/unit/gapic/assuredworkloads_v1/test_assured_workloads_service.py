...
from google.cloud.assuredworkloads_v1.services.assured_workloads_service.transports.base import (
...
def test_create_workload(
    transport: str = "grpc", request_type=assuredworkloads.CreateWorkloadRequest
):
    client = AssuredWorkloadsServiceClient(
...
def test_create_workload_flattened():
    ...
    with mock.patch.object(type(client.transport.create_workload), "__call__") as call:
        ...
        assert args[0].workload == assuredworkloads.Workload(name="name_value")
...
def test_update_workload(
    transport: str = "grpc", request_type=assuredworkloads.UpdateWorkloadRequest
):
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_delete_workload(
    transport: str = "grpc", request_type=assuredworkloads.DeleteWorkloadRequest
):
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_get_workload(
    transport: str = "grpc", request_type=assuredworkloads.GetWorkloadRequest
):
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_get_workload_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.get_workload(
            assuredworkloads.GetWorkloadRequest(), name="name_value",
        )
...
def test_list_workloads(
    transport: str = "grpc", request_type=assuredworkloads.ListWorkloadsRequest
):
    client = AssuredWorkloadsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_list_workloads_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_workloads(
            assuredworkloads.ListWorkloadsRequest(), parent="parent_value",
        )
...
def test_list_workloads_pager():
    ...
    with mock.patch.object(type(client.transport.list_workloads), "__call__") as call:
        ...
        call.side_effect = (
            ...
            assuredworkloads.ListWorkloadsResponse(
                workloads=[assuredworkloads.Workload(),], next_page_token="ghi",
            ),
            assuredworkloads.ListWorkloadsResponse(
                workloads=[assuredworkloads.Workload(), assuredworkloads.Workload(),],
            ),
            RuntimeError,
        )

...
from google.cloud.assuredworkloads_v1beta1.services.assured_workloads_service.transports.base import (
...
def test_assured_workloads_service_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_assured_workloads_service_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True

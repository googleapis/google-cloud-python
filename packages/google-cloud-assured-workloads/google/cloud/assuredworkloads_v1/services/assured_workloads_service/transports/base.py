...
class AssuredWorkloadsServiceTransport(abc.ABC):
    ...
    def list_violations(
        ...
        [assuredworkloads.ListViolationsRequest], Union[assuredworkloads.ListViolationsResponse, Awaitable[assuredworkloads.ListViolationsResponse]]
    ]:
        raise NotImplementedError()
    ...
    def get_violation(
        self,
    ) -> Callable[[assuredworkloads.GetViolationRequest], Union[assuredworkloads.Violation, Awaitable[assuredworkloads.Violation]]]:
        raise NotImplementedError()
    ...
    def acknowledge_violation(
        ...
        Union[assuredworkloads.AcknowledgeViolationResponse, Awaitable[assuredworkloads.AcknowledgeViolationResponse]],
    ]:
        raise NotImplementedError()

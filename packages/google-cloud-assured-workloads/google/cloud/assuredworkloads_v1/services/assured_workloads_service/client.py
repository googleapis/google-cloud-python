...
class AssuredWorkloadsServiceClient(metaclass=AssuredWorkloadsServiceClientMeta):
    ...
    def violation_path(
        ...
        return "organizations/{organization}/locations/{location}/workloads/{workload}/violations/{violation}".format(
    ...
    def parse_violation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/workloads/(?P<workload>.+?)/violations/(?P<violation>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AssuredWorkloadsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                AssuredWorkloadsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = AssuredWorkloadsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AssuredWorkloadsServiceClient._get_api_endpoint(

...
class AssuredWorkloadsServiceClient(metaclass=AssuredWorkloadsServiceClientMeta):
    ...
    def parse_violation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/workloads/(?P<workload>.+?)/violations/(?P<violation>.+?)$", path
        )
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AssuredWorkloadsServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or AssuredWorkloadsServiceClient._get_api_endpoint(

...
class AssuredWorkloadsServiceRestTransport(_BaseAssuredWorkloadsServiceRestTransport):
    ...
    class _AnalyzeWorkloadMove(_BaseAssuredWorkloadsServiceRestTransport._BaseAnalyzeWorkloadMove, AssuredWorkloadsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            raise NotImplementedError("Method AnalyzeWorkloadMove is not available over REST transport")
    ...
    class _GetWorkload(_BaseAssuredWorkloadsServiceRestTransport._BaseGetWorkload, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            raise NotImplementedError("Method GetWorkload is not available over REST transport")
    ...
    class _ListWorkloads(_BaseAssuredWorkloadsServiceRestTransport._BaseListWorkloads, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            raise NotImplementedError("Method ListWorkloads is not available over REST transport")
    ...
    class _UpdateWorkload(_BaseAssuredWorkloadsServiceRestTransport._BaseUpdateWorkload, AssuredWorkloadsServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            raise NotImplementedError("Method UpdateWorkload is not available over REST transport")

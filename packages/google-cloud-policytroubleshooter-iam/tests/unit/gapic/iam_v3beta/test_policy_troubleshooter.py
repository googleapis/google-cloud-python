...
from google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        PolicyTroubleshooterClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        PolicyTroubleshooterClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        PolicyTroubleshooterClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        PolicyTroubleshooterClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        PolicyTroubleshooterClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
@pytest.mark.parametrize(
    ...
    [
        (PolicyTroubleshooterClient, "grpc"),
        (PolicyTroubleshooterAsyncClient, "grpc_asyncio"),
        (PolicyTroubleshooterClient, "rest"),
    ],
)
def test_policy_troubleshooter_client_from_service_account_info(
    client_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.PolicyTroubleshooterGrpcTransport, "grpc"),
        (transports.PolicyTroubleshooterGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.PolicyTroubleshooterRestTransport, "rest"),
    ],
)
def test_policy_troubleshooter_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_policy_troubleshooter_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_policy_troubleshooter_client_get_transport_class():
    ...
    available_transports = [
        transports.PolicyTroubleshooterGrpcTransport,
        transports.PolicyTroubleshooterRestTransport,
    ]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            PolicyTroubleshooterAsyncClient,
            transports.PolicyTroubleshooterGrpcAsyncIOTransport,
            "grpc_asyncio",
        ),
        (
            PolicyTroubleshooterClient,
...
@mock.patch.object(
    PolicyTroubleshooterClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(PolicyTroubleshooterClient),
)
@mock.patch.object(
    PolicyTroubleshooterAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(PolicyTroubleshooterAsyncClient),
)
def test_policy_troubleshooter_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_policy_troubleshooter_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [PolicyTroubleshooterClient, PolicyTroubleshooterAsyncClient]
)
@mock.patch.object(
    PolicyTroubleshooterClient,
    "DEFAULT_ENDPOINT",
...
def test_policy_troubleshooter_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_policy_troubleshooter_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_policy_troubleshooter_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_policy_troubleshooter_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_troubleshoot_iam_policy_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        pb_return_value = troubleshooter.TroubleshootIamPolicyResponse.pb(return_value)
...
def test_credentials_transport_error():
    ...
    transport = transports.PolicyTroubleshooterGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = PolicyTroubleshooterClient(
...
def test_transport_get_channel():
    ...
    transport = transports.PolicyTroubleshooterGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_policy_troubleshooter_base_transport():
    ...
    with mock.patch(
        "google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport.__init__"
    ) as Transport:
...
def test_policy_troubleshooter_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.policytroubleshooter.iam_v3beta.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [
        (transports.PolicyTroubleshooterGrpcTransport, grpc_helpers),
        (transports.PolicyTroubleshooterGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_policy_troubleshooter_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_policy_troubleshooter_client_transport_session_collision(transport_name):
    ...
    client1 = PolicyTroubleshooterClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = PolicyTroubleshooterClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_policy_troubleshooter_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.PolicyTroubleshooterTransport, "_prep_wrapped_messages"
    ) as prep:
        client = PolicyTroubleshooterClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize(
    ...
    [
        (PolicyTroubleshooterClient, transports.PolicyTroubleshooterGrpcTransport),
        (
            PolicyTroubleshooterAsyncClient,
            transports.PolicyTroubleshooterGrpcAsyncIOTransport,
        ),

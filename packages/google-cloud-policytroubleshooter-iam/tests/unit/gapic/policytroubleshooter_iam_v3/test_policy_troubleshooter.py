...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert PolicyTroubleshooterClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert PolicyTroubleshooterClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert PolicyTroubleshooterClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                PolicyTroubleshooterClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        PolicyTroubleshooterClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == PolicyTroubleshooterClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        PolicyTroubleshooterClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == PolicyTroubleshooterClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_policy_troubleshooter_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.policytroubleshooter_iam_v3.services.policy_troubleshooter.transports.PolicyTroubleshooterGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_transport_kind_grpc():
    transport = PolicyTroubleshooterClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = PolicyTroubleshooterAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = PolicyTroubleshooterAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = PolicyTroubleshooterClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_troubleshoot_iam_policy_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.PolicyTroubleshooterRestInterceptor, "post_troubleshoot_iam_policy") as post, mock.patch.object(
        transports.PolicyTroubleshooterRestInterceptor, "post_troubleshoot_iam_policy_with_metadata"
...
def test_policy_troubleshooter_base_transport():
    ...
    with mock.patch(
        "google.cloud.policytroubleshooter_iam_v3.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport.__init__"
    ) as Transport:
...
def test_policy_troubleshooter_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.policytroubleshooter_iam_v3.services.policy_troubleshooter.transports.PolicyTroubleshooterTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.PolicyTroubleshooterGrpcTransport, grpc_helpers), (transports.PolicyTroubleshooterGrpcAsyncIOTransport, grpc_helpers_async)],
)

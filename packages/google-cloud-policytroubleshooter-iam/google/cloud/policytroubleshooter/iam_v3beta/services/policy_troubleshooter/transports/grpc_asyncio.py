...
from .base import DEFAULT_CLIENT_INFO, PolicyTroubleshooterTransport
from .grpc import PolicyTroubleshooterGrpcTransport


class PolicyTroubleshooterGrpcAsyncIOTransport(PolicyTroubleshooterTransport):
    """gRPC AsyncIO backend transport for PolicyTroubleshooter.
    ...
    def troubleshoot_iam_policy(
        ...
        Awaitable[troubleshooter.TroubleshootIamPolicyResponse],
    ]:
        ...
        if "troubleshoot_iam_policy" not in self._stubs:
            self._stubs["troubleshoot_iam_policy"] = self.grpc_channel.unary_unary(
                ...
                request_serializer=troubleshooter.TroubleshootIamPolicyRequest.serialize,
                response_deserializer=troubleshooter.TroubleshootIamPolicyResponse.deserialize,
            )
...
__all__ = ("PolicyTroubleshooterGrpcAsyncIOTransport",)

...
class TroubleshootIamPolicyRequest(proto.Message):
    ...
    Attributes:
        access_tuple (google.cloud.policytroubleshooter.iam_v3beta.types.AccessTuple):
...
class TroubleshootIamPolicyResponse(proto.Message):
    ...
    Attributes:
        overall_access_state (google.cloud.policytroubleshooter.iam_v3beta.types.TroubleshootIamPolicyResponse.OverallAccessState):
        ...
        access_tuple (google.cloud.policytroubleshooter.iam_v3beta.types.AccessTuple):
            ...
            condition.
        allow_policy_explanation (google.cloud.policytroubleshooter.iam_v3beta.types.AllowPolicyExplanation):
            An explanation of how the applicable IAM
            allow policies affect the final access state.
        deny_policy_explanation (google.cloud.policytroubleshooter.iam_v3beta.types.DenyPolicyExplanation):
...
class AccessTuple(proto.Message):
    ...
    Attributes:
        ...
        condition_context (google.cloud.policytroubleshooter.iam_v3beta.types.ConditionContext):
...
class ConditionContext(proto.Message):
    ...
    Attributes:
        resource (google.cloud.policytroubleshooter.iam_v3beta.types.ConditionContext.Resource):
            ...
            primary one.
        destination (google.cloud.policytroubleshooter.iam_v3beta.types.ConditionContext.Peer):
        ...
        request (google.cloud.policytroubleshooter.iam_v3beta.types.ConditionContext.Request):
            Represents a network request, such as an HTTP
            request.
        effective_tags (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.ConditionContext.EffectiveTag]):
...
class AllowPolicyExplanation(proto.Message):
    ...
    Attributes:
        allow_access_state (google.cloud.policytroubleshooter.iam_v3beta.types.AllowAccessState):
            Indicates whether the principal has the
            specified permission for the specified resource,
            based on evaluating all applicable IAM allow
            policies.
        explained_policies (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.ExplainedAllowPolicy]):
        ...
        relevance (google.cloud.policytroubleshooter.iam_v3beta.types.HeuristicRelevance):
...
class ExplainedAllowPolicy(proto.Message):
    ...
    Attributes:
        ...
        full_resource_name (str):
            ...
            services, see
            https://cloud.google.com/iam/help/troubleshooter/full-resource-names.
        binding_explanations (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.AllowBindingExplanation]):
...
class AllowBindingExplanation(proto.Message):
    ...
    Attributes:
        ...
        role (str):
            ...
            permissions in each role, see
            https://cloud.google.com/iam/help/roles/reference.
        role_permission (google.cloud.policytroubleshooter.iam_v3beta.types.RolePermissionInclusionState):
            Indicates whether the role granted by this
            role binding contains the specified permission.
        role_permission_relevance (google.cloud.policytroubleshooter.iam_v3beta.types.HeuristicRelevance):
            The relevance of the permission's existence,
            or nonexistence, in the role to the overall
            determination for the entire policy.
        combined_membership (google.cloud.policytroubleshooter.iam_v3beta.types.AllowBindingExplanation.AnnotatedAllowMembership):
        ...
        memberships (MutableMapping[str, google.cloud.policytroubleshooter.iam_v3beta.types.AllowBindingExplanation.AnnotatedAllowMembership]):
        ...
        condition_explanation (google.cloud.policytroubleshooter.iam_v3beta.types.ConditionExplanation):
    ...
    class AnnotatedAllowMembership(proto.Message):
        ...
        Attributes:
            membership (google.cloud.policytroubleshooter.iam_v3beta.types.MembershipMatchingState):
...
class DenyPolicyExplanation(proto.Message):
    ...
    Attributes:
        deny_access_state (google.cloud.policytroubleshooter.iam_v3beta.types.DenyAccessState):
            Indicates whether the principal is denied the
            specified permission for the specified resource,
            based on evaluating all applicable IAM deny
            policies.
        explained_resources (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.ExplainedDenyResource]):
...
class ExplainedDenyResource(proto.Message):
    ...
    Attributes:
        ...
        full_resource_name (str):
            ...
            services, see
            https://cloud.google.com/iam/help/troubleshooter/full-resource-names.
        explained_policies (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.ExplainedDenyPolicy]):
...
class ExplainedDenyPolicy(proto.Message):
    ...
    Attributes:
        ...
        policy (google.iam.v2.policy_pb2.Policy):
            ...
            If the sender of the request does not have
            access to the policy, this field is omitted.
        rule_explanations (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation]):
...
class DenyRuleExplanation(proto.Message):
    ...
    Attributes:
        deny_access_state (google.cloud.policytroubleshooter.iam_v3beta.types.DenyAccessState):
            ...
            ``overall_access_state`` field in the
            [TroubleshootIamPolicyResponse][google.cloud.policytroubleshooter.iam.v3beta.TroubleshootIamPolicyResponse].
        combined_denied_permission (google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedPermissionMatching):
            Indicates whether the permission in the
            request is listed as a denied permission in the
            deny rule.
        denied_permissions (MutableMapping[str, google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedPermissionMatching]):
            ...
            request.
        combined_exception_permission (google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedPermissionMatching):
            Indicates whether the permission in the
            request is listed as an exception permission in
            the deny rule.
        exception_permissions (MutableMapping[str, google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedPermissionMatching]):
            ...
            the request.
        combined_denied_principal (google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedDenyPrincipalMatching):
            ...
            set.
        denied_principals (MutableMapping[str, google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedDenyPrincipalMatching]):
            ...
            request.
        combined_exception_principal (google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedDenyPrincipalMatching):
            Indicates whether the principal is listed as
            an exception principal in the deny rule, either
            directly or through membership in a principal
            set.
        exception_principals (MutableMapping[str, google.cloud.policytroubleshooter.iam_v3beta.types.DenyRuleExplanation.AnnotatedDenyPrincipalMatching]):
    ...
    class AnnotatedPermissionMatching(proto.Message):
        ...
        Attributes:
            permission_matching_state (google.cloud.policytroubleshooter.iam_v3beta.types.PermissionPatternMatchingState):
                Indicates whether the permission in the
...
class ConditionExplanation(proto.Message):
    ...
    Attributes:
        ...
        evaluation_states (MutableSequence[google.cloud.policytroubleshooter.iam_v3beta.types.ConditionExplanation.EvaluationState]):

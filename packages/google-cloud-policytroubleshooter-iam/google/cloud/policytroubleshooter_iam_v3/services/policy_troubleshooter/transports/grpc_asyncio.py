...
class PolicyTroubleshooterGrpcAsyncIOTransport(PolicyTroubleshooterTransport):
    ...
    def troubleshoot_iam_policy(
        self,
    ) -> Callable[[troubleshooter.TroubleshootIamPolicyRequest], Awaitable[troubleshooter.TroubleshootIamPolicyResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.troubleshoot_iam_policy: self._wrap_method(

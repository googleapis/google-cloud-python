...
__lazy_modules__ = {
    "google.cloud.policytroubleshooter_iam_v3.services.policy_troubleshooter",
    "google.cloud.policytroubleshooter_iam_v3.types.troubleshooter",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.policytroubleshooter_iam_v3")  # type: ignore
    api_core.check_dependency_versions("google.cloud.policytroubleshooter_iam_v3")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.policytroubleshooter_iam_v3"

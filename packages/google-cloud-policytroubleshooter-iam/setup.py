...
description = "Google Cloud Policytroubleshooter Iam API client library"

version = None

with open(os.path.join(package_root, "google/cloud/policytroubleshooter_iam/gapic_version.py")) as fp:

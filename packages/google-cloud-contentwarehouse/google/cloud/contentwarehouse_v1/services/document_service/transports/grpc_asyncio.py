...
class DocumentServiceGrpcAsyncIOTransport(DocumentServiceTransport):
    ...
    @property
    def create_document(self) -> Callable[[document_service_request.CreateDocumentRequest], Awaitable[document_service.CreateDocumentResponse]]:
    ...
    @property
    def get_document(self) -> Callable[[document_service_request.GetDocumentRequest], Awaitable[gcc_document.Document]]:
    ...
    @property
    def update_document(self) -> Callable[[document_service_request.UpdateDocumentRequest], Awaitable[document_service.UpdateDocumentResponse]]:
    ...
    @property
    def delete_document(self) -> Callable[[document_service_request.DeleteDocumentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def search_documents(self) -> Callable[[document_service_request.SearchDocumentsRequest], Awaitable[document_service.SearchDocumentsResponse]]:
    ...
    @property
    def lock_document(self) -> Callable[[document_service_request.LockDocumentRequest], Awaitable[gcc_document.Document]]:
    ...
    @property
    def fetch_acl(self) -> Callable[[document_service_request.FetchAclRequest], Awaitable[document_service.FetchAclResponse]]:
    ...
    @property
    def set_acl(self) -> Callable[[document_service_request.SetAclRequest], Awaitable[document_service.SetAclResponse]]:

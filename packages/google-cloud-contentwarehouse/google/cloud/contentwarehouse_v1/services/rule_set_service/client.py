...
class RuleSetServiceClient(metaclass=RuleSetServiceClientMeta):
    ...
    def rule_set_path(
        ...
        return "projects/{project}/locations/{location}/ruleSets/{rule_set}".format(
            project=project,
            location=location,
            rule_set=rule_set,
        )
    ...
    def parse_rule_set_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/ruleSets/(?P<rule_set>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RuleSetServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RuleSetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = RuleSetServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RuleSetServiceClient._get_api_endpoint(

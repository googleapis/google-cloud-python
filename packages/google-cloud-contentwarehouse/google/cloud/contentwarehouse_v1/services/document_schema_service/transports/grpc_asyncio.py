...
class DocumentSchemaServiceGrpcAsyncIOTransport(DocumentSchemaServiceTransport):
    ...
    def create_document_schema(
        self,
    ) -> Callable[[document_schema_service.CreateDocumentSchemaRequest], Awaitable[gcc_document_schema.DocumentSchema]]:
    ...
    def update_document_schema(
        self,
    ) -> Callable[[document_schema_service.UpdateDocumentSchemaRequest], Awaitable[gcc_document_schema.DocumentSchema]]:
    ...
    @property
    def get_document_schema(self) -> Callable[[document_schema_service.GetDocumentSchemaRequest], Awaitable[document_schema.DocumentSchema]]:
    ...
    @property
    def delete_document_schema(self) -> Callable[[document_schema_service.DeleteDocumentSchemaRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def list_document_schemas(
        self,
    ) -> Callable[[document_schema_service.ListDocumentSchemasRequest], Awaitable[document_schema_service.ListDocumentSchemasResponse]]:
...
__all__ = ("DocumentSchemaServiceGrpcAsyncIOTransport",)

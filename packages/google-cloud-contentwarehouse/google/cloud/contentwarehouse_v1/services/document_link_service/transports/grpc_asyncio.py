...
class DocumentLinkServiceGrpcAsyncIOTransport(DocumentLinkServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_linked_targets: gapic_v1.method_async.wrap_method(
                self.list_linked_targets,
                default_timeout=180.0,
                client_info=client_info,
            ),
            self.list_linked_sources: gapic_v1.method_async.wrap_method(
                self.list_linked_sources,
                default_timeout=180.0,
                client_info=client_info,
            ),
            self.create_document_link: gapic_v1.method_async.wrap_method(
                self.create_document_link,
                default_timeout=180.0,
                client_info=client_info,
            ),
            self.delete_document_link: gapic_v1.method_async.wrap_method(
...
__all__ = ("DocumentLinkServiceGrpcAsyncIOTransport",)

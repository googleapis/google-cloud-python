...
class DocumentLinkServiceClient(metaclass=DocumentLinkServiceClientMeta):
    ...
    def document_link_path(
        ...
        return "projects/{project}/locations/{location}/documents/{document}/documentLinks/{document_link}".format(
            project=project,
            location=location,
            document=document,
    ...
    def parse_document_link_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/documents/(?P<document>.+?)/documentLinks/(?P<document_link>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DocumentLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or DocumentLinkServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DocumentLinkServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DocumentLinkServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DocumentLinkServiceClient._get_api_endpoint(
    ...
    def list_linked_targets(
        ...
        *,
        ...
        # in a document_link_service.ListLinkedTargetsRequest.
    ...
    def list_linked_sources(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_link_service.ListLinkedSourcesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_document_link(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_link_service.CreateDocumentLinkRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_document_link(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_link_service.DeleteDocumentLinkRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

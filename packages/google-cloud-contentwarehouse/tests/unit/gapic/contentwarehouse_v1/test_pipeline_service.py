...
def test__get_api_endpoint():
    ...
    assert (
        PipelineServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        PipelineServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == PipelineServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = PipelineServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = PipelineServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = PipelineServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = PipelineServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_run_pipeline_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PipelineServiceRestInterceptor, "post_run_pipeline"
    ) as post, mock.patch.object(
        transports.PipelineServiceRestInterceptor, "post_run_pipeline_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.PipelineServiceRestInterceptor, "pre_run_pipeline"
    ) as pre:
...
def test_pipeline_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.contentwarehouse_v1.services.pipeline_service.transports.PipelineServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.PipelineServiceGrpcTransport, grpc_helpers), (transports.PipelineServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

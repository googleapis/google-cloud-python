...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert DocumentSchemaServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert DocumentSchemaServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert DocumentSchemaServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                DocumentSchemaServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        DocumentSchemaServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == DocumentSchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        DocumentSchemaServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == DocumentSchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_document_schema_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.contentwarehouse_v1.services.document_schema_service.transports.DocumentSchemaServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_list_document_schemas_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_document_schemas), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async_pager = await client.list_document_schemas(
            request={},
        )
...
def test_create_document_schema_rest_required_fields(request_type=document_schema_service.CreateDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_document_schema._get_unset_required_fields(
        jsonified_request
    )
...
def test_update_document_schema_rest_required_fields(request_type=document_schema_service.UpdateDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_document_schema._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_document_schema_rest_required_fields(request_type=document_schema_service.GetDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_document_schema._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_document_schema_rest_required_fields(request_type=document_schema_service.DeleteDocumentSchemaRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_document_schema._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_document_schemas_rest_required_fields(request_type=document_schema_service.ListDocumentSchemasRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_document_schemas._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = DocumentSchemaServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = DocumentSchemaServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DocumentSchemaServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DocumentSchemaServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
        ...
        "property_definitions": [
            {
                ...
                "enum_type_options": {"possible_values": ["possible_values_value1", "possible_values_value2"], "validation_check_disabled": True},
                "date_time_type_options": {},
                "map_type_options": {},
                "timestamp_type_options": {},
                "schema_sources": [{"name": "name_value", "processor_type": "processor_type_value"}],
            }
        ],
        "document_is_folder": True,
...
def test_create_document_schema_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_create_document_schema") as post, mock.patch.object(
        transports.DocumentSchemaServiceRestInterceptor, "post_create_document_schema_with_metadata"
...
def test_update_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_update_document_schema") as post, mock.patch.object(
        transports.DocumentSchemaServiceRestInterceptor, "post_update_document_schema_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_get_document_schema") as post, mock.patch.object(
        transports.DocumentSchemaServiceRestInterceptor, "post_get_document_schema_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "pre_delete_document_schema") as pre:
        pre.assert_not_called()
...
def test_list_document_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentSchemaServiceRestInterceptor, "post_list_document_schemas") as post, mock.patch.object(
        transports.DocumentSchemaServiceRestInterceptor, "post_list_document_schemas_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_document_schema_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.contentwarehouse_v1.services.document_schema_service.transports.DocumentSchemaServiceTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.DocumentSchemaServiceGrpcTransport, grpc_helpers), (transports.DocumentSchemaServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

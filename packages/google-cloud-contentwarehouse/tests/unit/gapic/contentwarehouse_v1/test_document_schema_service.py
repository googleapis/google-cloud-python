...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DocumentSchemaServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DocumentSchemaServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DocumentSchemaServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DocumentSchemaServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__get_client_cert_source():
    ...
    assert (
        DocumentSchemaServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DocumentSchemaServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DocumentSchemaServiceClient),
)
@mock.patch.object(
    DocumentSchemaServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(DocumentSchemaServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DocumentSchemaServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DocumentSchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = DocumentSchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
...
def test__get_universe_domain():
    ...
    assert (
        DocumentSchemaServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        DocumentSchemaServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        DocumentSchemaServiceClient._get_universe_domain(None, None)
        == DocumentSchemaServiceClient._DEFAULT_UNIVERSE
    )
...
def test_document_schema_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_document_schema_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [DocumentSchemaServiceClient, DocumentSchemaServiceAsyncClient]
)
@mock.patch.object(
    DocumentSchemaServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DocumentSchemaServiceClient),
)
@mock.patch.object(
    DocumentSchemaServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DocumentSchemaServiceAsyncClient),
)
...
def test_document_schema_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_document_schema_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_document_schema_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_document_schema
...
@pytest.mark.asyncio
async def test_update_document_schema_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_document_schema
            in client._client._transport._wrapped_methods
        )
...
def test_get_document_schema_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_document_schema in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_document_schema_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_document_schema
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_document_schema_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_document_schema
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_document_schemas_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_document_schemas
            in client._client._transport._wrapped_methods
        )
...
def test_list_document_schemas_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = document_schema_service.ListDocumentSchemasResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_create_document_schema_rest_call_success(request_type):
    ...
    test_field = document_schema_service.CreateDocumentSchemaRequest.meta.fields[
        "document_schema"
    ]
...
def test_create_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcc_document_schema.DocumentSchema.to_json(
            gcc_document_schema.DocumentSchema()
        )
...
def test_get_document_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = document_schema.DocumentSchema.to_json(
            document_schema.DocumentSchema()
        )
        req.return_value.content = return_value
...
def test_list_document_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = document_schema_service.ListDocumentSchemasResponse.to_json(
            document_schema_service.ListDocumentSchemasResponse()
        )
        req.return_value.content = return_value
...
def test_document_schema_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_document_schema_path():
    ...
    actual = DocumentSchemaServiceClient.document_schema_path(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.DocumentSchemaServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = DocumentSchemaServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

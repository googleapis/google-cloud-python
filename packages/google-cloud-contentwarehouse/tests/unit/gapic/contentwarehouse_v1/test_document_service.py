...
from google.cloud.documentai_v1.types import barcode, document, geometry
...
def test_search_documents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.search_documents] = (
            mock_rpc
        )
        request = {}
...
def test_search_documents_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSearchDocuments,
        "_BaseSearchDocuments__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_lock_document_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseLockDocument,
        "_BaseLockDocument__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_fetch_acl_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseFetchAcl,
        "_BaseFetchAcl__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_set_acl_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetAcl,
        "_BaseSetAcl__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

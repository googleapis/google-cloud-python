...
def test_create_rule_set_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateRuleSet,
        "_BaseCreateRuleSet__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_get_rule_set_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetRuleSet,
        "_BaseGetRuleSet__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_rule_set_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateRuleSet,
        "_BaseUpdateRuleSet__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_rule_set_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteRuleSet,
        "_BaseDeleteRuleSet__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_rule_sets_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListRuleSets,
        "_BaseListRuleSets__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

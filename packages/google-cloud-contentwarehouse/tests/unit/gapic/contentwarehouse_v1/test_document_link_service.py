...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DocumentLinkServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DocumentLinkServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DocumentLinkServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DocumentLinkServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DocumentLinkServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        DocumentLinkServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert DocumentLinkServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert DocumentLinkServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert DocumentLinkServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                DocumentLinkServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        DocumentLinkServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DocumentLinkServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DocumentLinkServiceClient),
)
@mock.patch.object(
    DocumentLinkServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(DocumentLinkServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DocumentLinkServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DocumentLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = DocumentLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == DocumentLinkServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DocumentLinkServiceClient._get_api_endpoint(
    ...
    assert (
        DocumentLinkServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        DocumentLinkServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        DocumentLinkServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        DocumentLinkServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        DocumentLinkServiceClient._get_universe_domain(None, None)
        == DocumentLinkServiceClient._DEFAULT_UNIVERSE
    )
...
def test_document_link_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_document_link_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_document_link_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_document_link_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_document_link_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [DocumentLinkServiceClient, DocumentLinkServiceAsyncClient]
)
@mock.patch.object(
    DocumentLinkServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DocumentLinkServiceClient),
)
@mock.patch.object(
    DocumentLinkServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DocumentLinkServiceAsyncClient),
)
...
def test_document_link_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_document_link_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_document_link_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.contentwarehouse_v1.services.document_link_service.transports.DocumentLinkServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_document_link_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_linked_targets_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_linked_targets in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_linked_targets_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_linked_targets
...
def test_list_linked_sources_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_linked_sources in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_linked_sources_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_linked_sources
            in client._client._transport._wrapped_methods
        )
...
async def test_list_linked_sources_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_linked_sources(
            request={},
        )
...
def test_create_document_link_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_document_link in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_document_link_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_document_link
            in client._client._transport._wrapped_methods
        )
...
def test_delete_document_link_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_document_link in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_document_link_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_document_link
            in client._client._transport._wrapped_methods
        )
...
def test_list_linked_targets_rest_required_fields(
    request_type=document_link_service.ListLinkedTargetsRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_linked_targets._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = document_link_service.ListLinkedTargetsResponse.pb(
                return_value
            )
...
def test_list_linked_targets_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {
            "parent": "projects/sample1/locations/sample2/documents/sample3"
        }
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/documents/*}/linkedTargets"
...
def test_list_linked_sources_rest_required_fields(
    request_type=document_link_service.ListLinkedSourcesRequest,
):
    transport_class = transports.DocumentLinkServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_linked_sources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = document_link_service.ListLinkedSourcesResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_linked_sources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/documents/*}/linkedSources"
            % client.transport._host,
            args[1],
        )
...
def test_list_linked_sources_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            document_link_service.ListLinkedSourcesResponse.to_json(x) for x in response
        )
...
def test_create_document_link_rest_required_fields(
    request_type=document_link_service.CreateDocumentLinkRequest,
):
    transport_class = transports.DocumentLinkServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_document_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_document_link_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/documents/*}/documentLinks"
            % client.transport._host,
            args[1],
        )
...
def test_delete_document_link_rest_required_fields(
    request_type=document_link_service.DeleteDocumentLinkRequest,
):
    transport_class = transports.DocumentLinkServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_document_link._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_document_link_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/documents/sample3/documentLinks/sample4"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/documents/*/documentLinks/*}:delete"
            % client.transport._host,
            args[1],
        )
...
def test_list_linked_targets_rest_bad_request(
    request_type=document_link_service.ListLinkedTargetsRequest,
):
    client = DocumentLinkServiceClient(
...
def test_list_linked_targets_rest_interceptors(null_interceptor):
    transport = transports.DocumentLinkServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.DocumentLinkServiceRestInterceptor(),
    )
    client = DocumentLinkServiceClient(transport=transport)
    ...
    with (
        ...
        pb_message = document_link_service.ListLinkedTargetsRequest.pb(
            document_link_service.ListLinkedTargetsRequest()
        )
...
def test_list_linked_sources_rest_bad_request(
    request_type=document_link_service.ListLinkedSourcesRequest,
):
    client = DocumentLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_list_linked_sources_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = document_link_service.ListLinkedSourcesRequest.pb(
            document_link_service.ListLinkedSourcesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_create_document_link_rest_bad_request(
    request_type=document_link_service.CreateDocumentLinkRequest,
):
    client = DocumentLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_create_document_link_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = document_link_service.CreateDocumentLinkRequest.pb(
            document_link_service.CreateDocumentLinkRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_document_link_rest_bad_request(
    request_type=document_link_service.DeleteDocumentLinkRequest,
):
    client = DocumentLinkServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_document_link_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.contentwarehouse_v1.services.document_link_service.transports.DocumentLinkServiceTransport.__init__"
    ) as Transport:
...
def test_document_link_path():
    ...
    expected = "projects/{project}/locations/{location}/documents/{document}/documentLinks/{document_link}".format(
        project=project,
        location=location,
        document=document,
        document_link=document_link,
    )
    actual = DocumentLinkServiceClient.document_link_path(
        project, location, document, document_link
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.DocumentLinkServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = DocumentLinkServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

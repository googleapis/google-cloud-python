...
def test_list_linked_targets_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListLinkedTargets,
        "_BaseListLinkedTargets__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_list_linked_sources_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListLinkedSources,
        "_BaseListLinkedSources__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_document_link_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateDocumentLink,
        "_BaseCreateDocumentLink__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_document_link_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteDocumentLink,
        "_BaseDeleteDocumentLink__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

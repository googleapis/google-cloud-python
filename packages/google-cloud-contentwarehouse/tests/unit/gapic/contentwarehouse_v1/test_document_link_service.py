...
def test__get_api_endpoint():
    ...
    assert (
        DocumentLinkServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        DocumentLinkServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == DocumentLinkServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_list_linked_targets_rest_required_fields(request_type=document_link_service.ListLinkedTargetsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_linked_targets._get_unset_required_fields(
        jsonified_request
    )
...
def test_list_linked_sources_rest_required_fields(request_type=document_link_service.ListLinkedSourcesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_linked_sources._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_document_link_rest_required_fields(request_type=document_link_service.CreateDocumentLinkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_document_link._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = DocumentLinkServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = DocumentLinkServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DocumentLinkServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DocumentLinkServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_linked_targets_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "post_list_linked_targets") as post, mock.patch.object(
        transports.DocumentLinkServiceRestInterceptor, "post_list_linked_targets_with_metadata"
...
def test_list_linked_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "post_list_linked_sources") as post, mock.patch.object(
        transports.DocumentLinkServiceRestInterceptor, "post_list_linked_sources_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_document_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "post_create_document_link") as post, mock.patch.object(
        transports.DocumentLinkServiceRestInterceptor, "post_create_document_link_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_document_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentLinkServiceRestInterceptor, "pre_delete_document_link") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.DocumentLinkServiceGrpcTransport, grpc_helpers), (transports.DocumentLinkServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

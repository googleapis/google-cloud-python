...
from google.cloud.tasks_v2beta2.services.cloud_tasks import CloudTasksAsyncClient, CloudTasksClient, pagers, transports
...
def test_upload_queue_yaml(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.upload_queue_yaml), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_upload_queue_yaml_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.upload_queue_yaml] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_upload_queue_yaml_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudTasksAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.upload_queue_yaml in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.upload_queue_yaml] = mock_rpc
...
@pytest.mark.asyncio
async def test_lease_tasks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudTasksAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.lease_tasks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.lease_tasks] = mock_rpc
...
def test_acknowledge_task_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.acknowledge_task] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_acknowledge_task_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudTasksAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.acknowledge_task in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.acknowledge_task] = mock_rpc
...
@pytest.mark.asyncio
async def test_cancel_lease_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudTasksAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.cancel_lease in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.cancel_lease] = mock_rpc
...
def test_upload_queue_yaml_rest_error():
    ...
    assert "Method UploadQueueYaml is not available over REST transport" in str(not_implemented_error.value)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_upload_queue_yaml_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.upload_queue_yaml), "__call__") as call:
        call.return_value = None
        client.upload_queue_yaml(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.UploadQueueYamlRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lease_tasks_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.lease_tasks), "__call__") as call:
        call.return_value = cloudtasks.LeaseTasksResponse()
        client.lease_tasks(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.LeaseTasksRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_acknowledge_task_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.acknowledge_task), "__call__") as call:
        call.return_value = None
        client.acknowledge_task(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.AcknowledgeTaskRequest()
...
def test_renew_lease_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.renew_lease), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.RenewLeaseRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_lease_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.cancel_lease), "__call__") as call:
        call.return_value = task.Task()
        client.cancel_lease(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.CancelLeaseRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_upload_queue_yaml_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.upload_queue_yaml), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.upload_queue_yaml(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_lease_tasks_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.lease_tasks), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloudtasks.LeaseTasksResponse())
        await client.lease_tasks(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_acknowledge_task_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.acknowledge_task), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.acknowledge_task(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_cancel_lease_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.cancel_lease), "__call__") as call:
        ...
        await client.cancel_lease(request=None)
...
def test_create_queue_rest_call_success(request_type):
    ...
    request_init["queue"] = {
        ...
        "http_target": {
            ...
            "http_method": 1,
            "header_overrides": [{"header": {"key": "key_value", "value": "value_value"}}],
        ...
        "rate_limits": {"max_tasks_dispatched_per_second": 0.32680000000000003, "max_burst_size": 1519, "max_concurrent_tasks": 2157},
        "retry_config": {
            "max_attempts": 1303,
...
def test_lease_tasks_rest_bad_request(request_type=cloudtasks.LeaseTasksRequest):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/queues/sample3"}
    request = request_type(**request_init)
...
def test_lease_tasks_rest_call_success(request_type):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_lease_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudTasksRestInterceptor, "post_lease_tasks") as post, mock.patch.object(
        transports.CloudTasksRestInterceptor, "post_lease_tasks_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloudtasks.LeaseTasksResponse.to_json(cloudtasks.LeaseTasksResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = cloudtasks.LeaseTasksResponse(), metadata
...
def test_acknowledge_task_rest_bad_request(request_type=cloudtasks.AcknowledgeTaskRequest):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/queues/sample3/tasks/sample4"}
    request = request_type(**request_init)
...
def test_acknowledge_task_rest_call_success(request_type):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_acknowledge_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudTasksRestInterceptor, "pre_acknowledge_task") as pre:
        pre.assert_not_called()
...
def test_renew_lease_rest_bad_request(request_type=cloudtasks.RenewLeaseRequest):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/queues/sample3/tasks/sample4"}
    request = request_type(**request_init)
...
def test_renew_lease_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudTasksRestInterceptor, "post_renew_lease") as post, mock.patch.object(
        transports.CloudTasksRestInterceptor, "post_renew_lease_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_cancel_lease_rest_bad_request(request_type=cloudtasks.CancelLeaseRequest):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/queues/sample3/tasks/sample4"}
    request = request_type(**request_init)
...
def test_cancel_lease_rest_call_success(request_type):
    client = CloudTasksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_cancel_lease_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudTasksRestInterceptor, "post_cancel_lease") as post, mock.patch.object(
        transports.CloudTasksRestInterceptor, "post_cancel_lease_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_upload_queue_yaml_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lease_tasks_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_acknowledge_task_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_lease_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

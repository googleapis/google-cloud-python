...
def test_upload_queue_yaml_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.upload_queue_yaml] = (
            mock_rpc
        )
        request = {}
...
async def test_upload_queue_yaml_async(request_type, transport: str = "grpc_asyncio"):
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_lease_tasks_async(request_type, transport: str = "grpc_asyncio"):
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_acknowledge_task_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.acknowledge_task] = (
            mock_rpc
        )
        request = {}
...
async def test_acknowledge_task_async(request_type, transport: str = "grpc_asyncio"):
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_cancel_lease_async(request_type, transport: str = "grpc_asyncio"):
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_lease_tasks_rest_required_fields(request_type=cloudtasks.LeaseTasksRequest):
    ...
    default_values = getattr(
        transport_class._BaseLeaseTasks,
        "_BaseLeaseTasks__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_acknowledge_task_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAcknowledgeTask,
        "_BaseAcknowledgeTask__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_renew_lease_rest_required_fields(request_type=cloudtasks.RenewLeaseRequest):
    ...
    default_values = getattr(
        transport_class._BaseRenewLease,
...
def test_cancel_lease_rest_required_fields(request_type=cloudtasks.CancelLeaseRequest):
    ...
    default_values = getattr(
        transport_class._BaseCancelLease,
        "_BaseCancelLease__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_lease_tasks_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloudtasks.LeaseTasksResponse.to_json(
            cloudtasks.LeaseTasksResponse()
        )
        req.return_value.content = return_value

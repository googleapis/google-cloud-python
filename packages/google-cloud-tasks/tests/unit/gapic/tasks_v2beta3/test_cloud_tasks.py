...
def test_list_queues_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta3/{parent=projects/*/locations/*}/queues"
...
def test_get_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/queues/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{queue.name=projects/*/locations/*/queues/*}"
            % client.transport._host,
            args[1],
        )
...
def test_purge_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/queues/*}:purge"
            % client.transport._host,
            args[1],
        )
...
def test_pause_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/queues/*}:pause"
            % client.transport._host,
            args[1],
        )
...
def test_resume_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/queues/*}:resume"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{resource=projects/*/locations/*/queues/*}:getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{resource=projects/*/locations/*/queues/*}:setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{resource=projects/*/locations/*/queues/*}:testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_list_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{parent=projects/*/locations/*/queues/*}/tasks"
            % client.transport._host,
            args[1],
        )
...
def test_get_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/queues/*/tasks/*}"
            % client.transport._host,
            args[1],
        )
...
def test_batch_create_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{parent=projects/*/locations/*/queues/*}/tasks:batchCreate"
            % client.transport._host,
            args[1],
        )
...
def test_batch_delete_tasks_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_delete_tasks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_tasks_rest_unset_required_fields():
    transport = transports.CloudTasksRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.batch_delete_tasks._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_batch_delete_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{parent=projects/*/locations/*/queues/*}/tasks:batchDelete"
            % client.transport._host,
            args[1],
        )
...
def test_run_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/queues/*/tasks/*}:run"
            % client.transport._host,
            args[1],
        )
...
def test_update_cmek_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask",)) & set(("cmekConfig",)))
...
def test_update_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{cmek_config.name=projects/*/locations/*/cmekConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_get_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta3/{name=projects/*/locations/*/cmekConfig}"
            % client.transport._host,
            args[1],
        )

...
from google.cloud.tasks_v2.types import cloudtasks, cmek_config, queue, target, task
...
def test_batch_create_tasks_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.BatchCreateTasksRequest(
            parent="parent_value",
        )
        assert args[0] == request_msg
...
def test_batch_create_tasks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_create_tasks] = (
            mock_rpc
        )
        request = {}
...
def test_batch_create_tasks_field_headers():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_batch_create_tasks_field_headers_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_batch_create_tasks_flattened():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.batch_create_tasks(
            parent="parent_value",
            requests=[cloudtasks.CreateTaskRequest(parent="parent_value")],
        )
        ...
        assert arg == mock_val
        arg = args[0].requests
        mock_val = [cloudtasks.CreateTaskRequest(parent="parent_value")]
        assert arg == mock_val


def test_batch_create_tasks_flattened_error():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_batch_create_tasks_flattened_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_batch_create_tasks_flattened_error_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_batch_delete_tasks(request_type, transport: str = "grpc"):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.batch_delete_tasks), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.batch_delete_tasks(request)
...
def test_batch_delete_tasks_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.batch_delete_tasks(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.BatchDeleteTasksRequest(
            parent="parent_value",
        )
        assert args[0] == request_msg


def test_batch_delete_tasks_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudTasksClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_delete_tasks in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.batch_delete_tasks] = (
            mock_rpc
        )
        request = {}
        client.batch_delete_tasks(request)
...
@pytest.mark.asyncio
async def test_batch_delete_tasks_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_delete_tasks
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.batch_delete_tasks(request)
...
async def test_batch_delete_tasks_async(request_type, transport: str = "grpc_asyncio"):
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.batch_delete_tasks(request)
...
def test_batch_delete_tasks_field_headers():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_batch_delete_tasks_field_headers_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_batch_delete_tasks_flattened():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_batch_delete_tasks_flattened_error():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_batch_delete_tasks_flattened_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.batch_delete_tasks(
            parent="parent_value",
            names=["names_value"],
        )
...
@pytest.mark.asyncio
async def test_batch_delete_tasks_flattened_error_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.batch_delete_tasks(
            cloudtasks.BatchDeleteTasksRequest(),
            parent="parent_value",
            names=["names_value"],
        )
...
def test_update_cmek_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = gct_cmek_config.CmekConfig(
            name="name_value",
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, gct_cmek_config.CmekConfig)
    assert response.name == "name_value"
    assert response.kms_key == "kms_key_value"


def test_update_cmek_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.UpdateCmekConfigRequest()
        assert args[0] == request_msg
...
def test_update_cmek_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_cmek_config] = (
            mock_rpc
        )
        request = {}
...
def test_update_cmek_config_field_headers():
    ...
    request.cmek_config.name = "name_value"
    ...
    assert (
        "x-goog-request-params",
        "cmek_config.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_cmek_config_field_headers_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_cmek_config_flattened():
    ...
    with mock.patch.object(
        ...
        client.update_cmek_config(
            cmek_config=gct_cmek_config.CmekConfig(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        arg = args[0].cmek_config
        mock_val = gct_cmek_config.CmekConfig(name="name_value")
        assert arg == mock_val
        arg = args[0].update_mask
        mock_val = field_mask_pb2.FieldMask(paths=["paths_value"])
        assert arg == mock_val
...
def test_update_cmek_config_flattened_error():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_cmek_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_cmek_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = cmek_config.CmekConfig(
            name="name_value",
            kms_key="kms_key_value",
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, cmek_config.CmekConfig)
    assert response.name == "name_value"
    assert response.kms_key == "kms_key_value"
...
def test_get_cmek_config_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get_cmek_config), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloudtasks.GetCmekConfigRequest(
            name="name_value",
        )
        assert args[0] == request_msg
...
def test_get_cmek_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_cmek_config in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_get_cmek_config_field_headers_async():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_cmek_config_flattened_error():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_queues_rest_required_fields(request_type=cloudtasks.ListQueuesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListQueues,
...
def test_list_queues_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*}/queues" % client.transport._host,
            args[1],
        )
...
def test_get_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/queues/*}" % client.transport._host,
            args[1],
        )
...
def test_create_queue_rest_required_fields(request_type=cloudtasks.CreateQueueRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateQueue,
...
def test_update_queue_rest_required_fields(request_type=cloudtasks.UpdateQueueRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateQueue,
...
def test_update_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{queue.name=projects/*/locations/*/queues/*}"
...
def test_delete_queue_rest_required_fields(request_type=cloudtasks.DeleteQueueRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteQueue,
...
def test_purge_queue_rest_required_fields(request_type=cloudtasks.PurgeQueueRequest):
    ...
    default_values = getattr(
        transport_class._BasePurgeQueue,
...
def test_purge_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/queues/*}:purge"
            % client.transport._host,
            args[1],
        )
...
def test_pause_queue_rest_required_fields(request_type=cloudtasks.PauseQueueRequest):
    ...
    default_values = getattr(
        transport_class._BasePauseQueue,
...
def test_pause_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/queues/*}:pause"
            % client.transport._host,
            args[1],
        )
...
def test_resume_queue_rest_required_fields(request_type=cloudtasks.ResumeQueueRequest):
    ...
    default_values = getattr(
        transport_class._BaseResumeQueue,
...
def test_resume_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/queues/*}:resume"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{resource=projects/*/locations/*/queues/*}:getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{resource=projects/*/locations/*/queues/*}:setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{resource=projects/*/locations/*/queues/*}:testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_list_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*/queues/*}/tasks"
            % client.transport._host,
            args[1],
        )
...
def test_get_task_rest_required_fields(request_type=cloudtasks.GetTaskRequest):
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("responseView",))
...
def test_get_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/queues/*/tasks/*}"
            % client.transport._host,
            args[1],
        )
...
def test_batch_create_tasks_rest_required_fields(
    request_type=cloudtasks.BatchCreateTasksRequest,
):
    transport_class = transports.CloudTasksRestTransport
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateTasks,
...
def test_batch_create_tasks_rest_flattened():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_create_tasks(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*/queues/*}/tasks:batchCreate"
            % client.transport._host,
            args[1],
        )


def test_batch_create_tasks_rest_flattened_error(transport: str = "rest"):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_delete_tasks_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudTasksClient(
...
def test_batch_delete_tasks_rest_required_fields(
    request_type=cloudtasks.BatchDeleteTasksRequest,
):
    transport_class = transports.CloudTasksRestTransport
    ...
    default_values = getattr(
        transport_class._BaseBatchDeleteTasks,
...
def test_batch_delete_tasks_rest_flattened():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_delete_tasks(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*/queues/*}/tasks:batchDelete"
            % client.transport._host,
            args[1],
        )


def test_batch_delete_tasks_rest_flattened_error(transport: str = "rest"):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/queues/*/tasks/*}:run"
            % client.transport._host,
            args[1],
        )
...
def test_update_cmek_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudTasksClient(
...
def test_update_cmek_config_rest_required_fields(
    request_type=cloudtasks.UpdateCmekConfigRequest,
):
    transport_class = transports.CloudTasksRestTransport
    ...
    default_values = getattr(
        transport_class._BaseUpdateCmekConfig,
    ...
    # Designate an appropriate value for the returned response.
    return_value = gct_cmek_config.CmekConfig()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = gct_cmek_config.CmekConfig.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_update_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "cmek_config": {"name": "projects/sample1/locations/sample2/cmekConfig"}
        }
        ...
        client.update_cmek_config(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{cmek_config.name=projects/*/locations/*/cmekConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_get_cmek_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudTasksClient(
...
def test_get_cmek_config_rest_required_fields(
    request_type=cloudtasks.GetCmekConfigRequest,
):
    transport_class = transports.CloudTasksRestTransport
    ...
    default_values = getattr(
        transport_class._BaseGetCmekConfig,
    ...
    # Designate an appropriate value for the returned response.
    return_value = cmek_config.CmekConfig()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = cmek_config.CmekConfig.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_cmek_config(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/cmekConfig}" % client.transport._host,
            args[1],
        )
...
def test_list_queues_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_queues), "__call__") as call:
        call.return_value = cloudtasks.ListQueuesResponse()
        client.list_queues(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_queue), "__call__") as call:
        call.return_value = gct_queue.Queue()
        client.create_queue(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_queue), "__call__") as call:
        call.return_value = gct_queue.Queue()
        client.update_queue(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_queue), "__call__") as call:
        call.return_value = None
        client.delete_queue(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_purge_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.purge_queue), "__call__") as call:
        call.return_value = queue.Queue()
        client.purge_queue(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_pause_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.pause_queue), "__call__") as call:
        call.return_value = queue.Queue()
        client.pause_queue(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resume_queue_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.resume_queue), "__call__") as call:
        call.return_value = queue.Queue()
        client.resume_queue(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_tasks_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_delete_tasks(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_cmek_config_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_cmek_config_empty_call_grpc():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = CloudTasksAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_queues_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.list_queues), "__call__") as call:
        ...
        await client.list_queues(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_queue), "__call__") as call:
        ...
        await client.get_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_queue), "__call__") as call:
        ...
        await client.create_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_queue), "__call__") as call:
        ...
        await client.update_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_queue), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_purge_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.purge_queue), "__call__") as call:
        ...
        await client.purge_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_pause_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.pause_queue), "__call__") as call:
        ...
        await client.pause_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resume_queue_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.resume_queue), "__call__") as call:
        ...
        await client.resume_queue(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_tasks_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_delete_tasks(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_cmek_config_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_cmek_config_empty_call_grpc_asyncio():
    client = CloudTasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_transport_kind_rest():
    transport = CloudTasksClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_queues_rest_bad_request(request_type=cloudtasks.ListQueuesRequest):
    client = CloudTasksClient(
...
def test_list_queues_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_queues_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloudtasks.ListQueuesResponse.to_json(
            cloudtasks.ListQueuesResponse()
        )
...
def test_get_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_get_queue_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = queue.Queue.to_json(queue.Queue())
        req.return_value.content = return_value
...
def test_create_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    request_init["queue"] = {
        ...
        "rate_limits": {
            "max_dispatches_per_second": 0.26380000000000003,
            "max_burst_size": 1519,
            "max_concurrent_dispatches": 2671,
        },
        "retry_config": {
            "max_attempts": 1303,
        ...
        "stackdriver_logging_config": {"sampling_ratio": 0.1497},
    }
...
def test_create_queue_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gct_queue.Queue.to_json(gct_queue.Queue())
        req.return_value.content = return_value
...
def test_update_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_delete_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_purge_queue_rest_bad_request(request_type=cloudtasks.PurgeQueueRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_purge_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_pause_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_resume_queue_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_tasks_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloudtasks.ListTasksResponse.to_json(
            cloudtasks.ListTasksResponse()
        )
        req.return_value.content = return_value
...
def test_create_task_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gct_task.Task.to_json(gct_task.Task())
        req.return_value.content = return_value
...
def test_batch_create_tasks_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "post_batch_create_tasks"
        ) as post,
        mock.patch.object(
            transports.CloudTasksRestInterceptor,
        ...
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "pre_batch_create_tasks"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloudtasks.BatchCreateTasksRequest.pb(
            cloudtasks.BatchCreateTasksRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_batch_delete_tasks_rest_bad_request(
    request_type=cloudtasks.BatchDeleteTasksRequest,
):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_batch_delete_tasks_rest_call_success(request_type):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_batch_delete_tasks_rest_interceptors(null_interceptor):
    transport = transports.CloudTasksRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(operation.Operation, "_set_result_from_operation"),
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "post_batch_delete_tasks"
        ) as post,
        mock.patch.object(
            transports.CloudTasksRestInterceptor,
        ...
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "pre_batch_delete_tasks"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloudtasks.BatchDeleteTasksRequest.pb(
            cloudtasks.BatchDeleteTasksRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_run_task_rest_bad_request(request_type=cloudtasks.RunTaskRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_update_cmek_config_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = cloudtasks.UpdateCmekConfigRequest.meta.fields["cmek_config"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["cmek_config"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["cmek_config"][field])):
                    del request_init["cmek_config"][field][i][subfield]
            else:
                del request_init["cmek_config"][field][subfield]
    request = request_type(**request_init)
...
def test_update_cmek_config_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "post_update_cmek_config"
        ) as post,
        mock.patch.object(
            transports.CloudTasksRestInterceptor,
        ...
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "pre_update_cmek_config"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloudtasks.UpdateCmekConfigRequest.pb(
            cloudtasks.UpdateCmekConfigRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gct_cmek_config.CmekConfig.to_json(gct_cmek_config.CmekConfig())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = gct_cmek_config.CmekConfig()
        post_with_metadata.return_value = gct_cmek_config.CmekConfig(), metadata
...
def test_get_cmek_config_rest_bad_request(request_type=cloudtasks.GetCmekConfigRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_cmek_config_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "post_get_cmek_config"
        ) as post,
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "post_get_cmek_config_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.CloudTasksRestInterceptor, "pre_get_cmek_config"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloudtasks.GetCmekConfigRequest.pb(
            cloudtasks.GetCmekConfigRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cmek_config.CmekConfig.to_json(cmek_config.CmekConfig())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = cmek_config.CmekConfig()
        post_with_metadata.return_value = cmek_config.CmekConfig(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_queues_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_queue_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_queue_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_queue_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_purge_queue_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_pause_queue_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resume_queue_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_tasks_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_cmek_config_empty_call_rest():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cloud_tasks_rest_lro_client():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cloud_tasks_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.batch_delete_tasks._session
    session2 = client2.transport.batch_delete_tasks._session
    assert session1 != session2
    session1 = client1.transport.run_task._session
    session2 = client2.transport.run_task._session
    assert session1 != session2
    session1 = client1.transport.update_cmek_config._session
    session2 = client2.transport.update_cmek_config._session
    assert session1 != session2
    session1 = client1.transport.get_cmek_config._session
    session2 = client2.transport.get_cmek_config._session
    assert session1 != session2
...
def test_cloud_tasks_grpc_lro_client():
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_cloud_tasks_grpc_lro_async_client():
    client = CloudTasksAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc_asyncio",
    )
...
def test_cmek_config_path():
    ...
    actual = CloudTasksClient.cmek_config_path(project, location)
...
def test_parse_cmek_config_path():
    ...
    path = CloudTasksClient.cmek_config_path(**expected)

    # Check that the path construction is reversible.
    actual = CloudTasksClient.parse_cmek_config_path(path)
    assert expected == actual
...
def test_crypto_key_path():
    ...
    actual = CloudTasksClient.crypto_key_path(project, location, key_ring, crypto_key)
    assert expected == actual
...
def test_parse_crypto_key_path():
    ...
    path = CloudTasksClient.crypto_key_path(**expected)

    # Check that the path construction is reversible.
    actual = CloudTasksClient.parse_crypto_key_path(path)
    assert expected == actual
...
async def test_get_location_field_headers_async():
    client = CloudTasksAsyncClient(credentials=async_anonymous_credentials())

        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.tasks_v2.CloudTasksClient.BatchCreateTasks",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.tasks_v2.CloudTasksClient.batch_create_tasks",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
                        "rpcName": "BatchCreateTasks",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.tasks_v2.CloudTasksClient.BatchDeleteTasks",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.tasks_v2.CloudTasksClient.batch_delete_tasks",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
                        "rpcName": "BatchDeleteTasks",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.tasks_v2.CloudTasksClient.GetCmekConfig",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.tasks_v2.CloudTasksClient.get_cmek_config",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
                        "rpcName": "GetCmekConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.tasks_v2.CloudTasksClient.UpdateCmekConfig",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.tasks_v2.CloudTasksClient.update_cmek_config",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
                        "rpcName": "UpdateCmekConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.tasks_v2.CloudTasksClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.tasks_v2.CloudTasksAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.tasks.v2.CloudTasks",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

...
class CloudTasksGrpcAsyncIOTransport(CloudTasksTransport):
    ...
    @property
    def upload_queue_yaml(self) -> Callable[[cloudtasks.UploadQueueYamlRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def lease_tasks(self) -> Callable[[cloudtasks.LeaseTasksRequest], Awaitable[cloudtasks.LeaseTasksResponse]]:
    ...
    @property
    def acknowledge_task(self) -> Callable[[cloudtasks.AcknowledgeTaskRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def renew_lease(self) -> Callable[[cloudtasks.RenewLeaseRequest], Awaitable[task.Task]]:
    ...
    @property
    def cancel_lease(self) -> Callable[[cloudtasks.CancelLeaseRequest], Awaitable[task.Task]]:

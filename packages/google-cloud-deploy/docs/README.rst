Python Client for Cloud Deploy
==============================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-deploy.svg
   :target: https://pypi.org/project/google-cloud-deploy/
.. _Cloud Deploy: https://cloud.google.com/deploy/
...
3. `Enable the Cloud Deploy.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud Deploy.:  https://cloud.google.com/deploy/
...
-  Read the `Client Library Documentation`_ for Cloud Deploy
   to see other available methods on the client.
-  Read the `Cloud Deploy Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud Deploy Product documentation:  https://cloud.google.com/deploy/

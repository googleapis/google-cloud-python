...
__lazy_modules__ = {
    ...
    "google.cloud.deploy_v1.types.automation_payload",
    "google.cloud.deploy_v1.types.automationrun_payload",
    "google.cloud.deploy_v1.types.cloud_deploy",
    "google.cloud.deploy_v1.types.customtargettype_notification_payload",
    "google.cloud.deploy_v1.types.deliverypipeline_notification_payload",
    "google.cloud.deploy_v1.types.deploypolicy_evaluation_payload",
    "google.cloud.deploy_v1.types.deploypolicy_notification_payload",
    "google.cloud.deploy_v1.types.jobrun_notification_payload",
    "google.cloud.deploy_v1.types.log_enums",
    "google.cloud.deploy_v1.types.release_notification_payload",
    "google.cloud.deploy_v1.types.release_render_payload",
    "google.cloud.deploy_v1.types.rollout_notification_payload",
    "google.cloud.deploy_v1.types.rollout_update_payload",
    "google.cloud.deploy_v1.types.target_notification_payload",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.deploy_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.deploy_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.deploy_v1"

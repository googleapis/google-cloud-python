...
from google.cloud.geminidataanalytics_v1beta.services.data_chat_service import (
    DataChatServiceAsyncClient,
    DataChatServiceClient,
    pagers,
    transports,
)
from google.cloud.geminidataanalytics_v1beta.types import agent_context, context
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DataChatServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DataChatServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DataChatServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DataChatServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DataChatServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
...
def test__get_client_cert_source():
    ...
    assert (
        DataChatServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        DataChatServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DataChatServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                DataChatServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DataChatServiceClient),
)
@mock.patch.object(
    DataChatServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(DataChatServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DataChatServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DataChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = DataChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        DataChatServiceClient._get_api_endpoint(
    ...
    assert (
        DataChatServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        DataChatServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == DataChatServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DataChatServiceClient._get_api_endpoint(
    ...
    assert (
        DataChatServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        DataChatServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        DataChatServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        DataChatServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        DataChatServiceClient._get_universe_domain(None, None)
        == DataChatServiceClient._DEFAULT_UNIVERSE
    )
...
def test_data_chat_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_data_chat_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_data_chat_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_data_chat_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_data_chat_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [DataChatServiceClient, DataChatServiceAsyncClient]
)
@mock.patch.object(
    DataChatServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DataChatServiceClient),
)
@mock.patch.object(
    DataChatServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DataChatServiceAsyncClient),
)
...
def test_data_chat_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_data_chat_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_data_chat_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_chat_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.chat in client._client._transport._wrapped_methods
        )
...
async def test_chat_async(
    ...
    with mock.patch.object(type(client.transport.chat), "__call__") as call:
        ...
        call.return_value.read = mock.AsyncMock(
            side_effect=[data_chat_service.Message()]
        )
...
def test_query_data(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.query_data), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = data_chat_service.QueryDataResponse(
            generated_query="generated_query_value",
            intent_explanation="intent_explanation_value",
            natural_language_answer="natural_language_answer_value",
            disambiguation_question=["disambiguation_question_value"],
        )
        response = client.query_data(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = data_chat_service.QueryDataRequest()
        assert args[0] == request

    # Establish that the response is the type that we expect.
    assert isinstance(response, data_chat_service.QueryDataResponse)
    assert response.generated_query == "generated_query_value"
...
def test_query_data_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DataChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_query_data_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.query_data in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.query_data] = mock_rpc
        request = {}
        client.query_data(request)
...
@pytest.mark.asyncio
async def test_query_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataChatServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.query_data
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_query_data_field_headers_async():
    client = DataChatServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_chat_rest_required_fields(request_type=data_chat_service.ChatRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).chat._get_unset_required_fields(jsonified_request)
...
def test_create_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/conversations"
...
def test_delete_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/conversations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_messages_rest_required_fields(
    request_type=data_chat_service.ListMessagesRequest,
):
    transport_class = transports.DataChatServiceRestTransport
...
def test_list_messages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/conversations/*}/messages"
            % client.transport._host,
            args[1],
        )
...
def test_list_messages_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            data_chat_service.ListMessagesResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_query_data_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataChatServiceClient(
...
def test_query_data_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).query_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present

    jsonified_request["parent"] = "parent_value"
    jsonified_request["prompt"] = "prompt_value"
    ...
    assert "parent" in jsonified_request
    assert jsonified_request["parent"] == "parent_value"
    assert "prompt" in jsonified_request
    assert jsonified_request["prompt"] == "prompt_value"
    ...
    # Designate an appropriate value for the returned response.
    return_value = data_chat_service.QueryDataResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = data_chat_service.QueryDataResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_query_data_rest_unset_required_fields():
    transport = transports.DataChatServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.query_data._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_data_empty_call_grpc():
    client = DataChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.query_data), "__call__") as call:
        call.return_value = data_chat_service.QueryDataResponse()
        client.query_data(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_query_data_empty_call_grpc_asyncio():
    client = DataChatServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.query_data), "__call__") as call:
        ...
        await client.query_data(request=None)
...
def test_chat_rest_interceptors(null_interceptor):
    transport = transports.DataChatServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.DataChatServiceRestInterceptor(),
    )
    client = DataChatServiceClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.DataChatServiceRestInterceptor, "post_chat"
...
def test_create_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.DataChatServiceRestInterceptor, "post_create_conversation"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcg_conversation.CreateConversationRequest.pb(
            gcg_conversation.CreateConversationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.DataChatServiceRestInterceptor, "post_get_conversation"
    ) as post, mock.patch.object(
...
def test_list_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.DataChatServiceRestInterceptor, "post_list_conversations"
    ) as post, mock.patch.object(
        transports.DataChatServiceRestInterceptor,
...
def test_list_messages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.DataChatServiceRestInterceptor, "post_list_messages"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_chat_service.ListMessagesRequest.pb(
            data_chat_service.ListMessagesRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = data_chat_service.ListMessagesResponse.to_json(
            data_chat_service.ListMessagesResponse()
        )
        req.return_value.content = return_value
...
def test_query_data_rest_bad_request(request_type=data_chat_service.QueryDataRequest):
    client = DataChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_query_data_rest_call_success(request_type):
    client = DataChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_query_data_rest_interceptors(null_interceptor):
    transport = transports.DataChatServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with mock.patch.object(
        ...
        transports.DataChatServiceRestInterceptor, "post_query_data"
    ) as post, mock.patch.object(
        transports.DataChatServiceRestInterceptor, "post_query_data_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DataChatServiceRestInterceptor, "pre_query_data"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_chat_service.QueryDataRequest.pb(
            data_chat_service.QueryDataRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = data_chat_service.QueryDataResponse.to_json(
            data_chat_service.QueryDataResponse()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = data_chat_service.QueryDataResponse()
        post_with_metadata.return_value = (
            data_chat_service.QueryDataResponse(),
            metadata,
        )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_data_empty_call_rest():
    client = DataChatServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_data_chat_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.geminidataanalytics_v1beta.services.data_chat_service.transports.DataChatServiceTransport.__init__"
    ) as Transport:
...
def test_data_chat_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.query_data._session
    session2 = client2.transport.query_data._session
    assert session1 != session2
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.DataChatServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = DataChatServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

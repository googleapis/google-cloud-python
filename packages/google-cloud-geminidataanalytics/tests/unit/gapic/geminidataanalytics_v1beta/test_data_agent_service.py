...
def test_create_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/dataAgents:createSync"
            % client.transport._host,
            args[1],
        )
...
def test_update_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{data_agent.name=projects/*/locations/*/dataAgents/*}:updateSync"
            % client.transport._host,
            args[1],
        )
...
def test_delete_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/dataAgents/*}:deleteSync"
            % client.transport._host,
            args[1],
        )
...
def test_set_agent_ops_observability_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/observabilitySettings:setAgentOpsObservability"
            % client.transport._host,
            args[1],
        )
...
def test_retrieve_agent_ops_observability_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}:retrieveAgentOpsObservability"
            % client.transport._host,
            args[1],
        )

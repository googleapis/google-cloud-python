...
from google.cloud.geminidataanalytics_v1beta.services.context_retrieval_service import (
...
def test_context_retrieval_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.geminidataanalytics_v1beta.services.context_retrieval_service.transports.ContextRetrievalServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_context_retrieval_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.geminidataanalytics_v1beta.services.context_retrieval_service.transports.ContextRetrievalServiceTransport.__init__"
    ) as Transport:
...
def test_context_retrieval_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.geminidataanalytics_v1beta.services.context_retrieval_service.transports.ContextRetrievalServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

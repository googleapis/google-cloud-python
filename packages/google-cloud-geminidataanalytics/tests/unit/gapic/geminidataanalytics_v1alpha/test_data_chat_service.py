...
def test_create_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*}/conversations"
...
def test_list_messages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/conversations/*}/messages"
            % client.transport._host,
            args[1],
        )
...
def test_data_chat_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.geminidataanalytics_v1alpha.services.data_chat_service.transports.DataChatServiceTransport.__init__"
    ) as Transport:

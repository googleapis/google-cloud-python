...
from google.cloud.geminidataanalytics_v1alpha.types import data_agent_service, data_analytics_agent, datasource
from google.cloud.geminidataanalytics_v1alpha.types import data_agent as gcg_data_agent
from google.cloud.geminidataanalytics_v1alpha.types import context, credentials
...
def test__get_default_mtls_endpoint():
    ...
    assert DataAgentServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert DataAgentServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DataAgentServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DataAgentServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert DataAgentServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DataAgentServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DataAgentServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DataAgentServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DataAgentServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DataAgentServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DataAgentServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert DataAgentServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DataAgentServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(DataAgentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataAgentServiceClient))
@mock.patch.object(DataAgentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataAgentServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DataAgentServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DataAgentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DataAgentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DataAgentServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        DataAgentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == DataAgentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert DataAgentServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DataAgentServiceClient._get_api_endpoint(None, None, default_universe, "always") == DataAgentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        DataAgentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == DataAgentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert DataAgentServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DataAgentServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DataAgentServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DataAgentServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DataAgentServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DataAgentServiceClient._get_universe_domain(None, None) == DataAgentServiceClient._DEFAULT_UNIVERSE
...
def test_data_agent_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "geminidataanalytics.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://geminidataanalytics.googleapis.com"
        )
...
def test_data_agent_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_data_agent_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (DataAgentServiceAsyncClient, transports.DataAgentServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (DataAgentServiceClient, transports.DataAgentServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(DataAgentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataAgentServiceClient))
@mock.patch.object(DataAgentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataAgentServiceAsyncClient))
def test_data_agent_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (DataAgentServiceClient, transports.DataAgentServiceGrpcTransport, "grpc", "true"),
        (DataAgentServiceAsyncClient, transports.DataAgentServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (DataAgentServiceClient, transports.DataAgentServiceGrpcTransport, "grpc", "false"),
        (DataAgentServiceAsyncClient, transports.DataAgentServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (DataAgentServiceClient, transports.DataAgentServiceRestTransport, "rest", "true"),
        (DataAgentServiceClient, transports.DataAgentServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(DataAgentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataAgentServiceClient))
@mock.patch.object(DataAgentServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataAgentServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_data_agent_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [DataAgentServiceClient, DataAgentServiceAsyncClient])
@mock.patch.object(DataAgentServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataAgentServiceClient))
@mock.patch.object(DataAgentServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataAgentServiceAsyncClient))
...
def test_data_agent_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (DataAgentServiceClient, transports.DataAgentServiceGrpcTransport, "grpc", grpc_helpers),
        (DataAgentServiceAsyncClient, transports.DataAgentServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (DataAgentServiceClient, transports.DataAgentServiceRestTransport, "rest", None),
    ],
)
def test_data_agent_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_data_agent_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = DataAgentServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_data_agent_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_data_agents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_data_agents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_data_agents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_data_agents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_data_agents] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_data_agents_async(transport: str = "grpc_asyncio", request_type=data_agent_service.ListDataAgentsRequest):
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_data_agents_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_data_agents), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_agent_service.ListDataAgentsResponse())
        await client.list_data_agents(request)
...
async def test_list_data_agents_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_data_agents), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            data_agent_service.ListDataAgentsResponse(
                data_agents=[
...
async def test_list_data_agents_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_data_agents), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_data_agents(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_accessible_data_agents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_accessible_data_agents in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_accessible_data_agents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_accessible_data_agents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataAgentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_accessible_data_agents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_accessible_data_agents] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_accessible_data_agents_async(transport: str = "grpc_asyncio", request_type=data_agent_service.ListAccessibleDataAgentsRequest):
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_accessible_data_agents_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_accessible_data_agents), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_agent_service.ListAccessibleDataAgentsResponse())
        await client.list_accessible_data_agents(request)
...
def test_list_accessible_data_agents_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_accessible_data_agents), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_accessible_data_agents(request={}, retry=retry, timeout=timeout)
...
async def test_list_accessible_data_agents_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_accessible_data_agents), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            data_agent_service.ListAccessibleDataAgentsResponse(
                data_agents=[
...
async def test_list_accessible_data_agents_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_accessible_data_agents), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_accessible_data_agents(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_data_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataAgentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_data_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_data_agent] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_data_agent_async(transport: str = "grpc_asyncio", request_type=data_agent_service.GetDataAgentRequest):
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_data_agent_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_data_agent), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_agent.DataAgent())
        await client.get_data_agent(request)
...
def test_create_data_agent(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_data_agent), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_data_agent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_data_agent] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_data_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataAgentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_data_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_data_agent] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_data_agent_async(transport: str = "grpc_asyncio", request_type=data_agent_service.CreateDataAgentRequest):
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
        ...
        client.create_data_agent(
            ...
            data_agent=gcg_data_agent.DataAgent(
                data_analytics_agent=data_analytics_agent.DataAnalyticsAgent(
                    staging_context=context.Context(system_instruction="system_instruction_value")
                )
            ),
            data_agent_id="data_agent_id_value",
        )
...
def test_update_data_agent(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_data_agent), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_update_data_agent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_data_agent] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_data_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataAgentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_data_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_data_agent] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_data_agent_async(transport: str = "grpc_asyncio", request_type=data_agent_service.UpdateDataAgentRequest):
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_data_agent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_data_agent] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_data_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataAgentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_data_agent in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_data_agent] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_data_agent_async(transport: str = "grpc_asyncio", request_type=data_agent_service.DeleteDataAgentRequest):
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_data_agents_rest_required_fields(request_type=data_agent_service.ListDataAgentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_agents._get_unset_required_fields(jsonified_request)
...
def test_list_data_agents_rest_unset_required_fields():
    transport = transports.DataAgentServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/dataAgents" % client.transport._host, args[1])
...
def test_list_data_agents_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(data_agent_service.ListDataAgentsResponse.to_json(x) for x in response)
...
def test_list_accessible_data_agents_rest_required_fields(request_type=data_agent_service.ListAccessibleDataAgentsRequest):
    transport_class = transports.DataAgentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_accessible_data_agents._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = data_agent_service.ListAccessibleDataAgentsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_accessible_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/dataAgents:listAccessible" % client.transport._host, args[1])
...
def test_list_accessible_data_agents_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(data_agent_service.ListAccessibleDataAgentsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_data_agent_rest_required_fields(request_type=data_agent_service.GetDataAgentRequest):
    transport_class = transports.DataAgentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_data_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/dataAgents/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/dataAgents/*}" % client.transport._host, args[1])
...
def test_create_data_agent_rest_required_fields(request_type=data_agent_service.CreateDataAgentRequest):
    transport_class = transports.DataAgentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_agent_rest_required_fields(request_type=data_agent_service.UpdateDataAgentRequest):
    transport_class = transports.DataAgentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_data_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"data_agent": {"name": "projects/sample1/locations/sample2/dataAgents/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{data_agent.name=projects/*/locations/*/dataAgents/*}" % client.transport._host, args[1])
...
def test_delete_data_agent_rest_required_fields(request_type=data_agent_service.DeleteDataAgentRequest):
    transport_class = transports.DataAgentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_agent._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"resource": "projects/sample1/locations/sample2/dataAgents/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{resource=projects/*/locations/*/dataAgents/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = DataAgentServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = DataAgentServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = DataAgentServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DataAgentServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DataAgentServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_data_agents_rest_bad_request(request_type=data_agent_service.ListDataAgentsRequest):
    client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_data_agents_rest_interceptors(null_interceptor):
    transport = transports.DataAgentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DataAgentServiceRestInterceptor(),
    )
    client = DataAgentServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_list_data_agents") as post, mock.patch.object(
        transports.DataAgentServiceRestInterceptor, "post_list_data_agents_with_metadata"
        ...
        pb_message = data_agent_service.ListDataAgentsRequest.pb(data_agent_service.ListDataAgentsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = data_agent_service.ListDataAgentsResponse.to_json(data_agent_service.ListDataAgentsResponse())
        ...
        post_with_metadata.return_value = data_agent_service.ListDataAgentsResponse(), metadata
...
def test_list_accessible_data_agents_rest_bad_request(request_type=data_agent_service.ListAccessibleDataAgentsRequest):
    client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_accessible_data_agents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_list_accessible_data_agents") as post, mock.patch.object(
        transports.DataAgentServiceRestInterceptor, "post_list_accessible_data_agents_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_agent_service.ListAccessibleDataAgentsRequest.pb(data_agent_service.ListAccessibleDataAgentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = data_agent_service.ListAccessibleDataAgentsResponse.to_json(data_agent_service.ListAccessibleDataAgentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = data_agent_service.ListAccessibleDataAgentsResponse(), metadata
...
def test_get_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_get_data_agent") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_agent_service.GetDataAgentRequest.pb(data_agent_service.GetDataAgentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_data_agent_rest_bad_request(request_type=data_agent_service.CreateDataAgentRequest):
    client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
    ...
    request_init["data_agent"] = {
        "data_analytics_agent": {
            "staging_context": {
                        ...
                        "table_references": [
                            {
                                ...
                                "schema": {
                                    ...
                                    "tags": ["tags_value1", "tags_value2"],
                                    "display_name": "display_name_value",
                                    "filters": [{"field": "field_value", "value": "value_value", "type_": 1}],
                                },
                            }
                        ]
                    },
                    "studio": {"studio_references": [{"datasource_id": "datasource_id_value"}]},
                    "looker": {
                        "explore_references": [
                            {
                        ...
                        "credentials": {
                            "oauth": {
                                "secret": {"client_id": "client_id_value", "client_secret": "client_secret_value"},
                ...
                "example_queries": [{"sql_query": "sql_query_value", "natural_language_question": "natural_language_question_value"}],
                "glossary_terms": [
                    {"display_name": "display_name_value", "description": "description_value", "labels": ["labels_value1", "labels_value2"]}
                ],
                "schema_relationships": [
                    {
                        "left_schema_paths": {"table_fqn": "table_fqn_value", "paths": ["paths_value1", "paths_value2"]},
                        "right_schema_paths": {},
                        "sources": [1],
...
def test_create_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataAgentServiceRestInterceptor, "post_create_data_agent_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_agent_service.CreateDataAgentRequest.pb(data_agent_service.CreateDataAgentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_data_agent_rest_bad_request(request_type=data_agent_service.UpdateDataAgentRequest):
    client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"data_agent": {"name": "projects/sample1/locations/sample2/dataAgents/sample3"}}
    request = request_type(**request_init)
...
def test_update_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataAgentServiceRestInterceptor, "post_update_data_agent_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_agent_service.UpdateDataAgentRequest.pb(data_agent_service.UpdateDataAgentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_data_agent_rest_bad_request(request_type=data_agent_service.DeleteDataAgentRequest):
    client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/dataAgents/sample3"}
    request = request_type(**request_init)
...
def test_delete_data_agent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataAgentServiceRestInterceptor, "post_delete_data_agent_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_agent_service.DeleteDataAgentRequest.pb(data_agent_service.DeleteDataAgentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataAgentServiceRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
...
def test_data_agent_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.DataAgentServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_data_agent_service_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceTransport.__init__"
    ) as Transport:
...
def test_data_agent_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.geminidataanalytics_v1alpha.services.data_agent_service.transports.DataAgentServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.DataAgentServiceGrpcTransport, grpc_helpers), (transports.DataAgentServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.DataAgentServiceGrpcTransport, transports.DataAgentServiceGrpcAsyncIOTransport])
...
def test_data_agent_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.DataAgentServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_data_agent_service_host_no_port(transport_name):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="geminidataanalytics.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "geminidataanalytics.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://geminidataanalytics.googleapis.com"
...
def test_data_agent_service_host_with_port(transport_name):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="geminidataanalytics.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "geminidataanalytics.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://geminidataanalytics.googleapis.com:8000"
    )
...
@pytest.mark.parametrize("transport_class", [transports.DataAgentServiceGrpcTransport, transports.DataAgentServiceGrpcAsyncIOTransport])
def test_data_agent_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.DataAgentServiceTransport, "_prep_wrapped_messages") as prep:
        client = DataAgentServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = DataAgentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

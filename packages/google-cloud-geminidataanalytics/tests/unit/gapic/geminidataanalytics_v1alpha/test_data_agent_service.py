...
def test_list_data_agents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_data_agents] = (
            mock_rpc
        )
        request = {}
...
def test_create_data_agent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_data_agent] = (
            mock_rpc
        )
        request = {}
...
def test_create_data_agent_sync(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_data_agent_sync), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcg_data_agent.DataAgent(
            name="name_value",
            display_name="display_name_value",
            description="description_value",
        )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, gcg_data_agent.DataAgent)
    assert response.name == "name_value"
    assert response.display_name == "display_name_value"
    assert response.description == "description_value"
...
def test_create_data_agent_sync_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_data_agent_sync
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_data_agent_sync] = (
            mock_rpc
        )
        request = {}
        client.create_data_agent_sync(request)
...
@pytest.mark.asyncio
async def test_create_data_agent_sync_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_data_agent_sync
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.create_data_agent_sync(request)
...
@pytest.mark.asyncio
async def test_create_data_agent_sync_field_headers_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_data_agent_sync_flattened():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_create_data_agent_sync_flattened_error():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_data_agent_sync_flattened_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_data_agent_sync(
            parent="parent_value",
            data_agent=gcg_data_agent.DataAgent(
                data_analytics_agent=data_analytics_agent.DataAnalyticsAgent(
                    staging_context=context.Context(
...
@pytest.mark.asyncio
async def test_create_data_agent_sync_flattened_error_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_data_agent_sync(
            data_agent_service.CreateDataAgentRequest(),
            parent="parent_value",
            data_agent=gcg_data_agent.DataAgent(
                data_analytics_agent=data_analytics_agent.DataAnalyticsAgent(
...
def test_update_data_agent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_data_agent] = (
            mock_rpc
        )
        request = {}
...
def test_update_data_agent_sync(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.update_data_agent_sync), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcg_data_agent.DataAgent(
            name="name_value",
...
def test_update_data_agent_sync_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_data_agent_sync
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_data_agent_sync] = (
            mock_rpc
        )
        request = {}
        client.update_data_agent_sync(request)
...
@pytest.mark.asyncio
async def test_update_data_agent_sync_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_data_agent_sync
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.update_data_agent_sync(request)
...
@pytest.mark.asyncio
async def test_update_data_agent_sync_field_headers_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_data_agent_sync_flattened():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_data_agent_sync_flattened_error():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_data_agent_sync_flattened_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_data_agent_sync_flattened_error_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_data_agent_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_data_agent] = (
            mock_rpc
        )
        request = {}
...
def test_delete_data_agent_sync(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_data_agent_sync), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
        response = client.delete_data_agent_sync(request)
...
def test_delete_data_agent_sync_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_data_agent_sync_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_data_agent_sync
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_data_agent_sync] = (
            mock_rpc
        )
        request = {}
        client.delete_data_agent_sync(request)
...
@pytest.mark.asyncio
async def test_delete_data_agent_sync_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_data_agent_sync
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.delete_data_agent_sync(request)
...
async def test_delete_data_agent_sync_async(
    ...
    with mock.patch.object(
        ...
        response = await client.delete_data_agent_sync(request)
...
@pytest.mark.asyncio
async def test_delete_data_agent_sync_field_headers_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_data_agent_sync_flattened():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_data_agent_sync_flattened_error():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_data_agent_sync_flattened_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_data_agent_sync(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_data_agent_sync_flattened_error_async():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_data_agent_sync(
            data_agent_service.DeleteDataAgentRequest(),
            name="name_value",
        )
...
def test_list_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*}/dataAgents"
...
def test_list_accessible_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*}/dataAgents:listAccessible"
            % client.transport._host,
            args[1],
        )
...
def test_get_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataAgents/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_data_agent_sync_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataAgentServiceClient(
...
def test_create_data_agent_sync_rest_required_fields(
    request_type=data_agent_service.CreateDataAgentRequest,
):
    transport_class = transports.DataAgentServiceRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = gcg_data_agent.DataAgent()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = gcg_data_agent.DataAgent.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_create_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_data_agent_sync(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*}/dataAgents:createSync"
            % client.transport._host,
            args[1],
        )


def test_create_data_agent_sync_rest_flattened_error(transport: str = "rest"):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{data_agent.name=projects/*/locations/*/dataAgents/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_data_agent_sync_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataAgentServiceClient(
...
def test_update_data_agent_sync_rest_required_fields(
    request_type=data_agent_service.UpdateDataAgentRequest,
):
    transport_class = transports.DataAgentServiceRestTransport
...
def test_update_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_data_agent_sync(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{data_agent.name=projects/*/locations/*/dataAgents/*}:updateSync"
            % client.transport._host,
            args[1],
        )


def test_update_data_agent_sync_rest_flattened_error(transport: str = "rest"):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_data_agent_sync_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataAgentServiceClient(
...
def test_delete_data_agent_sync_rest_required_fields(
    request_type=data_agent_service.DeleteDataAgentRequest,
):
    transport_class = transports.DataAgentServiceRestTransport
...
def test_delete_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_data_agent_sync(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataAgents/*}:deleteSync"
            % client.transport._host,
            args[1],
        )


def test_delete_data_agent_sync_rest_flattened_error(transport: str = "rest"):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{resource=projects/*/locations/*/dataAgents/*}:setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_data_agent_sync_empty_call_grpc():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = gcg_data_agent.DataAgent()
        client.create_data_agent_sync(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_data_agent_sync_empty_call_grpc():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = gcg_data_agent.DataAgent()
        client.update_data_agent_sync(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_data_agent_sync_empty_call_grpc():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = None
        client.delete_data_agent_sync(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_data_agent_sync_empty_call_grpc_asyncio():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_data_agent_sync_empty_call_grpc_asyncio():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_data_agent_sync_empty_call_grpc_asyncio():
    client = DataAgentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_data_agent_sync(request=None)
...
def test_list_accessible_data_agents_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor,
            "post_list_accessible_data_agents",
        ) as post,
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor,
            "pre_list_accessible_data_agents",
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_data_agent_sync_rest_call_success(request_type):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_data_agent_sync_rest_interceptors(null_interceptor):
    transport = transports.DataAgentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor, "post_create_data_agent_sync"
        ) as post,
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor, "pre_create_data_agent_sync"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcg_data_agent.DataAgent.to_json(gcg_data_agent.DataAgent())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = gcg_data_agent.DataAgent()
        post_with_metadata.return_value = gcg_data_agent.DataAgent(), metadata
...
def test_update_data_agent_sync_rest_bad_request(
    request_type=data_agent_service.UpdateDataAgentRequest,
):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_update_data_agent_sync_rest_call_success(request_type):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_data_agent_sync_rest_interceptors(null_interceptor):
    transport = transports.DataAgentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor, "post_update_data_agent_sync"
        ) as post,
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor, "pre_update_data_agent_sync"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_data_agent_sync_rest_bad_request(
    request_type=data_agent_service.DeleteDataAgentRequest,
):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_delete_data_agent_sync_rest_call_success(request_type):
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_data_agent_sync_rest_interceptors(null_interceptor):
    transport = transports.DataAgentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.DataAgentServiceRestInterceptor, "pre_delete_data_agent_sync"
        ) as pre,
    ):
        pre.assert_not_called()
        pb_message = data_agent_service.DeleteDataAgentRequest.pb(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_data_agent_sync_empty_call_rest():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_data_agent_sync_empty_call_rest():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_data_agent_sync_empty_call_rest():
    client = DataAgentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_data_agent_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.create_data_agent_sync._session
    session2 = client2.transport.create_data_agent_sync._session
    assert session1 != session2
    session1 = client1.transport.update_data_agent._session
    session2 = client2.transport.update_data_agent._session
    assert session1 != session2
    session1 = client1.transport.update_data_agent_sync._session
    session2 = client2.transport.update_data_agent_sync._session
    assert session1 != session2
    session1 = client1.transport.delete_data_agent._session
    session2 = client2.transport.delete_data_agent._session
    assert session1 != session2
    session1 = client1.transport.delete_data_agent_sync._session
    session2 = client2.transport.delete_data_agent_sync._session
    assert session1 != session2

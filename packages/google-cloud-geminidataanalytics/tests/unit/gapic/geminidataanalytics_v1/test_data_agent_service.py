...
from google.cloud.geminidataanalytics_v1.services.data_agent_service import (
...
def test_data_agent_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.geminidataanalytics_v1.services.data_agent_service.transports.DataAgentServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/dataAgents" % client.transport._host,
            args[1],
        )
...
def test_list_accessible_data_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/dataAgents:listAccessible"
...
def test_get_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/dataAgents/*}" % client.transport._host,
            args[1],
        )
...
def test_create_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/dataAgents:createSync"
            % client.transport._host,
            args[1],
        )
...
def test_update_data_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{data_agent.name=projects/*/locations/*/dataAgents/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{data_agent.name=projects/*/locations/*/dataAgents/*}:updateSync"
            % client.transport._host,
            args[1],
        )
...
def test_delete_data_agent_sync_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/dataAgents/*}:deleteSync"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{resource=projects/*/locations/*/dataAgents/*}:setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_data_agent_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.geminidataanalytics_v1.services.data_agent_service.transports.DataAgentServiceTransport.__init__"
    ) as Transport:
...
def test_data_agent_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.geminidataanalytics_v1.services.data_agent_service.transports.DataAgentServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

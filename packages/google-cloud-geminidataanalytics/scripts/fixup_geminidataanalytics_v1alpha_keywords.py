...
class geminidataanalyticsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'list_accessible_data_agents': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'show_deleted', 'creator_filter', ),
...
def fix_files(
    ...
    *,
    transformer=geminidataanalyticsCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the geminidataanalytics client library.

...
class DataChatServiceAsyncClient:
    ...
    async def delete_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1alpha.types.DeleteConversationRequest, dict]]):
    ...
    async def query_data(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1alpha.types.QueryDataRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_data]

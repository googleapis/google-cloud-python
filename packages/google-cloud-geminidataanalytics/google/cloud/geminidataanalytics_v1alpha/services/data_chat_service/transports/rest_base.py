    ...
    class _BaseUpdateConversation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{conversation.name=projects/*/locations/*/conversations/*}",
                    "body": "conversation",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = gcg_conversation.UpdateConversationRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_unset_required_fields(
                    query_params
                )
            )

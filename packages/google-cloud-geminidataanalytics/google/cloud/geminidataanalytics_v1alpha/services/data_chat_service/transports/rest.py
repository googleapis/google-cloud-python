    ...
    class _UpdateConversation(
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_http_options()
            )

            request, metadata = self._interceptor.pre_update_conversation(
                request, metadata
            )
            transcoded_request = _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_transcoded_request(
                http_options, request
            )

            body = _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseDataChatServiceRestTransport._BaseUpdateConversation._get_query_params_json(
                transcoded_request
            )

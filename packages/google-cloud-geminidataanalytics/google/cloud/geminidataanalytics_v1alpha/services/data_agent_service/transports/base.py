...
class DataAgentServiceTransport(abc.ABC):
    ...
    def list_data_agents(
        ...
        Union[data_agent_service.ListDataAgentsResponse, Awaitable[data_agent_service.ListDataAgentsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def list_accessible_data_agents(
        ...
        Union[data_agent_service.ListAccessibleDataAgentsResponse, Awaitable[data_agent_service.ListAccessibleDataAgentsResponse]],
    ]:
        raise NotImplementedError()

    @property
    def get_data_agent(self) -> Callable[[data_agent_service.GetDataAgentRequest], Union[data_agent.DataAgent, Awaitable[data_agent.DataAgent]]]:
        raise NotImplementedError()

    @property
    def create_data_agent(
        self,
    ) -> Callable[[data_agent_service.CreateDataAgentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_data_agent(
        self,
    ) -> Callable[[data_agent_service.UpdateDataAgentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_data_agent(
        self,
    ) -> Callable[[data_agent_service.DeleteDataAgentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
...
__all__ = ("DataAgentServiceTransport",)

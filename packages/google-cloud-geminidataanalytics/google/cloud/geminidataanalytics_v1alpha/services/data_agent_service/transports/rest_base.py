    ...
    class _BaseCreateDataAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*}/dataAgents",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseCreateDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*}/dataAgents:createSync",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseDeleteDataAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1alpha/{name=projects/*/locations/*/dataAgents/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1alpha/{name=projects/*/locations/*/dataAgents/*}:deleteSync",
                },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseListAccessibleDataAgents:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1alpha/{parent=projects/*/locations/*}/dataAgents:listAccessible",
                },
            ]
            return http_options
    ...
    class _BaseRetrieveAgentOpsObservability:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1alpha/{parent=projects/*/locations/*}:retrieveAgentOpsObservability",
                },
            ]
            return http_options
    ...
    class _BaseSetAgentOpsObservability:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*}/observabilitySettings:setAgentOpsObservability",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{resource=projects/*/locations/*/dataAgents/*}:setIamPolicy",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdateDataAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{data_agent.name=projects/*/locations/*/dataAgents/*}",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseUpdateDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{data_agent.name=projects/*/locations/*/dataAgents/*}:updateSync",
                    "body": "data_agent",
                },
            ]
            return http_options

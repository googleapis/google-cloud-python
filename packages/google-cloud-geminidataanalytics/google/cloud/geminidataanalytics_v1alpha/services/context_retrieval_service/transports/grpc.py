...
from .base import DEFAULT_CLIENT_INFO, ContextRetrievalServiceTransport
...
class ContextRetrievalServiceGrpcTransport(ContextRetrievalServiceTransport):
    """gRPC backend transport for ContextRetrievalService.
...
__all__ = ("ContextRetrievalServiceGrpcTransport",)

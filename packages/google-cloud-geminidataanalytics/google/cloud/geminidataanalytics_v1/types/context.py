...
from google.cloud.geminidataanalytics_v1.types import datasource as gcg_datasource
...
class Context(proto.Message):
    ...
    class SchemaRelationship(proto.Message):
        ...
        Attributes:
            left_schema_paths (google.cloud.geminidataanalytics_v1.types.Context.SchemaRelationship.SchemaPaths):
            ...
            right_schema_paths (google.cloud.geminidataanalytics_v1.types.Context.SchemaRelationship.SchemaPaths):
            ...
            sources (MutableSequence[google.cloud.geminidataanalytics_v1.types.Context.SchemaRelationship.Source]):
...
class UserFunctions(proto.Message):
    ...
    Attributes:
        bq_routines (MutableSequence[google.cloud.geminidataanalytics_v1.types.BigQueryRoutine]):
...
class BigQueryRoutine(proto.Message):
    ...
    Attributes:
        routine_reference (google.cloud.geminidataanalytics_v1.types.BigQueryRoutineReference):
...
class MatchedQuery(proto.Message):
    ...
    Attributes:
        example_query (google.cloud.geminidataanalytics_v1.types.ExampleQuery):
            ...
            example query.
        query_parameter_values (MutableSequence[google.cloud.geminidataanalytics_v1.types.QueryParameterValues]):
...
class LookerQuery(proto.Message):
    ...
    Attributes:
        ...
        fields (MutableSequence[str]):
            ...
            explore.
        filters (MutableSequence[google.cloud.geminidataanalytics_v1.types.LookerQuery.Filter]):
...
class AnalysisOptions(proto.Message):
    ...
    Attributes:
        python (google.cloud.geminidataanalytics_v1.types.AnalysisOptions.Python):
...
class Citation(proto.Message):
    ...
    Attributes:
        sources (MutableSequence[google.cloud.geminidataanalytics_v1.types.CitationSource]):
            Output only. List of the sources being cited.
        anchors (MutableSequence[google.cloud.geminidataanalytics_v1.types.CitationAnchor]):
...
class CitationAnchor(proto.Message):
    ...
    Attributes:
        text_message_anchor (google.cloud.geminidataanalytics_v1.types.CitationAnchor.TextMessageCitationAnchor):

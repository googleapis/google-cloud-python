...
class ListDataAgentsResponse(proto.Message):
    ...
    Attributes:
        data_agents (MutableSequence[google.cloud.geminidataanalytics_v1.types.DataAgent]):
...
class ListAccessibleDataAgentsRequest(proto.Message):
    ...
    Attributes:
        ...
        show_deleted (bool):
            ...
            include soft-deleted DataAgents. Defaults to
            false.
        creator_filter (google.cloud.geminidataanalytics_v1.types.ListAccessibleDataAgentsRequest.CreatorFilter):
...
class CreateDataAgentRequest(proto.Message):
    ...
    Attributes:
        ...
        data_agent (google.cloud.geminidataanalytics_v1.types.DataAgent):

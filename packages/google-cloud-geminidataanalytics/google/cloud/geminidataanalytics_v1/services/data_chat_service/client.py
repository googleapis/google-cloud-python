...
from google.cloud.geminidataanalytics_v1.services.data_chat_service import pagers
...
class DataChatServiceClient(metaclass=DataChatServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = DataChatServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DataChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DataChatServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DataChatServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DataChatServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[DataChatServiceTransport], Callable[..., DataChatServiceTransport]
            ] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.geminidataanalytics_v1.DataChatServiceClient`.",
                    extra={
    ...
    def chat(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_chat():
                # Create a client
                client = geminidataanalytics_v1.DataChatServiceClient()

                # Initialize request argument(s)
                messages = geminidataanalytics_v1.Message()
                messages.user_message.text = "text_value"

                request = geminidataanalytics_v1.ChatRequest(
                    parent="parent_value",
                    messages=messages,
                )
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.ChatRequest, dict]):
        ...
        Returns:
            Iterable[google.cloud.geminidataanalytics_v1.types.Message]:
    ...
    def create_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.CreateConversationRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            conversation (google.cloud.geminidataanalytics_v1.types.Conversation):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_conversation():
                ...
                # Initialize request argument(s)
                request = geminidataanalytics_v1.DeleteConversationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.DeleteConversationRequest, dict]):
    ...
    def get_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.GetConversationRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_conversations():
                ...
                # Initialize request argument(s)
                request = geminidataanalytics_v1.ListConversationsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.ListConversationsRequest, dict]):
        ...
        Returns:
            google.cloud.geminidataanalytics_v1.services.data_chat_service.pagers.ListConversationsPager:
    ...
    def list_messages(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.ListMessagesRequest, dict]):
        ...
        Returns:
            google.cloud.geminidataanalytics_v1.services.data_chat_service.pagers.ListMessagesPager:

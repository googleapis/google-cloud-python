...
class DataChatServiceClient(metaclass=DataChatServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=DataChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def update_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1.types.UpdateConversationRequest, dict]):

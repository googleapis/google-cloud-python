    ...
    class _BaseCreateDataAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/dataAgents",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseCreateDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/dataAgents:createSync",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseDeleteDataAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/dataAgents/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/dataAgents/*}:deleteSync",
                },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseListAccessibleDataAgents:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*}/dataAgents:listAccessible",
                },
            ]
            return http_options
    ...
    class _BaseUpdateDataAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{data_agent.name=projects/*/locations/*/dataAgents/*}",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseUpdateDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{data_agent.name=projects/*/locations/*/dataAgents/*}:updateSync",
                    "body": "data_agent",
                },
            ]
            return http_options

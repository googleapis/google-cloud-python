...
class DatasourceReferences(proto.Message):
    ...
    Attributes:
        ...
        looker (google.cloud.geminidataanalytics_v1beta.types.LookerExploreReferences):
            ...
            This field is a member of `oneof`_ ``references``.
        alloydb (google.cloud.geminidataanalytics_v1beta.types.AlloyDbReference):
            Reference to an AlloyDB database. Only supported for the
            ``QueryData`` method.

            This field is a member of `oneof`_ ``references``.
        spanner_reference (google.cloud.geminidataanalytics_v1beta.types.SpannerReference):
            Reference to a Spanner database. Only supported for the
            ``QueryData`` method.

            This field is a member of `oneof`_ ``references``.
        cloud_sql_reference (google.cloud.geminidataanalytics_v1beta.types.CloudSqlReference):
            Reference to a CloudSql database. Only supported for the
            ``QueryData`` method.

            This field is a member of `oneof`_ ``references``.
        bigtable_reference (google.cloud.geminidataanalytics_v1beta.types.BigtableReference):
            Reference to a Bigtable instance.

            This field is a member of `oneof`_ ``references``.
        firestore_reference (google.cloud.geminidataanalytics_v1beta.types.FirestoreReference):
...
class AlloyDbReference(proto.Message):
    ...
    Attributes:
        database_reference (google.cloud.geminidataanalytics_v1beta.types.AlloyDbDatabaseReference):
...
class BigtableReference(proto.Message):
    ...
    Attributes:
        database_reference (google.cloud.geminidataanalytics_v1beta.types.BigtableDatabaseReference):
            Required. Singular proto that supports
            specifying which database and tables to include.
        agent_context_reference (google.cloud.geminidataanalytics_v1beta.types.AgentContextReference):
            Optional. Parameters for retrieving data from
...
class FirestoreReference(proto.Message):
    ...
    Attributes:
        database_reference (google.cloud.geminidataanalytics_v1beta.types.FirestoreDatabaseReference):
            Required. Singular proto that supports
            specifying which database and tables to include.
        agent_context_reference (google.cloud.geminidataanalytics_v1beta.types.AgentContextReference):
            Optional. Parameters for retrieving data from
...
class SpannerReference(proto.Message):
    ...
    Attributes:
        database_reference (google.cloud.geminidataanalytics_v1beta.types.SpannerDatabaseReference):
            Required. Singular proto that supports
            specifying which database and tables to include.
        agent_context_reference (google.cloud.geminidataanalytics_v1beta.types.AgentContextReference):
            Optional. Parameters for retrieving data from
...
class SpannerDatabaseReference(proto.Message):
    ...
    Attributes:
        engine (google.cloud.geminidataanalytics_v1beta.types.SpannerDatabaseReference.Engine):
...
class CloudSqlReference(proto.Message):
    ...
    Attributes:
        database_reference (google.cloud.geminidataanalytics_v1beta.types.CloudSqlDatabaseReference):
            Required. Singular proto that supports
            specifying which database and tables to include.
        agent_context_reference (google.cloud.geminidataanalytics_v1beta.types.AgentContextReference):
            Optional. Parameters for retrieving data from
...
class CloudSqlDatabaseReference(proto.Message):
    ...
    Attributes:
        engine (google.cloud.geminidataanalytics_v1beta.types.CloudSqlDatabaseReference.Engine):
...
class Datasource(proto.Message):
    ...
    Attributes:
        ...
        looker_explore_reference (google.cloud.geminidataanalytics_v1beta.types.LookerExploreReference):
            ...
            This field is a member of `oneof`_ ``reference``.
        alloy_db_reference (google.cloud.geminidataanalytics_v1beta.types.AlloyDbReference):

...
class RetrieveBigQueryTableContextResponse(proto.Message):
    ...
    Attributes:
        candidates (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.RetrieveBigQueryTableContextResponse.Candidate]):
            List of retrieved candidates with their
            bundled metadata.
        table_candidates (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.TableCandidate]):
            List of retrieved candidates with their
            bundled metadata.
    """
...
class RetrieveBigQueryTableContextsRequest(proto.Message):
    ...
    Attributes:
        ...
        query (str):
            Optional. User query in natural language.
        direct_lookups (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.DirectLookup]):
            Optional. A list of direct lookup parameters.
    """
...
class RetrieveBigQueryTableSuggestedExamplesResponse(proto.Message):
    ...
    Attributes:
        example_suggestions (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.RetrieveBigQueryTableSuggestedExamplesResponse.ExampleSuggestion]):
...
class DirectLookup(proto.Message):
    ...
    Attributes:
        big_query_table_reference (google.cloud.geminidataanalytics_v1beta.types.BigQueryTableReference):
...
class TableCandidate(proto.Message):
    ...
    Attributes:
        ...
        field_suggestions (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.TableCandidate.FieldSuggestion]):
    ...
    class FieldSuggestion(proto.Message):
        ...
        Attributes:
            ...
            suggested_description (str):
                ...
                were requested.
            nested (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.TableCandidate.FieldSuggestion]):

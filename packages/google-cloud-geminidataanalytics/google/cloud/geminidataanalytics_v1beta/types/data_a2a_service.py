...
class SendMessageConfiguration(proto.Message):
    ...
    Attributes:
        ...
        push_notification (google.cloud.geminidataanalytics_v1beta.types.PushNotificationConfig):
...
class A2ATask(proto.Message):
    ...
    Attributes:
        ...
        status (google.cloud.geminidataanalytics_v1beta.types.TaskStatus):
            Optional. The current status of a Task,
            including state and a message.
        artifacts (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.A2AArtifact]):
            Optional. A set of output artifacts for a
            Task.
        history (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.A2AMessage]):
...
class TaskStatus(proto.Message):
    ...
    Attributes:
        state (google.cloud.geminidataanalytics_v1beta.types.TaskState):
            Output only. The current state of this task.
        update (google.cloud.geminidataanalytics_v1beta.types.A2AMessage):
...
class Part(proto.Message):
    ...
    Attributes:
        ...
        file (google.cloud.geminidataanalytics_v1beta.types.FilePart):
            File content payload.

            This field is a member of `oneof`_ ``part``.
        data (google.cloud.geminidataanalytics_v1beta.types.DataPart):
...
class A2AMessage(proto.Message):
    ...
    Attributes:
        ...
        role (google.cloud.geminidataanalytics_v1beta.types.Role):
            Optional. A role for the message.
        content (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.Part]):
...
class A2AArtifact(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            artifact, optional.
        parts (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.Part]):
...
class TaskArtifactUpdateEvent(proto.Message):
    ...
    Attributes:
        ...
        context_id (str):
            ...
            task belongs to.
        artifact (google.cloud.geminidataanalytics_v1beta.types.A2AArtifact):
...
class PushNotificationConfig(proto.Message):
    ...
    Attributes:
        ...
        authentication (google.cloud.geminidataanalytics_v1beta.types.AuthenticationInfo):
...
class AgentCard(proto.Message):
    ...
    Attributes:
        ...
        additional_interfaces (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.AgentInterface]):
            Optional. Announcement of additional
            supported transports.
        provider (google.cloud.geminidataanalytics_v1beta.types.AgentProvider):
        ...
        capabilities (google.cloud.geminidataanalytics_v1beta.types.AgentCapabilities):
            Optional. A2A Capability set supported by the
            agent.
        security_schemes (MutableMapping[str, google.cloud.geminidataanalytics_v1beta.types.SecurityScheme]):
            The security scheme details used for
            authenticating with this agent.
        security (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.Security]):
        ...
        default_output_modes (MutableSequence[str]):
            ...
            from this agent.
        skills (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.AgentSkill]):
        ...
        supports_authenticated_extended_card (bool):
            ...
            is authenticated.
        signatures (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.AgentCardSignature]):
...
class AgentCapabilities(proto.Message):
    ...
    Attributes:
        ...
        extensions (MutableSequence[google.cloud.geminidataanalytics_v1beta.types.AgentExtension]):
...
class Security(proto.Message):
    ...
    Attributes:
        schemes (MutableMapping[str, google.cloud.geminidataanalytics_v1beta.types.StringList]):
...
class SecurityScheme(proto.Message):
    ...
    Attributes:
        api_key_security_scheme (google.cloud.geminidataanalytics_v1beta.types.APIKeySecurityScheme):
            API key security scheme.

            This field is a member of `oneof`_ ``scheme``.
        http_auth_security_scheme (google.cloud.geminidataanalytics_v1beta.types.HTTPAuthSecurityScheme):
            HTTP authentication security scheme.

            This field is a member of `oneof`_ ``scheme``.
        oauth2_security_scheme (google.cloud.geminidataanalytics_v1beta.types.OAuth2SecurityScheme):
            OAuth2 security scheme.

            This field is a member of `oneof`_ ``scheme``.
        open_id_connect_security_scheme (google.cloud.geminidataanalytics_v1beta.types.OpenIdConnectSecurityScheme):
            OpenID Connect security scheme.

            This field is a member of `oneof`_ ``scheme``.
        mtls_security_scheme (google.cloud.geminidataanalytics_v1beta.types.MutualTlsSecurityScheme):
...
class OAuth2SecurityScheme(proto.Message):
    ...
    Attributes:
        description (str):
            Optional. Description of this security
            scheme.
        flows (google.cloud.geminidataanalytics_v1beta.types.OAuthFlows):
...
class OAuthFlows(proto.Message):
    ...
    Attributes:
        authorization_code (google.cloud.geminidataanalytics_v1beta.types.AuthorizationCodeOAuthFlow):
            Authorization code flow.

            This field is a member of `oneof`_ ``flow``.
        client_credentials (google.cloud.geminidataanalytics_v1beta.types.ClientCredentialsOAuthFlow):
            Client credentials flow.

            This field is a member of `oneof`_ ``flow``.
        implicit (google.cloud.geminidataanalytics_v1beta.types.ImplicitOAuthFlow):
            Implicit flow.

            This field is a member of `oneof`_ ``flow``.
        password (google.cloud.geminidataanalytics_v1beta.types.PasswordOAuthFlow):
...
class SendMessageRequest(proto.Message):
    ...
    Attributes:
        ...
        configuration (google.cloud.geminidataanalytics_v1beta.types.SendMessageConfiguration):
...
class SendMessageResponse(proto.Message):
    ...
    Attributes:
        task (google.cloud.geminidataanalytics_v1beta.types.A2ATask):
            Completed task.

            This field is a member of `oneof`_ ``payload``.
        msg (google.cloud.geminidataanalytics_v1beta.types.A2AMessage):
...
class StreamResponse(proto.Message):
    ...
    Attributes:
        ...
        msg (google.cloud.geminidataanalytics_v1beta.types.A2AMessage):
            ...
            This field is a member of `oneof`_ ``payload``.
        status_update (google.cloud.geminidataanalytics_v1beta.types.TaskStatusUpdateEvent):
            Task status update event.

            This field is a member of `oneof`_ ``payload``.
        artifact_update (google.cloud.geminidataanalytics_v1beta.types.TaskArtifactUpdateEvent):

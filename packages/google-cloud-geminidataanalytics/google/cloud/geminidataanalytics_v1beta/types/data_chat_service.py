...
class QueryDataContext(proto.Message):
    ...
    Attributes:
        datasource_references (google.cloud.geminidataanalytics_v1beta.types.DatasourceReferences):
            ...
            for the query.
        parameterized_secure_view_parameters (google.cloud.geminidataanalytics_v1beta.types.ParameterizedSecureViewParameters):
            Optional. Parameters for Parameterized Secure
            Views (PSV).
    """
    ...
    parameterized_secure_view_parameters: "ParameterizedSecureViewParameters" = (
        proto.Field(
            proto.MESSAGE,
            number=2,
...
class ParameterizedSecureViewParameters(proto.Message):
    r"""Parameters for Parameterized Secure Views (PSV). These
...
class ChatRequest(proto.Message):
    ...
    class ThinkingMode(proto.Enum):
        r"""Mode of thinking for the agent.

    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomContextRetrievalServiceInterceptor(ContextRetrievalServiceRestInterceptor):
            ...
            def pre_retrieve_big_query_table_context(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_retrieve_big_query_table_context(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def pre_retrieve_big_query_table_context(
        self,
        ...
        """Pre-rpc interceptor for retrieve_big_query_table_context
    ...
    def post_retrieve_big_query_table_context(
        self, response: context_retrieval_service.RetrieveBigQueryTableContextResponse
    ) -> context_retrieval_service.RetrieveBigQueryTableContextResponse:
        """Post-rpc interceptor for retrieve_big_query_table_context

        DEPRECATED. Please use the `post_retrieve_big_query_table_context_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ContextRetrievalService server but before
        it is returned to user code. This `post_retrieve_big_query_table_context` interceptor runs
        before the `post_retrieve_big_query_table_context_with_metadata` interceptor.
        """
        return response

    def post_retrieve_big_query_table_context_with_metadata(
        self,
        ...
        We recommend only using this `post_retrieve_big_query_table_context_with_metadata`
        interceptor in new development instead of the `post_retrieve_big_query_table_context` interceptor.
        When both interceptors are used, this `post_retrieve_big_query_table_context_with_metadata` interceptor runs after the
        `post_retrieve_big_query_table_context` interceptor. The (possibly modified) response returned by
        `post_retrieve_big_query_table_context` will be passed to
...
class ContextRetrievalServiceRestTransport(_BaseContextRetrievalServiceRestTransport):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.RetrieveBigQueryRecentRelevantTables",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.retrieve_big_query_recent_relevant_tables",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryRecentRelevantTables",
    ...
    class _RetrieveBigQueryTableContext(
        _BaseContextRetrievalServiceRestTransport._BaseRetrieveBigQueryTableContext,
        ContextRetrievalServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "ContextRetrievalServiceRestTransport.RetrieveBigQueryTableContext"
            )
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseContextRetrievalServiceRestTransport._BaseRetrieveBigQueryTableContext._get_http_options()
            )

            request, metadata = self._interceptor.pre_retrieve_big_query_table_context(
                request, metadata
            )
            transcoded_request = _BaseContextRetrievalServiceRestTransport._BaseRetrieveBigQueryTableContext._get_transcoded_request(
                http_options, request
            )

            body = _BaseContextRetrievalServiceRestTransport._BaseRetrieveBigQueryTableContext._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseContextRetrievalServiceRestTransport._BaseRetrieveBigQueryTableContext._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.RetrieveBigQueryTableContext",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryTableContext",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = ContextRetrievalServiceRestTransport._RetrieveBigQueryTableContext._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = context_retrieval_service.RetrieveBigQueryTableContextResponse()
            pb_resp = context_retrieval_service.RetrieveBigQueryTableContextResponse.pb(
                resp
            )

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_retrieve_big_query_table_context(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            (
                resp,
                _,
            ) = self._interceptor.post_retrieve_big_query_table_context_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = context_retrieval_service.RetrieveBigQueryTableContextResponse.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.retrieve_big_query_table_context",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryTableContext",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.RetrieveBigQueryTableContexts",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.retrieve_big_query_table_contexts",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryTableContexts",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.RetrieveBigQueryTableContextsFromRecentTables",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.retrieve_big_query_table_contexts_from_recent_tables",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryTableContextsFromRecentTables",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.RetrieveBigQueryTableSuggestedDescriptions",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.retrieve_big_query_table_suggested_descriptions",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryTableSuggestedDescriptions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.RetrieveBigQueryTableSuggestedExamples",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.retrieve_big_query_table_suggested_examples",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "RetrieveBigQueryTableSuggestedExamples",
                        "metadata": http_response["headers"],
    ...
    def retrieve_big_query_table_context(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._RetrieveBigQueryTableContext(self._session, self._host, self._interceptor)  # type: ignore
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.ContextRetrievalServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.ContextRetrievalService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

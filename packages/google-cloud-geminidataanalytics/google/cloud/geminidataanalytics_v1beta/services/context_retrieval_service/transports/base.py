...
class ContextRetrievalServiceTransport(abc.ABC):
    """Abstract transport class for ContextRetrievalService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.retrieve_big_query_recent_relevant_tables: gapic_v1.method.wrap_method(
...
__all__ = ("ContextRetrievalServiceTransport",)

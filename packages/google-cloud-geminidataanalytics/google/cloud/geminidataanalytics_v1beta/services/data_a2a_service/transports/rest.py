        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.GetAgentCard",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.get_agent_card",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "GetAgentCard",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.SendMessage",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "SendMessage",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.send_message",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "SendMessage",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.SendStreamingMessage",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.send_streaming_message",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "SendStreamingMessage",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataA2AServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataA2AServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataA2AService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

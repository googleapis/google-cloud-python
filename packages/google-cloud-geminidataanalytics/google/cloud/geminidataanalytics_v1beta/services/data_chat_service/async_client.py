...
class DataChatServiceAsyncClient:
    ...
    parse_conversation_path = staticmethod(DataChatServiceClient.parse_conversation_path)
    ...
    common_billing_account_path = staticmethod(DataChatServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(DataChatServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(DataChatServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(DataChatServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(DataChatServiceClient.common_organization_path)
    ...
    parse_common_project_path = staticmethod(DataChatServiceClient.parse_common_project_path)
    common_location_path = staticmethod(DataChatServiceClient.common_location_path)
    parse_common_location_path = staticmethod(DataChatServiceClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DataChatServiceTransport, Callable[..., DataChatServiceTransport]]] = "grpc_asyncio",

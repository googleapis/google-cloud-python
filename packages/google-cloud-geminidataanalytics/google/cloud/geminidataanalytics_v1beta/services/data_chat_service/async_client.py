...
class DataChatServiceAsyncClient:
    ...
    _client: DataChatServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = DataChatServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = DataChatServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = DataChatServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = DataChatServiceClient._DEFAULT_UNIVERSE

    conversation_path = staticmethod(DataChatServiceClient.conversation_path)
    ...
    common_billing_account_path = staticmethod(
        DataChatServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        DataChatServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(DataChatServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        DataChatServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        DataChatServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        DataChatServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(DataChatServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        DataChatServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(DataChatServiceClient.common_location_path)
    parse_common_location_path = staticmethod(
        DataChatServiceClient.parse_common_location_path
    )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return DataChatServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> DataChatServiceTransport:
        ...
        Returns:
            DataChatServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = DataChatServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, DataChatServiceTransport, Callable[..., DataChatServiceTransport]
            ]
        ] = "grpc_asyncio",
        client_options: Optional[ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the data chat service async client.
        ...
        """
        self._client = DataChatServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.geminidataanalytics_v1beta.DataChatServiceAsyncClient`.",
                extra={
    ...
    def chat(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.ChatRequest, dict]]):
        ...
        Returns:
            AsyncIterable[google.cloud.geminidataanalytics_v1beta.types.Message]:
    ...
    async def create_conversation(
        self,
        request: Optional[
            Union[gcg_conversation.CreateConversationRequest, dict]
        ] = None,
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.CreateConversationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            conversation (:class:`google.cloud.geminidataanalytics_v1beta.types.Conversation`):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_conversation():
                ...
                # Initialize request argument(s)
                request = geminidataanalytics_v1beta.DeleteConversationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.DeleteConversationRequest, dict]]):
    ...
    async def update_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.UpdateConversationRequest, dict]]):
    ...
    async def get_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.GetConversationRequest, dict]]):
    ...
    async def list_conversations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.ListConversationsRequest, dict]]):
        ...
        Returns:
            google.cloud.geminidataanalytics_v1beta.services.data_chat_service.pagers.ListConversationsAsyncPager:
    ...
    async def list_messages(
        ...
        *,
        ...
        Returns:
            google.cloud.geminidataanalytics_v1beta.services.data_chat_service.pagers.ListMessagesAsyncPager:
    ...
    async def query_data(
        self,
        request: Optional[Union[data_chat_service.QueryDataRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> data_chat_service.QueryDataResponse:
        r"""Queries data from a natural language user query.
        ...
        .. code-block:: python
            ...
            async def sample_query_data():
                ...
                # Initialize request argument(s)
                request = geminidataanalytics_v1beta.QueryDataRequest(
                    parent="parent_value",
                    prompt="prompt_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.geminidataanalytics_v1beta.types.QueryDataRequest, dict]]):
                The request object. Request to query data from a natural
                language query.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.geminidataanalytics_v1beta.types.QueryDataResponse:
                Response containing the generated
                query and related information.

        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, data_chat_service.QueryDataRequest):
            request = data_chat_service.QueryDataRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.query_data
        ]
    ...
    async def __aenter__(self) -> "DataChatServiceAsyncClient":
        return self
...
__all__ = ("DataChatServiceAsyncClient",)

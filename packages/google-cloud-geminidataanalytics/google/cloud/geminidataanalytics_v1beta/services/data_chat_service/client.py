...
class DataChatServiceClient(metaclass=DataChatServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.geminidataanalytics_v1beta.DataChatServiceClient`.",
                    extra={
    ...
    def chat(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.ChatRequest, dict]):
        ...
        Returns:
            Iterable[google.cloud.geminidataanalytics_v1beta.types.Message]:
    ...
    def create_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.CreateConversationRequest, dict]):
    ...
    def delete_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.DeleteConversationRequest, dict]):
    ...
    def update_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.UpdateConversationRequest, dict]):
    ...
    def get_conversation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.GetConversationRequest, dict]):
    ...
    def list_conversations(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.ListConversationsRequest, dict]):
        ...
        Returns:
            google.cloud.geminidataanalytics_v1beta.services.data_chat_service.pagers.ListConversationsPager:
    ...
    def list_messages(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.ListMessagesRequest, dict]):
        ...
        Returns:
            google.cloud.geminidataanalytics_v1beta.services.data_chat_service.pagers.ListMessagesPager:
    ...
    def query_data(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.geminidataanalytics_v1beta.types.QueryDataRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_data]

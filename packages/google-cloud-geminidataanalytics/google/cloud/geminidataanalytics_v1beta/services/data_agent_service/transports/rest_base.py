    ...
    class _BaseCreateDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{parent=projects/*/locations/*}/dataAgents:createSync",
                    "body": "data_agent",
                },
            ]
            return http_options
    ...
    class _BaseDeleteDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta/{name=projects/*/locations/*/dataAgents/*}:deleteSync",
                },
            ]
            return http_options
    ...
    class _BaseUpdateDataAgentSync:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta/{data_agent.name=projects/*/locations/*/dataAgents/*}:updateSync",
                    "body": "data_agent",
                },
            ]
            return http_options

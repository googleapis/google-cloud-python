        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataAgentServiceClient.RetrieveAgentOpsObservability",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataAgentService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataAgentServiceClient.retrieve_agent_ops_observability",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataAgentService",
                        "rpcName": "RetrieveAgentOpsObservability",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.geminidataanalytics_v1beta.DataAgentServiceClient.SetAgentOpsObservability",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataAgentService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.geminidataanalytics_v1beta.DataAgentServiceClient.set_agent_ops_observability",
                    extra={
                        "serviceName": "google.cloud.geminidataanalytics.v1beta.DataAgentService",
                        "rpcName": "SetAgentOpsObservability",
                        "metadata": http_response["headers"],

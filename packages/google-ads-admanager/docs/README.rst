Python Client for Google Ad Manager API
=======================================

|preview| |pypi| |versions|

`Google Ad Manager API`_: Manage your Ad Manager inventory, run reports and more.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-ads-admanager.svg
   :target: https://pypi.org/project/google-ads-admanager/
.. _Google Ad Manager API: https://developers.google.com/ad-manager/api/beta
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/admanager/latest
...
3. `Enable the Google Ad Manager API.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Google Ad Manager API.:  https://developers.google.com/ad-manager/api/beta
...
-  Read the `Client Library Documentation`_ for Google Ad Manager API
   to see other available methods on the client.
-  Read the `Google Ad Manager API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Google Ad Manager API Product documentation:  https://developers.google.com/ad-manager/api/beta

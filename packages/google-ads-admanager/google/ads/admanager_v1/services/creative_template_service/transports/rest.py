...
class CreativeTemplateServiceRestInterceptor:
    """Interceptor for CreativeTemplateService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CreativeTemplateServiceRestTransport.

    .. code-block:: python
        class MyCustomCreativeTemplateServiceInterceptor(CreativeTemplateServiceRestInterceptor):
            def pre_get_creative_template(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_creative_template(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_creative_templates(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_creative_templates(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = CreativeTemplateServiceRestTransport(interceptor=MyCustomCreativeTemplateServiceInterceptor())
    ...
    def pre_get_creative_template(
        ...
        before they are sent to the CreativeTemplateService server.
        """
        return request, metadata
    ...
    def post_get_creative_template(
        ...
        after it is returned by the CreativeTemplateService server but before
        it is returned to user code. This `post_get_creative_template` interceptor runs
        before the `post_get_creative_template_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_creative_template_with_metadata(
        ...
        is returned by the CreativeTemplateService server but before it is returned to user code.

        We recommend only using this `post_get_creative_template_with_metadata`
        interceptor in new development instead of the `post_get_creative_template` interceptor.
        When both interceptors are used, this `post_get_creative_template_with_metadata` interceptor runs after the
        `post_get_creative_template` interceptor. The (possibly modified) response returned by
        `post_get_creative_template` will be passed to
    ...
    def post_list_creative_templates(
        self, response: creative_template_service.ListCreativeTemplatesResponse
    ) -> creative_template_service.ListCreativeTemplatesResponse:
        """Post-rpc interceptor for list_creative_templates

        DEPRECATED. Please use the `post_list_creative_templates_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the CreativeTemplateService server but before
        it is returned to user code. This `post_list_creative_templates` interceptor runs
        before the `post_list_creative_templates_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_creative_templates_with_metadata(
        ...
        We recommend only using this `post_list_creative_templates_with_metadata`
        interceptor in new development instead of the `post_list_creative_templates` interceptor.
        When both interceptors are used, this `post_list_creative_templates_with_metadata` interceptor runs after the
        `post_list_creative_templates` interceptor. The (possibly modified) response returned by
        `post_list_creative_templates` will be passed to
...
class CreativeTemplateServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CreativeTemplateServiceRestInterceptor


class CreativeTemplateServiceRestTransport(_BaseCreativeTemplateServiceRestTransport):
    """REST backend synchronous transport for CreativeTemplateService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[CreativeTemplateServiceRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[CreativeTemplateServiceRestInterceptor]): Interceptor used
    ...
    class _GetCreativeTemplate(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get creative template method over HTTP.

            Args:
                request (~.creative_template_service.GetCreativeTemplateRequest):
                    The request object. Request object for ``GetCreativeTemplate`` method.
            ...
            Returns:
                ~.creative_template_messages.CreativeTemplate:
                    A template that can be used to create a
                [TemplateCreative][].
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.CreativeTemplateServiceClient.GetCreativeTemplate",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
                        "rpcName": "GetCreativeTemplate",
            ...
            # Return the response
            resp = creative_template_messages.CreativeTemplate()
            pb_resp = creative_template_messages.CreativeTemplate.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.CreativeTemplateServiceClient.get_creative_template",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
                        "rpcName": "GetCreativeTemplate",
    ...
    class _ListCreativeTemplates(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list creative templates method over HTTP.

            Args:
                request (~.creative_template_service.ListCreativeTemplatesRequest):
                    The request object. Request object for ``ListCreativeTemplates`` method.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
                metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
            ...
            Returns:
                ~.creative_template_service.ListCreativeTemplatesResponse:
                    Response object for ``ListCreativeTemplatesRequest``
                containing matching ``CreativeTemplate`` objects.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.CreativeTemplateServiceClient.ListCreativeTemplates",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
                        "rpcName": "ListCreativeTemplates",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = creative_template_service.ListCreativeTemplatesResponse()
            pb_resp = creative_template_service.ListCreativeTemplatesResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.CreativeTemplateServiceClient.list_creative_templates",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
                        "rpcName": "ListCreativeTemplates",
                        "metadata": http_response["headers"],
    ...
    class _CancelOperation(
        ...
        def __hash__(self):
            return hash("CreativeTemplateServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.CreativeTemplateServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
            ...
            # Send the request
            response = (
                CreativeTemplateServiceRestTransport._CancelOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.CreativeTemplateServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.CreativeTemplateServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.CreativeTemplateService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
...
__all__ = ("CreativeTemplateServiceRestTransport",)

...
class LiveStreamServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_live_stream: gapic_v1.method.wrap_method(
                self.get_live_stream,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_live_streams: gapic_v1.method.wrap_method(
                self.list_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_live_stream: gapic_v1.method.wrap_method(
                self.create_live_stream,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_live_streams: gapic_v1.method.wrap_method(
                self.batch_create_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_live_stream: gapic_v1.method.wrap_method(
                self.update_live_stream,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_live_streams: gapic_v1.method.wrap_method(
                self.batch_update_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_activate_live_streams: gapic_v1.method.wrap_method(
                self.batch_activate_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_pause_live_streams: gapic_v1.method.wrap_method(
                self.batch_pause_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_archive_live_streams: gapic_v1.method.wrap_method(
                self.batch_archive_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_pause_ads_live_streams: gapic_v1.method.wrap_method(
                self.batch_pause_ads_live_streams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_refresh_master_playlists: gapic_v1.method.wrap_method(
                self.batch_refresh_master_playlists,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_live_stream(
        ...
        Union[
            live_stream_messages.LiveStream, Awaitable[live_stream_messages.LiveStream]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.ListLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_create_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchCreateLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_update_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchUpdateLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_activate_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchActivateLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_pause_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchPauseLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_archive_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchArchiveLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_pause_ads_live_streams(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchPauseAdsLiveStreamsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_refresh_master_playlists(
        ...
        Union[
            ...
            Awaitable[live_stream_service.BatchRefreshMasterPlaylistsResponse],
        ],
    ]:
        raise NotImplementedError()

...
class CreativeServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[creative_service.GetCreativeRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_creative(
        self, response: creative_service.Creative
    ...
    def pre_list_creatives(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[creative_service.ListCreativesRequest, Sequence[Tuple[str, str]]]:
...
class CreativeServiceRestTransport(CreativeServiceTransport):
    """REST backend transport for CreativeService.
    ...
    class _GetCreative(CreativeServiceRestStub):
        def __hash__(self):
            return hash("GetCreative")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=networks/*/creatives/*}",
                },
            ]
            request, metadata = self._interceptor.pre_get_creative(request, metadata)
            pb_request = creative_service.GetCreativeRequest.pb(request)
            ...
            # Return the response
            resp = creative_service.Creative()
            pb_resp = creative_service.Creative.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_get_creative(resp)
            return resp

    class _ListCreatives(CreativeServiceRestStub):
        def __hash__(self):
            return hash("ListCreatives")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=networks/*}/creatives",
                },
            ]
            request, metadata = self._interceptor.pre_list_creatives(request, metadata)
            pb_request = creative_service.ListCreativesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    def get_creative(
        self,
    ) -> Callable[[creative_service.GetCreativeRequest], creative_service.Creative]:

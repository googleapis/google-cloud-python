...
class PrivateAuctionServiceTransport(abc.ABC):
    """Abstract transport class for PrivateAuctionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_private_auction: gapic_v1.method.wrap_method(
                self.get_private_auction,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_private_auctions: gapic_v1.method.wrap_method(
                self.list_private_auctions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_private_auction: gapic_v1.method.wrap_method(
                self.create_private_auction,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_private_auction: gapic_v1.method.wrap_method(
                self.update_private_auction,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = ("PrivateAuctionServiceTransport",)

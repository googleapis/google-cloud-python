...
class DaiAuthenticationKeyServiceTransport(abc.ABC):
    """Abstract transport class for DaiAuthenticationKeyService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_dai_authentication_key: gapic_v1.method.wrap_method(
                self.get_dai_authentication_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_dai_authentication_keys: gapic_v1.method.wrap_method(
                self.list_dai_authentication_keys,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_dai_authentication_key: gapic_v1.method.wrap_method(
                self.create_dai_authentication_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_dai_authentication_keys: gapic_v1.method.wrap_method(
                self.batch_create_dai_authentication_keys,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_dai_authentication_key: gapic_v1.method.wrap_method(
                self.update_dai_authentication_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_dai_authentication_keys: gapic_v1.method.wrap_method(
                self.batch_update_dai_authentication_keys,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_activate_dai_authentication_keys: gapic_v1.method.wrap_method(
                self.batch_activate_dai_authentication_keys,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_deactivate_dai_authentication_keys: gapic_v1.method.wrap_method(
                self.batch_deactivate_dai_authentication_keys,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_dai_authentication_key(
        ...
        Union[
            ...
            Awaitable[dai_authentication_key_messages.DaiAuthenticationKey],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_dai_authentication_keys(
        ...
        Union[
            ...
            Awaitable[dai_authentication_key_service.ListDaiAuthenticationKeysResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("DaiAuthenticationKeyServiceTransport",)

...
class MobileCarrierServiceRestInterceptor:
    """Interceptor for MobileCarrierService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the MobileCarrierServiceRestTransport.

    .. code-block:: python
        class MyCustomMobileCarrierServiceInterceptor(MobileCarrierServiceRestInterceptor):
            def pre_get_mobile_carrier(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_mobile_carrier(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_mobile_carriers(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_mobile_carriers(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = MobileCarrierServiceRestTransport(interceptor=MyCustomMobileCarrierServiceInterceptor())
    ...
    def post_get_mobile_carrier(
        ...
        after it is returned by the MobileCarrierService server but before
        it is returned to user code. This `post_get_mobile_carrier` interceptor runs
        before the `post_get_mobile_carrier_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_mobile_carrier_with_metadata(
        ...
        is returned by the MobileCarrierService server but before it is returned to user code.

        We recommend only using this `post_get_mobile_carrier_with_metadata`
        interceptor in new development instead of the `post_get_mobile_carrier` interceptor.
        When both interceptors are used, this `post_get_mobile_carrier_with_metadata` interceptor runs after the
        `post_get_mobile_carrier` interceptor. The (possibly modified) response returned by
        `post_get_mobile_carrier` will be passed to
    ...
    def post_list_mobile_carriers(
        self, response: mobile_carrier_service.ListMobileCarriersResponse
    ) -> mobile_carrier_service.ListMobileCarriersResponse:
        """Post-rpc interceptor for list_mobile_carriers

        DEPRECATED. Please use the `post_list_mobile_carriers_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MobileCarrierService server but before
        it is returned to user code. This `post_list_mobile_carriers` interceptor runs
        before the `post_list_mobile_carriers_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_mobile_carriers_with_metadata(
        ...
        We recommend only using this `post_list_mobile_carriers_with_metadata`
        interceptor in new development instead of the `post_list_mobile_carriers` interceptor.
        When both interceptors are used, this `post_list_mobile_carriers_with_metadata` interceptor runs after the
        `post_list_mobile_carriers` interceptor. The (possibly modified) response returned by
        `post_list_mobile_carriers` will be passed to
...
class MobileCarrierServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: MobileCarrierServiceRestInterceptor


class MobileCarrierServiceRestTransport(_BaseMobileCarrierServiceRestTransport):
    """REST backend synchronous transport for MobileCarrierService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[MobileCarrierServiceRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[MobileCarrierServiceRestInterceptor]): Interceptor used
    ...
    class _GetMobileCarrier(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get mobile carrier method over HTTP.

            Args:
                request (~.mobile_carrier_service.GetMobileCarrierRequest):
                    The request object. Request object for ``GetMobileCarrier`` method.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.MobileCarrierServiceClient.GetMobileCarrier",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
                        "rpcName": "GetMobileCarrier",
            ...
            # Return the response
            resp = mobile_carrier_messages.MobileCarrier()
            pb_resp = mobile_carrier_messages.MobileCarrier.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.MobileCarrierServiceClient.get_mobile_carrier",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
                        "rpcName": "GetMobileCarrier",
    ...
    class _ListMobileCarriers(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list mobile carriers method over HTTP.

            Args:
                request (~.mobile_carrier_service.ListMobileCarriersRequest):
                    The request object. Request object for ``ListMobileCarriers`` method.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
                metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
            ...
            Returns:
                ...
                containing matching ``MobileCarrier`` objects.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.MobileCarrierServiceClient.ListMobileCarriers",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
                        "rpcName": "ListMobileCarriers",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = mobile_carrier_service.ListMobileCarriersResponse()
            pb_resp = mobile_carrier_service.ListMobileCarriersResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.MobileCarrierServiceClient.list_mobile_carriers",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
                        "rpcName": "ListMobileCarriers",
                        "metadata": http_response["headers"],
    ...
    class _CancelOperation(
        ...
        def __hash__(self):
            return hash("MobileCarrierServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.MobileCarrierServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
            ...
            # Send the request
            response = MobileCarrierServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.MobileCarrierServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.MobileCarrierServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.MobileCarrierService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
...
__all__ = ("MobileCarrierServiceRestTransport",)

...
class OrderServiceClient(metaclass=OrderServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, OrderServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, OrderServiceTransport]): The
    ...
    def get_order(
        ...
        *,
        ...
        # in a order_service.GetOrderRequest.
    ...
    def list_orders(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a order_service.ListOrdersRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

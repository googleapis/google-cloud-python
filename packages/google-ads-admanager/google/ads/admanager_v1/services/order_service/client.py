...
from google.ads.admanager_v1.types import applied_label, custom_field_value, order_enums, order_messages, order_service
...
class OrderServiceClient(metaclass=OrderServiceClientMeta):
    ...
    def parse_custom_field_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^networks/(?P<network_code>.+?)/customFields/(?P<custom_field>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OrderServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, OrderServiceTransport, Callable[..., OrderServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OrderServiceClient._read_environment_variables()
        self._client_cert_source = OrderServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = OrderServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OrderServiceTransport], Callable[..., OrderServiceTransport]] = (

...
class OrderServiceTransport(abc.ABC):
    ...
    @property
    def get_order(self) -> Callable[[order_service.GetOrderRequest], Union[order_messages.Order, Awaitable[order_messages.Order]]]:
        raise NotImplementedError()

    @property
    def list_orders(
        self,
    ) -> Callable[[order_service.ListOrdersRequest], Union[order_service.ListOrdersResponse, Awaitable[order_service.ListOrdersResponse]]]:
        raise NotImplementedError()

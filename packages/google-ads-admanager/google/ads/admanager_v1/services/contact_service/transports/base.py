...
class ContactServiceTransport(abc.ABC):
    """Abstract transport class for ContactService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.batch_create_contacts: gapic_v1.method.wrap_method(
            ...
            self.batch_update_contacts: gapic_v1.method.wrap_method(
...
__all__ = ("ContactServiceTransport",)

...
class ContactServiceRestTransport(_BaseContactServiceRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[ContactServiceRestInterceptor]): Interceptor used
    ...
    class _CancelOperation(
        _BaseContactServiceRestTransport._BaseCancelOperation, ContactServiceRestStub
    ):
        def __hash__(self):
            return hash("ContactServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContactServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContactService",
            ...
            # Send the request
            response = ContactServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,

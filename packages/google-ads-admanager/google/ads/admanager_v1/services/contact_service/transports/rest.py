...
class ContactServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[contact_service.GetContactRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_contacts(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[contact_service.ListContactsRequest, Sequence[Tuple[str, str]]]:
...
class ContactServiceRestTransport(ContactServiceTransport):
    ...
    def get_contact(
        self,
    ) -> Callable[[contact_service.GetContactRequest], contact_service.Contact]:

...
from .transports.base import DEFAULT_CLIENT_INFO, ContactServiceTransport
...
class ContactServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ContactServiceTransport]]
...
class ContactServiceClient(metaclass=ContactServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ContactServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ContactServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ContactServiceTransport, Callable[..., ContactServiceTransport]]
        ] = None,
        ...
        self._client_cert_source = ContactServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ContactServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ContactServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.admanager_v1.ContactServiceClient`.",
                    extra={
    ...
    def create_contact(
        self,
        request: Optional[Union[contact_service.CreateContactRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        contact: Optional[contact_messages.Contact] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> contact_messages.Contact:
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.CreateContactRequest, dict]):
                The request object. Request object for ``CreateContact`` method.
            parent (str):
                Required. The parent resource where this ``Contact``
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, contact]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, contact_service.CreateContactRequest):
            request = contact_service.CreateContactRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def batch_create_contacts(
        self,
        request: Optional[
            Union[contact_service.BatchCreateContactsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[contact_service.CreateContactRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchCreateContactsRequest, dict]):
            ...
            requests (MutableSequence[google.ads.admanager_v1.types.CreateContactRequest]):
                Required. The ``Contact`` objects to create. A maximum
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, contact_service.BatchCreateContactsRequest):
            request = contact_service.BatchCreateContactsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_contacts]
    ...
    def update_contact(
        self,
        request: Optional[Union[contact_service.UpdateContactRequest, dict]] = None,
        *,
        contact: Optional[contact_messages.Contact] = None,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.UpdateContactRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [contact, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, contact_service.UpdateContactRequest):
            request = contact_service.UpdateContactRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if contact is not None:
                request.contact = contact
    ...
    def batch_update_contacts(
        self,
        request: Optional[
            Union[contact_service.BatchUpdateContactsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[contact_service.UpdateContactRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchUpdateContactsRequest, dict]):
            ...
            requests (MutableSequence[google.ads.admanager_v1.types.UpdateContactRequest]):
                Required. The ``Contact`` objects to update. A maximum
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, contact_service.BatchUpdateContactsRequest):
            request = contact_service.BatchUpdateContactsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_update_contacts]

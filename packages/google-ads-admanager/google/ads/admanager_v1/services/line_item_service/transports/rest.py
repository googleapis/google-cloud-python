...
class LineItemServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[line_item_service.GetLineItemRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_line_item(
        self, response: line_item_service.LineItem
    ...
    def pre_list_line_items(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[line_item_service.ListLineItemsRequest, Sequence[Tuple[str, str]]]:
...
class LineItemServiceRestTransport(LineItemServiceTransport):
    ...
    def get_line_item(
        self,
    ) -> Callable[[line_item_service.GetLineItemRequest], line_item_service.LineItem]:

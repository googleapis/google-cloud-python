...
from .base import DEFAULT_CLIENT_INFO, LineItemServiceTransport


class _BaseLineItemServiceRestTransport(LineItemServiceTransport):
    """Base REST backend transport for LineItemService.
    ...
    class _BaseGetLineItem:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=networks/*/lineItems/*}",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseLineItemServiceRestTransport._BaseGetLineItem._get_unset_required_fields(query_params))
    ...
    class _BaseListLineItems:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseLineItemServiceRestTransport._BaseListLineItems._get_unset_required_fields(query_params))

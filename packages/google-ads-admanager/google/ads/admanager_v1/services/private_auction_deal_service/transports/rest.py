...
class PrivateAuctionDealServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_private_auction_deal(
        self, response: private_auction_deal_messages.PrivateAuctionDeal
    ...
    def post_get_private_auction_deal(
        self, response: private_auction_deal_messages.PrivateAuctionDeal
    ) -> private_auction_deal_messages.PrivateAuctionDeal:
    ...
    def post_list_private_auction_deals(
        self, response: private_auction_deal_service.ListPrivateAuctionDealsResponse
    ...
    def post_update_private_auction_deal(
        self, response: private_auction_deal_messages.PrivateAuctionDeal
    ) -> private_auction_deal_messages.PrivateAuctionDeal:
...
class PrivateAuctionDealServiceRestTransport(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[PrivateAuctionDealServiceRestInterceptor]): Interceptor used
    ...
    class _CancelOperation(
        _BasePrivateAuctionDealServiceRestTransport._BaseCancelOperation,
        PrivateAuctionDealServiceRestStub,
    ):
        def __hash__(self):
            return hash("PrivateAuctionDealServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BasePrivateAuctionDealServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(
                request, metadata
            )
            transcoded_request = _BasePrivateAuctionDealServiceRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BasePrivateAuctionDealServiceRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.PrivateAuctionDealServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.PrivateAuctionDealService",
            ...
            # Send the request
            response = (
                PrivateAuctionDealServiceRestTransport._CancelOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
...
__all__ = ("PrivateAuctionDealServiceRestTransport",)

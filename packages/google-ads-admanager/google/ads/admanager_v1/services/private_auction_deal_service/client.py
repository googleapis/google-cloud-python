...
from .transports.base import DEFAULT_CLIENT_INFO, PrivateAuctionDealServiceTransport
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=PrivateAuctionDealServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=PrivateAuctionDealServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=PrivateAuctionDealServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

...
class UserServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_user(
        self, request: user_service.GetUserRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[user_service.GetUserRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_user(self, response: user_service.User) -> user_service.User:
    ...
    ) -> Tuple[user_service.ListUsersRequest, Sequence[Tuple[str, str]]]:
...
class UserServiceRestTransport(UserServiceTransport):
    ...
    class _GetUser(UserServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            pb_resp = user_service.User.pb(resp)
    ...
    class _ListUsers(UserServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = user_service.ListUsersRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    @property
    def get_user(self) -> Callable[[user_service.GetUserRequest], user_service.User]:
    ...
    class _GetOperation(UserServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,

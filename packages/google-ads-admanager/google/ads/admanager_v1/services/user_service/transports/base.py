...
class UserServiceTransport(abc.ABC):
    """Abstract transport class for UserService."""
    ...
    @property
    def get_user(self) -> Callable[[user_service.GetUserRequest], Union[user_messages.User, Awaitable[user_messages.User]]]:
        raise NotImplementedError()

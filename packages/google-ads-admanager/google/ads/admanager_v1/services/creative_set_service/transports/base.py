...
class CreativeSetServiceTransport(abc.ABC):
    """Abstract transport class for CreativeSetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_creative_set: gapic_v1.method.wrap_method(
                self.get_creative_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_creative_sets: gapic_v1.method.wrap_method(
                self.list_creative_sets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_creative_set: gapic_v1.method.wrap_method(
                self.create_creative_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_creative_set: gapic_v1.method.wrap_method(
                self.update_creative_set,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_creative_set(
        ...
        Union[
            ...
            Awaitable[creative_set_messages.CreativeSet],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_creative_sets(
        ...
        Union[
            ...
            Awaitable[creative_set_service.ListCreativeSetsResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("CreativeSetServiceTransport",)

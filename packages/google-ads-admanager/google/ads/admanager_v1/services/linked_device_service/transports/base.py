...
class LinkedDeviceServiceTransport(abc.ABC):
    """Abstract transport class for LinkedDeviceService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_linked_device: gapic_v1.method.wrap_method(
                self.get_linked_device,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_linked_devices: gapic_v1.method.wrap_method(
                self.list_linked_devices,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_linked_device(
        ...
        Union[
            ...
            Awaitable[linked_device_messages.LinkedDevice],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_linked_devices(
        ...
        Union[
            ...
            Awaitable[linked_device_service.ListLinkedDevicesResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("LinkedDeviceServiceTransport",)

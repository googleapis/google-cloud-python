...
class _BaseBandwidthGroupServiceRestTransport(BandwidthGroupServiceTransport):
    """Base REST backend transport for BandwidthGroupService.
    ...
    class _BaseGetBandwidthGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=networks/*/bandwidthGroups/*}",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = bandwidth_group_service.GetBandwidthGroupRequest.pb(request)
    ...
    class _BaseListBandwidthGroups:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=networks/*}/bandwidthGroups",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = bandwidth_group_service.ListBandwidthGroupsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
...
__all__ = ("_BaseBandwidthGroupServiceRestTransport",)

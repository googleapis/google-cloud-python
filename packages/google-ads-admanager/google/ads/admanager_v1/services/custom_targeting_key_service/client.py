...
class CustomTargetingKeyServiceClient(metaclass=CustomTargetingKeyServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CustomTargetingKeyServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, CustomTargetingKeyServiceTransport]): The
    ...
    def get_custom_targeting_key(
        ...
        *,
        ...
        # in a custom_targeting_key_service.GetCustomTargetingKeyRequest.
    ...
    def list_custom_targeting_keys(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a custom_targeting_key_service.ListCustomTargetingKeysRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(

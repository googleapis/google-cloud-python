...
class CustomTargetingKeyServiceClientMeta(type):
    """Metaclass for the CustomTargetingKeyService client.
...
class CustomTargetingKeyServiceClient(metaclass=CustomTargetingKeyServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CustomTargetingKeyServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> CustomTargetingKeyServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            CustomTargetingKeyServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the custom targeting key service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,CustomTargetingKeyServiceTransport,Callable[..., CustomTargetingKeyServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CustomTargetingKeyServiceTransport constructor.
        ...
        transport_provided = isinstance(transport, CustomTargetingKeyServiceTransport)
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=CustomTargetingKeyServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=CustomTargetingKeyServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=CustomTargetingKeyServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get_custom_targeting_key(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_custom_targeting_key():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.GetCustomTargetingKeyRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_custom_targeting_key(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.GetCustomTargetingKeyRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_custom_targeting_key]
    ...
    def list_custom_targeting_keys(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_custom_targeting_keys():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.ListCustomTargetingKeysRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_custom_targeting_keys(request=request)
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.ListCustomTargetingKeysRequest, dict]):
        ...
        response = pagers.ListCustomTargetingKeysPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_custom_targeting_key(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_custom_targeting_key():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.CreateCustomTargetingKeyRequest(
                    parent="parent_value",
                )

                # Make the request
                response = client.create_custom_targeting_key(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.CreateCustomTargetingKeyRequest, dict]):
            ...
            custom_targeting_key (google.ads.admanager_v1.types.CustomTargetingKey):
                ...
                This corresponds to the ``custom_targeting_key`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        if not isinstance(
            ...
            if custom_targeting_key is not None:
                request.custom_targeting_key = custom_targeting_key
    ...
    def batch_create_custom_targeting_keys(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_batch_create_custom_targeting_keys():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                requests = admanager_v1.CreateCustomTargetingKeyRequest()
                requests.parent = "parent_value"

                request = admanager_v1.BatchCreateCustomTargetingKeysRequest(
                    parent="parent_value",
                    requests=requests,
                )

                # Make the request
                response = client.batch_create_custom_targeting_keys(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchCreateCustomTargetingKeysRequest, dict]):
                The request object. Request object for ``BatchCreateCustomTargetingKeys``
                method.
            parent (str):
                Required. The parent resource where
                ``CustomTargetingKeys`` will be created. Format:
                ``networks/{network_code}`` The parent field in the
                CreateCustomTargetingKeyRequest must match this field.
        ...
        Returns:
            google.ads.admanager_v1.types.BatchCreateCustomTargetingKeysResponse:
    ...
    def update_custom_targeting_key(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_custom_targeting_key():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.UpdateCustomTargetingKeyRequest(
                )

                # Make the request
                response = client.update_custom_targeting_key(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.UpdateCustomTargetingKeyRequest, dict]):
                The request object. Request object for ``UpdateCustomTargetingKey`` method.
            custom_targeting_key (google.ads.admanager_v1.types.CustomTargetingKey):
                Required. The ``CustomTargetingKey`` to update.

                The ``CustomTargetingKey``'s ``name`` is used to
                identify the ``CustomTargetingKey`` to update.
    ...
    def batch_update_custom_targeting_keys(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_batch_update_custom_targeting_keys():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.BatchUpdateCustomTargetingKeysRequest(
                    parent="parent_value",
                )

                # Make the request
                response = client.batch_update_custom_targeting_keys(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchUpdateCustomTargetingKeysRequest, dict]):
                The request object. Request object for ``BatchUpdateCustomTargetingKeys``
                method.
            parent (str):
                Required. The parent resource where
                ``CustomTargetingKeys`` will be updated. Format:
                ``networks/{network_code}`` The parent field in the
                UpdateCustomTargetingKeyRequest must match this field.
        ...
        Returns:
            google.ads.admanager_v1.types.BatchUpdateCustomTargetingKeysResponse:
    ...
    def batch_activate_custom_targeting_keys(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_batch_activate_custom_targeting_keys():
                # Create a client
                client = admanager_v1.CustomTargetingKeyServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.BatchActivateCustomTargetingKeysRequest(
                    parent="parent_value",
                    names=['names_value1', 'names_value2'],
                )

                # Make the request
                response = client.batch_activate_custom_targeting_keys(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchActivateCustomTargetingKeysRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.types.BatchActivateCustomTargetingKeysResponse:
    ...
    def batch_deactivate_custom_targeting_keys(
        ...
        *,
        ...
        r"""Deactivates a list of ``CustomTargetingKey`` objects.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchDeactivateCustomTargetingKeysRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.types.BatchDeactivateCustomTargetingKeysResponse:
                Response object for BatchDeactivateCustomTargetingKeys
                method.
    ...
    def __enter__(self) -> "CustomTargetingKeyServiceClient":
        return self

...
class _BaseCustomTargetingKeyServiceRestTransport(CustomTargetingKeyServiceTransport):
    ...
    class _BaseBatchActivateCustomTargetingKeys:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/customTargetingKeys:batchActivate",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseBatchCreateCustomTargetingKeys:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/customTargetingKeys:batchCreate",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseBatchDeactivateCustomTargetingKeys:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/customTargetingKeys:batchDeactivate",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseBatchUpdateCustomTargetingKeys:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/customTargetingKeys:batchUpdate",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseCreateCustomTargetingKey:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateCustomTargetingKey:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{custom_targeting_key.name=networks/*/customTargetingKeys/*}",
                    "body": "custom_targeting_key",
                },
            ]
            return http_options
...
__all__ = ("_BaseCustomTargetingKeyServiceRestTransport",)

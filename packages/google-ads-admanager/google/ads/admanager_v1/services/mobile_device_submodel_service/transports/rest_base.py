...
class _BaseMobileDeviceSubmodelServiceRestTransport(
    ...
    class _BaseGetMobileDeviceSubmodel:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=networks/*/mobileDeviceSubmodels/*}",
                },
            ]
            return http_options
    ...
    class _BaseListMobileDeviceSubmodels:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=networks/*}/mobileDeviceSubmodels",
                },
            ]
            return http_options
...
__all__ = ("_BaseMobileDeviceSubmodelServiceRestTransport",)

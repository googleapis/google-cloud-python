...
class AdUnitServiceTransport(abc.ABC):
    """Abstract transport class for AdUnitService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_ad_unit: gapic_v1.method.wrap_method(
                self.get_ad_unit,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_ad_units: gapic_v1.method.wrap_method(
                self.list_ad_units,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = ("AdUnitServiceTransport",)

...
class SlateServiceTransport(abc.ABC):
    """Abstract transport class for SlateService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.batch_create_slates: gapic_v1.method.wrap_method(
                self.batch_create_slates,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.batch_update_slates: gapic_v1.method.wrap_method(
                self.batch_update_slates,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_archive_slates: gapic_v1.method.wrap_method(
                self.batch_archive_slates,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_unarchive_slates: gapic_v1.method.wrap_method(
                self.batch_unarchive_slates,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_slate(
        ...
        [slate_service.GetSlateRequest],
        Union[slate_messages.Slate, Awaitable[slate_messages.Slate]],
    ]:
        raise NotImplementedError()
    ...
    def list_slates(
        ...
        [slate_service.ListSlatesRequest],
        Union[
            slate_service.ListSlatesResponse,
            Awaitable[slate_service.ListSlatesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def create_slate(
        ...
        [slate_service.CreateSlateRequest],
        Union[slate_messages.Slate, Awaitable[slate_messages.Slate]],
    ]:
        raise NotImplementedError()
    ...
    def batch_create_slates(
        ...
        Union[
            ...
            Awaitable[slate_service.BatchCreateSlatesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def update_slate(
        ...
        [slate_service.UpdateSlateRequest],
        Union[slate_messages.Slate, Awaitable[slate_messages.Slate]],
    ]:
        raise NotImplementedError()
    ...
    def batch_update_slates(
        ...
        Union[
            ...
            Awaitable[slate_service.BatchUpdateSlatesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_archive_slates(
        ...
        Union[
            ...
            Awaitable[slate_service.BatchArchiveSlatesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_unarchive_slates(
        ...
        Union[
            ...
            Awaitable[slate_service.BatchUnarchiveSlatesResponse],
        ],
    ]:
        raise NotImplementedError()

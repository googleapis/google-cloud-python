...
class ContentServiceClient(metaclass=ContentServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.admanager_v1.ContentServiceClient`.",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
    ...
    def get_content(
        self,
        request: Optional[Union[content_service.GetContentRequest, dict]] = None,
        *,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.GetContentRequest, dict]):
                The request object. Request object for ``GetContent`` method.
            name (str):
        ...
        Returns:
            google.ads.admanager_v1.types.Content:
                A piece of content from a Publisher's
                CMS.
        ...
        if not isinstance(request, content_service.GetContentRequest):
            request = content_service.GetContentRequest(request)
    ...
    def list_content(
        self,
        request: Optional[Union[content_service.ListContentRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_content():
                ...
                # Initialize request argument(s)
                request = admanager_v1.ListContentRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.ListContentRequest, dict]):
                The request object. Request object for ``ListContent`` method.
            parent (str):
                Required. The parent, which owns this collection of
                Content. Format: ``networks/{network_code}``
        ...
        Returns:
            google.ads.admanager_v1.services.content_service.pagers.ListContentPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, content_service.ListContentRequest):
            request = content_service.ListContentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.

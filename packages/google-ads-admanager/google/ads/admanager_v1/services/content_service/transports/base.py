...
class ContentServiceTransport(abc.ABC):
    ...
    @property
    def get_content(self) -> Callable[[content_service.GetContentRequest], Union[content_messages.Content, Awaitable[content_messages.Content]]]:
        raise NotImplementedError()

    @property
    def list_content(
        self,
    ) -> Callable[[content_service.ListContentRequest], Union[content_service.ListContentResponse, Awaitable[content_service.ListContentResponse]]]:
        raise NotImplementedError()

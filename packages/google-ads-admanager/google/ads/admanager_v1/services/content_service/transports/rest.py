            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseContentServiceRestTransport._BaseGetContent,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentServiceClient.GetContent",
                    extra={
            ...
            # Return the response
            resp = content_messages.Content()
            pb_resp = content_messages.Content.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.ContentServiceClient.get_content",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
                        "rpcName": "GetContent",
    ...
    class _ListContent(
        ...
        def __call__(
            ...
            *,
            ...
            Returns:
                ~.content_service.ListContentResponse:
                    Response object for ``ListContentRequest`` containing
                matching ``Content`` objects.
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseContentServiceRestTransport._BaseListContent,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentServiceClient.ListContent",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
                        "rpcName": "ListContent",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = content_service.ListContentResponse()
            pb_resp = content_service.ListContentResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.ContentServiceClient.list_content",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
                        "rpcName": "ListContent",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.ContentServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

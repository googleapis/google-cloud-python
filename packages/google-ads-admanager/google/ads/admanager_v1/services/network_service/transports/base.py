...
class NetworkServiceTransport(abc.ABC):
    ...
    @property
    def get_network(self) -> Callable[[network_service.GetNetworkRequest], Union[network_messages.Network, Awaitable[network_messages.Network]]]:
        raise NotImplementedError()
    ...
    def list_networks(
        ...
        [network_service.ListNetworksRequest], Union[network_service.ListNetworksResponse, Awaitable[network_service.ListNetworksResponse]]
    ]:
        raise NotImplementedError()
...
__all__ = ("NetworkServiceTransport",)

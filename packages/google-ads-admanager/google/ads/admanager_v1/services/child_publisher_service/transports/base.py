...
class ChildPublisherServiceTransport(abc.ABC):
    """Abstract transport class for ChildPublisherService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_child_publisher: gapic_v1.method.wrap_method(
                self.get_child_publisher,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_child_publishers: gapic_v1.method.wrap_method(
                self.list_child_publishers,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_child_publisher: gapic_v1.method.wrap_method(
                self.create_child_publisher,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_child_publishers: gapic_v1.method.wrap_method(
                self.batch_create_child_publishers,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_child_publisher: gapic_v1.method.wrap_method(
                self.update_child_publisher,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_child_publishers: gapic_v1.method.wrap_method(
                self.batch_update_child_publishers,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_child_publisher(
        ...
        Union[
            ...
            Awaitable[child_publisher_messages.ChildPublisher],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_child_publishers(
        ...
        Union[
            ...
            Awaitable[child_publisher_service.ListChildPublishersResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_create_child_publishers(
        ...
        Union[
            ...
            Awaitable[child_publisher_service.BatchCreateChildPublishersResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("ChildPublisherServiceTransport",)

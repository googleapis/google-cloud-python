...
class CustomFieldServiceClient(metaclass=CustomFieldServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CustomFieldServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            CustomFieldServiceClient._read_environment_variables()
        )
        self._client_cert_source = CustomFieldServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CustomFieldServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CustomFieldServiceClient._get_api_endpoint(
    ...
    def get_custom_field(
        self,
        request: Optional[
            Union[custom_field_service.GetCustomFieldRequest, dict]
        ] = None,
        *,
    ...
    def list_custom_fields(
        self,
        request: Optional[
            Union[custom_field_service.ListCustomFieldsRequest, dict]
        ] = None,
        *,

...
class CustomFieldServiceRestTransport(CustomFieldServiceTransport):
    """REST backend transport for CustomFieldService.
    ...
    class _GetCustomField(CustomFieldServiceRestStub):
        def __hash__(self):
            return hash("GetCustomField")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=networks/*/customFields/*}",
                },
            ]
            request, metadata = self._interceptor.pre_get_custom_field(
                request, metadata
            )
            pb_request = custom_field_service.GetCustomFieldRequest.pb(request)
    ...
    class _ListCustomFields(CustomFieldServiceRestStub):
        def __hash__(self):
            return hash("ListCustomFields")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=networks/*}/customFields",
                },
            ]
            request, metadata = self._interceptor.pre_list_custom_fields(
                request, metadata
            )
            pb_request = custom_field_service.ListCustomFieldsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetOperation(CustomFieldServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,

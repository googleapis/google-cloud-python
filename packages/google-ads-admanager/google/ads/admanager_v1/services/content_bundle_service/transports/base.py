...
class ContentBundleServiceTransport(abc.ABC):
    """Abstract transport class for ContentBundleService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_content_bundle: gapic_v1.method.wrap_method(
                self.get_content_bundle,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_content_bundles: gapic_v1.method.wrap_method(
                self.list_content_bundles,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_content_bundle(
        ...
        Union[content_bundle_messages.ContentBundle, Awaitable[content_bundle_messages.ContentBundle]],
    ]:
        raise NotImplementedError()
    ...
    def list_content_bundles(
        ...
        Union[content_bundle_service.ListContentBundlesResponse, Awaitable[content_bundle_service.ListContentBundlesResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("ContentBundleServiceTransport",)

...
class ContentBundleServiceRestInterceptor:
    """Interceptor for ContentBundleService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the ContentBundleServiceRestTransport.
    ...
    .. code-block:: python
        class MyCustomContentBundleServiceInterceptor(ContentBundleServiceRestInterceptor):
            ...
            def post_get_content_bundle(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_content_bundles(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_content_bundles(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = ContentBundleServiceRestTransport(interceptor=MyCustomContentBundleServiceInterceptor())
        client = ContentBundleServiceClient(transport=transport)
    ...
    def post_get_content_bundle(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ContentBundleService server but before
        it is returned to user code. This `post_get_content_bundle` interceptor runs
        before the `post_get_content_bundle_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_content_bundle_with_metadata(
        ...
        We recommend only using this `post_get_content_bundle_with_metadata`
        interceptor in new development instead of the `post_get_content_bundle` interceptor.
        When both interceptors are used, this `post_get_content_bundle_with_metadata` interceptor runs after the
        `post_get_content_bundle` interceptor. The (possibly modified) response returned by
        `post_get_content_bundle` will be passed to
        `post_get_content_bundle_with_metadata`.
        """
        return response, metadata
    ...
    def post_list_content_bundles(
        self, response: content_bundle_service.ListContentBundlesResponse
    ) -> content_bundle_service.ListContentBundlesResponse:
        """Post-rpc interceptor for list_content_bundles

        DEPRECATED. Please use the `post_list_content_bundles_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ContentBundleService server but before
        it is returned to user code. This `post_list_content_bundles` interceptor runs
        before the `post_list_content_bundles_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_content_bundles_with_metadata(
        ...
        We recommend only using this `post_list_content_bundles_with_metadata`
        interceptor in new development instead of the `post_list_content_bundles` interceptor.
        When both interceptors are used, this `post_list_content_bundles_with_metadata` interceptor runs after the
        `post_list_content_bundles` interceptor. The (possibly modified) response returned by
        `post_list_content_bundles` will be passed to
        `post_list_content_bundles_with_metadata`.
        """
        return response, metadata
...
class ContentBundleServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: ContentBundleServiceRestInterceptor


class ContentBundleServiceRestTransport(_BaseContentBundleServiceRestTransport):
    """REST backend synchronous transport for ContentBundleService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[ContentBundleServiceRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[ContentBundleServiceRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseContentBundleServiceRestTransport._BaseBatchActivateContentBundles,
                    "_BaseBatchActivateContentBundles__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseContentBundleServiceRestTransport._BaseBatchDeactivateContentBundles,
                    "_BaseBatchDeactivateContentBundles__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
    ...
    class _GetContentBundle(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get content bundle method over HTTP.

            Args:
                request (~.content_bundle_service.GetContentBundleRequest):
                    The request object. Request object for ``GetContentBundle`` method.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
                metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
            ...
            Returns:
                ...
                [Content][google.ads.admanager.v1.Content] that match
                certain filter rules along with the option to explicitly
                include or exclude certain Content IDs.
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseContentBundleServiceRestTransport._BaseGetContentBundle,
                    "_BaseGetContentBundle__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentBundleServiceClient.GetContentBundle",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
                        "rpcName": "GetContentBundle",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = content_bundle_messages.ContentBundle()
            pb_resp = content_bundle_messages.ContentBundle.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.ContentBundleServiceClient.get_content_bundle",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
                        "rpcName": "GetContentBundle",
                        "metadata": http_response["headers"],
    ...
    class _ListContentBundles(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list content bundles method over HTTP.

            Args:
                request (~.content_bundle_service.ListContentBundlesRequest):
                    The request object. Request object for ``ListContentBundles`` method.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
                metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
            ...
            Returns:
                ~.content_bundle_service.ListContentBundlesResponse:
                    Response object for ``ListContentBundlesRequest``
                containing matching ``ContentBundle`` objects.
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseContentBundleServiceRestTransport._BaseListContentBundles,
                    "_BaseListContentBundles__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentBundleServiceClient.ListContentBundles",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
                        "rpcName": "ListContentBundles",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = content_bundle_service.ListContentBundlesResponse()
            pb_resp = content_bundle_service.ListContentBundlesResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.ContentBundleServiceClient.list_content_bundles",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
                        "rpcName": "ListContentBundles",
                        "metadata": http_response["headers"],
    ...
    class _CancelOperation(
        _BaseContentBundleServiceRestTransport._BaseCancelOperation,
        ContentBundleServiceRestStub,
    ):
        def __hash__(self):
            return hash("ContentBundleServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseContentBundleServiceRestTransport._BaseCancelOperation._get_http_options()
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentBundleServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
            ...
            # Send the request
            response = ContentBundleServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentBundleServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.ads.admanager_v1.ContentBundleServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentBundleService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
...
__all__ = ("ContentBundleServiceRestTransport",)

...
class TargetingPresetServiceTransport(abc.ABC):
    """Abstract transport class for TargetingPresetService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_targeting_preset: gapic_v1.method.wrap_method(
                self.get_targeting_preset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_targeting_presets: gapic_v1.method.wrap_method(
                self.list_targeting_presets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_targeting_preset: gapic_v1.method.wrap_method(
                self.create_targeting_preset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_targeting_presets: gapic_v1.method.wrap_method(
                self.batch_create_targeting_presets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_targeting_preset: gapic_v1.method.wrap_method(
                self.update_targeting_preset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_targeting_presets: gapic_v1.method.wrap_method(
                self.batch_update_targeting_presets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_deactivate_targeting_presets: gapic_v1.method.wrap_method(
                self.batch_deactivate_targeting_presets,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_targeting_preset(
        ...
        Union[
            ...
            Awaitable[targeting_preset_messages.TargetingPreset],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_targeting_presets(
        ...
        Union[
            ...
            Awaitable[targeting_preset_service.ListTargetingPresetsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_create_targeting_presets(
        ...
        Union[
            ...
            Awaitable[targeting_preset_service.BatchCreateTargetingPresetsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_update_targeting_presets(
        ...
        Union[
            ...
            Awaitable[targeting_preset_service.BatchUpdateTargetingPresetsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_deactivate_targeting_presets(
        ...
        Union[
            ...
            Awaitable[targeting_preset_service.BatchDeactivateTargetingPresetsResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("TargetingPresetServiceTransport",)

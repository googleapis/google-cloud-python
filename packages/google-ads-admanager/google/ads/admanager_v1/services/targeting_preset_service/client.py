...
from google.ads.admanager_v1.services.targeting_preset_service import pagers
...
from .transports.base import DEFAULT_CLIENT_INFO, TargetingPresetServiceTransport
from .transports.rest import TargetingPresetServiceRestTransport


class TargetingPresetServiceClientMeta(type):
    """Metaclass for the TargetingPresetService client.
    ...
    ) -> Type[TargetingPresetServiceTransport]:
...
class TargetingPresetServiceClient(metaclass=TargetingPresetServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TargetingPresetServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> TargetingPresetServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            TargetingPresetServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def targeting_preset_path(
        network_code: str,
        targeting_preset: str,
    ) -> str:
        """Returns a fully-qualified targeting_preset string."""
        return "networks/{network_code}/targetingPresets/{targeting_preset}".format(
            network_code=network_code,
            targeting_preset=targeting_preset,
        )

    @staticmethod
    def parse_targeting_preset_path(path: str) -> Dict[str, str]:
        """Parses a targeting_preset path into its component segments."""
        m = re.match(
            r"^networks/(?P<network_code>.+?)/targetingPresets/(?P<targeting_preset>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = TargetingPresetServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = TargetingPresetServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = TargetingPresetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                TargetingPresetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = TargetingPresetServiceClient._DEFAULT_UNIVERSE
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., TargetingPresetServiceTransport],
            ]
        ] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the targeting preset service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,TargetingPresetServiceTransport,Callable[..., TargetingPresetServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the TargetingPresetServiceTransport constructor.
        ...
        self._client_cert_source = TargetingPresetServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TargetingPresetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, TargetingPresetServiceTransport)
        if transport_provided:
            # transport is a TargetingPresetServiceTransport instance.
            ...
            self._transport = cast(TargetingPresetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or TargetingPresetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                TargetingPresetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., TargetingPresetServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.admanager_v1.TargetingPresetServiceClient`.",
                    extra={
    ...
    def get_targeting_preset(
        self,
        request: Optional[
            Union[targeting_preset_service.GetTargetingPresetRequest, dict]
        ] = None,
        *,
        ...
        r"""Retrieves a ``TargetingPreset`` object. Note: Deactivated
        targeting presets are "logically deleted" (filtered out) by the
        get logic in the manager layer, so they will not be returned by
        ...
        .. code-block:: python
            ...
            def sample_get_targeting_preset():
                # Create a client
                client = admanager_v1.TargetingPresetServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.GetTargetingPresetRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_targeting_preset(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.GetTargetingPresetRequest, dict]):
        ...
        if not isinstance(request, targeting_preset_service.GetTargetingPresetRequest):
            request = targeting_preset_service.GetTargetingPresetRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_targeting_preset]
    ...
    def list_targeting_presets(
        self,
        request: Optional[
            Union[targeting_preset_service.ListTargetingPresetsRequest, dict]
        ] = None,
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListTargetingPresetsPager:
        r"""Lists ``TargetingPreset`` objects.
        ...
        .. code-block:: python
            ...
            def sample_list_targeting_presets():
                # Create a client
                client = admanager_v1.TargetingPresetServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.ListTargetingPresetsRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_targeting_presets(request=request)
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.ListTargetingPresetsRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.services.targeting_preset_service.pagers.ListTargetingPresetsPager:
        ...
        if not isinstance(
            ...
            request = targeting_preset_service.ListTargetingPresetsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_targeting_presets]
        ...
        response = pagers.ListTargetingPresetsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_targeting_preset(
        self,
        request: Optional[
            Union[targeting_preset_service.CreateTargetingPresetRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        targeting_preset: Optional[targeting_preset_messages.TargetingPreset] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> targeting_preset_messages.TargetingPreset:
        r"""Creates a ``TargetingPreset`` object.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.CreateTargetingPresetRequest, dict]):
                The request object. Request object for ``CreateTargetingPreset`` method.
            parent (str):
                Required. The parent resource where this
                ``TargetingPreset`` will be created. Format:
            ...
            targeting_preset (google.ads.admanager_v1.types.TargetingPreset):
                ...
                This corresponds to the ``targeting_preset`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, targeting_preset]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        if not isinstance(
            ...
            request = targeting_preset_service.CreateTargetingPresetRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
            if targeting_preset is not None:
                request.targeting_preset = targeting_preset

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_targeting_preset]
    ...
    def batch_create_targeting_presets(
        self,
        request: Optional[
            Union[targeting_preset_service.BatchCreateTargetingPresetsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[targeting_preset_service.CreateTargetingPresetRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> targeting_preset_service.BatchCreateTargetingPresetsResponse:
        r"""Creates ``TargetingPreset`` objects.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchCreateTargetingPresetsRequest, dict]):
            ...
            parent (str):
                ...
                parent field in the CreateTargetingPresetRequest must
                match this field.
        ...
        Returns:
            google.ads.admanager_v1.types.BatchCreateTargetingPresetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.batch_create_targeting_presets
        ]
    ...
    def update_targeting_preset(
        self,
        request: Optional[
            Union[targeting_preset_service.UpdateTargetingPresetRequest, dict]
        ] = None,
        *,
        targeting_preset: Optional[targeting_preset_messages.TargetingPreset] = None,
        ...
        r"""Updates a ``TargetingPreset`` object.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.UpdateTargetingPresetRequest, dict]):
                The request object. Request object for ``UpdateTargetingPreset`` method.
            targeting_preset (google.ads.admanager_v1.types.TargetingPreset):
                Required. The ``TargetingPreset`` to update.

                The ``TargetingPreset``'s ``name`` is used to identify
                the ``TargetingPreset`` to update.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [targeting_preset, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        if not isinstance(
            ...
            request = targeting_preset_service.UpdateTargetingPresetRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if targeting_preset is not None:
                request.targeting_preset = targeting_preset
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_targeting_preset]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (("targeting_preset.name", request.targeting_preset.name),)
            ),
        )
    ...
    def batch_update_targeting_presets(
        self,
        request: Optional[
            Union[targeting_preset_service.BatchUpdateTargetingPresetsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[targeting_preset_service.UpdateTargetingPresetRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> targeting_preset_service.BatchUpdateTargetingPresetsResponse:
        r"""Batch updates ``TargetingPreset`` objects.
        ...
        .. code-block:: python
            ...
            def sample_batch_update_targeting_presets():
                # Create a client
                client = admanager_v1.TargetingPresetServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.BatchUpdateTargetingPresetsRequest(
                    parent="parent_value",
                )

                # Make the request
                response = client.batch_update_targeting_presets(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchUpdateTargetingPresetsRequest, dict]):
                The request object. Request object for ``BatchUpdateTargetingPresets``
                method.
            parent (str):
                Required. The parent resource where ``TargetingPresets``
                will be updated. Format: ``networks/{network_code}`` The
                parent field in the UpdateTargetingPresetRequest must
                match this field.
        ...
        Returns:
            google.ads.admanager_v1.types.BatchUpdateTargetingPresetsResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_update_targeting_presets
        ]
    ...
    def batch_deactivate_targeting_presets(
        self,
        request: Optional[
            Union[targeting_preset_service.BatchDeactivateTargetingPresetsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[targeting_preset_service.DeactivateTargetingPresetRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> targeting_preset_service.BatchDeactivateTargetingPresetsResponse:
        r"""Batch deactivates ``TargetingPreset`` objects.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchDeactivateTargetingPresetsRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.types.BatchDeactivateTargetingPresetsResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_deactivate_targeting_presets
        ]
    ...
    def __enter__(self) -> "TargetingPresetServiceClient":
        return self

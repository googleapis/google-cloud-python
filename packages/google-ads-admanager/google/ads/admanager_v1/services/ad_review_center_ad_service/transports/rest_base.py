...
from .base import DEFAULT_CLIENT_INFO, AdReviewCenterAdServiceTransport


class _BaseAdReviewCenterAdServiceRestTransport(AdReviewCenterAdServiceTransport):
    """Base REST backend transport for AdReviewCenterAdService.
    ...
    class _BaseBatchAllowAdReviewCenterAds:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*/webProperties/*}/adReviewCenterAds:batchAllow",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseSearchAdReviewCenterAds:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=networks/*/webProperties/*}/adReviewCenterAds:search",
                },
            ]
            return http_options
...
__all__ = ("_BaseAdReviewCenterAdServiceRestTransport",)

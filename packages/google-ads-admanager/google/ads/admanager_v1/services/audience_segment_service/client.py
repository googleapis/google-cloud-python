...
from .transports.base import DEFAULT_CLIENT_INFO, AudienceSegmentServiceTransport
from .transports.rest import AudienceSegmentServiceRestTransport


class AudienceSegmentServiceClientMeta(type):
    """Metaclass for the AudienceSegmentService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[AudienceSegmentServiceTransport]]
    _transport_registry["rest"] = AudienceSegmentServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[AudienceSegmentServiceTransport]:
...
class AudienceSegmentServiceClient(metaclass=AudienceSegmentServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AudienceSegmentServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> AudienceSegmentServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            AudienceSegmentServiceTransport: The transport used by the client
                instance.
        """
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., AudienceSegmentServiceTransport],
            ]
        ] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the audience segment service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,AudienceSegmentServiceTransport,Callable[..., AudienceSegmentServiceTransport]]]):
        ...
        self._client_cert_source = AudienceSegmentServiceClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, AudienceSegmentServiceTransport)
        if transport_provided:
            # transport is a AudienceSegmentServiceTransport instance.
            ...
            self._transport = cast(AudienceSegmentServiceTransport, transport)
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=AudienceSegmentServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=AudienceSegmentServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=AudienceSegmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AudienceSegmentServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AudienceSegmentServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.admanager_v1.AudienceSegmentServiceClient`.",
                    extra={
    ...
    def get_audience_segment(
        self,
        request: Optional[
            Union[audience_segment_service.GetAudienceSegmentRequest, dict]
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.GetAudienceSegmentRequest, dict]):
                The request object. Request object for ``GetAudienceSegment`` method.
            name (str):
        ...
        Returns:
            google.ads.admanager_v1.types.AudienceSegment:
        ...
        if not isinstance(request, audience_segment_service.GetAudienceSegmentRequest):
            request = audience_segment_service.GetAudienceSegmentRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_audience_segment]
    ...
    def list_audience_segments(
        self,
        request: Optional[
            Union[audience_segment_service.ListAudienceSegmentsRequest, dict]
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.ListAudienceSegmentsRequest, dict]):
                The request object. Request object for ``ListAudienceSegments`` method.
            parent (str):
                Required. The parent publisher network associated with
                these audience segments. Format:
        ...
        Returns:
            google.ads.admanager_v1.services.audience_segment_service.pagers.ListAudienceSegmentsPager:
        ...
        if not isinstance(
            ...
            request = audience_segment_service.ListAudienceSegmentsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_audience_segments]
        ...
        response = pagers.ListAudienceSegmentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_audience_segment(
        self,
        request: Optional[
            Union[audience_segment_service.CreateAudienceSegmentRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        audience_segment: Optional[audience_segment_messages.AudienceSegment] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> audience_segment_messages.AudienceSegment:
        r"""Creates an ``AudienceSegment`` object.
        ...
        .. code-block:: python
            ...
            def sample_create_audience_segment():
                # Create a client
                client = admanager_v1.AudienceSegmentServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.CreateAudienceSegmentRequest(
                    parent="parent_value",
                )

                # Make the request
                response = client.create_audience_segment(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.CreateAudienceSegmentRequest, dict]):
                The request object. Request object for ``CreateAudienceSegment`` method.
            parent (str):
                Required. The parent resource where this
                ``AudienceSegment`` will be created. Format:
                ``networks/{network_code}``
            ...
            audience_segment (google.ads.admanager_v1.types.AudienceSegment):
                ...
                This corresponds to the ``audience_segment`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, audience_segment]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        if not isinstance(
            ...
            request = audience_segment_service.CreateAudienceSegmentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
            if audience_segment is not None:
                request.audience_segment = audience_segment

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_audience_segment]
    ...
    def batch_create_audience_segments(
        self,
        request: Optional[
            Union[audience_segment_service.BatchCreateAudienceSegmentsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[audience_segment_service.CreateAudienceSegmentRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> audience_segment_service.BatchCreateAudienceSegmentsResponse:
        r"""Creates ``AudienceSegment`` objects.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchCreateAudienceSegmentsRequest, dict]):
            ...
            parent (str):
                ...
                parent field in the CreateAudienceSegmentRequest must
                match this field.
        ...
        Returns:
            google.ads.admanager_v1.types.BatchCreateAudienceSegmentsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.batch_create_audience_segments
        ]
    ...
    def __enter__(self) -> "AudienceSegmentServiceClient":
        return self

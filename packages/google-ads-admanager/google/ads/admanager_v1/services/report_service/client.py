...
from google.ads.admanager_v1.types import report_definition, report_messages, report_service
...
class ReportServiceClient(metaclass=ReportServiceClientMeta):
    ...
    def report_path(
        ...
        return "networks/{network_code}/reports/{report}".format(
            network_code=network_code,
            report=report,
        )
    ...
    def update_report(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("report.name", request.report.name),)),)

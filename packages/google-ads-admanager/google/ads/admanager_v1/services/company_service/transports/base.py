...
class CompanyServiceTransport(abc.ABC):
    ...
    @property
    def get_company(self) -> Callable[[company_service.GetCompanyRequest], Union[company_messages.Company, Awaitable[company_messages.Company]]]:
        raise NotImplementedError()
    ...
    def list_companies(
        ...
        [company_service.ListCompaniesRequest], Union[company_service.ListCompaniesResponse, Awaitable[company_service.ListCompaniesResponse]]
    ]:
        raise NotImplementedError()

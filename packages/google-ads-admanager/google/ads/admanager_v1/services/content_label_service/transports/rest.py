...
class ContentLabelServiceRestTransport(_BaseContentLabelServiceRestTransport):
    ...
    class _CancelOperation(
        _BaseContentLabelServiceRestTransport._BaseCancelOperation,
        ContentLabelServiceRestStub,
    ):
        def __hash__(self):
            return hash("ContentLabelServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseContentLabelServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(
                request, metadata
            )
            transcoded_request = _BaseContentLabelServiceRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseContentLabelServiceRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.ContentLabelServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.ContentLabelService",
            ...
            # Send the request
            response = ContentLabelServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,

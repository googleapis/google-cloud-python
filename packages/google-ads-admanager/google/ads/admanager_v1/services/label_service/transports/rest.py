...
from google.ads.admanager_v1.types import label_service
...
class LabelServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[label_service.GetLabelRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_label(self, response: label_service.Label) -> label_service.Label:
    ...
    def pre_list_labels(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[label_service.ListLabelsRequest, Sequence[Tuple[str, str]]]:
...
class LabelServiceRestTransport(LabelServiceTransport):
    """REST backend transport for LabelService.
    ...
    class _GetLabel(LabelServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = label_service.Label()
            pb_resp = label_service.Label.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_get_label(resp)
            return resp

    class _ListLabels(LabelServiceRestStub):
        def __hash__(self):
            return hash("ListLabels")
        ...
        def __call__(
            ...
            *,
            ...
            Returns:
                ~.label_service.ListLabelsResponse:
                    Response object for ListLabelsRequest
                containing matching Label resources.
    ...
    def get_label(
        self,
    ) -> Callable[[label_service.GetLabelRequest], label_service.Label]:

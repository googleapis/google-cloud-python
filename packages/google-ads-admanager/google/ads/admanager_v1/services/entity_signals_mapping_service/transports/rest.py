...
class EntitySignalsMappingServiceRestTransport(EntitySignalsMappingServiceTransport):
    """REST backend transport for EntitySignalsMappingService.
    ...
    class _BatchCreateEntitySignalsMappings(EntitySignalsMappingServiceRestStub):
        def __hash__(self):
            return hash("BatchCreateEntitySignalsMappings")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/entitySignalsMappings:batchCreate",
                    "body": "*",
                },
            ]
            (
    ...
    class _BatchUpdateEntitySignalsMappings(EntitySignalsMappingServiceRestStub):
        def __hash__(self):
            return hash("BatchUpdateEntitySignalsMappings")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/entitySignalsMappings:batchUpdate",
                    "body": "*",
                },
            ]
            (
    ...
    class _CreateEntitySignalsMapping(EntitySignalsMappingServiceRestStub):
        def __hash__(self):
            return hash("CreateEntitySignalsMapping")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=networks/*}/entitySignalsMappings",
    ...
    class _GetEntitySignalsMapping(EntitySignalsMappingServiceRestStub):
        def __hash__(self):
            return hash("GetEntitySignalsMapping")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=networks/*/entitySignalsMappings/*}",
                },
            ]
    ...
    class _ListEntitySignalsMappings(EntitySignalsMappingServiceRestStub):
        def __hash__(self):
            return hash("ListEntitySignalsMappings")
    ...
    class _UpdateEntitySignalsMapping(EntitySignalsMappingServiceRestStub):
        def __hash__(self):
            return hash("UpdateEntitySignalsMapping")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{entity_signals_mapping.name=networks/*/entitySignalsMappings/*}",
                    "body": "entity_signals_mapping",
                },
            ]
    ...
    class _GetOperation(EntitySignalsMappingServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,

...
class EntitySignalsMappingServiceTransport(abc.ABC):
    """Abstract transport class for EntitySignalsMappingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_entity_signals_mapping: gapic_v1.method.wrap_method(
                self.get_entity_signals_mapping,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_entity_signals_mappings: gapic_v1.method.wrap_method(
                self.list_entity_signals_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_entity_signals_mapping: gapic_v1.method.wrap_method(
                self.create_entity_signals_mapping,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_entity_signals_mapping: gapic_v1.method.wrap_method(
                self.update_entity_signals_mapping,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_entity_signals_mappings: gapic_v1.method.wrap_method(
                self.batch_create_entity_signals_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_entity_signals_mappings: gapic_v1.method.wrap_method(
                self.batch_update_entity_signals_mappings,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_entity_signals_mapping(
        ...
        Union[entity_signals_mapping_messages.EntitySignalsMapping, Awaitable[entity_signals_mapping_messages.EntitySignalsMapping]],
    ]:
        raise NotImplementedError()
    ...
    def list_entity_signals_mappings(
        ...
        Union[
            ...
            Awaitable[entity_signals_mapping_service.ListEntitySignalsMappingsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_create_entity_signals_mappings(
        ...
        Union[
            ...
            Awaitable[entity_signals_mapping_service.BatchCreateEntitySignalsMappingsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_update_entity_signals_mappings(
        ...
        Union[
            ...
            Awaitable[entity_signals_mapping_service.BatchUpdateEntitySignalsMappingsResponse],
        ],
    ]:
        raise NotImplementedError()

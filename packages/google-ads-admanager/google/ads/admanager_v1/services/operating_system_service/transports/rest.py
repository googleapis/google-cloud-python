...
class OperatingSystemServiceRestTransport(_BaseOperatingSystemServiceRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[OperatingSystemServiceRestInterceptor]): Interceptor used
    ...
    class _CancelOperation(
        _BaseOperatingSystemServiceRestTransport._BaseCancelOperation,
        OperatingSystemServiceRestStub,
    ):
        def __hash__(self):
            return hash("OperatingSystemServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseOperatingSystemServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(
                request, metadata
            )
            transcoded_request = _BaseOperatingSystemServiceRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseOperatingSystemServiceRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.OperatingSystemServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.OperatingSystemService",
            ...
            # Send the request
            response = (
                OperatingSystemServiceRestTransport._CancelOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,

...
class OperatingSystemServiceTransport(abc.ABC):
    """Abstract transport class for OperatingSystemService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_operating_system: gapic_v1.method.wrap_method(
                self.get_operating_system,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_operating_systems: gapic_v1.method.wrap_method(
    ...
    def get_operating_system(
        ...
        Union[operating_system_messages.OperatingSystem, Awaitable[operating_system_messages.OperatingSystem]],
    ]:
        raise NotImplementedError()
    ...
    def list_operating_systems(
        ...
        Union[operating_system_service.ListOperatingSystemsResponse, Awaitable[operating_system_service.ListOperatingSystemsResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("OperatingSystemServiceTransport",)

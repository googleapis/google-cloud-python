...
class RoleServiceTransport(abc.ABC):
    ...
    @property
    def get_role(self) -> Callable[[role_service.GetRoleRequest], Union[role_messages.Role, Awaitable[role_messages.Role]]]:
        raise NotImplementedError()

    @property
    def list_roles(
        self,
    ) -> Callable[[role_service.ListRolesRequest], Union[role_service.ListRolesResponse, Awaitable[role_service.ListRolesResponse]]]:
        raise NotImplementedError()

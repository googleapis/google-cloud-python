...
class RoleServiceClientMeta(type):
    """Metaclass for the RoleService client.
...
class RoleServiceClient(metaclass=RoleServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RoleServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RoleServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            RoleServiceTransport: The transport used by the client
                instance.
        """
    ...
    def role_path(
        ...
        return "networks/{network_code}/roles/{role}".format(
            network_code=network_code,
            role=role,
        )
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RoleServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RoleServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RoleServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RoleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RoleServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RoleServiceTransport, Callable[..., RoleServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the role service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,RoleServiceTransport,Callable[..., RoleServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RoleServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RoleServiceClient._read_environment_variables()
        self._client_cert_source = RoleServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RoleServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RoleServiceTransport)
        if transport_provided:
            # transport is a RoleServiceTransport instance.
            ...
            self._transport = cast(RoleServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RoleServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RoleServiceTransport], Callable[..., RoleServiceTransport]] = (
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_role():
                ...
                request = admanager_v1.GetRoleRequest(
                    name="name_value",
                )
        ...
        if not isinstance(request, role_service.GetRoleRequest):
            request = role_service.GetRoleRequest(request)
    ...
    def list_roles(
        self,
        request: Optional[Union[role_service.ListRolesRequest, dict]] = None,
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, role_service.ListRolesRequest):
            request = role_service.ListRolesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
    ...
    def __enter__(self) -> "RoleServiceClient":
        return self

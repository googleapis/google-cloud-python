...
class DaiEncodingProfileServiceTransport(abc.ABC):
    """Abstract transport class for DaiEncodingProfileService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_dai_encoding_profile: gapic_v1.method.wrap_method(
                self.get_dai_encoding_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_dai_encoding_profiles: gapic_v1.method.wrap_method(
                self.list_dai_encoding_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_dai_encoding_profile: gapic_v1.method.wrap_method(
                self.create_dai_encoding_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_dai_encoding_profiles: gapic_v1.method.wrap_method(
                self.batch_create_dai_encoding_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_dai_encoding_profile: gapic_v1.method.wrap_method(
                self.update_dai_encoding_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_dai_encoding_profiles: gapic_v1.method.wrap_method(
                self.batch_update_dai_encoding_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_activate_dai_encoding_profiles: gapic_v1.method.wrap_method(
                self.batch_activate_dai_encoding_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_archive_dai_encoding_profiles: gapic_v1.method.wrap_method(
                self.batch_archive_dai_encoding_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_dai_encoding_profile(
        ...
        Union[
            ...
            Awaitable[dai_encoding_profile_messages.DaiEncodingProfile],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_dai_encoding_profiles(
        ...
        Union[
            ...
            Awaitable[dai_encoding_profile_service.ListDaiEncodingProfilesResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("DaiEncodingProfileServiceTransport",)

...
class ApplicationServiceClient(metaclass=ApplicationServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApplicationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ApplicationServiceTransport, Callable[..., ApplicationServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApplicationServiceClient._read_environment_variables()
        self._client_cert_source = ApplicationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApplicationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ApplicationServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApplicationServiceTransport], Callable[..., ApplicationServiceTransport]] = (
    ...
    def get_application(
        self,
        request: Optional[Union[application_service.GetApplicationRequest, dict]] = None,
        *,
    ...
    def list_applications(
        self,
        request: Optional[Union[application_service.ListApplicationsRequest, dict]] = None,
        *,

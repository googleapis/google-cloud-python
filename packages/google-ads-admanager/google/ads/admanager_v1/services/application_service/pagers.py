...
class ListApplicationsPager:
    ...
    :class:`google.ads.admanager_v1.types.ListApplicationsResponse` object, and
    ...
    All the usual :class:`google.ads.admanager_v1.types.ListApplicationsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.ads.admanager_v1.types.ListApplicationsRequest):
                The initial request object.
            response (google.ads.admanager_v1.types.ListApplicationsResponse):
    ...
    def __iter__(self) -> Iterator[application_messages.Application]:

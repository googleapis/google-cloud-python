...
class TeamServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_team: gapic_v1.method.wrap_method(
                self.create_team,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_teams: gapic_v1.method.wrap_method(
                self.batch_create_teams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_team: gapic_v1.method.wrap_method(
                self.update_team,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_teams: gapic_v1.method.wrap_method(
                self.batch_update_teams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_activate_teams: gapic_v1.method.wrap_method(
                self.batch_activate_teams,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_deactivate_teams: gapic_v1.method.wrap_method(
                self.batch_deactivate_teams,
                default_timeout=None,
                client_info=client_info,
            ),

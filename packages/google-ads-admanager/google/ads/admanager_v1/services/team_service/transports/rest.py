...
class TeamServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_team(
        self, request: team_service.GetTeamRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[team_service.GetTeamRequest, Sequence[Tuple[str, str]]]:
    ...
    ) -> Tuple[team_service.ListTeamsRequest, Sequence[Tuple[str, str]]]:
...
class TeamServiceRestTransport(TeamServiceTransport):
    ...
    @property
    def get_team(self) -> Callable[[team_service.GetTeamRequest], team_service.Team]:

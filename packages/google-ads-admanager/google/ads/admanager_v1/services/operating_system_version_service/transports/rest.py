...
class OperatingSystemVersionServiceRestTransport(
    ...
    class _CancelOperation(
        _BaseOperatingSystemVersionServiceRestTransport._BaseCancelOperation,
        OperatingSystemVersionServiceRestStub,
    ):
        def __hash__(self):
            return hash("OperatingSystemVersionServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseOperatingSystemVersionServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(
                request, metadata
            )
            transcoded_request = _BaseOperatingSystemVersionServiceRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseOperatingSystemVersionServiceRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.ads.admanager_v1.OperatingSystemVersionServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ads.admanager.v1.OperatingSystemVersionService",
            ...
            # Send the request
            response = OperatingSystemVersionServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,

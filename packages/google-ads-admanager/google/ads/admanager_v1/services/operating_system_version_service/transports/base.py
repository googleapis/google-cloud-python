...
class OperatingSystemVersionServiceTransport(abc.ABC):
    ...
    def get_operating_system_version(
        ...
        Union[operating_system_version_messages.OperatingSystemVersion, Awaitable[operating_system_version_messages.OperatingSystemVersion]],
    ]:
        raise NotImplementedError()
...
__all__ = ("OperatingSystemVersionServiceTransport",)

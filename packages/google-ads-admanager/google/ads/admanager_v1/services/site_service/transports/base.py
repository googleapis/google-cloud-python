...
class SiteServiceTransport(abc.ABC):
    """Abstract transport class for SiteService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.batch_create_sites: gapic_v1.method.wrap_method(
                self.batch_create_sites,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.batch_update_sites: gapic_v1.method.wrap_method(
                self.batch_update_sites,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_deactivate_sites: gapic_v1.method.wrap_method(
                self.batch_deactivate_sites,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_submit_sites_for_approval: gapic_v1.method.wrap_method(
                self.batch_submit_sites_for_approval,
                default_timeout=None,
                client_info=client_info,
            ),

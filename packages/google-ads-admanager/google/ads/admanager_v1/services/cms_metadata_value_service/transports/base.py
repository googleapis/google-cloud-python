...
class CmsMetadataValueServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_cms_metadata_value: gapic_v1.method.wrap_method(
                self.get_cms_metadata_value,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_cms_metadata_values: gapic_v1.method.wrap_method(
                self.list_cms_metadata_values,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_cms_metadata_value(
        ...
        Union[cms_metadata_value_messages.CmsMetadataValue, Awaitable[cms_metadata_value_messages.CmsMetadataValue]],
    ]:
        raise NotImplementedError()
    ...
    def list_cms_metadata_values(
        ...
        Union[cms_metadata_value_service.ListCmsMetadataValuesResponse, Awaitable[cms_metadata_value_service.ListCmsMetadataValuesResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("CmsMetadataValueServiceTransport",)

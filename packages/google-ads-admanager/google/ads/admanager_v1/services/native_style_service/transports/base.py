...
class NativeStyleServiceTransport(abc.ABC):
    """Abstract transport class for NativeStyleService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_native_style: gapic_v1.method.wrap_method(
                self.get_native_style,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_native_styles: gapic_v1.method.wrap_method(
            ...
            self.batch_update_native_styles: gapic_v1.method.wrap_method(
                self.batch_update_native_styles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_activate_native_styles: gapic_v1.method.wrap_method(
                self.batch_activate_native_styles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_deactivate_native_styles: gapic_v1.method.wrap_method(
                self.batch_deactivate_native_styles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_archive_native_styles: gapic_v1.method.wrap_method(
    ...
    def list_native_styles(
        ...
        Union[
            ...
            Awaitable[native_style_service.ListNativeStylesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_update_native_styles(
        ...
        Union[
            ...
            Awaitable[native_style_service.BatchUpdateNativeStylesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_activate_native_styles(
        ...
        Union[
            ...
            Awaitable[native_style_service.BatchActivateNativeStylesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_deactivate_native_styles(
        ...
        Union[
            ...
            Awaitable[native_style_service.BatchDeactivateNativeStylesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def batch_archive_native_styles(
        ...
        Union[
            ...
            Awaitable[native_style_service.BatchArchiveNativeStylesResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("NativeStyleServiceTransport",)

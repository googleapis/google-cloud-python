...
from .transports.base import DEFAULT_CLIENT_INFO, NativeStyleServiceTransport
from .transports.rest import NativeStyleServiceRestTransport


class NativeStyleServiceClientMeta(type):
    """Metaclass for the NativeStyleService client.
    ...
    ) -> Type[NativeStyleServiceTransport]:
...
class NativeStyleServiceClient(metaclass=NativeStyleServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NativeStyleServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> NativeStyleServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            NativeStyleServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def creative_template_path(
        network_code: str,
        creative_template: str,
    ) -> str:
        """Returns a fully-qualified creative_template string."""
        return "networks/{network_code}/creativeTemplates/{creative_template}".format(
            network_code=network_code,
            creative_template=creative_template,
        )

    @staticmethod
    def parse_creative_template_path(path: str) -> Dict[str, str]:
        """Parses a creative_template path into its component segments."""
        m = re.match(
            r"^networks/(?P<network_code>.+?)/creativeTemplates/(?P<creative_template>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def native_style_path(
        network_code: str,
        native_style: str,
    ) -> str:
        """Returns a fully-qualified native_style string."""
        return "networks/{network_code}/nativeStyles/{native_style}".format(
            network_code=network_code,
            native_style=native_style,
        )

    @staticmethod
    def parse_native_style_path(path: str) -> Dict[str, str]:
        """Parses a native_style path into its component segments."""
        m = re.match(
            r"^networks/(?P<network_code>.+?)/nativeStyles/(?P<native_style>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = NativeStyleServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = NativeStyleServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = NativeStyleServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NativeStyleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = NativeStyleServiceClient._DEFAULT_UNIVERSE
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., NativeStyleServiceTransport],
            ]
        ] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the native style service client.
        ...
        Args:
            ...
            transport (Optional[Union[str,NativeStyleServiceTransport,Callable[..., NativeStyleServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the NativeStyleServiceTransport constructor.
        ...
        self._client_cert_source = NativeStyleServiceClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, NativeStyleServiceTransport)
        if transport_provided:
            # transport is a NativeStyleServiceTransport instance.
            ...
            self._transport = cast(NativeStyleServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or NativeStyleServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                NativeStyleServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., NativeStyleServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.admanager_v1.NativeStyleServiceClient`.",
                    extra={
    ...
    def get_native_style(
        self,
        request: Optional[
            Union[native_style_service.GetNativeStyleRequest, dict]
        ] = None,
        *,
        ...
        r"""Retrieves a ``NativeStyle`` object.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.GetNativeStyleRequest, dict]):
        ...
        if not isinstance(request, native_style_service.GetNativeStyleRequest):
            request = native_style_service.GetNativeStyleRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_native_style]
    ...
    def list_native_styles(
        self,
        request: Optional[
            Union[native_style_service.ListNativeStylesRequest, dict]
        ] = None,
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListNativeStylesPager:
        r"""Lists ``NativeStyle`` objects.
        ...
        .. code-block:: python
            ...
            def sample_list_native_styles():
                # Create a client
                client = admanager_v1.NativeStyleServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.ListNativeStylesRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_native_styles(request=request)
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.ListNativeStylesRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.services.native_style_service.pagers.ListNativeStylesPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, native_style_service.ListNativeStylesRequest):
            request = native_style_service.ListNativeStylesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_native_styles]
        ...
        response = pagers.ListNativeStylesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def batch_create_native_styles(
        self,
        request: Optional[
            Union[native_style_service.BatchCreateNativeStylesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[native_style_service.CreateNativeStyleRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> native_style_service.BatchCreateNativeStylesResponse:
        r"""Creates ``NativeStyle`` objects.
        ...
        .. code-block:: python
            ...
            def sample_batch_create_native_styles():
                # Create a client
                client = admanager_v1.NativeStyleServiceClient()

                # Initialize request argument(s)
                requests = admanager_v1.CreateNativeStyleRequest()
                requests.parent = "parent_value"
                requests.native_style.size.width = 544
                requests.native_style.size.height = 633
                requests.native_style.size.size_type = "AUDIO"

                request = admanager_v1.BatchCreateNativeStylesRequest(
                    parent="parent_value",
                    requests=requests,
                )

                # Make the request
                response = client.batch_create_native_styles(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchCreateNativeStylesRequest, dict]):
                The request object. Request object for ``BatchCreateNativeStyles`` method.
            parent (str):
                Required. The parent resource where ``NativeStyles``
                will be created. Format: ``networks/{network_code}`` The
                parent field in the CreateNativeStyleRequest must match
                this field.
            ...
            requests (MutableSequence[google.ads.admanager_v1.types.CreateNativeStyleRequest]):
                Required. The ``NativeStyle`` objects to create. A
        ...
        Returns:
            google.ads.admanager_v1.types.BatchCreateNativeStylesResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, native_style_service.BatchCreateNativeStylesRequest):
            request = native_style_service.BatchCreateNativeStylesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.batch_create_native_styles
        ]
    ...
    def batch_update_native_styles(
        self,
        request: Optional[
            Union[native_style_service.BatchUpdateNativeStylesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        requests: Optional[
            MutableSequence[native_style_service.UpdateNativeStyleRequest]
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> native_style_service.BatchUpdateNativeStylesResponse:
        r"""Batch updates ``NativeStyle`` objects.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchUpdateNativeStylesRequest, dict]):
                The request object. Request object for ``BatchUpdateNativeStyles`` method.
            parent (str):
                Required. The parent resource where ``NativeStyles``
                will be updated. Format: ``networks/{network_code}`` The
                parent field in the UpdateNativeStyleRequest must match
                this field.
            ...
            requests (MutableSequence[google.ads.admanager_v1.types.UpdateNativeStyleRequest]):
                Required. The ``NativeStyle`` objects to update. A
        ...
        Returns:
            google.ads.admanager_v1.types.BatchUpdateNativeStylesResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, native_style_service.BatchUpdateNativeStylesRequest):
            request = native_style_service.BatchUpdateNativeStylesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_update_native_styles
        ]
    ...
    def batch_activate_native_styles(
        self,
        request: Optional[
            Union[native_style_service.BatchActivateNativeStylesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        ...
        r"""Beginning of non-CRUD Activates a list of ``NativeStyle``
        objects.
        ...
        .. code-block:: python
            ...
            def sample_batch_activate_native_styles():
                # Create a client
                client = admanager_v1.NativeStyleServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.BatchActivateNativeStylesRequest(
                    parent="parent_value",
                    names=['names_value1', 'names_value2'],
                )

                # Make the request
                response = client.batch_activate_native_styles(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchActivateNativeStylesRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.types.BatchActivateNativeStylesResponse:
        ...
        if not isinstance(
            ...
            request = native_style_service.BatchActivateNativeStylesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_activate_native_styles
        ]
    ...
    def batch_deactivate_native_styles(
        self,
        request: Optional[
            Union[native_style_service.BatchDeactivateNativeStylesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        names: Optional[MutableSequence[str]] = None,
        ...
        r"""Deactivates a list of ``NativeStyle`` objects.
        ...
        Args:
            request (Union[google.ads.admanager_v1.types.BatchDeactivateNativeStylesRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.types.BatchDeactivateNativeStylesResponse:
        ...
        if not isinstance(
            ...
            request = native_style_service.BatchDeactivateNativeStylesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_deactivate_native_styles
        ]
    ...
    def batch_archive_native_styles(
        self,
        request: Optional[
            Union[native_style_service.BatchArchiveNativeStylesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        names: Optional[MutableSequence[str]] = None,
        ...
        r"""Archives a list of ``NativeStyle`` objects.
        ...
        .. code-block:: python
            ...
            def sample_batch_archive_native_styles():
                # Create a client
                client = admanager_v1.NativeStyleServiceClient()

                # Initialize request argument(s)
                request = admanager_v1.BatchArchiveNativeStylesRequest(
                    parent="parent_value",
                    names=['names_value1', 'names_value2'],
                )

                # Make the request
                response = client.batch_archive_native_styles(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.admanager_v1.types.BatchArchiveNativeStylesRequest, dict]):
        ...
        Returns:
            google.ads.admanager_v1.types.BatchArchiveNativeStylesResponse:
        ...
        if not isinstance(
            ...
            request = native_style_service.BatchArchiveNativeStylesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_archive_native_styles
        ]
    ...
    def __enter__(self) -> "NativeStyleServiceClient":
        return self
...
__all__ = ("NativeStyleServiceClient",)

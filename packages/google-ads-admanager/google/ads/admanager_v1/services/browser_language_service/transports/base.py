...
class BrowserLanguageServiceTransport(abc.ABC):
    """Abstract transport class for BrowserLanguageService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_browser_language: gapic_v1.method.wrap_method(
                self.get_browser_language,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_browser_languages: gapic_v1.method.wrap_method(
    ...
    def get_browser_language(
        ...
        Union[browser_language_messages.BrowserLanguage, Awaitable[browser_language_messages.BrowserLanguage]],
    ]:
        raise NotImplementedError()
    ...
    def list_browser_languages(
        ...
        Union[browser_language_service.ListBrowserLanguagesResponse, Awaitable[browser_language_service.ListBrowserLanguagesResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("BrowserLanguageServiceTransport",)

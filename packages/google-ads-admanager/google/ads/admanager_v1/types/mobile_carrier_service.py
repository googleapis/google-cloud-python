...
from google.ads.admanager_v1.types import mobile_carrier_messages
...
class GetMobileCarrierRequest(proto.Message):
    r"""Request object for ``GetMobileCarrier`` method.
...
class ListMobileCarriersRequest(proto.Message):
    r"""Request object for ``ListMobileCarriers`` method.

    Attributes:
        parent (str):
            Required. The parent, which owns this collection of
            MobileCarriers. Format: ``networks/{network_code}``
        page_size (int):
            Optional. The maximum number of ``MobileCarriers`` to
            return. The service may return fewer than this value. If
            unspecified, at most 50 ``MobileCarriers`` will be returned.
            The maximum value is 1000; values greater than 1000 will be
            coerced to 1000.
        page_token (str):
            Optional. A page token, received from a previous
            ``ListMobileCarriers`` call. Provide this to retrieve the
            subsequent page.
...
class ListMobileCarriersResponse(proto.Message):
    r"""Response object for ``ListMobileCarriersRequest`` containing
    matching ``MobileCarrier`` objects.

    Attributes:
        mobile_carriers (MutableSequence[google.ads.admanager_v1.types.MobileCarrier]):
        ...
        next_page_token (str):
            ...
            pages.
        total_size (int):
            Total number of ``MobileCarrier`` objects. If a filter was

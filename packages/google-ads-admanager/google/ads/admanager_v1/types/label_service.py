...
class ListLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            Optional. The maximum number of Labels to
            return. The service may return fewer than this
            value. If unspecified, at most 50 labels will be
...
class ListLabelsResponse(proto.Message):
    ...
    Attributes:
        ...
        next_page_token (str):
            ...
            pages.
        total_size (int):
            Total number of Labels. If a filter was included in the

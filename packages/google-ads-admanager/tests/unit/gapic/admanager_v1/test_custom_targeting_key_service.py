...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CustomTargetingKeyServiceClient(credentials=cred)
...
def test_custom_targeting_key_service_client_get_transport_class():
    transport = CustomTargetingKeyServiceClient.get_transport_class()
    ...
    assert transport == transports.CustomTargetingKeyServiceRestTransport
...
def test_get_custom_targeting_key_rest_use_cached_wrapped_rpc():
...
def test_get_custom_targeting_key_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetCustomTargetingKey,
...
def test_get_custom_targeting_key_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_custom_targeting_key(**mock_args)
...
def test_list_custom_targeting_keys_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_list_custom_targeting_keys_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListCustomTargetingKeys,
    ...
    # Designate an appropriate value for the returned response.
    return_value = custom_targeting_key_service.ListCustomTargetingKeysResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.list_custom_targeting_keys(request)
...
def test_list_custom_targeting_keys_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_custom_targeting_keys(**mock_args)
...
def test_list_custom_targeting_keys_rest_pager(transport: str = "rest"):
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_custom_targeting_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_create_custom_targeting_key_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateCustomTargetingKey,
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.create_custom_targeting_key(request)
...
def test_create_custom_targeting_key_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_custom_targeting_key(**mock_args)
...
def test_batch_create_custom_targeting_keys_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_batch_create_custom_targeting_keys_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateCustomTargetingKeys,
...
def test_batch_create_custom_targeting_keys_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_create_custom_targeting_keys(**mock_args)
...
def test_update_custom_targeting_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_update_custom_targeting_key_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateCustomTargetingKey,
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.update_custom_targeting_key(request)
...
def test_update_custom_targeting_key_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_custom_targeting_key(**mock_args)
...
def test_batch_update_custom_targeting_keys_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_batch_update_custom_targeting_keys_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateCustomTargetingKeys,
...
def test_batch_update_custom_targeting_keys_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_update_custom_targeting_keys(**mock_args)
...
def test_batch_activate_custom_targeting_keys_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_batch_activate_custom_targeting_keys_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchActivateCustomTargetingKeys,
...
def test_batch_activate_custom_targeting_keys_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_activate_custom_targeting_keys(**mock_args)
...
def test_batch_deactivate_custom_targeting_keys_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CustomTargetingKeyServiceClient(
...
def test_batch_deactivate_custom_targeting_keys_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchDeactivateCustomTargetingKeys,
...
def test_batch_deactivate_custom_targeting_keys_rest_flattened():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_deactivate_custom_targeting_keys(**mock_args)
...
def test_get_custom_targeting_key_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        return_value = custom_targeting_key_messages.CustomTargetingKey(
            ...
            type_=custom_targeting_key_enums.CustomTargetingKeyTypeEnum.CustomTargetingKeyType.PREDEFINED,
            status=custom_targeting_key_enums.CustomTargetingKeyStatusEnum.CustomTargetingKeyStatus.ACTIVE,
            reportable_type=custom_targeting_key_enums.CustomTargetingKeyReportableTypeEnum.CustomTargetingKeyReportableType.OFF,
        )
...
def test_list_custom_targeting_keys_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListCustomTargetingKeysPager)
...
def test_create_custom_targeting_key_rest_call_success(request_type):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["custom_targeting_key"][field])):
                    del request_init["custom_targeting_key"][field][i][subfield]
            else:
                del request_init["custom_targeting_key"][field][subfield]
    request = request_type(**request_init)
...
def test_batch_activate_custom_targeting_keys_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = custom_targeting_key_service.BatchActivateCustomTargetingKeysResponse.to_json(
            custom_targeting_key_service.BatchActivateCustomTargetingKeysResponse()
        )
        req.return_value.content = return_value
...
def test_batch_deactivate_custom_targeting_keys_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = custom_targeting_key_service.BatchDeactivateCustomTargetingKeysResponse.to_json(
            custom_targeting_key_service.BatchDeactivateCustomTargetingKeysResponse()
        )
        req.return_value.content = return_value
...
def test_get_custom_targeting_key_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_custom_targeting_keys_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_custom_targeting_key_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_custom_targeting_keys_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_custom_targeting_key_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_custom_targeting_keys_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_activate_custom_targeting_keys_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_deactivate_custom_targeting_keys_empty_call_rest():
    client = CustomTargetingKeyServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_custom_targeting_key_service_base_transport_error():
...
def test_custom_targeting_key_service_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.ads.admanager_v1.services.custom_targeting_key_service.transports.CustomTargetingKeyServiceTransport.__init__"
    ) as Transport:
...
def test_custom_targeting_key_service_auth_adc():
...
def test_custom_targeting_key_service_client_transport_session_collision(
    ...
    client2 = CustomTargetingKeyServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.get_custom_targeting_key._session
    session2 = client2.transport.get_custom_targeting_key._session
    assert session1 != session2
    session1 = client1.transport.list_custom_targeting_keys._session
    session2 = client2.transport.list_custom_targeting_keys._session
    assert session1 != session2
    session1 = client1.transport.create_custom_targeting_key._session
    session2 = client2.transport.create_custom_targeting_key._session
    assert session1 != session2
    session1 = client1.transport.batch_create_custom_targeting_keys._session
    session2 = client2.transport.batch_create_custom_targeting_keys._session
    assert session1 != session2
    session1 = client1.transport.update_custom_targeting_key._session
    session2 = client2.transport.update_custom_targeting_key._session
    assert session1 != session2
    session1 = client1.transport.batch_update_custom_targeting_keys._session
    session2 = client2.transport.batch_update_custom_targeting_keys._session
    assert session1 != session2
    session1 = client1.transport.batch_activate_custom_targeting_keys._session
    session2 = client2.transport.batch_activate_custom_targeting_keys._session
    assert session1 != session2
    session1 = client1.transport.batch_deactivate_custom_targeting_keys._session
    session2 = client2.transport.batch_deactivate_custom_targeting_keys._session
    assert session1 != session2
...
def test_parse_custom_targeting_key_path():
    ...
    path = CustomTargetingKeyServiceClient.custom_targeting_key_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_custom_targeting_key_path(path)
    assert expected == actual
...
def test_network_path():
    ...
    actual = CustomTargetingKeyServiceClient.network_path(network_code)
    assert expected == actual
...
def test_parse_network_path():
    ...
    path = CustomTargetingKeyServiceClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_network_path(path)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = CustomTargetingKeyServiceClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = CustomTargetingKeyServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = CustomTargetingKeyServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = CustomTargetingKeyServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = CustomTargetingKeyServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = CustomTargetingKeyServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = CustomTargetingKeyServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = CustomTargetingKeyServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = CustomTargetingKeyServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = CustomTargetingKeyServiceClient.parse_common_location_path(path)
    assert expected == actual

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        UserServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test_get_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=networks/*/users/*}" % client.transport._host, args[1]
        )
...
def test_user_service_base_transport():
    ...
    with mock.patch(
        "google.ads.admanager_v1.services.user_service.transports.UserServiceTransport.__init__"
    ) as Transport:

...
def test__get_default_mtls_endpoint():
    ...
    assert NativeStyleServiceClient._get_default_mtls_endpoint(None) is None
    assert (
        NativeStyleServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        NativeStyleServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        NativeStyleServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        NativeStyleServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        NativeStyleServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        NativeStyleServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert NativeStyleServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                NativeStyleServiceClient._read_environment_variables()
            assert (
                str(excinfo.value)
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert NativeStyleServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert NativeStyleServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                NativeStyleServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        NativeStyleServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == NativeStyleServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        NativeStyleServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        NativeStyleServiceClient._get_api_endpoint(
    ...
    assert (
        NativeStyleServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        NativeStyleServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        NativeStyleServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        NativeStyleServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        NativeStyleServiceClient._get_universe_domain(None, None)
        == NativeStyleServiceClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        NativeStyleServiceClient._get_universe_domain("", None)
...
def test_get_native_style_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_native_style._get_unset_required_fields(jsonified_request)
...
def test_get_native_style_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.get_native_style._get_unset_required_fields({})
...
def test_list_native_styles_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_native_styles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_native_styles_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.list_native_styles._get_unset_required_fields({})
...
def test_batch_create_native_styles_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_create_native_styles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_native_styles_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.batch_create_native_styles._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_batch_update_native_styles_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_update_native_styles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_native_styles_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.batch_update_native_styles._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_batch_activate_native_styles_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_activate_native_styles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_activate_native_styles_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.batch_activate_native_styles._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_batch_deactivate_native_styles_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_deactivate_native_styles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_deactivate_native_styles_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.batch_deactivate_native_styles._get_unset_required_fields(
        {}
    )
    assert set(unset_fields) == (
        set(())
...
def test_batch_archive_native_styles_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_archive_native_styles._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_archive_native_styles_rest_unset_required_fields():
    transport = transports.NativeStyleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.batch_archive_native_styles._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (

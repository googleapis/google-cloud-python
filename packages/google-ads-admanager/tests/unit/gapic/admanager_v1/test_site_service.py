...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SiteServiceClient(credentials=cred)
...
def test_site_service_client_get_transport_class():
    transport = SiteServiceClient.get_transport_class()
    ...
    assert transport == transports.SiteServiceRestTransport
...
@pytest.mark.parametrize(
    ...
    [
        (SiteServiceClient, transports.SiteServiceRestTransport, "rest", "true"),
...
def test_get_site_rest_required_fields(request_type=site_service.GetSiteRequest):
    ...
    return_value = site_messages.Site()
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = site_messages.Site.pb(return_value)
...
def test_get_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {"name": "networks/sample1/sites/sample2"}
...
def test_list_sites_rest_required_fields(request_type=site_service.ListSitesRequest):
    transport_class = transports.SiteServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseListSites,
    ...
    # Designate an appropriate value for the returned response.
    return_value = site_service.ListSitesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = site_service.ListSitesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_sites_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(site_service.ListSitesResponse.to_json(x) for x in response)
...
def test_create_site_rest_required_fields(request_type=site_service.CreateSiteRequest):
    transport_class = transports.SiteServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseCreateSite,
...
def test_batch_create_sites_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_create_sites] = (
            mock_rpc
        )
...
def test_batch_create_sites_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateSites,
    ...
    # Designate an appropriate value for the returned response.
    return_value = site_service.BatchCreateSitesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = site_service.BatchCreateSitesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
            ...
            response = client.batch_create_sites(request)
...
def test_batch_create_sites_rest_flattened():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            parent="parent_value",
            requests=[site_service.CreateSiteRequest(parent="parent_value")],
        )
        mock_args.update(sample_request)
        ...
        client.batch_create_sites(**mock_args)
...
def test_update_site_rest_required_fields(request_type=site_service.UpdateSiteRequest):
    transport_class = transports.SiteServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseUpdateSite,
...
def test_update_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"site": {"name": "networks/sample1/sites/sample2"}}
...
def test_batch_update_sites_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SiteServiceClient(
        ...
        client._transport._wrapped_methods[client._transport.batch_update_sites] = (
            mock_rpc
        )
...
def test_batch_update_sites_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateSites,
    ...
    # Designate an appropriate value for the returned response.
    return_value = site_service.BatchUpdateSitesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = site_service.BatchUpdateSitesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
            ...
            response = client.batch_update_sites(request)
...
def test_batch_update_sites_rest_flattened():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_update_sites(**mock_args)
...
def test_batch_deactivate_sites_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SiteServiceClient(
        ...
        client._transport._wrapped_methods[client._transport.batch_deactivate_sites] = (
            mock_rpc
        )
...
def test_batch_deactivate_sites_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchDeactivateSites,
    ...
    # Designate an appropriate value for the returned response.
    return_value = site_service.BatchDeactivateSitesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = site_service.BatchDeactivateSitesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
            ...
            response = client.batch_deactivate_sites(request)
...
def test_batch_deactivate_sites_rest_flattened():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_deactivate_sites(**mock_args)
...
def test_batch_submit_sites_for_approval_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SiteServiceClient(
...
def test_batch_submit_sites_for_approval_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchSubmitSitesForApproval,
    ...
    # Designate an appropriate value for the returned response.
    return_value = site_service.BatchSubmitSitesForApprovalResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.batch_submit_sites_for_approval(request)
...
def test_batch_submit_sites_for_approval_rest_flattened():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.batch_submit_sites_for_approval(**mock_args)
...
def test_get_site_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        return_value = site_messages.Site(
            name="name_value",
            url="url_value",
            child_network_code="child_network_code_value",
            approval_status=site_enums.SiteApprovalStatusEnum.SiteApprovalStatus.APPROVED,
        )
    ...
    assert isinstance(response, site_messages.Site)
...
def test_get_site_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        pb_message = site_service.GetSiteRequest.pb(site_service.GetSiteRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = site_messages.Site.to_json(site_messages.Site())
        ...
        post.return_value = site_messages.Site()
        post_with_metadata.return_value = site_messages.Site(), metadata
...
def test_list_sites_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = site_service.ListSitesRequest.pb(site_service.ListSitesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        pre.return_value = request, metadata
        post.return_value = site_service.ListSitesResponse()
        post_with_metadata.return_value = site_service.ListSitesResponse(), metadata
...
def test_create_site_rest_call_success(request_type):
    ...
    request_init["site"] = {
        ...
        "child_network_code": "child_network_code_value",
        "approval_status": 1,
        "approval_status_update_time": {"seconds": 751, "nanos": 543},
        "disapproval_reasons": [{"type_": 1, "details": "details_value"}],
    }
    ...
    test_field = site_service.CreateSiteRequest.meta.fields["site"]
...
def test_create_site_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = site_service.CreateSiteRequest.pb(site_service.CreateSiteRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_batch_create_sites_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, site_service.BatchCreateSitesResponse)
...
def test_update_site_rest_call_success(request_type):
    ...
    request_init = {"site": {"name": "networks/sample1/sites/sample2"}}
    request_init["site"] = {
        "name": "networks/sample1/sites/sample2",
        "url": "url_value",
        "child_network_code": "child_network_code_value",
        "approval_status": 1,
        "approval_status_update_time": {"seconds": 751, "nanos": 543},
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = site_service.UpdateSiteRequest.meta.fields["site"]
...
def test_update_site_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = site_service.UpdateSiteRequest.pb(site_service.UpdateSiteRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_batch_update_sites_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, site_service.BatchUpdateSitesResponse)
...
def test_batch_deactivate_sites_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, site_service.BatchDeactivateSitesResponse)
...
def test_batch_submit_sites_for_approval_rest_call_success(request_type):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, site_service.BatchSubmitSitesForApprovalResponse)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_sites_empty_call_rest():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_sites_empty_call_rest():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_deactivate_sites_empty_call_rest():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_submit_sites_for_approval_empty_call_rest():
    client = SiteServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_site_service_auth_adc():
...
def test_site_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = SiteServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SiteServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    assert session1 != session2
    session1 = client1.transport.batch_create_sites._session
    session2 = client2.transport.batch_create_sites._session
    assert session1 != session2
    session1 = client1.transport.update_site._session
    session2 = client2.transport.update_site._session
    assert session1 != session2
    session1 = client1.transport.batch_update_sites._session
    session2 = client2.transport.batch_update_sites._session
    assert session1 != session2
    session1 = client1.transport.batch_deactivate_sites._session
    session2 = client2.transport.batch_deactivate_sites._session
    assert session1 != session2
    session1 = client1.transport.batch_submit_sites_for_approval._session
    session2 = client2.transport.batch_submit_sites_for_approval._session
    assert session1 != session2
...
def test_network_path():
    ...
    actual = SiteServiceClient.network_path(network_code)
...
def test_parse_network_path():
    ...
    path = SiteServiceClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_network_path(path)
    assert expected == actual
...
def test_site_path():
    network_code = "whelk"
    site = "octopus"
    expected = "networks/{network_code}/sites/{site}".format(
        network_code=network_code,
        site=site,
    )
    actual = SiteServiceClient.site_path(network_code, site)
    assert expected == actual
...
def test_parse_site_path():
    ...
    path = SiteServiceClient.site_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_site_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = SiteServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = SiteServiceClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = SiteServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = SiteServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = SiteServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = SiteServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = SiteServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = SiteServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = SiteServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = SiteServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = SiteServiceClient.parse_common_location_path(path)
    assert expected == actual
...
@pytest.mark.parametrize(
    ...
    [
        (SiteServiceClient, transports.SiteServiceRestTransport),
    ],
)

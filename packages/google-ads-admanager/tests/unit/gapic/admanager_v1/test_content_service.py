...
def test_get_content_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetContent,
        "_BaseGetContent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_list_content_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListContent,
        "_BaseListContent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

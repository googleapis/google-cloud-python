...
from google.ads.admanager_v1.services.content_service import ContentServiceClient, pagers, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ContentServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ContentServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ContentServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ContentServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ContentServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ContentServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ContentServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ContentServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ContentServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ContentServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ContentServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source
...
def test__get_api_endpoint():
    ...
    default_endpoint = ContentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ContentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ContentServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ContentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ContentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ContentServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ContentServiceClient._get_api_endpoint(None, None, default_universe, "always") == ContentServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ContentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ContentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ContentServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ContentServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ContentServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ContentServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ContentServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ContentServiceClient._get_universe_domain(None, None) == ContentServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ContentServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.ContentServiceRestTransport, "rest"),
    ],
)
...
def test_content_service_client_get_transport_class():
    ...
    assert transport == transports.ContentServiceRestTransport


@pytest.mark.parametrize(
    "client_class,transport_class,transport_name",
    [
        (ContentServiceClient, transports.ContentServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(ContentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ContentServiceClient))
...
@pytest.mark.parametrize(
    ...
    [
        (ContentServiceClient, transports.ContentServiceRestTransport, "rest", "true"),
        (ContentServiceClient, transports.ContentServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ContentServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ContentServiceClient))
...
@pytest.mark.parametrize("client_class", [ContentServiceClient])
...
@pytest.mark.parametrize(
    ...
    [
        (ContentServiceClient, transports.ContentServiceRestTransport, "rest", None),
    ],
)
...
def test_get_content_rest_required_fields(request_type=content_service.GetContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_content._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = content_messages.Content.pb(return_value)
...
def test_get_content_rest_unset_required_fields():
    transport = transports.ContentServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {"name": "networks/sample1/content/sample2"}
        ...
        assert path_template.validate("%s/v1/{name=networks/*/content/*}" % client.transport._host, args[1])
...
def test_get_content_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.get_content(
            content_service.GetContentRequest(),
            name="name_value",
        )
...
def test_list_content_rest_required_fields(request_type=content_service.ListContentRequest):
    transport_class = transports.ContentServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_content._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = content_service.ListContentResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = content_service.ListContentResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=networks/*}/content" % client.transport._host, args[1])
...
def test_list_content_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list_content(
            content_service.ListContentRequest(),
            parent="parent_value",
        )
...
def test_list_content_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(content_service.ListContentResponse.to_json(x) for x in response)
...
def test_transport_kind_rest():
    transport = ContentServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_content_rest_bad_request(request_type=content_service.GetContentRequest):
    client = ContentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "networks/sample1/content/sample2"}
    request = request_type(**request_init)
...
def test_get_content_rest_interceptors(null_interceptor):
    transport = transports.ContentServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ContentServiceRestInterceptor(),
    )
    client = ContentServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ContentServiceRestInterceptor, "post_get_content") as post, mock.patch.object(
        ...
        pb_message = content_service.GetContentRequest.pb(content_service.GetContentRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = content_messages.Content.to_json(content_messages.Content())
        ...
        post.return_value = content_messages.Content()
        post_with_metadata.return_value = content_messages.Content(), metadata
...
def test_list_content_rest_bad_request(request_type=content_service.ListContentRequest):
    client = ContentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ContentServiceRestInterceptor, "post_list_content") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = content_service.ListContentRequest.pb(content_service.ListContentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = content_service.ListContentResponse.to_json(content_service.ListContentResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = content_service.ListContentResponse()
        post_with_metadata.return_value = content_service.ListContentResponse(), metadata
...
def test_content_service_base_transport():
    ...
    with mock.patch("google.ads.admanager_v1.services.content_service.transports.ContentServiceTransport.__init__") as Transport:
...
def test_content_service_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ContentServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_content_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = ContentServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ContentServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_content_path():
    ...
    actual = ContentServiceClient.content_path(network_code, content)
...
def test_network_path():
    ...
    actual = ContentServiceClient.network_path(network_code)
    assert expected == actual
...
def test_parse_network_path():
    ...
    path = ContentServiceClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = ContentServiceClient.parse_network_path(path)
    assert expected == actual
...
@pytest.mark.parametrize(
    ...
    [
        (ContentServiceClient, transports.ContentServiceRestTransport),
    ],
)

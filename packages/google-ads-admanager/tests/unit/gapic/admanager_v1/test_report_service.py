...
from google.ads.admanager_v1.services.report_service import ReportServiceClient, pagers, transports
from google.ads.admanager_v1.types import report_definition, report_messages, report_service, report_value
...
def test_get_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{name=networks/*/reports/*}" % client.transport._host, args[1])
...
def test_list_reports_rest_required_fields(request_type=report_service.ListReportsRequest):
    transport_class = transports.ReportServiceRestTransport
...
def test_list_reports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=networks/*}/reports" % client.transport._host, args[1])
...
def test_list_reports_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(report_service.ListReportsResponse.to_json(x) for x in response)
...
def test_create_report_rest_required_fields(request_type=report_service.CreateReportRequest):
    transport_class = transports.ReportServiceRestTransport
...
def test_update_report_rest_required_fields(request_type=report_service.UpdateReportRequest):
    transport_class = transports.ReportServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_report._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{report.name=networks/*/reports/*}" % client.transport._host, args[1])
...
def test_run_report_rest_required_fields(request_type=report_service.RunReportRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).run_report._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_report_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=networks/*/reports/*}:run" % client.transport._host, args[1])
...
def test_fetch_report_result_rows_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_report_result_rows in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_report_result_rows] = mock_rpc
...
def test_fetch_report_result_rows_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=networks/*/reports/*/results/*}:fetchRows" % client.transport._host, args[1])
...
def test_fetch_report_result_rows_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(report_service.FetchReportResultRowsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.ReportServiceRestInterceptor, "post_get_report") as post, mock.patch.object(
        ...
        pb_message = report_service.GetReportRequest.pb(report_service.GetReportRequest())
...
def test_list_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ReportServiceRestInterceptor, "post_list_reports") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = report_service.ListReportsRequest.pb(report_service.ListReportsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = report_service.ListReportsResponse.to_json(report_service.ListReportsResponse())
        req.return_value.content = return_value
...
def test_create_report_rest_bad_request(request_type=report_service.CreateReportRequest):
    client = ReportServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "networks/sample1"}
    request = request_type(**request_init)
...
def test_create_report_rest_call_success(request_type):
    ...
    request_init["report"] = {
        ...
        "report_definition": {
            ...
            "date_range": {"fixed": {"start_date": {"year": 433, "month": 550, "day": 318}, "end_date": {}}, "relative": 1},
            ...
            "sorts": [{"field": {}, "descending": True, "slice_": {}, "time_period_index": 1800, "metric_value_type": 1}],
        },
        "display_name": "display_name_value",
...
def test_create_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ReportServiceRestInterceptor, "post_create_report") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = report_service.CreateReportRequest.pb(report_service.CreateReportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_report_rest_bad_request(request_type=report_service.UpdateReportRequest):
    client = ReportServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ReportServiceRestInterceptor, "post_update_report") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = report_service.UpdateReportRequest.pb(report_service.UpdateReportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_run_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = report_service.RunReportRequest.pb(report_service.RunReportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_fetch_report_result_rows_rest_bad_request(request_type=report_service.FetchReportResultRowsRequest):
    client = ReportServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_fetch_report_result_rows_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ReportServiceRestInterceptor, "post_fetch_report_result_rows") as post, mock.patch.object(
        transports.ReportServiceRestInterceptor, "post_fetch_report_result_rows_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = report_service.FetchReportResultRowsRequest.pb(report_service.FetchReportResultRowsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = report_service.FetchReportResultRowsResponse.to_json(report_service.FetchReportResultRowsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = report_service.FetchReportResultRowsResponse(), metadata
...
def test_fetch_report_result_rows_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.fetch_report_result_rows), "__call__") as call:
...
def test_report_service_base_transport():
    ...
    with mock.patch("google.ads.admanager_v1.services.report_service.transports.ReportServiceTransport.__init__") as Transport:

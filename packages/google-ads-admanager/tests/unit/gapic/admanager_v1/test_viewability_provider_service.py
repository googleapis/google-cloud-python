...
def test__get_default_mtls_endpoint():
    ...
    assert ViewabilityProviderServiceClient._get_default_mtls_endpoint(None) is None
    assert (
        ViewabilityProviderServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ViewabilityProviderServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ViewabilityProviderServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ViewabilityProviderServiceClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
    assert (
        ViewabilityProviderServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        ViewabilityProviderServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert ViewabilityProviderServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ViewabilityProviderServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                ViewabilityProviderServiceClient._use_client_cert_effective() is False
            )
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ViewabilityProviderServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        ViewabilityProviderServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == ViewabilityProviderServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ViewabilityProviderServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ViewabilityProviderServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ViewabilityProviderServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ViewabilityProviderServiceClient._get_universe_domain(None, None)
        == ViewabilityProviderServiceClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        ViewabilityProviderServiceClient._get_universe_domain("", None)
...
def test_get_viewability_provider_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_viewability_provider._get_unset_required_fields(jsonified_request)
...
def test_get_viewability_provider_rest_unset_required_fields():
    transport = transports.ViewabilityProviderServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.get_viewability_provider._get_unset_required_fields({})
...
def test_list_viewability_providers_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_viewability_providers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_viewability_providers_rest_unset_required_fields():
    transport = transports.ViewabilityProviderServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.list_viewability_providers._get_unset_required_fields({})
...
def test_create_viewability_provider_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_viewability_provider._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_viewability_provider_rest_unset_required_fields():
    transport = transports.ViewabilityProviderServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.create_viewability_provider._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_batch_create_viewability_providers_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_create_viewability_providers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_viewability_providers_rest_unset_required_fields():
    transport = transports.ViewabilityProviderServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = (
        transport.batch_create_viewability_providers._get_unset_required_fields({})
    )
    assert set(unset_fields) == (
        set(())
        & set(
...
def test_update_viewability_provider_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_viewability_provider._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_viewability_provider_rest_unset_required_fields():
    transport = transports.ViewabilityProviderServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.update_viewability_provider._get_unset_required_fields({})
    assert set(unset_fields) == (set(("updateMask",)) & set(("viewabilityProvider",)))
...
def test_batch_update_viewability_providers_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_update_viewability_providers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_viewability_providers_rest_unset_required_fields():
    transport = transports.ViewabilityProviderServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = (
        transport.batch_update_viewability_providers._get_unset_required_fields({})
    )
    assert set(unset_fields) == (
        set(())
        & set(

...
def test_create_team_rest_required_fields(request_type=team_service.CreateTeamRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_team._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_teams_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_create_teams in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.batch_create_teams] = (
            mock_rpc
        )
...
def test_batch_create_teams_rest_required_fields(
    request_type=team_service.BatchCreateTeamsRequest,
):
    transport_class = transports.TeamServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_create_teams._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_teams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=networks/*}/teams:batchCreate" % client.transport._host,
            args[1],
        )
...
def test_update_team_rest_required_fields(request_type=team_service.UpdateTeamRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_team._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_team_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask",)) & set(("team",)))
...
def test_update_team_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{team.name=networks/*/teams/*}" % client.transport._host, args[1]
        )
...
def test_batch_update_teams_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_update_teams in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.batch_update_teams] = (
            mock_rpc
        )
...
def test_batch_update_teams_rest_required_fields(
    request_type=team_service.BatchUpdateTeamsRequest,
):
    transport_class = transports.TeamServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_update_teams._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_update_teams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=networks/*}/teams:batchUpdate" % client.transport._host,
            args[1],
        )
...
def test_batch_activate_teams_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_activate_teams in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.batch_activate_teams] = (
            mock_rpc
        )
...
def test_batch_activate_teams_rest_required_fields(
    request_type=team_service.BatchActivateTeamsRequest,
):
    transport_class = transports.TeamServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_activate_teams._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_activate_teams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=networks/*}/teams:batchActivate" % client.transport._host,
            args[1],
        )
...
def test_batch_deactivate_teams_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_deactivate_teams
        ...
        client._transport._wrapped_methods[client._transport.batch_deactivate_teams] = (
            mock_rpc
        )
...
def test_batch_deactivate_teams_rest_required_fields(
    request_type=team_service.BatchDeactivateTeamsRequest,
):
    transport_class = transports.TeamServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_deactivate_teams._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_deactivate_teams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=networks/*}/teams:batchDeactivate" % client.transport._host,
            args[1],
        )
...
def test_list_teams_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = team_service.ListTeamsResponse.to_json(
            team_service.ListTeamsResponse()
        )
        req.return_value.content = return_value
...
def test_batch_create_teams_rest_bad_request(
    request_type=team_service.BatchCreateTeamsRequest,
):
    client = TeamServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_batch_create_teams_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = team_service.BatchCreateTeamsRequest.pb(
            team_service.BatchCreateTeamsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = team_service.BatchCreateTeamsResponse.to_json(
...
def test_batch_update_teams_rest_bad_request(
    request_type=team_service.BatchUpdateTeamsRequest,
):
    client = TeamServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_batch_update_teams_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = team_service.BatchUpdateTeamsRequest.pb(
            team_service.BatchUpdateTeamsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = team_service.BatchUpdateTeamsResponse.to_json(
...
def test_batch_activate_teams_rest_bad_request(
    request_type=team_service.BatchActivateTeamsRequest,
):
    client = TeamServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_batch_activate_teams_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = team_service.BatchActivateTeamsRequest.pb(
            team_service.BatchActivateTeamsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = team_service.BatchActivateTeamsResponse.to_json(
...
def test_batch_deactivate_teams_rest_bad_request(
    request_type=team_service.BatchDeactivateTeamsRequest,
):
    client = TeamServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_batch_deactivate_teams_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = team_service.BatchDeactivateTeamsRequest.pb(
            team_service.BatchDeactivateTeamsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = team_service.BatchDeactivateTeamsResponse.to_json(
...
def test_batch_create_teams_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.batch_create_teams), "__call__"
    ) as call:
...
def test_batch_update_teams_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.batch_update_teams), "__call__"
    ) as call:
...
def test_batch_activate_teams_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.batch_activate_teams), "__call__"
    ) as call:
...
def test_batch_deactivate_teams_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.batch_deactivate_teams), "__call__"
    ) as call:

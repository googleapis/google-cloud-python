...
#
# Snippet for BatchUpdateEntitySignalsMappings
...
def sample_batch_update_entity_signals_mappings():
    # Create a client
    ...
    # Make the request
    response = client.batch_update_entity_signals_mappings(request=request)

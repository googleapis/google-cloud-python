...
#
# Snippet for GetTaxonomyCategory
...
def sample_get_taxonomy_category():
    # Create a client
    client = admanager_v1.TaxonomyCategoryServiceClient()

    # Initialize request argument(s)
    request = admanager_v1.GetTaxonomyCategoryRequest(
        name="name_value",
    )

    # Make the request
    response = client.get_taxonomy_category(request=request)

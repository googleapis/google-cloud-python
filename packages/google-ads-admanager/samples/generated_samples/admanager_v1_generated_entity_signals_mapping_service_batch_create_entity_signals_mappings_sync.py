...
#
# Snippet for BatchCreateEntitySignalsMappings
...
def sample_batch_create_entity_signals_mappings():
    # Create a client
    ...
    # Make the request
    response = client.batch_create_entity_signals_mappings(request=request)

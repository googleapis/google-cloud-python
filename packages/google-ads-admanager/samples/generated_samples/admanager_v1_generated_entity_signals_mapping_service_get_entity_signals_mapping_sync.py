...
#
# Snippet for GetEntitySignalsMapping
...
def sample_get_entity_signals_mapping():
    # Create a client
    client = admanager_v1.EntitySignalsMappingServiceClient()

    # Initialize request argument(s)
    request = admanager_v1.GetEntitySignalsMappingRequest(
        name="name_value",
    )

    # Make the request
    response = client.get_entity_signals_mapping(request=request)

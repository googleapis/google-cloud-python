...
#
# Snippet for GetAudienceSegment
...
def sample_get_audience_segment():
    # Create a client
    client = admanager_v1.AudienceSegmentServiceClient()

    # Initialize request argument(s)
    request = admanager_v1.GetAudienceSegmentRequest(
        name="name_value",
    )

    # Make the request
    response = client.get_audience_segment(request=request)

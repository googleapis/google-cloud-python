...
from google.cloud.datacatalog_v1.services.data_catalog import DataCatalogAsyncClient, DataCatalogClient, pagers, transports
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = DataCatalogClient(credentials=cred)
...
def test_modify_entry_overview_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.modify_entry_overview in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.modify_entry_overview] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_modify_entry_overview_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.modify_entry_overview in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.modify_entry_overview] = mock_rpc
...
@pytest.mark.asyncio
async def test_modify_entry_overview_async(transport: str = "grpc_asyncio", request_type=datacatalog.ModifyEntryOverviewRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_modify_entry_overview_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.modify_entry_overview), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.EntryOverview())
        await client.modify_entry_overview(request)
...
def test_modify_entry_contacts_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.modify_entry_contacts in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.modify_entry_contacts] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_modify_entry_contacts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.modify_entry_contacts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.modify_entry_contacts] = mock_rpc
...
@pytest.mark.asyncio
async def test_modify_entry_contacts_async(transport: str = "grpc_asyncio", request_type=datacatalog.ModifyEntryContactsRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.modify_entry_contacts), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.Contacts())
...
@pytest.mark.asyncio
async def test_reconcile_tags_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.reconcile_tags in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.reconcile_tags] = mock_rpc
...
@pytest.mark.asyncio
async def test_reconcile_tags_async(transport: str = "grpc_asyncio", request_type=datacatalog.ReconcileTagsRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_star_entry_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.star_entry in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.star_entry] = mock_rpc
...
@pytest.mark.asyncio
async def test_star_entry_async(transport: str = "grpc_asyncio", request_type=datacatalog.StarEntryRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.star_entry), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.StarEntryResponse())
...
@pytest.mark.asyncio
async def test_unstar_entry_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.unstar_entry in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.unstar_entry] = mock_rpc
...
@pytest.mark.asyncio
async def test_unstar_entry_async(transport: str = "grpc_asyncio", request_type=datacatalog.UnstarEntryRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.unstar_entry), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.UnstarEntryResponse())
...
@pytest.mark.asyncio
async def test_import_entries_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_entries in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_entries] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_entries_async(transport: str = "grpc_asyncio", request_type=datacatalog.ImportEntriesRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_set_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.set_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.MigrationConfig(
            tag_template_migration=datacatalog.TagTemplateMigration.TAG_TEMPLATE_MIGRATION_ENABLED,
            catalog_ui_experience=datacatalog.CatalogUIExperience.CATALOG_UI_EXPERIENCE_ENABLED,
        )
        response = client.set_config(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = datacatalog.SetConfigRequest()
        assert args[0] == request

    # Establish that the response is the type that we expect.
    assert isinstance(response, datacatalog.MigrationConfig)
    assert response.tag_template_migration == datacatalog.TagTemplateMigration.TAG_TEMPLATE_MIGRATION_ENABLED
    assert response.catalog_ui_experience == datacatalog.CatalogUIExperience.CATALOG_UI_EXPERIENCE_ENABLED


def test_set_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_set_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_config] = mock_rpc
        request = {}
        client.set_config(request)
...
@pytest.mark.asyncio
async def test_set_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_config] = mock_rpc

        request = {}
        await client.set_config(request)
...
@pytest.mark.asyncio
async def test_set_config_async(transport: str = "grpc_asyncio", request_type=datacatalog.SetConfigRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.set_config), "__call__") as call:
        ...
        response = await client.set_config(request)
...
@pytest.mark.asyncio
async def test_set_config_field_headers_async():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.set_config), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.MigrationConfig())
        await client.set_config(request)
...
def test_retrieve_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.retrieve_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = datacatalog.OrganizationConfig()
        response = client.retrieve_config(request)
...
def test_retrieve_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_retrieve_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.retrieve_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.retrieve_config] = mock_rpc
        request = {}
        client.retrieve_config(request)
...
@pytest.mark.asyncio
async def test_retrieve_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.retrieve_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.retrieve_config] = mock_rpc

        request = {}
        await client.retrieve_config(request)
...
@pytest.mark.asyncio
async def test_retrieve_config_async(transport: str = "grpc_asyncio", request_type=datacatalog.RetrieveConfigRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.retrieve_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.OrganizationConfig())
        response = await client.retrieve_config(request)
...
@pytest.mark.asyncio
async def test_retrieve_config_field_headers_async():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_retrieve_effective_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.retrieve_effective_config), "__call__") as call:
        ...
        response = client.retrieve_effective_config(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = datacatalog.RetrieveEffectiveConfigRequest()
        assert args[0] == request
...
def test_retrieve_effective_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_retrieve_effective_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.retrieve_effective_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.retrieve_effective_config] = mock_rpc
        request = {}
        client.retrieve_effective_config(request)
...
@pytest.mark.asyncio
async def test_retrieve_effective_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DataCatalogAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.retrieve_effective_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.retrieve_effective_config] = mock_rpc

        request = {}
        await client.retrieve_effective_config(request)
...
@pytest.mark.asyncio
async def test_retrieve_effective_config_async(transport: str = "grpc_asyncio", request_type=datacatalog.RetrieveEffectiveConfigRequest):
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.retrieve_effective_config), "__call__") as call:
        ...
        response = await client.retrieve_effective_config(request)
...
@pytest.mark.asyncio
async def test_retrieve_effective_config_field_headers_async():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_search_catalog_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.search_catalog), "__call__") as call:
        call.return_value = datacatalog.SearchCatalogResponse()
        client.search_catalog(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_modify_entry_overview_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.modify_entry_overview), "__call__") as call:
        call.return_value = datacatalog.EntryOverview()
        client.modify_entry_overview(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_modify_entry_contacts_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.modify_entry_contacts), "__call__") as call:
        call.return_value = datacatalog.Contacts()
        client.modify_entry_contacts(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_tag_template_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_tag_template_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_tag_template), "__call__") as call:
        call.return_value = tags.TagTemplate()
        client.get_tag_template(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_tag_template_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_tag_template_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_tag_template_field_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_tag_template_field_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_rename_tag_template_field_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_rename_tag_template_field_enum_value_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_tag_template_field_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_reconcile_tags_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.reconcile_tags), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.reconcile_tags(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_star_entry_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.star_entry), "__call__") as call:
        call.return_value = datacatalog.StarEntryResponse()
        client.star_entry(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_unstar_entry_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.unstar_entry), "__call__") as call:
        call.return_value = datacatalog.UnstarEntryResponse()
        client.unstar_entry(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_entries_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.import_entries), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.import_entries(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_config_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.set_config), "__call__") as call:
        call.return_value = datacatalog.MigrationConfig()
        client.set_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_retrieve_config_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.retrieve_config), "__call__") as call:
        call.return_value = datacatalog.OrganizationConfig()
        client.retrieve_config(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_retrieve_effective_config_empty_call_grpc():
    client = DataCatalogClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.retrieve_effective_config), "__call__") as call:
        call.return_value = datacatalog.MigrationConfig()
        client.retrieve_effective_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_catalog_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.search_catalog), "__call__") as call:
        ...
        await client.search_catalog(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_modify_entry_overview_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.modify_entry_overview), "__call__") as call:
        ...
        await client.modify_entry_overview(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_modify_entry_contacts_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.modify_entry_contacts), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.Contacts())
        await client.modify_entry_contacts(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_tag_template_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_tag_template_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_tag_template_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_tag_template_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_tag_template_field_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_tag_template_field), "__call__") as call:
        ...
        await client.create_tag_template_field(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_tag_template_field_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_tag_template_field), "__call__") as call:
        ...
        await client.update_tag_template_field(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_rename_tag_template_field_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.rename_tag_template_field), "__call__") as call:
        ...
        await client.rename_tag_template_field(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_rename_tag_template_field_enum_value_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.rename_tag_template_field_enum_value), "__call__") as call:
        ...
        await client.rename_tag_template_field_enum_value(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_tag_template_field_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_reconcile_tags_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.reconcile_tags), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.reconcile_tags(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_star_entry_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.star_entry), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.StarEntryResponse())
        await client.star_entry(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_unstar_entry_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.unstar_entry), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.UnstarEntryResponse())
        await client.unstar_entry(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_entries_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.import_entries), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.import_entries(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_set_config_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.set_config), "__call__") as call:
        ...
        await client.set_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_retrieve_config_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.retrieve_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(datacatalog.OrganizationConfig())
        await client.retrieve_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_retrieve_effective_config_empty_call_grpc_asyncio():
    client = DataCatalogAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.retrieve_effective_config), "__call__") as call:
        ...
        await client.retrieve_effective_config(request=None)

...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                PolicyTagManagerSerializationClient._use_client_cert_effective() is True
            )
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = PolicyTagManagerSerializationClient(credentials=cred)
...
def test_replace_taxonomy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.replace_taxonomy in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.replace_taxonomy] = (
            mock_rpc
        )
        request = {}
...
def test_import_taxonomies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_taxonomies in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.import_taxonomies] = (
            mock_rpc
        )
        request = {}
...
def test_export_taxonomies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_taxonomies in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.export_taxonomies] = (
            mock_rpc
        )
        request = {}
...
def test_replace_taxonomy_empty_call_grpc():
    client = PolicyTagManagerSerializationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.replace_taxonomy), "__call__") as call:
        call.return_value = policytagmanager.Taxonomy()
        client.replace_taxonomy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_taxonomies_empty_call_grpc():
    client = PolicyTagManagerSerializationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_taxonomies_empty_call_grpc():
    client = PolicyTagManagerSerializationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_replace_taxonomy_empty_call_grpc_asyncio():
    client = PolicyTagManagerSerializationAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_taxonomies_empty_call_grpc_asyncio():
    client = PolicyTagManagerSerializationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_taxonomies_empty_call_grpc_asyncio():
    client = PolicyTagManagerSerializationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_policy_tag_manager_serialization_base_transport():
    ...
    with mock.patch(
        "google.cloud.datacatalog_v1.services.policy_tag_manager_serialization.transports.PolicyTagManagerSerializationTransport.__init__"
    ) as Transport:

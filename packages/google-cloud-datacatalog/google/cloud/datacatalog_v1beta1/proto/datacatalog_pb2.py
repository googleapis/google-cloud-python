...
SearchCatalogRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_token:
          ...
          ogResponse.next_page_token][google.cloud.datacatalog.v1beta1.S
          earchCatalogResponse.next_page_token], which indicates that
          this is a continuation of a prior [SearchCatalogRequest][googl
          e.cloud.datacatalog.v1beta1.DataCatalog.SearchCatalog] call,
          and that the system should return the next page of data. If
...
_DATACATALOG = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b'\202\323\344\223\002\227\001"F/v1beta1/{resource=projects/*/locations/*/tagTemplates/*}:setIamPolicy:\001*ZJ"E/v1beta1/{resource=projects/*/locations/*/entryGroups/*}:setIamPolicy:\001*',
        ),
        _descriptor.MethodDescriptor(
            name="GetIamPolicy",

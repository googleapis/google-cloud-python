...
class PolicyTagManagerSerializationGrpcAsyncIOTransport(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.replace_taxonomy: gapic_v1.method_async.wrap_method(
                self.replace_taxonomy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.import_taxonomies: gapic_v1.method_async.wrap_method(
                self.import_taxonomies,
                default_timeout=None,
                client_info=client_info,
            ),
            self.export_taxonomies: gapic_v1.method_async.wrap_method(

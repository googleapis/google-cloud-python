...
class PolicyTagManagerSerializationAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = PolicyTagManagerSerializationClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, PolicyTagManagerSerializationTransport, Callable[..., PolicyTagManagerSerializationTransport]]
        ] = "grpc_asyncio",
    ...
    async def replace_taxonomy(
        self,
        request: Optional[Union[policytagmanagerserialization.ReplaceTaxonomyRequest, dict]] = None,
        *,
        ...
        if not isinstance(request, policytagmanagerserialization.ReplaceTaxonomyRequest):
            request = policytagmanagerserialization.ReplaceTaxonomyRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.replace_taxonomy]
    ...
    async def import_taxonomies(
        self,
        request: Optional[Union[policytagmanagerserialization.ImportTaxonomiesRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, policytagmanagerserialization.ImportTaxonomiesRequest):
            request = policytagmanagerserialization.ImportTaxonomiesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_taxonomies]
    ...
    async def export_taxonomies(
        self,
        request: Optional[Union[policytagmanagerserialization.ExportTaxonomiesRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, policytagmanagerserialization.ExportTaxonomiesRequest):
            request = policytagmanagerserialization.ExportTaxonomiesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_taxonomies]

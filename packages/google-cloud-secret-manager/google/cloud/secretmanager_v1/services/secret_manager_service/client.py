...
class SecretManagerServiceClient(metaclass=SecretManagerServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SecretManagerServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = SecretManagerServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SecretManagerServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            if interceptors is not None:
                transport_kwargs["interceptors"] = interceptors

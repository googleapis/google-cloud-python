...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ValidationHelperV1Client._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        ValidationHelperV1Client._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ValidationHelperV1Client._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ValidationHelperV1Client),
)
@mock.patch.object(
    ValidationHelperV1AsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ValidationHelperV1AsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ValidationHelperV1Client._DEFAULT_UNIVERSE
    default_endpoint = ValidationHelperV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ValidationHelperV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        ValidationHelperV1Client._get_api_endpoint(
    ...
    assert (
        ValidationHelperV1Client._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ValidationHelperV1Client._get_api_endpoint(
    ...
    assert (
        ValidationHelperV1Client._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ValidationHelperV1Client._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ValidationHelperV1Client._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ValidationHelperV1Client._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ValidationHelperV1Client._get_universe_domain(None, None)
        == ValidationHelperV1Client._DEFAULT_UNIVERSE
    )
...
def test_validation_helper_v1_client_from_service_account_info(
    client_class, transport_name
):
...
def test_validation_helper_v1_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_validation_helper_v1_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_validate_attestation_occurrence_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.validate_attestation_occurrence
...
async def test_validate_attestation_occurrence_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.validate_attestation_occurrence
...
def test_validate_attestation_occurrence_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).validate_attestation_occurrence._get_unset_required_fields(jsonified_request)
...
def test_validate_attestation_occurrence_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ValidationHelperV1RestInterceptor,
            "post_validate_attestation_occurrence_with_metadata",

...
def test__read_environment_variables():
    assert SystemPolicyV1Client._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SystemPolicyV1Client._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert SystemPolicyV1Client._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SystemPolicyV1Client._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SystemPolicyV1Client._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SystemPolicyV1Client._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SystemPolicyV1Client._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SystemPolicyV1Client._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SystemPolicyV1Client._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert SystemPolicyV1Client._get_client_cert_source(None, False) is None
    assert SystemPolicyV1Client._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SystemPolicyV1Client._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert SystemPolicyV1Client._get_client_cert_source(None, True) is mock_default_cert_source
            assert SystemPolicyV1Client._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(SystemPolicyV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1Client))
@mock.patch.object(SystemPolicyV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1AsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SystemPolicyV1Client._DEFAULT_UNIVERSE
    default_endpoint = SystemPolicyV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SystemPolicyV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SystemPolicyV1Client._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        SystemPolicyV1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SystemPolicyV1Client.DEFAULT_MTLS_ENDPOINT
    )
    assert SystemPolicyV1Client._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SystemPolicyV1Client._get_api_endpoint(None, None, default_universe, "always") == SystemPolicyV1Client.DEFAULT_MTLS_ENDPOINT
    assert (
        SystemPolicyV1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SystemPolicyV1Client.DEFAULT_MTLS_ENDPOINT
    )
    assert SystemPolicyV1Client._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SystemPolicyV1Client._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SystemPolicyV1Client._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SystemPolicyV1Client._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SystemPolicyV1Client._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SystemPolicyV1Client._get_universe_domain(None, None) == SystemPolicyV1Client._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        SystemPolicyV1Client._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SystemPolicyV1Client(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (SystemPolicyV1Client, "grpc"),
        (SystemPolicyV1AsyncClient, "grpc_asyncio"),
        (SystemPolicyV1Client, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.SystemPolicyV1RestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SystemPolicyV1AsyncClient, transports.SystemPolicyV1GrpcAsyncIOTransport, "grpc_asyncio"),
        (SystemPolicyV1Client, transports.SystemPolicyV1RestTransport, "rest"),
    ],
)
@mock.patch.object(SystemPolicyV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1Client))
@mock.patch.object(SystemPolicyV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1AsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SystemPolicyV1AsyncClient, transports.SystemPolicyV1GrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (SystemPolicyV1Client, transports.SystemPolicyV1GrpcTransport, "grpc", "false"),
        (SystemPolicyV1AsyncClient, transports.SystemPolicyV1GrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (SystemPolicyV1Client, transports.SystemPolicyV1RestTransport, "rest", "true"),
        (SystemPolicyV1Client, transports.SystemPolicyV1RestTransport, "rest", "false"),
    ],
)
@mock.patch.object(SystemPolicyV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1Client))
@mock.patch.object(SystemPolicyV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1AsyncClient))
...
@mock.patch.object(SystemPolicyV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1Client))
@mock.patch.object(SystemPolicyV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SystemPolicyV1AsyncClient))
def test_system_policy_v1_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (SystemPolicyV1Client, transports.SystemPolicyV1GrpcTransport, "grpc", grpc_helpers),
        (SystemPolicyV1AsyncClient, transports.SystemPolicyV1GrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (SystemPolicyV1Client, transports.SystemPolicyV1RestTransport, "rest", None),
    ],
)
...
def test_transport_kind_grpc():
    transport = SystemPolicyV1Client.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = SystemPolicyV1AsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SystemPolicyV1AsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SystemPolicyV1Client.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_system_policy_rest_interceptors(null_interceptor):
    transport = transports.SystemPolicyV1RestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SystemPolicyV1RestInterceptor(),
    )
    client = SystemPolicyV1Client(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SystemPolicyV1RestInterceptor, "post_get_system_policy") as post, mock.patch.object(
        transports.SystemPolicyV1RestInterceptor, "post_get_system_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SystemPolicyV1RestInterceptor, "pre_get_system_policy"
    ) as pre:
...
@pytest.mark.parametrize(
    ...
    [(transports.SystemPolicyV1GrpcTransport, grpc_helpers), (transports.SystemPolicyV1GrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_system_policy_v1_client_transport_session_collision(transport_name):
    ...
    client1 = SystemPolicyV1Client(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SystemPolicyV1Client(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize(
    ...
    [
        (SystemPolicyV1Client, transports.SystemPolicyV1GrpcTransport),
        (SystemPolicyV1AsyncClient, transports.SystemPolicyV1GrpcAsyncIOTransport),
    ],
)

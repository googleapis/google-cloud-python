...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert BinauthzManagementServiceV1Client._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert BinauthzManagementServiceV1Client._use_client_cert_effective() is False
...
@mock.patch.object(
    BinauthzManagementServiceV1Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1Client)
)
@mock.patch.object(
    BinauthzManagementServiceV1AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(BinauthzManagementServiceV1AsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        BinauthzManagementServiceV1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        BinauthzManagementServiceV1Client._get_api_endpoint(None, None, default_universe, "always")
        == BinauthzManagementServiceV1Client.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BinauthzManagementServiceV1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == BinauthzManagementServiceV1Client.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = BinauthzManagementServiceV1Client.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = BinauthzManagementServiceV1AsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = BinauthzManagementServiceV1AsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = BinauthzManagementServiceV1Client.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_policy_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_get_policy") as post, mock.patch.object(
        transports.BinauthzManagementServiceV1RestInterceptor, "post_get_policy_with_metadata"
...
def test_update_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_update_policy") as post, mock.patch.object(
        transports.BinauthzManagementServiceV1RestInterceptor, "post_update_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_create_attestor") as post, mock.patch.object(
        transports.BinauthzManagementServiceV1RestInterceptor, "post_create_attestor_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_get_attestor") as post, mock.patch.object(
        transports.BinauthzManagementServiceV1RestInterceptor, "post_get_attestor_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_update_attestor") as post, mock.patch.object(
        transports.BinauthzManagementServiceV1RestInterceptor, "post_update_attestor_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_attestors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "post_list_attestors") as post, mock.patch.object(
        transports.BinauthzManagementServiceV1RestInterceptor, "post_list_attestors_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_attestor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BinauthzManagementServiceV1RestInterceptor, "pre_delete_attestor") as pre:
        pre.assert_not_called()

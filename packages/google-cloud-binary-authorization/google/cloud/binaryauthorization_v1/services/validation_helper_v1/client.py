...
class ValidationHelperV1Client(metaclass=ValidationHelperV1ClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ValidationHelperV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ValidationHelperV1Client._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ValidationHelperV1Client._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ValidationHelperV1Client._get_api_endpoint(
    ...
    def validate_attestation_occurrence(
        ...
        *,
        ...
        r"""Returns whether the given ``Attestation`` for the given image
        URI was signed by the given ``Attestor``

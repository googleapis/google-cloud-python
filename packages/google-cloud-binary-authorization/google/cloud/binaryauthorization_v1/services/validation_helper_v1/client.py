...
class ValidationHelperV1Client(metaclass=ValidationHelperV1ClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ValidationHelperV1Client._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ValidationHelperV1Client.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ValidationHelperV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ValidationHelperV1Client._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ValidationHelperV1Transport, Callable[..., ValidationHelperV1Transport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ValidationHelperV1Client._read_environment_variables()
        self._client_cert_source = ValidationHelperV1Client._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ValidationHelperV1Client._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ValidationHelperV1Transport)
        if transport_provided:
            ...
            self._transport = cast(ValidationHelperV1Transport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ValidationHelperV1Client._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ValidationHelperV1Transport], Callable[..., ValidationHelperV1Transport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.binaryauthorization_v1.ValidationHelperV1Client`.",
                    extra={
    ...
    def validate_attestation_occurrence(
        self,
        request: Optional[Union[service.ValidateAttestationOccurrenceRequest, dict]] = None,
        *,
        ...
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("attestor", request.attestor),)),)

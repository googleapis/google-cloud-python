...
class ValidationHelperV1GrpcAsyncIOTransport(ValidationHelperV1Transport):
    ...
    def validate_attestation_occurrence(
        self,
    ) -> Callable[[service.ValidateAttestationOccurrenceRequest], Awaitable[service.ValidateAttestationOccurrenceResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.validate_attestation_occurrence: self._wrap_method(

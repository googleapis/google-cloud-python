...
from .rest_base import _BaseValidationHelperV1RestTransport
...
class ValidationHelperV1RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_validate_attestation_occurrence(
        self, response: service.ValidateAttestationOccurrenceResponse
    ) -> service.ValidateAttestationOccurrenceResponse:
        """Post-rpc interceptor for validate_attestation_occurrence

        DEPRECATED. Please use the `post_validate_attestation_occurrence_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ValidationHelperV1 server but before
        it is returned to user code. This `post_validate_attestation_occurrence` interceptor runs
        before the `post_validate_attestation_occurrence_with_metadata` interceptor.
        """
        return response
    ...
    def post_validate_attestation_occurrence_with_metadata(
        ...
        is returned by the ValidationHelperV1 server but before it is returned to user code.

        We recommend only using this `post_validate_attestation_occurrence_with_metadata`
        interceptor in new development instead of the `post_validate_attestation_occurrence` interceptor.
        When both interceptors are used, this `post_validate_attestation_occurrence_with_metadata` interceptor runs after the
        `post_validate_attestation_occurrence` interceptor. The (possibly modified) response returned by
        `post_validate_attestation_occurrence` will be passed to
...
class ValidationHelperV1RestTransport(_BaseValidationHelperV1RestTransport):
    """REST backend synchronous transport for ValidationHelperV1.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[ValidationHelperV1RestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.ValidationHelperV1Client.ValidateAttestationOccurrence",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
                        "rpcName": "ValidateAttestationOccurrence",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.ValidationHelperV1Client.validate_attestation_occurrence",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
                        "rpcName": "ValidateAttestationOccurrence",
    ...
    def validate_attestation_occurrence(
        ...
        return self._ValidateAttestationOccurrence(
    ...
    class _GetIamPolicy(
        ...
        def __hash__(self):
            return hash("ValidationHelperV1RestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.ValidationHelperV1Client.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
            ...
            # Send the request
            response = ValidationHelperV1RestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.ValidationHelperV1AsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        ...
        def __hash__(self):
            return hash("ValidationHelperV1RestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.ValidationHelperV1Client.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
            ...
            # Send the request
            response = ValidationHelperV1RestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.ValidationHelperV1AsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("ValidationHelperV1RestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.ValidationHelperV1Client.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
            ...
            # Send the request
            response = (
                ValidationHelperV1RestTransport._TestIamPermissions._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.ValidationHelperV1AsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.ValidationHelperV1",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
...
__all__ = ("ValidationHelperV1RestTransport",)

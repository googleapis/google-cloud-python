...
class BinauthzManagementServiceV1RestTransport(
    _BaseBinauthzManagementServiceV1RestTransport
):
    ...
    class _CreateAttestor(
        _BaseBinauthzManagementServiceV1RestTransport._BaseCreateAttestor,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseBinauthzManagementServiceV1RestTransport._BaseCreateAttestor._get_request_body_json(
                transcoded_request
            )
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._CreateAttestor._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _DeleteAttestor(
        _BaseBinauthzManagementServiceV1RestTransport._BaseDeleteAttestor,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._DeleteAttestor._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetAttestor(
        _BaseBinauthzManagementServiceV1RestTransport._BaseGetAttestor,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._GetAttestor._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetPolicy(
        _BaseBinauthzManagementServiceV1RestTransport._BaseGetPolicy,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._GetPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _ListAttestors(
        _BaseBinauthzManagementServiceV1RestTransport._BaseListAttestors,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._ListAttestors._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _UpdateAttestor(
        _BaseBinauthzManagementServiceV1RestTransport._BaseUpdateAttestor,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdateAttestor._get_request_body_json(
                transcoded_request
            )
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._UpdateAttestor._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _UpdatePolicy(
        _BaseBinauthzManagementServiceV1RestTransport._BaseUpdatePolicy,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseBinauthzManagementServiceV1RestTransport._BaseUpdatePolicy._get_request_body_json(
                transcoded_request
            )
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._UpdatePolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetIamPolicy(
        _BaseBinauthzManagementServiceV1RestTransport._BaseGetIamPolicy,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseBinauthzManagementServiceV1RestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseGetIamPolicy._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseGetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.BinauthzManagementServiceV1Client.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1",
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._GetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.BinauthzManagementServiceV1AsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        _BaseBinauthzManagementServiceV1RestTransport._BaseSetIamPolicy,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseBinauthzManagementServiceV1RestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseSetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseBinauthzManagementServiceV1RestTransport._BaseSetIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseSetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.BinauthzManagementServiceV1Client.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1",
            ...
            # Send the request
            response = (
                BinauthzManagementServiceV1RestTransport._SetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.BinauthzManagementServiceV1AsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        _BaseBinauthzManagementServiceV1RestTransport._BaseTestIamPermissions,
        BinauthzManagementServiceV1RestStub,
    ):
        def __hash__(self):
            return hash("BinauthzManagementServiceV1RestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseBinauthzManagementServiceV1RestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseBinauthzManagementServiceV1RestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseBinauthzManagementServiceV1RestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseBinauthzManagementServiceV1RestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.BinauthzManagementServiceV1Client.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1",
            ...
            # Send the request
            response = BinauthzManagementServiceV1RestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.BinauthzManagementServiceV1AsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.BinauthzManagementServiceV1",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,

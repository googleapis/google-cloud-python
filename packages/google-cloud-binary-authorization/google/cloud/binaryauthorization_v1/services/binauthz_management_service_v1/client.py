...
class BinauthzManagementServiceV1Client(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = BinauthzManagementServiceV1Client._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = BinauthzManagementServiceV1Client._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or BinauthzManagementServiceV1Client._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                if isinstance(transport, str) or transport is None
                    ...
                    Callable[..., BinauthzManagementServiceV1Transport], transport
                )
            )

...
class BinauthzManagementServiceV1Client(metaclass=BinauthzManagementServiceV1ClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = BinauthzManagementServiceV1Client._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or BinauthzManagementServiceV1Client._get_api_endpoint(

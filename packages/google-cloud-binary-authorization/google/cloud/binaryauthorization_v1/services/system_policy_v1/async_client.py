...
class SystemPolicyV1AsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = SystemPolicyV1Client._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = SystemPolicyV1Client._DEFAULT_UNIVERSE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = SystemPolicyV1Client.from_service_account_info.__func__  # type: ignore
        return sa_info_func(SystemPolicyV1AsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            SystemPolicyV1AsyncClient: The constructed client.
        """
        sa_file_func = SystemPolicyV1Client.from_service_account_file.__func__  # type: ignore
        return sa_file_func(SystemPolicyV1AsyncClient, filename, *args, **kwargs)
    ...
    get_transport_class = SystemPolicyV1Client.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, SystemPolicyV1Transport, Callable[..., SystemPolicyV1Transport]]
        ] = "grpc_asyncio",
        client_options: Optional[ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the system policy v1 async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,SystemPolicyV1Transport,Callable[..., SystemPolicyV1Transport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SystemPolicyV1Transport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.binaryauthorization_v1.SystemPolicyV1AsyncClient`.",
                extra={

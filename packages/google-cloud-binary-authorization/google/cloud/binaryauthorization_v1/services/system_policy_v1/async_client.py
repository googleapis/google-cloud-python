...
class SystemPolicyV1AsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SystemPolicyV1Transport, Callable[..., SystemPolicyV1Transport]]] = "grpc_asyncio",
    ...
    async def get_system_policy(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_system_policy]

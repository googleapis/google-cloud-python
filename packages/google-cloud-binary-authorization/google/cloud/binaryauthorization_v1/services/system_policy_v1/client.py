...
class SystemPolicyV1Client(metaclass=SystemPolicyV1ClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SystemPolicyV1Client._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SystemPolicyV1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = SystemPolicyV1Client._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SystemPolicyV1Client._get_api_endpoint(

...
from .rest_base import _BaseSystemPolicyV1RestTransport
...
class SystemPolicyV1RestTransport(_BaseSystemPolicyV1RestTransport):
    """REST backend synchronous transport for SystemPolicyV1.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[SystemPolicyV1RestInterceptor]): Interceptor used
    ...
    class _GetIamPolicy(
        _BaseSystemPolicyV1RestTransport._BaseGetIamPolicy, SystemPolicyV1RestStub
    ):
        def __hash__(self):
            return hash("SystemPolicyV1RestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseSystemPolicyV1RestTransport._BaseGetIamPolicy._get_http_options()
            )

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseSystemPolicyV1RestTransport._BaseGetIamPolicy._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseSystemPolicyV1RestTransport._BaseGetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.SystemPolicyV1Client.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.SystemPolicyV1",
            ...
            # Send the request
            response = SystemPolicyV1RestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.SystemPolicyV1AsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.SystemPolicyV1",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        _BaseSystemPolicyV1RestTransport._BaseSetIamPolicy, SystemPolicyV1RestStub
    ):
        def __hash__(self):
            return hash("SystemPolicyV1RestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseSystemPolicyV1RestTransport._BaseSetIamPolicy._get_http_options()
            )

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseSystemPolicyV1RestTransport._BaseSetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseSystemPolicyV1RestTransport._BaseSetIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseSystemPolicyV1RestTransport._BaseSetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.SystemPolicyV1Client.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.SystemPolicyV1",
            ...
            # Send the request
            response = SystemPolicyV1RestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.SystemPolicyV1AsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.SystemPolicyV1",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        _BaseSystemPolicyV1RestTransport._BaseTestIamPermissions, SystemPolicyV1RestStub
    ):
        def __hash__(self):
            return hash("SystemPolicyV1RestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseSystemPolicyV1RestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseSystemPolicyV1RestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseSystemPolicyV1RestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseSystemPolicyV1RestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1.SystemPolicyV1Client.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.SystemPolicyV1",
            ...
            # Send the request
            response = SystemPolicyV1RestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1.SystemPolicyV1AsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1.SystemPolicyV1",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,

...
class BinauthzManagementServiceV1Beta1AsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            BinauthzManagementServiceV1Beta1Client.from_service_account_info.__func__
        )  # type: ignore
        return sa_info_func(
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            BinauthzManagementServiceV1Beta1Client.from_service_account_file.__func__
        )  # type: ignore
        return sa_file_func(
    ...
    get_transport_class = BinauthzManagementServiceV1Beta1Client.get_transport_class

...
class BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_attestor: gapic_v1.method_async.wrap_method(
                self.create_attestor,
                default_timeout=600.0,
                client_info=client_info,
            ),
            self.get_attestor: gapic_v1.method_async.wrap_method(
                self.get_attestor,
                default_retry=retries.AsyncRetry(
                    initial=0.1,
                    maximum=60.0,
            ...
            self.update_attestor: gapic_v1.method_async.wrap_method(
            ...
            self.list_attestors: gapic_v1.method_async.wrap_method(
                self.list_attestors,
                default_retry=retries.AsyncRetry(
                    initial=0.1,
                    maximum=60.0,
            ...
            self.delete_attestor: gapic_v1.method_async.wrap_method(

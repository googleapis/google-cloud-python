...
class BinauthzManagementServiceV1Beta1Client(metaclass=BinauthzManagementServiceV1Beta1ClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = BinauthzManagementServiceV1Beta1Client._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BinauthzManagementServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, BinauthzManagementServiceV1Beta1Transport, Callable[..., BinauthzManagementServiceV1Beta1Transport]]] = None,
        ...
        self._client_cert_source = BinauthzManagementServiceV1Beta1Client._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = BinauthzManagementServiceV1Beta1Client._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, BinauthzManagementServiceV1Beta1Transport)
        ...
        self._api_endpoint = self._api_endpoint or BinauthzManagementServiceV1Beta1Client._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BinauthzManagementServiceV1Beta1Transport], Callable[..., BinauthzManagementServiceV1Beta1Transport]] = (
                BinauthzManagementServiceV1Beta1Client.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., BinauthzManagementServiceV1Beta1Transport], transport)
            )

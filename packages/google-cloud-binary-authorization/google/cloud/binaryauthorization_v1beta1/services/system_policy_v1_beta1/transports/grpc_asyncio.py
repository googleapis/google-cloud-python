...
from .base import DEFAULT_CLIENT_INFO, SystemPolicyV1Beta1Transport
...
class SystemPolicyV1Beta1GrpcAsyncIOTransport(SystemPolicyV1Beta1Transport):
    """gRPC AsyncIO backend transport for SystemPolicyV1Beta1.
    ...
    @property
    def get_system_policy(self) -> Callable[[service.GetSystemPolicyRequest], Awaitable[resources.Policy]]:
        ...
        if "get_system_policy" not in self._stubs:
            self._stubs["get_system_policy"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_system_policy: self._wrap_method(
...
__all__ = ("SystemPolicyV1Beta1GrpcAsyncIOTransport",)

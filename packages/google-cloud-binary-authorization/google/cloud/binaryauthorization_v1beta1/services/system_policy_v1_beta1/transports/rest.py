...
from .rest_base import _BaseSystemPolicyV1Beta1RestTransport
...
class SystemPolicyV1Beta1RestInterceptor:
    """Interceptor for SystemPolicyV1Beta1.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the SystemPolicyV1Beta1RestTransport.

    .. code-block:: python
        class MyCustomSystemPolicyV1Beta1Interceptor(SystemPolicyV1Beta1RestInterceptor):
        ...
        transport = SystemPolicyV1Beta1RestTransport(interceptor=MyCustomSystemPolicyV1Beta1Interceptor())
    ...
    def pre_get_system_policy(
        ...
        before they are sent to the SystemPolicyV1Beta1 server.
        """
        return request, metadata
    ...
    def post_get_system_policy(self, response: resources.Policy) -> resources.Policy:
        ...
        after it is returned by the SystemPolicyV1Beta1 server but before
    ...
    def post_get_system_policy_with_metadata(
        ...
        is returned by the SystemPolicyV1Beta1 server but before it is returned to user code.
...
class SystemPolicyV1Beta1RestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: SystemPolicyV1Beta1RestInterceptor


class SystemPolicyV1Beta1RestTransport(_BaseSystemPolicyV1Beta1RestTransport):
    """REST backend synchronous transport for SystemPolicyV1Beta1.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[SystemPolicyV1Beta1RestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[SystemPolicyV1Beta1RestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or SystemPolicyV1Beta1RestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _GetSystemPolicy(
        _BaseSystemPolicyV1Beta1RestTransport._BaseGetSystemPolicy,
        SystemPolicyV1Beta1RestStub,
    ):
        def __hash__(self):
            return hash("SystemPolicyV1Beta1RestTransport.GetSystemPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1Client.GetSystemPolicy",
                    extra={
            ...
            # Send the request
            response = SystemPolicyV1Beta1RestTransport._GetSystemPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1Client.get_system_policy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
                        "rpcName": "GetSystemPolicy",
    ...
    class _GetIamPolicy(
        ...
        def __hash__(self):
            return hash("SystemPolicyV1Beta1RestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1Client.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
            ...
            # Send the request
            response = SystemPolicyV1Beta1RestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1AsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        ...
        def __hash__(self):
            return hash("SystemPolicyV1Beta1RestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1Client.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
            ...
            # Send the request
            response = SystemPolicyV1Beta1RestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1AsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("SystemPolicyV1Beta1RestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1Client.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
            ...
            # Send the request
            response = (
                SystemPolicyV1Beta1RestTransport._TestIamPermissions._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1AsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
...
__all__ = ("SystemPolicyV1Beta1RestTransport",)

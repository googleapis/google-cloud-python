...
class SystemPolicyV1Beta1RestTransport(_BaseSystemPolicyV1Beta1RestTransport):
    ...
    class _GetSystemPolicy(_BaseSystemPolicyV1Beta1RestTransport._BaseGetSystemPolicy, SystemPolicyV1Beta1RestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseSystemPolicyV1Beta1RestTransport._BaseGetSystemPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSystemPolicyV1Beta1RestTransport._BaseGetSystemPolicy._get_query_params_json(transcoded_request)

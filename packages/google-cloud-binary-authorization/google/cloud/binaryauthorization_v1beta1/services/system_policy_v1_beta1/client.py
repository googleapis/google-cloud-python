...
class SystemPolicyV1Beta1Client(metaclass=SystemPolicyV1Beta1ClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SystemPolicyV1Beta1Client._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or SystemPolicyV1Beta1Client._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.binaryauthorization_v1beta1.SystemPolicyV1Beta1Client`.",
                    extra={
...
__all__ = ("SystemPolicyV1Beta1Client",)

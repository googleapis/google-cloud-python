    ...
    class _CompleteControlPlaneUpgrade(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseClusterManagerRestTransport._BaseCompleteControlPlaneUpgrade._get_transcoded_request(
                http_options, request
            )

            body = _BaseClusterManagerRestTransport._BaseCompleteControlPlaneUpgrade._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseClusterManagerRestTransport._BaseCompleteControlPlaneUpgrade._get_query_params_json(
                transcoded_request
            )

...
class _BaseClusterManagerRestTransport(ClusterManagerTransport):
    ...
    class _BaseCompleteControlPlaneUpgrade:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = cluster_service.CompleteControlPlaneUpgradeRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseClusterManagerRestTransport._BaseCompleteControlPlaneUpgrade._get_unset_required_fields(
                    query_params
                )
            )

...
class ClusterManagerClient(metaclass=ClusterManagerClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or ClusterManagerClient._get_api_endpoint(
    ...
    def set_locations(
        ...
        *,
        ...
        """
        warnings.warn("ClusterManagerClient.set_locations is deprecated", DeprecationWarning)

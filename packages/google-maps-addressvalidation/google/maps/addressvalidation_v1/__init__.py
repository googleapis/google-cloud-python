...
from .services.address_validation import AddressValidationAsyncClient, AddressValidationClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.maps.addressvalidation_v1")  # type: ignore
    api_core.check_dependency_versions("google.maps.addressvalidation_v1")  # type: ignore
else:  # pragma: NO COVER

...
class AddressValidationClientMeta(type):
    """Metaclass for the AddressValidation client.
...
class AddressValidationClient(metaclass=AddressValidationClientMeta):
    ...
    DEFAULT_ENDPOINT = "addressvalidation.googleapis.com"
    DEFAULT_MTLS_ENDPOINT = _get_default_mtls_endpoint.__func__(DEFAULT_ENDPOINT)  # type: ignore

    _DEFAULT_ENDPOINT_TEMPLATE = "addressvalidation.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AddressValidationClient: The constructed client.
        """
    ...
    def transport(self) -> AddressValidationTransport:
        ...
        Returns:
            AddressValidationTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AddressValidationClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AddressValidationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AddressValidationClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AddressValidationTransport, Callable[..., AddressValidationTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AddressValidationClient._read_environment_variables()
        self._client_cert_source = AddressValidationClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AddressValidationClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AddressValidationTransport)
        if transport_provided:
            # transport is a AddressValidationTransport instance.
            ...
            self._transport = cast(AddressValidationTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or AddressValidationClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AddressValidationTransport], Callable[..., AddressValidationTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.maps.addressvalidation_v1.AddressValidationClient`.",
                    extra={
    ...
    def validate_address(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.validate_address]
    ...
    def provide_validation_feedback(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.provide_validation_feedback]

...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert DataScanServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert DataScanServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                DataScanServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        DataScanServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        DataScanServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == DataScanServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_generate_data_quality_rules(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.generate_data_quality_rules), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_data_scan_jobs_rest_required_fields(request_type=datascans.ListDataScanJobsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_scan_jobs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_generate_data_quality_rules_rest_required_fields(request_type=datascans.GenerateDataQualityRulesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_data_quality_rules._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = DataScanServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = DataScanServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DataScanServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DataScanServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_data_scan_rest_bad_request(request_type=datascans.CreateDataScanRequest):
    client = DataScanServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_data_scan_rest_call_success(request_type):
    ...
    request_init["data_scan"] = {
        ...
        "execution_spec": {"trigger": {"on_demand": {}, "schedule": {"cron": "cron_value"}}, "field": "field_value"},
        "execution_status": {"latest_job_start_time": {}, "latest_job_end_time": {}, "latest_job_create_time": {}},
        "type_": 1,
        "data_quality_spec": {
            "rules": [
                {
                    ...
                    "row_condition_expectation": {"sql_expression": "sql_expression_value"},
                    "table_condition_expectation": {"sql_expression": "sql_expression_value"},
        ...
        "data_profile_spec": {
            "sampling_percent": 0.17070000000000002,
            "row_filter": "row_filter_value",
            "post_scan_actions": {"bigquery_export": {"results_table": "results_table_value"}},
            "include_fields": {"field_names": ["field_names_value1", "field_names_value2"]},
            "exclude_fields": {},
            "catalog_publishing_enabled": True,
        },
        "data_discovery_spec": {
            ...
            "storage_config": {
                ...
                "json_options": {"encoding": "encoding_value", "type_inference_disabled": True},
            },
        },
        ...
        "data_quality_result": {
            "passed": True,
            "score": 0.54,
            "dimensions": [{"dimension": {"name": "name_value"}, "passed": True, "score": 0.54}],
            "columns": [{"column": "column_value", "score": 0.54, "passed": True, "dimensions": {}}],
            "rules": [
                {
                    "rule": {},
                    "passed": True,
            ...
            "row_count": 992,
            "scanned_data": {"incremental_field": {"field": "field_value", "start": "start_value", "end": "end_value"}},
            "post_scan_actions_result": {"bigquery_export_result": {"state": 1, "message": "message_value"}},
                ...
                "fields": [
                    {
                        ...
                        "profile": {
                            ...
                            "top_n_values": [{"value": "value_value", "count": 553, "ratio": 0.543}],
                            "string_profile": {"min_length": 1061, "max_length": 1063, "average_length": 0.1468},
                            "integer_profile": {"average": 0.731, "standard_deviation": 0.1907, "min_": 419, "quartiles": [987, 988], "max_": 421},
                            "double_profile": {
                                "average": 0.731,
        ...
        "data_discovery_result": {
            "bigquery_publishing": {"dataset": "dataset_value", "location": "location_value"},
            "scan_statistics": {
        ...
        "data_documentation_result": {
            "table_result": {
                ...
                "schema": {"fields": [{"name": "name_value", "description": "description_value", "fields": {}}]},
...
def test_get_data_scan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataScanServiceRestInterceptor, "post_get_data_scan") as post, mock.patch.object(
...
def test_list_data_scans_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataScanServiceRestInterceptor, "post_list_data_scans") as post, mock.patch.object(
...
def test_run_data_scan_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataScanServiceRestInterceptor, "post_run_data_scan") as post, mock.patch.object(
...
def test_get_data_scan_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataScanServiceRestInterceptor, "post_get_data_scan_job") as post, mock.patch.object(
        transports.DataScanServiceRestInterceptor, "post_get_data_scan_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_data_scan_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataScanServiceRestInterceptor, "post_list_data_scan_jobs") as post, mock.patch.object(
        transports.DataScanServiceRestInterceptor, "post_list_data_scan_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_generate_data_quality_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataScanServiceRestInterceptor, "post_generate_data_quality_rules") as post, mock.patch.object(
        transports.DataScanServiceRestInterceptor, "post_generate_data_quality_rules_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.DataScanServiceGrpcTransport, grpc_helpers), (transports.DataScanServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_data_scan_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.DataScanServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)

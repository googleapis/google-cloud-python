...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DataScanServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_create_data_scan_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_data_scan] = (
            mock_rpc
        )
        request = {}
...
def test_update_data_scan_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_data_scan] = (
            mock_rpc
        )
        request = {}
...
def test_delete_data_scan_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_data_scan] = (
            mock_rpc
        )
        request = {}
...
def test_get_data_scan_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_data_scan_job] = (
            mock_rpc
        )
        request = {}
...
def test_list_data_scan_jobs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_data_scan_jobs] = (
            mock_rpc
        )
        request = {}
...
def test_cancel_data_scan_job_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == datascans.CancelDataScanJobRequest(
            name="name_value",
        )
...
async def test_cancel_data_scan_job_async(
    transport: str = "grpc_asyncio", request_type=datascans.CancelDataScanJobRequest
):
    client = DataScanServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
@pytest.mark.asyncio
async def test_cancel_data_scan_job_async_from_dict():
    await test_cancel_data_scan_job_async(request_type=dict)
    ...
    request_init["data_scan"] = {
        ...
        "execution_spec": {
            "trigger": {
                ...
                "one_time": {
                    "ttl_after_scan_completion": {"seconds": 751, "nanos": 543}
                },
            },
            "field": "field_value",
        },
...
def test_generate_data_quality_rules_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.DataScanServiceRestInterceptor,
            "post_generate_data_quality_rules",
        ) as post,
        mock.patch.object(
            transports.DataScanServiceRestInterceptor,

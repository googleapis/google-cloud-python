...
def test_update_lake_field_headers():
    ...
    request.lake.name = "lake.name/value"
...
def test_update_zone_field_headers():
    ...
    request.zone.name = "zone.name/value"
...
def test_update_asset_field_headers():
    ...
    request.asset.name = "asset.name/value"
...
def test_update_task_field_headers():
    ...
    request.task.name = "task.name/value"
...
def test_dataplex_service_host_no_port():
    client = DataplexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_dataplex_service_host_with_port():
    client = DataplexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

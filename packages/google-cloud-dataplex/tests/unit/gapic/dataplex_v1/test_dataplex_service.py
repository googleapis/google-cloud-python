...
async def test_create_lake_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_lake_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_lake_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_lakes_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_lakes_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_lakes(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_get_lake_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_lake_actions_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_lake_actions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_lake_actions(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_create_zone_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_zone_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_zone_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_zone_actions_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_zone_actions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_zone_actions(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_asset_actions_async(request_type, transport: str = "grpc_asyncio"):
    client = DataplexServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_asset_actions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_asset_actions(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_lake_rest_required_fields(request_type=service.CreateLakeRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateLake,
...
def test_update_lake_rest_required_fields(request_type=service.UpdateLakeRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateLake,
...
def test_delete_lake_rest_required_fields(request_type=service.DeleteLakeRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteLake,
...
def test_list_lakes_rest_required_fields(request_type=service.ListLakesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListLakes,
...
def test_list_lake_actions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListLakeActions,
...
def test_create_zone_rest_required_fields(request_type=service.CreateZoneRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateZone,
...
def test_update_zone_rest_required_fields(request_type=service.UpdateZoneRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateZone,
...
def test_delete_zone_rest_required_fields(request_type=service.DeleteZoneRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteZone,
...
def test_list_zones_rest_required_fields(request_type=service.ListZonesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListZones,
...
def test_list_zone_actions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListZoneActions,
...
def test_create_asset_rest_required_fields(request_type=service.CreateAssetRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateAsset,
...
def test_update_asset_rest_required_fields(request_type=service.UpdateAssetRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateAsset,
...
def test_delete_asset_rest_required_fields(request_type=service.DeleteAssetRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteAsset,
...
def test_list_asset_actions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAssetActions,
...
def test_create_task_rest_required_fields(request_type=service.CreateTaskRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateTask,
...
def test_update_task_rest_required_fields(request_type=service.UpdateTaskRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateTask,
...
def test_delete_task_rest_required_fields(request_type=service.DeleteTaskRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteTask,
...
def test_list_tasks_rest_required_fields(request_type=service.ListTasksRequest):
    ...
    default_values = getattr(
        transport_class._BaseListTasks,

...
def test__get_api_endpoint():
    ...
    assert (
        MetadataServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        MetadataServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == MetadataServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_list_entities_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_entities), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_entities(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_partitions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_partitions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_partitions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_partition_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/lakes/*/zones/*/entities/*/partitions/**}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = MetadataServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = MetadataServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = MetadataServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = MetadataServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_entity_rest_bad_request(request_type=metadata_.CreateEntityRequest):
    client = MetadataServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_entity_rest_call_success(request_type):
    ...
    request_init["entity"] = {
        ...
        "format_": {
            ...
            "csv": {"encoding": "encoding_value", "header_rows": 1171, "delimiter": "delimiter_value", "quote": "quote_value"},
            "json": {"encoding": "encoding_value"},
            "iceberg": {"metadata_location": "metadata_location_value"},
        },
        "compatibility": {"hive_metastore": {"compatible": True, "reason": "reason_value"}, "bigquery": {}},
        "access": {"read": 1},
        "uid": "uid_value",
        "schema": {
            "user_managed": True,
            "fields": [{"name": "name_value", "description": "description_value", "type_": 1, "mode": 1, "fields": {}}],
            "partition_fields": [{"name": "name_value", "type_": 1}],
            "partition_style": 1,
        },
    }
...
def test_create_entity_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_entity") as post, mock.patch.object(
...
def test_update_entity_rest_call_success(request_type):
    ...
    request_init = {"entity": {"name": "projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5"}}
    request_init["entity"] = {
        "name": "projects/sample1/locations/sample2/lakes/sample3/zones/sample4/entities/sample5",
        "display_name": "display_name_value",
        "description": "description_value",
        "create_time": {"seconds": 751, "nanos": 543},
        "update_time": {},
...
def test_update_entity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_update_entity") as post, mock.patch.object(
...
def test_delete_entity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_entity") as pre:
        pre.assert_not_called()
...
def test_get_entity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_entity") as post, mock.patch.object(
...
def test_list_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_entities") as post, mock.patch.object(
...
def test_create_partition_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_partition") as post, mock.patch.object(
...
def test_delete_partition_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_partition") as pre:
        pre.assert_not_called()
...
def test_get_partition_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_partition") as post, mock.patch.object(
...
def test_list_partitions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_partitions") as post, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.MetadataServiceGrpcTransport, grpc_helpers), (transports.MetadataServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_metadata_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.MetadataServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
async def test_get_location_field_headers_async():
    client = MetadataServiceAsyncClient(credentials=async_anonymous_credentials())

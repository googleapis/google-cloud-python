...
class dataplexCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_entry_link': ('parent', 'entry_link_id', 'entry_link', ),
        ...
        'create_glossary': ('parent', 'glossary_id', 'glossary', 'validate_only', ),
        'create_glossary_category': ('parent', 'category_id', 'category', ),
        'create_glossary_term': ('parent', 'term_id', 'term', ),
        ...
        'delete_entry_link': ('name', ),
        'delete_entry_type': ('name', 'etag', ),
        'delete_environment': ('name', ),
        'delete_glossary': ('name', 'etag', ),
        'delete_glossary_category': ('name', ),
        'delete_glossary_term': ('name', ),
        'delete_lake': ('name', ),
        ...
        'list_glossaries': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_glossary_categories': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_glossary_terms': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        ...
        'update_glossary': ('glossary', 'update_mask', 'validate_only', ),
        'update_glossary_category': ('category', 'update_mask', ),
        'update_glossary_term': ('term', 'update_mask', ),

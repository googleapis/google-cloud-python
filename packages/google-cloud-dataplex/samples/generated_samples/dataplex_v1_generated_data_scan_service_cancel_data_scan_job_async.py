...
async def sample_cancel_data_scan_job():
    # Create a client
    client = dataplex_v1.DataScanServiceAsyncClient()

    # Initialize request argument(s)
    request = dataplex_v1.CancelDataScanJobRequest(
        name="name_value",
    )

    # Make the request
    response = await client.cancel_data_scan_job(request=request)

...
class BusinessGlossaryServiceGrpcAsyncIOTransport(BusinessGlossaryServiceTransport):
    ...
    @property
    def create_glossary(self) -> Callable[[business_glossary.CreateGlossaryRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_glossary(self) -> Callable[[business_glossary.UpdateGlossaryRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_glossary(self) -> Callable[[business_glossary.DeleteGlossaryRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_glossary(self) -> Callable[[business_glossary.GetGlossaryRequest], Awaitable[business_glossary.Glossary]]:
    ...
    @property
    def list_glossaries(self) -> Callable[[business_glossary.ListGlossariesRequest], Awaitable[business_glossary.ListGlossariesResponse]]:
    ...
    @property
    def create_glossary_category(self) -> Callable[[business_glossary.CreateGlossaryCategoryRequest], Awaitable[business_glossary.GlossaryCategory]]:
    ...
    @property
    def update_glossary_category(self) -> Callable[[business_glossary.UpdateGlossaryCategoryRequest], Awaitable[business_glossary.GlossaryCategory]]:
    ...
    @property
    def delete_glossary_category(self) -> Callable[[business_glossary.DeleteGlossaryCategoryRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_glossary_category(self) -> Callable[[business_glossary.GetGlossaryCategoryRequest], Awaitable[business_glossary.GlossaryCategory]]:
    ...
    def list_glossary_categories(
        self,
    ) -> Callable[[business_glossary.ListGlossaryCategoriesRequest], Awaitable[business_glossary.ListGlossaryCategoriesResponse]]:
    ...
    @property
    def create_glossary_term(self) -> Callable[[business_glossary.CreateGlossaryTermRequest], Awaitable[business_glossary.GlossaryTerm]]:
    ...
    @property
    def update_glossary_term(self) -> Callable[[business_glossary.UpdateGlossaryTermRequest], Awaitable[business_glossary.GlossaryTerm]]:
    ...
    @property
    def delete_glossary_term(self) -> Callable[[business_glossary.DeleteGlossaryTermRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_glossary_term(self) -> Callable[[business_glossary.GetGlossaryTermRequest], Awaitable[business_glossary.GlossaryTerm]]:
    ...
    @property
    def list_glossary_terms(self) -> Callable[[business_glossary.ListGlossaryTermsRequest], Awaitable[business_glossary.ListGlossaryTermsResponse]]:

...
class ListGlossaryCategoriesAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[business_glossary.ListGlossaryCategoriesResponse]],
        request: business_glossary.ListGlossaryCategoriesRequest,
        response: business_glossary.ListGlossaryCategoriesResponse,
        *,
        retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[business_glossary.ListGlossaryCategoriesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)

...
class CmekServiceTransport(abc.ABC):
    ...
    def create_encryption_config(
        self,
    ) -> Callable[[cmek.CreateEncryptionConfigRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_encryption_config(
        self,
    ) -> Callable[[cmek.UpdateEncryptionConfigRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_encryption_config(
        self,
    ) -> Callable[[cmek.DeleteEncryptionConfigRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def list_encryption_configs(
        self,
    ) -> Callable[[cmek.ListEncryptionConfigsRequest], Union[cmek.ListEncryptionConfigsResponse, Awaitable[cmek.ListEncryptionConfigsResponse]]]:
        raise NotImplementedError()

    @property
    def get_encryption_config(self) -> Callable[[cmek.GetEncryptionConfigRequest], Union[cmek.EncryptionConfig, Awaitable[cmek.EncryptionConfig]]]:
        raise NotImplementedError()

...
class CmekServiceGrpcAsyncIOTransport(CmekServiceTransport):
    ...
    @property
    def create_encryption_config(self) -> Callable[[cmek.CreateEncryptionConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_encryption_config(self) -> Callable[[cmek.UpdateEncryptionConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_encryption_config(self) -> Callable[[cmek.DeleteEncryptionConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_encryption_configs(self) -> Callable[[cmek.ListEncryptionConfigsRequest], Awaitable[cmek.ListEncryptionConfigsResponse]]:
    ...
    @property
    def get_encryption_config(self) -> Callable[[cmek.GetEncryptionConfigRequest], Awaitable[cmek.EncryptionConfig]]:

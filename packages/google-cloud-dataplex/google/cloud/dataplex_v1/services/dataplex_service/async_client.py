...
class DataplexServiceAsyncClient:
    ...
    session_path = staticmethod(DataplexServiceClient.session_path)
    parse_session_path = staticmethod(DataplexServiceClient.parse_session_path)
    ...
    common_billing_account_path = staticmethod(DataplexServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(DataplexServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(DataplexServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(DataplexServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(DataplexServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(DataplexServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(DataplexServiceClient.common_project_path)
    parse_common_project_path = staticmethod(DataplexServiceClient.parse_common_project_path)
    common_location_path = staticmethod(DataplexServiceClient.common_location_path)
    parse_common_location_path = staticmethod(DataplexServiceClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DataplexServiceTransport, Callable[..., DataplexServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_lake(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_lake]
    ...
    async def update_lake(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_lake]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("lake.name", request.lake.name),)),)
    ...
    async def delete_lake(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_lake]
    ...
    async def list_lakes(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_lakes]
    ...
    async def list_lake_actions(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_lake_actions]
    ...
    async def create_zone(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_zone]
    ...
    async def update_zone(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_zone]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("zone.name", request.zone.name),)),)
    ...
    async def delete_zone(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_zone]
    ...
    async def list_zones(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_zones]
    ...
    async def list_zone_actions(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_zone_actions]
    ...
    async def list_asset_actions(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_asset_actions]
    ...
    async def update_task(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("task.name", request.task.name),)),)
    ...
    async def create_environment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.CreateEnvironmentRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            environment (:class:`google.cloud.dataplex_v1.types.Environment`):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, environment, environment_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    async def update_environment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.UpdateEnvironmentRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [environment, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("environment.name", request.environment.name),)),)
    ...
    async def delete_environment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.DeleteEnvironmentRequest, dict]]):
    ...
    async def list_environments(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.ListEnvironmentsRequest, dict]]):
    ...
    async def list_sessions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.ListSessionsRequest, dict]]):

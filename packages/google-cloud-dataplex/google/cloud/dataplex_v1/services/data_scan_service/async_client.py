...
class DataScanServiceAsyncClient:
    ...
    entry_path = staticmethod(DataScanServiceClient.entry_path)
    parse_entry_path = staticmethod(DataScanServiceClient.parse_entry_path)
    ...
    async def cancel_data_scan_job(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.CancelDataScanJobRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.cancel_data_scan_job
        ]

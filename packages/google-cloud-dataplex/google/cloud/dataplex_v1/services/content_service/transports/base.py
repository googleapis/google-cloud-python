...
class ContentServiceTransport(abc.ABC):
    ...
    @property
    def create_content(self) -> Callable[[gcd_content.CreateContentRequest], Union[analyze.Content, Awaitable[analyze.Content]]]:
        raise NotImplementedError()

    @property
    def update_content(self) -> Callable[[gcd_content.UpdateContentRequest], Union[analyze.Content, Awaitable[analyze.Content]]]:
        raise NotImplementedError()

    @property
    def delete_content(self) -> Callable[[content.DeleteContentRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def get_content(self) -> Callable[[content.GetContentRequest], Union[analyze.Content, Awaitable[analyze.Content]]]:
        raise NotImplementedError()
    ...
    @property
    def list_content(self) -> Callable[[content.ListContentRequest], Union[content.ListContentResponse, Awaitable[content.ListContentResponse]]]:
        raise NotImplementedError()

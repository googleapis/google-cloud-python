...
class CatalogServiceClient(metaclass=CatalogServiceClientMeta):
    ...
    def aspect_type_path(
        ...
        return "projects/{project}/locations/{location}/aspectTypes/{aspect_type}".format(
            project=project,
            location=location,
    ...
    def metadata_job_path(
        ...
        return "projects/{project}/locations/{location}/metadataJobs/{metadataJob}".format(
            project=project,
            location=location,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or CatalogServiceClient._get_api_endpoint(
    ...
    def update_entry_type(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("entry_type.name", request.entry_type.name),)),)
    ...
    def update_aspect_type(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("aspect_type.name", request.aspect_type.name),)),)

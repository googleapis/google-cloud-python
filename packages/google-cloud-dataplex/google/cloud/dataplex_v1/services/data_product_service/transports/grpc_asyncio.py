...
class DataProductServiceGrpcAsyncIOTransport(DataProductServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_data_products: self._wrap_method(
                self.list_data_products,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_data_product: self._wrap_method(
                self.update_data_product,
                default_timeout=None,
                client_info=client_info,
            ),
            self.request_data_product_access: self._wrap_method(
                self.request_data_product_access,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_data_asset: self._wrap_method(
                self.create_data_asset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_data_asset: self._wrap_method(
                self.update_data_asset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_data_asset: self._wrap_method(
                self.delete_data_asset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_data_asset: self._wrap_method(
                self.get_data_asset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_data_assets: self._wrap_method(
...
__all__ = ("DataProductServiceGrpcAsyncIOTransport",)

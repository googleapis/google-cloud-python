...
def test__read_environment_variables():
    assert ConnectionServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ConnectionServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert ConnectionServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ConnectionServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ConnectionServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ConnectionServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ConnectionServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ConnectionServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ConnectionServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ConnectionServiceClient._get_client_cert_source(None, False) is None
    assert ConnectionServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ConnectionServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ConnectionServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ConnectionServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ConnectionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceClient))
@mock.patch.object(ConnectionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConnectionServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ConnectionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ConnectionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ConnectionServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ConnectionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ConnectionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ConnectionServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ConnectionServiceClient._get_api_endpoint(None, None, default_universe, "always") == ConnectionServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ConnectionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ConnectionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ConnectionServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ConnectionServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ConnectionServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ConnectionServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ConnectionServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ConnectionServiceClient._get_universe_domain(None, None) == ConnectionServiceClient._DEFAULT_UNIVERSE
...
def test_connection_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "bigqueryconnection.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://bigqueryconnection.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.ConnectionServiceRestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ConnectionServiceClient, transports.ConnectionServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(ConnectionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceClient))
@mock.patch.object(ConnectionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ConnectionServiceClient, transports.ConnectionServiceRestTransport, "rest", "true"),
        (ConnectionServiceClient, transports.ConnectionServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ConnectionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceClient))
@mock.patch.object(ConnectionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceAsyncClient))
...
@mock.patch.object(ConnectionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceClient))
@mock.patch.object(ConnectionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConnectionServiceAsyncClient))
def test_connection_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (ConnectionServiceClient, transports.ConnectionServiceGrpcTransport, "grpc", grpc_helpers),
        (ConnectionServiceAsyncClient, transports.ConnectionServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ConnectionServiceClient, transports.ConnectionServiceRestTransport, "rest", None),
    ],
)
...
def test_transport_kind_grpc():
    transport = ConnectionServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_connection_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_connection), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcbc_connection.CreateConnectionRequest()
...
def test_get_connection_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_connection), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = connection.GetConnectionRequest()
...
def test_list_connections_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_connections), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = connection.ListConnectionsRequest()
...
def test_update_connection_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.update_connection), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcbc_connection.UpdateConnectionRequest()
...
def test_delete_connection_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_connection), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = connection.DeleteConnectionRequest()
...
def test_transport_kind_grpc_asyncio():
    transport = ConnectionServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ConnectionServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ConnectionServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_connection_rest_bad_request(request_type=gcbc_connection.CreateConnectionRequest):
...
def test_create_connection_rest_call_success(request_type):
    ...
    request_init["connection"] = {
        ...
        "aws": {
            "cross_account_role": {"iam_role_id": "iam_role_id_value", "iam_user_id": "iam_user_id_value", "external_id": "external_id_value"},
            "access_role": {"iam_role_id": "iam_role_id_value", "identity": "identity_value"},
        },
        "azure": {
        ...
        "spark": {
            "service_account_id": "service_account_id_value",
            "metastore_service_config": {"metastore_service": "metastore_service_value"},
            "spark_history_server_config": {"dataproc_cluster": "dataproc_cluster_value"},
        },
        "salesforce_data_cloud": {"instance_uri": "instance_uri_value", "identity": "identity_value", "tenant_id": "tenant_id_value"},
        "creation_time": 1379,
        "last_modified_time": 1890,
        "has_credential": True,
    }
...
def test_create_connection_rest_interceptors(null_interceptor):
    transport = transports.ConnectionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ConnectionServiceRestInterceptor(),
    )
    client = ConnectionServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_create_connection") as post, mock.patch.object(
        transports.ConnectionServiceRestInterceptor, "post_create_connection_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcbc_connection.Connection.to_json(gcbc_connection.Connection())
...
def test_get_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_get_connection") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = connection.Connection.to_json(connection.Connection())
        req.return_value.content = return_value
...
def test_list_connections_rest_bad_request(request_type=connection.ListConnectionsRequest):
    client = ConnectionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_list_connections") as post, mock.patch.object(
        transports.ConnectionServiceRestInterceptor, "post_list_connections_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = connection.ListConnectionsResponse.to_json(connection.ListConnectionsResponse())
        req.return_value.content = return_value
...
def test_update_connection_rest_bad_request(request_type=gcbc_connection.UpdateConnectionRequest):
    client = ConnectionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/connections/sample3"}
    request = request_type(**request_init)
...
def test_update_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_update_connection") as post, mock.patch.object(
        transports.ConnectionServiceRestInterceptor, "post_update_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_connection_rest_bad_request(request_type=connection.DeleteConnectionRequest):
    client = ConnectionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/connections/sample3"}
    request = request_type(**request_init)
...
def test_delete_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_delete_connection") as pre:
        pre.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.ConnectionServiceRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.ConnectionServiceGrpcTransport, grpc_helpers), (transports.ConnectionServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_connection_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "bigqueryconnection.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://bigqueryconnection.googleapis.com:8000"
    )
...
def test_connection_service_client_transport_session_collision(transport_name):
    ...
    client1 = ConnectionServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ConnectionServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ConnectionServiceAsyncClient, transports.ConnectionServiceGrpcAsyncIOTransport),
    ],
)

...
from google.cloud.bigquery_connection_v1._compat import (
    get_api_endpoint,
...
class ConnectionServiceClient(metaclass=ConnectionServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "bigqueryconnection.{UNIVERSE_DOMAIN}"
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery.connection_v1.ConnectionServiceClient`.",
                    extra={

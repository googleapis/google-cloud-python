...
class CloudShellServiceTransport(abc.ABC):
    ...
    @property
    def get_environment(self) -> Callable[[cloudshell.GetEnvironmentRequest], Union[cloudshell.Environment, Awaitable[cloudshell.Environment]]]:
        raise NotImplementedError()

    @property
    def start_environment(
        self,
    ) -> Callable[[cloudshell.StartEnvironmentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def authorize_environment(
        self,
    ) -> Callable[[cloudshell.AuthorizeEnvironmentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def add_public_key(self) -> Callable[[cloudshell.AddPublicKeyRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def remove_public_key(
        self,
    ) -> Callable[[cloudshell.RemovePublicKeyRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
class CloudShellServiceGrpcAsyncIOTransport(CloudShellServiceTransport):
    ...
    @property
    def get_environment(self) -> Callable[[cloudshell.GetEnvironmentRequest], Awaitable[cloudshell.Environment]]:
    ...
    @property
    def start_environment(self) -> Callable[[cloudshell.StartEnvironmentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def authorize_environment(self) -> Callable[[cloudshell.AuthorizeEnvironmentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def add_public_key(self) -> Callable[[cloudshell.AddPublicKeyRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def remove_public_key(self) -> Callable[[cloudshell.RemovePublicKeyRequest], Awaitable[operations_pb2.Operation]]:

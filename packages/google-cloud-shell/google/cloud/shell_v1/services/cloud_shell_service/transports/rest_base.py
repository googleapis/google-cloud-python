...
class _BaseCloudShellServiceRestTransport(CloudShellServiceTransport):
    """Base REST backend transport for CloudShellService.
    ...
    class _BaseAuthorizeEnvironment:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseGetEnvironment:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCloudShellServiceRestTransport._BaseGetEnvironment._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseRemovePublicKey:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseCloudShellServiceRestTransport",)

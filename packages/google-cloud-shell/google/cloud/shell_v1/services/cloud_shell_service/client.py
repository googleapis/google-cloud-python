...
class CloudShellServiceClient(metaclass=CloudShellServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CloudShellServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudShellServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = CloudShellServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CloudShellServiceClient._get_api_endpoint(

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        CloudShellServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert CloudShellServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CloudShellServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CloudShellServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                CloudShellServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        CloudShellServiceClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        CloudShellServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                CloudShellServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(CloudShellServiceClient),
)
@mock.patch.object(
    CloudShellServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(CloudShellServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudShellServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CloudShellServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = CloudShellServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        CloudShellServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == CloudShellServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CloudShellServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        CloudShellServiceClient._get_api_endpoint(
    ...
    assert (
        CloudShellServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        CloudShellServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        CloudShellServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        CloudShellServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        CloudShellServiceClient._get_universe_domain(None, None)
        == CloudShellServiceClient._DEFAULT_UNIVERSE
    )
...
def test_start_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.start_environment] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_start_environment_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.start_environment
            in client._client._transport._wrapped_methods
        )
...
def test_authorize_environment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.authorize_environment
        ...
        client._transport._wrapped_methods[client._transport.authorize_environment] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_authorize_environment_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.authorize_environment
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_add_public_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.add_public_key
            in client._client._transport._wrapped_methods
        )
...
def test_remove_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.remove_public_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_remove_public_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.remove_public_key
            in client._client._transport._wrapped_methods
        )
...
def test_start_environment_rest_bad_request(
    request_type=cloudshell.StartEnvironmentRequest,
):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_authorize_environment_rest_bad_request(
    request_type=cloudshell.AuthorizeEnvironmentRequest,
):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_remove_public_key_rest_bad_request(
    request_type=cloudshell.RemovePublicKeyRequest,
):
    client = CloudShellServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )

...
from google.cloud.notebooks_v1.services.managed_notebook_service import ManagedNotebookServiceAsyncClient
...
from google.cloud.notebooks_v1.services.managed_notebook_service.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (ManagedNotebookServiceClient, transports.ManagedNotebookServiceGrpcTransport, "grpc"),
    (ManagedNotebookServiceAsyncClient, transports.ManagedNotebookServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ManagedNotebookServiceClient, transports.ManagedNotebookServiceGrpcTransport, "grpc", "true"),
    (ManagedNotebookServiceAsyncClient, transports.ManagedNotebookServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ManagedNotebookServiceClient, transports.ManagedNotebookServiceGrpcTransport, "grpc", "false"),
    (ManagedNotebookServiceAsyncClient, transports.ManagedNotebookServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(ManagedNotebookServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ManagedNotebookServiceClient))
@mock.patch.object(ManagedNotebookServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ManagedNotebookServiceAsyncClient))
...
def test_managed_notebook_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_runtimes(transport: str = 'grpc', request_type=managed_service.ListRuntimesRequest):
    ...
    with mock.patch.object(
            type(client.transport.list_runtimes),
            '__call__') as call:
...
def test_get_runtime(transport: str = 'grpc', request_type=managed_service.GetRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_runtime(transport: str = 'grpc', request_type=managed_service.CreateRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_runtime(transport: str = 'grpc', request_type=managed_service.DeleteRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_start_runtime(transport: str = 'grpc', request_type=managed_service.StartRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_stop_runtime(transport: str = 'grpc', request_type=managed_service.StopRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_switch_runtime(transport: str = 'grpc', request_type=managed_service.SwitchRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.switch_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_reset_runtime(transport: str = 'grpc', request_type=managed_service.ResetRuntimeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.reset_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_report_runtime_event(transport: str = 'grpc', request_type=managed_service.ReportRuntimeEventRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.report_runtime_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ManagedNotebookServiceGrpcTransport, transports.ManagedNotebookServiceGrpcAsyncIOTransport])
def test_managed_notebook_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()

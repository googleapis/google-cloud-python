...
from google.cloud.notebooks_v1.services.notebook_service import NotebookServiceAsyncClient, NotebookServiceClient, pagers, transports
...
def test_update_instance_metadata_items(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_instance_metadata_items), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_schedules_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_schedules), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            service.ListSchedulesResponse(
                schedules=[
    ...
    with mock.patch.object(type(client.transport.create_execution), "__call__") as call:
        ...
        client.create_execution(
            ...
            execution=gcn_execution.Execution(
                execution_template=gcn_execution.ExecutionTemplate(scale_tier=gcn_execution.ExecutionTemplate.ScaleTier.BASIC)
            ),
            execution_id="execution_id_value",
        )

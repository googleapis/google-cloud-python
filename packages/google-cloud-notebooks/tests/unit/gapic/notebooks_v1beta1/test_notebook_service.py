...
from google.cloud.notebooks_v1beta1.services.notebook_service import NotebookServiceAsyncClient, NotebookServiceClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        NotebookServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        NotebookServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == NotebookServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_notebook_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "notebooks.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://notebooks.googleapis.com"
        )
...
async def test_list_environments_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_environments), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            service.ListEnvironmentsResponse(
                environments=[
...
def test_set_instance_accelerator_rest_required_fields(request_type=service.SetInstanceAcceleratorRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_instance_accelerator._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_instance_machine_type_rest_required_fields(request_type=service.SetInstanceMachineTypeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_instance_machine_type._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_instance_labels_rest_required_fields(request_type=service.SetInstanceLabelsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_instance_labels._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_report_instance_info_rest_required_fields(request_type=service.ReportInstanceInfoRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).report_instance_info._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_is_instance_upgradeable_rest_required_fields(request_type=service.IsInstanceUpgradeableRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).is_instance_upgradeable._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_upgrade_instance_internal_rest_required_fields(request_type=service.UpgradeInstanceInternalRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).upgrade_instance_internal._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = NotebookServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = NotebookServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = NotebookServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = NotebookServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_instances") as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_list_instances_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_list_instances"
    ) as pre:
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_instance") as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_get_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_get_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_instance_rest_call_success(request_type):
    ...
    request_init["instance"] = {
        "name": "name_value",
        "vm_image": {"project": "project_value", "image_name": "image_name_value", "image_family": "image_family_value"},
        ...
        "service_account": "service_account_value",
        "machine_type": "machine_type_value",
        "accelerator_config": {"type_": 1, "core_count": 1073},
        "state": 1,
        "install_gpu_driver": True,
        "custom_gpu_driver_path": "custom_gpu_driver_path_value",
        "boot_disk_type": 1,
        ...
        "metadata": {},
        "nic_type": 1,
        "reservation_affinity": {"consume_reservation_type": 1, "key": "key_value", "values": ["values_value1", "values_value2"]},
        "can_ip_forward": True,
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_create_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_create_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_create_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_register_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_register_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_register_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_register_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_instance_accelerator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_set_instance_accelerator"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_set_instance_accelerator_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_set_instance_accelerator"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_instance_machine_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_set_instance_machine_type"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_set_instance_machine_type_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_set_instance_machine_type"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_instance_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_set_instance_labels"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_set_instance_labels_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_set_instance_labels"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_delete_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_delete_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_delete_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_start_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_start_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_start_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_stop_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_stop_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_stop_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_stop_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reset_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_reset_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_reset_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_reset_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_report_instance_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_report_instance_info"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_report_instance_info_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_report_instance_info"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_is_instance_upgradeable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NotebookServiceRestInterceptor, "post_is_instance_upgradeable") as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_is_instance_upgradeable_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_is_instance_upgradeable"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_upgrade_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_upgrade_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_upgrade_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_upgrade_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_upgrade_instance_internal_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_upgrade_instance_internal"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_upgrade_instance_internal_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_upgrade_instance_internal"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_environments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_environments") as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_list_environments_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_list_environments"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_environment") as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_get_environment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_get_environment"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_create_environment"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_create_environment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_create_environment"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_environment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_delete_environment"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_delete_environment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_delete_environment"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.NotebookServiceGrpcTransport, grpc_helpers), (transports.NotebookServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_notebook_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "notebooks.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://notebooks.googleapis.com:8000"
    )

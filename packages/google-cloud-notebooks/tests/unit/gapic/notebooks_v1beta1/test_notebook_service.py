...
async def test_register_instance_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_set_instance_labels_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_start_instance_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_stop_instance_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_reset_instance_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_register_instance_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRegisterInstance,
...
def test_set_instance_accelerator_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetInstanceAccelerator,
...
def test_set_instance_machine_type_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetInstanceMachineType,
...
def test_set_instance_labels_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetInstanceLabels,
...
def test_start_instance_rest_required_fields(request_type=service.StartInstanceRequest):
    ...
    default_values = getattr(
        transport_class._BaseStartInstance,
...
def test_stop_instance_rest_required_fields(request_type=service.StopInstanceRequest):
    ...
    default_values = getattr(
        transport_class._BaseStopInstance,
...
def test_reset_instance_rest_required_fields(request_type=service.ResetInstanceRequest):
    ...
    default_values = getattr(
        transport_class._BaseResetInstance,
...
def test_report_instance_info_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseReportInstanceInfo,
...
def test_is_instance_upgradeable_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseIsInstanceUpgradeable,
...
def test_upgrade_instance_internal_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpgradeInstanceInternal,
...
def test_list_environments_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListEnvironments,
...
def test_get_environment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetEnvironment,
...
def test_create_environment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateEnvironment,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("environmentId",))
...
def test_delete_environment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteEnvironment,

...
def test_check_instance_upgradability_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).check_instance_upgradability._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_instance_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).rollback_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_diagnose_instance_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).diagnose_instance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_check_instance_upgradability_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_check_instance_upgradability"
    ) as post, mock.patch.object(

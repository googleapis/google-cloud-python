...
from google.cloud.notebooks_v2.services.notebook_service import (
...
def test_notebook_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.notebooks_v2.services.notebook_service.transports.NotebookServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_check_instance_upgradability(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.check_instance_upgradability), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_check_instance_upgradability_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.check_instance_upgradability
...
@pytest.mark.asyncio
async def test_check_instance_upgradability_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.check_instance_upgradability
            in client._client._transport._wrapped_methods
        )
...
async def test_check_instance_upgradability_async(
...
def test_rollback_instance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.rollback_instance] = (
            mock_rpc
        )
        request = {}
...
async def test_rollback_instance_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_diagnose_instance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.diagnose_instance] = (
            mock_rpc
        )
        request = {}
...
async def test_diagnose_instance_async(request_type, transport: str = "grpc_asyncio"):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_check_instance_upgradability_rest_required_fields(
    request_type=service.CheckInstanceUpgradabilityRequest,
):
    transport_class = transports.NotebookServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseCheckInstanceUpgradability,
        "_BaseCheckInstanceUpgradability__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_rollback_instance_rest_required_fields(
    request_type=service.RollbackInstanceRequest,
):
    transport_class = transports.NotebookServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseRollbackInstance,
        "_BaseRollbackInstance__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_diagnose_instance_rest_required_fields(
    request_type=service.DiagnoseInstanceRequest,
):
    transport_class = transports.NotebookServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseDiagnoseInstance,
        "_BaseDiagnoseInstance__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_diagnose_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/instances/*}:diagnose"
            % client.transport._host,
            args[1],
        )
...
def test_check_instance_upgradability_rest_bad_request(
    request_type=service.CheckInstanceUpgradabilityRequest,
):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_check_instance_upgradability_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.NotebookServiceRestInterceptor,
            "post_check_instance_upgradability",
        ) as post,
        mock.patch.object(
            transports.NotebookServiceRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.CheckInstanceUpgradabilityRequest.pb(
            service.CheckInstanceUpgradabilityRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.CheckInstanceUpgradabilityResponse.to_json(
            service.CheckInstanceUpgradabilityResponse()
        )
        req.return_value.content = return_value
...
def test_rollback_instance_rest_bad_request(
    request_type=service.RollbackInstanceRequest,
):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_rollback_instance_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.RollbackInstanceRequest.pb(
            service.RollbackInstanceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_diagnose_instance_rest_bad_request(
    request_type=service.DiagnoseInstanceRequest,
):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_diagnose_instance_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.DiagnoseInstanceRequest.pb(
            service.DiagnoseInstanceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_notebook_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.notebooks_v2.services.notebook_service.transports.NotebookServiceTransport.__init__"
    ) as Transport:

...
def test_get_instance(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_instance), "__call__") as call:
        ...
        call.return_value = instance.Instance(
            ...
            id="id_value",
            health_state=instance.HealthState.HEALTHY,
...
def test_check_instance_upgradability_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.check_instance_upgradability), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.check_instance_upgradability(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_check_instance_upgradability_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.check_instance_upgradability in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.check_instance_upgradability] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_check_instance_upgradability_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.check_instance_upgradability in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.check_instance_upgradability] = mock_rpc
...
def test_check_instance_upgradability_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_check_instance_upgradability_rest_required_fields(request_type=service.CheckInstanceUpgradabilityRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).check_instance_upgradability._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_rollback_instance_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_diagnose_instance_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_instance_upgradability_empty_call_grpc():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.check_instance_upgradability), "__call__") as call:
        call.return_value = service.CheckInstanceUpgradabilityResponse()
        client.check_instance_upgradability(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.CheckInstanceUpgradabilityRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_check_instance_upgradability_empty_call_grpc_asyncio():
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.check_instance_upgradability), "__call__") as call:
        ...
        await client.check_instance_upgradability(request=None)
...
def test_create_instance_rest_call_success(request_type):
    ...
    request_init["instance"] = {
        ...
        "gce_setup": {
            ...
            "vm_image": {"project": "project_value", "name": "name_value", "family": "family_value"},
            "container_image": {"repository": "repository_value", "tag": "tag_value"},
            "boot_disk": {"disk_size_gb": 1261, "disk_type": 1, "disk_encryption": 1, "kms_key": "kms_key_value"},
            "data_disks": [{"disk_size_gb": 1261, "disk_type": 1, "disk_encryption": 1, "kms_key": "kms_key_value"}],
            "shielded_instance_config": {"enable_secure_boot": True, "enable_vtpm": True, "enable_integrity_monitoring": True},
            "network_interfaces": [{"network": "network_value", "subnet": "subnet_value", "nic_type": 1}],
            "disable_public_ip": True,
            "tags": ["tags_value1", "tags_value2"],
            "metadata": {},
            "enable_ip_forwarding": True,
            "gpu_driver_config": {"enable_gpu_driver": True, "custom_gpu_driver_path": "custom_gpu_driver_path_value"},
        },
        "proxy_uri": "proxy_uri_value",
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_update_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_update_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_update_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_check_instance_upgradability_rest_bad_request(request_type=service.CheckInstanceUpgradabilityRequest):
    client = NotebookServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_check_instance_upgradability_rest_call_success(request_type):
    client = NotebookServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_check_instance_upgradability_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NotebookServiceRestInterceptor, "post_check_instance_upgradability") as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_check_instance_upgradability_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_check_instance_upgradability"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.CheckInstanceUpgradabilityResponse.to_json(service.CheckInstanceUpgradabilityResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.CheckInstanceUpgradabilityResponse(), metadata
...
def test_rollback_instance_rest_bad_request(request_type=service.RollbackInstanceRequest):
    client = NotebookServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/instances/sample3"}
    request = request_type(**request_init)
...
def test_rollback_instance_rest_call_success(request_type):
    client = NotebookServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_rollback_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_rollback_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_rollback_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_rollback_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_diagnose_instance_rest_bad_request(request_type=service.DiagnoseInstanceRequest):
    client = NotebookServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/instances/sample3"}
    request = request_type(**request_init)
...
def test_diagnose_instance_rest_call_success(request_type):
    client = NotebookServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_diagnose_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NotebookServiceRestInterceptor, "post_diagnose_instance"
    ) as post, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "post_diagnose_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.NotebookServiceRestInterceptor, "pre_diagnose_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_instance_upgradability_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_rollback_instance_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_diagnose_instance_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_notebook_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.notebooks_v2.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
@pytest.mark.asyncio
async def test_check_instance_upgradability_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = NotebookServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.check_instance_upgradability()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == service.CheckInstanceUpgradabilityRequest()
...
def test_check_instance_upgradability_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.CheckInstanceUpgradabilityResponse.to_json(
            service.CheckInstanceUpgradabilityResponse()
        )
...
def test_check_instance_upgradability_rest_bad_request(
    transport: str = "rest", request_type=service.CheckInstanceUpgradabilityRequest
):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_rollback_instance_rest_bad_request(
    transport: str = "rest", request_type=service.RollbackInstanceRequest
):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_diagnose_instance_rest_bad_request(
    transport: str = "rest", request_type=service.DiagnoseInstanceRequest
):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

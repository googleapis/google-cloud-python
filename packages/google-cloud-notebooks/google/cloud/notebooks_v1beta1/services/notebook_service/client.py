...
class NotebookServiceClient(metaclass=NotebookServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.notebooks_v1beta1.NotebookServiceClient`.",
                    extra={
    ...
    def is_instance_upgradeable(
        ...
        *,
        ...
        """
        warnings.warn("NotebookServiceClient.is_instance_upgradeable is deprecated", DeprecationWarning)
    ...
    def upgrade_instance(
        ...
        *,
        ...
        """
        warnings.warn("NotebookServiceClient.upgrade_instance is deprecated", DeprecationWarning)
    ...
    def upgrade_instance_internal(
        ...
        *,
        ...
        """
        warnings.warn("NotebookServiceClient.upgrade_instance_internal is deprecated", DeprecationWarning)

...
class NotebookServiceGrpcAsyncIOTransport(NotebookServiceTransport):
    ...
    @property
    def register_instance(self) -> Callable[[service.RegisterInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def set_instance_accelerator(self) -> Callable[[service.SetInstanceAcceleratorRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def set_instance_machine_type(self) -> Callable[[service.SetInstanceMachineTypeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def set_instance_labels(self) -> Callable[[service.SetInstanceLabelsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def report_instance_info(self) -> Callable[[service.ReportInstanceInfoRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def is_instance_upgradeable(self) -> Callable[[service.IsInstanceUpgradeableRequest], Awaitable[service.IsInstanceUpgradeableResponse]]:
    ...
    @property
    def upgrade_instance_internal(self) -> Callable[[service.UpgradeInstanceInternalRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_environment(self) -> Callable[[service.GetEnvironmentRequest], Awaitable[environment.Environment]]:

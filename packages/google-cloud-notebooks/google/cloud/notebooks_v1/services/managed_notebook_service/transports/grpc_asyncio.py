...
class ManagedNotebookServiceGrpcAsyncIOTransport(ManagedNotebookServiceTransport):
    ...
    @property
    def list_runtimes(self) -> Callable[[managed_service.ListRuntimesRequest], Awaitable[managed_service.ListRuntimesResponse]]:
    ...
    @property
    def get_runtime(self) -> Callable[[managed_service.GetRuntimeRequest], Awaitable[runtime.Runtime]]:
    ...
    @property
    def create_runtime(self) -> Callable[[managed_service.CreateRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_runtime(self) -> Callable[[managed_service.UpdateRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_runtime(self) -> Callable[[managed_service.DeleteRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def start_runtime(self) -> Callable[[managed_service.StartRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def stop_runtime(self) -> Callable[[managed_service.StopRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def switch_runtime(self) -> Callable[[managed_service.SwitchRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def reset_runtime(self) -> Callable[[managed_service.ResetRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def upgrade_runtime(self) -> Callable[[managed_service.UpgradeRuntimeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def report_runtime_event(self) -> Callable[[managed_service.ReportRuntimeEventRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def refresh_runtime_token_internal(
        self,
    ) -> Callable[[managed_service.RefreshRuntimeTokenInternalRequest], Awaitable[managed_service.RefreshRuntimeTokenInternalResponse]]:
        ...
        if "refresh_runtime_token_internal" not in self._stubs:
            self._stubs["refresh_runtime_token_internal"] = self._logged_channel.unary_unary(
    ...
    @property
    def diagnose_runtime(self) -> Callable[[managed_service.DiagnoseRuntimeRequest], Awaitable[operations_pb2.Operation]]:

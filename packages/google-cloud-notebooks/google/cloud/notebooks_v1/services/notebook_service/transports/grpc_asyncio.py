...
class NotebookServiceGrpcAsyncIOTransport(NotebookServiceTransport):
    ...
    @property
    def update_instance_config(self) -> Callable[[service.UpdateInstanceConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_shielded_instance_config(self) -> Callable[[service.UpdateShieldedInstanceConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def update_instance_metadata_items(
        self,
    ) -> Callable[[service.UpdateInstanceMetadataItemsRequest], Awaitable[service.UpdateInstanceMetadataItemsResponse]]:
    ...
    @property
    def get_instance_health(self) -> Callable[[service.GetInstanceHealthRequest], Awaitable[service.GetInstanceHealthResponse]]:
    ...
    @property
    def list_schedules(self) -> Callable[[service.ListSchedulesRequest], Awaitable[service.ListSchedulesResponse]]:
    ...
    @property
    def get_schedule(self) -> Callable[[service.GetScheduleRequest], Awaitable[schedule.Schedule]]:
    ...
    @property
    def delete_schedule(self) -> Callable[[service.DeleteScheduleRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def create_schedule(self) -> Callable[[service.CreateScheduleRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def trigger_schedule(self) -> Callable[[service.TriggerScheduleRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_executions(self) -> Callable[[service.ListExecutionsRequest], Awaitable[service.ListExecutionsResponse]]:
    ...
    @property
    def get_execution(self) -> Callable[[service.GetExecutionRequest], Awaitable[execution.Execution]]:
    ...
    @property
    def delete_execution(self) -> Callable[[service.DeleteExecutionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def create_execution(self) -> Callable[[service.CreateExecutionRequest], Awaitable[operations_pb2.Operation]]:

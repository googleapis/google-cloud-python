...
from google.cloud.notebooks_v2.services.notebook_service import pagers
...
class NotebookServiceClient(metaclass=NotebookServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "notebooks.{UNIVERSE_DOMAIN}"
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = NotebookServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = NotebookServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, NotebookServiceTransport, Callable[..., NotebookServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NotebookServiceClient._read_environment_variables()
        self._client_cert_source = NotebookServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NotebookServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or NotebookServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NotebookServiceTransport], Callable[..., NotebookServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.notebooks_v2.NotebookServiceClient`.",
                    extra={
    ...
    def list_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.ListInstancesRequest, dict]):
    ...
    def get_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.GetInstanceRequest, dict]):
    ...
    def create_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.CreateInstanceRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.notebooks_v2.types.Instance` The
    ...
    def update_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.UpdateInstanceRequest, dict]):
                The request object. Request for updating a notebook
                instance.
            instance (google.cloud.notebooks_v2.types.Instance):
                Required. A representation of an
                instance.
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Required. Mask used to update an
                instance
    ...
    def delete_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.DeleteInstanceRequest, dict]):
    ...
    def start_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.StartInstanceRequest, dict]):
    ...
    def stop_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.StopInstanceRequest, dict]):
    ...
    def reset_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.ResetInstanceRequest, dict]):
    ...
    def check_instance_upgradability(
        self,
        request: Optional[Union[service.CheckInstanceUpgradabilityRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.CheckInstanceUpgradabilityRequest, dict]):
        ...
        Returns:
            google.cloud.notebooks_v2.types.CheckInstanceUpgradabilityResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.CheckInstanceUpgradabilityRequest):
            request = service.CheckInstanceUpgradabilityRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.check_instance_upgradability]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("notebook_instance", request.notebook_instance),)),)
    ...
    def upgrade_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.UpgradeInstanceRequest, dict]):
    ...
    def rollback_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.RollbackInstanceRequest, dict]):
    ...
    def diagnose_instance(
        self,
        request: Optional[Union[service.DiagnoseInstanceRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.notebooks_v2.types.DiagnoseInstanceRequest, dict]):
                The request object. Request for creating a notebook
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.diagnose_instance]

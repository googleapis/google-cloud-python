...
from google.cloud.notebooks_v2._compat import (
    get_api_endpoint,
...
from google.cloud.notebooks_v2.types import gce_setup, instance, service
...
class NotebookServiceClient(metaclass=NotebookServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=NotebookServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def check_instance_upgradability(
        self,
        request: Optional[
            Union[service.CheckInstanceUpgradabilityRequest, dict]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.check_instance_upgradability
        ]

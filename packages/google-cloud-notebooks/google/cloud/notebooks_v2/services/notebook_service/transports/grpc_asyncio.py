...
class NotebookServiceGrpcAsyncIOTransport(NotebookServiceTransport):
    ...
    def check_instance_upgradability(
        ...
        Returns:
            Callable[[~.CheckInstanceUpgradabilityRequest],
                    Awaitable[~.CheckInstanceUpgradabilityResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "check_instance_upgradability" not in self._stubs:
            self._stubs["check_instance_upgradability"] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.check_instance_upgradability: gapic_v1.method_async.wrap_method(
                self.check_instance_upgradability,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.rollback_instance: gapic_v1.method_async.wrap_method(
                self.rollback_instance,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.diagnose_instance: gapic_v1.method_async.wrap_method(

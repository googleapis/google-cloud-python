...
class _BaseNotebookServiceRestTransport(NotebookServiceTransport):
    ...
    class _BaseCheckInstanceUpgradability:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseNotebookServiceRestTransport._BaseCheckInstanceUpgradability._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseDiagnoseInstance:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseNotebookServiceRestTransport._BaseDiagnoseInstance._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseRollbackInstance:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseNotebookServiceRestTransport._BaseRollbackInstance._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateInstance:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseNotebookServiceRestTransport._BaseUpdateInstance._get_unset_required_fields(
                    query_params
                )
            )

...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.notebooks_v2")  # type: ignore
    api_core.check_dependency_versions("google.cloud.notebooks_v2")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.notebooks_v2"

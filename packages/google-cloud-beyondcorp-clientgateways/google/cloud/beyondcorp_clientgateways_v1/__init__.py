...
__lazy_modules__ = {
    "google.cloud.beyondcorp_clientgateways_v1.services.client_gateways_service",
    "google.cloud.beyondcorp_clientgateways_v1.types.client_gateways_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.beyondcorp_clientgateways_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.beyondcorp_clientgateways_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.beyondcorp_clientgateways_v1"

...
from google.cloud.beyondcorp_clientgateways_v1.services.client_gateways_service import pagers
...
class ClientGatewaysServiceClientMeta(type):
    """Metaclass for the ClientGatewaysService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ClientGatewaysServiceTransport]]
...
class ClientGatewaysServiceClient(metaclass=ClientGatewaysServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "beyondcorp.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ClientGatewaysServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> ClientGatewaysServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            ClientGatewaysServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def client_gateway_path(
        project: str,
        location: str,
        client_gateway: str,
    ) -> str:
        """Returns a fully-qualified client_gateway string."""
        return "projects/{project}/locations/{location}/clientGateways/{client_gateway}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_client_gateway_path(path: str) -> Dict[str, str]:
        """Parses a client_gateway path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clientGateways/(?P<client_gateway>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ClientGatewaysServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ClientGatewaysServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ClientGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ClientGatewaysServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ClientGatewaysServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ClientGatewaysServiceTransport, Callable[..., ClientGatewaysServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ClientGatewaysServiceClient._read_environment_variables()
        self._client_cert_source = ClientGatewaysServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ClientGatewaysServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ClientGatewaysServiceTransport)
        if transport_provided:
            # transport is a ClientGatewaysServiceTransport instance.
            ...
            self._transport = cast(ClientGatewaysServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ClientGatewaysServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ClientGatewaysServiceTransport], Callable[..., ClientGatewaysServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.beyondcorp.clientgateways_v1.ClientGatewaysServiceClient`.",
                    extra={
    ...
    def list_client_gateways(
        self,
        request: Optional[Union[client_gateways_service.ListClientGatewaysRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_client_gateways():
                ...
                request = beyondcorp_clientgateways_v1.ListClientGatewaysRequest(
                    parent="parent_value",
                )
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_client_gateways]
        ...
        response = pagers.ListClientGatewaysPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_client_gateway(
        self,
        request: Optional[Union[client_gateways_service.GetClientGatewayRequest, dict]] = None,
        *,
        ...
        Returns:
            google.cloud.beyondcorp_clientgateways_v1.types.ClientGateway:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_client_gateway]
    ...
    def create_client_gateway(
        self,
        request: Optional[Union[client_gateways_service.CreateClientGatewayRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_create_client_gateway():
                ...
                request = beyondcorp_clientgateways_v1.CreateClientGatewayRequest(
                    parent="parent_value",
                    client_gateway=client_gateway,
                )
        ...
        Args:
            ...
            client_gateway (google.cloud.beyondcorp_clientgateways_v1.types.ClientGateway):
                ...
                This corresponds to the ``client_gateway`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.beyondcorp_clientgateways_v1.types.ClientGateway`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, client_gateway, client_gateway_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, client_gateways_service.CreateClientGatewayRequest):
            ...
            if client_gateway is not None:
                request.client_gateway = client_gateway
            if client_gateway_id is not None:
                request.client_gateway_id = client_gateway_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_client_gateway]
        ...
        response = operation.from_gapic(
            ...
            client_gateways_service.ClientGateway,
            metadata_type=client_gateways_service.ClientGatewayOperationMetadata,
        )
    ...
    def delete_client_gateway(
        self,
        request: Optional[Union[client_gateways_service.DeleteClientGatewayRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_delete_client_gateway():
                ...
                # Initialize request argument(s)
                request = beyondcorp_clientgateways_v1.DeleteClientGatewayRequest(
                    name="name_value",
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_client_gateway]

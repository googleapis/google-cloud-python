...
class ClientGatewaysServiceClient(metaclass=ClientGatewaysServiceClientMeta):
    ...
    def parse_client_gateway_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clientGateways/(?P<client_gateway>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                ClientGatewaysServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            ClientGatewaysServiceClient._read_environment_variables()
        )
        self._client_cert_source = ClientGatewaysServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ClientGatewaysServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ClientGatewaysServiceClient._get_api_endpoint(

...
class ListClientGatewaysAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[client_gateways_service.ListClientGatewaysResponse]],
        request: client_gateways_service.ListClientGatewaysRequest,
        response: client_gateways_service.ListClientGatewaysResponse,
        *,
    ...
    @property
    async def pages(self) -> AsyncIterator[client_gateways_service.ListClientGatewaysResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

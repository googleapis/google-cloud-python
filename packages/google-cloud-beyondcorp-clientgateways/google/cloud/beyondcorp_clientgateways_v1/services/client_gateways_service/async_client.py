...
class ClientGatewaysServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ClientGatewaysServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ClientGatewaysServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ClientGatewaysServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ClientGatewaysServiceAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_client_gateway():
                ...
                # Make the request
                operation = await client.create_client_gateway(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_client_gateway():
                ...
                # Make the request
                operation = await client.delete_client_gateway(request=request)

...
class DirectAccessServiceClient(metaclass=DirectAccessServiceClientMeta):
    ...
    def parse_device_session_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/deviceSessions/(?P<device_session>.+?)$", path
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DirectAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = DirectAccessServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DirectAccessServiceClient._get_api_endpoint(

...
from .transports.grpc import DirectAccessServiceGrpcTransport
from .transports.grpc_asyncio import DirectAccessServiceGrpcAsyncIOTransport
from .transports.rest import DirectAccessServiceRestTransport


class DirectAccessServiceClientMeta(type):
    """Metaclass for the DirectAccessService client.
    ...
    ) -> Type[DirectAccessServiceTransport]:
...
class DirectAccessServiceClient(metaclass=DirectAccessServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "devicestreaming.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DirectAccessServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DirectAccessServiceTransport:
        ...
        Returns:
            DirectAccessServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def device_session_path(
        project: str,
        device_session: str,
    ) -> str:
        """Returns a fully-qualified device_session string."""
        return "projects/{project}/deviceSessions/{device_session}".format(
            project=project,
            device_session=device_session,
        )

    @staticmethod
    def parse_device_session_path(path: str) -> Dict[str, str]:
        """Parses a device_session path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/deviceSessions/(?P<device_session>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = DirectAccessServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DirectAccessServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DirectAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DirectAccessServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DirectAccessServiceTransport, Callable[..., DirectAccessServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the direct access service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DirectAccessServiceClient._read_environment_variables()
        self._client_cert_source = DirectAccessServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DirectAccessServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DirectAccessServiceTransport)
        if transport_provided:
            # transport is a DirectAccessServiceTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or DirectAccessServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DirectAccessServiceTransport], Callable[..., DirectAccessServiceTransport]] = (
                DirectAccessServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DirectAccessServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.devicestreaming_v1.DirectAccessServiceClient`.",
                    extra={
    ...
    def create_device_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.devicestreaming_v1.types.CreateDeviceSessionRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_device_session]
    ...
    def list_device_sessions(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListDeviceSessionsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_device_sessions():
                # Create a client
                client = devicestreaming_v1.DirectAccessServiceClient()
        ...
        Args:
            request (Union[google.cloud.devicestreaming_v1.types.ListDeviceSessionsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_device_sessions]
        ...
        response = pagers.ListDeviceSessionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_device_session():
                ...
                # Make the request
                response = client.get_device_session(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.devicestreaming_v1.types.GetDeviceSessionRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_device_session]
    ...
    def cancel_device_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.devicestreaming_v1.types.CancelDeviceSessionRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.cancel_device_session]
    ...
    def update_device_session(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_device_session():
                # Create a client
                client = devicestreaming_v1.DirectAccessServiceClient()
                ...
                # Make the request
                response = client.update_device_session(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.devicestreaming_v1.types.UpdateDeviceSessionRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_device_session]
    ...
    def adb_connect(
        self,
        requests: Optional[Iterator[adb_service.AdbMessage]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> Iterable[adb_service.DeviceMessage]:
        ...
        Args:
            requests (Iterator[google.cloud.devicestreaming_v1.types.AdbMessage]):
                The request object iterator. A message to an ADB server.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
        ...
        Returns:
            Iterable[google.cloud.devicestreaming_v1.types.DeviceMessage]:
                A message returned from a device.
        """

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.adb_connect]
    ...
    def __enter__(self) -> "DirectAccessServiceClient":
        return self
...
__all__ = ("DirectAccessServiceClient",)

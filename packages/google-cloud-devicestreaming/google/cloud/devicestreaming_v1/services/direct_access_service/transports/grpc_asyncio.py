...
class DirectAccessServiceGrpcAsyncIOTransport(DirectAccessServiceTransport):
    ...
    def create_device_session(
        ...
        [service.CreateDeviceSessionRequest], Awaitable[service.DeviceSession]
    ]:
    ...
    def get_device_session(
        self,
    ) -> Callable[[service.GetDeviceSessionRequest], Awaitable[service.DeviceSession]]:
    ...
    def cancel_device_session(
        self,
    ) -> Callable[[service.CancelDeviceSessionRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def update_device_session(
        ...
        [service.UpdateDeviceSessionRequest], Awaitable[service.DeviceSession]
    ]:
    ...
    def adb_connect(
        self,
    ) -> Callable[[adb_service.AdbMessage], Awaitable[adb_service.DeviceMessage]]:

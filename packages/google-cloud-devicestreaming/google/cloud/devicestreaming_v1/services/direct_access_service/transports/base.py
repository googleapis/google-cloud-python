...
class DirectAccessServiceTransport(abc.ABC):
    """Abstract transport class for DirectAccessService."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "devicestreaming.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_device_session: gapic_v1.method.wrap_method(
                self.create_device_session,
                default_timeout=20.0,
                client_info=client_info,
            ),
            self.list_device_sessions: gapic_v1.method.wrap_method(
            ...
            self.get_device_session: gapic_v1.method.wrap_method(
                self.get_device_session,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.cancel_device_session: gapic_v1.method.wrap_method(
                self.cancel_device_session,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.update_device_session: gapic_v1.method.wrap_method(
                self.update_device_session,
                default_timeout=20.0,
                client_info=client_info,
            ),
            self.adb_connect: gapic_v1.method.wrap_method(
                self.adb_connect,
...
__all__ = ("DirectAccessServiceTransport",)

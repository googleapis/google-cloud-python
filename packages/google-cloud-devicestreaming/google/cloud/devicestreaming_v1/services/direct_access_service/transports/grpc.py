...
class DirectAccessServiceGrpcTransport(DirectAccessServiceTransport):
    """gRPC backend transport for DirectAccessService.
...
__all__ = ("DirectAccessServiceGrpcTransport",)

...
from google.cloud.devicestreaming_v1.services.direct_access_service import (
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = DirectAccessServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (DirectAccessServiceClient, "grpc"),
        (DirectAccessServiceAsyncClient, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (transports.DirectAccessServiceGrpcTransport, "grpc"),
        (transports.DirectAccessServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_direct_access_service_client_get_transport_class():
    transport = DirectAccessServiceClient.get_transport_class()
    ...
    assert transport == transports.DirectAccessServiceGrpcTransport
...
def test_direct_access_service_client_client_options_from_dict():
    with mock.patch(
...
def test_direct_access_service_client_create_channel_credentials_file(
    ...
    with (
        ...
        create_channel.assert_called_with(
            ...
            scopes=None,
            default_host="devicestreaming.googleapis.com",
...
def test_create_device_session(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = service.DeviceSession(
            ...
            state=service.DeviceSession.SessionState.REQUESTED,
        )
    ...
    assert isinstance(response, service.DeviceSession)
    assert response.name == "name_value"
    assert response.display_name == "display_name_value"
    assert response.state == service.DeviceSession.SessionState.REQUESTED


def test_create_device_session_non_empty_request_with_auto_populated_field():
...
def test_create_device_session_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_device_session] = (
            mock_rpc
        )
        request = {}
...
async def test_create_device_session_async(
    ...
    with mock.patch.object(
        ...
        response = await client.create_device_session(request)
...
@pytest.mark.asyncio
async def test_create_device_session_field_headers_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_device_session_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.create_device_session(
            parent="parent_value",
            device_session=service.DeviceSession(name="name_value"),
            device_session_id="device_session_id_value",
        )
        ...
        assert arg == mock_val
        arg = args[0].device_session
        mock_val = service.DeviceSession(name="name_value")
        assert arg == mock_val
        arg = args[0].device_session_id
        mock_val = "device_session_id_value"
        assert arg == mock_val


def test_create_device_session_flattened_error():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_device_session_flattened_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_device_session_flattened_error_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_device_session(
            service.CreateDeviceSessionRequest(),
            parent="parent_value",
            device_session=service.DeviceSession(name="name_value"),
            device_session_id="device_session_id_value",
...
def test_list_device_sessions(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.list_device_sessions(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListDeviceSessionsPager)
    assert response.next_page_token == "next_page_token_value"


def test_list_device_sessions_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_device_sessions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_device_sessions] = (
            mock_rpc
        )
        request = {}
...
async def test_list_device_sessions_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_device_sessions(request)
...
@pytest.mark.asyncio
async def test_list_device_sessions_field_headers_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_device_sessions_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_device_sessions_flattened_error():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_device_sessions_flattened_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_device_sessions_flattened_error_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_device_sessions(
            service.ListDeviceSessionsRequest(),
            parent="parent_value",
        )


def test_list_device_sessions_pager(transport_name: str = "grpc"):
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_device_sessions_pages(transport_name: str = "grpc"):
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_device_sessions(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_device_sessions_async_pager():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_device_sessions(
            request={},
        )
        ...
        assert all(isinstance(i, service.DeviceSession) for i in responses)


@pytest.mark.asyncio
async def test_list_device_sessions_async_pages():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_device_session(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.get_device_session(request)
...
def test_get_device_session_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_device_session_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_device_session] = (
            mock_rpc
        )
        request = {}
...
async def test_get_device_session_async(request_type, transport: str = "grpc_asyncio"):
    ...
    with mock.patch.object(
        ...
        response = await client.get_device_session(request)
...
@pytest.mark.asyncio
async def test_get_device_session_field_headers_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_device_session_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_device_session_flattened_error():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_device_session_flattened_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_device_session_flattened_error_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_device_session(
            service.GetDeviceSessionRequest(),
            name="name_value",
        )
...
def test_cancel_device_session_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_cancel_device_session_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.cancel_device_session] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_cancel_device_session_field_headers_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_device_session(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.update_device_session(request)
...
def test_update_device_session_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_device_session_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_device_session] = (
            mock_rpc
        )
        request = {}
...
async def test_update_device_session_async(
    ...
    with mock.patch.object(
        ...
        response = await client.update_device_session(request)
...
def test_update_device_session_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "device_session.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_device_session_field_headers_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_device_session_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_device_session_flattened_error():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_device_session_flattened_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_device_session_flattened_error_async():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_device_session(
            service.UpdateDeviceSessionRequest(),
            device_session=service.DeviceSession(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_adb_connect(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.adb_connect), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([adb_service.DeviceMessage()])
        response = client.adb_connect(iter(requests))
...
def test_adb_connect_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DirectAccessServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.adb_connect in client._transport._wrapped_methods
...
def test_create_device_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateDeviceSession,
    ...
    assert not set(unset_fields) - set(("deviceSessionId",))
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = service.DeviceSession.pb(return_value)
...
def test_create_device_session_rest_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_device_session(**mock_args)
...
def test_list_device_sessions_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DirectAccessServiceClient(
...
def test_list_device_sessions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListDeviceSessions,
    ...
    # Designate an appropriate value for the returned response.
    return_value = service.ListDeviceSessionsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = service.ListDeviceSessionsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_device_sessions_rest_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_device_sessions(**mock_args)
...
def test_list_device_sessions_rest_pager(transport: str = "rest"):
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pages = list(client.list_device_sessions(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_get_device_session_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DirectAccessServiceClient(
...
def test_get_device_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetDeviceSession,
...
def test_get_device_session_rest_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/deviceSessions/sample2"}
        ...
        client.get_device_session(**mock_args)
...
def test_cancel_device_session_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DirectAccessServiceClient(
...
def test_cancel_device_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCancelDeviceSession,
...
def test_update_device_session_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DirectAccessServiceClient(
...
def test_update_device_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateDeviceSession,
...
def test_update_device_session_rest_flattened():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_device_session(**mock_args)
...
def test_adb_connect_rest_no_http_options():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_transport_get_channel():
    ...
    transport = transports.DirectAccessServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_create_device_session_empty_call_grpc():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_device_sessions_empty_call_grpc():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_device_session_empty_call_grpc():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_device_session_empty_call_grpc():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_device_session_empty_call_grpc():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_device_session_empty_call_grpc_asyncio():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.create_device_session(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_device_sessions_empty_call_grpc_asyncio():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_device_sessions(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_device_session_empty_call_grpc_asyncio():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_device_session(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_cancel_device_session_empty_call_grpc_asyncio():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_device_session_empty_call_grpc_asyncio():
    client = DirectAccessServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_device_session(request=None)
...
def test_create_device_session_rest_call_success(request_type):
    ...
    request_init["device_session"] = {
        ...
        "active_start_time": {},
        "android_device": {
            "android_model_id": "android_model_id_value",
            "android_version_id": "android_version_id_value",
            "locale": "locale_value",
    ...
    test_field = service.CreateDeviceSessionRequest.meta.fields["device_session"]
    ...
    for field, value in request_init["device_session"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["device_session"][field])):
                    del request_init["device_session"][field][i][subfield]
            else:
                del request_init["device_session"][field][subfield]
    request = request_type(**request_init)
...
def test_create_device_session_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.DeviceSession.to_json(service.DeviceSession())
        ...
        post.return_value = service.DeviceSession()
        post_with_metadata.return_value = service.DeviceSession(), metadata
...
def test_list_device_sessions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        pre.return_value = request, metadata
        post.return_value = service.ListDeviceSessionsResponse()
        post_with_metadata.return_value = service.ListDeviceSessionsResponse(), metadata
...
def test_update_device_session_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = service.UpdateDeviceSessionRequest.meta.fields["device_session"]
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_device_session_empty_call_rest():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_device_sessions_empty_call_rest():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_device_session_empty_call_rest():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_device_session_empty_call_rest():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_device_session_empty_call_rest():
    client = DirectAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_direct_access_service_auth_adc():
...
def test_direct_access_service_transport_auth_adc(transport_class):
...
def test_direct_access_service_transport_auth_gdch_credentials(transport_class):
...
def test_direct_access_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = DirectAccessServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = DirectAccessServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.create_device_session._session
    session2 = client2.transport.create_device_session._session
    assert session1 != session2
    session1 = client1.transport.list_device_sessions._session
    session2 = client2.transport.list_device_sessions._session
    assert session1 != session2
    session1 = client1.transport.get_device_session._session
    session2 = client2.transport.get_device_session._session
    assert session1 != session2
    session1 = client1.transport.cancel_device_session._session
    session2 = client2.transport.cancel_device_session._session
    assert session1 != session2
    session1 = client1.transport.update_device_session._session
    session2 = client2.transport.update_device_session._session
    assert session1 != session2
    session1 = client1.transport.adb_connect._session
    session2 = client2.transport.adb_connect._session
    assert session1 != session2


def test_direct_access_service_grpc_transport_channel():
...
def test_direct_access_service_grpc_asyncio_transport_channel():
...
def test_device_session_path():
    project = "squid"
    device_session = "clam"
    expected = "projects/{project}/deviceSessions/{device_session}".format(
        project=project,
        device_session=device_session,
    )
    actual = DirectAccessServiceClient.device_session_path(project, device_session)
    assert expected == actual


def test_parse_device_session_path():
    expected = {
        "project": "whelk",
        "device_session": "octopus",
    }
    path = DirectAccessServiceClient.device_session_path(**expected)

    # Check that the path construction is reversible.
    actual = DirectAccessServiceClient.parse_device_session_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = DirectAccessServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = DirectAccessServiceClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = DirectAccessServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = DirectAccessServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = DirectAccessServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = DirectAccessServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = DirectAccessServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = DirectAccessServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = DirectAccessServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = DirectAccessServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = DirectAccessServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = DirectAccessServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = DirectAccessServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = DirectAccessServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = DirectAccessServiceClient.parse_common_location_path(path)
    assert expected == actual

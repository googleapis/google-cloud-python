...
class DataFusionAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DataFusionTransport, Callable[..., DataFusionTransport]]] = "grpc_asyncio",
    ...
    async def list_available_versions(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_available_versions]

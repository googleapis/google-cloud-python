...
class DataFusionGrpcAsyncIOTransport(DataFusionTransport):
    ...
    @property
    def list_available_versions(self) -> Callable[[datafusion.ListAvailableVersionsRequest], Awaitable[datafusion.ListAvailableVersionsResponse]]:
    ...
    @property
    def list_instances(self) -> Callable[[datafusion.ListInstancesRequest], Awaitable[datafusion.ListInstancesResponse]]:
    ...
    @property
    def get_instance(self) -> Callable[[datafusion.GetInstanceRequest], Awaitable[datafusion.Instance]]:
    ...
    @property
    def create_instance(self) -> Callable[[datafusion.CreateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_instance(self) -> Callable[[datafusion.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_instance(self) -> Callable[[datafusion.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def restart_instance(self) -> Callable[[datafusion.RestartInstanceRequest], Awaitable[operations_pb2.Operation]]:

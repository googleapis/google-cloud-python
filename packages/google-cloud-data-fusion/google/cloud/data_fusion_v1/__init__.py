...
__lazy_modules__ = {
    "google.cloud.data_fusion_v1.services.data_fusion",
    "google.cloud.data_fusion_v1.types.datafusion",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.data_fusion_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.data_fusion_v1")  # type: ignore

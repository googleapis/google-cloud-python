...
- While logged into your GitHub account, navigate to the
  ``python-data-fusion`` `repo`_ on GitHub.

- Fork and clone the ``python-data-fusion`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-data-fusion`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-data-fusion``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-data-fusion.git hack-on-python-data-fusion
   $ cd hack-on-python-data-fusion
...
.. _repo: https://github.com/googleapis/python-data-fusion
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-data-fusion``. The

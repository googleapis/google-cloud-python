...
class WorkloadManagerTransport(abc.ABC):
    """Abstract transport class for WorkloadManager."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "workloadmanager.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_execution_results: gapic_v1.method.wrap_method(
                self.list_execution_results,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.list_scanned_resources: gapic_v1.method.wrap_method(
                self.list_scanned_resources,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
    ...
    def list_evaluations(
        ...
        Union[
            service.ListEvaluationsResponse, Awaitable[service.ListEvaluationsResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_evaluation(
        ...
        Union[service.Evaluation, Awaitable[service.Evaluation]],
    ]:
        raise NotImplementedError()
    ...
    def get_execution(
        ...
        Union[service.Execution, Awaitable[service.Execution]],
    ]:
        raise NotImplementedError()
    ...
    def list_execution_results(
        ...
        Union[
            ...
            Awaitable[service.ListExecutionResultsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_rules(
        ...
        Union[service.ListRulesResponse, Awaitable[service.ListRulesResponse]],
    ]:
        raise NotImplementedError()
    ...
    def list_scanned_resources(
        ...
        Union[
            ...
            Awaitable[service.ListScannedResourcesResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("WorkloadManagerTransport",)

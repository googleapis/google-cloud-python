...
class WorkloadManagerGrpcTransport(WorkloadManagerTransport):
    """gRPC backend transport for WorkloadManager.
    ...
    def list_evaluations(
        ...
        if "list_evaluations" not in self._stubs:
            self._stubs["list_evaluations"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.ListEvaluationsRequest.serialize,
                response_deserializer=service.ListEvaluationsResponse.deserialize,
            )
    ...
    def get_evaluation(
        ...
        if "get_evaluation" not in self._stubs:
            self._stubs["get_evaluation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.GetEvaluationRequest.serialize,
                response_deserializer=service.Evaluation.deserialize,
            )
    ...
    def create_evaluation(
        ...
        Creates a new Evaluation in a given project and
        location.
        ...
        if "create_evaluation" not in self._stubs:
            self._stubs["create_evaluation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.CreateEvaluationRequest.serialize,
    ...
    def update_evaluation(
        ...
        if "update_evaluation" not in self._stubs:
            self._stubs["update_evaluation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.UpdateEvaluationRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def delete_evaluation(
        ...
        if "delete_evaluation" not in self._stubs:
            self._stubs["delete_evaluation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.DeleteEvaluationRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def get_execution(
        ...
        if "get_execution" not in self._stubs:
            self._stubs["get_execution"] = self._logged_channel.unary_unary(
                ...
                response_deserializer=service.Execution.deserialize,
            )
    ...
    def run_evaluation(
        ...
        if "run_evaluation" not in self._stubs:
            self._stubs["run_evaluation"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.RunEvaluationRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def list_execution_results(
        ...
        r"""Return a callable for the list execution results method over gRPC.

        Lists the result of a single evaluation.

        Returns:
            Callable[[~.ListExecutionResultsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_execution_results" not in self._stubs:
            self._stubs["list_execution_results"] = self._logged_channel.unary_unary(
                "/google.cloud.workloadmanager.v1.WorkloadManager/ListExecutionResults",
                request_serializer=service.ListExecutionResultsRequest.serialize,
                response_deserializer=service.ListExecutionResultsResponse.deserialize,
            )
        return self._stubs["list_execution_results"]
    ...
    def list_rules(
        ...
        if "list_rules" not in self._stubs:
            self._stubs["list_rules"] = self._logged_channel.unary_unary(
                ...
                request_serializer=service.ListRulesRequest.serialize,
                response_deserializer=service.ListRulesResponse.deserialize,
            )
    ...
    def list_scanned_resources(
        ...
        r"""Return a callable for the list scanned resources method over gRPC.

        List all scanned resources for a single Execution.

        Returns:
            Callable[[~.ListScannedResourcesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_scanned_resources" not in self._stubs:
            self._stubs["list_scanned_resources"] = self._logged_channel.unary_unary(
                "/google.cloud.workloadmanager.v1.WorkloadManager/ListScannedResources",
                request_serializer=service.ListScannedResourcesRequest.serialize,
                response_deserializer=service.ListScannedResourcesResponse.deserialize,
            )
        return self._stubs["list_scanned_resources"]
...
__all__ = ("WorkloadManagerGrpcTransport",)

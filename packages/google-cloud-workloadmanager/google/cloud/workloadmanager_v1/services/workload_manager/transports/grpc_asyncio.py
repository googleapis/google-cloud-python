...
class WorkloadManagerGrpcAsyncIOTransport(WorkloadManagerTransport):
    """gRPC AsyncIO backend transport for WorkloadManager.
    ...
    def list_evaluations(
        ...
        [service.ListEvaluationsRequest], Awaitable[service.ListEvaluationsResponse]
    ]:
    ...
    def get_evaluation(
        self,
    ) -> Callable[[service.GetEvaluationRequest], Awaitable[service.Evaluation]]:
    ...
    def create_evaluation(
        ...
        [service.CreateEvaluationRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_evaluation(
        ...
        [service.UpdateEvaluationRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_evaluation(
        ...
        [service.DeleteEvaluationRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def get_execution(
        self,
    ) -> Callable[[service.GetExecutionRequest], Awaitable[service.Execution]]:
    ...
    def run_evaluation(
        self,
    ) -> Callable[[service.RunEvaluationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def list_execution_results(
        ...
        Returns:
            Callable[[~.ListExecutionResultsRequest],
                    Awaitable[~.ListExecutionResultsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_rules(
        self,
    ) -> Callable[[service.ListRulesRequest], Awaitable[service.ListRulesResponse]]:
    ...
    def list_scanned_resources(
        ...
        Returns:
            Callable[[~.ListScannedResourcesRequest],
                    Awaitable[~.ListScannedResourcesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_execution_results: self._wrap_method(
            ...
            self.list_scanned_resources: self._wrap_method(
...
__all__ = ("WorkloadManagerGrpcAsyncIOTransport",)

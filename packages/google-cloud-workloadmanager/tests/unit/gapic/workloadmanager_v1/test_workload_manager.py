...
async def test_list_executions_async(request_type, transport: str = "grpc_asyncio"):
    client = WorkloadManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_execution_async(request_type, transport: str = "grpc_asyncio"):
    client = WorkloadManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_execution_async(request_type, transport: str = "grpc_asyncio"):
    client = WorkloadManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_execution_results_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_execution_results(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_scanned_resources_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_scanned_resources(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_evaluations_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListEvaluations,
...
def test_get_evaluation_rest_required_fields(request_type=service.GetEvaluationRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetEvaluation,
...
def test_create_evaluation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateEvaluation,
...
def test_update_evaluation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateEvaluation,
...
def test_delete_evaluation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteEvaluation,
...
def test_run_evaluation_rest_required_fields(request_type=service.RunEvaluationRequest):
    ...
    default_values = getattr(
        transport_class._BaseRunEvaluation,
...
def test_list_execution_results_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListExecutionResults,
        "_BaseListExecutionResults__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_rules_rest_required_fields(request_type=service.ListRulesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListRules,
...
def test_list_scanned_resources_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListScannedResources,
        "_BaseListScannedResources__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

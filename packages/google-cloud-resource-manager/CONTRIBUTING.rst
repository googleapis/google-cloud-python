...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-resource-manager``. The
...
instead of
``https://github.com/googleapis/python-resource-manager/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-resource-manager/blob/main/noxfile.py

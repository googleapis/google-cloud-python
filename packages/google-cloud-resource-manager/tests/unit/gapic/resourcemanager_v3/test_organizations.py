...
def test__get_default_mtls_endpoint():
    ...
    assert (
        OrganizationsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        OrganizationsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        OrganizationsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                OrganizationsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                OrganizationsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(OrganizationsClient),
)
@mock.patch.object(
    OrganizationsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(OrganizationsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = OrganizationsClient._DEFAULT_UNIVERSE
    default_endpoint = OrganizationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = OrganizationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == OrganizationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        OrganizationsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        OrganizationsClient._get_api_endpoint(None, None, default_universe, "always")
        == OrganizationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        OrganizationsClient._get_api_endpoint(
    ...
    assert (
        OrganizationsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        OrganizationsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        OrganizationsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        OrganizationsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        OrganizationsClient._get_universe_domain(None, None)
        == OrganizationsClient._DEFAULT_UNIVERSE
    )
...
def test_get_organization_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_organization] = (
            mock_rpc
        )
        request = {}
...
async def test_get_organization_async(request_type, transport: str = "grpc_asyncio"):
    client = OrganizationsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_search_organizations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.search_organizations in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.search_organizations] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_search_organizations_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.search_organizations
            in client._client._transport._wrapped_methods
        )
...
def test_search_organizations_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = organizations.SearchOrganizationsResponse.to_json(
            organizations.SearchOrganizationsResponse()
        )
        req.return_value.content = return_value

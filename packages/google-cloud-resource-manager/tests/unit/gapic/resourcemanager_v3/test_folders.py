...
def test__get_default_mtls_endpoint():
    ...
    assert FoldersClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__get_client_cert_source():
    ...
    assert (
        FoldersClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        FoldersClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                FoldersClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(FoldersClient),
)
@mock.patch.object(
    FoldersAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(FoldersAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = FoldersClient._DEFAULT_UNIVERSE
    default_endpoint = FoldersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = FoldersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == FoldersClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        FoldersClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        FoldersClient._get_api_endpoint(None, None, default_universe, "always")
        == FoldersClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        FoldersClient._get_api_endpoint(
    ...
    assert (
        FoldersClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        FoldersClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        FoldersClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        FoldersClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        FoldersClient._get_universe_domain(None, None)
        == FoldersClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_search_folders_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.search_folders
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_folder_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_folder
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_move_folder_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.move_folder
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_undelete_folder_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.undelete_folder
            in client._client._transport._wrapped_methods
        )
...
def test_get_folder_rest_required_fields(request_type=folders.GetFolderRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_folder._get_unset_required_fields(jsonified_request)
...
def test_get_folder_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{name=folders/*}" % client.transport._host, args[1]
        )
...
def test_list_folders_rest_required_fields(request_type=folders.ListFoldersRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_folders._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_folders_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/folders:search" % client.transport._host, args[1]
        )
...
def test_create_folder_rest_required_fields(request_type=folders.CreateFolderRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_folder_rest_required_fields(request_type=folders.UpdateFolderRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_folder_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{folder.name=folders/*}" % client.transport._host, args[1]
        )
...
def test_move_folder_rest_required_fields(request_type=folders.MoveFolderRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).move_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_move_folder_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=folders/*}:move" % client.transport._host, args[1]
        )
...
def test_delete_folder_rest_required_fields(request_type=folders.DeleteFolderRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_folder_rest_required_fields(
    request_type=folders.UndeleteFolderRequest,
):
    transport_class = transports.FoldersRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).undelete_folder._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_folder_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=folders/*}:undelete" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{resource=folders/*}:getIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{resource=folders/*}:setIamPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{resource=folders/*}:testIamPermissions" % client.transport._host,
            args[1],
        )
...
def test_transport_kind_grpc_asyncio():
    transport = FoldersAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = FoldersClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_folders_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = folders.ListFoldersResponse.to_json(
            folders.ListFoldersResponse()
        )
        req.return_value.content = return_value
...
def test_search_folders_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = folders.SearchFoldersResponse.to_json(
            folders.SearchFoldersResponse()
        )
        req.return_value.content = return_value

...
def test__read_environment_variables():
    assert TagHoldsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TagHoldsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert TagHoldsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert TagHoldsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TagHoldsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TagHoldsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert TagHoldsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert TagHoldsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                TagHoldsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert TagHoldsClient._get_client_cert_source(None, False) is None
    assert TagHoldsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TagHoldsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert TagHoldsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TagHoldsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(TagHoldsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsClient))
@mock.patch.object(TagHoldsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TagHoldsClient._DEFAULT_UNIVERSE
    default_endpoint = TagHoldsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TagHoldsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TagHoldsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert TagHoldsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TagHoldsClient.DEFAULT_MTLS_ENDPOINT
    assert TagHoldsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TagHoldsClient._get_api_endpoint(None, None, default_universe, "always") == TagHoldsClient.DEFAULT_MTLS_ENDPOINT
    assert TagHoldsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == TagHoldsClient.DEFAULT_MTLS_ENDPOINT
    assert TagHoldsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TagHoldsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TagHoldsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TagHoldsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TagHoldsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TagHoldsClient._get_universe_domain(None, None) == TagHoldsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        TagHoldsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TagHoldsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (TagHoldsClient, "grpc"),
        (TagHoldsAsyncClient, "grpc_asyncio"),
        (TagHoldsClient, "rest"),
    ],
)
def test_tag_holds_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "cloudresourcemanager.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://cloudresourcemanager.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.TagHoldsGrpcTransport, "grpc"),
        (transports.TagHoldsGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.TagHoldsRestTransport, "rest"),
    ],
)
...
def test_tag_holds_client_get_transport_class():
    ...
    available_transports = [
        transports.TagHoldsGrpcTransport,
        transports.TagHoldsRestTransport,
    ]
...
@pytest.mark.parametrize(
    ...
    [
        (TagHoldsClient, transports.TagHoldsGrpcTransport, "grpc"),
        (TagHoldsAsyncClient, transports.TagHoldsGrpcAsyncIOTransport, "grpc_asyncio"),
        (TagHoldsClient, transports.TagHoldsRestTransport, "rest"),
    ],
)
@mock.patch.object(TagHoldsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsClient))
@mock.patch.object(TagHoldsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (TagHoldsClient, transports.TagHoldsGrpcTransport, "grpc", "true"),
        (TagHoldsAsyncClient, transports.TagHoldsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (TagHoldsClient, transports.TagHoldsGrpcTransport, "grpc", "false"),
        (TagHoldsAsyncClient, transports.TagHoldsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (TagHoldsClient, transports.TagHoldsRestTransport, "rest", "true"),
        (TagHoldsClient, transports.TagHoldsRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(TagHoldsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsClient))
@mock.patch.object(TagHoldsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsAsyncClient))
...
@mock.patch.object(TagHoldsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsClient))
@mock.patch.object(TagHoldsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TagHoldsAsyncClient))
def test_tag_holds_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (TagHoldsClient, transports.TagHoldsGrpcTransport, "grpc", grpc_helpers),
        (TagHoldsAsyncClient, transports.TagHoldsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (TagHoldsClient, transports.TagHoldsRestTransport, "rest", None),
    ],
)
...
def test_create_tag_hold_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_tag_hold in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_tag_hold] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_tag_hold_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_tag_hold in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_tag_hold] = mock_rpc
...
def test_create_tag_hold_flattened():
    ...
    with mock.patch.object(type(client.transport.create_tag_hold), "__call__") as call:
        ...
        client.create_tag_hold(
            parent="parent_value",
            tag_hold=tag_holds.TagHold(name="name_value"),
        )
...
def test_delete_tag_hold_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_tag_hold in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_tag_hold] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_tag_hold_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TagHoldsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_tag_hold in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_tag_hold] = mock_rpc
...
def test_list_tag_holds_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_tag_holds in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_tag_holds] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_tag_holds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TagHoldsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_tag_holds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_tag_holds] = mock_rpc
...
def test_list_tag_holds_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_tag_holds), "__call__") as call:
        ...
        pager = client.list_tag_holds(request={}, retry=retry, timeout=timeout)
...
async def test_list_tag_holds_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_tag_holds), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async_pager = await client.list_tag_holds(
            request={},
        )
...
async def test_list_tag_holds_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_tag_holds), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_tag_holds(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_create_tag_hold_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagHoldsClient(
...
def test_delete_tag_hold_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagHoldsClient(
...
def test_list_tag_holds_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TagHoldsClient(
...
def test_credentials_transport_error():
    ...
    transport = transports.TagHoldsGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = TagHoldsClient(
...
def test_transport_get_channel():
    ...
    transport = transports.TagHoldsGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind_grpc():
    transport = TagHoldsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_tag_hold_empty_call_grpc():
    client = TagHoldsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_tag_hold), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_tag_hold(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_tag_hold_empty_call_grpc():
    client = TagHoldsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_tag_hold), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_tag_hold(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_tag_holds_empty_call_grpc():
    client = TagHoldsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_tag_holds), "__call__") as call:
        call.return_value = tag_holds.ListTagHoldsResponse()
        client.list_tag_holds(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = TagHoldsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = TagHoldsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_tag_hold_empty_call_grpc_asyncio():
    client = TagHoldsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_tag_hold), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_tag_hold(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_tag_hold_empty_call_grpc_asyncio():
    client = TagHoldsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_tag_hold), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_tag_hold(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_tag_holds_empty_call_grpc_asyncio():
    client = TagHoldsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_tag_holds), "__call__") as call:
        ...
        await client.list_tag_holds(request=None)
...
def test_transport_kind_rest():
    transport = TagHoldsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_tag_hold_rest_bad_request(request_type=tag_holds.CreateTagHoldRequest):
...
def test_create_tag_hold_rest_call_success(request_type):
    client = TagHoldsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"parent": "tagValues/sample1"}
    request_init["tag_hold"] = {
        "name": "name_value",
        "holder": "holder_value",
        "origin": "origin_value",
    ...
    for field, value in request_init["tag_hold"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_tag_hold_rest_interceptors(null_interceptor):
    transport = transports.TagHoldsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TagHoldsRestInterceptor(),
    )
    client = TagHoldsClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.TagHoldsRestInterceptor, "post_create_tag_hold"
    ) as post, mock.patch.object(
        transports.TagHoldsRestInterceptor, "post_create_tag_hold_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TagHoldsRestInterceptor, "pre_create_tag_hold"
    ) as pre:
...
def test_delete_tag_hold_rest_bad_request(request_type=tag_holds.DeleteTagHoldRequest):
    client = TagHoldsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_delete_tag_hold_rest_call_success(request_type):
    client = TagHoldsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_tag_hold_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.TagHoldsRestInterceptor, "post_delete_tag_hold"
    ) as post, mock.patch.object(
        transports.TagHoldsRestInterceptor, "post_delete_tag_hold_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TagHoldsRestInterceptor, "pre_delete_tag_hold"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_tag_holds_rest_bad_request(request_type=tag_holds.ListTagHoldsRequest):
    client = TagHoldsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "tagValues/sample1"}
    request = request_type(**request_init)
...
def test_list_tag_holds_rest_call_success(request_type):
    client = TagHoldsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_tag_holds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TagHoldsRestInterceptor, "post_list_tag_holds") as post, mock.patch.object(
        transports.TagHoldsRestInterceptor, "post_list_tag_holds_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TagHoldsRestInterceptor, "pre_list_tag_holds"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_holds.ListTagHoldsResponse.to_json(tag_holds.ListTagHoldsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = tag_holds.ListTagHoldsResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_tag_hold_empty_call_rest():
    client = TagHoldsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_tag_hold_empty_call_rest():
    client = TagHoldsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_tag_holds_empty_call_rest():
    client = TagHoldsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_tag_holds_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.resourcemanager_v3.services.tag_holds.transports.TagHoldsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.TagHoldsGrpcTransport, grpc_helpers), (transports.TagHoldsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_tag_holds_client_transport_session_collision(transport_name):
    ...
    client1 = TagHoldsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = TagHoldsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_tag_hold_path():
    tag_value = "squid"
    tag_hold = "clam"
    expected = "tagValues/{tag_value}/tagHolds/{tag_hold}".format(
        tag_value=tag_value,
        tag_hold=tag_hold,
    )
...
@pytest.mark.parametrize(
    ...
    [
        (TagHoldsClient, transports.TagHoldsGrpcTransport),
        (TagHoldsAsyncClient, transports.TagHoldsGrpcAsyncIOTransport),
    ],
)

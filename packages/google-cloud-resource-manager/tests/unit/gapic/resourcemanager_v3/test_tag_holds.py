...
def test_create_tag_hold_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateTagHold,
        "_BaseCreateTagHold__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_delete_tag_hold_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteTagHold,
        "_BaseDeleteTagHold__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_tag_holds_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListTagHolds,
        "_BaseListTagHolds__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
from google.cloud.resourcemanager_v3.services.tag_holds import (
    TagHoldsAsyncClient,
    TagHoldsClient,
    pagers,
    transports,
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TagHoldsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        TagHoldsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        TagHoldsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert TagHoldsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert TagHoldsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__get_client_cert_source():
    ...
    assert (
        TagHoldsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        TagHoldsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TagHoldsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                TagHoldsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TagHoldsClient),
)
@mock.patch.object(
    TagHoldsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(TagHoldsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TagHoldsClient._DEFAULT_UNIVERSE
    default_endpoint = TagHoldsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TagHoldsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        TagHoldsClient._get_api_endpoint(
    ...
    assert (
        ...
        == TagHoldsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TagHoldsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TagHoldsClient._get_api_endpoint(None, None, default_universe, "always")
        == TagHoldsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TagHoldsClient._get_api_endpoint(
    ...
    assert (
        TagHoldsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TagHoldsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TagHoldsClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        TagHoldsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TagHoldsClient._get_universe_domain(None, None)
        == TagHoldsClient._DEFAULT_UNIVERSE
    )
...
def test_tag_holds_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_tag_holds_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    TagHoldsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TagHoldsClient)
)
@mock.patch.object(
    TagHoldsAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(TagHoldsAsyncClient),
)
...
def test_tag_holds_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_tag_holds_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_tag_holds_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.resourcemanager_v3.services.tag_holds.transports.TagHoldsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_tag_holds_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_tag_hold_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_tag_hold
...
@pytest.mark.asyncio
async def test_delete_tag_hold_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_tag_hold
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_tag_holds_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_tag_holds
            in client._client._transport._wrapped_methods
        )
...
async def test_list_tag_holds_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_tag_holds), "__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            tag_holds.ListTagHoldsResponse(
...
def test_create_tag_hold_rest_required_fields(
    request_type=tag_holds.CreateTagHoldRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_tag_hold._get_unset_required_fields(jsonified_request)
...
def test_create_tag_hold_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=tagValues/*}/tagHolds" % client.transport._host, args[1]
        )
...
def test_delete_tag_hold_rest_required_fields(
    request_type=tag_holds.DeleteTagHoldRequest,
):
    transport_class = transports.TagHoldsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_tag_hold._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_tag_hold_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=tagValues/*/tagHolds/*}" % client.transport._host, args[1]
        )
...
def test_list_tag_holds_rest_required_fields(
    request_type=tag_holds.ListTagHoldsRequest,
):
    transport_class = transports.TagHoldsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_tag_holds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc_asyncio():
    transport = TagHoldsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = TagHoldsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_tag_holds_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TagHoldsRestInterceptor, "post_list_tag_holds"
        ) as post,
        mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_holds.ListTagHoldsResponse.to_json(
            tag_holds.ListTagHoldsResponse()
        )
        req.return_value.content = return_value
...
def test_tag_holds_base_transport():
    ...
    with mock.patch(
        "google.cloud.resourcemanager_v3.services.tag_holds.transports.TagHoldsTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [
        (transports.TagHoldsGrpcTransport, grpc_helpers),
        (transports.TagHoldsGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
@pytest.mark.parametrize(
    "transport_class",
    [transports.TagHoldsGrpcTransport, transports.TagHoldsGrpcAsyncIOTransport],
)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.TagHoldsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = TagHoldsClient(
            credentials=ga_credentials.AnonymousCredentials(),

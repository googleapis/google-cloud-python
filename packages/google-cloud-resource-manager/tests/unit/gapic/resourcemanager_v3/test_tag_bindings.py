...
def test_list_tag_bindings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.list_tag_bindings
        ] = mock_rpc
        request = {}
...
def test_create_tag_binding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.create_tag_binding
        ] = mock_rpc
        request = {}
...
def test_delete_tag_binding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.delete_tag_binding
        ] = mock_rpc
        request = {}
...
def test_list_effective_tags_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.list_effective_tags
        ] = mock_rpc
        request = {}
...
def test_list_tag_bindings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = tag_bindings.ListTagBindingsResponse.to_json(
            tag_bindings.ListTagBindingsResponse()
        )
...
def test_list_tag_bindings_rest_bad_request(
    transport: str = "rest", request_type=tag_bindings.ListTagBindingsRequest
):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_tag_binding_rest_bad_request(
    transport: str = "rest", request_type=tag_bindings.CreateTagBindingRequest
):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_tag_binding_rest_bad_request(
    transport: str = "rest", request_type=tag_bindings.DeleteTagBindingRequest
):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_effective_tags_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tag_bindings.ListEffectiveTagsResponse.to_json(
            tag_bindings.ListEffectiveTagsResponse()
        )
...
def test_list_effective_tags_rest_bad_request(
    transport: str = "rest", request_type=tag_bindings.ListEffectiveTagsRequest
):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

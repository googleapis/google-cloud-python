...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert TagBindingsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TagBindingsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TagBindingsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                TagBindingsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        TagBindingsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        TagBindingsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TagBindingsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                TagBindingsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TagBindingsClient),
)
@mock.patch.object(
    TagBindingsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(TagBindingsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TagBindingsClient._DEFAULT_UNIVERSE
    default_endpoint = TagBindingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TagBindingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == TagBindingsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TagBindingsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TagBindingsClient._get_api_endpoint(None, None, default_universe, "always")
        == TagBindingsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TagBindingsClient._get_api_endpoint(
    ...
    assert (
        TagBindingsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TagBindingsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TagBindingsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        TagBindingsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TagBindingsClient._get_universe_domain(None, None)
        == TagBindingsClient._DEFAULT_UNIVERSE
    )
...
def test_list_tag_bindings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_tag_bindings] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_tag_bindings_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_tag_bindings
...
def test_create_tag_binding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_tag_binding in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_tag_binding] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_tag_binding_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_tag_binding
            in client._client._transport._wrapped_methods
        )
...
def test_delete_tag_binding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_tag_binding in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_tag_binding] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_tag_binding_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_tag_binding
            in client._client._transport._wrapped_methods
        )
...
def test_list_effective_tags(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_effective_tags), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_list_effective_tags_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_effective_tags in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.list_effective_tags] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_effective_tags_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_effective_tags
            in client._client._transport._wrapped_methods
        )
...
async def test_list_effective_tags_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_effective_tags(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
...
def test_list_tag_bindings_rest_required_fields(
    request_type=tag_bindings.ListTagBindingsRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_tag_bindings._get_unset_required_fields(jsonified_request)
...
def test_list_tag_bindings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/tagBindings" % client.transport._host, args[1]
        )
...
def test_list_tag_bindings_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            tag_bindings.ListTagBindingsResponse.to_json(x) for x in response
        )
...
def test_create_tag_binding_rest_required_fields(
    request_type=tag_bindings.CreateTagBindingRequest,
):
    transport_class = transports.TagBindingsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_tag_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_tag_binding_rest_required_fields(
    request_type=tag_bindings.DeleteTagBindingRequest,
):
    transport_class = transports.TagBindingsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_tag_binding._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_tag_binding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=tagBindings/**}" % client.transport._host, args[1]
        )
...
def test_list_effective_tags_rest_required_fields(
    request_type=tag_bindings.ListEffectiveTagsRequest,
):
    transport_class = transports.TagBindingsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_effective_tags._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_effective_tags_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/effectiveTags" % client.transport._host, args[1]
        )
...
def test_list_effective_tags_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            tag_bindings.ListEffectiveTagsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_list_tag_bindings_rest_bad_request(
    request_type=tag_bindings.ListTagBindingsRequest,
):
    client = TagBindingsClient(
...
def test_list_tag_bindings_rest_interceptors(null_interceptor):
    transport = transports.TagBindingsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.TagBindingsRestInterceptor(),
    )
    client = TagBindingsClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_bindings.ListTagBindingsResponse.to_json(
            tag_bindings.ListTagBindingsResponse()
        )
...
def test_create_tag_binding_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["tag_binding"] = {
        "name": "name_value",
        "parent": "parent_value",
        "tag_value": "tag_value_value",
        "tag_value_namespaced_name": "tag_value_namespaced_name_value",
    }
...
def test_list_effective_tags_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_bindings.ListEffectiveTagsResponse.to_json(
            tag_bindings.ListEffectiveTagsResponse()
        )
        req.return_value.content = return_value

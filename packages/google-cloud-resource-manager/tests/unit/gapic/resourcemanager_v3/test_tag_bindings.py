...
def test_list_effective_tags_rest_required_fields(request_type=tag_bindings.ListEffectiveTagsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_effective_tags._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = TagBindingsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = TagBindingsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = TagBindingsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = TagBindingsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_tag_bindings_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.TagBindingsRestInterceptor, "post_list_tag_bindings") as post, mock.patch.object(
...
def test_list_effective_tags_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TagBindingsRestInterceptor, "post_list_effective_tags") as post, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.TagBindingsGrpcTransport, grpc_helpers), (transports.TagBindingsGrpcAsyncIOTransport, grpc_helpers_async)],
)

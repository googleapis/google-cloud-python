...
def test__get_default_mtls_endpoint():
    ...
    assert TagKeysClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert TagKeysClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TagKeysClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TagKeysClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                TagKeysClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        TagKeysClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        TagKeysClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TagKeysClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TagKeysClient),
)
@mock.patch.object(
    TagKeysAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(TagKeysAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TagKeysClient._DEFAULT_UNIVERSE
    default_endpoint = TagKeysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TagKeysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == TagKeysClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TagKeysClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TagKeysClient._get_api_endpoint(None, None, default_universe, "always")
        == TagKeysClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TagKeysClient._get_api_endpoint(
    ...
    assert (
        TagKeysClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TagKeysClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TagKeysClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        TagKeysClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TagKeysClient._get_universe_domain(None, None)
        == TagKeysClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_list_tag_keys_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_tag_keys
...
async def test_list_tag_keys_async(request_type, transport: str = "grpc_asyncio"):
    client = TagKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_tag_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_tag_key
            in client._client._transport._wrapped_methods
        )
...
async def test_get_tag_key_async(request_type, transport: str = "grpc_asyncio"):
    client = TagKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_namespaced_tag_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_namespaced_tag_key
        ...
        client._transport._wrapped_methods[client._transport.get_namespaced_tag_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_namespaced_tag_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_namespaced_tag_key
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_tag_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_tag_key
            in client._client._transport._wrapped_methods
        )
...
async def test_create_tag_key_async(request_type, transport: str = "grpc_asyncio"):
    client = TagKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_tag_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_tag_key
            in client._client._transport._wrapped_methods
        )
...
async def test_update_tag_key_async(request_type, transport: str = "grpc_asyncio"):
    client = TagKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_tag_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_tag_key
            in client._client._transport._wrapped_methods
        )
...
async def test_delete_tag_key_async(request_type, transport: str = "grpc_asyncio"):
    client = TagKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_tag_keys_rest_required_fields(request_type=tag_keys.ListTagKeysRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_tag_keys._get_unset_required_fields(jsonified_request)
...
def test_get_tag_key_rest_required_fields(request_type=tag_keys.GetTagKeyRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_tag_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{name=tagKeys/*}" % client.transport._host, args[1]
        )
...
def test_create_tag_key_rest_required_fields(request_type=tag_keys.CreateTagKeyRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_tag_key_rest_required_fields(request_type=tag_keys.UpdateTagKeyRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_tag_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{tag_key.name=tagKeys/*}" % client.transport._host, args[1]
        )
...
def test_delete_tag_key_rest_required_fields(request_type=tag_keys.DeleteTagKeyRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_tag_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{resource=tagKeys/*}:getIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{resource=tagKeys/*}:setIamPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{resource=tagKeys/*}:testIamPermissions" % client.transport._host,
            args[1],
        )
...
def test_list_tag_keys_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = tag_keys.ListTagKeysResponse.to_json(
            tag_keys.ListTagKeysResponse()
        )
...
def test_get_namespaced_tag_key_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TagKeysRestInterceptor,

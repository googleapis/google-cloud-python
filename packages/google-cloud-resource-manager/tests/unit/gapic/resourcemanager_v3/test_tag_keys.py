...
def test_list_tag_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = tag_keys.ListTagKeysResponse.to_json(
            tag_keys.ListTagKeysResponse()
        )
...
def test_list_tag_keys_rest_bad_request(
    transport: str = "rest", request_type=tag_keys.ListTagKeysRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_tag_key_rest_bad_request(
    transport: str = "rest", request_type=tag_keys.GetTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_tag_key_rest_bad_request(
    transport: str = "rest", request_type=tag_keys.CreateTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_tag_key_rest_bad_request(
    transport: str = "rest", request_type=tag_keys.UpdateTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_tag_key_rest_bad_request(
    transport: str = "rest", request_type=tag_keys.DeleteTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

...
class TagBindingsGrpcAsyncIOTransport(TagBindingsTransport):
    ...
    @property
    def create_tag_binding(self) -> Callable[[tag_bindings.CreateTagBindingRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_tag_binding(self) -> Callable[[tag_bindings.DeleteTagBindingRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_effective_tags(self) -> Callable[[tag_bindings.ListEffectiveTagsRequest], Awaitable[tag_bindings.ListEffectiveTagsResponse]]:

...
class TagBindingsTransport(abc.ABC):
    ...
    def list_tag_bindings(
        ...
        [tag_bindings.ListTagBindingsRequest], Union[tag_bindings.ListTagBindingsResponse, Awaitable[tag_bindings.ListTagBindingsResponse]]
    ]:
        raise NotImplementedError()
    ...
    def create_tag_binding(
        self,
    ) -> Callable[[tag_bindings.CreateTagBindingRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_tag_binding(
        self,
    ) -> Callable[[tag_bindings.DeleteTagBindingRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    def list_effective_tags(
        ...
        [tag_bindings.ListEffectiveTagsRequest], Union[tag_bindings.ListEffectiveTagsResponse, Awaitable[tag_bindings.ListEffectiveTagsResponse]]
    ]:
        raise NotImplementedError()

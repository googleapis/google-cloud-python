...
class TagBindingsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, TagBindingsTransport, Callable[..., TagBindingsTransport]]] = "grpc_asyncio",
    ...
    async def list_tag_bindings(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_tag_bindings]
    ...
    async def create_tag_binding(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_tag_binding]
    ...
    async def delete_tag_binding(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_tag_binding]
    ...
    async def list_effective_tags(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_effective_tags]

...
class TagHoldsAsyncClient:
    ...
    common_billing_account_path = staticmethod(TagHoldsClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(TagHoldsClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(TagHoldsClient.parse_common_organization_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, TagHoldsTransport, Callable[..., TagHoldsTransport]]] = "grpc_asyncio",
    ...
    async def create_tag_hold(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_tag_hold]
    ...
    async def delete_tag_hold(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_tag_hold]
    ...
    async def list_tag_holds(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_tag_holds]

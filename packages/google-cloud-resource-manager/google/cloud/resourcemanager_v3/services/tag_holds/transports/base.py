...
class TagHoldsTransport(abc.ABC):
    ...
    @property
    def create_tag_hold(self) -> Callable[[tag_holds.CreateTagHoldRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_tag_hold(self) -> Callable[[tag_holds.DeleteTagHoldRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def list_tag_holds(
        self,
    ) -> Callable[[tag_holds.ListTagHoldsRequest], Union[tag_holds.ListTagHoldsResponse, Awaitable[tag_holds.ListTagHoldsResponse]]]:
        raise NotImplementedError()

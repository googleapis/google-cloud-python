...
class TagHoldsGrpcAsyncIOTransport(TagHoldsTransport):
    ...
    @property
    def create_tag_hold(self) -> Callable[[tag_holds.CreateTagHoldRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_tag_hold(self) -> Callable[[tag_holds.DeleteTagHoldRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_tag_holds(self) -> Callable[[tag_holds.ListTagHoldsRequest], Awaitable[tag_holds.ListTagHoldsResponse]]:

...
class ProjectsGrpcAsyncIOTransport(ProjectsTransport):
    ...
    @property
    def get_project(self) -> Callable[[projects.GetProjectRequest], Awaitable[projects.Project]]:
    ...
    @property
    def list_projects(self) -> Callable[[projects.ListProjectsRequest], Awaitable[projects.ListProjectsResponse]]:
    ...
    @property
    def search_projects(self) -> Callable[[projects.SearchProjectsRequest], Awaitable[projects.SearchProjectsResponse]]:
    ...
    @property
    def create_project(self) -> Callable[[projects.CreateProjectRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_project(self) -> Callable[[projects.UpdateProjectRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def move_project(self) -> Callable[[projects.MoveProjectRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_project(self) -> Callable[[projects.DeleteProjectRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def undelete_project(self) -> Callable[[projects.UndeleteProjectRequest], Awaitable[operations_pb2.Operation]]:

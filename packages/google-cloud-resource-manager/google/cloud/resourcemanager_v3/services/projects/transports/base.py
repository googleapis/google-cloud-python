    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.search_projects: gapic_v1.method.wrap_method(
                self.search_projects, default_timeout=60.0, client_info=client_info,
            ),
            self.create_project: gapic_v1.method.wrap_method(
                self.create_project, default_timeout=60.0, client_info=client_info,
            ),
            self.update_project: gapic_v1.method.wrap_method(
                self.update_project, default_timeout=60.0, client_info=client_info,
            ),
            self.move_project: gapic_v1.method.wrap_method(
                self.move_project, default_timeout=60.0, client_info=client_info,
            ),
            self.delete_project: gapic_v1.method.wrap_method(
                self.delete_project, default_timeout=60.0, client_info=client_info,
            ),
            self.undelete_project: gapic_v1.method.wrap_method(
                self.undelete_project, default_timeout=60.0, client_info=client_info,
            ),

    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_tag_key: gapic_v1.method.wrap_method(
                self.create_tag_key, default_timeout=60.0, client_info=client_info,
            ),
            self.update_tag_key: gapic_v1.method.wrap_method(
                self.update_tag_key, default_timeout=60.0, client_info=client_info,
            ),
            self.delete_tag_key: gapic_v1.method.wrap_method(
                self.delete_tag_key, default_timeout=60.0, client_info=client_info,
            ),

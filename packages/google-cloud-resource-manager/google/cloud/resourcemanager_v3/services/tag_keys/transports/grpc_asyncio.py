...
class TagKeysGrpcAsyncIOTransport(TagKeysTransport):
    ...
    @property
    def list_tag_keys(self) -> Callable[[tag_keys.ListTagKeysRequest], Awaitable[tag_keys.ListTagKeysResponse]]:
    ...
    @property
    def get_tag_key(self) -> Callable[[tag_keys.GetTagKeyRequest], Awaitable[tag_keys.TagKey]]:
    ...
    @property
    def get_namespaced_tag_key(self) -> Callable[[tag_keys.GetNamespacedTagKeyRequest], Awaitable[tag_keys.TagKey]]:
    ...
    @property
    def create_tag_key(self) -> Callable[[tag_keys.CreateTagKeyRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_tag_key(self) -> Callable[[tag_keys.UpdateTagKeyRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_tag_key(self) -> Callable[[tag_keys.DeleteTagKeyRequest], Awaitable[operations_pb2.Operation]]:

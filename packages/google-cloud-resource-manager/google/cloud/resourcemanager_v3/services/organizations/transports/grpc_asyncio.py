...
class OrganizationsGrpcAsyncIOTransport(OrganizationsTransport):
    ...
    @property
    def get_organization(self) -> Callable[[organizations.GetOrganizationRequest], Awaitable[organizations.Organization]]:
    ...
    @property
    def search_organizations(self) -> Callable[[organizations.SearchOrganizationsRequest], Awaitable[organizations.SearchOrganizationsResponse]]:

        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_folder():
                ...
                # Make the request
                operation = await client.create_folder(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_folder():
                ...
                # Make the request
                operation = await client.update_folder(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_folder():
                ...
                # Make the request
                operation = await client.delete_folder(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_undelete_folder():
                ...
                # Make the request
                operation = await client.undelete_folder(request=request)

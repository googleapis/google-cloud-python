...
class TagValuesGrpcAsyncIOTransport(TagValuesTransport):
    ...
    @property
    def list_tag_values(self) -> Callable[[tag_values.ListTagValuesRequest], Awaitable[tag_values.ListTagValuesResponse]]:
    ...
    @property
    def get_tag_value(self) -> Callable[[tag_values.GetTagValueRequest], Awaitable[tag_values.TagValue]]:
    ...
    @property
    def get_namespaced_tag_value(self) -> Callable[[tag_values.GetNamespacedTagValueRequest], Awaitable[tag_values.TagValue]]:
    ...
    @property
    def create_tag_value(self) -> Callable[[tag_values.CreateTagValueRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_tag_value(self) -> Callable[[tag_values.UpdateTagValueRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_tag_value(self) -> Callable[[tag_values.DeleteTagValueRequest], Awaitable[operations_pb2.Operation]]:

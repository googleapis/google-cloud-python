...
class DocumentUnderstandingServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = (
        DocumentUnderstandingServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    _DEFAULT_UNIVERSE = DocumentUnderstandingServiceClient._DEFAULT_UNIVERSE
    ...
    get_transport_class = DocumentUnderstandingServiceClient.get_transport_class
        ...
        *,
        ...
        Returns:
            google.cloud.documentai_v1beta2.types.Document:
                ...
                document resource in Document AI. It is
                an interchange format that provides
                insights into documents and allows for
                collaboration between users and Document
    ...
    async def __aenter__(self) -> "DocumentUnderstandingServiceAsyncClient":
        return self

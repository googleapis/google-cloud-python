...
class DocumentUnderstandingServiceClient(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DocumentUnderstandingServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                DocumentUnderstandingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = DocumentUnderstandingServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or DocumentUnderstandingServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        ) = DocumentUnderstandingServiceClient._read_environment_variables()
        self._client_cert_source = (
            DocumentUnderstandingServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = DocumentUnderstandingServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, DocumentUnderstandingServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(DocumentUnderstandingServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or DocumentUnderstandingServiceClient._get_api_endpoint(

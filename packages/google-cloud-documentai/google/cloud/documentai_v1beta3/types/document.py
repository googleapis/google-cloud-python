    ...
    class ChunkedDocument(proto.Message):
        ...
        class Chunk(proto.Message):
            ...
            class ChunkField(proto.Message):
                ...
                image_chunk_field: "Document.ChunkedDocument.Chunk.ImageChunkField" = proto.Field(
                    proto.MESSAGE,
                    number=1,
                    oneof="field_type",
                    message="Document.ChunkedDocument.Chunk.ImageChunkField",
                )
                table_chunk_field: "Document.ChunkedDocument.Chunk.TableChunkField" = proto.Field(
                    proto.MESSAGE,
                    number=2,
                    oneof="field_type",
            ...
            chunk_fields: MutableSequence["Document.ChunkedDocument.Chunk.ChunkField"] = proto.RepeatedField(
                proto.MESSAGE,
                number=7,
...
class RevisionRef(proto.Message):
    r"""The revision reference specifies which revision on the
    document to read.
    ...
    Attributes:
        ...
        latest_processor_version (str):
            Reads the revision generated by the processor version. The
            format takes the full resource name of processor version.
            ``projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processorVersion}``

            This field is a member of `oneof`_ ``source``.
    """

    class RevisionCase(proto.Enum):
        r"""Some predefined revision cases.
    ...
    revision_case: RevisionCase = proto.Field(
        proto.ENUM,
        number=1,
        oneof="source",
        enum=RevisionCase,
    ...
    latest_processor_version: str = proto.Field(
        proto.STRING,
        number=3,
        oneof="source",
    )

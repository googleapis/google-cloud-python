...
from .services.document_processor_service import DocumentProcessorServiceAsyncClient, DocumentProcessorServiceClient
...
from .types.document_io import BatchDocumentsInputConfig, DocumentOutputConfig, GcsDocument, GcsDocuments, GcsPrefix, OcrConfig, RawDocument
...
from .types.document_schema import DocumentSchema, EntityTypeMetadata, FieldExtractionMetadata, PropertyMetadata, SummaryOptions
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.documentai_v1beta3")  # type: ignore
    api_core.check_dependency_versions("google.cloud.documentai_v1beta3")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.documentai_v1beta3"

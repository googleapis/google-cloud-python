...
class DocumentProcessorServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_import_processor_version(
        self, request: document_processor_service.ImportProcessorVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[document_processor_service.ImportProcessorVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class DocumentProcessorServiceRestTransport(_BaseDocumentProcessorServiceRestTransport):
    ...
    @property
    def import_processor_version(self) -> Callable[[document_processor_service.ImportProcessorVersionRequest], operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

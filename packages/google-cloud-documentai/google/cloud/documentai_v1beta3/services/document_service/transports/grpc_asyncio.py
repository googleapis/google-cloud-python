...
class DocumentServiceGrpcAsyncIOTransport(DocumentServiceTransport):
    ...
    @property
    def update_dataset(self) -> Callable[[document_service.UpdateDatasetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_documents(self) -> Callable[[document_service.ImportDocumentsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_document(self) -> Callable[[document_service.GetDocumentRequest], Awaitable[document_service.GetDocumentResponse]]:
    ...
    @property
    def batch_delete_documents(self) -> Callable[[document_service.BatchDeleteDocumentsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_dataset_schema(self) -> Callable[[document_service.GetDatasetSchemaRequest], Awaitable[dataset.DatasetSchema]]:
    ...
    @property
    def update_dataset_schema(self) -> Callable[[document_service.UpdateDatasetSchemaRequest], Awaitable[dataset.DatasetSchema]]:

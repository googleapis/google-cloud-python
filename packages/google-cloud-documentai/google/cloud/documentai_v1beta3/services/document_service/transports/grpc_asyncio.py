...
class DocumentServiceGrpcAsyncIOTransport(DocumentServiceTransport):
    ...
    def update_dataset(
        ...
        [document_service.UpdateDatasetRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def get_dataset_schema(
        ...
        [document_service.GetDatasetSchemaRequest], Awaitable[dataset.DatasetSchema]
    ]:
    ...
    def update_dataset_schema(
        ...
        [document_service.UpdateDatasetSchemaRequest], Awaitable[dataset.DatasetSchema]
    ]:

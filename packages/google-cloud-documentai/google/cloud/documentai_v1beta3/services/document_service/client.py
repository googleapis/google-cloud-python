...
class DocumentServiceClient(metaclass=DocumentServiceClientMeta):
    ...
    def dataset_path(
        ...
        return "projects/{project}/locations/{location}/processors/{processor}/dataset".format(
            project=project,
            location=location,
            processor=processor,
        )
    ...
    def parse_dataset_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/processors/(?P<processor>.+?)/dataset$",
            path,
        )
    ...
    def dataset_schema_path(
        ...
        return "projects/{project}/locations/{location}/processors/{processor}/dataset/datasetSchema".format(
            project=project,
            location=location,
            processor=processor,
        )
    ...
    @staticmethod
    def parse_dataset_schema_path(path: str) -> Dict[str, str]:
        """Parses a dataset_schema path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/processors/(?P<processor>.+?)/dataset/datasetSchema$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def schema_path(
        ...
        return "projects/{project}/locations/{location}/schemas/{schema}".format(
            project=project,
            location=location,
            schema=schema,
        )
    ...
    def parse_schema_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemas/(?P<schema>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def update_dataset(
        ...
        *,
        ...
        # in a document_service.UpdateDatasetRequest.
    ...
    def import_documents(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.documentai_v1beta3.types.ImportDocumentsRequest, dict]):
                The request object.
            dataset (str):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_service.ImportDocumentsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_document(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.documentai_v1beta3.types.GetDocumentRequest, dict]):
                The request object.
            dataset (str):
    ...
    def list_documents(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.documentai_v1beta3.types.ListDocumentsRequest, dict]):
                The request object.
            dataset (str):
                Required. The resource name of the
    ...
    def batch_delete_documents(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.documentai_v1beta3.types.BatchDeleteDocumentsRequest, dict]):
                The request object.
            dataset (str):
                Required. The dataset resource name.
                Format:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_service.BatchDeleteDocumentsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_delete_documents]
    ...
    def get_dataset_schema(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.documentai_v1beta3.types.GetDatasetSchemaRequest, dict]):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_service.GetDatasetSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_dataset_schema]
    ...
    def update_dataset_schema(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.documentai_v1beta3.types.UpdateDatasetSchemaRequest, dict]):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a document_service.UpdateDatasetSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_dataset_schema]

...
def test__get_client_cert_source():
    ...
    assert (
        DocumentUnderstandingServiceClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DocumentUnderstandingServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DocumentUnderstandingServiceClient),
)
@mock.patch.object(
    DocumentUnderstandingServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(DocumentUnderstandingServiceAsyncClient),
)
def test__get_api_endpoint():
    ...
    assert (
        ...
        == DocumentUnderstandingServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DocumentUnderstandingServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        DocumentUnderstandingServiceClient._get_universe_domain(
    ...
    assert (
        DocumentUnderstandingServiceClient._get_universe_domain(None, None)
        == DocumentUnderstandingServiceClient._DEFAULT_UNIVERSE
    )

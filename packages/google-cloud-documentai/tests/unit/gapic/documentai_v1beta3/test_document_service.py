    ...
    with mock.patch.object(type(client.transport.update_dataset), "__call__") as call:
        ...
        client.update_dataset(
            dataset=gcd_dataset.Dataset(
                gcs_managed_config=gcd_dataset.Dataset.GCSManagedConfig(gcs_prefix=document_io.GcsPrefix(gcs_uri_prefix="gcs_uri_prefix_value"))
            ),
...
def test_batch_delete_documents_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.batch_delete_documents), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.batch_delete_documents(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_batch_delete_documents_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DocumentServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.batch_delete_documents in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_delete_documents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_delete_documents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DocumentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_delete_documents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_delete_documents] = mock_rpc
...
def test_get_dataset_schema_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get_dataset_schema), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.get_dataset_schema(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_dataset_schema_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DocumentServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_dataset_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_dataset_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_dataset_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DocumentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_dataset_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_dataset_schema] = mock_rpc
...
def test_update_dataset_schema_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DocumentServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_dataset_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_dataset_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_dataset_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DocumentServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_dataset_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_dataset_schema] = mock_rpc
...
def test_import_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta3/{dataset=projects/*/locations/*/processors/*/dataset}:importDocuments" % client.transport._host, args[1]
        )
...
def test_get_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{dataset=projects/*/locations/*/processors/*/dataset}:getDocument" % client.transport._host, args[1]
        )
...
def test_list_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{dataset=projects/*/locations/*/processors/*/dataset}:listDocuments" % client.transport._host, args[1]
        )
...
def test_batch_delete_documents_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DocumentServiceClient(
...
def test_batch_delete_documents_rest_required_fields(request_type=document_service.BatchDeleteDocumentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_delete_documents._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_delete_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{dataset=projects/*/locations/*/processors/*/dataset}:batchDeleteDocuments" % client.transport._host, args[1]
        )
...
def test_get_dataset_schema_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DocumentServiceClient(
...
def test_update_dataset_schema_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DocumentServiceClient(
...
def test_update_dataset_schema_rest_required_fields(request_type=document_service.UpdateDatasetSchemaRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_dataset_schema._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_dataset_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{dataset_schema.name=projects/*/locations/*/processors/*/dataset/datasetSchema}" % client.transport._host, args[1]
        )
...
def test_update_dataset_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.update_dataset), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = document_service.UpdateDatasetRequest()
...
def test_import_documents_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.import_documents), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = document_service.ImportDocumentsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_documents_empty_call_grpc():
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_delete_documents), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_delete_documents(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = document_service.BatchDeleteDocumentsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_dataset_schema_empty_call_grpc():
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_dataset_schema), "__call__") as call:
        call.return_value = dataset.DatasetSchema()
        client.get_dataset_schema(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = document_service.GetDatasetSchemaRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_dataset_schema_empty_call_grpc():
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_dataset_schema), "__call__") as call:
        call.return_value = dataset.DatasetSchema()
        client.update_dataset_schema(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = document_service.UpdateDatasetSchemaRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_documents_empty_call_grpc_asyncio():
    client = DocumentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_delete_documents), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.batch_delete_documents(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_dataset_schema_empty_call_grpc_asyncio():
    client = DocumentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_dataset_schema_empty_call_grpc_asyncio():
    client = DocumentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_update_dataset_rest_bad_request(request_type=document_service.UpdateDatasetRequest):
...
def test_update_dataset_rest_call_success(request_type):
    ...
    request_init = {"dataset": {"name": "projects/sample1/locations/sample2/processors/sample3/dataset"}}
    request_init["dataset"] = {
        "gcs_managed_config": {"gcs_prefix": {"gcs_uri_prefix": "gcs_uri_prefix_value"}},
        "document_warehouse_config": {"collection": "collection_value", "schema": "schema_value"},
...
def test_update_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DocumentServiceRestInterceptor, "post_update_dataset_with_metadata"
...
def test_import_documents_rest_bad_request(request_type=document_service.ImportDocumentsRequest):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = document_service.GetDocumentResponse.to_json(document_service.GetDocumentResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = document_service.GetDocumentResponse(), metadata
...
def test_batch_delete_documents_rest_bad_request(request_type=document_service.BatchDeleteDocumentsRequest):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"dataset": "projects/sample1/locations/sample2/processors/sample3/dataset"}
    request = request_type(**request_init)
...
def test_batch_delete_documents_rest_call_success(request_type):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_delete_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DocumentServiceRestInterceptor, "post_batch_delete_documents_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_dataset_schema_rest_bad_request(request_type=document_service.GetDatasetSchemaRequest):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_dataset_schema_rest_call_success(request_type):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_dataset_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentServiceRestInterceptor, "post_get_dataset_schema") as post, mock.patch.object(
        transports.DocumentServiceRestInterceptor, "post_get_dataset_schema_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset.DatasetSchema.to_json(dataset.DatasetSchema())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset.DatasetSchema(), metadata
...
def test_update_dataset_schema_rest_bad_request(request_type=document_service.UpdateDatasetSchemaRequest):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_dataset_schema_rest_call_success(request_type):
    client = DocumentServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
                    ...
                    "properties": [
                        {
                            ...
                            "occurrence_type": 1,
                            "method": 1,
                            "property_metadata": {"inactive": True, "field_extraction_metadata": {"summary_options": {"length": 1, "format_": 1}}},
                        }
                    ],
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["dataset_schema"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_update_dataset_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DocumentServiceRestInterceptor, "post_update_dataset_schema") as post, mock.patch.object(
        transports.DocumentServiceRestInterceptor, "post_update_dataset_schema_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_documents_empty_call_rest():
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_dataset_schema_empty_call_rest():
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_dataset_schema_empty_call_rest():
    client = DocumentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_dataset_path():
    ...
    location = "clam"
    processor = "whelk"
    expected = "projects/{project}/locations/{location}/processors/{processor}/dataset".format(
        project=project,
        location=location,
        processor=processor,
    )
...
async def test_get_location_field_headers_async():
    client = DocumentServiceAsyncClient(credentials=async_anonymous_credentials())

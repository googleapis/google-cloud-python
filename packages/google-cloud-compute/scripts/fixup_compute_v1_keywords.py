...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('instance_group_manager', 'project', 'region', 'request_id', ),
    ...
    'get': ('instance_group_manager', 'project', 'region', ),
    ...
    'insert': ('instance_group_manager_resource', 'project', 'region', 'request_id', ),
    ...
    'patch': ('instance_group_manager', 'instance_group_manager_resource', 'project', 'region', 'request_id', ),
    ...
    'update': ('backend_service', 'backend_service_resource', 'project', 'request_id', ),

...
class computeCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'add_network_interface': ('instance', 'network_interface_resource', 'project', 'zone', 'request_id', ),
        ...
        'bulk_set_labels': ('bulk_zone_set_labels_request_resource', 'project', 'zone', 'request_id', 'resource', ),
        ...
        'copy_rules': ('security_policy', 'request_id', 'source_security_policy', ),
        ...
        'create_members': ('interconnect_group', 'interconnect_groups_create_members_request_resource', 'project', ),
        ...
        'delete_network_interface': ('instance', 'network_interface_name', 'project', 'zone', 'request_id', ),
        ...
        'get_effective_security_policies': ('backend_service', 'project', ),
        ...
        'get_operational_status': ('interconnect_attachment_group', 'project', ),
        ...
        'list_preconfigured_expression_sets': ('filter', 'max_results', 'order_by', 'page_token', 'parent_id', 'return_partial_success', ),
        ...
        'report_faulty': ('parent_name', 'project', 'reservation_sub_block', 'reservation_sub_blocks_report_faulty_request_resource', 'zone', 'request_id', ),

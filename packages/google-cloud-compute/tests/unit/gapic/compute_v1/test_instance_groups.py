...
def test_add_instances_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAddInstances,
        "_BaseAddInstances__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_remove_instances_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveInstances,
        "_BaseRemoveInstances__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_set_named_ports_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetNamedPorts,
        "_BaseSetNamedPorts__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
from google.cloud.compute_v1.services.instance_groups import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        InstanceGroupsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        InstanceGroupsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        InstanceGroupsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        InstanceGroupsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        InstanceGroupsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
    assert (
        InstanceGroupsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        InstanceGroupsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        InstanceGroupsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                InstanceGroupsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                InstanceGroupsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(InstanceGroupsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = InstanceGroupsClient._DEFAULT_UNIVERSE
    default_endpoint = InstanceGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = InstanceGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        InstanceGroupsClient._get_api_endpoint(
    ...
    assert (
        InstanceGroupsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        InstanceGroupsClient._get_api_endpoint(None, None, default_universe, "always")
        == InstanceGroupsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        InstanceGroupsClient._get_api_endpoint(
    ...
    assert (
        InstanceGroupsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        InstanceGroupsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        InstanceGroupsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        InstanceGroupsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        InstanceGroupsClient._get_universe_domain(None, None)
        == InstanceGroupsClient._DEFAULT_UNIVERSE
    )
...
def test_instance_groups_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_instance_groups_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_instance_groups_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    InstanceGroupsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(InstanceGroupsClient),
)
...
def test_instance_groups_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_list_instances_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        sample_request["instance_groups_list_instances_request_resource"] = (
...
def test_remove_instances_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.remove_instances] = (
            mock_rpc
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsInstanceGroupRequest,
):
    transport_class = transports.InstanceGroupsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instanceGroups/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_add_instances_rest_call_success(request_type):
    ...
    test_field = compute.AddInstancesInstanceGroupRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["instance_groups_add_instances_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["instance_groups_add_instances_request_resource"][
...
def test_add_instances_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        pb_message = compute.AddInstancesInstanceGroupRequest.pb(
            compute.AddInstancesInstanceGroupRequest()
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.InstanceGroupsRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListInstanceGroupsRequest.pb(
            compute.AggregatedListInstanceGroupsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InstanceGroupAggregatedList.to_json(
            compute.InstanceGroupAggregatedList()
        )
        req.return_value.content = return_value
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteInstanceGroupRequest.pb(
            compute.DeleteInstanceGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.InstanceGroupsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetInstanceGroupRequest.pb(
            compute.GetInstanceGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertInstanceGroupRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertInstanceGroupRequest.pb(
            compute.InsertInstanceGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListInstanceGroupsRequest.pb(
            compute.ListInstanceGroupsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_instances_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.ListInstancesInstanceGroupsRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["instance_groups_list_instances_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["instance_groups_list_instances_request_resource"][
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListInstancesInstanceGroupsRequest.pb(
            compute.ListInstancesInstanceGroupsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InstanceGroupsListInstances.to_json(
            compute.InstanceGroupsListInstances()
        )
        req.return_value.content = return_value
...
def test_remove_instances_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.RemoveInstancesInstanceGroupRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                ...
                del request_init["instance_groups_remove_instances_request_resource"][
                    field
                ][subfield]
    request = request_type(**request_init)
...
def test_remove_instances_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveInstancesInstanceGroupRequest.pb(
            compute.RemoveInstancesInstanceGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_named_ports_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetNamedPortsInstanceGroupRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                ...
                del request_init["instance_groups_set_named_ports_request_resource"][
                    field
                ][subfield]
    request = request_type(**request_init)
...
def test_set_named_ports_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetNamedPortsInstanceGroupRequest.pb(
            compute.SetNamedPortsInstanceGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsInstanceGroupRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.InstanceGroupsRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.InstanceGroupsRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsInstanceGroupRequest.pb(
            compute.TestIamPermissionsInstanceGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_instance_groups_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.instance_groups.transports.InstanceGroupsTransport.__init__"
    ) as Transport:

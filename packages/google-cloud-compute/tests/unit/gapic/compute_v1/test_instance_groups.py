...
def test_add_instances_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.add_instances(
            ...
            instance_groups_add_instances_request_resource=instance_groups_add_instances_request_resource,
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.insert(
            project="project_value",
            zone="zone_value",
            instance_group_resource=instance_group_resource,
        )
...
def test_list_instances_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.InstanceGroupsListInstances(
            id="id_value",
            items=[compute.InstanceWithNamedPorts(instance="instance_value")],
            kind="kind_value",
            next_page_token="next_page_token_value",
            self_link="self_link_value",
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
...
def test_list_instances_rest_from_dict():
    test_list_instances_rest(request_type=dict)
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.list_instances(
            ...
            zone="zone_value",
            instance_group="instance_group_value",
            instance_groups_list_instances_request_resource=instance_groups_list_instances_request_resource,
        )
...
def test_remove_instances_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.remove_instances(
            ...
            zone="zone_value",
            instance_group="instance_group_value",
            instance_groups_remove_instances_request_resource=instance_groups_remove_instances_request_resource,
        )
...
def test_set_named_ports_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.set_named_ports(
            ...
            zone="zone_value",
            instance_group="instance_group_value",
            instance_groups_set_named_ports_request_resource=instance_groups_set_named_ports_request_resource,
        )

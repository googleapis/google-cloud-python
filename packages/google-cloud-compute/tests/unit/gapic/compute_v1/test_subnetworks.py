...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SubnetworksClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SubnetworksClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SubnetworksClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SubnetworksClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SubnetworksClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert SubnetworksClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SubnetworksClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert SubnetworksClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SubnetworksClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(SubnetworksClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SubnetworksClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SubnetworksClient._DEFAULT_UNIVERSE
    default_endpoint = SubnetworksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SubnetworksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SubnetworksClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SubnetworksClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SubnetworksClient.DEFAULT_MTLS_ENDPOINT
    assert SubnetworksClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SubnetworksClient._get_api_endpoint(None, None, default_universe, "always") == SubnetworksClient.DEFAULT_MTLS_ENDPOINT
    assert SubnetworksClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SubnetworksClient.DEFAULT_MTLS_ENDPOINT
    assert SubnetworksClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SubnetworksClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SubnetworksClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SubnetworksClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SubnetworksClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SubnetworksClient._get_universe_domain(None, None) == SubnetworksClient._DEFAULT_UNIVERSE
...
def test_expand_ip_cidr_range_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.expand_ip_cidr_range in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.expand_ip_cidr_range] = mock_rpc
...
def test_expand_ip_cidr_range_rest_required_fields(request_type=compute.ExpandIpCidrRangeSubnetworkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).expand_ip_cidr_range._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_expand_ip_cidr_range_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            subnetwork="subnetwork_value",
            subnetworks_expand_ip_cidr_range_request_resource=compute.SubnetworksExpandIpCidrRangeRequest(ip_cidr_range="ip_cidr_range_value"),
        )
        mock_args.update(sample_request)
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/subnetworks/{subnetwork}/expandIpCidrRange" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/subnetworks/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            region="region_value",
            subnetwork_resource=compute.Subnetwork(creation_timestamp="creation_timestamp_value"),
        )
        mock_args.update(sample_request)
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/subnetworks/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_private_ip_google_access_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_private_ip_google_access in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_private_ip_google_access] = mock_rpc
...
def test_set_private_ip_google_access_rest_required_fields(request_type=compute.SetPrivateIpGoogleAccessSubnetworkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_private_ip_google_access._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_private_ip_google_access_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/subnetworks/{subnetwork}/setPrivateIpGoogleAccess" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/subnetworks/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = SubnetworksClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListSubnetworksRequest):
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.SubnetworksRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SubnetworksRestInterceptor(),
    )
    client = SubnetworksClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SubnetworkAggregatedList.to_json(compute.SubnetworkAggregatedList())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_expand_ip_cidr_range_rest_bad_request(request_type=compute.ExpandIpCidrRangeSubnetworkRequest):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "subnetwork": "sample3"}
    request = request_type(**request_init)
...
def test_expand_ip_cidr_range_rest_call_success(request_type):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    for field, value in request_init["subnetworks_expand_ip_cidr_range_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_expand_ip_cidr_range_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_expand_ip_cidr_range") as post, mock.patch.object(
...
def test_get_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        return_value = compute.Subnetwork(
            ...
            state="state_value",
            system_reserved_external_ipv6_ranges=["system_reserved_external_ipv6_ranges_value"],
    ...
    assert response.system_reserved_external_ipv6_ranges == ["system_reserved_external_ipv6_ranges_value"]
    assert response.system_reserved_internal_ipv6_ranges == ["system_reserved_internal_ipv6_ranges_value"]
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_get") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.Subnetwork.to_json(compute.Subnetwork())
        req.return_value.content = return_value
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicySubnetworkRequest):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["subnetwork_resource"] = {
        ...
        "role": "role_value",
        "secondary_ip_ranges": [
            {"ip_cidr_range": "ip_cidr_range_value", "range_name": "range_name_value", "reserved_internal_range": "reserved_internal_range_value"}
        ],
        "self_link": "self_link_value",
        "stack_type": "stack_type_value",
        "state": "state_value",
        "system_reserved_external_ipv6_ranges": ["system_reserved_external_ipv6_ranges_value1", "system_reserved_external_ipv6_ranges_value2"],
        "system_reserved_internal_ipv6_ranges": ["system_reserved_internal_ipv6_ranges_value1", "system_reserved_internal_ipv6_ranges_value2"],
        "utilization_details": {
            "external_ipv6_instance_utilization": {"total_allocated_ip": {"high": 416, "low": 338}, "total_free_ip": {}},
            "external_ipv6_lb_utilization": {},
            "internal_ipv6_utilization": {},
            "ipv4_utilizations": [{"range_name": "range_name_value", "total_allocated_ip": 1892, "total_free_ip": 1373}],
        },
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_list") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SubnetworkList.to_json(compute.SubnetworkList())
        req.return_value.content = return_value
...
def test_list_usable_rest_bad_request(request_type=compute.ListUsableSubnetworksRequest):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_list_usable") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.UsableSubnetworksAggregatedList.to_json(compute.UsableSubnetworksAggregatedList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.UsableSubnetworksAggregatedList(), metadata
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicySubnetworkRequest):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "resource": "sample3"}
    request = request_type(**request_init)
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
...
def test_set_private_ip_google_access_rest_bad_request(request_type=compute.SetPrivateIpGoogleAccessSubnetworkRequest):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "subnetwork": "sample3"}
    request = request_type(**request_init)
...
def test_set_private_ip_google_access_rest_call_success(request_type):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["subnetworks_set_private_ip_google_access_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_private_ip_google_access_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_set_private_ip_google_access") as post, mock.patch.object(
        transports.SubnetworksRestInterceptor, "post_set_private_ip_google_access_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsSubnetworkRequest):
    client = SubnetworksClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "resource": "sample3"}
    request = request_type(**request_init)
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SubnetworksRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_expand_ip_cidr_range_unary_empty_call_rest():
    client = SubnetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.expand_ip_cidr_range), "__call__") as call:
        client.expand_ip_cidr_range_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_private_ip_google_access_unary_empty_call_rest():
    client = SubnetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.set_private_ip_google_access), "__call__") as call:
        client.set_private_ip_google_access_unary(request=None)

...
from google.cloud.compute_v1.services.snapshots import (
    SnapshotsClient,
    pagers,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SnapshotsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        SnapshotsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SnapshotsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SnapshotsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                SnapshotsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SnapshotsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SnapshotsClient._DEFAULT_UNIVERSE
    default_endpoint = SnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SnapshotsClient._get_api_endpoint(
    ...
    assert (
        ...
        == SnapshotsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SnapshotsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SnapshotsClient._get_api_endpoint(None, None, default_universe, "always")
        == SnapshotsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SnapshotsClient._get_api_endpoint(
    ...
    assert (
        SnapshotsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SnapshotsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SnapshotsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SnapshotsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SnapshotsClient._get_universe_domain(None, None)
        == SnapshotsClient._DEFAULT_UNIVERSE
    )
...
def test_snapshots_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_set_labels_unary_rest_required_fields(
    request_type=compute.SetLabelsSnapshotRequest,
):
    transport_class = transports.SnapshotsRestTransport
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsSnapshotRequest,
):
    transport_class = transports.SnapshotsRestTransport
...
def test_update_kms_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            snapshot="snapshot_value",
            snapshot_update_kms_key_request_resource=compute.SnapshotUpdateKmsKeyRequest(
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/snapshots/{snapshot}/updateKmsKey"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.SnapshotsRestInterceptor, "post_delete") as post,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SnapshotsRestInterceptor, "pre_delete") as pre,
    ):
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SnapshotsRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SnapshotsRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicySnapshotRequest.pb(
            compute.GetIamPolicySnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SnapshotsRestInterceptor, "post_insert") as post,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SnapshotsRestInterceptor, "pre_insert") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.SnapshotsRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.SnapshotsRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicySnapshotRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicySnapshotRequest.pb(
            compute.SetIamPolicySnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsSnapshotRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.SnapshotsRestInterceptor, "pre_set_labels") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsSnapshotRequest.pb(
            compute.SetLabelsSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsSnapshotRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SnapshotsRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsSnapshotRequest.pb(
            compute.TestIamPermissionsSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_kms_key_rest_bad_request(
    request_type=compute.UpdateKmsKeySnapshotRequest,
):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_update_kms_key_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "snapshot": "sample2"}
    request_init["snapshot_update_kms_key_request_resource"] = {
        "kms_key_name": "kms_key_name_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateKmsKeySnapshotRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0,
                    len(
                        request_init["snapshot_update_kms_key_request_resource"][field]
                    ),
                ):
                    del request_init["snapshot_update_kms_key_request_resource"][field][
                        i
                    ][subfield]
            else:
                del request_init["snapshot_update_kms_key_request_resource"][field][
...
def test_update_kms_key_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_update_kms_key"
        ) as post,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_update_kms_key_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "pre_update_kms_key"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateKmsKeySnapshotRequest.pb(
            compute.UpdateKmsKeySnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.UpdateKmsKeySnapshotRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]

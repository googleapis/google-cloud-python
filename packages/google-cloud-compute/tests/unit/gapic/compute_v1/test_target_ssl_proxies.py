...
def test__get_api_endpoint():
    ...
    assert (
        TargetSslProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        TargetSslProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == TargetSslProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setBackendService" % client.transport._host, args[1]
        )
...
def test_set_certificate_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setCertificateMap" % client.transport._host, args[1]
        )
...
def test_set_proxy_header_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setProxyHeader" % client.transport._host, args[1]
        )
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setSslCertificates" % client.transport._host, args[1]
        )
...
def test_set_ssl_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setSslPolicy" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = TargetSslProxiesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_set_backend_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_backend_service") as post, mock.patch.object(
        transports.TargetSslProxiesRestInterceptor, "post_set_backend_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_certificate_map") as post, mock.patch.object(
        transports.TargetSslProxiesRestInterceptor, "post_set_certificate_map_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_proxy_header_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_proxy_header") as post, mock.patch.object(
        transports.TargetSslProxiesRestInterceptor, "post_set_proxy_header_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_ssl_certificates") as post, mock.patch.object(
        transports.TargetSslProxiesRestInterceptor, "post_set_ssl_certificates_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_ssl_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_ssl_policy") as post, mock.patch.object(
        transports.TargetSslProxiesRestInterceptor, "post_set_ssl_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(

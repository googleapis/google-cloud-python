...
from google.cloud.compute_v1.services.health_checks import (
    HealthChecksClient,
    pagers,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        HealthChecksClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListHealthChecksRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/healthChecks"
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsHealthCheckRequest,
):
    transport_class = transports.HealthChecksRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/healthChecks/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_unary_rest_required_fields(
    request_type=compute.UpdateHealthCheckRequest,
):
    transport_class = transports.HealthChecksRestTransport
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.HealthChecksRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
        ...
        pb_message = compute.AggregatedListHealthChecksRequest.pb(
            compute.AggregatedListHealthChecksRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.HealthChecksAggregatedList.to_json(
            compute.HealthChecksAggregatedList()
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteHealthCheckRequest.pb(
            compute.DeleteHealthCheckRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertHealthCheckRequest.pb(
            compute.InsertHealthCheckRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListHealthChecksRequest.pb(
            compute.ListHealthChecksRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchHealthCheckRequest.pb(
            compute.PatchHealthCheckRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsHealthCheckRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.HealthChecksRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.HealthChecksRestInterceptor,
            "post_test_iam_permissions_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.HealthChecksRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsHealthCheckRequest.pb(
            compute.TestIamPermissionsHealthCheckRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateHealthCheckRequest.pb(
            compute.UpdateHealthCheckRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsHealthCheckRequest()

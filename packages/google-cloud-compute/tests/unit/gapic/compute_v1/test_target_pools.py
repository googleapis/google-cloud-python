...
def test_add_health_check_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAddHealthCheck,
        "_BaseAddHealthCheck__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_add_instance_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAddInstance,
        "_BaseAddInstance__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_remove_health_check_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveHealthCheck,
        "_BaseRemoveHealthCheck__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_remove_instance_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveInstance,
        "_BaseRemoveInstance__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_set_backup_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetBackup,
        "_BaseSetBackup__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

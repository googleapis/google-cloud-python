...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TargetPoolsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TargetPoolsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TargetPoolsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                TargetPoolsClient._use_client_cert_effective()
...
def test_add_health_check_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.add_health_check] = (
            mock_rpc
        )
...
def test_remove_health_check_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.remove_health_check] = (
            mock_rpc
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsTargetPoolRequest,
):
    transport_class = transports.TargetPoolsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/targetPools/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetPoolAggregatedList.to_json(
            compute.TargetPoolAggregatedList()
        )
        req.return_value.content = return_value
...
def test_get_health_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetPoolInstanceHealth.to_json(
...
def test_remove_health_check_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TargetPoolsRestInterceptor,
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetPoolRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TargetPoolsRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.TargetPoolsRestInterceptor,
        ...
        mock.patch.object(
            transports.TargetPoolsRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetPoolRequest.pb(
            compute.TestIamPermissionsTargetPoolRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_add_health_check_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.add_health_check), "__call__") as call:
...
def test_add_instance_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.add_instance), "__call__") as call:
...
def test_remove_health_check_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.remove_health_check), "__call__"
    ) as call:
...
def test_remove_instance_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.remove_instance), "__call__") as call:
...
def test_set_backup_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.set_backup), "__call__") as call:

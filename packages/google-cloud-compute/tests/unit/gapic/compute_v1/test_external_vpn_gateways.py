...
def test__get_client_cert_source():
    ...
    assert (
        ExternalVpnGatewaysClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ExternalVpnGatewaysClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ExternalVpnGatewaysClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ExternalVpnGatewaysClient._DEFAULT_UNIVERSE
    default_endpoint = ExternalVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ExternalVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        ExternalVpnGatewaysClient._get_api_endpoint(
    ...
    assert (
        ExternalVpnGatewaysClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ExternalVpnGatewaysClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ExternalVpnGatewaysClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ExternalVpnGatewaysClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ExternalVpnGatewaysClient._get_universe_domain(None, None)
        == ExternalVpnGatewaysClient._DEFAULT_UNIVERSE
    )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pb_message = compute.DeleteExternalVpnGatewayRequest.pb(
            compute.DeleteExternalVpnGatewayRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetExternalVpnGatewayRequest.pb(
            compute.GetExternalVpnGatewayRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertExternalVpnGatewayRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["external_vpn_gateway_resource"][field])
                ):
                    del request_init["external_vpn_gateway_resource"][field][i][
                        subfield
                    ]
            else:
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertExternalVpnGatewayRequest.pb(
            compute.InsertExternalVpnGatewayRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListExternalVpnGatewaysRequest.pb(
            compute.ListExternalVpnGatewaysRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ExternalVpnGatewayList.to_json(
            compute.ExternalVpnGatewayList()
        )
        req.return_value.content = return_value
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsExternalVpnGatewayRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsExternalVpnGatewayRequest.pb(
            compute.SetLabelsExternalVpnGatewayRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsExternalVpnGatewayRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ExternalVpnGatewaysRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsExternalVpnGatewayRequest.pb(
            compute.TestIamPermissionsExternalVpnGatewayRequest()
        )
        transcode.return_value = {
            "method": "post",

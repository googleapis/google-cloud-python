...
from google.cloud.compute_v1.services.region_backend_buckets import (
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendBuckets/{backend_bucket}"
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendBuckets/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendBuckets"
            % client.transport._host,
            args[1],
        )
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendBuckets/listUsable"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendBuckets/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendBuckets/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_region_backend_buckets_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.region_backend_buckets.transports.RegionBackendBucketsTransport.__init__"
    ) as Transport:
...
def test_region_backend_buckets_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1.services.region_backend_buckets.transports.RegionBackendBucketsTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

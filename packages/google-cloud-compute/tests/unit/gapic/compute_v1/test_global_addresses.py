...
def test__read_environment_variables():
    assert GlobalAddressesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert GlobalAddressesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert GlobalAddressesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GlobalAddressesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GlobalAddressesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GlobalAddressesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert GlobalAddressesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert GlobalAddressesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                GlobalAddressesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert GlobalAddressesClient._get_client_cert_source(None, False) is None
    assert GlobalAddressesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GlobalAddressesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert GlobalAddressesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GlobalAddressesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(GlobalAddressesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GlobalAddressesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GlobalAddressesClient._DEFAULT_UNIVERSE
    default_endpoint = GlobalAddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GlobalAddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GlobalAddressesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        GlobalAddressesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == GlobalAddressesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert GlobalAddressesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GlobalAddressesClient._get_api_endpoint(None, None, default_universe, "always") == GlobalAddressesClient.DEFAULT_MTLS_ENDPOINT
    assert (
        GlobalAddressesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == GlobalAddressesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert GlobalAddressesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GlobalAddressesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GlobalAddressesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GlobalAddressesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GlobalAddressesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GlobalAddressesClient._get_universe_domain(None, None) == GlobalAddressesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        GlobalAddressesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = GlobalAddressesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class", [GlobalAddressesClient])
@mock.patch.object(GlobalAddressesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GlobalAddressesClient))
def test_global_addresses_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (GlobalAddressesClient, transports.GlobalAddressesRestTransport, "rest", None),
    ],
)
...
def test_move_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            address="address_value",
            global_addresses_move_request_resource=compute.GlobalAddressesMoveRequest(description="description_value"),
        )
        mock_args.update(sample_request)
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsGlobalAddressRequest):
    transport_class = transports.GlobalAddressesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/addresses/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = GlobalAddressesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_delete_rest_bad_request(request_type=compute.DeleteGlobalAddressRequest):
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.GlobalAddressesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GlobalAddressesRestInterceptor(),
    )
    client = GlobalAddressesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_delete_with_metadata"
...
def test_get_rest_bad_request(request_type=compute.GetGlobalAddressRequest):
    client = GlobalAddressesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "address": "sample2"}
    request = request_type(**request_init)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_insert_rest_bad_request(request_type=compute.InsertGlobalAddressRequest):
    client = GlobalAddressesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_bad_request(request_type=compute.ListGlobalAddressesRequest):
    client = GlobalAddressesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "pre_list"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_move_rest_bad_request(request_type=compute.MoveGlobalAddressRequest):
    client = GlobalAddressesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "address": "sample2"}
    request = request_type(**request_init)
...
def test_move_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["global_addresses_move_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_move") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_move_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "pre_move"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_labels_rest_bad_request(request_type=compute.SetLabelsGlobalAddressRequest):
    client = GlobalAddressesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_set_labels") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_set_labels_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "pre_set_labels"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsGlobalAddressRequest):
    client = GlobalAddressesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "resource": "sample2"}
    request = request_type(**request_init)
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsGlobalAddressRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GlobalAddressesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsGlobalAddressRequest.pb(compute.TestIamPermissionsGlobalAddressRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        request_msg = compute.DeleteGlobalAddressRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetGlobalAddressRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertGlobalAddressRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListGlobalAddressesRequest()
...
def test_move_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.move), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.MoveGlobalAddressRequest()
...
def test_set_labels_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_labels), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetLabelsGlobalAddressRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsGlobalAddressRequest()
...
def test_global_addresses_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1.services.global_addresses.transports.GlobalAddressesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_global_addresses_client_transport_session_collision(transport_name):
    ...
    client1 = GlobalAddressesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = GlobalAddressesClient(
        credentials=creds2,
        transport=transport_name,
    )

...
from google.cloud.compute_v1.services.global_addresses import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GlobalAddressesClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        GlobalAddressesClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        GlobalAddressesClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        GlobalAddressesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        GlobalAddressesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
    assert (
        GlobalAddressesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        GlobalAddressesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        GlobalAddressesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                GlobalAddressesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                GlobalAddressesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(GlobalAddressesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GlobalAddressesClient._DEFAULT_UNIVERSE
    default_endpoint = GlobalAddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = GlobalAddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        GlobalAddressesClient._get_api_endpoint(
    ...
    assert (
        GlobalAddressesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        GlobalAddressesClient._get_api_endpoint(None, None, default_universe, "always")
        == GlobalAddressesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        GlobalAddressesClient._get_api_endpoint(
    ...
    assert (
        GlobalAddressesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        GlobalAddressesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        GlobalAddressesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        GlobalAddressesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        GlobalAddressesClient._get_universe_domain(None, None)
        == GlobalAddressesClient._DEFAULT_UNIVERSE
    )
...
def test_global_addresses_client_from_service_account_info(
    client_class, transport_name
):
...
def test_global_addresses_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_global_addresses_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_global_addresses_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_global_addresses_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    GlobalAddressesClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(GlobalAddressesClient),
)
...
def test_global_addresses_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_global_addresses_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_insert_unary_rest_required_fields(
    request_type=compute.InsertGlobalAddressRequest,
):
    transport_class = transports.GlobalAddressesRestTransport
...
def test_move_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            address="address_value",
            global_addresses_move_request_resource=compute.GlobalAddressesMoveRequest(
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/addresses/{address}/move"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_required_fields(
    request_type=compute.SetLabelsGlobalAddressRequest,
):
    transport_class = transports.GlobalAddressesRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/addresses/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsGlobalAddressRequest,
):
    transport_class = transports.GlobalAddressesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/addresses/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        pb_message = compute.DeleteGlobalAddressRequest.pb(
            compute.DeleteGlobalAddressRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.GlobalAddressesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetGlobalAddressRequest.pb(
            compute.GetGlobalAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertGlobalAddressRequest.pb(
            compute.InsertGlobalAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.GlobalAddressesRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListGlobalAddressesRequest.pb(
            compute.ListGlobalAddressesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_move_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "address": "sample2"}
    request_init["global_addresses_move_request_resource"] = {
        "description": "description_value",
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.MoveGlobalAddressRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0,
                    len(request_init["global_addresses_move_request_resource"][field]),
                ):
                    del request_init["global_addresses_move_request_resource"][field][
                        i
                    ][subfield]
            else:
                del request_init["global_addresses_move_request_resource"][field][
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor, "post_move"
        ) as post,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor, "post_move_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.GlobalAddressesRestInterceptor, "pre_move") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.MoveGlobalAddressRequest.pb(
            compute.MoveGlobalAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsGlobalAddressRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor, "post_set_labels"
        ) as post,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsGlobalAddressRequest.pb(
            compute.SetLabelsGlobalAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsGlobalAddressRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.GlobalAddressesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsGlobalAddressRequest.pb(
            compute.TestIamPermissionsGlobalAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_global_addresses_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.global_addresses.transports.GlobalAddressesTransport.__init__"
    ) as Transport:
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.GlobalAddressesTransport, "_prep_wrapped_messages"
    ) as prep:
        client = GlobalAddressesClient(
            credentials=ga_credentials.AnonymousCredentials(),

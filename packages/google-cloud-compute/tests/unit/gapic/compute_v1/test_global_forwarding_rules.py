...
from google.cloud.compute_v1.services.global_forwarding_rules import transports
...
def test_global_forwarding_rules_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class", [GlobalForwardingRulesClient,])
def test_global_forwarding_rules_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
@pytest.mark.parametrize(
    "request_type", [compute.DeleteGlobalForwardingRuleRequest, dict,]
)
...
def test_delete_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",)) & set(("forwardingRule", "project",))
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/forwardingRules/{forwarding_rule}"
...
@pytest.mark.parametrize(
    "request_type", [compute.GetGlobalForwardingRuleRequest, dict,]
)
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("forwardingRule", "project",)))
...
@pytest.mark.parametrize(
    "request_type", [compute.InsertGlobalForwardingRuleRequest, dict,]
)
...
def test_insert_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",)) & set(("forwardingRuleResource", "project",))
    )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/forwardingRules"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.ListGlobalForwardingRulesRequest, dict,]
)
...
def test_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListGlobalForwardingRulesRequest(), project="project_value",
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.PatchGlobalForwardingRuleRequest, dict,]
)
...
def test_patch_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",))
        & set(("forwardingRule", "forwardingRuleResource", "project",))
    )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetLabelsGlobalForwardingRuleRequest, dict,]
)
...
def test_set_labels_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/forwardingRules/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetTargetGlobalForwardingRuleRequest, dict,]
)
...
def test_set_target_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",))
        & set(("forwardingRule", "project", "targetReferenceResource",))
    )
...
def test_set_target_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/forwardingRules/{forwarding_rule}/setTarget"
            % client.transport._host,
            args[1],
        )
...
def test_global_forwarding_rules_host_with_port():
    client = GlobalForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

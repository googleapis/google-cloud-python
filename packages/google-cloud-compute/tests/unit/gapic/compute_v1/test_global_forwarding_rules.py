...
from google.cloud.compute_v1.services.global_forwarding_rules.transports.base import (
        ...
        return_value = compute.ForwardingRule(
            ...
            metadata_filters=[
                compute.MetadataFilter(
                    filter_labels=[compute.MetadataFilterLabelMatch(name="name_value")]
                )
            ],
            name="name_value",
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.insert(
            project="project_value", forwarding_rule_resource=forwarding_rule_resource,
        )
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.patch(
            project="project_value",
            forwarding_rule="forwarding_rule_value",
            forwarding_rule_resource=forwarding_rule_resource,
        )
...
def test_set_target_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.set_target(
            project="project_value",
            forwarding_rule="forwarding_rule_value",
            target_reference_resource=target_reference_resource,
        )
...
@requires_google_auth_lt_1_25_0
def test_global_forwarding_rules_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        GlobalForwardingRulesClient()

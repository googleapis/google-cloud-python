...
def test__get_api_endpoint():
    ...
    assert (
        AcceleratorTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        AcceleratorTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/acceleratorTypes/{accelerator_type}" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = AcceleratorTypesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.AcceleratorTypesRestInterceptor, "post_aggregated_list_with_metadata"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_list") as post, mock.patch.object(

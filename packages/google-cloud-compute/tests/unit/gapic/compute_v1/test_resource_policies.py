...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ResourcePoliciesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ResourcePoliciesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ResourcePoliciesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ResourcePoliciesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ResourcePoliciesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ResourcePoliciesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ResourcePoliciesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ResourcePoliciesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ResourcePoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ResourcePoliciesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ResourcePoliciesClient._DEFAULT_UNIVERSE
    default_endpoint = ResourcePoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ResourcePoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ResourcePoliciesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ResourcePoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ResourcePoliciesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ResourcePoliciesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ResourcePoliciesClient._get_api_endpoint(None, None, default_universe, "always") == ResourcePoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ResourcePoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ResourcePoliciesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ResourcePoliciesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ResourcePoliciesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ResourcePoliciesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ResourcePoliciesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ResourcePoliciesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ResourcePoliciesClient._get_universe_domain(None, None) == ResourcePoliciesClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize(
    ...
    [
        (ResourcePoliciesClient, transports.ResourcePoliciesRestTransport, "rest", "true"),
        (ResourcePoliciesClient, transports.ResourcePoliciesRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ResourcePoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ResourcePoliciesClient))
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource_policy}" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            region="region_value",
            resource_policy_resource=compute.ResourcePolicy(creation_timestamp="creation_timestamp_value"),
        )
        mock_args.update(sample_request)
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = ResourcePoliciesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListResourcePoliciesRequest):
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.ResourcePoliciesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ResourcePoliciesRestInterceptor(),
    )
    client = ResourcePoliciesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.ResourcePoliciesRestInterceptor, "post_aggregated_list_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.ResourcePolicyAggregatedList.to_json(compute.ResourcePolicyAggregatedList())
        ...
        post_with_metadata.return_value = compute.ResourcePolicyAggregatedList(), metadata
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyResourcePolicyRequest):
    client = ResourcePoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.ResourcePoliciesRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["resource_policy_resource"] = {
        ...
        "region": "region_value",
        "resource_status": {
            "instance_schedule_policy": {"last_run_start_time": "last_run_start_time_value", "next_run_start_time": "next_run_start_time_value"}
        },
        "self_link": "self_link_value",
        "snapshot_schedule_policy": {
            "retention_policy": {"max_retention_days": 1933, "on_source_disk_delete": "on_source_disk_delete_value"},
            "schedule": {
                "daily_schedule": {"days_in_cycle": 1366, "duration": "duration_value", "start_time": "start_time_value"},
                "hourly_schedule": {"duration": "duration_value", "hours_in_cycle": 1494, "start_time": "start_time_value"},
                "weekly_schedule": {"day_of_weeks": [{"day": "day_value", "duration": "duration_value", "start_time": "start_time_value"}]},
            },
            "snapshot_properties": {
    ...
    for field, value in request_init["resource_policy_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyResourcePolicyRequest):
    client = ResourcePoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "resource": "sample3"}
    request = request_type(**request_init)
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.ResourcePoliciesRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsResourcePolicyRequest):
    client = ResourcePoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "resource": "sample3"}
    request = request_type(**request_init)
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ResourcePoliciesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.ResourcePoliciesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(

...
def test_resource_policies_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class", [ResourcePoliciesClient,])
def test_resource_policies_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_aggregated_list_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        json_return_value = compute.ResourcePolicyAggregatedList.to_json(return_value)
...
def test_aggregated_list_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/resourcePolicies"
...
def test_aggregated_list_rest_pager():
    client = ResourcePoliciesClient(credentials=ga_credentials.AnonymousCredentials(),)
...
def test_delete_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource_policy}"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest(
    ...
    request_init["resource_policy_resource"] = compute.ResourcePolicy(
        creation_timestamp="creation_timestamp_value"
    )
    request = request_type(request_init)
...
def test_insert_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        json_return_value = compute.ResourcePolicyList.to_json(return_value)
        response_value._content = json_return_value.encode("UTF-8")
        req.return_value = response_value
...
def test_set_iam_policy_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_resource_policies_host_no_port():
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_resource_policies_host_with_port():
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

...
def test_get_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        pb_return_value = compute.InterconnectRemoteLocation.pb(return_value)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = compute.InterconnectRemoteLocation.to_json(
...
def test_get_rest_bad_request(
    transport: str = "rest", request_type=compute.GetInterconnectRemoteLocationRequest
):
    client = InterconnectRemoteLocationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/interconnectRemoteLocations/{interconnect_remote_location}"
...
def test_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.InterconnectRemoteLocationList.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InterconnectRemoteLocationList.to_json(
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListInterconnectRemoteLocationsRequest
):
    client = InterconnectRemoteLocationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/interconnectRemoteLocations"
            % client.transport._host,
            args[1],
        )
...
def test_interconnect_remote_locations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport.__init__"
    ) as Transport:
...
def test_interconnect_remote_locations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

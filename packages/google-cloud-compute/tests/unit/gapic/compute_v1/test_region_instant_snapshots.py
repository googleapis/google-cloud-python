...
def test_delete_rest_bad_request(
    transport: str = "rest", request_type=compute.DeleteRegionInstantSnapshotRequest
):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstantSnapshot.to_json(
...
def test_get_rest_bad_request(
    transport: str = "rest", request_type=compute.GetRegionInstantSnapshotRequest
):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_insert_rest_bad_request(
    transport: str = "rest", request_type=compute.InsertRegionInstantSnapshotRequest
):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstantSnapshotList.to_json(
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListRegionInstantSnapshotsRequest
):
    client = RegionInstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

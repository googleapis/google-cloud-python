...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DisksClient._get_client_cert_source(None, True)
...
def test_bulk_set_labels_rest_required_fields(
    request_type=compute.BulkSetLabelsDiskRequest,
):
    transport_class = transports.DisksRestTransport
...
def test_bulk_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/disks/bulkSetLabels"
            % client.transport._host,
            args[1],
        )
...
def test_bulk_set_labels_unary_rest_required_fields(
    request_type=compute.BulkSetLabelsDiskRequest,
):
    transport_class = transports.DisksRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/disks/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_kms_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DisksClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_kms_key in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.update_kms_key] = mock_rpc

        request = {}
        client.update_kms_key(request)
...
def test_update_kms_key_rest_required_fields(
    request_type=compute.UpdateKmsKeyDiskRequest,
):
    transport_class = transports.DisksRestTransport
...
def test_update_kms_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            zone="zone_value",
            disk="disk_value",
            disk_update_kms_key_request_resource=compute.DiskUpdateKmsKeyRequest(
        ...
        client.update_kms_key(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/updateKmsKey"
            % client.transport._host,
            args[1],
        )


def test_update_kms_key_rest_flattened_error(transport: str = "rest"):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_kms_key_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DisksClient(
        ...
        request = {}
        client.update_kms_key_unary(request)
...
def test_update_kms_key_unary_rest_required_fields(
    request_type=compute.UpdateKmsKeyDiskRequest,
):
    transport_class = transports.DisksRestTransport
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.update_kms_key_unary(request)
...
def test_update_kms_key_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_kms_key_unary(**mock_args)
...
def test_update_kms_key_unary_rest_flattened_error(transport: str = "rest"):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_resource_policies_rest_call_success(request_type):
    ...
    test_field = compute.AddResourcePoliciesDiskRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["disks_add_resource_policies_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["disks_add_resource_policies_request_resource"][field][
                    subfield
                ]
    request = request_type(**request_init)
...
def test_add_resource_policies_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        pb_message = compute.AddResourcePoliciesDiskRequest.pb(
            compute.AddResourcePoliciesDiskRequest()
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListDisksRequest.pb(
            compute.AggregatedListDisksRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_bulk_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.BulkInsertDiskRequest.meta.fields[
...
def test_bulk_set_labels_rest_bad_request(
    request_type=compute.BulkSetLabelsDiskRequest,
):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_bulk_set_labels_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2"}
    request_init["bulk_zone_set_labels_request_resource"] = {
        "requests": [{"label_fingerprint": "label_fingerprint_value", "labels": {}}]
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.BulkSetLabelsDiskRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["bulk_zone_set_labels_request_resource"][field])
                ):
                    del request_init["bulk_zone_set_labels_request_resource"][field][i][
                        subfield
                    ]
            else:
                del request_init["bulk_zone_set_labels_request_resource"][field][
                    subfield
                ]
    request = request_type(**request_init)
...
def test_bulk_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.BulkSetLabelsDiskRequest.pb(
            compute.BulkSetLabelsDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.CreateSnapshotDiskRequest.pb(
            compute.CreateSnapshotDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyDiskRequest.pb(
            compute.GetIamPolicyDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_remove_resource_policies_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.RemoveResourcePoliciesDiskRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["disks_remove_resource_policies_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["disks_remove_resource_policies_request_resource"][
...
def test_remove_resource_policies_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveResourcePoliciesDiskRequest.pb(
            compute.RemoveResourcePoliciesDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_resize_rest_call_success(request_type):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["disks_resize_request_resource"][field])
                ):
                    del request_init["disks_resize_request_resource"][field][i][
                        subfield
                    ]
            else:
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyDiskRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyDiskRequest.pb(
            compute.SetIamPolicyDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsDiskRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["zone_set_labels_request_resource"][field])
                ):
                    del request_init["zone_set_labels_request_resource"][field][i][
                        subfield
                    ]
            else:
...
def test_start_async_replication_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.StartAsyncReplicationDiskRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["disks_start_async_replication_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["disks_start_async_replication_request_resource"][
...
def test_stop_group_async_replication_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.StopGroupAsyncReplicationDiskRequest.meta.fields[
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsDiskRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsDiskRequest.pb(
            compute.TestIamPermissionsDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_kms_key_rest_bad_request(request_type=compute.UpdateKmsKeyDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_update_kms_key_rest_call_success(request_type):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "disk": "sample3"}
    request_init["disk_update_kms_key_request_resource"] = {
        "kms_key_name": "kms_key_name_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateKmsKeyDiskRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["disk_update_kms_key_request_resource"][field])
                ):
                    del request_init["disk_update_kms_key_request_resource"][field][i][
                        subfield
                    ]
            else:
                del request_init["disk_update_kms_key_request_resource"][field][
                    subfield
                ]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_kms_key_rest_interceptors(null_interceptor):
    transport = transports.DisksRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DisksRestInterceptor(),
    )
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.DisksRestInterceptor, "post_update_kms_key"
        ) as post,
        mock.patch.object(
            transports.DisksRestInterceptor, "post_update_kms_key_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.DisksRestInterceptor, "pre_update_kms_key") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateKmsKeyDiskRequest.pb(
            compute.UpdateKmsKeyDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.UpdateKmsKeyDiskRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_kms_key_unary_empty_call_rest():
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.update_kms_key), "__call__") as call:
        client.update_kms_key_unary(request=None)
...
def test_disks_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.update_kms_key._session
    session2 = client2.transport.update_kms_key._session
    assert session1 != session2

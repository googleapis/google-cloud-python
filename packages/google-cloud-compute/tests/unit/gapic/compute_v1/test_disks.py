...
def test_disks_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = DisksClient.from_service_account_info(info)
...
def test_add_resource_policies_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.add_resource_policies(
            ...
            zone="zone_value",
            disk="disk_value",
            disks_add_resource_policies_request_resource=disks_add_resource_policies_request_resource,
        )
        ...
        return_value = compute.DiskAggregatedList(
            ...
            items={
                "key_value": compute.DisksScopedList(
                    disks=[compute.Disk(creation_timestamp="creation_timestamp_value")]
                )
            },
            kind="kind_value",
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
            project="project_value", zone="zone_value", disk="disk_value",
        )
...
def test_get_rest(transport: str = "rest", request_type=compute.GetDiskRequest):
    ...
    assert response.creation_timestamp == "creation_timestamp_value"
    assert response.description == "description_value"
    assert response.disk_encryption_key == compute.CustomerEncryptionKey(
        kms_key_name="kms_key_name_value"
    )
...
def test_list_rest(transport: str = "rest", request_type=compute.ListDisksRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.DiskList(
            id="id_value",
            items=[compute.Disk(creation_timestamp="creation_timestamp_value")],
            kind="kind_value",
            next_page_token="next_page_token_value",
            self_link="self_link_value",
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
...
def test_remove_resource_policies_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.remove_resource_policies(
            ...
            zone="zone_value",
            disk="disk_value",
            disks_remove_resource_policies_request_resource=disks_remove_resource_policies_request_resource,
        )
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.resize(
            ...
            zone="zone_value",
            disk="disk_value",
            disks_resize_request_resource=disks_resize_request_resource,
        )
        ...
        assert compute.DisksResizeRequest.to_json(
            disks_resize_request_resource, including_default_value_fields=False
        ) in http_call[1] + str(body)
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.set_labels(
            ...
            zone="zone_value",
            resource="resource_value",
            zone_set_labels_request_resource=zone_set_labels_request_resource,
        )
        ...
        assert compute.ZoneSetLabelsRequest.to_json(
            zone_set_labels_request_resource, including_default_value_fields=False
        ) in http_call[1] + str(body)

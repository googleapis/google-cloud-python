...
from google.cloud.compute_v1.services.region_target_tcp_proxies import (
    RegionTargetTcpProxiesClient,
)
from google.cloud.compute_v1.services.region_target_tcp_proxies import pagers
from google.cloud.compute_v1.services.region_target_tcp_proxies import transports
...
def test_delete_rest_bad_request(
    transport: str = "rest", request_type=compute.DeleteRegionTargetTcpProxyRequest
):
    client = RegionTargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/targetTcpProxies/{target_tcp_proxy}"
...
def test_get_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.TargetTcpProxy.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.TargetTcpProxy.to_json(
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/targetTcpProxies"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.TargetTcpProxyList.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.TargetTcpProxyList.to_json(
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListRegionTargetTcpProxiesRequest
):
    client = RegionTargetTcpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_transport_kind(transport_name):
    transport = RegionTargetTcpProxiesClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_region_target_tcp_proxies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.region_target_tcp_proxies.transports.RegionTargetTcpProxiesTransport.__init__"
    ) as Transport:
...
def test_region_target_tcp_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.region_target_tcp_proxies.transports.RegionTargetTcpProxiesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
from google.cloud.compute_v1.services.future_reservations import (
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/futureReservations"
...
def test_cancel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/futureReservations/{future_reservation}/cancel"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/futureReservations/{future_reservation}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/futureReservations"
            % client.transport._host,
            args[1],
        )
...
def test_future_reservations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.future_reservations.transports.FutureReservationsTransport.__init__"
    ) as Transport:
...
def test_future_reservations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.future_reservations.transports.FutureReservationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

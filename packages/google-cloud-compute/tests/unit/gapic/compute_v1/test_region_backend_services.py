...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RegionBackendServicesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RegionBackendServicesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                RegionBackendServicesClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        RegionBackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        RegionBackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegionBackendServicesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/{backend_service}" % client.transport._host, args[1]
        )
...
def test_get_health_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/{backend_service}/getHealth" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/listUsable" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/{backend_service}/setSecurityPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/backendServices/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = RegionBackendServicesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_delete_with_metadata"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_health_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_health") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_get_health_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
    ...
    request_init["backend_service_resource"] = {
        ...
        "backends": [
            {
                ...
                "custom_metrics": [{"dry_run": True, "max_utilization": 0.1633, "name": "name_value"}],
                "description": "description_value",
                "failover": True,
                "group": "group_value",
        ...
        "cdn_policy": {
            ...
            "cache_key_policy": {
                ...
                "include_named_cookies": ["include_named_cookies_value1", "include_named_cookies_value2"],
                "include_protocol": True,
                "include_query_string": True,
                "query_string_blacklist": ["query_string_blacklist_value1", "query_string_blacklist_value2"],
        ...
        "consistent_hash": {
            "http_cookie": {"name": "name_value", "path": "path_value", "ttl": {"nanos": 543, "seconds": 751}},
            "http_header_name": "http_header_name_value",
            "minimum_ring_size": 1829,
        },
        "creation_timestamp": "creation_timestamp_value",
        "custom_metrics": [{"dry_run": True, "name": "name_value"}],
        "custom_request_headers": ["custom_request_headers_value1", "custom_request_headers_value2"],
        ...
        "external_managed_migration_state": "external_managed_migration_state_value",
        "external_managed_migration_testing_percentage": 0.47540000000000004,
        "failover_policy": {"disable_connection_drain_on_failover": True, "drop_traffic_if_unhealthy": True, "failover_ratio": 0.1494},
        "fingerprint": "fingerprint_value",
        "ha_policy": {
            "fast_i_p_move": "fast_i_p_move_value",
            "leader": {"backend_group": "backend_group_value", "network_endpoint": {"instance": "instance_value"}},
        },
        ...
        "kind": "kind_value",
        "load_balancing_scheme": "load_balancing_scheme_value",
        "locality_lb_policies": [{"custom_policy": {"data": "data_value", "name": "name_value"}, "policy": {"name": "name_value"}}],
        "locality_lb_policy": "locality_lb_policy_value",
        "log_config": {
            "enable": True,
        ...
        "security_settings": {
            ...
            "subject_alt_names": ["subject_alt_names_value1", "subject_alt_names_value2"],
        },
        "self_link": "self_link_value",
        "service_bindings": ["service_bindings_value1", "service_bindings_value2"],
        "service_lb_policy": "service_lb_policy_value",
        "session_affinity": "session_affinity_value",
        "strong_session_affinity_cookie": {"name": "name_value", "path": "path_value", "ttl": {}},
        "subsetting": {"policy": "policy_value"},
        "timeout_sec": 1185,
        "tls_settings": {
            "authentication_config": "authentication_config_value",
            "sni": "sni_value",
            "subject_alt_names": [{"dns_name": "dns_name_value", "uniform_resource_identifier": "uniform_resource_identifier_value"}],
        },
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_list_usable") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_list_usable_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_patch") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_patch_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_set_security_policy") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_set_security_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionBackendServicesRestInterceptor, "post_update") as post, mock.patch.object(
        transports.RegionBackendServicesRestInterceptor, "post_update_with_metadata"
    ) as post_with_metadata, mock.patch.object(

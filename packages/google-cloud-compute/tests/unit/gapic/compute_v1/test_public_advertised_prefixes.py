...
def test_announce_rest_bad_request(
    transport: str = "rest", request_type=compute.AnnouncePublicAdvertisedPrefixeRequest
):
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_announce_unary_rest_bad_request(
    transport: str = "rest", request_type=compute.AnnouncePublicAdvertisedPrefixeRequest
):
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_withdraw_rest_bad_request(
    transport: str = "rest", request_type=compute.WithdrawPublicAdvertisedPrefixeRequest
):
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_withdraw_unary_rest_bad_request(
    transport: str = "rest", request_type=compute.WithdrawPublicAdvertisedPrefixeRequest
):
    client = PublicAdvertisedPrefixesClient(
        credentials=ga_credentials.AnonymousCredentials(),

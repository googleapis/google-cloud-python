...
from google.cloud.compute_v1.services.region_disks.transports.base import (
...
def test_add_resource_policies_rest_flattened():
    client = RegionDisksClient(credentials=ga_credentials.AnonymousCredentials(),)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.add_resource_policies(
            ...
            region="region_value",
            disk="disk_value",
            region_disks_add_resource_policies_request_resource=region_disks_add_resource_policies_request_resource,
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.insert(
            project="project_value", region="region_value", disk_resource=disk_resource,
        )
...
def test_remove_resource_policies_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.remove_resource_policies(
            ...
            region="region_value",
            disk="disk_value",
            region_disks_remove_resource_policies_request_resource=region_disks_remove_resource_policies_request_resource,
        )
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.resize(
            ...
            region="region_value",
            disk="disk_value",
            region_disks_resize_request_resource=region_disks_resize_request_resource,
        )
...
def test_region_disks_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(
        google.auth, "load_credentials_from_file", autospec=True
    ) as load_creds, mock.patch(
...
@requires_google_auth_lt_1_25_0
def test_region_disks_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        RegionDisksClient()

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GlobalNetworkEndpointGroupsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        GlobalNetworkEndpointGroupsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        GlobalNetworkEndpointGroupsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        GlobalNetworkEndpointGroupsClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
    assert (
        GlobalNetworkEndpointGroupsClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                GlobalNetworkEndpointGroupsClient._use_client_cert_effective() is True
            )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                GlobalNetworkEndpointGroupsClient._use_client_cert_effective() is False
            )
...
def test__get_client_cert_source():
    ...
    assert (
        GlobalNetworkEndpointGroupsClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                GlobalNetworkEndpointGroupsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(GlobalNetworkEndpointGroupsClient),
)
def test__get_api_endpoint():
    ...
    default_endpoint = (
        GlobalNetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
            UNIVERSE_DOMAIN=default_universe
        )
    )
    mock_universe = "bar.com"
    mock_endpoint = GlobalNetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        GlobalNetworkEndpointGroupsClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        GlobalNetworkEndpointGroupsClient._get_universe_domain(
    ...
    assert (
        GlobalNetworkEndpointGroupsClient._get_universe_domain(None, None)
        == GlobalNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
    )
...
def test_global_network_endpoint_groups_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_global_network_endpoint_groups_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_global_network_endpoint_groups_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    GlobalNetworkEndpointGroupsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(GlobalNetworkEndpointGroupsClient),
)
def test_global_network_endpoint_groups_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_global_network_endpoint_groups_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_list_rest_required_fields(
    request_type=compute.ListGlobalNetworkEndpointGroupsRequest,
):
    transport_class = transports.GlobalNetworkEndpointGroupsRestTransport
...
def test_list_network_endpoints_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_network_endpoints] = (
            mock_rpc
        )
...
def test_attach_network_endpoints_rest_call_success(request_type):
    ...
    test_field = (
        compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest.meta.fields[
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteGlobalNetworkEndpointGroupRequest.pb(
            compute.DeleteGlobalNetworkEndpointGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_detach_network_endpoints_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = (
        compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest.meta.fields[
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetGlobalNetworkEndpointGroupRequest.pb(
            compute.GetGlobalNetworkEndpointGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertGlobalNetworkEndpointGroupRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertGlobalNetworkEndpointGroupRequest.pb(
            compute.InsertGlobalNetworkEndpointGroupRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListGlobalNetworkEndpointGroupsRequest.pb(
            compute.ListGlobalNetworkEndpointGroupsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_common_billing_account_path():
    ...
    actual = GlobalNetworkEndpointGroupsClient.common_billing_account_path(
        billing_account
    )

...
from google.cloud.compute_v1.services.global_network_endpoint_groups.transports.base import (
...
def test_global_network_endpoint_groups_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class", [GlobalNetworkEndpointGroupsClient,])
def test_global_network_endpoint_groups_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_attach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.attach_network_endpoints(
            ...
            global_network_endpoint_groups_attach_endpoints_request_resource=global_network_endpoint_groups_attach_endpoints_request_resource,
        )
...
def test_detach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.detach_network_endpoints(
            project="project_value",
            network_endpoint_group="network_endpoint_group_value",
            global_network_endpoint_groups_detach_endpoints_request_resource=global_network_endpoint_groups_detach_endpoints_request_resource,
        )
...
def test_list_rest_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListGlobalNetworkEndpointGroupsRequest(), project="project_value",
        )
...
def test_global_network_endpoint_groups_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(
        google.auth, "load_credentials_from_file", autospec=True
    ) as load_creds, mock.patch(
...
@requires_google_auth_lt_1_25_0
def test_global_network_endpoint_groups_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        GlobalNetworkEndpointGroupsClient()
...
def test_global_network_endpoint_groups_host_with_port():
    client = GlobalNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

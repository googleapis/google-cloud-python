...
from google.cloud.compute_v1.services.instance_group_manager_resize_requests import InstanceGroupManagerResizeRequestsClient, pagers, transports
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests" % client.transport._host,
            args[1],
        )

...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/addAssociation" % client.transport._host, args[1]
        )
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/cloneRules" % client.transport._host, args[1]
        )
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/getAssociation" % client.transport._host, args[1]
        )
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/removeAssociation" % client.transport._host, args[1]
        )
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/locations/global/firewallPolicies/{firewall_policy}/removeRule" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/locations/global/firewallPolicies/{resource}/testIamPermissions" % client.transport._host, args[1]
        )

...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert AutoscalersClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AutoscalersClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AutoscalersClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                AutoscalersClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        AutoscalersClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        AutoscalersClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AutoscalersClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                AutoscalersClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AutoscalersClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AutoscalersClient._DEFAULT_UNIVERSE
    default_endpoint = AutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == AutoscalersClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AutoscalersClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        AutoscalersClient._get_api_endpoint(None, None, default_universe, "always")
        == AutoscalersClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AutoscalersClient._get_api_endpoint(
    ...
    assert (
        AutoscalersClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AutoscalersClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        AutoscalersClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AutoscalersClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AutoscalersClient._get_universe_domain(None, None)
        == AutoscalersClient._DEFAULT_UNIVERSE
    )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsAutoscalerRequest,
):
    transport_class = transports.AutoscalersRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/autoscalers/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AutoscalerAggregatedList.to_json(
            compute.AutoscalerAggregatedList()
        )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsAutoscalerRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsAutoscalerRequest.pb(
            compute.TestIamPermissionsAutoscalerRequest()
        )
        transcode.return_value = {
            "method": "post",

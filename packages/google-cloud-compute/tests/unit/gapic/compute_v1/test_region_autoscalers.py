...
def test_region_autoscalers_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = RegionAutoscalersClient.from_service_account_info(info)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert compute.Autoscaler.to_json(
            autoscaler_resource, including_default_value_fields=False
...
def test_list_rest(
    ...
    assert isinstance(response, compute.RegionAutoscalerList)
    assert response.id == "id_value"

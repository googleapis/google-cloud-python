...
from google.cloud.compute_v1.services.region_autoscalers import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionAutoscalersClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        RegionAutoscalersClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        RegionAutoscalersClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionAutoscalersClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionAutoscalersClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionAutoscalersClient._DEFAULT_UNIVERSE
    default_endpoint = RegionAutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionAutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        RegionAutoscalersClient._get_api_endpoint(
    ...
    assert (
        RegionAutoscalersClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        RegionAutoscalersClient._get_api_endpoint(
    ...
    assert (
        RegionAutoscalersClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        RegionAutoscalersClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        RegionAutoscalersClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionAutoscalersClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionAutoscalersClient._get_universe_domain(None, None)
        == RegionAutoscalersClient._DEFAULT_UNIVERSE
    )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionAutoscalerRequest,
):
    transport_class = transports.RegionAutoscalersRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/autoscalers/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        pb_message = compute.DeleteRegionAutoscalerRequest.pb(
            compute.DeleteRegionAutoscalerRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionAutoscalerRequest.pb(
            compute.GetRegionAutoscalerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionAutoscalerRequest.pb(
            compute.InsertRegionAutoscalerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionAutoscalersRequest.pb(
            compute.ListRegionAutoscalersRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RegionAutoscalerList.to_json(
            compute.RegionAutoscalerList()
        )
        req.return_value.content = return_value
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRegionAutoscalerRequest.pb(
            compute.PatchRegionAutoscalerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionAutoscalerRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionAutoscalersRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.RegionAutoscalersRestInterceptor,
            "post_test_iam_permissions_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.RegionAutoscalersRestInterceptor, "pre_test_iam_permissions"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionAutoscalerRequest.pb(
            compute.TestIamPermissionsRegionAutoscalerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateRegionAutoscalerRequest.pb(
            compute.UpdateRegionAutoscalerRequest()
        )
        transcode.return_value = {
            "method": "post",

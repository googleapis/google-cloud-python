...
def test_packet_mirrorings_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class", [PacketMirroringsClient,])
def test_packet_mirrorings_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_packet_mirrorings_host_no_port():
    client = PacketMirroringsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_packet_mirrorings_host_with_port():
    client = PacketMirroringsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

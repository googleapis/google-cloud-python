...
def test_regions_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = RegionsClient.from_service_account_info(info)
...
def test_get_rest_flattened():
    client = RegionsClient(credentials=credentials.AnonymousCredentials(),)

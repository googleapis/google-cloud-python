...
from google.cloud.compute_v1.services.licenses import LicensesClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert LicensesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert LicensesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert LicensesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert LicensesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert LicensesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LicensesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                LicensesClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert LicensesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LicensesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LicensesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LicensesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert LicensesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert LicensesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                LicensesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert LicensesClient._get_client_cert_source(None, False) is None
    assert LicensesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LicensesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert LicensesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LicensesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(LicensesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicensesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LicensesClient._DEFAULT_UNIVERSE
    default_endpoint = LicensesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LicensesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LicensesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert LicensesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LicensesClient.DEFAULT_MTLS_ENDPOINT
    assert LicensesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LicensesClient._get_api_endpoint(None, None, default_universe, "always") == LicensesClient.DEFAULT_MTLS_ENDPOINT
    assert LicensesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LicensesClient.DEFAULT_MTLS_ENDPOINT
    assert LicensesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LicensesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LicensesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LicensesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LicensesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LicensesClient._get_universe_domain(None, None) == LicensesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        LicensesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = LicensesClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.LicensesRestTransport, "rest"),
    ],
)
def test_licenses_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_licenses_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(LicensesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LicensesClient))
...
@pytest.mark.parametrize("client_class", [LicensesClient])
@mock.patch.object(LicensesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicensesClient))
def test_licenses_client_client_api_endpoint(client_class):
...
def test_licenses_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_licenses_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_delete_rest_unset_required_fields():
    transport = transports.LicensesRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/global/licenses/{license_}" % client.transport._host, args[1])
...
def test_get_rest_required_fields(request_type=compute.GetLicenseRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.License.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_iam_policy_rest_required_fields(request_type=compute.GetIamPolicyLicenseRequest):
    transport_class = transports.LicensesRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/licenses/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            license_resource=compute.License(allowed_replacement_licenses=["allowed_replacement_licenses_value"]),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/licenses" % client.transport._host, args[1])
...
def test_list_rest_required_fields(request_type=compute.ListLicensesRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.LicensesListResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_set_iam_policy_rest_required_fields(request_type=compute.SetIamPolicyLicenseRequest):
    transport_class = transports.LicensesRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/licenses/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsLicenseRequest):
    transport_class = transports.LicensesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/licenses/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_update_rest_required_fields(request_type=compute.UpdateLicenseRequest):
    transport_class = transports.LicensesRestTransport
...
def test_update_unary_rest_required_fields(request_type=compute.UpdateLicenseRequest):
    transport_class = transports.LicensesRestTransport
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = LicensesClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_rest():
    transport = LicensesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_delete_rest_bad_request(request_type=compute.DeleteLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_delete_with_metadata"
        ...
        pb_message = compute.DeleteLicenseRequest.pb(compute.DeleteLicenseRequest())
...
def test_get_rest_bad_request(request_type=compute.GetLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "license_": "sample2"}
    request = request_type(**request_init)
...
def test_get_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        return_value = compute.License(
            ...
            appendable_to_disk=True,
            charges_use_fee=True,
            creation_timestamp="creation_timestamp_value",
            description="description_value",
            id=205,
            incompatible_licenses=["incompatible_licenses_value"],
            kind="kind_value",
            license_code=1245,
            ...
            required_coattached_licenses=["required_coattached_licenses_value"],
            self_link="self_link_value",
            self_link_with_id="self_link_with_id_value",
            sole_tenant_only=True,
            transferable=True,
    ...
    assert response.appendable_to_disk is True
    assert response.charges_use_fee is True
    assert response.creation_timestamp == "creation_timestamp_value"
    assert response.description == "description_value"
    assert response.id == 205
    assert response.incompatible_licenses == ["incompatible_licenses_value"]
    assert response.kind == "kind_value"
    assert response.license_code == 1245
    assert response.multi_tenant_only is True
    assert response.name == "name_value"
    assert response.os_license is True
    assert response.removable_from_disk is True
    assert response.required_coattached_licenses == ["required_coattached_licenses_value"]
    assert response.self_link == "self_link_value"
    assert response.self_link_with_id == "self_link_with_id_value"
    assert response.sole_tenant_only is True
    assert response.transferable is True
    assert response.update_timestamp == "update_timestamp_value"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetLicenseRequest.pb(compute.GetLicenseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.License.to_json(compute.License())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.License(), metadata
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyLicenseRequest.pb(compute.GetIamPolicyLicenseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_bad_request(request_type=compute.InsertLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["license_resource"] = {
        "allowed_replacement_licenses": ["allowed_replacement_licenses_value1", "allowed_replacement_licenses_value2"],
        "appendable_to_disk": True,
        "charges_use_fee": True,
        "creation_timestamp": "creation_timestamp_value",
        "description": "description_value",
        "id": 205,
        "incompatible_licenses": ["incompatible_licenses_value1", "incompatible_licenses_value2"],
        "kind": "kind_value",
        "license_code": 1245,
        "minimum_retention": {"nanos": 543, "seconds": 751},
        "multi_tenant_only": True,
        "name": "name_value",
        "os_license": True,
        "removable_from_disk": True,
        "required_coattached_licenses": ["required_coattached_licenses_value1", "required_coattached_licenses_value2"],
    ...
    test_field = compute.InsertLicenseRequest.meta.fields["license_resource"]
    ...
    for field, value in request_init["license_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["license_resource"][field])):
                    del request_init["license_resource"][field][i][subfield]
            else:
                del request_init["license_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertLicenseRequest.pb(compute.InsertLicenseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_bad_request(request_type=compute.ListLicensesRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListLicensesRequest.pb(compute.ListLicensesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.LicensesListResponse.to_json(compute.LicensesListResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.LicensesListResponse(), metadata
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "resource": "sample2"}
    request = request_type(**request_init)
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyLicenseRequest.meta.fields["global_set_policy_request_resource"]
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyLicenseRequest.pb(compute.SetIamPolicyLicenseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "resource": "sample2"}
    request = request_type(**request_init)
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsLicenseRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsLicenseRequest.pb(compute.TestIamPermissionsLicenseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_rest_bad_request(request_type=compute.UpdateLicenseRequest):
    client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "license_": "sample2"}
    request = request_type(**request_init)
...
def test_update_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateLicenseRequest.meta.fields["license_resource"]
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicensesRestInterceptor, "post_update") as post, mock.patch.object(
        transports.LicensesRestInterceptor, "post_update_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.LicensesRestInterceptor, "pre_update"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateLicenseRequest.pb(compute.UpdateLicenseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        request = compute.UpdateLicenseRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        request_msg = compute.DeleteLicenseRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetLicenseRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyLicenseRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertLicenseRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListLicensesRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyLicenseRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsLicenseRequest()
...
def test_update_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.update), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.UpdateLicenseRequest()
...
def test_licenses_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.LicensesTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_licenses_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.compute_v1.services.licenses.transports.LicensesTransport.__init__") as Transport:
...
def test_licenses_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.LicensesRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_licenses_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = LicensesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = LicensesClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.LicensesTransport, "_prep_wrapped_messages") as prep:
        client = LicensesClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = LicensesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

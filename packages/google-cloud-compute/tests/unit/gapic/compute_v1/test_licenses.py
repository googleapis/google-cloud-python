...
def test__get_default_mtls_endpoint():
    ...
    assert LicensesClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__get_client_cert_source():
    ...
    assert (
        LicensesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        LicensesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                LicensesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                LicensesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(LicensesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LicensesClient._DEFAULT_UNIVERSE
    default_endpoint = LicensesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = LicensesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        LicensesClient._get_api_endpoint(
    ...
    assert (
        ...
        == LicensesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LicensesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        LicensesClient._get_api_endpoint(None, None, default_universe, "always")
        == LicensesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LicensesClient._get_api_endpoint(
    ...
    assert (
        LicensesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        LicensesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        LicensesClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        LicensesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        LicensesClient._get_universe_domain(None, None)
        == LicensesClient._DEFAULT_UNIVERSE
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            license_resource=compute.License(
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.LicensesRestInterceptor, "post_delete") as post,
        mock.patch.object(
            transports.LicensesRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.LicensesRestInterceptor, "pre_delete") as pre,
    ):
...
def test_get_rest_call_success(request_type):
    ...
    assert response.allowed_replacement_licenses == [
    ...
    assert response.required_coattached_licenses == [
        "required_coattached_licenses_value"
    ]
    assert response.self_link == "self_link_value"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.LicensesRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.LicensesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.LicensesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyLicenseRequest.pb(
            compute.GetIamPolicyLicenseRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["license_resource"] = {
        "allowed_replacement_licenses": [
            "allowed_replacement_licenses_value1",
        ...
        "incompatible_licenses": [
            "incompatible_licenses_value1",
            "incompatible_licenses_value2",
        ],
        "kind": "kind_value",
        "license_code": 1245,
        ...
        "required_coattached_licenses": [
            ...
            "required_coattached_licenses_value2",
        ],
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.LicensesRestInterceptor, "post_insert") as post,
        mock.patch.object(
            transports.LicensesRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.LicensesRestInterceptor, "pre_insert") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.LicensesRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.LicensesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.LicensesRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.LicensesListResponse.to_json(
            compute.LicensesListResponse()
        )
        req.return_value.content = return_value
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyLicenseRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyLicenseRequest.pb(
            compute.SetIamPolicyLicenseRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsLicenseRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.LicensesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsLicenseRequest.pb(
            compute.TestIamPermissionsLicenseRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.LicensesRestInterceptor, "post_update") as post,
        mock.patch.object(
            transports.LicensesRestInterceptor, "post_update_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.LicensesRestInterceptor, "pre_update") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

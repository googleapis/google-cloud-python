...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = compute.InstantSnapshotAggregatedList.to_json(
...
def test_aggregated_list_rest_bad_request(
    transport: str = "rest", request_type=compute.AggregatedListInstantSnapshotsRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_rest_bad_request(
    transport: str = "rest", request_type=compute.DeleteInstantSnapshotRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_iam_policy_rest_bad_request(
    transport: str = "rest", request_type=compute.GetIamPolicyInstantSnapshotRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_insert_rest_bad_request(
    transport: str = "rest", request_type=compute.InsertInstantSnapshotRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListInstantSnapshotsRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_set_iam_policy_rest_bad_request(
    transport: str = "rest", request_type=compute.SetIamPolicyInstantSnapshotRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_set_labels_rest_bad_request(
    transport: str = "rest", request_type=compute.SetLabelsInstantSnapshotRequest
):
    client = InstantSnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

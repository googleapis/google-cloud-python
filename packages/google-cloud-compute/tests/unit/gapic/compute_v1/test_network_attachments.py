...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert NetworkAttachmentsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert NetworkAttachmentsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert NetworkAttachmentsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                NetworkAttachmentsClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        NetworkAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        NetworkAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{network_attachment}" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            network_attachment_resource=compute.NetworkAttachment(
                connection_endpoints=[compute.NetworkAttachmentConnectedEndpoint(ip_address="ip_address_value")]
            ),
        )
        mock_args.update(sample_request)
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/networkAttachments/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = NetworkAttachmentsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.NetworkAttachmentsRestInterceptor, "post_aggregated_list_with_metadata"
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.NetworkAttachmentsRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["network_attachment_resource"] = {
        "connection_endpoints": [
            {
                ...
                "secondary_ip_cidr_ranges": ["secondary_ip_cidr_ranges_value1", "secondary_ip_cidr_ranges_value2"],
                "status": "status_value",
                "subnetwork": "subnetwork_value",
                "subnetwork_cidr_range": "subnetwork_cidr_range_value",
            }
        ],
        "connection_preference": "connection_preference_value",
        "creation_timestamp": "creation_timestamp_value",
        ...
        "name": "name_value",
        "network": "network_value",
        "producer_accept_lists": ["producer_accept_lists_value1", "producer_accept_lists_value2"],
        "producer_reject_lists": ["producer_reject_lists_value1", "producer_reject_lists_value2"],
        "region": "region_value",
        "self_link": "self_link_value",
        "self_link_with_id": "self_link_with_id_value",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.NetworkAttachmentsRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkAttachmentsRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.NetworkAttachmentsRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(

...
from google.cloud.compute_v1.services.disk_types import (
    DiskTypesClient,
    pagers,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DiskTypesClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        DiskTypesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        DiskTypesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DiskTypesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                DiskTypesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DiskTypesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DiskTypesClient._DEFAULT_UNIVERSE
    default_endpoint = DiskTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = DiskTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        DiskTypesClient._get_api_endpoint(
    ...
    assert (
        ...
        == DiskTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DiskTypesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        DiskTypesClient._get_api_endpoint(None, None, default_universe, "always")
        == DiskTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DiskTypesClient._get_api_endpoint(
    ...
    assert (
        DiskTypesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        DiskTypesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        DiskTypesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        DiskTypesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        DiskTypesClient._get_universe_domain(None, None)
        == DiskTypesClient._DEFAULT_UNIVERSE
    )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/diskTypes"
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/zones/{zone}/diskTypes/{disk_type}"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.DiskTypesRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
        ...
        pb_message = compute.AggregatedListDiskTypesRequest.pb(
            compute.AggregatedListDiskTypesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.DiskTypeAggregatedList.to_json(
            compute.DiskTypeAggregatedList()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.DiskTypesRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.DiskTypesRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.DiskTypesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.DiskTypesRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.DiskTypesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.DiskTypesRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

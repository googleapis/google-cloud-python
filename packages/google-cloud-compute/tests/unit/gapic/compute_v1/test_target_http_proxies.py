...
from google.cloud.compute_v1.services.target_http_proxies import TargetHttpProxiesClient
from google.cloud.compute_v1.services.target_http_proxies import pagers
from google.cloud.compute_v1.services.target_http_proxies import transports
...
def test_target_http_proxies_client_from_service_account_info(client_class):
...
@pytest.mark.parametrize("client_class", [TargetHttpProxiesClient,])
def test_target_http_proxies_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
@pytest.mark.parametrize(
    "request_type", [compute.AggregatedListTargetHttpProxiesRequest, dict,]
)
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        json_return_value = compute.TargetHttpProxyAggregatedList.to_json(return_value)
...
def test_aggregated_list_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response_value = Response()
            response_value.status_code = 200
            json_return_value = compute.TargetHttpProxyAggregatedList.to_json(
                return_value
            )
            response_value._content = json_return_value.encode("UTF-8")
            req.return_value = response_value
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/targetHttpProxies"
...
def test_aggregated_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.aggregated_list(
            compute.AggregatedListTargetHttpProxiesRequest(), project="project_value",
        )
...
def test_aggregated_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.TargetHttpProxyAggregatedList(items={}, next_page_token="def",),
            compute.TargetHttpProxyAggregatedList(
                items={"g": compute.TargetHttpProxiesScopedList(),},
                next_page_token="ghi",
            ),
            compute.TargetHttpProxyAggregatedList(
                items={
...
@pytest.mark.parametrize("request_type", [compute.DeleteTargetHttpProxyRequest, dict,])
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/targetHttpProxies/{target_http_proxy}"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize("request_type", [compute.GetTargetHttpProxyRequest, dict,])
...
@pytest.mark.parametrize("request_type", [compute.InsertTargetHttpProxyRequest, dict,])
...
def test_insert_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",)) & set(("project", "targetHttpProxyResource",))
    )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/targetHttpProxies"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize("request_type", [compute.ListTargetHttpProxiesRequest, dict,])
...
def test_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListTargetHttpProxiesRequest(), project="project_value",
        )
...
@pytest.mark.parametrize("request_type", [compute.PatchTargetHttpProxyRequest, dict,])
...
def test_patch_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",))
        & set(("project", "targetHttpProxy", "targetHttpProxyResource",))
    )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetUrlMapTargetHttpProxyRequest, dict,]
)
...
def test_set_url_map_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",))
        & set(("project", "targetHttpProxy", "urlMapReferenceResource",))
    )
...
def test_set_url_map_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/targetHttpProxies/{target_http_proxy}/setUrlMap"
            % client.transport._host,
            args[1],
        )
...
def test_credentials_transport_error():
    ...
    with pytest.raises(ValueError):
        client = TargetHttpProxiesClient(client_options=options, transport=transport,)
...
def test_target_http_proxies_host_no_port():
    client = TargetHttpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_target_http_proxies_host_with_port():
    client = TargetHttpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

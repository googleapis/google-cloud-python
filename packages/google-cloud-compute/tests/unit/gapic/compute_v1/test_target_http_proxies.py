...
from google.cloud.compute_v1.services.target_http_proxies.transports.base import (
...
def test_aggregated_list_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.TargetHttpProxyAggregatedList(
            id="id_value",
            items={
                "key_value": compute.TargetHttpProxiesScopedList(
                    target_http_proxies=[
...
def test_target_http_proxies_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(
        google.auth, "load_credentials_from_file", autospec=True
    ) as load_creds, mock.patch(

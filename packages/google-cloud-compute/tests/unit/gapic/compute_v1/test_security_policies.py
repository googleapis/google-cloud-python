...
def test_security_policies_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = SecurityPoliciesClient.from_service_account_info(info)
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert compute.SecurityPolicyRule.to_json(
            security_policy_rule_resource, including_default_value_fields=False
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert compute.SecurityPolicy.to_json(
            security_policy_resource, including_default_value_fields=False
        ) in http_call[1] + str(body)

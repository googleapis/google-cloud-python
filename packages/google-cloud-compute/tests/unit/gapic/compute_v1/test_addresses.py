...
from google.cloud.compute_v1.services.addresses import (
    AddressesClient,
    pagers,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AddressesClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AddressesClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AddressesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert AddressesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AddressesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AddressesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                AddressesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        AddressesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        AddressesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AddressesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                AddressesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AddressesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AddressesClient._DEFAULT_UNIVERSE
    default_endpoint = AddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == AddressesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AddressesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        AddressesClient._get_api_endpoint(None, None, default_universe, "always")
        == AddressesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AddressesClient._get_api_endpoint(
    ...
    assert (
        AddressesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AddressesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        AddressesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AddressesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AddressesClient._get_universe_domain(None, None)
        == AddressesClient._DEFAULT_UNIVERSE
    )
...
def test_addresses_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    AddressesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AddressesClient)
)
...
def test_addresses_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListAddressesRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/addresses"
...
def test_move_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            address="address_value",
            region_addresses_move_request_resource=compute.RegionAddressesMoveRequest(
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/addresses/{address}/move"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/addresses/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_unary_rest_required_fields(
    request_type=compute.SetLabelsAddressRequest,
):
    transport_class = transports.AddressesRestTransport
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsAddressRequest,
):
    transport_class = transports.AddressesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/addresses/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_aggregated_list"
    ) as post, mock.patch.object(
        transports.AddressesRestInterceptor, "post_aggregated_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressesRestInterceptor, "pre_aggregated_list"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListAddressesRequest.pb(
            compute.AggregatedListAddressesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.AddressAggregatedList.to_json(
            compute.AddressAggregatedList()
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_list"
    ) as post, mock.patch.object(
        transports.AddressesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressesRestInterceptor, "pre_list"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_move_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "address": "sample3"}
    request_init["region_addresses_move_request_resource"] = {
        "description": "description_value",
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.MoveAddressRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0,
                    len(request_init["region_addresses_move_request_resource"][field]),
                ):
                    del request_init["region_addresses_move_request_resource"][field][
                        i
                    ][subfield]
            else:
                del request_init["region_addresses_move_request_resource"][field][
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_move"
    ) as post, mock.patch.object(
        transports.AddressesRestInterceptor, "post_move_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressesRestInterceptor, "pre_move"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsAddressRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_set_labels"
    ) as post, mock.patch.object(
        transports.AddressesRestInterceptor, "post_set_labels_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressesRestInterceptor, "pre_set_labels"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsAddressRequest.pb(
            compute.SetLabelsAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsAddressRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.AddressesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsAddressRequest.pb(
            compute.TestIamPermissionsAddressRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_addresses_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.addresses.transports.AddressesTransport.__init__"
    ) as Transport:
...
def test_addresses_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.addresses.transports.AddressesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.AddressesTransport, "_prep_wrapped_messages"
    ) as prep:
        client = AddressesClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = compute.AddressAggregatedList.to_json(
...
def test_aggregated_list_rest_bad_request(
    transport: str = "rest", request_type=compute.AggregatedListAddressesRequest
):
    client = AddressesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListAddressesRequest
):
    client = AddressesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_move_rest_bad_request(
    transport: str = "rest", request_type=compute.MoveAddressRequest
):
    client = AddressesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_set_labels_rest_bad_request(
    transport: str = "rest", request_type=compute.SetLabelsAddressRequest
):
    client = AddressesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

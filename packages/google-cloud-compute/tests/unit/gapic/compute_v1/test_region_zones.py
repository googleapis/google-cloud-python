...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionZonesClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.RegionZonesRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.RegionZonesRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionZonesRestInterceptor, "pre_list") as pre,
    ):

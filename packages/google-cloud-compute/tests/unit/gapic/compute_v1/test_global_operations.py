...
from google.cloud.compute_v1.services.global_operations import GlobalOperationsClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert GlobalOperationsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert GlobalOperationsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert GlobalOperationsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert GlobalOperationsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert GlobalOperationsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert GlobalOperationsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GlobalOperationsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GlobalOperationsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GlobalOperationsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert GlobalOperationsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert GlobalOperationsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                GlobalOperationsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert GlobalOperationsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GlobalOperationsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert GlobalOperationsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GlobalOperationsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(GlobalOperationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GlobalOperationsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GlobalOperationsClient._DEFAULT_UNIVERSE
    default_endpoint = GlobalOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GlobalOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GlobalOperationsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        GlobalOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == GlobalOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert GlobalOperationsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GlobalOperationsClient._get_api_endpoint(None, None, default_universe, "always") == GlobalOperationsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        GlobalOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == GlobalOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert GlobalOperationsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GlobalOperationsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GlobalOperationsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GlobalOperationsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GlobalOperationsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GlobalOperationsClient._get_universe_domain(None, None) == GlobalOperationsClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = GlobalOperationsClient(credentials=cred)
...
def test_global_operations_client_from_service_account_info(client_class, transport_name):
...
def test_global_operations_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_global_operations_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@mock.patch.object(GlobalOperationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GlobalOperationsClient))
def test_global_operations_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (GlobalOperationsClient, transports.GlobalOperationsRestTransport, "rest", "true"),
        (GlobalOperationsClient, transports.GlobalOperationsRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(GlobalOperationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GlobalOperationsClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_global_operations_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(GlobalOperationsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GlobalOperationsClient))
...
def test_global_operations_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_global_operations_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListGlobalOperationsRequest):
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.GlobalOperationsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/aggregated/operations" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/operations/{operation}" % client.transport._host, args[1])
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/operations" % client.transport._host, args[1])
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/operations/{operation}/wait" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = GlobalOperationsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_rest():
    transport = GlobalOperationsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListGlobalOperationsRequest):
    client = GlobalOperationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.GlobalOperationsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GlobalOperationsRestInterceptor(),
    )
    client = GlobalOperationsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.GlobalOperationsRestInterceptor, "post_aggregated_list_with_metadata"
        ...
        pb_message = compute.AggregatedListGlobalOperationsRequest.pb(compute.AggregatedListGlobalOperationsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.OperationAggregatedList.to_json(compute.OperationAggregatedList())
        ...
        post_with_metadata.return_value = compute.OperationAggregatedList(), metadata
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.GlobalOperationsRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteGlobalOperationRequest.pb(compute.DeleteGlobalOperationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.DeleteGlobalOperationResponse.to_json(compute.DeleteGlobalOperationResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.DeleteGlobalOperationResponse(), metadata
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_get") as post, mock.patch.object(
        transports.GlobalOperationsRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetGlobalOperationRequest.pb(compute.GetGlobalOperationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_list") as post, mock.patch.object(
        transports.GlobalOperationsRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListGlobalOperationsRequest.pb(compute.ListGlobalOperationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_wait") as post, mock.patch.object(
        transports.GlobalOperationsRestInterceptor, "post_wait_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.WaitGlobalOperationRequest.pb(compute.WaitGlobalOperationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_global_operations_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.GlobalOperationsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_global_operations_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.compute_v1.services.global_operations.transports.GlobalOperationsTransport.__init__") as Transport:
...
def test_global_operations_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.GlobalOperationsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = GlobalOperationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GlobalOperationsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.GlobalOperationsRestInterceptor,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.GlobalOperationsRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()

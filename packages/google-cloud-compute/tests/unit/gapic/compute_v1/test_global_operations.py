...
def test_global_operations_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = GlobalOperationsClient.from_service_account_info(info)
...
def test_aggregated_list_rest(
    ...
    assert isinstance(response, compute.OperationAggregatedList)
...
def test_aggregated_list_rest_flattened():
    client = GlobalOperationsClient(credentials=credentials.AnonymousCredentials(),)

...
- While logged into your GitHub account, navigate to the
  ``python-compute`` `repo`_ on GitHub.

- Fork and clone the ``python-compute`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-compute`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-compute``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-compute.git hack-on-python-compute
   $ cd hack-on-python-compute
...
.. _repo: https://github.com/googleapis/python-compute
...
.. _config: https://github.com/googleapis/python-compute/blob/main/packages/google-cloud-compute/noxfile.py

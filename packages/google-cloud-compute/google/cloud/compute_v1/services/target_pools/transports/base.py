...
class TargetPoolsTransport(abc.ABC):
    ...
    def get(
        ...
        typing.Union[compute.TargetPool, typing.Awaitable[compute.TargetPool]],
    ]:
        raise NotImplementedError()
    ...
    def get_health(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.TargetPoolInstanceHealth],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.TargetPoolList, typing.Awaitable[compute.TargetPoolList]],
    ]:
        raise NotImplementedError()

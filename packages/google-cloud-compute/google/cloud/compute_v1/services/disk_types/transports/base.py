...
class DiskTypesTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.DiskTypeAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.DiskType, typing.Awaitable[compute.DiskType]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.DiskTypeList, typing.Awaitable[compute.DiskTypeList]],
    ]:
        raise NotImplementedError()

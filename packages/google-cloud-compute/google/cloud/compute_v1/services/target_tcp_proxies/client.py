...
class TargetTcpProxiesClient(metaclass=TargetTcpProxiesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the target tcp proxies client.
        ...
        Returns:
            google.cloud.compute_v1.types.TargetTcpProxy:
                Represents a Target TCP Proxy resource.
                   ...
                   balancer. Global forwarding rules reference target
                   TCP proxy, and the target proxy then references an
                   external backend service. For more information, read
                   TCP Proxy Load Balancing overview. (== resource_for
    ...
    def list(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.TargetTcpProxyList:

...
class TargetTcpProxiesClientMeta(type):
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[TargetTcpProxiesTransport]]
...
class TargetTcpProxiesClient(metaclass=TargetTcpProxiesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = TargetTcpProxiesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = TargetTcpProxiesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = TargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TargetTcpProxiesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, TargetTcpProxiesTransport, Callable[..., TargetTcpProxiesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TargetTcpProxiesClient._read_environment_variables()
        self._client_cert_source = TargetTcpProxiesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TargetTcpProxiesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TargetTcpProxiesTransport)
        if transport_provided:
            ...
            self._transport = cast(TargetTcpProxiesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or TargetTcpProxiesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TargetTcpProxiesTransport], Callable[..., TargetTcpProxiesTransport]] = (
                TargetTcpProxiesClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.TargetTcpProxiesClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListTargetTcpProxiesRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1.AggregatedListTargetTcpProxiesRequest(
    ...
    def set_backend_service_unary(
        self,
        request: Optional[Union[compute.SetBackendServiceTargetTcpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        target_tcp_proxy: Optional[str] = None,
        target_tcp_proxies_set_backend_service_request_resource: Optional[compute.TargetTcpProxiesSetBackendServiceRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_tcp_proxy, target_tcp_proxies_set_backend_service_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.SetBackendServiceTargetTcpProxyRequest):
            ...
            if target_tcp_proxies_set_backend_service_request_resource is not None:
                request.target_tcp_proxies_set_backend_service_request_resource = target_tcp_proxies_set_backend_service_request_resource
    ...
    def set_proxy_header_unary(
        self,
        request: Optional[Union[compute.SetProxyHeaderTargetTcpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        target_tcp_proxy: Optional[str] = None,
        target_tcp_proxies_set_proxy_header_request_resource: Optional[compute.TargetTcpProxiesSetProxyHeaderRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, target_tcp_proxy, target_tcp_proxies_set_proxy_header_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.SetProxyHeaderTargetTcpProxyRequest):
            ...
            if target_tcp_proxies_set_proxy_header_request_resource is not None:
                request.target_tcp_proxies_set_proxy_header_request_resource = target_tcp_proxies_set_proxy_header_request_resource

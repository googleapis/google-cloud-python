...
class TargetTcpProxiesClient(metaclass=TargetTcpProxiesClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = TargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            TargetTcpProxiesClient._read_environment_variables()
        )
        self._client_cert_source = TargetTcpProxiesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TargetTcpProxiesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or TargetTcpProxiesClient._get_api_endpoint(
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsTargetTcpProxyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsTargetTcpProxyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsTargetTcpProxyRequest, dict]):
                The request object. A request message for
                TargetTcpProxies.TestIamPermissions. See
                the method description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetTcpProxyRequest):
            request = compute.TestIamPermissionsTargetTcpProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

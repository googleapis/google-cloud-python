...
class ZonesClient(metaclass=ZonesClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ZonesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ZonesTransport, Callable[..., ZonesTransport]]
        ] = None,
        ...
        self._client_cert_source = ZonesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ZonesClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ZonesTransport], Callable[..., ZonesTransport]
            ] = (

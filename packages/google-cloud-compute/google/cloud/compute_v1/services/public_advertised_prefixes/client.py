...
class PublicAdvertisedPrefixesClient(metaclass=PublicAdvertisedPrefixesClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or PublicAdvertisedPrefixesClient._compare_universes(
    ...
    def announce_unary(
        ...
        *,
        ...
        # in a compute.AnnouncePublicAdvertisedPrefixeRequest.
    ...
    def withdraw_unary(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.WithdrawPublicAdvertisedPrefixeRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

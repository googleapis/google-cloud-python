...
class GlobalOperationsClient(metaclass=GlobalOperationsClientMeta):
    ...
    def transport(self) -> GlobalOperationsTransport:
        ...
        Returns:
            GlobalOperationsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the global operations client.
        ...
        if isinstance(transport, GlobalOperationsTransport):

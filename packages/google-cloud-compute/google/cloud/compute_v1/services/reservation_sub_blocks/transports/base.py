...
class ReservationSubBlocksTransport(abc.ABC):
    ...
    def get(
        ...
        [compute.GetReservationSubBlockRequest], Union[compute.ReservationSubBlocksGetResponse, Awaitable[compute.ReservationSubBlocksGetResponse]]
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.ReservationSubBlocksListResponse, Awaitable[compute.ReservationSubBlocksListResponse]],
    ]:
        raise NotImplementedError()
    ...
    def perform_maintenance(
        self,
    ) -> Callable[[compute.PerformMaintenanceReservationSubBlockRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def report_faulty(self) -> Callable[[compute.ReportFaultyReservationSubBlockRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

...
class RegionInstantSnapshotGroupsTransport(abc.ABC):
    """Abstract transport class for RegionInstantSnapshotGroups."""
...
__all__ = ("RegionInstantSnapshotGroupsTransport",)

...
class GlobalPublicDelegatedPrefixesTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteGlobalPublicDelegatedPrefixeRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(
        self,
    ) -> Callable[[compute.GetGlobalPublicDelegatedPrefixeRequest], Union[compute.PublicDelegatedPrefix, Awaitable[compute.PublicDelegatedPrefix]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertGlobalPublicDelegatedPrefixeRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListGlobalPublicDelegatedPrefixesRequest], Union[compute.PublicDelegatedPrefixList, Awaitable[compute.PublicDelegatedPrefixList]]
    ]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchGlobalPublicDelegatedPrefixeRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

...
class GlobalPublicDelegatedPrefixesRestTransport(
    ...
    def delete(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/global/publicDelegatedPrefixes/{public_delegated_prefix}".format(
            host=self._host,
        ...
        query_params = {}
        if compute.DeleteGlobalPublicDelegatedPrefixeRequest.request_id in request:
    ...
    def insert(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.InsertGlobalPublicDelegatedPrefixeRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def list(
        ...
        *,
        ...
        if (
            compute.ListGlobalPublicDelegatedPrefixesRequest.return_partial_success
            in request
        ):
    ...
    def patch(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.PatchGlobalPublicDelegatedPrefixeRequest.request_id in request:
            query_params["requestId"] = request.request_id

...
class UrlMapsClient(metaclass=UrlMapsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = UrlMapsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, UrlMapsTransport, Callable[..., UrlMapsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = UrlMapsClient._read_environment_variables()
        self._client_cert_source = UrlMapsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = UrlMapsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[UrlMapsTransport], Callable[..., UrlMapsTransport]] = (
    ...
    def validate(
        ...
        *,
        project: Optional[str] = None,
        url_map: Optional[str] = None,
        url_maps_validate_request_resource: Optional[compute.UrlMapsValidateRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        if not isinstance(request, compute.ValidateUrlMapRequest):
            ...
            if url_maps_validate_request_resource is not None:
                request.url_maps_validate_request_resource = url_maps_validate_request_resource

...
class TargetInstancesClient(metaclass=TargetInstancesClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or TargetInstancesClient._compare_universes(
    ...
    def set_security_policy_unary(
        ...
        *,
        ...
        has_flattened_params = any(
            [project, zone, target_instance, security_policy_reference_resource]
        )
        if request is not None and has_flattened_params:
            raise ValueError(
                "If the `request` argument is set, then none of "
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetSecurityPolicyTargetInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

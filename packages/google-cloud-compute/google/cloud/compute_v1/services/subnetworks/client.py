...
class SubnetworksClient(metaclass=SubnetworksClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SubnetworksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SubnetworksTransport, Callable[..., SubnetworksTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SubnetworksClient._read_environment_variables()
        self._client_cert_source = SubnetworksClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SubnetworksClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SubnetworksTransport], Callable[..., SubnetworksTransport]] = (
    ...
    def expand_ip_cidr_range_unary(
        self,
        request: Optional[Union[compute.ExpandIpCidrRangeSubnetworkRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        subnetwork: Optional[str] = None,
        subnetworks_expand_ip_cidr_range_request_resource: Optional[compute.SubnetworksExpandIpCidrRangeRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, subnetwork, subnetworks_expand_ip_cidr_range_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.ExpandIpCidrRangeSubnetworkRequest):
            ...
            if subnetworks_expand_ip_cidr_range_request_resource is not None:
                request.subnetworks_expand_ip_cidr_range_request_resource = subnetworks_expand_ip_cidr_range_request_resource
    ...
    def set_private_ip_google_access_unary(
        self,
        request: Optional[Union[compute.SetPrivateIpGoogleAccessSubnetworkRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        subnetwork: Optional[str] = None,
        subnetworks_set_private_ip_google_access_request_resource: Optional[compute.SubnetworksSetPrivateIpGoogleAccessRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, subnetwork, subnetworks_set_private_ip_google_access_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.SetPrivateIpGoogleAccessSubnetworkRequest):
            ...
            if subnetworks_set_private_ip_google_access_request_resource is not None:
                request.subnetworks_set_private_ip_google_access_request_resource = subnetworks_set_private_ip_google_access_request_resource

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.set_private_ip_google_access]
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsSubnetworkRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,

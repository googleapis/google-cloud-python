...
class AutoscalersRestTransport(_BaseAutoscalersRestTransport):
    ...
    class _Delete(_BaseAutoscalersRestTransport._BaseDelete, AutoscalersRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAutoscalersRestTransport._BaseDelete._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAutoscalersRestTransport._BaseDelete._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            # Send the request
            response = AutoscalersRestTransport._Delete._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _Get(_BaseAutoscalersRestTransport._BaseGet, AutoscalersRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAutoscalersRestTransport._BaseGet._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAutoscalersRestTransport._BaseGet._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            # Send the request
            response = AutoscalersRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _Insert(_BaseAutoscalersRestTransport._BaseInsert, AutoscalersRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAutoscalersRestTransport._BaseInsert._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseAutoscalersRestTransport._BaseInsert._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseAutoscalersRestTransport._BaseInsert._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _List(_BaseAutoscalersRestTransport._BaseList, AutoscalersRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAutoscalersRestTransport._BaseList._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAutoscalersRestTransport._BaseList._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            # Send the request
            response = AutoscalersRestTransport._List._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _Patch(_BaseAutoscalersRestTransport._BasePatch, AutoscalersRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAutoscalersRestTransport._BasePatch._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseAutoscalersRestTransport._BasePatch._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseAutoscalersRestTransport._BasePatch._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _TestIamPermissions(
        _BaseAutoscalersRestTransport._BaseTestIamPermissions, AutoscalersRestStub
    ):
        def __hash__(self):
            return hash("AutoscalersRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.TestIamPermissionsAutoscalerRequest):
                    The request object. A request message for
                Autoscalers.TestIamPermissions. See the
                method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            http_options = _BaseAutoscalersRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseAutoscalersRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseAutoscalersRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseAutoscalersRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.AutoscalersClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Autoscalers",
            ...
            # Send the request
            response = AutoscalersRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.AutoscalersClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Autoscalers",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
    ...
    class _Update(_BaseAutoscalersRestTransport._BaseUpdate, AutoscalersRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAutoscalersRestTransport._BaseUpdate._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseAutoscalersRestTransport._BaseUpdate._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseAutoscalersRestTransport._BaseUpdate._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsAutoscalerRequest], compute.TestPermissionsResponse
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class AutoscalersTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.AutoscalerAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.Autoscaler, typing.Awaitable[compute.Autoscaler]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.AutoscalerList, typing.Awaitable[compute.AutoscalerList]],
    ]:
        raise NotImplementedError()

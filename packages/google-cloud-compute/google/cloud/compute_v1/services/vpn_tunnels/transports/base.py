...
class VpnTunnelsTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.VpnTunnelAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.VpnTunnel, typing.Awaitable[compute.VpnTunnel]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.VpnTunnelList, typing.Awaitable[compute.VpnTunnelList]],
    ]:
        raise NotImplementedError()

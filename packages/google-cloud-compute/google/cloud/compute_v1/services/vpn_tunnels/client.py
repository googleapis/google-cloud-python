...
class VpnTunnelsClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[VpnTunnelsTransport]:
...
class VpnTunnelsClient(metaclass=VpnTunnelsClientMeta):
    ...
    def transport(self) -> VpnTunnelsTransport:
        ...
        Returns:
            VpnTunnelsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the vpn tunnels client.
        ...
        Args:
            ...
            transport (Union[str, VpnTunnelsTransport]): The
        ...
        if isinstance(transport, VpnTunnelsTransport):
    ...
    def aggregated_list(
        self,
        request: compute.AggregatedListVpnTunnelsRequest = None,
        *,
        project: str = None,
        ...
        Returns:
            google.cloud.compute_v1.types.VpnTunnelAggregatedList:
        ...
        # in a compute.AggregatedListVpnTunnelsRequest.
    ...
    def delete(
        self,
        request: compute.DeleteVpnTunnelRequest = None,
        *,
        project: str = None,
        region: str = None,
        vpn_tunnel: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.DeleteVpnTunnelRequest):
                The request object. A request message for
    ...
    def get(
        self,
        request: compute.GetVpnTunnelRequest = None,
        *,
        project: str = None,
        region: str = None,
        vpn_tunnel: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.GetVpnTunnelRequest):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.types.VpnTunnel:
                Represents a Cloud VPN Tunnel resource.
                   ...
                   For more information about VPN, read the the Cloud
                   VPN Overview. (== resource_for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetVpnTunnelRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert(
        self,
        request: compute.InsertVpnTunnelRequest = None,
        *,
        project: str = None,
        region: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.InsertVpnTunnelRequest):
                The request object. A request message for
    ...
    def list(
        self,
        request: compute.ListVpnTunnelsRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        Returns:
            google.cloud.compute_v1.types.VpnTunnelList:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListVpnTunnelsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

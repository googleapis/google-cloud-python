...
class InstanceTemplatesClient(metaclass=InstanceTemplatesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = InstanceTemplatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, InstanceTemplatesTransport, Callable[..., InstanceTemplatesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InstanceTemplatesClient._read_environment_variables()
        self._client_cert_source = InstanceTemplatesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InstanceTemplatesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or InstanceTemplatesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[InstanceTemplatesTransport], Callable[..., InstanceTemplatesTransport]] = (
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListInstanceTemplatesRequest, dict]] = None,
        *,
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicyInstanceTemplateRequest, dict]] = None,
        *,
        project: Optional[str] = None,
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicyInstanceTemplateRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsInstanceTemplateRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,

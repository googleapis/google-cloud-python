...
class InstanceTemplatesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[InstanceTemplatesTransport]]
...
class InstanceTemplatesClient(metaclass=InstanceTemplatesClientMeta):
    ...
    def transport(self) -> InstanceTemplatesTransport:
        ...
        Returns:
            InstanceTemplatesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the instance templates client.
        ...
        if isinstance(transport, InstanceTemplatesTransport):
        ...
        Returns:
            google.cloud.compute_v1.types.InstanceTemplate:
                Represents an Instance Template resource.
                   ...
                   and managed instance groups. For more information,
                   read Instance Templates. (== resource_for

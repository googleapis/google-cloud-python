...
class MachineTypesTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.MachineTypeAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.MachineType, typing.Awaitable[compute.MachineType]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.MachineTypeList, typing.Awaitable[compute.MachineTypeList]
        ],
    ]:
        raise NotImplementedError()

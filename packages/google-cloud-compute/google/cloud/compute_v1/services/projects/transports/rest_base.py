...
class _BaseProjectsRestTransport(ProjectsTransport):
    ...
    class _BaseDisableXpnHost:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseDisableXpnHost._get_unset_required_fields(query_params))

            return query_params

    class _BaseDisableXpnResource:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseDisableXpnResource._get_unset_required_fields(query_params))

            return query_params

    class _BaseEnableXpnHost:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseEnableXpnHost._get_unset_required_fields(query_params))

            return query_params

    class _BaseEnableXpnResource:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseEnableXpnResource._get_unset_required_fields(query_params))
    ...
    class _BaseGet:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseGet._get_unset_required_fields(query_params))

            return query_params

    class _BaseGetXpnHost:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseGetXpnHost._get_unset_required_fields(query_params))

            return query_params

    class _BaseGetXpnResources:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseGetXpnResources._get_unset_required_fields(query_params))

            return query_params

    class _BaseListXpnHosts:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseListXpnHosts._get_unset_required_fields(query_params))
    ...
    class _BaseMoveDisk:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseMoveDisk._get_unset_required_fields(query_params))
    ...
    class _BaseMoveInstance:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseMoveInstance._get_unset_required_fields(query_params))

            return query_params

    class _BaseSetCloudArmorTier:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseSetCloudArmorTier._get_unset_required_fields(query_params))

            return query_params

    class _BaseSetCommonInstanceMetadata:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseSetCommonInstanceMetadata._get_unset_required_fields(query_params))

            return query_params

    class _BaseSetDefaultNetworkTier:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseSetDefaultNetworkTier._get_unset_required_fields(query_params))

            return query_params

    class _BaseSetUsageExportBucket:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectsRestTransport._BaseSetUsageExportBucket._get_unset_required_fields(query_params))

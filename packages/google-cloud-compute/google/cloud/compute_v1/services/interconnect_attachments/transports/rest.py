...
class InterconnectAttachmentsRestTransport(InterconnectAttachmentsTransport):
    ...
    def aggregated_list(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/aggregated/interconnectAttachments".format(
        ...
        query_params = {}
        if compute.AggregatedListInterconnectAttachmentsRequest.filter in request:
            query_params["filter"] = request.filter
        if (
            compute.AggregatedListInterconnectAttachmentsRequest.include_all_scopes
            in request
        ):
            query_params["includeAllScopes"] = request.include_all_scopes
        if compute.AggregatedListInterconnectAttachmentsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.AggregatedListInterconnectAttachmentsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.AggregatedListInterconnectAttachmentsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if (
            compute.AggregatedListInterconnectAttachmentsRequest.return_partial_success
            in request
        ):
    ...
    def delete(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.DeleteInterconnectAttachmentRequest.request_id in request:
    ...
    def insert(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/interconnectAttachments".format(
        ...
        #               not required for GCE
        query_params = {}
        if compute.InsertInterconnectAttachmentRequest.request_id in request:
            query_params["requestId"] = request.request_id
        if compute.InsertInterconnectAttachmentRequest.validate_only in request:
            query_params["validateOnly"] = request.validate_only
    ...
    def list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListInterconnectAttachmentsRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListInterconnectAttachmentsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListInterconnectAttachmentsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListInterconnectAttachmentsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.ListInterconnectAttachmentsRequest.return_partial_success in request:
            query_params["returnPartialSuccess"] = request.return_partial_success
    ...
    def patch(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.PatchInterconnectAttachmentRequest.request_id in request:
            query_params["requestId"] = request.request_id

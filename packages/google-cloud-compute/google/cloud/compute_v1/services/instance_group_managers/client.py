...
class InstanceGroupManagersClient(metaclass=InstanceGroupManagersClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the instance group managers client.
    ...
    def aggregated_list(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.InstanceGroupManagerAggregatedList:
    ...
    def list(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.InstanceGroupManagerList:
    ...
    def list_errors(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.InstanceGroupManagersListErrorsResponse:
    ...
    def list_managed_instances(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.InstanceGroupManagersListManagedInstancesResponse:
    ...
    def list_per_instance_configs(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.InstanceGroupManagersListPerInstanceConfigsResp:
    ...
    def recreate_instances(
        ...
        *,
        ...
        r"""Flags the specified instances in the managed instance
        group to be immediately recreated. The instances are
        deleted and recreated using the current instance
        template for the managed instance group. This operation
        is marked as DONE when the flag is set even if the
        instances have not yet been recreated. You must
        separately verify the status of the recreating action
        with the listmanagedinstances method.  If the group is

...
class NodeGroupsTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.NodeGroupAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        typing.Union[compute.NodeGroup, typing.Awaitable[compute.NodeGroup]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.NodeGroupList, typing.Awaitable[compute.NodeGroupList]],
    ]:
        raise NotImplementedError()
    ...
    def list_nodes(
        ...
        typing.Union[
            compute.NodeGroupsListNodes, typing.Awaitable[compute.NodeGroupsListNodes]
        ],
    ]:
        raise NotImplementedError()

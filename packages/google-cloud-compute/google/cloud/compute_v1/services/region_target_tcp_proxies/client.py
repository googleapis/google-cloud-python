...
from .transports.base import DEFAULT_CLIENT_INFO, RegionTargetTcpProxiesTransport
...
class RegionTargetTcpProxiesClient(metaclass=RegionTargetTcpProxiesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionTargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionTargetTcpProxiesTransport, Callable[..., RegionTargetTcpProxiesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionTargetTcpProxiesClient._read_environment_variables()
        self._client_cert_source = RegionTargetTcpProxiesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionTargetTcpProxiesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or RegionTargetTcpProxiesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionTargetTcpProxiesTransport], Callable[..., RegionTargetTcpProxiesTransport]] = (
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteRegionTargetTcpProxyRequest, dict]] = None,
        *,
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertRegionTargetTcpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def list(
        self,
        request: Optional[Union[compute.ListRegionTargetTcpProxiesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,

...
class InstanceGroupManagerResizeRequestsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_cancel(
        self, request: compute.CancelInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.CancelInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete(
        self, request: compute.DeleteInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.DeleteInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(
        self, request: compute.GetInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(
        self, request: compute.InsertInstanceGroupManagerResizeRequestRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.InsertInstanceGroupManagerResizeRequestRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        self, request: compute.ListInstanceGroupManagerResizeRequestsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.ListInstanceGroupManagerResizeRequestsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(
        self, response: compute.InstanceGroupManagerResizeRequestsListResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.InstanceGroupManagerResizeRequestsListResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class InstanceGroupManagerResizeRequestsRestTransport(_BaseInstanceGroupManagerResizeRequestsRestTransport):
    ...
    class _Cancel(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseCancel, InstanceGroupManagerResizeRequestsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Cancel._get_response(
    ...
    class _Delete(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseDelete, InstanceGroupManagerResizeRequestsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Delete._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request
            )
    ...
    class _Get(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseGet, InstanceGroupManagerResizeRequestsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Get._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request
            )
    ...
    class _Insert(_BaseInstanceGroupManagerResizeRequestsRestTransport._BaseInsert, InstanceGroupManagerResizeRequestsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = InstanceGroupManagerResizeRequestsRestTransport._Insert._get_response(
    ...
    @property
    def cancel(self) -> Callable[[compute.CancelInstanceGroupManagerResizeRequestRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Cancel(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def delete(self) -> Callable[[compute.DeleteInstanceGroupManagerResizeRequestRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Delete(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get(self) -> Callable[[compute.GetInstanceGroupManagerResizeRequestRequest], compute.InstanceGroupManagerResizeRequest]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Get(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def insert(self) -> Callable[[compute.InsertInstanceGroupManagerResizeRequestRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Insert(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def list(self) -> Callable[[compute.ListInstanceGroupManagerResizeRequestsRequest], compute.InstanceGroupManagerResizeRequestsListResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

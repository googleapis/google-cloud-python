...
class HealthChecksRestTransport(HealthChecksTransport):
    ...
    def aggregated_list(
        ...
        *,
        ...
        query_params = {}
        if compute.AggregatedListHealthChecksRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.AggregatedListHealthChecksRequest.include_all_scopes in request:
            query_params["includeAllScopes"] = request.include_all_scopes
        if compute.AggregatedListHealthChecksRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.AggregatedListHealthChecksRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.AggregatedListHealthChecksRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.AggregatedListHealthChecksRequest.return_partial_success in request:
    ...
    def delete(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.DeleteHealthCheckRequest.request_id in request:
    ...
    def insert(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.InsertHealthCheckRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListHealthChecksRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListHealthChecksRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListHealthChecksRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListHealthChecksRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.ListHealthChecksRequest.return_partial_success in request:
            query_params["returnPartialSuccess"] = request.return_partial_success
    ...
    def patch(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.PatchHealthCheckRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def update(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.UpdateHealthCheckRequest.request_id in request:
            query_params["requestId"] = request.request_id

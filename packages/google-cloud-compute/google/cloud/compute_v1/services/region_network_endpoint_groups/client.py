...
from .transports.base import DEFAULT_CLIENT_INFO, RegionNetworkEndpointGroupsTransport
...
class RegionNetworkEndpointGroupsClient(metaclass=RegionNetworkEndpointGroupsClientMeta):
    ...
    def transport(self) -> RegionNetworkEndpointGroupsTransport:
        ...
        Returns:
            RegionNetworkEndpointGroupsTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionNetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionNetworkEndpointGroupsTransport, Callable[..., RegionNetworkEndpointGroupsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionNetworkEndpointGroupsTransport,Callable[..., RegionNetworkEndpointGroupsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionNetworkEndpointGroupsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionNetworkEndpointGroupsClient._read_environment_variables()
        self._client_cert_source = RegionNetworkEndpointGroupsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionNetworkEndpointGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionNetworkEndpointGroupsTransport)
        ...
        self._api_endpoint = self._api_endpoint or RegionNetworkEndpointGroupsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionNetworkEndpointGroupsTransport], Callable[..., RegionNetworkEndpointGroupsTransport]] = (
                RegionNetworkEndpointGroupsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionNetworkEndpointGroupsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionNetworkEndpointGroupsClient`.",
                    extra={
    ...
    def attach_network_endpoints_unary(
        self,
        request: Optional[Union[compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        region_network_endpoint_groups_attach_endpoints_request_resource: Optional[compute.RegionNetworkEndpointGroupsAttachEndpointsRequest] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]):
            ...
            region_network_endpoint_groups_attach_endpoints_request_resource (google.cloud.compute_v1.types.RegionNetworkEndpointGroupsAttachEndpointsRequest):
                ...
                This corresponds to the ``region_network_endpoint_groups_attach_endpoints_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        flattened_params = [project, region, network_endpoint_group, region_network_endpoint_groups_attach_endpoints_request_resource]
        ...
        if not isinstance(request, compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest):
            request = compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest(request)
            ...
            if region_network_endpoint_groups_attach_endpoints_request_resource is not None:
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteRegionNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_endpoint_group]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def detach_network_endpoints_unary(
        self,
        request: Optional[Union[compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        region_network_endpoint_groups_detach_endpoints_request_resource: Optional[compute.RegionNetworkEndpointGroupsDetachEndpointsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
            ...
            network_endpoint_group (str):
                The name of the network endpoint
                group you are detaching network
                endpoints from. It should comply with
                RFC1035.
            ...
            region_network_endpoint_groups_detach_endpoints_request_resource (google.cloud.compute_v1.types.RegionNetworkEndpointGroupsDetachEndpointsRequest):
                The body resource for this request
                This corresponds to the ``region_network_endpoint_groups_detach_endpoints_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_endpoint_group, region_network_endpoint_groups_detach_endpoints_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest):
            request = compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if network_endpoint_group is not None:
                request.network_endpoint_group = network_endpoint_group
            if region_network_endpoint_groups_detach_endpoints_request_resource is not None:
    ...
    def get(
        self,
        request: Optional[Union[compute.GetRegionNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertRegionNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_endpoint_group_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def list(
        self,
        request: Optional[Union[compute.ListRegionNetworkEndpointGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def list_network_endpoints(
        self,
        request: Optional[Union[compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest):
            request = compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

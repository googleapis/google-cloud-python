...
class RegionNetworkEndpointGroupsClient(
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionNetworkEndpointGroupsClient._get_api_endpoint(
    ...
    def attach_network_endpoints_unary(
        self,
        request: Optional[
            Union[compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        region_network_endpoint_groups_attach_endpoints_request_resource: Optional[
            compute.RegionNetworkEndpointGroupsAttachEndpointsRequest
        ] = None,
    ...
    def detach_network_endpoints_unary(
        self,
        request: Optional[
            Union[compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        region_network_endpoint_groups_detach_endpoints_request_resource: Optional[
            compute.RegionNetworkEndpointGroupsDetachEndpointsRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def list_network_endpoints(
        self,
        request: Optional[
            Union[compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

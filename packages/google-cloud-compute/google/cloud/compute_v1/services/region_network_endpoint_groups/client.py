...
class RegionNetworkEndpointGroupsClient(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or RegionNetworkEndpointGroupsClient._compare_universes(
    ...
    def attach_network_endpoints_unary(
        ...
        *,
        ...
        # in a compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest.
    ...
    def detach_network_endpoints_unary(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
    ...
    def list_network_endpoints(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(

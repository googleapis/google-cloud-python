...
class CrossSiteNetworksClient(metaclass=CrossSiteNetworksClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_mtls_endpoint=CrossSiteNetworksClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=CrossSiteNetworksClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1.DeleteCrossSiteNetworkRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.DeleteCrossSiteNetworkRequest, dict]):
            ...
            cross_site_network (str):
                Name of the cross-site network to
                delete.
        ...
        if not isinstance(request, compute.DeleteCrossSiteNetworkRequest):
            request = compute.DeleteCrossSiteNetworkRequest(request)
    ...
    def get(
        self,
        request: Optional[Union[compute.GetCrossSiteNetworkRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        cross_site_network: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Returns the specified cross-site network in the given
        scope.
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetCrossSiteNetworkRequest(
                    cross_site_network="cross_site_network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetCrossSiteNetworkRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.types.CrossSiteNetwork:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetCrossSiteNetworkRequest):
            request = compute.GetCrossSiteNetworkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertCrossSiteNetworkRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        cross_site_network_resource: Optional[compute.CrossSiteNetwork] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        r"""Creates a cross-site network in the specified project
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertCrossSiteNetworkRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.InsertCrossSiteNetworkRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            cross_site_network_resource (google.cloud.compute_v1.types.CrossSiteNetwork):
                The body resource for this request
                This corresponds to the ``cross_site_network_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, cross_site_network_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.InsertCrossSiteNetworkRequest):
            request = compute.InsertCrossSiteNetworkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if cross_site_network_resource is not None:
                request.cross_site_network_resource = cross_site_network_resource
    ...
    def list(
        self,
        request: Optional[Union[compute.ListCrossSiteNetworksRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Lists the cross-site networks for a project in the
        given scope.
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListCrossSiteNetworksRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListCrossSiteNetworksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1.services.cross_site_networks.pagers.ListPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListCrossSiteNetworksRequest):
            request = compute.ListCrossSiteNetworksRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchCrossSiteNetworkRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        cross_site_network: Optional[str] = None,
        cross_site_network_resource: Optional[compute.CrossSiteNetwork] = None,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1.PatchCrossSiteNetworkRequest(
                    cross_site_network="cross_site_network_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.PatchCrossSiteNetworkRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, cross_site_network, cross_site_network_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.PatchCrossSiteNetworkRequest):
            request = compute.PatchCrossSiteNetworkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def __enter__(self) -> "CrossSiteNetworksClient":
        return self
...
__all__ = ("CrossSiteNetworksClient",)

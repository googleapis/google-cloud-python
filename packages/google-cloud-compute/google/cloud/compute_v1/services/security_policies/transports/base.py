...
class SecurityPoliciesTransport(abc.ABC):
    ...
    def get(
        ...
        typing.Union[compute.SecurityPolicy, typing.Awaitable[compute.SecurityPolicy]],
    ]:
        raise NotImplementedError()
    ...
    def get_rule(
        ...
        typing.Union[
            compute.SecurityPolicyRule, typing.Awaitable[compute.SecurityPolicyRule]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.SecurityPolicyList, typing.Awaitable[compute.SecurityPolicyList]
        ],
    ]:
        raise NotImplementedError()

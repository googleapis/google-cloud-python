...
class RoutersTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            compute.RouterAggregatedList, typing.Awaitable[compute.RouterAggregatedList]
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.Router, typing.Awaitable[compute.Router]],
    ]:
        raise NotImplementedError()
    ...
    def get_nat_mapping_info(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.VmEndpointNatMappingsList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_router_status(
        ...
        typing.Union[
            compute.RouterStatusResponse, typing.Awaitable[compute.RouterStatusResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.RouterList, typing.Awaitable[compute.RouterList]],
    ]:
        raise NotImplementedError()
    ...
    def preview(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.RoutersPreviewResponse],
        ],
    ]:
        raise NotImplementedError()

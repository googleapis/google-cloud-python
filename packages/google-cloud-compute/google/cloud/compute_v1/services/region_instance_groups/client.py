...
class RegionInstanceGroupsClient(metaclass=RegionInstanceGroupsClientMeta):
    ...
    def transport(self) -> RegionInstanceGroupsTransport:
        ...
        Returns:
            RegionInstanceGroupsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region instance groups client.
        ...
        if isinstance(transport, RegionInstanceGroupsTransport):

...
class RegionInstanceGroupsClient(metaclass=RegionInstanceGroupsClientMeta):
    ...
    def _compare_universes(
        ...
        default_universe = RegionInstanceGroupsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or RegionInstanceGroupsClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Union[str, RegionInstanceGroupsTransport]): The
    ...
    def get(
        ...
        *,
        ...
        # in a compute.GetRegionInstanceGroupRequest.
    ...
    def list(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListRegionInstanceGroupsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_instances(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListInstancesRegionInstanceGroupsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

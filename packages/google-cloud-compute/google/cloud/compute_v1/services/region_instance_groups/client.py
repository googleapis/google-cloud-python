...
class RegionInstanceGroupsClientMeta(type):
    """Metaclass for the RegionInstanceGroups client.
...
class RegionInstanceGroupsClient(metaclass=RegionInstanceGroupsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionInstanceGroupsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionInstanceGroupsTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionInstanceGroupsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RegionInstanceGroupsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionInstanceGroupsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionInstanceGroupsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionInstanceGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionInstanceGroupsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionInstanceGroupsTransport, Callable[..., RegionInstanceGroupsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionInstanceGroupsTransport,Callable[..., RegionInstanceGroupsTransport]]]):
                ...
                arguments as used in the RegionInstanceGroupsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionInstanceGroupsClient._read_environment_variables()
        self._client_cert_source = RegionInstanceGroupsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionInstanceGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionInstanceGroupsTransport)
        if transport_provided:
            # transport is a RegionInstanceGroupsTransport instance.
            ...
            self._transport = cast(RegionInstanceGroupsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RegionInstanceGroupsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionInstanceGroupsTransport], Callable[..., RegionInstanceGroupsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionInstanceGroupsClient`.",
                    extra={
        ...
        *,
        ...
        Args:
            ...
            region (str):
                ...
                should not be set.
            instance_group (str):
                Name of the instance group resource
                to return.
        ...
        flattened_params = [project, region, instance_group]
    ...
    def list_instances(
        self,
        request: Optional[Union[compute.ListInstancesRegionInstanceGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        instance_group: Optional[str] = None,
        region_instance_groups_list_instances_request_resource: Optional[compute.RegionInstanceGroupsListInstancesRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            ...
            region (str):
                ...
                should not be set.
            instance_group (str):
                Name of the regional instance group
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, instance_group, region_instance_groups_list_instances_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.ListInstancesRegionInstanceGroupsRequest):
            ...
            if instance_group is not None:
                request.instance_group = instance_group
            if region_instance_groups_list_instances_request_resource is not None:
                request.region_instance_groups_list_instances_request_resource = region_instance_groups_list_instances_request_resource
    ...
    def set_named_ports_unary(
        self,
        request: Optional[Union[compute.SetNamedPortsRegionInstanceGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        instance_group: Optional[str] = None,
        region_instance_groups_set_named_ports_request_resource: Optional[compute.RegionInstanceGroupsSetNamedPortsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, instance_group, region_instance_groups_set_named_ports_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.SetNamedPortsRegionInstanceGroupRequest):
            ...
            if region_instance_groups_set_named_ports_request_resource is not None:
                request.region_instance_groups_set_named_ports_request_resource = region_instance_groups_set_named_ports_request_resource
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRegionInstanceGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsRegionInstanceGroupRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsRegionInstanceGroupRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionInstanceGroupRequest):
            request = compute.TestIamPermissionsRegionInstanceGroupRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
...
__all__ = ("RegionInstanceGroupsClient",)

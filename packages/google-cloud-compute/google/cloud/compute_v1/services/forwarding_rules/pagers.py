...
class AggregatedListPager:
    ...
    @property
    def pages(self) -> Iterable[compute.ForwardingRuleAggregatedList]:
    ...
    def __iter__(self) -> Iterable[Tuple[str, compute.ForwardingRulesScopedList]]:
...
class ListPager:
    ...
    @property
    def pages(self) -> Iterable[compute.ForwardingRuleList]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, metadata=self._metadata)
    ...
    def __iter__(self) -> Iterable[compute.ForwardingRule]:
        for page in self.pages:

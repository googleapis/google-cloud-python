...
class NetworksTransport(abc.ABC):
    ...
    def get(
        ...
        typing.Union[compute.Network, typing.Awaitable[compute.Network]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.NetworkList, typing.Awaitable[compute.NetworkList]],
    ]:
        raise NotImplementedError()
    ...
    def list_peering_routes(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.ExchangedPeeringRoutesList],
        ],
    ]:
        raise NotImplementedError()

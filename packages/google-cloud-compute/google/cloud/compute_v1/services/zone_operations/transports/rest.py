        ...
        *,
        ...
        query_params = json.loads(
            compute.DeleteZoneOperationRequest.to_json(
                compute.DeleteZoneOperationRequest(transcoded_request["query_params"]),
        ...
        *,
        ...
        query_params = json.loads(
            compute.ListZoneOperationsRequest.to_json(
                compute.ListZoneOperationsRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )
        ...
        *,
        ...
        query_params = json.loads(
            compute.WaitZoneOperationRequest.to_json(
                compute.WaitZoneOperationRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )

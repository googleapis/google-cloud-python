...
class RegionNotificationEndpointsRestTransport(RegionNotificationEndpointsTransport):
    ...
    def delete(
        ...
        *,
        ...
        query_params = {}
        if compute.DeleteRegionNotificationEndpointRequest.request_id in request:
    ...
    def insert(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.InsertRegionNotificationEndpointRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListRegionNotificationEndpointsRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListRegionNotificationEndpointsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListRegionNotificationEndpointsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListRegionNotificationEndpointsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if (
            compute.ListRegionNotificationEndpointsRequest.return_partial_success
            in request
        ):

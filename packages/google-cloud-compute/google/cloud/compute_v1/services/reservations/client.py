...
class ReservationsClient(metaclass=ReservationsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=ReservationsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=ReservationsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=ReservationsClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def insert_unary(
        ...
        *,
        ...
        r"""Creates a new reservation. For more information,
        readReserving zonal resources.
    ...
    def perform_maintenance_unary(
        self,
        request: Optional[
            Union[compute.PerformMaintenanceReservationRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        reservation: Optional[str] = None,
        reservations_perform_maintenance_request_resource: Optional[
            compute.ReservationsPerformMaintenanceRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def resize_unary(
        ...
        *,
        ...
        reservations only). For more information, readModifying
        reservations.

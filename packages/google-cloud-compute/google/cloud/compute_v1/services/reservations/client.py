...
class ReservationsClient(metaclass=ReservationsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ReservationsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ReservationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ReservationsTransport, Callable[..., ReservationsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ReservationsClient._read_environment_variables()
        self._client_cert_source = ReservationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ReservationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ReservationsTransport], Callable[..., ReservationsTransport]] = (
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListReservationsRequest, dict]] = None,
        *,
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, reservation]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, reservation_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def perform_maintenance_unary(
        self,
        request: Optional[Union[compute.PerformMaintenanceReservationRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        reservation: Optional[str] = None,
        reservations_perform_maintenance_request_resource: Optional[compute.ReservationsPerformMaintenanceRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_perform_maintenance():
                ...
                # Initialize request argument(s)
                request = compute_v1.PerformMaintenanceReservationRequest(
                    project="project_value",
                    reservation="reservation_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.PerformMaintenanceReservationRequest, dict]):
                The request object. A request message for
                Reservations.PerformMaintenance. See the
                method description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
            ...
            zone (str):
                ...
                should not be set.
            reservation (str):
                The name of the reservation. Name
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reservations_perform_maintenance_request_resource (google.cloud.compute_v1.types.ReservationsPerformMaintenanceRequest):
                The body resource for this request
                This corresponds to the ``reservations_perform_maintenance_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, reservation, reservations_perform_maintenance_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.PerformMaintenanceReservationRequest):
            request = compute.PerformMaintenanceReservationRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if reservation is not None:
                request.reservation = reservation
            if reservations_perform_maintenance_request_resource is not None:
                request.reservations_perform_maintenance_request_resource = reservations_perform_maintenance_request_resource
    ...
    def resize_unary(
        ...
        *,
        ...
        zone: Optional[str] = None,
        reservation: Optional[str] = None,
        reservations_resize_request_resource: Optional[compute.ReservationsResizeRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, reservation, reservations_resize_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.ResizeReservationRequest):
            ...
            if reservations_resize_request_resource is not None:
                request.reservations_resize_request_resource = reservations_resize_request_resource
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsReservationRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        resource: Optional[str] = None,
    ...
    def update_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, reservation, reservation_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")

...
class ReservationsTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.ReservationAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.Reservation, typing.Awaitable[compute.Reservation]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.ReservationList, typing.Awaitable[compute.ReservationList]
        ],
    ]:
        raise NotImplementedError()

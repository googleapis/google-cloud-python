        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionAutoscalersClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionAutoscalersClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionAutoscalers",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

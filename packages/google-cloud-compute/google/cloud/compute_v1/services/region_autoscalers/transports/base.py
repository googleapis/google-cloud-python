...
class RegionAutoscalersTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteRegionAutoscalerRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetRegionAutoscalerRequest], Union[compute.Autoscaler, Awaitable[compute.Autoscaler]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertRegionAutoscalerRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListRegionAutoscalersRequest], Union[compute.RegionAutoscalerList, Awaitable[compute.RegionAutoscalerList]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchRegionAutoscalerRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def update(self) -> Callable[[compute.UpdateRegionAutoscalerRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

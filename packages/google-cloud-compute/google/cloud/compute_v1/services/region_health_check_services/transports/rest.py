...
class RegionHealthCheckServicesRestTransport(RegionHealthCheckServicesTransport):
    ...
    def _delete(
        ...
        *,
        ...
        request_kwargs = compute.DeleteRegionHealthCheckServiceRequest.to_dict(request)
    ...
    def _insert(
        ...
        *,
        ...
        request_kwargs = compute.InsertRegionHealthCheckServiceRequest.to_dict(request)
        transcoded_request = path_template.transcode(http_options, **request_kwargs)
    ...
    def _list(
        ...
        *,
        ...
        request_kwargs = compute.ListRegionHealthCheckServicesRequest.to_dict(request)
        transcoded_request = path_template.transcode(http_options, **request_kwargs)
    ...
    def _patch(
        ...
        *,
        ...
        request_kwargs = compute.PatchRegionHealthCheckServiceRequest.to_dict(request)
        transcoded_request = path_template.transcode(http_options, **request_kwargs)

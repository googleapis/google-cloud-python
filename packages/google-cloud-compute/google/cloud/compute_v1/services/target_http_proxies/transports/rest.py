...
class TargetHttpProxiesRestTransport(TargetHttpProxiesTransport):
    ...
    def _aggregated_list(
        ...
        *,
        ...
        request_kwargs = compute.AggregatedListTargetHttpProxiesRequest.to_dict(request)
        ...
        *,
        ...
        query_params = json.loads(
            compute.GetTargetHttpProxyRequest.to_json(
                compute.GetTargetHttpProxyRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )
        ...
        *,
        ...
        query_params = json.loads(
            compute.PatchTargetHttpProxyRequest.to_json(
                compute.PatchTargetHttpProxyRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )

...
class InstanceGroupsTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.InstanceGroupAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.InstanceGroupList, typing.Awaitable[compute.InstanceGroupList]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_instances(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.InstanceGroupsListInstances],
        ],
    ]:
        raise NotImplementedError()

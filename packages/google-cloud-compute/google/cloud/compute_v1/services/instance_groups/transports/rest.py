...
class InstanceGroupsRestTransport(InstanceGroupsTransport):
    ...
    def add_instances(
        ...
        *,
        ...
        query_params = {}
        if compute.AddInstancesInstanceGroupRequest.request_id in request:
    ...
    def aggregated_list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.AggregatedListInstanceGroupsRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.AggregatedListInstanceGroupsRequest.include_all_scopes in request:
            query_params["includeAllScopes"] = request.include_all_scopes
        if compute.AggregatedListInstanceGroupsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.AggregatedListInstanceGroupsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.AggregatedListInstanceGroupsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if (
            compute.AggregatedListInstanceGroupsRequest.return_partial_success
            in request
        ):
    ...
    def delete(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.DeleteInstanceGroupRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def insert(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.InsertInstanceGroupRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListInstanceGroupsRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListInstanceGroupsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListInstanceGroupsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListInstanceGroupsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.ListInstanceGroupsRequest.return_partial_success in request:
            query_params["returnPartialSuccess"] = request.return_partial_success
    ...
    def list_instances(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListInstancesInstanceGroupsRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListInstancesInstanceGroupsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListInstancesInstanceGroupsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListInstancesInstanceGroupsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.ListInstancesInstanceGroupsRequest.return_partial_success in request:
            query_params["returnPartialSuccess"] = request.return_partial_success
    ...
    def remove_instances(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.RemoveInstancesInstanceGroupRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def set_named_ports(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.SetNamedPortsInstanceGroupRequest.request_id in request:
            query_params["requestId"] = request.request_id

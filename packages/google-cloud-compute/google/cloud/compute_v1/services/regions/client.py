...
class RegionsClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[RegionsTransport]:
...
class RegionsClient(metaclass=RegionsClientMeta):
    ...
    def transport(self) -> RegionsTransport:
        ...
        Returns:
            RegionsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the regions client.
        ...
        Args:
            ...
            transport (Union[str, RegionsTransport]): The
        ...
        if isinstance(transport, RegionsTransport):
    ...
    def get(
        self,
        request: compute.GetRegionRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def list(
        self,
        request: compute.ListRegionsRequest = None,
        *,
        project: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        ...
        Returns:
            google.cloud.compute_v1.types.RegionList:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListRegionsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

...
class RegionsRestTransport(RegionsTransport):
    ...
    def list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListRegionsRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListRegionsRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListRegionsRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListRegionsRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.ListRegionsRequest.return_partial_success in request:

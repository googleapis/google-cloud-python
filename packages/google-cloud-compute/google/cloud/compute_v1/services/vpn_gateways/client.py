...
class VpnGatewaysClient(metaclass=VpnGatewaysClientMeta):
    ...
    def transport(self) -> VpnGatewaysTransport:
        ...
        Returns:
            VpnGatewaysTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the vpn gateways client.
    ...
    def aggregated_list(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.VpnGatewayAggregatedList:
    ...
    def list(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.VpnGatewayList:

...
class VpnGatewaysClient(metaclass=VpnGatewaysClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = VpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, VpnGatewaysTransport, Callable[..., VpnGatewaysTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = VpnGatewaysClient._read_environment_variables()
        self._client_cert_source = VpnGatewaysClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = VpnGatewaysClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[VpnGatewaysTransport], Callable[..., VpnGatewaysTransport]] = (
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsVpnGatewayRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,

...
class VpnGatewaysTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.VpnGatewayAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.VpnGateway, typing.Awaitable[compute.VpnGateway]],
    ]:
        raise NotImplementedError()
    ...
    def get_status(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.VpnGatewaysGetStatusResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.VpnGatewayList, typing.Awaitable[compute.VpnGatewayList]],
    ]:
        raise NotImplementedError()

...
class GlobalVmExtensionPoliciesRestTransport(
    ...
    class _Delete(
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseGlobalVmExtensionPoliciesRestTransport._BaseDelete._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseGlobalVmExtensionPoliciesRestTransport._BaseDelete._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalVmExtensionPoliciesRestTransport._Delete._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(
        _BaseGlobalVmExtensionPoliciesRestTransport._BaseGet,
        GlobalVmExtensionPoliciesRestStub,
    ):
        def __hash__(self):
            return hash("GlobalVmExtensionPoliciesRestTransport.Get")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.GetGlobalVmExtensionPolicyRequest):
                    The request object. A request message for
                GlobalVmExtensionPolicies.Get. See the
            ...
            Returns:
                ~.compute.GlobalVmExtensionPolicy:
                    Message describing
                GlobalVmExtensionPolicy object.

            """

            http_options = (
                _BaseGlobalVmExtensionPoliciesRestTransport._BaseGet._get_http_options()
            )

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseGlobalVmExtensionPoliciesRestTransport._BaseGet._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseGlobalVmExtensionPoliciesRestTransport._BaseGet._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalVmExtensionPoliciesRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = compute.GlobalVmExtensionPolicy()
            pb_resp = compute.GlobalVmExtensionPolicy.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.GlobalVmExtensionPolicy.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(
        _BaseGlobalVmExtensionPoliciesRestTransport._BaseInsert,
        GlobalVmExtensionPoliciesRestStub,
    ):
        def __hash__(self):
            return hash("GlobalVmExtensionPoliciesRestTransport.Insert")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.InsertGlobalVmExtensionPolicyRequest):
                    The request object. A request message for
                GlobalVmExtensionPolicies.Insert. See
                the method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            body = _BaseGlobalVmExtensionPoliciesRestTransport._BaseInsert._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseGlobalVmExtensionPoliciesRestTransport._BaseInsert._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalVmExtensionPoliciesRestTransport._Insert._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(
        _BaseGlobalVmExtensionPoliciesRestTransport._BaseList,
        GlobalVmExtensionPoliciesRestStub,
    ):
        def __hash__(self):
            return hash("GlobalVmExtensionPoliciesRestTransport.List")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.ListGlobalVmExtensionPoliciesRequest):
                    The request object. A request message for
                GlobalVmExtensionPolicies.List. See the
                method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            Returns:
                ~.compute.GlobalVmExtensionPolicyList:
                    Response to list global VM extension
                policy resources.
            ...
            # Jsonify the query params
            query_params = _BaseGlobalVmExtensionPoliciesRestTransport._BaseList._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.GlobalVmExtensionPolicyList()
            pb_resp = compute.GlobalVmExtensionPolicyList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.GlobalVmExtensionPolicyList.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Update(
        _BaseGlobalVmExtensionPoliciesRestTransport._BaseUpdate,
        GlobalVmExtensionPoliciesRestStub,
    ):
        def __hash__(self):
            return hash("GlobalVmExtensionPoliciesRestTransport.Update")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.UpdateGlobalVmExtensionPolicyRequest):
                    The request object. A request message for
                GlobalVmExtensionPolicies.Update. See
                the method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            body = _BaseGlobalVmExtensionPoliciesRestTransport._BaseUpdate._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseGlobalVmExtensionPoliciesRestTransport._BaseUpdate._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = GlobalVmExtensionPoliciesRestTransport._Update._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.GlobalVmExtensionPoliciesClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.GlobalVmExtensionPolicies",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
    ...
    def delete(
        self,
    ) -> Callable[[compute.DeleteGlobalVmExtensionPolicyRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get(
        ...
        [compute.GetGlobalVmExtensionPolicyRequest], compute.GlobalVmExtensionPolicy
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def insert(
        self,
    ) -> Callable[[compute.InsertGlobalVmExtensionPolicyRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def update(
        self,
    ) -> Callable[[compute.UpdateGlobalVmExtensionPolicyRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
...
__all__ = ("GlobalVmExtensionPoliciesRestTransport",)

...
class RegionOperationsClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[RegionOperationsTransport]:
...
class RegionOperationsClient(metaclass=RegionOperationsClientMeta):
    ...
    def transport(self) -> RegionOperationsTransport:
        ...
        Returns:
            RegionOperationsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region operations client.
    ...
    def delete(
        self,
        request: compute.DeleteRegionOperationRequest = None,
        *,
        project: str = None,
        region: str = None,
        operation: str = None,
    ...
    def get(
        self,
        request: compute.GetRegionOperationRequest = None,
        *,
        project: str = None,
        region: str = None,
        operation: str = None,
    ...
    def list(
        self,
        request: compute.ListRegionOperationsRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
    ...
    def wait(
        self,
        request: compute.WaitRegionOperationRequest = None,
        *,
        project: str = None,
        region: str = None,
        operation: str = None,

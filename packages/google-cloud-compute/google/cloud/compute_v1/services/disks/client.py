...
class DisksClient(metaclass=DisksClientMeta):
    ...
    def update_kms_key_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.UpdateKmsKeyDiskRequest, dict]):
                The request object. A request message for
            ...
            disk (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            disk_update_kms_key_request_resource (google.cloud.compute_v1.types.DiskUpdateKmsKeyRequest):
                The body resource for this request

...
class DisksTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            compute.DiskAggregatedList, typing.Awaitable[compute.DiskAggregatedList]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        typing.Union[compute.Disk, typing.Awaitable[compute.Disk]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.DiskList, typing.Awaitable[compute.DiskList]],
    ]:
        raise NotImplementedError()

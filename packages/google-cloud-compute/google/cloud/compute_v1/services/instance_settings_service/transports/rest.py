...
class InstanceSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get(
        self, request: compute.GetInstanceSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetInstanceSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(
        self, response: compute.InstanceSettings, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_patch(
        self, request: compute.PatchInstanceSettingRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.PatchInstanceSettingRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class InstanceSettingsServiceRestTransport(_BaseInstanceSettingsServiceRestTransport):
    ...
    @property
    def get(self) -> Callable[[compute.GetInstanceSettingRequest], compute.InstanceSettings]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Get(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def patch(self) -> Callable[[compute.PatchInstanceSettingRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

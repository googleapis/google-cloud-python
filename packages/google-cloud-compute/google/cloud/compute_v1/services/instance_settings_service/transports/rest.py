...
class InstanceSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[compute.GetInstanceSettingRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.PatchInstanceSettingRequest, Sequence[Tuple[str, str]]]:
...
class InstanceSettingsServiceRestTransport(InstanceSettingsServiceTransport):
    """REST backend transport for InstanceSettingsService.
    ...
    class _Get(InstanceSettingsServiceRestStub):
        def __hash__(self):
            return hash("Get")
    ...
    class _Patch(InstanceSettingsServiceRestStub):
        def __hash__(self):
            return hash("Patch")

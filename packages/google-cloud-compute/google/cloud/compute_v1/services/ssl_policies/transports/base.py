...
class SslPoliciesTransport(abc.ABC):
    ...
    def get(
        ...
        typing.Union[compute.SslPolicy, typing.Awaitable[compute.SslPolicy]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.SslPoliciesList, typing.Awaitable[compute.SslPoliciesList]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_available_features(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.SslPoliciesListAvailableFeaturesResponse],
        ],
    ]:
        raise NotImplementedError()

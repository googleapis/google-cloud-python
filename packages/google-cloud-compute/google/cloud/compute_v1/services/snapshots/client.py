        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_kms_key():
                ...
                # Initialize request argument(s)
                request = compute_v1.UpdateKmsKeySnapshotRequest(
                    project="project_value",
                    snapshot="snapshot_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.UpdateKmsKeySnapshotRequest, dict]):
                The request object. A request message for
            ...
            snapshot (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            snapshot_update_kms_key_request_resource (google.cloud.compute_v1.types.SnapshotUpdateKmsKeyRequest):
                The body resource for this request

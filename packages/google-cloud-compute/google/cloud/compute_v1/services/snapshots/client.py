...
class SnapshotsClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[SnapshotsTransport]:
...
class SnapshotsClient(metaclass=SnapshotsClientMeta):
    ...
    def transport(self) -> SnapshotsTransport:
        ...
        Returns:
            SnapshotsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the snapshots client.
    ...
    def delete(
        self,
        request: compute.DeleteSnapshotRequest = None,
        *,
        project: str = None,
        snapshot: str = None,
    ...
    def get(
        self,
        request: compute.GetSnapshotRequest = None,
        *,
        project: str = None,
        snapshot: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        Returns:
            google.cloud.compute_v1.types.Snapshot:
                Represents a Persistent Disk Snapshot resource.
                   ...
                   interval. For more information, read Creating
                   persistent disk snapshots. (== resource_for
    ...
    def get_iam_policy(
        self,
        request: compute.GetIamPolicySnapshotRequest = None,
        *,
        project: str = None,
        resource: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
    ...
    def list(
        self,
        request: compute.ListSnapshotsRequest = None,
        *,
        project: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
    ...
    def set_iam_policy(
        self,
        request: compute.SetIamPolicySnapshotRequest = None,
        *,
        project: str = None,
        resource: str = None,
    ...
    def set_labels(
        self,
        request: compute.SetLabelsSnapshotRequest = None,
        *,
        project: str = None,
        resource: str = None,
    ...
    def test_iam_permissions(
        self,
        request: compute.TestIamPermissionsSnapshotRequest = None,
        *,
        project: str = None,
        resource: str = None,

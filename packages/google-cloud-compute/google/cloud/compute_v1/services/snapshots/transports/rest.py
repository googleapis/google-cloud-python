...
class SnapshotsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[compute.DeleteSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(
        self, request: compute.GetSnapshotRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[compute.GetSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.GetIamPolicySnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.InsertSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(
        self, request: compute.ListSnapshotsRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[compute.ListSnapshotsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.SetIamPolicySnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_labels(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.SetLabelsSnapshotRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.TestIamPermissionsSnapshotRequest, Sequence[Tuple[str, str]]]:

    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomSnapshotsInterceptor(SnapshotsRestInterceptor):
            ...
            def pre_update_kms_key(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_kms_key(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def pre_get_iam_policy(
        ...
        compute.GetIamPolicySnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_set_iam_policy(
        ...
        compute.SetIamPolicySnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_set_labels(
        ...
        compute.SetLabelsSnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_update_kms_key(
        self,
        request: compute.UpdateKmsKeySnapshotRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        compute.UpdateKmsKeySnapshotRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for update_kms_key
    ...
    def post_update_kms_key(self, response: compute.Operation) -> compute.Operation:
        """Post-rpc interceptor for update_kms_key

        DEPRECATED. Please use the `post_update_kms_key_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the Snapshots server but before
        it is returned to user code. This `post_update_kms_key` interceptor runs
        before the `post_update_kms_key_with_metadata` interceptor.
        """
        return response

    def post_update_kms_key_with_metadata(
        self,
        response: compute.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_update_kms_key_with_metadata`
        interceptor in new development instead of the `post_update_kms_key` interceptor.
        When both interceptors are used, this `post_update_kms_key_with_metadata` interceptor runs after the
        `post_update_kms_key` interceptor. The (possibly modified) response returned by
        `post_update_kms_key` will be passed to
        `post_update_kms_key_with_metadata`.
        """
        return response, metadata
...
class SnapshotsRestTransport(_BaseSnapshotsRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[SnapshotsRestInterceptor]): Interceptor used
    ...
    class _Delete(_BaseSnapshotsRestTransport._BaseDelete, SnapshotsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = SnapshotsRestTransport._Delete._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _Get(_BaseSnapshotsRestTransport._BaseGet, SnapshotsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = SnapshotsRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetIamPolicy(
        _BaseSnapshotsRestTransport._BaseGetIamPolicy, SnapshotsRestStub
    ):
        def __hash__(self):
    ...
    class _SetIamPolicy(
        _BaseSnapshotsRestTransport._BaseSetIamPolicy, SnapshotsRestStub
    ):
        def __hash__(self):
    ...
    class _TestIamPermissions(
        _BaseSnapshotsRestTransport._BaseTestIamPermissions, SnapshotsRestStub
    ):
        def __hash__(self):
    ...
    class _UpdateKmsKey(
        _BaseSnapshotsRestTransport._BaseUpdateKmsKey, SnapshotsRestStub
    ):
        def __hash__(self):
            return hash("SnapshotsRestTransport.UpdateKmsKey")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update kms key method over HTTP.

            Args:
                request (~.compute.UpdateKmsKeySnapshotRequest):
                    The request object. A request message for
                Snapshots.UpdateKmsKey. See the method
                description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.SnapshotsClient.UpdateKmsKey",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Snapshots",
                        "rpcName": "UpdateKmsKey",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = SnapshotsRestTransport._UpdateKmsKey._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_update_kms_key(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_kms_key_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.SnapshotsClient.update_kms_key",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Snapshots",
                        "rpcName": "UpdateKmsKey",
                        "metadata": http_response["headers"],
    ...
    def update_kms_key(
        self,
    ) -> Callable[[compute.UpdateKmsKeySnapshotRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._UpdateKmsKey(self._session, self._host, self._interceptor)  # type: ignore

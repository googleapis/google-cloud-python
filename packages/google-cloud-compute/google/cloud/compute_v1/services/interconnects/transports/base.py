...
class InterconnectsTransport(abc.ABC):
    ...
    def get(
        ...
        typing.Union[compute.Interconnect, typing.Awaitable[compute.Interconnect]],
    ]:
        raise NotImplementedError()
    ...
    def get_diagnostics(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.InterconnectsGetDiagnosticsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.InterconnectList, typing.Awaitable[compute.InterconnectList]
        ],
    ]:
        raise NotImplementedError()

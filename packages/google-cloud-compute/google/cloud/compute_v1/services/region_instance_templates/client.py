...
class RegionInstanceTemplatesClient(metaclass=RegionInstanceTemplatesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionInstanceTemplatesClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or RegionInstanceTemplatesClient._get_api_endpoint(

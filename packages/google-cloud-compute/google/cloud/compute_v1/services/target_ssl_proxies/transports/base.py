...
class TargetSslProxiesTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetTargetSslProxyRequest], Union[compute.TargetSslProxy, Awaitable[compute.TargetSslProxy]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListTargetSslProxiesRequest], Union[compute.TargetSslProxyList, Awaitable[compute.TargetSslProxyList]]]:
        raise NotImplementedError()

    @property
    def set_backend_service(
        self,
    ) -> Callable[[compute.SetBackendServiceTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def set_certificate_map(
        self,
    ) -> Callable[[compute.SetCertificateMapTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def set_proxy_header(self) -> Callable[[compute.SetProxyHeaderTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def set_ssl_certificates(
        self,
    ) -> Callable[[compute.SetSslCertificatesTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def set_ssl_policy(self) -> Callable[[compute.SetSslPolicyTargetSslProxyRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

...
class ExternalVpnGatewaysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete(
        self, request: compute.DeleteExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.DeleteExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(
        self, request: compute.GetExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get(self, response: compute.ExternalVpnGateway) -> compute.ExternalVpnGateway:
    ...
    def post_get_with_metadata(
        self, response: compute.ExternalVpnGateway, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_insert(
        self, request: compute.InsertExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.InsertExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        self, request: compute.ListExternalVpnGatewaysRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.ListExternalVpnGatewaysRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list(self, response: compute.ExternalVpnGatewayList) -> compute.ExternalVpnGatewayList:
    ...
    def post_list_with_metadata(
        self, response: compute.ExternalVpnGatewayList, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_set_labels(
        self, request: compute.SetLabelsExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.SetLabelsExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsExternalVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class ExternalVpnGatewaysRestTransport(_BaseExternalVpnGatewaysRestTransport):
    ...
    class _Delete(_BaseExternalVpnGatewaysRestTransport._BaseDelete, ExternalVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseExternalVpnGatewaysRestTransport._BaseDelete._get_http_options()

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = _BaseExternalVpnGatewaysRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseExternalVpnGatewaysRestTransport._BaseDelete._get_query_params_json(transcoded_request)
    ...
    class _Get(_BaseExternalVpnGatewaysRestTransport._BaseGet, ExternalVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseExternalVpnGatewaysRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = _BaseExternalVpnGatewaysRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseExternalVpnGatewaysRestTransport._BaseGet._get_query_params_json(transcoded_request)
    ...
    class _Insert(_BaseExternalVpnGatewaysRestTransport._BaseInsert, ExternalVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseExternalVpnGatewaysRestTransport._BaseInsert._get_http_options()

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = _BaseExternalVpnGatewaysRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseExternalVpnGatewaysRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseExternalVpnGatewaysRestTransport._BaseInsert._get_query_params_json(transcoded_request)
    ...
    class _List(_BaseExternalVpnGatewaysRestTransport._BaseList, ExternalVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseExternalVpnGatewaysRestTransport._BaseList._get_http_options()

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = _BaseExternalVpnGatewaysRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseExternalVpnGatewaysRestTransport._BaseList._get_query_params_json(transcoded_request)
    ...
    class _SetLabels(_BaseExternalVpnGatewaysRestTransport._BaseSetLabels, ExternalVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseExternalVpnGatewaysRestTransport._BaseSetLabels._get_http_options()

            request, metadata = self._interceptor.pre_set_labels(request, metadata)
            transcoded_request = _BaseExternalVpnGatewaysRestTransport._BaseSetLabels._get_transcoded_request(http_options, request)

            body = _BaseExternalVpnGatewaysRestTransport._BaseSetLabels._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseExternalVpnGatewaysRestTransport._BaseSetLabels._get_query_params_json(transcoded_request)
    ...
    class _TestIamPermissions(_BaseExternalVpnGatewaysRestTransport._BaseTestIamPermissions, ExternalVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseExternalVpnGatewaysRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseExternalVpnGatewaysRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseExternalVpnGatewaysRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseExternalVpnGatewaysRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ExternalVpnGatewaysRestTransport._TestIamPermissions._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteExternalVpnGatewayRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Delete(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get(self) -> Callable[[compute.GetExternalVpnGatewayRequest], compute.ExternalVpnGateway]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Get(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def insert(self) -> Callable[[compute.InsertExternalVpnGatewayRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Insert(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def list(self) -> Callable[[compute.ListExternalVpnGatewaysRequest], compute.ExternalVpnGatewayList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._List(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def set_labels(self) -> Callable[[compute.SetLabelsExternalVpnGatewayRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._SetLabels(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsExternalVpnGatewayRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class TargetVpnGatewaysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_aggregated_list(
        ...
        compute.AggregatedListTargetVpnGatewaysRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def pre_delete(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.DeleteTargetVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.GetTargetVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.InsertTargetVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.ListTargetVpnGatewaysRequest, Sequence[Tuple[str, str]]]:
...
class TargetVpnGatewaysRestTransport(TargetVpnGatewaysTransport):
    ...
    _STUBS: Dict[str, TargetVpnGatewaysRestStub] = {}
    ...
    class _AggregatedList(TargetVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.AggregatedListTargetVpnGatewaysRequest.to_dict(
                request
            )
            ...
            query_params = json.loads(
                compute.AggregatedListTargetVpnGatewaysRequest.to_json(
            ...
            # Return the response
            resp = compute.TargetVpnGatewayAggregatedList.from_json(
                response.content, ignore_unknown_fields=True
            )
            resp = self._interceptor.post_aggregated_list(resp)
            return resp

    class _Delete(TargetVpnGatewaysRestStub):
        def __hash__(self):
            return hash("Delete")
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.DeleteTargetVpnGatewayRequest.to_dict(request)
            transcoded_request = path_template.transcode(http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(
                compute.DeleteTargetVpnGatewayRequest.to_json(
    ...
    class _Get(TargetVpnGatewaysRestStub):
        def __hash__(self):
            return hash("Get")
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.GetTargetVpnGatewayRequest.to_dict(request)
            transcoded_request = path_template.transcode(http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(
                compute.GetTargetVpnGatewayRequest.to_json(
            ...
            # Return the response
            resp = compute.TargetVpnGateway.from_json(
                response.content, ignore_unknown_fields=True
            )
            resp = self._interceptor.post_get(resp)
            return resp

    class _Insert(TargetVpnGatewaysRestStub):
        def __hash__(self):
            return hash("Insert")
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.InsertTargetVpnGatewayRequest.to_dict(request)
            transcoded_request = path_template.transcode(http_options, **request_kwargs)

            # Jsonify the request body
            body = compute.TargetVpnGateway.to_json(
                compute.TargetVpnGateway(transcoded_request["body"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
            uri = transcoded_request["uri"]
            ...
            # Jsonify the query params
            query_params = json.loads(
                compute.InsertTargetVpnGatewayRequest.to_json(
    ...
    class _List(TargetVpnGatewaysRestStub):
        def __hash__(self):
            return hash("List")
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.ListTargetVpnGatewaysRequest.to_dict(request)
            transcoded_request = path_template.transcode(http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(
                compute.ListTargetVpnGatewaysRequest.to_json(
            ...
            # Return the response
            resp = compute.TargetVpnGatewayList.from_json(
                response.content, ignore_unknown_fields=True
            )

...
class TargetVpnGatewaysTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.TargetVpnGatewayAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[
            compute.TargetVpnGateway, typing.Awaitable[compute.TargetVpnGateway]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.TargetVpnGatewayList, typing.Awaitable[compute.TargetVpnGatewayList]
        ],
    ]:
        raise NotImplementedError()

...
class RegionTargetHttpsProxiesClient(metaclass=RegionTargetHttpsProxiesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionTargetHttpsProxiesClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or RegionTargetHttpsProxiesClient._get_api_endpoint(

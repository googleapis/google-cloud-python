...
class GlobalNetworkEndpointGroupsTransport(abc.ABC):
    ...
    def attach_network_endpoints(
        self,
    ) -> Callable[[compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def delete(self) -> Callable[[compute.DeleteGlobalNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def detach_network_endpoints(
        self,
    ) -> Callable[[compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(
        self,
    ) -> Callable[[compute.GetGlobalNetworkEndpointGroupRequest], Union[compute.NetworkEndpointGroup, Awaitable[compute.NetworkEndpointGroup]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertGlobalNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListGlobalNetworkEndpointGroupsRequest], Union[compute.NetworkEndpointGroupList, Awaitable[compute.NetworkEndpointGroupList]]
    ]:
        raise NotImplementedError()

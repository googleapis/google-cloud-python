...
from .transports.base import DEFAULT_CLIENT_INFO, GlobalNetworkEndpointGroupsTransport
from .transports.rest import GlobalNetworkEndpointGroupsRestTransport


class GlobalNetworkEndpointGroupsClientMeta(type):
    """Metaclass for the GlobalNetworkEndpointGroups client.
...
class GlobalNetworkEndpointGroupsClient(metaclass=GlobalNetworkEndpointGroupsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GlobalNetworkEndpointGroupsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> GlobalNetworkEndpointGroupsTransport:
        """Returns the transport used by the client instance.

        Returns:
            GlobalNetworkEndpointGroupsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = GlobalNetworkEndpointGroupsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = GlobalNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = GlobalNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GlobalNetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = GlobalNetworkEndpointGroupsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, GlobalNetworkEndpointGroupsTransport, Callable[..., GlobalNetworkEndpointGroupsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,GlobalNetworkEndpointGroupsTransport,Callable[..., GlobalNetworkEndpointGroupsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the GlobalNetworkEndpointGroupsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GlobalNetworkEndpointGroupsClient._read_environment_variables()
        self._client_cert_source = GlobalNetworkEndpointGroupsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = GlobalNetworkEndpointGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, GlobalNetworkEndpointGroupsTransport)
        if transport_provided:
            # transport is a GlobalNetworkEndpointGroupsTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or GlobalNetworkEndpointGroupsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GlobalNetworkEndpointGroupsTransport], Callable[..., GlobalNetworkEndpointGroupsTransport]] = (
                GlobalNetworkEndpointGroupsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GlobalNetworkEndpointGroupsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.GlobalNetworkEndpointGroupsClient`.",
                    extra={
    ...
    def attach_network_endpoints_unary(
        self,
        request: Optional[Union[compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        global_network_endpoint_groups_attach_endpoints_request_resource: Optional[compute.GlobalNetworkEndpointGroupsAttachEndpointsRequest] = None,
        ...
        flattened_params = [project, network_endpoint_group, global_network_endpoint_groups_attach_endpoints_request_resource]
        ...
        if not isinstance(request, compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest):
            request = compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest(request)
            ...
            if global_network_endpoint_groups_attach_endpoints_request_resource is not None:
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteGlobalNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1.DeleteGlobalNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                )
    ...
    def detach_network_endpoints_unary(
        self,
        request: Optional[Union[compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        global_network_endpoint_groups_detach_endpoints_request_resource: Optional[compute.GlobalNetworkEndpointGroupsDetachEndpointsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_detach_network_endpoints():
                ...
                # Initialize request argument(s)
                request = compute_v1.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                )
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, network_endpoint_group, global_network_endpoint_groups_detach_endpoints_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest):
            request = compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if network_endpoint_group is not None:
                request.network_endpoint_group = network_endpoint_group
            if global_network_endpoint_groups_detach_endpoints_request_resource is not None:
    ...
    def get(
        self,
        request: Optional[Union[compute.GetGlobalNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetGlobalNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                )
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetGlobalNetworkEndpointGroupRequest):
            request = compute.GetGlobalNetworkEndpointGroupRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertGlobalNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertGlobalNetworkEndpointGroupRequest(
                    project="project_value",
                )
    ...
    def list(
        self,
        request: Optional[Union[compute.ListGlobalNetworkEndpointGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListGlobalNetworkEndpointGroupsRequest(
                    project="project_value",
                )
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListGlobalNetworkEndpointGroupsRequest):
            request = compute.ListGlobalNetworkEndpointGroupsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def list_network_endpoints(
        self,
        request: Optional[Union[compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list_network_endpoints():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                )
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest):
            request = compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

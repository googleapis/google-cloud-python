...
class AcceleratorTypesTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.AcceleratorTypeAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[
            compute.AcceleratorType, typing.Awaitable[compute.AcceleratorType]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[
            compute.AcceleratorTypeList, typing.Awaitable[compute.AcceleratorTypeList]
        ],
    ]:
        raise NotImplementedError()

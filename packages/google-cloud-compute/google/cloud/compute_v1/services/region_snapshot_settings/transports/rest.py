        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionSnapshotSettingsRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionSnapshotSettingsClient.Get",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionSnapshotSettingsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionSnapshotSettings",
                        "rpcName": "Get",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionSnapshotSettingsClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionSnapshotSettings",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionSnapshotSettingsClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionSnapshotSettings",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
...
__all__ = ("RegionSnapshotSettingsRestTransport",)

...
class NodeTypesTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        typing.Union[
            ...
            typing.Awaitable[compute.NodeTypeAggregatedList],
        ],
    ]:
    ...
    def get(
        ...
        typing.Union[compute.NodeType, typing.Awaitable[compute.NodeType]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        typing.Union[compute.NodeTypeList, typing.Awaitable[compute.NodeTypeList]],
    ]:
        raise NotImplementedError()

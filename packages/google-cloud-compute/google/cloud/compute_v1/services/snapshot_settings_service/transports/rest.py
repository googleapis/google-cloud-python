...
from .rest_base import _BaseSnapshotSettingsServiceRestTransport
...
class SnapshotSettingsServiceRestInterceptor:
    """Interceptor for SnapshotSettingsService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the SnapshotSettingsServiceRestTransport.

    .. code-block:: python
        class MyCustomSnapshotSettingsServiceInterceptor(SnapshotSettingsServiceRestInterceptor):
        ...
        transport = SnapshotSettingsServiceRestTransport(interceptor=MyCustomSnapshotSettingsServiceInterceptor())
        client = SnapshotSettingsServiceClient(transport=transport)
    ...
    def post_get(self, response: compute.SnapshotSettings) -> compute.SnapshotSettings:
        ...
        after it is returned by the SnapshotSettingsService server but before
    ...
    def post_get_with_metadata(
        ...
        is returned by the SnapshotSettingsService server but before it is returned to user code.
...
class SnapshotSettingsServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: SnapshotSettingsServiceRestInterceptor


class SnapshotSettingsServiceRestTransport(_BaseSnapshotSettingsServiceRestTransport):
    """REST backend synchronous transport for SnapshotSettingsService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[SnapshotSettingsServiceRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[SnapshotSettingsServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.SnapshotSettingsServiceClient.Get",
                    extra={
            ...
            # Return the response
            resp = compute.SnapshotSettings()
            pb_resp = compute.SnapshotSettings.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.SnapshotSettingsServiceClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.SnapshotSettingsService",
                        "rpcName": "Get",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.SnapshotSettingsServiceClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.SnapshotSettingsService",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.SnapshotSettingsServiceClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.SnapshotSettingsService",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
...
__all__ = ("SnapshotSettingsServiceRestTransport",)

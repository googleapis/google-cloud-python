...
class BackendServicesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_effective_security_policies_with_metadata(
        self, response: compute.GetEffectiveSecurityPoliciesBackendServiceResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetEffectiveSecurityPoliciesBackendServiceResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_effective_security_policies
...
class BackendServicesRestTransport(_BaseBackendServicesRestTransport):
    ...
    class _GetEffectiveSecurityPolicies(_BaseBackendServicesRestTransport._BaseGetEffectiveSecurityPolicies, BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            pb_resp = compute.GetEffectiveSecurityPoliciesBackendServiceResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.GetEffectiveSecurityPoliciesBackendServiceResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    def get_effective_security_policies(
        self,
    ) -> Callable[[compute.GetEffectiveSecurityPoliciesBackendServiceRequest], compute.GetEffectiveSecurityPoliciesBackendServiceResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

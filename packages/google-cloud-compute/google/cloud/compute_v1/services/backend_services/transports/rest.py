    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomBackendServicesInterceptor(BackendServicesRestInterceptor):
            ...
            def pre_set_security_policy(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_set_security_policy(response):
                logging.log(f"Received response: {response}")
...
class BackendServicesRestTransport(BackendServicesTransport):
    ...
    _STUBS: Dict[str, BackendServicesRestStub] = {}
    ...
    class _AddSignedUrlKey(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.AddSignedUrlKeyBackendServiceRequest.to_dict(
                request
            )
    ...
    class _AggregatedList(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.AggregatedListBackendServicesRequest.to_dict(
                request
            )
            transcoded_request = path_template.transcode(http_options, **request_kwargs)
            ...
            # Return the response
            resp = compute.BackendServiceAggregatedList.from_json(
                response.content, ignore_unknown_fields=True
            )
    ...
    class _Get(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = compute.BackendService.from_json(
                response.content, ignore_unknown_fields=True
            )
    ...
    class _GetHealth(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = compute.BackendServiceGroupHealth.from_json(
                response.content, ignore_unknown_fields=True
            )
    ...
    class _List(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = compute.BackendServiceList.from_json(
                response.content, ignore_unknown_fields=True
            )
    ...
    class _SetEdgeSecurityPolicy(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.SetEdgeSecurityPolicyBackendServiceRequest.to_dict(
                request
            )
            transcoded_request = path_template.transcode(http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(
                compute.SetEdgeSecurityPolicyBackendServiceRequest.to_json(
    ...
    class _SetSecurityPolicy(BackendServicesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request_kwargs = compute.SetSecurityPolicyBackendServiceRequest.to_dict(
                request
            )
            transcoded_request = path_template.transcode(http_options, **request_kwargs)
    ...
    def set_security_policy(
        ...
        stub = self._STUBS.get("set_security_policy")
        if not stub:
            stub = self._STUBS["set_security_policy"] = self._SetSecurityPolicy(
                self._session, self._host, self._interceptor
            )

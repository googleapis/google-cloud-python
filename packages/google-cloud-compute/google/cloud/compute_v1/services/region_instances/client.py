...
class RegionInstancesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[RegionInstancesTransport]:
...
class RegionInstancesClient(metaclass=RegionInstancesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(transport, RegionInstancesTransport):
    ...
    def bulk_insert(
        self,
        request: compute.BulkInsertRegionInstanceRequest = None,
        *,
        project: str = None,
        region: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.BulkInsertRegionInstanceRequest):

...
class RegionInstancesClientMeta(type):
    """Metaclass for the RegionInstances client.
...
class RegionInstancesClient(metaclass=RegionInstancesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionInstancesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionInstancesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionInstancesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RegionInstancesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionInstancesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionInstancesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionInstancesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionInstancesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionInstancesTransport, Callable[..., RegionInstancesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionInstancesTransport,Callable[..., RegionInstancesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionInstancesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionInstancesClient._read_environment_variables()
        self._client_cert_source = RegionInstancesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionInstancesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionInstancesTransport)
        if transport_provided:
            # transport is a RegionInstancesTransport instance.
            ...
            self._transport = cast(RegionInstancesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RegionInstancesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionInstancesTransport], Callable[..., RegionInstancesTransport]] = (
                RegionInstancesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionInstancesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionInstancesClient`.",
                    extra={

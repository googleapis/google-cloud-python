...
class RegionInstancesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RegionInstancesTransport]]
...
class RegionInstancesClient(metaclass=RegionInstancesClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionInstancesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, RegionInstancesTransport, Callable[..., RegionInstancesTransport]
            ]
        ] = None,
        ...
        ) = RegionInstancesClient._read_environment_variables()
        self._client_cert_source = RegionInstancesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionInstancesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionInstancesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[RegionInstancesTransport], Callable[..., RegionInstancesTransport]
            ] = (

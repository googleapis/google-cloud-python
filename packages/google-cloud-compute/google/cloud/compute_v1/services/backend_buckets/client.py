...
class BackendBucketsClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[BackendBucketsTransport]]
    _transport_registry["rest"] = BackendBucketsRestTransport

    def get_transport_class(cls, label: str = None,) -> Type[BackendBucketsTransport]:
...
class BackendBucketsClient(metaclass=BackendBucketsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the backend buckets client.
        ...
        if isinstance(transport, BackendBucketsTransport):

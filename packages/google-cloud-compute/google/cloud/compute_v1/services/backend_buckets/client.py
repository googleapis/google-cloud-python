...
class BackendBucketsClient(metaclass=BackendBucketsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BackendBucketsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, BackendBucketsTransport, Callable[..., BackendBucketsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BackendBucketsClient._read_environment_variables()
        self._client_cert_source = BackendBucketsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BackendBucketsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or BackendBucketsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BackendBucketsTransport], Callable[..., BackendBucketsTransport]] = (
    ...
    def add_signed_url_key_unary(
        self,
        request: Optional[Union[compute.AddSignedUrlKeyBackendBucketRequest, dict]] = None,
        *,
    ...
    def delete_signed_url_key_unary(
        self,
        request: Optional[Union[compute.DeleteSignedUrlKeyBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
    ...
    def set_edge_security_policy_unary(
        self,
        request: Optional[Union[compute.SetEdgeSecurityPolicyBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,

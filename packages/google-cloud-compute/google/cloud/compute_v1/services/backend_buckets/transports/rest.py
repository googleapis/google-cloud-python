        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.BackendBucketsClient.AggregatedList",
                    extra={
                        "serviceName": "google.cloud.compute.v1.BackendBuckets",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.BackendBucketsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.BackendBuckets",
                        "rpcName": "AggregatedList",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.BackendBucketsClient.ListUsable",
                    extra={
                        "serviceName": "google.cloud.compute.v1.BackendBuckets",
                        "rpcName": "ListUsable",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.BackendBucketsClient.list_usable",
                    extra={
                        "serviceName": "google.cloud.compute.v1.BackendBuckets",
                        "rpcName": "ListUsable",
                        "metadata": http_response["headers"],

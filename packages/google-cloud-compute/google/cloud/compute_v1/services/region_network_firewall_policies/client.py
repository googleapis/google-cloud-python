...
class RegionNetworkFirewallPoliciesClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, RegionNetworkFirewallPoliciesTransport, None] = None,
        ...
        if isinstance(transport, RegionNetworkFirewallPoliciesTransport):
    ...
    def set_iam_policy(
        self,
        request: Union[
            compute.SetIamPolicyRegionNetworkFirewallPolicyRequest, dict
        ] = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def test_iam_permissions(
        self,
        request: Union[
            compute.TestIamPermissionsRegionNetworkFirewallPolicyRequest, dict
        ] = None,
        *,
        project: str = None,
        region: str = None,

...
class ResourcePoliciesRestTransport(ResourcePoliciesTransport):
    ...
    def _aggregated_list(
        ...
        *,
        ...
        request_kwargs = compute.AggregatedListResourcePoliciesRequest.to_dict(request)
        ...
        *,
        ...
        query_params = json.loads(
            compute.DeleteResourcePolicyRequest.to_json(
                compute.DeleteResourcePolicyRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )
        ...
        *,
        ...
        query_params = json.loads(
            compute.GetResourcePolicyRequest.to_json(
                compute.GetResourcePolicyRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )
        ...
        *,
        ...
        query_params = json.loads(
            compute.InsertResourcePolicyRequest.to_json(
                compute.InsertResourcePolicyRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )
        ...
        *,
        ...
        query_params = json.loads(
            compute.ListResourcePoliciesRequest.to_json(
                compute.ListResourcePoliciesRequest(transcoded_request["query_params"]),
                including_default_value_fields=False,
                use_integers_for_enums=False,
            )
        )

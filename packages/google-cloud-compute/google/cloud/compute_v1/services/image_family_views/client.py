...
from .transports.base import ImageFamilyViewsTransport, DEFAULT_CLIENT_INFO
...
class ImageFamilyViewsClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ImageFamilyViewsTransport]]
    _transport_registry["rest"] = ImageFamilyViewsRestTransport

    def get_transport_class(cls, label: str = None,) -> Type[ImageFamilyViewsTransport]:
...
class ImageFamilyViewsClient(metaclass=ImageFamilyViewsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Union[str, ImageFamilyViewsTransport]): The
        ...
        if isinstance(transport, ImageFamilyViewsTransport):
    ...
    def get(
        self,
        request: compute.GetImageFamilyViewRequest = None,
        *,
        project: str = None,
        zone: str = None,
        family: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.GetImageFamilyViewRequest):
        ...
        # in a compute.GetImageFamilyViewRequest.

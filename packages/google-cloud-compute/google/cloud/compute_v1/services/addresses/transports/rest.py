...
class AddressesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_aggregated_list(
        self, request: compute.AggregatedListAddressesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.AggregatedListAddressesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list(self, response: compute.AddressAggregatedList) -> compute.AddressAggregatedList:
    ...
    def post_aggregated_list_with_metadata(
        self, response: compute.AddressAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_delete(
        self, request: compute.DeleteAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_get(
        self, request: compute.GetAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_insert(
        self, request: compute.InsertAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_list(
        self, request: compute.ListAddressesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_move(
        self, request: compute.MoveAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_set_labels(
        self, request: compute.SetLabelsAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.SetLabelsAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class AddressesRestTransport(_BaseAddressesRestTransport):
    ...
    class _AggregatedList(_BaseAddressesRestTransport._BaseAggregatedList, AddressesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseAddressesRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseAddressesRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
    ...
    class _Delete(_BaseAddressesRestTransport._BaseDelete, AddressesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAddressesRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = AddressesRestTransport._Delete._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Get(_BaseAddressesRestTransport._BaseGet, AddressesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAddressesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = AddressesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Insert(_BaseAddressesRestTransport._BaseInsert, AddressesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAddressesRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseAddressesRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseInsert._get_query_params_json(transcoded_request)
    ...
    class _List(_BaseAddressesRestTransport._BaseList, AddressesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAddressesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = AddressesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _Move(_BaseAddressesRestTransport._BaseMove, AddressesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAddressesRestTransport._BaseMove._get_transcoded_request(http_options, request)

            body = _BaseAddressesRestTransport._BaseMove._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseMove._get_query_params_json(transcoded_request)
    ...
    class _SetLabels(_BaseAddressesRestTransport._BaseSetLabels, AddressesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseAddressesRestTransport._BaseSetLabels._get_http_options()

            request, metadata = self._interceptor.pre_set_labels(request, metadata)
            transcoded_request = _BaseAddressesRestTransport._BaseSetLabels._get_transcoded_request(http_options, request)

            body = _BaseAddressesRestTransport._BaseSetLabels._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseSetLabels._get_query_params_json(transcoded_request)
    ...
    class _TestIamPermissions(_BaseAddressesRestTransport._BaseTestIamPermissions, AddressesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseAddressesRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseAddressesRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseAddressesRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseAddressesRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
    ...
    @property
    def aggregated_list(self) -> Callable[[compute.AggregatedListAddressesRequest], compute.AddressAggregatedList]:
    ...
    @property
    def set_labels(self) -> Callable[[compute.SetLabelsAddressRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._SetLabels(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsAddressRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
def sample_delete():
    # Create a client
    client = compute_v1.RegionHealthAggregationPoliciesClient()

    # Initialize request argument(s)
    request = compute_v1.DeleteRegionHealthAggregationPolicyRequest(
        health_aggregation_policy="health_aggregation_policy_value",

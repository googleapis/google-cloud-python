...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-orchestration-airflow``. The
...
instead of
``https://github.com/googleapis/python-orchestration-airflow/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-orchestration-airflow/blob/main/noxfile.py

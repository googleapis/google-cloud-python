        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "put",
                    "uri": "/v1beta1/{user_workloads_config_map.name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}",
                    "body": "user_workloads_config_map",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "put",
                    "uri": "/v1beta1/{user_workloads_secret.name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}",
                    "body": "user_workloads_secret",
                },
            ]

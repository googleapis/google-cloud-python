...
from google.cloud.orchestration.airflow.service_v1.services.image_versions.transports.base import (
...
def test_image_versions_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ImageVersionsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "false"}):
        assert ImageVersionsClient._read_environment_variables() == (
            False,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ImageVersionsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ImageVersionsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ImageVersionsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        ImageVersionsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ImageVersionsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ImageVersionsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ImageVersionsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ImageVersionsClient),
)
@mock.patch.object(
    ImageVersionsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ImageVersionsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ImageVersionsClient._DEFAULT_UNIVERSE
    default_endpoint = ImageVersionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ImageVersionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ImageVersionsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ImageVersionsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ImageVersionsClient._get_api_endpoint(None, None, default_universe, "always")
        == ImageVersionsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ImageVersionsClient._get_api_endpoint(
    ...
    assert (
        ImageVersionsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ImageVersionsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ImageVersionsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ImageVersionsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ImageVersionsClient._get_universe_domain(None, None)
        == ImageVersionsClient._DEFAULT_UNIVERSE
    )
...
def test_list_image_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_image_versions in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.list_image_versions] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_image_versions_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_image_versions
...
def test_list_image_versions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ImageVersionsRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = image_versions.ListImageVersionsResponse.to_json(
            image_versions.ListImageVersionsResponse()
        )

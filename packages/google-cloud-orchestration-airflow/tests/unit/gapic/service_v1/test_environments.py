...
from google.cloud.orchestration.airflow.service_v1.services.environments import EnvironmentsAsyncClient, EnvironmentsClient, pagers, transports
...
def test_update_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{user_workloads_secret.name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1]
        )
...
def test_create_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/environments/*}/userWorkloadsConfigMaps" % client.transport._host, args[1]
        )
...
def test_get_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1]
        )
...
def test_update_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{user_workloads_config_map.name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1]
        )

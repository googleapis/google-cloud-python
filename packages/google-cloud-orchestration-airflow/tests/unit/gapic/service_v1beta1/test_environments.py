...
from google.cloud.orchestration.airflow.service_v1beta1.services.environments.transports.base import (
...
def test_restart_web_server(
    transport: str = "grpc", request_type=environments.RestartWebServerRequest
):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_check_upgrade(
    transport: str = "grpc", request_type=environments.CheckUpgradeRequest
):
    client = EnvironmentsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )

...
from google.cloud.orchestration.airflow.service_v1beta1.services.environments import EnvironmentsAsyncClient, EnvironmentsClient, pagers, transports
...
def test_environments_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "composer.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://composer.googleapis.com"
        )
...
def test_list_workloads_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_workloads), "__call__") as call:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, environments.ListWorkloadsResponse.ComposerWorkload) for i in results)
...
async def test_list_workloads_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_workloads), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        assert len(responses) == 6
        assert all(isinstance(i, environments.ListWorkloadsResponse.ComposerWorkload) for i in responses)
...
def test_create_user_workloads_secret(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_user_workloads_secret), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_user_workloads_secrets(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_user_workloads_secrets), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_user_workloads_secrets_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_user_workloads_secrets), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            environments.ListUserWorkloadsSecretsResponse(
                user_workloads_secrets=[
...
async def test_list_user_workloads_secrets_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_user_workloads_secrets), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_user_workloads_secrets(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_user_workloads_config_map(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_user_workloads_config_map), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_get_user_workloads_config_map(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_user_workloads_config_map), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = environments.UserWorkloadsConfigMap(
            name="name_value",
        )
...
async def test_list_user_workloads_config_maps_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_user_workloads_config_maps), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            environments.ListUserWorkloadsConfigMapsResponse(
                user_workloads_config_maps=[
        ...
        assert len(responses) == 6
        assert all(isinstance(i, environments.UserWorkloadsConfigMap) for i in responses)
...
async def test_list_user_workloads_config_maps_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_user_workloads_config_maps), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_user_workloads_config_maps(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_user_workloads_config_map(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_user_workloads_config_map), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = environments.UserWorkloadsConfigMap(
            name="name_value",
        )
...
def test_fetch_database_properties(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_database_properties), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_user_workloads_secret_rest_required_fields(request_type=environments.CreateUserWorkloadsSecretRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_user_workloads_secret._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*/environments/*}/userWorkloadsSecrets" % client.transport._host, args[1]
        )
...
def test_get_user_workloads_secret_rest_required_fields(request_type=environments.GetUserWorkloadsSecretRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_user_workloads_secret._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1]
        )
...
def test_list_user_workloads_secrets_rest_required_fields(request_type=environments.ListUserWorkloadsSecretsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_user_workloads_secrets._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_user_workloads_secret_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{user_workloads_secret.name=projects/*/locations/*/environments/*/userWorkloadsSecrets/*}" % client.transport._host, args[1]
        )
...
def test_delete_user_workloads_secret_rest_required_fields(request_type=environments.DeleteUserWorkloadsSecretRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_user_workloads_secret._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_config_map_rest_required_fields(request_type=environments.CreateUserWorkloadsConfigMapRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_user_workloads_config_map._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*/environments/*}/userWorkloadsConfigMaps" % client.transport._host, args[1]
        )
...
def test_get_user_workloads_config_map_rest_required_fields(request_type=environments.GetUserWorkloadsConfigMapRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_user_workloads_config_map._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host, args[1]
        )
...
def test_list_user_workloads_config_maps_rest_required_fields(request_type=environments.ListUserWorkloadsConfigMapsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_user_workloads_config_maps._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_user_workloads_config_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "user_workloads_config_map": {"name": "projects/sample1/locations/sample2/environments/sample3/userWorkloadsConfigMaps/sample4"}
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{user_workloads_config_map.name=projects/*/locations/*/environments/*/userWorkloadsConfigMaps/*}" % client.transport._host,
            args[1],
        )
...
def test_delete_user_workloads_config_map_rest_required_fields(request_type=environments.DeleteUserWorkloadsConfigMapRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_user_workloads_config_map._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_fetch_database_properties_rest_required_fields(request_type=environments.FetchDatabasePropertiesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_database_properties._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_environment_rest_call_success(request_type):
    ...
    request_init["environment"] = {
        ...
        "config": {
            ...
            "web_server_network_access_control": {"allowed_ip_ranges": [{"value": "value_value", "description": "description_value"}]},
            "database_config": {"machine_type": "machine_type_value", "zone": "zone_value"},
            ...
            "maintenance_window": {"start_time": {"seconds": 751, "nanos": 543}, "end_time": {}, "recurrence": "recurrence_value"},
            "workloads_config": {
                "scheduler": {"cpu": 0.328, "memory_gb": 0.961, "storage_gb": 0.1053, "count": 553},
                "web_server": {"cpu": 0.328, "memory_gb": 0.961, "storage_gb": 0.1053},
                "worker": {"cpu": 0.328, "memory_gb": 0.961, "storage_gb": 0.1053, "min_count": 972, "max_count": 974},
                "triggerer": {"count": 553, "cpu": 0.328, "memory_gb": 0.961},
                "dag_processor": {"cpu": 0.328, "memory_gb": 0.961, "storage_gb": 0.1053, "count": 553},
            },
            "environment_size": 1,
            "master_authorized_networks_config": {
                "enabled": True,
                "cidr_blocks": [{"display_name": "display_name_value", "cidr_block": "cidr_block_value"}],
            },
            "recovery_config": {
            ...
            "data_retention_config": {
                ...
                "airflow_metadata_retention_config": {"retention_mode": 1, "retention_days": 1512},
            },
            "resilience_mode": 1,
        },
        "uuid": "uuid_value",
...
def test_restart_web_server_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EnvironmentsRestInterceptor, "post_restart_web_server_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_execute_airflow_command_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_execute_airflow_command") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_execute_airflow_command_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_stop_airflow_command_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_stop_airflow_command") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_stop_airflow_command_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_poll_airflow_command_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_poll_airflow_command") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_poll_airflow_command_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_workloads") as post, mock.patch.object(
...
def test_create_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_user_workloads_secret") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_create_user_workloads_secret_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_user_workloads_secret") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_get_user_workloads_secret_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_user_workloads_secrets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_user_workloads_secrets") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_list_user_workloads_secrets_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_user_workloads_secret") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_update_user_workloads_secret_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_user_workloads_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_delete_user_workloads_secret") as pre:
        pre.assert_not_called()
...
def test_create_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_create_user_workloads_config_map") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_create_user_workloads_config_map_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_get_user_workloads_config_map") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_get_user_workloads_config_map_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_user_workloads_config_maps_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_list_user_workloads_config_maps") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_list_user_workloads_config_maps_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_update_user_workloads_config_map") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_update_user_workloads_config_map_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_user_workloads_config_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "pre_delete_user_workloads_config_map") as pre:
        pre.assert_not_called()
...
def test_fetch_database_properties_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EnvironmentsRestInterceptor, "post_fetch_database_properties") as post, mock.patch.object(
        transports.EnvironmentsRestInterceptor, "post_fetch_database_properties_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_environments_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "composer.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://composer.googleapis.com:8000"
    )

...
def test__get_default_mtls_endpoint():
    ...
    assert AccountLimitsServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert AccountLimitsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert AccountLimitsServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert AccountLimitsServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert AccountLimitsServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert AccountLimitsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AccountLimitsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AccountLimitsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AccountLimitsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AccountLimitsServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AccountLimitsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AccountLimitsServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AccountLimitsServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert AccountLimitsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AccountLimitsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert AccountLimitsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AccountLimitsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(AccountLimitsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AccountLimitsServiceClient))
@mock.patch.object(AccountLimitsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AccountLimitsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AccountLimitsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AccountLimitsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AccountLimitsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AccountLimitsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        AccountLimitsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == AccountLimitsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert AccountLimitsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AccountLimitsServiceClient._get_api_endpoint(None, None, default_universe, "always") == AccountLimitsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        AccountLimitsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AccountLimitsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert AccountLimitsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AccountLimitsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AccountLimitsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AccountLimitsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AccountLimitsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AccountLimitsServiceClient._get_universe_domain(None, None) == AccountLimitsServiceClient._DEFAULT_UNIVERSE
...
def test_account_limits_service_client_from_service_account_info(client_class, transport_name):
...
def test_account_limits_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_account_limits_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (AccountLimitsServiceClient, transports.AccountLimitsServiceGrpcTransport, "grpc"),
        (AccountLimitsServiceAsyncClient, transports.AccountLimitsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (AccountLimitsServiceClient, transports.AccountLimitsServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(AccountLimitsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AccountLimitsServiceClient))
@mock.patch.object(AccountLimitsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AccountLimitsServiceAsyncClient))
def test_account_limits_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (AccountLimitsServiceClient, transports.AccountLimitsServiceGrpcTransport, "grpc", "true"),
        (AccountLimitsServiceAsyncClient, transports.AccountLimitsServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (AccountLimitsServiceClient, transports.AccountLimitsServiceGrpcTransport, "grpc", "false"),
        (AccountLimitsServiceAsyncClient, transports.AccountLimitsServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (AccountLimitsServiceClient, transports.AccountLimitsServiceRestTransport, "rest", "true"),
        (AccountLimitsServiceClient, transports.AccountLimitsServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(AccountLimitsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AccountLimitsServiceClient))
@mock.patch.object(AccountLimitsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AccountLimitsServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_account_limits_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [AccountLimitsServiceClient, AccountLimitsServiceAsyncClient])
@mock.patch.object(AccountLimitsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AccountLimitsServiceClient))
@mock.patch.object(AccountLimitsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AccountLimitsServiceAsyncClient))
...
def test_account_limits_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (AccountLimitsServiceClient, transports.AccountLimitsServiceGrpcTransport, "grpc", grpc_helpers),
        (AccountLimitsServiceAsyncClient, transports.AccountLimitsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (AccountLimitsServiceClient, transports.AccountLimitsServiceRestTransport, "rest", None),
    ],
)
def test_account_limits_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_account_limits_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = AccountLimitsServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_account_limits_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_account_limit(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_account_limit), "__call__") as call:
...
def test_get_account_limit_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_account_limit] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_account_limit_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_account_limit in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_account_limit] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_account_limit_async(transport: str = "grpc_asyncio", request_type=accountlimits.GetAccountLimitRequest):
    client = AccountLimitsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_account_limit_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_account_limit), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(accountlimits.AccountLimit())
        await client.get_account_limit(request)
...
def test_list_account_limits(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_account_limits), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_account_limits_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_account_limits in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_account_limits] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_account_limits_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AccountLimitsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_account_limits in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_account_limits] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_account_limits_async(transport: str = "grpc_asyncio", request_type=accountlimits.ListAccountLimitsRequest):
    client = AccountLimitsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_account_limits_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_account_limits), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(accountlimits.ListAccountLimitsResponse())
        await client.list_account_limits(request)
...
async def test_list_account_limits_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_account_limits), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            accountlimits.ListAccountLimitsResponse(
                account_limits=[
...
async def test_list_account_limits_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_account_limits), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_account_limits(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_account_limit_rest_required_fields(request_type=accountlimits.GetAccountLimitRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_account_limit._get_unset_required_fields(jsonified_request)
...
def test_get_account_limit_rest_unset_required_fields():
    transport = transports.AccountLimitsServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_account_limit_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/accounts/v1/{name=accounts/*/limits/*}" % client.transport._host, args[1])
...
def test_list_account_limits_rest_required_fields(request_type=accountlimits.ListAccountLimitsRequest):
    transport_class = transports.AccountLimitsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_account_limits._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_account_limits_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{parent=accounts/*}/limits" % client.transport._host, args[1])
...
def test_list_account_limits_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(accountlimits.ListAccountLimitsResponse.to_json(x) for x in response)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = AccountLimitsServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = AccountLimitsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = AccountLimitsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = AccountLimitsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AccountLimitsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AccountLimitsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_account_limit_rest_bad_request(request_type=accountlimits.GetAccountLimitRequest):
    client = AccountLimitsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_account_limit_rest_interceptors(null_interceptor):
    transport = transports.AccountLimitsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AccountLimitsServiceRestInterceptor(),
    )
    client = AccountLimitsServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AccountLimitsServiceRestInterceptor, "post_get_account_limit") as post, mock.patch.object(
        transports.AccountLimitsServiceRestInterceptor, "post_get_account_limit_with_metadata"
        ...
        pb_message = accountlimits.GetAccountLimitRequest.pb(accountlimits.GetAccountLimitRequest())
...
def test_list_account_limits_rest_bad_request(request_type=accountlimits.ListAccountLimitsRequest):
    client = AccountLimitsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_account_limits_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AccountLimitsServiceRestInterceptor, "post_list_account_limits") as post, mock.patch.object(
        transports.AccountLimitsServiceRestInterceptor, "post_list_account_limits_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = accountlimits.ListAccountLimitsRequest.pb(accountlimits.ListAccountLimitsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = accountlimits.ListAccountLimitsResponse.to_json(accountlimits.ListAccountLimitsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = accountlimits.ListAccountLimitsResponse(), metadata
...
def test_account_limits_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.AccountLimitsServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.AccountLimitsServiceGrpcTransport, grpc_helpers), (transports.AccountLimitsServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.AccountLimitsServiceGrpcTransport, transports.AccountLimitsServiceGrpcAsyncIOTransport])
def test_account_limits_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_account_limits_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.AccountLimitsServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.AccountLimitsServiceGrpcTransport, transports.AccountLimitsServiceGrpcAsyncIOTransport])
def test_account_limits_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.AccountLimitsServiceTransport, "_prep_wrapped_messages") as prep:
        client = AccountLimitsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = AccountLimitsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (AccountLimitsServiceAsyncClient, transports.AccountLimitsServiceGrpcAsyncIOTransport),
    ],
)

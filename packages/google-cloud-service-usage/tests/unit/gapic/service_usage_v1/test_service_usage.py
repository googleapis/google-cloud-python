...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ServiceUsageClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert ServiceUsageClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ServiceUsageClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ServiceUsageClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ServiceUsageClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        ServiceUsageClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ServiceUsageClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ServiceUsageClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ServiceUsageClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ServiceUsageClient),
)
@mock.patch.object(
    ServiceUsageAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ServiceUsageAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServiceUsageClient._DEFAULT_UNIVERSE
    default_endpoint = ServiceUsageClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ServiceUsageClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ServiceUsageClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ServiceUsageClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ServiceUsageClient._get_api_endpoint(None, None, default_universe, "always")
        == ServiceUsageClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ServiceUsageClient._get_api_endpoint(
    ...
    assert (
        ServiceUsageClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ServiceUsageClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ServiceUsageClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ServiceUsageClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ServiceUsageClient._get_universe_domain(None, None)
        == ServiceUsageClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_enable_service_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.enable_service
...
async def test_enable_service_async(request_type, transport: str = "grpc_asyncio"):
    client = ServiceUsageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_disable_service_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.disable_service
            in client._client._transport._wrapped_methods
        )
...
async def test_disable_service_async(request_type, transport: str = "grpc_asyncio"):
    client = ServiceUsageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_enable_services_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_enable_services
        ...
        client._transport._wrapped_methods[client._transport.batch_enable_services] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_batch_enable_services_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_enable_services
            in client._client._transport._wrapped_methods
        )
...
def test_batch_get_services_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_get_services in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.batch_get_services] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_batch_get_services_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_get_services
            in client._client._transport._wrapped_methods
        )
...
async def test_batch_get_services_async(request_type, transport: str = "grpc_asyncio"):
    client = ServiceUsageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_disable_service_rest_bad_request(
    request_type=serviceusage.DisableServiceRequest,
):
    client = ServiceUsageClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = serviceusage.ListServicesResponse.to_json(
            serviceusage.ListServicesResponse()
        )
        req.return_value.content = return_value
...
def test_batch_get_services_rest_bad_request(
    request_type=serviceusage.BatchGetServicesRequest,
):
    client = ServiceUsageClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_batch_get_services_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = serviceusage.BatchGetServicesResponse.to_json(
            serviceusage.BatchGetServicesResponse()
        )
        req.return_value.content = return_value

...
class ServiceUsageAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ServiceUsageClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = ServiceUsageClient._DEFAULT_UNIVERSE

    service_path = staticmethod(ServiceUsageClient.service_path)
    parse_service_path = staticmethod(ServiceUsageClient.parse_service_path)
    ...
    get_transport_class = ServiceUsageClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, ServiceUsageTransport, Callable[..., ServiceUsageTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.api.serviceusage_v1.ServiceUsageAsyncClient`.",
                extra={
    ...
    async def enable_service(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.enable_service]
    ...
    async def disable_service(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.disable_service]
    ...
    async def batch_enable_services(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_enable_services]
    ...
    async def batch_get_services(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_get_services]

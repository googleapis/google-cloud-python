...
class ServiceUsageAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ServiceUsageClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ServiceUsageAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ServiceUsageClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ServiceUsageAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_disable_service():
                ...
                # Make the request
                operation = await client.disable_service(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_batch_enable_services():
                ...
                # Make the request
                operation = await client.batch_enable_services(request=request)

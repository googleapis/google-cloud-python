...
class ServiceUsageGrpcAsyncIOTransport(ServiceUsageTransport):
    ...
    @property
    def enable_service(self) -> Callable[[serviceusage.EnableServiceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def disable_service(self) -> Callable[[serviceusage.DisableServiceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_service(self) -> Callable[[serviceusage.GetServiceRequest], Awaitable[resources.Service]]:
    ...
    @property
    def list_services(self) -> Callable[[serviceusage.ListServicesRequest], Awaitable[serviceusage.ListServicesResponse]]:
    ...
    @property
    def batch_enable_services(self) -> Callable[[serviceusage.BatchEnableServicesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def batch_get_services(self) -> Callable[[serviceusage.BatchGetServicesRequest], Awaitable[serviceusage.BatchGetServicesResponse]]:

...
class ServiceUsageClient(metaclass=ServiceUsageClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ServiceUsageTransport, Callable[..., ServiceUsageTransport]]] = None,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ServiceUsageTransport], Callable[..., ServiceUsageTransport]] = (

...
from google.cloud.run_v2.services.tasks import (
    TasksAsyncClient,
    TasksClient,
    pagers,
    transports,
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TasksClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    )
    assert (
        TasksClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        TasksClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert TasksClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TasksClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TasksClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                TasksClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        TasksClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TasksClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TasksClient),
)
@mock.patch.object(
    TasksAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(TasksAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TasksClient._DEFAULT_UNIVERSE
    default_endpoint = TasksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TasksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == TasksClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TasksClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TasksClient._get_api_endpoint(None, None, default_universe, "always")
        == TasksClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TasksClient._get_api_endpoint(
    ...
    assert (
        TasksClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TasksClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TasksClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        TasksClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TasksClient(credentials=cred)
...
def test_tasks_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [TasksClient, TasksAsyncClient])
@mock.patch.object(
    TasksClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TasksClient)
)
@mock.patch.object(
    TasksAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TasksAsyncClient)
)
...
def test_tasks_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_tasks_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_tasks_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.run_v2.services.tasks.transports.TasksGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = TasksClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_tasks_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_get_task_async(
    transport: str = "grpc_asyncio", request_type=task.GetTaskRequest
):
    client = TasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_list_tasks_async(
    transport: str = "grpc_asyncio", request_type=task.ListTasksRequest
):
    client = TasksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_get_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {
            "name": "projects/sample1/locations/sample2/jobs/sample3/executions/sample4/tasks/sample5"
        }
        ...
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/jobs/*/executions/*/tasks/*}"
...
def test_list_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "parent": "projects/sample1/locations/sample2/jobs/sample3/executions/sample4"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*/jobs/*/executions/*}/tasks"
            % client.transport._host,
            args[1],
        )
...
def test_get_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.TasksRestInterceptor, "post_get_task"
    ) as post, mock.patch.object(
        transports.TasksRestInterceptor, "post_get_task_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TasksRestInterceptor, "pre_get_task"
    ) as pre:
...
def test_list_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.TasksRestInterceptor, "post_list_tasks"
    ) as post, mock.patch.object(
        transports.TasksRestInterceptor, "post_list_tasks_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TasksRestInterceptor, "pre_list_tasks"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        post_with_metadata.return_value = task.ListTasksResponse(), metadata
...
def test_tasks_base_transport():
    ...
    with mock.patch(
        "google.cloud.run_v2.services.tasks.transports.TasksTransport.__init__"
    ) as Transport:
...
def test_tasks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.run_v2.services.tasks.transports.TasksTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    "transport_class",
    [transports.TasksGrpcTransport, transports.TasksGrpcAsyncIOTransport],
)
def test_tasks_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_tasks_transport_channel_mtls_with_client_cert_source(transport_class):
    with mock.patch(
...
def test_tasks_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_execution_path():
    ...
    expected = "projects/{project}/locations/{location}/jobs/{job}/executions/{execution}".format(
        project=project,
        location=location,
        job=job,
        execution=execution,
...
def test_task_path():
    ...
    execution = "nudibranch"
    task = "cuttlefish"
    expected = "projects/{project}/locations/{location}/jobs/{job}/executions/{execution}/tasks/{task}".format(
        project=project,
        location=location,
        job=job,
        execution=execution,

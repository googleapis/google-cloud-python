...
@pytest.mark.parametrize(
    ...
    [(ServicesClient, "grpc"), (ServicesAsyncClient, "grpc_asyncio"),],
)
...
@pytest.mark.parametrize("request_type", [gcr_service.CreateServiceRequest, dict,])
...
@pytest.mark.parametrize("request_type", [service.GetServiceRequest, dict,])
...
def test_get_service_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.get_service(
            service.GetServiceRequest(), name="name_value",
        )
...
@pytest.mark.parametrize("request_type", [service.ListServicesRequest, dict,])
...
async def test_list_services_async(
    ...
    with mock.patch.object(type(client.transport.list_services), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            service.ListServicesResponse(next_page_token="next_page_token_value",)
        )
...
def test_list_services_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_services(
            service.ListServicesRequest(), parent="parent_value",
        )
...
def test_list_services_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_services), "__call__") as call:
        ...
        call.side_effect = (
            ...
            service.ListServicesResponse(services=[], next_page_token="def",),
            service.ListServicesResponse(
...
@pytest.mark.parametrize("request_type", [gcr_service.UpdateServiceRequest, dict,])
...
@pytest.mark.parametrize("request_type", [service.DeleteServiceRequest, dict,])
...
def test_delete_service_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.delete_service(
            service.DeleteServiceRequest(), name="name_value",
        )

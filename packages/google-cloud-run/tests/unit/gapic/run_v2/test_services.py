...
def test_create_service_rest_required_fields(
    request_type=gcr_service.CreateServiceRequest,
):
...
def test_create_service_rest_bad_request(
    transport: str = "rest", request_type=gcr_service.CreateServiceRequest
):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
...
def test_create_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*}/services" % client.transport._host,
            args[1],
        )
...
def test_get_service_rest_bad_request(
    transport: str = "rest", request_type=service.GetServiceRequest
):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
...
def test_get_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/services/*}" % client.transport._host,
            args[1],
        )
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListServicesResponse.to_json(
            service.ListServicesResponse()
        )
...
def test_list_services_rest_bad_request(
    transport: str = "rest", request_type=service.ListServicesRequest
):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
...
def test_update_service_rest_required_fields(
    request_type=gcr_service.UpdateServiceRequest,
):
    transport_class = transports.ServicesRestTransport
...
def test_update_service_rest_bad_request(
    transport: str = "rest", request_type=gcr_service.UpdateServiceRequest
):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
...
def test_update_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{service.name=projects/*/locations/*/services/*}"
...
def test_delete_service_rest_bad_request(
    transport: str = "rest", request_type=service.DeleteServiceRequest
):
    client = ServicesClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,

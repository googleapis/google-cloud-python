...
from google.cloud.run_v2.services.instances import (
...
@mock.patch.object(
    InstancesAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(InstancesAsyncClient),
)
...
def test_instances_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.run_v2.services.instances.transports.InstancesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_instance_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.create_instance), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == gcr_instance.CreateInstanceRequest(
            parent="parent_value",
            instance_id="instance_id_value",
        )
...
async def test_create_instance_async(
    transport: str = "grpc_asyncio", request_type=gcr_instance.CreateInstanceRequest
):
    client = InstancesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.create_instance), "__call__") as call:
        ...
        client.create_instance(
            parent="parent_value",
            instance=gcr_instance.Instance(name="name_value"),
        )
...
def test_create_instance_rest_required_fields(
    request_type=gcr_instance.CreateInstanceRequest,
):
...
def test_create_instance_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_instance), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcr_instance.CreateInstanceRequest()
...
def test_create_instance_routing_parameters_request_1_grpc():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_delete_instance_routing_parameters_request_1_grpc():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_get_instance_routing_parameters_request_1_grpc():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_list_instances_routing_parameters_request_1_grpc():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
@pytest.mark.asyncio
async def test_create_instance_routing_parameters_request_1_grpc_asyncio():
    client = InstancesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
@pytest.mark.asyncio
async def test_delete_instance_routing_parameters_request_1_grpc_asyncio():
    client = InstancesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
@pytest.mark.asyncio
async def test_get_instance_routing_parameters_request_1_grpc_asyncio():
    client = InstancesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
@pytest.mark.asyncio
async def test_list_instances_routing_parameters_request_1_grpc_asyncio():
    client = InstancesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_create_instance_rest_call_success(request_type):
    ...
    request_init["instance"] = {
        ...
        "volumes": [
            {
                ...
                "secret": {
                    "secret": "secret_value",
                    "items": [
                        {"path": "path_value", "version": "version_value", "mode": 421}
                    ],
                    "default_mode": 1257,
                },
                "cloud_sql_instance": {
        ...
        "conditions": {},
        "container_statuses": [
            {"name": "name_value", "image_digest": "image_digest_value"}
        ],
        "satisfies_pzs": True,
    ...
    test_field = gcr_instance.CreateInstanceRequest.meta.fields["instance"]
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.InstancesRestInterceptor, "post_create_instance"
    ) as post, mock.patch.object(
        transports.InstancesRestInterceptor, "post_create_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InstancesRestInterceptor, "pre_create_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcr_instance.CreateInstanceRequest.pb(
            gcr_instance.CreateInstanceRequest()
        )
...
def test_stop_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.InstancesRestInterceptor, "post_stop_instance"
    ) as post, mock.patch.object(
        transports.InstancesRestInterceptor, "post_stop_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InstancesRestInterceptor, "pre_stop_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_start_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.InstancesRestInterceptor, "post_start_instance"
    ) as post, mock.patch.object(
        transports.InstancesRestInterceptor, "post_start_instance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InstancesRestInterceptor, "pre_start_instance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_instance_routing_parameters_request_1_rest():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_instance_routing_parameters_request_1_rest():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_instance_routing_parameters_request_1_rest():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_instances_routing_parameters_request_1_rest():
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_instances_base_transport():
    ...
    with mock.patch(
        "google.cloud.run_v2.services.instances.transports.InstancesTransport.__init__"
    ) as Transport:
...
def test_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.run_v2.services.instances.transports.InstancesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_connector_path():
    ...
    actual = InstancesClient.connector_path(project, location, connector)
...
def test_parse_connector_path():
    ...
    path = InstancesClient.connector_path(**expected)

    # Check that the path construction is reversible.
    actual = InstancesClient.parse_connector_path(path)
    assert expected == actual
...
def test_crypto_key_path():
    ...
    actual = InstancesClient.crypto_key_path(project, location, key_ring, crypto_key)
    assert expected == actual
...
def test_parse_crypto_key_path():
    ...
    path = InstancesClient.crypto_key_path(**expected)

    # Check that the path construction is reversible.
    actual = InstancesClient.parse_crypto_key_path(path)
    assert expected == actual
...
def test_instance_path():
    ...
    actual = InstancesClient.instance_path(project, location, instance)
    assert expected == actual
...
def test_policy_path():
    ...
    actual = InstancesClient.policy_path(project)
    assert expected == actual
...
def test_parse_policy_path():
    ...
    path = InstancesClient.policy_path(**expected)

    # Check that the path construction is reversible.
    actual = InstancesClient.parse_policy_path(path)
    assert expected == actual
...
def test_secret_path():
    ...
    actual = InstancesClient.secret_path(project, secret)
    assert expected == actual
...
def test_parse_secret_path():
    ...
    path = InstancesClient.secret_path(**expected)

    # Check that the path construction is reversible.
    actual = InstancesClient.parse_secret_path(path)
    assert expected == actual
...
def test_secret_version_path():
    ...
    actual = InstancesClient.secret_version_path(project, secret, version)
    assert expected == actual
...
def test_parse_secret_version_path():
    ...
    path = InstancesClient.secret_version_path(**expected)

    # Check that the path construction is reversible.
    actual = InstancesClient.parse_secret_version_path(path)
    assert expected == actual

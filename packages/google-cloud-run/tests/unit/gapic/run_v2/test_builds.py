...
def test__get_default_mtls_endpoint():
    ...
    assert BuildsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert BuildsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert BuildsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                BuildsClient._use_client_cert_effective()
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = BuildsClient(credentials=cred)
...
def test_submit_build_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.BuildsRestInterceptor, "post_submit_build_with_metadata"
        ...
        post_with_metadata.return_value = build.SubmitBuildResponse(), metadata

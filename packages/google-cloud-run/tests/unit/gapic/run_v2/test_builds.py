...
def test__get_default_mtls_endpoint():
    ...
    assert (
        BuildsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    )
    assert (
        BuildsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        BuildsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        BuildsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        BuildsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                BuildsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(BuildsClient),
)
@mock.patch.object(
    BuildsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(BuildsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BuildsClient._DEFAULT_UNIVERSE
    default_endpoint = BuildsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = BuildsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == BuildsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BuildsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        BuildsClient._get_api_endpoint(None, None, default_universe, "always")
        == BuildsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BuildsClient._get_api_endpoint(
    ...
    assert (
        BuildsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        BuildsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        BuildsClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        BuildsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        BuildsClient._get_universe_domain(None, None) == BuildsClient._DEFAULT_UNIVERSE
    )
...
def test_builds_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [BuildsClient, BuildsAsyncClient])
@mock.patch.object(
    BuildsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BuildsClient)
)
@mock.patch.object(
    BuildsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BuildsAsyncClient)
)
...
def test_builds_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_builds_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_builds_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.run_v2.services.builds.transports.BuildsGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = BuildsClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_builds_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_submit_build_empty_call():
...
@pytest.mark.asyncio
async def test_submit_build_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    ...
    with mock.patch.object(type(client.transport.submit_build), "__call__") as call:
        ...
        response = await client.submit_build()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == build.SubmitBuildRequest()
...
@pytest.mark.asyncio
async def test_submit_build_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.submit_build
...
def test_submit_build_rest(request_type):
    client = BuildsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_submit_build_rest_required_fields(request_type=build.SubmitBuildRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).submit_build._get_unset_required_fields(jsonified_request)
...
def test_submit_build_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.BuildsRestInterceptor, "post_submit_build"
    ) as post, mock.patch.object(
        transports.BuildsRestInterceptor, "pre_submit_build"
    ) as pre:
        ...
        req.return_value._content = build.SubmitBuildResponse.to_json(
            build.SubmitBuildResponse()
        )
...
def test_submit_build_rest_bad_request(
    transport: str = "rest", request_type=build.SubmitBuildRequest
):
    client = BuildsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_submit_build_rest_error():
    client = BuildsClient(
...
def test_transport_kind(transport_name):
    transport = BuildsClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_builds_base_transport():
    ...
    with mock.patch(
        "google.cloud.run_v2.services.builds.transports.BuildsTransport.__init__"
    ) as Transport:
...
def test_builds_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.run_v2.services.builds.transports.BuildsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    "transport_class",
    [transports.BuildsGrpcTransport, transports.BuildsGrpcAsyncIOTransport],
)
def test_builds_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_builds_transport_channel_mtls_with_client_cert_source(transport_class):
    with mock.patch(
...
def test_builds_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.BuildsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = BuildsClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
class JobsClient(metaclass=JobsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, JobsTransport]] = None,
        ...
        if isinstance(transport, JobsTransport):

...
class JobsRestTransport(JobsTransport):
    """REST backend transport for Jobs.
    ...
    class _GetIamPolicy(JobsRestStub):
        def __hash__(self):
    ...
    class _SetIamPolicy(JobsRestStub):
        def __hash__(self):
    ...
    class _TestIamPermissions(JobsRestStub):
        def __hash__(self):
    ...
    class _DeleteOperation(JobsRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(JobsRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(JobsRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(JobsRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,

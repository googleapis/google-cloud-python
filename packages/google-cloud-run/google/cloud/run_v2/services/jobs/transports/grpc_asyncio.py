...
class JobsGrpcAsyncIOTransport(JobsTransport):
    ...
    @property
    def create_job(self) -> Callable[[gcr_job.CreateJobRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_jobs(self) -> Callable[[job.ListJobsRequest], Awaitable[job.ListJobsResponse]]:
    ...
    @property
    def update_job(self) -> Callable[[gcr_job.UpdateJobRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_job(self) -> Callable[[job.DeleteJobRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def run_job(self) -> Callable[[job.RunJobRequest], Awaitable[operations_pb2.Operation]]:
...
__all__ = ("JobsGrpcAsyncIOTransport",)

...
class TasksTransport(abc.ABC):
    ...
    @property
    def get_task(self) -> Callable[[task.GetTaskRequest], Union[task.Task, Awaitable[task.Task]]]:
        raise NotImplementedError()

    @property
    def list_tasks(self) -> Callable[[task.ListTasksRequest], Union[task.ListTasksResponse, Awaitable[task.ListTasksResponse]]]:
        raise NotImplementedError()

...
class RevisionsTransport(abc.ABC):
    ...
    @property
    def get_revision(self) -> Callable[[revision.GetRevisionRequest], Union[revision.Revision, Awaitable[revision.Revision]]]:
        raise NotImplementedError()

    @property
    def list_revisions(
        self,
    ) -> Callable[[revision.ListRevisionsRequest], Union[revision.ListRevisionsResponse, Awaitable[revision.ListRevisionsResponse]]]:
        raise NotImplementedError()

    @property
    def delete_revision(self) -> Callable[[revision.DeleteRevisionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

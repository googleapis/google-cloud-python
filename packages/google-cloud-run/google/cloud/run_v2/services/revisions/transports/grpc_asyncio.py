...
class RevisionsGrpcAsyncIOTransport(RevisionsTransport):
    ...
    @property
    def get_revision(self) -> Callable[[revision.GetRevisionRequest], Awaitable[revision.Revision]]:
    ...
    @property
    def list_revisions(self) -> Callable[[revision.ListRevisionsRequest], Awaitable[revision.ListRevisionsResponse]]:
    ...
    @property
    def delete_revision(self) -> Callable[[revision.DeleteRevisionRequest], Awaitable[operations_pb2.Operation]]:

...
class ExecutionsGrpcAsyncIOTransport(ExecutionsTransport):
    ...
    @property
    def get_execution(self) -> Callable[[execution.GetExecutionRequest], Awaitable[execution.Execution]]:
    ...
    @property
    def list_executions(self) -> Callable[[execution.ListExecutionsRequest], Awaitable[execution.ListExecutionsResponse]]:
    ...
    @property
    def delete_execution(self) -> Callable[[execution.DeleteExecutionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def cancel_execution(self) -> Callable[[execution.CancelExecutionRequest], Awaitable[operations_pb2.Operation]]:

...
class ExecutionsTransport(abc.ABC):
    ...
    @property
    def get_execution(self) -> Callable[[execution.GetExecutionRequest], Union[execution.Execution, Awaitable[execution.Execution]]]:
        raise NotImplementedError()

    @property
    def list_executions(
        self,
    ) -> Callable[[execution.ListExecutionsRequest], Union[execution.ListExecutionsResponse, Awaitable[execution.ListExecutionsResponse]]]:
        raise NotImplementedError()

    @property
    def delete_execution(self) -> Callable[[execution.DeleteExecutionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def cancel_execution(self) -> Callable[[execution.CancelExecutionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
class BuildsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_submit_build(
        self, request: build.SubmitBuildRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[build.SubmitBuildRequest, Sequence[Tuple[str, str]]]:
...
class BuildsRestTransport(BuildsTransport):
    ...
    class _DeleteOperation(BuildsRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(BuildsRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(BuildsRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(BuildsRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,

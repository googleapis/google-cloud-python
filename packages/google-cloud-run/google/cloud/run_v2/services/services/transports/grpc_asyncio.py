...
class ServicesGrpcAsyncIOTransport(ServicesTransport):
    ...
    @property
    def create_service(self) -> Callable[[gcr_service.CreateServiceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_service(self) -> Callable[[service.GetServiceRequest], Awaitable[service.Service]]:
    ...
    @property
    def list_services(self) -> Callable[[service.ListServicesRequest], Awaitable[service.ListServicesResponse]]:
    ...
    @property
    def update_service(self) -> Callable[[gcr_service.UpdateServiceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_service(self) -> Callable[[service.DeleteServiceRequest], Awaitable[operations_pb2.Operation]]:

...
class ServicesTransport(abc.ABC):
    ...
    @property
    def create_service(self) -> Callable[[gcr_service.CreateServiceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_service(self) -> Callable[[service.GetServiceRequest], Union[service.Service, Awaitable[service.Service]]]:
        raise NotImplementedError()

    @property
    def list_services(self) -> Callable[[service.ListServicesRequest], Union[service.ListServicesResponse, Awaitable[service.ListServicesResponse]]]:
        raise NotImplementedError()

    @property
    def update_service(self) -> Callable[[gcr_service.UpdateServiceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_service(self) -> Callable[[service.DeleteServiceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

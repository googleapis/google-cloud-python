...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-run.svg
   :target: https://pypi.org/project/google-cloud-run/
.. _Cloud Run Admin API: https://cloud.google.com/run/docs
...
.. _Enable the Cloud Run Admin API.:  https://cloud.google.com/run/docs
...
.. _Cloud Run Admin API Product documentation:  https://cloud.google.com/run/docs

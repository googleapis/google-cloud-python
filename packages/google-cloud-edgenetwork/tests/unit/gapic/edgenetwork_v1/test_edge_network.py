...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert EdgeNetworkClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert EdgeNetworkClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                EdgeNetworkClient._use_client_cert_effective()
...
def test_edge_network_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "edgenetwork.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://edgenetwork.googleapis.com"
        )
...
async def test_list_subnets_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_subnets), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_subnets(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_interconnects_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_interconnects), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_interconnects(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_interconnect(request_type, transport: str = "grpc"):
    ...
    assert response.remote_peering_network_type == resources.RemotePeeringNetworkType.REMOTE_PEERING_NETWORK_TYPE_CUSTOMER_INTERNAL
...
async def test_list_interconnect_attachments_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_interconnect_attachments), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_interconnect_attachments(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_interconnect_attachment(request_type, transport: str = "grpc"):
    ...
    assert response.mtu == 342
    assert response.state == resources.ResourceState.STATE_PENDING
    assert response.peering_type == resources.RemotePeeringNetworkType.REMOTE_PEERING_NETWORK_TYPE_CUSTOMER_INTERNAL
...
async def test_list_routers_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_routers), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_routers(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_diagnose_interconnect_rest_required_fields(request_type=service.DiagnoseInterconnectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).diagnose_interconnect._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_interconnect_attachments_rest_required_fields(request_type=service.ListInterconnectAttachmentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_interconnect_attachments._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_interconnect_attachment_rest_required_fields(request_type=service.GetInterconnectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_interconnect_attachment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_interconnect_attachment_rest_required_fields(request_type=service.CreateInterconnectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_interconnect_attachment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_interconnect_attachment_rest_required_fields(request_type=service.DeleteInterconnectAttachmentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_interconnect_attachment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = EdgeNetworkClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = EdgeNetworkAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = EdgeNetworkAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = EdgeNetworkClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_initialize_zone_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_initialize_zone") as post, mock.patch.object(
...
def test_list_zones_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_zones") as post, mock.patch.object(
...
def test_get_zone_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_zone") as post, mock.patch.object(
...
def test_list_networks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_networks") as post, mock.patch.object(
...
def test_get_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_network") as post, mock.patch.object(
...
def test_diagnose_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_network") as post, mock.patch.object(
...
def test_list_subnets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_subnets") as post, mock.patch.object(
...
def test_get_subnet_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_subnet") as post, mock.patch.object(
...
def test_list_interconnects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_interconnects") as post, mock.patch.object(
...
def test_get_interconnect_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_interconnect") as post, mock.patch.object(
...
def test_diagnose_interconnect_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_interconnect") as post, mock.patch.object(
        transports.EdgeNetworkRestInterceptor, "post_diagnose_interconnect_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_interconnect_attachments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_interconnect_attachments") as post, mock.patch.object(
        transports.EdgeNetworkRestInterceptor, "post_list_interconnect_attachments_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_interconnect_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_interconnect_attachment") as post, mock.patch.object(
        transports.EdgeNetworkRestInterceptor, "post_get_interconnect_attachment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_interconnect_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EdgeNetworkRestInterceptor, "post_create_interconnect_attachment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_interconnect_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EdgeNetworkRestInterceptor, "post_delete_interconnect_attachment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_routers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_list_routers") as post, mock.patch.object(
...
def test_get_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_get_router") as post, mock.patch.object(
...
def test_diagnose_router_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeNetworkRestInterceptor, "post_diagnose_router") as post, mock.patch.object(
...
def test_create_router_rest_call_success(request_type):
    ...
    request_init["router"] = {
        ...
        "interface": [
            {
                ...
                "loopback_ip_addresses": ["loopback_ip_addresses_value1", "loopback_ip_addresses_value2"],
            }
        ],
        "bgp_peer": [
            {
        ...
        "state": 1,
        "route_advertisements": ["route_advertisements_value1", "route_advertisements_value2"],
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
@pytest.mark.parametrize(
    ...
    [(transports.EdgeNetworkGrpcTransport, grpc_helpers), (transports.EdgeNetworkGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_edge_network_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "edgenetwork.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://edgenetwork.googleapis.com:8000"
    )
...
def test_router_path():
    ...
    zone = "whelk"
    router = "octopus"
    expected = "projects/{project}/locations/{location}/zones/{zone}/routers/{router}".format(
        project=project,
        location=location,
        zone=zone,
        router=router,
...
def test_subnet_path():
    ...
    zone = "scallop"
    subnet = "abalone"
    expected = "projects/{project}/locations/{location}/zones/{zone}/subnets/{subnet}".format(
        project=project,
        location=location,
        zone=zone,
        subnet=subnet,
...
async def test_get_location_field_headers_async():
    client = EdgeNetworkAsyncClient(credentials=async_anonymous_credentials())

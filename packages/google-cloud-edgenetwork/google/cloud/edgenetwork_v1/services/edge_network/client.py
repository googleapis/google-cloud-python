...
class EdgeNetworkClient(metaclass=EdgeNetworkClientMeta):
    ...
    def interconnect_path(
        ...
        return "projects/{project}/locations/{location}/zones/{zone}/interconnects/{interconnect}".format(
            project=project,
            location=location,
            zone=zone,
    ...
    def parse_interconnect_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/interconnects/(?P<interconnect>.+?)$",
            path,
        )
    ...
    def interconnect_attachment_path(
        ...
        return "projects/{project}/locations/{location}/zones/{zone}/interconnectAttachments/{interconnect_attachment}".format(
            project=project,
            location=location,
            zone=zone,
    ...
    def parse_interconnect_attachment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/interconnectAttachments/(?P<interconnect_attachment>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def network_path(
        ...
        return "projects/{project}/locations/{location}/zones/{zone}/networks/{network}".format(
            project=project,
            location=location,
            zone=zone,
            network=network,
    ...
    def parse_network_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/networks/(?P<network>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def router_path(
        ...
        return "projects/{project}/locations/{location}/zones/{zone}/routers/{router}".format(
            project=project,
            location=location,
            zone=zone,
            router=router,
    ...
    def parse_router_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/routers/(?P<router>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def subnet_path(
        ...
        return "projects/{project}/locations/{location}/zones/{zone}/subnets/{subnet}".format(
            project=project,
            location=location,
            zone=zone,
            subnet=subnet,
    ...
    def parse_subnet_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/zones/(?P<zone>.+?)/subnets/(?P<subnet>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = EdgeNetworkClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = EdgeNetworkClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = EdgeNetworkClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = EdgeNetworkClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or EdgeNetworkClient._get_api_endpoint(
    ...
    def list_interconnect_attachments(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_interconnect_attachments
        ]
    ...
    def get_interconnect_attachment(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_interconnect_attachment
        ]
    ...
    def create_interconnect_attachment(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_interconnect_attachment
        ]
    ...
    def delete_interconnect_attachment(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_interconnect_attachment
        ]

...
class OrgPolicyGrpcAsyncIOTransport(OrgPolicyTransport):
    ...
    @property
    def list_constraints(self) -> Callable[[orgpolicy.ListConstraintsRequest], Awaitable[orgpolicy.ListConstraintsResponse]]:
    ...
    @property
    def list_policies(self) -> Callable[[orgpolicy.ListPoliciesRequest], Awaitable[orgpolicy.ListPoliciesResponse]]:
    ...
    @property
    def get_policy(self) -> Callable[[orgpolicy.GetPolicyRequest], Awaitable[orgpolicy.Policy]]:
    ...
    @property
    def get_effective_policy(self) -> Callable[[orgpolicy.GetEffectivePolicyRequest], Awaitable[orgpolicy.Policy]]:
    ...
    @property
    def create_policy(self) -> Callable[[orgpolicy.CreatePolicyRequest], Awaitable[orgpolicy.Policy]]:
    ...
    @property
    def update_policy(self) -> Callable[[orgpolicy.UpdatePolicyRequest], Awaitable[orgpolicy.Policy]]:
    ...
    @property
    def delete_policy(self) -> Callable[[orgpolicy.DeletePolicyRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def create_custom_constraint(self) -> Callable[[orgpolicy.CreateCustomConstraintRequest], Awaitable[constraint.CustomConstraint]]:
    ...
    @property
    def update_custom_constraint(self) -> Callable[[orgpolicy.UpdateCustomConstraintRequest], Awaitable[constraint.CustomConstraint]]:
    ...
    @property
    def get_custom_constraint(self) -> Callable[[orgpolicy.GetCustomConstraintRequest], Awaitable[constraint.CustomConstraint]]:
    ...
    @property
    def list_custom_constraints(self) -> Callable[[orgpolicy.ListCustomConstraintsRequest], Awaitable[orgpolicy.ListCustomConstraintsResponse]]:
    ...
    @property
    def delete_custom_constraint(self) -> Callable[[orgpolicy.DeleteCustomConstraintRequest], Awaitable[empty_pb2.Empty]]:

...
from google.cloud.orgpolicy_v2.services.org_policy import OrgPolicyAsyncClient, OrgPolicyClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert OrgPolicyClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert OrgPolicyClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                OrgPolicyClient._use_client_cert_effective()
...
def test_org_policy_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "orgpolicy.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://orgpolicy.googleapis.com"
        )
...
async def test_list_constraints_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_constraints), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            orgpolicy.ListConstraintsResponse(
                constraints=[
...
def test_create_custom_constraint(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_custom_constraint), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_update_custom_constraint(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_custom_constraint), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = constraint.CustomConstraint(
            name="name_value",
            resource_types=["resource_types_value"],
...
async def test_list_custom_constraints_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_custom_constraints), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            orgpolicy.ListCustomConstraintsResponse(
                custom_constraints=[
...
async def test_list_custom_constraints_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_custom_constraints), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_custom_constraints(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_effective_policy_rest_required_fields(request_type=orgpolicy.GetEffectivePolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_effective_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_custom_constraint_rest_required_fields(request_type=orgpolicy.CreateCustomConstraintRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_custom_constraint._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_custom_constraint_rest_required_fields(request_type=orgpolicy.UpdateCustomConstraintRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_custom_constraint._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_custom_constraint_rest_required_fields(request_type=orgpolicy.GetCustomConstraintRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_custom_constraint._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_custom_constraints_rest_required_fields(request_type=orgpolicy.ListCustomConstraintsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_custom_constraints._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_custom_constraint_rest_required_fields(request_type=orgpolicy.DeleteCustomConstraintRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_custom_constraint._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = OrgPolicyClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = OrgPolicyClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = OrgPolicyClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = OrgPolicyAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = OrgPolicyAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = OrgPolicyClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_constraints_rest_bad_request(request_type=orgpolicy.ListConstraintsRequest):
    client = OrgPolicyClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_constraints_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_list_constraints") as post, mock.patch.object(
...
def test_list_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_list_policies") as post, mock.patch.object(
...
def test_get_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_get_policy") as post, mock.patch.object(
...
def test_get_effective_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_get_effective_policy") as post, mock.patch.object(
...
def test_create_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_create_policy") as post, mock.patch.object(
...
def test_update_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_update_policy") as post, mock.patch.object(
...
def test_delete_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "pre_delete_policy") as pre:
        pre.assert_not_called()
...
def test_create_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_create_custom_constraint") as post, mock.patch.object(
        transports.OrgPolicyRestInterceptor, "post_create_custom_constraint_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_update_custom_constraint") as post, mock.patch.object(
        transports.OrgPolicyRestInterceptor, "post_update_custom_constraint_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_get_custom_constraint") as post, mock.patch.object(
...
def test_list_custom_constraints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "post_list_custom_constraints") as post, mock.patch.object(
        transports.OrgPolicyRestInterceptor, "post_list_custom_constraints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post_with_metadata.return_value = orgpolicy.ListCustomConstraintsResponse(), metadata
...
def test_delete_custom_constraint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OrgPolicyRestInterceptor, "pre_delete_custom_constraint") as pre:
        pre.assert_not_called()
...
def test_org_policy_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.OrgPolicyTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.OrgPolicyGrpcTransport, grpc_helpers), (transports.OrgPolicyGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_org_policy_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.OrgPolicyRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_org_policy_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "orgpolicy.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://orgpolicy.googleapis.com:8000"
    )
...
def test_client_ctx():
    ...
    for transport in transports:
        client = OrgPolicyClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
async def test_get_row_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rows_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_row_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_create_rows_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_create_rows] = (
            mock_rpc
        )
        request = {}
...
async def test_batch_create_rows_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_row_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_update_rows_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_update_rows] = (
            mock_rpc
        )
        request = {}
...
async def test_batch_update_rows_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_row_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_delete_rows_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_delete_rows] = (
            mock_rpc
        )
        request = {}
...
async def test_batch_delete_rows_async(request_type, transport: str = "grpc_asyncio"):
    client = TablesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_workspace_rest_required_fields(request_type=tables.GetWorkspaceRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetWorkspace,
...
def test_create_row_rest_required_fields(request_type=tables.CreateRowRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateRow,
...
def test_batch_create_rows_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateRows,
...
def test_update_row_rest_required_fields(request_type=tables.UpdateRowRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateRow,
...
def test_batch_update_rows_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateRows,
...
def test_delete_row_rest_required_fields(request_type=tables.DeleteRowRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteRow,
...
def test_batch_delete_rows_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchDeleteRows,

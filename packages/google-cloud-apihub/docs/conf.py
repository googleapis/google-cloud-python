...
##
# google-cloud-apihub documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-apihub",
...
htmlhelp_basename = "google-cloud-apihub-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-apihub.tex",
        "google-cloud-apihub Documentation",
        author,
        "manual",
    )
]

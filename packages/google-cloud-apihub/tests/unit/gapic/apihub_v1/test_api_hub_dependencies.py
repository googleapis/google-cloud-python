...
@mock.patch.object(
    ApiHubDependenciesAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ApiHubDependenciesAsyncClient),
)
...
@pytest.mark.parametrize(
    "client_class", [ApiHubDependenciesClient, ApiHubDependenciesAsyncClient]
)
@mock.patch.object(
    ApiHubDependenciesClient,
    "DEFAULT_ENDPOINT",
...
@mock.patch.object(
    ApiHubDependenciesAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ApiHubDependenciesAsyncClient),
)
...
def test_api_hub_dependencies_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.apihub_v1.services.api_hub_dependencies.transports.ApiHubDependenciesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_api_hub_dependencies_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_dependency_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_dependency
...
@pytest.mark.asyncio
async def test_get_dependency_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_dependency
            in client._client._transport._wrapped_methods
        )
...
def test_update_dependency_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_dependency] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_update_dependency_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_dependency
            in client._client._transport._wrapped_methods
        )
...
def test_delete_dependency_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_dependency] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_dependency_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_dependency
            in client._client._transport._wrapped_methods
        )
...
def test_list_dependencies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_dependencies] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_dependencies_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_dependencies
            in client._client._transport._wrapped_methods
        )
...
def test_create_dependency_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateDependency,
        "_BaseCreateDependency__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
    ...
    assert not set(unset_fields) - set(("dependencyId",))
...
def test_get_dependency_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetDependency,
        "_BaseGetDependency__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_dependency_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateDependency,
        "_BaseUpdateDependency__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_dependency_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteDependency,
        "_BaseDeleteDependency__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_dependencies_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListDependencies,
        "_BaseListDependencies__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

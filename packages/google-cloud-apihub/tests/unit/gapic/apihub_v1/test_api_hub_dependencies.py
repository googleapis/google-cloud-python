...
def test_create_dependency_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = common_fields.Dependency.to_json(
            common_fields.Dependency()
        )
...
def test_create_dependency_rest_bad_request(
    transport: str = "rest", request_type=apihub_service.CreateDependencyRequest
):
    client = ApiHubDependenciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_dependency_rest_bad_request(
    transport: str = "rest", request_type=apihub_service.GetDependencyRequest
):
    client = ApiHubDependenciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_dependency_rest_bad_request(
    transport: str = "rest", request_type=apihub_service.UpdateDependencyRequest
):
    client = ApiHubDependenciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_dependency_rest_bad_request(
    transport: str = "rest", request_type=apihub_service.DeleteDependencyRequest
):
    client = ApiHubDependenciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_dependencies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apihub_service.ListDependenciesResponse.to_json(
            apihub_service.ListDependenciesResponse()
        )
...
def test_list_dependencies_rest_bad_request(
    transport: str = "rest", request_type=apihub_service.ListDependenciesRequest
):
    client = ApiHubDependenciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

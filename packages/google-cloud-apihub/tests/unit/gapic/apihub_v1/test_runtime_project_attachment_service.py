...
from google.cloud.apihub_v1.services.runtime_project_attachment_service import (
...
@pytest.mark.parametrize(
    ...
    [
        (RuntimeProjectAttachmentServiceClient, "grpc"),
        (RuntimeProjectAttachmentServiceAsyncClient, "grpc_asyncio"),
...
def test_runtime_project_attachment_service_client_get_transport_class():
    transport = RuntimeProjectAttachmentServiceClient.get_transport_class()
    ...
    assert transport == transports.RuntimeProjectAttachmentServiceGrpcTransport
...
def test_runtime_project_attachment_service_client_client_api_endpoint(client_class):
...
def test_create_runtime_project_attachment(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = runtime_project_attachment_service.RuntimeProjectAttachment(
            name="name_value",
            runtime_project="runtime_project_value",
        )
...
def test_create_runtime_project_attachment_non_empty_request_with_auto_populated_field():
...
async def test_create_runtime_project_attachment_async(
    ...
    with mock.patch.object(
        ...
        response = await client.create_runtime_project_attachment(request)
...
@pytest.mark.asyncio
async def test_create_runtime_project_attachment_field_headers_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_runtime_project_attachment_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_create_runtime_project_attachment_flattened_error():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_runtime_project_attachment_flattened_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_runtime_project_attachment_flattened_error_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_runtime_project_attachment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_runtime_project_attachment_field_headers_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_runtime_project_attachment_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_runtime_project_attachment_flattened_error():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_runtime_project_attachment_flattened_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_runtime_project_attachment_flattened_error_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_runtime_project_attachment(
            runtime_project_attachment_service.GetRuntimeProjectAttachmentRequest(),
            name="name_value",
        )
...
def test_list_runtime_project_attachments(request_type, transport: str = "grpc"):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListRuntimeProjectAttachmentsPager)
    assert response.next_page_token == "next_page_token_value"


def test_list_runtime_project_attachments_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_list_runtime_project_attachments_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_runtime_project_attachments(request)
...
@pytest.mark.asyncio
async def test_list_runtime_project_attachments_field_headers_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_runtime_project_attachments_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_runtime_project_attachments_flattened_error():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_runtime_project_attachments_flattened_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_runtime_project_attachments_flattened_error_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_runtime_project_attachments(
            runtime_project_attachment_service.ListRuntimeProjectAttachmentsRequest(),
            parent="parent_value",
        )


def test_list_runtime_project_attachments_pager(transport_name: str = "grpc"):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_runtime_project_attachments_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_runtime_project_attachments(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_runtime_project_attachments_async_pager():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_runtime_project_attachments(
            request={},
        )
...
@pytest.mark.asyncio
async def test_list_runtime_project_attachments_async_pages():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_runtime_project_attachment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_runtime_project_attachment_field_headers_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_runtime_project_attachment_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_runtime_project_attachment_flattened_error():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_runtime_project_attachment_flattened_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_runtime_project_attachment(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_runtime_project_attachment_flattened_error_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_runtime_project_attachment(
            runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest(),
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_lookup_runtime_project_attachment_field_headers_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_lookup_runtime_project_attachment_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_lookup_runtime_project_attachment_flattened_error():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_lookup_runtime_project_attachment_flattened_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_lookup_runtime_project_attachment_flattened_error_async():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.lookup_runtime_project_attachment(
            runtime_project_attachment_service.LookupRuntimeProjectAttachmentRequest(),
            name="name_value",
        )
...
def test_create_runtime_project_attachment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateRuntimeProjectAttachment,
        "_BaseCreateRuntimeProjectAttachment__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
    ...
    assert not set(unset_fields) - set(("runtimeProjectAttachmentId",))
...
def test_create_runtime_project_attachment_rest_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_runtime_project_attachment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RuntimeProjectAttachmentServiceClient(
...
def test_get_runtime_project_attachment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetRuntimeProjectAttachment,
        "_BaseGetRuntimeProjectAttachment__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_runtime_project_attachment_rest_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_runtime_project_attachments_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListRuntimeProjectAttachments,
        "_BaseListRuntimeProjectAttachments__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_runtime_project_attachments_rest_pager(transport: str = "rest"):
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_runtime_project_attachment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RuntimeProjectAttachmentServiceClient(
...
def test_delete_runtime_project_attachment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteRuntimeProjectAttachment,
        "_BaseDeleteRuntimeProjectAttachment__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_lookup_runtime_project_attachment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseLookupRuntimeProjectAttachment,
        "_BaseLookupRuntimeProjectAttachment__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_lookup_runtime_project_attachment_rest_flattened():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_transport_get_channel():
    ...
    transport = transports.RuntimeProjectAttachmentServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_create_runtime_project_attachment_empty_call_grpc():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_runtime_project_attachment_empty_call_grpc():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_runtime_project_attachments_empty_call_grpc():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_runtime_project_attachment_empty_call_grpc():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lookup_runtime_project_attachment_empty_call_grpc():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_runtime_project_attachment_empty_call_grpc_asyncio():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.create_runtime_project_attachment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_runtime_project_attachment_empty_call_grpc_asyncio():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_runtime_project_attachment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_runtime_project_attachments_empty_call_grpc_asyncio():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_runtime_project_attachments(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_runtime_project_attachment_empty_call_grpc_asyncio():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_lookup_runtime_project_attachment_empty_call_grpc_asyncio():
    client = RuntimeProjectAttachmentServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_create_runtime_project_attachment_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request_init["runtime_project_attachment"] = {
        "name": "name_value",
        "runtime_project": "runtime_project_value",
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_runtime_project_attachment_empty_call_rest():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_runtime_project_attachment_empty_call_rest():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_runtime_project_attachments_empty_call_rest():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_runtime_project_attachment_empty_call_rest():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lookup_runtime_project_attachment_empty_call_rest():
    client = RuntimeProjectAttachmentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_runtime_project_attachment_service_base_transport_error():
...
def test_runtime_project_attachment_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.apihub_v1.services.runtime_project_attachment_service.transports.RuntimeProjectAttachmentServiceTransport.__init__"
    ) as Transport:
...
def test_runtime_project_attachment_service_base_transport_with_adc():
...
def test_runtime_project_attachment_service_auth_adc():
...
def test_runtime_project_attachment_service_transport_auth_adc(transport_class):
...
def test_runtime_project_attachment_service_client_transport_session_collision(
    ...
    client2 = RuntimeProjectAttachmentServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.create_runtime_project_attachment._session
    session2 = client2.transport.create_runtime_project_attachment._session
    assert session1 != session2
    session1 = client1.transport.get_runtime_project_attachment._session
    session2 = client2.transport.get_runtime_project_attachment._session
    assert session1 != session2
    session1 = client1.transport.list_runtime_project_attachments._session
    session2 = client2.transport.list_runtime_project_attachments._session
    assert session1 != session2
    session1 = client1.transport.delete_runtime_project_attachment._session
    session2 = client2.transport.delete_runtime_project_attachment._session
    assert session1 != session2
    session1 = client1.transport.lookup_runtime_project_attachment._session
    session2 = client2.transport.lookup_runtime_project_attachment._session
    assert session1 != session2


def test_runtime_project_attachment_service_grpc_transport_channel():
...
def test_runtime_project_attachment_path():
    project = "squid"
    location = "clam"
    runtime_project_attachment = "whelk"
    expected = "projects/{project}/locations/{location}/runtimeProjectAttachments/{runtime_project_attachment}".format(
        project=project,
        location=location,
...
def test_common_folder_path():
    ...
    actual = RuntimeProjectAttachmentServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = RuntimeProjectAttachmentServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = RuntimeProjectAttachmentServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = RuntimeProjectAttachmentServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = RuntimeProjectAttachmentServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = RuntimeProjectAttachmentServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = RuntimeProjectAttachmentServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = RuntimeProjectAttachmentServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = RuntimeProjectAttachmentServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = RuntimeProjectAttachmentServiceClient.parse_common_location_path(path)
    assert expected == actual

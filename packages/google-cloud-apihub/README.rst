...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-apihub.svg
   :target: https://pypi.org/project/google-cloud-apihub/
.. _API hub: https://cloud.google.com/apigee/
...
3. `Enable the API hub.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the API hub.:  https://cloud.google.com/apigee/
...
-  Read the `Client Library Documentation`_ for API hub
   to see other available methods on the client.
-  Read the `API hub Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _API hub Product documentation:  https://cloud.google.com/apigee/

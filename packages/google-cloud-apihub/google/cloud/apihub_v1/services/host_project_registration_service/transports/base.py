...
class HostProjectRegistrationServiceTransport(abc.ABC):
    """Abstract transport class for HostProjectRegistrationService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_host_project_registration: gapic_v1.method.wrap_method(
                self.create_host_project_registration,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_host_project_registration: gapic_v1.method.wrap_method(
            ...
            self.list_host_project_registrations: gapic_v1.method.wrap_method(
    ...
    def create_host_project_registration(
        ...
        Union[host_project_registration_service.HostProjectRegistration, Awaitable[host_project_registration_service.HostProjectRegistration]],
    ]:
        raise NotImplementedError()
...
__all__ = ("HostProjectRegistrationServiceTransport",)

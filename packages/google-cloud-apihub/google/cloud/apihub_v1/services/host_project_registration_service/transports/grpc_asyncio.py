...
class HostProjectRegistrationServiceGrpcAsyncIOTransport(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_host_project_registration: self._wrap_method(
                self.create_host_project_registration,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_host_project_registration: self._wrap_method(
            ...
            self.list_host_project_registrations: self._wrap_method(

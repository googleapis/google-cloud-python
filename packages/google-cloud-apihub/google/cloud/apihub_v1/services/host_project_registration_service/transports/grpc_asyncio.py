...
class HostProjectRegistrationServiceGrpcAsyncIOTransport(
    ...
    def create_host_project_registration(
        ...
        Returns:
            Callable[[~.CreateHostProjectRegistrationRequest],
                    Awaitable[~.HostProjectRegistration]]:
    ...
    def list_host_project_registrations(
        ...
        Returns:
            Callable[[~.ListHostProjectRegistrationsRequest],
                    Awaitable[~.ListHostProjectRegistrationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_host_project_registration: gapic_v1.method_async.wrap_method(
                self.create_host_project_registration,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_host_project_registration: gapic_v1.method_async.wrap_method(
                self.get_host_project_registration,
            ...
            self.list_host_project_registrations: gapic_v1.method_async.wrap_method(
                self.list_host_project_registrations,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
...
__all__ = ("HostProjectRegistrationServiceGrpcAsyncIOTransport",)

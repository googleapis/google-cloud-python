...
class HostProjectRegistrationServiceClient(
    metaclass=HostProjectRegistrationServiceClientMeta
):
    ...
    @staticmethod
    def host_project_registration_path(
        project: str,
        location: str,
        host_project_registration: str,
    ) -> str:
        """Returns a fully-qualified host_project_registration string."""
        return "projects/{project}/locations/{location}/hostProjectRegistrations/{host_project_registration}".format(
            project=project,
            location=location,
    ...
    def parse_host_project_registration_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/hostProjectRegistrations/(?P<host_project_registration>.+?)$",
            path,
        )
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or HostProjectRegistrationServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(
            transport, HostProjectRegistrationServiceTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or HostProjectRegistrationServiceClient._get_api_endpoint(
    ...
    def create_host_project_registration(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_host_project_registration
        ]
    ...
    def get_host_project_registration(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_host_project_registration
        ]
    ...
    def list_host_project_registrations(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_host_project_registrations
        ]

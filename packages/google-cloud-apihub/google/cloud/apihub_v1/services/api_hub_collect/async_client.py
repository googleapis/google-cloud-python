...
class ApiHubCollectAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ApiHubCollectClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ApiHubCollectAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ApiHubCollectClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ApiHubCollectAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_collect_api_data():
                ...
                # Make the request
                operation = await client.collect_api_data(request=request)

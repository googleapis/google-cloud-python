...
class ApiHubCollectClientMeta(type):
    """Metaclass for the ApiHubCollect client.
...
class ApiHubCollectClient(metaclass=ApiHubCollectClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ApiHubCollectClient: The constructed client.
        """
    ...
    def transport(self) -> ApiHubCollectTransport:
        ...
        Returns:
            ApiHubCollectTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ApiHubCollectClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubCollectClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ApiHubCollectClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ApiHubCollectClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ApiHubCollectTransport, Callable[..., ApiHubCollectTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApiHubCollectClient._read_environment_variables()
        self._client_cert_source = ApiHubCollectClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApiHubCollectClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ApiHubCollectTransport)
        if transport_provided:
            # transport is a ApiHubCollectTransport instance.
            ...
            self._transport = cast(ApiHubCollectTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ApiHubCollectClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApiHubCollectTransport], Callable[..., ApiHubCollectTransport]] = (
                ApiHubCollectClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ApiHubCollectTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.apihub_v1.ApiHubCollectClient`.",
                    extra={
    ...
    def collect_api_data(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.CollectApiDataRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.collect_api_data]
    ...
    def __enter__(self) -> "ApiHubCollectClient":
        return self

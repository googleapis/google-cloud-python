...
from .rest_base import _BaseApiHubDependenciesRestTransport
...
class ApiHubDependenciesRestInterceptor:
    """Interceptor for ApiHubDependencies.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the ApiHubDependenciesRestTransport.

    .. code-block:: python
        class MyCustomApiHubDependenciesInterceptor(ApiHubDependenciesRestInterceptor):
            def pre_create_dependency(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_dependency(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_dependency(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def pre_get_dependency(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_dependency(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_dependencies(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_dependencies(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_dependency(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_dependency(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = ApiHubDependenciesRestTransport(interceptor=MyCustomApiHubDependenciesInterceptor())
    ...
    def pre_create_dependency(
        ...
        before they are sent to the ApiHubDependencies server.
        """
        return request, metadata
    ...
    def post_create_dependency(
        ...
        after it is returned by the ApiHubDependencies server but before
        it is returned to user code. This `post_create_dependency` interceptor runs
        before the `post_create_dependency_with_metadata` interceptor.
        """
        return response
    ...
    def post_create_dependency_with_metadata(
        ...
        is returned by the ApiHubDependencies server but before it is returned to user code.

        We recommend only using this `post_create_dependency_with_metadata`
        interceptor in new development instead of the `post_create_dependency` interceptor.
        When both interceptors are used, this `post_create_dependency_with_metadata` interceptor runs after the
        `post_create_dependency` interceptor. The (possibly modified) response returned by
        `post_create_dependency` will be passed to
    ...
    def post_get_dependency(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ApiHubDependencies server but before
        it is returned to user code. This `post_get_dependency` interceptor runs
        before the `post_get_dependency_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_dependency_with_metadata(
        ...
        We recommend only using this `post_get_dependency_with_metadata`
        interceptor in new development instead of the `post_get_dependency` interceptor.
        When both interceptors are used, this `post_get_dependency_with_metadata` interceptor runs after the
        `post_get_dependency` interceptor. The (possibly modified) response returned by
        `post_get_dependency` will be passed to
    ...
    def post_list_dependencies(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ApiHubDependencies server but before
        it is returned to user code. This `post_list_dependencies` interceptor runs
        before the `post_list_dependencies_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_dependencies_with_metadata(
        ...
        We recommend only using this `post_list_dependencies_with_metadata`
        interceptor in new development instead of the `post_list_dependencies` interceptor.
        When both interceptors are used, this `post_list_dependencies_with_metadata` interceptor runs after the
        `post_list_dependencies` interceptor. The (possibly modified) response returned by
        `post_list_dependencies` will be passed to
    ...
    def post_update_dependency(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ApiHubDependencies server but before
        it is returned to user code. This `post_update_dependency` interceptor runs
        before the `post_update_dependency_with_metadata` interceptor.
        """
        return response
    ...
    def post_update_dependency_with_metadata(
        ...
        We recommend only using this `post_update_dependency_with_metadata`
        interceptor in new development instead of the `post_update_dependency` interceptor.
        When both interceptors are used, this `post_update_dependency_with_metadata` interceptor runs after the
        `post_update_dependency` interceptor. The (possibly modified) response returned by
        `post_update_dependency` will be passed to
...
class ApiHubDependenciesRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: ApiHubDependenciesRestInterceptor


class ApiHubDependenciesRestTransport(_BaseApiHubDependenciesRestTransport):
    """REST backend synchronous transport for ApiHubDependencies.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[ApiHubDependenciesRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[ApiHubDependenciesRestInterceptor]): Interceptor used
    ...
    class _CreateDependency(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the create dependency method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.CreateDependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "CreateDependency",
            ...
            # Return the response
            resp = common_fields.Dependency()
            pb_resp = common_fields.Dependency.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesClient.create_dependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "CreateDependency",
    ...
    class _DeleteDependency(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the delete dependency method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.DeleteDependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "DeleteDependency",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
    ...
    class _GetDependency(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get dependency method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.GetDependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "GetDependency",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesClient.get_dependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "GetDependency",
                        "metadata": http_response["headers"],
    ...
    class _ListDependencies(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list dependencies method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.ListDependencies",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "ListDependencies",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = apihub_service.ListDependenciesResponse()
            pb_resp = apihub_service.ListDependenciesResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesClient.list_dependencies",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "ListDependencies",
                        "metadata": http_response["headers"],
    ...
    class _UpdateDependency(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update dependency method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.UpdateDependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "UpdateDependency",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesClient.update_dependency",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "UpdateDependency",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubDependenciesClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubDependenciesAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubDependencies",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
...
__all__ = ("ApiHubDependenciesRestTransport",)

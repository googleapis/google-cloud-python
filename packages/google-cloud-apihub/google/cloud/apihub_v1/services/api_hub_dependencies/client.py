...
class ApiHubDependenciesClientMeta(type):
    """Metaclass for the ApiHubDependencies client.
...
class ApiHubDependenciesClient(metaclass=ApiHubDependenciesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ApiHubDependenciesClient: The constructed client.
        """
    ...
    def transport(self) -> ApiHubDependenciesTransport:
        ...
        Returns:
            ApiHubDependenciesTransport: The transport used by the client
                instance.
        """
    ...
    def dependency_path(
        ...
        return "projects/{project}/locations/{location}/dependencies/{dependency}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_dependency_path(path: str) -> Dict[str, str]:
        """Parses a dependency path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dependencies/(?P<dependency>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ApiHubDependenciesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubDependenciesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ApiHubDependenciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ApiHubDependenciesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ApiHubDependenciesTransport, Callable[..., ApiHubDependenciesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApiHubDependenciesClient._read_environment_variables()
        self._client_cert_source = ApiHubDependenciesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApiHubDependenciesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ApiHubDependenciesTransport)
        if transport_provided:
            # transport is a ApiHubDependenciesTransport instance.
            ...
            self._transport = cast(ApiHubDependenciesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ApiHubDependenciesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApiHubDependenciesTransport], Callable[..., ApiHubDependenciesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.apihub_v1.ApiHubDependenciesClient`.",
                    extra={
    ...
    def create_dependency(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_dependency]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_dependency():
                ...
                # Make the request
                response = client.get_dependency(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.GetDependencyRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_dependency]
    ...
    def update_dependency(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.UpdateDependencyRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_dependency]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("dependency.name", request.dependency.name),)),)
    ...
    def delete_dependency(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DeleteDependencyRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_dependency]
    ...
    def list_dependencies(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_dependencies]
        ...
        response = pagers.ListDependenciesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "ApiHubDependenciesClient":
        return self

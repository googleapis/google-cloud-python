...
class ApiHubDependenciesClient(metaclass=ApiHubDependenciesClientMeta):
    ...
    def parse_dependency_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dependencies/(?P<dependency>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubDependenciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ApiHubDependenciesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ApiHubDependenciesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ApiHubDependenciesClient._get_api_endpoint(

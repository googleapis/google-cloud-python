...
class ApiHubPluginClient(metaclass=ApiHubPluginClientMeta):
    ...
    def plugin_path(
        ...
        return "projects/{project}/locations/{location}/plugins/{plugin}".format(
            project=project,
            location=location,
            plugin=plugin,
        )
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ApiHubPluginClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or ApiHubPluginClient._get_api_endpoint(

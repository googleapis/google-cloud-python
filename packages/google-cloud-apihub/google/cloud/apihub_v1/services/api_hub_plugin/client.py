...
class ApiHubPluginClient(metaclass=ApiHubPluginClientMeta):
    ...
    def parse_plugin_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/plugins/(?P<plugin>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubPluginClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ApiHubPluginClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ApiHubPluginClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ApiHubPluginTransport], Callable[..., ApiHubPluginTransport]
            ] = (
    ...
    def execute_plugin_instance_action(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.execute_plugin_instance_action
        ]
    ...
    def enable_plugin_instance_action(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.enable_plugin_instance_action
        ]
    ...
    def disable_plugin_instance_action(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.disable_plugin_instance_action
        ]

...
class ApiHubPluginTransport(abc.ABC):
    """Abstract transport class for ApiHubPlugin."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_plugin: gapic_v1.method.wrap_method(
                self.get_plugin,
            ...
            self.enable_plugin: gapic_v1.method.wrap_method(
                self.enable_plugin,
                default_timeout=60.0,
                client_info=client_info,
            ),

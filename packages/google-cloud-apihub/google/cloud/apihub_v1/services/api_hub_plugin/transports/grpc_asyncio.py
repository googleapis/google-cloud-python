...
class ApiHubPluginGrpcAsyncIOTransport(ApiHubPluginTransport):
    """gRPC AsyncIO backend transport for ApiHubPlugin.
    ...
    @property
    def get_plugin(self) -> Callable[[plugin_service.GetPluginRequest], Awaitable[plugin_service.Plugin]]:
    ...
    @property
    def enable_plugin(self) -> Callable[[plugin_service.EnablePluginRequest], Awaitable[plugin_service.Plugin]]:
    ...
    @property
    def disable_plugin(self) -> Callable[[plugin_service.DisablePluginRequest], Awaitable[plugin_service.Plugin]]:
    ...
    @property
    def create_plugin(self) -> Callable[[plugin_service.CreatePluginRequest], Awaitable[plugin_service.Plugin]]:
    ...
    @property
    def list_plugins(self) -> Callable[[plugin_service.ListPluginsRequest], Awaitable[plugin_service.ListPluginsResponse]]:
    ...
    @property
    def delete_plugin(self) -> Callable[[plugin_service.DeletePluginRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def create_plugin_instance(self) -> Callable[[plugin_service.CreatePluginInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def execute_plugin_instance_action(self) -> Callable[[plugin_service.ExecutePluginInstanceActionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_plugin_instance(self) -> Callable[[plugin_service.GetPluginInstanceRequest], Awaitable[plugin_service.PluginInstance]]:
    ...
    @property
    def list_plugin_instances(self) -> Callable[[plugin_service.ListPluginInstancesRequest], Awaitable[plugin_service.ListPluginInstancesResponse]]:
        ...
        Returns:
            Callable[[~.ListPluginInstancesRequest],
                    Awaitable[~.ListPluginInstancesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def enable_plugin_instance_action(self) -> Callable[[plugin_service.EnablePluginInstanceActionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def disable_plugin_instance_action(self) -> Callable[[plugin_service.DisablePluginInstanceActionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_plugin_instance(self) -> Callable[[plugin_service.UpdatePluginInstanceRequest], Awaitable[plugin_service.PluginInstance]]:
    ...
    @property
    def delete_plugin_instance(self) -> Callable[[plugin_service.DeletePluginInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_plugin: self._wrap_method(
                self.get_plugin,
            ...
            self.enable_plugin: self._wrap_method(
                self.enable_plugin,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.disable_plugin: self._wrap_method(
                self.disable_plugin,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_plugin: self._wrap_method(
                self.create_plugin,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_plugins: self._wrap_method(
                self.list_plugins,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_plugin: self._wrap_method(
                self.delete_plugin,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_plugin_instance: self._wrap_method(
                self.create_plugin_instance,
                default_timeout=None,
                client_info=client_info,
            ),
            self.execute_plugin_instance_action: self._wrap_method(
                self.execute_plugin_instance_action,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_plugin_instance: self._wrap_method(
                self.get_plugin_instance,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_plugin_instances: self._wrap_method(
                self.list_plugin_instances,
                default_timeout=None,
                client_info=client_info,
            ),
            self.enable_plugin_instance_action: self._wrap_method(
                self.enable_plugin_instance_action,
                default_timeout=None,
                client_info=client_info,
            ),
            self.disable_plugin_instance_action: self._wrap_method(
                self.disable_plugin_instance_action,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_plugin_instance: self._wrap_method(
                self.update_plugin_instance,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_plugin_instance: self._wrap_method(
...
__all__ = ("ApiHubPluginGrpcAsyncIOTransport",)

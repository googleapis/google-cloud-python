...
class RuntimeProjectAttachmentServiceClient(
    metaclass=RuntimeProjectAttachmentServiceClientMeta
):
    ...
    def parse_runtime_project_attachment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/runtimeProjectAttachments/(?P<runtime_project_attachment>.+?)$",
            path,
        )
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(
            transport, RuntimeProjectAttachmentServiceTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RuntimeProjectAttachmentServiceClient._get_api_endpoint(
    ...
    def create_runtime_project_attachment(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_runtime_project_attachment
        ]
    ...
    def get_runtime_project_attachment(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_runtime_project_attachment
        ]
    ...
    def list_runtime_project_attachments(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_runtime_project_attachments
        ]
    ...
    def delete_runtime_project_attachment(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_runtime_project_attachment
        ]
    ...
    def lookup_runtime_project_attachment(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.lookup_runtime_project_attachment
        ]

...
class RuntimeProjectAttachmentServiceClientMeta(type):
    """Metaclass for the RuntimeProjectAttachmentService client.
...
class RuntimeProjectAttachmentServiceClient(metaclass=RuntimeProjectAttachmentServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RuntimeProjectAttachmentServiceClient: The constructed client.
        """
    ...
    def transport(self) -> RuntimeProjectAttachmentServiceTransport:
        ...
        Returns:
            RuntimeProjectAttachmentServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def runtime_project_attachment_path(
        project: str,
        location: str,
        runtime_project_attachment: str,
    ) -> str:
        """Returns a fully-qualified runtime_project_attachment string."""
        return "projects/{project}/locations/{location}/runtimeProjectAttachments/{runtime_project_attachment}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_runtime_project_attachment_path(path: str) -> Dict[str, str]:
        """Parses a runtime_project_attachment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/runtimeProjectAttachments/(?P<runtime_project_attachment>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RuntimeProjectAttachmentServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RuntimeProjectAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RuntimeProjectAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RuntimeProjectAttachmentServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RuntimeProjectAttachmentServiceTransport, Callable[..., RuntimeProjectAttachmentServiceTransport]]] = None,
        ...
        self._client_cert_source = RuntimeProjectAttachmentServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RuntimeProjectAttachmentServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RuntimeProjectAttachmentServiceTransport)
        if transport_provided:
            # transport is a RuntimeProjectAttachmentServiceTransport instance.
            ...
            self._transport = cast(RuntimeProjectAttachmentServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RuntimeProjectAttachmentServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RuntimeProjectAttachmentServiceTransport], Callable[..., RuntimeProjectAttachmentServiceTransport]] = (
                RuntimeProjectAttachmentServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RuntimeProjectAttachmentServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.apihub_v1.RuntimeProjectAttachmentServiceClient`.",
                    extra={
    ...
    def create_runtime_project_attachment(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_runtime_project_attachment():
                # Create a client
                ...
                # Make the request
                response = client.create_runtime_project_attachment(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.CreateRuntimeProjectAttachmentRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_runtime_project_attachment]
    ...
    def get_runtime_project_attachment(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_runtime_project_attachment():
                # Create a client
                client = apihub_v1.RuntimeProjectAttachmentServiceClient()
                ...
                # Make the request
                response = client.get_runtime_project_attachment(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.GetRuntimeProjectAttachmentRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_runtime_project_attachment]
    ...
    def list_runtime_project_attachments(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListRuntimeProjectAttachmentsPager:
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.ListRuntimeProjectAttachmentsRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_runtime_project_attachments]
        ...
        response = pagers.ListRuntimeProjectAttachmentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def delete_runtime_project_attachment(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_runtime_project_attachment():
                # Create a client
                client = apihub_v1.RuntimeProjectAttachmentServiceClient()
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DeleteRuntimeProjectAttachmentRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_runtime_project_attachment]
    ...
    def lookup_runtime_project_attachment(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_lookup_runtime_project_attachment():
                # Create a client
                client = apihub_v1.RuntimeProjectAttachmentServiceClient()
                ...
                # Make the request
                response = client.lookup_runtime_project_attachment(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.LookupRuntimeProjectAttachmentRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.lookup_runtime_project_attachment]
    ...
    def __enter__(self) -> "RuntimeProjectAttachmentServiceClient":
        return self

...
class RuntimeProjectAttachmentServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            RuntimeProjectAttachmentServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
            RuntimeProjectAttachmentServiceAsyncClient, info, *args, **kwargs
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            RuntimeProjectAttachmentServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            RuntimeProjectAttachmentServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return RuntimeProjectAttachmentServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore

...
class RuntimeProjectAttachmentServiceGrpcAsyncIOTransport(RuntimeProjectAttachmentServiceTransport):
    ...
    def delete_runtime_project_attachment(
        self,
    ) -> Callable[[runtime_project_attachment_service.DeleteRuntimeProjectAttachmentRequest], Awaitable[empty_pb2.Empty]]:
...
__all__ = ("RuntimeProjectAttachmentServiceGrpcAsyncIOTransport",)

...
class ProvisioningAsyncClient:
    ...
    parse_api_hub_instance_path = staticmethod(ProvisioningClient.parse_api_hub_instance_path)
    ...
    async def create_api_hub_instance(
        self,
        request: Optional[Union[provisioning_service.CreateApiHubInstanceRequest, dict]] = None,
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_api_hub_instance]
    ...
    async def delete_api_hub_instance(
        self,
        request: Optional[Union[provisioning_service.DeleteApiHubInstanceRequest, dict]] = None,
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_api_hub_instance]
    ...
    async def get_api_hub_instance(
        self,
        request: Optional[Union[provisioning_service.GetApiHubInstanceRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_api_hub_instance]
    ...
    async def lookup_api_hub_instance(
        self,
        request: Optional[Union[provisioning_service.LookupApiHubInstanceRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.lookup_api_hub_instance]

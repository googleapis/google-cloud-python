...
class ProvisioningClient(metaclass=ProvisioningClientMeta):
    ...
    @staticmethod
    def api_hub_instance_path(
        project: str,
        location: str,
        api_hub_instance: str,
    ) -> str:
        """Returns a fully-qualified api_hub_instance string."""
        return "projects/{project}/locations/{location}/apiHubInstances/{api_hub_instance}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_api_hub_instance_path(path: str) -> Dict[str, str]:
        """Parses a api_hub_instance path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apiHubInstances/(?P<api_hub_instance>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ProvisioningClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ProvisioningClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ProvisioningClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ProvisioningClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or ProvisioningClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ProvisioningTransport], Callable[..., ProvisioningTransport]
            ] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.apihub_v1.ProvisioningClient`.",
                    extra={
    ...
    def create_api_hub_instance(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_api_hub_instance():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.CreateApiHubInstanceRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_api_hub_instance]
    ...
    def delete_api_hub_instance(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_api_hub_instance():
                # Create a client
                client = apihub_v1.ProvisioningClient()
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.DeleteApiHubInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_api_hub_instance]
    ...
    def get_api_hub_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.apihub_v1.types.GetApiHubInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_api_hub_instance]
    ...
    def lookup_api_hub_instance(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_lookup_api_hub_instance():
                # Create a client
                client = apihub_v1.ProvisioningClient()
                ...
                # Make the request
                response = client.lookup_api_hub_instance(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.apihub_v1.types.LookupApiHubInstanceRequest, dict]):
                The request object. The
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.lookup_api_hub_instance]

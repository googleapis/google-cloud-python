...
class ApiHubClient(metaclass=ApiHubClientMeta):
    ...
    def parse_api_operation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)/versions/(?P<version>.+?)/operations/(?P<operation>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def deployment_path(
        ...
        return "projects/{project}/locations/{location}/deployments/{deployment}".format(
            project=project,
            location=location,
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ApiHubClient._use_client_cert_effective()
    ...
    def update_api(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("api.name", request.api.name),)),)
    ...
    def update_version(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("version.name", request.version.name),)),)
    ...
    def update_spec(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("spec.name", request.spec.name),)),)
    ...
    def update_api_operation(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("api_operation.name", request.api_operation.name),)),)
    ...
    def update_attribute(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("attribute.name", request.attribute.name),)),)
    ...
    def update_external_api(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("external_api.name", request.external_api.name),)),)

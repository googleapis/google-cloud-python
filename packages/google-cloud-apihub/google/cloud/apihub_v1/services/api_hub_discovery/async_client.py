...
class ApiHubDiscoveryAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ApiHubDiscoveryAsyncClient: The constructed client.
        """
        sa_info_func = (
            ApiHubDiscoveryClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ApiHubDiscoveryAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ApiHubDiscoveryClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ApiHubDiscoveryAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return ApiHubDiscoveryClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> ApiHubDiscoveryTransport:
        ...
        Returns:
            ApiHubDiscoveryTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = ApiHubDiscoveryClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = ApiHubDiscoveryClient(
    ...
    async def list_discovered_api_observations(
        ...
        *,
    ...
    ) -> pagers.ListDiscoveredApiObservationsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.apihub_v1.types.ListDiscoveredApiObservationsRequest, dict]]):
        ...
        response = pagers.ListDiscoveredApiObservationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_discovered_api_observation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.apihub_v1.types.GetDiscoveredApiObservationRequest, dict]]):
    ...
    async def list_discovered_api_operations(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListDiscoveredApiOperationsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.apihub_v1.types.ListDiscoveredApiOperationsRequest, dict]]):
                The request object. Message for requesting list of
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListDiscoveredApiOperationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_discovered_api_operation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.apihub_v1.types.GetDiscoveredApiOperationRequest, dict]]):
                The request object. Message for requesting a
    ...
    async def __aenter__(self) -> "ApiHubDiscoveryAsyncClient":
        return self
...
__all__ = ("ApiHubDiscoveryAsyncClient",)

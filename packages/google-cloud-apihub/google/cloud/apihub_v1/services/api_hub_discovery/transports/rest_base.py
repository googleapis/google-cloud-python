...
class _BaseApiHubDiscoveryRestTransport(ApiHubDiscoveryTransport):
    """Base REST backend transport for ApiHubDiscovery.
    ...
    class _BaseGetDiscoveredApiObservation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=projects/*/locations/*/discoveredApiObservations/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetDiscoveredApiOperation:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=projects/*/locations/*/discoveredApiObservations/*/discoveredApiOperations/*}",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = discovery_service.GetDiscoveredApiOperationRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListDiscoveredApiObservations:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*}/discoveredApiObservations",
                },
            ]
            return http_options
    ...
    class _BaseListDiscoveredApiOperations:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*/discoveredApiObservations/*}/discoveredApiOperations",
                },
            ]
            return http_options
...
__all__ = ("_BaseApiHubDiscoveryRestTransport",)

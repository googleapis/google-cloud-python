...
from .grpc import ApiHubDiscoveryGrpcTransport
...
class ApiHubDiscoveryGrpcAsyncIOTransport(ApiHubDiscoveryTransport):
    """gRPC AsyncIO backend transport for ApiHubDiscovery.
    ...
    def list_discovered_api_observations(
        self,
    ) -> Callable[[discovery_service.ListDiscoveredApiObservationsRequest], Awaitable[discovery_service.ListDiscoveredApiObservationsResponse]]:
        ...
        Returns:
            Callable[[~.ListDiscoveredApiObservationsRequest],
                    Awaitable[~.ListDiscoveredApiObservationsResponse]]:
    ...
    def get_discovered_api_observation(
        self,
    ) -> Callable[[discovery_service.GetDiscoveredApiObservationRequest], Awaitable[common_fields.DiscoveredApiObservation]]:
        ...
        Returns:
            Callable[[~.GetDiscoveredApiObservationRequest],
                    Awaitable[~.DiscoveredApiObservation]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_discovered_api_operations(
        self,
    ) -> Callable[[discovery_service.ListDiscoveredApiOperationsRequest], Awaitable[discovery_service.ListDiscoveredApiOperationsResponse]]:
        ...
        Returns:
            Callable[[~.ListDiscoveredApiOperationsRequest],
                    Awaitable[~.ListDiscoveredApiOperationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_discovered_api_operation(
        self,
    ) -> Callable[[discovery_service.GetDiscoveredApiOperationRequest], Awaitable[common_fields.DiscoveredApiOperation]]:
        ...
        Returns:
            Callable[[~.GetDiscoveredApiOperationRequest],
                    Awaitable[~.DiscoveredApiOperation]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_discovered_api_observations: self._wrap_method(
                self.list_discovered_api_observations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_discovered_api_observation: self._wrap_method(
                self.get_discovered_api_observation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_discovered_api_operations: self._wrap_method(
                self.list_discovered_api_operations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_discovered_api_operation: self._wrap_method(
...
__all__ = ("ApiHubDiscoveryGrpcAsyncIOTransport",)

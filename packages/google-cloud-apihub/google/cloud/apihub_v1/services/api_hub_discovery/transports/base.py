...
class ApiHubDiscoveryTransport(abc.ABC):
    """Abstract transport class for ApiHubDiscovery."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_discovered_api_observations: gapic_v1.method.wrap_method(
                self.list_discovered_api_observations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_discovered_api_observation: gapic_v1.method.wrap_method(
                self.get_discovered_api_observation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_discovered_api_operations: gapic_v1.method.wrap_method(
                self.list_discovered_api_operations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_discovered_api_operation: gapic_v1.method.wrap_method(
...
__all__ = ("ApiHubDiscoveryTransport",)

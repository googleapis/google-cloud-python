...
class ApiHubCurateClient(metaclass=ApiHubCurateClientMeta):
    ...
    def curation_path(
        ...
        return "projects/{project}/locations/{location}/curations/{curation}".format(
            project=project,
            location=location,
            curation=curation,
        )
    ...
    def parse_curation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/curations/(?P<curation>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ApiHubCurateClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiHubCurateClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ApiHubCurateClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ApiHubCurateClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or ApiHubCurateClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ApiHubCurateTransport], Callable[..., ApiHubCurateTransport]
            ] = (

...
class ApiHubCurateGrpcAsyncIOTransport(ApiHubCurateTransport):
    """gRPC AsyncIO backend transport for ApiHubCurate.
    ...
    @property
    def create_curation(self) -> Callable[[curate_service.CreateCurationRequest], Awaitable[curate_service.Curation]]:
    ...
    @property
    def get_curation(self) -> Callable[[curate_service.GetCurationRequest], Awaitable[curate_service.Curation]]:
    ...
    @property
    def list_curations(self) -> Callable[[curate_service.ListCurationsRequest], Awaitable[curate_service.ListCurationsResponse]]:
        ...
        Returns:
            Callable[[~.ListCurationsRequest],
                    Awaitable[~.ListCurationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def update_curation(self) -> Callable[[curate_service.UpdateCurationRequest], Awaitable[curate_service.Curation]]:
    ...
    @property
    def delete_curation(self) -> Callable[[curate_service.DeleteCurationRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_curation: self._wrap_method(
                self.create_curation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_curation: self._wrap_method(
                self.get_curation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_curations: self._wrap_method(
                self.list_curations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_curation: self._wrap_method(
                self.update_curation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_curation: self._wrap_method(
...
__all__ = ("ApiHubCurateGrpcAsyncIOTransport",)

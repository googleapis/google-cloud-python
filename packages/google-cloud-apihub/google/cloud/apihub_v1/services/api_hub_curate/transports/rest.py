...
from .rest_base import _BaseApiHubCurateRestTransport
...
class ApiHubCurateRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the ApiHubCurateRestTransport.

    .. code-block:: python
        class MyCustomApiHubCurateInterceptor(ApiHubCurateRestInterceptor):
            def pre_create_curation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_curation(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_curation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def pre_get_curation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_curation(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_curations(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_curations(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_curation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_curation(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = ApiHubCurateRestTransport(interceptor=MyCustomApiHubCurateInterceptor())
    ...
    def pre_create_curation(
        ...
        before they are sent to the ApiHubCurate server.
        """
        return request, metadata
    ...
    def post_create_curation(
        ...
        after it is returned by the ApiHubCurate server but before
        it is returned to user code. This `post_create_curation` interceptor runs
        before the `post_create_curation_with_metadata` interceptor.
        """
        return response
    ...
    def post_create_curation_with_metadata(
        ...
        is returned by the ApiHubCurate server but before it is returned to user code.

        We recommend only using this `post_create_curation_with_metadata`
        interceptor in new development instead of the `post_create_curation` interceptor.
        When both interceptors are used, this `post_create_curation_with_metadata` interceptor runs after the
        `post_create_curation` interceptor. The (possibly modified) response returned by
        `post_create_curation` will be passed to
        `post_create_curation_with_metadata`.
        """
    ...
    def post_get_curation(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ApiHubCurate server but before
        it is returned to user code. This `post_get_curation` interceptor runs
        before the `post_get_curation_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_curation_with_metadata(
        ...
        We recommend only using this `post_get_curation_with_metadata`
        interceptor in new development instead of the `post_get_curation` interceptor.
        When both interceptors are used, this `post_get_curation_with_metadata` interceptor runs after the
        `post_get_curation` interceptor. The (possibly modified) response returned by
        `post_get_curation` will be passed to
        `post_get_curation_with_metadata`.
        """
        return response, metadata
    ...
    def post_list_curations(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ApiHubCurate server but before
        it is returned to user code. This `post_list_curations` interceptor runs
        before the `post_list_curations_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_curations_with_metadata(
        ...
        We recommend only using this `post_list_curations_with_metadata`
        interceptor in new development instead of the `post_list_curations` interceptor.
        When both interceptors are used, this `post_list_curations_with_metadata` interceptor runs after the
        `post_list_curations` interceptor. The (possibly modified) response returned by
        `post_list_curations` will be passed to
        `post_list_curations_with_metadata`.
        """
        return response, metadata
    ...
    def post_update_curation(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ApiHubCurate server but before
        it is returned to user code. This `post_update_curation` interceptor runs
        before the `post_update_curation_with_metadata` interceptor.
        """
        return response
    ...
    def post_update_curation_with_metadata(
        ...
        We recommend only using this `post_update_curation_with_metadata`
        interceptor in new development instead of the `post_update_curation` interceptor.
        When both interceptors are used, this `post_update_curation_with_metadata` interceptor runs after the
        `post_update_curation` interceptor. The (possibly modified) response returned by
        `post_update_curation` will be passed to
        `post_update_curation_with_metadata`.
        """
        return response, metadata
...
class ApiHubCurateRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: ApiHubCurateRestInterceptor


class ApiHubCurateRestTransport(_BaseApiHubCurateRestTransport):
    """REST backend synchronous transport for ApiHubCurate.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[ApiHubCurateRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[ApiHubCurateRestInterceptor]): Interceptor used
    ...
    class _CreateCuration(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the create curation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.CreateCuration",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "CreateCuration",
            ...
            # Return the response
            resp = curate_service.Curation()
            pb_resp = curate_service.Curation.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateClient.create_curation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "CreateCuration",
    ...
    class _DeleteCuration(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the delete curation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.DeleteCuration",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "DeleteCuration",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
    ...
    class _GetCuration(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get curation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.GetCuration",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "GetCuration",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateClient.get_curation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "GetCuration",
                        "metadata": http_response["headers"],
    ...
    class _ListCurations(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list curations method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.ListCurations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "ListCurations",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = curate_service.ListCurationsResponse()
            pb_resp = curate_service.ListCurationsResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateClient.list_curations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "ListCurations",
                        "metadata": http_response["headers"],
    ...
    class _UpdateCuration(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update curation method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.UpdateCuration",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "UpdateCuration",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateClient.update_curation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "UpdateCuration",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.apihub_v1.ApiHubCurateClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.apihub_v1.ApiHubCurateAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.apihub.v1.ApiHubCurate",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
...
__all__ = ("ApiHubCurateRestTransport",)

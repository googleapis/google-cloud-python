...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GSuiteAddOnsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GSuiteAddOnsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GSuiteAddOnsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert GSuiteAddOnsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert GSuiteAddOnsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                GSuiteAddOnsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert GSuiteAddOnsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GSuiteAddOnsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert GSuiteAddOnsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GSuiteAddOnsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(GSuiteAddOnsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GSuiteAddOnsClient))
@mock.patch.object(GSuiteAddOnsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GSuiteAddOnsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GSuiteAddOnsClient._DEFAULT_UNIVERSE
    default_endpoint = GSuiteAddOnsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GSuiteAddOnsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GSuiteAddOnsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert GSuiteAddOnsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == GSuiteAddOnsClient.DEFAULT_MTLS_ENDPOINT
    assert GSuiteAddOnsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert GSuiteAddOnsClient._get_api_endpoint(None, None, default_universe, "always") == GSuiteAddOnsClient.DEFAULT_MTLS_ENDPOINT
    assert GSuiteAddOnsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == GSuiteAddOnsClient.DEFAULT_MTLS_ENDPOINT
    assert GSuiteAddOnsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GSuiteAddOnsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GSuiteAddOnsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GSuiteAddOnsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GSuiteAddOnsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert GSuiteAddOnsClient._get_universe_domain(None, None) == GSuiteAddOnsClient._DEFAULT_UNIVERSE
...
def test_g_suite_add_ons_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "gsuiteaddons.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://gsuiteaddons.googleapis.com"
        )
...
def test_get_authorization_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_authorization] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_authorization_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_authorization in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_authorization] = mock_rpc
...
def test_replace_deployment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.replace_deployment in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_replace_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GSuiteAddOnsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.replace_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.replace_deployment] = mock_rpc
...
def test_install_deployment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.install_deployment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.install_deployment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_install_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GSuiteAddOnsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.install_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.install_deployment] = mock_rpc
...
def test_uninstall_deployment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.uninstall_deployment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.uninstall_deployment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_uninstall_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GSuiteAddOnsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.uninstall_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.uninstall_deployment] = mock_rpc
...
def test_get_install_status_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_install_status in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_install_status] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_install_status_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GSuiteAddOnsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_install_status in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_install_status] = mock_rpc
...
def test_uninstall_deployment_rest_required_fields(request_type=gsuiteaddons.UninstallDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).uninstall_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = GSuiteAddOnsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = GSuiteAddOnsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = GSuiteAddOnsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = GSuiteAddOnsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_authorization_rest_bad_request(request_type=gsuiteaddons.GetAuthorizationRequest):
...
def test_get_authorization_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_authorization") as post, mock.patch.object(
...
def test_create_deployment_rest_bad_request(request_type=gsuiteaddons.CreateDeploymentRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    ...
    request_init["deployment"] = {
        ...
        "add_ons": {
            "common": {
                ...
                "layout_properties": {"primary_color": "primary_color_value", "secondary_color": "secondary_color_value"},
                "add_on_widget_set": {"used_widgets": [1]},
                "use_locale_from_app": True,
                "homepage_trigger": {"run_function": "run_function_value", "enabled": {"value": True}},
                "universal_actions": [{"label": "label_value", "open_link": "open_link_value", "run_function": "run_function_value"}],
            ...
            "gmail": {
                "homepage_trigger": {},
                "contextual_triggers": [{"unconditional": {}, "on_trigger_function": "on_trigger_function_value"}],
                "universal_actions": [{"text": "text_value", "open_link": "open_link_value", "run_function": "run_function_value"}],
                "compose_trigger": {
                    "actions": [{"run_function": "run_function_value", "label": "label_value", "logo_url": "logo_url_value"}],
                    "draft_access": 1,
                },
                "authorization_check_function": "authorization_check_function_value",
            },
            "drive": {"homepage_trigger": {}, "on_items_selected_trigger": {"run_function": "run_function_value"}},
            "calendar": {
                "homepage_trigger": {},
                "conference_solution": [
                    {"on_create_function": "on_create_function_value", "id": "id_value", "name": "name_value", "logo_url": "logo_url_value"}
                ],
            ...
            "docs": {"homepage_trigger": {}, "on_file_scope_granted_trigger": {"run_function": "run_function_value"}},
            "sheets": {"homepage_trigger": {}, "on_file_scope_granted_trigger": {"run_function": "run_function_value"}},
            "slides": {"homepage_trigger": {}, "on_file_scope_granted_trigger": {"run_function": "run_function_value"}},
...
def test_create_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_create_deployment") as post, mock.patch.object(
...
def test_replace_deployment_rest_bad_request(request_type=gsuiteaddons.ReplaceDeploymentRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_replace_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_replace_deployment") as post, mock.patch.object(
...
def test_get_deployment_rest_bad_request(request_type=gsuiteaddons.GetDeploymentRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_deployment") as post, mock.patch.object(
...
def test_list_deployments_rest_bad_request(request_type=gsuiteaddons.ListDeploymentsRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1"}
    request = request_type(**request_init)
...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_list_deployments") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gsuiteaddons.ListDeploymentsResponse.to_json(gsuiteaddons.ListDeploymentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gsuiteaddons.ListDeploymentsResponse(), metadata
...
def test_delete_deployment_rest_bad_request(request_type=gsuiteaddons.DeleteDeploymentRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/deployments/sample2"}
    request = request_type(**request_init)
...
def test_delete_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_delete_deployment") as pre:
        pre.assert_not_called()
...
def test_install_deployment_rest_bad_request(request_type=gsuiteaddons.InstallDeploymentRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/deployments/sample2"}
    request = request_type(**request_init)
...
def test_install_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_install_deployment") as pre:
        pre.assert_not_called()
...
def test_uninstall_deployment_rest_bad_request(request_type=gsuiteaddons.UninstallDeploymentRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/deployments/sample2"}
    request = request_type(**request_init)
...
def test_uninstall_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_uninstall_deployment") as pre:
        pre.assert_not_called()
...
def test_get_install_status_rest_bad_request(request_type=gsuiteaddons.GetInstallStatusRequest):
    client = GSuiteAddOnsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_install_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_install_status") as post, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.GSuiteAddOnsGrpcTransport, grpc_helpers), (transports.GSuiteAddOnsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_g_suite_add_ons_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "gsuiteaddons.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://gsuiteaddons.googleapis.com:8000"
    )

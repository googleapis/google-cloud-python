...
class GSuiteAddOnsGrpcAsyncIOTransport(GSuiteAddOnsTransport):
    ...
    @property
    def get_authorization(self) -> Callable[[gsuiteaddons.GetAuthorizationRequest], Awaitable[gsuiteaddons.Authorization]]:
    ...
    @property
    def create_deployment(self) -> Callable[[gsuiteaddons.CreateDeploymentRequest], Awaitable[gsuiteaddons.Deployment]]:
    ...
    @property
    def replace_deployment(self) -> Callable[[gsuiteaddons.ReplaceDeploymentRequest], Awaitable[gsuiteaddons.Deployment]]:
    ...
    @property
    def get_deployment(self) -> Callable[[gsuiteaddons.GetDeploymentRequest], Awaitable[gsuiteaddons.Deployment]]:
    ...
    @property
    def list_deployments(self) -> Callable[[gsuiteaddons.ListDeploymentsRequest], Awaitable[gsuiteaddons.ListDeploymentsResponse]]:
    ...
    @property
    def delete_deployment(self) -> Callable[[gsuiteaddons.DeleteDeploymentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def install_deployment(self) -> Callable[[gsuiteaddons.InstallDeploymentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def uninstall_deployment(self) -> Callable[[gsuiteaddons.UninstallDeploymentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_install_status(self) -> Callable[[gsuiteaddons.GetInstallStatusRequest], Awaitable[gsuiteaddons.InstallStatus]]:

...
class ListDeploymentsPager:
    ...
    :class:`google.cloud.gsuiteaddons_v1.types.ListDeploymentsResponse` object, and
    ...
    All the usual :class:`google.cloud.gsuiteaddons_v1.types.ListDeploymentsResponse`

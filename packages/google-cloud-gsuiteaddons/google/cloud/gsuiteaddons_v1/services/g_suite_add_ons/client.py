...
class GSuiteAddOnsClient(metaclass=GSuiteAddOnsClientMeta):
    ...
    def authorization_path(
        ...
        return "projects/{project}/authorization".format(
            project=project,
        )
    ...
    def deployment_path(
        ...
        return "projects/{project}/deployments/{deployment}".format(
            project=project,
    ...
    def parse_deployment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/deployments/(?P<deployment>.+?)$", path
        )
        return m.groupdict() if m else {}

    @staticmethod
    def install_status_path(
        project: str,
        deployment: str,
    ) -> str:
        """Returns a fully-qualified install_status string."""
        return "projects/{project}/deployments/{deployment}/installStatus".format(
            project=project,
            deployment=deployment,
        )
    ...
    def parse_install_status_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/deployments/(?P<deployment>.+?)/installStatus$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = GSuiteAddOnsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = GSuiteAddOnsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = GSuiteAddOnsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = GSuiteAddOnsClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or GSuiteAddOnsClient._get_api_endpoint(

...
class GSuiteAddOnsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, GSuiteAddOnsTransport, Callable[..., GSuiteAddOnsTransport]]] = "grpc_asyncio",
    ...
    async def get_authorization(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_authorization]
    ...
    async def replace_deployment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.replace_deployment]
    ...
    async def install_deployment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.install_deployment]
    ...
    async def uninstall_deployment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.uninstall_deployment]
    ...
    async def get_install_status(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_install_status]

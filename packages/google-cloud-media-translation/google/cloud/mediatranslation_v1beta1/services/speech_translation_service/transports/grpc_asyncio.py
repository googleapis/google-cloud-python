...
from .base import DEFAULT_CLIENT_INFO, SpeechTranslationServiceTransport
...
class SpeechTranslationServiceGrpcAsyncIOTransport(SpeechTranslationServiceTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            host (Optional[str]):
                 The hostname to connect to (default: 'mediatranslation.googleapis.com').
    ...
    def streaming_translate_speech(
        self,
    ) -> Callable[[media_translation.StreamingTranslateSpeechRequest], Awaitable[media_translation.StreamingTranslateSpeechResponse]]:
        ...
        if "streaming_translate_speech" not in self._stubs:
            self._stubs["streaming_translate_speech"] = self._logged_channel.stream_stream(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.streaming_translate_speech: self._wrap_method(

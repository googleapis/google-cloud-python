...
class SpeechTranslationServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = (
        SpeechTranslationServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            SpeechTranslationServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(SpeechTranslationServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            SpeechTranslationServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            SpeechTranslationServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return SpeechTranslationServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore

...
class SpeechTranslationServiceClient(metaclass=SpeechTranslationServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = SpeechTranslationServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or SpeechTranslationServiceClient._get_api_endpoint(

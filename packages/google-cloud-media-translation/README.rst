Python Client for Media Translation
===================================

|preview| |pypi| |versions|

`Media Translation`_: The Media Translation API provides enterprise-quality translation from/to various media types.
...
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/mediatranslation/latest/summary_overview

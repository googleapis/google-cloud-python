...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SpeechTranslationServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    SpeechTranslationServiceClient._use_client_cert_effective() is False
                )
...
def test__get_client_cert_source():
    ...
    assert (
        SpeechTranslationServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SpeechTranslationServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SpeechTranslationServiceClient),
)
@mock.patch.object(
    SpeechTranslationServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SpeechTranslationServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SpeechTranslationServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SpeechTranslationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SpeechTranslationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SpeechTranslationServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        SpeechTranslationServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SpeechTranslationServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SpeechTranslationServiceClient._get_universe_domain(None, None)
        == SpeechTranslationServiceClient._DEFAULT_UNIVERSE
    )
...
def test_speech_translation_service_client_client_options(
    ...
    with mock.patch.object(
        SpeechTranslationServiceClient, "get_transport_class"
    ) as gtc:
...
def test_speech_translation_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_speech_translation_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_speech_translation_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_streaming_translate_speech(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.streaming_translate_speech), "__call__"
    ) as call:
...
def test_streaming_translate_speech_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.streaming_translate_speech
...
@pytest.mark.asyncio
async def test_streaming_translate_speech_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.streaming_translate_speech
...
async def test_streaming_translate_speech_async(
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(
            side_effect=[media_translation.StreamingTranslateSpeechResponse()]
        )
...
def test_transport_kind_grpc_asyncio():
    transport = SpeechTranslationServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.SpeechTranslationServiceGrpcTransport, grpc_helpers),
        (transports.SpeechTranslationServiceGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
def test_speech_translation_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_speech_translation_service_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):

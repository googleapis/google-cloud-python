...
from .base import DEFAULT_CLIENT_INFO, DatastoreTransport
...
class DatastoreGrpcTransport(DatastoreTransport):
    ...
    def run_query(
        ...
        if "run_query" not in self._stubs:
            self._stubs["run_query"] = self._logged_channel.unary_unary(
    ...
    def run_aggregation_query(
        ...
        if "run_aggregation_query" not in self._stubs:
            self._stubs["run_aggregation_query"] = self._logged_channel.unary_unary(
    ...
    def allocate_ids(
        ...
        if "allocate_ids" not in self._stubs:
            self._stubs["allocate_ids"] = self._logged_channel.unary_unary(
    ...
    def reserve_ids(
        ...
        if "reserve_ids" not in self._stubs:
            self._stubs["reserve_ids"] = self._logged_channel.unary_unary(

...
class DatastoreAdminClient(metaclass=DatastoreAdminClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DatastoreAdminClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DatastoreAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = DatastoreAdminClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = DatastoreAdminClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DatastoreAdminClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                DatastoreAdminClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.datastore.admin_v1.DatastoreAdminClient`.",
                    extra={

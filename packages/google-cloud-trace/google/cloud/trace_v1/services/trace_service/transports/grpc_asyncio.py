...
class TraceServiceGrpcAsyncIOTransport(TraceServiceTransport):
    ...
    @property
    def list_traces(self) -> Callable[[trace.ListTracesRequest], Awaitable[trace.ListTracesResponse]]:
    ...
    @property
    def patch_traces(self) -> Callable[[trace.PatchTracesRequest], Awaitable[empty_pb2.Empty]]:

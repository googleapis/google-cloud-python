...
class TraceServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = TraceServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(TraceServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            TraceServiceAsyncClient: The constructed client.
        """
        sa_file_func = TraceServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(TraceServiceAsyncClient, filename, *args, **kwargs)

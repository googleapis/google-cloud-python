...
class TraceServiceTransport(abc.ABC):
    ...
    @property
    def batch_write_spans(self) -> Callable[[tracing.BatchWriteSpansRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def create_span(self) -> Callable[[trace.Span], Union[trace.Span, Awaitable[trace.Span]]]:
        raise NotImplementedError()

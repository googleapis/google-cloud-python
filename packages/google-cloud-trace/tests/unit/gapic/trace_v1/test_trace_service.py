...
def test_list_traces_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.TraceServiceRestInterceptor, "post_list_traces") as post, mock.patch.object(
...
def test_get_trace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TraceServiceRestInterceptor, "post_get_trace") as post, mock.patch.object(
...
def test_patch_traces_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TraceServiceRestInterceptor, "pre_patch_traces") as pre:
        pre.assert_not_called()

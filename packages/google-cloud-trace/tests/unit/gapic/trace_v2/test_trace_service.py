...
from google.cloud.trace_v2.services.trace_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TraceServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_batch_write_spans_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_write_spans] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_batch_write_spans_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_write_spans
...
@pytest.mark.asyncio
async def test_create_span_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_span
            in client._client._transport._wrapped_methods
        )
...
def test_batch_write_spans_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).batch_write_spans._get_unset_required_fields(jsonified_request)
...
def test_batch_write_spans_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{name=projects/*}/traces:batchWrite" % client.transport._host,
            args[1],
        )
...
def test_create_span_rest_required_fields(request_type=trace.Span):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_span._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_write_spans_rest_bad_request(
    request_type=tracing.BatchWriteSpansRequest,
):
    client = TraceServiceClient(
...
def test_batch_write_spans_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TraceServiceRestInterceptor, "pre_batch_write_spans"
        ) as pre,
    ):
...
def test_create_span_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.TraceServiceRestInterceptor, "post_create_span"
        ) as post,
        mock.patch.object(

...
from .rest_base import _BaseCloudLocationFinderRestTransport
...
class CloudLocationFinderRestInterceptor:
    """Interceptor for CloudLocationFinder.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CloudLocationFinderRestTransport.

    .. code-block:: python
        class MyCustomCloudLocationFinderInterceptor(CloudLocationFinderRestInterceptor):
            def pre_get_cloud_location(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_cloud_location(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_cloud_locations(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_cloud_locations(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_search_cloud_locations(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_search_cloud_locations(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = CloudLocationFinderRestTransport(interceptor=MyCustomCloudLocationFinderInterceptor())
        client = CloudLocationFinderClient(transport=transport)
    ...
    def pre_get_cloud_location(
        ...
        before they are sent to the CloudLocationFinder server.
        """
        return request, metadata
    ...
    def post_get_cloud_location(
        ...
        after it is returned by the CloudLocationFinder server but before
        it is returned to user code. This `post_get_cloud_location` interceptor runs
        before the `post_get_cloud_location_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_cloud_location_with_metadata(
        ...
        is returned by the CloudLocationFinder server but before it is returned to user code.

        We recommend only using this `post_get_cloud_location_with_metadata`
        interceptor in new development instead of the `post_get_cloud_location` interceptor.
        When both interceptors are used, this `post_get_cloud_location_with_metadata` interceptor runs after the
        `post_get_cloud_location` interceptor. The (possibly modified) response returned by
        `post_get_cloud_location` will be passed to
    ...
    def post_list_cloud_locations(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the CloudLocationFinder server but before
        it is returned to user code. This `post_list_cloud_locations` interceptor runs
        before the `post_list_cloud_locations_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_cloud_locations_with_metadata(
        ...
        We recommend only using this `post_list_cloud_locations_with_metadata`
        interceptor in new development instead of the `post_list_cloud_locations` interceptor.
        When both interceptors are used, this `post_list_cloud_locations_with_metadata` interceptor runs after the
        `post_list_cloud_locations` interceptor. The (possibly modified) response returned by
        `post_list_cloud_locations` will be passed to
    ...
    def post_search_cloud_locations(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the CloudLocationFinder server but before
        it is returned to user code. This `post_search_cloud_locations` interceptor runs
        before the `post_search_cloud_locations_with_metadata` interceptor.
        """
        return response
    ...
    def post_search_cloud_locations_with_metadata(
        ...
        We recommend only using this `post_search_cloud_locations_with_metadata`
        interceptor in new development instead of the `post_search_cloud_locations` interceptor.
        When both interceptors are used, this `post_search_cloud_locations_with_metadata` interceptor runs after the
        `post_search_cloud_locations` interceptor. The (possibly modified) response returned by
        `post_search_cloud_locations` will be passed to
...
class CloudLocationFinderRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CloudLocationFinderRestInterceptor


class CloudLocationFinderRestTransport(_BaseCloudLocationFinderRestTransport):
    """REST backend synchronous transport for CloudLocationFinder.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[CloudLocationFinderRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[CloudLocationFinderRestInterceptor]): Interceptor used
    ...
    class _GetCloudLocation(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get cloud location method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.locationfinder_v1.CloudLocationFinderClient.GetCloudLocation",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "GetCloudLocation",
            ...
            # Return the response
            resp = cloud_location.CloudLocation()
            pb_resp = cloud_location.CloudLocation.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.locationfinder_v1.CloudLocationFinderClient.get_cloud_location",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "GetCloudLocation",
    ...
    class _ListCloudLocations(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list cloud locations method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.locationfinder_v1.CloudLocationFinderClient.ListCloudLocations",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "ListCloudLocations",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = cloud_location.ListCloudLocationsResponse()
            pb_resp = cloud_location.ListCloudLocationsResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.locationfinder_v1.CloudLocationFinderClient.list_cloud_locations",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "ListCloudLocations",
                        "metadata": http_response["headers"],
    ...
    class _SearchCloudLocations(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the search cloud locations method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.locationfinder_v1.CloudLocationFinderClient.SearchCloudLocations",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "SearchCloudLocations",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = cloud_location.SearchCloudLocationsResponse()
            pb_resp = cloud_location.SearchCloudLocationsResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.locationfinder_v1.CloudLocationFinderClient.search_cloud_locations",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "SearchCloudLocations",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.locationfinder_v1.CloudLocationFinderClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.locationfinder_v1.CloudLocationFinderAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.locationfinder_v1.CloudLocationFinderClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.locationfinder_v1.CloudLocationFinderAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.locationfinder.v1.CloudLocationFinder",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
...
__all__ = ("CloudLocationFinderRestTransport",)

...
from google.shopping.merchant_reviews_v1beta.types import productreviews, productreviews_common
...
def test__get_default_mtls_endpoint():
    ...
    assert ProductReviewsServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ProductReviewsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ProductReviewsServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ProductReviewsServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ProductReviewsServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert ProductReviewsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ProductReviewsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ProductReviewsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ProductReviewsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ProductReviewsServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ProductReviewsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ProductReviewsServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ProductReviewsServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ProductReviewsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ProductReviewsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ProductReviewsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ProductReviewsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ProductReviewsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductReviewsServiceClient))
@mock.patch.object(ProductReviewsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductReviewsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ProductReviewsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ProductReviewsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ProductReviewsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ProductReviewsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ProductReviewsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ProductReviewsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ProductReviewsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ProductReviewsServiceClient._get_api_endpoint(None, None, default_universe, "always") == ProductReviewsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ProductReviewsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ProductReviewsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ProductReviewsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ProductReviewsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ProductReviewsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ProductReviewsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ProductReviewsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ProductReviewsServiceClient._get_universe_domain(None, None) == ProductReviewsServiceClient._DEFAULT_UNIVERSE
...
def test_product_reviews_service_client_from_service_account_info(client_class, transport_name):
...
def test_product_reviews_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_product_reviews_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (ProductReviewsServiceClient, transports.ProductReviewsServiceGrpcTransport, "grpc"),
        (ProductReviewsServiceAsyncClient, transports.ProductReviewsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (ProductReviewsServiceClient, transports.ProductReviewsServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(ProductReviewsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductReviewsServiceClient))
@mock.patch.object(ProductReviewsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductReviewsServiceAsyncClient))
def test_product_reviews_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (ProductReviewsServiceClient, transports.ProductReviewsServiceGrpcTransport, "grpc", "true"),
        (ProductReviewsServiceAsyncClient, transports.ProductReviewsServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (ProductReviewsServiceClient, transports.ProductReviewsServiceGrpcTransport, "grpc", "false"),
        (ProductReviewsServiceAsyncClient, transports.ProductReviewsServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (ProductReviewsServiceClient, transports.ProductReviewsServiceRestTransport, "rest", "true"),
        (ProductReviewsServiceClient, transports.ProductReviewsServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ProductReviewsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductReviewsServiceClient))
@mock.patch.object(ProductReviewsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ProductReviewsServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_product_reviews_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [ProductReviewsServiceClient, ProductReviewsServiceAsyncClient])
@mock.patch.object(ProductReviewsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProductReviewsServiceClient))
@mock.patch.object(ProductReviewsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProductReviewsServiceAsyncClient))
...
def test_product_reviews_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (ProductReviewsServiceClient, transports.ProductReviewsServiceGrpcTransport, "grpc", grpc_helpers),
        (ProductReviewsServiceAsyncClient, transports.ProductReviewsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ProductReviewsServiceClient, transports.ProductReviewsServiceRestTransport, "rest", None),
    ],
)
def test_product_reviews_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_product_reviews_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = ProductReviewsServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_product_reviews_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_product_review(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_product_review), "__call__") as call:
...
def test_get_product_review_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.get_product_review in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_product_review] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_product_review_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_product_review in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_product_review] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_product_review_async(transport: str = "grpc_asyncio", request_type=productreviews.GetProductReviewRequest):
    client = ProductReviewsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_product_review_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_product_review), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(productreviews.ProductReview())
        await client.get_product_review(request)
...
def test_list_product_reviews(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_product_reviews), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_product_reviews_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_product_reviews in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_product_reviews] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_product_reviews_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductReviewsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_product_reviews in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_product_reviews] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_product_reviews_async(transport: str = "grpc_asyncio", request_type=productreviews.ListProductReviewsRequest):
    client = ProductReviewsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_product_reviews_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_product_reviews), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(productreviews.ListProductReviewsResponse())
        await client.list_product_reviews(request)
...
async def test_list_product_reviews_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_product_reviews), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            productreviews.ListProductReviewsResponse(
                product_reviews=[
...
async def test_list_product_reviews_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_product_reviews), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_product_reviews(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_insert_product_review(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.insert_product_review), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = productreviews.ProductReview(
            name="name_value",
            product_review_id="product_review_id_value",
...
def test_insert_product_review_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.insert_product_review in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.insert_product_review] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_insert_product_review_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductReviewsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.insert_product_review in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.insert_product_review] = mock_rpc
...
@pytest.mark.asyncio
async def test_insert_product_review_async(transport: str = "grpc_asyncio", request_type=productreviews.InsertProductReviewRequest):
    client = ProductReviewsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_product_review(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_product_review), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_delete_product_review_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_product_review in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_product_review] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_product_review_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ProductReviewsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_product_review in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_product_review] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_product_review_async(transport: str = "grpc_asyncio", request_type=productreviews.DeleteProductReviewRequest):
    client = ProductReviewsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_product_review_rest_required_fields(request_type=productreviews.GetProductReviewRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_product_review._get_unset_required_fields(jsonified_request)
...
def test_get_product_review_rest_unset_required_fields():
    transport = transports.ProductReviewsServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_product_review_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/reviews/v1beta/{name=accounts/*/productReviews/*}" % client.transport._host, args[1])
...
def test_list_product_reviews_rest_required_fields(request_type=productreviews.ListProductReviewsRequest):
    transport_class = transports.ProductReviewsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_product_reviews._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_product_reviews_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/reviews/v1beta/{parent=accounts/*}/productReviews" % client.transport._host, args[1])
...
def test_list_product_reviews_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(productreviews.ListProductReviewsResponse.to_json(x) for x in response)
...
def test_insert_product_review_rest_required_fields(request_type=productreviews.InsertProductReviewRequest):
    transport_class = transports.ProductReviewsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).insert_product_review._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_product_review_rest_required_fields(request_type=productreviews.DeleteProductReviewRequest):
    transport_class = transports.ProductReviewsServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_product_review._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ProductReviewsServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ProductReviewsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ProductReviewsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = ProductReviewsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ProductReviewsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ProductReviewsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_product_review_rest_bad_request(request_type=productreviews.GetProductReviewRequest):
    client = ProductReviewsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_product_review_rest_interceptors(null_interceptor):
    transport = transports.ProductReviewsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ProductReviewsServiceRestInterceptor(),
    )
    client = ProductReviewsServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductReviewsServiceRestInterceptor, "post_get_product_review") as post, mock.patch.object(
        transports.ProductReviewsServiceRestInterceptor, "post_get_product_review_with_metadata"
        ...
        pb_message = productreviews.GetProductReviewRequest.pb(productreviews.GetProductReviewRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = productreviews.ProductReview.to_json(productreviews.ProductReview())
...
def test_list_product_reviews_rest_bad_request(request_type=productreviews.ListProductReviewsRequest):
    client = ProductReviewsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_product_reviews_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductReviewsServiceRestInterceptor, "post_list_product_reviews") as post, mock.patch.object(
        transports.ProductReviewsServiceRestInterceptor, "post_list_product_reviews_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = productreviews.ListProductReviewsRequest.pb(productreviews.ListProductReviewsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = productreviews.ListProductReviewsResponse.to_json(productreviews.ListProductReviewsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = productreviews.ListProductReviewsResponse(), metadata
...
def test_insert_product_review_rest_bad_request(request_type=productreviews.InsertProductReviewRequest):
    client = ProductReviewsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "accounts/sample1"}
    request = request_type(**request_init)
...
def test_insert_product_review_rest_call_success(request_type):
    ...
    request_init["product_review"] = {
        ...
        "product_review_attributes": {
            ...
            "reviewer_image_links": ["reviewer_image_links_value1", "reviewer_image_links_value2"],
            "min_rating": 1064,
            "max_rating": 1066,
            "rating": 0.645,
...
def test_insert_product_review_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductReviewsServiceRestInterceptor, "post_insert_product_review") as post, mock.patch.object(
        transports.ProductReviewsServiceRestInterceptor, "post_insert_product_review_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = productreviews.InsertProductReviewRequest.pb(productreviews.InsertProductReviewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_product_review_rest_bad_request(request_type=productreviews.DeleteProductReviewRequest):
    client = ProductReviewsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "accounts/sample1/productReviews/sample2"}
    request = request_type(**request_init)
...
def test_delete_product_review_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductReviewsServiceRestInterceptor, "pre_delete_product_review") as pre:
        pre.assert_not_called()
        pb_message = productreviews.DeleteProductReviewRequest.pb(productreviews.DeleteProductReviewRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_product_reviews_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ProductReviewsServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.ProductReviewsServiceGrpcTransport, grpc_helpers), (transports.ProductReviewsServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
def test_product_reviews_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.ProductReviewsServiceGrpcTransport, transports.ProductReviewsServiceGrpcAsyncIOTransport])
def test_product_reviews_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_product_reviews_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ProductReviewsServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.ProductReviewsServiceGrpcTransport, transports.ProductReviewsServiceGrpcAsyncIOTransport])
def test_product_reviews_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ProductReviewsServiceTransport, "_prep_wrapped_messages") as prep:
        client = ProductReviewsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ProductReviewsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ProductReviewsServiceAsyncClient, transports.ProductReviewsServiceGrpcAsyncIOTransport),
    ],
)

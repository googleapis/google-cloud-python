...
def test_get_product_review_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_product_review] = (
            mock_rpc
        )
        request = {}
...
def test_list_product_reviews_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_product_reviews] = (
            mock_rpc
        )
        request = {}
...
def test_insert_product_review_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.insert_product_review] = (
            mock_rpc
        )
        request = {}
...
def test_delete_product_review_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_product_review] = (
            mock_rpc
        )
        request = {}
...
def test_get_product_review_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetProductReview,
...
def test_list_product_reviews_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListProductReviews,
...
def test_insert_product_review_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseInsertProductReview,
...
def test_delete_product_review_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteProductReview,

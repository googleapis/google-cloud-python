Python Client for Shopping Merchant Reviews
===========================================

|preview| |pypi| |versions|

`Shopping Merchant Reviews`_: Programmatically manage your Merchant Center Accounts.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-shopping-merchant-reviews.svg
   :target: https://pypi.org/project/google-shopping-merchant-reviews/
.. _Shopping Merchant Reviews: https://developers.google.com/merchant/api
...
3. `Enable the Shopping Merchant Reviews.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Shopping Merchant Reviews.:  https://developers.google.com/merchant/api
...
-  Read the `Client Library Documentation`_ for Shopping Merchant Reviews
   to see other available methods on the client.
-  Read the `Shopping Merchant Reviews Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Shopping Merchant Reviews Product documentation:  https://developers.google.com/merchant/api

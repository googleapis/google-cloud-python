...
from .services.merchant_reviews_service import MerchantReviewsServiceAsyncClient, MerchantReviewsServiceClient
from .services.product_reviews_service import ProductReviewsServiceAsyncClient, ProductReviewsServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.shopping.merchant_reviews_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.shopping.merchant_reviews_v1beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.shopping.merchant_reviews_v1beta"

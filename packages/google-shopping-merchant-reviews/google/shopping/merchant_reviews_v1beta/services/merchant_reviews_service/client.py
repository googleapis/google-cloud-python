...
from google.shopping.merchant_reviews_v1beta.types import merchantreviews, merchantreviews_common

from .transports.base import DEFAULT_CLIENT_INFO, MerchantReviewsServiceTransport
from .transports.grpc import MerchantReviewsServiceGrpcTransport
from .transports.grpc_asyncio import MerchantReviewsServiceGrpcAsyncIOTransport
from .transports.rest import MerchantReviewsServiceRestTransport


class MerchantReviewsServiceClientMeta(type):
    """Metaclass for the MerchantReviewsService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[MerchantReviewsServiceTransport]]
    _transport_registry["grpc"] = MerchantReviewsServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = MerchantReviewsServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = MerchantReviewsServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[MerchantReviewsServiceTransport]:
...
class MerchantReviewsServiceClient(metaclass=MerchantReviewsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MerchantReviewsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> MerchantReviewsServiceTransport:
        ...
        Returns:
            MerchantReviewsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def merchant_review_path(
        account: str,
        name: str,
    ) -> str:
        """Returns a fully-qualified merchant_review string."""
        return "accounts/{account}/merchantReviews/{name}".format(
            account=account,
            name=name,
        )

    @staticmethod
    def parse_merchant_review_path(path: str) -> Dict[str, str]:
        """Parses a merchant_review path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/merchantReviews/(?P<name>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = MerchantReviewsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = MerchantReviewsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MerchantReviewsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = MerchantReviewsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, MerchantReviewsServiceTransport, Callable[..., MerchantReviewsServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the merchant reviews service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MerchantReviewsServiceClient._read_environment_variables()
        self._client_cert_source = MerchantReviewsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = MerchantReviewsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, MerchantReviewsServiceTransport)
        if transport_provided:
            # transport is a MerchantReviewsServiceTransport instance.
            ...
            self._transport = cast(MerchantReviewsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or MerchantReviewsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MerchantReviewsServiceTransport], Callable[..., MerchantReviewsServiceTransport]] = (
                MerchantReviewsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., MerchantReviewsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.reviews_v1beta.MerchantReviewsServiceClient`.",
                    extra={
    ...
    def get_merchant_review(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_reviews_v1beta.types.GetMerchantReviewRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_merchant_review]
    ...
    def list_merchant_reviews(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListMerchantReviewsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_merchant_reviews():
                # Create a client
                client = merchant_reviews_v1beta.MerchantReviewsServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_reviews_v1beta.types.ListMerchantReviewsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_reviews_v1beta.services.merchant_reviews_service.pagers.ListMerchantReviewsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_merchant_reviews]
        ...
        response = pagers.ListMerchantReviewsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def insert_merchant_review(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_reviews_v1beta.types.InsertMerchantReviewRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.insert_merchant_review]
    ...
    def delete_merchant_review(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_reviews_v1beta.types.DeleteMerchantReviewRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_merchant_review]
    ...
    def __enter__(self) -> "MerchantReviewsServiceClient":
        return self

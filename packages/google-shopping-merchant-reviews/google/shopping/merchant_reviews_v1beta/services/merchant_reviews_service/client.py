...
class MerchantReviewsServiceClient(metaclass=MerchantReviewsServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                MerchantReviewsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = MerchantReviewsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or MerchantReviewsServiceClient._get_api_endpoint(

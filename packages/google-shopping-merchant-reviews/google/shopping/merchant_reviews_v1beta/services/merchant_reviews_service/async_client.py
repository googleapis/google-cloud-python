...
class MerchantReviewsServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = MerchantReviewsServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(MerchantReviewsServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            MerchantReviewsServiceAsyncClient: The constructed client.
        """
        sa_file_func = MerchantReviewsServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(
            MerchantReviewsServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return MerchantReviewsServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore

...
from .transports.grpc import StorageBatchOperationsGrpcTransport
from .transports.grpc_asyncio import StorageBatchOperationsGrpcAsyncIOTransport
from .transports.rest import StorageBatchOperationsRestTransport


class StorageBatchOperationsClientMeta(type):
    """Metaclass for the StorageBatchOperations client.
    ...
    ) -> Type[StorageBatchOperationsTransport]:
...
class StorageBatchOperationsClient(metaclass=StorageBatchOperationsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            StorageBatchOperationsClient: The constructed client.
        """
    ...
    def transport(self) -> StorageBatchOperationsTransport:
        ...
        Returns:
            StorageBatchOperationsTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, StorageBatchOperationsTransport, Callable[..., StorageBatchOperationsTransport]]] = None,
        ...
        self._universe_domain = StorageBatchOperationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, StorageBatchOperationsTransport)
        if transport_provided:
            # transport is a StorageBatchOperationsTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or StorageBatchOperationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[StorageBatchOperationsTransport], Callable[..., StorageBatchOperationsTransport]] = (
                StorageBatchOperationsClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.storagebatchoperations_v1.StorageBatchOperationsClient`.",
                    extra={
    ...
    def list_jobs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.storagebatchoperations_v1.types.ListJobsRequest, dict]):
    ...
    def get_job(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.storagebatchoperations_v1.types.GetJobRequest, dict]):
    ...
    def create_job(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.storagebatchoperations_v1.types.CreateJobRequest, dict]):
    ...
    def delete_job(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.storagebatchoperations_v1.types.DeleteJobRequest, dict]):
    ...
    def cancel_job(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.storagebatchoperations_v1.types.CancelJobRequest, dict]):
    ...
    def __enter__(self) -> "StorageBatchOperationsClient":
        return self

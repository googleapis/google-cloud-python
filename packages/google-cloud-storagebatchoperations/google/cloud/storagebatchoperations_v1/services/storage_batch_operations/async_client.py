...
from .transports.grpc_asyncio import StorageBatchOperationsGrpcAsyncIOTransport
...
class StorageBatchOperationsAsyncClient:
    ...
    _client: StorageBatchOperationsClient
    ...
    bucket_operation_path = staticmethod(
        StorageBatchOperationsClient.bucket_operation_path
    )
    parse_bucket_operation_path = staticmethod(
        StorageBatchOperationsClient.parse_bucket_operation_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            StorageBatchOperationsAsyncClient: The constructed client.
        """
        return StorageBatchOperationsClient.from_service_account_info.__func__(StorageBatchOperationsAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            StorageBatchOperationsAsyncClient: The constructed client.
        """
        return StorageBatchOperationsClient.from_service_account_file.__func__(StorageBatchOperationsAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return StorageBatchOperationsClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> StorageBatchOperationsTransport:
        ...
        Returns:
            StorageBatchOperationsTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = StorageBatchOperationsClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,StorageBatchOperationsTransport,Callable[..., StorageBatchOperationsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the StorageBatchOperationsTransport constructor.
        ...
        """
        self._client = StorageBatchOperationsClient(
    ...
    async def list_jobs(
        self,
        request: Optional[Union[storage_batch_operations.ListJobsRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_jobs():
                # Create a client
                client = storagebatchoperations_v1.StorageBatchOperationsAsyncClient()

                # Initialize request argument(s)
                request = storagebatchoperations_v1.ListJobsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.ListJobsRequest, dict]]):
        ...
        if not isinstance(request, storage_batch_operations.ListJobsRequest):
            request = storage_batch_operations.ListJobsRequest(request)
    ...
    async def get_job(
        self,
        request: Optional[Union[storage_batch_operations.GetJobRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_job():
                ...
                # Initialize request argument(s)
                request = storagebatchoperations_v1.GetJobRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.GetJobRequest, dict]]):
        ...
        Returns:
            google.cloud.storagebatchoperations_v1.types.Job:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, storage_batch_operations.GetJobRequest):
            request = storage_batch_operations.GetJobRequest(request)
    ...
    async def create_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.CreateJobRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            job (:class:`google.cloud.storagebatchoperations_v1.types.Job`):
            ...
            job_id (:class:`str`):
                ...
                specified, an id is generated. ``job_id`` should be no
                more than 128 characters and must include only
                characters available in DNS names, as defined by
                RFC-1123.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.storagebatchoperations_v1.types.Job`
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, storage_batch_operations.CreateJobRequest):
            request = storage_batch_operations.CreateJobRequest(request)
        ...
        response = operation_async.from_gapic(
            ...
            storage_batch_operations_types.Job,
            metadata_type=storage_batch_operations.OperationMetadata,
        )
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_job():
                ...
                # Initialize request argument(s)
                request = storagebatchoperations_v1.DeleteJobRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.DeleteJobRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, storage_batch_operations.DeleteJobRequest):
            request = storage_batch_operations.DeleteJobRequest(request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_cancel_job():
                ...
                # Initialize request argument(s)
                request = storagebatchoperations_v1.CancelJobRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.CancelJobRequest, dict]]):
        ...
        Returns:
            google.cloud.storagebatchoperations_v1.types.CancelJobResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, storage_batch_operations.CancelJobRequest):
            request = storage_batch_operations.CancelJobRequest(request)
    ...
    async def list_bucket_operations(
        self,
        request: Optional[
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListBucketOperationsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_bucket_operations():
                # Create a client
                client = storagebatchoperations_v1.StorageBatchOperationsAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.ListBucketOperationsRequest, dict]]):
        ...
        Returns:
            google.cloud.storagebatchoperations_v1.services.storage_batch_operations.pagers.ListBucketOperationsAsyncPager:
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_bucket_operations
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListBucketOperationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_bucket_operation(
        self,
        request: Optional[
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_bucket_operation():
                # Create a client
                client = storagebatchoperations_v1.StorageBatchOperationsAsyncClient()
                ...
                # Make the request
                response = await client.get_bucket_operation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.storagebatchoperations_v1.types.GetBucketOperationRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_bucket_operation
        ]
    ...
    async def __aenter__(self) -> "StorageBatchOperationsAsyncClient":
        return self

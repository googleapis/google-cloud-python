...
from .base import DEFAULT_CLIENT_INFO, PrivateCatalogTransport
...
class PrivateCatalogGrpcAsyncIOTransport(PrivateCatalogTransport):
    ...
    @property
    def search_catalogs(self) -> Callable[[private_catalog.SearchCatalogsRequest], Awaitable[private_catalog.SearchCatalogsResponse]]:
    ...
    @property
    def search_products(self) -> Callable[[private_catalog.SearchProductsRequest], Awaitable[private_catalog.SearchProductsResponse]]:
    ...
    @property
    def search_versions(self) -> Callable[[private_catalog.SearchVersionsRequest], Awaitable[private_catalog.SearchVersionsResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.search_catalogs: self._wrap_method(
                self.search_catalogs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_products: self._wrap_method(
                self.search_products,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_versions: self._wrap_method(

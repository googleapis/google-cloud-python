...
class PrivateCatalogGrpcAsyncIOTransport(PrivateCatalogTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.search_catalogs: gapic_v1.method_async.wrap_method(
                self.search_catalogs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_products: gapic_v1.method_async.wrap_method(
                self.search_products,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_versions: gapic_v1.method_async.wrap_method(

...
class CloudControlsPartnerMonitoringClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.cloudcontrolspartner_v1beta.CloudControlsPartnerMonitoringClient`.",
                    extra={
    ...
    def list_violations(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.cloudcontrolspartner_v1beta.types.ListViolationsRequest, dict]):
    ...
    def get_violation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.cloudcontrolspartner_v1beta.types.GetViolationRequest, dict]):

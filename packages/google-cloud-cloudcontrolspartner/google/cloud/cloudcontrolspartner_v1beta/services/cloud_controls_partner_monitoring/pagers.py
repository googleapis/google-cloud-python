...
class ListViolationsPager:
    ...
    :class:`google.cloud.cloudcontrolspartner_v1beta.types.ListViolationsResponse` object, and
    ...
    All the usual :class:`google.cloud.cloudcontrolspartner_v1beta.types.ListViolationsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.cloudcontrolspartner_v1beta.types.ListViolationsRequest):
                The initial request object.
            response (google.cloud.cloudcontrolspartner_v1beta.types.ListViolationsResponse):

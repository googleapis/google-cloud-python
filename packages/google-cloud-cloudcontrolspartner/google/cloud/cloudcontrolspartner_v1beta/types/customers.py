...
from google.cloud.cloudcontrolspartner_v1beta.types import completion_state as gcc_completion_state
...
class ListCustomersResponse(proto.Message):
    ...
    Attributes:
        customers (MutableSequence[google.cloud.cloudcontrolspartner_v1beta.types.Customer]):
            List of customers
        next_page_token (str):
...
class CreateCustomerRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Required. Parent resource Format:
            ``organizations/{organization}/locations/{location}``
        customer (google.cloud.cloudcontrolspartner_v1beta.types.Customer):
...
class CustomerOnboardingState(proto.Message):
    ...
    Attributes:
        onboarding_steps (MutableSequence[google.cloud.cloudcontrolspartner_v1beta.types.CustomerOnboardingStep]):
...
class CustomerOnboardingStep(proto.Message):
    ...
    Attributes:
        step (google.cloud.cloudcontrolspartner_v1beta.types.CustomerOnboardingStep.Step):
            The onboarding step

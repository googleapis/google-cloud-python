...
__lazy_modules__ = {
    "google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_core",
    "google.cloud.cloudcontrolspartner_v1beta.services.cloud_controls_partner_monitoring",
    "google.cloud.cloudcontrolspartner_v1beta.types.access_approval_requests",
    "google.cloud.cloudcontrolspartner_v1beta.types.completion_state",
    "google.cloud.cloudcontrolspartner_v1beta.types.core",
    "google.cloud.cloudcontrolspartner_v1beta.types.customer_workloads",
    "google.cloud.cloudcontrolspartner_v1beta.types.customers",
    "google.cloud.cloudcontrolspartner_v1beta.types.ekm_connections",
    "google.cloud.cloudcontrolspartner_v1beta.types.monitoring",
    "google.cloud.cloudcontrolspartner_v1beta.types.partner_permissions",
    "google.cloud.cloudcontrolspartner_v1beta.types.partners",
    "google.cloud.cloudcontrolspartner_v1beta.types.violations",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.cloudcontrolspartner_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.cloud.cloudcontrolspartner_v1beta")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.cloudcontrolspartner_v1beta"

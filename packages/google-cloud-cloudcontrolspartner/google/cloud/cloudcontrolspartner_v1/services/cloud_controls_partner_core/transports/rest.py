...
from google.cloud.cloudcontrolspartner_v1._compat import transcode_request
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[CloudControlsPartnerCoreRestInterceptor]): Interceptor used

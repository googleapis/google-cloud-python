...
from .transports.base import DEFAULT_CLIENT_INFO, CloudControlsPartnerMonitoringTransport
...
class CloudControlsPartnerMonitoringClient(metaclass=CloudControlsPartnerMonitoringClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = CloudControlsPartnerMonitoringClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = CloudControlsPartnerMonitoringClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or CloudControlsPartnerMonitoringClient._get_api_endpoint(

...
class CloudControlsPartnerMonitoringClient(
    metaclass=CloudControlsPartnerMonitoringClientMeta
):
    ...
    def violation_path(
        ...
        return "organizations/{organization}/locations/{location}/customers/{customer}/workloads/{workload}/violations/{violation}".format(
    ...
    def parse_violation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/customers/(?P<customer>.+?)/workloads/(?P<workload>.+?)/violations/(?P<violation>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CloudControlsPartnerMonitoringClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                CloudControlsPartnerMonitoringClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = CloudControlsPartnerMonitoringClient._read_environment_variables()
        self._client_cert_source = (
            CloudControlsPartnerMonitoringClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CloudControlsPartnerMonitoringClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CloudControlsPartnerMonitoringTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CloudControlsPartnerMonitoringClient._get_api_endpoint(
...
__all__ = ("CloudControlsPartnerMonitoringClient",)

...
from .services.cloud_controls_partner_core import CloudControlsPartnerCoreAsyncClient, CloudControlsPartnerCoreClient
from .services.cloud_controls_partner_monitoring import CloudControlsPartnerMonitoringAsyncClient, CloudControlsPartnerMonitoringClient
from .types.access_approval_requests import AccessApprovalRequest, AccessReason, ListAccessApprovalRequestsRequest, ListAccessApprovalRequestsResponse
...
from .types.ekm_connections import EkmConnection, EkmConnections, GetEkmConnectionsRequest
...
from .types.violations import GetViolationRequest, ListViolationsRequest, ListViolationsResponse, Violation

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.cloudcontrolspartner_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.cloudcontrolspartner_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.cloudcontrolspartner_v1"

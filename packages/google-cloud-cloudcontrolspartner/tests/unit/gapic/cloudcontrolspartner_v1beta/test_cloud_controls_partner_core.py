...
def test_get_ekm_connections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{name=organizations/*/locations/*/customers/*/workloads/*/ekmConnections}" % client.transport._host, args[1]
        )
...
def test_get_partner_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=organizations/*/locations/*/customers/*/workloads/*/partnerPermissions}" % client.transport._host, args[1]
        )
...
def test_list_access_approval_requests_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=organizations/*/locations/*/customers/*/workloads/*}/accessApprovalRequests" % client.transport._host, args[1]
        )

...
def test__get_default_mtls_endpoint():
    ...
    assert CloudControlsPartnerCoreClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert CloudControlsPartnerCoreClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert CloudControlsPartnerCoreClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert CloudControlsPartnerCoreClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert CloudControlsPartnerCoreClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert CloudControlsPartnerCoreClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CloudControlsPartnerCoreClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CloudControlsPartnerCoreClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CloudControlsPartnerCoreClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CloudControlsPartnerCoreClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert CloudControlsPartnerCoreClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CloudControlsPartnerCoreClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert CloudControlsPartnerCoreClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CloudControlsPartnerCoreClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(CloudControlsPartnerCoreClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudControlsPartnerCoreClient))
@mock.patch.object(
    CloudControlsPartnerCoreAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudControlsPartnerCoreAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudControlsPartnerCoreClient._DEFAULT_UNIVERSE
    default_endpoint = CloudControlsPartnerCoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CloudControlsPartnerCoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CloudControlsPartnerCoreClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        CloudControlsPartnerCoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == CloudControlsPartnerCoreClient.DEFAULT_MTLS_ENDPOINT
    )
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        CloudControlsPartnerCoreClient._get_api_endpoint(None, None, default_universe, "always")
        == CloudControlsPartnerCoreClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CloudControlsPartnerCoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == CloudControlsPartnerCoreClient.DEFAULT_MTLS_ENDPOINT
    )
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CloudControlsPartnerCoreClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CloudControlsPartnerCoreClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CloudControlsPartnerCoreClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CloudControlsPartnerCoreClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CloudControlsPartnerCoreClient._get_universe_domain(None, None) == CloudControlsPartnerCoreClient._DEFAULT_UNIVERSE
...
def test_cloud_controls_partner_core_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "cloudcontrolspartner.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://cloudcontrolspartner.googleapis.com"
        )
...
def test_cloud_controls_partner_core_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_cloud_controls_partner_core_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreGrpcTransport, "grpc"),
        (CloudControlsPartnerCoreAsyncClient, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport, "grpc_asyncio"),
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreRestTransport, "rest"),
    ],
)
@mock.patch.object(CloudControlsPartnerCoreClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudControlsPartnerCoreClient))
@mock.patch.object(
...
def test_cloud_controls_partner_core_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(CloudControlsPartnerCoreClient, "get_transport_class") as gtc:
...
@pytest.mark.parametrize(
    ...
    [
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreGrpcTransport, "grpc", "true"),
        (CloudControlsPartnerCoreAsyncClient, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreGrpcTransport, "grpc", "false"),
        (CloudControlsPartnerCoreAsyncClient, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreRestTransport, "rest", "true"),
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(CloudControlsPartnerCoreClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudControlsPartnerCoreClient))
@mock.patch.object(
...
def test_cloud_controls_partner_core_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [CloudControlsPartnerCoreClient, CloudControlsPartnerCoreAsyncClient])
@mock.patch.object(CloudControlsPartnerCoreClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudControlsPartnerCoreClient))
@mock.patch.object(CloudControlsPartnerCoreAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudControlsPartnerCoreAsyncClient))
def test_cloud_controls_partner_core_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_cloud_controls_partner_core_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreGrpcTransport, "grpc", grpc_helpers),
        (CloudControlsPartnerCoreAsyncClient, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreRestTransport, "rest", None),
    ],
)
def test_cloud_controls_partner_core_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_cloud_controls_partner_core_client_client_options_from_dict():
    with mock.patch(
        ...
        client = CloudControlsPartnerCoreClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_cloud_controls_partner_core_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_workload(request_type, transport: str = "grpc"):
    ...
    assert response.partner == customer_workloads.Workload.Partner.PARTNER_LOCAL_CONTROLS_BY_S3NS
...
@pytest.mark.asyncio
async def test_get_workload_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_workload in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_workload] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_workload_async(transport: str = "grpc_asyncio", request_type=customer_workloads.GetWorkloadRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_workloads_async(transport: str = "grpc_asyncio", request_type=customer_workloads.ListWorkloadsRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_workloads_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_workloads), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(customer_workloads.ListWorkloadsResponse())
        await client.list_workloads(request)
...
async def test_list_workloads_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_workloads), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_workloads(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_customer_async(transport: str = "grpc_asyncio", request_type=customers.GetCustomerRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_customers_async(transport: str = "grpc_asyncio", request_type=customers.ListCustomersRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_customers_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_customers), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(customers.ListCustomersResponse())
        await client.list_customers(request)
...
def test_get_ekm_connections(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_ekm_connections), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_get_ekm_connections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_ekm_connections in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_ekm_connections] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_ekm_connections_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudControlsPartnerCoreAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_ekm_connections in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_ekm_connections] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_ekm_connections_async(transport: str = "grpc_asyncio", request_type=ekm_connections.GetEkmConnectionsRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_ekm_connections_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_ekm_connections), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(ekm_connections.EkmConnections())
        await client.get_ekm_connections(request)
...
def test_get_partner_permissions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_partner_permissions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_partner_permissions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_partner_permissions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudControlsPartnerCoreAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_partner_permissions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_partner_permissions] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_partner_permissions_async(transport: str = "grpc_asyncio", request_type=partner_permissions.GetPartnerPermissionsRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_partner_permissions_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_partner_permissions), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(partner_permissions.PartnerPermissions())
        await client.get_partner_permissions(request)
...
def test_list_access_approval_requests_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_access_approval_requests in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_access_approval_requests] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_access_approval_requests_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudControlsPartnerCoreAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_access_approval_requests in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_access_approval_requests] = mock_rpc
...
async def test_list_access_approval_requests_async(
    transport: str = "grpc_asyncio", request_type=access_approval_requests.ListAccessApprovalRequestsRequest
):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_list_access_approval_requests_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_access_approval_requests), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(access_approval_requests.ListAccessApprovalRequestsResponse())
        await client.list_access_approval_requests(request)
...
def test_list_access_approval_requests_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_access_approval_requests), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_access_approval_requests(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, access_approval_requests.AccessApprovalRequest) for i in results)
...
async def test_list_access_approval_requests_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_access_approval_requests), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            access_approval_requests.ListAccessApprovalRequestsResponse(
                access_approval_requests=[
        ...
        assert len(responses) == 6
        assert all(isinstance(i, access_approval_requests.AccessApprovalRequest) for i in responses)
...
async def test_list_access_approval_requests_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_access_approval_requests), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_access_approval_requests(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_partner_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudControlsPartnerCoreAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_partner in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_partner] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_partner_async(transport: str = "grpc_asyncio", request_type=partners.GetPartnerRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_customer_async(transport: str = "grpc_asyncio", request_type=customers.CreateCustomerRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_customer_async(transport: str = "grpc_asyncio", request_type=customers.UpdateCustomerRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_customer_async(transport: str = "grpc_asyncio", request_type=customers.DeleteCustomerRequest):
    client = CloudControlsPartnerCoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_workload_rest_required_fields(request_type=customer_workloads.GetWorkloadRequest):
...
def test_get_workload_rest_unset_required_fields():
    transport = transports.CloudControlsPartnerCoreRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_workload_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {"name": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4"}
        ...
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/customers/*/workloads/*}" % client.transport._host, args[1])
...
def test_list_workloads_rest_required_fields(request_type=customer_workloads.ListWorkloadsRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
...
def test_list_workloads_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "organizations/sample1/locations/sample2/customers/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*/customers/*}/workloads" % client.transport._host, args[1])
...
def test_list_workloads_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(customer_workloads.ListWorkloadsResponse.to_json(x) for x in response)
...
def test_get_customer_rest_required_fields(request_type=customers.GetCustomerRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_customer._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_customer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "organizations/sample1/locations/sample2/customers/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/customers/*}" % client.transport._host, args[1])
...
def test_list_customers_rest_required_fields(request_type=customers.ListCustomersRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_customers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_customers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/customers" % client.transport._host, args[1])
...
def test_get_ekm_connections_rest_required_fields(request_type=ekm_connections.GetEkmConnectionsRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
...
def test_get_ekm_connections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4/ekmConnections"}
        ...
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/customers/*/workloads/*/ekmConnections}" % client.transport._host, args[1]
        )
...
def test_get_partner_permissions_rest_required_fields(request_type=partner_permissions.GetPartnerPermissionsRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_partner_permissions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_partner_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4/partnerPermissions"}
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/customers/*/workloads/*/partnerPermissions}" % client.transport._host, args[1]
        )
...
def test_list_access_approval_requests_rest_required_fields(request_type=access_approval_requests.ListAccessApprovalRequestsRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_access_approval_requests._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = access_approval_requests.ListAccessApprovalRequestsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_access_approval_requests_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4"}
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*/customers/*/workloads/*}/accessApprovalRequests" % client.transport._host, args[1]
        )
...
def test_list_access_approval_requests_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(access_approval_requests.ListAccessApprovalRequestsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_partner_rest_required_fields(request_type=partners.GetPartnerRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_partner._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_partner_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/partner}" % client.transport._host, args[1])
...
def test_create_customer_rest_required_fields(request_type=customers.CreateCustomerRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_customer._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_customer_rest_required_fields(request_type=customers.UpdateCustomerRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_customer._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_customer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"customer": {"name": "organizations/sample1/locations/sample2/customers/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{customer.name=organizations/*/locations/*/customers/*}" % client.transport._host, args[1])
...
def test_delete_customer_rest_required_fields(request_type=customers.DeleteCustomerRequest):
    transport_class = transports.CloudControlsPartnerCoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_customer._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = CloudControlsPartnerCoreClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = CloudControlsPartnerCoreClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = CloudControlsPartnerCoreAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CloudControlsPartnerCoreAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CloudControlsPartnerCoreClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_workload_rest_bad_request(request_type=customer_workloads.GetWorkloadRequest):
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4"}
    request = request_type(**request_init)
...
def test_get_workload_rest_interceptors(null_interceptor):
    transport = transports.CloudControlsPartnerCoreRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CloudControlsPartnerCoreRestInterceptor(),
    )
    client = CloudControlsPartnerCoreClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_workload") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_get_workload_with_metadata"
        ...
        pb_message = customer_workloads.GetWorkloadRequest.pb(customer_workloads.GetWorkloadRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = customer_workloads.Workload.to_json(customer_workloads.Workload())
...
def test_list_workloads_rest_bad_request(request_type=customer_workloads.ListWorkloadsRequest):
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "organizations/sample1/locations/sample2/customers/sample3"}
    request = request_type(**request_init)
...
def test_list_workloads_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_workloads") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_list_workloads_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = customer_workloads.ListWorkloadsRequest.pb(customer_workloads.ListWorkloadsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = customer_workloads.ListWorkloadsResponse.to_json(customer_workloads.ListWorkloadsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = customer_workloads.ListWorkloadsResponse(), metadata
...
def test_get_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_customer") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_get_customer_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_customers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_list_customers") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_list_customers_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = customers.ListCustomersResponse.to_json(customers.ListCustomersResponse())
        req.return_value.content = return_value
...
def test_get_ekm_connections_rest_bad_request(request_type=ekm_connections.GetEkmConnectionsRequest):
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4/ekmConnections"}
    request = request_type(**request_init)
...
def test_get_ekm_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_ekm_connections") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_get_ekm_connections_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = ekm_connections.GetEkmConnectionsRequest.pb(ekm_connections.GetEkmConnectionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = ekm_connections.EkmConnections.to_json(ekm_connections.EkmConnections())
        req.return_value.content = return_value
...
def test_get_partner_permissions_rest_bad_request(request_type=partner_permissions.GetPartnerPermissionsRequest):
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4/partnerPermissions"}
    request = request_type(**request_init)
...
def test_get_partner_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner_permissions") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "pre_get_partner_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = partner_permissions.GetPartnerPermissionsRequest.pb(partner_permissions.GetPartnerPermissionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = partner_permissions.PartnerPermissions.to_json(partner_permissions.PartnerPermissions())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = partner_permissions.PartnerPermissions(), metadata
...
def test_list_access_approval_requests_rest_bad_request(request_type=access_approval_requests.ListAccessApprovalRequestsRequest):
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "organizations/sample1/locations/sample2/customers/sample3/workloads/sample4"}
    request = request_type(**request_init)
...
def test_list_access_approval_requests_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudControlsPartnerCoreRestInterceptor, "post_list_access_approval_requests"
    ) as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_list_access_approval_requests_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "pre_list_access_approval_requests"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = access_approval_requests.ListAccessApprovalRequestsRequest.pb(access_approval_requests.ListAccessApprovalRequestsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = access_approval_requests.ListAccessApprovalRequestsResponse.to_json(
            access_approval_requests.ListAccessApprovalRequestsResponse()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = access_approval_requests.ListAccessApprovalRequestsResponse()
        post_with_metadata.return_value = access_approval_requests.ListAccessApprovalRequestsResponse(), metadata
...
def test_get_partner_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_get_partner_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_customer_rest_call_success(request_type):
    ...
    request_init["customer"] = {
        ...
        "customer_onboarding_state": {
            "onboarding_steps": [{"step": 1, "start_time": {"seconds": 751, "nanos": 543}, "completion_time": {}, "completion_state": 1}]
        },
        "is_onboarded": True,
        "organization_domain": "organization_domain_value",
    }
...
def test_create_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_create_customer") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_create_customer_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = customers.CreateCustomerRequest.pb(customers.CreateCustomerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_customer_rest_bad_request(request_type=customers.UpdateCustomerRequest):
    client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"customer": {"name": "organizations/sample1/locations/sample2/customers/sample3"}}
    request = request_type(**request_init)
...
def test_update_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "post_update_customer") as post, mock.patch.object(
        transports.CloudControlsPartnerCoreRestInterceptor, "post_update_customer_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = customers.UpdateCustomerRequest.pb(customers.UpdateCustomerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_customer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudControlsPartnerCoreRestInterceptor, "pre_delete_customer") as pre:
        pre.assert_not_called()
        pb_message = customers.DeleteCustomerRequest.pb(customers.DeleteCustomerRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
@pytest.mark.parametrize(
    ...
    [(transports.CloudControlsPartnerCoreGrpcTransport, grpc_helpers), (transports.CloudControlsPartnerCoreGrpcAsyncIOTransport, grpc_helpers_async)],
)
def test_cloud_controls_partner_core_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize(
    "transport_class", [transports.CloudControlsPartnerCoreGrpcTransport, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport]
)
def test_cloud_controls_partner_core_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_cloud_controls_partner_core_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.CloudControlsPartnerCoreRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_cloud_controls_partner_core_host_no_port(transport_name):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="cloudcontrolspartner.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "cloudcontrolspartner.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://cloudcontrolspartner.googleapis.com"
...
def test_cloud_controls_partner_core_host_with_port(transport_name):
    client = CloudControlsPartnerCoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="cloudcontrolspartner.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_cloud_controls_partner_core_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_access_approval_request_path():
    ...
    actual = CloudControlsPartnerCoreClient.access_approval_request_path(organization, location, customer, workload, access_approval_request)
...
def test_customer_path():
    ...
    location = "abalone"
    customer = "squid"
    expected = "organizations/{organization}/locations/{location}/customers/{customer}".format(
        organization=organization,
        location=location,
        customer=customer,
    )
    actual = CloudControlsPartnerCoreClient.customer_path(organization, location, customer)
    assert expected == actual
...
def test_ekm_connections_path():
    ...
    actual = CloudControlsPartnerCoreClient.ekm_connections_path(organization, location, customer, workload)
    assert expected == actual
...
def test_partner_permissions_path():
    ...
    actual = CloudControlsPartnerCoreClient.partner_permissions_path(organization, location, customer, workload)
    assert expected == actual
...
def test_workload_path():
    ...
    actual = CloudControlsPartnerCoreClient.workload_path(organization, location, customer, workload)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.CloudControlsPartnerCoreTransport, "_prep_wrapped_messages") as prep:
        client = CloudControlsPartnerCoreClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = CloudControlsPartnerCoreClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        (CloudControlsPartnerCoreClient, transports.CloudControlsPartnerCoreGrpcTransport),
        (CloudControlsPartnerCoreAsyncClient, transports.CloudControlsPartnerCoreGrpcAsyncIOTransport),
    ],
)

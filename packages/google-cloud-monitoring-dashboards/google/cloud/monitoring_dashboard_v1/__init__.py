...
from .services.dashboards_service import DashboardsServiceAsyncClient, DashboardsServiceClient
...
from .types.metrics import SparkChartType, Threshold, TimeSeriesFilter, TimeSeriesFilterRatio, TimeSeriesQuery
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.monitoring_dashboard_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.monitoring_dashboard_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.monitoring_dashboard_v1"

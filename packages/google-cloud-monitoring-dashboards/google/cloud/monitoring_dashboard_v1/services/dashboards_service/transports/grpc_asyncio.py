...
class DashboardsServiceGrpcAsyncIOTransport(DashboardsServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_dashboard: gapic_v1.method_async.wrap_method(
                self.create_dashboard,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.list_dashboards: gapic_v1.method_async.wrap_method(
                self.list_dashboards,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_dashboard: gapic_v1.method_async.wrap_method(
                self.get_dashboard,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_dashboard: gapic_v1.method_async.wrap_method(
                self.delete_dashboard,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.update_dashboard: gapic_v1.method_async.wrap_method(

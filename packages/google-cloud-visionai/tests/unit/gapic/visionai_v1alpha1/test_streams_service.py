...
from google.cloud.visionai_v1alpha1.services.streams_service import (
...
def test_streams_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.visionai_v1alpha1.services.streams_service.transports.StreamsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*}/clusters"
...
def test_get_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{name=projects/*/locations/*/clusters/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{cluster.name=projects/*/locations/*/clusters/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_streams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*/clusters/*}/streams"
            % client.transport._host,
            args[1],
        )
...
def test_get_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{name=projects/*/locations/*/clusters/*/streams/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{stream.name=projects/*/locations/*/clusters/*/streams/*}"
            % client.transport._host,
            args[1],
        )
...
def test_generate_stream_hls_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{stream=projects/*/locations/*/clusters/*/streams/*}:generateStreamHlsToken"
            % client.transport._host,
            args[1],
        )
...
def test_list_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*/clusters/*}/events"
            % client.transport._host,
            args[1],
        )
...
def test_get_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{name=projects/*/locations/*/clusters/*/events/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{event.name=projects/*/locations/*/clusters/*/events/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*/clusters/*}/series"
            % client.transport._host,
            args[1],
        )
...
def test_get_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{name=projects/*/locations/*/clusters/*/series/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{series.name=projects/*/locations/*/clusters/*/series/*}"
            % client.transport._host,
            args[1],
        )
...
def test_materialize_channel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*/clusters/*}/channels"
            % client.transport._host,
            args[1],
        )
...
def test_streams_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.visionai_v1alpha1.services.streams_service.transports.StreamsServiceTransport.__init__"
    ) as Transport:

...
from google.cloud.visionai_v1alpha1.services.live_video_analytics import (
...
def test_live_video_analytics_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_analyses_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*/clusters/*}/analyses"
...
def test_get_analysis_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{name=projects/*/locations/*/clusters/*/analyses/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_analysis_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{analysis.name=projects/*/locations/*/clusters/*/analyses/*}"
            % client.transport._host,
            args[1],
        )
...
def test_live_video_analytics_base_transport():
    ...
    with mock.patch(
        "google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport.__init__"
    ) as Transport:
...
def test_live_video_analytics_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.visionai_v1alpha1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

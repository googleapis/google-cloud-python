...
from google.cloud.visionai_v1.services.streams_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        StreamsServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        StreamsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        StreamsServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        StreamsServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        StreamsServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
    assert (
        StreamsServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        StreamsServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        StreamsServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                StreamsServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(StreamsServiceClient),
)
@mock.patch.object(
    StreamsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(StreamsServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = StreamsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = StreamsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = StreamsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        StreamsServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        StreamsServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == StreamsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        StreamsServiceClient._get_api_endpoint(
    ...
    assert (
        StreamsServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        StreamsServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        StreamsServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        StreamsServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        StreamsServiceClient._get_universe_domain(None, None)
        == StreamsServiceClient._DEFAULT_UNIVERSE
    )
...
def test_streams_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_streams_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_streams_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [StreamsServiceClient, StreamsServiceAsyncClient]
)
@mock.patch.object(
    StreamsServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(StreamsServiceClient),
)
@mock.patch.object(
    StreamsServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(StreamsServiceAsyncClient),
)
...
def test_streams_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_streams_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_streams_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.visionai_v1.services.streams_service.transports.StreamsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_streams_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_stream_thumbnail(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_stream_thumbnail), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_get_stream_thumbnail_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_stream_thumbnail in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_stream_thumbnail] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_stream_thumbnail_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_stream_thumbnail
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_stream_thumbnail_async(
    transport: str = "grpc_asyncio",
...
def test_generate_stream_hls_token(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.generate_stream_hls_token), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_generate_stream_hls_token_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.generate_stream_hls_token
...
@pytest.mark.asyncio
async def test_generate_stream_hls_token_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.generate_stream_hls_token
            in client._client._transport._wrapped_methods
        )
...
async def test_get_event_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_event
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_event_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_event
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_event_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_event
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_event_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_event
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_series_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_series
            in client._client._transport._wrapped_methods
        )
...
async def test_list_series_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_series), "__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            streams_service.ListSeriesResponse(
...
async def test_get_series_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_series
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_series_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_series
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_series_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_series
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_series_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_series
            in client._client._transport._wrapped_methods
        )
...
def test_materialize_channel(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.materialize_channel), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_materialize_channel_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.materialize_channel in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.materialize_channel] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_materialize_channel_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.materialize_channel
            in client._client._transport._wrapped_methods
        )
...
def test_list_clusters_rest_required_fields(
    request_type=streams_service.ListClustersRequest,
):
...
def test_list_clusters_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            streams_service.ListClustersResponse.to_json(x) for x in response
        )
...
def test_get_cluster_rest_required_fields(
    request_type=streams_service.GetClusterRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_delete_cluster_rest_required_fields(
    request_type=streams_service.DeleteClusterRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_list_streams_rest_required_fields(
    request_type=streams_service.ListStreamsRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_list_streams_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/clusters/*}/streams"
            % client.transport._host,
            args[1],
        )
...
def test_list_streams_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            streams_service.ListStreamsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_get_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clusters/*/streams/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_stream_rest_required_fields(
    request_type=streams_service.CreateStreamRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_update_stream_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{stream.name=projects/*/locations/*/clusters/*/streams/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_stream_rest_required_fields(
    request_type=streams_service.DeleteStreamRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_get_stream_thumbnail_rest_required_fields(
    request_type=streams_service.GetStreamThumbnailRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_stream_thumbnail._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_stream_thumbnail_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "stream": "projects/sample1/locations/sample2/clusters/sample3/streams/sample4"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{stream=projects/*/locations/*/clusters/*/streams/*}:getThumbnail"
            % client.transport._host,
            args[1],
        )
...
def test_generate_stream_hls_token_rest_required_fields(
    request_type=streams_service.GenerateStreamHlsTokenRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).generate_stream_hls_token._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = streams_service.GenerateStreamHlsTokenResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_generate_stream_hls_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{stream=projects/*/locations/*/clusters/*/streams/*}:generateStreamHlsToken"
            % client.transport._host,
            args[1],
        )
...
def test_list_events_rest_required_fields(
    request_type=streams_service.ListEventsRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_list_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/clusters/*}/events"
            % client.transport._host,
            args[1],
        )
...
def test_list_events_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            streams_service.ListEventsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_get_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clusters/*/events/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_event_rest_required_fields(
...
def test_update_event_rest_required_fields(
    request_type=streams_service.UpdateEventRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{event.name=projects/*/locations/*/clusters/*/events/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_event_rest_required_fields(
    request_type=streams_service.DeleteEventRequest,
):
    transport_class = transports.StreamsServiceRestTransport
...
def test_list_series_rest_required_fields(
    request_type=streams_service.ListSeriesRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_series._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/clusters/*}/series"
            % client.transport._host,
            args[1],
        )
...
def test_list_series_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            streams_service.ListSeriesResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_get_series_rest_required_fields(request_type=streams_service.GetSeriesRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_series._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clusters/*/series/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_series_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_series._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_series_rest_required_fields(
    request_type=streams_service.UpdateSeriesRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_series._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{series.name=projects/*/locations/*/clusters/*/series/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_series_rest_required_fields(
    request_type=streams_service.DeleteSeriesRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_series._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_materialize_channel_rest_required_fields(
    request_type=streams_service.MaterializeChannelRequest,
):
    transport_class = transports.StreamsServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).materialize_channel._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_materialize_channel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/clusters/*}/channels"
            % client.transport._host,
            args[1],
        )
...
def test_transport_kind_grpc_asyncio():
    transport = StreamsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = StreamsServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_clusters_rest_interceptors(null_interceptor):
    transport = transports.StreamsServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.StreamsServiceRestInterceptor(),
    )
    client = StreamsServiceClient(transport=transport)
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = streams_service.ListClustersResponse.to_json(
            streams_service.ListClustersResponse()
        )
...
def test_list_streams_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = streams_service.ListStreamsResponse.to_json(
            streams_service.ListStreamsResponse()
        )
        req.return_value.content = return_value
...
def test_get_stream_thumbnail_rest_bad_request(
    request_type=streams_service.GetStreamThumbnailRequest,
):
    client = StreamsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_get_stream_thumbnail_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = streams_service.GetStreamThumbnailRequest.pb(
            streams_service.GetStreamThumbnailRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_generate_stream_hls_token_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = streams_service.GenerateStreamHlsTokenResponse.to_json(
            streams_service.GenerateStreamHlsTokenResponse()
        )
        req.return_value.content = return_value
...
def test_list_events_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = streams_service.ListEventsResponse.to_json(
            streams_service.ListEventsResponse()
        )
        req.return_value.content = return_value
...
def test_list_series_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = streams_service.ListSeriesResponse.to_json(
            streams_service.ListSeriesResponse()
        )
        req.return_value.content = return_value
...
def test_streams_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.visionai_v1.services.streams_service.transports.StreamsServiceTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [
        (transports.StreamsServiceGrpcTransport, grpc_helpers),
        (transports.StreamsServiceGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_streams_service_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.StreamsServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = StreamsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

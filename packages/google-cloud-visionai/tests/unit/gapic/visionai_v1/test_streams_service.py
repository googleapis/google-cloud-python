...
def test_update_cluster_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateCluster,
...
def test_get_stream_thumbnail_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetStreamThumbnail,
        "_BaseGetStreamThumbnail__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_generate_stream_hls_token_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateStreamHlsToken,
        "_BaseGenerateStreamHlsToken__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListEvents,
...
def test_create_event_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateEvent,
        "_BaseCreateEvent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_event_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateEvent,
        "_BaseUpdateEvent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_event_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteEvent,
        "_BaseDeleteEvent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_series_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSeries,
        "_BaseListSeries__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_series_rest_required_fields(request_type=streams_service.GetSeriesRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetSeries,
        "_BaseGetSeries__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_series_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSeries,
        "_BaseCreateSeries__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_series_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSeries,
        "_BaseUpdateSeries__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_series_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSeries,
        "_BaseDeleteSeries__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_materialize_channel_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseMaterializeChannel,
        "_BaseMaterializeChannel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

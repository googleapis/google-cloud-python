...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AppPlatformClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AppPlatformClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AppPlatformClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                AppPlatformClient._use_client_cert_effective()
...
def test_delete_application_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_application] = (
            mock_rpc
        )
        request = {}
...
def test_deploy_application_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.deploy_application] = (
            mock_rpc
        )
        request = {}
...
def test_undeploy_application_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.undeploy_application] = (
            mock_rpc
        )
        request = {}
...
async def test_list_drafts_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_drafts(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_processor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_processor] = (
            mock_rpc
        )
        request = {}
...
def test_list_applications_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = platform.ListApplicationsResponse.to_json(
            platform.ListApplicationsResponse()
        )
...
def test_update_application_stream_input_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.AppPlatformRestInterceptor,
            "post_update_application_stream_input",
        ) as post,
        mock.patch.object(
            transports.AppPlatformRestInterceptor,
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = platform.ListInstancesResponse.to_json(
            platform.ListInstancesResponse()
        )
        req.return_value.content = return_value
...
def test_list_drafts_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = platform.ListDraftsResponse.to_json(
            platform.ListDraftsResponse()
        )
        req.return_value.content = return_value
...
def test_list_processors_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = platform.ListProcessorsResponse.to_json(
            platform.ListProcessorsResponse()
        )
        req.return_value.content = return_value
...
def test_list_prebuilt_processors_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = platform.ListPrebuiltProcessorsResponse.to_json(
            platform.ListPrebuiltProcessorsResponse()
        )
        req.return_value.content = return_value
...
def test_get_location_field_headers():
    client = AppPlatformClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = AppPlatformAsyncClient(credentials=async_anonymous_credentials())

...
from google.cloud.visionai_v1.services.live_video_analytics import LiveVideoAnalyticsAsyncClient, LiveVideoAnalyticsClient, pagers, transports
...
def test__read_environment_variables():
    assert LiveVideoAnalyticsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LiveVideoAnalyticsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LiveVideoAnalyticsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LiveVideoAnalyticsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LiveVideoAnalyticsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert LiveVideoAnalyticsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LiveVideoAnalyticsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert LiveVideoAnalyticsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LiveVideoAnalyticsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(LiveVideoAnalyticsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LiveVideoAnalyticsClient))
@mock.patch.object(LiveVideoAnalyticsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LiveVideoAnalyticsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LiveVideoAnalyticsClient._DEFAULT_UNIVERSE
    default_endpoint = LiveVideoAnalyticsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LiveVideoAnalyticsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LiveVideoAnalyticsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        LiveVideoAnalyticsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == LiveVideoAnalyticsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LiveVideoAnalyticsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LiveVideoAnalyticsClient._get_api_endpoint(None, None, default_universe, "always") == LiveVideoAnalyticsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        LiveVideoAnalyticsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == LiveVideoAnalyticsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LiveVideoAnalyticsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LiveVideoAnalyticsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LiveVideoAnalyticsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LiveVideoAnalyticsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LiveVideoAnalyticsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LiveVideoAnalyticsClient._get_universe_domain(None, None) == LiveVideoAnalyticsClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [LiveVideoAnalyticsClient, LiveVideoAnalyticsAsyncClient])
...
def test_live_video_analytics_client_client_options_from_dict():
    with mock.patch("google.cloud.visionai_v1.services.live_video_analytics.transports.LiveVideoAnalyticsGrpcTransport.__init__") as grpc_transport:
        grpc_transport.return_value = None
        client = LiveVideoAnalyticsClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_list_public_operators(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_public_operators), "__call__") as call:
...
def test_list_public_operators_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_public_operators in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_public_operators] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_public_operators_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_public_operators in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_public_operators] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_public_operators_async(transport: str = "grpc_asyncio", request_type=lva_service.ListPublicOperatorsRequest):
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_public_operators_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_public_operators), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(lva_service.ListPublicOperatorsResponse())
        await client.list_public_operators(request)
...
async def test_list_public_operators_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_public_operators), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            lva_service.ListPublicOperatorsResponse(
                operators=[
...
async def test_list_public_operators_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_public_operators), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_public_operators(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_resolve_operator_info_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.resolve_operator_info in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.resolve_operator_info] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_resolve_operator_info_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resolve_operator_info in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resolve_operator_info] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_operators_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_operators in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_operators] = mock_rpc
...
async def test_list_operators_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_operators), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            lva_service.ListOperatorsResponse(
                operators=[
...
async def test_list_operators_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_operators), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_operators(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_operator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_operator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_operator] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_operator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_operator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_operator] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_operator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_operator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_operator] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_operator_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_operator in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_operator] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_analyses_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_analyses in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_analyses] = mock_rpc
...
async def test_list_analyses_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_analyses), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_analyses(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_analysis_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_analysis in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_analysis] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_analysis_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_analysis in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_analysis] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_analysis_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_analysis in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_analysis] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_analysis_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_analysis in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_analysis] = mock_rpc
...
def test_batch_run_process_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_run_process] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_run_process_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LiveVideoAnalyticsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_run_process in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_run_process] = mock_rpc
...
def test_list_public_operators_rest_required_fields(request_type=lva_service.ListPublicOperatorsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_public_operators._get_unset_required_fields(
        jsonified_request
    )
...
def test_list_public_operators_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}:listPublicOperators" % client.transport._host, args[1])
...
def test_list_public_operators_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(lva_service.ListPublicOperatorsResponse.to_json(x) for x in response)
...
def test_resolve_operator_info_rest_required_fields(request_type=lva_service.ResolveOperatorInfoRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).resolve_operator_info._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = LiveVideoAnalyticsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = LiveVideoAnalyticsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
    assert client is not None


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_public_operators_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_public_operators), "__call__") as call:
        call.return_value = lva_service.ListPublicOperatorsResponse()
        client.list_public_operators(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resolve_operator_info_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.resolve_operator_info), "__call__") as call:
        call.return_value = lva_service.ResolveOperatorInfoResponse()
        client.resolve_operator_info(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_operators_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_operators), "__call__") as call:
        call.return_value = lva_service.ListOperatorsResponse()
        client.list_operators(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_operator_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_operator), "__call__") as call:
        call.return_value = lva_resources.Operator()
        client.get_operator(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_operator_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_operator), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_operator(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_operator_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_operator), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_operator(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_operator_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_operator), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_operator(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_analyses_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_analyses), "__call__") as call:
        call.return_value = lva_service.ListAnalysesResponse()
        client.list_analyses(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_analysis_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_analysis), "__call__") as call:
        call.return_value = lva_resources.Analysis()
        client.get_analysis(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_analysis_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_analysis), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_analysis(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_analysis_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_analysis), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_analysis(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_analysis_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_analysis), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_analysis(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_run_process_empty_call_grpc():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_run_process), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_run_process(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = LiveVideoAnalyticsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_public_operators_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.list_public_operators), "__call__") as call:
        ...
        await client.list_public_operators(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resolve_operator_info_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.resolve_operator_info), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(lva_service.ResolveOperatorInfoResponse())
        await client.resolve_operator_info(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_operators_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_operators), "__call__") as call:
        ...
        await client.list_operators(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_operator_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_operator), "__call__") as call:
        ...
        await client.get_operator(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_operator_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_operator), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_operator(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_operator_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_operator), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_operator(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_operator_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_operator), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_operator(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_analyses_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_analyses), "__call__") as call:
        ...
        await client.list_analyses(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_analysis_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_analysis), "__call__") as call:
        ...
        await client.get_analysis(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_analysis_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_analysis), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_analysis(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_analysis_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_analysis), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_analysis(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_analysis_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_analysis), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_analysis(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_run_process_empty_call_grpc_asyncio():
    client = LiveVideoAnalyticsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_run_process), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.batch_run_process(request=None)
...
def test_transport_kind_rest():
    transport = LiveVideoAnalyticsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_public_operators_rest_bad_request(request_type=lva_service.ListPublicOperatorsRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_public_operators_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_public_operators_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_public_operators") as post, mock.patch.object(
        transports.LiveVideoAnalyticsRestInterceptor, "post_list_public_operators_with_metadata"
        ...
        pb_message = lva_service.ListPublicOperatorsRequest.pb(lva_service.ListPublicOperatorsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_service.ListPublicOperatorsResponse.to_json(lva_service.ListPublicOperatorsResponse())
        ...
        post_with_metadata.return_value = lva_service.ListPublicOperatorsResponse(), metadata
...
def test_resolve_operator_info_rest_bad_request(request_type=lva_service.ResolveOperatorInfoRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_resolve_operator_info_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_resolve_operator_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_resolve_operator_info") as post, mock.patch.object(
        transports.LiveVideoAnalyticsRestInterceptor, "post_resolve_operator_info_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_service.ResolveOperatorInfoResponse.to_json(lva_service.ResolveOperatorInfoResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = lva_service.ResolveOperatorInfoResponse(), metadata
...
def test_list_operators_rest_bad_request(request_type=lva_service.ListOperatorsRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_operators_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_operators_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_operators") as post, mock.patch.object(
        transports.LiveVideoAnalyticsRestInterceptor, "post_list_operators_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_service.ListOperatorsResponse.to_json(lva_service.ListOperatorsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = lva_service.ListOperatorsResponse(), metadata
...
def test_get_operator_rest_bad_request(request_type=lva_service.GetOperatorRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_operator_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_get_operator") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_resources.Operator.to_json(lva_resources.Operator())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = lva_resources.Operator(), metadata
...
def test_create_operator_rest_bad_request(request_type=lva_service.CreateOperatorRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_operator_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
            ...
            "attributes": [
                {
                    ...
                    "type_": "type__value",
                    "default_value": {"i": 105, "f": 0.10200000000000001, "b": True, "s": b"s_blob"},
                }
            ],
            "resources": {
                "cpu": "cpu_value",
...
def test_create_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_create_operator_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_operator_rest_bad_request(request_type=lva_service.UpdateOperatorRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_operator_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_update_operator_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_operator_rest_bad_request(request_type=lva_service.DeleteOperatorRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/operators/sample3"}
    request = request_type(**request_init)
...
def test_delete_operator_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_operator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_delete_operator_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_analyses_rest_bad_request(request_type=lva_service.ListAnalysesRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_analyses_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_analyses_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_analyses") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_service.ListAnalysesResponse.to_json(lva_service.ListAnalysesResponse())
        req.return_value.content = return_value
...
def test_get_analysis_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_get_analysis") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_resources.Analysis.to_json(lva_resources.Analysis())
        req.return_value.content = return_value
...
def test_create_analysis_rest_bad_request(request_type=lva_service.CreateAnalysisRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_create_analysis_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
            ...
            "analyzers": [
                {
                    ...
                    "operator_option": {"tag": "tag_value", "registry": "registry_value"},
                }
            ]
        },
...
def test_create_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_create_analysis_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_analysis_rest_bad_request(request_type=lva_service.UpdateAnalysisRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_analysis_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_update_analysis_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_analysis_rest_bad_request(request_type=lva_service.DeleteAnalysisRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3/analyses/sample4"}
    request = request_type(**request_init)
...
def test_delete_analysis_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_delete_analysis_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_processes_rest_bad_request(request_type=lva_service.ListProcessesRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_list_processes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_list_processes") as post, mock.patch.object(
        transports.LiveVideoAnalyticsRestInterceptor, "post_list_processes_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_service.ListProcessesResponse.to_json(lva_service.ListProcessesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = lva_service.ListProcessesResponse(), metadata
...
def test_get_process_rest_bad_request(request_type=lva_service.GetProcessRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LiveVideoAnalyticsRestInterceptor, "post_get_process") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = lva_resources.Process.to_json(lva_resources.Process())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = lva_resources.Process(), metadata
...
def test_create_process_rest_bad_request(request_type=lva_service.CreateProcessRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_create_process_rest_call_success(request_type):
    ...
    request_init["process"] = {
        ...
        "update_time": {},
        "analysis": "analysis_value",
        "attribute_overrides": ["attribute_overrides_value1", "attribute_overrides_value2"],
...
def test_create_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_create_process_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_process_rest_bad_request(request_type=lva_service.UpdateProcessRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_update_process_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_process_rest_bad_request(request_type=lva_service.DeleteProcessRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3/processes/sample4"}
    request = request_type(**request_init)
...
def test_delete_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_delete_process_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_run_process_rest_bad_request(request_type=lva_service.BatchRunProcessRequest):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_batch_run_process_rest_call_success(request_type):
    client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_run_process_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.LiveVideoAnalyticsRestInterceptor, "post_batch_run_process_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_public_operators_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resolve_operator_info_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_operators_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_operator_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_operator_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_operator_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_operator_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_analyses_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_analysis_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_analysis_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_analysis_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_analysis_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_run_process_empty_call_rest():
    client = LiveVideoAnalyticsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_live_video_analytics_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.LiveVideoAnalyticsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_live_video_analytics_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.visionai_v1.services.live_video_analytics.transports.LiveVideoAnalyticsTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.LiveVideoAnalyticsGrpcTransport, grpc_helpers), (transports.LiveVideoAnalyticsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_live_video_analytics_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_live_video_analytics_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.LiveVideoAnalyticsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.LiveVideoAnalyticsGrpcTransport, transports.LiveVideoAnalyticsGrpcAsyncIOTransport])
def test_live_video_analytics_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_ctx():
    ...
    for transport in transports:
        client = LiveVideoAnalyticsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

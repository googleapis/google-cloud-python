...
class visionaiCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'generate_hls_uri': ('name', 'temporal_partitions', ),
        ...
        'list_assets': ('parent', 'page_size', 'page_token', ),
        'list_clusters': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_corpora': ('parent', 'page_size', 'page_token', ),
        ...
        'search_assets': ('corpus', 'page_size', 'page_token', 'content_time_ranges', 'criteria', 'facet_selections', 'result_annotation_keys', ),

...
class _BaseStreamingServiceRestTransport(StreamingServiceTransport):
    """Base REST backend transport for StreamingService.
    ...
    class _BaseReceiveEvents:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

    class _BaseReceivePackets:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

    class _BaseReleaseLease:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseStreamingServiceRestTransport",)

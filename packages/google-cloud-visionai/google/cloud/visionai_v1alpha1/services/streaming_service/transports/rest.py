...
class StreamingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_acquire_lease(
        ...
        streaming_service.AcquireLeaseRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_release_lease(
        ...
        streaming_service.ReleaseLeaseRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_renew_lease(
        ...
        streaming_service.RenewLeaseRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[StreamingServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStreamingServiceRestTransport._BaseGetIamPolicy,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStreamingServiceRestTransport._BaseSetIamPolicy,

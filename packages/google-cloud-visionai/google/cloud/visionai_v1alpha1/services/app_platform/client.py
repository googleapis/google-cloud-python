...
class AppPlatformClient(metaclass=AppPlatformClientMeta):
    ...
    def application_path(
        ...
        return "projects/{project}/locations/{location}/applications/{application}".format(
            project=project,
            location=location,
    ...
    def parse_application_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/applications/(?P<application>.+?)$", path)
    ...
    def parse_draft_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/applications/(?P<application>.+?)/drafts/(?P<draft>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_instance_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/applications/(?P<application>.+?)/instances/(?P<instance>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AppPlatformClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AppPlatformClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AppPlatformTransport, Callable[..., AppPlatformTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AppPlatformClient._read_environment_variables()
        self._client_cert_source = AppPlatformClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AppPlatformClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AppPlatformTransport], Callable[..., AppPlatformTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.visionai_v1alpha1.AppPlatformClient`.",
                    extra={
    ...
    def list_applications(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.ListApplicationsRequest, dict]):
    ...
    def get_application(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.GetApplicationRequest, dict]):
    ...
    def create_application(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.CreateApplicationRequest, dict]):
    ...
    def update_application(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UpdateApplicationRequest, dict]):
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("application.name", request.application.name),)),)
    ...
    def delete_application(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.DeleteApplicationRequest, dict]):
    ...
    def deploy_application(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.DeployApplicationRequest, dict]):
    ...
    def undeploy_application(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UndeployApplicationRequest, dict]):
    ...
    def add_application_stream_input(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.AddApplicationStreamInputRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.add_application_stream_input]
    ...
    def remove_application_stream_input(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.RemoveApplicationStreamInputRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_application_stream_input]
    ...
    def update_application_stream_input(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UpdateApplicationStreamInputRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_application_stream_input]
    ...
    def list_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.ListInstancesRequest, dict]):
                The request object. Message for requesting list of
                Instances.
            parent (str):
                Required. Parent value for
    ...
    def get_instance(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.GetInstanceRequest, dict]):
    ...
    def create_application_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.CreateApplicationInstancesRequest, dict]):
                The request object. Message for adding stream input to an
                Application.
            name (str):
                Required. the name of the application
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_application_instances]
    ...
    def delete_application_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.DeleteApplicationInstancesRequest, dict]):
                The request object. Message for removing stream input
                from an Application.
            name (str):
                Required. the name of the application
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_application_instances]
    ...
    def update_application_instances(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UpdateApplicationInstancesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_application_instances]
    ...
    def list_drafts(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.ListDraftsRequest, dict]):
                The request object. Message for requesting list of
                Drafts.
            parent (str):
                Required. Parent value for
    ...
    def get_draft(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.GetDraftRequest, dict]):
    ...
    def create_draft(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.CreateDraftRequest, dict]):
    ...
    def update_draft(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UpdateDraftRequest, dict]):
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("draft.name", request.draft.name),)),)
    ...
    def delete_draft(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.DeleteDraftRequest, dict]):
    ...
    def list_processors(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.ListProcessorsRequest, dict]):
                The request object. Message for requesting list of
                Processors.
            parent (str):
                Required. Parent value for
    ...
    def list_prebuilt_processors(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.ListPrebuiltProcessorsRequest, dict]):
    ...
    def get_processor(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.GetProcessorRequest, dict]):
    ...
    def create_processor(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.CreateProcessorRequest, dict]):
    ...
    def update_processor(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UpdateProcessorRequest, dict]):
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("processor.name", request.processor.name),)),)
    ...
    def delete_processor(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.DeleteProcessorRequest, dict]):

...
class LiveVideoAnalyticsAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = LiveVideoAnalyticsClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(LiveVideoAnalyticsAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            LiveVideoAnalyticsAsyncClient: The constructed client.
        """
        sa_file_func = LiveVideoAnalyticsClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(LiveVideoAnalyticsAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return LiveVideoAnalyticsClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore

...
class ListAnalysesPager:
    ...
    :class:`google.cloud.visionai_v1alpha1.types.ListAnalysesResponse` object, and
    ...
    All the usual :class:`google.cloud.visionai_v1alpha1.types.ListAnalysesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.visionai_v1alpha1.types.ListAnalysesRequest):
                The initial request object.
            response (google.cloud.visionai_v1alpha1.types.ListAnalysesResponse):

...
class LiveVideoAnalyticsClient(metaclass=LiveVideoAnalyticsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or LiveVideoAnalyticsClient._get_api_endpoint(
    ...
    def update_analysis(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("analysis.name", request.analysis.name),)),)

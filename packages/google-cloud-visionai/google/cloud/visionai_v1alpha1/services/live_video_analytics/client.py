...
from google.cloud.visionai_v1alpha1.services.live_video_analytics import pagers
...
class LiveVideoAnalyticsClient(metaclass=LiveVideoAnalyticsClientMeta):
    ...
    def analysis_path(
        ...
        return "projects/{project}/locations/{location}/clusters/{cluster}/analyses/{analysis}".format(
            project=project,
            location=location,
            cluster=cluster,
            analysis=analysis,
    ...
    def parse_analysis_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/analyses/(?P<analysis>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = LiveVideoAnalyticsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = LiveVideoAnalyticsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = LiveVideoAnalyticsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = LiveVideoAnalyticsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or LiveVideoAnalyticsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.visionai_v1alpha1.LiveVideoAnalyticsClient`.",
                    extra={
    ...
    def list_analyses(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.ListAnalysesRequest, dict]):
    ...
    def get_analysis(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.GetAnalysisRequest, dict]):
        ...
        Returns:
            google.cloud.visionai_v1alpha1.types.Analysis:
    ...
    def create_analysis(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.CreateAnalysisRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.visionai_v1alpha1.types.Analysis`
    ...
    def update_analysis(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.UpdateAnalysisRequest, dict]):
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                Analysis resource by the update. The
    ...
    def delete_analysis(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.visionai_v1alpha1.types.DeleteAnalysisRequest, dict]):
...
__all__ = ("LiveVideoAnalyticsClient",)

...
from google.cloud.visionai_v1.types import annotations as gcv_annotations
...
class DataType(proto.Enum):
    ...
    Values:
        ...
        PROTO (2):
            ...
            data blob.
        PLACEHOLDER (4):
            A placeholder data type, applicable for the universal input
            processor which supports any data type. This will be
...
class CreateApplicationInstancesRequest(proto.Message):
    ...
    Attributes:
        ...
        application_instances (MutableSequence[google.cloud.visionai_v1.types.ApplicationInstance]):
...
class ListApplicationsResponse(proto.Message):
    ...
    Attributes:
        applications (MutableSequence[google.cloud.visionai_v1.types.Application]):
...
class ApplicationStreamInput(proto.Message):
    ...
    Attributes:
        stream_with_annotation (google.cloud.visionai_v1.types.StreamWithAnnotation):
...
class AddApplicationStreamInputRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            "projects/{project}/locations/{location}/applications/{application}".
        application_stream_inputs (MutableSequence[google.cloud.visionai_v1.types.ApplicationStreamInput]):
...
class RemoveApplicationStreamInputRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            "projects/{project}/locations/{location}/applications/{application}".
        target_stream_inputs (MutableSequence[google.cloud.visionai_v1.types.RemoveApplicationStreamInputRequest.TargetStreamInput]):
...
class ListInstancesResponse(proto.Message):
    ...
    Attributes:
        instances (MutableSequence[google.cloud.visionai_v1.types.Instance]):
...
class ListDraftsResponse(proto.Message):
    ...
    Attributes:
        drafts (MutableSequence[google.cloud.visionai_v1.types.Draft]):
            The list of Draft.
        next_page_token (str):
            A token identifying a page of results the
            server should return.
...
class UpdateDraftRequest(proto.Message):
    r"""Message for updating a Draft.
...
class DeleteDraftRequest(proto.Message):
    r"""Message for deleting a Draft.
...
class ListProcessorsResponse(proto.Message):
    ...
    Attributes:
        processors (MutableSequence[google.cloud.visionai_v1.types.Processor]):
...
class Application(proto.Message):
    ...
    Attributes:
        ...
        application_configs (google.cloud.visionai_v1.types.ApplicationConfigs):
            Application graph configuration.
        runtime_info (google.cloud.visionai_v1.types.Application.ApplicationRuntimeInfo):
            Output only. Application graph runtime info.
            Only exists when application state equals to
            DEPLOYED.
        state (google.cloud.visionai_v1.types.Application.State):
            Output only. State of the application.
        billing_mode (google.cloud.visionai_v1.types.Application.BillingMode):
    ...
    class ApplicationRuntimeInfo(proto.Message):
        ...
        Attributes:
            ...
            global_output_resources (MutableSequence[google.cloud.visionai_v1.types.Application.ApplicationRuntimeInfo.GlobalOutputResource]):
                Globally created resources like warehouse
                dataschemas.
            monitoring_config (google.cloud.visionai_v1.types.Application.ApplicationRuntimeInfo.MonitoringConfig):
...
class ApplicationConfigs(proto.Message):
    ...
    Attributes:
        nodes (MutableSequence[google.cloud.visionai_v1.types.Node]):
            A list of nodes  in the application graph.
        event_delivery_config (google.cloud.visionai_v1.types.ApplicationConfigs.EventDeliveryConfig):
...
class Node(proto.Message):
    ...
    Attributes:
        ...
        node_config (google.cloud.visionai_v1.types.ProcessorConfig):
            Node config.
        processor (str):
            Processor name refer to the chosen processor
            resource.
        parents (MutableSequence[google.cloud.visionai_v1.types.Node.InputEdge]):
...
class Instance(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.visionai_v1.types.Instance.State):
            State of the instance.
    """

    class InstanceType(proto.Enum):
        r"""All the supported instance types.
    ...
    class InputResource(proto.Message):
        ...
        Attributes:
            ...
            annotations (google.cloud.visionai_v1.types.ResourceAnnotations):
...
class Processor(proto.Message):
    ...
    Attributes:
        ...
        supported_annotation_types (MutableSequence[google.cloud.visionai_v1.types.StreamAnnotationType]):
...
class ProcessorIOSpec(proto.Message):
    ...
    Attributes:
        ...
        graph_output_channel_specs (MutableSequence[google.cloud.visionai_v1.types.ProcessorIOSpec.GraphOutputChannelSpec]):
            ...
            current processor.
        instance_resource_input_binding_specs (MutableSequence[google.cloud.visionai_v1.types.ProcessorIOSpec.InstanceResourceInputBindingSpec]):
            The input resource that needs to be fed from
            the application instance.
        instance_resource_output_binding_specs (MutableSequence[google.cloud.visionai_v1.types.ProcessorIOSpec.InstanceResourceOutputBindingSpec]):
...
class CustomProcessorSourceInfo(proto.Message):
    ...
    class ProductRecognizerArtifact(proto.Message):
        r"""Message describes product recognizer artifact.
        ...
        Attributes:
            ...
            vertex_model (str):
                Optional. The resource name of embedding
                model hosted in Vertex AI Platform.
        """

        retail_product_recognition_index: str = proto.Field(
            proto.STRING,
            number=1,
        )
    ...
    class ModelSchema(proto.Message):
        ...
        Attributes:
            ...
            parameters_schema (google.cloud.visionai_v1.types.GcsSource):
                Cloud Storage location to a YAML file that
                defines the prediction and explanation
                parameters.
            predictions_schema (google.cloud.visionai_v1.types.GcsSource):
                Cloud Storage location to a YAML file that
    ...
    product_recognizer_artifact: ProductRecognizerArtifact = proto.Field(
        proto.MESSAGE,
        number=3,
        oneof="artifact_path",
...
class ProcessorConfig(proto.Message):
    ...
    Attributes:
        video_stream_input_config (google.cloud.visionai_v1.types.VideoStreamInputConfig):
            Configs of stream input processor.

            This field is a member of `oneof`_ ``processor_config``.
        ai_enabled_devices_input_config (google.cloud.visionai_v1.types.AIEnabledDevicesInputConfig):
            Config of AI-enabled input devices.

            This field is a member of `oneof`_ ``processor_config``.
        media_warehouse_config (google.cloud.visionai_v1.types.MediaWarehouseConfig):
            Configs of media warehouse processor.

            This field is a member of `oneof`_ ``processor_config``.
        person_blur_config (google.cloud.visionai_v1.types.PersonBlurConfig):
            Configs of person blur processor.

            This field is a member of `oneof`_ ``processor_config``.
        occupancy_count_config (google.cloud.visionai_v1.types.OccupancyCountConfig):
            Configs of occupancy count processor.

            This field is a member of `oneof`_ ``processor_config``.
        person_vehicle_detection_config (google.cloud.visionai_v1.types.PersonVehicleDetectionConfig):
            Configs of Person Vehicle Detection
            processor.

            This field is a member of `oneof`_ ``processor_config``.
        vertex_automl_vision_config (google.cloud.visionai_v1.types.VertexAutoMLVisionConfig):
            Configs of Vertex AutoML vision processor.

            This field is a member of `oneof`_ ``processor_config``.
        vertex_automl_video_config (google.cloud.visionai_v1.types.VertexAutoMLVideoConfig):
            Configs of Vertex AutoML video processor.

            This field is a member of `oneof`_ ``processor_config``.
        vertex_custom_config (google.cloud.visionai_v1.types.VertexCustomConfig):
            Configs of Vertex Custom processor.

            This field is a member of `oneof`_ ``processor_config``.
        general_object_detection_config (google.cloud.visionai_v1.types.GeneralObjectDetectionConfig):
            Configs of General Object Detection
            processor.

            This field is a member of `oneof`_ ``processor_config``.
        big_query_config (google.cloud.visionai_v1.types.BigQueryConfig):
            Configs of BigQuery processor.

            This field is a member of `oneof`_ ``processor_config``.
        gcs_output_config (google.cloud.visionai_v1.types.GcsOutputConfig):
            Configs of Cloud Storage output processor.

            This field is a member of `oneof`_ ``processor_config``.
        product_recognizer_config (google.cloud.visionai_v1.types.ProductRecognizerConfig):
            Runtime configs of Product Recognizer
            processor.
        ...
        universal_input_config (google.cloud.visionai_v1.types.UniversalInputConfig):
            ...
            This field is a member of `oneof`_ ``processor_config``.
        experimental_config (google.protobuf.struct_pb2.Struct):
            Experimental configurations. Structured
            object containing not-yet-stable processor
            parameters.
    """
    ...
    product_recognizer_config: "ProductRecognizerConfig" = proto.Field(
        proto.MESSAGE,
        number=21,
        oneof="processor_config",
    ...
    tag_recognizer_config: "TagRecognizerConfig" = proto.Field(
        proto.MESSAGE,
        number=25,
        oneof="processor_config",
        message="TagRecognizerConfig",
    )
    universal_input_config: "UniversalInputConfig" = proto.Field(
        proto.MESSAGE,
        number=28,
        oneof="processor_config",
        message="UniversalInputConfig",
    )
    experimental_config: struct_pb2.Struct = proto.Field(
        proto.MESSAGE,
        number=26,
...
class StreamWithAnnotation(proto.Message):
    ...
    Attributes:
        ...
        application_annotations (MutableSequence[google.cloud.visionai_v1.types.StreamAnnotation]):
            ...
            application.
        node_annotations (MutableSequence[google.cloud.visionai_v1.types.StreamWithAnnotation.NodeAnnotation]):
...
class VideoStreamInputConfig(proto.Message):
    ...
    Attributes:
        ...
        streams_with_annotation (MutableSequence[google.cloud.visionai_v1.types.StreamWithAnnotation]):
...
class PersonBlurConfig(proto.Message):
    ...
    Attributes:
        person_blur_type (google.cloud.visionai_v1.types.PersonBlurConfig.PersonBlurType):
            Person blur type.
        faces_only (bool):
...
class VertexCustomConfig(proto.Message):
    ...
    Attributes:
        ...
        dedicated_resources (google.cloud.visionai_v1.types.DedicatedResources):
        ...
        dynamic_config_input_topic (str):
            ...
            processor will subscribe to given topic, only pub/sub topic
            is supported now. Example channel:
            //pubsub.googleapis.com/projects/visionai-testing-stable/topics/test-topic
            message schema should be: message Message { // The ID of the
            stream that associates with the application instance. string
            stream_id = 1; // The target fps. By default, the custom
            processor will *not* send any data to the Vertex Prediction
            container. Note that once the dynamic_config_input_topic is
            set, max_prediction_fps will not work and be preceded by the
    ...
    dynamic_config_input_topic: str = proto.Field(
        proto.STRING,
        number=6,
        optional=True,
    )
...
class GcsOutputConfig(proto.Message):
    r"""Message describing GcsOutputConfig.

    Attributes:
        gcs_path (str):
            The Cloud Storage path for Vision AI Platform
            to ingest annotations to.
    """
...
class UniversalInputConfig(proto.Message):
    r"""Message describing UniversalInputConfig."""
...
class MachineSpec(proto.Message):
    ...
    Attributes:
        machine_type (str):
            ...
            field is required.
        accelerator_type (google.cloud.visionai_v1.types.AcceleratorType):
...
class DedicatedResources(proto.Message):
    ...
    Attributes:
        machine_spec (google.cloud.visionai_v1.types.MachineSpec):
        ...
        autoscaling_metric_specs (MutableSequence[google.cloud.visionai_v1.types.AutoscalingMetricSpec]):
...
class ProductRecognizerConfig(proto.Message):
    r"""Message describing ProductRecognizerConfig.

    Attributes:
        retail_endpoint (str):
            The resource name of retail endpoint to use.
        recognition_confidence_threshold (float):
            Confidence threshold to filter detection
            results. If not set, a system default value will
            be used.
    """

    retail_endpoint: str = proto.Field(
        proto.STRING,
        number=1,
    )
    recognition_confidence_threshold: float = proto.Field(
        proto.FLOAT,
        number=2,
    )


class TagRecognizerConfig(proto.Message):
    r"""Message describing TagRecognizerConfig.
    ...
    Attributes:
        ...
        tag_parsing_config (google.cloud.visionai_v1.types.TagParsingConfig):
            Configuration to customize how tags are
            parsed.
    """

    entity_detection_confidence_threshold: float = proto.Field(
        proto.FLOAT,
        number=1,
    )
    tag_parsing_config: "TagParsingConfig" = proto.Field(
        proto.MESSAGE,
        number=2,
...
class TagParsingConfig(proto.Message):
    r"""Configuration for tag parsing.

    Attributes:
        entity_parsing_configs (MutableSequence[google.cloud.visionai_v1.types.TagParsingConfig.EntityParsingConfig]):
            Each tag entity class may have an optional
            EntityParsingConfig which is used to help parse
            the entities of the class.
    """

    class EntityParsingConfig(proto.Message):
        r"""Configuration for parsing a tag entity class.

        Attributes:
            entity_class (str):
                Required. The tag entity class name. This
                should match the class name produced by the tag
        ...
        class EntityMatchingStrategy(proto.Enum):
            r"""Type of entity matching strategy.

            Values:
                ENTITY_MATCHING_STRATEGY_UNSPECIFIED (0):
                    If unspecified, multi-line matching will be
                    used by default.
        ...
        entity_matching_strategy: "TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy" = proto.Field(
            proto.ENUM,
            number=3,
            enum="TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy",
        )

    entity_parsing_configs: MutableSequence[EntityParsingConfig] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,

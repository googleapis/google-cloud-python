...
from google.cloud.visionai_v1._compat import (
    get_api_endpoint,
...
class WarehouseClient(metaclass=WarehouseClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "warehouse-visionai.{UNIVERSE_DOMAIN}"
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=WarehouseClient._DEFAULT_ENDPOINT_TEMPLATE,

...
class WarehouseClient(metaclass=WarehouseClientMeta):
    ...
    def parse_asset_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/assets/(?P<asset>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_collection_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/collections/(?P<collection>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_corpus_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_data_schema_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/dataSchemas/(?P<data_schema>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_index_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/indexes/(?P<index>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_search_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/searchConfigs/(?P<search_config>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_search_hypernym_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project_number>.+?)/locations/(?P<location>.+?)/corpora/(?P<corpus>.+?)/searchHypernyms/(?P<search_hypernym>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = WarehouseClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = WarehouseClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, WarehouseTransport, Callable[..., WarehouseTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = WarehouseClient._read_environment_variables()
        self._client_cert_source = WarehouseClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = WarehouseClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[WarehouseTransport], Callable[..., WarehouseTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.visionai_v1.WarehouseClient`.",
                    extra={
    ...
    def update_asset(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("asset.name", request.asset.name),)),)
    ...
    def view_indexed_assets(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("index", request.index),)),)
    ...
    def update_index(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("index.name", request.index.name),)),)
    ...
    def update_data_schema(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("data_schema.name", request.data_schema.name),)),)
    ...
    def update_annotation(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("annotation.name", request.annotation.name),)),)
    ...
    def update_search_config(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("search_config.name", request.search_config.name),)),)
    ...
    def update_search_hypernym(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("search_hypernym.name", request.search_hypernym.name),)),)
    ...
    def search_assets(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("corpus", request.corpus),)),)
    ...
    def search_index_endpoint(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("index_endpoint", request.index_endpoint),)),)
    ...
    def update_index_endpoint(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("index_endpoint.name", request.index_endpoint.name),)),)
    ...
    def update_collection(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("collection.name", request.collection.name),)),)
    ...
    def add_collection_item(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("item.collection", request.item.collection),)),)
    ...
    def view_collection_items(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("collection", request.collection),)),)

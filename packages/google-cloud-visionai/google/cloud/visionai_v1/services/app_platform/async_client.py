...
class AppPlatformAsyncClient:
    ...
    common_billing_account_path = staticmethod(
        AppPlatformClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        AppPlatformClient.parse_common_billing_account_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = AppPlatformClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AppPlatformAsyncClient: The constructed client.
        """
        sa_file_func = AppPlatformClient.from_service_account_file.__func__  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.visionai_v1.AppPlatformAsyncClient`.",
                extra={
    ...
    async def list_applications(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.ListApplicationsRequest, dict]]):
    ...
    async def create_application(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.CreateApplicationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            application (:class:`google.cloud.visionai_v1.types.Application`):
    ...
    async def update_application(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.UpdateApplicationRequest, dict]]):
    ...
    async def delete_application(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.DeleteApplicationRequest, dict]]):
    ...
    async def deploy_application(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.DeployApplicationRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.deploy_application
        ]
    ...
    async def undeploy_application(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.UndeployApplicationRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.undeploy_application
        ]
    ...
    async def add_application_stream_input(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.AddApplicationStreamInputRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.add_application_stream_input
        ]
    ...
    async def remove_application_stream_input(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.RemoveApplicationStreamInputRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.remove_application_stream_input
        ]
    ...
    async def update_application_stream_input(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.UpdateApplicationStreamInputRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_application_stream_input
        ]
    ...
    async def list_instances(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.ListInstancesRequest, dict]]):
                The request object. Message for requesting list of
                Instances.
            parent (:class:`str`):
                Required. Parent value for
    ...
    async def create_application_instances(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.CreateApplicationInstancesRequest, dict]]):
                The request object. Message for adding stream input to an
                Application.
            name (:class:`str`):
                Required. the name of the application
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.create_application_instances
        ]
    ...
    async def delete_application_instances(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.DeleteApplicationInstancesRequest, dict]]):
                The request object. Message for removing stream input
                from an Application.
            name (:class:`str`):
                Required. the name of the application
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_application_instances
        ]
    ...
    async def update_application_instances(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.UpdateApplicationInstancesRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            application_instances (:class:`MutableSequence[google.cloud.visionai_v1.types.UpdateApplicationInstancesRequest.UpdateApplicationInstance]`):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_application_instances
        ]
    ...
    async def list_drafts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.ListDraftsRequest, dict]]):
                The request object. Message for requesting list of
                Drafts.
            parent (:class:`str`):
                Required. Parent value for
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_drafts
        ]
    ...
    async def get_draft(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_draft
        ]
    ...
    async def create_draft(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.CreateDraftRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            draft (:class:`google.cloud.visionai_v1.types.Draft`):
                Required. The resource being created.
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.create_draft
        ]
    ...
    async def update_draft(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.UpdateDraftRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_draft
        ]
    ...
    async def delete_draft(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.DeleteDraftRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_draft
        ]
    ...
    async def list_processors(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.ListProcessorsRequest, dict]]):
                The request object. Message for requesting list of
                Processors.
            parent (:class:`str`):
                Required. Parent value for
    ...
    async def list_prebuilt_processors(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.ListPrebuiltProcessorsRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_prebuilt_processors
        ]
    ...
    async def create_processor(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.CreateProcessorRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            processor (:class:`google.cloud.visionai_v1.types.Processor`):
                Required. The resource being created.
    ...
    async def update_processor(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.UpdateProcessorRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_processor
        ]
    ...
    async def delete_processor(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.visionai_v1.types.DeleteProcessorRequest, dict]]):
...
__all__ = ("AppPlatformAsyncClient",)

...
from google.cloud.visionai_v1.types import streaming_resources, streaming_service
...
class StreamingServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = StreamingServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    common_billing_account_path = staticmethod(
        StreamingServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        StreamingServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(StreamingServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        StreamingServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        StreamingServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        StreamingServiceClient.parse_common_organization_path
    )
    ...
    parse_common_location_path = staticmethod(
        StreamingServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = StreamingServiceClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            StreamingServiceAsyncClient: The constructed client.
        """
        sa_file_func = StreamingServiceClient.from_service_account_file.__func__  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.visionai_v1.StreamingServiceAsyncClient`.",
                extra={
    ...
    def receive_packets(
        self,
        requests: Optional[
            AsyncIterator[streaming_service.ReceivePacketsRequest]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def receive_events(
        self,
        requests: Optional[
            AsyncIterator[streaming_service.ReceiveEventsRequest]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
...
__all__ = ("StreamingServiceAsyncClient",)

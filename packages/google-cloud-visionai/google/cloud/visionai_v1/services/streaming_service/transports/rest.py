        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.visionai_v1.StreamingServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.visionai.v1.StreamingService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.visionai_v1.StreamingServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.visionai.v1.StreamingService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.visionai_v1.StreamingServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.visionai.v1.StreamingService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.visionai_v1.StreamingServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.visionai.v1.StreamingService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,

...
class _BaseLiveVideoAnalyticsRestTransport(LiveVideoAnalyticsTransport):
    """Base REST backend transport for LiveVideoAnalytics.
    ...
    class _BaseListPublicOperators:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseResolveOperatorInfo:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseLiveVideoAnalyticsRestTransport",)

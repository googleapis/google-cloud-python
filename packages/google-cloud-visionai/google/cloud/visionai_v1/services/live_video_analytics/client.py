...
class LiveVideoAnalyticsClient(metaclass=LiveVideoAnalyticsClientMeta):
    ...
    def operator_path(
        ...
        return "projects/{project}/locations/{location}/operators/{operator}".format(
            project=project,
            location=location,
            operator=operator,
        )
    ...
    def parse_operator_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/operators/(?P<operator>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def process_path(
        ...
        return "projects/{project}/locations/{location}/clusters/{cluster}/processes/{process}".format(
            project=project,
            location=location,
            cluster=cluster,
            process=process,
    ...
    def parse_process_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/processes/(?P<process>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                Operator resource by the update. The
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Required. Field mask is used to specify
                the fields to be overwritten in the
                Process resource by the update. The
                fields specified in the update_mask are
                relative to the resource, not the full
                request. A field will be overwritten if
                it is in the mask. If the user does not

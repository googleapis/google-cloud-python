...
##
# google-cloud-visionai documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-visionai",
...
htmlhelp_basename = "google-cloud-visionai-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-visionai.tex",
        "google-cloud-visionai Documentation",
        author,
        "manual",
    )
]

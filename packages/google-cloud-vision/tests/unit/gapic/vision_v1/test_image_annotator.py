...
from google.cloud.vision_v1.services.image_annotator import (
    ImageAnnotatorAsyncClient,
    ImageAnnotatorClient,
    transports,
)
from google.cloud.vision_v1.types import geometry, image_annotator, product_search
...
def test_batch_annotate_images_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/images:annotate" % client.transport._host, args[1]
        )
...
def test_batch_annotate_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/files:annotate" % client.transport._host, args[1]
        )
...
def test_async_batch_annotate_images_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/images:asyncBatchAnnotate" % client.transport._host, args[1]
        )
...
def test_async_batch_annotate_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/files:asyncBatchAnnotate" % client.transport._host, args[1]
        )

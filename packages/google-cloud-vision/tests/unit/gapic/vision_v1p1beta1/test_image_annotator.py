...
from google.cloud.vision_v1p1beta1.services.image_annotator import (
...
from google.cloud.vision_v1p1beta1.services.image_annotator.transports.base import (
...
def test_image_annotator_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.vision_v1p1beta1.services.image_annotator.transports.ImageAnnotatorGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_image_annotator_base_transport():
    ...
    with mock.patch(
        "google.cloud.vision_v1p1beta1.services.image_annotator.transports.ImageAnnotatorTransport.__init__"
    ) as Transport:

...
def test_batch_annotate_files_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_annotate_files in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.batch_annotate_files] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_batch_annotate_files_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_annotate_files
            in client._client._transport._wrapped_methods
        )
...
def test_async_batch_annotate_images_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.async_batch_annotate_images
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_async_batch_annotate_images_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.async_batch_annotate_images
            in client._client._transport._wrapped_methods
        )
...
def test_batch_annotate_images_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1p4beta1/images:annotate" % client.transport._host, args[1]
        )
...
def test_batch_annotate_files_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchAnnotateFiles,
...
def test_batch_annotate_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1p4beta1/files:annotate" % client.transport._host, args[1]
        )
...
def test_async_batch_annotate_images_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAsyncBatchAnnotateImages,
...
def test_async_batch_annotate_images_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1p4beta1/images:asyncBatchAnnotate" % client.transport._host, args[1]
        )
...
def test_async_batch_annotate_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1p4beta1/files:asyncBatchAnnotate" % client.transport._host, args[1]
        )

...
__lazy_modules__ = {
    "google.cloud.vision_v1p2beta1.services.image_annotator",
    "google.cloud.vision_v1p2beta1.types.geometry",
    "google.cloud.vision_v1p2beta1.types.image_annotator",
    "google.cloud.vision_v1p2beta1.types.text_annotation",
    "google.cloud.vision_v1p2beta1.types.web_detection",
}
...
api_core.check_python_version("google.cloud.vision_v1p2beta1")

...
class ImageAnnotatorGrpcTransport(ImageAnnotatorTransport):
    ...
    def async_batch_annotate_files(
        ...
        Run async image detection and annotation for a list of
        generic files (e.g. PDF) which may contain multiple
        pages and multiple images per page. Progress and results

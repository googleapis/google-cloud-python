...
class ProductSearchGrpcAsyncIOTransport(ProductSearchTransport):
    ...
    - The API has a collection of `ProductSet
      <google.cloud.vision.v1.ProductSet>`__ resources, named ``projects/*/locations/*/productSets/*``,
      which acts as a way to put different products into groups to limit
      identification. In parallel,  - The API has a collection of
      `Product <google.cloud.vision.v1.Product>`__ resources, named
      ``projects/*/locations/*/products/*``  - Each `Product <google.cloud.vision.v1.Product>`__ has
      a collection of `ReferenceImage
      <google.cloud.vision.v1.ReferenceImage>`__ resources, named

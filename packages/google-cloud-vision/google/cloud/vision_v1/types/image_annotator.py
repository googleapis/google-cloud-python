    ...
    class Type(proto.Enum):
        ...
        Values:
            ...
            TEXT_DETECTION (5):
                ...
                Text detection
                is optimized for areas of text within a larger image; if the
                image is
...
class ImageSource(proto.Message):
    ...
    Attributes:
        ...
        image_uri (str):
            ...
            images from
            HTTP/HTTPS URLs, Google cannot guarantee that the request
            will be
            completed. Your request may fail if the specified host
            denies the
...
class GcsDestination(proto.Message):
    ...
    Attributes:
        uri (str):
            ...
            stored. Results
            will be in JSON format and preceded by its corresponding
            input URI prefix.
            This field can either represent a gcs file prefix or gcs
            directory. In
            either case, the uri should be unique because in order to
            get all of the
            output files, you will need to do a wildcard gcs search on
            the uri prefix
            you provide.

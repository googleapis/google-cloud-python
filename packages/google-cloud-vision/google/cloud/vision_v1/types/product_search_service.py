...
class ImportProductSetsGcsSource(proto.Message):
    ...
    Attributes:
        csv_file_uri (str):
            ...
            to `display_name <google.cloud.vision.v1.Product.display_name>`__, the ``product-category`` column refers to
            `product_category <google.cloud.vision.v1.Product.product_category>`__, and the ``labels`` column refers to
            `product_labels <google.cloud.vision.v1.Product.product_labels>`__.
            ...
            system sets the `display_name <google.cloud.vision.v1.Product.display_name>`__ field for the product to a
            ...
            the CSV file that includes the same product information, and
            the ``bounding-poly`` values for each region of interest.

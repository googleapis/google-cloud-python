...
__lazy_modules__ = {
    ...
    "google.cloud.vision_v1.services.product_search",
    "google.cloud.vision_v1.types.geometry",
    "google.cloud.vision_v1.types.image_annotator",
    "google.cloud.vision_v1.types.product_search",
    "google.cloud.vision_v1.types.product_search_service",
    "google.cloud.vision_v1.types.text_annotation",
    "google.cloud.vision_v1.types.web_detection",
}
...
api_core.check_python_version("google.cloud.vision_v1")
api_core.check_dependency_versions("google.cloud.vision_v1")

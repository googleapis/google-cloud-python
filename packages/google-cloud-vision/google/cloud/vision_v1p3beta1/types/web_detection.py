...
class WebDetection(proto.Message):
    ...
    Attributes:
        web_entities (Sequence[google.cloud.vision_v1p3beta1.types.WebDetection.WebEntity]):
            Deduced entities from similar images on the
            Internet.
        full_matching_images (Sequence[google.cloud.vision_v1p3beta1.types.WebDetection.WebImage]):
            Fully matching images from the Internet.
            Can include resized copies of the query image.
        partial_matching_images (Sequence[google.cloud.vision_v1p3beta1.types.WebDetection.WebImage]):
            ...
            crops.
        pages_with_matching_images (Sequence[google.cloud.vision_v1p3beta1.types.WebDetection.WebPage]):
            Web pages containing the matching images from
            the Internet.
        visually_similar_images (Sequence[google.cloud.vision_v1p3beta1.types.WebDetection.WebImage]):
            The visually similar image results.
        best_guess_labels (Sequence[google.cloud.vision_v1p3beta1.types.WebDetection.WebLabel]):

...
class ProductSearchResults(proto.Message):
    ...
    Attributes:
        ...
        product_grouped_results (Sequence[google.cloud.vision_v1p3beta1.types.ProductSearchResults.GroupedResult]):
    ...
    class GroupedResult(proto.Message):
        ...
        Attributes:
            ...
            results (Sequence[google.cloud.vision_v1p3beta1.types.ProductSearchResults.Result]):
                List of results, one for each product match.
            object_annotations (Sequence[google.cloud.vision_v1p3beta1.types.ProductSearchResults.ObjectAnnotation]):

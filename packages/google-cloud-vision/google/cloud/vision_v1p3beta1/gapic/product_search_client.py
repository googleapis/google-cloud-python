...
class ProductSearchClient(object):
    ...
    def update_product_set(self,
        ...
        * Returns INVALID_ARGUMENT if display_name is present in update_mask but
        ...
        Args:
            product_set (Union[dict, ~google.cloud.vision_v1p3beta1.types.ProductSet]): The ProductSet resource which replaces the one on the server.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.vision_v1p3beta1.types.ProductSet`
            update_mask (Union[dict, ~google.cloud.vision_v1p3beta1.types.FieldMask]): The ``FieldMask`` that specifies which fields to
                update.
    ...
    def create_product(self,
        ...
        * Returns INVALID_ARGUMENT if product_category is missing or invalid.
        ...
        Args:
            ...
            product (Union[dict, ~google.cloud.vision_v1p3beta1.types.Product]): The product to create.
                If a dict is provided, it must be of the same form as the protobuf
    ...
    def update_product(self,
        ...
        * Returns INVALID_ARGUMENT if product_category is present in update_mask.
        ...
        Args:
            product (Union[dict, ~google.cloud.vision_v1p3beta1.types.Product]): The Product resource which replaces the one on the server.
                product.name is immutable.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.vision_v1p3beta1.types.Product`
            update_mask (Union[dict, ~google.cloud.vision_v1p3beta1.types.FieldMask]): The ``FieldMask`` that specifies which fields
                to update.
                If update_mask isn't specified, all mutable fields are to be updated.

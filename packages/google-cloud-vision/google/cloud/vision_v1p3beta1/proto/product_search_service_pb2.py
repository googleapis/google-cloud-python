...
Product = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      product_labels:
          ...
          product_labels.  Note that integer values can be provided as
...
CreateProductRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      product_id:
          ...
          ALREADY_EXISTS. Must be at most 128 characters long. It cannot
...
ListProductsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          100.
      page_token:
          The next_page_token returned from a previous List request, if
          any.
  """,
...
CreateReferenceImageRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      reference_image_id:
          ...
          with code ALREADY_EXISTS. Must be at most 128 characters long.
...
ImportProductSetsGcsSource = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      csv_file_uri:
          ...
          columns. 1. image_uri 2, image_id 3. product_set_id 4.
          product_id 5, product_category 6, product_display_name 7,
          labels 8. bounding_poly  Columns 1, 3, 4, and 5 are required,
          other columns are optional. A new ProductSet/Product with the
          same id will be created on the fly if the ProductSet/Product
          specified by product_set_id/product_id does not exist.  The
          image_id field is optional but has to be unique if provided.
          If it is empty, we will automatically assign an unique id to
          the image.  The product_display_name field is optional. If it
          is empty, a space (" ") is used as the place holder for the
          product display_name, which can be updated later through the
          realtime API.  If the Product with product_id already exists,
          the fields product_display_name, product_category and labels
          are ignored.  If a Product doesn’t exist and needs to be
          created on the fly, the product_display_name field refers to [
          Product.display_name][google.cloud.vision.v1p3beta1.Product.di
          splay_name], the product_category field refers to [Product.pro
          duct_category][google.cloud.vision.v1p3beta1.Product.product_c
          ategory], and the labels field refers to [Product.labels][].
          Labels (optional) should be a line containing a list of comma-
          separated key-value pairs, with the format
          “key_1=value_1,key_2=value_2,…,key_n=value_n”.  The
          bounding_poly (optional) field is used to identify one region
          of interest from the image in the same manner as
          ...
          resolution is too large to process (above 20MP).  Also note
          that at most one bounding_poly is allowed per line. If the
          image contains multiple regions of interest, the csv should
          contain one line per region of interest.  The bounding_poly
          column should contain an even number of comma-separated
          numbers, with the format “p1_x,p1_y,p2_x,p2_y,…,pn_x,pn_y”.
          Nonnegative integers should be used for absolute bounding
          polygons, and float values in [0, 1] should be used for
          normalized bounding polygons.
  """,
...
_PRODUCTSEARCH = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b'\202\323\344\223\002E"6/v1p3beta1/{parent=projects/*/locations/*}/productSets:\013product_set\332A!parent,product_set,product_set_id',
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b"\202\323\344\223\0028\0226/v1p3beta1/{parent=projects/*/locations/*}/productSets\332A\006parent",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="GetProductSet",
            ...
            output_type=_PRODUCTSET,
            serialized_options=b"\202\323\344\223\0028\0226/v1p3beta1/{name=projects/*/locations/*/productSets/*}\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b"\202\323\344\223\0028*6/v1p3beta1/{name=projects/*/locations/*/productSets/*}\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="CreateProduct",
            ...
            serialized_options=b'\202\323\344\223\002>"3/v1p3beta1/{parent=projects/*/locations/*}/products:\007product\332A\031parent,product,product_id',
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="ListProducts",
            ...
            serialized_options=b"\202\323\344\223\0025\0223/v1p3beta1/{parent=projects/*/locations/*}/products\332A\006parent",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="GetProduct",
            ...
            output_type=_PRODUCT,
            serialized_options=b"\202\323\344\223\0025\0223/v1p3beta1/{name=projects/*/locations/*/products/*}\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="UpdateProduct",
            ...
            output_type=_PRODUCT,
            serialized_options=b"\202\323\344\223\002F2;/v1p3beta1/{product.name=projects/*/locations/*/products/*}:\007product\332A\023product,update_mask",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            name="DeleteProduct",
            ...
            output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
            serialized_options=b"\202\323\344\223\0025*3/v1p3beta1/{name=projects/*/locations/*/products/*}\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b'\202\323\344\223\002X"E/v1p3beta1/{parent=projects/*/locations/*/products/*}/referenceImages:\017reference_image\332A)parent,reference_image,reference_image_id',
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
            serialized_options=b"\202\323\344\223\002G*E/v1p3beta1/{name=projects/*/locations/*/products/*/referenceImages/*}\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b"\202\323\344\223\002G\022E/v1p3beta1/{parent=projects/*/locations/*/products/*}/referenceImages\332A\006parent",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=_REFERENCEIMAGE,
            serialized_options=b"\202\323\344\223\002G\022E/v1p3beta1/{name=projects/*/locations/*/products/*/referenceImages/*}\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
            serialized_options=b'\202\323\344\223\002F"A/v1p3beta1/{name=projects/*/locations/*/productSets/*}:addProduct:\001*\332A\014name,product',
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
            serialized_options=b'\202\323\344\223\002I"D/v1p3beta1/{name=projects/*/locations/*/productSets/*}:removeProduct:\001*\332A\014name,product',
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b"\202\323\344\223\002A\022?/v1p3beta1/{name=projects/*/locations/*/productSets/*}/products\332A\004name",
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=b'\202\323\344\223\002B"=/v1p3beta1/{parent=projects/*/locations/*}/productSets:import:\001*\332A\023parent,input_config\312A3\n\031ImportProductSetsResponse\022\026BatchOperationMetadata',
            create_key=_descriptor._internal_create_key,
        ),
    ],
)

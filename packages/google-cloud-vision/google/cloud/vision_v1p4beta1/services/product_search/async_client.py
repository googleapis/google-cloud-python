...
class ProductSearchAsyncClient:
        ...
        *,
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:``google.cloud.vision_v1p4beta1.types.ImportProductSetsResponse`` Response message for the
    ...
    async def purge_products(
        ...
        *,
        ...
        after this
        operation has completed. It is also recommended to not add any
        of the
        ...
        Therefore, it is
        recommended to keep the csv files used in ImportProductSets (if
        that was

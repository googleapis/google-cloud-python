...
class ProductSearchAsyncClient:
    ...
    - The API has a collection of `ProductSet
      ...
      collection of `Product <google.cloud.vision.v1p4beta1.Product>`__
      resources, named ``projects/*/locations/*/products/*``  - Each `Product
      <google.cloud.vision.v1p4beta1.Product>`__ has a collection of
    ...
    async def update_product_set(
        ...
        *,
        ...
        r"""Makes changes to a ProductSet resource.  Only display_name can
    ...
    async def purge_products(
        ...
        *,
        ...
        into the empty  ProductSet, you must wait until the
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:``google.protobuf.empty_pb2.Empty`` A generic empty message that you can

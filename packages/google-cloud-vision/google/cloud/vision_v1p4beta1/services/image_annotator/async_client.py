...
class ImageAnnotatorAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = ImageAnnotatorClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ImageAnnotatorAsyncClient: The constructed client.
        """
        sa_file_func = ImageAnnotatorClient.from_service_account_file.__func__  # type: ignore

...
class ImageAnnotatorRestTransport(ImageAnnotatorTransport):
    ...
    class _AsyncBatchAnnotateFiles(ImageAnnotatorRestStub):
        def __hash__(self):
    ...
    class _AsyncBatchAnnotateImages(ImageAnnotatorRestStub):
        def __hash__(self):
    ...
    class _BatchAnnotateFiles(ImageAnnotatorRestStub):
        def __hash__(self):

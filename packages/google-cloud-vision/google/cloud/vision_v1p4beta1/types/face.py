...
class FaceRecognitionParams(proto.Message):
    ...
    Attributes:
        celebrity_set (MutableSequence[str]):
            ...
            `CelebritySet
            <google.cloud.vision.v1p4beta1.CelebritySet>`__s.
            A celebrity set is preloaded and can be
            specified as "builtin/default". If this is
            specified, the algorithm will try to match the
            faces detected in the input image to the
...
class FaceRecognitionResult(proto.Message):
    ...
    Attributes:
        celebrity (google.cloud.vision_v1p4beta1.types.Celebrity):
            The `Celebrity
            <google.cloud.vision.v1p4beta1.Celebrity>`__

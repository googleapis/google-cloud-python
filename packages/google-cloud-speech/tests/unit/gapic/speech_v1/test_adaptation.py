...
from google.cloud.speech_v1.services.adaptation import AdaptationAsyncClient, AdaptationClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AdaptationClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AdaptationClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AdaptationClient._use_client_cert_effective()
...
def test_adaptation_client_client_options_from_dict():
    with mock.patch("google.cloud.speech_v1.services.adaptation.transports.AdaptationGrpcTransport.__init__") as grpc_transport:
...
async def test_list_phrase_set_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_phrase_set), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            cloud_speech_adaptation.ListPhraseSetResponse(
                phrase_sets=[
...
async def test_list_phrase_set_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_phrase_set), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_phrase_set(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_custom_classes_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_custom_classes), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            cloud_speech_adaptation.ListCustomClassesResponse(
                custom_classes=[
...
async def test_list_custom_classes_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_custom_classes), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_custom_classes(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_custom_class(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_custom_class), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = resource.CustomClass(
            name="name_value",
            custom_class_id="custom_class_id_value",
...
def test_create_phrase_set_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/phraseSets" % client.transport._host, args[1])
...
def test_get_phrase_set_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/phraseSets/*}" % client.transport._host, args[1])
...
def test_update_phrase_set_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{phrase_set.name=projects/*/locations/*/phraseSets/*}" % client.transport._host, args[1])
...
def test_create_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.CreateCustomClassRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_custom_class._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_custom_class_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/customClasses" % client.transport._host, args[1])
...
def test_get_custom_class_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/customClasses/*}" % client.transport._host, args[1])
...
def test_list_custom_classes_rest_required_fields(request_type=cloud_speech_adaptation.ListCustomClassesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_custom_classes._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.UpdateCustomClassRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_custom_class._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_custom_class_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{custom_class.name=projects/*/locations/*/customClasses/*}" % client.transport._host, args[1])
...
def test_delete_custom_class_rest_required_fields(request_type=cloud_speech_adaptation.DeleteCustomClassRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_custom_class._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = AdaptationClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = AdaptationClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = AdaptationClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = AdaptationAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AdaptationAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AdaptationClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_phrase_set_rest_bad_request(request_type=cloud_speech_adaptation.CreatePhraseSetRequest):
    client = AdaptationClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_phrase_set_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_create_phrase_set") as post, mock.patch.object(
...
def test_get_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_get_phrase_set") as post, mock.patch.object(
...
def test_list_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_list_phrase_set") as post, mock.patch.object(
...
def test_update_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_update_phrase_set") as post, mock.patch.object(
...
def test_delete_phrase_set_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "pre_delete_phrase_set") as pre:
        pre.assert_not_called()
...
def test_create_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_create_custom_class") as post, mock.patch.object(
...
def test_get_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_get_custom_class") as post, mock.patch.object(
...
def test_list_custom_classes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_list_custom_classes") as post, mock.patch.object(
...
def test_update_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "post_update_custom_class") as post, mock.patch.object(
...
def test_delete_custom_class_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdaptationRestInterceptor, "pre_delete_custom_class") as pre:
        pre.assert_not_called()
...
def test_adaptation_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.AdaptationTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_adaptation_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.speech_v1.services.adaptation.transports.AdaptationTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.AdaptationGrpcTransport, grpc_helpers), (transports.AdaptationGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_adaptation_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.AdaptationRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = AdaptationClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

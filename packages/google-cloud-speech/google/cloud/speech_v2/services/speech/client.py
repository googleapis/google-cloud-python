...
class SpeechClient(metaclass=SpeechClientMeta):
    ...
    def recognizer_path(
        ...
        return "projects/{project}/locations/{location}/recognizers/{recognizer}".format(
            project=project,
            location=location,
    ...
    def parse_recognizer_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/recognizers/(?P<recognizer>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def update_recognizer(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("recognizer.name", request.recognizer.name),)),)
    ...
    def recognize(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("recognizer", request.recognizer),)),)
    ...
    def batch_recognize(
        ...
        *,
        ...
        config: Optional[cloud_speech.RecognitionConfig] = None,
        config_mask: Optional[field_mask_pb2.FieldMask] = None,
        files: Optional[MutableSequence[cloud_speech.BatchRecognizeFileMetadata]] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation.Operation:

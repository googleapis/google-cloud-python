...
class SpeechClient(metaclass=SpeechClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SpeechTransport, Callable[..., SpeechTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SpeechClient._read_environment_variables()
        self._client_cert_source = SpeechClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SpeechClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SpeechTransport], Callable[..., SpeechTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.speech_v1p1beta1.SpeechClient`.",
                    extra={

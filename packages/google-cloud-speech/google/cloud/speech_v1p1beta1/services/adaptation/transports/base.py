...
class AdaptationTransport(abc.ABC):
    ...
    def create_phrase_set(
        ...
        typing.Union[resource.PhraseSet, typing.Awaitable[resource.PhraseSet]],
    ]:
    ...
    def create_custom_class(
        ...
        typing.Union[resource.CustomClass, typing.Awaitable[resource.CustomClass]],
    ]:
        raise NotImplementedError()
    ...
    def list_custom_classes(
        ...
        typing.Union[
            ...
            typing.Awaitable[cloud_speech_adaptation.ListCustomClassesResponse],
        ],
    ]:
        raise NotImplementedError()

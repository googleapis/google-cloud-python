...
from google.cloud.network_security_v1.services.firewall_activation import (
...
def test_firewall_activation_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1.services.firewall_activation.transports.FirewallActivationGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.asyncio
async def test_list_project_firewall_endpoints_async_from_dict():
    await test_list_project_firewall_endpoints_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_get_project_firewall_endpoint_async_from_dict():
    await test_get_project_firewall_endpoint_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_create_project_firewall_endpoint_async_from_dict():
    await test_create_project_firewall_endpoint_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_delete_project_firewall_endpoint_async_from_dict():
    await test_delete_project_firewall_endpoint_async(request_type=dict)
...
@pytest.mark.asyncio
async def test_update_project_firewall_endpoint_async_from_dict():
    await test_update_project_firewall_endpoint_async(request_type=dict)
...
def test_list_firewall_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*}/firewallEndpoints"
...
def test_get_firewall_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/firewallEndpoints/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_firewall_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{firewall_endpoint.name=organizations/*/locations/*/firewallEndpoints/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_firewall_endpoint_associations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/firewallEndpointAssociations"
            % client.transport._host,
            args[1],
        )
...
def test_get_firewall_endpoint_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/firewallEndpointAssociations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_firewall_endpoint_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{firewall_endpoint_association.name=projects/*/locations/*/firewallEndpointAssociations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_firewall_activation_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1.services.firewall_activation.transports.FirewallActivationTransport.__init__"
    ) as Transport:
...
def test_firewall_activation_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.network_security_v1.services.firewall_activation.transports.FirewallActivationTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

...
def test__get_default_mtls_endpoint():
    ...
    assert SecurityProfileGroupServiceClient._get_default_mtls_endpoint(None) is None
    assert (
        SecurityProfileGroupServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        SecurityProfileGroupServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        SecurityProfileGroupServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        SecurityProfileGroupServiceClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
    assert (
        SecurityProfileGroupServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        SecurityProfileGroupServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert SecurityProfileGroupServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                SecurityProfileGroupServiceClient._use_client_cert_effective() is True
            )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                SecurityProfileGroupServiceClient._use_client_cert_effective() is False
            )
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                SecurityProfileGroupServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        SecurityProfileGroupServiceClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SecurityProfileGroupServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SecurityProfileGroupServiceClient),
)
@mock.patch.object(
    SecurityProfileGroupServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SecurityProfileGroupServiceAsyncClient),
)
def test__get_api_endpoint():
    ...
    mock_endpoint = SecurityProfileGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SecurityProfileGroupServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == SecurityProfileGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SecurityProfileGroupServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        SecurityProfileGroupServiceClient._get_universe_domain(
    ...
    assert (
        SecurityProfileGroupServiceClient._get_universe_domain(None, None)
        == SecurityProfileGroupServiceClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        SecurityProfileGroupServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SecurityProfileGroupServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (SecurityProfileGroupServiceClient, "grpc"),
        (SecurityProfileGroupServiceAsyncClient, "grpc_asyncio"),
        (SecurityProfileGroupServiceClient, "rest"),
    ],
)
def test_security_profile_group_service_client_from_service_account_info(
    client_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.SecurityProfileGroupServiceGrpcTransport, "grpc"),
        (transports.SecurityProfileGroupServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.SecurityProfileGroupServiceRestTransport, "rest"),
    ],
)
def test_security_profile_group_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_security_profile_group_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_security_profile_group_service_client_get_transport_class():
    transport = SecurityProfileGroupServiceClient.get_transport_class()
    available_transports = [
        transports.SecurityProfileGroupServiceGrpcTransport,
        transports.SecurityProfileGroupServiceRestTransport,
    ]
    assert transport in available_transports

    transport = SecurityProfileGroupServiceClient.get_transport_class("grpc")
    assert transport == transports.SecurityProfileGroupServiceGrpcTransport
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            SecurityProfileGroupServiceAsyncClient,
            transports.SecurityProfileGroupServiceGrpcAsyncIOTransport,
            "grpc_asyncio",
        ),
        (
            SecurityProfileGroupServiceClient,
...
def test_security_profile_group_service_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(
        SecurityProfileGroupServiceClient, "get_transport_class"
    ) as gtc:
...
def test_security_profile_group_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class",
    [SecurityProfileGroupServiceClient, SecurityProfileGroupServiceAsyncClient],
)
@mock.patch.object(
    SecurityProfileGroupServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SecurityProfileGroupServiceClient),
)
@mock.patch.object(
    SecurityProfileGroupServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SecurityProfileGroupServiceAsyncClient),
)
def test_security_profile_group_service_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_security_profile_group_service_client_client_api_endpoint(client_class):
...
def test_security_profile_group_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_security_profile_group_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_security_profile_group_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1.services.security_profile_group_service.transports.SecurityProfileGroupServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = SecurityProfileGroupServiceClient(
...
def test_security_profile_group_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_list_security_profile_groups_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SecurityProfileGroupServiceAsyncClient(
...
def test_list_security_profile_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/securityProfileGroups"
...
def test_get_security_profile_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/securityProfileGroups/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/securityProfileGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_security_profile_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{security_profile_group.name=projects/*/locations/*/securityProfileGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_security_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/securityProfiles"
            % client.transport._host,
            args[1],
        )
...
def test_get_security_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/securityProfiles/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/securityProfiles/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_security_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{security_profile.name=projects/*/locations/*/securityProfiles/*}"
            % client.transport._host,
            args[1],
        )
...
def test_credentials_transport_error():
    ...
    transport = transports.SecurityProfileGroupServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = SecurityProfileGroupServiceClient(
...
def test_transport_instance():
    ...
    client = SecurityProfileGroupServiceClient(transport=transport)
...
def test_transport_get_channel():
    ...
    transport = transports.SecurityProfileGroupServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind_grpc_asyncio():
    transport = SecurityProfileGroupServiceAsyncClient.get_transport_class(
        "grpc_asyncio"
    )(credentials=async_anonymous_credentials())
...
def test_transport_kind_rest():
    transport = SecurityProfileGroupServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_security_profile_groups_rest_interceptors(null_interceptor):
    transport = transports.SecurityProfileGroupServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.SecurityProfileGroupServiceRestInterceptor(),
    )
    client = SecurityProfileGroupServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.SecurityProfileGroupServiceRestInterceptor,
...
def test_security_profile_group_service_rest_lro_client():
    client = SecurityProfileGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_security_profile_group_service_base_transport_error():
    # Passing both a credentials object and credentials_file should raise an error
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.SecurityProfileGroupServiceTransport(
            credentials=ga_credentials.AnonymousCredentials(),
            credentials_file="credentials.json",
        )


def test_security_profile_group_service_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.cloud.network_security_v1.services.security_profile_group_service.transports.SecurityProfileGroupServiceTransport.__init__"
    ) as Transport:
...
def test_security_profile_group_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.network_security_v1.services.security_profile_group_service.transports.SecurityProfileGroupServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_security_profile_group_service_base_transport_with_adc():
...
def test_security_profile_group_service_auth_adc():
...
def test_security_profile_group_service_transport_auth_adc(transport_class):
...
def test_security_profile_group_service_transport_auth_gdch_credentials(
    transport_class,
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.SecurityProfileGroupServiceGrpcTransport, grpc_helpers),
        (
            transports.SecurityProfileGroupServiceGrpcAsyncIOTransport,
            grpc_helpers_async,
        ),
...
def test_security_profile_group_service_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_security_profile_group_service_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
    with mock.patch(
        "google.auth.transport.requests.AuthorizedSession.configure_mtls_channel"
...
def test_security_profile_group_service_host_no_port(transport_name):
    client = SecurityProfileGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_security_profile_group_service_host_with_port(transport_name):
    client = SecurityProfileGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
...
def test_security_profile_group_service_client_transport_session_collision(
    transport_name,
):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = SecurityProfileGroupServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SecurityProfileGroupServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_security_profile_group_service_grpc_transport_channel():
...
def test_security_profile_group_service_grpc_asyncio_transport_channel():
...
def test_security_profile_group_service_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_security_profile_group_service_transport_channel_mtls_with_adc(
    transport_class,
):
    mock_ssl_cred = mock.Mock()
...
def test_security_profile_group_service_grpc_lro_client():
    client = SecurityProfileGroupServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_security_profile_group_service_grpc_lro_async_client():
    client = SecurityProfileGroupServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc_asyncio",
    )
...
def test_intercept_endpoint_group_path():
    ...
    actual = SecurityProfileGroupServiceClient.intercept_endpoint_group_path(
...
def test_parse_intercept_endpoint_group_path():
    ...
    path = SecurityProfileGroupServiceClient.intercept_endpoint_group_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_intercept_endpoint_group_path(path)
    assert expected == actual
...
def test_mirroring_endpoint_group_path():
    ...
    actual = SecurityProfileGroupServiceClient.mirroring_endpoint_group_path(
...
def test_parse_mirroring_endpoint_group_path():
    ...
    path = SecurityProfileGroupServiceClient.mirroring_endpoint_group_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_mirroring_endpoint_group_path(path)
    assert expected == actual
...
def test_security_profile_path():
    ...
    actual = SecurityProfileGroupServiceClient.security_profile_path(
...
def test_parse_security_profile_path():
    ...
    path = SecurityProfileGroupServiceClient.security_profile_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_security_profile_path(path)
    assert expected == actual
...
def test_security_profile_group_path():
    ...
    actual = SecurityProfileGroupServiceClient.security_profile_group_path(
...
def test_parse_security_profile_group_path():
    ...
    path = SecurityProfileGroupServiceClient.security_profile_group_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_security_profile_group_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = SecurityProfileGroupServiceClient.common_billing_account_path(
        billing_account
    )
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = SecurityProfileGroupServiceClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = SecurityProfileGroupServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = SecurityProfileGroupServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = SecurityProfileGroupServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = SecurityProfileGroupServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = SecurityProfileGroupServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = SecurityProfileGroupServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = SecurityProfileGroupServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = SecurityProfileGroupServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = SecurityProfileGroupServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.SecurityProfileGroupServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = SecurityProfileGroupServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        transport_class = SecurityProfileGroupServiceClient.get_transport_class()
        transport = transport_class(
            credentials=ga_credentials.AnonymousCredentials(),
            client_info=client_info,
        )

...
from google.cloud.network_security_v1.services.network_security import NetworkSecurityAsyncClient, NetworkSecurityClient, pagers, transports
...
def test_update_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{authorization_policy.name=projects/*/locations/*/authorizationPolicies/*}" % client.transport._host, args[1]
        )

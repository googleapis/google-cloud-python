...
def test_list_authorization_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/authorizationPolicies"
...
def test_get_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/authorizationPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_authorization_policy_rest(request_type):
    ...
    for field, value in request_init["authorization_policy"].items():
        result = None
        is_repeated = False
        # For repeated fields
...
def test_update_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{authorization_policy.name=projects/*/locations/*/authorizationPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_server_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/serverTlsPolicies"
            % client.transport._host,
            args[1],
        )
...
def test_get_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/serverTlsPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_server_tls_policy_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["server_tls_policy"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_update_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{server_tls_policy.name=projects/*/locations/*/serverTlsPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_client_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/clientTlsPolicies"
            % client.transport._host,
            args[1],
        )
...
def test_get_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clientTlsPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_client_tls_policy_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["client_tls_policy"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_update_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{client_tls_policy.name=projects/*/locations/*/clientTlsPolicies/*}"
            % client.transport._host,
            args[1],
        )

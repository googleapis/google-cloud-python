...
from google.cloud.network_security_v1.services.address_group_service import (
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert AddressGroupServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AddressGroupServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AddressGroupServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AddressGroupServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        AddressGroupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == AddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        AddressGroupServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
@pytest.mark.parametrize("client_class", [AddressGroupServiceClient, AddressGroupServiceAsyncClient])
...
def test_address_group_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1.services.address_group_service.transports.AddressGroupServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = AddressGroupServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = AddressGroupServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = AddressGroupServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = AddressGroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = AddressGroupServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AddressGroupServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AddressGroupServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_address_groups_rest_bad_request(request_type=address_group.ListAddressGroupsRequest):
    client = AddressGroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_address_groups_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.AddressGroupServiceRestInterceptor, "post_list_address_groups") as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_list_address_groups_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_list_address_groups"
    ) as pre:
...
def test_get_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AddressGroupServiceRestInterceptor, "post_get_address_group") as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_get_address_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_get_address_group"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_create_address_group"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_create_address_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_create_address_group"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_address_group_rest_call_success(request_type):
    ...
    request_init = {"address_group": {"name": "projects/sample1/locations/sample2/addressGroups/sample3"}}
    request_init["address_group"] = {
        "name": "projects/sample1/locations/sample2/addressGroups/sample3",
        "description": "description_value",
        "create_time": {"seconds": 751, "nanos": 543},
        "update_time": {},
        "labels": {},
...
def test_update_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_update_address_group"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_update_address_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_update_address_group"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_address_group_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_add_address_group_items"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_add_address_group_items_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_add_address_group_items"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_remove_address_group_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_remove_address_group_items"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_remove_address_group_items_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_remove_address_group_items"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_clone_address_group_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_clone_address_group_items"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_clone_address_group_items_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_clone_address_group_items"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_delete_address_group"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_delete_address_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_delete_address_group"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_address_group_references_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AddressGroupServiceRestInterceptor, "post_list_address_group_references") as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "post_list_address_group_references_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor, "pre_list_address_group_references"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_address_group_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.AddressGroupServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
def test_address_group_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.network_security_v1.services.address_group_service.transports.AddressGroupServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.AddressGroupServiceGrpcTransport, grpc_helpers), (transports.AddressGroupServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_address_group_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_address_group_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.AddressGroupServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.AddressGroupServiceGrpcTransport, transports.AddressGroupServiceGrpcAsyncIOTransport])
def test_address_group_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AddressGroupServiceGrpcTransport, transports.AddressGroupServiceGrpcAsyncIOTransport])
def test_address_group_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_get_location_field_headers():
    client = AddressGroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = AddressGroupServiceAsyncClient(credentials=async_anonymous_credentials())
...
def test_client_ctx():
    ...
    for transport in transports:
        client = AddressGroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

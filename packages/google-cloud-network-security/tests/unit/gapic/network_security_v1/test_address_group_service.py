...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AddressGroupServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AddressGroupServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AddressGroupServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AddressGroupServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AddressGroupServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
def test__get_client_cert_source():
    ...
    assert (
        AddressGroupServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AddressGroupServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AddressGroupServiceClient),
)
@mock.patch.object(
    AddressGroupServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AddressGroupServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AddressGroupServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AddressGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AddressGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        AddressGroupServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AddressGroupServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        AddressGroupServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AddressGroupServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AddressGroupServiceClient._get_universe_domain(None, None)
        == AddressGroupServiceClient._DEFAULT_UNIVERSE
    )
...
def test_address_group_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_address_group_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_address_group_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_address_group_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_address_group_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    AddressGroupServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AddressGroupServiceClient),
)
@mock.patch.object(
    AddressGroupServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AddressGroupServiceAsyncClient),
)
...
def test_address_group_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_address_group_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_address_group_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_address_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/addressGroups"
...
def test_get_address_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/addressGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_address_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{address_group.name=projects/*/locations/*/addressGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_add_address_group_items_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "address_group": "projects/sample1/locations/sample2/addressGroups/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{address_group=projects/*/locations/*/addressGroups/*}:addItems"
            % client.transport._host,
            args[1],
        )
...
def test_remove_address_group_items_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{address_group=projects/*/locations/*/addressGroups/*}:removeItems"
            % client.transport._host,
            args[1],
        )
...
def test_clone_address_group_items_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{address_group=projects/*/locations/*/addressGroups/*}:cloneItems"
            % client.transport._host,
            args[1],
        )
...
def test_list_address_group_references_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{address_group=projects/*/locations/*/addressGroups/*}:listReferences"
            % client.transport._host,
            args[1],
        )
...
def test_list_address_groups_rest_interceptors(null_interceptor):
    transport = transports.AddressGroupServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.AddressGroupServiceRestInterceptor(),
    )
    client = AddressGroupServiceClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_list_address_groups"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor,
...
def test_get_address_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AddressGroupServiceRestInterceptor, "post_get_address_group"
    ) as post, mock.patch.object(
        transports.AddressGroupServiceRestInterceptor,
...
def test_address_group_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1.services.address_group_service.transports.AddressGroupServiceTransport.__init__"
    ) as Transport:
...
def test_address_group_path():
    ...
    actual = AddressGroupServiceClient.address_group_path(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.AddressGroupServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = AddressGroupServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

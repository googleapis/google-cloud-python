...
from google.cloud.network_security_v1.services.intercept import (
...
def test_intercept_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1.services.intercept.transports.InterceptGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_intercept_endpoint_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/interceptEndpointGroups"
...
def test_get_intercept_endpoint_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/interceptEndpointGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_intercept_endpoint_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{intercept_endpoint_group.name=projects/*/locations/*/interceptEndpointGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_intercept_endpoint_group_associations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/interceptEndpointGroupAssociations"
            % client.transport._host,
            args[1],
        )
...
def test_get_intercept_endpoint_group_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/interceptEndpointGroupAssociations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_intercept_endpoint_group_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{intercept_endpoint_group_association.name=projects/*/locations/*/interceptEndpointGroupAssociations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_intercept_deployment_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/interceptDeploymentGroups"
            % client.transport._host,
            args[1],
        )
...
def test_get_intercept_deployment_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/interceptDeploymentGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_intercept_deployment_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{intercept_deployment_group.name=projects/*/locations/*/interceptDeploymentGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_intercept_deployments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/interceptDeployments"
            % client.transport._host,
            args[1],
        )
...
def test_get_intercept_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/interceptDeployments/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_intercept_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{intercept_deployment.name=projects/*/locations/*/interceptDeployments/*}"
            % client.transport._host,
            args[1],
        )
...
def test_intercept_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1.services.intercept.transports.InterceptTransport.__init__"
    ) as Transport:
...
def test_intercept_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.network_security_v1.services.intercept.transports.InterceptTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

...
from google.cloud.network_security_v1.services.sse_realm_service import (
    SSERealmServiceAsyncClient,
    SSERealmServiceClient,
    pagers,
    transports,
)
from google.cloud.network_security_v1.types import common, sse_realm
...
def test_sse_realm_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1.services.sse_realm_service.transports.SSERealmServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_sac_realms_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/sacRealms" % client.transport._host,
            args[1],
        )
...
def test_get_sac_realm_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/sacRealms/*}" % client.transport._host,
            args[1],
        )
...
def test_list_sac_attachments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/sacAttachments"
...
def test_get_sac_attachment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/sacAttachments/*}"
            % client.transport._host,
            args[1],
        )
...
def test_sse_realm_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1.services.sse_realm_service.transports.SSERealmServiceTransport.__init__"
    ) as Transport:
...
def test_sse_realm_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.network_security_v1.services.sse_realm_service.transports.SSERealmServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

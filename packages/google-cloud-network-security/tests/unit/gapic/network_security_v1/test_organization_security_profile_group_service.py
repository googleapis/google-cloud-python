...
def test_organization_security_profile_group_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1.services.organization_security_profile_group_service.transports.OrganizationSecurityProfileGroupServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_security_profile_groups_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSecurityProfileGroups,
...
def test_list_security_profile_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*}/securityProfileGroups"
...
def test_get_security_profile_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSecurityProfileGroup,
...
def test_get_security_profile_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/securityProfileGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_security_profile_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSecurityProfileGroup,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("securityProfileGroupId",))
...
def test_update_security_profile_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSecurityProfileGroup,
...
def test_update_security_profile_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{security_profile_group.name=organizations/*/locations/*/securityProfileGroups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_security_profile_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSecurityProfileGroup,
...
def test_list_security_profiles_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSecurityProfiles,
...
def test_list_security_profiles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*}/securityProfiles"
            % client.transport._host,
            args[1],
        )
...
def test_get_security_profile_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSecurityProfile,
...
def test_get_security_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/securityProfiles/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_security_profile_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSecurityProfile,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("securityProfileId",))
...
def test_update_security_profile_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSecurityProfile,
...
def test_update_security_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{security_profile.name=organizations/*/locations/*/securityProfiles/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_security_profile_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSecurityProfile,
...
def test_organization_security_profile_group_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1.services.organization_security_profile_group_service.transports.OrganizationSecurityProfileGroupServiceTransport.__init__"
    ) as Transport:
...
def test_organization_security_profile_group_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.network_security_v1.services.organization_security_profile_group_service.transports.OrganizationSecurityProfileGroupServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

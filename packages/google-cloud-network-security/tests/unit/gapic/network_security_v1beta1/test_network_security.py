...
def test__get_default_mtls_endpoint():
    ...
    assert (
        NetworkSecurityClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        NetworkSecurityClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        NetworkSecurityClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                NetworkSecurityClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                NetworkSecurityClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(NetworkSecurityClient),
)
@mock.patch.object(
    NetworkSecurityAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(NetworkSecurityAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NetworkSecurityClient._DEFAULT_UNIVERSE
    default_endpoint = NetworkSecurityClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = NetworkSecurityClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        NetworkSecurityClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        NetworkSecurityClient._get_api_endpoint(None, None, default_universe, "always")
        == NetworkSecurityClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        NetworkSecurityClient._get_api_endpoint(
    ...
    assert (
        NetworkSecurityClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        NetworkSecurityClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        NetworkSecurityClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        NetworkSecurityClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        NetworkSecurityClient._get_universe_domain(None, None)
        == NetworkSecurityClient._DEFAULT_UNIVERSE
    )
...
def test_list_authorization_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_authorization_policies
...
@pytest.mark.asyncio
async def test_list_authorization_policies_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_authorization_policies
...
def test_list_authorization_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_authorization_policies(
...
def test_get_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_authorization_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_authorization_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_authorization_policy
            in client._client._transport._wrapped_methods
        )
...
def test_create_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_authorization_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_authorization_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_authorization_policy
            in client._client._transport._wrapped_methods
        )
...
def test_update_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_authorization_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_authorization_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_authorization_policy
            in client._client._transport._wrapped_methods
        )
...
def test_delete_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_authorization_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_authorization_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_authorization_policy
            in client._client._transport._wrapped_methods
        )
...
def test_list_server_tls_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_server_tls_policies
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_server_tls_policies_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_server_tls_policies
            in client._client._transport._wrapped_methods
        )
...
def test_list_server_tls_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_server_tls_policies(
            request={}, retry=retry, timeout=timeout
        )
...
def test_get_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_server_tls_policy
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_server_tls_policy] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_server_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_server_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_create_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_server_tls_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_server_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_server_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_update_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_server_tls_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_server_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_server_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_delete_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_server_tls_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_server_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_server_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_list_client_tls_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_client_tls_policies
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_client_tls_policies_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_client_tls_policies
            in client._client._transport._wrapped_methods
        )
...
def test_list_client_tls_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_client_tls_policies(
            request={}, retry=retry, timeout=timeout
        )
...
def test_get_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_client_tls_policy
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_client_tls_policy] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_client_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_client_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_create_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_client_tls_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_client_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_client_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_update_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_client_tls_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_client_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_client_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_delete_client_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_client_tls_policy
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_client_tls_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_client_tls_policy
            in client._client._transport._wrapped_methods
        )
...
def test_list_authorization_policies_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = authorization_policy.ListAuthorizationPoliciesResponse.pb(
                return_value
            )
...
def test_list_server_tls_policies_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = server_tls_policy.ListServerTlsPoliciesResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_client_tls_policies_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = client_tls_policy.ListClientTlsPoliciesResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_authorization_policies_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            ...
            "post_list_authorization_policies",
        ) as post,
        mock.patch.object(
            transports.NetworkSecurityRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = authorization_policy.ListAuthorizationPoliciesResponse.to_json(
            authorization_policy.ListAuthorizationPoliciesResponse()
        )
...
def test_get_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = authorization_policy.AuthorizationPolicy.to_json(
            authorization_policy.AuthorizationPolicy()
        )
        req.return_value.content = return_value
...
def test_create_authorization_policy_rest_call_success(request_type):
    ...
    test_field = gcn_authorization_policy.CreateAuthorizationPolicyRequest.meta.fields[
        "authorization_policy"
    ]
...
def test_create_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.NetworkSecurityRestInterceptor,
            "post_create_authorization_policy",
        ) as post,
        mock.patch.object(
            transports.NetworkSecurityRestInterceptor,
...
def test_update_authorization_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_authorization_policy.UpdateAuthorizationPolicyRequest.meta.fields[
        "authorization_policy"
    ]
...
def test_update_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.NetworkSecurityRestInterceptor,
            "post_update_authorization_policy",
        ) as post,
        mock.patch.object(
            transports.NetworkSecurityRestInterceptor,
...
def test_list_server_tls_policies_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = server_tls_policy.ListServerTlsPoliciesResponse.to_json(
            server_tls_policy.ListServerTlsPoliciesResponse()
        )
        req.return_value.content = return_value
...
def test_get_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = server_tls_policy.ServerTlsPolicy.to_json(
            server_tls_policy.ServerTlsPolicy()
        )
        req.return_value.content = return_value
...
def test_create_server_tls_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_server_tls_policy.CreateServerTlsPolicyRequest.meta.fields[
        "server_tls_policy"
    ]
...
def test_update_server_tls_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_server_tls_policy.UpdateServerTlsPolicyRequest.meta.fields[
        "server_tls_policy"
    ]
...
def test_list_client_tls_policies_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_tls_policy.ListClientTlsPoliciesResponse.to_json(
            client_tls_policy.ListClientTlsPoliciesResponse()
        )
        req.return_value.content = return_value
...
def test_get_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_tls_policy.ClientTlsPolicy.to_json(
            client_tls_policy.ClientTlsPolicy()
        )
        req.return_value.content = return_value
...
def test_create_client_tls_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_client_tls_policy.CreateClientTlsPolicyRequest.meta.fields[
        "client_tls_policy"
    ]
...
def test_update_client_tls_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_client_tls_policy.UpdateClientTlsPolicyRequest.meta.fields[
        "client_tls_policy"
    ]

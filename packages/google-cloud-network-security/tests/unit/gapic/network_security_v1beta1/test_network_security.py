...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert NetworkSecurityClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert NetworkSecurityClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert NetworkSecurityClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                NetworkSecurityClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        NetworkSecurityClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == NetworkSecurityClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        NetworkSecurityClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == NetworkSecurityClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_list_authorization_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_authorization_policies in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_authorization_policies] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_authorization_policies_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_authorization_policies in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_authorization_policies] = mock_rpc
...
def test_list_authorization_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_authorization_policies), "__call__") as call:
        ...
        pager = client.list_authorization_policies(request={}, retry=retry, timeout=timeout)
...
async def test_list_authorization_policies_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_authorization_policies), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_authorization_policies(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_authorization_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_authorization_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_authorization_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_authorization_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_authorization_policy] = mock_rpc
...
def test_create_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_authorization_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_authorization_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_authorization_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_authorization_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_authorization_policy] = mock_rpc
...
async def test_create_authorization_policy_async(
    transport: str = "grpc_asyncio", request_type=gcn_authorization_policy.CreateAuthorizationPolicyRequest
):
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_update_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_authorization_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_authorization_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_authorization_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_authorization_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_authorization_policy] = mock_rpc
...
async def test_update_authorization_policy_async(
    transport: str = "grpc_asyncio", request_type=gcn_authorization_policy.UpdateAuthorizationPolicyRequest
):
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_delete_authorization_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_authorization_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_authorization_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_authorization_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_authorization_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_authorization_policy] = mock_rpc
...
def test_list_server_tls_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_server_tls_policies in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_server_tls_policies] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_server_tls_policies_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_server_tls_policies in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_server_tls_policies] = mock_rpc
...
def test_list_server_tls_policies_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_server_tls_policies), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_server_tls_policies(request={}, retry=retry, timeout=timeout)
...
async def test_list_server_tls_policies_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_server_tls_policies), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_server_tls_policies(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_server_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_server_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_server_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_server_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_server_tls_policy] = mock_rpc
...
def test_create_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_server_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_server_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_server_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_server_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_server_tls_policy] = mock_rpc
...
def test_update_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_server_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_server_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_server_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_server_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_server_tls_policy] = mock_rpc
...
def test_delete_server_tls_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_server_tls_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_server_tls_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_server_tls_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NetworkSecurityAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_server_tls_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_server_tls_policy] = mock_rpc
...
async def test_list_client_tls_policies_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_client_tls_policies), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_client_tls_policies(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_authorization_policies_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_list_authorization_policies_rest_required_fields(request_type=authorization_policy.ListAuthorizationPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_authorization_policies._get_unset_required_fields(
        jsonified_request
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = authorization_policy.ListAuthorizationPoliciesResponse.pb(return_value)
...
def test_list_authorization_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/authorizationPolicies" % client.transport._host, args[1])
...
def test_list_authorization_policies_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(authorization_policy.ListAuthorizationPoliciesResponse.to_json(x) for x in response)
...
def test_get_authorization_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_get_authorization_policy_rest_required_fields(request_type=authorization_policy.GetAuthorizationPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_authorization_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = authorization_policy.AuthorizationPolicy.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/authorizationPolicies/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/authorizationPolicies/*}" % client.transport._host, args[1])
...
def test_create_authorization_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_create_authorization_policy_rest_required_fields(request_type=gcn_authorization_policy.CreateAuthorizationPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_authorization_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    assert jsonified_request["authorizationPolicyId"] == request_init["authorization_policy_id"]
...
def test_update_authorization_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_update_authorization_policy_rest_required_fields(request_type=gcn_authorization_policy.UpdateAuthorizationPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_authorization_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_authorization_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"authorization_policy": {"name": "projects/sample1/locations/sample2/authorizationPolicies/sample3"}}
        ...
        assert path_template.validate(
            "%s/v1beta1/{authorization_policy.name=projects/*/locations/*/authorizationPolicies/*}" % client.transport._host, args[1]
        )
...
def test_delete_authorization_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_delete_authorization_policy_rest_required_fields(request_type=authorization_policy.DeleteAuthorizationPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_authorization_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_server_tls_policies_rest_required_fields(request_type=server_tls_policy.ListServerTlsPoliciesRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_server_tls_policies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = server_tls_policy.ListServerTlsPoliciesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_server_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/serverTlsPolicies" % client.transport._host, args[1])
...
def test_list_server_tls_policies_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(server_tls_policy.ListServerTlsPoliciesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_server_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_get_server_tls_policy_rest_required_fields(request_type=server_tls_policy.GetServerTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_server_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = server_tls_policy.ServerTlsPolicy.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/serverTlsPolicies/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/serverTlsPolicies/*}" % client.transport._host, args[1])
...
def test_create_server_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_create_server_tls_policy_rest_required_fields(request_type=gcn_server_tls_policy.CreateServerTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_server_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    assert jsonified_request["serverTlsPolicyId"] == request_init["server_tls_policy_id"]
...
def test_update_server_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_update_server_tls_policy_rest_required_fields(request_type=gcn_server_tls_policy.UpdateServerTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_server_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_server_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"server_tls_policy": {"name": "projects/sample1/locations/sample2/serverTlsPolicies/sample3"}}
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{server_tls_policy.name=projects/*/locations/*/serverTlsPolicies/*}" % client.transport._host, args[1]
        )
...
def test_delete_server_tls_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworkSecurityClient(
...
def test_delete_server_tls_policy_rest_required_fields(request_type=server_tls_policy.DeleteServerTlsPolicyRequest):
    transport_class = transports.NetworkSecurityRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_server_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_client_tls_policies_rest_required_fields(request_type=client_tls_policy.ListClientTlsPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_client_tls_policies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_client_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/clientTlsPolicies" % client.transport._host, args[1])
...
def test_get_client_tls_policy_rest_required_fields(request_type=client_tls_policy.GetClientTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_client_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1])
...
def test_create_client_tls_policy_rest_required_fields(request_type=gcn_client_tls_policy.CreateClientTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_client_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_client_tls_policy_rest_required_fields(request_type=gcn_client_tls_policy.UpdateClientTlsPolicyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_client_tls_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{client_tls_policy.name=projects/*/locations/*/clientTlsPolicies/*}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = NetworkSecurityClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_authorization_policies_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_authorization_policies), "__call__") as call:
        call.return_value = authorization_policy.ListAuthorizationPoliciesResponse()
        client.list_authorization_policies(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_authorization_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_authorization_policy), "__call__") as call:
        call.return_value = authorization_policy.AuthorizationPolicy()
        client.get_authorization_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_authorization_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_authorization_policy), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_authorization_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_authorization_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_authorization_policy), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_authorization_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_authorization_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_authorization_policy), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_authorization_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_server_tls_policies_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_server_tls_policies), "__call__") as call:
        call.return_value = server_tls_policy.ListServerTlsPoliciesResponse()
        client.list_server_tls_policies(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_server_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_server_tls_policy), "__call__") as call:
        call.return_value = server_tls_policy.ServerTlsPolicy()
        client.get_server_tls_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_server_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_server_tls_policy), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_server_tls_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_server_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_server_tls_policy), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_server_tls_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_server_tls_policy_empty_call_grpc():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_server_tls_policy), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_server_tls_policy(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = NetworkSecurityAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = NetworkSecurityAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_authorization_policies_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.list_authorization_policies), "__call__") as call:
        ...
        await client.list_authorization_policies(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_authorization_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_authorization_policy), "__call__") as call:
        ...
        await client.get_authorization_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_authorization_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_authorization_policy), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_authorization_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_authorization_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_authorization_policy), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_authorization_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_authorization_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_authorization_policy), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_authorization_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_server_tls_policies_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_server_tls_policies), "__call__") as call:
        ...
        await client.list_server_tls_policies(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_server_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_server_tls_policy), "__call__") as call:
        ...
        await client.get_server_tls_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_server_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_server_tls_policy), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_server_tls_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_server_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_server_tls_policy), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_server_tls_policy(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_server_tls_policy_empty_call_grpc_asyncio():
    client = NetworkSecurityAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_server_tls_policy), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_server_tls_policy(request=None)
...
def test_transport_kind_rest():
    transport = NetworkSecurityClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_authorization_policies_rest_bad_request(request_type=authorization_policy.ListAuthorizationPoliciesRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_authorization_policies_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_authorization_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_authorization_policies") as post, mock.patch.object(
        transports.NetworkSecurityRestInterceptor, "post_list_authorization_policies_with_metadata"
        ...
        pb_message = authorization_policy.ListAuthorizationPoliciesRequest.pb(authorization_policy.ListAuthorizationPoliciesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = authorization_policy.ListAuthorizationPoliciesResponse.to_json(authorization_policy.ListAuthorizationPoliciesResponse())
        ...
        post_with_metadata.return_value = authorization_policy.ListAuthorizationPoliciesResponse(), metadata
...
def test_get_authorization_policy_rest_bad_request(request_type=authorization_policy.GetAuthorizationPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/authorizationPolicies/sample3"}
    request = request_type(**request_init)
...
def test_get_authorization_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_authorization_policy") as post, mock.patch.object(
        transports.NetworkSecurityRestInterceptor, "post_get_authorization_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = authorization_policy.GetAuthorizationPolicyRequest.pb(authorization_policy.GetAuthorizationPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = authorization_policy.AuthorizationPolicy.to_json(authorization_policy.AuthorizationPolicy())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = authorization_policy.AuthorizationPolicy(), metadata
...
def test_create_authorization_policy_rest_bad_request(request_type=gcn_authorization_policy.CreateAuthorizationPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_authorization_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["authorization_policy"] = {
        ...
        "rules": [
            {
                "sources": [{"principals": ["principals_value1", "principals_value2"], "ip_blocks": ["ip_blocks_value1", "ip_blocks_value2"]}],
                "destinations": [
                    {
                        "hosts": ["hosts_value1", "hosts_value2"],
                        "ports": [569, 570],
                        "methods": ["methods_value1", "methods_value2"],
                        "http_header_match": {"regex_match": "regex_match_value", "header_name": "header_name_value"},
                    }
                ],
            }
        ],
    ...
    test_field = gcn_authorization_policy.CreateAuthorizationPolicyRequest.meta.fields["authorization_policy"]
    ...
    for field, value in request_init["authorization_policy"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["authorization_policy"][field])):
                    del request_init["authorization_policy"][field][i][subfield]
            else:
                del request_init["authorization_policy"][field][subfield]
    request = request_type(**request_init)
...
def test_create_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_create_authorization_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcn_authorization_policy.CreateAuthorizationPolicyRequest.pb(gcn_authorization_policy.CreateAuthorizationPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_authorization_policy_rest_bad_request(request_type=gcn_authorization_policy.UpdateAuthorizationPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"authorization_policy": {"name": "projects/sample1/locations/sample2/authorizationPolicies/sample3"}}
    request = request_type(**request_init)
...
def test_update_authorization_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_authorization_policy.UpdateAuthorizationPolicyRequest.meta.fields["authorization_policy"]
...
def test_update_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_update_authorization_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcn_authorization_policy.UpdateAuthorizationPolicyRequest.pb(gcn_authorization_policy.UpdateAuthorizationPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_authorization_policy_rest_bad_request(request_type=authorization_policy.DeleteAuthorizationPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/authorizationPolicies/sample3"}
    request = request_type(**request_init)
...
def test_delete_authorization_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_authorization_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_delete_authorization_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = authorization_policy.DeleteAuthorizationPolicyRequest.pb(authorization_policy.DeleteAuthorizationPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_server_tls_policies_rest_bad_request(request_type=server_tls_policy.ListServerTlsPoliciesRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_server_tls_policies_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_server_tls_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_server_tls_policies") as post, mock.patch.object(
        transports.NetworkSecurityRestInterceptor, "post_list_server_tls_policies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = server_tls_policy.ListServerTlsPoliciesRequest.pb(server_tls_policy.ListServerTlsPoliciesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = server_tls_policy.ListServerTlsPoliciesResponse.to_json(server_tls_policy.ListServerTlsPoliciesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = server_tls_policy.ListServerTlsPoliciesResponse(), metadata
...
def test_get_server_tls_policy_rest_bad_request(request_type=server_tls_policy.GetServerTlsPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/serverTlsPolicies/sample3"}
    request = request_type(**request_init)
...
def test_get_server_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_server_tls_policy") as post, mock.patch.object(
        transports.NetworkSecurityRestInterceptor, "post_get_server_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = server_tls_policy.GetServerTlsPolicyRequest.pb(server_tls_policy.GetServerTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = server_tls_policy.ServerTlsPolicy.to_json(server_tls_policy.ServerTlsPolicy())
        req.return_value.content = return_value
...
def test_create_server_tls_policy_rest_bad_request(request_type=gcn_server_tls_policy.CreateServerTlsPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_server_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["server_tls_policy"] = {
        ...
        "server_certificate": {
            ...
            "certificate_provider_instance": {"plugin_instance": "plugin_instance_value"},
        },
        "mtls_policy": {"client_validation_ca": [{"grpc_endpoint": {}, "certificate_provider_instance": {}}]},
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_server_tls_policy.CreateServerTlsPolicyRequest.meta.fields["server_tls_policy"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["server_tls_policy"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["server_tls_policy"][field])):
                    del request_init["server_tls_policy"][field][i][subfield]
            else:
                del request_init["server_tls_policy"][field][subfield]
    request = request_type(**request_init)
...
def test_create_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_create_server_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcn_server_tls_policy.CreateServerTlsPolicyRequest.pb(gcn_server_tls_policy.CreateServerTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_server_tls_policy_rest_bad_request(request_type=gcn_server_tls_policy.UpdateServerTlsPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"server_tls_policy": {"name": "projects/sample1/locations/sample2/serverTlsPolicies/sample3"}}
    request = request_type(**request_init)
...
def test_update_server_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcn_server_tls_policy.UpdateServerTlsPolicyRequest.meta.fields["server_tls_policy"]
...
def test_update_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_update_server_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcn_server_tls_policy.UpdateServerTlsPolicyRequest.pb(gcn_server_tls_policy.UpdateServerTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_server_tls_policy_rest_bad_request(request_type=server_tls_policy.DeleteServerTlsPolicyRequest):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/serverTlsPolicies/sample3"}
    request = request_type(**request_init)
...
def test_delete_server_tls_policy_rest_call_success(request_type):
    client = NetworkSecurityClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_server_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_delete_server_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = server_tls_policy.DeleteServerTlsPolicyRequest.pb(server_tls_policy.DeleteServerTlsPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_client_tls_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_list_client_tls_policies") as post, mock.patch.object(
        transports.NetworkSecurityRestInterceptor, "post_list_client_tls_policies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkSecurityRestInterceptor, "post_get_client_tls_policy") as post, mock.patch.object(
        transports.NetworkSecurityRestInterceptor, "post_get_client_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_client_tls_policy_rest_call_success(request_type):
    ...
    request_init["client_tls_policy"] = {
        ...
        "server_validation_ca": [{"grpc_endpoint": {}, "certificate_provider_instance": {}}],
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_create_client_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_update_client_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_client_tls_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NetworkSecurityRestInterceptor, "post_delete_client_tls_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_authorization_policies_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_authorization_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_authorization_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_authorization_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_authorization_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_server_tls_policies_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_server_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_server_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_server_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_server_tls_policy_empty_call_rest():
    client = NetworkSecurityClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.NetworkSecurityGrpcTransport, grpc_helpers), (transports.NetworkSecurityGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_network_security_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.NetworkSecurityRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
async def test_get_location_field_headers_async():
    client = NetworkSecurityAsyncClient(credentials=async_anonymous_credentials())

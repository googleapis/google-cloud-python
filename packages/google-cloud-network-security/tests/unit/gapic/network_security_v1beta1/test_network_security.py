...
from google.cloud.network_security_v1beta1.services.network_security.transports.base import (
...
def test_network_security_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True

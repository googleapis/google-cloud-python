...
from google.cloud.networksecurity_v1alpha1.services.network_security import (
...
def test_network_security_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.networksecurity_v1alpha1.services.network_security.transports.NetworkSecurityGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_client_tls_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*}/clientTlsPolicies"
...
def test_get_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{name=projects/*/locations/*/clientTlsPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_client_tls_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{client_tls_policy.name=projects/*/locations/*/clientTlsPolicies/*}"
            % client.transport._host,
            args[1],
        )
    ...
    request_init["client_tls_policy"] = {
        ...
        "client_certificate": {
            "local_filepath": {
                ...
                "private_key_path": "private_key_path_value",
            },
...
def test_network_security_base_transport():
    ...
    with mock.patch(
        "google.cloud.networksecurity_v1alpha1.services.network_security.transports.NetworkSecurityTransport.__init__"
    ) as Transport:
...
def test_network_security_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.networksecurity_v1alpha1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

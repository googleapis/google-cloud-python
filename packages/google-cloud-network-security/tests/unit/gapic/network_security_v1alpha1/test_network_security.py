...
from google.cloud.network_security_v1alpha1.services.network_security import (
...
def test_network_security_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_network_security_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityTransport.__init__"
    ) as Transport:
...
def test_network_security_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.network_security_v1alpha1.services.network_security.transports.NetworkSecurityTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

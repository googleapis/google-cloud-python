...
from google.cloud.network_security_v1alpha1.services.firewall_activation import (
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = FirewallActivationClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (FirewallActivationClient, "grpc"),
        (FirewallActivationAsyncClient, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (transports.FirewallActivationGrpcTransport, "grpc"),
        (transports.FirewallActivationGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_firewall_activation_client_get_transport_class():
    transport = FirewallActivationClient.get_transport_class()
    ...
    assert transport == transports.FirewallActivationGrpcTransport
...
def test_firewall_activation_client_client_options_from_dict():
    with mock.patch(
...
def test_list_firewall_endpoints(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.list_firewall_endpoints(request)
    ...
    assert isinstance(response, pagers.ListFirewallEndpointsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_firewall_endpoints_non_empty_request_with_auto_populated_field():
...
async def test_list_firewall_endpoints_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_firewall_endpoints(request)
...
@pytest.mark.asyncio
async def test_list_firewall_endpoints_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_firewall_endpoints_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_firewall_endpoints_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_firewall_endpoints_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_firewall_endpoints_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_firewall_endpoints_pager(transport_name: str = "grpc"):
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_firewall_endpoints_pages(transport_name: str = "grpc"):
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_firewall_endpoints(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_firewall_endpoints_async_pager():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_firewall_endpoints_async_pages():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_firewall_endpoints(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_firewall_endpoint(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.get_firewall_endpoint(request)
...
def test_get_firewall_endpoint_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_firewall_endpoint_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_firewall_endpoint] = (
            mock_rpc
        )
        request = {}
...
async def test_get_firewall_endpoint_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_firewall_endpoint(request)
...
@pytest.mark.asyncio
async def test_get_firewall_endpoint_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_firewall_endpoint_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_firewall_endpoint_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_firewall_endpoint_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_firewall_endpoint(
            firewall_activation.GetFirewallEndpointRequest(),
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_create_firewall_endpoint_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_firewall_endpoint_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.create_firewall_endpoint(
            parent="parent_value",
...
@pytest.mark.asyncio
async def test_create_firewall_endpoint_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_firewall_endpoint_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_firewall_endpoint(
            firewall_activation.CreateFirewallEndpointRequest(),
            parent="parent_value",
            firewall_endpoint=firewall_activation.FirewallEndpoint(name="name_value"),
            firewall_endpoint_id="firewall_endpoint_id_value",
...
def test_delete_firewall_endpoint_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_firewall_endpoint_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_firewall_endpoint_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_firewall_endpoint_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_firewall_endpoint_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_firewall_endpoint_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_firewall_endpoint_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_firewall_endpoint(
            firewall_activation.UpdateFirewallEndpointRequest(),
            firewall_endpoint=firewall_activation.FirewallEndpoint(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_list_firewall_endpoint_associations(request_type, transport: str = "grpc"):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListFirewallEndpointAssociationsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]
...
async def test_list_firewall_endpoint_associations_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_firewall_endpoint_associations(request)
...
@pytest.mark.asyncio
async def test_list_firewall_endpoint_associations_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_firewall_endpoint_associations_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_firewall_endpoint_associations_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_firewall_endpoint_associations_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_firewall_endpoint_associations_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_firewall_endpoint_associations(
            firewall_activation.ListFirewallEndpointAssociationsRequest(),
            parent="parent_value",
        )


def test_list_firewall_endpoint_associations_pager(transport_name: str = "grpc"):
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
def test_list_firewall_endpoint_associations_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_firewall_endpoint_associations(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_firewall_endpoint_associations_async_pager():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_firewall_endpoint_associations(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        assert str(async_pager).startswith(f"{async_pager.__class__.__name__}<")
...
@pytest.mark.asyncio
async def test_list_firewall_endpoint_associations_async_pages():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_firewall_endpoint_association(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = firewall_activation.FirewallEndpointAssociation(
            name="name_value",
            state=firewall_activation.FirewallEndpointAssociation.State.CREATING,
            network="network_value",
            firewall_endpoint="firewall_endpoint_value",
            tls_inspection_policy="tls_inspection_policy_value",
            reconciling=True,
            disabled=True,
        )
        response = client.get_firewall_endpoint_association(request)
...
def test_get_firewall_endpoint_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_firewall_endpoint_association_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_firewall_endpoint_association(request)
...
@pytest.mark.asyncio
async def test_get_firewall_endpoint_association_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_firewall_endpoint_association_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_firewall_endpoint_association_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_firewall_endpoint_association_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_firewall_endpoint_association_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_firewall_endpoint_association(
            firewall_activation.GetFirewallEndpointAssociationRequest(),
            name="name_value",
        )
...
def test_create_firewall_endpoint_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_firewall_endpoint_association_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_firewall_endpoint_association_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].firewall_endpoint_association
        mock_val = firewall_activation.FirewallEndpointAssociation(name="name_value")
        assert arg == mock_val
        arg = args[0].firewall_endpoint_association_id
        mock_val = "firewall_endpoint_association_id_value"
        assert arg == mock_val


def test_create_firewall_endpoint_association_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_firewall_endpoint_association_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_firewall_endpoint_association_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_firewall_endpoint_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_association_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_firewall_endpoint_association_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_association_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_association_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_firewall_endpoint_association(
            firewall_activation.DeleteFirewallEndpointAssociationRequest(),
            name="name_value",
        )
...
def test_update_firewall_endpoint_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_firewall_endpoint_association_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "firewall_endpoint_association.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_firewall_endpoint_association_field_headers_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_firewall_endpoint_association_flattened_error():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_firewall_endpoint_association_flattened_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_firewall_endpoint_association_flattened_error_async():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_firewall_endpoints_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FirewallActivationClient(
...
def test_list_firewall_endpoints_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListFirewallEndpoints,
...
def test_list_firewall_endpoints_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_firewall_endpoints(**mock_args)
...
def test_list_firewall_endpoints_rest_pager(transport: str = "rest"):
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pager = client.list_firewall_endpoints(request=sample_request)
        ...
        pages = list(client.list_firewall_endpoints(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_firewall_endpoint_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetFirewallEndpoint,
...
def test_get_firewall_endpoint_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_firewall_endpoint(**mock_args)
...
def test_create_firewall_endpoint_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateFirewallEndpoint,
...
def test_create_firewall_endpoint_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_firewall_endpoint(**mock_args)
...
def test_delete_firewall_endpoint_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteFirewallEndpoint,
...
def test_delete_firewall_endpoint_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_firewall_endpoint(**mock_args)
...
def test_update_firewall_endpoint_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateFirewallEndpoint,
...
def test_update_firewall_endpoint_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_firewall_endpoint(**mock_args)
...
def test_update_firewall_endpoint_rest_flattened_error(transport: str = "rest"):
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_firewall_endpoint_associations_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FirewallActivationClient(
...
def test_list_firewall_endpoint_associations_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListFirewallEndpointAssociations,
...
def test_list_firewall_endpoint_associations_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_firewall_endpoint_associations(**mock_args)
...
def test_list_firewall_endpoint_associations_rest_pager(transport: str = "rest"):
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_firewall_endpoint_association_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FirewallActivationClient(
...
def test_get_firewall_endpoint_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetFirewallEndpointAssociation,
...
def test_get_firewall_endpoint_association_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_firewall_endpoint_association(**mock_args)
...
def test_create_firewall_endpoint_association_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FirewallActivationClient(
...
def test_create_firewall_endpoint_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateFirewallEndpointAssociation,
...
def test_create_firewall_endpoint_association_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_firewall_endpoint_association(**mock_args)
...
def test_delete_firewall_endpoint_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteFirewallEndpointAssociation,
...
def test_delete_firewall_endpoint_association_rest_flattened():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_firewall_endpoint_association(**mock_args)
...
def test_update_firewall_endpoint_association_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FirewallActivationClient(
...
def test_update_firewall_endpoint_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateFirewallEndpointAssociation,
...
def test_update_firewall_endpoint_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_firewall_endpoint_association(**mock_args)
...
def test_transport_get_channel():
    ...
    transport = transports.FirewallActivationGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_firewall_endpoints_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_firewall_endpoint_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_firewall_endpoint_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_firewall_endpoint_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_firewall_endpoint_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_firewall_endpoint_associations_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_firewall_endpoint_association_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_firewall_endpoint_association_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_firewall_endpoint_association_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_firewall_endpoint_association_empty_call_grpc():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_firewall_endpoints_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.list_firewall_endpoints(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_firewall_endpoint_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_firewall_endpoint(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_firewall_endpoint_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_firewall_endpoint_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_firewall_endpoint_associations_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_firewall_endpoint_associations(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_firewall_endpoint_association_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_firewall_endpoint_association(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_firewall_endpoint_association_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_firewall_endpoint_association_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_firewall_endpoint_association_empty_call_grpc_asyncio():
    client = FirewallActivationAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_firewall_endpoints_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_firewall_endpoint_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_firewall_endpoint_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_firewall_endpoint_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_firewall_endpoint_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_firewall_endpoint_associations_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_firewall_endpoint_association_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_firewall_endpoint_association_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_firewall_endpoint_association_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_firewall_endpoint_association_empty_call_rest():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_firewall_activation_rest_lro_client():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_firewall_activation_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_security_v1alpha1.services.firewall_activation.transports.FirewallActivationTransport.__init__"
    ) as Transport:
...
def test_firewall_activation_base_transport_with_adc():
...
def test_firewall_activation_auth_adc():
...
def test_firewall_activation_transport_auth_adc(transport_class):
...
def test_firewall_activation_transport_auth_gdch_credentials(transport_class):
...
def test_firewall_activation_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = FirewallActivationClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = FirewallActivationClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    assert session1 != session2
    session1 = client1.transport.get_firewall_endpoint_association._session
    session2 = client2.transport.get_firewall_endpoint_association._session
    assert session1 != session2
    session1 = client1.transport.create_firewall_endpoint_association._session
    session2 = client2.transport.create_firewall_endpoint_association._session
    assert session1 != session2
    session1 = client1.transport.delete_firewall_endpoint_association._session
    session2 = client2.transport.delete_firewall_endpoint_association._session
    assert session1 != session2
    session1 = client1.transport.update_firewall_endpoint_association._session
    session2 = client2.transport.update_firewall_endpoint_association._session
    assert session1 != session2


def test_firewall_activation_grpc_transport_channel():
...
def test_firewall_activation_grpc_asyncio_transport_channel():
...
def test_firewall_activation_grpc_lro_client():
    client = FirewallActivationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_firewall_activation_grpc_lro_async_client():
    client = FirewallActivationAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc_asyncio",
    )
...
def test_firewall_endpoint_path():
    organization = "squid"
    location = "clam"
    firewall_endpoint = "whelk"
    expected = "organizations/{organization}/locations/{location}/firewallEndpoints/{firewall_endpoint}".format(
...
def test_parse_firewall_endpoint_path():
    expected = {
        "organization": "octopus",
        "location": "oyster",
        "firewall_endpoint": "nudibranch",
    }
    path = FirewallActivationClient.firewall_endpoint_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_firewall_endpoint_path(path)
    assert expected == actual


def test_firewall_endpoint_association_path():
    project = "cuttlefish"
    location = "mussel"
    firewall_endpoint_association = "winkle"
    expected = "projects/{project}/locations/{location}/firewallEndpointAssociations/{firewall_endpoint_association}".format(
        project=project,
        location=location,
...
def test_parse_firewall_endpoint_association_path():
    expected = {
        "project": "nautilus",
        "location": "scallop",
        "firewall_endpoint_association": "abalone",
    }
    path = FirewallActivationClient.firewall_endpoint_association_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_firewall_endpoint_association_path(path)
    assert expected == actual
...
def test_network_path():
    ...
    actual = FirewallActivationClient.network_path(project, network)
    assert expected == actual
...
def test_parse_network_path():
    ...
    path = FirewallActivationClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_network_path(path)
    assert expected == actual
...
def test_tls_inspection_policy_path():
    project = "oyster"
    location = "nudibranch"
    tls_inspection_policy = "cuttlefish"
    expected = "projects/{project}/locations/{location}/tlsInspectionPolicies/{tls_inspection_policy}".format(
        project=project,
        location=location,
...
def test_parse_tls_inspection_policy_path():
    expected = {
        "project": "mussel",
        "location": "winkle",
        "tls_inspection_policy": "nautilus",
    }
    path = FirewallActivationClient.tls_inspection_policy_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_tls_inspection_policy_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = FirewallActivationClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = FirewallActivationClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = FirewallActivationClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = FirewallActivationClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = FirewallActivationClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = FirewallActivationClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = FirewallActivationClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = FirewallActivationClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = FirewallActivationClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = FirewallActivationClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = FirewallActivationClient.parse_common_location_path(path)
    assert expected == actual
...
def test_get_location_field_headers():
    client = FirewallActivationClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = FirewallActivationAsyncClient(credentials=async_anonymous_credentials())

...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = InterceptClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (InterceptClient, "grpc"),
        (InterceptAsyncClient, "grpc_asyncio"),
        (InterceptClient, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.InterceptGrpcTransport, "grpc"),
        (transports.InterceptGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_intercept_client_get_transport_class():
    transport = InterceptClient.get_transport_class()
    available_transports = [
        transports.InterceptGrpcTransport,
        transports.InterceptRestTransport,
    ]
    assert transport in available_transports

    transport = InterceptClient.get_transport_class("grpc")
    assert transport == transports.InterceptGrpcTransport
...
def test_list_intercept_endpoint_groups(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.list_intercept_endpoint_groups(request)
    ...
    assert isinstance(response, pagers.ListInterceptEndpointGroupsPager)
    assert response.next_page_token == "next_page_token_value"


def test_list_intercept_endpoint_groups_non_empty_request_with_auto_populated_field():
...
async def test_list_intercept_endpoint_groups_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_intercept_endpoint_groups(request)
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_groups_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_intercept_endpoint_groups_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_intercept_endpoint_groups_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_groups_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_groups_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_intercept_endpoint_groups(
            intercept.ListInterceptEndpointGroupsRequest(),
            parent="parent_value",
        )


def test_list_intercept_endpoint_groups_pager(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_intercept_endpoint_groups_pages(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_intercept_endpoint_groups(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_intercept_endpoint_groups_async_pager():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_intercept_endpoint_groups(
            request={},
        )
        ...
        assert all(isinstance(i, intercept.InterceptEndpointGroup) for i in responses)


@pytest.mark.asyncio
async def test_list_intercept_endpoint_groups_async_pages():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_endpoint_group(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = intercept.InterceptEndpointGroup(
            ...
            state=intercept.InterceptEndpointGroup.State.ACTIVE,
            reconciling=True,
            description="description_value",
        )
        response = client.get_intercept_endpoint_group(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, intercept.InterceptEndpointGroup)
    assert response.name == "name_value"
    assert response.intercept_deployment_group == "intercept_deployment_group_value"
    assert response.state == intercept.InterceptEndpointGroup.State.ACTIVE
    assert response.reconciling is True
    assert response.description == "description_value"


def test_get_intercept_endpoint_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_intercept_endpoint_group_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_intercept_endpoint_group(request)
...
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_endpoint_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_intercept_endpoint_group(
            name="name_value",
        )
...
def test_get_intercept_endpoint_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_intercept_endpoint_group(
            intercept.GetInterceptEndpointGroupRequest(),
            name="name_value",
        )
...
def test_create_intercept_endpoint_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_intercept_endpoint_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].intercept_endpoint_group
        mock_val = intercept.InterceptEndpointGroup(name="name_value")
        assert arg == mock_val
        arg = args[0].intercept_endpoint_group_id
        mock_val = "intercept_endpoint_group_id_value"
        assert arg == mock_val


def test_create_intercept_endpoint_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_endpoint_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_intercept_endpoint_group_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "intercept_endpoint_group.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_endpoint_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_intercept_endpoint_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_endpoint_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_endpoint_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_intercept_endpoint_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_intercept_endpoint_group(
            intercept.DeleteInterceptEndpointGroupRequest(),
            name="name_value",
        )
...
def test_list_intercept_endpoint_group_associations(
    ...
    with mock.patch.object(
        ...
        response = client.list_intercept_endpoint_group_associations(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListInterceptEndpointGroupAssociationsPager)
    assert response.next_page_token == "next_page_token_value"


def test_list_intercept_endpoint_group_associations_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_list_intercept_endpoint_group_associations_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_intercept_endpoint_group_associations(request)
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_group_associations_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_intercept_endpoint_group_associations_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_intercept_endpoint_group_associations_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_group_associations_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_group_associations_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_intercept_endpoint_group_associations(
            intercept.ListInterceptEndpointGroupAssociationsRequest(),
            parent="parent_value",
        )


def test_list_intercept_endpoint_group_associations_pager(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_group_associations_async_pager():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_intercept_endpoint_group_associations(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
...
@pytest.mark.asyncio
async def test_list_intercept_endpoint_group_associations_async_pages():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_endpoint_group_association(
    ...
    with mock.patch.object(
        ...
        call.return_value = intercept.InterceptEndpointGroupAssociation(
            ...
            state=intercept.InterceptEndpointGroupAssociation.State.ACTIVE,
            reconciling=True,
        )
        response = client.get_intercept_endpoint_group_association(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, intercept.InterceptEndpointGroupAssociation)
    assert response.name == "name_value"
    assert response.intercept_endpoint_group == "intercept_endpoint_group_value"
    assert response.network == "network_value"
    assert response.state == intercept.InterceptEndpointGroupAssociation.State.ACTIVE
    assert response.reconciling is True


def test_get_intercept_endpoint_group_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_intercept_endpoint_group_association_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_intercept_endpoint_group_association(request)
...
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_association_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_endpoint_group_association_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_intercept_endpoint_group_association_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_association_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_association_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_intercept_endpoint_group_association(
            intercept.GetInterceptEndpointGroupAssociationRequest(),
            name="name_value",
        )
...
def test_create_intercept_endpoint_group_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_association_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_intercept_endpoint_group_association_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].intercept_endpoint_group_association
        mock_val = intercept.InterceptEndpointGroupAssociation(name="name_value")
        assert arg == mock_val
        arg = args[0].intercept_endpoint_group_association_id
        mock_val = "intercept_endpoint_group_association_id_value"
        assert arg == mock_val


def test_create_intercept_endpoint_group_association_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_association_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_association_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_endpoint_group_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_intercept_endpoint_group_association_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "intercept_endpoint_group_association.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_association_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_endpoint_group_association_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_intercept_endpoint_group_association_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_association_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_association_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_endpoint_group_association_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_association_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_endpoint_group_association_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_intercept_endpoint_group_association_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_association_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_association_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_intercept_endpoint_group_association(
            intercept.DeleteInterceptEndpointGroupAssociationRequest(),
            name="name_value",
        )
...
def test_list_intercept_deployment_groups(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.list_intercept_deployment_groups(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListInterceptDeploymentGroupsPager)
    assert response.next_page_token == "next_page_token_value"


def test_list_intercept_deployment_groups_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_list_intercept_deployment_groups_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_intercept_deployment_groups(request)
...
@pytest.mark.asyncio
async def test_list_intercept_deployment_groups_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_intercept_deployment_groups_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_intercept_deployment_groups_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_deployment_groups_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_deployment_groups_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_intercept_deployment_groups(
            intercept.ListInterceptDeploymentGroupsRequest(),
            parent="parent_value",
        )


def test_list_intercept_deployment_groups_pager(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
def test_list_intercept_deployment_groups_pages(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_intercept_deployment_groups(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_intercept_deployment_groups_async_pager():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_intercept_deployment_groups(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
        ...
        assert len(responses) == 6
        assert all(isinstance(i, intercept.InterceptDeploymentGroup) for i in responses)


@pytest.mark.asyncio
async def test_list_intercept_deployment_groups_async_pages():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_deployment_group(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = intercept.InterceptDeploymentGroup(
            name="name_value",
            network="network_value",
            state=intercept.InterceptDeploymentGroup.State.ACTIVE,
            reconciling=True,
            description="description_value",
        )
        response = client.get_intercept_deployment_group(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, intercept.InterceptDeploymentGroup)
    assert response.name == "name_value"
    assert response.network == "network_value"
...
def test_get_intercept_deployment_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_intercept_deployment_group_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_intercept_deployment_group(request)
...
@pytest.mark.asyncio
async def test_get_intercept_deployment_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_deployment_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_intercept_deployment_group(
            name="name_value",
        )
...
def test_get_intercept_deployment_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_deployment_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_deployment_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_intercept_deployment_group(
            intercept.GetInterceptDeploymentGroupRequest(),
            name="name_value",
        )
...
def test_create_intercept_deployment_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_intercept_deployment_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_intercept_deployment_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].intercept_deployment_group
        mock_val = intercept.InterceptDeploymentGroup(name="name_value")
        assert arg == mock_val
        arg = args[0].intercept_deployment_group_id
        mock_val = "intercept_deployment_group_id_value"
        assert arg == mock_val


def test_create_intercept_deployment_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_deployment_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_deployment_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_deployment_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_intercept_deployment_group_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "intercept_deployment_group.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_intercept_deployment_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_deployment_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_intercept_deployment_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_deployment_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_deployment_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_deployment_group_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_intercept_deployment_group_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_deployment_group_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_intercept_deployment_group_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_deployment_group_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_deployment_group_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_intercept_deployment_group(
            intercept.DeleteInterceptDeploymentGroupRequest(),
            name="name_value",
        )
...
def test_list_intercept_deployments(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.list_intercept_deployments(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListInterceptDeploymentsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_intercept_deployments_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_list_intercept_deployments_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_intercept_deployments(request)
...
@pytest.mark.asyncio
async def test_list_intercept_deployments_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_intercept_deployments_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_intercept_deployments_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_deployments_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_intercept_deployments_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_intercept_deployments(
            intercept.ListInterceptDeploymentsRequest(),
            parent="parent_value",
        )


def test_list_intercept_deployments_pager(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
def test_list_intercept_deployments_pages(transport_name: str = "grpc"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_intercept_deployments(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_intercept_deployments_async_pager():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_intercept_deployments(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
        ...
        assert len(responses) == 6
        assert all(isinstance(i, intercept.InterceptDeployment) for i in responses)


@pytest.mark.asyncio
async def test_list_intercept_deployments_async_pages():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_deployment(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = intercept.InterceptDeployment(
            ...
            intercept_deployment_group="intercept_deployment_group_value",
            state=intercept.InterceptDeployment.State.ACTIVE,
            reconciling=True,
            description="description_value",
        )
        response = client.get_intercept_deployment(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, intercept.InterceptDeployment)
    assert response.name == "name_value"
    assert response.forwarding_rule == "forwarding_rule_value"
    assert response.intercept_deployment_group == "intercept_deployment_group_value"
...
def test_get_intercept_deployment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_intercept_deployment_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_intercept_deployment(request)
...
@pytest.mark.asyncio
async def test_get_intercept_deployment_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_intercept_deployment_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_intercept_deployment(
            name="name_value",
        )
...
def test_get_intercept_deployment_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_deployment_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_intercept_deployment_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_intercept_deployment(
            intercept.GetInterceptDeploymentRequest(),
            name="name_value",
        )
...
def test_create_intercept_deployment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_intercept_deployment_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_intercept_deployment_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.create_intercept_deployment(
            parent="parent_value",
            intercept_deployment=intercept.InterceptDeployment(name="name_value"),
            intercept_deployment_id="intercept_deployment_id_value",
        )
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].intercept_deployment
        mock_val = intercept.InterceptDeployment(name="name_value")
        assert arg == mock_val
        arg = args[0].intercept_deployment_id
        mock_val = "intercept_deployment_id_value"
        assert arg == mock_val


def test_create_intercept_deployment_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_deployment_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_intercept_deployment_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_intercept_deployment(
            intercept.CreateInterceptDeploymentRequest(),
            parent="parent_value",
            intercept_deployment=intercept.InterceptDeployment(name="name_value"),
            intercept_deployment_id="intercept_deployment_id_value",
...
def test_update_intercept_deployment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_intercept_deployment_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "intercept_deployment.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_intercept_deployment_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_intercept_deployment_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_intercept_deployment_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_deployment_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_intercept_deployment_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_intercept_deployment(
            intercept.UpdateInterceptDeploymentRequest(),
            intercept_deployment=intercept.InterceptDeployment(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_delete_intercept_deployment_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_intercept_deployment_field_headers_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_intercept_deployment_flattened():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_intercept_deployment_flattened_error():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_deployment_flattened_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_intercept_deployment_flattened_error_async():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_intercept_deployment(
            intercept.DeleteInterceptDeploymentRequest(),
            name="name_value",
        )
...
def test_list_intercept_endpoint_groups_rest_required_fields(
    ...
    return_value = intercept.ListInterceptEndpointGroupsResponse()
...
def test_list_intercept_endpoint_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_intercept_endpoint_groups(**mock_args)
...
def test_list_intercept_endpoint_groups_rest_pager(transport: str = "rest"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_intercept_endpoint_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_get_intercept_endpoint_group_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = intercept.InterceptEndpointGroup.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_intercept_endpoint_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_intercept_endpoint_group(**mock_args)
...
def test_create_intercept_endpoint_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_create_intercept_endpoint_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_intercept_endpoint_group(**mock_args)
...
def test_update_intercept_endpoint_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_update_intercept_endpoint_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_intercept_endpoint_group(**mock_args)
...
def test_update_intercept_endpoint_group_rest_flattened_error(transport: str = "rest"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_intercept_endpoint_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_delete_intercept_endpoint_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_intercept_endpoint_group(**mock_args)
...
def test_list_intercept_endpoint_group_associations_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_list_intercept_endpoint_group_associations_rest_required_fields(
    ...
    # Designate an appropriate value for the returned response.
    return_value = intercept.ListInterceptEndpointGroupAssociationsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_list_intercept_endpoint_group_associations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_intercept_endpoint_group_associations(**mock_args)
...
def test_list_intercept_endpoint_group_associations_rest_pager(transport: str = "rest"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_intercept_endpoint_group_association_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_get_intercept_endpoint_group_association_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = intercept.InterceptEndpointGroupAssociation.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_intercept_endpoint_group_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_intercept_endpoint_group_association(**mock_args)
...
def test_create_intercept_endpoint_group_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_intercept_endpoint_group_association(**mock_args)
...
def test_update_intercept_endpoint_group_association_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_update_intercept_endpoint_group_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_intercept_endpoint_group_association(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha1/{intercept_endpoint_group_association.name=projects/*/locations/*/interceptEndpointGroupAssociations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_intercept_endpoint_group_association_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_delete_intercept_endpoint_group_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_intercept_endpoint_group_association(**mock_args)
...
def test_list_intercept_deployment_groups_rest_required_fields(
    ...
    # Designate an appropriate value for the returned response.
    return_value = intercept.ListInterceptDeploymentGroupsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_list_intercept_deployment_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_intercept_deployment_groups(**mock_args)
...
def test_list_intercept_deployment_groups_rest_pager(transport: str = "rest"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_intercept_deployment_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_get_intercept_deployment_group_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = intercept.InterceptDeploymentGroup.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_intercept_deployment_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_intercept_deployment_group(**mock_args)
...
def test_create_intercept_deployment_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_intercept_deployment_group(**mock_args)
...
def test_update_intercept_deployment_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_update_intercept_deployment_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_intercept_deployment_group(**mock_args)
...
def test_delete_intercept_deployment_group_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_delete_intercept_deployment_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_intercept_deployment_group(**mock_args)
...
def test_list_intercept_deployments_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_list_intercept_deployments_rest_required_fields(
    ...
    # Designate an appropriate value for the returned response.
    return_value = intercept.ListInterceptDeploymentsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = intercept.ListInterceptDeploymentsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_intercept_deployments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_intercept_deployments(**mock_args)
...
def test_list_intercept_deployments_rest_pager(transport: str = "rest"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pages = list(client.list_intercept_deployments(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_get_intercept_deployment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_get_intercept_deployment_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = intercept.InterceptDeployment.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_intercept_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_intercept_deployment(**mock_args)
...
def test_create_intercept_deployment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_create_intercept_deployment_rest_required_fields(
    ...
    assert jsonified_request["parent"] == "parent_value"
    assert "interceptDeploymentId" in jsonified_request
    assert jsonified_request["interceptDeploymentId"] == "intercept_deployment_id_value"
...
def test_create_intercept_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_intercept_deployment(**mock_args)
...
def test_update_intercept_deployment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_update_intercept_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_intercept_deployment(**mock_args)
...
def test_update_intercept_deployment_rest_flattened_error(transport: str = "rest"):
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_intercept_deployment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = InterceptClient(
...
def test_delete_intercept_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_intercept_deployment(**mock_args)
...
def test_transport_get_channel():
    ...
    transport = transports.InterceptGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_intercept_endpoint_groups_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_endpoint_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_endpoint_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_endpoint_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_endpoint_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_intercept_endpoint_group_associations_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_endpoint_group_association_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_endpoint_group_association_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_endpoint_group_association_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_endpoint_group_association_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_intercept_deployment_groups_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_deployment_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_deployment_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_deployment_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_deployment_group_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_intercept_deployments_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_deployment_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_deployment_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_deployment_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_deployment_empty_call_grpc():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_intercept_endpoint_groups_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.list_intercept_endpoint_groups(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_intercept_endpoint_group(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_intercept_endpoint_group_associations_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_intercept_endpoint_group_associations(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_intercept_endpoint_group_association_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_intercept_endpoint_group_association(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_intercept_endpoint_group_association_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_intercept_endpoint_group_association_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_intercept_endpoint_group_association_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_intercept_deployment_groups_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_intercept_deployment_groups(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_intercept_deployment_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_intercept_deployment_group(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_intercept_deployment_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_intercept_deployment_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_intercept_deployment_group_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_intercept_deployments_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_intercept_deployments(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_intercept_deployment_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_intercept_deployment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_intercept_deployment_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_intercept_deployment_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_intercept_deployment_empty_call_grpc_asyncio():
    client = InterceptAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_list_intercept_endpoint_groups_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_intercept_endpoint_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
    ...
    with (
        ...
        pre.return_value = request, metadata
        post.return_value = intercept.InterceptEndpointGroup()
        post_with_metadata.return_value = intercept.InterceptEndpointGroup(), metadata
...
def test_create_intercept_endpoint_group_rest_call_success(request_type):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["intercept_endpoint_group"][field])):
                    del request_init["intercept_endpoint_group"][field][i][subfield]
            else:
                del request_init["intercept_endpoint_group"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_intercept_endpoint_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_intercept_endpoint_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_intercept_endpoint_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_intercept_endpoint_group_associations_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_intercept_endpoint_group_association_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
def test_create_intercept_endpoint_group_association_rest_call_success(request_type):
    ...
    request_init["intercept_endpoint_group_association"] = {
        ...
        "intercept_endpoint_group": "intercept_endpoint_group_value",
        "network": "network_value",
        "locations_details": [{"location": "location_value", "state": 1}],
        "state": 1,
        "reconciling": True,
        "locations": [{"location": "location_value", "state": 1}],
    }
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_intercept_deployment_groups_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_intercept_deployment_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
    ...
    with (
        ...
        pre.return_value = request, metadata
        post.return_value = intercept.InterceptDeploymentGroup()
        post_with_metadata.return_value = intercept.InterceptDeploymentGroup(), metadata
...
def test_create_intercept_deployment_group_rest_call_success(request_type):
    ...
    request_init["intercept_deployment_group"] = {
        ...
        "labels": {},
        "network": "network_value",
        "connected_endpoint_groups": [{"name": "name_value"}],
        "nested_deployments": [{"name": "name_value", "state": 1}],
        "state": 1,
        "reconciling": True,
        "description": "description_value",
        "locations": [{"location": "location_value", "state": 1}],
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_intercept_deployment_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
    ...
    with (
        ...
        mock.patch.object(
            transports.InterceptRestInterceptor,
            "post_create_intercept_deployment_group",
        ) as post,
        mock.patch.object(
            transports.InterceptRestInterceptor,
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_intercept_deployment_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
    ...
    with (
        ...
        mock.patch.object(
            transports.InterceptRestInterceptor,
            "post_update_intercept_deployment_group",
        ) as post,
        mock.patch.object(
            transports.InterceptRestInterceptor,
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_intercept_deployment_group_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
    ...
    with (
        ...
        mock.patch.object(
            transports.InterceptRestInterceptor,
            "post_delete_intercept_deployment_group",
        ) as post,
        mock.patch.object(
            transports.InterceptRestInterceptor,
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_intercept_deployments_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_intercept_deployment_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
    ...
    with (
        ...
        pre.return_value = request, metadata
        post.return_value = intercept.InterceptDeployment()
        post_with_metadata.return_value = intercept.InterceptDeployment(), metadata
...
def test_create_intercept_deployment_rest_call_success(request_type):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["intercept_deployment"][field])):
                    del request_init["intercept_deployment"][field][i][subfield]
            else:
                del request_init["intercept_deployment"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_intercept_deployment_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_intercept_deployment_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_intercept_deployment_rest_interceptors(null_interceptor):
    transport = transports.InterceptRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterceptRestInterceptor(),
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_intercept_endpoint_groups_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_endpoint_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_endpoint_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_endpoint_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_endpoint_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_intercept_endpoint_group_associations_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_endpoint_group_association_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_endpoint_group_association_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_endpoint_group_association_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_endpoint_group_association_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_intercept_deployment_groups_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_deployment_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_intercept_deployment_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_deployment_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_deployment_group_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_intercept_deployment_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_intercept_deployment_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_intercept_deployment_empty_call_rest():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_intercept_rest_lro_client():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_intercept_base_transport_with_adc():
...
def test_intercept_transport_auth_adc(transport_class):
...
def test_intercept_transport_auth_gdch_credentials(transport_class):
...
def test_intercept_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = InterceptClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = InterceptClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.list_intercept_endpoint_groups._session
    session2 = client2.transport.list_intercept_endpoint_groups._session
    assert session1 != session2
    session1 = client1.transport.get_intercept_endpoint_group._session
    session2 = client2.transport.get_intercept_endpoint_group._session
    assert session1 != session2
    session1 = client1.transport.create_intercept_endpoint_group._session
    session2 = client2.transport.create_intercept_endpoint_group._session
    assert session1 != session2
    session1 = client1.transport.update_intercept_endpoint_group._session
    session2 = client2.transport.update_intercept_endpoint_group._session
    assert session1 != session2
    session1 = client1.transport.delete_intercept_endpoint_group._session
    session2 = client2.transport.delete_intercept_endpoint_group._session
    assert session1 != session2
    session1 = client1.transport.list_intercept_endpoint_group_associations._session
    session2 = client2.transport.list_intercept_endpoint_group_associations._session
    assert session1 != session2
    session1 = client1.transport.get_intercept_endpoint_group_association._session
    session2 = client2.transport.get_intercept_endpoint_group_association._session
    assert session1 != session2
    session1 = client1.transport.create_intercept_endpoint_group_association._session
    session2 = client2.transport.create_intercept_endpoint_group_association._session
    assert session1 != session2
    session1 = client1.transport.update_intercept_endpoint_group_association._session
    session2 = client2.transport.update_intercept_endpoint_group_association._session
    assert session1 != session2
    session1 = client1.transport.delete_intercept_endpoint_group_association._session
    session2 = client2.transport.delete_intercept_endpoint_group_association._session
    assert session1 != session2
    session1 = client1.transport.list_intercept_deployment_groups._session
    session2 = client2.transport.list_intercept_deployment_groups._session
    assert session1 != session2
    session1 = client1.transport.get_intercept_deployment_group._session
    session2 = client2.transport.get_intercept_deployment_group._session
    assert session1 != session2
    session1 = client1.transport.create_intercept_deployment_group._session
    session2 = client2.transport.create_intercept_deployment_group._session
    assert session1 != session2
    session1 = client1.transport.update_intercept_deployment_group._session
    session2 = client2.transport.update_intercept_deployment_group._session
    assert session1 != session2
    session1 = client1.transport.delete_intercept_deployment_group._session
    session2 = client2.transport.delete_intercept_deployment_group._session
    assert session1 != session2
    session1 = client1.transport.list_intercept_deployments._session
    session2 = client2.transport.list_intercept_deployments._session
    assert session1 != session2
    session1 = client1.transport.get_intercept_deployment._session
    session2 = client2.transport.get_intercept_deployment._session
    assert session1 != session2
    session1 = client1.transport.create_intercept_deployment._session
    session2 = client2.transport.create_intercept_deployment._session
    assert session1 != session2
    session1 = client1.transport.update_intercept_deployment._session
    session2 = client2.transport.update_intercept_deployment._session
    assert session1 != session2
    session1 = client1.transport.delete_intercept_deployment._session
    session2 = client2.transport.delete_intercept_deployment._session
    assert session1 != session2


def test_intercept_grpc_transport_channel():
...
def test_intercept_grpc_asyncio_transport_channel():
...
def test_intercept_grpc_lro_client():
    client = InterceptClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_intercept_grpc_lro_async_client():
    client = InterceptAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc_asyncio",
    )
...
def test_forwarding_rule_path():
    ...
    expected = "projects/{project}/global/forwardingRules/{forwarding_rule}".format(
        project=project,
        forwarding_rule=forwarding_rule,
    )
    actual = InterceptClient.forwarding_rule_path(project, forwarding_rule)
...
def test_parse_forwarding_rule_path():
    expected = {
        "project": "whelk",
        "forwarding_rule": "octopus",
    }
    path = InterceptClient.forwarding_rule_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_forwarding_rule_path(path)
    assert expected == actual
...
def test_intercept_deployment_path():
    project = "oyster"
    location = "nudibranch"
    intercept_deployment = "cuttlefish"
    expected = "projects/{project}/locations/{location}/interceptDeployments/{intercept_deployment}".format(
        project=project,
        location=location,
...
def test_parse_intercept_deployment_path():
    expected = {
        "project": "mussel",
        "location": "winkle",
        "intercept_deployment": "nautilus",
    }
    path = InterceptClient.intercept_deployment_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_intercept_deployment_path(path)
    assert expected == actual
...
def test_intercept_deployment_group_path():
    project = "scallop"
    location = "abalone"
    intercept_deployment_group = "squid"
    expected = "projects/{project}/locations/{location}/interceptDeploymentGroups/{intercept_deployment_group}".format(
        project=project,
        location=location,
...
def test_parse_intercept_deployment_group_path():
    expected = {
        "project": "clam",
        "location": "whelk",
        "intercept_deployment_group": "octopus",
    }
    path = InterceptClient.intercept_deployment_group_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_intercept_deployment_group_path(path)
    assert expected == actual
...
def test_intercept_endpoint_group_path():
    project = "oyster"
    location = "nudibranch"
    intercept_endpoint_group = "cuttlefish"
...
def test_parse_intercept_endpoint_group_path():
    expected = {
        "project": "mussel",
        "location": "winkle",
        "intercept_endpoint_group": "nautilus",
    }
    path = InterceptClient.intercept_endpoint_group_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_intercept_endpoint_group_path(path)
    assert expected == actual
...
def test_intercept_endpoint_group_association_path():
    project = "scallop"
    location = "abalone"
    intercept_endpoint_group_association = "squid"
    expected = "projects/{project}/locations/{location}/interceptEndpointGroupAssociations/{intercept_endpoint_group_association}".format(
        project=project,
        location=location,
...
def test_parse_intercept_endpoint_group_association_path():
    expected = {
        "project": "clam",
        "location": "whelk",
        "intercept_endpoint_group_association": "octopus",
    }
    path = InterceptClient.intercept_endpoint_group_association_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_intercept_endpoint_group_association_path(path)
    assert expected == actual
...
def test_network_path():
    ...
    actual = InterceptClient.network_path(project, network)
    assert expected == actual
...
def test_parse_network_path():
    ...
    path = InterceptClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_network_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = InterceptClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = InterceptClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = InterceptClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = InterceptClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = InterceptClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = InterceptClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = InterceptClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = InterceptClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = InterceptClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = InterceptClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = InterceptClient.parse_common_location_path(path)
    assert expected == actual
...
def test_get_location_field_headers():
    client = InterceptClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = InterceptAsyncClient(credentials=async_anonymous_credentials())
...
@pytest.mark.parametrize(
    ...
    [
        (InterceptClient, transports.InterceptGrpcTransport),
        (InterceptAsyncClient, transports.InterceptGrpcAsyncIOTransport),
    ],
)

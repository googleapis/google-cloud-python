...
- While logged into your GitHub account, navigate to the
  ``python-network-security`` `repo`_ on GitHub.

- Fork and clone the ``python-network-security`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-network-security`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-network-security``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-network-security.git hack-on-python-network-security
   $ cd hack-on-python-network-security
   # Configure remotes such that you can pull changes from the googleapis/python-network-security
   # repository into your local repository.
   $ git remote add upstream git@github.com:googleapis/python-network-security.git
...
.. _repo: https://github.com/googleapis/python-network-security
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-network-security``. The

...
class ListSecurityProfileGroupsResponse(proto.Message):
    ...
    Attributes:
        security_profile_groups (MutableSequence[google.cloud.network_security_v1.types.SecurityProfileGroup]):
...
class ListSecurityProfilesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``projects|organizations/*/locations/{location}``.
        page_size (int):
            Optional. Maximum number of SecurityProfiles
            to return per call.
        page_token (str):
            Optional. The value returned by the last
...
class ListSecurityProfilesResponse(proto.Message):
    ...
    Attributes:
        security_profiles (MutableSequence[google.cloud.network_security_v1.types.SecurityProfile]):

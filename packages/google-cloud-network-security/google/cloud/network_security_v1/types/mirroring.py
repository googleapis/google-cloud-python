...
class MirroringEndpointGroup(proto.Message):
    ...
    Attributes:
        ...
        connected_deployment_groups (MutableSequence[google.cloud.network_security_v1.types.MirroringEndpointGroup.ConnectedDeploymentGroup]):
            Output only. List of details about the
            connected deployment groups to this endpoint
            group.
        state (google.cloud.network_security_v1.types.MirroringEndpointGroup.State):
        ...
        type_ (google.cloud.network_security_v1.types.MirroringEndpointGroup.Type):
            Immutable. The type of the endpoint group.
            If left unspecified, defaults to DIRECT.
        associations (MutableSequence[google.cloud.network_security_v1.types.MirroringEndpointGroup.AssociationDetails]):
    ...
    class ConnectedDeploymentGroup(proto.Message):
        ...
        Attributes:
            name (str):
                ...
                ``projects/123456789/locations/global/mirroringDeploymentGroups/my-dg``.
                See https://google.aip.dev/124.
            locations (MutableSequence[google.cloud.network_security_v1.types.MirroringLocation]):
    ...
    class AssociationDetails(proto.Message):
        ...
        Attributes:
            ...
            network (str):
                ...
                See https://google.aip.dev/124.
            state (google.cloud.network_security_v1.types.MirroringEndpointGroupAssociation.State):
...
class MirroringEndpointGroupAssociation(proto.Message):
    ...
    Attributes:
        ...
        locations_details (MutableSequence[google.cloud.network_security_v1.types.MirroringEndpointGroupAssociation.LocationDetails]):
            Output only. The list of locations where the
    ...
    class LocationDetails(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.network_security_v1.types.MirroringEndpointGroupAssociation.LocationDetails.State):
                Output only. The current state of the
...
class ListMirroringEndpointGroupAssociationsResponse(proto.Message):
    ...
    Attributes:
        mirroring_endpoint_group_associations (MutableSequence[google.cloud.network_security_v1.types.MirroringEndpointGroupAssociation]):
...
class MirroringDeploymentGroup(proto.Message):
    ...
    Attributes:
        ...
        network (str):
            ...
            https://google.aip.dev/124.
        connected_endpoint_groups (MutableSequence[google.cloud.network_security_v1.types.MirroringDeploymentGroup.ConnectedEndpointGroup]):
            Output only. The list of endpoint groups that
            are connected to this resource.
        nested_deployments (MutableSequence[google.cloud.network_security_v1.types.MirroringDeploymentGroup.Deployment]):
            Output only. The list of Mirroring
            Deployments that belong to this group.
        state (google.cloud.network_security_v1.types.MirroringDeploymentGroup.State):
            Output only. The current state of the
    ...
    class Deployment(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.network_security_v1.types.MirroringDeployment.State):
                Output only. Most recent known state of the
                deployment.
        """
...
class ListMirroringDeploymentGroupsResponse(proto.Message):
    ...
    Attributes:
        mirroring_deployment_groups (MutableSequence[google.cloud.network_security_v1.types.MirroringDeploymentGroup]):
...
class ListMirroringDeploymentsResponse(proto.Message):
    ...
    Attributes:
        mirroring_deployments (MutableSequence[google.cloud.network_security_v1.types.MirroringDeployment]):
...
class MirroringLocation(proto.Message):
    ...
    Attributes:
        location (str):
            Output only. The cloud location, e.g.
            "us-central1-a" or "asia-south1".
        state (google.cloud.network_security_v1.types.MirroringLocation.State):
            Output only. The current state of the
            association in this location.
    """

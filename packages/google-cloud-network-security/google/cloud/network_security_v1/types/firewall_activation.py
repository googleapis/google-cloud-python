...
class FirewallEndpoint(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.network_security_v1.types.FirewallEndpoint.State):
        ...
        associations (MutableSequence[google.cloud.network_security_v1.types.FirewallEndpoint.AssociationReference]):
            Output only. List of
        ...
        billing_project_id (str):
            Optional. Project to charge for the deployed
            firewall endpoint. This field must be specified
            when creating the endpoint in the organization
            scope, and should be omitted otherwise.
        endpoint_settings (google.cloud.network_security_v1.types.FirewallEndpoint.EndpointSettings):
...
class ListFirewallEndpointsResponse(proto.Message):
    ...
    Attributes:
        firewall_endpoints (MutableSequence[google.cloud.network_security_v1.types.FirewallEndpoint]):
...
class FirewallEndpointAssociation(proto.Message):
    ...
    Attributes:
        ...
        labels (MutableMapping[str, str]):
            Optional. Labels as key value pairs
        state (google.cloud.network_security_v1.types.FirewallEndpointAssociation.State):
...
class ListFirewallEndpointAssociationsResponse(proto.Message):
    ...
    Attributes:
        firewall_endpoint_associations (MutableSequence[google.cloud.network_security_v1.types.FirewallEndpointAssociation]):

...
class BackendAuthenticationConfig(proto.Message):
    ...
    Attributes:
        ...
        well_known_roots (google.cloud.network_security_v1.types.BackendAuthenticationConfig.WellKnownRoots):
...
class ListBackendAuthenticationConfigsResponse(proto.Message):
    ...
    Attributes:
        backend_authentication_configs (MutableSequence[google.cloud.network_security_v1.types.BackendAuthenticationConfig]):

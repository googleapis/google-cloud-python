...
class ThreatPreventionProfile(proto.Message):
    ...
    Attributes:
        severity_overrides (MutableSequence[google.cloud.network_security_v1.types.SeverityOverride]):
            Optional. Configuration for overriding
            threats actions by severity match.
        threat_overrides (MutableSequence[google.cloud.network_security_v1.types.ThreatOverride]):
        ...
        antivirus_overrides (MutableSequence[google.cloud.network_security_v1.types.AntivirusOverride]):
            Optional. Configuration for overriding
...
class SeverityOverride(proto.Message):
    ...
    Attributes:
        severity (google.cloud.network_security_v1.types.Severity):
            Required. Severity level to match.
        action (google.cloud.network_security_v1.types.ThreatAction):
...
class ThreatOverride(proto.Message):
    ...
    Attributes:
        threat_id (str):
            ...
            override.
        type_ (google.cloud.network_security_v1.types.ThreatType):
...
class AntivirusOverride(proto.Message):
    ...
    Attributes:
        protocol (google.cloud.network_security_v1.types.Protocol):

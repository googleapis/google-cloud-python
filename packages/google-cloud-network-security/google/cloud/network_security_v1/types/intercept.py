...
class InterceptEndpointGroup(proto.Message):
    ...
    Attributes:
        ...
        connected_deployment_group (google.cloud.network_security_v1.types.InterceptEndpointGroup.ConnectedDeploymentGroup):
            Output only. Details about the connected
            deployment group to this endpoint group.
        state (google.cloud.network_security_v1.types.InterceptEndpointGroup.State):
        ...
        associations (MutableSequence[google.cloud.network_security_v1.types.InterceptEndpointGroup.AssociationDetails]):
    ...
    class ConnectedDeploymentGroup(proto.Message):
        ...
        Attributes:
            name (str):
                ...
                ``projects/123456789/locations/global/interceptDeploymentGroups/my-dg``.
                See https://google.aip.dev/124.
            locations (MutableSequence[google.cloud.network_security_v1.types.InterceptLocation]):
    ...
    class AssociationDetails(proto.Message):
        ...
        Attributes:
            ...
            network (str):
                ...
                See https://google.aip.dev/124.
            state (google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation.State):
...
class ListInterceptEndpointGroupsResponse(proto.Message):
    ...
    Attributes:
        intercept_endpoint_groups (MutableSequence[google.cloud.network_security_v1.types.InterceptEndpointGroup]):
...
class CreateInterceptEndpointGroupRequest(proto.Message):
    ...
    Attributes:
        ...
        intercept_endpoint_group (google.cloud.network_security_v1.types.InterceptEndpointGroup):
...
class InterceptEndpointGroupAssociation(proto.Message):
    ...
    Attributes:
        ...
        network (str):
            ...
            See https://google.aip.dev/124.
        locations_details (MutableSequence[google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation.LocationDetails]):
            Output only. The list of locations where the
        ...
        network_cookie (int):
            Output only. Identifier used by the data-path. See the NSI
    ...
    class LocationDetails(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation.LocationDetails.State):
                Output only. The current state of the
    ...
    network_cookie: int = proto.Field(
        proto.UINT32,
        number=12,
    )
...
class ListInterceptEndpointGroupAssociationsResponse(proto.Message):
    ...
    Attributes:
        intercept_endpoint_group_associations (MutableSequence[google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation]):
...
class CreateInterceptEndpointGroupAssociationRequest(proto.Message):
    ...
    Attributes:
        ...
        intercept_endpoint_group_association_id (str):
            ...
            unique ID.
        intercept_endpoint_group_association (google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation):
...
class InterceptDeploymentGroup(proto.Message):
    ...
    Attributes:
        ...
        connected_endpoint_groups (MutableSequence[google.cloud.network_security_v1.types.InterceptDeploymentGroup.ConnectedEndpointGroup]):
            Output only. The list of endpoint groups that
            are connected to this resource.
        nested_deployments (MutableSequence[google.cloud.network_security_v1.types.InterceptDeploymentGroup.Deployment]):
            Output only. The list of Intercept
            Deployments that belong to this group.
        state (google.cloud.network_security_v1.types.InterceptDeploymentGroup.State):
            Output only. The current state of the
    ...
    class Deployment(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.network_security_v1.types.InterceptDeployment.State):
                Output only. Most recent known state of the
                deployment.
        """
...
class ListInterceptDeploymentGroupsResponse(proto.Message):
    ...
    Attributes:
        intercept_deployment_groups (MutableSequence[google.cloud.network_security_v1.types.InterceptDeploymentGroup]):
...
class CreateInterceptDeploymentGroupRequest(proto.Message):
    ...
    Attributes:
        ...
        intercept_deployment_group_id (str):
            ...
            name.
        intercept_deployment_group (google.cloud.network_security_v1.types.InterceptDeploymentGroup):
...
class ListInterceptDeploymentsResponse(proto.Message):
    ...
    Attributes:
        intercept_deployments (MutableSequence[google.cloud.network_security_v1.types.InterceptDeployment]):
...
class CreateInterceptDeploymentRequest(proto.Message):
    ...
    Attributes:
        ...
        intercept_deployment (google.cloud.network_security_v1.types.InterceptDeployment):
...
class InterceptLocation(proto.Message):
    ...
    Attributes:
        location (str):
            Output only. The cloud location, e.g.
            "us-central1-a" or "asia-south1".
        state (google.cloud.network_security_v1.types.InterceptLocation.State):
            Output only. The current state of the
            association in this location.
    """

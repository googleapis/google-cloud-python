...
class TlsInspectionPolicy(proto.Message):
    ...
    Attributes:
        ...
        min_tls_version (google.cloud.network_security_v1.types.TlsInspectionPolicy.TlsVersion):
            ...
            this field.
        tls_feature_profile (google.cloud.network_security_v1.types.TlsInspectionPolicy.Profile):
...
class CreateTlsInspectionPolicyRequest(proto.Message):
    ...
    Attributes:
        ...
        tls_inspection_policy (google.cloud.network_security_v1.types.TlsInspectionPolicy):
...
class ListTlsInspectionPoliciesResponse(proto.Message):
    ...
    Attributes:
        tls_inspection_policies (MutableSequence[google.cloud.network_security_v1.types.TlsInspectionPolicy]):

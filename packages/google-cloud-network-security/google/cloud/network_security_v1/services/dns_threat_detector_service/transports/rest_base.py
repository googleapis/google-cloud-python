...
class _BaseDnsThreatDetectorServiceRestTransport(DnsThreatDetectorServiceTransport):
    """Base REST backend transport for DnsThreatDetectorService.
    ...
    class _BaseCreateDnsThreatDetector:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/dnsThreatDetectors",
    ...
    class _BaseDeleteDnsThreatDetector:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/dnsThreatDetectors/*}",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = dns_threat_detector.DeleteDnsThreatDetectorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseGetDnsThreatDetector:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = dns_threat_detector.GetDnsThreatDetectorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListDnsThreatDetectors:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = dns_threat_detector.ListDnsThreatDetectorsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseUpdateDnsThreatDetector:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{dns_threat_detector.name=projects/*/locations/*/dnsThreatDetectors/*}",
                    "body": "dns_threat_detector",
                },
            ]
            return http_options
...
__all__ = ("_BaseDnsThreatDetectorServiceRestTransport",)

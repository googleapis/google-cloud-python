...
from .transports.base import DEFAULT_CLIENT_INFO, AddressGroupServiceTransport
...
class AddressGroupServiceAsyncClient:
    ...
    _client: AddressGroupServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = AddressGroupServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = AddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = AddressGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AddressGroupServiceAsyncClient: The constructed client.
        """
        return AddressGroupServiceClient.from_service_account_info.__func__(AddressGroupServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AddressGroupServiceAsyncClient: The constructed client.
        """
        return AddressGroupServiceClient.from_service_account_file.__func__(AddressGroupServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return AddressGroupServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> AddressGroupServiceTransport:
        ...
        Returns:
            AddressGroupServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = AddressGroupServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = AddressGroupServiceClient(
    ...
    async def __aenter__(self) -> "AddressGroupServiceAsyncClient":
        return self

...
class AddressGroupServiceGrpcAsyncIOTransport(AddressGroupServiceTransport):
    """gRPC AsyncIO backend transport for AddressGroupService.
...
__all__ = ("AddressGroupServiceGrpcAsyncIOTransport",)

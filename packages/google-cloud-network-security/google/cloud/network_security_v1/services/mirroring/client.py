...
from .transports.grpc import MirroringGrpcTransport
from .transports.grpc_asyncio import MirroringGrpcAsyncIOTransport
from .transports.rest import MirroringRestTransport


class MirroringClientMeta(type):
    """Metaclass for the Mirroring client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[MirroringTransport]]
    _transport_registry["grpc"] = MirroringGrpcTransport
    _transport_registry["grpc_asyncio"] = MirroringGrpcAsyncIOTransport
    _transport_registry["rest"] = MirroringRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[MirroringTransport]:
...
class MirroringClient(metaclass=MirroringClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MirroringClient: The constructed client.
        """
    ...
    def transport(self) -> MirroringTransport:
        ...
        Returns:
            MirroringTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def mirroring_deployment_path(
        project: str,
        location: str,
        mirroring_deployment: str,
    ) -> str:
        """Returns a fully-qualified mirroring_deployment string."""
        return "projects/{project}/locations/{location}/mirroringDeployments/{mirroring_deployment}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_mirroring_deployment_path(path: str) -> Dict[str, str]:
        """Parses a mirroring_deployment path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringDeployments/(?P<mirroring_deployment>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def mirroring_deployment_group_path(
        project: str,
        location: str,
        mirroring_deployment_group: str,
    ) -> str:
        """Returns a fully-qualified mirroring_deployment_group string."""
        return "projects/{project}/locations/{location}/mirroringDeploymentGroups/{mirroring_deployment_group}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_mirroring_deployment_group_path(path: str) -> Dict[str, str]:
        """Parses a mirroring_deployment_group path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringDeploymentGroups/(?P<mirroring_deployment_group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def mirroring_endpoint_group_association_path(
        project: str,
        location: str,
        mirroring_endpoint_group_association: str,
    ) -> str:
        """Returns a fully-qualified mirroring_endpoint_group_association string."""
        return "projects/{project}/locations/{location}/mirroringEndpointGroupAssociations/{mirroring_endpoint_group_association}".format(
            project=project,
            location=location,
            mirroring_endpoint_group_association=mirroring_endpoint_group_association,
        )

    @staticmethod
    def parse_mirroring_endpoint_group_association_path(path: str) -> Dict[str, str]:
        """Parses a mirroring_endpoint_group_association path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringEndpointGroupAssociations/(?P<mirroring_endpoint_group_association>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = MirroringClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = MirroringClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MirroringClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = MirroringClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            MirroringClient._read_environment_variables()
        )
        self._client_cert_source = MirroringClient._get_client_cert_source(
        ...
        transport_provided = isinstance(transport, MirroringTransport)
        if transport_provided:
            # transport is a MirroringTransport instance.
            ...
            self._transport = cast(MirroringTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or MirroringClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[MirroringTransport], Callable[..., MirroringTransport]
            ] = (
                MirroringClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., MirroringTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.networksecurity_v1.MirroringClient`.",
                    extra={
    ...
    def list_mirroring_endpoint_groups(
        ...
        *,
    ...
    ) -> pagers.ListMirroringEndpointGroupsPager:
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.ListMirroringEndpointGroupsRequest, dict]):
        ...
        Returns:
            google.cloud.network_security_v1.services.mirroring.pagers.ListMirroringEndpointGroupsPager:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_mirroring_endpoint_groups
        ]
        ...
        response = pagers.ListMirroringEndpointGroupsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.GetMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_mirroring_endpoint_group
        ]
    ...
    def create_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.CreateMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mirroring_endpoint_group (google.cloud.network_security_v1.types.MirroringEndpointGroup):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_mirroring_endpoint_group
        ]
    ...
    def update_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.UpdateMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_mirroring_endpoint_group
        ]
    ...
    def delete_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.DeleteMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_mirroring_endpoint_group
        ]
    ...
    def list_mirroring_endpoint_group_associations(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListMirroringEndpointGroupAssociationsPager:
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.ListMirroringEndpointGroupAssociationsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.services.mirroring.pagers.ListMirroringEndpointGroupAssociationsPager:
                Response message for
                ListMirroringEndpointGroupAssociations.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_mirroring_endpoint_group_associations
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListMirroringEndpointGroupAssociationsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_mirroring_endpoint_group_association(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_mirroring_endpoint_group_association():
                # Create a client
                client = network_security_v1.MirroringClient()
                ...
                # Make the request
                response = client.get_mirroring_endpoint_group_association(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.network_security_v1.types.GetMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_mirroring_endpoint_group_association
        ]
    ...
    def create_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.CreateMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mirroring_endpoint_group_association (google.cloud.network_security_v1.types.MirroringEndpointGroupAssociation):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_mirroring_endpoint_group_association
        ]
    ...
    def update_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.UpdateMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_mirroring_endpoint_group_association
        ]
    ...
    def delete_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.DeleteMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_mirroring_endpoint_group_association
        ]
    ...
    def list_mirroring_deployment_groups(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListMirroringDeploymentGroupsPager:
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.ListMirroringDeploymentGroupsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.services.mirroring.pagers.ListMirroringDeploymentGroupsPager:
                Response message for
                ListMirroringDeploymentGroups.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_mirroring_deployment_groups
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListMirroringDeploymentGroupsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.GetMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_mirroring_deployment_group
        ]
    ...
    def create_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.CreateMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mirroring_deployment_group (google.cloud.network_security_v1.types.MirroringDeploymentGroup):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_mirroring_deployment_group
        ]
    ...
    def update_mirroring_deployment_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_mirroring_deployment_group():
                # Create a client
                client = network_security_v1.MirroringClient()
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.UpdateMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_mirroring_deployment_group
        ]
    ...
    def delete_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.DeleteMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_mirroring_deployment_group
        ]
    ...
    def list_mirroring_deployments(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListMirroringDeploymentsPager:
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.ListMirroringDeploymentsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.services.mirroring.pagers.ListMirroringDeploymentsPager:
                Response message for
                ListMirroringDeployments.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_mirroring_deployments
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListMirroringDeploymentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.GetMirroringDeploymentRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_mirroring_deployment]
    ...
    def create_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.CreateMirroringDeploymentRequest, dict]):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mirroring_deployment (google.cloud.network_security_v1.types.MirroringDeployment):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_mirroring_deployment
        ]
    ...
    def update_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.UpdateMirroringDeploymentRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_mirroring_deployment
        ]
    ...
    def delete_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.DeleteMirroringDeploymentRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_mirroring_deployment
        ]
    ...
    def __enter__(self) -> "MirroringClient":
        return self

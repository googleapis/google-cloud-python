...
class OrganizationSecurityProfileGroupServiceGrpcAsyncIOTransport(
    ...
    def list_security_profile_groups(
        ...
        Lists SecurityProfileGroups in a given organization
        and location.
    ...
    def get_security_profile_group(
        ...
        Returns:
            Callable[[~.GetSecurityProfileGroupRequest],
                    Awaitable[~.SecurityProfileGroup]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_security_profiles(
        ...
        Returns:
            Callable[[~.ListSecurityProfilesRequest],
                    Awaitable[~.ListSecurityProfilesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_security_profile_groups: self._wrap_method(
                self.list_security_profile_groups,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_security_profile_group: self._wrap_method(
                self.get_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_security_profile_group: self._wrap_method(
                self.create_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_security_profile_group: self._wrap_method(
                self.update_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_security_profile_group: self._wrap_method(
                self.delete_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_security_profiles: self._wrap_method(
                self.list_security_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_security_profile: self._wrap_method(
                self.get_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_security_profile: self._wrap_method(
                self.create_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_security_profile: self._wrap_method(
                self.update_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_security_profile: self._wrap_method(
...
__all__ = ("OrganizationSecurityProfileGroupServiceGrpcAsyncIOTransport",)

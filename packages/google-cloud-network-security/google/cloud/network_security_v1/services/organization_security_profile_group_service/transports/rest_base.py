    ...
    class _BaseCreateSecurityProfile:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=organizations/*/locations/*}/securityProfiles",
    ...
    class _BaseCreateSecurityProfileGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=organizations/*/locations/*}/securityProfileGroups",
    ...
    class _BaseDeleteSecurityProfile:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=organizations/*/locations/*/securityProfiles/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteSecurityProfileGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=organizations/*/locations/*/securityProfileGroups/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateSecurityProfile:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{security_profile.name=organizations/*/locations/*/securityProfiles/*}",
                    "body": "security_profile",
                },
            ]
            return http_options
    ...
    class _BaseUpdateSecurityProfileGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{security_profile_group.name=organizations/*/locations/*/securityProfileGroups/*}",
                    "body": "security_profile_group",
                },
            ]
            return http_options

...
class OrganizationSecurityProfileGroupServiceAsyncClient:
    """Organization SecurityProfileGroup is created under
    organization.
    """

    _client: OrganizationSecurityProfileGroupServiceClient
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OrganizationSecurityProfileGroupServiceAsyncClient: The constructed client.
        """
        sa_info_func = (
            OrganizationSecurityProfileGroupServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
            OrganizationSecurityProfileGroupServiceAsyncClient, info, *args, **kwargs
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            OrganizationSecurityProfileGroupServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return OrganizationSecurityProfileGroupServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    def transport(self) -> OrganizationSecurityProfileGroupServiceTransport:
        ...
        Returns:
            OrganizationSecurityProfileGroupServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = OrganizationSecurityProfileGroupServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.networksecurity_v1.OrganizationSecurityProfileGroupServiceAsyncClient`.",
                extra={
    ...
    async def list_security_profile_groups(
        ...
        *,
        ...
        Returns:
            google.cloud.network_security_v1.services.organization_security_profile_group_service.pagers.ListSecurityProfileGroupsAsyncPager:
    ...
    async def list_security_profiles(
        ...
        *,
        ...
        Returns:
            google.cloud.network_security_v1.services.organization_security_profile_group_service.pagers.ListSecurityProfilesAsyncPager:
                Response returned by the
                ListSecurityProfiles method.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def __aenter__(self) -> "OrganizationSecurityProfileGroupServiceAsyncClient":
        return self
...
__all__ = ("OrganizationSecurityProfileGroupServiceAsyncClient",)

...
from google.cloud.network_security_v1.services.organization_security_profile_group_service import (
    pagers,
)
...
from .transports.grpc import OrganizationSecurityProfileGroupServiceGrpcTransport
from .transports.grpc_asyncio import (
    OrganizationSecurityProfileGroupServiceGrpcAsyncIOTransport,
)
from .transports.rest import OrganizationSecurityProfileGroupServiceRestTransport


class OrganizationSecurityProfileGroupServiceClientMeta(type):
    """Metaclass for the OrganizationSecurityProfileGroupService client.
    ...
    ) -> Type[OrganizationSecurityProfileGroupServiceTransport]:
...
class OrganizationSecurityProfileGroupServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OrganizationSecurityProfileGroupServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> OrganizationSecurityProfileGroupServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            OrganizationSecurityProfileGroupServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def mirroring_endpoint_group_path(
        project: str,
        location: str,
        mirroring_endpoint_group: str,
    ) -> str:
        """Returns a fully-qualified mirroring_endpoint_group string."""
        return "projects/{project}/locations/{location}/mirroringEndpointGroups/{mirroring_endpoint_group}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_mirroring_endpoint_group_path(path: str) -> Dict[str, str]:
        """Parses a mirroring_endpoint_group path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringEndpointGroups/(?P<mirroring_endpoint_group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def security_profile_path(
        organization: str,
        location: str,
        security_profile: str,
    ) -> str:
        """Returns a fully-qualified security_profile string."""
        return "organizations/{organization}/locations/{location}/securityProfiles/{security_profile}".format(
    ...
    @staticmethod
    def parse_security_profile_path(path: str) -> Dict[str, str]:
        """Parses a security_profile path into its component segments."""
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/securityProfiles/(?P<security_profile>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def security_profile_group_path(
        organization: str,
        location: str,
        security_profile_group: str,
    ) -> str:
        """Returns a fully-qualified security_profile_group string."""
        return "organizations/{organization}/locations/{location}/securityProfileGroups/{security_profile_group}".format(
            organization=organization,
            location=location,
    ...
    @staticmethod
    def parse_security_profile_group_path(path: str) -> Dict[str, str]:
        """Parses a security_profile_group path into its component segments."""
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/securityProfileGroups/(?P<security_profile_group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = OrganizationSecurityProfileGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,OrganizationSecurityProfileGroupServiceTransport,Callable[..., OrganizationSecurityProfileGroupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the OrganizationSecurityProfileGroupServiceTransport constructor.
        ...
        transport_provided = isinstance(
            transport, OrganizationSecurityProfileGroupServiceTransport
        )
        if transport_provided:
            # transport is a OrganizationSecurityProfileGroupServiceTransport instance.
        ...
        self._api_endpoint = (
            self._api_endpoint
            or OrganizationSecurityProfileGroupServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.networksecurity_v1.OrganizationSecurityProfileGroupServiceClient`.",
                    extra={
    ...
    def list_security_profile_groups(
        ...
        *,
    ...
    ) -> pagers.ListSecurityProfileGroupsPager:
        r"""Lists SecurityProfileGroups in a given organization
        and location.
        ...
        .. code-block:: python
            ...
            def sample_list_security_profile_groups():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.ListSecurityProfileGroupsRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_security_profile_groups(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.ListSecurityProfileGroupsRequest, dict]):
            ...
            parent (str):
                ...
                which the SecurityProfileGroups should be listed,
        ...
        Returns:
            google.cloud.network_security_v1.services.organization_security_profile_group_service.pagers.ListSecurityProfileGroupsPager:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_security_profile_groups
        ]
        ...
        response = pagers.ListSecurityProfileGroupsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_security_profile_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_security_profile_group():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.GetSecurityProfileGroupRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_security_profile_group(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.network_security_v1.types.GetSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
                GetSecurityProfileGroup method.
            name (str):
                Required. A name of the SecurityProfileGroup to get.
        ...
        Returns:
            google.cloud.network_security_v1.types.SecurityProfileGroup:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_security_profile_group
        ]
    ...
    def create_security_profile_group(
        ...
        *,
        ...
        r"""Creates a new SecurityProfileGroup in a given
        ...
        .. code-block:: python
            ...
            def sample_create_security_profile_group():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.CreateSecurityProfileGroupRequest(
                    parent="parent_value",
                    security_profile_group_id="security_profile_group_id_value",
                )

                # Make the request
                operation = client.create_security_profile_group(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.CreateSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
            ...
            security_profile_group (google.cloud.network_security_v1.types.SecurityProfileGroup):
                Required. SecurityProfileGroup
                resource to be created.

                This corresponds to the ``security_profile_group`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.SecurityProfileGroup` SecurityProfileGroup is a resource that defines the behavior for various
                   ProfileTypes.
        ...
        if not isinstance(
            ...
            if security_profile_group is not None:
                request.security_profile_group = security_profile_group
            if security_profile_group_id is not None:
                request.security_profile_group_id = security_profile_group_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_security_profile_group
        ]
    ...
    def update_security_profile_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_security_profile_group():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.UpdateSecurityProfileGroupRequest(
                )

                # Make the request
                operation = client.update_security_profile_group(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.UpdateSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
                UpdateSecurityProfileGroup method.
            security_profile_group (google.cloud.network_security_v1.types.SecurityProfileGroup):
                Required. Updated
                SecurityProfileGroup resource.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_security_profile_group
        ]
    ...
    def delete_security_profile_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_security_profile_group():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.DeleteSecurityProfileGroupRequest(
                    name="name_value",
                )

                # Make the request
                operation = client.delete_security_profile_group(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.DeleteSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
                DeleteSecurityProfileGroup method.
            name (str):
                Required. A name of the SecurityProfileGroup to delete.
                Must be in the format
                ``projects|organizations/*/locations/{location}/securityProfileGroups/{security_profile_group}``.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_security_profile_group
        ]
    ...
    def list_security_profiles(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListSecurityProfilesPager:
        r"""Lists SecurityProfiles in a given organization and
        location.
        ...
        .. code-block:: python
            ...
            def sample_list_security_profiles():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.ListSecurityProfilesRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_security_profiles(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.ListSecurityProfilesRequest, dict]):
                The request object. Request used with the
                ListSecurityProfiles method.
            parent (str):
                Required. The project or organization and location from
                which the SecurityProfiles should be listed, specified
                in the format
                ``projects|organizations/*/locations/{location}``.
        ...
        Returns:
            google.cloud.network_security_v1.services.organization_security_profile_group_service.pagers.ListSecurityProfilesPager:
                Response returned by the
                ListSecurityProfiles method.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_security_profiles]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListSecurityProfilesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_security_profile(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_security_profile():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.GetSecurityProfileRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_security_profile(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.network_security_v1.types.GetSecurityProfileRequest, dict]):
                The request object. Request used by the
                GetSecurityProfile method.
            name (str):
                Required. A name of the SecurityProfile to get. Must be
                in the format
        ...
        Returns:
            google.cloud.network_security_v1.types.SecurityProfile:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_security_profile]
    ...
    def create_security_profile(
        ...
        *,
        ...
        r"""Creates a new SecurityProfile in a given organization
        and location.
        ...
        .. code-block:: python
            ...
            def sample_create_security_profile():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.CreateSecurityProfileRequest(
                    parent="parent_value",
                    security_profile_id="security_profile_id_value",
                )

                # Make the request
                operation = client.create_security_profile(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.CreateSecurityProfileRequest, dict]):
                The request object. Request used by the
                CreateSecurityProfile method.
            parent (str):
                Required. The parent resource of the SecurityProfile.
                Must be in the format
                ``projects|organizations/*/locations/{location}``.
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            security_profile (google.cloud.network_security_v1.types.SecurityProfile):
                Required. SecurityProfile resource to
                be created.

                This corresponds to the ``security_profile`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.SecurityProfile` SecurityProfile is a resource that defines the behavior for one of many
                   ProfileTypes.
        ...
        if not isinstance(
            ...
            if security_profile is not None:
                request.security_profile = security_profile
            if security_profile_id is not None:
                request.security_profile_id = security_profile_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_security_profile]
    ...
    def update_security_profile(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_security_profile():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.UpdateSecurityProfileRequest(
                )

                # Make the request
                operation = client.update_security_profile(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.UpdateSecurityProfileRequest, dict]):
                The request object. Request used by the
                UpdateSecurityProfile method.
            security_profile (google.cloud.network_security_v1.types.SecurityProfile):
                Required. Updated SecurityProfile
                resource.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_security_profile]
    ...
    def delete_security_profile(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_security_profile():
                # Create a client
                client = network_security_v1.OrganizationSecurityProfileGroupServiceClient()

                # Initialize request argument(s)
                request = network_security_v1.DeleteSecurityProfileRequest(
                    name="name_value",
                )

                # Make the request
                operation = client.delete_security_profile(request=request)
        ...
        Args:
            request (Union[google.cloud.network_security_v1.types.DeleteSecurityProfileRequest, dict]):
                The request object. Request used by the
                DeleteSecurityProfile method.
            name (str):
                Required. A name of the SecurityProfile to delete. Must
                be in the format
                ``projects|organizations/*/locations/{location}/securityProfiles/{security_profile_id}``.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_security_profile]
    ...
    def __enter__(self) -> "OrganizationSecurityProfileGroupServiceClient":
        return self
...
__all__ = ("OrganizationSecurityProfileGroupServiceClient",)

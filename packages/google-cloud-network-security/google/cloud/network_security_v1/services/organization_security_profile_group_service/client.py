...
from google.cloud.network_security_v1._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=OrganizationSecurityProfileGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

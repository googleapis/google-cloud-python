...
class FirewallActivationGrpcTransport(FirewallActivationTransport):
    """gRPC backend transport for FirewallActivation.
    ...
    def list_firewall_endpoints(
        ...
        if "list_firewall_endpoints" not in self._stubs:
            self._stubs["list_firewall_endpoints"] = self._logged_channel.unary_unary(
    ...
    def get_firewall_endpoint(
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_firewall_endpoint" not in self._stubs:
            self._stubs["get_firewall_endpoint"] = self._logged_channel.unary_unary(
    ...
    def create_firewall_endpoint(
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_firewall_endpoint" not in self._stubs:
            self._stubs["create_firewall_endpoint"] = self._logged_channel.unary_unary(
    ...
    def delete_firewall_endpoint(
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_firewall_endpoint" not in self._stubs:
            self._stubs["delete_firewall_endpoint"] = self._logged_channel.unary_unary(
    ...
    def update_firewall_endpoint(
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_firewall_endpoint" not in self._stubs:
            self._stubs["update_firewall_endpoint"] = self._logged_channel.unary_unary(
    ...
    def list_firewall_endpoint_associations(
        ...
        Returns:
            Callable[[~.ListFirewallEndpointAssociationsRequest],
    ...
    def get_firewall_endpoint_association(
        ...
        Returns:
            Callable[[~.GetFirewallEndpointAssociationRequest],
    ...
    def create_firewall_endpoint_association(
        ...
        Returns:
            Callable[[~.CreateFirewallEndpointAssociationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def delete_firewall_endpoint_association(
        ...
        Returns:
            Callable[[~.DeleteFirewallEndpointAssociationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def update_firewall_endpoint_association(
        ...
        Returns:
            Callable[[~.UpdateFirewallEndpointAssociationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
...
__all__ = ("FirewallActivationGrpcTransport",)

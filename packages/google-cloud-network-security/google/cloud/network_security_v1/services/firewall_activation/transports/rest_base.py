    ...
    class _BaseCreateFirewallEndpoint:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=organizations/*/locations/*}/firewallEndpoints",
    ...
    class _BaseCreateFirewallEndpointAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/firewallEndpointAssociations",
    ...
    class _BaseDeleteFirewallEndpoint:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=organizations/*/locations/*/firewallEndpoints/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteFirewallEndpointAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/firewallEndpointAssociations/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateFirewallEndpoint:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{firewall_endpoint.name=organizations/*/locations/*/firewallEndpoints/*}",
                    "body": "firewall_endpoint",
                },
            ]
            return http_options
    ...
    class _BaseUpdateFirewallEndpointAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{firewall_endpoint_association.name=projects/*/locations/*/firewallEndpointAssociations/*}",
                    "body": "firewall_endpoint_association",
                },
            ]
            return http_options

...
class FirewallActivationGrpcAsyncIOTransport(FirewallActivationTransport):
    """gRPC AsyncIO backend transport for FirewallActivation.
    ...
    def list_firewall_endpoints(
        ...
        Returns:
            Callable[[~.ListFirewallEndpointsRequest],
                    Awaitable[~.ListFirewallEndpointsResponse]]:
    ...
    def list_firewall_endpoint_associations(
        ...
        Returns:
            Callable[[~.ListFirewallEndpointAssociationsRequest],
                    Awaitable[~.ListFirewallEndpointAssociationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_firewall_endpoints: self._wrap_method(
                self.list_firewall_endpoints,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_project_firewall_endpoints: self._wrap_method(
                self.list_project_firewall_endpoints,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_firewall_endpoint: self._wrap_method(
                self.get_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_project_firewall_endpoint: self._wrap_method(
                self.get_project_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_firewall_endpoint: self._wrap_method(
                self.create_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_project_firewall_endpoint: self._wrap_method(
                self.create_project_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_firewall_endpoint: self._wrap_method(
                self.delete_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_project_firewall_endpoint: self._wrap_method(
                self.delete_project_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_firewall_endpoint: self._wrap_method(
                self.update_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_project_firewall_endpoint: self._wrap_method(
                self.update_project_firewall_endpoint,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_firewall_endpoint_associations: self._wrap_method(
                self.list_firewall_endpoint_associations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_firewall_endpoint_association: self._wrap_method(
                self.get_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_firewall_endpoint_association: self._wrap_method(
                self.create_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_firewall_endpoint_association: self._wrap_method(
                self.delete_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_firewall_endpoint_association: self._wrap_method(

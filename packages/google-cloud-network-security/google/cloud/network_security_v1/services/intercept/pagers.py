...
class ListInterceptEndpointGroupsPager:
    ...
    :class:`google.cloud.network_security_v1.types.ListInterceptEndpointGroupsResponse` object, and
    ...
    All the usual :class:`google.cloud.network_security_v1.types.ListInterceptEndpointGroupsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.network_security_v1.types.ListInterceptEndpointGroupsRequest):
                The initial request object.
            response (google.cloud.network_security_v1.types.ListInterceptEndpointGroupsResponse):
...
class ListInterceptEndpointGroupAssociationsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.network_security_v1.types.ListInterceptEndpointGroupAssociationsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.network_security_v1.types.ListInterceptEndpointGroupAssociationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.network_security_v1.types.ListInterceptEndpointGroupAssociationsRequest):
                The initial request object.
            response (google.cloud.network_security_v1.types.ListInterceptEndpointGroupAssociationsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListInterceptDeploymentGroupsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.network_security_v1.types.ListInterceptDeploymentGroupsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.network_security_v1.types.ListInterceptDeploymentGroupsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.network_security_v1.types.ListInterceptDeploymentGroupsRequest):
                The initial request object.
            response (google.cloud.network_security_v1.types.ListInterceptDeploymentGroupsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListInterceptDeploymentsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.network_security_v1.types.ListInterceptDeploymentsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.network_security_v1.types.ListInterceptDeploymentsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.network_security_v1.types.ListInterceptDeploymentsRequest):
                The initial request object.
            response (google.cloud.network_security_v1.types.ListInterceptDeploymentsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

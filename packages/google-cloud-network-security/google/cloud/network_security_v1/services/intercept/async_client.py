...
from google.cloud.network_security_v1.services.intercept import pagers
from google.cloud.network_security_v1.types import common, intercept
...
class InterceptAsyncClient:
    """Service for Third-Party Packet Intercept (TPPI).
    TPPI is the "in-band" flavor of the Network Security
    Integrations product.
    """

    _client: InterceptClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = InterceptClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = InterceptClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = InterceptClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            InterceptAsyncClient: The constructed client.
        """
        sa_info_func = (
            InterceptClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(InterceptAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            InterceptClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(InterceptAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return InterceptClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> InterceptTransport:
        ...
        Returns:
            InterceptTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = InterceptClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.networksecurity_v1.InterceptAsyncClient`.",
                extra={
    ...
    async def list_intercept_endpoint_groups(
        ...
        *,
    ...
    ) -> pagers.ListInterceptEndpointGroupsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.ListInterceptEndpointGroupsRequest, dict]]):
        ...
        Returns:
            google.cloud.network_security_v1.services.intercept.pagers.ListInterceptEndpointGroupsAsyncPager:
        ...
        response = pagers.ListInterceptEndpointGroupsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_intercept_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.GetInterceptEndpointGroupRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.types.InterceptEndpointGroup:
    ...
    async def create_intercept_endpoint_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_intercept_endpoint_group():
                # Create a client
                client = network_security_v1.InterceptAsyncClient()
                ...
                request = network_security_v1.CreateInterceptEndpointGroupRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.CreateInterceptEndpointGroupRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_endpoint_group (:class:`google.cloud.network_security_v1.types.InterceptEndpointGroup`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_endpoint_group_id (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.InterceptEndpointGroup` An endpoint group is a consumer frontend for a deployment group (backend).
    ...
    async def update_intercept_endpoint_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_intercept_endpoint_group():
                # Create a client
                client = network_security_v1.InterceptAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.UpdateInterceptEndpointGroupRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_intercept_endpoint_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_intercept_endpoint_group():
                # Create a client
                client = network_security_v1.InterceptAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1.DeleteInterceptEndpointGroupRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.DeleteInterceptEndpointGroupRequest, dict]]):
                The request object. Request message for
    ...
    async def list_intercept_endpoint_group_associations(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListInterceptEndpointGroupAssociationsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_intercept_endpoint_group_associations():
                ...
                # Initialize request argument(s)
                request = network_security_v1.ListInterceptEndpointGroupAssociationsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.ListInterceptEndpointGroupAssociationsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.services.intercept.pagers.ListInterceptEndpointGroupAssociationsAsyncPager:
                Response message for
                ListInterceptEndpointGroupAssociations.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListInterceptEndpointGroupAssociationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_intercept_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.GetInterceptEndpointGroupAssociationRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_intercept_endpoint_group_association():
                ...
                # Initialize request argument(s)
                intercept_endpoint_group_association = network_security_v1.InterceptEndpointGroupAssociation()
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.CreateInterceptEndpointGroupAssociationRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_endpoint_group_association (:class:`google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation`):
                Required. The association to create.
                This corresponds to the ``intercept_endpoint_group_association`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_endpoint_group_association_id (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.InterceptEndpointGroupAssociation` An endpoint group association represents a link between a network and an
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_intercept_endpoint_group_association():
                ...
                request = network_security_v1.UpdateInterceptEndpointGroupAssociationRequest(
                    intercept_endpoint_group_association=intercept_endpoint_group_association,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.UpdateInterceptEndpointGroupAssociationRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_intercept_endpoint_group_association(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_intercept_endpoint_group_association():
                # Create a client
                client = network_security_v1.InterceptAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1.DeleteInterceptEndpointGroupAssociationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.DeleteInterceptEndpointGroupAssociationRequest, dict]]):
                The request object. Request message for
    ...
    async def list_intercept_deployment_groups(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListInterceptDeploymentGroupsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.ListInterceptDeploymentGroupsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.services.intercept.pagers.ListInterceptDeploymentGroupsAsyncPager:
                Response message for
                ListInterceptDeploymentGroups.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListInterceptDeploymentGroupsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_intercept_deployment_group(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.GetInterceptDeploymentGroupRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.types.InterceptDeploymentGroup:
    ...
    async def create_intercept_deployment_group(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.CreateInterceptDeploymentGroupRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_deployment_group (:class:`google.cloud.network_security_v1.types.InterceptDeploymentGroup`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_deployment_group_id (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.InterceptDeploymentGroup` A deployment group aggregates many zonal intercept backends (deployments)
    ...
    async def update_intercept_deployment_group(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.UpdateInterceptDeploymentGroupRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_intercept_deployment_group(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.DeleteInterceptDeploymentGroupRequest, dict]]):
                The request object. Request message for
    ...
    async def list_intercept_deployments(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListInterceptDeploymentsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.ListInterceptDeploymentsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.services.intercept.pagers.ListInterceptDeploymentsAsyncPager:
                Response message for
                ListInterceptDeployments.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListInterceptDeploymentsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_intercept_deployment(
        self,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_intercept_deployment():
                # Create a client
                client = network_security_v1.InterceptAsyncClient()
                ...
                # Make the request
                response = await client.get_intercept_deployment(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.GetInterceptDeploymentRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.network_security_v1.types.InterceptDeployment:
    ...
    async def create_intercept_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.CreateInterceptDeploymentRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_deployment (:class:`google.cloud.network_security_v1.types.InterceptDeployment`):
                Required. The deployment to create.
                This corresponds to the ``intercept_deployment`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intercept_deployment_id (:class:`str`):
                Required. The ID to use for the new
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.InterceptDeployment` A deployment represents a zonal intercept backend ready to accept
    ...
    async def update_intercept_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.UpdateInterceptDeploymentRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_intercept_deployment(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_intercept_deployment():
                # Create a client
                client = network_security_v1.InterceptAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1.DeleteInterceptDeploymentRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.DeleteInterceptDeploymentRequest, dict]]):
                The request object. Request message for
    ...
    async def __aenter__(self) -> "InterceptAsyncClient":
        return self

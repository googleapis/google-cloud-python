...
from google.cloud.network_security_v1.types import intercept
    ...
    class _BaseCreateInterceptDeployment:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/interceptDeployments",
    ...
    class _BaseCreateInterceptDeploymentGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/interceptDeploymentGroups",
    ...
    class _BaseCreateInterceptEndpointGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/interceptEndpointGroups",
    ...
    class _BaseCreateInterceptEndpointGroupAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/interceptEndpointGroupAssociations",
    ...
    class _BaseDeleteInterceptDeployment:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/interceptDeployments/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteInterceptDeploymentGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/interceptDeploymentGroups/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteInterceptEndpointGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/interceptEndpointGroups/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteInterceptEndpointGroupAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/interceptEndpointGroupAssociations/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateInterceptDeployment:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{intercept_deployment.name=projects/*/locations/*/interceptDeployments/*}",
                    "body": "intercept_deployment",
                },
            ]
            return http_options
    ...
    class _BaseUpdateInterceptDeploymentGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{intercept_deployment_group.name=projects/*/locations/*/interceptDeploymentGroups/*}",
                    "body": "intercept_deployment_group",
                },
            ]
            return http_options
    ...
    class _BaseUpdateInterceptEndpointGroup:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{intercept_endpoint_group.name=projects/*/locations/*/interceptEndpointGroups/*}",
                    "body": "intercept_endpoint_group",
                },
            ]
            return http_options
    ...
    class _BaseUpdateInterceptEndpointGroupAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{intercept_endpoint_group_association.name=projects/*/locations/*/interceptEndpointGroupAssociations/*}",
                    "body": "intercept_endpoint_group_association",
                },
            ]
            return http_options

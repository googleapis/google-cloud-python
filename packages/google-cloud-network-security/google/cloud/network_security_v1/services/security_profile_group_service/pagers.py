...
class ListSecurityProfileGroupsPager:
    ...
    :class:`google.cloud.network_security_v1.types.ListSecurityProfileGroupsResponse` object, and
    ...
    All the usual :class:`google.cloud.network_security_v1.types.ListSecurityProfileGroupsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.network_security_v1.types.ListSecurityProfileGroupsRequest):
                The initial request object.
            response (google.cloud.network_security_v1.types.ListSecurityProfileGroupsResponse):
    ...
    def __iter__(self) -> Iterator[security_profile_group.SecurityProfileGroup]:
        for page in self.pages:
            yield from page.security_profile_groups

    def __repr__(self) -> str:
        return "{0}<{1!r}>".format(self.__class__.__name__, self._response)


class ListSecurityProfileGroupsAsyncPager:
    """A pager for iterating through ``list_security_profile_groups`` requests.
    ...
    def __aiter__(self) -> AsyncIterator[security_profile_group.SecurityProfileGroup]:
        async def async_generator():
            async for page in self.pages:
                for response in page.security_profile_groups:
                    yield response
...
class ListSecurityProfilesPager:
    """A pager for iterating through ``list_security_profiles`` requests.

    This class thinly wraps an initial
    :class:`google.cloud.network_security_v1.types.ListSecurityProfilesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.network_security_v1.types.ListSecurityProfilesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.network_security_v1.types.ListSecurityProfilesRequest):
                The initial request object.
            response (google.cloud.network_security_v1.types.ListSecurityProfilesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
    ...
    def __iter__(self) -> Iterator[security_profile_group.SecurityProfile]:
        for page in self.pages:
            yield from page.security_profiles

    def __repr__(self) -> str:
        return "{0}<{1!r}>".format(self.__class__.__name__, self._response)


class ListSecurityProfilesAsyncPager:
    """A pager for iterating through ``list_security_profiles`` requests.
    ...
    def __aiter__(self) -> AsyncIterator[security_profile_group.SecurityProfile]:
        async def async_generator():
            async for page in self.pages:
                for response in page.security_profiles:
                    yield response

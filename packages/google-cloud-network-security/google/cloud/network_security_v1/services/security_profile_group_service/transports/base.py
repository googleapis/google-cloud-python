...
class SecurityProfileGroupServiceTransport(abc.ABC):
    """Abstract transport class for SecurityProfileGroupService."""
...
__all__ = ("SecurityProfileGroupServiceTransport",)

...
from .base import DEFAULT_CLIENT_INFO, SecurityProfileGroupServiceTransport
...
class SecurityProfileGroupServiceGrpcTransport(SecurityProfileGroupServiceTransport):
    """gRPC backend transport for SecurityProfileGroupService.
    ...
    def list_security_profile_groups(
        ...
        Lists SecurityProfileGroups in a given project and
        location.

        Returns:
            Callable[[~.ListSecurityProfileGroupsRequest],
    ...
    def get_security_profile_group(
        ...
        Returns:
            Callable[[~.GetSecurityProfileGroupRequest],
    ...
    def create_security_profile_group(
        ...
        Creates a new SecurityProfileGroup in a given project
        and location.

        Returns:
            Callable[[~.CreateSecurityProfileGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def update_security_profile_group(
        ...
        Returns:
            Callable[[~.UpdateSecurityProfileGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def delete_security_profile_group(
        ...
        Returns:
            Callable[[~.DeleteSecurityProfileGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def list_security_profiles(
        ...
        Lists SecurityProfiles in a given project and
        location.

        Returns:
            Callable[[~.ListSecurityProfilesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_security_profiles" not in self._stubs:
            self._stubs["list_security_profiles"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1.SecurityProfileGroupService/ListSecurityProfiles",
                request_serializer=security_profile_group_service.ListSecurityProfilesRequest.serialize,
                response_deserializer=security_profile_group_service.ListSecurityProfilesResponse.deserialize,
            )
    ...
    def get_security_profile(
        ...
        Returns:
            Callable[[~.GetSecurityProfileRequest],
                    ~.SecurityProfile]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_security_profile" not in self._stubs:
            self._stubs["get_security_profile"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1.SecurityProfileGroupService/GetSecurityProfile",
                request_serializer=security_profile_group_service.GetSecurityProfileRequest.serialize,
                response_deserializer=security_profile_group.SecurityProfile.deserialize,
            )
    ...
    def create_security_profile(
        ...
        Creates a new SecurityProfile in a given project and
        location.

        Returns:
            Callable[[~.CreateSecurityProfileRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_security_profile" not in self._stubs:
            self._stubs["create_security_profile"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1.SecurityProfileGroupService/CreateSecurityProfile",
                request_serializer=security_profile_group_service.CreateSecurityProfileRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def update_security_profile(
        ...
        Returns:
            Callable[[~.UpdateSecurityProfileRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_security_profile" not in self._stubs:
            self._stubs["update_security_profile"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1.SecurityProfileGroupService/UpdateSecurityProfile",
                request_serializer=security_profile_group_service.UpdateSecurityProfileRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def delete_security_profile(
        ...
        Returns:
            Callable[[~.DeleteSecurityProfileRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_security_profile" not in self._stubs:
            self._stubs["delete_security_profile"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1.SecurityProfileGroupService/DeleteSecurityProfile",
                request_serializer=security_profile_group_service.DeleteSecurityProfileRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["delete_security_profile"]
...
__all__ = ("SecurityProfileGroupServiceGrpcTransport",)

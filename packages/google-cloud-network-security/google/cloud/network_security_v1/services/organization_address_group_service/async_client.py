...
from .client import OrganizationAddressGroupServiceClient
from .transports.base import DEFAULT_CLIENT_INFO, OrganizationAddressGroupServiceTransport
from .transports.grpc_asyncio import OrganizationAddressGroupServiceGrpcAsyncIOTransport
...
class OrganizationAddressGroupServiceAsyncClient:
    ...
    DEFAULT_ENDPOINT = OrganizationAddressGroupServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = OrganizationAddressGroupServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = OrganizationAddressGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = OrganizationAddressGroupServiceClient._DEFAULT_UNIVERSE
    ...
    common_billing_account_path = staticmethod(OrganizationAddressGroupServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(OrganizationAddressGroupServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(OrganizationAddressGroupServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(OrganizationAddressGroupServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(OrganizationAddressGroupServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(OrganizationAddressGroupServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(OrganizationAddressGroupServiceClient.common_project_path)
    parse_common_project_path = staticmethod(OrganizationAddressGroupServiceClient.parse_common_project_path)
    common_location_path = staticmethod(OrganizationAddressGroupServiceClient.common_location_path)
    parse_common_location_path = staticmethod(OrganizationAddressGroupServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OrganizationAddressGroupServiceAsyncClient: The constructed client.
        """
        return OrganizationAddressGroupServiceClient.from_service_account_info.__func__(OrganizationAddressGroupServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            OrganizationAddressGroupServiceAsyncClient: The constructed client.
        """
        return OrganizationAddressGroupServiceClient.from_service_account_file.__func__(OrganizationAddressGroupServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return OrganizationAddressGroupServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

    @property
    def transport(self) -> OrganizationAddressGroupServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            OrganizationAddressGroupServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = OrganizationAddressGroupServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, OrganizationAddressGroupServiceTransport, Callable[..., OrganizationAddressGroupServiceTransport]]
        ] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,OrganizationAddressGroupServiceTransport,Callable[..., OrganizationAddressGroupServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the OrganizationAddressGroupServiceTransport constructor.
        ...
        """
        self._client = OrganizationAddressGroupServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.networksecurity_v1.OrganizationAddressGroupServiceAsyncClient`.",
                extra={
    ...
    async def list_address_groups(
        self,
        request: Optional[Union[address_group.ListAddressGroupsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListAddressGroupsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_address_groups():
                # Create a client
                client = network_security_v1.OrganizationAddressGroupServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.ListAddressGroupsRequest, dict]]):
        ...
        if not isinstance(request, address_group.ListAddressGroupsRequest):
            request = address_group.ListAddressGroupsRequest(request)
        ...
        response = pagers.ListAddressGroupsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_address_group(
        self,
        request: Optional[Union[address_group.GetAddressGroupRequest, dict]] = None,
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.GetAddressGroupRequest, dict]]):
                The request object. Request used by the GetAddressGroup
                method.
            name (:class:`str`):
                Required. A name of the AddressGroup to get. Must be in
                the format
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, address_group.GetAddressGroupRequest):
            request = address_group.GetAddressGroupRequest(request)
    ...
    async def create_address_group(
        ...
        *,
        ...
        r"""Creates a new address group in a given project and
        location.
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.CreateAddressGroupRequest, dict]]):
                The request object. Request used by the
                CreateAddressGroup method.
            parent (:class:`str`):
                Required. The parent resource of the AddressGroup. Must
                be in the format ``projects/*/locations/{location}``.

                This corresponds to the ``parent`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            address_group (:class:`google.cloud.network_security_v1.types.AddressGroup`):
                Required. AddressGroup resource to be
                created.

                This corresponds to the ``address_group`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            address_group_id (:class:`str`):
                ...
                This corresponds to the ``address_group_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1.types.AddressGroup` AddressGroup is a resource that specifies how a collection of IP/DNS used
                   in Firewall Policy.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_address_group.CreateAddressGroupRequest):
            request = gcn_address_group.CreateAddressGroupRequest(request)
        ...
        if address_group is not None:
            request.address_group = address_group
        ...
        response = operation_async.from_gapic(
            ...
            gcn_address_group.AddressGroup,
    ...
    async def update_address_group(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.UpdateAddressGroupRequest, dict]]):
                The request object. Request used by the
                UpdateAddressGroup method.
            address_group (:class:`google.cloud.network_security_v1.types.AddressGroup`):
                Required. Updated AddressGroup
                resource.
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                overwritten in the AddressGroup resource by the update.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_address_group.UpdateAddressGroupRequest):
            request = gcn_address_group.UpdateAddressGroupRequest(request)
    ...
    async def add_address_group_items(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.AddAddressGroupItemsRequest, dict]]):
                The request object. Request used by the
                AddAddressGroupItems method.
            address_group (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            items (:class:`MutableSequence[str]`):
                Required. List of items to add.
                This corresponds to the ``items`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_address_group.AddAddressGroupItemsRequest):
            request = gcn_address_group.AddAddressGroupItemsRequest(request)
    ...
    async def remove_address_group_items(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.RemoveAddressGroupItemsRequest, dict]]):
                The request object. Request used by the
                RemoveAddressGroupItems method.
            address_group (:class:`str`):
                Required. A name of the AddressGroup to remove items
                from. Must be in the format
                ``projects|organization/*/locations/{location}/addressGroups/*``.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_address_group.RemoveAddressGroupItemsRequest):
            request = gcn_address_group.RemoveAddressGroupItemsRequest(request)
    ...
    async def clone_address_group_items(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.CloneAddressGroupItemsRequest, dict]]):
                The request object. Request used by the
                CloneAddressGroupItems method.
            address_group (:class:`str`):
                Required. A name of the AddressGroup to clone items to.
                Must be in the format
                ``projects|organization/*/locations/{location}/addressGroups/*``.
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            source_address_group (:class:`str`):
                Required. Source address group to
                clone items from.

                This corresponds to the ``source_address_group`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_address_group.CloneAddressGroupItemsRequest):
            request = gcn_address_group.CloneAddressGroupItemsRequest(request)
        ...
        if source_address_group is not None:
            request.source_address_group = source_address_group
    ...
    async def delete_address_group(
        self,
        request: Optional[Union[address_group.DeleteAddressGroupRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.DeleteAddressGroupRequest, dict]]):
                The request object. Request used by the
                DeleteAddressGroup method.
            name (:class:`str`):
                Required. A name of the AddressGroup to delete. Must be
                in the format
                ``projects/*/locations/{location}/addressGroups/*``.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, address_group.DeleteAddressGroupRequest):
            request = address_group.DeleteAddressGroupRequest(request)
    ...
    async def list_address_group_references(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListAddressGroupReferencesAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1.types.ListAddressGroupReferencesRequest, dict]]):
                The request object. Request used by the
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, gcn_address_group.ListAddressGroupReferencesRequest):
            request = gcn_address_group.ListAddressGroupReferencesRequest(request)
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListAddressGroupReferencesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def __aenter__(self) -> "OrganizationAddressGroupServiceAsyncClient":
        return self

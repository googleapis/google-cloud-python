...
class ValidationCA(proto.Message):
    ...
    Attributes:
        ...
        grpc_endpoint (google.cloud.networksecurity_v1alpha1.types.GrpcEndpoint):
            gRPC specific configuration to access the
            gRPC server to obtain the CA certificate.

            This field is a member of `oneof`_ ``type``.
        certificate_provider_instance (google.cloud.networksecurity_v1alpha1.types.CertificateProviderInstance):
...
class CertificateProvider(proto.Message):
    ...
    Attributes:
        local_filepath (google.cloud.networksecurity_v1alpha1.types.CertificateProvider.TlsCertificateFiles):

...
class InterceptClient(metaclass=InterceptClientMeta):
    ...
    def parse_intercept_deployment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/interceptDeployments/(?P<intercept_deployment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_intercept_deployment_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/interceptDeploymentGroups/(?P<intercept_deployment_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = InterceptClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, InterceptTransport, Callable[..., InterceptTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InterceptClient._read_environment_variables()
        self._client_cert_source = InterceptClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InterceptClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[InterceptTransport], Callable[..., InterceptTransport]] = (
    ...
    def list_intercept_endpoint_groups(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_intercept_endpoint_groups]
    ...
    def get_intercept_endpoint_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_intercept_endpoint_group]
    ...
    def create_intercept_endpoint_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_intercept_endpoint_group]
    ...
    def update_intercept_endpoint_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_intercept_endpoint_group]
    ...
    def delete_intercept_endpoint_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_intercept_endpoint_group]
    ...
    def list_intercept_endpoint_group_associations(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_intercept_endpoint_group_associations]
    ...
    def get_intercept_endpoint_group_association(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_intercept_endpoint_group_association]
    ...
    def create_intercept_endpoint_group_association(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_intercept_endpoint_group_association]
    ...
    def update_intercept_endpoint_group_association(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_intercept_endpoint_group_association]
    ...
    def delete_intercept_endpoint_group_association(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_intercept_endpoint_group_association]
    ...
    def list_intercept_deployment_groups(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_intercept_deployment_groups]
    ...
    def get_intercept_deployment_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_intercept_deployment_group]
    ...
    def create_intercept_deployment_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_intercept_deployment_group]
    ...
    def update_intercept_deployment_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_intercept_deployment_group]
    ...
    def delete_intercept_deployment_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_intercept_deployment_group]
    ...
    def list_intercept_deployments(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_intercept_deployments]
    ...
    def create_intercept_deployment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_intercept_deployment]
    ...
    def update_intercept_deployment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_intercept_deployment]
    ...
    def delete_intercept_deployment(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_intercept_deployment]

...
class InterceptGrpcTransport(InterceptTransport):
    """gRPC backend transport for Intercept.
    ...
    def list_intercept_endpoint_groups(
        ...
        Returns:
            Callable[[~.ListInterceptEndpointGroupsRequest],
        ...
        if "list_intercept_endpoint_groups" not in self._stubs:
            self._stubs["list_intercept_endpoint_groups"] = (
    ...
    def get_intercept_endpoint_group(
        ...
        Returns:
            Callable[[~.GetInterceptEndpointGroupRequest],
        ...
        if "get_intercept_endpoint_group" not in self._stubs:
            self._stubs["get_intercept_endpoint_group"] = (
                self._logged_channel.unary_unary(
    ...
    def create_intercept_endpoint_group(
        ...
        Returns:
            Callable[[~.CreateInterceptEndpointGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "create_intercept_endpoint_group" not in self._stubs:
            self._stubs["create_intercept_endpoint_group"] = (
                self._logged_channel.unary_unary(
    ...
    def update_intercept_endpoint_group(
        ...
        Returns:
            Callable[[~.UpdateInterceptEndpointGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "update_intercept_endpoint_group" not in self._stubs:
            self._stubs["update_intercept_endpoint_group"] = (
                self._logged_channel.unary_unary(
    ...
    def delete_intercept_endpoint_group(
        ...
        Returns:
            Callable[[~.DeleteInterceptEndpointGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "delete_intercept_endpoint_group" not in self._stubs:
            self._stubs["delete_intercept_endpoint_group"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["delete_intercept_endpoint_group"]
    ...
    def list_intercept_endpoint_group_associations(
        ...
        Returns:
            Callable[[~.ListInterceptEndpointGroupAssociationsRequest],
        ...
        if "list_intercept_endpoint_group_associations" not in self._stubs:
            self._stubs["list_intercept_endpoint_group_associations"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["list_intercept_endpoint_group_associations"]
    ...
    def get_intercept_endpoint_group_association(
        ...
        Returns:
            Callable[[~.GetInterceptEndpointGroupAssociationRequest],
        ...
        if "get_intercept_endpoint_group_association" not in self._stubs:
            self._stubs["get_intercept_endpoint_group_association"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["get_intercept_endpoint_group_association"]
    ...
    def create_intercept_endpoint_group_association(
        ...
        Returns:
            Callable[[~.CreateInterceptEndpointGroupAssociationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "create_intercept_endpoint_group_association" not in self._stubs:
            self._stubs["create_intercept_endpoint_group_association"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["create_intercept_endpoint_group_association"]
    ...
    def update_intercept_endpoint_group_association(
        ...
        Returns:
            Callable[[~.UpdateInterceptEndpointGroupAssociationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "update_intercept_endpoint_group_association" not in self._stubs:
            self._stubs["update_intercept_endpoint_group_association"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["update_intercept_endpoint_group_association"]
    ...
    def delete_intercept_endpoint_group_association(
        ...
        Returns:
            Callable[[~.DeleteInterceptEndpointGroupAssociationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "delete_intercept_endpoint_group_association" not in self._stubs:
            self._stubs["delete_intercept_endpoint_group_association"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["delete_intercept_endpoint_group_association"]
    ...
    def list_intercept_deployment_groups(
        ...
        Returns:
            Callable[[~.ListInterceptDeploymentGroupsRequest],
        ...
        if "list_intercept_deployment_groups" not in self._stubs:
            self._stubs["list_intercept_deployment_groups"] = (
                self._logged_channel.unary_unary(
    ...
    def get_intercept_deployment_group(
        ...
        Returns:
            Callable[[~.GetInterceptDeploymentGroupRequest],
        ...
        if "get_intercept_deployment_group" not in self._stubs:
            self._stubs["get_intercept_deployment_group"] = (
                self._logged_channel.unary_unary(
    ...
    def create_intercept_deployment_group(
        ...
        Returns:
            Callable[[~.CreateInterceptDeploymentGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "create_intercept_deployment_group" not in self._stubs:
            self._stubs["create_intercept_deployment_group"] = (
                self._logged_channel.unary_unary(
    ...
    def update_intercept_deployment_group(
        ...
        Returns:
            Callable[[~.UpdateInterceptDeploymentGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "update_intercept_deployment_group" not in self._stubs:
            self._stubs["update_intercept_deployment_group"] = (
                self._logged_channel.unary_unary(
    ...
    def delete_intercept_deployment_group(
        ...
        Returns:
            Callable[[~.DeleteInterceptDeploymentGroupRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "delete_intercept_deployment_group" not in self._stubs:
            self._stubs["delete_intercept_deployment_group"] = (
                self._logged_channel.unary_unary(
    ...
    def list_intercept_deployments(
        ...
        if "list_intercept_deployments" not in self._stubs:
            self._stubs["list_intercept_deployments"] = (
                self._logged_channel.unary_unary(
    ...
    def get_intercept_deployment(
        ...
        Returns:
            Callable[[~.GetInterceptDeploymentRequest],
                    ~.InterceptDeployment]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_intercept_deployment" not in self._stubs:
            self._stubs["get_intercept_deployment"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1alpha1.Intercept/GetInterceptDeployment",
                request_serializer=intercept.GetInterceptDeploymentRequest.serialize,
                response_deserializer=intercept.InterceptDeployment.deserialize,
            )
    ...
    def create_intercept_deployment(
        ...
        if "create_intercept_deployment" not in self._stubs:
            self._stubs["create_intercept_deployment"] = (
                self._logged_channel.unary_unary(
    ...
    def update_intercept_deployment(
        ...
        Returns:
            Callable[[~.UpdateInterceptDeploymentRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "update_intercept_deployment" not in self._stubs:
            self._stubs["update_intercept_deployment"] = (
                self._logged_channel.unary_unary(
    ...
    def delete_intercept_deployment(
        ...
        Returns:
            Callable[[~.DeleteInterceptDeploymentRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "delete_intercept_deployment" not in self._stubs:
            self._stubs["delete_intercept_deployment"] = (
                self._logged_channel.unary_unary(
        ...
        return self._stubs["delete_intercept_deployment"]
...
__all__ = ("InterceptGrpcTransport",)

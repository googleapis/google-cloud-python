        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.CreateDnsThreatDetector",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.create_dns_threat_detector",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "CreateDnsThreatDetector",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.DeleteDnsThreatDetector",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.GetDnsThreatDetector",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.get_dns_threat_detector",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "GetDnsThreatDetector",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.ListDnsThreatDetectors",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.list_dns_threat_detectors",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "ListDnsThreatDetectors",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.UpdateDnsThreatDetector",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.update_dns_threat_detector",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "UpdateDnsThreatDetector",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.networksecurity_v1alpha1.DnsThreatDetectorServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

    ...
    async def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService",
...
class DnsThreatDetectorServiceGrpcAsyncIOTransport(DnsThreatDetectorServiceTransport):
    """gRPC AsyncIO backend transport for DnsThreatDetectorService.
    ...
    def list_dns_threat_detectors(
        ...
        Returns:
            Callable[[~.ListDnsThreatDetectorsRequest],
                    Awaitable[~.ListDnsThreatDetectorsResponse]]:
        ...
        if "list_dns_threat_detectors" not in self._stubs:
            self._stubs["list_dns_threat_detectors"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService/ListDnsThreatDetectors",
                request_serializer=dns_threat_detector.ListDnsThreatDetectorsRequest.serialize,
                response_deserializer=dns_threat_detector.ListDnsThreatDetectorsResponse.deserialize,
            )
        return self._stubs["list_dns_threat_detectors"]
    ...
    def get_dns_threat_detector(
        ...
        Returns:
            Callable[[~.GetDnsThreatDetectorRequest],
                    Awaitable[~.DnsThreatDetector]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_dns_threat_detector" not in self._stubs:
            self._stubs["get_dns_threat_detector"] = self._logged_channel.unary_unary(
                "/google.cloud.networksecurity.v1alpha1.DnsThreatDetectorService/GetDnsThreatDetector",
                request_serializer=dns_threat_detector.GetDnsThreatDetectorRequest.serialize,
                response_deserializer=dns_threat_detector.DnsThreatDetector.deserialize,
            )
        return self._stubs["get_dns_threat_detector"]
    ...
    def create_dns_threat_detector(
        ...
        Returns:
            Callable[[~.CreateDnsThreatDetectorRequest],
                    Awaitable[~.DnsThreatDetector]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def update_dns_threat_detector(
        ...
        Returns:
            Callable[[~.UpdateDnsThreatDetectorRequest],
                    Awaitable[~.DnsThreatDetector]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def delete_dns_threat_detector(
        ...
        Returns:
            Callable[[~.DeleteDnsThreatDetectorRequest],
                    Awaitable[~.Empty]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_dns_threat_detectors: self._wrap_method(
                self.list_dns_threat_detectors,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_dns_threat_detector: self._wrap_method(
                self.get_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_dns_threat_detector: self._wrap_method(
                self.create_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_dns_threat_detector: self._wrap_method(
                self.update_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_dns_threat_detector: self._wrap_method(
...
__all__ = ("DnsThreatDetectorServiceGrpcAsyncIOTransport",)

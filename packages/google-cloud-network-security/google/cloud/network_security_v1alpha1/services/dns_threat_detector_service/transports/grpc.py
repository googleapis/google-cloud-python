...
class DnsThreatDetectorServiceGrpcTransport(DnsThreatDetectorServiceTransport):
    """gRPC backend transport for DnsThreatDetectorService.
...
__all__ = ("DnsThreatDetectorServiceGrpcTransport",)

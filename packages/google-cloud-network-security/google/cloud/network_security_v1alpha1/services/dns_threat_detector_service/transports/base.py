...
from google.cloud.network_security_v1alpha1.types import dns_threat_detector as gcn_dns_threat_detector
from google.cloud.network_security_v1alpha1.types import dns_threat_detector
...
class DnsThreatDetectorServiceTransport(abc.ABC):
    """Abstract transport class for DnsThreatDetectorService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_dns_threat_detectors: gapic_v1.method.wrap_method(
                self.list_dns_threat_detectors,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_dns_threat_detector: gapic_v1.method.wrap_method(
                self.get_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_dns_threat_detector: gapic_v1.method.wrap_method(
                self.create_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_dns_threat_detector: gapic_v1.method.wrap_method(
                self.update_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_dns_threat_detector: gapic_v1.method.wrap_method(
                self.delete_dns_threat_detector,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = ("DnsThreatDetectorServiceTransport",)

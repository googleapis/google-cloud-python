...
class OrganizationSecurityProfileGroupServiceClient(metaclass=OrganizationSecurityProfileGroupServiceClientMeta):
    ...
    def parse_intercept_endpoint_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/interceptEndpointGroups/(?P<intercept_endpoint_group>.+?)$", path)
    ...
    def parse_mirroring_endpoint_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringEndpointGroups/(?P<mirroring_endpoint_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_security_profile_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/securityProfiles/(?P<security_profile>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_security_profile_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/securityProfileGroups/(?P<security_profile_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = OrganizationSecurityProfileGroupServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OrganizationSecurityProfileGroupServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = OrganizationSecurityProfileGroupServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = OrganizationSecurityProfileGroupServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = OrganizationSecurityProfileGroupServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = OrganizationSecurityProfileGroupServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, OrganizationSecurityProfileGroupServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(OrganizationSecurityProfileGroupServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or OrganizationSecurityProfileGroupServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[OrganizationSecurityProfileGroupServiceTransport], Callable[..., OrganizationSecurityProfileGroupServiceTransport]
            ] = (
                OrganizationSecurityProfileGroupServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., OrganizationSecurityProfileGroupServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networksecurity_v1alpha1.OrganizationSecurityProfileGroupServiceClient`.",
                    extra={
    ...
    def list_security_profile_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListSecurityProfileGroupsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_security_profile_groups]
    ...
    def get_security_profile_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetSecurityProfileGroupRequest, dict]):
        ...
        Returns:
            google.cloud.network_security_v1alpha1.types.SecurityProfileGroup:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_security_profile_group]
    ...
    def create_security_profile_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1alpha1.types.SecurityProfileGroup` SecurityProfileGroup is a resource that defines the behavior for various
                   ProfileTypes.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_security_profile_group]
    ...
    def update_security_profile_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_security_profile_group]
    ...
    def delete_security_profile_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteSecurityProfileGroupRequest, dict]):
                The request object. Request used by the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_security_profile_group]
    ...
    def list_security_profiles(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListSecurityProfilesRequest, dict]):
                The request object. Request used with the
    ...
    def get_security_profile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetSecurityProfileRequest, dict]):
                The request object. Request used by the
        ...
        Returns:
            google.cloud.network_security_v1alpha1.types.SecurityProfile:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_security_profile():
                ...
                # Initialize request argument(s)
                request = network_security_v1alpha1.CreateSecurityProfileRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateSecurityProfileRequest, dict]):
                The request object. Request used by the
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.network_security_v1alpha1.types.SecurityProfile` SecurityProfile is a resource that defines the behavior for one of many
                   ProfileTypes.
    ...
    def update_security_profile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateSecurityProfileRequest, dict]):
                The request object. Request used by the
    ...
    def delete_security_profile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteSecurityProfileRequest, dict]):
                The request object. Request used by the

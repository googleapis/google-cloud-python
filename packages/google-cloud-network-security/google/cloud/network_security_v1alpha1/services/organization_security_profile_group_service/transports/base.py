...
class OrganizationSecurityProfileGroupServiceTransport(abc.ABC):
    """Abstract transport class for OrganizationSecurityProfileGroupService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_security_profile_groups: gapic_v1.method.wrap_method(
                self.list_security_profile_groups,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_security_profile_group: gapic_v1.method.wrap_method(
                self.get_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_security_profile_group: gapic_v1.method.wrap_method(
                self.create_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_security_profile_group: gapic_v1.method.wrap_method(
                self.update_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_security_profile_group: gapic_v1.method.wrap_method(
                self.delete_security_profile_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_security_profiles: gapic_v1.method.wrap_method(
                self.list_security_profiles,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_security_profile: gapic_v1.method.wrap_method(
                self.get_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_security_profile: gapic_v1.method.wrap_method(
                self.create_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_security_profile: gapic_v1.method.wrap_method(
                self.update_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_security_profile: gapic_v1.method.wrap_method(
                self.delete_security_profile,
                default_timeout=None,
                client_info=client_info,
            ),

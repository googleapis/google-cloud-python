...
class MirroringClient(metaclass=MirroringClientMeta):
    ...
    def parse_forwarding_rule_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/global/forwardingRules/(?P<forwarding_rule>.+?)$", path)
    ...
    def parse_mirroring_deployment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringDeployments/(?P<mirroring_deployment>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_mirroring_deployment_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/mirroringDeploymentGroups/(?P<mirroring_deployment_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = MirroringClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, MirroringTransport, Callable[..., MirroringTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MirroringClient._read_environment_variables()
        self._client_cert_source = MirroringClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MirroringClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MirroringTransport], Callable[..., MirroringTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networksecurity_v1alpha1.MirroringClient`.",
                    extra={
    ...
    def list_mirroring_endpoint_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListMirroringEndpointGroupsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_mirroring_endpoint_groups]
    ...
    def get_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_mirroring_endpoint_group]
    ...
    def create_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_mirroring_endpoint_group]
    ...
    def update_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_mirroring_endpoint_group]
    ...
    def delete_mirroring_endpoint_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteMirroringEndpointGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_mirroring_endpoint_group]
    ...
    def list_mirroring_endpoint_group_associations(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListMirroringEndpointGroupAssociationsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_mirroring_endpoint_group_associations]
    ...
    def get_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_mirroring_endpoint_group_association]
    ...
    def create_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_mirroring_endpoint_group_association]
    ...
    def update_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_mirroring_endpoint_group_association]
    ...
    def delete_mirroring_endpoint_group_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteMirroringEndpointGroupAssociationRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_mirroring_endpoint_group_association]
    ...
    def list_mirroring_deployment_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListMirroringDeploymentGroupsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_mirroring_deployment_groups]
    ...
    def get_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_mirroring_deployment_group]
    ...
    def create_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_mirroring_deployment_group]
    ...
    def update_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_mirroring_deployment_group]
    ...
    def delete_mirroring_deployment_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteMirroringDeploymentGroupRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_mirroring_deployment_group]
    ...
    def list_mirroring_deployments(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListMirroringDeploymentsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_mirroring_deployments]
    ...
    def get_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetMirroringDeploymentRequest, dict]):
                The request object. Request message for
    ...
    def create_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateMirroringDeploymentRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_mirroring_deployment]
    ...
    def update_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateMirroringDeploymentRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_mirroring_deployment]
    ...
    def delete_mirroring_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteMirroringDeploymentRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_mirroring_deployment]

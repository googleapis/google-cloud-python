...
from .grpc import MirroringGrpcTransport
...
class MirroringGrpcAsyncIOTransport(MirroringTransport):
    """gRPC AsyncIO backend transport for Mirroring.
    ...
    def list_mirroring_endpoint_groups(
        self,
    ) -> Callable[[mirroring.ListMirroringEndpointGroupsRequest], Awaitable[mirroring.ListMirroringEndpointGroupsResponse]]:
        ...
        if "list_mirroring_endpoint_groups" not in self._stubs:
            self._stubs["list_mirroring_endpoint_groups"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_mirroring_endpoint_group(self) -> Callable[[mirroring.GetMirroringEndpointGroupRequest], Awaitable[mirroring.MirroringEndpointGroup]]:
        ...
        Returns:
            Callable[[~.GetMirroringEndpointGroupRequest],
                    Awaitable[~.MirroringEndpointGroup]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "get_mirroring_endpoint_group" not in self._stubs:
            self._stubs["get_mirroring_endpoint_group"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_mirroring_endpoint_group(self) -> Callable[[mirroring.CreateMirroringEndpointGroupRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_mirroring_endpoint_group" not in self._stubs:
            self._stubs["create_mirroring_endpoint_group"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_mirroring_endpoint_group(self) -> Callable[[mirroring.UpdateMirroringEndpointGroupRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "update_mirroring_endpoint_group" not in self._stubs:
            self._stubs["update_mirroring_endpoint_group"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_mirroring_endpoint_group(self) -> Callable[[mirroring.DeleteMirroringEndpointGroupRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_mirroring_endpoint_group" not in self._stubs:
            self._stubs["delete_mirroring_endpoint_group"] = self._logged_channel.unary_unary(
    ...
    def list_mirroring_endpoint_group_associations(
        ...
        Returns:
            Callable[[~.ListMirroringEndpointGroupAssociationsRequest],
                    Awaitable[~.ListMirroringEndpointGroupAssociationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "list_mirroring_endpoint_group_associations" not in self._stubs:
            self._stubs["list_mirroring_endpoint_group_associations"] = self._logged_channel.unary_unary(
    ...
    def get_mirroring_endpoint_group_association(
        self,
    ) -> Callable[[mirroring.GetMirroringEndpointGroupAssociationRequest], Awaitable[mirroring.MirroringEndpointGroupAssociation]]:
        ...
        Returns:
            Callable[[~.GetMirroringEndpointGroupAssociationRequest],
                    Awaitable[~.MirroringEndpointGroupAssociation]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "get_mirroring_endpoint_group_association" not in self._stubs:
            self._stubs["get_mirroring_endpoint_group_association"] = self._logged_channel.unary_unary(
    ...
    def create_mirroring_endpoint_group_association(
        self,
    ) -> Callable[[mirroring.CreateMirroringEndpointGroupAssociationRequest], Awaitable[operations_pb2.Operation]]:
        r"""Return a callable for the create mirroring endpoint
        ...
        if "create_mirroring_endpoint_group_association" not in self._stubs:
            self._stubs["create_mirroring_endpoint_group_association"] = self._logged_channel.unary_unary(
    ...
    def update_mirroring_endpoint_group_association(
        self,
    ) -> Callable[[mirroring.UpdateMirroringEndpointGroupAssociationRequest], Awaitable[operations_pb2.Operation]]:
        r"""Return a callable for the update mirroring endpoint
        group association method over gRPC.
        ...
        if "update_mirroring_endpoint_group_association" not in self._stubs:
            self._stubs["update_mirroring_endpoint_group_association"] = self._logged_channel.unary_unary(
    ...
    def delete_mirroring_endpoint_group_association(
        self,
    ) -> Callable[[mirroring.DeleteMirroringEndpointGroupAssociationRequest], Awaitable[operations_pb2.Operation]]:
        r"""Return a callable for the delete mirroring endpoint
        group association method over gRPC.
        ...
        if "delete_mirroring_endpoint_group_association" not in self._stubs:
            self._stubs["delete_mirroring_endpoint_group_association"] = self._logged_channel.unary_unary(
    ...
    def list_mirroring_deployment_groups(
        self,
    ) -> Callable[[mirroring.ListMirroringDeploymentGroupsRequest], Awaitable[mirroring.ListMirroringDeploymentGroupsResponse]]:
        ...
        Returns:
            Callable[[~.ListMirroringDeploymentGroupsRequest],
                    Awaitable[~.ListMirroringDeploymentGroupsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "list_mirroring_deployment_groups" not in self._stubs:
            self._stubs["list_mirroring_deployment_groups"] = self._logged_channel.unary_unary(
    ...
    def get_mirroring_deployment_group(
        self,
    ) -> Callable[[mirroring.GetMirroringDeploymentGroupRequest], Awaitable[mirroring.MirroringDeploymentGroup]]:
        ...
        Returns:
            Callable[[~.GetMirroringDeploymentGroupRequest],
                    Awaitable[~.MirroringDeploymentGroup]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "get_mirroring_deployment_group" not in self._stubs:
            self._stubs["get_mirroring_deployment_group"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_mirroring_deployment_group(self) -> Callable[[mirroring.CreateMirroringDeploymentGroupRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_mirroring_deployment_group" not in self._stubs:
            self._stubs["create_mirroring_deployment_group"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_mirroring_deployment_group(self) -> Callable[[mirroring.UpdateMirroringDeploymentGroupRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "update_mirroring_deployment_group" not in self._stubs:
            self._stubs["update_mirroring_deployment_group"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_mirroring_deployment_group(self) -> Callable[[mirroring.DeleteMirroringDeploymentGroupRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_mirroring_deployment_group" not in self._stubs:
            self._stubs["delete_mirroring_deployment_group"] = self._logged_channel.unary_unary(
    ...
    def list_mirroring_deployments(
        self,
    ) -> Callable[[mirroring.ListMirroringDeploymentsRequest], Awaitable[mirroring.ListMirroringDeploymentsResponse]]:
        ...
        if "list_mirroring_deployments" not in self._stubs:
            self._stubs["list_mirroring_deployments"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_mirroring_deployment(self) -> Callable[[mirroring.GetMirroringDeploymentRequest], Awaitable[mirroring.MirroringDeployment]]:
    ...
    @property
    def create_mirroring_deployment(self) -> Callable[[mirroring.CreateMirroringDeploymentRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_mirroring_deployment" not in self._stubs:
            self._stubs["create_mirroring_deployment"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_mirroring_deployment(self) -> Callable[[mirroring.UpdateMirroringDeploymentRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "update_mirroring_deployment" not in self._stubs:
            self._stubs["update_mirroring_deployment"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_mirroring_deployment(self) -> Callable[[mirroring.DeleteMirroringDeploymentRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_mirroring_deployment" not in self._stubs:
            self._stubs["delete_mirroring_deployment"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_mirroring_endpoint_groups: self._wrap_method(
                self.list_mirroring_endpoint_groups,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_mirroring_endpoint_group: self._wrap_method(
                self.get_mirroring_endpoint_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_mirroring_endpoint_group: self._wrap_method(
                self.create_mirroring_endpoint_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_mirroring_endpoint_group: self._wrap_method(
                self.update_mirroring_endpoint_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_mirroring_endpoint_group: self._wrap_method(
                self.delete_mirroring_endpoint_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_mirroring_endpoint_group_associations: self._wrap_method(
                self.list_mirroring_endpoint_group_associations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_mirroring_endpoint_group_association: self._wrap_method(
                self.get_mirroring_endpoint_group_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_mirroring_endpoint_group_association: self._wrap_method(
                self.create_mirroring_endpoint_group_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_mirroring_endpoint_group_association: self._wrap_method(
                self.update_mirroring_endpoint_group_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_mirroring_endpoint_group_association: self._wrap_method(
                self.delete_mirroring_endpoint_group_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_mirroring_deployment_groups: self._wrap_method(
                self.list_mirroring_deployment_groups,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_mirroring_deployment_group: self._wrap_method(
                self.get_mirroring_deployment_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_mirroring_deployment_group: self._wrap_method(
                self.create_mirroring_deployment_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_mirroring_deployment_group: self._wrap_method(
                self.update_mirroring_deployment_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_mirroring_deployment_group: self._wrap_method(
                self.delete_mirroring_deployment_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_mirroring_deployments: self._wrap_method(
                self.list_mirroring_deployments,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_mirroring_deployment: self._wrap_method(
                self.get_mirroring_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_mirroring_deployment: self._wrap_method(
                self.create_mirroring_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_mirroring_deployment: self._wrap_method(
                self.update_mirroring_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_mirroring_deployment: self._wrap_method(

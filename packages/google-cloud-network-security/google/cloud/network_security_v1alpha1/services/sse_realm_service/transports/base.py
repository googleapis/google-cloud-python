...
class SSERealmServiceTransport(abc.ABC):
    """Abstract transport class for SSERealmService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_sac_realms: gapic_v1.method.wrap_method(
                self.list_sac_realms,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_sac_realm: gapic_v1.method.wrap_method(
                self.get_sac_realm,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_sac_realm: gapic_v1.method.wrap_method(
                self.create_sac_realm,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_sac_realm: gapic_v1.method.wrap_method(
                self.delete_sac_realm,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_sac_attachments: gapic_v1.method.wrap_method(
                self.list_sac_attachments,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_sac_attachment: gapic_v1.method.wrap_method(
                self.get_sac_attachment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_sac_attachment: gapic_v1.method.wrap_method(
                self.create_sac_attachment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_sac_attachment: gapic_v1.method.wrap_method(
                self.delete_sac_attachment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_partner_sse_realms: gapic_v1.method.wrap_method(
                self.list_partner_sse_realms,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_partner_sse_realm: gapic_v1.method.wrap_method(
                self.get_partner_sse_realm,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_partner_sse_realm: gapic_v1.method.wrap_method(
                self.create_partner_sse_realm,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_partner_sse_realm: gapic_v1.method.wrap_method(
...
__all__ = ("SSERealmServiceTransport",)

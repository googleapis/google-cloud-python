...
class FirewallActivationTransport(abc.ABC):
    """Abstract transport class for FirewallActivation."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_firewall_endpoints: gapic_v1.method.wrap_method(
                self.list_firewall_endpoints,
            ...
            self.create_firewall_endpoint: gapic_v1.method.wrap_method(
            ...
            self.list_firewall_endpoint_associations: gapic_v1.method.wrap_method(
                self.list_firewall_endpoint_associations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_firewall_endpoint_association: gapic_v1.method.wrap_method(
                self.get_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_firewall_endpoint_association: gapic_v1.method.wrap_method(
                self.create_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_firewall_endpoint_association: gapic_v1.method.wrap_method(
                self.delete_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_firewall_endpoint_association: gapic_v1.method.wrap_method(
                self.update_firewall_endpoint_association,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = ("FirewallActivationTransport",)

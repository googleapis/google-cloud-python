...
from .base import DEFAULT_CLIENT_INFO, FirewallActivationTransport


class _BaseFirewallActivationRestTransport(FirewallActivationTransport):
    """Base REST backend transport for FirewallActivation.
    ...
    class _BaseCreateFirewallEndpoint:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha1/{parent=organizations/*/locations/*}/firewallEndpoints",
                    "body": "firewall_endpoint",
                },
                {
                    "method": "post",
                    "uri": "/v1alpha1/{parent=projects/*/locations/*}/firewallEndpoints",
                    "body": "firewall_endpoint",
                },
            ]
            return http_options
    ...
    class _BaseCreateFirewallEndpointAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha1/{parent=projects/*/locations/*}/firewallEndpointAssociations",
    ...
    class _BaseDeleteFirewallEndpoint:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1alpha1/{name=organizations/*/locations/*/firewallEndpoints/*}",
                },
                {
                    "method": "delete",
                    "uri": "/v1alpha1/{name=projects/*/locations/*/firewallEndpoints/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteFirewallEndpointAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1alpha1/{name=projects/*/locations/*/firewallEndpointAssociations/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateFirewallEndpoint:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha1/{firewall_endpoint.name=organizations/*/locations/*/firewallEndpoints/*}",
                    "body": "firewall_endpoint",
                },
                {
                    "method": "patch",
                    "uri": "/v1alpha1/{firewall_endpoint.name=projects/*/locations/*/firewallEndpoints/*}",
                    "body": "firewall_endpoint",
                },
            ]
            return http_options
    ...
    class _BaseUpdateFirewallEndpointAssociation:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha1/{firewall_endpoint_association.name=projects/*/locations/*/firewallEndpointAssociations/*}",
                    "body": "firewall_endpoint_association",
                },
            ]
            return http_options

...
class FirewallActivationClient(metaclass=FirewallActivationClientMeta):
    ...
    def parse_firewall_endpoint_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/firewallEndpoints/(?P<firewall_endpoint>.+?)$", path)
    ...
    def parse_firewall_endpoint_association_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/firewallEndpointAssociations/(?P<firewall_endpoint_association>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_tls_inspection_policy_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/tlsInspectionPolicies/(?P<tls_inspection_policy>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = FirewallActivationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FirewallActivationTransport, Callable[..., FirewallActivationTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FirewallActivationClient._read_environment_variables()
        self._client_cert_source = FirewallActivationClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FirewallActivationClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or FirewallActivationClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[FirewallActivationTransport], Callable[..., FirewallActivationTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networksecurity_v1alpha1.FirewallActivationClient`.",
                    extra={
    ...
    def list_firewall_endpoints(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListFirewallEndpointsRequest, dict]):
    ...
    def get_firewall_endpoint(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetFirewallEndpointRequest, dict]):
    ...
    def create_firewall_endpoint(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateFirewallEndpointRequest, dict]):
    ...
    def delete_firewall_endpoint(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteFirewallEndpointRequest, dict]):
    ...
    def update_firewall_endpoint(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateFirewallEndpointRequest, dict]):
    ...
    def list_firewall_endpoint_associations(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.ListFirewallEndpointAssociationsRequest, dict]):
                The request object. Message for requesting list of
                Associations
            parent (str):
                Required. Parent value for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_firewall_endpoint_associations]
    ...
    def get_firewall_endpoint_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.GetFirewallEndpointAssociationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_firewall_endpoint_association]
    ...
    def create_firewall_endpoint_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.CreateFirewallEndpointAssociationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_firewall_endpoint_association]
    ...
    def delete_firewall_endpoint_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.DeleteFirewallEndpointAssociationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_firewall_endpoint_association]
    ...
    def update_firewall_endpoint_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_security_v1alpha1.types.UpdateFirewallEndpointAssociationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_firewall_endpoint_association]

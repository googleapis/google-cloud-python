...
class FirewallActivationAsyncClient:
    """Service for managing Firewall Endpoints and Associations."""

    _client: FirewallActivationClient
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            FirewallActivationClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            FirewallActivationClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    def transport(self) -> FirewallActivationTransport:
        ...
        Returns:
            FirewallActivationTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = FirewallActivationClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = FirewallActivationClient(
        ...
        *,
    ...
    ) -> pagers.ListFirewallEndpointsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_firewall_endpoints():
                ...
                request = network_security_v1alpha1.ListFirewallEndpointsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.ListFirewallEndpointsRequest, dict]]):
        ...
        response = pagers.ListFirewallEndpointsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_firewall_endpoint():
                ...
                # Initialize request argument(s)
                request = network_security_v1alpha1.GetFirewallEndpointRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.GetFirewallEndpointRequest, dict]]):
        ...
        Returns:
            google.cloud.network_security_v1alpha1.types.FirewallEndpoint:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_firewall_endpoint():
                ...
                # Make the request
                operation = await client.create_firewall_endpoint(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.CreateFirewallEndpointRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            firewall_endpoint (:class:`google.cloud.network_security_v1alpha1.types.FirewallEndpoint`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.network_security_v1alpha1.types.FirewallEndpoint`
                Message describing Endpoint object.
    ...
    async def delete_firewall_endpoint(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.DeleteFirewallEndpointRequest, dict]]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_firewall_endpoint():
                ...
                request = network_security_v1alpha1.UpdateFirewallEndpointRequest(
                    firewall_endpoint=firewall_endpoint,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.UpdateFirewallEndpointRequest, dict]]):
    ...
    async def list_firewall_endpoint_associations(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListFirewallEndpointAssociationsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_firewall_endpoint_associations():
                ...
                # Initialize request argument(s)
                request = network_security_v1alpha1.ListFirewallEndpointAssociationsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.ListFirewallEndpointAssociationsRequest, dict]]):
                The request object. Message for requesting list of
                Associations
            parent (:class:`str`):
                Required. Parent value for
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListFirewallEndpointAssociationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_firewall_endpoint_association():
                ...
                # Initialize request argument(s)
                request = network_security_v1alpha1.GetFirewallEndpointAssociationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.GetFirewallEndpointAssociationRequest, dict]]):
        ...
        Returns:
            google.cloud.network_security_v1alpha1.types.FirewallEndpointAssociation:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_firewall_endpoint_association():
                ...
                request = network_security_v1alpha1.CreateFirewallEndpointAssociationRequest(
                    parent="parent_value",
                    firewall_endpoint_association=firewall_endpoint_association,
                )

                # Make the request
                operation = await client.create_firewall_endpoint_association(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.CreateFirewallEndpointAssociationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            firewall_endpoint_association (:class:`google.cloud.network_security_v1alpha1.types.FirewallEndpointAssociation`):
                Required. The resource being created
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.network_security_v1alpha1.types.FirewallEndpointAssociation`
                Message describing Association object
        ...
        if firewall_endpoint_association_id is not None:
            request.firewall_endpoint_association_id = firewall_endpoint_association_id
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_firewall_endpoint_association():
                ...
                # Initialize request argument(s)
                request = network_security_v1alpha1.DeleteFirewallEndpointAssociationRequest(
                    name="name_value",
                )

                # Make the request
                operation = await client.delete_firewall_endpoint_association(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.DeleteFirewallEndpointAssociationRequest, dict]]):
    ...
    async def update_firewall_endpoint_association(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.UpdateFirewallEndpointAssociationRequest, dict]]):
    ...
    async def __aenter__(self) -> "FirewallActivationAsyncClient":
        return self
...
__all__ = ("FirewallActivationAsyncClient",)

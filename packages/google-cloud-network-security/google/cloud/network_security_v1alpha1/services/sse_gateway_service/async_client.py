...
from .client import SSEGatewayServiceClient
from .transports.base import DEFAULT_CLIENT_INFO, SSEGatewayServiceTransport
...
class SSEGatewayServiceAsyncClient:
    """Service describing handlers for resources"""

    _client: SSEGatewayServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = SSEGatewayServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = SSEGatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            SSEGatewayServiceClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            SSEGatewayServiceClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return SSEGatewayServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

    @property
    def transport(self) -> SSEGatewayServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            SSEGatewayServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = SSEGatewayServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,SSEGatewayServiceTransport,Callable[..., SSEGatewayServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SSEGatewayServiceTransport constructor.
        ...
        """
        self._client = SSEGatewayServiceClient(
    ...
    async def list_partner_sse_gateways(
        ...
        *,
    ...
    ) -> pagers.ListPartnerSSEGatewaysAsyncPager:
        r"""Lists PartnerSSEGateways in a given project and
        location.
        ...
        .. code-block:: python
            ...
            async def sample_list_partner_sse_gateways():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1alpha1.ListPartnerSSEGatewaysRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_partner_sse_gateways(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.ListPartnerSSEGatewaysRequest, dict]]):
        ...
        if not isinstance(request, sse_gateway.ListPartnerSSEGatewaysRequest):
            request = sse_gateway.ListPartnerSSEGatewaysRequest(request)
        ...
        response = pagers.ListPartnerSSEGatewaysAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_partner_sse_gateway(
        self,
        request: Optional[Union[sse_gateway.GetPartnerSSEGatewayRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_partner_sse_gateway():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1alpha1.GetPartnerSSEGatewayRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.get_partner_sse_gateway(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.GetPartnerSSEGatewayRequest, dict]]):
        ...
        Returns:
            google.cloud.network_security_v1alpha1.types.PartnerSSEGateway:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sse_gateway.GetPartnerSSEGatewayRequest):
            request = sse_gateway.GetPartnerSSEGatewayRequest(request)
    ...
    async def create_partner_sse_gateway(
        ...
        *,
        ...
        partner_sse_gateway_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation_async.AsyncOperation:
        r"""Creates a new PartnerSSEGateway in a given project
        and location.
        ...
        .. code-block:: python
            ...
            async def sample_create_partner_sse_gateway():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()

                # Initialize request argument(s)
                partner_sse_gateway = network_security_v1alpha1.PartnerSSEGateway()
                partner_sse_gateway.sse_gateway_reference_id = "sse_gateway_reference_id_value"

                request = network_security_v1alpha1.CreatePartnerSSEGatewayRequest(
                    parent="parent_value",
                    partner_sse_gateway_id="partner_sse_gateway_id_value",
                    partner_sse_gateway=partner_sse_gateway,
                )

                # Make the request
                operation = await client.create_partner_sse_gateway(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.CreatePartnerSSEGatewayRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            partner_sse_gateway (:class:`google.cloud.network_security_v1alpha1.types.PartnerSSEGateway`):
                Required. The resource being created
                This corresponds to the ``partner_sse_gateway`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.network_security_v1alpha1.types.PartnerSSEGateway`
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sse_gateway.CreatePartnerSSEGatewayRequest):
            request = sse_gateway.CreatePartnerSSEGatewayRequest(request)

        # If we have keyword arguments corresponding to fields on the
        # request, apply these.
        if parent is not None:
            request.parent = parent
        if partner_sse_gateway is not None:
            request.partner_sse_gateway = partner_sse_gateway
        if partner_sse_gateway_id is not None:
            request.partner_sse_gateway_id = partner_sse_gateway_id
    ...
    async def delete_partner_sse_gateway(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_partner_sse_gateway():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1alpha1.DeletePartnerSSEGatewayRequest(
                    name="name_value",
                )

                # Make the request
                operation = await client.delete_partner_sse_gateway(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.DeletePartnerSSEGatewayRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sse_gateway.DeletePartnerSSEGatewayRequest):
            request = sse_gateway.DeletePartnerSSEGatewayRequest(request)
    ...
    async def update_partner_sse_gateway(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_partner_sse_gateway():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()
                ...
                request = network_security_v1alpha1.UpdatePartnerSSEGatewayRequest(
                    partner_sse_gateway=partner_sse_gateway,
                )

                # Make the request
                operation = await client.update_partner_sse_gateway(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.UpdatePartnerSSEGatewayRequest, dict]]):
                The request object. Message for deleting a
                PartnerSSEGateway
            partner_sse_gateway (:class:`google.cloud.network_security_v1alpha1.types.PartnerSSEGateway`):
                Required. The resource being created
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sse_gateway.UpdatePartnerSSEGatewayRequest):
            request = sse_gateway.UpdatePartnerSSEGatewayRequest(request)
    ...
    async def list_sse_gateway_references(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListSSEGatewayReferencesAsyncPager:
        r"""Lists SSEGatewayReferences in a given project and
        location.
        ...
        .. code-block:: python
            ...
            async def sample_list_sse_gateway_references():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1alpha1.ListSSEGatewayReferencesRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_sse_gateway_references(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.ListSSEGatewayReferencesRequest, dict]]):
                The request object. Message for requesting list of
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sse_gateway.ListSSEGatewayReferencesRequest):
            request = sse_gateway.ListSSEGatewayReferencesRequest(request)
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListSSEGatewayReferencesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_sse_gateway_reference(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_sse_gateway_reference():
                # Create a client
                client = network_security_v1alpha1.SSEGatewayServiceAsyncClient()

                # Initialize request argument(s)
                request = network_security_v1alpha1.GetSSEGatewayReferenceRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.get_sse_gateway_reference(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.network_security_v1alpha1.types.GetSSEGatewayReferenceRequest, dict]]):
                The request object. Message for getting a
                SSEGatewayReference
            name (:class:`str`):
                Required. Name of the resource
        ...
        Returns:
            google.cloud.network_security_v1alpha1.types.SSEGatewayReference:
                Message describing
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sse_gateway.GetSSEGatewayReferenceRequest):
            request = sse_gateway.GetSSEGatewayReferenceRequest(request)
    ...
    async def __aenter__(self) -> "SSEGatewayServiceAsyncClient":
        return self
...
__all__ = ("SSEGatewayServiceAsyncClient",)

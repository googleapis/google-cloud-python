...
class DnsThreatDetector(proto.Message):
    ...
    Attributes:
        ...
        provider (google.cloud.network_security_v1alpha1.types.DnsThreatDetector.Provider):
...
class ListDnsThreatDetectorsResponse(proto.Message):
    ...
    Attributes:
        dns_threat_detectors (MutableSequence[google.cloud.network_security_v1alpha1.types.DnsThreatDetector]):
...
class CreateDnsThreatDetectorRequest(proto.Message):
    ...
    Attributes:
        ...
        dns_threat_detector (google.cloud.network_security_v1alpha1.types.DnsThreatDetector):

...
class AuthorizationPolicy(proto.Message):
    ...
    Attributes:
        ...
        action (google.cloud.network_security_v1alpha1.types.AuthorizationPolicy.Action):
            Required. The action to take when a rule
            match is found. Possible values are "ALLOW" or
            "DENY".
        rules (MutableSequence[google.cloud.network_security_v1alpha1.types.AuthorizationPolicy.Rule]):
        ...
        class Destination(proto.Message):
            ...
            Attributes:
                ...
                methods (MutableSequence[str]):
                    ...
                    for gRPC services.
                http_header_match (google.cloud.network_security_v1alpha1.types.AuthorizationPolicy.Rule.Destination.HttpHeaderMatch):
...
class ListAuthorizationPoliciesResponse(proto.Message):
    ...
    Attributes:
        authorization_policies (MutableSequence[google.cloud.network_security_v1alpha1.types.AuthorizationPolicy]):

...
from .services.dns_threat_detector_service import DnsThreatDetectorServiceAsyncClient, DnsThreatDetectorServiceClient
...
from .types.tls import CertificateProvider, CertificateProviderInstance, GrpcEndpoint, ValidationCA

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.network_security_v1beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.network_security_v1beta1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.network_security_v1beta1"

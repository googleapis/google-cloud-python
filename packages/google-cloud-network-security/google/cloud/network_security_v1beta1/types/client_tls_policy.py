...
class ClientTlsPolicy(proto.Message):
    ...
    Attributes:
        ...
        client_certificate (google.cloud.network_security_v1beta1.types.CertificateProvider):
            ...
            this dictates mTLS.
        server_validation_ca (MutableSequence[google.cloud.network_security_v1beta1.types.ValidationCA]):
...
class ListClientTlsPoliciesResponse(proto.Message):
    ...
    Attributes:
        client_tls_policies (MutableSequence[google.cloud.network_security_v1beta1.types.ClientTlsPolicy]):

...
class ListAuthorizationPoliciesAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterable[authorization_policy.ListAuthorizationPoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListServerTlsPoliciesAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterable[server_tls_policy.ListServerTlsPoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
...
class ListClientTlsPoliciesAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterable[client_tls_policy.ListClientTlsPoliciesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)

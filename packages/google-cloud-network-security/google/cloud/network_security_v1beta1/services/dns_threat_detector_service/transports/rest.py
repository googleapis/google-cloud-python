...
from google.cloud.network_security_v1beta1._compat import transcode_request
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[DnsThreatDetectorServiceRestInterceptor]): Interceptor used

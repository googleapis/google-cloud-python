    ...
    class _BaseCreateDnsThreatDetector:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{parent=projects/*/locations/*}/dnsThreatDetectors",
    ...
    class _BaseDeleteDnsThreatDetector:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta1/{name=projects/*/locations/*/dnsThreatDetectors/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateDnsThreatDetector:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta1/{dns_threat_detector.name=projects/*/locations/*/dnsThreatDetectors/*}",
                    "body": "dns_threat_detector",
                },
            ]
            return http_options

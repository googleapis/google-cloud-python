...
#
# Snippet for ListInterceptDeploymentGroups
...
async def sample_list_intercept_deployment_groups():
    # Create a client
    client = network_security_v1alpha1.InterceptAsyncClient()
...
# [END networksecurity_v1alpha1_generated_Intercept_ListInterceptDeploymentGroups_async]

...
async def sample_update_mirroring_endpoint_group_association():
    ...
    # Make the request
    operation = await client.update_mirroring_endpoint_group_association(
        request=request
    )
...
# [END networksecurity_v1alpha1_generated_Mirroring_UpdateMirroringEndpointGroupAssociation_async]

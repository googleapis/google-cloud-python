...
#
# Snippet for UpdateInterceptEndpointGroupAssociation
...
async def sample_update_intercept_endpoint_group_association():
    # Create a client
    ...
    # Make the request
    operation = await client.update_intercept_endpoint_group_association(
        request=request
    )

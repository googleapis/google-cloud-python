...
#
# Snippet for UpdateInterceptDeployment
...
# [START networksecurity_v1_generated_Intercept_UpdateInterceptDeployment_sync]
...
def sample_update_intercept_deployment():
    ...
    intercept_deployment = network_security_v1.InterceptDeployment()
    ...
    request = network_security_v1.UpdateInterceptDeploymentRequest(

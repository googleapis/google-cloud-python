...
#
# Snippet for UpdateMirroringDeployment
...
def sample_update_mirroring_deployment():
    # Create a client
    client = network_security_v1alpha1.MirroringClient()
...
# [END networksecurity_v1alpha1_generated_Mirroring_UpdateMirroringDeployment_sync]

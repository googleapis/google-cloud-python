...
#
# Snippet for CreateMirroringEndpointGroupAssociation
...
def sample_create_mirroring_endpoint_group_association():
    # Create a client
...
# [END networksecurity_v1alpha1_generated_Mirroring_CreateMirroringEndpointGroupAssociation_sync]

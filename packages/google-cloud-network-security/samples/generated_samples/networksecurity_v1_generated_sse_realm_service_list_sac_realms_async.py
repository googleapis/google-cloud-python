...
async def sample_list_sac_realms():
    # Create a client
    client = network_security_v1.SSERealmServiceAsyncClient()

    # Initialize request argument(s)
    request = network_security_v1.ListSACRealmsRequest(
        parent="parent_value",
    )

    # Make the request
    page_result = client.list_sac_realms(request=request)

...
def sample_list_dns_threat_detectors():
    # Create a client
    client = network_security_v1.DnsThreatDetectorServiceClient()

    # Initialize request argument(s)
    request = network_security_v1.ListDnsThreatDetectorsRequest(
        parent="parent_value",
    )

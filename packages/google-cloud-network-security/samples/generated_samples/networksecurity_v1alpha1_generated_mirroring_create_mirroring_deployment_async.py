...
#
# Snippet for CreateMirroringDeployment
...
async def sample_create_mirroring_deployment():
    ...
    # Make the request
    operation = await client.create_mirroring_deployment(request=request)
...
# [END networksecurity_v1alpha1_generated_Mirroring_CreateMirroringDeployment_async]

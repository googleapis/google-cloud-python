...
# [START networksecurity_v1_generated_NetworkSecurity_DeleteUrlList_sync]
...
def sample_delete_url_list():
    ...
    request = network_security_v1.DeleteUrlListRequest(
        name="name_value",
    )
...
# [END networksecurity_v1_generated_NetworkSecurity_DeleteUrlList_sync]

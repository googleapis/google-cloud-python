...
#
# Snippet for CreateInterceptDeploymentGroup
...
def sample_create_intercept_deployment_group():
    ...
    intercept_deployment_group = network_security_v1.InterceptDeploymentGroup()
    intercept_deployment_group.network = "network_value"

    request = network_security_v1.CreateInterceptDeploymentGroupRequest(
        parent="parent_value",

...
#
# Snippet for CreateInterceptEndpointGroupAssociation
...
async def sample_create_intercept_endpoint_group_association():
    # Create a client
    client = network_security_v1.InterceptAsyncClient()

    # Initialize request argument(s)
    intercept_endpoint_group_association = (
        network_security_v1.InterceptEndpointGroupAssociation()
    )
    ...
    request = network_security_v1.CreateInterceptEndpointGroupAssociationRequest(
        parent="parent_value",

# Contains code from https://github.com/ibis-project/ibis/blob/9.2.0/ibis/expr/decompile.py
...
def literal(op, value, dtype):
    inferred = ibis_types.literal(value)
...
def decompile(
    ...
    result = out.getvalue()
    if render_import:
        result = f"import bigframes_vendored.ibis\n\n\n{result}"

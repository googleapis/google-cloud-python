# Contains code from https://github.com/ibis-project/ibis/blob/9.2.0/ibis/expr/api.py
...
def set_backend(backend: str | BaseBackend) -> None:
    ...
    if isinstance(backend, str):
        backend = bigframes_vendored.ibis.connect(backend)

    bigframes_vendored.ibis.options.default_backend = backend

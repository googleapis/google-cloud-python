# Contains code from https://github.com/ibis-project/ibis/blob/9.2.0/ibis/expr/types/json.py
...
from bigframes_vendored.ibis.expr.types import Column, Scalar, Value

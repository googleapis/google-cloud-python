# Contains code from https://github.com/ibis-project/ibis/blob/9.2.0/ibis/expr/types/relations.py
...
class Table(Expr, _FixedTextJupyterMixin):
    ...
    def __dataframe__(self, nan_as_null: bool = False, allow_copy: bool = True):
        from bigframes_vendored.ibis.expr.types.dataframe_interchange import (
            IbisDataFrame,
        )
    ...
    def __getitem__(self, what):
        ...
        └────────────────┴───────────────┴───────────────────┴─────────────┘
        """
        from bigframes_vendored.ibis.expr.types.logical import BooleanValue
    ...
    def join(
        ...
        *,
        ...
        └─────────┴───────────────────┴───────────────┴───────────────────┘
        """
        from bigframes_vendored.ibis.expr.types.joins import Join

# Contains code from https://github.com/ibis-project/ibis/blob/9.2.0/ibis/expr/types/joins.py
...
if TYPE_CHECKING:
    ...
    from bigframes_vendored.ibis.expr.operations.relations import JoinKind

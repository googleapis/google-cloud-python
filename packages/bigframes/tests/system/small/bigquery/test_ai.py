...
def test_ai_function_pandas_input(session):
    ...
    result = bbq.ai.generate_bool(prompt, endpoint="gemini-3.1-flash-lite")
...
def test_ai_function_compile_model_params(session):
    ...
    result = bbq.ai.generate_bool(
        prompt, endpoint="gemini-3.1-flash-lite", model_params=model_params
    )
...
def test_ai_generate(session):
    ...
    result = bbq.ai.generate(prompt, endpoint="gemini-3.1-flash-lite")
...
def test_ai_generate_int(session):
    ...
    result = bbq.ai.generate_int(prompt, endpoint="gemini-3.1-flash-lite")
...
def test_ai_generate_double(session):
    ...
    result = bbq.ai.generate_double(prompt, endpoint="gemini-3.1-flash-lite")

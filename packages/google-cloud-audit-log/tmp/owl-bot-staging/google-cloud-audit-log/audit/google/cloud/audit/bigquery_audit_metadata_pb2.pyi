...
class BigQueryAuditMetadata(_message.Message):
    __slots__ = ["dataset_change", "dataset_creation", "dataset_deletion", "first_party_app_metadata", "job_change", "job_deletion", "job_insertion", "model_creation", "model_data_change", "model_data_read", "model_deletion", "model_metadata_change", "routine_change", "routine_creation", "routine_deletion", "row_access_policy_change", "row_access_policy_creation", "row_access_policy_deletion", "table_change", "table_creation", "table_data_change", "table_data_read", "table_deletion", "unlink_dataset"]
    ...
    class Dataset(_message.Message):
        __slots__ = ["acl", "create_time", "dataset_info", "dataset_name", "default_collation", "default_encryption", "default_table_expire_duration", "update_time"]
    ...
    class JobConfig(_message.Message):
        __slots__ = ["extract_config", "labels", "load_config", "query_config", "table_copy_config", "type"]
        class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = []
        class Extract(_message.Message):
            __slots__ = ["destination_uris", "destination_uris_truncated", "source_model", "source_table"]
        ...
        class Load(_message.Message):
            __slots__ = ["create_disposition", "destination_table", "destination_table_encryption", "schema_json", "schema_json_truncated", "source_uris", "source_uris_truncated", "write_disposition"]
        ...
        class Query(_message.Message):
            __slots__ = ["create_disposition", "default_dataset", "destination_table", "destination_table_encryption", "priority", "query", "query_truncated", "statement_type", "table_definitions", "write_disposition"]
        ...
        class TableCopy(_message.Message):
            __slots__ = ["create_disposition", "destination_expiration_time", "destination_table", "destination_table_encryption", "operation_type", "source_tables", "source_tables_truncated", "write_disposition"]
            CREATE_DISPOSITION_FIELD_NUMBER: _ClassVar[int]
    ...
    class JobStats(_message.Message):
        __slots__ = ["create_time", "end_time", "extract_stats", "load_stats", "parent_job_name", "query_stats", "reservation", "reservation_usage", "start_time", "total_slot_ms"]
        class Extract(_message.Message):
        ...
        class Query(_message.Message):
            __slots__ = ["billing_tier", "cache_hit", "output_row_count", "referenced_routines", "referenced_tables", "referenced_views", "total_billed_bytes", "total_processed_bytes"]
    ...
    class Model(_message.Message):
        __slots__ = ["create_time", "encryption", "expire_time", "model_info", "model_name", "update_time"]
        CREATE_TIME_FIELD_NUMBER: _ClassVar[int]
    ...
    class RowAccessPolicyDeletion(_message.Message):
        __slots__ = ["all_row_access_policies_dropped", "job_name", "row_access_policies"]
    ...
    class Table(_message.Message):
        __slots__ = ["create_time", "encryption", "expire_time", "schema_json", "schema_json_truncated", "table_info", "table_name", "truncate_time", "update_time", "view"]
        CREATE_TIME_FIELD_NUMBER: _ClassVar[int]
        ENCRYPTION_FIELD_NUMBER: _ClassVar[int]
        EXPIRE_TIME_FIELD_NUMBER: _ClassVar[int]
        SCHEMA_JSON_FIELD_NUMBER: _ClassVar[int]
    ...
    class TableDataChange(_message.Message):
        __slots__ = ["deleted_rows_count", "inserted_rows_count", "job_name", "reason", "stream_name", "truncated"]
        class Reason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = []
    ...
    class TableDataRead(_message.Message):
        __slots__ = ["fields", "fields_truncated", "job_name", "policy_tags", "policy_tags_truncated", "reason", "session_name"]
        class Reason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = []

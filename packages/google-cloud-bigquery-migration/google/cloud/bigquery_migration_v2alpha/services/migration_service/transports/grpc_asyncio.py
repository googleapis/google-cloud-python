...
class MigrationServiceGrpcAsyncIOTransport(MigrationServiceTransport):
    ...
    def create_migration_workflow(
        self,
    ) -> Callable[[migration_service.CreateMigrationWorkflowRequest], Awaitable[migration_entities.MigrationWorkflow]]:
    ...
    @property
    def get_migration_workflow(self) -> Callable[[migration_service.GetMigrationWorkflowRequest], Awaitable[migration_entities.MigrationWorkflow]]:
    ...
    def list_migration_workflows(
        self,
    ) -> Callable[[migration_service.ListMigrationWorkflowsRequest], Awaitable[migration_service.ListMigrationWorkflowsResponse]]:
    ...
    @property
    def delete_migration_workflow(self) -> Callable[[migration_service.DeleteMigrationWorkflowRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def start_migration_workflow(self) -> Callable[[migration_service.StartMigrationWorkflowRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_migration_subtask(self) -> Callable[[migration_service.GetMigrationSubtaskRequest], Awaitable[migration_entities.MigrationSubtask]]:
    ...
    def list_migration_subtasks(
        self,
    ) -> Callable[[migration_service.ListMigrationSubtasksRequest], Awaitable[migration_service.ListMigrationSubtasksResponse]]:

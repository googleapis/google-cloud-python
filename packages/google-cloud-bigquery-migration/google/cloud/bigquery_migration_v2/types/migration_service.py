...
class ListMigrationWorkflowsResponse(proto.Message):
    ...
    Attributes:
        migration_workflows (Sequence[google.cloud.bigquery_migration_v2.types.MigrationWorkflow]):
...
class ListMigrationSubtasksResponse(proto.Message):
    ...
    Attributes:
        migration_subtasks (Sequence[google.cloud.bigquery_migration_v2.types.MigrationSubtask]):

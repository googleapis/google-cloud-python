...
class MigrationServiceTransport(abc.ABC):
    ...
    def create_migration_workflow(
        ...
        Union[migration_entities.MigrationWorkflow, Awaitable[migration_entities.MigrationWorkflow]],
    ]:
        raise NotImplementedError()
    ...
    def get_migration_workflow(
        ...
        [migration_service.GetMigrationWorkflowRequest], Union[migration_entities.MigrationWorkflow, Awaitable[migration_entities.MigrationWorkflow]]
    ]:
        raise NotImplementedError()
    ...
    def list_migration_workflows(
        ...
        Union[migration_service.ListMigrationWorkflowsResponse, Awaitable[migration_service.ListMigrationWorkflowsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def delete_migration_workflow(
        self,
    ) -> Callable[[migration_service.DeleteMigrationWorkflowRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def start_migration_workflow(
        self,
    ) -> Callable[[migration_service.StartMigrationWorkflowRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()
    ...
    def get_migration_subtask(
        ...
        [migration_service.GetMigrationSubtaskRequest], Union[migration_entities.MigrationSubtask, Awaitable[migration_entities.MigrationSubtask]]
    ]:
        raise NotImplementedError()
    ...
    def list_migration_subtasks(
        ...
        Union[migration_service.ListMigrationSubtasksResponse, Awaitable[migration_service.ListMigrationSubtasksResponse]],
    ]:
        raise NotImplementedError()

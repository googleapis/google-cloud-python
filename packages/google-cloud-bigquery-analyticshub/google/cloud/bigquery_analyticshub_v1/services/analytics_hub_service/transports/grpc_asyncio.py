...
class AnalyticsHubServiceGrpcAsyncIOTransport(AnalyticsHubServiceTransport):
    ...
    @property
    def list_data_exchanges(self) -> Callable[[analyticshub.ListDataExchangesRequest], Awaitable[analyticshub.ListDataExchangesResponse]]:
    ...
    @property
    def list_org_data_exchanges(self) -> Callable[[analyticshub.ListOrgDataExchangesRequest], Awaitable[analyticshub.ListOrgDataExchangesResponse]]:
    ...
    @property
    def get_data_exchange(self) -> Callable[[analyticshub.GetDataExchangeRequest], Awaitable[analyticshub.DataExchange]]:
    ...
    @property
    def create_data_exchange(self) -> Callable[[analyticshub.CreateDataExchangeRequest], Awaitable[analyticshub.DataExchange]]:
    ...
    @property
    def update_data_exchange(self) -> Callable[[analyticshub.UpdateDataExchangeRequest], Awaitable[analyticshub.DataExchange]]:
    ...
    @property
    def delete_data_exchange(self) -> Callable[[analyticshub.DeleteDataExchangeRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_listings(self) -> Callable[[analyticshub.ListListingsRequest], Awaitable[analyticshub.ListListingsResponse]]:
    ...
    @property
    def get_listing(self) -> Callable[[analyticshub.GetListingRequest], Awaitable[analyticshub.Listing]]:
    ...
    @property
    def create_listing(self) -> Callable[[analyticshub.CreateListingRequest], Awaitable[analyticshub.Listing]]:
    ...
    @property
    def update_listing(self) -> Callable[[analyticshub.UpdateListingRequest], Awaitable[analyticshub.Listing]]:
    ...
    @property
    def delete_listing(self) -> Callable[[analyticshub.DeleteListingRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def subscribe_listing(self) -> Callable[[analyticshub.SubscribeListingRequest], Awaitable[analyticshub.SubscribeListingResponse]]:
    ...
    @property
    def subscribe_data_exchange(self) -> Callable[[analyticshub.SubscribeDataExchangeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def refresh_subscription(self) -> Callable[[analyticshub.RefreshSubscriptionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_subscription(self) -> Callable[[analyticshub.GetSubscriptionRequest], Awaitable[analyticshub.Subscription]]:
    ...
    @property
    def list_subscriptions(self) -> Callable[[analyticshub.ListSubscriptionsRequest], Awaitable[analyticshub.ListSubscriptionsResponse]]:
    ...
    def list_shared_resource_subscriptions(
        self,
    ) -> Callable[[analyticshub.ListSharedResourceSubscriptionsRequest], Awaitable[analyticshub.ListSharedResourceSubscriptionsResponse]]:
    ...
    @property
    def revoke_subscription(self) -> Callable[[analyticshub.RevokeSubscriptionRequest], Awaitable[analyticshub.RevokeSubscriptionResponse]]:
    ...
    @property
    def delete_subscription(self) -> Callable[[analyticshub.DeleteSubscriptionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def create_query_template(self) -> Callable[[analyticshub.CreateQueryTemplateRequest], Awaitable[analyticshub.QueryTemplate]]:
    ...
    @property
    def get_query_template(self) -> Callable[[analyticshub.GetQueryTemplateRequest], Awaitable[analyticshub.QueryTemplate]]:
    ...
    @property
    def list_query_templates(self) -> Callable[[analyticshub.ListQueryTemplatesRequest], Awaitable[analyticshub.ListQueryTemplatesResponse]]:
    ...
    @property
    def update_query_template(self) -> Callable[[analyticshub.UpdateQueryTemplateRequest], Awaitable[analyticshub.QueryTemplate]]:
    ...
    @property
    def delete_query_template(self) -> Callable[[analyticshub.DeleteQueryTemplateRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def submit_query_template(self) -> Callable[[analyticshub.SubmitQueryTemplateRequest], Awaitable[analyticshub.QueryTemplate]]:
    ...
    @property
    def approve_query_template(self) -> Callable[[analyticshub.ApproveQueryTemplateRequest], Awaitable[analyticshub.QueryTemplate]]:

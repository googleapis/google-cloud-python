...
class AnalyticsHubServiceClient(metaclass=AnalyticsHubServiceClientMeta):
    ...
    def query_template_path(
        ...
        return "projects/{project}/locations/{location}/dataExchanges/{data_exchange}/queryTemplates/{query_template}".format(
            project=project,
            location=location,
            data_exchange=data_exchange,
    ...
    def parse_query_template_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataExchanges/(?P<data_exchange>.+?)/queryTemplates/(?P<query_template>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def list_shared_resource_subscriptions(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_shared_resource_subscriptions
        ]

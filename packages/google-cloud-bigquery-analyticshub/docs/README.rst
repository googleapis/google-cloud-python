Python Client for Analytics Hub
===============================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-bigquery-analyticshub.svg
   :target: https://pypi.org/project/google-cloud-bigquery-analyticshub/
.. _Analytics Hub: https://cloud.google.com/analytics-hub
...
3. `Enable the Analytics Hub.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Analytics Hub.:  https://cloud.google.com/analytics-hub
...
-  Read the `Client Library Documentation`_ for Analytics Hub
   to see other available methods on the client.
-  Read the `Analytics Hub Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Analytics Hub Product documentation:  https://cloud.google.com/analytics-hub

...
class analyticshubCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=analyticshubCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the analyticshub client library.

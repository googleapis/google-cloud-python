...
class LicenseManagerAsyncClient:
    ...
    parse_compute_instance_path = staticmethod(LicenseManagerClient.parse_compute_instance_path)
    configuration_path = staticmethod(LicenseManagerClient.configuration_path)
    parse_configuration_path = staticmethod(LicenseManagerClient.parse_configuration_path)
    ...
    common_billing_account_path = staticmethod(LicenseManagerClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(LicenseManagerClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(LicenseManagerClient.common_folder_path)
    parse_common_folder_path = staticmethod(LicenseManagerClient.parse_common_folder_path)
    common_organization_path = staticmethod(LicenseManagerClient.common_organization_path)
    parse_common_organization_path = staticmethod(LicenseManagerClient.parse_common_organization_path)
    common_project_path = staticmethod(LicenseManagerClient.common_project_path)
    parse_common_project_path = staticmethod(LicenseManagerClient.parse_common_project_path)
    common_location_path = staticmethod(LicenseManagerClient.common_location_path)
    parse_common_location_path = staticmethod(LicenseManagerClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, LicenseManagerTransport, Callable[..., LicenseManagerTransport]]] = "grpc_asyncio",
    ...
    async def list_configurations(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_configurations]
    ...
    async def get_configuration(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_configuration]
    ...
    async def create_configuration(
        self,
        request: Optional[Union[licensemanager.CreateConfigurationRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_configuration]
    ...
    async def update_configuration(
        self,
        request: Optional[Union[licensemanager.UpdateConfigurationRequest, dict]] = None,
        *,
        configuration: Optional[api_entities.Configuration] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_configuration]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("configuration.name", request.configuration.name),)),)
    ...
    async def delete_configuration(
        self,
        request: Optional[Union[licensemanager.DeleteConfigurationRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_configuration]
    ...
    async def deactivate_configuration(
        self,
        request: Optional[Union[licensemanager.DeactivateConfigurationRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.deactivate_configuration]
    ...
    async def reactivate_configuration(
        self,
        request: Optional[Union[licensemanager.ReactivateConfigurationRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reactivate_configuration]
    ...
    async def query_configuration_license_usage(
        self,
        request: Optional[Union[licensemanager.QueryConfigurationLicenseUsageRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, licensemanager.QueryConfigurationLicenseUsageRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_configuration_license_usage]
    ...
    async def aggregate_usage(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.aggregate_usage]

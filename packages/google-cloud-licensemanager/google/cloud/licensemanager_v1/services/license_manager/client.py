...
class LicenseManagerClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[LicenseManagerTransport]]
...
class LicenseManagerClient(metaclass=LicenseManagerClientMeta):
    ...
    def configuration_path(
        ...
        return "projects/{project}/locations/{location}/configurations/{configuration}".format(
            project=project,
            location=location,
    ...
    def parse_configuration_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/configurations/(?P<configuration>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = LicenseManagerClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = LicenseManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = LicenseManagerClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = LicenseManagerClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or LicenseManagerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[LicenseManagerTransport], Callable[..., LicenseManagerTransport]
            ] = (
    ...
    def query_configuration_license_usage(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.query_configuration_license_usage
        ]

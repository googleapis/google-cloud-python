Python Client for License Manager
=================================

|preview| |pypi| |versions|

`License Manager`_: License Manager is a tool to manage and track third-party licenses on Google Cloud. 
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-licensemanager.svg
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-licensemanager.svg
   :target: https://pypi.org/project/google-cloud-licensemanager/
.. _License Manager: https://cloud.google.com/compute/docs/instances/windows/ms-licensing
...
3. `Enable the License Manager.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the License Manager.:  https://cloud.google.com/compute/docs/instances/windows/ms-licensing
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-licensemanager/samples
...
.. code-block:: console
    ...
    pip install google-cloud-licensemanager
...
-  Read the `Client Library Documentation`_ for License Manager
   to see other available methods on the client.
-  Read the `License Manager Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _License Manager Product documentation:  https://cloud.google.com/compute/docs/instances/windows/ms-licensing

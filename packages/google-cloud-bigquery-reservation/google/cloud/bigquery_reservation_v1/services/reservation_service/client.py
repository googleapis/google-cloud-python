...
from google.cloud.bigquery_reservation_v1._compat import (
    get_api_endpoint,
...
class ReservationServiceClient(metaclass=ReservationServiceClientMeta):
    ...
    def reservation_group_path(
        ...
        return "projects/{project}/locations/{location}/reservationGroups/{reservation_group}".format(
            project=project,
            location=location,
    ...
    def parse_reservation_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reservationGroups/(?P<reservation_group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=ReservationServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def update_reservation_group(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_reservation_group():
                # Create a client
                client = bigquery_reservation_v1.ReservationServiceClient()
                ...
                # Make the request
                response = client.update_reservation_group(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_reservation_v1.types.UpdateReservationGroupRequest, dict]):
                The request object. The request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_reservation_group]

...
class ReservationServiceClient(metaclass=ReservationServiceClientMeta):
    ...
    def parse_assignment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reservations/(?P<reservation>.+?)/assignments/(?P<assignment>.+?)$", path
        )
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or ReservationServiceClient._get_api_endpoint(
    ...
    def update_capacity_commitment(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("capacity_commitment.name", request.capacity_commitment.name),)),)
    ...
    def search_assignments(
        ...
        **Note** "-" cannot be used for projects nor locations.
        ...
        """
        warnings.warn("ReservationServiceClient.search_assignments is deprecated", DeprecationWarning)
    ...
    def update_assignment(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("assignment.name", request.assignment.name),)),)
    ...
    def update_bi_reservation(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("bi_reservation.name", request.bi_reservation.name),)),)

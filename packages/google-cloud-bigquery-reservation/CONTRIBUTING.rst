...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-bigquery-reservation``. The
...
.. _config: https://github.com/googleapis/python-bigquery-reservation/blob/main/packages/google-cloud-bigquery-reservation/noxfile.py

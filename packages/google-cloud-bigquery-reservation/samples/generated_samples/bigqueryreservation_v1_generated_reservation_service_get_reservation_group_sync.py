...
#
# Snippet for GetReservationGroup
...
def sample_get_reservation_group():
    # Create a client
    client = bigquery_reservation_v1.ReservationServiceClient()

    # Initialize request argument(s)
    request = bigquery_reservation_v1.GetReservationGroupRequest(
        name="name_value",
    )

    # Make the request
    response = client.get_reservation_group(request=request)

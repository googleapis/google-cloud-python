        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.BatchCreateDataObjects",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceClient.batch_create_data_objects",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "BatchCreateDataObjects",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.BatchDeleteDataObjects",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.BatchUpdateDataObjects",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceClient.batch_update_data_objects",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "BatchUpdateDataObjects",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.CreateDataObject",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceClient.create_data_object",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "CreateDataObject",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.DeleteDataObject",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.GetDataObject",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceClient.get_data_object",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "GetDataObject",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.UpdateDataObject",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceClient.update_data_object",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "UpdateDataObject",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.vectorsearch_v1.DataObjectServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.vectorsearch_v1.DataObjectServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.vectorsearch.v1.DataObjectService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

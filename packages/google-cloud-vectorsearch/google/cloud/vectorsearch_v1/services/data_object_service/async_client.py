...
class DataObjectServiceAsyncClient:
    """Service for creating and managing data objects."""

    _client: DataObjectServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = DataObjectServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = DataObjectServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = DataObjectServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataObjectServiceAsyncClient: The constructed client.
        """
        sa_info_func = (
            DataObjectServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(DataObjectServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            DataObjectServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(DataObjectServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return DataObjectServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> DataObjectServiceTransport:
        ...
        Returns:
            DataObjectServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = DataObjectServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = DataObjectServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.vectorsearch_v1.DataObjectServiceAsyncClient`.",
                extra={
    ...
    async def create_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.CreateDataObjectRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            data_object (:class:`google.cloud.vectorsearch_v1.types.DataObject`):
                Required. The DataObject to create.
                This corresponds to the ``data_object`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            data_object_id (:class:`str`):
    ...
    async def batch_create_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.BatchCreateDataObjectsRequest, dict]]):
                The request object. Request message for
    ...
    async def get_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.GetDataObjectRequest, dict]]):
                The request object. Request message for
    ...
    async def update_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.UpdateDataObjectRequest, dict]]):
                The request object. Request message for
    ...
    async def batch_update_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.BatchUpdateDataObjectsRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            requests (:class:`MutableSequence[google.cloud.vectorsearch_v1.types.UpdateDataObjectRequest]`):
    ...
    async def delete_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.DeleteDataObjectRequest, dict]]):
                The request object. Request message for
    ...
    async def batch_delete_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.BatchDeleteDataObjectsRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            requests (:class:`MutableSequence[google.cloud.vectorsearch_v1.types.DeleteDataObjectRequest]`):
                Required. The request message
    ...
    async def __aenter__(self) -> "DataObjectServiceAsyncClient":
        return self
...
__all__ = ("DataObjectServiceAsyncClient",)

...
class ListCollectionsPager:
    ...
    :class:`google.cloud.vectorsearch_v1.types.ListCollectionsResponse` object, and
    ...
    All the usual :class:`google.cloud.vectorsearch_v1.types.ListCollectionsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.vectorsearch_v1.types.ListCollectionsRequest):
                The initial request object.
            response (google.cloud.vectorsearch_v1.types.ListCollectionsResponse):
...
class ListIndexesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.vectorsearch_v1.types.ListIndexesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``indexes`` field.
    ...
    All the usual :class:`google.cloud.vectorsearch_v1.types.ListIndexesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.vectorsearch_v1.types.ListIndexesRequest):
                The initial request object.
            response (google.cloud.vectorsearch_v1.types.ListIndexesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

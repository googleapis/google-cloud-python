...
class VectorSearchServiceClient(metaclass=VectorSearchServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.vectorsearch_v1.VectorSearchServiceClient`.",
                    extra={
    ...
    def list_collections(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.ListCollectionsRequest, dict]):
        ...
        Returns:
            google.cloud.vectorsearch_v1.services.vector_search_service.pagers.ListCollectionsPager:
    ...
    def get_collection(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.GetCollectionRequest, dict]):
    ...
    def create_collection(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.CreateCollectionRequest, dict]):
    ...
    def update_collection(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.UpdateCollectionRequest, dict]):
    ...
    def delete_collection(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.DeleteCollectionRequest, dict]):
    ...
    def list_indexes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.ListIndexesRequest, dict]):
                The request object. Message for requesting list of
                Indexes
            parent (str):
                Required. Parent value for
        ...
        Returns:
            google.cloud.vectorsearch_v1.services.vector_search_service.pagers.ListIndexesPager:
                Message for response to listing
                Indexes
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_index(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.GetIndexRequest, dict]):
    ...
    def create_index(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.CreateIndexRequest, dict]):
    ...
    def update_index(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.UpdateIndexRequest, dict]):
    ...
    def delete_index(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.DeleteIndexRequest, dict]):
    ...
    def import_data_objects(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.ImportDataObjectsRequest, dict]):
    ...
    def export_data_objects(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1.types.ExportDataObjectsRequest, dict]):
                The request object. Request message for

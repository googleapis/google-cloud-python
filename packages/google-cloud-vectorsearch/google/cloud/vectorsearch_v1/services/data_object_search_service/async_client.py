...
from google.cloud.vectorsearch_v1.services.data_object_search_service import pagers
...
class DataObjectSearchServiceAsyncClient:
    """Service for searching data objects."""

    _client: DataObjectSearchServiceClient
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataObjectSearchServiceAsyncClient: The constructed client.
        """
        return DataObjectSearchServiceClient.from_service_account_info.__func__(DataObjectSearchServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            DataObjectSearchServiceAsyncClient: The constructed client.
        """
        return DataObjectSearchServiceClient.from_service_account_file.__func__(DataObjectSearchServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return DataObjectSearchServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> DataObjectSearchServiceTransport:
        ...
        Returns:
            DataObjectSearchServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = DataObjectSearchServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = DataObjectSearchServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.vectorsearch_v1.DataObjectSearchServiceAsyncClient`.",
                extra={
    ...
    async def search_data_objects(
        ...
        *,
    ...
    ) -> pagers.SearchDataObjectsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.SearchDataObjectsRequest, dict]]):
        ...
        Returns:
            google.cloud.vectorsearch_v1.services.data_object_search_service.pagers.SearchDataObjectsAsyncPager:
        ...
        response = pagers.SearchDataObjectsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def query_data_objects(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.QueryDataObjectsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.QueryDataObjectsRequest, dict]]):
        ...
        Returns:
            google.cloud.vectorsearch_v1.services.data_object_search_service.pagers.QueryDataObjectsAsyncPager:
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.QueryDataObjectsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def aggregate_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.AggregateDataObjectsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.vectorsearch_v1.types.AggregateDataObjectsResponse:
                Response message for
                   [DataObjectSearchService.AggregateDataObjects][google.cloud.vectorsearch.v1.DataObjectSearchService.AggregateDataObjects].
    ...
    async def batch_search_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1.types.BatchSearchDataObjectsRequest, dict]]):
        ...
        Returns:
            google.cloud.vectorsearch_v1.types.BatchSearchDataObjectsResponse:
    ...
    async def __aenter__(self) -> "DataObjectSearchServiceAsyncClient":
        return self
...
__all__ = ("DataObjectSearchServiceAsyncClient",)

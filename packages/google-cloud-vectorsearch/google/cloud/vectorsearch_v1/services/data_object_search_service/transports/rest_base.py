    ...
    class _BaseBatchSearchDataObjects:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/collections/*}/dataObjects:batchSearch",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseQueryDataObjects:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/collections/*}/dataObjects:query",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseSearchDataObjects:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/collections/*}/dataObjects:search",
                    "body": "*",
                },
            ]
            return http_options

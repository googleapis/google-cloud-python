...
class DataObjectSearchServiceTransport(abc.ABC):
    """Abstract transport class for DataObjectSearchService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.search_data_objects: gapic_v1.method.wrap_method(
            ...
            self.query_data_objects: gapic_v1.method.wrap_method(
                self.query_data_objects,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.aggregate_data_objects: gapic_v1.method.wrap_method(
            ...
            self.batch_search_data_objects: gapic_v1.method.wrap_method(
                self.batch_search_data_objects,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
    ...
    def batch_search_data_objects(
        ...
        Union[
            ...
            Awaitable[data_object_search_service.BatchSearchDataObjectsResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("DataObjectSearchServiceTransport",)

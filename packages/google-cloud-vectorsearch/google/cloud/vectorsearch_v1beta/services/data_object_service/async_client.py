...
class DataObjectServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = DataObjectServiceClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            DataObjectServiceAsyncClient: The constructed client.
        """
        sa_file_func = DataObjectServiceClient.from_service_account_file.__func__  # type: ignore
    ...
    async def create_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.CreateDataObjectRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            data_object (:class:`google.cloud.vectorsearch_v1beta.types.DataObject`):
    ...
    async def batch_create_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.BatchCreateDataObjectsRequest, dict]]):
                The request object. Request message for
    ...
    async def get_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.GetDataObjectRequest, dict]]):
                The request object. Request message for
    ...
    async def update_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.UpdateDataObjectRequest, dict]]):
                The request object. Request message for
    ...
    async def batch_update_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.BatchUpdateDataObjectsRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            requests (:class:`MutableSequence[google.cloud.vectorsearch_v1beta.types.UpdateDataObjectRequest]`):
    ...
    async def delete_data_object(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.DeleteDataObjectRequest, dict]]):
                The request object. Request message for
    ...
    async def batch_delete_data_objects(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.vectorsearch_v1beta.types.BatchDeleteDataObjectsRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            requests (:class:`MutableSequence[google.cloud.vectorsearch_v1beta.types.DeleteDataObjectRequest]`):
                Required. The request message

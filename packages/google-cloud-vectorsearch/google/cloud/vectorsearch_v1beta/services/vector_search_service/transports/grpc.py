...
class VectorSearchServiceGrpcTransport(VectorSearchServiceTransport):
    """gRPC backend transport for VectorSearchService.
...
__all__ = ("VectorSearchServiceGrpcTransport",)

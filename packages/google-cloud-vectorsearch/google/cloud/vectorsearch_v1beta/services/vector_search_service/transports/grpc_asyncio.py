...
from .grpc import VectorSearchServiceGrpcTransport
    ...
    async def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.cloud.vectorsearch.v1beta.VectorSearchService",
...
class VectorSearchServiceGrpcAsyncIOTransport(VectorSearchServiceTransport):
    """gRPC AsyncIO backend transport for VectorSearchService.
    ...
    @property
    def list_collections(self) -> Callable[[vectorsearch_service.ListCollectionsRequest], Awaitable[vectorsearch_service.ListCollectionsResponse]]:
        ...
        if "list_collections" not in self._stubs:
            self._stubs["list_collections"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.ListCollectionsRequest.serialize,
                response_deserializer=vectorsearch_service.ListCollectionsResponse.deserialize,
            )
        return self._stubs["list_collections"]

    @property
    def get_collection(self) -> Callable[[vectorsearch_service.GetCollectionRequest], Awaitable[vectorsearch_service.Collection]]:
        ...
        if "get_collection" not in self._stubs:
            self._stubs["get_collection"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.GetCollectionRequest.serialize,
                response_deserializer=vectorsearch_service.Collection.deserialize,
            )
        return self._stubs["get_collection"]

    @property
    def create_collection(self) -> Callable[[vectorsearch_service.CreateCollectionRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_collection" not in self._stubs:
            self._stubs["create_collection"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.CreateCollectionRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["create_collection"]

    @property
    def update_collection(self) -> Callable[[vectorsearch_service.UpdateCollectionRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "update_collection" not in self._stubs:
            self._stubs["update_collection"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.UpdateCollectionRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["update_collection"]

    @property
    def delete_collection(self) -> Callable[[vectorsearch_service.DeleteCollectionRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_collection" not in self._stubs:
            self._stubs["delete_collection"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.DeleteCollectionRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["delete_collection"]

    @property
    def list_indexes(self) -> Callable[[vectorsearch_service.ListIndexesRequest], Awaitable[vectorsearch_service.ListIndexesResponse]]:
        ...
        if "list_indexes" not in self._stubs:
            self._stubs["list_indexes"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.ListIndexesRequest.serialize,
                response_deserializer=vectorsearch_service.ListIndexesResponse.deserialize,
            )
        return self._stubs["list_indexes"]

    @property
    def get_index(self) -> Callable[[vectorsearch_service.GetIndexRequest], Awaitable[vectorsearch_service.Index]]:
        ...
        if "get_index" not in self._stubs:
            self._stubs["get_index"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.GetIndexRequest.serialize,
                response_deserializer=vectorsearch_service.Index.deserialize,
            )
        return self._stubs["get_index"]

    @property
    def create_index(self) -> Callable[[vectorsearch_service.CreateIndexRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_index" not in self._stubs:
            self._stubs["create_index"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.CreateIndexRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["create_index"]

    @property
    def delete_index(self) -> Callable[[vectorsearch_service.DeleteIndexRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_index" not in self._stubs:
            self._stubs["delete_index"] = self._logged_channel.unary_unary(
                ...
                request_serializer=vectorsearch_service.DeleteIndexRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["delete_index"]

    @property
    def import_data_objects(self) -> Callable[[vectorsearch_service.ImportDataObjectsRequest], Awaitable[operations_pb2.Operation]]:
        r"""Return a callable for the import data objects method over gRPC.

        Initiates a Long-Running Operation to import
        DataObjects into a Collection.

        Returns:
            Callable[[~.ImportDataObjectsRequest],
                    Awaitable[~.Operation]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "import_data_objects" not in self._stubs:
            self._stubs["import_data_objects"] = self._logged_channel.unary_unary(
                "/google.cloud.vectorsearch.v1beta.VectorSearchService/ImportDataObjects",
                request_serializer=vectorsearch_service.ImportDataObjectsRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_collections: self._wrap_method(
            ...
            self.get_collection: self._wrap_method(
                self.get_collection,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,

...
class VectorSearchServiceGrpcAsyncIOTransport(VectorSearchServiceTransport):
    ...
    def get_collection(
        ...
        Awaitable[vectorsearch_service.Collection],
    ]:
    ...
    def get_index(
        ...
        [vectorsearch_service.GetIndexRequest], Awaitable[vectorsearch_service.Index]
    ]:
    ...
    def create_index(
        ...
        [vectorsearch_service.CreateIndexRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_index(
        ...
        [vectorsearch_service.DeleteIndexRequest], Awaitable[operations_pb2.Operation]
    ]:

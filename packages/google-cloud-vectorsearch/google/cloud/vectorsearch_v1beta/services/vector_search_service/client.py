...
class VectorSearchServiceClient(metaclass=VectorSearchServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = VectorSearchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = VectorSearchServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = VectorSearchServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or VectorSearchServiceClient._get_api_endpoint(
        ...
        *,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.vectorsearch_v1beta.types.ImportDataObjectsResponse` Response for
                   [VectorSearchService.ImportDataObjects][google.cloud.vectorsearch.v1beta.VectorSearchService.ImportDataObjects].
    ...
    def export_data_objects(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_export_data_objects():
                # Create a client
                client = vectorsearch_v1beta.VectorSearchServiceClient()
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1beta.types.ExportDataObjectsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.vectorsearch_v1beta.types.ExportDataObjectsResponse`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_data_objects]

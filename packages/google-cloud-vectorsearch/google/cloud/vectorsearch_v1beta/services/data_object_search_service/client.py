...
from .transports.grpc import DataObjectSearchServiceGrpcTransport
from .transports.grpc_asyncio import DataObjectSearchServiceGrpcAsyncIOTransport
from .transports.rest import DataObjectSearchServiceRestTransport


class DataObjectSearchServiceClientMeta(type):
    """Metaclass for the DataObjectSearchService client.
    ...
    ) -> Type[DataObjectSearchServiceTransport]:
...
class DataObjectSearchServiceClient(metaclass=DataObjectSearchServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataObjectSearchServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DataObjectSearchServiceTransport:
        ...
        Returns:
            DataObjectSearchServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = DataObjectSearchServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DataObjectSearchServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataObjectSearchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DataObjectSearchServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DataObjectSearchServiceTransport, Callable[..., DataObjectSearchServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,DataObjectSearchServiceTransport,Callable[..., DataObjectSearchServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the DataObjectSearchServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DataObjectSearchServiceClient._read_environment_variables()
        self._client_cert_source = DataObjectSearchServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DataObjectSearchServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DataObjectSearchServiceTransport)
        if transport_provided:
            # transport is a DataObjectSearchServiceTransport instance.
            ...
            self._transport = cast(DataObjectSearchServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or DataObjectSearchServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DataObjectSearchServiceTransport], Callable[..., DataObjectSearchServiceTransport]] = (
                DataObjectSearchServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DataObjectSearchServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.vectorsearch_v1beta.DataObjectSearchServiceClient`.",
                    extra={
    ...
    def search_data_objects(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_search_data_objects():
                # Create a client
                client = vectorsearch_v1beta.DataObjectSearchServiceClient()

                # Initialize request argument(s)
                vector_search = vectorsearch_v1beta.VectorSearch()
                vector_search.vector.values = [0.657, 0.658]
                vector_search.search_field = "search_field_value"
                ...
                # Make the request
                page_result = client.search_data_objects(request=request)
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1beta.types.SearchDataObjectsRequest, dict]):
        ...
        if not isinstance(request, data_object_search_service.SearchDataObjectsRequest):
            request = data_object_search_service.SearchDataObjectsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_data_objects]
        ...
        response = pagers.SearchDataObjectsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_query_data_objects():
                ...
                # Make the request
                page_result = client.query_data_objects(request=request)
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1beta.types.QueryDataObjectsRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, data_object_search_service.QueryDataObjectsRequest):
            request = data_object_search_service.QueryDataObjectsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_data_objects]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.QueryDataObjectsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def aggregate_data_objects(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregate_data_objects():
                # Create a client
                client = vectorsearch_v1beta.DataObjectSearchServiceClient()
                ...
                # Make the request
                response = client.aggregate_data_objects(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.vectorsearch_v1beta.types.AggregateDataObjectsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.vectorsearch_v1beta.types.AggregateDataObjectsResponse:
                Response message for
                   [DataObjectSearchService.AggregateDataObjects][google.cloud.vectorsearch.v1beta.DataObjectSearchService.AggregateDataObjects].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.aggregate_data_objects]
    ...
    def batch_search_data_objects(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_batch_search_data_objects():
                # Create a client
                client = vectorsearch_v1beta.DataObjectSearchServiceClient()
        ...
        Args:
            request (Union[google.cloud.vectorsearch_v1beta.types.BatchSearchDataObjectsRequest, dict]):
        ...
        Returns:
            google.cloud.vectorsearch_v1beta.types.BatchSearchDataObjectsResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_search_data_objects]
    ...
    def __enter__(self) -> "DataObjectSearchServiceClient":
        return self
...
__all__ = ("DataObjectSearchServiceClient",)

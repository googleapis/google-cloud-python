...
__lazy_modules__ = {
    "google.cloud.vectorsearch_v1beta.services.data_object_search_service",
    "google.cloud.vectorsearch_v1beta.services.data_object_service",
    "google.cloud.vectorsearch_v1beta.services.vector_search_service",
    "google.cloud.vectorsearch_v1beta.types.common",
    "google.cloud.vectorsearch_v1beta.types.data_object",
    "google.cloud.vectorsearch_v1beta.types.data_object_search_service",
    "google.cloud.vectorsearch_v1beta.types.data_object_service",
    "google.cloud.vectorsearch_v1beta.types.embedding_config",
    "google.cloud.vectorsearch_v1beta.types.encryption_spec",
    "google.cloud.vectorsearch_v1beta.types.vectorsearch_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.vectorsearch_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.cloud.vectorsearch_v1beta")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.vectorsearch_v1beta"

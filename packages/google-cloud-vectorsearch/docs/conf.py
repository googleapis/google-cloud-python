...
##
# google-cloud-vectorsearch documentation build configuration file
#
...
project = "google-cloud-vectorsearch"
copyright = "2025, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-vectorsearch",
...
htmlhelp_basename = "google-cloud-vectorsearch-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-vectorsearch.tex",
        "google-cloud-vectorsearch Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-vectorsearch",
        "google-cloud-vectorsearch Library",
        "APIs",
    )
]

...
async def sample_create_data_object():
    # Create a client
    client = vectorsearch_v1beta.DataObjectServiceAsyncClient()
    ...
    # Make the request
    response = await client.create_data_object(request=request)

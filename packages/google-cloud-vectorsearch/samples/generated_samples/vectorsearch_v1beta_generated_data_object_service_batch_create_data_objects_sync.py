...
#
# Snippet for BatchCreateDataObjects
...
def sample_batch_create_data_objects():
    # Create a client
    client = vectorsearch_v1beta.DataObjectServiceClient()

    # Initialize request argument(s)
    requests = vectorsearch_v1beta.CreateDataObjectRequest()
    requests.parent = "parent_value"
    requests.data_object_id = "data_object_id_value"
    ...
    # Make the request
    response = client.batch_create_data_objects(request=request)

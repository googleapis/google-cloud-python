...
from google.cloud.vectorsearch_v1.services.data_object_search_service import (
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = DataObjectSearchServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (DataObjectSearchServiceClient, "grpc"),
        (DataObjectSearchServiceAsyncClient, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (transports.DataObjectSearchServiceGrpcTransport, "grpc"),
        (transports.DataObjectSearchServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_data_object_search_service_client_get_transport_class():
    transport = DataObjectSearchServiceClient.get_transport_class()
    ...
    assert transport == transports.DataObjectSearchServiceGrpcTransport
...
def test_data_object_search_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.vectorsearch_v1.services.data_object_search_service.transports.DataObjectSearchServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_search_data_objects(request_type, transport: str = "grpc"):
    ...
    assert isinstance(response, pagers.SearchDataObjectsPager)
    assert response.next_page_token == "next_page_token_value"


def test_search_data_objects_non_empty_request_with_auto_populated_field():
...
async def test_search_data_objects_async(request_type, transport: str = "grpc_asyncio"):
    ...
    with mock.patch.object(
        ...
        response = await client.search_data_objects(request)
...
@pytest.mark.asyncio
async def test_search_data_objects_field_headers_async():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_search_data_objects_pager(transport_name: str = "grpc"):
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_search_data_objects_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.search_data_objects(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_search_data_objects_async_pager():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_data_objects(
            request={},
        )
...
@pytest.mark.asyncio
async def test_search_data_objects_async_pages():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.search_data_objects(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_query_data_objects(request_type, transport: str = "grpc"):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.QueryDataObjectsPager)
    assert response.next_page_token == "next_page_token_value"


def test_query_data_objects_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_query_data_objects_async(request_type, transport: str = "grpc_asyncio"):
    ...
    with mock.patch.object(
        ...
        response = await client.query_data_objects(request)
...
@pytest.mark.asyncio
async def test_query_data_objects_field_headers_async():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_query_data_objects_pager(transport_name: str = "grpc"):
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
def test_query_data_objects_pages(transport_name: str = "grpc"):
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.query_data_objects(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_query_data_objects_async_pager():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.query_data_objects(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        assert str(async_pager).startswith(f"{async_pager.__class__.__name__}<")
        ...
        assert len(responses) == 6
        assert all(isinstance(i, data_object.DataObject) for i in responses)


@pytest.mark.asyncio
async def test_query_data_objects_async_pages():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.query_data_objects(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_aggregate_data_objects_field_headers_async():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_batch_search_data_objects_field_headers_async():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_search_data_objects_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataObjectSearchServiceClient(
...
def test_search_data_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSearchDataObjects,
    ...
    return_value = data_object_search_service.SearchDataObjectsResponse()
...
def test_search_data_objects_rest_pager(transport: str = "rest"):
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_data_objects_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataObjectSearchServiceClient(
...
def test_query_data_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseQueryDataObjects,
    ...
    # Designate an appropriate value for the returned response.
    return_value = data_object_search_service.QueryDataObjectsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_query_data_objects_rest_pager(transport: str = "rest"):
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pages = list(client.query_data_objects(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_aggregate_data_objects_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataObjectSearchServiceClient(
...
def test_aggregate_data_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAggregateDataObjects,
    ...
    # Designate an appropriate value for the returned response.
    return_value = data_object_search_service.AggregateDataObjectsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_batch_search_data_objects_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DataObjectSearchServiceClient(
...
def test_batch_search_data_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchSearchDataObjects,
    ...
    # Designate an appropriate value for the returned response.
    return_value = data_object_search_service.BatchSearchDataObjectsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_transport_get_channel():
    ...
    transport = transports.DataObjectSearchServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_search_data_objects_empty_call_grpc():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_data_objects_empty_call_grpc():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_aggregate_data_objects_empty_call_grpc():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_search_data_objects_empty_call_grpc():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_data_objects_empty_call_grpc_asyncio():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.search_data_objects(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_query_data_objects_empty_call_grpc_asyncio():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.query_data_objects(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_aggregate_data_objects_empty_call_grpc_asyncio():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_search_data_objects_empty_call_grpc_asyncio():
    client = DataObjectSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_data_objects_empty_call_rest():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_data_objects_empty_call_rest():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_aggregate_data_objects_empty_call_rest():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_search_data_objects_empty_call_rest():
    client = DataObjectSearchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_data_object_search_service_base_transport_error():
...
def test_data_object_search_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.vectorsearch_v1.services.data_object_search_service.transports.DataObjectSearchServiceTransport.__init__"
    ) as Transport:
...
def test_data_object_search_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.vectorsearch_v1.services.data_object_search_service.transports.DataObjectSearchServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_data_object_search_service_base_transport_with_adc():
...
def test_data_object_search_service_transport_auth_adc(transport_class):
...
def test_data_object_search_service_transport_auth_gdch_credentials(transport_class):
...
def test_data_object_search_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = DataObjectSearchServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = DataObjectSearchServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.search_data_objects._session
    session2 = client2.transport.search_data_objects._session
    assert session1 != session2
    session1 = client1.transport.query_data_objects._session
    session2 = client2.transport.query_data_objects._session
    assert session1 != session2
    session1 = client1.transport.aggregate_data_objects._session
    session2 = client2.transport.aggregate_data_objects._session
    assert session1 != session2
    session1 = client1.transport.batch_search_data_objects._session
    session2 = client2.transport.batch_search_data_objects._session
    assert session1 != session2


def test_data_object_search_service_grpc_transport_channel():
...
def test_data_object_search_service_grpc_asyncio_transport_channel():
...
def test_parse_collection_path():
    ...
    path = DataObjectSearchServiceClient.collection_path(**expected)

    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_collection_path(path)
    assert expected == actual


def test_data_object_path():
    project = "cuttlefish"
    location = "mussel"
    collection = "winkle"
    dataObject = "nautilus"
    expected = "projects/{project}/locations/{location}/collections/{collection}/dataObjects/{dataObject}".format(
        project=project,
        location=location,
        collection=collection,
...
def test_parse_data_object_path():
    expected = {
        "project": "scallop",
        "location": "abalone",
        "collection": "squid",
    ...
    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_data_object_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = DataObjectSearchServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = DataObjectSearchServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = DataObjectSearchServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = DataObjectSearchServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = DataObjectSearchServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = DataObjectSearchServiceClient.parse_common_location_path(path)
    assert expected == actual

...
from google.cloud.vectorsearch_v1beta.types import common, embedding_config, vectorsearch_service
...
def test__get_default_mtls_endpoint():
    ...
    assert VectorSearchServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert VectorSearchServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert VectorSearchServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert VectorSearchServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert VectorSearchServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert VectorSearchServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert VectorSearchServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert VectorSearchServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert VectorSearchServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert VectorSearchServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert VectorSearchServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert VectorSearchServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert VectorSearchServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert VectorSearchServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(VectorSearchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VectorSearchServiceClient))
@mock.patch.object(VectorSearchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VectorSearchServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VectorSearchServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VectorSearchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = VectorSearchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert VectorSearchServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        VectorSearchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == VectorSearchServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert VectorSearchServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert VectorSearchServiceClient._get_api_endpoint(None, None, default_universe, "always") == VectorSearchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        VectorSearchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == VectorSearchServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert VectorSearchServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert VectorSearchServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        VectorSearchServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert VectorSearchServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert VectorSearchServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert VectorSearchServiceClient._get_universe_domain(None, None) == VectorSearchServiceClient._DEFAULT_UNIVERSE
...
def test_vector_search_service_client_from_service_account_info(client_class, transport_name):
...
def test_vector_search_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_vector_search_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (VectorSearchServiceClient, transports.VectorSearchServiceGrpcTransport, "grpc"),
        (VectorSearchServiceAsyncClient, transports.VectorSearchServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (VectorSearchServiceClient, transports.VectorSearchServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(VectorSearchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VectorSearchServiceClient))
@mock.patch.object(VectorSearchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VectorSearchServiceAsyncClient))
def test_vector_search_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (VectorSearchServiceClient, transports.VectorSearchServiceGrpcTransport, "grpc", "true"),
        (VectorSearchServiceAsyncClient, transports.VectorSearchServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (VectorSearchServiceClient, transports.VectorSearchServiceGrpcTransport, "grpc", "false"),
        (VectorSearchServiceAsyncClient, transports.VectorSearchServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (VectorSearchServiceClient, transports.VectorSearchServiceRestTransport, "rest", "true"),
        (VectorSearchServiceClient, transports.VectorSearchServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(VectorSearchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VectorSearchServiceClient))
@mock.patch.object(VectorSearchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VectorSearchServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_vector_search_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [VectorSearchServiceClient, VectorSearchServiceAsyncClient])
@mock.patch.object(VectorSearchServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VectorSearchServiceClient))
@mock.patch.object(VectorSearchServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VectorSearchServiceAsyncClient))
...
def test_vector_search_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (VectorSearchServiceClient, transports.VectorSearchServiceGrpcTransport, "grpc", grpc_helpers),
        (VectorSearchServiceAsyncClient, transports.VectorSearchServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (VectorSearchServiceClient, transports.VectorSearchServiceRestTransport, "rest", None),
    ],
)
def test_vector_search_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_vector_search_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.vectorsearch_v1beta.services.vector_search_service.transports.VectorSearchServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = VectorSearchServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_vector_search_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_collections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_collections] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_collections_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_collections in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_collections] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_collections_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.ListCollectionsRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_collections_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_collections), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(vectorsearch_service.ListCollectionsResponse())
        await client.list_collections(request)
...
async def test_list_collections_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_collections), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            vectorsearch_service.ListCollectionsResponse(
                collections=[
...
async def test_list_collections_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_collections), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_collections(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_collection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VectorSearchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_collection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_collection] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_collection_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.GetCollectionRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_collection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_collection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_collection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VectorSearchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_collection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_collection] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_collection_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.CreateCollectionRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_collection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_collection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_collection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VectorSearchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_collection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_collection] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_collection_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.UpdateCollectionRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_collection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_collection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_collection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VectorSearchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_collection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_collection] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_collection_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.DeleteCollectionRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_indexes_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.ListIndexesRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_indexes_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_indexes), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(vectorsearch_service.ListIndexesResponse())
        await client.list_indexes(request)
...
async def test_list_indexes_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_indexes), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            vectorsearch_service.ListIndexesResponse(
                indexes=[
...
async def test_list_indexes_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_indexes), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_indexes(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_index_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.GetIndexRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_index_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_index), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(vectorsearch_service.Index())
        await client.get_index(request)
...
@pytest.mark.asyncio
async def test_create_index_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.CreateIndexRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_index_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.DeleteIndexRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_import_data_objects(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.import_data_objects), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_import_data_objects_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_data_objects in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_data_objects] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_data_objects_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VectorSearchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_data_objects in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_data_objects] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_data_objects_async(transport: str = "grpc_asyncio", request_type=vectorsearch_service.ImportDataObjectsRequest):
    client = VectorSearchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_collections_rest_required_fields(request_type=vectorsearch_service.ListCollectionsRequest):
...
def test_list_collections_rest_unset_required_fields():
    transport = transports.VectorSearchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_collections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/collections" % client.transport._host, args[1])
...
def test_list_collections_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(vectorsearch_service.ListCollectionsResponse.to_json(x) for x in response)
...
def test_get_collection_rest_required_fields(request_type=vectorsearch_service.GetCollectionRequest):
    transport_class = transports.VectorSearchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_collection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_collection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/collections/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/collections/*}" % client.transport._host, args[1])
...
def test_create_collection_rest_required_fields(request_type=vectorsearch_service.CreateCollectionRequest):
    transport_class = transports.VectorSearchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_collection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_collection_rest_required_fields(request_type=vectorsearch_service.UpdateCollectionRequest):
    transport_class = transports.VectorSearchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_collection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_collection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"collection": {"name": "projects/sample1/locations/sample2/collections/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{collection.name=projects/*/locations/*/collections/*}" % client.transport._host, args[1])
...
def test_delete_collection_rest_required_fields(request_type=vectorsearch_service.DeleteCollectionRequest):
    transport_class = transports.VectorSearchServiceRestTransport
...
def test_list_indexes_rest_required_fields(request_type=vectorsearch_service.ListIndexesRequest):
    transport_class = transports.VectorSearchServiceRestTransport
...
def test_list_indexes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/collections/*}/indexes" % client.transport._host, args[1])
...
def test_list_indexes_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(vectorsearch_service.ListIndexesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_index_rest_required_fields(request_type=vectorsearch_service.GetIndexRequest):
    transport_class = transports.VectorSearchServiceRestTransport
...
def test_get_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/collections/sample3/indexes/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/collections/*/indexes/*}" % client.transport._host, args[1])
...
def test_create_index_rest_required_fields(request_type=vectorsearch_service.CreateIndexRequest):
    transport_class = transports.VectorSearchServiceRestTransport
...
def test_delete_index_rest_required_fields(request_type=vectorsearch_service.DeleteIndexRequest):
    transport_class = transports.VectorSearchServiceRestTransport
...
def test_import_data_objects_rest_required_fields(request_type=vectorsearch_service.ImportDataObjectsRequest):
    transport_class = transports.VectorSearchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_data_objects._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = VectorSearchServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = VectorSearchServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = VectorSearchServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = VectorSearchServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = VectorSearchServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_collections_rest_bad_request(request_type=vectorsearch_service.ListCollectionsRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_collections_rest_interceptors(null_interceptor):
    transport = transports.VectorSearchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.VectorSearchServiceRestInterceptor(),
    )
    client = VectorSearchServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VectorSearchServiceRestInterceptor, "post_list_collections") as post, mock.patch.object(
        transports.VectorSearchServiceRestInterceptor, "post_list_collections_with_metadata"
        ...
        pb_message = vectorsearch_service.ListCollectionsRequest.pb(vectorsearch_service.ListCollectionsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vectorsearch_service.ListCollectionsResponse.to_json(vectorsearch_service.ListCollectionsResponse())
        ...
        post_with_metadata.return_value = vectorsearch_service.ListCollectionsResponse(), metadata
...
def test_get_collection_rest_bad_request(request_type=vectorsearch_service.GetCollectionRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_collection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VectorSearchServiceRestInterceptor, "post_get_collection") as post, mock.patch.object(
        transports.VectorSearchServiceRestInterceptor, "post_get_collection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.GetCollectionRequest.pb(vectorsearch_service.GetCollectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vectorsearch_service.Collection.to_json(vectorsearch_service.Collection())
        req.return_value.content = return_value
...
def test_create_collection_rest_bad_request(request_type=vectorsearch_service.CreateCollectionRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_collection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VectorSearchServiceRestInterceptor, "post_create_collection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.CreateCollectionRequest.pb(vectorsearch_service.CreateCollectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_collection_rest_bad_request(request_type=vectorsearch_service.UpdateCollectionRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"collection": {"name": "projects/sample1/locations/sample2/collections/sample3"}}
    request = request_type(**request_init)
...
def test_update_collection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VectorSearchServiceRestInterceptor, "post_update_collection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.UpdateCollectionRequest.pb(vectorsearch_service.UpdateCollectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_collection_rest_bad_request(request_type=vectorsearch_service.DeleteCollectionRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/collections/sample3"}
    request = request_type(**request_init)
...
def test_delete_collection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VectorSearchServiceRestInterceptor, "post_delete_collection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.DeleteCollectionRequest.pb(vectorsearch_service.DeleteCollectionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_indexes_rest_bad_request(request_type=vectorsearch_service.ListIndexesRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_indexes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VectorSearchServiceRestInterceptor, "post_list_indexes") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.ListIndexesRequest.pb(vectorsearch_service.ListIndexesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vectorsearch_service.ListIndexesResponse.to_json(vectorsearch_service.ListIndexesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = vectorsearch_service.ListIndexesResponse(), metadata
...
def test_get_index_rest_bad_request(request_type=vectorsearch_service.GetIndexRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/collections/sample3/indexes/sample4"}
    request = request_type(**request_init)
...
def test_get_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VectorSearchServiceRestInterceptor, "post_get_index") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.GetIndexRequest.pb(vectorsearch_service.GetIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_index_rest_bad_request(request_type=vectorsearch_service.CreateIndexRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/collections/sample3"}
    request = request_type(**request_init)
...
def test_create_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.CreateIndexRequest.pb(vectorsearch_service.CreateIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_index_rest_bad_request(request_type=vectorsearch_service.DeleteIndexRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/collections/sample3/indexes/sample4"}
    request = request_type(**request_init)
...
def test_delete_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.DeleteIndexRequest.pb(vectorsearch_service.DeleteIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_import_data_objects_rest_bad_request(request_type=vectorsearch_service.ImportDataObjectsRequest):
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/collections/sample3"}
    request = request_type(**request_init)
...
def test_import_data_objects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VectorSearchServiceRestInterceptor, "post_import_data_objects_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vectorsearch_service.ImportDataObjectsRequest.pb(vectorsearch_service.ImportDataObjectsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_vector_search_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.VectorSearchServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_vector_search_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.vectorsearch_v1beta.services.vector_search_service.transports.VectorSearchServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.VectorSearchServiceGrpcTransport, grpc_helpers), (transports.VectorSearchServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.VectorSearchServiceGrpcTransport, transports.VectorSearchServiceGrpcAsyncIOTransport])
def test_vector_search_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_vector_search_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.VectorSearchServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.VectorSearchServiceGrpcTransport, transports.VectorSearchServiceGrpcAsyncIOTransport])
def test_vector_search_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.VectorSearchServiceTransport, "_prep_wrapped_messages") as prep:
        client = VectorSearchServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_location_field_headers():
    client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
def test_client_ctx():
    ...
    for transport in transports:
        client = VectorSearchServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VectorSearchServiceAsyncClient, transports.VectorSearchServiceGrpcAsyncIOTransport),
    ],
)

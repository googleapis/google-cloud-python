...
def test_list_collections_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListCollections,
...
def test_list_collections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/collections"
...
def test_get_collection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetCollection,
...
def test_get_collection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/collections/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_collection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateCollection,
...
def test_update_collection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateCollection,
...
def test_update_collection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{collection.name=projects/*/locations/*/collections/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_collection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteCollection,
...
def test_list_indexes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/collections/*}/indexes"
            % client.transport._host,
            args[1],
        )
...
def test_get_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/collections/*/indexes/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{index.name=projects/*/locations/*/collections/*/indexes/*}"
            % client.transport._host,
            args[1],
        )
...
def test_import_data_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseImportDataObjects,
...
def test_export_data_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseExportDataObjects,
...
def test_vector_search_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.vectorsearch_v1beta.services.vector_search_service.transports.VectorSearchServiceTransport.__init__"
    ) as Transport:

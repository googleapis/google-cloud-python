...
with open(os.path.join(package_root, "google/cloud/vectorsearch/gapic_version.py")) as fp:
...
extras = {}
url = "https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-vectorsearch"

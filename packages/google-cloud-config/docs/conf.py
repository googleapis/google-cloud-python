...
##
# google-cloud-config documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-config",
...
htmlhelp_basename = "google-cloud-config-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-config.tex",
        "google-cloud-config Documentation",
        author,
        "manual",
    )
]

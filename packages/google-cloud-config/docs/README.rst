Python Client for Infrastructure Manager
========================================

|preview| |pypi| |versions|

`Infrastructure Manager`_: Creates and manages Google Cloud Platform resources and infrastructure.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-config.svg
   :target: https://pypi.org/project/google-cloud-config/
.. _Infrastructure Manager: https://cloud.google.com/infrastructure-manager/
...
3. `Enable the Infrastructure Manager.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Infrastructure Manager.:  https://cloud.google.com/infrastructure-manager/
...
-  Read the `Client Library Documentation`_ for Infrastructure Manager
   to see other available methods on the client.
-  Read the `Infrastructure Manager Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Infrastructure Manager Product documentation:  https://cloud.google.com/infrastructure-manager/

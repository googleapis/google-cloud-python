...
class ConfigClient(metaclass=ConfigClientMeta):
    ...
    def parse_preview_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_resource_change_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)/resourceChanges/(?P<resource_change>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_resource_drift_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)/resourceDrifts/(?P<resource_drift>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_revision_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deployments/(?P<deployment>.+?)/revisions/(?P<revision>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_terraform_version_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/terraformVersions/(?P<terraform_version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def export_deployment_statefile(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_deployment_statefile]
    ...
    def export_revision_statefile(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_revision_statefile]

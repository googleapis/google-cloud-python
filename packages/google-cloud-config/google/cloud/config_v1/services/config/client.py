...
from google.cloud.config_v1._compat import (
    get_api_endpoint,
...
class ConfigClient(metaclass=ConfigClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "config.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def auto_migration_config_path(
        project: str,
        location: str,
    ) -> str:
        """Returns a fully-qualified auto_migration_config string."""
        return "projects/{project}/locations/{location}/autoMigrationConfig".format(
            project=project,
            location=location,
        )

    @staticmethod
    def parse_auto_migration_config_path(path: str) -> Dict[str, str]:
        """Parses a auto_migration_config path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/autoMigrationConfig$",
            path,
        )
    ...
    def preview_path(
        ...
        return "projects/{project}/locations/{location}/previews/{preview}".format(
            project=project,
            location=location,
            preview=preview,
        )
    ...
    @staticmethod
    def parse_preview_path(path: str) -> Dict[str, str]:
        """Parses a preview path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def resource_path(
        ...
        return "projects/{project}/locations/{location}/deployments/{deployment}/revisions/{revision}/resources/{resource}".format(
            project=project,
            location=location,
            deployment=deployment,
            revision=revision,
    ...
    def parse_resource_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deployments/(?P<deployment>.+?)/revisions/(?P<revision>.+?)/resources/(?P<resource>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def resource_change_path(
        project: str,
        location: str,
        preview: str,
        resource_change: str,
        ...
        return "projects/{project}/locations/{location}/previews/{preview}/resourceChanges/{resource_change}".format(
            project=project,
            location=location,
            preview=preview,
    ...
    @staticmethod
    def parse_resource_change_path(path: str) -> Dict[str, str]:
        """Parses a resource_change path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)/resourceChanges/(?P<resource_change>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def resource_drift_path(
        project: str,
        location: str,
        preview: str,
        resource_drift: str,
        ...
        return "projects/{project}/locations/{location}/previews/{preview}/resourceDrifts/{resource_drift}".format(
            project=project,
            location=location,
            preview=preview,
    ...
    @staticmethod
    def parse_resource_drift_path(path: str) -> Dict[str, str]:
        """Parses a resource_drift path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/previews/(?P<preview>.+?)/resourceDrifts/(?P<resource_drift>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def revision_path(
        ...
        return "projects/{project}/locations/{location}/deployments/{deployment}/revisions/{revision}".format(
            project=project,
            location=location,
            deployment=deployment,
            revision=revision,
    ...
    def parse_revision_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deployments/(?P<deployment>.+?)/revisions/(?P<revision>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.config_v1.ConfigClient`.",
                    extra={
    ...
    def update_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.UpdateDeploymentRequest, dict]):
                The request object.
            deployment (google.cloud.config_v1.types.Deployment):
                Required.
    ...
    def list_revisions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ListRevisionsRequest, dict]):
    ...
    def get_revision(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.GetRevisionRequest, dict]):
    ...
    def get_resource(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.GetResourceRequest, dict]):
    ...
    def list_resources(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ListResourcesRequest, dict]):
    ...
    def export_deployment_statefile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ExportDeploymentStatefileRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.export_deployment_statefile
        ]
    ...
    def export_revision_statefile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ExportRevisionStatefileRequest, dict]):
                The request object. A request to export a state file
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.export_revision_statefile
        ]
    ...
    def import_statefile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ImportStatefileRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_statefile]
    ...
    def delete_statefile(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.DeleteStatefileRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_statefile]
    ...
    def lock_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.LockDeploymentRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.lock_deployment]
    ...
    def unlock_deployment(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.UnlockDeploymentRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.unlock_deployment]
    ...
    def export_lock_info(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ExportLockInfoRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_lock_info]
    ...
    def create_preview(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_preview]
    ...
    def get_preview(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.GetPreviewRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_preview]
    ...
    def list_previews(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ListPreviewsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_previews]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListPreviewsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def delete_preview(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_preview]
    ...
    def export_preview_result(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_export_preview_result():
                # Create a client
                client = config_v1.ConfigClient()
                ...
                # Make the request
                response = client.export_preview_result(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.config_v1.types.ExportPreviewResultRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_preview_result]
    ...
    def list_resource_changes(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListResourceChangesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_resource_changes():
                # Create a client
                client = config_v1.ConfigClient()
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ListResourceChangesRequest, dict]):
                The request object. The request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_resource_changes]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListResourceChangesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_resource_change(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_resource_change():
                # Create a client
                client = config_v1.ConfigClient()
                ...
                # Make the request
                response = client.get_resource_change(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.config_v1.types.GetResourceChangeRequest, dict]):
                The request object. The request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_resource_change]
    ...
    def list_resource_drifts(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListResourceDriftsPager:
        ...
        Args:
            request (Union[google.cloud.config_v1.types.ListResourceDriftsRequest, dict]):
                The request object. The request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_resource_drifts]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListResourceDriftsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_resource_drift(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.config_v1.types.GetResourceDriftRequest, dict]):
                The request object. The request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_resource_drift]
    ...
    def get_auto_migration_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_auto_migration_config():
                # Create a client
                client = config_v1.ConfigClient()
                ...
                # Make the request
                response = client.get_auto_migration_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.config_v1.types.GetAutoMigrationConfigRequest, dict]):
                The request object. The request message for the
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_auto_migration_config
        ]
    ...
    def update_auto_migration_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_auto_migration_config():
                # Create a client
                client = config_v1.ConfigClient()
        ...
        Args:
            request (Union[google.cloud.config_v1.types.UpdateAutoMigrationConfigRequest, dict]):
                The request object. The request message for the
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_auto_migration_config
        ]

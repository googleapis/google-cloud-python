...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.config_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.config_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.config_v1"

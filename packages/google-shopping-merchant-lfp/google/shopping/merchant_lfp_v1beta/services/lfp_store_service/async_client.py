...
class LfpStoreServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = LfpStoreServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(LfpStoreServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            LfpStoreServiceAsyncClient: The constructed client.
        """
        sa_file_func = LfpStoreServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(LfpStoreServiceAsyncClient, filename, *args, **kwargs)

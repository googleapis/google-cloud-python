...
class LfpStoreServiceGrpcAsyncIOTransport(LfpStoreServiceTransport):
    ...
    def get_lfp_store(
        self,
    ) -> Callable[[lfpstore.GetLfpStoreRequest], Awaitable[lfpstore.LfpStore]]:
    ...
    def insert_lfp_store(
        self,
    ) -> Callable[[lfpstore.InsertLfpStoreRequest], Awaitable[lfpstore.LfpStore]]:
    ...
    def delete_lfp_store(
        self,
    ) -> Callable[[lfpstore.DeleteLfpStoreRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def list_lfp_stores(
        ...
        [lfpstore.ListLfpStoresRequest], Awaitable[lfpstore.ListLfpStoresResponse]
    ]:

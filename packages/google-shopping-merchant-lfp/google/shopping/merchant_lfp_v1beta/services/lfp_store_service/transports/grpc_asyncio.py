...
class LfpStoreServiceGrpcAsyncIOTransport(LfpStoreServiceTransport):
    ...
    @property
    def get_lfp_store(self) -> Callable[[lfpstore.GetLfpStoreRequest], Awaitable[lfpstore.LfpStore]]:
    ...
    @property
    def insert_lfp_store(self) -> Callable[[lfpstore.InsertLfpStoreRequest], Awaitable[lfpstore.LfpStore]]:
    ...
    @property
    def delete_lfp_store(self) -> Callable[[lfpstore.DeleteLfpStoreRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_lfp_stores(self) -> Callable[[lfpstore.ListLfpStoresRequest], Awaitable[lfpstore.ListLfpStoresResponse]]:

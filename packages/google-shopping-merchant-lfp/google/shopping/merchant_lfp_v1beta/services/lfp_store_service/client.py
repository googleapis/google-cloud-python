...
class LfpStoreServiceClient(metaclass=LfpStoreServiceClientMeta):
    ...
    def parse_lfp_store_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/lfpStores/(?P<target_merchant>.+?)~(?P<store_code>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = LfpStoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            LfpStoreServiceClient._read_environment_variables()
        )
        self._client_cert_source = LfpStoreServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = LfpStoreServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or LfpStoreServiceClient._get_api_endpoint(

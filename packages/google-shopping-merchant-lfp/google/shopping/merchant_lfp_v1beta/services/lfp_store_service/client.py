...
from .transports.grpc import LfpStoreServiceGrpcTransport
from .transports.grpc_asyncio import LfpStoreServiceGrpcAsyncIOTransport
from .transports.rest import LfpStoreServiceRestTransport


class LfpStoreServiceClientMeta(type):
    """Metaclass for the LfpStoreService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[LfpStoreServiceTransport]]
    _transport_registry["grpc"] = LfpStoreServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = LfpStoreServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = LfpStoreServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[LfpStoreServiceTransport]:
...
class LfpStoreServiceClient(metaclass=LfpStoreServiceClientMeta):
    """Service for a `LFP
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            LfpStoreServiceClient: The constructed client.
        """
    ...
    def transport(self) -> LfpStoreServiceTransport:
        ...
        Returns:
            LfpStoreServiceTransport: The transport used by the client
                instance.
        """
    ...
    def lfp_store_path(
        ...
        """Returns a fully-qualified lfp_store string."""
        return "accounts/{account}/lfpStores/{target_merchant}~{store_code}".format(
            account=account,
    ...
    @staticmethod
    def parse_lfp_store_path(path: str) -> Dict[str, str]:
        """Parses a lfp_store path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/lfpStores/(?P<target_merchant>.+?)~(?P<store_code>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = LfpStoreServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LfpStoreServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = LfpStoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = LfpStoreServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, LfpStoreServiceTransport, Callable[..., LfpStoreServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LfpStoreServiceClient._read_environment_variables()
        self._client_cert_source = LfpStoreServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LfpStoreServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, LfpStoreServiceTransport)
        if transport_provided:
            # transport is a LfpStoreServiceTransport instance.
            ...
            self._transport = cast(LfpStoreServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or LfpStoreServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LfpStoreServiceTransport], Callable[..., LfpStoreServiceTransport]] = (
                LfpStoreServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.lfp_v1beta.LfpStoreServiceClient`.",
                    extra={
    ...
    def get_lfp_store(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_lfp_store]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert_lfp_store():
                ...
                # Make the request
                response = client.insert_lfp_store(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_lfp_v1beta.types.InsertLfpStoreRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, lfp_store]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.insert_lfp_store]
    ...
    def delete_lfp_store(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_lfp_v1beta.types.DeleteLfpStoreRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_lfp_store]
    ...
    def list_lfp_stores(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_lfp_v1beta.types.ListLfpStoresRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_lfp_v1beta.services.lfp_store_service.pagers.ListLfpStoresPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_lfp_stores]
        ...
        response = pagers.ListLfpStoresPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "LfpStoreServiceClient":
        return self

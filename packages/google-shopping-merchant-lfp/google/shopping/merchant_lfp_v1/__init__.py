...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.shopping.merchant_lfp_v1")  # type: ignore
    api_core.check_dependency_versions("google.shopping.merchant_lfp_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.shopping.merchant_lfp_v1"

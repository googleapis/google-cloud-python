...
from .grpc import LfpSaleServiceGrpcTransport
    ...
    async def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.shopping.merchant.lfp.v1.LfpSaleService",
...
class LfpSaleServiceGrpcAsyncIOTransport(LfpSaleServiceTransport):
    """gRPC AsyncIO backend transport for LfpSaleService.
    ...
    @property
    def insert_lfp_sale(self) -> Callable[[lfpsale.InsertLfpSaleRequest], Awaitable[lfpsale.LfpSale]]:
        ...
        if "insert_lfp_sale" not in self._stubs:
            self._stubs["insert_lfp_sale"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.lfp.v1.LfpSaleService/InsertLfpSale",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.insert_lfp_sale: self._wrap_method(

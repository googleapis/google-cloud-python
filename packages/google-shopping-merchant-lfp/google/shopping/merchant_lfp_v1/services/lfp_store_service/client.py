...
from google.shopping.merchant_lfp_v1.services.lfp_store_service import pagers
...
class LfpStoreServiceClient(metaclass=LfpStoreServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.lfp_v1.LfpStoreServiceClient`.",
                    extra={
    ...
    def get_lfp_store(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_lfp_v1.types.GetLfpStoreRequest, dict]):
    ...
    def insert_lfp_store(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_lfp_v1.types.InsertLfpStoreRequest, dict]):
    ...
    def delete_lfp_store(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_lfp_v1.types.DeleteLfpStoreRequest, dict]):
                The request object. Request message for the
    ...
    def list_lfp_stores(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_lfp_v1.types.ListLfpStoresRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_lfp_v1.services.lfp_store_service.pagers.ListLfpStoresPager:

...
class LfpStoreServiceGrpcTransport(LfpStoreServiceTransport):
    """gRPC backend transport for LfpStoreService.
    ...
    def get_lfp_store(
        ...
        r"""Return a callable for the get lfp store method over gRPC.

        Retrieves information about a store.

        Returns:
            Callable[[~.GetLfpStoreRequest],
                    ~.LfpStore]:
        ...
        if "get_lfp_store" not in self._stubs:
            self._stubs["get_lfp_store"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.lfp.v1.LfpStoreService/GetLfpStore",
                request_serializer=lfpstore.GetLfpStoreRequest.serialize,
                response_deserializer=lfpstore.LfpStore.deserialize,
            )
        return self._stubs["get_lfp_store"]

    @property
    def insert_lfp_store(
        self,
    ) -> Callable[[lfpstore.InsertLfpStoreRequest], lfpstore.LfpStore]:
        r"""Return a callable for the insert lfp store method over gRPC.

        Inserts a store for the target merchant. If the store
        with the same store code already exists, it will be
        replaced.

        Returns:
            Callable[[~.InsertLfpStoreRequest],
                    ~.LfpStore]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "insert_lfp_store" not in self._stubs:
            self._stubs["insert_lfp_store"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.lfp.v1.LfpStoreService/InsertLfpStore",
                request_serializer=lfpstore.InsertLfpStoreRequest.serialize,
                response_deserializer=lfpstore.LfpStore.deserialize,
            )
        return self._stubs["insert_lfp_store"]

    @property
    def delete_lfp_store(
        self,
    ) -> Callable[[lfpstore.DeleteLfpStoreRequest], empty_pb2.Empty]:
        r"""Return a callable for the delete lfp store method over gRPC.

        Deletes a store for a target merchant.

        Returns:
            Callable[[~.DeleteLfpStoreRequest],
                    ~.Empty]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if "delete_lfp_store" not in self._stubs:
            self._stubs["delete_lfp_store"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.lfp.v1.LfpStoreService/DeleteLfpStore",
                request_serializer=lfpstore.DeleteLfpStoreRequest.serialize,
                response_deserializer=empty_pb2.Empty.FromString,
            )
        return self._stubs["delete_lfp_store"]

    @property
    def list_lfp_stores(
        self,
    ) -> Callable[[lfpstore.ListLfpStoresRequest], lfpstore.ListLfpStoresResponse]:
        r"""Return a callable for the list lfp stores method over gRPC.

        Lists the stores of the target merchant, specified by the filter
        in ``ListLfpStoresRequest``.

        Returns:
            Callable[[~.ListLfpStoresRequest],
        ...
        if "list_lfp_stores" not in self._stubs:
            self._stubs["list_lfp_stores"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.lfp.v1.LfpStoreService/ListLfpStores",
...
__all__ = ("LfpStoreServiceGrpcTransport",)

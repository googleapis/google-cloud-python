...
class LfpStoreServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.shopping.merchant.lfp_v1.LfpStoreServiceAsyncClient`.",
                extra={
    ...
    async def get_lfp_store(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_lfp_v1.types.GetLfpStoreRequest, dict]]):
    ...
    async def insert_lfp_store(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_lfp_v1.types.InsertLfpStoreRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lfp_store (:class:`google.shopping.merchant_lfp_v1.types.LfpStore`):
    ...
    async def delete_lfp_store(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_lfp_v1.types.DeleteLfpStoreRequest, dict]]):
                The request object. Request message for the
    ...
    async def list_lfp_stores(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_lfp_v1.types.ListLfpStoresRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_lfp_v1.services.lfp_store_service.pagers.ListLfpStoresAsyncPager:

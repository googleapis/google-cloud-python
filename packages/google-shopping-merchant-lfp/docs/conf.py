...
##
# google-shopping-merchant-lfp documentation build configuration file
#
...
project = "google-shopping-merchant-lfp"
copyright = "2025, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Shopping Client Libraries for google-shopping-merchant-lfp",
...
htmlhelp_basename = "google-shopping-merchant-lfp-doc"
...
latex_documents = [
    (
        root_doc,
        "google-shopping-merchant-lfp.tex",
        "google-shopping-merchant-lfp Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-shopping-merchant-lfp",
        "google-shopping-merchant-lfp Library",
        "APIs",
    )
]

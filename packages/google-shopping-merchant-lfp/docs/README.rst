Python Client for Shopping Merchant LFP
=======================================

|stable| |pypi| |versions|

`Shopping Merchant LFP`_: Programmatically manage your Merchant Center Accounts.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-shopping-merchant-lfp.svg
   :target: https://pypi.org/project/google-shopping-merchant-lfp/
.. _Shopping Merchant LFP: https://developers.google.com/merchant/api
...
3. `Enable the Shopping Merchant LFP.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Shopping Merchant LFP.:  https://developers.google.com/merchant/api
...
-  Read the `Client Library Documentation`_ for Shopping Merchant LFP
   to see other available methods on the client.
-  Read the `Shopping Merchant LFP Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Shopping Merchant LFP Product documentation:  https://developers.google.com/merchant/api

...
class CreateLockRequest(proto.Message):
...
class DeleteLockRequest(proto.Message):
    r"""Request message for the DeleteLock method.
...
class CheckLockRequest(proto.Message):
    r"""Request message for the CheckLock method.
...
class ListLocksRequest(proto.Message):
    r"""Request message for the ListLocks method.
...
class ListLocksResponse(proto.Message):
    ...
    locks: MutableSequence["Lock"] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message="Lock",
    )

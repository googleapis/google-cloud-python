...
class bigquery_biglakeCallTransformer(cst.CSTTransformer):
    CTRL_PARAMS: Tuple[str] = ('retry', 'timeout', 'metadata')
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'check_lock': ('name', ),
        'create_catalog': ('parent', 'catalog', 'catalog_id', ),
        'create_database': ('parent', 'database', 'database_id', ),
        'create_lock': ('parent', 'lock', ),
        'create_table': ('parent', 'table', 'table_id', ),
        'delete_catalog': ('name', ),
...
def fix_files(
    ...
    *,
    transformer=bigquery_biglakeCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the bigquery_biglake client library.

...
from google.cloud.bigquery_biglake_v1.services.metastore_service import MetastoreServiceAsyncClient, MetastoreServiceClient, pagers, transports
...
def test_create_catalog_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/catalogs" % client.transport._host, args[1])
...
def test_delete_catalog_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/catalogs/*}" % client.transport._host, args[1])
...
def test_create_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/catalogs/*}/databases" % client.transport._host, args[1])
...
def test_delete_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/catalogs/*/databases/*}" % client.transport._host, args[1])
...
def test_update_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{database.name=projects/*/locations/*/catalogs/*/databases/*}" % client.transport._host, args[1])
...
def test_create_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/catalogs/*/databases/*}/tables" % client.transport._host, args[1])
...
def test_delete_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/catalogs/*/databases/*/tables/*}" % client.transport._host, args[1])
...
def test_update_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{table.name=projects/*/locations/*/catalogs/*/databases/*/tables/*}" % client.transport._host, args[1])
...
def test_rename_table_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/catalogs/*/databases/*/tables/*}:rename" % client.transport._host, args[1])
...
def test_metastore_service_base_transport():
    ...
    with mock.patch("google.cloud.bigquery_biglake_v1.services.metastore_service.transports.MetastoreServiceTransport.__init__") as Transport:

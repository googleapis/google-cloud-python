...
class VpcAccessServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = VpcAccessServiceClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            VpcAccessServiceAsyncClient: The constructed client.
        """
        sa_file_func = VpcAccessServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(VpcAccessServiceAsyncClient, filename, *args, **kwargs)
    ...
    get_transport_class = VpcAccessServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.vpcaccess_v1.VpcAccessServiceAsyncClient`.",
                extra={

...
class VpcAccessServiceClient(metaclass=VpcAccessServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or VpcAccessServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = VpcAccessServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or VpcAccessServiceClient._get_api_endpoint(

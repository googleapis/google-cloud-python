...
class VpcAccessServiceClientMeta(type):
    """Metaclass for the VpcAccessService client.
...
class VpcAccessServiceClient(metaclass=VpcAccessServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            VpcAccessServiceClient: The constructed client.
        """
    ...
    def transport(self) -> VpcAccessServiceTransport:
        ...
        Returns:
            VpcAccessServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = VpcAccessServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = VpcAccessServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, VpcAccessServiceTransport, Callable[..., VpcAccessServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = VpcAccessServiceClient._read_environment_variables()
        self._client_cert_source = VpcAccessServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = VpcAccessServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, VpcAccessServiceTransport)
        if transport_provided:
            # transport is a VpcAccessServiceTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or VpcAccessServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[VpcAccessServiceTransport], Callable[..., VpcAccessServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.vpcaccess_v1.VpcAccessServiceClient`.",
                    extra={
    ...
    def create_connector(
        ...
        *,
        ...
        flattened_params = [parent, connector_id, connector]
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_connector]
    ...
    def get_connector(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_connector]
    ...
    def list_connectors(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_connectors]
    ...
    def delete_connector(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_connector]

...
from .base import DEFAULT_CLIENT_INFO, VpcAccessServiceTransport
...
class VpcAccessServiceGrpcTransport(VpcAccessServiceTransport):
    ...
    def create_connector(
        ...
        if "create_connector" not in self._stubs:
            self._stubs["create_connector"] = self._logged_channel.unary_unary(
    ...
    def get_connector(
        ...
        if "get_connector" not in self._stubs:
            self._stubs["get_connector"] = self._logged_channel.unary_unary(
    ...
    def list_connectors(
        ...
        if "list_connectors" not in self._stubs:
            self._stubs["list_connectors"] = self._logged_channel.unary_unary(
    ...
    def delete_connector(
        ...
        if "delete_connector" not in self._stubs:
            self._stubs["delete_connector"] = self._logged_channel.unary_unary(

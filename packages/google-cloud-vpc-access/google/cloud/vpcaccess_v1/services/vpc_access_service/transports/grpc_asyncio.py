...
class VpcAccessServiceGrpcAsyncIOTransport(VpcAccessServiceTransport):
    ...
    def create_connector(
        ...
        [vpc_access.CreateConnectorRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def list_connectors(
        ...
        [vpc_access.ListConnectorsRequest], Awaitable[vpc_access.ListConnectorsResponse]
    ]:
    ...
    def delete_connector(
        ...
        [vpc_access.DeleteConnectorRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_connector: gapic_v1.method_async.wrap_method(
                self.create_connector,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_connector: gapic_v1.method_async.wrap_method(
                self.get_connector,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_connectors: gapic_v1.method_async.wrap_method(
                self.list_connectors,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_connector: gapic_v1.method_async.wrap_method(

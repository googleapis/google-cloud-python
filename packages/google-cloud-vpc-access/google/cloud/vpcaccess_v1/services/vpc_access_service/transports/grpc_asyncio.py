...
class VpcAccessServiceGrpcAsyncIOTransport(VpcAccessServiceTransport):
    ...
    @property
    def create_connector(self) -> Callable[[vpc_access.CreateConnectorRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_connector(self) -> Callable[[vpc_access.GetConnectorRequest], Awaitable[vpc_access.Connector]]:
    ...
    @property
    def list_connectors(self) -> Callable[[vpc_access.ListConnectorsRequest], Awaitable[vpc_access.ListConnectorsResponse]]:
    ...
    @property
    def delete_connector(self) -> Callable[[vpc_access.DeleteConnectorRequest], Awaitable[operations_pb2.Operation]]:

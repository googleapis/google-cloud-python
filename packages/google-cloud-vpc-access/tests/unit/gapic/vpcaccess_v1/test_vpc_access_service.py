...
def test__read_environment_variables():
    assert VpcAccessServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert VpcAccessServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert VpcAccessServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert VpcAccessServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert VpcAccessServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert VpcAccessServiceClient._get_client_cert_source(None, False) is None
    assert VpcAccessServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert VpcAccessServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert VpcAccessServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert VpcAccessServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(VpcAccessServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceClient))
@mock.patch.object(VpcAccessServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VpcAccessServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert VpcAccessServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        VpcAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert VpcAccessServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert VpcAccessServiceClient._get_api_endpoint(None, None, default_universe, "always") == VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        VpcAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert VpcAccessServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert VpcAccessServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        VpcAccessServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert VpcAccessServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert VpcAccessServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert VpcAccessServiceClient._get_universe_domain(None, None) == VpcAccessServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize(
    ...
    [
        (VpcAccessServiceClient, "grpc"),
        (VpcAccessServiceAsyncClient, "grpc_asyncio"),
        (VpcAccessServiceClient, "rest"),
    ],
)
def test_vpc_access_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "vpcaccess.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://vpcaccess.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.VpcAccessServiceRestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VpcAccessServiceAsyncClient, transports.VpcAccessServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (VpcAccessServiceClient, transports.VpcAccessServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(VpcAccessServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceClient))
@mock.patch.object(VpcAccessServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (VpcAccessServiceClient, transports.VpcAccessServiceGrpcTransport, "grpc", "true"),
        (VpcAccessServiceAsyncClient, transports.VpcAccessServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (VpcAccessServiceClient, transports.VpcAccessServiceGrpcTransport, "grpc", "false"),
        (VpcAccessServiceAsyncClient, transports.VpcAccessServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (VpcAccessServiceClient, transports.VpcAccessServiceRestTransport, "rest", "true"),
        (VpcAccessServiceClient, transports.VpcAccessServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(VpcAccessServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceClient))
@mock.patch.object(VpcAccessServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceAsyncClient))
...
@mock.patch.object(VpcAccessServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceClient))
@mock.patch.object(VpcAccessServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VpcAccessServiceAsyncClient))
def test_vpc_access_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (VpcAccessServiceClient, transports.VpcAccessServiceGrpcTransport, "grpc", grpc_helpers),
        (VpcAccessServiceAsyncClient, transports.VpcAccessServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (VpcAccessServiceClient, transports.VpcAccessServiceRestTransport, "rest", None),
    ],
)
...
def test_transport_kind_grpc():
    transport = VpcAccessServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = VpcAccessServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = VpcAccessServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = VpcAccessServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_connector_rest_bad_request(request_type=vpc_access.CreateConnectorRequest):
...
def test_create_connector_rest_call_success(request_type):
    ...
    request_init["connector"] = {
        ...
        "min_throughput": 1533,
        "max_throughput": 1535,
        "connected_projects": ["connected_projects_value1", "connected_projects_value2"],
        "subnet": {"name": "name_value", "project_id": "project_id_value"},
        "machine_type": "machine_type_value",
        "min_instances": 1387,
        "max_instances": 1389,
    }
...
def test_create_connector_rest_interceptors(null_interceptor):
    transport = transports.VpcAccessServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.VpcAccessServiceRestInterceptor(),
    )
    client = VpcAccessServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VpcAccessServiceRestInterceptor, "post_create_connector_with_metadata"
...
def test_get_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_get_connector") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vpc_access.Connector.to_json(vpc_access.Connector())
        req.return_value.content = return_value
...
def test_list_connectors_rest_bad_request(request_type=vpc_access.ListConnectorsRequest):
    client = VpcAccessServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VpcAccessServiceRestInterceptor, "post_list_connectors") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vpc_access.ListConnectorsResponse.to_json(vpc_access.ListConnectorsResponse())
        req.return_value.content = return_value
...
def test_delete_connector_rest_bad_request(request_type=vpc_access.DeleteConnectorRequest):
    client = VpcAccessServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/connectors/sample3"}
    request = request_type(**request_init)
...
def test_delete_connector_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VpcAccessServiceRestInterceptor, "post_delete_connector_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.VpcAccessServiceGrpcTransport, grpc_helpers), (transports.VpcAccessServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_vpc_access_service_host_no_port(transport_name):
    client = VpcAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="vpcaccess.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "vpcaccess.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://vpcaccess.googleapis.com"
...
def test_vpc_access_service_host_with_port(transport_name):
    client = VpcAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="vpcaccess.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "vpcaccess.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://vpcaccess.googleapis.com:8000"
    )
...
def test_vpc_access_service_client_transport_session_collision(transport_name):
    ...
    client1 = VpcAccessServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = VpcAccessServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize(
    ...
    [
        (VpcAccessServiceClient, transports.VpcAccessServiceGrpcTransport),
        (VpcAccessServiceAsyncClient, transports.VpcAccessServiceGrpcAsyncIOTransport),
    ],
)

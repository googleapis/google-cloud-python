...
def test__get_client_cert_source():
    ...
    assert (
        VpcAccessServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        VpcAccessServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                VpcAccessServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(VpcAccessServiceClient),
)
@mock.patch.object(
    VpcAccessServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(VpcAccessServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VpcAccessServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = VpcAccessServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        VpcAccessServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        VpcAccessServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == VpcAccessServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        VpcAccessServiceClient._get_api_endpoint(
    ...
    assert (
        VpcAccessServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        VpcAccessServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        VpcAccessServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        VpcAccessServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        VpcAccessServiceClient._get_universe_domain(None, None)
        == VpcAccessServiceClient._DEFAULT_UNIVERSE
    )
...
def test_vpc_access_service_client_from_service_account_info(
    client_class, transport_name
):
    ...
    with mock.patch.object(
        ...
        assert client.transport._host == (
            ...
            else "https://vpcaccess.googleapis.com"
        )
...
def test_vpc_access_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_vpc_access_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_connector_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
@pytest.mark.asyncio
async def test_get_connector_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = VpcAccessServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_connectors_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = VpcAccessServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_connector_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = VpcAccessServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_connector_rest(request_type):
    ...
    request_init["connector"] = {
        ...
        "max_throughput": 1535,
        "connected_projects": [
            "connected_projects_value1",
            "connected_projects_value2",
        ],
...
def test_create_connector_rest_interceptors(null_interceptor):
    transport = transports.VpcAccessServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.VpcAccessServiceRestInterceptor(),
    )
...
def test_create_connector_rest_bad_request(
    transport: str = "rest", request_type=vpc_access.CreateConnectorRequest
):
    client = VpcAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_connector_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/connectors" % client.transport._host,
            args[1],
        )
...
def test_get_connector_rest_bad_request(
    transport: str = "rest", request_type=vpc_access.GetConnectorRequest
):
    client = VpcAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_connector_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/connectors/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/connectors/*}" % client.transport._host,
            args[1],
        )
...
def test_list_connectors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vpc_access.ListConnectorsResponse.to_json(
            vpc_access.ListConnectorsResponse()
        )
...
def test_list_connectors_rest_bad_request(
    transport: str = "rest", request_type=vpc_access.ListConnectorsRequest
):
    client = VpcAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_connector_rest_bad_request(
    transport: str = "rest", request_type=vpc_access.DeleteConnectorRequest
):
    client = VpcAccessServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_transport_kind(transport_name):
    transport = VpcAccessServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_vpc_access_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "vpcaccess.googleapis.com:8000"
        if transport_name in ["grpc", "grpc_asyncio"]
        else "https://vpcaccess.googleapis.com:8000"
    )

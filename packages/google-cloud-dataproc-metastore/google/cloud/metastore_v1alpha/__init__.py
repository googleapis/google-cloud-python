...
__lazy_modules__ = {
    "google.cloud.metastore_v1alpha.services.dataproc_metastore",
    "google.cloud.metastore_v1alpha.services.dataproc_metastore_federation",
    "google.cloud.metastore_v1alpha.types.metastore",
    "google.cloud.metastore_v1alpha.types.metastore_federation",
}
...
api_core.check_python_version("google.cloud.metastore_v1alpha")
api_core.check_dependency_versions("google.cloud.metastore_v1alpha")

...
class DataprocMetastoreFederationTransport(abc.ABC):
    ...
    def list_federations(
        ...
        Union[metastore_federation.ListFederationsResponse, Awaitable[metastore_federation.ListFederationsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def get_federation(
        self,
    ) -> Callable[[metastore_federation.GetFederationRequest], Union[metastore_federation.Federation, Awaitable[metastore_federation.Federation]]]:
        raise NotImplementedError()

    @property
    def create_federation(
        self,
    ) -> Callable[[metastore_federation.CreateFederationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_federation(
        self,
    ) -> Callable[[metastore_federation.UpdateFederationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_federation(
        self,
    ) -> Callable[[metastore_federation.DeleteFederationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
class DataprocMetastoreFederationGrpcAsyncIOTransport(DataprocMetastoreFederationTransport):
    ...
    @property
    def list_federations(self) -> Callable[[metastore_federation.ListFederationsRequest], Awaitable[metastore_federation.ListFederationsResponse]]:
    ...
    @property
    def get_federation(self) -> Callable[[metastore_federation.GetFederationRequest], Awaitable[metastore_federation.Federation]]:
    ...
    @property
    def create_federation(self) -> Callable[[metastore_federation.CreateFederationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_federation(self) -> Callable[[metastore_federation.UpdateFederationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_federation(self) -> Callable[[metastore_federation.DeleteFederationRequest], Awaitable[operations_pb2.Operation]]:

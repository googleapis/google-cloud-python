...
class DataprocMetastoreFederationGrpcAsyncIOTransport(
    ...
    def list_federations(
        ...
        if "list_federations" not in self._stubs:
            self._stubs["list_federations"] = self.grpc_channel.unary_unary(
    ...
    def get_federation(
        ...
        if "get_federation" not in self._stubs:
            self._stubs["get_federation"] = self.grpc_channel.unary_unary(
    ...
    def create_federation(
        ...
        if "create_federation" not in self._stubs:
            self._stubs["create_federation"] = self.grpc_channel.unary_unary(
    ...
    def update_federation(
        ...
        if "update_federation" not in self._stubs:
            self._stubs["update_federation"] = self.grpc_channel.unary_unary(
    ...
    def delete_federation(
        ...
        if "delete_federation" not in self._stubs:
            self._stubs["delete_federation"] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_federations: gapic_v1.method_async.wrap_method(
                self.list_federations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_federation: gapic_v1.method_async.wrap_method(
                self.get_federation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_federation: gapic_v1.method_async.wrap_method(
                self.create_federation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_federation: gapic_v1.method_async.wrap_method(
                self.update_federation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_federation: gapic_v1.method_async.wrap_method(

...
class DataprocMetastoreFederationClient(metaclass=DataprocMetastoreFederationClientMeta):
    ...
    def federation_path(
        ...
        return "projects/{project}/locations/{location}/federations/{federation}".format(
            project=project,
            location=location,
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DataprocMetastoreFederationClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or DataprocMetastoreFederationClient._get_api_endpoint(

...
from google.cloud.metastore_v1beta.services.dataproc_metastore import DataprocMetastoreAsyncClient, DataprocMetastoreClient, pagers, transports
...
def test_update_metadata_import_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}" % client.transport._host, args[1]
        )

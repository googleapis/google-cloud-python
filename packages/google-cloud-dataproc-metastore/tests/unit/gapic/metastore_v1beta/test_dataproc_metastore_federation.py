...
def test_dataproc_metastore_federation_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_federations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/federations"
...
def test_get_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/federations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{federation.name=projects/*/locations/*/federations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_dataproc_metastore_federation_base_transport():
    ...
    with mock.patch(
        "google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport.__init__"
    ) as Transport:
...
def test_dataproc_metastore_federation_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.metastore_v1beta.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

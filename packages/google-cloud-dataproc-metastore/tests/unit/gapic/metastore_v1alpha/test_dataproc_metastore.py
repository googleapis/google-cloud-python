...
async def test_get_metadata_import_async(request_type, transport: str = "grpc_asyncio"):
    client = DataprocMetastoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_export_metadata_async(request_type, transport: str = "grpc_asyncio"):
    client = DataprocMetastoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_restore_service_async(request_type, transport: str = "grpc_asyncio"):
    client = DataprocMetastoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_remove_iam_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.remove_iam_policy] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_remove_iam_policy_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.remove_iam_policy
            in client._client._transport._wrapped_methods
        )
...
async def test_remove_iam_policy_async(request_type, transport: str = "grpc_asyncio"):
    client = DataprocMetastoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_query_metadata_async(request_type, transport: str = "grpc_asyncio"):
    client = DataprocMetastoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateService,
...
def test_update_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateService,
...
def test_delete_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteService,
...
def test_list_metadata_imports_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListMetadataImports,
        "_BaseListMetadataImports__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_metadata_import_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetMetadataImport,
        "_BaseGetMetadataImport__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_metadata_import_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateMetadataImport,
        "_BaseCreateMetadataImport__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_metadata_import_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateMetadataImport,
        "_BaseUpdateMetadataImport__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_export_metadata_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseExportMetadata,
        "_BaseExportMetadata__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_restore_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRestoreService,
        "_BaseRestoreService__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_remove_iam_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveIamPolicy,
        "_BaseRemoveIamPolicy__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_query_metadata_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseQueryMetadata,
        "_BaseQueryMetadata__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_move_table_to_database_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseMoveTableToDatabase,
        "_BaseMoveTableToDatabase__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_alter_metadata_resource_location_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAlterMetadataResourceLocation,
        "_BaseAlterMetadataResourceLocation__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_remove_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metastore.RemoveIamPolicyResponse.to_json(
            metastore.RemoveIamPolicyResponse()
        )
        req.return_value.content = return_value

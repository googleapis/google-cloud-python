...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert DataprocMetastoreFederationClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert DataprocMetastoreFederationClient._use_client_cert_effective() is False
...
@mock.patch.object(
    DataprocMetastoreFederationClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataprocMetastoreFederationClient)
)
@mock.patch.object(
    DataprocMetastoreFederationAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataprocMetastoreFederationAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        DataprocMetastoreFederationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        DataprocMetastoreFederationClient._get_api_endpoint(None, None, default_universe, "always")
        == DataprocMetastoreFederationClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DataprocMetastoreFederationClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == DataprocMetastoreFederationClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = DataprocMetastoreFederationClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = DataprocMetastoreFederationAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DataprocMetastoreFederationAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DataprocMetastoreFederationClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_federations_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_list_federations") as post, mock.patch.object(
        transports.DataprocMetastoreFederationRestInterceptor, "post_list_federations_with_metadata"
...
def test_get_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataprocMetastoreFederationRestInterceptor, "post_get_federation") as post, mock.patch.object(
        transports.DataprocMetastoreFederationRestInterceptor, "post_get_federation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataprocMetastoreFederationRestInterceptor, "post_create_federation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataprocMetastoreFederationRestInterceptor, "post_update_federation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_federation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataprocMetastoreFederationRestInterceptor, "post_delete_federation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_federation_path():
    ...
    location = "clam"
    federation = "whelk"
    expected = "projects/{project}/locations/{location}/federations/{federation}".format(
        project=project,
        location=location,
...
async def test_get_location_field_headers_async():
    client = DataprocMetastoreFederationAsyncClient(credentials=async_anonymous_credentials())

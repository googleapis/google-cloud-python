...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DataprocMetastoreFederationClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DataprocMetastoreFederationClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DataprocMetastoreFederationClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DataprocMetastoreFederationClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
    assert (
        DataprocMetastoreFederationClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        DataprocMetastoreFederationClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert DataprocMetastoreFederationClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                DataprocMetastoreFederationClient._use_client_cert_effective() is True
            )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                DataprocMetastoreFederationClient._use_client_cert_effective() is False
            )
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                DataprocMetastoreFederationClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        DataprocMetastoreFederationClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DataprocMetastoreFederationClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DataprocMetastoreFederationClient),
)
@mock.patch.object(
    DataprocMetastoreFederationAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(DataprocMetastoreFederationAsyncClient),
)
def test__get_api_endpoint():
    ...
    mock_endpoint = DataprocMetastoreFederationClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == DataprocMetastoreFederationClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DataprocMetastoreFederationClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        DataprocMetastoreFederationClient._get_universe_domain(
    ...
    assert (
        DataprocMetastoreFederationClient._get_universe_domain(None, None)
        == DataprocMetastoreFederationClient._DEFAULT_UNIVERSE
    )
...
def test_dataproc_metastore_federation_client_from_service_account_info(
    client_class, transport_name
):
...
def test_dataproc_metastore_federation_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_dataproc_metastore_federation_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_dataproc_metastore_federation_client_client_options(
    ...
    with mock.patch.object(
        DataprocMetastoreFederationClient, "get_transport_class"
    ) as gtc:
...
def test_dataproc_metastore_federation_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    DataprocMetastoreFederationClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DataprocMetastoreFederationClient),
)
@mock.patch.object(
    DataprocMetastoreFederationAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DataprocMetastoreFederationAsyncClient),
)
...
def test_dataproc_metastore_federation_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_dataproc_metastore_federation_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_dataproc_metastore_federation_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_dataproc_metastore_federation_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_federations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_federations] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_federations_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_federations
...
async def test_list_federations_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_federations), "__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            metastore_federation.ListFederationsResponse(
        ...
        async_pager = await client.list_federations(
            request={},
        )
...
@pytest.mark.asyncio
async def test_get_federation_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_federation
            in client._client._transport._wrapped_methods
        )
...
def test_create_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_federation] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_federation_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_federation
            in client._client._transport._wrapped_methods
        )
...
def test_update_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_federation] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_update_federation_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_federation
            in client._client._transport._wrapped_methods
        )
...
def test_delete_federation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_federation] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_federation_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_federation
            in client._client._transport._wrapped_methods
        )
...
def test_list_federations_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_federations._get_unset_required_fields(jsonified_request)
...
def test_list_federations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*}/federations"
...
def test_list_federations_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            metastore_federation.ListFederationsResponse.to_json(x) for x in response
        )
...
def test_get_federation_rest_required_fields(
    request_type=metastore_federation.GetFederationRequest,
):
    transport_class = transports.DataprocMetastoreFederationRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/federations/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/federations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_federation_rest_required_fields(
    request_type=metastore_federation.CreateFederationRequest,
):
    transport_class = transports.DataprocMetastoreFederationRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_federation_rest_required_fields(
    request_type=metastore_federation.UpdateFederationRequest,
):
    transport_class = transports.DataprocMetastoreFederationRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_federation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{federation.name=projects/*/locations/*/federations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_federation_rest_required_fields(
    request_type=metastore_federation.DeleteFederationRequest,
):
    transport_class = transports.DataprocMetastoreFederationRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_federation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc_asyncio():
    transport = DataprocMetastoreFederationAsyncClient.get_transport_class(
        "grpc_asyncio"
    )(credentials=async_anonymous_credentials())
...
def test_list_federations_rest_bad_request(
    request_type=metastore_federation.ListFederationsRequest,
):
    client = DataprocMetastoreFederationClient(
...
def test_list_federations_rest_interceptors(null_interceptor):
    transport = transports.DataprocMetastoreFederationRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.DataprocMetastoreFederationRestInterceptor(),
    )
    client = DataprocMetastoreFederationClient(transport=transport)
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metastore_federation.ListFederationsResponse.to_json(
            metastore_federation.ListFederationsResponse()
        )
...
def test_get_federation_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = metastore_federation.Federation.to_json(
            metastore_federation.Federation()
        )
        req.return_value.content = return_value
...
def test_update_federation_rest_bad_request(
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "federation": {"name": "projects/sample1/locations/sample2/federations/sample3"}
    }
    request = request_type(**request_init)
...
def test_dataproc_metastore_federation_base_transport():
    ...
    with mock.patch(
        "google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport.__init__"
    ) as Transport:
...
def test_dataproc_metastore_federation_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.metastore_v1alpha.services.dataproc_metastore_federation.transports.DataprocMetastoreFederationTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_dataproc_metastore_federation_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_dataproc_metastore_federation_client_transport_session_collision(
    transport_name,
):
...
def test_federation_path():
    ...
    actual = DataprocMetastoreFederationClient.federation_path(
...
def test_common_billing_account_path():
    ...
    actual = DataprocMetastoreFederationClient.common_billing_account_path(
        billing_account
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.DataprocMetastoreFederationTransport, "_prep_wrapped_messages"
    ) as prep:
        client = DataprocMetastoreFederationClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
class ChatServiceGrpcTransport(ChatServiceTransport):
    ...
    def create_message(
        ...
        |Message sent with app authenticatio gRPC|
        ...
        |Message sent with user authenticatio gRPC|

        The maximum message size, including the message contents, is
        32,000 bytes.

        .. |Message sent with app authenticatio gRPC| image:: https://developers.google.com/workspace/chat/images/message-app-auth.svg
        .. |Message sent with user authenticatio gRPC| image:: https://developers.google.com/workspace/chat/images/message-user-auth.svg

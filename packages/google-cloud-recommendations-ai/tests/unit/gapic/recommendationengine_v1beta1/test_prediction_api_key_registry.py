...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert PredictionApiKeyRegistryClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert PredictionApiKeyRegistryClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert PredictionApiKeyRegistryClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                PredictionApiKeyRegistryClient._use_client_cert_effective()
...
@mock.patch.object(
    PredictionApiKeyRegistryAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PredictionApiKeyRegistryAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        PredictionApiKeyRegistryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == PredictionApiKeyRegistryClient.DEFAULT_MTLS_ENDPOINT
    )
    assert PredictionApiKeyRegistryClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        PredictionApiKeyRegistryClient._get_api_endpoint(None, None, default_universe, "always")
        == PredictionApiKeyRegistryClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        PredictionApiKeyRegistryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == PredictionApiKeyRegistryClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_create_prediction_api_key_registration_async(
    transport: str = "grpc_asyncio", request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest
):
    client = PredictionApiKeyRegistryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_list_prediction_api_key_registrations_async(
    transport: str = "grpc_asyncio", request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest
):
    client = PredictionApiKeyRegistryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_delete_prediction_api_key_registration_async(
    transport: str = "grpc_asyncio", request_type=prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest
):
    client = PredictionApiKeyRegistryAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_prediction_api_key_registration_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_prediction_api_key_registration._get_unset_required_fields(jsonified_request)
...
def test_create_prediction_api_key_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/predictionApiKeyRegistrations" % client.transport._host, args[1]
        )
...
def test_list_prediction_api_key_registrations_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_prediction_api_key_registrations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_prediction_api_key_registration_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_prediction_api_key_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_prediction_api_key_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/catalogs/*/eventStores/*/predictionApiKeyRegistrations/*}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = PredictionApiKeyRegistryClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = PredictionApiKeyRegistryAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = PredictionApiKeyRegistryAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = PredictionApiKeyRegistryClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_prediction_api_key_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PredictionApiKeyRegistryRestInterceptor, "post_create_prediction_api_key_registration"
    ) as post, mock.patch.object(
        transports.PredictionApiKeyRegistryRestInterceptor, "post_create_prediction_api_key_registration_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.PredictionApiKeyRegistryRestInterceptor, "pre_create_prediction_api_key_registration"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration.to_json(
            prediction_apikey_registry_service.PredictionApiKeyRegistration()
        )
...
def test_list_prediction_api_key_registrations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PredictionApiKeyRegistryRestInterceptor, "post_list_prediction_api_key_registrations"
    ) as post, mock.patch.object(
        transports.PredictionApiKeyRegistryRestInterceptor, "post_list_prediction_api_key_registrations_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.PredictionApiKeyRegistryRestInterceptor, "pre_list_prediction_api_key_registrations"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_prediction_api_key_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "pre_delete_prediction_api_key_registration") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.PredictionApiKeyRegistryGrpcTransport, grpc_helpers), (transports.PredictionApiKeyRegistryGrpcAsyncIOTransport, grpc_helpers_async)],
)

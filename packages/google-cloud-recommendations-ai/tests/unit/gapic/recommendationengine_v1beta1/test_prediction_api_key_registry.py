...
def test__get_default_mtls_endpoint():
    ...
    assert (
        PredictionApiKeyRegistryClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    PredictionApiKeyRegistryClient._use_client_cert_effective() is False
                )
...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                PredictionApiKeyRegistryClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(PredictionApiKeyRegistryClient),
)
@mock.patch.object(
    PredictionApiKeyRegistryAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(PredictionApiKeyRegistryAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = PredictionApiKeyRegistryClient._DEFAULT_UNIVERSE
    default_endpoint = PredictionApiKeyRegistryClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = PredictionApiKeyRegistryClient._DEFAULT_ENDPOINT_TEMPLATE.format(
...
def test__get_universe_domain():
    ...
    assert (
        PredictionApiKeyRegistryClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        PredictionApiKeyRegistryClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        PredictionApiKeyRegistryClient._get_universe_domain(None, None)
        == PredictionApiKeyRegistryClient._DEFAULT_UNIVERSE
    )
...
def test_list_prediction_api_key_registrations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_prediction_api_key_registrations(

...
async def test_create_catalog_item_async(request_type, transport: str = "grpc_asyncio"):
    client = CatalogServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_catalog_item_async(request_type, transport: str = "grpc_asyncio"):
    client = CatalogServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_catalog_items_async(request_type, transport: str = "grpc_asyncio"):
    client = CatalogServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_catalog_item_async(request_type, transport: str = "grpc_asyncio"):
    client = CatalogServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_catalog_item_async(request_type, transport: str = "grpc_asyncio"):
    client = CatalogServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_catalog_item_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateCatalogItem,
...
def test_get_catalog_item_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetCatalogItem,
...
def test_list_catalog_items_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListCatalogItems,
...
def test_update_catalog_item_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateCatalogItem,
...
def test_delete_catalog_item_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteCatalogItem,
...
def test_import_catalog_items_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseImportCatalogItems,

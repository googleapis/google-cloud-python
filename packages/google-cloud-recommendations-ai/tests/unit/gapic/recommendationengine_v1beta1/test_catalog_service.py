...
from google.cloud.recommendationengine_v1beta1.services.catalog_service import CatalogServiceAsyncClient, CatalogServiceClient, pagers, transports
from google.cloud.recommendationengine_v1beta1.types import catalog, catalog_service, common, import_, user_event
...
def test__get_api_endpoint():
    ...
    assert (
        CatalogServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CatalogServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        CatalogServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
...
def test_catalog_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "recommendationengine.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://recommendationengine.googleapis.com"
        )
...
async def test_list_catalog_items_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_catalog_items), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            catalog_service.ListCatalogItemsResponse(
                catalog_items=[
...
async def test_list_catalog_items_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_catalog_items), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_catalog_items(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_import_catalog_items(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.import_catalog_items), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_catalog_item_rest_required_fields(request_type=catalog_service.CreateCatalogItemRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_catalog_item._get_unset_required_fields(
        jsonified_request
    )
...
def test_update_catalog_item_rest_required_fields(request_type=catalog_service.UpdateCatalogItemRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_catalog_item._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_catalog_item_rest_required_fields(request_type=catalog_service.DeleteCatalogItemRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_catalog_item._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_import_catalog_items_rest_required_fields(request_type=import_.ImportCatalogItemsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_catalog_items._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = CatalogServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CatalogServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CatalogServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CatalogServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_catalog_item_rest_call_success(request_type):
    ...
    request_init["catalog_item"] = {
        "id": "id_value",
        "category_hierarchies": [{"categories": ["categories_value1", "categories_value2"]}],
        "title": "title_value",
        "description": "description_value",
...
def test_create_catalog_item_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_create_catalog_item") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_create_catalog_item_with_metadata"
...
def test_get_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_catalog_item") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_get_catalog_item_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_catalog_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_catalog_items") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_list_catalog_items_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_catalog_item") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_update_catalog_item_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_catalog_item_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_delete_catalog_item") as pre:
        pre.assert_not_called()
...
def test_import_catalog_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CatalogServiceRestInterceptor, "post_import_catalog_items_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.CatalogServiceGrpcTransport, grpc_helpers), (transports.CatalogServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

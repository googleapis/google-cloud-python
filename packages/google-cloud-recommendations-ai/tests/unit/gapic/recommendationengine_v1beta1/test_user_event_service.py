...
def test_write_user_event_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseWriteUserEvent,
...
def test_collect_user_event_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCollectUserEvent,
...
def test_list_user_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListUserEvents,
        "_BaseListUserEvents__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_purge_user_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BasePurgeUserEvents,
...
def test_import_user_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseImportUserEvents,

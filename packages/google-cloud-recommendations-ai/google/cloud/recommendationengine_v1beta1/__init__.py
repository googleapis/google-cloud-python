...
from .services.prediction_api_key_registry import PredictionApiKeyRegistryAsyncClient, PredictionApiKeyRegistryClient
...
from .types.user_event import EventDetail, ProductDetail, ProductEventDetail, PurchaseTransaction, UserEvent, UserInfo
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.recommendationengine_v1beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.recommendationengine_v1beta1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.recommendationengine_v1beta1"

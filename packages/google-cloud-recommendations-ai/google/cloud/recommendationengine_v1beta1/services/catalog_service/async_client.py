...
from google.cloud.recommendationengine_v1beta1.types import catalog, catalog_service, common, import_
...
class CatalogServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.recommendationengine_v1beta1.CatalogServiceAsyncClient`.",
                extra={
    ...
    async def create_catalog_item(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_catalog_item]
    ...
    async def get_catalog_item(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_catalog_item]
    ...
    async def list_catalog_items(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_catalog_items]
    ...
    async def update_catalog_item(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_catalog_item]
    ...
    async def delete_catalog_item(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_catalog_item]
    ...
    async def import_catalog_items(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_catalog_items]

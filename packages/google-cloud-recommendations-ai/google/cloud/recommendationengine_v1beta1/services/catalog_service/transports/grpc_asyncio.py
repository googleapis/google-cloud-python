...
class CatalogServiceGrpcAsyncIOTransport(CatalogServiceTransport):
    ...
    @property
    def create_catalog_item(self) -> Callable[[catalog_service.CreateCatalogItemRequest], Awaitable[catalog.CatalogItem]]:
    ...
    @property
    def get_catalog_item(self) -> Callable[[catalog_service.GetCatalogItemRequest], Awaitable[catalog.CatalogItem]]:
    ...
    @property
    def list_catalog_items(self) -> Callable[[catalog_service.ListCatalogItemsRequest], Awaitable[catalog_service.ListCatalogItemsResponse]]:
    ...
    @property
    def update_catalog_item(self) -> Callable[[catalog_service.UpdateCatalogItemRequest], Awaitable[catalog.CatalogItem]]:
    ...
    @property
    def delete_catalog_item(self) -> Callable[[catalog_service.DeleteCatalogItemRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def import_catalog_items(self) -> Callable[[import_.ImportCatalogItemsRequest], Awaitable[operations_pb2.Operation]]:

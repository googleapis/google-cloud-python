...
class CatalogServiceGrpcTransport(CatalogServiceTransport):
    ...
    def create_catalog_item(
        ...
        if "create_catalog_item" not in self._stubs:
            self._stubs["create_catalog_item"] = self._logged_channel.unary_unary(
    ...
    def get_catalog_item(
        ...
        if "get_catalog_item" not in self._stubs:
            self._stubs["get_catalog_item"] = self._logged_channel.unary_unary(
    ...
    def list_catalog_items(
        ...
        if "list_catalog_items" not in self._stubs:
            self._stubs["list_catalog_items"] = self._logged_channel.unary_unary(
    ...
    def update_catalog_item(
        ...
        if "update_catalog_item" not in self._stubs:
            self._stubs["update_catalog_item"] = self._logged_channel.unary_unary(
    ...
    def delete_catalog_item(
        ...
        if "delete_catalog_item" not in self._stubs:
            self._stubs["delete_catalog_item"] = self._logged_channel.unary_unary(
    ...
    def import_catalog_items(
        ...
        if "import_catalog_items" not in self._stubs:
            self._stubs["import_catalog_items"] = self._logged_channel.unary_unary(

...
class PredictionApiKeyRegistryClient(metaclass=PredictionApiKeyRegistryClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PredictionApiKeyRegistryClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or PredictionApiKeyRegistryClient._get_api_endpoint(

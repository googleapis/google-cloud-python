        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.recommendationengine_v1beta1.PredictionServiceClient.Predict",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.recommendationengine_v1beta1.PredictionServiceClient.predict",
                    extra={
                        "serviceName": "google.cloud.recommendationengine.v1beta1.PredictionService",
                        "rpcName": "Predict",

...
class ManagedIdentitiesServiceClient(metaclass=ManagedIdentitiesServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ManagedIdentitiesServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ManagedIdentitiesServiceClient._get_api_endpoint(

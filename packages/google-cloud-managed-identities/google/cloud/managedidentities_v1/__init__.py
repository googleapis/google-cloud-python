...
from .services.managed_identities_service import ManagedIdentitiesServiceAsyncClient, ManagedIdentitiesServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.managedidentities_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.managedidentities_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.managedidentities_v1"

...
- Clone your fork of ``python-access-context-manager`` from your GitHub account to your local
  ...
  as ``hack-on-python-access-context-manager``.  E.g.::
   ...
   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-access-context-manager.git hack-on-python-access-context-manager
   ...
   $ git remote add upstream git@github.com:googleapis/python-access-context-manager.git
...
.. _config: https://github.com/googleapis/python-access-context-manager/blob/main/noxfile.py

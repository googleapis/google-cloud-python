...
class AccessContextManagerTransport(abc.ABC):
    ...
    def get_access_policy(
        ...
        Union[access_policy.AccessPolicy, Awaitable[access_policy.AccessPolicy]],
    ]:
        raise NotImplementedError()
    ...
    def get_access_level(
        ...
        Union[access_level.AccessLevel, Awaitable[access_level.AccessLevel]],
    ]:
        raise NotImplementedError()
...
__all__ = ("AccessContextManagerTransport",)

...
from .services.cloud_functions_service import CloudFunctionsServiceAsyncClient, CloudFunctionsServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.functions_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.functions_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.functions_v1"

...
class ListFunctionsPager:
    ...
    :class:`google.cloud.functions_v2.types.ListFunctionsResponse` object, and
    ...
    All the usual :class:`google.cloud.functions_v2.types.ListFunctionsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.functions_v2.types.ListFunctionsRequest):
                The initial request object.
            response (google.cloud.functions_v2.types.ListFunctionsResponse):
    ...
    def __iter__(self) -> Iterator[functions.Function]:
...
class ListFunctionsAsyncPager:
    ...
    def __aiter__(self) -> AsyncIterator[functions.Function]:

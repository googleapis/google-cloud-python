...
from .grpc import FunctionServiceGrpcTransport
...
class FunctionServiceGrpcAsyncIOTransport(FunctionServiceTransport):
    """gRPC AsyncIO backend transport for FunctionService.
    ...
    @property
    def get_function(self) -> Callable[[functions.GetFunctionRequest], Awaitable[functions.Function]]:
    ...
    @property
    def list_runtimes(self) -> Callable[[functions.ListRuntimesRequest], Awaitable[functions.ListRuntimesResponse]]:
...
__all__ = ("FunctionServiceGrpcAsyncIOTransport",)

...
from google.cloud.functions_v2._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=FunctionServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=FunctionServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=FunctionServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

...
class FunctionServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(
        FunctionServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        FunctionServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(FunctionServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        FunctionServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        FunctionServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        FunctionServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(FunctionServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        FunctionServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(FunctionServiceClient.common_location_path)
    parse_common_location_path = staticmethod(
        FunctionServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            FunctionServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(FunctionServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            FunctionServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(FunctionServiceAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_function():
                ...
                # Make the request
                operation = await client.create_function(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_function():
                ...
                # Make the request
                operation = await client.update_function(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_function():
                ...
                # Make the request
                operation = await client.delete_function(request=request)

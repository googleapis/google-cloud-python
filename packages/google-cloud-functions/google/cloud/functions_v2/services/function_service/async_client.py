...
class FunctionServiceAsyncClient:
    ...
    _client: FunctionServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = FunctionServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = FunctionServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = FunctionServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = FunctionServiceClient._DEFAULT_UNIVERSE

    build_path = staticmethod(FunctionServiceClient.build_path)
    parse_build_path = staticmethod(FunctionServiceClient.parse_build_path)
    channel_path = staticmethod(FunctionServiceClient.channel_path)
    ...
    parse_repository_path = staticmethod(FunctionServiceClient.parse_repository_path)
    service_path = staticmethod(FunctionServiceClient.service_path)
    parse_service_path = staticmethod(FunctionServiceClient.parse_service_path)
    topic_path = staticmethod(FunctionServiceClient.topic_path)
    parse_topic_path = staticmethod(FunctionServiceClient.parse_topic_path)
    trigger_path = staticmethod(FunctionServiceClient.trigger_path)
    parse_trigger_path = staticmethod(FunctionServiceClient.parse_trigger_path)
    worker_pool_path = staticmethod(FunctionServiceClient.worker_pool_path)
    parse_worker_pool_path = staticmethod(FunctionServiceClient.parse_worker_pool_path)
    common_billing_account_path = staticmethod(FunctionServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(FunctionServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(FunctionServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(FunctionServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(FunctionServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(FunctionServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(FunctionServiceClient.common_project_path)
    parse_common_project_path = staticmethod(FunctionServiceClient.parse_common_project_path)
    common_location_path = staticmethod(FunctionServiceClient.common_location_path)
    parse_common_location_path = staticmethod(FunctionServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            FunctionServiceAsyncClient: The constructed client.
        """
        return FunctionServiceClient.from_service_account_info.__func__(FunctionServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            FunctionServiceAsyncClient: The constructed client.
        """
        return FunctionServiceClient.from_service_account_file.__func__(FunctionServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return FunctionServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> FunctionServiceTransport:
        ...
        Returns:
            FunctionServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FunctionServiceTransport, Callable[..., FunctionServiceTransport]]] = "grpc_asyncio",
        ...
        """
        self._client = FunctionServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.functions_v2.FunctionServiceAsyncClient`.",
                extra={

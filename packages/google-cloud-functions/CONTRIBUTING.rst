...
- While logged into your GitHub account, navigate to the
  ``python-functions`` `repo`_ on GitHub.

- Fork and clone the ``python-functions`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-functions`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-functions``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-functions.git hack-on-python-functions
   $ cd hack-on-python-functions
...
.. _repo: https://github.com/googleapis/python-functions
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-functions``. The

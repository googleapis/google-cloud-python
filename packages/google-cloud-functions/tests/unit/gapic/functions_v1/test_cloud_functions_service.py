...
def test__read_environment_variables():
    assert CloudFunctionsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CloudFunctionsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert CloudFunctionsServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CloudFunctionsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CloudFunctionsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CloudFunctionsServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CloudFunctionsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CloudFunctionsServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CloudFunctionsServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert CloudFunctionsServiceClient._get_client_cert_source(None, False) is None
    assert CloudFunctionsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CloudFunctionsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert CloudFunctionsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CloudFunctionsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(CloudFunctionsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudFunctionsServiceClient))
@mock.patch.object(CloudFunctionsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudFunctionsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudFunctionsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CloudFunctionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CloudFunctionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CloudFunctionsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        CloudFunctionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == CloudFunctionsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert CloudFunctionsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CloudFunctionsServiceClient._get_api_endpoint(None, None, default_universe, "always") == CloudFunctionsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        CloudFunctionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == CloudFunctionsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert CloudFunctionsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CloudFunctionsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CloudFunctionsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CloudFunctionsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CloudFunctionsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CloudFunctionsServiceClient._get_universe_domain(None, None) == CloudFunctionsServiceClient._DEFAULT_UNIVERSE
...
@mock.patch.object(CloudFunctionsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudFunctionsServiceClient))
@mock.patch.object(CloudFunctionsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CloudFunctionsServiceAsyncClient))
def test_cloud_functions_service_client_client_api_endpoint(client_class):
...
def test_call_function_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CloudFunctionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.call_function), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.call_function(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_call_function_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudFunctionsServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.call_function in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.call_function] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_call_function_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CloudFunctionsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.call_function in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.call_function] = mock_rpc
...
def test_call_function_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CloudFunctionsServiceClient(
...
def test_transport_kind_grpc():
    transport = CloudFunctionsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_call_function_empty_call_grpc():
    client = CloudFunctionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.call_function), "__call__") as call:
        call.return_value = functions.CallFunctionResponse()
        client.call_function(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = functions.CallFunctionRequest()
...
def test_transport_kind_grpc_asyncio():
    transport = CloudFunctionsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CloudFunctionsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_call_function_empty_call_grpc_asyncio():
    client = CloudFunctionsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.call_function), "__call__") as call:
        ...
        await client.call_function(request=None)
...
def test_transport_kind_rest():
    transport = CloudFunctionsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_functions_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_list_functions") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_list_functions_with_metadata"
...
def test_get_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_get_function") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_get_function_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = functions.CloudFunction.to_json(functions.CloudFunction())
        req.return_value.content = return_value
...
def test_create_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudFunctionsServiceRestInterceptor, "post_create_function_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudFunctionsServiceRestInterceptor, "post_update_function_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudFunctionsServiceRestInterceptor, "post_delete_function_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_call_function_rest_call_success(request_type):
    client = CloudFunctionsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_call_function_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_call_function") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_call_function_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = functions.CallFunctionResponse.to_json(functions.CallFunctionResponse())
        req.return_value.content = return_value
...
def test_generate_upload_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_generate_upload_url") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_generate_upload_url_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_generate_download_url_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_generate_download_url") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_generate_download_url_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudFunctionsServiceRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.CloudFunctionsServiceRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_call_function_empty_call_rest():
    client = CloudFunctionsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.CloudFunctionsServiceGrpcTransport, grpc_helpers), (transports.CloudFunctionsServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

...
def test_get_function_rest_required_fields(request_type=functions.GetFunctionRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetFunction,
        "_BaseGetFunction__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_list_functions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListFunctions,
        "_BaseListFunctions__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_function_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateFunction,
        "_BaseCreateFunction__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("functionId",))
...
def test_update_function_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateFunction,
        "_BaseUpdateFunction__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_function_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteFunction,
        "_BaseDeleteFunction__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_generate_upload_url_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateUploadUrl,
        "_BaseGenerateUploadUrl__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_generate_download_url_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateDownloadUrl,
        "_BaseGenerateDownloadUrl__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_runtimes_rest_required_fields(request_type=functions.ListRuntimesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListRuntimes,
        "_BaseListRuntimes__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_transport_kind_grpc_asyncio():
    transport = FunctionServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = FunctionServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_functions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = functions.ListFunctionsResponse.to_json(
            functions.ListFunctionsResponse()
        )
        req.return_value.content = return_value
...
def test_generate_upload_url_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = functions.GenerateUploadUrlResponse.to_json(
            functions.GenerateUploadUrlResponse()
        )
        req.return_value.content = return_value
...
def test_generate_download_url_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = functions.GenerateDownloadUrlResponse.to_json(
            functions.GenerateDownloadUrlResponse()
        )
        req.return_value.content = return_value
...
def test_list_runtimes_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = functions.ListRuntimesResponse.to_json(
            functions.ListRuntimesResponse()
        )
        req.return_value.content = return_value

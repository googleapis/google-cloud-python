...
from .types.asset_service import SearchAllIamPoliciesRequest, SearchAllIamPoliciesResponse, SearchAllResourcesRequest, SearchAllResourcesResponse
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.asset_v1p1beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.asset_v1p1beta1")  # type: ignore
else:  # pragma: NO COVER

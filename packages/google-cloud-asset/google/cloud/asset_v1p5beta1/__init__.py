...
__lazy_modules__ = {
    "google.cloud.asset_v1p5beta1.services.asset_service",
    "google.cloud.asset_v1p5beta1.types.asset_service",
    "google.cloud.asset_v1p5beta1.types.assets",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.asset_v1p5beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.asset_v1p5beta1")  # type: ignore

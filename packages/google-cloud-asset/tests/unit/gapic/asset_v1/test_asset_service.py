...
async def test_analyze_org_policy_governed_containers_async(
    transport: str = "grpc_asyncio", request_type=asset_service.AnalyzeOrgPolicyGovernedContainersRequest
):
    client = AssetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_analyze_org_policy_governed_assets_async(
    transport: str = "grpc_asyncio", request_type=asset_service.AnalyzeOrgPolicyGovernedAssetsRequest
):
    client = AssetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_batch_get_assets_history_rest_required_fields(request_type=asset_service.BatchGetAssetsHistoryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_get_assets_history._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_analyze_iam_policy_longrunning_rest_required_fields(request_type=asset_service.AnalyzeIamPolicyLongrunningRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).analyze_iam_policy_longrunning._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_get_effective_iam_policies_rest_required_fields(request_type=asset_service.BatchGetEffectiveIamPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_get_effective_iam_policies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_analyze_org_policies_rest_required_fields(request_type=asset_service.AnalyzeOrgPoliciesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).analyze_org_policies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_analyze_org_policy_governed_containers_rest_required_fields(request_type=asset_service.AnalyzeOrgPolicyGovernedContainersRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).analyze_org_policy_governed_containers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_analyze_org_policy_governed_assets_rest_required_fields(request_type=asset_service.AnalyzeOrgPolicyGovernedAssetsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).analyze_org_policy_governed_assets._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_list_assets") as post, mock.patch.object(
...
def test_batch_get_assets_history_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_batch_get_assets_history") as post, mock.patch.object(
        transports.AssetServiceRestInterceptor, "post_batch_get_assets_history_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_analyze_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_analyze_iam_policy") as post, mock.patch.object(
...
def test_analyze_iam_policy_longrunning_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AssetServiceRestInterceptor, "post_analyze_iam_policy_longrunning_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_analyze_move_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_analyze_move") as post, mock.patch.object(
...
def test_query_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_query_assets") as post, mock.patch.object(
    ...
    request_init["saved_query"] = {
        ...
        "content": {
            "iam_policy_analysis_query": {
                ...
                "access_selector": {"roles": ["roles_value1", "roles_value2"], "permissions": ["permissions_value1", "permissions_value2"]},
                "options": {
                    "expand_groups": True,
                    "expand_roles": True,
...
def test_create_saved_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_create_saved_query") as post, mock.patch.object(
...
def test_get_saved_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_get_saved_query") as post, mock.patch.object(
...
def test_list_saved_queries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_list_saved_queries") as post, mock.patch.object(
...
def test_update_saved_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_update_saved_query") as post, mock.patch.object(
...
def test_delete_saved_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "pre_delete_saved_query") as pre:
        pre.assert_not_called()
...
def test_batch_get_effective_iam_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_batch_get_effective_iam_policies") as post, mock.patch.object(
        transports.AssetServiceRestInterceptor, "post_batch_get_effective_iam_policies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_analyze_org_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_analyze_org_policies") as post, mock.patch.object(
        transports.AssetServiceRestInterceptor, "post_analyze_org_policies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_analyze_org_policy_governed_containers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AssetServiceRestInterceptor, "post_analyze_org_policy_governed_containers"
    ) as post, mock.patch.object(
        transports.AssetServiceRestInterceptor, "post_analyze_org_policy_governed_containers_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AssetServiceRestInterceptor, "pre_analyze_org_policy_governed_containers"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_analyze_org_policy_governed_assets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AssetServiceRestInterceptor, "post_analyze_org_policy_governed_assets") as post, mock.patch.object(
        transports.AssetServiceRestInterceptor, "post_analyze_org_policy_governed_assets_with_metadata"
    ) as post_with_metadata, mock.patch.object(

...
def test__get_api_endpoint():
    ...
    assert (
        AppConnectionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        AppConnectionsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AppConnectionsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_list_app_connections_rest_required_fields(request_type=app_connections_service.ListAppConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_app_connections._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_app_connection_rest_required_fields(request_type=app_connections_service.CreateAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_app_connection._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_app_connection_rest_required_fields(request_type=app_connections_service.UpdateAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_app_connection._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_app_connection_rest_required_fields(request_type=app_connections_service.DeleteAppConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_app_connection._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_resolve_app_connections_rest_required_fields(request_type=app_connections_service.ResolveAppConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).resolve_app_connections._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = AppConnectionsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = AppConnectionsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AppConnectionsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AppConnectionsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_app_connections_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_list_app_connections") as post, mock.patch.object(
        transports.AppConnectionsServiceRestInterceptor, "post_list_app_connections_with_metadata"
...
def test_get_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_get_app_connection") as post, mock.patch.object(
        transports.AppConnectionsServiceRestInterceptor, "post_get_app_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_app_connection_rest_call_success(request_type):
    ...
    request_init["app_connection"] = {
        ...
        "state": 1,
        "gateway": {"type_": 1, "uri": "uri_value", "ingress_port": 1311, "app_gateway": "app_gateway_value"},
    }
...
def test_create_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AppConnectionsServiceRestInterceptor, "post_create_app_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AppConnectionsServiceRestInterceptor, "post_update_app_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_app_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AppConnectionsServiceRestInterceptor, "post_delete_app_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_resolve_app_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AppConnectionsServiceRestInterceptor, "post_resolve_app_connections") as post, mock.patch.object(
        transports.AppConnectionsServiceRestInterceptor, "post_resolve_app_connections_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.AppConnectionsServiceGrpcTransport, grpc_helpers), (transports.AppConnectionsServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

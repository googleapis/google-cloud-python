...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AppConnectionsServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert AppConnectionsServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AppConnectionsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AppConnectionsServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                AppConnectionsServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        AppConnectionsServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AppConnectionsServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AppConnectionsServiceClient),
)
@mock.patch.object(
    AppConnectionsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AppConnectionsServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AppConnectionsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AppConnectionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AppConnectionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        AppConnectionsServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == AppConnectionsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AppConnectionsServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        AppConnectionsServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AppConnectionsServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AppConnectionsServiceClient._get_universe_domain(None, None)
        == AppConnectionsServiceClient._DEFAULT_UNIVERSE
    )
...
def test_list_app_connections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_app_connections in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.list_app_connections] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_app_connections_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_app_connections
...
def test_get_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_app_connection in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_app_connection] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_app_connection_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_app_connection
            in client._client._transport._wrapped_methods
        )
...
def test_create_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_app_connection
        ...
        client._transport._wrapped_methods[client._transport.create_app_connection] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_app_connection_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_app_connection
            in client._client._transport._wrapped_methods
        )
...
def test_update_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_app_connection
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_app_connection] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_update_app_connection_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_app_connection
            in client._client._transport._wrapped_methods
        )
...
def test_delete_app_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_app_connection
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_app_connection] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_app_connection_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_app_connection
            in client._client._transport._wrapped_methods
        )
...
def test_resolve_app_connections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.resolve_app_connections
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_resolve_app_connections_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.resolve_app_connections
            in client._client._transport._wrapped_methods
        )
...
def test_list_app_connections_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = app_connections_service.ListAppConnectionsResponse.pb(
                return_value
            )
...
def test_resolve_app_connections_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = app_connections_service.ResolveAppConnectionsResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_app_connections_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.AppConnectionsServiceRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_connections_service.ListAppConnectionsResponse.to_json(
            app_connections_service.ListAppConnectionsResponse()
        )
...
def test_get_app_connection_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_connections_service.AppConnection.to_json(
            app_connections_service.AppConnection()
        )
        req.return_value.content = return_value
...
def test_create_app_connection_rest_call_success(request_type):
    ...
    test_field = app_connections_service.CreateAppConnectionRequest.meta.fields[
        "app_connection"
    ]
...
def test_update_app_connection_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = app_connections_service.UpdateAppConnectionRequest.meta.fields[
        "app_connection"
    ]
...
def test_resolve_app_connections_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_connections_service.ResolveAppConnectionsResponse.to_json(
            app_connections_service.ResolveAppConnectionsResponse()
        )
        req.return_value.content = return_value
...
async def test_get_location_field_headers_async():
    client = AppConnectionsServiceAsyncClient(credentials=async_anonymous_credentials())

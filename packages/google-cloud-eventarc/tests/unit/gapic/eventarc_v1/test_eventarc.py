...
def test_get_trigger_rest_bad_request(
    transport: str = "rest", request_type=eventarc.GetTriggerRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_triggers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = eventarc.ListTriggersResponse.to_json(
            eventarc.ListTriggersResponse()
        )
...
def test_list_triggers_rest_bad_request(
    transport: str = "rest", request_type=eventarc.ListTriggersRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_trigger_rest_bad_request(
    transport: str = "rest", request_type=eventarc.CreateTriggerRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_trigger_rest_bad_request(
    transport: str = "rest", request_type=eventarc.UpdateTriggerRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_trigger_rest_bad_request(
    transport: str = "rest", request_type=eventarc.DeleteTriggerRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_channel_rest_bad_request(
    transport: str = "rest", request_type=eventarc.GetChannelRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_channels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = eventarc.ListChannelsResponse.to_json(
            eventarc.ListChannelsResponse()
        )
...
def test_list_channels_rest_bad_request(
    transport: str = "rest", request_type=eventarc.ListChannelsRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_channel_rest_bad_request(
    transport: str = "rest", request_type=eventarc.CreateChannelRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_channel_rest_bad_request(
    transport: str = "rest", request_type=eventarc.UpdateChannelRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_channel_rest_bad_request(
    transport: str = "rest", request_type=eventarc.DeleteChannelRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_provider_rest_bad_request(
    transport: str = "rest", request_type=eventarc.GetProviderRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_providers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = eventarc.ListProvidersResponse.to_json(
            eventarc.ListProvidersResponse()
        )
...
def test_list_providers_rest_bad_request(
    transport: str = "rest", request_type=eventarc.ListProvidersRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_channel_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = channel_connection.ChannelConnection.to_json(
            channel_connection.ChannelConnection()
        )
...
def test_get_channel_connection_rest_bad_request(
    transport: str = "rest", request_type=eventarc.GetChannelConnectionRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_channel_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = eventarc.ListChannelConnectionsResponse.to_json(
            eventarc.ListChannelConnectionsResponse()
        )
...
def test_list_channel_connections_rest_bad_request(
    transport: str = "rest", request_type=eventarc.ListChannelConnectionsRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_channel_connection_rest_bad_request(
    transport: str = "rest", request_type=eventarc.CreateChannelConnectionRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_channel_connection_rest_bad_request(
    transport: str = "rest", request_type=eventarc.DeleteChannelConnectionRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_google_channel_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = google_channel_config.GoogleChannelConfig.to_json(
            google_channel_config.GoogleChannelConfig()
        )
...
def test_get_google_channel_config_rest_bad_request(
    transport: str = "rest", request_type=eventarc.GetGoogleChannelConfigRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_google_channel_config_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = gce_google_channel_config.GoogleChannelConfig.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_update_google_channel_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = (
            gce_google_channel_config.GoogleChannelConfig.to_json(
                gce_google_channel_config.GoogleChannelConfig()
            )
        )
...
def test_update_google_channel_config_rest_bad_request(
    transport: str = "rest", request_type=eventarc.UpdateGoogleChannelConfigRequest
):
    client = EventarcClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

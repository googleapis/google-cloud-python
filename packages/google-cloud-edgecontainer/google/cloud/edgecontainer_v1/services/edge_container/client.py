...
class EdgeContainerClient(metaclass=EdgeContainerClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = EdgeContainerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = EdgeContainerClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = EdgeContainerClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or EdgeContainerClient._get_api_endpoint(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                to be overwritten in the Cluster
    ...
    def generate_offline_credential(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.generate_offline_credential
        ]
    ...
    def update_node_pool(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Field mask is used to specify the fields
                to be overwritten in the NodePool
                resource by the update. The fields
                specified in the update_mask are
                relative to the resource, not the full
                request. A field will be overwritten if

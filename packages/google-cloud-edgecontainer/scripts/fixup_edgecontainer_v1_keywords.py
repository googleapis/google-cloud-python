...
class edgecontainerCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_node_pool': ('parent', 'node_pool_id', 'node_pool', 'request_id', ),
        'create_vpn_connection': ('parent', 'vpn_connection_id', 'vpn_connection', 'request_id', ),
        ...
        'list_node_pools': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
...
def fix_files(
    ...
    *,
    transformer=edgecontainerCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the edgecontainer client library.

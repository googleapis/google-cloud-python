...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert EdgeContainerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EdgeContainerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EdgeContainerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert EdgeContainerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert EdgeContainerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                EdgeContainerClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert EdgeContainerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert EdgeContainerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert EdgeContainerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert EdgeContainerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(EdgeContainerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EdgeContainerClient))
@mock.patch.object(EdgeContainerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EdgeContainerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EdgeContainerClient._DEFAULT_UNIVERSE
    default_endpoint = EdgeContainerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = EdgeContainerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert EdgeContainerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EdgeContainerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EdgeContainerClient.DEFAULT_MTLS_ENDPOINT
    assert EdgeContainerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EdgeContainerClient._get_api_endpoint(None, None, default_universe, "always") == EdgeContainerClient.DEFAULT_MTLS_ENDPOINT
    assert (
        EdgeContainerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EdgeContainerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert EdgeContainerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EdgeContainerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EdgeContainerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EdgeContainerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EdgeContainerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
def test_edge_container_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "edgecontainer.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://edgecontainer.googleapis.com"
        )
...
def test_get_cluster(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_cluster), "__call__") as call:
        ...
        call.return_value = resources.Cluster(
            ...
            external_load_balancer_ipv4_address_pools=["external_load_balancer_ipv4_address_pools_value"],
            ...
            external_load_balancer_ipv6_address_pools=["external_load_balancer_ipv6_address_pools_value"],
        )
    ...
    assert response.external_load_balancer_ipv4_address_pools == ["external_load_balancer_ipv4_address_pools_value"]
    ...
    assert response.external_load_balancer_ipv6_address_pools == ["external_load_balancer_ipv6_address_pools_value"]
...
@pytest.mark.asyncio
async def test_upgrade_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.upgrade_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.upgrade_cluster] = mock_rpc
...
@pytest.mark.asyncio
async def test_upgrade_cluster_async(transport: str = "grpc_asyncio", request_type=service.UpgradeClusterRequest):
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_generate_offline_credential_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.generate_offline_credential), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.generate_offline_credential(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_generate_offline_credential_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.generate_offline_credential in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_offline_credential] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_offline_credential_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_offline_credential in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_offline_credential] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_offline_credential_async(transport: str = "grpc_asyncio", request_type=service.GenerateOfflineCredentialRequest):
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_generate_offline_credential_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.generate_offline_credential), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.GenerateOfflineCredentialResponse())
        await client.generate_offline_credential(request)
...
def test_list_node_pools_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_node_pools), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_node_pools(request={}, retry=retry, timeout=timeout)
...
def test_list_machines_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_machines), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.list_machines(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_machines_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_machines in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_machines] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_machines_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_machines in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_machines] = mock_rpc
...
def test_list_machines_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_machines), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_machines(request={}, retry=retry, timeout=timeout)
...
def test_get_machine_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.get_machine), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.get_machine(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_machine_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_machine in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_machine] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_machine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_machine in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_machine] = mock_rpc
...
def test_list_vpn_connections_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.list_vpn_connections(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_vpn_connections_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_vpn_connections in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_vpn_connections] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_vpn_connections_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_vpn_connections in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_vpn_connections] = mock_rpc
...
def test_list_vpn_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_vpn_connections(request={}, retry=retry, timeout=timeout)
...
def test_get_vpn_connection_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.get_vpn_connection), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.get_vpn_connection(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_vpn_connection_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_vpn_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_vpn_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_vpn_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_vpn_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_vpn_connection] = mock_rpc
...
def test_create_vpn_connection_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.create_vpn_connection), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.create_vpn_connection(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_vpn_connection_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_vpn_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_vpn_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_vpn_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_vpn_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_vpn_connection] = mock_rpc
...
def test_delete_vpn_connection_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.delete_vpn_connection), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.delete_vpn_connection(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_delete_vpn_connection_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_vpn_connection in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_vpn_connection] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_vpn_connection_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EdgeContainerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_vpn_connection in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_vpn_connection] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_server_config_async(transport: str = "grpc_asyncio", request_type=service.GetServerConfigRequest):
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_upgrade_cluster_rest_required_fields(request_type=service.UpgradeClusterRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).upgrade_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_upgrade_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/clusters/*}:upgrade" % client.transport._host, args[1])
...
def test_generate_offline_credential_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
...
def test_generate_offline_credential_rest_required_fields(request_type=service.GenerateOfflineCredentialRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_offline_credential._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_generate_offline_credential_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{cluster=projects/*/locations/*/clusters/*}:generateOfflineCredential" % client.transport._host, args[1])
...
def test_get_machine_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
...
def test_list_vpn_connections_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
...
def test_list_vpn_connections_rest_required_fields(request_type=service.ListVpnConnectionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_vpn_connections._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_vpn_connection_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
...
def test_create_vpn_connection_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
...
def test_create_vpn_connection_rest_required_fields(request_type=service.CreateVpnConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_vpn_connection._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_vpn_connection_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EdgeContainerClient(
...
def test_delete_vpn_connection_rest_required_fields(request_type=service.DeleteVpnConnectionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_vpn_connection._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_server_config_rest_required_fields(request_type=service.GetServerConfigRequest):
    transport_class = transports.EdgeContainerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_server_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = EdgeContainerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_generate_access_token_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.generate_access_token), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GenerateAccessTokenRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_offline_credential_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.generate_offline_credential), "__call__") as call:
        call.return_value = service.GenerateOfflineCredentialResponse()
        client.generate_offline_credential(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GenerateOfflineCredentialRequest()
...
def test_list_node_pools_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_node_pools), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListNodePoolsRequest()
...
def test_get_node_pool_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_node_pool), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetNodePoolRequest()
...
def test_create_node_pool_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_node_pool), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.CreateNodePoolRequest()
...
def test_delete_node_pool_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_node_pool), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.DeleteNodePoolRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_machines_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_machines), "__call__") as call:
        call.return_value = service.ListMachinesResponse()
        client.list_machines(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListMachinesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_machine_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_machine), "__call__") as call:
        call.return_value = resources.Machine()
        client.get_machine(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_vpn_connections_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), "__call__") as call:
        call.return_value = service.ListVpnConnectionsResponse()
        client.list_vpn_connections(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.ListVpnConnectionsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vpn_connection_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_vpn_connection), "__call__") as call:
        call.return_value = resources.VpnConnection()
        client.get_vpn_connection(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetVpnConnectionRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_vpn_connection_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_vpn_connection), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_vpn_connection(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_vpn_connection_empty_call_grpc():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_vpn_connection), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_vpn_connection(request=None)
...
def test_get_server_config_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_server_config), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service.GetServerConfigRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = EdgeContainerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = EdgeContainerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_generate_offline_credential_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.generate_offline_credential), "__call__") as call:
        ...
        await client.generate_offline_credential(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_machines_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_machines), "__call__") as call:
        ...
        await client.list_machines(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_machine_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_machine), "__call__") as call:
        ...
        await client.get_machine(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_vpn_connections_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), "__call__") as call:
        ...
        await client.list_vpn_connections(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_vpn_connection_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_vpn_connection), "__call__") as call:
        ...
        await client.get_vpn_connection(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_vpn_connection_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_vpn_connection), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_vpn_connection(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_vpn_connection_empty_call_grpc_asyncio():
    client = EdgeContainerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_vpn_connection), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_vpn_connection(request=None)
...
def test_transport_kind_rest():
    transport = EdgeContainerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_clusters") as post, mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListClustersResponse.to_json(service.ListClustersResponse())
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_cluster") as post, mock.patch.object(
...
def test_create_cluster_rest_call_success(request_type):
    ...
    request_init["cluster"] = {
        ...
        "networking": {
            "cluster_ipv4_cidr_blocks": ["cluster_ipv4_cidr_blocks_value1", "cluster_ipv4_cidr_blocks_value2"],
            "services_ipv4_cidr_blocks": ["services_ipv4_cidr_blocks_value1", "services_ipv4_cidr_blocks_value2"],
        },
        ...
        "cluster_ca_certificate": "cluster_ca_certificate_value",
        "maintenance_policy": {
            "window": {"recurring_window": {"window": {"start_time": {}, "end_time": {}}, "recurrence": "recurrence_value"}},
        ...
        "system_addons_config": {"ingress": {"disabled": True, "ipv4_vip": "ipv4_vip_value"}, "vm_service_config": {"vmm_enabled": True}},
...
def test_generate_access_token_rest_bad_request(request_type=service.GenerateAccessTokenRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_generate_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_generate_access_token") as post, mock.patch.object(
        transports.EdgeContainerRestInterceptor, "post_generate_access_token_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.GenerateAccessTokenResponse.to_json(service.GenerateAccessTokenResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.GenerateAccessTokenResponse(), metadata
...
def test_generate_offline_credential_rest_bad_request(request_type=service.GenerateOfflineCredentialRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"cluster": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_generate_offline_credential_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_generate_offline_credential_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_generate_offline_credential") as post, mock.patch.object(
        transports.EdgeContainerRestInterceptor, "post_generate_offline_credential_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = service.GenerateOfflineCredentialRequest.pb(service.GenerateOfflineCredentialRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.GenerateOfflineCredentialResponse.to_json(service.GenerateOfflineCredentialResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service.GenerateOfflineCredentialResponse(), metadata
...
def test_list_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_node_pools") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListNodePoolsResponse.to_json(service.ListNodePoolsResponse())
        req.return_value.content = return_value
...
def test_get_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_node_pool") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.NodePool.to_json(resources.NodePool())
        req.return_value.content = return_value
...
def test_create_node_pool_rest_call_success(request_type):
    ...
    request_init["node_pool"] = {
        ...
        "node_version": "node_version_value",
        "node_config": {"labels": {}, "node_storage_schema": "node_storage_schema_value"},
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_list_machines_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_machines_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_machines") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListMachinesResponse.to_json(service.ListMachinesResponse())
        req.return_value.content = return_value
...
def test_get_machine_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_machine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_machine") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.Machine.to_json(resources.Machine())
        req.return_value.content = return_value
...
def test_list_vpn_connections_rest_bad_request(request_type=service.ListVpnConnectionsRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_vpn_connections_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_vpn_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_list_vpn_connections") as post, mock.patch.object(
        transports.EdgeContainerRestInterceptor, "post_list_vpn_connections_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service.ListVpnConnectionsResponse.to_json(service.ListVpnConnectionsResponse())
        req.return_value.content = return_value
...
def test_get_vpn_connection_rest_bad_request(request_type=service.GetVpnConnectionRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_vpn_connection_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_vpn_connection") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.VpnConnection.to_json(resources.VpnConnection())
        req.return_value.content = return_value
...
def test_create_vpn_connection_rest_bad_request(request_type=service.CreateVpnConnectionRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_vpn_connection_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["vpn_connection"] = {
        ...
        "cluster": "cluster_value",
        "vpc": "vpc_value",
        "vpc_project": {"project_id": "project_id_value", "service_account": "service_account_value"},
        "enable_high_availability": True,
        "router": "router_value",
        "details": {"state": 1, "error": "error_value", "cloud_router": {"name": "name_value"}, "cloud_vpns": [{"gateway": "gateway_value"}]},
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EdgeContainerRestInterceptor, "post_create_vpn_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_vpn_connection_rest_bad_request(request_type=service.DeleteVpnConnectionRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/vpnConnections/sample3"}
    request = request_type(**request_init)
...
def test_delete_vpn_connection_rest_call_success(request_type):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_vpn_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EdgeContainerRestInterceptor, "post_delete_vpn_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_server_config_rest_bad_request(request_type=service.GetServerConfigRequest):
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, "post_get_server_config") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.ServerConfig.to_json(resources.ServerConfig())
        req.return_value.content = return_value
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_offline_credential_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_machines_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_machine_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_vpn_connections_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vpn_connection_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_vpn_connection_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_vpn_connection_empty_call_rest():
    client = EdgeContainerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.EdgeContainerGrpcTransport, grpc_helpers), (transports.EdgeContainerGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_edge_container_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "edgecontainer.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://edgecontainer.googleapis.com:8000"
    )
...
async def test_get_location_field_headers_async():
    client = EdgeContainerAsyncClient(credentials=async_anonymous_credentials())

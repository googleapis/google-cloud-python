...
class HealthProfileServiceTransport(abc.ABC):
    """Abstract transport class for HealthProfileService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_identity: gapic_v1.method.wrap_method(
                self.get_identity,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.get_irn_profile: gapic_v1.method.wrap_method(
            ...
            self.get_paired_device: gapic_v1.method.wrap_method(
            ...
            self.list_paired_devices: gapic_v1.method.wrap_method(
    ...
    def get_profile(
        ...
        Union[health_profile.Profile, Awaitable[health_profile.Profile]],
    ]:
        raise NotImplementedError()
    ...
    def get_settings(
        ...
        Union[health_profile.Settings, Awaitable[health_profile.Settings]],
    ]:
        raise NotImplementedError()
    ...
    def get_identity(
        ...
        Union[health_profile.Identity, Awaitable[health_profile.Identity]],
    ]:
        raise NotImplementedError()
    ...
    def get_irn_profile(
        ...
        Union[health_profile.IrnProfile, Awaitable[health_profile.IrnProfile]],
    ]:
        raise NotImplementedError()
    ...
    def get_paired_device(
        ...
        Union[health_profile.PairedDevice, Awaitable[health_profile.PairedDevice]],
    ]:
        raise NotImplementedError()

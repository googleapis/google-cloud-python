...
class DataSubscriptionServiceGrpcTransport(DataSubscriptionServiceTransport):
    """gRPC backend transport for DataSubscriptionService.
    ...
    def create_subscriber(
        ...
        r"""Return a callable for the create subscriber method over gRPC.

        Registers a new subscriber endpoint to receive notifications. A
        ...
        **Endpoint Verification:** For a subscriber to be successfully
        ...
        Returns:
            Callable[[~.CreateSubscriberRequest],
                    ~.Operation]:
        ...
        if "create_subscriber" not in self._stubs:
            self._stubs["create_subscriber"] = self._logged_channel.unary_unary(
                "/google.devicesandservices.health.v4.DataSubscriptionService/CreateSubscriber",
                request_serializer=data_subscription_service.CreateSubscriberRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["create_subscriber"]
    ...
    def list_subscribers(
        ...
        Lists all subscribers registered within the owned
        ...
        if "list_subscribers" not in self._stubs:
            self._stubs["list_subscribers"] = self._logged_channel.unary_unary(
                ...
                request_serializer=data_subscription_service.ListSubscribersRequest.serialize,
                response_deserializer=data_subscription_service.ListSubscribersResponse.deserialize,
            )
    ...
    def update_subscriber(
        ...
        r"""Return a callable for the update subscriber method over gRPC.
        ...
        **Endpoint Verification:** If the ``endpoint_uri`` or
        ...
        Returns:
            Callable[[~.UpdateSubscriberRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_subscriber" not in self._stubs:
            self._stubs["update_subscriber"] = self._logged_channel.unary_unary(
                "/google.devicesandservices.health.v4.DataSubscriptionService/UpdateSubscriber",
                request_serializer=data_subscription_service.UpdateSubscriberRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["update_subscriber"]
    ...
    def delete_subscriber(
        ...
        r"""Return a callable for the delete subscriber method over gRPC.

        Deletes a subscriber registration. This will stop all
        notifications to the subscriber's endpoint.

        Returns:
            Callable[[~.DeleteSubscriberRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_subscriber" not in self._stubs:
            self._stubs["delete_subscriber"] = self._logged_channel.unary_unary(
                "/google.devicesandservices.health.v4.DataSubscriptionService/DeleteSubscriber",
                request_serializer=data_subscription_service.DeleteSubscriberRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["delete_subscriber"]
    ...
    def create_subscription(
        ...
        Creates a subscription for a specific user to a specific
        ...
        if "create_subscription" not in self._stubs:
            self._stubs["create_subscription"] = self._logged_channel.unary_unary(
                ...
                request_serializer=data_subscription_service.CreateSubscriptionRequest.serialize,
                response_deserializer=data_subscription_service.Subscription.deserialize,
            )
    ...
    def list_subscriptions(
        ...
        if "list_subscriptions" not in self._stubs:
            self._stubs["list_subscriptions"] = self._logged_channel.unary_unary(
                ...
                request_serializer=data_subscription_service.ListSubscriptionsRequest.serialize,
                response_deserializer=data_subscription_service.ListSubscriptionsResponse.deserialize,
            )
    ...
    def update_subscription(
        ...
        Updates the data types for an existing user
        subscription.
        ...
        if "update_subscription" not in self._stubs:
            self._stubs["update_subscription"] = self._logged_channel.unary_unary(
                ...
                request_serializer=data_subscription_service.UpdateSubscriptionRequest.serialize,
                response_deserializer=data_subscription_service.Subscription.deserialize,
            )
    ...
    def delete_subscription(
        ...
        if "delete_subscription" not in self._stubs:
            self._stubs["delete_subscription"] = self._logged_channel.unary_unary(
                ...
                request_serializer=data_subscription_service.DeleteSubscriptionRequest.serialize,
...
__all__ = ("DataSubscriptionServiceGrpcTransport",)

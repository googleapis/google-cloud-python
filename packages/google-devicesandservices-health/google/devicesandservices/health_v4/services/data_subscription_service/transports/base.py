...
class DataSubscriptionServiceTransport(abc.ABC):
    """Abstract transport class for DataSubscriptionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_subscriber: gapic_v1.method.wrap_method(
            ...
            self.update_subscriber: gapic_v1.method.wrap_method(
                self.update_subscriber,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_subscriber: gapic_v1.method.wrap_method(
    ...
    def create_subscription(
        ...
        Union[
            ...
            Awaitable[data_subscription_service.Subscription],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("DataSubscriptionServiceTransport",)

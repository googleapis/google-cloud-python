...
class DataSubscriptionServiceGrpcAsyncIOTransport(DataSubscriptionServiceTransport):
    """gRPC AsyncIO backend transport for DataSubscriptionService.
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_subscriber: self._wrap_method(
            ...
            self.update_subscriber: self._wrap_method(
                self.update_subscriber,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_subscriber: self._wrap_method(
...
__all__ = ("DataSubscriptionServiceGrpcAsyncIOTransport",)

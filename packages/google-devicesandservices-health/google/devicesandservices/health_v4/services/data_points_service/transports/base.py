...
class DataPointsServiceTransport(abc.ABC):
    """Abstract transport class for DataPointsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_data_point: gapic_v1.method.wrap_method(
                self.get_data_point,
            ...
            self.list_data_points: gapic_v1.method.wrap_method(
            ...
            self.create_data_point: gapic_v1.method.wrap_method(
                self.create_data_point,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_data_point: gapic_v1.method.wrap_method(
                self.update_data_point,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.batch_delete_data_points: gapic_v1.method.wrap_method(
            ...
            self.reconcile_data_points: gapic_v1.method.wrap_method(
            ...
            self.roll_up_data_points: gapic_v1.method.wrap_method(
            ...
            self.daily_roll_up_data_points: gapic_v1.method.wrap_method(
            ...
            self.export_exercise_tcx: gapic_v1.method.wrap_method(
    ...
    def get_data_point(
        ...
        Union[data_points.DataPoint, Awaitable[data_points.DataPoint]],
    ]:
        raise NotImplementedError()
...
__all__ = ("DataPointsServiceTransport",)

...
from .transports.base import DEFAULT_CLIENT_INFO, PhishingProtectionServiceV1Beta1Transport
...
class PhishingProtectionServiceV1Beta1AsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = PhishingProtectionServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, PhishingProtectionServiceV1Beta1Transport, Callable[..., PhishingProtectionServiceV1Beta1Transport]]
        ] = "grpc_asyncio",
    ...
    async def report_phishing(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.report_phishing]

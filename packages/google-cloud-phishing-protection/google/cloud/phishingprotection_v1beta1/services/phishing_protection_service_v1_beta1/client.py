...
class PhishingProtectionServiceV1Beta1Client(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PhishingProtectionServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or PhishingProtectionServiceV1Beta1Client._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(
            transport, PhishingProtectionServiceV1Beta1Transport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or PhishingProtectionServiceV1Beta1Client._get_api_endpoint(

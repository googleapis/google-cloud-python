...
def test__get_client_cert_source():
    ...
    assert (
        PhishingProtectionServiceV1Beta1Client._get_client_cert_source(None, False)
        is None
    )
    assert (
        PhishingProtectionServiceV1Beta1Client._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(PhishingProtectionServiceV1Beta1Client),
)
@mock.patch.object(
    PhishingProtectionServiceV1Beta1AsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
...
def test__get_api_endpoint():
    ...
    default_endpoint = (
        PhishingProtectionServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
...
def test__get_universe_domain():
    ...
    assert (
        PhishingProtectionServiceV1Beta1Client._get_universe_domain(
    ...
    assert (
        PhishingProtectionServiceV1Beta1Client._get_universe_domain(None, None)
        == PhishingProtectionServiceV1Beta1Client._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_report_phishing_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.report_phishing
...
async def test_report_phishing_async(request_type, transport: str = "grpc_asyncio"):
    client = PhishingProtectionServiceV1Beta1AsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_report_phishing_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).report_phishing._get_unset_required_fields(jsonified_request)
...
def test_report_phishing_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*}/phishing:report" % client.transport._host,
            args[1],
        )
...
def test_transport_kind_grpc_asyncio():
    transport = PhishingProtectionServiceV1Beta1AsyncClient.get_transport_class(
        "grpc_asyncio"
    )(credentials=async_anonymous_credentials())
...
def test_report_phishing_rest_bad_request(
    request_type=phishingprotection.ReportPhishingRequest,
):
    client = PhishingProtectionServiceV1Beta1Client(
...
def test_report_phishing_rest_interceptors(null_interceptor):
    transport = transports.PhishingProtectionServiceV1Beta1RestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.PhishingProtectionServiceV1Beta1RestInterceptor(),
    )
    client = PhishingProtectionServiceV1Beta1Client(transport=transport)
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = phishingprotection.ReportPhishingResponse.to_json(
            phishingprotection.ReportPhishingResponse()
        )
...
def test_phishing_protection_service_v1_beta1_client_transport_session_collision(
    transport_name,
):

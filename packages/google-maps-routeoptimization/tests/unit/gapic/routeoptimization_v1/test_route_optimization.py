...
def test_optimize_tours_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseOptimizeTours,
...
def test_batch_optimize_tours_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchOptimizeTours,
...
def test_optimize_tours_long_running_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseOptimizeToursLongRunning,
...
def test_optimize_tours_uri_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseOptimizeToursUri,

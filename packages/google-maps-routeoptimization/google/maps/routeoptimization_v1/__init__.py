...
from .services.route_optimization import RouteOptimizationAsyncClient, RouteOptimizationClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.maps.routeoptimization_v1")  # type: ignore
    api_core.check_dependency_versions("google.maps.routeoptimization_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.routeoptimization_v1"

...
class RouteOptimizationClient(metaclass=RouteOptimizationClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RouteOptimizationClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RouteOptimizationClient._read_environment_variables()
        self._client_cert_source = RouteOptimizationClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RouteOptimizationClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or RouteOptimizationClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RouteOptimizationTransport], Callable[..., RouteOptimizationTransport]] = (
    ...
    def optimize_tours_long_running(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.optimize_tours_long_running]

...
class RouteOptimizationGrpcAsyncIOTransport(RouteOptimizationTransport):
    ...
    def optimize_tours(
        self,
    ) -> Callable[[route_optimization_service.OptimizeToursRequest], Awaitable[route_optimization_service.OptimizeToursResponse]]:
    ...
    @property
    def batch_optimize_tours(self) -> Callable[[route_optimization_service.BatchOptimizeToursRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def optimize_tours_long_running(self) -> Callable[[route_optimization_service.OptimizeToursRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def optimize_tours_uri(self) -> Callable[[route_optimization_service.OptimizeToursUriRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.optimize_tours_long_running: self._wrap_method(
                self.optimize_tours_long_running,
                default_timeout=None,
                client_info=client_info,
            ),
            self.optimize_tours_uri: self._wrap_method(

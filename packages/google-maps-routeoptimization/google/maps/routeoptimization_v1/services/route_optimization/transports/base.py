...
class RouteOptimizationTransport(abc.ABC):
    ...
    def optimize_tours(
        ...
        Union[route_optimization_service.OptimizeToursResponse, Awaitable[route_optimization_service.OptimizeToursResponse]],
    ]:
        raise NotImplementedError()
    ...
    def batch_optimize_tours(
        self,
    ) -> Callable[[route_optimization_service.BatchOptimizeToursRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def optimize_tours_long_running(
        self,
    ) -> Callable[[route_optimization_service.OptimizeToursRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def optimize_tours_uri(
        self,
    ) -> Callable[[route_optimization_service.OptimizeToursUriRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
`Network Management API`_: The Network Management API provides a collection of network performance
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-network-management.svg
   :target: https://pypi.org/project/google-cloud-network-management/
.. _Network Management API: 
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-network-management/latest/summary_overview
...
.. _Enable the Network Management API.:  
...
.. _Network Management API Product documentation:  

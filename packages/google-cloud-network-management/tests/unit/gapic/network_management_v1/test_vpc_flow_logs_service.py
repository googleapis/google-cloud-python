...
@pytest.mark.parametrize(
    ...
    [
        (VpcFlowLogsServiceClient, "grpc"),
        (VpcFlowLogsServiceAsyncClient, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (transports.VpcFlowLogsServiceGrpcTransport, "grpc"),
        (transports.VpcFlowLogsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_vpc_flow_logs_service_client_get_transport_class():
    transport = VpcFlowLogsServiceClient.get_transport_class()
    ...
    assert transport == transports.VpcFlowLogsServiceGrpcTransport
...
def test_vpc_flow_logs_service_client_client_options_from_dict():
    with mock.patch(
...
def test_list_vpc_flow_logs_configs(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.list_vpc_flow_logs_configs(request)
    ...
    assert isinstance(response, pagers.ListVpcFlowLogsConfigsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_vpc_flow_logs_configs_non_empty_request_with_auto_populated_field():
...
async def test_list_vpc_flow_logs_configs_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_vpc_flow_logs_configs(request)
...
@pytest.mark.asyncio
async def test_list_vpc_flow_logs_configs_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_vpc_flow_logs_configs_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_vpc_flow_logs_configs_flattened_error():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_vpc_flow_logs_configs_flattened_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_vpc_flow_logs_configs_flattened_error_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_vpc_flow_logs_configs(
            vpc_flow_logs.ListVpcFlowLogsConfigsRequest(),
            parent="parent_value",
        )


def test_list_vpc_flow_logs_configs_pager(transport_name: str = "grpc"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_vpc_flow_logs_configs_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_vpc_flow_logs_configs(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_vpc_flow_logs_configs_async_pager():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_vpc_flow_logs_configs(
            request={},
        )
...
@pytest.mark.asyncio
async def test_list_vpc_flow_logs_configs_async_pages():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_vpc_flow_logs_configs(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_vpc_flow_logs_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = vpc_flow_logs_config.VpcFlowLogsConfig(
            ...
            state=vpc_flow_logs_config.VpcFlowLogsConfig.State.ENABLED,
            aggregation_interval=vpc_flow_logs_config.VpcFlowLogsConfig.AggregationInterval.INTERVAL_5_SEC,
            flow_sampling=0.1394,
            metadata=vpc_flow_logs_config.VpcFlowLogsConfig.Metadata.INCLUDE_ALL_METADATA,
            metadata_fields=["metadata_fields_value"],
            filter_expr="filter_expr_value",
            cross_project_metadata=vpc_flow_logs_config.VpcFlowLogsConfig.CrossProjectMetadata.CROSS_PROJECT_METADATA_ENABLED,
            target_resource_state=vpc_flow_logs_config.VpcFlowLogsConfig.TargetResourceState.TARGET_RESOURCE_EXISTS,
            network="network_value",
        )
        response = client.get_vpc_flow_logs_config(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, vpc_flow_logs_config.VpcFlowLogsConfig)
...
async def test_get_vpc_flow_logs_config_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_vpc_flow_logs_config(request)
...
@pytest.mark.asyncio
async def test_get_vpc_flow_logs_config_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_vpc_flow_logs_config_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_vpc_flow_logs_config_flattened_error():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_vpc_flow_logs_config_flattened_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_vpc_flow_logs_config_flattened_error_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_vpc_flow_logs_config(
            vpc_flow_logs.GetVpcFlowLogsConfigRequest(),
            name="name_value",
        )
...
def test_create_vpc_flow_logs_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_vpc_flow_logs_config_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_vpc_flow_logs_config_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].vpc_flow_logs_config
        mock_val = gcn_vpc_flow_logs_config.VpcFlowLogsConfig(name="name_value")
        assert arg == mock_val
        arg = args[0].vpc_flow_logs_config_id
        mock_val = "vpc_flow_logs_config_id_value"
        assert arg == mock_val


def test_create_vpc_flow_logs_config_flattened_error():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_vpc_flow_logs_config_flattened_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_vpc_flow_logs_config_flattened_error_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_vpc_flow_logs_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_vpc_flow_logs_config_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "vpc_flow_logs_config.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_vpc_flow_logs_config_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_vpc_flow_logs_config_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_vpc_flow_logs_config_flattened_error():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_vpc_flow_logs_config_flattened_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_vpc_flow_logs_config_flattened_error_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_vpc_flow_logs_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_vpc_flow_logs_config_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_vpc_flow_logs_config_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_vpc_flow_logs_config_flattened_error():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_vpc_flow_logs_config_flattened_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_vpc_flow_logs_config_flattened_error_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_query_org_vpc_flow_logs_configs(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.query_org_vpc_flow_logs_configs(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.QueryOrgVpcFlowLogsConfigsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]
...
async def test_query_org_vpc_flow_logs_configs_async(
    ...
    with mock.patch.object(
        ...
        response = await client.query_org_vpc_flow_logs_configs(request)
...
@pytest.mark.asyncio
async def test_query_org_vpc_flow_logs_configs_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_query_org_vpc_flow_logs_configs_pager(transport_name: str = "grpc"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
def test_query_org_vpc_flow_logs_configs_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.query_org_vpc_flow_logs_configs(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_query_org_vpc_flow_logs_configs_async_pager():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.query_org_vpc_flow_logs_configs(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        assert str(async_pager).startswith(f"{async_pager.__class__.__name__}<")
...
@pytest.mark.asyncio
async def test_query_org_vpc_flow_logs_configs_async_pages():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_show_effective_flow_logs_configs(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.show_effective_flow_logs_configs(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ShowEffectiveFlowLogsConfigsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]
...
async def test_show_effective_flow_logs_configs_async(
    ...
    with mock.patch.object(
        ...
        response = await client.show_effective_flow_logs_configs(request)
...
@pytest.mark.asyncio
async def test_show_effective_flow_logs_configs_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_show_effective_flow_logs_configs_pager(transport_name: str = "grpc"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
        ...
        call.side_effect = (
            vpc_flow_logs.ShowEffectiveFlowLogsConfigsResponse(
                effective_flow_logs_configs=[
                    vpc_flow_logs_config.EffectiveVpcFlowLogsConfig(),
                    vpc_flow_logs_config.EffectiveVpcFlowLogsConfig(),
                    vpc_flow_logs_config.EffectiveVpcFlowLogsConfig(),
                ],
                next_page_token="abc",
...
def test_show_effective_flow_logs_configs_pages(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pages = list(client.show_effective_flow_logs_configs(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_show_effective_flow_logs_configs_async_pager():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        async_pager = await client.show_effective_flow_logs_configs(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        assert str(async_pager).startswith(f"{async_pager.__class__.__name__}<")
...
@pytest.mark.asyncio
async def test_show_effective_flow_logs_configs_async_pages():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_vpc_flow_logs_configs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListVpcFlowLogsConfigs,
    ...
    return_value = vpc_flow_logs.ListVpcFlowLogsConfigsResponse()
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = vpc_flow_logs.ListVpcFlowLogsConfigsResponse.pb(return_value)
...
def test_list_vpc_flow_logs_configs_rest_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_vpc_flow_logs_configs(**mock_args)
...
def test_list_vpc_flow_logs_configs_rest_pager(transport: str = "rest"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_vpc_flow_logs_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpcFlowLogsServiceClient(
...
def test_get_vpc_flow_logs_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetVpcFlowLogsConfig,
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = vpc_flow_logs_config.VpcFlowLogsConfig.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_vpc_flow_logs_config_rest_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_vpc_flow_logs_config(**mock_args)
...
def test_create_vpc_flow_logs_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpcFlowLogsServiceClient(
...
def test_create_vpc_flow_logs_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateVpcFlowLogsConfig,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("vpcFlowLogsConfigId",))

    # verify required fields with non-default values are left alone
    assert "parent" in jsonified_request
    assert jsonified_request["parent"] == "parent_value"
    assert "vpcFlowLogsConfigId" in jsonified_request
    assert jsonified_request["vpcFlowLogsConfigId"] == "vpc_flow_logs_config_id_value"
...
def test_create_vpc_flow_logs_config_rest_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_vpc_flow_logs_config(**mock_args)
...
def test_update_vpc_flow_logs_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpcFlowLogsServiceClient(
...
def test_update_vpc_flow_logs_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateVpcFlowLogsConfig,
...
def test_update_vpc_flow_logs_config_rest_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_vpc_flow_logs_config(**mock_args)
...
def test_update_vpc_flow_logs_config_rest_flattened_error(transport: str = "rest"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_vpc_flow_logs_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpcFlowLogsServiceClient(
...
def test_delete_vpc_flow_logs_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteVpcFlowLogsConfig,
...
def test_delete_vpc_flow_logs_config_rest_flattened():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_vpc_flow_logs_config(**mock_args)
...
def test_query_org_vpc_flow_logs_configs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpcFlowLogsServiceClient(
...
def test_query_org_vpc_flow_logs_configs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseQueryOrgVpcFlowLogsConfigs,
        "_BaseQueryOrgVpcFlowLogsConfigs__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    # Designate an appropriate value for the returned response.
    return_value = vpc_flow_logs.QueryOrgVpcFlowLogsConfigsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_query_org_vpc_flow_logs_configs_rest_pager(transport: str = "rest"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pager = client.query_org_vpc_flow_logs_configs(request=sample_request)
...
def test_show_effective_flow_logs_configs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VpcFlowLogsServiceClient(
...
def test_show_effective_flow_logs_configs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseShowEffectiveFlowLogsConfigs,
        "_BaseShowEffectiveFlowLogsConfigs__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    # Designate an appropriate value for the returned response.
    return_value = vpc_flow_logs.ShowEffectiveFlowLogsConfigsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
...
def test_show_effective_flow_logs_configs_rest_pager(transport: str = "rest"):
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        pager = client.show_effective_flow_logs_configs(request=sample_request)
...
def test_transport_get_channel():
    ...
    transport = transports.VpcFlowLogsServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_vpc_flow_logs_configs_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vpc_flow_logs_config_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_vpc_flow_logs_config_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_vpc_flow_logs_config_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_vpc_flow_logs_config_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_org_vpc_flow_logs_configs_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_show_effective_flow_logs_configs_empty_call_grpc():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_vpc_flow_logs_configs_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.list_vpc_flow_logs_configs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_vpc_flow_logs_config_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_vpc_flow_logs_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_vpc_flow_logs_config_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_vpc_flow_logs_config_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_vpc_flow_logs_config_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_query_org_vpc_flow_logs_configs_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.query_org_vpc_flow_logs_configs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_show_effective_flow_logs_configs_empty_call_grpc_asyncio():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.show_effective_flow_logs_configs(request=None)
...
def test_create_vpc_flow_logs_config_rest_call_success(request_type):
    ...
    request_init["vpc_flow_logs_config"] = {
        ...
        "filter_expr": "filter_expr_value",
        "cross_project_metadata": 1,
        "target_resource_state": 1,
        "network": "network_value",
        "subnet": "subnet_value",
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["vpc_flow_logs_config"][field])):
                    del request_init["vpc_flow_logs_config"][field][i][subfield]
            else:
                del request_init["vpc_flow_logs_config"][field][subfield]
    request = request_type(**request_init)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_vpc_flow_logs_configs_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_vpc_flow_logs_config_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_vpc_flow_logs_config_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_vpc_flow_logs_config_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_vpc_flow_logs_config_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_org_vpc_flow_logs_configs_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_show_effective_flow_logs_configs_empty_call_rest():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_vpc_flow_logs_service_rest_lro_client():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_vpc_flow_logs_service_auth_adc():
...
def test_vpc_flow_logs_service_transport_auth_adc(transport_class):
...
def test_vpc_flow_logs_service_transport_auth_gdch_credentials(transport_class):
...
def test_vpc_flow_logs_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = VpcFlowLogsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = VpcFlowLogsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.list_vpc_flow_logs_configs._session
    session2 = client2.transport.list_vpc_flow_logs_configs._session
    assert session1 != session2
    session1 = client1.transport.get_vpc_flow_logs_config._session
    session2 = client2.transport.get_vpc_flow_logs_config._session
    assert session1 != session2
    session1 = client1.transport.create_vpc_flow_logs_config._session
    session2 = client2.transport.create_vpc_flow_logs_config._session
    assert session1 != session2
    session1 = client1.transport.update_vpc_flow_logs_config._session
    session2 = client2.transport.update_vpc_flow_logs_config._session
    assert session1 != session2
    session1 = client1.transport.delete_vpc_flow_logs_config._session
    session2 = client2.transport.delete_vpc_flow_logs_config._session
    assert session1 != session2
    session1 = client1.transport.query_org_vpc_flow_logs_configs._session
    session2 = client2.transport.query_org_vpc_flow_logs_configs._session
    assert session1 != session2
    session1 = client1.transport.show_effective_flow_logs_configs._session
    session2 = client2.transport.show_effective_flow_logs_configs._session
    assert session1 != session2


def test_vpc_flow_logs_service_grpc_transport_channel():
...
def test_vpc_flow_logs_service_grpc_asyncio_transport_channel():
...
def test_vpc_flow_logs_service_grpc_lro_client():
    client = VpcFlowLogsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_vpc_flow_logs_service_grpc_lro_async_client():
    client = VpcFlowLogsServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc_asyncio",
    )
...
def test_vpc_flow_logs_config_path():
    project = "squid"
    location = "clam"
    vpc_flow_logs_config = "whelk"
    expected = "projects/{project}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}".format(
        project=project,
        location=location,
...
def test_parse_vpc_flow_logs_config_path():
    expected = {
        "project": "octopus",
        "location": "oyster",
        "vpc_flow_logs_config": "nudibranch",
    }
    path = VpcFlowLogsServiceClient.vpc_flow_logs_config_path(**expected)

    # Check that the path construction is reversible.
    actual = VpcFlowLogsServiceClient.parse_vpc_flow_logs_config_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = VpcFlowLogsServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = VpcFlowLogsServiceClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = VpcFlowLogsServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = VpcFlowLogsServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = VpcFlowLogsServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = VpcFlowLogsServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = VpcFlowLogsServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = VpcFlowLogsServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = VpcFlowLogsServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = VpcFlowLogsServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = VpcFlowLogsServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = VpcFlowLogsServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = VpcFlowLogsServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = VpcFlowLogsServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = VpcFlowLogsServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_get_location_field_headers():
    client = VpcFlowLogsServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = VpcFlowLogsServiceAsyncClient(credentials=async_anonymous_credentials())

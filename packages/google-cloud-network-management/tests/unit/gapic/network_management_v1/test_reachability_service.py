...
def test__get_client_cert_source():
    ...
    assert (
        ReachabilityServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ReachabilityServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ReachabilityServiceClient),
)
@mock.patch.object(
    ReachabilityServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ReachabilityServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ReachabilityServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ReachabilityServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ReachabilityServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ReachabilityServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ReachabilityServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ReachabilityServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ReachabilityServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ReachabilityServiceClient._get_universe_domain(None, None)
        == ReachabilityServiceClient._DEFAULT_UNIVERSE
    )
...
def test_list_connectivity_tests_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_connectivity_tests
...
@pytest.mark.asyncio
async def test_list_connectivity_tests_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_connectivity_tests
...
def test_get_connectivity_test_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_connectivity_test
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_connectivity_test] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_connectivity_test_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_connectivity_test
            in client._client._transport._wrapped_methods
        )
...
def test_create_connectivity_test_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_connectivity_test
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_connectivity_test_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_connectivity_test
            in client._client._transport._wrapped_methods
        )
...
def test_update_connectivity_test_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_connectivity_test
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_connectivity_test_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_connectivity_test
            in client._client._transport._wrapped_methods
        )
...
def test_rerun_connectivity_test_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.rerun_connectivity_test
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_rerun_connectivity_test_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.rerun_connectivity_test
            in client._client._transport._wrapped_methods
        )
...
def test_delete_connectivity_test_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_connectivity_test
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_connectivity_test_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_connectivity_test
            in client._client._transport._wrapped_methods
        )
...
def test_transport_kind_grpc_asyncio():
    transport = ReachabilityServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ReachabilityServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_connectivity_tests_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = reachability.ListConnectivityTestsResponse.to_json(
            reachability.ListConnectivityTestsResponse()
        )
...
def test_get_connectivity_test_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = connectivity_test.ConnectivityTest.to_json(
            connectivity_test.ConnectivityTest()
        )
        req.return_value.content = return_value

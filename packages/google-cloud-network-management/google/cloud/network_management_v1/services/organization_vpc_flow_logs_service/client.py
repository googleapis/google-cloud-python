...
from .transports.grpc import OrganizationVpcFlowLogsServiceGrpcTransport
from .transports.grpc_asyncio import OrganizationVpcFlowLogsServiceGrpcAsyncIOTransport
from .transports.rest import OrganizationVpcFlowLogsServiceRestTransport


class OrganizationVpcFlowLogsServiceClientMeta(type):
    """Metaclass for the OrganizationVpcFlowLogsService client.
    ...
    ) -> Type[OrganizationVpcFlowLogsServiceTransport]:
...
class OrganizationVpcFlowLogsServiceClient(metaclass=OrganizationVpcFlowLogsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OrganizationVpcFlowLogsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> OrganizationVpcFlowLogsServiceTransport:
        ...
        Returns:
            OrganizationVpcFlowLogsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = OrganizationVpcFlowLogsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OrganizationVpcFlowLogsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = OrganizationVpcFlowLogsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = OrganizationVpcFlowLogsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, OrganizationVpcFlowLogsServiceTransport, Callable[..., OrganizationVpcFlowLogsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OrganizationVpcFlowLogsServiceClient._read_environment_variables()
        self._client_cert_source = OrganizationVpcFlowLogsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = OrganizationVpcFlowLogsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, OrganizationVpcFlowLogsServiceTransport)
        if transport_provided:
            # transport is a OrganizationVpcFlowLogsServiceTransport instance.
            ...
            self._transport = cast(OrganizationVpcFlowLogsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or OrganizationVpcFlowLogsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OrganizationVpcFlowLogsServiceTransport], Callable[..., OrganizationVpcFlowLogsServiceTransport]] = (
                OrganizationVpcFlowLogsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., OrganizationVpcFlowLogsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networkmanagement_v1.OrganizationVpcFlowLogsServiceClient`.",
                    extra={
    ...
    def __enter__(self) -> "OrganizationVpcFlowLogsServiceClient":
        return self

    ...
    class _BaseDeleteVpcFlowLogsConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=organizations/*/locations/*/vpcFlowLogsConfigs/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateVpcFlowLogsConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{vpc_flow_logs_config.name=organizations/*/locations/*/vpcFlowLogsConfigs/*}",
                    "body": "vpc_flow_logs_config",
                },
            ]
            return http_options
...
__all__ = ("_BaseOrganizationVpcFlowLogsServiceRestTransport",)

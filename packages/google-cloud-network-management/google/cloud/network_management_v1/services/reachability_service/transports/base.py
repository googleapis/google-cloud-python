...
class ReachabilityServiceTransport(abc.ABC):
    ...
    def list_connectivity_tests(
        ...
        Union[reachability.ListConnectivityTestsResponse, Awaitable[reachability.ListConnectivityTestsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def get_connectivity_test(
        ...
        [reachability.GetConnectivityTestRequest], Union[connectivity_test.ConnectivityTest, Awaitable[connectivity_test.ConnectivityTest]]
    ]:
        raise NotImplementedError()
    ...
    def create_connectivity_test(
        self,
    ) -> Callable[[reachability.CreateConnectivityTestRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_connectivity_test(
        self,
    ) -> Callable[[reachability.UpdateConnectivityTestRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def rerun_connectivity_test(
        self,
    ) -> Callable[[reachability.RerunConnectivityTestRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_connectivity_test(
        self,
    ) -> Callable[[reachability.DeleteConnectivityTestRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
class _BaseReachabilityServiceRestTransport(ReachabilityServiceTransport):
    """Base REST backend transport for ReachabilityService.
    ...
    class _BaseDeleteConnectivityTest:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseGetConnectivityTest:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListConnectivityTests:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseRerunConnectivityTest:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateConnectivityTest:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseReachabilityServiceRestTransport",)

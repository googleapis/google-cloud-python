...
class ReachabilityServiceClient(metaclass=ReachabilityServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "networkmanagement.{UNIVERSE_DOMAIN}"
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ReachabilityServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ReachabilityServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ReachabilityServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ReachabilityServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ReachabilityServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ReachabilityServiceTransport, Callable[..., ReachabilityServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ReachabilityServiceClient._read_environment_variables()
        self._client_cert_source = ReachabilityServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ReachabilityServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ReachabilityServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ReachabilityServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ReachabilityServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ReachabilityServiceTransport], Callable[..., ReachabilityServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networkmanagement_v1.ReachabilityServiceClient`.",
                    extra={
    ...
    def list_connectivity_tests(
        self,
        request: Optional[Union[reachability.ListConnectivityTestsRequest, dict]] = None,
        *,
    ...
    def create_connectivity_test(
        self,
        request: Optional[Union[reachability.CreateConnectivityTestRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, test_id, resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def update_connectivity_test(
        self,
        request: Optional[Union[reachability.UpdateConnectivityTestRequest, dict]] = None,
        *,
    ...
    def rerun_connectivity_test(
        self,
        request: Optional[Union[reachability.RerunConnectivityTestRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def delete_connectivity_test(
        self,
        request: Optional[Union[reachability.DeleteConnectivityTestRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,

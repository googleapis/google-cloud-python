...
class VpcFlowLogsServiceClient(metaclass=VpcFlowLogsServiceClientMeta):
    ...
    def parse_vpc_flow_logs_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/vpcFlowLogsConfigs/(?P<vpc_flow_logs_config>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = VpcFlowLogsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = VpcFlowLogsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = VpcFlowLogsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or VpcFlowLogsServiceClient._get_api_endpoint(
    ...
    def list_vpc_flow_logs_configs(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_vpc_flow_logs_configs
        ]
    ...
    def create_vpc_flow_logs_config(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_vpc_flow_logs_config
        ]
    ...
    def update_vpc_flow_logs_config(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_vpc_flow_logs_config
        ]
    ...
    def delete_vpc_flow_logs_config(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_vpc_flow_logs_config
        ]

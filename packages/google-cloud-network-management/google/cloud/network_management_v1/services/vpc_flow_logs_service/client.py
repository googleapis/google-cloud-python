...
from .transports.grpc import VpcFlowLogsServiceGrpcTransport
from .transports.grpc_asyncio import VpcFlowLogsServiceGrpcAsyncIOTransport
from .transports.rest import VpcFlowLogsServiceRestTransport


class VpcFlowLogsServiceClientMeta(type):
    """Metaclass for the VpcFlowLogsService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[VpcFlowLogsServiceTransport]]
    _transport_registry["grpc"] = VpcFlowLogsServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = VpcFlowLogsServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = VpcFlowLogsServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[VpcFlowLogsServiceTransport]:
...
class VpcFlowLogsServiceClient(metaclass=VpcFlowLogsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            VpcFlowLogsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> VpcFlowLogsServiceTransport:
        ...
        Returns:
            VpcFlowLogsServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def vpc_flow_logs_config_path(
        project: str,
        location: str,
        vpc_flow_logs_config: str,
    ) -> str:
        """Returns a fully-qualified vpc_flow_logs_config string."""
        return "projects/{project}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_vpc_flow_logs_config_path(path: str) -> Dict[str, str]:
        """Parses a vpc_flow_logs_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/vpcFlowLogsConfigs/(?P<vpc_flow_logs_config>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = VpcFlowLogsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = VpcFlowLogsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = VpcFlowLogsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = VpcFlowLogsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, VpcFlowLogsServiceTransport, Callable[..., VpcFlowLogsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = VpcFlowLogsServiceClient._read_environment_variables()
        self._client_cert_source = VpcFlowLogsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = VpcFlowLogsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, VpcFlowLogsServiceTransport)
        if transport_provided:
            # transport is a VpcFlowLogsServiceTransport instance.
            ...
            self._transport = cast(VpcFlowLogsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or VpcFlowLogsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[VpcFlowLogsServiceTransport], Callable[..., VpcFlowLogsServiceTransport]] = (
                VpcFlowLogsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., VpcFlowLogsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networkmanagement_v1.VpcFlowLogsServiceClient`.",
                    extra={
    ...
    def list_vpc_flow_logs_configs(
        ...
        *,
    ...
    ) -> pagers.ListVpcFlowLogsConfigsPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_vpc_flow_logs_configs]
        ...
        response = pagers.ListVpcFlowLogsConfigsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_vpc_flow_logs_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceClient()
                ...
                # Make the request
                response = client.get_vpc_flow_logs_config(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_vpc_flow_logs_config]
    ...
    def create_vpc_flow_logs_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceClient()
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_vpc_flow_logs_config]
    ...
    def update_vpc_flow_logs_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_vpc_flow_logs_config():
                # Create a client
                client = network_management_v1.VpcFlowLogsServiceClient()
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_vpc_flow_logs_config]
    ...
    def delete_vpc_flow_logs_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_vpc_flow_logs_config]
    ...
    def query_org_vpc_flow_logs_configs(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_org_vpc_flow_logs_configs]
    ...
    def show_effective_flow_logs_configs(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.show_effective_flow_logs_configs]
    ...
    def __enter__(self) -> "VpcFlowLogsServiceClient":
        return self
...
__all__ = ("VpcFlowLogsServiceClient",)

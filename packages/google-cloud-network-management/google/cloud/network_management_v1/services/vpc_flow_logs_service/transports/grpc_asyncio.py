...
from .base import DEFAULT_CLIENT_INFO, VpcFlowLogsServiceTransport
...
class VpcFlowLogsServiceGrpcAsyncIOTransport(VpcFlowLogsServiceTransport):
    ...
    def list_vpc_flow_logs_configs(
        self,
    ) -> Callable[[vpc_flow_logs.ListVpcFlowLogsConfigsRequest], Awaitable[vpc_flow_logs.ListVpcFlowLogsConfigsResponse]]:
    ...
    @property
    def get_vpc_flow_logs_config(self) -> Callable[[vpc_flow_logs.GetVpcFlowLogsConfigRequest], Awaitable[vpc_flow_logs_config.VpcFlowLogsConfig]]:
    ...
    @property
    def create_vpc_flow_logs_config(self) -> Callable[[vpc_flow_logs.CreateVpcFlowLogsConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_vpc_flow_logs_config(self) -> Callable[[vpc_flow_logs.UpdateVpcFlowLogsConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_vpc_flow_logs_config(self) -> Callable[[vpc_flow_logs.DeleteVpcFlowLogsConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def query_org_vpc_flow_logs_configs(
        self,
    ) -> Callable[[vpc_flow_logs.QueryOrgVpcFlowLogsConfigsRequest], Awaitable[vpc_flow_logs.QueryOrgVpcFlowLogsConfigsResponse]]:
        ...
        if "query_org_vpc_flow_logs_configs" not in self._stubs:
            self._stubs["query_org_vpc_flow_logs_configs"] = self._logged_channel.unary_unary(
    ...
    def show_effective_flow_logs_configs(
        self,
    ) -> Callable[[vpc_flow_logs.ShowEffectiveFlowLogsConfigsRequest], Awaitable[vpc_flow_logs.ShowEffectiveFlowLogsConfigsResponse]]:
        ...
        if "show_effective_flow_logs_configs" not in self._stubs:
            self._stubs["show_effective_flow_logs_configs"] = self._logged_channel.unary_unary(
...
__all__ = ("VpcFlowLogsServiceGrpcAsyncIOTransport",)

...
from google.cloud.policysimulator_v1.services.simulator import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SimulatorClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        SimulatorClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        SimulatorClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert SimulatorClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert (
        SimulatorClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert SimulatorClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert SimulatorClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert SimulatorClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                SimulatorClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        SimulatorClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SimulatorClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SimulatorClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SimulatorClient),
)
@mock.patch.object(
    SimulatorAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SimulatorAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SimulatorClient._DEFAULT_UNIVERSE
    default_endpoint = SimulatorClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SimulatorClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == SimulatorClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SimulatorClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SimulatorClient._get_api_endpoint(None, None, default_universe, "always")
        == SimulatorClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SimulatorClient._get_api_endpoint(
    ...
    assert (
        SimulatorClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SimulatorClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SimulatorClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SimulatorClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SimulatorClient._get_universe_domain(None, None)
        == SimulatorClient._DEFAULT_UNIVERSE
    )
...
def test_simulator_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_simulator_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    SimulatorClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SimulatorClient)
)
@mock.patch.object(
    SimulatorAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SimulatorAsyncClient),
)
...
def test_simulator_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_simulator_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_simulator_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.policysimulator_v1.services.simulator.transports.SimulatorGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_simulator_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_get_replay_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_replay
...
@pytest.mark.asyncio
async def test_create_replay_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_replay
            in client._client._transport._wrapped_methods
        )
...
def test_list_replay_results(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_replay_results), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_list_replay_results_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_replay_results in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.list_replay_results] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_replay_results_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_replay_results
            in client._client._transport._wrapped_methods
        )
...
async def test_list_replay_results_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_replay_results(
            request={},
        )
...
def test_get_replay_rest_required_fields(request_type=simulator.GetReplayRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_replay._get_unset_required_fields(jsonified_request)
...
def test_get_replay_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/replays/*}" % client.transport._host,
            args[1],
        )
...
def test_create_replay_rest_required_fields(request_type=simulator.CreateReplayRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_replay._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_replay_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/replays" % client.transport._host,
            args[1],
        )
...
def test_list_replay_results_rest_required_fields(
    request_type=simulator.ListReplayResultsRequest,
):
    transport_class = transports.SimulatorRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_replay_results._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_replay_results_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "parent": "projects/sample1/locations/sample2/replays/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/replays/*}/results"
...
def test_list_replay_results_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            simulator.ListReplayResultsResponse.to_json(x) for x in response
        )
...
def test_create_replay_rest_call_success(request_type):
    ...
    request_init["replay"] = {
        "name": "name_value",
        "state": 1,
        "config": {"policy_overlay": {}, "log_source": 1},
        "results_summary": {
            "log_count": 970,
            "unchanged_count": 1589,
            "difference_count": 1683,
            "error_count": 1202,
            "oldest_date": {"year": 433, "month": 550, "day": 318},
            "newest_date": {},
        },
    }
...
def test_list_replay_results_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SimulatorRestInterceptor,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = simulator.ListReplayResultsResponse.to_json(
            simulator.ListReplayResultsResponse()
        )
        req.return_value.content = return_value
...
def test_simulator_base_transport():
    ...
    with mock.patch(
        "google.cloud.policysimulator_v1.services.simulator.transports.SimulatorTransport.__init__"
    ) as Transport:
...
def test_simulator_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.policysimulator_v1.services.simulator.transports.SimulatorTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
@pytest.mark.parametrize(
    "transport_class",
    [transports.SimulatorGrpcTransport, transports.SimulatorGrpcAsyncIOTransport],
)
...
def test_replay_path():
    ...
    location = "clam"
    replay = "whelk"
    expected = "projects/{project}/locations/{location}/replays/{replay}".format(
        project=project,
        location=location,
        replay=replay,
    )
...
def test_replay_result_path():
    ...
    expected = "projects/{project}/locations/{location}/replays/{replay}/results/{replay_result}".format(
        project=project,
        location=location,
        replay=replay,
        replay_result=replay_result,
    )
    actual = SimulatorClient.replay_result_path(
        project, location, replay, replay_result
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.SimulatorTransport, "_prep_wrapped_messages"
    ) as prep:
        client = SimulatorClient(
            credentials=ga_credentials.AnonymousCredentials(),

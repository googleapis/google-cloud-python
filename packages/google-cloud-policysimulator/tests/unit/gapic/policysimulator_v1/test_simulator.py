...
def test_list_replay_results_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.list_replay_results
        ] = mock_rpc
        request = {}
...
def test_get_replay_rest_bad_request(
    transport: str = "rest", request_type=simulator.GetReplayRequest
):
    client = SimulatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_replay_rest_bad_request(
    transport: str = "rest", request_type=simulator.CreateReplayRequest
):
    client = SimulatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_replay_results_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = simulator.ListReplayResultsResponse.to_json(
            simulator.ListReplayResultsResponse()
        )
...
def test_list_replay_results_rest_bad_request(
    transport: str = "rest", request_type=simulator.ListReplayResultsRequest
):
    client = SimulatorClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

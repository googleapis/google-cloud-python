...
def test_get_replay_rest_required_fields(request_type=simulator.GetReplayRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetReplay,
        "_BaseGetReplay__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_create_replay_rest_required_fields(request_type=simulator.CreateReplayRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateReplay,
        "_BaseCreateReplay__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_replay_results_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListReplayResults,
        "_BaseListReplayResults__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

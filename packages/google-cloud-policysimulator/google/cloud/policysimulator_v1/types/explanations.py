...
class ExplainedPolicy(proto.Message):
    ...
    Attributes:
        access (google.cloud.policysimulator_v1.types.AccessState):
        ...
        policy (google.iam.v1.policy_pb2.Policy):
            ...
            If the user who created the
            [Replay][google.cloud.policysimulator.v1.Replay] does not
            have access to the policy, this field is empty.
        binding_explanations (MutableSequence[google.cloud.policysimulator_v1.types.BindingExplanation]):
            Details about how each binding in the policy affects the
            principal's ability, or inability, to use the permission for
            the resource.
...
class BindingExplanation(proto.Message):
    ...
    Attributes:
        ...
        role (str):
            ...
            https://cloud.google.com/iam/help/roles/reference.
        role_permission (google.cloud.policysimulator_v1.types.BindingExplanation.RolePermission):
            Indicates whether the role granted by this
            binding contains the specified permission.
        role_permission_relevance (google.cloud.policysimulator_v1.types.HeuristicRelevance):
            The relevance of the permission's existence,
            or nonexistence, in the role to the overall
            determination for the entire policy.
        memberships (MutableMapping[str, google.cloud.policysimulator_v1.types.BindingExplanation.AnnotatedMembership]):
    ...
    class AnnotatedMembership(proto.Message):
        ...
        Attributes:
            membership (google.cloud.policysimulator_v1.types.BindingExplanation.Membership):

...
class SimulatorAsyncClient:
    ...
    common_billing_account_path = staticmethod(
        SimulatorClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        SimulatorClient.parse_common_billing_account_path
    )
    ...
    parse_common_organization_path = staticmethod(
        SimulatorClient.parse_common_organization_path
    )
    ...
    parse_common_location_path = staticmethod(
        SimulatorClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            SimulatorClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(SimulatorAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            SimulatorClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(SimulatorAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_replay():
                ...
                # Make the request
                operation = await client.create_replay(request=request)

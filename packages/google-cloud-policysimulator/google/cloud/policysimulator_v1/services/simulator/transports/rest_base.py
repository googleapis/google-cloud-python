...
class _BaseSimulatorRestTransport(SimulatorTransport):
    ...
    class _BaseCreateReplay:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSimulatorRestTransport._BaseCreateReplay._get_unset_required_fields(query_params))
    ...
    class _BaseGetReplay:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSimulatorRestTransport._BaseGetReplay._get_unset_required_fields(query_params))
    ...
    class _BaseListReplayResults:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSimulatorRestTransport._BaseListReplayResults._get_unset_required_fields(query_params))

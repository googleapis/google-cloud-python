...
class SimulatorClient(metaclass=SimulatorClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SimulatorClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SimulatorClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = SimulatorClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SimulatorClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or SimulatorClient._get_api_endpoint(

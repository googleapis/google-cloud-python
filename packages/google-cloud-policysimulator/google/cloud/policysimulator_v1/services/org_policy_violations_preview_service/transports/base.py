...
class OrgPolicyViolationsPreviewServiceTransport(abc.ABC):
    """Abstract transport class for OrgPolicyViolationsPreviewService."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "policysimulator.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_org_policy_violations_previews: gapic_v1.method.wrap_method(
                self.list_org_policy_violations_previews,
            ...
            self.get_org_policy_violations_preview: gapic_v1.method.wrap_method(
                self.get_org_policy_violations_preview,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.create_org_policy_violations_preview: gapic_v1.method.wrap_method(
                self.create_org_policy_violations_preview,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_org_policy_violations: gapic_v1.method.wrap_method(
                self.list_org_policy_violations,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
...
__all__ = ("OrgPolicyViolationsPreviewServiceTransport",)

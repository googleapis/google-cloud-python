...
class OrgPolicyViolationsPreviewServiceGrpcAsyncIOTransport(
    ...
    def list_org_policy_violations_previews(
        ...
        Returns:
            Callable[[~.ListOrgPolicyViolationsPreviewsRequest],
                    Awaitable[~.ListOrgPolicyViolationsPreviewsResponse]]:
    ...
    def get_org_policy_violations_preview(
        ...
        Returns:
            Callable[[~.GetOrgPolicyViolationsPreviewRequest],
                    Awaitable[~.OrgPolicyViolationsPreview]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_org_policy_violations(
        ...
        Returns:
            Callable[[~.ListOrgPolicyViolationsRequest],
                    Awaitable[~.ListOrgPolicyViolationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_org_policy_violations_previews: self._wrap_method(
            ...
            self.get_org_policy_violations_preview: self._wrap_method(
            ...
            self.create_org_policy_violations_preview: self._wrap_method(
                self.create_org_policy_violations_preview,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_org_policy_violations: self._wrap_method(
...
__all__ = ("OrgPolicyViolationsPreviewServiceGrpcAsyncIOTransport",)

...
class OrgPolicyViolationsPreviewServiceClientMeta(type):
    """Metaclass for the OrgPolicyViolationsPreviewService client.
...
class OrgPolicyViolationsPreviewServiceClient(
    ...
    def transport(self) -> OrgPolicyViolationsPreviewServiceTransport:
        ...
        Returns:
            OrgPolicyViolationsPreviewServiceTransport: The transport used by the client
                instance.
        """
    ...
    def org_policy_violation_path(
        ...
        return "organizations/{organization}/locations/{location}/orgPolicyViolationsPreviews/{org_policy_violations_preview}/orgPolicyViolations/{org_policy_violation}".format(
            organization=organization,
            location=location,
    ...
    @staticmethod
    def parse_org_policy_violation_path(path: str) -> Dict[str, str]:
        """Parses a org_policy_violation path into its component segments."""
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/orgPolicyViolationsPreviews/(?P<org_policy_violations_preview>.+?)/orgPolicyViolations/(?P<org_policy_violation>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def org_policy_violations_preview_path(
        organization: str,
        location: str,
        org_policy_violations_preview: str,
    ) -> str:
        """Returns a fully-qualified org_policy_violations_preview string."""
        return "organizations/{organization}/locations/{location}/orgPolicyViolationsPreviews/{org_policy_violations_preview}".format(
            organization=organization,
            location=location,
            org_policy_violations_preview=org_policy_violations_preview,
        )
    ...
    @staticmethod
    def parse_org_policy_violations_preview_path(path: str) -> Dict[str, str]:
        """Parses a org_policy_violations_preview path into its component segments."""
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/orgPolicyViolationsPreviews/(?P<org_policy_violations_preview>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=OrgPolicyViolationsPreviewServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def list_org_policy_violations_previews(
        ...
        *,
        ...
        response = pagers.ListOrgPolicyViolationsPreviewsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_org_policy_violations(
        ...
        *,
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListOrgPolicyViolationsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "OrgPolicyViolationsPreviewServiceClient":
        return self

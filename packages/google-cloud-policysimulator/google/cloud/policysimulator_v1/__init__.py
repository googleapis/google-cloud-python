...
__lazy_modules__ = {
    ...
    "google.cloud.policysimulator_v1.services.simulator",
    "google.cloud.policysimulator_v1.types.explanations",
    "google.cloud.policysimulator_v1.types.orgpolicy",
    "google.cloud.policysimulator_v1.types.simulator",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.policysimulator_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.policysimulator_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.policysimulator_v1"

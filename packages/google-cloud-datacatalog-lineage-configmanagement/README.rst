...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-datacatalog-lineage-configmanagement.svg
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-datacatalog-lineage-configmanagement.svg
   :target: https://pypi.org/project/google-cloud-datacatalog-lineage-configmanagement/
.. _Data Lineage: https://cloud.google.com/dataplex/
...
3. `Enable the Data Lineage.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Data Lineage.:  https://cloud.google.com/dataplex/
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-datacatalog-lineage-configmanagement/samples
...
.. code-block:: console
    ...
    pip install google-cloud-datacatalog-lineage-configmanagement
...
-  Read the `Client Library Documentation`_ for Data Lineage
   to see other available methods on the client.
-  Read the `Data Lineage Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Data Lineage Product documentation:  https://cloud.google.com/dataplex/

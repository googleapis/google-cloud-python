...
class BigtableInstanceAdminAsyncClient:
    ...
    memory_layer_path = staticmethod(BigtableInstanceAdminClient.memory_layer_path)
    parse_memory_layer_path = staticmethod(
        BigtableInstanceAdminClient.parse_memory_layer_path
    )
    ...
    async def update_memory_layer(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable_admin_v2.types.UpdateMemoryLayerRequest, dict]]):
                The request object. Request message for
                BigtableInstanceAdmin.UpdateMemoryLayer.
            memory_layer (:class:`google.cloud.bigtable_admin_v2.types.MemoryLayer`):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_memory_layer
        ]
    ...
    async def list_memory_layers(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListMemoryLayersAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_memory_layers():
                # Create a client
                client = bigtable_admin_v2.BigtableInstanceAdminAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable_admin_v2.types.ListMemoryLayersRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigtable_admin_v2.services.bigtable_instance_admin.pagers.ListMemoryLayersAsyncPager:
                Response message for
                BigtableInstanceAdmin.ListMemoryLayers.
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_memory_layers
        ]
        ...
        response = pagers.ListMemoryLayersAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_memory_layer(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.bigtable_admin_v2.types.GetMemoryLayerRequest, dict]]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_memory_layer
        ]

...
class ListMemoryLayersPager:
    """A pager for iterating through ``list_memory_layers`` requests.

    This class thinly wraps an initial
    :class:`google.cloud.bigtable_admin_v2.types.ListMemoryLayersResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``memory_layers`` field.

    If there are more pages, the ``__iter__`` method will make additional
    ``ListMemoryLayers`` requests and continue to iterate
    through the ``memory_layers`` field on the
    corresponding responses.

    All the usual :class:`google.cloud.bigtable_admin_v2.types.ListMemoryLayersResponse`
    ...
    def __init__(
        self,
        method: Callable[..., bigtable_instance_admin.ListMemoryLayersResponse],
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.bigtable_admin_v2.types.ListMemoryLayersRequest):
                The initial request object.
            response (google.cloud.bigtable_admin_v2.types.ListMemoryLayersResponse):
        ...
        """
        self._method = method
        self._request = bigtable_instance_admin.ListMemoryLayersRequest(request)
    ...
    @property
    def pages(self) -> Iterator[bigtable_instance_admin.ListMemoryLayersResponse]:
    ...
    def __iter__(self) -> Iterator[instance.MemoryLayer]:
        for page in self.pages:
            yield from page.memory_layers

    def __repr__(self) -> str:
        return "{0}<{1!r}>".format(self.__class__.__name__, self._response)


class ListMemoryLayersAsyncPager:
    """A pager for iterating through ``list_memory_layers`` requests.
    ...
    async def pages(
        self,
    ) -> AsyncIterator[bigtable_instance_admin.ListMemoryLayersResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
    ...
    def __aiter__(self) -> AsyncIterator[instance.MemoryLayer]:
        async def async_generator():
            async for page in self.pages:
                for response in page.memory_layers:
                    yield response

...
class GetClientConfigurationRequest(proto.Message):
    r"""See GetClientConfiguration() RPC in bigtable.proto. Internal
    usage only.

    Attributes:
        instance_name (str):
            Required. The unique name of the instance for which the
            client will target with Data API requests.

            Values are of the form
            ``projects/<project>/instances/<instance>``
        app_profile_id (str):
            Optional. The name of the AppProfile which will be used by
            the client when sending requests in the Data API.

            If not specified, the ``default`` application profile will
            be used.
    """
...
class ClientConfiguration(proto.Message):
    r"""Configuration for the Session API. Internal usage only.
    ...
    Attributes:
        session_configuration (google.cloud.bigtable_v2.types.SessionClientConfiguration):
            The configuration for Bigtable Sessions.
        stop_polling (bool):
            If the client should cease to check for new
            configurations, e.g. a backstop to prevent
            excessive GetClientConfiguration RPCs.

            This field is a member of `oneof`_ ``polling``.
        polling_interval (google.protobuf.duration_pb2.Duration):
            Deprecated, prerfer polling_configuration.

            A duration describing the time between
            GetClientConfiguration RPCs. Only strictly positive values
            are permissible.

            This field is a member of `oneof`_ ``polling``.
        polling_configuration (google.cloud.bigtable_v2.types.ClientConfiguration.PollingConfiguration):
            If the client should continue to check for
            new configurations.

            This field is a member of `oneof`_ ``polling``.
        telemetry_configuration (google.cloud.bigtable_v2.types.TelemetryConfiguration):
            Configuration for telemetry.
    """

    class PollingConfiguration(proto.Message):
        r"""

        Attributes:
            polling_interval (google.protobuf.duration_pb2.Duration):
                A duration describing the time between
                GetClientConfiguration RPCs. Only strictly
                positive values are permissible.
            validity_duration (google.protobuf.duration_pb2.Duration):
                How long the client should consider the
                configuration it receives from
                GetClientConfiguration valid for. Once this
                duration has passed, the client should consider
                the configuration invalid and must either:

                  - Get a new configuration from
                  GetClientConfiguration
                  - Or if it cannot, use a sane default
                  configuration

                This duration will be at least as long as the
                polling interval.
            max_rpc_retry_count (int):
                Number of times the client should retry a
                failed GetClientConfiguration RPC per polling
        ...
        validity_duration: duration_pb2.Duration = proto.Field(
            proto.MESSAGE,
            number=2,
            message=duration_pb2.Duration,
        )
        max_rpc_retry_count: int = proto.Field(
            proto.INT32,
            number=6,
        )

    session_configuration: "SessionClientConfiguration" = proto.Field(
        proto.MESSAGE,
        number=2,
        message="SessionClientConfiguration",
    )
    stop_polling: bool = proto.Field(
        proto.BOOL,
        number=3,
        oneof="polling",
    )
    ...
    polling_configuration: PollingConfiguration = proto.Field(
        proto.MESSAGE,
        number=5,
        oneof="polling",
        message=PollingConfiguration,
    )
    telemetry_configuration: "TelemetryConfiguration" = proto.Field(
        proto.MESSAGE,
        number=6,
...
class SessionRequest(proto.Message):
    ...
    Attributes:
        open_session (google.cloud.bigtable_v2.types.OpenSessionRequest):

            This field is a member of `oneof`_ ``payload``.
        close_session (google.cloud.bigtable_v2.types.CloseSessionRequest):

            This field is a member of `oneof`_ ``payload``.
        virtual_rpc (google.cloud.bigtable_v2.types.VirtualRpcRequest):

            This field is a member of `oneof`_ ``payload``.
    """

    open_session: "OpenSessionRequest" = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="payload",
        message="OpenSessionRequest",
    )
    close_session: "CloseSessionRequest" = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="payload",
        message="CloseSessionRequest",
    )
    virtual_rpc: "VirtualRpcRequest" = proto.Field(
        proto.MESSAGE,
        number=3,
        oneof="payload",
...
class SessionResponse(proto.Message):
    r"""Internal usage only.
    ...
    Attributes:
        open_session (google.cloud.bigtable_v2.types.OpenSessionResponse):

            This field is a member of `oneof`_ ``payload``.
        virtual_rpc (google.cloud.bigtable_v2.types.VirtualRpcResponse):
            A vRPC can result in either a successful
            result or an error. Error results are separate
            to allow for multiple vRPC responses, e.g. for
            streaming calls like scans (post-V1). See Flow
            Control.

            This field is a member of `oneof`_ ``payload``.
        error (google.cloud.bigtable_v2.types.ErrorResponse):

            This field is a member of `oneof`_ ``payload``.
        session_parameters (google.cloud.bigtable_v2.types.SessionParametersResponse):

            This field is a member of `oneof`_ ``payload``.
        heartbeat (google.cloud.bigtable_v2.types.HeartbeatResponse):

            This field is a member of `oneof`_ ``payload``.
        go_away (google.cloud.bigtable_v2.types.GoAwayResponse):

            This field is a member of `oneof`_ ``payload``.
        session_refresh_config (google.cloud.bigtable_v2.types.SessionRefreshConfig):

            This field is a member of `oneof`_ ``payload``.
    """

    open_session: "OpenSessionResponse" = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="payload",
        message="OpenSessionResponse",
    )
    virtual_rpc: "VirtualRpcResponse" = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="payload",
        message="VirtualRpcResponse",
    )
    error: "ErrorResponse" = proto.Field(
        proto.MESSAGE,
        number=3,
        oneof="payload",
        message="ErrorResponse",
    )
    session_parameters: "SessionParametersResponse" = proto.Field(
        proto.MESSAGE,
        number=4,
        oneof="payload",
        message="SessionParametersResponse",
    )
    heartbeat: "HeartbeatResponse" = proto.Field(
        proto.MESSAGE,
        number=5,
        oneof="payload",
        message="HeartbeatResponse",
    )
    go_away: "GoAwayResponse" = proto.Field(
        proto.MESSAGE,
        number=6,
        oneof="payload",
        message="GoAwayResponse",
    )
    session_refresh_config: "SessionRefreshConfig" = proto.Field(
        proto.MESSAGE,
        number=7,
        oneof="payload",

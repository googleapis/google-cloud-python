...
.. _repo: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-bigtable
...
base it on the `samples/data_client/snippets` folder (providing `noxfile.py` and
...
- To run sample tests, you can execute::
   ...
   $ cd samples/data_client/snippets
   $ nox -s py-3.14
...
instead of
``https://github.com/googleapis/google-cloud-python/blob/main/packages/google-cloud-bigtable/CONTRIBUTING.rst``)

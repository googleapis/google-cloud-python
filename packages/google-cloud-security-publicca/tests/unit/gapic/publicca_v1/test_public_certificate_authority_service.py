...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert PublicCertificateAuthorityServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert PublicCertificateAuthorityServiceClient._use_client_cert_effective() is False
...
@mock.patch.object(
    PublicCertificateAuthorityServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PublicCertificateAuthorityServiceClient)
)
@mock.patch.object(
    PublicCertificateAuthorityServiceAsyncClient,
...
def test__get_api_endpoint():
    ...
    assert (
        PublicCertificateAuthorityServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    )
    assert (
        PublicCertificateAuthorityServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        PublicCertificateAuthorityServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == PublicCertificateAuthorityServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        PublicCertificateAuthorityServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == PublicCertificateAuthorityServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_public_certificate_authority_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "publicca.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://publicca.googleapis.com"
        )
...
@mock.patch.object(
    PublicCertificateAuthorityServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublicCertificateAuthorityServiceAsyncClient)
)
...
def test_create_external_account_key_rest_required_fields(request_type=service.CreateExternalAccountKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_external_account_key._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_external_account_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/externalAccountKeys" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = PublicCertificateAuthorityServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = PublicCertificateAuthorityServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = PublicCertificateAuthorityServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = PublicCertificateAuthorityServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_external_account_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PublicCertificateAuthorityServiceRestInterceptor, "post_create_external_account_key"
    ) as post, mock.patch.object(
        transports.PublicCertificateAuthorityServiceRestInterceptor, "post_create_external_account_key_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.PublicCertificateAuthorityServiceRestInterceptor, "pre_create_external_account_key"
    ) as pre:
...
@pytest.mark.parametrize(
    "transport_class", [transports.PublicCertificateAuthorityServiceGrpcTransport, transports.PublicCertificateAuthorityServiceGrpcAsyncIOTransport]
)
...
def test_public_certificate_authority_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "publicca.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://publicca.googleapis.com:8000"
    )

...
`Public Certificate Authority API`_: The Public Certificate Authority API may be used to create and manage ACME
...
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-security-publicca/latest/summary_overview

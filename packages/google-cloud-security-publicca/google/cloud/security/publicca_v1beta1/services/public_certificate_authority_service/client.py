...
from google.cloud.security.publicca_v1beta1._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=PublicCertificateAuthorityServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

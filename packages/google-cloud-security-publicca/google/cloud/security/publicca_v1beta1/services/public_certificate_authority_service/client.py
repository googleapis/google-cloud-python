...
from .transports.base import DEFAULT_CLIENT_INFO, PublicCertificateAuthorityServiceTransport
...
class PublicCertificateAuthorityServiceClient(metaclass=PublicCertificateAuthorityServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = PublicCertificateAuthorityServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PublicCertificateAuthorityServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or PublicCertificateAuthorityServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.security.publicca_v1beta1.PublicCertificateAuthorityServiceClient`.",
                    extra={

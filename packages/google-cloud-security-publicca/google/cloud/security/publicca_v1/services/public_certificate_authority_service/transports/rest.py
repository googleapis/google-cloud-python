...
from google.cloud.security.publicca_v1._compat import transcode_request
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[PublicCertificateAuthorityServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.security.publicca_v1.PublicCertificateAuthorityServiceClient.CreateExternalAccountKey",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.security.publicca_v1.PublicCertificateAuthorityServiceClient.create_external_account_key",
                    extra={
                        "serviceName": "google.cloud.security.publicca.v1.PublicCertificateAuthorityService",
                        "rpcName": "CreateExternalAccountKey",

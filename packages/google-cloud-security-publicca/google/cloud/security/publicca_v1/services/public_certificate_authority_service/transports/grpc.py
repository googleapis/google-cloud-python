...
class PublicCertificateAuthorityServiceGrpcTransport(PublicCertificateAuthorityServiceTransport):
    ...
    def create_external_account_key(self) -> Callable[[service.CreateExternalAccountKeyRequest], resources.ExternalAccountKey]:
        ...
        if "create_external_account_key" not in self._stubs:
            self._stubs["create_external_account_key"] = self._logged_channel.unary_unary(

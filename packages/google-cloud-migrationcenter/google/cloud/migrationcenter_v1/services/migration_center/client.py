...
class MigrationCenterClient(metaclass=MigrationCenterClientMeta):
    ...
    def parse_import_data_file_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/importJobs/(?P<import_job>.+?)/importDataFiles/(?P<import_data_file>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = MigrationCenterClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or MigrationCenterClient._get_api_endpoint(
    ...
    def update_import_job(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("import_job.name", request.import_job.name),)),)
    ...
    def update_preference_set(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("preference_set.name", request.preference_set.name),)),)

...
class bare_metal_solutionCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'create_snapshot_schedule_policy': ('parent', 'snapshot_schedule_policy', 'snapshot_schedule_policy_id', ),
        'create_volume_snapshot': ('parent', 'volume_snapshot', ),
        'delete_snapshot_schedule_policy': ('name', ),
        'delete_volume_snapshot': ('name', ),
        'get_instance': ('name', ),
        'get_lun': ('name', ),
        'get_network': ('name', ),
        'get_snapshot_schedule_policy': ('name', ),
        'get_volume': ('name', ),
        'get_volume_snapshot': ('name', ),
        'list_instances': ('parent', 'page_size', 'page_token', ),
        'list_luns': ('parent', 'page_size', 'page_token', ),
        'list_networks': ('parent', 'page_size', 'page_token', ),
        'list_snapshot_schedule_policies': ('parent', 'page_size', 'page_token', ),
        'list_volumes': ('parent', 'page_size', 'page_token', ),
        'list_volume_snapshots': ('parent', 'page_size', 'page_token', ),
        'reset_instance': ('name', ),
        'restore_volume_snapshot': ('volume_snapshot', ),
        'update_snapshot_schedule_policy': ('snapshot_schedule_policy', 'update_mask', ),

...
from .services.bare_metal_solution import BareMetalSolutionAsyncClient, BareMetalSolutionClient
...
from .types.lun import EvictLunRequest, GetLunRequest, ListLunsRequest, ListLunsResponse, Lun
...
from .types.ssh_key import CreateSSHKeyRequest, DeleteSSHKeyRequest, ListSSHKeysRequest, ListSSHKeysResponse, SSHKey
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.bare_metal_solution_v2")  # type: ignore
    api_core.check_dependency_versions("google.cloud.bare_metal_solution_v2")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.bare_metal_solution_v2"

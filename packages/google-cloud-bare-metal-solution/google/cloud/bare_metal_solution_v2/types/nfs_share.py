...
class NfsShare(proto.Message):
    ...
    Attributes:
        ...
        id (str):
            ...
            generated by the backend. This is the same value
            as nfs_share_id and will replace it in the
            future.
    ...
    class AllowedClient(proto.Message):
        ...
        Attributes:
            ...
            share_ip (str):
                Output only. The IP address of the share on this
                network. Assigned automatically during
                provisioning based on the network's
                services_cidr.

...
def test_location_path():
    ...
    actual = EnterpriseKnowledgeGraphServiceClient.location_path(project, location)
    assert expected == actual
...
def test_parse_location_path():
    ...
    path = EnterpriseKnowledgeGraphServiceClient.location_path(**expected)

    # Check that the path construction is reversible.
    actual = EnterpriseKnowledgeGraphServiceClient.parse_location_path(path)
    assert expected == actual

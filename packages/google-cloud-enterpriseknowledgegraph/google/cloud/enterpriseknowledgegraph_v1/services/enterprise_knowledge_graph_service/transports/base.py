...
class EnterpriseKnowledgeGraphServiceTransport(abc.ABC):
    """Abstract transport class for EnterpriseKnowledgeGraphService."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "enterpriseknowledgegraph.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_entity_reconciliation_job: gapic_v1.method.wrap_method(
                self.create_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_entity_reconciliation_job: gapic_v1.method.wrap_method(
            ...
            self.list_entity_reconciliation_jobs: gapic_v1.method.wrap_method(
            ...
            self.cancel_entity_reconciliation_job: gapic_v1.method.wrap_method(
                self.cancel_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_entity_reconciliation_job: gapic_v1.method.wrap_method(
...
__all__ = ("EnterpriseKnowledgeGraphServiceTransport",)

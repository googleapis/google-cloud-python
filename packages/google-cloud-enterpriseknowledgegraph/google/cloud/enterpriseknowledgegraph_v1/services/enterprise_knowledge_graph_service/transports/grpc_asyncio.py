...
class EnterpriseKnowledgeGraphServiceGrpcAsyncIOTransport(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_entity_reconciliation_job: self._wrap_method(
                self.create_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_entity_reconciliation_job: self._wrap_method(
            ...
            self.list_entity_reconciliation_jobs: self._wrap_method(
            ...
            self.cancel_entity_reconciliation_job: self._wrap_method(
                self.cancel_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_entity_reconciliation_job: self._wrap_method(
            ...
            self.lookup_public_kg: self._wrap_method(
                self.lookup_public_kg,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_public_kg: self._wrap_method(

...
class EnterpriseKnowledgeGraphServiceGrpcAsyncIOTransport(
    ...
    def create_entity_reconciliation_job(
        ...
        Returns:
            Callable[[~.CreateEntityReconciliationJobRequest],
                    Awaitable[~.EntityReconciliationJob]]:
    ...
    def get_entity_reconciliation_job(
        ...
        Returns:
            Callable[[~.GetEntityReconciliationJobRequest],
                    Awaitable[~.EntityReconciliationJob]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def list_entity_reconciliation_jobs(
        ...
        Returns:
            Callable[[~.ListEntityReconciliationJobsRequest],
                    Awaitable[~.ListEntityReconciliationJobsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def cancel_entity_reconciliation_job(
        ...
        Returns:
            Callable[[~.CancelEntityReconciliationJobRequest],
                    Awaitable[~.Empty]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def delete_entity_reconciliation_job(
        ...
        Returns:
            Callable[[~.DeleteEntityReconciliationJobRequest],
                    Awaitable[~.Empty]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_entity_reconciliation_job: gapic_v1.method_async.wrap_method(
                self.create_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_entity_reconciliation_job: gapic_v1.method_async.wrap_method(
                self.get_entity_reconciliation_job,
            ...
            self.list_entity_reconciliation_jobs: gapic_v1.method_async.wrap_method(
                self.list_entity_reconciliation_jobs,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.cancel_entity_reconciliation_job: gapic_v1.method_async.wrap_method(
                self.cancel_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_entity_reconciliation_job: gapic_v1.method_async.wrap_method(
                self.delete_entity_reconciliation_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            ...
            self.lookup_public_kg: gapic_v1.method_async.wrap_method(
                self.lookup_public_kg,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_public_kg: gapic_v1.method_async.wrap_method(
...
__all__ = ("EnterpriseKnowledgeGraphServiceGrpcAsyncIOTransport",)

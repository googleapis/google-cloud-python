...
class EnterpriseKnowledgeGraphServiceClient(metaclass=EnterpriseKnowledgeGraphServiceClientMeta):
    ...
    def parse_cloud_knowledge_graph_entity_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/cloudKnowledgeGraphEntities/(?P<cloud_knowledge_graph_entity>.+?)$", path
        )
    ...
    def parse_public_knowledge_graph_entity_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/publicKnowledgeGraphEntities/(?P<public_knowledge_graph_entity>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = EnterpriseKnowledgeGraphServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = EnterpriseKnowledgeGraphServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or EnterpriseKnowledgeGraphServiceClient._get_api_endpoint(

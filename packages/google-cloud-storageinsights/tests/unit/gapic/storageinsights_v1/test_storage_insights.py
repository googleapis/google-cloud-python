...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert StorageInsightsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert StorageInsightsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                StorageInsightsClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        StorageInsightsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        StorageInsightsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == StorageInsightsClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_storage_insights_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "storageinsights.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://storageinsights.googleapis.com"
        )
...
def test_list_dataset_configs(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_dataset_configs), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_dataset_configs_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_dataset_configs), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            storageinsights.ListDatasetConfigsResponse(
                dataset_configs=[
...
async def test_list_dataset_configs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_dataset_configs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_dataset_configs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_dataset_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_dataset_config), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_dataset_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_dataset_config), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_update_dataset_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_dataset_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_dataset_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_dataset_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_list_report_configs_rest_required_fields(request_type=storageinsights.ListReportConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_report_configs._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_report_config_rest_required_fields(request_type=storageinsights.CreateReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_report_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_report_config_rest_required_fields(request_type=storageinsights.UpdateReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_report_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_report_config_rest_required_fields(request_type=storageinsights.DeleteReportConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_report_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_report_details_rest_required_fields(request_type=storageinsights.ListReportDetailsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_report_details._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_dataset_configs_rest_required_fields(request_type=storageinsights.ListDatasetConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_dataset_configs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_dataset_config_rest_required_fields(request_type=storageinsights.CreateDatasetConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_dataset_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_dataset_config_rest_required_fields(request_type=storageinsights.UpdateDatasetConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_dataset_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_dataset_config_rest_required_fields(request_type=storageinsights.DeleteDatasetConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_dataset_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = StorageInsightsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = StorageInsightsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = StorageInsightsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = StorageInsightsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_report_configs_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_report_configs") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_list_report_configs_with_metadata"
...
def test_get_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_report_config") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_get_report_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_report_config_rest_call_success(request_type):
    ...
    request_init["report_config"] = {
        ...
        "update_time": {},
        "frequency_options": {"frequency": 1, "start_date": {"year": 433, "month": 550, "day": 318}, "end_date": {}},
        "csv_options": {"record_separator": "record_separator_value", "delimiter": "delimiter_value", "header_required": True},
        "parquet_options": {},
        "object_metadata_report_options": {
            "metadata_fields": ["metadata_fields_value1", "metadata_fields_value2"],
            "storage_filters": {"bucket": "bucket_value"},
            "storage_destination_options": {"bucket": "bucket_value", "destination_path": "destination_path_value"},
        },
        "labels": {},
        "display_name": "display_name_value",
    }
...
def test_create_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_create_report_config") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_create_report_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_update_report_config") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_update_report_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_report_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "pre_delete_report_config") as pre:
        pre.assert_not_called()
...
def test_list_report_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_report_details") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_list_report_details_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_report_detail_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_report_detail") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_get_report_detail_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_dataset_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_list_dataset_configs") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_list_dataset_configs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageInsightsRestInterceptor, "post_get_dataset_config") as post, mock.patch.object(
        transports.StorageInsightsRestInterceptor, "post_get_dataset_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_dataset_config_rest_call_success(request_type):
    ...
    request_init["dataset_config"] = {
        ...
        "include_cloud_storage_locations": {"locations": ["locations_value1", "locations_value2"]},
        "exclude_cloud_storage_locations": {},
        "include_cloud_storage_buckets": {
            "cloud_storage_buckets": [{"bucket_name": "bucket_name_value", "bucket_prefix_regex": "bucket_prefix_regex_value"}]
        },
...
def test_create_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.StorageInsightsRestInterceptor, "post_create_dataset_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.StorageInsightsRestInterceptor, "post_update_dataset_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_dataset_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.StorageInsightsRestInterceptor, "post_delete_dataset_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.StorageInsightsGrpcTransport, grpc_helpers), (transports.StorageInsightsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_storage_insights_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "storageinsights.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://storageinsights.googleapis.com:8000"
    )
...
def test_report_config_path():
    ...
    expected = "projects/{project}/locations/{location}/reportConfigs/{report_config}".format(
        project=project,
        location=location,

...
class StorageInsightsClient(metaclass=StorageInsightsClientMeta):
    ...
    def parse_report_detail_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reportConfigs/(?P<report_config>.+?)/reportDetails/(?P<report_detail>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or StorageInsightsClient._get_api_endpoint(

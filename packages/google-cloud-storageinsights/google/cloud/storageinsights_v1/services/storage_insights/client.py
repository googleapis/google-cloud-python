...
class StorageInsightsClient(metaclass=StorageInsightsClientMeta):
    ...
    def dataset_config_path(
        ...
        return "projects/{project}/locations/{location}/datasetConfigs/{dataset_config}".format(
            project=project,
            location=location,
    ...
    def parse_dataset_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasetConfigs/(?P<dataset_config>.+?)$",
            path,
        )
    ...
    def report_detail_path(
        ...
        return "projects/{project}/locations/{location}/reportConfigs/{report_config}/reportDetails/{report_detail}".format(
            project=project,
            location=location,
            report_config=report_config,
    ...
    def parse_report_detail_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reportConfigs/(?P<report_config>.+?)/reportDetails/(?P<report_detail>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = StorageInsightsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = StorageInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = StorageInsightsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or StorageInsightsClient._get_api_endpoint(

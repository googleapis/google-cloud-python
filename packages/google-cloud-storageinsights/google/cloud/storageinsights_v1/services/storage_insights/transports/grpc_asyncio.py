...
class StorageInsightsGrpcAsyncIOTransport(StorageInsightsTransport):
    ...
    def update_report_config(
        ...
        if "update_report_config" not in self._stubs:
            self._stubs["update_report_config"] = self.grpc_channel.unary_unary(
    ...
    def list_report_details(
        ...
        if "list_report_details" not in self._stubs:
            self._stubs["list_report_details"] = self.grpc_channel.unary_unary(
    ...
    def get_report_detail(
        ...
        if "get_report_detail" not in self._stubs:
            self._stubs["get_report_detail"] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_report_config: gapic_v1.method_async.wrap_method(
            ...
            self.list_report_details: gapic_v1.method_async.wrap_method(
            ...
            self.get_report_detail: gapic_v1.method_async.wrap_method(

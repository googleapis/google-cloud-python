...
from .base import DEFAULT_CLIENT_INFO, StorageInsightsTransport
from .grpc import StorageInsightsGrpcTransport
...
class StorageInsightsGrpcAsyncIOTransport(StorageInsightsTransport):
    """gRPC AsyncIO backend transport for StorageInsights.
    ...
    @property
    def list_report_configs(self) -> Callable[[storageinsights.ListReportConfigsRequest], Awaitable[storageinsights.ListReportConfigsResponse]]:
        ...
        if "list_report_configs" not in self._stubs:
            self._stubs["list_report_configs"] = self._logged_channel.unary_unary(
                ...
                request_serializer=storageinsights.ListReportConfigsRequest.serialize,
                response_deserializer=storageinsights.ListReportConfigsResponse.deserialize,
            )
        return self._stubs["list_report_configs"]

    @property
    def get_report_config(self) -> Callable[[storageinsights.GetReportConfigRequest], Awaitable[storageinsights.ReportConfig]]:
        ...
        if "get_report_config" not in self._stubs:
            self._stubs["get_report_config"] = self._logged_channel.unary_unary(
                ...
                request_serializer=storageinsights.GetReportConfigRequest.serialize,
                response_deserializer=storageinsights.ReportConfig.deserialize,
            )
        return self._stubs["get_report_config"]

    @property
    def create_report_config(self) -> Callable[[storageinsights.CreateReportConfigRequest], Awaitable[storageinsights.ReportConfig]]:
        ...
        if "create_report_config" not in self._stubs:
            self._stubs["create_report_config"] = self._logged_channel.unary_unary(
                ...
                request_serializer=storageinsights.CreateReportConfigRequest.serialize,
                response_deserializer=storageinsights.ReportConfig.deserialize,
            )
        return self._stubs["create_report_config"]

    @property
    def update_report_config(self) -> Callable[[storageinsights.UpdateReportConfigRequest], Awaitable[storageinsights.ReportConfig]]:
        r"""Return a callable for the update report config method over gRPC.

        Updates the parameters of a single ReportConfig.

        Returns:
            Callable[[~.UpdateReportConfigRequest],
                    Awaitable[~.ReportConfig]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_report_config" not in self._stubs:
            self._stubs["update_report_config"] = self._logged_channel.unary_unary(
                "/google.cloud.storageinsights.v1.StorageInsights/UpdateReportConfig",
                request_serializer=storageinsights.UpdateReportConfigRequest.serialize,
                response_deserializer=storageinsights.ReportConfig.deserialize,
            )
        return self._stubs["update_report_config"]

    @property
    def delete_report_config(self) -> Callable[[storageinsights.DeleteReportConfigRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if "delete_report_config" not in self._stubs:
            self._stubs["delete_report_config"] = self._logged_channel.unary_unary(
                ...
                request_serializer=storageinsights.DeleteReportConfigRequest.serialize,
                response_deserializer=empty_pb2.Empty.FromString,
            )
        return self._stubs["delete_report_config"]

    @property
    def list_report_details(self) -> Callable[[storageinsights.ListReportDetailsRequest], Awaitable[storageinsights.ListReportDetailsResponse]]:
        r"""Return a callable for the list report details method over gRPC.

        Lists ReportDetails in a given project and location.

        Returns:
            Callable[[~.ListReportDetailsRequest],
                    Awaitable[~.ListReportDetailsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_report_details" not in self._stubs:
            self._stubs["list_report_details"] = self._logged_channel.unary_unary(
                "/google.cloud.storageinsights.v1.StorageInsights/ListReportDetails",
                request_serializer=storageinsights.ListReportDetailsRequest.serialize,
                response_deserializer=storageinsights.ListReportDetailsResponse.deserialize,
            )
        return self._stubs["list_report_details"]

    @property
    def get_report_detail(self) -> Callable[[storageinsights.GetReportDetailRequest], Awaitable[storageinsights.ReportDetail]]:
        r"""Return a callable for the get report detail method over gRPC.

        Gets details of a single ReportDetail.

        Returns:
            Callable[[~.GetReportDetailRequest],
                    Awaitable[~.ReportDetail]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_report_detail" not in self._stubs:
            self._stubs["get_report_detail"] = self._logged_channel.unary_unary(
                "/google.cloud.storageinsights.v1.StorageInsights/GetReportDetail",
                request_serializer=storageinsights.GetReportDetailRequest.serialize,
                response_deserializer=storageinsights.ReportDetail.deserialize,
            )
        return self._stubs["get_report_detail"]

    @property
    def list_dataset_configs(self) -> Callable[[storageinsights.ListDatasetConfigsRequest], Awaitable[storageinsights.ListDatasetConfigsResponse]]:
        ...
        Returns:
            Callable[[~.ListDatasetConfigsRequest],
                    Awaitable[~.ListDatasetConfigsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def get_dataset_config(self) -> Callable[[storageinsights.GetDatasetConfigRequest], Awaitable[storageinsights.DatasetConfig]]:
    ...
    @property
    def create_dataset_config(self) -> Callable[[storageinsights.CreateDatasetConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_dataset_config(self) -> Callable[[storageinsights.UpdateDatasetConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_dataset_config(self) -> Callable[[storageinsights.DeleteDatasetConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def link_dataset(self) -> Callable[[storageinsights.LinkDatasetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def unlink_dataset(self) -> Callable[[storageinsights.UnlinkDatasetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_report_config: self._wrap_method(
            ...
            self.list_report_details: self._wrap_method(
            ...
            self.get_report_detail: self._wrap_method(
            ...
            self.list_dataset_configs: self._wrap_method(
            ...
            self.get_dataset_config: self._wrap_method(
                self.get_dataset_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_dataset_config: self._wrap_method(
            ...
            self.update_dataset_config: self._wrap_method(
            ...
            self.delete_dataset_config: self._wrap_method(
            ...
            self.link_dataset: self._wrap_method(
                self.link_dataset,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=60.0,
            ...
            self.unlink_dataset: self._wrap_method(
                self.unlink_dataset,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=60.0,
...
__all__ = ("StorageInsightsGrpcAsyncIOTransport",)

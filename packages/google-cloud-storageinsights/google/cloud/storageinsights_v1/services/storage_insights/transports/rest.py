    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomStorageInsightsInterceptor(StorageInsightsRestInterceptor):
            def pre_create_report_config(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_report_config(response):
                logging.log(f"Received response: {response}")

            def pre_delete_report_config(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def pre_get_report_config(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_report_config(response):
                logging.log(f"Received response: {response}")

            def pre_get_report_detail(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_report_detail(response):
                logging.log(f"Received response: {response}")

            def pre_list_report_configs(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_report_configs(response):
                logging.log(f"Received response: {response}")

            def pre_list_report_details(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_report_details(response):
                logging.log(f"Received response: {response}")

            def pre_update_report_config(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_report_config(response):
                logging.log(f"Received response: {response}")
...
class StorageInsightsRestTransport(StorageInsightsTransport):
    ...
    class _CreateReportConfig(StorageInsightsRestStub):
        def __hash__(self):
    ...
    class _DeleteReportConfig(StorageInsightsRestStub):
        def __hash__(self):
    ...
    class _GetReportConfig(StorageInsightsRestStub):
        def __hash__(self):
    ...
    class _GetReportDetail(StorageInsightsRestStub):
        def __hash__(self):
            return hash("GetReportDetail")
    ...
    class _ListReportConfigs(StorageInsightsRestStub):
        def __hash__(self):
    ...
    class _ListReportDetails(StorageInsightsRestStub):
        def __hash__(self):
            return hash("ListReportDetails")
    ...
    class _UpdateReportConfig(StorageInsightsRestStub):
        def __hash__(self):
            return hash("UpdateReportConfig")
    ...
    class _GetLocation(StorageInsightsRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(StorageInsightsRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _CancelOperation(StorageInsightsRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(StorageInsightsRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(StorageInsightsRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(StorageInsightsRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,

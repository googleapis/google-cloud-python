...
class ReportDetail(proto.Message):
    ...
    Attributes:
        ...
        snapshot_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            of time.
        report_names (MutableSequence[str]):
            Generated report's full path with name. It will be of the
            form destination_bucket/<destination_path>/.
    ...
    report_names: MutableSequence[str] = proto.RepeatedField(
        proto.STRING,
        number=3,
    )

...
from .services.certificate_manager import CertificateManagerAsyncClient, CertificateManagerClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.certificate_manager_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.certificate_manager_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.certificate_manager_v1"

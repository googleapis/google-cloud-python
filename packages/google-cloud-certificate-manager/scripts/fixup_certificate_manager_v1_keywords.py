...
class certificate_managerCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_trust_config': ('parent', 'trust_config_id', 'trust_config', ),
        ...
        'list_trust_configs': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        ...
        'update_trust_config': ('trust_config', 'update_mask', ),
    }

...
class PublisherGrpcAsyncIOTransport(PublisherTransport):
    ...
    def publish_channel_connection_events(
        self,
    ) -> Callable[[publisher.PublishChannelConnectionEventsRequest], Awaitable[publisher.PublishChannelConnectionEventsResponse]]:
    ...
    @property
    def publish_events(self) -> Callable[[publisher.PublishEventsRequest], Awaitable[publisher.PublishEventsResponse]]:
    ...
    @property
    def publish(self) -> Callable[[publisher.PublishRequest], Awaitable[publisher.PublishResponse]]:

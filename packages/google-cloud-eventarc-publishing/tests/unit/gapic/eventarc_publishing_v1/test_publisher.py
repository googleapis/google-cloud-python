...
def test_publish_channel_connection_events_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.publish_channel_connection_events
...
@pytest.mark.asyncio
async def test_publish_channel_connection_events_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.publish_channel_connection_events
...
@pytest.mark.asyncio
async def test_publish_events_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.publish_events
            in client._client._transport._wrapped_methods
        )
...
def test_publish_rest_bad_request(request_type=publisher.PublishRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "message_bus": "projects/sample1/locations/sample2/messageBuses/sample3"
    }
    request = request_type(**request_init)

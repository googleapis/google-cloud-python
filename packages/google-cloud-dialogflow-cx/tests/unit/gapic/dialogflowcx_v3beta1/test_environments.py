...
from google.cloud.dialogflowcx_v3beta1.services.environments import EnvironmentsAsyncClient, EnvironmentsClient, pagers, transports
...
def test_update_environment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{environment.name=projects/*/locations/*/agents/*/environments/*}" % client.transport._host, args[1]
        )
...
def test_lookup_environment_history_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{name=projects/*/locations/*/agents/*/environments/*}:lookupEnvironmentHistory" % client.transport._host, args[1]
        )
...
def test_list_continuous_test_results_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{parent=projects/*/locations/*/agents/*/environments/*}/continuousTestResults" % client.transport._host, args[1]
        )

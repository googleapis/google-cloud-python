...
def test_export_agent_rest_required_fields(request_type=agent.ExportAgentRequest):
    ...
    default_values = getattr(
        transport_class._BaseExportAgent,
        "_BaseExportAgent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_restore_agent_rest_required_fields(request_type=agent.RestoreAgentRequest):
    ...
    default_values = getattr(
        transport_class._BaseRestoreAgent,
        "_BaseRestoreAgent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_validate_agent_rest_required_fields(request_type=agent.ValidateAgentRequest):
    ...
    default_values = getattr(
        transport_class._BaseValidateAgent,
        "_BaseValidateAgent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_agent_validation_result_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetAgentValidationResult,
        "_BaseGetAgentValidationResult__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_generative_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetGenerativeSettings,
        "_BaseGetGenerativeSettings__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_generative_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateGenerativeSettings,
        "_BaseUpdateGenerativeSettings__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

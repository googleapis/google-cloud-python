...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert SecuritySettingsServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SecuritySettingsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SecuritySettingsServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SecuritySettingsServiceClient._use_client_cert_effective()
...
@mock.patch.object(
    SecuritySettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SecuritySettingsServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        SecuritySettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SecuritySettingsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        SecuritySettingsServiceClient._get_api_endpoint(None, None, default_universe, "always") == SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SecuritySettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_list_security_settings_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_security_settings), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_security_settings(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_security_settings_rest_required_fields(request_type=gcdc_security_settings.CreateSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_security_settings._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_security_settings_rest_required_fields(request_type=security_settings.GetSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_security_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_security_settings_rest_required_fields(request_type=gcdc_security_settings.UpdateSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_security_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{security_settings.name=projects/*/locations/*/securitySettings/*}" % client.transport._host, args[1]
        )
...
def test_list_security_settings_rest_required_fields(request_type=security_settings.ListSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_security_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_security_settings_rest_required_fields(request_type=security_settings.DeleteSecuritySettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_security_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = SecuritySettingsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = SecuritySettingsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SecuritySettingsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SecuritySettingsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_security_settings_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_create_security_settings") as post, mock.patch.object(
        transports.SecuritySettingsServiceRestInterceptor, "post_create_security_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SecuritySettingsServiceRestInterceptor, "pre_create_security_settings"
    ) as pre:
...
def test_get_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_get_security_settings") as post, mock.patch.object(
        transports.SecuritySettingsServiceRestInterceptor, "post_get_security_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_update_security_settings") as post, mock.patch.object(
        transports.SecuritySettingsServiceRestInterceptor, "post_update_security_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SecuritySettingsServiceRestInterceptor, "pre_update_security_settings"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "post_list_security_settings") as post, mock.patch.object(
        transports.SecuritySettingsServiceRestInterceptor, "post_list_security_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_security_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SecuritySettingsServiceRestInterceptor, "pre_delete_security_settings") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.SecuritySettingsServiceGrpcTransport, grpc_helpers), (transports.SecuritySettingsServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
async def test_get_location_field_headers_async():
    client = SecuritySettingsServiceAsyncClient(credentials=async_anonymous_credentials())

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ConversationHistoryClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ConversationHistoryClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ConversationHistoryClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ConversationHistoryClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ConversationHistoryClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        ConversationHistoryClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert ConversationHistoryClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ConversationHistoryClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ConversationHistoryClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ConversationHistoryClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        ConversationHistoryClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ConversationHistoryClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ConversationHistoryClient),
)
@mock.patch.object(
    ConversationHistoryAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ConversationHistoryAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConversationHistoryClient._DEFAULT_UNIVERSE
    default_endpoint = ConversationHistoryClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ConversationHistoryClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ConversationHistoryClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ConversationHistoryClient._get_api_endpoint(
    ...
    assert (
        ConversationHistoryClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ConversationHistoryClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ConversationHistoryClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ConversationHistoryClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ConversationHistoryClient._get_universe_domain(None, None)
        == ConversationHistoryClient._DEFAULT_UNIVERSE
    )
...
def test_conversation_history_client_from_service_account_info(
    client_class, transport_name
):
...
def test_conversation_history_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_conversation_history_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_conversation_history_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_conversation_history_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [ConversationHistoryClient, ConversationHistoryAsyncClient]
)
@mock.patch.object(
    ConversationHistoryClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ConversationHistoryClient),
)
@mock.patch.object(
    ConversationHistoryAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ConversationHistoryAsyncClient),
)
...
def test_conversation_history_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_conversation_history_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_conversation_history_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.conversation_history.transports.ConversationHistoryGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_conversation_history_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_conversations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, conversation_history.Conversation) for i in results)
...
async def test_list_conversations_async_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, conversation_history.Conversation) for i in responses)
...
def test_list_conversations_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = conversation_history.ListConversationsResponse.pb(
                return_value
            )
...
def test_list_conversations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{parent=projects/*/locations/*/agents/*}/conversations"
...
def test_list_conversations_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            conversation_history.ListConversationsResponse.to_json(x) for x in response
        )
...
def test_get_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{name=projects/*/locations/*/agents/*/conversations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_conversations_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ConversationHistoryRestInterceptor,
...
def test_conversation_history_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.conversation_history.transports.ConversationHistoryTransport.__init__"
    ) as Transport:
...
def test_conversation_history_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.dialogflowcx_v3beta1.services.conversation_history.transports.ConversationHistoryTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_conversation_history_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_conversation_path():
    ...
    expected = "projects/{project}/locations/{location}/agents/{agent}/conversations/{conversation}".format(
        project=project,
        location=location,
        agent=agent,
        conversation=conversation,
    )
    actual = ConversationHistoryClient.conversation_path(
        project, location, agent, conversation
    )
...
def test_entity_type_path():
    ...
    actual = ConversationHistoryClient.entity_type_path(
...
def test_environment_path():
    ...
    actual = ConversationHistoryClient.environment_path(
...
def test_example_path():
    ...
    actual = ConversationHistoryClient.example_path(
        project, location, agent, playbook, example
    )
    assert expected == actual
...
def test_generator_path():
    ...
    actual = ConversationHistoryClient.generator_path(
...
def test_service_path():
    ...
    actual = ConversationHistoryClient.service_path(
...
def test_session_entity_type_path():
    ...
    actual = ConversationHistoryClient.session_entity_type_path(
...
def test_test_case_path():
    ...
    actual = ConversationHistoryClient.test_case_path(
        project, location, agent, test_case
    )
    assert expected == actual
...
def test_transition_route_group_path():
    ...
    actual = ConversationHistoryClient.transition_route_group_path(
...
def test_version_path():
    ...
    actual = ConversationHistoryClient.version_path(

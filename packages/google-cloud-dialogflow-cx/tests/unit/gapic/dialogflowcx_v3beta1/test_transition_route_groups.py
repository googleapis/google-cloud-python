...
from google.cloud.dialogflowcx_v3beta1.types import advanced_settings, fulfillment, gcs, page, response_message, tool_call
...
def test_list_transition_route_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{parent=projects/*/locations/*/agents/*/flows/*}/transitionRouteGroups" % client.transport._host, args[1]
        )
...
def test_get_transition_route_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{name=projects/*/locations/*/agents/*/flows/*/transitionRouteGroups/*}" % client.transport._host, args[1]
        )
...
def test_update_transition_route_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{transition_route_group.name=projects/*/locations/*/agents/*/flows/*/transitionRouteGroups/*}" % client.transport._host,
            args[1],
        )

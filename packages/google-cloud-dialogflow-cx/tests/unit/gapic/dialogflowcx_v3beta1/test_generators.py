...
from google.cloud.dialogflowcx_v3beta1.services.generators import GeneratorsAsyncClient, GeneratorsClient, pagers, transports
...
def test_generators_client_client_options_from_dict():
    with mock.patch("google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsGrpcTransport.__init__") as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_generator_async(transport: str = "grpc_asyncio", request_type=gcdc_generator.CreateGeneratorRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_generator_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_generator), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcdc_generator.Generator())
        await client.create_generator(request)
...
@pytest.mark.asyncio
async def test_update_generator_async(transport: str = "grpc_asyncio", request_type=gcdc_generator.UpdateGeneratorRequest):
    client = GeneratorsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_generators_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v3beta1/{parent=projects/*/locations/*/agents/*}/generators" % client.transport._host, args[1])
...
def test_get_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/agents/sample3/generators/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{name=projects/*/locations/*/agents/*/generators/*}" % client.transport._host, args[1])
...
def test_create_generator_rest_required_fields(request_type=gcdc_generator.CreateGeneratorRequest):
    transport_class = transports.GeneratorsRestTransport
...
def test_update_generator_rest_required_fields(request_type=gcdc_generator.UpdateGeneratorRequest):
    transport_class = transports.GeneratorsRestTransport
...
def test_update_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"generator": {"name": "projects/sample1/locations/sample2/agents/sample3/generators/sample4"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3beta1/{generator.name=projects/*/locations/*/agents/*/generators/*}" % client.transport._host, args[1])
...
def test_get_generator_rest_bad_request(request_type=generator.GetGeneratorRequest):
    client = GeneratorsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/agents/sample3/generators/sample4"}
    request = request_type(**request_init)
...
def test_create_generator_rest_bad_request(request_type=gcdc_generator.CreateGeneratorRequest):
    client = GeneratorsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/agents/sample3"}
    request = request_type(**request_init)
...
def test_create_generator_rest_call_success(request_type):
    ...
    request_init["generator"] = {
        ...
        "model_parameter": {"temperature": 0.1198, "max_decode_steps": 1687, "top_p": 0.546, "top_k": 541},
    }
...
def test_create_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_generator.CreateGeneratorRequest.pb(gcdc_generator.CreateGeneratorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_generator_rest_bad_request(request_type=gcdc_generator.UpdateGeneratorRequest):
    client = GeneratorsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"generator": {"name": "projects/sample1/locations/sample2/agents/sample3/generators/sample4"}}
    request = request_type(**request_init)
...
def test_update_generator_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_generator.UpdateGeneratorRequest.pb(gcdc_generator.UpdateGeneratorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_generators_base_transport():
    ...
    with mock.patch("google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsTransport.__init__") as Transport:
...
def test_generators_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_generator_path():
    ...
    actual = GeneratorsClient.generator_path(project, location, agent, generator)

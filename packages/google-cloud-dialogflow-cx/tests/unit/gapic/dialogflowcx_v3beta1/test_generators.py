...
def test_generators_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_generators_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{parent=projects/*/locations/*/agents/*}/generators"
...
def test_get_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{name=projects/*/locations/*/agents/*/generators/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{generator.name=projects/*/locations/*/agents/*/generators/*}"
            % client.transport._host,
            args[1],
        )
...
def test_generators_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3beta1.services.generators.transports.GeneratorsTransport.__init__"
    ) as Transport:

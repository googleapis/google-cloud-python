...
from google.cloud.dialogflowcx_v3beta1.types import entity_type, inline
...
def test_get_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{name=projects/*/locations/*/agents/*/entityTypes/*}"
...
def test_create_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{parent=projects/*/locations/*/agents/*}/entityTypes"
            % client.transport._host,
            args[1],
        )
...
def test_update_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{entity_type.name=projects/*/locations/*/agents/*/entityTypes/*}"
            % client.transport._host,
            args[1],
        )

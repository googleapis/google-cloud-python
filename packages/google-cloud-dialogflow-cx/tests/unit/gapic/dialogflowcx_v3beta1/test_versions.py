...
from google.cloud.dialogflowcx_v3beta1.services.versions import VersionsAsyncClient, VersionsClient, pagers, transports
...
def test_update_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3beta1/{version.name=projects/*/locations/*/agents/*/flows/*/versions/*}" % client.transport._host, args[1]
        )
...
def test_compare_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3beta1/{base_version=projects/*/locations/*/agents/*/flows/*/versions/*}:compareVersions" % client.transport._host, args[1]
        )

...
from google.cloud.dialogflowcx_v3.services.versions import (
    VersionsAsyncClient,
    VersionsClient,
    pagers,
    transports,
...
async def test_load_version_async(request_type, transport: str = "grpc_asyncio"):
    client = VersionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_compare_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.compare_versions] = (
            mock_rpc
        )
        request = {}
...
async def test_compare_versions_async(request_type, transport: str = "grpc_asyncio"):
    client = VersionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*/flows/*}/versions"
...
def test_get_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/flows/*/versions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{version.name=projects/*/locations/*/agents/*/flows/*/versions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_load_version_rest_required_fields(request_type=version.LoadVersionRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).load_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_load_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/flows/*/versions/*}:load"
            % client.transport._host,
            args[1],
        )
...
def test_compare_versions_rest_required_fields(
    request_type=version.CompareVersionsRequest,
):
    transport_class = transports.VersionsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).compare_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_compare_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{base_version=projects/*/locations/*/agents/*/flows/*/versions/*}:compareVersions"
            % client.transport._host,
            args[1],
        )
...
def test_load_version_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.VersionsRestInterceptor, "post_load_version_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_compare_versions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.VersionsRestInterceptor, "post_compare_versions_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(

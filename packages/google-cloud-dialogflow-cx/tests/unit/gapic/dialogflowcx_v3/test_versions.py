...
from google.cloud.dialogflowcx_v3.services.versions import VersionsAsyncClient, VersionsClient, pagers, transports
...
def test_compare_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{base_version=projects/*/locations/*/agents/*/flows/*/versions/*}:compareVersions" % client.transport._host, args[1]
        )
...
def test_compare_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.VersionsRestInterceptor, "post_compare_versions") as post, mock.patch.object(

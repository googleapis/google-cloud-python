...
def test_get_location_field_headers():
    client = TestCasesClient(credentials=_AnonymousCredentialsWithUniverseDomain())
...
async def test_get_location_field_headers_async():
    client = TestCasesAsyncClient(credentials=_AnonymousCredentialsWithUniverseDomain())

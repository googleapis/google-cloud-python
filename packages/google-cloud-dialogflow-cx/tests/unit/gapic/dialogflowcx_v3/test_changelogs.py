...
from google.cloud.dialogflowcx_v3.services.changelogs import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ChangelogsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        ChangelogsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ChangelogsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ChangelogsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert ChangelogsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert (
        ChangelogsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert ChangelogsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ChangelogsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ChangelogsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ChangelogsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        ChangelogsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ChangelogsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ChangelogsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ChangelogsClient),
)
@mock.patch.object(
    ChangelogsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ChangelogsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ChangelogsClient._DEFAULT_UNIVERSE
    default_endpoint = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ChangelogsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ChangelogsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ChangelogsClient._get_api_endpoint(None, None, default_universe, "always")
        == ChangelogsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ChangelogsClient._get_api_endpoint(
    ...
    assert (
        ChangelogsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ChangelogsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ChangelogsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ChangelogsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ChangelogsClient._get_universe_domain(None, None)
        == ChangelogsClient._DEFAULT_UNIVERSE
    )
...
def test_changelogs_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_changelogs_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_changelogs_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    ChangelogsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ChangelogsClient)
)
@mock.patch.object(
    ChangelogsAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ChangelogsAsyncClient),
)
...
def test_changelogs_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_changelogs_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_changelogs_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.changelogs.transports.ChangelogsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_changelogs_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_list_changelogs_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_changelogs), "__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            changelog.ListChangelogsResponse(
...
def test_list_changelogs_rest_required_fields(
    request_type=changelog.ListChangelogsRequest,
):
...
def test_list_changelogs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*}/changelogs"
...
def test_get_changelog_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/changelogs/*}"
            % client.transport._host,
            args[1],
        )
...
def test_changelogs_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.changelogs.transports.ChangelogsTransport.__init__"
    ) as Transport:
...
def test_changelogs_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.dialogflowcx_v3.services.changelogs.transports.ChangelogsTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

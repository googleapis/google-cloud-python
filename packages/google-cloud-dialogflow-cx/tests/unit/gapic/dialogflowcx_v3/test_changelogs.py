...
from google.cloud.dialogflowcx_v3.services.changelogs import ChangelogsAsyncClient
...
from google.cloud.dialogflowcx_v3.services.changelogs import transports
from google.cloud.dialogflowcx_v3.services.changelogs.transports.base import (
...
def test_list_changelogs(
    transport: str = "grpc", request_type=changelog.ListChangelogsRequest
):
...
def test_list_changelogs_from_dict():
    test_list_changelogs(request_type=dict)
...
def test_list_changelogs_pager():
    client = ChangelogsClient(credentials=ga_credentials.AnonymousCredentials,)
...
def test_list_changelogs_pages():
    client = ChangelogsClient(credentials=ga_credentials.AnonymousCredentials,)
...
def test_get_changelog(
    transport: str = "grpc", request_type=changelog.GetChangelogRequest
):
    client = ChangelogsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_get_changelog_from_dict():
    test_get_changelog(request_type=dict)
...
def test_changelogs_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(
        google.auth, "load_credentials_from_file", autospec=True
    ) as load_creds, mock.patch(
...
@requires_google_auth_lt_1_25_0
def test_changelogs_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        ChangelogsClient()
...
@requires_google_auth_lt_1_25_0
def test_changelogs_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_changelogs_host_no_port():
    client = ChangelogsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_changelogs_host_with_port():
    client = ChangelogsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(

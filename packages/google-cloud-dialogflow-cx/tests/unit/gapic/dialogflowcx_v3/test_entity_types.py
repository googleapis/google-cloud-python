...
from google.cloud.dialogflowcx_v3.services.entity_types import (
...
def test_entity_types_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_export_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.export_entity_types in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.export_entity_types] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_export_entity_types_async(
...
def test_import_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.import_entity_types in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.import_entity_types] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_import_entity_types_async(
...
def test_get_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/entityTypes/*}"
...
def test_create_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*}/entityTypes"
            % client.transport._host,
            args[1],
        )
...
def test_update_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{entity_type.name=projects/*/locations/*/agents/*/entityTypes/*}"
            % client.transport._host,
            args[1],
        )
...
def test_export_entity_types_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).export_entity_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_entity_types_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).import_entity_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_entity_types_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport.__init__"
    ) as Transport:

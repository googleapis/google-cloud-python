...
from google.cloud.dialogflowcx_v3.services.entity_types import EntityTypesAsyncClient, EntityTypesClient, pagers, transports
...
def test_export_entity_types(request_type, transport: str = "grpc"):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_entity_types_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
        ...
        # Ensure method has been cached
        assert client._transport.export_entity_types in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_entity_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_entity_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_entity_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_entity_types] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_entity_types_async(transport: str = "grpc_asyncio", request_type=entity_type.ExportEntityTypesRequest):
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.export_entity_types), "__call__") as call:
        ...
        response = await client.export_entity_types(request)
...
@pytest.mark.asyncio
async def test_export_entity_types_async_from_dict():
    await test_export_entity_types_async(request_type=dict)


def test_export_entity_types_field_headers():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_import_entity_types(request_type, transport: str = "grpc"):
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.import_entity_types), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_import_entity_types_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EntityTypesClient(
        ...
        # Ensure method has been cached
        assert client._transport.import_entity_types in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_entity_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_entity_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_entity_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_entity_types] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_entity_types_async(transport: str = "grpc_asyncio", request_type=entity_type.ImportEntityTypesRequest):
    client = EntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.import_entity_types), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        response = await client.import_entity_types(request)
...
@pytest.mark.asyncio
async def test_import_entity_types_async_from_dict():
    await test_import_entity_types_async(request_type=dict)


def test_import_entity_types_field_headers():
    client = EntityTypesClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {"name": "projects/sample1/locations/sample2/agents/sample3/entityTypes/sample4"}
        ...
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_create_entity_type_rest_required_fields(request_type=gcdc_entity_type.CreateEntityTypeRequest):
    transport_class = transports.EntityTypesRestTransport
...
def test_create_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*}/entityTypes" % client.transport._host, args[1])
...
def test_update_entity_type_rest_required_fields(request_type=gcdc_entity_type.UpdateEntityTypeRequest):
    transport_class = transports.EntityTypesRestTransport
...
def test_update_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"entity_type": {"name": "projects/sample1/locations/sample2/agents/sample3/entityTypes/sample4"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{entity_type.name=projects/*/locations/*/agents/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_export_entity_types_rest_required_fields(request_type=entity_type.ExportEntityTypesRequest):
    transport_class = transports.EntityTypesRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["entity_types"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, use_integers_for_enums=False))
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_entity_types._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    jsonified_request["parent"] = "parent_value"
    jsonified_request["entityTypes"] = "entity_types_value"
    ...
    assert "parent" in jsonified_request
    assert jsonified_request["parent"] == "parent_value"
    assert "entityTypes" in jsonified_request
    assert jsonified_request["entityTypes"] == "entity_types_value"
...
def test_export_entity_types_rest_unset_required_fields():
    transport = transports.EntityTypesRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.export_entity_types._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_import_entity_types_rest_required_fields(request_type=entity_type.ImportEntityTypesRequest):
    transport_class = transports.EntityTypesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_entity_types._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_import_entity_types_rest_unset_required_fields():
    transport = transports.EntityTypesRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.import_entity_types._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_get_entity_type_rest_bad_request(request_type=entity_type.GetEntityTypeRequest):
    ...
    request_init = {"name": "projects/sample1/locations/sample2/agents/sample3/entityTypes/sample4"}
    request = request_type(**request_init)
...
def test_create_entity_type_rest_bad_request(request_type=gcdc_entity_type.CreateEntityTypeRequest):
    client = EntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_entity_type.CreateEntityTypeRequest.pb(gcdc_entity_type.CreateEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcdc_entity_type.EntityType.to_json(gcdc_entity_type.EntityType())
        req.return_value.content = return_value
...
def test_update_entity_type_rest_bad_request(request_type=gcdc_entity_type.UpdateEntityTypeRequest):
    client = EntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"entity_type": {"name": "projects/sample1/locations/sample2/agents/sample3/entityTypes/sample4"}}
    request = request_type(**request_init)
...
def test_update_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_entity_type.UpdateEntityTypeRequest.pb(gcdc_entity_type.UpdateEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_export_entity_types_rest_bad_request(request_type=entity_type.ExportEntityTypesRequest):
    client = EntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/agents/sample3"}
    request = request_type(**request_init)
...
def test_export_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_type.ExportEntityTypesRequest.pb(entity_type.ExportEntityTypesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_import_entity_types_rest_bad_request(request_type=entity_type.ImportEntityTypesRequest):
    client = EntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/agents/sample3"}
    request = request_type(**request_init)
...
def test_import_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = entity_type.ImportEntityTypesRequest.pb(entity_type.ImportEntityTypesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_entity_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.dialogflowcx_v3.services.entity_types.transports.EntityTypesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_entity_types_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.export_entity_types._session
    session2 = client2.transport.export_entity_types._session
    assert session1 != session2
    session1 = client1.transport.import_entity_types._session
    session2 = client2.transport.import_entity_types._session
    assert session1 != session2

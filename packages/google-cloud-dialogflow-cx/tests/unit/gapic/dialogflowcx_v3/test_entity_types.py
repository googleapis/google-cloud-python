...
def test_export_entity_types_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseExportEntityTypes,
        "_BaseExportEntityTypes__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_import_entity_types_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseImportEntityTypes,
        "_BaseImportEntityTypes__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
from google.cloud.dialogflowcx_v3.services.playbooks import (
...
from google.cloud.dialogflowcx_v3.types import response_message, tool_call, trace
...
def test_playbooks_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.playbooks.transports.PlaybooksGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_playbook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*}/playbooks"
...
def test_delete_playbook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/playbooks/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_playbook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{playbook.name=projects/*/locations/*/agents/*/playbooks/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_playbook_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*/playbooks/*}/versions"
            % client.transport._host,
            args[1],
        )
...
def test_get_playbook_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/playbooks/*/versions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_restore_playbook_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/playbooks/*/versions/*}:restore"
            % client.transport._host,
            args[1],
        )
...
def test_playbooks_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.playbooks.transports.PlaybooksTransport.__init__"
    ) as Transport:
...
def test_playbooks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflowcx_v3.services.playbooks.transports.PlaybooksTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

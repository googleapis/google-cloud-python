...
from google.cloud.dialogflowcx_v3.services.session_entity_types import SessionEntityTypesAsyncClient, SessionEntityTypesClient, pagers, transports
...
async def test_create_session_entity_type_async(
    transport: str = "grpc_asyncio", request_type=gcdc_session_entity_type.CreateSessionEntityTypeRequest
):
    client = SessionEntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_update_session_entity_type_async(
    transport: str = "grpc_asyncio", request_type=gcdc_session_entity_type.UpdateSessionEntityTypeRequest
):
    client = SessionEntityTypesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_session_entity_types_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {"parent": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4"}
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*/sessions/*}/entityTypes" % client.transport._host, args[1])
...
def test_get_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4/entityTypes/sample5"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/sessions/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_create_session_entity_type_rest_required_fields(request_type=gcdc_session_entity_type.CreateSessionEntityTypeRequest):
    transport_class = transports.SessionEntityTypesRestTransport
...
def test_update_session_entity_type_rest_required_fields(request_type=gcdc_session_entity_type.UpdateSessionEntityTypeRequest):
    transport_class = transports.SessionEntityTypesRestTransport
...
def test_update_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"session_entity_type": {"name": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4/entityTypes/sample5"}}
        ...
        assert path_template.validate(
            "%s/v3/{session_entity_type.name=projects/*/locations/*/agents/*/sessions/*/entityTypes/*}" % client.transport._host, args[1]
        )
...
def test_list_session_entity_types_rest_bad_request(request_type=session_entity_type.ListSessionEntityTypesRequest):
    ...
    request_init = {"parent": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4"}
    request = request_type(**request_init)
...
def test_get_session_entity_type_rest_bad_request(request_type=session_entity_type.GetSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4/entityTypes/sample5"}
    request = request_type(**request_init)
...
def test_create_session_entity_type_rest_bad_request(request_type=gcdc_session_entity_type.CreateSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4"}
    request = request_type(**request_init)
...
def test_create_session_entity_type_rest_call_success(request_type):
    ...
    test_field = gcdc_session_entity_type.CreateSessionEntityTypeRequest.meta.fields["session_entity_type"]
...
def test_create_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_session_entity_type.CreateSessionEntityTypeRequest.pb(gcdc_session_entity_type.CreateSessionEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcdc_session_entity_type.SessionEntityType.to_json(gcdc_session_entity_type.SessionEntityType())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcdc_session_entity_type.SessionEntityType(), metadata
...
def test_update_session_entity_type_rest_bad_request(request_type=gcdc_session_entity_type.UpdateSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"session_entity_type": {"name": "projects/sample1/locations/sample2/agents/sample3/sessions/sample4/entityTypes/sample5"}}
    request = request_type(**request_init)
...
def test_update_session_entity_type_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcdc_session_entity_type.UpdateSessionEntityTypeRequest.meta.fields["session_entity_type"]
...
def test_update_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_session_entity_type.UpdateSessionEntityTypeRequest.pb(gcdc_session_entity_type.UpdateSessionEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_session_entity_types_base_transport():
    ...
    with mock.patch("google.cloud.dialogflowcx_v3.services.session_entity_types.transports.SessionEntityTypesTransport.__init__") as Transport:

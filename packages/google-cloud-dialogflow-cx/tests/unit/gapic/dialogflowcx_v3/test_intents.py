...
from google.cloud.dialogflowcx_v3.services.intents import IntentsAsyncClient, IntentsClient, pagers, transports
...
def test_import_intents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_intents in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_intents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_intents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IntentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_intents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_intents] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_intents_async(transport: str = "grpc_asyncio", request_type=intent.ImportIntentsRequest):
    client = IntentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.import_intents), "__call__") as call:
        ...
        response = await client.import_intents(request)
...
@pytest.mark.asyncio
async def test_export_intents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = IntentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_intents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_intents] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_intents_async(transport: str = "grpc_asyncio", request_type=intent.ExportIntentsRequest):
    client = IntentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.export_intents), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        response = await client.export_intents(request)
...
def test_list_intents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*}/intents" % client.transport._host, args[1])
...
def test_get_intent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/agents/sample3/intents/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/intents/*}" % client.transport._host, args[1])
...
def test_create_intent_rest_required_fields(request_type=gcdc_intent.CreateIntentRequest):
    transport_class = transports.IntentsRestTransport
...
def test_update_intent_rest_required_fields(request_type=gcdc_intent.UpdateIntentRequest):
    transport_class = transports.IntentsRestTransport
...
def test_update_intent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"intent": {"name": "projects/sample1/locations/sample2/agents/sample3/intents/sample4"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{intent.name=projects/*/locations/*/agents/*/intents/*}" % client.transport._host, args[1])
...
def test_import_intents_rest_required_fields(request_type=intent.ImportIntentsRequest):
    transport_class = transports.IntentsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_intents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_intents_rest_unset_required_fields():
    ...
    unset_fields = transport.import_intents._get_unset_required_fields({})
...
def test_export_intents_rest_required_fields(request_type=intent.ExportIntentsRequest):
    transport_class = transports.IntentsRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["intents"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, use_integers_for_enums=False))
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_intents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present

    jsonified_request["parent"] = "parent_value"
    jsonified_request["intents"] = "intents_value"
    ...
    assert "parent" in jsonified_request
    assert jsonified_request["parent"] == "parent_value"
    assert "intents" in jsonified_request
    assert jsonified_request["intents"] == "intents_value"
...
def test_export_intents_rest_unset_required_fields():
    ...
    unset_fields = transport.export_intents._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_get_intent_rest_bad_request(request_type=intent.GetIntentRequest):
    client = IntentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/agents/sample3/intents/sample4"}
    request = request_type(**request_init)
...
def test_create_intent_rest_call_success(request_type):
    ...
    request_init["intent"] = {
        "name": "name_value",
        "display_name": "display_name_value",
        "training_phrases": [{"id": "id_value", "parts": [{"text": "text_value", "parameter_id": "parameter_id_value"}], "repeat_count": 1289}],
        "parameters": [{"id": "id_value", "entity_type": "entity_type_value", "is_list": True, "redact": True}],
        "priority": 898,
        "is_fallback": True,
        "labels": {},
        "description": "description_value",
...
def test_create_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_intent.CreateIntentRequest.pb(gcdc_intent.CreateIntentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_intent_rest_bad_request(request_type=gcdc_intent.UpdateIntentRequest):
    client = IntentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"intent": {"name": "projects/sample1/locations/sample2/agents/sample3/intents/sample4"}}
    request = request_type(**request_init)
...
def test_update_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcdc_intent.UpdateIntentRequest.pb(gcdc_intent.UpdateIntentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_intents_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.dialogflowcx_v3.services.intents.transports.IntentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_intents_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.import_intents._session
    session2 = client2.transport.import_intents._session
    assert session1 != session2
    session1 = client1.transport.export_intents._session
    session2 = client2.transport.export_intents._session
    assert session1 != session2

...
from google.cloud.dialogflowcx_v3.services.webhooks import (
    WebhooksAsyncClient,
    WebhooksClient,
    pagers,
    transports,
...
def test__get_client_cert_source():
    ...
    assert (
        WebhooksClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        WebhooksClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                WebhooksClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                WebhooksClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(WebhooksClient),
)
@mock.patch.object(
    WebhooksAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(WebhooksAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WebhooksClient._DEFAULT_UNIVERSE
    default_endpoint = WebhooksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = WebhooksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        WebhooksClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        WebhooksClient._get_api_endpoint(None, None, default_universe, "always")
        == WebhooksClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        WebhooksClient._get_api_endpoint(
    ...
    assert (
        WebhooksClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        WebhooksClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        WebhooksClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        WebhooksClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        WebhooksClient._get_universe_domain(None, None)
        == WebhooksClient._DEFAULT_UNIVERSE
    )
...
def test_create_webhook_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.create_webhook), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == webhook.CreateWebhookRequest(
            parent="parent_value",
        )
...
async def test_create_webhook_async(
    transport: str = "grpc_asyncio", request_type=webhook.CreateWebhookRequest
):
    client = WebhooksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_webhook_flattened():
    ...
    with mock.patch.object(type(client.transport.create_webhook), "__call__") as call:
        ...
        client.create_webhook(
            parent="parent_value",
            webhook=webhook.Webhook(name="name_value"),
        )
        ...
        assert arg == mock_val
        arg = args[0].webhook
        mock_val = webhook.Webhook(name="name_value")
        assert arg == mock_val
...
def test_update_webhook_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.update_webhook), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == webhook.UpdateWebhookRequest()
...
async def test_update_webhook_async(
    transport: str = "grpc_asyncio", request_type=webhook.UpdateWebhookRequest
):
    client = WebhooksAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_webhooks_rest_required_fields(request_type=webhook.ListWebhooksRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_webhooks._get_unset_required_fields(jsonified_request)
...
def test_list_webhooks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*}/webhooks"
...
def test_get_webhook_rest_required_fields(request_type=webhook.GetWebhookRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_webhook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/webhooks/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_webhook_rest_required_fields(request_type=webhook.CreateWebhookRequest):
    transport_class = transports.WebhooksRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_webhook_rest_required_fields(request_type=webhook.UpdateWebhookRequest):
    transport_class = transports.WebhooksRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_webhook_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{webhook.name=projects/*/locations/*/agents/*/webhooks/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_webhook_rest_required_fields(request_type=webhook.DeleteWebhookRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_webhook._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_webhook_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_webhook), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = webhook.CreateWebhookRequest()
...
def test_update_webhook_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.update_webhook), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = webhook.UpdateWebhookRequest()
...
def test_create_webhook_rest_bad_request(request_type=webhook.CreateWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_create_webhook_rest_call_success(request_type):
    ...
    test_field = webhook.CreateWebhookRequest.meta.fields["webhook"]
...
def test_create_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = webhook.CreateWebhookRequest.pb(webhook.CreateWebhookRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_webhook_rest_bad_request(request_type=webhook.UpdateWebhookRequest):
    client = WebhooksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_update_webhook_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = webhook.UpdateWebhookRequest.meta.fields["webhook"]
...
def test_update_webhook_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = webhook.UpdateWebhookRequest.pb(webhook.UpdateWebhookRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,

...
def test__get_default_mtls_endpoint():
    ...
    assert WebhooksClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_create_webhook_rest_required_fields(
...
def test_update_webhook_rest_required_fields(
...
def test_get_webhook_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.WebhooksRestInterceptor, "pre_get_webhook") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_webhook_rest_call_success(request_type):
    ...
    request_init["webhook"] = {
        ...
        "generic_web_service": {
            ...
            "service_account_auth_config": {"service_account": "service_account_value"},
            "webhook_type": 1,
            "http_method": 1,

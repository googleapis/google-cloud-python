...
def test_get_location_field_headers():
    client = WebhooksClient(credentials=_AnonymousCredentialsWithUniverseDomain())
...
async def test_get_location_field_headers_async():
    client = WebhooksAsyncClient(credentials=_AnonymousCredentialsWithUniverseDomain())

...
from google.cloud.dialogflowcx_v3.services.agents import AgentsAsyncClient, AgentsClient, pagers, transports
...
def test_get_generative_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/generativeSettings}" % client.transport._host, args[1])
...
def test_update_generative_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{generative_settings.name=projects/*/locations/*/agents/*/generativeSettings}" % client.transport._host, args[1]
        )
...
def test_update_generative_settings_rest_call_success(request_type):
    ...
    request_init["generative_settings"] = {
        ...
        "generative_safety_settings": {"banned_phrases": [{"text": "text_value", "language_code": "language_code_value"}]},

...
from google.cloud.dialogflowcx_v3.services.sessions import SessionsAsyncClient, SessionsClient, transports
from google.cloud.dialogflowcx_v3.types import audio_config, entity_type, intent, page, session, session_entity_type
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SessionsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SessionsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SessionsClient._use_client_cert_effective()
...
def test_server_streaming_detect_intent(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.server_streaming_detect_intent), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_submit_answer_feedback(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.submit_answer_feedback), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_server_streaming_detect_intent_rest_required_fields(request_type=session.DetectIntentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).server_streaming_detect_intent._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_submit_answer_feedback_rest_required_fields(request_type=session.SubmitAnswerFeedbackRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).submit_answer_feedback._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_streaming_detect_intent_rest_error():
    client = SessionsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    assert "Method StreamingDetectIntent is not available over REST transport" in str(not_implemented_error.value)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = SessionsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = SessionsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = SessionsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = SessionsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SessionsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SessionsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_detect_intent_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.SessionsRestInterceptor, "post_detect_intent") as post, mock.patch.object(
...
def test_server_streaming_detect_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionsRestInterceptor, "post_server_streaming_detect_intent") as post, mock.patch.object(
        transports.SessionsRestInterceptor, "post_server_streaming_detect_intent_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_match_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionsRestInterceptor, "post_match_intent") as post, mock.patch.object(
...
def test_fulfill_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionsRestInterceptor, "post_fulfill_intent") as post, mock.patch.object(
...
def test_submit_answer_feedback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionsRestInterceptor, "post_submit_answer_feedback") as post, mock.patch.object(
...
def test_sessions_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.SessionsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.SessionsGrpcTransport, grpc_helpers), (transports.SessionsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_sessions_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.SessionsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = SessionsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

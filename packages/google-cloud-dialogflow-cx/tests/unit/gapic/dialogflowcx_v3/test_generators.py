...
from google.cloud.dialogflowcx_v3.services.generators import GeneratorsAsyncClient, GeneratorsClient, pagers, transports
...
def test_generators_client_client_options_from_dict():
    with mock.patch("google.cloud.dialogflowcx_v3.services.generators.transports.GeneratorsGrpcTransport.__init__") as grpc_transport:
...
def test_list_generators_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v3/{parent=projects/*/locations/*/agents/*}/generators" % client.transport._host, args[1])
...
def test_get_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*/locations/*/agents/*/generators/*}" % client.transport._host, args[1])
...
def test_update_generator_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{generator.name=projects/*/locations/*/agents/*/generators/*}" % client.transport._host, args[1])
...
def test_generators_base_transport():
    ...
    with mock.patch("google.cloud.dialogflowcx_v3.services.generators.transports.GeneratorsTransport.__init__") as Transport:

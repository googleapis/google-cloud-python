...
from google.cloud.dialogflowcx_v3.services.experiments import ExperimentsAsyncClient, ExperimentsClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ExperimentsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ExperimentsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ExperimentsClient._use_client_cert_effective()
...
async def test_list_experiments_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_experiments), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            experiment.ListExperimentsResponse(
                experiments=[
...
async def test_list_experiments_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_experiments), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_experiments(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_experiment(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_experiment), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_update_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{experiment.name=projects/*/locations/*/agents/*/environments/*/experiments/*}" % client.transport._host, args[1]
        )
...
def test_start_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:start" % client.transport._host, args[1]
        )
...
def test_stop_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:stop" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ExperimentsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ExperimentsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ExperimentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = ExperimentsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ExperimentsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ExperimentsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_experiments_rest_bad_request(request_type=experiment.ListExperimentsRequest):
    client = ExperimentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_experiments_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "post_list_experiments") as post, mock.patch.object(
...
def test_get_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "post_get_experiment") as post, mock.patch.object(
...
def test_create_experiment_rest_call_success(request_type):
    ...
    request_init["experiment"] = {
        ...
        "definition": {
            ...
            "version_variants": {"variants": [{"version": "version_value", "traffic_allocation": 0.1892, "is_control_group": True}]},
        },
        "rollout_config": {
            "rollout_steps": [{"display_name": "display_name_value", "traffic_percent": 1583, "min_duration": {"seconds": 751, "nanos": 543}}],
            "rollout_condition": "rollout_condition_value",
            "failure_condition": "failure_condition_value",
        },
        "rollout_state": {"step": "step_value", "step_index": 1075, "start_time": {"seconds": 751, "nanos": 543}},
        "rollout_failure_reason": "rollout_failure_reason_value",
        "result": {
            "version_metrics": [
                {
...
def test_create_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "post_create_experiment") as post, mock.patch.object(
...
def test_update_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "post_update_experiment") as post, mock.patch.object(
...
def test_delete_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "pre_delete_experiment") as pre:
        pre.assert_not_called()
...
def test_start_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "post_start_experiment") as post, mock.patch.object(
...
def test_stop_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ExperimentsRestInterceptor, "post_stop_experiment") as post, mock.patch.object(
...
def test_experiments_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ExperimentsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.ExperimentsGrpcTransport, grpc_helpers), (transports.ExperimentsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_experiments_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ExperimentsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ExperimentsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
async def test_list_experiments_async(
    ...
    with mock.patch.object(type(client.transport.list_experiments), "__call__") as call:
        ...
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            experiment.ListExperimentsResponse(next_page_token="next_page_token_value",)
        )
...
def test_list_experiments_field_headers():
    client = ExperimentsClient(credentials=credentials.AnonymousCredentials(),)
...
async def test_list_experiments_field_headers_async():
    client = ExperimentsAsyncClient(credentials=credentials.AnonymousCredentials(),)
...
def test_list_experiments_flattened():
    ...
    with mock.patch.object(type(client.transport.list_experiments), "__call__") as call:
        ...
        client.list_experiments(parent="parent_value",)
...
def test_list_experiments_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_experiments(
            experiment.ListExperimentsRequest(), parent="parent_value",
        )
...
async def test_list_experiments_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_experiments), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_experiments(parent="parent_value",)
...
def test_list_experiments_pager():
    ...
    with mock.patch.object(type(client.transport.list_experiments), "__call__") as call:
        ...
        call.side_effect = (
            ...
            experiment.ListExperimentsResponse(experiments=[], next_page_token="def",),
            experiment.ListExperimentsResponse(
                experiments=[experiment.Experiment(),], next_page_token="ghi",
            ),
            experiment.ListExperimentsResponse(
...
def test_update_experiment_field_headers():
    ...
    # Establish that the field header was sent.
    _, _, kw = call.mock_calls[0]
    assert ("x-goog-request-params", "experiment.name=experiment.name/value",) in kw[
        "metadata"
    ]
...
def test_stop_experiment_flattened():
    ...
    with mock.patch.object(type(client.transport.stop_experiment), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.stop_experiment(name="name_value",)
...
async def test_stop_experiment_flattened_async():
    ...
    with mock.patch.object(type(client.transport.stop_experiment), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.stop_experiment(name="name_value",)
...
def test_transport_grpc_default():
    ...
    client = ExperimentsClient(credentials=credentials.AnonymousCredentials(),)
    assert isinstance(client.transport, transports.ExperimentsGrpcTransport,)

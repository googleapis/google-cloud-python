...
from google.cloud.dialogflowcx_v3.services.experiments import (
...
def test_experiments_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.experiments.transports.ExperimentsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_experiments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_experiments] = (
            mock_rpc
        )
        request = {}
...
def test_create_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_experiment] = (
            mock_rpc
        )
        request = {}
...
def test_update_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_experiment] = (
            mock_rpc
        )
        request = {}
...
def test_delete_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_experiment] = (
            mock_rpc
        )
        request = {}
...
def test_start_experiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.start_experiment] = (
            mock_rpc
        )
        request = {}
...
def test_list_experiments_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListExperiments,
...
def test_list_experiments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*/agents/*/environments/*}/experiments"
...
def test_get_experiment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetExperiment,
...
def test_get_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_experiment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateExperiment,
...
def test_update_experiment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateExperiment,
...
def test_update_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{experiment.name=projects/*/locations/*/agents/*/environments/*/experiments/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_experiment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteExperiment,
...
def test_start_experiment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseStartExperiment,
...
def test_start_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:start"
            % client.transport._host,
            args[1],
        )
...
def test_stop_experiment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseStopExperiment,
...
def test_stop_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/agents/*/environments/*/experiments/*}:stop"
            % client.transport._host,
            args[1],
        )
...
def test_experiments_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflowcx_v3.services.experiments.transports.ExperimentsTransport.__init__"
    ) as Transport:

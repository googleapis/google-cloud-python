...
def test_create_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v3/{parent=projects/*/locations/*}/securitySettings"
...
def test_get_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{name=projects/*/locations/*/securitySettings/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_security_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v3/{security_settings.name=projects/*/locations/*/securitySettings/*}"
            % client.transport._host,
            args[1],
        )

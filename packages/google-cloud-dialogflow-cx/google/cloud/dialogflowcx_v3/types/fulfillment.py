...
class Fulfillment(proto.Message):
    ...
    Attributes:
        ...
        set_parameter_actions (Sequence[google.cloud.dialogflowcx_v3.types.Fulfillment.SetParameterAction]):
            ...
            webhook.
        conditional_cases (Sequence[google.cloud.dialogflowcx_v3.types.Fulfillment.ConditionalCases]):
    ...
    class ConditionalCases(proto.Message):
        ...
        Attributes:
            cases (Sequence[google.cloud.dialogflowcx_v3.types.Fulfillment.ConditionalCases.Case]):
        ...
        class Case(proto.Message):
            ...
            Attributes:
                ...
                case_content (Sequence[google.cloud.dialogflowcx_v3.types.Fulfillment.ConditionalCases.Case.CaseContent]):

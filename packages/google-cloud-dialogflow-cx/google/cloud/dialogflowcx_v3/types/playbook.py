...
class Playbook(proto.Message):
    ...
    Attributes:
        ...
        instruction (google.cloud.dialogflowcx_v3.types.Playbook.Instruction):
        ...
        code_block (google.cloud.dialogflowcx_v3.types.CodeBlock):
        ...
        llm_model_settings (google.cloud.dialogflowcx_v3.types.LlmModelSettings):
            ...
            playbook.
        handlers (MutableSequence[google.cloud.dialogflowcx_v3.types.Handler]):
            Optional. A list of registered handlers to
            execuate based on the specified triggers.
        playbook_type (google.cloud.dialogflowcx_v3.types.Playbook.PlaybookType):
    ...
    class Step(proto.Message):
        ...
        Attributes:
            ...
            steps (MutableSequence[google.cloud.dialogflowcx_v3.types.Playbook.Step]):
...
class CreatePlaybookVersionRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``projects/<ProjectID>/locations/<LocationID>/agents/<AgentID>/playbooks/<PlaybookID>``.
        playbook_version (google.cloud.dialogflowcx_v3.types.PlaybookVersion):
...
class ExportPlaybookRequest(proto.Message):
    ...
    Attributes:
        ...
        data_format (google.cloud.dialogflowcx_v3.types.ExportPlaybookRequest.DataFormat):
...
class ImportPlaybookRequest(proto.Message):
    ...
    Attributes:
        ...
        playbook_content (bytes):
            ...
            This field is a member of `oneof`_ ``playbook``.
        import_strategy (google.cloud.dialogflowcx_v3.types.PlaybookImportStrategy):
...
class ImportPlaybookResponse(proto.Message):
    ...
    Attributes:
        playbook (str):
            ...
            ``projects/<ProjectID>/locations/<LocationID>/agents/<AgentID>/playbooks/<PlaybookID>``.
        conflicting_resources (google.cloud.dialogflowcx_v3.types.ImportPlaybookResponse.ConflictingResources):
...
class Handler(proto.Message):
    ...
    Attributes:
        event_handler (google.cloud.dialogflowcx_v3.types.Handler.EventHandler):
            A handler triggered by event.

            This field is a member of `oneof`_ ``handler``.
        lifecycle_handler (google.cloud.dialogflowcx_v3.types.Handler.LifecycleHandler):
    ...
    class EventHandler(proto.Message):
        ...
        Attributes:
            ...
            fulfillment (google.cloud.dialogflowcx_v3.types.Fulfillment):

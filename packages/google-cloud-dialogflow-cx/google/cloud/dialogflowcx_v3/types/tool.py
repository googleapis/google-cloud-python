...
class Tool(proto.Message):
    ...
    [Playbook][google.cloud.dialogflow.cx.v3.Playbook] to attain its
    ...
    Attributes:
        ...
        description (str):
            ...
            and its usage.
        open_api_spec (google.cloud.dialogflowcx_v3.types.Tool.OpenApiTool):
            OpenAPI specification of the Tool.

            This field is a member of `oneof`_ ``specification``.
        data_store_spec (google.cloud.dialogflowcx_v3.types.Tool.DataStoreTool):
            Data store search tool specification.

            This field is a member of `oneof`_ ``specification``.
        function_spec (google.cloud.dialogflowcx_v3.types.Tool.FunctionTool):
            Client side executed function specification.

            This field is a member of `oneof`_ ``specification``.
        tool_type (google.cloud.dialogflowcx_v3.types.Tool.ToolType):
    ...
    class OpenApiTool(proto.Message):
        ...
        Attributes:
            ...
            authentication (google.cloud.dialogflowcx_v3.types.Tool.Authentication):
                Optional. Authentication information required
                by the API.
            tls_config (google.cloud.dialogflowcx_v3.types.Tool.TLSConfig):
                Optional. TLS configuration for the HTTPS
                verification.
            service_directory_config (google.cloud.dialogflowcx_v3.types.Tool.ServiceDirectoryConfig):
    ...
    class DataStoreTool(proto.Message):
        ...
        Attributes:
            ...
            fallback_prompt (google.cloud.dialogflowcx_v3.types.Tool.DataStoreTool.FallbackPrompt):
    ...
    class Authentication(proto.Message):
        ...
        Attributes:
            api_key_config (google.cloud.dialogflowcx_v3.types.Tool.Authentication.ApiKeyConfig):
                Config for API key auth.

                This field is a member of `oneof`_ ``auth_config``.
            oauth_config (google.cloud.dialogflowcx_v3.types.Tool.Authentication.OAuthConfig):
                Config for OAuth.
            ...
            service_agent_auth_config (google.cloud.dialogflowcx_v3.types.Tool.Authentication.ServiceAgentAuthConfig):
                ...
                This field is a member of `oneof`_ ``auth_config``.
            bearer_token_config (google.cloud.dialogflowcx_v3.types.Tool.Authentication.BearerTokenConfig):
                Config for bearer token auth.

                This field is a member of `oneof`_ ``auth_config``.
            service_account_auth_config (google.cloud.dialogflowcx_v3.types.Tool.Authentication.ServiceAccountAuthConfig):
        ...
        class ApiKeyConfig(proto.Message):
            ...
            Attributes:
                ...
                request_location (google.cloud.dialogflowcx_v3.types.Tool.Authentication.RequestLocation):
        ...
        class OAuthConfig(proto.Message):
            ...
            Attributes:
                oauth_grant_type (google.cloud.dialogflowcx_v3.types.Tool.Authentication.OAuthConfig.OauthGrantType):
    ...
    class TLSConfig(proto.Message):
        ...
        Attributes:
            ca_certs (MutableSequence[google.cloud.dialogflowcx_v3.types.Tool.TLSConfig.CACert]):

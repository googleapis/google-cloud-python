...
class CreateExampleRequest(proto.Message):
    ...
    Attributes:
        ...
        example (google.cloud.dialogflowcx_v3.types.Example):
...
class ListExamplesResponse(proto.Message):
    ...
    Attributes:
        examples (MutableSequence[google.cloud.dialogflowcx_v3.types.Example]):
...
class Example(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            updated.
        conversation_state (google.cloud.dialogflowcx_v3.types.OutputState):

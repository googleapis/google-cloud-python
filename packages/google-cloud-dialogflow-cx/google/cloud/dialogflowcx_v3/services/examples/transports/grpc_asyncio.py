...
from .base import DEFAULT_CLIENT_INFO, ExamplesTransport
...
class ExamplesGrpcAsyncIOTransport(ExamplesTransport):
    ...
    def create_example(
        self,
    ) -> Callable[[gcdc_example.CreateExampleRequest], Awaitable[gcdc_example.Example]]:
    ...
    def delete_example(
        self,
    ) -> Callable[[example.DeleteExampleRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def list_examples(
        ...
        [example.ListExamplesRequest], Awaitable[example.ListExamplesResponse]
    ]:
    ...
    def get_example(
        self,
    ) -> Callable[[example.GetExampleRequest], Awaitable[example.Example]]:
    ...
    def update_example(
        self,
    ) -> Callable[[gcdc_example.UpdateExampleRequest], Awaitable[gcdc_example.Example]]:
...
__all__ = ("ExamplesGrpcAsyncIOTransport",)

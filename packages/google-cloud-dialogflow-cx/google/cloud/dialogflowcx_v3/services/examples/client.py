...
class ExamplesClient(metaclass=ExamplesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ExamplesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ExamplesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ExamplesClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ExamplesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3.ExamplesClient`.",
                    extra={
    ...
    def create_example(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.CreateExampleRequest, dict]):
    ...
    def delete_example(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.DeleteExampleRequest, dict]):
                The request object. The request message for
    ...
    def list_examples(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ListExamplesRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.examples.pagers.ListExamplesPager:
    ...
    def get_example(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.GetExampleRequest, dict]):
                The request object. The request message for
    ...
    def update_example(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.UpdateExampleRequest, dict]):
                The request object. The request message for

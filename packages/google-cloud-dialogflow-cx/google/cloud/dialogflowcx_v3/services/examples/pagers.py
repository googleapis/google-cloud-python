...
class ListExamplesPager:
    ...
    :class:`google.cloud.dialogflowcx_v3.types.ListExamplesResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListExamplesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.dialogflowcx_v3.types.ListExamplesRequest):
                The initial request object.
            response (google.cloud.dialogflowcx_v3.types.ListExamplesResponse):

...
class _BaseTestCasesRestTransport(TestCasesTransport):
    """Base REST backend transport for TestCases.
    ...
    class _BaseBatchDeleteTestCases:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/testCases:batchDelete",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseBatchRunTestCases:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/testCases:batchRun",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseCalculateCoverage:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v3/{agent=projects/*/locations/*/agents/*}/testCases:calculateCoverage",
                },
            ]
            return http_options
    ...
    class _BaseCreateTestCase:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/testCases",
                    "body": "test_case",
                },
            ]
            return http_options
    ...
    class _BaseExportTestCases:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/testCases:export",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseGetTestCase:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/testCases/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetTestCaseResult:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/testCases/*/results/*}",
                },
            ]
            return http_options
    ...
    class _BaseImportTestCases:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/testCases:import",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseListTestCaseResults:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*/testCases/*}/results",
                },
            ]
            return http_options
    ...
    class _BaseRunTestCase:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/testCases/*}:run",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdateTestCase:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v3/{test_case.name=projects/*/locations/*/agents/*/testCases/*}",
                    "body": "test_case",
                },
            ]
            return http_options
...
__all__ = ("_BaseTestCasesRestTransport",)

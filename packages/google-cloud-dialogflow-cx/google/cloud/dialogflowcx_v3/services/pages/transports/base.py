...
class PagesTransport(abc.ABC):
    ...
    @property
    def list_pages(self) -> Callable[[page.ListPagesRequest], Union[page.ListPagesResponse, Awaitable[page.ListPagesResponse]]]:
        raise NotImplementedError()

    @property
    def get_page(self) -> Callable[[page.GetPageRequest], Union[page.Page, Awaitable[page.Page]]]:
        raise NotImplementedError()

    @property
    def create_page(self) -> Callable[[gcdc_page.CreatePageRequest], Union[gcdc_page.Page, Awaitable[gcdc_page.Page]]]:
        raise NotImplementedError()

    @property
    def update_page(self) -> Callable[[gcdc_page.UpdatePageRequest], Union[gcdc_page.Page, Awaitable[gcdc_page.Page]]]:
        raise NotImplementedError()

    @property
    def delete_page(self) -> Callable[[page.DeletePageRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

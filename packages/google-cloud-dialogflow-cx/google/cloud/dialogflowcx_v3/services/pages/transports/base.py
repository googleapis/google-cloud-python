...
class PagesTransport(abc.ABC):
    ...
    def list_pages(
        ...
        typing.Union[page.ListPagesResponse, typing.Awaitable[page.ListPagesResponse]],
    ]:
    ...
    def get_page(
        ...
        [page.GetPageRequest], typing.Union[page.Page, typing.Awaitable[page.Page]]
    ]:
        raise NotImplementedError()
    ...
    def create_page(
        ...
        typing.Union[gcdc_page.Page, typing.Awaitable[gcdc_page.Page]],
    ]:
        raise NotImplementedError()

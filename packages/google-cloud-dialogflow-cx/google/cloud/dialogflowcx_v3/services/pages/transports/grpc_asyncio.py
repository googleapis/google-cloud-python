...
class PagesGrpcAsyncIOTransport(PagesTransport):
    ...
    @property
    def list_pages(self) -> Callable[[page.ListPagesRequest], Awaitable[page.ListPagesResponse]]:
    ...
    @property
    def create_page(self) -> Callable[[gcdc_page.CreatePageRequest], Awaitable[gcdc_page.Page]]:
    ...
    @property
    def update_page(self) -> Callable[[gcdc_page.UpdatePageRequest], Awaitable[gcdc_page.Page]]:
    ...
    @property
    def delete_page(self) -> Callable[[page.DeletePageRequest], Awaitable[empty_pb2.Empty]]:

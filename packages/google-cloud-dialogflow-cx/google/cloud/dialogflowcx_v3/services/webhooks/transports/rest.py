...
from .base import WebhooksTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/webhooks",
                    "body": "webhook",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/webhooks/*}",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v3/{webhook.name=projects/*/locations/*/agents/*/webhooks/*}",
                    "body": "webhook",
                },
            ]

...
class WebhooksGrpcAsyncIOTransport(WebhooksTransport):
    ...
    @property
    def list_webhooks(self) -> Callable[[webhook.ListWebhooksRequest], Awaitable[webhook.ListWebhooksResponse]]:
    ...
    @property
    def get_webhook(self) -> Callable[[webhook.GetWebhookRequest], Awaitable[webhook.Webhook]]:
    ...
    @property
    def create_webhook(self) -> Callable[[gcdc_webhook.CreateWebhookRequest], Awaitable[gcdc_webhook.Webhook]]:
    ...
    @property
    def update_webhook(self) -> Callable[[gcdc_webhook.UpdateWebhookRequest], Awaitable[gcdc_webhook.Webhook]]:
    ...
    @property
    def delete_webhook(self) -> Callable[[webhook.DeleteWebhookRequest], Awaitable[empty_pb2.Empty]]:

...
class VersionsGrpcAsyncIOTransport(VersionsTransport):
    ...
    @property
    def create_version(self) -> Callable[[gcdc_version.CreateVersionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_version(self) -> Callable[[gcdc_version.UpdateVersionRequest], Awaitable[gcdc_version.Version]]:
    ...
    @property
    def delete_version(self) -> Callable[[version.DeleteVersionRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def load_version(self) -> Callable[[version.LoadVersionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def compare_versions(self) -> Callable[[version.CompareVersionsRequest], Awaitable[version.CompareVersionsResponse]]:

...
class VersionsTransport(abc.ABC):
    ...
    @property
    def create_version(self) -> Callable[[gcdc_version.CreateVersionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_version(self) -> Callable[[gcdc_version.UpdateVersionRequest], Union[gcdc_version.Version, Awaitable[gcdc_version.Version]]]:
        raise NotImplementedError()

    @property
    def delete_version(self) -> Callable[[version.DeleteVersionRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def load_version(self) -> Callable[[version.LoadVersionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def compare_versions(
        self,
    ) -> Callable[[version.CompareVersionsRequest], Union[version.CompareVersionsResponse, Awaitable[version.CompareVersionsResponse]]]:
        raise NotImplementedError()

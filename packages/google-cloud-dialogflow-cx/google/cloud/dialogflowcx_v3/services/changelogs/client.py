...
class ChangelogsClient(metaclass=ChangelogsClientMeta):
    ...
    def changelog_path(
        ...
        return "projects/{project}/locations/{location}/agents/{agent}/changelogs/{changelog}".format(
            project=project,
            location=location,
            agent=agent,
            changelog=changelog,
    ...
    def parse_changelog_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/changelogs/(?P<changelog>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ChangelogsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or ChangelogsClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ChangelogsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ChangelogsClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or ChangelogsClient._get_api_endpoint(

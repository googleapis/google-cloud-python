...
from .base import DEFAULT_CLIENT_INFO, ChangelogsTransport
...
class ChangelogsGrpcAsyncIOTransport(ChangelogsTransport):
    ...
    @property
    def list_changelogs(self) -> Callable[[changelog.ListChangelogsRequest], Awaitable[changelog.ListChangelogsResponse]]:
    ...
    @property
    def get_changelog(self) -> Callable[[changelog.GetChangelogRequest], Awaitable[changelog.Changelog]]:

...
class ExperimentsAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = ExperimentsClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(ExperimentsAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ExperimentsAsyncClient: The constructed client.
        """
        sa_file_func = ExperimentsClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(ExperimentsAsyncClient, filename, *args, **kwargs)

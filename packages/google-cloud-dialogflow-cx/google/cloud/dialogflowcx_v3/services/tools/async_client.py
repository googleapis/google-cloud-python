...
from google.cloud.dialogflowcx_v3.services.tools import pagers
...
class ToolsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3.ToolsAsyncClient`.",
                extra={
    ...
    async def create_tool(
        ...
        *,
        ...
        r"""Creates a [Tool][google.cloud.dialogflow.cx.v3.Tool] in the
        specified agent.
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.CreateToolRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            tool (:class:`google.cloud.dialogflowcx_v3.types.Tool`):
        ...
        Returns:
            google.cloud.dialogflowcx_v3.types.Tool:
                A tool provides a list of actions which are available to the
                   [Playbook][google.cloud.dialogflow.cx.v3.Playbook] to
                   attain its goal. A Tool consists of a description of
                   the tool's usage and a specification of the tool
    ...
    async def list_tools(
        ...
        *,
        ...
        r"""Returns a list of [Tools][google.cloud.dialogflow.cx.v3.Tool] in
        the specified agent.
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.ListToolsRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.tools.pagers.ListToolsAsyncPager:
    ...
    async def get_tool(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.GetToolRequest, dict]]):
                The request object. The request message for
    ...
    async def update_tool(
        ...
        *,
        ...
        r"""Update the specified [Tool][google.cloud.dialogflow.cx.v3.Tool].
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.UpdateToolRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_tool(
        ...
        *,
        ...
        r"""Deletes a specified [Tool][google.cloud.dialogflow.cx.v3.Tool].
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.DeleteToolRequest, dict]]):
                The request object. The request message for
    ...
    async def list_tool_versions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.ListToolVersionsRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.tools.pagers.ListToolVersionsAsyncPager:
                The response message for
                   [Tools.ListToolVersions][google.cloud.dialogflow.cx.v3.Tools.ListToolVersions].
    ...
    async def create_tool_version(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.CreateToolVersionRequest, dict]]):
                The request object. The request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            tool_version (:class:`google.cloud.dialogflowcx_v3.types.ToolVersion`):
        ...
        Returns:
            google.cloud.dialogflowcx_v3.types.ToolVersion:
    ...
    async def get_tool_version(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.GetToolVersionRequest, dict]]):
                The request object. The request message for
    ...
    async def delete_tool_version(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.DeleteToolVersionRequest, dict]]):
                The request object. The request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_restore_tool_version():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.RestoreToolVersionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.RestoreToolVersionRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.types.RestoreToolVersionResponse:
                The response message for
                   [Tools.RestoreToolVersion][google.cloud.dialogflow.cx.v3.Tools.RestoreToolVersion].

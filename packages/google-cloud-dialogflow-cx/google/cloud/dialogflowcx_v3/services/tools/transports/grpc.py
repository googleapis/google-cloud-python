    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.cloud.dialogflow.cx.v3.Tools",
...
class ToolsGrpcTransport(ToolsTransport):
    """gRPC backend transport for Tools.
    ...
    def create_tool(self) -> Callable[[gcdc_tool.CreateToolRequest], gcdc_tool.Tool]:
        ...
        Creates a [Tool][google.cloud.dialogflow.cx.v3.Tool] in the
        specified agent.
    ...
    def list_tools(self) -> Callable[[tool.ListToolsRequest], tool.ListToolsResponse]:
        ...
        Returns a list of [Tools][google.cloud.dialogflow.cx.v3.Tool] in
        the specified agent.

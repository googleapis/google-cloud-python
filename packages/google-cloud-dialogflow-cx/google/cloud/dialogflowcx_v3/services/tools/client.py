...
class ToolsClient(metaclass=ToolsClientMeta):
    ...
    def tool_version_path(
        ...
        return "projects/{project}/locations/{location}/agents/{agent}/tools/{tool}/versions/{version}".format(
            project=project,
            location=location,
            agent=agent,
            tool=tool,
    ...
    def parse_tool_version_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/tools/(?P<tool>.+?)/versions/(?P<version>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3.ToolsClient`.",
                    extra={
    ...
    def create_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.CreateToolRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            tool (google.cloud.dialogflowcx_v3.types.Tool):
    ...
    def list_tools(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ListToolsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.tools.pagers.ListToolsPager:
    ...
    def get_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.GetToolRequest, dict]):
                The request object. The request message for
    ...
    def update_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.UpdateToolRequest, dict]):
                The request object. The request message for
    ...
    def delete_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.DeleteToolRequest, dict]):
                The request object. The request message for
    ...
    def list_tool_versions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ListToolVersionsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.tools.pagers.ListToolVersionsPager:
                The response message for
                   [Tools.ListToolVersions][google.cloud.dialogflow.cx.v3.Tools.ListToolVersions].
    ...
    def create_tool_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.CreateToolVersionRequest, dict]):
                The request object. The request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            tool_version (google.cloud.dialogflowcx_v3.types.ToolVersion):
    ...
    def get_tool_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.GetToolVersionRequest, dict]):
                The request object. The request message for
    ...
    def delete_tool_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.DeleteToolVersionRequest, dict]):
                The request object. The request message for
    ...
    def restore_tool_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.RestoreToolVersionRequest, dict]):
                The request object. The request message for

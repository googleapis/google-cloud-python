...
class ListPlaybooksPager:
    ...
    :class:`google.cloud.dialogflowcx_v3.types.ListPlaybooksResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListPlaybooksResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.dialogflowcx_v3.types.ListPlaybooksRequest):
                The initial request object.
            response (google.cloud.dialogflowcx_v3.types.ListPlaybooksResponse):
...
class ListPlaybookVersionsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.dialogflowcx_v3.types.ListPlaybookVersionsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListPlaybookVersionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.dialogflowcx_v3.types.ListPlaybookVersionsRequest):
                The initial request object.
            response (google.cloud.dialogflowcx_v3.types.ListPlaybookVersionsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

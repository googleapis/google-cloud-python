...
class PlaybooksClient(metaclass=PlaybooksClientMeta):
    ...
    def playbook_version_path(
        ...
        return "projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/versions/{version}".format(
            project=project,
            location=location,
            agent=agent,
            playbook=playbook,
    ...
    def parse_playbook_version_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/playbooks/(?P<playbook>.+?)/versions/(?P<version>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = PlaybooksClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PlaybooksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PlaybooksClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PlaybooksClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or PlaybooksClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3.PlaybooksClient`.",
                    extra={
    ...
    def create_playbook(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.CreatePlaybookRequest, dict]):
    ...
    def delete_playbook(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.DeletePlaybookRequest, dict]):
                The request object. The request message for
    ...
    def list_playbooks(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ListPlaybooksRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.playbooks.pagers.ListPlaybooksPager:
    ...
    def get_playbook(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.GetPlaybookRequest, dict]):
                The request object. The request message for
    ...
    def export_playbook(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ExportPlaybookRequest, dict]):
                The request object. The request message for
    ...
    def import_playbook(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ImportPlaybookRequest, dict]):
                The request object. The request message for
    ...
    def update_playbook(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.UpdatePlaybookRequest, dict]):
                The request object. The request message for
    ...
    def create_playbook_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.CreatePlaybookVersionRequest, dict]):
                The request object. The request message for
    ...
    def get_playbook_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.GetPlaybookVersionRequest, dict]):
                The request object. The request message for
    ...
    def restore_playbook_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.RestorePlaybookVersionRequest, dict]):
                The request object. The request message for
    ...
    def list_playbook_versions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ListPlaybookVersionsRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.playbooks.pagers.ListPlaybookVersionsPager:
                The response message for
                   [Playbooks.ListPlaybookVersions][google.cloud.dialogflow.cx.v3.Playbooks.ListPlaybookVersions].
    ...
    def delete_playbook_version(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.DeletePlaybookVersionRequest, dict]):
                The request object. The request message for

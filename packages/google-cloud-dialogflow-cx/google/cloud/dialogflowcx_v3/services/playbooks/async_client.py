...
from google.cloud.dialogflowcx_v3.services.playbooks import pagers
...
class PlaybooksAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            PlaybooksClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(PlaybooksAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            PlaybooksClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(PlaybooksAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3.PlaybooksAsyncClient`.",
                extra={
    ...
    async def create_playbook(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.CreatePlaybookRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            playbook (:class:`google.cloud.dialogflowcx_v3.types.Playbook`):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_playbook():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.DeletePlaybookRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.DeletePlaybookRequest, dict]]):
                The request object. The request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_playbooks():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.ListPlaybooksRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.ListPlaybooksRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.playbooks.pagers.ListPlaybooksAsyncPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_playbook():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.GetPlaybookRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.GetPlaybookRequest, dict]]):
                The request object. The request message for
    ...
    async def export_playbook(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.ExportPlaybookRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3.types.ExportPlaybookResponse` The response message for
                   [Playbooks.ExportPlaybook][google.cloud.dialogflow.cx.v3.Playbooks.ExportPlaybook].
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_import_playbook():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.ImportPlaybookRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.ImportPlaybookRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3.types.ImportPlaybookResponse` The response message for
                   [Playbooks.ImportPlaybook][google.cloud.dialogflow.cx.v3.Playbooks.ImportPlaybook].
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_playbook():
                ...
                request = dialogflowcx_v3.UpdatePlaybookRequest(
                    playbook=playbook,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.UpdatePlaybookRequest, dict]]):
                The request object. The request message for
    ...
    async def create_playbook_version(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.CreatePlaybookVersionRequest, dict]]):
                The request object. The request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            playbook_version (:class:`google.cloud.dialogflowcx_v3.types.PlaybookVersion`):
        ...
        Returns:
            google.cloud.dialogflowcx_v3.types.PlaybookVersion:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_playbook_version():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.GetPlaybookVersionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.GetPlaybookVersionRequest, dict]]):
                The request object. The request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_restore_playbook_version():
                ...
                # Initialize request argument(s)
                request = dialogflowcx_v3.RestorePlaybookVersionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.RestorePlaybookVersionRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.types.RestorePlaybookVersionResponse:
                The response message for
                   [Playbooks.RestorePlaybookVersion][google.cloud.dialogflow.cx.v3.Playbooks.RestorePlaybookVersion].
    ...
    async def list_playbook_versions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.ListPlaybookVersionsRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflowcx_v3.services.playbooks.pagers.ListPlaybookVersionsAsyncPager:
                The response message for
                   [Playbooks.ListPlaybookVersions][google.cloud.dialogflow.cx.v3.Playbooks.ListPlaybookVersions].
    ...
    async def delete_playbook_version(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3.types.DeletePlaybookVersionRequest, dict]]):
                The request object. The request message for

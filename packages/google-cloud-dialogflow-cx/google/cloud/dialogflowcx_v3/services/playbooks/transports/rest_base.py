    ...
    class _BaseCreatePlaybook:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*}/playbooks",
                    "body": "playbook",
                },
            ]
            return http_options
    ...
    class _BaseCreatePlaybookVersion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*/playbooks/*}/versions",
    ...
    class _BaseDeletePlaybook:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/playbooks/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeletePlaybookVersion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/playbooks/*/versions/*}",
                },
            ]
            return http_options
    ...
    class _BaseExportPlaybook:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/playbooks/*}:export",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseRestorePlaybookVersion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/playbooks/*/versions/*}:restore",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdatePlaybook:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v3/{playbook.name=projects/*/locations/*/agents/*/playbooks/*}",
                    "body": "playbook",
                },
            ]
            return http_options

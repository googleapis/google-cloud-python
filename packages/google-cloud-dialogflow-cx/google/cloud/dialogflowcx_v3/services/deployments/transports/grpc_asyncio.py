...
class DeploymentsGrpcAsyncIOTransport(DeploymentsTransport):
    ...
    @property
    def list_deployments(self) -> Callable[[deployment.ListDeploymentsRequest], Awaitable[deployment.ListDeploymentsResponse]]:
    ...
    @property
    def get_deployment(self) -> Callable[[deployment.GetDeploymentRequest], Awaitable[deployment.Deployment]]:

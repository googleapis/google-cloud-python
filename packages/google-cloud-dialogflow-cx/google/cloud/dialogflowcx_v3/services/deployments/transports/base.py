...
class DeploymentsTransport(abc.ABC):
    ...
    def list_deployments(
        self,
    ) -> Callable[[deployment.ListDeploymentsRequest], Union[deployment.ListDeploymentsResponse, Awaitable[deployment.ListDeploymentsResponse]]]:
        raise NotImplementedError()

    @property
    def get_deployment(self) -> Callable[[deployment.GetDeploymentRequest], Union[deployment.Deployment, Awaitable[deployment.Deployment]]]:
        raise NotImplementedError()

...
class _BaseSessionEntityTypesRestTransport(SessionEntityTypesTransport):
    """Base REST backend transport for SessionEntityTypes.
    ...
    class _BaseCreateSessionEntityType:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*/sessions/*}/entityTypes",
                    "body": "session_entity_type",
                },
                {
                    "method": "post",
                    "uri": "/v3/{parent=projects/*/locations/*/agents/*/environments/*/sessions/*}/entityTypes",
                    "body": "session_entity_type",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = gcdc_session_entity_type.CreateSessionEntityTypeRequest.pb(request)
    ...
    class _BaseDeleteSessionEntityType:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/sessions/*/entityTypes/*}",
                },
                {
                    "method": "delete",
                    "uri": "/v3/{name=projects/*/locations/*/agents/*/environments/*/sessions/*/entityTypes/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetSessionEntityType:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListSessionEntityTypes:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateSessionEntityType:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v3/{session_entity_type.name=projects/*/locations/*/agents/*/sessions/*/entityTypes/*}",
                    "body": "session_entity_type",
                },
                {
                    "method": "patch",
                    "uri": "/v3/{session_entity_type.name=projects/*/locations/*/agents/*/environments/*/sessions/*/entityTypes/*}",
                    "body": "session_entity_type",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = gcdc_session_entity_type.UpdateSessionEntityTypeRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
...
__all__ = ("_BaseSessionEntityTypesRestTransport",)

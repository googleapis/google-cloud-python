...
class SessionEntityTypesGrpcTransport(SessionEntityTypesTransport):
    ...
    def create_session_entity_type(
        self,
    ) -> Callable[[gcdc_session_entity_type.CreateSessionEntityTypeRequest], gcdc_session_entity_type.SessionEntityType]:
    ...
    def update_session_entity_type(
        self,
    ) -> Callable[[gcdc_session_entity_type.UpdateSessionEntityTypeRequest], gcdc_session_entity_type.SessionEntityType]:

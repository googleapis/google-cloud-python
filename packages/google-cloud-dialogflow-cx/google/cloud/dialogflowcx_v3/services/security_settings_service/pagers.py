...
class ListSecuritySettingsPager:
    ...
    :class:`google.cloud.dialogflowcx_v3.types.ListSecuritySettingsResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3.types.ListSecuritySettingsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            response (google.cloud.dialogflowcx_v3.types.ListSecuritySettingsResponse):
...
class ListSecuritySettingsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[security_settings.ListSecuritySettingsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

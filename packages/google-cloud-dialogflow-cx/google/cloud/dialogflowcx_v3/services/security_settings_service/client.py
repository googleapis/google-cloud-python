...
class SecuritySettingsServiceClient(metaclass=SecuritySettingsServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                SecuritySettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = (
            SecuritySettingsServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = SecuritySettingsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SecuritySettingsServiceClient._get_api_endpoint(

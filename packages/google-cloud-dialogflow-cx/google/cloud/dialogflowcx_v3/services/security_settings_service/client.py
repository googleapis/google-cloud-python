...
class SecuritySettingsServiceClient(metaclass=SecuritySettingsServiceClientMeta):
    ...
    def parse_deidentify_template_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/deidentifyTemplates/(?P<deidentify_template>.+?)$", path)
    ...
    def parse_inspect_template_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/inspectTemplates/(?P<inspect_template>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SecuritySettingsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SecuritySettingsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SecuritySettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SecuritySettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SecuritySettingsServiceTransport, Callable[..., SecuritySettingsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SecuritySettingsServiceClient._read_environment_variables()
        self._client_cert_source = SecuritySettingsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SecuritySettingsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SecuritySettingsServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(SecuritySettingsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or SecuritySettingsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SecuritySettingsServiceTransport], Callable[..., SecuritySettingsServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3.SecuritySettingsServiceClient`.",
                    extra={

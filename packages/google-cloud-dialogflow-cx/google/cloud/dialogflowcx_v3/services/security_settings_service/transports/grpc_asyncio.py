...
class SecuritySettingsServiceGrpcAsyncIOTransport(SecuritySettingsServiceTransport):
    ...
    def create_security_settings(
        self,
    ) -> Callable[[gcdc_security_settings.CreateSecuritySettingsRequest], Awaitable[gcdc_security_settings.SecuritySettings]]:
    ...
    @property
    def get_security_settings(self) -> Callable[[security_settings.GetSecuritySettingsRequest], Awaitable[security_settings.SecuritySettings]]:
    ...
    def update_security_settings(
        self,
    ) -> Callable[[gcdc_security_settings.UpdateSecuritySettingsRequest], Awaitable[gcdc_security_settings.SecuritySettings]]:
    ...
    def list_security_settings(
        self,
    ) -> Callable[[security_settings.ListSecuritySettingsRequest], Awaitable[security_settings.ListSecuritySettingsResponse]]:
    ...
    @property
    def delete_security_settings(self) -> Callable[[security_settings.DeleteSecuritySettingsRequest], Awaitable[empty_pb2.Empty]]:

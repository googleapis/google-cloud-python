...
class SecuritySettingsServiceTransport(abc.ABC):
    ...
    def create_security_settings(
        ...
        Union[gcdc_security_settings.SecuritySettings, Awaitable[gcdc_security_settings.SecuritySettings]],
    ]:
        raise NotImplementedError()
    ...
    def get_security_settings(
        ...
        [security_settings.GetSecuritySettingsRequest], Union[security_settings.SecuritySettings, Awaitable[security_settings.SecuritySettings]]
    ]:
        raise NotImplementedError()
    ...
    def list_security_settings(
        ...
        Union[security_settings.ListSecuritySettingsResponse, Awaitable[security_settings.ListSecuritySettingsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def delete_security_settings(
        self,
    ) -> Callable[[security_settings.DeleteSecuritySettingsRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

...
class SessionsGrpcAsyncIOTransport(SessionsTransport):
    ...
    @property
    def detect_intent(self) -> Callable[[session.DetectIntentRequest], Awaitable[session.DetectIntentResponse]]:
    ...
    @property
    def server_streaming_detect_intent(self) -> Callable[[session.DetectIntentRequest], Awaitable[session.DetectIntentResponse]]:
    ...
    @property
    def match_intent(self) -> Callable[[session.MatchIntentRequest], Awaitable[session.MatchIntentResponse]]:
    ...
    @property
    def fulfill_intent(self) -> Callable[[session.FulfillIntentRequest], Awaitable[session.FulfillIntentResponse]]:
    ...
    @property
    def submit_answer_feedback(self) -> Callable[[session.SubmitAnswerFeedbackRequest], Awaitable[session.AnswerFeedback]]:

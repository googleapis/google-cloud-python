...
class EntityTypesGrpcAsyncIOTransport(EntityTypesTransport):
    ...
    @property
    def create_entity_type(self) -> Callable[[gcdc_entity_type.CreateEntityTypeRequest], Awaitable[gcdc_entity_type.EntityType]]:
    ...
    @property
    def update_entity_type(self) -> Callable[[gcdc_entity_type.UpdateEntityTypeRequest], Awaitable[gcdc_entity_type.EntityType]]:
    ...
    @property
    def export_entity_types(self) -> Callable[[entity_type.ExportEntityTypesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_entity_types(self) -> Callable[[entity_type.ImportEntityTypesRequest], Awaitable[operations_pb2.Operation]]:

...
class EntityTypesClient(metaclass=EntityTypesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = EntityTypesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = EntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, EntityTypesTransport, Callable[..., EntityTypesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EntityTypesClient._read_environment_variables()
        self._client_cert_source = EntityTypesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EntityTypesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EntityTypesTransport], Callable[..., EntityTypesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3.EntityTypesClient`.",
                    extra={
    ...
    def update_entity_type(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("entity_type.name", request.entity_type.name),)),)
    ...
    def export_entity_types(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_export_entity_types():
                # Create a client
                client = dialogflowcx_v3.EntityTypesClient()
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ExportEntityTypesRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3.types.ExportEntityTypesResponse` The response message for
                   [EntityTypes.ExportEntityTypes][google.cloud.dialogflow.cx.v3.EntityTypes.ExportEntityTypes].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_entity_types]
    ...
    def import_entity_types(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflowcx_v3.types.ImportEntityTypesRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflowcx_v3.types.ImportEntityTypesResponse` The response message for
                   [EntityTypes.ImportEntityTypes][google.cloud.dialogflow.cx.v3.EntityTypes.ImportEntityTypes].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_entity_types]

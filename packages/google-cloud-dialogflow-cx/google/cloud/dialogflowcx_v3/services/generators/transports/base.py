...
class GeneratorsTransport(abc.ABC):
    ...
    def create_generator(
        self,
    ) -> Callable[[gcdc_generator.CreateGeneratorRequest], Union[gcdc_generator.Generator, Awaitable[gcdc_generator.Generator]]]:
        raise NotImplementedError()

    @property
    def update_generator(
        self,
    ) -> Callable[[gcdc_generator.UpdateGeneratorRequest], Union[gcdc_generator.Generator, Awaitable[gcdc_generator.Generator]]]:
        raise NotImplementedError()

...
class GeneratorsGrpcAsyncIOTransport(GeneratorsTransport):
    ...
    @property
    def list_generators(self) -> Callable[[generator.ListGeneratorsRequest], Awaitable[generator.ListGeneratorsResponse]]:
    ...
    @property
    def get_generator(self) -> Callable[[generator.GetGeneratorRequest], Awaitable[generator.Generator]]:
    ...
    @property
    def create_generator(self) -> Callable[[gcdc_generator.CreateGeneratorRequest], Awaitable[gcdc_generator.Generator]]:
    ...
    @property
    def update_generator(self) -> Callable[[gcdc_generator.UpdateGeneratorRequest], Awaitable[gcdc_generator.Generator]]:
    ...
    @property
    def delete_generator(self) -> Callable[[generator.DeleteGeneratorRequest], Awaitable[empty_pb2.Empty]]:

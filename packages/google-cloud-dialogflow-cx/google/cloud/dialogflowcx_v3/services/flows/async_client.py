...
class FlowsAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            FlowsClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(FlowsAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            FlowsClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(FlowsAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_train_flow():
                ...
                # Make the request
                operation = await client.train_flow(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_import_flow():
                ...
                # Make the request
                operation = await client.import_flow(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_export_flow():
                ...
                # Make the request
                operation = await client.export_flow(request=request)

...
class Generator(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            during fulfillment.
        prompt_text (google.cloud.dialogflowcx_v3beta1.types.Phrase):
            Required. Prompt for the LLM model.
        placeholders (MutableSequence[google.cloud.dialogflowcx_v3beta1.types.Generator.Placeholder]):
...
class ListGeneratorsResponse(proto.Message):
    ...
    Attributes:
        generators (MutableSequence[google.cloud.dialogflowcx_v3beta1.types.Generator]):

...
class TestCase(proto.Message):
    ...
    creation_time = proto.Field(proto.MESSAGE, number=10, message=timestamp.Timestamp,)
...
class TestCaseResult(proto.Message):
    ...
    test_time = proto.Field(proto.MESSAGE, number=5, message=timestamp.Timestamp,)
...
class ConversationTurn(proto.Message):
    ...
    class VirtualAgentOutput(proto.Message):
        ...
        session_parameters = proto.Field(
            proto.MESSAGE, number=4, message=struct.Struct,
        )
        ...
        diagnostic_info = proto.Field(proto.MESSAGE, number=6, message=struct.Struct,)
        ...
        status = proto.Field(proto.MESSAGE, number=10, message=gr_status.Status,)
...
class TestError(proto.Message):
    ...
    test_time = proto.Field(proto.MESSAGE, number=3, message=timestamp.Timestamp,)

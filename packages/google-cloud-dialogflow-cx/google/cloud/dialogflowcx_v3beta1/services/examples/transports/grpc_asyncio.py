...
class ExamplesGrpcAsyncIOTransport(ExamplesTransport):
    ...
    @property
    def create_example(self) -> Callable[[gcdc_example.CreateExampleRequest], Awaitable[gcdc_example.Example]]:
    ...
    @property
    def delete_example(self) -> Callable[[example.DeleteExampleRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_examples(self) -> Callable[[example.ListExamplesRequest], Awaitable[example.ListExamplesResponse]]:
    ...
    @property
    def get_example(self) -> Callable[[example.GetExampleRequest], Awaitable[example.Example]]:
    ...
    @property
    def update_example(self) -> Callable[[gcdc_example.UpdateExampleRequest], Awaitable[gcdc_example.Example]]:

...
class ChangelogsGrpcTransport(ChangelogsTransport):
    ...
    @property
    def list_changelogs(self) -> Callable[[changelog.ListChangelogsRequest], changelog.ListChangelogsResponse]:
    ...
    @property
    def get_changelog(self) -> Callable[[changelog.GetChangelogRequest], changelog.Changelog]:

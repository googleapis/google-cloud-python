...
class GeneratorsAsyncClient:
    ...
    common_billing_account_path = staticmethod(GeneratorsClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(GeneratorsClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(GeneratorsClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(GeneratorsClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, GeneratorsTransport, Callable[..., GeneratorsTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.GeneratorsAsyncClient`.",
                extra={
    ...
    async def list_generators(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListGeneratorsRequest, dict]]):
        ...
        Returns:
            google.cloud.dialogflowcx_v3beta1.services.generators.pagers.ListGeneratorsAsyncPager:
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_generators]
    ...
    async def get_generator(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetGeneratorRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_generator]
    ...
    async def create_generator(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreateGeneratorRequest, dict]]):
                The request object. The request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            generator (:class:`google.cloud.dialogflowcx_v3beta1.types.Generator`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_generator]
    ...
    async def update_generator(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdateGeneratorRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_generator]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("generator.name", request.generator.name),)),)
    ...
    async def delete_generator(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeleteGeneratorRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_generator]

...
class ToolsGrpcAsyncIOTransport(ToolsTransport):
    ...
    def create_tool(
        ...
        if "create_tool" not in self._stubs:
            self._stubs["create_tool"] = self.grpc_channel.unary_unary(
    ...
    def list_tools(
        ...
        if "list_tools" not in self._stubs:
            self._stubs["list_tools"] = self.grpc_channel.unary_unary(
    ...
    def export_tools(
        ...
        if "export_tools" not in self._stubs:
            self._stubs["export_tools"] = self.grpc_channel.unary_unary(
    ...
    def get_tool(self) -> Callable[[tool.GetToolRequest], Awaitable[tool.Tool]]:
        ...
        if "get_tool" not in self._stubs:
            self._stubs["get_tool"] = self.grpc_channel.unary_unary(
    ...
    def update_tool(
        ...
        if "update_tool" not in self._stubs:
            self._stubs["update_tool"] = self.grpc_channel.unary_unary(
    ...
    def delete_tool(
        ...
        if "delete_tool" not in self._stubs:
            self._stubs["delete_tool"] = self.grpc_channel.unary_unary(

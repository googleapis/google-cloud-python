...
class WebhooksTransport(abc.ABC):
    ...
    def list_webhooks(
        ...
        typing.Union[
            webhook.ListWebhooksResponse, typing.Awaitable[webhook.ListWebhooksResponse]
        ],
    ]:
    ...
    def get_webhook(
        ...
        typing.Union[webhook.Webhook, typing.Awaitable[webhook.Webhook]],
    ]:
        raise NotImplementedError()
    ...
    def create_webhook(
        ...
        typing.Union[gcdc_webhook.Webhook, typing.Awaitable[gcdc_webhook.Webhook]],
    ]:
        raise NotImplementedError()

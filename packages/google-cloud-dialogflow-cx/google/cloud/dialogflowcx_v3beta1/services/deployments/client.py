...
from .transports.base import DEFAULT_CLIENT_INFO, DeploymentsTransport
...
class DeploymentsClient(metaclass=DeploymentsClientMeta):
    ...
    def parse_deployment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/environments/(?P<environment>.+?)/deployments/(?P<deployment>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = DeploymentsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DeploymentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, DeploymentsTransport, Callable[..., DeploymentsTransport]]
        ] = None,
        ...
        self._client_cert_source = DeploymentsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DeploymentsClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or DeploymentsClient._get_api_endpoint(

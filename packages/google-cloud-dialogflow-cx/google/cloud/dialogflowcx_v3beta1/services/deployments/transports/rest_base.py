...
class _BaseDeploymentsRestTransport(DeploymentsTransport):
    """Base REST backend transport for Deployments.
    ...
    class _BaseGetDeployment:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseDeploymentsRestTransport._BaseGetDeployment._get_unset_required_fields(query_params))
    ...
    class _BaseListDeployments:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseDeploymentsRestTransport._BaseListDeployments._get_unset_required_fields(query_params))
...
__all__ = ("_BaseDeploymentsRestTransport",)

...
from google.cloud.dialogflowcx_v3beta1.types import advanced_settings, code_block, example, generative_settings, parameter_definition
...
class PlaybooksAsyncClient:
    ...
    parse_playbook_version_path = staticmethod(PlaybooksClient.parse_playbook_version_path)
    ...
    common_billing_account_path = staticmethod(PlaybooksClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(PlaybooksClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(PlaybooksClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(PlaybooksClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, PlaybooksTransport, Callable[..., PlaybooksTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.PlaybooksAsyncClient`.",
                extra={
    ...
    async def create_playbook(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_playbook]
    ...
    async def delete_playbook(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_playbook]
    ...
    async def list_playbooks(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_playbooks]
    ...
    async def get_playbook(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_playbook]
    ...
    async def export_playbook(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_playbook]
    ...
    async def import_playbook(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_playbook]
    ...
    async def update_playbook(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_playbook]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("playbook.name", request.playbook.name),)),)
    ...
    async def create_playbook_version(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_playbook_version]
    ...
    async def get_playbook_version(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_playbook_version]
    ...
    async def restore_playbook_version(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restore_playbook_version]
    ...
    async def list_playbook_versions(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_playbook_versions]
    ...
    async def delete_playbook_version(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_playbook_version]

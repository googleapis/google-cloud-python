...
class EntityTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_export_entity_types(
        ...
        entity_type.ExportEntityTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_import_entity_types(
        ...
        entity_type.ImportEntityTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseEntityTypesRestTransport._BaseExportEntityTypes,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_export_entity_types_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseEntityTypesRestTransport._BaseImportEntityTypes,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_entity_types_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG

...
class IntentsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow.cx_v3beta1.IntentsAsyncClient`.",
                extra={
    ...
    async def list_intents(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ListIntentsRequest, dict]]):
    ...
    async def get_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.GetIntentRequest, dict]]):
                The request object. The request message for
    ...
    async def create_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.CreateIntentRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, intent]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    async def update_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.UpdateIntentRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [intent, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    async def delete_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.DeleteIntentRequest, dict]]):
                The request object. The request message for
    ...
    async def import_intents(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ImportIntentsRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_intents]
    ...
    async def export_intents(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflowcx_v3beta1.types.ExportIntentsRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_intents]

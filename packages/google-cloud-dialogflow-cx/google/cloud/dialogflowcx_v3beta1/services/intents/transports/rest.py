...
class IntentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_intent(
        self, request: gcdc_intent.CreateIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcdc_intent.CreateIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_intent_with_metadata(
        self, response: gcdc_intent.Intent, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_export_intents(
        self, request: intent.ExportIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[intent.ExportIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_import_intents(
        self, request: intent.ImportIntentsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[intent.ImportIntentsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_intent(
        self, request: gcdc_intent.UpdateIntentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcdc_intent.UpdateIntentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:

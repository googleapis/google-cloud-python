...
class IntentsGrpcTransport(IntentsTransport):
    ...
    @property
    def create_intent(self) -> Callable[[gcdc_intent.CreateIntentRequest], gcdc_intent.Intent]:
    ...
    @property
    def update_intent(self) -> Callable[[gcdc_intent.UpdateIntentRequest], gcdc_intent.Intent]:
    ...
    @property
    def import_intents(self) -> Callable[[intent.ImportIntentsRequest], operations_pb2.Operation]:
    ...
    @property
    def export_intents(self) -> Callable[[intent.ExportIntentsRequest], operations_pb2.Operation]:

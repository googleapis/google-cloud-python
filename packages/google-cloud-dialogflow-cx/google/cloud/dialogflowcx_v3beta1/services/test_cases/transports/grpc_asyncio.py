...
class TestCasesGrpcAsyncIOTransport(TestCasesTransport):
    ...
    @property
    def batch_delete_test_cases(self) -> Callable[[test_case.BatchDeleteTestCasesRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_test_case(self) -> Callable[[test_case.GetTestCaseRequest], Awaitable[test_case.TestCase]]:
    ...
    @property
    def create_test_case(self) -> Callable[[gcdc_test_case.CreateTestCaseRequest], Awaitable[gcdc_test_case.TestCase]]:
    ...
    @property
    def update_test_case(self) -> Callable[[gcdc_test_case.UpdateTestCaseRequest], Awaitable[gcdc_test_case.TestCase]]:
    ...
    @property
    def run_test_case(self) -> Callable[[test_case.RunTestCaseRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def batch_run_test_cases(self) -> Callable[[test_case.BatchRunTestCasesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def calculate_coverage(self) -> Callable[[test_case.CalculateCoverageRequest], Awaitable[test_case.CalculateCoverageResponse]]:
    ...
    @property
    def import_test_cases(self) -> Callable[[test_case.ImportTestCasesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_test_cases(self) -> Callable[[test_case.ExportTestCasesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_test_case_results(self) -> Callable[[test_case.ListTestCaseResultsRequest], Awaitable[test_case.ListTestCaseResultsResponse]]:
    ...
    @property
    def get_test_case_result(self) -> Callable[[test_case.GetTestCaseResultRequest], Awaitable[test_case.TestCaseResult]]:

...
class EnvironmentsClient(metaclass=EnvironmentsClientMeta):
    ...
    def continuous_test_result_path(
        ...
        return (
            "projects/{project}/locations/{location}/agents/{agent}/environments/{environment}/continuousTestResults/{continuous_test_result}".format(
                project=project,
                location=location,
                agent=agent,
    ...
    def parse_version_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/flows/(?P<flow>.+?)/versions/(?P<version>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = EnvironmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, EnvironmentsTransport, Callable[..., EnvironmentsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EnvironmentsClient._read_environment_variables()
        self._client_cert_source = EnvironmentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EnvironmentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EnvironmentsTransport], Callable[..., EnvironmentsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow.cx_v3beta1.EnvironmentsClient`.",
                    extra={
    ...
    def create_environment(
        self,
        request: Optional[Union[gcdc_environment.CreateEnvironmentRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
    ...
    def update_environment(
        self,
        request: Optional[Union[gcdc_environment.UpdateEnvironmentRequest, dict]] = None,
        *,
        environment: Optional[gcdc_environment.Environment] = None,
    ...
    def lookup_environment_history(
        self,
        request: Optional[Union[environment.LookupEnvironmentHistoryRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_continuous_test_results(
        self,
        request: Optional[Union[environment.ListContinuousTestResultsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_continuous_test_results]

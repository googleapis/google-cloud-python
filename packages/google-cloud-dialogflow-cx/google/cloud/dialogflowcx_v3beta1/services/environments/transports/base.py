...
class EnvironmentsTransport(abc.ABC):
    ...
    def list_environments(
        ...
        [environment.ListEnvironmentsRequest], Union[environment.ListEnvironmentsResponse, Awaitable[environment.ListEnvironmentsResponse]]
    ]:
        raise NotImplementedError()

    @property
    def get_environment(self) -> Callable[[environment.GetEnvironmentRequest], Union[environment.Environment, Awaitable[environment.Environment]]]:
        raise NotImplementedError()

    @property
    def create_environment(
        self,
    ) -> Callable[[gcdc_environment.CreateEnvironmentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_environment(
        self,
    ) -> Callable[[gcdc_environment.UpdateEnvironmentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_environment(self) -> Callable[[environment.DeleteEnvironmentRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()
    ...
    def lookup_environment_history(
        ...
        Union[environment.LookupEnvironmentHistoryResponse, Awaitable[environment.LookupEnvironmentHistoryResponse]],
    ]:
        raise NotImplementedError()
    ...
    def run_continuous_test(
        self,
    ) -> Callable[[environment.RunContinuousTestRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    def list_continuous_test_results(
        ...
        Union[environment.ListContinuousTestResultsResponse, Awaitable[environment.ListContinuousTestResultsResponse]],
    ]:
        raise NotImplementedError()

    @property
    def deploy_flow(self) -> Callable[[environment.DeployFlowRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

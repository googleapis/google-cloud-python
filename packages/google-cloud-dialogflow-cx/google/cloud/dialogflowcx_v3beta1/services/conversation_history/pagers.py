...
class ListConversationsPager:
    ...
    :class:`google.cloud.dialogflowcx_v3beta1.types.ListConversationsResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflowcx_v3beta1.types.ListConversationsResponse`
    ...
    def __init__(
        self,
        method: Callable[..., conversation_history.ListConversationsResponse],
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.dialogflowcx_v3beta1.types.ListConversationsRequest):
    ...
    @property
    def pages(self) -> Iterator[conversation_history.ListConversationsResponse]:
...
class ListConversationsAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[conversation_history.ListConversationsResponse]],
        request: conversation_history.ListConversationsRequest,
        response: conversation_history.ListConversationsResponse,
        *,
    ...
    @property
    async def pages(self) -> AsyncIterator[conversation_history.ListConversationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

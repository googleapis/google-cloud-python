...
class ConversationHistoryClient(metaclass=ConversationHistoryClientMeta):
    ...
    def conversation_path(
        ...
        return "projects/{project}/locations/{location}/agents/{agent}/conversations/{conversation}".format(
            project=project,
            location=location,
            agent=agent,
    ...
    def parse_conversation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/agents/(?P<agent>.+?)/conversations/(?P<conversation>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ConversationHistoryClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversationHistoryClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ConversationHistoryClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ConversationHistoryClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ConversationHistoryClient._get_api_endpoint(
...
__all__ = ("ConversationHistoryClient",)

...
class ConversationHistoryGrpcAsyncIOTransport(ConversationHistoryTransport):
    """gRPC AsyncIO backend transport for ConversationHistory.
    ...
    def list_conversations(
        self,
    ) -> Callable[[conversation_history.ListConversationsRequest], Awaitable[conversation_history.ListConversationsResponse]]:
    ...
    @property
    def get_conversation(self) -> Callable[[conversation_history.GetConversationRequest], Awaitable[conversation_history.Conversation]]:
    ...
    @property
    def delete_conversation(self) -> Callable[[conversation_history.DeleteConversationRequest], Awaitable[empty_pb2.Empty]]:
...
__all__ = ("ConversationHistoryGrpcAsyncIOTransport",)

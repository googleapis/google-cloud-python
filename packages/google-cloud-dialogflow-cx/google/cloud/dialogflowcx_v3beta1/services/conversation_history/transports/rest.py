...
class ConversationHistoryRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete_conversation(
        self, request: conversation_history.DeleteConversationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[conversation_history.DeleteConversationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_conversation(
        self, request: conversation_history.GetConversationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[conversation_history.GetConversationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_conversation_with_metadata(
        self, response: conversation_history.Conversation, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[conversation_history.Conversation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_conversation
    ...
    def pre_list_conversations(
        self, request: conversation_history.ListConversationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[conversation_history.ListConversationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_conversations_with_metadata(
        self, response: conversation_history.ListConversationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[conversation_history.ListConversationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_conversations
    ...
    class _DeleteConversation(_BaseConversationHistoryRestTransport._BaseDeleteConversation, ConversationHistoryRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ConversationHistoryRestTransport._DeleteConversation._get_response(
    ...
    class _ListConversations(_BaseConversationHistoryRestTransport._BaseListConversations, ConversationHistoryRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ConversationHistoryRestTransport._ListConversations._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request
            )

...
class _BaseConversationHistoryRestTransport(ConversationHistoryTransport):
    ...
    class _BaseDeleteConversation:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseConversationHistoryRestTransport._BaseDeleteConversation._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetConversation:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseConversationHistoryRestTransport._BaseGetConversation._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListConversations:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseConversationHistoryRestTransport._BaseListConversations._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseConversationHistoryRestTransport",)

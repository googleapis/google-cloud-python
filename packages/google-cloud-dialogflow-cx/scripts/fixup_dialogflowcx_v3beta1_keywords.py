...
class dialogflowcxCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_playbook': ('parent', 'playbook', ),
        'create_playbook_version': ('parent', 'playbook_version', ),
        ...
        'export_tools': ('parent', 'tools', 'tools_uri', 'tools_content_inline', 'data_format', ),
        ...
        'list_conversations': ('parent', 'filter', 'page_size', 'page_token', ),
        ...
        'list_examples': ('parent', 'page_size', 'page_token', 'language_code', ),
        ...
        'list_playbooks': ('parent', 'page_size', 'page_token', ),
        'list_playbook_versions': ('parent', 'page_size', 'page_token', ),
        ...
        'update_example': ('example', 'update_mask', ),
        ...
        'update_playbook': ('playbook', 'update_mask', ),

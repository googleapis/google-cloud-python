...
#
# Snippet for DeletePlaybookVersion
...
async def sample_delete_playbook_version():
    # Create a client
    client = dialogflowcx_v3.PlaybooksAsyncClient()

    # Initialize request argument(s)
    request = dialogflowcx_v3.DeletePlaybookVersionRequest(
        name="name_value",
    )
...
# [END dialogflow_v3_generated_Playbooks_DeletePlaybookVersion_async]

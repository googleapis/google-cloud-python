...
def sample_create_playbook():
    # Create a client
    client = dialogflowcx_v3.PlaybooksClient()

    # Initialize request argument(s)
    playbook = dialogflowcx_v3.Playbook()
    playbook.display_name = "display_name_value"
    playbook.goal = "goal_value"

    request = dialogflowcx_v3.CreatePlaybookRequest(
        parent="parent_value",
        playbook=playbook,
    )
...
# [END dialogflow_v3_generated_Playbooks_CreatePlaybook_sync]

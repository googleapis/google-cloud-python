...
async def sample_get_tool_version():
    # Create a client
    client = dialogflowcx_v3.ToolsAsyncClient()

    # Initialize request argument(s)
    request = dialogflowcx_v3.GetToolVersionRequest(
        name="name_value",
    )
...
# [END dialogflow_v3_generated_Tools_GetToolVersion_async]

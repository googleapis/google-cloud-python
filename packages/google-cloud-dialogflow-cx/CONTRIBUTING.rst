...
- While logged into your GitHub account, navigate to the
  ``python-dialogflow-cx`` `repo`_ on GitHub.

- Fork and clone the ``python-dialogflow-cx`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-dialogflow-cx`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-dialogflow-cx``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-dialogflow-cx.git hack-on-python-dialogflow-cx
   $ cd hack-on-python-dialogflow-cx
...
.. _repo: https://github.com/googleapis/python-dialogflow-cx
...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-dialogflow-cx``. The
...
.. _config: https://github.com/googleapis/python-dialogflow-cx/blob/main/packages/google-cloud-dialogflow-cx/noxfile.py

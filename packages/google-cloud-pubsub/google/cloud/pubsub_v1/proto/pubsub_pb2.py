...
_DETACHSUBSCRIPTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="subscription",
            full_name="google.pubsub.v1.DetachSubscriptionRequest.subscription",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_SUBSCRIPTION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="detached",
            full_name="google.pubsub.v1.Subscription.detached",
            index=12,
            number=15,
            type=8,
            cpp_type=7,
...
_STREAMINGPULLREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.pubsub.v1.StreamingPullRequest.max_outstanding_messages",
            index=6,
            number=7,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.pubsub.v1.StreamingPullRequest.max_outstanding_bytes",
            index=7,
            number=8,
            type=3,
            cpp_type=2,
...
] = _DETACHSUBSCRIPTIONREQUEST
DESCRIPTOR.message_types_by_name[
    "DetachSubscriptionResponse"
] = _DETACHSUBSCRIPTIONRESPONSE
...
DetachSubscriptionRequest = _reflection.GeneratedProtocolMessageType(
    "DetachSubscriptionRequest",
    (_message.Message,),
    {
...
DetachSubscriptionResponse = _reflection.GeneratedProtocolMessageType(
    "DetachSubscriptionResponse",
    (_message.Message,),
    {
        "DESCRIPTOR": _DETACHSUBSCRIPTIONRESPONSE,
        "__module__": "google.cloud.pubsub_v1.proto.pubsub_pb2",
        "__doc__": """Response for the DetachSubscription method. Reserved for future use.""",
...
Subscription = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      dead_letter_policy:
          ...
          (i.e., service-{project_number}@gcp-sa-
          pubsub.iam.gserviceaccount.com) must have permission to
          Acknowledge() messages on this subscription.
      retry_policy:
          A policy that specifies how Pub/Sub retries message delivery
          for this subscription.  If not set, the default retry policy
          is applied. This generally implies that messages will be
      ...
      detached:
          ...
          and don’t retain any backlog. ``Pull`` and ``StreamingPull``
          requests will return FAILED_PRECONDITION. If the subscription
          is a push subscription, pushes to the endpoint will not be
          made.
  """,
...
DeadLetterPolicy = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      max_delivery_attempts:
          ...
          automatically extend ack_deadlines.  This field will be
...
ReceivedMessage = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      delivery_attempt:
          ...
          ack_deadline exceeds) for this message.  A NACK is any call to
          ModifyAckDeadline with a 0 deadline. An ack_deadline exceeds
          event is whenever a message is not acknowledged within
          ack_deadline. Note that ack_deadline is initially
          Subscription.ackDeadlineSeconds, but may get extended
          automatically by the client library.  Upon the first delivery
          of a given message, ``delivery_attempt`` will have a value of
          1. The value is calculated at best effort and is approximate.
...
StreamingPullRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      client_id:
          ...
          the same stream, the client_id should be set to the same value
          so that state associated with the old stream can be
      ...
      max_outstanding_messages:
          ...
          messages. When there are ``max_outstanding_messages`` or more
          currently sent to the streaming pull client that have not yet
          been acked or nacked, the server stops sending more messages.
          The sending of messages resumes once the number of outstanding
          messages is less than this value. If the value is <= 0, there
          is no limit to the number of outstanding messages. This
          property can only be set on the initial StreamingPullRequest.
          If it is set on a subsequent request, the stream will be
          aborted with status ``INVALID_ARGUMENT``.
      max_outstanding_bytes:
          Flow control settings for the maximum number of outstanding
          bytes. When there are ``max_outstanding_bytes`` or more worth
...
Snapshot = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      expire_time:
          ...
          snapshot – which will always capture this 3-day-old backlog as
          long as the snapshot exists – will expire in 4 days. The

...
class PublisherClient(metaclass=PublisherClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PublisherClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PublisherClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = PublisherClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = PublisherClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, PublisherTransport)
        ...
        self._api_endpoint = self._api_endpoint or PublisherClient._get_api_endpoint(

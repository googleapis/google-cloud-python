...
class ModelArmorGrpcAsyncIOTransport(ModelArmorTransport):
    ...
    def list_templates(
        ...
        [service.ListTemplatesRequest], Awaitable[service.ListTemplatesResponse]
    ]:
    ...
    def get_template(
        self,
    ) -> Callable[[service.GetTemplateRequest], Awaitable[service.Template]]:
    ...
    def create_template(
        self,
    ) -> Callable[[service.CreateTemplateRequest], Awaitable[service.Template]]:
    ...
    def update_template(
        self,
    ) -> Callable[[service.UpdateTemplateRequest], Awaitable[service.Template]]:
    ...
    def delete_template(
        self,
    ) -> Callable[[service.DeleteTemplateRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_floor_setting(
        self,
    ) -> Callable[[service.GetFloorSettingRequest], Awaitable[service.FloorSetting]]:
    ...
    def update_floor_setting(
        self,
    ) -> Callable[[service.UpdateFloorSettingRequest], Awaitable[service.FloorSetting]]:

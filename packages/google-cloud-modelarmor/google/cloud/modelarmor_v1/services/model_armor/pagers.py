...
class ListTemplatesPager:
    ...
    :class:`google.cloud.modelarmor_v1.types.ListTemplatesResponse` object, and
    ...
    All the usual :class:`google.cloud.modelarmor_v1.types.ListTemplatesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.modelarmor_v1.types.ListTemplatesRequest):
                The initial request object.
            response (google.cloud.modelarmor_v1.types.ListTemplatesResponse):

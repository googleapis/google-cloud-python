...
class _BaseModelArmorRestTransport(ModelArmorTransport):
    """Base REST backend transport for ModelArmor.
    ...
    class _BaseCreateTemplate:
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = service.CreateTemplateRequest.pb(request)
    ...
    class _BaseDeleteTemplate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.DeleteTemplateRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseGetFloorSetting:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=projects/*/locations/*/floorSetting}",
                },
                {
                    "method": "get",
                    "uri": "/v1/{name=folders/*/locations/*/floorSetting}",
                },
                {
                    "method": "get",
                    "uri": "/v1/{name=organizations/*/locations/*/floorSetting}",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.GetFloorSettingRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseGetTemplate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.GetTemplateRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseListTemplates:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.ListTemplatesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseSanitizeModelResponse:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/templates/*}:sanitizeModelResponse",
                    "body": "*",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.SanitizeModelResponseRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseSanitizeUserPrompt:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/templates/*}:sanitizeUserPrompt",
                    "body": "*",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.SanitizeUserPromptRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseUpdateFloorSetting:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{floor_setting.name=projects/*/locations/*/floorSetting}",
                    "body": "floor_setting",
                },
                {
                    "method": "patch",
                    "uri": "/v1/{floor_setting.name=folders/*/locations/*/floorSetting}",
                    "body": "floor_setting",
                },
                {
                    "method": "patch",
                    "uri": "/v1/{floor_setting.name=organizations/*/locations/*/floorSetting}",
                    "body": "floor_setting",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.UpdateFloorSettingRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseUpdateTemplate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = service.UpdateTemplateRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
...
__all__ = ("_BaseModelArmorRestTransport",)

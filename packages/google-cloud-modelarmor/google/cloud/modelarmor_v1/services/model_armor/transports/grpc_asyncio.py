...
from .grpc import ModelArmorGrpcTransport
...
class ModelArmorGrpcAsyncIOTransport(ModelArmorTransport):
    """gRPC AsyncIO backend transport for ModelArmor.
    ...
    @property
    def list_templates(self) -> Callable[[service.ListTemplatesRequest], Awaitable[service.ListTemplatesResponse]]:
    ...
    @property
    def get_template(self) -> Callable[[service.GetTemplateRequest], Awaitable[service.Template]]:
    ...
    @property
    def create_template(self) -> Callable[[service.CreateTemplateRequest], Awaitable[service.Template]]:
    ...
    @property
    def update_template(self) -> Callable[[service.UpdateTemplateRequest], Awaitable[service.Template]]:
    ...
    @property
    def delete_template(self) -> Callable[[service.DeleteTemplateRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def get_floor_setting(self) -> Callable[[service.GetFloorSettingRequest], Awaitable[service.FloorSetting]]:
    ...
    @property
    def update_floor_setting(self) -> Callable[[service.UpdateFloorSettingRequest], Awaitable[service.FloorSetting]]:
    ...
    @property
    def sanitize_user_prompt(self) -> Callable[[service.SanitizeUserPromptRequest], Awaitable[service.SanitizeUserPromptResponse]]:
    ...
    @property
    def sanitize_model_response(self) -> Callable[[service.SanitizeModelResponseRequest], Awaitable[service.SanitizeModelResponseResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_templates: self._wrap_method(
                self.list_templates,
            ...
            self.create_template: self._wrap_method(
                self.create_template,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_template: self._wrap_method(
                self.update_template,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_template: self._wrap_method(
                self.delete_template,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_floor_setting: self._wrap_method(
            ...
            self.update_floor_setting: self._wrap_method(
                self.update_floor_setting,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.sanitize_user_prompt: self._wrap_method(
                self.sanitize_user_prompt,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.sanitize_model_response: self._wrap_method(
                self.sanitize_model_response,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
...
__all__ = ("ModelArmorGrpcAsyncIOTransport",)

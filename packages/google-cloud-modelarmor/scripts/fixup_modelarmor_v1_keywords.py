...
class modelarmorCallTransformer(cst.CSTTransformer):
    CTRL_PARAMS: Tuple[str] = ('retry', 'timeout', 'metadata')
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'create_template': ('parent', 'template_id', 'template', 'request_id', ),
        'delete_template': ('name', 'request_id', ),
...
def fix_files(
    ...
    *,
    transformer=modelarmorCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the modelarmor client library.

...
from google.cloud.language_v2.services.language_service import (
...
def test__get_client_cert_source():
    ...
    assert (
        LanguageServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        LanguageServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                LanguageServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                LanguageServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(LanguageServiceClient),
)
@mock.patch.object(
    LanguageServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(LanguageServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LanguageServiceClient._DEFAULT_UNIVERSE
    default_endpoint = LanguageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = LanguageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        LanguageServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        LanguageServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == LanguageServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LanguageServiceClient._get_api_endpoint(
    ...
    assert (
        LanguageServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        LanguageServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        LanguageServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        LanguageServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        LanguageServiceClient._get_universe_domain(None, None)
        == LanguageServiceClient._DEFAULT_UNIVERSE
    )
...
def test_language_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.language_v2.services.language_service.transports.LanguageServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.asyncio
async def test_analyze_sentiment_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.analyze_sentiment
...
@pytest.mark.asyncio
async def test_analyze_entities_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.analyze_entities
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_classify_text_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.classify_text
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_moderate_text_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.moderate_text
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_annotate_text_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.annotate_text
            in client._client._transport._wrapped_methods
        )
...
def test_analyze_sentiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/documents:analyzeSentiment" % client.transport._host, args[1]
        )
...
def test_analyze_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/documents:analyzeEntities" % client.transport._host, args[1]
        )
...
def test_classify_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/documents:classifyText" % client.transport._host, args[1]
        )
...
def test_moderate_text_rest_required_fields(
    request_type=language_service.ModerateTextRequest,
):
    transport_class = transports.LanguageServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).moderate_text._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_moderate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/documents:moderateText" % client.transport._host, args[1]
        )
...
def test_annotate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/documents:annotateText" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc_asyncio():
    transport = LanguageServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = LanguageServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_language_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.language_v2.services.language_service.transports.LanguageServiceTransport.__init__"
    ) as Transport:

...
from google.cloud.language_v2.services.language_service import LanguageServiceAsyncClient, LanguageServiceClient, transports
...
def test__read_environment_variables():
    assert LanguageServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LanguageServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LanguageServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LanguageServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LanguageServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert LanguageServiceClient._get_client_cert_source(None, False) is None
    assert LanguageServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LanguageServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert LanguageServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LanguageServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(LanguageServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LanguageServiceClient))
@mock.patch.object(LanguageServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LanguageServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LanguageServiceClient._DEFAULT_UNIVERSE
    default_endpoint = LanguageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LanguageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LanguageServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        LanguageServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == LanguageServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LanguageServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LanguageServiceClient._get_api_endpoint(None, None, default_universe, "always") == LanguageServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        LanguageServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == LanguageServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LanguageServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LanguageServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LanguageServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LanguageServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LanguageServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LanguageServiceClient._get_universe_domain(None, None) == LanguageServiceClient._DEFAULT_UNIVERSE
...
def test_language_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "language.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://language.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (LanguageServiceClient, transports.LanguageServiceRestTransport, "rest", "true"),
        (LanguageServiceClient, transports.LanguageServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(LanguageServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LanguageServiceClient))
@mock.patch.object(LanguageServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LanguageServiceAsyncClient))
...
@mock.patch.object(LanguageServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LanguageServiceClient))
@mock.patch.object(LanguageServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LanguageServiceAsyncClient))
def test_language_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (LanguageServiceClient, transports.LanguageServiceGrpcTransport, "grpc", grpc_helpers),
        (LanguageServiceAsyncClient, transports.LanguageServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_language_service_client_client_options_from_dict():
    with mock.patch("google.cloud.language_v2.services.language_service.transports.LanguageServiceGrpcTransport.__init__") as grpc_transport:
...
def test_analyze_sentiment(request_type, transport: str = "grpc"):
    ...
    assert response.language_supported is True


def test_analyze_sentiment_non_empty_request_with_auto_populated_field():
...
def test_analyze_sentiment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.analyze_sentiment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.analyze_sentiment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_analyze_sentiment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.analyze_sentiment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.analyze_sentiment] = mock_rpc

        request = {}
        await client.analyze_sentiment(request)
...
def test_analyze_entities_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_analyze_entities_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.analyze_entities in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.analyze_entities] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_analyze_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LanguageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.analyze_entities in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.analyze_entities] = mock_rpc

        request = {}
        await client.analyze_entities(request)
...
def test_classify_text_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_classify_text_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.classify_text in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.classify_text] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_classify_text_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LanguageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.classify_text in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.classify_text] = mock_rpc

        request = {}
        await client.classify_text(request)
...
def test_moderate_text_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_moderate_text_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.moderate_text in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.moderate_text] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_moderate_text_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LanguageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.moderate_text in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.moderate_text] = mock_rpc

        request = {}
        await client.moderate_text(request)
...
async def test_moderate_text_flattened_async():
    ...
    with mock.patch.object(type(client.transport.moderate_text), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.moderate_text(
            document=language_service.Document(type_=language_service.Document.Type.PLAIN_TEXT),
        )
...
def test_annotate_text_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_annotate_text_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.annotate_text in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.annotate_text] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_annotate_text_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LanguageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.annotate_text in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.annotate_text] = mock_rpc

        request = {}
        await client.annotate_text(request)
...
def test_annotate_text_flattened():
    ...
    with mock.patch.object(type(client.transport.annotate_text), "__call__") as call:
        ...
        client.annotate_text(
            document=language_service.Document(type_=language_service.Document.Type.PLAIN_TEXT),
            features=language_service.AnnotateTextRequest.Features(extract_entities=True),
            encoding_type=language_service.EncodingType.UTF8,
        )
        ...
        assert arg == mock_val
        arg = args[0].features
        mock_val = language_service.AnnotateTextRequest.Features(extract_entities=True)
        assert arg == mock_val
        arg = args[0].encoding_type
        mock_val = language_service.EncodingType.UTF8
        assert arg == mock_val
...
def test_analyze_sentiment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
def test_analyze_sentiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2/documents:analyzeSentiment" % client.transport._host, args[1])
...
def test_analyze_entities_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
def test_analyze_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/documents:analyzeEntities" % client.transport._host, args[1])
...
def test_classify_text_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
def test_classify_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/documents:classifyText" % client.transport._host, args[1])
...
def test_moderate_text_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
def test_moderate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/documents:moderateText" % client.transport._host, args[1])
...
def test_annotate_text_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = LanguageServiceClient(
...
def test_annotate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/documents:annotateText" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = LanguageServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_analyze_sentiment_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.analyze_sentiment), "__call__") as call:
        call.return_value = language_service.AnalyzeSentimentResponse()
        client.analyze_sentiment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_entities_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.analyze_entities), "__call__") as call:
        call.return_value = language_service.AnalyzeEntitiesResponse()
        client.analyze_entities(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_classify_text_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.classify_text), "__call__") as call:
        call.return_value = language_service.ClassifyTextResponse()
        client.classify_text(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_moderate_text_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.moderate_text), "__call__") as call:
        call.return_value = language_service.ModerateTextResponse()
        client.moderate_text(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_annotate_text_empty_call_grpc():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.annotate_text), "__call__") as call:
        call.return_value = language_service.AnnotateTextResponse()
        client.annotate_text(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = LanguageServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = LanguageServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_analyze_sentiment_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.analyze_sentiment), "__call__") as call:
        ...
        await client.analyze_sentiment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_analyze_entities_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.analyze_entities), "__call__") as call:
        ...
        await client.analyze_entities(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_classify_text_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.classify_text), "__call__") as call:
        ...
        await client.classify_text(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_moderate_text_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.moderate_text), "__call__") as call:
        ...
        await client.moderate_text(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_annotate_text_empty_call_grpc_asyncio():
    client = LanguageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.annotate_text), "__call__") as call:
        ...
        await client.annotate_text(request=None)
...
def test_transport_kind_rest():
    transport = LanguageServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_analyze_sentiment_rest_bad_request(request_type=language_service.AnalyzeSentimentRequest):
...
def test_analyze_sentiment_rest_call_success(request_type):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_analyze_sentiment_rest_interceptors(null_interceptor):
    transport = transports.LanguageServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.LanguageServiceRestInterceptor(),
    )
    client = LanguageServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_sentiment") as post, mock.patch.object(
        transports.LanguageServiceRestInterceptor, "post_analyze_sentiment_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.AnalyzeSentimentResponse.to_json(language_service.AnalyzeSentimentResponse())
        ...
        post_with_metadata.return_value = language_service.AnalyzeSentimentResponse(), metadata
...
def test_analyze_entities_rest_bad_request(request_type=language_service.AnalyzeEntitiesRequest):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_analyze_entities_rest_call_success(request_type):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_analyze_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LanguageServiceRestInterceptor, "post_analyze_entities") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.AnalyzeEntitiesResponse.to_json(language_service.AnalyzeEntitiesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = language_service.AnalyzeEntitiesResponse(), metadata
...
def test_classify_text_rest_bad_request(request_type=language_service.ClassifyTextRequest):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_classify_text_rest_call_success(request_type):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_classify_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LanguageServiceRestInterceptor, "post_classify_text") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.ClassifyTextResponse.to_json(language_service.ClassifyTextResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = language_service.ClassifyTextResponse(), metadata
...
def test_moderate_text_rest_bad_request(request_type=language_service.ModerateTextRequest):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_moderate_text_rest_call_success(request_type):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_moderate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LanguageServiceRestInterceptor, "post_moderate_text") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.ModerateTextResponse.to_json(language_service.ModerateTextResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = language_service.ModerateTextResponse(), metadata
...
def test_annotate_text_rest_bad_request(request_type=language_service.AnnotateTextRequest):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_annotate_text_rest_call_success(request_type):
    client = LanguageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_annotate_text_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LanguageServiceRestInterceptor, "post_annotate_text") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = language_service.AnnotateTextResponse.to_json(language_service.AnnotateTextResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = language_service.AnnotateTextResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_sentiment_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_analyze_entities_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_classify_text_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_moderate_text_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_annotate_text_empty_call_rest():
    client = LanguageServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_language_service_base_transport():
    ...
    with mock.patch("google.cloud.language_v2.services.language_service.transports.LanguageServiceTransport.__init__") as Transport:
...
def test_language_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.language_v2.services.language_service.transports.LanguageServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.LanguageServiceGrpcTransport, grpc_helpers), (transports.LanguageServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_language_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "language.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://language.googleapis.com:8000"
    )

...
class LanguageServiceGrpcAsyncIOTransport(LanguageServiceTransport):
    ...
    def analyze_entity_sentiment(
        self,
    ) -> Callable[[language_service.AnalyzeEntitySentimentRequest], Awaitable[language_service.AnalyzeEntitySentimentResponse]]:
    ...
    @property
    def analyze_syntax(self) -> Callable[[language_service.AnalyzeSyntaxRequest], Awaitable[language_service.AnalyzeSyntaxResponse]]:

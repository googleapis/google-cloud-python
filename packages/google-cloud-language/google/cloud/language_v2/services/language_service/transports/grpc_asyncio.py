...
class LanguageServiceGrpcAsyncIOTransport(LanguageServiceTransport):
    ...
    @property
    def analyze_sentiment(self) -> Callable[[language_service.AnalyzeSentimentRequest], Awaitable[language_service.AnalyzeSentimentResponse]]:
    ...
    @property
    def analyze_entities(self) -> Callable[[language_service.AnalyzeEntitiesRequest], Awaitable[language_service.AnalyzeEntitiesResponse]]:
    ...
    @property
    def classify_text(self) -> Callable[[language_service.ClassifyTextRequest], Awaitable[language_service.ClassifyTextResponse]]:
    ...
    @property
    def moderate_text(self) -> Callable[[language_service.ModerateTextRequest], Awaitable[language_service.ModerateTextResponse]]:
    ...
    @property
    def annotate_text(self) -> Callable[[language_service.AnnotateTextRequest], Awaitable[language_service.AnnotateTextResponse]]:

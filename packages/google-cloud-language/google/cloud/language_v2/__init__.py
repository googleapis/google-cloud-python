...
__lazy_modules__ = {
    "google.cloud.language_v2.services.language_service",
    "google.cloud.language_v2.types.language_service",
}
...
api_core.check_python_version("google.cloud.language_v2")
api_core.check_dependency_versions("google.cloud.language_v2")

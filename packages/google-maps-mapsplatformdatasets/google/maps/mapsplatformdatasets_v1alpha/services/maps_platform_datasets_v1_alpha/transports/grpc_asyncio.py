...
class MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport(
    MapsPlatformDatasetsV1AlphaTransport
):
    """gRPC AsyncIO backend transport for MapsPlatformDatasetsV1Alpha.
    ...
    def delete_dataset_version(
        ...
        [maps_platform_datasets.DeleteDatasetVersionRequest], Awaitable[empty_pb2.Empty]
    ]:
...
__all__ = ("MapsPlatformDatasetsV1AlphaGrpcAsyncIOTransport",)

...
class MapsPlatformDatasetsV1AlphaClientMeta(type):
    """Metaclass for the MapsPlatformDatasetsV1Alpha client.
    ...
    ) -> Type[MapsPlatformDatasetsV1AlphaTransport]:
...
class MapsPlatformDatasetsV1AlphaClient(
    metaclass=MapsPlatformDatasetsV1AlphaClientMeta
):
    ...
    DEFAULT_ENDPOINT = "mapsplatformdatasets.googleapis.com"
    DEFAULT_MTLS_ENDPOINT = _get_default_mtls_endpoint.__func__(  # type: ignore
        DEFAULT_ENDPOINT
    )

    _DEFAULT_ENDPOINT_TEMPLATE = "mapsplatformdatasets.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MapsPlatformDatasetsV1AlphaClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> MapsPlatformDatasetsV1AlphaTransport:
        """Returns the transport used by the client instance.

        Returns:
            MapsPlatformDatasetsV1AlphaTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = MapsPlatformDatasetsV1AlphaClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = MapsPlatformDatasetsV1AlphaClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = MapsPlatformDatasetsV1AlphaClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or MapsPlatformDatasetsV1AlphaClient._compare_universes(
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., MapsPlatformDatasetsV1AlphaTransport],
            ]
        ] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the maps platform datasets v1 alpha client.
        ...
        Args:
            ...
            transport (Optional[Union[str,MapsPlatformDatasetsV1AlphaTransport,Callable[..., MapsPlatformDatasetsV1AlphaTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the MapsPlatformDatasetsV1AlphaTransport constructor.
        ...
        self._universe_domain = MapsPlatformDatasetsV1AlphaClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, MapsPlatformDatasetsV1AlphaTransport)
        if transport_provided:
            # transport is a MapsPlatformDatasetsV1AlphaTransport instance.
            ...
            self._transport = cast(MapsPlatformDatasetsV1AlphaTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or MapsPlatformDatasetsV1AlphaClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                if isinstance(transport, str) or transport is None
                    ...
                    Callable[..., MapsPlatformDatasetsV1AlphaTransport], transport
                )
            )
    ...
    def create_dataset(
        ...
        *,
        ...
        Args:
            request (Union[google.maps.mapsplatformdatasets_v1alpha.types.CreateDatasetRequest, dict]):
        ...
        Returns:
            google.maps.mapsplatformdatasets_v1alpha.types.Dataset:
    ...
    def update_dataset_metadata(
        ...
        *,
        ...
        r"""Update the metadata for the dataset. To update the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_dataset_metadata]
    ...
    def get_dataset(
        ...
        *,
        ...
        r"""Get the published or latest version of the dataset.
        ...
        Args:
            ...
            name (str):
                ...
                In order to retrieve a previous version of the dataset,
                also provide the version ID. Example:
    ...
    def list_dataset_versions(
        self,
        request: Optional[
            Union[maps_platform_datasets.ListDatasetVersionsRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""List all the versions of a dataset.
        ...
        .. code-block:: python
            ...
            def sample_list_dataset_versions():
                ...
                # Initialize request argument(s)
                request = mapsplatformdatasets_v1alpha.ListDatasetVersionsRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.maps.mapsplatformdatasets_v1alpha.types.ListDatasetVersionsRequest, dict]):
                The request object. Request to list of all versions of
                the dataset.
            name (str):
                Required. The name of the dataset to
                list all the versions for.
        ...
        Returns:
            google.maps.mapsplatformdatasets_v1alpha.services.maps_platform_datasets_v1_alpha.pagers.ListDatasetVersionsPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, maps_platform_datasets.ListDatasetVersionsRequest):
            request = maps_platform_datasets.ListDatasetVersionsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_datasets():
                ...
                # Initialize request argument(s)
                request = mapsplatformdatasets_v1alpha.ListDatasetsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.maps.mapsplatformdatasets_v1alpha.types.ListDatasetsRequest, dict]):
        ...
        Returns:
            google.maps.mapsplatformdatasets_v1alpha.services.maps_platform_datasets_v1_alpha.pagers.ListDatasetsPager:
    ...
    def delete_dataset(
        ...
        *,
        ...
        r"""Delete the specified dataset and optionally all its
        ...
        Args:
            request (Union[google.maps.mapsplatformdatasets_v1alpha.types.DeleteDatasetRequest, dict]):
    ...
    def delete_dataset_version(
        self,
        request: Optional[
            Union[maps_platform_datasets.DeleteDatasetVersionRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Delete a specific version of the dataset.
        ...
        Args:
            request (Union[google.maps.mapsplatformdatasets_v1alpha.types.DeleteDatasetVersionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, maps_platform_datasets.DeleteDatasetVersionRequest):
            request = maps_platform_datasets.DeleteDatasetVersionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def __enter__(self) -> "MapsPlatformDatasetsV1AlphaClient":
        return self

...
class MapsPlatformDatasetsV1AlphaAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = (
        MapsPlatformDatasetsV1AlphaClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    ...
    parse_dataset_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.parse_dataset_path
    )
    common_billing_account_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.common_folder_path
    )
    parse_common_folder_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.parse_common_organization_path
    )
    common_project_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.common_project_path
    )
    parse_common_project_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        MapsPlatformDatasetsV1AlphaClient.parse_common_location_path
    )
    ...
    get_transport_class = functools.partial(
        type(MapsPlatformDatasetsV1AlphaClient).get_transport_class,
...
__all__ = ("MapsPlatformDatasetsV1AlphaAsyncClient",)

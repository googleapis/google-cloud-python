...
class MapsPlatformDatasetsGrpcAsyncIOTransport(MapsPlatformDatasetsTransport):
    ...
    @property
    def create_dataset(self) -> Callable[[maps_platform_datasets.CreateDatasetRequest], Awaitable[gmm_dataset.Dataset]]:
    ...
    @property
    def update_dataset_metadata(self) -> Callable[[maps_platform_datasets.UpdateDatasetMetadataRequest], Awaitable[gmm_dataset.Dataset]]:
    ...
    @property
    def get_dataset(self) -> Callable[[maps_platform_datasets.GetDatasetRequest], Awaitable[dataset.Dataset]]:
    ...
    def fetch_dataset_errors(
        self,
    ) -> Callable[[maps_platform_datasets.FetchDatasetErrorsRequest], Awaitable[maps_platform_datasets.FetchDatasetErrorsResponse]]:
    ...
    @property
    def list_datasets(self) -> Callable[[maps_platform_datasets.ListDatasetsRequest], Awaitable[maps_platform_datasets.ListDatasetsResponse]]:
    ...
    @property
    def delete_dataset(self) -> Callable[[maps_platform_datasets.DeleteDatasetRequest], Awaitable[empty_pb2.Empty]]:

...
from .transports.grpc import MapsPlatformDatasetsGrpcTransport
from .transports.grpc_asyncio import MapsPlatformDatasetsGrpcAsyncIOTransport
from .transports.rest import MapsPlatformDatasetsRestTransport


class MapsPlatformDatasetsClientMeta(type):
    """Metaclass for the MapsPlatformDatasets client.
...
class MapsPlatformDatasetsClient(metaclass=MapsPlatformDatasetsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MapsPlatformDatasetsClient: The constructed client.
        """
    ...
    def transport(self) -> MapsPlatformDatasetsTransport:
        ...
        Returns:
            MapsPlatformDatasetsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = MapsPlatformDatasetsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = MapsPlatformDatasetsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = MapsPlatformDatasetsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MapsPlatformDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = MapsPlatformDatasetsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, MapsPlatformDatasetsTransport, Callable[..., MapsPlatformDatasetsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = MapsPlatformDatasetsClient._read_environment_variables()
        self._client_cert_source = MapsPlatformDatasetsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = MapsPlatformDatasetsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, MapsPlatformDatasetsTransport)
        if transport_provided:
            # transport is a MapsPlatformDatasetsTransport instance.
            ...
            self._transport = cast(MapsPlatformDatasetsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or MapsPlatformDatasetsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MapsPlatformDatasetsTransport], Callable[..., MapsPlatformDatasetsTransport]] = (
    ...
    def __enter__(self) -> "MapsPlatformDatasetsClient":
        return self

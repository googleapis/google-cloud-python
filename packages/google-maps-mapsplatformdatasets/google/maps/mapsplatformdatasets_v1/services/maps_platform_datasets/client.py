...
class MapsPlatformDatasetsClient(metaclass=MapsPlatformDatasetsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = MapsPlatformDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _compare_universes(
        ...
        default_universe = MapsPlatformDatasetsClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or MapsPlatformDatasetsClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        ) = MapsPlatformDatasetsClient._read_environment_variables()
        self._client_cert_source = MapsPlatformDatasetsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = MapsPlatformDatasetsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or MapsPlatformDatasetsClient._get_api_endpoint(

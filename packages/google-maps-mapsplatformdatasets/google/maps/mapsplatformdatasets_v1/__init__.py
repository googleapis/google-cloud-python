...
from .services.maps_platform_datasets import MapsPlatformDatasetsAsyncClient, MapsPlatformDatasetsClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.maps.mapsplatformdatasets_v1")  # type: ignore
    api_core.check_dependency_versions("google.maps.mapsplatformdatasets_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.mapsplatformdatasets_v1"

...
from google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets import (
...
def test__get_default_mtls_endpoint():
    ...
    assert MapsPlatformDatasetsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert MapsPlatformDatasetsClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert MapsPlatformDatasetsClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert MapsPlatformDatasetsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert MapsPlatformDatasetsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert MapsPlatformDatasetsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert MapsPlatformDatasetsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert MapsPlatformDatasetsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert MapsPlatformDatasetsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert MapsPlatformDatasetsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert MapsPlatformDatasetsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert MapsPlatformDatasetsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert MapsPlatformDatasetsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                MapsPlatformDatasetsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert MapsPlatformDatasetsClient._get_client_cert_source(None, False) is None
    assert MapsPlatformDatasetsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MapsPlatformDatasetsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert MapsPlatformDatasetsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert MapsPlatformDatasetsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(MapsPlatformDatasetsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsClient))
@mock.patch.object(MapsPlatformDatasetsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MapsPlatformDatasetsClient._DEFAULT_UNIVERSE
    default_endpoint = MapsPlatformDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = MapsPlatformDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert MapsPlatformDatasetsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        MapsPlatformDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == MapsPlatformDatasetsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert MapsPlatformDatasetsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MapsPlatformDatasetsClient._get_api_endpoint(None, None, default_universe, "always") == MapsPlatformDatasetsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        MapsPlatformDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == MapsPlatformDatasetsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert MapsPlatformDatasetsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert MapsPlatformDatasetsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        MapsPlatformDatasetsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert MapsPlatformDatasetsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert MapsPlatformDatasetsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert MapsPlatformDatasetsClient._get_universe_domain(None, None) == MapsPlatformDatasetsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        MapsPlatformDatasetsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = MapsPlatformDatasetsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (MapsPlatformDatasetsClient, "grpc"),
        (MapsPlatformDatasetsAsyncClient, "grpc_asyncio"),
        (MapsPlatformDatasetsClient, "rest"),
    ],
)
def test_maps_platform_datasets_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "mapsplatformdatasets.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://mapsplatformdatasets.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.MapsPlatformDatasetsGrpcTransport, "grpc"),
        (transports.MapsPlatformDatasetsGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.MapsPlatformDatasetsRestTransport, "rest"),
    ],
)
def test_maps_platform_datasets_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_maps_platform_datasets_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
def test_maps_platform_datasets_client_get_transport_class():
    transport = MapsPlatformDatasetsClient.get_transport_class()
    available_transports = [
        transports.MapsPlatformDatasetsGrpcTransport,
        transports.MapsPlatformDatasetsRestTransport,
    ]
    assert transport in available_transports

    transport = MapsPlatformDatasetsClient.get_transport_class("grpc")
    assert transport == transports.MapsPlatformDatasetsGrpcTransport


@pytest.mark.parametrize(
    "client_class,transport_class,transport_name",
    [
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport, "grpc"),
        (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport, "grpc_asyncio"),
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsRestTransport, "rest"),
    ],
)
@mock.patch.object(MapsPlatformDatasetsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsClient))
@mock.patch.object(MapsPlatformDatasetsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsAsyncClient))
def test_maps_platform_datasets_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(MapsPlatformDatasetsClient, "get_transport_class") as gtc:
...
@pytest.mark.parametrize(
    ...
    [
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport, "grpc", "true"),
        (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport, "grpc", "false"),
        (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsRestTransport, "rest", "true"),
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(MapsPlatformDatasetsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsClient))
@mock.patch.object(MapsPlatformDatasetsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_maps_platform_datasets_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [MapsPlatformDatasetsClient, MapsPlatformDatasetsAsyncClient])
@mock.patch.object(MapsPlatformDatasetsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MapsPlatformDatasetsClient))
@mock.patch.object(MapsPlatformDatasetsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MapsPlatformDatasetsAsyncClient))
def test_maps_platform_datasets_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
@mock.patch.object(MapsPlatformDatasetsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsClient))
@mock.patch.object(MapsPlatformDatasetsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MapsPlatformDatasetsAsyncClient))
def test_maps_platform_datasets_client_client_api_endpoint(client_class):
...
def test_maps_platform_datasets_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport, "grpc", grpc_helpers),
        (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsRestTransport, "rest", None),
    ],
)
def test_maps_platform_datasets_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_maps_platform_datasets_client_client_options_from_dict():
    with mock.patch(
        "google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets.transports.MapsPlatformDatasetsGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = MapsPlatformDatasetsClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_maps_platform_datasets_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_update_dataset_metadata_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_dataset_metadata in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_dataset_metadata] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_dataset_metadata_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MapsPlatformDatasetsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_dataset_metadata in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_dataset_metadata] = mock_rpc
...
def test_fetch_dataset_errors_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_dataset_errors in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_dataset_errors] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_dataset_errors_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MapsPlatformDatasetsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_dataset_errors in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_dataset_errors] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_dataset_errors_async(transport: str = "grpc_asyncio", request_type=maps_platform_datasets.FetchDatasetErrorsRequest):
    client = MapsPlatformDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_fetch_dataset_errors_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_dataset_errors), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(maps_platform_datasets.FetchDatasetErrorsResponse())
        await client.fetch_dataset_errors(request)
...
def test_fetch_dataset_errors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.fetch_dataset_errors), "__call__") as call:
        ...
        retry = retries.Retry()
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("dataset", ""),)),)
        pager = client.fetch_dataset_errors(request={}, retry=retry, timeout=timeout)
...
async def test_fetch_dataset_errors_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_dataset_errors), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            maps_platform_datasets.FetchDatasetErrorsResponse(
                errors=[
...
async def test_fetch_dataset_errors_async_pages():
    ...
    with mock.patch.object(type(client.transport.fetch_dataset_errors), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.fetch_dataset_errors(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_dataset_rest_unset_required_fields():
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*}/datasets" % client.transport._host, args[1])
...
def test_update_dataset_metadata_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{dataset.name=projects/*/datasets/*}" % client.transport._host, args[1])
...
def test_get_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/datasets/*}" % client.transport._host, args[1])
...
def test_fetch_dataset_errors_rest_required_fields(request_type=maps_platform_datasets.FetchDatasetErrorsRequest):
    transport_class = transports.MapsPlatformDatasetsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_dataset_errors._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = maps_platform_datasets.FetchDatasetErrorsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_fetch_dataset_errors_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{dataset=projects/*/datasets/*}:fetchDatasetErrors" % client.transport._host, args[1])
...
def test_fetch_dataset_errors_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(maps_platform_datasets.FetchDatasetErrorsResponse.to_json(x) for x in response)
...
def test_credentials_transport_error():
    ...
    transport = transports.MapsPlatformDatasetsGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = MapsPlatformDatasetsClient(
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = MapsPlatformDatasetsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_get_channel():
    ...
    transport = transports.MapsPlatformDatasetsGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
@pytest.mark.parametrize(
    ...
    [
        transports.MapsPlatformDatasetsGrpcTransport,
        transports.MapsPlatformDatasetsGrpcAsyncIOTransport,
        transports.MapsPlatformDatasetsRestTransport,
    ],
)
...
def test_transport_kind_grpc():
    transport = MapsPlatformDatasetsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_dataset_metadata_empty_call_grpc():
    client = MapsPlatformDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_dataset_metadata), "__call__") as call:
        call.return_value = gmm_dataset.Dataset()
        client.update_dataset_metadata(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_fetch_dataset_errors_empty_call_grpc():
    client = MapsPlatformDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.fetch_dataset_errors), "__call__") as call:
        call.return_value = maps_platform_datasets.FetchDatasetErrorsResponse()
        client.fetch_dataset_errors(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = MapsPlatformDatasetsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = MapsPlatformDatasetsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_dataset_metadata_empty_call_grpc_asyncio():
    client = MapsPlatformDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_dataset_metadata), "__call__") as call:
        ...
        await client.update_dataset_metadata(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_fetch_dataset_errors_empty_call_grpc_asyncio():
    client = MapsPlatformDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.fetch_dataset_errors), "__call__") as call:
        ...
        await client.fetch_dataset_errors(request=None)
...
def test_transport_kind_rest():
    transport = MapsPlatformDatasetsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_dataset_rest_bad_request(request_type=maps_platform_datasets.CreateDatasetRequest):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_dataset_rest_call_success(request_type):
    ...
    request_init["dataset"] = {
        ...
        "status": {"state": 1, "error_message": "error_message_value"},
...
def test_create_dataset_rest_interceptors(null_interceptor):
    transport = transports.MapsPlatformDatasetsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MapsPlatformDatasetsRestInterceptor(),
    )
    client = MapsPlatformDatasetsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_create_dataset") as post, mock.patch.object(
        transports.MapsPlatformDatasetsRestInterceptor, "post_create_dataset_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gmm_dataset.Dataset.to_json(gmm_dataset.Dataset())
        ...
        post_with_metadata.return_value = gmm_dataset.Dataset(), metadata
...
def test_update_dataset_metadata_rest_bad_request(request_type=maps_platform_datasets.UpdateDatasetMetadataRequest):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_dataset_metadata_rest_call_success(request_type):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_dataset_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_update_dataset_metadata") as post, mock.patch.object(
        transports.MapsPlatformDatasetsRestInterceptor, "post_update_dataset_metadata_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_dataset_rest_bad_request(request_type=maps_platform_datasets.GetDatasetRequest):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_get_dataset") as post, mock.patch.object(
...
def test_fetch_dataset_errors_rest_bad_request(request_type=maps_platform_datasets.FetchDatasetErrorsRequest):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_fetch_dataset_errors_rest_call_success(request_type):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_fetch_dataset_errors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_fetch_dataset_errors") as post, mock.patch.object(
        transports.MapsPlatformDatasetsRestInterceptor, "post_fetch_dataset_errors_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = maps_platform_datasets.FetchDatasetErrorsRequest.pb(maps_platform_datasets.FetchDatasetErrorsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = maps_platform_datasets.FetchDatasetErrorsResponse.to_json(maps_platform_datasets.FetchDatasetErrorsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = maps_platform_datasets.FetchDatasetErrorsResponse(), metadata
...
def test_list_datasets_rest_bad_request(request_type=maps_platform_datasets.ListDatasetsRequest):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1"}
    request = request_type(**request_init)
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "post_list_datasets") as post, mock.patch.object(
        transports.MapsPlatformDatasetsRestInterceptor, "post_list_datasets_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = maps_platform_datasets.ListDatasetsResponse.to_json(maps_platform_datasets.ListDatasetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = maps_platform_datasets.ListDatasetsResponse(), metadata
...
def test_delete_dataset_rest_bad_request(request_type=maps_platform_datasets.DeleteDatasetRequest):
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/datasets/sample2"}
    request = request_type(**request_init)
...
def test_delete_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, "pre_delete_dataset") as pre:
        pre.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_dataset_metadata_empty_call_rest():
    client = MapsPlatformDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_fetch_dataset_errors_empty_call_rest():
    client = MapsPlatformDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_maps_platform_datasets_base_transport_error():
    # Passing both a credentials object and credentials_file should raise an error
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.MapsPlatformDatasetsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_maps_platform_datasets_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets.transports.MapsPlatformDatasetsTransport.__init__"
    ) as Transport:
...
def test_maps_platform_datasets_auth_adc():
...
def test_maps_platform_datasets_transport_auth_adc(transport_class):
...
def test_maps_platform_datasets_transport_auth_gdch_credentials(transport_class):
...
@pytest.mark.parametrize(
    ...
    [(transports.MapsPlatformDatasetsGrpcTransport, grpc_helpers), (transports.MapsPlatformDatasetsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.MapsPlatformDatasetsGrpcTransport, transports.MapsPlatformDatasetsGrpcAsyncIOTransport])
def test_maps_platform_datasets_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_maps_platform_datasets_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.MapsPlatformDatasetsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_maps_platform_datasets_host_no_port(transport_name):
    client = MapsPlatformDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="mapsplatformdatasets.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "mapsplatformdatasets.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://mapsplatformdatasets.googleapis.com"
...
def test_maps_platform_datasets_host_with_port(transport_name):
    client = MapsPlatformDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="mapsplatformdatasets.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_maps_platform_datasets_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = MapsPlatformDatasetsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = MapsPlatformDatasetsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_maps_platform_datasets_grpc_transport_channel():
...
def test_maps_platform_datasets_grpc_asyncio_transport_channel():
...
@pytest.mark.parametrize("transport_class", [transports.MapsPlatformDatasetsGrpcTransport, transports.MapsPlatformDatasetsGrpcAsyncIOTransport])
def test_maps_platform_datasets_transport_channel_mtls_with_client_cert_source(transport_class):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MapsPlatformDatasetsGrpcTransport, transports.MapsPlatformDatasetsGrpcAsyncIOTransport])
def test_maps_platform_datasets_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_dataset_path():
    ...
    actual = MapsPlatformDatasetsClient.dataset_path(project, dataset)
...
def test_parse_dataset_path():
    ...
    path = MapsPlatformDatasetsClient.dataset_path(**expected)

    # Check that the path construction is reversible.
    actual = MapsPlatformDatasetsClient.parse_dataset_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = MapsPlatformDatasetsClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = MapsPlatformDatasetsClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = MapsPlatformDatasetsClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = MapsPlatformDatasetsClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = MapsPlatformDatasetsClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = MapsPlatformDatasetsClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = MapsPlatformDatasetsClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = MapsPlatformDatasetsClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = MapsPlatformDatasetsClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = MapsPlatformDatasetsClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = MapsPlatformDatasetsClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = MapsPlatformDatasetsClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = MapsPlatformDatasetsClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = MapsPlatformDatasetsClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = MapsPlatformDatasetsClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MapsPlatformDatasetsTransport, "_prep_wrapped_messages") as prep:
        client = MapsPlatformDatasetsClient(
            credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(transports.MapsPlatformDatasetsTransport, "_prep_wrapped_messages") as prep:
        transport_class = MapsPlatformDatasetsClient.get_transport_class()
        transport = transport_class(
            credentials=ga_credentials.AnonymousCredentials(),
            client_info=client_info,
        )
...
def test_client_ctx():
    ...
    for transport in transports:
        client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        (MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport),
        (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport),
    ],
)

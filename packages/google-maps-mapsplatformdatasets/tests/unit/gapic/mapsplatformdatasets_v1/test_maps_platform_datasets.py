...
def test__get_default_mtls_endpoint():
    ...
    assert (
        MapsPlatformDatasetsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        MapsPlatformDatasetsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        MapsPlatformDatasetsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        MapsPlatformDatasetsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__get_client_cert_source():
    ...
    assert (
        MapsPlatformDatasetsClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                MapsPlatformDatasetsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(MapsPlatformDatasetsClient),
)
@mock.patch.object(
    MapsPlatformDatasetsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(MapsPlatformDatasetsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MapsPlatformDatasetsClient._DEFAULT_UNIVERSE
    default_endpoint = MapsPlatformDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = MapsPlatformDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        MapsPlatformDatasetsClient._get_api_endpoint(
    ...
    assert (
        MapsPlatformDatasetsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        MapsPlatformDatasetsClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        MapsPlatformDatasetsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        MapsPlatformDatasetsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        MapsPlatformDatasetsClient._get_universe_domain(None, None)
        == MapsPlatformDatasetsClient._DEFAULT_UNIVERSE
    )
...
def test_maps_platform_datasets_client_from_service_account_info(
    client_class, transport_name
):
...
def test_maps_platform_datasets_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_maps_platform_datasets_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_maps_platform_datasets_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_maps_platform_datasets_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [MapsPlatformDatasetsClient, MapsPlatformDatasetsAsyncClient]
)
@mock.patch.object(
    MapsPlatformDatasetsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(MapsPlatformDatasetsClient),
)
@mock.patch.object(
    MapsPlatformDatasetsAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(MapsPlatformDatasetsAsyncClient),
)
...
def test_maps_platform_datasets_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_maps_platform_datasets_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_maps_platform_datasets_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_fetch_dataset_errors_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.fetch_dataset_errors] = (
            mock_rpc
        )
        request = {}
...
async def test_fetch_dataset_errors_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.fetch_dataset_errors(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*}/datasets" % client.transport._host, args[1]
        )
...
def test_update_dataset_metadata_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{dataset.name=projects/*/datasets/*}" % client.transport._host,
            args[1],
        )
...
def test_get_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/datasets/*}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc_asyncio():
    transport = MapsPlatformDatasetsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = MapsPlatformDatasetsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_update_dataset_metadata_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = maps_platform_datasets.UpdateDatasetMetadataRequest.meta.fields[
        "dataset"
    ]
...
def test_fetch_dataset_errors_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = maps_platform_datasets.FetchDatasetErrorsResponse.to_json(
            maps_platform_datasets.FetchDatasetErrorsResponse()
        )
        req.return_value.content = return_value
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = maps_platform_datasets.ListDatasetsResponse.to_json(
            maps_platform_datasets.ListDatasetsResponse()
        )
        req.return_value.content = return_value
...
@pytest.mark.parametrize(
    ...
    [
        (transports.MapsPlatformDatasetsGrpcTransport, grpc_helpers),
        (transports.MapsPlatformDatasetsGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_maps_platform_datasets_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_maps_platform_datasets_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(

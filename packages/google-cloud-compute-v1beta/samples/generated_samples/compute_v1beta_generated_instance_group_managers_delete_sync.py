...
# [START compute_v1beta_generated_InstanceGroupManagers_Delete_sync]
...
def sample_delete():
    ...
    request = compute_v1beta.DeleteInstanceGroupManagerRequest(
...
# [END compute_v1beta_generated_InstanceGroupManagers_Delete_sync]

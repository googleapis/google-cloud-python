...
#
# Snippet for GetSerialPortOutput
...
# [START compute_v1beta_generated_Instances_GetSerialPortOutput_sync]
...
def sample_get_serial_port_output():
    ...
    request = compute_v1beta.GetSerialPortOutputInstanceRequest(

...
# [START compute_v1beta_generated_FirewallPolicies_PatchRule_sync]
...
def sample_patch_rule():
    ...
    request = compute_v1beta.PatchRuleFirewallPolicyRequest(
...
# [END compute_v1beta_generated_FirewallPolicies_PatchRule_sync]

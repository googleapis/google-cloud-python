...
#
# Snippet for GetEffectiveSecurityPolicies
...
# [START compute_v1beta_generated_BackendServices_GetEffectiveSecurityPolicies_sync]
...
def sample_get_effective_security_policies():
    # Create a client
    client = compute_v1beta.BackendServicesClient()

    # Initialize request argument(s)
    request = compute_v1beta.GetEffectiveSecurityPoliciesBackendServiceRequest(

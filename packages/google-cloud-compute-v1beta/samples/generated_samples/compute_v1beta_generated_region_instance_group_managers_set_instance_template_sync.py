...
#
# Snippet for SetInstanceTemplate
...
# [START compute_v1beta_generated_RegionInstanceGroupManagers_SetInstanceTemplate_sync]
...
def sample_set_instance_template():
    ...
    request = compute_v1beta.SetInstanceTemplateRegionInstanceGroupManagerRequest(

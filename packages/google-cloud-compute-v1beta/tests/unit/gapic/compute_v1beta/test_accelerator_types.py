...
from google.cloud.compute_v1beta.services.accelerator_types import AcceleratorTypesClient, pagers, transports
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/acceleratorTypes/{accelerator_type}" % client.transport._host, args[1]
        )
...
def test_accelerator_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

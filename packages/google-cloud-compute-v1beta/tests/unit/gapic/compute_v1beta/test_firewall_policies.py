...
from google.cloud.compute_v1beta.services.firewall_policies import FirewallPoliciesClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert FirewallPoliciesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert FirewallPoliciesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert FirewallPoliciesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert FirewallPoliciesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert FirewallPoliciesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert FirewallPoliciesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert FirewallPoliciesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert FirewallPoliciesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert FirewallPoliciesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert FirewallPoliciesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert FirewallPoliciesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                FirewallPoliciesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert FirewallPoliciesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert FirewallPoliciesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert FirewallPoliciesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert FirewallPoliciesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(FirewallPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirewallPoliciesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = FirewallPoliciesClient._DEFAULT_UNIVERSE
    default_endpoint = FirewallPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = FirewallPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert FirewallPoliciesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        FirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == FirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert FirewallPoliciesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert FirewallPoliciesClient._get_api_endpoint(None, None, default_universe, "always") == FirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
    assert (
        FirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == FirewallPoliciesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert FirewallPoliciesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert FirewallPoliciesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        FirewallPoliciesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert FirewallPoliciesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert FirewallPoliciesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert FirewallPoliciesClient._get_universe_domain(None, None) == FirewallPoliciesClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = FirewallPoliciesClient(credentials=cred)
...
def test_firewall_policies_client_from_service_account_info(client_class, transport_name):
...
def test_firewall_policies_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_firewall_policies_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@mock.patch.object(FirewallPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirewallPoliciesClient))
def test_firewall_policies_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (FirewallPoliciesClient, transports.FirewallPoliciesRestTransport, "rest", "true"),
        (FirewallPoliciesClient, transports.FirewallPoliciesRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(FirewallPoliciesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirewallPoliciesClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_firewall_policies_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(FirewallPoliciesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FirewallPoliciesClient))
def test_firewall_policies_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_firewall_policies_client_client_options_scopes(client_class, transport_class, transport_name):
...
def test_firewall_policies_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_add_association_rest_required_fields(request_type=compute.AddAssociationFirewallPolicyRequest):
...
def test_add_association_rest_unset_required_fields():
    transport = transports.FirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addAssociation" % client.transport._host, args[1]
        )
...
def test_add_association_unary_rest_required_fields(request_type=compute.AddAssociationFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_add_packet_mirroring_rule_rest_required_fields(request_type=compute.AddPacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_add_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addPacketMirroringRule" % client.transport._host, args[1]
        )
...
def test_add_packet_mirroring_rule_unary_rest_required_fields(request_type=compute.AddPacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_add_rule_rest_required_fields(request_type=compute.AddRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addRule" % client.transport._host, args[1])
...
def test_add_rule_unary_rest_required_fields(request_type=compute.AddRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_clone_rules_rest_required_fields(request_type=compute.CloneRulesFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/cloneRules" % client.transport._host, args[1]
        )
...
def test_clone_rules_unary_rest_required_fields(request_type=compute.CloneRulesFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}" % client.transport._host, args[1])
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_get_association_rest_required_fields(request_type=compute.GetAssociationFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getAssociation" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_required_fields(request_type=compute.GetIamPolicyFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_get_iam_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("optionsRequestedPolicyVersion",)) & set(("resource",)))
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_get_packet_mirroring_rule_rest_required_fields(request_type=compute.GetPacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_get_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getPacketMirroringRule" % client.transport._host, args[1]
        )
...
def test_get_rule_rest_required_fields(request_type=compute.GetRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getRule" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_list_associations_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_associations] = mock_rpc
...
def test_move_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/move" % client.transport._host, args[1])
...
def test_move_unary_rest_required_fields(request_type=compute.MoveFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_patch_unary_rest_required_fields(request_type=compute.PatchFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_patch_packet_mirroring_rule_rest_required_fields(request_type=compute.PatchPacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_patch_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/patchPacketMirroringRule" % client.transport._host, args[1]
        )
...
def test_patch_packet_mirroring_rule_unary_rest_required_fields(request_type=compute.PatchPacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_patch_rule_rest_required_fields(request_type=compute.PatchRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/patchRule" % client.transport._host, args[1]
        )
...
def test_patch_rule_unary_rest_required_fields(request_type=compute.PatchRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_remove_association_rest_required_fields(request_type=compute.RemoveAssociationFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removeAssociation" % client.transport._host, args[1]
        )
...
def test_remove_association_unary_rest_required_fields(request_type=compute.RemoveAssociationFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_remove_packet_mirroring_rule_rest_required_fields(request_type=compute.RemovePacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_remove_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removePacketMirroringRule" % client.transport._host, args[1]
        )
...
def test_remove_packet_mirroring_rule_unary_rest_required_fields(request_type=compute.RemovePacketMirroringRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_remove_rule_rest_required_fields(request_type=compute.RemoveRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removeRule" % client.transport._host, args[1]
        )
...
def test_remove_rule_unary_rest_required_fields(request_type=compute.RemoveRuleFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_set_iam_policy_rest_required_fields(request_type=compute.SetIamPolicyFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/locations/global/firewallPolicies/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsFirewallPolicyRequest):
    transport_class = transports.FirewallPoliciesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = FirewallPoliciesClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_rest():
    transport = FirewallPoliciesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_add_association_rest_bad_request(request_type=compute.AddAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_add_association_rest_call_success(request_type):
    ...
    test_field = compute.AddAssociationFirewallPolicyRequest.meta.fields["firewall_policy_association_resource"]
...
def test_add_association_rest_interceptors(null_interceptor):
    transport = transports.FirewallPoliciesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.FirewallPoliciesRestInterceptor(),
    )
    client = FirewallPoliciesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_association") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_add_association_with_metadata"
        ...
        pb_message = compute.AddAssociationFirewallPolicyRequest.pb(compute.AddAssociationFirewallPolicyRequest())
...
def test_add_packet_mirroring_rule_rest_bad_request(request_type=compute.AddPacketMirroringRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_add_packet_mirroring_rule_rest_call_success(request_type):
    ...
    request_init["firewall_policy_rule_resource"] = {
        ...
        "target_forwarding_rules": ["target_forwarding_rules_value1", "target_forwarding_rules_value2"],
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.AddPacketMirroringRuleFirewallPolicyRequest.meta.fields["firewall_policy_rule_resource"]
...
def test_add_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "pre_add_packet_mirroring_rule"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AddPacketMirroringRuleFirewallPolicyRequest.pb(compute.AddPacketMirroringRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_add_rule_rest_bad_request(request_type=compute.AddRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_add_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.AddRuleFirewallPolicyRequest.meta.fields["firewall_policy_rule_resource"]
...
def test_add_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_add_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_add_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AddRuleFirewallPolicyRequest.pb(compute.AddRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_clone_rules_rest_bad_request(request_type=compute.CloneRulesFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_clone_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_clone_rules") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_clone_rules_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.CloneRulesFirewallPolicyRequest.pb(compute.CloneRulesFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_rest_bad_request(request_type=compute.DeleteFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteFirewallPolicyRequest.pb(compute.DeleteFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_bad_request(request_type=compute.GetFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetFirewallPolicyRequest.pb(compute.GetFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_association_rest_bad_request(request_type=compute.GetAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_association") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_get_association_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetAssociationFirewallPolicyRequest.pb(compute.GetAssociationFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_iam_policy_rest_bad_request(request_type=compute.GetIamPolicyFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyFirewallPolicyRequest.pb(compute.GetIamPolicyFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_packet_mirroring_rule_rest_bad_request(request_type=compute.GetPacketMirroringRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_get_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "pre_get_packet_mirroring_rule"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetPacketMirroringRuleFirewallPolicyRequest.pb(compute.GetPacketMirroringRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rule_rest_bad_request(request_type=compute.GetRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_get_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_get_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRuleFirewallPolicyRequest.pb(compute.GetRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_bad_request(request_type=compute.InsertFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertFirewallPolicyRequest.meta.fields["firewall_policy_resource"]
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertFirewallPolicyRequest.pb(compute.InsertFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_bad_request(request_type=compute.ListFirewallPoliciesRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListFirewallPoliciesRequest.pb(compute.ListFirewallPoliciesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_associations_rest_bad_request(request_type=compute.ListAssociationsFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_list_associations_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # Convert return value to protobuf type
        return_value = compute.FirewallPoliciesListAssociationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
        response_value.content = json_return_value.encode("UTF-8")
        req.return_value = response_value
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
...
def test_list_associations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_list_associations") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_list_associations_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListAssociationsFirewallPolicyRequest.pb(compute.ListAssociationsFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.FirewallPoliciesListAssociationsResponse.to_json(compute.FirewallPoliciesListAssociationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.FirewallPoliciesListAssociationsResponse(), metadata
...
def test_move_rest_bad_request(request_type=compute.MoveFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_move") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_move_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.MoveFirewallPolicyRequest.pb(compute.MoveFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_patch_rest_bad_request(request_type=compute.PatchFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchFirewallPolicyRequest.meta.fields["firewall_policy_resource"]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_patch_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchFirewallPolicyRequest.pb(compute.PatchFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_patch_packet_mirroring_rule_rest_bad_request(request_type=compute.PatchPacketMirroringRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_patch_packet_mirroring_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchPacketMirroringRuleFirewallPolicyRequest.meta.fields["firewall_policy_rule_resource"]
...
def test_patch_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_packet_mirroring_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_patch_packet_mirroring_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "pre_patch_packet_mirroring_rule"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchPacketMirroringRuleFirewallPolicyRequest.pb(compute.PatchPacketMirroringRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_patch_rule_rest_bad_request(request_type=compute.PatchRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_patch_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRuleFirewallPolicyRequest.meta.fields["firewall_policy_rule_resource"]
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_patch_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_patch_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRuleFirewallPolicyRequest.pb(compute.PatchRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_remove_association_rest_bad_request(request_type=compute.RemoveAssociationFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_remove_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_association") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_remove_association_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveAssociationFirewallPolicyRequest.pb(compute.RemoveAssociationFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_remove_packet_mirroring_rule_rest_bad_request(request_type=compute.RemovePacketMirroringRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_remove_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_packet_mirroring_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_remove_packet_mirroring_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "pre_remove_packet_mirroring_rule"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemovePacketMirroringRuleFirewallPolicyRequest.pb(compute.RemovePacketMirroringRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_remove_rule_rest_bad_request(request_type=compute.RemoveRuleFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"firewall_policy": "sample1"}
    request = request_type(**request_init)
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_remove_rule") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_remove_rule_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveRuleFirewallPolicyRequest.pb(compute.RemoveRuleFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_iam_policy_rest_bad_request(request_type=compute.SetIamPolicyFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"resource": "sample1"}
    request = request_type(**request_init)
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyFirewallPolicyRequest.meta.fields["global_organization_set_policy_request_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["global_organization_set_policy_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["global_organization_set_policy_request_resource"][field])):
                    del request_init["global_organization_set_policy_request_resource"][field][i][subfield]
            else:
                del request_init["global_organization_set_policy_request_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyFirewallPolicyRequest.pb(compute.SetIamPolicyFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsFirewallPolicyRequest):
    client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"resource": "sample1"}
    request = request_type(**request_init)
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsFirewallPolicyRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FirewallPoliciesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.FirewallPoliciesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsFirewallPolicyRequest.pb(compute.TestIamPermissionsFirewallPolicyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_add_association_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.add_association), "__call__") as call:
        ...
        request_msg = compute.AddAssociationFirewallPolicyRequest()
...
def test_add_packet_mirroring_rule_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.add_packet_mirroring_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.AddPacketMirroringRuleFirewallPolicyRequest()
...
def test_add_rule_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.add_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.AddRuleFirewallPolicyRequest()
...
def test_clone_rules_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.clone_rules), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.CloneRulesFirewallPolicyRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteFirewallPolicyRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetFirewallPolicyRequest()
...
def test_get_association_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_association), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetAssociationFirewallPolicyRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyFirewallPolicyRequest()
...
def test_get_packet_mirroring_rule_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_packet_mirroring_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetPacketMirroringRuleFirewallPolicyRequest()
...
def test_get_rule_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRuleFirewallPolicyRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertFirewallPolicyRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListFirewallPoliciesRequest()
...
def test_list_associations_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.list_associations), "__call__") as call:
        client.list_associations(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListAssociationsFirewallPolicyRequest()
...
def test_move_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.move), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.MoveFirewallPolicyRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchFirewallPolicyRequest()
...
def test_patch_packet_mirroring_rule_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch_packet_mirroring_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchPacketMirroringRuleFirewallPolicyRequest()
...
def test_patch_rule_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchRuleFirewallPolicyRequest()
...
def test_remove_association_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.remove_association), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.RemoveAssociationFirewallPolicyRequest()
...
def test_remove_packet_mirroring_rule_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.remove_packet_mirroring_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.RemovePacketMirroringRuleFirewallPolicyRequest()
...
def test_remove_rule_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.remove_rule), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.RemoveRuleFirewallPolicyRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyFirewallPolicyRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsFirewallPolicyRequest()
...
def test_firewall_policies_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.FirewallPoliciesTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_firewall_policies_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.compute_v1beta.services.firewall_policies.transports.FirewallPoliciesTransport.__init__") as Transport:
...
def test_firewall_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.firewall_policies.transports.FirewallPoliciesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_firewall_policies_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.FirewallPoliciesRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_firewall_policies_client_transport_session_collision(transport_name):
    ...
    client2 = FirewallPoliciesClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_client_ctx():
    ...
    for transport in transports:
        client = FirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        (FirewallPoliciesClient, transports.FirewallPoliciesRestTransport),
    ],
)

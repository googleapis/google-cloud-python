...
from google.cloud.compute_v1beta.services.firewall_policies import (
...
def test_add_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAddAssociation,
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addAssociation"
...
def test_add_packet_mirroring_rule_rest_required_fields(
    request_type=compute.AddPacketMirroringRuleFirewallPolicyRequest,
):
    transport_class = transports.FirewallPoliciesRestTransport
    ...
    default_values = getattr(
        transport_class._BaseAddPacketMirroringRule,
        "_BaseAddPacketMirroringRule__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_add_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addPacketMirroringRule"
            % client.transport._host,
            args[1],
        )
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/addRule"
            % client.transport._host,
            args[1],
        )
...
def test_clone_rules_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCloneRules,
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/cloneRules"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}"
            % client.transport._host,
            args[1],
        )
...
def test_get_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetAssociation,
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getAssociation"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_get_packet_mirroring_rule_rest_required_fields(
    request_type=compute.GetPacketMirroringRuleFirewallPolicyRequest,
):
    transport_class = transports.FirewallPoliciesRestTransport
    ...
    default_values = getattr(
        transport_class._BaseGetPacketMirroringRule,
        "_BaseGetPacketMirroringRule__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getPacketMirroringRule"
            % client.transport._host,
            args[1],
        )
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/getRule"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies"
            % client.transport._host,
            args[1],
        )
...
def test_list_associations_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_associations] = (
            mock_rpc
        )
...
def test_move_rest_required_fields(request_type=compute.MoveFirewallPolicyRequest):
    ...
    default_values = getattr(
        ...
        "_BaseMove__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_move_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/move"
            % client.transport._host,
            args[1],
        )
...
def test_patch_packet_mirroring_rule_rest_required_fields(
    request_type=compute.PatchPacketMirroringRuleFirewallPolicyRequest,
):
    transport_class = transports.FirewallPoliciesRestTransport
    ...
    default_values = getattr(
        transport_class._BasePatchPacketMirroringRule,
        "_BasePatchPacketMirroringRule__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_patch_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/patchPacketMirroringRule"
            % client.transport._host,
            args[1],
        )
...
def test_patch_rule_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BasePatchRule,
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/patchRule"
            % client.transport._host,
            args[1],
        )
...
def test_remove_association_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.remove_association] = (
            mock_rpc
        )
...
def test_remove_association_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveAssociation,
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removeAssociation"
            % client.transport._host,
            args[1],
        )
...
def test_remove_packet_mirroring_rule_rest_required_fields(
    request_type=compute.RemovePacketMirroringRuleFirewallPolicyRequest,
):
    transport_class = transports.FirewallPoliciesRestTransport
    ...
    default_values = getattr(
        transport_class._BaseRemovePacketMirroringRule,
        "_BaseRemovePacketMirroringRule__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_remove_packet_mirroring_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removePacketMirroringRule"
            % client.transport._host,
            args[1],
        )
...
def test_remove_rule_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveRule,
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{firewall_policy}/removeRule"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/locations/global/firewallPolicies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_add_association_rest_call_success(request_type):
    ...
    test_field = compute.AddAssociationFirewallPolicyRequest.meta.fields[
...
def test_add_association_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.FirewallPoliciesRestInterceptor,
        ...
        pb_message = compute.AddAssociationFirewallPolicyRequest.pb(
            compute.AddAssociationFirewallPolicyRequest()
        )
...
def test_add_packet_mirroring_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.AddPacketMirroringRuleFirewallPolicyRequest.meta.fields[
...
def test_add_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.FirewallPoliciesRestInterceptor, "post_add_packet_mirroring_rule"
        ) as post,
        mock.patch.object(
            transports.FirewallPoliciesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AddPacketMirroringRuleFirewallPolicyRequest.pb(
            compute.AddPacketMirroringRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_add_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.AddRuleFirewallPolicyRequest.meta.fields[
        "firewall_policy_rule_resource"
    ]
...
def test_add_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AddRuleFirewallPolicyRequest.pb(
            compute.AddRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_clone_rules_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.CloneRulesFirewallPolicyRequest.pb(
            compute.CloneRulesFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteFirewallPolicyRequest.pb(
            compute.DeleteFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.FirewallPoliciesRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetFirewallPolicyRequest.pb(
            compute.GetFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetAssociationFirewallPolicyRequest.pb(
            compute.GetAssociationFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyFirewallPolicyRequest.pb(
            compute.GetIamPolicyFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.FirewallPoliciesRestInterceptor, "post_get_packet_mirroring_rule"
        ) as post,
        mock.patch.object(
            transports.FirewallPoliciesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetPacketMirroringRuleFirewallPolicyRequest.pb(
            compute.GetPacketMirroringRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRuleFirewallPolicyRequest.pb(
            compute.GetRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertFirewallPolicyRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertFirewallPolicyRequest.pb(
            compute.InsertFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListFirewallPoliciesRequest.pb(
            compute.ListFirewallPoliciesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_associations_rest_bad_request(
    request_type=compute.ListAssociationsFirewallPolicyRequest,
):
    client = FirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_associations_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListAssociationsFirewallPolicyRequest.pb(
            compute.ListAssociationsFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.FirewallPoliciesListAssociationsResponse.to_json(
...
def test_move_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.MoveFirewallPolicyRequest.pb(
            compute.MoveFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchFirewallPolicyRequest.meta.fields[
        "firewall_policy_resource"
    ]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchFirewallPolicyRequest.pb(
            compute.PatchFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_packet_mirroring_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchPacketMirroringRuleFirewallPolicyRequest.meta.fields[
        "firewall_policy_rule_resource"
    ]
...
def test_patch_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchPacketMirroringRuleFirewallPolicyRequest.pb(
            compute.PatchPacketMirroringRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_rule_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRuleFirewallPolicyRequest.meta.fields[
        "firewall_policy_rule_resource"
    ]
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRuleFirewallPolicyRequest.pb(
            compute.PatchRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_remove_association_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveAssociationFirewallPolicyRequest.pb(
            compute.RemoveAssociationFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_remove_packet_mirroring_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemovePacketMirroringRuleFirewallPolicyRequest.pb(
            compute.RemovePacketMirroringRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.RemoveRuleFirewallPolicyRequest.pb(
            compute.RemoveRuleFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyFirewallPolicyRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["global_organization_set_policy_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["global_organization_set_policy_request_resource"][
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyFirewallPolicyRequest.pb(
            compute.SetIamPolicyFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsFirewallPolicyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsFirewallPolicyRequest.pb(
            compute.TestIamPermissionsFirewallPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_firewall_policies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.firewall_policies.transports.FirewallPoliciesTransport.__init__"
    ) as Transport:

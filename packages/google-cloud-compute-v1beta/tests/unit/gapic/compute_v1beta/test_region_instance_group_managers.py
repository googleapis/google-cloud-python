...
from google.cloud.compute_v1beta.services.region_instance_group_managers import (
...
def test__get_client_cert_source():
    ...
    assert (
        RegionInstanceGroupManagersClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionInstanceGroupManagersClient._get_client_cert_source(None, True)
...
def test_adopt_instances_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.adopt_instances in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.adopt_instances] = mock_rpc

        request = {}
        client.adopt_instances(request)
...
def test_adopt_instances_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).adopt_instances._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.adopt_instances(request)
...
def test_adopt_instances_rest_unset_required_fields():
    ...
    unset_fields = transport.adopt_instances._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(("requestId",))
        & set(
            (
...
def test_adopt_instances_rest_flattened():
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            instance_group_manager="instance_group_manager_value",
            region_instance_group_managers_adopt_instances_request_resource=compute.RegionInstanceGroupManagersAdoptInstancesRequest(
        ...
        client.adopt_instances(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/adoptInstances"
            % client.transport._host,
            args[1],
        )


def test_adopt_instances_rest_flattened_error(transport: str = "rest"):
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_adopt_instances_unary_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        request = {}
        client.adopt_instances_unary(request)
...
def test_adopt_instances_unary_rest_required_fields(
    request_type=compute.AdoptInstancesRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.adopt_instances_unary(request)
...
def test_adopt_instances_unary_rest_flattened():
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.adopt_instances_unary(**mock_args)
...
def test_adopt_instances_unary_rest_flattened_error(transport: str = "rest"):
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers"
            % client.transport._host,
            args[1],
        )
...
def test_list_errors_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/listErrors"
            % client.transport._host,
            args[1],
        )
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/resize"
            % client.transport._host,
            args[1],
        )
...
def test_resume_instances_rest_required_fields(
    request_type=compute.ResumeInstancesRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_set_auto_healing_policies_rest_required_fields(
    request_type=compute.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_start_instances_rest_required_fields(
    request_type=compute.StartInstancesRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_stop_instances_rest_required_fields(
    request_type=compute.StopInstancesRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_stop_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            instance_group_manager="instance_group_manager_value",
            region_instance_group_managers_stop_instances_request_resource=compute.RegionInstanceGroupManagersStopInstancesRequest(
                force_stop=True
            ),
        )
        mock_args.update(sample_request)
...
def test_suspend_instances_rest_required_fields(
    request_type=compute.SuspendInstancesRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroupManagers/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_rest_required_fields(
    request_type=compute.UpdateRegionInstanceGroupManagerRequest,
):
    transport_class = transports.RegionInstanceGroupManagersRestTransport
...
def test_adopt_instances_rest_bad_request(
    request_type=compute.AdoptInstancesRegionInstanceGroupManagerRequest,
):
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_adopt_instances_rest_call_success(request_type):
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    request_init["region_instance_group_managers_adopt_instances_request_resource"] = {
        "instances": [
            {
                "fingerprint": "fingerprint_value",
                "name": "name_value",
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.AdoptInstancesRegionInstanceGroupManagerRequest.meta.fields[
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_adopt_instances_rest_interceptors(null_interceptor):
    transport = transports.RegionInstanceGroupManagersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with mock.patch.object(
        ...
        transports.RegionInstanceGroupManagersRestInterceptor, "post_adopt_instances"
    ) as post, mock.patch.object(
        transports.RegionInstanceGroupManagersRestInterceptor,
        "post_adopt_instances_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.RegionInstanceGroupManagersRestInterceptor, "pre_adopt_instances"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AdoptInstancesRegionInstanceGroupManagerRequest.pb(
            compute.AdoptInstancesRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_resize_advanced_rest_call_success(request_type):
    ...
    request_init["region_instance_group_managers_resize_advanced_request_resource"] = {
        "no_creation_retries": True,
        "target_size": 1185,
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
...
def test_resize_advanced_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionInstanceGroupManagersRestInterceptor, "post_resize_advanced"
    ) as post, mock.patch.object(
        transports.RegionInstanceGroupManagersRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ResizeAdvancedRegionInstanceGroupManagerRequest.pb(
            compute.ResizeAdvancedRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_resume_instances_rest_call_success(request_type):
    ...
    request_init["region_instance_group_managers_resume_instances_request_resource"] = {
        "instances": ["instances_value1", "instances_value2"]
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
...
def test_resume_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ResumeInstancesRegionInstanceGroupManagerRequest.pb(
            compute.ResumeInstancesRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_auto_healing_policies_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = (
        compute.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest.meta.fields[
...
def test_start_instances_rest_call_success(request_type):
    ...
    request_init["region_instance_group_managers_start_instances_request_resource"] = {
        "instances": ["instances_value1", "instances_value2"]
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
...
def test_start_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionInstanceGroupManagersRestInterceptor, "post_start_instances"
    ) as post, mock.patch.object(
        transports.RegionInstanceGroupManagersRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.StartInstancesRegionInstanceGroupManagerRequest.pb(
            compute.StartInstancesRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_stop_instances_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.StopInstancesRegionInstanceGroupManagerRequest.meta.fields[
...
def test_stop_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.StopInstancesRegionInstanceGroupManagerRequest.pb(
            compute.StopInstancesRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_suspend_instances_rest_call_success(request_type):
    ...
    ] = {"force_suspend": True, "instances": ["instances_value1", "instances_value2"]}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_suspend_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionInstanceGroupManagersRestInterceptor, "post_suspend_instances"
    ) as post, mock.patch.object(
        transports.RegionInstanceGroupManagersRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SuspendInstancesRegionInstanceGroupManagerRequest.pb(
            compute.SuspendInstancesRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = (
        compute.TestIamPermissionsRegionInstanceGroupManagerRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionInstanceGroupManagerRequest.pb(
            compute.TestIamPermissionsRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateRegionInstanceGroupManagerRequest.meta.fields[
        "instance_group_manager_resource"
    ]
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionInstanceGroupManagersRestInterceptor, "post_update"
    ) as post, mock.patch.object(
        transports.RegionInstanceGroupManagersRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateRegionInstanceGroupManagerRequest.pb(
            compute.UpdateRegionInstanceGroupManagerRequest()
        )
        transcode.return_value = {
            "method": "post",
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_adopt_instances_unary_empty_call_rest():
    client = RegionInstanceGroupManagersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport.adopt_instances), "__call__") as call:
        client.adopt_instances_unary(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.AdoptInstancesRegionInstanceGroupManagerRequest()
...
def test_region_instance_group_managers_client_transport_session_collision(
    ...
    session1 = client1.transport.adopt_instances._session
    session2 = client2.transport.adopt_instances._session
    assert session1 != session2

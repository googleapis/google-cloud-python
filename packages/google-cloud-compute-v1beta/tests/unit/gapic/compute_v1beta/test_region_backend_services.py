...
from google.cloud.compute_v1beta.services.region_backend_services import RegionBackendServicesClient, pagers, transports
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/{backend_service}" % client.transport._host, args[1]
        )
...
def test_get_health_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/{backend_service}/getHealth" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/listUsable" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/{backend_service}/setSecurityPolicy" % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendServices/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["backend_service_resource"] = {
        ...
        "circuit_breakers": {
            "connect_timeout": {"nanos": 543, "seconds": 751},
            "max_connections": 1608,
        ...
        "consistent_hash": {
            "http_cookie": {"name": "name_value", "path": "path_value", "ttl": {}},
        ...
        "name": "name_value",
        "network": "network_value",
        "network_pass_through_lb_traffic_policy": {"zonal_affinity": {"spillover": "spillover_value", "spillover_ratio": 0.163}},
        "outlier_detection": {
            "base_ejection_time": {},
        ...
        "subsetting": {"policy": "policy_value", "subset_size": 1200},
        "timeout_sec": 1185,
        "tls_settings": {
...
def test_region_backend_services_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.region_backend_services.transports.RegionBackendServicesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

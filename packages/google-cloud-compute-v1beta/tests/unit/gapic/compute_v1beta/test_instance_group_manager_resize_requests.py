...
def test_cancel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}/cancel"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}"
            % client.transport._host,
            args[1],
        )
...
def test_instance_group_manager_resize_requests_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.instance_group_manager_resize_requests.transports.InstanceGroupManagerResizeRequestsTransport.__init__"
    ) as Transport:

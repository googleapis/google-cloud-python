...
from google.cloud.compute_v1beta.services.region_operations import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionOperationsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionOperationsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionOperationsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RegionOperationsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RegionOperationsClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        RegionOperationsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        RegionOperationsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        RegionOperationsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionOperationsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                RegionOperationsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionOperationsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionOperationsClient._DEFAULT_UNIVERSE
    default_endpoint = RegionOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        RegionOperationsClient._get_api_endpoint(
    ...
    assert (
        RegionOperationsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        RegionOperationsClient._get_api_endpoint(None, None, default_universe, "always")
        == RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionOperationsClient._get_api_endpoint(
    ...
    assert (
        RegionOperationsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        RegionOperationsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        RegionOperationsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionOperationsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionOperationsClient._get_universe_domain(None, None)
        == RegionOperationsClient._DEFAULT_UNIVERSE
    )
...
def test_region_operations_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_region_operations_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    RegionOperationsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RegionOperationsClient),
)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/operations/{operation}"
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/operations"
            % client.transport._host,
            args[1],
        )
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/operations/{operation}/wait"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionOperationsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.RegionOperationsRestInterceptor(),
    )
    client = RegionOperationsClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionOperationsRestInterceptor, "post_delete"
        ) as post,
        mock.patch.object(
        ...
        pb_message = compute.DeleteRegionOperationRequest.pb(
            compute.DeleteRegionOperationRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.DeleteRegionOperationResponse.to_json(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionOperationsRestInterceptor, "post_get"
        ) as post,
        mock.patch.object(
            transports.RegionOperationsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionOperationsRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionOperationRequest.pb(
            compute.GetRegionOperationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionOperationsRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionOperationsRequest.pb(
            compute.ListRegionOperationsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionOperationsRestInterceptor, "post_wait"
        ) as post,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.WaitRegionOperationRequest.pb(
            compute.WaitRegionOperationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_region_operations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_operations.transports.RegionOperationsTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.region_operations import RegionOperationsClient, pagers, transports
...
def test__read_environment_variables():
    assert RegionOperationsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionOperationsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                RegionOperationsClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert RegionOperationsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RegionOperationsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RegionOperationsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RegionOperationsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RegionOperationsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RegionOperationsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                RegionOperationsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert RegionOperationsClient._get_client_cert_source(None, False) is None
    assert RegionOperationsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RegionOperationsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert RegionOperationsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RegionOperationsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(RegionOperationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionOperationsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionOperationsClient._DEFAULT_UNIVERSE
    default_endpoint = RegionOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RegionOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RegionOperationsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        RegionOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RegionOperationsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RegionOperationsClient._get_api_endpoint(None, None, default_universe, "always") == RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        RegionOperationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegionOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RegionOperationsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RegionOperationsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RegionOperationsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RegionOperationsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RegionOperationsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RegionOperationsClient._get_universe_domain(None, None) == RegionOperationsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        RegionOperationsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionOperationsClient(credentials=cred)
...
@pytest.mark.parametrize("client_class", [RegionOperationsClient])
@mock.patch.object(RegionOperationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionOperationsClient))
def test_region_operations_client_client_api_endpoint(client_class):
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/operations/{operation}" % client.transport._host, args[1])
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/operations" % client.transport._host, args[1])
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/operations/{operation}/wait" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = RegionOperationsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_delete_rest_bad_request(request_type=compute.DeleteRegionOperationRequest):
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionOperationsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegionOperationsRestInterceptor(),
    )
    client = RegionOperationsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionOperationsRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "pre_delete"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.DeleteRegionOperationResponse.to_json(compute.DeleteRegionOperationResponse())
        ...
        post_with_metadata.return_value = compute.DeleteRegionOperationResponse(), metadata
...
def test_get_rest_bad_request(request_type=compute.GetRegionOperationRequest):
    client = RegionOperationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "operation": "sample3"}
    request = request_type(**request_init)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionOperationsRestInterceptor, "post_get") as post, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "pre_get"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_bad_request(request_type=compute.ListRegionOperationsRequest):
    client = RegionOperationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionOperationsRestInterceptor, "post_list") as post, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "pre_list"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_wait_rest_bad_request(request_type=compute.WaitRegionOperationRequest):
    client = RegionOperationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "operation": "sample3"}
    request = request_type(**request_init)
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionOperationsRestInterceptor, "post_wait") as post, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "post_wait_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionOperationsRestInterceptor, "pre_wait"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        request_msg = compute.DeleteRegionOperationRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRegionOperationRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListRegionOperationsRequest()
...
def test_wait_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.wait), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.WaitRegionOperationRequest()
...
def test_region_operations_base_transport():
    ...
    with mock.patch("google.cloud.compute_v1beta.services.region_operations.transports.RegionOperationsTransport.__init__") as Transport:
...
def test_region_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.region_operations.transports.RegionOperationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_region_operations_client_transport_session_collision(transport_name):
    ...
    client1 = RegionOperationsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RegionOperationsClient(
        credentials=creds2,
        transport=transport_name,
    )

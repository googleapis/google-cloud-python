...
from google.cloud.compute_v1beta.services.global_operations import (
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/operations"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/operations/{operation}"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/operations"
            % client.transport._host,
            args[1],
        )
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/operations/{operation}/wait"
            % client.transport._host,
            args[1],
        )
...
def test_global_operations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.global_operations.transports.GlobalOperationsTransport.__init__"
    ) as Transport:

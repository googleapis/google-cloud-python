...
from google.cloud.compute_v1beta.services.global_operations import GlobalOperationsClient, pagers, transports
...
def test_global_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.global_operations.transports.GlobalOperationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
from google.cloud.compute_v1beta.services.region_ssl_certificates import (
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/sslCertificates/{ssl_certificate}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/sslCertificates"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionSslCertificateRequest,
):
    transport_class = transports.RegionSslCertificatesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/sslCertificates/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionSslCertificateRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionSslCertificatesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.RegionSslCertificatesRestInterceptor,
        "post_test_iam_permissions_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.RegionSslCertificatesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionSslCertificateRequest.pb(
            compute.TestIamPermissionsRegionSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_region_ssl_certificates_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_ssl_certificates.transports.RegionSslCertificatesTransport.__init__"
    ) as Transport:
...
def test_region_ssl_certificates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1beta.services.region_ssl_certificates.transports.RegionSslCertificatesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

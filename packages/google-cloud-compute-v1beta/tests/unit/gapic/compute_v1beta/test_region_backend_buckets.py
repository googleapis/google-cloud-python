...
from google.cloud.compute_v1beta.services.region_backend_buckets import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionBackendBucketsClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionBackendBucketsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionBackendBucketsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RegionBackendBucketsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__read_environment_variables():
    assert RegionBackendBucketsClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                RegionBackendBucketsClient._read_environment_variables()
            assert (
                str(excinfo.value)
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RegionBackendBucketsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RegionBackendBucketsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                RegionBackendBucketsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert RegionBackendBucketsClient._get_client_cert_source(None, False) is None
    assert (
        RegionBackendBucketsClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionBackendBucketsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionBackendBucketsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionBackendBucketsClient._DEFAULT_UNIVERSE
    default_endpoint = RegionBackendBucketsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionBackendBucketsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        RegionBackendBucketsClient._get_api_endpoint(
    ...
    assert (
        ...
        == RegionBackendBucketsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionBackendBucketsClient._get_api_endpoint(
    ...
    assert (
        RegionBackendBucketsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        RegionBackendBucketsClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        RegionBackendBucketsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionBackendBucketsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionBackendBucketsClient._get_universe_domain(None, None)
        == RegionBackendBucketsClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        RegionBackendBucketsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = RegionBackendBucketsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (RegionBackendBucketsClient, "rest"),
    ],
)
def test_region_backend_buckets_client_from_service_account_info(
    client_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.RegionBackendBucketsRestTransport, "rest"),
    ],
)
def test_region_backend_buckets_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_region_backend_buckets_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_region_backend_buckets_client_get_transport_class():
    transport = RegionBackendBucketsClient.get_transport_class()
    available_transports = [
        transports.RegionBackendBucketsRestTransport,
    ]
    assert transport in available_transports

    transport = RegionBackendBucketsClient.get_transport_class("rest")
    assert transport == transports.RegionBackendBucketsRestTransport
...
def test_region_backend_buckets_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(RegionBackendBucketsClient, "get_transport_class") as gtc:
...
def test_region_backend_buckets_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize("client_class", [RegionBackendBucketsClient])
@mock.patch.object(
    RegionBackendBucketsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RegionBackendBucketsClient),
)
def test_region_backend_buckets_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_region_backend_buckets_client_client_api_endpoint(client_class):
...
def test_region_backend_buckets_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_region_backend_buckets_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_delete_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RegionBackendBucketsClient(
            credentials=ga_credentials.AnonymousCredentials(),
            transport="rest",
        )
...
def test_delete_rest_required_fields(
    request_type=compute.DeleteRegionBackendBucketRequest,
):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_delete_rest_unset_required_fields():
    transport = transports.RegionBackendBucketsRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendBuckets/{backend_bucket}"
...
def test_delete_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.delete(
            compute.DeleteRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            backend_bucket="backend_bucket_value",
        )
...
def test_get_rest_required_fields(request_type=compute.GetRegionBackendBucketRequest):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_get_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.get(
            compute.GetRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            backend_bucket="backend_bucket_value",
        )
...
def test_get_iam_policy_rest_required_fields(
    request_type=compute.GetIamPolicyRegionBackendBucketRequest,
):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendBuckets/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.get_iam_policy(
            compute.GetIamPolicyRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            resource="resource_value",
        )
...
def test_insert_rest_required_fields(
    request_type=compute.InsertRegionBackendBucketRequest,
):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendBuckets"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.insert(
            compute.InsertRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            backend_bucket_resource=compute.BackendBucket(
                bucket_name="bucket_name_value"
...
def test_list_rest_required_fields(
    request_type=compute.ListRegionBackendBucketsRequest,
):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListRegionBackendBucketsRequest(),
            project="project_value",
            region="region_value",
        )
...
def test_list_usable_rest_required_fields(
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.BackendBucketListUsable()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.BackendBucketListUsable.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendBuckets/listUsable"
            % client.transport._host,
            args[1],
        )
...
def test_list_usable_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list_usable(
            compute.ListUsableRegionBackendBucketsRequest(),
            project="project_value",
            region="region_value",
        )
...
def test_list_usable_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(compute.BackendBucketListUsable.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_patch_rest_required_fields(
    request_type=compute.PatchRegionBackendBucketRequest,
):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_patch_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.patch(
            compute.PatchRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            backend_bucket="backend_bucket_value",
            backend_bucket_resource=compute.BackendBucket(
...
def test_set_iam_policy_rest_required_fields(
    request_type=compute.SetIamPolicyRegionBackendBucketRequest,
):
    transport_class = transports.RegionBackendBucketsRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendBuckets/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.set_iam_policy(
            compute.SetIamPolicyRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            resource="resource_value",
            region_set_policy_request_resource=compute.RegionSetPolicyRequest(
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/backendBuckets/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.test_iam_permissions(
            compute.TestIamPermissionsRegionBackendBucketRequest(),
            project="project_value",
            region="region_value",
            resource="resource_value",
            test_permissions_request_resource=compute.TestPermissionsRequest(
...
def test_delete_rest_bad_request(request_type=compute.DeleteRegionBackendBucketRequest):
    client = RegionBackendBucketsClient(
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionBackendBucketsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.RegionBackendBucketsRestInterceptor(),
    )
    client = RegionBackendBucketsClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        pb_message = compute.DeleteRegionBackendBucketRequest.pb(
            compute.DeleteRegionBackendBucketRequest()
        )
        ...
        request = compute.DeleteRegionBackendBucketRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_get_rest_bad_request(request_type=compute.GetRegionBackendBucketRequest):
    client = RegionBackendBucketsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionBackendBucketRequest.pb(
            compute.GetRegionBackendBucketRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.GetRegionBackendBucketRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyRegionBackendBucketRequest.pb(
            compute.GetIamPolicyRegionBackendBucketRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.GetIamPolicyRegionBackendBucketRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_insert_rest_bad_request(request_type=compute.InsertRegionBackendBucketRequest):
    client = RegionBackendBucketsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertRegionBackendBucketRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionBackendBucketRequest.pb(
            compute.InsertRegionBackendBucketRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.InsertRegionBackendBucketRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_list_rest_bad_request(request_type=compute.ListRegionBackendBucketsRequest):
    client = RegionBackendBucketsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionBackendBucketsRequest.pb(
            compute.ListRegionBackendBucketsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.ListRegionBackendBucketsRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListUsableRegionBackendBucketsRequest.pb(
            compute.ListUsableRegionBackendBucketsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendBucketListUsable.to_json(
            compute.BackendBucketListUsable()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = compute.BackendBucketListUsable()
        post_with_metadata.return_value = compute.BackendBucketListUsable(), metadata
...
def test_patch_rest_bad_request(request_type=compute.PatchRegionBackendBucketRequest):
    client = RegionBackendBucketsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRegionBackendBucketRequest.meta.fields[
        "backend_bucket_resource"
    ]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRegionBackendBucketRequest.pb(
            compute.PatchRegionBackendBucketRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.PatchRegionBackendBucketRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyRegionBackendBucketRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyRegionBackendBucketRequest.pb(
            compute.SetIamPolicyRegionBackendBucketRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.SetIamPolicyRegionBackendBucketRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionBackendBucketRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionBackendBucketRequest.pb(
            compute.TestIamPermissionsRegionBackendBucketRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        request_msg = compute.DeleteRegionBackendBucketRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetRegionBackendBucketRequest()
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyRegionBackendBucketRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertRegionBackendBucketRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListRegionBackendBucketsRequest()
...
def test_list_usable_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list_usable), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListUsableRegionBackendBucketsRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchRegionBackendBucketRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyRegionBackendBucketRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsRegionBackendBucketRequest()

        assert args[0] == request_msg


def test_region_backend_buckets_base_transport_error():
...
def test_region_backend_buckets_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_backend_buckets.transports.RegionBackendBucketsTransport.__init__"
    ) as Transport:
...
def test_region_backend_buckets_auth_adc():
...
def test_region_backend_buckets_http_transport_client_cert_source_for_mtls():
...
def test_region_backend_buckets_host_no_port(transport_name):
    client = RegionBackendBucketsClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_region_backend_buckets_host_with_port(transport_name):
    client = RegionBackendBucketsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
...
def test_region_backend_buckets_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = RegionBackendBucketsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RegionBackendBucketsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_common_billing_account_path():
    ...
    actual = RegionBackendBucketsClient.common_billing_account_path(billing_account)
...
def test_parse_common_billing_account_path():
    ...
    path = RegionBackendBucketsClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionBackendBucketsClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = RegionBackendBucketsClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = RegionBackendBucketsClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionBackendBucketsClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = RegionBackendBucketsClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = RegionBackendBucketsClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionBackendBucketsClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = RegionBackendBucketsClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = RegionBackendBucketsClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionBackendBucketsClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = RegionBackendBucketsClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = RegionBackendBucketsClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = RegionBackendBucketsClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.RegionBackendBucketsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = RegionBackendBucketsClient(
            credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        transport_class = RegionBackendBucketsClient.get_transport_class()
...
@pytest.mark.parametrize(
    ...
    [
        (RegionBackendBucketsClient, transports.RegionBackendBucketsRestTransport),
    ],
)

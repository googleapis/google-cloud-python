...
from google.cloud.compute_v1beta.services.machine_images import (
    MachineImagesClient,
    pagers,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        MachineImagesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/machineImages/{machine_image}"
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/machineImages/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/machineImages"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/machineImages/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_required_fields(
    request_type=compute.SetLabelsMachineImageRequest,
):
    transport_class = transports.MachineImagesRestTransport
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/machineImages/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/machineImages/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsMachineImageRequest.meta.fields[
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.MachineImagesRestInterceptor, "post_set_labels"
        ) as post,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetLabelsMachineImageRequest.pb(
            compute.SetLabelsMachineImageRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.MachineImagesRestInterceptor,
...
def test_machine_images_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.machine_images.transports.MachineImagesTransport.__init__"
    ) as Transport:

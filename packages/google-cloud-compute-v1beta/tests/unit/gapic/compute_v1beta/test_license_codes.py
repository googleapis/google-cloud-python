...
from google.cloud.compute_v1beta.services.license_codes import (
    LicenseCodesClient,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        LicenseCodesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        LicenseCodesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        LicenseCodesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                LicenseCodesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                LicenseCodesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(LicenseCodesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LicenseCodesClient._DEFAULT_UNIVERSE
    default_endpoint = LicenseCodesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = LicenseCodesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        LicenseCodesClient._get_api_endpoint(
    ...
    assert (
        ...
        == LicenseCodesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LicenseCodesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        LicenseCodesClient._get_api_endpoint(None, None, default_universe, "always")
        == LicenseCodesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LicenseCodesClient._get_api_endpoint(
    ...
    assert (
        LicenseCodesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        LicenseCodesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        LicenseCodesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        LicenseCodesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        LicenseCodesClient._get_universe_domain(None, None)
        == LicenseCodesClient._DEFAULT_UNIVERSE
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/licenseCodes/{license_code}"
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/licenseCodes/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_required_fields(
    request_type=compute.SetIamPolicyLicenseCodeRequest,
):
    transport_class = transports.LicenseCodesRestTransport
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/licenseCodes/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/licenseCodes/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.LicenseCodesRestInterceptor, "post_get_iam_policy"
        ) as post,
        mock.patch.object(
            transports.LicenseCodesRestInterceptor, "post_get_iam_policy_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.LicenseCodesRestInterceptor, "pre_get_iam_policy"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetIamPolicyLicenseCodeRequest.pb(
            compute.GetIamPolicyLicenseCodeRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_set_iam_policy_rest_call_success(request_type):
    ...
    test_field = compute.SetIamPolicyLicenseCodeRequest.meta.fields[
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.LicenseCodesRestInterceptor, "post_set_iam_policy"
        ) as post,
        mock.patch.object(
            transports.LicenseCodesRestInterceptor, "post_set_iam_policy_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.LicenseCodesRestInterceptor, "pre_set_iam_policy"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetIamPolicyLicenseCodeRequest.pb(
            compute.SetIamPolicyLicenseCodeRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.LicenseCodesRestInterceptor,
...
def test_get_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetIamPolicyLicenseCodeRequest()
...
def test_set_iam_policy_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.set_iam_policy), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetIamPolicyLicenseCodeRequest()
...
def test_license_codes_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.license_codes.transports.LicenseCodesTransport.__init__"
    ) as Transport:

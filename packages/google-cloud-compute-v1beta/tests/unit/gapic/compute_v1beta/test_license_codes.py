...
from google.cloud.compute_v1beta.services.license_codes import LicenseCodesClient, transports
...
def test__read_environment_variables():
    assert LicenseCodesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LicenseCodesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert LicenseCodesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LicenseCodesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LicenseCodesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LicenseCodesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert LicenseCodesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert LicenseCodesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                LicenseCodesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert LicenseCodesClient._get_client_cert_source(None, False) is None
    assert LicenseCodesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LicenseCodesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert LicenseCodesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LicenseCodesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(LicenseCodesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseCodesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LicenseCodesClient._DEFAULT_UNIVERSE
    default_endpoint = LicenseCodesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LicenseCodesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LicenseCodesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert LicenseCodesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == LicenseCodesClient.DEFAULT_MTLS_ENDPOINT
    assert LicenseCodesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert LicenseCodesClient._get_api_endpoint(None, None, default_universe, "always") == LicenseCodesClient.DEFAULT_MTLS_ENDPOINT
    assert LicenseCodesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == LicenseCodesClient.DEFAULT_MTLS_ENDPOINT
    assert LicenseCodesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LicenseCodesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LicenseCodesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LicenseCodesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LicenseCodesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LicenseCodesClient._get_universe_domain(None, None) == LicenseCodesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        LicenseCodesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = LicenseCodesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class", [LicenseCodesClient])
@mock.patch.object(LicenseCodesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseCodesClient))
def test_license_codes_client_client_api_endpoint(client_class):
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/global/licenseCodes/{license_code}" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/licenseCodes/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = LicenseCodesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_rest_bad_request(request_type=compute.GetLicenseCodeRequest):
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.LicenseCodesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.LicenseCodesRestInterceptor, "post_get_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.LicenseCode.to_json(compute.LicenseCode())
        ...
        post_with_metadata.return_value = compute.LicenseCode(), metadata
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsLicenseCodeRequest):
    client = LicenseCodesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicenseCodesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.LicenseCodesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        request_msg = compute.GetLicenseCodeRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsLicenseCodeRequest()
...
def test_license_codes_base_transport():
    ...
    with mock.patch("google.cloud.compute_v1beta.services.license_codes.transports.LicenseCodesTransport.__init__") as Transport:
...
def test_license_codes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.license_codes.transports.LicenseCodesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
from google.cloud.compute_v1beta.services.region_instance_groups import (
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroups/{instance_group}"
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroups"
            % client.transport._host,
            args[1],
        )
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroups/{instance_group}/listInstances"
            % client.transport._host,
            args[1],
        )
...
def test_set_named_ports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroups/{instance_group}/setNamedPorts"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceGroups/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_region_instance_groups_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_instance_groups.transports.RegionInstanceGroupsTransport.__init__"
    ) as Transport:
...
def test_region_instance_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1beta.services.region_instance_groups.transports.RegionInstanceGroupsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

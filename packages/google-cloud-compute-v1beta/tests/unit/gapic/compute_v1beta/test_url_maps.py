...
from google.cloud.compute_v1beta.services.url_maps import UrlMapsClient, pagers, transports
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/urlMaps" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/urlMaps/{url_map}" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/urlMaps" % client.transport._host, args[1])
...
def test_invalidate_cache_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/urlMaps/{url_map}/invalidateCache" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsUrlMapRequest):
    transport_class = transports.UrlMapsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/urlMaps/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/urlMaps/{url_map}/validate" % client.transport._host, args[1])
...
def test_transport_kind_rest():
    transport = UrlMapsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_invalidate_cache_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_invalidate_cache") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsUrlMapRequest):
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsUrlMapRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.UrlMapsRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.UrlMapsRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsUrlMapRequest.pb(compute.TestIamPermissionsUrlMapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_update") as post, mock.patch.object(
...
def test_validate_rest_call_success(request_type):
    ...
    request_init["url_maps_validate_request_resource"] = {
        "load_balancing_schemes": ["load_balancing_schemes_value1", "load_balancing_schemes_value2"],
        "resource": {
            "creation_timestamp": "creation_timestamp_value",
            "default_custom_error_response_policy": {
                "error_response_rules": [
...
def test_validate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, "post_validate") as post, mock.patch.object(
...
def test_url_maps_base_transport():
    ...
    with mock.patch("google.cloud.compute_v1beta.services.url_maps.transports.UrlMapsTransport.__init__") as Transport:
...
def test_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.url_maps.transports.UrlMapsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

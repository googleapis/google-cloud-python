...
from google.cloud.compute_v1beta.services.backend_services import BackendServicesClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        BackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        BackendServicesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == BackendServicesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_add_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/addSignedUrlKey" % client.transport._host, args[1]
        )
...
def test_delete_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/deleteSignedUrlKey" % client.transport._host, args[1]
        )
...
def test_get_effective_security_policies_rest_required_fields(request_type=compute.GetEffectiveSecurityPoliciesBackendServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_effective_security_policies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_effective_security_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/getEffectiveSecurityPolicies" % client.transport._host,
            args[1],
        )
...
def test_get_health_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/getHealth" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_edge_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/setEdgeSecurityPolicy" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/setSecurityPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = BackendServicesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_add_signed_url_key_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_add_signed_url_key") as post, mock.patch.object(
        transports.BackendServicesRestInterceptor, "post_add_signed_url_key_with_metadata"
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_delete_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_delete_signed_url_key") as post, mock.patch.object(
        transports.BackendServicesRestInterceptor, "post_delete_signed_url_key_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_get_effective_security_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_effective_security_policies") as post, mock.patch.object(
        transports.BackendServicesRestInterceptor, "post_get_effective_security_policies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendServicesGetEffectiveSecurityPoliciesResponse.to_json(
...
def test_get_health_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_health") as post, mock.patch.object(
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_list_usable") as post, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_set_edge_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_edge_security_policy") as post, mock.patch.object(
        transports.BackendServicesRestInterceptor, "post_set_edge_security_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
...
def test_set_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_security_policy") as post, mock.patch.object(
        transports.BackendServicesRestInterceptor, "post_set_security_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.BackendServicesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendServicesRestInterceptor, "post_update") as post, mock.patch.object(

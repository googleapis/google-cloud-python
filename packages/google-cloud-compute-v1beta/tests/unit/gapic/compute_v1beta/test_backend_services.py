...
from google.cloud.compute_v1beta.services.backend_services import (
...
def test_add_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/addSignedUrlKey"
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/backendServices"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/deleteSignedUrlKey"
            % client.transport._host,
            args[1],
        )
...
def test_get_effective_security_policies_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = (
                compute.BackendServicesGetEffectiveSecurityPoliciesResponse.pb(
                    return_value
                )
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_effective_security_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = compute.BackendServicesGetEffectiveSecurityPoliciesResponse.pb(
            return_value
        )
        json_return_value = json_format.MessageToJson(return_value)
        response_value._content = json_return_value.encode("UTF-8")
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/getEffectiveSecurityPolicies"
            % client.transport._host,
            args[1],
        )
...
def test_get_health_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/getHealth"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices"
            % client.transport._host,
            args[1],
        )
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/listUsable"
            % client.transport._host,
            args[1],
        )
...
def test_set_edge_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/setEdgeSecurityPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{backend_service}/setSecurityPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendServices/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_get_effective_security_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = (
            compute.BackendServicesGetEffectiveSecurityPoliciesResponse.to_json(
...
def test_backend_services_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.backend_services.transports.BackendServicesTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.public_delegated_prefixes import PublicDelegatedPrefixesClient, pagers, transports
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/publicDelegatedPrefixes" % client.transport._host, args[1])
...
def test_announce_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/announce" % client.transport._host,
            args[1],
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}" % client.transport._host, args[1]
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes" % client.transport._host, args[1])
...
def test_withdraw_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/withdraw" % client.transport._host,
            args[1],
        )
...
def test_announce_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.announce), "__call__") as call:
...
def test_withdraw_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.withdraw), "__call__") as call:
...
def test_public_delegated_prefixes_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport.__init__"
    ) as Transport:
...
def test_public_delegated_prefixes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

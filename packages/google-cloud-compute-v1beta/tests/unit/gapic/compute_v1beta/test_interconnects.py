...
from google.cloud.compute_v1beta.services.interconnects import InterconnectsClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        InterconnectsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == InterconnectsClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_get_diagnostics_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnects/{interconnect}/getDiagnostics" % client.transport._host, args[1]
        )
...
def test_get_macsec_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnects/{interconnect}/getMacsecConfig" % client.transport._host, args[1]
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnects/{resource}/setLabels" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnects/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = InterconnectsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_get_diagnostics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_diagnostics") as post, mock.patch.object(
...
def test_get_macsec_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_get_macsec_config") as post, mock.patch.object(
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["interconnect_resource"] = {
        ...
        "application_aware_interconnect": {
            "bandwidth_percentage_policy": {"bandwidth_percentages": [{"percentage": 1054, "traffic_class": "traffic_class_value"}]},
        ...
        "expected_outages": [
            {
                "affected_circuits": ["affected_circuits_value1", "affected_circuits_value2"],
                "description": "description_value",
                "end_time": 837,
        ...
        "google_reference_id": "google_reference_id_value",
        "id": 205,
        "interconnect_attachments": ["interconnect_attachments_value1", "interconnect_attachments_value2"],
        "interconnect_groups": ["interconnect_groups_value1", "interconnect_groups_value2"],
        "interconnect_type": "interconnect_type_value",
        "kind": "kind_value",
        "label_fingerprint": "label_fingerprint_value",
        "labels": {},
        "link_type": "link_type_value",
        "location": "location_value",
        "macsec": {"fail_open": True, "pre_shared_keys": [{"name": "name_value", "start_time": "start_time_value"}]},
        "macsec_enabled": True,
        "name": "name_value",
        "noc_contact_email": "noc_contact_email_value",
        "operational_status": "operational_status_value",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_set_labels") as post, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectsRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.InterconnectsRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InterconnectsRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_diagnostics_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_diagnostics), "__call__") as call:
...
def test_get_macsec_config_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_macsec_config), "__call__") as call:
...
def test_interconnects_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.interconnects.transports.InterconnectsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

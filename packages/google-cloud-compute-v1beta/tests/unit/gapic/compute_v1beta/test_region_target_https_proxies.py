...
from google.cloud.compute_v1beta.services.region_target_https_proxies import (
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    RegionTargetHttpsProxiesClient._use_client_cert_effective() is False
                )
...
def test__get_universe_domain():
    ...
    assert (
        RegionTargetHttpsProxiesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionTargetHttpsProxiesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionTargetHttpsProxiesClient._get_universe_domain(None, None)
        == RegionTargetHttpsProxiesClient._DEFAULT_UNIVERSE
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies"
            % client.transport._host,
            args[1],
        )
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setSslCertificates"
            % client.transport._host,
            args[1],
        )
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setUrlMap"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionTargetHttpsProxyRequest,
):
    transport_class = transports.RegionTargetHttpsProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionTargetHttpsProxyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionTargetHttpsProxyRequest.pb(
            compute.TestIamPermissionsRegionTargetHttpsProxyRequest()
        )
        transcode.return_value = {
            "method": "post",

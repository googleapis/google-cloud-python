...
from google.cloud.compute_v1beta.services.region_target_https_proxies import RegionTargetHttpsProxiesClient, pagers, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert RegionTargetHttpsProxiesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RegionTargetHttpsProxiesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RegionTargetHttpsProxiesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                RegionTargetHttpsProxiesClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        RegionTargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RegionTargetHttpsProxiesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        RegionTargetHttpsProxiesClient._get_api_endpoint(None, None, default_universe, "always")
        == RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionTargetHttpsProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegionTargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}" % client.transport._host, args[1]
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            region="region_value",
            target_https_proxy_resource=compute.TargetHttpsProxy(authentication="authentication_value"),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies" % client.transport._host, args[1])
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setSslCertificates" % client.transport._host,
            args[1],
        )
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setUrlMap" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsRegionTargetHttpsProxyRequest):
    transport_class = transports.RegionTargetHttpsProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetHttpsProxies/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = RegionTargetHttpsProxiesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_delete_with_metadata"
...
def test_get_rest_call_success(request_type):
    ...
    assert response.authentication == "authentication_value"
    assert response.authorization == "authorization_value"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_patch") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_patch_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_ssl_certificates") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_ssl_certificates_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_url_map") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_set_url_map_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsRegionTargetHttpsProxyRequest):
    client = RegionTargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionTargetHttpsProxyRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionTargetHttpsProxiesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionTargetHttpsProxiesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionTargetHttpsProxyRequest.pb(compute.TestIamPermissionsRegionTargetHttpsProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsRegionTargetHttpsProxyRequest()
...
def test_region_target_https_proxies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_target_https_proxies.transports.RegionTargetHttpsProxiesTransport.__init__"
    ) as Transport:
...
def test_region_target_https_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.region_target_https_proxies.transports.RegionTargetHttpsProxiesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

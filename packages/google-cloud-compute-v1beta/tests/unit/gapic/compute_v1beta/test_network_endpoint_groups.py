...
from google.cloud.compute_v1beta.services.network_endpoint_groups import NetworkEndpointGroupsClient, pagers, transports
...
def test__read_environment_variables():
    assert NetworkEndpointGroupsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert NetworkEndpointGroupsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert NetworkEndpointGroupsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert NetworkEndpointGroupsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert NetworkEndpointGroupsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert NetworkEndpointGroupsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert NetworkEndpointGroupsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                NetworkEndpointGroupsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert NetworkEndpointGroupsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert NetworkEndpointGroupsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert NetworkEndpointGroupsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert NetworkEndpointGroupsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(NetworkEndpointGroupsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NetworkEndpointGroupsClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NetworkEndpointGroupsClient._DEFAULT_UNIVERSE
    default_endpoint = NetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = NetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert NetworkEndpointGroupsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        NetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == NetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert NetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert NetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "always") == NetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        NetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == NetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert NetworkEndpointGroupsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert NetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        NetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert NetworkEndpointGroupsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert NetworkEndpointGroupsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert NetworkEndpointGroupsClient._get_universe_domain(None, None) == NetworkEndpointGroupsClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = NetworkEndpointGroupsClient(credentials=cred)
...
def test_network_endpoint_groups_client_from_service_account_info(client_class, transport_name):
...
def test_network_endpoint_groups_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (NetworkEndpointGroupsClient, transports.NetworkEndpointGroupsRestTransport, "rest", None),
    ],
)
def test_network_endpoint_groups_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListNetworkEndpointGroupsRequest):
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.NetworkEndpointGroupsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/networkEndpointGroups" % client.transport._host, args[1])
...
def test_attach_network_endpoints_rest_required_fields(request_type=compute.AttachNetworkEndpointsNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_attach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints"
...
def test_attach_network_endpoints_unary_rest_required_fields(request_type=compute.AttachNetworkEndpointsNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_delete_rest_required_fields(request_type=compute.DeleteNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}" % client.transport._host, args[1]
        )
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_detach_network_endpoints_rest_required_fields(request_type=compute.DetachNetworkEndpointsNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_detach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
def test_detach_network_endpoints_unary_rest_required_fields(request_type=compute.DetachNetworkEndpointsNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_insert_rest_required_fields(request_type=compute.InsertNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListNetworkEndpointGroupsRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_list_network_endpoints_rest_required_fields(request_type=compute.ListNetworkEndpointsNetworkEndpointGroupsRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            network_endpoint_groups_list_endpoints_request_resource=compute.NetworkEndpointGroupsListEndpointsRequest(
                endpoint_filters=[
                    compute.NetworkEndpointGroupsListEndpointsRequestNetworkEndpointFilter(
                        network_endpoint=compute.NetworkEndpoint(annotations={"key_value": "value_value"})
                    )
                ]
            ),
        )
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
def test_list_network_endpoints_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        sample_request = {"project": "sample1", "zone": "sample2", "network_endpoint_group": "sample3"}
        sample_request["network_endpoint_groups_list_endpoints_request_resource"] = compute.NetworkEndpointGroupsListEndpointsRequest(
            endpoint_filters=[
                compute.NetworkEndpointGroupsListEndpointsRequestNetworkEndpointFilter(
                    network_endpoint=compute.NetworkEndpoint(annotations={"key_value": "value_value"})
                )
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsNetworkEndpointGroupRequest):
    transport_class = transports.NetworkEndpointGroupsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = NetworkEndpointGroupsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_rest():
    transport = NetworkEndpointGroupsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListNetworkEndpointGroupsRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.NetworkEndpointGroupsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NetworkEndpointGroupsRestInterceptor(),
    )
    client = NetworkEndpointGroupsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_aggregated_list_with_metadata"
        ...
        pb_message = compute.AggregatedListNetworkEndpointGroupsRequest.pb(compute.AggregatedListNetworkEndpointGroupsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NetworkEndpointGroupAggregatedList.to_json(compute.NetworkEndpointGroupAggregatedList())
        ...
        post_with_metadata.return_value = compute.NetworkEndpointGroupAggregatedList(), metadata
...
def test_attach_network_endpoints_rest_bad_request(request_type=compute.AttachNetworkEndpointsNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_attach_network_endpoints_rest_call_success(request_type):
    ...
    test_field = compute.AttachNetworkEndpointsNetworkEndpointGroupRequest.meta.fields["network_endpoint_groups_attach_endpoints_request_resource"]
    ...
    for field, value in request_init["network_endpoint_groups_attach_endpoints_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["network_endpoint_groups_attach_endpoints_request_resource"][field])):
                    del request_init["network_endpoint_groups_attach_endpoints_request_resource"][field][i][subfield]
            else:
                del request_init["network_endpoint_groups_attach_endpoints_request_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_attach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AttachNetworkEndpointsNetworkEndpointGroupRequest.pb(compute.AttachNetworkEndpointsNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_rest_bad_request(request_type=compute.DeleteNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "network_endpoint_group": "sample3"}
    request = request_type(**request_init)
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteNetworkEndpointGroupRequest.pb(compute.DeleteNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_detach_network_endpoints_rest_bad_request(request_type=compute.DetachNetworkEndpointsNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "network_endpoint_group": "sample3"}
    request = request_type(**request_init)
...
def test_detach_network_endpoints_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.DetachNetworkEndpointsNetworkEndpointGroupRequest.meta.fields["network_endpoint_groups_detach_endpoints_request_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["network_endpoint_groups_detach_endpoints_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["network_endpoint_groups_detach_endpoints_request_resource"][field])):
                    del request_init["network_endpoint_groups_detach_endpoints_request_resource"][field][i][subfield]
            else:
                del request_init["network_endpoint_groups_detach_endpoints_request_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_detach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DetachNetworkEndpointsNetworkEndpointGroupRequest.pb(compute.DetachNetworkEndpointsNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_bad_request(request_type=compute.GetNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "network_endpoint_group": "sample3"}
    request = request_type(**request_init)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_get") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetNetworkEndpointGroupRequest.pb(compute.GetNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_insert_rest_bad_request(request_type=compute.InsertNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["network_endpoint_group_resource"] = {
        ...
        "id": 205,
        "kind": "kind_value",
        "load_balancer": {"default_port": 1289, "network": "network_value", "subnetwork": "subnetwork_value", "zone": "zone_value"},
        "name": "name_value",
        "network": "network_value",
        "network_endpoint_type": "network_endpoint_type_value",
        "psc_data": {
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.InsertNetworkEndpointGroupRequest.meta.fields["network_endpoint_group_resource"]
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertNetworkEndpointGroupRequest.pb(compute.InsertNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_bad_request(request_type=compute.ListNetworkEndpointGroupsRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2"}
    request = request_type(**request_init)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_list") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListNetworkEndpointGroupsRequest.pb(compute.ListNetworkEndpointGroupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_network_endpoints_rest_bad_request(request_type=compute.ListNetworkEndpointsNetworkEndpointGroupsRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "network_endpoint_group": "sample3"}
    request = request_type(**request_init)
...
def test_list_network_endpoints_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.ListNetworkEndpointsNetworkEndpointGroupsRequest.meta.fields["network_endpoint_groups_list_endpoints_request_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["network_endpoint_groups_list_endpoints_request_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["network_endpoint_groups_list_endpoints_request_resource"][field])):
                    del request_init["network_endpoint_groups_list_endpoints_request_resource"][field][i][subfield]
            else:
                del request_init["network_endpoint_groups_list_endpoints_request_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_list_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListNetworkEndpointsNetworkEndpointGroupsRequest.pb(compute.ListNetworkEndpointsNetworkEndpointGroupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsNetworkEndpointGroupRequest):
    client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsNetworkEndpointGroupRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.NetworkEndpointGroupsRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsNetworkEndpointGroupRequest.pb(compute.TestIamPermissionsNetworkEndpointGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListNetworkEndpointGroupsRequest()
...
def test_attach_network_endpoints_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.attach_network_endpoints), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.AttachNetworkEndpointsNetworkEndpointGroupRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteNetworkEndpointGroupRequest()
...
def test_detach_network_endpoints_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.detach_network_endpoints), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DetachNetworkEndpointsNetworkEndpointGroupRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetNetworkEndpointGroupRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertNetworkEndpointGroupRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListNetworkEndpointGroupsRequest()
...
def test_list_network_endpoints_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list_network_endpoints), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListNetworkEndpointsNetworkEndpointGroupsRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsNetworkEndpointGroupRequest()
...
def test_network_endpoint_groups_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.NetworkEndpointGroupsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_network_endpoint_groups_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.compute_v1beta.services.network_endpoint_groups.transports.NetworkEndpointGroupsTransport.__init__") as Transport:
...
def test_network_endpoint_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.network_endpoint_groups.transports.NetworkEndpointGroupsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_network_endpoint_groups_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.NetworkEndpointGroupsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = NetworkEndpointGroupsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

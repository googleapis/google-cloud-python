...
from google.cloud.compute_v1beta.services.network_endpoint_groups import (
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/networkEndpointGroups"
...
def test_attach_network_endpoints_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAttachNetworkEndpoints,
        "_BaseAttachNetworkEndpoints__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}"
            % client.transport._host,
            args[1],
        )
...
def test_detach_network_endpoints_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDetachNetworkEndpoints,
        "_BaseDetachNetworkEndpoints__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups"
            % client.transport._host,
            args[1],
        )
...
def test_list_network_endpoints_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListNetworkEndpoints,
        "_BaseListNetworkEndpoints__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
            ...
            network_endpoint_groups_list_endpoints_request_resource=compute.NetworkEndpointGroupsListEndpointsRequest(
                endpoint_filters=[
                    compute.NetworkEndpointGroupsListEndpointsRequestNetworkEndpointFilter(
                        network_endpoint=compute.NetworkEndpoint(
                            annotations={"key_value": "value_value"}
                        )
                    )
                ]
...
def test_list_network_endpoints_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        sample_request["network_endpoint_groups_list_endpoints_request_resource"] = (
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/networkEndpointGroups/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.NetworkEndpointGroupsRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NetworkEndpointGroupAggregatedList.to_json(
            compute.NetworkEndpointGroupAggregatedList()
        )
...
def test_network_endpoint_groups_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.network_endpoint_groups.transports.NetworkEndpointGroupsTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.global_forwarding_rules import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GlobalForwardingRulesClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        GlobalForwardingRulesClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        GlobalForwardingRulesClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        GlobalForwardingRulesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        GlobalForwardingRulesClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
def test__get_client_cert_source():
    ...
    assert (
        GlobalForwardingRulesClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                GlobalForwardingRulesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(GlobalForwardingRulesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GlobalForwardingRulesClient._DEFAULT_UNIVERSE
    default_endpoint = GlobalForwardingRulesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = GlobalForwardingRulesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        GlobalForwardingRulesClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        GlobalForwardingRulesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        GlobalForwardingRulesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        GlobalForwardingRulesClient._get_universe_domain(None, None)
        == GlobalForwardingRulesClient._DEFAULT_UNIVERSE
    )
...
def test_global_forwarding_rules_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_global_forwarding_rules_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_global_forwarding_rules_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_global_forwarding_rules_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    GlobalForwardingRulesClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(GlobalForwardingRulesClient),
)
...
def test_global_forwarding_rules_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_global_forwarding_rules_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/forwardingRules/{forwarding_rule}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/forwardingRules"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/forwardingRules/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_set_target_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/forwardingRules/{forwarding_rule}/setTarget"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsGlobalForwardingRuleRequest,
):
    transport_class = transports.GlobalForwardingRulesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/forwardingRules/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsGlobalForwardingRuleRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.GlobalForwardingRulesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.GlobalForwardingRulesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsGlobalForwardingRuleRequest.pb(
            compute.TestIamPermissionsGlobalForwardingRuleRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_global_forwarding_rules_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.global_forwarding_rules.transports.GlobalForwardingRulesTransport.__init__"
    ) as Transport:
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.GlobalForwardingRulesTransport, "_prep_wrapped_messages"
    ) as prep:
        client = GlobalForwardingRulesClient(
            credentials=ga_credentials.AnonymousCredentials(),

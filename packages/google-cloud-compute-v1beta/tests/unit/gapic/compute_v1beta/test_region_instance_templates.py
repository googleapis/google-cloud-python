...
from google.cloud.compute_v1beta.services.region_instance_templates import RegionInstanceTemplatesClient, pagers, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert RegionInstanceTemplatesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RegionInstanceTemplatesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RegionInstanceTemplatesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                RegionInstanceTemplatesClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        RegionInstanceTemplatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == RegionInstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RegionInstanceTemplatesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        RegionInstanceTemplatesClient._get_api_endpoint(None, None, default_universe, "always") == RegionInstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionInstanceTemplatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegionInstanceTemplatesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instanceTemplates/{instance_template}" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = RegionInstanceTemplatesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.RegionInstanceTemplatesRestInterceptor, "post_delete_with_metadata"
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.RegionInstanceTemplatesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.RegionInstanceTemplatesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionInstanceTemplatesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.RegionInstanceTemplatesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_region_instance_templates_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_instance_templates.transports.RegionInstanceTemplatesTransport.__init__"
    ) as Transport:
...
def test_region_instance_templates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.region_instance_templates.transports.RegionInstanceTemplatesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

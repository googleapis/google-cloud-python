...
from google.cloud.compute_v1beta.services.zone_operations import (
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ZoneOperationsClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ZoneOperationsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ZoneOperationsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ZoneOperationsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        ZoneOperationsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ZoneOperationsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ZoneOperationsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ZoneOperationsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ZoneOperationsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ZoneOperationsClient._DEFAULT_UNIVERSE
    default_endpoint = ZoneOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ZoneOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ZoneOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ZoneOperationsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ZoneOperationsClient._get_api_endpoint(None, None, default_universe, "always")
        == ZoneOperationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ZoneOperationsClient._get_api_endpoint(
    ...
    assert (
        ZoneOperationsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ZoneOperationsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ZoneOperationsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ZoneOperationsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ZoneOperationsClient._get_universe_domain(None, None)
        == ZoneOperationsClient._DEFAULT_UNIVERSE
    )
...
def test_zone_operations_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/operations/{operation}"
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/operations"
            % client.transport._host,
            args[1],
        )
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/operations/{operation}/wait"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.ZoneOperationsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.ZoneOperationsRestInterceptor(),
    )
    client = ZoneOperationsClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        pb_message = compute.DeleteZoneOperationRequest.pb(
            compute.DeleteZoneOperationRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.DeleteZoneOperationResponse.to_json(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetZoneOperationRequest.pb(
            compute.GetZoneOperationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListZoneOperationsRequest.pb(
            compute.ListZoneOperationsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.WaitZoneOperationRequest.pb(
            compute.WaitZoneOperationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_zone_operations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.zone_operations.transports.ZoneOperationsTransport.__init__"
    ) as Transport:
...
def test_zone_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1beta.services.zone_operations.transports.ZoneOperationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

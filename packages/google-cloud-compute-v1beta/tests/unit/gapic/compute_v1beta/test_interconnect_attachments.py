...
from google.cloud.compute_v1beta.services.interconnect_attachments import InterconnectAttachmentsClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        InterconnectAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        InterconnectAttachmentsClient._get_api_endpoint(None, None, default_universe, "always") == InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        InterconnectAttachmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments/{interconnect_attachment}" % client.transport._host, args[1]
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments/{resource}/setLabels" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/interconnectAttachments/{resource}/testIamPermissions" % client.transport._host,
            args[1],
        )
...
def test_transport_kind_rest():
    transport = InterconnectAttachmentsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "post_aggregated_list_with_metadata"
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["interconnect_attachment_resource"] = {
        ...
        "candidate_customer_router_ip_address": "candidate_customer_router_ip_address_value",
        "candidate_customer_router_ipv6_address": "candidate_customer_router_ipv6_address_value",
        "candidate_ipv6_subnets": ["candidate_ipv6_subnets_value1", "candidate_ipv6_subnets_value2"],
        "candidate_subnets": ["candidate_subnets_value1", "candidate_subnets_value2"],
        "cloud_router_ip_address": "cloud_router_ip_address_value",
        "cloud_router_ipv6_address": "cloud_router_ipv6_address_value",
        "cloud_router_ipv6_interface_id": "cloud_router_ipv6_interface_id_value",
        "configuration_constraints": {"bgp_md5": "bgp_md5_value", "bgp_peer_asn_ranges": [{"max_": 421, "min_": 419}]},
        "creation_timestamp": "creation_timestamp_value",
        "customer_router_ip_address": "customer_router_ip_address_value",
        "customer_router_ipv6_address": "customer_router_ipv6_address_value",
        "customer_router_ipv6_interface_id": "customer_router_ipv6_interface_id_value",
        ...
        "id": 205,
        "interconnect": "interconnect_value",
        "ipsec_internal_addresses": ["ipsec_internal_addresses_value1", "ipsec_internal_addresses_value2"],
        "kind": "kind_value",
        "label_fingerprint": "label_fingerprint_value",
        "labels": {},
        "mtu": 342,
        ...
        "pairing_key": "pairing_key_value",
        "partner_asn": 1181,
        "partner_metadata": {"interconnect_name": "interconnect_name_value", "partner_name": "partner_name_value", "portal_url": "portal_url_value"},
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_patch") as post, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "post_patch_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_set_labels") as post, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "post_set_labels_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InterconnectAttachmentsRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_interconnect_attachments_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.interconnect_attachments.transports.InterconnectAttachmentsTransport.__init__"
    ) as Transport:
...
def test_interconnect_attachments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.interconnect_attachments.transports.InterconnectAttachmentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

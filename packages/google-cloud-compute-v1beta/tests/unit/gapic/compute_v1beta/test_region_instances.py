...
from google.cloud.compute_v1beta.services.region_instances import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionInstancesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RegionInstancesClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RegionInstancesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RegionInstancesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                RegionInstancesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        RegionInstancesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        RegionInstancesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionInstancesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                RegionInstancesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionInstancesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionInstancesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionInstancesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionInstancesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == RegionInstancesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionInstancesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        RegionInstancesClient._get_api_endpoint(None, None, default_universe, "always")
        == RegionInstancesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionInstancesClient._get_api_endpoint(
    ...
    assert (
        RegionInstancesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        RegionInstancesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        RegionInstancesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionInstancesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionInstancesClient._get_universe_domain(None, None)
        == RegionInstancesClient._DEFAULT_UNIVERSE
    )
...
def test_bulk_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/instances/bulkInsert"
...
def test_bulk_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.RegionInstancesRestInterceptor, "post_bulk_insert_with_metadata"
...
def test_region_instances_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_instances.transports.RegionInstancesTransport.__init__"
    ) as Transport:
...
def test_region_instances_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1beta.services.region_instances.transports.RegionInstancesTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

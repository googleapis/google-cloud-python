...
from google.cloud.compute_v1beta.services.region_instances import RegionInstancesClient, transports
...
def test__get_api_endpoint():
    ...
    assert (
        RegionInstancesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        RegionInstancesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegionInstancesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_rest():
    transport = RegionInstancesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_bulk_insert_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.RegionInstancesRestInterceptor, "post_bulk_insert") as post, mock.patch.object(

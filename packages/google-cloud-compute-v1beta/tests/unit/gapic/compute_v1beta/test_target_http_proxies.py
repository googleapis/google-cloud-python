...
from google.cloud.compute_v1beta.services.target_http_proxies import (
...
def test__get_client_cert_source():
    ...
    assert (
        TargetHttpProxiesClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        TargetHttpProxiesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TargetHttpProxiesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TargetHttpProxiesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TargetHttpProxiesClient._DEFAULT_UNIVERSE
    default_endpoint = TargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        TargetHttpProxiesClient._get_api_endpoint(
    ...
    assert (
        TargetHttpProxiesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TargetHttpProxiesClient._get_api_endpoint(
    ...
    assert (
        TargetHttpProxiesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TargetHttpProxiesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TargetHttpProxiesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        TargetHttpProxiesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TargetHttpProxiesClient._get_universe_domain(None, None)
        == TargetHttpProxiesClient._DEFAULT_UNIVERSE
    )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/targetHttpProxies"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetHttpProxies/{target_http_proxy}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetHttpProxies"
            % client.transport._host,
            args[1],
        )
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/targetHttpProxies/{target_http_proxy}/setUrlMap"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsTargetHttpProxyRequest,
):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetHttpProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.TargetHttpProxiesRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetHttpProxyAggregatedList.to_json(
            compute.TargetHttpProxyAggregatedList()
        )
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertTargetHttpProxyRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["target_http_proxy_resource"][field])
                ):
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetHttpProxyList.to_json(
            compute.TargetHttpProxyList()
        )
        req.return_value.content = return_value
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchTargetHttpProxyRequest.meta.fields[
        "target_http_proxy_resource"
    ]
...
def test_set_url_map_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetUrlMapTargetHttpProxyRequest.meta.fields[
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetHttpProxyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.TargetHttpProxiesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetHttpProxyRequest.pb(
            compute.TestIamPermissionsTargetHttpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_target_http_proxies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.target_http_proxies.transports.TargetHttpProxiesTransport.__init__"
    ) as Transport:

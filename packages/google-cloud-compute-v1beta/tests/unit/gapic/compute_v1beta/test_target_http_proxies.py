...
from google.cloud.compute_v1beta.services.target_http_proxies import TargetHttpProxiesClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert TargetHttpProxiesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert TargetHttpProxiesClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert TargetHttpProxiesClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert TargetHttpProxiesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert TargetHttpProxiesClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert TargetHttpProxiesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TargetHttpProxiesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                TargetHttpProxiesClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert TargetHttpProxiesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert TargetHttpProxiesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TargetHttpProxiesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TargetHttpProxiesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert TargetHttpProxiesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert TargetHttpProxiesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                TargetHttpProxiesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert TargetHttpProxiesClient._get_client_cert_source(None, False) is None
    assert TargetHttpProxiesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TargetHttpProxiesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert TargetHttpProxiesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TargetHttpProxiesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(TargetHttpProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TargetHttpProxiesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TargetHttpProxiesClient._DEFAULT_UNIVERSE
    default_endpoint = TargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TargetHttpProxiesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        TargetHttpProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == TargetHttpProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert TargetHttpProxiesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TargetHttpProxiesClient._get_api_endpoint(None, None, default_universe, "always") == TargetHttpProxiesClient.DEFAULT_MTLS_ENDPOINT
    assert (
        TargetHttpProxiesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == TargetHttpProxiesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert TargetHttpProxiesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TargetHttpProxiesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TargetHttpProxiesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TargetHttpProxiesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TargetHttpProxiesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TargetHttpProxiesClient._get_universe_domain(None, None) == TargetHttpProxiesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        TargetHttpProxiesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TargetHttpProxiesClient(credentials=cred)
...
def test_target_http_proxies_client_from_service_account_info(client_class, transport_name):
...
def test_target_http_proxies_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_target_http_proxies_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@mock.patch.object(TargetHttpProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TargetHttpProxiesClient))
def test_target_http_proxies_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (TargetHttpProxiesClient, transports.TargetHttpProxiesRestTransport, "rest", "true"),
        (TargetHttpProxiesClient, transports.TargetHttpProxiesRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(TargetHttpProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TargetHttpProxiesClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_target_http_proxies_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(TargetHttpProxiesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TargetHttpProxiesClient))
...
@pytest.mark.parametrize("client_class", [TargetHttpProxiesClient])
@mock.patch.object(TargetHttpProxiesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TargetHttpProxiesClient))
def test_target_http_proxies_client_client_api_endpoint(client_class):
...
def test_target_http_proxies_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (TargetHttpProxiesClient, transports.TargetHttpProxiesRestTransport, "rest", None),
    ],
)
def test_target_http_proxies_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListTargetHttpProxiesRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = compute.TargetHttpProxyAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_unset_required_fields():
    transport = transports.TargetHttpProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/targetHttpProxies" % client.transport._host, args[1])
...
def test_aggregated_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(compute.TargetHttpProxyAggregatedList.to_json(x) for x in response)
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (str, compute.TargetHttpProxiesScopedList)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetHttpProxies/{target_http_proxy}" % client.transport._host, args[1]
        )
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteTargetHttpProxyRequest):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_get_rest_required_fields(request_type=compute.GetTargetHttpProxyRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.TargetHttpProxy.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            target_http_proxy_resource=compute.TargetHttpProxy(creation_timestamp="creation_timestamp_value"),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/targetHttpProxies" % client.transport._host, args[1])
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertTargetHttpProxyRequest):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_list_rest_required_fields(request_type=compute.ListTargetHttpProxiesRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.TargetHttpProxyList.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_patch_unary_rest_required_fields(request_type=compute.PatchTargetHttpProxyRequest):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_set_url_map_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetHttpProxiesClient(
        ...
        # Ensure method has been cached
        assert client._transport.set_url_map in client._transport._wrapped_methods
...
def test_set_url_map_rest_required_fields(request_type=compute.SetUrlMapTargetHttpProxyRequest):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/targetHttpProxies/{target_http_proxy}/setUrlMap" % client.transport._host, args[1]
        )
...
def test_set_url_map_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = TargetHttpProxiesClient(
...
def test_set_url_map_unary_rest_required_fields(request_type=compute.SetUrlMapTargetHttpProxyRequest):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsTargetHttpProxyRequest):
    transport_class = transports.TargetHttpProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetHttpProxies/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.test_iam_permissions(
            compute.TestIamPermissionsTargetHttpProxyRequest(),
            project="project_value",
            resource="resource_value",
            test_permissions_request_resource=compute.TestPermissionsRequest(permissions=["permissions_value"]),
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = TargetHttpProxiesClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_rest():
    transport = TargetHttpProxiesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListTargetHttpProxiesRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.TargetHttpProxiesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TargetHttpProxiesRestInterceptor(),
    )
    client = TargetHttpProxiesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_aggregated_list_with_metadata"
        ...
        pb_message = compute.AggregatedListTargetHttpProxiesRequest.pb(compute.AggregatedListTargetHttpProxiesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetHttpProxyAggregatedList.to_json(compute.TargetHttpProxyAggregatedList())
        ...
        post_with_metadata.return_value = compute.TargetHttpProxyAggregatedList(), metadata
...
def test_delete_rest_bad_request(request_type=compute.DeleteTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteTargetHttpProxyRequest.pb(compute.DeleteTargetHttpProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_bad_request(request_type=compute.GetTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_http_proxy": "sample2"}
    request = request_type(**request_init)
...
def test_get_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        return_value = compute.TargetHttpProxy(
            ...
            http_filters=["http_filters_value"],
    ...
    assert response.http_filters == ["http_filters_value"]
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetTargetHttpProxyRequest.pb(compute.GetTargetHttpProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetHttpProxy.to_json(compute.TargetHttpProxy())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.TargetHttpProxy(), metadata
...
def test_insert_rest_bad_request(request_type=compute.InsertTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["target_http_proxy_resource"] = {
        ...
        "description": "description_value",
        "fingerprint": "fingerprint_value",
        "http_filters": ["http_filters_value1", "http_filters_value2"],
        "http_keep_alive_timeout_sec": 2868,
        "id": 205,
        "kind": "kind_value",
        "name": "name_value",
    ...
    test_field = compute.InsertTargetHttpProxyRequest.meta.fields["target_http_proxy_resource"]
    ...
    for field, value in request_init["target_http_proxy_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["target_http_proxy_resource"][field])):
                    del request_init["target_http_proxy_resource"][field][i][subfield]
            else:
                del request_init["target_http_proxy_resource"][field][subfield]
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertTargetHttpProxyRequest.pb(compute.InsertTargetHttpProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_rest_bad_request(request_type=compute.ListTargetHttpProxiesRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListTargetHttpProxiesRequest.pb(compute.ListTargetHttpProxiesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.TargetHttpProxyList.to_json(compute.TargetHttpProxyList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.TargetHttpProxyList(), metadata
...
def test_patch_rest_bad_request(request_type=compute.PatchTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_http_proxy": "sample2"}
    request = request_type(**request_init)
...
def test_patch_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchTargetHttpProxyRequest.meta.fields["target_http_proxy_resource"]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_patch") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_patch_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchTargetHttpProxyRequest.pb(compute.PatchTargetHttpProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_set_url_map_rest_bad_request(request_type=compute.SetUrlMapTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_http_proxy": "sample2"}
    request = request_type(**request_init)
...
def test_set_url_map_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetUrlMapTargetHttpProxyRequest.meta.fields["url_map_reference_resource"]
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_set_url_map") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_set_url_map_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.SetUrlMapTargetHttpProxyRequest.pb(compute.SetUrlMapTargetHttpProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsTargetHttpProxyRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TargetHttpProxiesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsTargetHttpProxyRequest.pb(compute.TestIamPermissionsTargetHttpProxyRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        request = compute.TestIamPermissionsTargetHttpProxyRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListTargetHttpProxiesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteTargetHttpProxyRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetTargetHttpProxyRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertTargetHttpProxyRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListTargetHttpProxiesRequest()
...
def test_patch_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.PatchTargetHttpProxyRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_set_url_map_unary_empty_call_rest():
    client = TargetHttpProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.set_url_map), "__call__") as call:
        client.set_url_map_unary(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.SetUrlMapTargetHttpProxyRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsTargetHttpProxyRequest()
...
def test_target_http_proxies_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.TargetHttpProxiesTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_target_http_proxies_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.compute_v1beta.services.target_http_proxies.transports.TargetHttpProxiesTransport.__init__") as Transport:
...
def test_target_http_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.target_http_proxies.transports.TargetHttpProxiesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_target_http_proxies_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.TargetHttpProxiesRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.TargetHttpProxiesTransport, "_prep_wrapped_messages") as prep:
        client = TargetHttpProxiesClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = TargetHttpProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
from google.cloud.compute_v1beta.services.ssl_policies import (
    SslPoliciesClient,
    pagers,
    transports,
)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/sslPolicies"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslPolicies/{ssl_policy}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslPolicies"
            % client.transport._host,
            args[1],
        )
...
def test_list_available_features_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslPolicies/listAvailableFeatures"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslPolicies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsSslPolicyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.SslPoliciesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsSslPolicyRequest.pb(
            compute.TestIamPermissionsSslPolicyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_ssl_policies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.ssl_policies.transports.SslPoliciesTransport.__init__"
    ) as Transport:

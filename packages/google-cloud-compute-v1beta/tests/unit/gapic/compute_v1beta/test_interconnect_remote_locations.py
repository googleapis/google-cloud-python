...
from google.cloud.compute_v1beta.services.interconnect_remote_locations import InterconnectRemoteLocationsClient, pagers, transports
...
def test__read_environment_variables():
    assert InterconnectRemoteLocationsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert InterconnectRemoteLocationsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert InterconnectRemoteLocationsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert InterconnectRemoteLocationsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert InterconnectRemoteLocationsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert InterconnectRemoteLocationsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert InterconnectRemoteLocationsClient._use_client_cert_effective() is False
...
def test__get_client_cert_source():
    ...
    assert InterconnectRemoteLocationsClient._get_client_cert_source(None, False) is None
    assert InterconnectRemoteLocationsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert InterconnectRemoteLocationsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert InterconnectRemoteLocationsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert InterconnectRemoteLocationsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(
    InterconnectRemoteLocationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectRemoteLocationsClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = InterconnectRemoteLocationsClient._DEFAULT_UNIVERSE
    default_endpoint = InterconnectRemoteLocationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = InterconnectRemoteLocationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert InterconnectRemoteLocationsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        InterconnectRemoteLocationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == InterconnectRemoteLocationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        InterconnectRemoteLocationsClient._get_api_endpoint(None, None, default_universe, "always")
        == InterconnectRemoteLocationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        InterconnectRemoteLocationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == InterconnectRemoteLocationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert InterconnectRemoteLocationsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        InterconnectRemoteLocationsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert InterconnectRemoteLocationsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert InterconnectRemoteLocationsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert InterconnectRemoteLocationsClient._get_universe_domain(None, None) == InterconnectRemoteLocationsClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = InterconnectRemoteLocationsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (InterconnectRemoteLocationsClient, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (transports.InterconnectRemoteLocationsRestTransport, "rest"),
    ],
)
...
def test_interconnect_remote_locations_client_get_transport_class():
    ...
    available_transports = [
        transports.InterconnectRemoteLocationsRestTransport,
    ]
...
@pytest.mark.parametrize(
    ...
    [
        (InterconnectRemoteLocationsClient, transports.InterconnectRemoteLocationsRestTransport, "rest"),
    ],
)
@mock.patch.object(
    InterconnectRemoteLocationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectRemoteLocationsClient)
...
@pytest.mark.parametrize(
    ...
    [
        (InterconnectRemoteLocationsClient, transports.InterconnectRemoteLocationsRestTransport, "rest", "true"),
        (InterconnectRemoteLocationsClient, transports.InterconnectRemoteLocationsRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(
    InterconnectRemoteLocationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(InterconnectRemoteLocationsClient)
...
def test_interconnect_remote_locations_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (InterconnectRemoteLocationsClient, transports.InterconnectRemoteLocationsRestTransport, "rest", None),
    ],
)
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnectRemoteLocations/{interconnect_remote_location}" % client.transport._host, args[1]
        )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/interconnectRemoteLocations" % client.transport._host, args[1])
...
def test_transport_kind_rest():
    transport = InterconnectRemoteLocationsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_rest_bad_request(request_type=compute.GetInterconnectRemoteLocationRequest):
...
def test_get_rest_interceptors(null_interceptor):
    transport = transports.InterconnectRemoteLocationsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterconnectRemoteLocationsRestInterceptor(),
    )
    client = InterconnectRemoteLocationsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "post_get") as post, mock.patch.object(
        transports.InterconnectRemoteLocationsRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InterconnectRemoteLocationsRestInterceptor, "pre_get"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectRemoteLocation.to_json(compute.InterconnectRemoteLocation())
        ...
        post_with_metadata.return_value = compute.InterconnectRemoteLocation(), metadata
...
def test_list_rest_bad_request(request_type=compute.ListInterconnectRemoteLocationsRequest):
    client = InterconnectRemoteLocationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.InterconnectRemoteLocationsRestInterceptor, "post_list") as post, mock.patch.object(
        transports.InterconnectRemoteLocationsRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.InterconnectRemoteLocationsRestInterceptor, "pre_list"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectRemoteLocationList.to_json(compute.InterconnectRemoteLocationList())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = compute.InterconnectRemoteLocationList(), metadata
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        request_msg = compute.GetInterconnectRemoteLocationRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListInterconnectRemoteLocationsRequest()
...
def test_interconnect_remote_locations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport.__init__"
    ) as Transport:
...
def test_interconnect_remote_locations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.interconnect_remote_locations.transports.InterconnectRemoteLocationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_interconnect_remote_locations_client_transport_session_collision(transport_name):
    ...
    client1 = InterconnectRemoteLocationsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = InterconnectRemoteLocationsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize(
    ...
    [
        (InterconnectRemoteLocationsClient, transports.InterconnectRemoteLocationsRestTransport),
    ],
)

...
from google.cloud.compute_v1beta.services.interconnect_remote_locations import (
...
def test__get_client_cert_source():
    ...
    assert (
        InterconnectRemoteLocationsClient._get_client_cert_source(None, False) is None
    )
    assert (
        InterconnectRemoteLocationsClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                InterconnectRemoteLocationsClient._get_client_cert_source(None, True)
...
def test_interconnect_remote_locations_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_interconnect_remote_locations_client_client_options(
    ...
    with mock.patch.object(
        InterconnectRemoteLocationsClient, "get_transport_class"
    ) as gtc:
...
def test_interconnect_remote_locations_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    InterconnectRemoteLocationsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(InterconnectRemoteLocationsClient),
)
def test_interconnect_remote_locations_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_interconnect_remote_locations_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_interconnect_remote_locations_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_get_rest_required_fields(
    request_type=compute.GetInterconnectRemoteLocationRequest,
):
    ...
    assert (
        jsonified_request["interconnectRemoteLocation"]
        == "interconnect_remote_location_value"
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {
            "project": "sample1",
            "interconnect_remote_location": "sample2",
        }
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnectRemoteLocations/{interconnect_remote_location}"
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/interconnectRemoteLocations"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            compute.InterconnectRemoteLocationList.to_json(x) for x in response
        )
...
def test_get_rest_interceptors(null_interceptor):
    transport = transports.InterconnectRemoteLocationsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.InterconnectRemoteLocationsRestInterceptor(),
    )
    client = InterconnectRemoteLocationsClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.InterconnectRemoteLocationsRestInterceptor, "post_get"
        ...
        pb_message = compute.GetInterconnectRemoteLocationRequest.pb(
            compute.GetInterconnectRemoteLocationRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectRemoteLocation.to_json(
            compute.InterconnectRemoteLocation()
        )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.InterconnectRemoteLocationsRestInterceptor, "post_list"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListInterconnectRemoteLocationsRequest.pb(
            compute.ListInterconnectRemoteLocationsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.InterconnectRemoteLocationList.to_json(
            compute.InterconnectRemoteLocationList()
        )
        req.return_value.content = return_value
...
def test_interconnect_remote_locations_client_transport_session_collision(
    transport_name,
):
...
def test_common_billing_account_path():
    ...
    actual = InterconnectRemoteLocationsClient.common_billing_account_path(
        billing_account
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.InterconnectRemoteLocationsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = InterconnectRemoteLocationsClient(
            credentials=ga_credentials.AnonymousCredentials(),

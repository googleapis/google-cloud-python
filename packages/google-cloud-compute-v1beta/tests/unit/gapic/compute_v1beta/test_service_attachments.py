...
from google.cloud.compute_v1beta.services.service_attachments import (
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/serviceAttachments"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{service_attachment}"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["service_attachment_resource"] = {
        ...
        "target_service": "target_service_value",
        "tunneling_config": {
            "encapsulation_profile": "encapsulation_profile_value",
...
def test_service_attachments_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.service_attachments.transports.ServiceAttachmentsTransport.__init__"
    ) as Transport:
...
def test_service_attachments_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1beta.services.service_attachments.transports.ServiceAttachmentsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

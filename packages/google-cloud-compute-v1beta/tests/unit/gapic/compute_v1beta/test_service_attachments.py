...
from google.cloud.compute_v1beta.services.service_attachments import ServiceAttachmentsClient, pagers, transports
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{service_attachment}" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/serviceAttachments/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["service_attachment_resource"] = {
        ...
        "self_link": "self_link_value",
        "target_service": "target_service_value",
        "tunneling_config": {"encapsulation_profile": "encapsulation_profile_value", "routing_mode": "routing_mode_value"},
    }

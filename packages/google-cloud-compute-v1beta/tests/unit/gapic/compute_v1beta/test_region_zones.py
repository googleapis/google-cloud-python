...
from google.cloud.compute_v1beta.services.region_zones import (
    RegionZonesClient,
    pagers,
    transports,
)
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/zones"
...
def test_region_zones_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_zones.transports.RegionZonesTransport.__init__"
    ) as Transport:

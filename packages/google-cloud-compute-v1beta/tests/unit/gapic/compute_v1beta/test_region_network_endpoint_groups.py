...
from google.cloud.compute_v1beta.services.region_network_endpoint_groups import RegionNetworkEndpointGroupsClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RegionNetworkEndpointGroupsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RegionNetworkEndpointGroupsClient._use_client_cert_effective() is False
...
@mock.patch.object(
    RegionNetworkEndpointGroupsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RegionNetworkEndpointGroupsClient)
)
def test__get_api_endpoint():
    ...
    assert (
        RegionNetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        RegionNetworkEndpointGroupsClient._get_api_endpoint(None, None, default_universe, "always")
        == RegionNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RegionNetworkEndpointGroupsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RegionNetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_attach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}" % client.transport._host, args[1]
        )
...
def test_detach_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
def test_list_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
def test_transport_kind_rest():
    transport = RegionNetworkEndpointGroupsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_attach_network_endpoints_rest_call_success(request_type):
    ...
    test_field = compute.AttachNetworkEndpointsRegionNetworkEndpointGroupRequest.meta.fields[
...
def test_attach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints"
    ) as post, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_attach_network_endpoints"
    ) as pre:
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_detach_network_endpoints_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.DetachNetworkEndpointsRegionNetworkEndpointGroupRequest.meta.fields[
...
def test_detach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints"
    ) as post, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_detach_network_endpoints"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_list_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints"
    ) as post, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RegionNetworkEndpointGroupsRestInterceptor, "pre_list_network_endpoints"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_region_network_endpoint_groups_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport.__init__"
    ) as Transport:
...
def test_region_network_endpoint_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

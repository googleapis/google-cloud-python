...
from google.cloud.compute_v1beta.services.target_ssl_proxies import (
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies"
            % client.transport._host,
            args[1],
        )
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setBackendService"
            % client.transport._host,
            args[1],
        )
...
def test_set_certificate_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setCertificateMap"
            % client.transport._host,
            args[1],
        )
...
def test_set_proxy_header_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setProxyHeader"
            % client.transport._host,
            args[1],
        )
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setSslCertificates"
            % client.transport._host,
            args[1],
        )
...
def test_set_ssl_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{target_ssl_proxy}/setSslPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetSslProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_target_ssl_proxies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.target_ssl_proxies.transports.TargetSslProxiesTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.images import ImagesClient, pagers, transports
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/images/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_deprecate_rest_call_success(request_type):
    ...
    request_init["deprecation_status_resource"] = {
        ...
        "state": "state_value",
        "state_override": {"default_rollout_time": "default_rollout_time_value", "location_rollout_policies": {}},
    }
...
def test_images_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.images.transports.ImagesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
from google.cloud.compute_v1beta.services.region_target_tcp_proxies import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RegionTargetTcpProxiesClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionTargetTcpProxiesClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RegionTargetTcpProxiesClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RegionTargetTcpProxiesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RegionTargetTcpProxiesClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    RegionTargetTcpProxiesClient._use_client_cert_effective() is False
                )
...
def test__get_client_cert_source():
    ...
    assert (
        RegionTargetTcpProxiesClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RegionTargetTcpProxiesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RegionTargetTcpProxiesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RegionTargetTcpProxiesClient._DEFAULT_UNIVERSE
    default_endpoint = RegionTargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RegionTargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        RegionTargetTcpProxiesClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        RegionTargetTcpProxiesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        RegionTargetTcpProxiesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RegionTargetTcpProxiesClient._get_universe_domain(None, None)
        == RegionTargetTcpProxiesClient._DEFAULT_UNIVERSE
    )
...
def test_region_target_tcp_proxies_client_from_service_account_info(
    client_class, transport_name
):
...
def test_region_target_tcp_proxies_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_region_target_tcp_proxies_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_region_target_tcp_proxies_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_region_target_tcp_proxies_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    RegionTargetTcpProxiesClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RegionTargetTcpProxiesClient),
)
def test_region_target_tcp_proxies_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_region_target_tcp_proxies_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_region_target_tcp_proxies_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_delete_rest_required_fields(
    request_type=compute.DeleteRegionTargetTcpProxyRequest,
):
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetTcpProxies/{target_tcp_proxy}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetTcpProxies"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_required_fields(
    request_type=compute.ListRegionTargetTcpProxiesRequest,
):
    transport_class = transports.RegionTargetTcpProxiesRestTransport
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionTargetTcpProxyRequest,
):
    transport_class = transports.RegionTargetTcpProxiesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/targetTcpProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.RegionTargetTcpProxiesRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.RegionTargetTcpProxiesRestInterceptor(),
    )
    client = RegionTargetTcpProxiesClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.RegionTargetTcpProxiesRestInterceptor, "post_delete"
        ...
        pb_message = compute.DeleteRegionTargetTcpProxyRequest.pb(
            compute.DeleteRegionTargetTcpProxyRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionTargetTcpProxiesRestInterceptor, "post_get"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRegionTargetTcpProxyRequest.pb(
            compute.GetRegionTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertRegionTargetTcpProxyRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["target_tcp_proxy_resource"][field])
                ):
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionTargetTcpProxiesRestInterceptor, "post_insert"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertRegionTargetTcpProxyRequest.pb(
            compute.InsertRegionTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionTargetTcpProxiesRestInterceptor, "post_list"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRegionTargetTcpProxiesRequest.pb(
            compute.ListRegionTargetTcpProxiesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionTargetTcpProxyRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.RegionTargetTcpProxiesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.RegionTargetTcpProxiesRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionTargetTcpProxyRequest.pb(
            compute.TestIamPermissionsRegionTargetTcpProxyRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.RegionTargetTcpProxiesTransport, "_prep_wrapped_messages"
    ) as prep:
        client = RegionTargetTcpProxiesClient(
            credentials=ga_credentials.AnonymousCredentials(),

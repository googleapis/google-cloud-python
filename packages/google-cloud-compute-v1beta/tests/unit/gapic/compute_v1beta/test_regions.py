...
from google.cloud.compute_v1beta.services.regions import (
    RegionsClient,
    pagers,
    transports,
)
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}"
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions" % client.transport._host,
            args[1],
        )
...
def test_regions_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.regions.transports.RegionsTransport.__init__"
    ) as Transport:
...
def test_regions_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1beta.services.regions.transports.RegionsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

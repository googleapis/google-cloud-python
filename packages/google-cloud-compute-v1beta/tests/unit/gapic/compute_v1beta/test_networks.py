...
def test_networks_client_get_transport_class():
    transport = NetworksClient.get_transport_class()
    ...
    assert transport == transports.NetworksRestTransport
...
@pytest.mark.parametrize(
    ...
    [
        (NetworksClient, transports.NetworksRestTransport, "rest", "true"),
...
def test_add_peering_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.add_peering in client._transport._wrapped_methods
...
def test_add_peering_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
...
def test_cancel_request_remove_peering_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.cancel_request_remove_peering
        ...
        request = {}
        client.cancel_request_remove_peering(request)
...
def test_cancel_request_remove_peering_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.cancel_request_remove_peering(request)
...
def test_cancel_request_remove_peering_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            project="project_value",
            network="network_value",
            networks_cancel_request_remove_peering_request_resource=compute.NetworksCancelRequestRemovePeeringRequest(
                name="name_value"
            ),
        )
        mock_args.update(sample_request)
        ...
        client.cancel_request_remove_peering(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/networks/{network}/cancelRequestRemovePeering"
            % client.transport._host,
            args[1],
        )


def test_cancel_request_remove_peering_rest_flattened_error(transport: str = "rest"):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_request_remove_peering_unary_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        request = {}
        client.cancel_request_remove_peering_unary(request)
...
def test_cancel_request_remove_peering_unary_rest_required_fields(
    request_type=compute.CancelRequestRemovePeeringNetworkRequest,
):
    transport_class = transports.NetworksRestTransport
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response = client.cancel_request_remove_peering_unary(request)
...
def test_cancel_request_remove_peering_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.cancel_request_remove_peering_unary(**mock_args)
...
def test_cancel_request_remove_peering_unary_rest_flattened_error(
    transport: str = "rest",
):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        client.cancel_request_remove_peering_unary(
            compute.CancelRequestRemovePeeringNetworkRequest(),
            project="project_value",
            network="network_value",
            networks_cancel_request_remove_peering_request_resource=compute.NetworksCancelRequestRemovePeeringRequest(
...
def test_remove_peering_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
        ...
        # Ensure method has been cached
        assert client._transport.remove_peering in client._transport._wrapped_methods
...
def test_remove_peering_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
...
def test_request_remove_peering_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.request_remove_peering] = (
            mock_rpc
        )
...
def test_switch_to_custom_mode_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.switch_to_custom_mode] = (
            mock_rpc
        )
...
def test_switch_to_custom_mode_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
...
def test_update_peering_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_peering in client._transport._wrapped_methods
...
def test_update_peering_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NetworksClient(
...
def test_add_peering_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.NetworksRestInterceptor, "pre_add_peering") as pre,
    ):
...
def test_cancel_request_remove_peering_rest_bad_request(
    request_type=compute.CancelRequestRemovePeeringNetworkRequest,
):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_cancel_request_remove_peering_rest_call_success(request_type):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "network": "sample2"}
    request_init["networks_cancel_request_remove_peering_request_resource"] = {
        "name": "name_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.CancelRequestRemovePeeringNetworkRequest.meta.fields[
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_cancel_request_remove_peering_rest_interceptors(null_interceptor):
    transport = transports.NetworksRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.NetworksRestInterceptor(),
    )
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.NetworksRestInterceptor, "post_cancel_request_remove_peering"
        ) as post,
        mock.patch.object(
            transports.NetworksRestInterceptor,
            "post_cancel_request_remove_peering_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.NetworksRestInterceptor, "pre_cancel_request_remove_peering"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.CancelRequestRemovePeeringNetworkRequest.pb(
            compute.CancelRequestRemovePeeringNetworkRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.NetworksRestInterceptor, "post_delete") as post,
        mock.patch.object(
            transports.NetworksRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.NetworksRestInterceptor, "pre_delete") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.NetworksRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.NetworksRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.NetworksRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["network_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.NetworksRestInterceptor, "post_insert") as post,
        mock.patch.object(
            transports.NetworksRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.NetworksRestInterceptor, "pre_insert") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.NetworksRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.NetworksRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.NetworksRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.NetworksRestInterceptor, "post_patch") as post,
        mock.patch.object(
            transports.NetworksRestInterceptor, "post_patch_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.NetworksRestInterceptor, "pre_patch") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_add_peering_unary_empty_call_rest():
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport.add_peering), "__call__") as call:
        client.add_peering_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_request_remove_peering_unary_empty_call_rest():
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(
        ...
        client.cancel_request_remove_peering_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_peering_unary_empty_call_rest():
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.remove_peering), "__call__") as call:
        client.remove_peering_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_peering_unary_empty_call_rest():
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.update_peering), "__call__") as call:
        client.update_peering_unary(request=None)
...
def test_networks_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.cancel_request_remove_peering._session
    session2 = client2.transport.cancel_request_remove_peering._session
    assert session1 != session2
...
def test_common_billing_account_path():
    ...
    actual = NetworksClient.common_billing_account_path(billing_account)
...
def test_parse_common_billing_account_path():
    ...
    path = NetworksClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworksClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = NetworksClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworksClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = NetworksClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworksClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = NetworksClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworksClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = NetworksClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = NetworksClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = NetworksClient.parse_common_location_path(path)
    assert expected == actual
...
@pytest.mark.parametrize(
    ...
    [
        (NetworksClient, transports.NetworksRestTransport),
    ],
)

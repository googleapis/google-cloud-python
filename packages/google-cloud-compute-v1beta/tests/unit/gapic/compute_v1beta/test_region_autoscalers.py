...
from google.cloud.compute_v1beta.services.region_autoscalers import (
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/autoscalers/{autoscaler}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/autoscalers"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/autoscalers/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_region_autoscalers_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_autoscalers.transports.RegionAutoscalersTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.region_autoscalers import RegionAutoscalersClient, pagers, transports
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/autoscalers/{autoscaler}" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/autoscalers/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["autoscaler_resource"] = {
        "autoscaling_policy": {
            ...
            "mode": "mode_value",
            "scale_down_control": {"max_scaled_down_replicas": {"calculated": 1042, "fixed": 528, "percent": 753}, "time_window_sec": 1600},
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RegionAutoscalersRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.RegionAutoscalersRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_region_autoscalers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.region_autoscalers.transports.RegionAutoscalersTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

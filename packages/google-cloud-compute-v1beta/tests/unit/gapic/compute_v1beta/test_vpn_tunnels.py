...
from google.cloud.compute_v1beta.services.vpn_tunnels import (
    VpnTunnelsClient,
    pagers,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        VpnTunnelsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        VpnTunnelsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        VpnTunnelsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        VpnTunnelsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert VpnTunnelsClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert (
        VpnTunnelsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        VpnTunnelsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        VpnTunnelsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                VpnTunnelsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(VpnTunnelsClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VpnTunnelsClient._DEFAULT_UNIVERSE
    default_endpoint = VpnTunnelsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = VpnTunnelsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        VpnTunnelsClient._get_api_endpoint(
    ...
    assert (
        ...
        == VpnTunnelsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        VpnTunnelsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        VpnTunnelsClient._get_api_endpoint(None, None, default_universe, "always")
        == VpnTunnelsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        VpnTunnelsClient._get_api_endpoint(
    ...
    assert (
        VpnTunnelsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        VpnTunnelsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        VpnTunnelsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        VpnTunnelsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        VpnTunnelsClient._get_universe_domain(None, None)
        == VpnTunnelsClient._DEFAULT_UNIVERSE
    )
...
def test_vpn_tunnels_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_vpn_tunnels_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    VpnTunnelsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VpnTunnelsClient)
)
...
def test_vpn_tunnels_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_vpn_tunnels_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListVpnTunnelsRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/vpnTunnels"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/vpnTunnels/{vpn_tunnel}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/vpnTunnels"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/vpnTunnels/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsVpnTunnelRequest,
):
    transport_class = transports.VpnTunnelsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/vpnTunnels/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.VpnTunnelsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.VpnTunnelsRestInterceptor(),
    )
    client = VpnTunnelsClient(transport=transport)
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.VpnTunnelAggregatedList.to_json(
            compute.VpnTunnelAggregatedList()
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "post_delete") as post,
        mock.patch.object(
            transports.VpnTunnelsRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "pre_delete") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.VpnTunnelsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["vpn_tunnel_resource"] = {
        ...
        "remote_traffic_selector": [
            "remote_traffic_selector_value1",
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "post_insert") as post,
        mock.patch.object(
            transports.VpnTunnelsRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "pre_insert") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.VpnTunnelsRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.VpnTunnelsRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_set_labels_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsVpnTunnelRequest.meta.fields[
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsVpnTunnelRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.VpnTunnelsRestInterceptor, "post_test_iam_permissions"
        ) as post,
        mock.patch.object(
            transports.VpnTunnelsRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsVpnTunnelRequest.pb(
            compute.TestIamPermissionsVpnTunnelRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_vpn_tunnels_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.vpn_tunnels.transports.VpnTunnelsTransport.__init__"
    ) as Transport:
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.VpnTunnelsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = VpnTunnelsClient(
            credentials=ga_credentials.AnonymousCredentials(),

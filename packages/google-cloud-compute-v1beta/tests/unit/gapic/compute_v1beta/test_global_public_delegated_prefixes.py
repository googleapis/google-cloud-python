...
from google.cloud.compute_v1beta.services.global_public_delegated_prefixes import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GlobalPublicDelegatedPrefixesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                GlobalPublicDelegatedPrefixesClient._use_client_cert_effective() is True
            )
...
def test__get_client_cert_source():
    ...
    assert (
        GlobalPublicDelegatedPrefixesClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                GlobalPublicDelegatedPrefixesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(GlobalPublicDelegatedPrefixesClient),
)
...
def test__get_universe_domain():
    ...
    assert (
        GlobalPublicDelegatedPrefixesClient._get_universe_domain(None, None)
        == GlobalPublicDelegatedPrefixesClient._DEFAULT_UNIVERSE
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/publicDelegatedPrefixes/{public_delegated_prefix}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/publicDelegatedPrefixes"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.GlobalPublicDelegatedPrefixesRestInterceptor,

...
from google.cloud.compute_v1beta.services.routers import RoutersClient, pagers, transports
...
def test__get_client_cert_source():
    ...
    assert RoutersClient._get_client_cert_source(None, False) is None
    assert RoutersClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RoutersClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert RoutersClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RoutersClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(RoutersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RoutersClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RoutersClient._DEFAULT_UNIVERSE
    default_endpoint = RoutersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RoutersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RoutersClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RoutersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RoutersClient.DEFAULT_MTLS_ENDPOINT
    assert RoutersClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RoutersClient._get_api_endpoint(None, None, default_universe, "always") == RoutersClient.DEFAULT_MTLS_ENDPOINT
    assert RoutersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RoutersClient.DEFAULT_MTLS_ENDPOINT
    assert RoutersClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RoutersClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RoutersClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RoutersClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RoutersClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RoutersClient._get_universe_domain(None, None) == RoutersClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [RoutersClient])
@mock.patch.object(RoutersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RoutersClient))
def test_routers_client_client_api_endpoint(client_class):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/routers" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers/{router}" % client.transport._host, args[1])
...
def test_delete_route_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_route_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_route_policy] = mock_rpc
...
def test_delete_route_policy_rest_required_fields(request_type=compute.DeleteRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_route_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_route_policy(**mock_args)
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/deleteRoutePolicy" % client.transport._host, args[1]
        )


def test_delete_route_policy_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_route_policy_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
...
def test_delete_route_policy_unary_rest_required_fields(request_type=compute.DeleteRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
...
def test_delete_route_policy_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_route_policy_unary(**mock_args)
...
def test_delete_route_policy_unary_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        client.delete_route_policy_unary(
            compute.DeleteRoutePolicyRouterRequest(),
            project="project_value",
            region="region_value",
            router="router_value",
...
def test_get_nat_ip_info_rest_required_fields(request_type=compute.GetNatIpInfoRouterRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_nat_ip_info._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_nat_ip_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getNatIpInfo" % client.transport._host, args[1]
        )
...
def test_get_nat_mapping_info_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_nat_mapping_info in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_nat_mapping_info] = mock_rpc
...
def test_get_nat_mapping_info_rest_required_fields(request_type=compute.GetNatMappingInfoRoutersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_nat_mapping_info._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_nat_mapping_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getNatMappingInfo" % client.transport._host, args[1]
        )
...
def test_get_route_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_route_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_route_policy] = mock_rpc
...
def test_get_route_policy_rest_required_fields(request_type=compute.GetRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_route_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.RoutersGetRoutePolicyResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.RoutersGetRoutePolicyResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_route_policy(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getRoutePolicy" % client.transport._host, args[1]
        )


def test_get_route_policy_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_router_status_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_router_status] = mock_rpc
...
def test_get_router_status_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/getRouterStatus" % client.transport._host, args[1]
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/regions/{region}/routers" % client.transport._host, args[1])
...
def test_list_bgp_routes_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_bgp_routes in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_bgp_routes] = mock_rpc

        request = {}
        client.list_bgp_routes(request)
...
def test_list_bgp_routes_rest_required_fields(request_type=compute.ListBgpRoutesRoutersRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_bgp_routes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.RoutersListBgpRoutes()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.RoutersListBgpRoutes.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_bgp_routes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_bgp_routes(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/listBgpRoutes" % client.transport._host, args[1]
        )


def test_list_bgp_routes_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_bgp_routes_rest_pager(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(compute.RoutersListBgpRoutes.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
        ...
        pages = list(client.list_bgp_routes(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_list_route_policies_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_route_policies in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_route_policies] = mock_rpc
...
def test_list_route_policies_rest_required_fields(request_type=compute.ListRoutePoliciesRoutersRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_route_policies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.RoutersListRoutePolicies()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.RoutersListRoutePolicies.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_route_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_route_policies(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/listRoutePolicies" % client.transport._host, args[1]
        )


def test_list_route_policies_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_route_policies_rest_pager(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(compute.RoutersListRoutePolicies.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
        ...
        pages = list(client.list_route_policies(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_patch_route_policy_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.patch_route_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.patch_route_policy] = mock_rpc
...
def test_patch_route_policy_rest_required_fields(request_type=compute.PatchRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).patch_route_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_patch_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            router="router_value",
            route_policy_resource=compute.RoutePolicy(description="description_value"),
        )
        mock_args.update(sample_request)
        ...
        client.patch_route_policy(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/patchRoutePolicy" % client.transport._host, args[1]
        )


def test_patch_route_policy_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_route_policy_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
...
def test_patch_route_policy_unary_rest_required_fields(request_type=compute.PatchRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
...
def test_patch_route_policy_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.patch_route_policy_unary(**mock_args)
...
def test_patch_route_policy_unary_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        client.patch_route_policy_unary(
            compute.PatchRoutePolicyRouterRequest(),
            project="project_value",
            region="region_value",
            router="router_value",
...
def test_preview_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/preview" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsRouterRequest):
    transport_class = transports.RoutersRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.test_iam_permissions(
            compute.TestIamPermissionsRouterRequest(),
            project="project_value",
            region="region_value",
            resource="resource_value",
            test_permissions_request_resource=compute.TestPermissionsRequest(permissions=["permissions_value"]),
...
def test_update_route_policy_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_route_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_route_policy] = mock_rpc
...
def test_update_route_policy_rest_required_fields(request_type=compute.UpdateRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_route_policy._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_route_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_route_policy(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/routers/{router}/updateRoutePolicy" % client.transport._host, args[1]
        )


def test_update_route_policy_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_route_policy_unary_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = RoutersClient(
...
def test_update_route_policy_unary_rest_required_fields(request_type=compute.UpdateRoutePolicyRouterRequest):
    transport_class = transports.RoutersRestTransport
...
def test_update_route_policy_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_route_policy_unary(**mock_args)
...
def test_update_route_policy_unary_rest_flattened_error(transport: str = "rest"):
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind_rest():
    transport = RoutersClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListRoutersRequest):
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RouterAggregatedList.to_json(compute.RouterAggregatedList())
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_delete") as post, mock.patch.object(
...
def test_delete_route_policy_rest_bad_request(request_type=compute.DeleteRoutePolicyRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_delete_route_policy_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_route_policy_rest_interceptors(null_interceptor):
    transport = transports.RoutersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RoutersRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_delete_route_policy") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_delete_route_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_delete_route_policy"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteRoutePolicyRouterRequest.pb(compute.DeleteRoutePolicyRouterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_get") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.Router.to_json(compute.Router())
        req.return_value.content = return_value
...
def test_get_nat_ip_info_rest_bad_request(request_type=compute.GetNatIpInfoRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_get_nat_ip_info_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_nat_ip_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_get_nat_ip_info") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetNatIpInfoRouterRequest.pb(compute.GetNatIpInfoRouterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.NatIpInfoResponse.to_json(compute.NatIpInfoResponse())
        req.return_value.content = return_value
...
def test_get_nat_mapping_info_rest_bad_request(request_type=compute.GetNatMappingInfoRoutersRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_get_nat_mapping_info_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_nat_mapping_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_get_nat_mapping_info") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.VmEndpointNatMappingsList.to_json(compute.VmEndpointNatMappingsList())
        req.return_value.content = return_value
...
def test_get_route_policy_rest_bad_request(request_type=compute.GetRoutePolicyRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_get_route_policy_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, compute.RoutersGetRoutePolicyResponse)


@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_route_policy_rest_interceptors(null_interceptor):
    transport = transports.RoutersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RoutersRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_get_route_policy") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_get_route_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_get_route_policy"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetRoutePolicyRouterRequest.pb(compute.GetRoutePolicyRouterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RoutersGetRoutePolicyResponse.to_json(compute.RoutersGetRoutePolicyResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = compute.RoutersGetRoutePolicyResponse()
        post_with_metadata.return_value = compute.RoutersGetRoutePolicyResponse(), metadata
...
def test_get_router_status_rest_bad_request(request_type=compute.GetRouterStatusRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_get_router_status_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_router_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_get_router_status") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RouterStatusResponse.to_json(compute.RouterStatusResponse())
        req.return_value.content = return_value
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["router_resource"] = {
        "bgp": {
            ...
            "advertised_groups": ["advertised_groups_value1", "advertised_groups_value2"],
            "advertised_ip_ranges": [{"description": "description_value", "range_": "range__value"}],
            "asn": 322,
        ...
        "nats": [
            {
                ...
                "rules": [
                    {
                        "action": {
                            "source_nat_active_ips": ["source_nat_active_ips_value1", "source_nat_active_ips_value2"],
                            "source_nat_active_ranges": ["source_nat_active_ranges_value1", "source_nat_active_ranges_value2"],
                            "source_nat_drain_ips": ["source_nat_drain_ips_value1", "source_nat_drain_ips_value2"],
                ...
                "subnetworks": [
                    {
                        "name": "name_value",
                        "secondary_ip_range_names": ["secondary_ip_range_names_value1", "secondary_ip_range_names_value2"],
                        "source_ip_ranges_to_nat": ["source_ip_ranges_to_nat_value1", "source_ip_ranges_to_nat_value2"],
                    }
                ],
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_insert") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_list") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RouterList.to_json(compute.RouterList())
        req.return_value.content = return_value
...
def test_list_bgp_routes_rest_bad_request(request_type=compute.ListBgpRoutesRoutersRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_list_bgp_routes_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListBgpRoutesPager)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_bgp_routes_rest_interceptors(null_interceptor):
    transport = transports.RoutersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RoutersRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_list_bgp_routes") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_list_bgp_routes_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_list_bgp_routes"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListBgpRoutesRoutersRequest.pb(compute.ListBgpRoutesRoutersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RoutersListBgpRoutes.to_json(compute.RoutersListBgpRoutes())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = compute.RoutersListBgpRoutes()
        post_with_metadata.return_value = compute.RoutersListBgpRoutes(), metadata
...
def test_list_route_policies_rest_bad_request(request_type=compute.ListRoutePoliciesRoutersRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_list_route_policies_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListRoutePoliciesPager)
    assert response.etag == "etag_value"
    assert response.id == "id_value"
    assert response.kind == "kind_value"
    assert response.next_page_token == "next_page_token_value"
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_route_policies_rest_interceptors(null_interceptor):
    transport = transports.RoutersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RoutersRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_list_route_policies") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_list_route_policies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_list_route_policies"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListRoutePoliciesRoutersRequest.pb(compute.ListRoutePoliciesRoutersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RoutersListRoutePolicies.to_json(compute.RoutersListRoutePolicies())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = compute.RoutersListRoutePolicies()
        post_with_metadata.return_value = compute.RoutersListRoutePolicies(), metadata
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_patch") as post, mock.patch.object(
...
def test_patch_route_policy_rest_bad_request(request_type=compute.PatchRoutePolicyRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_patch_route_policy_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request_init["route_policy_resource"] = {
        "description": "description_value",
        ...
        "terms": [
            {
                "actions": [
                    {"description": "description_value", "expression": "expression_value", "location": "location_value", "title": "title_value"}
                ],
                "match": {},
                "priority": 898,
            }
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRoutePolicyRouterRequest.meta.fields["route_policy_resource"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["route_policy_resource"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["route_policy_resource"][field])):
                    del request_init["route_policy_resource"][field][i][subfield]
            else:
                del request_init["route_policy_resource"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_patch_route_policy_rest_interceptors(null_interceptor):
    transport = transports.RoutersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RoutersRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_patch_route_policy") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_patch_route_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_patch_route_policy"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.PatchRoutePolicyRouterRequest.pb(compute.PatchRoutePolicyRouterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_preview_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_preview") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.RoutersPreviewResponse.to_json(compute.RoutersPreviewResponse())
        req.return_value.content = return_value
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRouterRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRouterRequest.pb(compute.TestIamPermissionsRouterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_update") as post, mock.patch.object(
...
def test_update_route_policy_rest_bad_request(request_type=compute.UpdateRoutePolicyRouterRequest):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "router": "sample3"}
    request = request_type(**request_init)
...
def test_update_route_policy_rest_call_success(request_type):
    client = RoutersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateRoutePolicyRouterRequest.meta.fields["route_policy_resource"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_route_policy_rest_interceptors(null_interceptor):
    transport = transports.RoutersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RoutersRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RoutersRestInterceptor, "post_update_route_policy") as post, mock.patch.object(
        transports.RoutersRestInterceptor, "post_update_route_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.RoutersRestInterceptor, "pre_update_route_policy"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateRoutePolicyRouterRequest.pb(compute.UpdateRoutePolicyRouterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_route_policy_unary_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport.delete_route_policy), "__call__") as call:
        client.delete_route_policy_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_nat_ip_info_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_nat_ip_info), "__call__") as call:
        client.get_nat_ip_info(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_nat_mapping_info_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_nat_mapping_info), "__call__") as call:
        client.get_nat_mapping_info(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_route_policy_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_route_policy), "__call__") as call:
        client.get_route_policy(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_router_status_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.get_router_status), "__call__") as call:
        client.get_router_status(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_bgp_routes_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport.list_bgp_routes), "__call__") as call:
        client.list_bgp_routes(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_route_policies_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport.list_route_policies), "__call__") as call:
        client.list_route_policies(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_patch_route_policy_unary_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport.patch_route_policy), "__call__") as call:
        client.patch_route_policy_unary(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_preview_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_route_policy_unary_empty_call_rest():
    client = RoutersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(type(client.transport.update_route_policy), "__call__") as call:
        client.update_route_policy_unary(request=None)
...
def test_routers_base_transport():
    ...
    with mock.patch("google.cloud.compute_v1beta.services.routers.transports.RoutersTransport.__init__") as Transport:
...
def test_routers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.routers.transports.RoutersTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_routers_client_transport_session_collision(transport_name):
    ...
    client1 = RoutersClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = RoutersClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    assert session1 != session2
    session1 = client1.transport.delete_route_policy._session
    session2 = client2.transport.delete_route_policy._session
    assert session1 != session2
    ...
    assert session1 != session2
    session1 = client1.transport.get_route_policy._session
    session2 = client2.transport.get_route_policy._session
    assert session1 != session2
    ...
    assert session1 != session2
    session1 = client1.transport.list_bgp_routes._session
    session2 = client2.transport.list_bgp_routes._session
    assert session1 != session2
    session1 = client1.transport.list_route_policies._session
    session2 = client2.transport.list_route_policies._session
    assert session1 != session2
    session1 = client1.transport.patch._session
    session2 = client2.transport.patch._session
    assert session1 != session2
    session1 = client1.transport.patch_route_policy._session
    session2 = client2.transport.patch_route_policy._session
    assert session1 != session2
    ...
    assert session1 != session2
    session1 = client1.transport.update_route_policy._session
    session2 = client2.transport.update_route_policy._session
    assert session1 != session2

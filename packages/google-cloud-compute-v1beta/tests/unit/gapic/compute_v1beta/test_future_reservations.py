...
from google.cloud.compute_v1beta.services.future_reservations import (
...
def test__get_client_cert_source():
    ...
    assert (
        FutureReservationsClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                FutureReservationsClient._get_client_cert_source(None, True)
...
def test_future_reservations_client_from_service_account_info(
    client_class, transport_name
):
...
def test_future_reservations_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_future_reservations_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_future_reservations_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_future_reservations_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    FutureReservationsClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(FutureReservationsClient),
)
...
def test_future_reservations_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_future_reservations_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListFutureReservationsRequest,
):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = compute.FutureReservationsAggregatedListResponse.pb(
                return_value
            )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/futureReservations"
...
def test_aggregated_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            compute.FutureReservationsAggregatedListResponse.to_json(x)
            for x in response
        )
        ...
        for result in results:
            ...
            assert tuple(type(t) for t in result) == (
                str,
                compute.FutureReservationsScopedList,
            )
...
def test_cancel_rest_required_fields(
    request_type=compute.CancelFutureReservationRequest,
):
    transport_class = transports.FutureReservationsRestTransport
...
def test_cancel_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/futureReservations/{future_reservation}/cancel"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_required_fields(
    request_type=compute.DeleteFutureReservationRequest,
):
    transport_class = transports.FutureReservationsRestTransport
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/futureReservations/{future_reservation}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_required_fields(
    request_type=compute.InsertFutureReservationRequest,
):
    transport_class = transports.FutureReservationsRestTransport
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/futureReservations"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            compute.FutureReservationsListResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_update_rest_required_fields(
    request_type=compute.UpdateFutureReservationRequest,
):
    transport_class = transports.FutureReservationsRestTransport
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.FutureReservationsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.FutureReservationsRestInterceptor(),
    )
    client = FutureReservationsClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_aggregated_list"
    ) as post, mock.patch.object(
        transports.FutureReservationsRestInterceptor,
        ...
        pb_message = compute.AggregatedListFutureReservationsRequest.pb(
            compute.AggregatedListFutureReservationsRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.FutureReservationsAggregatedListResponse.to_json(
            compute.FutureReservationsAggregatedListResponse()
        )
...
def test_cancel_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_cancel"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.CancelFutureReservationRequest.pb(
            compute.CancelFutureReservationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_delete"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteFutureReservationRequest.pb(
            compute.DeleteFutureReservationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_call_success(request_type):
    ...
    assert (
        response.auto_created_reservations_delete_time
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_get"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetFutureReservationRequest.pb(
            compute.GetFutureReservationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertFutureReservationRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["future_reservation_resource"][field])
                ):
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_insert"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertFutureReservationRequest.pb(
            compute.InsertFutureReservationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_list"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListFutureReservationsRequest.pb(
            compute.ListFutureReservationsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.FutureReservationsListResponse.to_json(
            compute.FutureReservationsListResponse()
        )
        req.return_value.content = return_value
...
def test_update_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateFutureReservationRequest.meta.fields[
        "future_reservation_resource"
    ]
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FutureReservationsRestInterceptor, "post_update"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateFutureReservationRequest.pb(
            compute.UpdateFutureReservationRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_future_reservations_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.future_reservations.transports.FutureReservationsTransport.__init__"
    ) as Transport:
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.FutureReservationsTransport, "_prep_wrapped_messages"
    ) as prep:
        client = FutureReservationsClient(
            credentials=ga_credentials.AnonymousCredentials(),

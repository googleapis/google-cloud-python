...
from google.cloud.compute_v1beta.services.disk_types import (
    DiskTypesClient,
    pagers,
    transports,
)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/diskTypes"
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/diskTypes/{disk_type}"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/diskTypes"
            % client.transport._host,
            args[1],
        )
...
def test_disk_types_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.disk_types.transports.DiskTypesTransport.__init__"
    ) as Transport:

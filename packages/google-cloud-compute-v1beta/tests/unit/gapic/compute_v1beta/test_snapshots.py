...
from google.cloud.compute_v1beta.services.snapshots import (
    SnapshotsClient,
    pagers,
    transports,
)
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListSnapshotsRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/snapshots"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{snapshot}"
            % client.transport._host,
            args[1],
        )
...
def test_get_effective_recycle_bin_rule_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SnapshotsClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_effective_recycle_bin_rule
        ...
        request = {}
        client.get_effective_recycle_bin_rule(request)
...
def test_get_effective_recycle_bin_rule_rest_required_fields(
    request_type=compute.GetEffectiveRecycleBinRuleSnapshotRequest,
):
    transport_class = transports.SnapshotsRestTransport
    ...
    default_values = getattr(
        transport_class._BaseGetEffectiveRecycleBinRule,
    ...
    # Designate an appropriate value for the returned response.
    return_value = compute.SnapshotsGetEffectiveRecycleBinRuleResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = compute.SnapshotsGetEffectiveRecycleBinRuleResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
            ...
            response = client.get_effective_recycle_bin_rule(request)
...
def test_get_effective_recycle_bin_rule_rest_flattened():
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_effective_recycle_bin_rule(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{snapshot}/getEffectiveRecycleBinRule"
            % client.transport._host,
            args[1],
        )


def test_get_effective_recycle_bin_rule_rest_flattened_error(transport: str = "rest"):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        client.get_effective_recycle_bin_rule(
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_kms_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{snapshot}/updateKmsKey"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_aggregated_list"
        ) as post,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_aggregated_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "pre_aggregated_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.AggregatedListSnapshotsRequest.pb(
            compute.AggregatedListSnapshotsRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SnapshotAggregatedList.to_json(
            compute.SnapshotAggregatedList()
        )
...
def test_get_effective_recycle_bin_rule_rest_bad_request(
    request_type=compute.GetEffectiveRecycleBinRuleSnapshotRequest,
):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_get_effective_recycle_bin_rule_rest_call_success(request_type):
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, compute.SnapshotsGetEffectiveRecycleBinRuleResponse)
    assert response.retention_duration_days == 2477


@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_effective_recycle_bin_rule_rest_interceptors(null_interceptor):
    transport = transports.SnapshotsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SnapshotsRestInterceptor(),
    )
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "post_get_effective_recycle_bin_rule"
        ) as post,
        mock.patch.object(
        ...
        mock.patch.object(
            transports.SnapshotsRestInterceptor, "pre_get_effective_recycle_bin_rule"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetEffectiveRecycleBinRuleSnapshotRequest.pb(
            compute.GetEffectiveRecycleBinRuleSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SnapshotsGetEffectiveRecycleBinRuleResponse.to_json(
        ...
        pre.return_value = request, metadata
        post.return_value = compute.SnapshotsGetEffectiveRecycleBinRuleResponse()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_effective_recycle_bin_rule_empty_call_rest():
    client = SnapshotsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.get_effective_recycle_bin_rule), "__call__"
    ) as call:
        client.get_effective_recycle_bin_rule(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetEffectiveRecycleBinRuleSnapshotRequest()
        assert args[0] == request_msg
...
def test_snapshots_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.snapshots.transports.SnapshotsTransport.__init__"
    ) as Transport:
    ...
    methods = (
        ...
        "delete",
        "get",
        "get_effective_recycle_bin_rule",
        "get_iam_policy",
        "insert",
        "list",
        "set_iam_policy",
...
def test_snapshots_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.compute_v1beta.services.snapshots.transports.SnapshotsTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_snapshots_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.get_effective_recycle_bin_rule._session
    session2 = client2.transport.get_effective_recycle_bin_rule._session
    assert session1 != session2

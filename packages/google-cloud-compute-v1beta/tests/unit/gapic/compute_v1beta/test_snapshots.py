...
from google.cloud.compute_v1beta.services.snapshots import SnapshotsClient, pagers, transports
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/snapshots/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.SnapshotsRestInterceptor, "post_aggregated_list") as post, mock.patch.object(

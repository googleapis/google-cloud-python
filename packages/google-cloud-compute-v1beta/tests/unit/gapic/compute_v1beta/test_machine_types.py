...
from google.cloud.compute_v1beta.services.machine_types import (
    MachineTypesClient,
    pagers,
    transports,
)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/machineTypes"
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/machineTypes/{machine_type}"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/machineTypes"
            % client.transport._host,
            args[1],
        )
...
def test_machine_types_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.machine_types.transports.MachineTypesTransport.__init__"
    ) as Transport:

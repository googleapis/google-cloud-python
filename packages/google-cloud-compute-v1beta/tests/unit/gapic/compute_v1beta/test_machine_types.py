...
from google.cloud.compute_v1beta.services.machine_types import MachineTypesClient, pagers, transports
...
def test_transport_kind_rest():
    transport = MachineTypesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.MachineTypesRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MachineTypesRestInterceptor, "post_get") as post, mock.patch.object(
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MachineTypesRestInterceptor, "post_list") as post, mock.patch.object(
...
def test_machine_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.machine_types.transports.MachineTypesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
from google.cloud.compute_v1beta.services.region_commitments import (
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/commitments"
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/commitments/{commitment}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/commitments"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsRegionCommitmentRequest,
):
    transport_class = transports.RegionCommitmentsRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/commitments/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_reservations_rest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_reservations in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_reservations] = (
            mock_rpc
        )
...
def test_update_reservations_rest_required_fields(
    request_type=compute.UpdateReservationsRegionCommitmentRequest,
):
    transport_class = transports.RegionCommitmentsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_reservations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_reservations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/commitments/{commitment}/updateReservations"
            % client.transport._host,
            args[1],
        )
...
def test_update_reservations_unary_rest_required_fields(
    request_type=compute.UpdateReservationsRegionCommitmentRequest,
):
    transport_class = transports.RegionCommitmentsRestTransport
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.CommitmentAggregatedList.to_json(
            compute.CommitmentAggregatedList()
        )
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsRegionCommitmentRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsRegionCommitmentRequest.pb(
            compute.TestIamPermissionsRegionCommitmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_reservations_rest_bad_request(
    request_type=compute.UpdateReservationsRegionCommitmentRequest,
):
    client = RegionCommitmentsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_update_reservations_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateReservationsRegionCommitmentRequest.meta.fields[
        "region_commitments_update_reservations_request_resource"
    ]
...
def test_update_reservations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateReservationsRegionCommitmentRequest.pb(
            compute.UpdateReservationsRegionCommitmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_reservations_unary_empty_call_rest():
    ...
    # Mock the actual call, and fake the request.
    with mock.patch.object(
        type(client.transport.update_reservations), "__call__"
    ) as call:
...
def test_region_commitments_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_commitments.transports.RegionCommitmentsTransport.__init__"
    ) as Transport:

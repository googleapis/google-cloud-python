...
from google.cloud.compute_v1beta.services.firewalls import (
    FirewallsClient,
    pagers,
    transports,
)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/firewalls/{firewall}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/firewalls"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/firewalls/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_firewalls_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.firewalls.transports.FirewallsTransport.__init__"
    ) as Transport:
...
def test_firewalls_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1beta.services.firewalls.transports.FirewallsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

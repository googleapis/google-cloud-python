...
from google.cloud.compute_v1beta.services.instance_groups import (
...
def test_add_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups/{instance_group}/addInstances"
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/instanceGroups"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups/{instance_group}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups"
            % client.transport._host,
            args[1],
        )
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups/{instance_group}/listInstances"
            % client.transport._host,
            args[1],
        )
...
def test_remove_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups/{instance_group}/removeInstances"
            % client.transport._host,
            args[1],
        )
...
def test_set_named_ports_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups/{instance_group}/setNamedPorts"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/zones/{zone}/instanceGroups/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_instance_groups_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.instance_groups.transports.InstanceGroupsTransport.__init__"
    ) as Transport:

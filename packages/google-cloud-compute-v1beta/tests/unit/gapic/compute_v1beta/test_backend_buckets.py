...
from google.cloud.compute_v1beta.services.backend_buckets import BackendBucketsClient, pagers, transports
...
def test_add_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/addSignedUrlKey" % client.transport._host, args[1]
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}" % client.transport._host, args[1])
...
def test_delete_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/deleteSignedUrlKey" % client.transport._host, args[1]
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{resource}/getIamPolicy" % client.transport._host, args[1]
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/backendBuckets" % client.transport._host, args[1])
...
def test_list_usable_rest_required_fields(request_type=compute.ListUsableBackendBucketsRequest):
    transport_class = transports.BackendBucketsRestTransport
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/backendBuckets/listUsable" % client.transport._host, args[1])
...
def test_set_edge_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/setEdgeSecurityPolicy" % client.transport._host, args[1]
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{resource}/setIamPolicy" % client.transport._host, args[1]
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_list_usable_rest_bad_request(request_type=compute.ListUsableBackendBucketsRequest):
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, "post_list_usable") as post, mock.patch.object(
        transports.BackendBucketsRestInterceptor, "post_list_usable_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.BackendBucketsRestInterceptor, "pre_list_usable"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListUsableBackendBucketsRequest.pb(compute.ListUsableBackendBucketsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.BackendBucketListUsable.to_json(compute.BackendBucketListUsable())
        req.return_value.content = return_value
...
def test_list_usable_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list_usable), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListUsableBackendBucketsRequest()
...
def test_backend_buckets_base_transport():
    ...
    with mock.patch("google.cloud.compute_v1beta.services.backend_buckets.transports.BackendBucketsTransport.__init__") as Transport:
...
def test_backend_buckets_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.backend_buckets.transports.BackendBucketsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

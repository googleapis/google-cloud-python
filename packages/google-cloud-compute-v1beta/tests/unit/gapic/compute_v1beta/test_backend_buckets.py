...
from google.cloud.compute_v1beta.services.backend_buckets import (
...
def test_add_signed_url_key_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAddSignedUrlKey,
...
def test_add_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/addSignedUrlKey"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_signed_url_key_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSignedUrlKey,
...
def test_delete_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/deleteSignedUrlKey"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets"
            % client.transport._host,
            args[1],
        )
...
def test_list_usable_rest_required_fields(
    request_type=compute.ListUsableBackendBucketsRequest,
):
    transport_class = transports.BackendBucketsRestTransport
...
def test_list_usable_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/listUsable"
            % client.transport._host,
            args[1],
        )
...
def test_set_edge_security_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetEdgeSecurityPolicy,
...
def test_set_edge_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{backend_bucket}/setEdgeSecurityPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/backendBuckets/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.BackendBucketsRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.BackendBucketsRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.BackendBucketsRestInterceptor, "post_list_usable"
        ) as post,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListUsableBackendBucketsRequest.pb(
            compute.ListUsableBackendBucketsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(transports.BackendBucketsRestInterceptor, "pre_patch") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_backend_buckets_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.backend_buckets.transports.BackendBucketsTransport.__init__"
    ) as Transport:

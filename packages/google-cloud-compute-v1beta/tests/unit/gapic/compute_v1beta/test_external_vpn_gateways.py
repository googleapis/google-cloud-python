...
from google.cloud.compute_v1beta.services.external_vpn_gateways import (
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/externalVpnGateways/{external_vpn_gateway}"
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/externalVpnGateways"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/externalVpnGateways/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/externalVpnGateways/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_external_vpn_gateways_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.external_vpn_gateways.transports.ExternalVpnGatewaysTransport.__init__"
    ) as Transport:

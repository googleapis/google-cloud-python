...
from google.cloud.compute_v1beta.services.target_tcp_proxies import (
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/targetTcpProxies"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetTcpProxies/{target_tcp_proxy}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetTcpProxies"
            % client.transport._host,
            args[1],
        )
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetTcpProxies/{target_tcp_proxy}/setBackendService"
            % client.transport._host,
            args[1],
        )
...
def test_set_proxy_header_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetTcpProxies/{target_tcp_proxy}/setProxyHeader"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/targetTcpProxies/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_target_tcp_proxies_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.target_tcp_proxies.transports.TargetTcpProxiesTransport.__init__"
    ) as Transport:

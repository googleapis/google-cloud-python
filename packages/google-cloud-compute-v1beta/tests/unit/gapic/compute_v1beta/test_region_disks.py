...
from google.cloud.compute_v1beta.services.region_disks import (
    RegionDisksClient,
    pagers,
    transports,
)
...
def test_add_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/addResourcePolicies"
...
def test_bulk_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/bulkInsert"
            % client.transport._host,
            args[1],
        )
...
def test_create_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/createSnapshot"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}"
            % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{resource}/getIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks"
            % client.transport._host,
            args[1],
        )
...
def test_remove_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/removeResourcePolicies"
            % client.transport._host,
            args[1],
        )
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/resize"
            % client.transport._host,
            args[1],
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{resource}/setLabels"
            % client.transport._host,
            args[1],
        )
...
def test_start_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/startAsyncReplication"
            % client.transport._host,
            args[1],
        )
...
def test_stop_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/stopAsyncReplication"
            % client.transport._host,
            args[1],
        )
...
def test_stop_group_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/stopGroupAsyncReplication"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_update_kms_key_rest_required_fields(
    request_type=compute.UpdateKmsKeyRegionDiskRequest,
):
    transport_class = transports.RegionDisksRestTransport
...
def test_update_kms_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        mock_args = dict(
            ...
            region="region_value",
            disk="disk_value",
            region_disk_update_kms_key_request_resource=compute.RegionDiskUpdateKmsKeyRequest(
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/regions/{region}/disks/{disk}/updateKmsKey"
            % client.transport._host,
            args[1],
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_delete") as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_delete") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_get") as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_get") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_insert") as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_insert") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_list") as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_list") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_resize_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_resize") as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_resize_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_resize") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with (
        mock.patch.object(type(client.transport._session), "request") as req,
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(transports.RegionDisksRestInterceptor, "post_update") as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_update_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(transports.RegionDisksRestInterceptor, "pre_update") as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_kms_key_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "region": "sample2", "disk": "sample3"}
    request_init["region_disk_update_kms_key_request_resource"] = {
        "kms_key_name": "kms_key_name_value"
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.UpdateKmsKeyRegionDiskRequest.meta.fields[
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    ...
                    del request_init["region_disk_update_kms_key_request_resource"][
                        field
                    ][i][subfield]
            else:
                del request_init["region_disk_update_kms_key_request_resource"][field][
                    subfield
                ]
    request = request_type(**request_init)
...
def test_update_kms_key_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_update_kms_key"
        ) as post,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "post_update_kms_key_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.RegionDisksRestInterceptor, "pre_update_kms_key"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.UpdateKmsKeyRegionDiskRequest.pb(
            compute.UpdateKmsKeyRegionDiskRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        request = compute.UpdateKmsKeyRegionDiskRequest()
        metadata = [
            ("key", "val"),
            ("cephalopod", "squid"),
        ]
...
def test_region_disks_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.region_disks.transports.RegionDisksTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.ssl_certificates import (
...
def test__get_client_cert_source():
    ...
    assert (
        SslCertificatesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SslCertificatesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SslCertificatesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                SslCertificatesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SslCertificatesClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SslCertificatesClient._DEFAULT_UNIVERSE
    default_endpoint = SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SslCertificatesClient._get_api_endpoint(
    ...
    assert (
        SslCertificatesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SslCertificatesClient._get_api_endpoint(None, None, default_universe, "always")
        == SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SslCertificatesClient._get_api_endpoint(
    ...
    assert (
        SslCertificatesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SslCertificatesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SslCertificatesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SslCertificatesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SslCertificatesClient._get_universe_domain(None, None)
        == SslCertificatesClient._DEFAULT_UNIVERSE
    )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/aggregated/sslCertificates"
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslCertificates/{ssl_certificate}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslCertificates"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsSslCertificateRequest,
):
    transport_class = transports.SslCertificatesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslCertificates/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pb_message = compute.AggregatedListSslCertificatesRequest.pb(
            compute.AggregatedListSslCertificatesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SslCertificateAggregatedList.to_json(
            compute.SslCertificateAggregatedList()
        )
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.DeleteSslCertificateRequest.pb(
            compute.DeleteSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.GetSslCertificateRequest.pb(
            compute.GetSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest_call_success(request_type):
    ...
    test_field = compute.InsertSslCertificateRequest.meta.fields[
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.InsertSslCertificateRequest.pb(
            compute.InsertSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.ListSslCertificatesRequest.pb(
            compute.ListSslCertificatesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsSslCertificateRequest.meta.fields[
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.SslCertificatesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsSslCertificateRequest.pb(
            compute.TestIamPermissionsSslCertificateRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_ssl_certificates_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1beta.services.ssl_certificates.transports.SslCertificatesTransport.__init__"
    ) as Transport:

...
from google.cloud.compute_v1beta.services.ssl_certificates import SslCertificatesClient, pagers, transports
...
def test__read_environment_variables():
    assert SslCertificatesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SslCertificatesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert SslCertificatesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SslCertificatesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SslCertificatesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SslCertificatesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SslCertificatesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SslCertificatesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SslCertificatesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert SslCertificatesClient._get_client_cert_source(None, False) is None
    assert SslCertificatesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SslCertificatesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert SslCertificatesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SslCertificatesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(SslCertificatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SslCertificatesClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SslCertificatesClient._DEFAULT_UNIVERSE
    default_endpoint = SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SslCertificatesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        SslCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SslCertificatesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SslCertificatesClient._get_api_endpoint(None, None, default_universe, "always") == SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
    assert (
        SslCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SslCertificatesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SslCertificatesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SslCertificatesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SslCertificatesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SslCertificatesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SslCertificatesClient._get_universe_domain(None, None) == SslCertificatesClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        SslCertificatesClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SslCertificatesClient(credentials=cred)
...
@pytest.mark.parametrize("client_class", [SslCertificatesClient])
@mock.patch.object(SslCertificatesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SslCertificatesClient))
def test_ssl_certificates_client_client_api_endpoint(client_class):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/compute/beta/projects/{project}/aggregated/sslCertificates" % client.transport._host, args[1])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/sslCertificates/{ssl_certificate}" % client.transport._host, args[1])
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/beta/projects/{project}/global/sslCertificates" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsSslCertificateRequest):
    transport_class = transports.SslCertificatesRestTransport
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/beta/projects/{project}/global/sslCertificates/{resource}/testIamPermissions" % client.transport._host, args[1]
        )
...
def test_transport_kind_rest():
    transport = SslCertificatesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_aggregated_list_rest_bad_request(request_type=compute.AggregatedListSslCertificatesRequest):
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.SslCertificatesRestInterceptor, "post_aggregated_list") as post, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "post_aggregated_list_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = compute.SslCertificateAggregatedList.to_json(compute.SslCertificateAggregatedList())
        ...
        post_with_metadata.return_value = compute.SslCertificateAggregatedList(), metadata
...
def test_delete_rest_bad_request(request_type=compute.DeleteSslCertificateRequest):
    client = SslCertificatesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SslCertificatesRestInterceptor, "post_delete") as post, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "post_delete_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_rest_bad_request(request_type=compute.GetSslCertificateRequest):
    client = SslCertificatesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "ssl_certificate": "sample2"}
    request = request_type(**request_init)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SslCertificatesRestInterceptor, "post_get") as post, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "post_get_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_insert_rest_bad_request(request_type=compute.InsertSslCertificateRequest):
    client = SslCertificatesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["ssl_certificate_resource"] = {
        ...
        "id": 205,
        "kind": "kind_value",
        "managed": {"domain_status": {}, "domains": ["domains_value1", "domains_value2"], "status": "status_value"},
        "name": "name_value",
        "private_key": "private_key_value",
        "region": "region_value",
        "self_link": "self_link_value",
        "self_managed": {"certificate": "certificate_value", "private_key": "private_key_value"},
        "subject_alternative_names": ["subject_alternative_names_value1", "subject_alternative_names_value2"],
        "type_": "type__value",
    }
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SslCertificatesRestInterceptor, "post_insert") as post, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "post_insert_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_rest_bad_request(request_type=compute.ListSslCertificatesRequest):
    client = SslCertificatesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request = request_type(**request_init)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SslCertificatesRestInterceptor, "post_list") as post, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "post_list_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_test_iam_permissions_rest_bad_request(request_type=compute.TestIamPermissionsSslCertificateRequest):
    client = SslCertificatesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_test_iam_permissions_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsSslCertificateRequest.meta.fields["test_permissions_request_resource"]
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SslCertificatesRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SslCertificatesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = compute.TestIamPermissionsSslCertificateRequest.pb(compute.TestIamPermissionsSslCertificateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_aggregated_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.aggregated_list), "__call__") as call:
        ...
        request_msg = compute.AggregatedListSslCertificatesRequest()
...
def test_delete_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.DeleteSslCertificateRequest()
...
def test_get_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.GetSslCertificateRequest()
...
def test_insert_unary_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.InsertSslCertificateRequest()
...
def test_list_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.ListSslCertificatesRequest()
...
def test_test_iam_permissions_empty_call_rest():
    ...
    with mock.patch.object(type(client.transport.test_iam_permissions), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = compute.TestIamPermissionsSslCertificateRequest()
...
def test_ssl_certificates_base_transport():
    ...
    with mock.patch("google.cloud.compute_v1beta.services.ssl_certificates.transports.SslCertificatesTransport.__init__") as Transport:
...
def test_ssl_certificates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.compute_v1beta.services.ssl_certificates.transports.SslCertificatesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_ssl_certificates_client_transport_session_collision(transport_name):
    ...
    client1 = SslCertificatesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SslCertificatesClient(
        credentials=creds2,
        transport=transport_name,
    )

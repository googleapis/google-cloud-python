...
class computeCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'add_packet_mirroring_rule': ('firewall_policy', 'firewall_policy_rule_resource', 'request_id', ),
        ...
        'add_traffic_classification_rule': ('network_policy', 'network_policy_traffic_classification_rule_resource', 'project', 'region', 'request_id', ),
        ...
        'calendar_mode': ('calendar_mode_advice_request_resource', 'project', 'region', ),
        'cancel': ('future_reservation', 'project', 'zone', 'request_id', ),
        ...
        'get_available_accelerator_topologies': ('project', 'resource_id', 'zone', ),
        ...
        'get_packet_mirroring_rule': ('firewall_policy', 'priority', ),
        'get_partner_metadata': ('instance', 'project', 'zone', 'namespaces', ),
        ...
        'get_shielded_vm_identity': ('instance', 'project', 'zone', ),
        'get_status': ('project', 'region', 'vpn_gateway', ),
        'get_traffic_classification_rule': ('network_policy', 'project', 'region', 'priority', ),
        ...
        'invalidate_cache': ('cache_invalidation_rule_resource', 'project', 'region', 'url_map', 'request_id', ),
        'list': ('project', 'zone', 'filter', 'max_results', 'order_by', 'page_token', 'return_partial_success', ),
        'list_associations': ('include_inherited_policies', 'target_resource', ),
        ...
        'patch_association': ('firewall_policy', 'firewall_policy_association_resource', 'project', 'region', 'request_id', ),
        'patch_packet_mirroring_rule': ('firewall_policy', 'firewall_policy_rule_resource', 'priority', 'request_id', ),
        'patch_partner_metadata': ('instance', 'partner_metadata_resource', 'project', 'zone', 'request_id', ),
        ...
        'patch_traffic_classification_rule': ('network_policy', 'network_policy_traffic_classification_rule_resource', 'project', 'region', 'priority', 'request_id', ),
        ...
        'remove_packet_mirroring_rule': ('firewall_policy', 'priority', 'request_id', ),
        ...
        'remove_traffic_classification_rule': ('network_policy', 'project', 'region', 'priority', 'request_id', ),
        ...
        'resize_advanced': ('instance_group_manager', 'instance_group_managers_resize_advanced_request_resource', 'project', 'zone', 'request_id', ),
        'resume': ('instance', 'instances_resume_request_resource', 'project', 'zone', 'request_id', ),
        ...
        'set_auto_healing_policies': ('instance_group_manager', 'instance_group_managers_set_auto_healing_request_resource', 'project', 'zone', 'request_id', ),
        ...
        'set_managed_protection_tier': ('project', 'projects_set_managed_protection_tier_request_resource', 'request_id', ),
        ...
        'set_shielded_vm_integrity_policy': ('instance', 'project', 'shielded_vm_integrity_policy_resource', 'zone', 'request_id', ),
        ...
        'stop': ('instance', 'project', 'zone', 'discard_local_ssd', 'no_graceful_shutdown', 'request_id', ),
        ...
        'update_reservations': ('commitment', 'project', 'region', 'region_commitments_update_reservations_request_resource', 'request_id', ),
        ...
        'update_shielded_vm_config': ('instance', 'project', 'shielded_vm_config_resource', 'zone', 'request_id', ),

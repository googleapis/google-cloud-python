...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.FirewallList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.FirewallList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListFirewallsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.FirewallList):

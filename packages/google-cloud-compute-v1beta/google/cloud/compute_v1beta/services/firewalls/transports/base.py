...
class FirewallsTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteFirewallRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetFirewallRequest], Union[compute.Firewall, Awaitable[compute.Firewall]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertFirewallRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListFirewallsRequest], Union[compute.FirewallList, Awaitable[compute.FirewallList]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchFirewallRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def test_iam_permissions(
        self,
    ) -> Callable[[compute.TestIamPermissionsFirewallRequest], Union[compute.TestPermissionsResponse, Awaitable[compute.TestPermissionsResponse]]]:
        raise NotImplementedError()

    @property
    def update(self) -> Callable[[compute.UpdateFirewallRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

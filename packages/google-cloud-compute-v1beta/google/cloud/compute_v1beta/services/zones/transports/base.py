...
class ZonesTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetZoneRequest], Union[compute.Zone, Awaitable[compute.Zone]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListZonesRequest], Union[compute.ZoneList, Awaitable[compute.ZoneList]]]:
        raise NotImplementedError()

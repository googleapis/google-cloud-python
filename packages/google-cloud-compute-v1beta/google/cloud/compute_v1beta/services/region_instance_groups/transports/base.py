...
class RegionInstanceGroupsTransport(abc.ABC):
    """Abstract transport class for RegionInstanceGroups."""
    ...
    @property
    def get(self) -> Callable[[compute.GetRegionInstanceGroupRequest], Union[compute.InstanceGroup, Awaitable[compute.InstanceGroup]]]:
        raise NotImplementedError()

    @property
    def list(
        self,
    ) -> Callable[[compute.ListRegionInstanceGroupsRequest], Union[compute.RegionInstanceGroupList, Awaitable[compute.RegionInstanceGroupList]]]:
        raise NotImplementedError()
    ...
    def list_instances(
        ...
        Union[compute.RegionInstanceGroupsListInstances, Awaitable[compute.RegionInstanceGroupsListInstances]],
    ]:
        raise NotImplementedError()

    @property
    def set_named_ports(self) -> Callable[[compute.SetNamedPortsRegionInstanceGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsRegionInstanceGroupRequest], Union[compute.TestPermissionsResponse, Awaitable[compute.TestPermissionsResponse]]
    ]:
        raise NotImplementedError()

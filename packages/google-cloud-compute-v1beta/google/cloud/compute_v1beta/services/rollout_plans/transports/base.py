...
class RolloutPlansTransport(abc.ABC):
    """Abstract transport class for RolloutPlans."""
    ...
    def delete(
        ...
        [compute.DeleteRolloutPlanRequest],
    ...
    def get(
        ...
        [compute.GetRolloutPlanRequest],
        Union[compute.RolloutPlan, Awaitable[compute.RolloutPlan]],
    ]:
        raise NotImplementedError()
    ...
    def insert(
        ...
        [compute.InsertRolloutPlanRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListRolloutPlansRequest],
        Union[
            compute.RolloutPlansListResponse,
            Awaitable[compute.RolloutPlansListResponse],
        ],
    ]:
        raise NotImplementedError()

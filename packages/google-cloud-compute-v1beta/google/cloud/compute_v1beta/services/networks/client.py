...
class NetworksClient(metaclass=NetworksClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=NetworksClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=NetworksClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=NetworksClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def cancel_request_remove_peering_unary(
        self,
        request: Optional[
            Union[compute.CancelRequestRemovePeeringNetworkRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        network: Optional[str] = None,
        networks_cancel_request_remove_peering_request_resource: Optional[
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.CancelRequestRemovePeeringNetworkRequest, dict]):
                The request object. A request message for
            ...
            network (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            networks_cancel_request_remove_peering_request_resource (google.cloud.compute_v1beta.types.NetworksCancelRequestRemovePeeringRequest):
                The body resource for this request
                This corresponds to the ``networks_cancel_request_remove_peering_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.CancelRequestRemovePeeringNetworkRequest):
            request = compute.CancelRequestRemovePeeringNetworkRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if network is not None:
                request.network = network
            if networks_cancel_request_remove_peering_request_resource is not None:
                request.networks_cancel_request_remove_peering_request_resource = (
                    networks_cancel_request_remove_peering_request_resource
                )
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.cancel_request_remove_peering
        ]

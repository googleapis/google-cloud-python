...
class RegionMultiMigsTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteRegionMultiMigRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetRegionMultiMigRequest], Union[compute.MultiMig, Awaitable[compute.MultiMig]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertRegionMultiMigRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListRegionMultiMigsRequest], Union[compute.MultiMigsList, Awaitable[compute.MultiMigsList]]]:
        raise NotImplementedError()
...
__all__ = ("RegionMultiMigsTransport",)

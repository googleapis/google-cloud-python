...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.DiskList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.DiskList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionDisksRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.DiskList):
        ...
        """
        self._method = method
        self._request = compute.ListRegionDisksRequest(request)

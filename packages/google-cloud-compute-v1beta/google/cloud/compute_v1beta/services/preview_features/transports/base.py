...
class PreviewFeaturesTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetPreviewFeatureRequest], Union[compute.PreviewFeature, Awaitable[compute.PreviewFeature]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListPreviewFeaturesRequest], Union[compute.PreviewFeatureList, Awaitable[compute.PreviewFeatureList]]]:
        raise NotImplementedError()

    @property
    def update(self) -> Callable[[compute.UpdatePreviewFeatureRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

...
class AddressesClient(metaclass=AddressesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=AddressesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=AddressesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=AddressesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.AddressesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListAddressesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListAddressesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.addresses.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteAddressRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteAddressRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetAddressRequest(
                    address="address_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetAddressRequest, dict]):
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertAddressRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            address_resource (google.cloud.compute_v1beta.types.Address):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListAddressesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListAddressesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.addresses.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_move():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.MoveAddressRequest(
                    address="address_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.MoveAddressRequest, dict]):
            ...
            address (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_addresses_move_request_resource (google.cloud.compute_v1beta.types.RegionAddressesMoveRequest):
                The body resource for this request
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsAddressRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsAddressRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsAddressRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsAddressRequest, dict]):
                The request object. A request message for

...
class AutoscalersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class AutoscalersRestTransport(_BaseAutoscalersRestTransport):
    ...
    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsAutoscalerRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

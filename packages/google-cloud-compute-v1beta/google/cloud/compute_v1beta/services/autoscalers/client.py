...
class AutoscalersClient(metaclass=AutoscalersClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, AutoscalersTransport, Callable[..., AutoscalersTransport]]
        ] = None,
        ...
        ) = AutoscalersClient._read_environment_variables()
        self._client_cert_source = AutoscalersClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AutoscalersClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AutoscalersTransport], Callable[..., AutoscalersTransport]
            ] = (
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsAutoscalerRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,

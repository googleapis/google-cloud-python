...
class RegionAutoscalersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsRegionAutoscalerRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsRegionAutoscalerRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionAutoscalersRestTransport(_BaseRegionAutoscalersRestTransport):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.Delete",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Delete",
        ...
        def __call__(
            ...
            *,
            ...
            Returns:
                ...
                `Zonal </compute/docs/reference/rest/beta/autoscalers>`__
                \*
                `Regional </compute/docs/reference/rest/beta/regionAutoscalers>`__
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseRegionAutoscalersRestTransport._BaseTestIamPermissions, RegionAutoscalersRestStub):
        def __hash__(self):
            return hash("RegionAutoscalersRestTransport.TestIamPermissions")
        ...
        def __call__(
            self,
            request: compute.TestIamPermissionsRegionAutoscalerRequest,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ...
            http_options = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
            ...
            # Send the request
            response = RegionAutoscalersRestTransport._TestIamPermissions._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionAutoscalersClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionAutoscalersClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionAutoscalers",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
    ...
    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsRegionAutoscalerRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class RegionAutoscalersRestTransport(_BaseRegionAutoscalersRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionAutoscalersRestInterceptor]): Interceptor used
    ...
    class _TestIamPermissions(
        _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions,
        RegionAutoscalersRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionAutoscalersRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )

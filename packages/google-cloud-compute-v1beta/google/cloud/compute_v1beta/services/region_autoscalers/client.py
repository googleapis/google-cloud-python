...
class RegionAutoscalersClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RegionAutoscalersTransport]]
...
class RegionAutoscalersClient(metaclass=RegionAutoscalersClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionAutoscalersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionAutoscalersClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionAutoscalersClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionAutoscalersClient._get_api_endpoint(
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionAutoscalerRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

...
class RecoverableSnapshotsTransport(abc.ABC):
    """Abstract transport class for RecoverableSnapshots."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.recover: gapic_v1.method.wrap_method(
                self.recover,
                default_timeout=600.0,
                client_info=client_info,
            ),
    ...
    def delete(
        ...
        [compute.DeleteRecoverableSnapshotRequest],
    ...
    def get(
        ...
        [compute.GetRecoverableSnapshotRequest],
        Union[compute.RecoverableSnapshot, Awaitable[compute.RecoverableSnapshot]],
    ]:
        raise NotImplementedError()
    ...
    def get_iam_policy(
        ...
        [compute.GetIamPolicyRecoverableSnapshotRequest],
    ...
    def list(
        ...
        [compute.ListRecoverableSnapshotsRequest],
        Union[
            compute.RecoverableSnapshotList, Awaitable[compute.RecoverableSnapshotList]
        ],
    ]:
        raise NotImplementedError()
    ...
    def recover(
        ...
        [compute.RecoverRecoverableSnapshotRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
    ...
    def set_iam_policy(
        ...
        [compute.SetIamPolicyRecoverableSnapshotRequest],
        Union[compute.Policy, Awaitable[compute.Policy]],
    ]:
        raise NotImplementedError()
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsRecoverableSnapshotRequest],
        Union[
...
__all__ = ("RecoverableSnapshotsTransport",)

...
class DisksClient(metaclass=DisksClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DisksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DisksTransport, Callable[..., DisksTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DisksClient._read_environment_variables()
        self._client_cert_source = DisksClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DisksClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DisksTransport], Callable[..., DisksTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.DisksClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_add_resource_policies():
                ...
                request = compute_v1beta.AddResourcePoliciesDiskRequest(
                    disk="disk_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddResourcePoliciesDiskRequest, dict]):
            ...
            disk (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            disks_add_resource_policies_request_resource (google.cloud.compute_v1beta.types.DisksAddResourcePoliciesRequest):
        ...
        flattened_params = [project, zone, disk, disks_add_resource_policies_request_resource]
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListDisksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.disks.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_bulk_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.BulkInsertDiskRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.BulkInsertDiskRequest, dict]):
                The request object. A request message for
    ...
    def bulk_set_labels_unary(
        ...
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        bulk_zone_set_labels_request_resource: Optional[compute.BulkZoneSetLabelsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.BulkSetLabelsDiskRequest, dict]):
                The request object. A request message for
            ...
            zone (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            bulk_zone_set_labels_request_resource (google.cloud.compute_v1beta.types.BulkZoneSetLabelsRequest):
                The body resource for this request
        ...
        if not isinstance(request, compute.BulkSetLabelsDiskRequest):
            ...
            if bulk_zone_set_labels_request_resource is not None:
                request.bulk_zone_set_labels_request_resource = bulk_zone_set_labels_request_resource
    ...
    def create_snapshot_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.CreateSnapshotDiskRequest, dict]):
                The request object. A request message for
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteDiskRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetDiskRequest(
                    disk="disk_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetDiskRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyDiskRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyDiskRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertDiskRequest, dict]):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListDisksRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.disks.pagers.ListPager:
    ...
    def remove_resource_policies_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.RemoveResourcePoliciesDiskRequest, dict]):
                The request object. A request message for
            ...
            disk (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            disks_remove_resource_policies_request_resource (google.cloud.compute_v1beta.types.DisksRemoveResourcePoliciesRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, disk, disks_remove_resource_policies_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def resize_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ResizeDiskRequest, dict]):
            ...
            disk (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            disks_resize_request_resource (google.cloud.compute_v1beta.types.DisksResizeRequest):
                The body resource for this request
    ...
    def set_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyDiskRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsDiskRequest(
                    project="project_value",
                    resource="resource_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsDiskRequest, dict]):
                The request object. A request message for
    ...
    def start_async_replication_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.StartAsyncReplicationDiskRequest, dict]):
                The request object. A request message for
            ...
            disk (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            disks_start_async_replication_request_resource (google.cloud.compute_v1beta.types.DisksStartAsyncReplicationRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, disk, disks_start_async_replication_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_stop_async_replication():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.StopAsyncReplicationDiskRequest(
                    disk="disk_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.StopAsyncReplicationDiskRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_stop_group_async_replication():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.StopGroupAsyncReplicationDiskRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.StopGroupAsyncReplicationDiskRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, disks_stop_group_async_replication_resource_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsDiskRequest(
                    project="project_value",
                    resource="resource_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsDiskRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateDiskRequest, dict]):

...
class DisksClient(metaclass=DisksClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=DisksClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=DisksClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=DisksClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def update_kms_key_unary(
        self,
        request: Optional[Union[compute.UpdateKmsKeyDiskRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        disk: Optional[str] = None,
        disk_update_kms_key_request_resource: Optional[
            compute.DiskUpdateKmsKeyRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_update_kms_key():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdateKmsKeyDiskRequest(
                    disk="disk_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateKmsKeyDiskRequest, dict]):
                The request object. A request message for
            ...
            disk (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            disk_update_kms_key_request_resource (google.cloud.compute_v1beta.types.DiskUpdateKmsKeyRequest):
                The body resource for this request
                This corresponds to the ``disk_update_kms_key_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.UpdateKmsKeyDiskRequest):
            request = compute.UpdateKmsKeyDiskRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if disk is not None:
                request.disk = disk
            if disk_update_kms_key_request_resource is not None:
                request.disk_update_kms_key_request_resource = (

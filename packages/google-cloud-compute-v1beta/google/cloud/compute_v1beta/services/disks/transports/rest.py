        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.DisksClient.UpdateKmsKey",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Disks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.DisksClient.update_kms_key",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Disks",
                        "rpcName": "UpdateKmsKey",
                        "metadata": http_response["headers"],

    ...
    class _BaseAddResourcePolicies:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/addResourcePolicies",
    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/aggregated/disks",
                },
            ]
            return http_options
    ...
    class _BaseBulkInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/bulkInsert",
    ...
    class _BaseBulkSetLabels:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/bulkSetLabels",
    ...
    class _BaseCreateSnapshot:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/createSnapshot",
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}",
                },
            ]
            return http_options
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/getIamPolicy",
                },
            ]
            return http_options
    ...
    class _BaseRemoveResourcePolicies:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/removeResourcePolicies",
    ...
    class _BaseResize:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/resize",
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/setIamPolicy",
    ...
    class _BaseSetLabels:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/setLabels",
    ...
    class _BaseStartAsyncReplication:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/startAsyncReplication",
    ...
    class _BaseStopAsyncReplication:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/stopAsyncReplication",
                },
            ]
            return http_options
    ...
    class _BaseStopGroupAsyncReplication:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/stopGroupAsyncReplication",
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{resource}/testIamPermissions",
    ...
    class _BaseUpdateKmsKey:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/disks/{disk}/updateKmsKey",

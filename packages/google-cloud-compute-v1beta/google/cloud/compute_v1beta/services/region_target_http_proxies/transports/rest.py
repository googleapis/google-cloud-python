...
class RegionTargetHttpProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(
        ...
        compute.TestIamPermissionsRegionTargetHttpProxyRequest,
        Sequence[Tuple[str, Union[str, bytes]]],
    ]:
...
class RegionTargetHttpProxiesRestTransport(_BaseRegionTargetHttpProxiesRestTransport):
    ...
    class _TestIamPermissions(
        _BaseRegionTargetHttpProxiesRestTransport._BaseTestIamPermissions,
        RegionTargetHttpProxiesRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseRegionTargetHttpProxiesRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionTargetHttpProxiesRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionTargetHttpProxiesRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = (
                RegionTargetHttpProxiesRestTransport._TestIamPermissions._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,

...
from google.cloud.compute_v1beta.services.region_target_http_proxies import pagers
from google.cloud.compute_v1beta.types import compute

from .transports.base import DEFAULT_CLIENT_INFO, RegionTargetHttpProxiesTransport
from .transports.rest import RegionTargetHttpProxiesRestTransport


class RegionTargetHttpProxiesClientMeta(type):
    """Metaclass for the RegionTargetHttpProxies client.
...
class RegionTargetHttpProxiesClient(metaclass=RegionTargetHttpProxiesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionTargetHttpProxiesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionTargetHttpProxiesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionTargetHttpProxiesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RegionTargetHttpProxiesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionTargetHttpProxiesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionTargetHttpProxiesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionTargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionTargetHttpProxiesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionTargetHttpProxiesTransport, Callable[..., RegionTargetHttpProxiesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionTargetHttpProxiesTransport,Callable[..., RegionTargetHttpProxiesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionTargetHttpProxiesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionTargetHttpProxiesClient._read_environment_variables()
        self._client_cert_source = RegionTargetHttpProxiesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionTargetHttpProxiesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionTargetHttpProxiesTransport)
        if transport_provided:
            # transport is a RegionTargetHttpProxiesTransport instance.
            ...
            self._transport = cast(RegionTargetHttpProxiesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RegionTargetHttpProxiesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionTargetHttpProxiesTransport], Callable[..., RegionTargetHttpProxiesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionTargetHttpProxiesClient`.",
                    extra={
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteRegionTargetHttpProxyRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                # Create a client
                client = compute_v1beta.RegionTargetHttpProxiesClient()

                # Initialize request argument(s)
                request = compute_v1beta.DeleteRegionTargetHttpProxyRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionTargetHttpProxyRequest, dict]):
        ...
        flattened_params = [project, region, target_http_proxy]
    ...
    def get(
        self,
        request: Optional[Union[compute.GetRegionTargetHttpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        target_http_proxy: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionTargetHttpProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_http_proxy="target_http_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.TargetHttpProxy:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetRegionTargetHttpProxyRequest):
            request = compute.GetRegionTargetHttpProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertRegionTargetHttpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionTargetHttpProxyRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionTargetHttpProxyRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_http_proxy_resource (google.cloud.compute_v1beta.types.TargetHttpProxy):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_http_proxy_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def list(
        self,
        request: Optional[Union[compute.ListRegionTargetHttpProxiesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionTargetHttpProxiesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionTargetHttpProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_target_http_proxies.pagers.ListPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListRegionTargetHttpProxiesRequest):
            request = compute.ListRegionTargetHttpProxiesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def set_url_map_unary(
        self,
        request: Optional[Union[compute.SetUrlMapRegionTargetHttpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        target_http_proxy: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_set_url_map():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetUrlMapRegionTargetHttpProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_http_proxy="target_http_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetUrlMapRegionTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_http_proxy, url_map_reference_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRegionTargetHttpProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionTargetHttpProxyRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionTargetHttpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionTargetHttpProxyRequest):
            request = compute.TestIamPermissionsRegionTargetHttpProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

...
class FutureReservationsRestTransport(_BaseFutureReservationsRestTransport):
    ...
    class _AggregatedList(
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseAggregatedList._get_http_options()
            )
    ...
    class _Cancel(
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseCancel._get_http_options()
            )

            request, metadata = self._interceptor.pre_cancel(request, metadata)
            transcoded_request = _BaseFutureReservationsRestTransport._BaseCancel._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = (
                _BaseFutureReservationsRestTransport._BaseCancel._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _Delete(
        _BaseFutureReservationsRestTransport._BaseDelete, FutureReservationsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseDelete._get_http_options()
            )

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = _BaseFutureReservationsRestTransport._BaseDelete._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = (
                _BaseFutureReservationsRestTransport._BaseDelete._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _Get(
        _BaseFutureReservationsRestTransport._BaseGet, FutureReservationsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseGet._get_http_options()
            )

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = (
                _BaseFutureReservationsRestTransport._BaseGet._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseFutureReservationsRestTransport._BaseGet._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _Insert(
        _BaseFutureReservationsRestTransport._BaseInsert, FutureReservationsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseInsert._get_http_options()
            )

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = _BaseFutureReservationsRestTransport._BaseInsert._get_transcoded_request(
                http_options, request
            )

            body = (
                _BaseFutureReservationsRestTransport._BaseInsert._get_request_body_json(
                    transcoded_request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseFutureReservationsRestTransport._BaseInsert._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _List(
        _BaseFutureReservationsRestTransport._BaseList, FutureReservationsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseList._get_http_options()
            )

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = (
                _BaseFutureReservationsRestTransport._BaseList._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseFutureReservationsRestTransport._BaseList._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _Update(
        _BaseFutureReservationsRestTransport._BaseUpdate, FutureReservationsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFutureReservationsRestTransport._BaseUpdate._get_http_options()
            )

            request, metadata = self._interceptor.pre_update(request, metadata)
            transcoded_request = _BaseFutureReservationsRestTransport._BaseUpdate._get_transcoded_request(
                http_options, request
            )

            body = (
                _BaseFutureReservationsRestTransport._BaseUpdate._get_request_body_json(
                    transcoded_request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseFutureReservationsRestTransport._BaseUpdate._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    def cancel(
        self,
    ) -> Callable[[compute.CancelFutureReservationRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def delete(
        self,
    ) -> Callable[[compute.DeleteFutureReservationRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get(
        self,
    ) -> Callable[[compute.GetFutureReservationRequest], compute.FutureReservation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def insert(
        self,
    ) -> Callable[[compute.InsertFutureReservationRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def list(
        ...
        [compute.ListFutureReservationsRequest], compute.FutureReservationsListResponse
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def update(
        self,
    ) -> Callable[[compute.UpdateFutureReservationRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

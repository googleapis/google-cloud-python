...
class FutureReservationsTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        Union[compute.FutureReservationsAggregatedListResponse, Awaitable[compute.FutureReservationsAggregatedListResponse]],
    ]:
        raise NotImplementedError()

    @property
    def cancel(self) -> Callable[[compute.CancelFutureReservationRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def delete(self) -> Callable[[compute.DeleteFutureReservationRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetFutureReservationRequest], Union[compute.FutureReservation, Awaitable[compute.FutureReservation]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertFutureReservationRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListFutureReservationsRequest], Union[compute.FutureReservationsListResponse, Awaitable[compute.FutureReservationsListResponse]]
    ]:
        raise NotImplementedError()

    @property
    def update(self) -> Callable[[compute.UpdateFutureReservationRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

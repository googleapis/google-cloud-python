...
from google.cloud.compute_v1beta.services.interconnects import pagers
...
class InterconnectsClient(metaclass=InterconnectsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = InterconnectsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = InterconnectsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = InterconnectsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = InterconnectsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = InterconnectsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, InterconnectsTransport, Callable[..., InterconnectsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InterconnectsClient._read_environment_variables()
        self._client_cert_source = InterconnectsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InterconnectsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, InterconnectsTransport)
        if transport_provided:
            ...
            self._transport = cast(InterconnectsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or InterconnectsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[InterconnectsTransport], Callable[..., InterconnectsTransport]] = (
                InterconnectsClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.InterconnectsClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteInterconnectRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteInterconnectRequest, dict]):
        ...
        flattened_params = [project, interconnect]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetInterconnectRequest(
                    interconnect="interconnect_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetInterconnectRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.Interconnect:
    ...
    def get_diagnostics(
        self,
        request: Optional[Union[compute.GetDiagnosticsInterconnectRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        interconnect: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get_diagnostics():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetDiagnosticsInterconnectRequest(
                    interconnect="interconnect_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetDiagnosticsInterconnectRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.InterconnectsGetDiagnosticsResponse:
                Response for the
    ...
    def get_macsec_config(
        self,
        request: Optional[Union[compute.GetMacsecConfigInterconnectRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        interconnect: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Returns the interconnectMacsecConfig for the
        ...
        .. code-block:: python
            ...
            def sample_get_macsec_config():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetMacsecConfigInterconnectRequest(
                    interconnect="interconnect_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetMacsecConfigInterconnectRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.InterconnectsGetMacsecConfigResponse:
                Response for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_macsec_config]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertInterconnectRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertInterconnectRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            interconnect_resource (google.cloud.compute_v1beta.types.Interconnect):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, interconnect_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListInterconnectsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListInterconnectsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.interconnects.pagers.ListPager:
    ...
    def patch_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchInterconnectRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, interconnect, interconnect_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsInterconnectRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsInterconnectRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsInterconnectRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsInterconnectRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsInterconnectRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsInterconnectRequest):
            request = compute.TestIamPermissionsInterconnectRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

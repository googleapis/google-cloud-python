...
class NodeTemplatesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_aggregated_list(
        self, request: compute.AggregatedListNodeTemplatesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.AggregatedListNodeTemplatesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_aggregated_list(self, response: compute.NodeTemplateAggregatedList) -> compute.NodeTemplateAggregatedList:
    ...
    def post_aggregated_list_with_metadata(
        self, response: compute.NodeTemplateAggregatedList, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.NodeTemplateAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(
        self, request: compute.DeleteNodeTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.DeleteNodeTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(
        self, request: compute.GetNodeTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def post_get_with_metadata(
        self, response: compute.NodeTemplate, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_get_iam_policy(
        self, request: compute.GetIamPolicyNodeTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetIamPolicyNodeTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(
        self, request: compute.InsertNodeTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.InsertNodeTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        self, request: compute.ListNodeTemplatesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.ListNodeTemplatesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(
        self, response: compute.NodeTemplateList, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_set_iam_policy(
        self, request: compute.SetIamPolicyNodeTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.SetIamPolicyNodeTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsNodeTemplateRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsNodeTemplateRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class NodeTemplatesRestTransport(_BaseNodeTemplatesRestTransport):
    ...
    class _AggregatedList(_BaseNodeTemplatesRestTransport._BaseAggregatedList, NodeTemplatesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseNodeTemplatesRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseAggregatedList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseAggregatedList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.AggregatedList",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.NodeTemplateAggregatedList.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "AggregatedList",
    ...
    class _Delete(_BaseNodeTemplatesRestTransport._BaseDelete, NodeTemplatesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseNodeTemplatesRestTransport._BaseDelete._get_http_options()

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(_BaseNodeTemplatesRestTransport._BaseGet, NodeTemplatesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = NodeTemplatesRestTransport._Get._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _GetIamPolicy(_BaseNodeTemplatesRestTransport._BaseGetIamPolicy, NodeTemplatesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseNodeTemplatesRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.get_iam_policy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "GetIamPolicy",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseNodeTemplatesRestTransport._BaseInsert, NodeTemplatesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseNodeTemplatesRestTransport._BaseInsert._get_http_options()

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseInsert._get_transcoded_request(http_options, request)

            body = _BaseNodeTemplatesRestTransport._BaseInsert._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseInsert._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseNodeTemplatesRestTransport._BaseList, NodeTemplatesRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = NodeTemplatesRestTransport._List._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _SetIamPolicy(_BaseNodeTemplatesRestTransport._BaseSetIamPolicy, NodeTemplatesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseNodeTemplatesRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseNodeTemplatesRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.set_iam_policy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "SetIamPolicy",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseNodeTemplatesRestTransport._BaseTestIamPermissions, NodeTemplatesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseNodeTemplatesRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseNodeTemplatesRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseNodeTemplatesRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.NodeTemplatesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.NodeTemplatesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.NodeTemplates",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
    ...
    @property
    def aggregated_list(self) -> Callable[[compute.AggregatedListNodeTemplatesRequest], compute.NodeTemplateAggregatedList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._AggregatedList(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def delete(self) -> Callable[[compute.DeleteNodeTemplateRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    @property
    def get_iam_policy(self) -> Callable[[compute.GetIamPolicyNodeTemplateRequest], compute.Policy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._GetIamPolicy(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def insert(self) -> Callable[[compute.InsertNodeTemplateRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Insert(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def list(self) -> Callable[[compute.ListNodeTemplatesRequest], compute.NodeTemplateList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._List(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def set_iam_policy(self) -> Callable[[compute.SetIamPolicyNodeTemplateRequest], compute.Policy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._SetIamPolicy(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsNodeTemplateRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

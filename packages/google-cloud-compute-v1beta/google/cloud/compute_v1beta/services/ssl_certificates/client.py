...
class SslCertificatesClient(metaclass=SslCertificatesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=SslCertificatesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=SslCertificatesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsSslCertificateRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,

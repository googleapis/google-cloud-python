...
class SslCertificatesTransport(abc.ABC):
    ...
    def get(
        ...
        Union[compute.SslCertificate, Awaitable[compute.SslCertificate]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.SslCertificateList, Awaitable[compute.SslCertificateList]],
    ]:
        raise NotImplementedError()
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsSslCertificateRequest],
        Union[

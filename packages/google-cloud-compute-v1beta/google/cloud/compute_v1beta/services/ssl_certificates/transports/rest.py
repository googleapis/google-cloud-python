...
class SslCertificatesRestTransport(_BaseSslCertificatesRestTransport):
    ...
    class _TestIamPermissions(
        _BaseSslCertificatesRestTransport._BaseTestIamPermissions,
        SslCertificatesRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseSslCertificatesRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseSslCertificatesRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseSslCertificatesRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseSslCertificatesRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )

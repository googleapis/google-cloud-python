...
class SnapshotGroupsTransport(abc.ABC):
    """Abstract transport class for SnapshotGroups."""
    ...
    def get(
        ...
        Union[compute.SnapshotGroup, Awaitable[compute.SnapshotGroup]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.ListSnapshotGroups, Awaitable[compute.ListSnapshotGroups]],
    ]:
        raise NotImplementedError()
...
__all__ = ("SnapshotGroupsTransport",)

...
class RegionZonesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list(
        self, request: compute.ListRegionZonesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionZonesClient.List",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionZonesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionZones",
                        "rpcName": "List",

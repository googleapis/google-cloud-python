...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.ZoneList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.ZoneList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionZonesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.ZoneList):

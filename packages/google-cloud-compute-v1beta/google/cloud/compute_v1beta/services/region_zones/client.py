...
from google.cloud.compute_v1beta.services.region_zones import pagers
...
class RegionZonesClient(metaclass=RegionZonesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RegionZonesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RegionZonesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RegionZonesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionZonesClient`.",
                    extra={
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionZonesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_zones.pagers.ListPager:

...
class CrossSiteNetworksTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteCrossSiteNetworkRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetCrossSiteNetworkRequest], Union[compute.CrossSiteNetwork, Awaitable[compute.CrossSiteNetwork]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertCrossSiteNetworkRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListCrossSiteNetworksRequest], Union[compute.CrossSiteNetworkList, Awaitable[compute.CrossSiteNetworkList]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchCrossSiteNetworkRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

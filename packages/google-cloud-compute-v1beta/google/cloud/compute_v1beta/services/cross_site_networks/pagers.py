...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.CrossSiteNetworkList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.CrossSiteNetworkList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListCrossSiteNetworksRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.CrossSiteNetworkList):

...
from google.cloud.compute_v1beta.services.interconnect_attachments import pagers
...
class InterconnectAttachmentsClient(metaclass=InterconnectAttachmentsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = InterconnectAttachmentsClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or InterconnectAttachmentsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.InterconnectAttachmentsClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListInterconnectAttachmentsRequest, dict]):
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteInterconnectAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetInterconnectAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertInterconnectAttachmentRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            interconnect_attachment_resource (google.cloud.compute_v1beta.types.InterconnectAttachment):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListInterconnectAttachmentsRequest, dict]):
                The request object. A request message for
    ...
    def patch_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchInterconnectAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def set_labels_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsInterconnectAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsInterconnectAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsInterconnectAttachmentRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsInterconnectAttachmentRequest):
            request = compute.TestIamPermissionsInterconnectAttachmentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

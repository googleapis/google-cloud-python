...
class InterconnectAttachmentsRestTransport(_BaseInterconnectAttachmentsRestTransport):
    ...
    class _TestIamPermissions(
        _BaseInterconnectAttachmentsRestTransport._BaseTestIamPermissions,
        InterconnectAttachmentsRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseInterconnectAttachmentsRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseInterconnectAttachmentsRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseInterconnectAttachmentsRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseInterconnectAttachmentsRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = (
                InterconnectAttachmentsRestTransport._TestIamPermissions._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,

    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/aggregated/vmExtensionPolicies",
                },
            ]
            return http_options
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}/delete",
    ...
    class _BaseGet:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}",
                },
            ]
            return http_options

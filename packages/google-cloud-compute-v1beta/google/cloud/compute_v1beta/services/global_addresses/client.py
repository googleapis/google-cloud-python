...
class GlobalAddressesClient(metaclass=GlobalAddressesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.GlobalAddressesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteGlobalAddressRequest, dict]):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetGlobalAddressRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertGlobalAddressRequest, dict]):
                The request object. A request message for
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListGlobalAddressesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.global_addresses.pagers.ListPager:
    ...
    def move_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.MoveGlobalAddressRequest, dict]):
                The request object. A request message for
            ...
            address (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            global_addresses_move_request_resource (google.cloud.compute_v1beta.types.GlobalAddressesMoveRequest):
                The body resource for this request
    ...
    def set_labels_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsGlobalAddressRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsGlobalAddressRequest, dict]):
                The request object. A request message for

...
class GlobalAddressesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete(
        self, request: compute.DeleteGlobalAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.DeleteGlobalAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(
        self, request: compute.GetGlobalAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetGlobalAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(
        self, response: compute.Address, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_insert(
        self, request: compute.InsertGlobalAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.InsertGlobalAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        self, request: compute.ListGlobalAddressesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.ListGlobalAddressesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_with_metadata(
        self, response: compute.AddressList, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_move(
        self, request: compute.MoveGlobalAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.MoveGlobalAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_set_labels(
        self, request: compute.SetLabelsGlobalAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.SetLabelsGlobalAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsGlobalAddressRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsGlobalAddressRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class GlobalAddressesRestTransport(_BaseGlobalAddressesRestTransport):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteGlobalAddressRequest], compute.Operation]:
    ...
    @property
    def insert(self) -> Callable[[compute.InsertGlobalAddressRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Insert(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def list(self) -> Callable[[compute.ListGlobalAddressesRequest], compute.AddressList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    @property
    def set_labels(self) -> Callable[[compute.SetLabelsGlobalAddressRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._SetLabels(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsGlobalAddressRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/compute/beta/projects/{project}/global/addresses/{address}",
                },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/addresses",
    ...
    class _BaseMove:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/addresses/{address}/move",
    ...
    class _BaseSetLabels:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/addresses/{resource}/setLabels",
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/addresses/{resource}/testIamPermissions",

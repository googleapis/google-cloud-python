...
class GlobalAddressesTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteGlobalAddressRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetGlobalAddressRequest], Union[compute.Address, Awaitable[compute.Address]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertGlobalAddressRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListGlobalAddressesRequest], Union[compute.AddressList, Awaitable[compute.AddressList]]]:
        raise NotImplementedError()

    @property
    def move(self) -> Callable[[compute.MoveGlobalAddressRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def set_labels(self) -> Callable[[compute.SetLabelsGlobalAddressRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsGlobalAddressRequest], Union[compute.TestPermissionsResponse, Awaitable[compute.TestPermissionsResponse]]
    ]:
        raise NotImplementedError()

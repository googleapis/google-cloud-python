...
class SnapshotSettingsServiceTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetSnapshotSettingRequest], Union[compute.SnapshotSettings, Awaitable[compute.SnapshotSettings]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchSnapshotSettingRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

...
from .transports.base import DEFAULT_CLIENT_INFO, SnapshotSettingsServiceTransport
from .transports.rest import SnapshotSettingsServiceRestTransport


class SnapshotSettingsServiceClientMeta(type):
    """Metaclass for the SnapshotSettingsService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SnapshotSettingsServiceTransport]]
    _transport_registry["rest"] = SnapshotSettingsServiceRestTransport
...
class SnapshotSettingsServiceClient(metaclass=SnapshotSettingsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SnapshotSettingsServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> SnapshotSettingsServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            SnapshotSettingsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SnapshotSettingsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = SnapshotSettingsServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = SnapshotSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SnapshotSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SnapshotSettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SnapshotSettingsServiceTransport, Callable[..., SnapshotSettingsServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SnapshotSettingsServiceClient._read_environment_variables()
        self._client_cert_source = SnapshotSettingsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SnapshotSettingsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SnapshotSettingsServiceTransport)
        if transport_provided:
            # transport is a SnapshotSettingsServiceTransport instance.
            ...
            self._transport = cast(SnapshotSettingsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or SnapshotSettingsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SnapshotSettingsServiceTransport], Callable[..., SnapshotSettingsServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.SnapshotSettingsServiceClient`.",
                    extra={
    ...
    def get(
        self,
        request: Optional[Union[compute.GetSnapshotSettingRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                # Create a client
                client = compute_v1beta.SnapshotSettingsServiceClient()

                # Initialize request argument(s)
                request = compute_v1beta.GetSnapshotSettingRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetSnapshotSettingRequest, dict]):
                The request object. A request message for
                SnapshotSettingsService.Get. See the
        ...
        Returns:
            google.cloud.compute_v1beta.types.SnapshotSettings:
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchSnapshotSettingRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        snapshot_settings_resource: Optional[compute.SnapshotSettings] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchSnapshotSettingRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchSnapshotSettingRequest, dict]):
                The request object. A request message for
                SnapshotSettingsService.Patch. See the
                method description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            snapshot_settings_resource (google.cloud.compute_v1beta.types.SnapshotSettings):
                The body resource for this request
                This corresponds to the ``snapshot_settings_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, snapshot_settings_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.PatchSnapshotSettingRequest):
            ...
            if project is not None:
                request.project = project
            if snapshot_settings_resource is not None:
                request.snapshot_settings_resource = snapshot_settings_resource
    ...
    def __enter__(self) -> "SnapshotSettingsServiceClient":
        return self
...
__all__ = ("SnapshotSettingsServiceClient",)

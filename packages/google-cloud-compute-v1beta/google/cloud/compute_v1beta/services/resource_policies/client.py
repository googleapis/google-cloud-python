...
class ResourcePoliciesClient(metaclass=ResourcePoliciesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=ResourcePoliciesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=ResourcePoliciesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=ResourcePoliciesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ResourcePoliciesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListResourcePoliciesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListResourcePoliciesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.resource_policies.pagers.AggregatedListPager:
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteResourcePolicyRequest, dict]):
                The request object. A request message for
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetResourcePolicyRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.ResourcePolicy:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyResourcePolicyRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyResourcePolicyRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertResourcePolicyRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            resource_policy_resource (google.cloud.compute_v1beta.types.ResourcePolicy):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListResourcePoliciesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListResourcePoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.resource_policies.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchResourcePolicyRequest, dict]):
                The request object. A request message for
    ...
    def set_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyResourcePolicyRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsResourcePolicyRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsResourcePolicyRequest, dict]):
                The request object. A request message for

...
class RegionInstanceTemplatesTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteRegionInstanceTemplateRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetRegionInstanceTemplateRequest], Union[compute.InstanceTemplate, Awaitable[compute.InstanceTemplate]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertRegionInstanceTemplateRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(
        self,
    ) -> Callable[[compute.ListRegionInstanceTemplatesRequest], Union[compute.InstanceTemplateList, Awaitable[compute.InstanceTemplateList]]]:
        raise NotImplementedError()

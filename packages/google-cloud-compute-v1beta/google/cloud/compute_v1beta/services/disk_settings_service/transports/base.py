...
class DiskSettingsServiceTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetDiskSettingRequest], Union[compute.DiskSettings, Awaitable[compute.DiskSettings]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchDiskSettingRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
...
__all__ = ("DiskSettingsServiceTransport",)

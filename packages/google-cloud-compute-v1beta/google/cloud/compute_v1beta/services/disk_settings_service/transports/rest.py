...
from .rest_base import _BaseDiskSettingsServiceRestTransport
...
class DiskSettingsServiceRestInterceptor:
    """Interceptor for DiskSettingsService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the DiskSettingsServiceRestTransport.

    .. code-block:: python
        class MyCustomDiskSettingsServiceInterceptor(DiskSettingsServiceRestInterceptor):
        ...
        transport = DiskSettingsServiceRestTransport(interceptor=MyCustomDiskSettingsServiceInterceptor())
        client = DiskSettingsServiceClient(transport=transport)
    ...
    def pre_get(
        ...
        before they are sent to the DiskSettingsService server.
        """
        return request, metadata

    def post_get(self, response: compute.DiskSettings) -> compute.DiskSettings:
        ...
        after it is returned by the DiskSettingsService server but before
    ...
    def post_get_with_metadata(
        ...
        is returned by the DiskSettingsService server but before it is returned to user code.
...
class DiskSettingsServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: DiskSettingsServiceRestInterceptor


class DiskSettingsServiceRestTransport(_BaseDiskSettingsServiceRestTransport):
    """REST backend synchronous transport for DiskSettingsService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[DiskSettingsServiceRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[DiskSettingsServiceRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseDiskSettingsServiceRestTransport._BaseGet,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.DiskSettingsServiceClient.Get",
                    extra={
            ...
            # Return the response
            resp = compute.DiskSettings()
            pb_resp = compute.DiskSettings.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.DiskSettingsServiceClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.DiskSettingsService",
                        "rpcName": "Get",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseDiskSettingsServiceRestTransport._BasePatch,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.DiskSettingsServiceClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.DiskSettingsService",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.DiskSettingsServiceClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.DiskSettingsService",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    @property
    def get(self) -> Callable[[compute.GetDiskSettingRequest], compute.DiskSettings]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Get(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def patch(self) -> Callable[[compute.PatchDiskSettingRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
...
__all__ = ("DiskSettingsServiceRestTransport",)

...
class ZoneOperationsClient(metaclass=ZoneOperationsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ZoneOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ZoneOperationsTransport, Callable[..., ZoneOperationsTransport]]
        ] = None,
        ...
        self._client_cert_source = ZoneOperationsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ZoneOperationsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ZoneOperationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ZoneOperationsTransport], Callable[..., ZoneOperationsTransport]
            ] = (

...
class ZoneOperationsClientMeta(type):
    """Metaclass for the ZoneOperations client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ZoneOperationsTransport]]
    _transport_registry["rest"] = ZoneOperationsRestTransport
...
class ZoneOperationsClient(metaclass=ZoneOperationsClientMeta):
    ...
    @property
    def transport(self) -> ZoneOperationsTransport:
        """Returns the transport used by the client instance.

        Returns:
            ZoneOperationsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ZoneOperationsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ZoneOperationsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ZoneOperationsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ZoneOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ZoneOperationsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,ZoneOperationsTransport,Callable[..., ZoneOperationsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ZoneOperationsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ZoneOperationsClient._read_environment_variables()
        self._client_cert_source = ZoneOperationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ZoneOperationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ZoneOperationsTransport)
        if transport_provided:
            # transport is a ZoneOperationsTransport instance.
            ...
            self._transport = cast(ZoneOperationsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ZoneOperationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ZoneOperationsTransport], Callable[..., ZoneOperationsTransport]] = (
                ZoneOperationsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ZoneOperationsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ZoneOperationsClient`.",
                    extra={
    ...
    def delete(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                # Create a client
                client = compute_v1beta.ZoneOperationsClient()

                # Initialize request argument(s)
                request = compute_v1beta.DeleteZoneOperationRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteZoneOperationRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.DeleteZoneOperationResponse:
        ...
        flattened_params = [project, zone, operation]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetZoneOperationRequest(
                    operation="operation_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetZoneOperationRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListZoneOperationsRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListZoneOperationsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.zone_operations.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_wait():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.WaitZoneOperationRequest(
                    operation="operation_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.WaitZoneOperationRequest, dict]):
                The request object. A request message for

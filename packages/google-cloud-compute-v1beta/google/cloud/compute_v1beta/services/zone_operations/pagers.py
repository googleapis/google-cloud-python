...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.OperationList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.OperationList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListZoneOperationsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.OperationList):
        ...
        """
        self._method = method
        self._request = compute.ListZoneOperationsRequest(request)

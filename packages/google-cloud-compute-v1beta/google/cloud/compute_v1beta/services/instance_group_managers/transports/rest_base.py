...
class _BaseInstanceGroupManagersRestTransport(InstanceGroupManagersTransport):
    ...
    class _BaseAbandonInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/abandonInstances",
    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/aggregated/instanceGroupManagers",
                },
            ]
            return http_options
    ...
    class _BaseApplyUpdatesToInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/applyUpdatesToInstances",
    ...
    class _BaseCreateInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/createInstances",
    ...
    class _BaseDeleteInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/deleteInstances",
    ...
    class _BaseDeletePerInstanceConfigs:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/deletePerInstanceConfigs",
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers",
    ...
    class _BaseListErrors:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listErrors",
                },
            ]
            return http_options
    ...
    class _BaseListManagedInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listManagedInstances",
                },
            ]
            return http_options
    ...
    class _BaseListPerInstanceConfigs:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listPerInstanceConfigs",
                },
            ]
            return http_options
    ...
    class _BasePatchPerInstanceConfigs:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/patchPerInstanceConfigs",
    ...
    class _BaseRecreateInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/recreateInstances",
    ...
    class _BaseResize:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resize",
                },
            ]
            return http_options
    ...
    class _BaseResizeAdvanced:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeAdvanced",
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.ResizeAdvancedInstanceGroupManagerRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseInstanceGroupManagersRestTransport._BaseResizeAdvanced._get_unset_required_fields(query_params))
    ...
    class _BaseResumeInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resumeInstances",
    ...
    class _BaseSetAutoHealingPolicies:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setAutoHealingPolicies",
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.SetAutoHealingPoliciesInstanceGroupManagerRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseInstanceGroupManagersRestTransport._BaseSetAutoHealingPolicies._get_unset_required_fields(query_params))
    ...
    class _BaseSetInstanceTemplate:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setInstanceTemplate",
    ...
    class _BaseSetTargetPools:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setTargetPools",
    ...
    class _BaseStartInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/startInstances",
    ...
    class _BaseStopInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/stopInstances",
    ...
    class _BaseSuspendInstances:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/suspendInstances",
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{resource}/testIamPermissions",
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.TestIamPermissionsInstanceGroupManagerRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseInstanceGroupManagersRestTransport._BaseTestIamPermissions._get_unset_required_fields(query_params))
    ...
    class _BaseUpdate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.UpdateInstanceGroupManagerRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseInstanceGroupManagersRestTransport._BaseUpdate._get_unset_required_fields(query_params))
    ...
    class _BaseUpdatePerInstanceConfigs:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/updatePerInstanceConfigs",

...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.FirewallPolicyList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.FirewallPolicyList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListFirewallPoliciesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.FirewallPolicyList):

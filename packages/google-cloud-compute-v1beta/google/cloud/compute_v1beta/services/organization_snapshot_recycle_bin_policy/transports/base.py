...
class OrganizationSnapshotRecycleBinPolicyTransport(abc.ABC):
    """Abstract transport class for OrganizationSnapshotRecycleBinPolicy."""
    ...
    def get(
        ...
        [compute.GetOrganizationSnapshotRecycleBinPolicyRequest],
        Union[
            compute.SnapshotRecycleBinPolicy,
            Awaitable[compute.SnapshotRecycleBinPolicy],
        ],
    ]:
        raise NotImplementedError()
    ...
    def patch(
        ...
        [compute.PatchOrganizationSnapshotRecycleBinPolicyRequest],
...
__all__ = ("OrganizationSnapshotRecycleBinPolicyTransport",)

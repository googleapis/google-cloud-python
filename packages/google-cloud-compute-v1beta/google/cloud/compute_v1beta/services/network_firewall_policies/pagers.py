...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.NetworkFirewallPolicyAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NetworkFirewallPolicyAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListNetworkFirewallPoliciesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NetworkFirewallPolicyAggregatedList):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListNetworkFirewallPoliciesRequest):
                The initial request object.

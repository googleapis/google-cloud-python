...
class InstanceSettingsServiceClient(metaclass=InstanceSettingsServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = InstanceSettingsServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or InstanceSettingsServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.InstanceSettingsServiceClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetInstanceSettingRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.InstanceSettings:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchInstanceSettingRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchInstanceSettingRequest, dict]):
                The request object. A request message for
            ...
            zone (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            instance_settings_resource (google.cloud.compute_v1beta.types.InstanceSettings):

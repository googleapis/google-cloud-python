...
class InstanceSettingsServiceTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetInstanceSettingRequest], Union[compute.InstanceSettings, Awaitable[compute.InstanceSettings]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchInstanceSettingRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

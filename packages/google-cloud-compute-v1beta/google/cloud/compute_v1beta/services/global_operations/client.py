...
from google.cloud.compute_v1beta.services.global_operations import pagers
...
class GlobalOperationsClient(metaclass=GlobalOperationsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GlobalOperationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, GlobalOperationsTransport, Callable[..., GlobalOperationsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GlobalOperationsClient._read_environment_variables()
        self._client_cert_source = GlobalOperationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GlobalOperationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or GlobalOperationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GlobalOperationsTransport], Callable[..., GlobalOperationsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.GlobalOperationsClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListGlobalOperationsRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListGlobalOperationsRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListGlobalOperationsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.global_operations.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteGlobalOperationRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteGlobalOperationRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.DeleteGlobalOperationResponse:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, operation]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetGlobalOperationRequest(
                    operation="operation_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetGlobalOperationRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListGlobalOperationsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListGlobalOperationsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.global_operations.pagers.ListPager:
    ...
    def wait(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.WaitGlobalOperationRequest, dict]):
                The request object. A request message for
...
__all__ = ("GlobalOperationsClient",)

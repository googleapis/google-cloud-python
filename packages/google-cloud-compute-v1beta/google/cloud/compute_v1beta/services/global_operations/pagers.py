...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.OperationAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.OperationAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListGlobalOperationsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.OperationAggregatedList):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListGlobalOperationsRequest):
                The initial request object.

...
class LicenseCodesTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetLicenseCodeRequest], Union[compute.LicenseCode, Awaitable[compute.LicenseCode]]]:
        raise NotImplementedError()

    @property
    def test_iam_permissions(
        self,
    ) -> Callable[[compute.TestIamPermissionsLicenseCodeRequest], Union[compute.TestPermissionsResponse, Awaitable[compute.TestPermissionsResponse]]]:
        raise NotImplementedError()

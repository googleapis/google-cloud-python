        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.LicenseCodesClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.LicenseCodes",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.LicenseCodesClient.get_iam_policy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.LicenseCodes",
                        "rpcName": "GetIamPolicy",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.LicenseCodesClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.LicenseCodes",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.LicenseCodesClient.set_iam_policy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.LicenseCodes",
                        "rpcName": "SetIamPolicy",
                        "metadata": http_response["headers"],

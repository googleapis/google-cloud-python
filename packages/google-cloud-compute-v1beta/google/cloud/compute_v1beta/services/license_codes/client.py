...
class LicenseCodesClient(metaclass=LicenseCodesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LicenseCodesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, LicenseCodesTransport, Callable[..., LicenseCodesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LicenseCodesClient._read_environment_variables()
        self._client_cert_source = LicenseCodesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LicenseCodesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LicenseCodesTransport], Callable[..., LicenseCodesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.LicenseCodesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                request = compute_v1beta.GetLicenseCodeRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetLicenseCodeRequest, dict]):
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsLicenseCodeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        *Caution* This resource is intended for use only by third-party
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsLicenseCodeRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsLicenseCodeRequest, dict]):
                The request object. A request message for

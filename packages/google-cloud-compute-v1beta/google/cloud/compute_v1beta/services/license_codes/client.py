...
class LicenseCodesClient(metaclass=LicenseCodesClientMeta):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyLicenseCodeRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyLicenseCodeRequest, dict]):
                The request object. A request message for
    ...
    def set_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyLicenseCodeRequest, dict]):
                The request object. A request message for

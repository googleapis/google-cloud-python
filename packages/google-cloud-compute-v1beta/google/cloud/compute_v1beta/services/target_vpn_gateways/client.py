...
from .transports.base import DEFAULT_CLIENT_INFO, TargetVpnGatewaysTransport
from .transports.rest import TargetVpnGatewaysRestTransport


class TargetVpnGatewaysClientMeta(type):
    """Metaclass for the TargetVpnGateways client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[TargetVpnGatewaysTransport]]
    _transport_registry["rest"] = TargetVpnGatewaysRestTransport
...
class TargetVpnGatewaysClient(metaclass=TargetVpnGatewaysClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TargetVpnGatewaysClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> TargetVpnGatewaysTransport:
        """Returns the transport used by the client instance.

        Returns:
            TargetVpnGatewaysTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = TargetVpnGatewaysClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = TargetVpnGatewaysClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = TargetVpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TargetVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = TargetVpnGatewaysClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, TargetVpnGatewaysTransport, Callable[..., TargetVpnGatewaysTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = TargetVpnGatewaysClient._read_environment_variables()
        self._client_cert_source = TargetVpnGatewaysClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = TargetVpnGatewaysClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, TargetVpnGatewaysTransport)
        if transport_provided:
            # transport is a TargetVpnGatewaysTransport instance.
            ...
            self._transport = cast(TargetVpnGatewaysTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or TargetVpnGatewaysClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TargetVpnGatewaysTransport], Callable[..., TargetVpnGatewaysTransport]] = (
                TargetVpnGatewaysClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetVpnGatewaysClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListTargetVpnGatewaysRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                # Create a client
                client = compute_v1beta.TargetVpnGatewaysClient()

                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListTargetVpnGatewaysRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListTargetVpnGatewaysRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_vpn_gateways.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetVpnGatewayRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_vpn_gateway]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (
                    ...
                    ("target_vpn_gateway", request.target_vpn_gateway),
                )
            ),
        )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
                    target_vpn_gateway="target_vpn_gateway_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetVpnGatewayRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.TargetVpnGateway:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetVpnGatewayRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_vpn_gateway_resource (google.cloud.compute_v1beta.types.TargetVpnGateway):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_vpn_gateway_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListTargetVpnGatewaysRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetVpnGatewaysRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_vpn_gateways.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsTargetVpnGatewayRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsTargetVpnGatewayRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetVpnGatewayRequest, dict]):
                The request object. A request message for
                TargetVpnGateways.TestIamPermissions.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetVpnGatewayRequest):
            request = compute.TestIamPermissionsTargetVpnGatewayRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
...
__all__ = ("TargetVpnGatewaysClient",)

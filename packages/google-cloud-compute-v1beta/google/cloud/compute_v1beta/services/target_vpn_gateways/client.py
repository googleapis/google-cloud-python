...
class TargetVpnGatewaysClient(metaclass=TargetVpnGatewaysClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = TargetVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = TargetVpnGatewaysClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TargetVpnGatewaysClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or TargetVpnGatewaysClient._get_api_endpoint(
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsTargetVpnGatewayRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

...
class TargetVpnGatewaysRestTransport(_BaseTargetVpnGatewaysRestTransport):
    ...
    class _TestIamPermissions(
        _BaseTargetVpnGatewaysRestTransport._BaseTestIamPermissions,
        TargetVpnGatewaysRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseTargetVpnGatewaysRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseTargetVpnGatewaysRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseTargetVpnGatewaysRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseTargetVpnGatewaysRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = TargetVpnGatewaysRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,

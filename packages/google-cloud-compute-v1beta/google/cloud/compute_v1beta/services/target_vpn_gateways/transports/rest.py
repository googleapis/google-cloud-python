...
class TargetVpnGatewaysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsTargetVpnGatewayRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsTargetVpnGatewayRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class TargetVpnGatewaysRestTransport(_BaseTargetVpnGatewaysRestTransport):
    ...
    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsTargetVpnGatewayRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class SecurityPoliciesClient(metaclass=SecurityPoliciesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=SecurityPoliciesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=SecurityPoliciesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=SecurityPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsSecurityPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,

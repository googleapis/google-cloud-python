...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.ImageList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.ImageList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListImagesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.ImageList):

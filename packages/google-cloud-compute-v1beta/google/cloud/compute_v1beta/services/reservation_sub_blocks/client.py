...
class ReservationSubBlocksClient(metaclass=ReservationSubBlocksClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=ReservationSubBlocksClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=ReservationSubBlocksClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=ReservationSubBlocksClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyReservationSubBlockRequest, dict]):
                The request object. A request message for
    ...
    def get_version_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetVersionReservationSubBlockRequest, dict]):
                The request object. A request message for
            ...
            reservation_sub_block (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reservation_sub_blocks_get_version_request_resource (google.cloud.compute_v1beta.types.ReservationSubBlocksGetVersionRequest):
    ...
    def set_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyReservationSubBlockRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsReservationSubBlockRequest, dict]):
                The request object. A request message for

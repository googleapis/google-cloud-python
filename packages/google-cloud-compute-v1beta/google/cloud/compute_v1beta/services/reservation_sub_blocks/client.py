...
from google.cloud.compute_v1beta.services.reservation_sub_blocks import pagers
...
class ReservationSubBlocksClient(metaclass=ReservationSubBlocksClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ReservationSubBlocksClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ReservationSubBlocksTransport, Callable[..., ReservationSubBlocksTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ReservationSubBlocksClient._read_environment_variables()
        self._client_cert_source = ReservationSubBlocksClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ReservationSubBlocksClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ReservationSubBlocksClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ReservationSubBlocksTransport], Callable[..., ReservationSubBlocksTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ReservationSubBlocksClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetReservationSubBlockRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.ReservationSubBlocksGetResponse:
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListReservationSubBlocksRequest, dict]):
                The request object. A request message for
    ...
    def perform_maintenance_unary(
        self,
        request: Optional[Union[compute.PerformMaintenanceReservationSubBlockRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        parent_name: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.PerformMaintenanceReservationSubBlockRequest):
    ...
    def report_faulty_unary(
        self,
        request: Optional[Union[compute.ReportFaultyReservationSubBlockRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        parent_name: Optional[str] = None,
        reservation_sub_block: Optional[str] = None,
        reservation_sub_blocks_report_faulty_request_resource: Optional[compute.ReservationSubBlocksReportFaultyRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ReportFaultyReservationSubBlockRequest, dict]):
                The request object. A request message for
            ...
            reservation_sub_block (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reservation_sub_blocks_report_faulty_request_resource (google.cloud.compute_v1beta.types.ReservationSubBlocksReportFaultyRequest):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, parent_name, reservation_sub_block, reservation_sub_blocks_report_faulty_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.ReportFaultyReservationSubBlockRequest):
            ...
            if reservation_sub_blocks_report_faulty_request_resource is not None:
                request.reservation_sub_blocks_report_faulty_request_resource = reservation_sub_blocks_report_faulty_request_resource

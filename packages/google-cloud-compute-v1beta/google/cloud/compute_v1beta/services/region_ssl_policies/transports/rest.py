...
class RegionSslPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_test_iam_permissions(
        ...
        compute.TestIamPermissionsRegionSslPolicyRequest,
        Sequence[Tuple[str, Union[str, bytes]]],
    ]:
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionSslPoliciesRestInterceptor]): Interceptor used
    ...
    class _TestIamPermissions(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )

...
from .rest_base import _BaseRegionSslPoliciesRestTransport
...
class RegionSslPoliciesRestInterceptor:
    """Interceptor for RegionSslPolicies.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RegionSslPoliciesRestTransport.

    .. code-block:: python
        class MyCustomRegionSslPoliciesInterceptor(RegionSslPoliciesRestInterceptor):
        ...
        transport = RegionSslPoliciesRestTransport(interceptor=MyCustomRegionSslPoliciesInterceptor())
        client = RegionSslPoliciesClient(transport=transport)
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsRegionSslPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsRegionSslPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class RegionSslPoliciesRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: RegionSslPoliciesRestInterceptor


class RegionSslPoliciesRestTransport(_BaseRegionSslPoliciesRestTransport):
    """REST backend synchronous transport for RegionSslPolicies.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[RegionSslPoliciesRestInterceptor] = None,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.Delete",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseRegionSslPoliciesRestTransport._BaseGet, RegionSslPoliciesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.ListAvailableFeatures",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.list_available_features",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "ListAvailableFeatures",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions, RegionSslPoliciesRestStub):
        def __hash__(self):
            return hash("RegionSslPoliciesRestTransport.TestIamPermissions")
        ...
        def __call__(
            self,
            request: compute.TestIamPermissionsRegionSslPolicyRequest,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ...
            Args:
                request (~.compute.TestIamPermissionsRegionSslPolicyRequest):
                    The request object. A request message for
                RegionSslPolicies.TestIamPermissions.
                See the method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            http_options = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionSslPoliciesRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionSslPoliciesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
            ...
            # Send the request
            response = RegionSslPoliciesRestTransport._TestIamPermissions._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionSslPoliciesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionSslPolicies",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
    ...
    @property
    def get(self) -> Callable[[compute.GetRegionSslPolicyRequest], compute.SslPolicy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsRegionSslPolicyRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
...
__all__ = ("RegionSslPoliciesRestTransport",)

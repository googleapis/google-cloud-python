...
class RegionSslPoliciesClient(metaclass=RegionSslPoliciesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RegionSslPoliciesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RegionSslPoliciesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RegionSslPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get_iam_policy(
        self,
        request: Optional[
            Union[compute.GetIamPolicyRegionSslPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyRegionSslPolicyRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyRegionSslPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetIamPolicyRegionSslPolicyRequest):
            request = compute.GetIamPolicyRegionSslPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def set_iam_policy(
        self,
        request: Optional[
            Union[compute.SetIamPolicyRegionSslPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyRegionSslPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetIamPolicyRegionSslPolicyRequest):
            request = compute.SetIamPolicyRegionSslPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionSslPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

...
class SnapshotsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_aggregated_list(
        ...
        compute.AggregatedListSnapshotsRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_aggregated_list(
        self, response: compute.SnapshotAggregatedList
    ...
    def post_aggregated_list_with_metadata(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.SnapshotAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for aggregated_list
...
class SnapshotsRestTransport(_BaseSnapshotsRestTransport):
    ...
    class _AggregatedList(
        _BaseSnapshotsRestTransport._BaseAggregatedList, SnapshotsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = SnapshotsRestTransport._AggregatedList._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.SnapshotsClient.UpdateKmsKey",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Snapshots",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.SnapshotsClient.update_kms_key",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Snapshots",
                        "rpcName": "UpdateKmsKey",
                        "metadata": http_response["headers"],
    ...
    def aggregated_list(
        ...
        [compute.AggregatedListSnapshotsRequest], compute.SnapshotAggregatedList
    ]:

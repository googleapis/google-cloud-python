...
from google.cloud.compute_v1beta.services.snapshots import pagers
...
class SnapshotsClient(metaclass=SnapshotsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=SnapshotsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=SnapshotsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=SnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.SnapshotsClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListSnapshotsRequest, dict]] = None,
        *,
        ...
        r"""Retrieves an aggregated list of all of the snapshots in your
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListSnapshotsRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListSnapshotsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.snapshots.pagers.AggregatedListPager:
        ...
        if not isinstance(request, compute.AggregatedListSnapshotsRequest):
            request = compute.AggregatedListSnapshotsRequest(request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteSnapshotRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteSnapshotRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetSnapshotRequest(
                    project="project_value",
                    snapshot="snapshot_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetSnapshotRequest, dict]):
    ...
    def get_effective_recycle_bin_rule(
        self,
        request: Optional[
            Union[compute.GetEffectiveRecycleBinRuleSnapshotRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        snapshot: Optional[str] = None,
        ...
        r"""Returns the effective recycle bin rule for a snapshot
        by merging org and project level rules. If no rules are
        defined at org and project level, the standard default
        rule is returned.
        ...
        .. code-block:: python
            ...
            def sample_get_effective_recycle_bin_rule():
                # Create a client
                client = compute_v1beta.SnapshotsClient()

                # Initialize request argument(s)
                request = compute_v1beta.GetEffectiveRecycleBinRuleSnapshotRequest(
                    project="project_value",
                    snapshot="snapshot_value",
                )

                # Make the request
                response = client.get_effective_recycle_bin_rule(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.compute_v1beta.types.GetEffectiveRecycleBinRuleSnapshotRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                should not be set.
            snapshot (str):
                Name of the Snapshot resource to get
                the effective recycle bin rule for.
        ...
        Returns:
            google.cloud.compute_v1beta.types.SnapshotsGetEffectiveRecycleBinRuleResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetEffectiveRecycleBinRuleSnapshotRequest):
            request = compute.GetEffectiveRecycleBinRuleSnapshotRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_effective_recycle_bin_rule
        ]
    ...
    def get_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicySnapshotRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertSnapshotRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertSnapshotRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListSnapshotsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListSnapshotsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.snapshots.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetIamPolicySnapshotRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicySnapshotRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsSnapshotRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def update_kms_key_unary(
        self,
        request: Optional[Union[compute.UpdateKmsKeySnapshotRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        snapshot: Optional[str] = None,
        snapshot_update_kms_key_request_resource: Optional[
            compute.SnapshotUpdateKmsKeyRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_update_kms_key():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.UpdateKmsKeySnapshotRequest(
                    project="project_value",
                    snapshot="snapshot_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateKmsKeySnapshotRequest, dict]):
                The request object. A request message for
            ...
            snapshot (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            snapshot_update_kms_key_request_resource (google.cloud.compute_v1beta.types.SnapshotUpdateKmsKeyRequest):
                The body resource for this request
                This corresponds to the ``snapshot_update_kms_key_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, snapshot, snapshot_update_kms_key_request_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.UpdateKmsKeySnapshotRequest):
            request = compute.UpdateKmsKeySnapshotRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            if snapshot is not None:
                request.snapshot = snapshot
            if snapshot_update_kms_key_request_resource is not None:
                request.snapshot_update_kms_key_request_resource = (

...
class RegionDiskTypesClient(metaclass=RegionDiskTypesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RegionDiskTypesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RegionDiskTypesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RegionDiskTypesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionDiskTypesClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionDiskTypeRequest, dict]):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionDiskTypesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_disk_types.pagers.ListPager:

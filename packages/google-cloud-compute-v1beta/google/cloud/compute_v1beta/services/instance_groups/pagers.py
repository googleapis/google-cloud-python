...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.InstanceGroupAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListInstanceGroupsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupAggregatedList):
...
class ListPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.InstanceGroupList` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupList`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListInstanceGroupsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupList):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListInstancesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.InstanceGroupsListInstances` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupsListInstances`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListInstancesInstanceGroupsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupsListInstances):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

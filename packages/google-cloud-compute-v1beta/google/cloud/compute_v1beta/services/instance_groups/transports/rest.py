...
class InstanceGroupsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list_with_metadata(
        ...
        compute.InstanceGroupAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(
        ...
        compute.DeleteInstanceGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_get(
        ...
        compute.GetInstanceGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_get_with_metadata(
        self,
        response: compute.InstanceGroup,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ...
    def pre_insert(
        ...
        compute.InsertInstanceGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_list(
        ...
        compute.ListInstanceGroupsRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_list_instances_with_metadata(
        ...
        compute.InstanceGroupsListInstances, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for list_instances
...
class InstanceGroupsRestTransport(_BaseInstanceGroupsRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[InstanceGroupsRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseAddInstances,
            ...
            resp, _ = self._interceptor.post_add_instances_with_metadata(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseAggregatedList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseDelete,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseGet,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseInsert,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseListInstances,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseRemoveInstances,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_remove_instances_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseSetNamedPorts,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_set_named_ports_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
    ...
    class _TestIamPermissions(
        _BaseInstanceGroupsRestTransport._BaseTestIamPermissions, InstanceGroupsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseInstanceGroupsRestTransport._BaseTestIamPermissions,

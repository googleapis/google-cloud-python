...
class DhcpOptionsConfigsTransport(abc.ABC):
    """Abstract transport class for DhcpOptionsConfigs."""
    ...
    def delete(
        ...
        [compute.DeleteDhcpOptionsConfigRequest],
    ...
    def get(
        ...
        [compute.GetDhcpOptionsConfigRequest],
        Union[compute.DhcpOptionsConfig, Awaitable[compute.DhcpOptionsConfig]],
    ]:
        raise NotImplementedError()
    ...
    def insert(
        ...
        [compute.InsertDhcpOptionsConfigRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListDhcpOptionsConfigsRequest],
        Union[compute.DhcpOptionsConfigList, Awaitable[compute.DhcpOptionsConfigList]],
    ]:
        raise NotImplementedError()
    ...
    def patch(
        ...
        [compute.PatchDhcpOptionsConfigRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsDhcpOptionsConfigRequest],
        Union[
...
__all__ = ("DhcpOptionsConfigsTransport",)

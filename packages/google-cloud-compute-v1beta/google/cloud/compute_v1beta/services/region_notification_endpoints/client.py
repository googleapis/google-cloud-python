...
class RegionNotificationEndpointsClient(metaclass=RegionNotificationEndpointsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionNotificationEndpointsClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or RegionNotificationEndpointsClient._get_api_endpoint(

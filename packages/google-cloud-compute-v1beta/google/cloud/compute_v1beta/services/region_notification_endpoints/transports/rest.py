...
from .rest_base import _BaseRegionNotificationEndpointsRestTransport
...
class RegionNotificationEndpointsRestInterceptor:
    """Interceptor for RegionNotificationEndpoints.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RegionNotificationEndpointsRestTransport.

    .. code-block:: python
        class MyCustomRegionNotificationEndpointsInterceptor(RegionNotificationEndpointsRestInterceptor):
        ...
        transport = RegionNotificationEndpointsRestTransport(interceptor=MyCustomRegionNotificationEndpointsInterceptor())
    ...
    def pre_aggregated_list(
        ...
        before they are sent to the RegionNotificationEndpoints server.
        """
        return request, metadata

    def post_aggregated_list(
        self, response: compute.NotificationEndpointAggregatedList
        ...
        after it is returned by the RegionNotificationEndpoints server but before
    ...
    def post_aggregated_list_with_metadata(
        self,
        response: compute.NotificationEndpointAggregatedList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        compute.NotificationEndpointAggregatedList,
        Sequence[Tuple[str, Union[str, bytes]]],
        ...
        is returned by the RegionNotificationEndpoints server but before it is returned to user code.
...
class RegionNotificationEndpointsRestTransport(
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[RegionNotificationEndpointsRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionNotificationEndpointsRestInterceptor]): Interceptor used
    ...
    class _AggregatedList(
        _BaseRegionNotificationEndpointsRestTransport._BaseAggregatedList,
        RegionNotificationEndpointsRestStub,
    ):
        def __hash__(self):
            return hash("RegionNotificationEndpointsRestTransport.AggregatedList")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRegionNotificationEndpointsRestTransport._BaseAggregatedList._get_http_options()

            request, metadata = self._interceptor.pre_aggregated_list(request, metadata)
            transcoded_request = _BaseRegionNotificationEndpointsRestTransport._BaseAggregatedList._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseRegionNotificationEndpointsRestTransport._BaseAggregatedList._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.AggregatedList",
                    extra={
            ...
            # Send the request
            response = (
                RegionNotificationEndpointsRestTransport._AggregatedList._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            # Return the response
            resp = compute.NotificationEndpointAggregatedList()
            pb_resp = compute.NotificationEndpointAggregatedList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = (
                        compute.NotificationEndpointAggregatedList.to_json(response)
                    )
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "AggregatedList",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.NotificationEndpoint()
            pb_resp = compute.NotificationEndpoint.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.NotificationEndpointList()
            pb_resp = compute.NotificationEndpointList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(
        _BaseRegionNotificationEndpointsRestTransport._BaseTestIamPermissions,
        RegionNotificationEndpointsRestStub,
    ):
        def __hash__(self):
            return hash("RegionNotificationEndpointsRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRegionNotificationEndpointsRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseRegionNotificationEndpointsRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionNotificationEndpointsRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionNotificationEndpointsRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
            ...
            # Send the request
            response = RegionNotificationEndpointsRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionNotificationEndpointsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionNotificationEndpoints",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

...
class WireGroupsTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteWireGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetWireGroupRequest], Union[compute.WireGroup, Awaitable[compute.WireGroup]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertWireGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListWireGroupsRequest], Union[compute.WireGroupList, Awaitable[compute.WireGroupList]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchWireGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

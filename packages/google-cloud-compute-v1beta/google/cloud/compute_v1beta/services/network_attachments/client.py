    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=NetworkAttachmentsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=NetworkAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE,

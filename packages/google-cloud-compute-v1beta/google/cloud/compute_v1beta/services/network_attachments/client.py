...
from google.cloud.compute_v1beta.services.network_attachments import pagers
...
class NetworkAttachmentsClientMeta(type):
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[NetworkAttachmentsTransport]]
...
class NetworkAttachmentsClient(metaclass=NetworkAttachmentsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = NetworkAttachmentsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = NetworkAttachmentsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = NetworkAttachmentsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NetworkAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = NetworkAttachmentsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, NetworkAttachmentsTransport, Callable[..., NetworkAttachmentsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,NetworkAttachmentsTransport,Callable[..., NetworkAttachmentsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the NetworkAttachmentsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NetworkAttachmentsClient._read_environment_variables()
        self._client_cert_source = NetworkAttachmentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NetworkAttachmentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, NetworkAttachmentsTransport)
        if transport_provided:
            ...
            self._transport = cast(NetworkAttachmentsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or NetworkAttachmentsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NetworkAttachmentsTransport], Callable[..., NetworkAttachmentsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.NetworkAttachmentsClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListNetworkAttachmentsRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                # Create a client
                client = compute_v1beta.NetworkAttachmentsClient()

                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListNetworkAttachmentsRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListNetworkAttachmentsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.network_attachments.pagers.AggregatedListPager:
                Contains a list of
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteNetworkAttachmentRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNetworkAttachmentRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_attachment]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNetworkAttachmentRequest(
                    network_attachment="network_attachment_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNetworkAttachmentRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.NetworkAttachment:
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicyNetworkAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyNetworkAttachmentRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyNetworkAttachmentRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertNetworkAttachmentRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertNetworkAttachmentRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_attachment_resource (google.cloud.compute_v1beta.types.NetworkAttachment):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_attachment_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNetworkAttachmentsRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNetworkAttachmentsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.network_attachments.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchNetworkAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_attachment: Optional[str] = None,
        ...
        r"""Patches the specified NetworkAttachment resource with
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchNetworkAttachmentRequest(
                    network_attachment="network_attachment_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchNetworkAttachmentRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_attachment, network_attachment_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.PatchNetworkAttachmentRequest):
            request = compute.PatchNetworkAttachmentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicyNetworkAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetIamPolicyNetworkAttachmentRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyNetworkAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsNetworkAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsNetworkAttachmentRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsNetworkAttachmentRequest, dict]):
                The request object. A request message for

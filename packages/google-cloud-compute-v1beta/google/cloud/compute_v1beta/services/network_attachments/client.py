...
class NetworkAttachmentsClient(metaclass=NetworkAttachmentsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = NetworkAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            NetworkAttachmentsClient._read_environment_variables()
        )
        self._client_cert_source = NetworkAttachmentsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = NetworkAttachmentsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or NetworkAttachmentsClient._get_api_endpoint(

...
class ZoneVmExtensionPoliciesTransport(abc.ABC):
    """Abstract transport class for ZoneVmExtensionPolicies."""
    ...
    def get(
        ...
        Union[compute.VmExtensionPolicy, Awaitable[compute.VmExtensionPolicy]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.VmExtensionPolicyList, Awaitable[compute.VmExtensionPolicyList]],
    ]:
        raise NotImplementedError()
...
__all__ = ("ZoneVmExtensionPoliciesTransport",)

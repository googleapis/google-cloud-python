...
class TargetHttpsProxiesClient(metaclass=TargetHttpsProxiesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=TargetHttpsProxiesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=TargetHttpsProxiesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=TargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetHttpsProxiesClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListTargetHttpsProxiesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_https_proxies.pagers.AggregatedListPager:
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetHttpsProxyRequest, dict]):
                The request object. A request message for
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetHttpsProxyRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetHttpsProxyRequest, dict]):
                The request object. A request message for
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetHttpsProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_https_proxies.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchTargetHttpsProxyRequest(
                    project="project_value",
                    target_https_proxy="target_https_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchTargetHttpsProxyRequest, dict]):
                The request object. A request message for
    ...
    def set_certificate_map_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetCertificateMapTargetHttpsProxyRequest, dict]):
                The request object. A request message for
            ...
            target_https_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_https_proxies_set_certificate_map_request_resource (google.cloud.compute_v1beta.types.TargetHttpsProxiesSetCertificateMapRequest):
                The body resource for this request
    ...
    def set_quic_override_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetQuicOverrideTargetHttpsProxyRequest, dict]):
                The request object. A request message for
            ...
            target_https_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_https_proxies_set_quic_override_request_resource (google.cloud.compute_v1beta.types.TargetHttpsProxiesSetQuicOverrideRequest):
                The body resource for this request
    ...
    def set_ssl_certificates_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetSslCertificatesTargetHttpsProxyRequest, dict]):
                The request object. A request message for
            ...
            target_https_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_https_proxies_set_ssl_certificates_request_resource (google.cloud.compute_v1beta.types.TargetHttpsProxiesSetSslCertificatesRequest):
                The body resource for this request
    ...
    def set_ssl_policy_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetSslPolicyTargetHttpsProxyRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_url_map():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetUrlMapTargetHttpsProxyRequest(
                    project="project_value",
                    target_https_proxy="target_https_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetUrlMapTargetHttpsProxyRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsTargetHttpsProxyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsTargetHttpsProxyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetHttpsProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetHttpsProxyRequest):
            request = compute.TestIamPermissionsTargetHttpsProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

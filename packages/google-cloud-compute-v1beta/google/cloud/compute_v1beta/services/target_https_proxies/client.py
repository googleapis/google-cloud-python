...
class TargetHttpsProxiesClient(metaclass=TargetHttpsProxiesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or TargetHttpsProxiesClient._get_api_endpoint(
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsTargetHttpsProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,

...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.NetworkEndpointGroupAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NetworkEndpointGroupAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListNetworkEndpointGroupsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NetworkEndpointGroupAggregatedList):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListNetworkEndpointGroupsRequest):
                The initial request object.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListNetworkEndpointsNetworkEndpointGroupsRequest):
                The initial request object.
        ...
        """
        self._method = method
        self._request = compute.ListNetworkEndpointsNetworkEndpointGroupsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata

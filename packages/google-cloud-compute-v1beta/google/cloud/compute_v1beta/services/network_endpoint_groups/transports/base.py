...
class NetworkEndpointGroupsTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        Union[compute.NetworkEndpointGroupAggregatedList, Awaitable[compute.NetworkEndpointGroupAggregatedList]],
    ]:
        raise NotImplementedError()
    ...
    def attach_network_endpoints(
        self,
    ) -> Callable[[compute.AttachNetworkEndpointsNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def delete(self) -> Callable[[compute.DeleteNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def detach_network_endpoints(
        self,
    ) -> Callable[[compute.DetachNetworkEndpointsNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetNetworkEndpointGroupRequest], Union[compute.NetworkEndpointGroup, Awaitable[compute.NetworkEndpointGroup]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertNetworkEndpointGroupRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(
        self,
    ) -> Callable[[compute.ListNetworkEndpointGroupsRequest], Union[compute.NetworkEndpointGroupList, Awaitable[compute.NetworkEndpointGroupList]]]:
        raise NotImplementedError()
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsNetworkEndpointGroupRequest], Union[compute.TestPermissionsResponse, Awaitable[compute.TestPermissionsResponse]]
    ]:
        raise NotImplementedError()

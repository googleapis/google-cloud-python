...
from google.cloud.compute_v1beta.services.network_endpoint_groups import pagers
from google.cloud.compute_v1beta.types import compute

from .transports.base import DEFAULT_CLIENT_INFO, NetworkEndpointGroupsTransport
from .transports.rest import NetworkEndpointGroupsRestTransport


class NetworkEndpointGroupsClientMeta(type):
    """Metaclass for the NetworkEndpointGroups client.
...
class NetworkEndpointGroupsClient(metaclass=NetworkEndpointGroupsClientMeta):
    ...
    @property
    def transport(self) -> NetworkEndpointGroupsTransport:
        """Returns the transport used by the client instance.

        Returns:
            NetworkEndpointGroupsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = NetworkEndpointGroupsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = NetworkEndpointGroupsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = NetworkEndpointGroupsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NetworkEndpointGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = NetworkEndpointGroupsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, NetworkEndpointGroupsTransport, Callable[..., NetworkEndpointGroupsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NetworkEndpointGroupsClient._read_environment_variables()
        self._client_cert_source = NetworkEndpointGroupsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NetworkEndpointGroupsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, NetworkEndpointGroupsTransport)
        if transport_provided:
            # transport is a NetworkEndpointGroupsTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or NetworkEndpointGroupsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NetworkEndpointGroupsTransport], Callable[..., NetworkEndpointGroupsTransport]] = (
                NetworkEndpointGroupsClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.NetworkEndpointGroupsClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListNetworkEndpointGroupsRequest, dict]] = None,
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListNetworkEndpointGroupsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.network_endpoint_groups.pagers.AggregatedListPager:
    ...
    def attach_network_endpoints_unary(
        self,
        request: Optional[Union[compute.AttachNetworkEndpointsNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        network_endpoint_groups_attach_endpoints_request_resource: Optional[compute.NetworkEndpointGroupsAttachEndpointsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_attach_network_endpoints():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.AttachNetworkEndpointsNetworkEndpointGroupRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AttachNetworkEndpointsNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
            ...
            network_endpoint_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_endpoint_groups_attach_endpoints_request_resource (google.cloud.compute_v1beta.types.NetworkEndpointGroupsAttachEndpointsRequest):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, network_endpoint_group, network_endpoint_groups_attach_endpoints_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.AttachNetworkEndpointsNetworkEndpointGroupRequest):
            ...
            if network_endpoint_groups_attach_endpoints_request_resource is not None:
                request.network_endpoint_groups_attach_endpoints_request_resource = network_endpoint_groups_attach_endpoints_request_resource
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, network_endpoint_group]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def detach_network_endpoints_unary(
        self,
        request: Optional[Union[compute.DetachNetworkEndpointsNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        network_endpoint_groups_detach_endpoints_request_resource: Optional[compute.NetworkEndpointGroupsDetachEndpointsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_detach_network_endpoints():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DetachNetworkEndpointsNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DetachNetworkEndpointsNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
            ...
            network_endpoint_group (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_endpoint_groups_detach_endpoints_request_resource (google.cloud.compute_v1beta.types.NetworkEndpointGroupsDetachEndpointsRequest):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, network_endpoint_group, network_endpoint_groups_detach_endpoints_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.DetachNetworkEndpointsNetworkEndpointGroupRequest):
            ...
            if network_endpoint_groups_detach_endpoints_request_resource is not None:
                request.network_endpoint_groups_detach_endpoints_request_resource = network_endpoint_groups_detach_endpoints_request_resource
    ...
    def get(
        self,
        request: Optional[Union[compute.GetNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNetworkEndpointGroupRequest(
                    network_endpoint_group="network_endpoint_group_value",
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertNetworkEndpointGroupRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
            ...
            zone (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_endpoint_group_resource (google.cloud.compute_v1beta.types.NetworkEndpointGroup):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, network_endpoint_group_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.InsertNetworkEndpointGroupRequest):
            ...
            if network_endpoint_group_resource is not None:
                request.network_endpoint_group_resource = network_endpoint_group_resource
    ...
    def list(
        self,
        request: Optional[Union[compute.ListNetworkEndpointGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListNetworkEndpointGroupsRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNetworkEndpointGroupsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.network_endpoint_groups.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def list_network_endpoints(
        self,
        request: Optional[Union[compute.ListNetworkEndpointsNetworkEndpointGroupsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        network_endpoint_group: Optional[str] = None,
        network_endpoint_groups_list_endpoints_request_resource: Optional[compute.NetworkEndpointGroupsListEndpointsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNetworkEndpointsNetworkEndpointGroupsRequest, dict]):
                The request object. A request message for
            ...
            network_endpoint_group (str):
                The name of the network endpoint
                group from which you want to generate a
                list of included network endpoints. It
                should comply with RFC1035.

                This corresponds to the ``network_endpoint_group`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_endpoint_groups_list_endpoints_request_resource (google.cloud.compute_v1beta.types.NetworkEndpointGroupsListEndpointsRequest):
                The body resource for this request
        ...
        Returns:
            google.cloud.compute_v1beta.services.network_endpoint_groups.pagers.ListNetworkEndpointsPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, network_endpoint_group, network_endpoint_groups_list_endpoints_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListNetworkEndpointsNetworkEndpointGroupsRequest):
            ...
            if network_endpoint_group is not None:
                request.network_endpoint_group = network_endpoint_group
            if network_endpoint_groups_list_endpoints_request_resource is not None:
                request.network_endpoint_groups_list_endpoints_request_resource = network_endpoint_groups_list_endpoints_request_resource
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListNetworkEndpointsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsNetworkEndpointGroupRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsNetworkEndpointGroupRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsNetworkEndpointGroupRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsNetworkEndpointGroupRequest):
...
__all__ = ("NetworkEndpointGroupsClient",)

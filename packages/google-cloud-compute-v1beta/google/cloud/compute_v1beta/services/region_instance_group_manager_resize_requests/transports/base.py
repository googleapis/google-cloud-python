...
class RegionInstanceGroupManagerResizeRequestsTransport(abc.ABC):
    ...
    def cancel(
        self,
    ) -> Callable[[compute.CancelRegionInstanceGroupManagerResizeRequestRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def delete(
        self,
    ) -> Callable[[compute.DeleteRegionInstanceGroupManagerResizeRequestRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def insert(
        self,
    ) -> Callable[[compute.InsertRegionInstanceGroupManagerResizeRequestRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.RegionInstanceGroupManagerResizeRequestsListResponse, Awaitable[compute.RegionInstanceGroupManagerResizeRequestsListResponse]],
    ]:
        raise NotImplementedError()

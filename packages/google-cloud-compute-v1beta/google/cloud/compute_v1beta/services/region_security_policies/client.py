...
class RegionSecurityPoliciesClient(metaclass=RegionSecurityPoliciesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionSecurityPoliciesClient`.",
                    extra={
    ...
    def add_rule_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AddRuleRegionSecurityPolicyRequest, dict]):
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionSecurityPolicyRequest(
                    project="project_value",
                    region="region_value",
                    security_policy="security_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def get_rule(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRuleRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionSecurityPoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_security_policies.pagers.ListPager:
    ...
    def patch_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def patch_rule_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRuleRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def remove_rule_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.RemoveRuleRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
    ...
    def set_labels_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsRegionSecurityPolicyRequest, dict]):
                The request object. A request message for

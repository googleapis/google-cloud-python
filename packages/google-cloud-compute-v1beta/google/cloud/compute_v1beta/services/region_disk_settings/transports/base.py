...
class RegionDiskSettingsTransport(abc.ABC):
    """Abstract transport class for RegionDiskSettings."""
    ...
    @property
    def get(self) -> Callable[[compute.GetRegionDiskSettingRequest], Union[compute.DiskSettings, Awaitable[compute.DiskSettings]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchRegionDiskSettingRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
...
__all__ = ("RegionDiskSettingsTransport",)

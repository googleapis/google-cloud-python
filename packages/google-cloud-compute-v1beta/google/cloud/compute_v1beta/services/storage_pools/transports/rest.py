...
class StoragePoolsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_aggregated_list(
        ...
        compute.AggregatedListStoragePoolsRequest,
    ...
    def post_aggregated_list_with_metadata(
        self,
        response: compute.StoragePoolAggregatedList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        compute.StoragePoolAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for aggregated_list
    ...
    def pre_delete(
        ...
        compute.DeleteStoragePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_get_iam_policy(
        ...
        compute.GetIamPolicyStoragePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_insert(
        ...
        compute.InsertStoragePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_list(
        ...
        compute.ListStoragePoolsRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_list_with_metadata(
        self,
        response: compute.StoragePoolList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ...
    def pre_list_disks(
        ...
        compute.ListDisksStoragePoolsRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_list_disks_with_metadata(
        self,
        response: compute.StoragePoolListDisks,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ...
    def pre_set_iam_policy(
        ...
        compute.SetIamPolicyStoragePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_update(
        ...
        compute.UpdateStoragePoolRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[StoragePoolsRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseAggregatedList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseDelete,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseGet,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseGetIamPolicy,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseInsert,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseListDisks,
                    "_BaseListDisks__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=False,
            )
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_disks_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseSetIamPolicy,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseTestIamPermissions,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseStoragePoolsRestTransport._BaseUpdate,

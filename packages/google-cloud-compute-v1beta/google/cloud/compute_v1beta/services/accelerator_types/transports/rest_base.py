    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/aggregated/acceleratorTypes",
                },
            ]
            return http_options
    ...
    class _BaseGet:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/acceleratorTypes/{accelerator_type}",
                },
            ]
            return http_options
    ...
    class _BaseList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/acceleratorTypes",
                },
            ]
            return http_options

            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseAcceleratorTypesRestTransport._BaseAggregatedList,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.AcceleratorTypesClient.AggregatedList",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.AcceleratorTypesClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.AcceleratorTypes",
                        "rpcName": "AggregatedList",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseAcceleratorTypesRestTransport._BaseGet,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.AcceleratorTypesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.AcceleratorTypes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.AcceleratorTypesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.AcceleratorTypes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseAcceleratorTypesRestTransport._BaseList,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.AcceleratorTypesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.AcceleratorTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.AcceleratorTypesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.AcceleratorTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],

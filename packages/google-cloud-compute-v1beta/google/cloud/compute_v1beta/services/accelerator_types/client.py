...
from google.cloud.compute_v1beta.services.accelerator_types import pagers
...
class AcceleratorTypesClient(metaclass=AcceleratorTypesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=AcceleratorTypesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=AcceleratorTypesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=AcceleratorTypesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.AcceleratorTypesClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListAcceleratorTypesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.accelerator_types.pagers.AggregatedListPager:
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetAcceleratorTypeRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.AcceleratorType:
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListAcceleratorTypesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.accelerator_types.pagers.ListPager:

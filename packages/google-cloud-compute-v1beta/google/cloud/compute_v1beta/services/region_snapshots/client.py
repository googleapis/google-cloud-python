...
class RegionSnapshotsClient(metaclass=RegionSnapshotsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionSnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionSnapshotsTransport, Callable[..., RegionSnapshotsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionSnapshotsClient._read_environment_variables()
        self._client_cert_source = RegionSnapshotsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionSnapshotsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or RegionSnapshotsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionSnapshotsTransport], Callable[..., RegionSnapshotsTransport]] = (
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicyRegionSnapshotRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicyRegionSnapshotRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRegionSnapshotRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,

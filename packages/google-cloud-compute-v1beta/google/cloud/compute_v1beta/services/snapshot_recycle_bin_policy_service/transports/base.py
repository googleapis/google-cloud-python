...
class SnapshotRecycleBinPolicyServiceTransport(abc.ABC):
    """Abstract transport class for SnapshotRecycleBinPolicyService."""
...
__all__ = ("SnapshotRecycleBinPolicyServiceTransport",)

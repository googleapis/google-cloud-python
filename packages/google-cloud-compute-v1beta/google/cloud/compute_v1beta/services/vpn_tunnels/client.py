...
class VpnTunnelsClient(metaclass=VpnTunnelsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = VpnTunnelsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, VpnTunnelsTransport, Callable[..., VpnTunnelsTransport]]
        ] = None,
        ...
        self._client_cert_source = VpnTunnelsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = VpnTunnelsClient._get_universe_domain(
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsVpnTunnelRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

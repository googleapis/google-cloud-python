...
from .rest_base import _BaseRegionCommitmentsRestTransport
    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomRegionCommitmentsInterceptor(RegionCommitmentsRestInterceptor):
            ...
            def pre_update_reservations(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_reservations(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def post_aggregated_list_with_metadata(
        ...
        is returned by the RegionCommitments server but before it is returned to user code.
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_reservations(
        self, request: compute.UpdateReservationsRegionCommitmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.UpdateReservationsRegionCommitmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for update_reservations
    ...
    def post_update_reservations(self, response: compute.Operation) -> compute.Operation:
        """Post-rpc interceptor for update_reservations

        DEPRECATED. Please use the `post_update_reservations_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the RegionCommitments server but before
        it is returned to user code. This `post_update_reservations` interceptor runs
        before the `post_update_reservations_with_metadata` interceptor.
        """
        return response

    def post_update_reservations_with_metadata(
        self, response: compute.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_reservations
        ...
        We recommend only using this `post_update_reservations_with_metadata`
        interceptor in new development instead of the `post_update_reservations` interceptor.
        When both interceptors are used, this `post_update_reservations_with_metadata` interceptor runs after the
        `post_update_reservations` interceptor. The (possibly modified) response returned by
        `post_update_reservations` will be passed to
...
class RegionCommitmentsRestTransport(_BaseRegionCommitmentsRestTransport):
    """REST backend synchronous transport for RegionCommitments.
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.AggregatedList",
                    extra={
            ...
            # Return the response
            resp = compute.CommitmentAggregatedList()
            pb_resp = compute.CommitmentAggregatedList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "AggregatedList",
    ...
    class _Get(_BaseRegionCommitmentsRestTransport._BaseGet, RegionCommitmentsRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.Commitment()
            pb_resp = compute.Commitment.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.CommitmentList()
            pb_resp = compute.CommitmentList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseRegionCommitmentsRestTransport._BaseTestIamPermissions, RegionCommitmentsRestStub):
        def __hash__(self):
            return hash("RegionCommitmentsRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._TestIamPermissions._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
    ...
    class _UpdateReservations(_BaseRegionCommitmentsRestTransport._BaseUpdateReservations, RegionCommitmentsRestStub):
        def __hash__(self):
            return hash("RegionCommitmentsRestTransport.UpdateReservations")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update reservations method over HTTP.
            ...
            http_options = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_http_options()

            request, metadata = self._interceptor.pre_update_reservations(request, metadata)
            transcoded_request = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_transcoded_request(http_options, request)

            body = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionCommitmentsClient.UpdateReservations",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "UpdateReservations",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = RegionCommitmentsRestTransport._UpdateReservations._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )
            ...
            resp = self._interceptor.post_update_reservations(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_reservations_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.Operation.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionCommitmentsClient.update_reservations",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionCommitments",
                        "rpcName": "UpdateReservations",
                        "metadata": http_response["headers"],
    ...
    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsRegionCommitmentRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    @property
    def update_reservations(self) -> Callable[[compute.UpdateReservationsRegionCommitmentRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._UpdateReservations(self._session, self._host, self._interceptor)  # type: ignore

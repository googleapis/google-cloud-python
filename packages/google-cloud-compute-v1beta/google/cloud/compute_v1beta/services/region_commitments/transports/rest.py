...
class RegionCommitmentsRestTransport(_BaseRegionCommitmentsRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionCommitmentsRestInterceptor]): Interceptor used
    ...
    class _TestIamPermissions(
        _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions,
        RegionCommitmentsRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionCommitmentsRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
    ...
    class _UpdateReservations(
        _BaseRegionCommitmentsRestTransport._BaseUpdateReservations,
        RegionCommitmentsRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_update_reservations(
                request, metadata
            )
            transcoded_request = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionCommitmentsRestTransport._BaseUpdateReservations._get_query_params_json(
                transcoded_request
            )
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_reservations_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
    ...
    def update_reservations(
        ...
        [compute.UpdateReservationsRegionCommitmentRequest], compute.Operation
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class RegionCommitmentsClient(metaclass=RegionCommitmentsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or RegionCommitmentsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionCommitmentsClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListRegionCommitmentsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_commitments.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionCommitmentRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionCommitmentRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionCommitmentRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionCommitmentRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            commitment_resource (google.cloud.compute_v1beta.types.Commitment):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionCommitmentsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_commitments.pagers.ListPager:
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRegionCommitmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionCommitmentRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionCommitmentRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionCommitmentRequest):
            request = compute.TestIamPermissionsRegionCommitmentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def update_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateRegionCommitmentRequest, dict]):
                The request object. A request message for
    ...
    def update_reservations_unary(
        self,
        request: Optional[Union[compute.UpdateReservationsRegionCommitmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        commitment: Optional[str] = None,
        region_commitments_update_reservations_request_resource: Optional[compute.RegionCommitmentsUpdateReservationsRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        r"""Transfers GPUs or Local SSD disks between
        reservations that are attached to the same commitment.
        ...
        .. code-block:: python
            ...
            def sample_update_reservations():
                # Create a client
                client = compute_v1beta.RegionCommitmentsClient()

                # Initialize request argument(s)
                request = compute_v1beta.UpdateReservationsRegionCommitmentRequest(
                    commitment="commitment_value",
                    project="project_value",
                    region="region_value",
                )
                ...
                # Make the request
                response = client.update_reservations(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateReservationsRegionCommitmentRequest, dict]):
                The request object. A request message for
            ...
            commitment (str):
                ...
                reservations are being updated.

                This corresponds to the ``commitment`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_commitments_update_reservations_request_resource (google.cloud.compute_v1beta.types.RegionCommitmentsUpdateReservationsRequest):
                The body resource for this request
                This corresponds to the ``region_commitments_update_reservations_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, commitment, region_commitments_update_reservations_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.UpdateReservationsRegionCommitmentRequest):
            request = compute.UpdateReservationsRegionCommitmentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if commitment is not None:
                request.commitment = commitment
            if region_commitments_update_reservations_request_resource is not None:
                request.region_commitments_update_reservations_request_resource = region_commitments_update_reservations_request_resource

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_reservations]

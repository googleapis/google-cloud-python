...
class RegionCommitmentsClient(metaclass=RegionCommitmentsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RegionCommitmentsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RegionCommitmentsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RegionCommitmentsClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionCommitmentRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def update_reservations_unary(
        self,
        request: Optional[
            Union[compute.UpdateReservationsRegionCommitmentRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        commitment: Optional[str] = None,
        region_commitments_update_reservations_request_resource: Optional[
            compute.RegionCommitmentsUpdateReservationsRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        if not isinstance(request, compute.UpdateReservationsRegionCommitmentRequest):
            ...
            if region_commitments_update_reservations_request_resource is not None:
                request.region_commitments_update_reservations_request_resource = (
                    region_commitments_update_reservations_request_resource
                )

...
class OrganizationRolloutsTransport(abc.ABC):
    """Abstract transport class for OrganizationRollouts."""
    ...
    def get(
        ...
        Union[compute.Rollout, Awaitable[compute.Rollout]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.OrganizationRolloutsListResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("OrganizationRolloutsTransport",)

...
from google.cloud.compute_v1beta.services.target_tcp_proxies import pagers
...
class TargetTcpProxiesClient(metaclass=TargetTcpProxiesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=TargetTcpProxiesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=TargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=TargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetTcpProxiesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListTargetTcpProxiesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListTargetTcpProxiesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_tcp_proxies.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteTargetTcpProxyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetTcpProxyRequest, dict]):
                The request object. A request message for
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetTcpProxyRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.TargetTcpProxy:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertTargetTcpProxyRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetTcpProxyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_tcp_proxy_resource (google.cloud.compute_v1beta.types.TargetTcpProxy):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListTargetTcpProxiesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetTcpProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_tcp_proxies.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_backend_service():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetBackendServiceTargetTcpProxyRequest(
                    project="project_value",
                    target_tcp_proxy="target_tcp_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetBackendServiceTargetTcpProxyRequest, dict]):
                The request object. A request message for
            ...
            target_tcp_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_tcp_proxies_set_backend_service_request_resource (google.cloud.compute_v1beta.types.TargetTcpProxiesSetBackendServiceRequest):
                The body resource for this request
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_proxy_header():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetProxyHeaderTargetTcpProxyRequest(
                    project="project_value",
                    target_tcp_proxy="target_tcp_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetProxyHeaderTargetTcpProxyRequest, dict]):
                The request object. A request message for
            ...
            target_tcp_proxy (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_tcp_proxies_set_proxy_header_request_resource (google.cloud.compute_v1beta.types.TargetTcpProxiesSetProxyHeaderRequest):
                The body resource for this request
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsTargetTcpProxyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetTcpProxyRequest, dict]):
                The request object. A request message for

    ...
    class _BaseGet:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/zones/{zone}/imageFamilyViews/{family}",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseImageFamilyViewsRestTransport._BaseGet._get_unset_required_fields(query_params))

...
class ImageFamilyViewsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get(
        self, request: compute.GetImageFamilyViewRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetImageFamilyViewRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_with_metadata(
        self, response: compute.ImageFamilyView, metadata: Sequence[Tuple[str, Union[str, bytes]]]
...
class ImageFamilyViewsRestTransport(_BaseImageFamilyViewsRestTransport):
    ...
    @property
    def get(self) -> Callable[[compute.GetImageFamilyViewRequest], compute.ImageFamilyView]:

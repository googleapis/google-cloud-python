...
class ImageFamilyViewsClient(metaclass=ImageFamilyViewsClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ImageFamilyViewsClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetImageFamilyViewRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.ImageFamilyView:

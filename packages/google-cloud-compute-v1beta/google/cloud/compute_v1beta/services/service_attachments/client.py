...
class ServiceAttachmentsClient(metaclass=ServiceAttachmentsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ServiceAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ServiceAttachmentsTransport, Callable[..., ServiceAttachmentsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ServiceAttachmentsClient._read_environment_variables()
        self._client_cert_source = ServiceAttachmentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ServiceAttachmentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ServiceAttachmentsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ServiceAttachmentsTransport], Callable[..., ServiceAttachmentsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ServiceAttachmentsClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListServiceAttachmentsRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1beta.AggregatedListServiceAttachmentsRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListServiceAttachmentsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.service_attachments.pagers.AggregatedListPager:
                Contains a list of
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteServiceAttachmentRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteServiceAttachmentRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetServiceAttachmentRequest(
                    project="project_value",
                    region="region_value",
                    service_attachment="service_attachment_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetServiceAttachmentRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.ServiceAttachment:
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicyServiceAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicyServiceAttachmentRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicyServiceAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertServiceAttachmentRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            service_attachment_resource (google.cloud.compute_v1beta.types.ServiceAttachment):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListServiceAttachmentsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.service_attachments.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchServiceAttachmentRequest(
                    project="project_value",
                    region="region_value",
                    service_attachment="service_attachment_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchServiceAttachmentRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, service_attachment, service_attachment_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicyServiceAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicyServiceAttachmentRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsServiceAttachmentRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsServiceAttachmentRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsServiceAttachmentRequest, dict]):
                The request object. A request message for

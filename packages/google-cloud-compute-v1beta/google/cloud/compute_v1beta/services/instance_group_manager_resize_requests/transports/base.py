...
class InstanceGroupManagerResizeRequestsTransport(abc.ABC):
    ...
    @property
    def cancel(self) -> Callable[[compute.CancelInstanceGroupManagerResizeRequestRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def delete(self) -> Callable[[compute.DeleteInstanceGroupManagerResizeRequestRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.InstanceGroupManagerResizeRequest, Awaitable[compute.InstanceGroupManagerResizeRequest]],
    ]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertInstanceGroupManagerResizeRequestRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.InstanceGroupManagerResizeRequestsListResponse, Awaitable[compute.InstanceGroupManagerResizeRequestsListResponse]],
    ]:
        raise NotImplementedError()

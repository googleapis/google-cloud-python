...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.InstanceGroupManagerResizeRequestsListResponse` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.InstanceGroupManagerResizeRequestsListResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListInstanceGroupManagerResizeRequestsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.InstanceGroupManagerResizeRequestsListResponse):

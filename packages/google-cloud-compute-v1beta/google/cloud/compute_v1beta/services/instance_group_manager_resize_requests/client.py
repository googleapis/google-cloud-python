...
class InstanceGroupManagerResizeRequestsClient(
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=InstanceGroupManagerResizeRequestsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=InstanceGroupManagerResizeRequestsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=InstanceGroupManagerResizeRequestsClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def delete_unary(
        self,
        request: Optional[
            Union[compute.DeleteInstanceGroupManagerResizeRequestRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
    ...
    def get(
        self,
        request: Optional[
            Union[compute.GetInstanceGroupManagerResizeRequestRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
    ...
    def insert_unary(
        self,
        request: Optional[
            Union[compute.InsertInstanceGroupManagerResizeRequestRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        instance_group_manager: Optional[str] = None,
        instance_group_manager_resize_request_resource: Optional[
            compute.InstanceGroupManagerResizeRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        if not isinstance(
            ...
            if instance_group_manager_resize_request_resource is not None:
                request.instance_group_manager_resize_request_resource = (
                    instance_group_manager_resize_request_resource
                )
    ...
    def list(
        self,
        request: Optional[
            Union[compute.ListInstanceGroupManagerResizeRequestsRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,

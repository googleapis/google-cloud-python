        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionHealthCheckServicesClient.AggregatedList",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionHealthCheckServicesClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionHealthCheckServices",
                        "rpcName": "AggregatedList",

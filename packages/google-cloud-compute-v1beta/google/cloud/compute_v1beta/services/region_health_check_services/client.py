...
class RegionHealthCheckServicesClient(metaclass=RegionHealthCheckServicesClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RegionHealthCheckServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., RegionHealthCheckServicesTransport],
            ]
        ] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            RegionHealthCheckServicesClient._read_environment_variables()
        )
        self._client_cert_source = (
            RegionHealthCheckServicesClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = RegionHealthCheckServicesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionHealthCheckServicesClient._get_api_endpoint(
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionHealthCheckServiceRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        #   there are no flattened fields), or create one.
        if not isinstance(
            request, compute.TestIamPermissionsRegionHealthCheckServiceRequest
        ):

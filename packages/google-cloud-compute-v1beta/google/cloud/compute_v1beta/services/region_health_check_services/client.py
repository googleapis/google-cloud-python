...
from google.cloud.compute_v1beta.services.region_health_check_services import pagers
...
class RegionHealthCheckServicesClient(metaclass=RegionHealthCheckServicesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RegionHealthCheckServicesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = RegionHealthCheckServicesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = RegionHealthCheckServicesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionHealthCheckServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = RegionHealthCheckServicesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionHealthCheckServicesTransport, Callable[..., RegionHealthCheckServicesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionHealthCheckServicesTransport,Callable[..., RegionHealthCheckServicesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionHealthCheckServicesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionHealthCheckServicesClient._read_environment_variables()
        self._client_cert_source = RegionHealthCheckServicesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionHealthCheckServicesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, RegionHealthCheckServicesTransport)
        if transport_provided:
            ...
            self._transport = cast(RegionHealthCheckServicesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RegionHealthCheckServicesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionHealthCheckServicesTransport], Callable[..., RegionHealthCheckServicesTransport]] = (
                RegionHealthCheckServicesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionHealthCheckServicesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionHealthCheckServicesClient`.",
                    extra={
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteRegionHealthCheckServiceRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteRegionHealthCheckServiceRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionHealthCheckServiceRequest, dict]):
    ...
    def get(
        self,
        request: Optional[Union[compute.GetRegionHealthCheckServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        health_check_service: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionHealthCheckServiceRequest(
                    health_check_service="health_check_service_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionHealthCheckServiceRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.HealthCheckService:
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertRegionHealthCheckServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionHealthCheckServiceRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionHealthCheckServiceRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            health_check_service_resource (google.cloud.compute_v1beta.types.HealthCheckService):
    ...
    def list(
        self,
        request: Optional[Union[compute.ListRegionHealthCheckServicesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionHealthCheckServicesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionHealthCheckServicesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_health_check_services.pagers.ListPager:
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchRegionHealthCheckServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        health_check_service: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchRegionHealthCheckServiceRequest(
                    health_check_service="health_check_service_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRegionHealthCheckServiceRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, health_check_service, health_check_service_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRegionHealthCheckServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionHealthCheckServiceRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionHealthCheckServiceRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionHealthCheckServiceRequest):
            request = compute.TestIamPermissionsRegionHealthCheckServiceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

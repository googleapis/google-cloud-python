    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListRegionNetworkEndpointGroupsRequest):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListNetworkEndpointsRegionNetworkEndpointGroupsRequest):
                The initial request object.

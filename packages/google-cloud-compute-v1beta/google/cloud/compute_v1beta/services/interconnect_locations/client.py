...
class InterconnectLocationsClient(metaclass=InterconnectLocationsClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.InterconnectLocationsClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetInterconnectLocationRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.InterconnectLocation:
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListInterconnectLocationsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.interconnect_locations.pagers.ListPager:

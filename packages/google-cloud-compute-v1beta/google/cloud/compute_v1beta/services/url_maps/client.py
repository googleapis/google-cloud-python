...
from google.cloud.compute_v1beta.services.url_maps import pagers
...
class UrlMapsClient(metaclass=UrlMapsClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.UrlMapsClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListUrlMapsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.url_maps.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteUrlMapRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteUrlMapRequest, dict]):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetUrlMapRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertUrlMapRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertUrlMapRequest, dict]):
    ...
    def invalidate_cache_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InvalidateCacheUrlMapRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListUrlMapsRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListUrlMapsRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.url_maps.pagers.ListPager:
    ...
    def patch_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchUrlMapRequest, dict]):
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsUrlMapRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateUrlMapRequest, dict]):
    ...
    def validate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ValidateUrlMapRequest, dict]):
                The request object. A request message for
            ...
            url_map (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            url_maps_validate_request_resource (google.cloud.compute_v1beta.types.UrlMapsValidateRequest):
                The body resource for this request

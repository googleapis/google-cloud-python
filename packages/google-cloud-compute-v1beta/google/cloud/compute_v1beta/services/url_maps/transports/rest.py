...
from .rest_base import _BaseUrlMapsRestTransport
    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomUrlMapsInterceptor(UrlMapsRestInterceptor):
            ...
            def pre_invalidate_cache(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_invalidate_cache(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def post_aggregated_list_with_metadata(
        ...
        is returned by the UrlMaps server but before it is returned to user code.
    ...
    def post_invalidate_cache(self, response: compute.Operation) -> compute.Operation:
        ...
        DEPRECATED. Please use the `post_invalidate_cache_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the UrlMaps server but before
        it is returned to user code. This `post_invalidate_cache` interceptor runs
        before the `post_invalidate_cache_with_metadata` interceptor.
        """
        return response
    ...
    def post_invalidate_cache_with_metadata(
        ...
        We recommend only using this `post_invalidate_cache_with_metadata`
        interceptor in new development instead of the `post_invalidate_cache` interceptor.
        When both interceptors are used, this `post_invalidate_cache_with_metadata` interceptor runs after the
        `post_invalidate_cache` interceptor. The (possibly modified) response returned by
        `post_invalidate_cache` will be passed to
        `post_invalidate_cache_with_metadata`.
        """
        return response, metadata
    ...
    def pre_test_iam_permissions(
        self, request: compute.TestIamPermissionsUrlMapRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.TestIamPermissionsUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class UrlMapsRestTransport(_BaseUrlMapsRestTransport):
    """REST backend synchronous transport for UrlMaps.
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.AggregatedList",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "AggregatedList",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.InvalidateCache",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.invalidate_cache",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "InvalidateCache",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(_BaseUrlMapsRestTransport._BaseTestIamPermissions, UrlMapsRestStub):
        def __hash__(self):
            return hash("UrlMapsRestTransport.TestIamPermissions")
        ...
        def __call__(
            self,
            request: compute.TestIamPermissionsUrlMapRequest,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ...
            Args:
                request (~.compute.TestIamPermissionsUrlMapRequest):
                    The request object. A request message for
                UrlMaps.TestIamPermissions. See the
            ...
            http_options = _BaseUrlMapsRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseUrlMapsRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseUrlMapsRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseUrlMapsRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
            ...
            # Send the request
            response = UrlMapsRestTransport._TestIamPermissions._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.UrlMapsClient.Validate",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Validate",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.UrlMapsClient.validate",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.UrlMaps",
                        "rpcName": "Validate",
                        "metadata": http_response["headers"],
    ...
    @property
    def test_iam_permissions(self) -> Callable[[compute.TestIamPermissionsUrlMapRequest], compute.TestPermissionsResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

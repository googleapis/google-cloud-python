...
class RegionBackendServicesClient(metaclass=RegionBackendServicesClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RegionBackendServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionBackendServicesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionBackendServicesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionBackendServicesClient._get_api_endpoint(
    ...
    def list_usable(
        self,
        request: Optional[
            Union[compute.ListUsableRegionBackendServicesRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def set_security_policy_unary(
        self,
        request: Optional[
            Union[compute.SetSecurityPolicyRegionBackendServiceRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionBackendServiceRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

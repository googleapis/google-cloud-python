...
class RegionSslCertificatesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_with_metadata(
        self,
        response: compute.SslCertificate,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ...
    def post_list_with_metadata(
        self,
        response: compute.SslCertificateList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
...
class RegionSslCertificatesRestTransport(_BaseRegionSslCertificatesRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionSslCertificatesRestInterceptor]): Interceptor used
    ...
    class _Delete(
        _BaseRegionSslCertificatesRestTransport._BaseDelete,
    ...
    class _Get(
        _BaseRegionSslCertificatesRestTransport._BaseGet, RegionSslCertificatesRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Jsonify the query params
            query_params = (
                _BaseRegionSslCertificatesRestTransport._BaseGet._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _Insert(
        _BaseRegionSslCertificatesRestTransport._BaseInsert,
        RegionSslCertificatesRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseRegionSslCertificatesRestTransport._BaseInsert._get_request_body_json(
                transcoded_request
            )
    ...
    class _List(
        _BaseRegionSslCertificatesRestTransport._BaseList, RegionSslCertificatesRestStub
    ):
        def __hash__(self):
    ...
    class _TestIamPermissions(
        _BaseRegionSslCertificatesRestTransport._BaseTestIamPermissions,
        RegionSslCertificatesRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseRegionSslCertificatesRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionSslCertificatesRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionSslCertificatesRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = (
                RegionSslCertificatesRestTransport._TestIamPermissions._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,

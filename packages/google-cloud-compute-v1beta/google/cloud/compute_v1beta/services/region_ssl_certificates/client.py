...
class RegionSslCertificatesClient(metaclass=RegionSslCertificatesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RegionSslCertificatesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RegionSslCertificatesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RegionSslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionSslCertificateRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionHealthSourcesClient.GetHealth",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionHealthSources",
                        "rpcName": "GetHealth",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionHealthSourcesClient.get_health",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionHealthSources",
                        "rpcName": "GetHealth",
                        "metadata": http_response["headers"],

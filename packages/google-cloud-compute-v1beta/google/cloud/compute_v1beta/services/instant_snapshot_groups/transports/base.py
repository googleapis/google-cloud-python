...
class InstantSnapshotGroupsTransport(abc.ABC):
    """Abstract transport class for InstantSnapshotGroups."""
    ...
    def get(
        ...
        [compute.GetInstantSnapshotGroupRequest],
        Union[compute.InstantSnapshotGroup, Awaitable[compute.InstantSnapshotGroup]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.ListInstantSnapshotGroups],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("InstantSnapshotGroupsTransport",)

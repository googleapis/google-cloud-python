...
class BackendBucketsClient(metaclass=BackendBucketsClientMeta):
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListBackendBucketsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.backend_buckets.pagers.AggregatedListPager:

...
class BackendBucketsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list(
        self, response: compute.BackendBucketAggregatedList
    ...
    def post_aggregated_list_with_metadata(
        ...
        compute.BackendBucketAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for aggregated_list
...
class BackendBucketsRestTransport(_BaseBackendBucketsRestTransport):
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseAddSignedUrlKey,
    ...
    class _AggregatedList(
        _BaseBackendBucketsRestTransport._BaseAggregatedList, BackendBucketsRestStub
    ):
        def __hash__(self):
            return hash("BackendBucketsRestTransport.AggregatedList")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseBackendBucketsRestTransport._BaseAggregatedList._get_http_options()
            )
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseAggregatedList,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.BackendBucketsClient.AggregatedList",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.BackendBuckets",
            ...
            # Send the request
            response = BackendBucketsRestTransport._AggregatedList._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = compute.BackendBucketAggregatedList()
            pb_resp = compute.BackendBucketAggregatedList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.BackendBucketAggregatedList.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.BackendBucketsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.BackendBuckets",
                        "rpcName": "AggregatedList",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseDelete,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseDeleteSignedUrlKey,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseGet,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseGetIamPolicy,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseInsert,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseListUsable,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BasePatch,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseSetIamPolicy,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseTestIamPermissions,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseBackendBucketsRestTransport._BaseUpdate,

...
from google.cloud.compute_v1beta.services.network_edge_security_services import pagers
...
class NetworkEdgeSecurityServicesClientMeta(type):
    """Metaclass for the NetworkEdgeSecurityServices client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[NetworkEdgeSecurityServicesTransport]]
    _transport_registry["rest"] = NetworkEdgeSecurityServicesRestTransport
...
class NetworkEdgeSecurityServicesClient(metaclass=NetworkEdgeSecurityServicesClientMeta):
    ...
    @property
    def transport(self) -> NetworkEdgeSecurityServicesTransport:
        """Returns the transport used by the client instance.

        Returns:
            NetworkEdgeSecurityServicesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = NetworkEdgeSecurityServicesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = NetworkEdgeSecurityServicesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = NetworkEdgeSecurityServicesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NetworkEdgeSecurityServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = NetworkEdgeSecurityServicesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, NetworkEdgeSecurityServicesTransport, Callable[..., NetworkEdgeSecurityServicesTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,NetworkEdgeSecurityServicesTransport,Callable[..., NetworkEdgeSecurityServicesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the NetworkEdgeSecurityServicesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NetworkEdgeSecurityServicesClient._read_environment_variables()
        self._client_cert_source = NetworkEdgeSecurityServicesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = NetworkEdgeSecurityServicesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, NetworkEdgeSecurityServicesTransport)
        if transport_provided:
            # transport is a NetworkEdgeSecurityServicesTransport instance.
            ...
            self._transport = cast(NetworkEdgeSecurityServicesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or NetworkEdgeSecurityServicesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NetworkEdgeSecurityServicesTransport], Callable[..., NetworkEdgeSecurityServicesTransport]] = (
                NetworkEdgeSecurityServicesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., NetworkEdgeSecurityServicesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.NetworkEdgeSecurityServicesClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[Union[compute.AggregatedListNetworkEdgeSecurityServicesRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                # Create a client
                client = compute_v1beta.NetworkEdgeSecurityServicesClient()

                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListNetworkEdgeSecurityServicesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListNetworkEdgeSecurityServicesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.network_edge_security_services.pagers.AggregatedListPager:
        ...
        if not isinstance(request, compute.AggregatedListNetworkEdgeSecurityServicesRequest):
            request = compute.AggregatedListNetworkEdgeSecurityServicesRequest(request)
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteNetworkEdgeSecurityServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeleteNetworkEdgeSecurityServiceRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNetworkEdgeSecurityServiceRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_edge_security_service]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (
                    ...
                    ("network_edge_security_service", request.network_edge_security_service),
                )
            ),
        )
    ...
    def get(
        self,
        request: Optional[Union[compute.GetNetworkEdgeSecurityServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_edge_security_service: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNetworkEdgeSecurityServiceRequest(
                    network_edge_security_service="network_edge_security_service_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNetworkEdgeSecurityServiceRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.NetworkEdgeSecurityService:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetNetworkEdgeSecurityServiceRequest):
            request = compute.GetNetworkEdgeSecurityServiceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertNetworkEdgeSecurityServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_edge_security_service_resource: Optional[compute.NetworkEdgeSecurityService] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertNetworkEdgeSecurityServiceRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertNetworkEdgeSecurityServiceRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_edge_security_service_resource (google.cloud.compute_v1beta.types.NetworkEdgeSecurityService):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_edge_security_service_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.InsertNetworkEdgeSecurityServiceRequest):
            ...
            if network_edge_security_service_resource is not None:
                request.network_edge_security_service_resource = network_edge_security_service_resource
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchNetworkEdgeSecurityServiceRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        network_edge_security_service: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchNetworkEdgeSecurityServiceRequest(
                    network_edge_security_service="network_edge_security_service_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchNetworkEdgeSecurityServiceRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, network_edge_security_service, network_edge_security_service_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")

...
class NetworkEdgeSecurityServicesClient(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                NetworkEdgeSecurityServicesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str,
                NetworkEdgeSecurityServicesTransport,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            NetworkEdgeSecurityServicesClient._read_environment_variables()
        )
        self._client_cert_source = (
            NetworkEdgeSecurityServicesClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = NetworkEdgeSecurityServicesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or NetworkEdgeSecurityServicesClient._get_api_endpoint(

...
class TargetGrpcProxiesClient(metaclass=TargetGrpcProxiesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.TargetGrpcProxiesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteTargetGrpcProxyRequest, dict]):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetTargetGrpcProxyRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.TargetGrpcProxy:
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertTargetGrpcProxyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            target_grpc_proxy_resource (google.cloud.compute_v1beta.types.TargetGrpcProxy):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListTargetGrpcProxiesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.target_grpc_proxies.pagers.ListPager:
    ...
    def patch_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchTargetGrpcProxyRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsTargetGrpcProxyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsTargetGrpcProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetGrpcProxyRequest):
            request = compute.TestIamPermissionsTargetGrpcProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

...
from google.cloud.compute_v1beta.services.ssl_policies import pagers
...
class SslPoliciesClient(metaclass=SslPoliciesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.SslPoliciesClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListSslPoliciesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.ssl_policies.pagers.AggregatedListPager:
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteSslPolicyRequest, dict]):
                The request object. A request message for
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetSslPolicyRequest, dict]):
                The request object. A request message for
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicySslPolicyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetIamPolicySslPolicyRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicySslPolicyRequest, dict]):
                The request object. A request message for
                SslPolicies.GetIamPolicy. See the method
                description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetIamPolicySslPolicyRequest):
            request = compute.GetIamPolicySslPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertSslPolicyRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertSslPolicyRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            ssl_policy_resource (google.cloud.compute_v1beta.types.SslPolicy):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListSslPoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.ssl_policies.pagers.ListPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def list_available_features(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListAvailableFeaturesSslPoliciesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.SslPoliciesListAvailableFeaturesResponse:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchSslPolicyRequest(
                    project="project_value",
                    ssl_policy="ssl_policy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchSslPolicyRequest, dict]):
                The request object. A request message for
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicySslPolicyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicySslPolicyRequest, dict]):
                The request object. A request message for
                SslPolicies.SetIamPolicy. See the method
                description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetIamPolicySslPolicyRequest):
            request = compute.SetIamPolicySslPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsSslPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsSslPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsSslPolicyRequest):
            request = compute.TestIamPermissionsSslPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

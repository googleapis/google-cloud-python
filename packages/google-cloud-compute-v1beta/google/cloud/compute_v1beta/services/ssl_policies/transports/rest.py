...
class SslPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_iam_policy(
        ...
        compute.GetIamPolicySslPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_set_iam_policy(
        ...
        compute.SetIamPolicySslPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
...
class SslPoliciesRestTransport(_BaseSslPoliciesRestTransport):
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseAggregatedList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseDelete,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseGet,
    ...
    class _GetIamPolicy(
        _BaseSslPoliciesRestTransport._BaseGetIamPolicy, SslPoliciesRestStub
    ):
        def __hash__(self):
            return hash("SslPoliciesRestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseSslPoliciesRestTransport._BaseGetIamPolicy._get_http_options()
            )
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseGetIamPolicy,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.SslPoliciesClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.SslPolicies",
            ...
            # Send the request
            response = SslPoliciesRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.SslPoliciesClient.get_iam_policy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.SslPolicies",
                        "rpcName": "GetIamPolicy",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseInsert,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseList,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseListAvailableFeatures,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BasePatch,
    ...
    class _SetIamPolicy(
        _BaseSslPoliciesRestTransport._BaseSetIamPolicy, SslPoliciesRestStub
    ):
        def __hash__(self):
            return hash("SslPoliciesRestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseSslPoliciesRestTransport._BaseSetIamPolicy._get_http_options()
            )
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseSetIamPolicy,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.SslPoliciesClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.SslPolicies",
            ...
            # Send the request
            response = SslPoliciesRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.SslPoliciesClient.set_iam_policy",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.SslPolicies",
                        "rpcName": "SetIamPolicy",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(
        _BaseSslPoliciesRestTransport._BaseTestIamPermissions, SslPoliciesRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseSslPoliciesRestTransport._BaseTestIamPermissions,
            ...
            # Send the request
            response = SslPoliciesRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    def get_iam_policy(
        self,
    ) -> Callable[[compute.GetIamPolicySslPolicyRequest], compute.Policy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def set_iam_policy(
        self,
    ) -> Callable[[compute.SetIamPolicySslPolicyRequest], compute.Policy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsSslPolicyRequest], compute.TestPermissionsResponse
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

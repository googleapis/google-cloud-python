    ...
    class _BaseAttachNetworkEndpoints:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints",
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/compute/beta/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}",
                },
            ]
            return http_options
    ...
    class _BaseDetachNetworkEndpoints:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints",
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/networkEndpointGroups",
    ...
    class _BaseListNetworkEndpoints:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints",
                },
            ]
            return http_options

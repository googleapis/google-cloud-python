...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.NetworkEndpointGroupList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NetworkEndpointGroupList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListGlobalNetworkEndpointGroupsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NetworkEndpointGroupList):
...
class ListNetworkEndpointsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.NetworkEndpointGroupsListNetworkEndpoints` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NetworkEndpointGroupsListNetworkEndpoints`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NetworkEndpointGroupsListNetworkEndpoints):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
        ...
        """
        self._method = method
        self._request = compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata

...
from google.cloud.compute_v1beta.services.routes import pagers
...
class RoutesClient(metaclass=RoutesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RoutesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRouteRequest, dict]):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRouteRequest, dict]):
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRouteRequest, dict]):
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            route_resource (google.cloud.compute_v1beta.types.Route):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRoutesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.routes.pagers.ListPager:
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRouteRequest, dict]):

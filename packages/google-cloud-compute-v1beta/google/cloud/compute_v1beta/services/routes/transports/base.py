...
class RoutesTransport(abc.ABC):
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteRouteRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetRouteRequest], Union[compute.Route, Awaitable[compute.Route]]]:
        raise NotImplementedError()

    @property
    def insert(self) -> Callable[[compute.InsertRouteRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListRoutesRequest], Union[compute.RouteList, Awaitable[compute.RouteList]]]:
        raise NotImplementedError()

    @property
    def test_iam_permissions(
        self,
    ) -> Callable[[compute.TestIamPermissionsRouteRequest], Union[compute.TestPermissionsResponse, Awaitable[compute.TestPermissionsResponse]]]:
        raise NotImplementedError()

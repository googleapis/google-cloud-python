...
class RegionOperationsClient(metaclass=RegionOperationsClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionOperationsClient`.",
                    extra={
    ...
    def delete(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionOperationRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.types.DeleteRegionOperationResponse:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionOperationRequest(
                    operation="operation_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionOperationRequest, dict]):
                The request object. A request message for
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionOperationsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_operations.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_wait():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.WaitRegionOperationRequest(
                    operation="operation_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.WaitRegionOperationRequest, dict]):
                The request object. A request message for

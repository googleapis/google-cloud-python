...
class RegionSnapshotSettingsTransport(abc.ABC):
    ...
    @property
    def get(self) -> Callable[[compute.GetRegionSnapshotSettingRequest], Union[compute.SnapshotSettings, Awaitable[compute.SnapshotSettings]]]:
        raise NotImplementedError()

    @property
    def patch(self) -> Callable[[compute.PatchRegionSnapshotSettingRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

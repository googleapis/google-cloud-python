...
from .base import DEFAULT_CLIENT_INFO, SubnetworksTransport


class _BaseSubnetworksRestTransport(SubnetworksTransport):
    """Base REST backend transport for Subnetworks.
    ...
    class _BaseAggregatedList:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/aggregated/subnetworks",
                },
            ]
            return http_options
    ...
    class _BaseDelete:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks/{subnetwork}",
                },
            ]
            return http_options
    ...
    class _BaseExpandIpCidrRange:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks/{subnetwork}/expandIpCidrRange",
    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks/{resource}/getIamPolicy",
                },
            ]
            return http_options
    ...
    class _BaseInsert:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks",
    ...
    class _BaseListUsable:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/compute/beta/projects/{project}/aggregated/subnetworks/listUsable",
                },
            ]
            return http_options
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks/{resource}/setIamPolicy",
    ...
    class _BaseSetPrivateIpGoogleAccess:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks/{subnetwork}/setPrivateIpGoogleAccess",
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/subnetworks/{resource}/testIamPermissions",
...
__all__ = ("_BaseSubnetworksRestTransport",)

...
from google.cloud.compute_v1beta.services.subnetworks import pagers
...
class SubnetworksClient(metaclass=SubnetworksClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.SubnetworksClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListSubnetworksRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.subnetworks.pagers.AggregatedListPager:
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteSubnetworkRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_expand_ip_cidr_range():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ExpandIpCidrRangeSubnetworkRequest(
                    project="project_value",
                    region="region_value",
                    subnetwork="subnetwork_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ExpandIpCidrRangeSubnetworkRequest, dict]):
                The request object. A request message for
            ...
            subnetwork (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            subnetworks_expand_ip_cidr_range_request_resource (google.cloud.compute_v1beta.types.SubnetworksExpandIpCidrRangeRequest):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetSubnetworkRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.Subnetwork:
    ...
    def get_iam_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetIamPolicySubnetworkRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertSubnetworkRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertSubnetworkRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            subnetwork_resource (google.cloud.compute_v1beta.types.Subnetwork):
                The body resource for this request
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListSubnetworksRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListSubnetworksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.subnetworks.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_usable():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListUsableSubnetworksRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListUsableSubnetworksRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.subnetworks.pagers.ListUsablePager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchSubnetworkRequest(
                    project="project_value",
                    region="region_value",
                    subnetwork="subnetwork_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchSubnetworkRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetIamPolicySubnetworkRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetIamPolicySubnetworkRequest, dict]):
                The request object. A request message for
    ...
    def set_private_ip_google_access_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetPrivateIpGoogleAccessSubnetworkRequest, dict]):
                The request object. A request message for
            ...
            subnetwork (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            subnetworks_set_private_ip_google_access_request_resource (google.cloud.compute_v1beta.types.SubnetworksSetPrivateIpGoogleAccessRequest):
                The body resource for this request
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsSubnetworkRequest, dict]):
                The request object. A request message for

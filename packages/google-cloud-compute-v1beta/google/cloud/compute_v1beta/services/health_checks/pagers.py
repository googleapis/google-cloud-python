...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.HealthChecksAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.HealthChecksAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListHealthChecksRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.HealthChecksAggregatedList):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListHealthChecksRequest):
                The initial request object.

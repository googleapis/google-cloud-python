...
class InstantSnapshotsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list(
        self, response: compute.InstantSnapshotAggregatedList
    ...
    def post_aggregated_list_with_metadata(
        self,
        response: compute.InstantSnapshotAggregatedList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        compute.InstantSnapshotAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for aggregated_list
...
class InstantSnapshotsRestTransport(_BaseInstantSnapshotsRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[InstantSnapshotsRestInterceptor]): Interceptor used
    ...
    class _AggregatedList(
        _BaseInstantSnapshotsRestTransport._BaseAggregatedList, InstantSnapshotsRestStub
    ):
        def __hash__(self):
    ...
    class _Delete(
        _BaseInstantSnapshotsRestTransport._BaseDelete, InstantSnapshotsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Jsonify the query params
            query_params = (
                _BaseInstantSnapshotsRestTransport._BaseDelete._get_query_params_json(
                    transcoded_request
                )
            )
        ...
        def __call__(
            ...
            *,
            ...
            Returns:
                ...
                resource.
                You can use instant snapshots to create
            ...
            # Jsonify the query params
            query_params = (
                _BaseInstantSnapshotsRestTransport._BaseGet._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _GetIamPolicy(
        _BaseInstantSnapshotsRestTransport._BaseGetIamPolicy, InstantSnapshotsRestStub
    ):
        def __hash__(self):
    ...
    class _Insert(
        _BaseInstantSnapshotsRestTransport._BaseInsert, InstantSnapshotsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = (
                _BaseInstantSnapshotsRestTransport._BaseInsert._get_request_body_json(
                    transcoded_request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseInstantSnapshotsRestTransport._BaseInsert._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _List(_BaseInstantSnapshotsRestTransport._BaseList, InstantSnapshotsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Jsonify the query params
            query_params = (
                _BaseInstantSnapshotsRestTransport._BaseList._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _SetIamPolicy(
        _BaseInstantSnapshotsRestTransport._BaseSetIamPolicy, InstantSnapshotsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseInstantSnapshotsRestTransport._BaseSetIamPolicy._get_request_body_json(
                transcoded_request
            )
    ...
    class _SetLabels(
        _BaseInstantSnapshotsRestTransport._BaseSetLabels, InstantSnapshotsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseInstantSnapshotsRestTransport._BaseSetLabels._get_request_body_json(
                transcoded_request
            )
    ...
    class _TestIamPermissions(
        _BaseInstantSnapshotsRestTransport._BaseTestIamPermissions,
        InstantSnapshotsRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseInstantSnapshotsRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseInstantSnapshotsRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )
    ...
    def delete(
        self,
    ) -> Callable[[compute.DeleteInstantSnapshotRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get(
        self,
    ) -> Callable[[compute.GetInstantSnapshotRequest], compute.InstantSnapshot]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get_iam_policy(
        self,
    ) -> Callable[[compute.GetIamPolicyInstantSnapshotRequest], compute.Policy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def insert(
        self,
    ) -> Callable[[compute.InsertInstantSnapshotRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def list(
        self,
    ) -> Callable[[compute.ListInstantSnapshotsRequest], compute.InstantSnapshotList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def set_iam_policy(
        self,
    ) -> Callable[[compute.SetIamPolicyInstantSnapshotRequest], compute.Policy]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def set_labels(
        self,
    ) -> Callable[[compute.SetLabelsInstantSnapshotRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

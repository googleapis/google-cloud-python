            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseExternalVpnGatewaysRestTransport._BaseDelete,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.Delete",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "Delete",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseExternalVpnGatewaysRestTransport._BaseGet,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseExternalVpnGatewaysRestTransport._BaseInsert,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseExternalVpnGatewaysRestTransport._BaseList,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.SetLabels",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "SetLabels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.set_labels",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "SetLabels",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.ExternalVpnGatewaysClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.ExternalVpnGateways",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

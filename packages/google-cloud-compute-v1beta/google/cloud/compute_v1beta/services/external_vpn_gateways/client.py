...
from google.cloud.compute_v1beta.services.external_vpn_gateways import pagers
...
class ExternalVpnGatewaysClient(metaclass=ExternalVpnGatewaysClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ExternalVpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ExternalVpnGatewaysTransport, Callable[..., ExternalVpnGatewaysTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ExternalVpnGatewaysClient._read_environment_variables()
        self._client_cert_source = ExternalVpnGatewaysClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ExternalVpnGatewaysClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ExternalVpnGatewaysClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ExternalVpnGatewaysTransport], Callable[..., ExternalVpnGatewaysTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.ExternalVpnGatewaysClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteExternalVpnGatewayRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteExternalVpnGatewayRequest, dict]):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetExternalVpnGatewayRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertExternalVpnGatewayRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertExternalVpnGatewayRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            external_vpn_gateway_resource (google.cloud.compute_v1beta.types.ExternalVpnGateway):
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListExternalVpnGatewaysRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.external_vpn_gateways.pagers.ListPager:
    ...
    def set_labels_unary(
        self,
        request: Optional[Union[compute.SetLabelsExternalVpnGatewayRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsExternalVpnGatewayRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsExternalVpnGatewayRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsExternalVpnGatewayRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsExternalVpnGatewayRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsExternalVpnGatewayRequest, dict]):
                The request object. A request message for

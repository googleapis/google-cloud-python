...
class RegionUrlMapsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete(
        ...
        compute.DeleteRegionUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_get(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.GetRegionUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_insert(
        ...
        compute.InsertRegionUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_invalidate_cache(
        self,
        request: compute.InvalidateCacheRegionUrlMapRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
    ...
    def pre_list(
        ...
        compute.ListRegionUrlMapsRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_patch(
        ...
        compute.PatchRegionUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_update(
        ...
        compute.UpdateRegionUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def pre_validate(
        ...
        compute.ValidateRegionUrlMapRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
...
class RegionUrlMapsRestTransport(_BaseRegionUrlMapsRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionUrlMapsRestInterceptor]): Interceptor used
    ...
    class _Delete(_BaseRegionUrlMapsRestTransport._BaseDelete, RegionUrlMapsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionUrlMapsRestTransport._BaseDelete._get_http_options()
            )

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BaseDelete._get_transcoded_request(
            ...
            query_params = (
                _BaseRegionUrlMapsRestTransport._BaseDelete._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.Delete",
                    extra={
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._Delete._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseRegionUrlMapsRestTransport._BaseGet, RegionUrlMapsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BaseGet._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseRegionUrlMapsRestTransport._BaseGet._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseRegionUrlMapsRestTransport._BaseInsert, RegionUrlMapsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionUrlMapsRestTransport._BaseInsert._get_http_options()
            )

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BaseInsert._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseRegionUrlMapsRestTransport._BaseInsert._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseRegionUrlMapsRestTransport._BaseInsert._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._Insert._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _InvalidateCache(
        _BaseRegionUrlMapsRestTransport._BaseInvalidateCache, RegionUrlMapsRestStub
    ):
        def __hash__(self):
            return hash("RegionUrlMapsRestTransport.InvalidateCache")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.InvalidateCacheRegionUrlMapRequest):
                    The request object. A request message for
                RegionUrlMaps.InvalidateCache. See the
            ...
            http_options = (
                _BaseRegionUrlMapsRestTransport._BaseInvalidateCache._get_http_options()
            )

            request, metadata = self._interceptor.pre_invalidate_cache(
                request, metadata
            )
            transcoded_request = _BaseRegionUrlMapsRestTransport._BaseInvalidateCache._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionUrlMapsRestTransport._BaseInvalidateCache._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionUrlMapsRestTransport._BaseInvalidateCache._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.InvalidateCache",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._InvalidateCache._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.invalidate_cache",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "InvalidateCache",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseRegionUrlMapsRestTransport._BaseList, RegionUrlMapsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BaseList._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseRegionUrlMapsRestTransport._BaseList._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _Patch(_BaseRegionUrlMapsRestTransport._BasePatch, RegionUrlMapsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionUrlMapsRestTransport._BasePatch._get_http_options()
            )

            request, metadata = self._interceptor.pre_patch(request, metadata)
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BasePatch._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseRegionUrlMapsRestTransport._BasePatch._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseRegionUrlMapsRestTransport._BasePatch._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._Patch._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(
        _BaseRegionUrlMapsRestTransport._BaseTestIamPermissions, RegionUrlMapsRestStub
    ):
        def __hash__(self):
            return hash("RegionUrlMapsRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.TestIamPermissionsRegionUrlMapRequest):
                    The request object. A request message for
                RegionUrlMaps.TestIamPermissions. See
            ...
            http_options = _BaseRegionUrlMapsRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseRegionUrlMapsRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseRegionUrlMapsRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRegionUrlMapsRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
    ...
    class _Update(_BaseRegionUrlMapsRestTransport._BaseUpdate, RegionUrlMapsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionUrlMapsRestTransport._BaseUpdate._get_http_options()
            )

            request, metadata = self._interceptor.pre_update(request, metadata)
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BaseUpdate._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseRegionUrlMapsRestTransport._BaseUpdate._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseRegionUrlMapsRestTransport._BaseUpdate._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._Update._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
    ...
    class _Validate(
        _BaseRegionUrlMapsRestTransport._BaseValidate, RegionUrlMapsRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionUrlMapsRestTransport._BaseValidate._get_http_options()
            )

            request, metadata = self._interceptor.pre_validate(request, metadata)
            transcoded_request = (
                _BaseRegionUrlMapsRestTransport._BaseValidate._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseRegionUrlMapsRestTransport._BaseValidate._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseRegionUrlMapsRestTransport._BaseValidate._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RegionUrlMapsClient.Validate",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Validate",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RegionUrlMapsRestTransport._Validate._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RegionUrlMapsClient.validate",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.RegionUrlMaps",
                        "rpcName": "Validate",
                        "metadata": http_response["headers"],
    ...
    def invalidate_cache(
        self,
    ) -> Callable[[compute.InvalidateCacheRegionUrlMapRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsRegionUrlMapRequest], compute.TestPermissionsResponse
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

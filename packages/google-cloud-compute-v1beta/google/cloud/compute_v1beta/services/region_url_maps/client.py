...
class RegionUrlMapsClient(metaclass=RegionUrlMapsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RegionUrlMapsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RegionUrlMapsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RegionUrlMapsClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def invalidate_cache_unary(
        self,
        request: Optional[
            Union[compute.InvalidateCacheRegionUrlMapRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionUrlMapRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

...
from google.cloud.compute_v1beta.services.region_url_maps import pagers
...
class RegionUrlMapsClient(metaclass=RegionUrlMapsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionUrlMapsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, RegionUrlMapsTransport, Callable[..., RegionUrlMapsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = RegionUrlMapsClient._read_environment_variables()
        self._client_cert_source = RegionUrlMapsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = RegionUrlMapsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or RegionUrlMapsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[RegionUrlMapsTransport], Callable[..., RegionUrlMapsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.RegionUrlMapsClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1beta.DeleteRegionUrlMapRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteRegionUrlMapRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetRegionUrlMapRequest(
                    project="project_value",
                    region="region_value",
                    url_map="url_map_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetRegionUrlMapRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InsertRegionUrlMapRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertRegionUrlMapRequest, dict]):
                The request object. A request message for
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            url_map_resource (google.cloud.compute_v1beta.types.UrlMap):
    ...
    def invalidate_cache_unary(
        self,
        request: Optional[Union[compute.InvalidateCacheRegionUrlMapRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        url_map: Optional[str] = None,
        cache_invalidation_rule_resource: Optional[compute.CacheInvalidationRule] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        .. code-block:: python
            ...
            def sample_invalidate_cache():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.InvalidateCacheRegionUrlMapRequest(
                    project="project_value",
                    region="region_value",
                    url_map="url_map_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InvalidateCacheRegionUrlMapRequest, dict]):
                The request object. A request message for
            ...
            url_map (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            cache_invalidation_rule_resource (google.cloud.compute_v1beta.types.CacheInvalidationRule):
                The body resource for this request
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, url_map, cache_invalidation_rule_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.InvalidateCacheRegionUrlMapRequest):
            request = compute.InvalidateCacheRegionUrlMapRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
            ...
            if cache_invalidation_rule_resource is not None:
                request.cache_invalidation_rule_resource = cache_invalidation_rule_resource
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListRegionUrlMapsRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListRegionUrlMapsRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.region_url_maps.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchRegionUrlMapRequest(
                    project="project_value",
                    region="region_value",
                    url_map="url_map_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchRegionUrlMapRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRegionUrlMapRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsRegionUrlMapRequest(
                    project="project_value",
                    region="region_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsRegionUrlMapRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRegionUrlMapRequest):
            request = compute.TestIamPermissionsRegionUrlMapRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def update_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateRegionUrlMapRequest, dict]):
                The request object. A request message for
    ...
    def validate(
        ...
        *,
        ...
        region: Optional[str] = None,
        url_map: Optional[str] = None,
        region_url_maps_validate_request_resource: Optional[compute.RegionUrlMapsValidateRequest] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ValidateRegionUrlMapRequest, dict]):
                The request object. A request message for
            ...
            url_map (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            region_url_maps_validate_request_resource (google.cloud.compute_v1beta.types.RegionUrlMapsValidateRequest):
                The body resource for this request
        ...
        Returns:
            google.cloud.compute_v1beta.types.UrlMapsValidateResponse:

        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, url_map, region_url_maps_validate_request_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if not isinstance(request, compute.ValidateRegionUrlMapRequest):
            ...
            if region_url_maps_validate_request_resource is not None:
                request.region_url_maps_validate_request_resource = region_url_maps_validate_request_resource

...
class ForwardingRulesClient(metaclass=ForwardingRulesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=ForwardingRulesClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=ForwardingRulesClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=ForwardingRulesClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsForwardingRuleRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,

...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.ForwardingRuleAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.ForwardingRuleAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListForwardingRulesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.ForwardingRuleAggregatedList):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListForwardingRulesRequest):
                The initial request object.

    ...
    class _BaseCalendarMode:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/advice/calendarMode",
    ...
    class _BaseCapacity:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/advice/capacity",
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.CapacityAdviceRpcRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAdviceRestTransport._BaseCapacity._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseCapacityHistory:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/beta/projects/{project}/regions/{region}/advice/capacityHistory",
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.CapacityHistoryAdviceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAdviceRestTransport._BaseCapacityHistory._get_unset_required_fields(
                    query_params
                )
            )

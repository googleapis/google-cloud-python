...
class PublicDelegatedPrefixesClient(metaclass=PublicDelegatedPrefixesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PublicDelegatedPrefixesClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or PublicDelegatedPrefixesClient._get_api_endpoint(

...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.NodeTypeAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NodeTypeAggregatedList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.AggregatedListNodeTypesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NodeTypeAggregatedList):
...
class ListPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.compute_v1beta.types.NodeTypeList` object, and
    provides an ``__iter__`` method to iterate through its
    ``items`` field.
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.NodeTypeList`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1beta.types.ListNodeTypesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.NodeTypeList):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

...
class InterconnectRemoteLocationsTransport(abc.ABC):
    ...
    def get(
        ...
        [compute.GetInterconnectRemoteLocationRequest], Union[compute.InterconnectRemoteLocation, Awaitable[compute.InterconnectRemoteLocation]]
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.InterconnectRemoteLocationList, Awaitable[compute.InterconnectRemoteLocationList]],
    ]:
        raise NotImplementedError()

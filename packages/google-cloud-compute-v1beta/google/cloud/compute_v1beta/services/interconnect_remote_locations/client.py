...
class InterconnectRemoteLocationsClient(metaclass=InterconnectRemoteLocationsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = InterconnectRemoteLocationsClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or InterconnectRemoteLocationsClient._get_api_endpoint(

...
class DiskTypesTransport(abc.ABC):
    ...
    def aggregated_list(
        self,
    ) -> Callable[[compute.AggregatedListDiskTypesRequest], Union[compute.DiskTypeAggregatedList, Awaitable[compute.DiskTypeAggregatedList]]]:
        raise NotImplementedError()

    @property
    def get(self) -> Callable[[compute.GetDiskTypeRequest], Union[compute.DiskType, Awaitable[compute.DiskType]]]:
        raise NotImplementedError()

    @property
    def list(self) -> Callable[[compute.ListDiskTypesRequest], Union[compute.DiskTypeList, Awaitable[compute.DiskTypeList]]]:
        raise NotImplementedError()

...
from google.cloud.compute_v1beta.services.disk_types import pagers
...
class DiskTypesClient(metaclass=DiskTypesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DiskTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DiskTypesTransport, Callable[..., DiskTypesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DiskTypesClient._read_environment_variables()
        self._client_cert_source = DiskTypesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DiskTypesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DiskTypesTransport], Callable[..., DiskTypesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.DiskTypesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                # Create a client
                client = compute_v1beta.DiskTypesClient()

                # Initialize request argument(s)
                request = compute_v1beta.AggregatedListDiskTypesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AggregatedListDiskTypesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.disk_types.pagers.AggregatedListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetDiskTypeRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetDiskTypeRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, disk_type]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListDiskTypesRequest(
                    project="project_value",
                    zone="zone_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListDiskTypesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1beta.services.disk_types.pagers.ListPager:

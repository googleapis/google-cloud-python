...
class GlobalOrganizationOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete(
        self, request: compute.DeleteGlobalOrganizationOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.DeleteGlobalOrganizationOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete(self, response: compute.DeleteGlobalOrganizationOperationResponse) -> compute.DeleteGlobalOrganizationOperationResponse:
    ...
    def post_delete_with_metadata(
        self, response: compute.DeleteGlobalOrganizationOperationResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.DeleteGlobalOrganizationOperationResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete
    ...
    def pre_get(
        self, request: compute.GetGlobalOrganizationOperationRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.GetGlobalOrganizationOperationRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        self, request: compute.ListGlobalOrganizationOperationsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.ListGlobalOrganizationOperationsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class GlobalOrganizationOperationsRestTransport(_BaseGlobalOrganizationOperationsRestTransport):
    ...
    class _Delete(_BaseGlobalOrganizationOperationsRestTransport._BaseDelete, GlobalOrganizationOperationsRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseGlobalOrganizationOperationsRestTransport._BaseDelete._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalOrganizationOperationsRestTransport._BaseDelete._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOrganizationOperationsClient.Delete",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = compute.DeleteGlobalOrganizationOperationResponse.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOrganizationOperationsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalOrganizationOperations",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseGlobalOrganizationOperationsRestTransport._BaseGet, GlobalOrganizationOperationsRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseGlobalOrganizationOperationsRestTransport._BaseGet._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalOrganizationOperationsRestTransport._BaseGet._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOrganizationOperationsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalOrganizationOperations",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOrganizationOperationsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalOrganizationOperations",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseGlobalOrganizationOperationsRestTransport._BaseList, GlobalOrganizationOperationsRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseGlobalOrganizationOperationsRestTransport._BaseList._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseGlobalOrganizationOperationsRestTransport._BaseList._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalOrganizationOperationsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalOrganizationOperations",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalOrganizationOperationsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalOrganizationOperations",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteGlobalOrganizationOperationRequest], compute.DeleteGlobalOrganizationOperationResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Delete(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get(self) -> Callable[[compute.GetGlobalOrganizationOperationRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Get(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def list(self) -> Callable[[compute.ListGlobalOrganizationOperationsRequest], compute.OperationList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

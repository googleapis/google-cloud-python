...
class GlobalOrganizationOperationsClient(metaclass=GlobalOrganizationOperationsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = GlobalOrganizationOperationsClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = GlobalOrganizationOperationsClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or GlobalOrganizationOperationsClient._get_api_endpoint(
    ...
    def delete(
        ...
        *,
        ...
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("operation", request.operation),)),)
...
__all__ = ("GlobalOrganizationOperationsClient",)

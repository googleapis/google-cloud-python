        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.Announce",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.announce",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Announce",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.Withdraw",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Withdraw",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient.withdraw",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.PublicAdvertisedPrefixes",
                        "rpcName": "Withdraw",
                        "metadata": http_response["headers"],

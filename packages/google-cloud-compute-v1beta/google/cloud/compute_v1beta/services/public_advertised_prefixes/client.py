...
from google.cloud.compute_v1beta.services.public_advertised_prefixes import pagers
...
class PublicAdvertisedPrefixesClient(metaclass=PublicAdvertisedPrefixesClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PublicAdvertisedPrefixesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, PublicAdvertisedPrefixesTransport, Callable[..., PublicAdvertisedPrefixesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PublicAdvertisedPrefixesClient._read_environment_variables()
        self._client_cert_source = PublicAdvertisedPrefixesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PublicAdvertisedPrefixesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or PublicAdvertisedPrefixesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PublicAdvertisedPrefixesTransport], Callable[..., PublicAdvertisedPrefixesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.PublicAdvertisedPrefixesClient`.",
                    extra={
    ...
    def announce_unary(
        self,
        request: Optional[Union[compute.AnnouncePublicAdvertisedPrefixeRequest, dict]] = None,
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.AnnouncePublicAdvertisedPrefixeRequest, dict]):
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeletePublicAdvertisedPrefixeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        public_advertised_prefix: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.DeletePublicAdvertisedPrefixeRequest(
                    project="project_value",
                    public_advertised_prefix="public_advertised_prefix_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeletePublicAdvertisedPrefixeRequest, dict]):
                The request object. A request message for
    ...
    def get(
        self,
        request: Optional[Union[compute.GetPublicAdvertisedPrefixeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        public_advertised_prefix: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetPublicAdvertisedPrefixeRequest(
                    project="project_value",
                    public_advertised_prefix="public_advertised_prefix_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetPublicAdvertisedPrefixeRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.PublicAdvertisedPrefix:
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertPublicAdvertisedPrefixeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        public_advertised_prefix_resource: Optional[compute.PublicAdvertisedPrefix] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertPublicAdvertisedPrefixeRequest, dict]):
                The request object. A request message for
            ...
            project (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            public_advertised_prefix_resource (google.cloud.compute_v1beta.types.PublicAdvertisedPrefix):
        ...
        if not isinstance(request, compute.InsertPublicAdvertisedPrefixeRequest):
            ...
            if public_advertised_prefix_resource is not None:
                request.public_advertised_prefix_resource = public_advertised_prefix_resource
    ...
    def list(
        self,
        request: Optional[Union[compute.ListPublicAdvertisedPrefixesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.ListPublicAdvertisedPrefixesRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListPublicAdvertisedPrefixesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.public_advertised_prefixes.pagers.ListPager:
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchPublicAdvertisedPrefixeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        public_advertised_prefix: Optional[str] = None,
        public_advertised_prefix_resource: Optional[compute.PublicAdvertisedPrefix] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchPublicAdvertisedPrefixeRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, public_advertised_prefix, public_advertised_prefix_resource]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def withdraw_unary(
        self,
        request: Optional[Union[compute.WithdrawPublicAdvertisedPrefixeRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        public_advertised_prefix: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_withdraw():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.WithdrawPublicAdvertisedPrefixeRequest(
                    project="project_value",
                    public_advertised_prefix="public_advertised_prefix_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.WithdrawPublicAdvertisedPrefixeRequest, dict]):
                The request object. A request message for

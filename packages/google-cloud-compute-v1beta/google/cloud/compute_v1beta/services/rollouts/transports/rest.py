...
from .rest_base import _BaseRolloutsRestTransport
...
class RolloutsRestInterceptor:
    """Interceptor for Rollouts.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RolloutsRestTransport.
    ...
    def pre_cancel(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.CancelRolloutRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.DeleteRolloutRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.GetRolloutRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.ListRolloutsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list(
        self, response: compute.RolloutsListResponse
    ...
    def post_list_with_metadata(
        self,
        response: compute.RolloutsListResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.RolloutsListResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class RolloutsRestStub:
    ...
    _host: str
    _interceptor: RolloutsRestInterceptor


class RolloutsRestTransport(_BaseRolloutsRestTransport):
    """REST backend synchronous transport for Rollouts.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[RolloutsRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RolloutsRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.Advance",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Advance",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.advance",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Advance",
    ...
    class _Cancel(_BaseRolloutsRestTransport._BaseCancel, RolloutsRestStub):
        def __hash__(self):
            return hash("RolloutsRestTransport.Cancel")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.CancelRolloutRequest):
                    The request object. A request message for
                Rollouts.Cancel. See the method
                description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.Cancel",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Cancel",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RolloutsRestTransport._Cancel._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.cancel",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Cancel",
                        "metadata": http_response["headers"],
    ...
    class _Delete(_BaseRolloutsRestTransport._BaseDelete, RolloutsRestStub):
        def __hash__(self):
            return hash("RolloutsRestTransport.Delete")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.DeleteRolloutRequest):
                    The request object. A request message for
                Rollouts.Delete. See the method
                description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RolloutsRestTransport._Delete._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(_BaseRolloutsRestTransport._BaseGet, RolloutsRestStub):
        def __hash__(self):
            return hash("RolloutsRestTransport.Get")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.GetRolloutRequest):
                    The request object. A request message for Rollouts.Get.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RolloutsRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseRolloutsRestTransport._BaseList, RolloutsRestStub):
        def __hash__(self):
            return hash("RolloutsRestTransport.List")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.compute.ListRolloutsRequest):
                    The request object. A request message for Rollouts.List.
                See the method description for details.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.RolloutsListResponse()
            pb_resp = compute.RolloutsListResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.RolloutsListResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.Pause",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Pause",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.pause",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Pause",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.RolloutsClient.Resume",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Resume",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.RolloutsClient.resume",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.Rollouts",
                        "rpcName": "Resume",
                        "metadata": http_response["headers"],
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteRolloutRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._Delete(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get(self) -> Callable[[compute.GetRolloutRequest], compute.Rollout]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def list(
        self,
    ) -> Callable[[compute.ListRolloutsRequest], compute.RolloutsListResponse]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

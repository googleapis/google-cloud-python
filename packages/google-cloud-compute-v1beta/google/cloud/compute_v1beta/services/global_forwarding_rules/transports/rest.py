        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.Delete",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Delete",
        ...
        def __call__(
            ...
            *,
            ...
            Returns:
                ...
                Forwarding rule resources in Google Cloud can be either
                ...
                For more information, read Forwarding rule concepts and
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.SetLabels",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "SetLabels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.set_labels",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "SetLabels",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.SetTarget",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "SetTarget",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.set_target",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "SetTarget",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1beta.GlobalForwardingRulesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1beta.GlobalForwardingRulesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1beta.GlobalForwardingRules",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],

...
class _BaseGlobalForwardingRulesRestTransport(GlobalForwardingRulesTransport):
    ...
    class _BaseTestIamPermissions:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.TestIamPermissionsGlobalForwardingRuleRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseGlobalForwardingRulesRestTransport._BaseTestIamPermissions._get_unset_required_fields(
                    query_params
                )
            )

...
class ListPager:
    ...
    :class:`google.cloud.compute_v1beta.types.ForwardingRuleList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1beta.types.ForwardingRuleList`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1beta.types.ListGlobalForwardingRulesRequest):
                The initial request object.
            response (google.cloud.compute_v1beta.types.ForwardingRuleList):

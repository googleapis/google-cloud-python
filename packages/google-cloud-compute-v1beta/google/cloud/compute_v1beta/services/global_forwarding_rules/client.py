...
class GlobalForwardingRulesClient(metaclass=GlobalForwardingRulesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1beta.GlobalForwardingRulesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteGlobalForwardingRuleRequest, dict]):
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetGlobalForwardingRuleRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.InsertGlobalForwardingRuleRequest, dict]):
                The request object. A request message for
    ...
    def list(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListGlobalForwardingRulesRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.global_forwarding_rules.pagers.ListPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.PatchGlobalForwardingRuleRequest(
                    forwarding_rule="forwarding_rule_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchGlobalForwardingRuleRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetLabelsGlobalForwardingRuleRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetLabelsGlobalForwardingRuleRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_target():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.SetTargetGlobalForwardingRuleRequest(
                    forwarding_rule="forwarding_rule_value",
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.SetTargetGlobalForwardingRuleRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsGlobalForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.TestIamPermissionsGlobalForwardingRuleRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.TestIamPermissionsGlobalForwardingRuleRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsGlobalForwardingRuleRequest):
            request = compute.TestIamPermissionsGlobalForwardingRuleRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project

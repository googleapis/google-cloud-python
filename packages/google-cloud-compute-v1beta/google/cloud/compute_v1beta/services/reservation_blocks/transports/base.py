...
class ReservationBlocksTransport(abc.ABC):
    ...
    def get(
        self,
    ) -> Callable[[compute.GetReservationBlockRequest], Union[compute.ReservationBlocksGetResponse, Awaitable[compute.ReservationBlocksGetResponse]]]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListReservationBlocksRequest], Union[compute.ReservationBlocksListResponse, Awaitable[compute.ReservationBlocksListResponse]]
    ]:
        raise NotImplementedError()
    ...
    def perform_maintenance(
        self,
    ) -> Callable[[compute.PerformMaintenanceReservationBlockRequest], Union[compute.Operation, Awaitable[compute.Operation]]]:
        raise NotImplementedError()

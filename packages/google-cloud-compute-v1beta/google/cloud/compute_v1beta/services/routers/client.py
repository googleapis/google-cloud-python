...
class RoutersClient(metaclass=RoutersClientMeta):
    ...
    def delete_named_set_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.DeleteNamedSetRouterRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_named_set():
                ...
                # Initialize request argument(s)
                request = compute_v1beta.GetNamedSetRouterRequest(
                    project="project_value",
                    region="region_value",
                    router="router_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.GetNamedSetRouterRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.types.RoutersGetNamedSetResponse:
    ...
    def list_named_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.ListNamedSetsRoutersRequest, dict]):
                The request object. A request message for
        ...
        Returns:
            google.cloud.compute_v1beta.services.routers.pagers.ListNamedSetsPager:
                Iterating over this object will yield
                results and resolve additional pages
                automatically.
    ...
    def patch_named_set_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.PatchNamedSetRouterRequest, dict]):
                The request object. A request message for
            ...
            router (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            named_set_resource (google.cloud.compute_v1beta.types.NamedSet):
                The body resource for this request
    ...
    def update_named_set_unary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1beta.types.UpdateNamedSetRouterRequest, dict]):
                The request object. A request message for

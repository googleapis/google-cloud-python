...
from .services.beta_analytics_data import BetaAnalyticsDataAsyncClient, BetaAnalyticsDataClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.analytics.data_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.analytics.data_v1beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.analytics.data_v1beta"

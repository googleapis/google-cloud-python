...
from .services.alpha_analytics_data import AlphaAnalyticsDataAsyncClient, AlphaAnalyticsDataClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.analytics.data_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.analytics.data_v1alpha")  # type: ignore
else:  # pragma: NO COVER

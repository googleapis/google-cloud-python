...
`Google Analytics Data API`_: Accesses report data in Google Analytics. Warning: Creating multiple Customer Applications, Accounts, or Projects to simulate or act as a single Customer Application, Account, or Project (respectively) or to circumvent Service-specific usage limits or quotas is a direct violation of Google Cloud Platform Terms of Service as well as Google APIs Terms of Service. These actions can result in immediate termination of your GCP project(s) without any warning.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-analytics-data.svg
   :target: https://pypi.org/project/google-analytics-data/
.. _Google Analytics Data API: https://developers.google.com/analytics/
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/data/latest
...
3. `Enable the Google Analytics Data API.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Google Analytics Data API.:  https://developers.google.com/analytics/
...
-  Read the `Client Library Documentation`_ for Google Analytics Data API
   to see other available methods on the client.
-  Read the `Google Analytics Data API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Google Analytics Data API Product documentation:  https://developers.google.com/analytics/

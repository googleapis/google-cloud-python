...
from google.analytics.data_v1beta.services.beta_analytics_data import BetaAnalyticsDataAsyncClient, BetaAnalyticsDataClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert BetaAnalyticsDataClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert BetaAnalyticsDataClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                BetaAnalyticsDataClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        BetaAnalyticsDataClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        BetaAnalyticsDataClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == BetaAnalyticsDataClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_beta_analytics_data_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "analyticsdata.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://analyticsdata.googleapis.com"
        )
...
def test_create_audience_export(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_audience_export), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_audience_exports_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_audience_exports), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            analytics_data_api.ListAudienceExportsResponse(
                audience_exports=[
...
async def test_list_audience_exports_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_audience_exports), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_audience_exports(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_audience_export_rest_required_fields(request_type=analytics_data_api.CreateAudienceExportRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_audience_export._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_query_audience_export_rest_required_fields(request_type=analytics_data_api.QueryAudienceExportRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_audience_export._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_audience_exports_rest_required_fields(request_type=analytics_data_api.ListAudienceExportsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_audience_exports._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = BetaAnalyticsDataClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = BetaAnalyticsDataAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = BetaAnalyticsDataAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = BetaAnalyticsDataClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_run_report_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_report") as post, mock.patch.object(
...
def test_run_pivot_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_pivot_report") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_run_pivot_report_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_run_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_reports") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_reports_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_run_pivot_reports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_pivot_reports") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_batch_run_pivot_reports_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_get_metadata") as post, mock.patch.object(
...
def test_run_realtime_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_run_realtime_report") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_run_realtime_report_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_check_compatibility_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_check_compatibility") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_check_compatibility_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_audience_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.BetaAnalyticsDataRestInterceptor, "post_create_audience_export_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_query_audience_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_query_audience_export") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_query_audience_export_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_audience_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_get_audience_export") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_get_audience_export_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_audience_exports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BetaAnalyticsDataRestInterceptor, "post_list_audience_exports") as post, mock.patch.object(
        transports.BetaAnalyticsDataRestInterceptor, "post_list_audience_exports_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.BetaAnalyticsDataGrpcTransport, grpc_helpers), (transports.BetaAnalyticsDataGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_beta_analytics_data_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "analyticsdata.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://analyticsdata.googleapis.com:8000"
    )

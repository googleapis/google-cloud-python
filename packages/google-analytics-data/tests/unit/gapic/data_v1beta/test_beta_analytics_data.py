...
async def test_run_report_async(request_type, transport: str = "grpc_asyncio"):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_run_pivot_report_async(request_type, transport: str = "grpc_asyncio"):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_batch_run_reports_async(request_type, transport: str = "grpc_asyncio"):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_metadata_async(request_type, transport: str = "grpc_asyncio"):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_run_realtime_report_async(request_type, transport: str = "grpc_asyncio"):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_audience_export_async(request_type, transport: str = "grpc_asyncio"):
    client = BetaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_audience_exports_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_audience_exports(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_metadata_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetMetadata,
...
def test_create_audience_export_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateAudienceExport,
...
def test_query_audience_export_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseQueryAudienceExport,
...
def test_get_audience_export_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetAudienceExport,
...
def test_list_audience_exports_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAudienceExports,

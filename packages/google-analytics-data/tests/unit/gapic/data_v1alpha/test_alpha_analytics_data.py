...
async def test_run_funnel_report_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_query_audience_list_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_audience_list_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_audience_lists_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_property_quotas_snapshot(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_property_quotas_snapshot), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_get_property_quotas_snapshot_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_property_quotas_snapshot
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_property_quotas_snapshot_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_property_quotas_snapshot
            in client._client._transport._wrapped_methods
        )
...
async def test_get_property_quotas_snapshot_async(
    request_type, transport: str = "grpc_asyncio"
):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_report_task_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_query_report_task_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_report_task_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_report_tasks_async(request_type, transport: str = "grpc_asyncio"):
    client = AlphaAnalyticsDataAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_chat(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.chat), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = analytics_data_api.ChatResponse(
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, analytics_data_api.ChatResponse)
...
def test_chat_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.chat), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = analytics_data_api.ChatRequest(
            property="property_value",
            user_query="user_query_value",
            session_id="session_id_value",
        )
...
def test_create_audience_list_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateAudienceList,
...
def test_query_audience_list_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseQueryAudienceList,
...
def test_get_audience_list_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetAudienceList,
...
def test_list_audience_lists_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAudienceLists,
...
def test_create_recurring_audience_list_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateRecurringAudienceList,
...
def test_get_recurring_audience_list_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetRecurringAudienceList,
...
def test_list_recurring_audience_lists_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListRecurringAudienceLists,
...
def test_get_property_quotas_snapshot_rest_required_fields(
    request_type=analytics_data_api.GetPropertyQuotasSnapshotRequest,
):
    transport_class = transports.AlphaAnalyticsDataRestTransport
    ...
    default_values = getattr(
        transport_class._BaseGetPropertyQuotasSnapshot,
...
def test_get_property_quotas_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=properties/*/propertyQuotasSnapshot}"
            % client.transport._host,
            args[1],
        )
...
def test_create_report_task_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateReportTask,
...
def test_query_report_task_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseQueryReportTask,
...
def test_get_report_task_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetReportTask,
...
def test_list_report_tasks_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListReportTasks,
...
def test_chat_rest_required_fields(request_type=analytics_data_api.ChatRequest):
    transport_class = transports.AlphaAnalyticsDataRestTransport

    request_init = {}
    request_init["property"] = ""
    request_init["user_query"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(
        json_format.MessageToJson(pb_request, use_integers_for_enums=False)
    ...
    jsonified_request["userQuery"] = "user_query_value"

    # verify required fields with non-default values are left alone
    assert "property" in jsonified_request
    assert jsonified_request["property"] == "property_value"
    assert "userQuery" in jsonified_request
    assert jsonified_request["userQuery"] == "user_query_value"
    ...
    # Designate an appropriate value for the returned response.
    return_value = analytics_data_api.ChatResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = analytics_data_api.ChatResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_chat_rest_bad_request(request_type=analytics_data_api.ChatRequest):
    client = AlphaAnalyticsDataClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_chat_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.AlphaAnalyticsDataRestInterceptor, "post_chat"
        ) as post,
        mock.patch.object(
            transports.AlphaAnalyticsDataRestInterceptor, "post_chat_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.AlphaAnalyticsDataRestInterceptor, "pre_chat"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = analytics_data_api.ChatRequest.pb(analytics_data_api.ChatRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = analytics_data_api.ChatResponse.to_json(
            analytics_data_api.ChatResponse()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = analytics_data_api.ChatResponse()
        post_with_metadata.return_value = analytics_data_api.ChatResponse(), metadata
...
def test_property_path():
    ...
    actual = AlphaAnalyticsDataClient.property_path(property)
    assert expected == actual
...
def test_parse_property_path():
    ...
    path = AlphaAnalyticsDataClient.property_path(**expected)

    # Check that the path construction is reversible.
    actual = AlphaAnalyticsDataClient.parse_property_path(path)
    assert expected == actual

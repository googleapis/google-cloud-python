...
class RecaptchaEnterpriseServiceClient(metaclass=RecaptchaEnterpriseServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RecaptchaEnterpriseServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or RecaptchaEnterpriseServiceClient._get_api_endpoint(

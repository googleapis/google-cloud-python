...
class ListKeysPager:
    ...
    :class:`~.recaptchaenterprise.ListKeysResponse` object, and
    ...
    All the usual :class:`~.recaptchaenterprise.ListKeysResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`~.recaptchaenterprise.ListKeysResponse`):

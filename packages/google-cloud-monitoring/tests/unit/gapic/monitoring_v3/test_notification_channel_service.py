...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert NotificationChannelServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert NotificationChannelServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                NotificationChannelServiceClient._use_client_cert_effective()
...
@mock.patch.object(
    NotificationChannelServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(NotificationChannelServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        NotificationChannelServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        NotificationChannelServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == NotificationChannelServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        NotificationChannelServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == NotificationChannelServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_list_notification_channel_descriptors_async(
    transport: str = "grpc_asyncio", request_type=notification_service.ListNotificationChannelDescriptorsRequest
):
    client = NotificationChannelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_get_notification_channel_descriptor_async(
    transport: str = "grpc_asyncio", request_type=notification_service.GetNotificationChannelDescriptorRequest
):
    client = NotificationChannelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_send_notification_channel_verification_code_async(
    transport: str = "grpc_asyncio", request_type=notification_service.SendNotificationChannelVerificationCodeRequest
):
    client = NotificationChannelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_get_notification_channel_verification_code_async(
    transport: str = "grpc_asyncio", request_type=notification_service.GetNotificationChannelVerificationCodeRequest
):
    client = NotificationChannelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_transport_kind_grpc():
    transport = NotificationChannelServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = NotificationChannelServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = NotificationChannelServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
@pytest.mark.parametrize(
    "transport_class", [transports.NotificationChannelServiceGrpcTransport, transports.NotificationChannelServiceGrpcAsyncIOTransport]
)

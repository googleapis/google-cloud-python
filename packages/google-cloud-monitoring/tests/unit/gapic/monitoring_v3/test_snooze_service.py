...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SnoozeServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        SnoozeServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        SnoozeServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        SnoozeServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__get_client_cert_source():
    ...
    assert (
        SnoozeServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SnoozeServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SnoozeServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                SnoozeServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SnoozeServiceClient),
)
@mock.patch.object(
    SnoozeServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SnoozeServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SnoozeServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SnoozeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SnoozeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SnoozeServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == SnoozeServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SnoozeServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SnoozeServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == SnoozeServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SnoozeServiceClient._get_api_endpoint(
    ...
    assert (
        SnoozeServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SnoozeServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SnoozeServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SnoozeServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SnoozeServiceClient._get_universe_domain(None, None)
        == SnoozeServiceClient._DEFAULT_UNIVERSE
    )
...
def test_snooze_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_snooze_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_snooze_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [SnoozeServiceClient, SnoozeServiceAsyncClient]
)
@mock.patch.object(
    SnoozeServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SnoozeServiceClient),
)
@mock.patch.object(
    SnoozeServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SnoozeServiceAsyncClient),
)
...
def test_snooze_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_snooze_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_snooze_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.monitoring_v3.services.snooze_service.transports.SnoozeServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_snooze_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_create_snooze_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_snooze
...
async def test_list_snoozes_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_snoozes
            in client._client._transport._wrapped_methods
        )
...
async def test_list_snoozes_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_snoozes), "__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            snooze_service.ListSnoozesResponse(
...
async def test_get_snooze_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_snooze
            in client._client._transport._wrapped_methods
        )
...
async def test_update_snooze_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_snooze
            in client._client._transport._wrapped_methods
        )
...
def test_snooze_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.monitoring_v3.services.snooze_service.transports.SnoozeServiceTransport.__init__"
    ) as Transport:
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.SnoozeServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = SnoozeServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
def test_transport_kind_grpc():
    transport = GroupServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = GroupServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = GroupServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
@pytest.mark.parametrize(
    ...
    [(transports.GroupServiceGrpcTransport, grpc_helpers), (transports.GroupServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

...
def test__read_environment_variables():
    assert ServiceMonitoringServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ServiceMonitoringServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ServiceMonitoringServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ServiceMonitoringServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ServiceMonitoringServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ServiceMonitoringServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ServiceMonitoringServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ServiceMonitoringServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ServiceMonitoringServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ServiceMonitoringServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ServiceMonitoringServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ServiceMonitoringServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ServiceMonitoringServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceMonitoringServiceClient))
@mock.patch.object(
    ServiceMonitoringServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceMonitoringServiceAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServiceMonitoringServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ServiceMonitoringServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ServiceMonitoringServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ServiceMonitoringServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ServiceMonitoringServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ServiceMonitoringServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        ServiceMonitoringServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == ServiceMonitoringServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ServiceMonitoringServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ServiceMonitoringServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ServiceMonitoringServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ServiceMonitoringServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ServiceMonitoringServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ServiceMonitoringServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ServiceMonitoringServiceClient._get_universe_domain(None, None) == ServiceMonitoringServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ServiceMonitoringServiceClient(credentials=cred)
...
def test_create_service_level_objective_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_service_level_objective in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_service_level_objective] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceMonitoringServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_service_level_objective in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_service_level_objective] = mock_rpc
...
def test_get_service_level_objective_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_service_level_objective in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_service_level_objective] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceMonitoringServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_service_level_objective in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_service_level_objective] = mock_rpc
...
def test_list_service_level_objectives_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_service_level_objectives in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_service_level_objectives] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_service_level_objectives_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceMonitoringServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_service_level_objectives in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_service_level_objectives] = mock_rpc
...
def test_list_service_level_objectives_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_service_level_objectives), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_service_level_objectives(request={}, retry=retry, timeout=timeout)
...
def test_update_service_level_objective_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_service_level_objective in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_service_level_objective] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceMonitoringServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_service_level_objective in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_service_level_objective] = mock_rpc
...
def test_delete_service_level_objective_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_service_level_objective in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_service_level_objective] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_service_level_objective_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceMonitoringServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_service_level_objective in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_service_level_objective] = mock_rpc
...
def test_transport_kind_grpc():
    transport = ServiceMonitoringServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.CreateServiceRequest()
...
def test_get_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.GetServiceRequest()
...
def test_list_services_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_services), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.ListServicesRequest()
...
def test_update_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.update_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.UpdateServiceRequest()
...
def test_delete_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.DeleteServiceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_service_level_objective_empty_call_grpc():
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_service_level_objective), "__call__") as call:
        call.return_value = service.ServiceLevelObjective()
        client.create_service_level_objective(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.CreateServiceLevelObjectiveRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_service_level_objective_empty_call_grpc():
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_service_level_objective), "__call__") as call:
        call.return_value = service.ServiceLevelObjective()
        client.get_service_level_objective(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.GetServiceLevelObjectiveRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_service_level_objectives_empty_call_grpc():
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_service_level_objectives), "__call__") as call:
        call.return_value = service_service.ListServiceLevelObjectivesResponse()
        client.list_service_level_objectives(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.ListServiceLevelObjectivesRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_service_level_objective_empty_call_grpc():
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_service_level_objective), "__call__") as call:
        call.return_value = service.ServiceLevelObjective()
        client.update_service_level_objective(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.UpdateServiceLevelObjectiveRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_service_level_objective_empty_call_grpc():
    client = ServiceMonitoringServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_service_level_objective), "__call__") as call:
        call.return_value = None
        client.delete_service_level_objective(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = service_service.DeleteServiceLevelObjectiveRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ServiceMonitoringServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ServiceMonitoringServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_service_level_objective_empty_call_grpc_asyncio():
    client = ServiceMonitoringServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_service_level_objective), "__call__") as call:
        ...
        await client.create_service_level_objective(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_service_level_objective_empty_call_grpc_asyncio():
    client = ServiceMonitoringServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_service_level_objective), "__call__") as call:
        ...
        await client.get_service_level_objective(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_service_level_objectives_empty_call_grpc_asyncio():
    client = ServiceMonitoringServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_service_level_objectives), "__call__") as call:
        ...
        await client.list_service_level_objectives(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_service_level_objective_empty_call_grpc_asyncio():
    client = ServiceMonitoringServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_service_level_objective), "__call__") as call:
        ...
        await client.update_service_level_objective(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_service_level_objective_empty_call_grpc_asyncio():
    client = ServiceMonitoringServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_service_level_objective), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_service_level_objective(request=None)
...
@pytest.mark.parametrize(
    ...
    [(transports.ServiceMonitoringServiceGrpcTransport, grpc_helpers), (transports.ServiceMonitoringServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize(
    "transport_class", [transports.ServiceMonitoringServiceGrpcTransport, transports.ServiceMonitoringServiceGrpcAsyncIOTransport]
)

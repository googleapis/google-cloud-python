...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AlertPolicyServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        AlertPolicyServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AlertPolicyServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AlertPolicyServiceClient),
)
@mock.patch.object(
    AlertPolicyServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AlertPolicyServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AlertPolicyServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AlertPolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AlertPolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        AlertPolicyServiceClient._get_api_endpoint(
    ...
    assert (
        AlertPolicyServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        AlertPolicyServiceClient._get_api_endpoint(
    ...
    assert (
        AlertPolicyServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AlertPolicyServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        AlertPolicyServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AlertPolicyServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AlertPolicyServiceClient._get_universe_domain(None, None)
        == AlertPolicyServiceClient._DEFAULT_UNIVERSE
    )
...
def test_list_alert_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_alert_policies in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.list_alert_policies] = (
            mock_rpc
        )
        request = {}
...
def test_get_alert_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_alert_policy] = (
            mock_rpc
        )
        request = {}
...
def test_create_alert_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_alert_policy in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_alert_policy] = (
            mock_rpc
        )
        request = {}
...
def test_delete_alert_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_alert_policy in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_alert_policy] = (
            mock_rpc
        )
        request = {}
...
def test_update_alert_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_alert_policy in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_alert_policy] = (
            mock_rpc
        )
        request = {}

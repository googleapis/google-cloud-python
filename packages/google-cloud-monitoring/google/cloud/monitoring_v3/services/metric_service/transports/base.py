...
class MetricServiceTransport(abc.ABC):
    ...
    def list_monitored_resource_descriptors(
        ...
        Union[metric_service.ListMonitoredResourceDescriptorsResponse, Awaitable[metric_service.ListMonitoredResourceDescriptorsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def get_monitored_resource_descriptor(
        ...
        Union[monitored_resource_pb2.MonitoredResourceDescriptor, Awaitable[monitored_resource_pb2.MonitoredResourceDescriptor]],
    ]:
        raise NotImplementedError()
    ...
    def list_metric_descriptors(
        ...
        Union[metric_service.ListMetricDescriptorsResponse, Awaitable[metric_service.ListMetricDescriptorsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def get_metric_descriptor(
        self,
    ) -> Callable[[metric_service.GetMetricDescriptorRequest], Union[metric_pb2.MetricDescriptor, Awaitable[metric_pb2.MetricDescriptor]]]:
        raise NotImplementedError()

    @property
    def create_metric_descriptor(
        self,
    ) -> Callable[[metric_service.CreateMetricDescriptorRequest], Union[metric_pb2.MetricDescriptor, Awaitable[metric_pb2.MetricDescriptor]]]:
        raise NotImplementedError()

    @property
    def delete_metric_descriptor(
        self,
    ) -> Callable[[metric_service.DeleteMetricDescriptorRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()
    ...
    def list_time_series(
        ...
        [metric_service.ListTimeSeriesRequest], Union[metric_service.ListTimeSeriesResponse, Awaitable[metric_service.ListTimeSeriesResponse]]
    ]:
        raise NotImplementedError()

    @property
    def create_time_series(self) -> Callable[[metric_service.CreateTimeSeriesRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def create_service_time_series(self) -> Callable[[metric_service.CreateTimeSeriesRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

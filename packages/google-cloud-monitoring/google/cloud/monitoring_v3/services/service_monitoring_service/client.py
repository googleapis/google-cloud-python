...
class ServiceMonitoringServiceClient(metaclass=ServiceMonitoringServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ServiceMonitoringServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ServiceMonitoringServiceClient._get_api_endpoint(

...
class UptimeCheckServiceGrpcAsyncIOTransport(UptimeCheckServiceTransport):
    ...
    def list_uptime_check_configs(
        self,
    ) -> Callable[[uptime_service.ListUptimeCheckConfigsRequest], Awaitable[uptime_service.ListUptimeCheckConfigsResponse]]:
    ...
    @property
    def get_uptime_check_config(self) -> Callable[[uptime_service.GetUptimeCheckConfigRequest], Awaitable[uptime.UptimeCheckConfig]]:
    ...
    @property
    def create_uptime_check_config(self) -> Callable[[uptime_service.CreateUptimeCheckConfigRequest], Awaitable[uptime.UptimeCheckConfig]]:
    ...
    @property
    def update_uptime_check_config(self) -> Callable[[uptime_service.UpdateUptimeCheckConfigRequest], Awaitable[uptime.UptimeCheckConfig]]:
    ...
    @property
    def delete_uptime_check_config(self) -> Callable[[uptime_service.DeleteUptimeCheckConfigRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_uptime_check_ips(self) -> Callable[[uptime_service.ListUptimeCheckIpsRequest], Awaitable[uptime_service.ListUptimeCheckIpsResponse]]:

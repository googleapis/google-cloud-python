...
class AlertPolicyServiceTransport(abc.ABC):
    ...
    def list_alert_policies(
        ...
        [alert_service.ListAlertPoliciesRequest], Union[alert_service.ListAlertPoliciesResponse, Awaitable[alert_service.ListAlertPoliciesResponse]]
    ]:
        raise NotImplementedError()

    @property
    def get_alert_policy(self) -> Callable[[alert_service.GetAlertPolicyRequest], Union[alert.AlertPolicy, Awaitable[alert.AlertPolicy]]]:
        raise NotImplementedError()

    @property
    def create_alert_policy(self) -> Callable[[alert_service.CreateAlertPolicyRequest], Union[alert.AlertPolicy, Awaitable[alert.AlertPolicy]]]:
        raise NotImplementedError()

    @property
    def delete_alert_policy(self) -> Callable[[alert_service.DeleteAlertPolicyRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def update_alert_policy(self) -> Callable[[alert_service.UpdateAlertPolicyRequest], Union[alert.AlertPolicy, Awaitable[alert.AlertPolicy]]]:
        raise NotImplementedError()

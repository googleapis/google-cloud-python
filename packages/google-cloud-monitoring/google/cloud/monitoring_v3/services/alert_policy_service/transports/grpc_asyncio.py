...
class AlertPolicyServiceGrpcAsyncIOTransport(AlertPolicyServiceTransport):
    ...
    @property
    def list_alert_policies(self) -> Callable[[alert_service.ListAlertPoliciesRequest], Awaitable[alert_service.ListAlertPoliciesResponse]]:
    ...
    @property
    def get_alert_policy(self) -> Callable[[alert_service.GetAlertPolicyRequest], Awaitable[alert.AlertPolicy]]:
    ...
    @property
    def create_alert_policy(self) -> Callable[[alert_service.CreateAlertPolicyRequest], Awaitable[alert.AlertPolicy]]:
    ...
    @property
    def delete_alert_policy(self) -> Callable[[alert_service.DeleteAlertPolicyRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def update_alert_policy(self) -> Callable[[alert_service.UpdateAlertPolicyRequest], Awaitable[alert.AlertPolicy]]:

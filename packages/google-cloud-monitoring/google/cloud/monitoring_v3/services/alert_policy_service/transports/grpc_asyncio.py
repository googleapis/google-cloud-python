...
class AlertPolicyServiceGrpcAsyncIOTransport(AlertPolicyServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_alert_policies: gapic_v1.method_async.wrap_method(
            ...
            self.get_alert_policy: gapic_v1.method_async.wrap_method(
            ...
            self.create_alert_policy: gapic_v1.method_async.wrap_method(
                self.create_alert_policy,
                default_timeout=30.0,
                client_info=client_info,
            ),
            self.delete_alert_policy: gapic_v1.method_async.wrap_method(
            ...
            self.update_alert_policy: gapic_v1.method_async.wrap_method(

...
class GroupServiceGrpcAsyncIOTransport(GroupServiceTransport):
    ...
    @property
    def list_groups(self) -> Callable[[group_service.ListGroupsRequest], Awaitable[group_service.ListGroupsResponse]]:
    ...
    @property
    def get_group(self) -> Callable[[group_service.GetGroupRequest], Awaitable[group.Group]]:
    ...
    @property
    def create_group(self) -> Callable[[group_service.CreateGroupRequest], Awaitable[gm_group.Group]]:
    ...
    @property
    def update_group(self) -> Callable[[group_service.UpdateGroupRequest], Awaitable[gm_group.Group]]:
    ...
    @property
    def delete_group(self) -> Callable[[group_service.DeleteGroupRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_group_members(self) -> Callable[[group_service.ListGroupMembersRequest], Awaitable[group_service.ListGroupMembersResponse]]:

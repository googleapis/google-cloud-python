...
class SnoozeServiceGrpcAsyncIOTransport(SnoozeServiceTransport):
    ...
    @property
    def create_snooze(self) -> Callable[[snooze_service.CreateSnoozeRequest], Awaitable[gm_snooze.Snooze]]:
    ...
    @property
    def list_snoozes(self) -> Callable[[snooze_service.ListSnoozesRequest], Awaitable[snooze_service.ListSnoozesResponse]]:
    ...
    @property
    def get_snooze(self) -> Callable[[snooze_service.GetSnoozeRequest], Awaitable[snooze.Snooze]]:
    ...
    @property
    def update_snooze(self) -> Callable[[snooze_service.UpdateSnoozeRequest], Awaitable[gm_snooze.Snooze]]:

...
class SnoozeServiceGrpcTransport(SnoozeServiceTransport):
    ...
    @property
    def create_snooze(self) -> Callable[[snooze_service.CreateSnoozeRequest], gm_snooze.Snooze]:
    ...
    @property
    def list_snoozes(self) -> Callable[[snooze_service.ListSnoozesRequest], snooze_service.ListSnoozesResponse]:
    ...
    @property
    def update_snooze(self) -> Callable[[snooze_service.UpdateSnoozeRequest], gm_snooze.Snooze]:

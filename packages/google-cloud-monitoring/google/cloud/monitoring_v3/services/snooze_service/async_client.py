...
class SnoozeServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SnoozeServiceTransport, Callable[..., SnoozeServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_snooze(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_snooze]
    ...
    async def list_snoozes(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_snoozes]
    ...
    async def get_snooze(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_snooze]
    ...
    async def update_snooze(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_snooze]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("snooze.name", request.snooze.name),)),)

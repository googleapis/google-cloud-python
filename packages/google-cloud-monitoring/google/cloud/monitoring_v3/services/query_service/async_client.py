...
class QueryServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, QueryServiceTransport, Callable[..., QueryServiceTransport]]] = "grpc_asyncio",
    ...
    async def query_time_series(
        ...
        *,
        ...
        """
        warnings.warn("QueryServiceAsyncClient.query_time_series is deprecated", DeprecationWarning)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_time_series]

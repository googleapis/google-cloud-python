...
class QueryServiceClient(metaclass=QueryServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = QueryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, QueryServiceTransport, Callable[..., QueryServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = QueryServiceClient._read_environment_variables()
        self._client_cert_source = QueryServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = QueryServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[QueryServiceTransport], Callable[..., QueryServiceTransport]] = (
    ...
    def query_time_series(
        ...
        *,
        ...
        """
        warnings.warn("QueryServiceClient.query_time_series is deprecated", DeprecationWarning)

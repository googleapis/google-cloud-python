...
_ALERTPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='notification_channels', full_name='google.monitoring.v3.AlertPolicy.notification_channels', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='creation_record', full_name='google.monitoring.v3.AlertPolicy.creation_record', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mutation_record', full_name='google.monitoring.v3.AlertPolicy.mutation_record', index=9,
...
AlertPolicy = _reflection.GeneratedProtocolMessageType('AlertPolicy', (_message.Message,), dict(
  ...
  Condition = _reflection.GeneratedProtocolMessageType('Condition', (_message.Message,), dict(
    ...
    MetricThreshold = _reflection.GeneratedProtocolMessageType('MetricThreshold', (_message.Message,), dict(
      ...
      Attributes:
          ...
          duration:
              ...
              that are a multiple of a minute--e.g. 60, 120, or 300 seconds
              --are supported. If an invalid value is given, an error will
              be returned. The ``Duration.nanos`` field is ignored. When
              choosing a duration, it is useful to keep in mind the
              frequency of the underlying time series data (which may also
              be affected by any alignments specified in the ``aggregation``
    ...
    MetricAbsence = _reflection.GeneratedProtocolMessageType('MetricAbsence', (_message.Message,), dict(
  ...
  UserLabelsEntry = _reflection.GeneratedProtocolMessageType('UserLabelsEntry', (_message.Message,), dict(
...
_ALERTPOLICY_USERLABELSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

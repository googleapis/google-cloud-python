...
NotificationChannelDescriptor = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          elDescriptors/[TYPE]  In the above, ``[TYPE]`` is the value of
          the ``type`` field.
      type:
...
NotificationChannel = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      name:
          ...
          ::      projects/[PROJECT_ID_OR_NUMBER]/notificationChannels/[
          CHANNEL_ID]  The ``[CHANNEL_ID]`` is automatically assigned by

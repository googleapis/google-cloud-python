...
class AlertPolicy(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            name}/{alert name}", where the {rule group name}
            and {alert name} should be taken from the
            corresponding Prometheus configuration file.
            This convention is not enforced. In any case the
            display_name is not a unique key of the
            AlertPolicy.
    ...
    class Documentation(proto.Message):
        ...
        Attributes:
            ...
            mime_type (str):
                ...
                more information.
            subject (str):
                Optional. The subject line of the notification.
                The subject line may not exceed 10,240 bytes. In
                notifications generated by this policy, the
                contents of the subject line after variable
                expansion will be truncated to 255 bytes or
                shorter at the latest UTF-8 character boundary.
                The 255-byte limit is recommended by [this
                thread](https://stackoverflow.com/questions/1592291/what-is-the-email-subject-length-limit).
                It is both the limit imposed by some third-party
                ticketing products and it is common to define
                textual fields in databases as VARCHAR(255).

                The contents of the subject line can be
                [templatized by using
                variables](https://cloud.google.com/monitoring/alerts/doc-variables#doc-vars).
                If this field is missing or empty, a default
        ...
        class Link(proto.Message):
            ...
            Attributes:
                ...
                url (str):
                    ...
                    in the path or the query parameters. The total
                    length of a URL should not exceed 2083
                    characters before and after variable expansion.
                    Example:
    ...
    class Condition(proto.Message):
        ...
        class EvaluationMissingData(proto.Enum):
            ...
            Values:
                EVALUATION_MISSING_DATA_UNSPECIFIED (0):
                    ...
                    Equivalent to EVALUATION_MISSING_DATA_NO_OP.
        ...
        class LogMatch(proto.Message):
            r"""A condition type that checks whether a log message in the
            [scoping
            project](https://cloud.google.com/monitoring/api/v3#project_name)
            satisfies the given filter. Logs from other projects in the
            metrics scope are not evaluated.

            Attributes:
                filter (str):
                    Required. A logs-based filter. See [Advanced
                    Logs
        ...
        class PrometheusQueryLanguageCondition(proto.Message):
            ...
            Attributes:
                ...
                rule_group (str):
                    ...
                    characters in length.
                alert_rule (str):
                    Optional. The alerting rule name of this alert
                    in the corresponding Prometheus configuration
                    file.
                    ...
                    This field is optional. If this field is not
                    empty, then it must be a [valid Prometheus label
    ...
    class AlertStrategy(proto.Message):
        ...
        Attributes:
            ...
            notification_prompts (MutableSequence[google.cloud.monitoring_v3.types.AlertPolicy.AlertStrategy.NotificationPrompt]):
                For log-based alert policies, the notification
                prompts is always [OPENED]. For non log-based
                alert policies, the notification prompts can be
        ...
        class NotificationChannelStrategy(proto.Message):
            ...
            Attributes:
                notification_channel_names (MutableSequence[str]):
                    The full REST resource name for the notification
                    channels that these settings apply to. Each of
                    these correspond to the name field in one of the
                    NotificationChannel objects referenced in the

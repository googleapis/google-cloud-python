Python Client for Service Health
================================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-servicehealth.svg
   :target: https://pypi.org/project/google-cloud-servicehealth/
.. _Service Health: https://cloud.google.com/service-health/
...
3. `Enable the Service Health.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Service Health.:  https://cloud.google.com/service-health/
...
-  Read the `Client Library Documentation`_ for Service Health
   to see other available methods on the client.
-  Read the `Service Health Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Service Health Product documentation:  https://cloud.google.com/service-health/

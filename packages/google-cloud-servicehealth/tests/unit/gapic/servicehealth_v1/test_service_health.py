...
from google.cloud.servicehealth_v1.services.service_health import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ServiceHealthClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ServiceHealthClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ServiceHealthClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ServiceHealthClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__get_client_cert_source():
    ...
    assert (
        ServiceHealthClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ServiceHealthClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ServiceHealthClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ServiceHealthClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ServiceHealthClient),
)
@mock.patch.object(
    ServiceHealthAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ServiceHealthAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServiceHealthClient._DEFAULT_UNIVERSE
    default_endpoint = ServiceHealthClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ServiceHealthClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        ServiceHealthClient._get_api_endpoint(
    ...
    assert (
        ...
        == ServiceHealthClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ServiceHealthClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ServiceHealthClient._get_api_endpoint(None, None, default_universe, "always")
        == ServiceHealthClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ServiceHealthClient._get_api_endpoint(
    ...
    assert (
        ServiceHealthClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ServiceHealthClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ServiceHealthClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ServiceHealthClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ServiceHealthClient._get_universe_domain(None, None)
        == ServiceHealthClient._DEFAULT_UNIVERSE
    )
...
def test_service_health_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(
        ...
        assert client.transport._host == (
            ...
            else "https://servicehealth.googleapis.com"
        )
...
def test_service_health_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_service_health_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [ServiceHealthClient, ServiceHealthAsyncClient]
)
@mock.patch.object(
    ServiceHealthClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ServiceHealthClient),
)
@mock.patch.object(
    ServiceHealthAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ServiceHealthAsyncClient),
)
...
def test_service_health_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_service_health_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_service_health_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.servicehealth_v1.services.service_health.transports.ServiceHealthGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_service_health_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_event(request_type, transport: str = "grpc"):
    ...
    assert (
        response.detailed_category
        == event_resources.Event.DetailedCategory.CONFIRMED_INCIDENT
    )
...
def test_list_organization_events_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_organization_events
...
@pytest.mark.asyncio
async def test_list_organization_events_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_organization_events
            in client._client._transport._wrapped_methods
        )
...
def test_list_organization_events_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_organization_events(
...
async def test_list_organization_events_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_organization_events),
        "__call__",
...
def test_get_organization_event(request_type, transport: str = "grpc"):
    ...
    assert (
        response.detailed_category
        == event_resources.OrganizationEvent.DetailedCategory.CONFIRMED_INCIDENT
    )
    assert response.state == event_resources.OrganizationEvent.State.ACTIVE
    assert (
        response.detailed_state
...
def test_get_organization_event_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_organization_event
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_organization_event] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_organization_event_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_organization_event
            in client._client._transport._wrapped_methods
        )
...
def test_list_organization_impacts_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_organization_impacts
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_organization_impacts_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_organization_impacts
            in client._client._transport._wrapped_methods
        )
...
def test_list_organization_impacts_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_organization_impacts(
            request={}, retry=retry, timeout=timeout
        )
...
async def test_list_organization_impacts_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_organization_impacts),
        "__call__",
        new_callable=mock.AsyncMock,
    ) as call:
        # Set the response to a series of pages.
...
def test_get_organization_impact_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_organization_impact
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_organization_impact_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_organization_impact
            in client._client._transport._wrapped_methods
        )
...
def test_list_events_rest_required_fields(
    request_type=event_resources.ListEventsRequest,
):
...
def test_list_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/events" % client.transport._host,
            args[1],
        )
...
def test_list_events_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            event_resources.ListEventsResponse.to_json(x) for x in response
        )
...
def test_get_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/events/*}" % client.transport._host,
            args[1],
        )
...
def test_list_organization_events_rest_required_fields(
    request_type=event_resources.ListOrganizationEventsRequest,
):
    transport_class = transports.ServiceHealthRestTransport
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = event_resources.ListOrganizationEventsResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_organization_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*}/organizationEvents"
...
def test_list_organization_events_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            event_resources.ListOrganizationEventsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_get_organization_event_rest_required_fields(
    request_type=event_resources.GetOrganizationEventRequest,
):
    transport_class = transports.ServiceHealthRestTransport
...
def test_get_organization_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "organizations/sample1/locations/sample2/organizationEvents/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/organizationEvents/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_organization_impacts_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = event_resources.ListOrganizationImpactsResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_organization_impacts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*}/organizationImpacts"
            % client.transport._host,
            args[1],
        )
...
def test_list_organization_impacts_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            event_resources.ListOrganizationImpactsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_get_organization_impact_rest_required_fields(
    request_type=event_resources.GetOrganizationImpactRequest,
):
    transport_class = transports.ServiceHealthRestTransport
...
def test_get_organization_impact_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "organizations/sample1/locations/sample2/organizationImpacts/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/organizationImpacts/*}"
            % client.transport._host,
            args[1],
        )
...
def test_transport_kind_grpc_asyncio():
    transport = ServiceHealthAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ServiceHealthClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_service_health_base_transport():
    ...
    with mock.patch(
        "google.cloud.servicehealth_v1.services.service_health.transports.ServiceHealthTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [
        (transports.ServiceHealthGrpcTransport, grpc_helpers),
        (transports.ServiceHealthGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_service_health_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "servicehealth.googleapis.com:8000"
        if transport_name in ["grpc", "grpc_asyncio"]
        else "https://servicehealth.googleapis.com:8000"
    )
...
def test_organization_impact_path():
    ...
    actual = ServiceHealthClient.organization_impact_path(
        organization, location, organization_impact
    )
    assert expected == actual

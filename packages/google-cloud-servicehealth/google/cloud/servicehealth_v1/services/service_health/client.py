...
class ServiceHealthClient(metaclass=ServiceHealthClientMeta):
    ...
    def event_path(
        ...
        return "projects/{project}/locations/{location}/events/{event}".format(
            project=project,
            location=location,
            event=event,
        )
    ...
    def parse_event_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/events/(?P<event>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def organization_event_path(
        organization: str,
        location: str,
        event: str,
    ) -> str:
        """Returns a fully-qualified organization_event string."""
        return "organizations/{organization}/locations/{location}/organizationEvents/{event}".format(
    ...
    def parse_organization_event_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/organizationEvents/(?P<event>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def organization_impact_path(
        organization: str,
        location: str,
        organization_impact: str,
    ) -> str:
        """Returns a fully-qualified organization_impact string."""
        return "organizations/{organization}/locations/{location}/organizationImpacts/{organization_impact}".format(
            organization=organization,
            location=location,
    ...
    def parse_organization_impact_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/organizationImpacts/(?P<organization_impact>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ServiceHealthClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ServiceHealthClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ServiceHealthClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ServiceHealthClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ServiceHealthClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ServiceHealthTransport], Callable[..., ServiceHealthTransport]
            ] = (
    ...
    def list_organization_impacts(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_organization_impacts
        ]

...
class ServiceHealthTransport(abc.ABC):
    """Abstract transport class for ServiceHealth."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "servicehealth.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_organization_events: gapic_v1.method.wrap_method(
            ...
            self.get_organization_event: gapic_v1.method.wrap_method(
            ...
            self.list_organization_impacts: gapic_v1.method.wrap_method(
            ...
            self.get_organization_impact: gapic_v1.method.wrap_method(
...
__all__ = ("ServiceHealthTransport",)

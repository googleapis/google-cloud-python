...
class ServiceHealthGrpcAsyncIOTransport(ServiceHealthTransport):
    """gRPC AsyncIO backend transport for ServiceHealth.
    ...
    @property
    def list_events(self) -> Callable[[event_resources.ListEventsRequest], Awaitable[event_resources.ListEventsResponse]]:
    ...
    @property
    def get_event(self) -> Callable[[event_resources.GetEventRequest], Awaitable[event_resources.Event]]:
    ...
    def list_organization_events(
        self,
    ) -> Callable[[event_resources.ListOrganizationEventsRequest], Awaitable[event_resources.ListOrganizationEventsResponse]]:
        ...
        Returns:
            Callable[[~.ListOrganizationEventsRequest],
                    Awaitable[~.ListOrganizationEventsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def get_organization_event(self) -> Callable[[event_resources.GetOrganizationEventRequest], Awaitable[event_resources.OrganizationEvent]]:
    ...
    def list_organization_impacts(
        self,
    ) -> Callable[[event_resources.ListOrganizationImpactsRequest], Awaitable[event_resources.ListOrganizationImpactsResponse]]:
        ...
        Returns:
            Callable[[~.ListOrganizationImpactsRequest],
                    Awaitable[~.ListOrganizationImpactsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    @property
    def get_organization_impact(self) -> Callable[[event_resources.GetOrganizationImpactRequest], Awaitable[event_resources.OrganizationImpact]]:
...
__all__ = ("ServiceHealthGrpcAsyncIOTransport",)

...
class ServiceHealthGrpcTransport(ServiceHealthTransport):
    """gRPC backend transport for ServiceHealth.
    ...
    def list_organization_events(
        ...
        Returns:
            Callable[[~.ListOrganizationEventsRequest],
    ...
    def get_organization_event(
        ...
        Returns:
            Callable[[~.GetOrganizationEventRequest],
                    ~.OrganizationEvent]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        return self._stubs["get_organization_event"]
    ...
    def list_organization_impacts(
        ...
        Returns:
            Callable[[~.ListOrganizationImpactsRequest],
    ...
    def get_organization_impact(
        ...
        Returns:
            Callable[[~.GetOrganizationImpactRequest],
                    ~.OrganizationImpact]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        return self._stubs["get_organization_impact"]
...
__all__ = ("ServiceHealthGrpcTransport",)

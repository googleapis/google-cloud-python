...
class ParseUtilsTests(TestCase):
    ...
    def test_with_host(self):
        url = 'cloudspanner://spanner.googleapis.com/projects/test-project-012345/instances/test-instance/databases/dev-db'
    ...
    def test_with_host_and_port(self):
        url = 'cloudspanner://spanner.googleapis.com:443/projects/test-project-012345/instances/test-instance/databases/dev-db'
    ...
    def test_with_host_with_properties(self):
        url = 'cloudspanner://spanner.googleapis.com/projects/test-project-012345/instances/test-instance/databases/dev-db?autocommit=true;readonly=true'

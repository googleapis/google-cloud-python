...
# documentation.
html_theme_options = {
    "description": "Django API Libraries for google-cloud-spanner",
    "github_user": "googleapis",
    "github_repo": "python-spanner-django",
    "github_banner": True,
...
suppress_warnings = [
    ...
    # cross-reference" warning, which are intractable for us to avoid
    # while in a mono-repo.
...
# For "manual" documents, if this is True,
# then toplevel headings are parts, not chapters.
...
# (source_start_file, target_name, title, author,
#  dir_menu_entry, description, category)
texinfo_documents = [
    (
        master_doc,
        "django-google-spanner",

...
api_core.check_python_version("google.cloud.bigquery_data_exchange_v1beta1")
api_core.check_dependency_versions("google.cloud.bigquery_data_exchange_v1beta1")

...
for library in s.get_staging_dirs(default_version):
    ...
    s.replace(
        ...
        "google.cloud.bigquery.data_exchange_{library.name}.common.Category",
    )
    s.replace(
        library / f"docs/common/types.rst",
        "google.cloud.bigquery.data_exchange.common.types"
        "google.cloud.bigquery.data_exchange_{library.name}.common.types",
    )
    s.replace(
        [
            library  / f"google/cloud/bigquery/data_exchange_{library.name}/**/*.py",
    ...
    s.move(library / "google/cloud/bigquery/data_exchange/common", library / "google/cloud/bigquery/data_exchange_v1beta1/common")
    s.move(library, excludes=["setup.py", "README.rst", "docs/index.rst", "google/cloud/bigquery/data_exchange/**"])

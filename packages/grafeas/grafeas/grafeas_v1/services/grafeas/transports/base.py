...
class GrafeasTransport(abc.ABC):
    ...
    def get_occurrence(
        ...
        Union[grafeas.Occurrence, Awaitable[grafeas.Occurrence]],
    ]:
        raise NotImplementedError()
    ...
    def list_occurrences(
        ...
        Union[
            grafeas.ListOccurrencesResponse, Awaitable[grafeas.ListOccurrencesResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_occurrence_note(
        ...
        [grafeas.GetOccurrenceNoteRequest], Union[grafeas.Note, Awaitable[grafeas.Note]]
    ]:
        raise NotImplementedError()
    ...
    def get_note(
        ...
        [grafeas.GetNoteRequest], Union[grafeas.Note, Awaitable[grafeas.Note]]
    ]:
        raise NotImplementedError()
    ...
    def list_notes(
        ...
        Union[grafeas.ListNotesResponse, Awaitable[grafeas.ListNotesResponse]],
    ]:
        raise NotImplementedError()
    ...
    def delete_note(
        ...
        [grafeas.DeleteNoteRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def create_note(
        ...
        [grafeas.CreateNoteRequest], Union[grafeas.Note, Awaitable[grafeas.Note]]
    ]:
        raise NotImplementedError()
    ...
    def update_note(
        ...
        [grafeas.UpdateNoteRequest], Union[grafeas.Note, Awaitable[grafeas.Note]]
    ]:
        raise NotImplementedError()

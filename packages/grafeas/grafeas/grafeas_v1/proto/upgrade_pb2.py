...
# source: grafeas_v1/proto/upgrade.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="grafeas_v1/proto/upgrade.proto",
    package="grafeas.v1",
    syntax="proto3",
...
UpgradeNote = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="grafeas_v1.proto.upgrade_pb2",
        __doc__="""An Upgrade Note represents a potential upgrade of a package to a given
  version. For each package version combination (i.e. bash 4.0, bash 4.1,
  bash 4.1.2), there will be an Upgrade Note. For Windows, windows\_update
...
UpgradeDistribution = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      classification:
          ...
          Windows the classification is one of the category\_ids listed
...
WindowsUpdate = _reflection.GeneratedProtocolMessageType(
    ...
    """,
        ...
        __module__="grafeas_v1.proto.upgrade_pb2",
        __doc__="""Windows Update represents the metadata about the update for the Windows
...
UpgradeOccurrence = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="grafeas_v1.proto.upgrade_pb2",
        __doc__="""An Upgrade Occurrence represents that a specific resource\_url could
  ...
  availability). For Windows, both distribution and windows\_update
  ...
  Attributes:
      ...
      distribution:
          ...
          operating system for the resource\_url. This allows efficient

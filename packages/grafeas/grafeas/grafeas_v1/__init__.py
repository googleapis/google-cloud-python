...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("grafeas.grafeas_v1")  # type: ignore
    api_core.check_dependency_versions("grafeas.grafeas_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "grafeas.grafeas_v1"

...
class CertificateAuthority(proto.Message):
    ...
    delete_time = proto.Field(proto.MESSAGE, number=15, message=timestamp.Timestamp,)

    expire_time = proto.Field(proto.MESSAGE, number=16, message=timestamp.Timestamp,)
...
class CertificateIdentityConstraints(proto.Message):
    ...
    cel_expression = proto.Field(proto.MESSAGE, number=1, message=expr.Expr,)

    allow_subject_passthrough = proto.Field(proto.BOOL, number=2)

    allow_subject_alt_names_passthrough = proto.Field(proto.BOOL, number=3)

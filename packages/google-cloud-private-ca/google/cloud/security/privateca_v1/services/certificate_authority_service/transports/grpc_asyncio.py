...
class CertificateAuthorityServiceGrpcAsyncIOTransport(CertificateAuthorityServiceTransport):
    ...
    @property
    def undelete_certificate_authority(self) -> Callable[[service.UndeleteCertificateAuthorityRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "undelete_certificate_authority" not in self._stubs:
            self._stubs["undelete_certificate_authority"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_certificate_authority(self) -> Callable[[service.DeleteCertificateAuthorityRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_certificate_authority" not in self._stubs:
            self._stubs["delete_certificate_authority"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_ca_pool(self) -> Callable[[service.CreateCaPoolRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_ca_pool(self) -> Callable[[service.UpdateCaPoolRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_ca_pool(self) -> Callable[[service.GetCaPoolRequest], Awaitable[resources.CaPool]]:
    ...
    @property
    def list_ca_pools(self) -> Callable[[service.ListCaPoolsRequest], Awaitable[service.ListCaPoolsResponse]]:
    ...
    @property
    def delete_ca_pool(self) -> Callable[[service.DeleteCaPoolRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def fetch_ca_certs(self) -> Callable[[service.FetchCaCertsRequest], Awaitable[service.FetchCaCertsResponse]]:
    ...
    @property
    def create_certificate_template(self) -> Callable[[service.CreateCertificateTemplateRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_certificate_template" not in self._stubs:
            self._stubs["create_certificate_template"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_certificate_template(self) -> Callable[[service.DeleteCertificateTemplateRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_certificate_template" not in self._stubs:
            self._stubs["delete_certificate_template"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_certificate_template(self) -> Callable[[service.GetCertificateTemplateRequest], Awaitable[resources.CertificateTemplate]]:
    ...
    @property
    def list_certificate_templates(self) -> Callable[[service.ListCertificateTemplatesRequest], Awaitable[service.ListCertificateTemplatesResponse]]:
        ...
        if "list_certificate_templates" not in self._stubs:
            self._stubs["list_certificate_templates"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_certificate_template(self) -> Callable[[service.UpdateCertificateTemplateRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "update_certificate_template" not in self._stubs:
            self._stubs["update_certificate_template"] = self._logged_channel.unary_unary(

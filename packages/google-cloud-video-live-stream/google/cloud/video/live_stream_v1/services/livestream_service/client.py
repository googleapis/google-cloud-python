...
class LivestreamServiceClient(metaclass=LivestreamServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "livestream.{UNIVERSE_DOMAIN}"
    ...
    def parse_asset_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/assets/(?P<asset>.+?)$", path)
    ...
    def clip_path(
        ...
        return "projects/{project}/locations/{location}/channels/{channel}/clips/{clip}".format(
            project=project,
            location=location,
            channel=channel,
            clip=clip,
    ...
    def parse_clip_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/channels/(?P<channel>.+?)/clips/(?P<clip>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_dvr_session_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/channels/(?P<channel>.+?)/dvrSessions/(?P<dvr_session>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_event_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/channels/(?P<channel>.+?)/events/(?P<event>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_input_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/inputs/(?P<input>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def pool_path(
        ...
        return "projects/{project}/locations/{location}/pools/{pool}".format(
            project=project,
            location=location,
            pool=pool,
        )
    ...
    def parse_pool_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/pools/(?P<pool>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = LivestreamServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, LivestreamServiceTransport, Callable[..., LivestreamServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = LivestreamServiceClient._read_environment_variables()
        self._client_cert_source = LivestreamServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = LivestreamServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or LivestreamServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[LivestreamServiceTransport], Callable[..., LivestreamServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.video.livestream_v1.LivestreamServiceClient`.",
                    extra={
    ...
    def update_channel(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("channel.name", request.channel.name),)),)
    ...
    def update_input(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("input.name", request.input.name),)),)
    ...
    def list_clips(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.ListClipsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_clips]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListClipsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_clip():
                ...
                # Make the request
                response = client.get_clip(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.video.live_stream_v1.types.GetClipRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_clip]
    ...
    def create_clip(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.CreateClipRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_clip]
    ...
    def delete_clip(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.DeleteClipRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_clip]
    ...
    def update_dvr_session(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("dvr_session.name", request.dvr_session.name),)),)
    ...
    def create_asset(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.CreateAssetRequest, dict]):
                The request object. Request message for
    ...
    def delete_asset(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.DeleteAssetRequest, dict]):
                The request object. Request message for
    ...
    def get_asset(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.GetAssetRequest, dict]):
                The request object. Request message for
    ...
    def list_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.ListAssetsRequest, dict]):
                The request object. Request message for
    ...
    def get_pool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.GetPoolRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_pool]
    ...
    def update_pool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.video.live_stream_v1.types.UpdatePoolRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_pool]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("pool.name", request.pool.name),)),)

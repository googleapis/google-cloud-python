...
from google.cloud.video.live_stream_v1._compat import (
    get_api_endpoint,
...
class LivestreamServiceClient(metaclass=LivestreamServiceClientMeta):
    ...
    def parse_clip_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/channels/(?P<channel>.+?)/clips/(?P<clip>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def parse_pool_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/pools/(?P<pool>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=LivestreamServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

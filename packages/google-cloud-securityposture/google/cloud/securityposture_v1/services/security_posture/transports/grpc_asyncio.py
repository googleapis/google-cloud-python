...
from .base import DEFAULT_CLIENT_INFO, SecurityPostureTransport
...
class SecurityPostureGrpcAsyncIOTransport(SecurityPostureTransport):
    ...
    def get_posture(
        ...
        [securityposture.GetPostureRequest], Awaitable[securityposture.Posture]
    ]:
    ...
    def create_posture(
        ...
        [securityposture.CreatePostureRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_posture(
        ...
        [securityposture.UpdatePostureRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_posture(
        ...
        [securityposture.DeletePostureRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def extract_posture(
        ...
        [securityposture.ExtractPostureRequest], Awaitable[operations_pb2.Operation]
    ]:
...
__all__ = ("SecurityPostureGrpcAsyncIOTransport",)

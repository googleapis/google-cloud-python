...
class ListPostureRevisionsAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterator[securityposture.ListPostureRevisionsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
...
class ListPostureDeploymentsAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterator[securityposture.ListPostureDeploymentsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)
...
class ListPostureTemplatesAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterator[securityposture.ListPostureTemplatesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, metadata=self._metadata)

...
class SecurityPostureAsyncClient:
    ...
    posture_deployment_path = staticmethod(
        SecurityPostureClient.posture_deployment_path
    )
    parse_posture_deployment_path = staticmethod(
        SecurityPostureClient.parse_posture_deployment_path
    )
    posture_template_path = staticmethod(SecurityPostureClient.posture_template_path)
    parse_posture_template_path = staticmethod(
        SecurityPostureClient.parse_posture_template_path
    )
    common_billing_account_path = staticmethod(
        SecurityPostureClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        SecurityPostureClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(SecurityPostureClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        SecurityPostureClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        SecurityPostureClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        SecurityPostureClient.parse_common_organization_path
    )
    common_project_path = staticmethod(SecurityPostureClient.common_project_path)
    parse_common_project_path = staticmethod(
        SecurityPostureClient.parse_common_project_path
    )
    common_location_path = staticmethod(SecurityPostureClient.common_location_path)
    parse_common_location_path = staticmethod(
        SecurityPostureClient.parse_common_location_path
    )
    ...
    get_transport_class = functools.partial(
        type(SecurityPostureClient).get_transport_class, type(SecurityPostureClient)
    )
    ...
    async def list_posture_revisions(
        self,
        request: Optional[
    ...
    async def list_posture_deployments(
        self,
        request: Optional[
    ...
    async def get_posture_deployment(
        self,
        request: Optional[
    ...
    async def create_posture_deployment(
        self,
        request: Optional[
    ...
    async def update_posture_deployment(
        self,
        request: Optional[
    ...
    async def delete_posture_deployment(
        self,
        request: Optional[
    ...
    async def list_posture_templates(
        self,
        request: Optional[
    ...
    async def get_posture_template(
        self,
        request: Optional[
...
__all__ = ("SecurityPostureAsyncClient",)

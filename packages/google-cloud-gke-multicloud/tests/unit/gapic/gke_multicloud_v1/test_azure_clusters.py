...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AzureClustersClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AzureClustersClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AzureClustersClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AzureClustersClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AzureClustersClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AzureClustersClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert AzureClustersClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AzureClustersClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert AzureClustersClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AzureClustersClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(AzureClustersClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AzureClustersClient))
@mock.patch.object(AzureClustersAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AzureClustersAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AzureClustersClient._DEFAULT_UNIVERSE
    default_endpoint = AzureClustersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AzureClustersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AzureClustersClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AzureClustersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AzureClustersClient.DEFAULT_MTLS_ENDPOINT
    assert AzureClustersClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AzureClustersClient._get_api_endpoint(None, None, default_universe, "always") == AzureClustersClient.DEFAULT_MTLS_ENDPOINT
    assert (
        AzureClustersClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AzureClustersClient.DEFAULT_MTLS_ENDPOINT
    )
    assert AzureClustersClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AzureClustersClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AzureClustersClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AzureClustersClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AzureClustersClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AzureClustersClient._get_universe_domain(None, None) == AzureClustersClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (AzureClustersAsyncClient, transports.AzureClustersGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (AzureClustersAsyncClient, transports.AzureClustersGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (AzureClustersClient, transports.AzureClustersGrpcTransport, "grpc", "false"),
        (AzureClustersAsyncClient, transports.AzureClustersGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
@pytest.mark.parametrize(
    ...
    [
        (AzureClustersClient, transports.AzureClustersGrpcTransport, "grpc", grpc_helpers),
        (AzureClustersAsyncClient, transports.AzureClustersGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_azure_client_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_azure_client in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_azure_client] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_azure_client_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_azure_client in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_azure_client] = mock_rpc
...
def test_get_azure_client_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_azure_client] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_azure_client_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_azure_client in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_azure_client] = mock_rpc
...
def test_list_azure_clients_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_azure_clients in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_azure_clients] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_azure_clients_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_azure_clients in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_azure_clients] = mock_rpc
...
async def test_list_azure_clients_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_azure_clients), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_azure_clients(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_azure_client_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_azure_client in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_azure_client] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_azure_client_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_azure_client in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_azure_client] = mock_rpc
...
def test_create_azure_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_azure_cluster in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_azure_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_azure_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_azure_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_azure_cluster] = mock_rpc
...
def test_update_azure_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_azure_cluster in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_azure_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_azure_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_azure_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_azure_cluster] = mock_rpc
...
def test_get_azure_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_azure_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_azure_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_azure_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_azure_cluster] = mock_rpc
...
def test_list_azure_clusters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_azure_clusters in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_azure_clusters] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_azure_clusters_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_azure_clusters in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_azure_clusters] = mock_rpc
...
async def test_list_azure_clusters_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_azure_clusters), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_azure_clusters(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_azure_cluster_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_azure_cluster in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_azure_cluster] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_azure_cluster_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_azure_cluster in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_azure_cluster] = mock_rpc
...
def test_generate_azure_cluster_agent_token_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_azure_cluster_agent_token in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_azure_cluster_agent_token] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_azure_cluster_agent_token_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_azure_cluster_agent_token in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_azure_cluster_agent_token] = mock_rpc
...
async def test_generate_azure_cluster_agent_token_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.generate_azure_cluster_agent_token), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(azure_service.GenerateAzureClusterAgentTokenResponse())
        await client.generate_azure_cluster_agent_token(request)
...
def test_generate_azure_access_token_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_azure_access_token in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_azure_access_token] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_azure_access_token_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_azure_access_token in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_azure_access_token] = mock_rpc
...
def test_create_azure_node_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_azure_node_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_azure_node_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_azure_node_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_azure_node_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_azure_node_pool] = mock_rpc
...
def test_update_azure_node_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_azure_node_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_azure_node_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_azure_node_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_azure_node_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_azure_node_pool] = mock_rpc
...
def test_get_azure_node_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_azure_node_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_azure_node_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_azure_node_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_azure_node_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_azure_node_pool] = mock_rpc
...
def test_list_azure_node_pools_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_azure_node_pools in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_azure_node_pools] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_azure_node_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_azure_node_pools in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_azure_node_pools] = mock_rpc
...
async def test_list_azure_node_pools_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_azure_node_pools), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_azure_node_pools(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_azure_node_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_azure_node_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_azure_node_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_azure_node_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_azure_node_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_azure_node_pool] = mock_rpc
...
def test_get_azure_open_id_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_azure_open_id_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_azure_open_id_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_azure_open_id_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_azure_open_id_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_azure_open_id_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_azure_open_id_config_async(transport: str = "grpc_asyncio", request_type=azure_service.GetAzureOpenIdConfigRequest):
    client = AzureClustersAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_azure_open_id_config_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_azure_open_id_config), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(azure_resources.AzureOpenIdConfig())
        await client.get_azure_open_id_config(request)
...
def test_get_azure_json_web_keys_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_azure_json_web_keys in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_azure_json_web_keys] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_azure_json_web_keys_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_azure_json_web_keys in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_azure_json_web_keys] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_azure_json_web_keys_async(transport: str = "grpc_asyncio", request_type=azure_service.GetAzureJsonWebKeysRequest):
    client = AzureClustersAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.get_azure_json_web_keys), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(azure_resources.AzureJsonWebKeys())
...
def test_get_azure_server_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_azure_server_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_azure_server_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_azure_server_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AzureClustersAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_azure_server_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_azure_server_config] = mock_rpc
...
def test_create_azure_client_rest_required_fields(request_type=azure_service.CreateAzureClientRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_azure_client._get_unset_required_fields(
        jsonified_request
    )
...
def test_delete_azure_client_rest_required_fields(request_type=azure_service.DeleteAzureClientRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_azure_client._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_azure_cluster_rest_required_fields(request_type=azure_service.CreateAzureClusterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_azure_cluster._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_azure_clusters_rest_required_fields(request_type=azure_service.ListAzureClustersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_azure_clusters._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_azure_cluster_rest_required_fields(request_type=azure_service.DeleteAzureClusterRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_azure_cluster._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_generate_azure_cluster_agent_token_rest_required_fields(request_type=azure_service.GenerateAzureClusterAgentTokenRequest):
    transport_class = transports.AzureClustersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_azure_cluster_agent_token._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = azure_service.GenerateAzureClusterAgentTokenResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_generate_azure_cluster_agent_token_rest_unset_required_fields():
    ...
    unset_fields = transport.generate_azure_cluster_agent_token._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(())
        & set(
            (
...
def test_generate_azure_access_token_rest_required_fields(request_type=azure_service.GenerateAzureAccessTokenRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_azure_access_token._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_azure_node_pool_rest_required_fields(request_type=azure_service.CreateAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_azure_node_pool._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_azure_node_pool_rest_required_fields(request_type=azure_service.UpdateAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_azure_node_pool._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_azure_node_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{azure_node_pool.name=projects/*/locations/*/azureClusters/*/azureNodePools/*}" % client.transport._host, args[1]
        )
...
def test_get_azure_node_pool_rest_required_fields(request_type=azure_service.GetAzureNodePoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_azure_node_pool._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_azure_node_pools_rest_required_fields(request_type=azure_service.ListAzureNodePoolsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_azure_node_pools._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_azure_open_id_config_rest_required_fields(request_type=azure_service.GetAzureOpenIdConfigRequest):
    transport_class = transports.AzureClustersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_azure_open_id_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_azure_open_id_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"azure_cluster": "projects/sample1/locations/sample2/azureClusters/sample3"}
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{azure_cluster=projects/*/locations/*/azureClusters/*}/.well-known/openid-configuration" % client.transport._host, args[1]
        )
...
def test_get_azure_json_web_keys_rest_required_fields(request_type=azure_service.GetAzureJsonWebKeysRequest):
    transport_class = transports.AzureClustersRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_azure_json_web_keys._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_azure_json_web_keys_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{azure_cluster=projects/*/locations/*/azureClusters/*}/jwks" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = AzureClustersClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = AzureClustersAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AzureClustersAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AzureClustersClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_azure_client_rest_bad_request(request_type=azure_service.CreateAzureClientRequest):
...
def test_create_azure_client_rest_interceptors(null_interceptor):
    transport = transports.AzureClustersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AzureClustersRestInterceptor(),
    )
    client = AzureClustersClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_create_azure_client_with_metadata"
...
def test_get_azure_client_rest_bad_request(request_type=azure_service.GetAzureClientRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_client") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_resources.AzureClient.to_json(azure_resources.AzureClient())
        req.return_value.content = return_value
...
def test_list_azure_clients_rest_bad_request(request_type=azure_service.ListAzureClientsRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_azure_clients_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_clients") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_service.ListAzureClientsResponse.to_json(azure_service.ListAzureClientsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = azure_service.ListAzureClientsResponse(), metadata
...
def test_delete_azure_client_rest_bad_request(request_type=azure_service.DeleteAzureClientRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/azureClients/sample3"}
    request = request_type(**request_init)
...
def test_delete_azure_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_delete_azure_client_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_azure_cluster_rest_bad_request(request_type=azure_service.CreateAzureClusterRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_azure_cluster_rest_call_success(request_type):
    ...
    request_init["azure_cluster"] = {
        ...
        "control_plane": {
            ...
            "proxy_config": {"resource_group_id": "resource_group_id_value", "secret_id": "secret_id_value"},
            "config_encryption": {"key_id": "key_id_value", "public_key": "public_key_value"},
            "tags": {},
            "replica_placements": [{"subnet_id": "subnet_id_value", "azure_availability_zone": "azure_availability_zone_value"}],
        ...
        "azure_services_authentication": {"tenant_id": "tenant_id_value", "application_id": "application_id_value"},
        "state": 1,
        "endpoint": "endpoint_value",
        "uid": "uid_value",
        "reconciling": True,
...
def test_create_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_create_azure_cluster_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_azure_cluster_rest_bad_request(request_type=azure_service.UpdateAzureClusterRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_update_azure_cluster_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_azure_cluster_rest_bad_request(request_type=azure_service.GetAzureClusterRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_cluster") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_resources.AzureCluster.to_json(azure_resources.AzureCluster())
        req.return_value.content = return_value
...
def test_list_azure_clusters_rest_bad_request(request_type=azure_service.ListAzureClustersRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_azure_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_clusters") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_list_azure_clusters_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_service.ListAzureClustersResponse.to_json(azure_service.ListAzureClustersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = azure_service.ListAzureClustersResponse(), metadata
...
def test_delete_azure_cluster_rest_bad_request(request_type=azure_service.DeleteAzureClusterRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/azureClusters/sample3"}
    request = request_type(**request_init)
...
def test_delete_azure_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_delete_azure_cluster_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_generate_azure_cluster_agent_token_rest_bad_request(request_type=azure_service.GenerateAzureClusterAgentTokenRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_generate_azure_cluster_agent_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_generate_azure_cluster_agent_token") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_generate_azure_cluster_agent_token_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AzureClustersRestInterceptor, "pre_generate_azure_cluster_agent_token"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = azure_service.GenerateAzureClusterAgentTokenRequest.pb(azure_service.GenerateAzureClusterAgentTokenRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_service.GenerateAzureClusterAgentTokenResponse.to_json(azure_service.GenerateAzureClusterAgentTokenResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = azure_service.GenerateAzureClusterAgentTokenResponse(), metadata
...
def test_generate_azure_access_token_rest_bad_request(request_type=azure_service.GenerateAzureAccessTokenRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"azure_cluster": "projects/sample1/locations/sample2/azureClusters/sample3"}
    request = request_type(**request_init)
...
def test_generate_azure_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_generate_azure_access_token") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_generate_azure_access_token_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_service.GenerateAzureAccessTokenResponse.to_json(azure_service.GenerateAzureAccessTokenResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = azure_service.GenerateAzureAccessTokenResponse(), metadata
...
def test_create_azure_node_pool_rest_bad_request(request_type=azure_service.CreateAzureNodePoolRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_create_azure_node_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_azure_node_pool_rest_bad_request(request_type=azure_service.UpdateAzureNodePoolRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_update_azure_node_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_azure_node_pool_rest_bad_request(request_type=azure_service.GetAzureNodePoolRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_node_pool") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_get_azure_node_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_resources.AzureNodePool.to_json(azure_resources.AzureNodePool())
        req.return_value.content = return_value
...
def test_list_azure_node_pools_rest_bad_request(request_type=azure_service.ListAzureNodePoolsRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/azureClusters/sample3"}
    request = request_type(**request_init)
...
def test_list_azure_node_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_list_azure_node_pools") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_list_azure_node_pools_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_service.ListAzureNodePoolsResponse.to_json(azure_service.ListAzureNodePoolsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = azure_service.ListAzureNodePoolsResponse(), metadata
...
def test_delete_azure_node_pool_rest_bad_request(request_type=azure_service.DeleteAzureNodePoolRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/azureClusters/sample3/azureNodePools/sample4"}
    request = request_type(**request_init)
...
def test_delete_azure_node_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AzureClustersRestInterceptor, "post_delete_azure_node_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_azure_open_id_config_rest_bad_request(request_type=azure_service.GetAzureOpenIdConfigRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"azure_cluster": "projects/sample1/locations/sample2/azureClusters/sample3"}
    request = request_type(**request_init)
...
def test_get_azure_open_id_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_open_id_config") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_get_azure_open_id_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = azure_service.GetAzureOpenIdConfigRequest.pb(azure_service.GetAzureOpenIdConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_resources.AzureOpenIdConfig.to_json(azure_resources.AzureOpenIdConfig())
        req.return_value.content = return_value
...
def test_get_azure_json_web_keys_rest_bad_request(request_type=azure_service.GetAzureJsonWebKeysRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"azure_cluster": "projects/sample1/locations/sample2/azureClusters/sample3"}
    request = request_type(**request_init)
...
def test_get_azure_json_web_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_json_web_keys") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_get_azure_json_web_keys_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = azure_service.GetAzureJsonWebKeysRequest.pb(azure_service.GetAzureJsonWebKeysRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_resources.AzureJsonWebKeys.to_json(azure_resources.AzureJsonWebKeys())
        req.return_value.content = return_value
...
def test_get_azure_server_config_rest_bad_request(request_type=azure_service.GetAzureServerConfigRequest):
    client = AzureClustersClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_azure_server_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AzureClustersRestInterceptor, "post_get_azure_server_config") as post, mock.patch.object(
        transports.AzureClustersRestInterceptor, "post_get_azure_server_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = azure_resources.AzureServerConfig.to_json(azure_resources.AzureServerConfig())
        req.return_value.content = return_value
...
@pytest.mark.parametrize(
    ...
    [(transports.AzureClustersGrpcTransport, grpc_helpers), (transports.AzureClustersGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_azure_client_path():
    ...
    location = "clam"
    azure_client = "whelk"
    expected = "projects/{project}/locations/{location}/azureClients/{azure_client}".format(
        project=project,
        location=location,
...
def test_azure_cluster_path():
    ...
    expected = "projects/{project}/locations/{location}/azureClusters/{azure_cluster}".format(
        project=project,
        location=location,

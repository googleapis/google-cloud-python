...
class AwsClustersClient(metaclass=AwsClustersClientMeta):
    ...
    def aws_cluster_path(
        ...
        return "projects/{project}/locations/{location}/awsClusters/{aws_cluster}".format(
            project=project,
            location=location,
    ...
    def parse_aws_cluster_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/awsClusters/(?P<aws_cluster>.+?)$", path)
    ...
    def parse_aws_node_pool_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/awsClusters/(?P<aws_cluster>.+?)/awsNodePools/(?P<aws_node_pool>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_aws_server_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/awsServerConfig$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AwsClustersClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AwsClustersTransport, Callable[..., AwsClustersTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AwsClustersClient._read_environment_variables()
        self._client_cert_source = AwsClustersClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AwsClustersClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AwsClustersTransport], Callable[..., AwsClustersTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.gkemulticloud_v1.AwsClustersClient`.",
                    extra={
    ...
    def create_aws_cluster(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.create_aws_cluster is deprecated", DeprecationWarning)
    ...
    def update_aws_cluster(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.update_aws_cluster is deprecated", DeprecationWarning)
        ...
        *,
        ...
        Returns:
            google.cloud.gke_multicloud_v1.types.AwsCluster:
                An Anthos cluster running on AWS.
        """
        warnings.warn("AwsClustersClient.get_aws_cluster is deprecated", DeprecationWarning)
    ...
    def list_aws_clusters(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.list_aws_clusters is deprecated", DeprecationWarning)
    ...
    def delete_aws_cluster(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.delete_aws_cluster is deprecated", DeprecationWarning)
    ...
    def generate_aws_cluster_agent_token(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.generate_aws_cluster_agent_token is deprecated", DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_aws_cluster_agent_token]
    ...
    def generate_aws_access_token(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.generate_aws_access_token is deprecated", DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_aws_access_token]
    ...
    def create_aws_node_pool(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.create_aws_node_pool is deprecated", DeprecationWarning)
    ...
    def update_aws_node_pool(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.update_aws_node_pool is deprecated", DeprecationWarning)
    ...
    def rollback_aws_node_pool_update(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.rollback_aws_node_pool_update is deprecated", DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.rollback_aws_node_pool_update]
        ...
        *,
        ...
        Returns:
            google.cloud.gke_multicloud_v1.types.AwsNodePool:
                An Anthos node pool running on AWS.
        """
        warnings.warn("AwsClustersClient.get_aws_node_pool is deprecated", DeprecationWarning)
    ...
    def list_aws_node_pools(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.list_aws_node_pools is deprecated", DeprecationWarning)
    ...
    def get_aws_open_id_config(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.get_aws_open_id_config is deprecated", DeprecationWarning)
    ...
    def get_aws_json_web_keys(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.get_aws_json_web_keys is deprecated", DeprecationWarning)
    ...
    def get_aws_server_config(
        ...
        *,
        ...
        """
        warnings.warn("AwsClustersClient.get_aws_server_config is deprecated", DeprecationWarning)

...
class AdvisoryNotificationsServiceClient(metaclass=AdvisoryNotificationsServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AdvisoryNotificationsServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AdvisoryNotificationsServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or AdvisoryNotificationsServiceClient._get_api_endpoint(

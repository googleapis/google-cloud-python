...
class AdvisoryNotificationsServiceClient(
    metaclass=AdvisoryNotificationsServiceClientMeta
):
    ...
    def notification_path(
        ...
        return "organizations/{organization}/locations/{location}/notifications/{notification}".format(
    ...
    def parse_notification_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/notifications/(?P<notification>.+?)$",
            path,
        )
    ...
    def settings_path(
        ...
        return "organizations/{organization}/locations/{location}/settings".format(
            organization=organization,
            location=location,
        )
    ...
    def parse_settings_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/settings$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AdvisoryNotificationsServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                AdvisoryNotificationsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = AdvisoryNotificationsServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdvisoryNotificationsServiceTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AdvisoryNotificationsServiceClient._get_api_endpoint(

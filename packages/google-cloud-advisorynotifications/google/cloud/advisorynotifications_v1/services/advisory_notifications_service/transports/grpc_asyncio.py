...
from .base import DEFAULT_CLIENT_INFO, AdvisoryNotificationsServiceTransport
...
class AdvisoryNotificationsServiceGrpcAsyncIOTransport(AdvisoryNotificationsServiceTransport):
    ...
    @property
    def list_notifications(self) -> Callable[[service.ListNotificationsRequest], Awaitable[service.ListNotificationsResponse]]:
    ...
    @property
    def get_notification(self) -> Callable[[service.GetNotificationRequest], Awaitable[service.Notification]]:
    ...
    @property
    def get_settings(self) -> Callable[[service.GetSettingsRequest], Awaitable[service.Settings]]:
    ...
    @property
    def update_settings(self) -> Callable[[service.UpdateSettingsRequest], Awaitable[service.Settings]]:
...
__all__ = ("AdvisoryNotificationsServiceGrpcAsyncIOTransport",)

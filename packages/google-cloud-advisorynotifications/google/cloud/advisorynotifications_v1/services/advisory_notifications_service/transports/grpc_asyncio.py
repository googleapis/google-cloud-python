...
class AdvisoryNotificationsServiceGrpcAsyncIOTransport(
    ...
    def list_notifications(
        ...
        [service.ListNotificationsRequest], Awaitable[service.ListNotificationsResponse]
    ]:
    ...
    def get_notification(
        self,
    ) -> Callable[[service.GetNotificationRequest], Awaitable[service.Notification]]:
    ...
    def get_settings(
        self,
    ) -> Callable[[service.GetSettingsRequest], Awaitable[service.Settings]]:
    ...
    def update_settings(
        self,
    ) -> Callable[[service.UpdateSettingsRequest], Awaitable[service.Settings]]:

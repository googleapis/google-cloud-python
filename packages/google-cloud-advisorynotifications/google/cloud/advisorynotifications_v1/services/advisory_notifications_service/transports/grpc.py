...
class AdvisoryNotificationsServiceGrpcTransport(AdvisoryNotificationsServiceTransport):
    """gRPC backend transport for AdvisoryNotificationsService.
...
__all__ = ("AdvisoryNotificationsServiceGrpcTransport",)

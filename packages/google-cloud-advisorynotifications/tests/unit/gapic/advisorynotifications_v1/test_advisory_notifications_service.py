...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AdvisoryNotificationsServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AdvisoryNotificationsServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AdvisoryNotificationsServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AdvisoryNotificationsServiceClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
...
def test__read_environment_variables():
    assert AdvisoryNotificationsServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test__get_client_cert_source():
    ...
    assert (
        AdvisoryNotificationsServiceClient._get_client_cert_source(None, False) is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AdvisoryNotificationsServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AdvisoryNotificationsServiceClient),
)
@mock.patch.object(
    AdvisoryNotificationsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AdvisoryNotificationsServiceAsyncClient),
)
def test__get_api_endpoint():
    ...
    assert (
        ...
        == AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AdvisoryNotificationsServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        AdvisoryNotificationsServiceClient._get_universe_domain(
    ...
    assert (
        AdvisoryNotificationsServiceClient._get_universe_domain(None, None)
        == AdvisoryNotificationsServiceClient._DEFAULT_UNIVERSE
    )
...
def test_advisory_notifications_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_advisory_notifications_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_advisory_notifications_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_advisory_notifications_service_client_client_options(
    ...
    with mock.patch.object(
        AdvisoryNotificationsServiceClient, "get_transport_class"
    ) as gtc:
        transport = transport_class(credentials=ga_credentials.AnonymousCredentials())
        client = client_class(transport=transport)
...
def test_advisory_notifications_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    AdvisoryNotificationsServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AdvisoryNotificationsServiceClient),
)
@mock.patch.object(
    AdvisoryNotificationsServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AdvisoryNotificationsServiceAsyncClient),
)
...
def test_advisory_notifications_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_advisory_notifications_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_advisory_notifications_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.advisorynotifications_v1.services.advisory_notifications_service.transports.AdvisoryNotificationsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_advisory_notifications_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_notifications_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_notifications in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[
            client._transport.list_notifications
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_notifications_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_notifications
...
async def test_list_notifications_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_notifications(
            request={},
        )
...
def test_get_notification_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.get_notification
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_notification_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_notification
            in client._client._transport._wrapped_methods
        )
...
def test_list_notifications_rest_required_fields(
    request_type=service.ListNotificationsRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_notifications._get_unset_required_fields(jsonified_request)
...
def test_list_notifications_rest_interceptors(null_interceptor):
    transport = transports.AdvisoryNotificationsServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.AdvisoryNotificationsServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        req.return_value._content = service.ListNotificationsResponse.to_json(
            service.ListNotificationsResponse()
        )
...
def test_list_notifications_rest_bad_request(
    transport: str = "rest", request_type=service.ListNotificationsRequest
):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_notifications_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=organizations/*/locations/*}/notifications"
...
def test_get_notification_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "name": "organizations/sample1/locations/sample2/notifications/sample3"
    }
    request = request_type(**request_init)
...
def test_get_notification_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_notification._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_notification_rest_bad_request(
    transport: str = "rest", request_type=service.GetNotificationRequest
):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_notification_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/notifications/*}"
            % client.transport._host,
            args[1],
        )
...
def test_get_settings_rest_bad_request(
    transport: str = "rest", request_type=service.GetSettingsRequest
):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=organizations/*/locations/*/settings}"
            % client.transport._host,
            args[1],
        )
...
def test_update_settings_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "settings": {"name": "organizations/sample1/locations/sample2/settings"}
    }
    request_init["settings"] = {
        "name": "organizations/sample1/locations/sample2/settings",
...
def test_update_settings_rest_required_fields(
    request_type=service.UpdateSettingsRequest,
):
    transport_class = transports.AdvisoryNotificationsServiceRestTransport
...
def test_update_settings_rest_bad_request(
    transport: str = "rest", request_type=service.UpdateSettingsRequest
):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{settings.name=organizations/*/locations/*/settings}"
            % client.transport._host,
            args[1],
        )
...
def test_advisory_notifications_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.advisorynotifications_v1.services.advisory_notifications_service.transports.AdvisoryNotificationsServiceTransport.__init__"
    ) as Transport:
...
def test_advisory_notifications_service_transport_auth_gdch_credentials(
    transport_class,
):
...
def test_advisory_notifications_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_advisory_notifications_service_host_no_port(transport_name):
    client = AdvisoryNotificationsServiceClient(
        ...
        client_options=client_options.ClientOptions(
            api_endpoint="advisorynotifications.googleapis.com"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_advisory_notifications_service_host_with_port(transport_name):
    client = AdvisoryNotificationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
            api_endpoint="advisorynotifications.googleapis.com:8000"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_advisory_notifications_service_client_transport_session_collision(
    transport_name,
):
...
def test_notification_path():
    ...
    location = "clam"
    notification = "whelk"
    expected = "organizations/{organization}/locations/{location}/notifications/{notification}".format(
        organization=organization,
        location=location,
        notification=notification,
    )
    actual = AdvisoryNotificationsServiceClient.notification_path(
...
def test_settings_path():
    ...
    location = "mussel"
    expected = "organizations/{organization}/locations/{location}/settings".format(
        organization=organization,
        location=location,
    )
...
def test_common_billing_account_path():
    ...
    actual = AdvisoryNotificationsServiceClient.common_billing_account_path(
        billing_account
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.AdvisoryNotificationsServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = AdvisoryNotificationsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

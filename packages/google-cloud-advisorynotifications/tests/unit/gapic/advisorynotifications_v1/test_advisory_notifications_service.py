...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AdvisoryNotificationsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AdvisoryNotificationsServiceClient._use_client_cert_effective() is False
...
@mock.patch.object(
    AdvisoryNotificationsServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceClient)
)
@mock.patch.object(
    AdvisoryNotificationsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AdvisoryNotificationsServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        AdvisoryNotificationsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        AdvisoryNotificationsServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AdvisoryNotificationsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AdvisoryNotificationsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = AdvisoryNotificationsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = AdvisoryNotificationsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AdvisoryNotificationsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AdvisoryNotificationsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_notifications_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_list_notifications") as post, mock.patch.object(
        transports.AdvisoryNotificationsServiceRestInterceptor, "post_list_notifications_with_metadata"
...
def test_get_notification_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_notification") as post, mock.patch.object(
        transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_notification_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_settings") as post, mock.patch.object(
        transports.AdvisoryNotificationsServiceRestInterceptor, "post_get_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AdvisoryNotificationsServiceRestInterceptor, "post_update_settings") as post, mock.patch.object(
        transports.AdvisoryNotificationsServiceRestInterceptor, "post_update_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    "transport_class", [transports.AdvisoryNotificationsServiceGrpcTransport, transports.AdvisoryNotificationsServiceGrpcAsyncIOTransport]
)
...
def test_advisory_notifications_service_host_no_port(transport_name):
    ...
    assert client.transport._host == (
        "advisorynotifications.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://advisorynotifications.googleapis.com"
    )

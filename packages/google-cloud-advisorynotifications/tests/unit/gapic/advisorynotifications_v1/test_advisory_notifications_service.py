...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                AdvisoryNotificationsServiceClient._use_client_cert_effective() is True
            )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert (
                AdvisoryNotificationsServiceClient._use_client_cert_effective() is False
            )
...
def test_list_notifications_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_notifications] = (
            mock_rpc
        )
        request = {}
...
def test_get_notification_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_notification] = (
            mock_rpc
        )
        request = {}
...
def test_transport_kind_grpc_asyncio():
    transport = AdvisoryNotificationsServiceAsyncClient.get_transport_class(
        "grpc_asyncio"
    )(credentials=async_anonymous_credentials())

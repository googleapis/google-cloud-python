...
class BudgetServiceGrpcAsyncIOTransport(BudgetServiceTransport):
    ...
    @property
    def create_budget(self) -> Callable[[budget_service.CreateBudgetRequest], Awaitable[budget_model.Budget]]:
    ...
    @property
    def update_budget(self) -> Callable[[budget_service.UpdateBudgetRequest], Awaitable[budget_model.Budget]]:
    ...
    @property
    def get_budget(self) -> Callable[[budget_service.GetBudgetRequest], Awaitable[budget_model.Budget]]:
    ...
    @property
    def list_budgets(self) -> Callable[[budget_service.ListBudgetsRequest], Awaitable[budget_service.ListBudgetsResponse]]:
    ...
    @property
    def delete_budget(self) -> Callable[[budget_service.DeleteBudgetRequest], Awaitable[empty_pb2.Empty]]:

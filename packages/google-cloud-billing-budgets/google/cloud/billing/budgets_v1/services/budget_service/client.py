...
class BudgetServiceClient(metaclass=BudgetServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = BudgetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = BudgetServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = BudgetServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or BudgetServiceClient._get_api_endpoint(

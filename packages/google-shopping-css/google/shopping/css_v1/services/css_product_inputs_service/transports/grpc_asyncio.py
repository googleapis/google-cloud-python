...
class CssProductInputsServiceGrpcAsyncIOTransport(CssProductInputsServiceTransport):
    ...
    def delete_css_product_input(
        ...
        [css_product_inputs.DeleteCssProductInputRequest], Awaitable[empty_pb2.Empty]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.insert_css_product_input: gapic_v1.method_async.wrap_method(
                self.insert_css_product_input,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_css_product_input: gapic_v1.method_async.wrap_method(

...
class CssProductInputsServiceGrpcAsyncIOTransport(CssProductInputsServiceTransport):
    ...
    @property
    def insert_css_product_input(self) -> Callable[[css_product_inputs.InsertCssProductInputRequest], Awaitable[css_product_inputs.CssProductInput]]:
    ...
    @property
    def update_css_product_input(self) -> Callable[[css_product_inputs.UpdateCssProductInputRequest], Awaitable[css_product_inputs.CssProductInput]]:
    ...
    @property
    def delete_css_product_input(self) -> Callable[[css_product_inputs.DeleteCssProductInputRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.delete_css_product_input: self._wrap_method(
...
__all__ = ("CssProductInputsServiceGrpcAsyncIOTransport",)

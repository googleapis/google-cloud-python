...
class AccountsServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.css_v1.AccountsServiceAsyncClient`.",
                extra={
    ...
    async def list_child_accounts(
        ...
        *,
    ...
    ) -> pagers.ListChildAccountsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.shopping.css_v1.types.ListChildAccountsRequest, dict]]):
        ...
        Returns:
            google.shopping.css_v1.services.accounts_service.pagers.ListChildAccountsAsyncPager:
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_child_accounts]
        ...
        response = pagers.ListChildAccountsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def update_labels(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.css_v1.types.UpdateAccountLabelsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_labels]

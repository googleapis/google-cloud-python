...
class _BaseAccountsServiceRestTransport(AccountsServiceTransport):
    ...
    class _BaseListChildAccounts:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAccountsServiceRestTransport._BaseListChildAccounts._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateLabels:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAccountsServiceRestTransport._BaseUpdateLabels._get_unset_required_fields(
                    query_params
                )
            )

...
class AccountsServiceGrpcAsyncIOTransport(AccountsServiceTransport):
    ...
    def list_child_accounts(
        ...
        Awaitable[accounts.ListChildAccountsResponse],
    ]:
    ...
    def update_labels(
        self,
    ) -> Callable[[accounts.UpdateAccountLabelsRequest], Awaitable[accounts.Account]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_child_accounts: gapic_v1.method_async.wrap_method(
            ...
            self.update_labels: gapic_v1.method_async.wrap_method(
                self.update_labels,
                default_timeout=60.0,
                client_info=client_info,
            ),

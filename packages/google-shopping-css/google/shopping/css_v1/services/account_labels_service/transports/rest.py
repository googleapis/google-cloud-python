...
class AccountLabelsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_account_label(
        self, response: accounts_labels.AccountLabel
    ...
    def post_create_account_label_with_metadata(
        self,
        response: accounts_labels.AccountLabel,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ...
    def post_list_account_labels(
        self, response: accounts_labels.ListAccountLabelsResponse
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[AccountLabelsServiceRestInterceptor]): Interceptor used
    ...
    class _CreateAccountLabel(
        ...
        def __call__(
            ...
            *,
            ...
            resp, _ = self._interceptor.post_create_account_label_with_metadata(
    ...
    class _ListAccountLabels(
        ...
        def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_account_labels_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
    ...
    class _UpdateAccountLabel(
        ...
        def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_account_label_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG

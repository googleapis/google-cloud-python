...
class AccountLabelsServiceClient(metaclass=AccountLabelsServiceClientMeta):
    ...
    @staticmethod
    def account_label_path(
        account: str,
        label: str,
    ) -> str:
        """Returns a fully-qualified account_label string."""
        return "accounts/{account}/labels/{label}".format(
            account=account,
            label=label,
        )
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AccountLabelsServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or AccountLabelsServiceClient._get_api_endpoint(

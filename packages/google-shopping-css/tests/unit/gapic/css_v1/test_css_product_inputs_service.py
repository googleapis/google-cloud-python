...
def test_insert_css_product_input_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseInsertCssProductInput,
    ...
    assert not set(unset_fields) - set(("feedId",))
...
def test_update_css_product_input_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateCssProductInput,
...
def test_delete_css_product_input_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteCssProductInput,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("supplementalFeedId",))

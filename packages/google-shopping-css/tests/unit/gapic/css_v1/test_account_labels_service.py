...
def test__get_client_cert_source():
    ...
    assert (
        AccountLabelsServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AccountLabelsServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AccountLabelsServiceClient),
)
@mock.patch.object(
    AccountLabelsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AccountLabelsServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AccountLabelsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AccountLabelsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AccountLabelsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        AccountLabelsServiceClient._get_api_endpoint(
    ...
    assert (
        AccountLabelsServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AccountLabelsServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        AccountLabelsServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AccountLabelsServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AccountLabelsServiceClient._get_universe_domain(None, None)
        == AccountLabelsServiceClient._DEFAULT_UNIVERSE
    )
...
def test_list_account_labels_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_account_labels in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.list_account_labels] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_account_labels_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_account_labels
...
def test_create_account_label_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_account_label in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_account_label] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_account_label_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_account_label
            in client._client._transport._wrapped_methods
        )
...
def test_update_account_label_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_account_label in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_account_label] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_update_account_label_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_account_label
            in client._client._transport._wrapped_methods
        )
...
def test_delete_account_label_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_account_label in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_account_label] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_account_label_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_account_label
            in client._client._transport._wrapped_methods
        )
...
def test_transport_kind_grpc_asyncio():
    transport = AccountLabelsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = AccountLabelsServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )

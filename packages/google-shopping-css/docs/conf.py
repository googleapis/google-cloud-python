...
##
# google-shopping-css documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Shopping Client Libraries for google-shopping-css",
...
htmlhelp_basename = "google-shopping-css-doc"
...
latex_documents = [
    (
        root_doc,
        "google-shopping-css.tex",
        "google-shopping-css Documentation",
        author,
        "manual",
    )
]

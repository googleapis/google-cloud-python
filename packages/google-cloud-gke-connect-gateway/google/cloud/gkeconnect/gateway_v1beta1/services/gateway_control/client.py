...
from google.cloud.gkeconnect.gateway_v1beta1._compat import (
    get_api_endpoint,
...
class GatewayControlClient(metaclass=GatewayControlClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.gkeconnect.gateway_v1beta1.GatewayControlClient`.",
                    extra={
    ...
    def generate_credentials(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.gkeconnect.gateway_v1beta1.types.GenerateCredentialsRequest, dict]):
        ...
        Returns:
            google.cloud.gkeconnect.gateway_v1beta1.types.GenerateCredentialsResponse:

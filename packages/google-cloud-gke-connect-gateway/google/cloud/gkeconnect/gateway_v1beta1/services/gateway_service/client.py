...
class GatewayServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[GatewayServiceTransport]]
...
class GatewayServiceClient(metaclass=GatewayServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = GatewayServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GatewayServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = GatewayServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or GatewayServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = GatewayServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = GatewayServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, GatewayServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(GatewayServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or GatewayServiceClient._get_api_endpoint(

...
class GatewayControlAsyncClient:
    ...
    _client: GatewayControlClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = GatewayControlClient.DEFAULT_ENDPOINT
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GatewayControlAsyncClient: The constructed client.
        """
        return GatewayControlClient.from_service_account_info.__func__(GatewayControlAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            GatewayControlAsyncClient: The constructed client.
        """
        return GatewayControlClient.from_service_account_file.__func__(GatewayControlAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return GatewayControlClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> GatewayControlTransport:
        ...
        Returns:
            GatewayControlTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = GatewayControlClient(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_generate_credentials():
                # Create a client
                client = gateway_v1.GatewayControlAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.gkeconnect.gateway_v1.types.GenerateCredentialsRequest, dict]]):
    ...
    async def __aenter__(self) -> "GatewayControlAsyncClient":
        return self

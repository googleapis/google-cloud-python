...
class GatewayControlClientMeta(type):
    """Metaclass for the GatewayControl client.
...
class GatewayControlClient(metaclass=GatewayControlClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "connectgateway.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GatewayControlClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> GatewayControlTransport:
        """Returns the transport used by the client instance.

        Returns:
            GatewayControlTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = GatewayControlClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GatewayControlClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GatewayControlClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = GatewayControlClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, GatewayControlTransport, Callable[..., GatewayControlTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the gateway control client.
        ...
        Args:
            ...
            transport (Optional[Union[str,GatewayControlTransport,Callable[..., GatewayControlTransport]]]):
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GatewayControlClient._read_environment_variables()
        self._client_cert_source = GatewayControlClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GatewayControlClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, GatewayControlTransport)
        if transport_provided:
            # transport is a GatewayControlTransport instance.
            ...
            self._transport = cast(GatewayControlTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or GatewayControlClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GatewayControlTransport], Callable[..., GatewayControlTransport]] = (
                GatewayControlClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GatewayControlTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.gkeconnect.gateway_v1.GatewayControlClient`.",
                    extra={
    ...
    def generate_credentials(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.gkeconnect.gateway_v1.types.GenerateCredentialsRequest, dict]):
        ...
        Returns:
            google.cloud.gkeconnect.gateway_v1.types.GenerateCredentialsResponse:
        ...
        if not isinstance(request, control.GenerateCredentialsRequest):
            request = control.GenerateCredentialsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_credentials]
    ...
    def __enter__(self) -> "GatewayControlClient":
        return self

...
from google.cloud.gkeconnect.gateway_v1._compat import transcode_request
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[GatewayControlRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.gkeconnect.gateway_v1.GatewayControlClient.GenerateCredentials",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.gkeconnect.gateway_v1.GatewayControlClient.generate_credentials",
                    extra={
                        "serviceName": "google.cloud.gkeconnect.gateway.v1.GatewayControl",
                        "rpcName": "GenerateCredentials",

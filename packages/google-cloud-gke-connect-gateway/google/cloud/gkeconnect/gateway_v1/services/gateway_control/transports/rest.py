...
class GatewayControlRestTransport(GatewayControlTransport):
    """REST backend transport for GatewayControl.
    ...
    class _GenerateCredentials(GatewayControlRestStub):
        def __hash__(self):
            return hash("GenerateCredentials")

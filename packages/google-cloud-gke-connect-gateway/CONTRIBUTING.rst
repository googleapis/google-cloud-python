...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-gke-connect-gateway``. The
...
instead of
``https://github.com/googleapis/python-gke-connect-gateway/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-gke-connect-gateway/blob/main/noxfile.py

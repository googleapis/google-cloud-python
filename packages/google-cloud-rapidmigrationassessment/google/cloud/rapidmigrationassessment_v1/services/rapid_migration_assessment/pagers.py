...
class ListCollectorsAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[rapidmigrationassessment.ListCollectorsResponse]],
        request: rapidmigrationassessment.ListCollectorsRequest,
        response: rapidmigrationassessment.ListCollectorsResponse,
        *,
    ...
    @property
    async def pages(self) -> AsyncIterator[rapidmigrationassessment.ListCollectorsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

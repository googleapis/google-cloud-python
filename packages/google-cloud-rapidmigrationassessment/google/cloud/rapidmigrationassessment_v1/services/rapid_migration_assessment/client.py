...
class RapidMigrationAssessmentClient(metaclass=RapidMigrationAssessmentClientMeta):
    ...
    def annotation_path(
        ...
        return "projects/{project}/locations/{location}/annotations/{annotation}".format(
            project=project,
            location=location,
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RapidMigrationAssessmentClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or RapidMigrationAssessmentClient._get_api_endpoint(

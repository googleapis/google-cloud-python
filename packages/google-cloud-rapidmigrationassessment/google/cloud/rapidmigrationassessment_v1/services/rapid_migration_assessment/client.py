...
class RapidMigrationAssessmentClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RapidMigrationAssessmentTransport]]
...
class RapidMigrationAssessmentClient(metaclass=RapidMigrationAssessmentClientMeta):
    ...
    def annotation_path(
        ...
        return (
            "projects/{project}/locations/{location}/annotations/{annotation}".format(
                project=project,
                location=location,
    ...
    def parse_annotation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/annotations/(?P<annotation>.+?)$",
            path,
        )
    ...
    def collector_path(
        ...
        return "projects/{project}/locations/{location}/collectors/{collector}".format(
            project=project,
            location=location,
            collector=collector,
        )
    ...
    def parse_collector_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/collectors/(?P<collector>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RapidMigrationAssessmentClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RapidMigrationAssessmentClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = (
            RapidMigrationAssessmentClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = RapidMigrationAssessmentClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RapidMigrationAssessmentClient._get_api_endpoint(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                Collector resource by the update. The

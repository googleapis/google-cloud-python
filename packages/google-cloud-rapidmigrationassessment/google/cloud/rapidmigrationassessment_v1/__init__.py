...
from .services.rapid_migration_assessment import RapidMigrationAssessmentAsyncClient, RapidMigrationAssessmentClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.rapidmigrationassessment_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.rapidmigrationassessment_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.rapidmigrationassessment_v1"

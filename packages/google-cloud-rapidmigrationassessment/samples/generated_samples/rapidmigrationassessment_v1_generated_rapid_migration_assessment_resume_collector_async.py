...
async def sample_resume_collector():
    ...
    # Make the request
    operation = await client.resume_collector(request=request)
...
# [END rapidmigrationassessment_v1_generated_RapidMigrationAssessment_ResumeCollector_async]

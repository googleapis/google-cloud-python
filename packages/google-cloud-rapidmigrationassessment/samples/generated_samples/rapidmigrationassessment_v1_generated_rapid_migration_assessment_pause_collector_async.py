...
# [START rapidmigrationassessment_v1_generated_RapidMigrationAssessment_PauseCollector_async]
...
async def sample_pause_collector():
    ...
    # Make the request
    operation = await client.pause_collector(request=request)
...
# [END rapidmigrationassessment_v1_generated_RapidMigrationAssessment_PauseCollector_async]

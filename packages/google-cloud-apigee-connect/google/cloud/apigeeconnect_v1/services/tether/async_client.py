...
class TetherAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = TetherClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            TetherClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(TetherAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            TetherClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(TetherAsyncClient, filename, *args, **kwargs)
    ...
    get_transport_class = TetherClient.get_transport_class
    ...
    def egress(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.egress]

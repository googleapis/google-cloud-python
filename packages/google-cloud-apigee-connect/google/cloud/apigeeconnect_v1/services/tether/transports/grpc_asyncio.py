...
from .base import DEFAULT_CLIENT_INFO, TetherTransport
...
class TetherGrpcAsyncIOTransport(TetherTransport):
    ...
    def egress(
        self,
    ) -> Callable[[tether.EgressResponse], Awaitable[tether.EgressRequest]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.egress: gapic_v1.method_async.wrap_method(
                self.egress,

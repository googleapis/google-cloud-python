...
from google.cloud.apigeeconnect_v1.services.connection_service.transports.base import (
...
def test_connection_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.apigeeconnect_v1.services.connection_service.transports.ConnectionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_connection_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.apigeeconnect_v1.services.connection_service.transports.ConnectionServiceTransport.__init__"
    ) as Transport:
...
def test_connection_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.apigeeconnect_v1.services.connection_service.transports.ConnectionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

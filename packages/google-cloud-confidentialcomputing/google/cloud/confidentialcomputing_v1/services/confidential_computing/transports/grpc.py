...
class ConfidentialComputingGrpcTransport(ConfidentialComputingTransport):
    ...
    def create_challenge(
        ...
        if "create_challenge" not in self._stubs:
            self._stubs["create_challenge"] = self._logged_channel.unary_unary(
    ...
    def verify_attestation(
        ...
        if "verify_attestation" not in self._stubs:
            self._stubs["verify_attestation"] = self._logged_channel.unary_unary(
...
__all__ = ("ConfidentialComputingGrpcTransport",)

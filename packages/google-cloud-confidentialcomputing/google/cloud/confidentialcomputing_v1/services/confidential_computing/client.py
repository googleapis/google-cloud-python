...
from .transports.grpc import ConfidentialComputingGrpcTransport
from .transports.grpc_asyncio import ConfidentialComputingGrpcAsyncIOTransport
from .transports.rest import ConfidentialComputingRestTransport


class ConfidentialComputingClientMeta(type):
    """Metaclass for the ConfidentialComputing client.
...
class ConfidentialComputingClient(metaclass=ConfidentialComputingClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "confidentialcomputing.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConfidentialComputingClient: The constructed client.
        """
    ...
    def transport(self) -> ConfidentialComputingTransport:
        ...
        Returns:
            ConfidentialComputingTransport: The transport used by the client
                instance.
        """
    ...
    def challenge_path(
        ...
        """Returns a fully-qualified challenge string."""
        return "projects/{project}/locations/{location}/challenges/{uuid}".format(
            project=project,
            location=location,
            uuid=uuid,
        )
    ...
    @staticmethod
    def parse_challenge_path(path: str) -> Dict[str, str]:
        """Parses a challenge path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/challenges/(?P<uuid>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ConfidentialComputingClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = ConfidentialComputingClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = ConfidentialComputingClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConfidentialComputingClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConfidentialComputingClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ConfidentialComputingTransport, Callable[..., ConfidentialComputingTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,ConfidentialComputingTransport,Callable[..., ConfidentialComputingTransport]]]):
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConfidentialComputingClient._read_environment_variables()
        self._client_cert_source = ConfidentialComputingClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConfidentialComputingClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ConfidentialComputingTransport)
        if transport_provided:
            # transport is a ConfidentialComputingTransport instance.
            ...
            self._transport = cast(ConfidentialComputingTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ConfidentialComputingClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConfidentialComputingTransport], Callable[..., ConfidentialComputingTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.confidentialcomputing_v1.ConfidentialComputingClient`.",
                    extra={
    ...
    def create_challenge(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.confidentialcomputing_v1.types.CreateChallengeRequest, dict]):
        ...
        flattened_params = [parent, challenge]
        ...
        if not isinstance(request, service.CreateChallengeRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_challenge]
    ...
    def verify_attestation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.confidentialcomputing_v1.types.VerifyAttestationRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, service.VerifyAttestationRequest):
            request = service.VerifyAttestationRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.verify_attestation]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("challenge", request.challenge),)),)
    ...
    def verify_confidential_space(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_verify_confidential_space():
                # Create a client
                client = confidentialcomputing_v1.ConfidentialComputingClient()
                ...
                # Make the request
                response = client.verify_confidential_space(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.confidentialcomputing_v1.types.VerifyConfidentialSpaceRequest, dict]):
                The request object. A request for an attestation token,
                providing all the necessary information
                needed for this service to verify the
                platform state of the requestor.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.verify_confidential_space]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_verify_confidential_gke():
                ...
                # Make the request
                response = client.verify_confidential_gke(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.confidentialcomputing_v1.types.VerifyConfidentialGkeRequest, dict]):
                The request object. A request for an attestation token,
                providing all the necessary information
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.verify_confidential_gke]
    ...
    def __enter__(self) -> "ConfidentialComputingClient":
        return self

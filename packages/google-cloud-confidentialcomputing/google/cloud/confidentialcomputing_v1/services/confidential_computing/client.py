...
class ConfidentialComputingClient(metaclass=ConfidentialComputingClientMeta):
    ...
    def parse_challenge_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/challenges/(?P<uuid>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                ConfidentialComputingClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ConfidentialComputingClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ConfidentialComputingClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ConfidentialComputingClient._get_api_endpoint(
    ...
    def verify_confidential_space(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.verify_confidential_space
        ]

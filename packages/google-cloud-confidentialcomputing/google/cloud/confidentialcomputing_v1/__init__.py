...
__lazy_modules__ = {
    "google.cloud.confidentialcomputing_v1.services.confidential_computing",
    "google.cloud.confidentialcomputing_v1.types.service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.confidentialcomputing_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.confidentialcomputing_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.confidentialcomputing_v1"

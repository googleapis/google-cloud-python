...
class VerifyAttestationRequest(proto.Message):
    ...
    Attributes:
        ...
        gcp_credentials (google.cloud.confidentialcomputing_v1alpha1.types.GcpCredentials):
            Optional. Credentials used to populate the "emails" claim in
            the claims_token.
        tpm_attestation (google.cloud.confidentialcomputing_v1alpha1.types.TpmAttestation):
...
class VerifyAttestationResponse(proto.Message):
    ...
    Attributes:
        claims_token (bytes):
            Output only. The OIDC token issued by this
            service. It contains specific platform claims
            based on the contents of the provided
            attestation. --
    """

    claims_token: bytes = proto.Field(
        proto.BYTES,
        number=1,
    )
...
class GcpCredentials(proto.Message):
    ...
    Attributes:
        id_tokens (MutableSequence[bytes]):
    ...
    id_tokens: MutableSequence[bytes] = proto.RepeatedField(
        proto.BYTES,
        number=1,
    )
...
class TpmAttestation(proto.Message):
    ...
    Attributes:
        quotes (MutableSequence[google.cloud.confidentialcomputing_v1alpha1.types.TpmAttestation.Quote]):

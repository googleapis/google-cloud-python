...
from google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing import (
...
def test_confidential_computing_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_challenge_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha1/{parent=projects/*/locations/*}/challenges"
...
def test_confidential_computing_base_transport():
    ...
    with mock.patch(
        "google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingTransport.__init__"
    ) as Transport:
...
def test_confidential_computing_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.confidentialcomputing_v1alpha1.services.confidential_computing.transports.ConfidentialComputingTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

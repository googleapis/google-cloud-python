...
def test_create_challenge_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateChallenge,
...
def test_verify_attestation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseVerifyAttestation,
...
def test_verify_confidential_space_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseVerifyConfidentialSpace,
...
def test_verify_confidential_gke_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseVerifyConfidentialGke,

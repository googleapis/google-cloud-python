...
`Cloud Billing API`_: Allows developers to manage billing for their Google Cloud Platform projects     programmatically.
...
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/billing/latest/summary_overview

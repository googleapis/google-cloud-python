...
class CloudCatalogTransport(abc.ABC):
    ...
    def list_services(
        self,
    ) -> Callable[[cloud_catalog.ListServicesRequest], Union[cloud_catalog.ListServicesResponse, Awaitable[cloud_catalog.ListServicesResponse]]]:
        raise NotImplementedError()

    @property
    def list_skus(
        self,
    ) -> Callable[[cloud_catalog.ListSkusRequest], Union[cloud_catalog.ListSkusResponse, Awaitable[cloud_catalog.ListSkusResponse]]]:
        raise NotImplementedError()

...
class CloudCatalogGrpcAsyncIOTransport(CloudCatalogTransport):
    ...
    @property
    def list_services(self) -> Callable[[cloud_catalog.ListServicesRequest], Awaitable[cloud_catalog.ListServicesResponse]]:
    ...
    @property
    def list_skus(self) -> Callable[[cloud_catalog.ListSkusRequest], Awaitable[cloud_catalog.ListSkusResponse]]:

...
class CloudBillingClient(metaclass=CloudBillingClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CloudBillingClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudBillingClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = CloudBillingClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CloudBillingClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or CloudBillingClient._get_api_endpoint(

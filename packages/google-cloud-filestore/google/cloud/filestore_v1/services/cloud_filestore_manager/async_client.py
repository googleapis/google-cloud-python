...
class CloudFilestoreManagerAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = CloudFilestoreManagerClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            CloudFilestoreManagerClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            CloudFilestoreManagerClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    get_transport_class = CloudFilestoreManagerClient.get_transport_class
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_restore_instance():
                ...
                # Make the request
                operation = await client.restore_instance(request=request)
    ...
    async def revert_instance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.filestore_v1.types.RevertInstanceRequest, dict]]):
    ...
    async def promote_replica(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.filestore_v1.types.PromoteReplicaRequest, dict]]):

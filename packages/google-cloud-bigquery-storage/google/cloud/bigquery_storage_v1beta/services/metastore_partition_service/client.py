...
from google.cloud.bigquery_storage_v1beta._compat import (
    get_api_endpoint,
...
class MetastorePartitionServiceClient(metaclass=MetastorePartitionServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=MetastorePartitionServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def batch_create_metastore_partitions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_storage_v1beta.types.BatchCreateMetastorePartitionsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.batch_create_metastore_partitions
        ]
    ...
    def batch_delete_metastore_partitions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_storage_v1beta.types.BatchDeleteMetastorePartitionsRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_delete_metastore_partitions
        ]
    ...
    def batch_update_metastore_partitions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_storage_v1beta.types.BatchUpdateMetastorePartitionsRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_update_metastore_partitions
        ]
    ...
    def list_metastore_partitions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_storage_v1beta.types.ListMetastorePartitionsRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_metastore_partitions
        ]
    ...
    def stream_metastore_partitions(
        self,
        requests: Optional[
            Iterator[metastore_partition.StreamMetastorePartitionsRequest]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> Iterable[metastore_partition.StreamMetastorePartitionsResponse]:
        ...
        .. code-block:: python
            ...
            def sample_stream_metastore_partitions():
                ...
                # Initialize request argument(s)
                request = bigquery_storage_v1beta.StreamMetastorePartitionsRequest(
                    parent="parent_value",
                )

                # This method expects an iterator which contains
                # 'bigquery_storage_v1beta.StreamMetastorePartitionsRequest' objects
        ...
        Args:
            requests (Iterator[google.cloud.bigquery_storage_v1beta.types.StreamMetastorePartitionsRequest]):
        ...
        Returns:
            Iterable[google.cloud.bigquery_storage_v1beta.types.StreamMetastorePartitionsResponse]:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.stream_metastore_partitions
        ]
    ...
    def __enter__(self) -> "MetastorePartitionServiceClient":
        return self

...
# source: google/cloud/bigquery_storage_v1/proto/avro.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/bigquery_storage_v1/proto/avro.proto",
...
_AVROSCHEMA = _descriptor.Descriptor(
    name="AvroSchema",
    full_name="google.cloud.bigquery.storage.v1.AvroSchema",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="schema",
            full_name="google.cloud.bigquery.storage.v1.AvroSchema.schema",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_AVROROWS = _descriptor.Descriptor(
    name="AvroRows",
    full_name="google.cloud.bigquery.storage.v1.AvroRows",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.bigquery.storage.v1.AvroRows.serialized_binary_rows",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="row_count",
            full_name="google.cloud.bigquery.storage.v1.AvroRows.row_count",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
AvroSchema = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "google.cloud.bigquery_storage_v1.proto.avro_pb2",
        "__doc__": """Avro schema.

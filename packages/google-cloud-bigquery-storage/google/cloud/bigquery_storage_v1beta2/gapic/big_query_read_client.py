...
"""Accesses the google.cloud.bigquery.storage.v1beta2 BigQueryRead API."""
...
from google.cloud.bigquery_storage_v1beta2.gapic import big_query_read_client_config
from google.cloud.bigquery_storage_v1beta2.gapic import enums
from google.cloud.bigquery_storage_v1beta2.gapic.transports import (
...
class BigQueryReadClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.bigquery.storage.v1beta2.BigQueryRead"
    ...
    def create_read_session(
        ...
        Args:
            ...
            read_session (Union[dict, ~google.cloud.bigquery_storage_v1beta2.types.ReadSession]): Required. Session to be created.
                ...
                message :class:`~google.cloud.bigquery_storage_v1beta2.types.ReadSession`
        ...
        Returns:
            A :class:`~google.cloud.bigquery_storage_v1beta2.types.ReadSession` instance.
    ...
    def split_read_stream(
        ...
        Returns:
            A :class:`~google.cloud.bigquery_storage_v1beta2.types.SplitReadStreamResponse` instance.

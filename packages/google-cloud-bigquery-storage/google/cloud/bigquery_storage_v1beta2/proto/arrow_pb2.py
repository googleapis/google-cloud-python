...
# source: google/cloud/bigquery/storage_v1beta2/proto/arrow.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/bigquery/storage_v1beta2/proto/arrow.proto",
...
_ARROWSERIALIZATIONOPTIONS_FORMAT = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="ARROW_0_14", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ARROW_0_15", index=2, number=2, serialized_options=None, type=None
        ),
    ],
...
ArrowSchema = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="google.cloud.bigquery.storage_v1beta2.proto.arrow_pb2",

...
AvroSchema = _reflection.GeneratedProtocolMessageType('AvroSchema', (_message.Message,), dict(
...
AvroRows = _reflection.GeneratedProtocolMessageType('AvroRows', (_message.Message,), dict(

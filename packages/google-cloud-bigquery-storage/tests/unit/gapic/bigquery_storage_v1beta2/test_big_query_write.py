...
from google.cloud.bigquery_storage_v1beta2.types import protobuf, storage, stream, table
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        BigQueryWriteClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "false"}):
        assert BigQueryWriteClient._read_environment_variables() == (
            False,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert BigQueryWriteClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert BigQueryWriteClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                BigQueryWriteClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        BigQueryWriteClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        BigQueryWriteClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                BigQueryWriteClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                BigQueryWriteClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(BigQueryWriteClient),
)
@mock.patch.object(
    BigQueryWriteAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(BigQueryWriteAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BigQueryWriteClient._DEFAULT_UNIVERSE
    default_endpoint = BigQueryWriteClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = BigQueryWriteClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        BigQueryWriteClient._get_api_endpoint(
    ...
    assert (
        ...
        == BigQueryWriteClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BigQueryWriteClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        BigQueryWriteClient._get_api_endpoint(None, None, default_universe, "always")
        == BigQueryWriteClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BigQueryWriteClient._get_api_endpoint(
    ...
    assert (
        BigQueryWriteClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        BigQueryWriteClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        BigQueryWriteClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        BigQueryWriteClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        BigQueryWriteClient._get_universe_domain(None, None)
        == BigQueryWriteClient._DEFAULT_UNIVERSE
    )
...
def test_big_query_write_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_create_write_stream_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.create_write_stream in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_write_stream] = (
            mock_rpc
        )
        request = {}
...
async def test_create_write_stream_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_write_stream
...
@pytest.mark.asyncio
async def test_append_rows_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.append_rows
            in client._client._transport._wrapped_methods
        )
...
def test_get_write_stream_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_write_stream] = (
            mock_rpc
        )
        request = {}
...
async def test_get_write_stream_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_write_stream
            in client._client._transport._wrapped_methods
        )
...
def test_finalize_write_stream_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.finalize_write_stream
        ...
        client._transport._wrapped_methods[client._transport.finalize_write_stream] = (
            mock_rpc
        )
        request = {}
...
async def test_finalize_write_stream_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.finalize_write_stream
            in client._client._transport._wrapped_methods
        )
...
def test_batch_commit_write_streams_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_commit_write_streams
            in client._transport._wrapped_methods
        )
...
async def test_batch_commit_write_streams_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_commit_write_streams
            in client._client._transport._wrapped_methods
        )
...
async def test_flush_rows_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.flush_rows
            in client._client._transport._wrapped_methods
        )
...
def test_write_stream_path():
    ...
    stream = "nautilus"
    expected = (
        "projects/{project}/datasets/{dataset}/tables/{table}/streams/{stream}".format(
            project=project,
            dataset=dataset,
            table=table,
            stream=stream,

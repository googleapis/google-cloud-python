...
from google.cloud.bigquery_storage_v1beta.services.metastore_partition_service import (
...
def test_metastore_partition_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery_storage_v1beta.services.metastore_partition_service.transports.MetastorePartitionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_metastore_partition_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery_storage_v1beta.services.metastore_partition_service.transports.MetastorePartitionServiceTransport.__init__"
    ) as Transport:
...
def test_metastore_partition_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigquery_storage_v1beta.services.metastore_partition_service.transports.MetastorePartitionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        MetastorePartitionServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        MetastorePartitionServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        MetastorePartitionServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
    ...
    assert (
        MetastorePartitionServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        MetastorePartitionServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert MetastorePartitionServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert MetastorePartitionServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                MetastorePartitionServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                MetastorePartitionServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(MetastorePartitionServiceClient),
)
@mock.patch.object(
    MetastorePartitionServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(MetastorePartitionServiceAsyncClient),
)
def test__get_api_endpoint():
    ...
    mock_endpoint = MetastorePartitionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        MetastorePartitionServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == MetastorePartitionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        MetastorePartitionServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        MetastorePartitionServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        MetastorePartitionServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        MetastorePartitionServiceClient._get_universe_domain(None, None)
        == MetastorePartitionServiceClient._DEFAULT_UNIVERSE
    )
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = MetastorePartitionServiceClient(credentials=cred)
...
def test_metastore_partition_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_metastore_partition_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_metastore_partition_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_metastore_partition_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_metastore_partition_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    MetastorePartitionServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(MetastorePartitionServiceClient),
)
@mock.patch.object(
    MetastorePartitionServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(MetastorePartitionServiceAsyncClient),
)
def test_metastore_partition_service_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_metastore_partition_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_metastore_partition_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_metastore_partition_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery_storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_metastore_partition_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_batch_create_metastore_partitions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.batch_create_metastore_partitions
...
async def test_batch_create_metastore_partitions_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_create_metastore_partitions
...
def test_batch_delete_metastore_partitions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_delete_metastore_partitions
            in client._transport._wrapped_methods
        )
...
async def test_batch_delete_metastore_partitions_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_delete_metastore_partitions
            in client._client._transport._wrapped_methods
        )
...
def test_batch_update_metastore_partitions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_update_metastore_partitions
            in client._transport._wrapped_methods
        )
...
async def test_batch_update_metastore_partitions_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_update_metastore_partitions
            in client._client._transport._wrapped_methods
        )
...
def test_list_metastore_partitions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_metastore_partitions
            in client._transport._wrapped_methods
        )
...
async def test_list_metastore_partitions_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_metastore_partitions
            in client._client._transport._wrapped_methods
        )
...
def test_stream_metastore_partitions(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.stream_metastore_partitions), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
    ...
    for message in response:
        assert isinstance(
            message, metastore_partition.StreamMetastorePartitionsResponse
        )
...
def test_stream_metastore_partitions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.stream_metastore_partitions
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_stream_metastore_partitions_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.stream_metastore_partitions
            in client._client._transport._wrapped_methods
        )
...
async def test_stream_metastore_partitions_async(
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(
            side_effect=[metastore_partition.StreamMetastorePartitionsResponse()]
        )
...
def test_metastore_partition_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery_storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceTransport.__init__"
    ) as Transport:
...
def test_metastore_partition_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.bigquery_storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_metastore_partition_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_metastore_partition_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_read_stream_path():
    ...
    actual = MetastorePartitionServiceClient.read_stream_path(
...
def test_common_billing_account_path():
    ...
    actual = MetastorePartitionServiceClient.common_billing_account_path(
        billing_account
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.MetastorePartitionServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = MetastorePartitionServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

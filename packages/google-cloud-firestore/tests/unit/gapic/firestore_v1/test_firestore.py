...
def test__get_default_mtls_endpoint():
    ...
    assert (
        FirestoreClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert FirestoreClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert FirestoreClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                FirestoreClient._use_client_cert_effective()

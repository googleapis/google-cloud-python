...
class TestExpressionessionMethods:
    ...
    def test_array_transform(self):
        ...
        instance = Expression.array_transform(arg1, element_alias, body)
        ...
        assert len(instance.params) == 3
        assert repr(instance) == "Value.array_transform(Constant.of('e'), BodyValue)"
        infix_instance = arg1.array_transform(element_alias, body)
        assert infix_instance == instance

    def test_array_transform_with_index(self):
        arg1 = self._make_arg("Value")
        element_alias = "e"
        index_alias = "i"
        body = self._make_arg("BodyValue")

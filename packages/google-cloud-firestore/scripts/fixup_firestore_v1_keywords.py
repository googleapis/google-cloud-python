...
class firestoreCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'run_aggregation_query': ('parent', 'structured_aggregation_query', 'transaction', 'new_transaction', 'read_time', 'mode', ),
        'run_query': ('parent', 'structured_query', 'transaction', 'new_transaction', 'read_time', 'mode', ),

...
##
# google-cloud-ftp documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-ftp",
...
htmlhelp_basename = "google-cloud-ftp-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-ftp.tex",
        "google-cloud-ftp Documentation",
        author,
        "manual",
    )
]

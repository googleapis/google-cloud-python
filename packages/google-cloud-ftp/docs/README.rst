Python Client for Cloud FTP
===========================

|preview| |pypi| |versions|

`Cloud FTP`_: A managed, cloud-native solution to move data in and out of Google Cloud by
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-ftp.svg
   :target: https://pypi.org/project/google-cloud-ftp/
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-ftp.svg
   :target: https://pypi.org/project/google-cloud-ftp/
.. _Cloud FTP: https://docs.cloud.google.com/cloud-ftp
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-ftp/latest/summary_overview
.. _Product Documentation:  https://docs.cloud.google.com/cloud-ftp
...
3. `Enable the Cloud FTP.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud FTP.:  https://docs.cloud.google.com/cloud-ftp
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-ftp/samples
...
-  Read the `Client Library Documentation`_ for Cloud FTP
   to see other available methods on the client.
-  Read the `Cloud FTP Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud FTP Product documentation:  https://docs.cloud.google.com/cloud-ftp

...
class AutokeyClient(metaclass=AutokeyClientMeta):
    ...
    def parse_key_handle_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/keyHandles/(?P<key_handle>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AutokeyClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AutokeyTransport, Callable[..., AutokeyTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AutokeyClient._read_environment_variables()
        self._client_cert_source = AutokeyClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AutokeyClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AutokeyTransport], Callable[..., AutokeyTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.kms_v1.AutokeyClient`.",
                    extra={
    ...
    def create_key_handle(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.kms_v1.types.CreateKeyHandleRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_key_handle]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_key_handle():
                ...
                # Make the request
                response = client.get_key_handle(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.kms_v1.types.GetKeyHandleRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_key_handle]
    ...
    def list_key_handles(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_key_handles]
    ...
    def __enter__(self) -> "AutokeyClient":
        return self

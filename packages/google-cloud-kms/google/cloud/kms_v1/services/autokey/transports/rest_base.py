...
class _BaseAutokeyRestTransport(AutokeyTransport):
    ...
    class _BaseCreateKeyHandle:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutokeyRestTransport._BaseCreateKeyHandle._get_unset_required_fields(query_params))
    ...
    class _BaseGetKeyHandle:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutokeyRestTransport._BaseGetKeyHandle._get_unset_required_fields(query_params))
    ...
    class _BaseListKeyHandles:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutokeyRestTransport._BaseListKeyHandles._get_unset_required_fields(query_params))

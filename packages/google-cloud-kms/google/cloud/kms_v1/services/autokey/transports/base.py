...
class AutokeyTransport(abc.ABC):
    ...
    @property
    def create_key_handle(self) -> Callable[[autokey.CreateKeyHandleRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_key_handle(self) -> Callable[[autokey.GetKeyHandleRequest], Union[autokey.KeyHandle, Awaitable[autokey.KeyHandle]]]:
        raise NotImplementedError()

    @property
    def list_key_handles(
        self,
    ) -> Callable[[autokey.ListKeyHandlesRequest], Union[autokey.ListKeyHandlesResponse, Awaitable[autokey.ListKeyHandlesResponse]]]:
        raise NotImplementedError()

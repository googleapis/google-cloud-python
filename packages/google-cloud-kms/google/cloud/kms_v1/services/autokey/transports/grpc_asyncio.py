...
class AutokeyGrpcAsyncIOTransport(AutokeyTransport):
    ...
    @property
    def create_key_handle(self) -> Callable[[autokey.CreateKeyHandleRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_key_handle(self) -> Callable[[autokey.GetKeyHandleRequest], Awaitable[autokey.KeyHandle]]:
    ...
    @property
    def list_key_handles(self) -> Callable[[autokey.ListKeyHandlesRequest], Awaitable[autokey.ListKeyHandlesResponse]]:

...
class EkmServiceGrpcAsyncIOTransport(EkmServiceTransport):
    ...
    @property
    def list_ekm_connections(self) -> Callable[[ekm_service.ListEkmConnectionsRequest], Awaitable[ekm_service.ListEkmConnectionsResponse]]:
    ...
    @property
    def get_ekm_connection(self) -> Callable[[ekm_service.GetEkmConnectionRequest], Awaitable[ekm_service.EkmConnection]]:
    ...
    @property
    def update_ekm_connection(self) -> Callable[[ekm_service.UpdateEkmConnectionRequest], Awaitable[ekm_service.EkmConnection]]:
    ...
    @property
    def get_ekm_config(self) -> Callable[[ekm_service.GetEkmConfigRequest], Awaitable[ekm_service.EkmConfig]]:
    ...
    @property
    def update_ekm_config(self) -> Callable[[ekm_service.UpdateEkmConfigRequest], Awaitable[ekm_service.EkmConfig]]:
    ...
    @property
    def verify_connectivity(self) -> Callable[[ekm_service.VerifyConnectivityRequest], Awaitable[ekm_service.VerifyConnectivityResponse]]:

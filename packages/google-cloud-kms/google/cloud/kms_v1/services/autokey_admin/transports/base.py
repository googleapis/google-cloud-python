...
class AutokeyAdminTransport(abc.ABC):
    ...
    def update_autokey_config(
        self,
    ) -> Callable[[autokey_admin.UpdateAutokeyConfigRequest], Union[autokey_admin.AutokeyConfig, Awaitable[autokey_admin.AutokeyConfig]]]:
        raise NotImplementedError()

    @property
    def get_autokey_config(
        self,
    ) -> Callable[[autokey_admin.GetAutokeyConfigRequest], Union[autokey_admin.AutokeyConfig, Awaitable[autokey_admin.AutokeyConfig]]]:
        raise NotImplementedError()
    ...
    def show_effective_autokey_config(
        ...
        Union[autokey_admin.ShowEffectiveAutokeyConfigResponse, Awaitable[autokey_admin.ShowEffectiveAutokeyConfigResponse]],
    ]:
        raise NotImplementedError()

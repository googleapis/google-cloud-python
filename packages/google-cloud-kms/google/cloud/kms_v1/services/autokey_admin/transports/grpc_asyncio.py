...
class AutokeyAdminGrpcAsyncIOTransport(AutokeyAdminTransport):
    ...
    @property
    def update_autokey_config(self) -> Callable[[autokey_admin.UpdateAutokeyConfigRequest], Awaitable[autokey_admin.AutokeyConfig]]:
    ...
    @property
    def get_autokey_config(self) -> Callable[[autokey_admin.GetAutokeyConfigRequest], Awaitable[autokey_admin.AutokeyConfig]]:
    ...
    def show_effective_autokey_config(
        self,
    ) -> Callable[[autokey_admin.ShowEffectiveAutokeyConfigRequest], Awaitable[autokey_admin.ShowEffectiveAutokeyConfigResponse]]:

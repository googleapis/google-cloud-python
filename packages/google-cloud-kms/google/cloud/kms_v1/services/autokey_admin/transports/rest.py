...
class AutokeyAdminRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[autokey_admin.GetAutokeyConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_show_effective_autokey_config(
        ...
        autokey_admin.ShowEffectiveAutokeyConfigRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def pre_update_autokey_config(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[autokey_admin.UpdateAutokeyConfigRequest, Sequence[Tuple[str, str]]]:
...
class AutokeyAdminRestTransport(AutokeyAdminTransport):
    """REST backend transport for AutokeyAdmin.
    ...
    class _GetAutokeyConfig(AutokeyAdminRestStub):
        def __hash__(self):
            return hash("GetAutokeyConfig")
    ...
    class _ShowEffectiveAutokeyConfig(AutokeyAdminRestStub):
        def __hash__(self):
            return hash("ShowEffectiveAutokeyConfig")
    ...
    class _UpdateAutokeyConfig(AutokeyAdminRestStub):
        def __hash__(self):
            return hash("UpdateAutokeyConfig")
    ...
    class _GetLocation(AutokeyAdminRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(AutokeyAdminRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(AutokeyAdminRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(AutokeyAdminRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(AutokeyAdminRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _GetOperation(AutokeyAdminRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,

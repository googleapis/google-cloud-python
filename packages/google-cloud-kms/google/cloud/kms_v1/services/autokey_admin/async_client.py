...
class AutokeyAdminAsyncClient:
    ...
    parse_autokey_config_path = staticmethod(AutokeyAdminClient.parse_autokey_config_path)
    common_billing_account_path = staticmethod(AutokeyAdminClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AutokeyAdminClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(AutokeyAdminClient.parse_common_organization_path)
    common_project_path = staticmethod(AutokeyAdminClient.common_project_path)
    parse_common_project_path = staticmethod(AutokeyAdminClient.parse_common_project_path)
    common_location_path = staticmethod(AutokeyAdminClient.common_location_path)
    parse_common_location_path = staticmethod(AutokeyAdminClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AutokeyAdminTransport, Callable[..., AutokeyAdminTransport]]] = "grpc_asyncio",
    ...
    async def update_autokey_config(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_autokey_config]
    ...
    async def get_autokey_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_autokey_config]
    ...
    async def show_effective_autokey_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.show_effective_autokey_config]

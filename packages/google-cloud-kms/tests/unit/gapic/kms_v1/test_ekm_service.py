...
def test_list_ekm_connections_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_ekm_connections] = (
            mock_rpc
        )
        request = {}
...
def test_get_ekm_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_ekm_connection] = (
            mock_rpc
        )
        request = {}
...
def test_create_ekm_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_ekm_connection] = (
            mock_rpc
        )
        request = {}
...
def test_update_ekm_connection_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_ekm_connection] = (
            mock_rpc
        )
        request = {}
...
def test_update_ekm_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_ekm_config] = (
            mock_rpc
        )
        request = {}
...
def test_verify_connectivity_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.verify_connectivity] = (
            mock_rpc
        )
        request = {}
...
def test_list_ekm_connections_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListEkmConnections,
...
def test_get_ekm_connection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetEkmConnection,
...
def test_create_ekm_connection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateEkmConnection,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("ekmConnectionId",))
...
def test_update_ekm_connection_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateEkmConnection,
...
def test_get_ekm_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetEkmConfig,
...
def test_update_ekm_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateEkmConfig,
...
def test_verify_connectivity_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseVerifyConnectivity,

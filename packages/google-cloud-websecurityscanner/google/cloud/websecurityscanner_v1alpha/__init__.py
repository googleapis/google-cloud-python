...
from .services.web_security_scanner import WebSecurityScannerAsyncClient, WebSecurityScannerClient
from .types.crawled_url import CrawledUrl
from .types.finding import Finding
from .types.finding_addon import OutdatedLibrary, ViolatingResource, VulnerableHeaders, VulnerableParameters, Xss
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.websecurityscanner_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.cloud.websecurityscanner_v1alpha")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.websecurityscanner_v1alpha"

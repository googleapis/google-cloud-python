...
class WebSecurityScannerTransport(abc.ABC):
    ...
    def create_scan_config(
        self,
    ) -> Callable[[web_security_scanner.CreateScanConfigRequest], Union[scan_config.ScanConfig, Awaitable[scan_config.ScanConfig]]]:
        raise NotImplementedError()
    ...
    def update_scan_config(
        self,
    ) -> Callable[[web_security_scanner.UpdateScanConfigRequest], Union[scan_config.ScanConfig, Awaitable[scan_config.ScanConfig]]]:
        raise NotImplementedError()

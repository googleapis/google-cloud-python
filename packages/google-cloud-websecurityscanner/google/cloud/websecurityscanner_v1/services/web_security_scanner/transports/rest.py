...
class WebSecurityScannerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_scan_config(self, response: scan_config.ScanConfig) -> scan_config.ScanConfig:
    ...
    def post_update_scan_config(self, response: scan_config.ScanConfig) -> scan_config.ScanConfig:
...
class WebSecurityScannerRestTransport(_BaseWebSecurityScannerRestTransport):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.CreateScanConfig",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.create_scan_config",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "CreateScanConfig",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.DeleteScanConfig",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.GetFinding",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "GetFinding",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.get_finding",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "GetFinding",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.GetScanConfig",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.get_scan_config",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "GetScanConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.GetScanRun",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "GetScanRun",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.get_scan_run",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "GetScanRun",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.ListCrawledUrls",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.list_crawled_urls",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "ListCrawledUrls",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.ListFindings",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.list_findings",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "ListFindings",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.ListFindingTypeStats",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.list_finding_type_stats",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "ListFindingTypeStats",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.ListScanConfigs",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.list_scan_configs",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "ListScanConfigs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.ListScanRuns",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.list_scan_runs",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "ListScanRuns",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.StartScanRun",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.start_scan_run",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "StartScanRun",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.StopScanRun",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "StopScanRun",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.stop_scan_run",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "StopScanRun",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.UpdateScanConfig",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.websecurityscanner_v1.WebSecurityScannerClient.update_scan_config",
                    extra={
                        "serviceName": "google.cloud.websecurityscanner.v1.WebSecurityScanner",
                        "rpcName": "UpdateScanConfig",
                        "metadata": http_response["headers"],
    ...
    @property
    def create_scan_config(self) -> Callable[[web_security_scanner.CreateScanConfigRequest], scan_config.ScanConfig]:
    ...
    @property
    def update_scan_config(self) -> Callable[[web_security_scanner.UpdateScanConfigRequest], scan_config.ScanConfig]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

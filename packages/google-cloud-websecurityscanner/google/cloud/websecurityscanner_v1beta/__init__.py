...
from .types.finding_addon import Form, OutdatedLibrary, ViolatingResource, VulnerableHeaders, VulnerableParameters, Xss
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.websecurityscanner_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.cloud.websecurityscanner_v1beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.websecurityscanner_v1beta"

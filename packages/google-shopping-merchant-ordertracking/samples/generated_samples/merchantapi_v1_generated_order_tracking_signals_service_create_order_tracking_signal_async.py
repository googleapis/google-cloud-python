...
from google.shopping import merchant_ordertracking_v1


async def sample_create_order_tracking_signal():
    # Create a client
    client = merchant_ordertracking_v1.OrderTrackingSignalsServiceAsyncClient()

    # Initialize request argument(s)
    order_tracking_signal = merchant_ordertracking_v1.OrderTrackingSignal()
    ...
    request = merchant_ordertracking_v1.CreateOrderTrackingSignalRequest(
        parent="parent_value",

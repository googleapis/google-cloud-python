...
class AppOptimizeTransport(abc.ABC):
    """Abstract transport class for AppOptimize."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "appoptimize.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.read_report: gapic_v1.method.wrap_method(
                self.read_report,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
    ...
    def get_report(
        ...
        Union[app_optimize.Report, Awaitable[app_optimize.Report]],
    ]:
        raise NotImplementedError()
    ...
    def list_reports(
        ...
        Union[
            ...
            Awaitable[app_optimize.ListReportsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def read_report(
        ...
        Union[
            app_optimize.ReadReportResponse, Awaitable[app_optimize.ReadReportResponse]
        ],
    ]:
        raise NotImplementedError()

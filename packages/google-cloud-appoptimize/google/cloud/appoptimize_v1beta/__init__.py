...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.appoptimize_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.cloud.appoptimize_v1beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.appoptimize_v1beta"

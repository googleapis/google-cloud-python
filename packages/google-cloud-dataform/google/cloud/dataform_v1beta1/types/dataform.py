...
class CompilationResultAction(proto.Message):
    ...
    Attributes:
        ...
        notebook (google.cloud.dataform_v1beta1.types.CompilationResultAction.Notebook):
            ...
            This field is a member of `oneof`_ ``compiled_object``.
        data_preparation (google.cloud.dataform_v1beta1.types.CompilationResultAction.DataPreparation):
    ...
    class Relation(proto.Message):
        ...
        Attributes:
            ...
            table_format (google.cloud.dataform_v1beta1.types.CompilationResultAction.Relation.TableFormat):
                Optional. The table format for the BigQuery
                table.
            file_format (google.cloud.dataform_v1beta1.types.CompilationResultAction.Relation.FileFormat):
        ...
        class SqlDefinition(proto.Message):
            ...
            Attributes:
                query (str):
                    ...
                    statement.
                error_table (google.cloud.dataform_v1beta1.types.CompilationResultAction.DataPreparation.ErrorTable):
                    Error table configuration,
                load (google.cloud.dataform_v1beta1.types.CompilationResultAction.LoadConfig):
                    Load configuration.
            """
    ...
    class LoadConfig(proto.Message):
        ...
        Attributes:
            replace (google.cloud.dataform_v1beta1.types.CompilationResultAction.SimpleLoadMode):
                Replace destination table

                This field is a member of `oneof`_ ``mode``.
            append (google.cloud.dataform_v1beta1.types.CompilationResultAction.SimpleLoadMode):
                Append into destination table

                This field is a member of `oneof`_ ``mode``.
            maximum (google.cloud.dataform_v1beta1.types.CompilationResultAction.IncrementalLoadMode):
                Insert records where the value exceeds the
                previous maximum value for a column in the
                destination table

                This field is a member of `oneof`_ ``mode``.
            unique (google.cloud.dataform_v1beta1.types.CompilationResultAction.IncrementalLoadMode):
    ...
    class DataPreparationAction(proto.Message):
        ...
        Attributes:
            contents_yaml (str):
                ...
                This field is a member of `oneof`_ ``definition``.
            contents_sql (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionSqlDefinition):
                SQL definition for a Data Preparation.
                Contains a SQL query and additional context
                information.
        ...
        class ActionSqlDefinition(proto.Message):
            ...
            Attributes:
                query (str):
                    ...
                    preparation steps. Formatted as a Pipe SQL query
                    statement.
                error_table (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionErrorTable):
                    Error table configuration,
                load_config (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionLoadConfig):
                    Load configuration.
            """
        ...
        class ActionLoadConfig(proto.Message):
            ...
            Attributes:
                replace (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionSimpleLoadMode):
                    Replace destination table

                    This field is a member of `oneof`_ ``mode``.
                append (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionSimpleLoadMode):
                    Append into destination table

                    This field is a member of `oneof`_ ``mode``.
                maximum (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionIncrementalLoadMode):
                    Insert records where the value exceeds the
                    previous maximum value for a column in the
                    destination table

                    This field is a member of `oneof`_ ``mode``.
                unique (google.cloud.dataform_v1beta1.types.WorkflowInvocationAction.DataPreparationAction.ActionIncrementalLoadMode):
                    Insert records where the value of a column is
                    not already present in the destination table
...
class QueryFolderContentsResponse(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.dataform_v1beta1.types.QueryFolderContentsResponse.FolderContentsEntry]):
...
class QueryUserRootContentsResponse(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.dataform_v1beta1.types.QueryUserRootContentsResponse.RootContentsEntry]):
            List of entries in the folder.
        next_page_token (str):
            A token, which can be sent as ``page_token`` to retrieve the
            next page. If this field is omitted, there are no subsequent
...
class CreateTeamFolderRequest(proto.Message):
    ...
    team_folder_id: str = proto.Field(
        proto.STRING,
        number=3,
    )
...
class QueryTeamFolderContentsResponse(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.dataform_v1beta1.types.QueryTeamFolderContentsResponse.TeamFolderContentsEntry]):
...
class SearchTeamFoldersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.cloud.dataform_v1beta1.types.SearchTeamFoldersResponse.TeamFolderSearchResult]):
...
class MoveFolderMetadata(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.dataform_v1beta1.types.MoveFolderMetadata.State):
...
class MoveRepositoryMetadata(proto.Message):
    ...
    Attributes:
        ...
        target (str):
            Output only. Server-defined resource path for
            the target of the operation.
        state (google.cloud.dataform_v1beta1.types.MoveRepositoryMetadata.State):
            The state of the move.
        percent_complete (int):
            Percent complete of the move [0, 100].
    """

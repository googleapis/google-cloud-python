...
class DataformAsyncClient:
    ...
    async def delete_team_folder_tree(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.DeleteTeamFolderTreeRequest, dict]]):
    ...
    async def delete_folder_tree(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.DeleteFolderTreeRequest, dict]]):
    ...
    async def delete_repository_long_running(
        self,
        request: Optional[
            Union[dataform.DeleteRepositoryLongRunningRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        force: Optional[bool] = None,
        ...
        .. code-block:: python
            ...
            async def sample_delete_repository_long_running():
                # Create a client
                client = dataform_v1beta1.DataformAsyncClient()
                ...
                # Make the request
                operation = await client.delete_repository_long_running(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.DeleteRepositoryLongRunningRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                should not be set.
            force (:class:`bool`):
                Optional. If set to true, child resources of this
                repository (compilation results and workflow
                invocations) will also be deleted. Otherwise, the
                request will only succeed if the repository has no child
                resources.

                **Note:** *This flag doesn't support deletion of
                workspaces, release configs or workflow configs. If any
                of such resources exists in the repository, the request
                will fail.*
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.dataform_v1beta1.types.DeleteRepositoryLongRunningResponse`
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, dataform.DeleteRepositoryLongRunningRequest):
            request = dataform.DeleteRepositoryLongRunningRequest(request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_repository_long_running
        ]
        ...
        response = operation_async.from_gapic(
            response,
            self._client._transport.operations_client,
            dataform.DeleteRepositoryLongRunningResponse,
            metadata_type=dataform.DeleteRepositoryLongRunningMetadata,
        )
    ...
    async def sync_workspace_refs(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.SyncWorkspaceRefsRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.sync_workspace_refs
        ]
    ...
    async def fetch_workspace_branches(
        self,
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.FetchWorkspaceBranchesAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_fetch_workspace_branches():
                # Create a client
                client = dataform_v1beta1.DataformAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.FetchWorkspaceBranchesRequest, dict]]):
        ...
        Returns:
            google.cloud.dataform_v1beta1.services.dataform.pagers.FetchWorkspaceBranchesAsyncPager:
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.fetch_workspace_branches
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.FetchWorkspaceBranchesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def delete_branch(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.DeleteBranchRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_branch
        ]
    ...
    async def checkout_workspace_branch(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.CheckoutWorkspaceBranchRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.checkout_workspace_branch
        ]
    ...
    async def fetch_current_workspace_branch(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataform_v1beta1.types.FetchCurrentWorkspaceBranchRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.fetch_current_workspace_branch
        ]

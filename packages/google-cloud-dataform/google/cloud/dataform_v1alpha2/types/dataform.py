...
class Repository(proto.Message):
    ...
    class GitRemoteSettings(proto.Message):
        ...
        Attributes:
            ...
            token_status (google.cloud.dataform_v1alpha2.types.Repository.GitRemoteSettings.TokenStatus):
...
class ListRepositoriesResponse(proto.Message):
    ...
    Attributes:
        repositories (Sequence[google.cloud.dataform_v1alpha2.types.Repository]):
...
class ListWorkspacesResponse(proto.Message):
    ...
    Attributes:
        workspaces (Sequence[google.cloud.dataform_v1alpha2.types.Workspace]):
            List of workspaces.
        next_page_token (str):
            A token, which can be sent as ``page_token`` to retrieve the
            next page. If this field is omitted, there are no subsequent
...
class PullGitCommitsRequest(proto.Message):
    ...
    Attributes:
        ...
        remote_branch (str):
            ...
            be used.
        author (google.cloud.dataform_v1alpha2.types.CommitAuthor):
...
class FetchFileGitStatusesResponse(proto.Message):
    ...
    class UncommittedFileChange(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.dataform_v1alpha2.types.FetchFileGitStatusesResponse.UncommittedFileChange.State):
...
class QueryDirectoryContentsResponse(proto.Message):
    ...
    Attributes:
        directory_entries (Sequence[google.cloud.dataform_v1alpha2.types.QueryDirectoryContentsResponse.DirectoryEntry]):
...
class CompilationResult(proto.Message):
    ...
    Attributes:
        ...
        workspace (str):
            ...
            This field is a member of `oneof`_ ``source``.
        code_compilation_config (google.cloud.dataform_v1alpha2.types.CompilationResult.CodeCompilationConfig):
        ...
        dataform_core_version (str):
            ...
            for compilation.
        compilation_errors (Sequence[google.cloud.dataform_v1alpha2.types.CompilationResult.CompilationError]):
    ...
    class CompilationError(proto.Message):
        ...
        Attributes:
            ...
            path (str):
                ...
                project root.
            action_target (google.cloud.dataform_v1alpha2.types.Target):
...
class RelationDescriptor(proto.Message):
    ...
    Attributes:
        ...
        columns (Sequence[google.cloud.dataform_v1alpha2.types.RelationDescriptor.ColumnDescriptor]):
...
class CompilationResultAction(proto.Message):
    ...
    Attributes:
        target (google.cloud.dataform_v1alpha2.types.Target):
            This action's identifier. Unique within the
            compilation result.
        canonical_target (google.cloud.dataform_v1alpha2.types.Target):
        ...
        file_path (str):
            ...
            workspace root.
        relation (google.cloud.dataform_v1alpha2.types.CompilationResultAction.Relation):
            The database relation created/updated by this
            action.

            This field is a member of `oneof`_ ``compiled_object``.
        operations (google.cloud.dataform_v1alpha2.types.CompilationResultAction.Operations):
            The database operations executed by this
            action.

            This field is a member of `oneof`_ ``compiled_object``.
        assertion (google.cloud.dataform_v1alpha2.types.CompilationResultAction.Assertion):
            The assertion executed by this action.

            This field is a member of `oneof`_ ``compiled_object``.
        declaration (google.cloud.dataform_v1alpha2.types.CompilationResultAction.Declaration):
    ...
    class Relation(proto.Message):
        ...
        Attributes:
            dependency_targets (Sequence[google.cloud.dataform_v1alpha2.types.Target]):
            ...
            relation_descriptor (google.cloud.dataform_v1alpha2.types.RelationDescriptor):
                Descriptor for the relation and its columns.
            relation_type (google.cloud.dataform_v1alpha2.types.CompilationResultAction.Relation.RelationType):
            ...
            post_operations (Sequence[str]):
                ...
                the relation.
            incremental_table_config (google.cloud.dataform_v1alpha2.types.CompilationResultAction.Relation.IncrementalTableConfig):
    ...
    class Assertion(proto.Message):
        ...
        Attributes:
            dependency_targets (Sequence[google.cloud.dataform_v1alpha2.types.Target]):
                A list of actions that this action depends
                on.
            parent_action (google.cloud.dataform_v1alpha2.types.Target):
...
class QueryCompilationResultActionsResponse(proto.Message):
    ...
    Attributes:
        compilation_result_actions (Sequence[google.cloud.dataform_v1alpha2.types.CompilationResultAction]):
...
class WorkflowInvocation(proto.Message):
    ...
    Attributes:
        ...
        invocation_config (google.cloud.dataform_v1alpha2.types.WorkflowInvocation.InvocationConfig):
            Immutable. If left unset, a default
            InvocationConfig will be used.
        state (google.cloud.dataform_v1alpha2.types.WorkflowInvocation.State):
    ...
    class InvocationConfig(proto.Message):
        ...
        Attributes:
            included_targets (Sequence[google.cloud.dataform_v1alpha2.types.Target]):
...
class ListWorkflowInvocationsResponse(proto.Message):
    ...
    Attributes:
        workflow_invocations (Sequence[google.cloud.dataform_v1alpha2.types.WorkflowInvocation]):
...
class WorkflowInvocationAction(proto.Message):
    ...
    Attributes:
        ...
        bigquery_action (google.cloud.dataform_v1alpha2.types.WorkflowInvocationAction.BigQueryAction):
...
class QueryWorkflowInvocationActionsResponse(proto.Message):
    ...
    Attributes:
        workflow_invocation_actions (Sequence[google.cloud.dataform_v1alpha2.types.WorkflowInvocationAction]):

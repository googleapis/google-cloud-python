...
class DataformClient(metaclass=DataformClientMeta):
        ...
        *,
        ...
        Args:
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            repository (google.cloud.dataform_v1alpha2.types.Repository):
    ...
    def list_workspaces(
        ...
        *,
        ...
        Returns:
            google.cloud.dataform_v1alpha2.services.dataform.pagers.ListWorkspacesPager:
    ...
    def list_compilation_results(
        ...
        *,
        ...
        Returns:
            google.cloud.dataform_v1alpha2.services.dataform.pagers.ListCompilationResultsPager:
        ...
        *,
        ...
        Args:
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            compilation_result (google.cloud.dataform_v1alpha2.types.CompilationResult):
    ...
    def query_compilation_result_actions(
        ...
        *,
        ...
        Returns:
            google.cloud.dataform_v1alpha2.services.dataform.pagers.QueryCompilationResultActionsPager:
    ...
    def list_workflow_invocations(
        ...
        *,
        ...
        Returns:
            google.cloud.dataform_v1alpha2.services.dataform.pagers.ListWorkflowInvocationsPager:
    ...
    def query_workflow_invocation_actions(
        ...
        *,
        ...
        Returns:
            google.cloud.dataform_v1alpha2.services.dataform.pagers.QueryWorkflowInvocationActionsPager:

...
from google.cloud.dataform_v1._compat import (
    get_api_endpoint,
...
class DataformClient(metaclass=DataformClientMeta):
    ...
    def folder_path(
        ...
        return "projects/{project}/locations/{location}/folders/{folder}".format(
            project=project,
            location=location,
            folder=folder,
        )
    ...
    def parse_folder_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/folders/(?P<folder>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def parse_team_folder_path(path: str) -> Dict[str, str]:
        """Parses a team_folder path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/teamFolders/(?P<team_folder>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dataform_v1.DataformClient`.",
                    extra={
    ...
    def get_team_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetTeamFolderRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_team_folder]
    ...
    def create_team_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateTeamFolderRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_team_folder]
    ...
    def update_team_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.UpdateTeamFolderRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_team_folder]
    ...
    def delete_team_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteTeamFolderRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_team_folder]
    ...
    def delete_team_folder_tree(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteTeamFolderTreeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_team_folder_tree]
    ...
    def query_team_folder_contents(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.QueryTeamFolderContentsPager:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.query_team_folder_contents
        ]
        ...
        response = pagers.QueryTeamFolderContentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def search_team_folders(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.SearchTeamFoldersRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_team_folders]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.SearchTeamFoldersPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetFolderRequest, dict]):
    ...
    def create_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateFolderRequest, dict]):
    ...
    def update_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.UpdateFolderRequest, dict]):
    ...
    def delete_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteFolderRequest, dict]):
    ...
    def delete_folder_tree(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteFolderTreeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_folder_tree]
    ...
    def query_folder_contents(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.QueryFolderContentsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_folder_contents]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.QueryFolderContentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def query_user_root_contents(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.QueryUserRootContentsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_user_root_contents]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.QueryUserRootContentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def move_folder(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.MoveFolderRequest, dict]):
    ...
    def list_repositories(
        ...
        **Note:** *This method can return repositories not shown in the*
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ListRepositoriesRequest, dict]):
    ...
    def get_repository(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetRepositoryRequest, dict]):
    ...
    def create_repository(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateRepositoryRequest, dict]):
    ...
    def update_repository(
        ...
        **Note:** *This method does not fully
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.UpdateRepositoryRequest, dict]):
    ...
    def delete_repository(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteRepositoryRequest, dict]):
    ...
    def move_repository(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.MoveRepositoryRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.move_repository]
    ...
    def commit_repository_changes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CommitRepositoryChangesRequest, dict]):
    ...
    def read_repository_file(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ReadRepositoryFileRequest, dict]):
    ...
    def query_repository_directory_contents(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.QueryRepositoryDirectoryContentsRequest, dict]):
    ...
    def fetch_repository_history(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.FetchRepositoryHistoryRequest, dict]):
    ...
    def compute_repository_access_token_status(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ComputeRepositoryAccessTokenStatusRequest, dict]):
    ...
    def fetch_remote_branches(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.FetchRemoteBranchesRequest, dict]):
    ...
    def list_workspaces(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ListWorkspacesRequest, dict]):
    ...
    def get_workspace(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetWorkspaceRequest, dict]):
    ...
    def create_workspace(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateWorkspaceRequest, dict]):
    ...
    def delete_workspace(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteWorkspaceRequest, dict]):
    ...
    def install_npm_packages(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.InstallNpmPackagesRequest, dict]):
    ...
    def pull_git_commits(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.PullGitCommitsRequest, dict]):
    ...
    def push_git_commits(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.PushGitCommitsRequest, dict]):
    ...
    def fetch_file_git_statuses(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.FetchFileGitStatusesRequest, dict]):
    ...
    def fetch_git_ahead_behind(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.FetchGitAheadBehindRequest, dict]):
    ...
    def commit_workspace_changes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CommitWorkspaceChangesRequest, dict]):
    ...
    def reset_workspace_changes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ResetWorkspaceChangesRequest, dict]):
    ...
    def fetch_file_diff(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.FetchFileDiffRequest, dict]):
    ...
    def query_directory_contents(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.QueryDirectoryContentsRequest, dict]):
    ...
    def search_files(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.SearchFilesRequest, dict]):
    ...
    def make_directory(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.MakeDirectoryRequest, dict]):
    ...
    def remove_directory(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.RemoveDirectoryRequest, dict]):
    ...
    def move_directory(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.MoveDirectoryRequest, dict]):
    ...
    def read_file(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ReadFileRequest, dict]):
    ...
    def remove_file(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.RemoveFileRequest, dict]):
    ...
    def move_file(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.MoveFileRequest, dict]):
    ...
    def write_file(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.WriteFileRequest, dict]):
    ...
    def list_release_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ListReleaseConfigsRequest, dict]):
    ...
    def get_release_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetReleaseConfigRequest, dict]):
    ...
    def create_release_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateReleaseConfigRequest, dict]):
    ...
    def update_release_config(
        ...
        **Note:** *This method does not fully
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.UpdateReleaseConfigRequest, dict]):
    ...
    def delete_release_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteReleaseConfigRequest, dict]):
    ...
    def list_compilation_results(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ListCompilationResultsRequest, dict]):
    ...
    def get_compilation_result(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetCompilationResultRequest, dict]):
    ...
    def create_compilation_result(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateCompilationResultRequest, dict]):
    ...
    def query_compilation_result_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.QueryCompilationResultActionsRequest, dict]):
    ...
    def list_workflow_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ListWorkflowConfigsRequest, dict]):
    ...
    def get_workflow_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetWorkflowConfigRequest, dict]):
    ...
    def create_workflow_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateWorkflowConfigRequest, dict]):
    ...
    def update_workflow_config(
        ...
        **Note:** *This method does not fully
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.UpdateWorkflowConfigRequest, dict]):
    ...
    def delete_workflow_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteWorkflowConfigRequest, dict]):
    ...
    def list_workflow_invocations(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.ListWorkflowInvocationsRequest, dict]):
    ...
    def get_workflow_invocation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetWorkflowInvocationRequest, dict]):
    ...
    def create_workflow_invocation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CreateWorkflowInvocationRequest, dict]):
    ...
    def delete_workflow_invocation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.DeleteWorkflowInvocationRequest, dict]):
    ...
    def cancel_workflow_invocation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.CancelWorkflowInvocationRequest, dict]):
    ...
    def query_workflow_invocation_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.QueryWorkflowInvocationActionsRequest, dict]):
    ...
    def get_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.GetConfigRequest, dict]):
    ...
    def update_config(
        ...
        **Note:** *This method does not fully
        ...
        Args:
            request (Union[google.cloud.dataform_v1.types.UpdateConfigRequest, dict]):

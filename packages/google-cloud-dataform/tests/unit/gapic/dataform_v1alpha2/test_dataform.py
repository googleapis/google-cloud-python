...
from google.cloud.dataform_v1alpha2.services.dataform import DataformClient
from google.cloud.dataform_v1alpha2.services.dataform import pagers
from google.cloud.dataform_v1alpha2.services.dataform import transports
...
def test_dataform_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dataform_v1alpha2.services.dataform.transports.DataformGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_dataform_base_transport():
    ...
    with mock.patch(
        "google.cloud.dataform_v1alpha2.services.dataform.transports.DataformTransport.__init__"
    ) as Transport:
...
def test_dataform_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dataform_v1alpha2.services.dataform.transports.DataformTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

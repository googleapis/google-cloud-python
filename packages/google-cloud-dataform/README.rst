Python Client for Dataform API
==============================

|preview| |pypi| |versions|

`Dataform API`_: Service to develop, version control, and operationalize SQL pipelines in BigQuery.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-dataform.svg
   :target: https://pypi.org/project/google-cloud-dataform/
.. _Dataform API: https://cloud.google.com/dataform/docs/overview
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/dataform/latest/summary_overview
.. _Product Documentation:  https://cloud.google.com/dataform/docs/overview
...
3. `Enable the Dataform API.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Dataform API.:  https://cloud.google.com/dataform/docs/overview
...
-  Read the `Client Library Documentation`_ for Dataform API
   to see other available methods on the client.
-  Read the `Dataform API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Dataform API Product documentation:  https://cloud.google.com/dataform/docs/overview

...
class ImageServiceGrpcTransport(ImageServiceTransport):
    """gRPC backend transport for ImageService.
    ...
    def generate_product_image_background(
        ...
        if "generate_product_image_background" not in self._stubs:
            self._stubs["generate_product_image_background"] = (
    ...
    def remove_product_image_background(
        ...
        if "remove_product_image_background" not in self._stubs:
            self._stubs["remove_product_image_background"] = (
                self._logged_channel.unary_unary(
...
__all__ = ("ImageServiceGrpcTransport",)

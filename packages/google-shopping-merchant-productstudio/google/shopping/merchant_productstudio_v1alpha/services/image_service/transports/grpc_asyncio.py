...
from .base import DEFAULT_CLIENT_INFO, ImageServiceTransport
...
class ImageServiceGrpcAsyncIOTransport(ImageServiceTransport):
    ...
    def generate_product_image_background(
        self,
    ) -> Callable[[image.GenerateProductImageBackgroundRequest], Awaitable[image.GenerateProductImageBackgroundResponse]]:
    ...
    def remove_product_image_background(
        self,
    ) -> Callable[[image.RemoveProductImageBackgroundRequest], Awaitable[image.RemoveProductImageBackgroundResponse]]:
    ...
    @property
    def upscale_product_image(self) -> Callable[[image.UpscaleProductImageRequest], Awaitable[image.UpscaleProductImageResponse]]:
...
__all__ = ("ImageServiceGrpcAsyncIOTransport",)

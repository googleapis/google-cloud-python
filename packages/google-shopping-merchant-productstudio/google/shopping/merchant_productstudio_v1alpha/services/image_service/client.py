...
from .transports.grpc import ImageServiceGrpcTransport
from .transports.grpc_asyncio import ImageServiceGrpcAsyncIOTransport
from .transports.rest import ImageServiceRestTransport


class ImageServiceClientMeta(type):
    """Metaclass for the ImageService client.
...
class ImageServiceClient(metaclass=ImageServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ImageServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ImageServiceTransport:
        ...
        Returns:
            ImageServiceTransport: The transport used by the client
                instance.
        """
    ...
    def generated_image_path(
        ...
        """Returns a fully-qualified generated_image string."""
        return "accounts/{account}/generatedImages/{generated_image}".format(
            account=account,
            generated_image=generated_image,
        )

    @staticmethod
    def parse_generated_image_path(path: str) -> Dict[str, str]:
        """Parses a generated_image path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/generatedImages/(?P<generated_image>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ImageServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ImageServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ImageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ImageServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ImageServiceTransport, Callable[..., ImageServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the image service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ImageServiceClient._read_environment_variables()
        self._client_cert_source = ImageServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ImageServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ImageServiceTransport)
        if transport_provided:
            # transport is a ImageServiceTransport instance.
            ...
            self._transport = cast(ImageServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ImageServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ImageServiceTransport], Callable[..., ImageServiceTransport]] = (
                ImageServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ImageServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.productstudio_v1alpha.ImageServiceClient`.",
                    extra={
    ...
    def generate_product_image_background(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_productstudio_v1alpha.types.GenerateProductImageBackgroundRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.generate_product_image_background]
    ...
    def remove_product_image_background(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_productstudio_v1alpha.types.RemoveProductImageBackgroundRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_product_image_background]
    ...
    def upscale_product_image(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_productstudio_v1alpha.types.UpscaleProductImageRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.upscale_product_image]
    ...
    def __enter__(self) -> "ImageServiceClient":
        return self

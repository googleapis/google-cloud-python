...
class ImageServiceClient(metaclass=ImageServiceClientMeta):
    ...
    def parse_generated_image_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/generatedImages/(?P<generated_image>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ImageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            ImageServiceClient._read_environment_variables()
        )
        self._client_cert_source = ImageServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ImageServiceClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ImageServiceTransport], Callable[..., ImageServiceTransport]
            ] = (
    ...
    def generate_product_image_background(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.generate_product_image_background
        ]
    ...
    def remove_product_image_background(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.remove_product_image_background
        ]

...
from .services.text_suggestions_service import TextSuggestionsServiceAsyncClient, TextSuggestionsServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.shopping.merchant_productstudio_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.shopping.merchant_productstudio_v1alpha")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.shopping.merchant_productstudio_v1alpha"

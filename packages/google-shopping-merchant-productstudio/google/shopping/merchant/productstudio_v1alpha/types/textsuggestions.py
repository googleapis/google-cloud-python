...
class GenerateProductTextSuggestionsRequest(proto.Message):
    ...
    Attributes:
        ...
        product_info (google.shopping.merchant.productstudio_v1alpha.types.ProductInfo):
            Required. Available information about the
            product. Used to inform the genAI models.
        output_spec (google.shopping.merchant.productstudio_v1alpha.types.OutputSpec):
        ...
        title_examples (MutableSequence[google.shopping.merchant.productstudio_v1alpha.types.TitleExample]):
...
class GenerateProductTextSuggestionsResponse(proto.Message):
    ...
    Attributes:
        title (google.shopping.merchant.productstudio_v1alpha.types.ProductTextGenerationSuggestion):
            Generated title suggestion.

            This field is a member of `oneof`_ ``_title``.
        description (google.shopping.merchant.productstudio_v1alpha.types.ProductTextGenerationSuggestion):
            Generated description suggestion.

            This field is a member of `oneof`_ ``_description``.
        attributes (MutableMapping[str, str]):
            Any other generated attributes.
        metadata (google.shopping.merchant.productstudio_v1alpha.types.ProductTextGenerationMetadata):
...
class ProductInfo(proto.Message):
    ...
    Attributes:
        ...
        product_image (google.shopping.merchant.productstudio_v1alpha.types.Image):

...
from .services.marketingplatform_admin_service import MarketingplatformAdminServiceAsyncClient, MarketingplatformAdminServiceClient
...
from .types.resources import AnalyticsAccountLink, AnalyticsPropertyType, AnalyticsServiceLevel, LinkVerificationState, Organization

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.ads.marketingplatform_admin_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.ads.marketingplatform_admin_v1alpha")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.ads.marketingplatform_admin_v1alpha"

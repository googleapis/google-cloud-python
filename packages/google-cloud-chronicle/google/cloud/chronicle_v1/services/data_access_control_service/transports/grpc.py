...
class DataAccessControlServiceGrpcTransport(DataAccessControlServiceTransport):
    """gRPC backend transport for DataAccessControlService.
    ...
    def create_data_access_label(
        ...
        Returns:
            Callable[[~.CreateDataAccessLabelRequest],
                    ~.DataAccessLabel]:
        ...
        if "create_data_access_label" not in self._stubs:
            self._stubs["create_data_access_label"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/CreateDataAccessLabel",
                request_serializer=data_access_control.CreateDataAccessLabelRequest.serialize,
                response_deserializer=data_access_control.DataAccessLabel.deserialize,
            )
    ...
    def get_data_access_label(
        ...
        Returns:
            Callable[[~.GetDataAccessLabelRequest],
                    ~.DataAccessLabel]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_data_access_label" not in self._stubs:
            self._stubs["get_data_access_label"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/GetDataAccessLabel",
                request_serializer=data_access_control.GetDataAccessLabelRequest.serialize,
                response_deserializer=data_access_control.DataAccessLabel.deserialize,
            )
        return self._stubs["get_data_access_label"]
    ...
    def list_data_access_labels(
        ...
        Returns:
            Callable[[~.ListDataAccessLabelsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_data_access_labels" not in self._stubs:
            self._stubs["list_data_access_labels"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/ListDataAccessLabels",
                request_serializer=data_access_control.ListDataAccessLabelsRequest.serialize,
                response_deserializer=data_access_control.ListDataAccessLabelsResponse.deserialize,
            )
    ...
    def update_data_access_label(
        ...
        Returns:
            Callable[[~.UpdateDataAccessLabelRequest],
                    ~.DataAccessLabel]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_data_access_label" not in self._stubs:
            self._stubs["update_data_access_label"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/UpdateDataAccessLabel",
                request_serializer=data_access_control.UpdateDataAccessLabelRequest.serialize,
                response_deserializer=data_access_control.DataAccessLabel.deserialize,
            )
    ...
    def delete_data_access_label(
        ...
        Returns:
            Callable[[~.DeleteDataAccessLabelRequest],
                    ~.Empty]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_data_access_label" not in self._stubs:
            self._stubs["delete_data_access_label"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/DeleteDataAccessLabel",
                request_serializer=data_access_control.DeleteDataAccessLabelRequest.serialize,
    ...
    def create_data_access_scope(
        ...
        Returns:
            Callable[[~.CreateDataAccessScopeRequest],
                    ~.DataAccessScope]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_data_access_scope" not in self._stubs:
            self._stubs["create_data_access_scope"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/CreateDataAccessScope",
                request_serializer=data_access_control.CreateDataAccessScopeRequest.serialize,
                response_deserializer=data_access_control.DataAccessScope.deserialize,
            )
    ...
    def get_data_access_scope(
        ...
        Returns:
            Callable[[~.GetDataAccessScopeRequest],
                    ~.DataAccessScope]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_data_access_scope" not in self._stubs:
            self._stubs["get_data_access_scope"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/GetDataAccessScope",
                request_serializer=data_access_control.GetDataAccessScopeRequest.serialize,
                response_deserializer=data_access_control.DataAccessScope.deserialize,
            )
        return self._stubs["get_data_access_scope"]
    ...
    def list_data_access_scopes(
        ...
        Returns:
            Callable[[~.ListDataAccessScopesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_data_access_scopes" not in self._stubs:
            self._stubs["list_data_access_scopes"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/ListDataAccessScopes",
                request_serializer=data_access_control.ListDataAccessScopesRequest.serialize,
                response_deserializer=data_access_control.ListDataAccessScopesResponse.deserialize,
            )
    ...
    def update_data_access_scope(
        ...
        Returns:
            Callable[[~.UpdateDataAccessScopeRequest],
                    ~.DataAccessScope]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_data_access_scope" not in self._stubs:
            self._stubs["update_data_access_scope"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/UpdateDataAccessScope",
                request_serializer=data_access_control.UpdateDataAccessScopeRequest.serialize,
                response_deserializer=data_access_control.DataAccessScope.deserialize,
            )
    ...
    def delete_data_access_scope(
        ...
        Returns:
            Callable[[~.DeleteDataAccessScopeRequest],
                    ~.Empty]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_data_access_scope" not in self._stubs:
            self._stubs["delete_data_access_scope"] = self._logged_channel.unary_unary(
                "/google.cloud.chronicle.v1.DataAccessControlService/DeleteDataAccessScope",
                request_serializer=data_access_control.DeleteDataAccessScopeRequest.serialize,
                response_deserializer=empty_pb2.Empty.FromString,
            )
        return self._stubs["delete_data_access_scope"]
...
__all__ = ("DataAccessControlServiceGrpcTransport",)

...
class DataAccessControlServiceTransport(abc.ABC):
    """Abstract transport class for DataAccessControlService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_data_access_label: gapic_v1.method.wrap_method(
                self.create_data_access_label,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_data_access_label: gapic_v1.method.wrap_method(
                self.get_data_access_label,
            ...
            self.list_data_access_labels: gapic_v1.method.wrap_method(
                self.list_data_access_labels,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.update_data_access_label: gapic_v1.method.wrap_method(
                self.update_data_access_label,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_data_access_label: gapic_v1.method.wrap_method(
                self.delete_data_access_label,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_data_access_scope: gapic_v1.method.wrap_method(
                self.create_data_access_scope,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_data_access_scope: gapic_v1.method.wrap_method(
                self.get_data_access_scope,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.list_data_access_scopes: gapic_v1.method.wrap_method(
                self.list_data_access_scopes,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.update_data_access_scope: gapic_v1.method.wrap_method(
                self.update_data_access_scope,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_data_access_scope: gapic_v1.method.wrap_method(
                self.delete_data_access_scope,
                default_timeout=60.0,
                client_info=client_info,
            ),
...
__all__ = ("DataAccessControlServiceTransport",)

...
class DataAccessControlServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[DataAccessControlServiceTransport]]
...
class DataAccessControlServiceClient(metaclass=DataAccessControlServiceClientMeta):
    ...
    def parse_data_access_label_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/dataAccessLabels/(?P<data_access_label>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                DataAccessControlServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = DataAccessControlServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DataAccessControlServiceClient._get_api_endpoint(

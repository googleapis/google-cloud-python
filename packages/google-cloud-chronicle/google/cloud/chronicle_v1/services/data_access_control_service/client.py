...
class DataAccessControlServiceClient(metaclass=DataAccessControlServiceClientMeta):
    ...
    def data_access_label_path(
        ...
        return "projects/{project}/locations/{location}/instances/{instance}/dataAccessLabels/{data_access_label}".format(
            project=project,
            location=location,
            instance=instance,
    ...
    def parse_data_access_label_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/dataAccessLabels/(?P<data_access_label>.+?)$", path
        )
    ...
    def parse_data_access_scope_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/instances/(?P<instance>.+?)/dataAccessScopes/(?P<data_access_scope>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = DataAccessControlServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DataAccessControlServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or DataAccessControlServiceClient._get_api_endpoint(

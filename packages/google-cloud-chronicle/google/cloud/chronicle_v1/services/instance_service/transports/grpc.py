...
from .base import DEFAULT_CLIENT_INFO, InstanceServiceTransport
...
class InstanceServiceGrpcTransport(InstanceServiceTransport):
    """gRPC backend transport for InstanceService.
...
__all__ = ("InstanceServiceGrpcTransport",)

...
from .transports.grpc import NativeDashboardServiceGrpcTransport
from .transports.grpc_asyncio import NativeDashboardServiceGrpcAsyncIOTransport
from .transports.rest import NativeDashboardServiceRestTransport


class NativeDashboardServiceClientMeta(type):
    """Metaclass for the NativeDashboardService client.
    ...
    ) -> Type[NativeDashboardServiceTransport]:
...
class NativeDashboardServiceClient(metaclass=NativeDashboardServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NativeDashboardServiceClient: The constructed client.
        """
    ...
    def transport(self) -> NativeDashboardServiceTransport:
        ...
        Returns:
            NativeDashboardServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = NativeDashboardServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = NativeDashboardServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                NativeDashboardServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = NativeDashboardServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = NativeDashboardServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = NativeDashboardServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, NativeDashboardServiceTransport)
        if transport_provided:
            # transport is a NativeDashboardServiceTransport instance.
            ...
            self._transport = cast(NativeDashboardServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or NativeDashboardServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                NativeDashboardServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., NativeDashboardServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.chronicle_v1.NativeDashboardServiceClient`.",
                    extra={
    ...
    def create_native_dashboard(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.CreateNativeDashboardRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_native_dashboard]
    ...
    def get_native_dashboard(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.GetNativeDashboardRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_native_dashboard]
    ...
    def list_native_dashboards(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListNativeDashboardsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_native_dashboards():
                # Create a client
                client = chronicle_v1.NativeDashboardServiceClient()
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.ListNativeDashboardsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_native_dashboards]
        ...
        response = pagers.ListNativeDashboardsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_native_dashboard(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_native_dashboard():
                # Create a client
                client = chronicle_v1.NativeDashboardServiceClient()
                ...
                # Make the request
                response = client.update_native_dashboard(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.chronicle_v1.types.UpdateNativeDashboardRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_native_dashboard]
    ...
    def duplicate_native_dashboard(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.DuplicateNativeDashboardRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.duplicate_native_dashboard
        ]
    ...
    def delete_native_dashboard(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_native_dashboard():
                # Create a client
                client = chronicle_v1.NativeDashboardServiceClient()
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.DeleteNativeDashboardRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_native_dashboard]
    ...
    def add_chart(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.AddChartRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.add_chart]
    ...
    def remove_chart(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.RemoveChartRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_chart]
    ...
    def edit_chart(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.EditChartRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.edit_chart]
    ...
    def duplicate_chart(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.DuplicateChartRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.duplicate_chart]
    ...
    def export_native_dashboards(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.chronicle_v1.types.ExportNativeDashboardsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.export_native_dashboards]
    ...
    def import_native_dashboards(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_import_native_dashboards():
                # Create a client
                client = chronicle_v1.NativeDashboardServiceClient()
                ...
                # Make the request
                response = client.import_native_dashboards(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.chronicle_v1.types.ImportNativeDashboardsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_native_dashboards]
    ...
    def __enter__(self) -> "NativeDashboardServiceClient":
        return self
...
__all__ = ("NativeDashboardServiceClient",)

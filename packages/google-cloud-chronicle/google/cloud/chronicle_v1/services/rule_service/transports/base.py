...
class RuleServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_rule_revisions: gapic_v1.method.wrap_method(
            ...
            self.create_retrohunt: gapic_v1.method.wrap_method(
                self.create_retrohunt,
                default_timeout=600.0,
                client_info=client_info,
            ),
            self.get_retrohunt: gapic_v1.method.wrap_method(
                self.get_retrohunt,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=60.0,
            ...
            self.list_retrohunts: gapic_v1.method.wrap_method(
            ...
            self.get_rule_deployment: gapic_v1.method.wrap_method(
            ...
            self.list_rule_deployments: gapic_v1.method.wrap_method(
            ...
            self.update_rule_deployment: gapic_v1.method.wrap_method(

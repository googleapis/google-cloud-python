...
#
# Snippet for CreateDataAccessLabel
...
def sample_create_data_access_label():
    # Create a client
    client = chronicle_v1.DataAccessControlServiceClient()
    ...
    # Make the request
    response = client.create_data_access_label(request=request)

...
def sample_enable_feed():
    # Create a client
    client = chronicle_v1.FeedsServiceClient()

    # Initialize request argument(s)
    request = chronicle_v1.EnableFeedRequest(
        name="name_value",
    )

    # Make the request
    response = client.enable_feed(request=request)

...
# [START chronicle_v1_generated_NativeDashboardService_DuplicateChart_sync]
...
def sample_duplicate_chart():
    ...
    # Make the request
    response = client.duplicate_chart(request=request)

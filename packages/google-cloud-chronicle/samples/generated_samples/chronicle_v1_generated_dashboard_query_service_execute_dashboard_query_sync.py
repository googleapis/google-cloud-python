...
#
# Snippet for ExecuteDashboardQuery
...
def sample_execute_dashboard_query():
    # Create a client
    client = chronicle_v1.DashboardQueryServiceClient()

    # Initialize request argument(s)
    query = chronicle_v1.DashboardQuery()
    query.query = "query_value"

    request = chronicle_v1.ExecuteDashboardQueryRequest(
        parent="parent_value",
        query=query,
    )

    # Make the request
    response = client.execute_dashboard_query(request=request)

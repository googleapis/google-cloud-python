...
from google.cloud.chronicle_v1.services.rule_service import RuleServiceAsyncClient, RuleServiceClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert RuleServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert RuleServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert RuleServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert RuleServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RuleServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RuleServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert RuleServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RuleServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert RuleServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RuleServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(RuleServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RuleServiceClient))
@mock.patch.object(RuleServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RuleServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RuleServiceClient._DEFAULT_UNIVERSE
    default_endpoint = RuleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RuleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RuleServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert RuleServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == RuleServiceClient.DEFAULT_MTLS_ENDPOINT
    assert RuleServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RuleServiceClient._get_api_endpoint(None, None, default_universe, "always") == RuleServiceClient.DEFAULT_MTLS_ENDPOINT
    assert RuleServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == RuleServiceClient.DEFAULT_MTLS_ENDPOINT
    assert RuleServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RuleServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RuleServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RuleServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RuleServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RuleServiceClient._get_universe_domain(None, None) == RuleServiceClient._DEFAULT_UNIVERSE
...
def test_rule_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RuleServiceAsyncClient, transports.RuleServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (RuleServiceClient, transports.RuleServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(RuleServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RuleServiceClient))
@mock.patch.object(RuleServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RuleServiceAsyncClient))
def test_rule_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RuleServiceAsyncClient, transports.RuleServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (RuleServiceClient, transports.RuleServiceGrpcTransport, "grpc", "false"),
        (RuleServiceAsyncClient, transports.RuleServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_rule_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(RuleServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RuleServiceClient))
@mock.patch.object(RuleServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RuleServiceAsyncClient))
...
def test_rule_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RuleServiceAsyncClient, transports.RuleServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (RuleServiceClient, transports.RuleServiceRestTransport, "rest", None),
    ],
)
def test_rule_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_rule_service_client_client_options_from_dict():
    with mock.patch("google.cloud.chronicle_v1.services.rule_service.transports.RuleServiceGrpcTransport.__init__") as grpc_transport:
...
def test_rule_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_rule_async(transport: str = "grpc_asyncio", request_type=gcc_rule.CreateRuleRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_rule_async(transport: str = "grpc_asyncio", request_type=rule.GetRuleRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rules_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_rules in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_rules] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_rules_async(transport: str = "grpc_asyncio", request_type=rule.ListRulesRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rules_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rules), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(rule.ListRulesResponse())
        await client.list_rules(request)
...
async def test_list_rules_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rules), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            rule.ListRulesResponse(
                rules=[
...
async def test_list_rules_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_rules), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_rules(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_update_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_rule_async(transport: str = "grpc_asyncio", request_type=gcc_rule.UpdateRuleRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_rule_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_rule in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_rule] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_rule_async(transport: str = "grpc_asyncio", request_type=rule.DeleteRuleRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_rule_revisions(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rule_revisions), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_rule_revisions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_rule_revisions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_rule_revisions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_rule_revisions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_rule_revisions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_rule_revisions] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_rule_revisions_async(transport: str = "grpc_asyncio", request_type=rule.ListRuleRevisionsRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rule_revisions_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rule_revisions), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(rule.ListRuleRevisionsResponse())
        await client.list_rule_revisions(request)
...
async def test_list_rule_revisions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rule_revisions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            rule.ListRuleRevisionsResponse(
                rules=[
...
async def test_list_rule_revisions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_rule_revisions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_rule_revisions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_retrohunt_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_retrohunt] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_retrohunt_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_retrohunt in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_retrohunt] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_retrohunt_async(transport: str = "grpc_asyncio", request_type=rule.CreateRetrohuntRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_retrohunt_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_retrohunt in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_retrohunt] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_retrohunt_async(transport: str = "grpc_asyncio", request_type=rule.GetRetrohuntRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_retrohunts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_retrohunts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_retrohunts] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_retrohunts_async(transport: str = "grpc_asyncio", request_type=rule.ListRetrohuntsRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_retrohunts_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_retrohunts), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(rule.ListRetrohuntsResponse())
        await client.list_retrohunts(request)
...
async def test_list_retrohunts_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_retrohunts), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            rule.ListRetrohuntsResponse(
                retrohunts=[
...
async def test_list_retrohunts_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_retrohunts), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_retrohunts(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_rule_deployment(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_rule_deployment), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_get_rule_deployment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_rule_deployment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_rule_deployment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_rule_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_rule_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_rule_deployment] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_rule_deployment_async(transport: str = "grpc_asyncio", request_type=rule.GetRuleDeploymentRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_rule_deployments(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rule_deployments), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_rule_deployments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_rule_deployments in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_rule_deployments] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_rule_deployments_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_rule_deployments in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_rule_deployments] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_rule_deployments_async(transport: str = "grpc_asyncio", request_type=rule.ListRuleDeploymentsRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rule_deployments_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rule_deployments), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(rule.ListRuleDeploymentsResponse())
        await client.list_rule_deployments(request)
...
async def test_list_rule_deployments_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_rule_deployments), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            rule.ListRuleDeploymentsResponse(
                rule_deployments=[
...
async def test_list_rule_deployments_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_rule_deployments), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_rule_deployments(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_rule_deployment(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_rule_deployment), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = rule.RuleDeployment(
            name="name_value",
            enabled=True,
...
def test_update_rule_deployment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_rule_deployment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_rule_deployment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_rule_deployment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RuleServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_rule_deployment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_rule_deployment] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_rule_deployment_async(transport: str = "grpc_asyncio", request_type=rule.UpdateRuleDeploymentRequest):
    client = RuleServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_rule_rest_required_fields(request_type=gcc_rule.CreateRuleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_rule._get_unset_required_fields(jsonified_request)
...
def test_create_rule_rest_unset_required_fields():
    transport = transports.RuleServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/instances/*}/rules" % client.transport._host, args[1])
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/rules/*}" % client.transport._host, args[1])
...
def test_list_rules_rest_required_fields(request_type=rule.ListRulesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rules._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rule_rest_required_fields(request_type=gcc_rule.UpdateRuleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"rule": {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{rule.name=projects/*/locations/*/instances/*/rules/*}" % client.transport._host, args[1])
...
def test_delete_rule_rest_required_fields(request_type=rule.DeleteRuleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_rule._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rule_revisions_rest_required_fields(request_type=rule.ListRuleRevisionsRequest):
    transport_class = transports.RuleServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rule_revisions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_rule_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/rules/*}:listRevisions" % client.transport._host, args[1])
...
def test_create_retrohunt_rest_required_fields(request_type=rule.CreateRetrohuntRequest):
    transport_class = transports.RuleServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_retrohunt._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_retrohunt_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/instances/*/rules/*}/retrohunts" % client.transport._host, args[1])
...
def test_get_retrohunt_rest_required_fields(request_type=rule.GetRetrohuntRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_retrohunt._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_retrohunt_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4/retrohunts/sample5"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/rules/*/retrohunts/*}" % client.transport._host, args[1])
...
def test_list_retrohunts_rest_required_fields(request_type=rule.ListRetrohuntsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_retrohunts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_rule_deployment_rest_required_fields(request_type=rule.GetRuleDeploymentRequest):
    transport_class = transports.RuleServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_rule_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_rule_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4/deployment"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/instances/*/rules/*/deployment}" % client.transport._host, args[1])
...
def test_list_rule_deployments_rest_required_fields(request_type=rule.ListRuleDeploymentsRequest):
    transport_class = transports.RuleServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rule_deployments._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_rule_deployments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/instances/*/rules/*}/deployments" % client.transport._host, args[1])
...
def test_update_rule_deployment_rest_required_fields(request_type=rule.UpdateRuleDeploymentRequest):
    transport_class = transports.RuleServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_rule_deployment._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_rule_deployment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"rule_deployment": {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4/deployment"}}
        ...
        assert path_template.validate(
            "%s/v1/{rule_deployment.name=projects/*/locations/*/instances/*/rules/*/deployment}" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = RuleServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = RuleServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = RuleServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = RuleServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = RuleServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_rule_rest_bad_request(request_type=gcc_rule.CreateRuleRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
        ...
        "compilation_diagnostics": [
            {
                ...
                "position": {"start_line": 1077, "start_column": 1307, "end_line": 830, "end_column": 1060},
                "severity": 1,
                "uri": "uri_value",
            }
        ],
...
def test_create_rule_rest_interceptors(null_interceptor):
    transport = transports.RuleServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RuleServiceRestInterceptor(),
    )
    client = RuleServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_create_rule") as post, mock.patch.object(
...
def test_get_rule_rest_bad_request(request_type=rule.GetRuleRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}
    request = request_type(**request_init)
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_rule") as post, mock.patch.object(
...
def test_list_rules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rules") as post, mock.patch.object(
...
def test_update_rule_rest_bad_request(request_type=gcc_rule.UpdateRuleRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"rule": {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}}
    request = request_type(**request_init)
...
def test_update_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_update_rule") as post, mock.patch.object(
...
def test_delete_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "pre_delete_rule") as pre:
        pre.assert_not_called()
...
def test_list_rule_revisions_rest_bad_request(request_type=rule.ListRuleRevisionsRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}
    request = request_type(**request_init)
...
def test_list_rule_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rule_revisions") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = rule.ListRuleRevisionsResponse.to_json(rule.ListRuleRevisionsResponse())
        req.return_value.content = return_value
...
def test_create_retrohunt_rest_bad_request(request_type=rule.CreateRetrohuntRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}
    request = request_type(**request_init)
...
def test_create_retrohunt_rest_call_success(request_type):
    ...
    request_init["retrohunt"] = {
        "name": "name_value",
        "process_interval": {"start_time": {"seconds": 751, "nanos": 543}, "end_time": {}},
        "execution_interval": {},
        "state": 1,
        "progress_percentage": 0.2034,
    }
...
def test_get_retrohunt_rest_bad_request(request_type=rule.GetRetrohuntRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4/retrohunts/sample5"}
    request = request_type(**request_init)
...
def test_get_retrohunt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_retrohunt") as post, mock.patch.object(
...
def test_list_retrohunts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_retrohunts") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = rule.ListRetrohuntsResponse.to_json(rule.ListRetrohuntsResponse())
        req.return_value.content = return_value
...
def test_get_rule_deployment_rest_bad_request(request_type=rule.GetRuleDeploymentRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4/deployment"}
    request = request_type(**request_init)
...
def test_get_rule_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_get_rule_deployment") as post, mock.patch.object(
...
def test_list_rule_deployments_rest_bad_request(request_type=rule.ListRuleDeploymentsRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/instances/sample3/rules/sample4"}
    request = request_type(**request_init)
...
def test_list_rule_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_list_rule_deployments") as post, mock.patch.object(
        transports.RuleServiceRestInterceptor, "post_list_rule_deployments_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = rule.ListRuleDeploymentsRequest.pb(rule.ListRuleDeploymentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = rule.ListRuleDeploymentsResponse.to_json(rule.ListRuleDeploymentsResponse())
        req.return_value.content = return_value
...
def test_update_rule_deployment_rest_bad_request(request_type=rule.UpdateRuleDeploymentRequest):
    client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"rule_deployment": {"name": "projects/sample1/locations/sample2/instances/sample3/rules/sample4/deployment"}}
    request = request_type(**request_init)
...
def test_update_rule_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RuleServiceRestInterceptor, "post_update_rule_deployment") as post, mock.patch.object(
        transports.RuleServiceRestInterceptor, "post_update_rule_deployment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = rule.UpdateRuleDeploymentRequest.pb(rule.UpdateRuleDeploymentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_rule_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.RuleServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_rule_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.chronicle_v1.services.rule_service.transports.RuleServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.RuleServiceGrpcTransport, grpc_helpers), (transports.RuleServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.RuleServiceGrpcTransport, transports.RuleServiceGrpcAsyncIOTransport])
...
def test_rule_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.RuleServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_data_access_scope_path():
    ...
    actual = RuleServiceClient.data_access_scope_path(project, location, instance, data_access_scope)
...
def test_reference_list_path():
    ...
    actual = RuleServiceClient.reference_list_path(project, location, instance, reference_list)
    assert expected == actual
...
def test_retrohunt_path():
    ...
    actual = RuleServiceClient.retrohunt_path(project, location, instance, rule, retrohunt)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.RuleServiceTransport, "_prep_wrapped_messages") as prep:
        client = RuleServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = RuleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
from google.cloud.networkconnectivity_v1beta.services.hub_service import (
    HubServiceAsyncClient,
    HubServiceClient,
    pagers,
    transports,
)
from google.cloud.networkconnectivity_v1beta.types import common, hub
...
def test_hub_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.networkconnectivity_v1beta.services.hub_service.transports.HubServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.parametrize(
    "request_type",
    [
        hub.CreateGatewayAdvertisedRouteRequest,
        dict,
    ],
)
def test_create_gateway_advertised_route(request_type, transport: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_gateway_advertised_route), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.create_gateway_advertised_route(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = hub.CreateGatewayAdvertisedRouteRequest()
        assert args[0] == request
...
def test_create_gateway_advertised_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.create_gateway_advertised_route(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hub.CreateGatewayAdvertisedRouteRequest(
            parent="parent_value",
            gateway_advertised_route_id="gateway_advertised_route_id_value",
        )


def test_create_gateway_advertised_route_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = HubServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_gateway_advertised_route
        ...
        request = {}
        client.create_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_gateway_advertised_route
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.create_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_async(
    transport: str = "grpc_asyncio",
    request_type=hub.CreateGatewayAdvertisedRouteRequest,
):
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    ...
    with mock.patch.object(
        ...
        response = await client.create_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_async_from_dict():
    await test_create_gateway_advertised_route_async(request_type=dict)


def test_create_gateway_advertised_route_field_headers():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_field_headers_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_gateway_advertised_route_flattened():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        client.create_gateway_advertised_route(
            parent="parent_value",
            gateway_advertised_route=hub.GatewayAdvertisedRoute(name="name_value"),
            gateway_advertised_route_id="gateway_advertised_route_id_value",
        )
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].gateway_advertised_route
        mock_val = hub.GatewayAdvertisedRoute(name="name_value")
        assert arg == mock_val
        arg = args[0].gateway_advertised_route_id
        mock_val = "gateway_advertised_route_id_value"
        assert arg == mock_val


def test_create_gateway_advertised_route_flattened_error():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_flattened_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_gateway_advertised_route(
            parent="parent_value",
            gateway_advertised_route=hub.GatewayAdvertisedRoute(name="name_value"),
            gateway_advertised_route_id="gateway_advertised_route_id_value",
        )
...
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_flattened_error_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_gateway_advertised_route(
            hub.CreateGatewayAdvertisedRouteRequest(),
            parent="parent_value",
            gateway_advertised_route=hub.GatewayAdvertisedRoute(name="name_value"),
            gateway_advertised_route_id="gateway_advertised_route_id_value",
...
@pytest.mark.parametrize(
    "request_type",
    [
        hub.GetGatewayAdvertisedRouteRequest,
        dict,
    ],
)
def test_get_gateway_advertised_route(request_type, transport: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_gateway_advertised_route), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = hub.GatewayAdvertisedRoute(
            name="name_value",
            description="description_value",
            unique_id="unique_id_value",
            state=hub.State.CREATING,
            ...
            priority=898,
            recipient=hub.GatewayAdvertisedRoute.Recipient.ADVERTISE_TO_HUB,
        )
        response = client.get_gateway_advertised_route(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = hub.GetGatewayAdvertisedRouteRequest()
        assert args[0] == request

    # Establish that the response is the type that we expect.
    assert isinstance(response, hub.GatewayAdvertisedRoute)
    assert response.name == "name_value"
    assert response.description == "description_value"
    assert response.unique_id == "unique_id_value"
    assert response.state == hub.State.CREATING
    assert response.ip_range == "ip_range_value"
    assert response.priority == 898
    assert response.recipient == hub.GatewayAdvertisedRoute.Recipient.ADVERTISE_TO_HUB


def test_get_gateway_advertised_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.get_gateway_advertised_route(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hub.GetGatewayAdvertisedRouteRequest(
            name="name_value",
        )


def test_get_gateway_advertised_route_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = HubServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_gateway_advertised_route
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.get_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_gateway_advertised_route
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.get_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_async(
    transport: str = "grpc_asyncio", request_type=hub.GetGatewayAdvertisedRouteRequest
):
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    ...
    with mock.patch.object(
        ...
        response = await client.get_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_async_from_dict():
    await test_get_gateway_advertised_route_async(request_type=dict)


def test_get_gateway_advertised_route_field_headers():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_field_headers_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_gateway_advertised_route_flattened():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_gateway_advertised_route(
            name="name_value",
        )
...
def test_get_gateway_advertised_route_flattened_error():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_flattened_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_gateway_advertised_route(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_flattened_error_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_gateway_advertised_route(
            hub.GetGatewayAdvertisedRouteRequest(),
            name="name_value",
        )
...
def test_list_gateway_advertised_routes(request_type, transport: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_gateway_advertised_routes), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = hub.ListGatewayAdvertisedRoutesResponse(
            next_page_token="next_page_token_value",
            unreachable=["unreachable_value"],
        )
        response = client.list_gateway_advertised_routes(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListGatewayAdvertisedRoutesPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_gateway_advertised_routes_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.list_gateway_advertised_routes(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hub.ListGatewayAdvertisedRoutesRequest(
            parent="parent_value",
            page_token="page_token_value",
            filter="filter_value",
            order_by="order_by_value",
...
def test_list_gateway_advertised_routes_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = HubServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_gateway_advertised_routes
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.list_gateway_advertised_routes(request)
...
@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_gateway_advertised_routes
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.list_gateway_advertised_routes(request)
...
@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_async(
    ...
    with mock.patch.object(
        ...
        response = await client.list_gateway_advertised_routes(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListGatewayAdvertisedRoutesAsyncPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_async_from_dict():
    await test_list_gateway_advertised_routes_async(request_type=dict)


def test_list_gateway_advertised_routes_field_headers():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_field_headers_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_gateway_advertised_routes_flattened():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_gateway_advertised_routes_flattened_error():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_flattened_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_gateway_advertised_routes(
            parent="parent_value",
        )
...
@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_flattened_error_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_gateway_advertised_routes(
            hub.ListGatewayAdvertisedRoutesRequest(),
            parent="parent_value",
        )


def test_list_gateway_advertised_routes_pager(transport_name: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pager = client.list_gateway_advertised_routes(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, hub.GatewayAdvertisedRoute) for i in results)


def test_list_gateway_advertised_routes_pages(transport_name: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_gateway_advertised_routes(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_async_pager():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_gateway_advertised_routes),
        "__call__",
        new_callable=mock.AsyncMock,
    ) as call:
        # Set the response to a series of pages.
        ...
        async_pager = await client.list_gateway_advertised_routes(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
        ...
        assert len(responses) == 6
        assert all(isinstance(i, hub.GatewayAdvertisedRoute) for i in responses)


@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_async_pages():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.parametrize(
    "request_type",
    [
        hub.UpdateGatewayAdvertisedRouteRequest,
        dict,
    ],
)
def test_update_gateway_advertised_route(request_type, transport: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.update_gateway_advertised_route), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.update_gateway_advertised_route(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = hub.UpdateGatewayAdvertisedRouteRequest()
        assert args[0] == request
...
def test_update_gateway_advertised_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.update_gateway_advertised_route(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hub.UpdateGatewayAdvertisedRouteRequest()


def test_update_gateway_advertised_route_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = HubServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_gateway_advertised_route
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.update_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_update_gateway_advertised_route_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_gateway_advertised_route
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.update_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_update_gateway_advertised_route_async(
    transport: str = "grpc_asyncio",
    request_type=hub.UpdateGatewayAdvertisedRouteRequest,
):
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    ...
    with mock.patch.object(
        ...
        response = await client.update_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_update_gateway_advertised_route_async_from_dict():
    await test_update_gateway_advertised_route_async(request_type=dict)


def test_update_gateway_advertised_route_field_headers():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    request.gateway_advertised_route.name = "name_value"
    ...
    assert (
        "x-goog-request-params",
        "gateway_advertised_route.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_gateway_advertised_route_field_headers_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_gateway_advertised_route_flattened():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.update_gateway_advertised_route(
            gateway_advertised_route=hub.GatewayAdvertisedRoute(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_update_gateway_advertised_route_flattened_error():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_gateway_advertised_route_flattened_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_gateway_advertised_route(
            gateway_advertised_route=hub.GatewayAdvertisedRoute(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
@pytest.mark.asyncio
async def test_update_gateway_advertised_route_flattened_error_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_gateway_advertised_route(
            hub.UpdateGatewayAdvertisedRouteRequest(),
            gateway_advertised_route=hub.GatewayAdvertisedRoute(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
@pytest.mark.parametrize(
    "request_type",
    [
        hub.DeleteGatewayAdvertisedRouteRequest,
        dict,
    ],
)
def test_delete_gateway_advertised_route(request_type, transport: str = "grpc"):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_gateway_advertised_route), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.delete_gateway_advertised_route(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = hub.DeleteGatewayAdvertisedRouteRequest()
        assert args[0] == request
...
def test_delete_gateway_advertised_route_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.delete_gateway_advertised_route(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hub.DeleteGatewayAdvertisedRouteRequest(
            name="name_value",
        )


def test_delete_gateway_advertised_route_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = HubServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_gateway_advertised_route
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.delete_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_gateway_advertised_route
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.delete_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_async(
    transport: str = "grpc_asyncio",
    request_type=hub.DeleteGatewayAdvertisedRouteRequest,
):
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    ...
    with mock.patch.object(
        ...
        response = await client.delete_gateway_advertised_route(request)
...
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_async_from_dict():
    await test_delete_gateway_advertised_route_async(request_type=dict)


def test_delete_gateway_advertised_route_field_headers():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_field_headers_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_gateway_advertised_route_flattened():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.delete_gateway_advertised_route(
            name="name_value",
        )
...
def test_delete_gateway_advertised_route_flattened_error():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_flattened_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_gateway_advertised_route(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_flattened_error_async():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_gateway_advertised_route(
            hub.DeleteGatewayAdvertisedRouteRequest(),
            name="name_value",
        )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_gateway_advertised_route_empty_call_grpc():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_gateway_advertised_route(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hub.CreateGatewayAdvertisedRouteRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_gateway_advertised_route_empty_call_grpc():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = hub.GatewayAdvertisedRoute()
        client.get_gateway_advertised_route(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hub.GetGatewayAdvertisedRouteRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_gateway_advertised_routes_empty_call_grpc():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = hub.ListGatewayAdvertisedRoutesResponse()
        client.list_gateway_advertised_routes(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_gateway_advertised_route_empty_call_grpc():
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_gateway_advertised_route(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hub.UpdateGatewayAdvertisedRouteRequest()
...
def test_delete_gateway_advertised_route_empty_call_grpc():
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_gateway_advertised_route(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hub.DeleteGatewayAdvertisedRouteRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_gateway_advertised_route_empty_call_grpc_asyncio():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_gateway_advertised_route(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_gateway_advertised_route_empty_call_grpc_asyncio():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_gateway_advertised_route(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_gateway_advertised_routes_empty_call_grpc_asyncio():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_gateway_advertised_routes(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_gateway_advertised_route_empty_call_grpc_asyncio():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_gateway_advertised_route(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_gateway_advertised_route_empty_call_grpc_asyncio():
    client = HubServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_gateway_advertised_route(request=None)
...
def test_hub_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.networkconnectivity_v1beta.services.hub_service.transports.HubServiceTransport.__init__"
    ) as Transport:
...
def test_hub_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.networkconnectivity_v1beta.services.hub_service.transports.HubServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_gateway_advertised_route_path():
    ...
    location = "clam"
    spoke = "whelk"
    gateway_advertised_route = "octopus"
    expected = "projects/{project}/locations/{location}/spokes/{spoke}/gatewayAdvertisedRoutes/{gateway_advertised_route}".format(
        project=project,
        location=location,
        spoke=spoke,
        gateway_advertised_route=gateway_advertised_route,
    )
    actual = HubServiceClient.gateway_advertised_route_path(
        project, location, spoke, gateway_advertised_route
    )
    assert expected == actual


def test_parse_gateway_advertised_route_path():
    expected = {
        "project": "oyster",
        "location": "nudibranch",
        "spoke": "cuttlefish",
        "gateway_advertised_route": "mussel",
    }
    path = HubServiceClient.gateway_advertised_route_path(**expected)

    # Check that the path construction is reversible.
    actual = HubServiceClient.parse_gateway_advertised_route_path(path)
    assert expected == actual
...
def test_sac_attachment_path():
    ...
    actual = HubServiceClient.sac_attachment_path(project, location, sac_attachment)
    assert expected == actual
...
def test_parse_sac_attachment_path():
    ...
    path = HubServiceClient.sac_attachment_path(**expected)

    # Check that the path construction is reversible.
    actual = HubServiceClient.parse_sac_attachment_path(path)
    assert expected == actual

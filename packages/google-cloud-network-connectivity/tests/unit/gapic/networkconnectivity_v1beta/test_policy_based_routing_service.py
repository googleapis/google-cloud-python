...
def test_policy_based_routing_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.networkconnectivity_v1beta.services.policy_based_routing_service.transports.PolicyBasedRoutingServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_policy_based_routing_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.networkconnectivity_v1beta.services.policy_based_routing_service.transports.PolicyBasedRoutingServiceTransport.__init__"
    ) as Transport:
...
def test_policy_based_routing_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.networkconnectivity_v1beta.services.policy_based_routing_service.transports.PolicyBasedRoutingServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

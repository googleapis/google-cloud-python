...
def test__get_default_mtls_endpoint():
    ...
    assert (
        PolicyBasedRoutingServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
async def test_list_policy_based_routes_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_policy_based_routes(
            request={},
        )
...
def test_get_policy_based_route_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_policy_based_route] = (
            mock_rpc
        )
        request = {}
...
def test_policy_based_routing_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.networkconnectivity_v1.services.policy_based_routing_service.transports.PolicyBasedRoutingServiceTransport.__init__"
    ) as Transport:
...
def test_policy_based_route_path():
    ...
    expected = "projects/{project}/locations/global/PolicyBasedRoutes/{policy_based_route}".format(
        project=project,

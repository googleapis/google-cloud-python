...
class PresetTopology(proto.Enum):
    ...
    Values:
        ...
        HYBRID_INSPECTION (4):
            Hybrid inspection has 4 groups ('non-prod',
            'prod', 'services', and 'untrusted') that are
            automatically created along with hub creation.
    """
...
class Hub(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.networkconnectivity_v1beta.types.State):
            ...
            this hub.
        routing_vpcs (MutableSequence[google.cloud.networkconnectivity_v1beta.types.RoutingVPC]):
            Output only. The VPC networks associated with
            this hub's spokes.
        ...
        route_tables (MutableSequence[str]):
            ...
            under the hub.
        spoke_summary (google.cloud.networkconnectivity_v1beta.types.SpokeSummary):
        ...
        policy_mode (google.cloud.networkconnectivity_v1beta.types.PolicyMode):
            Optional. The policy mode of this hub. This field can be
            either PRESET or CUSTOM. If unspecified, the policy_mode
            defaults to PRESET.
        preset_topology (google.cloud.networkconnectivity_v1beta.types.PresetTopology):
...
class Spoke(proto.Message):
    ...
    Attributes:
        ...
        linked_vpn_tunnels (google.cloud.networkconnectivity_v1beta.types.LinkedVpnTunnels):
            Optional. VPN tunnels that are associated
            with the spoke.
        linked_interconnect_attachments (google.cloud.networkconnectivity_v1beta.types.LinkedInterconnectAttachments):
            Optional. VLAN attachments that are
            associated with the spoke.
        linked_router_appliance_instances (google.cloud.networkconnectivity_v1beta.types.LinkedRouterApplianceInstances):
            Optional. Router appliance instances that are
            associated with the spoke.
        linked_vpc_network (google.cloud.networkconnectivity_v1beta.types.LinkedVpcNetwork):
            Optional. VPC network that is associated with
            the spoke.
        gateway (google.cloud.networkconnectivity_v1beta.types.Gateway):
            Optional. This is a gateway that can apply
            specialized processing to traffic going through
            it.
        linked_producer_vpc_network (google.cloud.networkconnectivity_v1beta.types.LinkedProducerVpcNetwork):
        ...
        state (google.cloud.networkconnectivity_v1beta.types.State):
            Output only. The current lifecycle state of
            this spoke.
        reasons (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Spoke.StateReason]):
            Output only. The reasons for current state of
            the spoke.
        spoke_type (google.cloud.networkconnectivity_v1beta.types.SpokeType):
    ...
    class StateReason(proto.Message):
        ...
        Attributes:
            code (google.cloud.networkconnectivity_v1beta.types.Spoke.StateReason.Code):
        ...
        class Code(proto.Enum):
            r"""The Code enum represents the various reasons for the state of
            the spoke.
...
class Route(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.networkconnectivity_v1beta.types.RouteType):
            Output only. The route's type. Its type is
            determined by the properties of its IP address
            range.
        next_hop_vpc_network (google.cloud.networkconnectivity_v1beta.types.NextHopVpcNetwork):
        ...
        priority (int):
            ...
            priority value wins.
        next_hop_vpn_tunnel (google.cloud.networkconnectivity_v1beta.types.NextHopVPNTunnel):
            Immutable. The next-hop VPN tunnel for
            packets on this route.
        next_hop_router_appliance_instance (google.cloud.networkconnectivity_v1beta.types.NextHopRouterApplianceInstance):
            Immutable. The next-hop Router appliance
            instance for packets on this route.
        next_hop_interconnect_attachment (google.cloud.networkconnectivity_v1beta.types.NextHopInterconnectAttachment):
            Immutable. The next-hop VLAN attachment for
            packets on this route.
        next_hop_spoke (google.cloud.networkconnectivity_v1beta.types.NextHopSpoke):
            Immutable. The next-hop spoke for packets on
            this route.
    """
    ...
    next_hop_spoke: "NextHopSpoke" = proto.Field(
        proto.MESSAGE,
        number=18,
        message="NextHopSpoke",
    )
...
class Group(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.networkconnectivity_v1beta.types.State):
            Output only. The current lifecycle state of
            this group.
        auto_accept (google.cloud.networkconnectivity_v1beta.types.AutoAccept):
...
class ListHubsResponse(proto.Message):
    ...
    Attributes:
        hubs (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Hub]):
            The requested hubs.
        next_page_token (str):
...
class CreateHubRequest(proto.Message):
    ...
    Attributes:
        ...
        hub (google.cloud.networkconnectivity_v1beta.types.Hub):
...
class ListHubSpokesRequest(proto.Message):
    ...
    Attributes:
        ...
        view (google.cloud.networkconnectivity_v1beta.types.ListHubSpokesRequest.SpokeView):
...
class ListHubSpokesResponse(proto.Message):
    ...
    Attributes:
        spokes (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Spoke]):
...
class QueryHubStatusResponse(proto.Message):
    ...
    Attributes:
        hub_status_entries (MutableSequence[google.cloud.networkconnectivity_v1beta.types.HubStatusEntry]):
...
class HubStatusEntry(proto.Message):
    ...
    Attributes:
        ...
        psc_propagation_status (google.cloud.networkconnectivity_v1beta.types.PscPropagationStatus):
...
class PscPropagationStatus(proto.Message):
    ...
    Attributes:
        ...
        target_group (str):
            ...
            belongs to.
        code (google.cloud.networkconnectivity_v1beta.types.PscPropagationStatus.Code):
...
class CreateSpokeRequest(proto.Message):
    ...
    Attributes:
        ...
        spoke (google.cloud.networkconnectivity_v1beta.types.Spoke):
...
class ListRoutesResponse(proto.Message):
    ...
    Attributes:
        routes (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Route]):
...
class ListRouteTablesResponse(proto.Message):
    ...
    Attributes:
        route_tables (MutableSequence[google.cloud.networkconnectivity_v1beta.types.RouteTable]):
...
class ListGroupsResponse(proto.Message):
    ...
    Attributes:
        groups (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Group]):
...
class LinkedRouterApplianceInstances(proto.Message):
    ...
    Attributes:
        instances (MutableSequence[google.cloud.networkconnectivity_v1beta.types.RouterApplianceInstance]):
...
class LinkedVpcNetwork(proto.Message):
    ...
    Attributes:
        ...
        proposed_include_export_ranges (MutableSequence[str]):
            Output only. The proposed include export IP
        ...
        producer_vpc_spokes (MutableSequence[str]):
            ...
            through VPC peering, NCC export filters do not
...
class Gateway(proto.Message):
    ...
    Attributes:
        ip_range_reservations (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Gateway.IpRangeReservation]):
            Optional. A list of IP ranges that are
            reserved for this gateway's internal
            intfrastructure.
        capacity (google.cloud.networkconnectivity_v1beta.types.Gateway.GatewayCapacity):
            Optional. The aggregate processing capacity
            of this gateway.
        cloud_routers (MutableSequence[str]):
            Output only. The list of Cloud Routers that
            are connected to this gateway. Should be in the
            form:

            https://www.googleapis.com/compute/v1/projects/{project}/regions/{region}/routers/{router}
        sac_attachment (str):
            Output only. The URI of the connected SACAttachment. Should
            be in the form:
            projects/{project}/locations/{location}/sacAttachments/{sac_attachment}
    """

    class GatewayCapacity(proto.Enum):
        r"""The aggregate processing capacity of this gateway.

        Values:
            GATEWAY_CAPACITY_UNSPECIFIED (0):
                The gateway capacity is unspecified.
            CAPACITY_1_GBPS (5):
                The gateway has 1 Gbps of aggregate
                processing capacity
            CAPACITY_10_GBPS (1):
                The gateway has 10 Gbps of aggregate
                processing capacity
            CAPACITY_100_GBPS (4):
                The gateway has 100 Gbps of aggregate
                processing capacity
        """
    ...
    class IpRangeReservation(proto.Message):
        r"""A list of IP ranges that are reserved for this gateway's
        internal intfrastructure.

        Attributes:
            ip_range (str):
                Required. A block of IP addresses used to
                allocate supporting infrastructure for this
                gateway. This block must not overlap with
                subnets in any spokes or peer VPC networks that
                the gateway can communicate with. Example:
                "10.1.2.0/24".
        """
    ...
    ip_range_reservations: MutableSequence[IpRangeReservation] = proto.RepeatedField(
        proto.MESSAGE,
        number=7,
        message=IpRangeReservation,
    )
    capacity: GatewayCapacity = proto.Field(
        proto.ENUM,
        number=10,
        enum=GatewayCapacity,
    )
    cloud_routers: MutableSequence[str] = proto.RepeatedField(
        proto.STRING,
        number=13,
    )
    sac_attachment: str = proto.Field(
        proto.STRING,
        number=14,
    )


class GatewayAdvertisedRoute(proto.Message):
    r"""A gateway advertised route is a route that a gateway spoke
    advertises somewhere.
    ...
    Attributes:
        name (str):
            Identifier. The name of the gateway advertised route. Route
        ...
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The time the gateway advertised
            route was created.
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The time the gateway advertised
        ...
        description (str):
            ...
            advertised route.
        unique_id (str):
            Output only. The Google-generated UUID for the gateway
            advertised route. This value is unique across all gateway
            advertised route resources. If a gateway advertised route is
            deleted and another with the same name is created, the new
            route is assigned a different ``unique_id``.
        state (google.cloud.networkconnectivity_v1beta.types.State):
            Output only. The current lifecycle state of
            this gateway advertised route.
        ip_range (str):
            Immutable. This route's advertised IP address range. Must be
            a valid CIDR-formatted prefix. If an IP address is provided
            without a subnet mask, it is interpreted as, for IPv4, a
            ``/32`` singular IP address range, and, for IPv6, ``/128``.
        priority (int):
            Optional. The priority of this advertised route. You can
            choose a value from ``0`` to ``65335``. If you don't provide
            a value, Google Cloud assigns a priority of ``100`` to the
            ranges.
        ...
        recipient (google.cloud.networkconnectivity_v1beta.types.GatewayAdvertisedRoute.Recipient):
            Optional. The recipient of this advertised
            route.
    """

    class Recipient(proto.Enum):
        r"""The recipient of an advertised route.

        Values:
            RECIPIENT_UNSPECIFIED (0):
                No recipient specified. By default routes are
                advertised to the hub.
            ADVERTISE_TO_HUB (1):
                Advertises a route toward the hub. Other
                spokes reachable from this spoke will receive
                the route.
        """
    ...
    recipient: Recipient = proto.Field(
        proto.ENUM,
        number=10,
        enum=Recipient,
    )
...
class CreateGatewayAdvertisedRouteRequest(proto.Message):
    r"""The request for
    ...
    Attributes:
        parent (str):
            Required. The parent resource.
        gateway_advertised_route_id (str):
            Required. Unique id for the route to create.
        gateway_advertised_route (google.cloud.networkconnectivity_v1beta.types.GatewayAdvertisedRoute):
            Required. Initial values for the new gateway
            advertised route.
        request_id (str):
            Optional. A request ID to identify requests.
            Specify a unique request ID so that if you must
    ...
    gateway_advertised_route_id: str = proto.Field(
        proto.STRING,
        number=2,
    )
    gateway_advertised_route: "GatewayAdvertisedRoute" = proto.Field(
        proto.MESSAGE,
        number=3,
        message="GatewayAdvertisedRoute",
    )
    request_id: str = proto.Field(
        proto.STRING,
        number=4,
...
class ListGatewayAdvertisedRoutesRequest(proto.Message):
    r"""The request for
    ...
    Attributes:
        parent (str):
            Required. The parent resource's name.
        page_size (int):
            Optional. The maximum number of results per
            page that should be returned.
        page_token (str):
            Optional. A page token, received from a previous
            ``ListGatewayAdvertisedRoutes`` call. Provide this to
            retrieve the subsequent page.

            When paginating, all other parameters provided to
            ``ListGatewayAdvertisedRoutes`` must match the call that
...
class ListGatewayAdvertisedRoutesResponse(proto.Message):
    r"""Response for
    [HubService.ListGatewayAdvertisedRoutes][google.cloud.networkconnectivity.v1beta.HubService.ListGatewayAdvertisedRoutes]
    method.
    ...
    gateway_advertised_routes: MutableSequence["GatewayAdvertisedRoute"] = (
        proto.RepeatedField(
            proto.MESSAGE,
            number=1,
            message="GatewayAdvertisedRoute",
...
class UpdateGatewayAdvertisedRouteRequest(proto.Message):
    r"""The request for
    ...
    Attributes:
        ...
        gateway_advertised_route (google.cloud.networkconnectivity_v1beta.types.GatewayAdvertisedRoute):
            ...
            The gateway advertised route's ``name`` field is used to
            identify the gateway advertised route to update. Format:
...
class DeleteGatewayAdvertisedRouteRequest(proto.Message):
    r"""Request for
...
class LocationMetadata(proto.Message):
    ...
    Attributes:
        location_features (MutableSequence[google.cloud.networkconnectivity_v1beta.types.LocationFeature]):
...
class NextHopSpoke(proto.Message):
    ...
    Attributes:
        ...
        site_to_site_data_transfer (bool):
            Indicates whether site-to-site data transfer is allowed for
            this spoke resource. Data transfer is available only in
            `supported
            locations <https://cloud.google.com/network-connectivity/docs/network-connectivity-center/concepts/locations>`__.
            Whether this route is accessible to other hybrid spokes with
            site-to-site data transfer enabled. If this is false, the
            route is only accessible to VPC spokes of the connected Hub.
    """
...
class SpokeSummary(proto.Message):
    ...
    Attributes:
        spoke_type_counts (MutableSequence[google.cloud.networkconnectivity_v1beta.types.SpokeSummary.SpokeTypeCount]):
            Output only. Counts the number of spokes of
            each type that are associated with a specific
            hub.
        spoke_state_counts (MutableSequence[google.cloud.networkconnectivity_v1beta.types.SpokeSummary.SpokeStateCount]):
            Output only. Counts the number of spokes that
            are in each state and associated with a given
            hub.
        spoke_state_reason_counts (MutableSequence[google.cloud.networkconnectivity_v1beta.types.SpokeSummary.SpokeStateReasonCount]):
            Output only. Counts the number of spokes that
    ...
    class SpokeStateReasonCount(proto.Message):
        ...
        Attributes:
            state_reason_code (google.cloud.networkconnectivity_v1beta.types.Spoke.StateReason.Code):
...
class UpdateGroupRequest(proto.Message):
    ...
    Attributes:
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            is in the mask. If the user does not provide a mask, then
            all fields are overwritten.
        group (google.cloud.networkconnectivity_v1beta.types.Group):

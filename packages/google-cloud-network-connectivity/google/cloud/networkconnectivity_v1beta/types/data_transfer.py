...
class MulticloudDataTransferConfig(proto.Message):
    ...
    Attributes:
        ...
        services (MutableMapping[str, google.cloud.networkconnectivity_v1beta.types.StateTimeline]):
...
class ListMulticloudDataTransferConfigsResponse(proto.Message):
    ...
    Attributes:
        multicloud_data_transfer_configs (MutableSequence[google.cloud.networkconnectivity_v1beta.types.MulticloudDataTransferConfig]):
...
class CreateMulticloudDataTransferConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        multicloud_data_transfer_config_id (str):
            ...
            resource name.
        multicloud_data_transfer_config (google.cloud.networkconnectivity_v1beta.types.MulticloudDataTransferConfig):
...
class Destination(proto.Message):
    ...
    Attributes:
        ...
        endpoints (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Destination.DestinationEndpoint]):
            Required. Unordered list. The list of
            ``DestinationEndpoint`` resources configured for the IP
            prefix.
        state_timeline (google.cloud.networkconnectivity_v1beta.types.StateTimeline):
    ...
    class DestinationEndpoint(proto.Message):
        ...
        Attributes:
            ...
            state (google.cloud.networkconnectivity_v1beta.types.Destination.DestinationEndpoint.State):
...
class ListDestinationsResponse(proto.Message):
    ...
    Attributes:
        destinations (MutableSequence[google.cloud.networkconnectivity_v1beta.types.Destination]):
...
class CreateDestinationRequest(proto.Message):
    ...
    Attributes:
        ...
        destination_id (str):
            ...
            resource name.
        destination (google.cloud.networkconnectivity_v1beta.types.Destination):
...
class StateTimeline(proto.Message):
    ...
    Attributes:
        states (MutableSequence[google.cloud.networkconnectivity_v1beta.types.StateTimeline.StateMetadata]):
    ...
    class StateMetadata(proto.Message):
        ...
        Attributes:
            state (google.cloud.networkconnectivity_v1beta.types.StateTimeline.StateMetadata.State):
...
class MulticloudDataTransferSupportedService(proto.Message):
    ...
    Attributes:
        ...
        service_configs (MutableSequence[google.cloud.networkconnectivity_v1beta.types.ServiceConfig]):
...
class ServiceConfig(proto.Message):
    ...
    Attributes:
        eligibility_criteria (google.cloud.networkconnectivity_v1beta.types.ServiceConfig.EligibilityCriteria):
...
class ListMulticloudDataTransferSupportedServicesResponse(proto.Message):
    ...
    Attributes:
        multicloud_data_transfer_supported_services (MutableSequence[google.cloud.networkconnectivity_v1beta.types.MulticloudDataTransferSupportedService]):

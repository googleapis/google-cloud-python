...
class PolicyBasedRoute(proto.Message):
    ...
    Attributes:
        virtual_machine (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.VirtualMachine):
            Optional. VM instances that this policy-based
            route applies to.

            This field is a member of `oneof`_ ``target``.
        interconnect_attachment (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.InterconnectAttachment):
        ...
        next_hop_other_routes (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.OtherRoutes):
            ...
            This field is a member of `oneof`_ ``next_hop``.
        name (str):
            Immutable. Identifier. A unique name of the resource in the
            form of
        ...
        filter (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.Filter):
        ...
        priority (int):
            ...
            1000. The priority value must be from 1 to
                65535, inclusive.
        warnings (MutableSequence[google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.Warnings]):
    ...
    class Filter(proto.Message):
        ...
        Attributes:
            ...
            dest_range (str):
                ...
                version is IPv4 and "::/0" if protocol version
                is IPv6.
            protocol_version (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.Filter.ProtocolVersion):
                Required. Internet protocol versions this
                policy-based route applies to. IPV4 and IPV6 is
                supported.
        """
        ...
        class ProtocolVersion(proto.Enum):
            ...
            Values:
                ...
                IPV4 (1):
                    ...
                    traffic.
                IPV6 (2):
                    The PBR is for IPv6 internet protocol
                    traffic.
            """
    ...
    class Warnings(proto.Message):
        ...
        Attributes:
            code (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute.Warnings.Code):
...
class ListPolicyBasedRoutesResponse(proto.Message):
    ...
    Attributes:
        policy_based_routes (MutableSequence[google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute]):
...
class CreatePolicyBasedRouteRequest(proto.Message):
    ...
    Attributes:
        ...
        policy_based_route (google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute):

...
from google.cloud.networkconnectivity_v1beta.services.hub_service import pagers
...
class HubServiceClient(metaclass=HubServiceClientMeta):
    ...
    @staticmethod
    def gateway_advertised_route_path(
        project: str,
        location: str,
        spoke: str,
        gateway_advertised_route: str,
    ) -> str:
        """Returns a fully-qualified gateway_advertised_route string."""
        return "projects/{project}/locations/{location}/spokes/{spoke}/gatewayAdvertisedRoutes/{gateway_advertised_route}".format(
            project=project,
            location=location,
            spoke=spoke,
    ...
    @staticmethod
    def parse_gateway_advertised_route_path(path: str) -> Dict[str, str]:
        """Parses a gateway_advertised_route path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/spokes/(?P<spoke>.+?)/gatewayAdvertisedRoutes/(?P<gateway_advertised_route>.+?)$",
            path,
        )
    ...
    def group_path(
        ...
        return "projects/{project}/locations/global/hubs/{hub}/groups/{group}".format(
            project=project,
            hub=hub,
            group=group,
        )
    ...
    def parse_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/global/hubs/(?P<hub>.+?)/groups/(?P<group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def hub_route_path(
        ...
        return "projects/{project}/locations/global/hubs/{hub}/routeTables/{route_table}/routes/{route}".format(
            project=project,
            hub=hub,
    ...
    @staticmethod
    def parse_hub_route_path(path: str) -> Dict[str, str]:
        """Parses a hub_route path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/global/hubs/(?P<hub>.+?)/routeTables/(?P<route_table>.+?)/routes/(?P<route>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def route_table_path(
        ...
        return "projects/{project}/locations/global/hubs/{hub}/routeTables/{route_table}".format(
            project=project,
            hub=hub,
            route_table=route_table,
        )
    ...
    @staticmethod
    def parse_route_table_path(path: str) -> Dict[str, str]:
        """Parses a route_table path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/global/hubs/(?P<hub>.+?)/routeTables/(?P<route_table>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def sac_attachment_path(
        project: str,
        location: str,
        sac_attachment: str,
    ) -> str:
        """Returns a fully-qualified sac_attachment string."""
        return "projects/{project}/locations/{location}/sacAttachments/{sac_attachment}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_sac_attachment_path(path: str) -> Dict[str, str]:
        """Parses a sac_attachment path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sacAttachments/(?P<sac_attachment>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.networkconnectivity_v1beta.HubServiceClient`.",
                    extra={
    ...
    def list_hubs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListHubsRequest, dict]):
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListHubsPager:
                Response for
                   [HubService.ListHubs][google.cloud.networkconnectivity.v1beta.HubService.ListHubs]
                   method.
    ...
    def get_hub(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetHubRequest, dict]):
                The request object. Request for
    ...
    def create_hub(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.CreateHubRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.Hub` A Network Connectivity Center hub is a global management resource to which
    ...
    def update_hub(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.UpdateHubRequest, dict]):
                The request object. Request for
    ...
    def delete_hub(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.DeleteHubRequest, dict]):
    ...
    def list_hub_spokes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListHubSpokesRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListHubSpokesPager:
                The response for
                   [HubService.ListHubSpokes][google.cloud.networkconnectivity.v1beta.HubService.ListHubSpokes].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_hub_spokes]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListHubSpokesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def query_hub_status(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.QueryHubStatusRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.QueryHubStatusPager:
                The response for
                   [HubService.QueryHubStatus][google.cloud.networkconnectivity.v1beta.HubService.QueryHubStatus].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_hub_status]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.QueryHubStatusPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_spokes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListSpokesRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListSpokesPager:
                The response for
                   [HubService.ListSpokes][google.cloud.networkconnectivity.v1beta.HubService.ListSpokes].
    ...
    def get_spoke(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetSpokeRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.types.Spoke:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_spoke():
                ...
                # Initialize request argument(s)
                request = networkconnectivity_v1beta.CreateSpokeRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.CreateSpokeRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.Spoke` A Network Connectivity Center spoke represents one or more network
                   connectivity resources.
    ...
    def update_spoke(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.UpdateSpokeRequest, dict]):
                The request object. Request for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_reject_hub_spoke():
                ...
                # Initialize request argument(s)
                request = networkconnectivity_v1beta.RejectHubSpokeRequest(
                    name="name_value",
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.RejectHubSpokeRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.RejectHubSpokeResponse` The response for
                   [HubService.RejectHubSpoke][google.cloud.networkconnectivity.v1beta.HubService.RejectHubSpoke].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reject_hub_spoke]
    ...
    def accept_hub_spoke(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.AcceptHubSpokeRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.AcceptHubSpokeResponse` The response for
                   [HubService.AcceptHubSpoke][google.cloud.networkconnectivity.v1beta.HubService.AcceptHubSpoke].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.accept_hub_spoke]
    ...
    def accept_spoke_update(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_accept_spoke_update():
                # Create a client
                client = networkconnectivity_v1beta.HubServiceClient()
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.AcceptSpokeUpdateRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.AcceptSpokeUpdateResponse` The response for
                   [HubService.AcceptSpokeUpdate][google.cloud.networkconnectivity.v1beta.HubService.AcceptSpokeUpdate].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.accept_spoke_update]
    ...
    def reject_spoke_update(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.RejectSpokeUpdateRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.RejectSpokeUpdateResponse` The response for
                   [HubService.RejectSpokeUpdate][google.cloud.networkconnectivity.v1beta.HubService.RejectSpokeUpdate].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reject_spoke_update]
    ...
    def delete_spoke(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.DeleteSpokeRequest, dict]):
                The request object. The request for
    ...
    def get_route_table(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetRouteTableRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.types.RouteTable:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_route_table]
    ...
    def get_route(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetRouteRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.types.Route:
    ...
    def list_routes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListRoutesRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListRoutesPager:
                Response for
                   [HubService.ListRoutes][google.cloud.networkconnectivity.v1beta.HubService.ListRoutes]
                   method.
    ...
    def list_route_tables(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListRouteTablesRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListRouteTablesPager:
                Response for
                   [HubService.ListRouteTables][google.cloud.networkconnectivity.v1beta.HubService.ListRouteTables]
                   method.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_route_tables]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListRouteTablesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetGroupRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.types.Group:
    ...
    def list_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListGroupsRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListGroupsPager:
                Response for
                   [HubService.ListGroups][google.cloud.networkconnectivity.v1beta.HubService.ListGroups]
                   method.
    ...
    def update_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.UpdateGroupRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.networkconnectivity_v1beta.types.Group`
    ...
    def create_gateway_advertised_route(
        self,
        request: Optional[Union[hub.CreateGatewayAdvertisedRouteRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        gateway_advertised_route: Optional[hub.GatewayAdvertisedRoute] = None,
        gateway_advertised_route_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation.Operation:
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.CreateGatewayAdvertisedRouteRequest, dict]):
                The request object. The request for
            ...
            gateway_advertised_route (google.cloud.networkconnectivity_v1beta.types.GatewayAdvertisedRoute):
                Required. Initial values for the new
                gateway advertised route.

                This corresponds to the ``gateway_advertised_route`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            gateway_advertised_route_id (str):
                Required. Unique id for the route to
                create.

                This corresponds to the ``gateway_advertised_route_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.GatewayAdvertisedRoute` A gateway advertised route is a route that a gateway spoke advertises
                   somewhere.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, hub.CreateGatewayAdvertisedRouteRequest):
            request = hub.CreateGatewayAdvertisedRouteRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
            if gateway_advertised_route is not None:
                request.gateway_advertised_route = gateway_advertised_route
            if gateway_advertised_route_id is not None:
                request.gateway_advertised_route_id = gateway_advertised_route_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_gateway_advertised_route
        ]
    ...
    def get_gateway_advertised_route(
        self,
        request: Optional[Union[hub.GetGatewayAdvertisedRouteRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetGatewayAdvertisedRouteRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.types.GatewayAdvertisedRoute:
                A gateway advertised route is a route
                that a gateway spoke advertises
                somewhere.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, hub.GetGatewayAdvertisedRouteRequest):
            request = hub.GetGatewayAdvertisedRouteRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_gateway_advertised_route
        ]
    ...
    def list_gateway_advertised_routes(
        self,
        request: Optional[Union[hub.ListGatewayAdvertisedRoutesRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListGatewayAdvertisedRoutesPager:
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListGatewayAdvertisedRoutesRequest, dict]):
                The request object. The request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.hub_service.pagers.ListGatewayAdvertisedRoutesPager:
                Response for
                   [HubService.ListGatewayAdvertisedRoutes][google.cloud.networkconnectivity.v1beta.HubService.ListGatewayAdvertisedRoutes]
                   method.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, hub.ListGatewayAdvertisedRoutesRequest):
            request = hub.ListGatewayAdvertisedRoutesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_gateway_advertised_routes
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListGatewayAdvertisedRoutesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_gateway_advertised_route(
        self,
        request: Optional[Union[hub.UpdateGatewayAdvertisedRouteRequest, dict]] = None,
        *,
        gateway_advertised_route: Optional[hub.GatewayAdvertisedRoute] = None,
        update_mask: Optional[field_mask_pb2.FieldMask] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_update_gateway_advertised_route():
                # Create a client
                client = networkconnectivity_v1beta.HubServiceClient()
                ...
                # Make the request
                operation = client.update_gateway_advertised_route(request=request)
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.UpdateGatewayAdvertisedRouteRequest, dict]):
                The request object. The request for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [gateway_advertised_route, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, hub.UpdateGatewayAdvertisedRouteRequest):
            request = hub.UpdateGatewayAdvertisedRouteRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if gateway_advertised_route is not None:
                request.gateway_advertised_route = gateway_advertised_route
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_gateway_advertised_route
        ]
            ...
            gapic_v1.routing_header.to_grpc_metadata(
                (
                    (
                        ...
                        request.gateway_advertised_route.name,
                    ),
                )
            ),
        )
    ...
    def delete_gateway_advertised_route(
        self,
        request: Optional[Union[hub.DeleteGatewayAdvertisedRouteRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_delete_gateway_advertised_route():
                # Create a client
                client = networkconnectivity_v1beta.HubServiceClient()
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.DeleteGatewayAdvertisedRouteRequest, dict]):
                The request object. Request for
                [HubService.DeleteGatewayAdvertisedRoute][google.cloud.networkconnectivity.v1beta.HubService.DeleteGatewayAdvertisedRoute]
                method.
            name (str):
                Required. The name of the gateway
                advertised route to delete.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, hub.DeleteGatewayAdvertisedRouteRequest):
            request = hub.DeleteGatewayAdvertisedRouteRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_gateway_advertised_route
        ]

...
class HubServiceGrpcAsyncIOTransport(HubServiceTransport):
    ...
    def create_gateway_advertised_route(
        ...
        [hub.CreateGatewayAdvertisedRouteRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def get_gateway_advertised_route(
        ...
        [hub.GetGatewayAdvertisedRouteRequest], Awaitable[hub.GatewayAdvertisedRoute]
    ]:
        ...
        Returns:
            Callable[[~.GetGatewayAdvertisedRouteRequest],
                    Awaitable[~.GatewayAdvertisedRoute]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_gateway_advertised_routes(
        ...
        Returns:
            Callable[[~.ListGatewayAdvertisedRoutesRequest],
                    Awaitable[~.ListGatewayAdvertisedRoutesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def update_gateway_advertised_route(
        ...
        [hub.UpdateGatewayAdvertisedRouteRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_gateway_advertised_route(
        ...
        [hub.DeleteGatewayAdvertisedRouteRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.create_gateway_advertised_route: self._wrap_method(
                self.create_gateway_advertised_route,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_gateway_advertised_route: self._wrap_method(
                self.get_gateway_advertised_route,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_gateway_advertised_routes: self._wrap_method(
                self.list_gateway_advertised_routes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_gateway_advertised_route: self._wrap_method(
                self.update_gateway_advertised_route,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_gateway_advertised_route: self._wrap_method(

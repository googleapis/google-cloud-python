...
from google.cloud.networkconnectivity_v1beta.types import hub
from google.cloud.networkconnectivity_v1beta.types import hub as gcn_hub
    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.cloud.networkconnectivity.v1beta.HubService",
...
class HubServiceGrpcTransport(HubServiceTransport):
    ...
    def create_gateway_advertised_route(
        self,
    ) -> Callable[[hub.CreateGatewayAdvertisedRouteRequest], operations_pb2.Operation]:
        r"""Return a callable for the create gateway advertised
        route method over gRPC.

        Create a GatewayAdvertisedRoute

        Returns:
            Callable[[~.CreateGatewayAdvertisedRouteRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_gateway_advertised_route" not in self._stubs:
            self._stubs["create_gateway_advertised_route"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.networkconnectivity.v1beta.HubService/CreateGatewayAdvertisedRoute",
                    request_serializer=hub.CreateGatewayAdvertisedRouteRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["create_gateway_advertised_route"]

    @property
    def get_gateway_advertised_route(
        self,
    ) -> Callable[[hub.GetGatewayAdvertisedRouteRequest], hub.GatewayAdvertisedRoute]:
        r"""Return a callable for the get gateway advertised route method over gRPC.

        Get a GatewayAdvertisedRoute

        Returns:
            Callable[[~.GetGatewayAdvertisedRouteRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_gateway_advertised_route" not in self._stubs:
            self._stubs["get_gateway_advertised_route"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.networkconnectivity.v1beta.HubService/GetGatewayAdvertisedRoute",
                    request_serializer=hub.GetGatewayAdvertisedRouteRequest.serialize,
                    response_deserializer=hub.GatewayAdvertisedRoute.deserialize,
                )
            )
        return self._stubs["get_gateway_advertised_route"]

    @property
    def list_gateway_advertised_routes(
        self,
    ) -> Callable[
        [hub.ListGatewayAdvertisedRoutesRequest],
        hub.ListGatewayAdvertisedRoutesResponse,
    ]:
        r"""Return a callable for the list gateway advertised routes method over gRPC.

        List GatewayAdvertisedRoutes

        Returns:
            Callable[[~.ListGatewayAdvertisedRoutesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_gateway_advertised_routes" not in self._stubs:
            self._stubs["list_gateway_advertised_routes"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.networkconnectivity.v1beta.HubService/ListGatewayAdvertisedRoutes",
                    request_serializer=hub.ListGatewayAdvertisedRoutesRequest.serialize,
                    response_deserializer=hub.ListGatewayAdvertisedRoutesResponse.deserialize,
                )
            )
        return self._stubs["list_gateway_advertised_routes"]

    @property
    def update_gateway_advertised_route(
        self,
    ) -> Callable[[hub.UpdateGatewayAdvertisedRouteRequest], operations_pb2.Operation]:
        r"""Return a callable for the update gateway advertised
        route method over gRPC.

        Update a GatewayAdvertisedRoute

        Returns:
            Callable[[~.UpdateGatewayAdvertisedRouteRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_gateway_advertised_route" not in self._stubs:
            self._stubs["update_gateway_advertised_route"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.networkconnectivity.v1beta.HubService/UpdateGatewayAdvertisedRoute",
                    request_serializer=hub.UpdateGatewayAdvertisedRouteRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["update_gateway_advertised_route"]

    @property
    def delete_gateway_advertised_route(
        self,
    ) -> Callable[[hub.DeleteGatewayAdvertisedRouteRequest], operations_pb2.Operation]:
        r"""Return a callable for the delete gateway advertised
        route method over gRPC.

        Delete a GatewayAdvertisedRoute

        Returns:
            Callable[[~.DeleteGatewayAdvertisedRouteRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_gateway_advertised_route" not in self._stubs:
            self._stubs["delete_gateway_advertised_route"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.networkconnectivity.v1beta.HubService/DeleteGatewayAdvertisedRoute",
                    request_serializer=hub.DeleteGatewayAdvertisedRouteRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["delete_gateway_advertised_route"]

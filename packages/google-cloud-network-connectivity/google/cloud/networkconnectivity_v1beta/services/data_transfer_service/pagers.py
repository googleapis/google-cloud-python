...
class ListMulticloudDataTransferConfigsPager:
    ...
    :class:`google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferConfigsResponse` object, and
    ...
    All the usual :class:`google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferConfigsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferConfigsRequest):
                The initial request object.
            response (google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferConfigsResponse):
...
class ListDestinationsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.networkconnectivity_v1beta.types.ListDestinationsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``destinations`` field.
    ...
    All the usual :class:`google.cloud.networkconnectivity_v1beta.types.ListDestinationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.networkconnectivity_v1beta.types.ListDestinationsRequest):
                The initial request object.
            response (google.cloud.networkconnectivity_v1beta.types.ListDestinationsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListMulticloudDataTransferSupportedServicesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferSupportedServicesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferSupportedServicesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferSupportedServicesRequest):
                The initial request object.
            response (google.cloud.networkconnectivity_v1beta.types.ListMulticloudDataTransferSupportedServicesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

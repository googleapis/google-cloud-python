...
from google.cloud.networkconnectivity_v1beta.types import data_transfer
...
class DataTransferServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_multicloud_data_transfer_configs: gapic_v1.method.wrap_method(
                self.list_multicloud_data_transfer_configs,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_multicloud_data_transfer_config: gapic_v1.method.wrap_method(
                self.get_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_multicloud_data_transfer_config: gapic_v1.method.wrap_method(
                self.create_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_multicloud_data_transfer_config: gapic_v1.method.wrap_method(
                self.update_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_multicloud_data_transfer_config: gapic_v1.method.wrap_method(
                self.delete_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_destinations: gapic_v1.method.wrap_method(
                self.list_destinations,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_destination: gapic_v1.method.wrap_method(
                self.get_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_destination: gapic_v1.method.wrap_method(
                self.create_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_destination: gapic_v1.method.wrap_method(
                self.update_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_destination: gapic_v1.method.wrap_method(
                self.delete_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_multicloud_data_transfer_supported_service: gapic_v1.method.wrap_method(
                self.get_multicloud_data_transfer_supported_service,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_multicloud_data_transfer_supported_services: gapic_v1.method.wrap_method(
                self.list_multicloud_data_transfer_supported_services,
                default_timeout=60.0,
                client_info=client_info,
            ),

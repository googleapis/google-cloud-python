...
class PolicyBasedRoutingServiceClient(metaclass=PolicyBasedRoutingServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.networkconnectivity_v1beta.PolicyBasedRoutingServiceClient`.",
                    extra={
    ...
    def list_policy_based_routes(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.ListPolicyBasedRoutesRequest, dict]):
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.policy_based_routing_service.pagers.ListPolicyBasedRoutesPager:
                Response for
                   [PolicyBasedRoutingService.ListPolicyBasedRoutes][google.cloud.networkconnectivity.v1beta.PolicyBasedRoutingService.ListPolicyBasedRoutes]
                   method.
    ...
    def get_policy_based_route(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.GetPolicyBasedRouteRequest, dict]):
                The request object. Request for
    ...
    def create_policy_based_route(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.CreatePolicyBasedRouteRequest, dict]):
                The request object. Request for
    ...
    def delete_policy_based_route(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.networkconnectivity_v1beta.types.DeletePolicyBasedRouteRequest, dict]):
                The request object. Request for

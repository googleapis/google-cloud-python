...
from google.cloud.networkconnectivity_v1beta.services.policy_based_routing_service import (
    pagers,
)
from google.cloud.networkconnectivity_v1beta.types import common, policy_based_routing
...
class PolicyBasedRoutingServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            PolicyBasedRoutingServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(PolicyBasedRoutingServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            PolicyBasedRoutingServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            PolicyBasedRoutingServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return PolicyBasedRoutingServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    get_transport_class = PolicyBasedRoutingServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.networkconnectivity_v1beta.PolicyBasedRoutingServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_policy_based_routes():
                ...
                request = networkconnectivity_v1beta.ListPolicyBasedRoutesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networkconnectivity_v1beta.types.ListPolicyBasedRoutesRequest, dict]]):
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.services.policy_based_routing_service.pagers.ListPolicyBasedRoutesAsyncPager:
                Response for
                   [PolicyBasedRoutingService.ListPolicyBasedRoutes][google.cloud.networkconnectivity.v1beta.PolicyBasedRoutingService.ListPolicyBasedRoutes]
                   method.
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_policy_based_route():
                ...
                # Initialize request argument(s)
                request = networkconnectivity_v1beta.GetPolicyBasedRouteRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networkconnectivity_v1beta.types.GetPolicyBasedRouteRequest, dict]]):
                The request object. Request for
        ...
        Returns:
            google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute:
    ...
    async def create_policy_based_route(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.networkconnectivity_v1beta.types.CreatePolicyBasedRouteRequest, dict]]):
                The request object. Request for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            policy_based_route (:class:`google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.networkconnectivity_v1beta.types.PolicyBasedRoute` Policy-based routes route L4 network traffic based on not just destination IP
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_policy_based_route():
                ...
                # Initialize request argument(s)
                request = networkconnectivity_v1beta.DeletePolicyBasedRouteRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.networkconnectivity_v1beta.types.DeletePolicyBasedRouteRequest, dict]]):
                The request object. Request for
    ...
    async def __aenter__(self) -> "PolicyBasedRoutingServiceAsyncClient":
        return self

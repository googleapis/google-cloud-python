...
class ListPolicyBasedRoutesPager:
    ...
    :class:`google.cloud.networkconnectivity_v1beta.types.ListPolicyBasedRoutesResponse` object, and
    ...
    All the usual :class:`google.cloud.networkconnectivity_v1beta.types.ListPolicyBasedRoutesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.networkconnectivity_v1beta.types.ListPolicyBasedRoutesRequest):
                The initial request object.
            response (google.cloud.networkconnectivity_v1beta.types.ListPolicyBasedRoutesResponse):

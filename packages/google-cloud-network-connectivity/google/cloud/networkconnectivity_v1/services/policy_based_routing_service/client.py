...
class PolicyBasedRoutingServiceClient(metaclass=PolicyBasedRoutingServiceClientMeta):
    ...
    @staticmethod
    def policy_based_route_path(
        project: str,
        policy_based_route: str,
    ) -> str:
        """Returns a fully-qualified policy_based_route string."""
        return "projects/{project}/locations/global/PolicyBasedRoutes/{policy_based_route}".format(
            project=project,
    ...
    def parse_policy_based_route_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/global/PolicyBasedRoutes/(?P<policy_based_route>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = PolicyBasedRoutingServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = PolicyBasedRoutingServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or PolicyBasedRoutingServiceClient._get_api_endpoint(
    ...
    def create_policy_based_route(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_policy_based_route
        ]
    ...
    def delete_policy_based_route(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_policy_based_route
        ]

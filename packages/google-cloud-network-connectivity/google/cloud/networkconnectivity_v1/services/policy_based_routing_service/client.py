...
class PolicyBasedRoutingServiceClient(metaclass=PolicyBasedRoutingServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PolicyBasedRoutingServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or PolicyBasedRoutingServiceClient._get_api_endpoint(

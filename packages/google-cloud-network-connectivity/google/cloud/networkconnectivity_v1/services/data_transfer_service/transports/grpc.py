...
class DataTransferServiceGrpcTransport(DataTransferServiceTransport):
    ...
    def list_multicloud_data_transfer_configs(
        self,
    ) -> Callable[[data_transfer.ListMulticloudDataTransferConfigsRequest], data_transfer.ListMulticloudDataTransferConfigsResponse]:
        r"""Return a callable for the list multicloud data transfer
        configs method over gRPC.

        Lists the ``MulticloudDataTransferConfig`` resources in a
        specified project and location.

        Returns:
            Callable[[~.ListMulticloudDataTransferConfigsRequest],
    ...
    def get_multicloud_data_transfer_config(
        self,
    ) -> Callable[[data_transfer.GetMulticloudDataTransferConfigRequest], data_transfer.MulticloudDataTransferConfig]:
        ...
        Returns:
            Callable[[~.GetMulticloudDataTransferConfigRequest],
    ...
    @property
    def create_multicloud_data_transfer_config(self) -> Callable[[data_transfer.CreateMulticloudDataTransferConfigRequest], operations_pb2.Operation]:
        r"""Return a callable for the create multicloud data
        transfer config method over gRPC.

        Creates a ``MulticloudDataTransferConfig`` resource in a
        specified project and location.

        Returns:
            Callable[[~.CreateMulticloudDataTransferConfigRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    @property
    def update_multicloud_data_transfer_config(self) -> Callable[[data_transfer.UpdateMulticloudDataTransferConfigRequest], operations_pb2.Operation]:
        r"""Return a callable for the update multicloud data
        transfer config method over gRPC.

        Updates a ``MulticloudDataTransferConfig`` resource in a
        specified project and location.

        Returns:
            Callable[[~.UpdateMulticloudDataTransferConfigRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    @property
    def delete_multicloud_data_transfer_config(self) -> Callable[[data_transfer.DeleteMulticloudDataTransferConfigRequest], operations_pb2.Operation]:
        ...
        Returns:
            Callable[[~.DeleteMulticloudDataTransferConfigRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    @property
    def list_destinations(self) -> Callable[[data_transfer.ListDestinationsRequest], data_transfer.ListDestinationsResponse]:
        ...
        Returns:
            Callable[[~.ListDestinationsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_destinations" not in self._stubs:
            self._stubs["list_destinations"] = self._logged_channel.unary_unary(
                "/google.cloud.networkconnectivity.v1.DataTransferService/ListDestinations",
                request_serializer=data_transfer.ListDestinationsRequest.serialize,
                response_deserializer=data_transfer.ListDestinationsResponse.deserialize,
            )
        return self._stubs["list_destinations"]

    @property
    def get_destination(self) -> Callable[[data_transfer.GetDestinationRequest], data_transfer.Destination]:
        r"""Return a callable for the get destination method over gRPC.

        Gets the details of a ``Destination`` resource.

        Returns:
            Callable[[~.GetDestinationRequest],
                    ~.Destination]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_destination" not in self._stubs:
            self._stubs["get_destination"] = self._logged_channel.unary_unary(
                "/google.cloud.networkconnectivity.v1.DataTransferService/GetDestination",
                request_serializer=data_transfer.GetDestinationRequest.serialize,
                response_deserializer=data_transfer.Destination.deserialize,
            )
        return self._stubs["get_destination"]

    @property
    def create_destination(self) -> Callable[[data_transfer.CreateDestinationRequest], operations_pb2.Operation]:
        ...
        Returns:
            Callable[[~.CreateDestinationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_destination" not in self._stubs:
            self._stubs["create_destination"] = self._logged_channel.unary_unary(
                "/google.cloud.networkconnectivity.v1.DataTransferService/CreateDestination",
                request_serializer=data_transfer.CreateDestinationRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["create_destination"]

    @property
    def update_destination(self) -> Callable[[data_transfer.UpdateDestinationRequest], operations_pb2.Operation]:
        ...
        Returns:
            Callable[[~.UpdateDestinationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_destination" not in self._stubs:
            self._stubs["update_destination"] = self._logged_channel.unary_unary(
                "/google.cloud.networkconnectivity.v1.DataTransferService/UpdateDestination",
                request_serializer=data_transfer.UpdateDestinationRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["update_destination"]

    @property
    def delete_destination(self) -> Callable[[data_transfer.DeleteDestinationRequest], operations_pb2.Operation]:
        r"""Return a callable for the delete destination method over gRPC.

        Deletes a ``Destination`` resource.

        Returns:
            Callable[[~.DeleteDestinationRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_destination" not in self._stubs:
            self._stubs["delete_destination"] = self._logged_channel.unary_unary(
                "/google.cloud.networkconnectivity.v1.DataTransferService/DeleteDestination",
                request_serializer=data_transfer.DeleteDestinationRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["delete_destination"]

    @property
    def get_multicloud_data_transfer_supported_service(
        self,
    ) -> Callable[[data_transfer.GetMulticloudDataTransferSupportedServiceRequest], data_transfer.MulticloudDataTransferSupportedService]:
        r"""Return a callable for the get multicloud data transfer
        supported service method over gRPC.

        Gets the details of a service that is supported for
        Data Transfer Essentials.

        Returns:
            Callable[[~.GetMulticloudDataTransferSupportedServiceRequest],
    ...
    @property
    def list_multicloud_data_transfer_supported_services(
        self,
    ) -> Callable[
        [data_transfer.ListMulticloudDataTransferSupportedServicesRequest], data_transfer.ListMulticloudDataTransferSupportedServicesResponse
    ]:
        r"""Return a callable for the list multicloud data transfer
        supported services method over gRPC.

        Lists the services in the project for a region that
        are supported for Data Transfer Essentials.

        Returns:
            Callable[[~.ListMulticloudDataTransferSupportedServicesRequest],

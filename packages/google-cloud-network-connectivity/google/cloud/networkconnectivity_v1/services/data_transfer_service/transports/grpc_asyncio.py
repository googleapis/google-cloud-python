...
class DataTransferServiceGrpcAsyncIOTransport(DataTransferServiceTransport):
    ...
    def list_multicloud_data_transfer_configs(
        ...
        Returns:
            Callable[[~.ListMulticloudDataTransferConfigsRequest],
                    Awaitable[~.ListMulticloudDataTransferConfigsResponse]]:
    ...
    def get_multicloud_data_transfer_config(
        ...
        Returns:
            Callable[[~.GetMulticloudDataTransferConfigRequest],
                    Awaitable[~.MulticloudDataTransferConfig]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_multicloud_data_transfer_supported_service(
        ...
        Returns:
            Callable[[~.GetMulticloudDataTransferSupportedServiceRequest],
                    Awaitable[~.MulticloudDataTransferSupportedService]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_multicloud_data_transfer_supported_services(
        ...
        Returns:
            Callable[[~.ListMulticloudDataTransferSupportedServicesRequest],
                    Awaitable[~.ListMulticloudDataTransferSupportedServicesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_multicloud_data_transfer_configs: self._wrap_method(
                self.list_multicloud_data_transfer_configs,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_multicloud_data_transfer_config: self._wrap_method(
                self.get_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_multicloud_data_transfer_config: self._wrap_method(
                self.create_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_multicloud_data_transfer_config: self._wrap_method(
                self.update_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_multicloud_data_transfer_config: self._wrap_method(
                self.delete_multicloud_data_transfer_config,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_destinations: self._wrap_method(
                self.list_destinations,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_destination: self._wrap_method(
                self.get_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_destination: self._wrap_method(
                self.create_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_destination: self._wrap_method(
                self.update_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_destination: self._wrap_method(
                self.delete_destination,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.get_multicloud_data_transfer_supported_service: self._wrap_method(
                self.get_multicloud_data_transfer_supported_service,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_multicloud_data_transfer_supported_services: self._wrap_method(

...
class HubServiceClient(metaclass=HubServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = HubServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = HubServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = HubServiceClient._get_universe_domain(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                the fields to be overwritten in the Hub
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                Spoke resource by the update. The fields
                specified in the update_mask are
                relative to the resource, not the full
                request. A field will be overwritten if
                it is in the mask. If the user does not

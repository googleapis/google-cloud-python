...
class networkconnectivityCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_destination': ('parent', 'destination_id', 'destination', 'request_id', ),
        'create_hub': ('parent', 'hub_id', 'hub', 'request_id', ),
        'create_internal_range': ('parent', 'internal_range', 'internal_range_id', 'request_id', ),
        'create_multicloud_data_transfer_config': ('parent', 'multicloud_data_transfer_config_id', 'multicloud_data_transfer_config', 'request_id', ),
        ...
        'delete_destination': ('name', 'request_id', 'etag', ),
        'delete_hub': ('name', 'request_id', ),
        'delete_internal_range': ('name', 'request_id', ),
        'delete_multicloud_data_transfer_config': ('name', 'request_id', 'etag', ),
        ...
        'get_multicloud_data_transfer_config': ('name', ),
        'get_multicloud_data_transfer_supported_service': ('name', ),
        ...
        'get_spoke': ('name', ),
        'list_destinations': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'return_partial_success', ),
        ...
        'list_multicloud_data_transfer_configs': ('parent', 'page_size', 'page_token', 'filter', 'order_by', 'return_partial_success', ),
        'list_multicloud_data_transfer_supported_services': ('parent', 'page_size', 'page_token', ),
        ...
        'update_destination': ('destination', 'update_mask', 'request_id', ),
        ...
        'update_multicloud_data_transfer_config': ('multicloud_data_transfer_config', 'update_mask', 'request_id', ),

...
- While logged into your GitHub account, navigate to the
  ``python-network-connectivity`` `repo`_ on GitHub.

- Fork and clone the ``python-network-connectivity`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-network-connectivity`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-network-connectivity``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-network-connectivity.git hack-on-python-network-connectivity
   $ cd hack-on-python-network-connectivity
...
.. _repo: https://github.com/googleapis/python-network-connectivity

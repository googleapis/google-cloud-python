...
#
# Snippet for GetRemoteTransportProfile
...
def sample_get_remote_transport_profile():
    # Create a client
    client = networkconnectivity_v1beta.TransportManagerClient()

    # Initialize request argument(s)
    request = networkconnectivity_v1beta.GetRemoteTransportProfileRequest(
        name="name_value",
    )

    # Make the request
    response = client.get_remote_transport_profile(request=request)

...
def sample_accept_hub_spoke():
    ...
    request = networkconnectivity_v1beta.AcceptHubSpokeRequest(
        name="name_value",
...
# [END networkconnectivity_v1beta_generated_HubService_AcceptHubSpoke_sync]

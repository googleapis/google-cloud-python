...
async def sample_reject_spoke_update():
    # Create a client
    client = networkconnectivity_v1beta.HubServiceAsyncClient()

    # Initialize request argument(s)
    request = networkconnectivity_v1beta.RejectSpokeUpdateRequest(
        name="name_value",
...
# [END networkconnectivity_v1beta_generated_HubService_RejectSpokeUpdate_async]

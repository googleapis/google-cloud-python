...
#
# Snippet for DeleteInternalRange
...
def sample_delete_internal_range():
    # Create a client
    client = networkconnectivity_v1.InternalRangeServiceClient()

    # Initialize request argument(s)
    request = networkconnectivity_v1.DeleteInternalRangeRequest(
        name="name_value",
    )

    # Make the request
    operation = client.delete_internal_range(request=request)

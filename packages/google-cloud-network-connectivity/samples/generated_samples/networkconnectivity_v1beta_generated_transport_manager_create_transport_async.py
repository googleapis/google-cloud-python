...
async def sample_create_transport():
    # Create a client
    client = networkconnectivity_v1beta.TransportManagerAsyncClient()

    # Initialize request argument(s)
    request = networkconnectivity_v1beta.CreateTransportRequest(
        parent="parent_value",
        transport_id="transport_id_value",
    )

    # Make the request
    operation = await client.create_transport(request=request)

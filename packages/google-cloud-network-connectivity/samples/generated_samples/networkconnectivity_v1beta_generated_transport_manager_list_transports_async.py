...
async def sample_list_transports():
    # Create a client
    client = networkconnectivity_v1beta.TransportManagerAsyncClient()

    # Initialize request argument(s)
    request = networkconnectivity_v1beta.ListTransportsRequest(
        parent="parent_value",
    )

    # Make the request
    page_result = client.list_transports(request=request)
...
# [END networkconnectivity_v1beta_generated_TransportManager_ListTransports_async]

...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for sqlalchemy-spanner",
...
htmlhelp_basename = "sqlalchemy-spanner-doc"
...
latex_documents = [
    (
        root_doc,
        "sqlalchemy-spanner.tex",
        "sqlalchemy-spanner Documentation",
        author,
        "manual",
    )
]

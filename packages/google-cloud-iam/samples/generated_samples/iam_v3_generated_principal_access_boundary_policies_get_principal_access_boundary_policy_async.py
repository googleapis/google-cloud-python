...
#
# Snippet for GetPrincipalAccessBoundaryPolicy
...
async def sample_get_principal_access_boundary_policy():
    # Create a client
    client = iam_v3.PrincipalAccessBoundaryPoliciesAsyncClient()

    # Initialize request argument(s)
    request = iam_v3.GetPrincipalAccessBoundaryPolicyRequest(
        name="name_value",
    )

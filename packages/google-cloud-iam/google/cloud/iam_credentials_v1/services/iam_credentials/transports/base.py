...
class IAMCredentialsTransport(abc.ABC):
    ...
    def generate_access_token(
        self,
    ) -> Callable[[common.GenerateAccessTokenRequest], Union[common.GenerateAccessTokenResponse, Awaitable[common.GenerateAccessTokenResponse]]]:
        raise NotImplementedError()

    @property
    def generate_id_token(
        self,
    ) -> Callable[[common.GenerateIdTokenRequest], Union[common.GenerateIdTokenResponse, Awaitable[common.GenerateIdTokenResponse]]]:
        raise NotImplementedError()

    @property
    def sign_blob(self) -> Callable[[common.SignBlobRequest], Union[common.SignBlobResponse, Awaitable[common.SignBlobResponse]]]:
        raise NotImplementedError()

    @property
    def sign_jwt(self) -> Callable[[common.SignJwtRequest], Union[common.SignJwtResponse, Awaitable[common.SignJwtResponse]]]:
        raise NotImplementedError()

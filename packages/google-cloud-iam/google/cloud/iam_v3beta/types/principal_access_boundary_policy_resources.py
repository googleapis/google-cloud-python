...
class PrincipalAccessBoundaryPolicy(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            updated.
        details (google.cloud.iam_v3beta.types.PrincipalAccessBoundaryPolicyDetails):
...
class PrincipalAccessBoundaryPolicyDetails(proto.Message):
    ...
    Attributes:
        rules (MutableSequence[google.cloud.iam_v3beta.types.PrincipalAccessBoundaryPolicyRule]):

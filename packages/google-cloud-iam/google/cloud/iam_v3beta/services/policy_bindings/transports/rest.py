    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[PolicyBindingsRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.CreatePolicyBinding",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsClient.create_policy_binding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "CreatePolicyBinding",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.DeletePolicyBinding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsClient.delete_policy_binding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "DeletePolicyBinding",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.GetPolicyBinding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsClient.get_policy_binding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "GetPolicyBinding",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.ListPolicyBindings",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsClient.list_policy_bindings",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "ListPolicyBindings",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.SearchTargetPolicyBindings",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsClient.search_target_policy_bindings",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "SearchTargetPolicyBindings",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.UpdatePolicyBinding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsClient.update_policy_binding",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "UpdatePolicyBinding",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3beta.PolicyBindingsClient.GetOperation",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3beta.PolicyBindingsAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.iam.v3beta.PolicyBindings",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

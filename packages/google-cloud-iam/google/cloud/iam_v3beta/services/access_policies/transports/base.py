...
class AccessPoliciesTransport(abc.ABC):
    """Abstract transport class for AccessPolicies."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.search_access_policy_bindings: gapic_v1.method.wrap_method(
...
__all__ = ("AccessPoliciesTransport",)

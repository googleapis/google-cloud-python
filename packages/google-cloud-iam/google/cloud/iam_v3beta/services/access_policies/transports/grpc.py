...
from .base import DEFAULT_CLIENT_INFO, AccessPoliciesTransport
...
class AccessPoliciesGrpcTransport(AccessPoliciesTransport):
    """gRPC backend transport for AccessPolicies.
    ...
    def create_access_policy(
        ...
        Returns:
            Callable[[~.CreateAccessPolicyRequest],
                    ~.Operation]:
        ...
        if "create_access_policy" not in self._stubs:
            self._stubs["create_access_policy"] = self._logged_channel.unary_unary(
                ...
                request_serializer=access_policies_service.CreateAccessPolicyRequest.serialize,
    ...
    def get_access_policy(
        ...
        if "get_access_policy" not in self._stubs:
            self._stubs["get_access_policy"] = self._logged_channel.unary_unary(
                ...
                request_serializer=access_policies_service.GetAccessPolicyRequest.serialize,
                response_deserializer=access_policy_resources.AccessPolicy.deserialize,
            )
    ...
    def update_access_policy(
        ...
        if "update_access_policy" not in self._stubs:
            self._stubs["update_access_policy"] = self._logged_channel.unary_unary(
                ...
                request_serializer=access_policies_service.UpdateAccessPolicyRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def delete_access_policy(
        ...
        if "delete_access_policy" not in self._stubs:
            self._stubs["delete_access_policy"] = self._logged_channel.unary_unary(
                ...
                request_serializer=access_policies_service.DeleteAccessPolicyRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def list_access_policies(
        ...
        if "list_access_policies" not in self._stubs:
            self._stubs["list_access_policies"] = self._logged_channel.unary_unary(
                ...
                request_serializer=access_policies_service.ListAccessPoliciesRequest.serialize,
                response_deserializer=access_policies_service.ListAccessPoliciesResponse.deserialize,
            )
    ...
    def search_access_policy_bindings(
        ...
        r"""Return a callable for the search access policy bindings method over gRPC.
        ...
        Returns:
            Callable[[~.SearchAccessPolicyBindingsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "search_access_policy_bindings" not in self._stubs:
            self._stubs["search_access_policy_bindings"] = (
                self._logged_channel.unary_unary(
                    "/google.iam.v3beta.AccessPolicies/SearchAccessPolicyBindings",
                    request_serializer=access_policies_service.SearchAccessPolicyBindingsRequest.serialize,
                    response_deserializer=access_policies_service.SearchAccessPolicyBindingsResponse.deserialize,
                )
            )
        return self._stubs["search_access_policy_bindings"]
...
__all__ = ("AccessPoliciesGrpcTransport",)

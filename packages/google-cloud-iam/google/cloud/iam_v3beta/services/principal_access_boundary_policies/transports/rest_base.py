...
class _BasePrincipalAccessBoundaryPoliciesRestTransport(PrincipalAccessBoundaryPoliciesTransport):
    ...
    class _BaseCreatePrincipalAccessBoundaryPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v3beta/{parent=organizations/*/locations/*}/principalAccessBoundaryPolicies",
    ...
    class _BaseDeletePrincipalAccessBoundaryPolicy:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v3beta/{name=organizations/*/locations/*/principalAccessBoundaryPolicies/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetPrincipalAccessBoundaryPolicy:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListPrincipalAccessBoundaryPolicies:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseSearchPrincipalAccessBoundaryPolicyBindings:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v3beta/{name=organizations/*/locations/*/principalAccessBoundaryPolicies/*}:searchPolicyBindings",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePrincipalAccessBoundaryPoliciesRestTransport._BaseSearchPrincipalAccessBoundaryPolicyBindings._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdatePrincipalAccessBoundaryPolicy:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v3beta/{principal_access_boundary_policy.name=organizations/*/locations/*/principalAccessBoundaryPolicies/*}",
                    "body": "principal_access_boundary_policy",
                },
            ]
            return http_options
...
__all__ = ("_BasePrincipalAccessBoundaryPoliciesRestTransport",)

...
class AccessPolicy(proto.Message):
    ...
    Attributes:
        ...
        details (google.cloud.iam_v3.types.AccessPolicyDetails):
...
class AccessPolicyDetails(proto.Message):
    ...
    Attributes:
        rules (MutableSequence[google.cloud.iam_v3.types.AccessPolicyRule]):
...
class AccessPolicyRule(proto.Message):
    ...
    Attributes:
        ...
        effect (google.cloud.iam_v3.types.AccessPolicyRule.Effect):
        ...
        excluded_principals (MutableSequence[str]):
            ...
            that group.
        operation (google.cloud.iam_v3.types.AccessPolicyRule.Operation):

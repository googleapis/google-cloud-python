...
from google.cloud.iam_v3.types import access_policy_resources, policy_binding_resources
...
class ListAccessPoliciesResponse(proto.Message):
    ...
    Attributes:
        access_policies (MutableSequence[google.cloud.iam_v3.types.AccessPolicy]):

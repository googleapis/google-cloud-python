...
from .services.principal_access_boundary_policies import PrincipalAccessBoundaryPoliciesAsyncClient, PrincipalAccessBoundaryPoliciesClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.iam_v3")  # type: ignore
    api_core.check_dependency_versions("google.cloud.iam_v3")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.iam_v3"

...
from .base import DEFAULT_CLIENT_INFO, PolicyBindingsTransport
...
class PolicyBindingsGrpcTransport(PolicyBindingsTransport):
    """gRPC backend transport for PolicyBindings.
    ...
    def create_policy_binding(
        ...
        Returns:
            Callable[[~.CreatePolicyBindingRequest],
                    ~.Operation]:
        ...
        if "create_policy_binding" not in self._stubs:
            self._stubs["create_policy_binding"] = self._logged_channel.unary_unary(
                "/google.iam.v3.PolicyBindings/CreatePolicyBinding",
                request_serializer=policy_bindings_service.CreatePolicyBindingRequest.serialize,
    ...
    def get_policy_binding(
        ...
        Returns:
            Callable[[~.GetPolicyBindingRequest],
                    ~.PolicyBinding]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_policy_binding" not in self._stubs:
            self._stubs["get_policy_binding"] = self._logged_channel.unary_unary(
                "/google.iam.v3.PolicyBindings/GetPolicyBinding",
                request_serializer=policy_bindings_service.GetPolicyBindingRequest.serialize,
                response_deserializer=policy_binding_resources.PolicyBinding.deserialize,
            )
    ...
    def update_policy_binding(
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_policy_binding" not in self._stubs:
            self._stubs["update_policy_binding"] = self._logged_channel.unary_unary(
                "/google.iam.v3.PolicyBindings/UpdatePolicyBinding",
                request_serializer=policy_bindings_service.UpdatePolicyBindingRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def delete_policy_binding(
        ...
        Returns:
            Callable[[~.DeletePolicyBindingRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_policy_binding" not in self._stubs:
            self._stubs["delete_policy_binding"] = self._logged_channel.unary_unary(
                "/google.iam.v3.PolicyBindings/DeletePolicyBinding",
                request_serializer=policy_bindings_service.DeletePolicyBindingRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["delete_policy_binding"]
    ...
    def list_policy_bindings(
        ...
        Returns:
            Callable[[~.ListPolicyBindingsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_policy_bindings" not in self._stubs:
            self._stubs["list_policy_bindings"] = self._logged_channel.unary_unary(
                "/google.iam.v3.PolicyBindings/ListPolicyBindings",
                request_serializer=policy_bindings_service.ListPolicyBindingsRequest.serialize,
                response_deserializer=policy_bindings_service.ListPolicyBindingsResponse.deserialize,
            )
        return self._stubs["list_policy_bindings"]
    ...
    def search_target_policy_bindings(
        ...
        Returns:
            Callable[[~.SearchTargetPolicyBindingsRequest],
        ...
        if "search_target_policy_bindings" not in self._stubs:
            self._stubs["search_target_policy_bindings"] = (
        ...
        return self._stubs["search_target_policy_bindings"]
...
__all__ = ("PolicyBindingsGrpcTransport",)

...
class PolicyBindingsClient(metaclass=PolicyBindingsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = PolicyBindingsClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or PolicyBindingsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.iam_v3.PolicyBindingsClient`.",
                    extra={
    ...
    def create_policy_binding(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.CreatePolicyBindingRequest, dict]):
    ...
    def get_policy_binding(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.GetPolicyBindingRequest, dict]):
    ...
    def update_policy_binding(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.UpdatePolicyBindingRequest, dict]):
                The request object. Request message for
    ...
    def delete_policy_binding(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.DeletePolicyBindingRequest, dict]):
                The request object. Request message for
    ...
    def list_policy_bindings(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.ListPolicyBindingsRequest, dict]):
                The request object. Request message for
    ...
    def search_target_policy_bindings(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.iam_v3.types.SearchTargetPolicyBindingsRequest, dict]):
                The request object. Request message for

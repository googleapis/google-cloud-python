...
from google.cloud.iam_v3._compat import (
    get_api_endpoint,
...
class PrincipalAccessBoundaryPoliciesClient(
    ...
    @staticmethod
    def principal_access_boundary_policy_path(
        organization: str,
        location: str,
        principal_access_boundary_policy: str,
    ) -> str:
        """Returns a fully-qualified principal_access_boundary_policy string."""
        return "organizations/{organization}/locations/{location}/principalAccessBoundaryPolicies/{principal_access_boundary_policy}".format(
            organization=organization,
            location=location,
            principal_access_boundary_policy=principal_access_boundary_policy,
        )
    ...
    def parse_principal_access_boundary_policy_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/principalAccessBoundaryPolicies/(?P<principal_access_boundary_policy>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=PrincipalAccessBoundaryPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE,
...
__all__ = ("PrincipalAccessBoundaryPoliciesClient",)

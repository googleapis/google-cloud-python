        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.CreateAccessPolicy",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesClient.create_access_policy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "CreateAccessPolicy",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.DeleteAccessPolicy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesClient.delete_access_policy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "DeleteAccessPolicy",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.GetAccessPolicy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesClient.get_access_policy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "GetAccessPolicy",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.ListAccessPolicies",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesClient.list_access_policies",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "ListAccessPolicies",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.SearchAccessPolicyBindings",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesClient.search_access_policy_bindings",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "SearchAccessPolicyBindings",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.UpdateAccessPolicy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesClient.update_access_policy",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "UpdateAccessPolicy",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.iam_v3.AccessPoliciesClient.GetOperation",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.iam_v3.AccessPoliciesAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.iam.v3.AccessPolicies",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,

...
from google.cloud.iam_v3.types import access_policies_service, access_policy_resources

from .base import DEFAULT_CLIENT_INFO, AccessPoliciesTransport
from .grpc import AccessPoliciesGrpcTransport
...
class AccessPoliciesGrpcAsyncIOTransport(AccessPoliciesTransport):
    """gRPC AsyncIO backend transport for AccessPolicies.
    ...
    def get_access_policy(
        ...
        Awaitable[access_policy_resources.AccessPolicy],
    ]:
    ...
    def search_access_policy_bindings(
        ...
        Returns:
            Callable[[~.SearchAccessPolicyBindingsRequest],
                    Awaitable[~.SearchAccessPolicyBindingsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.search_access_policy_bindings: self._wrap_method(
                self.search_access_policy_bindings,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
...
__all__ = ("AccessPoliciesGrpcAsyncIOTransport",)

...
class ListAccessPoliciesPager:
    ...
    :class:`google.cloud.iam_v3.types.ListAccessPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.iam_v3.types.ListAccessPoliciesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.iam_v3.types.ListAccessPoliciesRequest):
                The initial request object.
            response (google.cloud.iam_v3.types.ListAccessPoliciesResponse):
...
class SearchAccessPolicyBindingsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.iam_v3.types.SearchAccessPolicyBindingsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.iam_v3.types.SearchAccessPolicyBindingsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.iam_v3.types.SearchAccessPolicyBindingsRequest):
                The initial request object.
            response (google.cloud.iam_v3.types.SearchAccessPolicyBindingsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

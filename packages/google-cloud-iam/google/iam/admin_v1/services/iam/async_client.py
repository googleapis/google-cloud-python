...
class IAMAsyncClient:
    ...
    async def list_service_accounts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.ListServiceAccountsRequest, dict]]):
    ...
    async def get_service_account(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.GetServiceAccountRequest, dict]]):
    ...
    async def create_service_account(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.CreateServiceAccountRequest, dict]]):
    ...
    async def update_service_account(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.ServiceAccount, dict]]):
    ...
    async def patch_service_account(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.PatchServiceAccountRequest, dict]]):
    ...
    async def delete_service_account(
        ...
        **Warning:** After you delete a service account, you might not
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.DeleteServiceAccountRequest, dict]]):
    ...
    async def undelete_service_account(
        ...
        **Important:** It is not always possible to restore a deleted
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.UndeleteServiceAccountRequest, dict]]):
    ...
    async def enable_service_account(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.EnableServiceAccountRequest, dict]]):
    ...
    async def disable_service_account(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.DisableServiceAccountRequest, dict]]):
    ...
    async def list_service_account_keys(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.ListServiceAccountKeysRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            key_types (:class:`MutableSequence[google.iam.admin_v1.types.ListServiceAccountKeysRequest.KeyType]`):
    ...
    async def get_service_account_key(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.GetServiceAccountKeyRequest, dict]]):
    ...
    async def create_service_account_key(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.CreateServiceAccountKeyRequest, dict]]):
    ...
    async def upload_service_account_key(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.UploadServiceAccountKeyRequest, dict]]):
    ...
    async def delete_service_account_key(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.DeleteServiceAccountKeyRequest, dict]]):
    ...
    async def disable_service_account_key(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.DisableServiceAccountKeyRequest, dict]]):
    ...
    async def enable_service_account_key(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.EnableServiceAccountKeyRequest, dict]]):
    ...
    async def sign_blob(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.SignBlobRequest, dict]]):
    ...
    async def sign_jwt(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.SignJwtRequest, dict]]):
                The request object. Deprecated. `Migrate to Service Account Credentials
                API <https://cloud.google.com/iam/help/credentials/migrate-api>`__.
    ...
    async def query_grantable_roles(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.QueryGrantableRolesRequest, dict]]):
    ...
    async def list_roles(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.ListRolesRequest, dict]]):
    ...
    async def get_role(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.GetRoleRequest, dict]]):
    ...
    async def create_role(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.CreateRoleRequest, dict]]):
    ...
    async def update_role(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.UpdateRoleRequest, dict]]):
    ...
    async def delete_role(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.DeleteRoleRequest, dict]]):
    ...
    async def undelete_role(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.UndeleteRoleRequest, dict]]):
    ...
    async def query_testable_permissions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.QueryTestablePermissionsRequest, dict]]):
    ...
    async def query_auditable_services(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.QueryAuditableServicesRequest, dict]]):
    ...
    async def lint_policy(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.iam.admin_v1.types.LintPolicyRequest, dict]]):

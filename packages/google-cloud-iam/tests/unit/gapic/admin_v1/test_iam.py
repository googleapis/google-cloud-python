...
from google.iam.admin_v1.services.iam import (
    IAMAsyncClient,
    IAMClient,
    pagers,
    transports,
...
def test_iam_client_client_options_from_dict():
    with mock.patch(
        "google.iam.admin_v1.services.iam.transports.IAMGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_iam_base_transport():
    ...
    with mock.patch(
        "google.iam.admin_v1.services.iam.transports.IAMTransport.__init__"
    ) as Transport:
...
def test_iam_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.iam.admin_v1.services.iam.transports.IAMTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

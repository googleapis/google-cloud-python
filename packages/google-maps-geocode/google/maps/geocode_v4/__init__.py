...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.maps.geocode_v4")  # type: ignore
    api_core.check_dependency_versions("google.maps.geocode_v4")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.geocode_v4"

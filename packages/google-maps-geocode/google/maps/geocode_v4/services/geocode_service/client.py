...
from .transports.grpc import GeocodeServiceGrpcTransport
from .transports.grpc_asyncio import GeocodeServiceGrpcAsyncIOTransport
from .transports.rest import GeocodeServiceRestTransport


class GeocodeServiceClientMeta(type):
    """Metaclass for the GeocodeService client.
...
class GeocodeServiceClient(metaclass=GeocodeServiceClientMeta):
    ...
    DEFAULT_ENDPOINT = "geocoding-backend.googleapis.com"
    DEFAULT_MTLS_ENDPOINT = _get_default_mtls_endpoint.__func__(  # type: ignore
        DEFAULT_ENDPOINT
    )

    _DEFAULT_ENDPOINT_TEMPLATE = "geocoding-backend.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GeocodeServiceClient: The constructed client.
        """
    ...
    def transport(self) -> GeocodeServiceTransport:
        ...
        Returns:
            GeocodeServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = GeocodeServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = GeocodeServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GeocodeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = GeocodeServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the geocode service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            GeocodeServiceClient._read_environment_variables()
        )
        self._client_cert_source = GeocodeServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = GeocodeServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, GeocodeServiceTransport)
        if transport_provided:
            # transport is a GeocodeServiceTransport instance.
            ...
            self._transport = cast(GeocodeServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or GeocodeServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[GeocodeServiceTransport], Callable[..., GeocodeServiceTransport]
            ] = (
                GeocodeServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GeocodeServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.maps.geocode_v4.GeocodeServiceClient`.",
                    extra={
    ...
    def geocode_address(
        ...
        *,
        ...
        Args:
            request (Union[google.maps.geocode_v4.types.GeocodeAddressRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.geocode_address]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_geocode_location():
                ...
                # Make the request
                response = client.geocode_location(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.maps.geocode_v4.types.GeocodeLocationRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.geocode_location]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_geocode_place():
                ...
                # Make the request
                response = client.geocode_place(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.maps.geocode_v4.types.GeocodePlaceRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.geocode_place]
    ...
    def __enter__(self) -> "GeocodeServiceClient":
        return self

...
from google.maps.geocode_v4._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=GeocodeServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=GeocodeServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=GeocodeServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

...
##
# google-maps-geocode documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Maps Client Libraries for google-maps-geocode",
...
htmlhelp_basename = "google-maps-geocode-doc"
...
latex_documents = [
    (
        root_doc,
        "google-maps-geocode.tex",
        "google-maps-geocode Documentation",
        author,
        "manual",
    )
]

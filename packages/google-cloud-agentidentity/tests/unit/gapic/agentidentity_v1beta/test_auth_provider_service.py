...
from google.cloud.agentidentity_v1beta.services.auth_provider_service import (
...
def test_auth_provider_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.agentidentity_v1beta.services.auth_provider_service.transports.AuthProviderServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_auth_providers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/authProviders"
...
def test_get_auth_provider_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_auth_provider_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{auth_provider.name=projects/*/locations/*/authProviders/*}"
            % client.transport._host,
            args[1],
        )
...
def test_undelete_auth_provider_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*}:undelete"
            % client.transport._host,
            args[1],
        )
...
def test_query_auth_providers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/authProviders:query"
            % client.transport._host,
            args[1],
        )
...
def test_query_workloads_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*}:queryWorkloads"
            % client.transport._host,
            args[1],
        )
...
def test_list_authorizations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/authProviders/*}/authorizations"
            % client.transport._host,
            args[1],
        )
...
def test_get_authorization_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*/authorizations/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_access_summaries_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/accessSummaries"
            % client.transport._host,
            args[1],
        )
...
def test_get_access_summary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/accessSummaries/*}"
            % client.transport._host,
            args[1],
        )
...
def test_revoke_authorization_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*}:revokeAuthorization"
            % client.transport._host,
            args[1],
        )
...
def test_enable_auth_provider_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*}:enable"
            % client.transport._host,
            args[1],
        )
...
def test_disable_auth_provider_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/authProviders/*}:disable"
            % client.transport._host,
            args[1],
        )
...
def test_auth_provider_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.agentidentity_v1beta.services.auth_provider_service.transports.AuthProviderServiceTransport.__init__"
    ) as Transport:
...
def test_auth_provider_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.agentidentity_v1beta.services.auth_provider_service.transports.AuthProviderServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

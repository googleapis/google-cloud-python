...
##
# google-cloud-agentidentity documentation build configuration file
#
...
project = "google-cloud-agentidentity"
copyright = "2026, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-agentidentity",
...
htmlhelp_basename = "google-cloud-agentidentity-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-agentidentity.tex",
        "google-cloud-agentidentity Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-agentidentity",
        "google-cloud-agentidentity Library",
        "APIs",
    )
]

Python Client for Agent Identity
================================
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-agentidentity.svg
   :target: https://pypi.org/project/google-cloud-agentidentity/
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-agentidentity.svg
   :target: https://pypi.org/project/google-cloud-agentidentity/
.. _Agent Identity: https://cloud.google.com/agentidentity/
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-agentidentity/latest/summary_overview
.. _Product Documentation:  https://cloud.google.com/agentidentity/
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-agentidentity/samples
...
.. code-block:: console
    ...
    pip install google-cloud-agentidentity
...
-  Read the `Client Library Documentation`_ for Agent Identity
   to see other available methods on the client.
-  Read the `Agent Identity Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Agent Identity Product documentation:  https://cloud.google.com/agentidentity/

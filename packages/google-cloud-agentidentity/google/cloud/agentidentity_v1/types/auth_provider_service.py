...
class AuthProvider(proto.Message):
    ...
    class AuthProviderTypeParams(proto.Message):
        ...
        Attributes:
            three_legged_oauth (google.cloud.agentidentity_v1.types.ThreeLeggedOAuth):
                ThreeLeggedOAuth AuthProvider type
                parameters.

                This field is a member of `oneof`_ ``type``.
            two_legged_oauth (google.cloud.agentidentity_v1.types.TwoLeggedOAuth):
                TwoLeggedOAuth AuthProvider type parameters.

                This field is a member of `oneof`_ ``type``.
            api_key (google.cloud.agentidentity_v1.types.ApiKeyParams):
                ApiKey AuthProvider type parameters.

                This field is a member of `oneof`_ ``type``.
            ge_auth_provider (google.cloud.agentidentity_v1.types.GeminiEnterpriseAuthProviderParams):
...
class ListAuthProvidersResponse(proto.Message):
    ...
    Attributes:
        auth_providers (MutableSequence[google.cloud.agentidentity_v1.types.AuthProvider]):
...
class ListAuthorizationsResponse(proto.Message):
    ...
    Attributes:
        authorizations (MutableSequence[google.cloud.agentidentity_v1.types.Authorization]):
...
class AccessSummary(proto.Message):
    ...
    Attributes:
        ...
        auth_provider_type (google.cloud.agentidentity_v1.types.AuthProviderType):
...
class ListAccessSummariesResponse(proto.Message):
    ...
    Attributes:
        access_summaries (MutableSequence[google.cloud.agentidentity_v1.types.AccessSummary]):

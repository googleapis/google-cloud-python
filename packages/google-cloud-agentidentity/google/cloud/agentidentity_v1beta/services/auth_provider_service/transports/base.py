...
class AuthProviderServiceTransport(abc.ABC):
    """Abstract transport class for AuthProviderService."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "agentidentity.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_auth_providers: gapic_v1.method.wrap_method(
                self.list_auth_providers,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_auth_provider: gapic_v1.method.wrap_method(
                self.get_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_auth_provider: gapic_v1.method.wrap_method(
                self.create_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_auth_provider: gapic_v1.method.wrap_method(
                self.update_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_auth_provider: gapic_v1.method.wrap_method(
                self.delete_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
            self.undelete_auth_provider: gapic_v1.method.wrap_method(
                self.undelete_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
            self.query_auth_providers: gapic_v1.method.wrap_method(
                self.query_auth_providers,
                default_timeout=None,
                client_info=client_info,
            ),
            self.query_workloads: gapic_v1.method.wrap_method(
                self.query_workloads,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_authorizations: gapic_v1.method.wrap_method(
            ...
            self.delete_authorization: gapic_v1.method.wrap_method(
                self.delete_authorization,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_access_summaries: gapic_v1.method.wrap_method(
                self.list_access_summaries,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_access_summary: gapic_v1.method.wrap_method(
                self.get_access_summary,
                default_timeout=None,
                client_info=client_info,
            ),
            self.revoke_authorization: gapic_v1.method.wrap_method(
                self.revoke_authorization,
                default_timeout=None,
                client_info=client_info,
            ),
            self.enable_auth_provider: gapic_v1.method.wrap_method(
                self.enable_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
            self.disable_auth_provider: gapic_v1.method.wrap_method(
                self.disable_auth_provider,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_auth_provider(
        ...
        Union[
            ...
            Awaitable[auth_provider_service.AuthProvider],
        ],
    ]:
        raise NotImplementedError()
    ...
    def query_workloads(
        ...
        Union[
            ...
            Awaitable[auth_provider_service.QueryWorkloadsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_authorization(
        ...
        Union[
            ...
            Awaitable[auth_provider_service.Authorization],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_access_summary(
        ...
        Union[
            ...
            Awaitable[auth_provider_service.AccessSummary],
        ],
    ]:
        raise NotImplementedError()
    ...
    def revoke_authorization(
        ...
        Union[
            ...
            Awaitable[auth_provider_service.RevokeAuthorizationResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("AuthProviderServiceTransport",)

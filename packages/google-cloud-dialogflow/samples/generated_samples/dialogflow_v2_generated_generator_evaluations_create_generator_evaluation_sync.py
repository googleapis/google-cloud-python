...
def sample_create_generator_evaluation():
    # Create a client
    client = dialogflow_v2.GeneratorEvaluationsClient()

    # Initialize request argument(s)
    generator_evaluation = dialogflow_v2.GeneratorEvaluation()
    ...
    request = dialogflow_v2.CreateGeneratorEvaluationRequest(
        parent="parent_value",

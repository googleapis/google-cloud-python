...
class dialogflowCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'bidi_streaming_analyze_content': ('config', 'input', ),
        ...
        'create_generator_evaluation': ('parent', 'generator_evaluation', ),
        ...
        'create_tool': ('parent', 'tool', 'tool_id', ),
        ...
        'delete_generator_evaluation': ('name', ),
        'delete_intent': ('name', ),
        ...
        'generate_stateless_suggestion': ('parent', 'generator', 'generator_name', 'context_references', 'conversation_context', 'trigger_events', 'security_settings', ),
        ...
        'list_generator_evaluations': ('parent', 'page_size', 'page_token', ),

...
class dialogflowCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'clear_suggestion_feature_config': ('conversation_profile', 'participant_role', 'suggestion_feature_type', ),
        'complete_conversation': ('name', ),
        'create_context': ('parent', 'context', ),
        'create_conversation': ('parent', 'conversation', 'conversation_id', ),
        'create_conversation_dataset': ('parent', 'conversation_dataset', ),
        'create_conversation_model': ('conversation_model', 'parent', ),
        'create_conversation_model_evaluation': ('parent', 'conversation_model_evaluation', ),
        ...
        'create_generator': ('parent', 'generator', 'generator_id', ),
        ...
        'delete_context': ('name', ),
        'delete_conversation_dataset': ('name', ),
        'delete_conversation_model': ('name', ),
        ...
        'delete_version': ('name', ),
        'deploy_conversation_model': ('name', ),
        ...
        'get_conversation_dataset': ('name', ),
        'get_conversation_model': ('name', ),
        'get_conversation_model_evaluation': ('name', ),
        ...
        'list_conversation_datasets': ('parent', 'page_size', 'page_token', ),
        'list_conversation_model_evaluations': ('parent', 'page_size', 'page_token', ),
        'list_conversation_models': ('parent', 'page_size', 'page_token', ),
        ...
        'list_generators': ('parent', 'page_size', 'page_token', ),
        ...
        'train_agent': ('parent', ),
        'undeploy_conversation_model': ('name', ),
        ...
        'update_generator': ('generator', 'update_mask', ),

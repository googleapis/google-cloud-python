...
class AgentsClient(object):
    ...
    def set_agent(
        ...
        Args:
            agent (Union[dict, ~google.cloud.dialogflow_v2beta1.types.Agent]): Required. The agent to update.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.dialogflow_v2beta1.types.Agent`
    ...
    def search_agents(
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.dialogflow_v2beta1.types.Agent` instances.
    ...
    def get_validation_result(
        ...
        Returns:
            A :class:`~google.cloud.dialogflow_v2beta1.types.ValidationResult` instance.

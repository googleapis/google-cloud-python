...
DetectIntentResponse = _reflection.GeneratedProtocolMessageType('DetectIntentResponse', (_message.Message,), dict(
  ...
  Attributes:
      ...
      alternative_query_results:
          ...
          Knowledge Connectors are disabled this field will be empty at
...
QueryParameters = _reflection.GeneratedProtocolMessageType('QueryParameters', (_message.Message,), dict(
  ...
  Attributes:
      ...
      knowledge_base_names:
          ...
          ID>/knowledgeBases/<Knowledge Base ID>``.  Note: This field is
          ``repeated`` for forward compatibility, currently only the
          first one is supported, we may return an error if multiple
  ...
  Answer = _reflection.GeneratedProtocolMessageType('Answer', (_message.Message,), dict(
    ...
    Attributes:
        ...
        match_confidence:
            ...
            good match for this converstational query, range from 0.0
            ...
            using ``match_confidence_level`` which should be generally
            more stable.
    """,
...
_SESSIONS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\231\001\";/v2beta1/{session=projects/*/agent/sessions/*}:detectIntent:\001*ZW\"R/v2beta1/{session=projects/*/agent/environments/*/users/*/sessions/*}:detectIntent:\001*')),
  ),
  _descriptor.MethodDescriptor(

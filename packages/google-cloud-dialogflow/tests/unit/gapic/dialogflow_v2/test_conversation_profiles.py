...
def test__get_api_endpoint():
    ...
    assert (
        ConversationProfilesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        ConversationProfilesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ConversationProfilesClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_conversation_profiles_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow_v2.services.conversation_profiles.transports.ConversationProfilesGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_list_conversation_profiles_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_conversation_profiles), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_conversation_profiles(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_create_conversation_profile_async(
    transport: str = "grpc_asyncio", request_type=gcd_conversation_profile.CreateConversationProfileRequest
):
    client = ConversationProfilesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_update_conversation_profile_async(
    transport: str = "grpc_asyncio", request_type=gcd_conversation_profile.UpdateConversationProfileRequest
):
    client = ConversationProfilesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_set_suggestion_feature_config_flattened():
    ...
    with mock.patch.object(type(client.transport.set_suggestion_feature_config), "__call__") as call:
        ...
        mock_val = gcd_conversation_profile.HumanAgentAssistantConfig.SuggestionFeatureConfig(
            suggestion_feature=gcd_conversation_profile.SuggestionFeature(type_=gcd_conversation_profile.SuggestionFeature.Type.ARTICLE_SUGGESTION)
        )
        assert arg == mock_val
...
async def test_clear_suggestion_feature_config_async(
    transport: str = "grpc_asyncio", request_type=gcd_conversation_profile.ClearSuggestionFeatureConfigRequest
):
    client = ConversationProfilesAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_conversation_profiles_rest_required_fields(request_type=conversation_profile.ListConversationProfilesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_conversation_profiles._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_conversation_profile_rest_required_fields(request_type=conversation_profile.GetConversationProfileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_conversation_profile._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_conversation_profile_rest_required_fields(request_type=gcd_conversation_profile.CreateConversationProfileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_conversation_profile._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_conversation_profile_rest_required_fields(request_type=gcd_conversation_profile.UpdateConversationProfileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_conversation_profile._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_conversation_profile_rest_required_fields(request_type=conversation_profile.DeleteConversationProfileRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_conversation_profile._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_suggestion_feature_config_rest_required_fields(request_type=gcd_conversation_profile.SetSuggestionFeatureConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_suggestion_feature_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_suggestion_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{conversation_profile=projects/*/conversationProfiles/*}:setSuggestionFeatureConfig" % client.transport._host, args[1]
        )
...
def test_clear_suggestion_feature_config_rest_required_fields(request_type=gcd_conversation_profile.ClearSuggestionFeatureConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).clear_suggestion_feature_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_clear_suggestion_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{conversation_profile=projects/*/conversationProfiles/*}:clearSuggestionFeatureConfig" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = ConversationProfilesClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ConversationProfilesAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ConversationProfilesAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ConversationProfilesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_conversation_profiles_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_list_conversation_profiles") as post, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "post_list_conversation_profiles_with_metadata"
...
def test_get_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_get_conversation_profile") as post, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "post_get_conversation_profile_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_conversation_profile_rest_call_success(request_type):
    ...
    request_init["conversation_profile"] = {
        ...
        "update_time": {},
        "automated_agent_config": {"agent": "agent_value", "session_ttl": {"seconds": 751, "nanos": 543}},
        "human_agent_assistant_config": {
                ...
                "feature_configs": [
                    {
                        ...
                        "suggestion_trigger_settings": {"no_smalltalk": True, "only_end_user": True},
                        "query_config": {
                            "knowledge_base_query_source": {"knowledge_bases": ["knowledge_bases_value1", "knowledge_bases_value2"]},
                            "document_query_source": {"documents": ["documents_value1", "documents_value2"]},
                            "dialogflow_query_source": {"agent": "agent_value", "human_agent_side_config": {"agent": "agent_value"}},
                            "max_results": 1207,
                        ...
                        "conversation_model_config": {"model": "model_value", "baseline_model_version": "baseline_model_version_value"},
            ...
            "message_analysis_config": {"enable_entity_extraction": True, "enable_sentiment_analysis": True},
        },
        ...
        "tts_config": {
            ...
            "effects_profile_id": ["effects_profile_id_value1", "effects_profile_id_value2"],
...
def test_create_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_create_conversation_profile") as post, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "post_create_conversation_profile_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "pre_create_conversation_profile"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationProfilesRestInterceptor, "post_update_conversation_profile") as post, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "post_update_conversation_profile_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "pre_update_conversation_profile"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_conversation_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationProfilesRestInterceptor, "pre_delete_conversation_profile") as pre:
        pre.assert_not_called()
...
def test_set_suggestion_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationProfilesRestInterceptor, "post_set_suggestion_feature_config"
    ) as post, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "post_set_suggestion_feature_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "pre_set_suggestion_feature_config"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_clear_suggestion_feature_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationProfilesRestInterceptor, "post_clear_suggestion_feature_config"
    ) as post, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "post_clear_suggestion_feature_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationProfilesRestInterceptor, "pre_clear_suggestion_feature_config"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_conversation_profiles_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.dialogflow_v2.services.conversation_profiles.transports.ConversationProfilesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.ConversationProfilesGrpcTransport, grpc_helpers), (transports.ConversationProfilesGrpcAsyncIOTransport, grpc_helpers_async)],
)

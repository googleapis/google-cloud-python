...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AnswerRecordsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_list_answer_records_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_answer_records] = (
            mock_rpc
        )
        request = {}
...
def test_update_answer_record_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_answer_record] = (
            mock_rpc
        )
        request = {}
...
def test_transport_kind_grpc_asyncio():
    transport = AnswerRecordsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = AnswerRecordsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_answer_records_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.AnswerRecordsRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = answer_record.ListAnswerRecordsResponse.to_json(
            answer_record.ListAnswerRecordsResponse()
        )
...
def test_update_answer_record_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_answer_record.AnswerRecord.to_json(
            gcd_answer_record.AnswerRecord()
        )
        req.return_value.content = return_value

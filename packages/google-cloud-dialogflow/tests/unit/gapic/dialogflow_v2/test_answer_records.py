...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AnswerRecordsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AnswerRecordsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AnswerRecordsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AnswerRecordsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AnswerRecordsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AnswerRecordsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert AnswerRecordsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AnswerRecordsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert AnswerRecordsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AnswerRecordsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(AnswerRecordsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AnswerRecordsClient))
@mock.patch.object(AnswerRecordsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AnswerRecordsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AnswerRecordsClient._DEFAULT_UNIVERSE
    default_endpoint = AnswerRecordsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AnswerRecordsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AnswerRecordsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert AnswerRecordsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == AnswerRecordsClient.DEFAULT_MTLS_ENDPOINT
    assert AnswerRecordsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AnswerRecordsClient._get_api_endpoint(None, None, default_universe, "always") == AnswerRecordsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        AnswerRecordsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == AnswerRecordsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert AnswerRecordsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AnswerRecordsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AnswerRecordsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AnswerRecordsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AnswerRecordsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AnswerRecordsClient._get_universe_domain(None, None) == AnswerRecordsClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = AnswerRecordsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (AnswerRecordsAsyncClient, transports.AnswerRecordsGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (AnswerRecordsClient, transports.AnswerRecordsGrpcTransport, "grpc", grpc_helpers),
        (AnswerRecordsAsyncClient, transports.AnswerRecordsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_answer_records_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_answer_records in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_answer_records] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_answer_records_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_answer_records in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_answer_records] = mock_rpc
...
async def test_list_answer_records_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_answer_records), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_answer_records(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_answer_record_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_answer_record in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_answer_record] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_answer_record_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AnswerRecordsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_answer_record in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_answer_record] = mock_rpc
...
def test_list_answer_records_rest_required_fields(request_type=answer_record.ListAnswerRecordsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_answer_records._get_unset_required_fields(
        jsonified_request
    )
...
def test_update_answer_record_rest_required_fields(request_type=gcd_answer_record.UpdateAnswerRecordRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_answer_record._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = AnswerRecordsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_answer_records_empty_call_grpc():
    client = AnswerRecordsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_answer_records), "__call__") as call:
        call.return_value = answer_record.ListAnswerRecordsResponse()
        client.list_answer_records(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_answer_record_empty_call_grpc():
    client = AnswerRecordsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_answer_record), "__call__") as call:
        call.return_value = gcd_answer_record.AnswerRecord()
        client.update_answer_record(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = AnswerRecordsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AnswerRecordsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_answer_records_empty_call_grpc_asyncio():
    client = AnswerRecordsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.list_answer_records), "__call__") as call:
        ...
        await client.list_answer_records(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_answer_record_empty_call_grpc_asyncio():
    client = AnswerRecordsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_answer_record), "__call__") as call:
        ...
        await client.update_answer_record(request=None)
...
def test_transport_kind_rest():
    transport = AnswerRecordsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_answer_records_rest_bad_request(request_type=answer_record.ListAnswerRecordsRequest):
...
def test_list_answer_records_rest_call_success(request_type):
    client = AnswerRecordsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_answer_records_rest_interceptors(null_interceptor):
    transport = transports.AnswerRecordsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AnswerRecordsRestInterceptor(),
    )
    client = AnswerRecordsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_list_answer_records") as post, mock.patch.object(
        transports.AnswerRecordsRestInterceptor, "post_list_answer_records_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = answer_record.ListAnswerRecordsResponse.to_json(answer_record.ListAnswerRecordsResponse())
        ...
        post_with_metadata.return_value = answer_record.ListAnswerRecordsResponse(), metadata
...
def test_update_answer_record_rest_bad_request(request_type=gcd_answer_record.UpdateAnswerRecordRequest):
    client = AnswerRecordsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_answer_record_rest_call_success(request_type):
    client = AnswerRecordsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["answer_record"] = {
        ...
        "answer_feedback": {
            ...
            "agent_assistant_detail_feedback": {
                ...
                "knowledge_search_feedback": {"answer_copied": True, "clicked_uris": ["clicked_uris_value1", "clicked_uris_value2"]},
                "knowledge_assist_feedback": {"answer_copied": True, "clicked_uris": ["clicked_uris_value1", "clicked_uris_value2"]},
            },
            "clicked": True,
            "click_time": {},
            "displayed": True,
        ...
        "agent_assistant_record": {
            ...
            "dialogflow_assist_answer": {
                "query_result": {
                    ...
                    "fulfillment_messages": [
                        {
                            ...
                            "simple_responses": {
                                "simple_responses": [
                                    {"text_to_speech": "text_to_speech_value", "ssml": "ssml_value", "display_text": "display_text_value"}
                                ]
                            },
                            "basic_card": {
                                "title": "title_value",
                    ...
                    "webhook_payload": {},
                    "output_contexts": [{"name": "name_value", "lifespan_count": 1498, "parameters": {}}],
                    "intent": {
                        "name": "name_value",
                    ...
                    "diagnostic_info": {},
                    "sentiment_analysis_result": {"query_text_sentiment": {"score": 0.54, "magnitude": 0.9580000000000001}},
                },
                "intent_suggestion": {"display_name": "display_name_value", "intent_v2": "intent_v2_value", "description": "description_value"},
                "answer_record": "answer_record_value",
            },
        },
    }
...
def test_update_answer_record_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_update_answer_record") as post, mock.patch.object(
        transports.AnswerRecordsRestInterceptor, "post_update_answer_record_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_answer_record.AnswerRecord.to_json(gcd_answer_record.AnswerRecord())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcd_answer_record.AnswerRecord(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_answer_records_empty_call_rest():
    client = AnswerRecordsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_answer_record_empty_call_rest():
    client = AnswerRecordsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.AnswerRecordsGrpcTransport, grpc_helpers), (transports.AnswerRecordsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
async def test_get_location_field_headers_async():
    client = AnswerRecordsAsyncClient(credentials=async_anonymous_credentials())

...
def test_list_answer_records_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAnswerRecords,
        "_BaseListAnswerRecords__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_update_answer_record_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateAnswerRecord,
        "_BaseUpdateAnswerRecord__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

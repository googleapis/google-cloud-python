...
def test__read_environment_variables():
    assert ConversationModelsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ConversationModelsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ConversationModelsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ConversationModelsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ConversationModelsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ConversationModelsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ConversationModelsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ConversationModelsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ConversationModelsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ConversationModelsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ConversationModelsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ConversationModelsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ConversationModelsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationModelsClient))
@mock.patch.object(ConversationModelsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationModelsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConversationModelsClient._DEFAULT_UNIVERSE
    default_endpoint = ConversationModelsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ConversationModelsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ConversationModelsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ConversationModelsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ConversationModelsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ConversationModelsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ConversationModelsClient._get_api_endpoint(None, None, default_universe, "always") == ConversationModelsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ConversationModelsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ConversationModelsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ConversationModelsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ConversationModelsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ConversationModelsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ConversationModelsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ConversationModelsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ConversationModelsClient._get_universe_domain(None, None) == ConversationModelsClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ConversationModelsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ConversationModelsAsyncClient, transports.ConversationModelsGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (ConversationModelsClient, transports.ConversationModelsGrpcTransport, "grpc", "true"),
        (ConversationModelsAsyncClient, transports.ConversationModelsGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (ConversationModelsClient, transports.ConversationModelsGrpcTransport, "grpc", "false"),
        (ConversationModelsAsyncClient, transports.ConversationModelsGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (ConversationModelsClient, transports.ConversationModelsRestTransport, "rest", "true"),
        (ConversationModelsClient, transports.ConversationModelsRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ConversationModelsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationModelsClient))
@mock.patch.object(ConversationModelsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationModelsAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (ConversationModelsClient, transports.ConversationModelsGrpcTransport, "grpc", grpc_helpers),
        (ConversationModelsAsyncClient, transports.ConversationModelsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ConversationModelsClient, transports.ConversationModelsRestTransport, "rest", None),
    ],
)
...
def test_create_conversation_model_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.create_conversation_model), "__call__") as call:
        ...
        client.create_conversation_model(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_conversation_model in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_conversation_model] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_conversation_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_conversation_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_conversation_model] = mock_rpc
...
def test_create_conversation_model_flattened():
    ...
    with mock.patch.object(type(client.transport.create_conversation_model), "__call__") as call:
        ...
        client.create_conversation_model(
            parent="parent_value",
            conversation_model=gcd_conversation_model.ConversationModel(name="name_value"),
        )
...
def test_get_conversation_model_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.get_conversation_model), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.get_conversation_model(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_conversation_model_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_conversation_model in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_conversation_model] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_conversation_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_conversation_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_conversation_model] = mock_rpc
...
def test_list_conversation_models_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.list_conversation_models), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.list_conversation_models(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_conversation_models_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_conversation_models in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_conversation_models] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_conversation_models_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_conversation_models in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_conversation_models] = mock_rpc
...
def test_list_conversation_models_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_conversation_models), "__call__") as call:
        ...
        pager = client.list_conversation_models(request={}, retry=retry, timeout=timeout)
...
async def test_list_conversation_models_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_conversation_models), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_conversation_models(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_conversation_model_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.delete_conversation_model), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.delete_conversation_model(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_delete_conversation_model_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_conversation_model in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_conversation_model] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_conversation_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_conversation_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_conversation_model] = mock_rpc
...
def test_deploy_conversation_model_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.deploy_conversation_model), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.deploy_conversation_model(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_deploy_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.deploy_conversation_model in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.deploy_conversation_model] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_deploy_conversation_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.deploy_conversation_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.deploy_conversation_model] = mock_rpc
...
def test_undeploy_conversation_model_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.undeploy_conversation_model), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.undeploy_conversation_model(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_undeploy_conversation_model_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
        ...
        # Ensure method has been cached
        assert client._transport.undeploy_conversation_model in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.undeploy_conversation_model] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_undeploy_conversation_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undeploy_conversation_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undeploy_conversation_model] = mock_rpc
...
def test_get_conversation_model_evaluation_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.get_conversation_model_evaluation), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.get_conversation_model_evaluation(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_conversation_model_evaluation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_conversation_model_evaluation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_conversation_model_evaluation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_conversation_model_evaluation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_conversation_model_evaluation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_conversation_model_evaluation] = mock_rpc
...
async def test_get_conversation_model_evaluation_async(
    transport: str = "grpc_asyncio", request_type=conversation_model.GetConversationModelEvaluationRequest
):
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_conversation_model_evaluations_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.list_conversation_model_evaluations), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.list_conversation_model_evaluations(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_conversation_model_evaluations_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_conversation_model_evaluations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_conversation_model_evaluations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_conversation_model_evaluations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_conversation_model_evaluations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_conversation_model_evaluations] = mock_rpc
...
async def test_list_conversation_model_evaluations_async(
    transport: str = "grpc_asyncio", request_type=conversation_model.ListConversationModelEvaluationsRequest
):
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_conversation_model_evaluations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_conversation_model_evaluations), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_conversation_model_evaluations(request={}, retry=retry, timeout=timeout)
...
async def test_list_conversation_model_evaluations_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_conversation_model_evaluations), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_conversation_model_evaluations(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_conversation_model_evaluation_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.create_conversation_model_evaluation), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.create_conversation_model_evaluation(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_conversation_model_evaluation_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_conversation_model_evaluation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_conversation_model_evaluation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_conversation_model_evaluation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationModelsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_conversation_model_evaluation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_conversation_model_evaluation] = mock_rpc
...
async def test_create_conversation_model_evaluation_async(
    transport: str = "grpc_asyncio", request_type=conversation_model.CreateConversationModelEvaluationRequest
):
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_conversation_model_evaluation_flattened():
    ...
    with mock.patch.object(type(client.transport.create_conversation_model_evaluation), "__call__") as call:
        ...
        client.create_conversation_model_evaluation(
            parent="parent_value",
            conversation_model_evaluation=conversation_model.ConversationModelEvaluation(name="name_value"),
        )
...
def test_create_conversation_model_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_create_conversation_model_rest_required_fields(request_type=gcd_conversation_model.CreateConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_conversation_model._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_conversation_model_rest_required_fields(request_type=conversation_model.GetConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_conversation_model._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_conversation_models_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_list_conversation_models_rest_required_fields(request_type=conversation_model.ListConversationModelsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_conversation_models._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_conversation_model_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_delete_conversation_model_rest_required_fields(request_type=conversation_model.DeleteConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_conversation_model._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_deploy_conversation_model_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_deploy_conversation_model_rest_required_fields(request_type=conversation_model.DeployConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).deploy_conversation_model._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_undeploy_conversation_model_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_undeploy_conversation_model_rest_required_fields(request_type=conversation_model.UndeployConversationModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).undeploy_conversation_model._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_conversation_model_evaluation_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_get_conversation_model_evaluation_rest_required_fields(request_type=conversation_model.GetConversationModelEvaluationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_conversation_model_evaluation._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_conversation_model_evaluations_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_list_conversation_model_evaluations_rest_required_fields(request_type=conversation_model.ListConversationModelEvaluationsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_conversation_model_evaluations._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_conversation_model_evaluation_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationModelsClient(
...
def test_create_conversation_model_evaluation_rest_required_fields(request_type=conversation_model.CreateConversationModelEvaluationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_conversation_model_evaluation._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = ConversationModelsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_conversation_model_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_conversation_model), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_conversation_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcd_conversation_model.CreateConversationModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_conversation_model_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_conversation_model), "__call__") as call:
        call.return_value = conversation_model.ConversationModel()
        client.get_conversation_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_model.GetConversationModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_conversation_models_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_conversation_models), "__call__") as call:
        call.return_value = conversation_model.ListConversationModelsResponse()
        client.list_conversation_models(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_conversation_model_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_conversation_model), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_conversation_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_model.DeleteConversationModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_deploy_conversation_model_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.deploy_conversation_model), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.deploy_conversation_model(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undeploy_conversation_model_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.undeploy_conversation_model), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.undeploy_conversation_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_model.UndeployConversationModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_conversation_model_evaluation_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_conversation_model_evaluation), "__call__") as call:
        call.return_value = conversation_model.ConversationModelEvaluation()
        client.get_conversation_model_evaluation(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_model.GetConversationModelEvaluationRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_conversation_model_evaluations_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_conversation_model_evaluations), "__call__") as call:
        call.return_value = conversation_model.ListConversationModelEvaluationsResponse()
        client.list_conversation_model_evaluations(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_model.ListConversationModelEvaluationsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_conversation_model_evaluation_empty_call_grpc():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_conversation_model_evaluation), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_conversation_model_evaluation(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_model.CreateConversationModelEvaluationRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ConversationModelsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ConversationModelsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_conversation_model_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_conversation_model), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_conversation_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_conversation_model_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_conversation_model), "__call__") as call:
        ...
        await client.get_conversation_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_conversation_models_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_conversation_models), "__call__") as call:
        ...
        await client.list_conversation_models(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_conversation_model_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_conversation_model), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_conversation_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_deploy_conversation_model_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.deploy_conversation_model), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.deploy_conversation_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undeploy_conversation_model_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.undeploy_conversation_model), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.undeploy_conversation_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_conversation_model_evaluation_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_conversation_model_evaluation), "__call__") as call:
        ...
        await client.get_conversation_model_evaluation(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_conversation_model_evaluations_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_conversation_model_evaluations), "__call__") as call:
        ...
        await client.list_conversation_model_evaluations(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_conversation_model_evaluation_empty_call_grpc_asyncio():
    client = ConversationModelsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_conversation_model_evaluation), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_conversation_model_evaluation(request=None)
...
def test_transport_kind_rest():
    transport = ConversationModelsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_conversation_model_rest_bad_request(request_type=gcd_conversation_model.CreateConversationModelRequest):
...
def test_create_conversation_model_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_conversation_model_rest_interceptors(null_interceptor):
    transport = transports.ConversationModelsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ConversationModelsRestInterceptor(),
    )
    client = ConversationModelsClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_create_conversation_model_with_metadata"
...
def test_get_conversation_model_rest_bad_request(request_type=conversation_model.GetConversationModelRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_conversation_model_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationModelsRestInterceptor, "post_get_conversation_model") as post, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "post_get_conversation_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ConversationModel.to_json(conversation_model.ConversationModel())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_model.ConversationModel(), metadata
...
def test_list_conversation_models_rest_bad_request(request_type=conversation_model.ListConversationModelsRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1"}
    request = request_type(**request_init)
...
def test_list_conversation_models_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_conversation_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationModelsRestInterceptor, "post_list_conversation_models") as post, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "post_list_conversation_models_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ListConversationModelsResponse.to_json(conversation_model.ListConversationModelsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_model.ListConversationModelsResponse(), metadata
...
def test_delete_conversation_model_rest_bad_request(request_type=conversation_model.DeleteConversationModelRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/conversationModels/sample2"}
    request = request_type(**request_init)
...
def test_delete_conversation_model_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_delete_conversation_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_deploy_conversation_model_rest_bad_request(request_type=conversation_model.DeployConversationModelRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/conversationModels/sample2"}
    request = request_type(**request_init)
...
def test_deploy_conversation_model_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_deploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_deploy_conversation_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_undeploy_conversation_model_rest_bad_request(request_type=conversation_model.UndeployConversationModelRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/conversationModels/sample2"}
    request = request_type(**request_init)
...
def test_undeploy_conversation_model_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_undeploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_undeploy_conversation_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_conversation_model_evaluation_rest_bad_request(request_type=conversation_model.GetConversationModelEvaluationRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_conversation_model_evaluation_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_get_conversation_model_evaluation"
    ) as post, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "post_get_conversation_model_evaluation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "pre_get_conversation_model_evaluation"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ConversationModelEvaluation.to_json(conversation_model.ConversationModelEvaluation())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_model.ConversationModelEvaluation(), metadata
...
def test_list_conversation_model_evaluations_rest_bad_request(request_type=conversation_model.ListConversationModelEvaluationsRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_conversation_model_evaluations_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_conversation_model_evaluations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_list_conversation_model_evaluations"
    ) as post, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "post_list_conversation_model_evaluations_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "pre_list_conversation_model_evaluations"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ListConversationModelEvaluationsResponse.to_json(
            conversation_model.ListConversationModelEvaluationsResponse()
        )
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_model.ListConversationModelEvaluationsResponse(), metadata
...
def test_create_conversation_model_evaluation_rest_bad_request(request_type=conversation_model.CreateConversationModelEvaluationRequest):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_conversation_model_evaluation_rest_call_success(request_type):
    client = ConversationModelsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationModelsRestInterceptor, "post_create_conversation_model_evaluation"
    ) as post, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "post_create_conversation_model_evaluation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationModelsRestInterceptor, "pre_create_conversation_model_evaluation"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_conversation_model_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_conversation_model_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_conversation_models_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_conversation_model_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_deploy_conversation_model_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undeploy_conversation_model_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_conversation_model_evaluation_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_conversation_model_evaluations_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_conversation_model_evaluation_empty_call_rest():
    client = ConversationModelsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.ConversationModelsGrpcTransport, grpc_helpers), (transports.ConversationModelsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
async def test_get_location_field_headers_async():
    client = ConversationModelsAsyncClient(credentials=async_anonymous_credentials())
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ConversationModelsAsyncClient, transports.ConversationModelsGrpcAsyncIOTransport),
    ],
)

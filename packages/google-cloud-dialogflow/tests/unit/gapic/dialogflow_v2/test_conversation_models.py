...
def test_create_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.create_conversation_model
...
@pytest.mark.asyncio
async def test_create_conversation_model_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_conversation_model
...
def test_get_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_conversation_model
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_conversation_model] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_conversation_model_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_conversation_model
            in client._client._transport._wrapped_methods
        )
...
def test_list_conversation_models_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_conversation_models
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_conversation_models_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_conversation_models
            in client._client._transport._wrapped_methods
        )
...
def test_list_conversation_models_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_conversation_models(
...
def test_delete_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_conversation_model
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_conversation_model_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_conversation_model
            in client._client._transport._wrapped_methods
        )
...
def test_deploy_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.deploy_conversation_model
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_deploy_conversation_model_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.deploy_conversation_model
            in client._client._transport._wrapped_methods
        )
...
def test_undeploy_conversation_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.undeploy_conversation_model
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_undeploy_conversation_model_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.undeploy_conversation_model
            in client._client._transport._wrapped_methods
        )
...
def test_get_conversation_model_evaluation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_conversation_model_evaluation
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_conversation_model_evaluation_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_conversation_model_evaluation
            in client._client._transport._wrapped_methods
        )
...
def test_list_conversation_model_evaluations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_conversation_model_evaluations
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_conversation_model_evaluations_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_conversation_model_evaluations
            in client._client._transport._wrapped_methods
        )
...
def test_list_conversation_model_evaluations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_conversation_model_evaluations(
            request={}, retry=retry, timeout=timeout
        )
...
def test_create_conversation_model_evaluation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_conversation_model_evaluation
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_conversation_model_evaluation_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_conversation_model_evaluation
            in client._client._transport._wrapped_methods
        )
...
def test_create_conversation_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateConversationModel,
        "_BaseCreateConversationModel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_get_conversation_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetConversationModel,
        "_BaseGetConversationModel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_conversation_models_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListConversationModels,
        "_BaseListConversationModels__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_conversation_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteConversationModel,
        "_BaseDeleteConversationModel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_deploy_conversation_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeployConversationModel,
        "_BaseDeployConversationModel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_undeploy_conversation_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUndeployConversationModel,
        "_BaseUndeployConversationModel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_conversation_model_evaluation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetConversationModelEvaluation,
        "_BaseGetConversationModelEvaluation__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_conversation_model_evaluations_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListConversationModelEvaluations,
        "_BaseListConversationModelEvaluations__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_conversation_model_evaluation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateConversationModelEvaluation,
        "_BaseCreateConversationModelEvaluation__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_transport_kind_grpc_asyncio():
    transport = ConversationModelsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ConversationModelsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_create_conversation_model_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            ...
            "post_create_conversation_model",
        ) as post,
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
...
def test_get_conversation_model_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ConversationModel.to_json(
            conversation_model.ConversationModel()
        )
        req.return_value.content = return_value
...
def test_list_conversation_models_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ListConversationModelsResponse.to_json(
            conversation_model.ListConversationModelsResponse()
        )
        req.return_value.content = return_value
...
def test_delete_conversation_model_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
            "post_delete_conversation_model",
        ) as post,
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
...
def test_deploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
            "post_deploy_conversation_model",
        ) as post,
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
...
def test_undeploy_conversation_model_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
            "post_undeploy_conversation_model",
        ) as post,
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
        ...
        mock.patch.object(
            transports.ConversationModelsRestInterceptor,
            "pre_undeploy_conversation_model",
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_conversation_model_evaluation_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_model.ConversationModelEvaluation.to_json(
            conversation_model.ConversationModelEvaluation()
        )
        req.return_value.content = return_value

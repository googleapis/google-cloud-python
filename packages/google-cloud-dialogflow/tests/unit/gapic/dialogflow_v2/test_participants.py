...
from google.cloud.dialogflow_v2.services.participants import ParticipantsAsyncClient, ParticipantsClient, pagers, transports
...
def test_update_participant(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_participant), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcd_participant.Participant(
            name="name_value",
            role=gcd_participant.Participant.Role.HUMAN_AGENT,
    ...
    with mock.patch.object(type(client.transport.analyze_content), "__call__") as call:
        ...
        client.analyze_content(
            ...
            audio_input=gcd_participant.AudioInput(
                config=audio_config.InputAudioConfig(audio_encoding=audio_config.AudioEncoding.AUDIO_ENCODING_LINEAR_16)
            ),
        )
...
def test_analyze_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{participant=projects/*/conversations/*/participants/*}:analyzeContent" % client.transport._host, args[1]
        )
...
def test_suggest_articles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestArticles" % client.transport._host, args[1]
        )
...
def test_suggest_faq_answers_rest_required_fields(request_type=participant.SuggestFaqAnswersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).suggest_faq_answers._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_suggest_faq_answers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestFaqAnswers" % client.transport._host, args[1]
        )
...
def test_suggest_smart_replies_rest_required_fields(request_type=participant.SuggestSmartRepliesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).suggest_smart_replies._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_suggest_smart_replies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestSmartReplies" % client.transport._host, args[1]
        )
...
def test_suggest_knowledge_assist_rest_required_fields(request_type=participant.SuggestKnowledgeAssistRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).suggest_knowledge_assist._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_streaming_analyze_content_rest_error():
    client = ParticipantsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    assert "Method StreamingAnalyzeContent is not available over REST transport" in str(not_implemented_error.value)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ParticipantsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ParticipantsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ParticipantsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = ParticipantsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ParticipantsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ParticipantsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_participant_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_create_participant") as post, mock.patch.object(
...
def test_get_participant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_get_participant") as post, mock.patch.object(
...
def test_list_participants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_list_participants") as post, mock.patch.object(
...
def test_update_participant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_update_participant") as post, mock.patch.object(
...
def test_analyze_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_analyze_content") as post, mock.patch.object(
...
def test_suggest_articles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_suggest_articles") as post, mock.patch.object(
...
def test_suggest_faq_answers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_suggest_faq_answers") as post, mock.patch.object(
...
def test_suggest_smart_replies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_suggest_smart_replies") as post, mock.patch.object(
        transports.ParticipantsRestInterceptor, "post_suggest_smart_replies_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_suggest_knowledge_assist_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_suggest_knowledge_assist") as post, mock.patch.object(
        transports.ParticipantsRestInterceptor, "post_suggest_knowledge_assist_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_participants_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ParticipantsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.ParticipantsGrpcTransport, grpc_helpers), (transports.ParticipantsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_participants_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ParticipantsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ParticipantsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

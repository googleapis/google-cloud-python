...
async def test_create_participant_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_participant_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_analyze_content_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_suggest_articles_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_suggest_faq_answers_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_participant_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateParticipant,
...
def test_update_participant_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateParticipant,
...
def test_analyze_content_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseAnalyzeContent,
...
def test_suggest_articles_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSuggestArticles,
...
def test_suggest_faq_answers_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSuggestFaqAnswers,
...
def test_suggest_smart_replies_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSuggestSmartReplies,
...
def test_suggest_knowledge_assist_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSuggestKnowledgeAssist,

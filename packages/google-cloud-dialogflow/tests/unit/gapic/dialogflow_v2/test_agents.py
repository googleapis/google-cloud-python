...
async def test_set_agent_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.set_agent
            in client._client._transport._wrapped_methods
        )
...
async def test_set_agent_async(request_type, transport: str = "grpc_asyncio"):
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_train_agent_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.train_agent
            in client._client._transport._wrapped_methods
        )
...
async def test_train_agent_async(request_type, transport: str = "grpc_asyncio"):
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_import_agent_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.import_agent
            in client._client._transport._wrapped_methods
        )
...
async def test_import_agent_async(request_type, transport: str = "grpc_asyncio"):
    client = AgentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_validation_result_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_validation_result
        ...
        client._transport._wrapped_methods[client._transport.get_validation_result] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_validation_result_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_validation_result
            in client._client._transport._wrapped_methods
        )
...
def test_set_agent_rest_required_fields(request_type=gcd_agent.SetAgentRequest):
    ...
    default_values = getattr(
        transport_class._BaseSetAgent,
        "_BaseSetAgent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_train_agent_rest_required_fields(request_type=agent.TrainAgentRequest):
    ...
    default_values = getattr(
        transport_class._BaseTrainAgent,
        "_BaseTrainAgent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_import_agent_rest_required_fields(request_type=agent.ImportAgentRequest):
    ...
    default_values = getattr(
        transport_class._BaseImportAgent,
        "_BaseImportAgent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_validation_result_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetValidationResult,
        "_BaseGetValidationResult__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_validation_result_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = validation_result.ValidationResult.to_json(
            validation_result.ValidationResult()
        )
        req.return_value.content = return_value

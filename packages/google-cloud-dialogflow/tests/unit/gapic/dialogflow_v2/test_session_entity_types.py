...
def test_list_session_entity_types_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSessionEntityTypes,
        "_BaseListSessionEntityTypes__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_get_session_entity_type_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSessionEntityType,
        "_BaseGetSessionEntityType__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_session_entity_type_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSessionEntityType,
        "_BaseCreateSessionEntityType__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_session_entity_type_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSessionEntityType,
        "_BaseUpdateSessionEntityType__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_session_entity_type_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSessionEntityType,
        "_BaseDeleteSessionEntityType__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

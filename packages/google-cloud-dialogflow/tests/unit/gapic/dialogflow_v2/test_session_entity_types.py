...
from google.cloud.dialogflow_v2.types import entity_type, session_entity_type
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SessionEntityTypesClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        SessionEntityTypesClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SessionEntityTypesClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SessionEntityTypesClient),
)
@mock.patch.object(
    SessionEntityTypesAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SessionEntityTypesAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SessionEntityTypesClient._DEFAULT_UNIVERSE
    default_endpoint = SessionEntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SessionEntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        SessionEntityTypesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SessionEntityTypesClient._get_api_endpoint(
    ...
    assert (
        SessionEntityTypesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SessionEntityTypesClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        SessionEntityTypesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SessionEntityTypesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SessionEntityTypesClient._get_universe_domain(None, None)
        == SessionEntityTypesClient._DEFAULT_UNIVERSE
    )
...
def test_list_session_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_session_entity_types
...
def test_get_session_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_session_entity_type
            in client._transport._wrapped_methods
        )
...
def test_create_session_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_session_entity_type
            in client._transport._wrapped_methods
        )
...
def test_list_session_entity_types_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/agent/sessions/*}/entityTypes"
...
def test_get_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/agent/sessions/*/entityTypes/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{session_entity_type.name=projects/*/agent/sessions/*/entityTypes/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_session_entity_types_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            ...
            "post_list_session_entity_types",
        ) as post,
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
...
def test_create_session_entity_type_rest_call_success(request_type):
    ...
    test_field = gcd_session_entity_type.CreateSessionEntityTypeRequest.meta.fields[
        "session_entity_type"
    ]
...
def test_create_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
            "post_create_session_entity_type",
        ) as post,
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
        ...
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
            "pre_create_session_entity_type",
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_session_entity_type.SessionEntityType.to_json(
            gcd_session_entity_type.SessionEntityType()
        )
        req.return_value.content = return_value
...
def test_update_session_entity_type_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = gcd_session_entity_type.UpdateSessionEntityTypeRequest.meta.fields[
        "session_entity_type"
    ]
...
def test_update_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
            "post_update_session_entity_type",
        ) as post,
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
        ...
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
            "pre_update_session_entity_type",
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.SessionEntityTypesRestInterceptor,
            "pre_delete_session_entity_type",
        ) as pre,
    ):
        pre.assert_not_called()

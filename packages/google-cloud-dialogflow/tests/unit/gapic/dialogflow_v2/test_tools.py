...
from google.cloud.dialogflow_v2.services.tools import (
    ToolsAsyncClient,
    ToolsClient,
    pagers,
    transports,
...
def test_tools_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow_v2.services.tools.transports.ToolsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_tool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*}/tools" % client.transport._host,
            args[1],
        )
...
def test_get_tool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/tools/*}" % client.transport._host,
            args[1],
        )
...
def test_update_tool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{tool.name=projects/*/locations/*/tools/*}" % client.transport._host,
            args[1],
        )
...
def test_tools_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow_v2.services.tools.transports.ToolsTransport.__init__"
    ) as Transport:
...
def test_tools_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.dialogflow_v2.services.tools.transports.ToolsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

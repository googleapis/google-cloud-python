...
from google.cloud.dialogflow_v2.services.conversations import ConversationsAsyncClient, ConversationsClient, pagers, transports
from google.cloud.dialogflow_v2.types import conversation_profile, generator, participant, session
...
def test_create_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*}/conversations" % client.transport._host, args[1])
...
def test_get_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/conversations/*}" % client.transport._host, args[1])
...
def test_complete_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/conversations/*}:complete" % client.transport._host, args[1])
...
def test_ingest_context_references_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{conversation=projects/*/locations/*/conversations/*}:ingestContextReferences" % client.transport._host, args[1]
        )
...
def test_list_messages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/conversations/*}/messages" % client.transport._host, args[1])
...
def test_suggest_conversation_summary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{conversation=projects/*/conversations/*}/suggestions:suggestConversationSummary" % client.transport._host, args[1]
        )
...
def test_generate_suggestions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{conversation=projects/*/conversations/*}/suggestions:generate" % client.transport._host, args[1])
...
def test_conversations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.dialogflow_v2.services.conversations.transports.ConversationsTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

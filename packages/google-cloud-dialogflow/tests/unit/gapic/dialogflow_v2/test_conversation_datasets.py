...
from google.cloud.dialogflow_v2.types import conversation_dataset, gcs
...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ConversationDatasetsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ConversationDatasetsClient),
)
@mock.patch.object(
    ConversationDatasetsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ConversationDatasetsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConversationDatasetsClient._DEFAULT_UNIVERSE
    default_endpoint = ConversationDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ConversationDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ConversationDatasetsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ConversationDatasetsClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ConversationDatasetsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ConversationDatasetsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ConversationDatasetsClient._get_universe_domain(None, None)
        == ConversationDatasetsClient._DEFAULT_UNIVERSE
    )
...
def test_create_conversation_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.create_conversation_dataset
...
@pytest.mark.asyncio
async def test_create_conversation_dataset_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_conversation_dataset
...
def test_get_conversation_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_conversation_dataset
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_conversation_dataset_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_conversation_dataset
            in client._client._transport._wrapped_methods
        )
...
def test_list_conversation_datasets_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_conversation_datasets
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_conversation_datasets_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_conversation_datasets
            in client._client._transport._wrapped_methods
        )
...
def test_list_conversation_datasets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_conversation_datasets(
...
def test_delete_conversation_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_conversation_dataset
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_conversation_dataset_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_conversation_dataset
            in client._client._transport._wrapped_methods
        )
...
def test_import_conversation_data_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.import_conversation_data
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_import_conversation_data_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.import_conversation_data
            in client._client._transport._wrapped_methods
        )
...
def test_create_conversation_dataset_rest_required_fields(
    request_type=gcd_conversation_dataset.CreateConversationDatasetRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_conversation_dataset._get_unset_required_fields(jsonified_request)
...
def test_create_conversation_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*}/conversationDatasets"
...
def test_get_conversation_dataset_rest_required_fields(
    request_type=conversation_dataset.GetConversationDatasetRequest,
):
    transport_class = transports.ConversationDatasetsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_conversation_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_conversation_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/conversationDatasets/*}" % client.transport._host,
            args[1],
        )
...
def test_list_conversation_datasets_rest_required_fields(
    request_type=conversation_dataset.ListConversationDatasetsRequest,
):
    transport_class = transports.ConversationDatasetsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_conversation_datasets._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = conversation_dataset.ListConversationDatasetsResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_conversation_datasets_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{parent=projects/*}/conversationDatasets" % client.transport._host,
            args[1],
        )
...
def test_list_conversation_datasets_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            conversation_dataset.ListConversationDatasetsResponse.to_json(x)
            for x in response
        )
...
def test_delete_conversation_dataset_rest_required_fields(
    request_type=conversation_dataset.DeleteConversationDatasetRequest,
):
    transport_class = transports.ConversationDatasetsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_conversation_dataset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_conversation_dataset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/conversationDatasets/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/conversationDatasets/*}"
            % client.transport._host,
            args[1],
        )
...
def test_import_conversation_data_rest_required_fields(
    request_type=conversation_dataset.ImportConversationDataRequest,
):
    transport_class = transports.ConversationDatasetsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).import_conversation_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc_asyncio():
    transport = ConversationDatasetsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ConversationDatasetsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_conversation_dataset_rest_bad_request(
    request_type=gcd_conversation_dataset.CreateConversationDatasetRequest,
):
    client = ConversationDatasetsClient(
...
def test_create_conversation_dataset_rest_call_success(request_type):
    ...
    test_field = gcd_conversation_dataset.CreateConversationDatasetRequest.meta.fields[
...
def test_create_conversation_dataset_rest_interceptors(null_interceptor):
    transport = transports.ConversationDatasetsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.ConversationDatasetsRestInterceptor(),
    )
    client = ConversationDatasetsClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor,
        "post_create_conversation_dataset",
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor,
        "post_create_conversation_dataset_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor,
        "pre_create_conversation_dataset",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_conversation_dataset.CreateConversationDatasetRequest.pb(
            gcd_conversation_dataset.CreateConversationDatasetRequest()
        )
...
def test_get_conversation_dataset_rest_bad_request(
    request_type=conversation_dataset.GetConversationDatasetRequest,
):
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_get_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor, "post_get_conversation_dataset"
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = conversation_dataset.GetConversationDatasetRequest.pb(
            conversation_dataset.GetConversationDatasetRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_dataset.ConversationDataset.to_json(
            conversation_dataset.ConversationDataset()
        )
        req.return_value.content = return_value
...
def test_list_conversation_datasets_rest_bad_request(
    request_type=conversation_dataset.ListConversationDatasetsRequest,
):
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_list_conversation_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor,
        "post_list_conversation_datasets",
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = conversation_dataset.ListConversationDatasetsRequest.pb(
            conversation_dataset.ListConversationDatasetsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_dataset.ListConversationDatasetsResponse.to_json(
            conversation_dataset.ListConversationDatasetsResponse()
        )
        req.return_value.content = return_value
...
def test_delete_conversation_dataset_rest_bad_request(
    request_type=conversation_dataset.DeleteConversationDatasetRequest,
):
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_delete_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor,
        "post_delete_conversation_dataset",
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor,
        "post_delete_conversation_dataset_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor,
        "pre_delete_conversation_dataset",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = conversation_dataset.DeleteConversationDatasetRequest.pb(
            conversation_dataset.DeleteConversationDatasetRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_import_conversation_data_rest_bad_request(
    request_type=conversation_dataset.ImportConversationDataRequest,
):
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_import_conversation_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = conversation_dataset.ImportConversationDataRequest.pb(
            conversation_dataset.ImportConversationDataRequest()
        )
        transcode.return_value = {
            "method": "post",

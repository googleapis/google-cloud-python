...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ConversationDatasetsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_list_conversation_datasets_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ConversationDatasetsRestInterceptor,
            "pre_list_conversation_datasets",
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()

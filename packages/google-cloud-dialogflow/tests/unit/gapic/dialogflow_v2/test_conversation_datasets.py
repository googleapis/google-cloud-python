...
def test__read_environment_variables():
    assert ConversationDatasetsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ConversationDatasetsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                ConversationDatasetsClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert ConversationDatasetsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ConversationDatasetsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ConversationDatasetsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ConversationDatasetsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ConversationDatasetsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ConversationDatasetsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ConversationDatasetsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ConversationDatasetsClient._get_client_cert_source(None, False) is None
    assert ConversationDatasetsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ConversationDatasetsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ConversationDatasetsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ConversationDatasetsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ConversationDatasetsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationDatasetsClient))
@mock.patch.object(ConversationDatasetsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationDatasetsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ConversationDatasetsClient._DEFAULT_UNIVERSE
    default_endpoint = ConversationDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ConversationDatasetsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ConversationDatasetsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ConversationDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ConversationDatasetsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ConversationDatasetsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ConversationDatasetsClient._get_api_endpoint(None, None, default_universe, "always") == ConversationDatasetsClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ConversationDatasetsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ConversationDatasetsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ConversationDatasetsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ConversationDatasetsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ConversationDatasetsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ConversationDatasetsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ConversationDatasetsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ConversationDatasetsClient._get_universe_domain(None, None) == ConversationDatasetsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        ConversationDatasetsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ConversationDatasetsClient(credentials=cred)
...
@mock.patch.object(ConversationDatasetsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationDatasetsClient))
@mock.patch.object(ConversationDatasetsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ConversationDatasetsAsyncClient))
def test_conversation_datasets_client_client_api_endpoint(client_class):
...
def test_create_conversation_dataset_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_conversation_dataset in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_conversation_dataset] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_conversation_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_conversation_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_conversation_dataset] = mock_rpc
...
async def test_create_conversation_dataset_async(
    transport: str = "grpc_asyncio", request_type=gcd_conversation_dataset.CreateConversationDatasetRequest
):
    client = ConversationDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_get_conversation_dataset_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_conversation_dataset in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_conversation_dataset] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_conversation_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationDatasetsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_conversation_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_conversation_dataset] = mock_rpc
...
def test_list_conversation_datasets_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_conversation_datasets in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_conversation_datasets] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_conversation_datasets_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationDatasetsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_conversation_datasets in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_conversation_datasets] = mock_rpc
...
def test_list_conversation_datasets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_conversation_datasets), "__call__") as call:
        ...
        pager = client.list_conversation_datasets(request={}, retry=retry, timeout=timeout)
...
def test_delete_conversation_dataset_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_conversation_dataset in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_conversation_dataset] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_conversation_dataset_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationDatasetsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_conversation_dataset in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_conversation_dataset] = mock_rpc
...
def test_import_conversation_data_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
        ...
        # Ensure method has been cached
        assert client._transport.import_conversation_data in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_conversation_data] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_conversation_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConversationDatasetsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_conversation_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_conversation_data] = mock_rpc
...
def test_create_conversation_dataset_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
...
def test_create_conversation_dataset_rest_required_fields(request_type=gcd_conversation_dataset.CreateConversationDatasetRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_conversation_dataset._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_conversation_dataset_rest_required_fields(request_type=conversation_dataset.GetConversationDatasetRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_conversation_dataset._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_conversation_datasets_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
...
def test_list_conversation_datasets_rest_required_fields(request_type=conversation_dataset.ListConversationDatasetsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_conversation_datasets._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_conversation_dataset_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
...
def test_delete_conversation_dataset_rest_required_fields(request_type=conversation_dataset.DeleteConversationDatasetRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_conversation_dataset._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_import_conversation_data_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ConversationDatasetsClient(
...
def test_import_conversation_data_rest_required_fields(request_type=conversation_dataset.ImportConversationDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_conversation_data._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = ConversationDatasetsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_conversation_dataset_empty_call_grpc():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_conversation_dataset), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_conversation_dataset(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = gcd_conversation_dataset.CreateConversationDatasetRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_conversation_dataset_empty_call_grpc():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_conversation_dataset), "__call__") as call:
        call.return_value = conversation_dataset.ConversationDataset()
        client.get_conversation_dataset(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_dataset.GetConversationDatasetRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_conversation_datasets_empty_call_grpc():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_conversation_datasets), "__call__") as call:
        call.return_value = conversation_dataset.ListConversationDatasetsResponse()
        client.list_conversation_datasets(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_dataset.ListConversationDatasetsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_conversation_dataset_empty_call_grpc():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_conversation_dataset), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_conversation_dataset(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_dataset.DeleteConversationDatasetRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_conversation_data_empty_call_grpc():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.import_conversation_data), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.import_conversation_data(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = conversation_dataset.ImportConversationDataRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ConversationDatasetsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ConversationDatasetsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_conversation_dataset_empty_call_grpc_asyncio():
    client = ConversationDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_conversation_dataset), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_conversation_dataset(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_conversation_dataset_empty_call_grpc_asyncio():
    client = ConversationDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_conversation_dataset), "__call__") as call:
        ...
        await client.get_conversation_dataset(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_conversation_datasets_empty_call_grpc_asyncio():
    client = ConversationDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_conversation_datasets), "__call__") as call:
        ...
        await client.list_conversation_datasets(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_conversation_dataset_empty_call_grpc_asyncio():
    client = ConversationDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_conversation_dataset), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_conversation_dataset(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_conversation_data_empty_call_grpc_asyncio():
    client = ConversationDatasetsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.import_conversation_data), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.import_conversation_data(request=None)
...
def test_transport_kind_rest():
    transport = ConversationDatasetsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_conversation_dataset_rest_bad_request(request_type=gcd_conversation_dataset.CreateConversationDatasetRequest):
...
def test_create_conversation_dataset_rest_call_success(request_type):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request_init["conversation_dataset"] = {
        "name": "name_value",
        "display_name": "display_name_value",
        "description": "description_value",
    ...
    for field, value in request_init["conversation_dataset"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor, "post_create_conversation_dataset"
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "post_create_conversation_dataset_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "pre_create_conversation_dataset"
    ) as pre:
...
def test_get_conversation_dataset_rest_bad_request(request_type=conversation_dataset.GetConversationDatasetRequest):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_conversation_dataset_rest_call_success(request_type):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_get_conversation_dataset") as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "post_get_conversation_dataset_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "pre_get_conversation_dataset"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_dataset.ConversationDataset.to_json(conversation_dataset.ConversationDataset())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_dataset.ConversationDataset(), metadata
...
def test_list_conversation_datasets_rest_bad_request(request_type=conversation_dataset.ListConversationDatasetsRequest):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_conversation_datasets_rest_call_success(request_type):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_conversation_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConversationDatasetsRestInterceptor, "post_list_conversation_datasets") as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "post_list_conversation_datasets_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "pre_list_conversation_datasets"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = conversation_dataset.ListConversationDatasetsResponse.to_json(conversation_dataset.ListConversationDatasetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = conversation_dataset.ListConversationDatasetsResponse(), metadata
...
def test_delete_conversation_dataset_rest_bad_request(request_type=conversation_dataset.DeleteConversationDatasetRequest):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_delete_conversation_dataset_rest_call_success(request_type):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_conversation_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor, "post_delete_conversation_dataset"
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "post_delete_conversation_dataset_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "pre_delete_conversation_dataset"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_import_conversation_data_rest_bad_request(request_type=conversation_dataset.ImportConversationDataRequest):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/conversationDatasets/sample2"}
    request = request_type(**request_init)
...
def test_import_conversation_data_rest_call_success(request_type):
    client = ConversationDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_import_conversation_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConversationDatasetsRestInterceptor, "post_import_conversation_data"
    ) as post, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "post_import_conversation_data_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ConversationDatasetsRestInterceptor, "pre_import_conversation_data"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_conversation_dataset_empty_call_rest():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_conversation_dataset_empty_call_rest():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_conversation_datasets_empty_call_rest():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_conversation_dataset_empty_call_rest():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_conversation_data_empty_call_rest():
    client = ConversationDatasetsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.ConversationDatasetsGrpcTransport, grpc_helpers), (transports.ConversationDatasetsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
async def test_get_location_field_headers_async():
    client = ConversationDatasetsAsyncClient(credentials=async_anonymous_credentials())

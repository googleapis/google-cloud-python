...
from google.cloud.dialogflow_v2.services.environments import (
    EnvironmentsAsyncClient,
    EnvironmentsClient,
    pagers,
    transports,
)
from google.cloud.dialogflow_v2.types import audio_config, environment, fulfillment
...
def test_list_environments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/agent}/environments" % client.transport._host,
            args[1],
        )

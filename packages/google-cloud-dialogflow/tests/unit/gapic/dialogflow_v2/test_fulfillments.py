...
def test__read_environment_variables():
    assert FulfillmentsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert FulfillmentsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                FulfillmentsClient._read_environment_variables()
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert FulfillmentsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert FulfillmentsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert FulfillmentsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert FulfillmentsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert FulfillmentsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                FulfillmentsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert FulfillmentsClient._get_client_cert_source(None, False) is None
    assert FulfillmentsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert FulfillmentsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert FulfillmentsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert FulfillmentsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(FulfillmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FulfillmentsClient))
@mock.patch.object(FulfillmentsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FulfillmentsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = FulfillmentsClient._DEFAULT_UNIVERSE
    default_endpoint = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert FulfillmentsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert FulfillmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == FulfillmentsClient.DEFAULT_MTLS_ENDPOINT
    assert FulfillmentsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert FulfillmentsClient._get_api_endpoint(None, None, default_universe, "always") == FulfillmentsClient.DEFAULT_MTLS_ENDPOINT
    assert FulfillmentsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == FulfillmentsClient.DEFAULT_MTLS_ENDPOINT
    assert FulfillmentsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert FulfillmentsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        FulfillmentsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert FulfillmentsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert FulfillmentsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert FulfillmentsClient._get_universe_domain(None, None) == FulfillmentsClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        FulfillmentsClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = FulfillmentsClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (FulfillmentsClient, "grpc"),
        (FulfillmentsAsyncClient, "grpc_asyncio"),
        (FulfillmentsClient, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.FulfillmentsRestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (FulfillmentsClient, transports.FulfillmentsRestTransport, "rest", "true"),
        (FulfillmentsClient, transports.FulfillmentsRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(FulfillmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FulfillmentsClient))
@mock.patch.object(FulfillmentsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FulfillmentsAsyncClient))
...
@mock.patch.object(FulfillmentsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FulfillmentsClient))
@mock.patch.object(FulfillmentsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FulfillmentsAsyncClient))
def test_fulfillments_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (FulfillmentsClient, transports.FulfillmentsGrpcTransport, "grpc", grpc_helpers),
        (FulfillmentsAsyncClient, transports.FulfillmentsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (FulfillmentsClient, transports.FulfillmentsRestTransport, "rest", None),
    ],
)
...
def test_get_fulfillment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.get_fulfillment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_fulfillment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_fulfillment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_fulfillment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_fulfillment] = mock_rpc
...
def test_update_fulfillment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_fulfillment in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_fulfillment] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_fulfillment_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FulfillmentsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_fulfillment in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_fulfillment] = mock_rpc
...
def test_get_fulfillment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FulfillmentsClient(
...
def test_update_fulfillment_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = FulfillmentsClient(
...
def test_transport_kind_grpc():
    transport = FulfillmentsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_fulfillment_empty_call_grpc():
    client = FulfillmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_fulfillment), "__call__") as call:
        call.return_value = fulfillment.Fulfillment()
        client.get_fulfillment(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_fulfillment_empty_call_grpc():
    client = FulfillmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_fulfillment), "__call__") as call:
        call.return_value = gcd_fulfillment.Fulfillment()
        client.update_fulfillment(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = FulfillmentsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = FulfillmentsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_fulfillment_empty_call_grpc_asyncio():
    client = FulfillmentsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.get_fulfillment), "__call__") as call:
        ...
        await client.get_fulfillment(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_fulfillment_empty_call_grpc_asyncio():
    client = FulfillmentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_fulfillment), "__call__") as call:
        ...
        await client.update_fulfillment(request=None)
...
def test_transport_kind_rest():
    transport = FulfillmentsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_fulfillment_rest_bad_request(request_type=fulfillment.GetFulfillmentRequest):
...
def test_get_fulfillment_rest_call_success(request_type):
    client = FulfillmentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_fulfillment_rest_interceptors(null_interceptor):
    transport = transports.FulfillmentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.FulfillmentsRestInterceptor, "post_get_fulfillment") as post, mock.patch.object(
        transports.FulfillmentsRestInterceptor, "post_get_fulfillment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.FulfillmentsRestInterceptor, "pre_get_fulfillment"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = fulfillment.Fulfillment.to_json(fulfillment.Fulfillment())
        ...
        post_with_metadata.return_value = fulfillment.Fulfillment(), metadata
...
def test_update_fulfillment_rest_bad_request(request_type=gcd_fulfillment.UpdateFulfillmentRequest):
    client = FulfillmentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_fulfillment_rest_call_success(request_type):
    client = FulfillmentsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"fulfillment": {"name": "projects/sample1/agent/fulfillment"}}
    request_init["fulfillment"] = {
        "name": "projects/sample1/agent/fulfillment",
        "display_name": "display_name_value",
        "generic_web_service": {
            "uri": "uri_value",
    ...
    for field, value in request_init["fulfillment"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_update_fulfillment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.FulfillmentsRestInterceptor, "post_update_fulfillment") as post, mock.patch.object(
        transports.FulfillmentsRestInterceptor, "post_update_fulfillment_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.FulfillmentsRestInterceptor, "pre_update_fulfillment"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_fulfillment.Fulfillment.to_json(gcd_fulfillment.Fulfillment())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcd_fulfillment.Fulfillment(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_fulfillment_empty_call_rest():
    client = FulfillmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_fulfillment_empty_call_rest():
    client = FulfillmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.FulfillmentsGrpcTransport, grpc_helpers), (transports.FulfillmentsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_fulfillments_client_transport_session_collision(transport_name):
    ...
    client1 = FulfillmentsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = FulfillmentsClient(
        credentials=creds2,
        transport=transport_name,
    )
...
async def test_get_location_field_headers_async():
    client = FulfillmentsAsyncClient(credentials=async_anonymous_credentials())
...
@pytest.mark.parametrize(
    ...
    [
        (FulfillmentsClient, transports.FulfillmentsGrpcTransport),
        (FulfillmentsAsyncClient, transports.FulfillmentsGrpcAsyncIOTransport),
    ],
)

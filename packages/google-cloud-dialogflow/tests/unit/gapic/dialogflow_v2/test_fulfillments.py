...
def test_get_fulfillment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetFulfillment,
        "_BaseGetFulfillment__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_update_fulfillment_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateFulfillment,
        "_BaseUpdateFulfillment__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
from google.cloud.dialogflow_v2.services.fulfillments import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        FulfillmentsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        FulfillmentsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        FulfillmentsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                FulfillmentsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                FulfillmentsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(FulfillmentsClient),
)
@mock.patch.object(
    FulfillmentsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(FulfillmentsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = FulfillmentsClient._DEFAULT_UNIVERSE
    default_endpoint = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        FulfillmentsClient._get_api_endpoint(
    ...
    assert (
        ...
        == FulfillmentsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        FulfillmentsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        FulfillmentsClient._get_api_endpoint(None, None, default_universe, "always")
        == FulfillmentsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        FulfillmentsClient._get_api_endpoint(
    ...
    assert (
        FulfillmentsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        FulfillmentsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        FulfillmentsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        FulfillmentsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        FulfillmentsClient._get_universe_domain(None, None)
        == FulfillmentsClient._DEFAULT_UNIVERSE
    )
...
def test_fulfillments_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_get_fulfillment_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_fulfillment
...
def test_update_fulfillment_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_fulfillment in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_fulfillment] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_update_fulfillment_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_fulfillment
            in client._client._transport._wrapped_methods
        )
...
def test_get_fulfillment_rest_required_fields(
    request_type=fulfillment.GetFulfillmentRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_fulfillment._get_unset_required_fields(jsonified_request)
...
def test_get_fulfillment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{name=projects/*/agent/fulfillment}" % client.transport._host,
            args[1],
        )
...
def test_update_fulfillment_rest_required_fields(
    request_type=gcd_fulfillment.UpdateFulfillmentRequest,
):
    transport_class = transports.FulfillmentsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_fulfillment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_fulfillment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{fulfillment.name=projects/*/agent/fulfillment}"
...
def test_get_fulfillment_rest_bad_request(
    request_type=fulfillment.GetFulfillmentRequest,
):
    client = FulfillmentsClient(
...
def test_get_fulfillment_rest_interceptors(null_interceptor):
    transport = transports.FulfillmentsRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.FulfillmentsRestInterceptor(),
    )
    client = FulfillmentsClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.FulfillmentsRestInterceptor, "post_get_fulfillment"
        ) as post,
        mock.patch.object(
        ...
        pb_message = fulfillment.GetFulfillmentRequest.pb(
            fulfillment.GetFulfillmentRequest()
        )
...
def test_update_fulfillment_rest_bad_request(
    request_type=gcd_fulfillment.UpdateFulfillmentRequest,
):
    client = FulfillmentsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_update_fulfillment_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.FulfillmentsRestInterceptor, "post_update_fulfillment"
        ) as post,
        mock.patch.object(
            transports.FulfillmentsRestInterceptor,
            "post_update_fulfillment_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gcd_fulfillment.UpdateFulfillmentRequest.pb(
            gcd_fulfillment.UpdateFulfillmentRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_fulfillment.Fulfillment.to_json(
            gcd_fulfillment.Fulfillment()
        )
        req.return_value.content = return_value

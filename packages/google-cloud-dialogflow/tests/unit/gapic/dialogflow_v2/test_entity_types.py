...
def test__get_default_mtls_endpoint():
    ...
    assert (
        EntityTypesClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        EntityTypesClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        EntityTypesClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                EntityTypesClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                EntityTypesClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(EntityTypesClient),
)
@mock.patch.object(
    EntityTypesAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(EntityTypesAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EntityTypesClient._DEFAULT_UNIVERSE
    default_endpoint = EntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = EntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        EntityTypesClient._get_api_endpoint(
    ...
    assert (
        ...
        == EntityTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        EntityTypesClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        EntityTypesClient._get_api_endpoint(None, None, default_universe, "always")
        == EntityTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        EntityTypesClient._get_api_endpoint(
    ...
    assert (
        EntityTypesClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        EntityTypesClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        EntityTypesClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        EntityTypesClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        EntityTypesClient._get_universe_domain(None, None)
        == EntityTypesClient._DEFAULT_UNIVERSE
    )
...
def test_batch_update_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_update_entity_types
...
@pytest.mark.asyncio
async def test_batch_update_entity_types_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_update_entity_types
            in client._client._transport._wrapped_methods
        )
...
def test_batch_delete_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.batch_delete_entity_types
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_batch_delete_entity_types_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_delete_entity_types
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_batch_create_entities_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_create_entities
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_batch_update_entities_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_update_entities
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_batch_delete_entities_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.batch_delete_entities
            in client._client._transport._wrapped_methods
        )
...
def test_list_entity_types_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.EntityTypesRestInterceptor,

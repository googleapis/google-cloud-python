...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert EntityTypesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert EntityTypesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                EntityTypesClient._use_client_cert_effective()
...
async def test_list_entity_types_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_entity_types), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_entity_types(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_batch_update_entity_types_rest_required_fields(request_type=entity_type.BatchUpdateEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_update_entity_types._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_delete_entity_types_rest_required_fields(request_type=entity_type.BatchDeleteEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_delete_entity_types._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_create_entities_rest_required_fields(request_type=entity_type.BatchCreateEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_entities._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_update_entities_rest_required_fields(request_type=entity_type.BatchUpdateEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_update_entities._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_delete_entities_rest_required_fields(request_type=entity_type.BatchDeleteEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_delete_entities._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = EntityTypesClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = EntityTypesAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = EntityTypesAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = EntityTypesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_entity_types_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.EntityTypesRestInterceptor, "post_list_entity_types") as post, mock.patch.object(
...
def test_get_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EntityTypesRestInterceptor, "post_get_entity_type") as post, mock.patch.object(
...
def test_create_entity_type_rest_call_success(request_type):
    ...
    request_init["entity_type"] = {
        ...
        "entities": [{"value": "value_value", "synonyms": ["synonyms_value1", "synonyms_value2"]}],
        "enable_fuzzy_extraction": True,
    }
...
def test_create_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EntityTypesRestInterceptor, "post_create_entity_type") as post, mock.patch.object(
...
def test_update_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EntityTypesRestInterceptor, "post_update_entity_type") as post, mock.patch.object(
...
def test_delete_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EntityTypesRestInterceptor, "pre_delete_entity_type") as pre:
        pre.assert_not_called()
...
def test_batch_update_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EntityTypesRestInterceptor, "post_batch_update_entity_types_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_delete_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EntityTypesRestInterceptor, "post_batch_delete_entity_types_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_create_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EntityTypesRestInterceptor, "post_batch_create_entities_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_update_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EntityTypesRestInterceptor, "post_batch_update_entities_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_delete_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.EntityTypesRestInterceptor, "post_batch_delete_entities_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.EntityTypesGrpcTransport, grpc_helpers), (transports.EntityTypesGrpcAsyncIOTransport, grpc_helpers_async)],
)

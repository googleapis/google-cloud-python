...
def test_list_knowledge_bases_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListKnowledgeBases,
        "_BaseListKnowledgeBases__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_get_knowledge_base_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetKnowledgeBase,
        "_BaseGetKnowledgeBase__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_knowledge_base_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateKnowledgeBase,
        "_BaseCreateKnowledgeBase__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_knowledge_base_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteKnowledgeBase,
        "_BaseDeleteKnowledgeBase__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_knowledge_base_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateKnowledgeBase,
        "_BaseUpdateKnowledgeBase__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

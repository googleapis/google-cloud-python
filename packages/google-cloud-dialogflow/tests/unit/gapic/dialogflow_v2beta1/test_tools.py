...
from google.cloud.dialogflow_v2beta1.services.tools import (
    ToolsAsyncClient,
    ToolsClient,
    pagers,
    transports,
...
def test_tools_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dialogflow_v2beta1.services.tools.transports.ToolsGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_create_tool_async(
    transport: str = "grpc_asyncio", request_type=gcd_tool.CreateToolRequest
):
    client = ToolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_update_tool_async(
    transport: str = "grpc_asyncio", request_type=gcd_tool.UpdateToolRequest
):
    client = ToolsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_tool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/locations/*}/tools" % client.transport._host,
            args[1],
        )
...
def test_get_tool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/locations/*/tools/*}" % client.transport._host,
            args[1],
        )
...
def test_update_tool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "tool": {"name": "projects/sample1/locations/sample2/tools/sample3"}
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{tool.name=projects/*/locations/*/tools/*}"
...
def test_tools_base_transport():
    ...
    with mock.patch(
        "google.cloud.dialogflow_v2beta1.services.tools.transports.ToolsTransport.__init__"
    ) as Transport:

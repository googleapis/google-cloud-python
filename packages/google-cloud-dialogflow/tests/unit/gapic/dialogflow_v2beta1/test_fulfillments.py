...
from google.cloud.dialogflow_v2beta1.services.fulfillments import FulfillmentsAsyncClient, FulfillmentsClient, transports
...
def test_fulfillments_client_client_options_from_dict():
    with mock.patch("google.cloud.dialogflow_v2beta1.services.fulfillments.transports.FulfillmentsGrpcTransport.__init__") as grpc_transport:
...
def test_get_fulfillment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2beta1/{name=projects/*/agent/fulfillment}" % client.transport._host, args[1])
...
def test_update_fulfillment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{fulfillment.name=projects/*/agent/fulfillment}" % client.transport._host, args[1])
...
def test_fulfillments_base_transport():
    ...
    with mock.patch("google.cloud.dialogflow_v2beta1.services.fulfillments.transports.FulfillmentsTransport.__init__") as Transport:

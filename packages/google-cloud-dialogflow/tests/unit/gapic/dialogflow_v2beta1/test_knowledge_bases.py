...
def test_list_knowledge_bases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*}/knowledgeBases" % client.transport._host,
            args[1],
        )
...
def test_get_knowledge_base_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/knowledgeBases/*}" % client.transport._host,
            args[1],
        )
...
def test_update_knowledge_base_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{knowledge_base.name=projects/*/knowledgeBases/*}"

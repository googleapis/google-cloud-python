...
from google.cloud.dialogflow_v2beta1.services.documents import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DocumentsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        DocumentsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        DocumentsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DocumentsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                DocumentsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DocumentsClient),
)
@mock.patch.object(
    DocumentsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
...
def test__get_api_endpoint():
    ...
    default_endpoint = DocumentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = DocumentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        DocumentsClient._get_api_endpoint(
    ...
    assert (
        ...
        == DocumentsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DocumentsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        DocumentsClient._get_api_endpoint(None, None, default_universe, "always")
        == DocumentsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        DocumentsClient._get_api_endpoint(
    ...
    assert (
        DocumentsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        DocumentsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        DocumentsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        DocumentsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        DocumentsClient._get_universe_domain(None, None)
        == DocumentsClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_reload_document_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.reload_document
            in client._client._transport._wrapped_methods
        )
...
async def test_reload_document_async(request_type, transport: str = "grpc_asyncio"):
    client = DocumentsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_documents_rest_required_fields(
    request_type=document.ListDocumentsRequest,
):
...
def test_list_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/knowledgeBases/*}/documents"
...
def test_get_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/knowledgeBases/*/documents/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_document_rest_required_fields(
    request_type=gcd_document.CreateDocumentRequest,
):
    transport_class = transports.DocumentsRestTransport
...
def test_import_documents_rest_required_fields(
    request_type=document.ImportDocumentsRequest,
):
    transport_class = transports.DocumentsRestTransport
...
def test_delete_document_rest_required_fields(
    request_type=document.DeleteDocumentRequest,
):
    transport_class = transports.DocumentsRestTransport
...
def test_update_document_rest_required_fields(
    request_type=gcd_document.UpdateDocumentRequest,
):
    transport_class = transports.DocumentsRestTransport
...
def test_update_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{document.name=projects/*/knowledgeBases/*/documents/*}"
            % client.transport._host,
            args[1],
        )
...
def test_reload_document_rest_required_fields(
    request_type=document.ReloadDocumentRequest,
):
    transport_class = transports.DocumentsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).reload_document._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reload_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/knowledgeBases/*/documents/*}:reload"
            % client.transport._host,
            args[1],
        )
...
def test_transport_kind_grpc_asyncio():
    transport = DocumentsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = DocumentsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_documents_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = document.ListDocumentsResponse.to_json(
            document.ListDocumentsResponse()
        )

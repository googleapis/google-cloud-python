...
def test_get_location_field_headers():
    client = DocumentsClient(credentials=_AnonymousCredentialsWithUniverseDomain())
...
async def test_get_location_field_headers_async():
    client = DocumentsAsyncClient(credentials=_AnonymousCredentialsWithUniverseDomain())

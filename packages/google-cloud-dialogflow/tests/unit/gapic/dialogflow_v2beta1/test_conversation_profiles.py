    ...
    with mock.patch.object(type(client.transport.set_suggestion_feature_config), "__call__") as call:
        ...
        client.set_suggestion_feature_config(
            ...
            suggestion_feature_config=gcd_conversation_profile.HumanAgentAssistantConfig.SuggestionFeatureConfig(
                suggestion_feature=participant.SuggestionFeature(type_=participant.SuggestionFeature.Type.ARTICLE_SUGGESTION)
            ),
        )
...
def test_set_suggestion_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{conversation_profile=projects/*/conversationProfiles/*}:setSuggestionFeatureConfig" % client.transport._host, args[1]
        )
...
def test_clear_suggestion_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{conversation_profile=projects/*/conversationProfiles/*}:clearSuggestionFeatureConfig" % client.transport._host, args[1]
        )
...
def test_create_conversation_profile_rest_call_success(request_type):
    ...
    request_init["conversation_profile"] = {
                ...
                "feature_configs": [
                    {
                        ...
                        "rai_settings": {"rai_category_configs": [{"category": 1, "sensitivity_level": 1}]},
        ...
        "tts_config": {
            ...
            "pronunciations": [{"phrase": "phrase_value", "phonetic_encoding": 1, "pronunciation": "pronunciation_value"}],
        },
    }

...
from google.cloud.dialogflow_v2beta1.services.answer_records import AnswerRecordsAsyncClient, AnswerRecordsClient, pagers, transports
from google.cloud.dialogflow_v2beta1.types import context, generator, intent, participant, session, tool_call
...
def test_get_answer_record(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_answer_record), "__call__") as call:
...
def test_get_answer_record_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_answer_record] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_answer_record_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_answer_record in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_answer_record] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_answer_record_async(transport: str = "grpc_asyncio", request_type=answer_record.GetAnswerRecordRequest):
    client = AnswerRecordsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_answer_records_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2beta1/{parent=projects/*}/answerRecords" % client.transport._host, args[1])
...
def test_update_answer_record_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{answer_record.name=projects/*/answerRecords/*}" % client.transport._host, args[1])
...
def test_get_answer_record_empty_call_grpc():
    client = AnswerRecordsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_answer_record), "__call__") as call:
        call.return_value = answer_record.AnswerRecord()
        client.get_answer_record(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_answer_record_empty_call_grpc_asyncio():
    client = AnswerRecordsAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.get_answer_record), "__call__") as call:
        ...
        await client.get_answer_record(request=None)
...
def test_get_answer_record_rest_bad_request(request_type=answer_record.GetAnswerRecordRequest):
...
def test_get_answer_record_rest_call_success(request_type):
    client = AnswerRecordsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_answer_record_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.AnswerRecordsRestInterceptor, "post_get_answer_record") as post, mock.patch.object(
        transports.AnswerRecordsRestInterceptor, "post_get_answer_record_with_metadata"
        ...
        pb_message = answer_record.GetAnswerRecordRequest.pb(answer_record.GetAnswerRecordRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = answer_record.AnswerRecord.to_json(answer_record.AnswerRecord())
        ...
        post_with_metadata.return_value = answer_record.AnswerRecord(), metadata
                    ...
                    "fulfillment_messages": [
                        {
                            ...
                            "telephony_synthesize_speech": {"text": "text_value", "ssml": "ssml_value"},
                            "telephony_transfer_call": {"phone_number": "phone_number_value"},
                            "rbm_text": {
                                "text": "text_value",
                                "rbm_suggestion": [
                                    {
                                        "reply": {"text": "text_value", "postback_data": "postback_data_value"},
                                        "action": {
                                            "text": "text_value",
                            ...
                            "rbm_standalone_rich_card": {
                                ...
                                "card_content": {
                                    "title": "title_value",
                                    "description": "description_value",
                                    "media": {"file_uri": "file_uri_value", "thumbnail_uri": "thumbnail_uri_value", "height": 1},
                                    "suggestions": {},
                                },
                            },
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_answer_record_empty_call_rest():
    client = AnswerRecordsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_answer_records_base_transport():
    ...
    with mock.patch("google.cloud.dialogflow_v2beta1.services.answer_records.transports.AnswerRecordsTransport.__init__") as Transport:

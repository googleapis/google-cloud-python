...
from google.cloud.dialogflow_v2beta1.services.session_entity_types import SessionEntityTypesAsyncClient, SessionEntityTypesClient, pagers, transports
...
def test__read_environment_variables():
    assert SessionEntityTypesClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SessionEntityTypesClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                SessionEntityTypesClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert SessionEntityTypesClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SessionEntityTypesClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SessionEntityTypesClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SessionEntityTypesClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SessionEntityTypesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SessionEntityTypesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SessionEntityTypesClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert SessionEntityTypesClient._get_client_cert_source(None, False) is None
    assert SessionEntityTypesClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SessionEntityTypesClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert SessionEntityTypesClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SessionEntityTypesClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(SessionEntityTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionEntityTypesClient))
@mock.patch.object(SessionEntityTypesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionEntityTypesAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SessionEntityTypesClient._DEFAULT_UNIVERSE
    default_endpoint = SessionEntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SessionEntityTypesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SessionEntityTypesClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        SessionEntityTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == SessionEntityTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SessionEntityTypesClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SessionEntityTypesClient._get_api_endpoint(None, None, default_universe, "always") == SessionEntityTypesClient.DEFAULT_MTLS_ENDPOINT
    assert (
        SessionEntityTypesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SessionEntityTypesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SessionEntityTypesClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SessionEntityTypesClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SessionEntityTypesClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SessionEntityTypesClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SessionEntityTypesClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SessionEntityTypesClient._get_universe_domain(None, None) == SessionEntityTypesClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SessionEntityTypesClient, transports.SessionEntityTypesRestTransport, "rest", "true"),
        (SessionEntityTypesClient, transports.SessionEntityTypesRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(SessionEntityTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionEntityTypesClient))
@mock.patch.object(SessionEntityTypesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionEntityTypesAsyncClient))
...
@mock.patch.object(SessionEntityTypesClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionEntityTypesClient))
@mock.patch.object(SessionEntityTypesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionEntityTypesAsyncClient))
def test_session_entity_types_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (SessionEntityTypesClient, transports.SessionEntityTypesGrpcTransport, "grpc", grpc_helpers),
        (SessionEntityTypesAsyncClient, transports.SessionEntityTypesGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (SessionEntityTypesClient, transports.SessionEntityTypesRestTransport, "rest", None),
    ],
)
...
def test_list_session_entity_types_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_session_entity_types in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_session_entity_types] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_session_entity_types_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_session_entity_types in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_session_entity_types] = mock_rpc
...
def test_list_session_entity_types_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_session_entity_types), "__call__") as call:
        ...
        pager = client.list_session_entity_types(request={}, retry=retry, timeout=timeout)
...
async def test_list_session_entity_types_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_session_entity_types), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_session_entity_types(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_session_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_session_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_session_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_session_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionEntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_session_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_session_entity_type] = mock_rpc
...
def test_create_session_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_session_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_session_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_session_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionEntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_session_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_session_entity_type] = mock_rpc
...
def test_create_session_entity_type_flattened():
    ...
    with mock.patch.object(type(client.transport.create_session_entity_type), "__call__") as call:
        ...
        client.create_session_entity_type(
            parent="parent_value",
            session_entity_type=gcd_session_entity_type.SessionEntityType(name="name_value"),
        )
...
def test_update_session_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_session_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_session_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_session_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionEntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_session_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_session_entity_type] = mock_rpc
...
def test_delete_session_entity_type_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_session_entity_type in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_session_entity_type] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_session_entity_type_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionEntityTypesAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_session_entity_type in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_session_entity_type] = mock_rpc
...
def test_list_session_entity_types_rest_required_fields(request_type=session_entity_type.ListSessionEntityTypesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_session_entity_types._get_unset_required_fields(
        jsonified_request
    )
...
def test_list_session_entity_types_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2beta1/{parent=projects/*/agent/sessions/*}/entityTypes" % client.transport._host, args[1])
...
def test_get_session_entity_type_rest_required_fields(request_type=session_entity_type.GetSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_session_entity_type._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta1/{name=projects/*/agent/sessions/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_create_session_entity_type_rest_required_fields(request_type=gcd_session_entity_type.CreateSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_session_entity_type._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_session_entity_type_rest_required_fields(request_type=gcd_session_entity_type.UpdateSessionEntityTypeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_session_entity_type._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_session_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{session_entity_type.name=projects/*/agent/sessions/*/entityTypes/*}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = SessionEntityTypesClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = SessionEntityTypesAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SessionEntityTypesAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SessionEntityTypesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_session_entity_types_rest_bad_request(request_type=session_entity_type.ListSessionEntityTypesRequest):
...
def test_list_session_entity_types_rest_interceptors(null_interceptor):
    transport = transports.SessionEntityTypesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SessionEntityTypesRestInterceptor(),
    )
    client = SessionEntityTypesClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_list_session_entity_types") as post, mock.patch.object(
        transports.SessionEntityTypesRestInterceptor, "post_list_session_entity_types_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_entity_type.ListSessionEntityTypesResponse.to_json(session_entity_type.ListSessionEntityTypesResponse())
        ...
        post_with_metadata.return_value = session_entity_type.ListSessionEntityTypesResponse(), metadata
...
def test_get_session_entity_type_rest_bad_request(request_type=session_entity_type.GetSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_get_session_entity_type") as post, mock.patch.object(
        transports.SessionEntityTypesRestInterceptor, "post_get_session_entity_type_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_entity_type.SessionEntityType.to_json(session_entity_type.SessionEntityType())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = session_entity_type.SessionEntityType(), metadata
...
def test_create_session_entity_type_rest_bad_request(request_type=gcd_session_entity_type.CreateSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/agent/sessions/sample2"}
    request = request_type(**request_init)
...
def test_create_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_create_session_entity_type") as post, mock.patch.object(
        transports.SessionEntityTypesRestInterceptor, "post_create_session_entity_type_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_session_entity_type.SessionEntityType.to_json(gcd_session_entity_type.SessionEntityType())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcd_session_entity_type.SessionEntityType(), metadata
...
def test_update_session_entity_type_rest_bad_request(request_type=gcd_session_entity_type.UpdateSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionEntityTypesRestInterceptor, "post_update_session_entity_type") as post, mock.patch.object(
        transports.SessionEntityTypesRestInterceptor, "post_update_session_entity_type_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_session_entity_type_rest_bad_request(request_type=session_entity_type.DeleteSessionEntityTypeRequest):
    client = SessionEntityTypesClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/agent/sessions/sample2/entityTypes/sample3"}
    request = request_type(**request_init)
...
def test_delete_session_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionEntityTypesRestInterceptor, "pre_delete_session_entity_type") as pre:
        pre.assert_not_called()
...
def test_session_entity_types_base_transport():
    ...
    with mock.patch("google.cloud.dialogflow_v2beta1.services.session_entity_types.transports.SessionEntityTypesTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.SessionEntityTypesGrpcTransport, grpc_helpers), (transports.SessionEntityTypesGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SessionEntityTypesAsyncClient, transports.SessionEntityTypesGrpcAsyncIOTransport),
    ],
)

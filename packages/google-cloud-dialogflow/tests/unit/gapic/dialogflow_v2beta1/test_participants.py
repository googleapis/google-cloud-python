...
async def test_list_suggestions_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_compile_suggestion_async(request_type, transport: str = "grpc_asyncio"):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_suggestions_rest_bad_request(
    request_type=participant.ListSuggestionsRequest,
):
    client = ParticipantsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_suggestions_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = participant.ListSuggestionsResponse.to_json(
            participant.ListSuggestionsResponse()
        )
        req.return_value.content = return_value
...
def test_compile_suggestion_rest_bad_request(
    request_type=participant.CompileSuggestionRequest,
):
    client = ParticipantsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_compile_suggestion_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = participant.CompileSuggestionResponse.to_json(
            participant.CompileSuggestionResponse()
        )
        req.return_value.content = return_value

...
from google.cloud.dialogflow_v2beta1.services.participants import ParticipantsAsyncClient, ParticipantsClient, pagers, transports
...
def test_create_participant(request_type, transport: str = "grpc"):
    ...
    assert response.agent_desktop_source == gcd_participant.Participant.AgentDesktopSource.LIVE_PERSON
...
def test_get_participant(request_type, transport: str = "grpc"):
    ...
    assert response.obfuscated_external_user_id == "obfuscated_external_user_id_value"
    assert response.agent_desktop_source == participant.Participant.AgentDesktopSource.LIVE_PERSON
...
def test_bidi_streaming_analyze_content_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.bidi_streaming_analyze_content in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.bidi_streaming_analyze_content] = mock_rpc
        request = [{}]
...
@pytest.mark.asyncio
async def test_bidi_streaming_analyze_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ParticipantsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.bidi_streaming_analyze_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.bidi_streaming_analyze_content] = mock_rpc
...
@pytest.mark.asyncio
async def test_bidi_streaming_analyze_content_async(transport: str = "grpc_asyncio", request_type=participant.BidiStreamingAnalyzeContentRequest):
    client = ParticipantsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.bidi_streaming_analyze_content), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.StreamStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[participant.BidiStreamingAnalyzeContentResponse()])
...
async def test_list_suggestions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_suggestions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            participant.ListSuggestionsResponse(
                suggestions=[
...
def test_compile_suggestion(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.compile_suggestion), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_analyze_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{participant=projects/*/conversations/*/participants/*}:analyzeContent" % client.transport._host, args[1]
        )
...
def test_suggest_articles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestArticles" % client.transport._host, args[1]
        )
...
def test_suggest_faq_answers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestFaqAnswers" % client.transport._host, args[1]
        )
...
def test_suggest_smart_replies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/conversations/*/participants/*}/suggestions:suggestSmartReplies" % client.transport._host, args[1]
        )
...
def test_bidi_streaming_analyze_content_rest_error():
    ...
    assert "Method BidiStreamingAnalyzeContent is not available over REST transport" in str(not_implemented_error.value)
...
def test_list_suggestions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_list_suggestions") as post, mock.patch.object(
...
def test_compile_suggestion_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParticipantsRestInterceptor, "post_compile_suggestion") as post, mock.patch.object(

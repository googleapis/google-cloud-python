...
def test_detect_intent_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = gcd_session.DetectIntentResponse.to_json(
            gcd_session.DetectIntentResponse()
        )
...
def test_detect_intent_rest_bad_request(
    transport: str = "rest", request_type=gcd_session.DetectIntentRequest
):
    client = SessionsClient(
        credentials=_AnonymousCredentialsWithUniverseDomain(),
        transport=transport,
...
def test_get_location_field_headers():
    client = SessionsClient(credentials=_AnonymousCredentialsWithUniverseDomain())
...
async def test_get_location_field_headers_async():
    client = SessionsAsyncClient(credentials=_AnonymousCredentialsWithUniverseDomain())

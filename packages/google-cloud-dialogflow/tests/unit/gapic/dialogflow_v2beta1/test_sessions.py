...
from google.cloud.dialogflow_v2beta1.services.sessions import SessionsAsyncClient, SessionsClient, transports
from google.cloud.dialogflow_v2beta1.types import agent, audio_config, context, entity_type
    ...
    with mock.patch.object(type(client.transport.detect_intent), "__call__") as call:
        ...
        client.detect_intent(
            ...
            query_input=gcd_session.QueryInput(
                audio_config=audio_config.InputAudioConfig(audio_encoding=audio_config.AudioEncoding.AUDIO_ENCODING_LINEAR_16)
            ),
        )

...
def test_get_location_field_headers():
    client = ContextsClient(credentials=_AnonymousCredentialsWithUniverseDomain())
...
async def test_get_location_field_headers_async():
    client = ContextsAsyncClient(credentials=_AnonymousCredentialsWithUniverseDomain())

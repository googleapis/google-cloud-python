...
from google.cloud.dialogflow_v2beta1.services.contexts.transports.base import (
...
@pytest.mark.parametrize("client_class", [ContextsClient, ContextsAsyncClient,])
def test_contexts_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_contexts_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True

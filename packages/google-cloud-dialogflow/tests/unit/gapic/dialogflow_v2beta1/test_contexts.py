...
def test__get_client_cert_source():
    ...
    assert (
        ContextsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        ContextsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ContextsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ContextsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ContextsClient),
)
@mock.patch.object(
    ContextsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ContextsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ContextsClient._DEFAULT_UNIVERSE
    default_endpoint = ContextsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ContextsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ContextsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ContextsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ContextsClient._get_api_endpoint(None, None, default_universe, "always")
        == ContextsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ContextsClient._get_api_endpoint(
    ...
    assert (
        ContextsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ContextsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ContextsClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        ContextsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ContextsClient._get_universe_domain(None, None)
        == ContextsClient._DEFAULT_UNIVERSE
    )
...
def test_contexts_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_contexts_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_context_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_context
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_context_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_context
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_context_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_context
            in client._client._transport._wrapped_methods
        )
...
def test_delete_all_contexts_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_all_contexts in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_all_contexts_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_all_contexts
            in client._client._transport._wrapped_methods
        )
...
def test_list_contexts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent/sessions/*}/contexts"
...
def test_get_context_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/agent/sessions/*/contexts/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_context_rest_required_fields(
    request_type=gcd_context.CreateContextRequest,
):
    transport_class = transports.ContextsRestTransport
...
def test_update_context_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{context.name=projects/*/agent/sessions/*/contexts/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_all_contexts_rest_required_fields(
    request_type=context.DeleteAllContextsRequest,
):
    transport_class = transports.ContextsRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_all_contexts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc_asyncio():
    transport = ContextsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ContextsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = context.ListContextsResponse.to_json(
            context.ListContextsResponse()
        )
...
def test_update_context_rest_bad_request(request_type=gcd_context.UpdateContextRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "context": {"name": "projects/sample1/agent/sessions/sample2/contexts/sample3"}
    }
    request = request_type(**request_init)
...
def test_delete_all_contexts_rest_bad_request(
    request_type=context.DeleteAllContextsRequest,
):
    client = ContextsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"

...
from google.cloud.dialogflow_v2beta1.services.agents import (
    AgentsAsyncClient,
    AgentsClient,
    pagers,
    transports,
...
def test_get_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*}/agent" % client.transport._host, args[1]
        )
...
def test_set_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{agent.parent=projects/*}/agent" % client.transport._host,
            args[1],
        )
...
def test_search_agents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*}/agent:search" % client.transport._host,
            args[1],
        )
...
def test_train_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*}/agent:train" % client.transport._host,
            args[1],
        )
...
def test_export_agent_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*}/agent:export" % client.transport._host,
            args[1],
        )

...
def test_list_entity_types_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent}/entityTypes" % client.transport._host,
            args[1],
        )
...
def test_get_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/agent/entityTypes/*}" % client.transport._host,
            args[1],
        )
...
def test_update_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{entity_type.name=projects/*/agent/entityTypes/*}"
...
def test_batch_delete_entity_types_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent}/entityTypes:batchDelete"
            % client.transport._host,
            args[1],
        )
...
def test_batch_create_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent/entityTypes/*}/entities:batchCreate"
            % client.transport._host,
            args[1],
        )
...
def test_batch_update_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent/entityTypes/*}/entities:batchUpdate"
            % client.transport._host,
            args[1],
        )
...
def test_batch_delete_entities_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent/entityTypes/*}/entities:batchDelete"
            % client.transport._host,
            args[1],
        )

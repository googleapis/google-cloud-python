...
from google.cloud.dialogflow_v2beta1.services.versions import (
    VersionsAsyncClient,
    VersionsClient,
    pagers,
    transports,
...
def test_list_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta1/{parent=projects/*/agent}/versions" % client.transport._host,
            args[1],
        )
...
def test_get_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{name=projects/*/agent/versions/*}" % client.transport._host,
            args[1],
        )
...
def test_update_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta1/{version.name=projects/*/agent/versions/*}"

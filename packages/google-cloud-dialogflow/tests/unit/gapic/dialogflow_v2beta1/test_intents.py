...
def test_batch_update_intents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_update_intents] = (
            mock_rpc
        )
        request = {}
...
def test_batch_delete_intents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_delete_intents] = (
            mock_rpc
        )
        request = {}
...
def test_batch_update_intents_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateIntents,
...
def test_batch_delete_intents_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchDeleteIntents,

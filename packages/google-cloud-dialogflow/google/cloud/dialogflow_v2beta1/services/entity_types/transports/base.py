...
class EntityTypesTransport(abc.ABC):
    ...
    def create_entity_type(
        self,
    ) -> Callable[[gcd_entity_type.CreateEntityTypeRequest], Union[gcd_entity_type.EntityType, Awaitable[gcd_entity_type.EntityType]]]:
        raise NotImplementedError()

    @property
    def update_entity_type(
        self,
    ) -> Callable[[gcd_entity_type.UpdateEntityTypeRequest], Union[gcd_entity_type.EntityType, Awaitable[gcd_entity_type.EntityType]]]:
        raise NotImplementedError()
    ...
    def batch_update_entity_types(
        self,
    ) -> Callable[[entity_type.BatchUpdateEntityTypesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def batch_delete_entity_types(
        self,
    ) -> Callable[[entity_type.BatchDeleteEntityTypesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def batch_create_entities(
        self,
    ) -> Callable[[entity_type.BatchCreateEntitiesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def batch_update_entities(
        self,
    ) -> Callable[[entity_type.BatchUpdateEntitiesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def batch_delete_entities(
        self,
    ) -> Callable[[entity_type.BatchDeleteEntitiesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

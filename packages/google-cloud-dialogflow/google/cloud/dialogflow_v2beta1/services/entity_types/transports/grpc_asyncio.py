...
class EntityTypesGrpcAsyncIOTransport(EntityTypesTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.batch_update_entity_types: gapic_v1.method_async.wrap_method(
                self.batch_update_entity_types,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_delete_entity_types: gapic_v1.method_async.wrap_method(
                self.batch_delete_entity_types,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_create_entities: gapic_v1.method_async.wrap_method(
                self.batch_create_entities,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_update_entities: gapic_v1.method_async.wrap_method(
                self.batch_update_entities,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_delete_entities: gapic_v1.method_async.wrap_method(

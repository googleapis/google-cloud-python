...
class GeneratorsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_generator(
        self, request: gcd_generator.CreateGeneratorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcd_generator.CreateGeneratorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_generator_with_metadata(
        self, response: gcd_generator.Generator, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_update_generator(
        self, request: gcd_generator.UpdateGeneratorRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcd_generator.UpdateGeneratorRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class GeneratorsRestTransport(_BaseGeneratorsRestTransport):
    ...
    @property
    def create_generator(self) -> Callable[[gcd_generator.CreateGeneratorRequest], gcd_generator.Generator]:
    ...
    @property
    def update_generator(self) -> Callable[[gcd_generator.UpdateGeneratorRequest], gcd_generator.Generator]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

...
class ListToolsPager:
    ...
    :class:`google.cloud.dialogflow_v2beta1.types.ListToolsResponse` object, and
    ...
    All the usual :class:`google.cloud.dialogflow_v2beta1.types.ListToolsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.dialogflow_v2beta1.types.ListToolsRequest):
                The initial request object.
            response (google.cloud.dialogflow_v2beta1.types.ListToolsResponse):

...
class ToolsClient(metaclass=ToolsClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2beta1.ToolsClient`.",
                    extra={
    ...
    def create_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.CreateToolRequest, dict]):
    ...
    def get_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.GetToolRequest, dict]):
    ...
    def list_tools(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.ListToolsRequest, dict]):
    ...
    def delete_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.DeleteToolRequest, dict]):
    ...
    def update_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.UpdateToolRequest, dict]):

...
class ToolsGrpcAsyncIOTransport(ToolsTransport):
    ...
    @property
    def create_tool(self) -> Callable[[gcd_tool.CreateToolRequest], Awaitable[gcd_tool.Tool]]:
    ...
    @property
    def update_tool(self) -> Callable[[gcd_tool.UpdateToolRequest], Awaitable[gcd_tool.Tool]]:

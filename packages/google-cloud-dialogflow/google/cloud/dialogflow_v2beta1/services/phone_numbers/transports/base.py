...
class PhoneNumbersTransport(abc.ABC):
    """Abstract transport class for PhoneNumbers."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_phone_numbers: gapic_v1.method.wrap_method(
                self.list_phone_numbers,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_phone_number: gapic_v1.method.wrap_method(
                self.update_phone_number,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_phone_number: gapic_v1.method.wrap_method(
                self.delete_phone_number,
                default_timeout=None,
                client_info=client_info,
            ),
            self.undelete_phone_number: gapic_v1.method.wrap_method(

...
class DocumentsGrpcAsyncIOTransport(DocumentsTransport):
    ...
    @property
    def list_documents(self) -> Callable[[document.ListDocumentsRequest], Awaitable[document.ListDocumentsResponse]]:
    ...
    @property
    def get_document(self) -> Callable[[document.GetDocumentRequest], Awaitable[document.Document]]:
    ...
    @property
    def create_document(self) -> Callable[[gcd_document.CreateDocumentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_documents(self) -> Callable[[document.ImportDocumentsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_document(self) -> Callable[[document.DeleteDocumentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_document(self) -> Callable[[gcd_document.UpdateDocumentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def reload_document(self) -> Callable[[document.ReloadDocumentRequest], Awaitable[operations_pb2.Operation]]:

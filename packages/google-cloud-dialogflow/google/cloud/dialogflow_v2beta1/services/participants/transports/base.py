...
class ParticipantsTransport(abc.ABC):
    ...
    def bidi_streaming_analyze_content(
        ...
        Union[participant.BidiStreamingAnalyzeContentResponse, Awaitable[participant.BidiStreamingAnalyzeContentResponse]],
    ]:
        raise NotImplementedError()
    ...
    def list_suggestions(
        self,
    ) -> Callable[[participant.ListSuggestionsRequest], Union[participant.ListSuggestionsResponse, Awaitable[participant.ListSuggestionsResponse]]]:
        raise NotImplementedError()
    ...
    def compile_suggestion(
        ...
        [participant.CompileSuggestionRequest], Union[participant.CompileSuggestionResponse, Awaitable[participant.CompileSuggestionResponse]]
    ]:
        raise NotImplementedError()

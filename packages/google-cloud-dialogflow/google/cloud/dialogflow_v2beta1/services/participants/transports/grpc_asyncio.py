...
class ParticipantsGrpcAsyncIOTransport(ParticipantsTransport):
    ...
    def bidi_streaming_analyze_content(
        self,
    ) -> Callable[[participant.BidiStreamingAnalyzeContentRequest], Awaitable[participant.BidiStreamingAnalyzeContentResponse]]:
    ...
    @property
    def list_suggestions(self) -> Callable[[participant.ListSuggestionsRequest], Awaitable[participant.ListSuggestionsResponse]]:
    ...
    @property
    def compile_suggestion(self) -> Callable[[participant.CompileSuggestionRequest], Awaitable[participant.CompileSuggestionResponse]]:

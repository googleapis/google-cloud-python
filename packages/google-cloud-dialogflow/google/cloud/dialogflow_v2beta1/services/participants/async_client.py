...
class ParticipantsAsyncClient:
    ...
    def bidi_streaming_analyze_content(
        self,
        requests: Optional[AsyncIterator[participant.BidiStreamingAnalyzeContentRequest]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.bidi_streaming_analyze_content]
    ...
    async def list_suggestions(
        ...
        *,
        ...
        """
        warnings.warn("ParticipantsAsyncClient.list_suggestions is deprecated", DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_suggestions]
    ...
    async def compile_suggestion(
        ...
        *,
        ...
        """
        warnings.warn("ParticipantsAsyncClient.compile_suggestion is deprecated", DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.compile_suggestion]

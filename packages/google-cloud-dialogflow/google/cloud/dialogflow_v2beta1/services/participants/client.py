...
class ParticipantsClient(metaclass=ParticipantsClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ParticipantsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ParticipantsTransport, Callable[..., ParticipantsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ParticipantsClient._read_environment_variables()
        self._client_cert_source = ParticipantsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ParticipantsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ParticipantsTransport], Callable[..., ParticipantsTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2beta1.ParticipantsClient`.",
                    extra={
    ...
    def update_participant(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("participant.name", request.participant.name),)),)
    ...
    def analyze_content(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [participant, text_input, audio_input, event_input]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("participant", request.participant),)),)
    ...
    def bidi_streaming_analyze_content(
        self,
        requests: Optional[Iterator[participant.BidiStreamingAnalyzeContentRequest]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.bidi_streaming_analyze_content]
    ...
    def suggest_knowledge_assist(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2beta1.types.SuggestKnowledgeAssistRequest, dict]):
                The request object. The request message for
    ...
    def list_suggestions(
        ...
        *,
        ...
        """
        warnings.warn("ParticipantsClient.list_suggestions is deprecated", DeprecationWarning)
    ...
    def compile_suggestion(
        ...
        *,
        ...
        """
        warnings.warn("ParticipantsClient.compile_suggestion is deprecated", DeprecationWarning)

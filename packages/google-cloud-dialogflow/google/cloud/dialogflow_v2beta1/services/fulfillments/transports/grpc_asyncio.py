...
class FulfillmentsGrpcAsyncIOTransport(FulfillmentsTransport):
    ...
    @property
    def get_fulfillment(self) -> Callable[[fulfillment.GetFulfillmentRequest], Awaitable[fulfillment.Fulfillment]]:
    ...
    @property
    def update_fulfillment(self) -> Callable[[gcd_fulfillment.UpdateFulfillmentRequest], Awaitable[gcd_fulfillment.Fulfillment]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_fulfillment: self._wrap_method(
                self.get_fulfillment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_fulfillment: self._wrap_method(

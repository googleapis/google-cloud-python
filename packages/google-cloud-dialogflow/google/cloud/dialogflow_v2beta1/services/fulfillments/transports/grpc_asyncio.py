...
class FulfillmentsGrpcAsyncIOTransport(FulfillmentsTransport):
    ...
    def get_fulfillment(
        ...
        [fulfillment.GetFulfillmentRequest], Awaitable[fulfillment.Fulfillment]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_fulfillment: gapic_v1.method_async.wrap_method(
                self.get_fulfillment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_fulfillment: gapic_v1.method_async.wrap_method(

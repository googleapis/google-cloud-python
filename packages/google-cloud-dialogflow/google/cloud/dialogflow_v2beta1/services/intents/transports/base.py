...
class IntentsTransport(abc.ABC):
    ...
    def list_intents(
        ...
        Union[intent.ListIntentsResponse, Awaitable[intent.ListIntentsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def get_intent(
        ...
        [intent.GetIntentRequest], Union[intent.Intent, Awaitable[intent.Intent]]
    ]:
        raise NotImplementedError()
    ...
    def create_intent(
        ...
        Union[gcd_intent.Intent, Awaitable[gcd_intent.Intent]],
    ]:
        raise NotImplementedError()

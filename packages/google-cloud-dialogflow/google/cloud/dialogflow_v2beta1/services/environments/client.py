...
class EnvironmentsClient(metaclass=EnvironmentsClientMeta):
    ...
    def environment_path(project: str, environment: str,) -> str:
        ...
        return "projects/{project}/agent/environments/{environment}".format(
    ...
    def parse_environment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/agent/environments/(?P<environment>.+?)$", path
        )
    ...
    def get_environment(
        ...
        *,
        ...
        Args:
            request (google.cloud.dialogflow_v2beta1.types.GetEnvironmentRequest):
                The request object. The request message for
    ...
    def create_environment(
        ...
        *,
        ...
        Args:
            request (google.cloud.dialogflow_v2beta1.types.CreateEnvironmentRequest):
                The request object. The request message for
    ...
    def update_environment(
        ...
        *,
        ...
        Args:
            request (google.cloud.dialogflow_v2beta1.types.UpdateEnvironmentRequest):
                The request object. The request message for
    ...
    def delete_environment(
        ...
        *,
        ...
        Args:
            request (google.cloud.dialogflow_v2beta1.types.DeleteEnvironmentRequest):
                The request object. The request message for

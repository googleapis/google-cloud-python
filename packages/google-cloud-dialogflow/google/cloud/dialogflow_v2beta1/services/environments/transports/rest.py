...
class EnvironmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_environment(
        self, request: environment.CreateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[environment.CreateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_environment_history(
        self, request: environment.GetEnvironmentHistoryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[environment.GetEnvironmentHistoryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_environment_history_with_metadata(
        self, response: environment.EnvironmentHistory, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def pre_update_environment(
        self, request: environment.UpdateEnvironmentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[environment.UpdateEnvironmentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:

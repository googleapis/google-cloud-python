...
class EnvironmentsGrpcAsyncIOTransport(EnvironmentsTransport):
    ...
    @property
    def create_environment(self) -> Callable[[environment.CreateEnvironmentRequest], Awaitable[environment.Environment]]:
    ...
    @property
    def update_environment(self) -> Callable[[environment.UpdateEnvironmentRequest], Awaitable[environment.Environment]]:
    ...
    @property
    def get_environment_history(self) -> Callable[[environment.GetEnvironmentHistoryRequest], Awaitable[environment.EnvironmentHistory]]:

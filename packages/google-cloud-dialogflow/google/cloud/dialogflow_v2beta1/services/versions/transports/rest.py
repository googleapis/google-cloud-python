...
class VersionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_version(
        self, request: gcd_version.CreateVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcd_version.CreateVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_version_with_metadata(
        self, response: gcd_version.Version, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcd_version.Version, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_version
    ...
    def pre_update_version(
        self, request: gcd_version.UpdateVersionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcd_version.UpdateVersionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.CreateVersion",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsClient.create_version",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "CreateVersion",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.DeleteVersion",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.GetVersion",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "GetVersion",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsClient.get_version",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "GetVersion",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.ListVersions",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsClient.list_versions",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "ListVersions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.UpdateVersion",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsClient.update_version",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "UpdateVersion",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2beta1.VersionsClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2beta1.VersionsAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2beta1.Versions",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

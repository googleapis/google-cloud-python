...
class VersionsTransport(abc.ABC):
    ...
    @property
    def create_version(self) -> Callable[[gcd_version.CreateVersionRequest], Union[gcd_version.Version, Awaitable[gcd_version.Version]]]:
        raise NotImplementedError()

    @property
    def update_version(self) -> Callable[[gcd_version.UpdateVersionRequest], Union[gcd_version.Version, Awaitable[gcd_version.Version]]]:
        raise NotImplementedError()

...
class AnswerRecordsClient(metaclass=AnswerRecordsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or AnswerRecordsClient._get_api_endpoint(
    ...
    def get_answer_record(
        ...
        *,
        ...
        """
        warnings.warn("AnswerRecordsClient.get_answer_record is deprecated", DeprecationWarning)

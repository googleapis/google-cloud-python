...
class AnswerRecordsGrpcAsyncIOTransport(AnswerRecordsTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_answer_record: gapic_v1.method_async.wrap_method(
                self.get_answer_record,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_answer_records: gapic_v1.method_async.wrap_method(
                self.list_answer_records,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_answer_record: gapic_v1.method_async.wrap_method(

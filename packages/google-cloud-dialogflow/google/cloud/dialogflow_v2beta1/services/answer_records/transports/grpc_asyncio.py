...
class AnswerRecordsGrpcAsyncIOTransport(AnswerRecordsTransport):
    ...
    @property
    def get_answer_record(self) -> Callable[[answer_record.GetAnswerRecordRequest], Awaitable[answer_record.AnswerRecord]]:
    ...
    @property
    def list_answer_records(self) -> Callable[[answer_record.ListAnswerRecordsRequest], Awaitable[answer_record.ListAnswerRecordsResponse]]:
    ...
    @property
    def update_answer_record(self) -> Callable[[gcd_answer_record.UpdateAnswerRecordRequest], Awaitable[gcd_answer_record.AnswerRecord]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_answer_record: self._wrap_method(
                self.get_answer_record,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_answer_records: self._wrap_method(
                self.list_answer_records,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_answer_record: self._wrap_method(

...
class AnswerRecordsTransport(abc.ABC):
    ...
    def get_answer_record(
        self,
    ) -> Callable[[answer_record.GetAnswerRecordRequest], Union[answer_record.AnswerRecord, Awaitable[answer_record.AnswerRecord]]]:
        raise NotImplementedError()
    ...
    def list_answer_records(
        ...
        [answer_record.ListAnswerRecordsRequest], Union[answer_record.ListAnswerRecordsResponse, Awaitable[answer_record.ListAnswerRecordsResponse]]
    ]:
        raise NotImplementedError()
    ...
    def update_answer_record(
        self,
    ) -> Callable[[gcd_answer_record.UpdateAnswerRecordRequest], Union[gcd_answer_record.AnswerRecord, Awaitable[gcd_answer_record.AnswerRecord]]]:
        raise NotImplementedError()

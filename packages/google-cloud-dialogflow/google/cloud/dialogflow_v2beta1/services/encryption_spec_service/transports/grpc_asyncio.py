...
class EncryptionSpecServiceGrpcAsyncIOTransport(EncryptionSpecServiceTransport):
    """gRPC AsyncIO backend transport for EncryptionSpecService.
    ...
    @property
    def get_encryption_spec(self) -> Callable[[encryption_spec.GetEncryptionSpecRequest], Awaitable[encryption_spec.EncryptionSpec]]:
    ...
    @property
    def initialize_encryption_spec(self) -> Callable[[gcd_encryption_spec.InitializeEncryptionSpecRequest], Awaitable[operations_pb2.Operation]]:
...
__all__ = ("EncryptionSpecServiceGrpcAsyncIOTransport",)

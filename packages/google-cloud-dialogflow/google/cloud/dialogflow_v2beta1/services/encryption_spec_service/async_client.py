...
class EncryptionSpecServiceAsyncClient:
    ...
    _client: EncryptionSpecServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = EncryptionSpecServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = EncryptionSpecServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = EncryptionSpecServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = EncryptionSpecServiceClient._DEFAULT_UNIVERSE

    encryption_spec_path = staticmethod(EncryptionSpecServiceClient.encryption_spec_path)
    parse_encryption_spec_path = staticmethod(EncryptionSpecServiceClient.parse_encryption_spec_path)
    common_billing_account_path = staticmethod(EncryptionSpecServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(EncryptionSpecServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(EncryptionSpecServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(EncryptionSpecServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(EncryptionSpecServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(EncryptionSpecServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(EncryptionSpecServiceClient.common_project_path)
    parse_common_project_path = staticmethod(EncryptionSpecServiceClient.parse_common_project_path)
    common_location_path = staticmethod(EncryptionSpecServiceClient.common_location_path)
    parse_common_location_path = staticmethod(EncryptionSpecServiceClient.parse_common_location_path)
    ...
    def transport(self) -> EncryptionSpecServiceTransport:
        ...
        Returns:
            EncryptionSpecServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = EncryptionSpecServiceClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, EncryptionSpecServiceTransport, Callable[..., EncryptionSpecServiceTransport]]] = "grpc_asyncio",
        ...
        """
        self._client = EncryptionSpecServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2beta1.EncryptionSpecServiceAsyncClient`.",
                extra={
    ...
    async def get_encryption_spec(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.GetEncryptionSpecRequest, dict]]):
    ...
    async def initialize_encryption_spec(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2beta1.types.InitializeEncryptionSpecRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.dialogflow_v2beta1.types.InitializeEncryptionSpecResponse`
    ...
    async def __aenter__(self) -> "EncryptionSpecServiceAsyncClient":
        return self
...
__all__ = ("EncryptionSpecServiceAsyncClient",)

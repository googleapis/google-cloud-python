...
class EncryptionSpecServiceAsyncClient:
    ...
    encryption_spec_path = staticmethod(
        EncryptionSpecServiceClient.encryption_spec_path
    )
    ...
    parse_common_location_path = staticmethod(
        EncryptionSpecServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            EncryptionSpecServiceClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            EncryptionSpecServiceClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    async def initialize_encryption_spec(
        self,
        request: Optional[
            Union[gcd_encryption_spec.InitializeEncryptionSpecRequest, dict]
        ] = None,
        *,

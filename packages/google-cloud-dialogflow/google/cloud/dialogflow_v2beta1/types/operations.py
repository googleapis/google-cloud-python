...
class GeneratorEvaluationOperationMetadata(proto.Message):
    r"""Metadata for a
    ...
    Attributes:
        generator_evaluation (str):
            Output only. The resource name of the generator evaluation.
            Format:
            ``projects/<Project ID>/locations/<Location ID>/generators/<Generator ID>/evaluations/<Evaluation ID>``
    """

    generator_evaluation: str = proto.Field(
        proto.STRING,
        number=1,
    )

...
class CreateGeneratorEvaluationRequest(proto.Message):
    ...
    Attributes:
        ...
        generator_evaluation (google.cloud.dialogflow_v2.types.GeneratorEvaluation):
...
class ListGeneratorEvaluationsResponse(proto.Message):
    ...
    Attributes:
        generator_evaluations (MutableSequence[google.cloud.dialogflow_v2.types.GeneratorEvaluation]):
...
class GeneratorEvaluation(proto.Message):
    ...
    Attributes:
        ...
        generator_evaluation_config (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig):
        ...
        initial_generator (google.cloud.dialogflow_v2.types.Generator):
            ...
            the evaluation.
        summarization_metrics (google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics):
            Output only. Only available when the
            summarization generator is provided.

            This field is a member of `oneof`_ ``metrics``.
        evaluation_status (google.cloud.dialogflow_v2.types.EvaluationStatus):
...
class SummarizationEvaluationMetrics(proto.Message):
    ...
    Attributes:
        summarization_evaluation_results (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.SummarizationEvaluationResult]):
        ...
        overall_metrics (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.OverallScoresByMetric]):
            Output only. A list of aggregated(average)
            scores per metric section.
        overall_section_tokens (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.SectionToken]):
        ...
        conversation_details (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.ConversationDetail]):
    ...
    class Decomposition(proto.Message):
        ...
        Attributes:
            accuracy_decomposition (google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.AccuracyDecomposition):
                only available for accuracy metric.

                This field is a member of `oneof`_ ``decomposition``.
            adherence_decomposition (google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.AdherenceDecomposition):
    ...
    class EvaluationResult(proto.Message):
        ...
        Attributes:
            ...
            adherence_rubric (google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.AdherenceRubric):
                Only available for adherence metric.

                This field is a member of `oneof`_ ``result``.
            completeness_rubric (google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.CompletenessRubric):
    ...
    class SummarizationEvaluationResult(proto.Message):
        ...
        Attributes:
            ...
            decompositions (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.Decomposition]):
                Output only. List of decompostion details
            evaluation_results (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.EvaluationResult]):
    ...
    class ConversationDetail(proto.Message):
        ...
        conatins evaluation results of all the metrics and sections.
        ...
        Attributes:
            ...
            metric_details (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.ConversationDetail.MetricDetail]):
                Output only. List of metric details.
            section_tokens (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.SectionToken]):
        ...
        class MetricDetail(proto.Message):
            r"""Aggregated result on metric level. This conatins the
            ...
            Attributes:
                ...
                section_details (MutableSequence[google.cloud.dialogflow_v2.types.SummarizationEvaluationMetrics.ConversationDetail.MetricDetail.SectionDetail]):
...
class GeneratorEvaluationConfig(proto.Message):
    ...
    Attributes:
        input_data_config (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig.InputDataConfig):
        ...
        summarization_config (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig.SummarizationConfig):
    ...
    class InputDataConfig(proto.Message):
        ...
        Attributes:
            input_data_source_type (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig.InputDataSourceType):
            ...
            is_summary_generation_allowed (bool):
                ...
                size.
            summary_generation_option (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig.InputDataConfig.SummaryGenerationOption):
                Optional. Option to control whether summaries
                are generated during evaluation.
            agent_assist_input_data_config (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig.AgentAssistInputDataConfig):
            ...
            dataset_input_data_config (google.cloud.dialogflow_v2.types.GeneratorEvaluationConfig.DatasetInputDataConfig):

...
class ListSipTrunksResponse(proto.Message):
    ...
    Attributes:
        sip_trunks (MutableSequence[google.cloud.dialogflow_v2.types.SipTrunk]):
...
class SipTrunk(proto.Message):
    ...
    Attributes:
        ...
        expected_hostname (MutableSequence[str]):
            ...
            authentication.
        connections (MutableSequence[google.cloud.dialogflow_v2.types.Connection]):
...
class Connection(proto.Message):
    ...
    Attributes:
        connection_id (str):
            ...
            Trunk connection.
        state (google.cloud.dialogflow_v2.types.Connection.State):
        ...
        error_details (google.cloud.dialogflow_v2.types.Connection.ErrorDetails):
    ...
    class ErrorDetails(proto.Message):
        ...
        Attributes:
            certificate_state (google.cloud.dialogflow_v2.types.Connection.CertificateState):

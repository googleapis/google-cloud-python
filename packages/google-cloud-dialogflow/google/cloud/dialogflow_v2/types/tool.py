...
class Tool(proto.Message):
    ...
    Attributes:
        ...
        function_spec (google.cloud.dialogflow_v2.types.Tool.FunctionTool):
            Client side executed function specification.

            This field is a member of `oneof`_ ``specification``.
        connector_spec (google.cloud.dialogflow_v2.types.Tool.ConnectorTool):
            Integration connectors tool specification.

            This field is a member of `oneof`_ ``specification``.
        open_api_spec (google.cloud.dialogflow_v2.types.Tool.OpenApiTool):
            OpenAPI tool.
    ...
    class FunctionTool(proto.Message):
        ...
        Attributes:
            ...
            output_schema (google.protobuf.struct_pb2.Struct):
                ...
                object.
            method_type (google.cloud.dialogflow_v2.types.Tool.MethodType):
    ...
    class OpenApiTool(proto.Message):
        ...
        Attributes:
            ...
            authentication (google.cloud.dialogflow_v2.types.Tool.Authentication):
                Optional. Authentication information required
                by the API.
            tls_config (google.cloud.dialogflow_v2.types.Tool.TLSConfig):
                Optional. TLS configuration for the HTTPS
                verification.
            service_directory_config (google.cloud.dialogflow_v2.types.Tool.ServiceDirectoryConfig):
    ...
    class ConnectorTool(proto.Message):
        ...
        Attributes:
            ...
            actions (MutableSequence[google.cloud.dialogflow_v2.types.Tool.ConnectorTool.Action]):
        ...
        class Action(proto.Message):
            ...
            Attributes:
                ...
                entity_operation (google.cloud.dialogflow_v2.types.Tool.ConnectorTool.Action.EntityOperation):
            ...
            class EntityOperation(proto.Message):
                ...
                Attributes:
                    ...
                    operation (google.cloud.dialogflow_v2.types.Tool.ConnectorTool.Action.EntityOperation.OperationType):
    ...
    class Authentication(proto.Message):
        ...
        Attributes:
            api_key_config (google.cloud.dialogflow_v2.types.Tool.Authentication.ApiKeyConfig):
                Config for API key auth.

                This field is a member of `oneof`_ ``auth_config``.
            oauth_config (google.cloud.dialogflow_v2.types.Tool.Authentication.OAuthConfig):
                Config for OAuth.
            ...
            service_agent_auth_config (google.cloud.dialogflow_v2.types.Tool.Authentication.ServiceAgentAuthConfig):
                ...
                This field is a member of `oneof`_ ``auth_config``.
            bearer_token_config (google.cloud.dialogflow_v2.types.Tool.Authentication.BearerTokenConfig):
        ...
        class ApiKeyConfig(proto.Message):
            ...
            Attributes:
                ...
                request_location (google.cloud.dialogflow_v2.types.Tool.Authentication.RequestLocation):
        ...
        class OAuthConfig(proto.Message):
            ...
            Attributes:
                oauth_grant_type (google.cloud.dialogflow_v2.types.Tool.Authentication.OAuthConfig.OauthGrantType):
    ...
    class TLSConfig(proto.Message):
        ...
        Attributes:
            ca_certs (MutableSequence[google.cloud.dialogflow_v2.types.Tool.TLSConfig.CACert]):

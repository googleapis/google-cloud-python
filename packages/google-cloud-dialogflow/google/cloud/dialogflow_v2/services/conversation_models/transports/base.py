...
class ConversationModelsTransport(abc.ABC):
    ...
    def create_conversation_model(
        self,
    ) -> Callable[[gcd_conversation_model.CreateConversationModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    def get_conversation_model(
        ...
        [conversation_model.GetConversationModelRequest], Union[conversation_model.ConversationModel, Awaitable[conversation_model.ConversationModel]]
    ]:
        raise NotImplementedError()
    ...
    def list_conversation_models(
        ...
        Union[conversation_model.ListConversationModelsResponse, Awaitable[conversation_model.ListConversationModelsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def delete_conversation_model(
        self,
    ) -> Callable[[conversation_model.DeleteConversationModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def deploy_conversation_model(
        self,
    ) -> Callable[[conversation_model.DeployConversationModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def undeploy_conversation_model(
        self,
    ) -> Callable[[conversation_model.UndeployConversationModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    def get_conversation_model_evaluation(
        ...
        Union[conversation_model.ConversationModelEvaluation, Awaitable[conversation_model.ConversationModelEvaluation]],
    ]:
        raise NotImplementedError()
    ...
    def list_conversation_model_evaluations(
        ...
        Union[conversation_model.ListConversationModelEvaluationsResponse, Awaitable[conversation_model.ListConversationModelEvaluationsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def create_conversation_model_evaluation(
        ...
        [conversation_model.CreateConversationModelEvaluationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]
    ]:
        raise NotImplementedError()

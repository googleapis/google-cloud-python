...
class ConversationModelsGrpcAsyncIOTransport(ConversationModelsTransport):
    ...
    @property
    def create_conversation_model(self) -> Callable[[gcd_conversation_model.CreateConversationModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_conversation_model(self) -> Callable[[conversation_model.GetConversationModelRequest], Awaitable[conversation_model.ConversationModel]]:
    ...
    def list_conversation_models(
        self,
    ) -> Callable[[conversation_model.ListConversationModelsRequest], Awaitable[conversation_model.ListConversationModelsResponse]]:
    ...
    @property
    def delete_conversation_model(self) -> Callable[[conversation_model.DeleteConversationModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def deploy_conversation_model(self) -> Callable[[conversation_model.DeployConversationModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def undeploy_conversation_model(self) -> Callable[[conversation_model.UndeployConversationModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def get_conversation_model_evaluation(
        self,
    ) -> Callable[[conversation_model.GetConversationModelEvaluationRequest], Awaitable[conversation_model.ConversationModelEvaluation]]:
    ...
    def list_conversation_model_evaluations(
        ...
        [conversation_model.ListConversationModelEvaluationsRequest], Awaitable[conversation_model.ListConversationModelEvaluationsResponse]
    ]:
    ...
    def create_conversation_model_evaluation(
        self,
    ) -> Callable[[conversation_model.CreateConversationModelEvaluationRequest], Awaitable[operations_pb2.Operation]]:

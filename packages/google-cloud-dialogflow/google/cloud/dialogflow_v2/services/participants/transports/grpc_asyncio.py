...
class ParticipantsGrpcAsyncIOTransport(ParticipantsTransport):
    ...
    @property
    def create_participant(self) -> Callable[[gcd_participant.CreateParticipantRequest], Awaitable[gcd_participant.Participant]]:
    ...
    @property
    def get_participant(self) -> Callable[[participant.GetParticipantRequest], Awaitable[participant.Participant]]:
    ...
    @property
    def list_participants(self) -> Callable[[participant.ListParticipantsRequest], Awaitable[participant.ListParticipantsResponse]]:
    ...
    @property
    def update_participant(self) -> Callable[[gcd_participant.UpdateParticipantRequest], Awaitable[gcd_participant.Participant]]:
    ...
    @property
    def analyze_content(self) -> Callable[[gcd_participant.AnalyzeContentRequest], Awaitable[gcd_participant.AnalyzeContentResponse]]:
    ...
    def streaming_analyze_content(
        self,
    ) -> Callable[[participant.StreamingAnalyzeContentRequest], Awaitable[participant.StreamingAnalyzeContentResponse]]:
    ...
    @property
    def suggest_articles(self) -> Callable[[participant.SuggestArticlesRequest], Awaitable[participant.SuggestArticlesResponse]]:
    ...
    @property
    def suggest_faq_answers(self) -> Callable[[participant.SuggestFaqAnswersRequest], Awaitable[participant.SuggestFaqAnswersResponse]]:
    ...
    @property
    def suggest_smart_replies(self) -> Callable[[participant.SuggestSmartRepliesRequest], Awaitable[participant.SuggestSmartRepliesResponse]]:
    ...
    def suggest_knowledge_assist(
        self,
    ) -> Callable[[participant.SuggestKnowledgeAssistRequest], Awaitable[participant.SuggestKnowledgeAssistResponse]]:

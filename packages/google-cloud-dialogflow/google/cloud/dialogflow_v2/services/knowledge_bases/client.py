...
class KnowledgeBasesClient(metaclass=KnowledgeBasesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = KnowledgeBasesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = KnowledgeBasesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = KnowledgeBasesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = KnowledgeBasesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = KnowledgeBasesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, KnowledgeBasesTransport, Callable[..., KnowledgeBasesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = KnowledgeBasesClient._read_environment_variables()
        self._client_cert_source = KnowledgeBasesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = KnowledgeBasesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, KnowledgeBasesTransport)
        if transport_provided:
            ...
            self._transport = cast(KnowledgeBasesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or KnowledgeBasesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[KnowledgeBasesTransport], Callable[..., KnowledgeBasesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2.KnowledgeBasesClient`.",
                    extra={
    ...
    def create_knowledge_base(
        self,
        request: Optional[Union[gcd_knowledge_base.CreateKnowledgeBaseRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, knowledge_base]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def delete_knowledge_base(
        self,
        request: Optional[Union[knowledge_base.DeleteKnowledgeBaseRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_knowledge_base(
        self,
        request: Optional[Union[gcd_knowledge_base.UpdateKnowledgeBaseRequest, dict]] = None,
        *,
        knowledge_base: Optional[gcd_knowledge_base.KnowledgeBase] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [knowledge_base, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("knowledge_base.name", request.knowledge_base.name),)),)

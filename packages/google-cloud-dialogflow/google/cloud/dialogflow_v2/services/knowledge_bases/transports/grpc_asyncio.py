...
class KnowledgeBasesGrpcAsyncIOTransport(KnowledgeBasesTransport):
    """gRPC AsyncIO backend transport for KnowledgeBases.
    ...
    @property
    def list_knowledge_bases(self) -> Callable[[knowledge_base.ListKnowledgeBasesRequest], Awaitable[knowledge_base.ListKnowledgeBasesResponse]]:
        ...
        Returns:
            Callable[[~.ListKnowledgeBasesRequest],
                    Awaitable[~.ListKnowledgeBasesResponse]]:
        ...
        if "list_knowledge_bases" not in self._stubs:
            self._stubs["list_knowledge_bases"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_knowledge_base(self) -> Callable[[knowledge_base.GetKnowledgeBaseRequest], Awaitable[knowledge_base.KnowledgeBase]]:
        ...
        if "get_knowledge_base" not in self._stubs:
            self._stubs["get_knowledge_base"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_knowledge_base(self) -> Callable[[gcd_knowledge_base.CreateKnowledgeBaseRequest], Awaitable[gcd_knowledge_base.KnowledgeBase]]:
        ...
        if "create_knowledge_base" not in self._stubs:
            self._stubs["create_knowledge_base"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_knowledge_base(self) -> Callable[[knowledge_base.DeleteKnowledgeBaseRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if "delete_knowledge_base" not in self._stubs:
            self._stubs["delete_knowledge_base"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_knowledge_base(self) -> Callable[[gcd_knowledge_base.UpdateKnowledgeBaseRequest], Awaitable[gcd_knowledge_base.KnowledgeBase]]:
        ...
        if "update_knowledge_base" not in self._stubs:
            self._stubs["update_knowledge_base"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_knowledge_bases: self._wrap_method(
                self.list_knowledge_bases,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_knowledge_base: self._wrap_method(
                self.get_knowledge_base,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_knowledge_base: self._wrap_method(
                self.create_knowledge_base,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_knowledge_base: self._wrap_method(
                self.delete_knowledge_base,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_knowledge_base: self._wrap_method(

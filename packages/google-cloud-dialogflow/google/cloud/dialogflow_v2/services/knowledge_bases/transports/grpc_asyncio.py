...
class KnowledgeBasesGrpcAsyncIOTransport(KnowledgeBasesTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_knowledge_bases: gapic_v1.method_async.wrap_method(
                self.list_knowledge_bases,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_knowledge_base: gapic_v1.method_async.wrap_method(
                self.get_knowledge_base,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_knowledge_base: gapic_v1.method_async.wrap_method(
                self.create_knowledge_base,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_knowledge_base: gapic_v1.method_async.wrap_method(
                self.delete_knowledge_base,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_knowledge_base: gapic_v1.method_async.wrap_method(

        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v2/{parent=projects/*}/answerRecords",
                },
                {
                    "method": "get",
                    "uri": "/v2/{parent=projects/*/locations/*}/answerRecords",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v2/{answer_record.name=projects/*/answerRecords/*}",
                    "body": "answer_record",
                },
                {
                    "method": "patch",
                    "uri": "/v2/{answer_record.name=projects/*/locations/*/answerRecords/*}",
                    "body": "answer_record",
                },
            ]

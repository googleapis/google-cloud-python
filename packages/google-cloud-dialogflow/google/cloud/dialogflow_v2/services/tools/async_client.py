...
class ToolsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2.ToolsAsyncClient`.",
                extra={
    ...
    async def create_tool(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.CreateToolRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            tool (:class:`google.cloud.dialogflow_v2.types.Tool`):
    ...
    async def get_tool(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.GetToolRequest, dict]]):
    ...
    async def list_tools(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.ListToolsRequest, dict]]):
        ...
        Returns:
            google.cloud.dialogflow_v2.services.tools.pagers.ListToolsAsyncPager:
    ...
    async def delete_tool(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.DeleteToolRequest, dict]]):
    ...
    async def update_tool(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.UpdateToolRequest, dict]]):

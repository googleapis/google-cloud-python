...
from .transports.rest import ToolsRestTransport


class ToolsClientMeta(type):
    """Metaclass for the Tools client.
...
class ToolsClient(metaclass=ToolsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ToolsClient: The constructed client.
        """
    ...
    def transport(self) -> ToolsTransport:
        ...
        Returns:
            ToolsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ToolsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ToolsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ToolsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ToolsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            ToolsClient._read_environment_variables()
        )
        self._client_cert_source = ToolsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ToolsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ToolsTransport)
        if transport_provided:
            # transport is a ToolsTransport instance.
            ...
            self._transport = cast(ToolsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ToolsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2.ToolsClient`.",
                    extra={
    ...
    def create_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.CreateToolRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            tool (google.cloud.dialogflow_v2.types.Tool):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_tool():
                ...
                # Initialize request argument(s)
                request = dialogflow_v2.GetToolRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.GetToolRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_tools():
                ...
                # Initialize request argument(s)
                request = dialogflow_v2.ListToolsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.ListToolsRequest, dict]):
        ...
        Returns:
            google.cloud.dialogflow_v2.services.tools.pagers.ListToolsPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_tool():
                ...
                # Initialize request argument(s)
                request = dialogflow_v2.DeleteToolRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.DeleteToolRequest, dict]):
    ...
    def update_tool(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.UpdateToolRequest, dict]):

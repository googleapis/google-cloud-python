        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.CreateTool",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsClient.create_tool",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "CreateTool",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.DeleteTool",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "DeleteTool",
                        "httpRequest": http_request,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.GetTool",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "GetTool",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsClient.get_tool",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "GetTool",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.ListTools",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "ListTools",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsClient.list_tools",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "ListTools",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.UpdateTool",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "UpdateTool",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsClient.update_tool",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "UpdateTool",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.ToolsClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.ToolsAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.Tools",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

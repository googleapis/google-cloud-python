...
class SessionsGrpcAsyncIOTransport(SessionsTransport):
    ...
    @property
    def detect_intent(self) -> Callable[[gcd_session.DetectIntentRequest], Awaitable[gcd_session.DetectIntentResponse]]:
    ...
    @property
    def streaming_detect_intent(self) -> Callable[[session.StreamingDetectIntentRequest], Awaitable[session.StreamingDetectIntentResponse]]:

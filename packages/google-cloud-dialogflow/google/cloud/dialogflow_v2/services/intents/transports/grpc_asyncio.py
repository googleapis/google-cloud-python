...
class IntentsGrpcAsyncIOTransport(IntentsTransport):
    ...
    @property
    def list_intents(self) -> Callable[[intent.ListIntentsRequest], Awaitable[intent.ListIntentsResponse]]:
        ...
        if "list_intents" not in self._stubs:
            self._stubs["list_intents"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_intent(self) -> Callable[[intent.GetIntentRequest], Awaitable[intent.Intent]]:
        ...
        if "get_intent" not in self._stubs:
            self._stubs["get_intent"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_intent(self) -> Callable[[gcd_intent.CreateIntentRequest], Awaitable[gcd_intent.Intent]]:
    ...
    @property
    def update_intent(self) -> Callable[[gcd_intent.UpdateIntentRequest], Awaitable[gcd_intent.Intent]]:
    ...
    @property
    def delete_intent(self) -> Callable[[intent.DeleteIntentRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if "delete_intent" not in self._stubs:
            self._stubs["delete_intent"] = self._logged_channel.unary_unary(
    ...
    @property
    def batch_update_intents(self) -> Callable[[intent.BatchUpdateIntentsRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "batch_update_intents" not in self._stubs:
            self._stubs["batch_update_intents"] = self._logged_channel.unary_unary(
    ...
    @property
    def batch_delete_intents(self) -> Callable[[intent.BatchDeleteIntentsRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "batch_delete_intents" not in self._stubs:
            self._stubs["batch_delete_intents"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.batch_update_intents: self._wrap_method(
                self.batch_update_intents,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_delete_intents: self._wrap_method(

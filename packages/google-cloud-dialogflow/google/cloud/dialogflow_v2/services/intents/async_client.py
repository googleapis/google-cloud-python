...
class IntentsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, IntentsTransport, Callable[..., IntentsTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2.IntentsAsyncClient`.",
                extra={
    ...
    async def list_intents(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.ListIntentsRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_intents]
    ...
    async def get_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.GetIntentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_intent]
    ...
    async def create_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.CreateIntentRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, intent, language_code]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_intent]
    ...
    async def update_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.UpdateIntentRequest, dict]]):
                The request object. The request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [intent, language_code, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_intent]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("intent.name", request.intent.name),)),)
    ...
    async def delete_intent(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.DeleteIntentRequest, dict]]):
                The request object. The request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_intent]
    ...
    async def batch_update_intents(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.BatchUpdateIntentsRequest, dict]]):
                The request object.
            parent (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.dialogflow_v2.types.BatchUpdateIntentsResponse` The response message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, intent_batch_uri, intent_batch_inline]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_update_intents]
    ...
    async def batch_delete_intents(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.BatchDeleteIntentsRequest, dict]]):
                The request object. The request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            intents (:class:`MutableSequence[google.cloud.dialogflow_v2.types.Intent]`):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, intents]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_delete_intents]

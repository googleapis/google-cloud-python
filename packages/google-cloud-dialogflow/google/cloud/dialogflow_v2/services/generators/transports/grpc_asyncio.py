...
class GeneratorsGrpcAsyncIOTransport(GeneratorsTransport):
    ...
    @property
    def create_generator(self) -> Callable[[gcd_generator.CreateGeneratorRequest], Awaitable[gcd_generator.Generator]]:
    ...
    @property
    def update_generator(self) -> Callable[[gcd_generator.UpdateGeneratorRequest], Awaitable[gcd_generator.Generator]]:

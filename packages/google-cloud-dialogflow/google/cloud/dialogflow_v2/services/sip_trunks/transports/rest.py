    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[SipTrunksRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.CreateSipTrunk",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksClient.create_sip_trunk",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "CreateSipTrunk",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.DeleteSipTrunk",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.GetSipTrunk",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "GetSipTrunk",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksClient.get_sip_trunk",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "GetSipTrunk",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.ListSipTrunks",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksClient.list_sip_trunks",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "ListSipTrunks",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.UpdateSipTrunk",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksClient.update_sip_trunk",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "UpdateSipTrunk",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.SipTrunksClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.SipTrunksAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.SipTrunks",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

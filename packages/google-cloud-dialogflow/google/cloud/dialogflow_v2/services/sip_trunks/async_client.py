...
from google.cloud.dialogflow_v2.services.sip_trunks import pagers
...
class SipTrunksAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.dialogflow_v2.SipTrunksAsyncClient`.",
                extra={
    ...
    async def create_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.CreateSipTrunkRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            sip_trunk (:class:`google.cloud.dialogflow_v2.types.SipTrunk`):
        ...
        Returns:
            google.cloud.dialogflow_v2.types.SipTrunk:
    ...
    async def delete_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.DeleteSipTrunkRequest, dict]]):
                The request object. The request message for
    ...
    async def list_sip_trunks(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.ListSipTrunksRequest, dict]]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflow_v2.services.sip_trunks.pagers.ListSipTrunksAsyncPager:
    ...
    async def get_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.GetSipTrunkRequest, dict]]):
                The request object. The request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_sip_trunk():
                ...
                request = dialogflow_v2.UpdateSipTrunkRequest(
                    sip_trunk=sip_trunk,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.dialogflow_v2.types.UpdateSipTrunkRequest, dict]]):
                The request object. The request message for

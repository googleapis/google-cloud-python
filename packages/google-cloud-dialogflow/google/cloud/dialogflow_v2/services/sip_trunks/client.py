...
class SipTrunksClient(metaclass=SipTrunksClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=SipTrunksClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2.SipTrunksClient`.",
                    extra={
    ...
    def create_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.CreateSipTrunkRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            sip_trunk (google.cloud.dialogflow_v2.types.SipTrunk):
    ...
    def delete_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.DeleteSipTrunkRequest, dict]):
                The request object. The request message for
    ...
    def list_sip_trunks(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.ListSipTrunksRequest, dict]):
                The request object. The request message for
        ...
        Returns:
            google.cloud.dialogflow_v2.services.sip_trunks.pagers.ListSipTrunksPager:
    ...
    def get_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.GetSipTrunkRequest, dict]):
                The request object. The request message for
    ...
    def update_sip_trunk(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dialogflow_v2.types.UpdateSipTrunkRequest, dict]):
                The request object. The request message for

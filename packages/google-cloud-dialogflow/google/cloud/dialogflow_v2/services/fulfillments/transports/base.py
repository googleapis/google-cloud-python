...
class FulfillmentsTransport(abc.ABC):
    """Abstract transport class for Fulfillments."""
    ...
    @property
    def get_fulfillment(self) -> Callable[[fulfillment.GetFulfillmentRequest], Union[fulfillment.Fulfillment, Awaitable[fulfillment.Fulfillment]]]:
        raise NotImplementedError()

    @property
    def update_fulfillment(
        self,
    ) -> Callable[[gcd_fulfillment.UpdateFulfillmentRequest], Union[gcd_fulfillment.Fulfillment, Awaitable[gcd_fulfillment.Fulfillment]]]:
        raise NotImplementedError()

...
from .base import DEFAULT_CLIENT_INFO, FulfillmentsTransport
...
class FulfillmentsGrpcTransport(FulfillmentsTransport):
    ...
    def get_fulfillment(
        ...
        if "get_fulfillment" not in self._stubs:
            self._stubs["get_fulfillment"] = self._logged_channel.unary_unary(
    ...
    def update_fulfillment(
        ...
        if "update_fulfillment" not in self._stubs:
            self._stubs["update_fulfillment"] = self._logged_channel.unary_unary(

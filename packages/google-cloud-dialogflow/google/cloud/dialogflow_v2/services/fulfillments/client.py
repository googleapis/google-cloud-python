...
from .transports.base import DEFAULT_CLIENT_INFO, FulfillmentsTransport
...
from .transports.rest import FulfillmentsRestTransport
...
class FulfillmentsClientMeta(type):
    ...
    _transport_registry["rest"] = FulfillmentsRestTransport
...
class FulfillmentsClient(metaclass=FulfillmentsClientMeta):
    ...
    def transport(self) -> FulfillmentsTransport:
        ...
        Returns:
            FulfillmentsTransport: The transport used by the client
                instance.
        """
    ...
    def fulfillment_path(
        ...
        return "projects/{project}/agent/fulfillment".format(
            project=project,
        )
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = FulfillmentsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = FulfillmentsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = FulfillmentsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = FulfillmentsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FulfillmentsTransport, Callable[..., FulfillmentsTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,FulfillmentsTransport,Callable[..., FulfillmentsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the FulfillmentsTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FulfillmentsClient._read_environment_variables()
        self._client_cert_source = FulfillmentsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FulfillmentsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, FulfillmentsTransport)
        if transport_provided:
            ...
            self._transport = cast(FulfillmentsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or FulfillmentsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[FulfillmentsTransport], Callable[..., FulfillmentsTransport]] = (
                FulfillmentsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., FulfillmentsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dialogflow_v2.FulfillmentsClient`.",
                    extra={
    ...
    def get_fulfillment(
        self,
        request: Optional[Union[fulfillment.GetFulfillmentRequest, dict]] = None,
        *,
    ...
    def update_fulfillment(
        self,
        request: Optional[Union[gcd_fulfillment.UpdateFulfillmentRequest, dict]] = None,
        *,
        fulfillment: Optional[gcd_fulfillment.Fulfillment] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [fulfillment, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("fulfillment.name", request.fulfillment.name),)),)

...
class FulfillmentsClient(metaclass=FulfillmentsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = FulfillmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, FulfillmentsTransport, Callable[..., FulfillmentsTransport]]
        ] = None,
        ...
        self._client_cert_source = FulfillmentsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = FulfillmentsClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[FulfillmentsTransport], Callable[..., FulfillmentsTransport]
            ] = (

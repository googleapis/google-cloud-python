...
class _BaseAgentsRestTransport(AgentsTransport):
    """Base REST backend transport for Agents.
    ...
    class _BaseDeleteAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v2/{parent=projects/*}/agent",
                },
                {
                    "method": "delete",
                    "uri": "/v2/{parent=projects/*/locations/*}/agent",
                },
            ]
            return http_options
    ...
    class _BaseExportAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*}/agent:export",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*/locations/*}/agent:export",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseGetValidationResult:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v2/{parent=projects/*}/agent/validationResult",
                },
                {
                    "method": "get",
                    "uri": "/v2/{parent=projects/*/locations/*}/agent/validationResult",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAgentsRestTransport._BaseGetValidationResult._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseImportAgent:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*}/agent:import",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*/locations/*}/agent:import",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAgentsRestTransport._BaseImportAgent._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseRestoreAgent:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseSearchAgents:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v2/{parent=projects/*}/agent:search",
                },
                {
                    "method": "get",
                    "uri": "/v2/{parent=projects/*/locations/*}/agent:search",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAgentsRestTransport._BaseSearchAgents._get_unset_required_fields(query_params))
    ...
    class _BaseSetAgent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v2/{agent.parent=projects/*}/agent",
                    "body": "agent",
                },
                {
                    "method": "post",
                    "uri": "/v2/{agent.parent=projects/*/locations/*}/agent",
                    "body": "agent",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAgentsRestTransport._BaseSetAgent._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseTrainAgent:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*}/agent:train",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*/locations/*}/agent:train",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAgentsRestTransport._BaseTrainAgent._get_unset_required_fields(query_params))
...
__all__ = ("_BaseAgentsRestTransport",)

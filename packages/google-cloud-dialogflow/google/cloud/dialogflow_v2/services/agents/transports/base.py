...
class AgentsTransport(abc.ABC):
    ...
    @property
    def set_agent(self) -> Callable[[gcd_agent.SetAgentRequest], Union[gcd_agent.Agent, Awaitable[gcd_agent.Agent]]]:
        raise NotImplementedError()
    ...
    @property
    def search_agents(self) -> Callable[[agent.SearchAgentsRequest], Union[agent.SearchAgentsResponse, Awaitable[agent.SearchAgentsResponse]]]:
        raise NotImplementedError()

    @property
    def train_agent(self) -> Callable[[agent.TrainAgentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    @property
    def import_agent(self) -> Callable[[agent.ImportAgentRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    def get_validation_result(
        self,
    ) -> Callable[[agent.GetValidationResultRequest], Union[validation_result.ValidationResult, Awaitable[validation_result.ValidationResult]]]:
        raise NotImplementedError()

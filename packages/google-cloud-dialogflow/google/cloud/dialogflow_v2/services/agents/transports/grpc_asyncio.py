...
class AgentsGrpcAsyncIOTransport(AgentsTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.set_agent: gapic_v1.method_async.wrap_method(
                self.set_agent,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.search_agents: gapic_v1.method_async.wrap_method(
                self.search_agents,
                default_timeout=None,
                client_info=client_info,
            ),
            self.train_agent: gapic_v1.method_async.wrap_method(
                self.train_agent,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.import_agent: gapic_v1.method_async.wrap_method(
                self.import_agent,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.get_validation_result: gapic_v1.method_async.wrap_method(

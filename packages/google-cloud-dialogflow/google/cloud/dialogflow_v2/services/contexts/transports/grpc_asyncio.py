...
from .base import DEFAULT_CLIENT_INFO, ContextsTransport
...
class ContextsGrpcAsyncIOTransport(ContextsTransport):
    ...
    @property
    def list_contexts(self) -> Callable[[context.ListContextsRequest], Awaitable[context.ListContextsResponse]]:
    ...
    @property
    def get_context(self) -> Callable[[context.GetContextRequest], Awaitable[context.Context]]:
    ...
    @property
    def create_context(self) -> Callable[[gcd_context.CreateContextRequest], Awaitable[gcd_context.Context]]:
    ...
    @property
    def update_context(self) -> Callable[[gcd_context.UpdateContextRequest], Awaitable[gcd_context.Context]]:
    ...
    @property
    def delete_context(self) -> Callable[[context.DeleteContextRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def delete_all_contexts(self) -> Callable[[context.DeleteAllContextsRequest], Awaitable[empty_pb2.Empty]]:

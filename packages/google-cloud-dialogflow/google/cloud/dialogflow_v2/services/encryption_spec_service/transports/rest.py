...
class EncryptionSpecServiceRestInterceptor:
    """Interceptor for EncryptionSpecService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the EncryptionSpecServiceRestTransport.

    .. code-block:: python
        class MyCustomEncryptionSpecServiceInterceptor(EncryptionSpecServiceRestInterceptor):
        ...
        transport = EncryptionSpecServiceRestTransport(interceptor=MyCustomEncryptionSpecServiceInterceptor())
    ...
    def pre_get_encryption_spec(
        ...
        before they are sent to the EncryptionSpecService server.
        """
        return request, metadata
...
class EncryptionSpecServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: EncryptionSpecServiceRestInterceptor


class EncryptionSpecServiceRestTransport(_BaseEncryptionSpecServiceRestTransport):
    """REST backend synchronous transport for EncryptionSpecService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[EncryptionSpecServiceRestInterceptor] = None,
        ...
        self._interceptor = interceptor or EncryptionSpecServiceRestInterceptor()
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.GetEncryptionSpec",
                    extra={
            ...
            # Return the response
            resp = encryption_spec.EncryptionSpec()
            pb_resp = encryption_spec.EncryptionSpec.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.get_encryption_spec",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "GetEncryptionSpec",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.InitializeEncryptionSpec",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.initialize_encryption_spec",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "InitializeEncryptionSpec",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EncryptionSpecServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EncryptionSpecServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EncryptionSpecServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.dialogflow_v2.EncryptionSpecServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.dialogflow_v2.EncryptionSpecServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.dialogflow.v2.EncryptionSpecService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
...
__all__ = ("EncryptionSpecServiceRestTransport",)

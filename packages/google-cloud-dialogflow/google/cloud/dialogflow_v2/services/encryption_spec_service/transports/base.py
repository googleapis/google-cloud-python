...
class EncryptionSpecServiceTransport(abc.ABC):
    ...
    def get_encryption_spec(
        self,
    ) -> Callable[[encryption_spec.GetEncryptionSpecRequest], Union[encryption_spec.EncryptionSpec, Awaitable[encryption_spec.EncryptionSpec]]]:
        raise NotImplementedError()

    @property
    def initialize_encryption_spec(
        self,
    ) -> Callable[[gcd_encryption_spec.InitializeEncryptionSpecRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

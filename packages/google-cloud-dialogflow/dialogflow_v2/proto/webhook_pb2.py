...
_ORIGINALDETECTINTENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='payload', full_name='google.cloud.dialogflow.v2.OriginalDetectIntentRequest.payload', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEBHOOKREQUEST.fields_by_name['query_result'].message_type = google_dot_cloud_dot_dialogflow__v2_dot_proto_dot_session__pb2._QUERYRESULT
_WEBHOOKREQUEST.fields_by_name['original_detect_intent_request'].message_type = _ORIGINALDETECTINTENTREQUEST
_WEBHOOKRESPONSE.fields_by_name['fulfillment_messages'].message_type = google_dot_cloud_dot_dialogflow__v2_dot_proto_dot_intent__pb2._INTENT_MESSAGE
_WEBHOOKRESPONSE.fields_by_name['payload'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_WEBHOOKRESPONSE.fields_by_name['output_contexts'].message_type = google_dot_cloud_dot_dialogflow__v2_dot_proto_dot_context__pb2._CONTEXT
_WEBHOOKRESPONSE.fields_by_name['followup_event_input'].message_type = google_dot_cloud_dot_dialogflow__v2_dot_proto_dot_session__pb2._EVENTINPUT
...
OriginalDetectIntentRequest = _reflection.GeneratedProtocolMessageType('OriginalDetectIntentRequest', (_message.Message,), dict(
  ...
  Attributes:
      source:
          ...
          oogle.cloud.dialogflow.v2.Intent.Message.Platform].
      payload:

...
# [START ces_v1_generated_SessionService_StreamRunSession_async]
...
async def sample_stream_run_session():
    # Create a client
    client = ces_v1.SessionServiceAsyncClient()

    # Initialize request argument(s)
    config = ces_v1.SessionConfig()
    config.session = "session_value"

    inputs = ces_v1.SessionInput()
...
# [END ces_v1_generated_SessionService_StreamRunSession_async]

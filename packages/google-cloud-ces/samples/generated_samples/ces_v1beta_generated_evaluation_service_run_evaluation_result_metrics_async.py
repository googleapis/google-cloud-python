...
#
# Snippet for RunEvaluationResultMetrics
...
async def sample_run_evaluation_result_metrics():
    # Create a client
    ...
    # Make the request
    operation = await client.run_evaluation_result_metrics(request=request)

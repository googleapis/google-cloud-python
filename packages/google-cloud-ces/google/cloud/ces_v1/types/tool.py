...
from google.cloud.ces_v1.types import google_search_tool as gcc_google_search_tool
from google.cloud.ces_v1.types import mcp_tool as gcc_mcp_tool
from google.cloud.ces_v1.types import open_api_tool as gcc_open_api_tool
from google.cloud.ces_v1.types import python_function as gcc_python_function
from google.cloud.ces_v1.types import system_tool as gcc_system_tool
from google.cloud.ces_v1.types import widget_tool as gcc_widget_tool
...
class Tool(proto.Message):
    ...
    Attributes:
        client_function (google.cloud.ces_v1.types.ClientFunction):
            Optional. The client function.

            This field is a member of `oneof`_ ``tool_type``.
        open_api_tool (google.cloud.ces_v1.types.OpenApiTool):
            Optional. The open API tool.

            This field is a member of `oneof`_ ``tool_type``.
        google_search_tool (google.cloud.ces_v1.types.GoogleSearchTool):
            Optional. The google search tool.

            This field is a member of `oneof`_ ``tool_type``.
        connector_tool (google.cloud.ces_v1.types.ConnectorTool):
            Optional. The Integration Connector tool.

            This field is a member of `oneof`_ ``tool_type``.
        data_store_tool (google.cloud.ces_v1.types.DataStoreTool):
        ...
        python_function (google.cloud.ces_v1.types.PythonFunction):
            ...
            This field is a member of `oneof`_ ``tool_type``.
        mcp_tool (google.cloud.ces_v1.types.McpTool):
            Optional. The MCP tool. An MCP tool cannot be
            created or updated directly and is managed by
            the MCP toolset.

            This field is a member of `oneof`_ ``tool_type``.
        file_search_tool (google.cloud.ces_v1.types.FileSearchTool):
            Optional. The file search tool.

            This field is a member of `oneof`_ ``tool_type``.
        system_tool (google.cloud.ces_v1.types.SystemTool):

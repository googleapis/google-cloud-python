...
class ApiKeyConfig(proto.Message):
    ...
    Attributes:
        ...
        request_location (google.cloud.ces_v1.types.ApiKeyConfig.RequestLocation):
...
class OAuthConfig(proto.Message):
    ...
    Attributes:
        oauth_grant_type (google.cloud.ces_v1.types.OAuthConfig.OauthGrantType):
...
class EndUserAuthConfig(proto.Message):
    ...
    Attributes:
        oauth2_auth_code_config (google.cloud.ces_v1.types.EndUserAuthConfig.Oauth2AuthCodeConfig):
            Oauth 2.0 Authorization Code authentication.

            This field is a member of `oneof`_ ``auth_config``.
        oauth2_jwt_bearer_config (google.cloud.ces_v1.types.EndUserAuthConfig.Oauth2JwtBearerConfig):
...
class ApiAuthentication(proto.Message):
    ...
    Attributes:
        api_key_config (google.cloud.ces_v1.types.ApiKeyConfig):
            Optional. Config for API key auth.

            This field is a member of `oneof`_ ``auth_config``.
        oauth_config (google.cloud.ces_v1.types.OAuthConfig):
            Optional. Config for OAuth.

            This field is a member of `oneof`_ ``auth_config``.
        service_agent_id_token_auth_config (google.cloud.ces_v1.types.ServiceAgentIdTokenAuthConfig):
            Optional. Config for ID token auth generated
            from CES service agent.

            This field is a member of `oneof`_ ``auth_config``.
        service_account_auth_config (google.cloud.ces_v1.types.ServiceAccountAuthConfig):
            Optional. Config for service account
            authentication.

            This field is a member of `oneof`_ ``auth_config``.
        bearer_token_config (google.cloud.ces_v1.types.BearerTokenConfig):

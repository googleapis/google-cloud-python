...
from google.cloud.ces_v1.types import common, example
...
class Conversation(proto.Message):
    ...
    Attributes:
        ...
        end_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. Timestamp when the conversation
            was completed.
        turns (MutableSequence[google.cloud.ces_v1.types.Conversation.Turn]):
            Required. The turns in the conversation.
        turn_count (int):
            Output only. The number of turns in the
            conversation.
        channel_type (google.cloud.ces_v1.types.Conversation.ChannelType):
            DEPRECATED. Please use
            [input_types][google.cloud.ces.v1.Conversation.input_types]
            instead.
        source (google.cloud.ces_v1.types.Conversation.Source):
            Output only. Indicate the source of the
            conversation.
        input_types (MutableSequence[google.cloud.ces_v1.types.Conversation.InputType]):

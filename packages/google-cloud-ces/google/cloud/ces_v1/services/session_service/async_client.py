...
from google.cloud.ces_v1.types import session_service
...
class SessionServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.ces_v1.SessionServiceAsyncClient`.",
                extra={
    ...
    async def run_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.ces_v1.types.RunSessionRequest, dict]]):
        ...
        Returns:
            google.cloud.ces_v1.types.RunSessionResponse:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.run_session
        ]
    ...
    def stream_run_session(
        ...
        *,
        ...
        Returns:
            AsyncIterable[google.cloud.ces_v1.types.RunSessionResponse]:
                Response message for
                   [SessionService.RunSession][google.cloud.ces.v1.SessionService.RunSession].
    ...
    def bidi_run_session(
        self,
        requests: Optional[
            AsyncIterator[session_service.BidiSessionClientMessage]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        agent. The agent processes continuous multimodal inputs (e.g.,
        text, audio) and generates real-time multimodal output streams.

        --- Client Request Stream --- The client streams requests in the
        following order:

        1. Initialization: The first message must contain
        ...
        2. Interaction: Subsequent messages stream
           [SessionInput][google.cloud.ces.v1.BidiSessionClientMessage.realtime_input]
           containing real-time user input data.

        3. Termination: The client should half-close the stream when
           there is no more user input. It should also half-close upon
           receiving
           [EndSession][google.cloud.ces.v1.BidiSessionServerMessage.end_session]
           or
           [GoAway][google.cloud.ces.v1.BidiSessionServerMessage.go_away]
           from the agent.

        --- Server Response Stream --- For each interaction turn, the
        agent streams messages in the following sequence:

        1. Speech Recognition (First N messages): Contains
           [RecognitionResult][google.cloud.ces.v1.BidiSessionServerMessage.recognition_result]
           representing the concatenated user speech segments captured
           so far. This is only populated for audio sessions.

        2. Response (Next M messages): Contains
           [SessionOutput][google.cloud.ces.v1.BidiSessionServerMessage.session_output]
           delivering the agent's response in various modalities (e.g.,
           text, audio).

        3. Turn Completion (Final message of the turn): Contains
           [SessionOutput][google.cloud.ces.v1.BidiSessionServerMessage.session_output]
           with
           [turn_completed][google.cloud.ces.v1.SessionOutput.turn_completed]
           set to true. This signals the end of the current turn and
           includes
        ...
        1. Streaming: Stream [audio
           data][google.cloud.ces.v1.SessionInput.audio]
           **CONTINUOUSLY**, even during silence. Recommended chunk
           size: 40-120ms (balances latency vs. efficiency).

        2. Playback & Interruption: Play [audio
           responses][google.cloud.ces.v1.SessionOutput.audio] upon
        ...
        Args:
            requests (AsyncIterator[`google.cloud.ces_v1.types.BidiSessionClientMessage`]):
        ...
        Returns:
            AsyncIterable[google.cloud.ces_v1.types.BidiSessionServerMessage]:

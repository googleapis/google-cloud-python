...
class SessionServiceClient(metaclass=SessionServiceClientMeta):
    ...
    def session_path(
        ...
        return "projects/{project}/locations/{location}/apps/{app}/sessions/{session}".format(
            project=project,
            location=location,
            app=app,
            session=session,
    ...
    def parse_session_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/sessions/(?P<session>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.ces_v1.SessionServiceClient`.",
                    extra={
    ...
    def run_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.ces_v1.types.RunSessionRequest, dict]):
    ...
    def stream_run_session(
        ...
        *,
        ...
        Returns:
            Iterable[google.cloud.ces_v1.types.RunSessionResponse]:
                Response message for
                   [SessionService.RunSession][google.cloud.ces.v1.SessionService.RunSession].
    ...
    def bidi_run_session(
        ...
        *,
        ...
        Args:
            requests (Iterator[google.cloud.ces_v1.types.BidiSessionClientMessage]):
        ...
        Returns:
            Iterable[google.cloud.ces_v1.types.BidiSessionServerMessage]:

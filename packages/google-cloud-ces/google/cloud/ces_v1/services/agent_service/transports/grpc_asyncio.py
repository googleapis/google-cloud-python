...
class AgentServiceGrpcAsyncIOTransport(AgentServiceTransport):
    ...
    def list_apps(
        ...
        [agent_service.ListAppsRequest], Awaitable[agent_service.ListAppsResponse]
    ]:
    ...
    @property
    def get_app(self) -> Callable[[agent_service.GetAppRequest], Awaitable[app.App]]:
    ...
    def create_app(
        ...
        [agent_service.CreateAppRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_app(
        self,
    ) -> Callable[[agent_service.UpdateAppRequest], Awaitable[gcc_app.App]]:
    ...
    def delete_app(
        ...
        [agent_service.DeleteAppRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def export_app(
        ...
        [agent_service.ExportAppRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def import_app(
        ...
        [agent_service.ImportAppRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def list_agents(
        ...
        [agent_service.ListAgentsRequest], Awaitable[agent_service.ListAgentsResponse]
    ]:
    ...
    def get_agent(
        self,
    ) -> Callable[[agent_service.GetAgentRequest], Awaitable[agent.Agent]]:
    ...
    def create_agent(
        self,
    ) -> Callable[[agent_service.CreateAgentRequest], Awaitable[gcc_agent.Agent]]:
    ...
    def update_agent(
        self,
    ) -> Callable[[agent_service.UpdateAgentRequest], Awaitable[gcc_agent.Agent]]:
    ...
    def delete_agent(
        self,
    ) -> Callable[[agent_service.DeleteAgentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_example(
        self,
    ) -> Callable[[agent_service.GetExampleRequest], Awaitable[example.Example]]:
    ...
    def create_example(
        self,
    ) -> Callable[[agent_service.CreateExampleRequest], Awaitable[gcc_example.Example]]:
    ...
    def update_example(
        self,
    ) -> Callable[[agent_service.UpdateExampleRequest], Awaitable[gcc_example.Example]]:
    ...
    def delete_example(
        self,
    ) -> Callable[[agent_service.DeleteExampleRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def list_tools(
        ...
        [agent_service.ListToolsRequest], Awaitable[agent_service.ListToolsResponse]
    ]:
    ...
    def get_tool(
        self,
    ) -> Callable[[agent_service.GetToolRequest], Awaitable[tool.Tool]]:
    ...
    def get_conversation(
        ...
        [agent_service.GetConversationRequest], Awaitable[conversation.Conversation]
    ]:
    ...
    def delete_conversation(
        ...
        [agent_service.DeleteConversationRequest], Awaitable[empty_pb2.Empty]
    ]:
    ...
    def create_tool(
        self,
    ) -> Callable[[agent_service.CreateToolRequest], Awaitable[gcc_tool.Tool]]:
    ...
    def update_tool(
        self,
    ) -> Callable[[agent_service.UpdateToolRequest], Awaitable[gcc_tool.Tool]]:
    ...
    def delete_tool(
        self,
    ) -> Callable[[agent_service.DeleteToolRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_guardrail(
        self,
    ) -> Callable[[agent_service.GetGuardrailRequest], Awaitable[guardrail.Guardrail]]:
    ...
    def create_guardrail(
        ...
        [agent_service.CreateGuardrailRequest], Awaitable[gcc_guardrail.Guardrail]
    ]:
    ...
    def update_guardrail(
        ...
        [agent_service.UpdateGuardrailRequest], Awaitable[gcc_guardrail.Guardrail]
    ]:
    ...
    def delete_guardrail(
        self,
    ) -> Callable[[agent_service.DeleteGuardrailRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_deployment(
        ...
        [agent_service.GetDeploymentRequest], Awaitable[deployment.Deployment]
    ]:
    ...
    def create_deployment(
        ...
        [agent_service.CreateDeploymentRequest], Awaitable[gcc_deployment.Deployment]
    ]:
    ...
    def update_deployment(
        ...
        [agent_service.UpdateDeploymentRequest], Awaitable[gcc_deployment.Deployment]
    ]:
    ...
    def delete_deployment(
        self,
    ) -> Callable[[agent_service.DeleteDeploymentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_toolset(
        self,
    ) -> Callable[[agent_service.GetToolsetRequest], Awaitable[toolset.Toolset]]:
    ...
    def create_toolset(
        self,
    ) -> Callable[[agent_service.CreateToolsetRequest], Awaitable[gcc_toolset.Toolset]]:
    ...
    def update_toolset(
        self,
    ) -> Callable[[agent_service.UpdateToolsetRequest], Awaitable[gcc_toolset.Toolset]]:
    ...
    def delete_toolset(
        self,
    ) -> Callable[[agent_service.DeleteToolsetRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_app_version(
        ...
        [agent_service.GetAppVersionRequest], Awaitable[app_version.AppVersion]
    ]:
    ...
    def create_app_version(
        ...
        [agent_service.CreateAppVersionRequest], Awaitable[gcc_app_version.AppVersion]
    ]:
    ...
    def delete_app_version(
        self,
    ) -> Callable[[agent_service.DeleteAppVersionRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def restore_app_version(
        ...
        [agent_service.RestoreAppVersionRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def get_changelog(
        self,
    ) -> Callable[[agent_service.GetChangelogRequest], Awaitable[changelog.Changelog]]:
...
__all__ = ("AgentServiceGrpcAsyncIOTransport",)

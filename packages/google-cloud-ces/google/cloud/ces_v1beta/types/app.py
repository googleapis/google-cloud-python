...
class App(proto.Message):
    ...
    Attributes:
        ...
        language_settings (google.cloud.ces_v1beta.types.LanguageSettings):
            Optional. Language settings of the app.
        time_zone_settings (google.cloud.ces_v1beta.types.TimeZoneSettings):
            Optional. TimeZone settings of the app.
        audio_processing_config (google.cloud.ces_v1beta.types.AudioProcessingConfig):
            Optional. Audio processing configuration of
            the app.
        logging_settings (google.cloud.ces_v1beta.types.LoggingSettings):
            Optional. Logging settings of the app.
        error_handling_settings (google.cloud.ces_v1beta.types.ErrorHandlingSettings):
        ...
        model_settings (google.cloud.ces_v1beta.types.ModelSettings):
            ...
            needed.
        tool_execution_mode (google.cloud.ces_v1beta.types.App.ToolExecutionMode):
        ...
        evaluation_metrics_thresholds (google.cloud.ces_v1beta.types.EvaluationMetricsThresholds):
            ...
            app.
        variable_declarations (MutableSequence[google.cloud.ces_v1beta.types.App.VariableDeclaration]):
            Optional. The declarations of the variables.
        predefined_variable_declarations (MutableSequence[google.cloud.ces_v1beta.types.App.VariableDeclaration]):
        ...
        data_store_settings (google.cloud.ces_v1beta.types.DataStoreSettings):
            Optional. The data store settings for the
            app.
        default_channel_profile (google.cloud.ces_v1beta.types.ChannelProfile):
        ...
        evaluation_personas (MutableSequence[google.cloud.ces_v1beta.types.EvaluationPersona]):
            Optional. The evaluation personas for the
            app. This field is used to define the personas
            that can be used for evaluation. Maximum of 30
            personas can be defined.
    ...
    class VariableDeclaration(proto.Message):
        ...
        Attributes:
            ...
            schema (google.cloud.ces_v1beta.types.Schema):
    ...
    evaluation_personas: MutableSequence["EvaluationPersona"] = proto.RepeatedField(
        proto.MESSAGE,
        number=30,
        message="EvaluationPersona",
    )
    evaluation_settings: "EvaluationSettings" = proto.Field(
        proto.MESSAGE,
        number=33,
    ...
    Attributes:
        ...
        fallback_action (str):
            ...
            - A predefined system action, such as "escalate" or "exit",
              ...
              with corresponding
              [metadata][google.cloud.ces.v1beta.EndSession.metadata] to
...
class EvaluationMetricsThresholds(proto.Message):
    ...
    class GoldenEvaluationMetricsThresholds(proto.Message):
        ...
        Attributes:
            turn_level_metrics_thresholds (google.cloud.ces_v1beta.types.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds):
                Optional. The turn level metrics thresholds.
            expectation_level_metrics_thresholds (google.cloud.ces_v1beta.types.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.ExpectationLevelMetricsThresholds):
                Optional. The expectation level metrics
                thresholds.
            tool_matching_settings (google.cloud.ces_v1beta.types.EvaluationMetricsThresholds.ToolMatchingSettings):
        ...
        class TurnLevelMetricsThresholds(proto.Message):
            ...
            Attributes:
                ...
                semantic_similarity_channel (google.cloud.ces_v1beta.types.EvaluationMetricsThresholds.GoldenEvaluationMetricsThresholds.TurnLevelMetricsThresholds.SemanticSimilarityChannel):
    ...
    class ToolMatchingSettings(proto.Message):
        ...
        Attributes:
            extra_tool_call_behavior (google.cloud.ces_v1beta.types.EvaluationMetricsThresholds.ToolMatchingSettings.ExtraToolCallBehavior):
...
class EvaluationSettings(proto.Message):
    r"""Settings for evaluation.

    Attributes:
        scenario_conversation_initiator (google.cloud.ces_v1beta.types.EvaluationSettings.ScenarioConversationInitiator):
            Optional. Who starts the conversation in a
            scenario evaluation.
        golden_run_method (google.cloud.ces_v1beta.types.GoldenRunMethod):
            Optional. The default method used to run golden evaluations.
            This will be used if no golden_run_method is specified in
            the RunEvaluationRequest.
        golden_evaluation_tool_call_behaviour (google.cloud.ces_v1beta.types.EvaluationToolCallBehaviour):
            Optional. Configures the default tool call
            behaviour for golden evaluations.
    ...
    class ScenarioConversationInitiator(proto.Enum):
        r"""Determines who starts the conversation in a scenario
        evaluation session.
    ...
    golden_evaluation_tool_call_behaviour: fakes.EvaluationToolCallBehaviour = (
        proto.Field(
            proto.ENUM,
            number=2,
    ...
    scenario_evaluation_tool_call_behaviour: fakes.EvaluationToolCallBehaviour = (
        proto.Field(
            proto.ENUM,
            number=3,
            enum=fakes.EvaluationToolCallBehaviour,
...
class DataStoreSettings(proto.Message):
    ...
    Attributes:
        engines (MutableSequence[google.cloud.ces_v1beta.types.DataStoreSettings.Engine]):
...
class EvaluationPersona(proto.Message):
    r"""A persona represents an end user in an evaluation.
    ...
    Attributes:
        ...
        display_name (str):
            Required. The display name of the persona.
            Unique within an app.
        personality (str):
            Required. An instruction for the agent on how
            to behave in the evaluation.
        speech_config (google.cloud.ces_v1beta.types.EvaluationPersona.SpeechConfig):
            Optional. Configuration for how the persona
            sounds (TTS settings).
    """

    class SpeechConfig(proto.Message):
        r"""Configuration for Text-to-Speech generation.

        Attributes:
            speaking_rate (float):
                Optional. The speaking rate. 1.0 is normal.
                Lower is slower (e.g., 0.8), higher is faster
                (e.g., 1.5). Useful for testing how the agent
                handles fast talkers.
            environment (google.cloud.ces_v1beta.types.EvaluationPersona.SpeechConfig.BackgroundEnvironment):
                Optional. The simulated audio environment.
            voice_id (str):
                Optional. The specific voice
                identifier/accent to use. Example:
                "en-US-Wavenet-D" or "en-GB-Standard-A".
        """

        class BackgroundEnvironment(proto.Enum):
            r"""Simulated audio environment.
        ...
        environment: "EvaluationPersona.SpeechConfig.BackgroundEnvironment" = (
            proto.Field(
                proto.ENUM,
                number=2,

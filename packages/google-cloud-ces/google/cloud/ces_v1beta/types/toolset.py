...
from google.cloud.ces_v1beta.types import connector_toolset as gcc_connector_toolset
from google.cloud.ces_v1beta.types import mcp_toolset as gcc_mcp_toolset
from google.cloud.ces_v1beta.types import open_api_toolset as gcc_open_api_toolset
...
class Toolset(proto.Message):
    ...
    Attributes:
        mcp_toolset (google.cloud.ces_v1beta.types.McpToolset):
        ...
        open_api_toolset (google.cloud.ces_v1beta.types.OpenApiToolset):
            Optional. A toolset that contains a list of
            tools that are defined by an OpenAPI schema.

            This field is a member of `oneof`_ ``toolset_type``.
        connector_toolset (google.cloud.ces_v1beta.types.ConnectorToolset):

...
class _BaseSessionServiceRestTransport(SessionServiceTransport):
    ...
    class _BaseRunSession:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseSessionServiceRestTransport._BaseRunSession._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseStreamRunSession:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{config.session=projects/*/locations/*/apps/*/sessions/*}:streamRunSession",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseSessionServiceRestTransport._BaseStreamRunSession._get_unset_required_fields(
                    query_params
                )
            )

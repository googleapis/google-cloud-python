...
from google.cloud.ces_v1beta.services.session_service import (
    SessionServiceAsyncClient,
    SessionServiceClient,
    transports,
)
from google.cloud.ces_v1beta.types import example, session_service, toolset_tool
...
def test_session_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.ces_v1beta.services.session_service.transports.SessionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_run_session(request_type, transport: str = "grpc"):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.run_session), "__call__") as call:
        ...
        call.return_value = session_service.RunSessionResponse()
...
def test_run_session_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.run_session), "__call__") as call:
        ...
        client.run_session(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == session_service.RunSessionRequest()


def test_run_session_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.run_session in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.run_session] = mock_rpc
        request = {}
        client.run_session(request)
...
@pytest.mark.asyncio
async def test_run_session_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.run_session
        ...
        request = {}
        await client.run_session(request)
...
@pytest.mark.asyncio
async def test_run_session_async(
    ...
    with mock.patch.object(type(client.transport.run_session), "__call__") as call:
        ...
        response = await client.run_session(request)
...
@pytest.mark.asyncio
async def test_run_session_async_from_dict():
    await test_run_session_async(request_type=dict)


def test_run_session_field_headers():
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_run_session_field_headers_async():
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_bidi_run_session(request_type, transport: str = "grpc"):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.bidi_run_session), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([session_service.BidiSessionServerMessage()])
        response = client.bidi_run_session(iter(requests))
    ...
    for message in response:
        assert isinstance(message, session_service.BidiSessionServerMessage)


def test_bidi_run_session_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SessionServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.bidi_run_session in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.bidi_run_session] = (
            mock_rpc
        )
        request = [{}]
        client.bidi_run_session(request)
...
@pytest.mark.asyncio
async def test_bidi_run_session_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.bidi_run_session
            in client._client._transport._wrapped_methods
        )
        ...
        request = [{}]
        await client.bidi_run_session(request)
...
@pytest.mark.asyncio
async def test_bidi_run_session_async(
    transport: str = "grpc_asyncio",
    ...
    with mock.patch.object(type(client.transport.bidi_run_session), "__call__") as call:
        ...
        call.return_value.read = mock.AsyncMock(
            side_effect=[session_service.BidiSessionServerMessage()]
        )
        response = await client.bidi_run_session(iter(requests))
...
@pytest.mark.asyncio
async def test_bidi_run_session_async_from_dict():
    await test_bidi_run_session_async(request_type=dict)


def test_run_session_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SessionServiceClient(
...
def test_run_session_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).run_session._get_unset_required_fields(jsonified_request)
...
def test_run_session_rest_unset_required_fields():
    transport = transports.SessionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.run_session._get_unset_required_fields({})
...
def test_bidi_run_session_rest_no_http_options():
    ...
    with pytest.raises(RuntimeError):
        client.bidi_run_session(requests)


def test_bidi_run_session_rest_error():
    client = SessionServiceClient(
    ...
    assert "Method BidiRunSession is not available over REST transport" in str(
...
def test_run_session_empty_call_grpc():
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.run_session), "__call__") as call:
        call.return_value = session_service.RunSessionResponse()
        client.run_session(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_run_session_empty_call_grpc_asyncio():
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_run_session_rest_bad_request(request_type=session_service.RunSessionRequest):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_run_session_rest_call_success(request_type):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_run_session_rest_interceptors(null_interceptor):
    transport = transports.SessionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with mock.patch.object(
        ...
        transports.SessionServiceRestInterceptor, "post_run_session"
    ) as post, mock.patch.object(
        transports.SessionServiceRestInterceptor, "post_run_session_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SessionServiceRestInterceptor, "pre_run_session"
    ) as pre:
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_run_session_empty_call_rest():
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_session_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.ces_v1beta.services.session_service.transports.SessionServiceTransport.__init__"
    ) as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.ces_v1beta.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_agent_path():
    ...
    actual = SessionServiceClient.agent_path(project, location, app, agent)
...
def test_parse_agent_path():
    ...
    path = SessionServiceClient.agent_path(**expected)

    # Check that the path construction is reversible.
    actual = SessionServiceClient.parse_agent_path(path)
    assert expected == actual
...
def test_session_path():
    ...
    actual = SessionServiceClient.session_path(project, location, app, session)
    assert expected == actual
...
def test_tool_path():
    ...
    actual = SessionServiceClient.tool_path(project, location, app, tool)
    assert expected == actual
...
def test_parse_tool_path():
    ...
    path = SessionServiceClient.tool_path(**expected)

    # Check that the path construction is reversible.
    actual = SessionServiceClient.parse_tool_path(path)
    assert expected == actual
...
def test_toolset_path():
    ...
    actual = SessionServiceClient.toolset_path(project, location, app, toolset)
    assert expected == actual
...
def test_parse_toolset_path():
    ...
    path = SessionServiceClient.toolset_path(**expected)

    # Check that the path construction is reversible.
    actual = SessionServiceClient.parse_toolset_path(path)
    assert expected == actual

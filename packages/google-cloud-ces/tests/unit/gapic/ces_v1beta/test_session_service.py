...
async def test_run_session_async(request_type, transport: str = "grpc_asyncio"):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_stream_run_session_async(request_type, transport: str = "grpc_asyncio"):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_bidi_run_session_async(request_type, transport: str = "grpc_asyncio"):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_run_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRunSession,
        "_BaseRunSession__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_stream_run_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseStreamRunSession,
        "_BaseStreamRunSession__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
from google.cloud.ces_v1.services.session_service import (
    SessionServiceAsyncClient,
    SessionServiceClient,
    transports,
)
from google.cloud.ces_v1.types import example, session_service, toolset_tool
...
def test_session_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.ces_v1.services.session_service.transports.SessionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_session_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.ces_v1.services.session_service.transports.SessionServiceTransport.__init__"
    ) as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.ces_v1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

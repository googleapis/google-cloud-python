...
class PublicCertificateAuthorityServiceClient(
    ...
    @staticmethod
    def external_account_key_path(
        project: str,
        location: str,
        external_account_key: str,
    ) -> str:
        """Returns a fully-qualified external_account_key string."""
        return "projects/{project}/locations/{location}/externalAccountKeys/{external_account_key}".format(
            project=project,
            location=location,
    ...
    def parse_external_account_key_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/externalAccountKeys/(?P<external_account_key>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                PublicCertificateAuthorityServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = PublicCertificateAuthorityServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _compare_universes(
        ...
        default_universe = PublicCertificateAuthorityServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or PublicCertificateAuthorityServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        ) = PublicCertificateAuthorityServiceClient._read_environment_variables()
        self._client_cert_source = (
            PublicCertificateAuthorityServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            PublicCertificateAuthorityServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, PublicCertificateAuthorityServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                PublicCertificateAuthorityServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or PublicCertificateAuthorityServiceClient._get_api_endpoint(
    ...
    def create_external_account_key(
        ...
        *,
        ...
        has_flattened_params = any([parent, external_account_key])
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_external_account_key
        ]
...
__all__ = ("PublicCertificateAuthorityServiceClient",)

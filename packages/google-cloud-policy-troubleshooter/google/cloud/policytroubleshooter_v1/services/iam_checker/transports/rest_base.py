...
from .base import DEFAULT_CLIENT_INFO, IamCheckerTransport


class _BaseIamCheckerRestTransport(IamCheckerTransport):
    """Base REST backend transport for IamChecker.
...
__all__ = ("_BaseIamCheckerRestTransport",)

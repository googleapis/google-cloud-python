...
class IamCheckerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_troubleshoot_iam_policy(
        ...
        checker.TroubleshootIamPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_troubleshoot_iam_policy_with_metadata(
        self,
        response: checker.TroubleshootIamPolicyResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        checker.TroubleshootIamPolicyResponse, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for troubleshoot_iam_policy
...
class IamCheckerRestTransport(_BaseIamCheckerRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[IamCheckerRestInterceptor]): Interceptor used
    ...
    class _TroubleshootIamPolicy(
        _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy, IamCheckerRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_query_params_json(
                transcoded_request
            )

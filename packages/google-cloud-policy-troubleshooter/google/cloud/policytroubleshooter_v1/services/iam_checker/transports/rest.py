...
from .rest_base import _BaseIamCheckerRestTransport
...
class IamCheckerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_troubleshoot_iam_policy(
        self, request: checker.TroubleshootIamPolicyRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[checker.TroubleshootIamPolicyRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_troubleshoot_iam_policy_with_metadata(
        self, response: checker.TroubleshootIamPolicyResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[checker.TroubleshootIamPolicyResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for troubleshoot_iam_policy

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the IamChecker server but before it is returned to user code.
...
class IamCheckerRestTransport(_BaseIamCheckerRestTransport):
    """REST backend synchronous transport for IamChecker.
    ...
    class _TroubleshootIamPolicy(_BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy, IamCheckerRestStub):
        def __hash__(self):
            return hash("IamCheckerRestTransport.TroubleshootIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_troubleshoot_iam_policy(request, metadata)
            transcoded_request = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseIamCheckerRestTransport._BaseTroubleshootIamPolicy._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.policytroubleshooter_v1.IamCheckerClient.TroubleshootIamPolicy",
                    extra={
            ...
            # Send the request
            response = IamCheckerRestTransport._TroubleshootIamPolicy._get_response(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = checker.TroubleshootIamPolicyResponse.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.policytroubleshooter_v1.IamCheckerClient.troubleshoot_iam_policy",
                    extra={
                        "serviceName": "google.cloud.policytroubleshooter.v1.IamChecker",
                        "rpcName": "TroubleshootIamPolicy",

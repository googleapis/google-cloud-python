...
def test__get_default_mtls_endpoint():
    ...
    assert (
        IamCheckerClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        IamCheckerClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        IamCheckerClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        IamCheckerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert IamCheckerClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert (
        IamCheckerClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        IamCheckerClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        IamCheckerClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                IamCheckerClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                IamCheckerClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(IamCheckerClient),
)
@mock.patch.object(
    IamCheckerAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(IamCheckerAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = IamCheckerClient._DEFAULT_UNIVERSE
    default_endpoint = IamCheckerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = IamCheckerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        IamCheckerClient._get_api_endpoint(
    ...
    assert (
        ...
        == IamCheckerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        IamCheckerClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        IamCheckerClient._get_api_endpoint(None, None, default_universe, "always")
        == IamCheckerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        IamCheckerClient._get_api_endpoint(
    ...
    assert (
        IamCheckerClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        IamCheckerClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        IamCheckerClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        IamCheckerClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        IamCheckerClient._get_universe_domain(None, None)
        == IamCheckerClient._DEFAULT_UNIVERSE
    )
...
def test_iam_checker_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_iam_checker_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_iam_checker_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.policytroubleshooter_v1.services.iam_checker.transports.IamCheckerGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_iam_checker_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_troubleshoot_iam_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.troubleshoot_iam_policy
...
async def test_troubleshoot_iam_policy_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.troubleshoot_iam_policy
...
def test_transport_kind_grpc_asyncio():
    transport = IamCheckerAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = IamCheckerClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_troubleshoot_iam_policy_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.IamCheckerRestInterceptor,
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = checker.TroubleshootIamPolicyResponse.to_json(
            checker.TroubleshootIamPolicyResponse()
        )
...
def test_iam_checker_base_transport():
    ...
    with mock.patch(
        "google.cloud.policytroubleshooter_v1.services.iam_checker.transports.IamCheckerTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [
        (transports.IamCheckerGrpcTransport, grpc_helpers),
        (transports.IamCheckerGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_iam_checker_host_no_port(transport_name):
    client = IamCheckerClient(
        ...
        client_options=client_options.ClientOptions(
            api_endpoint="policytroubleshooter.googleapis.com"
        ),
...
def test_iam_checker_host_with_port(transport_name):
    client = IamCheckerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
            api_endpoint="policytroubleshooter.googleapis.com:8000"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (

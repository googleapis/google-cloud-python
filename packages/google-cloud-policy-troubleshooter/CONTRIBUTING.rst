...
instead of
``https://github.com/googleapis/python-policy-troubleshooter/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-policy-troubleshooter/blob/main/noxfile.py

...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.maps.routing_v2")  # type: ignore
    api_core.check_dependency_versions("google.maps.routing_v2")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.routing_v2"

...
class RoutesTransport(abc.ABC):
    ...
    def compute_routes(
        ...
        [routes_service.ComputeRoutesRequest], Union[routes_service.ComputeRoutesResponse, Awaitable[routes_service.ComputeRoutesResponse]]
    ]:
        raise NotImplementedError()
    ...
    def compute_route_matrix(
        self,
    ) -> Callable[[routes_service.ComputeRouteMatrixRequest], Union[routes_service.RouteMatrixElement, Awaitable[routes_service.RouteMatrixElement]]]:
        raise NotImplementedError()

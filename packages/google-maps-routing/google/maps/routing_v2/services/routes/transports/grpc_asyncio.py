...
class RoutesGrpcAsyncIOTransport(RoutesTransport):
    ...
    @property
    def compute_routes(self) -> Callable[[routes_service.ComputeRoutesRequest], Awaitable[routes_service.ComputeRoutesResponse]]:
    ...
    @property
    def compute_route_matrix(self) -> Callable[[routes_service.ComputeRouteMatrixRequest], Awaitable[routes_service.RouteMatrixElement]]:

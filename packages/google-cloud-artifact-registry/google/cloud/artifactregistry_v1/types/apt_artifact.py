...
class ImportAptArtifactsResponse(proto.Message):
    ...
    Attributes:
        apt_artifacts (Sequence[google.cloud.artifactregistry_v1.types.AptArtifact]):
            The Apt artifacts imported.
        errors (Sequence[google.cloud.artifactregistry_v1.types.ImportAptArtifactsErrorInfo]):

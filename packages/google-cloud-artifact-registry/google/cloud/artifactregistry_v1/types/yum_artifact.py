...
class ImportYumArtifactsResponse(proto.Message):
    ...
    Attributes:
        yum_artifacts (Sequence[google.cloud.artifactregistry_v1.types.YumArtifact]):
            The yum artifacts imported.
        errors (Sequence[google.cloud.artifactregistry_v1.types.ImportYumArtifactsErrorInfo]):

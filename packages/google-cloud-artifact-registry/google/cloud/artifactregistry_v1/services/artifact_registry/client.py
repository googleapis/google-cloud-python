...
class ArtifactRegistryClient(metaclass=ArtifactRegistryClientMeta):
    ...
    def parse_apt_artifact_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/aptArtifacts/(?P<apt_artifact>.+?)$", path
        )
    ...
    def attachment_path(
        ...
        return "projects/{project}/locations/{location}/repositories/{repository}/attachments/{attachment}".format(
            project=project,
            location=location,
            repository=repository,
    ...
    def parse_attachment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/attachments/(?P<attachment>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_docker_image_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/dockerImages/(?P<docker_image>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_maven_artifact_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/mavenArtifacts/(?P<maven_artifact>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_npm_package_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/npmPackages/(?P<npm_package>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_python_package_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/pythonPackages/(?P<python_package>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def rule_path(
        ...
        return "projects/{project}/locations/{location}/repositories/{repository}/rules/{rule}".format(
            project=project,
            location=location,
            repository=repository,
            rule=rule,
    ...
    def parse_yum_artifact_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/yumArtifacts/(?P<yum_artifact>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ArtifactRegistryClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or ArtifactRegistryClient._get_api_endpoint(

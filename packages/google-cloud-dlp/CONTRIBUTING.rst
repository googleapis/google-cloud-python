...
instead of
``https://github.com/googleapis/python-dlp/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-dlp/blob/main/packages/google-cloud-dlp/noxfile.py

...
- While logged into your GitHub account, navigate to the
  ``python-datastream`` `repo`_ on GitHub.

- Fork and clone the ``python-datastream`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-datastream`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-datastream``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-datastream.git hack-on-python-datastream
   $ cd hack-on-python-datastream
...
.. _repo: https://github.com/googleapis/python-datastream

...
from google.cloud.datastream_v1alpha1.services.datastream import DatastreamAsyncClient, DatastreamClient, pagers, transports
...
def test_update_connection_profile_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha1/{connection_profile.name=projects/*/locations/*/connectionProfiles/*}" % client.transport._host, args[1]
        )
...
def test_create_connection_profile_rest_call_success(request_type):
    ...
    request_init["connection_profile"] = {
        ...
        "gcs_profile": {"bucket_name": "bucket_name_value", "root_path": "root_path_value"},
        "mysql_profile": {
            "hostname": "hostname_value",
            "port": 453,
            "username": "username_value",
        ...
        "private_connectivity": {"private_connection_name": "private_connection_name_value"},
    }

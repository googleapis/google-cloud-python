...
async def test_run_stream_async(request_type, transport: str = "grpc_asyncio"):
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_stream_object_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = datastream.GetStreamObjectRequest(
            name="name_value",
        )
        assert args[0] == request_msg


def test_get_stream_object_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_stream_object in client._transport._wrapped_methods
...
async def test_get_stream_object_async(request_type, transport: str = "grpc_asyncio"):
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_lookup_stream_object_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = datastream.LookupStreamObjectRequest(
            parent="parent_value",
        )
        assert args[0] == request_msg


def test_lookup_stream_object_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
def test_list_stream_objects_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
async def test_list_stream_objects_async(request_type, transport: str = "grpc_asyncio"):
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_start_backfill_job_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = datastream.StartBackfillJobRequest(
            object_="object__value",
        )
        assert args[0] == request_msg


def test_start_backfill_job_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
async def test_start_backfill_job_async(request_type, transport: str = "grpc_asyncio"):
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_stop_backfill_job_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = datastream.StopBackfillJobRequest(
            object_="object__value",
        )
        assert args[0] == request_msg


def test_stop_backfill_job_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
        ...
        # Ensure method has been cached
        assert client._transport.stop_backfill_job in client._transport._wrapped_methods
...
async def test_stop_backfill_job_async(request_type, transport: str = "grpc_asyncio"):
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_run_stream_rest_required_fields(request_type=datastream.RunStreamRequest):
    ...
    default_values = getattr(
        transport_class._BaseRunStream,
...
def test_get_stream_object_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetStreamObject,
...
def test_lookup_stream_object_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
def test_lookup_stream_object_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseLookupStreamObject,
...
def test_list_stream_objects_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
def test_list_stream_objects_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListStreamObjects,
...
def test_start_backfill_job_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
def test_start_backfill_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseStartBackfillJob,
...
def test_stop_backfill_job_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DatastreamClient(
...
def test_stop_backfill_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseStopBackfillJob,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lookup_stream_object_empty_call_grpc():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_stream_objects_empty_call_grpc():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_start_backfill_job_empty_call_grpc():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_backfill_job_empty_call_grpc():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_stream_object_empty_call_grpc_asyncio():
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_stream_object(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_lookup_stream_object_empty_call_grpc_asyncio():
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.lookup_stream_object(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_stream_objects_empty_call_grpc_asyncio():
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_stream_objects(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_start_backfill_job_empty_call_grpc_asyncio():
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_stop_backfill_job_empty_call_grpc_asyncio():
    client = DatastreamAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_create_connection_profile_rest_call_success(request_type):
    ...
    request_init["connection_profile"] = {
        ...
        "private_connectivity": {"private_connection": "private_connection_value"},
    }
    ...
    request_init["stream"] = {
        ...
        "destination_config": {
            ...
            "bigquery_destination_config": {
                "single_target_dataset": {"dataset_id": "dataset_id_value"},
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lookup_stream_object_empty_call_rest():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_stream_objects_empty_call_rest():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_start_backfill_job_empty_call_rest():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_backfill_job_empty_call_rest():
    client = DatastreamClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
async def test_get_location_field_headers_async():
    client = DatastreamAsyncClient(credentials=async_anonymous_credentials())

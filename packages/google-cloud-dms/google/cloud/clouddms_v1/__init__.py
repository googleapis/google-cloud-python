...
__lazy_modules__ = {
    "google.cloud.clouddms_v1.services.data_migration_service",
    "google.cloud.clouddms_v1.types.clouddms",
    "google.cloud.clouddms_v1.types.clouddms_resources",
    "google.cloud.clouddms_v1.types.conversionworkspace_resources",
}

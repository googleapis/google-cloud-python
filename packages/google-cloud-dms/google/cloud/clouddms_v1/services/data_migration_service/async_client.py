...
class DataMigrationServiceAsyncClient:
    ...
    parse_mapping_rule_path = staticmethod(
        DataMigrationServiceClient.parse_mapping_rule_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            DataMigrationServiceClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            DataMigrationServiceClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    async def generate_tcp_proxy_script(
        self,

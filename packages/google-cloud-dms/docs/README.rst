Python Client for Database Migration
====================================

|stable| |pypi| |versions|

`Database Migration`_: makes it easier for you to migrate your data to Google Cloud. This service helps you lift and shift your MySQL and PostgreSQL workloads into Cloud SQL.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-dms.svg
   :target: https://pypi.org/project/google-cloud-dms/
.. _Database Migration: https://cloud.google.com/database-migration/
...
3. `Enable the Database Migration.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Database Migration.:  https://cloud.google.com/database-migration/
...
-  Read the `Client Library Documentation`_ for Database Migration
   to see other available methods on the client.
-  Read the `Database Migration Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Database Migration Product documentation:  https://cloud.google.com/database-migration/

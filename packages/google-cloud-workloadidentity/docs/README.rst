Python Client for Workload Identity
===================================
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-workloadidentity.svg
   :target: https://pypi.org/project/google-cloud-workloadidentity/
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-workloadidentity.svg
   :target: https://pypi.org/project/google-cloud-workloadidentity/
.. _Workload Identity: https://cloud.google.com/iam/
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-workloadidentity/latest/summary_overview
...
3. `Enable the Workload Identity.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Workload Identity.:  https://cloud.google.com/iam/
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-workloadidentity/samples
...
.. code-block:: console
    ...
    pip install google-cloud-workloadidentity
...
-  Read the `Client Library Documentation`_ for Workload Identity
   to see other available methods on the client.
-  Read the `Workload Identity Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Workload Identity Product documentation:  https://cloud.google.com/iam/

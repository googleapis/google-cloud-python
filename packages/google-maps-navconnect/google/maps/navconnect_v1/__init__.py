...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.maps.navconnect_v1")  # type: ignore
    api_core.check_dependency_versions("google.maps.navconnect_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.navconnect_v1"

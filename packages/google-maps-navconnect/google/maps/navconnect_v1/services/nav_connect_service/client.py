...
from .transports.grpc import NavConnectServiceGrpcTransport
from .transports.grpc_asyncio import NavConnectServiceGrpcAsyncIOTransport
from .transports.rest import NavConnectServiceRestTransport


class NavConnectServiceClientMeta(type):
    """Metaclass for the NavConnectService client.
    ...
    ) -> Type[NavConnectServiceTransport]:
...
class NavConnectServiceClient(metaclass=NavConnectServiceClientMeta):
    ...
    DEFAULT_ENDPOINT = "navigationconnect.googleapis.com"
    DEFAULT_MTLS_ENDPOINT = _get_default_mtls_endpoint.__func__(  # type: ignore
        DEFAULT_ENDPOINT
    )

    _DEFAULT_ENDPOINT_TEMPLATE = "navigationconnect.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NavConnectServiceClient: The constructed client.
        """
    ...
    def transport(self) -> NavConnectServiceTransport:
        ...
        Returns:
            NavConnectServiceTransport: The transport used by the client
                instance.
        """
    ...
    def trip_path(
        ...
        return "projects/{project}/trips/{trip}".format(
            project=project,
            trip=trip,
        )
    ...
    def parse_trip_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/trips/(?P<trip>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = NavConnectServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = NavConnectServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NavConnectServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = NavConnectServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the nav connect service client.
        ...
        self._client_cert_source = NavConnectServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = NavConnectServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, NavConnectServiceTransport)
        if transport_provided:
            # transport is a NavConnectServiceTransport instance.
            ...
            self._transport = cast(NavConnectServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or NavConnectServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                NavConnectServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., NavConnectServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.maps.navconnect_v1.NavConnectServiceClient`.",
                    extra={
    ...
    def create_trip(
        ...
        *,
        ...
        Args:
            request (Union[google.maps.navconnect_v1.types.CreateTripRequest, dict]):
    ...
    def get_trip(
        ...
        *,
        ...
        Args:
            request (Union[google.maps.navconnect_v1.types.GetTripRequest, dict]):
                The request object. Request message for
    ...
    def __enter__(self) -> "NavConnectServiceClient":
        return self
...
__all__ = ("NavConnectServiceClient",)

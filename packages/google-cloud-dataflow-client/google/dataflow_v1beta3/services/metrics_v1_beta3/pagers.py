...
class GetJobExecutionDetailsPager:
    ...
    :class:`google.dataflow_v1beta3.types.JobExecutionDetails` object, and
    ...
    All the usual :class:`google.dataflow_v1beta3.types.JobExecutionDetails`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.dataflow_v1beta3.types.GetJobExecutionDetailsRequest):
                The initial request object.
            response (google.dataflow_v1beta3.types.JobExecutionDetails):
...
class GetStageExecutionDetailsPager:
    ...
    This class thinly wraps an initial
    :class:`google.dataflow_v1beta3.types.StageExecutionDetails` object, and
    provides an ``__iter__`` method to iterate through its
    ``workers`` field.
    ...
    All the usual :class:`google.dataflow_v1beta3.types.StageExecutionDetails`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.dataflow_v1beta3.types.GetStageExecutionDetailsRequest):
                The initial request object.
            response (google.dataflow_v1beta3.types.StageExecutionDetails):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """

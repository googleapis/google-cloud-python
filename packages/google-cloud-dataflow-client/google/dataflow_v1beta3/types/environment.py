...
class Environment(proto.Message):
    ...
    Attributes:
        ...
        worker_pools (Sequence[google.dataflow_v1beta3.types.WorkerPool]):
        ...
        flex_resource_scheduling_goal (google.dataflow_v1beta3.types.FlexResourceSchedulingGoal):
        ...
        worker_zone (str):
            ...
            capacity.
        shuffle_mode (google.dataflow_v1beta3.types.ShuffleMode):
            Output only. The shuffle mode used for the
            job.
        debug_options (google.dataflow_v1beta3.types.DebugOptions):
...
class TaskRunnerSettings(proto.Message):
    ...
    Attributes:
        ...
        parallel_worker_settings (google.dataflow_v1beta3.types.WorkerSettings):
...
class AutoscalingSettings(proto.Message):
    ...
    Attributes:
        algorithm (google.dataflow_v1beta3.types.AutoscalingAlgorithm):
...
class WorkerPool(proto.Message):
    ...
    Attributes:
        ...
        packages (Sequence[google.dataflow_v1beta3.types.Package]):
            Packages to be installed on workers.
        default_package_set (google.dataflow_v1beta3.types.DefaultPackageSet):
        ...
        teardown_policy (google.dataflow_v1beta3.types.TeardownPolicy):
        ...
        zone (str):
            ...
            unspecified, the service will attempt to choose
            a reasonable default.
        taskrunner_settings (google.dataflow_v1beta3.types.TaskRunnerSettings):
        ...
        data_disks (Sequence[google.dataflow_v1beta3.types.Disk]):
            Data disks that are used by a VM in this
            workflow.
        metadata (Sequence[google.dataflow_v1beta3.types.WorkerPool.MetadataEntry]):
            Metadata to set on the Google Compute Engine
            VMs.
        autoscaling_settings (google.dataflow_v1beta3.types.AutoscalingSettings):
        ...
        sdk_harness_container_images (Sequence[google.dataflow_v1beta3.types.SdkHarnessContainerImage]):

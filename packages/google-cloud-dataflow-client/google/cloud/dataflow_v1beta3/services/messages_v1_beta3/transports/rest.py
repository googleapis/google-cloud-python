...
class MessagesV1Beta3RestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_list_job_messages(
        self, request: messages.ListJobMessagesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[messages.ListJobMessagesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_job_messages(self, response: messages.ListJobMessagesResponse) -> messages.ListJobMessagesResponse:
    ...
    def post_list_job_messages_with_metadata(
        self, response: messages.ListJobMessagesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[messages.ListJobMessagesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_job_messages
...
class MessagesV1Beta3RestTransport(_BaseMessagesV1Beta3RestTransport):
    ...
    class _ListJobMessages(_BaseMessagesV1Beta3RestTransport._BaseListJobMessages, MessagesV1Beta3RestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_list_job_messages(request, metadata)
            transcoded_request = _BaseMessagesV1Beta3RestTransport._BaseListJobMessages._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseMessagesV1Beta3RestTransport._BaseListJobMessages._get_query_params_json(transcoded_request)
            ...
            resp, _ = self._interceptor.post_list_job_messages_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = messages.ListJobMessagesResponse.to_json(response)
                except:
    ...
    @property
    def list_job_messages(self) -> Callable[[messages.ListJobMessagesRequest], messages.ListJobMessagesResponse]:

...
class TemplatesServiceGrpcAsyncIOTransport(TemplatesServiceTransport):
    ...
    @property
    def create_job_from_template(self) -> Callable[[templates.CreateJobFromTemplateRequest], Awaitable[jobs.Job]]:
    ...
    @property
    def launch_template(self) -> Callable[[templates.LaunchTemplateRequest], Awaitable[templates.LaunchTemplateResponse]]:
    ...
    @property
    def get_template(self) -> Callable[[templates.GetTemplateRequest], Awaitable[templates.GetTemplateResponse]]:

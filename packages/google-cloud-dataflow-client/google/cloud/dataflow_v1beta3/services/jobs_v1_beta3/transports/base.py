...
class JobsV1Beta3Transport(abc.ABC):
    ...
    @property
    def create_job(self) -> Callable[[jobs.CreateJobRequest], Union[jobs.Job, Awaitable[jobs.Job]]]:
        raise NotImplementedError()
    ...
    @property
    def aggregated_list_jobs(self) -> Callable[[jobs.ListJobsRequest], Union[jobs.ListJobsResponse, Awaitable[jobs.ListJobsResponse]]]:
        raise NotImplementedError()

    @property
    def check_active_jobs(
        self,
    ) -> Callable[[jobs.CheckActiveJobsRequest], Union[jobs.CheckActiveJobsResponse, Awaitable[jobs.CheckActiveJobsResponse]]]:
        raise NotImplementedError()

    @property
    def snapshot_job(self) -> Callable[[jobs.SnapshotJobRequest], Union[snapshots.Snapshot, Awaitable[snapshots.Snapshot]]]:
        raise NotImplementedError()

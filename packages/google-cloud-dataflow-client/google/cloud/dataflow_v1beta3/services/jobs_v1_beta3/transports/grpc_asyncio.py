...
class JobsV1Beta3GrpcAsyncIOTransport(JobsV1Beta3Transport):
    ...
    @property
    def aggregated_list_jobs(self) -> Callable[[jobs.ListJobsRequest], Awaitable[jobs.ListJobsResponse]]:
    ...
    @property
    def check_active_jobs(self) -> Callable[[jobs.CheckActiveJobsRequest], Awaitable[jobs.CheckActiveJobsResponse]]:
    ...
    @property
    def snapshot_job(self) -> Callable[[jobs.SnapshotJobRequest], Awaitable[snapshots.Snapshot]]:

...
class MetricsV1Beta3GrpcAsyncIOTransport(MetricsV1Beta3Transport):
    ...
    @property
    def get_job_metrics(self) -> Callable[[metrics.GetJobMetricsRequest], Awaitable[metrics.JobMetrics]]:
    ...
    @property
    def get_job_execution_details(self) -> Callable[[metrics.GetJobExecutionDetailsRequest], Awaitable[metrics.JobExecutionDetails]]:
    ...
    @property
    def get_stage_execution_details(self) -> Callable[[metrics.GetStageExecutionDetailsRequest], Awaitable[metrics.StageExecutionDetails]]:

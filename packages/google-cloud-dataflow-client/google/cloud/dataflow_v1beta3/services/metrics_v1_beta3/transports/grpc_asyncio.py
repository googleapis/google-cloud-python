...
class MetricsV1Beta3GrpcAsyncIOTransport(MetricsV1Beta3Transport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_job_metrics: gapic_v1.method_async.wrap_method(
                self.get_job_metrics,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_job_execution_details: gapic_v1.method_async.wrap_method(
                self.get_job_execution_details,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_stage_execution_details: gapic_v1.method_async.wrap_method(

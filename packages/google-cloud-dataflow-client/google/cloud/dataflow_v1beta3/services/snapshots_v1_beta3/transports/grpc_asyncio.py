...
class SnapshotsV1Beta3GrpcAsyncIOTransport(SnapshotsV1Beta3Transport):
    ...
    @property
    def get_snapshot(self) -> Callable[[snapshots.GetSnapshotRequest], Awaitable[snapshots.Snapshot]]:
    ...
    @property
    def delete_snapshot(self) -> Callable[[snapshots.DeleteSnapshotRequest], Awaitable[snapshots.DeleteSnapshotResponse]]:
    ...
    @property
    def list_snapshots(self) -> Callable[[snapshots.ListSnapshotsRequest], Awaitable[snapshots.ListSnapshotsResponse]]:

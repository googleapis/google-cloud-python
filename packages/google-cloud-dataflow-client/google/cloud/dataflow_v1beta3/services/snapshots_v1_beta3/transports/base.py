...
class SnapshotsV1Beta3Transport(abc.ABC):
    ...
    @property
    def get_snapshot(self) -> Callable[[snapshots.GetSnapshotRequest], Union[snapshots.Snapshot, Awaitable[snapshots.Snapshot]]]:
        raise NotImplementedError()

    @property
    def delete_snapshot(
        self,
    ) -> Callable[[snapshots.DeleteSnapshotRequest], Union[snapshots.DeleteSnapshotResponse, Awaitable[snapshots.DeleteSnapshotResponse]]]:
        raise NotImplementedError()

    @property
    def list_snapshots(
        self,
    ) -> Callable[[snapshots.ListSnapshotsRequest], Union[snapshots.ListSnapshotsResponse, Awaitable[snapshots.ListSnapshotsResponse]]]:
        raise NotImplementedError()

...
def test__get_client_cert_source():
    ...
    assert (
        SnapshotsV1Beta3Client._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SnapshotsV1Beta3Client._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SnapshotsV1Beta3Client._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                SnapshotsV1Beta3Client._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SnapshotsV1Beta3Client),
)
@mock.patch.object(
    SnapshotsV1Beta3AsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SnapshotsV1Beta3AsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SnapshotsV1Beta3Client._DEFAULT_UNIVERSE
    default_endpoint = SnapshotsV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SnapshotsV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SnapshotsV1Beta3Client._get_api_endpoint(
    ...
    assert (
        SnapshotsV1Beta3Client._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SnapshotsV1Beta3Client._get_api_endpoint(None, None, default_universe, "always")
        == SnapshotsV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SnapshotsV1Beta3Client._get_api_endpoint(
    ...
    assert (
        SnapshotsV1Beta3Client._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SnapshotsV1Beta3Client._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SnapshotsV1Beta3Client._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SnapshotsV1Beta3Client._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SnapshotsV1Beta3Client._get_universe_domain(None, None)
        == SnapshotsV1Beta3Client._DEFAULT_UNIVERSE
    )
...
def test_transport_kind_grpc_asyncio():
    transport = SnapshotsV1Beta3AsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = SnapshotsV1Beta3Client.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    transport = transports.SnapshotsV1Beta3RestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.SnapshotsV1Beta3RestInterceptor(),
    )
    client = SnapshotsV1Beta3Client(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.SnapshotsV1Beta3RestInterceptor, "post_get_snapshot"
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.SnapshotsV1Beta3RestInterceptor, "post_delete_snapshot"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = snapshots.DeleteSnapshotRequest.pb(
            snapshots.DeleteSnapshotRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = snapshots.DeleteSnapshotResponse.to_json(
            snapshots.DeleteSnapshotResponse()
        )
        req.return_value.content = return_value
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.SnapshotsV1Beta3RestInterceptor, "post_list_snapshots"
    ) as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = snapshots.ListSnapshotsResponse.to_json(
            snapshots.ListSnapshotsResponse()
        )
        req.return_value.content = return_value

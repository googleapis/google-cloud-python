...
def test__get_default_mtls_endpoint():
    ...
    assert (
        MetricsV1Beta3Client._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert MetricsV1Beta3Client._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert MetricsV1Beta3Client._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert MetricsV1Beta3Client._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                MetricsV1Beta3Client._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        MetricsV1Beta3Client._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        MetricsV1Beta3Client._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                MetricsV1Beta3Client._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                MetricsV1Beta3Client._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(MetricsV1Beta3Client),
)
@mock.patch.object(
    MetricsV1Beta3AsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(MetricsV1Beta3AsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MetricsV1Beta3Client._DEFAULT_UNIVERSE
    default_endpoint = MetricsV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = MetricsV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == MetricsV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        MetricsV1Beta3Client._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        MetricsV1Beta3Client._get_api_endpoint(None, None, default_universe, "always")
        == MetricsV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        MetricsV1Beta3Client._get_api_endpoint(
    ...
    assert (
        MetricsV1Beta3Client._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        MetricsV1Beta3Client._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        MetricsV1Beta3Client._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        MetricsV1Beta3Client._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        MetricsV1Beta3Client._get_universe_domain(None, None)
        == MetricsV1Beta3Client._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_get_job_metrics_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_job_metrics
...
def test_get_job_execution_details_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_job_execution_details
...
@pytest.mark.asyncio
async def test_get_job_execution_details_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_job_execution_details
            in client._client._transport._wrapped_methods
        )
...
def test_get_job_execution_details_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.get_job_execution_details(
...
def test_get_stage_execution_details_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_stage_execution_details
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_stage_execution_details_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_stage_execution_details
            in client._client._transport._wrapped_methods
        )
...
def test_get_stage_execution_details_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.get_stage_execution_details(
            request={}, retry=retry, timeout=timeout
        )
...
def test_get_job_execution_details_rest_bad_request(
    request_type=metrics.GetJobExecutionDetailsRequest,
):
    client = MetricsV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )

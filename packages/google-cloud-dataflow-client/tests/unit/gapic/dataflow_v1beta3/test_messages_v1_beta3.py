...
def test__get_default_mtls_endpoint():
    ...
    assert (
        MessagesV1Beta3Client._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        MessagesV1Beta3Client._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        MessagesV1Beta3Client._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                MessagesV1Beta3Client._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                MessagesV1Beta3Client._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(MessagesV1Beta3Client),
)
@mock.patch.object(
    MessagesV1Beta3AsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(MessagesV1Beta3AsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MessagesV1Beta3Client._DEFAULT_UNIVERSE
    default_endpoint = MessagesV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = MessagesV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        MessagesV1Beta3Client._get_api_endpoint(
    ...
    assert (
        MessagesV1Beta3Client._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        MessagesV1Beta3Client._get_api_endpoint(None, None, default_universe, "always")
        == MessagesV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        MessagesV1Beta3Client._get_api_endpoint(
    ...
    assert (
        MessagesV1Beta3Client._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        MessagesV1Beta3Client._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        MessagesV1Beta3Client._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        MessagesV1Beta3Client._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        MessagesV1Beta3Client._get_universe_domain(None, None)
        == MessagesV1Beta3Client._DEFAULT_UNIVERSE
    )
...
def test_messages_v1_beta3_client_from_service_account_info(
    client_class, transport_name
):
...
def test_messages_v1_beta3_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_list_job_messages_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_job_messages] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_job_messages_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_job_messages
...
async def test_list_job_messages_async(request_type, transport: str = "grpc_asyncio"):
    client = MessagesV1Beta3AsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc_asyncio():
    transport = MessagesV1Beta3AsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = MessagesV1Beta3Client.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_list_job_messages_rest_bad_request(
    request_type=messages.ListJobMessagesRequest,
):
    client = MessagesV1Beta3Client(
...
def test_list_job_messages_rest_interceptors(null_interceptor):
    transport = transports.MessagesV1Beta3RestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.MessagesV1Beta3RestInterceptor(),
    )
    client = MessagesV1Beta3Client(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.MessagesV1Beta3RestInterceptor, "post_list_job_messages"
        ) as post,
        mock.patch.object(
            transports.MessagesV1Beta3RestInterceptor,
        ...
        pb_message = messages.ListJobMessagesRequest.pb(
            messages.ListJobMessagesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = messages.ListJobMessagesResponse.to_json(
            messages.ListJobMessagesResponse()
        )

...
def test__read_environment_variables():
    assert MessagesV1Beta3Client._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert MessagesV1Beta3Client._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert MessagesV1Beta3Client._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert MessagesV1Beta3Client._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert MessagesV1Beta3Client._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert MessagesV1Beta3Client._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert MessagesV1Beta3Client._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert MessagesV1Beta3Client._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                MessagesV1Beta3Client._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert MessagesV1Beta3Client._get_client_cert_source(None, False) is None
    assert MessagesV1Beta3Client._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MessagesV1Beta3Client._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert MessagesV1Beta3Client._get_client_cert_source(None, True) is mock_default_cert_source
            assert MessagesV1Beta3Client._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(MessagesV1Beta3Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3Client))
@mock.patch.object(MessagesV1Beta3AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3AsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MessagesV1Beta3Client._DEFAULT_UNIVERSE
    default_endpoint = MessagesV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = MessagesV1Beta3Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert MessagesV1Beta3Client._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        MessagesV1Beta3Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == MessagesV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    )
    assert MessagesV1Beta3Client._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MessagesV1Beta3Client._get_api_endpoint(None, None, default_universe, "always") == MessagesV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    assert (
        MessagesV1Beta3Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == MessagesV1Beta3Client.DEFAULT_MTLS_ENDPOINT
    )
    assert MessagesV1Beta3Client._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert MessagesV1Beta3Client._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        MessagesV1Beta3Client._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert MessagesV1Beta3Client._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert MessagesV1Beta3Client._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert MessagesV1Beta3Client._get_universe_domain(None, None) == MessagesV1Beta3Client._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        MessagesV1Beta3Client._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = MessagesV1Beta3Client(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (MessagesV1Beta3Client, "grpc"),
        (MessagesV1Beta3AsyncClient, "grpc_asyncio"),
        (MessagesV1Beta3Client, "rest"),
    ],
)
def test_messages_v1_beta3_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "dataflow.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://dataflow.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (MessagesV1Beta3AsyncClient, transports.MessagesV1Beta3GrpcAsyncIOTransport, "grpc_asyncio"),
        (MessagesV1Beta3Client, transports.MessagesV1Beta3RestTransport, "rest"),
    ],
)
@mock.patch.object(MessagesV1Beta3Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3Client))
@mock.patch.object(MessagesV1Beta3AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3AsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (MessagesV1Beta3Client, transports.MessagesV1Beta3GrpcTransport, "grpc", "true"),
        (MessagesV1Beta3AsyncClient, transports.MessagesV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (MessagesV1Beta3Client, transports.MessagesV1Beta3GrpcTransport, "grpc", "false"),
        (MessagesV1Beta3AsyncClient, transports.MessagesV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (MessagesV1Beta3Client, transports.MessagesV1Beta3RestTransport, "rest", "true"),
        (MessagesV1Beta3Client, transports.MessagesV1Beta3RestTransport, "rest", "false"),
    ],
)
@mock.patch.object(MessagesV1Beta3Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3Client))
@mock.patch.object(MessagesV1Beta3AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3AsyncClient))
...
@mock.patch.object(MessagesV1Beta3Client, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3Client))
@mock.patch.object(MessagesV1Beta3AsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MessagesV1Beta3AsyncClient))
def test_messages_v1_beta3_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (MessagesV1Beta3Client, transports.MessagesV1Beta3GrpcTransport, "grpc", grpc_helpers),
        (MessagesV1Beta3AsyncClient, transports.MessagesV1Beta3GrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (MessagesV1Beta3Client, transports.MessagesV1Beta3RestTransport, "rest", None),
    ],
)
...
def test_list_job_messages_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_job_messages), "__call__") as call:
        ...
        client.list_job_messages(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_job_messages_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_job_messages in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_job_messages] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_job_messages_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_job_messages in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_job_messages] = mock_rpc
...
def test_list_job_messages_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_job_messages), "__call__") as call:
        ...
        pager = client.list_job_messages(request={}, retry=retry, timeout=timeout)
...
async def test_list_job_messages_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_job_messages), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async_pager = await client.list_job_messages(
            request={},
        )
...
async def test_list_job_messages_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_job_messages), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_job_messages(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_list_job_messages_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = MessagesV1Beta3Client(
...
def test_transport_kind_grpc():
    transport = MessagesV1Beta3Client.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_job_messages_empty_call_grpc():
    client = MessagesV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_job_messages), "__call__") as call:
        call.return_value = messages.ListJobMessagesResponse()
        client.list_job_messages(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = messages.ListJobMessagesRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = MessagesV1Beta3AsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = MessagesV1Beta3AsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_job_messages_empty_call_grpc_asyncio():
    client = MessagesV1Beta3AsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.list_job_messages), "__call__") as call:
        ...
        await client.list_job_messages(request=None)
...
def test_transport_kind_rest():
    transport = MessagesV1Beta3Client.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_job_messages_rest_bad_request(request_type=messages.ListJobMessagesRequest):
...
def test_list_job_messages_rest_call_success(request_type):
    client = MessagesV1Beta3Client(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        return_value = messages.ListJobMessagesResponse(
            next_page_token="next_page_token_value",
        )
...
def test_list_job_messages_rest_interceptors(null_interceptor):
    transport = transports.MessagesV1Beta3RestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MessagesV1Beta3RestInterceptor(),
    )
    client = MessagesV1Beta3Client(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.MessagesV1Beta3RestInterceptor, "post_list_job_messages") as post, mock.patch.object(
        transports.MessagesV1Beta3RestInterceptor, "post_list_job_messages_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.MessagesV1Beta3RestInterceptor, "pre_list_job_messages"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = messages.ListJobMessagesResponse.to_json(messages.ListJobMessagesResponse())
        ...
        post_with_metadata.return_value = messages.ListJobMessagesResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_job_messages_empty_call_rest():
    client = MessagesV1Beta3Client(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.MessagesV1Beta3GrpcTransport, grpc_helpers), (transports.MessagesV1Beta3GrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_messages_v1_beta3_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "dataflow.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://dataflow.googleapis.com:8000"
    )
...
def test_messages_v1_beta3_client_transport_session_collision(transport_name):
    ...
    client1 = MessagesV1Beta3Client(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = MessagesV1Beta3Client(
        credentials=creds2,
        transport=transport_name,
    )

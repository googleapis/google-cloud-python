...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TemplatesServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert TemplatesServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TemplatesServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TemplatesServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert TemplatesServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert TemplatesServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                TemplatesServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert TemplatesServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TemplatesServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert TemplatesServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TemplatesServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(TemplatesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TemplatesServiceClient))
@mock.patch.object(TemplatesServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TemplatesServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TemplatesServiceClient._DEFAULT_UNIVERSE
    default_endpoint = TemplatesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TemplatesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TemplatesServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        TemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == TemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert TemplatesServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TemplatesServiceClient._get_api_endpoint(None, None, default_universe, "always") == TemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        TemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == TemplatesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert TemplatesServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TemplatesServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TemplatesServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TemplatesServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TemplatesServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TemplatesServiceClient._get_universe_domain(None, None) == TemplatesServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TemplatesServiceClient, transports.TemplatesServiceRestTransport, "rest", "true"),
        (TemplatesServiceClient, transports.TemplatesServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(TemplatesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TemplatesServiceClient))
@mock.patch.object(TemplatesServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TemplatesServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (TemplatesServiceClient, transports.TemplatesServiceGrpcTransport, "grpc", grpc_helpers),
        (TemplatesServiceAsyncClient, transports.TemplatesServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (TemplatesServiceClient, transports.TemplatesServiceRestTransport, "rest", None),
    ],
)
...
def test_create_job_from_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_job_from_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_job_from_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_job_from_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_job_from_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_job_from_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_launch_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TemplatesServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.launch_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.launch_template] = mock_rpc
...
def test_transport_kind_grpc():
    transport = TemplatesServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = TemplatesServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = TemplatesServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = TemplatesServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_job_from_template_rest_bad_request(request_type=templates.CreateJobFromTemplateRequest):
...
def test_create_job_from_template_rest_interceptors(null_interceptor):
    transport = transports.TemplatesServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TemplatesServiceRestInterceptor(),
    )
    client = TemplatesServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_create_job_from_template") as post, mock.patch.object(
        transports.TemplatesServiceRestInterceptor, "post_create_job_from_template_with_metadata"
...
def test_launch_template_rest_call_success(request_type):
    ...
    request_init["launch_parameters"] = {
        ...
        "environment": {
            ...
            "additional_experiments": ["additional_experiments_value1", "additional_experiments_value2"],
...
def test_launch_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_launch_template") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = templates.LaunchTemplateResponse.to_json(templates.LaunchTemplateResponse())
        req.return_value.content = return_value
...
def test_get_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TemplatesServiceRestInterceptor, "post_get_template") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = templates.GetTemplateResponse.to_json(templates.GetTemplateResponse())
        req.return_value.content = return_value
...
@pytest.mark.parametrize(
    ...
    [(transports.TemplatesServiceGrpcTransport, grpc_helpers), (transports.TemplatesServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

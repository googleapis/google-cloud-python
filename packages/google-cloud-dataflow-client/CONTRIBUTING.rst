...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-dataflow-client``. The
...
instead of
``https://github.com/googleapis/python-dataflow-client/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-dataflow-client/blob/main/packages/google-cloud-dataflow-client/noxfile.py

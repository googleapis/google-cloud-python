...
class AppConnectorsServiceGrpcTransport(AppConnectorsServiceTransport):
    ...
    def list_app_connectors(
        ...
        if "list_app_connectors" not in self._stubs:
            self._stubs["list_app_connectors"] = self.grpc_channel.unary_unary(
    ...
    def get_app_connector(
        ...
        if "get_app_connector" not in self._stubs:
            self._stubs["get_app_connector"] = self.grpc_channel.unary_unary(
    ...
    def create_app_connector(
        ...
        if "create_app_connector" not in self._stubs:
            self._stubs["create_app_connector"] = self.grpc_channel.unary_unary(
    ...
    def update_app_connector(
        ...
        if "update_app_connector" not in self._stubs:
            self._stubs["update_app_connector"] = self.grpc_channel.unary_unary(
    ...
    def delete_app_connector(
        ...
        if "delete_app_connector" not in self._stubs:
            self._stubs["delete_app_connector"] = self.grpc_channel.unary_unary(
    ...
    def report_status(
        ...
        if "report_status" not in self._stubs:
            self._stubs["report_status"] = self.grpc_channel.unary_unary(

...
class AppConnectorsServiceGrpcAsyncIOTransport(AppConnectorsServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_app_connectors: self._wrap_method(
                self.list_app_connectors,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app_connector: self._wrap_method(
                self.get_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app_connector: self._wrap_method(
                self.create_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_app_connector: self._wrap_method(
            ...
            self.report_status: self._wrap_method(
                self.report_status,
                default_timeout=None,
                client_info=client_info,
            ),

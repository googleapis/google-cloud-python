...
class AppConnectorsServiceGrpcAsyncIOTransport(AppConnectorsServiceTransport):
    ...
    def list_app_connectors(
        ...
        Returns:
            Callable[[~.ListAppConnectorsRequest],
                    Awaitable[~.ListAppConnectorsResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_app_connectors: gapic_v1.method_async.wrap_method(
                self.list_app_connectors,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app_connector: gapic_v1.method_async.wrap_method(
                self.get_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app_connector: gapic_v1.method_async.wrap_method(
                self.create_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_app_connector: gapic_v1.method_async.wrap_method(
                self.update_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_app_connector: gapic_v1.method_async.wrap_method(
                self.delete_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.report_status: gapic_v1.method_async.wrap_method(
                self.report_status,
                default_timeout=None,
                client_info=client_info,
            ),
...
__all__ = ("AppConnectorsServiceGrpcAsyncIOTransport",)

...
class AppConnectorsServiceTransport(abc.ABC):
    """Abstract transport class for AppConnectorsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_app_connectors: gapic_v1.method.wrap_method(
                self.list_app_connectors,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app_connector: gapic_v1.method.wrap_method(
                self.get_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app_connector: gapic_v1.method.wrap_method(
                self.create_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_app_connector: gapic_v1.method.wrap_method(
                self.update_app_connector,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_app_connector: gapic_v1.method.wrap_method(
...
__all__ = ("AppConnectorsServiceTransport",)

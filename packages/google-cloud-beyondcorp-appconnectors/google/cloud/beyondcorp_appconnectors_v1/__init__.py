...
__lazy_modules__ = {
    "google.cloud.beyondcorp_appconnectors_v1.services.app_connectors_service",
    "google.cloud.beyondcorp_appconnectors_v1.types.app_connector_instance_config",
    "google.cloud.beyondcorp_appconnectors_v1.types.app_connectors_service",
    "google.cloud.beyondcorp_appconnectors_v1.types.resource_info",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.beyondcorp_appconnectors_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.beyondcorp_appconnectors_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.beyondcorp_appconnectors_v1"

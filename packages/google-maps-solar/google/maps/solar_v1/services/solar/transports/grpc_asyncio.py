...
class SolarGrpcAsyncIOTransport(SolarTransport):
    ...
    def get_data_layers(
        ...
        [solar_service.GetDataLayersRequest], Awaitable[solar_service.DataLayers]
    ]:
    ...
    def get_geo_tiff(
        self,
    ) -> Callable[[solar_service.GetGeoTiffRequest], Awaitable[httpbody_pb2.HttpBody]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.find_closest_building_insights: gapic_v1.method_async.wrap_method(
            ...
            self.get_data_layers: gapic_v1.method_async.wrap_method(
            ...
            self.get_geo_tiff: gapic_v1.method_async.wrap_method(
                self.get_geo_tiff,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,

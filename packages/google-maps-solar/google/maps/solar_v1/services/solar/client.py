...
class SolarClient(metaclass=SolarClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SolarClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or SolarClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SolarTransport]] = None,
        ...
        self._client_cert_source = SolarClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SolarClient._get_universe_domain(
    ...
    def find_closest_building_insights(
        ...
        *,
        ...
        # in a solar_service.FindClosestBuildingInsightsRequest.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.find_closest_building_insights
        ]
    ...
    def get_data_layers(
        ...
        *,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a solar_service.GetDataLayersRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_geo_tiff(
        ...
        *,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a solar_service.GetGeoTiffRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

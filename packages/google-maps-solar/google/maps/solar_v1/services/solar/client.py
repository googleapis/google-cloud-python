...
from .transports.grpc import SolarGrpcTransport
from .transports.grpc_asyncio import SolarGrpcAsyncIOTransport
from .transports.rest import SolarRestTransport


class SolarClientMeta(type):
    """Metaclass for the Solar client.
...
class SolarClient(metaclass=SolarClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SolarClient: The constructed client.
        """
    ...
    def transport(self) -> SolarTransport:
        ...
        Returns:
            SolarTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SolarClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SolarClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SolarClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SolarClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SolarTransport, Callable[..., SolarTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the solar client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SolarClient._read_environment_variables()
        self._client_cert_source = SolarClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SolarClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SolarTransport)
        if transport_provided:
            # transport is a SolarTransport instance.
            ...
            self._transport = cast(SolarTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or SolarClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SolarTransport], Callable[..., SolarTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.maps.solar_v1.SolarClient`.",
                    extra={
    ...
    def find_closest_building_insights(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_find_closest_building_insights():
                # Create a client
        ...
        Args:
            request (Union[google.maps.solar_v1.types.FindClosestBuildingInsightsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.find_closest_building_insights]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_data_layers():
                ...
                # Make the request
                response = client.get_data_layers(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.maps.solar_v1.types.GetDataLayersRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_data_layers]
    ...
    def get_geo_tiff(
        ...
        *,
        ...
        Args:
            request (Union[google.maps.solar_v1.types.GetGeoTiffRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_geo_tiff]

...
from .base import DEFAULT_CLIENT_INFO, MonitoringTransport
from .grpc import MonitoringGrpcTransport
...
class MonitoringGrpcAsyncIOTransport(MonitoringTransport):
    """gRPC AsyncIO backend transport for Monitoring.
    ...
    def list_framework_compliance_summaries(
        ...
        Lists the framework compliance summary for a given
        scope.

        Returns:
            Callable[[~.ListFrameworkComplianceSummariesRequest],
                    Awaitable[~.ListFrameworkComplianceSummariesResponse]]:
    ...
    def list_finding_summaries(
        ...
        Returns:
            Callable[[~.ListFindingSummariesRequest],
                    Awaitable[~.ListFindingSummariesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_finding_summaries" not in self._stubs:
            self._stubs["list_finding_summaries"] = self._logged_channel.unary_unary(
                "/google.cloud.cloudsecuritycompliance.v1.Monitoring/ListFindingSummaries",
                request_serializer=monitoring.ListFindingSummariesRequest.serialize,
                response_deserializer=monitoring.ListFindingSummariesResponse.deserialize,
            )
        return self._stubs["list_finding_summaries"]
    ...
    def fetch_framework_compliance_report(
        ...
        Returns:
            Callable[[~.FetchFrameworkComplianceReportRequest],
                    Awaitable[~.FrameworkComplianceReport]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_control_compliance_summaries(
        ...
        Lists the control compliance summary for a given
        scope.

        Returns:
            Callable[[~.ListControlComplianceSummariesRequest],
                    Awaitable[~.ListControlComplianceSummariesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def aggregate_framework_compliance_report(
        ...
        Gets the aggregated compliance report over time for a
        given scope.

        Returns:
            Callable[[~.AggregateFrameworkComplianceReportRequest],
                    Awaitable[~.AggregateFrameworkComplianceReportResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_framework_compliance_summaries: self._wrap_method(
            ...
            self.list_finding_summaries: self._wrap_method(
            ...
            self.fetch_framework_compliance_report: self._wrap_method(
            ...
            self.list_control_compliance_summaries: self._wrap_method(
            ...
            self.aggregate_framework_compliance_report: self._wrap_method(
...
__all__ = ("MonitoringGrpcAsyncIOTransport",)

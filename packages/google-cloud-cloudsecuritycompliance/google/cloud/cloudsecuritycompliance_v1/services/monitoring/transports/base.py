...
class MonitoringTransport(abc.ABC):
    """Abstract transport class for Monitoring."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_framework_compliance_summaries: gapic_v1.method.wrap_method(
                self.list_framework_compliance_summaries,
            ...
            self.list_finding_summaries: gapic_v1.method.wrap_method(
                self.list_finding_summaries,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.fetch_framework_compliance_report: gapic_v1.method.wrap_method(
            ...
            self.list_control_compliance_summaries: gapic_v1.method.wrap_method(
                self.list_control_compliance_summaries,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.aggregate_framework_compliance_report: gapic_v1.method.wrap_method(
                self.aggregate_framework_compliance_report,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,

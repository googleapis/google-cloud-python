...
class ListFrameworkComplianceSummariesAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[monitoring.ListFrameworkComplianceSummariesResponse]],
        request: monitoring.ListFrameworkComplianceSummariesRequest,
        response: monitoring.ListFrameworkComplianceSummariesResponse,
        *,
    ...
    @property
    async def pages(self) -> AsyncIterator[monitoring.ListFrameworkComplianceSummariesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListControlComplianceSummariesAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[monitoring.ListControlComplianceSummariesResponse]],
        request: monitoring.ListControlComplianceSummariesRequest,
        response: monitoring.ListControlComplianceSummariesResponse,
        *,
        retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[monitoring.ListControlComplianceSummariesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)

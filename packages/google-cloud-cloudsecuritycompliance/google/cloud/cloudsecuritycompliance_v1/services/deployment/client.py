...
class DeploymentClient(metaclass=DeploymentClientMeta):
    ...
    @staticmethod
    def cloud_control_deployment_path(
        organization: str,
        location: str,
        cloud_control_deployment: str,
    ) -> str:
        """Returns a fully-qualified cloud_control_deployment string."""
        return "organizations/{organization}/locations/{location}/cloudControlDeployments/{cloud_control_deployment}".format(
            organization=organization,
            location=location,
    ...
    def parse_cloud_control_deployment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/cloudControlDeployments/(?P<cloud_control_deployment>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def framework_deployment_path(
        ...
        return "organizations/{organization}/locations/{location}/frameworkDeployments/{framework_deployment}".format(
            organization=organization,
            location=location,
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = DeploymentClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or DeploymentClient._get_api_endpoint(

...
class DeploymentGrpcAsyncIOTransport(DeploymentTransport):
    ...
    @property
    def create_framework_deployment(self) -> Callable[[deployment.CreateFrameworkDeploymentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_framework_deployment(self) -> Callable[[deployment.DeleteFrameworkDeploymentRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_framework_deployment(self) -> Callable[[deployment.GetFrameworkDeploymentRequest], Awaitable[deployment.FrameworkDeployment]]:
    ...
    def list_framework_deployments(
        self,
    ) -> Callable[[deployment.ListFrameworkDeploymentsRequest], Awaitable[deployment.ListFrameworkDeploymentsResponse]]:
    ...
    @property
    def get_cloud_control_deployment(self) -> Callable[[deployment.GetCloudControlDeploymentRequest], Awaitable[deployment.CloudControlDeployment]]:
    ...
    def list_cloud_control_deployments(
        self,
    ) -> Callable[[deployment.ListCloudControlDeploymentsRequest], Awaitable[deployment.ListCloudControlDeploymentsResponse]]:
...
__all__ = ("DeploymentGrpcAsyncIOTransport",)

...
from .rest_base import _BaseCmEnrollmentServiceRestTransport
...
class CmEnrollmentServiceRestInterceptor:
    """Interceptor for CmEnrollmentService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CmEnrollmentServiceRestTransport.

    .. code-block:: python
        class MyCustomCmEnrollmentServiceInterceptor(CmEnrollmentServiceRestInterceptor):
            def pre_calculate_effective_cm_enrollment(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_calculate_effective_cm_enrollment(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_cm_enrollment(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_cm_enrollment(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = CmEnrollmentServiceRestTransport(interceptor=MyCustomCmEnrollmentServiceInterceptor())
    ...
    def pre_calculate_effective_cm_enrollment(
        ...
        before they are sent to the CmEnrollmentService server.
        """
        return request, metadata

    def post_calculate_effective_cm_enrollment(
        self, response: cm_enrollment_service.CalculateEffectiveCmEnrollmentResponse
    ) -> cm_enrollment_service.CalculateEffectiveCmEnrollmentResponse:
        """Post-rpc interceptor for calculate_effective_cm_enrollment

        DEPRECATED. Please use the `post_calculate_effective_cm_enrollment_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the CmEnrollmentService server but before
        it is returned to user code. This `post_calculate_effective_cm_enrollment` interceptor runs
        before the `post_calculate_effective_cm_enrollment_with_metadata` interceptor.
        """
        return response
    ...
    def post_calculate_effective_cm_enrollment_with_metadata(
        ...
        is returned by the CmEnrollmentService server but before it is returned to user code.

        We recommend only using this `post_calculate_effective_cm_enrollment_with_metadata`
        interceptor in new development instead of the `post_calculate_effective_cm_enrollment` interceptor.
        When both interceptors are used, this `post_calculate_effective_cm_enrollment_with_metadata` interceptor runs after the
        `post_calculate_effective_cm_enrollment` interceptor. The (possibly modified) response returned by
        `post_calculate_effective_cm_enrollment` will be passed to
    ...
    def post_update_cm_enrollment(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the CmEnrollmentService server but before
        it is returned to user code. This `post_update_cm_enrollment` interceptor runs
        before the `post_update_cm_enrollment_with_metadata` interceptor.
        """
        return response
    ...
    def post_update_cm_enrollment_with_metadata(
        ...
        We recommend only using this `post_update_cm_enrollment_with_metadata`
        interceptor in new development instead of the `post_update_cm_enrollment` interceptor.
        When both interceptors are used, this `post_update_cm_enrollment_with_metadata` interceptor runs after the
        `post_update_cm_enrollment` interceptor. The (possibly modified) response returned by
        `post_update_cm_enrollment` will be passed to
...
class CmEnrollmentServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CmEnrollmentServiceRestInterceptor


class CmEnrollmentServiceRestTransport(_BaseCmEnrollmentServiceRestTransport):
    """REST backend synchronous transport for CmEnrollmentService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[CmEnrollmentServiceRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[CmEnrollmentServiceRestInterceptor]): Interceptor used
    ...
    class _CalculateEffectiveCmEnrollment(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the calculate effective cm
            enrollment method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.CalculateEffectiveCmEnrollment",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "CalculateEffectiveCmEnrollment",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.calculate_effective_cm_enrollment",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "CalculateEffectiveCmEnrollment",
    ...
    class _UpdateCmEnrollment(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update cm enrollment method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.UpdateCmEnrollment",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "UpdateCmEnrollment",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = cm_enrollment_service.CmEnrollment()
            pb_resp = cm_enrollment_service.CmEnrollment.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.update_cm_enrollment",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "UpdateCmEnrollment",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.cloudsecuritycompliance_v1.CmEnrollmentServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
...
__all__ = ("CmEnrollmentServiceRestTransport",)

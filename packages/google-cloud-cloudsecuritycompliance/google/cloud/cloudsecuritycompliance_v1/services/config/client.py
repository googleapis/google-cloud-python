...
class ConfigClient(metaclass=ConfigClientMeta):
    ...
    def parse_cloud_control_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/cloudControls/(?P<cloud_control>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ConfigClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = ConfigClient._get_universe_domain(

...
class ConfigClientMeta(type):
    """Metaclass for the Config client.
...
class ConfigClient(metaclass=ConfigClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConfigClient: The constructed client.
        """
    ...
    def transport(self) -> ConfigTransport:
        ...
        Returns:
            ConfigTransport: The transport used by the client
                instance.
        """
    ...
    def cloud_control_path(
        ...
        return "organizations/{organization}/locations/{location}/cloudControls/{cloud_control}".format(
    ...
    @staticmethod
    def parse_cloud_control_path(path: str) -> Dict[str, str]:
        """Parses a cloud_control path into its component segments."""
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/cloudControls/(?P<cloud_control>.+?)$", path)
    ...
    def parse_framework_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/locations/(?P<location>.+?)/frameworks/(?P<framework>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ConfigClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ConfigClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ConfigClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ConfigClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ConfigTransport, Callable[..., ConfigTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ConfigClient._read_environment_variables()
        self._client_cert_source = ConfigClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ConfigClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ConfigClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ConfigTransport], Callable[..., ConfigTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.cloudsecuritycompliance_v1.ConfigClient`.",
                    extra={
    ...
    def list_frameworks(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_frameworks]
        ...
        response = pagers.ListFrameworksPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_framework():
                ...
                # Make the request
                response = client.get_framework(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_framework]
    ...
    def create_framework(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_framework]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_framework():
                ...
                # Make the request
                response = client.update_framework(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.cloudsecuritycompliance_v1.types.UpdateFrameworkRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_framework]
    ...
    def delete_framework(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_framework]
    ...
    def list_cloud_controls(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_cloud_controls():
                # Create a client
                client = cloudsecuritycompliance_v1.ConfigClient()
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_cloud_controls]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListCloudControlsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_cloud_control():
                ...
                # Make the request
                response = client.get_cloud_control(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.cloudsecuritycompliance_v1.types.GetCloudControlRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_cloud_control]
    ...
    def create_cloud_control(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_cloud_control():
                # Create a client
                client = cloudsecuritycompliance_v1.ConfigClient()
                ...
                # Make the request
                response = client.create_cloud_control(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_cloud_control]
    ...
    def update_cloud_control(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_cloud_control():
                # Create a client
                client = cloudsecuritycompliance_v1.ConfigClient()
                ...
                # Make the request
                response = client.update_cloud_control(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.cloudsecuritycompliance_v1.types.UpdateCloudControlRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_cloud_control]
    ...
    def delete_cloud_control(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_cloud_control():
                # Create a client
                client = cloudsecuritycompliance_v1.ConfigClient()
        ...
        Args:
            request (Union[google.cloud.cloudsecuritycompliance_v1.types.DeleteCloudControlRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_cloud_control]

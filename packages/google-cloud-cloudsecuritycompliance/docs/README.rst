Python Client for Cloud Security Compliance
===========================================
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-cloudsecuritycompliance.svg
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-cloudsecuritycompliance.svg
   :target: https://pypi.org/project/google-cloud-cloudsecuritycompliance/
.. _Cloud Security Compliance: https://cloud.google.com/security-command-center/docs/compliance-manager-overview
...
3. `Enable the Cloud Security Compliance.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud Security Compliance.:  https://cloud.google.com/security-command-center/docs/compliance-manager-overview
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-cloudsecuritycompliance/samples
...
.. code-block:: console
    ...
    pip install google-cloud-cloudsecuritycompliance
...
-  Read the `Client Library Documentation`_ for Cloud Security Compliance
   to see other available methods on the client.
-  Read the `Cloud Security Compliance Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud Security Compliance Product documentation:  https://cloud.google.com/security-command-center/docs/compliance-manager-overview

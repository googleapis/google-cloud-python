...
#
# Snippet for ListFrameworkAudits
...
def sample_list_framework_audits():
    # Create a client
    client = cloudsecuritycompliance_v1.AuditClient()

    # Initialize request argument(s)
    request = cloudsecuritycompliance_v1.ListFrameworkAuditsRequest(
        parent="parent_value",
    )

    # Make the request
    page_result = client.list_framework_audits(request=request)

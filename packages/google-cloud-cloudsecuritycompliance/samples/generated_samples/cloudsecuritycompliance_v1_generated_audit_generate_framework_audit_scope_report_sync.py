...
#
# Snippet for GenerateFrameworkAuditScopeReport
...
def sample_generate_framework_audit_scope_report():
    # Create a client
    client = cloudsecuritycompliance_v1.AuditClient()

    # Initialize request argument(s)
    request = cloudsecuritycompliance_v1.GenerateFrameworkAuditScopeReportRequest(
        scope="scope_value",
        report_format="ODF",
    ...
    # Make the request
    response = client.generate_framework_audit_scope_report(request=request)

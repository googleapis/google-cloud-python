...
#
# Snippet for FetchFrameworkComplianceReport
...
def sample_fetch_framework_compliance_report():
    # Create a client
    ...
    # Make the request
    response = client.fetch_framework_compliance_report(request=request)

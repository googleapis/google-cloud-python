...
#
# Snippet for GetFrameworkDeployment
...
def sample_get_framework_deployment():
    # Create a client
    client = cloudsecuritycompliance_v1.DeploymentClient()

    # Initialize request argument(s)
    request = cloudsecuritycompliance_v1.GetFrameworkDeploymentRequest(
        name="name_value",
    )

    # Make the request
    response = client.get_framework_deployment(request=request)

...
#
# Snippet for CalculateEffectiveCmEnrollment
...
async def sample_calculate_effective_cm_enrollment():
    # Create a client
    client = cloudsecuritycompliance_v1.CmEnrollmentServiceAsyncClient()
    ...
    # Make the request
    response = await client.calculate_effective_cm_enrollment(request=request)

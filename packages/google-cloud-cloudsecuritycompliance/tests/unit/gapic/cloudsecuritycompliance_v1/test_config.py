...
from google.cloud.cloudsecuritycompliance_v1.services.config import ConfigAsyncClient, ConfigClient, pagers, transports
...
def test_config_client_client_options_from_dict():
    with mock.patch("google.cloud.cloudsecuritycompliance_v1.services.config.transports.ConfigGrpcTransport.__init__") as grpc_transport:
...
@pytest.mark.asyncio
async def test_list_frameworks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_frameworks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_frameworks] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_frameworks_async(transport: str = "grpc_asyncio", request_type=config.ListFrameworksRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_frameworks_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_frameworks), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(config.ListFrameworksResponse())
        await client.list_frameworks(request)
...
async def test_list_frameworks_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_frameworks), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            config.ListFrameworksResponse(
                frameworks=[
...
async def test_list_frameworks_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_frameworks), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_frameworks(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_framework(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_framework), "__call__") as call:
        ...
        call.return_value = common.Framework(
            ...
            supported_target_resource_types=[common.TargetResourceType.TARGET_RESOURCE_CRM_TYPE_ORG],
    ...
    assert response.supported_target_resource_types == [common.TargetResourceType.TARGET_RESOURCE_CRM_TYPE_ORG]
...
@pytest.mark.asyncio
async def test_get_framework_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_framework in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_framework] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_framework_async(transport: str = "grpc_asyncio", request_type=config.GetFrameworkRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_framework_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_framework] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_framework_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_framework in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_framework] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_framework_async(transport: str = "grpc_asyncio", request_type=config.CreateFrameworkRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_framework_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_framework] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_framework_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_framework in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_framework] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_framework_async(transport: str = "grpc_asyncio", request_type=config.UpdateFrameworkRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_framework_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_framework] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_framework_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_framework in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_framework] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_framework_async(transport: str = "grpc_asyncio", request_type=config.DeleteFrameworkRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_cloud_controls(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_cloud_controls), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_cloud_controls_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_cloud_controls in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_cloud_controls] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_cloud_controls_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_cloud_controls in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_cloud_controls] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_cloud_controls_async(transport: str = "grpc_asyncio", request_type=config.ListCloudControlsRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_cloud_controls_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_cloud_controls), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(config.ListCloudControlsResponse())
        await client.list_cloud_controls(request)
...
async def test_list_cloud_controls_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_cloud_controls), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            config.ListCloudControlsResponse(
                cloud_controls=[
...
async def test_list_cloud_controls_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_cloud_controls), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_cloud_controls(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_cloud_control(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_cloud_control), "__call__") as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.categories == [common.CloudControlCategory.CC_CATEGORY_INFRASTRUCTURE]
    assert response.supported_target_resource_types == [common.TargetResourceType.TARGET_RESOURCE_CRM_TYPE_ORG]
...
def test_get_cloud_control_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_cloud_control] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_cloud_control_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_cloud_control in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_cloud_control] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_cloud_control_async(transport: str = "grpc_asyncio", request_type=config.GetCloudControlRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_cloud_control(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_cloud_control), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = common.CloudControl(
            name="name_value",
            major_revision_id=1811,
...
def test_create_cloud_control_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_cloud_control in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_cloud_control] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_cloud_control_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_cloud_control in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_cloud_control] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_cloud_control_async(transport: str = "grpc_asyncio", request_type=config.CreateCloudControlRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_cloud_control(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_cloud_control), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = common.CloudControl(
            name="name_value",
            major_revision_id=1811,
...
def test_update_cloud_control_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_cloud_control in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_cloud_control] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_cloud_control_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_cloud_control in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_cloud_control] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_cloud_control_async(transport: str = "grpc_asyncio", request_type=config.UpdateCloudControlRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_cloud_control(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_cloud_control), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_cloud_control_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_cloud_control in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_cloud_control] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_cloud_control_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ConfigAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_cloud_control in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_cloud_control] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_cloud_control_async(transport: str = "grpc_asyncio", request_type=config.DeleteCloudControlRequest):
    client = ConfigAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_frameworks_rest_required_fields(request_type=config.ListFrameworksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_frameworks._get_unset_required_fields(jsonified_request)
...
def test_list_frameworks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/frameworks" % client.transport._host, args[1])
...
def test_get_framework_rest_required_fields(request_type=config.GetFrameworkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_framework._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_framework_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "organizations/sample1/locations/sample2/frameworks/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/frameworks/*}" % client.transport._host, args[1])
...
def test_create_framework_rest_required_fields(request_type=config.CreateFrameworkRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_framework._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_framework_rest_required_fields(request_type=config.UpdateFrameworkRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_framework._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_framework_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"framework": {"name": "organizations/sample1/locations/sample2/frameworks/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{framework.name=organizations/*/locations/*/frameworks/*}" % client.transport._host, args[1])
...
def test_delete_framework_rest_required_fields(request_type=config.DeleteFrameworkRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_framework._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_cloud_controls_rest_required_fields(request_type=config.ListCloudControlsRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_cloud_controls._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_cloud_controls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/locations/*}/cloudControls" % client.transport._host, args[1])
...
def test_get_cloud_control_rest_required_fields(request_type=config.GetCloudControlRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_cloud_control._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_cloud_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "organizations/sample1/locations/sample2/cloudControls/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/locations/*/cloudControls/*}" % client.transport._host, args[1])
...
def test_create_cloud_control_rest_required_fields(request_type=config.CreateCloudControlRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cloud_control._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_cloud_control_rest_required_fields(request_type=config.UpdateCloudControlRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_cloud_control._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_cloud_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"cloud_control": {"name": "organizations/sample1/locations/sample2/cloudControls/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{cloud_control.name=organizations/*/locations/*/cloudControls/*}" % client.transport._host, args[1])
...
def test_delete_cloud_control_rest_required_fields(request_type=config.DeleteCloudControlRequest):
    transport_class = transports.ConfigRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_cloud_control._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_frameworks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_list_frameworks") as post, mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListFrameworksResponse.to_json(config.ListFrameworksResponse())
...
def test_get_framework_rest_bad_request(request_type=config.GetFrameworkRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/frameworks/sample3"}
    request = request_type(**request_init)
...
def test_get_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_get_framework") as post, mock.patch.object(
...
def test_create_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_create_framework") as post, mock.patch.object(
...
def test_update_framework_rest_bad_request(request_type=config.UpdateFrameworkRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"framework": {"name": "organizations/sample1/locations/sample2/frameworks/sample3"}}
    request = request_type(**request_init)
...
def test_update_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_update_framework") as post, mock.patch.object(
...
def test_delete_framework_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_framework") as pre:
        pre.assert_not_called()
...
def test_list_cloud_controls_rest_bad_request(request_type=config.ListCloudControlsRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "organizations/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_cloud_controls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_list_cloud_controls") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.ListCloudControlsRequest.pb(config.ListCloudControlsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = config.ListCloudControlsResponse.to_json(config.ListCloudControlsResponse())
        req.return_value.content = return_value
...
def test_get_cloud_control_rest_bad_request(request_type=config.GetCloudControlRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/cloudControls/sample3"}
    request = request_type(**request_init)
...
def test_get_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_get_cloud_control") as post, mock.patch.object(
...
def test_create_cloud_control_rest_bad_request(request_type=config.CreateCloudControlRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "organizations/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_cloud_control_rest_call_success(request_type):
    ...
    request_init["cloud_control"] = {
        ...
        "parameter_spec": [
            {
                ...
                "substitution_rules": [
                    {
                        "placeholder_substitution_rule": {"attribute": "attribute_value"},
        ...
        "rules": [
            {
                "cel_expression": {"resource_types_values": {}, "expression": "expression_value"},
                "description": "description_value",
                "rule_action_types": [1],
            }
        ],
        ...
        "finding_category": "finding_category_value",
        "supported_cloud_providers": [1],
        "related_frameworks": ["related_frameworks_value1", "related_frameworks_value2"],
        "remediation_steps": "remediation_steps_value",
        "categories": [1],
...
def test_create_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_create_cloud_control") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.CreateCloudControlRequest.pb(config.CreateCloudControlRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_cloud_control_rest_bad_request(request_type=config.UpdateCloudControlRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"cloud_control": {"name": "organizations/sample1/locations/sample2/cloudControls/sample3"}}
    request = request_type(**request_init)
...
def test_update_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "post_update_cloud_control") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = config.UpdateCloudControlRequest.pb(config.UpdateCloudControlRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_cloud_control_rest_bad_request(request_type=config.DeleteCloudControlRequest):
    client = ConfigClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "organizations/sample1/locations/sample2/cloudControls/sample3"}
    request = request_type(**request_init)
...
def test_delete_cloud_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigRestInterceptor, "pre_delete_cloud_control") as pre:
        pre.assert_not_called()
        pb_message = config.DeleteCloudControlRequest.pb(config.DeleteCloudControlRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_config_base_transport():
    ...
    with mock.patch("google.cloud.cloudsecuritycompliance_v1.services.config.transports.ConfigTransport.__init__") as Transport:

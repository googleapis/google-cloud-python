...
class AttributeContext(_message.Message):
    __slots__ = ["api", "destination", "extensions", "origin", "request", "resource", "response", "source"]
    ...
    class Request(_message.Message):
        __slots__ = ["auth", "headers", "host", "id", "method", "origin", "path", "protocol", "query", "reason", "scheme", "size", "time"]
        ...
        def __init__(self, id: _Optional[str] = ..., method: _Optional[str] = ..., headers: _Optional[_Mapping[str, str]] = ..., path: _Optional[str] = ..., host: _Optional[str] = ..., scheme: _Optional[str] = ..., query: _Optional[str] = ..., time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., size: _Optional[int] = ..., protocol: _Optional[str] = ..., reason: _Optional[str] = ..., auth: _Optional[_Union[AttributeContext.Auth, _Mapping]] = ..., origin: _Optional[str] = ...) -> None: ...
    class Resource(_message.Message):
        __slots__ = ["annotations", "create_time", "delete_time", "display_name", "etag", "labels", "location", "name", "service", "type", "uid", "update_time"]

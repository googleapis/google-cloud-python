...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.cloud.location.locations_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _LOCATIONS.methods_by_name['ListLocations']._serialized_options = b'\202\323\344\223\0029\022\024/v1/{name=locations}Z!\022\037/v1/{name=projects/*}/locations'
  _LOCATIONS.methods_by_name['GetLocation']._options = None
  _LOCATIONS.methods_by_name['GetLocation']._serialized_options = b'\202\323\344\223\002=\022\026/v1/{name=locations/*}Z#\022!/v1/{name=projects/*/locations/*}'

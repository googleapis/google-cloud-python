Python Client for Parallelstore
===============================
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-parallelstore.svg
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-parallelstore.svg
   :target: https://pypi.org/project/google-cloud-parallelstore/
.. _Parallelstore: https://cloud.google.com/parallelstore?hl=en
...
3. `Enable the Parallelstore.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Parallelstore.:  https://cloud.google.com/parallelstore?hl=en
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-parallelstore/samples
...
-  Read the `Client Library Documentation`_ for Parallelstore
   to see other available methods on the client.
-  Read the `Parallelstore Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Parallelstore Product documentation:  https://cloud.google.com/parallelstore?hl=en

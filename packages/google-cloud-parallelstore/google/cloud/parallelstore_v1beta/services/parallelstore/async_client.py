...
class ParallelstoreAsyncClient:
    ...
    parse_service_account_path = staticmethod(ParallelstoreClient.parse_service_account_path)
    common_billing_account_path = staticmethod(ParallelstoreClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ParallelstoreClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ParallelstoreClient.common_folder_path)
    parse_common_folder_path = staticmethod(ParallelstoreClient.parse_common_folder_path)
    common_organization_path = staticmethod(ParallelstoreClient.common_organization_path)
    parse_common_organization_path = staticmethod(ParallelstoreClient.parse_common_organization_path)
    common_project_path = staticmethod(ParallelstoreClient.common_project_path)
    parse_common_project_path = staticmethod(ParallelstoreClient.parse_common_project_path)
    common_location_path = staticmethod(ParallelstoreClient.common_location_path)
    parse_common_location_path = staticmethod(ParallelstoreClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ParallelstoreTransport, Callable[..., ParallelstoreTransport]]] = "grpc_asyncio",
    ...
    async def import_data(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_data]
    ...
    async def export_data(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_data]

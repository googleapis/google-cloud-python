...
class ParallelstoreGrpcAsyncIOTransport(ParallelstoreTransport):
    ...
    @property
    def list_instances(self) -> Callable[[parallelstore.ListInstancesRequest], Awaitable[parallelstore.ListInstancesResponse]]:
    ...
    @property
    def get_instance(self) -> Callable[[parallelstore.GetInstanceRequest], Awaitable[parallelstore.Instance]]:
    ...
    @property
    def create_instance(self) -> Callable[[parallelstore.CreateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_instance(self) -> Callable[[parallelstore.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_instance(self) -> Callable[[parallelstore.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_data(self) -> Callable[[parallelstore.ImportDataRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_data(self) -> Callable[[parallelstore.ExportDataRequest], Awaitable[operations_pb2.Operation]]:

...
from google.cloud.parallelstore_v1.services.parallelstore import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ParallelstoreClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ParallelstoreClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ParallelstoreClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ParallelstoreClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ParallelstoreClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
...
def test__get_client_cert_source():
    ...
    assert (
        ParallelstoreClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ParallelstoreClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ParallelstoreClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ParallelstoreClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ParallelstoreClient),
)
@mock.patch.object(
    ParallelstoreAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ParallelstoreAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ParallelstoreClient._DEFAULT_UNIVERSE
    default_endpoint = ParallelstoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ParallelstoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ParallelstoreClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ParallelstoreClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ParallelstoreClient._get_api_endpoint(None, None, default_universe, "always")
        == ParallelstoreClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ParallelstoreClient._get_api_endpoint(
    ...
    assert (
        ParallelstoreClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ParallelstoreClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ParallelstoreClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ParallelstoreClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ParallelstoreClient._get_universe_domain(None, None)
        == ParallelstoreClient._DEFAULT_UNIVERSE
    )
...
def test_parallelstore_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_parallelstore_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_parallelstore_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [ParallelstoreClient, ParallelstoreAsyncClient]
)
@mock.patch.object(
    ParallelstoreClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ParallelstoreClient),
)
@mock.patch.object(
    ParallelstoreAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ParallelstoreAsyncClient),
)
...
def test_parallelstore_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_parallelstore_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_parallelstore_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.parallelstore_v1.services.parallelstore.transports.ParallelstoreGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_parallelstore_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = parallelstore.ListInstancesResponse.to_json(
            parallelstore.ListInstancesResponse()
        )
...
def test_list_instances_rest_bad_request(
    transport: str = "rest", request_type=parallelstore.ListInstancesRequest
):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_instances_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            parallelstore.ListInstancesResponse.to_json(x) for x in response
        )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = parallelstore.Instance.to_json(
            parallelstore.Instance()
        )
...
def test_get_instance_rest_bad_request(
    transport: str = "rest", request_type=parallelstore.GetInstanceRequest
):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_instance_rest_bad_request(
    transport: str = "rest", request_type=parallelstore.CreateInstanceRequest
):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_instance_rest_bad_request(
    transport: str = "rest", request_type=parallelstore.UpdateInstanceRequest
):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_instance_rest_bad_request(
    transport: str = "rest", request_type=parallelstore.DeleteInstanceRequest
):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_parallelstore_base_transport():
    ...
    with mock.patch(
        "google.cloud.parallelstore_v1.services.parallelstore.transports.ParallelstoreTransport.__init__"
    ) as Transport:
...
def test_parallelstore_host_no_port(transport_name):
    client = ParallelstoreClient(
        ...
        client_options=client_options.ClientOptions(
            api_endpoint="parallelstore.googleapis.com"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_parallelstore_host_with_port(transport_name):
    client = ParallelstoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
            api_endpoint="parallelstore.googleapis.com:8000"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.ParallelstoreTransport, "_prep_wrapped_messages"
    ) as prep:
        client = ParallelstoreClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_location_field_headers_async():
    client = ParallelstoreAsyncClient(credentials=ga_credentials.AnonymousCredentials())

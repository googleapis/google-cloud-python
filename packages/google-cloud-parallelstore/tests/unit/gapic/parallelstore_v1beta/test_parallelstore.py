...
from google.cloud.parallelstore_v1beta.services.parallelstore import (
...
def test_parallelstore_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.parallelstore_v1beta.services.parallelstore.transports.ParallelstoreGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_parallelstore_base_transport():
    ...
    with mock.patch(
        "google.cloud.parallelstore_v1beta.services.parallelstore.transports.ParallelstoreTransport.__init__"
    ) as Transport:
...
def test_parallelstore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.parallelstore_v1beta.services.parallelstore.transports.ParallelstoreTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

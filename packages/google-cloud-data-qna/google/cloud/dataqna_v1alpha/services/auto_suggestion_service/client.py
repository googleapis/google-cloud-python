...
class AutoSuggestionServiceClient(metaclass=AutoSuggestionServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                AutoSuggestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            AutoSuggestionServiceClient._read_environment_variables()
        )
        self._client_cert_source = AutoSuggestionServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AutoSuggestionServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AutoSuggestionServiceClient._get_api_endpoint(

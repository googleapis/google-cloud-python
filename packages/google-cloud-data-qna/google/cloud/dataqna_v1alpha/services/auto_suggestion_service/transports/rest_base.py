...
class _BaseAutoSuggestionServiceRestTransport(AutoSuggestionServiceTransport):
    """Base REST backend transport for AutoSuggestionService.
    ...
    class _BaseSuggestQueries:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutoSuggestionServiceRestTransport._BaseSuggestQueries._get_unset_required_fields(query_params))

            return query_params


__all__ = ("_BaseAutoSuggestionServiceRestTransport",)

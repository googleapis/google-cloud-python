...
class QuestionServiceClient(metaclass=QuestionServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or QuestionServiceClient._get_api_endpoint(
    ...
    def update_user_feedback(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("user_feedback.name", request.user_feedback.name),)),)

...
class _BaseQuestionServiceRestTransport(QuestionServiceTransport):
    """Base REST backend transport for QuestionService.
    ...
    class _BaseCreateQuestion:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseQuestionServiceRestTransport._BaseCreateQuestion._get_unset_required_fields(query_params))

            return query_params

    class _BaseExecuteQuestion:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseQuestionServiceRestTransport._BaseExecuteQuestion._get_unset_required_fields(query_params))

            return query_params

    class _BaseGetQuestion:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseQuestionServiceRestTransport._BaseGetQuestion._get_unset_required_fields(query_params))

            return query_params

    class _BaseGetUserFeedback:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseQuestionServiceRestTransport._BaseGetUserFeedback._get_unset_required_fields(query_params))

            return query_params

    class _BaseUpdateUserFeedback:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseQuestionServiceRestTransport._BaseUpdateUserFeedback._get_unset_required_fields(query_params))

            return query_params


__all__ = ("_BaseQuestionServiceRestTransport",)

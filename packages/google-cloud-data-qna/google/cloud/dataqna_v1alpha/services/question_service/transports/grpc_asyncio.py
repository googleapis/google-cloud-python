...
class QuestionServiceGrpcAsyncIOTransport(QuestionServiceTransport):
    ...
    @property
    def get_question(self) -> Callable[[question_service.GetQuestionRequest], Awaitable[question.Question]]:
    ...
    @property
    def create_question(self) -> Callable[[question_service.CreateQuestionRequest], Awaitable[gcd_question.Question]]:
    ...
    @property
    def execute_question(self) -> Callable[[question_service.ExecuteQuestionRequest], Awaitable[question.Question]]:
    ...
    @property
    def get_user_feedback(self) -> Callable[[question_service.GetUserFeedbackRequest], Awaitable[user_feedback.UserFeedback]]:
    ...
    @property
    def update_user_feedback(self) -> Callable[[question_service.UpdateUserFeedbackRequest], Awaitable[gcd_user_feedback.UserFeedback]]:

...
class QuestionServiceTransport(abc.ABC):
    ...
    def get_question(
        ...
        typing.Union[question.Question, typing.Awaitable[question.Question]],
    ]:
    ...
    def create_question(
        ...
        typing.Union[gcd_question.Question, typing.Awaitable[gcd_question.Question]],
    ]:
        raise NotImplementedError()
    ...
    def get_user_feedback(
        ...
        typing.Union[
            user_feedback.UserFeedback, typing.Awaitable[user_feedback.UserFeedback]
        ],
    ]:
        raise NotImplementedError()

...
from .services.auto_suggestion_service import AutoSuggestionServiceAsyncClient, AutoSuggestionServiceClient
...
from .types.auto_suggestion_service import Suggestion, SuggestionInfo, SuggestionType, SuggestQueriesRequest, SuggestQueriesResponse
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.dataqna_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.cloud.dataqna_v1alpha")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.dataqna_v1alpha"

...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert QuestionServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert QuestionServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert QuestionServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert QuestionServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert QuestionServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert QuestionServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                QuestionServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert QuestionServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert QuestionServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert QuestionServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert QuestionServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(QuestionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuestionServiceClient))
@mock.patch.object(QuestionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuestionServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = QuestionServiceClient._DEFAULT_UNIVERSE
    default_endpoint = QuestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = QuestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert QuestionServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        QuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == QuestionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert QuestionServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert QuestionServiceClient._get_api_endpoint(None, None, default_universe, "always") == QuestionServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        QuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == QuestionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert QuestionServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert QuestionServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        QuestionServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert QuestionServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert QuestionServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert QuestionServiceClient._get_universe_domain(None, None) == QuestionServiceClient._DEFAULT_UNIVERSE
...
def test_question_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "dataqna.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://dataqna.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (QuestionServiceClient, transports.QuestionServiceRestTransport, "rest", "true"),
        (QuestionServiceClient, transports.QuestionServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(QuestionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuestionServiceClient))
@mock.patch.object(QuestionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(QuestionServiceAsyncClient))
...
@pytest.mark.asyncio
async def test_get_question_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_question in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_question] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_question_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = QuestionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_question in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_question] = mock_rpc
...
def test_execute_question_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.execute_question] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_execute_question_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = QuestionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.execute_question in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.execute_question] = mock_rpc
...
def test_get_user_feedback_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_user_feedback] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_user_feedback_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = QuestionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_user_feedback in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_user_feedback] = mock_rpc
...
def test_update_user_feedback_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_user_feedback in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_user_feedback] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_user_feedback_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = QuestionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_user_feedback in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_user_feedback] = mock_rpc
...
def test_update_user_feedback_rest_required_fields(request_type=question_service.UpdateUserFeedbackRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_user_feedback._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_user_feedback_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{user_feedback.name=projects/*/locations/*/questions/*/userFeedback}" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = QuestionServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_question_empty_call_grpc():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_question), "__call__") as call:
        call.return_value = question.Question()
        client.get_question(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_question_empty_call_grpc():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_question), "__call__") as call:
        call.return_value = gcd_question.Question()
        client.create_question(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_execute_question_empty_call_grpc():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.execute_question), "__call__") as call:
        call.return_value = question.Question()
        client.execute_question(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_user_feedback_empty_call_grpc():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_user_feedback), "__call__") as call:
        call.return_value = user_feedback.UserFeedback()
        client.get_user_feedback(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_user_feedback_empty_call_grpc():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_user_feedback), "__call__") as call:
        call.return_value = gcd_user_feedback.UserFeedback()
        client.update_user_feedback(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = QuestionServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = QuestionServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_question_empty_call_grpc_asyncio():
    client = QuestionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.get_question), "__call__") as call:
        ...
        await client.get_question(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_question_empty_call_grpc_asyncio():
    client = QuestionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_question), "__call__") as call:
        ...
        await client.create_question(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_execute_question_empty_call_grpc_asyncio():
    client = QuestionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.execute_question), "__call__") as call:
        ...
        await client.execute_question(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_user_feedback_empty_call_grpc_asyncio():
    client = QuestionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_user_feedback), "__call__") as call:
        ...
        await client.get_user_feedback(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_user_feedback_empty_call_grpc_asyncio():
    client = QuestionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_user_feedback), "__call__") as call:
        ...
        await client.update_user_feedback(request=None)
...
def test_transport_kind_rest():
    transport = QuestionServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_question_rest_bad_request(request_type=question_service.GetQuestionRequest):
...
def test_get_question_rest_call_success(request_type):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_question_rest_interceptors(null_interceptor):
    transport = transports.QuestionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.QuestionServiceRestInterceptor(),
    )
    client = QuestionServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.QuestionServiceRestInterceptor, "post_get_question") as post, mock.patch.object(
...
def test_create_question_rest_bad_request(request_type=question_service.CreateQuestionRequest):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_question_rest_call_success(request_type):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["question"] = {
        ...
        "query": "query_value",
        "data_source_annotations": ["data_source_annotations_value1", "data_source_annotations_value2"],
        "interpret_error": {
            "message": "message_value",
            "code": 1,
            "details": {
                "unsupported_details": {"operators": ["operators_value1", "operators_value2"], "intent": ["intent_value1", "intent_value2"]},
        ...
        "interpretations": [
            {
                ...
                "human_readable": {
                    "generated_interpretation": {
                        ...
                        "markups": [{"type_": 1, "start_char_index": 1698, "length": 642}],
                    },
                    "original_question": {},
                },
                "interpretation_structure": {
                    "visualization_types": [1],
                    "column_info": [{"output_alias": "output_alias_value", "display_name": "display_name_value"}],
                },
                ...
                "execution_info": {
                    ...
                    "bigquery_job": {"job_id": "job_id_value", "project_id": "project_id_value", "location": "location_value"},
                },
            }
        ],
        "create_time": {},
...
def test_create_question_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.QuestionServiceRestInterceptor, "post_create_question") as post, mock.patch.object(
...
def test_execute_question_rest_bad_request(request_type=question_service.ExecuteQuestionRequest):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/questions/sample3"}
    request = request_type(**request_init)
...
def test_execute_question_rest_call_success(request_type):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_execute_question_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.QuestionServiceRestInterceptor, "post_execute_question") as post, mock.patch.object(
...
def test_get_user_feedback_rest_bad_request(request_type=question_service.GetUserFeedbackRequest):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_user_feedback_rest_call_success(request_type):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_user_feedback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.QuestionServiceRestInterceptor, "post_get_user_feedback") as post, mock.patch.object(
        transports.QuestionServiceRestInterceptor, "post_get_user_feedback_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_user_feedback_rest_bad_request(request_type=question_service.UpdateUserFeedbackRequest):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_user_feedback_rest_call_success(request_type):
    client = QuestionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_user_feedback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.QuestionServiceRestInterceptor, "post_update_user_feedback") as post, mock.patch.object(
        transports.QuestionServiceRestInterceptor, "post_update_user_feedback_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcd_user_feedback.UserFeedback.to_json(gcd_user_feedback.UserFeedback())
        req.return_value.content = return_value
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_question_empty_call_rest():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_question_empty_call_rest():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_execute_question_empty_call_rest():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_user_feedback_empty_call_rest():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_user_feedback_empty_call_rest():
    client = QuestionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.QuestionServiceGrpcTransport, grpc_helpers), (transports.QuestionServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_question_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "dataqna.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://dataqna.googleapis.com:8000"
    )

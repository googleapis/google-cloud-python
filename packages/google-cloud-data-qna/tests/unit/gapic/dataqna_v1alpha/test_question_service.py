...
from google.cloud.dataqna_v1alpha.types import (
    annotated_string,
    question,
    question_service,
    user_feedback,
...
def test_execute_question_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.execute_question] = (
            mock_rpc
        )
        request = {}
...
def test_get_user_feedback_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_user_feedback] = (
            mock_rpc
        )
        request = {}
...
def test_update_user_feedback_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_user_feedback] = (
            mock_rpc
        )
        request = {}
...
def test_get_question_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetQuestion,
    ...
    assert not set(unset_fields) - set(("readMask",))
...
def test_create_question_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateQuestion,
...
def test_execute_question_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseExecuteQuestion,
...
def test_get_user_feedback_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetUserFeedback,
...
def test_update_user_feedback_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateUserFeedback,
...
def test_transport_kind_grpc_asyncio():
    transport = QuestionServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = QuestionServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )

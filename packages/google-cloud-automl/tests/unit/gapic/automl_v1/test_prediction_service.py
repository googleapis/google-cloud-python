...
def test_prediction_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.automl_v1.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/models/*}:predict"
...
def test_batch_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/models/*}:batchPredict"
            % client.transport._host,
            args[1],
        )
...
def test_prediction_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.automl_v1.services.prediction_service.transports.PredictionServiceTransport.__init__"
    ) as Transport:

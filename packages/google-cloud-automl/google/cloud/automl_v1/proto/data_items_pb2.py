...
Image = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      data:
          ...
          [image_bytes][google.cloud.automl.v1.Image.image_bytes] must
          be set .
      image_bytes:
...
Document = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        text_segment:
            ...
            le.cloud.automl.v1p1beta.Document.document_text].
        page_number:
            Page number of the [text_segment][google.cloud.automl.v1.Docum
            ent.Layout.text_segment] in the original document, starts from
            1.
        bounding_poly:
            The position of the [text_segment][google.cloud.automl.v1.Docu
            ment.Layout.text_segment] in the page. Contains exactly 4  [no
            rmalized_vertices][google.cloud.automl.v1p1beta.BoundingPoly.n
            ormalized_vertices] and they are connected by edges in the
            order provided, which will represent a rectangle parallel to
            the frame. The [NormalizedVertex-s][google.cloud.automl.v1p1be
            ta.NormalizedVertex] are relative to the page. Coordinates are
            based on top-left as point (0,0).
        text_segment_type:
            The type of the [text_segment][google.cloud.automl.v1.Document
            .Layout.text_segment] in document.
    """,

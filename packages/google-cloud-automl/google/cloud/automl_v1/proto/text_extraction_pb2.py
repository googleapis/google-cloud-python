...
_TEXTEXTRACTIONANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="text_segment",
            full_name="google.cloud.automl.v1.TextExtractionAnnotation.text_segment",
            index=0,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="score",
            full_name="google.cloud.automl.v1.TextExtractionAnnotation.score",
            index=1,
            number=1,
            type=2,
            cpp_type=6,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="annotation",
            full_name="google.cloud.automl.v1.TextExtractionAnnotation.annotation",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_TEXTEXTRACTIONEVALUATIONMETRICS_CONFIDENCEMETRICSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.automl.v1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.confidence_threshold",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="recall",
            full_name="google.cloud.automl.v1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.recall",
            index=1,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="precision",
            full_name="google.cloud.automl.v1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.precision",
            index=2,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="f1_score",
            full_name="google.cloud.automl.v1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.f1_score",
            index=3,
            number=5,
            type=2,
            cpp_type=6,
...
_TEXTEXTRACTIONEVALUATIONMETRICS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="au_prc",
            full_name="google.cloud.automl.v1.TextExtractionEvaluationMetrics.au_prc",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.automl.v1.TextExtractionEvaluationMetrics.confidence_metrics_entries",
            index=1,
            number=2,
            type=11,
            cpp_type=10,

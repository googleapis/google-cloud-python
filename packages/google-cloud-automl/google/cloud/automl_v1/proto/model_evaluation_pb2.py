...
ModelEvaluation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      annotation_spec_id:
          ...
          CLASSIFICATION  [prediction_type-s][google.cloud.automl.v1.Tab
          lesModelMetadata.prediction_type] the [display_name][google.cl
          oud.automl.v1.ModelEvaluation.display_name] field is used.
      display_name:
          Output only. The value of [display_name][google.cloud.automl.v
          1.AnnotationSpec.display_name] at the moment when the model
          ...
          CLASSIFICATION  [prediction_type-s][google.cloud.automl.v1.Tab
          lesModelMetadata.prediction_type] distinct values of the
      ...
      evaluated_example_count:
          ...
          the  [annotation_spec_id][google.cloud.automl.v1.ModelEvaluati
          on.annotation_spec_id].
  """,

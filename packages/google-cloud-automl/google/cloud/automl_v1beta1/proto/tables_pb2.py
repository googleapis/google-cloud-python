...
_TABLESANNOTATION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="baseline_score",
            full_name="google.cloud.automl.v1beta1.TablesAnnotation.baseline_score",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
...
TablesDatasetMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      ml_use_column_spec_id:
          ...
          time_column_spec_id are not set, then all rows are treated as
          ``UNASSIGNED``. NOTE: Updates of this field will instantly
          affect any other users concurrently working with the dataset.
      target_column_correlations:
          Output only. Correlations between  [TablesDatasetMetadata.targ
          et_column_spec_id][google.cloud.automl.v1beta1.TablesDatasetMe
          tadata.target_column_spec_id], and other columns of the  [Tabl
          esDatasetMetadataprimary_table][google.cloud.automl.v1beta1.Ta
          blesDatasetMetadata.primary_table_spec_id]. Only set if the
          target column is set. Mapping from other column spec id to its
          CorrelationStats with the target column. This field may be
          stale, see the stats_update_time field for for the timestamp
          at which these stats were last updated.
      stats_update_time:
...
TablesModelMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      target_column_spec:
          ...
          target_column_spec_id of the dataset the model is trained from
          is used. If neither is set, CreateModel will error.
          display_name - Output only. data_type - Output only.
      input_feature_column_specs:
          Column specs of the dataset’s primary table’s columns, on
          which the model is trained and which are used as the input for
          predictions. The  [target_column][google.cloud.automl.v1beta1.
          TablesModelMetadata.target_column_spec] as well as, according
          to dataset’s state upon model creation,  [weight_column][googl
          e.cloud.automl.v1beta1.TablesDatasetMetadata.weight_column_spe
          c_id], and  [ml_use_column][google.cloud.automl.v1beta1.Tables
          DatasetMetadata.ml_use_column_spec_id] must never be included
          here.  Only 3 fields are used:  -  name - May be set on
          CreateModel, if set only the columns specified    are used,
          otherwise all primary table’s columns (except the ones
          listed above) are used for the training and prediction input.
          -  display_name - Output only.  -  data_type - Output only.
      optimization_objective:
          ...
          used.  CLASSIFICATION_BINARY: “MAXIMIZE_AU_ROC” (default) -
          Maximize the area under the receiver operating characteristic
          (ROC) curve. “MINIMIZE_LOG_LOSS” - Minimize log loss.
          “MAXIMIZE_AU_PRC” - Maximize the area under the precision-
          recall curve. “MAXIMIZE_PRECISION_AT_RECALL” - Maximize
          precision for a specified recall value.
          “MAXIMIZE_RECALL_AT_PRECISION” - Maximize recall for a
          specified precision value.  CLASSIFICATION_MULTI_CLASS :
          “MINIMIZE_LOG_LOSS” (default) - Minimize log loss.
          REGRESSION: “MINIMIZE_RMSE” (default) - Minimize root-mean-
          squared error (RMSE). “MINIMIZE_MAE” - Minimize mean-absolute
          error (MAE). “MINIMIZE_RMSLE” - Minimize root-mean-squared log
          error (RMSLE).
      tables_model_column_info:
...
TablesAnnotation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      score:
          ...
          returned value. For  [target_column_spec][google.cloud.automl.
          v1beta1.TablesModelMetadata.target_column_spec] of FLOAT64
          data type the score is not populated.
      prediction_interval:
          Output only. Only populated when  [target_column_spec][google.
          cloud.automl.v1beta1.TablesModelMetadata.target_column_spec]
          has FLOAT64 data type. An interval in which the exactly
          correct target value has 95% chance to be in.
      value:
          The predicted value of the row’s  [target_column][google.cloud
          .automl.v1beta1.TablesModelMetadata.target_column_spec]. The
          value depends on the column’s DataType:  -  CATEGORY - the
      ...
      baseline_score:
          Output only. Stores the prediction score for the baseline
          example, which is defined as the example with all values set
          to their baseline values. This is used as part of the Sampled
          Shapley explanation of the model’s prediction. This field is
          populated only when feature importance is requested. For
          regression models, this holds the baseline prediction for the
          baseline example. For classification models, this holds the
          baseline prediction for the baseline example for the argmax
          class.
  """,
...
TablesModelColumnInfo = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      feature_importance:
          ...
          set) or Batch Predict (populated iff [feature_importance][goog
          le.cloud.automl.v1beta1.PredictRequest.params] param is set):

...
_AUTOML = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            output_type=google_dot_cloud_dot_automl__v1beta1_dot_proto_dot_dataset__pb2._ANNOTATIONSPEC,
            serialized_options=_b(

...
ModelEvaluation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      annotation_spec_id:
          ...
          CLASSIFICATION  [prediction_type-s][google.cloud.automl.v1beta
          1.TablesModelMetadata.prediction_type] the [display_name][goog
          le.cloud.automl.v1beta1.ModelEvaluation.display_name] field is
          used.
      display_name:
          Output only. The value of [display_name][google.cloud.automl.v
          1beta1.AnnotationSpec.display_name] at the moment when the
          ...
          CLASSIFICATION  [prediction_type-s][google.cloud.automl.v1beta
          1.TablesModelMetadata.prediction_type] distinct values of the
          target column at the moment of the model evaluation are
          populated here. The display_name is empty for the overall
          model evaluation.
      create_time:
      ...
      evaluated_example_count:
          ...
          the  [annotation_spec_id][google.cloud.automl.v1beta1.ModelEva
          luation.annotation_spec_id].
  """,

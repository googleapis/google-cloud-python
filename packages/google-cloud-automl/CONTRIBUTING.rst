...
instead of
``https://github.com/googleapis/python-automl/blob/main/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-automl/blob/main/packages/google-cloud-automl/noxfile.py

...
class IDSGrpcAsyncIOTransport(IDSTransport):
    ...
    @property
    def list_endpoints(self) -> Callable[[ids.ListEndpointsRequest], Awaitable[ids.ListEndpointsResponse]]:
    ...
    @property
    def get_endpoint(self) -> Callable[[ids.GetEndpointRequest], Awaitable[ids.Endpoint]]:
    ...
    @property
    def create_endpoint(self) -> Callable[[ids.CreateEndpointRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_endpoint(self) -> Callable[[ids.DeleteEndpointRequest], Awaitable[operations_pb2.Operation]]:
...
__all__ = ("IDSGrpcAsyncIOTransport",)

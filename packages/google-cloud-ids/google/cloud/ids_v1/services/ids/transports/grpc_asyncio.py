...
class IDSGrpcAsyncIOTransport(IDSTransport):
    ...
    def list_endpoints(
        self,
    ) -> Callable[[ids.ListEndpointsRequest], Awaitable[ids.ListEndpointsResponse]]:
    ...
    def get_endpoint(
        self,
    ) -> Callable[[ids.GetEndpointRequest], Awaitable[ids.Endpoint]]:
    ...
    def create_endpoint(
        self,
    ) -> Callable[[ids.CreateEndpointRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def delete_endpoint(
        self,
    ) -> Callable[[ids.DeleteEndpointRequest], Awaitable[operations_pb2.Operation]]:

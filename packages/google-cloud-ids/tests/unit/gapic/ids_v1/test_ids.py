...
def test_ids_client_from_service_account_info(client_class):
    ...
    with mock.patch.object(
        ...
        assert client.transport._host == "ids.googleapis.com:443"
...
def test_list_endpoints(transport: str = "grpc", request_type=ids.ListEndpointsRequest):
    client = IDSClient(
...
def test_get_endpoint(transport: str = "grpc", request_type=ids.GetEndpointRequest):
    client = IDSClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_create_endpoint(
    transport: str = "grpc", request_type=ids.CreateEndpointRequest
):
    client = IDSClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_delete_endpoint(
    transport: str = "grpc", request_type=ids.DeleteEndpointRequest
):
    client = IDSClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_ids_host_with_port():
    ...
    assert client.transport._host == "ids.googleapis.com:8000"

...
from .transports.grpc import KeyTrackingServiceGrpcTransport
from .transports.grpc_asyncio import KeyTrackingServiceGrpcAsyncIOTransport
from .transports.rest import KeyTrackingServiceRestTransport


class KeyTrackingServiceClientMeta(type):
    """Metaclass for the KeyTrackingService client.
...
class KeyTrackingServiceClient(metaclass=KeyTrackingServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            KeyTrackingServiceClient: The constructed client.
        """
    ...
    def transport(self) -> KeyTrackingServiceTransport:
        ...
        Returns:
            KeyTrackingServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def protected_resources_summary_path(
        project: str,
        location: str,
        key_ring: str,
        crypto_key: str,
    ) -> str:
        """Returns a fully-qualified protected_resources_summary string."""
        return "projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/protectedResourcesSummary".format(
            project=project,
            location=location,
            key_ring=key_ring,
            crypto_key=crypto_key,
    ...
    @staticmethod
    def parse_protected_resources_summary_path(path: str) -> Dict[str, str]:
        """Parses a protected_resources_summary path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/keyRings/(?P<key_ring>.+?)/cryptoKeys/(?P<crypto_key>.+?)/protectedResourcesSummary$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, KeyTrackingServiceTransport]] = None,
        ...
        if isinstance(transport, KeyTrackingServiceTransport):
            # transport is a KeyTrackingServiceTransport instance.
    ...
    def get_protected_resources_summary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.kms.inventory_v1.types.GetProtectedResourcesSummaryRequest, dict]):
        ...
        # in a key_tracking_service.GetProtectedResourcesSummaryRequest.
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_protected_resources_summary
        ]
    ...
    def search_protected_resources(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, str]] = (),
    ) -> pagers.SearchProtectedResourcesPager:
        ...
        Args:
            request (Union[google.cloud.kms.inventory_v1.types.SearchProtectedResourcesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.kms.inventory_v1.services.key_tracking_service.pagers.SearchProtectedResourcesPager:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a key_tracking_service.SearchProtectedResourcesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.search_protected_resources
        ]
        ...
        response = pagers.SearchProtectedResourcesPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def __enter__(self) -> "KeyTrackingServiceClient":
        return self
...
__all__ = ("KeyTrackingServiceClient",)

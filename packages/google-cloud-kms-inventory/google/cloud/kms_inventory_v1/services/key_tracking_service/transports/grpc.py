...
class KeyTrackingServiceGrpcTransport(KeyTrackingServiceTransport):
    """gRPC backend transport for KeyTrackingService.
    ...
    def get_protected_resources_summary(
        ...
        r"""Return a callable for the get protected resources
        ...
        if "get_protected_resources_summary" not in self._stubs:
            self._stubs["get_protected_resources_summary"] = self._logged_channel.unary_unary(
    ...
    def search_protected_resources(
        ...
        r"""Return a callable for the search protected resources method over gRPC.
        ...
        if "search_protected_resources" not in self._stubs:
            self._stubs["search_protected_resources"] = self._logged_channel.unary_unary(
...
__all__ = ("KeyTrackingServiceGrpcTransport",)

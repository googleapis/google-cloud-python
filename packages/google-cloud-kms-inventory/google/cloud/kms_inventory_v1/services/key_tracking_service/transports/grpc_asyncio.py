...
class KeyTrackingServiceGrpcAsyncIOTransport(KeyTrackingServiceTransport):
    ...
    def get_protected_resources_summary(
        self,
    ) -> Callable[[key_tracking_service.GetProtectedResourcesSummaryRequest], Awaitable[key_tracking_service.ProtectedResourcesSummary]]:
    ...
    def search_protected_resources(
        self,
    ) -> Callable[[key_tracking_service.SearchProtectedResourcesRequest], Awaitable[key_tracking_service.SearchProtectedResourcesResponse]]:

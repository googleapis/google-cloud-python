...
class KeyTrackingServiceClient(metaclass=KeyTrackingServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = KeyTrackingServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = KeyTrackingServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = KeyTrackingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = KeyTrackingServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, KeyTrackingServiceTransport, Callable[..., KeyTrackingServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = KeyTrackingServiceClient._read_environment_variables()
        self._client_cert_source = KeyTrackingServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = KeyTrackingServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, KeyTrackingServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(KeyTrackingServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or KeyTrackingServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[KeyTrackingServiceTransport], Callable[..., KeyTrackingServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.kms.inventory_v1.KeyTrackingServiceClient`.",
                    extra={
    ...
    def get_protected_resources_summary(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.kms_inventory_v1.types.GetProtectedResourcesSummaryRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_protected_resources_summary]
    ...
    def search_protected_resources(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.kms_inventory_v1.types.SearchProtectedResourcesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.kms_inventory_v1.services.key_tracking_service.pagers.SearchProtectedResourcesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_protected_resources]

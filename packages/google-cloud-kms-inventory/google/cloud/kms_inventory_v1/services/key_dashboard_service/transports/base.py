...
class KeyDashboardServiceTransport(abc.ABC):
    """Abstract transport class for KeyDashboardService."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "kmsinventory.googleapis.com"
    ...
    def list_crypto_keys(
        ...
        Union[key_dashboard_service.ListCryptoKeysResponse, Awaitable[key_dashboard_service.ListCryptoKeysResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("KeyDashboardServiceTransport",)

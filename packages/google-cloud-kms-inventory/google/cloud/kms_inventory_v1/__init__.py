...
__lazy_modules__ = {
    "google.cloud.kms_inventory_v1.services.key_dashboard_service",
    "google.cloud.kms_inventory_v1.services.key_tracking_service",
    "google.cloud.kms_inventory_v1.types.key_dashboard_service",
    "google.cloud.kms_inventory_v1.types.key_tracking_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.kms_inventory_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.kms_inventory_v1")  # type: ignore

...
def test_get_protected_resources_summary_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetProtectedResourcesSummary,
        "_BaseGetProtectedResourcesSummary__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
    ...
    assert not set(unset_fields) - set(("fallbackScope",))
...
def test_search_protected_resources_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSearchProtectedResources,
        "_BaseSearchProtectedResources__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

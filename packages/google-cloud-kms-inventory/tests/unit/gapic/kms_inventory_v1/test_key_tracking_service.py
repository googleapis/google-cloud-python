...
from google.cloud.kms_inventory_v1.services.key_tracking_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        KeyTrackingServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        KeyTrackingServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        KeyTrackingServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        KeyTrackingServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        KeyTrackingServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
def test__get_client_cert_source():
    ...
    assert (
        KeyTrackingServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                KeyTrackingServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(KeyTrackingServiceClient),
)
@mock.patch.object(
    KeyTrackingServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(KeyTrackingServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = KeyTrackingServiceClient._DEFAULT_UNIVERSE
    default_endpoint = KeyTrackingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = KeyTrackingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        KeyTrackingServiceClient._get_api_endpoint(
    ...
    assert (
        KeyTrackingServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        KeyTrackingServiceClient._get_api_endpoint(
    ...
    assert (
        KeyTrackingServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        KeyTrackingServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        KeyTrackingServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        KeyTrackingServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        KeyTrackingServiceClient._get_universe_domain(None, None)
        == KeyTrackingServiceClient._DEFAULT_UNIVERSE
    )
...
def test_key_tracking_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_key_tracking_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    KeyTrackingServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(KeyTrackingServiceClient),
)
@mock.patch.object(
    KeyTrackingServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(KeyTrackingServiceAsyncClient),
)
...
def test_key_tracking_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_key_tracking_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_key_tracking_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_protected_resources_summary_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.get_protected_resources_summary
...
@pytest.mark.asyncio
async def test_get_protected_resources_summary_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_protected_resources_summary
...
def test_search_protected_resources_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.search_protected_resources
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_search_protected_resources_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.search_protected_resources
            in client._client._transport._wrapped_methods
        )
...
def test_search_protected_resources_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.search_protected_resources(
        ...
        assert all(
            isinstance(i, key_tracking_service.ProtectedResource) for i in results
        )
...
async def test_search_protected_resources_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.search_protected_resources),
        "__call__",
        ...
        assert all(
            isinstance(i, key_tracking_service.ProtectedResource) for i in responses
        )
...
def test_get_protected_resources_summary_rest_required_fields(
    request_type=key_tracking_service.GetProtectedResourcesSummaryRequest,
):
...
def test_get_protected_resources_summary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/keyRings/*/cryptoKeys/**}/protectedResourcesSummary"
...
def test_search_protected_resources_rest_required_fields(
    request_type=key_tracking_service.SearchProtectedResourcesRequest,
):
    transport_class = transports.KeyTrackingServiceRestTransport
...
def test_search_protected_resources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{scope=organizations/*}/protectedResources:search"
            % client.transport._host,
            args[1],
        )
...
def test_search_protected_resources_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            key_tracking_service.SearchProtectedResourcesResponse.to_json(x)
            for x in response
        )
...
def test_transport_kind_grpc_asyncio():
    transport = KeyTrackingServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = KeyTrackingServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_get_protected_resources_summary_rest_bad_request(
    request_type=key_tracking_service.GetProtectedResourcesSummaryRequest,
):
    client = KeyTrackingServiceClient(
...
def test_get_protected_resources_summary_rest_interceptors(null_interceptor):
    transport = transports.KeyTrackingServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.KeyTrackingServiceRestInterceptor(),
    )
    client = KeyTrackingServiceClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.KeyTrackingServiceRestInterceptor,
        "post_get_protected_resources_summary",
    ) as post, mock.patch.object(
        transports.KeyTrackingServiceRestInterceptor,
        "post_get_protected_resources_summary_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.KeyTrackingServiceRestInterceptor,
        "pre_get_protected_resources_summary",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = key_tracking_service.GetProtectedResourcesSummaryRequest.pb(
            key_tracking_service.GetProtectedResourcesSummaryRequest()
        )
...
def test_search_protected_resources_rest_bad_request(
    request_type=key_tracking_service.SearchProtectedResourcesRequest,
):
    client = KeyTrackingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_search_protected_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.KeyTrackingServiceRestInterceptor, "post_search_protected_resources"
    ) as post, mock.patch.object(
        transports.KeyTrackingServiceRestInterceptor,
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = key_tracking_service.SearchProtectedResourcesRequest.pb(
            key_tracking_service.SearchProtectedResourcesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_key_tracking_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.kms_inventory_v1.services.key_tracking_service.transports.KeyTrackingServiceTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [
        (transports.KeyTrackingServiceGrpcTransport, grpc_helpers),
        (transports.KeyTrackingServiceGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_key_tracking_service_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_key_tracking_service_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_crypto_key_version_path():
    ...
    actual = KeyTrackingServiceClient.crypto_key_version_path(
...
def test_protected_resources_summary_path():
    ...
    actual = KeyTrackingServiceClient.protected_resources_summary_path(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.KeyTrackingServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = KeyTrackingServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

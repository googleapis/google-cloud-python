...
from google.cloud.kms.inventory_v1.services.key_tracking_service import (
...
def test_key_tracking_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.kms.inventory_v1.services.key_tracking_service.transports.KeyTrackingServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_key_tracking_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.kms.inventory_v1.services.key_tracking_service.transports.KeyTrackingServiceTransport.__init__"
    ) as Transport:
...
def test_key_tracking_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.kms.inventory_v1.services.key_tracking_service.transports.KeyTrackingServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

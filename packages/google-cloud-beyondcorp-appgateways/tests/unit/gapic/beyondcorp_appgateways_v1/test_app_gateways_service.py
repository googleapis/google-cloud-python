...
def test_list_app_gateways_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAppGateways,
        "_BaseListAppGateways__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_get_app_gateway_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetAppGateway,
        "_BaseGetAppGateway__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_app_gateway_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateAppGateway,
        "_BaseCreateAppGateway__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_app_gateway_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteAppGateway,
        "_BaseDeleteAppGateway__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

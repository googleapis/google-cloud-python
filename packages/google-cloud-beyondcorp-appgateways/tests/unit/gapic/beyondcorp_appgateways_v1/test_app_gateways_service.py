...
def test__read_environment_variables():
    assert AppGatewaysServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert AppGatewaysServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            with pytest.raises(ValueError) as excinfo:
                AppGatewaysServiceClient._read_environment_variables()
            assert str(excinfo.value) == "Environment variable `GOOGLE_API_USE_CLIENT_CERTIFICATE` must be either `true` or `false`"
        else:
            assert AppGatewaysServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert AppGatewaysServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert AppGatewaysServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert AppGatewaysServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AppGatewaysServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AppGatewaysServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AppGatewaysServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert AppGatewaysServiceClient._get_client_cert_source(None, False) is None
    assert AppGatewaysServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert AppGatewaysServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert AppGatewaysServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert AppGatewaysServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(AppGatewaysServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppGatewaysServiceClient))
@mock.patch.object(AppGatewaysServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppGatewaysServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AppGatewaysServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AppGatewaysServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = AppGatewaysServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert AppGatewaysServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        AppGatewaysServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == AppGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert AppGatewaysServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert AppGatewaysServiceClient._get_api_endpoint(None, None, default_universe, "always") == AppGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        AppGatewaysServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AppGatewaysServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert AppGatewaysServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert AppGatewaysServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        AppGatewaysServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert AppGatewaysServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert AppGatewaysServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert AppGatewaysServiceClient._get_universe_domain(None, None) == AppGatewaysServiceClient._DEFAULT_UNIVERSE
...
@mock.patch.object(AppGatewaysServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppGatewaysServiceClient))
@mock.patch.object(AppGatewaysServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AppGatewaysServiceAsyncClient))
def test_app_gateways_service_client_client_api_endpoint(client_class):
...
def test_list_app_gateways_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_app_gateways), "__call__") as call:
        ...
        client.list_app_gateways(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_list_app_gateways_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_app_gateways in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_app_gateways] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_app_gateways_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_app_gateways in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_app_gateways] = mock_rpc
...
def test_list_app_gateways_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_app_gateways), "__call__") as call:
        ...
        pager = client.list_app_gateways(request={}, retry=retry, timeout=timeout)
...
def test_get_app_gateway_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get_app_gateway), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.get_app_gateway(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_get_app_gateway_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_app_gateway in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_app_gateway] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_app_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_app_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_app_gateway] = mock_rpc
...
def test_create_app_gateway_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.create_app_gateway), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.create_app_gateway(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_create_app_gateway_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_app_gateway in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_app_gateway] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_app_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_app_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_app_gateway] = mock_rpc
...
def test_delete_app_gateway_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.delete_app_gateway), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.delete_app_gateway(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
...
def test_delete_app_gateway_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_app_gateway in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_app_gateway] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_app_gateway_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_app_gateway in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_app_gateway] = mock_rpc
...
def test_list_app_gateways_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
...
def test_get_app_gateway_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
...
def test_create_app_gateway_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
...
def test_delete_app_gateway_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = AppGatewaysServiceClient(
...
def test_transport_kind_grpc():
    transport = AppGatewaysServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_app_gateways_empty_call_grpc():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_app_gateways), "__call__") as call:
        call.return_value = app_gateways_service.ListAppGatewaysResponse()
        client.list_app_gateways(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_app_gateway_empty_call_grpc():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_app_gateway), "__call__") as call:
        call.return_value = app_gateways_service.AppGateway()
        client.get_app_gateway(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = app_gateways_service.GetAppGatewayRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_app_gateway_empty_call_grpc():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_app_gateway), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_app_gateway(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = app_gateways_service.CreateAppGatewayRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_app_gateway_empty_call_grpc():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_app_gateway), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_app_gateway(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = app_gateways_service.DeleteAppGatewayRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = AppGatewaysServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AppGatewaysServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_app_gateways_empty_call_grpc_asyncio():
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.list_app_gateways), "__call__") as call:
        ...
        await client.list_app_gateways(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_app_gateway_empty_call_grpc_asyncio():
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_app_gateway_empty_call_grpc_asyncio():
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_app_gateway), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_app_gateway(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_app_gateway_empty_call_grpc_asyncio():
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_app_gateway), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_app_gateway(request=None)
...
def test_transport_kind_rest():
    transport = AppGatewaysServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_app_gateways_rest_bad_request(request_type=app_gateways_service.ListAppGatewaysRequest):
...
def test_list_app_gateways_rest_call_success(request_type):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_app_gateways_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_list_app_gateways") as post, mock.patch.object(
        transports.AppGatewaysServiceRestInterceptor, "post_list_app_gateways_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_gateways_service.ListAppGatewaysResponse.to_json(app_gateways_service.ListAppGatewaysResponse())
        ...
        post_with_metadata.return_value = app_gateways_service.ListAppGatewaysResponse(), metadata
...
def test_get_app_gateway_rest_bad_request(request_type=app_gateways_service.GetAppGatewayRequest):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_app_gateway_rest_call_success(request_type):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_get_app_gateway") as post, mock.patch.object(
        transports.AppGatewaysServiceRestInterceptor, "post_get_app_gateway_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_gateways_service.AppGateway.to_json(app_gateways_service.AppGateway())
        req.return_value.content = return_value
...
def test_create_app_gateway_rest_bad_request(request_type=app_gateways_service.CreateAppGatewayRequest):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_app_gateway_rest_call_success(request_type):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    for field, value in request_init["app_gateway"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
...
def test_create_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AppGatewaysServiceRestInterceptor, "post_create_app_gateway_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_app_gateway_rest_bad_request(request_type=app_gateways_service.DeleteAppGatewayRequest):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/appGateways/sample3"}
    request = request_type(**request_init)
...
def test_delete_app_gateway_rest_call_success(request_type):
    client = AppGatewaysServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AppGatewaysServiceRestInterceptor, "post_delete_app_gateway_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_app_gateways_empty_call_rest():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_app_gateway_empty_call_rest():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_app_gateway_empty_call_rest():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_app_gateway_empty_call_rest():
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.AppGatewaysServiceGrpcTransport, grpc_helpers), (transports.AppGatewaysServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_app_gateway_path():
    ...
    location = "clam"
    app_gateway = "whelk"
    expected = "projects/{project}/locations/{location}/appGateways/{app_gateway}".format(
        project=project,
        location=location,
...
async def test_get_location_field_headers_async():
    client = AppGatewaysServiceAsyncClient(credentials=async_anonymous_credentials())

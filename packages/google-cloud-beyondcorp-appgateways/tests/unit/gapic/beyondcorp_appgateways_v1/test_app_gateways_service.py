...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AppGatewaysServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        AppGatewaysServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AppGatewaysServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AppGatewaysServiceClient),
)
@mock.patch.object(
    AppGatewaysServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AppGatewaysServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AppGatewaysServiceClient._DEFAULT_UNIVERSE
    default_endpoint = AppGatewaysServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AppGatewaysServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        AppGatewaysServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        AppGatewaysServiceClient._get_api_endpoint(
    ...
    assert (
        AppGatewaysServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AppGatewaysServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        AppGatewaysServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AppGatewaysServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AppGatewaysServiceClient._get_universe_domain(None, None)
        == AppGatewaysServiceClient._DEFAULT_UNIVERSE
    )
...
def test_list_app_gateways_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_app_gateways] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_app_gateways_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_app_gateways
...
async def test_list_app_gateways_async(request_type, transport: str = "grpc_asyncio"):
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_app_gateway_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_app_gateway
            in client._client._transport._wrapped_methods
        )
...
async def test_get_app_gateway_async(request_type, transport: str = "grpc_asyncio"):
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_app_gateway_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_app_gateway in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.create_app_gateway] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_app_gateway_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_app_gateway
            in client._client._transport._wrapped_methods
        )
...
async def test_create_app_gateway_async(request_type, transport: str = "grpc_asyncio"):
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_app_gateway_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_app_gateway in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_app_gateway] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_app_gateway_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_app_gateway
            in client._client._transport._wrapped_methods
        )
...
async def test_delete_app_gateway_async(request_type, transport: str = "grpc_asyncio"):
    client = AppGatewaysServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc_asyncio():
    transport = AppGatewaysServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = AppGatewaysServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_app_gateways_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_gateways_service.ListAppGatewaysResponse.to_json(
            app_gateways_service.ListAppGatewaysResponse()
        )
...
def test_get_app_gateway_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = app_gateways_service.AppGateway.to_json(
            app_gateways_service.AppGateway()
        )
        req.return_value.content = return_value

...
__lazy_modules__ = {
    "google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service",
    "google.cloud.beyondcorp_appgateways_v1.types.app_gateways_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.beyondcorp_appgateways_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.beyondcorp_appgateways_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.beyondcorp_appgateways_v1"

...
class AppGatewaysServiceClient(metaclass=AppGatewaysServiceClientMeta):
    ...
    def app_gateway_path(
        ...
        return "projects/{project}/locations/{location}/appGateways/{app_gateway}".format(
            project=project,
            location=location,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or AppGatewaysServiceClient._get_api_endpoint(

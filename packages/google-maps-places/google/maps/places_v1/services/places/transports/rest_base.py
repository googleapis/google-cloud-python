...
class _BasePlacesRestTransport(PlacesTransport):
    ...
    class _BaseAutocompletePlaces:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePlacesRestTransport._BaseAutocompletePlaces._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetPhotoMedia:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePlacesRestTransport._BaseGetPhotoMedia._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetPlace:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePlacesRestTransport._BaseGetPlace._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseSearchNearby:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePlacesRestTransport._BaseSearchNearby._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseSearchText:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePlacesRestTransport._BaseSearchText._get_unset_required_fields(
                    query_params
                )
            )

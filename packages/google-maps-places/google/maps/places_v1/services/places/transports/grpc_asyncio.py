...
class PlacesGrpcAsyncIOTransport(PlacesTransport):
    ...
    @property
    def search_nearby(self) -> Callable[[places_service.SearchNearbyRequest], Awaitable[places_service.SearchNearbyResponse]]:
    ...
    @property
    def search_text(self) -> Callable[[places_service.SearchTextRequest], Awaitable[places_service.SearchTextResponse]]:
    ...
    @property
    def get_photo_media(self) -> Callable[[places_service.GetPhotoMediaRequest], Awaitable[places_service.PhotoMedia]]:
    ...
    @property
    def get_place(self) -> Callable[[places_service.GetPlaceRequest], Awaitable[place.Place]]:
    ...
    @property
    def autocomplete_places(self) -> Callable[[places_service.AutocompletePlacesRequest], Awaitable[places_service.AutocompletePlacesResponse]]:

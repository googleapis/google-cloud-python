...
from .transports.grpc import PlacesGrpcTransport
from .transports.grpc_asyncio import PlacesGrpcAsyncIOTransport
from .transports.rest import PlacesRestTransport


class PlacesClientMeta(type):
    """Metaclass for the Places client.
...
class PlacesClient(metaclass=PlacesClientMeta):
    ...
    DEFAULT_ENDPOINT = "places.googleapis.com"
    DEFAULT_MTLS_ENDPOINT = _get_default_mtls_endpoint.__func__(DEFAULT_ENDPOINT)  # type: ignore

    _DEFAULT_ENDPOINT_TEMPLATE = "places.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PlacesClient: The constructed client.
        """
    ...
    def transport(self) -> PlacesTransport:
        ...
        Returns:
            PlacesTransport: The transport used by the client
                instance.
        """
    ...
    def photo_path(
        ...
        """Returns a fully-qualified photo string."""
        return "places/{place}/photos/{photo}".format(
            place=place,
            photo=photo,
        )

    @staticmethod
    def parse_photo_path(path: str) -> Dict[str, str]:
        """Parses a photo path into its component segments."""
        m = re.match(r"^places/(?P<place>.+?)/photos/(?P<photo>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def photo_media_path(
        place_id: str,
        photo_reference: str,
    ) -> str:
        """Returns a fully-qualified photo_media string."""
        return "places/{place_id}/photos/{photo_reference}/media".format(
            place_id=place_id,
            photo_reference=photo_reference,
        )

    @staticmethod
    def parse_photo_media_path(path: str) -> Dict[str, str]:
        """Parses a photo_media path into its component segments."""
        m = re.match(r"^places/(?P<place_id>.+?)/photos/(?P<photo_reference>.+?)/media$", path)
        return m.groupdict() if m else {}
    ...
    def review_path(
        ...
        """Returns a fully-qualified review string."""
        return "places/{place}/reviews/{review}".format(
            place=place,
            review=review,
        )

    @staticmethod
    def parse_review_path(path: str) -> Dict[str, str]:
        """Parses a review path into its component segments."""
        m = re.match(r"^places/(?P<place>.+?)/reviews/(?P<review>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = PlacesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PlacesClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = PlacesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, PlacesTransport, Callable[..., PlacesTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PlacesClient._read_environment_variables()
        self._client_cert_source = PlacesClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PlacesClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, PlacesTransport)
        if transport_provided:
            # transport is a PlacesTransport instance.
            ...
            self._transport = cast(PlacesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or PlacesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PlacesTransport], Callable[..., PlacesTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.maps.places_v1.PlacesClient`.",
                    extra={
    ...
    def search_nearby(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.search_nearby]
    ...
    def search_text(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_text]
    ...
    def get_photo_media(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_photo_media]
    ...
    def get_place(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_place]

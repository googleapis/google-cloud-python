...
class PlacesClient(metaclass=PlacesClientMeta):
    ...
    def parse_photo_media_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^places/(?P<place_id>.+?)/photos/(?P<photo_reference>.+?)/media$", path
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PlacesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or PlacesClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, PlacesTransport]] = None,
        ...
        self._client_cert_source = PlacesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PlacesClient._get_universe_domain(
    ...
    def search_nearby(
        ...
        *,
        ...
        # in a places_service.SearchNearbyRequest.
    ...
    def search_text(
        ...
        *,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a places_service.SearchTextRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_photo_media(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a places_service.GetPhotoMediaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_place(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a places_service.GetPlaceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

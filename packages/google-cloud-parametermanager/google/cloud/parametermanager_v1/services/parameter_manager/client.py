...
class ParameterManagerClient(metaclass=ParameterManagerClientMeta):
    ...
    def parse_parameter_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/parameters/(?P<parameter>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_parameter_version_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/parameters/(?P<parameter>.+?)/versions/(?P<parameter_version>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ParameterManagerClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ParameterManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ParameterManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ParameterManagerClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ParameterManagerTransport, Callable[..., ParameterManagerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ParameterManagerClient._read_environment_variables()
        self._client_cert_source = ParameterManagerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ParameterManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ParameterManagerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ParameterManagerTransport], Callable[..., ParameterManagerTransport]] = (

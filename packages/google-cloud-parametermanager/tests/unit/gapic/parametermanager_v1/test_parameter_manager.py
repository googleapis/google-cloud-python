...
from google.cloud.parametermanager_v1.services.parameter_manager import ParameterManagerAsyncClient, ParameterManagerClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        ParameterManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        ParameterManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ParameterManagerClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_parameter_manager_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "parametermanager.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://parametermanager.googleapis.com"
        )
...
@pytest.mark.parametrize("client_class", [ParameterManagerClient, ParameterManagerAsyncClient])
...
def test_parameter_manager_client_client_options_from_dict():
    with mock.patch(
        ...
        client = ParameterManagerClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
async def test_list_parameters_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_parameters), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            service.ListParametersResponse(
                parameters=[
...
async def test_list_parameters_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_parameters), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_parameters(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_parameter_versions(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_parameter_versions), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_parameter_versions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_parameter_versions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            service.ListParameterVersionsResponse(
                parameter_versions=[
...
async def test_list_parameter_versions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_parameter_versions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_parameter_versions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_parameter_version(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_parameter_version), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_render_parameter_version(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.render_parameter_version), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_parameter_version(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_parameter_version), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.ParameterVersion(
            name="name_value",
            disabled=True,
...
def test_update_parameter_version(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_parameter_version), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = service.ParameterVersion(
            name="name_value",
            disabled=True,
...
def test_delete_parameter_version(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_parameter_version), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_parameter_versions_rest_required_fields(request_type=service.ListParameterVersionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_parameter_versions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_parameter_version_rest_required_fields(request_type=service.GetParameterVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_parameter_version._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_render_parameter_version_rest_required_fields(request_type=service.RenderParameterVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).render_parameter_version._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_parameter_version_rest_required_fields(request_type=service.CreateParameterVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_parameter_version._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_parameter_version_rest_required_fields(request_type=service.UpdateParameterVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_parameter_version._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_parameter_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parameter_version.name=projects/*/locations/*/parameters/*/versions/*}" % client.transport._host, args[1]
        )
...
def test_delete_parameter_version_rest_required_fields(request_type=service.DeleteParameterVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_parameter_version._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ParameterManagerClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ParameterManagerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ParameterManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = ParameterManagerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ParameterManagerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ParameterManagerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_parameters_rest_bad_request(request_type=service.ListParametersRequest):
    client = ParameterManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_parameters_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_list_parameters") as post, mock.patch.object(
...
def test_get_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_get_parameter") as post, mock.patch.object(
...
def test_create_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_create_parameter") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_create_parameter_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_update_parameter") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_update_parameter_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_parameter_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_delete_parameter") as pre:
        pre.assert_not_called()
...
def test_list_parameter_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_list_parameter_versions") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_list_parameter_versions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_get_parameter_version") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_get_parameter_version_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_render_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_render_parameter_version") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_render_parameter_version_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_create_parameter_version") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_create_parameter_version_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "post_update_parameter_version") as post, mock.patch.object(
        transports.ParameterManagerRestInterceptor, "post_update_parameter_version_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_parameter_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ParameterManagerRestInterceptor, "pre_delete_parameter_version") as pre:
        pre.assert_not_called()
...
def test_parameter_manager_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ParameterManagerTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.ParameterManagerGrpcTransport, grpc_helpers), (transports.ParameterManagerGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_parameter_manager_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ParameterManagerRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_parameter_manager_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "parametermanager.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://parametermanager.googleapis.com:8000"
    )
...
@pytest.mark.parametrize("transport_class", [transports.ParameterManagerGrpcTransport, transports.ParameterManagerGrpcAsyncIOTransport])
def test_parameter_manager_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ParameterManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
class vmmigrationCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'cancel_disk_migration_job': ('name', ),
        'cancel_image_import_job': ('name', ),
        ...
        'create_disk_migration_job': ('parent', 'disk_migration_job_id', 'disk_migration_job', 'request_id', ),
        'create_group': ('parent', 'group_id', 'group', 'request_id', ),
        'create_image_import': ('parent', 'image_import_id', 'image_import', 'request_id', ),
        ...
        'delete_disk_migration_job': ('name', ),
        'delete_group': ('name', 'request_id', ),
        'delete_image_import': ('name', 'request_id', ),
        ...
        'extend_migration': ('migrating_vm', ),
        'fetch_inventory': ('source', 'force_refresh', ),
        'fetch_storage_inventory': ('source', 'type_', 'force_refresh', 'page_size', 'page_token', ),
        'finalize_migration': ('migrating_vm', ),
        'get_clone_job': ('name', ),
        'get_cutover_job': ('name', ),
        'get_datacenter_connector': ('name', ),
        'get_disk_migration_job': ('name', ),
        'get_group': ('name', ),
        'get_image_import': ('name', ),
        'get_image_import_job': ('name', ),
        'get_migrating_vm': ('name', 'view', ),
        'get_replication_cycle': ('name', ),
        'get_source': ('name', ),
        ...
        'list_disk_migration_jobs': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_groups': ('parent', 'page_token', 'page_size', 'filter', 'order_by', ),
        'list_image_import_jobs': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_image_imports': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        'list_migrating_vms': ('parent', 'page_token', 'page_size', 'filter', 'order_by', 'view', ),
        'list_replication_cycles': ('parent', 'page_token', 'page_size', 'filter', 'order_by', ),
        ...
        'run_disk_migration_job': ('name', ),
        'start_migration': ('migrating_vm', ),
        'update_disk_migration_job': ('disk_migration_job', 'update_mask', 'request_id', ),

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        WebRiskServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        WebRiskServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        WebRiskServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                WebRiskServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                WebRiskServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(WebRiskServiceClient),
)
@mock.patch.object(
    WebRiskServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(WebRiskServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WebRiskServiceClient._DEFAULT_UNIVERSE
    default_endpoint = WebRiskServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = WebRiskServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        WebRiskServiceClient._get_api_endpoint(
    ...
    assert (
        WebRiskServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        WebRiskServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == WebRiskServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        WebRiskServiceClient._get_api_endpoint(
    ...
    assert (
        WebRiskServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        WebRiskServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        WebRiskServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        WebRiskServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        WebRiskServiceClient._get_universe_domain(None, None)
        == WebRiskServiceClient._DEFAULT_UNIVERSE
    )
...
def test_compute_threat_list_diff_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.compute_threat_list_diff
...
def test_create_submission_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_submission] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_submission_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_submission
            in client._client._transport._wrapped_methods
        )
...
async def test_create_submission_async(request_type, transport: str = "grpc_asyncio"):
    client = WebRiskServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_submit_uri_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.submit_uri
            in client._client._transport._wrapped_methods
        )
...
async def test_submit_uri_async(request_type, transport: str = "grpc_asyncio"):
    client = WebRiskServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc_asyncio():
    transport = WebRiskServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = WebRiskServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )

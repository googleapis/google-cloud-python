...
def test__get_default_mtls_endpoint():
    ...
    assert (
        WebRiskServiceV1Beta1Client._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        WebRiskServiceV1Beta1Client._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                WebRiskServiceV1Beta1Client._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(WebRiskServiceV1Beta1Client),
)
@mock.patch.object(
    WebRiskServiceV1Beta1AsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(WebRiskServiceV1Beta1AsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WebRiskServiceV1Beta1Client._DEFAULT_UNIVERSE
    default_endpoint = WebRiskServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = WebRiskServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        WebRiskServiceV1Beta1Client._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        WebRiskServiceV1Beta1Client._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        WebRiskServiceV1Beta1Client._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        WebRiskServiceV1Beta1Client._get_universe_domain(None, None)
        == WebRiskServiceV1Beta1Client._DEFAULT_UNIVERSE
    )
...
def test_compute_threat_list_diff_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/threatLists:computeDiff" % client.transport._host, args[1]
        )
...
def test_search_uris_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/uris:search" % client.transport._host, args[1]
        )
...
def test_search_hashes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/hashes:search" % client.transport._host, args[1]
        )
...
def test_compute_threat_list_diff_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.WebRiskServiceV1Beta1RestInterceptor,
            "post_compute_threat_list_diff",
        ) as post,
        mock.patch.object(
            transports.WebRiskServiceV1Beta1RestInterceptor,

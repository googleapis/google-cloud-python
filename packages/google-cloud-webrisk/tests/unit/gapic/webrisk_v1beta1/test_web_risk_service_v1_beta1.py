...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert WebRiskServiceV1Beta1Client._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert WebRiskServiceV1Beta1Client._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert WebRiskServiceV1Beta1Client._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                WebRiskServiceV1Beta1Client._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        WebRiskServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == WebRiskServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        WebRiskServiceV1Beta1Client._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == WebRiskServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = WebRiskServiceV1Beta1Client.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = WebRiskServiceV1Beta1AsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = WebRiskServiceV1Beta1AsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = WebRiskServiceV1Beta1Client.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_compute_threat_list_diff_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_compute_threat_list_diff") as post, mock.patch.object(
        transports.WebRiskServiceV1Beta1RestInterceptor, "post_compute_threat_list_diff_with_metadata"
...
def test_search_uris_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_uris") as post, mock.patch.object(
        transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_uris_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_search_hashes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_hashes") as post, mock.patch.object(
        transports.WebRiskServiceV1Beta1RestInterceptor, "post_search_hashes_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.WebRiskServiceV1Beta1GrpcTransport, grpc_helpers), (transports.WebRiskServiceV1Beta1GrpcAsyncIOTransport, grpc_helpers_async)],
)

...
from .base import DEFAULT_CLIENT_INFO, WebRiskServiceV1Beta1Transport
...
class WebRiskServiceV1Beta1GrpcAsyncIOTransport(WebRiskServiceV1Beta1Transport):
    ...
    @property
    def compute_threat_list_diff(self) -> Callable[[webrisk.ComputeThreatListDiffRequest], Awaitable[webrisk.ComputeThreatListDiffResponse]]:
        ...
        if "compute_threat_list_diff" not in self._stubs:
            self._stubs["compute_threat_list_diff"] = self._logged_channel.unary_unary(
    ...
    @property
    def search_uris(self) -> Callable[[webrisk.SearchUrisRequest], Awaitable[webrisk.SearchUrisResponse]]:
        ...
        if "search_uris" not in self._stubs:
            self._stubs["search_uris"] = self._logged_channel.unary_unary(
    ...
    @property
    def search_hashes(self) -> Callable[[webrisk.SearchHashesRequest], Awaitable[webrisk.SearchHashesResponse]]:
        ...
        if "search_hashes" not in self._stubs:
            self._stubs["search_hashes"] = self._logged_channel.unary_unary(

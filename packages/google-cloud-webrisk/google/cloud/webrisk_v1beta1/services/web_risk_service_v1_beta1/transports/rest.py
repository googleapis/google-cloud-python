...
from .rest_base import _BaseWebRiskServiceV1Beta1RestTransport
...
class WebRiskServiceV1Beta1RestInterceptor:
    """Interceptor for WebRiskServiceV1Beta1.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the WebRiskServiceV1Beta1RestTransport.

    .. code-block:: python
        class MyCustomWebRiskServiceV1Beta1Interceptor(WebRiskServiceV1Beta1RestInterceptor):
        ...
        transport = WebRiskServiceV1Beta1RestTransport(interceptor=MyCustomWebRiskServiceV1Beta1Interceptor())
    ...
    def pre_compute_threat_list_diff(
        ...
        before they are sent to the WebRiskServiceV1Beta1 server.
        """
        return request, metadata
...
class WebRiskServiceV1Beta1RestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: WebRiskServiceV1Beta1RestInterceptor


class WebRiskServiceV1Beta1RestTransport(_BaseWebRiskServiceV1Beta1RestTransport):
    """REST backend synchronous transport for WebRiskServiceV1Beta1.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[WebRiskServiceV1Beta1RestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client.ComputeThreatListDiff",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client.compute_threat_list_diff",
                    extra={
                        "serviceName": "google.cloud.webrisk.v1beta1.WebRiskServiceV1Beta1",
                        "rpcName": "ComputeThreatListDiff",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client.SearchHashes",
                    extra={
                        "serviceName": "google.cloud.webrisk.v1beta1.WebRiskServiceV1Beta1",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client.search_hashes",
                    extra={
                        "serviceName": "google.cloud.webrisk.v1beta1.WebRiskServiceV1Beta1",
                        "rpcName": "SearchHashes",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client.SearchUris",
                    extra={
                        "serviceName": "google.cloud.webrisk.v1beta1.WebRiskServiceV1Beta1",
                        "rpcName": "SearchUris",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client.search_uris",
                    extra={
                        "serviceName": "google.cloud.webrisk.v1beta1.WebRiskServiceV1Beta1",
                        "rpcName": "SearchUris",
                        "metadata": http_response["headers"],

...
class WebRiskServiceV1Beta1RestTransport(WebRiskServiceV1Beta1Transport):
    """REST backend transport for WebRiskServiceV1Beta1.
    ...
    class _ComputeThreatListDiff(WebRiskServiceV1Beta1RestStub):
        def __hash__(self):
    ...
    class _SearchHashes(WebRiskServiceV1Beta1RestStub):
        def __hash__(self):
    ...
    class _SearchUris(WebRiskServiceV1Beta1RestStub):
        def __hash__(self):

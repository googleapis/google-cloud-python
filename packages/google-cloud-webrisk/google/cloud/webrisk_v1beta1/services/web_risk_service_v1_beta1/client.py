...
class WebRiskServiceV1Beta1Client(metaclass=WebRiskServiceV1Beta1ClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                WebRiskServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = WebRiskServiceV1Beta1Client._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = WebRiskServiceV1Beta1Client._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or WebRiskServiceV1Beta1Client._get_api_endpoint(

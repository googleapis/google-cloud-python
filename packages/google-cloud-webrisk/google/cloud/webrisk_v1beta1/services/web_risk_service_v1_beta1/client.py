...
class WebRiskServiceV1Beta1Client(metaclass=WebRiskServiceV1Beta1ClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = WebRiskServiceV1Beta1Client._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = WebRiskServiceV1Beta1Client.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = WebRiskServiceV1Beta1Client._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = WebRiskServiceV1Beta1Client._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, WebRiskServiceV1Beta1Transport, Callable[..., WebRiskServiceV1Beta1Transport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = WebRiskServiceV1Beta1Client._read_environment_variables()
        self._client_cert_source = WebRiskServiceV1Beta1Client._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = WebRiskServiceV1Beta1Client._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, WebRiskServiceV1Beta1Transport)
        if transport_provided:
            ...
            self._transport = cast(WebRiskServiceV1Beta1Transport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or WebRiskServiceV1Beta1Client._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[WebRiskServiceV1Beta1Transport], Callable[..., WebRiskServiceV1Beta1Transport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.webrisk_v1beta1.WebRiskServiceV1Beta1Client`.",
                    extra={

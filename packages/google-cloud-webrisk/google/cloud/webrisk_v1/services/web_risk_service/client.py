...
class WebRiskServiceClient(metaclass=WebRiskServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = WebRiskServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, WebRiskServiceTransport, Callable[..., WebRiskServiceTransport]]
        ] = None,
        ...
        self._universe_domain = WebRiskServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or WebRiskServiceClient._get_api_endpoint(

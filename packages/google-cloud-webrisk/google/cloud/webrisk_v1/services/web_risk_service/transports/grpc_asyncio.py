...
class WebRiskServiceGrpcAsyncIOTransport(WebRiskServiceTransport):
    ...
    @property
    def create_submission(self) -> Callable[[webrisk.CreateSubmissionRequest], Awaitable[webrisk.Submission]]:
    ...
    @property
    def submit_uri(self) -> Callable[[webrisk.SubmitUriRequest], Awaitable[operations_pb2.Operation]]:

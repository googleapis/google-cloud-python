...
class _BaseWebRiskServiceRestTransport(WebRiskServiceTransport):
    """Base REST backend transport for WebRiskService.
...
__all__ = ("_BaseWebRiskServiceRestTransport",)

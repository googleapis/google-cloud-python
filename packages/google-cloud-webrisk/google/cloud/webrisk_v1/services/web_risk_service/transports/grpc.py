...
from .base import DEFAULT_CLIENT_INFO, WebRiskServiceTransport
...
class WebRiskServiceGrpcTransport(WebRiskServiceTransport):
    ...
    def create_submission(
        ...
        if "create_submission" not in self._stubs:
            self._stubs["create_submission"] = self._logged_channel.unary_unary(
    ...
    def submit_uri(
        ...
        if "submit_uri" not in self._stubs:
            self._stubs["submit_uri"] = self._logged_channel.unary_unary(

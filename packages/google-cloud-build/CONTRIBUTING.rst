...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-cloudbuild``. The the suggested remote name ``upstream``
...
instead of
``https://github.com/googleapis/python-cloudbuild/blob/master/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-cloudbuild/blob/master/noxfile.py

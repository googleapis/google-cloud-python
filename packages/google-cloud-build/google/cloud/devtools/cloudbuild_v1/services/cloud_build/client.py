...
class CloudBuildClient(metaclass=CloudBuildClientMeta):
    ...
    def parse_default_service_account_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/defaultServiceAccount$", path)
        return m.groupdict() if m else {}
    ...
    def get_default_service_account(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_default_service_account]

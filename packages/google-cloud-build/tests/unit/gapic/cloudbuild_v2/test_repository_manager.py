...
def test__read_environment_variables():
    assert RepositoryManagerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RepositoryManagerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RepositoryManagerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RepositoryManagerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RepositoryManagerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RepositoryManagerClient._use_client_cert_effective() is False
...
def test__get_client_cert_source():
    ...
    assert RepositoryManagerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RepositoryManagerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert RepositoryManagerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RepositoryManagerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(RepositoryManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RepositoryManagerClient))
@mock.patch.object(RepositoryManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RepositoryManagerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RepositoryManagerClient._DEFAULT_UNIVERSE
    default_endpoint = RepositoryManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RepositoryManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RepositoryManagerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        RepositoryManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == RepositoryManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RepositoryManagerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RepositoryManagerClient._get_api_endpoint(None, None, default_universe, "always") == RepositoryManagerClient.DEFAULT_MTLS_ENDPOINT
    assert (
        RepositoryManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RepositoryManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RepositoryManagerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RepositoryManagerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RepositoryManagerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RepositoryManagerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RepositoryManagerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert RepositoryManagerClient._get_universe_domain(None, None) == RepositoryManagerClient._DEFAULT_UNIVERSE
...
def test_repository_manager_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "cloudbuild.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://cloudbuild.googleapis.com"
        )
...
def test_batch_create_repositories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_create_repositories in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_create_repositories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_create_repositories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RepositoryManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_create_repositories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_repositories] = mock_rpc
...
def test_fetch_linkable_repositories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_linkable_repositories in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_linkable_repositories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_linkable_repositories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RepositoryManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_linkable_repositories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_linkable_repositories] = mock_rpc
...
def test_fetch_linkable_repositories_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.fetch_linkable_repositories), "__call__") as call:
        ...
        pager = client.fetch_linkable_repositories(request={}, retry=retry, timeout=timeout)
...
def test_batch_create_repositories_rest_required_fields(request_type=repositories.BatchCreateRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_repositories._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_create_repositories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*/connections/*}/repositories:batchCreate" % client.transport._host, args[1]
        )
...
def test_fetch_read_write_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{repository=projects/*/locations/*/connections/*/repositories/*}:accessReadWriteToken" % client.transport._host, args[1]
        )
...
def test_fetch_read_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{repository=projects/*/locations/*/connections/*/repositories/*}:accessReadToken" % client.transport._host, args[1]
        )
...
def test_fetch_linkable_repositories_rest_required_fields(request_type=repositories.FetchLinkableRepositoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_linkable_repositories._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_fetch_git_refs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{repository=projects/*/locations/*/connections/*/repositories/*}:fetchGitRefs" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = RepositoryManagerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_repositories_empty_call_grpc():
    client = RepositoryManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_create_repositories), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.batch_create_repositories(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_fetch_linkable_repositories_empty_call_grpc():
    client = RepositoryManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.fetch_linkable_repositories), "__call__") as call:
        call.return_value = repositories.FetchLinkableRepositoriesResponse()
        client.fetch_linkable_repositories(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = RepositoryManagerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = RepositoryManagerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_create_repositories_empty_call_grpc_asyncio():
    client = RepositoryManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_create_repositories), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.batch_create_repositories(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_fetch_linkable_repositories_empty_call_grpc_asyncio():
    client = RepositoryManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.fetch_linkable_repositories), "__call__") as call:
        ...
        await client.fetch_linkable_repositories(request=None)
...
def test_transport_kind_rest():
    transport = RepositoryManagerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_connection_rest_bad_request(request_type=repositories.CreateConnectionRequest):
...
def test_create_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RepositoryManagerRestInterceptor, "post_create_connection_with_metadata"
...
def test_get_connection_rest_bad_request(request_type=repositories.GetConnectionRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_get_connection") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.Connection.to_json(repositories.Connection())
        req.return_value.content = return_value
...
def test_list_connections_rest_bad_request(request_type=repositories.ListConnectionsRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_list_connections") as post, mock.patch.object(
        transports.RepositoryManagerRestInterceptor, "post_list_connections_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.ListConnectionsResponse.to_json(repositories.ListConnectionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = repositories.ListConnectionsResponse(), metadata
...
def test_update_connection_rest_bad_request(request_type=repositories.UpdateConnectionRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RepositoryManagerRestInterceptor, "post_update_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_connection_rest_bad_request(request_type=repositories.DeleteConnectionRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/connections/sample3"}
    request = request_type(**request_init)
...
def test_delete_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RepositoryManagerRestInterceptor, "post_delete_connection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_repository_rest_bad_request(request_type=repositories.CreateRepositoryRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RepositoryManagerRestInterceptor, "post_create_repository_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_create_repositories_rest_bad_request(request_type=repositories.BatchCreateRepositoriesRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/connections/sample3"}
    request = request_type(**request_init)
...
def test_batch_create_repositories_rest_call_success(request_type):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_create_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RepositoryManagerRestInterceptor, "post_batch_create_repositories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_repository_rest_bad_request(request_type=repositories.GetRepositoryRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_get_repository") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.Repository.to_json(repositories.Repository())
        req.return_value.content = return_value
...
def test_list_repositories_rest_bad_request(request_type=repositories.ListRepositoriesRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/connections/sample3"}
    request = request_type(**request_init)
...
def test_list_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_list_repositories") as post, mock.patch.object(
        transports.RepositoryManagerRestInterceptor, "post_list_repositories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.ListRepositoriesResponse.to_json(repositories.ListRepositoriesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = repositories.ListRepositoriesResponse(), metadata
...
def test_delete_repository_rest_bad_request(request_type=repositories.DeleteRepositoryRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/connections/sample3/repositories/sample4"}
    request = request_type(**request_init)
...
def test_delete_repository_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.RepositoryManagerRestInterceptor, "post_delete_repository_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_fetch_read_write_token_rest_bad_request(request_type=repositories.FetchReadWriteTokenRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_fetch_read_write_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_read_write_token") as post, mock.patch.object(
        transports.RepositoryManagerRestInterceptor, "post_fetch_read_write_token_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.FetchReadWriteTokenResponse.to_json(repositories.FetchReadWriteTokenResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = repositories.FetchReadWriteTokenResponse(), metadata
...
def test_fetch_read_token_rest_bad_request(request_type=repositories.FetchReadTokenRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"repository": "projects/sample1/locations/sample2/connections/sample3/repositories/sample4"}
    request = request_type(**request_init)
...
def test_fetch_read_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_read_token") as post, mock.patch.object(
        transports.RepositoryManagerRestInterceptor, "post_fetch_read_token_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.FetchReadTokenResponse.to_json(repositories.FetchReadTokenResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = repositories.FetchReadTokenResponse(), metadata
...
def test_fetch_linkable_repositories_rest_bad_request(request_type=repositories.FetchLinkableRepositoriesRequest):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_fetch_linkable_repositories_rest_call_success(request_type):
    client = RepositoryManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_fetch_linkable_repositories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_linkable_repositories") as post, mock.patch.object(
        transports.RepositoryManagerRestInterceptor, "post_fetch_linkable_repositories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.FetchLinkableRepositoriesResponse.to_json(repositories.FetchLinkableRepositoriesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = repositories.FetchLinkableRepositoriesResponse(), metadata
...
def test_fetch_git_refs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RepositoryManagerRestInterceptor, "post_fetch_git_refs") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = repositories.FetchGitRefsResponse.to_json(repositories.FetchGitRefsResponse())
        req.return_value.content = return_value
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_repositories_empty_call_rest():
    client = RepositoryManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_fetch_linkable_repositories_empty_call_rest():
    client = RepositoryManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.RepositoryManagerGrpcTransport, grpc_helpers), (transports.RepositoryManagerGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_repository_manager_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "cloudbuild.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://cloudbuild.googleapis.com:8000"
    )

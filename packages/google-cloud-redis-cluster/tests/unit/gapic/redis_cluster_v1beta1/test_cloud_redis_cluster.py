...
def test_cloud_redis_cluster_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.redis_cluster_v1beta1.services.cloud_redis_cluster.transports.CloudRedisClusterGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_cluster_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/clusters/*/certificateAuthority}" % client.transport._host, args[1])
...
def test_reschedule_cluster_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/clusters/*}:rescheduleClusterMaintenance" % client.transport._host, args[1]
        )
...
def test_list_backup_collections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/backupCollections" % client.transport._host, args[1])
...
def test_get_backup_collection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/backupCollections/*}" % client.transport._host, args[1])
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/backupCollections/*}/backups" % client.transport._host, args[1])
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/backupCollections/*/backups/*}" % client.transport._host, args[1])
...
def test_backup_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/clusters/*}:backup" % client.transport._host, args[1])

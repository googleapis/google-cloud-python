...
def test_list_clusters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*}/clusters"
...
def test_get_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/clusters/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{cluster.name=projects/*/locations/*/clusters/*}"
            % client.transport._host,
            args[1],
        )
...
def test_get_shared_regional_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/sharedRegionalCertificateAuthority}"
            % client.transport._host,
            args[1],
        )
...
def test_reschedule_cluster_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/clusters/*}:rescheduleClusterMaintenance"
            % client.transport._host,
            args[1],
        )
...
def test_list_backup_collections_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*}/backupCollections"
            % client.transport._host,
            args[1],
        )
...
def test_get_backup_collection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/backupCollections/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_backups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*/backupCollections/*}/backups"
            % client.transport._host,
            args[1],
        )
...
def test_get_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/backupCollections/*/backups/*}"
            % client.transport._host,
            args[1],
        )
...
def test_backup_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/clusters/*}:backup"
            % client.transport._host,
            args[1],
        )
...
def test_cloud_redis_cluster_base_transport():
    ...
    with mock.patch(
        "google.cloud.redis_cluster_v1beta1.services.cloud_redis_cluster.transports.CloudRedisClusterTransport.__init__"
    ) as Transport:

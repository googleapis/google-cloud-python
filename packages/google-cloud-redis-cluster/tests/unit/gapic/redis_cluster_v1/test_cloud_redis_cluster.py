...
from google.cloud.redis_cluster_v1.services.cloud_redis_cluster import CloudRedisClusterAsyncClient, CloudRedisClusterClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        CloudRedisClusterClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        CloudRedisClusterClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == CloudRedisClusterClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_get_cluster_certificate_authority_async(
    transport: str = "grpc_asyncio", request_type=cloud_redis_cluster.GetClusterCertificateAuthorityRequest
):
    client = CloudRedisClusterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_reschedule_cluster_maintenance(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.reschedule_cluster_maintenance), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
async def test_reschedule_cluster_maintenance_async(
    transport: str = "grpc_asyncio", request_type=cloud_redis_cluster.RescheduleClusterMaintenanceRequest
):
    client = CloudRedisClusterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_list_backup_collections_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_backup_collections), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            cloud_redis_cluster.ListBackupCollectionsResponse(
                backup_collections=[
        ...
        assert len(responses) == 6
        assert all(isinstance(i, cloud_redis_cluster.BackupCollection) for i in responses)
...
async def test_list_backup_collections_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_backup_collections), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_backup_collections(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_cluster_certificate_authority_rest_required_fields(request_type=cloud_redis_cluster.GetClusterCertificateAuthorityRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_cluster_certificate_authority._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_reschedule_cluster_maintenance_rest_required_fields(request_type=cloud_redis_cluster.RescheduleClusterMaintenanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reschedule_cluster_maintenance._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = CloudRedisClusterClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CloudRedisClusterAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CloudRedisClusterAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CloudRedisClusterClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CloudRedisClusterRestInterceptor, "post_list_clusters") as post, mock.patch.object(
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisClusterRestInterceptor, "post_get_cluster") as post, mock.patch.object(
...
def test_update_cluster_rest_call_success(request_type):
    ...
    request_init["cluster"] = {
        ...
        "discovery_endpoints": [{"address": "address_value", "port": 453, "psc_config": {}}],
        "psc_connections": [
            {
        ...
        "state_info": {"update_info": {"target_shard_count": 1920, "target_replica_count": 2126}},
        "node_type": 1,
        ...
        "psc_service_attachments": [{"service_attachment": "service_attachment_value", "connection_type": 1}],
        "cluster_endpoints": [
            {
                "connections": [
                    {
...
def test_get_cluster_certificate_authority_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudRedisClusterRestInterceptor, "post_get_cluster_certificate_authority_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.CloudRedisClusterRestInterceptor, "pre_get_cluster_certificate_authority"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reschedule_cluster_maintenance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudRedisClusterRestInterceptor, "post_reschedule_cluster_maintenance"
    ) as post, mock.patch.object(
        transports.CloudRedisClusterRestInterceptor, "post_reschedule_cluster_maintenance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.CloudRedisClusterRestInterceptor, "pre_reschedule_cluster_maintenance"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_backup_collections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisClusterRestInterceptor, "post_list_backup_collections") as post, mock.patch.object(
        transports.CloudRedisClusterRestInterceptor, "post_list_backup_collections_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_backup_collection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisClusterRestInterceptor, "post_get_backup_collection") as post, mock.patch.object(
        transports.CloudRedisClusterRestInterceptor, "post_get_backup_collection_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisClusterRestInterceptor, "post_list_backups") as post, mock.patch.object(
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisClusterRestInterceptor, "post_get_backup") as post, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.CloudRedisClusterGrpcTransport, grpc_helpers), (transports.CloudRedisClusterGrpcAsyncIOTransport, grpc_helpers_async)],
)

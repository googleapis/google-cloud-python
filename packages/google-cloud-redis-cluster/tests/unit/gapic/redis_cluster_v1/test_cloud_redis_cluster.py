...
from google.cloud.redis_cluster_v1.services.cloud_redis_cluster import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        CloudRedisClusterClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        CloudRedisClusterClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        CloudRedisClusterClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        CloudRedisClusterClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__read_environment_variables():
    assert CloudRedisClusterClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CloudRedisClusterClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CloudRedisClusterClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                CloudRedisClusterClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        CloudRedisClusterClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        CloudRedisClusterClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                CloudRedisClusterClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(CloudRedisClusterClient),
)
@mock.patch.object(
    CloudRedisClusterAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(CloudRedisClusterAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudRedisClusterClient._DEFAULT_UNIVERSE
    default_endpoint = CloudRedisClusterClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = CloudRedisClusterClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == CloudRedisClusterClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CloudRedisClusterClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        CloudRedisClusterClient._get_api_endpoint(
    ...
    assert (
        CloudRedisClusterClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        CloudRedisClusterClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        CloudRedisClusterClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        CloudRedisClusterClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        CloudRedisClusterClient._get_universe_domain(None, None)
        == CloudRedisClusterClient._DEFAULT_UNIVERSE
    )
...
def test_cloud_redis_cluster_client_from_service_account_info(
    client_class, transport_name
):
...
def test_cloud_redis_cluster_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_cloud_redis_cluster_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_cloud_redis_cluster_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_cloud_redis_cluster_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [CloudRedisClusterClient, CloudRedisClusterAsyncClient]
)
@mock.patch.object(
    CloudRedisClusterClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CloudRedisClusterClient),
)
@mock.patch.object(
    CloudRedisClusterAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CloudRedisClusterAsyncClient),
)
...
def test_cloud_redis_cluster_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_cloud_redis_cluster_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_cloud_redis_cluster_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.redis_cluster_v1.services.cloud_redis_cluster.transports.CloudRedisClusterGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_cloud_redis_cluster_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_cluster(request_type, transport: str = "grpc"):
    ...
    assert (
        ...
        == cloud_redis_cluster.AuthorizationMode.AUTH_MODE_IAM_AUTH
    )
    assert (
        response.transit_encryption_mode
        == cloud_redis_cluster.TransitEncryptionMode.TRANSIT_ENCRYPTION_MODE_DISABLED
    )
...
def test_update_cluster_flattened():
    ...
    with mock.patch.object(type(client.transport.update_cluster), "__call__") as call:
        ...
        client.update_cluster(
            cluster=cloud_redis_cluster.Cluster(
                gcs_source=cloud_redis_cluster.Cluster.GcsBackupSource(
                    uris=["uris_value"]
                )
            ),
        ...
        _, args, _ = call.mock_calls[0]
        arg = args[0].cluster
        mock_val = cloud_redis_cluster.Cluster(
            gcs_source=cloud_redis_cluster.Cluster.GcsBackupSource(uris=["uris_value"])
        )
        assert arg == mock_val
...
def test_get_shared_regional_certificate_authority(
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = cloud_redis_cluster.SharedRegionalCertificateAuthority(
            name="name_value",
        )
...
def test_reschedule_cluster_maintenance(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.reschedule_cluster_maintenance), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_reschedule_cluster_maintenance_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.reschedule_cluster_maintenance
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_reschedule_cluster_maintenance_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.reschedule_cluster_maintenance
            in client._client._transport._wrapped_methods
        )
...
async def test_list_backup_collections_async_pager():
    ...
    with mock.patch.object(
        ...
        assert len(responses) == 6
        assert all(
            isinstance(i, cloud_redis_cluster.BackupCollection) for i in responses
        )
...
async def test_list_backups_async_pager():
    ...
    with mock.patch.object(
        ...
        assert len(responses) == 6
        assert all(isinstance(i, cloud_redis_cluster.Backup) for i in responses)
...
@pytest.mark.asyncio
async def test_backup_cluster_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.backup_cluster
            in client._client._transport._wrapped_methods
        )
...
def test_list_clusters_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            cloud_redis_cluster.ListClustersResponse.to_json(x) for x in response
        )
...
def test_get_cluster_certificate_authority_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clusters/*/certificateAuthority}"
            % client.transport._host,
            args[1],
        )
...
def test_get_shared_regional_certificate_authority_rest_required_fields(
    ...
    # Designate an appropriate value for the returned response.
    return_value = cloud_redis_cluster.SharedRegionalCertificateAuthority()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = cloud_redis_cluster.SharedRegionalCertificateAuthority.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_reschedule_cluster_maintenance_rest_required_fields(
    request_type=cloud_redis_cluster.RescheduleClusterMaintenanceRequest,
):
    transport_class = transports.CloudRedisClusterRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).reschedule_cluster_maintenance._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reschedule_cluster_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clusters/*}:rescheduleClusterMaintenance"
            % client.transport._host,
            args[1],
        )
...
def test_list_backup_collections_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = cloud_redis_cluster.ListBackupCollectionsResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_backup_collections_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            cloud_redis_cluster.ListBackupCollectionsResponse.to_json(x)
            for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
...
def test_list_backups_rest_required_fields(
    request_type=cloud_redis_cluster.ListBackupsRequest,
):
    transport_class = transports.CloudRedisClusterRestTransport
...
def test_list_backups_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            cloud_redis_cluster.ListBackupsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_get_backup_rest_required_fields(
    request_type=cloud_redis_cluster.GetBackupRequest,
):
    transport_class = transports.CloudRedisClusterRestTransport
...
def test_backup_cluster_rest_required_fields(
    request_type=cloud_redis_cluster.BackupClusterRequest,
):
    transport_class = transports.CloudRedisClusterRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).backup_cluster._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_backup_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clusters/*}:backup"
            % client.transport._host,
            args[1],
        )
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.ListClustersResponse.to_json(
            cloud_redis_cluster.ListClustersResponse()
        )
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.Cluster.to_json(
            cloud_redis_cluster.Cluster()
        )
        req.return_value.content = return_value
...
def test_update_cluster_rest_call_success(request_type):
    ...
    request_init["cluster"] = {
        ...
        "size_gb": 739,
        "shard_count": 1178,
        "psc_configs": [{"network": "network_value"}],
        "discovery_endpoints": [
            {"address": "address_value", "port": 453, "psc_config": {}}
        ],
        "psc_connections": [
            {
        ...
        "cross_cluster_replication_config": {
            "cluster_role": 1,
            "primary_cluster": {"cluster": "cluster_value", "uid": "uid_value"},
            "secondary_clusters": {},
            "update_time": {},
            "membership": {"primary_cluster": {}, "secondary_clusters": {}},
        },
        "deletion_protection_enabled": True,
        "maintenance_policy": {
            "create_time": {},
...
def test_get_cluster_certificate_authority_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.CertificateAuthority.to_json(
            cloud_redis_cluster.CertificateAuthority()
        )
        req.return_value.content = return_value
...
def test_get_shared_regional_certificate_authority_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post_with_metadata.assert_not_called()
        pb_message = (
            cloud_redis_cluster.GetSharedRegionalCertificateAuthorityRequest.pb(
                cloud_redis_cluster.GetSharedRegionalCertificateAuthorityRequest()
            )
        )
        transcode.return_value = {
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.SharedRegionalCertificateAuthority.to_json(
            cloud_redis_cluster.SharedRegionalCertificateAuthority()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = cloud_redis_cluster.SharedRegionalCertificateAuthority()
        post_with_metadata.return_value = (
            cloud_redis_cluster.SharedRegionalCertificateAuthority(),
            metadata,
        )
...
def test_list_backup_collections_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.ListBackupCollectionsResponse.to_json(
            cloud_redis_cluster.ListBackupCollectionsResponse()
        )
        req.return_value.content = return_value
...
def test_get_backup_collection_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.BackupCollection.to_json(
            cloud_redis_cluster.BackupCollection()
        )
        req.return_value.content = return_value
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_redis_cluster.ListBackupsResponse.to_json(
            cloud_redis_cluster.ListBackupsResponse()
        )
        req.return_value.content = return_value
...
def test_cloud_redis_cluster_base_transport():
    ...
    with mock.patch(
        "google.cloud.redis_cluster_v1.services.cloud_redis_cluster.transports.CloudRedisClusterTransport.__init__"
    ) as Transport:
...
def test_cloud_redis_cluster_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.redis_cluster_v1.services.cloud_redis_cluster.transports.CloudRedisClusterTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_backup_path():
    ...
    actual = CloudRedisClusterClient.backup_path(
        project, location, backup_collection, backup
    )
...
def test_backup_collection_path():
    ...
    actual = CloudRedisClusterClient.backup_collection_path(
...
def test_ca_pool_path():
    ...
    actual = CloudRedisClusterClient.ca_pool_path(project, location, ca_pool)
    assert expected == actual
...
def test_parse_ca_pool_path():
    ...
    # Check that the path construction is reversible.
    actual = CloudRedisClusterClient.parse_ca_pool_path(path)
    assert expected == actual
...
def test_crypto_key_path():
    ...
    actual = CloudRedisClusterClient.crypto_key_path(
...
def test_crypto_key_version_path():
    ...
    actual = CloudRedisClusterClient.crypto_key_version_path(
...
def test_forwarding_rule_path():
    ...
    actual = CloudRedisClusterClient.forwarding_rule_path(
        project, region, forwarding_rule
    )
    assert expected == actual
...
def test_service_attachment_path():
    ...
    actual = CloudRedisClusterClient.service_attachment_path(
...
def test_shared_regional_certificate_authority_path():
    ...
    actual = CloudRedisClusterClient.shared_regional_certificate_authority_path(
        project, location
    )
    assert expected == actual
...
def test_parse_shared_regional_certificate_authority_path():
    ...
    # Check that the path construction is reversible.
    actual = CloudRedisClusterClient.parse_shared_regional_certificate_authority_path(
        path
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.CloudRedisClusterTransport, "_prep_wrapped_messages"
    ) as prep:
        client = CloudRedisClusterClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
async def test_get_location_field_headers_async():
    client = CloudRedisClusterAsyncClient(credentials=async_anonymous_credentials())

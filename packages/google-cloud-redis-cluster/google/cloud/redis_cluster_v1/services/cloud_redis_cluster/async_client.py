...
from .client import CloudRedisClusterClient
from .transports.base import DEFAULT_CLIENT_INFO, CloudRedisClusterTransport
from .transports.grpc_asyncio import CloudRedisClusterGrpcAsyncIOTransport
...
class CloudRedisClusterAsyncClient:
    ...
    _client: CloudRedisClusterClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = CloudRedisClusterClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = CloudRedisClusterClient.DEFAULT_MTLS_ENDPOINT
    ...
    backup_collection_path = staticmethod(CloudRedisClusterClient.backup_collection_path)
    parse_backup_collection_path = staticmethod(CloudRedisClusterClient.parse_backup_collection_path)
    certificate_authority_path = staticmethod(CloudRedisClusterClient.certificate_authority_path)
    parse_certificate_authority_path = staticmethod(CloudRedisClusterClient.parse_certificate_authority_path)
    ...
    crypto_key_path = staticmethod(CloudRedisClusterClient.crypto_key_path)
    parse_crypto_key_path = staticmethod(CloudRedisClusterClient.parse_crypto_key_path)
    crypto_key_version_path = staticmethod(CloudRedisClusterClient.crypto_key_version_path)
    parse_crypto_key_version_path = staticmethod(CloudRedisClusterClient.parse_crypto_key_version_path)
    forwarding_rule_path = staticmethod(CloudRedisClusterClient.forwarding_rule_path)
    parse_forwarding_rule_path = staticmethod(CloudRedisClusterClient.parse_forwarding_rule_path)
    network_path = staticmethod(CloudRedisClusterClient.network_path)
    parse_network_path = staticmethod(CloudRedisClusterClient.parse_network_path)
    service_attachment_path = staticmethod(CloudRedisClusterClient.service_attachment_path)
    parse_service_attachment_path = staticmethod(CloudRedisClusterClient.parse_service_attachment_path)
    common_billing_account_path = staticmethod(CloudRedisClusterClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(CloudRedisClusterClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(CloudRedisClusterClient.common_folder_path)
    parse_common_folder_path = staticmethod(CloudRedisClusterClient.parse_common_folder_path)
    common_organization_path = staticmethod(CloudRedisClusterClient.common_organization_path)
    parse_common_organization_path = staticmethod(CloudRedisClusterClient.parse_common_organization_path)
    common_project_path = staticmethod(CloudRedisClusterClient.common_project_path)
    parse_common_project_path = staticmethod(CloudRedisClusterClient.parse_common_project_path)
    common_location_path = staticmethod(CloudRedisClusterClient.common_location_path)
    parse_common_location_path = staticmethod(CloudRedisClusterClient.parse_common_location_path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return CloudRedisClusterClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

    @property
    def transport(self) -> CloudRedisClusterTransport:
        """Returns the transport used by the client instance.

        Returns:
            CloudRedisClusterTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = CloudRedisClusterClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, CloudRedisClusterTransport, Callable[..., CloudRedisClusterTransport]]] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,CloudRedisClusterTransport,Callable[..., CloudRedisClusterTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CloudRedisClusterTransport constructor.
        ...
        """
        self._client = CloudRedisClusterClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.redis.cluster_v1.CloudRedisClusterAsyncClient`.",
                extra={
    ...
    async def list_clusters(
        self,
        request: Optional[Union[cloud_redis_cluster.ListClustersRequest, dict]] = None,
        *,
        ...
        r"""Lists all Redis clusters owned by a project in either the
        ...
        .. code-block:: python
            ...
            async def sample_list_clusters():
                ...
                request = redis_cluster_v1.ListClustersRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.ListClustersRequest, dict]]):
        ...
        if not isinstance(request, cloud_redis_cluster.ListClustersRequest):
            request = cloud_redis_cluster.ListClustersRequest(request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_cluster():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.GetClusterRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.GetClusterRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1.types.Cluster:
                A cluster instance.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.GetClusterRequest):
            request = cloud_redis_cluster.GetClusterRequest(request)
    ...
    async def update_cluster(
        self,
        request: Optional[Union[cloud_redis_cluster.UpdateClusterRequest, dict]] = None,
        *,
        cluster: Optional[cloud_redis_cluster.Cluster] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.UpdateClusterRequest):
            request = cloud_redis_cluster.UpdateClusterRequest(request)
    ...
    async def delete_cluster(
        ...
        *,
        ...
        r"""Deletes a specific Redis cluster. Cluster stops
        ...
        .. code-block:: python
            ...
            async def sample_delete_cluster():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.DeleteClusterRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.DeleteClusterRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.DeleteClusterRequest):
            request = cloud_redis_cluster.DeleteClusterRequest(request)
    ...
    async def create_cluster(
        self,
        request: Optional[Union[cloud_redis_cluster.CreateClusterRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        cluster: Optional[cloud_redis_cluster.Cluster] = None,
        ...
        r"""Creates a Redis cluster based on the specified
        ...
        .. code-block:: python
            ...
            async def sample_create_cluster():
                ...
                request = redis_cluster_v1.CreateClusterRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.CreateClusterRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            cluster (:class:`google.cloud.redis_cluster_v1.types.Cluster`):
                Required. The cluster that is to be
                created.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.CreateClusterRequest):
            request = cloud_redis_cluster.CreateClusterRequest(request)
    ...
    async def get_cluster_certificate_authority(
        self,
        request: Optional[Union[cloud_redis_cluster.GetClusterCertificateAuthorityRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.GetClusterCertificateAuthorityRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_cluster_certificate_authority]
    ...
    async def reschedule_cluster_maintenance(
        self,
        request: Optional[Union[cloud_redis_cluster.RescheduleClusterMaintenanceRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        reschedule_type: Optional[cloud_redis_cluster.RescheduleClusterMaintenanceRequest.RescheduleType] = None,
        ...
        .. code-block:: python
            ...
            async def sample_reschedule_cluster_maintenance():
                # Create a client
                client = redis_cluster_v1.CloudRedisClusterAsyncClient()

                # Initialize request argument(s)
                request = redis_cluster_v1.RescheduleClusterMaintenanceRequest(
                    name="name_value",
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.RescheduleClusterMaintenanceRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.RescheduleClusterMaintenanceRequest):
            request = cloud_redis_cluster.RescheduleClusterMaintenanceRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reschedule_cluster_maintenance]
    ...
    async def list_backup_collections(
        self,
        request: Optional[Union[cloud_redis_cluster.ListBackupCollectionsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_list_backup_collections():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.ListBackupCollectionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.ListBackupCollectionsRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.ListBackupCollectionsRequest):
            request = cloud_redis_cluster.ListBackupCollectionsRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_backup_collections]
    ...
    async def get_backup_collection(
        self,
        request: Optional[Union[cloud_redis_cluster.GetBackupCollectionRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_get_backup_collection():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.GetBackupCollectionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.GetBackupCollectionRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1.types.BackupCollection:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.GetBackupCollectionRequest):
            request = cloud_redis_cluster.GetBackupCollectionRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_backup_collection]
    ...
    async def list_backups(
        self,
        request: Optional[Union[cloud_redis_cluster.ListBackupsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_list_backups():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.ListBackupsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.ListBackupsRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.ListBackupsRequest):
            request = cloud_redis_cluster.ListBackupsRequest(request)
    ...
    async def get_backup(
        self,
        request: Optional[Union[cloud_redis_cluster.GetBackupRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_get_backup():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.GetBackupRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.GetBackupRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1.types.Backup:
                Backup of a cluster.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.GetBackupRequest):
            request = cloud_redis_cluster.GetBackupRequest(request)
    ...
    async def delete_backup(
        self,
        request: Optional[Union[cloud_redis_cluster.DeleteBackupRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_backup():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1.DeleteBackupRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.DeleteBackupRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.DeleteBackupRequest):
            request = cloud_redis_cluster.DeleteBackupRequest(request)
    ...
    async def export_backup(
        self,
        request: Optional[Union[cloud_redis_cluster.ExportBackupRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.ExportBackupRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.redis_cluster_v1.types.Backup`
                Backup of a cluster.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.ExportBackupRequest):
            request = cloud_redis_cluster.ExportBackupRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_backup]
    ...
    async def backup_cluster(
        self,
        request: Optional[Union[cloud_redis_cluster.BackupClusterRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_backup_cluster():
                # Create a client
                client = redis_cluster_v1.CloudRedisClusterAsyncClient()

                # Initialize request argument(s)
                request = redis_cluster_v1.BackupClusterRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1.types.BackupClusterRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, cloud_redis_cluster.BackupClusterRequest):
            request = cloud_redis_cluster.BackupClusterRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.backup_cluster]
    ...
    async def __aenter__(self) -> "CloudRedisClusterAsyncClient":
        return self

...
from .services.cloud_redis_cluster import CloudRedisClusterAsyncClient, CloudRedisClusterClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.redis_cluster_v1beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.redis_cluster_v1beta1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.redis_cluster_v1beta1"

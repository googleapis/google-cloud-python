...
from google.cloud.redis_cluster_v1beta1.services.cloud_redis_cluster import pagers
...
class CloudRedisClusterAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.redis.cluster_v1beta1.CloudRedisClusterAsyncClient`.",
                extra={
    ...
    async def list_clusters(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.ListClustersRequest, dict]]):
    ...
    async def get_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.GetClusterRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1beta1.types.Cluster:
                A cluster instance.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
    ...
    async def update_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.UpdateClusterRequest, dict]]):
                The request object. Request for [UpdateCluster][CloudRedis.UpdateCluster].
            cluster (:class:`google.cloud.redis_cluster_v1beta1.types.Cluster`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.redis_cluster_v1beta1.types.Cluster`
                A cluster instance.
    ...
    async def delete_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.DeleteClusterRequest, dict]]):
    ...
    async def create_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.CreateClusterRequest, dict]]):
    ...
    async def get_cluster_certificate_authority(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.GetClusterCertificateAuthorityRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1beta1.types.CertificateAuthority:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_shared_regional_certificate_authority():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1beta1.GetSharedRegionalCertificateAuthorityRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.GetSharedRegionalCertificateAuthorityRequest, dict]]):
                The request object. Request for
        ...
        Returns:
            google.cloud.redis_cluster_v1beta1.types.SharedRegionalCertificateAuthority:
    ...
    async def reschedule_cluster_maintenance(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.RescheduleClusterMaintenanceRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            reschedule_type (:class:`google.cloud.redis_cluster_v1beta1.types.RescheduleClusterMaintenanceRequest.RescheduleType`):
    ...
    async def list_backup_collections(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.ListBackupCollectionsRequest, dict]]):
    ...
    async def get_backup_collection(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.GetBackupCollectionRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1beta1.types.BackupCollection:
    ...
    async def list_backups(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.ListBackupsRequest, dict]]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_backup():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1beta1.GetBackupRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.GetBackupRequest, dict]]):
        ...
        Returns:
            google.cloud.redis_cluster_v1beta1.types.Backup:
                Backup of a cluster.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
    ...
    async def delete_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.DeleteBackupRequest, dict]]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_export_backup():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1beta1.ExportBackupRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.ExportBackupRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be
                :class:`google.cloud.redis_cluster_v1beta1.types.Backup`
                Backup of a cluster.
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_backup_cluster():
                ...
                # Initialize request argument(s)
                request = redis_cluster_v1beta1.BackupClusterRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.redis_cluster_v1beta1.types.BackupClusterRequest, dict]]):

...
# [START redis_v1beta1_generated_CloudRedisCluster_DeleteBackup_sync]
...
def sample_delete_backup():
    ...
    request = redis_cluster_v1beta1.DeleteBackupRequest(
        name="name_value",
    )
...
# [END redis_v1beta1_generated_CloudRedisCluster_DeleteBackup_sync]

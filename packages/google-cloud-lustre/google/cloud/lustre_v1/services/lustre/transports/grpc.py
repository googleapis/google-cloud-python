...
class LustreGrpcTransport(LustreTransport):
    """gRPC backend transport for Lustre.
    ...
    def __init__(
        self,
        *,
        host: str = "lustre.googleapis.com",
        ...
        Args:
            host (Optional[str]):
                 The hostname to connect to (default: 'lustre.googleapis.com').
    ...
    @property
    def create_instance(self) -> Callable[[gcl_instance.CreateInstanceRequest], operations_pb2.Operation]:
        ...
        if "create_instance" not in self._stubs:
            self._stubs["create_instance"] = self._logged_channel.unary_unary(
                ...
                request_serializer=gcl_instance.CreateInstanceRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["create_instance"]

    @property
    def update_instance(self) -> Callable[[gcl_instance.UpdateInstanceRequest], operations_pb2.Operation]:
        ...
        if "update_instance" not in self._stubs:
            self._stubs["update_instance"] = self._logged_channel.unary_unary(
                ...
                request_serializer=gcl_instance.UpdateInstanceRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    @property
    def import_data(self) -> Callable[[transfer.ImportDataRequest], operations_pb2.Operation]:
        r"""Return a callable for the import data method over gRPC.

        Imports data from Cloud Storage to a Managed Lustre
        instance.
        ...
        if "import_data" not in self._stubs:
            self._stubs["import_data"] = self._logged_channel.unary_unary(
                ...
                request_serializer=transfer.ImportDataRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["import_data"]

    @property
    def export_data(self) -> Callable[[transfer.ExportDataRequest], operations_pb2.Operation]:
        r"""Return a callable for the export data method over gRPC.

        Exports data from a Managed Lustre instance to Cloud
        Storage.
        ...
        if "export_data" not in self._stubs:
            self._stubs["export_data"] = self._logged_channel.unary_unary(
                ...
                request_serializer=transfer.ExportDataRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )

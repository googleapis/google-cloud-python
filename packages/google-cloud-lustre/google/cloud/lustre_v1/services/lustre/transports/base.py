...
class LustreTransport(abc.ABC):
    """Abstract transport class for Lustre."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "lustre.googleapis.com"
    ...
    @property
    def create_instance(self) -> Callable[[gcl_instance.CreateInstanceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_instance(self) -> Callable[[gcl_instance.UpdateInstanceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    @property
    def import_data(self) -> Callable[[transfer.ImportDataRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def export_data(self) -> Callable[[transfer.ExportDataRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
class LustreGrpcAsyncIOTransport(LustreTransport):
    ...
    @property
    def create_instance(self) -> Callable[[gcl_instance.CreateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_instance(self) -> Callable[[gcl_instance.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_data(self) -> Callable[[transfer.ImportDataRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_data(self) -> Callable[[transfer.ExportDataRequest], Awaitable[operations_pb2.Operation]]:

...
class LustreGrpcAsyncIOTransport(LustreTransport):
    ...
    def create_instance(
        ...
        [gcl_instance.CreateInstanceRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_instance(
        ...
        [gcl_instance.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def export_data(
        self,
    ) -> Callable[[transfer.ExportDataRequest], Awaitable[operations_pb2.Operation]]:

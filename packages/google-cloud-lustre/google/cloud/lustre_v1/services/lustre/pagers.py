...
class ListInstancesPager:
    ...
    :class:`google.cloud.lustre_v1.types.ListInstancesResponse` object, and
    ...
    All the usual :class:`google.cloud.lustre_v1.types.ListInstancesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.lustre_v1.types.ListInstancesRequest):
                The initial request object.
            response (google.cloud.lustre_v1.types.ListInstancesResponse):

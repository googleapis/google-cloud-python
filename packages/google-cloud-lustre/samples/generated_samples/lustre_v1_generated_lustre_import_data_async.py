...
# [START lustre_v1_generated_Lustre_ImportData_async]
...
async def sample_import_data():
    ...
    gcs_path = lustre_v1.GcsPath()
    gcs_path.uri = "uri_value"

    request = lustre_v1.ImportDataRequest(
        gcs_path=gcs_path,
        name="name_value",
    )
...
# [END lustre_v1_generated_Lustre_ImportData_async]

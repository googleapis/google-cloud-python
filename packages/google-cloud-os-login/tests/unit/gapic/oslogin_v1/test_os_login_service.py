...
def test__get_client_cert_source():
    ...
    assert (
        OsLoginServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        OsLoginServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                OsLoginServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                OsLoginServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(OsLoginServiceClient),
)
@mock.patch.object(
    OsLoginServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(OsLoginServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = OsLoginServiceClient._DEFAULT_UNIVERSE
    default_endpoint = OsLoginServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = OsLoginServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        OsLoginServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        OsLoginServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == OsLoginServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        OsLoginServiceClient._get_api_endpoint(
    ...
    assert (
        OsLoginServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        OsLoginServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        OsLoginServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        OsLoginServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        OsLoginServiceClient._get_universe_domain(None, None)
        == OsLoginServiceClient._DEFAULT_UNIVERSE
    )
...
def test_create_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.create_ssh_public_key
        ...
        client._transport._wrapped_methods[client._transport.create_ssh_public_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_create_ssh_public_key_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_ssh_public_key
...
def test_delete_posix_account_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_posix_account in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_posix_account] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_posix_account_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_posix_account
            in client._client._transport._wrapped_methods
        )
...
def test_delete_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_ssh_public_key
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.delete_ssh_public_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_delete_ssh_public_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_ssh_public_key
            in client._client._transport._wrapped_methods
        )
...
def test_get_login_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_login_profile] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_login_profile_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_login_profile
            in client._client._transport._wrapped_methods
        )
...
def test_get_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_ssh_public_key in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_ssh_public_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_get_ssh_public_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_ssh_public_key
            in client._client._transport._wrapped_methods
        )
...
def test_import_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.import_ssh_public_key
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.import_ssh_public_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_import_ssh_public_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.import_ssh_public_key
            in client._client._transport._wrapped_methods
        )
...
def test_update_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_ssh_public_key
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.update_ssh_public_key] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_update_ssh_public_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_ssh_public_key
            in client._client._transport._wrapped_methods
        )
...
def test_create_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.OsLoginServiceRestInterceptor,

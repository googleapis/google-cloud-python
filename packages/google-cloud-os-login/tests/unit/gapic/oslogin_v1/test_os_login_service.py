...
def test__read_environment_variables():
    assert OsLoginServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert OsLoginServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert OsLoginServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert OsLoginServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert OsLoginServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert OsLoginServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert OsLoginServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert OsLoginServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                OsLoginServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert OsLoginServiceClient._get_client_cert_source(None, False) is None
    assert OsLoginServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert OsLoginServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert OsLoginServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert OsLoginServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(OsLoginServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsLoginServiceClient))
@mock.patch.object(OsLoginServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsLoginServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = OsLoginServiceClient._DEFAULT_UNIVERSE
    default_endpoint = OsLoginServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = OsLoginServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert OsLoginServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        OsLoginServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == OsLoginServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert OsLoginServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert OsLoginServiceClient._get_api_endpoint(None, None, default_universe, "always") == OsLoginServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        OsLoginServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == OsLoginServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert OsLoginServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert OsLoginServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        OsLoginServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert OsLoginServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert OsLoginServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert OsLoginServiceClient._get_universe_domain(None, None) == OsLoginServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        OsLoginServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = OsLoginServiceClient(credentials=cred)
...
def test_os_login_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "oslogin.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://oslogin.googleapis.com"
        )
...
@mock.patch.object(OsLoginServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsLoginServiceClient))
@mock.patch.object(OsLoginServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OsLoginServiceAsyncClient))
def test_os_login_service_client_client_api_endpoint(client_class):
...
def test_create_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_ssh_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_ssh_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_ssh_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_ssh_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_ssh_public_key] = mock_rpc
...
def test_delete_posix_account_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_posix_account in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_posix_account] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_posix_account_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsLoginServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_posix_account in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_posix_account] = mock_rpc
...
def test_delete_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_ssh_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_ssh_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_ssh_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsLoginServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_ssh_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_ssh_public_key] = mock_rpc
...
def test_get_login_profile_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_login_profile in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_login_profile] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_login_profile_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsLoginServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_login_profile in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_login_profile] = mock_rpc
...
def test_get_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_ssh_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_ssh_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_ssh_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsLoginServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_ssh_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_ssh_public_key] = mock_rpc
...
def test_import_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_ssh_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_ssh_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_ssh_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsLoginServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_ssh_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_ssh_public_key] = mock_rpc
...
def test_update_ssh_public_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_ssh_public_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_ssh_public_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_ssh_public_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = OsLoginServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_ssh_public_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_ssh_public_key] = mock_rpc
...
def test_create_ssh_public_key_rest_required_fields(request_type=oslogin.CreateSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_ssh_public_key._get_unset_required_fields(
        jsonified_request
    )
...
def test_delete_posix_account_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OsLoginServiceClient(
...
def test_delete_posix_account_rest_required_fields(request_type=oslogin.DeletePosixAccountRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_posix_account._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_ssh_public_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OsLoginServiceClient(
...
def test_delete_ssh_public_key_rest_required_fields(request_type=oslogin.DeleteSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_ssh_public_key._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_login_profile_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OsLoginServiceClient(
...
def test_get_ssh_public_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OsLoginServiceClient(
...
def test_import_ssh_public_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OsLoginServiceClient(
...
def test_import_ssh_public_key_rest_required_fields(request_type=oslogin.ImportSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_ssh_public_key._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_ssh_public_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = OsLoginServiceClient(
...
def test_update_ssh_public_key_rest_required_fields(request_type=oslogin.UpdateSshPublicKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_ssh_public_key._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = OsLoginServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_ssh_public_key_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_ssh_public_key), "__call__") as call:
        call.return_value = common.SshPublicKey()
        client.create_ssh_public_key(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_posix_account_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_posix_account), "__call__") as call:
        call.return_value = None
        client.delete_posix_account(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_ssh_public_key_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_ssh_public_key), "__call__") as call:
        call.return_value = None
        client.delete_ssh_public_key(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_login_profile_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_login_profile), "__call__") as call:
        call.return_value = oslogin.LoginProfile()
        client.get_login_profile(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_ssh_public_key_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_ssh_public_key), "__call__") as call:
        call.return_value = common.SshPublicKey()
        client.get_ssh_public_key(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_ssh_public_key_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.import_ssh_public_key), "__call__") as call:
        call.return_value = oslogin.ImportSshPublicKeyResponse()
        client.import_ssh_public_key(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_ssh_public_key_empty_call_grpc():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_ssh_public_key), "__call__") as call:
        call.return_value = common.SshPublicKey()
        client.update_ssh_public_key(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = OsLoginServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = OsLoginServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_ssh_public_key_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_ssh_public_key), "__call__") as call:
        ...
        await client.create_ssh_public_key(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_posix_account_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_posix_account), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_posix_account(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_ssh_public_key_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_ssh_public_key), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_ssh_public_key(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_login_profile_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_login_profile), "__call__") as call:
        ...
        await client.get_login_profile(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_ssh_public_key_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_ssh_public_key), "__call__") as call:
        ...
        await client.get_ssh_public_key(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_ssh_public_key_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.import_ssh_public_key), "__call__") as call:
        ...
        await client.import_ssh_public_key(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_ssh_public_key_empty_call_grpc_asyncio():
    client = OsLoginServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_ssh_public_key), "__call__") as call:
        ...
        await client.update_ssh_public_key(request=None)
...
def test_transport_kind_rest():
    transport = OsLoginServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_ssh_public_key_rest_bad_request(request_type=oslogin.CreateSshPublicKeyRequest):
...
def test_create_ssh_public_key_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
    ...
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_create_ssh_public_key") as post, mock.patch.object(
        transports.OsLoginServiceRestInterceptor, "post_create_ssh_public_key_with_metadata"
        ...
        post_with_metadata.return_value = common.SshPublicKey(), metadata
...
def test_delete_posix_account_rest_bad_request(request_type=oslogin.DeletePosixAccountRequest):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_delete_posix_account_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_posix_account_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_delete_posix_account") as pre:
        pre.assert_not_called()
...
def test_delete_ssh_public_key_rest_bad_request(request_type=oslogin.DeleteSshPublicKeyRequest):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_delete_ssh_public_key_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_delete_ssh_public_key") as pre:
        pre.assert_not_called()
...
def test_get_login_profile_rest_bad_request(request_type=oslogin.GetLoginProfileRequest):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_login_profile_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_login_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_get_login_profile") as post, mock.patch.object(
        transports.OsLoginServiceRestInterceptor, "post_get_login_profile_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post_with_metadata.return_value = oslogin.LoginProfile(), metadata
...
def test_get_ssh_public_key_rest_bad_request(request_type=oslogin.GetSshPublicKeyRequest):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "users/sample1/sshPublicKeys/sample2"}
    request = request_type(**request_init)
...
def test_get_ssh_public_key_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_get_ssh_public_key") as post, mock.patch.object(
        transports.OsLoginServiceRestInterceptor, "post_get_ssh_public_key_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_import_ssh_public_key_rest_bad_request(request_type=oslogin.ImportSshPublicKeyRequest):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "users/sample1"}
    request = request_type(**request_init)
...
def test_import_ssh_public_key_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_import_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_import_ssh_public_key") as post, mock.patch.object(
        transports.OsLoginServiceRestInterceptor, "post_import_ssh_public_key_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = oslogin.ImportSshPublicKeyResponse.to_json(oslogin.ImportSshPublicKeyResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = oslogin.ImportSshPublicKeyResponse(), metadata
...
def test_update_ssh_public_key_rest_bad_request(request_type=oslogin.UpdateSshPublicKeyRequest):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "users/sample1/sshPublicKeys/sample2"}
    request = request_type(**request_init)
...
def test_update_ssh_public_key_rest_call_success(request_type):
    client = OsLoginServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_update_ssh_public_key") as post, mock.patch.object(
        transports.OsLoginServiceRestInterceptor, "post_update_ssh_public_key_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_ssh_public_key_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_posix_account_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_ssh_public_key_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_login_profile_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_ssh_public_key_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_ssh_public_key_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_ssh_public_key_empty_call_rest():
    client = OsLoginServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.OsLoginServiceGrpcTransport, grpc_helpers), (transports.OsLoginServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_os_login_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "oslogin.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://oslogin.googleapis.com:8000"
    )

...
`Cloud OS Login`_: You can use OS Login to manage access to your VM instances using IAM roles.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-os-login.svg
   :target: https://pypi.org/project/google-cloud-os-login/
.. _Cloud OS Login: https://cloud.google.com/compute/
...
.. _Enable the Cloud OS Login.:  https://cloud.google.com/compute/
...
-  Read the `Client Library Documentation`_ for Cloud OS Login
   to see other available methods on the client.
-  Read the `Cloud OS Login Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud OS Login Product documentation:  https://cloud.google.com/compute/

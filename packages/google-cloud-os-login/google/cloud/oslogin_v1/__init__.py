...
__lazy_modules__ = {
    "google.cloud.oslogin_v1.services.os_login_service",
    "google.cloud.oslogin_v1.types.oslogin",
}
...
api_core.check_python_version("google.cloud.oslogin_v1")
api_core.check_dependency_versions("google.cloud.oslogin_v1")

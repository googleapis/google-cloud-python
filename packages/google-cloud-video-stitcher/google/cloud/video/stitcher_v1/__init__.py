...
from .services.video_stitcher_service import VideoStitcherServiceAsyncClient, VideoStitcherServiceClient
from .types.ad_tag_details import AdRequest, LiveAdTagDetail, RequestMetadata, ResponseMetadata, VodAdTagDetail
from .types.cdn_keys import AkamaiCdnKey, CdnKey, GoogleCdnKey, MediaCdnKey
from .types.companions import Companion, CompanionAds, HtmlAdResource, IframeAdResource, StaticAdResource
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.video.stitcher_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.video.stitcher_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.video.stitcher_v1"

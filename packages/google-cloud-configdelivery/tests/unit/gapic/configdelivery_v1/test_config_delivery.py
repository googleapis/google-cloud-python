...
from google.cloud.configdelivery_v1.services.config_delivery import ConfigDeliveryAsyncClient, ConfigDeliveryClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ConfigDeliveryClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ConfigDeliveryClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ConfigDeliveryClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        ConfigDeliveryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ConfigDeliveryClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        ConfigDeliveryClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
...
def test_config_delivery_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "configdelivery.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://configdelivery.googleapis.com"
        )
...
@pytest.mark.parametrize("client_class", [ConfigDeliveryClient, ConfigDeliveryAsyncClient])
...
def test_config_delivery_client_client_options_from_dict():
    with mock.patch("google.cloud.configdelivery_v1.services.config_delivery.transports.ConfigDeliveryGrpcTransport.__init__") as grpc_transport:
        grpc_transport.return_value = None
        client = ConfigDeliveryClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_list_resource_bundles(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_resource_bundles), "__call__") as call:
...
async def test_list_resource_bundles_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_resource_bundles), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            config_delivery.ListResourceBundlesResponse(
                resource_bundles=[
...
async def test_list_resource_bundles_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_resource_bundles), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_resource_bundles(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_resource_bundle(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_resource_bundle), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_resource_bundle(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_resource_bundle), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_update_resource_bundle(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_resource_bundle), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_resource_bundle(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_resource_bundle), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_list_fleet_packages(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_fleet_packages), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_fleet_packages_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_fleet_packages), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            config_delivery.ListFleetPackagesResponse(
                fleet_packages=[
...
async def test_list_fleet_packages_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_fleet_packages), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_fleet_packages(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_fleet_package(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_fleet_package), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_fleet_package(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_fleet_package), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_update_fleet_package(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_fleet_package), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_fleet_package(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_fleet_package), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
async def test_list_releases_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_releases), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_releases(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_variants_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_variants), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            config_delivery.ListVariantsResponse(
                variants=[
...
async def test_list_variants_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_variants), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_variants(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_rollouts_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_rollouts), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_rollouts(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_resource_bundles_rest_required_fields(request_type=config_delivery.ListResourceBundlesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_resource_bundles._get_unset_required_fields(
        jsonified_request
    )
...
def test_list_resource_bundles_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/resourceBundles" % client.transport._host, args[1])
...
def test_get_resource_bundle_rest_required_fields(request_type=config_delivery.GetResourceBundleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_resource_bundle._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_resource_bundle_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/resourceBundles/*}" % client.transport._host, args[1])
...
def test_create_resource_bundle_rest_required_fields(request_type=config_delivery.CreateResourceBundleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_resource_bundle._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_resource_bundle_rest_required_fields(request_type=config_delivery.UpdateResourceBundleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_resource_bundle._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_resource_bundle_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource_bundle.name=projects/*/locations/*/resourceBundles/*}" % client.transport._host, args[1])
...
def test_delete_resource_bundle_rest_required_fields(request_type=config_delivery.DeleteResourceBundleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_resource_bundle._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_fleet_packages_rest_required_fields(request_type=config_delivery.ListFleetPackagesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_fleet_packages._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_fleet_packages_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/fleetPackages" % client.transport._host, args[1])
...
def test_get_fleet_package_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/fleetPackages/*}" % client.transport._host, args[1])
...
def test_create_fleet_package_rest_required_fields(request_type=config_delivery.CreateFleetPackageRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_fleet_package._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_fleet_package_rest_required_fields(request_type=config_delivery.UpdateFleetPackageRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_fleet_package._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_fleet_package_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{fleet_package.name=projects/*/locations/*/fleetPackages/*}" % client.transport._host, args[1])
...
def test_delete_fleet_package_rest_required_fields(request_type=config_delivery.DeleteFleetPackageRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_fleet_package._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_releases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/resourceBundles/*}/releases" % client.transport._host, args[1])
...
def test_get_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1])
...
def test_update_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{release.name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1])
...
def test_list_variants_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/resourceBundles/*/releases/*}/variants" % client.transport._host, args[1])
...
def test_get_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1])
...
def test_update_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{variant.name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1]
        )
...
def test_list_rollouts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/fleetPackages/*}/rollouts" % client.transport._host, args[1])
...
def test_get_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}" % client.transport._host, args[1])
...
def test_suspend_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:suspend" % client.transport._host, args[1])
...
def test_resume_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:resume" % client.transport._host, args[1])
...
def test_abort_rollout_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/fleetPackages/*/rollouts/*}:abort" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ConfigDeliveryClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ConfigDeliveryClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ConfigDeliveryClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = ConfigDeliveryAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ConfigDeliveryAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ConfigDeliveryClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_resource_bundles_rest_bad_request(request_type=config_delivery.ListResourceBundlesRequest):
    client = ConfigDeliveryClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_resource_bundles_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_resource_bundles") as post, mock.patch.object(
        transports.ConfigDeliveryRestInterceptor, "post_list_resource_bundles_with_metadata"
...
def test_get_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_resource_bundle") as post, mock.patch.object(
        transports.ConfigDeliveryRestInterceptor, "post_get_resource_bundle_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConfigDeliveryRestInterceptor, "post_create_resource_bundle_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConfigDeliveryRestInterceptor, "post_update_resource_bundle_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_resource_bundle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConfigDeliveryRestInterceptor, "post_delete_resource_bundle_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_fleet_packages_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_fleet_packages") as post, mock.patch.object(
        transports.ConfigDeliveryRestInterceptor, "post_list_fleet_packages_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_fleet_package") as post, mock.patch.object(
...
def test_create_fleet_package_rest_call_success(request_type):
    ...
    request_init["fleet_package"] = {
        ...
        "target": {"fleet": {"project": "project_value", "selector": {"match_labels": {}}}},
...
def test_create_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConfigDeliveryRestInterceptor, "post_create_fleet_package_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConfigDeliveryRestInterceptor, "post_update_fleet_package_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_fleet_package_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ConfigDeliveryRestInterceptor, "post_delete_fleet_package_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_releases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_releases") as post, mock.patch.object(
...
def test_get_release_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_release") as post, mock.patch.object(
...
def test_create_release_rest_call_success(request_type):
    ...
    request_init["release"] = {
        ...
        "version": "version_value",
        "publish_time": {},
        "info": {"oci_image_path": "oci_image_path_value", "variant_oci_image_paths": {}},
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_list_variants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_variants") as post, mock.patch.object(
...
def test_get_variant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_variant") as post, mock.patch.object(
...
def test_list_rollouts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_list_rollouts") as post, mock.patch.object(
...
def test_get_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ConfigDeliveryRestInterceptor, "post_get_rollout") as post, mock.patch.object(
...
def test_config_delivery_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ConfigDeliveryTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_config_delivery_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.configdelivery_v1.services.config_delivery.transports.ConfigDeliveryTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.ConfigDeliveryGrpcTransport, grpc_helpers), (transports.ConfigDeliveryGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_config_delivery_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ConfigDeliveryRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_config_delivery_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "configdelivery.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://configdelivery.googleapis.com:8000"
    )
...
@pytest.mark.parametrize("transport_class", [transports.ConfigDeliveryGrpcTransport, transports.ConfigDeliveryGrpcAsyncIOTransport])
def test_config_delivery_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_fleet_package_path():
    ...
    location = "clam"
    fleet_package = "whelk"
    expected = "projects/{project}/locations/{location}/fleetPackages/{fleet_package}".format(
        project=project,
        location=location,
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ConfigDeliveryClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

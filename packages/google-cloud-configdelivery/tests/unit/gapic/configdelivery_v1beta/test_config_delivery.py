...
from google.cloud.configdelivery_v1beta.services.config_delivery import ConfigDeliveryAsyncClient, ConfigDeliveryClient, pagers, transports
...
def test_update_release_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{release.name=projects/*/locations/*/resourceBundles/*/releases/*}" % client.transport._host, args[1]
        )
...
def test_list_variants_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/resourceBundles/*/releases/*}/variants" % client.transport._host, args[1]
        )
...
def test_get_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1]
        )
...
def test_update_variant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{variant.name=projects/*/locations/*/resourceBundles/*/releases/*/variants/*}" % client.transport._host, args[1]
        )

...
class ListResourceBundlesPager:
    ...
    :class:`google.cloud.configdelivery_v1.types.ListResourceBundlesResponse` object, and
    ...
    All the usual :class:`google.cloud.configdelivery_v1.types.ListResourceBundlesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.configdelivery_v1.types.ListResourceBundlesRequest):
                The initial request object.
            response (google.cloud.configdelivery_v1.types.ListResourceBundlesResponse):
...
class ListFleetPackagesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.configdelivery_v1.types.ListFleetPackagesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.configdelivery_v1.types.ListFleetPackagesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.configdelivery_v1.types.ListFleetPackagesRequest):
                The initial request object.
            response (google.cloud.configdelivery_v1.types.ListFleetPackagesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListReleasesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.configdelivery_v1.types.ListReleasesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``releases`` field.
    ...
    All the usual :class:`google.cloud.configdelivery_v1.types.ListReleasesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.configdelivery_v1.types.ListReleasesRequest):
                The initial request object.
            response (google.cloud.configdelivery_v1.types.ListReleasesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListVariantsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.configdelivery_v1.types.ListVariantsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``variants`` field.
    ...
    All the usual :class:`google.cloud.configdelivery_v1.types.ListVariantsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.configdelivery_v1.types.ListVariantsRequest):
                The initial request object.
            response (google.cloud.configdelivery_v1.types.ListVariantsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListRolloutsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.configdelivery_v1.types.ListRolloutsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``rollouts`` field.
    ...
    All the usual :class:`google.cloud.configdelivery_v1.types.ListRolloutsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.configdelivery_v1.types.ListRolloutsRequest):
                The initial request object.
            response (google.cloud.configdelivery_v1.types.ListRolloutsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

...
class ConfigDeliveryTransport(abc.ABC):
    """Abstract transport class for ConfigDelivery."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "configdelivery.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_resource_bundles: gapic_v1.method.wrap_method(
            ...
            self.get_resource_bundle: gapic_v1.method.wrap_method(
            ...
            self.create_resource_bundle: gapic_v1.method.wrap_method(
                self.create_resource_bundle,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_resource_bundle: gapic_v1.method.wrap_method(
                self.update_resource_bundle,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_resource_bundle: gapic_v1.method.wrap_method(
                self.delete_resource_bundle,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_fleet_packages: gapic_v1.method.wrap_method(
            ...
            self.get_fleet_package: gapic_v1.method.wrap_method(
            ...
            self.create_fleet_package: gapic_v1.method.wrap_method(
                self.create_fleet_package,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_fleet_package: gapic_v1.method.wrap_method(
                self.update_fleet_package,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_fleet_package: gapic_v1.method.wrap_method(
            ...
            self.list_variants: gapic_v1.method.wrap_method(
                self.list_variants,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.get_variant: gapic_v1.method.wrap_method(
                self.get_variant,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.create_variant: gapic_v1.method.wrap_method(
                self.create_variant,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_variant: gapic_v1.method.wrap_method(
                self.update_variant,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_variant: gapic_v1.method.wrap_method(
                self.delete_variant,
                default_timeout=60.0,
                client_info=client_info,
            ),
            ...
            self.suspend_rollout: gapic_v1.method.wrap_method(
                self.suspend_rollout,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.resume_rollout: gapic_v1.method.wrap_method(
                self.resume_rollout,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.abort_rollout: gapic_v1.method.wrap_method(
                self.abort_rollout,
                default_timeout=60.0,
                client_info=client_info,
            ),
...
__all__ = ("ConfigDeliveryTransport",)

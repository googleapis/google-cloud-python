...
__lazy_modules__ = {
    "google.cloud.configdelivery_v1alpha.services.config_delivery",
    "google.cloud.configdelivery_v1alpha.types.config_delivery",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.configdelivery_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.cloud.configdelivery_v1alpha")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.configdelivery_v1alpha"

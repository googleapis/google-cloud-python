...
__lazy_modules__ = {
    "google.cloud.apigateway_v1.services.api_gateway_service",
    "google.cloud.apigateway_v1.types.apigateway",
    "google.cloud.apigateway_v1.types.apigateway_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.apigateway_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.apigateway_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.apigateway_v1"

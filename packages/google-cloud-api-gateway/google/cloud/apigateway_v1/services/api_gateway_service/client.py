...
class ApiGatewayServiceClient(metaclass=ApiGatewayServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ApiGatewayServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ApiGatewayServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ApiGatewayServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ApiGatewayServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ApiGatewayServiceClient._get_api_endpoint(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                to be overwritten in the Gateway
    ...
    def update_api(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Field mask is used to specify the fields
                to be overwritten in the Api resource by
    ...
    def update_api_config(
        ...
        *,
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Field mask is used to specify the fields
                to be overwritten in the ApiConfig
                resource by the update. The fields
                specified in the update_mask are
                relative to the resource, not the full
                request. A field will be overwritten if

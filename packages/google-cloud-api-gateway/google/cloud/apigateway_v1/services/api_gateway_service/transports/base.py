...
class ApiGatewayServiceTransport(abc.ABC):
    ...
    def get_gateway(
        ...
        typing.Union[apigateway.Gateway, typing.Awaitable[apigateway.Gateway]],
    ]:
        raise NotImplementedError()
    ...
    def list_apis(
        ...
        typing.Union[
            apigateway.ListApisResponse, typing.Awaitable[apigateway.ListApisResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_api(
        ...
        typing.Union[apigateway.Api, typing.Awaitable[apigateway.Api]],
    ]:
        raise NotImplementedError()
    ...
    def get_api_config(
        ...
        typing.Union[apigateway.ApiConfig, typing.Awaitable[apigateway.ApiConfig]],
    ]:
        raise NotImplementedError()

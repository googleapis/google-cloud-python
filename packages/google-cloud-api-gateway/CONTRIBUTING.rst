...
- In order to make ``nox -s lint`` run faster, you can set some environment
  ...
  version of ``python-api-gateway``. The the suggested remote name ``upstream``
...
instead of
``https://github.com/googleapis/python-api-gateway/blob/master/CONTRIBUTING.rst``)
...
.. _config: https://github.com/googleapis/python-api-gateway/blob/master/noxfile.py

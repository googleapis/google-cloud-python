...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ApiGatewayServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ApiGatewayServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ApiGatewayServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        ApiGatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        ApiGatewayServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ApiGatewayServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_api_gateway_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "apigateway.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://apigateway.googleapis.com"
        )
...
async def test_list_gateways_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_gateways), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_gateways(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_api_configs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_api_configs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_api_configs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_transport_kind_grpc():
    transport = ApiGatewayServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ApiGatewayServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ApiGatewayServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ApiGatewayServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_gateways_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_gateways") as post, mock.patch.object(
...
def test_get_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_gateway") as post, mock.patch.object(
...
def test_list_apis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_apis") as post, mock.patch.object(
...
def test_get_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_api") as post, mock.patch.object(
...
def test_list_api_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_list_api_configs") as post, mock.patch.object(
        transports.ApiGatewayServiceRestInterceptor, "post_list_api_configs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiGatewayServiceRestInterceptor, "post_get_api_config") as post, mock.patch.object(
...
def test_create_api_config_rest_call_success(request_type):
    ...
    request_init["api_config"] = {
        ...
        "service_config_id": "service_config_id_value",
        "state": 1,
        "openapi_documents": [{"document": {"path": "path_value", "contents": b"contents_blob"}}],
...
def test_create_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ApiGatewayServiceRestInterceptor, "post_create_api_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ApiGatewayServiceRestInterceptor, "post_update_api_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_api_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ApiGatewayServiceRestInterceptor, "post_delete_api_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.ApiGatewayServiceGrpcTransport, grpc_helpers), (transports.ApiGatewayServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_api_gateway_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "apigateway.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://apigateway.googleapis.com:8000"
    )

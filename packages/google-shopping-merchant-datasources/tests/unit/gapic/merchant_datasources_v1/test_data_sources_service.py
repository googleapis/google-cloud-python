...
from google.shopping.merchant_datasources_v1.types import (
    datasources,
    datasourcetypes,
    fileinputs,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        DataSourcesServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DataSourcesServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        DataSourcesServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        DataSourcesServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
...
def test__get_client_cert_source():
    ...
    assert (
        DataSourcesServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                DataSourcesServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(DataSourcesServiceClient),
)
@mock.patch.object(
    DataSourcesServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(DataSourcesServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DataSourcesServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DataSourcesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = DataSourcesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        DataSourcesServiceClient._get_api_endpoint(
    ...
    assert (
        DataSourcesServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        DataSourcesServiceClient._get_api_endpoint(
    ...
    assert (
        DataSourcesServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        DataSourcesServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        DataSourcesServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        DataSourcesServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        DataSourcesServiceClient._get_universe_domain(None, None)
        == DataSourcesServiceClient._DEFAULT_UNIVERSE
    )
...
def test_data_sources_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_data_sources_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_data_sources_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_data_sources_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_data_sources_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [DataSourcesServiceClient, DataSourcesServiceAsyncClient]
)
@mock.patch.object(
    DataSourcesServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DataSourcesServiceClient),
)
@mock.patch.object(
    DataSourcesServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(DataSourcesServiceAsyncClient),
)
...
def test_data_sources_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_data_sources_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_data_sources_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_create_data_source(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_data_source), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = datasources.DataSource(
            name="name_value",
...
def test_create_data_source_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_data_source in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_data_source_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_data_source
            in client._client._transport._wrapped_methods
        )
    ...
    with mock.patch.object(
        ...
        client.create_data_source(
            ...
            data_source=datasources.DataSource(
                primary_product_data_source=datasourcetypes.PrimaryProductDataSource(
                    legacy_local=True
                )
            ),
        )
        ...
        mock_val = datasources.DataSource(
            primary_product_data_source=datasourcetypes.PrimaryProductDataSource(
                legacy_local=True
            )
        )
...
def test_delete_data_source(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_data_source), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_delete_data_source_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_data_source in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_data_source_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_data_source
            in client._client._transport._wrapped_methods
        )
...
def test_fetch_data_source(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.fetch_data_source), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_fetch_data_source_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.fetch_data_source
            in client._client._transport._wrapped_methods
        )
...
def test_get_data_source_rest_required_fields(
    request_type=datasources.GetDataSourceRequest,
):
...
def test_get_data_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/datasources/v1/{name=accounts/*/dataSources/*}"
...
def test_list_data_sources_rest_required_fields(
    request_type=datasources.ListDataSourcesRequest,
):
    transport_class = transports.DataSourcesServiceRestTransport
...
def test_list_data_sources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/datasources/v1/{parent=accounts/*}/dataSources"
            % client.transport._host,
            args[1],
        )
...
def test_list_data_sources_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            datasources.ListDataSourcesResponse.to_json(x) for x in response
        )
...
def test_create_data_source_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_data_source._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_data_source_rest_required_fields(
    request_type=datasources.UpdateDataSourceRequest,
):
    transport_class = transports.DataSourcesServiceRestTransport
...
def test_update_data_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "data_source": {"name": "accounts/sample1/dataSources/sample2"}
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/datasources/v1/{data_source.name=accounts/*/dataSources/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_data_source_rest_required_fields(
    request_type=datasources.DeleteDataSourceRequest,
):
    transport_class = transports.DataSourcesServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_data_source._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_data_source_rest_required_fields(
    request_type=datasources.FetchDataSourceRequest,
):
    transport_class = transports.DataSourcesServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).fetch_data_source._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc_asyncio():
    transport = DataSourcesServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = DataSourcesServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_get_data_source_rest_interceptors(null_interceptor):
    transport = transports.DataSourcesServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.DataSourcesServiceRestInterceptor(),
    )
    client = DataSourcesServiceClient(transport=transport)
...
def test_fetch_data_source_rest_bad_request(
    request_type=datasources.FetchDataSourceRequest,
):
    client = DataSourcesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
@pytest.mark.parametrize(
    ...
    [
        (transports.DataSourcesServiceGrpcTransport, grpc_helpers),
        (transports.DataSourcesServiceGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_data_sources_service_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.DataSourcesServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = DataSourcesServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
from google.shopping.merchant_datasources_v1beta.services.data_sources_service import pagers
from google.shopping.merchant_datasources_v1beta.types import datasources, datasourcetypes, fileinputs
...
class DataSourcesServiceClient(metaclass=DataSourcesServiceClientMeta):
    ...
    def data_source_path(
        ...
        return "accounts/{account}/dataSources/{datasource}".format(
            account=account,
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = DataSourcesServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or DataSourcesServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.datasources_v1beta.DataSourcesServiceClient`.",
                    extra={
    ...
    def get_data_source(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1beta.types.GetDataSourceRequest, dict]):
    ...
    def list_data_sources(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1beta.types.ListDataSourcesRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_datasources_v1beta.services.data_sources_service.pagers.ListDataSourcesPager:
    ...
    def create_data_source(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1beta.types.CreateDataSourceRequest, dict]):
                The request object. Request message for the
    ...
    def update_data_source(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1beta.types.UpdateDataSourceRequest, dict]):
                The request object. Request message for the
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("data_source.name", request.data_source.name),)),)
    ...
    def delete_data_source(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1beta.types.DeleteDataSourceRequest, dict]):
                The request object. Request message for the
    ...
    def fetch_data_source(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_datasources_v1beta.types.FetchDataSourceRequest, dict]):
                The request object. Request message for the

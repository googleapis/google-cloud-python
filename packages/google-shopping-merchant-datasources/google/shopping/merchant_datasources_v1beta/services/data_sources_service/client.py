...
class DataSourcesServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[DataSourcesServiceTransport]]
...
class DataSourcesServiceClient(metaclass=DataSourcesServiceClientMeta):
    ...
    def parse_data_source_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/dataSources/(?P<datasource>.+?)$", path
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DataSourcesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DataSourcesServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DataSourcesServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DataSourcesServiceClient._get_api_endpoint(

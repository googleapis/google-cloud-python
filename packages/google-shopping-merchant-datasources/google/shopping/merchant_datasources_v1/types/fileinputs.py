...
class FileInput(proto.Message):
    ...
    Attributes:
        fetch_settings (google.shopping.merchant_datasources_v1.types.FileInput.FetchSettings):
        ...
        file_input_type (google.shopping.merchant_datasources_v1.types.FileInput.FileInputType):
    ...
    class FileInputType(proto.Enum):
        ...
        Values:
            ...
            GOOGLE_SHEETS (3):
                ...
                [fetch_uri][google.shopping.merchant.datasources.v1.FileInput.FetchSettings.fetch_uri].
                However, you can't set up ``GOOGLE_SHEETS`` as a data source
                through the API. To add ``GOOGLE_SHEETS`` as a data source
    ...
    class FetchSettings(proto.Message):
        ...
        Attributes:
            ...
            time_zone (str):
                ...
                "America/Los_Angeles".
            frequency (google.shopping.merchant_datasources_v1.types.FileInput.FetchSettings.Frequency):
        ...
        class Frequency(proto.Enum):
            ...
            day <../Shared.Types/TimeOfDay>`__ are required. For a weekly fetch
            schedule, `day of week <../Shared.Types/DayOfWeek>`__ and `hour of
            day <../Shared.Types/TimeOfDay>`__ are required. For a daily fetch
            schedule, only an `hour of day <../Shared.Types/TimeOfDay>`__ is
            required.

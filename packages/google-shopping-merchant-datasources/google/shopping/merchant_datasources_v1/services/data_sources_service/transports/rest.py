...
from google.shopping.merchant_datasources_v1._compat import transcode_request
        ...
        def __call__(
            ...
            *,
            ...
            Returns:
                ~.datasources.DataSource:
                    The `data
                source </merchant/api/guides/data-sources/overview>`__
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.CreateDataSource",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.create_data_source",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
                        "rpcName": "CreateDataSource",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.DeleteDataSource",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.FetchDataSource",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.GetDataSource",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.get_data_source",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
                        "rpcName": "GetDataSource",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.ListDataSources",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.list_data_sources",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
                        "rpcName": "ListDataSources",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.UpdateDataSource",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.datasources_v1.DataSourcesServiceClient.update_data_source",
                    extra={
                        "serviceName": "google.shopping.merchant.datasources.v1.DataSourcesService",
                        "rpcName": "UpdateDataSource",
                        "metadata": http_response["headers"],

...
__lazy_modules__ = {
    "google.cloud.recommender_v1.services.recommender",
    "google.cloud.recommender_v1.types.insight",
    "google.cloud.recommender_v1.types.insight_type_config",
    "google.cloud.recommender_v1.types.recommendation",
    "google.cloud.recommender_v1.types.recommender_config",
    "google.cloud.recommender_v1.types.recommender_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.recommender_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.recommender_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.recommender_v1"

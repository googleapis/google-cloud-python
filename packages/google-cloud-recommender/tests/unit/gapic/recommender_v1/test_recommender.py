...
from google.cloud.recommender_v1.services.recommender import RecommenderAsyncClient, RecommenderClient, pagers, transports
...
async def test_mark_recommendation_dismissed_async(
    transport: str = "grpc_asyncio", request_type=recommender_service.MarkRecommendationDismissedRequest
):
    client = RecommenderAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_mark_recommendation_dismissed_rest_required_fields(request_type=recommender_service.MarkRecommendationDismissedRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mark_recommendation_dismissed._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_mark_recommendation_claimed_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markClaimed" % client.transport._host, args[1]
        )
...
def test_mark_recommendation_succeeded_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markSucceeded" % client.transport._host, args[1]
        )
...
def test_mark_recommendation_failed_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markFailed" % client.transport._host, args[1]
        )
...
def test_update_recommender_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{recommender_config.name=projects/*/locations/*/recommenders/*/config}" % client.transport._host, args[1]
        )
...
def test_update_insight_type_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{insight_type_config.name=projects/*/locations/*/insightTypes/*/config}" % client.transport._host, args[1]
        )
...
def test_mark_recommendation_dismissed_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RecommenderRestInterceptor, "post_mark_recommendation_dismissed") as post, mock.patch.object(
        transports.RecommenderRestInterceptor, "post_mark_recommendation_dismissed_with_metadata"
    ) as post_with_metadata, mock.patch.object(

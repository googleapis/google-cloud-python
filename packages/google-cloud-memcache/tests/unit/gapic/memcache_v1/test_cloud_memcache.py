...
from google.cloud.memcache_v1.services.cloud_memcache import (
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "false"}):
        assert CloudMemcacheClient._read_environment_variables() == (
            False,
            "auto",
            None,
        )
...
def test__get_client_cert_source():
    ...
    assert (
        CloudMemcacheClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        CloudMemcacheClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                CloudMemcacheClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(CloudMemcacheClient),
)
@mock.patch.object(
    CloudMemcacheAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(CloudMemcacheAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CloudMemcacheClient._DEFAULT_UNIVERSE
    default_endpoint = CloudMemcacheClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = CloudMemcacheClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == CloudMemcacheClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CloudMemcacheClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        CloudMemcacheClient._get_api_endpoint(None, None, default_universe, "always")
        == CloudMemcacheClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CloudMemcacheClient._get_api_endpoint(
    ...
    assert (
        CloudMemcacheClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        CloudMemcacheClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        CloudMemcacheClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        CloudMemcacheClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        CloudMemcacheClient._get_universe_domain(None, None)
        == CloudMemcacheClient._DEFAULT_UNIVERSE
    )
...
def test_cloud_memcache_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.memcache_v1.services.cloud_memcache.transports.CloudMemcacheGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_cloud_memcache_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_update_parameters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.update_parameters
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_parameters_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_parameters
            in client._client._transport._wrapped_methods
        )
...
def test_apply_parameters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.apply_parameters
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_apply_parameters_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.apply_parameters
            in client._client._transport._wrapped_methods
        )
...
def test_list_instances_rest_required_fields(
    request_type=cloud_memcache.ListInstancesRequest,
):
...
def test_list_instances_rest_interceptors(null_interceptor):
    transport = transports.CloudMemcacheRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.CloudMemcacheRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        req.return_value._content = cloud_memcache.ListInstancesResponse.to_json(
            cloud_memcache.ListInstancesResponse()
        )
...
def test_list_instances_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.ListInstancesRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_instances_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            cloud_memcache.ListInstancesResponse.to_json(x) for x in response
        )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_memcache.Instance.to_json(
            cloud_memcache.Instance()
        )
...
def test_get_instance_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.GetInstanceRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_instance_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.CreateInstanceRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_instance_rest_required_fields(
    request_type=cloud_memcache.UpdateInstanceRequest,
):
    transport_class = transports.CloudMemcacheRestTransport
...
def test_update_instance_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.UpdateInstanceRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_parameters_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_parameters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/instances/*}:updateParameters"
            % client.transport._host,
            args[1],
        )
...
def test_delete_instance_rest_required_fields(
    request_type=cloud_memcache.DeleteInstanceRequest,
):
    transport_class = transports.CloudMemcacheRestTransport
...
def test_delete_instance_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.DeleteInstanceRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_apply_parameters_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).apply_parameters._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_apply_parameters_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.ApplyParametersRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_apply_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/instances/*}:applyParameters"
            % client.transport._host,
            args[1],
        )
...
def test_reschedule_maintenance_rest_bad_request(
    transport: str = "rest", request_type=cloud_memcache.RescheduleMaintenanceRequest
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_reschedule_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{instance=projects/*/locations/*/instances/*}:rescheduleMaintenance"
            % client.transport._host,
            args[1],
        )
...
def test_cloud_memcache_base_transport():
    ...
    with mock.patch(
        "google.cloud.memcache_v1.services.cloud_memcache.transports.CloudMemcacheTransport.__init__"
    ) as Transport:

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        CloudMemcacheClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CloudMemcacheClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CloudMemcacheClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                CloudMemcacheClient._use_client_cert_effective()
...
def test_update_parameters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_parameters] = (
            mock_rpc
        )
        request = {}
...
def test_apply_parameters_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.apply_parameters] = (
            mock_rpc
        )
        request = {}
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_memcache.ListInstancesResponse.to_json(
            cloud_memcache.ListInstancesResponse()
        )
...
async def test_get_location_field_headers_async():
    client = CloudMemcacheAsyncClient(credentials=async_anonymous_credentials())

...
from google.cloud.memcache_v1.services.cloud_memcache import CloudMemcacheAsyncClient, CloudMemcacheClient, pagers, transports
...
def test__get_api_endpoint():
    ...
    assert (
        CloudMemcacheClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CloudMemcacheClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_cloud_memcache_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "memcache.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://memcache.googleapis.com"
        )
...
def test_transport_kind_grpc():
    transport = CloudMemcacheClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CloudMemcacheAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CloudMemcacheAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CloudMemcacheClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_list_instances") as post, mock.patch.object(
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudMemcacheRestInterceptor, "post_get_instance") as post, mock.patch.object(
...
def test_create_instance_rest_call_success(request_type):
    ...
    request_init["instance"] = {
        ...
        "memcache_nodes": [{"node_id": "node_id_value", "zone": "zone_value", "state": 1, "host": "host_value", "port": 453, "parameters": {}}],
        ...
        "maintenance_policy": {
            ...
            "weekly_maintenance_window": [
                {"day": 1, "start_time": {"hours": 561, "minutes": 773, "seconds": 751, "nanos": 543}, "duration": {"seconds": 751, "nanos": 543}}
            ],
        },
        "maintenance_schedule": {"start_time": {}, "end_time": {}, "schedule_deadline_time": {}},
    }
...
def test_reschedule_maintenance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudMemcacheRestInterceptor, "post_reschedule_maintenance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.CloudMemcacheGrpcTransport, grpc_helpers), (transports.CloudMemcacheGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_cloud_memcache_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "memcache.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://memcache.googleapis.com:8000"
    )

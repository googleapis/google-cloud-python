...
def test_apply_software_update_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.apply_software_update
        ...
        client._transport._wrapped_methods[client._transport.apply_software_update] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_apply_software_update_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.apply_software_update
            in client._client._transport._wrapped_methods
        )
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta2/{parent=projects/*/locations/*}/instances"
...
def test_get_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/{name=projects/*/locations/*/instances/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "resource": {"name": "projects/sample1/locations/sample2/instances/sample3"}
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/{resource.name=projects/*/locations/*/instances/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/{name=projects/*/locations/*/instances/*}:updateParameters"
            % client.transport._host,
            args[1],
        )
...
def test_apply_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/{name=projects/*/locations/*/instances/*}:applyParameters"
            % client.transport._host,
            args[1],
        )
...
def test_apply_software_update_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseApplySoftwareUpdate,
        "_BaseApplySoftwareUpdate__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_apply_software_update_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/{instance=projects/*/locations/*/instances/*}:applySoftwareUpdate"
            % client.transport._host,
            args[1],
        )
...
def test_reschedule_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/{instance=projects/*/locations/*/instances/*}:rescheduleMaintenance"
            % client.transport._host,
            args[1],
        )
...
def test_apply_software_update_rest_bad_request(
    request_type=cloud_memcache.ApplySoftwareUpdateRequest,
):
    client = CloudMemcacheClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_apply_software_update_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(operation.Operation, "_set_result_from_operation"),
        mock.patch.object(
            transports.CloudMemcacheRestInterceptor, "post_apply_software_update"
        ) as post,
        mock.patch.object(
            transports.CloudMemcacheRestInterceptor,
        ...
        mock.patch.object(
            transports.CloudMemcacheRestInterceptor, "pre_apply_software_update"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_memcache.ApplySoftwareUpdateRequest.pb(
            cloud_memcache.ApplySoftwareUpdateRequest()
        )
        transcode.return_value = {
            "method": "post",

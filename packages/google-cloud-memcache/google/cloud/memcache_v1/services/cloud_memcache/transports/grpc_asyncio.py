...
class CloudMemcacheGrpcAsyncIOTransport(CloudMemcacheTransport):
    ...
    @property
    def list_instances(self) -> Callable[[cloud_memcache.ListInstancesRequest], Awaitable[cloud_memcache.ListInstancesResponse]]:
    ...
    @property
    def get_instance(self) -> Callable[[cloud_memcache.GetInstanceRequest], Awaitable[cloud_memcache.Instance]]:
    ...
    @property
    def create_instance(self) -> Callable[[cloud_memcache.CreateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_instance(self) -> Callable[[cloud_memcache.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_parameters(self) -> Callable[[cloud_memcache.UpdateParametersRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_instance(self) -> Callable[[cloud_memcache.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def apply_parameters(self) -> Callable[[cloud_memcache.ApplyParametersRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def reschedule_maintenance(self) -> Callable[[cloud_memcache.RescheduleMaintenanceRequest], Awaitable[operations_pb2.Operation]]:

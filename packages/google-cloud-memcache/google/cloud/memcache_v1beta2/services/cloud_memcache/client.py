...
class CloudMemcacheClient(metaclass=CloudMemcacheClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudMemcacheClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = CloudMemcacheClient._read_environment_variables()
        self._client_cert_source = CloudMemcacheClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CloudMemcacheClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CloudMemcacheClient._get_api_endpoint(

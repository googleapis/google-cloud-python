...
__lazy_modules__ = {
    "google.cloud.memcache_v1beta2.services.cloud_memcache",
...
api_core.check_python_version("google.cloud.memcache_v1beta2")
api_core.check_dependency_versions("google.cloud.memcache_v1beta2")

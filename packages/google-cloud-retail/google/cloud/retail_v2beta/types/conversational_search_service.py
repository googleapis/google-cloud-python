...
from google.cloud.retail_v2beta.types import common, safety, search_service
...
class ConversationalSearchRequest(proto.Message):
    ...
    Attributes:
        ...
        search_params (google.cloud.retail_v2beta.types.ConversationalSearchRequest.SearchParams):
        ...
        conversational_filtering_spec (google.cloud.retail_v2beta.types.ConversationalSearchRequest.ConversationalFilteringSpec):
        ...
        user_labels (MutableMapping[str, str]):
            ...
            for more details.
        safety_settings (MutableSequence[google.cloud.retail_v2beta.types.SafetySetting]):
    ...
    class UserAnswer(proto.Message):
        ...
        Attributes:
            ...
            selected_answer (google.cloud.retail_v2beta.types.ConversationalSearchRequest.UserAnswer.SelectedAnswer):
    ...
    class ConversationalFilteringSpec(proto.Message):
        ...
        Attributes:
            enable_conversational_filtering (bool):
                ...
                instead.
            user_answer (google.cloud.retail_v2beta.types.ConversationalSearchRequest.UserAnswer):
            ...
            conversational_filtering_mode (google.cloud.retail_v2beta.types.ConversationalSearchRequest.ConversationalFilteringSpec.Mode):
...
class ConversationalSearchResponse(proto.Message):
    ...
    Attributes:
        ...
        followup_question (google.cloud.retail_v2beta.types.ConversationalSearchResponse.FollowupQuestion):
        ...
        state (google.cloud.retail_v2beta.types.ConversationalSearchResponse.State):
    ...
    class FollowupQuestion(proto.Message):
        ...
        Attributes:
            followup_question (str):
                The conversational followup question
                generated for Intent refinement.
            suggested_answers (MutableSequence[google.cloud.retail_v2beta.types.ConversationalSearchResponse.FollowupQuestion.SuggestedAnswer]):
    ...
    class ConversationalFilteringResult(proto.Message):
        ...
        Attributes:
            ...
            additional_filter (google.cloud.retail_v2beta.types.ConversationalSearchResponse.ConversationalFilteringResult.AdditionalFilter):

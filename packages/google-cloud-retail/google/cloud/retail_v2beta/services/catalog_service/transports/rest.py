...
class CatalogServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_batch_remove_catalog_attributes(
        self, request: catalog_service.BatchRemoveCatalogAttributesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[catalog_service.BatchRemoveCatalogAttributesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_batch_remove_catalog_attributes_with_metadata(
        self, response: catalog_service.BatchRemoveCatalogAttributesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[catalog_service.BatchRemoveCatalogAttributesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_remove_catalog_attributes
    ...
    class _BatchRemoveCatalogAttributes(_BaseCatalogServiceRestTransport._BaseBatchRemoveCatalogAttributes, CatalogServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = CatalogServiceRestTransport._BatchRemoveCatalogAttributes._get_response(
                self._host, metadata, query_params, self._session, timeout, transcoded_request, body
            )

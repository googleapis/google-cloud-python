...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
    ...
    def create_model(
        ...
        [model_service.CreateModelRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def pause_model(
        self,
    ) -> Callable[[model_service.PauseModelRequest], Awaitable[model.Model]]:
    ...
    def resume_model(
        self,
    ) -> Callable[[model_service.ResumeModelRequest], Awaitable[model.Model]]:
    ...
    def delete_model(
        self,
    ) -> Callable[[model_service.DeleteModelRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def update_model(
        self,
    ) -> Callable[[model_service.UpdateModelRequest], Awaitable[gcr_model.Model]]:
    ...
    def tune_model(
        ...
        [model_service.TuneModelRequest], Awaitable[operations_pb2.Operation]
    ]:

...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
    ...
    @property
    def create_model(self) -> Callable[[model_service.CreateModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def pause_model(self) -> Callable[[model_service.PauseModelRequest], Awaitable[model.Model]]:
    ...
    @property
    def resume_model(self) -> Callable[[model_service.ResumeModelRequest], Awaitable[model.Model]]:
    ...
    @property
    def delete_model(self) -> Callable[[model_service.DeleteModelRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def update_model(self) -> Callable[[model_service.UpdateModelRequest], Awaitable[gcr_model.Model]]:
    ...
    @property
    def tune_model(self) -> Callable[[model_service.TuneModelRequest], Awaitable[operations_pb2.Operation]]:

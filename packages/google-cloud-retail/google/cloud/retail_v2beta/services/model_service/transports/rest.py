...
class ModelServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_pause_model(self, response: model.Model) -> model.Model:
        ...
        DEPRECATED. Please use the `post_pause_model_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ModelService server but before
        it is returned to user code. This `post_pause_model` interceptor runs
        before the `post_pause_model_with_metadata` interceptor.
        """
        return response

    def post_pause_model_with_metadata(
        self, response: model.Model, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[model.Model, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for pause_model
        ...
        We recommend only using this `post_pause_model_with_metadata`
        interceptor in new development instead of the `post_pause_model` interceptor.
        When both interceptors are used, this `post_pause_model_with_metadata` interceptor runs after the
        `post_pause_model` interceptor. The (possibly modified) response returned by
        `post_pause_model` will be passed to
        `post_pause_model_with_metadata`.
        """
        return response, metadata
    ...
    def post_resume_model(self, response: model.Model) -> model.Model:
        ...
        DEPRECATED. Please use the `post_resume_model_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ModelService server but before
        it is returned to user code. This `post_resume_model` interceptor runs
        before the `post_resume_model_with_metadata` interceptor.
        """
        return response

    def post_resume_model_with_metadata(
        self, response: model.Model, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[model.Model, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for resume_model
        ...
        We recommend only using this `post_resume_model_with_metadata`
        interceptor in new development instead of the `post_resume_model` interceptor.
        When both interceptors are used, this `post_resume_model_with_metadata` interceptor runs after the
        `post_resume_model` interceptor. The (possibly modified) response returned by
        `post_resume_model` will be passed to
        `post_resume_model_with_metadata`.
        """
        return response, metadata
    ...
    def post_tune_model(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the ModelService server but before
        it is returned to user code. This `post_tune_model` interceptor runs
        before the `post_tune_model_with_metadata` interceptor.
        """
        return response
    ...
    def post_tune_model_with_metadata(
        ...
        We recommend only using this `post_tune_model_with_metadata`
        interceptor in new development instead of the `post_tune_model` interceptor.
        When both interceptors are used, this `post_tune_model_with_metadata` interceptor runs after the
        `post_tune_model` interceptor. The (possibly modified) response returned by
        `post_tune_model` will be passed to
        `post_tune_model_with_metadata`.
        """
        return response, metadata
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseModelServiceRestTransport._BaseCreateModel,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.CreateModel",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.create_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "CreateModel",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseModelServiceRestTransport._BaseDeleteModel,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.DeleteModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "DeleteModel",
                        "httpRequest": http_request,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.GetModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "GetModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.get_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "GetModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.ListModels",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "ListModels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.list_models",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "ListModels",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseModelServiceRestTransport._BasePauseModel,
                    "_BasePauseModel__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.PauseModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "PauseModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.pause_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "PauseModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseModelServiceRestTransport._BaseResumeModel,
                    "_BaseResumeModel__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.ResumeModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "ResumeModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.resume_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "ResumeModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseModelServiceRestTransport._BaseTuneModel,
                    "_BaseTuneModel__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.TuneModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "TuneModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.tune_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "TuneModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseModelServiceRestTransport._BaseUpdateModel,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.UpdateModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "UpdateModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceClient.update_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "UpdateModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2beta.ModelServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2beta.ModelServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2beta.ModelService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

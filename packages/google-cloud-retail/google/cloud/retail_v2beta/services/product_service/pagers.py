...
from google.cloud.retail_v2beta.types import product, product_service
...
class ListProductsPager:
    ...
    :class:`google.cloud.retail_v2beta.types.ListProductsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2beta.types.ListProductsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            response (google.cloud.retail_v2beta.types.ListProductsResponse):

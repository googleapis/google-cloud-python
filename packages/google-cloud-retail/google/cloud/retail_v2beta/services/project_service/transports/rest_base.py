...
class _BaseProjectServiceRestTransport(ProjectServiceTransport):
    ...
    class _BaseGetAlertConfig:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseProjectServiceRestTransport._BaseGetAlertConfig._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateAlertConfig:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseProjectServiceRestTransport._BaseUpdateAlertConfig._get_unset_required_fields(
                    query_params
                )
            )

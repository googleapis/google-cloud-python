    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2beta.ConversationalSearchServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_conversational_search():
                # Create a client
                client = retail_v2beta.ConversationalSearchServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.ConversationalSearchRequest, dict]]):
        ...
        Returns:
            AsyncIterable[google.cloud.retail_v2beta.types.ConversationalSearchResponse]:

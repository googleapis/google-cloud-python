    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2beta.PredictionServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_predict():
                # Create a client
                client = retail_v2beta.PredictionServiceAsyncClient()
                ...
                request = retail_v2beta.PredictRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2beta.types.PredictRequest, dict]]):
        ...
        Returns:
            google.cloud.retail_v2beta.types.PredictResponse:

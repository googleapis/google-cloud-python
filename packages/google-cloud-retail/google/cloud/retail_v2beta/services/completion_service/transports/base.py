...
from google.cloud.retail_v2beta.types import completion_service, import_config
...
class CompletionServiceTransport(abc.ABC):
    ...
    def complete_query(
        ...
        Union[completion_service.CompleteQueryResponse, Awaitable[completion_service.CompleteQueryResponse]],
    ]:
        raise NotImplementedError()
    ...
    def import_completion_data(
        self,
    ) -> Callable[[import_config.ImportCompletionDataRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

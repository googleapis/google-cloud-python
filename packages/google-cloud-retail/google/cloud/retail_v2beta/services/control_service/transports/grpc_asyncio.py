...
class ControlServiceGrpcAsyncIOTransport(ControlServiceTransport):
    ...
    @property
    def create_control(self) -> Callable[[control_service.CreateControlRequest], Awaitable[gcr_control.Control]]:
        ...
        if "create_control" not in self._stubs:
            self._stubs["create_control"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_control(self) -> Callable[[control_service.DeleteControlRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if "delete_control" not in self._stubs:
            self._stubs["delete_control"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_control(self) -> Callable[[control_service.UpdateControlRequest], Awaitable[gcr_control.Control]]:
        ...
        if "update_control" not in self._stubs:
            self._stubs["update_control"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_control(self) -> Callable[[control_service.GetControlRequest], Awaitable[control.Control]]:
        ...
        if "get_control" not in self._stubs:
            self._stubs["get_control"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_controls(self) -> Callable[[control_service.ListControlsRequest], Awaitable[control_service.ListControlsResponse]]:
        ...
        if "list_controls" not in self._stubs:
            self._stubs["list_controls"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_control: self._wrap_method(
                self.create_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_control: self._wrap_method(
                self.delete_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_control: self._wrap_method(
                self.update_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_control: self._wrap_method(
                self.get_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_controls: self._wrap_method(
                self.list_controls,
                default_timeout=None,
                client_info=client_info,
            ),

...
class ControlServiceGrpcAsyncIOTransport(ControlServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_control: gapic_v1.method_async.wrap_method(
                self.create_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_control: gapic_v1.method_async.wrap_method(
                self.delete_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_control: gapic_v1.method_async.wrap_method(
                self.update_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_control: gapic_v1.method_async.wrap_method(
                self.get_control,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_controls: gapic_v1.method_async.wrap_method(
                self.list_controls,
                default_timeout=None,
                client_info=client_info,
            ),

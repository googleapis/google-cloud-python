...
class CompletionServiceClient(metaclass=CompletionServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CompletionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CompletionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CompletionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CompletionServiceTransport, Callable[..., CompletionServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,CompletionServiceTransport,Callable[..., CompletionServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CompletionServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CompletionServiceClient._read_environment_variables()
        self._client_cert_source = CompletionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CompletionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if transport_provided:
            ...
            self._transport = cast(CompletionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or CompletionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CompletionServiceTransport], Callable[..., CompletionServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2.CompletionServiceClient`.",
                    extra={
    ...
    def import_completion_data(
        self,
        request: Optional[Union[import_config.ImportCompletionDataRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),

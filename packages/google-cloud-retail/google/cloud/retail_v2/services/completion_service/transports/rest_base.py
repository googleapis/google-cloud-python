...
class _BaseCompletionServiceRestTransport(CompletionServiceTransport):
    ...
    class _BaseCompleteQuery:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v2/{catalog=projects/*/locations/*/catalogs/*}:completeQuery",
                },
            ]
            return http_options
    ...
    class _BaseImportCompletionData:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*/locations/*/catalogs/*}/completionData:import",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseCompletionServiceRestTransport._BaseImportCompletionData._get_unset_required_fields(query_params))

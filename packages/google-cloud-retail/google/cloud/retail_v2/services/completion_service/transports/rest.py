...
class CompletionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_import_completion_data(
        self, request: import_config.ImportCompletionDataRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[import_config.ImportCompletionDataRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    class _ImportCompletionData(_BaseCompletionServiceRestTransport._BaseImportCompletionData, CompletionServiceRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = CompletionServiceRestTransport._ImportCompletionData._get_response(

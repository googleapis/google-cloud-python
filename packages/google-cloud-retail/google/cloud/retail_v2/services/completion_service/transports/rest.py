...
class CompletionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_import_completion_data_with_metadata(
        self,
...
class CompletionServiceRestTransport(_BaseCompletionServiceRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[CompletionServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.CompletionServiceClient.CompleteQuery",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.CompletionServiceClient.complete_query",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
                        "rpcName": "CompleteQuery",
    ...
    class _ImportCompletionData(
        _BaseCompletionServiceRestTransport._BaseImportCompletionData,
        CompletionServiceRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_transcoded_request(
                http_options, request
            )

            body = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseCompletionServiceRestTransport._BaseImportCompletionData._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.CompletionServiceClient.ImportCompletionData",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
            ...
            # Send the request
            response = (
                CompletionServiceRestTransport._ImportCompletionData._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_completion_data_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.CompletionServiceClient.import_completion_data",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
                        "rpcName": "ImportCompletionData",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.CompletionServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.CompletionServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.CompletionServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.CompletionServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2.CompletionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

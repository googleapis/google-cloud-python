...
class UserEventServiceGrpcAsyncIOTransport(UserEventServiceTransport):
    ...
    @property
    def write_user_event(self) -> Callable[[user_event_service.WriteUserEventRequest], Awaitable[user_event.UserEvent]]:
    ...
    @property
    def purge_user_events(self) -> Callable[[purge_config.PurgeUserEventsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_user_events(self) -> Callable[[import_config.ImportUserEventsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def rejoin_user_events(self) -> Callable[[user_event_service.RejoinUserEventsRequest], Awaitable[operations_pb2.Operation]]:

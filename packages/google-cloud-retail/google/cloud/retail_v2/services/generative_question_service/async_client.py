...
class GenerativeQuestionServiceAsyncClient:
    ...
    async def update_generative_questions_feature_config(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.UpdateGenerativeQuestionsFeatureConfigRequest, dict]]):
                The request object. Request for
                UpdateGenerativeQuestionsFeatureConfig
                method.
            generative_questions_feature_config (:class:`google.cloud.retail_v2.types.GenerativeQuestionsFeatureConfig`):
    ...
    async def get_generative_questions_feature_config(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.GetGenerativeQuestionsFeatureConfigRequest, dict]]):
                The request object. Request for
    ...
    async def list_generative_question_configs(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.ListGenerativeQuestionConfigsRequest, dict]]):
    ...
    async def update_generative_question_config(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.UpdateGenerativeQuestionConfigRequest, dict]]):
                The request object. Request for
                UpdateGenerativeQuestionConfig method.
            generative_question_config (:class:`google.cloud.retail_v2.types.GenerativeQuestionConfig`):
    ...
    async def batch_update_generative_question_configs(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.BatchUpdateGenerativeQuestionConfigsRequest, dict]]):
                The request object. Request for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            requests (:class:`MutableSequence[google.cloud.retail_v2.types.UpdateGenerativeQuestionConfigRequest]`):

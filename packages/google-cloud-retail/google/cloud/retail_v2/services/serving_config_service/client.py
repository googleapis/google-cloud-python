...
class ServingConfigServiceClient(metaclass=ServingConfigServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ServingConfigServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ServingConfigServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ServingConfigServiceTransport, Callable[..., ServingConfigServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ServingConfigServiceClient._read_environment_variables()
        self._client_cert_source = ServingConfigServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ServingConfigServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or ServingConfigServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ServingConfigServiceTransport], Callable[..., ServingConfigServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2.ServingConfigServiceClient`.",
                    extra={
    ...
    def create_serving_config(
        self,
        request: Optional[Union[serving_config_service.CreateServingConfigRequest, dict]] = None,
        *,
    ...
    def delete_serving_config(
        self,
        request: Optional[Union[serving_config_service.DeleteServingConfigRequest, dict]] = None,
        *,
    ...
    def update_serving_config(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("serving_config.name", request.serving_config.name),)),)
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_add_control():
                ...
                # Initialize request argument(s)
                request = retail_v2.AddControlRequest(
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [serving_config]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
    ...
    def remove_control(
        self,
        request: Optional[Union[serving_config_service.RemoveControlRequest, dict]] = None,
        *,
        serving_config: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,

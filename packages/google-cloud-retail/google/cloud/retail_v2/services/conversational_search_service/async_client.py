...
class ConversationalSearchServiceAsyncClient:
    ...
    parse_branch_path = staticmethod(
        ConversationalSearchServiceClient.parse_branch_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ConversationalSearchServiceClient.from_service_account_info.__func__
        )  # type: ignore
        return sa_info_func(
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ConversationalSearchServiceClient.from_service_account_file.__func__
        )  # type: ignore
        return sa_file_func(
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2.ConversationalSearchServiceAsyncClient`.",
                extra={
    ...
    def conversational_search(
        ...
        *,
        ...
        AsyncIterable[conversational_search_service.ConversationalSearchResponse]
    ]:
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.ConversationalSearchRequest, dict]]):
        ...
        Returns:
            AsyncIterable[google.cloud.retail_v2.types.ConversationalSearchResponse]:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.conversational_search
        ]

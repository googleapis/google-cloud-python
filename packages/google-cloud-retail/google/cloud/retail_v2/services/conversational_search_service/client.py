...
class ConversationalSearchServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2.ConversationalSearchServiceClient`.",
                    extra={
    ...
    def conversational_search(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.ConversationalSearchRequest, dict]):
        ...
        Returns:
            Iterable[google.cloud.retail_v2.types.ConversationalSearchResponse]:

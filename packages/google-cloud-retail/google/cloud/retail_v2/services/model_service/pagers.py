...
class ListModelsPager:
    ...
    :class:`google.cloud.retail_v2.types.ListModelsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2.types.ListModelsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.retail_v2.types.ListModelsRequest):
                The initial request object.
            response (google.cloud.retail_v2.types.ListModelsResponse):

...
class ModelServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2.ModelServiceAsyncClient`.",
                extra={
    ...
    async def create_model(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.CreateModelRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            model (:class:`google.cloud.retail_v2.types.Model`):
    ...
    async def list_models(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.ListModelsRequest, dict]]):
    ...
    async def update_model(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.UpdateModelRequest, dict]]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_tune_model():
                ...
                # Make the request
                operation = await client.tune_model(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.TuneModelRequest, dict]]):

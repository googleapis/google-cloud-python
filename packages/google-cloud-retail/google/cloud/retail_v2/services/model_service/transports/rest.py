        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.CreateModel",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.create_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "CreateModel",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.DeleteModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "DeleteModel",
                        "httpRequest": http_request,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.GetModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "GetModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.get_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "GetModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.ListModels",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "ListModels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.list_models",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "ListModels",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.PauseModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "PauseModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.pause_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "PauseModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.ResumeModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "ResumeModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.resume_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "ResumeModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.TuneModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "TuneModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.tune_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "TuneModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.UpdateModel",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "UpdateModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceClient.update_model",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "UpdateModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2.ModelServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2.ModelServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2.ModelService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

...
class ModelServiceTransport(abc.ABC):
    ...
    @property
    def create_model(self) -> Callable[[model_service.CreateModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    @property
    def pause_model(self) -> Callable[[model_service.PauseModelRequest], Union[model.Model, Awaitable[model.Model]]]:
        raise NotImplementedError()

    @property
    def resume_model(self) -> Callable[[model_service.ResumeModelRequest], Union[model.Model, Awaitable[model.Model]]]:
        raise NotImplementedError()

    @property
    def delete_model(self) -> Callable[[model_service.DeleteModelRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()
    ...
    @property
    def update_model(self) -> Callable[[model_service.UpdateModelRequest], Union[gcr_model.Model, Awaitable[gcr_model.Model]]]:
        raise NotImplementedError()

    @property
    def tune_model(self) -> Callable[[model_service.TuneModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

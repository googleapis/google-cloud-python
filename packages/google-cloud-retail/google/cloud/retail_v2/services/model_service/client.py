...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    def parse_model_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/catalogs/(?P<catalog>.+?)/models/(?P<model>.+?)$", path)
        return m.groupdict() if m else {}
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2.ModelServiceClient`.",
                    extra={
    ...
    def create_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.CreateModelRequest, dict]):
            ...
            model (google.cloud.retail_v2.types.Model):
                ...
                [Model][google.cloud.retail.v2.Model] to create.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2.types.Model` Metadata that describes the training and serving parameters of a
                   [Model][google.cloud.retail.v2.Model]. A
                   [Model][google.cloud.retail.v2.Model] can be
                   associated with a
    ...
    def get_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.GetModelRequest, dict]):
                The request object. Request for getting a model.
            name (str):
                Required. The resource name of the
                [Model][google.cloud.retail.v2.Model] to get. Format:
    ...
    def pause_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.PauseModelRequest, dict]):
    ...
    def resume_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.ResumeModelRequest, dict]):
    ...
    def delete_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.DeleteModelRequest, dict]):
                The request object. Request for deleting a model.
            name (str):
                Required. The resource name of the
                [Model][google.cloud.retail.v2.Model] to delete. Format:
                ``projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/models/{model_id}``
    ...
    def list_models(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.ListModelsRequest, dict]):
    ...
    def update_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.UpdateModelRequest, dict]):
    ...
    def tune_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2.types.TuneModelRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.retail_v2.types.TuneModelResponse`

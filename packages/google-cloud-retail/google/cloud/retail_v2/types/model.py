...
class Model(proto.Message):
    ...
    Attributes:
        ...
        model_features_config (google.cloud.retail_v2.types.Model.ModelFeaturesConfig):
    ...
    class FrequentlyBoughtTogetherFeaturesConfig(proto.Message):
        ...
        Attributes:
            context_products_type (google.cloud.retail_v2.types.Model.ContextProductsType):
    ...
    class ModelFeaturesConfig(proto.Message):
        ...
        Attributes:
            frequently_bought_together_config (google.cloud.retail_v2.types.Model.FrequentlyBoughtTogetherFeaturesConfig):

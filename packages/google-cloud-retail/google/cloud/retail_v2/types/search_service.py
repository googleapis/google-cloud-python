...
class SearchRequest(proto.Message):
    ...
    Attributes:
        ...
        conversational_search_spec (google.cloud.retail_v2.types.SearchRequest.ConversationalSearchSpec):
    ...
    class ConversationalSearchSpec(proto.Message):
        ...
        class UserAnswer(proto.Message):
            ...
            class SelectedAnswer(proto.Message):
                ...
                Attributes:
                    product_attribute_values (MutableSequence[google.cloud.retail_v2.types.ProductAttributeValue]):
...
class SearchResponse(proto.Message):
    ...
    Attributes:
        ...
        tile_navigation_result (google.cloud.retail_v2.types.SearchResponse.TileNavigationResult):
            This field specifies all related information
    ...
    class TileNavigationResult(proto.Message):
        ...
        Attributes:
            tiles (MutableSequence[google.cloud.retail_v2.types.Tile]):

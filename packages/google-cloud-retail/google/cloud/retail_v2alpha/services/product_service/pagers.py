...
from google.cloud.retail_v2alpha.types import product, product_service
...
class ListProductsPager:
    ...
    :class:`google.cloud.retail_v2alpha.types.ListProductsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2alpha.types.ListProductsResponse`
    ...
    def __init__(
        self,
        method: Callable[..., product_service.ListProductsResponse],
        ...
        *,
        ...
        """
        self._method = method
        self._request = product_service.ListProductsRequest(request)
...
class ListProductsAsyncPager:
    ...
    def __init__(
        self,
        method: Callable[..., Awaitable[product_service.ListProductsResponse]],
        request: product_service.ListProductsRequest,
        response: product_service.ListProductsResponse,
        *,

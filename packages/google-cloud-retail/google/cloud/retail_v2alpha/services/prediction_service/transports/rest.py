        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.PredictionServiceClient.Predict",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.PredictionServiceClient.predict",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.PredictionService",
                        "rpcName": "Predict",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.PredictionServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.PredictionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.PredictionServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.PredictionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.PredictionServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.PredictionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.PredictionServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.PredictionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

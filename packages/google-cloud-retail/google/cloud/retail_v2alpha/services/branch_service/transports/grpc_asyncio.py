...
class BranchServiceGrpcAsyncIOTransport(BranchServiceTransport):
    ...
    @property
    def list_branches(self) -> Callable[[branch_service.ListBranchesRequest], Awaitable[branch_service.ListBranchesResponse]]:
        ...
        if "list_branches" not in self._stubs:
            self._stubs["list_branches"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_branch(self) -> Callable[[branch_service.GetBranchRequest], Awaitable[branch.Branch]]:
        ...
        if "get_branch" not in self._stubs:
            self._stubs["get_branch"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_branches: self._wrap_method(
                self.list_branches,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_branch: self._wrap_method(
                self.get_branch,
                default_timeout=None,
                client_info=client_info,
            ),

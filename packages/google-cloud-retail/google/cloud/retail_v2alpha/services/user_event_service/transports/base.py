...
from google.cloud.retail_v2alpha.types import export_config, import_config, purge_config, user_event, user_event_service
...
class UserEventServiceTransport(abc.ABC):
    ...
    def export_user_events(
        self,
    ) -> Callable[[export_config.ExportUserEventsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

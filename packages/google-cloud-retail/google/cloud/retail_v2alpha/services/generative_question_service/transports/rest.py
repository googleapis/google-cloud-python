    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[GenerativeQuestionServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.BatchUpdateGenerativeQuestionConfigs",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.batch_update_generative_question_configs",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "BatchUpdateGenerativeQuestionConfigs",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.GetGenerativeQuestionsFeatureConfig",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.get_generative_questions_feature_config",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "GetGenerativeQuestionsFeatureConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.ListGenerativeQuestionConfigs",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.list_generative_question_configs",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "ListGenerativeQuestionConfigs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.UpdateGenerativeQuestionConfig",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.update_generative_question_config",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "UpdateGenerativeQuestionConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.UpdateGenerativeQuestionsFeatureConfig",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.update_generative_questions_feature_config",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "UpdateGenerativeQuestionsFeatureConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.retail_v2alpha.GenerativeQuestionServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.retail_v2alpha.GenerativeQuestionServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.retail.v2alpha.GenerativeQuestionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

...
class GenerativeQuestionServiceClient(metaclass=GenerativeQuestionServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = GenerativeQuestionServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = GenerativeQuestionServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or GenerativeQuestionServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2alpha.GenerativeQuestionServiceClient`.",
                    extra={
    ...
    def update_generative_questions_feature_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.UpdateGenerativeQuestionsFeatureConfigRequest, dict]):
                The request object. Request for
                UpdateGenerativeQuestionsFeatureConfig
                method.
            generative_questions_feature_config (google.cloud.retail_v2alpha.types.GenerativeQuestionsFeatureConfig):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.update_generative_questions_feature_config
        ]
    ...
    def get_generative_questions_feature_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.GetGenerativeQuestionsFeatureConfigRequest, dict]):
                The request object. Request for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_generative_questions_feature_config
        ]
    ...
    def list_generative_question_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.ListGenerativeQuestionConfigsRequest, dict]):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_generative_question_configs
        ]
    ...
    def update_generative_question_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.UpdateGenerativeQuestionConfigRequest, dict]):
                The request object. Request for
                UpdateGenerativeQuestionConfig method.
            generative_question_config (google.cloud.retail_v2alpha.types.GenerativeQuestionConfig):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_generative_question_config
        ]
    ...
    def batch_update_generative_question_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.BatchUpdateGenerativeQuestionConfigsRequest, dict]):
                The request object. Request for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_update_generative_question_configs
        ]
...
__all__ = ("GenerativeQuestionServiceClient",)

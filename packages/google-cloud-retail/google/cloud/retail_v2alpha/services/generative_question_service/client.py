...
class GenerativeQuestionServiceClient(metaclass=GenerativeQuestionServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = GenerativeQuestionServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or GenerativeQuestionServiceClient._get_api_endpoint(

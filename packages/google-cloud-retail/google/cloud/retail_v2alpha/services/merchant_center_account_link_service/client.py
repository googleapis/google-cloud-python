...
class MerchantCenterAccountLinkServiceClient(metaclass=MerchantCenterAccountLinkServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = MerchantCenterAccountLinkServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = MerchantCenterAccountLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, MerchantCenterAccountLinkServiceTransport, Callable[..., MerchantCenterAccountLinkServiceTransport]]] = None,
        ...
        self._client_cert_source = MerchantCenterAccountLinkServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = MerchantCenterAccountLinkServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, MerchantCenterAccountLinkServiceTransport)
        ...
        self._api_endpoint = self._api_endpoint or MerchantCenterAccountLinkServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[MerchantCenterAccountLinkServiceTransport], Callable[..., MerchantCenterAccountLinkServiceTransport]] = (
                MerchantCenterAccountLinkServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., MerchantCenterAccountLinkServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.retail_v2alpha.MerchantCenterAccountLinkServiceClient`.",
                    extra={
    ...
    def list_merchant_center_account_links(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_merchant_center_account_links]
    ...
    def create_merchant_center_account_link(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_merchant_center_account_link]
    ...
    def delete_merchant_center_account_link(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_merchant_center_account_link]

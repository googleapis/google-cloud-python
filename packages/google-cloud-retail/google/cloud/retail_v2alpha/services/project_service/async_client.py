...
class ProjectServiceAsyncClient:
    ...
    parse_logging_config_path = staticmethod(ProjectServiceClient.parse_logging_config_path)
    retail_project_path = staticmethod(ProjectServiceClient.retail_project_path)
    parse_retail_project_path = staticmethod(ProjectServiceClient.parse_retail_project_path)
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.retail_v2alpha.ProjectServiceAsyncClient`.",
                extra={
    ...
    async def accept_terms(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.accept_terms]
    ...
    async def enroll_solution(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.enroll_solution]
    ...
    async def list_enrolled_solutions(
        self,
        request: Optional[Union[project_service.ListEnrolledSolutionsRequest, dict]] = None,
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_enrolled_solutions]
    ...
    async def get_logging_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_logging_config]
    ...
    async def update_logging_config(
        self,
        request: Optional[Union[project_service.UpdateLoggingConfigRequest, dict]] = None,
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [logging_config, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_logging_config]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("logging_config.name", request.logging_config.name),)),)
    ...
    async def get_alert_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_alert_config]
    ...
    async def update_alert_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_alert_config]

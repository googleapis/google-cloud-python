...
async def sample_import_completion_data():
    # Create a client
    client = retail_v2beta.CompletionServiceAsyncClient()
    ...
    request = retail_v2beta.ImportCompletionDataRequest(
        parent="parent_value",
        input_config=input_config,
    )

    # Make the request
    operation = await client.import_completion_data(request=request)

...
from google.cloud.retail_v2alpha.services.user_event_service import UserEventServiceAsyncClient, UserEventServiceClient, transports
from google.cloud.retail_v2alpha.types import common, export_config, import_config, product, promotion, purge_config, user_event, user_event_service
...
def test_write_user_event_rest_call_success(request_type):
    ...
    request_init["user_event"] = {
        ...
        "product_details": [
            {
                "product": {
                    ...
                    "collection_member_ids": ["collection_member_ids_value1", "collection_member_ids_value2"],
                    "gtin": "gtin_value",
                    ...
                    "price_info": {
                        ...
                        "price_expire_time": {},
                        "price_range": {
                            "price": {"minimum": 0.764, "exclusive_minimum": 0.18430000000000002, "maximum": 0.766, "exclusive_maximum": 0.1845},
                            "original_price": {},
                        },
                    },
                    "rating": {"rating_count": 1293, "average_rating": 0.1471, "rating_histogram": [1715, 1716]},
                    "available_time": {},
                    "availability": 1,
                    "available_quantity": {"value": 541},
                    "fulfillment_info": [{"type_": "type__value", "place_ids": ["place_ids_value1", "place_ids_value2"]}],
                    "uri": "uri_value",
                    "images": [{"uri": "uri_value", "height": 633, "width": 544}],
                    "audience": {"genders": ["genders_value1", "genders_value2"], "age_groups": ["age_groups_value1", "age_groups_value2"]},
                    "color_info": {
                    ...
                    "local_inventories": [
                        {
                            ...
                            "availability": 1,
                            "attributes": {},
                            "fulfillment_types": ["fulfillment_types_value1", "fulfillment_types_value2"],
                        }
                    ],
                },
                "quantity": {},
        ...
        "attributes": {},
        "cart_id": "cart_id_value",
        "purchase_transaction": {"id": "id_value", "revenue": 0.762, "tax": 0.333, "cost": 0.441, "currency_code": "currency_code_value"},
        "search_query": "search_query_value",
        "filter": "filter_value",
        "order_by": "order_by_value",
        "offset": 647,
        "page_categories": ["page_categories_value1", "page_categories_value2"],
        "user_info": {"user_id": "user_id_value", "ip_address": "ip_address_value", "user_agent": "user_agent_value", "direct_user_request": True},
        "uri": "uri_value",
        "referrer_uri": "referrer_uri_value",
        "page_view_id": "page_view_id_value",
        "entity": "entity_value",
...
def test_export_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.UserEventServiceRestInterceptor, "post_export_user_events"
    ) as post, mock.patch.object(
        transports.UserEventServiceRestInterceptor, "post_export_user_events_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.UserEventServiceRestInterceptor, "pre_export_user_events"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_rejoin_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.UserEventServiceRestInterceptor, "post_rejoin_user_events_with_metadata"
    ) as post_with_metadata, mock.patch.object(

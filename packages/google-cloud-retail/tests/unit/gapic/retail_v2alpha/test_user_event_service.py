...
async def test_export_user_events_async(request_type, transport: str = "grpc_asyncio"):
    client = UserEventServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_write_user_event_rest_required_fields(
    ...
    assert not set(unset_fields) - set(("writeAsync",))
...
def test_export_user_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseExportUserEvents,
...
def test_rejoin_user_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRejoinUserEvents,

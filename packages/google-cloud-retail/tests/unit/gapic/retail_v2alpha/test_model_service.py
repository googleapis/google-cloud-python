...
from google.cloud.retail_v2alpha.types import common, model, model_service
...
async def test_pause_model_async(request_type, transport: str = "grpc_asyncio"):
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_resume_model_async(request_type, transport: str = "grpc_asyncio"):
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_tune_model_async(request_type, transport: str = "grpc_asyncio"):
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateModel,
    ...
    assert not set(unset_fields) - set(("dryRun",))
...
def test_pause_model_rest_required_fields(request_type=model_service.PauseModelRequest):
    ...
    default_values = getattr(
        transport_class._BasePauseModel,
...
def test_resume_model_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseResumeModel,
...
def test_tune_model_rest_required_fields(request_type=model_service.TuneModelRequest):
    ...
    default_values = getattr(
        transport_class._BaseTuneModel,

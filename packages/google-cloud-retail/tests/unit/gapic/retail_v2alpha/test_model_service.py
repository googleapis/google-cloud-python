...
from google.cloud.retail_v2alpha.services.model_service import ModelServiceAsyncClient, ModelServiceClient, pagers, transports
...
@pytest.mark.asyncio
async def test_pause_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ModelServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.pause_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.pause_model] = mock_rpc
...
@pytest.mark.asyncio
async def test_resume_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ModelServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resume_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resume_model] = mock_rpc
...
async def test_tune_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.tune_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.tune_model] = mock_rpc
...
def test_create_model_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_model), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = model_service.CreateModelRequest()
...
def test_pause_model_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.pause_model), "__call__") as call:
        call.return_value = model.Model()
        client.pause_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = model_service.PauseModelRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resume_model_empty_call_grpc():
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.resume_model), "__call__") as call:
        call.return_value = model.Model()
        client.resume_model(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_tune_model_empty_call_grpc():
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.tune_model), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.tune_model(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = model_service.TuneModelRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_pause_model_empty_call_grpc_asyncio():
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.pause_model), "__call__") as call:
        ...
        await client.pause_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_resume_model_empty_call_grpc_asyncio():
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.resume_model), "__call__") as call:
        ...
        await client.resume_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_tune_model_empty_call_grpc_asyncio():
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.tune_model), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.tune_model(request=None)
...
def test_create_model_rest_bad_request(request_type=model_service.CreateModelRequest):
...
def test_create_model_rest_call_success(request_type):
    ...
    request_init["model"] = {
        "page_optimization_config": {
            ...
            "panels": [
                {"display_name": "display_name_value", "candidates": [{"serving_config_id": "serving_config_id_value"}], "default_candidate": {}}
            ],
            "restriction": 1,
        },
        "name": "name_value",
        ...
        "data_state": 1,
        "filtering_option": 1,
        "serving_config_lists": [{"serving_config_ids": ["serving_config_ids_value1", "serving_config_ids_value2"]}],
        "model_features_config": {"frequently_bought_together_config": {"context_products_type": 1}},
    }
...
def test_create_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "post_create_model_with_metadata"
...
def test_pause_model_rest_bad_request(request_type=model_service.PauseModelRequest):
    client = ModelServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/catalogs/sample3/models/sample4"}
    request = request_type(**request_init)
...
def test_pause_model_rest_call_success(request_type):
    client = ModelServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_pause_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ModelServiceRestInterceptor, "post_pause_model") as post, mock.patch.object(
        transports.ModelServiceRestInterceptor, "post_pause_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_resume_model_rest_bad_request(request_type=model_service.ResumeModelRequest):
    client = ModelServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/catalogs/sample3/models/sample4"}
    request = request_type(**request_init)
...
def test_resume_model_rest_call_success(request_type):
    client = ModelServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_resume_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ModelServiceRestInterceptor, "post_resume_model") as post, mock.patch.object(
        transports.ModelServiceRestInterceptor, "post_resume_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ModelServiceRestInterceptor, "pre_delete_model") as pre:
        pre.assert_not_called()
...
def test_update_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ModelServiceRestInterceptor, "post_update_model") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcr_model.Model.to_json(gcr_model.Model())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gcr_model.Model(), metadata
...
def test_tune_model_rest_bad_request(request_type=model_service.TuneModelRequest):
    client = ModelServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/catalogs/sample3/models/sample4"}
    request = request_type(**request_init)
...
def test_tune_model_rest_call_success(request_type):
    client = ModelServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_tune_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "post_tune_model_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_pause_model_empty_call_rest():
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_resume_model_empty_call_rest():
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_tune_model_empty_call_rest():
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

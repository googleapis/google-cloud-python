...
from google.cloud.retail_v2alpha.services.catalog_service import CatalogServiceAsyncClient, CatalogServiceClient, pagers, transports
...
async def test_batch_remove_catalog_attributes_async(
    transport: str = "grpc_asyncio", request_type=catalog_service.BatchRemoveCatalogAttributesRequest
):
    client = CatalogServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_get_completion_config_rest_required_fields(request_type=catalog_service.GetCompletionConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_completion_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_completion_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2alpha/{completion_config.name=projects/*/locations/*/catalogs/*/completionConfig}" % client.transport._host, args[1]
        )
...
def test_get_attributes_config_rest_required_fields(request_type=catalog_service.GetAttributesConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_attributes_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_attributes_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2alpha/{attributes_config.name=projects/*/locations/*/catalogs/*/attributesConfig}" % client.transport._host, args[1]
        )
...
def test_add_catalog_attribute_rest_required_fields(request_type=catalog_service.AddCatalogAttributeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_catalog_attribute._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_remove_catalog_attribute_rest_required_fields(request_type=catalog_service.RemoveCatalogAttributeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_catalog_attribute._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_remove_catalog_attributes_rest_required_fields(request_type=catalog_service.BatchRemoveCatalogAttributesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_remove_catalog_attributes._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_replace_catalog_attribute_rest_required_fields(request_type=catalog_service.ReplaceCatalogAttributeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).replace_catalog_attribute._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_catalogs_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_list_catalogs") as post, mock.patch.object(
            ...
            "links": [
                {
                    ...
                    "feeds": [{"primary_feed_id": 1571, "data_source_id": 1462, "primary_feed_name": "primary_feed_name_value"}],
                }
            ]
        },
    }
...
def test_update_catalog_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_catalog") as post, mock.patch.object(
...
def test_set_default_branch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "pre_set_default_branch") as pre:
        pre.assert_not_called()
...
def test_get_default_branch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_default_branch") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_get_default_branch_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_completion_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_completion_config") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_get_completion_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_completion_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_completion_config") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_update_completion_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_attributes_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_get_attributes_config") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_get_attributes_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_attributes_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_update_attributes_config") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_update_attributes_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_add_catalog_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_add_catalog_attribute") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_add_catalog_attribute_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_remove_catalog_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_remove_catalog_attribute") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_remove_catalog_attribute_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_remove_catalog_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_batch_remove_catalog_attributes") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_batch_remove_catalog_attributes_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_replace_catalog_attribute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CatalogServiceRestInterceptor, "post_replace_catalog_attribute") as post, mock.patch.object(
        transports.CatalogServiceRestInterceptor, "post_replace_catalog_attribute_with_metadata"
    ) as post_with_metadata, mock.patch.object(

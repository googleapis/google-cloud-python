...
from google.cloud.retail_v2alpha.services.control_service import ControlServiceAsyncClient, ControlServiceClient, pagers, transports
...
def test_create_control_rest_call_success(request_type):
    ...
    request_init["control"] = {
        "facet_spec": {
            "facet_key": {
                "key": "key_value",
                "intervals": [{"minimum": 0.764, "exclusive_minimum": 0.18430000000000002, "maximum": 0.766, "exclusive_maximum": 0.1845}],
        ...
        "rule": {
            "boost_action": {"boost": 0.551, "products_filter": "products_filter_value"},
            ...
            "do_not_associate_action": {
                "query_terms": ["query_terms_value1", "query_terms_value2"],
                "do_not_associate_terms": ["do_not_associate_terms_value1", "do_not_associate_terms_value2"],
            ...
            "ignore_action": {"ignore_terms": ["ignore_terms_value1", "ignore_terms_value2"]},
            "filter_action": {"filter": "filter_value"},
            "twoway_synonyms_action": {"synonyms": ["synonyms_value1", "synonyms_value2"]},
            "force_return_facet_action": {"facet_position_adjustments": [{"attribute_name": "attribute_name_value", "position": 885}]},
            "remove_facet_action": {"attribute_names": ["attribute_names_value1", "attribute_names_value2"]},
            "pin_action": {"pin_map": {}},
            "condition": {

...
from google.cloud.retail_v2alpha.services.completion_service import CompletionServiceAsyncClient, CompletionServiceClient, transports
...
def test_complete_query_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.complete_query in client._transport._wrapped_methods
...
def test_import_completion_data_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_completion_data in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_completion_data] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_completion_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = CompletionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_completion_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_completion_data] = mock_rpc
...
def test_complete_query_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CompletionServiceClient(
...
def test_complete_query_rest_required_fields(request_type=completion_service.CompleteQueryRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = completion_service.CompleteQueryResponse.pb(return_value)
...
def test_import_completion_data_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CompletionServiceClient(
...
def test_import_completion_data_rest_required_fields(request_type=import_config.ImportCompletionDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_completion_data._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_complete_query_empty_call_grpc():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.complete_query), "__call__") as call:
        call.return_value = completion_service.CompleteQueryResponse()
        client.complete_query(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_completion_data_empty_call_grpc():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.import_completion_data), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.import_completion_data(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_complete_query_empty_call_grpc_asyncio():
    client = CompletionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.complete_query), "__call__") as call:
        ...
        await client.complete_query(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_completion_data_empty_call_grpc_asyncio():
    client = CompletionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.import_completion_data), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.import_completion_data(request=None)
...
def test_import_completion_data_rest_bad_request(request_type=import_config.ImportCompletionDataRequest):
    client = CompletionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_import_completion_data_rest_call_success(request_type):
    client = CompletionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_import_completion_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CompletionServiceRestInterceptor, "post_import_completion_data_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_complete_query_empty_call_rest():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_completion_data_empty_call_rest():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )

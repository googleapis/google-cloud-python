...
from google.cloud.retail_v2.services.serving_config_service import ServingConfigServiceAsyncClient, ServingConfigServiceClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert ServingConfigServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ServingConfigServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ServingConfigServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ServingConfigServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ServingConfigServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert ServingConfigServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ServingConfigServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ServingConfigServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ServingConfigServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ServingConfigServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ServingConfigServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ServingConfigServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ServingConfigServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ServingConfigServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ServingConfigServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ServingConfigServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ServingConfigServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ServingConfigServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServingConfigServiceClient))
@mock.patch.object(ServingConfigServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServingConfigServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServingConfigServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ServingConfigServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ServingConfigServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ServingConfigServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ServingConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ServingConfigServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServingConfigServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ServingConfigServiceClient._get_api_endpoint(None, None, default_universe, "always") == ServingConfigServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ServingConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ServingConfigServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServingConfigServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ServingConfigServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ServingConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ServingConfigServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ServingConfigServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ServingConfigServiceClient._get_universe_domain(None, None) == ServingConfigServiceClient._DEFAULT_UNIVERSE
...
def test_serving_config_service_client_from_service_account_info(client_class, transport_name):
...
def test_serving_config_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_serving_config_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (ServingConfigServiceClient, transports.ServingConfigServiceGrpcTransport, "grpc"),
        (ServingConfigServiceAsyncClient, transports.ServingConfigServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (ServingConfigServiceClient, transports.ServingConfigServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(ServingConfigServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServingConfigServiceClient))
@mock.patch.object(ServingConfigServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServingConfigServiceAsyncClient))
def test_serving_config_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (ServingConfigServiceClient, transports.ServingConfigServiceGrpcTransport, "grpc", "true"),
        (ServingConfigServiceAsyncClient, transports.ServingConfigServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (ServingConfigServiceClient, transports.ServingConfigServiceGrpcTransport, "grpc", "false"),
        (ServingConfigServiceAsyncClient, transports.ServingConfigServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (ServingConfigServiceClient, transports.ServingConfigServiceRestTransport, "rest", "true"),
        (ServingConfigServiceClient, transports.ServingConfigServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ServingConfigServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServingConfigServiceClient))
@mock.patch.object(ServingConfigServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServingConfigServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_serving_config_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [ServingConfigServiceClient, ServingConfigServiceAsyncClient])
@mock.patch.object(ServingConfigServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ServingConfigServiceClient))
@mock.patch.object(ServingConfigServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ServingConfigServiceAsyncClient))
...
def test_serving_config_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (ServingConfigServiceClient, transports.ServingConfigServiceGrpcTransport, "grpc", grpc_helpers),
        (ServingConfigServiceAsyncClient, transports.ServingConfigServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ServingConfigServiceClient, transports.ServingConfigServiceRestTransport, "rest", None),
    ],
)
def test_serving_config_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_serving_config_service_client_client_options_from_dict():
    with mock.patch("google.cloud.retail_v2.services.serving_config_service.transports.ServingConfigServiceGrpcTransport.__init__") as grpc_transport:
        grpc_transport.return_value = None
        client = ServingConfigServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_serving_config_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_create_serving_config(request_type, transport: str = "grpc"):
    ...
    assert response.do_not_associate_control_ids == ["do_not_associate_control_ids_value"]
    ...
    assert response.diversity_type == gcr_serving_config.ServingConfig.DiversityType.RULE_BASED_DIVERSITY
...
def test_create_serving_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_serving_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_serving_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_serving_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_serving_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_serving_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_serving_config_async(transport: str = "grpc_asyncio", request_type=serving_config_service.CreateServingConfigRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_serving_config_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_serving_config), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcr_serving_config.ServingConfig())
        await client.create_serving_config(request)
...
def test_delete_serving_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_serving_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_serving_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_serving_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServingConfigServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_serving_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_serving_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_serving_config_async(transport: str = "grpc_asyncio", request_type=serving_config_service.DeleteServingConfigRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_serving_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_serving_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_serving_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_serving_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServingConfigServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_serving_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_serving_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_serving_config_async(transport: str = "grpc_asyncio", request_type=serving_config_service.UpdateServingConfigRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_serving_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_serving_config), "__call__") as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.ignore_control_ids == ["ignore_control_ids_value"]
    assert response.diversity_level == "diversity_level_value"
    assert response.diversity_type == serving_config.ServingConfig.DiversityType.RULE_BASED_DIVERSITY
    assert response.enable_category_filter_level == "enable_category_filter_level_value"
    assert response.ignore_recs_denylist is True
    assert response.solution_types == [common.SolutionType.SOLUTION_TYPE_RECOMMENDATION]
...
def test_get_serving_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_serving_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_serving_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_serving_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServingConfigServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_serving_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_serving_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_serving_config_async(transport: str = "grpc_asyncio", request_type=serving_config_service.GetServingConfigRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_serving_configs(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_serving_configs), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_serving_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_serving_configs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_serving_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_serving_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServingConfigServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_serving_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_serving_configs] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_serving_configs_async(transport: str = "grpc_asyncio", request_type=serving_config_service.ListServingConfigsRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_serving_configs_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_serving_configs), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(serving_config_service.ListServingConfigsResponse())
        await client.list_serving_configs(request)
...
async def test_list_serving_configs_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_serving_configs), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            serving_config_service.ListServingConfigsResponse(
                serving_configs=[
...
async def test_list_serving_configs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_serving_configs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_serving_configs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_add_control_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServingConfigServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.add_control in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.add_control] = mock_rpc
...
@pytest.mark.asyncio
async def test_add_control_async(transport: str = "grpc_asyncio", request_type=serving_config_service.AddControlRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_remove_control_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServingConfigServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.remove_control in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.remove_control] = mock_rpc
...
@pytest.mark.asyncio
async def test_remove_control_async(transport: str = "grpc_asyncio", request_type=serving_config_service.RemoveControlRequest):
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_serving_config_rest_required_fields(request_type=serving_config_service.CreateServingConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_serving_config._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_serving_config_rest_unset_required_fields():
    transport = transports.ServingConfigServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_serving_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*/catalogs/*}/servingConfigs" % client.transport._host, args[1])
...
def test_delete_serving_config_rest_required_fields(request_type=serving_config_service.DeleteServingConfigRequest):
    transport_class = transports.ServingConfigServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_serving_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_serving_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/catalogs/*/servingConfigs/*}" % client.transport._host, args[1])
...
def test_update_serving_config_rest_required_fields(request_type=serving_config_service.UpdateServingConfigRequest):
    transport_class = transports.ServingConfigServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_serving_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_serving_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"serving_config": {"name": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}}
        ...
        assert path_template.validate(
            "%s/v2/{serving_config.name=projects/*/locations/*/catalogs/*/servingConfigs/*}" % client.transport._host, args[1]
        )
...
def test_get_serving_config_rest_required_fields(request_type=serving_config_service.GetServingConfigRequest):
    transport_class = transports.ServingConfigServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_serving_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_serving_configs_rest_required_fields(request_type=serving_config_service.ListServingConfigsRequest):
    transport_class = transports.ServingConfigServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_serving_configs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = serving_config_service.ListServingConfigsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_serving_configs_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(serving_config_service.ListServingConfigsResponse.to_json(x) for x in response)
...
def test_add_control_rest_required_fields(request_type=serving_config_service.AddControlRequest):
    transport_class = transports.ServingConfigServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_control._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"serving_config": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{serving_config=projects/*/locations/*/catalogs/*/servingConfigs/*}:addControl" % client.transport._host, args[1]
        )
...
def test_remove_control_rest_required_fields(request_type=serving_config_service.RemoveControlRequest):
    transport_class = transports.ServingConfigServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_control._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{serving_config=projects/*/locations/*/catalogs/*/servingConfigs/*}:removeControl" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ServingConfigServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ServingConfigServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
    assert client is not None


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_serving_config_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_serving_config), "__call__") as call:
        call.return_value = gcr_serving_config.ServingConfig()
        client.create_serving_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.CreateServingConfigRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_serving_config_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_serving_config), "__call__") as call:
        call.return_value = None
        client.delete_serving_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.DeleteServingConfigRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_serving_config_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_serving_config), "__call__") as call:
        call.return_value = gcr_serving_config.ServingConfig()
        client.update_serving_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.UpdateServingConfigRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_serving_config_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_serving_config), "__call__") as call:
        call.return_value = serving_config.ServingConfig()
        client.get_serving_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.GetServingConfigRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_serving_configs_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_serving_configs), "__call__") as call:
        call.return_value = serving_config_service.ListServingConfigsResponse()
        client.list_serving_configs(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.ListServingConfigsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_add_control_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.add_control), "__call__") as call:
        call.return_value = gcr_serving_config.ServingConfig()
        client.add_control(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.AddControlRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_control_empty_call_grpc():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.remove_control), "__call__") as call:
        call.return_value = gcr_serving_config.ServingConfig()
        client.remove_control(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = serving_config_service.RemoveControlRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ServingConfigServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_serving_config_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_serving_config), "__call__") as call:
        ...
        await client.create_serving_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_serving_config_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_serving_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_serving_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_serving_config_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_serving_config), "__call__") as call:
        ...
        await client.update_serving_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_serving_config_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_serving_config), "__call__") as call:
        ...
        await client.get_serving_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_serving_configs_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_serving_configs), "__call__") as call:
        ...
        await client.list_serving_configs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_add_control_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.add_control), "__call__") as call:
        ...
        await client.add_control(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_remove_control_empty_call_grpc_asyncio():
    client = ServingConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.remove_control), "__call__") as call:
        ...
        await client.remove_control(request=None)
...
def test_transport_kind_rest():
    transport = ServingConfigServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_serving_config_rest_bad_request(request_type=serving_config_service.CreateServingConfigRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_serving_config_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["serving_config"] = {
        ...
        "filter_control_ids": ["filter_control_ids_value1", "filter_control_ids_value2"],
        "redirect_control_ids": ["redirect_control_ids_value1", "redirect_control_ids_value2"],
        "twoway_synonyms_control_ids": ["twoway_synonyms_control_ids_value1", "twoway_synonyms_control_ids_value2"],
        "oneway_synonyms_control_ids": ["oneway_synonyms_control_ids_value1", "oneway_synonyms_control_ids_value2"],
        "do_not_associate_control_ids": ["do_not_associate_control_ids_value1", "do_not_associate_control_ids_value2"],
        "replacement_control_ids": ["replacement_control_ids_value1", "replacement_control_ids_value2"],
        "ignore_control_ids": ["ignore_control_ids_value1", "ignore_control_ids_value2"],
        "diversity_level": "diversity_level_value",
        "diversity_type": 2,
        "enable_category_filter_level": "enable_category_filter_level_value",
        "ignore_recs_denylist": True,
    ...
    test_field = serving_config_service.CreateServingConfigRequest.meta.fields["serving_config"]
...
def test_create_serving_config_rest_interceptors(null_interceptor):
    transport = transports.ServingConfigServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ServingConfigServiceRestInterceptor(),
    )
    client = ServingConfigServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_create_serving_config") as post, mock.patch.object(
        transports.ServingConfigServiceRestInterceptor, "post_create_serving_config_with_metadata"
        ...
        pb_message = serving_config_service.CreateServingConfigRequest.pb(serving_config_service.CreateServingConfigRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gcr_serving_config.ServingConfig.to_json(gcr_serving_config.ServingConfig())
...
def test_delete_serving_config_rest_bad_request(request_type=serving_config_service.DeleteServingConfigRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}
    request = request_type(**request_init)
...
def test_delete_serving_config_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_serving_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "pre_delete_serving_config") as pre:
        pre.assert_not_called()
        pb_message = serving_config_service.DeleteServingConfigRequest.pb(serving_config_service.DeleteServingConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_serving_config_rest_bad_request(request_type=serving_config_service.UpdateServingConfigRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"serving_config": {"name": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}}
    request = request_type(**request_init)
...
def test_update_serving_config_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = serving_config_service.UpdateServingConfigRequest.meta.fields["serving_config"]
...
def test_update_serving_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_update_serving_config") as post, mock.patch.object(
        transports.ServingConfigServiceRestInterceptor, "post_update_serving_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = serving_config_service.UpdateServingConfigRequest.pb(serving_config_service.UpdateServingConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_serving_config_rest_bad_request(request_type=serving_config_service.GetServingConfigRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}
    request = request_type(**request_init)
...
def test_get_serving_config_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_serving_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_get_serving_config") as post, mock.patch.object(
        transports.ServingConfigServiceRestInterceptor, "post_get_serving_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = serving_config_service.GetServingConfigRequest.pb(serving_config_service.GetServingConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = serving_config.ServingConfig.to_json(serving_config.ServingConfig())
        req.return_value.content = return_value
...
def test_list_serving_configs_rest_bad_request(request_type=serving_config_service.ListServingConfigsRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/catalogs/sample3"}
    request = request_type(**request_init)
...
def test_list_serving_configs_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_serving_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_list_serving_configs") as post, mock.patch.object(
        transports.ServingConfigServiceRestInterceptor, "post_list_serving_configs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = serving_config_service.ListServingConfigsRequest.pb(serving_config_service.ListServingConfigsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = serving_config_service.ListServingConfigsResponse.to_json(serving_config_service.ListServingConfigsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = serving_config_service.ListServingConfigsResponse(), metadata
...
def test_add_control_rest_bad_request(request_type=serving_config_service.AddControlRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"serving_config": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}
    request = request_type(**request_init)
...
def test_add_control_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_add_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_add_control") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = serving_config_service.AddControlRequest.pb(serving_config_service.AddControlRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_remove_control_rest_bad_request(request_type=serving_config_service.RemoveControlRequest):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"serving_config": "projects/sample1/locations/sample2/catalogs/sample3/servingConfigs/sample4"}
    request = request_type(**request_init)
...
def test_remove_control_rest_call_success(request_type):
    client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_remove_control_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServingConfigServiceRestInterceptor, "post_remove_control") as post, mock.patch.object(
        transports.ServingConfigServiceRestInterceptor, "post_remove_control_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = serving_config_service.RemoveControlRequest.pb(serving_config_service.RemoveControlRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_serving_config_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_serving_config_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_serving_config_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_serving_config_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_serving_configs_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_add_control_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_remove_control_empty_call_rest():
    client = ServingConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_serving_config_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ServingConfigServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_serving_config_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.retail_v2.services.serving_config_service.transports.ServingConfigServiceTransport.__init__") as Transport:
...
def test_serving_config_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.retail_v2.services.serving_config_service.transports.ServingConfigServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.ServingConfigServiceGrpcTransport, grpc_helpers), (transports.ServingConfigServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.ServingConfigServiceGrpcTransport, transports.ServingConfigServiceGrpcAsyncIOTransport])
def test_serving_config_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_serving_config_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ServingConfigServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.ServingConfigServiceGrpcTransport, transports.ServingConfigServiceGrpcAsyncIOTransport])
def test_serving_config_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_serving_config_path():
    ...
    actual = ServingConfigServiceClient.serving_config_path(project, location, catalog, serving_config)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ServingConfigServiceTransport, "_prep_wrapped_messages") as prep:
        client = ServingConfigServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ServingConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ServingConfigServiceAsyncClient, transports.ServingConfigServiceGrpcAsyncIOTransport),
    ],
)

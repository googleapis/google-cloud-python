...
from google.cloud.retail_v2.services.generative_question_service import (
...
def test_update_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{generative_questions_feature_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature"
...
def test_generative_question_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.retail_v2.services.generative_question_service.transports.GenerativeQuestionServiceTransport.__init__"
    ) as Transport:

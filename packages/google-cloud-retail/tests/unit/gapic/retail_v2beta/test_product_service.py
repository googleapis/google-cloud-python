...
from google.cloud.retail_v2beta.services.product_service import ProductServiceAsyncClient, ProductServiceClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ProductServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ProductServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ProductServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        ProductServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ProductServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        ProductServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
...
def test_update_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{product.name=projects/*/locations/*/catalogs/*/branches/*/products/**}" % client.transport._host, args[1]
        )
...
def test_set_inventory_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{inventory.name=projects/*/locations/*/catalogs/*/branches/*/products/**}:setInventory" % client.transport._host, args[1]
        )
...
def test_add_fulfillment_places_rest_required_fields(request_type=product_service.AddFulfillmentPlacesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_fulfillment_places._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_add_fulfillment_places_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addFulfillmentPlaces" % client.transport._host, args[1]
        )
...
def test_remove_fulfillment_places_rest_required_fields(request_type=product_service.RemoveFulfillmentPlacesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_fulfillment_places._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_remove_fulfillment_places_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeFulfillmentPlaces" % client.transport._host, args[1]
        )
...
def test_add_local_inventories_rest_required_fields(request_type=product_service.AddLocalInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_local_inventories._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_add_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addLocalInventories" % client.transport._host, args[1]
        )
...
def test_remove_local_inventories_rest_required_fields(request_type=product_service.RemoveLocalInventoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_local_inventories._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_remove_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeLocalInventories" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = ProductServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ProductServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ProductServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ProductServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_product_rest_call_success(request_type):
    ...
    request_init["product"] = {
        ...
        "color_info": {"color_families": ["color_families_value1", "color_families_value2"], "colors": ["colors_value1", "colors_value2"]},
...
def test_create_product_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ProductServiceRestInterceptor, "post_create_product") as post, mock.patch.object(
...
def test_get_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductServiceRestInterceptor, "post_get_product") as post, mock.patch.object(
...
def test_list_products_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductServiceRestInterceptor, "post_list_products") as post, mock.patch.object(
...
def test_update_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductServiceRestInterceptor, "post_update_product") as post, mock.patch.object(
...
def test_delete_product_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProductServiceRestInterceptor, "pre_delete_product") as pre:
        pre.assert_not_called()
...
def test_add_fulfillment_places_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ProductServiceRestInterceptor, "post_add_fulfillment_places_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_remove_fulfillment_places_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ProductServiceRestInterceptor, "post_remove_fulfillment_places_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_add_local_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ProductServiceRestInterceptor, "post_add_local_inventories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_remove_local_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ProductServiceRestInterceptor, "post_remove_local_inventories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.ProductServiceGrpcTransport, grpc_helpers), (transports.ProductServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

...
from google.cloud.retail_v2beta.services.project_service import (
...
def test_project_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_alert_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_alert_config] = (
            mock_rpc
        )
        request = {}
...
def test_update_alert_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_alert_config] = (
            mock_rpc
        )
        request = {}
...
def test_get_alert_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetAlertConfig,
...
def test_get_alert_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{name=projects/*/alertConfig}" % client.transport._host, args[1]
        )
...
def test_update_alert_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateAlertConfig,
...
def test_update_alert_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{alert_config.name=projects/*/alertConfig}"
...
def test_project_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceTransport.__init__"
    ) as Transport:

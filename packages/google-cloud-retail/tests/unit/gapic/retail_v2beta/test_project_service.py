...
from google.cloud.retail_v2beta.services.project_service import ProjectServiceAsyncClient, ProjectServiceClient, transports
...
def test_update_alert_config_rest_required_fields(request_type=project_service.UpdateAlertConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_alert_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_alert_config_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ProjectServiceRestInterceptor, "post_get_alert_config") as post, mock.patch.object(
...
def test_update_alert_config_rest_call_success(request_type):
    ...
    request_init["alert_config"] = {
        ...
        "alert_policies": [{"alert_group": "alert_group_value", "enroll_status": 1, "recipients": [{"email_address": "email_address_value"}]}],
    }
...
def test_update_alert_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ProjectServiceRestInterceptor, "post_update_alert_config") as post, mock.patch.object(
        transports.ProjectServiceRestInterceptor, "post_update_alert_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_project_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.retail_v2beta.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

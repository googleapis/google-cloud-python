...
from google.cloud.retail_v2beta.services.catalog_service import CatalogServiceAsyncClient, CatalogServiceClient, pagers, transports
...
def test_update_completion_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{completion_config.name=projects/*/locations/*/catalogs/*/completionConfig}" % client.transport._host, args[1]
        )
...
def test_update_attributes_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{attributes_config.name=projects/*/locations/*/catalogs/*/attributesConfig}" % client.transport._host, args[1]
        )
            ...
            "links": [
                {
                    ...
                    "feeds": [{"primary_feed_id": 1571, "primary_feed_name": "primary_feed_name_value"}],
                }
            ]
        },
    }

...
def test_get_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature" % client.transport._host, args[1]
        )
...
def test_update_generative_question_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{generative_question_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestion" % client.transport._host, args[1]
        )
...
def test_batch_update_generative_question_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*/locations/*/catalogs/*}/generativeQuestion:batchUpdate" % client.transport._host, args[1]
        )

...
from google.cloud.retail_v2beta.services.generative_question_service import (
...
def test_generative_question_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_update_generative_questions_feature_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateGenerativeQuestionsFeatureConfig,
...
def test_update_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{generative_questions_feature_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature"
...
def test_get_generative_questions_feature_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetGenerativeQuestionsFeatureConfig,
...
def test_get_generative_questions_feature_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{catalog=projects/*/locations/*/catalogs/*}/generativeQuestionFeature"
            % client.transport._host,
            args[1],
        )
...
def test_list_generative_question_configs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListGenerativeQuestionConfigs,
...
def test_list_generative_question_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*/locations/*/catalogs/*}/generativeQuestions"
            % client.transport._host,
            args[1],
        )
...
def test_update_generative_question_config_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateGenerativeQuestionConfig,
...
def test_update_generative_question_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{generative_question_config.catalog=projects/*/locations/*/catalogs/*}/generativeQuestion"
            % client.transport._host,
            args[1],
        )
...
def test_batch_update_generative_question_configs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateGenerativeQuestionConfigs,
...
def test_batch_update_generative_question_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*/locations/*/catalogs/*}/generativeQuestion:batchUpdate"
            % client.transport._host,
            args[1],
        )
...
def test_generative_question_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceTransport.__init__"
    ) as Transport:
...
def test_generative_question_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.retail_v2beta.services.generative_question_service.transports.GenerativeQuestionServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

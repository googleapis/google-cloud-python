...
from google.cloud.retail_v2beta.services.user_event_service import UserEventServiceAsyncClient, UserEventServiceClient, transports
from google.cloud.retail_v2beta.types import common, export_config, import_config, product, promotion, purge_config, user_event, user_event_service

...
class DataTransferServiceGrpcAsyncIOTransport(DataTransferServiceTransport):
    ...
    @property
    def get_data_source(self) -> Callable[[datatransfer.GetDataSourceRequest], Awaitable[datatransfer.DataSource]]:
    ...
    @property
    def list_data_sources(self) -> Callable[[datatransfer.ListDataSourcesRequest], Awaitable[datatransfer.ListDataSourcesResponse]]:
    ...
    @property
    def create_transfer_config(self) -> Callable[[datatransfer.CreateTransferConfigRequest], Awaitable[transfer.TransferConfig]]:
    ...
    @property
    def update_transfer_config(self) -> Callable[[datatransfer.UpdateTransferConfigRequest], Awaitable[transfer.TransferConfig]]:
    ...
    @property
    def delete_transfer_config(self) -> Callable[[datatransfer.DeleteTransferConfigRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_transfer_configs(self) -> Callable[[datatransfer.ListTransferConfigsRequest], Awaitable[datatransfer.ListTransferConfigsResponse]]:
    ...
    @property
    def schedule_transfer_runs(self) -> Callable[[datatransfer.ScheduleTransferRunsRequest], Awaitable[datatransfer.ScheduleTransferRunsResponse]]:
    ...
    def start_manual_transfer_runs(
        self,
    ) -> Callable[[datatransfer.StartManualTransferRunsRequest], Awaitable[datatransfer.StartManualTransferRunsResponse]]:
    ...
    @property
    def get_transfer_run(self) -> Callable[[datatransfer.GetTransferRunRequest], Awaitable[transfer.TransferRun]]:
    ...
    @property
    def delete_transfer_run(self) -> Callable[[datatransfer.DeleteTransferRunRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def list_transfer_runs(self) -> Callable[[datatransfer.ListTransferRunsRequest], Awaitable[datatransfer.ListTransferRunsResponse]]:
    ...
    @property
    def list_transfer_logs(self) -> Callable[[datatransfer.ListTransferLogsRequest], Awaitable[datatransfer.ListTransferLogsResponse]]:
    ...
    @property
    def check_valid_creds(self) -> Callable[[datatransfer.CheckValidCredsRequest], Awaitable[datatransfer.CheckValidCredsResponse]]:
    ...
    @property
    def enroll_data_sources(self) -> Callable[[datatransfer.EnrollDataSourcesRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def unenroll_data_sources(self) -> Callable[[datatransfer.UnenrollDataSourcesRequest], Awaitable[empty_pb2.Empty]]:

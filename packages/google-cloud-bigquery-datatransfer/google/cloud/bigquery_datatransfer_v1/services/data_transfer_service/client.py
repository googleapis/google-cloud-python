...
class DataTransferServiceClient(metaclass=DataTransferServiceClientMeta):
    ...
    def update_transfer_config(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("transfer_config.name", request.transfer_config.name),)),)
    ...
    def schedule_transfer_runs(
        ...
        *,
        ...
        """
        warnings.warn("DataTransferServiceClient.schedule_transfer_runs is deprecated", DeprecationWarning)

...
def test_data_transfer_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "bigquerydatatransfer.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://bigquerydatatransfer.googleapis.com"
        )
...
async def test_list_transfer_configs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_transfer_configs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_transfer_configs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_transfer_runs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_transfer_runs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_transfer_runs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_list_transfer_logs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_transfer_logs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_transfer_logs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_unenroll_data_sources(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.unenroll_data_sources), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_transfer_config_rest_required_fields(request_type=datatransfer.CreateTransferConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_transfer_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_transfer_config_rest_required_fields(request_type=datatransfer.UpdateTransferConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_transfer_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_transfer_config_rest_required_fields(request_type=datatransfer.DeleteTransferConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_transfer_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_transfer_config_rest_required_fields(request_type=datatransfer.GetTransferConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_transfer_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_transfer_configs_rest_required_fields(request_type=datatransfer.ListTransferConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_transfer_configs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_schedule_transfer_runs_rest_required_fields(request_type=datatransfer.ScheduleTransferRunsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).schedule_transfer_runs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_start_manual_transfer_runs_rest_required_fields(request_type=datatransfer.StartManualTransferRunsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start_manual_transfer_runs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_transfer_run_rest_required_fields(request_type=datatransfer.DeleteTransferRunRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_transfer_run._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_enroll_data_sources_rest_required_fields(request_type=datatransfer.EnrollDataSourcesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enroll_data_sources._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_unenroll_data_sources_rest_required_fields(request_type=datatransfer.UnenrollDataSourcesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).unenroll_data_sources._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_rest():
    transport = DataTransferServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_data_source_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_get_data_source") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_get_data_source_with_metadata"
...
def test_list_data_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_list_data_sources") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_list_data_sources_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_transfer_config_rest_call_success(request_type):
    ...
    request_init["transfer_config"] = {
        ...
        "params": {"fields": {}},
        "schedule": "schedule_value",
        "schedule_options": {"disable_auto_scheduling": True, "start_time": {"seconds": 751, "nanos": 543}, "end_time": {}},
        "schedule_options_v2": {
            "time_based_schedule": {"schedule": "schedule_value", "start_time": {}, "end_time": {}},
            "manual_schedule": {},
            "event_driven_schedule": {"pubsub_subscription": "pubsub_subscription_value"},
        },
        "data_refresh_window_days": 2543,
        "disabled": True,
        "update_time": {},
...
def test_create_transfer_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_create_transfer_config") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_create_transfer_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_transfer_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_update_transfer_config") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_update_transfer_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_transfer_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "pre_delete_transfer_config") as pre:
        pre.assert_not_called()
...
def test_get_transfer_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_get_transfer_config") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_get_transfer_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_transfer_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_list_transfer_configs") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_list_transfer_configs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_schedule_transfer_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_schedule_transfer_runs") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_schedule_transfer_runs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_start_manual_transfer_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_start_manual_transfer_runs") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_start_manual_transfer_runs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_transfer_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_get_transfer_run") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_get_transfer_run_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_transfer_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "pre_delete_transfer_run") as pre:
        pre.assert_not_called()
...
def test_list_transfer_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_list_transfer_runs") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_list_transfer_runs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_transfer_logs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_list_transfer_logs") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_list_transfer_logs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_check_valid_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "post_check_valid_creds") as post, mock.patch.object(
        transports.DataTransferServiceRestInterceptor, "post_check_valid_creds_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_enroll_data_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "pre_enroll_data_sources") as pre:
        pre.assert_not_called()
...
def test_unenroll_data_sources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataTransferServiceRestInterceptor, "pre_unenroll_data_sources") as pre:
        pre.assert_not_called()

...
from google.shopping.merchant_reports_v1._compat import transcode_request
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.reports_v1.ReportServiceClient.Search",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.reports_v1.ReportServiceClient.search",
                    extra={
                        "serviceName": "google.shopping.merchant.reports.v1.ReportService",
                        "rpcName": "Search",

...
from google.shopping import merchant_reports_v1alpha


async def sample_search():
    # Create a client
    client = merchant_reports_v1alpha.ReportServiceAsyncClient()

    # Initialize request argument(s)
    request = merchant_reports_v1alpha.SearchRequest(
        parent="parent_value",
        query="query_value",
    )

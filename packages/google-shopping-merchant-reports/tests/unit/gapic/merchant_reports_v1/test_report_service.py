...
from google.shopping.merchant_reports_v1.services.report_service import (
...
def test_report_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_reports_v1.services.report_service.transports.ReportServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_search_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/reports/v1/{parent=accounts/*}/reports:search" % client.transport._host,
            args[1],
        )
...
def test_report_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_reports_v1.services.report_service.transports.ReportServiceTransport.__init__"
    ) as Transport:
...
def test_report_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.shopping.merchant_reports_v1.services.report_service.transports.ReportServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

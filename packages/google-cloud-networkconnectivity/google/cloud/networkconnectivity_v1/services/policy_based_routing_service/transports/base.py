...
class PolicyBasedRoutingServiceTransport(abc.ABC):
    """Abstract transport class for PolicyBasedRoutingService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_policy_based_routes: gapic_v1.method.wrap_method(
                self.list_policy_based_routes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_policy_based_route: gapic_v1.method.wrap_method(
                self.get_policy_based_route,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_policy_based_route: gapic_v1.method.wrap_method(
                self.create_policy_based_route,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_policy_based_route: gapic_v1.method.wrap_method(
...
__all__ = ("PolicyBasedRoutingServiceTransport",)

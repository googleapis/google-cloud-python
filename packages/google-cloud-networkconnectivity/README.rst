Python Client for Network Connectivity API
==========================================

|preview| |pypi| |versions|

`Network Connectivity API`_: This API enables connectivity with and between Google Cloud resources.
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-networkconnectivity.svg
   :target: https://pypi.org/project/google-cloud-networkconnectivity/
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-networkconnectivity.svg
   :target: https://pypi.org/project/google-cloud-networkconnectivity/
.. _Network Connectivity API: 
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-networkconnectivity/latest/summary_overview
...
3. `Enable the Network Connectivity API.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Network Connectivity API.:  
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-networkconnectivity/samples
...
.. code-block:: console
    ...
    pip install google-cloud-networkconnectivity
...
-  Read the `Client Library Documentation`_ for Network Connectivity API
   to see other available methods on the client.
-  Read the `Network Connectivity API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Network Connectivity API Product documentation:  

...
def test__get_api_endpoint():
    ...
    assert (
        QuotaControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        QuotaControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == QuotaControllerClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = QuotaControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = QuotaControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = QuotaControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = QuotaControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_allocate_quota_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.QuotaControllerRestInterceptor, "post_allocate_quota") as post, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.QuotaControllerGrpcTransport, grpc_helpers), (transports.QuotaControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)

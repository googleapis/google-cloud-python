...
from google.cloud.servicecontrol_v1.services.service_controller import ServiceControllerAsyncClient, ServiceControllerClient, transports
from google.cloud.servicecontrol_v1.types import http_request, log_entry, metric_value, operation, service_controller
...
def test__read_environment_variables():
    assert ServiceControllerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ServiceControllerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ServiceControllerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ServiceControllerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ServiceControllerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ServiceControllerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ServiceControllerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ServiceControllerClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ServiceControllerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ServiceControllerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ServiceControllerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ServiceControllerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ServiceControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceControllerClient))
@mock.patch.object(ServiceControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceControllerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServiceControllerClient._DEFAULT_UNIVERSE
    default_endpoint = ServiceControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ServiceControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ServiceControllerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ServiceControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ServiceControllerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServiceControllerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ServiceControllerClient._get_api_endpoint(None, None, default_universe, "always") == ServiceControllerClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ServiceControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ServiceControllerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServiceControllerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ServiceControllerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ServiceControllerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ServiceControllerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ServiceControllerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ServiceControllerClient._get_universe_domain(None, None) == ServiceControllerClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ServiceControllerClient(credentials=cred)
...
def test_service_controller_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "servicecontrol.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://servicecontrol.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ServiceControllerAsyncClient, transports.ServiceControllerGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ServiceControllerClient, transports.ServiceControllerRestTransport, "rest", "true"),
        (ServiceControllerClient, transports.ServiceControllerRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(ServiceControllerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceControllerClient))
@mock.patch.object(ServiceControllerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceControllerAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        (ServiceControllerClient, transports.ServiceControllerGrpcTransport, "grpc", grpc_helpers),
        (ServiceControllerAsyncClient, transports.ServiceControllerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ServiceControllerClient, transports.ServiceControllerRestTransport, "rest", None),
    ],
)
...
async def test_check_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.check in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.check] = mock_rpc
...
async def test_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.report] = mock_rpc
...
def test_transport_kind_grpc():
    transport = ServiceControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ServiceControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ServiceControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ServiceControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_check_rest_interceptors(null_interceptor):
    transport = transports.ServiceControllerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ServiceControllerRestInterceptor(),
    )
    client = ServiceControllerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceControllerRestInterceptor, "post_check") as post, mock.patch.object(
        transports.ServiceControllerRestInterceptor, "post_check_with_metadata"
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service_controller.CheckResponse.to_json(service_controller.CheckResponse())
        ...
        post_with_metadata.return_value = service_controller.CheckResponse(), metadata
...
def test_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceControllerRestInterceptor, "post_report") as post, mock.patch.object(
        transports.ServiceControllerRestInterceptor, "post_report_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = service_controller.ReportResponse.to_json(service_controller.ReportResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = service_controller.ReportResponse(), metadata
...
def test_service_controller_base_transport():
    ...
    with mock.patch("google.cloud.servicecontrol_v1.services.service_controller.transports.ServiceControllerTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.ServiceControllerGrpcTransport, grpc_helpers), (transports.ServiceControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_service_controller_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "servicecontrol.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://servicecontrol.googleapis.com:8000"
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ServiceControllerAsyncClient, transports.ServiceControllerGrpcAsyncIOTransport),
    ],
)

...
class ServiceControllerTransport(abc.ABC):
    ...
    def check(
        self,
    ) -> Callable[[service_controller.CheckRequest], Union[service_controller.CheckResponse, Awaitable[service_controller.CheckResponse]]]:
        raise NotImplementedError()

    @property
    def report(
        self,
    ) -> Callable[[service_controller.ReportRequest], Union[service_controller.ReportResponse, Awaitable[service_controller.ReportResponse]]]:
        raise NotImplementedError()

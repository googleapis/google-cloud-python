...
class ServiceControllerGrpcAsyncIOTransport(ServiceControllerTransport):
    ...
    def check(
        ...
        [service_controller.CheckRequest], Awaitable[service_controller.CheckResponse]
    ]:
    ...
    def report(
        ...
        [service_controller.ReportRequest], Awaitable[service_controller.ReportResponse]
    ]:

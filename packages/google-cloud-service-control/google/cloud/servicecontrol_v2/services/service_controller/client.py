...
class ServiceControllerClientMeta(type):
    """Metaclass for the ServiceController client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ServiceControllerTransport]]
...
class ServiceControllerClient(metaclass=ServiceControllerClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "servicecontrol.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ServiceControllerClient: The constructed client.
        """
    ...
    def transport(self) -> ServiceControllerTransport:
        ...
        Returns:
            ServiceControllerTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ServiceControllerClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ServiceControllerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ServiceControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ServiceControllerClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ServiceControllerTransport, Callable[..., ServiceControllerTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ServiceControllerClient._read_environment_variables()
        self._client_cert_source = ServiceControllerClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ServiceControllerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ServiceControllerTransport)
        if transport_provided:
            # transport is a ServiceControllerTransport instance.
            ...
            self._transport = cast(ServiceControllerTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ServiceControllerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ServiceControllerTransport], Callable[..., ServiceControllerTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.api.servicecontrol_v2.ServiceControllerClient`.",
                    extra={
    ...
    def check(
        ...
        *,
        ...
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("service_name", request.service_name),)),)

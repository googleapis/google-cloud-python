...
class QuotaControllerRestTransport(_BaseQuotaControllerRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[QuotaControllerRestInterceptor]): Interceptor used
    ...
    class _AllocateQuota(
        _BaseQuotaControllerRestTransport._BaseAllocateQuota, QuotaControllerRestStub
    ):
        def __hash__(self):

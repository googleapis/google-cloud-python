...
class QuotaControllerGrpcAsyncIOTransport(QuotaControllerTransport):
    ...
    @property
    def allocate_quota(self) -> Callable[[quota_controller.AllocateQuotaRequest], Awaitable[quota_controller.AllocateQuotaResponse]]:
        ...
        **NOTE:** The client **must** fail-open on server errors
        ...
        if "allocate_quota" not in self._stubs:
            self._stubs["allocate_quota"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.allocate_quota: self._wrap_method(
                self.allocate_quota,

...
class QuotaControllerClient(metaclass=QuotaControllerClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = QuotaControllerClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = QuotaControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, QuotaControllerTransport, Callable[..., QuotaControllerTransport]
            ]
        ] = None,
        ...
        self._client_cert_source = QuotaControllerClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = QuotaControllerClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or QuotaControllerClient._get_api_endpoint(

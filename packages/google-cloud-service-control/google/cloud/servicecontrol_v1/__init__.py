...
from .services.service_controller import ServiceControllerAsyncClient, ServiceControllerClient
...
from .types.quota_controller import AllocateQuotaRequest, AllocateQuotaResponse, QuotaError, QuotaOperation
from .types.service_controller import CheckRequest, CheckResponse, ReportRequest, ReportResponse

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.servicecontrol_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.servicecontrol_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.servicecontrol_v1"

...
from google.cloud.hypercomputecluster_v1.services.hypercompute_cluster import (
    HypercomputeClusterAsyncClient,
    HypercomputeClusterClient,
    pagers,
    transports,
)
from google.cloud.hypercomputecluster_v1.types import (
...
def test__get_default_mtls_endpoint():
    ...
    assert HypercomputeClusterClient._get_default_mtls_endpoint(None) is None
    assert (
        HypercomputeClusterClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        HypercomputeClusterClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        HypercomputeClusterClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        HypercomputeClusterClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        HypercomputeClusterClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )


def test__read_environment_variables():
    assert HypercomputeClusterClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert HypercomputeClusterClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert HypercomputeClusterClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                HypercomputeClusterClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert HypercomputeClusterClient._get_client_cert_source(None, False) is None
    assert (
        HypercomputeClusterClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                HypercomputeClusterClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(HypercomputeClusterClient),
)
@mock.patch.object(
    HypercomputeClusterAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(HypercomputeClusterAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = HypercomputeClusterClient._DEFAULT_UNIVERSE
    default_endpoint = HypercomputeClusterClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = HypercomputeClusterClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == HypercomputeClusterClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        HypercomputeClusterClient._get_api_endpoint(
    ...
    assert (
        HypercomputeClusterClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        HypercomputeClusterClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        HypercomputeClusterClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        HypercomputeClusterClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        HypercomputeClusterClient._get_universe_domain(None, None)
        == HypercomputeClusterClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        HypercomputeClusterClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = HypercomputeClusterClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (HypercomputeClusterClient, "grpc"),
        (HypercomputeClusterAsyncClient, "grpc_asyncio"),
        (HypercomputeClusterClient, "rest"),
    ],
)
def test_hypercompute_cluster_client_from_service_account_info(
    client_class, transport_name
):
    ...
    with mock.patch.object(
        ...
        assert client.transport._host == (
            "hypercomputecluster.googleapis.com:443"
            if transport_name in ["grpc", "grpc_asyncio"]
            else "https://hypercomputecluster.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.HypercomputeClusterGrpcTransport, "grpc"),
        (transports.HypercomputeClusterGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.HypercomputeClusterRestTransport, "rest"),
    ],
)
def test_hypercompute_cluster_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_hypercompute_cluster_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_hypercompute_cluster_client_get_transport_class():
    transport = HypercomputeClusterClient.get_transport_class()
    ...
    transport = HypercomputeClusterClient.get_transport_class("grpc")
    assert transport == transports.HypercomputeClusterGrpcTransport
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            HypercomputeClusterAsyncClient,
            transports.HypercomputeClusterGrpcAsyncIOTransport,
            "grpc_asyncio",
        ),
        (
            HypercomputeClusterClient,
...
def test_hypercompute_cluster_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(HypercomputeClusterClient, "get_transport_class") as gtc:
...
def test_hypercompute_cluster_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [HypercomputeClusterClient, HypercomputeClusterAsyncClient]
)
@mock.patch.object(
    HypercomputeClusterClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(HypercomputeClusterClient),
)
@mock.patch.object(
    HypercomputeClusterAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(HypercomputeClusterAsyncClient),
)
def test_hypercompute_cluster_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_hypercompute_cluster_client_client_api_endpoint(client_class):
...
def test_hypercompute_cluster_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_hypercompute_cluster_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_hypercompute_cluster_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.hypercomputecluster_v1.services.hypercompute_cluster.transports.HypercomputeClusterGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = HypercomputeClusterClient(
...
def test_hypercompute_cluster_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
    ...
    with mock.patch.object(
        ...
        create_channel.assert_called_with(
            ...
            scopes=None,
            default_host="hypercomputecluster.googleapis.com",
...
def test_list_clusters(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_clusters), "__call__") as call:
        ...
        call.return_value = hypercompute_cluster.ListClustersResponse(
...
def test_list_clusters_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_clusters), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hypercompute_cluster.ListClustersRequest(
            parent="parent_value",
            page_token="page_token_value",
            filter="filter_value",
            order_by="order_by_value",
...
async def test_list_clusters_async(
    transport: str = "grpc_asyncio",
    request_type=hypercompute_cluster.ListClustersRequest,
):
    client = HypercomputeClusterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_clusters_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_clusters), "__call__") as call:
        ...
        assert all(isinstance(i, hypercompute_cluster.Cluster) for i in results)
...
async def test_list_clusters_async_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, hypercompute_cluster.Cluster) for i in responses)
...
def test_get_cluster(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_cluster), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = hypercompute_cluster.Cluster(
            name="name_value",
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, hypercompute_cluster.Cluster)
...
def test_get_cluster_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hypercompute_cluster.GetClusterRequest(
            name="name_value",
        )
...
async def test_get_cluster_async(
    transport: str = "grpc_asyncio", request_type=hypercompute_cluster.GetClusterRequest
):
    client = HypercomputeClusterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_cluster_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.create_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hypercompute_cluster.CreateClusterRequest(
            parent="parent_value",
            cluster_id="cluster_id_value",
        )
...
async def test_create_cluster_async(
    transport: str = "grpc_asyncio",
    request_type=hypercompute_cluster.CreateClusterRequest,
):
    client = HypercomputeClusterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_cluster_flattened():
    ...
    with mock.patch.object(type(client.transport.create_cluster), "__call__") as call:
        ...
        assert arg == mock_val
        arg = args[0].cluster
        mock_val = hypercompute_cluster.Cluster(name="name_value")
        assert arg == mock_val
...
def test_update_cluster_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.update_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hypercompute_cluster.UpdateClusterRequest()
...
def test_delete_cluster_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.delete_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == hypercompute_cluster.DeleteClusterRequest(
            name="name_value",
        )
...
async def test_delete_cluster_async(
    transport: str = "grpc_asyncio",
    request_type=hypercompute_cluster.DeleteClusterRequest,
):
    client = HypercomputeClusterAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_clusters_rest_required_fields(
    ...
    transport_class = transports.HypercomputeClusterRestTransport
    ...
    return_value = hypercompute_cluster.ListClustersResponse()
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = hypercompute_cluster.ListClustersResponse.pb(return_value)
...
def test_list_clusters_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            hypercompute_cluster.ListClustersResponse.to_json(x) for x in response
        )
...
def test_get_cluster_rest_required_fields(
    request_type=hypercompute_cluster.GetClusterRequest,
):
    transport_class = transports.HypercomputeClusterRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = hypercompute_cluster.Cluster()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = hypercompute_cluster.Cluster.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_credentials_transport_error():
    ...
    transport = transports.HypercomputeClusterGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = HypercomputeClusterClient(
...
def test_transport_get_channel():
    ...
    transport = transports.HypercomputeClusterGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_list_clusters_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_clusters), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hypercompute_cluster.ListClustersRequest()
...
def test_get_cluster_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hypercompute_cluster.GetClusterRequest()
...
def test_create_cluster_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hypercompute_cluster.CreateClusterRequest()
...
def test_delete_cluster_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_cluster), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = hypercompute_cluster.DeleteClusterRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = HypercomputeClusterAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = HypercomputeClusterClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_clusters_rest_interceptors(null_interceptor):
    transport = transports.HypercomputeClusterRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.HypercomputeClusterRestInterceptor(),
    )
    client = HypercomputeClusterClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.HypercomputeClusterRestInterceptor, "post_list_clusters"
    ) as post, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor,
        "post_list_clusters_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor, "pre_list_clusters"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = hypercompute_cluster.ListClustersRequest.pb(
            hypercompute_cluster.ListClustersRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = hypercompute_cluster.ListClustersResponse.to_json(
            hypercompute_cluster.ListClustersResponse()
        )
        ...
        post.return_value = hypercompute_cluster.ListClustersResponse()
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.HypercomputeClusterRestInterceptor, "post_get_cluster"
    ) as post, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor, "post_get_cluster_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor, "pre_get_cluster"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = hypercompute_cluster.GetClusterRequest.pb(
            hypercompute_cluster.GetClusterRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = hypercompute_cluster.Cluster.to_json(
            hypercompute_cluster.Cluster()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = hypercompute_cluster.Cluster()
        post_with_metadata.return_value = hypercompute_cluster.Cluster(), metadata
...
def test_create_cluster_rest_call_success(request_type):
        ...
        "orchestrator": {
            "slurm": {
                "login_nodes": {
                    ...
                    "labels": {},
                    "storage_configs": [
                        {"id": "id_value", "local_mount": "local_mount_value"}
                    ],
                    "instances": [{"instance": "instance_value"}],
                    "boot_disk": {"type_": "type__value", "size_gb": 739},
                },
                "node_sets": [
                    {
                        "compute_instance": {
                        ...
                        "id": "id_value",
                        "compute_id": "compute_id_value",
                        "storage_configs": {},
                        "static_node_count": 1813,
                        "max_dynamic_node_count": 2327,
                    }
                ],
                "partitions": [
                    {
                        "id": "id_value",
                        "node_set_ids": ["node_set_ids_value1", "node_set_ids_value2"],
                    }
                ],
                "default_partition": "default_partition_value",
                "prolog_bash_scripts": [
                    "prolog_bash_scripts_value1",
                    "prolog_bash_scripts_value2",
                ],
                "epilog_bash_scripts": [
                    "epilog_bash_scripts_value1",
                    "epilog_bash_scripts_value2",
                ],
            }
        },
    }
    ...
    test_field = hypercompute_cluster.CreateClusterRequest.meta.fields["cluster"]
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.HypercomputeClusterRestInterceptor, "post_create_cluster"
    ) as post, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor,
        "post_create_cluster_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor, "pre_create_cluster"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = hypercompute_cluster.CreateClusterRequest.pb(
            hypercompute_cluster.CreateClusterRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_cluster_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = hypercompute_cluster.UpdateClusterRequest.meta.fields["cluster"]
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.HypercomputeClusterRestInterceptor, "post_update_cluster"
    ) as post, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor,
        "post_update_cluster_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor, "pre_update_cluster"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = hypercompute_cluster.UpdateClusterRequest.pb(
            hypercompute_cluster.UpdateClusterRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.HypercomputeClusterRestInterceptor, "post_delete_cluster"
    ) as post, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor,
        "post_delete_cluster_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.HypercomputeClusterRestInterceptor, "pre_delete_cluster"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = hypercompute_cluster.DeleteClusterRequest.pb(
            hypercompute_cluster.DeleteClusterRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_hypercompute_cluster_rest_lro_client():
    client = HypercomputeClusterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_hypercompute_cluster_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.HypercomputeClusterTransport(
            credentials=ga_credentials.AnonymousCredentials(),
            credentials_file="credentials.json",
        )


def test_hypercompute_cluster_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.cloud.hypercomputecluster_v1.services.hypercompute_cluster.transports.HypercomputeClusterTransport.__init__"
    ) as Transport:
...
def test_hypercompute_cluster_base_transport_with_credentials_file():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(
        google.auth, "load_credentials_from_file", autospec=True
    ) as load_creds, mock.patch(
        "google.cloud.hypercomputecluster_v1.services.hypercompute_cluster.transports.HypercomputeClusterTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_hypercompute_cluster_base_transport_with_adc():
...
def test_hypercompute_cluster_transport_auth_adc(transport_class):
...
def test_hypercompute_cluster_transport_auth_gdch_credentials(transport_class):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.HypercomputeClusterGrpcTransport, grpc_helpers),
        (transports.HypercomputeClusterGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
def test_hypercompute_cluster_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(
        google.auth, "default", autospec=True
...
def test_hypercompute_cluster_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_hypercompute_cluster_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
    with mock.patch(
        "google.auth.transport.requests.AuthorizedSession.configure_mtls_channel"
...
def test_hypercompute_cluster_host_no_port(transport_name):
    client = HypercomputeClusterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
            api_endpoint="hypercomputecluster.googleapis.com"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
...
def test_hypercompute_cluster_host_with_port(transport_name):
    client = HypercomputeClusterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
            api_endpoint="hypercomputecluster.googleapis.com:8000"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
        "hypercomputecluster.googleapis.com:8000"
        if transport_name in ["grpc", "grpc_asyncio"]
        else "https://hypercomputecluster.googleapis.com:8000"
    )
...
def test_hypercompute_cluster_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = HypercomputeClusterClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = HypercomputeClusterClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_hypercompute_cluster_grpc_transport_channel():
...
def test_hypercompute_cluster_grpc_asyncio_transport_channel():
...
def test_hypercompute_cluster_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_hypercompute_cluster_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_hypercompute_cluster_grpc_lro_client():
    client = HypercomputeClusterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_hypercompute_cluster_grpc_lro_async_client():
    client = HypercomputeClusterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc_asyncio",
    )
...
def test_bucket_path():
    ...
    actual = HypercomputeClusterClient.bucket_path(project, bucket)
...
def test_parse_bucket_path():
    ...
    path = HypercomputeClusterClient.bucket_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_bucket_path(path)
    assert expected == actual
...
def test_cluster_path():
    ...
    actual = HypercomputeClusterClient.cluster_path(project, location, cluster)
    assert expected == actual
...
def test_parse_cluster_path():
    ...
    path = HypercomputeClusterClient.cluster_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_cluster_path(path)
    assert expected == actual
...
def test_compute_instance_path():
    ...
    actual = HypercomputeClusterClient.compute_instance_path(project, zone, instance)
    assert expected == actual


def test_parse_compute_instance_path():
    expected = {
        "project": "clam",
        "zone": "whelk",
        "instance": "octopus",
    }
    path = HypercomputeClusterClient.compute_instance_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_compute_instance_path(path)
    assert expected == actual
...
def test_disk_type_path():
    project = "oyster"
    zone = "nudibranch"
    disk_type = "cuttlefish"
    expected = "projects/{project}/zones/{zone}/diskTypes/{disk_type}".format(
        project=project,
        zone=zone,
        disk_type=disk_type,
    )
    actual = HypercomputeClusterClient.disk_type_path(project, zone, disk_type)
    assert expected == actual


def test_parse_disk_type_path():
    expected = {
        "project": "mussel",
        "zone": "winkle",
        "disk_type": "nautilus",
    }
    path = HypercomputeClusterClient.disk_type_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_disk_type_path(path)
    assert expected == actual
...
def test_file_instance_path():
    ...
    actual = HypercomputeClusterClient.file_instance_path(project, location, instance)
    assert expected == actual


def test_parse_file_instance_path():
    expected = {
        "project": "clam",
        "location": "whelk",
        "instance": "octopus",
    }
    path = HypercomputeClusterClient.file_instance_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_file_instance_path(path)
    assert expected == actual
...
def test_instance_path():
    ...
    actual = HypercomputeClusterClient.instance_path(project, location, instance)
    assert expected == actual
...
def test_parse_instance_path():
    ...
    path = HypercomputeClusterClient.instance_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_instance_path(path)
    assert expected == actual
...
def test_network_path():
    ...
    actual = HypercomputeClusterClient.network_path(project, network)
    assert expected == actual
...
def test_parse_network_path():
    ...
    path = HypercomputeClusterClient.network_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_network_path(path)
    assert expected == actual
...
def test_reservation_path():
    ...
    zone = "octopus"
    reservation = "oyster"
    expected = "projects/{project}/zones/{zone}/reservations/{reservation}".format(
        project=project,
        zone=zone,
        reservation=reservation,
    )
    actual = HypercomputeClusterClient.reservation_path(project, zone, reservation)
    assert expected == actual
...
def test_parse_reservation_path():
    ...
    path = HypercomputeClusterClient.reservation_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_reservation_path(path)
    assert expected == actual
...
def test_subnetwork_path():
    ...
    actual = HypercomputeClusterClient.subnetwork_path(project, region, subnetwork)
    assert expected == actual
...
def test_parse_subnetwork_path():
    ...
    path = HypercomputeClusterClient.subnetwork_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_subnetwork_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = HypercomputeClusterClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = HypercomputeClusterClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = HypercomputeClusterClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = HypercomputeClusterClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = HypercomputeClusterClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = HypercomputeClusterClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = HypercomputeClusterClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = HypercomputeClusterClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = HypercomputeClusterClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = HypercomputeClusterClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = HypercomputeClusterClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        ...
        transport_class = HypercomputeClusterClient.get_transport_class()
        transport = transport_class(
            credentials=ga_credentials.AnonymousCredentials(),
            client_info=client_info,
        )
...
async def test_get_location_field_headers_async():
    client = HypercomputeClusterAsyncClient(credentials=async_anonymous_credentials())
...
@pytest.mark.parametrize(
    ...
    [
        (HypercomputeClusterClient, transports.HypercomputeClusterGrpcTransport),
        (
            HypercomputeClusterAsyncClient,
            transports.HypercomputeClusterGrpcAsyncIOTransport,
        ),

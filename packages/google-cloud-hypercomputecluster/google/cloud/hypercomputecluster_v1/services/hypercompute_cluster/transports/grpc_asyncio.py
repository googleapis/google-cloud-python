...
class HypercomputeClusterGrpcAsyncIOTransport(HypercomputeClusterTransport):
    """gRPC AsyncIO backend transport for HypercomputeCluster.
    ...
    def get_cluster(
        ...
        Awaitable[hypercompute_cluster.Cluster],
    ]:
    ...
    def create_cluster(
        ...
        [hypercompute_cluster.CreateClusterRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_cluster(
        ...
        [hypercompute_cluster.UpdateClusterRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_cluster(
        ...
        [hypercompute_cluster.DeleteClusterRequest], Awaitable[operations_pb2.Operation]
    ]:
...
__all__ = ("HypercomputeClusterGrpcAsyncIOTransport",)

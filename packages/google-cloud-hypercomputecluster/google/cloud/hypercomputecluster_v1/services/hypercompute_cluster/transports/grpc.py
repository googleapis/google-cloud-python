...
from google.cloud.hypercomputecluster_v1.types import hypercompute_cluster

from .base import DEFAULT_CLIENT_INFO, HypercomputeClusterTransport
...
class HypercomputeClusterGrpcTransport(HypercomputeClusterTransport):
    """gRPC backend transport for HypercomputeCluster.
    ...
    def list_clusters(
        ...
        if "list_clusters" not in self._stubs:
            self._stubs["list_clusters"] = self._logged_channel.unary_unary(
                ...
                request_serializer=hypercompute_cluster.ListClustersRequest.serialize,
                response_deserializer=hypercompute_cluster.ListClustersResponse.deserialize,
            )
    ...
    def get_cluster(
        ...
        if "get_cluster" not in self._stubs:
            self._stubs["get_cluster"] = self._logged_channel.unary_unary(
                ...
                request_serializer=hypercompute_cluster.GetClusterRequest.serialize,
                response_deserializer=hypercompute_cluster.Cluster.deserialize,
            )
    ...
    def create_cluster(
        ...
        if "create_cluster" not in self._stubs:
            self._stubs["create_cluster"] = self._logged_channel.unary_unary(
                ...
                request_serializer=hypercompute_cluster.CreateClusterRequest.serialize,
    ...
    def update_cluster(
        ...
        if "update_cluster" not in self._stubs:
            self._stubs["update_cluster"] = self._logged_channel.unary_unary(
                ...
                request_serializer=hypercompute_cluster.UpdateClusterRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def delete_cluster(
        ...
        if "delete_cluster" not in self._stubs:
            self._stubs["delete_cluster"] = self._logged_channel.unary_unary(
                ...
                request_serializer=hypercompute_cluster.DeleteClusterRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
...
__all__ = ("HypercomputeClusterGrpcTransport",)

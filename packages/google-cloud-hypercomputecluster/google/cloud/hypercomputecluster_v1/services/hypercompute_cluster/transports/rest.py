...
from google.cloud.hypercomputecluster_v1._compat import transcode_request
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.CreateCluster",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.create_cluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "CreateCluster",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.DeleteCluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.delete_cluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "DeleteCluster",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.GetCluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "GetCluster",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.get_cluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "GetCluster",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.ListClusters",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.list_clusters",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "ListClusters",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.UpdateCluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.update_cluster",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "UpdateCluster",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.hypercomputecluster_v1.HypercomputeClusterClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.hypercomputecluster_v1.HypercomputeClusterAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.hypercomputecluster.v1.HypercomputeCluster",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

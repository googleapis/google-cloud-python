...
class HypercomputeClusterGrpcAsyncIOTransport(HypercomputeClusterTransport):
    ...
    @property
    def list_clusters(self) -> Callable[[hypercompute_cluster.ListClustersRequest], Awaitable[hypercompute_cluster.ListClustersResponse]]:
    ...
    @property
    def get_cluster(self) -> Callable[[hypercompute_cluster.GetClusterRequest], Awaitable[hypercompute_cluster.Cluster]]:
    ...
    @property
    def create_cluster(self) -> Callable[[hypercompute_cluster.CreateClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_cluster(self) -> Callable[[hypercompute_cluster.UpdateClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_cluster(self) -> Callable[[hypercompute_cluster.DeleteClusterRequest], Awaitable[operations_pb2.Operation]]:

...
class HypercomputeClusterTransport(abc.ABC):
    ...
    def list_clusters(
        ...
        Union[
            ...
            Awaitable[hypercompute_cluster.ListClustersResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_cluster(
        ...
        [hypercompute_cluster.GetClusterRequest],
        Union[hypercompute_cluster.Cluster, Awaitable[hypercompute_cluster.Cluster]],
    ]:
        raise NotImplementedError()

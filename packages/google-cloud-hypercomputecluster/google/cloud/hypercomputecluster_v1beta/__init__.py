...
__lazy_modules__ = {
    "google.cloud.hypercomputecluster_v1beta.services.hypercompute_cluster",
    "google.cloud.hypercomputecluster_v1beta.types.hypercompute_cluster",
    "google.cloud.hypercomputecluster_v1beta.types.operation_metadata",
}
...
api_core.check_python_version("google.cloud.hypercomputecluster_v1beta")
api_core.check_dependency_versions("google.cloud.hypercomputecluster_v1beta")

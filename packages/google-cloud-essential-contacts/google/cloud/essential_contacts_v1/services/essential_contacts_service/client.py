...
class EssentialContactsServiceClient(metaclass=EssentialContactsServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                EssentialContactsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = EssentialContactsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or EssentialContactsServiceClient._get_api_endpoint(

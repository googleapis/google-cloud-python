...
from .base import DEFAULT_CLIENT_INFO, EssentialContactsServiceTransport
...
class EssentialContactsServiceGrpcAsyncIOTransport(EssentialContactsServiceTransport):
    ...
    @property
    def create_contact(self) -> Callable[[service.CreateContactRequest], Awaitable[service.Contact]]:
        ...
        if "create_contact" not in self._stubs:
            self._stubs["create_contact"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_contact(self) -> Callable[[service.UpdateContactRequest], Awaitable[service.Contact]]:
        ...
        if "update_contact" not in self._stubs:
            self._stubs["update_contact"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_contacts(self) -> Callable[[service.ListContactsRequest], Awaitable[service.ListContactsResponse]]:
        ...
        if "list_contacts" not in self._stubs:
            self._stubs["list_contacts"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_contact(self) -> Callable[[service.GetContactRequest], Awaitable[service.Contact]]:
        ...
        if "get_contact" not in self._stubs:
            self._stubs["get_contact"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_contact(self) -> Callable[[service.DeleteContactRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if "delete_contact" not in self._stubs:
            self._stubs["delete_contact"] = self._logged_channel.unary_unary(
    ...
    @property
    def compute_contacts(self) -> Callable[[service.ComputeContactsRequest], Awaitable[service.ComputeContactsResponse]]:
        ...
        if "compute_contacts" not in self._stubs:
            self._stubs["compute_contacts"] = self._logged_channel.unary_unary(
    ...
    @property
    def send_test_message(self) -> Callable[[service.SendTestMessageRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if "send_test_message" not in self._stubs:
            self._stubs["send_test_message"] = self._logged_channel.unary_unary(

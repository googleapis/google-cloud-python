...
class EssentialContactsServiceGrpcAsyncIOTransport(EssentialContactsServiceTransport):
    ...
    def create_contact(
        self,
    ) -> Callable[[service.CreateContactRequest], Awaitable[service.Contact]]:
    ...
    def update_contact(
        self,
    ) -> Callable[[service.UpdateContactRequest], Awaitable[service.Contact]]:
    ...
    def list_contacts(
        ...
        [service.ListContactsRequest], Awaitable[service.ListContactsResponse]
    ]:
    ...
    def get_contact(
        self,
    ) -> Callable[[service.GetContactRequest], Awaitable[service.Contact]]:
    ...
    def delete_contact(
        self,
    ) -> Callable[[service.DeleteContactRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def compute_contacts(
        ...
        [service.ComputeContactsRequest], Awaitable[service.ComputeContactsResponse]
    ]:
    ...
    def send_test_message(
        self,
    ) -> Callable[[service.SendTestMessageRequest], Awaitable[empty_pb2.Empty]]:

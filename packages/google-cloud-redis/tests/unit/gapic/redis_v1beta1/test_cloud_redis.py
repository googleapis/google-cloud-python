...
from google.cloud.redis_v1beta1.services.cloud_redis import CloudRedisAsyncClient, CloudRedisClient, pagers, transports
...
def test_cloud_redis_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "redis.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://redis.googleapis.com"
        )
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/instances" % client.transport._host, args[1])
...
def test_get_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}" % client.transport._host, args[1])
...
def test_get_instance_auth_string_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}/authString" % client.transport._host, args[1])
...
def test_update_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{instance.name=projects/*/locations/*/instances/*}" % client.transport._host, args[1])
...
def test_upgrade_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}:upgrade" % client.transport._host, args[1])
...
def test_import_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}:import" % client.transport._host, args[1])
...
def test_export_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}:export" % client.transport._host, args[1])
...
def test_failover_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}:failover" % client.transport._host, args[1])
...
def test_reschedule_maintenance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/instances/*}:rescheduleMaintenance" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = CloudRedisClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CloudRedisAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CloudRedisAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CloudRedisClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CloudRedisRestInterceptor, "post_list_instances") as post, mock.patch.object(
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisRestInterceptor, "post_get_instance") as post, mock.patch.object(
...
def test_get_instance_auth_string_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CloudRedisRestInterceptor, "post_get_instance_auth_string") as post, mock.patch.object(
        transports.CloudRedisRestInterceptor, "post_get_instance_auth_string_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_instance_rest_call_success(request_type):
    ...
    request_init["instance"] = {
        ...
        "maintenance_schedule": {"start_time": {}, "end_time": {}, "can_reschedule": True, "schedule_deadline_time": {}},
        "replica_count": 1384,
        "nodes": [{"id": "id_value", "zone": "zone_value"}],
        "read_endpoint": "read_endpoint_value",
        "read_endpoint_port": 1920,
        "read_replicas_mode": 1,
        "persistence_config": {"persistence_mode": 1, "rdb_snapshot_period": 3, "rdb_next_snapshot_time": {}, "rdb_snapshot_start_time": {}},
    }
...
def test_reschedule_maintenance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CloudRedisRestInterceptor, "post_reschedule_maintenance_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_cloud_redis_base_transport():
    ...
    with mock.patch("google.cloud.redis_v1beta1.services.cloud_redis.transports.CloudRedisTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.CloudRedisGrpcTransport, grpc_helpers), (transports.CloudRedisGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_cloud_redis_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "redis.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://redis.googleapis.com:8000"
    )

...
class CloudRedisGrpcAsyncIOTransport(CloudRedisTransport):
    ...
    @property
    def get_instance(self) -> Callable[[cloud_redis.GetInstanceRequest], Awaitable[cloud_redis.Instance]]:
    ...
    @property
    def get_instance_auth_string(self) -> Callable[[cloud_redis.GetInstanceAuthStringRequest], Awaitable[cloud_redis.InstanceAuthString]]:
    ...
    @property
    def create_instance(self) -> Callable[[cloud_redis.CreateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_instance(self) -> Callable[[cloud_redis.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def upgrade_instance(self) -> Callable[[cloud_redis.UpgradeInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_instance(self) -> Callable[[cloud_redis.ImportInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_instance(self) -> Callable[[cloud_redis.ExportInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def failover_instance(self) -> Callable[[cloud_redis.FailoverInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_instance(self) -> Callable[[cloud_redis.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def reschedule_maintenance(self) -> Callable[[cloud_redis.RescheduleMaintenanceRequest], Awaitable[operations_pb2.Operation]]:

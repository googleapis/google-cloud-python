...
Instance = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          [alternative_location_id][google.cloud.redis.v1.Instance.alter
          native_location_id] fields for more details.
      display_name:
      ...
      location_id:
          ...
          For STANDARD_HA tier, instances will be created across two
          zones for protection against zonal failures. If [alternative_l
          ocation_id][google.cloud.redis.v1.Instance.alternative_locatio
          n_id] is also provided, it must be different from
      ...
      redis_version:
          ...
          compatibility -  ``REDIS_4_0`` for Redis 4.0 compatibility
      ...
      current_location_id:
          ...
          alternative_location_id][google.cloud.redis.v1.Instance.altern
          ative_location_id] and can change after a failover event.
      create_time:
      ...
      redis_configs:
          ...
          parameters are:  Redis version 3.2 and newer:  -  maxmemory-
          policy -  notify-keyspace-events  Redis version 4.0 and newer:
          -  activedefrag -  lfu-decay-time -  lfu-log-factor -
          maxmemory-gb  Redis version 5.0 and newer:  -  stream-node-
          max-bytes -  stream-node-max-entries
      tier:
      ...
      connect_mode:
          ...
          default one will be used. Current default: DIRECT_PEERING.
  """,
...
ListInstancesRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          token``][google.cloud.redis.v1.ListInstancesResponse.next_page
          _token] to determine if there are more instances left to be
          queried.
      page_token:

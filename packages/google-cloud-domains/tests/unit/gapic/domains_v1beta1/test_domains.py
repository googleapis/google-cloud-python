...
from google.cloud.domains_v1beta1.services.domains import DomainsAsyncClient, DomainsClient, pagers, transports
...
def test_domains_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "domains.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://domains.googleapis.com"
        )
...
async def test_list_registrations_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_registrations), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            domains.ListRegistrationsResponse(
                registrations=[
...
def test_update_registration(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_registration), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_export_registration(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.export_registration), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_registration(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_registration), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_reset_authorization_code(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.reset_authorization_code), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = domains.AuthorizationCode(
            code="code_value",
        )
...
def test_retrieve_register_parameters_rest_required_fields(request_type=domains.RetrieveRegisterParametersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_register_parameters._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_retrieve_register_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{location=projects/*/locations/*}/registrations:retrieveRegisterParameters" % client.transport._host, args[1]
        )
...
def test_retrieve_transfer_parameters_rest_required_fields(request_type=domains.RetrieveTransferParametersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_transfer_parameters._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_retrieve_transfer_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{location=projects/*/locations/*}/registrations:retrieveTransferParameters" % client.transport._host, args[1]
        )
...
def test_update_registration_rest_required_fields(request_type=domains.UpdateRegistrationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_registration._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_configure_management_settings_rest_required_fields(request_type=domains.ConfigureManagementSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).configure_management_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_configure_management_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:configureManagementSettings" % client.transport._host, args[1]
        )
...
def test_configure_dns_settings_rest_required_fields(request_type=domains.ConfigureDnsSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).configure_dns_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_configure_dns_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:configureDnsSettings" % client.transport._host, args[1]
        )
...
def test_configure_contact_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:configureContactSettings" % client.transport._host, args[1]
        )
...
def test_export_registration_rest_required_fields(request_type=domains.ExportRegistrationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_registration._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_registration_rest_required_fields(request_type=domains.DeleteRegistrationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_registration._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_retrieve_authorization_code_rest_required_fields(request_type=domains.RetrieveAuthorizationCodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_authorization_code._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_retrieve_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:retrieveAuthorizationCode" % client.transport._host, args[1]
        )
...
def test_reset_authorization_code_rest_required_fields(request_type=domains.ResetAuthorizationCodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_authorization_code._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_reset_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{registration=projects/*/locations/*/registrations/*}:resetAuthorizationCode" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = DomainsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = DomainsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = DomainsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = DomainsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DomainsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DomainsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_search_domains_rest_bad_request(request_type=domains.SearchDomainsRequest):
    client = DomainsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_search_domains_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_search_domains") as post, mock.patch.object(
...
def test_retrieve_register_parameters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_retrieve_register_parameters") as post, mock.patch.object(
        transports.DomainsRestInterceptor, "post_retrieve_register_parameters_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_retrieve_transfer_parameters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_retrieve_transfer_parameters") as post, mock.patch.object(
        transports.DomainsRestInterceptor, "post_retrieve_transfer_parameters_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_registrations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_list_registrations") as post, mock.patch.object(
...
def test_get_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_get_registration") as post, mock.patch.object(
    ...
    request_init["registration"] = {
        ...
        "dns_settings": {
            "custom_dns": {
                ...
                "ds_records": [{"key_tag": 740, "algorithm": 1, "digest_type": 1, "digest": "digest_value"}],
            },
            "google_domains_dns": {"name_servers": ["name_servers_value1", "name_servers_value2"], "ds_state": 1, "ds_records": {}},
            "glue_records": [
                {
                    "host_name": "host_name_value",
                    "ipv4_addresses": ["ipv4_addresses_value1", "ipv4_addresses_value2"],
                    "ipv6_addresses": ["ipv6_addresses_value1", "ipv6_addresses_value2"],
                }
            ],
        },
        "contact_settings": {
...
def test_configure_management_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DomainsRestInterceptor, "post_configure_management_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_configure_contact_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DomainsRestInterceptor, "post_configure_contact_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_retrieve_authorization_code_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_retrieve_authorization_code") as post, mock.patch.object(
        transports.DomainsRestInterceptor, "post_retrieve_authorization_code_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_reset_authorization_code_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DomainsRestInterceptor, "post_reset_authorization_code") as post, mock.patch.object(
...
def test_domains_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.DomainsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.DomainsGrpcTransport, grpc_helpers), (transports.DomainsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_domains_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.DomainsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_domains_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "domains.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://domains.googleapis.com:8000"
    )
...
def test_client_ctx():
    ...
    for transport in transports:
        client = DomainsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

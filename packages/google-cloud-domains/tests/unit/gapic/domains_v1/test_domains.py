...
from google.cloud.domains_v1.services.domains import DomainsAsyncClient, DomainsClient, pagers, transports
...
def test_retrieve_register_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{location=projects/*/locations/*}/registrations:retrieveRegisterParameters" % client.transport._host, args[1]
        )
...
def test_retrieve_transfer_parameters_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{location=projects/*/locations/*}/registrations:retrieveTransferParameters" % client.transport._host, args[1]
        )
...
def test_configure_management_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{registration=projects/*/locations/*/registrations/*}:configureManagementSettings" % client.transport._host, args[1]
        )
...
def test_configure_dns_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{registration=projects/*/locations/*/registrations/*}:configureDnsSettings" % client.transport._host, args[1]
        )
...
def test_configure_contact_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{registration=projects/*/locations/*/registrations/*}:configureContactSettings" % client.transport._host, args[1]
        )
...
def test_retrieve_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{registration=projects/*/locations/*/registrations/*}:retrieveAuthorizationCode" % client.transport._host, args[1]
        )
...
def test_reset_authorization_code_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{registration=projects/*/locations/*/registrations/*}:resetAuthorizationCode" % client.transport._host, args[1]
        )

...
class DomainsAsyncClient:
    ...
    async def update_registration(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("registration.name", request.registration.name),)),)
    ...
    async def configure_management_settings(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("registration", request.registration),)),)

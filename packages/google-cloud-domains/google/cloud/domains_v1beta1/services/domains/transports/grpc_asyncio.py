...
class DomainsGrpcAsyncIOTransport(DomainsTransport):
    ...
    def retrieve_register_parameters(
        self,
    ) -> Callable[[domains.RetrieveRegisterParametersRequest], Awaitable[domains.RetrieveRegisterParametersResponse]]:
    ...
    @property
    def register_domain(self) -> Callable[[domains.RegisterDomainRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def retrieve_transfer_parameters(
        self,
    ) -> Callable[[domains.RetrieveTransferParametersRequest], Awaitable[domains.RetrieveTransferParametersResponse]]:
    ...
    @property
    def transfer_domain(self) -> Callable[[domains.TransferDomainRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_registrations(self) -> Callable[[domains.ListRegistrationsRequest], Awaitable[domains.ListRegistrationsResponse]]:
    ...
    @property
    def get_registration(self) -> Callable[[domains.GetRegistrationRequest], Awaitable[domains.Registration]]:
    ...
    @property
    def update_registration(self) -> Callable[[domains.UpdateRegistrationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def configure_management_settings(self) -> Callable[[domains.ConfigureManagementSettingsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def configure_dns_settings(self) -> Callable[[domains.ConfigureDnsSettingsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def configure_contact_settings(self) -> Callable[[domains.ConfigureContactSettingsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_registration(self) -> Callable[[domains.ExportRegistrationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_registration(self) -> Callable[[domains.DeleteRegistrationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def retrieve_authorization_code(self) -> Callable[[domains.RetrieveAuthorizationCodeRequest], Awaitable[domains.AuthorizationCode]]:
    ...
    @property
    def reset_authorization_code(self) -> Callable[[domains.ResetAuthorizationCodeRequest], Awaitable[domains.AuthorizationCode]]:

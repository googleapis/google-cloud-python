...
AppEngineHttpTarget = _reflection.GeneratedProtocolMessageType(
  ...
  an HTTP request via an [http\_method][google.cloud.scheduler.v1.AppEng
  ineHttpTarget.http\_method] such as HTTP POST, HTTP GET, etc. The job
  is acknowledged by means of an HTTP response code in the range [200 -

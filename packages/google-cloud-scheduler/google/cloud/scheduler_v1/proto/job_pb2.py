...
# source: google/cloud/scheduler_v1/proto/job.proto
...
from google.cloud.scheduler_v1.proto import (
    target_pb2 as google_dot_cloud_dot_scheduler__v1_dot_proto_dot_target__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/scheduler_v1/proto/job.proto",
    ...
    dependencies=[
        ...
        google_dot_cloud_dot_scheduler__v1_dot_proto_dot_target__pb2.DESCRIPTOR,
...
_JOB = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.scheduler.v1.Job.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="description",
            full_name="google.cloud.scheduler.v1.Job.description",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="pubsub_target",
            full_name="google.cloud.scheduler.v1.Job.pubsub_target",
            index=2,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.Job.app_engine_http_target",
            index=3,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="http_target",
            full_name="google.cloud.scheduler.v1.Job.http_target",
            index=4,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="schedule",
            full_name="google.cloud.scheduler.v1.Job.schedule",
            index=5,
            number=20,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="time_zone",
            full_name="google.cloud.scheduler.v1.Job.time_zone",
            index=6,
            number=21,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.Job.user_update_time",
            index=7,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="status",
            full_name="google.cloud.scheduler.v1.Job.status",
            index=9,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="schedule_time",
            full_name="google.cloud.scheduler.v1.Job.schedule_time",
            index=10,
            number=17,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.Job.last_attempt_time",
            index=11,
            number=18,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="retry_config",
            full_name="google.cloud.scheduler.v1.Job.retry_config",
            index=12,
            number=19,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.Job.attempt_deadline",
            index=13,
            number=22,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="target",
            full_name="google.cloud.scheduler.v1.Job.target",
            index=0,
            containing_type=None,
            fields=[],
        )
...
_RETRYCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="retry_count",
            full_name="google.cloud.scheduler.v1.RetryConfig.retry_count",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.RetryConfig.max_retry_duration",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.RetryConfig.min_backoff_duration",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.scheduler.v1.RetryConfig.max_backoff_duration",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="max_doublings",
            full_name="google.cloud.scheduler.v1.RetryConfig.max_doublings",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_JOB.fields_by_name[
    ...
    google_dot_cloud_dot_scheduler__v1_dot_proto_dot_target__pb2._PUBSUBTARGET
)
_JOB.fields_by_name[
    "app_engine_http_target"
].message_type = (
    google_dot_cloud_dot_scheduler__v1_dot_proto_dot_target__pb2._APPENGINEHTTPTARGET
)
_JOB.fields_by_name[
    "http_target"
].message_type = (
    google_dot_cloud_dot_scheduler__v1_dot_proto_dot_target__pb2._HTTPTARGET
)
_JOB.fields_by_name[
    "user_update_time"
...
Job = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          ...
          ler.v1.CloudScheduler.CreateJob], after which it becomes
      ...
      description:
          Optionally caller-specified in [CreateJob][google.cloud.schedu
          ler.v1.CloudScheduler.CreateJob] or [UpdateJob][google.cloud.s
          cheduler.v1.CloudScheduler.UpdateJob].  A human-readable
          description for the job. This string must not contain more
          than 500 characters.
      target:
      ...
      schedule:
          ...
          uler.v1.CloudScheduler.UpdateJob].  Describes the schedule on
          which the job will be executed.  The schedule can be either of
          ...
          er.v1.RetryConfig.retry\_count] > 0 and a job attempt fails,
          the job will be tried a total of [retry\_count][google.cloud.s
          cheduler.v1.RetryConfig.retry\_count] times, with exponential
          backoff, until the next scheduled start time.
      time_zone:
          Specifies the time zone to be used in interpreting
          [schedule][google.cloud.scheduler.v1.Job.schedule]. The value
          of this field must be a time zone name from the `tz database
          <http://en.wikipedia.org/wiki/Tz_database>`__.  Note that some
          time zones include a provision for daylight savings time. The
          rules for daylight saving time are determined by the chosen
          tz. For UTC use the string "utc". If a time zone is not
      ...
      attempt_deadline:
          ...
          [RetryConfig][google.cloud.scheduler.v1.RetryConfig].  The
          allowed duration for this deadline is: \* For [HTTP
          targets][google.cloud.scheduler.v1.Job.http\_target], between
          15 seconds and 30 minutes. \* For [App Engine HTTP targets][go
          ogle.cloud.scheduler.v1.Job.app\_engine\_http\_target],
...
RetryConfig = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      retry_count:
          ...
          blings][google.cloud.scheduler.v1.RetryConfig.max\_doublings].
          The default value of retry\_count is zero.  If retry\_count is
          zero, a job attempt will *not* be retried if it fails. Instead
          the Cloud Scheduler system will wait for the next scheduled
          execution time.  If retry\_count is set to a non-zero number
          then Cloud Scheduler will retry failed attempts, using
          exponential backoff, retry\_count times, or until the next
      ...
      max_retry_duration:
          ...
          y\_count][google.cloud.scheduler.v1.RetryConfig.retry\_count],
          the job will be retried until both limits are reached.  The
          default value for max\_retry\_duration is zero, which means
      ...
      max_doublings:
          ...
          le.cloud.scheduler.v1.RetryConfig.min\_backoff\_duration],
          then doubles ``max_doublings`` times, then increases linearly,
          and finally retries retries at intervals of [max\_backoff\_dur
          ation][google.cloud.scheduler.v1.RetryConfig.max\_backoff\_dur
          ation] up to [retry\_count][google.cloud.scheduler.v1.RetryCon
          fig.retry\_count] times.  For example, if [min\_backoff\_durat
          ion][google.cloud.scheduler.v1.RetryConfig.min\_backoff\_durat
          ion] is 10s, [max\_backoff\_duration][google.cloud.scheduler.v
          1.RetryConfig.max\_backoff\_duration] is 300s, and
          ...
          at intervals of [max\_backoff\_duration][google.cloud.schedule
          r.v1.RetryConfig.max\_backoff\_duration] until the job has
          been attempted [retry\_count][google.cloud.scheduler.v1.RetryC
          onfig.retry\_count] times. Thus, the requests will retry at

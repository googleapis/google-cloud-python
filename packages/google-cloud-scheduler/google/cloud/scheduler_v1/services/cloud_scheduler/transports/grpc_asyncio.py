...
class CloudSchedulerGrpcAsyncIOTransport(CloudSchedulerTransport):
    ...
    @property
    def list_jobs(self) -> Callable[[cloudscheduler.ListJobsRequest], Awaitable[cloudscheduler.ListJobsResponse]]:
    ...
    @property
    def create_job(self) -> Callable[[cloudscheduler.CreateJobRequest], Awaitable[gcs_job.Job]]:
    ...
    @property
    def update_job(self) -> Callable[[cloudscheduler.UpdateJobRequest], Awaitable[gcs_job.Job]]:
    ...
    @property
    def delete_job(self) -> Callable[[cloudscheduler.DeleteJobRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def pause_job(self) -> Callable[[cloudscheduler.PauseJobRequest], Awaitable[job.Job]]:
    ...
    @property
    def resume_job(self) -> Callable[[cloudscheduler.ResumeJobRequest], Awaitable[job.Job]]:

...
class CloudSchedulerTransport(abc.ABC):
    ...
    def list_jobs(
        ...
        Union[
            cloudscheduler.ListJobsResponse, Awaitable[cloudscheduler.ListJobsResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_job(
        self,
    ) -> Callable[[cloudscheduler.GetJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()
    ...
    def create_job(
        ...
        [cloudscheduler.CreateJobRequest], Union[gcs_job.Job, Awaitable[gcs_job.Job]]
    ]:
        raise NotImplementedError()
    ...
    def update_job(
        ...
        [cloudscheduler.UpdateJobRequest], Union[gcs_job.Job, Awaitable[gcs_job.Job]]
    ]:
        raise NotImplementedError()
    ...
    def pause_job(
        self,
    ) -> Callable[[cloudscheduler.PauseJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()
    ...
    def resume_job(
        ...
        [cloudscheduler.ResumeJobRequest], Union[job.Job, Awaitable[job.Job]]
    ]:
        raise NotImplementedError()

...
class CloudSchedulerTransport(abc.ABC):
    ...
    def list_jobs(
        self,
    ) -> Callable[[cloudscheduler.ListJobsRequest], Union[cloudscheduler.ListJobsResponse, Awaitable[cloudscheduler.ListJobsResponse]]]:
        raise NotImplementedError()

    @property
    def get_job(self) -> Callable[[cloudscheduler.GetJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()

    @property
    def create_job(self) -> Callable[[cloudscheduler.CreateJobRequest], Union[gcs_job.Job, Awaitable[gcs_job.Job]]]:
        raise NotImplementedError()

    @property
    def update_job(self) -> Callable[[cloudscheduler.UpdateJobRequest], Union[gcs_job.Job, Awaitable[gcs_job.Job]]]:
        raise NotImplementedError()

    @property
    def delete_job(self) -> Callable[[cloudscheduler.DeleteJobRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def pause_job(self) -> Callable[[cloudscheduler.PauseJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()

    @property
    def resume_job(self) -> Callable[[cloudscheduler.ResumeJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()

    @property
    def run_job(self) -> Callable[[cloudscheduler.RunJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()

...
class _BaseCloudSchedulerRestTransport(CloudSchedulerTransport):
    """Base REST backend transport for CloudScheduler.
    ...
    class _BasePauseJob:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/jobs/*}:pause",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseResumeJob:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/jobs/*}:resume",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseRunJob:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/jobs/*}:run",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdateJob:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{job.name=projects/*/locations/*/jobs/*}",
                    "body": "job",
                },
            ]
            return http_options
...
__all__ = ("_BaseCloudSchedulerRestTransport",)

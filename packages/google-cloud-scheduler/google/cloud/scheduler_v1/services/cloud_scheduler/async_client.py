...
class CloudSchedulerAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CloudSchedulerTransport, Callable[..., CloudSchedulerTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.scheduler_v1.CloudSchedulerAsyncClient`.",
                extra={
    ...
    async def pause_job(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.pause_job]
    ...
    async def resume_job(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resume_job]

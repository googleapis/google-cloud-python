...
__lazy_modules__ = {
    ...
    "google.cloud.scheduler_v1.types.cloudscheduler",
    "google.cloud.scheduler_v1.types.job",
    "google.cloud.scheduler_v1.types.target",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.scheduler_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.scheduler_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.scheduler_v1"

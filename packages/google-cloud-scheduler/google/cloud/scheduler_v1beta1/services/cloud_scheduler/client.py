...
class CloudSchedulerClient(metaclass=CloudSchedulerClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CloudSchedulerClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudSchedulerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = CloudSchedulerClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CloudSchedulerClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.scheduler_v1beta1.CloudSchedulerClient`.",
                    extra={

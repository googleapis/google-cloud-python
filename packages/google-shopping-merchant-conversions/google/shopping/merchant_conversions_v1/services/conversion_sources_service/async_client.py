...
class ConversionSourcesServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ConversionSourcesServiceClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ConversionSourcesServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
    ...
    async def create_conversion_source(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_conversions_v1.types.CreateConversionSourceRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            conversion_source (:class:`google.shopping.merchant_conversions_v1.types.ConversionSource`):
    ...
    async def update_conversion_source(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_conversions_v1.types.UpdateConversionSourceRequest, dict]]):
                The request object. Request message for the
    ...
    async def delete_conversion_source(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_conversions_v1.types.DeleteConversionSourceRequest, dict]]):
                The request object. Request message for the
    ...
    async def undelete_conversion_source(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_conversions_v1.types.UndeleteConversionSourceRequest, dict]]):
                The request object. Request message for the
    ...
    async def get_conversion_source(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_conversions_v1.types.GetConversionSourceRequest, dict]]):
                The request object. Request message for the
    ...
    async def list_conversion_sources(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_conversions_v1.types.ListConversionSourcesRequest, dict]]):
                The request object. Request message for the
        ...
        Returns:
            google.shopping.merchant_conversions_v1.services.conversion_sources_service.pagers.ListConversionSourcesAsyncPager:

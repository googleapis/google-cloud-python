...
class ListConversionSourcesPager:
    ...
    :class:`google.shopping.merchant_conversions_v1.types.ListConversionSourcesResponse` object, and
    ...
    All the usual :class:`google.shopping.merchant_conversions_v1.types.ListConversionSourcesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.shopping.merchant_conversions_v1.types.ListConversionSourcesRequest):
                The initial request object.
            response (google.shopping.merchant_conversions_v1.types.ListConversionSourcesResponse):
...
class ListConversionSourcesAsyncPager:
    ...
    async def pages(
        self,
    ) -> AsyncIterator[conversionsources.ListConversionSourcesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

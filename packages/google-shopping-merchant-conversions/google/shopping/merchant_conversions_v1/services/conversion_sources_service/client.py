...
class ConversionSourcesServiceClient(metaclass=ConversionSourcesServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ConversionSourcesServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ConversionSourcesServiceClient._get_api_endpoint(

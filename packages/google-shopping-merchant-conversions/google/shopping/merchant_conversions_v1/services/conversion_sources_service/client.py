...
class ConversionSourcesServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ConversionSourcesServiceTransport]]
...
class ConversionSourcesServiceClient(metaclass=ConversionSourcesServiceClientMeta):
    ...
    def conversion_source_path(
        ...
        return "accounts/{account}/conversionSources/{conversion_source}".format(
            account=account,
    ...
    def parse_conversion_source_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/conversionSources/(?P<conversion_source>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ConversionSourcesServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                ConversionSourcesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = ConversionSourcesServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ConversionSourcesServiceClient._get_api_endpoint(

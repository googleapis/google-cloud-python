...
class ConversionSourcesServiceTransport(abc.ABC):
    """Abstract transport class for ConversionSourcesService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_conversion_source: gapic_v1.method.wrap_method(
                self.create_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_conversion_source: gapic_v1.method.wrap_method(
                self.update_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_conversion_source: gapic_v1.method.wrap_method(
                self.delete_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.undelete_conversion_source: gapic_v1.method.wrap_method(
                self.undelete_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_conversion_source: gapic_v1.method.wrap_method(
                self.get_conversion_source,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_conversion_sources: gapic_v1.method.wrap_method(
...
__all__ = ("ConversionSourcesServiceTransport",)

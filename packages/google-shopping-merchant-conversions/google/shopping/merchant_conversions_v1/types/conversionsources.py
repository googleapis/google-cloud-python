...
__protobuf__ = proto.module(
    package="google.shopping.merchant.conversions.v1",
    manifest={
        "ConversionSource",
        "AttributionSettings",
        "GoogleAnalyticsLink",
...
class ConversionSource(proto.Message):
    ...
    Attributes:
        google_analytics_link (google.shopping.merchant_conversions_v1.types.GoogleAnalyticsLink):
            Immutable. Conversion Source of type "Link to
            Google Analytics Property".

            This field is a member of `oneof`_ ``source_data``.
        merchant_center_destination (google.shopping.merchant_conversions_v1.types.MerchantCenterDestination):
        ...
        name (str):
            ...
            creation of a new ``ConversionSource``. Format:
            ``[a-z]{4}:.+`` The four characters before the colon
            represent the type of conversion source. Content after the
            colon represents the ID of the conversion source within that
            type. The ID of two different conversion sources might be
        ...
        controller (google.shopping.merchant_conversions_v1.types.ConversionSource.Controller):
            Output only. Controller of the conversion
            source.
    """

    class State(proto.Enum):
        r"""Represents the state of a conversion source.
        ...
        Values:
            ...
            ARCHIVED (2):
                ...
                last 30 days and is currently not functional.
                Can be restored using the undelete method.
            PENDING (3):
...
class AttributionSettings(proto.Message):
    ...
    Attributes:
        attribution_lookback_window_days (int):
            Required. Lookback window (in days) used for attribution in
            this source. Supported values are ``7``, ``30`` & ``40``.
        attribution_model (google.shopping.merchant_conversions_v1.types.AttributionSettings.AttributionModel):
            Required. Attribution model.
        conversion_type (MutableSequence[google.shopping.merchant_conversions_v1.types.AttributionSettings.ConversionType]):
    ...
    class ConversionType(proto.Message):
        r"""Message representing the type of a conversion event.
...
class GoogleAnalyticsLink(proto.Message):
    ...
    Attributes:
        ...
        attribution_settings (google.shopping.merchant_conversions_v1.types.AttributionSettings):
...
class MerchantCenterDestination(proto.Message):
    ...
    Attributes:
        ...
        attribution_settings (google.shopping.merchant_conversions_v1.types.AttributionSettings):
            Required. Attribution settings used for the
        ...
        display_name (str):
            ...
            Merchant Center UI. The maximum length is 64
            characters.
        currency_code (str):
...
class CreateConversionSourceRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Required. The merchant account that will own the new
            conversion source. Format: ``accounts/{account}``
        conversion_source (google.shopping.merchant_conversions_v1.types.ConversionSource):
...
class ListConversionSourcesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Required. The merchant account who owns the collection of
        ...
        page_token (str):
            Optional. Page token.
        show_deleted (bool):
            Optional. Show deleted (archived) conversion
            sources. By default, deleted conversion sources
            are not returned.
    """
...
class ListConversionSourcesResponse(proto.Message):
    ...
    Attributes:
        conversion_sources (MutableSequence[google.shopping.merchant_conversions_v1.types.ConversionSource]):

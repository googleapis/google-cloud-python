...
class ConversionSourcesServiceGrpcTransport(ConversionSourcesServiceTransport):
    """gRPC backend transport for ConversionSourcesService.
    ...
    def create_conversion_source(
        ...
        Returns:
            Callable[[~.CreateConversionSourceRequest],
                    ~.ConversionSource]:
        ...
        if "create_conversion_source" not in self._stubs:
            self._stubs["create_conversion_source"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.conversions.v1beta.ConversionSourcesService/CreateConversionSource",
                request_serializer=conversionsources.CreateConversionSourceRequest.serialize,
    ...
    def update_conversion_source(
        ...
        Returns:
            Callable[[~.UpdateConversionSourceRequest],
                    ~.ConversionSource]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_conversion_source" not in self._stubs:
            self._stubs["update_conversion_source"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.conversions.v1beta.ConversionSourcesService/UpdateConversionSource",
                request_serializer=conversionsources.UpdateConversionSourceRequest.serialize,
                response_deserializer=conversionsources.ConversionSource.deserialize,
            )
    ...
    def delete_conversion_source(
        ...
        Returns:
            Callable[[~.DeleteConversionSourceRequest],
                    ~.Empty]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_conversion_source" not in self._stubs:
            self._stubs["delete_conversion_source"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.conversions.v1beta.ConversionSourcesService/DeleteConversionSource",
                request_serializer=conversionsources.DeleteConversionSourceRequest.serialize,
    ...
    def undelete_conversion_source(
        ...
        Returns:
            Callable[[~.UndeleteConversionSourceRequest],
                    ~.ConversionSource]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def get_conversion_source(
        ...
        Returns:
            Callable[[~.GetConversionSourceRequest],
                    ~.ConversionSource]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_conversion_source" not in self._stubs:
            self._stubs["get_conversion_source"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.conversions.v1beta.ConversionSourcesService/GetConversionSource",
                request_serializer=conversionsources.GetConversionSourceRequest.serialize,
                response_deserializer=conversionsources.ConversionSource.deserialize,
            )
    ...
    def list_conversion_sources(
        ...
        Returns:
            Callable[[~.ListConversionSourcesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_conversion_sources" not in self._stubs:
            self._stubs["list_conversion_sources"] = self._logged_channel.unary_unary(
...
__all__ = ("ConversionSourcesServiceGrpcTransport",)

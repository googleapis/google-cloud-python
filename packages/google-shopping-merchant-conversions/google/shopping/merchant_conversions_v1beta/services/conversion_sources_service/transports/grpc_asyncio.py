...
class ConversionSourcesServiceGrpcAsyncIOTransport(ConversionSourcesServiceTransport):
    ...
    @property
    def create_conversion_source(self) -> Callable[[conversionsources.CreateConversionSourceRequest], Awaitable[conversionsources.ConversionSource]]:
    ...
    @property
    def update_conversion_source(self) -> Callable[[conversionsources.UpdateConversionSourceRequest], Awaitable[conversionsources.ConversionSource]]:
    ...
    @property
    def delete_conversion_source(self) -> Callable[[conversionsources.DeleteConversionSourceRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def undelete_conversion_source(
        self,
    ) -> Callable[[conversionsources.UndeleteConversionSourceRequest], Awaitable[conversionsources.ConversionSource]]:
    ...
    @property
    def get_conversion_source(self) -> Callable[[conversionsources.GetConversionSourceRequest], Awaitable[conversionsources.ConversionSource]]:

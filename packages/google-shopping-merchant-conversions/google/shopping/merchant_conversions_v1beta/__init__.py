...
api_core.check_python_version("google.shopping.merchant_conversions_v1beta")
api_core.check_dependency_versions("google.shopping.merchant_conversions_v1beta")

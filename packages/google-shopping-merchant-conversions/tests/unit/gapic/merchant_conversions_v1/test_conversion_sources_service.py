...
def test_create_conversion_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/conversions/v1/{parent=accounts/*}/conversionSources"
...
def test_update_conversion_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/conversions/v1/{conversion_source.name=accounts/*/conversionSources/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_conversion_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/conversions/v1/{name=accounts/*/conversionSources/*}"
            % client.transport._host,
            args[1],
        )

        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.maintenance.api_v1.MaintenanceClient.GetResourceMaintenance",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.maintenance.api_v1.MaintenanceClient.get_resource_maintenance",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
                        "rpcName": "GetResourceMaintenance",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.maintenance.api_v1.MaintenanceClient.ListResourceMaintenances",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.maintenance.api_v1.MaintenanceClient.list_resource_maintenances",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
                        "rpcName": "ListResourceMaintenances",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.maintenance.api_v1.MaintenanceClient.SummarizeMaintenances",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.maintenance.api_v1.MaintenanceClient.summarize_maintenances",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
                        "rpcName": "SummarizeMaintenances",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.maintenance.api_v1.MaintenanceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.maintenance.api_v1.MaintenanceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.maintenance.api_v1.MaintenanceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.maintenance.api_v1.MaintenanceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.maintenance.api.v1.Maintenance",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,

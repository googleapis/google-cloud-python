...
class MaintenanceTransport(abc.ABC):
    """Abstract transport class for Maintenance."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "maintenance.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.summarize_maintenances: gapic_v1.method.wrap_method(
                self.summarize_maintenances,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_resource_maintenances: gapic_v1.method.wrap_method(
                self.list_resource_maintenances,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_resource_maintenance: gapic_v1.method.wrap_method(
                self.get_resource_maintenance,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def summarize_maintenances(
        ...
        Union[
            ...
            Awaitable[maintenance_service.SummarizeMaintenancesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_resource_maintenances(
        ...
        Union[
            ...
            Awaitable[maintenance_service.ListResourceMaintenancesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_resource_maintenance(
        ...
        Union[
            ...
            Awaitable[maintenance_service.ResourceMaintenance],
        ],
    ]:
        raise NotImplementedError()

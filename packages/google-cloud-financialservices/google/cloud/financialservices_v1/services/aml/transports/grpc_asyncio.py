...
class AMLGrpcAsyncIOTransport(AMLTransport):
    ...
    @property
    def create_instance(self) -> Callable[[gcf_instance.CreateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_instance(self) -> Callable[[gcf_instance.UpdateInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_instance(self) -> Callable[[instance.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def import_registered_parties(self) -> Callable[[instance.ImportRegisteredPartiesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_registered_parties(self) -> Callable[[instance.ExportRegisteredPartiesRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_datasets(self) -> Callable[[dataset.ListDatasetsRequest], Awaitable[dataset.ListDatasetsResponse]]:
    ...
    @property
    def get_dataset(self) -> Callable[[dataset.GetDatasetRequest], Awaitable[dataset.Dataset]]:
    ...
    @property
    def create_dataset(self) -> Callable[[gcf_dataset.CreateDatasetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_dataset(self) -> Callable[[gcf_dataset.UpdateDatasetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_dataset(self) -> Callable[[dataset.DeleteDatasetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_models(self) -> Callable[[model.ListModelsRequest], Awaitable[model.ListModelsResponse]]:
    ...
    @property
    def create_model(self) -> Callable[[gcf_model.CreateModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_model(self) -> Callable[[gcf_model.UpdateModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_model_metadata(self) -> Callable[[gcf_model.ExportModelMetadataRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_model(self) -> Callable[[model.DeleteModelRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_engine_configs(self) -> Callable[[engine_config.ListEngineConfigsRequest], Awaitable[engine_config.ListEngineConfigsResponse]]:
    ...
    @property
    def get_engine_config(self) -> Callable[[engine_config.GetEngineConfigRequest], Awaitable[engine_config.EngineConfig]]:
    ...
    @property
    def create_engine_config(self) -> Callable[[gcf_engine_config.CreateEngineConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_engine_config(self) -> Callable[[gcf_engine_config.UpdateEngineConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def export_engine_config_metadata(self) -> Callable[[gcf_engine_config.ExportEngineConfigMetadataRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_engine_config(self) -> Callable[[engine_config.DeleteEngineConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_engine_version(self) -> Callable[[engine_version.GetEngineVersionRequest], Awaitable[engine_version.EngineVersion]]:
    ...
    @property
    def list_engine_versions(self) -> Callable[[engine_version.ListEngineVersionsRequest], Awaitable[engine_version.ListEngineVersionsResponse]]:
    ...
    def list_prediction_results(
        self,
    ) -> Callable[[prediction_result.ListPredictionResultsRequest], Awaitable[prediction_result.ListPredictionResultsResponse]]:
    ...
    @property
    def get_prediction_result(self) -> Callable[[prediction_result.GetPredictionResultRequest], Awaitable[prediction_result.PredictionResult]]:
    ...
    @property
    def create_prediction_result(self) -> Callable[[gcf_prediction_result.CreatePredictionResultRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_prediction_result(self) -> Callable[[gcf_prediction_result.UpdatePredictionResultRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def export_prediction_result_metadata(
        self,
    ) -> Callable[[gcf_prediction_result.ExportPredictionResultMetadataRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_prediction_result(self) -> Callable[[prediction_result.DeletePredictionResultRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_backtest_results(self) -> Callable[[backtest_result.ListBacktestResultsRequest], Awaitable[backtest_result.ListBacktestResultsResponse]]:
    ...
    @property
    def get_backtest_result(self) -> Callable[[backtest_result.GetBacktestResultRequest], Awaitable[backtest_result.BacktestResult]]:
    ...
    @property
    def create_backtest_result(self) -> Callable[[gcf_backtest_result.CreateBacktestResultRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_backtest_result(self) -> Callable[[gcf_backtest_result.UpdateBacktestResultRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def export_backtest_result_metadata(
        self,
    ) -> Callable[[gcf_backtest_result.ExportBacktestResultMetadataRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_backtest_result(self) -> Callable[[backtest_result.DeleteBacktestResultRequest], Awaitable[operations_pb2.Operation]]:
...
__all__ = ("AMLGrpcAsyncIOTransport",)

...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert IdentityAwareProxyOAuthServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert IdentityAwareProxyOAuthServiceClient._use_client_cert_effective() is False
...
@mock.patch.object(
    IdentityAwareProxyOAuthServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(IdentityAwareProxyOAuthServiceClient)
)
@mock.patch.object(
    IdentityAwareProxyOAuthServiceAsyncClient,
...
def test__get_api_endpoint():
    ...
    assert (
        IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == IdentityAwareProxyOAuthServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        IdentityAwareProxyOAuthServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == IdentityAwareProxyOAuthServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
@pytest.mark.parametrize("client_class", [IdentityAwareProxyOAuthServiceClient, IdentityAwareProxyOAuthServiceAsyncClient])
...
def test_identity_aware_proxy_o_auth_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = IdentityAwareProxyOAuthServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_list_identity_aware_proxy_clients(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_identity_aware_proxy_clients), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_identity_aware_proxy_clients_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_identity_aware_proxy_clients), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            service.ListIdentityAwareProxyClientsResponse(
                identity_aware_proxy_clients=[
...
async def test_list_identity_aware_proxy_clients_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_identity_aware_proxy_clients), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_identity_aware_proxy_clients(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_identity_aware_proxy_client(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_identity_aware_proxy_client), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_identity_aware_proxy_client_rest_required_fields(request_type=service.CreateIdentityAwareProxyClientRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_identity_aware_proxy_client._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_identity_aware_proxy_clients_rest_required_fields(request_type=service.ListIdentityAwareProxyClientsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_identity_aware_proxy_clients._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_reset_identity_aware_proxy_client_secret_rest_required_fields(request_type=service.ResetIdentityAwareProxyClientSecretRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).reset_identity_aware_proxy_client_secret._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_identity_aware_proxy_client_rest_required_fields(request_type=service.DeleteIdentityAwareProxyClientRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_identity_aware_proxy_client._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = IdentityAwareProxyOAuthServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = IdentityAwareProxyOAuthServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = IdentityAwareProxyOAuthServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = IdentityAwareProxyOAuthServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = IdentityAwareProxyOAuthServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_brands_rest_bad_request(request_type=service.ListBrandsRequest):
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_brands_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_brands") as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_brands_with_metadata"
...
def test_create_brand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_brand") as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_brand_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_brand_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_brand") as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_brand_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_identity_aware_proxy_client"
    ) as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_create_identity_aware_proxy_client_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_create_identity_aware_proxy_client"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_identity_aware_proxy_clients_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_identity_aware_proxy_clients"
    ) as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_list_identity_aware_proxy_clients_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_list_identity_aware_proxy_clients"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_identity_aware_proxy_client"
    ) as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_get_identity_aware_proxy_client_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_get_identity_aware_proxy_client"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reset_identity_aware_proxy_client_secret_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_reset_identity_aware_proxy_client_secret"
    ) as post, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "post_reset_identity_aware_proxy_client_secret_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_reset_identity_aware_proxy_client_secret"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, "pre_delete_identity_aware_proxy_client") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    "transport_class", [transports.IdentityAwareProxyOAuthServiceGrpcTransport, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport]
)
def test_identity_aware_proxy_o_auth_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_identity_aware_proxy_o_auth_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_identity_aware_proxy_o_auth_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_identity_aware_proxy_o_auth_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_client_ctx():
    ...
    for transport in transports:
        client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
class IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport(IdentityAwareProxyOAuthServiceTransport):
    ...
    @property
    def list_brands(self) -> Callable[[service.ListBrandsRequest], Awaitable[service.ListBrandsResponse]]:
    ...
    @property
    def create_brand(self) -> Callable[[service.CreateBrandRequest], Awaitable[service.Brand]]:
    ...
    @property
    def get_brand(self) -> Callable[[service.GetBrandRequest], Awaitable[service.Brand]]:
    ...
    def create_identity_aware_proxy_client(
        self,
    ) -> Callable[[service.CreateIdentityAwareProxyClientRequest], Awaitable[service.IdentityAwareProxyClient]]:
    ...
    def list_identity_aware_proxy_clients(
        self,
    ) -> Callable[[service.ListIdentityAwareProxyClientsRequest], Awaitable[service.ListIdentityAwareProxyClientsResponse]]:
    ...
    @property
    def get_identity_aware_proxy_client(self) -> Callable[[service.GetIdentityAwareProxyClientRequest], Awaitable[service.IdentityAwareProxyClient]]:
    ...
    def reset_identity_aware_proxy_client_secret(
        self,
    ) -> Callable[[service.ResetIdentityAwareProxyClientSecretRequest], Awaitable[service.IdentityAwareProxyClient]]:
    ...
    @property
    def delete_identity_aware_proxy_client(self) -> Callable[[service.DeleteIdentityAwareProxyClientRequest], Awaitable[empty_pb2.Empty]]:

...
class IdentityAwareProxyOAuthServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            IdentityAwareProxyOAuthServiceClient._use_client_cert_effective()
        )
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(
            transport, IdentityAwareProxyOAuthServiceTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or IdentityAwareProxyOAuthServiceClient._get_api_endpoint(

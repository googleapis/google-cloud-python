...
from .transports.base import DEFAULT_CLIENT_INFO, IdentityAwareProxyOAuthServiceTransport
...
from .transports.rest import IdentityAwareProxyOAuthServiceRestTransport
...
class IdentityAwareProxyOAuthServiceClient(metaclass=IdentityAwareProxyOAuthServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "iap.{UNIVERSE_DOMAIN}"
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = IdentityAwareProxyOAuthServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = IdentityAwareProxyOAuthServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = IdentityAwareProxyOAuthServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = IdentityAwareProxyOAuthServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, IdentityAwareProxyOAuthServiceTransport, Callable[..., IdentityAwareProxyOAuthServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = IdentityAwareProxyOAuthServiceClient._read_environment_variables()
        self._client_cert_source = IdentityAwareProxyOAuthServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = IdentityAwareProxyOAuthServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, IdentityAwareProxyOAuthServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(IdentityAwareProxyOAuthServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or IdentityAwareProxyOAuthServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[IdentityAwareProxyOAuthServiceTransport], Callable[..., IdentityAwareProxyOAuthServiceTransport]] = (
                IdentityAwareProxyOAuthServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., IdentityAwareProxyOAuthServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.iap_v1.IdentityAwareProxyOAuthServiceClient`.",
                    extra={
    ...
    def create_identity_aware_proxy_client(
        self,
        request: Optional[Union[service.CreateIdentityAwareProxyClientRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def list_identity_aware_proxy_clients(
        self,
        request: Optional[Union[service.ListIdentityAwareProxyClientsRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def get_identity_aware_proxy_client(
        self,
        request: Optional[Union[service.GetIdentityAwareProxyClientRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def reset_identity_aware_proxy_client_secret(
        self,
        request: Optional[Union[service.ResetIdentityAwareProxyClientSecretRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def delete_identity_aware_proxy_client(
        self,
        request: Optional[Union[service.DeleteIdentityAwareProxyClientRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),

...
class IdentityAwareProxyAdminServiceClient(
    metaclass=IdentityAwareProxyAdminServiceClientMeta
):
    ...
    @staticmethod
    def tunnel_dest_group_path(
        project: str,
        location: str,
        dest_group: str,
    ) -> str:
        """Returns a fully-qualified tunnel_dest_group string."""
        return "projects/{project}/iap_tunnel/locations/{location}/destGroups/{dest_group}".format(
            project=project,
            location=location,
    ...
    def parse_tunnel_dest_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/iap_tunnel/locations/(?P<location>.+?)/destGroups/(?P<dest_group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def tunnel_location_path(
        project: str,
        location: str,
    ) -> str:
        """Returns a fully-qualified tunnel_location string."""
        return "projects/{project}/iap_tunnel/locations/{location}".format(
            project=project,
            location=location,
        )
    ...
    def parse_tunnel_location_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/iap_tunnel/locations/(?P<location>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or IdentityAwareProxyAdminServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(
            transport, IdentityAwareProxyAdminServiceTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or IdentityAwareProxyAdminServiceClient._get_api_endpoint(

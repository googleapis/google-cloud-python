...
class IdentityAwareProxyAdminServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            IdentityAwareProxyAdminServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
            IdentityAwareProxyAdminServiceAsyncClient, info, *args, **kwargs
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            IdentityAwareProxyAdminServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            IdentityAwareProxyAdminServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    get_transport_class = IdentityAwareProxyAdminServiceClient.get_transport_class

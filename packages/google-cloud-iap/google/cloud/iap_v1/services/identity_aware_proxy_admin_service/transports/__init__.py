...
from .rest import IdentityAwareProxyAdminServiceRestInterceptor, IdentityAwareProxyAdminServiceRestTransport
...
__all__ = (
    ...
    "IdentityAwareProxyAdminServiceRestTransport",
    "IdentityAwareProxyAdminServiceRestInterceptor",
)

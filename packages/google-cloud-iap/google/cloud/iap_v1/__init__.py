...
from .services.identity_aware_proxy_admin_service import IdentityAwareProxyAdminServiceAsyncClient, IdentityAwareProxyAdminServiceClient
from .services.identity_aware_proxy_o_auth_service import IdentityAwareProxyOAuthServiceAsyncClient, IdentityAwareProxyOAuthServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.iap_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.iap_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.iap_v1"

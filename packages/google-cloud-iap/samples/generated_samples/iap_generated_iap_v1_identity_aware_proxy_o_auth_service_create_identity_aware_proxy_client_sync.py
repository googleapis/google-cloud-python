...
# [START iap_generated_iap_v1_IdentityAwareProxyOAuthService_CreateIdentityAwareProxyClient_sync]
...
# [END iap_generated_iap_v1_IdentityAwareProxyOAuthService_CreateIdentityAwareProxyClient_sync]

...
# [START iap_generated_iap_v1_IdentityAwareProxyOAuthService_GetIdentityAwareProxyClient_sync]
...
# [END iap_generated_iap_v1_IdentityAwareProxyOAuthService_GetIdentityAwareProxyClient_sync]

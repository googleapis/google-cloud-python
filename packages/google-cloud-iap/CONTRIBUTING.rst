...
- While logged into your GitHub account, navigate to the
  ``python-iap`` `repo`_ on GitHub.

- Fork and clone the ``python-iap`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-iap`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-iap``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-iap.git hack-on-python-iap
   $ cd hack-on-python-iap
   # Configure remotes such that you can pull changes from the googleapis/python-iap
   # repository into your local repository.
   $ git remote add upstream git@github.com:googleapis/python-iap.git
...
.. _repo: https://github.com/googleapis/python-iap

...
from .types.common import EncryptionKey, NamespacedName, NamespacedNames, Namespaces, VolumeTypeEnum
...
from .types.restore import ResourceSelector, Restore, RestoreConfig, VolumeDataRestorePolicyOverride
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.gke_backup_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.gke_backup_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.gke_backup_v1"

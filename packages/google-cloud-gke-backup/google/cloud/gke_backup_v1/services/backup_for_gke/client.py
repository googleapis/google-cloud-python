...
class BackupForGKEClient(metaclass=BackupForGKEClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "gkebackup.{UNIVERSE_DOMAIN}"
    ...
    @staticmethod
    def backup_channel_path(
        project: str,
        location: str,
        backup_channel: str,
    ) -> str:
        """Returns a fully-qualified backup_channel string."""
        return "projects/{project}/locations/{location}/backupChannels/{backup_channel}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_backup_channel_path(path: str) -> Dict[str, str]:
        """Parses a backup_channel path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupChannels/(?P<backup_channel>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def backup_plan_path(
        ...
        return "projects/{project}/locations/{location}/backupPlans/{backup_plan}".format(
            project=project,
            location=location,
            backup_plan=backup_plan,
        )
    ...
    @staticmethod
    def backup_plan_binding_path(
        project: str,
        location: str,
        backup_channel: str,
        backup_plan_binding: str,
    ) -> str:
        """Returns a fully-qualified backup_plan_binding string."""
        return "projects/{project}/locations/{location}/backupChannels/{backup_channel}/backupPlanBindings/{backup_plan_binding}".format(
            project=project,
            location=location,
            backup_channel=backup_channel,
    ...
    @staticmethod
    def parse_backup_plan_binding_path(path: str) -> Dict[str, str]:
        """Parses a backup_plan_binding path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupChannels/(?P<backup_channel>.+?)/backupPlanBindings/(?P<backup_plan_binding>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def restore_channel_path(
        project: str,
        location: str,
        restore_channel: str,
    ) -> str:
        """Returns a fully-qualified restore_channel string."""
        return "projects/{project}/locations/{location}/restoreChannels/{restore_channel}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_restore_channel_path(path: str) -> Dict[str, str]:
        """Parses a restore_channel path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/restoreChannels/(?P<restore_channel>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def restore_plan_binding_path(
        project: str,
        location: str,
        restore_channel: str,
        restore_plan_binding: str,
    ) -> str:
        """Returns a fully-qualified restore_plan_binding string."""
        return "projects/{project}/locations/{location}/restoreChannels/{restore_channel}/restorePlanBindings/{restore_plan_binding}".format(
            project=project,
            location=location,
            restore_channel=restore_channel,
    ...
    @staticmethod
    def parse_restore_plan_binding_path(path: str) -> Dict[str, str]:
        """Parses a restore_plan_binding path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/restoreChannels/(?P<restore_channel>.+?)/restorePlanBindings/(?P<restore_plan_binding>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = BackupForGKEClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BackupForGKEClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = BackupForGKEClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = BackupForGKEClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, BackupForGKETransport, Callable[..., BackupForGKETransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BackupForGKEClient._read_environment_variables()
        self._client_cert_source = BackupForGKEClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BackupForGKEClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, BackupForGKETransport)
        if transport_provided:
            ...
            self._transport = cast(BackupForGKETransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or BackupForGKEClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BackupForGKETransport], Callable[..., BackupForGKETransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.gkebackup_v1.BackupForGKEClient`.",
                    extra={
    ...
    def create_backup_channel(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_backup_channel():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.CreateBackupChannelRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_backup_channel]
    ...
    def list_backup_channels(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListBackupChannelsPager:
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.ListBackupChannelsRequest, dict]):
                The request object. Request message for
                ListBackupChannels.
            parent (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_backup_channels]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListBackupChannelsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_backup_channel():
                ...
                # Make the request
                response = client.get_backup_channel(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.gke_backup_v1.types.GetBackupChannelRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_backup_channel]
    ...
    def update_backup_channel(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_backup_channel():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.UpdateBackupChannelRequest, dict]):
                The request object. Request message for
                UpdateBackupChannel.
            backup_channel (google.cloud.gke_backup_v1.types.BackupChannel):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_backup_channel]
    ...
    def delete_backup_channel(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.DeleteBackupChannelRequest, dict]):
                The request object. Request message for
                DeleteBackupChannel.
            name (str):
                Required. Fully qualified BackupChannel name. Format:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_backup_channel]
    ...
    def list_backup_plan_bindings(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListBackupPlanBindingsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_backup_plan_bindings():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.ListBackupPlanBindingsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_backup_plan_bindings]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListBackupPlanBindingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_backup_plan_binding(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_backup_plan_binding():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
                ...
                # Make the request
                response = client.get_backup_plan_binding(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.gke_backup_v1.types.GetBackupPlanBindingRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_backup_plan_binding]
    ...
    def create_restore_channel(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_restore_channel():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.CreateRestoreChannelRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_restore_channel]
    ...
    def list_restore_channels(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListRestoreChannelsPager:
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.ListRestoreChannelsRequest, dict]):
                The request object. Request message for
                ListRestoreChannels.
            parent (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_restore_channels]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListRestoreChannelsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_restore_channel(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_restore_channel():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
                ...
                # Make the request
                response = client.get_restore_channel(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.gke_backup_v1.types.GetRestoreChannelRequest, dict]):
                The request object. Request message for
                GetRestoreChannel.
            name (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_restore_channel]
    ...
    def update_restore_channel(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.UpdateRestoreChannelRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_restore_channel]
    ...
    def delete_restore_channel(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.DeleteRestoreChannelRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_restore_channel]
    ...
    def list_restore_plan_bindings(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListRestorePlanBindingsPager:
        ...
        Args:
            request (Union[google.cloud.gke_backup_v1.types.ListRestorePlanBindingsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_restore_plan_bindings]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListRestorePlanBindingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_restore_plan_binding(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_restore_plan_binding():
                # Create a client
                client = gke_backup_v1.BackupForGKEClient()
                ...
                # Make the request
                response = client.get_restore_plan_binding(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.gke_backup_v1.types.GetRestorePlanBindingRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_restore_plan_binding]
    ...
    def get_backup_index_download_url(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_backup_index_download_url]

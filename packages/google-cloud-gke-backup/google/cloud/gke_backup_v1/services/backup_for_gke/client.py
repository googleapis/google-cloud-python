...
class BackupForGKEClient(metaclass=BackupForGKEClientMeta):
    ...
    def parse_backup_channel_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupChannels/(?P<backup_channel>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def parse_restore_channel_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/restoreChannels/(?P<restore_channel>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = BackupForGKEClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = BackupForGKEClient._get_client_cert_source(
    ...
    def list_backup_plan_bindings(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_backup_plan_bindings
        ]
    ...
    def list_restore_plan_bindings(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_restore_plan_bindings
        ]

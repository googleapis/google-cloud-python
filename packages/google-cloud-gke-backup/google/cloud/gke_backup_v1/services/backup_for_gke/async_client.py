...
class BackupForGKEAsyncClient:
    ...
    parse_backup_channel_path = staticmethod(BackupForGKEClient.parse_backup_channel_path)
    ...
    parse_backup_plan_binding_path = staticmethod(BackupForGKEClient.parse_backup_plan_binding_path)
    ...
    parse_restore_channel_path = staticmethod(BackupForGKEClient.parse_restore_channel_path)
    ...
    restore_plan_binding_path = staticmethod(BackupForGKEClient.restore_plan_binding_path)
    parse_restore_plan_binding_path = staticmethod(BackupForGKEClient.parse_restore_plan_binding_path)
    ...
    parse_volume_restore_path = staticmethod(BackupForGKEClient.parse_volume_restore_path)
    common_billing_account_path = staticmethod(BackupForGKEClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(BackupForGKEClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(BackupForGKEClient.parse_common_organization_path)
    common_project_path = staticmethod(BackupForGKEClient.common_project_path)
    parse_common_project_path = staticmethod(BackupForGKEClient.parse_common_project_path)
    common_location_path = staticmethod(BackupForGKEClient.common_location_path)
    parse_common_location_path = staticmethod(BackupForGKEClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, BackupForGKETransport, Callable[..., BackupForGKETransport]]] = "grpc_asyncio",
    ...
    async def create_backup_plan(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_backup_plan]
    ...
    async def list_backup_plans(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_backup_plans]
    ...
    async def get_backup_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_backup_plan]
    ...
    async def update_backup_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_backup_plan]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("backup_plan.name", request.backup_plan.name),)),)
    ...
    async def delete_backup_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_backup_plan]
    ...
    async def create_backup_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_backup_channel]
    ...
    async def list_backup_channels(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_backup_channels]
    ...
    async def get_backup_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_backup_channel]
    ...
    async def update_backup_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_backup_channel]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("backup_channel.name", request.backup_channel.name),)),)
    ...
    async def delete_backup_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_backup_channel]
    ...
    async def list_backup_plan_bindings(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_backup_plan_bindings]
    ...
    async def get_backup_plan_binding(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_backup_plan_binding]
    ...
    async def list_volume_backups(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_volume_backups]
    ...
    async def get_volume_backup(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_volume_backup]
    ...
    async def create_restore_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_restore_plan]
    ...
    async def list_restore_plans(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_restore_plans]
    ...
    async def get_restore_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_restore_plan]
    ...
    async def update_restore_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_restore_plan]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("restore_plan.name", request.restore_plan.name),)),)
    ...
    async def delete_restore_plan(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_restore_plan]
    ...
    async def create_restore_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_restore_channel]
    ...
    async def list_restore_channels(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_restore_channels]
    ...
    async def get_restore_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_restore_channel]
    ...
    async def update_restore_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_restore_channel]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("restore_channel.name", request.restore_channel.name),)),)
    ...
    async def delete_restore_channel(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_restore_channel]
    ...
    async def list_restore_plan_bindings(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_restore_plan_bindings]
    ...
    async def get_restore_plan_binding(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_restore_plan_binding]
    ...
    async def create_restore(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_restore]
    ...
    async def list_restores(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_restores]
    ...
    async def get_restore(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_restore]
    ...
    async def update_restore(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_restore]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("restore.name", request.restore.name),)),)
    ...
    async def delete_restore(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_restore]
    ...
    async def list_volume_restores(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_volume_restores]
    ...
    async def get_volume_restore(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_volume_restore]
    ...
    async def get_backup_index_download_url(
        self,
        request: Optional[Union[gkebackup.GetBackupIndexDownloadUrlRequest, dict]] = None,
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_backup_index_download_url]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("backup", request.backup),)),)

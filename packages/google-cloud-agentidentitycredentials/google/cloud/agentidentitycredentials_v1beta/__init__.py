...
api_core.check_python_version("google.cloud.agentidentitycredentials_v1beta")
api_core.check_dependency_versions("google.cloud.agentidentitycredentials_v1beta")

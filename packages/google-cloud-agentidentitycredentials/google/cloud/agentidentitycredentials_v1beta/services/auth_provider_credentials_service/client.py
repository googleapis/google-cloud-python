...
from google.cloud.agentidentitycredentials_v1beta._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=AuthProviderCredentialsServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

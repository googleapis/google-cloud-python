...
class AuthProviderCredentialsServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.agentidentitycredentials_v1.AuthProviderCredentialsServiceClient`.",
                    extra={
    ...
    def retrieve_credentials(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.agentidentitycredentials_v1.types.RetrieveCredentialsRequest, dict]):
    ...
    def finalize_credentials(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.agentidentitycredentials_v1.types.FinalizeCredentialsRequest, dict]):
                The request object. Request message for
                FinalizeCredentials.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.

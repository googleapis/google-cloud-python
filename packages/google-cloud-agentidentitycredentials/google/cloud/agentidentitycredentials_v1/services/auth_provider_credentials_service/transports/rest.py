        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.agentidentitycredentials_v1.AuthProviderCredentialsServiceClient.FinalizeCredentials",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.agentidentitycredentials_v1.AuthProviderCredentialsServiceClient.finalize_credentials",
                    extra={
                        "serviceName": "google.cloud.agentidentitycredentials.v1.AuthProviderCredentialsService",
                        "rpcName": "FinalizeCredentials",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.agentidentitycredentials_v1.AuthProviderCredentialsServiceClient.RetrieveCredentials",
                    extra={
                        "serviceName": "google.cloud.agentidentitycredentials.v1.AuthProviderCredentialsService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.agentidentitycredentials_v1.AuthProviderCredentialsServiceClient.retrieve_credentials",
                    extra={
                        "serviceName": "google.cloud.agentidentitycredentials.v1.AuthProviderCredentialsService",
                        "rpcName": "RetrieveCredentials",
                        "metadata": http_response["headers"],

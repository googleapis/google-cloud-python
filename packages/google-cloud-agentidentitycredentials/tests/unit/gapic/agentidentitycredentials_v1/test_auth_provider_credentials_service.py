...
from google.cloud.agentidentitycredentials_v1.services.auth_provider_credentials_service import (
...
def test_auth_provider_credentials_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.agentidentitycredentials_v1.services.auth_provider_credentials_service.transports.AuthProviderCredentialsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_retrieve_credentials_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{auth_provider=projects/*/locations/*/authProviders/*}/credentials:retrieve"
...
def test_auth_provider_credentials_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.agentidentitycredentials_v1.services.auth_provider_credentials_service.transports.AuthProviderCredentialsServiceTransport.__init__"
    ) as Transport:
...
def test_auth_provider_credentials_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.agentidentitycredentials_v1.services.auth_provider_credentials_service.transports.AuthProviderCredentialsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

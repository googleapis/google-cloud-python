...
##
# google-cloud-agentidentitycredentials documentation build configuration file
#
...
project = "google-cloud-agentidentitycredentials"
copyright = "2026, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-agentidentitycredentials",
...
htmlhelp_basename = "google-cloud-agentidentitycredentials-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-agentidentitycredentials.tex",
        "google-cloud-agentidentitycredentials Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-agentidentitycredentials",
        "google-cloud-agentidentitycredentials Library",
        "APIs",
    )
]

...
class channelCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'change_offer': ('name', 'offer', 'parameters', 'purchase_order_id', 'request_id', 'billing_account', 'price_reference_id', ),
        ...
        'list_subscribers': ('account', 'page_size', 'page_token', 'integrator', ),
        ...
        'register_subscriber': ('service_account', 'account', 'integrator', ),
        ...
        'unregister_subscriber': ('service_account', 'account', 'integrator', ),

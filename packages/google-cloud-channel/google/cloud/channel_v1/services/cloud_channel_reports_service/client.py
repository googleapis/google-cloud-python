...
class CloudChannelReportsServiceClient(metaclass=CloudChannelReportsServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                CloudChannelReportsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = CloudChannelReportsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CloudChannelReportsServiceClient._get_api_endpoint(

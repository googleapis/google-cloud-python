...
class CloudChannelReportsServiceGrpcTransport(CloudChannelReportsServiceTransport):
    ...
    @property
    def run_report_job(self) -> Callable[[reports_service.RunReportJobRequest], operations_pb2.Operation]:
    ...
    @property
    def fetch_report_results(self) -> Callable[[reports_service.FetchReportResultsRequest], reports_service.FetchReportResultsResponse]:
    ...
    @property
    def list_reports(self) -> Callable[[reports_service.ListReportsRequest], reports_service.ListReportsResponse]:
...
__all__ = ("CloudChannelReportsServiceGrpcTransport",)

...
from .base import DEFAULT_CLIENT_INFO, CloudChannelReportsServiceTransport
...
class CloudChannelReportsServiceGrpcAsyncIOTransport(CloudChannelReportsServiceTransport):
    ...
    @property
    def run_report_job(self) -> Callable[[reports_service.RunReportJobRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "run_report_job" not in self._stubs:
            self._stubs["run_report_job"] = self._logged_channel.unary_unary(
    ...
    @property
    def fetch_report_results(self) -> Callable[[reports_service.FetchReportResultsRequest], Awaitable[reports_service.FetchReportResultsResponse]]:
        ...
        if "fetch_report_results" not in self._stubs:
            self._stubs["fetch_report_results"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_reports(self) -> Callable[[reports_service.ListReportsRequest], Awaitable[reports_service.ListReportsResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.run_report_job: self._wrap_method(
                self.run_report_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.fetch_report_results: self._wrap_method(
...
__all__ = ("CloudChannelReportsServiceGrpcAsyncIOTransport",)

...
class CloudChannelServiceClient(metaclass=CloudChannelServiceClientMeta):
    ...
    def billing_account_path(
        ...
        return "accounts/{account}/billingAccounts/{billing_account}".format(
            account=account,
    ...
    def parse_billing_account_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^accounts/(?P<account>.+?)/billingAccounts/(?P<billing_account>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_channel_partner_link_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^accounts/(?P<account>.+?)/channelPartnerLinks/(?P<channel_partner_link>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_customer_repricing_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^accounts/(?P<account>.+?)/customers/(?P<customer>.+?)/customerRepricingConfigs/(?P<customer_repricing_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudChannelServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CloudChannelServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CloudChannelServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CloudChannelServiceTransport, Callable[..., CloudChannelServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CloudChannelServiceClient._read_environment_variables()
        self._client_cert_source = CloudChannelServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CloudChannelServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CloudChannelServiceTransport)
        ...
        self._api_endpoint = self._api_endpoint or CloudChannelServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CloudChannelServiceTransport], Callable[..., CloudChannelServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.channel_v1.CloudChannelServiceClient`.",
                    extra={
    ...
    def get_customer_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_customer_repricing_config]
    ...
    def list_customer_repricing_configs(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_customer_repricing_configs]
    ...
    def create_customer_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_customer_repricing_config]
    ...
    def update_customer_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_customer_repricing_config]
    ...
    def delete_customer_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_customer_repricing_config]
    ...
    def get_channel_partner_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_channel_partner_repricing_config]
    ...
    def list_channel_partner_repricing_configs(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_channel_partner_repricing_configs]
    ...
    def create_channel_partner_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_channel_partner_repricing_config]
    ...
    def update_channel_partner_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_channel_partner_repricing_config]
    ...
    def delete_channel_partner_repricing_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_channel_partner_repricing_config]
    ...
    def list_sku_group_billable_skus(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_sku_group_billable_skus]
    ...
    def query_eligible_billing_accounts(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.query_eligible_billing_accounts]

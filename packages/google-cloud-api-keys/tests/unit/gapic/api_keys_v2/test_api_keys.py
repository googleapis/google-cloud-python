...
def test__get_default_mtls_endpoint():
    ...
    assert ApiKeysClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__get_client_cert_source():
    ...
    assert (
        ApiKeysClient._get_client_cert_source(mock_provided_cert_source, False) is None
    )
    assert (
        ApiKeysClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ApiKeysClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ApiKeysClient),
)
@mock.patch.object(
    ApiKeysAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ApiKeysAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ApiKeysClient._DEFAULT_UNIVERSE
    default_endpoint = ApiKeysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ApiKeysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        ApiKeysClient._get_api_endpoint(
    ...
    assert (
        ...
        == ApiKeysClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ApiKeysClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ApiKeysClient._get_api_endpoint(None, None, default_universe, "always")
        == ApiKeysClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ApiKeysClient._get_api_endpoint(
    ...
    assert (
        ApiKeysClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ApiKeysClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ApiKeysClient._get_universe_domain(client_universe_domain, universe_domain_env)
        == client_universe_domain
    )
    assert (
        ApiKeysClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ApiKeysClient._get_universe_domain(None, None)
        == ApiKeysClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_get_key_string_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_key_string
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_undelete_key_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.undelete_key
            in client._client._transport._wrapped_methods
        )
...
async def test_lookup_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.lookup_key
            in client._client._transport._wrapped_methods
        )
...
def test_transport_kind_grpc_asyncio():
    transport = ApiKeysAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ApiKeysClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )

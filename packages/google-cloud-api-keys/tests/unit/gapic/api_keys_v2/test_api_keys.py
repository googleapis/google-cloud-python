...
from google.cloud.api_keys_v2.services.api_keys import ApiKeysAsyncClient, ApiKeysClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert ApiKeysClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ApiKeysClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ApiKeysClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert ApiKeysClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert ApiKeysClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ApiKeysClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert ApiKeysClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ApiKeysClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ApiKeysClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ApiKeysClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ApiKeysClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ApiKeysClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ApiKeysClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ApiKeysClient._get_client_cert_source(None, False) is None
    assert ApiKeysClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ApiKeysClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ApiKeysClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ApiKeysClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ApiKeysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiKeysClient))
@mock.patch.object(ApiKeysAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiKeysAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ApiKeysClient._DEFAULT_UNIVERSE
    default_endpoint = ApiKeysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ApiKeysClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ApiKeysClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ApiKeysClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ApiKeysClient.DEFAULT_MTLS_ENDPOINT
    assert ApiKeysClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ApiKeysClient._get_api_endpoint(None, None, default_universe, "always") == ApiKeysClient.DEFAULT_MTLS_ENDPOINT
    assert ApiKeysClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ApiKeysClient.DEFAULT_MTLS_ENDPOINT
    assert ApiKeysClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ApiKeysClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ApiKeysClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ApiKeysClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ApiKeysClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ApiKeysClient._get_universe_domain(None, None) == ApiKeysClient._DEFAULT_UNIVERSE
...
def test_api_keys_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "apikeys.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://apikeys.googleapis.com"
        )
...
def test_api_keys_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ApiKeysAsyncClient, transports.ApiKeysGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (ApiKeysClient, transports.ApiKeysGrpcTransport, "grpc", "false"),
        (ApiKeysAsyncClient, transports.ApiKeysGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_api_keys_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(ApiKeysClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApiKeysClient))
@mock.patch.object(ApiKeysAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApiKeysAsyncClient))
...
@mock.patch.object(ApiKeysClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiKeysClient))
@mock.patch.object(ApiKeysAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApiKeysAsyncClient))
def test_api_keys_client_client_api_endpoint(client_class):
...
def test_api_keys_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ApiKeysAsyncClient, transports.ApiKeysGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ApiKeysClient, transports.ApiKeysRestTransport, "rest", None),
    ],
)
def test_api_keys_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_api_keys_client_client_options_from_dict():
    with mock.patch("google.cloud.api_keys_v2.services.api_keys.transports.ApiKeysGrpcTransport.__init__") as grpc_transport:
...
def test_api_keys_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_key_async(transport: str = "grpc_asyncio", request_type=apikeys.CreateKeyRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_keys_async(transport: str = "grpc_asyncio", request_type=apikeys.ListKeysRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_keys_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_keys), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(apikeys.ListKeysResponse())
        await client.list_keys(request)
...
async def test_list_keys_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_keys), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_keys(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_key_async(transport: str = "grpc_asyncio", request_type=apikeys.GetKeyRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_key_string_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_key_string in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_key_string] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_key_string_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiKeysAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_key_string in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_key_string] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_key_string_async(transport: str = "grpc_asyncio", request_type=apikeys.GetKeyStringRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_key_string_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_key_string), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(apikeys.GetKeyStringResponse())
        await client.get_key_string(request)
...
@pytest.mark.asyncio
async def test_update_key_async(transport: str = "grpc_asyncio", request_type=apikeys.UpdateKeyRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_key_async(transport: str = "grpc_asyncio", request_type=apikeys.DeleteKeyRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_undelete_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.undelete_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.undelete_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_undelete_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiKeysAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undelete_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_key] = mock_rpc
...
@pytest.mark.asyncio
async def test_undelete_key_async(transport: str = "grpc_asyncio", request_type=apikeys.UndeleteKeyRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_lookup_key_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.lookup_key in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.lookup_key] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_lookup_key_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApiKeysAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.lookup_key in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.lookup_key] = mock_rpc

        request = {}
        await client.lookup_key(request)
...
@pytest.mark.asyncio
async def test_lookup_key_async(transport: str = "grpc_asyncio", request_type=apikeys.LookupKeyRequest):
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_key_rest_required_fields(request_type=apikeys.CreateKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_key._get_unset_required_fields(jsonified_request)
...
def test_create_key_rest_unset_required_fields():
    transport = transports.ApiKeysRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/keys" % client.transport._host, args[1])
...
def test_list_keys_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_list_keys_rest_required_fields(request_type=apikeys.ListKeysRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_keys._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = apikeys.ListKeysResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_get_key_rest_required_fields(request_type=apikeys.GetKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = resources.Key.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/keys/*}" % client.transport._host, args[1])
...
def test_get_key_string_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_get_key_string_rest_required_fields(request_type=apikeys.GetKeyStringRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_key_string._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = apikeys.GetKeyStringResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_key_string_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/keys/*}/keyString" % client.transport._host, args[1])
...
def test_update_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_update_key_rest_required_fields(request_type=apikeys.UpdateKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"key": {"name": "projects/sample1/locations/sample2/keys/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{key.name=projects/*/locations/*/keys/*}" % client.transport._host, args[1])
...
def test_delete_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_delete_key_rest_required_fields(request_type=apikeys.DeleteKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_undelete_key_rest_required_fields(request_type=apikeys.UndeleteKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).undelete_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lookup_key_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApiKeysClient(
...
def test_lookup_key_rest_required_fields(request_type=apikeys.LookupKeyRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).lookup_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = apikeys.LookupKeyResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ApiKeysClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ApiKeysClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_key_string_empty_call_grpc():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_key_string), "__call__") as call:
        call.return_value = apikeys.GetKeyStringResponse()
        client.get_key_string(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undelete_key_empty_call_grpc():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.undelete_key), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.undelete_key(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lookup_key_empty_call_grpc():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.lookup_key), "__call__") as call:
        call.return_value = apikeys.LookupKeyResponse()
        client.lookup_key(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = ApiKeysAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ApiKeysAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_key_string_empty_call_grpc_asyncio():
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_key_string), "__call__") as call:
        ...
        await client.get_key_string(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undelete_key_empty_call_grpc_asyncio():
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.undelete_key), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.undelete_key(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_lookup_key_empty_call_grpc_asyncio():
    client = ApiKeysAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.lookup_key), "__call__") as call:
        ...
        await client.lookup_key(request=None)
...
def test_transport_kind_rest():
    transport = ApiKeysClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_key_rest_bad_request(request_type=apikeys.CreateKeyRequest):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_key_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["key"] = {
        ...
        "annotations": {},
        "restrictions": {
            "browser_key_restrictions": {"allowed_referrers": ["allowed_referrers_value1", "allowed_referrers_value2"]},
            "server_key_restrictions": {"allowed_ips": ["allowed_ips_value1", "allowed_ips_value2"]},
            "android_key_restrictions": {
                "allowed_applications": [{"sha1_fingerprint": "sha1_fingerprint_value", "package_name": "package_name_value"}]
            },
            "ios_key_restrictions": {"allowed_bundle_ids": ["allowed_bundle_ids_value1", "allowed_bundle_ids_value2"]},
            "api_targets": [{"service": "service_value", "methods": ["methods_value1", "methods_value2"]}],
        },
        "etag": "etag_value",
    }
    ...
    test_field = apikeys.CreateKeyRequest.meta.fields["key"]
    ...
    for field, value in request_init["key"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["key"][field])):
                    del request_init["key"][field][i][subfield]
            else:
                del request_init["key"][field][subfield]
    request = request_type(**request_init)
...
def test_list_keys_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiKeysRestInterceptor, "post_list_keys") as post, mock.patch.object(
...
def test_get_key_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiKeysRestInterceptor, "post_get_key") as post, mock.patch.object(
...
def test_get_key_string_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_key_string_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiKeysRestInterceptor, "post_get_key_string") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = apikeys.GetKeyStringResponse.to_json(apikeys.GetKeyStringResponse())
        req.return_value.content = return_value
...
def test_update_key_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = apikeys.UpdateKeyRequest.meta.fields["key"]
...
def test_delete_key_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_undelete_key_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_lookup_key_rest_call_success(request_type):
    client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_lookup_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApiKeysRestInterceptor, "post_lookup_key") as post, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_key_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_keys_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_key_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_key_string_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_key_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_key_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undelete_key_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_lookup_key_empty_call_rest():
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_api_keys_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ApiKeysTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_api_keys_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.api_keys_v2.services.api_keys.transports.ApiKeysTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.ApiKeysGrpcTransport, grpc_helpers), (transports.ApiKeysGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.ApiKeysGrpcTransport, transports.ApiKeysGrpcAsyncIOTransport])
...
def test_api_keys_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ApiKeysRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_api_keys_host_no_port(transport_name):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="apikeys.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "apikeys.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://apikeys.googleapis.com"
...
def test_api_keys_host_with_port(transport_name):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="apikeys.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "apikeys.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://apikeys.googleapis.com:8000"
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ApiKeysTransport, "_prep_wrapped_messages") as prep:
        client = ApiKeysClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ApiKeysClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

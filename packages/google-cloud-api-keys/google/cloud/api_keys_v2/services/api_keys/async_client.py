...
class ApiKeysAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ApiKeysClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ApiKeysAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ApiKeysClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ApiKeysAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_key():
                ...
                # Make the request
                operation = await client.create_key(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_key():
                ...
                # Make the request
                operation = await client.delete_key(request=request)

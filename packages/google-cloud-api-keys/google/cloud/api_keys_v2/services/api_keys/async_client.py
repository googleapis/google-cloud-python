...
class ApiKeysAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ApiKeysClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    common_billing_account_path = staticmethod(ApiKeysClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ApiKeysClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(ApiKeysClient.parse_common_organization_path)
    ...
    get_transport_class = ApiKeysClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, ApiKeysTransport, Callable[..., ApiKeysTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.api.apikeys_v2.ApiKeysAsyncClient`.",
                extra={
    ...
    async def get_key_string(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_key_string]
    ...
    async def undelete_key(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.undelete_key]
    ...
    async def lookup_key(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.lookup_key]

...
from .base import DEFAULT_CLIENT_INFO, ApiKeysTransport
...
class ApiKeysGrpcAsyncIOTransport(ApiKeysTransport):
    ...
    @property
    def get_key(self) -> Callable[[apikeys.GetKeyRequest], Awaitable[resources.Key]]:
...
__all__ = ("ApiKeysGrpcAsyncIOTransport",)

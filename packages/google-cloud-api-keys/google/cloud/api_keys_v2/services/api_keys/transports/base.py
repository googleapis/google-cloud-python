...
class ApiKeysTransport(abc.ABC):
    """Abstract transport class for ApiKeys."""
    ...
    DEFAULT_HOST: str = "apikeys.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_key_string: gapic_v1.method.wrap_method(
                self.get_key_string,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.undelete_key: gapic_v1.method.wrap_method(
                self.undelete_key,
                default_timeout=None,
                client_info=client_info,
            ),
            self.lookup_key: gapic_v1.method.wrap_method(
                self.lookup_key,
                default_timeout=None,
                client_info=client_info,
            ),

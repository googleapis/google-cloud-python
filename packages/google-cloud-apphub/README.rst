...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-apphub.svg
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-apphub.svg
   :target: https://pypi.org/project/google-cloud-apphub/
.. _App Hub: https://cloud.google.com/app-hub/
...
3. `Enable the App Hub.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the App Hub.:  https://cloud.google.com/app-hub/
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-apphub/samples
...
-  Read the `Client Library Documentation`_ for App Hub
   to see other available methods on the client.
-  Read the `App Hub Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _App Hub Product documentation:  https://cloud.google.com/app-hub/

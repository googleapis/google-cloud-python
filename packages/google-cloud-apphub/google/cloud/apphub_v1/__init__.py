...
from .types.service import DiscoveredService, Service, ServiceProperties, ServiceReference
from .types.service_project_attachment import ServiceProjectAttachment
from .types.workload import DiscoveredWorkload, Workload, WorkloadProperties, WorkloadReference

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.apphub_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.apphub_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.apphub_v1"

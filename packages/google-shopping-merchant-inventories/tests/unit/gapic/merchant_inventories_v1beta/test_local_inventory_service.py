...
def test_list_local_inventories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = localinventory.ListLocalInventoriesResponse.to_json(
            localinventory.ListLocalInventoriesResponse()
        )
...
def test_list_local_inventories_rest_bad_request(
    transport: str = "rest", request_type=localinventory.ListLocalInventoriesRequest
):
    client = LocalInventoryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_insert_local_inventory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = localinventory.LocalInventory.to_json(
            localinventory.LocalInventory()
        )
...
def test_insert_local_inventory_rest_bad_request(
    transport: str = "rest", request_type=localinventory.InsertLocalInventoryRequest
):
    client = LocalInventoryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_local_inventory_rest_bad_request(
    transport: str = "rest", request_type=localinventory.DeleteLocalInventoryRequest
):
    client = LocalInventoryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

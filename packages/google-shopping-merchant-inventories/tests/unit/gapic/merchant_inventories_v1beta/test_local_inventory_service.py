...
def test__get_default_mtls_endpoint():
    ...
    assert (
        LocalInventoryServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        LocalInventoryServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        LocalInventoryServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        LocalInventoryServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        LocalInventoryServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )


def test__read_environment_variables():
    assert LocalInventoryServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert LocalInventoryServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert LocalInventoryServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                LocalInventoryServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        LocalInventoryServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                LocalInventoryServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(LocalInventoryServiceClient),
)
@mock.patch.object(
    LocalInventoryServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(LocalInventoryServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LocalInventoryServiceClient._DEFAULT_UNIVERSE
    default_endpoint = LocalInventoryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = LocalInventoryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == LocalInventoryServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LocalInventoryServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        LocalInventoryServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        LocalInventoryServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        LocalInventoryServiceClient._get_universe_domain(None, None)
        == LocalInventoryServiceClient._DEFAULT_UNIVERSE
    )
...
def test_local_inventory_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_local_inventory_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_local_inventory_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_local_inventory_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_local_inventory_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [LocalInventoryServiceClient, LocalInventoryServiceAsyncClient]
)
@mock.patch.object(
    LocalInventoryServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(LocalInventoryServiceClient),
)
@mock.patch.object(
    LocalInventoryServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(LocalInventoryServiceAsyncClient),
)
...
def test_local_inventory_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_local_inventory_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_local_inventory_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_inventories_v1beta.services.local_inventory_service.transports.LocalInventoryServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_local_inventory_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_local_inventories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_local_inventories] = (
            mock_rpc
        )
        request = {}
...
async def test_list_local_inventories_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_local_inventories(
            request={},
        )
...
def test_insert_local_inventory_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.insert_local_inventory] = (
            mock_rpc
        )
        request = {}
...
def test_delete_local_inventory_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_local_inventory] = (
            mock_rpc
        )
        request = {}
...
def test_list_local_inventories_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_local_inventories._get_unset_required_fields(jsonified_request)
...
def test_list_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/inventories/v1beta/{parent=accounts/*/products/*}/localInventories"
...
def test_list_local_inventories_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            localinventory.ListLocalInventoriesResponse.to_json(x) for x in response
        )
...
def test_insert_local_inventory_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).insert_local_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_local_inventory_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_local_inventory._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_local_inventory_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "accounts/sample1/products/sample2/localInventories/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/inventories/v1beta/{name=accounts/*/products/*/localInventories/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_local_inventories_rest_bad_request(
    request_type=localinventory.ListLocalInventoriesRequest,
):
    client = LocalInventoryServiceClient(
...
def test_list_local_inventories_rest_interceptors(null_interceptor):
    transport = transports.LocalInventoryServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.LocalInventoryServiceRestInterceptor(),
    )
    client = LocalInventoryServiceClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.LocalInventoryServiceRestInterceptor, "post_list_local_inventories"
    ) as post, mock.patch.object(
        transports.LocalInventoryServiceRestInterceptor,
        "post_list_local_inventories_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.LocalInventoryServiceRestInterceptor, "pre_list_local_inventories"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = localinventory.ListLocalInventoriesRequest.pb(
            localinventory.ListLocalInventoriesRequest()
        )
...
def test_insert_local_inventory_rest_bad_request(
    request_type=localinventory.InsertLocalInventoryRequest,
):
    client = LocalInventoryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_insert_local_inventory_rest_call_success(request_type):
    ...
    test_field = localinventory.InsertLocalInventoryRequest.meta.fields[
        "local_inventory"
    ]
...
def test_insert_local_inventory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.LocalInventoryServiceRestInterceptor, "post_insert_local_inventory"
    ) as post, mock.patch.object(
        transports.LocalInventoryServiceRestInterceptor,
        "post_insert_local_inventory_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.LocalInventoryServiceRestInterceptor, "pre_insert_local_inventory"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = localinventory.InsertLocalInventoryRequest.pb(
            localinventory.InsertLocalInventoryRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_local_inventory_rest_bad_request(
    request_type=localinventory.DeleteLocalInventoryRequest,
):
    client = LocalInventoryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_delete_local_inventory_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.LocalInventoryServiceRestInterceptor, "pre_delete_local_inventory"
    ) as pre:
        pre.assert_not_called()
        pb_message = localinventory.DeleteLocalInventoryRequest.pb(
            localinventory.DeleteLocalInventoryRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_local_inventory_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_inventories_v1beta.services.local_inventory_service.transports.LocalInventoryServiceTransport.__init__"
    ) as Transport:
...
def test_local_inventory_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.shopping.merchant_inventories_v1beta.services.local_inventory_service.transports.LocalInventoryServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_local_inventory_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_local_inventory_path():
    ...
    store_code = "whelk"
    expected = (
        "accounts/{account}/products/{product}/localInventories/{store_code}".format(
            account=account,
            product=product,
            store_code=store_code,
        )
    )
    actual = LocalInventoryServiceClient.local_inventory_path(
        account, product, store_code
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.LocalInventoryServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = LocalInventoryServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

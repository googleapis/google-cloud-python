...
def test_local_inventory_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_inventories_v1.services.local_inventory_service.transports.LocalInventoryServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/inventories/v1/{parent=accounts/*/products/*}/localInventories"
...
def test_delete_local_inventory_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/inventories/v1/{name=accounts/*/products/*/localInventories/*}"
            % client.transport._host,
            args[1],
        )
...
def test_local_inventory_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_inventories_v1.services.local_inventory_service.transports.LocalInventoryServiceTransport.__init__"
    ) as Transport:
...
def test_local_inventory_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.shopping.merchant_inventories_v1.services.local_inventory_service.transports.LocalInventoryServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

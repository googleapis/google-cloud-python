Python Client for Shopping Merchant Inventories
===============================================

|stable| |pypi| |versions|

`Shopping Merchant Inventories`_: Programmatically manage your Merchant Center Accounts.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-shopping-merchant-inventories.svg
   :target: https://pypi.org/project/google-shopping-merchant-inventories/
.. _Shopping Merchant Inventories: https://developers.google.com/merchant/api
...
3. `Enable the Shopping Merchant Inventories.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Shopping Merchant Inventories.:  https://developers.google.com/merchant/api
...
-  Read the `Client Library Documentation`_ for Shopping Merchant Inventories
   to see other available methods on the client.
-  Read the `Shopping Merchant Inventories Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Shopping Merchant Inventories Product documentation:  https://developers.google.com/merchant/api

    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[LocalInventoryServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.inventories_v1.LocalInventoryServiceClient.DeleteLocalInventory",
                    extra={
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.inventories_v1.LocalInventoryServiceClient.InsertLocalInventory",
                    extra={
                        "serviceName": "google.shopping.merchant.inventories.v1.LocalInventoryService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.inventories_v1.LocalInventoryServiceClient.insert_local_inventory",
                    extra={
                        "serviceName": "google.shopping.merchant.inventories.v1.LocalInventoryService",
                        "rpcName": "InsertLocalInventory",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.inventories_v1.LocalInventoryServiceClient.ListLocalInventories",
                    extra={
                        "serviceName": "google.shopping.merchant.inventories.v1.LocalInventoryService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.inventories_v1.LocalInventoryServiceClient.list_local_inventories",
                    extra={
                        "serviceName": "google.shopping.merchant.inventories.v1.LocalInventoryService",
                        "rpcName": "ListLocalInventories",
                        "metadata": http_response["headers"],

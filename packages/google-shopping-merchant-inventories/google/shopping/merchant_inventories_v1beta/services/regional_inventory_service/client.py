...
class RegionalInventoryServiceClient(metaclass=RegionalInventoryServiceClientMeta):
    ...
    def parse_regional_inventory_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/products/(?P<product>.+?)/regionalInventories/(?P<region>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionalInventoryServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RegionalInventoryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionalInventoryServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.inventories_v1beta.RegionalInventoryServiceClient`.",
                    extra={
    ...
    def list_regional_inventories(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_inventories_v1beta.types.ListRegionalInventoriesRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_inventories_v1beta.services.regional_inventory_service.pagers.ListRegionalInventoriesPager:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_regional_inventories
        ]
    ...
    def insert_regional_inventory(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_inventories_v1beta.types.InsertRegionalInventoryRequest, dict]):
    ...
    def delete_regional_inventory(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_inventories_v1beta.types.DeleteRegionalInventoryRequest, dict]):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_regional_inventory
        ]

...
class RegionalInventoryServiceClient(metaclass=RegionalInventoryServiceClientMeta):
    ...
    def regional_inventory_path(
        ...
        return "accounts/{account}/products/{product}/regionalInventories/{region}".format(
            account=account,
            product=product,
            region=region,
        )
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionalInventoryServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or RegionalInventoryServiceClient._get_api_endpoint(

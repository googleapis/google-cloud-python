...
class _BaseLocalInventoryServiceRestTransport(LocalInventoryServiceTransport):
    ...
    class _BaseDeleteLocalInventory:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseLocalInventoryServiceRestTransport._BaseDeleteLocalInventory._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseInsertLocalInventory:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseLocalInventoryServiceRestTransport._BaseInsertLocalInventory._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListLocalInventories:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseLocalInventoryServiceRestTransport._BaseListLocalInventories._get_unset_required_fields(
                    query_params
                )
            )

...
class _BaseLocalInventoryServiceRestTransport(LocalInventoryServiceTransport):
    """Base REST backend transport for LocalInventoryService.
    ...
    class _BaseDeleteLocalInventory:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseLocalInventoryServiceRestTransport._BaseDeleteLocalInventory._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseInsertLocalInventory:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseLocalInventoryServiceRestTransport._BaseInsertLocalInventory._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseListLocalInventories:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseLocalInventoryServiceRestTransport._BaseListLocalInventories._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params


__all__ = ("_BaseLocalInventoryServiceRestTransport",)

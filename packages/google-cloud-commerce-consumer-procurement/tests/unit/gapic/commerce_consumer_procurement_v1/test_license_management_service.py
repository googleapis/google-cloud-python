...
def test__get_default_mtls_endpoint():
    ...
    assert LicenseManagementServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert LicenseManagementServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert LicenseManagementServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert LicenseManagementServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert LicenseManagementServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert LicenseManagementServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert LicenseManagementServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert LicenseManagementServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert LicenseManagementServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert LicenseManagementServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert LicenseManagementServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert LicenseManagementServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                LicenseManagementServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert LicenseManagementServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert LicenseManagementServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert LicenseManagementServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert LicenseManagementServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(LicenseManagementServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseManagementServiceClient))
@mock.patch.object(
    LicenseManagementServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseManagementServiceAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = LicenseManagementServiceClient._DEFAULT_UNIVERSE
    default_endpoint = LicenseManagementServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = LicenseManagementServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert LicenseManagementServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        LicenseManagementServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == LicenseManagementServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LicenseManagementServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        LicenseManagementServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == LicenseManagementServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        LicenseManagementServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == LicenseManagementServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert LicenseManagementServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert LicenseManagementServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        LicenseManagementServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert LicenseManagementServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert LicenseManagementServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert LicenseManagementServiceClient._get_universe_domain(None, None) == LicenseManagementServiceClient._DEFAULT_UNIVERSE
...
def test_license_management_service_client_from_service_account_info(client_class, transport_name):
...
def test_license_management_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_license_management_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (LicenseManagementServiceClient, transports.LicenseManagementServiceGrpcTransport, "grpc"),
        (LicenseManagementServiceAsyncClient, transports.LicenseManagementServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (LicenseManagementServiceClient, transports.LicenseManagementServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(LicenseManagementServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseManagementServiceClient))
@mock.patch.object(
...
def test_license_management_service_client_client_options(client_class, transport_class, transport_name):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(LicenseManagementServiceClient, "get_transport_class") as gtc:
...
@pytest.mark.parametrize(
    ...
    [
        (LicenseManagementServiceClient, transports.LicenseManagementServiceGrpcTransport, "grpc", "true"),
        (LicenseManagementServiceAsyncClient, transports.LicenseManagementServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (LicenseManagementServiceClient, transports.LicenseManagementServiceGrpcTransport, "grpc", "false"),
        (LicenseManagementServiceAsyncClient, transports.LicenseManagementServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (LicenseManagementServiceClient, transports.LicenseManagementServiceRestTransport, "rest", "true"),
        (LicenseManagementServiceClient, transports.LicenseManagementServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(LicenseManagementServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(LicenseManagementServiceClient))
@mock.patch.object(
...
def test_license_management_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [LicenseManagementServiceClient, LicenseManagementServiceAsyncClient])
@mock.patch.object(LicenseManagementServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LicenseManagementServiceClient))
@mock.patch.object(LicenseManagementServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(LicenseManagementServiceAsyncClient))
def test_license_management_service_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_license_management_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (LicenseManagementServiceClient, transports.LicenseManagementServiceGrpcTransport, "grpc", grpc_helpers),
        (LicenseManagementServiceAsyncClient, transports.LicenseManagementServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (LicenseManagementServiceClient, transports.LicenseManagementServiceRestTransport, "rest", None),
    ],
)
def test_license_management_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_license_management_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = LicenseManagementServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_license_management_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_license_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_license_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_license_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_license_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_license_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_license_pool_async(transport: str = "grpc_asyncio", request_type=license_management_service.GetLicensePoolRequest):
    client = LicenseManagementServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_license_pool_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_license_pool), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(license_management_service.LicensePool())
        await client.get_license_pool(request)
...
def test_update_license_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_license_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_license_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_license_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LicenseManagementServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_license_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_license_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_license_pool_async(transport: str = "grpc_asyncio", request_type=license_management_service.UpdateLicensePoolRequest):
    client = LicenseManagementServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_assign_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.assign in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.assign] = mock_rpc
...
@pytest.mark.asyncio
async def test_assign_async(transport: str = "grpc_asyncio", request_type=license_management_service.AssignRequest):
    client = LicenseManagementServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.assign), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(license_management_service.AssignResponse())
...
async def test_unassign_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.unassign in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.unassign] = mock_rpc
...
@pytest.mark.asyncio
async def test_unassign_async(transport: str = "grpc_asyncio", request_type=license_management_service.UnassignRequest):
    client = LicenseManagementServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.unassign), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(license_management_service.UnassignResponse())
...
def test_enumerate_licensed_users(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.enumerate_licensed_users), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_enumerate_licensed_users_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.enumerate_licensed_users in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.enumerate_licensed_users] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_enumerate_licensed_users_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = LicenseManagementServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.enumerate_licensed_users in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.enumerate_licensed_users] = mock_rpc
...
@pytest.mark.asyncio
async def test_enumerate_licensed_users_async(transport: str = "grpc_asyncio", request_type=license_management_service.EnumerateLicensedUsersRequest):
    client = LicenseManagementServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_enumerate_licensed_users_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.enumerate_licensed_users), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(license_management_service.EnumerateLicensedUsersResponse())
        await client.enumerate_licensed_users(request)
...
def test_enumerate_licensed_users_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.enumerate_licensed_users), "__call__") as call:
        ...
        pager = client.enumerate_licensed_users(request={}, retry=retry, timeout=timeout)
        ...
        assert all(isinstance(i, license_management_service.LicensedUser) for i in results)
...
async def test_enumerate_licensed_users_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.enumerate_licensed_users), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            license_management_service.EnumerateLicensedUsersResponse(
                licensed_users=[
        ...
        assert all(isinstance(i, license_management_service.LicensedUser) for i in responses)
...
async def test_enumerate_licensed_users_async_pages():
    ...
    with mock.patch.object(type(client.transport.enumerate_licensed_users), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.enumerate_licensed_users(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_license_pool_rest_required_fields(request_type=license_management_service.GetLicensePoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_license_pool._get_unset_required_fields(jsonified_request)
...
def test_get_license_pool_rest_unset_required_fields():
    transport = transports.LicenseManagementServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_license_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{name=billingAccounts/*/orders/*/licensePool}" % client.transport._host, args[1])
...
def test_update_license_pool_rest_required_fields(request_type=license_management_service.UpdateLicensePoolRequest):
    transport_class = transports.LicenseManagementServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_license_pool._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_license_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"license_pool": {"name": "billingAccounts/sample1/orders/sample2/licensePool"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{license_pool.name=billingAccounts/*/orders/*/licensePool}" % client.transport._host, args[1])
...
def test_assign_rest_required_fields(request_type=license_management_service.AssignRequest):
    transport_class = transports.LicenseManagementServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).assign._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_assign_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "billingAccounts/sample1/orders/sample2/licensePool"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=billingAccounts/*/orders/*/licensePool}:assign" % client.transport._host, args[1])
...
def test_unassign_rest_required_fields(request_type=license_management_service.UnassignRequest):
    transport_class = transports.LicenseManagementServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).unassign._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_unassign_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=billingAccounts/*/orders/*/licensePool}:unassign" % client.transport._host, args[1])
...
def test_enumerate_licensed_users_rest_required_fields(request_type=license_management_service.EnumerateLicensedUsersRequest):
    transport_class = transports.LicenseManagementServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enumerate_licensed_users._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = license_management_service.EnumerateLicensedUsersResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_enumerate_licensed_users_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=billingAccounts/*/orders/*/licensePool}:enumerateLicensedUsers" % client.transport._host, args[1]
        )
...
def test_enumerate_licensed_users_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(license_management_service.EnumerateLicensedUsersResponse.to_json(x) for x in response)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = LicenseManagementServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = LicenseManagementServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = LicenseManagementServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = LicenseManagementServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = LicenseManagementServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = LicenseManagementServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_license_pool_rest_bad_request(request_type=license_management_service.GetLicensePoolRequest):
    client = LicenseManagementServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_license_pool_rest_interceptors(null_interceptor):
    transport = transports.LicenseManagementServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.LicenseManagementServiceRestInterceptor(),
    )
    client = LicenseManagementServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_get_license_pool") as post, mock.patch.object(
        transports.LicenseManagementServiceRestInterceptor, "post_get_license_pool_with_metadata"
        ...
        pb_message = license_management_service.GetLicensePoolRequest.pb(license_management_service.GetLicensePoolRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = license_management_service.LicensePool.to_json(license_management_service.LicensePool())
        ...
        post_with_metadata.return_value = license_management_service.LicensePool(), metadata
...
def test_update_license_pool_rest_bad_request(request_type=license_management_service.UpdateLicensePoolRequest):
    client = LicenseManagementServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"license_pool": {"name": "billingAccounts/sample1/orders/sample2/licensePool"}}
    request = request_type(**request_init)
...
def test_update_license_pool_rest_call_success(request_type):
    ...
    request_init["license_pool"] = {
        ...
        "license_assignment_protocol": {
            ...
            "auto_assignment_type": {"inactive_license_ttl": {"seconds": 751, "nanos": 543}},
        },
        "available_license_count": 2411,
        "total_license_count": 2030,
    }
    ...
    test_field = license_management_service.UpdateLicensePoolRequest.meta.fields["license_pool"]
...
def test_update_license_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_update_license_pool") as post, mock.patch.object(
        transports.LicenseManagementServiceRestInterceptor, "post_update_license_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = license_management_service.UpdateLicensePoolRequest.pb(license_management_service.UpdateLicensePoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_assign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_assign") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = license_management_service.AssignRequest.pb(license_management_service.AssignRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = license_management_service.AssignResponse.to_json(license_management_service.AssignResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = license_management_service.AssignResponse(), metadata
...
def test_unassign_rest_bad_request(request_type=license_management_service.UnassignRequest):
    client = LicenseManagementServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "billingAccounts/sample1/orders/sample2/licensePool"}
    request = request_type(**request_init)
...
def test_unassign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_unassign") as post, mock.patch.object(
        transports.LicenseManagementServiceRestInterceptor, "post_unassign_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = license_management_service.UnassignRequest.pb(license_management_service.UnassignRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = license_management_service.UnassignResponse.to_json(license_management_service.UnassignResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = license_management_service.UnassignResponse(), metadata
...
def test_enumerate_licensed_users_rest_bad_request(request_type=license_management_service.EnumerateLicensedUsersRequest):
    client = LicenseManagementServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "billingAccounts/sample1/orders/sample2/licensePool"}
    request = request_type(**request_init)
...
def test_enumerate_licensed_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.LicenseManagementServiceRestInterceptor, "post_enumerate_licensed_users") as post, mock.patch.object(
        transports.LicenseManagementServiceRestInterceptor, "post_enumerate_licensed_users_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.LicenseManagementServiceRestInterceptor, "pre_enumerate_licensed_users"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = license_management_service.EnumerateLicensedUsersRequest.pb(license_management_service.EnumerateLicensedUsersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = license_management_service.EnumerateLicensedUsersResponse.to_json(license_management_service.EnumerateLicensedUsersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = license_management_service.EnumerateLicensedUsersResponse(), metadata
...
@pytest.mark.parametrize(
    ...
    [(transports.LicenseManagementServiceGrpcTransport, grpc_helpers), (transports.LicenseManagementServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
def test_license_management_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize(
    "transport_class", [transports.LicenseManagementServiceGrpcTransport, transports.LicenseManagementServiceGrpcAsyncIOTransport]
)
def test_license_management_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_license_management_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.LicenseManagementServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_license_management_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.LicenseManagementServiceTransport, "_prep_wrapped_messages") as prep:
        client = LicenseManagementServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = LicenseManagementServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        (LicenseManagementServiceClient, transports.LicenseManagementServiceGrpcTransport),
        (LicenseManagementServiceAsyncClient, transports.LicenseManagementServiceGrpcAsyncIOTransport),
    ],
)

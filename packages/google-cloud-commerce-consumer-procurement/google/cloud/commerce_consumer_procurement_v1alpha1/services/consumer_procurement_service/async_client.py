...
from google.cloud.commerce_consumer_procurement_v1alpha1 import gapic_version as package_version
...
from google.cloud.commerce_consumer_procurement_v1alpha1.services.consumer_procurement_service import pagers
...
class ConsumerProcurementServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ConsumerProcurementServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    common_billing_account_path = staticmethod(ConsumerProcurementServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ConsumerProcurementServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ConsumerProcurementServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ConsumerProcurementServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ConsumerProcurementServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ConsumerProcurementServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ConsumerProcurementServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ConsumerProcurementServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ConsumerProcurementServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ConsumerProcurementServiceClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ConsumerProcurementServiceTransport, Callable[..., ConsumerProcurementServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.commerce.consumer.procurement_v1alpha1.ConsumerProcurementServiceAsyncClient`.",
                extra={
    ...
    async def place_order(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.place_order]
    ...
    async def get_order(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_order]
    ...
    async def list_orders(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_orders]

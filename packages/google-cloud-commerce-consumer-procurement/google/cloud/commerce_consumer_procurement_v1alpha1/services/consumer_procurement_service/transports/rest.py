...
from google.cloud.commerce_consumer_procurement_v1alpha1._compat import (
    transcode_request,
)
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[ConsumerProcurementServiceRestInterceptor]): Interceptor used

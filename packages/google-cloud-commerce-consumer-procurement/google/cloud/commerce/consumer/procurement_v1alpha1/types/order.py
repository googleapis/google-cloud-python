...
class Order(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            order.
        line_items (MutableSequence[google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItem]):
            Output only. The items being purchased.
        cancelled_line_items (MutableSequence[google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItem]):
...
class LineItem(proto.Message):
    ...
    Attributes:
        ...
        line_item_info (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemInfo):
            Output only. Current state and information of
            this item. It tells what, e.g. which offer, is
            currently effective.
        pending_change (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemChange):
            ...
            undergoing a change.
        change_history (MutableSequence[google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemChange]):
...
class LineItemChange(proto.Message):
    ...
    Attributes:
        ...
        change_type (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemChangeType):
            Required. Type of the change to make.
        old_line_item_info (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemInfo):
            Output only. Line item info before the
            change.
        new_line_item_info (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemInfo):
            Line item info after the change.
        change_state (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemChangeState):
        ...
        state_reason (str):
            ...
            ``CANCELED`` states.
        change_state_reason_type (google.cloud.commerce.consumer.procurement_v1alpha1.types.LineItemChangeStateReasonType):
...
class LineItemInfo(proto.Message):
    ...
    Attributes:
        ...
        parameters (MutableSequence[google.cloud.commerce.consumer.procurement_v1alpha1.types.Parameter]):
            Optional. User-provided parameters.
        subscription (google.cloud.commerce.consumer.procurement_v1alpha1.types.Subscription):
...
class Parameter(proto.Message):
    ...
    Attributes:
        ...
        value (google.cloud.commerce.consumer.procurement_v1alpha1.types.Parameter.Value):
            Value of parameter.
    """

...
from google.cloud.commerce.consumer.procurement_v1alpha1 import (
...
from google.cloud.commerce.consumer.procurement_v1alpha1.services.consumer_procurement_service import (
    pagers,
)
from google.cloud.commerce.consumer.procurement_v1alpha1.types import (
    order,
    procurement_service,
)
...
class ConsumerProcurementServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ConsumerProcurementServiceTransport]]
...
class ConsumerProcurementServiceClient(metaclass=ConsumerProcurementServiceClientMeta):
    ...
    def offer_path(
        ...
        return "services/{service}/standardOffers/{offer}".format(
            service=service,
            offer=offer,
        )
    ...
    def order_path(
        ...
        return "billingAccounts/{billing_account}/orders/{order}".format(
    ...
    def parse_order_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^billingAccounts/(?P<billing_account>.+?)/orders/(?P<order>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def place_order(
        ...
        *,
        ...
        .. code-block:: python
            ...
            from google.cloud.commerce.consumer import procurement_v1alpha1

            def sample_place_order():
                # Create a client
                client = procurement_v1alpha1.ConsumerProcurementServiceClient()

                # Initialize request argument(s)
                request = procurement_v1alpha1.PlaceOrderRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[google.cloud.commerce.consumer.procurement_v1alpha1.types.PlaceOrderRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.commerce.consumer.procurement_v1alpha1.types.Order` Represents a purchase made by a customer on Cloud Marketplace.
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_order():
                ...
                # Initialize request argument(s)
                request = procurement_v1alpha1.GetOrderRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.commerce.consumer.procurement_v1alpha1.types.GetOrderRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.commerce.consumer.procurement_v1alpha1.types.Order:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_orders():
                ...
                # Initialize request argument(s)
                request = procurement_v1alpha1.ListOrdersRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.commerce.consumer.procurement_v1alpha1.types.ListOrdersRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.commerce.consumer.procurement_v1alpha1.services.consumer_procurement_service.pagers.ListOrdersPager:

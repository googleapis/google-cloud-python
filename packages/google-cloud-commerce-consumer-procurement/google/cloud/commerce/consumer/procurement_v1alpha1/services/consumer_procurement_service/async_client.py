...
class ConsumerProcurementServiceAsyncClient:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_place_order():
                # Create a client
                client = procurement_v1alpha1.ConsumerProcurementServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.commerce.consumer.procurement_v1alpha1.types.PlaceOrderRequest, dict]]):
    ...
    async def get_order(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.commerce.consumer.procurement_v1alpha1.types.GetOrderRequest, dict]]):
                The request object. Request message for
    ...
    async def list_orders(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.commerce.consumer.procurement_v1alpha1.types.ListOrdersRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.commerce.consumer.procurement_v1alpha1.services.consumer_procurement_service.pagers.ListOrdersAsyncPager:

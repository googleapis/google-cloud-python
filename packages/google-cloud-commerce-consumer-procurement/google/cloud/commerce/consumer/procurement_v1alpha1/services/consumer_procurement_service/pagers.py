...
class ListOrdersPager:
    ...
    :class:`google.cloud.commerce.consumer.procurement_v1alpha1.types.ListOrdersResponse` object, and
    ...
    All the usual :class:`google.cloud.commerce.consumer.procurement_v1alpha1.types.ListOrdersResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.commerce.consumer.procurement_v1alpha1.types.ListOrdersRequest):
                The initial request object.
            response (google.cloud.commerce.consumer.procurement_v1alpha1.types.ListOrdersResponse):

...
from google.cloud.commerce.consumer.procurement_v1.types import order
...
class PlaceOrderRequest(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            order being placed.
        line_item_info (MutableSequence[google.cloud.commerce.consumer.procurement_v1.types.LineItemInfo]):
...
class ListOrdersResponse(proto.Message):
    ...
    Attributes:
        orders (MutableSequence[google.cloud.commerce.consumer.procurement_v1.types.Order]):

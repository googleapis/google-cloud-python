...
from google.cloud.commerce.consumer.procurement_v1.services.consumer_procurement_service import (
    pagers,
)
    ...
    async def place_order(
        ...
        *,
        ...
        .. code-block:: python
            ...
            from google.cloud.commerce.consumer import procurement_v1

            async def sample_place_order():
                # Create a client
                client = procurement_v1.ConsumerProcurementServiceAsyncClient()

                # Initialize request argument(s)
                request = procurement_v1.PlaceOrderRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.commerce.consumer.procurement_v1.types.PlaceOrderRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.commerce.consumer.procurement_v1.types.Order` Represents a purchase made by a customer on Cloud Marketplace.
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_order():
                ...
                # Initialize request argument(s)
                request = procurement_v1.GetOrderRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.commerce.consumer.procurement_v1.types.GetOrderRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.commerce.consumer.procurement_v1.types.Order:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_orders():
                ...
                # Initialize request argument(s)
                request = procurement_v1.ListOrdersRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.commerce.consumer.procurement_v1.types.ListOrdersRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.commerce.consumer.procurement_v1.services.consumer_procurement_service.pagers.ListOrdersAsyncPager:

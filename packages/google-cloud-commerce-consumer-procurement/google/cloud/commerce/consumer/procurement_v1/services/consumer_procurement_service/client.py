...
class ConsumerProcurementServiceClient(metaclass=ConsumerProcurementServiceClientMeta):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_place_order():
                # Create a client
                client = procurement_v1.ConsumerProcurementServiceClient()
        ...
        Args:
            request (Union[google.cloud.commerce.consumer.procurement_v1.types.PlaceOrderRequest, dict]):
    ...
    def get_order(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.commerce.consumer.procurement_v1.types.GetOrderRequest, dict]):
                The request object. Request message for
    ...
    def list_orders(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.commerce.consumer.procurement_v1.types.ListOrdersRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.commerce.consumer.procurement_v1.services.consumer_procurement_service.pagers.ListOrdersPager:

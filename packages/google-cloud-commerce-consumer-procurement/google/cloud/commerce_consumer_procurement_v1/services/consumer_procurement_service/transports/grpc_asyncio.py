...
class ConsumerProcurementServiceGrpcAsyncIOTransport(ConsumerProcurementServiceTransport):
    ...
    @property
    def place_order(self) -> Callable[[procurement_service.PlaceOrderRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_order(self) -> Callable[[procurement_service.GetOrderRequest], Awaitable[order.Order]]:
    ...
    @property
    def list_orders(self) -> Callable[[procurement_service.ListOrdersRequest], Awaitable[procurement_service.ListOrdersResponse]]:
    ...
    @property
    def modify_order(self) -> Callable[[procurement_service.ModifyOrderRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def cancel_order(self) -> Callable[[procurement_service.CancelOrderRequest], Awaitable[operations_pb2.Operation]]:

...
class ConsumerProcurementServiceClient(metaclass=ConsumerProcurementServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ConsumerProcurementServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ConsumerProcurementServiceClient._get_api_endpoint(

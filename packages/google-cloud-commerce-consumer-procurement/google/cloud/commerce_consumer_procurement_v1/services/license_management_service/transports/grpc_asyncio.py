...
class LicenseManagementServiceGrpcAsyncIOTransport(LicenseManagementServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_license_pool: self._wrap_method(
                self.get_license_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_license_pool: self._wrap_method(
                self.update_license_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.assign: self._wrap_method(
                self.assign,
                default_timeout=None,
                client_info=client_info,
            ),
            self.unassign: self._wrap_method(
                self.unassign,
                default_timeout=None,
                client_info=client_info,
            ),
            self.enumerate_licensed_users: self._wrap_method(

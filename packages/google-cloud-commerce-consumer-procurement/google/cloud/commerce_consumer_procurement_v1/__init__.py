...
from .services.consumer_procurement_service import ConsumerProcurementServiceAsyncClient, ConsumerProcurementServiceClient
from .services.license_management_service import LicenseManagementServiceAsyncClient, LicenseManagementServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.commerce_consumer_procurement_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.commerce_consumer_procurement_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.commerce_consumer_procurement_v1"

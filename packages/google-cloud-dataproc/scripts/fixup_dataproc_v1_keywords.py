...
class dataprocCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_node_group': ('parent', 'node_group', 'node_group_id', 'request_id', ),
        'create_session': ('parent', 'session', 'session_id', 'request_id', ),
        'create_session_template': ('parent', 'session_template', ),
        ...
        'list_session_templates': ('parent', 'page_size', 'page_token', 'filter', ),
        'list_workflow_templates': ('parent', 'page_size', 'page_token', ),
        'resize_node_group': ('name', 'size', 'request_id', 'graceful_decommission_timeout', ),
        ...
        'terminate_session': ('name', 'request_id', ),
        ...
        'update_session_template': ('session_template', ),

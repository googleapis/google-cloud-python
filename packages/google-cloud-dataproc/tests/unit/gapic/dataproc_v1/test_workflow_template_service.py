...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert WorkflowTemplateServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert WorkflowTemplateServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                WorkflowTemplateServiceClient._use_client_cert_effective()
...
@mock.patch.object(
    WorkflowTemplateServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(WorkflowTemplateServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        WorkflowTemplateServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        WorkflowTemplateServiceClient._get_api_endpoint(None, None, default_universe, "always") == WorkflowTemplateServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        WorkflowTemplateServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == WorkflowTemplateServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_instantiate_workflow_template_async(
    transport: str = "grpc_asyncio", request_type=workflow_templates.InstantiateWorkflowTemplateRequest
):
    client = WorkflowTemplateServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_workflow_template_rest_required_fields(request_type=workflow_templates.CreateWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_workflow_template._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_workflow_template_rest_required_fields(request_type=workflow_templates.GetWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_workflow_template._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_instantiate_inline_workflow_template_rest_required_fields(request_type=workflow_templates.InstantiateInlineWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).instantiate_inline_workflow_template._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_workflow_template_rest_required_fields(request_type=workflow_templates.UpdateWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_workflow_template._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_workflow_templates_rest_required_fields(request_type=workflow_templates.ListWorkflowTemplatesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_workflow_templates._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_workflow_template_rest_required_fields(request_type=workflow_templates.DeleteWorkflowTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_workflow_template._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = WorkflowTemplateServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = WorkflowTemplateServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = WorkflowTemplateServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = WorkflowTemplateServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
        ...
        "placement": {
            "managed_cluster": {
                ...
                "config": {
                    ...
                    "lifecycle_config": {"idle_delete_ttl": {}, "auto_delete_time": {}, "auto_delete_ttl": {}, "idle_start_time": {}},
                    ...
                    "dataproc_metric_config": {
                        "metrics": [{"metric_source": 1, "metric_overrides": ["metric_overrides_value1", "metric_overrides_value2"]}]
                    },
                    "auxiliary_node_groups": [
                        {
                            "node_group": {"name": "name_value", "roles": [1], "node_group_config": {}, "labels": {}},
        ...
        "jobs": [
            {
                ...
                "prerequisite_step_ids": ["prerequisite_step_ids_value1", "prerequisite_step_ids_value2"],
            }
        ],
        "parameters": [
            {
                ...
                "validation": {"regex": {"regexes": ["regexes_value1", "regexes_value2"]}, "values": {"values": ["values_value1", "values_value2"]}},
            }
        ],
        "dag_timeout": {},
...
def test_create_workflow_template_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_create_workflow_template") as post, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "post_create_workflow_template_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "pre_create_workflow_template"
    ) as pre:
...
def test_get_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_get_workflow_template") as post, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "post_get_workflow_template_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_instantiate_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_workflow_template"
    ) as post, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_workflow_template_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "pre_instantiate_workflow_template"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_instantiate_inline_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_inline_workflow_template"
    ) as post, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "post_instantiate_inline_workflow_template_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "pre_instantiate_inline_workflow_template"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_update_workflow_template") as post, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "post_update_workflow_template_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "pre_update_workflow_template"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_workflow_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "post_list_workflow_templates") as post, mock.patch.object(
        transports.WorkflowTemplateServiceRestInterceptor, "post_list_workflow_templates_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_workflow_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.WorkflowTemplateServiceRestInterceptor, "pre_delete_workflow_template") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.WorkflowTemplateServiceGrpcTransport, grpc_helpers), (transports.WorkflowTemplateServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

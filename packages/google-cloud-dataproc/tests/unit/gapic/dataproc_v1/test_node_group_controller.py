...
from google.cloud.dataproc_v1.services.node_group_controller import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        NodeGroupControllerClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        NodeGroupControllerClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        NodeGroupControllerClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        NodeGroupControllerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        NodeGroupControllerClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        NodeGroupControllerClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert NodeGroupControllerClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert NodeGroupControllerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert NodeGroupControllerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                NodeGroupControllerClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        NodeGroupControllerClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                NodeGroupControllerClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(NodeGroupControllerClient),
)
@mock.patch.object(
    NodeGroupControllerAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(NodeGroupControllerAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = NodeGroupControllerClient._DEFAULT_UNIVERSE
    default_endpoint = NodeGroupControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = NodeGroupControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        NodeGroupControllerClient._get_api_endpoint(
    ...
    assert (
        ...
        == NodeGroupControllerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        NodeGroupControllerClient._get_api_endpoint(
    ...
    assert (
        NodeGroupControllerClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        NodeGroupControllerClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        NodeGroupControllerClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        NodeGroupControllerClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        NodeGroupControllerClient._get_universe_domain(None, None)
        == NodeGroupControllerClient._DEFAULT_UNIVERSE
    )
...
def test_node_group_controller_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_node_group_controller_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [NodeGroupControllerClient, NodeGroupControllerAsyncClient]
)
@mock.patch.object(
    NodeGroupControllerClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(NodeGroupControllerClient),
)
@mock.patch.object(
    NodeGroupControllerAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(NodeGroupControllerAsyncClient),
)
...
def test_node_group_controller_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_node_group_controller_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.dataproc_v1.services.node_group_controller.transports.NodeGroupControllerGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_node_group_controller_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_node_group_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_node_group
...
@pytest.mark.asyncio
async def test_resize_node_group_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.resize_node_group
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_node_group_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_node_group
            in client._client._transport._wrapped_methods
        )
...
def test_create_node_group_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.NodeGroupControllerRestInterceptor,
...
def test_node_group_controller_base_transport():
    ...
    with mock.patch(
        "google.cloud.dataproc_v1.services.node_group_controller.transports.NodeGroupControllerTransport.__init__"
    ) as Transport:
...
def test_node_group_controller_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.dataproc_v1.services.node_group_controller.transports.NodeGroupControllerTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_node_group_path():
    ...
    actual = NodeGroupControllerClient.node_group_path(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.NodeGroupControllerTransport, "_prep_wrapped_messages"
    ) as prep:
        client = NodeGroupControllerClient(
            credentials=ga_credentials.AnonymousCredentials(),

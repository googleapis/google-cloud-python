...
def test_create_node_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateNodeGroup,
        "_BaseCreateNodeGroup__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_resize_node_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseResizeNodeGroup,
        "_BaseResizeNodeGroup__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_node_group_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetNodeGroup,
        "_BaseGetNodeGroup__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

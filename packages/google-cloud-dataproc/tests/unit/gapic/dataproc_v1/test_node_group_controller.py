...
def test__get_api_endpoint():
    ...
    assert (
        NodeGroupControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        NodeGroupControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == NodeGroupControllerClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = NodeGroupControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = NodeGroupControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = NodeGroupControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = NodeGroupControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_node_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NodeGroupControllerRestInterceptor, "post_create_node_group_with_metadata"
...
def test_resize_node_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.NodeGroupControllerRestInterceptor, "post_resize_node_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_node_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.NodeGroupControllerRestInterceptor, "post_get_node_group") as post, mock.patch.object(
        transports.NodeGroupControllerRestInterceptor, "post_get_node_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.NodeGroupControllerGrpcTransport, grpc_helpers), (transports.NodeGroupControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)

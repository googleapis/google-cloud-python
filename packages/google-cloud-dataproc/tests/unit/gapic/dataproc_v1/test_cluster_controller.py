...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ClusterControllerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ClusterControllerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ClusterControllerClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        ClusterControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        ClusterControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ClusterControllerClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_diagnose_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:diagnose" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc():
    transport = ClusterControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ClusterControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ClusterControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ClusterControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    ...
    request_init["cluster"] = {
        ...
        "config": {
            ...
            "master_config": {
                ...
                "accelerators": [{"accelerator_type_uri": "accelerator_type_uri_value", "accelerator_count": 1805}],
                ...
                "instance_flexibility_policy": {
                    ...
                    "instance_selection_list": [{"machine_types": ["machine_types_value1", "machine_types_value2"], "rank": 428}],
                    "instance_selection_results": [{"machine_type": "machine_type_value", "vm_count": 875}],
                },
                "startup_config": {"required_registration_fraction": 0.3216},
            },
            "worker_config": {},
            "secondary_worker_config": {},
            "software_config": {"image_version": "image_version_value", "properties": {}, "optional_components": [5]},
            "initialization_actions": [{"executable_file": "executable_file_value", "execution_timeout": {"seconds": 751, "nanos": 543}}],
            "encryption_config": {"gce_pd_kms_key_name": "gce_pd_kms_key_name_value", "kms_key": "kms_key_value"},
            ...
            "metastore_config": {"dataproc_metastore_service": "dataproc_metastore_service_value"},
            "dataproc_metric_config": {"metrics": [{"metric_source": 1, "metric_overrides": ["metric_overrides_value1", "metric_overrides_value2"]}]},
            "auxiliary_node_groups": [
                {"node_group": {"name": "name_value", "roles": [1], "node_group_config": {}, "labels": {}}, "node_group_id": "node_group_id_value"}
            ],
        },
        "virtual_cluster_config": {
            ...
            "kubernetes_cluster_config": {
                ...
                "kubernetes_software_config": {"component_version": {}, "properties": {}},
            },
            "auxiliary_services_config": {"metastore_config": {}, "spark_history_server_config": {"dataproc_cluster": "dataproc_cluster_value"}},
        },
        "labels": {},
        "status": {"state": 1, "detail": "detail_value", "state_start_time": {}, "substate": 1},
        "status_history": {},
        "cluster_uuid": "cluster_uuid_value",
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ClusterControllerRestInterceptor, "post_get_cluster") as post, mock.patch.object(
...
def test_list_clusters_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ClusterControllerRestInterceptor, "post_list_clusters") as post, mock.patch.object(
...
def test_diagnose_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ClusterControllerRestInterceptor, "post_diagnose_cluster_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.ClusterControllerGrpcTransport, grpc_helpers), (transports.ClusterControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)

...
def test_get_session_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_session_template] = (
            mock_rpc
        )
        request = {}
...
def test_list_session_templates_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_session_templates] = (
            mock_rpc
        )
        request = {}
...
def test_create_session_template_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSessionTemplate,
...
def test_update_session_template_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSessionTemplate,
...
def test_get_session_template_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSessionTemplate,
...
def test_list_session_templates_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSessionTemplates,
...
def test_delete_session_template_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSessionTemplate,

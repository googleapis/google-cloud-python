...
def test__get_api_endpoint():
    ...
    assert (
        BatchControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        BatchControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == BatchControllerClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_transport_kind_grpc():
    transport = BatchControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = BatchControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = BatchControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = BatchControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_batch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchControllerRestInterceptor, "post_get_batch") as post, mock.patch.object(
...
def test_list_batches_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchControllerRestInterceptor, "post_list_batches") as post, mock.patch.object(
...
def test_delete_batch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.BatchControllerRestInterceptor, "pre_delete_batch") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.BatchControllerGrpcTransport, grpc_helpers), (transports.BatchControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)

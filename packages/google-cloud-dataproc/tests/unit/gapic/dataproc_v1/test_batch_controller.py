...
def test__get_default_mtls_endpoint():
    ...
    assert (
        BatchControllerClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert BatchControllerClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert BatchControllerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert BatchControllerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                BatchControllerClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        BatchControllerClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        BatchControllerClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                BatchControllerClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                BatchControllerClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(BatchControllerClient),
)
@mock.patch.object(
    BatchControllerAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(BatchControllerAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = BatchControllerClient._DEFAULT_UNIVERSE
    default_endpoint = BatchControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = BatchControllerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == BatchControllerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BatchControllerClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        BatchControllerClient._get_api_endpoint(None, None, default_universe, "always")
        == BatchControllerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        BatchControllerClient._get_api_endpoint(
    ...
    assert (
        BatchControllerClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        BatchControllerClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        BatchControllerClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        BatchControllerClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        BatchControllerClient._get_universe_domain(None, None)
        == BatchControllerClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_create_batch_async_use_cached_wrapped_rpc(
...
@pytest.mark.asyncio
async def test_list_batches_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
...
@pytest.mark.asyncio
async def test_delete_batch_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
...
def test_create_batch_rest_call_success(request_type):
    ...
    request_init["batch"] = {
        ...
        "pyspark_notebook_batch": {
            "notebook_file_uri": "notebook_file_uri_value",
            "params": {},
            "python_file_uris": ["python_file_uris_value1", "python_file_uris_value2"],
            "jar_file_uris": ["jar_file_uris_value1", "jar_file_uris_value2"],
            "file_uris": ["file_uris_value1", "file_uris_value2"],
...
def test_create_batch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.BatchControllerRestInterceptor, "post_create_batch_with_metadata"
...
def test_get_batch_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.BatchControllerRestInterceptor, "post_get_batch_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_list_batches_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.BatchControllerRestInterceptor, "post_list_batches_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = batches.ListBatchesResponse.to_json(
            batches.ListBatchesResponse()
        )
        req.return_value.content = return_value
...
def test_crypto_key_path():
    ...
    actual = BatchControllerClient.crypto_key_path(
...
def test_parse_crypto_key_path():
    ...
    path = BatchControllerClient.crypto_key_path(**expected)

    # Check that the path construction is reversible.
    actual = BatchControllerClient.parse_crypto_key_path(path)
    assert expected == actual

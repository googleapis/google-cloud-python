...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert JobControllerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert JobControllerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                JobControllerClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        JobControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == JobControllerClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_submit_job_as_operation_rest_required_fields(request_type=jobs.SubmitJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).submit_job_as_operation._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = JobControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = JobControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = JobControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = JobControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_submit_job_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.JobControllerRestInterceptor, "post_submit_job") as post, mock.patch.object(
        transports.JobControllerRestInterceptor, "post_submit_job_with_metadata"
...
def test_submit_job_as_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.JobControllerRestInterceptor, "post_submit_job_as_operation_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobControllerRestInterceptor, "post_get_job") as post, mock.patch.object(
        transports.JobControllerRestInterceptor, "post_get_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobControllerRestInterceptor, "post_list_jobs") as post, mock.patch.object(
        transports.JobControllerRestInterceptor, "post_list_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_job_rest_call_success(request_type):
    ...
    request_init["job"] = {
        ...
        "placement": {"cluster_name": "cluster_name_value", "cluster_uuid": "cluster_uuid_value", "cluster_labels": {}},
        "hadoop_job": {
        ...
        "status": {"state": 1, "details": "details_value", "state_start_time": {"seconds": 751, "nanos": 543}, "substate": 1},
        "status_history": {},
        "yarn_applications": [{"name": "name_value", "state": 1, "progress": 0.885, "tracking_url": "tracking_url_value"}],
        "driver_output_resource_uri": "driver_output_resource_uri_value",
        "driver_control_files_uri": "driver_control_files_uri_value",
        "labels": {},
...
def test_update_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobControllerRestInterceptor, "post_update_job") as post, mock.patch.object(
        transports.JobControllerRestInterceptor, "post_update_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_cancel_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobControllerRestInterceptor, "post_cancel_job") as post, mock.patch.object(
        transports.JobControllerRestInterceptor, "post_cancel_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.JobControllerRestInterceptor, "pre_delete_job") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.JobControllerGrpcTransport, grpc_helpers), (transports.JobControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)

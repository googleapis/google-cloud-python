...
from google.cloud.dataproc_v1.services.session_controller import SessionControllerAsyncClient, SessionControllerClient, pagers, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert SessionControllerClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SessionControllerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SessionControllerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SessionControllerClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        SessionControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == SessionControllerClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        SessionControllerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SessionControllerClient.DEFAULT_MTLS_ENDPOINT
    )
...
@pytest.mark.parametrize("client_class", [SessionControllerClient, SessionControllerAsyncClient])
...
def test_session_controller_client_client_options_from_dict():
    with mock.patch("google.cloud.dataproc_v1.services.session_controller.transports.SessionControllerGrpcTransport.__init__") as grpc_transport:
        ...
        client = SessionControllerClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_terminate_session(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.terminate_session), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = SessionControllerClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = SessionControllerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = SessionControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = SessionControllerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SessionControllerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SessionControllerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_session_rest_bad_request(request_type=sessions.CreateSessionRequest):
    client = SessionControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["session"] = {
        ...
        "runtime_info": {
            ...
            "current_usage": {
                ...
                "milli_dcu_premium": 1808,
                "shuffle_storage_gb_premium": 2759,
                "milli_accelerator": 1787,
                "accelerator_type": "accelerator_type_value",
                "snapshot_time": {},
            },
        },
...
def test_create_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SessionControllerRestInterceptor, "post_create_session_with_metadata"
...
def test_get_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionControllerRestInterceptor, "post_get_session") as post, mock.patch.object(
        transports.SessionControllerRestInterceptor, "post_get_session_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionControllerRestInterceptor, "post_list_sessions") as post, mock.patch.object(
        transports.SessionControllerRestInterceptor, "post_list_sessions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_terminate_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SessionControllerRestInterceptor, "post_terminate_session_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SessionControllerRestInterceptor, "post_delete_session_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_session_controller_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.SessionControllerTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.SessionControllerGrpcTransport, grpc_helpers), (transports.SessionControllerGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_session_controller_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.SessionControllerRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.SessionControllerGrpcTransport, transports.SessionControllerGrpcAsyncIOTransport])
def test_session_controller_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_ctx():
    ...
    for transport in transports:
        client = SessionControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
`Cloud Dataproc`_: is a faster, easier, more cost-effective way to run Apache Spark and Apache Hadoop.
...
.. _Enable the Cloud Dataproc.:  https://cloud.google.com/dataproc
...
-  Read the `Client Library Documentation`_ for Cloud Dataproc
   to see other available methods on the client.
-  Read the `Cloud Dataproc Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud Dataproc Product documentation:  https://cloud.google.com/dataproc

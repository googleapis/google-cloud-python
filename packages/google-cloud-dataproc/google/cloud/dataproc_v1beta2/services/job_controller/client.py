...
class JobControllerClient(metaclass=JobControllerClientMeta):
    ...
    def submit_job(
        ...
        *,
        ...
        Args:
            request (google.cloud.dataproc_v1beta2.types.SubmitJobRequest):
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            job (google.cloud.dataproc_v1beta2.types.Job):
    ...
    def get_job(
        ...
        *,
        ...
        Args:
            request (google.cloud.dataproc_v1beta2.types.GetJobRequest):
    ...
    def list_jobs(
        ...
        *,
        ...
        Returns:
            google.cloud.dataproc_v1beta2.services.job_controller.pagers.ListJobsPager:
    ...
    def update_job(
        ...
        *,
        ...
        Args:
            request (google.cloud.dataproc_v1beta2.types.UpdateJobRequest):
    ...
    def cancel_job(
        ...
        *,
        ...
        Args:
            request (google.cloud.dataproc_v1beta2.types.CancelJobRequest):
    ...
    def delete_job(
        ...
        *,
        ...
        Args:
            request (google.cloud.dataproc_v1beta2.types.DeleteJobRequest):

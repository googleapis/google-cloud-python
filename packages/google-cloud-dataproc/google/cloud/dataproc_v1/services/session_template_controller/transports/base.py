...
class SessionTemplateControllerTransport(abc.ABC):
    ...
    def create_session_template(
        ...
        [session_templates.CreateSessionTemplateRequest], Union[session_templates.SessionTemplate, Awaitable[session_templates.SessionTemplate]]
    ]:
        raise NotImplementedError()
    ...
    def update_session_template(
        ...
        [session_templates.UpdateSessionTemplateRequest], Union[session_templates.SessionTemplate, Awaitable[session_templates.SessionTemplate]]
    ]:
        raise NotImplementedError()
    ...
    def get_session_template(
        ...
        [session_templates.GetSessionTemplateRequest], Union[session_templates.SessionTemplate, Awaitable[session_templates.SessionTemplate]]
    ]:
        raise NotImplementedError()
    ...
    def list_session_templates(
        ...
        Union[session_templates.ListSessionTemplatesResponse, Awaitable[session_templates.ListSessionTemplatesResponse]],
    ]:
        raise NotImplementedError()
    ...
    def delete_session_template(
        self,
    ) -> Callable[[session_templates.DeleteSessionTemplateRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

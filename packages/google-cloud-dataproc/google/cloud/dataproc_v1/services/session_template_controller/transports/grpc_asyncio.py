...
class SessionTemplateControllerGrpcAsyncIOTransport(SessionTemplateControllerTransport):
    ...
    @property
    def create_session_template(self) -> Callable[[session_templates.CreateSessionTemplateRequest], Awaitable[session_templates.SessionTemplate]]:
    ...
    @property
    def update_session_template(self) -> Callable[[session_templates.UpdateSessionTemplateRequest], Awaitable[session_templates.SessionTemplate]]:
    ...
    @property
    def get_session_template(self) -> Callable[[session_templates.GetSessionTemplateRequest], Awaitable[session_templates.SessionTemplate]]:
    ...
    def list_session_templates(
        self,
    ) -> Callable[[session_templates.ListSessionTemplatesRequest], Awaitable[session_templates.ListSessionTemplatesResponse]]:
    ...
    @property
    def delete_session_template(self) -> Callable[[session_templates.DeleteSessionTemplateRequest], Awaitable[empty_pb2.Empty]]:

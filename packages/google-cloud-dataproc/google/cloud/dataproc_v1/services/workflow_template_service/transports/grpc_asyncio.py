...
class WorkflowTemplateServiceGrpcAsyncIOTransport(WorkflowTemplateServiceTransport):
    ...
    def create_workflow_template(
        self,
    ) -> Callable[[workflow_templates.CreateWorkflowTemplateRequest], Awaitable[workflow_templates.WorkflowTemplate]]:
    ...
    @property
    def get_workflow_template(self) -> Callable[[workflow_templates.GetWorkflowTemplateRequest], Awaitable[workflow_templates.WorkflowTemplate]]:
    ...
    @property
    def instantiate_workflow_template(self) -> Callable[[workflow_templates.InstantiateWorkflowTemplateRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def instantiate_inline_workflow_template(
        self,
    ) -> Callable[[workflow_templates.InstantiateInlineWorkflowTemplateRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def update_workflow_template(
        self,
    ) -> Callable[[workflow_templates.UpdateWorkflowTemplateRequest], Awaitable[workflow_templates.WorkflowTemplate]]:
    ...
    def list_workflow_templates(
        self,
    ) -> Callable[[workflow_templates.ListWorkflowTemplatesRequest], Awaitable[workflow_templates.ListWorkflowTemplatesResponse]]:
    ...
    @property
    def delete_workflow_template(self) -> Callable[[workflow_templates.DeleteWorkflowTemplateRequest], Awaitable[empty_pb2.Empty]]:

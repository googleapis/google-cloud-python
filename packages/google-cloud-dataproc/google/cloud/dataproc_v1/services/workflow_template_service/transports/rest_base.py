...
class _BaseWorkflowTemplateServiceRestTransport(WorkflowTemplateServiceTransport):
    ...
    class _BaseCreateWorkflowTemplate:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseCreateWorkflowTemplate._get_unset_required_fields(query_params))
    ...
    class _BaseDeleteWorkflowTemplate:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseDeleteWorkflowTemplate._get_unset_required_fields(query_params))
    ...
    class _BaseGetWorkflowTemplate:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseGetWorkflowTemplate._get_unset_required_fields(query_params))
    ...
    class _BaseInstantiateInlineWorkflowTemplate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = workflow_templates.InstantiateInlineWorkflowTemplateRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseWorkflowTemplateServiceRestTransport._BaseInstantiateInlineWorkflowTemplate._get_unset_required_fields(query_params)
            )
    ...
    class _BaseInstantiateWorkflowTemplate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = workflow_templates.InstantiateWorkflowTemplateRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseInstantiateWorkflowTemplate._get_unset_required_fields(query_params))
    ...
    class _BaseListWorkflowTemplates:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseListWorkflowTemplates._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateWorkflowTemplate:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseWorkflowTemplateServiceRestTransport._BaseUpdateWorkflowTemplate._get_unset_required_fields(query_params))

...
class WorkflowTemplateServiceClient(metaclass=WorkflowTemplateServiceClientMeta):
    ...
    def parse_node_group_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/regions/(?P<region>.+?)/clusters/(?P<cluster>.+?)/nodeGroups/(?P<node_group>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_workflow_template_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/regions/(?P<region>.+?)/workflowTemplates/(?P<workflow_template>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = WorkflowTemplateServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = WorkflowTemplateServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = WorkflowTemplateServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, WorkflowTemplateServiceTransport, Callable[..., WorkflowTemplateServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = WorkflowTemplateServiceClient._read_environment_variables()
        self._client_cert_source = WorkflowTemplateServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = WorkflowTemplateServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, WorkflowTemplateServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(WorkflowTemplateServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or WorkflowTemplateServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[WorkflowTemplateServiceTransport], Callable[..., WorkflowTemplateServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.dataproc_v1.WorkflowTemplateServiceClient`.",
                    extra={
    ...
    def instantiate_workflow_template(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.instantiate_workflow_template]
    ...
    def instantiate_inline_workflow_template(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.instantiate_inline_workflow_template]

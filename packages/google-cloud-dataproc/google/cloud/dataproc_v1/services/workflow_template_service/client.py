...
class WorkflowTemplateServiceClient(metaclass=WorkflowTemplateServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                WorkflowTemplateServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = WorkflowTemplateServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or WorkflowTemplateServiceClient._get_api_endpoint(

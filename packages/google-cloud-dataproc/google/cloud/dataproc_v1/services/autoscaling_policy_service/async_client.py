...
class AutoscalingPolicyServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = AutoscalingPolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AutoscalingPolicyServiceTransport, Callable[..., AutoscalingPolicyServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_autoscaling_policy(
        self,
        request: Optional[Union[autoscaling_policies.CreateAutoscalingPolicyRequest, dict]] = None,
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_autoscaling_policy]
    ...
    async def update_autoscaling_policy(
        self,
        request: Optional[Union[autoscaling_policies.UpdateAutoscalingPolicyRequest, dict]] = None,
        *,
        policy: Optional[autoscaling_policies.AutoscalingPolicy] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_autoscaling_policy]
    ...
    async def get_autoscaling_policy(
        self,
        request: Optional[Union[autoscaling_policies.GetAutoscalingPolicyRequest, dict]] = None,
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_autoscaling_policy]
    ...
    async def list_autoscaling_policies(
        self,
        request: Optional[Union[autoscaling_policies.ListAutoscalingPoliciesRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_autoscaling_policies]
    ...
    async def delete_autoscaling_policy(
        self,
        request: Optional[Union[autoscaling_policies.DeleteAutoscalingPolicyRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_autoscaling_policy]

...
class _BaseAutoscalingPolicyServiceRestTransport(AutoscalingPolicyServiceTransport):
    ...
    class _BaseCreateAutoscalingPolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutoscalingPolicyServiceRestTransport._BaseCreateAutoscalingPolicy._get_unset_required_fields(query_params))
    ...
    class _BaseDeleteAutoscalingPolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutoscalingPolicyServiceRestTransport._BaseDeleteAutoscalingPolicy._get_unset_required_fields(query_params))
    ...
    class _BaseGetAutoscalingPolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutoscalingPolicyServiceRestTransport._BaseGetAutoscalingPolicy._get_unset_required_fields(query_params))
    ...
    class _BaseListAutoscalingPolicies:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutoscalingPolicyServiceRestTransport._BaseListAutoscalingPolicies._get_unset_required_fields(query_params))
    ...
    class _BaseUpdateAutoscalingPolicy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutoscalingPolicyServiceRestTransport._BaseUpdateAutoscalingPolicy._get_unset_required_fields(query_params))

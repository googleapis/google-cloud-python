...
class AutoscalingPolicyServiceGrpcAsyncIOTransport(AutoscalingPolicyServiceTransport):
    ...
    def create_autoscaling_policy(
        self,
    ) -> Callable[[autoscaling_policies.CreateAutoscalingPolicyRequest], Awaitable[autoscaling_policies.AutoscalingPolicy]]:
    ...
    def update_autoscaling_policy(
        self,
    ) -> Callable[[autoscaling_policies.UpdateAutoscalingPolicyRequest], Awaitable[autoscaling_policies.AutoscalingPolicy]]:
    ...
    def get_autoscaling_policy(
        self,
    ) -> Callable[[autoscaling_policies.GetAutoscalingPolicyRequest], Awaitable[autoscaling_policies.AutoscalingPolicy]]:
    ...
    def list_autoscaling_policies(
        self,
    ) -> Callable[[autoscaling_policies.ListAutoscalingPoliciesRequest], Awaitable[autoscaling_policies.ListAutoscalingPoliciesResponse]]:
    ...
    @property
    def delete_autoscaling_policy(self) -> Callable[[autoscaling_policies.DeleteAutoscalingPolicyRequest], Awaitable[empty_pb2.Empty]]:

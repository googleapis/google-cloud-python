...
class NodeGroupControllerTransport(abc.ABC):
    ...
    def create_node_group(
        self,
    ) -> Callable[[node_groups.CreateNodeGroupRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def resize_node_group(
        self,
    ) -> Callable[[node_groups.ResizeNodeGroupRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_node_group(self) -> Callable[[node_groups.GetNodeGroupRequest], Union[clusters.NodeGroup, Awaitable[clusters.NodeGroup]]]:
        raise NotImplementedError()

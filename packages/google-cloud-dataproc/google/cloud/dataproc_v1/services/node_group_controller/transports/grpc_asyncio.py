...
class NodeGroupControllerGrpcAsyncIOTransport(NodeGroupControllerTransport):
    ...
    @property
    def create_node_group(self) -> Callable[[node_groups.CreateNodeGroupRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def resize_node_group(self) -> Callable[[node_groups.ResizeNodeGroupRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_node_group(self) -> Callable[[node_groups.GetNodeGroupRequest], Awaitable[clusters.NodeGroup]]:

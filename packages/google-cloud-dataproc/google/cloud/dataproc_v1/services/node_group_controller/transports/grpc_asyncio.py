...
class NodeGroupControllerGrpcAsyncIOTransport(NodeGroupControllerTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_node_group: gapic_v1.method_async.wrap_method(
                self.create_node_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resize_node_group: gapic_v1.method_async.wrap_method(
                self.resize_node_group,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_node_group: gapic_v1.method_async.wrap_method(
                self.get_node_group,
                default_timeout=None,
                client_info=client_info,
            ),

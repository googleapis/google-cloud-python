...
class SessionControllerGrpcAsyncIOTransport(SessionControllerTransport):
    ...
    @property
    def create_session(self) -> Callable[[sessions.CreateSessionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_session(self) -> Callable[[sessions.GetSessionRequest], Awaitable[sessions.Session]]:
    ...
    @property
    def list_sessions(self) -> Callable[[sessions.ListSessionsRequest], Awaitable[sessions.ListSessionsResponse]]:
    ...
    @property
    def terminate_session(self) -> Callable[[sessions.TerminateSessionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_session(self) -> Callable[[sessions.DeleteSessionRequest], Awaitable[operations_pb2.Operation]]:

...
class SessionControllerTransport(abc.ABC):
    ...
    @property
    def create_session(self) -> Callable[[sessions.CreateSessionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_session(self) -> Callable[[sessions.GetSessionRequest], Union[sessions.Session, Awaitable[sessions.Session]]]:
        raise NotImplementedError()

    @property
    def list_sessions(
        self,
    ) -> Callable[[sessions.ListSessionsRequest], Union[sessions.ListSessionsResponse, Awaitable[sessions.ListSessionsResponse]]]:
        raise NotImplementedError()

    @property
    def terminate_session(self) -> Callable[[sessions.TerminateSessionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_session(self) -> Callable[[sessions.DeleteSessionRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
class BatchControllerRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_create_batch(
        self, request: batches.CreateBatchRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[batches.CreateBatchRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_batch(
        self, request: batches.DeleteBatchRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[batches.DeleteBatchRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_batch(
        self, request: batches.GetBatchRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[batches.GetBatchRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_batches(
        self, request: batches.ListBatchesRequest, metadata: Sequence[Tuple[str, str]]
    ) -> Tuple[batches.ListBatchesRequest, Sequence[Tuple[str, str]]]:
...
class BatchControllerRestTransport(BatchControllerTransport):
    """REST backend transport for BatchController.
    ...
    class _CreateBatch(BatchControllerRestStub):
        def __hash__(self):
    ...
    class _DeleteBatch(BatchControllerRestStub):
        def __hash__(self):
    ...
    class _GetBatch(BatchControllerRestStub):
        def __hash__(self):
    ...
    class _ListBatches(BatchControllerRestStub):
        def __hash__(self):
    ...
    class _GetIamPolicy(BatchControllerRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(BatchControllerRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(BatchControllerRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(BatchControllerRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(BatchControllerRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(BatchControllerRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(BatchControllerRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,

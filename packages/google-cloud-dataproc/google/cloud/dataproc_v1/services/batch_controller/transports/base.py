...
class BatchControllerTransport(abc.ABC):
    ...
    @property
    def create_batch(self) -> Callable[[batches.CreateBatchRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_batch(self) -> Callable[[batches.GetBatchRequest], Union[batches.Batch, Awaitable[batches.Batch]]]:
        raise NotImplementedError()

    @property
    def list_batches(self) -> Callable[[batches.ListBatchesRequest], Union[batches.ListBatchesResponse, Awaitable[batches.ListBatchesResponse]]]:
        raise NotImplementedError()

    @property
    def delete_batch(self) -> Callable[[batches.DeleteBatchRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

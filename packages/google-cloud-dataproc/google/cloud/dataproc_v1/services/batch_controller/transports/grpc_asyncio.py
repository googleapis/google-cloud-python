...
class BatchControllerGrpcAsyncIOTransport(BatchControllerTransport):
    ...
    @property
    def create_batch(self) -> Callable[[batches.CreateBatchRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_batch(self) -> Callable[[batches.GetBatchRequest], Awaitable[batches.Batch]]:
    ...
    @property
    def list_batches(self) -> Callable[[batches.ListBatchesRequest], Awaitable[batches.ListBatchesResponse]]:
    ...
    @property
    def delete_batch(self) -> Callable[[batches.DeleteBatchRequest], Awaitable[empty_pb2.Empty]]:

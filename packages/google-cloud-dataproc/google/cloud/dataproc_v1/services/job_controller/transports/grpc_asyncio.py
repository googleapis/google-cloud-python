...
class JobControllerGrpcAsyncIOTransport(JobControllerTransport):
    ...
    @property
    def submit_job_as_operation(self) -> Callable[[jobs.SubmitJobRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_jobs(self) -> Callable[[jobs.ListJobsRequest], Awaitable[jobs.ListJobsResponse]]:
    ...
    @property
    def delete_job(self) -> Callable[[jobs.DeleteJobRequest], Awaitable[empty_pb2.Empty]]:

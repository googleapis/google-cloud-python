...
class ClusterControllerGrpcAsyncIOTransport(ClusterControllerTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.stop_cluster: gapic_v1.method_async.wrap_method(
                self.stop_cluster,
                default_timeout=None,
                client_info=client_info,
            ),
            self.start_cluster: gapic_v1.method_async.wrap_method(
                self.start_cluster,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.diagnose_cluster: gapic_v1.method_async.wrap_method(

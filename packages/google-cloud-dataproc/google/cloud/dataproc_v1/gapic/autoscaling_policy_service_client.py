...
"""Accesses the google.cloud.dataproc.v1 AutoscalingPolicyService API."""
...
from google.cloud.dataproc_v1.gapic import autoscaling_policy_service_client_config
...
class AutoscalingPolicyServiceClient(object):
    ...
    _INTERFACE_NAME = "google.cloud.dataproc.v1.AutoscalingPolicyService"
    ...
    def list_autoscaling_policies(
        ...
        Returns:
            ...
            An iterable of :class:`~google.cloud.dataproc_v1.types.AutoscalingPolicy` instances.

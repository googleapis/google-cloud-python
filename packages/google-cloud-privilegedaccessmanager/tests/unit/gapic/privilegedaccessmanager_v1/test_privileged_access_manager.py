...
def test__get_default_mtls_endpoint():
    ...
    assert PrivilegedAccessManagerClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert PrivilegedAccessManagerClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert PrivilegedAccessManagerClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert PrivilegedAccessManagerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert PrivilegedAccessManagerClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert PrivilegedAccessManagerClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert PrivilegedAccessManagerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert PrivilegedAccessManagerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert PrivilegedAccessManagerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert PrivilegedAccessManagerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert PrivilegedAccessManagerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert PrivilegedAccessManagerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                PrivilegedAccessManagerClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert PrivilegedAccessManagerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert PrivilegedAccessManagerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert PrivilegedAccessManagerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert PrivilegedAccessManagerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(PrivilegedAccessManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PrivilegedAccessManagerClient))
@mock.patch.object(
    PrivilegedAccessManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PrivilegedAccessManagerAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = PrivilegedAccessManagerClient._DEFAULT_UNIVERSE
    default_endpoint = PrivilegedAccessManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = PrivilegedAccessManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert PrivilegedAccessManagerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        PrivilegedAccessManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        PrivilegedAccessManagerClient._get_api_endpoint(None, None, default_universe, "always") == PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        PrivilegedAccessManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == PrivilegedAccessManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert PrivilegedAccessManagerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        PrivilegedAccessManagerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert PrivilegedAccessManagerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert PrivilegedAccessManagerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert PrivilegedAccessManagerClient._get_universe_domain(None, None) == PrivilegedAccessManagerClient._DEFAULT_UNIVERSE
...
def test_privileged_access_manager_client_from_service_account_info(client_class, transport_name):
...
def test_privileged_access_manager_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_privileged_access_manager_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerGrpcTransport, "grpc"),
        (PrivilegedAccessManagerAsyncClient, transports.PrivilegedAccessManagerGrpcAsyncIOTransport, "grpc_asyncio"),
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerRestTransport, "rest"),
    ],
)
@mock.patch.object(PrivilegedAccessManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PrivilegedAccessManagerClient))
@mock.patch.object(
...
def test_privileged_access_manager_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerGrpcTransport, "grpc", "true"),
        (PrivilegedAccessManagerAsyncClient, transports.PrivilegedAccessManagerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerGrpcTransport, "grpc", "false"),
        (PrivilegedAccessManagerAsyncClient, transports.PrivilegedAccessManagerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerRestTransport, "rest", "true"),
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(PrivilegedAccessManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(PrivilegedAccessManagerClient))
@mock.patch.object(
...
def test_privileged_access_manager_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [PrivilegedAccessManagerClient, PrivilegedAccessManagerAsyncClient])
@mock.patch.object(PrivilegedAccessManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PrivilegedAccessManagerClient))
@mock.patch.object(PrivilegedAccessManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PrivilegedAccessManagerAsyncClient))
def test_privileged_access_manager_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_privileged_access_manager_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerGrpcTransport, "grpc", grpc_helpers),
        (PrivilegedAccessManagerAsyncClient, transports.PrivilegedAccessManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerRestTransport, "rest", None),
    ],
)
def test_privileged_access_manager_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_privileged_access_manager_client_client_options_from_dict():
    with mock.patch(
        ...
        client = PrivilegedAccessManagerClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_privileged_access_manager_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_check_onboarding_status(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.check_onboarding_status), "__call__") as call:
...
def test_check_onboarding_status_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.check_onboarding_status in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.check_onboarding_status] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_check_onboarding_status_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.check_onboarding_status in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.check_onboarding_status] = mock_rpc
...
@pytest.mark.asyncio
async def test_check_onboarding_status_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.CheckOnboardingStatusRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_check_onboarding_status_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.check_onboarding_status), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(privilegedaccessmanager.CheckOnboardingStatusResponse())
        await client.check_onboarding_status(request)
...
@pytest.mark.asyncio
async def test_list_entitlements_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.ListEntitlementsRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_entitlements_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_entitlements), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(privilegedaccessmanager.ListEntitlementsResponse())
        await client.list_entitlements(request)
...
async def test_list_entitlements_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_entitlements), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        assert all(isinstance(i, privilegedaccessmanager.Entitlement) for i in responses)
...
def test_search_entitlements_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.search_entitlements in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.search_entitlements] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_search_entitlements_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_entitlements in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_entitlements] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_entitlements_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.SearchEntitlementsRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_search_entitlements_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.search_entitlements), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            privilegedaccessmanager.SearchEntitlementsResponse(
                entitlements=[
...
async def test_search_entitlements_async_pages():
    ...
    with mock.patch.object(type(client.transport.search_entitlements), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.search_entitlements(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_get_entitlement_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.GetEntitlementRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_entitlement_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_entitlement), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(privilegedaccessmanager.Entitlement())
        await client.get_entitlement(request)
...
@pytest.mark.asyncio
async def test_create_entitlement_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.CreateEntitlementRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_entitlement_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_entitlement in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_entitlement] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_entitlement_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_entitlement in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_entitlement] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_entitlement_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.DeleteEntitlementRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_entitlement_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_entitlement in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_entitlement] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_entitlement_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_entitlement in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_entitlement] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_entitlement_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.UpdateEntitlementRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_grants_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_grants in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_grants] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_grants_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.ListGrantsRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_grants_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_grants), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            privilegedaccessmanager.ListGrantsResponse(
                grants=[
...
async def test_list_grants_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_grants), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_grants(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_search_grants_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_grants in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_grants] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_grants_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.SearchGrantsRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_search_grants_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.search_grants), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(privilegedaccessmanager.SearchGrantsResponse())
        await client.search_grants(request)
...
async def test_search_grants_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.search_grants), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            privilegedaccessmanager.SearchGrantsResponse(
                grants=[
...
async def test_search_grants_async_pages():
    ...
    with mock.patch.object(type(client.transport.search_grants), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.search_grants(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_get_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_grant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_grant] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_grant_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.GetGrantRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_grant_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_grant), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(privilegedaccessmanager.Grant())
        await client.get_grant(request)
...
@pytest.mark.asyncio
async def test_create_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_grant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_grant] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_grant_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.CreateGrantRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_approve_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.approve_grant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.approve_grant] = mock_rpc
...
@pytest.mark.asyncio
async def test_approve_grant_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.ApproveGrantRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_deny_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.deny_grant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.deny_grant] = mock_rpc
...
@pytest.mark.asyncio
async def test_deny_grant_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.DenyGrantRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_revoke_grant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PrivilegedAccessManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.revoke_grant in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.revoke_grant] = mock_rpc
...
@pytest.mark.asyncio
async def test_revoke_grant_async(transport: str = "grpc_asyncio", request_type=privilegedaccessmanager.RevokeGrantRequest):
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_check_onboarding_status_rest_required_fields(request_type=privilegedaccessmanager.CheckOnboardingStatusRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).check_onboarding_status._get_unset_required_fields(
        jsonified_request
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = privilegedaccessmanager.CheckOnboardingStatusResponse.pb(return_value)
...
def test_check_onboarding_status_rest_unset_required_fields():
    transport = transports.PrivilegedAccessManagerRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_entitlements_rest_required_fields(request_type=privilegedaccessmanager.ListEntitlementsRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_entitlements._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_entitlements_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/entitlements" % client.transport._host, args[1])
...
def test_list_entitlements_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(privilegedaccessmanager.ListEntitlementsResponse.to_json(x) for x in response)
...
def test_search_entitlements_rest_required_fields(request_type=privilegedaccessmanager.SearchEntitlementsRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_entitlements._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = privilegedaccessmanager.SearchEntitlementsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_search_entitlements_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(privilegedaccessmanager.SearchEntitlementsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_entitlement_rest_required_fields(request_type=privilegedaccessmanager.GetEntitlementRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_entitlement._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_entitlement_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/entitlements/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/entitlements/*}" % client.transport._host, args[1])
...
def test_create_entitlement_rest_required_fields(request_type=privilegedaccessmanager.CreateEntitlementRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_entitlement._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_entitlement_rest_required_fields(request_type=privilegedaccessmanager.DeleteEntitlementRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_entitlement._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_entitlement_rest_required_fields(request_type=privilegedaccessmanager.UpdateEntitlementRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_entitlement._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_entitlement_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"entitlement": {"name": "projects/sample1/locations/sample2/entitlements/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{entitlement.name=projects/*/locations/*/entitlements/*}" % client.transport._host, args[1])
...
def test_list_grants_rest_required_fields(request_type=privilegedaccessmanager.ListGrantsRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_grants._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_grants_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "projects/sample1/locations/sample2/entitlements/sample3"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/entitlements/*}/grants" % client.transport._host, args[1])
...
def test_list_grants_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(privilegedaccessmanager.ListGrantsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_search_grants_rest_required_fields(request_type=privilegedaccessmanager.SearchGrantsRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_grants._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_search_grants_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(privilegedaccessmanager.SearchGrantsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_grant_rest_required_fields(request_type=privilegedaccessmanager.GetGrantRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_grant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_grant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/entitlements/sample3/grants/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/entitlements/*/grants/*}" % client.transport._host, args[1])
...
def test_create_grant_rest_required_fields(request_type=privilegedaccessmanager.CreateGrantRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_grant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_approve_grant_rest_required_fields(request_type=privilegedaccessmanager.ApproveGrantRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).approve_grant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_deny_grant_rest_required_fields(request_type=privilegedaccessmanager.DenyGrantRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).deny_grant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_revoke_grant_rest_required_fields(request_type=privilegedaccessmanager.RevokeGrantRequest):
    transport_class = transports.PrivilegedAccessManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).revoke_grant._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = PrivilegedAccessManagerClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = PrivilegedAccessManagerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
    assert client is not None


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_onboarding_status_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.check_onboarding_status), "__call__") as call:
        call.return_value = privilegedaccessmanager.CheckOnboardingStatusResponse()
        client.check_onboarding_status(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_entitlements_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.search_entitlements), "__call__") as call:
        call.return_value = privilegedaccessmanager.SearchEntitlementsResponse()
        client.search_entitlements(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_entitlement_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_entitlement), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_entitlement(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_entitlement_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_entitlement), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_entitlement(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_grants_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_grants), "__call__") as call:
        call.return_value = privilegedaccessmanager.ListGrantsResponse()
        client.list_grants(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_grants_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.search_grants), "__call__") as call:
        call.return_value = privilegedaccessmanager.SearchGrantsResponse()
        client.search_grants(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_grant_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_grant_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_grant), "__call__") as call:
        call.return_value = privilegedaccessmanager.Grant()
        client.create_grant(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_approve_grant_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.approve_grant), "__call__") as call:
        call.return_value = privilegedaccessmanager.Grant()
        client.approve_grant(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_deny_grant_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.deny_grant), "__call__") as call:
        call.return_value = privilegedaccessmanager.Grant()
        client.deny_grant(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_revoke_grant_empty_call_grpc():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.revoke_grant), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.revoke_grant(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = PrivilegedAccessManagerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_check_onboarding_status_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.check_onboarding_status), "__call__") as call:
        ...
        await client.check_onboarding_status(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_entitlements_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.search_entitlements), "__call__") as call:
        ...
        await client.search_entitlements(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_entitlement_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_entitlement), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_entitlement(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_entitlement_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_entitlement), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_entitlement(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_grants_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_grants), "__call__") as call:
        ...
        await client.list_grants(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_grants_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.search_grants), "__call__") as call:
        ...
        await client.search_grants(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_grant_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_grant), "__call__") as call:
        ...
        await client.get_grant(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_grant_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_grant), "__call__") as call:
        ...
        await client.create_grant(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_approve_grant_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.approve_grant), "__call__") as call:
        ...
        await client.approve_grant(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_deny_grant_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.deny_grant), "__call__") as call:
        ...
        await client.deny_grant(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_revoke_grant_empty_call_grpc_asyncio():
    client = PrivilegedAccessManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.revoke_grant), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.revoke_grant(request=None)
...
def test_transport_kind_rest():
    transport = PrivilegedAccessManagerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_check_onboarding_status_rest_bad_request(request_type=privilegedaccessmanager.CheckOnboardingStatusRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_check_onboarding_status_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_check_onboarding_status_rest_interceptors(null_interceptor):
    transport = transports.PrivilegedAccessManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.PrivilegedAccessManagerRestInterceptor(),
    )
    client = PrivilegedAccessManagerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_check_onboarding_status") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_check_onboarding_status_with_metadata"
        ...
        pb_message = privilegedaccessmanager.CheckOnboardingStatusRequest.pb(privilegedaccessmanager.CheckOnboardingStatusRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.CheckOnboardingStatusResponse.to_json(privilegedaccessmanager.CheckOnboardingStatusResponse())
        ...
        post_with_metadata.return_value = privilegedaccessmanager.CheckOnboardingStatusResponse(), metadata
...
def test_list_entitlements_rest_bad_request(request_type=privilegedaccessmanager.ListEntitlementsRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_entitlements_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_list_entitlements") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_list_entitlements_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.ListEntitlementsRequest.pb(privilegedaccessmanager.ListEntitlementsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.ListEntitlementsResponse.to_json(privilegedaccessmanager.ListEntitlementsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = privilegedaccessmanager.ListEntitlementsResponse(), metadata
...
def test_search_entitlements_rest_bad_request(request_type=privilegedaccessmanager.SearchEntitlementsRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_search_entitlements_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_search_entitlements_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_search_entitlements") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_search_entitlements_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.SearchEntitlementsRequest.pb(privilegedaccessmanager.SearchEntitlementsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.SearchEntitlementsResponse.to_json(privilegedaccessmanager.SearchEntitlementsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = privilegedaccessmanager.SearchEntitlementsResponse(), metadata
...
def test_get_entitlement_rest_bad_request(request_type=privilegedaccessmanager.GetEntitlementRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_entitlement_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_get_entitlement") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_get_entitlement_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.GetEntitlementRequest.pb(privilegedaccessmanager.GetEntitlementRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.Entitlement.to_json(privilegedaccessmanager.Entitlement())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = privilegedaccessmanager.Entitlement(), metadata
...
def test_create_entitlement_rest_bad_request(request_type=privilegedaccessmanager.CreateEntitlementRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_entitlement_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["entitlement"] = {
                ...
                "steps": [
                    {
                        ...
                        "approver_email_recipients": ["approver_email_recipients_value1", "approver_email_recipients_value2"],
                    }
                ],
            }
        },
        "privileged_access": {
            "gcp_iam_access": {
                ...
                "role_bindings": [{"role": "role_value", "condition_expression": "condition_expression_value"}],
            }
        },
        ...
        "additional_notification_targets": {
            "admin_email_recipients": ["admin_email_recipients_value1", "admin_email_recipients_value2"],
            "requester_email_recipients": ["requester_email_recipients_value1", "requester_email_recipients_value2"],
        },
        "etag": "etag_value",
    }
    ...
    test_field = privilegedaccessmanager.CreateEntitlementRequest.meta.fields["entitlement"]
...
def test_create_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PrivilegedAccessManagerRestInterceptor, "post_create_entitlement_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.CreateEntitlementRequest.pb(privilegedaccessmanager.CreateEntitlementRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_entitlement_rest_bad_request(request_type=privilegedaccessmanager.DeleteEntitlementRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/entitlements/sample3"}
    request = request_type(**request_init)
...
def test_delete_entitlement_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PrivilegedAccessManagerRestInterceptor, "post_delete_entitlement_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.DeleteEntitlementRequest.pb(privilegedaccessmanager.DeleteEntitlementRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_entitlement_rest_bad_request(request_type=privilegedaccessmanager.UpdateEntitlementRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"entitlement": {"name": "projects/sample1/locations/sample2/entitlements/sample3"}}
    request = request_type(**request_init)
...
def test_update_entitlement_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = privilegedaccessmanager.UpdateEntitlementRequest.meta.fields["entitlement"]
...
def test_update_entitlement_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PrivilegedAccessManagerRestInterceptor, "post_update_entitlement_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.UpdateEntitlementRequest.pb(privilegedaccessmanager.UpdateEntitlementRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_grants_rest_bad_request(request_type=privilegedaccessmanager.ListGrantsRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_list_grants_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_grants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_list_grants") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_list_grants_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.ListGrantsRequest.pb(privilegedaccessmanager.ListGrantsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.ListGrantsResponse.to_json(privilegedaccessmanager.ListGrantsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = privilegedaccessmanager.ListGrantsResponse(), metadata
...
def test_search_grants_rest_bad_request(request_type=privilegedaccessmanager.SearchGrantsRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/entitlements/sample3"}
    request = request_type(**request_init)
...
def test_search_grants_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_search_grants_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_search_grants") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_search_grants_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.SearchGrantsRequest.pb(privilegedaccessmanager.SearchGrantsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.SearchGrantsResponse.to_json(privilegedaccessmanager.SearchGrantsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = privilegedaccessmanager.SearchGrantsResponse(), metadata
...
def test_get_grant_rest_bad_request(request_type=privilegedaccessmanager.GetGrantRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/entitlements/sample3/grants/sample4"}
    request = request_type(**request_init)
...
def test_get_grant_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_get_grant") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_get_grant_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.GetGrantRequest.pb(privilegedaccessmanager.GetGrantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = privilegedaccessmanager.Grant.to_json(privilegedaccessmanager.Grant())
        req.return_value.content = return_value
...
def test_create_grant_rest_bad_request(request_type=privilegedaccessmanager.CreateGrantRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/entitlements/sample3"}
    request = request_type(**request_init)
...
def test_create_grant_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["grant"] = {
        ...
        "justification": {"unstructured_justification": "unstructured_justification_value"},
        "state": 1,
        "timeline": {
            "events": [
                {
        ...
        "additional_email_recipients": ["additional_email_recipients_value1", "additional_email_recipients_value2"],
        "externally_modified": True,
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
...
def test_create_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_create_grant") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_create_grant_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.CreateGrantRequest.pb(privilegedaccessmanager.CreateGrantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_approve_grant_rest_bad_request(request_type=privilegedaccessmanager.ApproveGrantRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/entitlements/sample3/grants/sample4"}
    request = request_type(**request_init)
...
def test_approve_grant_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_approve_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_approve_grant") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_approve_grant_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.ApproveGrantRequest.pb(privilegedaccessmanager.ApproveGrantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_deny_grant_rest_bad_request(request_type=privilegedaccessmanager.DenyGrantRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/entitlements/sample3/grants/sample4"}
    request = request_type(**request_init)
...
def test_deny_grant_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_deny_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.PrivilegedAccessManagerRestInterceptor, "post_deny_grant") as post, mock.patch.object(
        transports.PrivilegedAccessManagerRestInterceptor, "post_deny_grant_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.DenyGrantRequest.pb(privilegedaccessmanager.DenyGrantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_revoke_grant_rest_bad_request(request_type=privilegedaccessmanager.RevokeGrantRequest):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/entitlements/sample3/grants/sample4"}
    request = request_type(**request_init)
...
def test_revoke_grant_rest_call_success(request_type):
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_revoke_grant_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.PrivilegedAccessManagerRestInterceptor, "post_revoke_grant_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = privilegedaccessmanager.RevokeGrantRequest.pb(privilegedaccessmanager.RevokeGrantRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_onboarding_status_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_entitlements_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_entitlement_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_entitlement_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_entitlement_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_entitlement_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_grants_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_grants_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_grant_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_grant_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_approve_grant_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_deny_grant_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_revoke_grant_empty_call_rest():
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.PrivilegedAccessManagerGrpcTransport, grpc_helpers), (transports.PrivilegedAccessManagerGrpcAsyncIOTransport, grpc_helpers_async)],
)
def test_privileged_access_manager_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.PrivilegedAccessManagerGrpcTransport, transports.PrivilegedAccessManagerGrpcAsyncIOTransport])
def test_privileged_access_manager_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_privileged_access_manager_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.PrivilegedAccessManagerRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_privileged_access_manager_host_no_port(transport_name):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="privilegedaccessmanager.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "privilegedaccessmanager.googleapis.com:443"
...
def test_privileged_access_manager_host_with_port(transport_name):
    client = PrivilegedAccessManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="privilegedaccessmanager.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.PrivilegedAccessManagerGrpcTransport, transports.PrivilegedAccessManagerGrpcAsyncIOTransport])
def test_privileged_access_manager_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_entitlement_path():
    ...
    location = "clam"
    entitlement = "whelk"
    expected = "projects/{project}/locations/{location}/entitlements/{entitlement}".format(
        project=project,
        location=location,
        entitlement=entitlement,
    )
    actual = PrivilegedAccessManagerClient.entitlement_path(project, location, entitlement)
...
def test_grant_path():
    ...
    actual = PrivilegedAccessManagerClient.grant_path(project, location, entitlement, grant)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.PrivilegedAccessManagerTransport, "_prep_wrapped_messages") as prep:
        client = PrivilegedAccessManagerClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_location_field_headers():
    client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = PrivilegedAccessManagerAsyncClient(credentials=async_anonymous_credentials())
...
def test_client_ctx():
    ...
    for transport in transports:
        client = PrivilegedAccessManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        (PrivilegedAccessManagerClient, transports.PrivilegedAccessManagerGrpcTransport),
        (PrivilegedAccessManagerAsyncClient, transports.PrivilegedAccessManagerGrpcAsyncIOTransport),
    ],
)

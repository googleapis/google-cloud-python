...
class PrivilegedAccessManagerGrpcAsyncIOTransport(PrivilegedAccessManagerTransport):
    ...
    def check_onboarding_status(
        ...
        Returns:
            Callable[[~.CheckOnboardingStatusRequest],
                    Awaitable[~.CheckOnboardingStatusResponse]]:
    ...
    def search_entitlements(
        ...
        Returns:
            Callable[[~.SearchEntitlementsRequest],
                    Awaitable[~.SearchEntitlementsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def search_grants(
        ...
        Returns:
            Callable[[~.SearchGrantsRequest],
                    Awaitable[~.SearchGrantsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.check_onboarding_status: gapic_v1.method_async.wrap_method(
            ...
            self.search_entitlements: gapic_v1.method_async.wrap_method(
            ...
            self.delete_entitlement: gapic_v1.method_async.wrap_method(
                self.delete_entitlement,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_entitlement: gapic_v1.method_async.wrap_method(
                self.update_entitlement,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_grants: gapic_v1.method_async.wrap_method(
                self.list_grants,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_grants: gapic_v1.method_async.wrap_method(
                self.search_grants,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_grant: gapic_v1.method_async.wrap_method(
                self.get_grant,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_grant: gapic_v1.method_async.wrap_method(
                self.create_grant,
                default_timeout=None,
                client_info=client_info,
            ),
            self.approve_grant: gapic_v1.method_async.wrap_method(
                self.approve_grant,
                default_timeout=None,
                client_info=client_info,
            ),
            self.deny_grant: gapic_v1.method_async.wrap_method(
                self.deny_grant,
                default_timeout=None,
                client_info=client_info,
            ),
            self.revoke_grant: gapic_v1.method_async.wrap_method(
                self.revoke_grant,
                default_timeout=None,
                client_info=client_info,
            ),

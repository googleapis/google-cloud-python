...
class PrivilegedAccessManagerClient(metaclass=PrivilegedAccessManagerClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PrivilegedAccessManagerClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or PrivilegedAccessManagerClient._get_api_endpoint(

...
class PrivilegedAccessManagerClient(metaclass=PrivilegedAccessManagerClientMeta):
    ...
    def grant_path(
        ...
        return "projects/{project}/locations/{location}/entitlements/{entitlement}/grants/{grant}".format(
            project=project,
            location=location,
            entitlement=entitlement,
            grant=grant,
    ...
    def parse_grant_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/entitlements/(?P<entitlement>.+?)/grants/(?P<grant>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                PrivilegedAccessManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = (
            self._api_endpoint
            or PrivilegedAccessManagerClient._get_api_endpoint(

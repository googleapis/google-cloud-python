...
# [START bigquerydatapolicy_v2beta1_generated_DataPolicyService_GetDataPolicy_sync]
...
def sample_get_data_policy():
    ...
    request = bigquery_datapolicies_v2beta1.GetDataPolicyRequest(
        name="name_value",
    )
...
# [END bigquerydatapolicy_v2beta1_generated_DataPolicyService_GetDataPolicy_sync]

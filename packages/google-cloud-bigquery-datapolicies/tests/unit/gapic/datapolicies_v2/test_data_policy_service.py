...
from google.cloud.bigquery.datapolicies_v2.services.data_policy_service import (
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery.datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_data_policy_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery.datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport.__init__"
    ) as Transport:
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigquery.datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

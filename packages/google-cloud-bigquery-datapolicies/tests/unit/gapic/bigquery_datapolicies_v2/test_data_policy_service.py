...
def test_create_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/dataPolicies" % client.transport._host, args[1])
...
def test_add_grantees_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{data_policy=projects/*/locations/*/dataPolicies/*}:addGrantees" % client.transport._host, args[1])
...
def test_remove_grantees_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{data_policy=projects/*/locations/*/dataPolicies/*}:removeGrantees" % client.transport._host, args[1])
...
def test_update_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{data_policy.name=projects/*/locations/*/dataPolicies/*}" % client.transport._host, args[1])
...
def test_delete_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/dataPolicies/*}" % client.transport._host, args[1])
...
def test_data_policy_service_base_transport():
    ...
    with mock.patch("google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport.__init__") as Transport:

...
from google.cloud.bigquery_datapolicies_v2.services.data_policy_service import (
...
def test_data_policy_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_data_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_data_policy] = (
            mock_rpc
        )
        request = {}
...
def test_update_data_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_data_policy] = (
            mock_rpc
        )
        request = {}
...
def test_delete_data_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_data_policy] = (
            mock_rpc
        )
        request = {}
...
def test_list_data_policies_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_data_policies] = (
            mock_rpc
        )
        request = {}
...
def test_create_data_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateDataPolicy,
...
def test_create_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/locations/*}/dataPolicies"
...
def test_add_grantees_rest_required_fields(request_type=datapolicy.AddGranteesRequest):
    ...
    default_values = getattr(
        transport_class._BaseAddGrantees,
...
def test_add_grantees_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{data_policy=projects/*/locations/*/dataPolicies/*}:addGrantees"
            % client.transport._host,
            args[1],
        )
...
def test_remove_grantees_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRemoveGrantees,
...
def test_remove_grantees_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{data_policy=projects/*/locations/*/dataPolicies/*}:removeGrantees"
            % client.transport._host,
            args[1],
        )
...
def test_update_data_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateDataPolicy,
...
def test_update_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{data_policy.name=projects/*/locations/*/dataPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_data_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteDataPolicy,
...
def test_delete_data_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=projects/*/locations/*/dataPolicies/*}"
            % client.transport._host,
            args[1],
        )
...
def test_get_data_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetDataPolicy,
...
def test_list_data_policies_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListDataPolicies,
...
def test_update_data_policy_rest_call_success(request_type):
    ...
    request_init["data_policy"] = {
        "data_masking_policy": {"predefined_expression": 1, "routine": "routine_value"},
        "name": "projects/sample1/locations/sample2/dataPolicies/sample3",
        "data_policy_id": "data_policy_id_value",
        "etag": "etag_value",
        "data_policy_type": 1,
...
def test_data_policy_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport.__init__"
    ) as Transport:
...
def test_data_policy_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.bigquery_datapolicies_v2.services.data_policy_service.transports.DataPolicyServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_routine_path():
    ...
    actual = DataPolicyServiceClient.routine_path(project, dataset, routine)
    assert expected == actual
...
def test_parse_routine_path():
    ...
    path = DataPolicyServiceClient.routine_path(**expected)

    # Check that the path construction is reversible.
    actual = DataPolicyServiceClient.parse_routine_path(path)
    assert expected == actual

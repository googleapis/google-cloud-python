...
__protobuf__ = proto.module(
    package="google.cloud.bigquery.datapolicies.v2beta1",
    manifest={
...
class ListDataPoliciesResponse(proto.Message):
    ...
    Attributes:
        data_policies (MutableSequence[google.cloud.bigquery.datapolicies_v2beta1.types.DataPolicy]):
...
class DataPolicy(proto.Message):
    ...
    Attributes:
        data_masking_policy (google.cloud.bigquery.datapolicies_v2beta1.types.DataMaskingPolicy):
        ...
        data_policy_type (google.cloud.bigquery.datapolicies_v2beta1.types.DataPolicy.DataPolicyType):
        ...
        grantees (MutableSequence[str]):
            ...
            populated.
        version (google.cloud.bigquery.datapolicies_v2beta1.types.DataPolicy.Version):
...
class DataMaskingPolicy(proto.Message):
    ...
    Attributes:
        predefined_expression (google.cloud.bigquery.datapolicies_v2beta1.types.DataMaskingPolicy.PredefinedExpression):

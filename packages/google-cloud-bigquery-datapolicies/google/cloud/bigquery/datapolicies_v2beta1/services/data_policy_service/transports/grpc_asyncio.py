...
from google.cloud.bigquery.datapolicies_v2beta1.types import datapolicy
...
class DataPolicyServiceGrpcAsyncIOTransport(DataPolicyServiceTransport):
    ...
    def add_grantees(
        self,
    ) -> Callable[[datapolicy.AddGranteesRequest], Awaitable[datapolicy.DataPolicy]]:
    ...
    def remove_grantees(
        self,
    ) -> Callable[[datapolicy.RemoveGranteesRequest], Awaitable[datapolicy.DataPolicy]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.add_grantees: self._wrap_method(
                self.add_grantees,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=60.0,
            ...
            self.remove_grantees: self._wrap_method(

...
class DataPolicyServiceTransport(abc.ABC):
    ...
    @property
    def create_data_policy(self) -> Callable[[datapolicy.CreateDataPolicyRequest], Union[datapolicy.DataPolicy, Awaitable[datapolicy.DataPolicy]]]:
        raise NotImplementedError()

    @property
    def update_data_policy(self) -> Callable[[datapolicy.UpdateDataPolicyRequest], Union[datapolicy.DataPolicy, Awaitable[datapolicy.DataPolicy]]]:
        raise NotImplementedError()

    @property
    def delete_data_policy(self) -> Callable[[datapolicy.DeleteDataPolicyRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def get_data_policy(self) -> Callable[[datapolicy.GetDataPolicyRequest], Union[datapolicy.DataPolicy, Awaitable[datapolicy.DataPolicy]]]:
        raise NotImplementedError()

    @property
    def list_data_policies(
        self,
    ) -> Callable[[datapolicy.ListDataPoliciesRequest], Union[datapolicy.ListDataPoliciesResponse, Awaitable[datapolicy.ListDataPoliciesResponse]]]:
        raise NotImplementedError()

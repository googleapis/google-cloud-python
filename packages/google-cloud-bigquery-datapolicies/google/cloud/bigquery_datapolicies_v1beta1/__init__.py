...
from .services.data_policy_service import DataPolicyServiceAsyncClient, DataPolicyServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.bigquery_datapolicies_v1beta1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.bigquery_datapolicies_v1beta1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.bigquery_datapolicies_v1beta1"

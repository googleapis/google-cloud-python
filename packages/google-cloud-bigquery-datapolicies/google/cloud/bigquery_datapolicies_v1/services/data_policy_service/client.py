...
class DataPolicyServiceClient(metaclass=DataPolicyServiceClientMeta):
    ...
    def data_policy_path(
        ...
        return "projects/{project}/locations/{location}/dataPolicies/{data_policy}".format(
            project=project,
            location=location,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or DataPolicyServiceClient._get_api_endpoint(

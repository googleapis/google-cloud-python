...
class DataPolicyServiceClient(metaclass=DataPolicyServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery.datapolicies_v2.DataPolicyServiceClient`.",
                    extra={
    ...
    def create_data_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.CreateDataPolicyRequest, dict]):
    ...
    def add_grantees(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.AddGranteesRequest, dict]):
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("data_policy", request.data_policy),)),)
    ...
    def remove_grantees(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.RemoveGranteesRequest, dict]):
                The request object. Request message for the
    ...
    def update_data_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.UpdateDataPolicyRequest, dict]):
                The request object. Request message for the
    ...
    def delete_data_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.DeleteDataPolicyRequest, dict]):
                The request object. Request message for the
    ...
    def get_data_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.GetDataPolicyRequest, dict]):
    ...
    def list_data_policies(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.bigquery_datapolicies_v2.types.ListDataPoliciesRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.bigquery_datapolicies_v2.services.data_policy_service.pagers.ListDataPoliciesPager:

...
__lazy_modules__ = {
    "google.shopping.merchant_issueresolution_v1beta.services.aggregate_product_statuses_service",
    "google.shopping.merchant_issueresolution_v1beta.services.issue_resolution_service",
    "google.shopping.merchant_issueresolution_v1beta.types.aggregateproductstatuses",
    "google.shopping.merchant_issueresolution_v1beta.types.issueresolution",
}
...
api_core.check_python_version("google.shopping.merchant_issueresolution_v1beta")
api_core.check_dependency_versions("google.shopping.merchant_issueresolution_v1beta")

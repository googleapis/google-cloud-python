...
from .services.aggregate_product_statuses_service import AggregateProductStatusesServiceAsyncClient, AggregateProductStatusesServiceClient
from .services.issue_resolution_service import IssueResolutionServiceAsyncClient, IssueResolutionServiceClient
from .types.aggregateproductstatuses import AggregateProductStatus, ListAggregateProductStatusesRequest, ListAggregateProductStatusesResponse
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.shopping.merchant_issueresolution_v1beta"

...
class RenderAccountIssuesResponse(proto.Message):
    ...
    Attributes:
        rendered_issues (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.RenderedIssue]):
...
class RenderAccountIssuesRequest(proto.Message):
    ...
    Attributes:
        ...
        payload (google.shopping.merchant_issueresolution_v1beta.types.RenderIssuesRequestPayload):
...
class RenderIssuesRequestPayload(proto.Message):
    ...
    Attributes:
        content_option (google.shopping.merchant_issueresolution_v1beta.types.ContentOption):
        ...
        user_input_action_option (google.shopping.merchant_issueresolution_v1beta.types.UserInputActionRenderingOption):
    ...
    Attributes:
        prerendered_content (str):
            ...
            - ``issue-detail`` - top level container for the detail of
              the issue
            - ``callout-banners`` - section of the ``issue-detail`` with
              callout banners
            ...
            - ``content-element`` - content element such as a list, link
              or paragraph, inside ``issue-content``
            ...
            - ``tooltip`` - used on paragraphs that should be rendered
              ...
              the ``tooltip-text`` section would be shown on a new line,
            ...
            - ``tooltip-icon`` - marks a section of the text within a
              ``tooltip``, that can be replaced with a tooltip icon, for
              example '?' or 'i'. By default, this section contains a
              ``br`` tag, that is separating the main text and the
            ...
            - ``tooltip-style-info`` - the tooltip adds additional
              ...
              icon.
            - ``content-moderation`` - marks the paragraph that explains
        ...
        prerendered_out_of_court_dispute_settlement (str):
            ...
            - ``ods-description``\ \* - intro text for the out-of-court
              dispute resolution. It may contain multiple segments and a
              link.
            ...
            - ``ods-param-value``\ \* - value of the ODS parameter. This
              value should be rendered in a way that it is easy for the
              user to identify and copy.
            - ``segment`` - section of the text, ``span`` inside
              paragraph
            - ``segment-attribute`` - section of the text that
              represents a product attribute, for example 'image_link'
        ...
        title (str):
            Title of the issue.
        impact (google.shopping.merchant_issueresolution_v1beta.types.Impact):
            ...
            and ``INFO``.
        actions (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.Action]):
...
class Impact(proto.Message):
    ...
    Attributes:
        ...
        severity (google.shopping.merchant_issueresolution_v1beta.types.Severity):
            The severity of the issue.
        breakdowns (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.Breakdown]):
...
class Breakdown(proto.Message):
    ...
    Attributes:
        regions (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.Breakdown.Region]):
...
class Action(proto.Message):
    ...
    Attributes:
        builtin_simple_action (google.shopping.merchant_issueresolution_v1beta.types.BuiltInSimpleAction):
        ...
        external_action (google.shopping.merchant_issueresolution_v1beta.types.ExternalAction):
            ...
            This field is a member of `oneof`_ ``action``.
        builtin_user_input_action (google.shopping.merchant_issueresolution_v1beta.types.BuiltInUserInputAction):
            Action implemented and performed in (your)
        ...
        reasons (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.Action.Reason]):
    ...
    class Reason(proto.Message):
        ...
        Attributes:
            ...
            action (google.shopping.merchant_issueresolution_v1beta.types.Action):
...
class BuiltInSimpleAction(proto.Message):
    ...
    Attributes:
        type_ (google.shopping.merchant_issueresolution_v1beta.types.BuiltInSimpleAction.BuiltInSimpleActionType):
        ...
        additional_content (google.shopping.merchant_issueresolution_v1beta.types.BuiltInSimpleAction.AdditionalContent):
...
class BuiltInUserInputAction(proto.Message):
    ...
    Attributes:
        ...
        flows (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.ActionFlow]):
...
class ActionFlow(proto.Message):
    ...
    Attributes:
        ...
        inputs (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.InputField]):
            A list of input fields.
        dialog_title (str):
            Title of the request dialog. For example:
            "Before you request a review".
        dialog_message (google.shopping.merchant_issueresolution_v1beta.types.TextWithTooltip):
        ...
        dialog_callout (google.shopping.merchant_issueresolution_v1beta.types.Callout):
...
class InputField(proto.Message):
    ...
    Attributes:
        ...
        label (google.shopping.merchant_issueresolution_v1beta.types.TextWithTooltip):
    ...
    class TextInput(proto.Message):
        ...
        Attributes:
            type_ (google.shopping.merchant_issueresolution_v1beta.types.InputField.TextInput.TextInputType):
                Type of the text input
            additional_info (google.shopping.merchant_issueresolution_v1beta.types.TextWithTooltip):
    ...
    class ChoiceInput(proto.Message):
        ...
        Attributes:
            options (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.InputField.ChoiceInput.ChoiceInputOption]):
        ...
        class ChoiceInputOption(proto.Message):
            ...
            Attributes:
                ...
                label (google.shopping.merchant_issueresolution_v1beta.types.TextWithTooltip):
                    ...
                    tooltip.
                additional_input (google.shopping.merchant_issueresolution_v1beta.types.InputField):
...
class TextWithTooltip(proto.Message):
    ...
    Attributes:
        ...
        tooltip_icon_style (google.shopping.merchant_issueresolution_v1beta.types.TextWithTooltip.TooltipIconStyle):
...
class Callout(proto.Message):
    ...
    Attributes:
        style_hint (google.shopping.merchant_issueresolution_v1beta.types.Callout.CalloutStyleHint):
        ...
        full_message (google.shopping.merchant_issueresolution_v1beta.types.TextWithTooltip):
...
class ExternalAction(proto.Message):
    ...
    Attributes:
        type_ (google.shopping.merchant_issueresolution_v1beta.types.ExternalAction.ExternalActionType):
...
class TriggerActionRequest(proto.Message):
    ...
    Attributes:
        ...
        payload (google.shopping.merchant_issueresolution_v1beta.types.TriggerActionPayload):
...
class TriggerActionPayload(proto.Message):
    ...
    Attributes:
        ...
        action_input (google.shopping.merchant_issueresolution_v1beta.types.ActionInput):
...
class ActionInput(proto.Message):
    ...
    Attributes:
        action_flow_id (str):
            Required.
            [Id][google.shopping.merchant.issueresolution.v1beta.ActionFlow.id]
            of the selected action flow.
        input_values (MutableSequence[google.shopping.merchant_issueresolution_v1beta.types.InputValue]):
...
class InputValue(proto.Message):
    ...
    Attributes:
        text_input_value (google.shopping.merchant_issueresolution_v1beta.types.InputValue.TextInputValue):
            Value for [text
            input][google.shopping.merchant.issueresolution.v1beta.InputField.TextInput]
            field.

            This field is a member of `oneof`_ ``value``.
        choice_input_value (google.shopping.merchant_issueresolution_v1beta.types.InputValue.ChoiceInputValue):
            Value for [choice
            input][google.shopping.merchant.issueresolution.v1beta.InputField.ChoiceInput]
            field.

            This field is a member of `oneof`_ ``value``.
        checkbox_input_value (google.shopping.merchant_issueresolution_v1beta.types.InputValue.CheckboxInputValue):
            Value for [checkbox
        ...
        input_field_id (str):
            Required.
            [Id][google.shopping.merchant.issueresolution.v1beta.InputField.id]

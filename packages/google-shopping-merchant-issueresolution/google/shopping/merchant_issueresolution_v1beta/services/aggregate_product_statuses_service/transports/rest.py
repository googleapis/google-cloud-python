...
class AggregateProductStatusesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_list_aggregate_product_statuses(
        self, response: aggregateproductstatuses.ListAggregateProductStatusesResponse
...
class AggregateProductStatusesServiceRestTransport(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[AggregateProductStatusesServiceRestInterceptor]): Interceptor used
    ...
    def list_aggregate_product_statuses(
        ...
        return self._ListAggregateProductStatuses(
...
__all__ = ("AggregateProductStatusesServiceRestTransport",)

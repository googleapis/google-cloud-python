...
from .transports.grpc import IssueResolutionServiceGrpcTransport
from .transports.grpc_asyncio import IssueResolutionServiceGrpcAsyncIOTransport
from .transports.rest import IssueResolutionServiceRestTransport


class IssueResolutionServiceClientMeta(type):
    """Metaclass for the IssueResolutionService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[IssueResolutionServiceTransport]]
    _transport_registry["grpc"] = IssueResolutionServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = IssueResolutionServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = IssueResolutionServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[IssueResolutionServiceTransport]:
...
class IssueResolutionServiceClient(metaclass=IssueResolutionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IssueResolutionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> IssueResolutionServiceTransport:
        ...
        Returns:
            IssueResolutionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = IssueResolutionServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = IssueResolutionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = IssueResolutionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, IssueResolutionServiceTransport, Callable[..., IssueResolutionServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the issue resolution service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = IssueResolutionServiceClient._read_environment_variables()
        self._client_cert_source = IssueResolutionServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = IssueResolutionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, IssueResolutionServiceTransport)
        if transport_provided:
            # transport is a IssueResolutionServiceTransport instance.
            ...
            self._transport = cast(IssueResolutionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or IssueResolutionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[IssueResolutionServiceTransport], Callable[..., IssueResolutionServiceTransport]] = (
                IssueResolutionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., IssueResolutionServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.issueresolution_v1beta.IssueResolutionServiceClient`.",
                    extra={
    ...
    def render_account_issues(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_render_account_issues():
                # Create a client
        ...
        Args:
            request (Union[google.shopping.merchant_issueresolution_v1beta.types.RenderAccountIssuesRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.render_account_issues]
    ...
    def render_product_issues(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_render_product_issues():
                # Create a client
                client = merchant_issueresolution_v1beta.IssueResolutionServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_issueresolution_v1beta.types.RenderProductIssuesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.render_product_issues]
    ...
    def trigger_action(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_issueresolution_v1beta.types.TriggerActionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.trigger_action]
    ...
    def __enter__(self) -> "IssueResolutionServiceClient":
        return self
...
__all__ = ("IssueResolutionServiceClient",)

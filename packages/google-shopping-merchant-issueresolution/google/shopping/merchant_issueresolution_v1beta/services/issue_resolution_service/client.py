...
class IssueResolutionServiceClient(metaclass=IssueResolutionServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                IssueResolutionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = IssueResolutionServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or IssueResolutionServiceClient._get_api_endpoint(

...
api_core.check_python_version("google.shopping.merchant_issueresolution_v1")
api_core.check_dependency_versions("google.shopping.merchant_issueresolution_v1")

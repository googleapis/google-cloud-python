...
class AggregateProductStatusesServiceTransport(abc.ABC):
    """Abstract transport class for AggregateProductStatusesService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_aggregate_product_statuses: gapic_v1.method.wrap_method(
    ...
    def list_aggregate_product_statuses(
        ...
        Union[
            aggregateproductstatuses.ListAggregateProductStatusesResponse, Awaitable[aggregateproductstatuses.ListAggregateProductStatusesResponse]
        ],
    ]:
        raise NotImplementedError()

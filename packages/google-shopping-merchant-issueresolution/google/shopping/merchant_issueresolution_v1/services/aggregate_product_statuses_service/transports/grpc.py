...
class AggregateProductStatusesServiceGrpcTransport(AggregateProductStatusesServiceTransport):
    """gRPC backend transport for AggregateProductStatusesService.
...
__all__ = ("AggregateProductStatusesServiceGrpcTransport",)

...
class IssueResolutionServiceClient(metaclass=IssueResolutionServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.issueresolution_v1.IssueResolutionServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_render_account_issues():
                # Create a client
                client = merchant_issueresolution_v1.IssueResolutionServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_issueresolution_v1.types.RenderAccountIssuesRequest, dict]):
    ...
    def render_product_issues(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_issueresolution_v1.types.RenderProductIssuesRequest, dict]):
    ...
    def trigger_action(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_issueresolution_v1.types.TriggerActionRequest, dict]):

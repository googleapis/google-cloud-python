...
#
# Snippet for RenderProductIssues
...
async def sample_render_product_issues():
    # Create a client
    client = merchant_issueresolution_v1.IssueResolutionServiceAsyncClient()

    # Initialize request argument(s)
    request = merchant_issueresolution_v1.RenderProductIssuesRequest(
        name="name_value",
    )

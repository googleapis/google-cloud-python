...
from google.cloud.capacityplanner_v1beta.services.usage_service import UsageServiceAsyncClient, UsageServiceClient, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert UsageServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert UsageServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert UsageServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert UsageServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert UsageServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert UsageServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert UsageServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert UsageServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert UsageServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                UsageServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert UsageServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert UsageServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert UsageServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert UsageServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(UsageServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UsageServiceClient))
@mock.patch.object(UsageServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UsageServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = UsageServiceClient._DEFAULT_UNIVERSE
    default_endpoint = UsageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = UsageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert UsageServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert UsageServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == UsageServiceClient.DEFAULT_MTLS_ENDPOINT
    assert UsageServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert UsageServiceClient._get_api_endpoint(None, None, default_universe, "always") == UsageServiceClient.DEFAULT_MTLS_ENDPOINT
    assert UsageServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == UsageServiceClient.DEFAULT_MTLS_ENDPOINT
    assert UsageServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert UsageServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        UsageServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert UsageServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert UsageServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert UsageServiceClient._get_universe_domain(None, None) == UsageServiceClient._DEFAULT_UNIVERSE
...
def test_usage_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "capacityplanner.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://capacityplanner.googleapis.com"
        )
...
def test_usage_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (UsageServiceAsyncClient, transports.UsageServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (UsageServiceClient, transports.UsageServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(UsageServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UsageServiceClient))
@mock.patch.object(UsageServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(UsageServiceAsyncClient))
def test_usage_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (UsageServiceAsyncClient, transports.UsageServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (UsageServiceClient, transports.UsageServiceGrpcTransport, "grpc", "false"),
        (UsageServiceAsyncClient, transports.UsageServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_usage_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(UsageServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UsageServiceClient))
@mock.patch.object(UsageServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UsageServiceAsyncClient))
...
def test_usage_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (UsageServiceClient, transports.UsageServiceGrpcTransport, "grpc", grpc_helpers),
        (UsageServiceAsyncClient, transports.UsageServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (UsageServiceClient, transports.UsageServiceRestTransport, "rest", None),
    ],
)
def test_usage_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_usage_service_client_client_options_from_dict():
    with mock.patch("google.cloud.capacityplanner_v1beta.services.usage_service.transports.UsageServiceGrpcTransport.__init__") as grpc_transport:
...
def test_usage_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_query_usage_histories(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.query_usage_histories), "__call__") as call:
...
def test_query_usage_histories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.query_usage_histories in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.query_usage_histories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_query_usage_histories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.query_usage_histories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_usage_histories] = mock_rpc
...
@pytest.mark.asyncio
async def test_query_usage_histories_async(transport: str = "grpc_asyncio", request_type=usage_service.QueryUsageHistoriesRequest):
    client = UsageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.query_usage_histories), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(usage_service.QueryUsageHistoriesResponse())
...
@pytest.mark.asyncio
async def test_query_forecasts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UsageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.query_forecasts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_forecasts] = mock_rpc
...
@pytest.mark.asyncio
async def test_query_forecasts_async(transport: str = "grpc_asyncio", request_type=usage_service.QueryForecastsRequest):
    client = UsageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.query_forecasts), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(usage_service.QueryForecastsResponse())
...
def test_query_reservations(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.query_reservations), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_query_reservations_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.query_reservations in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.query_reservations] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_query_reservations_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UsageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.query_reservations in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_reservations] = mock_rpc
...
@pytest.mark.asyncio
async def test_query_reservations_async(transport: str = "grpc_asyncio", request_type=usage_service.QueryReservationsRequest):
    client = UsageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.query_reservations), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(usage_service.QueryReservationsResponse())
...
def test_export_usage_histories(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.export_usage_histories), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_export_usage_histories_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_usage_histories in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_usage_histories] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_usage_histories_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UsageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_usage_histories in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_usage_histories] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_usage_histories_async(transport: str = "grpc_asyncio", request_type=usage_service.ExportUsageHistoriesRequest):
    client = UsageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_export_forecasts_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_forecasts] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_forecasts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UsageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_forecasts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_forecasts] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_forecasts_async(transport: str = "grpc_asyncio", request_type=usage_service.ExportForecastsRequest):
    client = UsageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_export_reservations_usage(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.export_reservations_usage), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_export_reservations_usage_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_reservations_usage in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_reservations_usage] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_reservations_usage_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UsageServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_reservations_usage in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_reservations_usage] = mock_rpc
...
@pytest.mark.asyncio
async def test_export_reservations_usage_async(transport: str = "grpc_asyncio", request_type=usage_service.ExportReservationsUsageRequest):
    client = UsageServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_query_usage_histories_rest_required_fields(request_type=usage_service.QueryUsageHistoriesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_usage_histories._get_unset_required_fields(
        jsonified_request
    )
...
def test_query_usage_histories_rest_unset_required_fields():
    transport = transports.UsageServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_query_forecasts_rest_required_fields(request_type=usage_service.QueryForecastsRequest):
    transport_class = transports.UsageServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_forecasts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_reservations_rest_required_fields(request_type=usage_service.QueryReservationsRequest):
    transport_class = transports.UsageServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_reservations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_query_reservations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*}/reservations:query" % client.transport._host, args[1])
...
def test_export_usage_histories_rest_required_fields(request_type=usage_service.ExportUsageHistoriesRequest):
    transport_class = transports.UsageServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_usage_histories._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_export_forecasts_rest_required_fields(request_type=usage_service.ExportForecastsRequest):
    transport_class = transports.UsageServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_forecasts._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_reservations_usage_rest_required_fields(request_type=usage_service.ExportReservationsUsageRequest):
    transport_class = transports.UsageServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_reservations_usage._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = UsageServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = UsageServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = UsageServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = UsageServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = UsageServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_query_usage_histories_rest_bad_request(request_type=usage_service.QueryUsageHistoriesRequest):
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_query_usage_histories_rest_interceptors(null_interceptor):
    transport = transports.UsageServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.UsageServiceRestInterceptor(),
    )
    client = UsageServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_usage_histories") as post, mock.patch.object(
        transports.UsageServiceRestInterceptor, "post_query_usage_histories_with_metadata"
        ...
        pb_message = usage_service.QueryUsageHistoriesRequest.pb(usage_service.QueryUsageHistoriesRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = usage_service.QueryUsageHistoriesResponse.to_json(usage_service.QueryUsageHistoriesResponse())
        ...
        post_with_metadata.return_value = usage_service.QueryUsageHistoriesResponse(), metadata
...
def test_query_forecasts_rest_bad_request(request_type=usage_service.QueryForecastsRequest):
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_query_forecasts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_forecasts") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = usage_service.QueryForecastsRequest.pb(usage_service.QueryForecastsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = usage_service.QueryForecastsResponse.to_json(usage_service.QueryForecastsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = usage_service.QueryForecastsResponse(), metadata
...
def test_query_reservations_rest_bad_request(request_type=usage_service.QueryReservationsRequest):
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_query_reservations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UsageServiceRestInterceptor, "post_query_reservations") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = usage_service.QueryReservationsRequest.pb(usage_service.QueryReservationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = usage_service.QueryReservationsResponse.to_json(usage_service.QueryReservationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = usage_service.QueryReservationsResponse(), metadata
...
def test_export_usage_histories_rest_bad_request(request_type=usage_service.ExportUsageHistoriesRequest):
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_export_usage_histories_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.UsageServiceRestInterceptor, "post_export_usage_histories_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = usage_service.ExportUsageHistoriesRequest.pb(usage_service.ExportUsageHistoriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_export_forecasts_rest_bad_request(request_type=usage_service.ExportForecastsRequest):
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_export_forecasts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = usage_service.ExportForecastsRequest.pb(usage_service.ExportForecastsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_export_reservations_usage_rest_bad_request(request_type=usage_service.ExportReservationsUsageRequest):
    client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_export_reservations_usage_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.UsageServiceRestInterceptor, "post_export_reservations_usage_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = usage_service.ExportReservationsUsageRequest.pb(usage_service.ExportReservationsUsageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_usage_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.UsageServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_usage_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.capacityplanner_v1beta.services.usage_service.transports.UsageServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.UsageServiceGrpcTransport, grpc_helpers), (transports.UsageServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.UsageServiceGrpcTransport, transports.UsageServiceGrpcAsyncIOTransport])
...
def test_usage_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.UsageServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_usage_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "capacityplanner.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://capacityplanner.googleapis.com:8000"
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.UsageServiceTransport, "_prep_wrapped_messages") as prep:
        client = UsageServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = UsageServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
from .types.resource import ResourceAttribute, ResourceContainer, ResourceIdentifier, ResourceIdKey, ResourceValue, Unit, Value
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.capacityplanner_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.cloud.capacityplanner_v1beta")  # type: ignore
else:  # pragma: NO COVER

...
class capacityplannerCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=capacityplannerCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the capacityplanner client library.

Python Client for Google Apps Script Types
==========================================

|preview| |pypi| |versions|

`Google Apps Script Types`_: 
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-apps-script-type.svg
   :target: https://pypi.org/project/google-apps-script-type/
.. _Google Apps Script Types: https://developers.google.com/apps-script/
...
3. `Enable the Google Apps Script Types.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Google Apps Script Types.:  https://developers.google.com/apps-script/
...
-  Read the `Client Library Documentation`_ for Google Apps Script Types
   to see other available methods on the client.
-  Read the `Google Apps Script Types Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Google Apps Script Types Product documentation:  https://developers.google.com/apps-script/

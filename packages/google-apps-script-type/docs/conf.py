...
##
# google-apps-script-type documentation build configuration file
#
...
project = "google-apps-script-type"
copyright = "2025, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Apps Script Client Libraries for google-apps-script-type",
...
htmlhelp_basename = "google-apps-script-type-doc"
...
latex_documents = [
    (
        root_doc,
        "google-apps-script-type.tex",
        "google-apps-script-type Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-apps-script-type",
        "google-apps-script-type Library",
        "APIs",
    )
]

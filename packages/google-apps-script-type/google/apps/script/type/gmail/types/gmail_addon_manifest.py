...
class ComposeTrigger(proto.Message):
    ...
    Attributes:
        actions (MutableSequence[google.apps.script.type.extension_point_pb2.MenuItemExtensionPoint]):
    ...
    actions: MutableSequence[
        extension_point_pb2.MenuItemExtensionPoint
    ] = proto.RepeatedField(
        proto.MESSAGE,
        number=5,
        message=extension_point_pb2.MenuItemExtensionPoint,
    )

...
from google.ai.generativelanguage_v1beta2.services.model_service import (
...
def test_model_service_client_client_options_from_dict():
    with mock.patch(
        "google.ai.generativelanguage_v1beta2.services.model_service.transports.ModelServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta2/{name=models/*}" % client.transport._host, args[1]
        )
...
def test_list_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta2/models" % client.transport._host, args[1]
        )
...
def test_model_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1beta2.services.model_service.transports.ModelServiceTransport.__init__"
    ) as Transport:
...
def test_model_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.ai.generativelanguage_v1beta2.services.model_service.transports.ModelServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
from google.ai.generativelanguage_v1.services.generative_service import GenerativeServiceAsyncClient, GenerativeServiceClient, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert GenerativeServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert GenerativeServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                GenerativeServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        GenerativeServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        GenerativeServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == GenerativeServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
@pytest.mark.parametrize("client_class", [GenerativeServiceClient, GenerativeServiceAsyncClient])
...
def test_generative_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = GenerativeServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_stream_generate_content_rest_required_fields(request_type=generative_service.GenerateContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).stream_generate_content._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_embed_contents_rest_required_fields(request_type=generative_service.BatchEmbedContentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_embed_contents._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = GenerativeServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = GenerativeServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = GenerativeServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = GenerativeServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = GenerativeServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = GenerativeServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_generate_content_rest_bad_request(request_type=generative_service.GenerateContentRequest):
    client = GenerativeServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_generate_content_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_generate_content") as post, mock.patch.object(
        transports.GenerativeServiceRestInterceptor, "post_generate_content_with_metadata"
...
def test_stream_generate_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_stream_generate_content") as post, mock.patch.object(
        transports.GenerativeServiceRestInterceptor, "post_stream_generate_content_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_embed_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_embed_content") as post, mock.patch.object(
...
def test_batch_embed_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_batch_embed_contents") as post, mock.patch.object(
        transports.GenerativeServiceRestInterceptor, "post_batch_embed_contents_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_count_tokens_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_count_tokens") as post, mock.patch.object(
...
def test_generative_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.GenerativeServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.GenerativeServiceGrpcTransport, grpc_helpers), (transports.GenerativeServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_generative_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.GenerativeServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.GenerativeServiceGrpcTransport, transports.GenerativeServiceGrpcAsyncIOTransport])
def test_generative_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_ctx():
    ...
    for transport in transports:
        client = GenerativeServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
from google.ai.generativelanguage_v1alpha.services.cache_service import (
...
def test_cache_service_client_client_options_from_dict():
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/cachedContents" % client.transport._host, args[1]
        )
...
def test_get_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=cachedContents/*}" % client.transport._host, args[1]
        )
...
def test_update_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{cached_content.name=cachedContents/*}"
...
def test_cache_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceTransport.__init__"
    ) as Transport:
...
def test_cache_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.ai.generativelanguage_v1alpha.services.cache_service.transports.CacheServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

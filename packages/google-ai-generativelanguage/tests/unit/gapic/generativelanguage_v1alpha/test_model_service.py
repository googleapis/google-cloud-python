...
from google.ai.generativelanguage_v1alpha.services.model_service import (
...
def test_model_service_client_client_options_from_dict():
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.model_service.transports.ModelServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{name=models/*}" % client.transport._host, args[1]
        )
...
def test_list_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/models" % client.transport._host, args[1]
        )
...
def test_get_tuned_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=tunedModels/*}" % client.transport._host, args[1]
        )
...
def test_list_tuned_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/tunedModels" % client.transport._host, args[1]
        )
...
def test_update_tuned_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{tuned_model.name=tunedModels/*}" % client.transport._host,
            args[1],
        )
...
def test_model_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.model_service.transports.ModelServiceTransport.__init__"
    ) as Transport:
...
def test_model_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.ai.generativelanguage_v1alpha.services.model_service.transports.ModelServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

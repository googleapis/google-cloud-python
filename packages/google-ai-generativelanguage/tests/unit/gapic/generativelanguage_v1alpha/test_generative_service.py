...
from google.ai.generativelanguage_v1alpha.services.generative_service import (
...
def test_generative_service_client_client_options_from_dict():
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:generateContent" % client.transport._host,
            args[1],
        )
...
def test_generate_answer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:generateAnswer" % client.transport._host,
            args[1],
        )
...
def test_stream_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:streamGenerateContent"
...
def test_embed_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:embedContent" % client.transport._host, args[1]
        )
...
def test_batch_embed_contents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:batchEmbedContents" % client.transport._host,
            args[1],
        )
...
def test_count_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:countTokens" % client.transport._host, args[1]
        )
...
def test_generative_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceTransport.__init__"
    ) as Transport:
...
def test_generative_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.ai.generativelanguage_v1alpha.services.generative_service.transports.GenerativeServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

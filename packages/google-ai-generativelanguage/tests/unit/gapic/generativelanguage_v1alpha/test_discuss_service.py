...
from google.ai.generativelanguage_v1alpha.services.discuss_service import (
...
def test_generate_message_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.generate_message] = (
            mock_rpc
        )
        request = {}
...
def test_count_message_tokens_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.count_message_tokens] = (
            mock_rpc
        )
        request = {}
...
def test_generate_message_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:generateMessage" % client.transport._host,
            args[1],
        )
...
def test_count_message_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{model=models/*}:countMessageTokens" % client.transport._host,
            args[1],
        )
...
def test_count_message_tokens_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.DiscussServiceRestInterceptor,
...
def test_discuss_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1alpha.services.discuss_service.transports.DiscussServiceTransport.__init__"
    ) as Transport:

...
from google.ai.generativelanguage_v1beta.services.retriever_service import RetrieverServiceAsyncClient, RetrieverServiceClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert RetrieverServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert RetrieverServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert RetrieverServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert RetrieverServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert RetrieverServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert RetrieverServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert RetrieverServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert RetrieverServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert RetrieverServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert RetrieverServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert RetrieverServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                RetrieverServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert RetrieverServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert RetrieverServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert RetrieverServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert RetrieverServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(RetrieverServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RetrieverServiceClient))
@mock.patch.object(RetrieverServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RetrieverServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RetrieverServiceClient._DEFAULT_UNIVERSE
    default_endpoint = RetrieverServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = RetrieverServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert RetrieverServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        RetrieverServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == RetrieverServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RetrieverServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert RetrieverServiceClient._get_api_endpoint(None, None, default_universe, "always") == RetrieverServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        RetrieverServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == RetrieverServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert RetrieverServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert RetrieverServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        RetrieverServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert RetrieverServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert RetrieverServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
def test_retriever_service_client_from_service_account_info(client_class, transport_name):
...
def test_retriever_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_retriever_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (RetrieverServiceAsyncClient, transports.RetrieverServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (RetrieverServiceClient, transports.RetrieverServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(RetrieverServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RetrieverServiceClient))
@mock.patch.object(RetrieverServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RetrieverServiceAsyncClient))
def test_retriever_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (RetrieverServiceClient, transports.RetrieverServiceGrpcTransport, "grpc", "true"),
        (RetrieverServiceAsyncClient, transports.RetrieverServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (RetrieverServiceClient, transports.RetrieverServiceGrpcTransport, "grpc", "false"),
        (RetrieverServiceAsyncClient, transports.RetrieverServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (RetrieverServiceClient, transports.RetrieverServiceRestTransport, "rest", "true"),
        (RetrieverServiceClient, transports.RetrieverServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(RetrieverServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RetrieverServiceClient))
@mock.patch.object(RetrieverServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(RetrieverServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_retriever_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [RetrieverServiceClient, RetrieverServiceAsyncClient])
@mock.patch.object(RetrieverServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RetrieverServiceClient))
@mock.patch.object(RetrieverServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RetrieverServiceAsyncClient))
...
def test_retriever_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (RetrieverServiceClient, transports.RetrieverServiceGrpcTransport, "grpc", grpc_helpers),
        (RetrieverServiceAsyncClient, transports.RetrieverServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (RetrieverServiceClient, transports.RetrieverServiceRestTransport, "rest", None),
    ],
)
def test_retriever_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_retriever_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = RetrieverServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_retriever_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_create_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_corpus_async(transport: str = "grpc_asyncio", request_type=retriever_service.CreateCorpusRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_corpus_async(transport: str = "grpc_asyncio", request_type=retriever_service.GetCorpusRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_corpus_async(transport: str = "grpc_asyncio", request_type=retriever_service.UpdateCorpusRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_corpus_async(transport: str = "grpc_asyncio", request_type=retriever_service.DeleteCorpusRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_corpora_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_corpora in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_corpora] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_corpora_async(transport: str = "grpc_asyncio", request_type=retriever_service.ListCorporaRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_corpora_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_corpora), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            retriever_service.ListCorporaResponse(
                corpora=[
...
async def test_list_corpora_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_corpora), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_corpora(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_query_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.query_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_query_corpus_async(transport: str = "grpc_asyncio", request_type=retriever_service.QueryCorpusRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.query_corpus), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.QueryCorpusResponse())
...
@pytest.mark.asyncio
async def test_create_document_async(transport: str = "grpc_asyncio", request_type=retriever_service.CreateDocumentRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_document_async(transport: str = "grpc_asyncio", request_type=retriever_service.GetDocumentRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_document_async(transport: str = "grpc_asyncio", request_type=retriever_service.UpdateDocumentRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_document_async(transport: str = "grpc_asyncio", request_type=retriever_service.DeleteDocumentRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_documents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_documents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_documents] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_documents_async(transport: str = "grpc_asyncio", request_type=retriever_service.ListDocumentsRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_documents_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_documents), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.ListDocumentsResponse())
        await client.list_documents(request)
...
async def test_list_documents_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_documents), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_documents(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_query_document_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.query_document in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_document] = mock_rpc
...
@pytest.mark.asyncio
async def test_query_document_async(transport: str = "grpc_asyncio", request_type=retriever_service.QueryDocumentRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.query_document), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.QueryDocumentResponse())
...
@pytest.mark.asyncio
async def test_create_chunk_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_chunk in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_chunk] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_chunk_async(transport: str = "grpc_asyncio", request_type=retriever_service.CreateChunkRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_create_chunks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_create_chunks in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_create_chunks] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_create_chunks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_create_chunks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_chunks] = mock_rpc
...
@pytest.mark.asyncio
async def test_batch_create_chunks_async(transport: str = "grpc_asyncio", request_type=retriever_service.BatchCreateChunksRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_chunk_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_chunk in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_chunk] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_chunk_async(transport: str = "grpc_asyncio", request_type=retriever_service.GetChunkRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_chunk_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_chunk in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_chunk] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_chunk_async(transport: str = "grpc_asyncio", request_type=retriever_service.UpdateChunkRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_update_chunks(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.batch_update_chunks), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_batch_update_chunks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_update_chunks in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_update_chunks] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_update_chunks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_update_chunks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_update_chunks] = mock_rpc
...
@pytest.mark.asyncio
async def test_batch_update_chunks_async(transport: str = "grpc_asyncio", request_type=retriever_service.BatchUpdateChunksRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.batch_update_chunks), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.BatchUpdateChunksResponse())
...
@pytest.mark.asyncio
async def test_delete_chunk_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_chunk in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_chunk] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_chunk_async(transport: str = "grpc_asyncio", request_type=retriever_service.DeleteChunkRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_delete_chunks(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.batch_delete_chunks), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_batch_delete_chunks_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_delete_chunks in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_delete_chunks] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_delete_chunks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_delete_chunks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_delete_chunks] = mock_rpc
...
@pytest.mark.asyncio
async def test_batch_delete_chunks_async(transport: str = "grpc_asyncio", request_type=retriever_service.BatchDeleteChunksRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_chunks_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = RetrieverServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_chunks in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_chunks] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_chunks_async(transport: str = "grpc_asyncio", request_type=retriever_service.ListChunksRequest):
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_chunks_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_chunks), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.ListChunksResponse())
        await client.list_chunks(request)
...
async def test_list_chunks_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_chunks), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            retriever_service.ListChunksResponse(
                chunks=[
...
async def test_list_chunks_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_chunks), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_chunks(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_corpus_rest_required_fields(request_type=retriever_service.CreateCorpusRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_corpus._get_unset_required_fields(jsonified_request)
...
def test_create_corpus_rest_unset_required_fields():
    transport = transports.RetrieverServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/corpora" % client.transport._host, args[1])
...
def test_get_corpus_rest_required_fields(request_type=retriever_service.GetCorpusRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=corpora/*}" % client.transport._host, args[1])
...
def test_update_corpus_rest_required_fields(request_type=retriever_service.UpdateCorpusRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{corpus.name=corpora/*}" % client.transport._host, args[1])
...
def test_delete_corpus_rest_required_fields(request_type=retriever_service.DeleteCorpusRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_corpora_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(retriever_service.ListCorporaResponse.to_json(x) for x in response)
...
def test_query_corpus_rest_required_fields(request_type=retriever_service.QueryCorpusRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_document_rest_required_fields(request_type=retriever_service.CreateDocumentRequest):
    transport_class = transports.RetrieverServiceRestTransport
...
def test_create_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=corpora/*}/documents" % client.transport._host, args[1])
...
def test_get_document_rest_required_fields(request_type=retriever_service.GetDocumentRequest):
    transport_class = transports.RetrieverServiceRestTransport
...
def test_get_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=corpora/*/documents/*}" % client.transport._host, args[1])
...
def test_update_document_rest_required_fields(request_type=retriever_service.UpdateDocumentRequest):
    transport_class = transports.RetrieverServiceRestTransport
...
def test_update_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{document.name=corpora/*/documents/*}" % client.transport._host, args[1])
...
def test_delete_document_rest_required_fields(request_type=retriever_service.DeleteDocumentRequest):
    transport_class = transports.RetrieverServiceRestTransport
...
def test_list_documents_rest_required_fields(request_type=retriever_service.ListDocumentsRequest):
    transport_class = transports.RetrieverServiceRestTransport
...
def test_list_documents_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(retriever_service.ListDocumentsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_query_document_rest_required_fields(request_type=retriever_service.QueryDocumentRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).query_document._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_chunk_rest_required_fields(request_type=retriever_service.CreateChunkRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_chunk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=corpora/*/documents/*}/chunks" % client.transport._host, args[1])
...
def test_batch_create_chunks_rest_required_fields(request_type=retriever_service.BatchCreateChunksRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_chunks._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_chunk_rest_required_fields(request_type=retriever_service.GetChunkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_chunk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=corpora/*/documents/*/chunks/*}" % client.transport._host, args[1])
...
def test_update_chunk_rest_required_fields(request_type=retriever_service.UpdateChunkRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_chunk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"chunk": {"name": "corpora/sample1/documents/sample2/chunks/sample3"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{chunk.name=corpora/*/documents/*/chunks/*}" % client.transport._host, args[1])
...
def test_batch_update_chunks_rest_required_fields(request_type=retriever_service.BatchUpdateChunksRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_update_chunks._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_chunk_rest_required_fields(request_type=retriever_service.DeleteChunkRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_chunk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_delete_chunks_rest_required_fields(request_type=retriever_service.BatchDeleteChunksRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_delete_chunks._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_chunks_rest_required_fields(request_type=retriever_service.ListChunksRequest):
    transport_class = transports.RetrieverServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_chunks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_chunks_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(retriever_service.ListChunksResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = RetrieverServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = RetrieverServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
    assert client is not None


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_corpus_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_corpus), "__call__") as call:
        call.return_value = retriever.Corpus()
        client.create_corpus(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_corpus_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_corpus), "__call__") as call:
        call.return_value = retriever.Corpus()
        client.get_corpus(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_corpus_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_corpus), "__call__") as call:
        call.return_value = retriever.Corpus()
        client.update_corpus(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_corpus_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_corpus), "__call__") as call:
        call.return_value = None
        client.delete_corpus(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_corpora_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_corpora), "__call__") as call:
        call.return_value = retriever_service.ListCorporaResponse()
        client.list_corpora(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_corpus_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.query_corpus), "__call__") as call:
        call.return_value = retriever_service.QueryCorpusResponse()
        client.query_corpus(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_document_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.query_document), "__call__") as call:
        call.return_value = retriever_service.QueryDocumentResponse()
        client.query_document(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_chunk_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_chunk), "__call__") as call:
        call.return_value = retriever.Chunk()
        client.create_chunk(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_chunks_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_create_chunks), "__call__") as call:
        call.return_value = retriever_service.BatchCreateChunksResponse()
        client.batch_create_chunks(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_chunk_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_chunk_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_chunk), "__call__") as call:
        call.return_value = retriever.Chunk()
        client.update_chunk(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_chunks_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_update_chunks), "__call__") as call:
        call.return_value = retriever_service.BatchUpdateChunksResponse()
        client.batch_update_chunks(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_chunk_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_chunk), "__call__") as call:
        call.return_value = None
        client.delete_chunk(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_chunks_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_delete_chunks), "__call__") as call:
        call.return_value = None
        client.batch_delete_chunks(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_chunks_empty_call_grpc():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_chunks), "__call__") as call:
        call.return_value = retriever_service.ListChunksResponse()
        client.list_chunks(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = RetrieverServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = RetrieverServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_corpus_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.create_corpus), "__call__") as call:
        ...
        await client.create_corpus(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_corpus_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_corpus), "__call__") as call:
        ...
        await client.get_corpus(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_corpus_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_corpus), "__call__") as call:
        ...
        await client.update_corpus(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_corpus_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_corpus), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_corpus(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_corpora_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_corpora), "__call__") as call:
        ...
        await client.list_corpora(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_query_corpus_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.query_corpus), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.QueryCorpusResponse())
        await client.query_corpus(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_query_document_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.query_document), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.QueryDocumentResponse())
        await client.query_document(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_chunk_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_chunk), "__call__") as call:
        ...
        await client.create_chunk(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_create_chunks_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_create_chunks), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.BatchCreateChunksResponse())
        await client.batch_create_chunks(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_chunk_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_chunk), "__call__") as call:
        ...
        await client.get_chunk(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_chunk_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_chunk), "__call__") as call:
        ...
        await client.update_chunk(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_update_chunks_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_update_chunks), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(retriever_service.BatchUpdateChunksResponse())
        await client.batch_update_chunks(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_chunk_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_chunk), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_chunk(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_delete_chunks_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.batch_delete_chunks), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.batch_delete_chunks(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_chunks_empty_call_grpc_asyncio():
    client = RetrieverServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_chunks), "__call__") as call:
        ...
        await client.list_chunks(request=None)
...
def test_transport_kind_rest():
    transport = RetrieverServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_corpus_rest_bad_request(request_type=retriever_service.CreateCorpusRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_corpus_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_corpus_rest_interceptors(null_interceptor):
    transport = transports.RetrieverServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RetrieverServiceRestInterceptor(),
    )
    client = RetrieverServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_corpus") as post, mock.patch.object(
        ...
        pb_message = retriever_service.CreateCorpusRequest.pb(retriever_service.CreateCorpusRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever.Corpus.to_json(retriever.Corpus())
...
def test_get_corpus_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_corpus") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.GetCorpusRequest.pb(retriever_service.GetCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_corpus_rest_bad_request(request_type=retriever_service.UpdateCorpusRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_corpus_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_corpus") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.UpdateCorpusRequest.pb(retriever_service.UpdateCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_corpus_rest_bad_request(request_type=retriever_service.DeleteCorpusRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "corpora/sample1"}
    request = request_type(**request_init)
...
def test_delete_corpus_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_delete_corpus") as pre:
        pre.assert_not_called()
        pb_message = retriever_service.DeleteCorpusRequest.pb(retriever_service.DeleteCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_corpora_rest_bad_request(request_type=retriever_service.ListCorporaRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_list_corpora_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_corpora_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_corpora") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.ListCorporaRequest.pb(retriever_service.ListCorporaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.ListCorporaResponse.to_json(retriever_service.ListCorporaResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.ListCorporaResponse(), metadata
...
def test_query_corpus_rest_bad_request(request_type=retriever_service.QueryCorpusRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "corpora/sample1"}
    request = request_type(**request_init)
...
def test_query_corpus_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_query_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_query_corpus") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.QueryCorpusRequest.pb(retriever_service.QueryCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.QueryCorpusResponse.to_json(retriever_service.QueryCorpusResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.QueryCorpusResponse(), metadata
...
def test_create_document_rest_bad_request(request_type=retriever_service.CreateDocumentRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_document") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.CreateDocumentRequest.pb(retriever_service.CreateDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever.Document.to_json(retriever.Document())
        req.return_value.content = return_value
...
def test_get_document_rest_bad_request(request_type=retriever_service.GetDocumentRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_document") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.GetDocumentRequest.pb(retriever_service.GetDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_document_rest_bad_request(request_type=retriever_service.UpdateDocumentRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_document") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.UpdateDocumentRequest.pb(retriever_service.UpdateDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_document_rest_bad_request(request_type=retriever_service.DeleteDocumentRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "corpora/sample1/documents/sample2"}
    request = request_type(**request_init)
...
def test_delete_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_delete_document") as pre:
        pre.assert_not_called()
        pb_message = retriever_service.DeleteDocumentRequest.pb(retriever_service.DeleteDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_documents_rest_bad_request(request_type=retriever_service.ListDocumentsRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "corpora/sample1"}
    request = request_type(**request_init)
...
def test_list_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_documents") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.ListDocumentsRequest.pb(retriever_service.ListDocumentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.ListDocumentsResponse.to_json(retriever_service.ListDocumentsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.ListDocumentsResponse(), metadata
...
def test_query_document_rest_bad_request(request_type=retriever_service.QueryDocumentRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "corpora/sample1/documents/sample2"}
    request = request_type(**request_init)
...
def test_query_document_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_query_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_query_document") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.QueryDocumentRequest.pb(retriever_service.QueryDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.QueryDocumentResponse.to_json(retriever_service.QueryDocumentResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.QueryDocumentResponse(), metadata
...
def test_create_chunk_rest_bad_request(request_type=retriever_service.CreateChunkRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_create_chunk_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_create_chunk") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.CreateChunkRequest.pb(retriever_service.CreateChunkRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever.Chunk.to_json(retriever.Chunk())
        req.return_value.content = return_value
...
def test_batch_create_chunks_rest_bad_request(request_type=retriever_service.BatchCreateChunksRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "corpora/sample1/documents/sample2"}
    request = request_type(**request_init)
...
def test_batch_create_chunks_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_create_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_batch_create_chunks") as post, mock.patch.object(
        transports.RetrieverServiceRestInterceptor, "post_batch_create_chunks_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.BatchCreateChunksRequest.pb(retriever_service.BatchCreateChunksRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.BatchCreateChunksResponse.to_json(retriever_service.BatchCreateChunksResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.BatchCreateChunksResponse(), metadata
...
def test_get_chunk_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_get_chunk") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.GetChunkRequest.pb(retriever_service.GetChunkRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_chunk_rest_bad_request(request_type=retriever_service.UpdateChunkRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"chunk": {"name": "corpora/sample1/documents/sample2/chunks/sample3"}}
    request = request_type(**request_init)
...
def test_update_chunk_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_update_chunk") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.UpdateChunkRequest.pb(retriever_service.UpdateChunkRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_batch_update_chunks_rest_bad_request(request_type=retriever_service.BatchUpdateChunksRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "corpora/sample1/documents/sample2"}
    request = request_type(**request_init)
...
def test_batch_update_chunks_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_update_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_batch_update_chunks") as post, mock.patch.object(
        transports.RetrieverServiceRestInterceptor, "post_batch_update_chunks_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.BatchUpdateChunksRequest.pb(retriever_service.BatchUpdateChunksRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.BatchUpdateChunksResponse.to_json(retriever_service.BatchUpdateChunksResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.BatchUpdateChunksResponse(), metadata
...
def test_delete_chunk_rest_bad_request(request_type=retriever_service.DeleteChunkRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "corpora/sample1/documents/sample2/chunks/sample3"}
    request = request_type(**request_init)
...
def test_delete_chunk_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_chunk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_delete_chunk") as pre:
        pre.assert_not_called()
        pb_message = retriever_service.DeleteChunkRequest.pb(retriever_service.DeleteChunkRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_batch_delete_chunks_rest_bad_request(request_type=retriever_service.BatchDeleteChunksRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "corpora/sample1/documents/sample2"}
    request = request_type(**request_init)
...
def test_batch_delete_chunks_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_batch_delete_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "pre_batch_delete_chunks") as pre:
        pre.assert_not_called()
        pb_message = retriever_service.BatchDeleteChunksRequest.pb(retriever_service.BatchDeleteChunksRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_chunks_rest_bad_request(request_type=retriever_service.ListChunksRequest):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "corpora/sample1/documents/sample2"}
    request = request_type(**request_init)
...
def test_list_chunks_rest_call_success(request_type):
    client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_chunks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.RetrieverServiceRestInterceptor, "post_list_chunks") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = retriever_service.ListChunksRequest.pb(retriever_service.ListChunksRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = retriever_service.ListChunksResponse.to_json(retriever_service.ListChunksResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = retriever_service.ListChunksResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_corpus_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_corpus_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_corpus_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_corpus_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_corpora_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_corpus_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_query_document_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_chunk_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_create_chunks_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_chunk_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_chunk_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_update_chunks_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_chunk_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_delete_chunks_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_chunks_empty_call_rest():
    client = RetrieverServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_retriever_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.RetrieverServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_retriever_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.ai.generativelanguage_v1beta.services.retriever_service.transports.RetrieverServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.RetrieverServiceGrpcTransport, grpc_helpers), (transports.RetrieverServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.RetrieverServiceGrpcTransport, transports.RetrieverServiceGrpcAsyncIOTransport])
...
def test_retriever_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.RetrieverServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.RetrieverServiceGrpcTransport, transports.RetrieverServiceGrpcAsyncIOTransport])
def test_retriever_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.RetrieverServiceTransport, "_prep_wrapped_messages") as prep:
        client = RetrieverServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = RetrieverServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

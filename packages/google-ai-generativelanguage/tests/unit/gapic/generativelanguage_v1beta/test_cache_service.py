...
from google.ai.generativelanguage_v1beta.services.cache_service import CacheServiceAsyncClient, CacheServiceClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CacheServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CacheServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CacheServiceClient._use_client_cert_effective()
...
def test_cache_service_client_client_options_from_dict():
    with mock.patch("google.ai.generativelanguage_v1beta.services.cache_service.transports.CacheServiceGrpcTransport.__init__") as grpc_transport:
...
def test_list_cached_contents(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_cached_contents), "__call__") as call:
...
async def test_list_cached_contents_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_cached_contents), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            cache_service.ListCachedContentsResponse(
                cached_contents=[
...
async def test_list_cached_contents_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_cached_contents), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_cached_contents(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_cached_content(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_cached_content), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = gag_cached_content.CachedContent(
            name="name_value",
            display_name="display_name_value",
...
def test_create_cached_content_rest_required_fields(request_type=cache_service.CreateCachedContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_cached_content._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/cachedContents" % client.transport._host, args[1])
...
def test_get_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=cachedContents/*}" % client.transport._host, args[1])
...
def test_update_cached_content_rest_required_fields(request_type=cache_service.UpdateCachedContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_cached_content._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{cached_content.name=cachedContents/*}" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = CacheServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = CacheServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = CacheServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = CacheServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CacheServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CacheServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_cached_contents_rest_bad_request(request_type=cache_service.ListCachedContentsRequest):
    client = CacheServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_cached_contents_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CacheServiceRestInterceptor, "post_list_cached_contents") as post, mock.patch.object(
        transports.CacheServiceRestInterceptor, "post_list_cached_contents_with_metadata"
            ...
            "parts": [
                {
                    ...
                    "function_call": {"id": "id_value", "name": "name_value", "args": {"fields": {}}},
                    "function_response": {
                        "id": "id_value",
                        "name": "name_value",
                        "response": {},
                        "parts": [{"inline_data": {"mime_type": "mime_type_value", "data": b"data_blob"}}],
                        "will_continue": True,
                        "scheduling": 1,
                    },
                    "file_data": {"mime_type": "mime_type_value", "file_uri": "file_uri_value"},
                    "executable_code": {"language": 1, "code": "code_value"},
                    "code_execution_result": {"outcome": 1, "output": "output_value"},
                    "video_metadata": {"start_offset": {}, "end_offset": {}, "fps": 0.329},
                    "thought": True,
        ...
        "tools": [
            {
                "function_declarations": [
                    {
                        ...
                        "parameters": {
                            ...
                            "any_of": {},
                            "property_ordering": ["property_ordering_value1", "property_ordering_value2"],
                            "default": {},
                        },
                ...
                "google_search_retrieval": {"dynamic_retrieval_config": {"mode": 1, "dynamic_threshold": 0.1809}},
                "code_execution": {},
                "google_search": {"time_range_filter": {"start_time": {}, "end_time": {}}},
                "computer_use": {
                    "environment": 1,
                    "excluded_predefined_functions": ["excluded_predefined_functions_value1", "excluded_predefined_functions_value2"],
                },
                "url_context": {},
            }
        ],
        "tool_config": {
            "function_calling_config": {"mode": 1, "allowed_function_names": ["allowed_function_names_value1", "allowed_function_names_value2"]}
        },
        "create_time": {},
        "update_time": {},
...
def test_create_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CacheServiceRestInterceptor, "post_create_cached_content") as post, mock.patch.object(
        transports.CacheServiceRestInterceptor, "post_create_cached_content_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CacheServiceRestInterceptor, "post_get_cached_content") as post, mock.patch.object(
...
def test_update_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CacheServiceRestInterceptor, "post_update_cached_content") as post, mock.patch.object(
        transports.CacheServiceRestInterceptor, "post_update_cached_content_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CacheServiceRestInterceptor, "pre_delete_cached_content") as pre:
        pre.assert_not_called()
...
def test_cache_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.CacheServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_cache_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.ai.generativelanguage_v1beta.services.cache_service.transports.CacheServiceTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.CacheServiceGrpcTransport, grpc_helpers), (transports.CacheServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_cache_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.CacheServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = CacheServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

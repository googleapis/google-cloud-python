...
from google.ai.generativelanguage_v1beta.services.generative_service import GenerativeServiceAsyncClient, GenerativeServiceClient, transports
from google.ai.generativelanguage_v1beta.types import generative_service, retriever, safety
...
def test_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/{model=models/*}:generateContent" % client.transport._host, args[1])
...
def test_generate_answer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:generateAnswer" % client.transport._host, args[1])
...
def test_stream_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:streamGenerateContent" % client.transport._host, args[1])
...
def test_embed_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:embedContent" % client.transport._host, args[1])
...
def test_batch_embed_contents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:batchEmbedContents" % client.transport._host, args[1])
...
def test_count_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{model=models/*}:countTokens" % client.transport._host, args[1])
...
def test_bidi_generate_content_rest_error():
    ...
    assert "Method BidiGenerateContent is not available over REST transport" in str(not_implemented_error.value)
...
def test_generate_answer_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GenerativeServiceRestInterceptor, "post_generate_answer") as post, mock.patch.object(
        transports.GenerativeServiceRestInterceptor, "post_generate_answer_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_generative_service_base_transport():
    ...
    with mock.patch("google.ai.generativelanguage_v1beta.services.generative_service.transports.GenerativeServiceTransport.__init__") as Transport:

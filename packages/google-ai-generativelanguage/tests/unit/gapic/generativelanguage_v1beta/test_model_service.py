...
from google.ai.generativelanguage_v1beta.services.model_service import (
...
def test_model_service_client_client_options_from_dict():
    with mock.patch(
        "google.ai.generativelanguage_v1beta.services.model_service.transports.ModelServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_tuned_models_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_tuned_models] = (
            mock_rpc
        )
        request = {}
...
async def test_list_tuned_models_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_tuned_models),
        "__call__",
...
def test_create_tuned_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_tuned_model] = (
            mock_rpc
        )
        request = {}
    ...
    with mock.patch.object(
        ...
        client.create_tuned_model(
            tuned_model=gag_tuned_model.TunedModel(
                tuned_model_source=gag_tuned_model.TunedModelSource(
                    tuned_model="tuned_model_value"
                )
            ),
            tuned_model_id="tuned_model_id_value",
        )
        ...
        mock_val = gag_tuned_model.TunedModel(
            tuned_model_source=gag_tuned_model.TunedModelSource(
                tuned_model="tuned_model_value"
            )
        )
...
def test_update_tuned_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_tuned_model] = (
            mock_rpc
        )
        request = {}
...
def test_delete_tuned_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_tuned_model] = (
            mock_rpc
        )
        request = {}
...
def test_get_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{name=models/*}" % client.transport._host, args[1]
        )
...
def test_list_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/models" % client.transport._host, args[1]
        )
...
def test_get_tuned_model_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_tuned_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_tuned_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=tunedModels/*}" % client.transport._host, args[1]
        )
...
def test_list_tuned_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/tunedModels" % client.transport._host, args[1]
        )
...
def test_list_tuned_models_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(
            model_service.ListTunedModelsResponse.to_json(x) for x in response
        )
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
...
def test_create_tuned_model_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_tuned_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_tuned_model_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_tuned_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_tuned_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{tuned_model.name=tunedModels/*}" % client.transport._host,
            args[1],
        )
...
def test_delete_tuned_model_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_tuned_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_tuned_model_rest_bad_request(
    request_type=model_service.GetTunedModelRequest,
):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_get_tuned_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "post_get_tuned_model"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = model_service.GetTunedModelRequest.pb(
            model_service.GetTunedModelRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_tuned_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "post_list_tuned_models"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = model_service.ListTunedModelsRequest.pb(
            model_service.ListTunedModelsRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_create_tuned_model_rest_bad_request(
    request_type=model_service.CreateTunedModelRequest,
):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_create_tuned_model_rest_call_success(request_type):
    ...
    request_init["tuned_model"] = {
        ...
        "tuning_task": {
            ...
            "complete_time": {},
            "snapshots": [
                {"step": 444, "epoch": 527, "mean_loss": 0.961, "compute_time": {}}
            ],
            "training_data": {
                "examples": {
                    "examples": [
...
def test_create_tuned_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = model_service.CreateTunedModelRequest.pb(
            model_service.CreateTunedModelRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_tuned_model_rest_bad_request(
    request_type=model_service.UpdateTunedModelRequest,
):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_update_tuned_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "post_update_tuned_model"
    ) as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = model_service.UpdateTunedModelRequest.pb(
            model_service.UpdateTunedModelRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_tuned_model_rest_bad_request(
    request_type=model_service.DeleteTunedModelRequest,
):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_delete_tuned_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "pre_delete_tuned_model"
    ) as pre:
        pre.assert_not_called()
        pb_message = model_service.DeleteTunedModelRequest.pb(
            model_service.DeleteTunedModelRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_model_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1beta.services.model_service.transports.ModelServiceTransport.__init__"
    ) as Transport:

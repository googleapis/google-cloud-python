...
from google.ai.generativelanguage_v1beta3.services.text_service import (
...
def test_text_service_client_client_options_from_dict():
    with mock.patch(
        "google.ai.generativelanguage_v1beta3.services.text_service.transports.TextServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_batch_embed_text_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.batch_embed_text] = (
            mock_rpc
        )
        request = {}
...
def test_count_text_tokens_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.count_text_tokens] = (
            mock_rpc
        )
        request = {}
...
def test_generate_text_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateText,
...
def test_generate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta3/{model=models/*}:generateText" % client.transport._host, args[1]
        )
...
def test_embed_text_rest_required_fields(request_type=text_service.EmbedTextRequest):
    ...
    default_values = getattr(
        transport_class._BaseEmbedText,
...
def test_embed_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{model=models/*}:embedText" % client.transport._host, args[1]
        )
...
def test_batch_embed_text_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchEmbedText,
    ...
    jsonified_request["model"] = "model_value"
    jsonified_request["texts"] = "texts_value"

    # verify required fields with non-default values are left alone
    assert "model" in jsonified_request
    assert jsonified_request["model"] == "model_value"
    assert "texts" in jsonified_request
    assert jsonified_request["texts"] == "texts_value"
...
def test_batch_embed_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{model=models/*}:batchEmbedText" % client.transport._host,
            args[1],
        )
...
def test_count_text_tokens_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCountTextTokens,
...
def test_count_text_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta3/{model=models/*}:countTextTokens" % client.transport._host,
            args[1],
        )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_embed_text_empty_call_grpc():
    client = TextServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.batch_embed_text), "__call__") as call:
        call.return_value = text_service.BatchEmbedTextResponse()
        client.batch_embed_text(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_count_text_tokens_empty_call_grpc():
    client = TextServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_embed_text_empty_call_grpc_asyncio():
    client = TextServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_count_text_tokens_empty_call_grpc_asyncio():
    client = TextServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.count_text_tokens(request=None)
...
def test_count_text_tokens_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TextServiceRestInterceptor,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_embed_text_empty_call_rest():
    client = TextServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_count_text_tokens_empty_call_rest():
    client = TextServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_text_service_base_transport():
    ...
    with mock.patch(
        "google.ai.generativelanguage_v1beta3.services.text_service.transports.TextServiceTransport.__init__"
    ) as Transport:
...
def test_text_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.ai.generativelanguage_v1beta3.services.text_service.transports.TextServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

...
from google.ai.generativelanguage_v1beta3.services.text_service import TextServiceAsyncClient, TextServiceClient, transports
...
def test_text_service_client_client_options_from_dict():
    with mock.patch("google.ai.generativelanguage_v1beta3.services.text_service.transports.TextServiceGrpcTransport.__init__") as grpc_transport:
...
def test_generate_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta3/{model=models/*}:generateText" % client.transport._host, args[1])
...
def test_embed_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta3/{model=models/*}:embedText" % client.transport._host, args[1])
...
def test_batch_embed_text_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta3/{model=models/*}:batchEmbedText" % client.transport._host, args[1])
...
def test_count_text_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta3/{model=models/*}:countTextTokens" % client.transport._host, args[1])
...
def test_text_service_base_transport():
    ...
    with mock.patch("google.ai.generativelanguage_v1beta3.services.text_service.transports.TextServiceTransport.__init__") as Transport:

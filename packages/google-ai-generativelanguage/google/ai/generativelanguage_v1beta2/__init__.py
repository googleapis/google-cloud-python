...
from .types.text_service import Embedding, EmbedTextRequest, EmbedTextResponse, GenerateTextRequest, GenerateTextResponse, TextCompletion, TextPrompt

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.ai.generativelanguage_v1beta2")  # type: ignore
    api_core.check_dependency_versions("google.ai.generativelanguage_v1beta2")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.ai.generativelanguage_v1beta2"

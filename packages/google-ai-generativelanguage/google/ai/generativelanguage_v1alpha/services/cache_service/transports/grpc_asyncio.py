...
class CacheServiceGrpcAsyncIOTransport(CacheServiceTransport):
    ...
    @property
    def list_cached_contents(self) -> Callable[[cache_service.ListCachedContentsRequest], Awaitable[cache_service.ListCachedContentsResponse]]:
    ...
    @property
    def create_cached_content(self) -> Callable[[cache_service.CreateCachedContentRequest], Awaitable[gag_cached_content.CachedContent]]:
    ...
    @property
    def get_cached_content(self) -> Callable[[cache_service.GetCachedContentRequest], Awaitable[cached_content.CachedContent]]:
    ...
    @property
    def update_cached_content(self) -> Callable[[cache_service.UpdateCachedContentRequest], Awaitable[gag_cached_content.CachedContent]]:
    ...
    @property
    def delete_cached_content(self) -> Callable[[cache_service.DeleteCachedContentRequest], Awaitable[empty_pb2.Empty]]:

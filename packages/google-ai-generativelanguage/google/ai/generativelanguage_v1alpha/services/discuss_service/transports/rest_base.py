...
class _BaseDiscussServiceRestTransport(DiscussServiceTransport):
    ...
    class _BaseCountMessageTokens:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseDiscussServiceRestTransport._BaseCountMessageTokens._get_unset_required_fields(query_params))
    ...
    class _BaseGenerateMessage:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseDiscussServiceRestTransport._BaseGenerateMessage._get_unset_required_fields(query_params))

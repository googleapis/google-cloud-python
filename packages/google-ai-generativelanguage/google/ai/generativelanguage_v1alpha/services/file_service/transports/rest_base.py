...
class _BaseFileServiceRestTransport(FileServiceTransport):
    ...
    class _BaseDeleteFile:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFileServiceRestTransport._BaseDeleteFile._get_unset_required_fields(query_params))
    ...
    class _BaseGetFile:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFileServiceRestTransport._BaseGetFile._get_unset_required_fields(query_params))

...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.ai.generativelanguage_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.ai.generativelanguage_v1alpha")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.ai.generativelanguage_v1alpha"

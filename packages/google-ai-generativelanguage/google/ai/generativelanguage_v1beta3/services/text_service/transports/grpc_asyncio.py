...
class TextServiceGrpcAsyncIOTransport(TextServiceTransport):
    ...
    @property
    def generate_text(self) -> Callable[[text_service.GenerateTextRequest], Awaitable[text_service.GenerateTextResponse]]:
    ...
    @property
    def embed_text(self) -> Callable[[text_service.EmbedTextRequest], Awaitable[text_service.EmbedTextResponse]]:
    ...
    @property
    def batch_embed_text(self) -> Callable[[text_service.BatchEmbedTextRequest], Awaitable[text_service.BatchEmbedTextResponse]]:
    ...
    @property
    def count_text_tokens(self) -> Callable[[text_service.CountTextTokensRequest], Awaitable[text_service.CountTextTokensResponse]]:

...
class DiscussServiceTransport(abc.ABC):
    ...
    def generate_message(
        ...
        [discuss_service.GenerateMessageRequest], Union[discuss_service.GenerateMessageResponse, Awaitable[discuss_service.GenerateMessageResponse]]
    ]:
        raise NotImplementedError()
    ...
    def count_message_tokens(
        ...
        Union[discuss_service.CountMessageTokensResponse, Awaitable[discuss_service.CountMessageTokensResponse]],
    ]:
        raise NotImplementedError()

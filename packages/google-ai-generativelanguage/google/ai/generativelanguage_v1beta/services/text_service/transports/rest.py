...
class TextServiceRestTransport(_BaseTextServiceRestTransport):
    ...
    class _CancelOperation(
        _BaseTextServiceRestTransport._BaseCancelOperation, TextServiceRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseTextServiceRestTransport._BaseCancelOperation._get_http_options()
            )

            request, metadata = self._interceptor.pre_cancel_operation(
                request, metadata
            )
            transcoded_request = _BaseTextServiceRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseTextServiceRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = TextServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _DeleteOperation(
        _BaseTextServiceRestTransport._BaseDeleteOperation, TextServiceRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseTextServiceRestTransport._BaseDeleteOperation._get_http_options()
            )

            request, metadata = self._interceptor.pre_delete_operation(
                request, metadata
            )
            transcoded_request = _BaseTextServiceRestTransport._BaseDeleteOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseTextServiceRestTransport._BaseDeleteOperation._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = TextServiceRestTransport._DeleteOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,

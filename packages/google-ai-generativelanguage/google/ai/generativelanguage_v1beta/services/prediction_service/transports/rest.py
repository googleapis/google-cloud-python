...
class PredictionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_predict_long_running(
        self, request: prediction_service.PredictLongRunningRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[prediction_service.PredictLongRunningRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class PredictionServiceRestTransport(_BasePredictionServiceRestTransport):
    ...
    class _PredictLongRunning(_BasePredictionServiceRestTransport._BasePredictLongRunning, PredictionServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BasePredictionServiceRestTransport._BasePredictLongRunning._get_http_options()

            request, metadata = self._interceptor.pre_predict_long_running(request, metadata)
            transcoded_request = _BasePredictionServiceRestTransport._BasePredictLongRunning._get_transcoded_request(http_options, request)

            body = _BasePredictionServiceRestTransport._BasePredictLongRunning._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePredictionServiceRestTransport._BasePredictLongRunning._get_query_params_json(transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_predict_long_running_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    @property
    def predict_long_running(self) -> Callable[[prediction_service.PredictLongRunningRequest], operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    class _CancelOperation(_BasePredictionServiceRestTransport._BaseCancelOperation, PredictionServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.PredictionServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta.PredictionService",
    ...
    class _DeleteOperation(_BasePredictionServiceRestTransport._BaseDeleteOperation, PredictionServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.ai.generativelanguage_v1beta.PredictionServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.ai.generativelanguage.v1beta.PredictionService",

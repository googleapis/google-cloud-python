...
from google.cloud.sql_v1beta4.services.sql_operations_service import (
...
def test__get_client_cert_source():
    ...
    assert SqlOperationsServiceClient._get_client_cert_source(None, False) is None
    assert (
        SqlOperationsServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SqlOperationsServiceClient._get_client_cert_source(None, True)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SqlOperationsServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (SqlOperationsServiceClient, "grpc"),
        (SqlOperationsServiceAsyncClient, "grpc_asyncio"),
        (SqlOperationsServiceClient, "rest"),
    ],
)
def test_sql_operations_service_client_from_service_account_info(
    client_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.SqlOperationsServiceRestTransport, "rest"),
    ],
)
def test_sql_operations_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_sql_operations_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_sql_operations_service_client_get_transport_class():
    ...
    available_transports = [
        ...
        transports.SqlOperationsServiceRestTransport,
    ]
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SqlOperationsServiceClient),
)
@mock.patch.object(
    SqlOperationsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SqlOperationsServiceAsyncClient),
)
def test_sql_operations_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_sql_operations_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [SqlOperationsServiceClient, SqlOperationsServiceAsyncClient]
)
@mock.patch.object(
    SqlOperationsServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SqlOperationsServiceClient),
)
@mock.patch.object(
    SqlOperationsServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SqlOperationsServiceAsyncClient),
)
def test_sql_operations_service_client_get_mtls_endpoint_and_cert_source(client_class):
...
def test_sql_operations_service_client_client_api_endpoint(client_class):
    mock_client_cert_source = client_cert_source_callback
    api_override = "foo.com"
    default_universe = SqlOperationsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SqlOperationsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SqlOperationsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
...
def test_sql_operations_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_sql_operations_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_sql_operations_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_sql_operations_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        request = cloud_sql.SqlOperationsGetRequest()
...
def test_get_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlOperationsGetRequest(
            operation="operation_value",
            project="project_value",
            location="location_value",
        )
...
def test_get_field_headers():
    ...
    request.operation = "operation_value"
...
def test_list(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = cloud_sql_resources.OperationsListResponse(
            kind="kind_value",
...
def test_list_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlOperationsListRequest(
            instance="instance_value",
            page_token="page_token_value",
            project="project_value",
            location="location_value",
...
def test_list_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        assert all(isinstance(i, cloud_sql_resources.Operation) for i in results)
...
async def test_list_async_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, cloud_sql_resources.Operation) for i in responses)
...
def test_cancel(request_type, transport: str = "grpc"):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.cancel), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql.SqlOperationsCancelRequest()
        assert args[0] == request
...
def test_cancel_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.cancel), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlOperationsCancelRequest(
            operation="operation_value",
            project="project_value",
            location="location_value",
        )
...
def test_cancel_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SqlOperationsServiceClient(
...
@pytest.mark.asyncio
async def test_cancel_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SqlOperationsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.cancel
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.cancel] = (
            mock_rpc
        )
...
async def test_cancel_async(request_type, transport: str = "grpc_asyncio"):
    client = SqlOperationsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_cancel_field_headers_async():
    client = SqlOperationsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            cloud_sql_resources.OperationsListResponse.to_json(x) for x in response
        )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_empty_call_grpc():
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = SqlOperationsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_cancel_empty_call_grpc_asyncio():
    client = SqlOperationsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.cancel), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.cancel(request=None)
...
def test_transport_kind_rest():
    transport = SqlOperationsServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_get_rest_bad_request(request_type=cloud_sql.SqlOperationsGetRequest):
    client = SqlOperationsServiceClient(
...
def test_get_rest_interceptors(null_interceptor):
    transport = transports.SqlOperationsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
        else transports.SqlOperationsServiceRestInterceptor(),
    )
    client = SqlOperationsServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "post_get"
        ) as post,
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "pre_get"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_sql.SqlOperationsGetRequest.pb(
            cloud_sql.SqlOperationsGetRequest()
        )
...
def test_list_rest_bad_request(request_type=cloud_sql.SqlOperationsListRequest):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        # Designate an appropriate value for the returned response.
        return_value = cloud_sql_resources.OperationsListResponse(
            kind="kind_value",
            next_page_token="next_page_token_value",
        )
        ...
        # Convert return value to protobuf type
        return_value = cloud_sql_resources.OperationsListResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
        response_value.content = json_return_value.encode("UTF-8")
        req.return_value = response_value
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "pre_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_sql.SqlOperationsListRequest.pb(
            cloud_sql.SqlOperationsListRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_sql_resources.OperationsListResponse.to_json(
            cloud_sql_resources.OperationsListResponse()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = cloud_sql_resources.OperationsListResponse()
...
def test_cancel_rest_bad_request(request_type=cloud_sql.SqlOperationsCancelRequest):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_cancel_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SqlOperationsServiceRestInterceptor, "pre_cancel"
        ) as pre,
    ):
        pre.assert_not_called()
        pb_message = cloud_sql.SqlOperationsCancelRequest.pb(
            cloud_sql.SqlOperationsCancelRequest()
        )
        transcode.return_value = {
            "method": "post",
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_cancel_empty_call_rest():
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_sql_operations_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceTransport.__init__"
    ) as Transport:
...
def test_sql_operations_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sql_v1beta4.services.sql_operations_service.transports.SqlOperationsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_sql_operations_service_transport_auth_gdch_credentials(transport_class):
...
def test_sql_operations_service_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
    with mock.patch(
        "google.auth.transport.requests.AuthorizedSession.configure_mtls_channel"
...
def test_sql_operations_service_host_no_port(transport_name):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_sql_operations_service_host_with_port(transport_name):
    client = SqlOperationsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
...
def test_sql_operations_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = SqlOperationsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SqlOperationsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_sql_operations_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.SqlOperationsServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = SqlOperationsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize(
    ...
    [
        (SqlOperationsServiceClient, transports.SqlOperationsServiceGrpcTransport),
        (
            SqlOperationsServiceAsyncClient,
            transports.SqlOperationsServiceGrpcAsyncIOTransport,
        ),

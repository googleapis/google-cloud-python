...
from google.cloud.sql_v1beta4.services.sql_backup_runs_service import (
...
def test_sql_backup_runs_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sql_v1beta4.services.sql_backup_runs_service.transports.SqlBackupRunsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_sql_backup_runs_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sql_v1beta4.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport.__init__"
    ) as Transport:
...
def test_sql_backup_runs_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sql_v1beta4.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

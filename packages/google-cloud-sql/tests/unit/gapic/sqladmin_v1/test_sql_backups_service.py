...
from google.cloud.sqladmin_v1.services.sql_backups_service import (
...
def test_sql_backups_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_backups_service.transports.SqlBackupsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.parametrize(
    "request_type",
    [
        cloud_sql_backups.CreateBackupRequest(),
        {},
    ],
)
def test_create_backup(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.create_backup), "__call__") as call:
        ...
        request = cloud_sql_backups.CreateBackupRequest()
...
def test_create_backup_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.create_backup), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backups.CreateBackupRequest(
            parent="parent_value",
        )
...
def test_create_backup_flattened():
    ...
    with mock.patch.object(type(client.transport.create_backup), "__call__") as call:
        ...
        client.create_backup(
            parent="parent_value",
            backup=cloud_sql_backups.Backup(name="name_value"),
        )
        ...
        assert arg == mock_val
        arg = args[0].backup
        mock_val = cloud_sql_backups.Backup(name="name_value")
        assert arg == mock_val
...
@pytest.mark.parametrize(
    "request_type",
    [
        cloud_sql_backups.GetBackupRequest(),
        {},
    ],
)
def test_get_backup(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_backup), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = cloud_sql_backups.Backup(
            name="name_value",
            kind="kind_value",
            self_link="self_link_value",
            type_=cloud_sql_backups.Backup.SqlBackupType.AUTOMATED,
            description="description_value",
            instance="instance_value",
            location="location_value",
            state=cloud_sql_backups.Backup.SqlBackupState.ENQUEUED,
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_backups.GetBackupRequest()
        assert args[0] == request

    # Establish that the response is the type that we expect.
    assert isinstance(response, cloud_sql_backups.Backup)
    assert response.name == "name_value"
    assert response.kind == "kind_value"
    assert response.self_link == "self_link_value"
    assert response.type_ == cloud_sql_backups.Backup.SqlBackupType.AUTOMATED
    assert response.description == "description_value"
    assert response.instance == "instance_value"
    assert response.location == "location_value"
    assert response.state == cloud_sql_backups.Backup.SqlBackupState.ENQUEUED
...
def test_get_backup_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get_backup), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backups.GetBackupRequest(
            name="name_value",
        )
        assert args[0] == request_msg
...
@pytest.mark.parametrize(
    "request_type",
    [
        cloud_sql_backups.ListBackupsRequest(),
        {},
    ],
)
def test_list_backups(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_backups), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = cloud_sql_backups.ListBackupsResponse(
...
def test_list_backups_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_backups), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backups.ListBackupsRequest(
            parent="parent_value",
            page_token="page_token_value",
            filter="filter_value",
        )
...
async def test_list_backups_async(request_type, transport: str = "grpc_asyncio"):
    ...
    with mock.patch.object(type(client.transport.list_backups), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            cloud_sql_backups.ListBackupsResponse(
                next_page_token="next_page_token_value",
            )
        )
...
def test_list_backups_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_backups), "__call__") as call:
        ...
        assert all(isinstance(i, cloud_sql_backups.Backup) for i in results)
...
async def test_list_backups_async_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, cloud_sql_backups.Backup) for i in responses)
...
@pytest.mark.parametrize(
    "request_type",
    [
        cloud_sql_backups.UpdateBackupRequest(),
        {},
    ],
)
def test_update_backup(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.update_backup), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_backups.UpdateBackupRequest()
        assert args[0] == request
...
def test_update_backup_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.update_backup), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backups.UpdateBackupRequest()
        assert args[0] == request_msg
...
@pytest.mark.parametrize(
    "request_type",
    [
        cloud_sql_backups.DeleteBackupRequest(),
        {},
    ],
)
def test_delete_backup(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.delete_backup), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_backups.DeleteBackupRequest()
        assert args[0] == request
...
def test_delete_backup_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.delete_backup), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backups.DeleteBackupRequest(
            name="name_value",
        )
        assert args[0] == request_msg
...
def test_sql_backups_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_backups_service.transports.SqlBackupsServiceTransport.__init__"
    ) as Transport:
...
def test_sql_backups_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sqladmin_v1.services.sql_backups_service.transports.SqlBackupsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

...
from google.cloud.sqladmin_v1.services.sql_operations_service import (
...
def test_sql_operations_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_operations_service.transports.SqlOperationsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        request = cloud_sql_operations.SqlOperationsGetRequest()
...
def test_get_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_operations.SqlOperationsGetRequest(
            operation="operation_value",
            project="project_value",
            location="location_value",
        )
...
def test_list_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_operations.SqlOperationsListRequest(
            instance="instance_value",
            page_token="page_token_value",
            project="project_value",
            location="location_value",
...
def test_cancel(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.cancel), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_operations.SqlOperationsCancelRequest()
        assert args[0] == request
...
def test_cancel_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.cancel), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_operations.SqlOperationsCancelRequest(
            operation="operation_value",
            project="project_value",
            location="location_value",
        )
...
def test_sql_operations_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_operations_service.transports.SqlOperationsServiceTransport.__init__"
    ) as Transport:
...
def test_sql_operations_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sqladmin_v1.services.sql_operations_service.transports.SqlOperationsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

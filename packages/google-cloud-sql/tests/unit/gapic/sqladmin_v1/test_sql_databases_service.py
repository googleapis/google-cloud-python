...
from google.cloud.sqladmin_v1.services.sql_databases_service import (
...
def test_sql_databases_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_databases_service.transports.SqlDatabasesServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_delete(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        request = cloud_sql_databases.SqlDatabasesDeleteRequest()
...
def test_delete_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_databases.SqlDatabasesDeleteRequest(
            database="database_value",
            instance="instance_value",
            project="project_value",
        )
...
def test_get(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_databases.SqlDatabasesGetRequest()
        assert args[0] == request
...
def test_get_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_databases.SqlDatabasesGetRequest(
            database="database_value",
            instance="instance_value",
            project="project_value",
        )
...
def test_insert(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_databases.SqlDatabasesInsertRequest()
        assert args[0] == request
...
def test_insert_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_databases.SqlDatabasesInsertRequest(
            instance="instance_value",
            project="project_value",
        )
        assert args[0] == request_msg
...
def test_list(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_databases.SqlDatabasesListRequest()
        assert args[0] == request
...
def test_list_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_databases.SqlDatabasesListRequest(
            instance="instance_value",
            project="project_value",
        )
        assert args[0] == request_msg
...
def test_patch(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_databases.SqlDatabasesUpdateRequest()
        assert args[0] == request
...
def test_patch_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.patch), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_databases.SqlDatabasesUpdateRequest(
            database="database_value",
            instance="instance_value",
            project="project_value",
        )
...
def test_sql_databases_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_databases_service.transports.SqlDatabasesServiceTransport.__init__"
    ) as Transport:
...
def test_sql_databases_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sqladmin_v1.services.sql_databases_service.transports.SqlDatabasesServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

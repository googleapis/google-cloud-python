...
from google.cloud.sqladmin_v1.services.sql_backup_runs_service import (
...
def test__get_client_cert_source():
    ...
    assert SqlBackupRunsServiceClient._get_client_cert_source(None, False) is None
    assert (
        SqlBackupRunsServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SqlBackupRunsServiceClient._get_client_cert_source(None, True)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = SqlBackupRunsServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (SqlBackupRunsServiceClient, "grpc"),
        (SqlBackupRunsServiceAsyncClient, "grpc_asyncio"),
    ],
)
def test_sql_backup_runs_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_sql_backup_runs_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_sql_backup_runs_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(SqlBackupRunsServiceClient),
)
@mock.patch.object(
    SqlBackupRunsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SqlBackupRunsServiceAsyncClient),
)
def test_sql_backup_runs_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_sql_backup_runs_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [SqlBackupRunsServiceClient, SqlBackupRunsServiceAsyncClient]
)
@mock.patch.object(
    SqlBackupRunsServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SqlBackupRunsServiceClient),
)
@mock.patch.object(
    SqlBackupRunsServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(SqlBackupRunsServiceAsyncClient),
)
def test_sql_backup_runs_service_client_get_mtls_endpoint_and_cert_source(client_class):
...
def test_sql_backup_runs_service_client_client_api_endpoint(client_class):
    mock_client_cert_source = client_cert_source_callback
    api_override = "foo.com"
    default_universe = SqlBackupRunsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SqlBackupRunsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SqlBackupRunsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
...
def test_sql_backup_runs_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_sql_backup_runs_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_sql_backup_runs_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_sql_backup_runs_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_delete(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        request = cloud_sql_backup_runs.SqlBackupRunsDeleteRequest()
...
def test_delete_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backup_runs.SqlBackupRunsDeleteRequest(
            instance="instance_value",
            project="project_value",
        )
...
def test_delete_field_headers():
    ...
    assert (
        ...
        "project=project_value&instance=instance_value&id=205",
    ) in kw["metadata"]
...
def test_get(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_backup_runs.SqlBackupRunsGetRequest()
        assert args[0] == request
...
def test_get_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backup_runs.SqlBackupRunsGetRequest(
            instance="instance_value",
            project="project_value",
        )
        assert args[0] == request_msg
...
def test_insert(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = cloud_sql_backup_runs.SqlBackupRunsInsertRequest()
        assert args[0] == request
...
def test_insert_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backup_runs.SqlBackupRunsInsertRequest(
            instance="instance_value",
            project="project_value",
        )
        assert args[0] == request_msg
...
def test_list_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql_backup_runs.SqlBackupRunsListRequest(
            instance="instance_value",
            page_token="page_token_value",
            project="project_value",
        )
...
def test_list_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        assert all(isinstance(i, cloud_sql_backup_runs.BackupRun) for i in results)
...
async def test_list_async_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, cloud_sql_backup_runs.BackupRun) for i in responses)
...
def test_transport_kind_grpc_asyncio():
    transport = SqlBackupRunsServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_sql_backup_runs_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sqladmin_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport.__init__"
    ) as Transport:
...
def test_sql_backup_runs_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sqladmin_v1.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_sql_backup_runs_service_transport_auth_gdch_credentials(transport_class):
...
def test_sql_backup_runs_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_sql_backup_runs_service_host_no_port(transport_name):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_sql_backup_runs_service_host_with_port(transport_name):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
...
def test_sql_backup_runs_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.SqlBackupRunsServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = SqlBackupRunsServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize(
    ...
    [
        (SqlBackupRunsServiceClient, transports.SqlBackupRunsServiceGrpcTransport),
        (
            SqlBackupRunsServiceAsyncClient,
            transports.SqlBackupRunsServiceGrpcAsyncIOTransport,
        ),

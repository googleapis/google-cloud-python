...
from google.cloud.sql_v1.services.sql_users_service import (
...
def test_sql_users_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sql_v1.services.sql_users_service.transports.SqlUsersServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_sql_users_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sql_v1.services.sql_users_service.transports.SqlUsersServiceTransport.__init__"
    ) as Transport:
...
def test_sql_users_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sql_v1.services.sql_users_service.transports.SqlUsersServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

...
from google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SqlBackupRunsServiceClient, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.SqlBackupRunsServiceRestTransport, "rest"),
    ],
)
...
def test_sql_backup_runs_service_client_get_transport_class():
    ...
    available_transports = [
        ...
        transports.SqlBackupRunsServiceRestTransport,
    ]
...
def test_sql_backup_runs_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service.transports.SqlBackupRunsServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_delete_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.delete), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlBackupRunsDeleteRequest(
            instance="instance_value",
            project="project_value",
        )
...
def test_get_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.get), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlBackupRunsGetRequest(
            instance="instance_value",
            project="project_value",
        )
        assert args[0] == request_msg
...
def test_insert_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.insert), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlBackupRunsInsertRequest(
            instance="instance_value",
            project="project_value",
        )
        assert args[0] == request_msg
...
def test_list_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = cloud_sql.SqlBackupRunsListRequest(
            instance="instance_value",
            page_token="page_token_value",
            project="project_value",
        )
...
def test_list_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list), "__call__") as call:
        ...
        assert all(isinstance(i, cloud_sql_resources.BackupRun) for i in results)
...
async def test_list_async_pager():
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, cloud_sql_resources.BackupRun) for i in responses)
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            cloud_sql_resources.BackupRunsListResponse.to_json(x) for x in response
        )
        ...
        sample_request = {"project": "sample1", "instance": "sample2"}
...
def test_transport_kind_rest():
    transport = SqlBackupRunsServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_delete_rest_bad_request(request_type=cloud_sql.SqlBackupRunsDeleteRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "instance": "sample2", "id": 205}
...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.SqlBackupRunsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
        else transports.SqlBackupRunsServiceRestInterceptor(),
    )
    client = SqlBackupRunsServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_delete"
        ) as post,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_delete_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "pre_delete"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_sql.SqlBackupRunsDeleteRequest.pb(
            cloud_sql.SqlBackupRunsDeleteRequest()
        )
...
def test_get_rest_bad_request(request_type=cloud_sql.SqlBackupRunsGetRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_get_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        # Designate an appropriate value for the returned response.
        return_value = cloud_sql_resources.BackupRun(
            kind="kind_value",
            status=cloud_sql_resources.SqlBackupRunStatus.ENQUEUED,
            id=205,
            type_=cloud_sql_resources.SqlBackupRunType.AUTOMATED,
        ...
        # Convert return value to protobuf type
        return_value = cloud_sql_resources.BackupRun.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
        response_value.content = json_return_value.encode("UTF-8")
        req.return_value = response_value
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_get"
        ) as post,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_get_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "pre_get"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_sql.SqlBackupRunsGetRequest.pb(
            cloud_sql.SqlBackupRunsGetRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_sql_resources.BackupRun.to_json(
            cloud_sql_resources.BackupRun()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = cloud_sql_resources.BackupRun()
        post_with_metadata.return_value = cloud_sql_resources.BackupRun(), metadata
...
def test_insert_rest_bad_request(request_type=cloud_sql.SqlBackupRunsInsertRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_insert_rest_call_success(request_type):
    ...
    request_init["body"] = {
        "kind": "kind_value",
        "status": 1,
        "enqueued_time": {"seconds": 751, "nanos": 543},
        "id": 205,
        "start_time": {},
        "end_time": {},
        "error": {
    ...
    test_field = cloud_sql.SqlBackupRunsInsertRequest.meta.fields["body"]
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_insert"
        ) as post,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_insert_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "pre_insert"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_sql.SqlBackupRunsInsertRequest.pb(
            cloud_sql.SqlBackupRunsInsertRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_bad_request(request_type=cloud_sql.SqlBackupRunsListRequest):
    client = SqlBackupRunsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    # send a request that will satisfy transcoding
...
def test_list_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        # Designate an appropriate value for the returned response.
        return_value = cloud_sql_resources.BackupRunsListResponse(
            kind="kind_value",
            next_page_token="next_page_token_value",
        )
        ...
        # Convert return value to protobuf type
        return_value = cloud_sql_resources.BackupRunsListResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
        response_value.content = json_return_value.encode("UTF-8")
        req.return_value = response_value
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_list"
        ) as post,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "post_list_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.SqlBackupRunsServiceRestInterceptor, "pre_list"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = cloud_sql.SqlBackupRunsListRequest.pb(
            cloud_sql.SqlBackupRunsListRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_sql_resources.BackupRunsListResponse.to_json(
            cloud_sql_resources.BackupRunsListResponse()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = cloud_sql_resources.BackupRunsListResponse()
...
def test_sql_backup_runs_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport.__init__"
    ) as Transport:
...
def test_sql_backup_runs_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service.transports.SqlBackupRunsServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_sql_backup_runs_service_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
    with mock.patch(
        "google.auth.transport.requests.AuthorizedSession.configure_mtls_channel"
...
def test_sql_backup_runs_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = SqlBackupRunsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = SqlBackupRunsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )

...
from .base import DEFAULT_CLIENT_INFO, SqlUsersServiceTransport
...
class SqlUsersServiceGrpcAsyncIOTransport(SqlUsersServiceTransport):
    ...
    def get(
        ...
        [cloud_sql_users.SqlUsersGetRequest], Awaitable[cloud_sql_users.User]
    ]:
        ...
        if "get" not in self._stubs:
            self._stubs["get"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_users.SqlUsersGetRequest.serialize,
                response_deserializer=cloud_sql_users.User.deserialize,
            )
...
__all__ = ("SqlUsersServiceGrpcAsyncIOTransport",)

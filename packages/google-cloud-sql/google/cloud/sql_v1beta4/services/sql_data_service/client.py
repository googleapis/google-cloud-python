...
class SqlDataServiceClient(metaclass=SqlDataServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            SqlDataServiceClient._read_environment_variables()
        )
    ...
    def stream_sql_data(
        ...
        *,
        ...
        Args:
            requests (Iterator[google.cloud.sql_v1beta4.types.StreamSqlDataRequest]):
        ...
        Returns:
            Iterable[google.cloud.sql_v1beta4.types.StreamSqlDataResponse]:

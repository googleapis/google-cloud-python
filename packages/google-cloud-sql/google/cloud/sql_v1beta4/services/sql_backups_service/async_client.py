...
from google.cloud.sql_v1beta4.services.sql_backups_service import pagers
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_backup():
                # Create a client
                client = sql_v1beta4.SqlBackupsServiceAsyncClient()

                # Initialize request argument(s)
                backup = sql_v1beta4.Backup()
                backup.ttl_days = 868

                request = sql_v1beta4.CreateBackupRequest(
                    parent="parent_value",
                    backup=backup,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.CreateBackupRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            backup (:class:`google.cloud.sql_v1beta4.types.Backup`):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_backup():
                ...
                # Initialize request argument(s)
                request = sql_v1beta4.GetBackupRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.GetBackupRequest, dict]]):
        ...
        Returns:
            google.cloud.sql_v1beta4.types.Backup:
                A backup resource.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_backups():
                ...
                # Initialize request argument(s)
                request = sql_v1beta4.ListBackupsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.ListBackupsRequest, dict]]):
        ...
        Returns:
            google.cloud.sql_v1beta4.services.sql_backups_service.pagers.ListBackupsAsyncPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_backup():
                ...
                request = sql_v1beta4.UpdateBackupRequest(
                    backup=backup,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.UpdateBackupRequest, dict]]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_backup():
                ...
                # Initialize request argument(s)
                request = sql_v1beta4.DeleteBackupRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.DeleteBackupRequest, dict]]):

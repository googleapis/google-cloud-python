...
class SqlBackupsServiceClient(metaclass=SqlBackupsServiceClientMeta):
    ...
    def create_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.CreateBackupRequest, dict]):
    ...
    def get_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.GetBackupRequest, dict]):
    ...
    def list_backups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.ListBackupsRequest, dict]):
        ...
        Returns:
            google.cloud.sql_v1beta4.services.sql_backups_service.pagers.ListBackupsPager:
    ...
    def update_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.UpdateBackupRequest, dict]):
    ...
    def delete_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.DeleteBackupRequest, dict]):

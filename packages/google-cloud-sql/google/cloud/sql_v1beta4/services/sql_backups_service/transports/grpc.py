...
class SqlBackupsServiceGrpcTransport(SqlBackupsServiceTransport):
    ...
    def create_backup(
        ...
        if "create_backup" not in self._stubs:
            self._stubs["create_backup"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.CreateBackupRequest.serialize,
    ...
    def get_backup(
        ...
        if "get_backup" not in self._stubs:
            self._stubs["get_backup"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.GetBackupRequest.serialize,
                response_deserializer=cloud_sql_resources.Backup.deserialize,
            )
    ...
    def list_backups(
        ...
        if "list_backups" not in self._stubs:
            self._stubs["list_backups"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.ListBackupsRequest.serialize,
                response_deserializer=cloud_sql.ListBackupsResponse.deserialize,
            )
    ...
    def update_backup(
        ...
        Updates the retention period and the description of
        ...
        if "update_backup" not in self._stubs:
            self._stubs["update_backup"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.UpdateBackupRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def delete_backup(
        ...
        if "delete_backup" not in self._stubs:
            self._stubs["delete_backup"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.DeleteBackupRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )

...
class SqlBackupsServiceGrpcAsyncIOTransport(SqlBackupsServiceTransport):
    """gRPC AsyncIO backend transport for SqlBackupsService.
    ...
    def create_backup(
        ...
        [cloud_sql.CreateBackupRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
    ...
    def get_backup(
        self,
    ) -> Callable[[cloud_sql.GetBackupRequest], Awaitable[cloud_sql_resources.Backup]]:
    ...
    def list_backups(
        ...
        [cloud_sql.ListBackupsRequest], Awaitable[cloud_sql.ListBackupsResponse]
    ]:
    ...
    def update_backup(
        ...
        [cloud_sql.UpdateBackupRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
    ...
    def delete_backup(
        ...
        [cloud_sql.DeleteBackupRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
...
__all__ = ("SqlBackupsServiceGrpcAsyncIOTransport",)

...
class SqlInstancesServiceClient(metaclass=SqlInstancesServiceClientMeta):
    ...
    def add_server_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesAddServerCertificateRequest, dict]):
    ...
    def add_entra_id_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesAddEntraIdCertificateRequest, dict]):
    ...
    def demote(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesDemoteRequest, dict]):
    ...
    def reencrypt(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesReencryptRequest, dict]):
    ...
    def list_server_certificates(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesListServerCertificatesRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    def list_entra_id_certificates(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesListEntraIdCertificatesRequest, dict]):
    ...
    def switchover(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesSwitchoverRequest, dict]):
    ...
    def rotate_server_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesRotateServerCertificateRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    def rotate_entra_id_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesRotateEntraIdCertificateRequest, dict]):
                The request object. Request message for
    ...
    def perform_disk_shrink(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesPerformDiskShrinkRequest, dict]):
    ...
    def get_disk_shrink_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesGetDiskShrinkConfigRequest, dict]):
    ...
    def reset_replica_size(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesResetReplicaSizeRequest, dict]):
    ...
    def get_latest_recovery_time(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesGetLatestRecoveryTimeRequest, dict]):
    ...
    def execute_sql(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesExecuteSqlRequest, dict]):
    ...
    def acquire_ssrs_lease(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesAcquireSsrsLeaseRequest, dict]):
    ...
    def release_ssrs_lease(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesReleaseSsrsLeaseRequest, dict]):
    ...
    def pre_check_major_version_upgrade(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesPreCheckMajorVersionUpgradeRequest, dict]):
    ...
    def point_in_time_restore(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1beta4.types.SqlInstancesPointInTimeRestoreRequest, dict]):

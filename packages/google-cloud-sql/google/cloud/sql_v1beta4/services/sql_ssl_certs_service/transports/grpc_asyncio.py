...
class SqlSslCertsServiceGrpcAsyncIOTransport(SqlSslCertsServiceTransport):
    ...
    def delete(
        ...
        [cloud_sql.SqlSslCertsDeleteRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
    ...
    def get(
        ...
        [cloud_sql.SqlSslCertsGetRequest], Awaitable[cloud_sql_resources.SslCert]
    ]:
...
__all__ = ("SqlSslCertsServiceGrpcAsyncIOTransport",)

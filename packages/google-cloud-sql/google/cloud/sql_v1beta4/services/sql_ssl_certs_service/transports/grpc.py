...
from .base import DEFAULT_CLIENT_INFO, SqlSslCertsServiceTransport
...
class SqlSslCertsServiceGrpcTransport(SqlSslCertsServiceTransport):
    ...
    def delete(
        self,
    ) -> Callable[[cloud_sql.SqlSslCertsDeleteRequest], cloud_sql_resources.Operation]:
        ...
        if "delete" not in self._stubs:
            self._stubs["delete"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.SqlSslCertsDeleteRequest.serialize,
    ...
    def get(
        self,
    ) -> Callable[[cloud_sql.SqlSslCertsGetRequest], cloud_sql_resources.SslCert]:
        ...
        if "get" not in self._stubs:
            self._stubs["get"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.SqlSslCertsGetRequest.serialize,
    ...
    def insert(
        ...
        [cloud_sql.SqlSslCertsInsertRequest], cloud_sql_resources.SslCertsInsertResponse
    ]:
        ...
        if "insert" not in self._stubs:
            self._stubs["insert"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.SqlSslCertsInsertRequest.serialize,
                response_deserializer=cloud_sql_resources.SslCertsInsertResponse.deserialize,
            )
    ...
    def list(
        ...
        [cloud_sql.SqlSslCertsListRequest], cloud_sql_resources.SslCertsListResponse
    ]:
        ...
        if "list" not in self._stubs:
            self._stubs["list"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql.SqlSslCertsListRequest.serialize,
                response_deserializer=cloud_sql_resources.SslCertsListResponse.deserialize,
            )
...
__all__ = ("SqlSslCertsServiceGrpcTransport",)

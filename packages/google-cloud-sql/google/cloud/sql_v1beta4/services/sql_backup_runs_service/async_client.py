...
class SqlBackupRunsServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.sql_v1beta4.SqlBackupRunsServiceAsyncClient`.",
                extra={
    ...
    async def delete(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.SqlBackupRunsDeleteRequest, dict]]):
                The request object.
    ...
    async def get(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.SqlBackupRunsGetRequest, dict]]):
                The request object.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    async def insert(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.SqlBackupRunsInsertRequest, dict]]):
                The request object.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    async def list(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1beta4.types.SqlBackupRunsListRequest, dict]]):
                The request object.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.

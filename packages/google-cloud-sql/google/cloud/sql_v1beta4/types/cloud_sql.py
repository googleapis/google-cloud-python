...
class CreateBackupRequest(proto.Message):
    ...
    Attributes:
        ...
        backup (google.cloud.sql_v1beta4.types.Backup):
...
class ListBackupsResponse(proto.Message):
    ...
    Attributes:
        backups (MutableSequence[google.cloud.sql_v1beta4.types.Backup]):
            A list of backups.
        next_page_token (str):
...
class SqlInstancesDemoteRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            ...
            contains the instance.
        body (google.cloud.sql_v1beta4.types.InstancesDemoteRequest):
            The request body.
    """
...
class SqlInstancesResetSslConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Project ID of the project that contains the
            instance.
        mode (google.cloud.sql_v1beta4.types.SqlInstancesResetSslConfigRequest.ResetSslMode):
...
class SqlInstancesRotateServerCertificateRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1beta4.types.InstancesRotateServerCertificateRequest):
...
class SqlInstancesRotateEntraIdCertificateRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1beta4.types.InstancesRotateEntraIdCertificateRequest):
...
class SqlInstancesReencryptRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            ID of the project that contains the instance.
        body (google.cloud.sql_v1beta4.types.InstancesReencryptRequest):
...
class InstancesReencryptRequest(proto.Message):
    ...
    Attributes:
        backup_reencryption_config (google.cloud.sql_v1beta4.types.BackupReencryptionConfig):
...
class BackupReencryptionConfig(proto.Message):
    ...
    Attributes:
        ...
        backup_type (google.cloud.sql_v1beta4.types.BackupReencryptionConfig.BackupType):
...
class SqlInstancesPerformDiskShrinkRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Project ID of the project that contains the
            instance.
        body (google.cloud.sql_v1beta4.types.PerformDiskShrinkContext):
...
class SqlInstancesVerifyExternalSyncSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        migration_type (google.cloud.sql_v1beta4.types.SqlInstancesVerifyExternalSyncSettingsRequest.MigrationType):
        ...
        sync_parallel_level (google.cloud.sql_v1beta4.types.ExternalSyncParallelLevel):
            Optional. Parallel level for initial data
            sync. Only applicable for PostgreSQL.
        selected_objects (MutableSequence[google.cloud.sql_v1beta4.types.ExternalSyncSelectedObject]):
...
class SqlInstancesExecuteSqlRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1beta4.types.ExecuteSqlPayload):
            The request body.
    """
...
class ExecuteSqlPayload(proto.Message):
    ...
    Attributes:
        ...
        row_limit (int):
            ...
            per SQL statement.
        partial_result_mode (google.cloud.sql_v1beta4.types.ExecuteSqlPayload.PartialResultMode):
...
class SqlInstancesExecuteSqlResponse(proto.Message):
    ...
    Attributes:
        messages (MutableSequence[google.cloud.sql_v1beta4.types.SqlInstancesExecuteSqlResponse.Message]):
        ...
        metadata (google.cloud.sql_v1beta4.types.Metadata):
            The additional metadata information regarding
            the execution of the SQL statements.
        results (MutableSequence[google.cloud.sql_v1beta4.types.QueryResult]):
...
class QueryResult(proto.Message):
    ...
    Attributes:
        columns (MutableSequence[google.cloud.sql_v1beta4.types.Column]):
            List of columns included in the result. This
            also includes the data type of the column.
        rows (MutableSequence[google.cloud.sql_v1beta4.types.Row]):
...
class Row(proto.Message):
    ...
    Attributes:
        values (MutableSequence[google.cloud.sql_v1beta4.types.Value]):
...
class SqlInstancesAcquireSsrsLeaseRequest(proto.Message):
    ...
    Attributes:
        ...
        body (google.cloud.sql_v1beta4.types.InstancesAcquireSsrsLeaseRequest):
...
class SqlInstancesPreCheckMajorVersionUpgradeRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1beta4.types.InstancesPreCheckMajorVersionUpgradeRequest):
...
class SqlInstancesPointInTimeRestoreRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            projects/{project}
        context (google.cloud.sql_v1beta4.types.PointInTimeRestoreContext):
            Required. The context for request to perform

...
class ConnectSettings(proto.Message):
    ...
    Attributes:
        ...
        server_ca_mode (google.cloud.sql_v1beta4.types.ConnectSettings.CaMode):
        ...
        nodes (MutableSequence[google.cloud.sql_v1beta4.types.ConnectSettings.ConnectPoolNodeConfig]):
            Output only. Entries containing information
            about each read pool node of the read pool.
        mdx_protocol_support (MutableSequence[google.cloud.sql_v1beta4.types.ConnectSettings.MdxProtocolSupport]):

...
class CreateBackupRequest(proto.Message):
    ...
    Attributes:
        ...
        backup (google.cloud.sql_v1.types.Backup):
...
class ListBackupsResponse(proto.Message):
    ...
    Attributes:
        backups (MutableSequence[google.cloud.sql_v1.types.Backup]):
            A list of backups.
        next_page_token (str):
...
class Backup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.sql_v1.types.Backup.SqlBackupType):
        ...
        backup_interval (google.type.interval_pb2.Interval):
            ...
            aren't available.
        state (google.cloud.sql_v1.types.Backup.SqlBackupState):
        ...
        instance_deletion_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            deleted.
        instance_settings (google.cloud.sql_v1.types.DatabaseInstance):

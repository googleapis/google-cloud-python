...
class SqlInstancesDemoteRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            ...
            instance.
        body (google.cloud.sql_v1.types.InstancesDemoteRequest):
...
class SqlInstancesResetSslConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Project ID of the project that contains the
            instance.
        mode (google.cloud.sql_v1.types.SqlInstancesResetSslConfigRequest.ResetSslMode):
...
class SqlInstancesRotateServerCertificateRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1.types.InstancesRotateServerCertificateRequest):
...
class SqlInstancesRotateEntraIdCertificateRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1.types.InstancesRotateEntraIdCertificateRequest):
...
class SqlInstancesPerformDiskShrinkRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Project ID of the project that contains the
            instance.
        body (google.cloud.sql_v1.types.PerformDiskShrinkContext):
...
class SqlInstancesReencryptRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            ID of the project that contains the instance.
        body (google.cloud.sql_v1.types.InstancesReencryptRequest):
...
class InstancesReencryptRequest(proto.Message):
    ...
    Attributes:
        backup_reencryption_config (google.cloud.sql_v1.types.BackupReencryptionConfig):
...
class BackupReencryptionConfig(proto.Message):
    ...
    Attributes:
        ...
        backup_type (google.cloud.sql_v1.types.BackupReencryptionConfig.BackupType):
...
class SqlInstancesVerifyExternalSyncSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        migration_type (google.cloud.sql_v1.types.SqlInstancesVerifyExternalSyncSettingsRequest.MigrationType):
        ...
        sync_parallel_level (google.cloud.sql_v1.types.ExternalSyncParallelLevel):
            Optional. Parallel level for initial data
            sync. Only applicable for PostgreSQL.
        selected_objects (MutableSequence[google.cloud.sql_v1.types.ExternalSyncSelectedObject]):
...
class InstancesDemoteRequest(proto.Message):
    ...
    Attributes:
        demote_context (google.cloud.sql_v1.types.DemoteContext):
...
class InstancesListResponse(proto.Message):
    ...
    Attributes:
        ...
        warnings (MutableSequence[google.cloud.sql_v1.types.ApiWarning]):
            List of warnings that occurred while handling
            the request.
        items (MutableSequence[google.cloud.sql_v1.types.DatabaseInstance]):
...
class InstancesListServerCasResponse(proto.Message):
    ...
    Attributes:
        certs (MutableSequence[google.cloud.sql_v1.types.SslCert]):
...
class InstancesListServerCertificatesResponse(proto.Message):
    ...
    Attributes:
        ca_certs (MutableSequence[google.cloud.sql_v1.types.SslCert]):
            List of server CA certificates for the
            instance.
        server_certs (MutableSequence[google.cloud.sql_v1.types.SslCert]):
...
class InstancesRestoreBackupRequest(proto.Message):
    ...
    Attributes:
        ...
        restore_instance_settings (google.cloud.sql_v1.types.DatabaseInstance):
...
class InstancesRotateServerCertificateRequest(proto.Message):
    ...
    Attributes:
        rotate_server_certificate_context (google.cloud.sql_v1.types.RotateServerCertificateContext):
...
class InstancesRotateEntraIdCertificateRequest(proto.Message):
    ...
    Attributes:
        rotate_entra_id_certificate_context (google.cloud.sql_v1.types.RotateEntraIdCertificateContext):
            Optional. Contains details about the rotate
            server certificate operation.
    """
...
class SqlInstancesPreCheckMajorVersionUpgradeRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1.types.InstancesPreCheckMajorVersionUpgradeRequest):
...
class SqlInstancesVerifyExternalSyncSettingsResponse(proto.Message):
    ...
    Attributes:
        ...
        errors (MutableSequence[google.cloud.sql_v1.types.SqlExternalSyncSettingError]):
            List of migration violations.
        warnings (MutableSequence[google.cloud.sql_v1.types.SqlExternalSyncSettingError]):
...
class PointInTimeRestoreContext(proto.Message):
    ...
    Attributes:
        ...
        preferred_secondary_zone (str):
            ...
            This field is a member of `oneof`_ ``_preferred_secondary_zone``.
        target_instance_settings (google.cloud.sql_v1.types.DatabaseInstance):
...
class DatabaseInstance(proto.Message):
    ...
    Attributes:
        ...
        suspension_reason (MutableSequence[google.cloud.sql_v1.types.SqlSuspensionReason]):
        ...
        upgradable_database_versions (MutableSequence[google.cloud.sql_v1.types.AvailableDatabaseVersion]):
            Output only. All database versions that are
            available for upgrade.
        sql_network_architecture (google.cloud.sql_v1.types.DatabaseInstance.SqlNetworkArchitecture):
        ...
        replication_cluster (google.cloud.sql_v1.types.ReplicationCluster):
        ...
        gemini_config (google.cloud.sql_v1.types.GeminiInstanceConfig):
        ...
        nodes (MutableSequence[google.cloud.sql_v1.types.DatabaseInstance.PoolNodeConfig]):
...
class OnPremisesConfiguration(proto.Message):
    ...
    Attributes:
        ...
        source_instance (google.cloud.sql_v1.types.InstanceReference):
            ...
            source is Cloud SQL.
        selected_objects (MutableSequence[google.cloud.sql_v1.types.SelectedObjects]):
            Optional. A list of objects that the user
            selects for replication from an external source
            instance.
        ssl_option (google.cloud.sql_v1.types.OnPremisesConfiguration.SslOption):
...
class SqlInstancesExecuteSqlRequest(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            Required. Project ID of the project that
            contains the instance.
        body (google.cloud.sql_v1.types.ExecuteSqlPayload):
            The request body.
    """
...
class ExecuteSqlPayload(proto.Message):
    ...
    Attributes:
        ...
        row_limit (int):
            ...
            per SQL statement.
        partial_result_mode (google.cloud.sql_v1.types.ExecuteSqlPayload.PartialResultMode):
...
class SqlInstancesExecuteSqlResponse(proto.Message):
    ...
    Attributes:
        messages (MutableSequence[google.cloud.sql_v1.types.SqlInstancesExecuteSqlResponse.Message]):
        ...
        metadata (google.cloud.sql_v1.types.Metadata):
            The additional metadata information regarding
            the execution of the SQL statements.
        results (MutableSequence[google.cloud.sql_v1.types.QueryResult]):
...
class QueryResult(proto.Message):
    ...
    Attributes:
        columns (MutableSequence[google.cloud.sql_v1.types.Column]):
            List of columns included in the result. This
            also includes the data type of the column.
        rows (MutableSequence[google.cloud.sql_v1.types.Row]):
...
class Row(proto.Message):
    ...
    Attributes:
        values (MutableSequence[google.cloud.sql_v1.types.Value]):
...
class SqlInstancesAcquireSsrsLeaseRequest(proto.Message):
    ...
    Attributes:
        ...
        body (google.cloud.sql_v1.types.InstancesAcquireSsrsLeaseRequest):
            Required. The request body.
    """
...
class SqlInstancesPointInTimeRestoreRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            projects/{project}
        context (google.cloud.sql_v1.types.PointInTimeRestoreContext):
            Required. The context for request to perform

...
class SqlFlagsListRequest(proto.Message):
    ...
    Attributes:
        database_version (str):
            ...
            versions.
        flag_scope (google.cloud.sql_v1.types.SqlFlagScope):
...
class FlagsListResponse(proto.Message):
    ...
    Attributes:
        ...
        items (MutableSequence[google.cloud.sql_v1.types.Flag]):
            List of flags.
    """
...
class Flag(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.sql_v1.types.SqlFlagType):
            ...
            ``skip_grant_tables``.
        applies_to (MutableSequence[google.cloud.sql_v1.types.SqlDatabaseVersion]):

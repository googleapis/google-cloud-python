...
class UserPasswordValidationPolicy(proto.Message):
    ...
    Attributes:
        ...
        enable_failed_attempts_check (bool):
            ...
            enabled.
        status (google.cloud.sql_v1.types.PasswordStatus):
...
class User(proto.Message):
    ...
    Attributes:
        ...
        instance (str):
            ...
            the project ID. Can be omitted for ``update`` because it is
        ...
        project (str):
            ...
            Can be omitted for ``update`` because it is already
        ...
        password_policy (google.cloud.sql_v1.types.UserPasswordValidationPolicy):
            User level password validation policy.
        dual_password_type (google.cloud.sql_v1.types.User.DualPasswordType):
            Dual password status for the user.

            This field is a member of `oneof`_ ``_dual_password_type``.
        iam_status (google.cloud.sql_v1.types.User.IamStatus):
...
class UsersListResponse(proto.Message):
    ...
    Attributes:
        ...
        items (MutableSequence[google.cloud.sql_v1.types.User]):

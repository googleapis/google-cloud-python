...
class SqlBackupsServiceAsyncClient:
    ...
    async def create_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.CreateBackupRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            backup (:class:`google.cloud.sql_v1.types.Backup`):
    ...
    async def get_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.GetBackupRequest, dict]]):
    ...
    async def list_backups(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.ListBackupsRequest, dict]]):
        ...
        Returns:
            google.cloud.sql_v1.services.sql_backups_service.pagers.ListBackupsAsyncPager:
    ...
    async def update_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.UpdateBackupRequest, dict]]):
    ...
    async def delete_backup(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.DeleteBackupRequest, dict]]):

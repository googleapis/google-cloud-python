...
from google.cloud.sql_v1.services.sql_backups_service import pagers
...
class SqlBackupsServiceClient(metaclass=SqlBackupsServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            SqlBackupsServiceClient._read_environment_variables()
        )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_backup():
                ...
                backup = sql_v1.Backup()
                backup.ttl_days = 868

                request = sql_v1.CreateBackupRequest(
                    parent="parent_value",
                    backup=backup,
                )
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.CreateBackupRequest, dict]):
    ...
    def get_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.GetBackupRequest, dict]):
        ...
        Returns:
            google.cloud.sql_v1.types.Backup:
                A backup resource.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
    ...
    def list_backups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.ListBackupsRequest, dict]):
        ...
        Returns:
            google.cloud.sql_v1.services.sql_backups_service.pagers.ListBackupsPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_backup():
                ...
                request = sql_v1.UpdateBackupRequest(
                    backup=backup,
                )
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.UpdateBackupRequest, dict]):
    ...
    def delete_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.DeleteBackupRequest, dict]):

...
from google.cloud.sql_v1.types import cloud_sql_backup_runs, cloud_sql_resources
...
class SqlBackupRunsServiceAsyncClient:
    ...
    parse_common_billing_account_path = staticmethod(
        SqlBackupRunsServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(SqlBackupRunsServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        SqlBackupRunsServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        SqlBackupRunsServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        SqlBackupRunsServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(SqlBackupRunsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        SqlBackupRunsServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(SqlBackupRunsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(
        SqlBackupRunsServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            SqlBackupRunsServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(SqlBackupRunsServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            SqlBackupRunsServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(SqlBackupRunsServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return SqlBackupRunsServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    get_transport_class = SqlBackupRunsServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the sql backup runs service async client.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.sql_v1.SqlBackupRunsServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete():
                # Create a client
                client = sql_v1.SqlBackupRunsServiceAsyncClient()

                # Initialize request argument(s)
                request = sql_v1.SqlBackupRunsDeleteRequest(
                )
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.SqlBackupRunsDeleteRequest, dict]]):
    ...
    async def get(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.SqlBackupRunsGetRequest, dict]]):
    ...
    async def insert(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.SqlBackupRunsInsertRequest, dict]]):
    ...
    async def list(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sql_v1.types.SqlBackupRunsListRequest, dict]]):
    ...
    async def __aenter__(self) -> "SqlBackupRunsServiceAsyncClient":
        return self
...
__all__ = ("SqlBackupRunsServiceAsyncClient",)

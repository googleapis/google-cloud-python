...
class SqlInstancesServiceGrpcTransport(SqlInstancesServiceTransport):
    ...
    def add_server_certificate(
        ...
        if "add_server_certificate" not in self._stubs:
            self._stubs["add_server_certificate"] = self._logged_channel.unary_unary(
                "/google.cloud.sql.v1.SqlInstancesService/AddServerCertificate",
                request_serializer=cloud_sql_instances.SqlInstancesAddServerCertificateRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def add_entra_id_certificate(
        ...
        if "add_entra_id_certificate" not in self._stubs:
            self._stubs["add_entra_id_certificate"] = self._logged_channel.unary_unary(
                "/google.cloud.sql.v1.SqlInstancesService/AddEntraIdCertificate",
                request_serializer=cloud_sql_instances.SqlInstancesAddEntraIdCertificateRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def clone(
        ...
        [cloud_sql_instances.SqlInstancesCloneRequest], cloud_sql_resources.Operation
    ]:
    ...
    def delete(
        ...
        [cloud_sql_instances.SqlInstancesDeleteRequest], cloud_sql_resources.Operation
    ]:
    ...
    def demote(
        ...
        [cloud_sql_instances.SqlInstancesDemoteRequest], cloud_sql_resources.Operation
    ]:
        ...
        if "demote" not in self._stubs:
            self._stubs["demote"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesDemoteRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def export(
        ...
        [cloud_sql_instances.SqlInstancesExportRequest], cloud_sql_resources.Operation
    ]:
    ...
    def failover(
        ...
        [cloud_sql_instances.SqlInstancesFailoverRequest], cloud_sql_resources.Operation
    ]:
    ...
    def reencrypt(
        ...
        if "reencrypt" not in self._stubs:
            self._stubs["reencrypt"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesReencryptRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def import_(
        ...
        [cloud_sql_instances.SqlInstancesImportRequest], cloud_sql_resources.Operation
    ]:
    ...
    def insert(
        ...
        [cloud_sql_instances.SqlInstancesInsertRequest], cloud_sql_resources.Operation
    ]:
    ...
    def list_server_certificates(
        ...
        if "list_server_certificates" not in self._stubs:
            self._stubs["list_server_certificates"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesListServerCertificatesRequest.serialize,
                response_deserializer=cloud_sql_instances.InstancesListServerCertificatesResponse.deserialize,
            )
        ...
        if "list_entra_id_certificates" not in self._stubs:
            self._stubs["list_entra_id_certificates"] = (
                self._logged_channel.unary_unary(
                    ...
                    request_serializer=cloud_sql_instances.SqlInstancesListEntraIdCertificatesRequest.serialize,
                    response_deserializer=cloud_sql_instances.InstancesListEntraIdCertificatesResponse.deserialize,
                )
            )
    ...
    def patch(
        ...
        [cloud_sql_instances.SqlInstancesPatchRequest], cloud_sql_resources.Operation
    ]:
    ...
    def switchover(
        ...
        if "switchover" not in self._stubs:
            self._stubs["switchover"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesSwitchoverRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def restart(
        ...
        [cloud_sql_instances.SqlInstancesRestartRequest], cloud_sql_resources.Operation
    ]:
    ...
    def rotate_server_certificate(
        ...
        if "rotate_server_certificate" not in self._stubs:
            self._stubs["rotate_server_certificate"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesRotateServerCertificateRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
        ...
        if "rotate_entra_id_certificate" not in self._stubs:
            self._stubs["rotate_entra_id_certificate"] = (
                self._logged_channel.unary_unary(
                    ...
                    request_serializer=cloud_sql_instances.SqlInstancesRotateEntraIdCertificateRequest.serialize,
                    response_deserializer=cloud_sql_resources.Operation.deserialize,
                )
            )
    ...
    def update(
        ...
        [cloud_sql_instances.SqlInstancesUpdateRequest], cloud_sql_resources.Operation
    ]:
    ...
    def perform_disk_shrink(
        ...
        if "perform_disk_shrink" not in self._stubs:
            self._stubs["perform_disk_shrink"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesPerformDiskShrinkRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def get_disk_shrink_config(
        ...
        if "get_disk_shrink_config" not in self._stubs:
            self._stubs["get_disk_shrink_config"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesGetDiskShrinkConfigRequest.serialize,
                response_deserializer=cloud_sql_instances.SqlInstancesGetDiskShrinkConfigResponse.deserialize,
            )
    ...
    def reset_replica_size(
        ...
        if "reset_replica_size" not in self._stubs:
            self._stubs["reset_replica_size"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesResetReplicaSizeRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
    ...
    def get_latest_recovery_time(
        ...
        if "get_latest_recovery_time" not in self._stubs:
            self._stubs["get_latest_recovery_time"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesGetLatestRecoveryTimeRequest.serialize,
                response_deserializer=cloud_sql_instances.SqlInstancesGetLatestRecoveryTimeResponse.deserialize,
            )
    ...
    def execute_sql(
        ...
        if "execute_sql" not in self._stubs:
            self._stubs["execute_sql"] = self._logged_channel.unary_unary(
                "/google.cloud.sql.v1.SqlInstancesService/ExecuteSql",
                request_serializer=cloud_sql_instances.SqlInstancesExecuteSqlRequest.serialize,
                response_deserializer=cloud_sql_instances.SqlInstancesExecuteSqlResponse.deserialize,
            )
    ...
    def acquire_ssrs_lease(
        ...
        if "acquire_ssrs_lease" not in self._stubs:
            self._stubs["acquire_ssrs_lease"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesAcquireSsrsLeaseRequest.serialize,
                response_deserializer=cloud_sql_instances.SqlInstancesAcquireSsrsLeaseResponse.deserialize,
            )
    ...
    def release_ssrs_lease(
        ...
        if "release_ssrs_lease" not in self._stubs:
            self._stubs["release_ssrs_lease"] = self._logged_channel.unary_unary(
                ...
                request_serializer=cloud_sql_instances.SqlInstancesReleaseSsrsLeaseRequest.serialize,
                response_deserializer=cloud_sql_instances.SqlInstancesReleaseSsrsLeaseResponse.deserialize,
            )
        ...
        if "pre_check_major_version_upgrade" not in self._stubs:
            self._stubs["pre_check_major_version_upgrade"] = (
                self._logged_channel.unary_unary(
                    ...
                    request_serializer=cloud_sql_instances.SqlInstancesPreCheckMajorVersionUpgradeRequest.serialize,
                    response_deserializer=cloud_sql_resources.Operation.deserialize,
                )
            )
    ...
    def point_in_time_restore(
        ...
        if "point_in_time_restore" not in self._stubs:
            self._stubs["point_in_time_restore"] = self._logged_channel.unary_unary(
                "/google.cloud.sql.v1.SqlInstancesService/PointInTimeRestore",
                request_serializer=cloud_sql_instances.SqlInstancesPointInTimeRestoreRequest.serialize,
                response_deserializer=cloud_sql_resources.Operation.deserialize,
            )
...
__all__ = ("SqlInstancesServiceGrpcTransport",)

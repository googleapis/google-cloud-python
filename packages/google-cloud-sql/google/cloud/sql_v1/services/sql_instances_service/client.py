...
class SqlInstancesServiceClient(metaclass=SqlInstancesServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            SqlInstancesServiceClient._read_environment_variables()
        )
    ...
    def add_server_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesAddServerCertificateRequest, dict]):
    ...
    def add_entra_id_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesAddEntraIdCertificateRequest, dict]):
    ...
    def demote(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesDemoteRequest, dict]):
    ...
    def reencrypt(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesReencryptRequest, dict]):
    ...
    def list_server_certificates(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesListServerCertificatesRequest, dict]):
    ...
    def list_entra_id_certificates(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesListEntraIdCertificatesRequest, dict]):
    ...
    def switchover(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesSwitchoverRequest, dict]):
    ...
    def rotate_server_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesRotateServerCertificateRequest, dict]):
    ...
    def rotate_entra_id_certificate(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesRotateEntraIdCertificateRequest, dict]):
                The request object. Instance rotate server certificate
                request.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
    ...
    def perform_disk_shrink(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesPerformDiskShrinkRequest, dict]):
    ...
    def get_disk_shrink_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesGetDiskShrinkConfigRequest, dict]):
    ...
    def reset_replica_size(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesResetReplicaSizeRequest, dict]):
    ...
    def get_latest_recovery_time(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesGetLatestRecoveryTimeRequest, dict]):
    ...
    def execute_sql(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesExecuteSqlRequest, dict]):
    ...
    def acquire_ssrs_lease(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesAcquireSsrsLeaseRequest, dict]):
    ...
    def release_ssrs_lease(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesReleaseSsrsLeaseRequest, dict]):
    ...
    def pre_check_major_version_upgrade(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesPreCheckMajorVersionUpgradeRequest, dict]):
    ...
    def point_in_time_restore(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.sql_v1.types.SqlInstancesPointInTimeRestoreRequest, dict]):

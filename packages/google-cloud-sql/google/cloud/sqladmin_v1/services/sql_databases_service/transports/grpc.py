...
class SqlDatabasesServiceGrpcTransport(SqlDatabasesServiceTransport):
    ...
    def delete(
        ...
        [cloud_sql_databases.SqlDatabasesDeleteRequest], cloud_sql_resources.Operation
    ]:
    ...
    def get(
        ...
        [cloud_sql_databases.SqlDatabasesGetRequest], cloud_sql_resources.Database
    ]:
    ...
    def insert(
        ...
        [cloud_sql_databases.SqlDatabasesInsertRequest], cloud_sql_resources.Operation
    ]:
        r"""Return a callable for the insert method over gRPC.

        Inserts a resource containing information about a database
    ...
    def patch(
        ...
        [cloud_sql_databases.SqlDatabasesUpdateRequest], cloud_sql_resources.Operation
    ]:
...
__all__ = ("SqlDatabasesServiceGrpcTransport",)

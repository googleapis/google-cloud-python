...
from google.cloud.sqladmin_v1.types import cloud_sql_databases, cloud_sql_resources
...
class SqlDatabasesServiceClient(metaclass=SqlDatabasesServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.sql_v1.SqlDatabasesServiceClient`.",
                    extra={
    ...
    def delete(
        self,
        request: Optional[
            Union[cloud_sql_databases.SqlDatabasesDeleteRequest, dict]
        ] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = sqladmin_v1.SqlDatabasesDeleteRequest(
                )
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1.types.SqlDatabasesDeleteRequest, dict]):
    ...
    def get(
        self,
        request: Optional[
            Union[cloud_sql_databases.SqlDatabasesGetRequest, dict]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = sqladmin_v1.SqlDatabasesGetRequest(
                )
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1.types.SqlDatabasesGetRequest, dict]):
        ...
        Returns:
            google.cloud.sqladmin_v1.types.Database:
    ...
    def insert(
        self,
        request: Optional[
            Union[cloud_sql_databases.SqlDatabasesInsertRequest, dict]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        **Note:** You can't modify the default character set and
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = sqladmin_v1.SqlDatabasesInsertRequest(
                )
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1.types.SqlDatabasesInsertRequest, dict]):
    ...
    def list(
        self,
        request: Optional[
            Union[cloud_sql_databases.SqlDatabasesListRequest, dict]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1.types.SqlDatabasesListRequest, dict]):
        ...
        Returns:
            google.cloud.sqladmin_v1.types.DatabasesListResponse:
    ...
    def patch(
        self,
        request: Optional[
            Union[cloud_sql_databases.SqlDatabasesUpdateRequest, dict]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = sqladmin_v1.SqlDatabasesUpdateRequest(
                )
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1.types.SqlDatabasesUpdateRequest, dict]):

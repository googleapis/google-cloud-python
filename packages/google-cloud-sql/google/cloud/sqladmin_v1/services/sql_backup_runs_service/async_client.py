...
class SqlBackupRunsServiceAsyncClient:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete():
                # Create a client
                client = sqladmin_v1.SqlBackupRunsServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1.types.SqlBackupRunsDeleteRequest, dict]]):
    ...
    async def get(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1.types.SqlBackupRunsGetRequest, dict]]):
    ...
    async def insert(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1.types.SqlBackupRunsInsertRequest, dict]]):
    ...
    async def list(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1.types.SqlBackupRunsListRequest, dict]]):
        ...
        Returns:
            google.cloud.sqladmin_v1.services.sql_backup_runs_service.pagers.ListAsyncPager:

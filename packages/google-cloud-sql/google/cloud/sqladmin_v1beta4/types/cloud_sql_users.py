...
class UserPasswordValidationPolicy(proto.Message):
    ...
    Attributes:
        ...
        enable_failed_attempts_check (bool):
            ...
            enabled.
        status (google.cloud.sqladmin_v1beta4.types.PasswordStatus):
...
class User(proto.Message):
    ...
    Attributes:
        ...
        project (str):
            ...
            <b>update</b> because it is already specified on
            the URL.
        type_ (google.cloud.sqladmin_v1beta4.types.User.SqlUserType):
        ...
        sqlserver_user_details (google.cloud.sqladmin_v1beta4.types.SqlServerUserDetails):
        ...
        password_policy (google.cloud.sqladmin_v1beta4.types.UserPasswordValidationPolicy):
            User level password validation policy.
        dual_password_type (google.cloud.sqladmin_v1beta4.types.User.DualPasswordType):
            Dual password status for the user.

            This field is a member of `oneof`_ ``_dual_password_type``.
        iam_status (google.cloud.sqladmin_v1beta4.types.User.IamStatus):
...
class UsersListResponse(proto.Message):
    ...
    Attributes:
        ...
        items (MutableSequence[google.cloud.sqladmin_v1beta4.types.User]):

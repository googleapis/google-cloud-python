...
class SqlSslCertsServiceTransport(abc.ABC):
    ...
    def delete(
        ...
        [cloud_sql.SqlSslCertsDeleteRequest],
    ...
    def get(
        ...
        [cloud_sql.SqlSslCertsGetRequest],
    ...
    def insert(
        ...
        [cloud_sql.SqlSslCertsInsertRequest],
        Union[
            cloud_sql_resources.SslCertsInsertResponse,
            Awaitable[cloud_sql_resources.SslCertsInsertResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [cloud_sql.SqlSslCertsListRequest],
        Union[
            cloud_sql_resources.SslCertsListResponse,
            Awaitable[cloud_sql_resources.SslCertsListResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("SqlSslCertsServiceTransport",)

...
class SqlDataServiceAsyncClient:
    ...
    def stream_sql_data(
        ...
        *,
        ...
        Args:
            requests (AsyncIterator[`google.cloud.sqladmin_v1beta4.types.StreamSqlDataRequest`]):
        ...
        Returns:
            AsyncIterable[google.cloud.sqladmin_v1beta4.types.StreamSqlDataResponse]:

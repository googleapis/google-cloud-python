...
from .grpc import SqlDataServiceGrpcTransport
...
class SqlDataServiceGrpcAsyncIOTransport(SqlDataServiceTransport):
    """gRPC AsyncIO backend transport for SqlDataService.
    ...
    def stream_sql_data(
        ...
        [cloud_sql_data.StreamSqlDataRequest],
        Awaitable[cloud_sql_data.StreamSqlDataResponse],
    ]:
        ...
        Returns:
            Callable[[~.StreamSqlDataRequest],
                    Awaitable[~.StreamSqlDataResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.stream_sql_data: self._wrap_method(
                self.stream_sql_data,
...
__all__ = ("SqlDataServiceGrpcAsyncIOTransport",)

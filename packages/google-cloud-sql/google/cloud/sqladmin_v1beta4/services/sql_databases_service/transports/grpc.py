...
class SqlDatabasesServiceGrpcTransport(SqlDatabasesServiceTransport):
    ...
    def delete(
        self,
    ) -> Callable[[cloud_sql.SqlDatabasesDeleteRequest], cloud_sql_resources.Operation]:
    ...
    def get(
        self,
    ) -> Callable[[cloud_sql.SqlDatabasesGetRequest], cloud_sql_resources.Database]:
    ...
    def insert(
        self,
    ) -> Callable[[cloud_sql.SqlDatabasesInsertRequest], cloud_sql_resources.Operation]:
    ...
    def list(
        ...
        [cloud_sql.SqlDatabasesListRequest], cloud_sql_resources.DatabasesListResponse
    ]:
    ...
    def patch(
        self,
    ) -> Callable[[cloud_sql.SqlDatabasesUpdateRequest], cloud_sql_resources.Operation]:

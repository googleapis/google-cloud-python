...
class SqlDatabasesServiceGrpcAsyncIOTransport(SqlDatabasesServiceTransport):
    ...
    def delete(
        ...
        [cloud_sql.SqlDatabasesDeleteRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
    ...
    def get(
        ...
        [cloud_sql.SqlDatabasesGetRequest], Awaitable[cloud_sql_resources.Database]
    ]:
    ...
    def insert(
        ...
        [cloud_sql.SqlDatabasesInsertRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
    ...
    def patch(
        ...
        [cloud_sql.SqlDatabasesUpdateRequest], Awaitable[cloud_sql_resources.Operation]
    ]:

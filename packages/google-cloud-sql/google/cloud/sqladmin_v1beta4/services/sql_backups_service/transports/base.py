...
class SqlBackupsServiceTransport(abc.ABC):
    """Abstract transport class for SqlBackupsService."""
    ...
    def get_backup(
        ...
        Union[cloud_sql_resources.Backup, Awaitable[cloud_sql_resources.Backup]],
    ]:
        raise NotImplementedError()
    ...
    def list_backups(
        ...
        Union[cloud_sql.ListBackupsResponse, Awaitable[cloud_sql.ListBackupsResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("SqlBackupsServiceTransport",)

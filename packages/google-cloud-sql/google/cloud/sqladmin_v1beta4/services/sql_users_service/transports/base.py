...
class SqlUsersServiceTransport(abc.ABC):
    """Abstract transport class for SqlUsersService."""
    ...
    def get(
        ...
        [cloud_sql_users.SqlUsersGetRequest],
        Union[cloud_sql_users.User, Awaitable[cloud_sql_users.User]],
    ]:
        raise NotImplementedError()
...
__all__ = ("SqlUsersServiceTransport",)

...
from .base import DEFAULT_CLIENT_INFO, SqlBackupRunsServiceTransport
...
class SqlBackupRunsServiceGrpcTransport(SqlBackupRunsServiceTransport):
    ...
    def delete(
        ...
        [cloud_sql.SqlBackupRunsDeleteRequest], cloud_sql_resources.Operation
    ]:
    ...
    def get(
        self,
    ) -> Callable[[cloud_sql.SqlBackupRunsGetRequest], cloud_sql_resources.BackupRun]:
    ...
    def insert(
        ...
        [cloud_sql.SqlBackupRunsInsertRequest], cloud_sql_resources.Operation
    ]:
    ...
    def list(
        ...
        [cloud_sql.SqlBackupRunsListRequest], cloud_sql_resources.BackupRunsListResponse
    ]:
...
__all__ = ("SqlBackupRunsServiceGrpcTransport",)

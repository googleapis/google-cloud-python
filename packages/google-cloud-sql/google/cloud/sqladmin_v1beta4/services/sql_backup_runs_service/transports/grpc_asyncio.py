...
class SqlBackupRunsServiceGrpcAsyncIOTransport(SqlBackupRunsServiceTransport):
    ...
    def delete(
        ...
        [cloud_sql.SqlBackupRunsDeleteRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
    ...
    def get(
        ...
        [cloud_sql.SqlBackupRunsGetRequest], Awaitable[cloud_sql_resources.BackupRun]
    ]:
    ...
    def insert(
        ...
        [cloud_sql.SqlBackupRunsInsertRequest], Awaitable[cloud_sql_resources.Operation]
    ]:
...
__all__ = ("SqlBackupRunsServiceGrpcAsyncIOTransport",)

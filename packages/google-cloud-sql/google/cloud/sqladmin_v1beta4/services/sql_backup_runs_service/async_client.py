...
class SqlBackupRunsServiceAsyncClient:
    ...
    async def delete(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsDeleteRequest, dict]]):
                The request object.
    ...
    async def get(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsGetRequest, dict]]):
                The request object.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    async def insert(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsInsertRequest, dict]]):
                The request object.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    async def list(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsListRequest, dict]]):
                The request object.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service.pagers.ListAsyncPager:

...
from google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service import pagers
...
from .transports.rest import SqlBackupRunsServiceRestTransport
...
class SqlBackupRunsServiceClient(metaclass=SqlBackupRunsServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.sql_v1beta4.SqlBackupRunsServiceClient`.",
                    extra={
    ...
    def delete(
        self,
        request: Optional[Union[cloud_sql.SqlBackupRunsDeleteRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = sqladmin_v1beta4.SqlBackupRunsDeleteRequest(
                )
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsDeleteRequest, dict]):
                The request object.
    ...
    def get(
        self,
        request: Optional[Union[cloud_sql.SqlBackupRunsGetRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsGetRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sqladmin_v1beta4.types.BackupRun:
    ...
    def insert(
        self,
        request: Optional[Union[cloud_sql.SqlBackupRunsInsertRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsInsertRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
    ...
    def list(
        self,
        request: Optional[Union[cloud_sql.SqlBackupRunsListRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.cloud.sqladmin_v1beta4.types.SqlBackupRunsListRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.sqladmin_v1beta4.services.sql_backup_runs_service.pagers.ListPager:

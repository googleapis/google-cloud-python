...
#
# Snippet for ResolveConnectSettings
...
async def sample_resolve_connect_settings():
    ...
    request = sqladmin_v1beta4.ResolveConnectSettingsRequest(
        dns_name="dns_name_value",
        location="location_value",
    )

    # Make the request
    response = await client.resolve_connect_settings(request=request)

...
# [START sqladmin_v1_generated_SqlBackupsService_DeleteBackup_sync]
...
def sample_delete_backup():
    ...
    request = sql_v1.DeleteBackupRequest(
        name="name_value",
    )
...
# [END sqladmin_v1_generated_SqlBackupsService_DeleteBackup_sync]

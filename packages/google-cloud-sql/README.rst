Python Client for Cloud SQL Admin
=================================

|preview| |pypi| |versions|

`Cloud SQL Admin`_: Cloud SQL Admin API
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-sql.svg
   :target: https://pypi.org/project/google-cloud-sql/
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-sql.svg
   :target: https://pypi.org/project/google-cloud-sql/
.. _Cloud SQL Admin: https://cloud.google.com/sql/
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-sql/latest/summary_overview
.. _Product Documentation:  https://cloud.google.com/sql/
...
3. `Enable the Cloud SQL Admin.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud SQL Admin.:  https://cloud.google.com/sql/
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-sql/samples
...
-  Read the `Client Library Documentation`_ for Cloud SQL Admin
   to see other available methods on the client.
-  Read the `Cloud SQL Admin Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud SQL Admin Product documentation:  https://cloud.google.com/sql/

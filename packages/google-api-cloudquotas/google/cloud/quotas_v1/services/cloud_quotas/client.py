...
from google.cloud.quotas_v1.services.cloud_quotas import pagers
...
class CloudQuotasClient(metaclass=CloudQuotasClientMeta):
    ...
    def quota_info_path(
        ...
        return "projects/{project}/locations/{location}/services/{service}/quotaInfos/{quota_info}".format(
            project=project,
            location=location,
            service=service,
    ...
    def parse_quota_info_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/services/(?P<service>.+?)/quotaInfos/(?P<quota_info>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def quota_preference_path(
        project: str,
        location: str,
        quota_preference: str,
    ) -> str:
        """Returns a fully-qualified quota_preference string."""
        return "projects/{project}/locations/{location}/quotaPreferences/{quota_preference}".format(
            project=project,
            location=location,
    ...
    def parse_quota_preference_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/quotaPreferences/(?P<quota_preference>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(transport, CloudQuotasTransport):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_quota_infos():
                ...
                request = quotas_v1.ListQuotaInfosRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.quotas_v1.types.ListQuotaInfosRequest, dict]):
        ...
        Returns:
            google.cloud.quotas_v1.services.cloud_quotas.pagers.ListQuotaInfosPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_quota_info():
                ...
                # Initialize request argument(s)
                request = quotas_v1.GetQuotaInfoRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.quotas_v1.types.GetQuotaInfoRequest, dict]):
        ...
        Returns:
            google.cloud.quotas_v1.types.QuotaInfo:
    ...
    def list_quota_preferences(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.quotas_v1.types.ListQuotaPreferencesRequest, dict]):
                The request object. Message for requesting list of
                QuotaPreferences
            parent (str):
        ...
        Returns:
            google.cloud.quotas_v1.services.cloud_quotas.pagers.ListQuotaPreferencesPager:
                Message for response to listing
                QuotaPreferences
                Iterating over this object will yield
                results and resolve additional pages
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_quota_preference():
                ...
                # Initialize request argument(s)
                request = quotas_v1.GetQuotaPreferenceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.quotas_v1.types.GetQuotaPreferenceRequest, dict]):
        ...
        Returns:
            google.cloud.quotas_v1.types.QuotaPreference:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_quota_preference():
                ...
                # Initialize request argument(s)
                quota_preference = quotas_v1.QuotaPreference()
                ...
                request = quotas_v1.CreateQuotaPreferenceRequest(
                    parent="parent_value",
                    quota_preference=quota_preference,
                )
        ...
        Args:
            request (Union[google.cloud.quotas_v1.types.CreateQuotaPreferenceRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            quota_preference (google.cloud.quotas_v1.types.QuotaPreference):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_quota_preference():
                ...
                request = quotas_v1.UpdateQuotaPreferenceRequest(
                    quota_preference=quota_preference,
                )
        ...
        Args:
            request (Union[google.cloud.quotas_v1.types.UpdateQuotaPreferenceRequest, dict]):

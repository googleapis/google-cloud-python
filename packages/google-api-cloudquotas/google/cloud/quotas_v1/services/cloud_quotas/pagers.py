...
class ListQuotaInfosPager:
    ...
    :class:`google.cloud.quotas_v1.types.ListQuotaInfosResponse` object, and
    ...
    All the usual :class:`google.cloud.quotas_v1.types.ListQuotaInfosResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.quotas_v1.types.ListQuotaInfosRequest):
                The initial request object.
            response (google.cloud.quotas_v1.types.ListQuotaInfosResponse):
...
class ListQuotaPreferencesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.quotas_v1.types.ListQuotaPreferencesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.quotas_v1.types.ListQuotaPreferencesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.quotas_v1.types.ListQuotaPreferencesRequest):
                The initial request object.
            response (google.cloud.quotas_v1.types.ListQuotaPreferencesResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """

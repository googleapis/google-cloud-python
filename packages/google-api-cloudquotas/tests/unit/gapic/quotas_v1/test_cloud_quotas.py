...
from google.cloud.quotas_v1.services.cloud_quotas import (
...
def test_cloud_quotas_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_cloud_quotas_base_transport():
    ...
    with mock.patch(
        "google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasTransport.__init__"
    ) as Transport:
...
def test_cloud_quotas_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.quotas_v1.services.cloud_quotas.transports.CloudQuotasTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

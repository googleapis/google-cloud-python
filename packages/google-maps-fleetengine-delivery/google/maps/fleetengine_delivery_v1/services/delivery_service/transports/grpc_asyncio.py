...
class DeliveryServiceGrpcAsyncIOTransport(DeliveryServiceTransport):
    """gRPC AsyncIO backend transport for DeliveryService.
    ...
    def batch_create_tasks(
        ...
        Returns:
            Callable[[~.BatchCreateTasksRequest],
                    Awaitable[~.BatchCreateTasksResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_delivery_vehicles(
        ...
        Returns:
            Callable[[~.ListDeliveryVehiclesRequest],
                    Awaitable[~.ListDeliveryVehiclesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.delete_delivery_vehicle: self._wrap_method(

...
class DeliveryServiceTransport(abc.ABC):
    """Abstract transport class for DeliveryService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_delivery_vehicle: gapic_v1.method.wrap_method(
            ...
            self.get_delivery_vehicle: gapic_v1.method.wrap_method(
            ...
            self.get_task_tracking_info: gapic_v1.method.wrap_method(
            ...
            self.list_delivery_vehicles: gapic_v1.method.wrap_method(
...
__all__ = ("DeliveryServiceTransport",)

...
from .types.delivery_vehicles import DeliveryVehicle, LocationInfo, VehicleJourneySegment, VehicleStop
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.maps.fleetengine_delivery_v1")  # type: ignore
    api_core.check_dependency_versions("google.maps.fleetengine_delivery_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.fleetengine_delivery_v1"

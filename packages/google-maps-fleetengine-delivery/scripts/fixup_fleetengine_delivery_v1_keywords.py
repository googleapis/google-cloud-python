...
class fleetengine_deliveryCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    *,
    transformer=fleetengine_deliveryCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the fleetengine_delivery client library.

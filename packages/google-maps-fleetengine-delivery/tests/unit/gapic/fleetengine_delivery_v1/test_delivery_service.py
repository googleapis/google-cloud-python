...
def test_get_delivery_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_delivery_vehicle] = (
            mock_rpc
        )
        request = {}
...
def test_delete_delivery_vehicle(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_delivery_vehicle), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_delete_delivery_vehicle_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_delivery_vehicle
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_delivery_vehicle_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_delivery_vehicle
            in client._client._transport._wrapped_methods
        )
...
def test_get_task_tracking_info_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_task_tracking_info] = (
            mock_rpc
        )
        request = {}
...
def test_list_delivery_vehicles_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_delivery_vehicles] = (
            mock_rpc
        )
        request = {}
...
def test_create_delivery_vehicle_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateDeliveryVehicle,
...
def test_get_delivery_vehicle_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetDeliveryVehicle,
...
def test_delete_delivery_vehicle_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteDeliveryVehicle,
...
def test_update_delivery_vehicle_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateDeliveryVehicle,
...
def test_get_task_tracking_info_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetTaskTrackingInfo,
...
def test_list_delivery_vehicles_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListDeliveryVehicles,
...
def test_delete_delivery_vehicle_rest_bad_request(
    request_type=delivery_api.DeleteDeliveryVehicleRequest,
):
    client = DeliveryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"

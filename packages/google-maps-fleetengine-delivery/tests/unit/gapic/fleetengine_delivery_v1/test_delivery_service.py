...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert DeliveryServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert DeliveryServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                DeliveryServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        DeliveryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        DeliveryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == DeliveryServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_delivery_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "fleetengine.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://fleetengine.googleapis.com"
        )
...
async def test_list_delivery_vehicles_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_delivery_vehicles), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_delivery_vehicles(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_delivery_vehicle_rest_required_fields(request_type=delivery_api.DeleteDeliveryVehicleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_delivery_vehicle._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_delivery_vehicle_rest_required_fields(request_type=delivery_api.UpdateDeliveryVehicleRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_delivery_vehicle._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_task_tracking_info_rest_required_fields(request_type=delivery_api.GetTaskTrackingInfoRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_task_tracking_info._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_delivery_vehicles_rest_required_fields(request_type=delivery_api.ListDeliveryVehiclesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_delivery_vehicles._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = DeliveryServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = DeliveryServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DeliveryServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = DeliveryServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_create_delivery_vehicle_rest_call_success(request_type):
    ...
    request_init["delivery_vehicle"] = {
        ...
        "remaining_vehicle_journey_segments": [
            {
                "stop": {
                    ...
                    "tasks": [{"task_id": "task_id_value", "task_duration": {}, "target_time_window": {"start_time": {}, "end_time": {}}}],
                    "state": 1,
                },
        ...
        "attributes": [
            {"key": "key_value", "value": "value_value", "string_value": "string_value_value", "bool_value": True, "number_value": 0.1285}
        ],
        "type_": 1,
    }
...
def test_create_delivery_vehicle_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_create_delivery_vehicle") as post, mock.patch.object(
        transports.DeliveryServiceRestInterceptor, "post_create_delivery_vehicle_with_metadata"
...
def test_get_delivery_vehicle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_delivery_vehicle") as post, mock.patch.object(
        transports.DeliveryServiceRestInterceptor, "post_get_delivery_vehicle_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_delivery_vehicle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_delete_delivery_vehicle") as pre:
        pre.assert_not_called()
...
def test_update_delivery_vehicle_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_update_delivery_vehicle") as post, mock.patch.object(
        transports.DeliveryServiceRestInterceptor, "post_update_delivery_vehicle_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_create_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_batch_create_tasks") as post, mock.patch.object(
        transports.DeliveryServiceRestInterceptor, "post_batch_create_tasks_with_metadata"
    ) as post_with_metadata, mock.patch.object(
            ...
            "remaining_vehicle_journey_segments": [
                {
                    "stop": {
                        "planned_location": {},
                        "tasks": [{"task_id": "task_id_value", "task_duration": {}, "target_time_window": {}}],
                        "state": 1,
                    },
...
def test_create_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_create_task") as post, mock.patch.object(
...
def test_get_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_task") as post, mock.patch.object(
...
def test_delete_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "pre_delete_task") as pre:
        pre.assert_not_called()
...
def test_update_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_update_task") as post, mock.patch.object(
...
def test_list_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_list_tasks") as post, mock.patch.object(
...
def test_get_task_tracking_info_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_get_task_tracking_info") as post, mock.patch.object(
        transports.DeliveryServiceRestInterceptor, "post_get_task_tracking_info_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_delivery_vehicles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DeliveryServiceRestInterceptor, "post_list_delivery_vehicles") as post, mock.patch.object(
        transports.DeliveryServiceRestInterceptor, "post_list_delivery_vehicles_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.DeliveryServiceGrpcTransport, grpc_helpers), (transports.DeliveryServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_delivery_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "fleetengine.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://fleetengine.googleapis.com:8000"
    )

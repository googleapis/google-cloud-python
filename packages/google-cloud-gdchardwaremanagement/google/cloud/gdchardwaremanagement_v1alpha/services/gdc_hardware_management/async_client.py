...
class GDCHardwareManagementAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            GDCHardwareManagementClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            GDCHardwareManagementClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    async def request_order_date_change(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.request_order_date_change
        ]

...
__lazy_modules__ = {
    "google.cloud.gdchardwaremanagement_v1alpha.services.gdc_hardware_management",
    "google.cloud.gdchardwaremanagement_v1alpha.types.resources",
    "google.cloud.gdchardwaremanagement_v1alpha.types.service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.gdchardwaremanagement_v1alpha")  # type: ignore
    api_core.check_dependency_versions("google.cloud.gdchardwaremanagement_v1alpha")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.gdchardwaremanagement_v1alpha"

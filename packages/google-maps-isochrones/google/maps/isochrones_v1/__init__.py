...
__lazy_modules__ = {
    "google.maps.isochrones_v1.services.isochrone_service",
    "google.maps.isochrones_v1.types.isochrones_service",
}
...
api_core.check_python_version("google.maps.isochrones_v1")
api_core.check_dependency_versions("google.maps.isochrones_v1")

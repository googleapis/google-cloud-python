...
##
# google-maps-isochrones documentation build configuration file
#
...
project = "google-maps-isochrones"
copyright = "2026, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Maps Client Libraries for google-maps-isochrones",
...
htmlhelp_basename = "google-maps-isochrones-doc"
...
latex_documents = [
    (
        root_doc,
        "google-maps-isochrones.tex",
        "google-maps-isochrones Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-maps-isochrones",
        "google-maps-isochrones Library",
        "APIs",
    )
]

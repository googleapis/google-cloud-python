...
description = "Google Developer Knowledge API client library"
...
extras = {}
url = "https://github.com/googleapis/google-cloud-python/tree/main/packages/google-developer-knowledge"

...
class DeveloperKnowledgeGrpcAsyncIOTransport(DeveloperKnowledgeTransport):
    """gRPC AsyncIO backend transport for DeveloperKnowledge.
    ...
    def search_document_chunks(
        ...
        Returns:
            Callable[[~.SearchDocumentChunksRequest],
                    Awaitable[~.SearchDocumentChunksResponse]]:
    ...
    def get_document(
        ...
        [developerknowledge.GetDocumentRequest], Awaitable[developerknowledge.Document]
    ]:
...
__all__ = ("DeveloperKnowledgeGrpcAsyncIOTransport",)

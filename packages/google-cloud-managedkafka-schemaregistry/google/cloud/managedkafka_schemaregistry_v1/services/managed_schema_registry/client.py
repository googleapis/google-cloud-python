...
class ManagedSchemaRegistryClient(metaclass=ManagedSchemaRegistryClientMeta):
    ...
    **Mode** represents the mode of a schema registry or a specific
    ...
    def parse_schema_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/schemas/ids/(?P<schema>.+?)$", path
        )
    ...
    def parse_schema_context_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/contexts/(?P<context>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_schema_subject_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/schemaRegistries/(?P<schema_registry>.+?)/subjects/(?P<subject>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or ManagedSchemaRegistryClient._get_api_endpoint(

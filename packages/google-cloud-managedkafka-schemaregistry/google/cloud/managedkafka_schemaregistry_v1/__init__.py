...
from .services.managed_schema_registry import ManagedSchemaRegistryAsyncClient, ManagedSchemaRegistryClient
...
from .types.schema_registry_resources import Context, Schema, SchemaConfig, SchemaMode, SchemaRegistry, SchemaSubject, SchemaVersion

if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.managedkafka_schemaregistry_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.managedkafka_schemaregistry_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.managedkafka_schemaregistry_v1"

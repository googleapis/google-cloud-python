...
api_core.check_python_version("google.cloud.managedkafka_schemaregistry_v1")
api_core.check_dependency_versions("google.cloud.managedkafka_schemaregistry_v1")

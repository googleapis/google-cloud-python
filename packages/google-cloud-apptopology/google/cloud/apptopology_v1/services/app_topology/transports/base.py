...
class AppTopologyTransport(abc.ABC):
    """Abstract transport class for AppTopology."""
    ...
    DEFAULT_HOST: str = "apptopology.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.generate_discovered_resources_topology: gapic_v1.method.wrap_method(
    ...
    def get_domain(
        ...
        [service.GetDomainRequest], Union[schema.Domain, Awaitable[schema.Domain]]
    ]:
        raise NotImplementedError()
    ...
    def list_domains(
        ...
        Union[service.ListDomainsResponse, Awaitable[service.ListDomainsResponse]],
    ]:
        raise NotImplementedError()

    ...
    class _GenerateDiscoveredResourcesTopology(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAppTopologyRestTransport._BaseGenerateDiscoveredResourcesTopology._get_transcoded_request(
                http_options, request
            )

            body = _BaseAppTopologyRestTransport._BaseGenerateDiscoveredResourcesTopology._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseAppTopologyRestTransport._BaseGenerateDiscoveredResourcesTopology._get_query_params_json(
                transcoded_request
            )
    ...
    class _GetDomain(_BaseAppTopologyRestTransport._BaseGetDomain, AppTopologyRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAppTopologyRestTransport._BaseGetDomain._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAppTopologyRestTransport._BaseGetDomain._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _GetSchema(_BaseAppTopologyRestTransport._BaseGetSchema, AppTopologyRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAppTopologyRestTransport._BaseGetSchema._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAppTopologyRestTransport._BaseGetSchema._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _ListDomains(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAppTopologyRestTransport._BaseListDomains._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAppTopologyRestTransport._BaseListDomains._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _GetLocation(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAppTopologyRestTransport._BaseGetLocation._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAppTopologyRestTransport._BaseGetLocation._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _ListLocations(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAppTopologyRestTransport._BaseListLocations._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = (
                _BaseAppTopologyRestTransport._BaseListLocations._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _CancelOperation(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAppTopologyRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            body = _BaseAppTopologyRestTransport._BaseCancelOperation._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseAppTopologyRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
    ...
    class _DeleteOperation(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAppTopologyRestTransport._BaseDeleteOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseAppTopologyRestTransport._BaseDeleteOperation._get_query_params_json(
                transcoded_request
            )
    ...
    class _GetOperation(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = (
                _BaseAppTopologyRestTransport._BaseGetOperation._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseAppTopologyRestTransport._BaseGetOperation._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _ListOperations(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseAppTopologyRestTransport._BaseListOperations._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseAppTopologyRestTransport._BaseListOperations._get_query_params_json(
                transcoded_request
            )

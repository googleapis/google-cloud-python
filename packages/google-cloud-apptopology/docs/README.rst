Python Client for App Topology
==============================
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-apptopology.svg
   :target: https://pypi.org/project/google-cloud-apptopology/
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-apptopology.svg
   :target: https://pypi.org/project/google-cloud-apptopology/
.. _App Topology: https://docs.cloud.google.com/app-topology
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-apptopology/latest/summary_overview
.. _Product Documentation:  https://docs.cloud.google.com/app-topology
...
3. `Enable the App Topology.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the App Topology.:  https://docs.cloud.google.com/app-topology
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-apptopology/samples
...
.. code-block:: console
    ...
    pip install google-cloud-apptopology
...
-  Read the `Client Library Documentation`_ for App Topology
   to see other available methods on the client.
-  Read the `App Topology Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _App Topology Product documentation:  https://docs.cloud.google.com/app-topology

...
from google.cloud.network_services_v1beta1.services.dep_service import (
...
def test_dep_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.network_services_v1beta1.services.dep_service.transports.DepServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_extension_bindings(request_type, transport: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_extension_bindings), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = dep.ListExtensionBindingsResponse(
            next_page_token="next_page_token_value",
            unreachable=["unreachable_value"],
        )
        response = client.list_extension_bindings(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListExtensionBindingsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_extension_bindings_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.list_extension_bindings(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = dep.ListExtensionBindingsRequest(
            parent="parent_value",
            page_token="page_token_value",
        )
        assert args[0] == request_msg
...
def test_list_extension_bindings_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_extension_bindings
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.list_extension_bindings(request)
...
@pytest.mark.asyncio
async def test_list_extension_bindings_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_extension_bindings
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.list_extension_bindings(request)
...
async def test_list_extension_bindings_async(
    request_type, transport: str = "grpc_asyncio"
):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.list_extension_bindings(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListExtensionBindingsAsyncPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_extension_bindings_field_headers():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_extension_bindings_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_extension_bindings_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.list_extension_bindings(
            parent="parent_value",
        )
...
def test_list_extension_bindings_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_extension_bindings_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_extension_bindings(
            parent="parent_value",
        )
...
@pytest.mark.asyncio
async def test_list_extension_bindings_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_extension_bindings(
            dep.ListExtensionBindingsRequest(),
            parent="parent_value",
        )


def test_list_extension_bindings_pager(transport_name: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pager = client.list_extension_bindings(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dep.ExtensionBinding) for i in results)


def test_list_extension_bindings_pages(transport_name: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_extension_bindings(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_extension_bindings_async_pager():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_extension_bindings),
        "__call__",
        new_callable=mock.AsyncMock,
    ) as call:
        # Set the response to a series of pages.
        ...
        async_pager = await client.list_extension_bindings(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        assert str(async_pager).startswith(f"{async_pager.__class__.__name__}<")
        ...
        assert len(responses) == 6
        assert all(isinstance(i, dep.ExtensionBinding) for i in responses)


@pytest.mark.asyncio
async def test_list_extension_bindings_async_pages():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_extension_bindings(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_extension_binding(request_type, transport: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_extension_binding), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = dep.ExtensionBinding(
            name="name_value",
            description="description_value",
            etag="etag_value",
            producer_extension="producer_extension_value",
            fail_open=True,
            priority=898,
        )
        response = client.get_extension_binding(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, dep.ExtensionBinding)
    assert response.name == "name_value"
    assert response.description == "description_value"
    assert response.etag == "etag_value"
    assert response.producer_extension == "producer_extension_value"
    assert response.fail_open is True
    assert response.priority == 898


def test_get_extension_binding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.get_extension_binding(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = dep.GetExtensionBindingRequest(
            name="name_value",
        )
        assert args[0] == request_msg


def test_get_extension_binding_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_extension_binding
            in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.get_extension_binding] = (
            mock_rpc
        )
        request = {}
        client.get_extension_binding(request)
...
@pytest.mark.asyncio
async def test_get_extension_binding_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_extension_binding
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.get_extension_binding(request)
...
async def test_get_extension_binding_async(
    request_type, transport: str = "grpc_asyncio"
):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.get_extension_binding(request)
...
def test_get_extension_binding_field_headers():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_extension_binding_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_extension_binding_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_extension_binding_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_extension_binding_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_extension_binding(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_get_extension_binding_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_extension_binding(
            dep.GetExtensionBindingRequest(),
            name="name_value",
        )
...
def test_create_extension_binding(request_type, transport: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_extension_binding), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.create_extension_binding(request)
...
def test_create_extension_binding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.create_extension_binding(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = dep.CreateExtensionBindingRequest(
            parent="parent_value",
            extension_binding_id="extension_binding_id_value",
        )
        assert args[0] == request_msg
...
def test_create_extension_binding_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_extension_binding
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.create_extension_binding(request)
...
@pytest.mark.asyncio
async def test_create_extension_binding_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_extension_binding
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.create_extension_binding(request)
...
async def test_create_extension_binding_async(
    request_type, transport: str = "grpc_asyncio"
):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.create_extension_binding(request)
...
def test_create_extension_binding_field_headers():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_extension_binding_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_extension_binding_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.create_extension_binding(
            parent="parent_value",
            extension_binding=dep.ExtensionBinding(name="name_value"),
            extension_binding_id="extension_binding_id_value",
        )
        ...
        mock_val = "parent_value"
        assert arg == mock_val
        arg = args[0].extension_binding
        mock_val = dep.ExtensionBinding(name="name_value")
        assert arg == mock_val
        arg = args[0].extension_binding_id
        mock_val = "extension_binding_id_value"
        assert arg == mock_val


def test_create_extension_binding_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_extension_binding_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_extension_binding(
            parent="parent_value",
            extension_binding=dep.ExtensionBinding(name="name_value"),
            extension_binding_id="extension_binding_id_value",
        )
...
@pytest.mark.asyncio
async def test_create_extension_binding_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_extension_binding(
            dep.CreateExtensionBindingRequest(),
            parent="parent_value",
            extension_binding=dep.ExtensionBinding(name="name_value"),
            extension_binding_id="extension_binding_id_value",
...
def test_update_extension_binding(request_type, transport: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.update_extension_binding), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.update_extension_binding(request)
...
def test_update_extension_binding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.update_extension_binding(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = dep.UpdateExtensionBindingRequest()
        assert args[0] == request_msg


def test_update_extension_binding_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_extension_binding
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.update_extension_binding(request)
...
@pytest.mark.asyncio
async def test_update_extension_binding_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_extension_binding
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.update_extension_binding(request)
...
async def test_update_extension_binding_async(
    request_type, transport: str = "grpc_asyncio"
):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.update_extension_binding(request)
...
def test_update_extension_binding_field_headers():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    request.extension_binding.name = "name_value"
    ...
    assert (
        "x-goog-request-params",
        "extension_binding.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_extension_binding_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_extension_binding_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.update_extension_binding(
            extension_binding=dep.ExtensionBinding(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_update_extension_binding_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_extension_binding_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_extension_binding(
            extension_binding=dep.ExtensionBinding(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
@pytest.mark.asyncio
async def test_update_extension_binding_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_extension_binding(
            dep.UpdateExtensionBindingRequest(),
            extension_binding=dep.ExtensionBinding(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_delete_extension_binding(request_type, transport: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_extension_binding), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.delete_extension_binding(request)
...
def test_delete_extension_binding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        client.delete_extension_binding(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = dep.DeleteExtensionBindingRequest(
            name="name_value",
            etag="etag_value",
        )
        assert args[0] == request_msg
...
def test_delete_extension_binding_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_extension_binding
            in client._transport._wrapped_methods
        )
        ...
        request = {}
        client.delete_extension_binding(request)
...
@pytest.mark.asyncio
async def test_delete_extension_binding_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_extension_binding
            in client._client._transport._wrapped_methods
        )
        ...
        request = {}
        await client.delete_extension_binding(request)
...
async def test_delete_extension_binding_async(
    request_type, transport: str = "grpc_asyncio"
):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.delete_extension_binding(request)
...
def test_delete_extension_binding_field_headers():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_extension_binding_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_extension_binding_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.delete_extension_binding(
            name="name_value",
        )
...
def test_delete_extension_binding_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_extension_binding_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_extension_binding(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_extension_binding_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_extension_binding(
            dep.DeleteExtensionBindingRequest(),
            name="name_value",
        )
...
def test_list_lb_traffic_extensions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*}/lbTrafficExtensions"
...
def test_get_lb_traffic_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/lbTrafficExtensions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_lb_traffic_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{lb_traffic_extension.name=projects/*/locations/*/lbTrafficExtensions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_lb_route_extensions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*}/lbRouteExtensions"
            % client.transport._host,
            args[1],
        )
...
def test_get_lb_route_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/lbRouteExtensions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_lb_route_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{lb_route_extension.name=projects/*/locations/*/lbRouteExtensions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_extension_bindings_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_list_extension_bindings_rest_required_fields(
    request_type=dep.ListExtensionBindingsRequest,
):
    transport_class = transports.DepServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseListExtensionBindings,
    ...
    # Designate an appropriate value for the returned response.
    return_value = dep.ListExtensionBindingsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = dep.ListExtensionBindingsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_extension_bindings_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_extension_bindings(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*}/extensionBindings"
            % client.transport._host,
            args[1],
        )


def test_list_extension_bindings_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_extension_bindings_rest_pager(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dep.ListExtensionBindingsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
        ...
        pager = client.list_extension_bindings(request=sample_request)
        ...
        pages = list(client.list_extension_bindings(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_get_extension_binding_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_get_extension_binding_rest_required_fields(
    request_type=dep.GetExtensionBindingRequest,
):
    transport_class = transports.DepServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseGetExtensionBinding,
    ...
    # Designate an appropriate value for the returned response.
    return_value = dep.ExtensionBinding()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = dep.ExtensionBinding.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_extension_binding_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/extensionBindings/sample3"
        }
        ...
        client.get_extension_binding(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/extensionBindings/*}"
            % client.transport._host,
            args[1],
        )


def test_get_extension_binding_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_extension_binding_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_create_extension_binding_rest_required_fields(
    request_type=dep.CreateExtensionBindingRequest,
):
    transport_class = transports.DepServiceRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["extension_binding_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(
        json_format.MessageToJson(pb_request, use_integers_for_enums=False)
    ...
    # verify fields with default values are dropped
    assert "extensionBindingId" not in jsonified_request

    default_values = getattr(
        transport_class._BaseCreateExtensionBinding,
    ...
    # verify required fields with default values are now present
    assert "extensionBindingId" in jsonified_request
    assert (
        jsonified_request["extensionBindingId"] == request_init["extension_binding_id"]
    )

    jsonified_request["parent"] = "parent_value"
    jsonified_request["extensionBindingId"] = "extension_binding_id_value"

    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("extensionBindingId",))

    # verify required fields with non-default values are left alone
    assert "parent" in jsonified_request
    assert jsonified_request["parent"] == "parent_value"
    assert "extensionBindingId" in jsonified_request
    assert jsonified_request["extensionBindingId"] == "extension_binding_id_value"
...
def test_create_extension_binding_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_extension_binding(**mock_args)
...
def test_create_extension_binding_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_extension_binding_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_update_extension_binding_rest_required_fields(
    request_type=dep.UpdateExtensionBindingRequest,
):
    transport_class = transports.DepServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseUpdateExtensionBinding,
...
def test_update_extension_binding_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_extension_binding(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{extension_binding.name=projects/*/locations/*/extensionBindings/*}"
            % client.transport._host,
            args[1],
        )


def test_update_extension_binding_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_extension_binding_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_delete_extension_binding_rest_required_fields(
    request_type=dep.DeleteExtensionBindingRequest,
):
    transport_class = transports.DepServiceRestTransport
    ...
    default_values = getattr(
        transport_class._BaseDeleteExtensionBinding,
...
def test_delete_extension_binding_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_extension_binding(**mock_args)
...
def test_delete_extension_binding_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_extension_bindings_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = dep.ListExtensionBindingsResponse()
        client.list_extension_bindings(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_extension_binding_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = dep.ExtensionBinding()
        client.get_extension_binding(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_extension_binding_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_extension_binding(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_extension_binding_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_extension_binding(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_extension_binding_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
        ...
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_extension_binding(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_extension_bindings_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_extension_bindings(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_extension_binding_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_extension_binding(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_extension_binding_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_extension_binding(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_extension_binding_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_extension_binding(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_extension_binding_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_extension_binding(request=None)
...
def test_list_extension_bindings_rest_bad_request(
    request_type=dep.ListExtensionBindingsRequest,
):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_list_extension_bindings_rest_call_success(request_type):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_extension_bindings_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.DepServiceRestInterceptor, "post_list_extension_bindings"
        ) as post,
        mock.patch.object(
            transports.DepServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DepServiceRestInterceptor, "pre_list_extension_bindings"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.ListExtensionBindingsRequest.pb(
            dep.ListExtensionBindingsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.ListExtensionBindingsResponse.to_json(
            dep.ListExtensionBindingsResponse()
        )
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = dep.ListExtensionBindingsResponse()
        post_with_metadata.return_value = dep.ListExtensionBindingsResponse(), metadata
...
def test_get_extension_binding_rest_bad_request(
    request_type=dep.GetExtensionBindingRequest,
):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_get_extension_binding_rest_call_success(request_type):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_extension_binding_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.DepServiceRestInterceptor, "post_get_extension_binding"
        ) as post,
        mock.patch.object(
            transports.DepServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DepServiceRestInterceptor, "pre_get_extension_binding"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.GetExtensionBindingRequest.pb(dep.GetExtensionBindingRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.ExtensionBinding.to_json(dep.ExtensionBinding())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = dep.ExtensionBinding()
        post_with_metadata.return_value = dep.ExtensionBinding(), metadata
...
def test_create_extension_binding_rest_bad_request(
    request_type=dep.CreateExtensionBindingRequest,
):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_create_extension_binding_rest_call_success(request_type):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request_init["extension_binding"] = {
        "name": "name_value",
        "create_time": {"seconds": 751, "nanos": 543},
        "update_time": {},
        "description": "description_value",
        ...
        "target": {
            ...
            "scope": {"parent": "parent_value", "resource_types": [1]},
        },
        "match_conditions": [
            {
                "to": {
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = dep.CreateExtensionBindingRequest.meta.fields["extension_binding"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["extension_binding"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["extension_binding"][field])):
                    del request_init["extension_binding"][field][i][subfield]
            else:
                del request_init["extension_binding"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_extension_binding_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(operation.Operation, "_set_result_from_operation"),
        mock.patch.object(
            transports.DepServiceRestInterceptor, "post_create_extension_binding"
        ) as post,
        mock.patch.object(
            transports.DepServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DepServiceRestInterceptor, "pre_create_extension_binding"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.CreateExtensionBindingRequest.pb(
            dep.CreateExtensionBindingRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_extension_binding_rest_bad_request(
    request_type=dep.UpdateExtensionBindingRequest,
):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_update_extension_binding_rest_call_success(request_type):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = dep.UpdateExtensionBindingRequest.meta.fields["extension_binding"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_extension_binding_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(operation.Operation, "_set_result_from_operation"),
        mock.patch.object(
            transports.DepServiceRestInterceptor, "post_update_extension_binding"
        ) as post,
        mock.patch.object(
            transports.DepServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DepServiceRestInterceptor, "pre_update_extension_binding"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.UpdateExtensionBindingRequest.pb(
            dep.UpdateExtensionBindingRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_extension_binding_rest_bad_request(
    request_type=dep.DeleteExtensionBindingRequest,
):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_delete_extension_binding_rest_call_success(request_type):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_extension_binding_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with (
        ...
        mock.patch.object(operation.Operation, "_set_result_from_operation"),
        mock.patch.object(
            transports.DepServiceRestInterceptor, "post_delete_extension_binding"
        ) as post,
        mock.patch.object(
            transports.DepServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.DepServiceRestInterceptor, "pre_delete_extension_binding"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.DeleteExtensionBindingRequest.pb(
            dep.DeleteExtensionBindingRequest()
        )
        transcode.return_value = {
            "method": "post",
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_extension_bindings_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_extension_binding_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_extension_binding_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_extension_binding_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_extension_binding_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_dep_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.network_services_v1beta1.services.dep_service.transports.DepServiceTransport.__init__"
    ) as Transport:
    ...
    methods = (
        ...
        "list_extension_bindings",
        "get_extension_binding",
        "create_extension_binding",
        "update_extension_binding",
        "delete_extension_binding",
        "set_iam_policy",
        "get_iam_policy",
...
def test_dep_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.network_services_v1beta1.services.dep_service.transports.DepServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_dep_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.list_extension_bindings._session
    session2 = client2.transport.list_extension_bindings._session
    assert session1 != session2
    session1 = client1.transport.get_extension_binding._session
    session2 = client2.transport.get_extension_binding._session
    assert session1 != session2
    session1 = client1.transport.create_extension_binding._session
    session2 = client2.transport.create_extension_binding._session
    assert session1 != session2
    session1 = client1.transport.update_extension_binding._session
    session2 = client2.transport.update_extension_binding._session
    assert session1 != session2
    session1 = client1.transport.delete_extension_binding._session
    session2 = client2.transport.delete_extension_binding._session
    assert session1 != session2
...
def test_extension_binding_path():
    project = "squid"
    location = "clam"
    extension_binding = "whelk"
    expected = "projects/{project}/locations/{location}/extensionBindings/{extension_binding}".format(
        project=project,
        location=location,
        extension_binding=extension_binding,
    )
    actual = DepServiceClient.extension_binding_path(
        project, location, extension_binding
    )
    assert expected == actual


def test_parse_extension_binding_path():
    expected = {
        "project": "octopus",
        "location": "oyster",
        "extension_binding": "nudibranch",
    }
    path = DepServiceClient.extension_binding_path(**expected)

    # Check that the path construction is reversible.
    actual = DepServiceClient.parse_extension_binding_path(path)
    assert expected == actual

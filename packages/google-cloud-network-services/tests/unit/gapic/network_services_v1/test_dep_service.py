...
from google.cloud.network_services_v1.services.dep_service import DepServiceAsyncClient, DepServiceClient, pagers, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert DepServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert DepServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                DepServiceClient._use_client_cert_effective()
...
def test_dep_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "networkservices.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://networkservices.googleapis.com"
        )
...
def test_list_lb_traffic_extensions(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_lb_traffic_extensions), "__call__") as call:
...
async def test_list_lb_traffic_extensions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_lb_traffic_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            dep.ListLbTrafficExtensionsResponse(
                lb_traffic_extensions=[
...
async def test_list_lb_traffic_extensions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_lb_traffic_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_lb_traffic_extensions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_lb_traffic_extension(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_lb_traffic_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_lb_route_extensions(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_lb_route_extensions), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_lb_route_extensions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_lb_route_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            dep.ListLbRouteExtensionsResponse(
                lb_route_extensions=[
...
async def test_list_lb_route_extensions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_lb_route_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_lb_route_extensions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_update_lb_route_extension(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_lb_route_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_list_lb_edge_extensions(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = dep.ListLbEdgeExtensionsResponse(
            next_page_token="next_page_token_value",
            unreachable=["unreachable_value"],
        )
        response = client.list_lb_edge_extensions(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListLbEdgeExtensionsPager)
    assert response.next_page_token == "next_page_token_value"
    assert response.unreachable == ["unreachable_value"]


def test_list_lb_edge_extensions_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_lb_edge_extensions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_lb_edge_extensions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_lb_edge_extensions] = mock_rpc
        request = {}
        client.list_lb_edge_extensions(request)
...
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_lb_edge_extensions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_lb_edge_extensions] = mock_rpc

        request = {}
        await client.list_lb_edge_extensions(request)
...
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_async(transport: str = "grpc_asyncio", request_type=dep.ListLbEdgeExtensionsRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        ...
        response = await client.list_lb_edge_extensions(request)
...
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dep.ListLbEdgeExtensionsResponse())
        await client.list_lb_edge_extensions(request)
...
def test_list_lb_edge_extensions_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.list_lb_edge_extensions(
            parent="parent_value",
        )
...
def test_list_lb_edge_extensions_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_lb_edge_extensions(
            parent="parent_value",
        )
...
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_lb_edge_extensions(
            dep.ListLbEdgeExtensionsRequest(),
            parent="parent_value",
        )


def test_list_lb_edge_extensions_pager(transport_name: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        ...
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("parent", ""),)),)
        pager = client.list_lb_edge_extensions(request={}, retry=retry, timeout=timeout)
...
def test_list_lb_edge_extensions_pages(transport_name: str = "grpc"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        ...
        pages = list(client.list_lb_edge_extensions(request={}).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.asyncio
async def test_list_lb_edge_extensions_async_pager():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )

    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            dep.ListLbEdgeExtensionsResponse(
                lb_edge_extensions=[
        ...
        async_pager = await client.list_lb_edge_extensions(
            request={},
        )
        assert async_pager.next_page_token == "abc"
        responses = []
...
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_async_pages():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_lb_edge_extensions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_lb_edge_extension(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = dep.LbEdgeExtension(
            name="name_value",
            description="description_value",
            forwarding_rules=["forwarding_rules_value"],
            load_balancing_scheme=dep.LoadBalancingScheme.INTERNAL_MANAGED,
        )
        response = client.get_lb_edge_extension(request)
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, dep.LbEdgeExtension)
    assert response.name == "name_value"
    assert response.description == "description_value"
    assert response.forwarding_rules == ["forwarding_rules_value"]
    assert response.load_balancing_scheme == dep.LoadBalancingScheme.INTERNAL_MANAGED
...
def test_get_lb_edge_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_lb_edge_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_lb_edge_extension] = mock_rpc
        request = {}
        client.get_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_get_lb_edge_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_lb_edge_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_lb_edge_extension] = mock_rpc

        request = {}
        await client.get_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_get_lb_edge_extension_async(transport: str = "grpc_asyncio", request_type=dep.GetLbEdgeExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.get_lb_edge_extension), "__call__") as call:
        ...
        response = await client.get_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_get_lb_edge_extension_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_lb_edge_extension), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dep.LbEdgeExtension())
        await client.get_lb_edge_extension(request)
...
def test_get_lb_edge_extension_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_get_lb_edge_extension_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_lb_edge_extension_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.get_lb_edge_extension), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_lb_edge_extension(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_get_lb_edge_extension_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_lb_edge_extension(
            dep.GetLbEdgeExtensionRequest(),
            name="name_value",
        )
...
def test_create_lb_edge_extension(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.create_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.create_lb_edge_extension(request)
...
def test_create_lb_edge_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_lb_edge_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_lb_edge_extension] = mock_rpc
        request = {}
        client.create_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_create_lb_edge_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_lb_edge_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_lb_edge_extension] = mock_rpc

        request = {}
        await client.create_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_create_lb_edge_extension_async(transport: str = "grpc_asyncio", request_type=dep.CreateLbEdgeExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.create_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        response = await client.create_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_create_lb_edge_extension_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_lb_edge_extension_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(type(client.transport.create_lb_edge_extension), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.create_lb_edge_extension(
            parent="parent_value",
            lb_edge_extension=dep.LbEdgeExtension(name="name_value"),
            lb_edge_extension_id="lb_edge_extension_id_value",
        )
        ...
        assert arg == mock_val
        arg = args[0].lb_edge_extension_id
        mock_val = "lb_edge_extension_id_value"
        assert arg == mock_val


def test_create_lb_edge_extension_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_lb_edge_extension_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.create_lb_edge_extension), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_lb_edge_extension(
            parent="parent_value",
            lb_edge_extension=dep.LbEdgeExtension(name="name_value"),
            lb_edge_extension_id="lb_edge_extension_id_value",
        )
...
@pytest.mark.asyncio
async def test_create_lb_edge_extension_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_lb_edge_extension(
            dep.CreateLbEdgeExtensionRequest(),
            parent="parent_value",
            lb_edge_extension=dep.LbEdgeExtension(name="name_value"),
            lb_edge_extension_id="lb_edge_extension_id_value",
...
def test_update_lb_edge_extension(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.update_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.update_lb_edge_extension(request)
...
def test_update_lb_edge_extension_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_lb_edge_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_lb_edge_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_lb_edge_extension] = mock_rpc
        request = {}
        client.update_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_update_lb_edge_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_lb_edge_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_lb_edge_extension] = mock_rpc

        request = {}
        await client.update_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_update_lb_edge_extension_async(transport: str = "grpc_asyncio", request_type=dep.UpdateLbEdgeExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.update_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        response = await client.update_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_update_lb_edge_extension_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_lb_edge_extension_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(type(client.transport.update_lb_edge_extension), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.update_lb_edge_extension(
            lb_edge_extension=dep.LbEdgeExtension(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_update_lb_edge_extension_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_lb_edge_extension_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.update_lb_edge_extension), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_lb_edge_extension(
            lb_edge_extension=dep.LbEdgeExtension(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
@pytest.mark.asyncio
async def test_update_lb_edge_extension_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_lb_edge_extension(
            dep.UpdateLbEdgeExtensionRequest(),
            lb_edge_extension=dep.LbEdgeExtension(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_delete_lb_edge_extension(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.delete_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
        response = client.delete_lb_edge_extension(request)
...
def test_delete_lb_edge_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_lb_edge_extension in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_lb_edge_extension] = mock_rpc
        request = {}
        client.delete_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_delete_lb_edge_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DepServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_lb_edge_extension in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_lb_edge_extension] = mock_rpc

        request = {}
        await client.delete_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_delete_lb_edge_extension_async(transport: str = "grpc_asyncio", request_type=dep.DeleteLbEdgeExtensionRequest):
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.delete_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        response = await client.delete_lb_edge_extension(request)
...
@pytest.mark.asyncio
async def test_delete_lb_edge_extension_field_headers_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_lb_edge_extension_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_lb_edge_extension_flattened_error():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_lb_edge_extension_flattened_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.delete_lb_edge_extension), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_lb_edge_extension(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_lb_edge_extension_flattened_error_async():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_lb_edge_extension(
            dep.DeleteLbEdgeExtensionRequest(),
            name="name_value",
        )
...
async def test_list_authz_extensions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_authz_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            dep.ListAuthzExtensionsResponse(
                authz_extensions=[
...
async def test_list_authz_extensions_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_authz_extensions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_authz_extensions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_list_lb_traffic_extensions_rest_required_fields(request_type=dep.ListLbTrafficExtensionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_lb_traffic_extensions._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_lb_traffic_extension_rest_required_fields(request_type=dep.CreateLbTrafficExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_traffic_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_lb_traffic_extension_rest_required_fields(request_type=dep.UpdateLbTrafficExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_lb_traffic_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_lb_traffic_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{lb_traffic_extension.name=projects/*/locations/*/lbTrafficExtensions/*}" % client.transport._host, args[1]
        )
...
def test_delete_lb_traffic_extension_rest_required_fields(request_type=dep.DeleteLbTrafficExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_lb_traffic_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_lb_route_extensions_rest_required_fields(request_type=dep.ListLbRouteExtensionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_lb_route_extensions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_lb_route_extension_rest_required_fields(request_type=dep.GetLbRouteExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_lb_route_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_lb_route_extension_rest_required_fields(request_type=dep.CreateLbRouteExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_route_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_lb_route_extension_rest_required_fields(request_type=dep.UpdateLbRouteExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_lb_route_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_lb_route_extension_rest_required_fields(request_type=dep.DeleteLbRouteExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_lb_route_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_lb_edge_extensions_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_list_lb_edge_extensions_rest_required_fields(request_type=dep.ListLbEdgeExtensionsRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_lb_edge_extensions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    # Designate an appropriate value for the returned response.
    return_value = dep.ListLbEdgeExtensionsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = dep.ListLbEdgeExtensionsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_lb_edge_extensions_rest_unset_required_fields():
    transport = transports.DepServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.list_lb_edge_extensions._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(
            (
                "filter",
...
def test_list_lb_edge_extensions_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_lb_edge_extensions(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/lbEdgeExtensions" % client.transport._host, args[1])


def test_list_lb_edge_extensions_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_lb_edge_extensions_rest_pager(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dep.ListLbEdgeExtensionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
        ...
        pages = list(client.list_lb_edge_extensions(request=sample_request).pages)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


def test_get_lb_edge_extension_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_get_lb_edge_extension_rest_required_fields(request_type=dep.GetLbEdgeExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = dep.LbEdgeExtension()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = dep.LbEdgeExtension.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_lb_edge_extension_rest_unset_required_fields():
    transport = transports.DepServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.get_lb_edge_extension._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name",)))


def test_get_lb_edge_extension_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3"}
        ...
        client.get_lb_edge_extension(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}" % client.transport._host, args[1])


def test_get_lb_edge_extension_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_lb_edge_extension_rest_required_fields(request_type=dep.CreateLbEdgeExtensionRequest):
    transport_class = transports.DepServiceRestTransport

    request_init = {}
    request_init["parent"] = ""
    request_init["lb_edge_extension_id"] = ""
    request = request_type(**request_init)
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, use_integers_for_enums=False))

    # verify fields with default values are dropped
    assert "lbEdgeExtensionId" not in jsonified_request

    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_lb_edge_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "lbEdgeExtensionId" in jsonified_request
    assert jsonified_request["lbEdgeExtensionId"] == request_init["lb_edge_extension_id"]
    ...
    assert jsonified_request["parent"] == "parent_value"
    assert "lbEdgeExtensionId" in jsonified_request
    assert jsonified_request["lbEdgeExtensionId"] == "lb_edge_extension_id_value"
...
def test_create_lb_edge_extension_rest_unset_required_fields():
    transport = transports.DepServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_lb_edge_extension._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(
            (
                "lbEdgeExtensionId",
...
def test_create_lb_edge_extension_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_lb_edge_extension(**mock_args)
...
def test_create_lb_edge_extension_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_lb_edge_extension_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_update_lb_edge_extension_rest_required_fields(request_type=dep.UpdateLbEdgeExtensionRequest):
    transport_class = transports.DepServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_lb_edge_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_lb_edge_extension_rest_unset_required_fields():
    transport = transports.DepServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.update_lb_edge_extension._get_unset_required_fields({})
    assert set(unset_fields) == (
        set(
            (
                "requestId",
...
def test_update_lb_edge_extension_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"lb_edge_extension": {"name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3"}}
        ...
        client.update_lb_edge_extension(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{lb_edge_extension.name=projects/*/locations/*/lbEdgeExtensions/*}" % client.transport._host, args[1])


def test_update_lb_edge_extension_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_lb_edge_extension_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DepServiceClient(
...
def test_delete_lb_edge_extension_rest_required_fields(request_type=dep.DeleteLbEdgeExtensionRequest):
    transport_class = transports.DepServiceRestTransport
...
def test_delete_lb_edge_extension_rest_unset_required_fields():
    transport = transports.DepServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.delete_lb_edge_extension._get_unset_required_fields({})
    assert set(unset_fields) == (set(("requestId",)) & set(("name",)))


def test_delete_lb_edge_extension_rest_flattened():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_lb_edge_extension(**mock_args)
...
def test_delete_lb_edge_extension_rest_flattened_error(transport: str = "rest"):
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_authz_extensions_rest_required_fields(request_type=dep.ListAuthzExtensionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_authz_extensions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_authz_extension_rest_required_fields(request_type=dep.GetAuthzExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_authz_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_authz_extension_rest_required_fields(request_type=dep.CreateAuthzExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_authz_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_authz_extension_rest_required_fields(request_type=dep.UpdateAuthzExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_authz_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_authz_extension_rest_required_fields(request_type=dep.DeleteAuthzExtensionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_authz_extension._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = DepServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = DepServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_lb_edge_extensions_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        call.return_value = dep.ListLbEdgeExtensionsResponse()
        client.list_lb_edge_extensions(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_lb_edge_extension_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_lb_edge_extension), "__call__") as call:
        call.return_value = dep.LbEdgeExtension()
        client.get_lb_edge_extension(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_lb_edge_extension_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_lb_edge_extension), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_lb_edge_extension(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_lb_edge_extension_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_lb_edge_extension), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_lb_edge_extension(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_lb_edge_extension_empty_call_grpc():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_lb_edge_extension), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.delete_lb_edge_extension(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = DepServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = DepServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_lb_edge_extensions_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_lb_edge_extensions), "__call__") as call:
        ...
        await client.list_lb_edge_extensions(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_lb_edge_extension_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_lb_edge_extension), "__call__") as call:
        ...
        await client.get_lb_edge_extension(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_lb_edge_extension_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_lb_edge_extension(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_lb_edge_extension_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_lb_edge_extension(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_lb_edge_extension_empty_call_grpc_asyncio():
    client = DepServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_lb_edge_extension), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.delete_lb_edge_extension(request=None)
...
def test_transport_kind_rest():
    transport = DepServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_lb_traffic_extensions_rest_bad_request(request_type=dep.ListLbTrafficExtensionsRequest):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_lb_traffic_extensions_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_traffic_extensions") as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_list_lb_traffic_extensions_with_metadata"
...
def test_get_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_traffic_extension") as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_get_lb_traffic_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_create_lb_traffic_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_update_lb_traffic_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_lb_traffic_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_delete_lb_traffic_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_lb_route_extensions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_route_extensions") as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_list_lb_route_extensions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_route_extension") as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_get_lb_route_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_create_lb_route_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_update_lb_route_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_lb_route_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_delete_lb_route_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_lb_edge_extensions_rest_bad_request(request_type=dep.ListLbEdgeExtensionsRequest):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_list_lb_edge_extensions_rest_call_success(request_type):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_list_lb_edge_extensions_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DepServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_list_lb_edge_extensions") as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_list_lb_edge_extensions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DepServiceRestInterceptor, "pre_list_lb_edge_extensions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.ListLbEdgeExtensionsRequest.pb(dep.ListLbEdgeExtensionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.ListLbEdgeExtensionsResponse.to_json(dep.ListLbEdgeExtensionsResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = dep.ListLbEdgeExtensionsResponse()
        post_with_metadata.return_value = dep.ListLbEdgeExtensionsResponse(), metadata
...
def test_get_lb_edge_extension_rest_bad_request(request_type=dep.GetLbEdgeExtensionRequest):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3"}
    request = request_type(**request_init)
...
def test_get_lb_edge_extension_rest_call_success(request_type):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_lb_edge_extension_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DepServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_get_lb_edge_extension") as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_get_lb_edge_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DepServiceRestInterceptor, "pre_get_lb_edge_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.GetLbEdgeExtensionRequest.pb(dep.GetLbEdgeExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dep.LbEdgeExtension.to_json(dep.LbEdgeExtension())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = dep.LbEdgeExtension()
        post_with_metadata.return_value = dep.LbEdgeExtension(), metadata
...
def test_create_lb_edge_extension_rest_bad_request(request_type=dep.CreateLbEdgeExtensionRequest):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_lb_edge_extension_rest_call_success(request_type):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request_init["lb_edge_extension"] = {
        "name": "name_value",
        "create_time": {"seconds": 751, "nanos": 543},
        "update_time": {},
        "description": "description_value",
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = dep.CreateLbEdgeExtensionRequest.meta.fields["lb_edge_extension"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["lb_edge_extension"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["lb_edge_extension"][field])):
                    del request_init["lb_edge_extension"][field][i][subfield]
            else:
                del request_init["lb_edge_extension"][field][subfield]
    request = request_type(**request_init)
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_create_lb_edge_extension_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DepServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_create_lb_edge_extension"
    ) as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_create_lb_edge_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DepServiceRestInterceptor, "pre_create_lb_edge_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.CreateLbEdgeExtensionRequest.pb(dep.CreateLbEdgeExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_lb_edge_extension_rest_bad_request(request_type=dep.UpdateLbEdgeExtensionRequest):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"lb_edge_extension": {"name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3"}}
    request = request_type(**request_init)
...
def test_update_lb_edge_extension_rest_call_success(request_type):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    # send a request that will satisfy transcoding
    request_init = {"lb_edge_extension": {"name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3"}}
    request_init["lb_edge_extension"] = {
        "name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3",
        "create_time": {"seconds": 751, "nanos": 543},
        "update_time": {},
        "description": "description_value",
        "labels": {},
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = dep.UpdateLbEdgeExtensionRequest.meta.fields["lb_edge_extension"]
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_update_lb_edge_extension_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DepServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_update_lb_edge_extension"
    ) as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_update_lb_edge_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DepServiceRestInterceptor, "pre_update_lb_edge_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.UpdateLbEdgeExtensionRequest.pb(dep.UpdateLbEdgeExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_lb_edge_extension_rest_bad_request(request_type=dep.DeleteLbEdgeExtensionRequest):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/lbEdgeExtensions/sample3"}
    request = request_type(**request_init)
...
def test_delete_lb_edge_extension_rest_call_success(request_type):
    client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_delete_lb_edge_extension_rest_interceptors(null_interceptor):
    transport = transports.DepServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DepServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_delete_lb_edge_extension"
    ) as post, mock.patch.object(
        transports.DepServiceRestInterceptor, "post_delete_lb_edge_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DepServiceRestInterceptor, "pre_delete_lb_edge_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dep.DeleteLbEdgeExtensionRequest.pb(dep.DeleteLbEdgeExtensionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_authz_extensions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_list_authz_extensions") as post, mock.patch.object(
...
def test_get_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DepServiceRestInterceptor, "post_get_authz_extension") as post, mock.patch.object(
...
def test_create_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_create_authz_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_update_authz_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_authz_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DepServiceRestInterceptor, "post_delete_authz_extension_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_lb_edge_extensions_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_lb_edge_extension_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_lb_edge_extension_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_lb_edge_extension_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_lb_edge_extension_empty_call_rest():
    client = DepServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_dep_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.DepServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.DepServiceGrpcTransport, grpc_helpers), (transports.DepServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_dep_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.DepServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_dep_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "networkservices.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://networkservices.googleapis.com:8000"
    )
...
def test_dep_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.list_lb_edge_extensions._session
    session2 = client2.transport.list_lb_edge_extensions._session
    assert session1 != session2
    session1 = client1.transport.get_lb_edge_extension._session
    session2 = client2.transport.get_lb_edge_extension._session
    assert session1 != session2
    session1 = client1.transport.create_lb_edge_extension._session
    session2 = client2.transport.create_lb_edge_extension._session
    assert session1 != session2
    session1 = client1.transport.update_lb_edge_extension._session
    session2 = client2.transport.update_lb_edge_extension._session
    assert session1 != session2
    session1 = client1.transport.delete_lb_edge_extension._session
    session2 = client2.transport.delete_lb_edge_extension._session
    assert session1 != session2
...
def test_lb_edge_extension_path():
    project = "cuttlefish"
    location = "mussel"
    lb_edge_extension = "winkle"
    expected = "projects/{project}/locations/{location}/lbEdgeExtensions/{lb_edge_extension}".format(
        project=project,
        location=location,
        lb_edge_extension=lb_edge_extension,
    )
    actual = DepServiceClient.lb_edge_extension_path(project, location, lb_edge_extension)
    assert expected == actual


def test_parse_lb_edge_extension_path():
    expected = {
        "project": "nautilus",
        "location": "scallop",
        "lb_edge_extension": "abalone",
    }
    path = DepServiceClient.lb_edge_extension_path(**expected)

    # Check that the path construction is reversible.
    actual = DepServiceClient.parse_lb_edge_extension_path(path)
    assert expected == actual
...
def test_client_ctx():
    ...
    for transport in transports:
        client = DepServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

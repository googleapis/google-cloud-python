...
class network_servicesCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_lb_edge_extension': ('parent', 'lb_edge_extension_id', 'lb_edge_extension', 'request_id', ),
        ...
        'delete_lb_edge_extension': ('name', 'request_id', ),
        ...
        'list_lb_edge_extensions': ('parent', 'page_size', 'page_token', 'filter', 'order_by', ),
        ...
        'update_lb_edge_extension': ('lb_edge_extension', 'update_mask', 'request_id', ),

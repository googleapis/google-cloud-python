...
from google.cloud.network_services_v1beta1.types import common
...
class EndpointPolicy(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.network_services_v1beta1.types.EndpointPolicy.EndpointPolicyType):
        ...
        endpoint_matcher (google.cloud.network_services_v1beta1.types.EndpointMatcher):
            Required. A matcher that selects endpoints to
            which the policies should be applied.
        traffic_port_selector (google.cloud.network_services_v1beta1.types.TrafficPortSelector):
...
class ListEndpointPoliciesResponse(proto.Message):
    ...
    Attributes:
        endpoint_policies (MutableSequence[google.cloud.network_services_v1beta1.types.EndpointPolicy]):

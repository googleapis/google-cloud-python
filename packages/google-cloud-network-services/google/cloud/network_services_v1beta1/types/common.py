...
class EndpointMatcher(proto.Message):
    ...
    Attributes:
        metadata_label_matcher (google.cloud.network_services_v1beta1.types.EndpointMatcher.MetadataLabelMatcher):
    ...
    class MetadataLabelMatcher(proto.Message):
        ...
        Attributes:
            metadata_label_match_criteria (google.cloud.network_services_v1beta1.types.EndpointMatcher.MetadataLabelMatcher.MetadataLabelMatchCriteria):
            ...
            metadata_labels (MutableSequence[google.cloud.network_services_v1beta1.types.EndpointMatcher.MetadataLabelMatcher.MetadataLabels]):

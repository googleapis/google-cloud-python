...
from google.cloud.network_services_v1beta1._compat import (
    get_api_endpoint,
...
class NetworkServicesClient(metaclass=NetworkServicesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=NetworkServicesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.networkservices_v1beta1.NetworkServicesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_endpoint_policies():
                # Create a client
                client = network_services_v1beta1.NetworkServicesClient()
        ...
        Args:
            request (Union[google.cloud.network_services_v1beta1.types.ListEndpointPoliciesRequest, dict]):
        ...
        Returns:
            google.cloud.network_services_v1beta1.services.network_services.pagers.ListEndpointPoliciesPager:
    ...
    def get_endpoint_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1beta1.types.GetEndpointPolicyRequest, dict]):
                The request object. Request used with the
    ...
    def create_endpoint_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1beta1.types.CreateEndpointPolicyRequest, dict]):
                The request object. Request used with the
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            endpoint_policy (google.cloud.network_services_v1beta1.types.EndpointPolicy):
    ...
    def update_endpoint_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1beta1.types.UpdateEndpointPolicyRequest, dict]):
                The request object. Request used with the
    ...
    def delete_endpoint_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1beta1.types.DeleteEndpointPolicyRequest, dict]):
                The request object. Request used with the

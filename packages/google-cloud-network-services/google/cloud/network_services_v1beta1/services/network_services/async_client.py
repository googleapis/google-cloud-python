...
from google.cloud.network_services_v1beta1.services.network_services import pagers
from google.cloud.network_services_v1beta1.types import common, endpoint_policy
from google.cloud.network_services_v1beta1.types import (
...
class NetworkServicesAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            NetworkServicesClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(NetworkServicesAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            NetworkServicesClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(NetworkServicesAsyncClient, filename, *args, **kwargs)
    ...
    get_transport_class = NetworkServicesClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.networkservices_v1beta1.NetworkServicesAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_endpoint_policies():
                ...
                request = network_services_v1beta1.ListEndpointPoliciesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1beta1.types.ListEndpointPoliciesRequest, dict]]):
        ...
        Returns:
            google.cloud.network_services_v1beta1.services.network_services.pagers.ListEndpointPoliciesAsyncPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_endpoint_policy():
                ...
                # Initialize request argument(s)
                request = network_services_v1beta1.GetEndpointPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1beta1.types.GetEndpointPolicyRequest, dict]]):
                The request object. Request used with the
        ...
        Returns:
            google.cloud.network_services_v1beta1.types.EndpointPolicy:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_endpoint_policy():
                ...
                request = network_services_v1beta1.CreateEndpointPolicyRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1beta1.types.CreateEndpointPolicyRequest, dict]]):
                The request object. Request used with the
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            endpoint_policy (:class:`google.cloud.network_services_v1beta1.types.EndpointPolicy`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_services_v1beta1.types.EndpointPolicy` EndpointPolicy is a resource that helps apply desired configuration
    ...
    async def update_endpoint_policy(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1beta1.types.UpdateEndpointPolicyRequest, dict]]):
                The request object. Request used with the
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_endpoint_policy():
                ...
                # Initialize request argument(s)
                request = network_services_v1beta1.DeleteEndpointPolicyRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1beta1.types.DeleteEndpointPolicyRequest, dict]]):
                The request object. Request used with the

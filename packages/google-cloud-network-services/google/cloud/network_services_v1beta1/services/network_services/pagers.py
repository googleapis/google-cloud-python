...
class ListEndpointPoliciesPager:
    ...
    :class:`google.cloud.network_services_v1beta1.types.ListEndpointPoliciesResponse` object, and
    ...
    All the usual :class:`google.cloud.network_services_v1beta1.types.ListEndpointPoliciesResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.network_services_v1beta1.types.ListEndpointPoliciesRequest):
                The initial request object.
            response (google.cloud.network_services_v1beta1.types.ListEndpointPoliciesResponse):

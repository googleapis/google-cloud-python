...
class DepServiceGrpcAsyncIOTransport(DepServiceTransport):
    ...
    def list_extension_bindings(
        ...
        [dep.ListExtensionBindingsRequest], Awaitable[dep.ListExtensionBindingsResponse]
    ]:
        ...
        Returns:
            Callable[[~.ListExtensionBindingsRequest],
                    Awaitable[~.ListExtensionBindingsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_extension_binding(
        self,
    ) -> Callable[[dep.GetExtensionBindingRequest], Awaitable[dep.ExtensionBinding]]:
    ...
    def create_extension_binding(
        ...
        [dep.CreateExtensionBindingRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_extension_binding(
        ...
        [dep.UpdateExtensionBindingRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_extension_binding(
        ...
        [dep.DeleteExtensionBindingRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_extension_bindings: self._wrap_method(
                self.list_extension_bindings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_extension_binding: self._wrap_method(
                self.get_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_extension_binding: self._wrap_method(
                self.create_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_extension_binding: self._wrap_method(
                self.update_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_extension_binding: self._wrap_method(

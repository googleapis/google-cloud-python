...
class DepServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_extension_bindings: gapic_v1.method.wrap_method(
                self.list_extension_bindings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_extension_binding: gapic_v1.method.wrap_method(
                self.get_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_extension_binding: gapic_v1.method.wrap_method(
                self.create_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_extension_binding: gapic_v1.method.wrap_method(
                self.update_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_extension_binding: gapic_v1.method.wrap_method(
                self.delete_extension_binding,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    @property
    def list_extension_bindings(
        self,
    ) -> Callable[
        [dep.ListExtensionBindingsRequest],
        Union[
            dep.ListExtensionBindingsResponse,
            Awaitable[dep.ListExtensionBindingsResponse],
        ],
    ]:
        raise NotImplementedError()

    @property
    def get_extension_binding(
        self,
    ) -> Callable[
        [dep.GetExtensionBindingRequest],
        Union[dep.ExtensionBinding, Awaitable[dep.ExtensionBinding]],
    ]:
        raise NotImplementedError()

    @property
    def create_extension_binding(
        self,
    ) -> Callable[
        [dep.CreateExtensionBindingRequest],
        Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]],
    ]:
        raise NotImplementedError()

    @property
    def update_extension_binding(
        self,
    ) -> Callable[
        [dep.UpdateExtensionBindingRequest],
        Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]],
    ]:
        raise NotImplementedError()

    @property
    def delete_extension_binding(
        self,
    ) -> Callable[
        [dep.DeleteExtensionBindingRequest],
        Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]],
    ]:
        raise NotImplementedError()

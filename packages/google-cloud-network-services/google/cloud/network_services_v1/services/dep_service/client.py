...
from .transports.grpc import DepServiceGrpcTransport
from .transports.grpc_asyncio import DepServiceGrpcAsyncIOTransport
from .transports.rest import DepServiceRestTransport


class DepServiceClientMeta(type):
    """Metaclass for the DepService client.
...
class DepServiceClient(metaclass=DepServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DepServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DepServiceTransport:
        ...
        Returns:
            DepServiceTransport: The transport used by the client
                instance.
        """
    ...
    def parse_authz_extension_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/authzExtensions/(?P<authz_extension>.+?)$", path)
    ...
    def parse_lb_edge_extension_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/lbEdgeExtensions/(?P<lb_edge_extension>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def lb_route_extension_path(
        project: str,
        location: str,
        lb_route_extension: str,
    ) -> str:
        """Returns a fully-qualified lb_route_extension string."""
        return "projects/{project}/locations/{location}/lbRouteExtensions/{lb_route_extension}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_lb_route_extension_path(path: str) -> Dict[str, str]:
        """Parses a lb_route_extension path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/lbRouteExtensions/(?P<lb_route_extension>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def lb_traffic_extension_path(
        project: str,
        location: str,
        lb_traffic_extension: str,
    ) -> str:
        """Returns a fully-qualified lb_traffic_extension string."""
        return "projects/{project}/locations/{location}/lbTrafficExtensions/{lb_traffic_extension}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_lb_traffic_extension_path(path: str) -> Dict[str, str]:
        """Parses a lb_traffic_extension path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/lbTrafficExtensions/(?P<lb_traffic_extension>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DepServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DepServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = DepServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, DepServiceTransport, Callable[..., DepServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DepServiceClient._read_environment_variables()
        self._client_cert_source = DepServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DepServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DepServiceTransport)
        if transport_provided:
            # transport is a DepServiceTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or DepServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DepServiceTransport], Callable[..., DepServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.networkservices_v1.DepServiceClient`.",
                    extra={
    ...
    def list_lb_traffic_extensions(
        ...
        *,
    ...
    ) -> pagers.ListLbTrafficExtensionsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_lb_traffic_extensions():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.ListLbTrafficExtensionsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_lb_traffic_extensions]
        ...
        response = pagers.ListLbTrafficExtensionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_lb_traffic_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.GetLbTrafficExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_lb_traffic_extension]
    ...
    def create_lb_traffic_extension(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_lb_traffic_extension():
                # Create a client
                client = network_services_v1.DepServiceClient()
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.CreateLbTrafficExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_lb_traffic_extension]
    ...
    def update_lb_traffic_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.UpdateLbTrafficExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_lb_traffic_extension]
    ...
    def delete_lb_traffic_extension(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_lb_traffic_extension():
                # Create a client
                client = network_services_v1.DepServiceClient()
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.DeleteLbTrafficExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_lb_traffic_extension]
    ...
    def list_lb_route_extensions(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLbRouteExtensionsPager:
        ...
        .. code-block:: python
            ...
            def sample_list_lb_route_extensions():
                # Create a client
                client = network_services_v1.DepServiceClient()
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.ListLbRouteExtensionsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_lb_route_extensions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListLbRouteExtensionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_lb_route_extension(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_lb_route_extension():
                # Create a client
                client = network_services_v1.DepServiceClient()
                ...
                # Make the request
                response = client.get_lb_route_extension(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.network_services_v1.types.GetLbRouteExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_lb_route_extension]
    ...
    def create_lb_route_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.CreateLbRouteExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_lb_route_extension]
    ...
    def update_lb_route_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.UpdateLbRouteExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_lb_route_extension]
    ...
    def delete_lb_route_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.network_services_v1.types.DeleteLbRouteExtensionRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_lb_route_extension]

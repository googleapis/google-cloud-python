...
class DepServiceClient(metaclass=DepServiceClientMeta):
    ...
    def parse_lb_route_extension_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/lbRouteExtensions/(?P<lb_route_extension>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def parse_lb_traffic_extension_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/lbTrafficExtensions/(?P<lb_traffic_extension>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DepServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def list_lb_traffic_extensions(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_lb_traffic_extensions
        ]
    ...
    def create_lb_traffic_extension(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_lb_traffic_extension
        ]
    ...
    def update_lb_traffic_extension(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_lb_traffic_extension
        ]
    ...
    def delete_lb_traffic_extension(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_lb_traffic_extension
        ]
    ...
    def create_lb_route_extension(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_lb_route_extension
        ]
    ...
    def update_lb_route_extension(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_lb_route_extension
        ]

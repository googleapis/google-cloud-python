...
from .transports.base import DEFAULT_CLIENT_INFO, DepServiceTransport
from .transports.grpc_asyncio import DepServiceGrpcAsyncIOTransport
...
class DepServiceAsyncClient:
    """Service describing handlers for resources."""

    _client: DepServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = DepServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = DepServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = DepServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = DepServiceClient._DEFAULT_UNIVERSE

    authz_extension_path = staticmethod(DepServiceClient.authz_extension_path)
    parse_authz_extension_path = staticmethod(DepServiceClient.parse_authz_extension_path)
    lb_edge_extension_path = staticmethod(DepServiceClient.lb_edge_extension_path)
    parse_lb_edge_extension_path = staticmethod(DepServiceClient.parse_lb_edge_extension_path)
    lb_route_extension_path = staticmethod(DepServiceClient.lb_route_extension_path)
    parse_lb_route_extension_path = staticmethod(DepServiceClient.parse_lb_route_extension_path)
    lb_traffic_extension_path = staticmethod(DepServiceClient.lb_traffic_extension_path)
    parse_lb_traffic_extension_path = staticmethod(DepServiceClient.parse_lb_traffic_extension_path)
    common_billing_account_path = staticmethod(DepServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(DepServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(DepServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(DepServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(DepServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(DepServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(DepServiceClient.common_project_path)
    parse_common_project_path = staticmethod(DepServiceClient.parse_common_project_path)
    common_location_path = staticmethod(DepServiceClient.common_location_path)
    parse_common_location_path = staticmethod(DepServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DepServiceAsyncClient: The constructed client.
        """
        return DepServiceClient.from_service_account_info.__func__(DepServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            DepServiceAsyncClient: The constructed client.
        """
        return DepServiceClient.from_service_account_file.__func__(DepServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return DepServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

    @property
    def transport(self) -> DepServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            DepServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = DepServiceClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, DepServiceTransport, Callable[..., DepServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.networkservices_v1.DepServiceAsyncClient`.",
                extra={
    ...
    async def list_lb_traffic_extensions(
        self,
        request: Optional[Union[dep.ListLbTrafficExtensionsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLbTrafficExtensionsAsyncPager:
        r"""Lists ``LbTrafficExtension`` resources in a given project and
        location.
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.ListLbTrafficExtensionsRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_lb_traffic_extensions]
        ...
        response = pagers.ListLbTrafficExtensionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_lb_traffic_extension(
        self,
        request: Optional[Union[dep.GetLbTrafficExtensionRequest, dict]] = None,
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.GetLbTrafficExtensionRequest, dict]]):
                The request object. Message for getting a ``LbTrafficExtension`` resource.
            name (:class:`str`):
                Required. A name of the ``LbTrafficExtension`` resource
        ...
        Returns:
            google.cloud.network_services_v1.types.LbTrafficExtension:
                LbTrafficExtension is a resource that lets the extension service modify the
                   headers and payloads of both requests and responses
                   without impacting the choice of backend services or
                   any other security policies associated with the
                   backend service.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_lb_traffic_extension]
    ...
    async def create_lb_traffic_extension(
        self,
        request: Optional[Union[dep.CreateLbTrafficExtensionRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        lb_traffic_extension: Optional[dep.LbTrafficExtension] = None,
        lb_traffic_extension_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation_async.AsyncOperation:
        r"""Creates a new ``LbTrafficExtension`` resource in a given project
        and location.
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.CreateLbTrafficExtensionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lb_traffic_extension (:class:`google.cloud.network_services_v1.types.LbTrafficExtension`):
                Required. ``LbTrafficExtension`` resource to be created.
                This corresponds to the ``lb_traffic_extension`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lb_traffic_extension_id (:class:`str`):
                Required. User-provided ID of the ``LbTrafficExtension``
                resource to be created.

                This corresponds to the ``lb_traffic_extension_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_services_v1.types.LbTrafficExtension` LbTrafficExtension is a resource that lets the extension service modify the
                   headers and payloads of both requests and responses
                   without impacting the choice of backend services or
                   any other security policies associated with the
                   backend service.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, lb_traffic_extension, lb_traffic_extension_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if lb_traffic_extension is not None:
            request.lb_traffic_extension = lb_traffic_extension
        if lb_traffic_extension_id is not None:
            request.lb_traffic_extension_id = lb_traffic_extension_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_lb_traffic_extension]
    ...
    async def update_lb_traffic_extension(
        self,
        request: Optional[Union[dep.UpdateLbTrafficExtensionRequest, dict]] = None,
        *,
        lb_traffic_extension: Optional[dep.LbTrafficExtension] = None,
        ...
        r"""Updates the parameters of the specified ``LbTrafficExtension``
        resource.
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.UpdateLbTrafficExtensionRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [lb_traffic_extension, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_lb_traffic_extension]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("lb_traffic_extension.name", request.lb_traffic_extension.name),)),)
    ...
    async def delete_lb_traffic_extension(
        self,
        request: Optional[Union[dep.DeleteLbTrafficExtensionRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.DeleteLbTrafficExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_lb_traffic_extension]
    ...
    async def list_lb_route_extensions(
        self,
        request: Optional[Union[dep.ListLbRouteExtensionsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLbRouteExtensionsAsyncPager:
        r"""Lists ``LbRouteExtension`` resources in a given project and
        location.
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.ListLbRouteExtensionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_lb_route_extensions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListLbRouteExtensionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_lb_route_extension(
        self,
        request: Optional[Union[dep.GetLbRouteExtensionRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.GetLbRouteExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_lb_route_extension]
    ...
    async def create_lb_route_extension(
        self,
        request: Optional[Union[dep.CreateLbRouteExtensionRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        lb_route_extension: Optional[dep.LbRouteExtension] = None,
        lb_route_extension_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation_async.AsyncOperation:
        r"""Creates a new ``LbRouteExtension`` resource in a given project
        and location.
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.CreateLbRouteExtensionRequest, dict]]):
                The request object. Message for creating a ``LbRouteExtension`` resource.
            parent (:class:`str`):
                Required. The parent resource of the
                ``LbRouteExtension`` resource. Must be in the format
                ``projects/{project}/locations/{location}``.

                This corresponds to the ``parent`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lb_route_extension (:class:`google.cloud.network_services_v1.types.LbRouteExtension`):
                Required. ``LbRouteExtension`` resource to be created.
                This corresponds to the ``lb_route_extension`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lb_route_extension_id (:class:`str`):
                Required. User-provided ID of the ``LbRouteExtension``
                resource to be created.

                This corresponds to the ``lb_route_extension_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.network_services_v1.types.LbRouteExtension` LbRouteExtension is a resource that lets you control where traffic is
                   routed to for a given request.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, lb_route_extension, lb_route_extension_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        if lb_route_extension is not None:
            request.lb_route_extension = lb_route_extension
        if lb_route_extension_id is not None:
            request.lb_route_extension_id = lb_route_extension_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_lb_route_extension]
    ...
    async def update_lb_route_extension(
        self,
        request: Optional[Union[dep.UpdateLbRouteExtensionRequest, dict]] = None,
        *,
        lb_route_extension: Optional[dep.LbRouteExtension] = None,
        update_mask: Optional[field_mask_pb2.FieldMask] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Updates the parameters of the specified ``LbRouteExtension``
        resource.
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.UpdateLbRouteExtensionRequest, dict]]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [lb_route_extension, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_lb_route_extension]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("lb_route_extension.name", request.lb_route_extension.name),)),)
    ...
    async def delete_lb_route_extension(
        self,
        request: Optional[Union[dep.DeleteLbRouteExtensionRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.DeleteLbRouteExtensionRequest, dict]]):
                The request object. Message for deleting a ``LbRouteExtension`` resource.
            name (:class:`str`):
                Required. The name of the ``LbRouteExtension`` resource
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_lb_route_extension]
    ...
    async def list_lb_edge_extensions(
        self,
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLbEdgeExtensionsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_lb_edge_extensions():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.ListLbEdgeExtensionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_lb_edge_extensions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListLbEdgeExtensionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_lb_edge_extension(
        self,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_lb_edge_extension():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
                ...
                # Make the request
                response = await client.get_lb_edge_extension(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.GetLbEdgeExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_lb_edge_extension]
    ...
    async def create_lb_edge_extension(
        self,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_lb_edge_extension():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.CreateLbEdgeExtensionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lb_edge_extension (:class:`google.cloud.network_services_v1.types.LbEdgeExtension`):
                Required. ``LbEdgeExtension`` resource to be created.
                This corresponds to the ``lb_edge_extension`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            lb_edge_extension_id (:class:`str`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_lb_edge_extension]
    ...
    async def update_lb_edge_extension(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.UpdateLbEdgeExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_lb_edge_extension]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("lb_edge_extension.name", request.lb_edge_extension.name),)),)
    ...
    async def delete_lb_edge_extension(
        self,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_lb_edge_extension():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.DeleteLbEdgeExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_lb_edge_extension]
    ...
    async def list_authz_extensions(
        self,
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListAuthzExtensionsAsyncPager:
        ...
        .. code-block:: python
            ...
            async def sample_list_authz_extensions():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.ListAuthzExtensionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_authz_extensions]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListAuthzExtensionsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_authz_extension(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.GetAuthzExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_authz_extension]
    ...
    async def create_authz_extension(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.CreateAuthzExtensionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            authz_extension (:class:`google.cloud.network_services_v1.types.AuthzExtension`):
                Required. ``AuthzExtension`` resource to be created.
                This corresponds to the ``authz_extension`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            authz_extension_id (:class:`str`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_authz_extension]
    ...
    async def update_authz_extension(
        self,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_authz_extension():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.UpdateAuthzExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_authz_extension]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("authz_extension.name", request.authz_extension.name),)),)
    ...
    async def delete_authz_extension(
        self,
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_authz_extension():
                # Create a client
                client = network_services_v1.DepServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.network_services_v1.types.DeleteAuthzExtensionRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_authz_extension]
    ...
    async def __aenter__(self) -> "DepServiceAsyncClient":
        return self

...
class NetworkServicesClient(metaclass=NetworkServicesClientMeta):
    ...
    def wasm_plugin_path(
        ...
        return "projects/{project}/locations/{location}/wasmPlugins/{wasm_plugin}".format(
            project=project,
            location=location,
    ...
    def parse_wasm_plugin_version_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/wasmPlugins/(?P<wasm_plugin>.+?)/versions/(?P<wasm_plugin_version>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = NetworkServicesClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or NetworkServicesClient._get_api_endpoint(

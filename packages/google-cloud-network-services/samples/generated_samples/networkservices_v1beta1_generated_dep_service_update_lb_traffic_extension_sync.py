...
# [START networkservices_v1beta1_generated_DepService_UpdateLbTrafficExtension_sync]
...
def sample_update_lb_traffic_extension():
    # Create a client
    client = network_services_v1beta1.DepServiceClient()

    # Initialize request argument(s)
    lb_traffic_extension = network_services_v1beta1.LbTrafficExtension()
    lb_traffic_extension.name = "name_value"
    lb_traffic_extension.forwarding_rules = [
    ...
    request = network_services_v1beta1.UpdateLbTrafficExtensionRequest(
...
# [END networkservices_v1beta1_generated_DepService_UpdateLbTrafficExtension_sync]

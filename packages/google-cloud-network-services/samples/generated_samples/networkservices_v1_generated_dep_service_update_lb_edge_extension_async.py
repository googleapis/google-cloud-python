...
#
# Snippet for UpdateLbEdgeExtension
...
# [START networkservices_v1_generated_DepService_UpdateLbEdgeExtension_async]
...
async def sample_update_lb_edge_extension():
    # Create a client
    ...
    lb_edge_extension.forwarding_rules = [
        "forwarding_rules_value1",
        "forwarding_rules_value2",
    ]
    lb_edge_extension.extension_chains.name = "name_value"
    lb_edge_extension.extension_chains.match_condition.cel_expression = (
...
# [END networkservices_v1_generated_DepService_UpdateLbEdgeExtension_async]

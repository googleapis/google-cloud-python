...
#
# Snippet for ListServiceLbPolicies
...
# [START networkservices_v1_generated_NetworkServices_ListServiceLbPolicies_async]
...
async def sample_list_service_lb_policies():
    # Create a client

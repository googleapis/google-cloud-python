...
class ResourceSettingsServiceAsyncClient:
    ...
    parse_setting_value_path = staticmethod(
        ResourceSettingsServiceClient.parse_setting_value_path
    )
    ...
    async def search_setting_values(
        self,
    ...
    async def lookup_effective_setting_value(
        self,
    ...
    async def create_setting_value(
        self,

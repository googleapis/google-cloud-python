...
class ResourceSettingsServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = (
        ResourceSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    ...
    get_transport_class = ResourceSettingsServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.resourcesettings_v1.ResourceSettingsServiceAsyncClient`.",
                extra={

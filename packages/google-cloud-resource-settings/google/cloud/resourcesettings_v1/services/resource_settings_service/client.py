...
class ResourceSettingsServiceClient(metaclass=ResourceSettingsServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "resourcesettings.{UNIVERSE_DOMAIN}"
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = ResourceSettingsServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = ResourceSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ResourceSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ResourceSettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(
        ...
        default_universe = ResourceSettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or ResourceSettingsServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        ) = ResourceSettingsServiceClient._read_environment_variables()
        self._client_cert_source = (
            ResourceSettingsServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = ResourceSettingsServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ResourceSettingsServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ResourceSettingsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ResourceSettingsServiceClient._get_api_endpoint(

...
class _BaseResourceSettingsServiceRestTransport(ResourceSettingsServiceTransport):
    ...
    class _BaseGetSetting:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseResourceSettingsServiceRestTransport._BaseGetSetting._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListSettings:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseResourceSettingsServiceRestTransport._BaseListSettings._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateSetting:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseResourceSettingsServiceRestTransport._BaseUpdateSetting._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseResourceSettingsServiceRestTransport",)

...
class ResourceSettingsServiceGrpcAsyncIOTransport(ResourceSettingsServiceTransport):
    ...
    def search_setting_values(
        ...
        Awaitable[resource_settings.SearchSettingValuesResponse],
    ]:
        ...
        Returns:
            Callable[[~.SearchSettingValuesRequest],
                    Awaitable[~.SearchSettingValuesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_setting_value(
        ...
        Awaitable[resource_settings.SettingValue],
    ]:
    ...
    def delete_setting_value(
        ...
        [resource_settings.DeleteSettingValueRequest], Awaitable[empty.Empty]
    ]:

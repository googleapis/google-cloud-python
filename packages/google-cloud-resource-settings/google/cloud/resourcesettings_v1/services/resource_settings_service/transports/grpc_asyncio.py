...
class ResourceSettingsServiceGrpcAsyncIOTransport(ResourceSettingsServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_settings: gapic_v1.method_async.wrap_method(
                self.list_settings,
            ...
            self.get_setting: gapic_v1.method_async.wrap_method(
                self.get_setting,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.update_setting: gapic_v1.method_async.wrap_method(
                self.update_setting,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,

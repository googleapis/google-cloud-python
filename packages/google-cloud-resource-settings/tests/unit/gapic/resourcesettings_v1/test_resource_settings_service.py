...
def test__read_environment_variables():
    assert ResourceSettingsServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test__get_client_cert_source():
    ...
    assert ResourceSettingsServiceClient._get_client_cert_source(None, False) is None
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ResourceSettingsServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ResourceSettingsServiceClient),
)
@mock.patch.object(
    ResourceSettingsServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ResourceSettingsServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ResourceSettingsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ResourceSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ResourceSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        ResourceSettingsServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == ResourceSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ResourceSettingsServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        ResourceSettingsServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ResourceSettingsServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ResourceSettingsServiceClient._get_universe_domain(None, None)
        == ResourceSettingsServiceClient._DEFAULT_UNIVERSE
    )

    with pytest.raises(ValueError) as excinfo:
        ResourceSettingsServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = ResourceSettingsServiceClient(credentials=cred)
...
def test_resource_settings_service_client_client_api_endpoint(client_class):
...
def test_list_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.list_settings in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.list_settings] = mock_rpc
        request = {}
...
async def test_list_settings_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_settings
...
def test_list_settings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_settings), "__call__") as call:
        ...
        pager = client.list_settings(request={}, retry=retry, timeout=timeout)
...
def test_get_setting_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ResourceSettingsServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.get_setting in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.get_setting] = mock_rpc
        request = {}
...
async def test_get_setting_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_setting
            in client._client._transport._wrapped_methods
        )
...
def test_update_setting_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ResourceSettingsServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_setting in client._transport._wrapped_methods
        ...
        client._transport._wrapped_methods[client._transport.update_setting] = mock_rpc
        request = {}
...
async def test_update_setting_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_setting
            in client._client._transport._wrapped_methods
        )
...
def test_list_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ResourceSettingsServiceRestInterceptor,
...
def test_get_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post_with_metadata.return_value = resource_settings.Setting(), metadata

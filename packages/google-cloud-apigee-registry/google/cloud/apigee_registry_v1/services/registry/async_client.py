...
class RegistryAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            RegistryClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(RegistryAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            RegistryClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(RegistryAsyncClient, filename, *args, **kwargs)

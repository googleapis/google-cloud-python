...
class ProvisioningRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_instance(
        ...
        provisioning_service.GetInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_get_instance(
        self, response: provisioning_service.Instance
    ...
    def post_get_instance_with_metadata(
        self,
        response: provisioning_service.Instance,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
...
class ProvisioningRestTransport(_BaseProvisioningRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[ProvisioningRestInterceptor]): Interceptor used
    ...
    class _CreateInstance(
        _BaseProvisioningRestTransport._BaseCreateInstance, ProvisioningRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseProvisioningRestTransport._BaseCreateInstance._get_http_options()
            )

            request, metadata = self._interceptor.pre_create_instance(request, metadata)
            transcoded_request = _BaseProvisioningRestTransport._BaseCreateInstance._get_transcoded_request(
                http_options, request
            )

            body = _BaseProvisioningRestTransport._BaseCreateInstance._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseProvisioningRestTransport._BaseCreateInstance._get_query_params_json(
                transcoded_request
            )
    ...
    class _DeleteInstance(
        _BaseProvisioningRestTransport._BaseDeleteInstance, ProvisioningRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseProvisioningRestTransport._BaseDeleteInstance._get_http_options()
            )

            request, metadata = self._interceptor.pre_delete_instance(request, metadata)
            transcoded_request = _BaseProvisioningRestTransport._BaseDeleteInstance._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseProvisioningRestTransport._BaseDeleteInstance._get_query_params_json(
                transcoded_request
            )
    ...
    class _GetInstance(
        _BaseProvisioningRestTransport._BaseGetInstance, ProvisioningRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseProvisioningRestTransport._BaseGetInstance._get_http_options()
            )

            request, metadata = self._interceptor.pre_get_instance(request, metadata)
            transcoded_request = (
                _BaseProvisioningRestTransport._BaseGetInstance._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseProvisioningRestTransport._BaseGetInstance._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    def create_instance(
        ...
        [provisioning_service.CreateInstanceRequest], operations_pb2.Operation
    ]:
    ...
    def delete_instance(
        ...
        [provisioning_service.DeleteInstanceRequest], operations_pb2.Operation
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def get_instance(
        ...
        [provisioning_service.GetInstanceRequest], provisioning_service.Instance
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    class _GetIamPolicy(
        _BaseProvisioningRestTransport._BaseGetIamPolicy, ProvisioningRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseProvisioningRestTransport._BaseGetIamPolicy._get_http_options()
            )

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseProvisioningRestTransport._BaseGetIamPolicy._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = (
                _BaseProvisioningRestTransport._BaseGetIamPolicy._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _SetIamPolicy(
        _BaseProvisioningRestTransport._BaseSetIamPolicy, ProvisioningRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseProvisioningRestTransport._BaseSetIamPolicy._get_http_options()
            )

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseProvisioningRestTransport._BaseSetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = (
                _BaseProvisioningRestTransport._BaseSetIamPolicy._get_request_body_json(
                    transcoded_request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseProvisioningRestTransport._BaseSetIamPolicy._get_query_params_json(
                    transcoded_request
                )
            )
    ...
    class _TestIamPermissions(
        _BaseProvisioningRestTransport._BaseTestIamPermissions, ProvisioningRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseProvisioningRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseProvisioningRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseProvisioningRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )

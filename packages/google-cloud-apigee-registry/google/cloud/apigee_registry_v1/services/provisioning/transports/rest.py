...
class ProvisioningRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[provisioning_service.CreateInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_instance(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[provisioning_service.DeleteInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_instance(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[provisioning_service.GetInstanceRequest, Sequence[Tuple[str, str]]]:

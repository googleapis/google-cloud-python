...
class TextToSpeechLongAudioSynthesizeAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, TextToSpeechLongAudioSynthesizeTransport, Callable[..., TextToSpeechLongAudioSynthesizeTransport]]
        ] = "grpc_asyncio",
    ...
    async def synthesize_long_audio(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.synthesize_long_audio]

        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.texttospeech_v1.TextToSpeechLongAudioSynthesizeClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.texttospeech_v1.TextToSpeechLongAudioSynthesizeAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

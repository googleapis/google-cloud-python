...
class TextToSpeechGrpcAsyncIOTransport(TextToSpeechTransport):
    ...
    @property
    def list_voices(self) -> Callable[[cloud_tts.ListVoicesRequest], Awaitable[cloud_tts.ListVoicesResponse]]:
    ...
    @property
    def synthesize_speech(self) -> Callable[[cloud_tts.SynthesizeSpeechRequest], Awaitable[cloud_tts.SynthesizeSpeechResponse]]:
    ...
    @property
    def streaming_synthesize(self) -> Callable[[cloud_tts.StreamingSynthesizeRequest], Awaitable[cloud_tts.StreamingSynthesizeResponse]]:

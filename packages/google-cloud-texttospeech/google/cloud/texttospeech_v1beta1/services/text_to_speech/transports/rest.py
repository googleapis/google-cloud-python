...
class TextToSpeechRestTransport(TextToSpeechTransport):
    """REST backend transport for TextToSpeech.
    ...
    class _GetOperation(TextToSpeechRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(TextToSpeechRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,

...
class _BaseTextToSpeechLongAudioSynthesizeRestTransport(TextToSpeechLongAudioSynthesizeTransport):
    ...
    class _BaseSynthesizeLongAudio:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseTextToSpeechLongAudioSynthesizeRestTransport._BaseSynthesizeLongAudio._get_unset_required_fields(query_params))

...
class TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport(TextToSpeechLongAudioSynthesizeTransport):
    ...
    @property
    def synthesize_long_audio(self) -> Callable[[cloud_tts_lrs.SynthesizeLongAudioRequest], Awaitable[operations_pb2.Operation]]:

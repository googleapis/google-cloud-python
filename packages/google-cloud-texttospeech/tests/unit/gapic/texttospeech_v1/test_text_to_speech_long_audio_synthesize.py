...
def test__read_environment_variables():
    assert TextToSpeechLongAudioSynthesizeClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert TextToSpeechLongAudioSynthesizeClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert TextToSpeechLongAudioSynthesizeClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TextToSpeechLongAudioSynthesizeClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TextToSpeechLongAudioSynthesizeClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert TextToSpeechLongAudioSynthesizeClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert TextToSpeechLongAudioSynthesizeClient._use_client_cert_effective() is False
...
def test__get_client_cert_source():
    ...
    assert TextToSpeechLongAudioSynthesizeClient._get_client_cert_source(None, False) is None
    assert TextToSpeechLongAudioSynthesizeClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TextToSpeechLongAudioSynthesizeClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert TextToSpeechLongAudioSynthesizeClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TextToSpeechLongAudioSynthesizeClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(
    TextToSpeechLongAudioSynthesizeClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TextToSpeechLongAudioSynthesizeClient)
)
@mock.patch.object(
    TextToSpeechLongAudioSynthesizeAsyncClient,
...
def test__get_api_endpoint():
    ...
    default_endpoint = TextToSpeechLongAudioSynthesizeClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TextToSpeechLongAudioSynthesizeClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == TextToSpeechLongAudioSynthesizeClient.DEFAULT_MTLS_ENDPOINT
    )
    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, None, default_universe, "always")
        == TextToSpeechLongAudioSynthesizeClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == TextToSpeechLongAudioSynthesizeClient.DEFAULT_MTLS_ENDPOINT
    )
    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TextToSpeechLongAudioSynthesizeClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TextToSpeechLongAudioSynthesizeClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TextToSpeechLongAudioSynthesizeClient._get_universe_domain(None, None) == TextToSpeechLongAudioSynthesizeClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TextToSpeechLongAudioSynthesizeClient(credentials=cred)
...
def test_text_to_speech_long_audio_synthesize_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "texttospeech.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://texttospeech.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeGrpcTransport, "grpc"),
        (TextToSpeechLongAudioSynthesizeAsyncClient, transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeGrpcTransport, "grpc", "true"),
        (TextToSpeechLongAudioSynthesizeAsyncClient, transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeGrpcTransport, "grpc", "false"),
        (TextToSpeechLongAudioSynthesizeAsyncClient, transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeRestTransport, "rest", "true"),
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(
    TextToSpeechLongAudioSynthesizeClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TextToSpeechLongAudioSynthesizeClient)
...
@mock.patch.object(
    TextToSpeechLongAudioSynthesizeAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TextToSpeechLongAudioSynthesizeAsyncClient)
)
...
@pytest.mark.parametrize(
    ...
    [
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeGrpcTransport, "grpc", grpc_helpers),
        (
            TextToSpeechLongAudioSynthesizeAsyncClient,
        ...
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeRestTransport, "rest", None),
    ],
)
...
def test_synthesize_long_audio_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.synthesize_long_audio in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.synthesize_long_audio] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_synthesize_long_audio_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.synthesize_long_audio in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.synthesize_long_audio] = mock_rpc
...
def test_synthesize_long_audio_rest_required_fields(request_type=cloud_tts_lrs.SynthesizeLongAudioRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).synthesize_long_audio._get_unset_required_fields(
        jsonified_request
    )
...
def test_transport_kind_grpc():
    transport = TextToSpeechLongAudioSynthesizeClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = TextToSpeechLongAudioSynthesizeAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = TextToSpeechLongAudioSynthesizeAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = TextToSpeechLongAudioSynthesizeClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_synthesize_long_audio_rest_bad_request(request_type=cloud_tts_lrs.SynthesizeLongAudioRequest):
...
def test_synthesize_long_audio_rest_interceptors(null_interceptor):
    transport = transports.TextToSpeechLongAudioSynthesizeRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TextToSpeechLongAudioSynthesizeRestInterceptor(),
    )
    client = TextToSpeechLongAudioSynthesizeClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.TextToSpeechLongAudioSynthesizeRestInterceptor, "post_synthesize_long_audio"
    ) as post, mock.patch.object(
        transports.TextToSpeechLongAudioSynthesizeRestInterceptor, "post_synthesize_long_audio_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TextToSpeechLongAudioSynthesizeRestInterceptor, "pre_synthesize_long_audio"
    ) as pre:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
@pytest.mark.parametrize(
    "transport_class", [transports.TextToSpeechLongAudioSynthesizeGrpcTransport, transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport]
)
...
def test_text_to_speech_long_audio_synthesize_host_no_port(transport_name):
    client = TextToSpeechLongAudioSynthesizeClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="texttospeech.googleapis.com"),
...
def test_text_to_speech_long_audio_synthesize_host_with_port(transport_name):
    client = TextToSpeechLongAudioSynthesizeClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="texttospeech.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "texttospeech.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://texttospeech.googleapis.com:8000"
    )
...
@pytest.mark.parametrize(
    ...
    [
        (TextToSpeechLongAudioSynthesizeClient, transports.TextToSpeechLongAudioSynthesizeGrpcTransport),
        (TextToSpeechLongAudioSynthesizeAsyncClient, transports.TextToSpeechLongAudioSynthesizeGrpcAsyncIOTransport),
    ],
)

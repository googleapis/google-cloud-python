...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TextToSpeechClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_synthesize_speech_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.synthesize_speech] = (
            mock_rpc
        )
        request = {}
...
def test_streaming_synthesize_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.streaming_synthesize] = (
            mock_rpc
        )
        request = [{}]
...
def test_transport_kind_grpc_asyncio():
    transport = TextToSpeechAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = TextToSpeechClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_voices_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tts.ListVoicesResponse.to_json(
            cloud_tts.ListVoicesResponse()
        )
...
def test_synthesize_speech_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TextToSpeechRestInterceptor,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = cloud_tts.SynthesizeSpeechResponse.to_json(
            cloud_tts.SynthesizeSpeechResponse()
        )
        req.return_value.content = return_value

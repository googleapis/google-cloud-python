...
from google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize import (
    TextToSpeechLongAudioSynthesizeAsyncClient,
    TextToSpeechLongAudioSynthesizeClient,
    transports,
)
from google.cloud.texttospeech_v1beta1.types import cloud_tts, cloud_tts_lrs
...
def test_text_to_speech_long_audio_synthesize_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_text_to_speech_long_audio_synthesize_base_transport():
    ...
    with mock.patch(
        "google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeTransport.__init__"
    ) as Transport:
...
def test_text_to_speech_long_audio_synthesize_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.texttospeech_v1beta1.services.text_to_speech_long_audio_synthesize.transports.TextToSpeechLongAudioSynthesizeTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
__protobuf__ = proto.module(
    package="google.maps.mapmanagement.v2",
    manifest={
        "MapRenderingType",
        "StyleConfigView",
...
class StyleConfigView(proto.Enum):
    ...
    Values:
        STYLE_CONFIG_VIEW_UNSPECIFIED (0):
            Unspecified view.
        FULL (1):
            Include the ``json_style_sheet`` and ``style_sheet`` in the
            response.
        METADATA_ONLY (2):
            Exclude the ``json_style_sheet`` and ``style_sheet`` from
            the response.
    """
...
class ListMapConfigsResponse(proto.Message):
    ...
    Attributes:
        map_configs (MutableSequence[google.maps.mapmanagement_v2.types.MapConfig]):
...
class MapFeatures(proto.Message):
    ...
    Attributes:
        simple_features (MutableSequence[google.maps.mapmanagement_v2.types.MapFeatures.SimpleFeature]):
...
class MapConfig(proto.Message):
    ...
    Attributes:
        ...
        map_features (google.maps.mapmanagement_v2.types.MapFeatures):
        ...
        map_type (google.maps.mapmanagement_v2.types.MapRenderingType):
...
class StyleConfig(proto.Message):
    ...
    Attributes:
        ...
        json_style_sheet (str):
            Optional. JSON representation of the style sheet for this
            StyleConfig. If not specified or if provided as an empty
            string, the base unstyled Google map style will be used. See
            https://developers.google.com/maps/documentation/javascript/cloud-customization/json-reference
            for more details on the acceptable JSON format. If both
            ``style_sheet`` and ``json_style_sheet`` are filled out,
            ``style_sheet`` takes precedence.
        style_sheet (google.protobuf.struct_pb2.Struct):
            Optional. The style sheet for this StyleConfig, represented
            as a raw JSON object. If both ``style_sheet`` and
            ``json_style_sheet`` are filled out, ``style_sheet`` takes
            precedence. See
            https://developers.google.com/maps/documentation/javascript/cloud-customization/json-reference
    ...
    style_sheet: struct_pb2.Struct = proto.Field(
        proto.MESSAGE,
        number=9,
...
class ListStyleConfigsRequest(proto.Message):
    ...
    Attributes:
        ...
        view (google.maps.mapmanagement_v2.types.StyleConfigView):
...
class ListStyleConfigsResponse(proto.Message):
    ...
    Attributes:
        style_configs (MutableSequence[google.maps.mapmanagement_v2.types.StyleConfig]):
            The StyleConfigs.
        next_page_token (str):
            A token, which can be sent as ``page_token`` to retrieve the
            next page. If this field is omitted, there are no subsequent
...
class MapContextConfig(proto.Message):
    ...
    Attributes:
        ...
        map_variants (MutableSequence[google.maps.mapmanagement_v2.types.MapContextConfig.MapVariant]):
...
class ListMapContextConfigsResponse(proto.Message):
    ...
    Attributes:
        map_context_configs (MutableSequence[google.maps.mapmanagement_v2.types.MapContextConfig]):

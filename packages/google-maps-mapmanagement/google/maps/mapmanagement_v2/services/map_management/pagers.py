...
class ListMapConfigsPager:
    ...
    :class:`google.maps.mapmanagement_v2.types.ListMapConfigsResponse` object, and
    ...
    All the usual :class:`google.maps.mapmanagement_v2.types.ListMapConfigsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.maps.mapmanagement_v2.types.ListMapConfigsRequest):
                The initial request object.
            response (google.maps.mapmanagement_v2.types.ListMapConfigsResponse):
...
class ListStyleConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.maps.mapmanagement_v2.types.ListStyleConfigsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``style_configs`` field.
    ...
    All the usual :class:`google.maps.mapmanagement_v2.types.ListStyleConfigsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.maps.mapmanagement_v2.types.ListStyleConfigsRequest):
                The initial request object.
            response (google.maps.mapmanagement_v2.types.ListStyleConfigsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListMapContextConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.maps.mapmanagement_v2.types.ListMapContextConfigsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.maps.mapmanagement_v2.types.ListMapContextConfigsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.maps.mapmanagement_v2.types.ListMapContextConfigsRequest):
                The initial request object.
            response (google.maps.mapmanagement_v2.types.ListMapContextConfigsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

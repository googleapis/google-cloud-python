...
class MapManagementTransport(abc.ABC):
    """Abstract transport class for MapManagement."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "mapmanagement.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_map_config: gapic_v1.method.wrap_method(
                self.create_map_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_map_config: gapic_v1.method.wrap_method(
                self.get_map_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_map_configs: gapic_v1.method.wrap_method(
                self.list_map_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_map_config: gapic_v1.method.wrap_method(
                self.update_map_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_map_config: gapic_v1.method.wrap_method(
                self.delete_map_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_style_config: gapic_v1.method.wrap_method(
                self.create_style_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_style_config: gapic_v1.method.wrap_method(
                self.get_style_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_style_configs: gapic_v1.method.wrap_method(
                self.list_style_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_style_config: gapic_v1.method.wrap_method(
                self.update_style_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_style_config: gapic_v1.method.wrap_method(
                self.delete_style_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_map_context_config: gapic_v1.method.wrap_method(
                self.create_map_context_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_map_context_config: gapic_v1.method.wrap_method(
                self.get_map_context_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_map_context_configs: gapic_v1.method.wrap_method(
                self.list_map_context_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_map_context_config: gapic_v1.method.wrap_method(
                self.update_map_context_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_map_context_config: gapic_v1.method.wrap_method(

...
from google.maps.mapmanagement_v2._compat import transcode_request
from google.maps.mapmanagement_v2.types import map_management_service
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.CreateMapConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.create_map_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "CreateMapConfig",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.CreateMapContextConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.create_map_context_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "CreateMapContextConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.CreateStyleConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.create_style_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "CreateStyleConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.DeleteMapConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.DeleteMapContextConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.DeleteStyleConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.GetMapConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.get_map_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "GetMapConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.GetMapContextConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.get_map_context_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "GetMapContextConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.GetStyleConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.get_style_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "GetStyleConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.ListMapConfigs",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.list_map_configs",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "ListMapConfigs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.ListMapContextConfigs",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.list_map_context_configs",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "ListMapContextConfigs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.ListStyleConfigs",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.list_style_configs",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "ListStyleConfigs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.UpdateMapConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.update_map_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "UpdateMapConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.UpdateMapContextConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.update_map_context_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "UpdateMapContextConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.maps.mapmanagement_v2.MapManagementClient.UpdateStyleConfig",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.maps.mapmanagement_v2.MapManagementClient.update_style_config",
                    extra={
                        "serviceName": "google.maps.mapmanagement.v2.MapManagement",
                        "rpcName": "UpdateStyleConfig",
                        "metadata": http_response["headers"],

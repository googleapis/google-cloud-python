...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.maps.mapmanagement_v2beta")  # type: ignore
    api_core.check_dependency_versions("google.maps.mapmanagement_v2beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.maps.mapmanagement_v2beta"

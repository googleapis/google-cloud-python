...
class AgentRegistryTransport(abc.ABC):
    """Abstract transport class for AgentRegistry."""
    ...
    DEFAULT_HOST: str = "agentregistry.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.search_mcp_servers: gapic_v1.method.wrap_method(
            ...
            self.list_bindings: gapic_v1.method.wrap_method(
                self.list_bindings,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.get_binding: gapic_v1.method.wrap_method(
                self.get_binding,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.create_binding: gapic_v1.method.wrap_method(
                self.create_binding,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_binding: gapic_v1.method.wrap_method(
                self.update_binding,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_binding: gapic_v1.method.wrap_method(
                self.delete_binding,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.fetch_available_bindings: gapic_v1.method.wrap_method(
    ...
    def get_agent(
        ...
        Union[agent.Agent, Awaitable[agent.Agent]],
    ]:
        raise NotImplementedError()
    ...
    def get_mcp_server(
        ...
        Union[mcp_server.McpServer, Awaitable[mcp_server.McpServer]],
    ]:
        raise NotImplementedError()
    ...
    def get_binding(
        ...
        Union[binding.Binding, Awaitable[binding.Binding]],
    ]:
        raise NotImplementedError()
...
__all__ = ("AgentRegistryTransport",)

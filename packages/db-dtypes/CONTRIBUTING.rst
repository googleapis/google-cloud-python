...
.. _repo: https://github.com/googleapis/google-cloud-python/tree/main/packages/db-dtypes
...
instead of
``https://github.com/googleapis/google-cloud-python/blob/main/packages/db-dtypes/CONTRIBUTING.rst``)

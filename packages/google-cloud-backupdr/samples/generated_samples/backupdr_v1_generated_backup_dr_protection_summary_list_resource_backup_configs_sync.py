...
def sample_list_resource_backup_configs():
    # Create a client
    client = backupdr_v1.BackupDrProtectionSummaryClient()

    # Initialize request argument(s)
    request = backupdr_v1.ListResourceBackupConfigsRequest(
        parent="parent_value",
    )

    # Make the request
    page_result = client.list_resource_backup_configs(request=request)

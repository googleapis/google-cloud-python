...
# [START backupdr_v1beta_generated_BackupDR_InitializeService_async]
...
async def sample_initialize_service():
    ...
    cloud_sql_instance_initialization_config = (
        backupdr_v1beta.CloudSqlInstanceInitializationConfig()
    )
    cloud_sql_instance_initialization_config.edition = "ENTERPRISE_PLUS"

    request = backupdr_v1beta.InitializeServiceRequest(
...
# [END backupdr_v1beta_generated_BackupDR_InitializeService_async]

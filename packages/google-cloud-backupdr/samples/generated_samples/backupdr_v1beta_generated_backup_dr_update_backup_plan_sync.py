...
# [START backupdr_v1beta_generated_BackupDR_UpdateBackupPlan_sync]
...
def sample_update_backup_plan():
    ...
    request = backupdr_v1beta.UpdateBackupPlanRequest(
...
# [END backupdr_v1beta_generated_BackupDR_UpdateBackupPlan_sync]

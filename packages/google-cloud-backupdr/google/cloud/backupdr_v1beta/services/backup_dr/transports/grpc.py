    ...
    def intercept_unary_unary(self, continuation, client_call_details, request):
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.cloud.backupdr.v1beta.BackupDR",
...
class BackupDRGrpcTransport(BackupDRTransport):
    ...
    def list_management_servers(
        ...
        if "list_management_servers" not in self._stubs:
            self._stubs["list_management_servers"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/ListManagementServers",
    ...
    def get_management_server(
        ...
        if "get_management_server" not in self._stubs:
            self._stubs["get_management_server"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetManagementServer",
    ...
    def create_management_server(
        ...
        if "create_management_server" not in self._stubs:
            self._stubs["create_management_server"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/CreateManagementServer",
    ...
    def delete_management_server(
        ...
        if "delete_management_server" not in self._stubs:
            self._stubs["delete_management_server"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/DeleteManagementServer",
    ...
    def create_backup_vault(
        ...
        if "create_backup_vault" not in self._stubs:
            self._stubs["create_backup_vault"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/CreateBackupVault",
    ...
    def list_backup_vaults(
        ...
        if "list_backup_vaults" not in self._stubs:
            self._stubs["list_backup_vaults"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/ListBackupVaults",
        ...
        if "fetch_usable_backup_vaults" not in self._stubs:
            self._stubs["fetch_usable_backup_vaults"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/FetchUsableBackupVaults",
    ...
    def get_backup_vault(
        ...
        if "get_backup_vault" not in self._stubs:
            self._stubs["get_backup_vault"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetBackupVault",
    ...
    def update_backup_vault(
        ...
        if "update_backup_vault" not in self._stubs:
            self._stubs["update_backup_vault"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/UpdateBackupVault",
    ...
    def list_data_sources(
        ...
        if "list_data_sources" not in self._stubs:
            self._stubs["list_data_sources"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/ListDataSources",
    ...
    def get_data_source(
        ...
        if "get_data_source" not in self._stubs:
            self._stubs["get_data_source"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetDataSource",
    ...
    def update_data_source(
        ...
        if "update_data_source" not in self._stubs:
            self._stubs["update_data_source"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/UpdateDataSource",
    ...
    def list_backups(
        ...
        if "list_backups" not in self._stubs:
            self._stubs["list_backups"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/ListBackups",
    ...
    def fetch_backups_for_resource_type(
        ...
        Returns:
            Callable[[~.FetchBackupsForResourceTypeRequest],
    ...
    def get_backup(
        ...
        if "get_backup" not in self._stubs:
            self._stubs["get_backup"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetBackup",
    ...
    def update_backup(
        ...
        if "update_backup" not in self._stubs:
            self._stubs["update_backup"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/UpdateBackup",
    ...
    def delete_backup(
        ...
        if "delete_backup" not in self._stubs:
            self._stubs["delete_backup"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/DeleteBackup",
    ...
    def restore_backup(
        ...
        if "restore_backup" not in self._stubs:
            self._stubs["restore_backup"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/RestoreBackup",
    ...
    def create_backup_plan(
        ...
        if "create_backup_plan" not in self._stubs:
            self._stubs["create_backup_plan"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/CreateBackupPlan",
    ...
    def update_backup_plan(
        ...
        if "update_backup_plan" not in self._stubs:
            self._stubs["update_backup_plan"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/UpdateBackupPlan",
    ...
    def get_backup_plan(
        ...
        if "get_backup_plan" not in self._stubs:
            self._stubs["get_backup_plan"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetBackupPlan",
    ...
    def list_backup_plans(
        ...
        if "list_backup_plans" not in self._stubs:
            self._stubs["list_backup_plans"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/ListBackupPlans",
    ...
    def delete_backup_plan(
        ...
        if "delete_backup_plan" not in self._stubs:
            self._stubs["delete_backup_plan"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/DeleteBackupPlan",
    ...
    def get_backup_plan_revision(
        ...
        if "get_backup_plan_revision" not in self._stubs:
            self._stubs["get_backup_plan_revision"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetBackupPlanRevision",
    ...
    def list_backup_plan_revisions(
        ...
        if "list_backup_plan_revisions" not in self._stubs:
            self._stubs["list_backup_plan_revisions"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListBackupPlanRevisions",
    ...
    def get_backup_plan_association(
        ...
        if "get_backup_plan_association" not in self._stubs:
            self._stubs["get_backup_plan_association"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/GetBackupPlanAssociation",
    ...
    def list_backup_plan_associations(
        ...
        if "list_backup_plan_associations" not in self._stubs:
            self._stubs["list_backup_plan_associations"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListBackupPlanAssociations",
    ...
    def trigger_backup(
        ...
        if "trigger_backup" not in self._stubs:
            self._stubs["trigger_backup"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/TriggerBackup",
    ...
    def get_data_source_reference(
        ...
        if "get_data_source_reference" not in self._stubs:
            self._stubs["get_data_source_reference"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/GetDataSourceReference",
    ...
    def list_data_source_references(
        ...
        Returns:
            Callable[[~.ListDataSourceReferencesRequest],
        ...
        if "list_data_source_references" not in self._stubs:
            self._stubs["list_data_source_references"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListDataSourceReferences",
    ...
    def initialize_service(
        ...
        if "initialize_service" not in self._stubs:
            self._stubs["initialize_service"] = self._logged_channel.unary_unary(
                "/google.cloud.backupdr.v1beta.BackupDR/InitializeService",
    ...
    def create_auto_protection_policy(
        ...
        [autoprotectionpolicy.CreateAutoProtectionPolicyRequest],
        operations_pb2.Operation,
    ]:
        r"""Return a callable for the create auto protection policy method over gRPC.

        Creates a new AutoProtectionPolicy in a given project
        and location.

        Returns:
            Callable[[~.CreateAutoProtectionPolicyRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_auto_protection_policy" not in self._stubs:
            self._stubs["create_auto_protection_policy"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/CreateAutoProtectionPolicy",
                    request_serializer=autoprotectionpolicy.CreateAutoProtectionPolicyRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["create_auto_protection_policy"]

    @property
    def list_auto_protection_policies(
        self,
    ) -> Callable[
        [autoprotectionpolicy.ListAutoProtectionPoliciesRequest],
        autoprotectionpolicy.ListAutoProtectionPoliciesResponse,
    ]:
        r"""Return a callable for the list auto protection policies method over gRPC.

        Lists AutoProtectionPolicies for a given project and
        location.

        Returns:
            Callable[[~.ListAutoProtectionPoliciesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_auto_protection_policies" not in self._stubs:
            self._stubs["list_auto_protection_policies"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListAutoProtectionPolicies",
                    request_serializer=autoprotectionpolicy.ListAutoProtectionPoliciesRequest.serialize,
                    response_deserializer=autoprotectionpolicy.ListAutoProtectionPoliciesResponse.deserialize,
                )
            )
        return self._stubs["list_auto_protection_policies"]

    @property
    def get_auto_protection_policy(
        self,
    ) -> Callable[
        [autoprotectionpolicy.GetAutoProtectionPolicyRequest],
        autoprotectionpolicy.AutoProtectionPolicy,
    ]:
        r"""Return a callable for the get auto protection policy method over gRPC.

        Gets details of a single AutoProtectionPolicy.

        Returns:
            Callable[[~.GetAutoProtectionPolicyRequest],
                    ~.AutoProtectionPolicy]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_auto_protection_policy" not in self._stubs:
            self._stubs["get_auto_protection_policy"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/GetAutoProtectionPolicy",
                    request_serializer=autoprotectionpolicy.GetAutoProtectionPolicyRequest.serialize,
                    response_deserializer=autoprotectionpolicy.AutoProtectionPolicy.deserialize,
                )
            )
        return self._stubs["get_auto_protection_policy"]

    @property
    def update_auto_protection_policy(
        self,
    ) -> Callable[
        [autoprotectionpolicy.UpdateAutoProtectionPolicyRequest],
        operations_pb2.Operation,
    ]:
        r"""Return a callable for the update auto protection policy method over gRPC.

        Updates the parameters of a single
        AutoProtectionPolicy.

        Returns:
            Callable[[~.UpdateAutoProtectionPolicyRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_auto_protection_policy" not in self._stubs:
            self._stubs["update_auto_protection_policy"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/UpdateAutoProtectionPolicy",
                    request_serializer=autoprotectionpolicy.UpdateAutoProtectionPolicyRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["update_auto_protection_policy"]

    @property
    def delete_auto_protection_policy(
        self,
    ) -> Callable[
        [autoprotectionpolicy.DeleteAutoProtectionPolicyRequest],
        operations_pb2.Operation,
    ]:
        r"""Return a callable for the delete auto protection policy method over gRPC.

        Deletes a single AutoProtectionPolicy.

        Returns:
            Callable[[~.DeleteAutoProtectionPolicyRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_auto_protection_policy" not in self._stubs:
            self._stubs["delete_auto_protection_policy"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/DeleteAutoProtectionPolicy",
                    request_serializer=autoprotectionpolicy.DeleteAutoProtectionPolicyRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["delete_auto_protection_policy"]

    @property
    def create_auto_protection_policy_binding(
        self,
    ) -> Callable[
        [autoprotectionpolicybinding.CreateAutoProtectionPolicyBindingRequest],
        operations_pb2.Operation,
    ]:
        r"""Return a callable for the create auto protection policy
        binding method over gRPC.

        Creates a new AutoProtectionPolicyBinding in a given
        project and location.

        Returns:
            Callable[[~.CreateAutoProtectionPolicyBindingRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_auto_protection_policy_binding" not in self._stubs:
            self._stubs["create_auto_protection_policy_binding"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/CreateAutoProtectionPolicyBinding",
                    request_serializer=autoprotectionpolicybinding.CreateAutoProtectionPolicyBindingRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["create_auto_protection_policy_binding"]

    @property
    def get_auto_protection_policy_binding(
        self,
    ) -> Callable[
        [autoprotectionpolicybinding.GetAutoProtectionPolicyBindingRequest],
        autoprotectionpolicybinding.AutoProtectionPolicyBinding,
    ]:
        r"""Return a callable for the get auto protection policy
        binding method over gRPC.

        Returns the auto protection policy binding read from
        the CCFE tables.

        Returns:
            Callable[[~.GetAutoProtectionPolicyBindingRequest],
                    ~.AutoProtectionPolicyBinding]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_auto_protection_policy_binding" not in self._stubs:
            self._stubs["get_auto_protection_policy_binding"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/GetAutoProtectionPolicyBinding",
                    request_serializer=autoprotectionpolicybinding.GetAutoProtectionPolicyBindingRequest.serialize,
                    response_deserializer=autoprotectionpolicybinding.AutoProtectionPolicyBinding.deserialize,
                )
            )
        return self._stubs["get_auto_protection_policy_binding"]

    @property
    def list_auto_protection_policy_bindings(
        self,
    ) -> Callable[
        [autoprotectionpolicybinding.ListAutoProtectionPolicyBindingsRequest],
        autoprotectionpolicybinding.ListAutoProtectionPolicyBindingsResponse,
    ]:
        r"""Return a callable for the list auto protection policy
        bindings method over gRPC.

        Returns the auto protection policy bindings read from
        the CCFE tables.

        Returns:
            Callable[[~.ListAutoProtectionPolicyBindingsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_auto_protection_policy_bindings" not in self._stubs:
            self._stubs["list_auto_protection_policy_bindings"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListAutoProtectionPolicyBindings",
                    request_serializer=autoprotectionpolicybinding.ListAutoProtectionPolicyBindingsRequest.serialize,
                    response_deserializer=autoprotectionpolicybinding.ListAutoProtectionPolicyBindingsResponse.deserialize,
                )
            )
        return self._stubs["list_auto_protection_policy_bindings"]
    ...
    def list_applied_auto_protection_policies(
        ...
        r"""Return a callable for the list applied auto protection
        ...
        Returns:
            Callable[[~.ListAppliedAutoProtectionPoliciesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_applied_auto_protection_policies" not in self._stubs:
            self._stubs["list_applied_auto_protection_policies"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListAppliedAutoProtectionPolicies",
                    request_serializer=appliedautoprotectionpolicy.ListAppliedAutoProtectionPoliciesRequest.serialize,
                    response_deserializer=appliedautoprotectionpolicy.ListAppliedAutoProtectionPoliciesResponse.deserialize,
                )
            )
        return self._stubs["list_applied_auto_protection_policies"]

    @property
    def initiate_delete_auto_protection_policy_binding(
        self,
    ) -> Callable[
        [autoprotectionpolicybinding.InitiateDeleteAutoProtectionPolicyBindingRequest],
        operations_pb2.Operation,
    ]:
        r"""Return a callable for the initiate delete auto
        protection policy binding method over gRPC.

        InitiateDeleteAutoProtectionPolicyBinding initiates
        delete for AutoProtectionPolicy Binding

        Returns:
            Callable[[~.InitiateDeleteAutoProtectionPolicyBindingRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "initiate_delete_auto_protection_policy_binding" not in self._stubs:
            self._stubs["initiate_delete_auto_protection_policy_binding"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/InitiateDeleteAutoProtectionPolicyBinding",
                    request_serializer=autoprotectionpolicybinding.InitiateDeleteAutoProtectionPolicyBindingRequest.serialize,
                    response_deserializer=operations_pb2.Operation.FromString,
                )
            )
        return self._stubs["initiate_delete_auto_protection_policy_binding"]

    @property
    def get_binding_matching_resource(
        self,
    ) -> Callable[
        [bindingmatchingresource.GetBindingMatchingResourceRequest],
        bindingmatchingresource.BindingMatchingResource,
    ]:
        r"""Return a callable for the get binding matching resource method over gRPC.

        Gets details of a single Binding Matching Resource.

        Returns:
            Callable[[~.GetBindingMatchingResourceRequest],
                    ~.BindingMatchingResource]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_binding_matching_resource" not in self._stubs:
            self._stubs["get_binding_matching_resource"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/GetBindingMatchingResource",
                    request_serializer=bindingmatchingresource.GetBindingMatchingResourceRequest.serialize,
                    response_deserializer=bindingmatchingresource.BindingMatchingResource.deserialize,
                )
            )
        return self._stubs["get_binding_matching_resource"]

    @property
    def list_binding_matching_resources(
        self,
    ) -> Callable[
        [bindingmatchingresource.ListBindingMatchingResourcesRequest],
        bindingmatchingresource.ListBindingMatchingResourcesResponse,
    ]:
        r"""Return a callable for the list binding matching
        resources method over gRPC.

        Lists Binding Matching Resources for a given
        AutoProtectionPolicyBinding.

        Returns:
            Callable[[~.ListBindingMatchingResourcesRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_binding_matching_resources" not in self._stubs:
            self._stubs["list_binding_matching_resources"] = (
                self._logged_channel.unary_unary(
                    "/google.cloud.backupdr.v1beta.BackupDR/ListBindingMatchingResources",
                    request_serializer=bindingmatchingresource.ListBindingMatchingResourcesRequest.serialize,
                    response_deserializer=bindingmatchingresource.ListBindingMatchingResourcesResponse.deserialize,
                )
            )
        return self._stubs["list_binding_matching_resources"]

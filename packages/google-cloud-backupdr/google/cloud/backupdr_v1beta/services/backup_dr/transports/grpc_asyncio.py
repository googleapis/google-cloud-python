...
class BackupDRGrpcAsyncIOTransport(BackupDRTransport):
    ...
    def fetch_backups_for_resource_type(
        ...
        Returns:
            Callable[[~.FetchBackupsForResourceTypeRequest],
                    Awaitable[~.FetchBackupsForResourceTypeResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def update_backup_plan(
        ...
        [backupplan.UpdateBackupPlanRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def get_backup_plan_revision(
        ...
        Awaitable[backupplan.BackupPlanRevision],
    ]:
    ...
    def list_backup_plan_revisions(
        ...
        Returns:
            Callable[[~.ListBackupPlanRevisionsRequest],
                    Awaitable[~.ListBackupPlanRevisionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def fetch_backup_plan_associations_for_resource_type(
        ...
        Returns:
            Callable[[~.FetchBackupPlanAssociationsForResourceTypeRequest],
                    Awaitable[~.FetchBackupPlanAssociationsForResourceTypeResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_data_source_references(
        ...
        Returns:
            Callable[[~.ListDataSourceReferencesRequest],
                    Awaitable[~.ListDataSourceReferencesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def fetch_data_source_references_for_resource_type(
        ...
        Returns:
            Callable[[~.FetchDataSourceReferencesForResourceTypeRequest],
                    Awaitable[~.FetchDataSourceReferencesForResourceTypeResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_auto_protection_policies(
        ...
        Returns:
            Callable[[~.ListAutoProtectionPoliciesRequest],
                    Awaitable[~.ListAutoProtectionPoliciesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_auto_protection_policy(
        ...
        Awaitable[autoprotectionpolicy.AutoProtectionPolicy],
    ]:
        ...
        Returns:
            Callable[[~.GetAutoProtectionPolicyRequest],
                    Awaitable[~.AutoProtectionPolicy]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_auto_protection_policy_binding(
        ...
        Awaitable[autoprotectionpolicybinding.AutoProtectionPolicyBinding],
    ]:
        ...
        Returns:
            Callable[[~.GetAutoProtectionPolicyBindingRequest],
                    Awaitable[~.AutoProtectionPolicyBinding]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_auto_protection_policy_bindings(
        ...
        Awaitable[autoprotectionpolicybinding.ListAutoProtectionPolicyBindingsResponse],
    ]:
        ...
        Returns:
            Callable[[~.ListAutoProtectionPolicyBindingsRequest],
                    Awaitable[~.ListAutoProtectionPolicyBindingsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_applied_auto_protection_policies(
        ...
        Returns:
            Callable[[~.ListAppliedAutoProtectionPoliciesRequest],
                    Awaitable[~.ListAppliedAutoProtectionPoliciesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_binding_matching_resource(
        ...
        Awaitable[bindingmatchingresource.BindingMatchingResource],
    ]:
        ...
        Returns:
            Callable[[~.GetBindingMatchingResourceRequest],
                    Awaitable[~.BindingMatchingResource]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_binding_matching_resources(
        ...
        Returns:
            Callable[[~.ListBindingMatchingResourcesRequest],
                    Awaitable[~.ListBindingMatchingResourcesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.fetch_backups_for_resource_type: self._wrap_method(
            ...
            self.update_backup_plan: self._wrap_method(
            ...
            self.get_backup_plan_revision: self._wrap_method(
                self.get_backup_plan_revision,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_backup_plan_revisions: self._wrap_method(
            ...
            self.update_backup_plan_association: self._wrap_method(
            ...
            self.fetch_backup_plan_associations_for_resource_type: self._wrap_method(
            ...
            self.get_data_source_reference: self._wrap_method(
                self.get_data_source_reference,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_data_source_references: self._wrap_method(
                self.list_data_source_references,
                default_timeout=None,
                client_info=client_info,
            ),
            self.fetch_data_source_references_for_resource_type: self._wrap_method(
            ...
            self.create_auto_protection_policy: self._wrap_method(
                self.create_auto_protection_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_auto_protection_policies: self._wrap_method(
                self.list_auto_protection_policies,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_auto_protection_policy: self._wrap_method(
                self.get_auto_protection_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_auto_protection_policy: self._wrap_method(
                self.update_auto_protection_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_auto_protection_policy: self._wrap_method(
                self.delete_auto_protection_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_auto_protection_policy_binding: self._wrap_method(
                self.create_auto_protection_policy_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_auto_protection_policy_binding: self._wrap_method(
                self.get_auto_protection_policy_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_auto_protection_policy_bindings: self._wrap_method(
                self.list_auto_protection_policy_bindings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_applied_auto_protection_policies: self._wrap_method(
                self.list_applied_auto_protection_policies,
                default_timeout=None,
                client_info=client_info,
            ),
            self.initiate_delete_auto_protection_policy_binding: self._wrap_method(
                self.initiate_delete_auto_protection_policy_binding,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_binding_matching_resource: self._wrap_method(
                self.get_binding_matching_resource,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_binding_matching_resources: self._wrap_method(
                self.list_binding_matching_resources,
                default_timeout=None,
                client_info=client_info,
            ),

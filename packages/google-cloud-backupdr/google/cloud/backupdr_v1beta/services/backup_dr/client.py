...
from google.cloud.backupdr_v1beta.services.backup_dr import pagers
...
from .transports.rest import BackupDRRestTransport


class BackupDRClientMeta(type):
    """Metaclass for the BackupDR client.
...
class BackupDRClient(metaclass=BackupDRClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BackupDRClient: The constructed client.
        """
    ...
    def transport(self) -> BackupDRTransport:
        ...
        Returns:
            BackupDRTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def applied_auto_protection_policy_path(
        project: str,
        location: str,
        applied_auto_protection_policy: str,
    ) -> str:
        """Returns a fully-qualified applied_auto_protection_policy string."""
        return "projects/{project}/locations/{location}/appliedAutoProtectionPolicies/{applied_auto_protection_policy}".format(
            project=project,
            location=location,
            applied_auto_protection_policy=applied_auto_protection_policy,
        )

    @staticmethod
    def parse_applied_auto_protection_policy_path(path: str) -> Dict[str, str]:
        """Parses a applied_auto_protection_policy path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/appliedAutoProtectionPolicies/(?P<applied_auto_protection_policy>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def auto_protection_policy_path(
        project: str,
        location: str,
        auto_protection_policy: str,
    ) -> str:
        """Returns a fully-qualified auto_protection_policy string."""
        return "projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_auto_protection_policy_path(path: str) -> Dict[str, str]:
        """Parses a auto_protection_policy path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/autoProtectionPolicies/(?P<auto_protection_policy>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def auto_protection_policy_binding_path(
        project: str,
        location: str,
        auto_protection_policy: str,
        binding: str,
    ) -> str:
        """Returns a fully-qualified auto_protection_policy_binding string."""
        return "projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}/bindings/{binding}".format(
            project=project,
            location=location,
            auto_protection_policy=auto_protection_policy,
            binding=binding,
    ...
    @staticmethod
    def parse_auto_protection_policy_binding_path(path: str) -> Dict[str, str]:
        """Parses a auto_protection_policy_binding path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/autoProtectionPolicies/(?P<auto_protection_policy>.+?)/bindings/(?P<binding>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def binding_matching_resource_path(
        project: str,
        location: str,
        auto_protection_policy: str,
        binding: str,
        ...
        """Returns a fully-qualified binding_matching_resource string."""
        return "projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}/bindings/{binding}/matchingResources/{matching_resource}".format(
            project=project,
            location=location,
            auto_protection_policy=auto_protection_policy,
            binding=binding,
    ...
    @staticmethod
    def parse_binding_matching_resource_path(path: str) -> Dict[str, str]:
        """Parses a binding_matching_resource path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/autoProtectionPolicies/(?P<auto_protection_policy>.+?)/bindings/(?P<binding>.+?)/matchingResources/(?P<matching_resource>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def management_server_path(
        ...
        return "projects/{project}/locations/{location}/managementServers/{managementserver}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_management_server_path(path: str) -> Dict[str, str]:
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(transport, BackupDRTransport)
        if transport_provided:
            # transport is a BackupDRTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=BackupDRClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[BackupDRTransport], Callable[..., BackupDRTransport]
            ] = (
                BackupDRClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., BackupDRTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.backupdr_v1beta.BackupDRClient`.",
                    extra={
        ...
        *,
    ...
    ) -> pagers.ListManagementServersPager:
        ...
        .. code-block:: python
            ...
            def sample_list_management_servers():
                ...
                request = backupdr_v1beta.ListManagementServersRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListManagementServersRequest, dict]):
            ...
            parent (str):
                ...
                Cloud Backup and DR, locations map to Google Cloud
                regions, for example **us-central1**. To retrieve
                management servers for all locations, use "-" for the
                '{location}' value.
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListManagementServersPager:
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_management_servers]
        ...
        response = pagers.ListManagementServersPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_management_server(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetManagementServerRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.ManagementServer:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_management_server]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_management_server():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.CreateManagementServerRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.CreateManagementServerRequest, dict]):
                The request object. Request message for creating a
                management server instance.
            parent (str):
                Required. The management server project and location in
                the format 'projects/{project_id}/locations/{location}'.
                In Google Cloud Backup and DR locations map to Google
                Cloud regions, for example **us-central1**.

                This corresponds to the ``parent`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            management_server (google.cloud.backupdr_v1beta.types.ManagementServer):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.backupdr_v1beta.types.ManagementServer`
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_management_server]
    ...
    def delete_management_server(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.DeleteManagementServerRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_management_server]
    ...
    def create_backup_vault(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.CreateBackupVaultRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup_vault (google.cloud.backupdr_v1beta.types.BackupVault):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.backupdr_v1beta.types.BackupVault`
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_backup_vaults():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.ListBackupVaultsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListBackupVaultsRequest, dict]):
                The request object. Request message for listing
                backupvault stores.
            parent (str):
                Required. The project and location for which to retrieve
                ...
                Cloud Backup and DR, locations map to Google Cloud
                regions, for example **us-central1**. To retrieve
                backupvault stores for all locations, use "-" for the
                '{location}' value.
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListBackupVaultsPager:
                Response message for listing
                BackupVaults.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def fetch_usable_backup_vaults(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.FetchUsableBackupVaultsRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.FetchUsableBackupVaultsPager:
    ...
    def get_backup_vault(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetBackupVaultRequest, dict]):
                The request object. Request message for getting a
                BackupVault.
            name (str):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_backup_vault():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.UpdateBackupVaultRequest(
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.UpdateBackupVaultRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_backup_vault():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.DeleteBackupVaultRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.DeleteBackupVaultRequest, dict]):
    ...
    def list_data_sources(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListDataSourcesRequest, dict]):
                The request object. Request message for listing
                DataSources.
            parent (str):
                Required. The project and location for which to retrieve
                ...
                'projects/{project_id}/locations/{location}'. In Google
                Cloud Backup and DR, locations map to Google Cloud
                regions, for example **us-central1**. To retrieve data
                sources for all locations, use "-" for the '{location}'
                value.
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListDataSourcesPager:
                Response message for listing
                DataSources.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_data_source():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.GetDataSourceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetDataSourceRequest, dict]):
                The request object. Request message for getting a
                DataSource instance.
            name (str):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.DataSource:
    ...
    def update_data_source(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.UpdateDataSourceRequest, dict]):
                The request object. Request message for updating a data
                source instance.
            data_source (google.cloud.backupdr_v1beta.types.DataSource):
                Required. The resource being updated
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.backupdr_v1beta.types.DataSource` Message describing a DataSource object.
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_backups():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.ListBackupsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListBackupsRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListBackupsPager:
    ...
    def fetch_backups_for_resource_type(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.FetchBackupsForResourceTypeRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.FetchBackupsForResourceTypePager:
                Response for the
                FetchBackupsForResourceType method.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def get_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetBackupRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.Backup:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_backup():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.UpdateBackupRequest(
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.UpdateBackupRequest, dict]):
                The request object. Request message for updating a
                Backup.
            backup (google.cloud.backupdr_v1beta.types.Backup):
                Required. The resource being updated
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.backupdr_v1beta.types.Backup`
                Message describing a Backup object.
    ...
    def delete_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.DeleteBackupRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_restore_backup():
                ...
                # Initialize request argument(s)
                compute_instance_target_environment = backupdr_v1beta.ComputeInstanceTargetEnvironment()
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.RestoreBackupRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.backupdr_v1beta.types.RestoreBackupResponse`
    ...
    def create_backup_plan(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.CreateBackupPlanRequest, dict]):
            ...
            parent (str):
                ...
                Google Cloud Backup and DR locations map to Google Cloud
                regions, for example **us-central1**.

                This corresponds to the ``parent`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup_plan (google.cloud.backupdr_v1beta.types.BackupPlan):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.backupdr_v1beta.types.BackupPlan` A BackupPlan specifies some common fields, such as description as well
    ...
    def update_backup_plan(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.UpdateBackupPlanRequest, dict]):
    ...
    def get_backup_plan(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetBackupPlanRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_backup_plans():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.ListBackupPlansRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListBackupPlansRequest, dict]):
                The request object. The request message for getting a list ``BackupPlan``.
            parent (str):
                Required. The project and location for which to retrieve
                ``BackupPlans`` information. Format:
                ``projects/{project}/locations/{location}``. In Google
                Cloud Backup and DR, locations map to Google Cloud
                regions, for e.g. **us-central1**. To retrieve backup
                plans for all locations, use "-" for the ``{location}``
                value.
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListBackupPlansPager:
    ...
    def delete_backup_plan(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.DeleteBackupPlanRequest, dict]):
    ...
    def get_backup_plan_revision(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetBackupPlanRevisionRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.BackupPlanRevision:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_backup_plan_revisions():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.ListBackupPlanRevisionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListBackupPlanRevisionsRequest, dict]):
            ...
            parent (str):
                ...
                ``projects/{project}/locations/{location}/backupPlans/{backup_plan}``.
                In Google Cloud Backup and DR, locations map to Google
                Cloud regions, for e.g. **us-central1**.
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListBackupPlanRevisionsPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_backup_plan_association():
                ...
                request = backupdr_v1beta.CreateBackupPlanAssociationRequest(
                    parent="parent_value",
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.CreateBackupPlanAssociationRequest, dict]):
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            backup_plan_association (google.cloud.backupdr_v1beta.types.BackupPlanAssociation):
                Required. The resource being created
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.backupdr_v1beta.types.BackupPlanAssociation` A BackupPlanAssociation represents a single BackupPlanAssociation which
    ...
    def update_backup_plan_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.UpdateBackupPlanAssociationRequest, dict]):
                The request object. Request message for updating a backup
                plan association.
            backup_plan_association (google.cloud.backupdr_v1beta.types.BackupPlanAssociation):
                Required. The resource being updated
    ...
    def get_backup_plan_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetBackupPlanAssociationRequest, dict]):
                The request object. Request message for getting a
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_backup_plan_associations():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.ListBackupPlanAssociationsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListBackupPlanAssociationsRequest, dict]):
            ...
            parent (str):
                ...
                for example **us-central1**. To retrieve backup plan
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListBackupPlanAssociationsPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_fetch_backup_plan_associations_for_resource_type():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.FetchBackupPlanAssociationsForResourceTypeRequest(
                    parent="parent_value",
                    resource_type="resource_type_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.FetchBackupPlanAssociationsForResourceTypeRequest, dict]):
                The request object. Request for the
            ...
            parent (str):
                ...
                should not be set.
            resource_type (str):
                Required. The type of the Google
                Cloud resource. Ex:
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.FetchBackupPlanAssociationsForResourceTypePager:
                Response for the
                FetchBackupPlanAssociationsForResourceType
    ...
    def delete_backup_plan_association(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.DeleteBackupPlanAssociationRequest, dict]):
    ...
    def trigger_backup(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.TriggerBackupRequest, dict]):
            ...
            name (str):
                ...
                should not be set.
            rule_id (str):
                Optional. backup rule_id for which a backup needs to be
                triggered. If not specified, on-demand backup with
    ...
    def get_data_source_reference(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetDataSourceReferenceRequest, dict]):
                The request object. Request for the
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_data_source_references():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.ListDataSourceReferencesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListDataSourceReferencesRequest, dict]):
                The request object. Request for the
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListDataSourceReferencesPager:
                Response for the
                ListDataSourceReferences method.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_fetch_data_source_references_for_resource_type():
                ...
                # Initialize request argument(s)
                request = backupdr_v1beta.FetchDataSourceReferencesForResourceTypeRequest(
                    parent="parent_value",
                    resource_type="resource_type_value",
                )
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.FetchDataSourceReferencesForResourceTypeRequest, dict]):
                The request object. Request for the
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.FetchDataSourceReferencesForResourceTypePager:
                Response for the
                FetchDataSourceReferencesForResourceType
                method.  Iterating over this object will
                yield results and resolve additional
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_initialize_service():
                ...
                # Initialize request argument(s)
                cloud_sql_instance_initialization_config = backupdr_v1beta.CloudSqlInstanceInitializationConfig()
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.InitializeServiceRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.backupdr_v1beta.types.InitializeServiceResponse`
    ...
    def create_auto_protection_policy(
        self,
        request: Optional[
            Union[autoprotectionpolicy.CreateAutoProtectionPolicyRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        auto_protection_policy: Optional[
            autoprotectionpolicy.AutoProtectionPolicy
        ] = None,
        auto_protection_policy_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation.Operation:
        r"""Creates a new AutoProtectionPolicy in a given project
        and location.
        ...
        .. code-block:: python
            ...
            def sample_create_auto_protection_policy():
                ...
                auto_protection_policy.criteria.matching_conditions.label_condition.key = "key_value"
                auto_protection_policy.criteria.matching_conditions.label_condition.values = ['values_value1', 'values_value2']
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.CreateAutoProtectionPolicyRequest, dict]):
                The request object. Request message for creating an
                AutoProtectionPolicy.
            parent (str):
                Required. The parent resource where
                this policy will be created. Format:
                projects/{project}/locations/{location}
            ...
            auto_protection_policy (google.cloud.backupdr_v1beta.types.AutoProtectionPolicy):
                Required. The AutoProtectionPolicy
                resource to create.

                This corresponds to the ``auto_protection_policy`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            auto_protection_policy_id (str):
                Required. The ID to use for the
                policy. This will become the final
                component of the policy's resource name.

                This corresponds to the ``auto_protection_policy_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.backupdr_v1beta.types.AutoProtectionPolicy` An AutoprotectionPolicy is a policy resource designed to automate backup
                   management, moving from manual per-resource
                   protection to a bulk approach. The policy dynamically
                   discovers and applies a specified backup plan to all
                   eligible resources that match its defined scope and
                   criteria.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, auto_protection_policy, auto_protection_policy_id]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        #   there are no flattened fields), or create one.
        if not isinstance(
            request, autoprotectionpolicy.CreateAutoProtectionPolicyRequest
        ):
            request = autoprotectionpolicy.CreateAutoProtectionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
            if auto_protection_policy is not None:
                request.auto_protection_policy = auto_protection_policy
            if auto_protection_policy_id is not None:
                request.auto_protection_policy_id = auto_protection_policy_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_auto_protection_policy
        ]
    ...
    def list_auto_protection_policies(
        self,
        request: Optional[
            Union[autoprotectionpolicy.ListAutoProtectionPoliciesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListAutoProtectionPoliciesPager:
        r"""Lists AutoProtectionPolicies for a given project and
        location.
        ...
        .. code-block:: python
            ...
            def sample_list_auto_protection_policies():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()

                # Initialize request argument(s)
                request = backupdr_v1beta.ListAutoProtectionPoliciesRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_auto_protection_policies(request=request)
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListAutoProtectionPoliciesRequest, dict]):
                The request object. Request message for
                ListAutoProtectionPolicies.
            parent (str):
                Required. The project and location
                for which to retrieve the list of
                policies. Format:
                projects/{project}/locations/{location}
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListAutoProtectionPoliciesPager:
        ...
        if not isinstance(
            ...
            request = autoprotectionpolicy.ListAutoProtectionPoliciesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_auto_protection_policies
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListAutoProtectionPoliciesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_auto_protection_policy(
        self,
        request: Optional[
            Union[autoprotectionpolicy.GetAutoProtectionPolicyRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Gets details of a single AutoProtectionPolicy.
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetAutoProtectionPolicyRequest, dict]):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.AutoProtectionPolicy:
                An AutoprotectionPolicy is a policy
                resource designed to automate backup
                management, moving from manual
                per-resource protection to a bulk
                approach. The policy dynamically
                discovers and applies a specified backup
                plan to all eligible resources that
                match its defined scope and criteria.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, autoprotectionpolicy.GetAutoProtectionPolicyRequest):
            request = autoprotectionpolicy.GetAutoProtectionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_auto_protection_policy
        ]
    ...
    def update_auto_protection_policy(
        self,
        request: Optional[
            Union[autoprotectionpolicy.UpdateAutoProtectionPolicyRequest, dict]
        ] = None,
        *,
        auto_protection_policy: Optional[
            autoprotectionpolicy.AutoProtectionPolicy
        ...
        .. code-block:: python
            ...
            def sample_update_auto_protection_policy():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()
                ...
                request = backupdr_v1beta.UpdateAutoProtectionPolicyRequest(
                    auto_protection_policy=auto_protection_policy,
                )

                # Make the request
                operation = client.update_auto_protection_policy(request=request)
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.UpdateAutoProtectionPolicyRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [auto_protection_policy, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        #   there are no flattened fields), or create one.
        if not isinstance(
            request, autoprotectionpolicy.UpdateAutoProtectionPolicyRequest
        ):
            request = autoprotectionpolicy.UpdateAutoProtectionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if auto_protection_policy is not None:
                request.auto_protection_policy = auto_protection_policy
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_auto_protection_policy
        ]
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (("auto_protection_policy.name", request.auto_protection_policy.name),)
            ),
        )
    ...
    def delete_auto_protection_policy(
        self,
        request: Optional[
            Union[autoprotectionpolicy.DeleteAutoProtectionPolicyRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Deletes a single AutoProtectionPolicy.
        ...
        .. code-block:: python
            ...
            def sample_delete_auto_protection_policy():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()

                # Initialize request argument(s)
                request = backupdr_v1beta.DeleteAutoProtectionPolicyRequest(
                    name="name_value",
                )

                # Make the request
                operation = client.delete_auto_protection_policy(request=request)
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.DeleteAutoProtectionPolicyRequest, dict]):
        ...
        #   there are no flattened fields), or create one.
        if not isinstance(
            request, autoprotectionpolicy.DeleteAutoProtectionPolicyRequest
        ):
            request = autoprotectionpolicy.DeleteAutoProtectionPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_auto_protection_policy
        ]
    ...
    def create_auto_protection_policy_binding(
        ...
        *,
        parent: Optional[str] = None,
        auto_protection_policy_binding: Optional[
            autoprotectionpolicybinding.AutoProtectionPolicyBinding
        ] = None,
        auto_protection_policy_binding_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> operation.Operation:
        r"""Creates a new AutoProtectionPolicyBinding in a given
        ...
        .. code-block:: python
            ...
            def sample_create_auto_protection_policy_binding():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()
                ...
                # Make the request
                operation = client.create_auto_protection_policy_binding(request=request)
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.CreateAutoProtectionPolicyBindingRequest, dict]):
                The request object. Request message for creating an
                AutoProtectionPolicyBinding.
            parent (str):
            ...
            auto_protection_policy_binding (google.cloud.backupdr_v1beta.types.AutoProtectionPolicyBinding):
                Required. The
                AutoProtectionPolicyBinding resource to
                create.

                This corresponds to the ``auto_protection_policy_binding`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            auto_protection_policy_binding_id (str):
                Required. The ID to use for the
                binding. This will become the final
                component of the binding's resource
                name.

                This corresponds to the ``auto_protection_policy_binding_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.backupdr_v1beta.types.AutoProtectionPolicyBinding` An AutoprotectionPolicyBinding (APPA) acts as the bridge between an
                   AutoprotectionPolicy and the scope (Project, Folder,
        ...
        if not isinstance(
            ...
            if parent is not None:
                request.parent = parent
            if auto_protection_policy_binding is not None:
                request.auto_protection_policy_binding = auto_protection_policy_binding
            if auto_protection_policy_binding_id is not None:
                request.auto_protection_policy_binding_id = (
                    auto_protection_policy_binding_id
                )
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_auto_protection_policy_binding
        ]
    ...
    def get_auto_protection_policy_binding(
        ...
        request: Optional[
            Union[
                autoprotectionpolicybinding.GetAutoProtectionPolicyBindingRequest, dict
            ]
        ] = None,
        *,
        name: Optional[str] = None,
        ...
        r"""Returns the auto protection policy binding read from
        the CCFE tables.
        ...
        .. code-block:: python
            ...
            def sample_get_auto_protection_policy_binding():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()
                ...
                # Make the request
                response = client.get_auto_protection_policy_binding(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetAutoProtectionPolicyBindingRequest, dict]):
                The request object. Request message for getting an
                AutoProtectionPolicyBinding.
            name (str):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.AutoProtectionPolicyBinding:
                An AutoprotectionPolicyBinding (APPA)
                acts as the bridge between an
                AutoprotectionPolicy and the scope
                (Project, Folder, or Organization) where
        ...
        #   there are no flattened fields), or create one.
        if not isinstance(
            request, autoprotectionpolicybinding.GetAutoProtectionPolicyBindingRequest
        ):
            request = autoprotectionpolicybinding.GetAutoProtectionPolicyBindingRequest(
                request
            )
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_auto_protection_policy_binding
        ]
    ...
    def list_auto_protection_policy_bindings(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListAutoProtectionPolicyBindingsPager:
        r"""Returns the auto protection policy bindings read from
        the CCFE tables.
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListAutoProtectionPolicyBindingsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListAutoProtectionPolicyBindingsPager:
                Response message for
                ListAutoProtectionPolicyBindings.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_auto_protection_policy_bindings
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListAutoProtectionPolicyBindingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_applied_auto_protection_policies(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListAppliedAutoProtectionPoliciesPager:
        r"""Lists AppliedAutoProtectionPolicies in a given
        project and location.
        ...
        .. code-block:: python
            ...
            def sample_list_applied_auto_protection_policies():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListAppliedAutoProtectionPoliciesRequest, dict]):
                The request object. Request message for listing
                AppliedAutoProtectionPolicies.
            parent (str):
                Required. The project and location
                for which to retrieve the list of
                applied policies. Format:
                projects/{project}/locations/{location}
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListAppliedAutoProtectionPoliciesPager:
                Response message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_applied_auto_protection_policies
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListAppliedAutoProtectionPoliciesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def initiate_delete_auto_protection_policy_binding(
        ...
        *,
        ...
        r"""InitiateDeleteAutoProtectionPolicyBinding initiates
        ...
        .. code-block:: python
            ...
            def sample_initiate_delete_auto_protection_policy_binding():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()

                # Initialize request argument(s)
                request = backupdr_v1beta.InitiateDeleteAutoProtectionPolicyBindingRequest(
                    name="name_value",
                )

                # Make the request
                operation = client.initiate_delete_auto_protection_policy_binding(request=request)
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.InitiateDeleteAutoProtectionPolicyBindingRequest, dict]):
                The request object. Request message for initiating delete
                of an AutoProtectionPolicyBinding.
            name (str):
        ...
        if not isinstance(
            ...
            request = autoprotectionpolicybinding.InitiateDeleteAutoProtectionPolicyBindingRequest(
                request
            )
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.initiate_delete_auto_protection_policy_binding
        ]
    ...
    def get_binding_matching_resource(
        self,
        request: Optional[
            Union[bindingmatchingresource.GetBindingMatchingResourceRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Gets details of a single Binding Matching Resource.
        ...
        .. code-block:: python
            ...
            def sample_get_binding_matching_resource():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()

                # Initialize request argument(s)
                request = backupdr_v1beta.GetBindingMatchingResourceRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_binding_matching_resource(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.backupdr_v1beta.types.GetBindingMatchingResourceRequest, dict]):
                The request object. Request message for getting a
                BindingMatchingResource.
            name (str):
        ...
        Returns:
            google.cloud.backupdr_v1beta.types.BindingMatchingResource:
                BindingMatchingResource contains the
                details of a resource that matches the
        ...
        #   there are no flattened fields), or create one.
        if not isinstance(
            request, bindingmatchingresource.GetBindingMatchingResourceRequest
        ):
            request = bindingmatchingresource.GetBindingMatchingResourceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_binding_matching_resource
        ]
    ...
    def list_binding_matching_resources(
        self,
        request: Optional[
            Union[bindingmatchingresource.ListBindingMatchingResourcesRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListBindingMatchingResourcesPager:
        r"""Lists Binding Matching Resources for a given
        AutoProtectionPolicyBinding.
        ...
        .. code-block:: python
            ...
            def sample_list_binding_matching_resources():
                # Create a client
                client = backupdr_v1beta.BackupDRClient()

                # Initialize request argument(s)
                request = backupdr_v1beta.ListBindingMatchingResourcesRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_binding_matching_resources(request=request)
        ...
        Args:
            request (Union[google.cloud.backupdr_v1beta.types.ListBindingMatchingResourcesRequest, dict]):
                The request object. Request message for List
                BindingMatchingResources.
            parent (str):
                Required. The project, location, auto protection policy
                and binding for which to retrieve
                ``BindingMatchingResources`` information. Format:
                ``projects/{project}/locations/{location}/autoProtectionPolicies/{auto_protection_policy}/bindings/{binding}``.
                In Google Cloud Backup and DR, locations map to Google
                Cloud regions, for example **us-central1**.
        ...
        Returns:
            google.cloud.backupdr_v1beta.services.backup_dr.pagers.ListBindingMatchingResourcesPager:
                The response message for getting a list of
                BindingMatchingResources.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_binding_matching_resources
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListBindingMatchingResourcesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

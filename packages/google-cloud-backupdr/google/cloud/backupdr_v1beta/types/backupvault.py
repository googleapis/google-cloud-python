...
class BackupVault(proto.Message):
    ...
    Attributes:
        ...
        backup_minimum_enforced_retention_duration (google.protobuf.duration_pb2.Duration):
            ...
            can be extended. Note: Longer minimum enforced
            retention period impacts potential storage costs
            post introductory trial. We recommend starting
            with a short duration of 3 days or less.

            This field is a member of `oneof`_ ``_backup_minimum_enforced_retention_duration``.
        backup_retention_inheritance (google.cloud.backupdr_v1beta.types.BackupVault.BackupRetentionInheritance):
        ...
        state (google.cloud.backupdr_v1beta.types.BackupVault.State):
        ...
        access_restriction (google.cloud.backupdr_v1beta.types.BackupVault.AccessRestriction):
        ...
        encryption_config (google.cloud.backupdr_v1beta.types.BackupVault.EncryptionConfig):
...
class DataSource(proto.Message):
    ...
    Attributes:
        data_source_gcp_resource (google.cloud.backupdr_v1beta.types.DataSourceGcpResource):
        ...
        data_source_backup_appliance_application (google.cloud.backupdr_v1beta.types.DataSourceBackupApplianceApplication):
        ...
        name (str):
            ...
            be between 3-63 characters long and must be unique within
            the backup vault.
        state (google.cloud.backupdr_v1beta.types.DataSource.State):
        ...
        config_state (google.cloud.backupdr_v1beta.types.BackupConfigState):
            Output only. The backup configuration state.
        backup_config_info (google.cloud.backupdr_v1beta.types.BackupConfigInfo):
...
class BackupConfigInfo(proto.Message):
    ...
    Attributes:
        gcp_backup_config (google.cloud.backupdr_v1beta.types.GcpBackupConfig):
            Configuration for a Google Cloud resource.

            This field is a member of `oneof`_ ``backup_config``.
        backup_appliance_backup_config (google.cloud.backupdr_v1beta.types.BackupApplianceBackupConfig):
...
class DataSourceGcpResource(proto.Message):
    ...
    Attributes:
        compute_instance_datasource_properties (google.cloud.backupdr_v1beta.types.ComputeInstanceDataSourceProperties):
        ...
        cloud_sql_instance_datasource_properties (google.cloud.backupdr_v1beta.types.CloudSqlInstanceDataSourceProperties):
            Output only.
            ...
            This field is a member of `oneof`_ ``gcp_resource_properties``.
        alloy_db_cluster_datasource_properties (google.cloud.backupdr_v1beta.types.AlloyDBClusterDataSourceProperties):
            Output only.
            AlloyDBClusterDataSourceProperties has a subset
            of AlloyDB cluster properties that are useful at
            the Datasource level. Currently none of its
            child properties are auditable. If new auditable
            properties are added, the AUDIT annotation
            should be added.

            This field is a member of `oneof`_ ``gcp_resource_properties``.
        disk_datasource_properties (google.cloud.backupdr_v1beta.types.DiskDataSourceProperties):
...
class BackupLock(proto.Message):
    ...
    Attributes:
        backup_appliance_lock_info (google.cloud.backupdr_v1beta.types.BackupApplianceLockInfo):
        ...
        service_lock_info (google.cloud.backupdr_v1beta.types.ServiceLockInfo):
...
class Backup(proto.Message):
    ...
    Attributes:
        compute_instance_backup_properties (google.cloud.backupdr_v1beta.types.ComputeInstanceBackupProperties):
            Output only. Compute Engine specific backup
            properties.

            This field is a member of `oneof`_ ``backup_properties``.
        cloud_sql_instance_backup_properties (google.cloud.backupdr_v1beta.types.CloudSqlInstanceBackupProperties):
            Output only. Cloud SQL specific backup
            properties.

            This field is a member of `oneof`_ ``backup_properties``.
        backup_appliance_backup_properties (google.cloud.backupdr_v1beta.types.BackupApplianceBackupProperties):
            Output only. Backup Appliance specific backup
            properties.

            This field is a member of `oneof`_ ``backup_properties``.
        alloy_db_backup_properties (google.cloud.backupdr_v1beta.types.AlloyDbClusterBackupProperties):
            Output only. AlloyDB specific backup
            properties.

            This field is a member of `oneof`_ ``backup_properties``.
        disk_backup_properties (google.cloud.backupdr_v1beta.types.DiskBackupProperties):
            Output only. Disk specific backup properties.

            This field is a member of `oneof`_ ``backup_properties``.
        gcp_backup_plan_info (google.cloud.backupdr_v1beta.types.Backup.GCPBackupPlanInfo):
            Output only. Configuration for a Google Cloud
            resource.

            This field is a member of `oneof`_ ``plan_info``.
        gcp_resource (google.cloud.backupdr_v1beta.types.BackupGcpResource):
        ...
        etag (str):
            ...
            This field is a member of `oneof`_ ``_etag``.
        state (google.cloud.backupdr_v1beta.types.Backup.State):
            Output only. The Backup resource instance
            state.
        service_locks (MutableSequence[google.cloud.backupdr_v1beta.types.BackupLock]):
            Output only. The list of BackupLocks taken by
            the service to prevent the deletion of the
            backup.
        backup_appliance_locks (MutableSequence[google.cloud.backupdr_v1beta.types.BackupLock]):
            Optional. The list of BackupLocks taken by
            the accessor Backup Appliance.
        backup_type (google.cloud.backupdr_v1beta.types.Backup.BackupType):
...
class ListBackupVaultsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            for example **us-central1**. To retrieve backupvault stores
        ...
        view (google.cloud.backupdr_v1beta.types.BackupVaultView):
...
class ListBackupVaultsResponse(proto.Message):
    ...
    Attributes:
        backup_vaults (MutableSequence[google.cloud.backupdr_v1beta.types.BackupVault]):
...
class FetchBackupsForResourceTypeRequest(proto.Message):
    ...
    Attributes:
        ...
        order_by (str):
            ...
            - name
        view (google.cloud.backupdr_v1beta.types.BackupView):
...
class FetchBackupsForResourceTypeResponse(proto.Message):
    ...
    Attributes:
        backups (MutableSequence[google.cloud.backupdr_v1beta.types.Backup]):
...
class ListDataSourcesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            'projects/{project_id}/locations/{location}'. In Google
            Cloud Backup and DR, locations map to Google Cloud regions,
            for example **us-central1**. To retrieve data sources for
...
class ListDataSourcesResponse(proto.Message):
    ...
    Attributes:
        data_sources (MutableSequence[google.cloud.backupdr_v1beta.types.DataSource]):
...
class RestoreBackupRequest(proto.Message):
    ...
    Attributes:
        compute_instance_target_environment (google.cloud.backupdr_v1beta.types.ComputeInstanceTargetEnvironment):
            Compute Engine target environment to be used
            during restore.

            This field is a member of `oneof`_ ``target_environment``.
        disk_target_environment (google.cloud.backupdr_v1beta.types.DiskTargetEnvironment):
            Disk target environment to be used during
            restore.

            This field is a member of `oneof`_ ``target_environment``.
        region_disk_target_environment (google.cloud.backupdr_v1beta.types.RegionDiskTargetEnvironment):
            Region disk target environment to be used
            during restore.

            This field is a member of `oneof`_ ``target_environment``.
        compute_instance_restore_properties (google.cloud.backupdr_v1beta.types.ComputeInstanceRestoreProperties):
            Compute Engine instance properties to be
            overridden during restore.

            This field is a member of `oneof`_ ``instance_properties``.
        disk_restore_properties (google.cloud.backupdr_v1beta.types.DiskRestoreProperties):
...
class RestoreBackupResponse(proto.Message):
    ...
    Attributes:
        target_resource (google.cloud.backupdr_v1beta.types.TargetResource):
...
class TargetResource(proto.Message):
    ...
    Attributes:
        gcp_resource (google.cloud.backupdr_v1beta.types.GcpResource):

...
from google.cloud.backupdr_v1beta.types import backupvault_gce
...
class DiskRestoreProperties(proto.Message):
    ...
    Attributes:
        instance_backup_source (google.cloud.backupdr_v1beta.types.RestoreDiskFromInstanceOptions):
            Options for creating a disk from a source
        ...
        access_mode (google.cloud.backupdr_v1beta.types.DiskRestoreProperties.AccessMode):
            Optional. The access mode of the disk.

            This field is a member of `oneof`_ ``_access_mode``.
        architecture (google.cloud.backupdr_v1beta.types.DiskRestoreProperties.Architecture):
    ...
    instance_backup_source: "RestoreDiskFromInstanceOptions" = proto.Field(
        proto.MESSAGE,
        number=19,
        oneof="source_options",
        message="RestoreDiskFromInstanceOptions",
    )
...
class RestoreDiskFromInstanceOptions(proto.Message):
    r"""Options for creating a disk from a source Compute Instance
    backup.
    ...
    Attributes:
        source_device_name (str):
            The device name of the disk to restore from
            the VM backup.

            This field is a member of `oneof`_ ``source_disk``.
        boot_disk (bool):
            Set to true to restore the boot disk from the
            instance backup. This field should only be set
            to true if selected.

            This field is a member of `oneof`_ ``source_disk``.
    """

    source_device_name: str = proto.Field(
        proto.STRING,
        number=1,
        oneof="source_disk",
    )
    boot_disk: bool = proto.Field(
        proto.BOOL,
        number=2,
        oneof="source_disk",
    )
...
class DiskBackupProperties(proto.Message):
    ...
    Attributes:
        ...
        architecture (google.cloud.backupdr_v1beta.types.DiskBackupProperties.Architecture):
        ...
        access_mode (str):
            ...
            This field is a member of `oneof`_ ``_access_mode``.
        provisioned_iops (int):
            The number of IOPS provisioned for the source
            disk.

            This field is a member of `oneof`_ ``_provisioned_iops``.
        provisioned_throughput (int):
            The number of throughput provisioned for the
            source disk.
        ...
        physical_block_size_bytes (int):
            ...
            This field is a member of `oneof`_ ``_physical_block_size_bytes``.
        enable_confidential_compute (bool):
            Indicates whether the source disk is using
        ...
        guest_flush (bool):
            Optional. Defines if the guest flush is
            enabled for the source disk. Default value is
            false.
    """

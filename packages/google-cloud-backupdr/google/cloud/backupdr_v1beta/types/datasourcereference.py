...
class DataSourceReference(proto.Message):
    ...
    Attributes:
        ...
        data_source_backup_config_state (google.cloud.backupdr_v1beta.types.BackupConfigState):
            Output only. The backup configuration state
            of the DataSource.
        data_source_backup_count (int):
            Output only. Number of backups in the
            DataSource.
        data_source_backup_config_info (google.cloud.backupdr_v1beta.types.DataSourceBackupConfigInfo):
            Output only. Information of backup
            configuration on the DataSource.
        data_source_gcp_resource_info (google.cloud.backupdr_v1beta.types.DataSourceGcpResourceInfo):
            Output only. The Google Cloud resource that
            the DataSource is associated with.
...
class DataSourceBackupConfigInfo(proto.Message):
    ...
    Attributes:
        last_backup_state (google.cloud.backupdr_v1beta.types.BackupConfigInfo.LastBackupState):
...
class DataSourceGcpResourceInfo(proto.Message):
    r"""The Google Cloud resource that the DataSource is associated
    with.
    ...
    Attributes:
        cloud_sql_instance_properties (google.cloud.backupdr_v1beta.types.CloudSqlInstanceDataSourceReferenceProperties):
            Output only. The properties of the Cloud SQL
            instance.

            This field is a member of `oneof`_ ``resource_properties``.
        alloy_db_cluster_properties (google.cloud.backupdr_v1beta.types.AlloyDBClusterDataSourceReferenceProperties):
            Output only. The properties of the AlloyDB
            cluster.

            This field is a member of `oneof`_ ``resource_properties``.
        gcp_resourcename (str):
            Output only. The resource name of the Google
            Cloud resource. Ex:
            projects/{project}/zones/{zone}/instances/{instance}
        type_ (str):
            Output only. The type of the Google Cloud
            resource. Ex: compute.googleapis.com/Instance
        location (str):
            Output only. The location of the Google Cloud
            resource. Ex:
    ...
    alloy_db_cluster_properties: backupvault_alloydb.AlloyDBClusterDataSourceReferenceProperties = proto.Field(
        proto.MESSAGE,
        number=6,
        oneof="resource_properties",
        message=backupvault_alloydb.AlloyDBClusterDataSourceReferenceProperties,
    )
...
class ListDataSourceReferencesResponse(proto.Message):
    ...
    Attributes:
        data_source_references (MutableSequence[google.cloud.backupdr_v1beta.types.DataSourceReference]):
...
class FetchDataSourceReferencesForResourceTypeRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            Format: projects/{project}/locations/{location}
        resource_type (str):
            Required. The type of the Google Cloud

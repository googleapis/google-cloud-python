...
class BackupPlan(proto.Message):
    ...
    Attributes:
        disk_backup_plan_properties (google.cloud.backupdr_v1beta.types.DiskBackupPlanProperties):
            Optional. Defines optional properties
            specific to backups of disk-based resources,
            such as Compute Engine Persistent Disks. This
            includes settings like whether to perform a
            guest flush.

            This field is a member of `oneof`_ ``resource_properties``.
        compute_instance_backup_plan_properties (google.cloud.backupdr_v1beta.types.ComputeInstanceBackupPlanProperties):
            Optional. Defines optional properties
            specific to backups of compute instance based
            resources, such as Compute Engine Instances.
            This includes settings like whether to perform a
            guest flush.
        ...
        backup_rules (MutableSequence[google.cloud.backupdr_v1beta.types.BackupRule]):
            Optional. The backup rules for this ``BackupPlan``.
        max_custom_on_demand_retention_days (int):
            Optional. Optional field to configure the
            maximum number of days for which a backup can be
            retained. This field is only applicable for
            on-demand backups taken with custom retention
            value.
        state (google.cloud.backupdr_v1beta.types.BackupPlan.State):
        ...
        backup_vault_service_account (str):
            ...
            to be used by the BackupVault for taking
            backups. Specify the email address of the Backup
    ...
    disk_backup_plan_properties: "DiskBackupPlanProperties" = proto.Field(
        proto.MESSAGE,
        number=19,
        oneof="resource_properties",
        message="DiskBackupPlanProperties",
    )
    compute_instance_backup_plan_properties: "ComputeInstanceBackupPlanProperties" = (
        proto.Field(
            proto.MESSAGE,
            number=20,
            oneof="resource_properties",
            message="ComputeInstanceBackupPlanProperties",
        )
    )
    ...
    max_custom_on_demand_retention_days: int = proto.Field(
        proto.INT32,
        number=18,
    )
...
class BackupRule(proto.Message):
    ...
    Attributes:
        standard_schedule (google.cloud.backupdr_v1beta.types.StandardSchedule):
        ...
        backup_retention_days (int):
            ...
            for all other rules. Note: Longer retention can
            lead to higher storage costs post introductory
            trial. We recommend starting with a short
...
class StandardSchedule(proto.Message):
    ...
    Attributes:
        recurrence_type (google.cloud.backupdr_v1beta.types.StandardSchedule.RecurrenceType):
        ...
        week_day_of_month (google.cloud.backupdr_v1beta.types.WeekDayOfMonth):
        ...
        months (MutableSequence[google.type.month_pb2.Month]):
            ...
            are supplied.
        backup_window (google.cloud.backupdr_v1beta.types.BackupWindow):
...
class WeekDayOfMonth(proto.Message):
    ...
    Attributes:
        week_of_month (google.cloud.backupdr_v1beta.types.WeekDayOfMonth.WeekOfMonth):
...
class ListBackupPlansRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``projects/{project}/locations/{location}``. In Google Cloud
            Backup and DR, locations map to Google Cloud regions, for
            e.g. **us-central1**. To retrieve backup plans for all
...
class ListBackupPlansResponse(proto.Message):
    ...
    Attributes:
        backup_plans (MutableSequence[google.cloud.backupdr_v1beta.types.BackupPlan]):
...
class BackupPlanRevision(proto.Message):
    ...
    Attributes:
        ...
        revision_id (str):
            ...
            Example: v0, v1, v2, etc.
        state (google.cloud.backupdr_v1beta.types.BackupPlanRevision.State):
            Output only. Resource State
        backup_plan_snapshot (google.cloud.backupdr_v1beta.types.BackupPlan):
...
class ListBackupPlanRevisionsResponse(proto.Message):
    ...
    Attributes:
        backup_plan_revisions (MutableSequence[google.cloud.backupdr_v1beta.types.BackupPlanRevision]):
...
class DiskBackupPlanProperties(proto.Message):
    r"""Properties for a disk backup plan.

    Attributes:
        guest_flush (bool):
            Optional. Indicates whether to perform a
            guest flush operation before taking a disk
...
class ComputeInstanceBackupPlanProperties(proto.Message):

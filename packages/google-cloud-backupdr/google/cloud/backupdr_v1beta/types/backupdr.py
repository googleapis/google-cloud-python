...
from google.cloud.backupdr_v1beta.types import backupvault_cloudsql
...
class NetworkConfig(proto.Message):
    ...
    Attributes:
        ...
        peering_mode (google.cloud.backupdr_v1beta.types.NetworkConfig.PeeringMode):
    ...
    class PeeringMode(proto.Enum):
        r"""VPC peering modes supported by Google Cloud Backup and DR.
        ...
        Values:
            ...
            PRIVATE_SERVICE_ACCESS (1):
                ...
                Cloud services, including Google Cloud Backup
                and DR.
        """
...
class ManagementServer(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The time when the instance was
            updated.
        type_ (google.cloud.backupdr_v1beta.types.ManagementServer.InstanceType):
            Optional. The type of the ManagementServer
            resource.
        management_uri (google.cloud.backupdr_v1beta.types.ManagementURI):
            ...
            APIs.
        workforce_identity_based_management_uri (google.cloud.backupdr_v1beta.types.WorkforceIdentityBasedManagementURI):
            Output only. The hostnames of the exposed AGM
            endpoints for both types of user i.e. 1p and 3p,
            used to connect AGM/RM UI.
        state (google.cloud.backupdr_v1beta.types.ManagementServer.InstanceState):
            Output only. The ManagementServer state.
        networks (MutableSequence[google.cloud.backupdr_v1beta.types.NetworkConfig]):
        ...
        oauth2_client_id (str):
            ...
            calls to the Backup and DR instance API of this
            ManagementServer. This is the value that should be provided
            in the 'aud' field of the OIDC ID Token (see openid
            specification
            https://openid.net/specs/openid-connect-core-1_0.html#IDToken).
        workforce_identity_based_oauth2_client_id (google.cloud.backupdr_v1beta.types.WorkforceIdentityBasedOAuth2ClientID):
...
class ListManagementServersRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            for example **us-central1**. To retrieve management servers
...
class ListManagementServersResponse(proto.Message):
    ...
    Attributes:
        management_servers (MutableSequence[google.cloud.backupdr_v1beta.types.ManagementServer]):
...
class InitializeServiceRequest(proto.Message):
    ...
    Attributes:
        cloud_sql_instance_initialization_config (google.cloud.backupdr_v1beta.types.CloudSqlInstanceInitializationConfig):
        ...
        name (str):
            ...
            initialize the service. The location must be the location of
            the BackupVault. Format:
        ...
        request_id (str):
            ...
            exception that zero UUID is not supported
            (00000000-0000-0000-0000-000000000000).
        backup_plan_location (str):
            Optional. The location where the BackupPlan will be created.
            This field is required for multi-region BackupVaults and is
            optional for regional BackupVaults. It is useful when
            creating a Backup Vault in a multi-region, allowing the
            BackupPlan to reside in a specific region within that
            multi-region. If this field is not provided, the BackupPlan
            will be created in the same location as specified in the
            ``name`` field.
        validate_only (bool):
            Optional. If set, validates the request and
            returns the result, but does not actually run
            it.
    """
    ...
    backup_plan_location: str = proto.Field(
        proto.STRING,
        number=6,
    )

...
from google.cloud.backupdr_v1beta.types import backupvault_alloydb, backupvault_cloudsql
...
class BackupPlanAssociation(proto.Message):
    ...
    Attributes:
        cloud_sql_instance_backup_plan_association_properties (google.cloud.backupdr_v1beta.types.CloudSqlInstanceBackupPlanAssociationProperties):
            Output only. Cloud SQL instance's backup plan
            association properties.

            This field is a member of `oneof`_ ``resource_properties``.
        alloydb_cluster_backup_plan_association_properties (google.cloud.backupdr_v1beta.types.AlloyDBClusterBackupPlanAssociationProperties):
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The time when the instance was
            updated.
        state (google.cloud.backupdr_v1beta.types.BackupPlanAssociation.State):
            Output only. The BackupPlanAssociation
            resource state.
        rules_config_info (MutableSequence[google.cloud.backupdr_v1beta.types.RuleConfigInfo]):
        ...
        auto_protection_policy_binding (str):
            Output only. The resource name of the
            ``AutoProtectionPolicyBinding`` that manages this
            association, if any. Format:
    ...
    class State(proto.Enum):
        ...
        Values:
            ...
            PAUSED (6):
                The resource has been created but backups are
                paused.
        """
    ...
    auto_protection_policy_binding: str = proto.Field(
        proto.STRING,
        number=16,
    )
...
class RuleConfigInfo(proto.Message):
    ...
    Attributes:
        rule_id (str):
            ...
            backup plan.
        last_backup_state (google.cloud.backupdr_v1beta.types.RuleConfigInfo.LastBackupState):
...
class CreateBackupPlanAssociationRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            in the format
            ``projects/{project_id}/locations/{location}``. In Backup
...
class ListBackupPlanAssociationsResponse(proto.Message):
    ...
    Attributes:
        backup_plan_associations (MutableSequence[google.cloud.backupdr_v1beta.types.BackupPlanAssociation]):
...
class DeleteBackupPlanAssociationRequest(proto.Message):
    ...
    Attributes:
        ...
        request_id (str):
            ...
            (00000000-0000-0000-0000-000000000000).
        auto_protection_policy_binding (str):
            Optional. This field is exclusively used by Backup and DR's
            auto-protection feature. The resource name of the
            ``AutoProtectionPolicyBinding`` that triggered the deletion
            of this association. Format:
            ``projects/{project}/locations/{location}/autoProtectionPolicies/{policy}/bindings/{binding}``.
    """
...
class TriggerBackupRequest(proto.Message):
    ...
    Attributes:
        ...
        rule_id (str):
            ...
            triggered. If not specified, on-demand backup with custom
            retention will be triggered.
        request_id (str):
            Optional. An optional request ID to identify
            requests. Specify a unique request ID so that if
            you must retry your request, the server will
        ...
        custom_retention_days (int):
            Optional. The duration for which backup data will be kept,
            while taking an on-demand backup with custom retention. It
            is defined in "days". It is mutually exclusive with rule_id.
            This field is required if rule_id is not provided.
    ...
    custom_retention_days: int = proto.Field(
        proto.INT32,
        number=6,
    )

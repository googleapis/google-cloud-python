...
class ListResourceBackupConfigsResponse(proto.Message):
    ...
    Attributes:
        resource_backup_configs (MutableSequence[google.cloud.backupdr_v1beta.types.ResourceBackupConfig]):
...
class ResourceBackupConfig(proto.Message):
    ...
    Attributes:
        ...
        target_resource_display_name (str):
            ...
            target resource.
        target_resource_type (google.cloud.backupdr_v1beta.types.ResourceBackupConfig.ResourceType):
        ...
        backup_configs_details (MutableSequence[google.cloud.backupdr_v1beta.types.BackupConfigDetails]):
...
class BackupConfigDetails(proto.Message):
    ...
    Attributes:
        backup_dr_plan_config (google.cloud.backupdr_v1beta.types.BackupDrPlanConfig):
            Google Cloud Backup and DR's Backup Plan
            specific data.

            This field is a member of `oneof`_ ``plan_specific_config``.
        backup_dr_template_config (google.cloud.backupdr_v1beta.types.BackupDrTemplateConfig):
        ...
        type_ (google.cloud.backupdr_v1beta.types.BackupConfigDetails.Type):
            Output only. The type of the backup config
            resource.
        state (google.cloud.backupdr_v1beta.types.BackupConfigDetails.State):
            Output only. The state of the backup config
            resource.
        pitr_settings (google.cloud.backupdr_v1beta.types.PitrSettings):
        ...
        backup_locations (MutableSequence[google.cloud.backupdr_v1beta.types.BackupLocation]):
...
class BackupDrTemplateConfig(proto.Message):
    r"""Provides additional information about Google Cloud Backup and
    DR's Template backup configuration.
...
class BackupDrPlanConfig(proto.Message):
    ...
    Attributes:
        backup_dr_plan_rules (MutableSequence[google.cloud.backupdr_v1beta.types.BackupDrPlanRule]):
...
class BackupLocation(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.backupdr_v1beta.types.BackupLocation.Type):

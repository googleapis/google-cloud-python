...
class AlloyDBClusterDataSourceProperties(proto.Message):
    ...
    Attributes:
        ...
        pitr_windows (MutableSequence[google.cloud.backupdr_v1beta.types.AlloyDbPitrWindow]):
            Output only. Point in time recovery windows.
            The order is guaranteed to be ascending by start
            time.
        cluster_uid (str):
            Output only. The cluster UID of the AlloyDB
            cluster backed up by the datasource.
    """
    ...
    pitr_windows: MutableSequence["AlloyDbPitrWindow"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
        message="AlloyDbPitrWindow",
    )
...
class AlloyDBClusterDataSourceReferenceProperties(proto.Message):
    r"""AlloyDBClusterDataSourceReferenceProperties represents the
    properties of an AlloyDB cluster that are stored in the
    DataSourceReference.
...
class AlloyDbPitrWindow(proto.Message):
    r"""Point in time recovery window for an AlloyDB cluster.

    Attributes:
        start_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The start time of the PITR
            window.
        end_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The end time of the PITR window.
            It is not set if the corresponding Backup Plan
            Association is active.
        log_retention_days (int):
            Output only. Log retention days for the PITR
            window.
    """

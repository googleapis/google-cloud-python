    ...
    class _BaseListResourceBackupConfigs:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*}/resourceBackupConfigs",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = protection_summary.ListResourceBackupConfigsRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseBackupDrProtectionSummaryRestTransport._BaseListResourceBackupConfigs._get_unset_required_fields(
                    query_params
                )
            )

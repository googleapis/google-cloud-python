...
class BackupDrProtectionSummaryGrpcAsyncIOTransport(BackupDrProtectionSummaryTransport):
    """gRPC AsyncIO backend transport for BackupDrProtectionSummary.
    ...
    def list_resource_backup_configs(
        ...
        Returns:
            Callable[[~.ListResourceBackupConfigsRequest],
                    Awaitable[~.ListResourceBackupConfigsResponse]]:
        ...
        if "list_resource_backup_configs" not in self._stubs:
            self._stubs["list_resource_backup_configs"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_resource_backup_configs: self._wrap_method(

...
class BackupDRClient(metaclass=BackupDRClientMeta):
    ...
    def backup_vault_path(
        ...
        return "projects/{project}/locations/{location}/backupVaults/{backupvault}".format(
            project=project,
            location=location,
            backupvault=backupvault,
        )
    ...
    def parse_crypto_key_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/keyRings/(?P<ring>.+?)/cryptoKeys/(?P<key>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_data_source_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupVaults/(?P<backupvault>.+?)/dataSources/(?P<datasource>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or BackupDRClient._get_api_endpoint(
    ...
    def fetch_backups_for_resource_type(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_backups_for_resource_type]
    ...
    def list_data_source_references(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_data_source_references]

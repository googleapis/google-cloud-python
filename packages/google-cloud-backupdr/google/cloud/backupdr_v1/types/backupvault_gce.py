...
class ComputeInstanceRestoreProperties(proto.Message):
    ...
    Attributes:
        ...
        hostname (str):
            Optional. Specifies the hostname of the
            instance. The specified hostname must be RFC1035
            compliant. If hostname is not specified, the
            default hostname is
            [INSTANCE_NAME].c.[PROJECT_ID].internal when
        ...
        private_ipv6_google_access (google.cloud.backupdr_v1.types.ComputeInstanceRestoreProperties.InstancePrivateIpv6GoogleAccess):
            Optional. The private IPv6 google access type
            for the VM. If not specified, use
...
class NetworkInterface(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            Output only. [Output Only] The name of the
            network interface, which is generated by the
            server.

            This field is a member of `oneof`_ ``_name``.
        access_configs (MutableSequence[google.cloud.backupdr_v1.types.AccessConfig]):
            Optional. An array of configurations for this
            interface. Currently, only one access
            config,ONE_TO_ONE_NAT is supported. If there are
            no accessConfigs specified, then this instance
            will have no external internet access.
        ipv6_access_configs (MutableSequence[google.cloud.backupdr_v1.types.AccessConfig]):
            Optional. An array of IPv6 access configurations
            for this interface. Currently, only one IPv6
            access config, DIRECT_IPV6, is supported. If
            there is no ipv6AccessConfig specified, then
            this instance will have no external IPv6
            Internet access.
        ...
        ipv6_access_type (google.cloud.backupdr_v1.types.NetworkInterface.Ipv6AccessType):
            Optional. [Output Only] One of EXTERNAL,
            INTERNAL to indicate whether the IP can be
            accessed from the Internet. This field is always
        ...
        network_attachment (str):
            Optional. The URL of the network attachment that
            this interface should connect to in the
            following format:
...
class AccessConfig(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.backupdr_v1.types.AccessConfig.AccessType):
            ...
            ipv6AccessConfigs, the default and only option
            is DIRECT_IPV6.
...
class AttachedDisk(proto.Message):
    ...
    Attributes:
        ...
        device_name (str):
            Optional. This is used as an identifier for the
            disks. This is the unique name has to provided
            to modify disk parameters like disk_name and

...
class QuotaAdjusterSettingsManagerAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.api.cloudquotas_v1.QuotaAdjusterSettingsManagerAsyncClient`.",
                extra={
    ...
    async def update_quota_adjuster_settings(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudquotas_v1.types.UpdateQuotaAdjusterSettingsRequest, dict]]):
                The request object. Request for updating
                QuotaAdjusterSettings
            quota_adjuster_settings (:class:`google.cloud.cloudquotas_v1.types.QuotaAdjusterSettings`):
    ...
    async def get_quota_adjuster_settings(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.cloudquotas_v1.types.GetQuotaAdjusterSettingsRequest, dict]]):
...
__all__ = ("QuotaAdjusterSettingsManagerAsyncClient",)

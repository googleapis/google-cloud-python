        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1.QuotaAdjusterSettingsManagerClient.GetQuotaAdjusterSettings",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1.QuotaAdjusterSettingsManagerClient.get_quota_adjuster_settings",
                    extra={
                        "serviceName": "google.api.cloudquotas.v1.QuotaAdjusterSettingsManager",
                        "rpcName": "GetQuotaAdjusterSettings",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.api.cloudquotas_v1.QuotaAdjusterSettingsManagerClient.UpdateQuotaAdjusterSettings",
                    extra={
                        "serviceName": "google.api.cloudquotas.v1.QuotaAdjusterSettingsManager",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.api.cloudquotas_v1.QuotaAdjusterSettingsManagerClient.update_quota_adjuster_settings",
                    extra={
                        "serviceName": "google.api.cloudquotas.v1.QuotaAdjusterSettingsManager",
                        "rpcName": "UpdateQuotaAdjusterSettings",
                        "metadata": http_response["headers"],

...
from .services.quota_adjuster_settings_manager import QuotaAdjusterSettingsManagerAsyncClient, QuotaAdjusterSettingsManagerClient
...
from .types.quota_adjuster_settings import GetQuotaAdjusterSettingsRequest, QuotaAdjusterSettings, UpdateQuotaAdjusterSettingsRequest

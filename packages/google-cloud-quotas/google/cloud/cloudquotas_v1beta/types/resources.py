...
class QuotaInfo(proto.Message):
    ...
    Attributes:
        ...
        metric_unit (str):
            ...
            reported, e.g., "MByte".
        quota_increase_eligibility (google.cloud.cloudquotas_v1beta.types.QuotaIncreaseEligibility):
            Whether it is eligible to request a higher
            quota value for this quota.
        is_fixed (bool):
            Whether the quota value is fixed or
            adjustable
        dimensions_infos (MutableSequence[google.cloud.cloudquotas_v1beta.types.DimensionsInfo]):
...
class QuotaIncreaseEligibility(proto.Message):
    ...
    Attributes:
        is_eligible (bool):
            ...
            for the quota.
        ineligibility_reason (google.cloud.cloudquotas_v1beta.types.QuotaIncreaseEligibility.IneligibilityReason):
...
class QuotaConfig(proto.Message):
    ...
    Attributes:
        ...
        request_origin (google.cloud.cloudquotas_v1beta.types.QuotaConfig.Origin):
...
class DimensionsInfo(proto.Message):
    ...
    Attributes:
        ...
        applicable_locations (MutableSequence[str]):
            ...
            dimension. The field is set to ['global'] for
            quotas that are not per region or per zone.
            Otherwise, it will be set to the list of
...
class QuotaDetails(proto.Message):
    ...
    Attributes:
        value (int):
            ...
            enforced.
        rollout_info (google.cloud.cloudquotas_v1beta.types.RolloutInfo):

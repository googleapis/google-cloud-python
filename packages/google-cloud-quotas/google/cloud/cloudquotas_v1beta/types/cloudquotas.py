...
class ListQuotaInfosResponse(proto.Message):
    ...
    Attributes:
        quota_infos (MutableSequence[google.cloud.cloudquotas_v1beta.types.QuotaInfo]):
...
class ListQuotaPreferencesResponse(proto.Message):
    ...
    Attributes:
        quota_preferences (MutableSequence[google.cloud.cloudquotas_v1beta.types.QuotaPreference]):
...
class CreateQuotaPreferenceRequest(proto.Message):
    ...
    Attributes:
        ...
        ignore_safety_checks (MutableSequence[google.cloud.cloudquotas_v1beta.types.QuotaSafetyCheck]):

...
from google.cloud.cloudquotas_v1beta.types import cloudquotas, resources
...
class CloudQuotasGrpcAsyncIOTransport(CloudQuotasTransport):
    """gRPC AsyncIO backend transport for CloudQuotas.
    ...
    @property
    def list_quota_infos(self) -> Callable[[cloudquotas.ListQuotaInfosRequest], Awaitable[cloudquotas.ListQuotaInfosResponse]]:
        ...
        Returns:
            Callable[[~.ListQuotaInfosRequest],
                    Awaitable[~.ListQuotaInfosResponse]]:
        ...
        if "list_quota_infos" not in self._stubs:
            self._stubs["list_quota_infos"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_quota_info(self) -> Callable[[cloudquotas.GetQuotaInfoRequest], Awaitable[resources.QuotaInfo]]:
        ...
        if "get_quota_info" not in self._stubs:
            self._stubs["get_quota_info"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_quota_preferences(self) -> Callable[[cloudquotas.ListQuotaPreferencesRequest], Awaitable[cloudquotas.ListQuotaPreferencesResponse]]:
        ...
        Returns:
            Callable[[~.ListQuotaPreferencesRequest],
                    Awaitable[~.ListQuotaPreferencesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "list_quota_preferences" not in self._stubs:
            self._stubs["list_quota_preferences"] = self._logged_channel.unary_unary(
    ...
    @property
    def get_quota_preference(self) -> Callable[[cloudquotas.GetQuotaPreferenceRequest], Awaitable[resources.QuotaPreference]]:
        ...
        if "get_quota_preference" not in self._stubs:
            self._stubs["get_quota_preference"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_quota_preference(self) -> Callable[[cloudquotas.CreateQuotaPreferenceRequest], Awaitable[resources.QuotaPreference]]:
        ...
        if "create_quota_preference" not in self._stubs:
            self._stubs["create_quota_preference"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_quota_preference(self) -> Callable[[cloudquotas.UpdateQuotaPreferenceRequest], Awaitable[resources.QuotaPreference]]:
        ...
        if "update_quota_preference" not in self._stubs:
            self._stubs["update_quota_preference"] = self._logged_channel.unary_unary(

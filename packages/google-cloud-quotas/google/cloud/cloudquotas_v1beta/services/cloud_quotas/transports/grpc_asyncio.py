...
class CloudQuotasGrpcAsyncIOTransport(CloudQuotasTransport):
    ...
    def list_quota_infos(
        ...
        Awaitable[cloudquotas.ListQuotaInfosResponse],
    ]:
    ...
    def get_quota_info(
        self,
    ) -> Callable[[cloudquotas.GetQuotaInfoRequest], Awaitable[resources.QuotaInfo]]:
    ...
    def list_quota_preferences(
        ...
        Awaitable[cloudquotas.ListQuotaPreferencesResponse],
    ]:
    ...
    def get_quota_preference(
        ...
        [cloudquotas.GetQuotaPreferenceRequest], Awaitable[resources.QuotaPreference]
    ]:
    ...
    def create_quota_preference(
        ...
        [cloudquotas.CreateQuotaPreferenceRequest], Awaitable[resources.QuotaPreference]
    ]:
    ...
    def update_quota_preference(
        ...
        [cloudquotas.UpdateQuotaPreferenceRequest], Awaitable[resources.QuotaPreference]
    ]:

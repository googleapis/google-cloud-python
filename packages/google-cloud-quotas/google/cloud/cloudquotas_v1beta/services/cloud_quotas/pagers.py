...
class ListQuotaInfosPager:
    ...
    :class:`google.cloud.cloudquotas_v1beta.types.ListQuotaInfosResponse` object, and
    ...
    All the usual :class:`google.cloud.cloudquotas_v1beta.types.ListQuotaInfosResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.cloudquotas_v1beta.types.ListQuotaInfosRequest):
                The initial request object.
            response (google.cloud.cloudquotas_v1beta.types.ListQuotaInfosResponse):
...
class ListQuotaPreferencesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.cloudquotas_v1beta.types.ListQuotaPreferencesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.cloudquotas_v1beta.types.ListQuotaPreferencesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.cloudquotas_v1beta.types.ListQuotaPreferencesRequest):
                The initial request object.
            response (google.cloud.cloudquotas_v1beta.types.ListQuotaPreferencesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

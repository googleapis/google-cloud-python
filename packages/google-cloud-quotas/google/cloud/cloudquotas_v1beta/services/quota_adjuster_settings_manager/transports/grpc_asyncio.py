...
class QuotaAdjusterSettingsManagerGrpcAsyncIOTransport(QuotaAdjusterSettingsManagerTransport):
    ...
    def update_quota_adjuster_settings(
        self,
    ) -> Callable[[gac_quota_adjuster_settings.UpdateQuotaAdjusterSettingsRequest], Awaitable[gac_quota_adjuster_settings.QuotaAdjusterSettings]]:
    ...
    def get_quota_adjuster_settings(
        self,
    ) -> Callable[[quota_adjuster_settings.GetQuotaAdjusterSettingsRequest], Awaitable[quota_adjuster_settings.QuotaAdjusterSettings]]:

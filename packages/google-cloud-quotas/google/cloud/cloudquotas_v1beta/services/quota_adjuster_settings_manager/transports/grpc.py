...
class QuotaAdjusterSettingsManagerGrpcTransport(QuotaAdjusterSettingsManagerTransport):
    """gRPC backend transport for QuotaAdjusterSettingsManager.
    ...
    def update_quota_adjuster_settings(
        ...
        if "update_quota_adjuster_settings" not in self._stubs:
            self._stubs["update_quota_adjuster_settings"] = self._logged_channel.unary_unary(
    ...
    def get_quota_adjuster_settings(
        ...
        if "get_quota_adjuster_settings" not in self._stubs:
            self._stubs["get_quota_adjuster_settings"] = self._logged_channel.unary_unary(
...
__all__ = ("QuotaAdjusterSettingsManagerGrpcTransport",)

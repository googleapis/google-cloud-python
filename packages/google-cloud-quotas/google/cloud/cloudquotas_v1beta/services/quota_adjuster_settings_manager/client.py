...
from google.cloud.cloudquotas_v1beta._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = get_universe_domain(
            ...
            default_universe=QuotaAdjusterSettingsManagerClient._DEFAULT_UNIVERSE,
        )
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=QuotaAdjusterSettingsManagerClient._DEFAULT_ENDPOINT_TEMPLATE,

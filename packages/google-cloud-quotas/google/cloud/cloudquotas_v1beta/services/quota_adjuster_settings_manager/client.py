...
from .transports.grpc import QuotaAdjusterSettingsManagerGrpcTransport
from .transports.grpc_asyncio import QuotaAdjusterSettingsManagerGrpcAsyncIOTransport
from .transports.rest import QuotaAdjusterSettingsManagerRestTransport


class QuotaAdjusterSettingsManagerClientMeta(type):
    """Metaclass for the QuotaAdjusterSettingsManager client.
    ...
    ) -> Type[QuotaAdjusterSettingsManagerTransport]:
...
class QuotaAdjusterSettingsManagerClient(metaclass=QuotaAdjusterSettingsManagerClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            QuotaAdjusterSettingsManagerClient: The constructed client.
        """
    ...
    def transport(self) -> QuotaAdjusterSettingsManagerTransport:
        ...
        Returns:
            QuotaAdjusterSettingsManagerTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def quota_adjuster_settings_path(
        project: str,
        location: str,
    ) -> str:
        """Returns a fully-qualified quota_adjuster_settings string."""
        return "projects/{project}/locations/{location}/quotaAdjusterSettings".format(
            project=project,
            location=location,
        )

    @staticmethod
    def parse_quota_adjuster_settings_path(path: str) -> Dict[str, str]:
        """Parses a quota_adjuster_settings path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/quotaAdjusterSettings$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = QuotaAdjusterSettingsManagerClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = QuotaAdjusterSettingsManagerClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = QuotaAdjusterSettingsManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = QuotaAdjusterSettingsManagerClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, QuotaAdjusterSettingsManagerTransport, Callable[..., QuotaAdjusterSettingsManagerTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,QuotaAdjusterSettingsManagerTransport,Callable[..., QuotaAdjusterSettingsManagerTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the QuotaAdjusterSettingsManagerTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = QuotaAdjusterSettingsManagerClient._read_environment_variables()
        self._client_cert_source = QuotaAdjusterSettingsManagerClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = QuotaAdjusterSettingsManagerClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, QuotaAdjusterSettingsManagerTransport)
        if transport_provided:
            # transport is a QuotaAdjusterSettingsManagerTransport instance.
            ...
            self._transport = cast(QuotaAdjusterSettingsManagerTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or QuotaAdjusterSettingsManagerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[QuotaAdjusterSettingsManagerTransport], Callable[..., QuotaAdjusterSettingsManagerTransport]] = (
                QuotaAdjusterSettingsManagerClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., QuotaAdjusterSettingsManagerTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.api.cloudquotas_v1beta.QuotaAdjusterSettingsManagerClient`.",
                    extra={
    ...
    def update_quota_adjuster_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.UpdateQuotaAdjusterSettingsRequest, dict]):
            ...
            quota_adjuster_settings (google.cloud.cloudquotas_v1beta.types.QuotaAdjusterSettings):
                Required. The QuotaAdjusterSettings
                to update.

                This corresponds to the ``quota_adjuster_settings`` field
        ...
        Returns:
            google.cloud.cloudquotas_v1beta.types.QuotaAdjusterSettings:
        ...
        if not isinstance(request, gac_quota_adjuster_settings.UpdateQuotaAdjusterSettingsRequest):
            ...
            # request, apply these.
            if quota_adjuster_settings is not None:
                request.quota_adjuster_settings = quota_adjuster_settings
            if update_mask is not None:
                request.update_mask = update_mask

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_quota_adjuster_settings]
    ...
    def get_quota_adjuster_settings(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_quota_adjuster_settings():
                # Create a client
                client = cloudquotas_v1beta.QuotaAdjusterSettingsManagerClient()

                # Initialize request argument(s)
                request = cloudquotas_v1beta.GetQuotaAdjusterSettingsRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_quota_adjuster_settings(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.cloudquotas_v1beta.types.GetQuotaAdjusterSettingsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_quota_adjuster_settings]
    ...
    def __enter__(self) -> "QuotaAdjusterSettingsManagerClient":
        return self
...
__all__ = ("QuotaAdjusterSettingsManagerClient",)

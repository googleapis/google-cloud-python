...
class QuotaAdjusterSettingsManagerClientMeta(type):
    ...
    _transport_registry[
        "grpc_asyncio"
    ] = QuotaAdjusterSettingsManagerGrpcAsyncIOTransport
...
class QuotaAdjusterSettingsManagerClient(
    metaclass=QuotaAdjusterSettingsManagerClientMeta
):
    ...
    def parse_quota_adjuster_settings_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/quotaAdjusterSettings$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                QuotaAdjusterSettingsManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = (
            QuotaAdjusterSettingsManagerClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = QuotaAdjusterSettingsManagerClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, QuotaAdjusterSettingsManagerTransport
        )
        ...
        self._api_endpoint = (
            self._api_endpoint
            or QuotaAdjusterSettingsManagerClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                if isinstance(transport, str) or transport is None
                    ...
                    Callable[..., QuotaAdjusterSettingsManagerTransport], transport
                )
            )
    ...
    def update_quota_adjuster_settings(
        ...
        *,
        ...
        has_flattened_params = any([quota_adjuster_settings, update_mask])
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.update_quota_adjuster_settings
        ]
    ...
    def get_quota_adjuster_settings(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_quota_adjuster_settings
        ]

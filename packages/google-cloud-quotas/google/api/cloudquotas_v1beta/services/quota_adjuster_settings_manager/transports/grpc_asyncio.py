...
from google.api.cloudquotas_v1beta.types import (
...
class QuotaAdjusterSettingsManagerGrpcAsyncIOTransport(
    QuotaAdjusterSettingsManagerTransport
):
    """gRPC AsyncIO backend transport for QuotaAdjusterSettingsManager.
    ...
    def update_quota_adjuster_settings(
        ...
        Returns:
            Callable[[~.UpdateQuotaAdjusterSettingsRequest],
                    Awaitable[~.QuotaAdjusterSettings]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.update_quota_adjuster_settings: self._wrap_method(
            ...
            self.get_quota_adjuster_settings: self._wrap_method(
...
__all__ = ("QuotaAdjusterSettingsManagerGrpcAsyncIOTransport",)

...
from google.cloud.cloudquotas_v1beta.services.cloud_quotas import (
...
def test_cloud_quotas_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.cloudquotas_v1beta.services.cloud_quotas.transports.CloudQuotasGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_quota_infos_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/services/*}/quotaInfos"
...
def test_get_quota_info_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/services/*/quotaInfos/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_quota_preferences_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/quotaPreferences"
            % client.transport._host,
            args[1],
        )
...
def test_get_quota_preference_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/quotaPreferences/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_quota_preference_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{quota_preference.name=projects/*/locations/*/quotaPreferences/*}"
            % client.transport._host,
            args[1],
        )
...
def test_cloud_quotas_base_transport():
    ...
    with mock.patch(
        "google.cloud.cloudquotas_v1beta.services.cloud_quotas.transports.CloudQuotasTransport.__init__"
    ) as Transport:
...
def test_cloud_quotas_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.cloudquotas_v1beta.services.cloud_quotas.transports.CloudQuotasTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

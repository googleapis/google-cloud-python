...
class TranscoderServiceTransport(abc.ABC):
    ...
    def create_job(
        ...
        typing.Union[resources.Job, typing.Awaitable[resources.Job]],
    ]:
    ...
    def list_jobs(
        ...
        typing.Union[
            services.ListJobsResponse, typing.Awaitable[services.ListJobsResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def create_job_template(
        ...
        typing.Union[resources.JobTemplate, typing.Awaitable[resources.JobTemplate]],
    ]:
        raise NotImplementedError()

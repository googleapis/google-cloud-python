...
class StorageTransferServiceClient(metaclass=StorageTransferServiceClientMeta):
    ...
    def parse_agent_pools_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project_id>.+?)/agentPools/(?P<agent_pool_id>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = StorageTransferServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, StorageTransferServiceTransport, Callable[..., StorageTransferServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = StorageTransferServiceClient._read_environment_variables()
        self._client_cert_source = StorageTransferServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = StorageTransferServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or StorageTransferServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[StorageTransferServiceTransport], Callable[..., StorageTransferServiceTransport]] = (

...
class StorageTransferServiceGrpcAsyncIOTransport(StorageTransferServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_google_service_account: gapic_v1.method_async.wrap_method(
                self.get_google_service_account,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_transfer_job: gapic_v1.method_async.wrap_method(
                self.create_transfer_job,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_transfer_job: gapic_v1.method_async.wrap_method(
                self.update_transfer_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_transfer_job: gapic_v1.method_async.wrap_method(
                self.get_transfer_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_transfer_jobs: gapic_v1.method_async.wrap_method(
                self.list_transfer_jobs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.pause_transfer_operation: gapic_v1.method_async.wrap_method(
                self.pause_transfer_operation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resume_transfer_operation: gapic_v1.method_async.wrap_method(
                self.resume_transfer_operation,
                default_timeout=None,
                client_info=client_info,
            ),
            self.run_transfer_job: gapic_v1.method_async.wrap_method(
                self.run_transfer_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_transfer_job: gapic_v1.method_async.wrap_method(
                self.delete_transfer_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_agent_pool: gapic_v1.method_async.wrap_method(
                self.create_agent_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_agent_pool: gapic_v1.method_async.wrap_method(
                self.update_agent_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_agent_pool: gapic_v1.method_async.wrap_method(
                self.get_agent_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_agent_pools: gapic_v1.method_async.wrap_method(
                self.list_agent_pools,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_agent_pool: gapic_v1.method_async.wrap_method(

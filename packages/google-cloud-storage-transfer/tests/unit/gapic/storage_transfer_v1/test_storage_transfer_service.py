...
def test_get_google_service_account_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetGoogleServiceAccount,
        "_BaseGetGoogleServiceAccount__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_create_transfer_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateTransferJob,
        "_BaseCreateTransferJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_transfer_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateTransferJob,
        "_BaseUpdateTransferJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_transfer_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetTransferJob,
        "_BaseGetTransferJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    assert not set(unset_fields) - set(("projectId",))
...
def test_list_transfer_jobs_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListTransferJobs,
        "_BaseListTransferJobs__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_pause_transfer_operation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BasePauseTransferOperation,
        "_BasePauseTransferOperation__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_resume_transfer_operation_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseResumeTransferOperation,
        "_BaseResumeTransferOperation__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_run_transfer_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRunTransferJob,
        "_BaseRunTransferJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_transfer_job_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteTransferJob,
        "_BaseDeleteTransferJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_agent_pool_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateAgentPool,
        "_BaseCreateAgentPool__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("agentPoolId",))
...
def test_update_agent_pool_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateAgentPool,
        "_BaseUpdateAgentPool__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_agent_pool_rest_required_fields(request_type=transfer.GetAgentPoolRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetAgentPool,
        "_BaseGetAgentPool__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_agent_pools_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListAgentPools,
        "_BaseListAgentPools__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_agent_pool_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteAgentPool,
        "_BaseDeleteAgentPool__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

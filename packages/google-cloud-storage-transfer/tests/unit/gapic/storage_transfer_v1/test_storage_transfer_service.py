...
def test__read_environment_variables():
    assert StorageTransferServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert StorageTransferServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert StorageTransferServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert StorageTransferServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert StorageTransferServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert StorageTransferServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert StorageTransferServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert StorageTransferServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert StorageTransferServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(StorageTransferServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageTransferServiceClient))
@mock.patch.object(
    StorageTransferServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageTransferServiceAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = StorageTransferServiceClient._DEFAULT_UNIVERSE
    default_endpoint = StorageTransferServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = StorageTransferServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert StorageTransferServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        StorageTransferServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == StorageTransferServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert StorageTransferServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
    ...
    assert (
        StorageTransferServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == StorageTransferServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert StorageTransferServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert StorageTransferServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        StorageTransferServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert StorageTransferServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert StorageTransferServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert StorageTransferServiceClient._get_universe_domain(None, None) == StorageTransferServiceClient._DEFAULT_UNIVERSE
...
def test_storage_transfer_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "storagetransfer.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://storagetransfer.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (StorageTransferServiceClient, transports.StorageTransferServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(StorageTransferServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageTransferServiceClient))
@mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (StorageTransferServiceClient, transports.StorageTransferServiceRestTransport, "rest", "true"),
        (StorageTransferServiceClient, transports.StorageTransferServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(StorageTransferServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageTransferServiceClient))
@mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [
        (StorageTransferServiceClient, transports.StorageTransferServiceGrpcTransport, "grpc", grpc_helpers),
        (StorageTransferServiceAsyncClient, transports.StorageTransferServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (StorageTransferServiceClient, transports.StorageTransferServiceRestTransport, "rest", None),
    ],
)
...
def test_get_google_service_account_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.get_google_service_account in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_google_service_account] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_google_service_account_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_google_service_account in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_google_service_account] = mock_rpc
...
def test_create_transfer_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_transfer_job in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_create_transfer_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_transfer_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_transfer_job] = mock_rpc
...
def test_update_transfer_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_transfer_job in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_update_transfer_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_transfer_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_transfer_job] = mock_rpc
...
def test_get_transfer_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_transfer_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_transfer_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_transfer_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_transfer_job] = mock_rpc
...
def test_list_transfer_jobs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_transfer_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_transfer_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_transfer_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_transfer_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_transfer_jobs] = mock_rpc
...
async def test_list_transfer_jobs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_transfer_jobs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_transfer_jobs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_pause_transfer_operation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.pause_transfer_operation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.pause_transfer_operation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_pause_transfer_operation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.pause_transfer_operation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.pause_transfer_operation] = mock_rpc
...
def test_resume_transfer_operation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.resume_transfer_operation in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.resume_transfer_operation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_resume_transfer_operation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.resume_transfer_operation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.resume_transfer_operation] = mock_rpc
...
@pytest.mark.asyncio
async def test_run_transfer_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.run_transfer_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_transfer_job] = mock_rpc
...
def test_delete_transfer_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_transfer_job in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_transfer_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_transfer_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_transfer_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_transfer_job] = mock_rpc
...
def test_create_agent_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_agent_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_agent_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_agent_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_agent_pool] = mock_rpc
...
def test_update_agent_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_agent_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_agent_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_agent_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_agent_pool] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_agent_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_agent_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_agent_pool] = mock_rpc
...
def test_list_agent_pools_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_agent_pools] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_agent_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_agent_pools in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_agent_pools] = mock_rpc
...
async def test_list_agent_pools_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_agent_pools), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_agent_pools(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_delete_agent_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_agent_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_agent_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageTransferServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_agent_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_agent_pool] = mock_rpc
...
def test_get_google_service_account_rest_required_fields(request_type=transfer.GetGoogleServiceAccountRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_google_service_account._get_unset_required_fields(
        jsonified_request
    )
...
def test_create_transfer_job_rest_required_fields(request_type=transfer.CreateTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_transfer_job._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_transfer_job_rest_required_fields(request_type=transfer.UpdateTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_transfer_job._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_pause_transfer_operation_rest_required_fields(request_type=transfer.PauseTransferOperationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).pause_transfer_operation._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_transfer_job_rest_required_fields(request_type=transfer.DeleteTransferJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_transfer_job._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = StorageTransferServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = StorageTransferServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = StorageTransferServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = StorageTransferServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_google_service_account_rest_bad_request(request_type=transfer.GetGoogleServiceAccountRequest):
...
def test_get_google_service_account_rest_interceptors(null_interceptor):
    transport = transports.StorageTransferServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.StorageTransferServiceRestInterceptor(),
    )
    client = StorageTransferServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_google_service_account") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_get_google_service_account_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "pre_get_google_service_account"
    ) as pre:
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = transfer_types.GoogleServiceAccount.to_json(transfer_types.GoogleServiceAccount())
        ...
        post_with_metadata.return_value = transfer_types.GoogleServiceAccount(), metadata
...
def test_create_transfer_job_rest_bad_request(request_type=transfer.CreateTransferJobRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_create_transfer_job_rest_call_success(request_type):
    ...
    request_init["transfer_job"] = {
        ...
        "service_account": "service_account_value",
        "transfer_spec": {
            "gcs_data_sink": {"bucket_name": "bucket_name_value", "path": "path_value", "managed_folder_transfer_enabled": True},
            "posix_data_sink": {"root_directory": "root_directory_value"},
            "gcs_data_source": {},
            "aws_s3_data_source": {
                "bucket_name": "bucket_name_value",
                "aws_access_key": {"access_key_id": "access_key_id_value", "secret_access_key": "secret_access_key_value"},
                "path": "path_value",
            ...
            "azure_blob_storage_data_source": {
                ...
                "path": "path_value",
                "credentials_secret": "credentials_secret_value",
                "federated_identity_config": {"client_id": "client_id_value", "tenant_id": "tenant_id_value"},
            },
            "aws_s3_compatible_data_source": {
                ...
                "region": "region_value",
                "s3_metadata": {"auth_method": 1, "request_model": 1, "protocol": 1, "list_api": 1},
            },
            "hdfs_data_source": {"path": "path_value"},
            "gcs_intermediate_data_location": {},
            "object_conditions": {
                "min_time_elapsed_since_last_modification": {"seconds": 751, "nanos": 543},
                "max_time_elapsed_since_last_modification": {},
                "include_prefixes": ["include_prefixes_value1", "include_prefixes_value2"],
                "exclude_prefixes": ["exclude_prefixes_value1", "exclude_prefixes_value2"],
        ...
        "replication_spec": {"gcs_data_source": {}, "gcs_data_sink": {}, "object_conditions": {}, "transfer_options": {}},
        "notification_config": {"pubsub_topic": "pubsub_topic_value", "event_types": [1], "payload_format": 1},
        "logging_config": {"log_actions": [1], "log_action_states": [1], "enable_onprem_gcs_transfer_logs": True},
        "schedule": {
            "schedule_start_date": {"year": 433, "month": 550, "day": 318},
            "schedule_end_date": {},
            "start_time_of_day": {"hours": 561, "minutes": 773, "seconds": 751, "nanos": 543},
            "end_time_of_day": {},
            "repeat_interval": {},
        },
        "event_stream": {"name": "name_value", "event_stream_start_time": {}, "event_stream_expiration_time": {}},
        "status": 1,
        "creation_time": {},
...
def test_create_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_create_transfer_job") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_create_transfer_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_transfer_job_rest_bad_request(request_type=transfer.UpdateTransferJobRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_update_transfer_job") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_update_transfer_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_transfer_job") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_get_transfer_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_transfer_jobs_rest_bad_request(request_type=transfer.ListTransferJobsRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_list_transfer_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_list_transfer_jobs") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_list_transfer_jobs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = transfer.ListTransferJobsResponse.to_json(transfer.ListTransferJobsResponse())
        req.return_value.content = return_value
...
def test_pause_transfer_operation_rest_bad_request(request_type=transfer.PauseTransferOperationRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_pause_transfer_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_pause_transfer_operation") as pre:
        pre.assert_not_called()
...
def test_resume_transfer_operation_rest_bad_request(request_type=transfer.ResumeTransferOperationRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "transferOperations/sample1"}
    request = request_type(**request_init)
...
def test_resume_transfer_operation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_resume_transfer_operation") as pre:
        pre.assert_not_called()
...
def test_run_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.StorageTransferServiceRestInterceptor, "post_run_transfer_job_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_transfer_job_rest_bad_request(request_type=transfer.DeleteTransferJobRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"job_name": "transferJobs/sample1"}
    request = request_type(**request_init)
...
def test_delete_transfer_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_delete_transfer_job") as pre:
        pre.assert_not_called()
...
def test_create_agent_pool_rest_bad_request(request_type=transfer.CreateAgentPoolRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"project_id": "sample1"}
    request = request_type(**request_init)
...
def test_create_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_create_agent_pool") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_create_agent_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_agent_pool_rest_bad_request(request_type=transfer.UpdateAgentPoolRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_update_agent_pool") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_update_agent_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_get_agent_pool") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_get_agent_pool_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_agent_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "post_list_agent_pools") as post, mock.patch.object(
        transports.StorageTransferServiceRestInterceptor, "post_list_agent_pools_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = transfer.ListAgentPoolsResponse.to_json(transfer.ListAgentPoolsResponse())
        req.return_value.content = return_value
...
def test_delete_agent_pool_rest_bad_request(request_type=transfer.DeleteAgentPoolRequest):
    client = StorageTransferServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/agentPools/sample2"}
    request = request_type(**request_init)
...
def test_delete_agent_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.StorageTransferServiceRestInterceptor, "pre_delete_agent_pool") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.StorageTransferServiceGrpcTransport, grpc_helpers), (transports.StorageTransferServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_storage_transfer_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "storagetransfer.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://storagetransfer.googleapis.com:8000"
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (StorageTransferServiceAsyncClient, transports.StorageTransferServiceGrpcAsyncIOTransport),
    ],
)

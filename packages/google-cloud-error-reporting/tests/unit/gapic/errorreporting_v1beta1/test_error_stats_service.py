...
async def test_list_group_stats_async(request_type, transport: str = "grpc_asyncio"):
    client = ErrorStatsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_events_async(request_type, transport: str = "grpc_asyncio"):
    client = ErrorStatsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_group_stats_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListGroupStats,
...
def test_delete_events_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteEvents,

...
class SummarizeMaintenancesResponse(proto.Message):
    ...
    Attributes:
        maintenances (MutableSequence[google.cloud.maintenance_api_v1.types.MaintenanceSummary]):
...
class MaintenanceSummary(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            maintenance.
        category (google.cloud.maintenance_api_v1.types.MaintenanceCategory):
        ...
        user_controllable (bool):
            ...
            field).
        controls (MutableSequence[google.cloud.maintenance_api_v1.types.MaintenanceControl]):
        ...
        stats (MutableSequence[google.cloud.maintenance_api_v1.types.MaintenanceSummary.Stats]):
    ...
    class Stats(proto.Message):
        ...
        Attributes:
            ...
            aggregates (MutableSequence[google.cloud.maintenance_api_v1.types.MaintenanceSummary.Aggregate]):
...
class ResourceMaintenance(proto.Message):
    ...
    Attributes:
        ...
        resource (google.cloud.maintenance_api_v1.types.ResourceMaintenance.Resource):
            Output only. The resource spec of the
            resource maintenance.
        maintenance (google.cloud.maintenance_api_v1.types.ResourceMaintenance.Maintenance):
            Output only. The details of the maintenance.
        state (google.cloud.maintenance_api_v1.types.ResourceMaintenance.State):
...
class MaintenanceControl(proto.Message):
    ...
    Attributes:
        control (google.cloud.maintenance_api_v1.types.MaintenanceControl.Control):
...
class ListResourceMaintenancesResponse(proto.Message):
    ...
    Attributes:
        resource_maintenances (MutableSequence[google.cloud.maintenance_api_v1.types.ResourceMaintenance]):

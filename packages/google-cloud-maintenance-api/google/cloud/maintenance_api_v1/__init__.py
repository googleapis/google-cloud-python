...
__lazy_modules__ = {
    "google.cloud.maintenance_api_v1.services.maintenance",
    "google.cloud.maintenance_api_v1.types.maintenance_service",
}
...
api_core.check_python_version("google.cloud.maintenance_api_v1")
api_core.check_dependency_versions("google.cloud.maintenance_api_v1")

...
from .transports.grpc import UserListGlobalLicenseServiceGrpcTransport
from .transports.grpc_asyncio import UserListGlobalLicenseServiceGrpcAsyncIOTransport
from .transports.rest import UserListGlobalLicenseServiceRestTransport


class UserListGlobalLicenseServiceClientMeta(type):
    """Metaclass for the UserListGlobalLicenseService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[UserListGlobalLicenseServiceTransport]]
    _transport_registry["grpc"] = UserListGlobalLicenseServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = (
        UserListGlobalLicenseServiceGrpcAsyncIOTransport
    )
    _transport_registry["rest"] = UserListGlobalLicenseServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[UserListGlobalLicenseServiceTransport]:
...
class UserListGlobalLicenseServiceClient(
    metaclass=UserListGlobalLicenseServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            UserListGlobalLicenseServiceClient: The constructed client.
        """
    ...
    def transport(self) -> UserListGlobalLicenseServiceTransport:
        ...
        Returns:
            UserListGlobalLicenseServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def user_list_global_license_path(
        account_type: str,
        account: str,
        user_list_global_license: str,
    ) -> str:
        """Returns a fully-qualified user_list_global_license string."""
        return "accountTypes/{account_type}/accounts/{account}/userListGlobalLicenses/{user_list_global_license}".format(
            account_type=account_type,
            account=account,
            user_list_global_license=user_list_global_license,
        )

    @staticmethod
    def parse_user_list_global_license_path(path: str) -> Dict[str, str]:
        """Parses a user_list_global_license path into its component segments."""
        m = re.match(
            r"^accountTypes/(?P<account_type>.+?)/accounts/(?P<account>.+?)/userListGlobalLicenses/(?P<user_list_global_license>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def user_list_global_license_customer_info_path(
        account_type: str,
        account: str,
        user_list_global_license: str,
        license_customer_info: str,
    ) -> str:
        """Returns a fully-qualified user_list_global_license_customer_info string."""
        return "accountTypes/{account_type}/accounts/{account}/userListGlobalLicenses/{user_list_global_license}/customerInfos/{license_customer_info}".format(
            account_type=account_type,
            account=account,
            user_list_global_license=user_list_global_license,
            license_customer_info=license_customer_info,
        )

    @staticmethod
    def parse_user_list_global_license_customer_info_path(path: str) -> Dict[str, str]:
        """Parses a user_list_global_license_customer_info path into its component segments."""
        m = re.match(
            r"^accountTypes/(?P<account_type>.+?)/accounts/(?P<account>.+?)/userListGlobalLicenses/(?P<user_list_global_license>.+?)/customerInfos/(?P<license_customer_info>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            UserListGlobalLicenseServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = UserListGlobalLicenseServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                UserListGlobalLicenseServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = UserListGlobalLicenseServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the user list global license service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            UserListGlobalLicenseServiceClient._read_environment_variables()
        )
        self._client_cert_source = (
            UserListGlobalLicenseServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = UserListGlobalLicenseServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, UserListGlobalLicenseServiceTransport
        )
        if transport_provided:
            # transport is a UserListGlobalLicenseServiceTransport instance.
            ...
            self._transport = cast(UserListGlobalLicenseServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or UserListGlobalLicenseServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                UserListGlobalLicenseServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., UserListGlobalLicenseServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.datamanager_v1.UserListGlobalLicenseServiceClient`.",
                    extra={
    ...
    def create_user_list_global_license(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_user_list_global_license():
                # Create a client
                ...
                # Make the request
                response = client.create_user_list_global_license(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.datamanager_v1.types.CreateUserListGlobalLicenseRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_user_list_global_license
        ]
    ...
    def update_user_list_global_license(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_user_list_global_license():
                # Create a client
                client = datamanager_v1.UserListGlobalLicenseServiceClient()
                ...
                # Make the request
                response = client.update_user_list_global_license(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ads.datamanager_v1.types.UpdateUserListGlobalLicenseRequest, dict]):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_user_list_global_license
        ]
    ...
    def get_user_list_global_license(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.GetUserListGlobalLicenseRequest, dict]):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_user_list_global_license
        ]
    ...
    def list_user_list_global_licenses(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListUserListGlobalLicensesPager:
        ...
        .. code-block:: python
            ...
            def sample_list_user_list_global_licenses():
                # Create a client
                client = datamanager_v1.UserListGlobalLicenseServiceClient()
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.ListUserListGlobalLicensesRequest, dict]):
        ...
        Returns:
            google.ads.datamanager_v1.services.user_list_global_license_service.pagers.ListUserListGlobalLicensesPager:
                Response from the
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_user_list_global_licenses
        ]
        ...
        response = pagers.ListUserListGlobalLicensesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_user_list_global_license_customer_infos(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListUserListGlobalLicenseCustomerInfosPager:
        ...
        .. code-block:: python
            ...
            def sample_list_user_list_global_license_customer_infos():
                # Create a client
                client = datamanager_v1.UserListGlobalLicenseServiceClient()
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.ListUserListGlobalLicenseCustomerInfosRequest, dict]):
                The request object. Request to list all
        ...
        Returns:
            google.ads.datamanager_v1.services.user_list_global_license_service.pagers.ListUserListGlobalLicenseCustomerInfosPager:
                Response from the
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_user_list_global_license_customer_infos
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListUserListGlobalLicenseCustomerInfosPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "UserListGlobalLicenseServiceClient":
        return self
...
__all__ = ("UserListGlobalLicenseServiceClient",)

...
class UserListGlobalLicenseServiceTransport(abc.ABC):
    """Abstract transport class for UserListGlobalLicenseService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_user_list_global_license: gapic_v1.method.wrap_method(
                self.create_user_list_global_license,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_user_list_global_license: gapic_v1.method.wrap_method(
                self.update_user_list_global_license,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_user_list_global_license: gapic_v1.method.wrap_method(
                self.get_user_list_global_license,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_user_list_global_licenses: gapic_v1.method.wrap_method(
                self.list_user_list_global_licenses,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_user_list_global_license_customer_infos: gapic_v1.method.wrap_method(
...
__all__ = ("UserListGlobalLicenseServiceTransport",)

...
class PartnerLinkServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_partner_link: gapic_v1.method.wrap_method(
                self.create_partner_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_partner_link: gapic_v1.method.wrap_method(
                self.delete_partner_link,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_partner_links: gapic_v1.method.wrap_method(
                self.search_partner_links,
                default_timeout=None,
                client_info=client_info,
            ),
        }
    ...
    def create_partner_link(
        ...
        Union[
            ...
            Awaitable[partner_link_service.PartnerLink],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("PartnerLinkServiceTransport",)

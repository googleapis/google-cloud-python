...
from .transports.grpc import IngestionServiceGrpcTransport
from .transports.grpc_asyncio import IngestionServiceGrpcAsyncIOTransport
from .transports.rest import IngestionServiceRestTransport


class IngestionServiceClientMeta(type):
    """Metaclass for the IngestionService client.
    ...
    ) -> Type[IngestionServiceTransport]:
...
class IngestionServiceClient(metaclass=IngestionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IngestionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> IngestionServiceTransport:
        ...
        Returns:
            IngestionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = IngestionServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = IngestionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = IngestionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = IngestionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, IngestionServiceTransport, Callable[..., IngestionServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the ingestion service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = IngestionServiceClient._read_environment_variables()
        self._client_cert_source = IngestionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = IngestionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, IngestionServiceTransport)
        if transport_provided:
            # transport is a IngestionServiceTransport instance.
            ...
            self._transport = cast(IngestionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or IngestionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[IngestionServiceTransport], Callable[..., IngestionServiceTransport]] = (
                IngestionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., IngestionServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.ads.datamanager_v1.IngestionServiceClient`.",
                    extra={
    ...
    def ingest_audience_members(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_ingest_audience_members():
                # Create a client
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.IngestAudienceMembersRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.ingest_audience_members]
    ...
    def remove_audience_members(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.RemoveAudienceMembersRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.remove_audience_members]
    ...
    def ingest_events(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.IngestEventsRequest, dict]):
                The request object. Request to upload audience members to the provided
                destinations. Returns an
    ...
    def retrieve_request_status(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_retrieve_request_status():
                # Create a client
                client = datamanager_v1.IngestionServiceClient()
        ...
        Args:
            request (Union[google.ads.datamanager_v1.types.RetrieveRequestStatusRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.retrieve_request_status]
    ...
    def __enter__(self) -> "IngestionServiceClient":
        return self

...
async def sample_retrieve_insights():
    # Create a client
    client = datamanager_v1.MarketingDataInsightsServiceAsyncClient()
    ...
    # Make the request
    response = await client.retrieve_insights(request=request)

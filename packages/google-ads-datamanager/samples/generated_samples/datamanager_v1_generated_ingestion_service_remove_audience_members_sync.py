...
#
# Snippet for RemoveAudienceMembers
...
def sample_remove_audience_members():
    # Create a client
    ...
    request = datamanager_v1.RemoveAudienceMembersRequest(
        destinations=destinations,
        audience_members=audience_members,
    )

    # Make the request
    response = client.remove_audience_members(request=request)

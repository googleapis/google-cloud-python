...
#
# Snippet for ListUserListDirectLicenses
...
def sample_list_user_list_direct_licenses():
    # Create a client
    client = datamanager_v1.UserListDirectLicenseServiceClient()

    # Initialize request argument(s)
    request = datamanager_v1.ListUserListDirectLicensesRequest(
        parent="parent_value",
    )

    # Make the request
    page_result = client.list_user_list_direct_licenses(request=request)

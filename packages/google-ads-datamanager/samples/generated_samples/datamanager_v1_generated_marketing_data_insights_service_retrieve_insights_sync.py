...
def sample_retrieve_insights():
    # Create a client
    client = datamanager_v1.MarketingDataInsightsServiceClient()

    # Initialize request argument(s)
    request = datamanager_v1.RetrieveInsightsRequest(
        parent="parent_value",
        user_list_id="user_list_id_value",
    )

    # Make the request
    response = client.retrieve_insights(request=request)

...
class ManagedKafkaAsyncClient:
    ...
    parse_consumer_group_path = staticmethod(ManagedKafkaClient.parse_consumer_group_path)
    ...
    common_billing_account_path = staticmethod(ManagedKafkaClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ManagedKafkaClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(ManagedKafkaClient.parse_common_organization_path)
    common_project_path = staticmethod(ManagedKafkaClient.common_project_path)
    parse_common_project_path = staticmethod(ManagedKafkaClient.parse_common_project_path)
    common_location_path = staticmethod(ManagedKafkaClient.common_location_path)
    parse_common_location_path = staticmethod(ManagedKafkaClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return ManagedKafkaClient.from_service_account_info.__func__(ManagedKafkaAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ManagedKafkaAsyncClient: The constructed client.
        """
        return ManagedKafkaClient.from_service_account_file.__func__(ManagedKafkaAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ManagedKafkaTransport, Callable[..., ManagedKafkaTransport]]] = "grpc_asyncio",
    ...
    async def list_topics(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_topics]
    ...
    async def get_topic(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_topic]
    ...
    async def create_topic(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_topic]
    ...
    async def update_topic(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_topic]
    ...
    async def delete_topic(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_topic]
    ...
    async def list_consumer_groups(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_consumer_groups]
    ...
    async def get_consumer_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_consumer_group]
    ...
    async def update_consumer_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_consumer_group]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("consumer_group.name", request.consumer_group.name),)),)
    ...
    async def delete_consumer_group(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_consumer_group]
    ...
    async def list_acls(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_acls]
    ...
    async def create_acl(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_acl]
    ...
    async def update_acl(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_acl]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("acl.name", request.acl.name),)),)
    ...
    async def delete_acl(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_acl]
    ...
    async def add_acl_entry(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.add_acl_entry]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("acl", request.acl),)),)
    ...
    async def remove_acl_entry(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_acl_entry]

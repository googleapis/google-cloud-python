...
from google.cloud.managedkafka_v1.services.managed_kafka import ManagedKafkaAsyncClient, ManagedKafkaClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert ManagedKafkaClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert ManagedKafkaClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert ManagedKafkaClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert ManagedKafkaClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ManagedKafkaClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ManagedKafkaClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ManagedKafkaClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ManagedKafkaClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ManagedKafkaClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ManagedKafkaClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ManagedKafkaClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ManagedKafkaClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ManagedKafkaClient))
@mock.patch.object(ManagedKafkaAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ManagedKafkaAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ManagedKafkaClient._DEFAULT_UNIVERSE
    default_endpoint = ManagedKafkaClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ManagedKafkaClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ManagedKafkaClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ManagedKafkaClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ManagedKafkaClient.DEFAULT_MTLS_ENDPOINT
    assert ManagedKafkaClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ManagedKafkaClient._get_api_endpoint(None, None, default_universe, "always") == ManagedKafkaClient.DEFAULT_MTLS_ENDPOINT
    assert ManagedKafkaClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ManagedKafkaClient.DEFAULT_MTLS_ENDPOINT
    assert ManagedKafkaClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ManagedKafkaClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ManagedKafkaClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ManagedKafkaClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ManagedKafkaClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ManagedKafkaClient._get_universe_domain(None, None) == ManagedKafkaClient._DEFAULT_UNIVERSE
...
def test_managed_kafka_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ManagedKafkaAsyncClient, transports.ManagedKafkaGrpcAsyncIOTransport, "grpc_asyncio"),
        (ManagedKafkaClient, transports.ManagedKafkaRestTransport, "rest"),
    ],
)
@mock.patch.object(ManagedKafkaClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ManagedKafkaClient))
@mock.patch.object(ManagedKafkaAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ManagedKafkaAsyncClient))
def test_managed_kafka_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ManagedKafkaAsyncClient, transports.ManagedKafkaGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (ManagedKafkaClient, transports.ManagedKafkaGrpcTransport, "grpc", "false"),
        (ManagedKafkaAsyncClient, transports.ManagedKafkaGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_managed_kafka_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@mock.patch.object(ManagedKafkaClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ManagedKafkaClient))
@mock.patch.object(ManagedKafkaAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ManagedKafkaAsyncClient))
...
def test_managed_kafka_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (ManagedKafkaClient, transports.ManagedKafkaGrpcTransport, "grpc", grpc_helpers),
        (ManagedKafkaAsyncClient, transports.ManagedKafkaGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ManagedKafkaClient, transports.ManagedKafkaRestTransport, "rest", None),
    ],
)
def test_managed_kafka_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_managed_kafka_client_client_options_from_dict():
    with mock.patch("google.cloud.managedkafka_v1.services.managed_kafka.transports.ManagedKafkaGrpcTransport.__init__") as grpc_transport:
...
def test_managed_kafka_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_list_clusters_async(transport: str = "grpc_asyncio", request_type=managed_kafka.ListClustersRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_clusters_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_clusters), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(managed_kafka.ListClustersResponse())
        await client.list_clusters(request)
...
@pytest.mark.asyncio
async def test_get_cluster_async(transport: str = "grpc_asyncio", request_type=managed_kafka.GetClusterRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_cluster_async(transport: str = "grpc_asyncio", request_type=managed_kafka.CreateClusterRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.create_cluster), "__call__") as call:
        ...
        client.create_cluster(
            ...
            cluster=resources.Cluster(
                gcp_config=resources.GcpConfig(access_config=resources.AccessConfig(network_configs=[resources.NetworkConfig(subnet="subnet_value")]))
            ),
            cluster_id="cluster_id_value",
        )
...
@pytest.mark.asyncio
async def test_update_cluster_async(transport: str = "grpc_asyncio", request_type=managed_kafka.UpdateClusterRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_cluster_async(transport: str = "grpc_asyncio", request_type=managed_kafka.DeleteClusterRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_topics_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_topics in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_topics] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_topics_async(transport: str = "grpc_asyncio", request_type=managed_kafka.ListTopicsRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_topics_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_topics), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(managed_kafka.ListTopicsResponse())
        await client.list_topics(request)
...
async def test_list_topics_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_topics), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            managed_kafka.ListTopicsResponse(
                topics=[
...
async def test_list_topics_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_topics), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_topics(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_get_topic_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_topic in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_topic] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_topic_async(transport: str = "grpc_asyncio", request_type=managed_kafka.GetTopicRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_topic_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_topic in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_topic] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_topic_async(transport: str = "grpc_asyncio", request_type=managed_kafka.CreateTopicRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_topic_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_topic in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_topic] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_topic_async(transport: str = "grpc_asyncio", request_type=managed_kafka.UpdateTopicRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_topic_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_topic in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_topic] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_topic_async(transport: str = "grpc_asyncio", request_type=managed_kafka.DeleteTopicRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_consumer_groups_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_consumer_groups in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_consumer_groups] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_consumer_groups_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_consumer_groups in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_consumer_groups] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_consumer_groups_async(transport: str = "grpc_asyncio", request_type=managed_kafka.ListConsumerGroupsRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_consumer_groups_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_consumer_groups), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(managed_kafka.ListConsumerGroupsResponse())
        await client.list_consumer_groups(request)
...
async def test_list_consumer_groups_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_consumer_groups), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            managed_kafka.ListConsumerGroupsResponse(
                consumer_groups=[
...
async def test_list_consumer_groups_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_consumer_groups), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_consumer_groups(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_consumer_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_consumer_group in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_consumer_group] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_consumer_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_consumer_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_consumer_group] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_consumer_group_async(transport: str = "grpc_asyncio", request_type=managed_kafka.GetConsumerGroupRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_consumer_group_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_consumer_group), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.ConsumerGroup())
        await client.get_consumer_group(request)
...
def test_update_consumer_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_consumer_group in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_consumer_group] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_consumer_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_consumer_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_consumer_group] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_consumer_group_async(transport: str = "grpc_asyncio", request_type=managed_kafka.UpdateConsumerGroupRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_consumer_group_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_consumer_group in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_consumer_group] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_consumer_group_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_consumer_group in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_consumer_group] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_consumer_group_async(transport: str = "grpc_asyncio", request_type=managed_kafka.DeleteConsumerGroupRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_acls_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_acls in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_acls] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_acls_async(transport: str = "grpc_asyncio", request_type=managed_kafka.ListAclsRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_acls_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_acls), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(managed_kafka.ListAclsResponse())
        await client.list_acls(request)
...
async def test_list_acls_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_acls), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            managed_kafka.ListAclsResponse(
                acls=[
...
async def test_list_acls_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_acls), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_acls(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_get_acl_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_acl in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_acl] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_acl_async(transport: str = "grpc_asyncio", request_type=managed_kafka.GetAclRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_acl_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_acl in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_acl] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_acl_async(transport: str = "grpc_asyncio", request_type=managed_kafka.CreateAclRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_acl_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.update_acl in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_acl] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_acl_async(transport: str = "grpc_asyncio", request_type=managed_kafka.UpdateAclRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_acl_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_acl in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_acl] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_acl_async(transport: str = "grpc_asyncio", request_type=managed_kafka.DeleteAclRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_add_acl_entry_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.add_acl_entry in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.add_acl_entry] = mock_rpc
...
@pytest.mark.asyncio
async def test_add_acl_entry_async(transport: str = "grpc_asyncio", request_type=managed_kafka.AddAclEntryRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_add_acl_entry_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.add_acl_entry), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(managed_kafka.AddAclEntryResponse())
        await client.add_acl_entry(request)
...
def test_remove_acl_entry_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.remove_acl_entry] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_remove_acl_entry_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ManagedKafkaAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.remove_acl_entry in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.remove_acl_entry] = mock_rpc
...
@pytest.mark.asyncio
async def test_remove_acl_entry_async(transport: str = "grpc_asyncio", request_type=managed_kafka.RemoveAclEntryRequest):
    client = ManagedKafkaAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.remove_acl_entry), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(managed_kafka.RemoveAclEntryResponse())
...
def test_list_clusters_rest_required_fields(request_type=managed_kafka.ListClustersRequest):
...
def test_list_clusters_rest_unset_required_fields():
    transport = transports.ManagedKafkaRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_clusters_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(managed_kafka.ListClustersResponse.to_json(x) for x in response)
...
def test_create_cluster_rest_required_fields(request_type=managed_kafka.CreateClusterRequest):
    transport_class = transports.ManagedKafkaRestTransport
...
def test_update_cluster_rest_required_fields(request_type=managed_kafka.UpdateClusterRequest):
    transport_class = transports.ManagedKafkaRestTransport
...
def test_delete_cluster_rest_required_fields(request_type=managed_kafka.DeleteClusterRequest):
    transport_class = transports.ManagedKafkaRestTransport
...
def test_list_topics_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/clusters/*}/topics" % client.transport._host, args[1])
...
def test_get_topic_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/clusters/sample3/topics/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/clusters/*/topics/*}" % client.transport._host, args[1])
...
def test_create_topic_rest_required_fields(request_type=managed_kafka.CreateTopicRequest):
    transport_class = transports.ManagedKafkaRestTransport
...
def test_update_topic_rest_required_fields(request_type=managed_kafka.UpdateTopicRequest):
    transport_class = transports.ManagedKafkaRestTransport
...
def test_update_topic_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"topic": {"name": "projects/sample1/locations/sample2/clusters/sample3/topics/sample4"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{topic.name=projects/*/locations/*/clusters/*/topics/*}" % client.transport._host, args[1])
...
def test_delete_topic_rest_required_fields(request_type=managed_kafka.DeleteTopicRequest):
    transport_class = transports.ManagedKafkaRestTransport
...
def test_list_consumer_groups_rest_required_fields(request_type=managed_kafka.ListConsumerGroupsRequest):
    transport_class = transports.ManagedKafkaRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_consumer_groups._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_consumer_groups_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/clusters/*}/consumerGroups" % client.transport._host, args[1])
...
def test_list_consumer_groups_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(managed_kafka.ListConsumerGroupsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_get_consumer_group_rest_required_fields(request_type=managed_kafka.GetConsumerGroupRequest):
    transport_class = transports.ManagedKafkaRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_consumer_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_consumer_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/clusters/*/consumerGroups/**}" % client.transport._host, args[1])
...
def test_update_consumer_group_rest_required_fields(request_type=managed_kafka.UpdateConsumerGroupRequest):
    transport_class = transports.ManagedKafkaRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_consumer_group._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_consumer_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"consumer_group": {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4"}}
        ...
        assert path_template.validate(
            "%s/v1/{consumer_group.name=projects/*/locations/*/clusters/*/consumerGroups/**}" % client.transport._host, args[1]
        )
...
def test_delete_consumer_group_rest_required_fields(request_type=managed_kafka.DeleteConsumerGroupRequest):
    transport_class = transports.ManagedKafkaRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_consumer_group._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_acls_rest_required_fields(request_type=managed_kafka.ListAclsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_acls._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_acls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/clusters/*}/acls" % client.transport._host, args[1])
...
def test_get_acl_rest_required_fields(request_type=managed_kafka.GetAclRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_acl._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_acl_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/clusters/*/acls/**}" % client.transport._host, args[1])
...
def test_create_acl_rest_required_fields(request_type=managed_kafka.CreateAclRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_acl._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_acl_rest_required_fields(request_type=managed_kafka.UpdateAclRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_acl._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_acl_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"acl": {"name": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{acl.name=projects/*/locations/*/clusters/*/acls/**}" % client.transport._host, args[1])
...
def test_delete_acl_rest_required_fields(request_type=managed_kafka.DeleteAclRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_acl._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_acl_entry_rest_required_fields(request_type=managed_kafka.AddAclEntryRequest):
    transport_class = transports.ManagedKafkaRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_acl_entry._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_add_acl_entry_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"acl": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{acl=projects/*/locations/*/clusters/*/acls/**}:addAclEntry" % client.transport._host, args[1])
...
def test_remove_acl_entry_rest_required_fields(request_type=managed_kafka.RemoveAclEntryRequest):
    transport_class = transports.ManagedKafkaRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).remove_acl_entry._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_remove_acl_entry_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{acl=projects/*/locations/*/clusters/*/acls/**}:removeAclEntry" % client.transport._host, args[1])
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ManagedKafkaClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ManagedKafkaClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = ManagedKafkaAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ManagedKafkaAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ManagedKafkaClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_clusters_rest_bad_request(request_type=managed_kafka.ListClustersRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_clusters_rest_interceptors(null_interceptor):
    transport = transports.ManagedKafkaRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ManagedKafkaRestInterceptor(),
    )
    client = ManagedKafkaClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_clusters") as post, mock.patch.object(
        ...
        pb_message = managed_kafka.ListClustersRequest.pb(managed_kafka.ListClustersRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = managed_kafka.ListClustersResponse.to_json(managed_kafka.ListClustersResponse())
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_cluster") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.GetClusterRequest.pb(managed_kafka.GetClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_cluster_rest_bad_request(request_type=managed_kafka.CreateClusterRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2"}
    request = request_type(**request_init)
...
def test_create_cluster_rest_call_success(request_type):
    ...
    request_init["cluster"] = {
        "gcp_config": {"access_config": {"network_configs": [{"subnet": "subnet_value"}]}, "kms_key": "kms_key_value"},
        "name": "name_value",
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.CreateClusterRequest.pb(managed_kafka.CreateClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_cluster_rest_bad_request(request_type=managed_kafka.UpdateClusterRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.UpdateClusterRequest.pb(managed_kafka.UpdateClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_cluster_rest_bad_request(request_type=managed_kafka.DeleteClusterRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.DeleteClusterRequest.pb(managed_kafka.DeleteClusterRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_topics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_topics") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.ListTopicsRequest.pb(managed_kafka.ListTopicsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = managed_kafka.ListTopicsResponse.to_json(managed_kafka.ListTopicsResponse())
        req.return_value.content = return_value
...
def test_get_topic_rest_bad_request(request_type=managed_kafka.GetTopicRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3/topics/sample4"}
    request = request_type(**request_init)
...
def test_get_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_topic") as post, mock.patch.object(
...
def test_create_topic_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/clusters/sample3"}
    request_init["topic"] = {"name": "name_value", "partition_count": 1634, "replication_factor": 1912, "configs": {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_topic") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.CreateTopicRequest.pb(managed_kafka.CreateTopicRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_topic_rest_bad_request(request_type=managed_kafka.UpdateTopicRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"topic": {"name": "projects/sample1/locations/sample2/clusters/sample3/topics/sample4"}}
    request = request_type(**request_init)
...
def test_update_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_topic") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.UpdateTopicRequest.pb(managed_kafka.UpdateTopicRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_topic") as pre:
        pre.assert_not_called()
        pb_message = managed_kafka.DeleteTopicRequest.pb(managed_kafka.DeleteTopicRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_consumer_groups_rest_bad_request(request_type=managed_kafka.ListConsumerGroupsRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/clusters/sample3"}
    request = request_type(**request_init)
...
def test_list_consumer_groups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_consumer_groups") as post, mock.patch.object(
        transports.ManagedKafkaRestInterceptor, "post_list_consumer_groups_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.ListConsumerGroupsRequest.pb(managed_kafka.ListConsumerGroupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = managed_kafka.ListConsumerGroupsResponse.to_json(managed_kafka.ListConsumerGroupsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = managed_kafka.ListConsumerGroupsResponse(), metadata
...
def test_get_consumer_group_rest_bad_request(request_type=managed_kafka.GetConsumerGroupRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4"}
    request = request_type(**request_init)
...
def test_get_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_consumer_group") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.GetConsumerGroupRequest.pb(managed_kafka.GetConsumerGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_consumer_group_rest_bad_request(request_type=managed_kafka.UpdateConsumerGroupRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"consumer_group": {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4"}}
    request = request_type(**request_init)
...
def test_update_consumer_group_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"consumer_group": {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4"}}
    request_init["consumer_group"] = {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4", "topics": {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_consumer_group") as post, mock.patch.object(
        transports.ManagedKafkaRestInterceptor, "post_update_consumer_group_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.UpdateConsumerGroupRequest.pb(managed_kafka.UpdateConsumerGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_consumer_group_rest_bad_request(request_type=managed_kafka.DeleteConsumerGroupRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3/consumerGroups/sample4"}
    request = request_type(**request_init)
...
def test_delete_consumer_group_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_consumer_group") as pre:
        pre.assert_not_called()
        pb_message = managed_kafka.DeleteConsumerGroupRequest.pb(managed_kafka.DeleteConsumerGroupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_acls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_list_acls") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = managed_kafka.ListAclsResponse.to_json(managed_kafka.ListAclsResponse())
        req.return_value.content = return_value
...
def test_get_acl_rest_bad_request(request_type=managed_kafka.GetAclRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}
    request = request_type(**request_init)
...
def test_get_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_get_acl") as post, mock.patch.object(
...
def test_create_acl_rest_call_success(request_type):
    ...
    request_init["acl"] = {
        "name": "name_value",
        "acl_entries": [
            {"principal": "principal_value", "permission_type": "permission_type_value", "operation": "operation_value", "host": "host_value"}
        ],
        "etag": "etag_value",
        "resource_type": "resource_type_value",
        "resource_name": "resource_name_value",
...
def test_create_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_create_acl") as post, mock.patch.object(
...
def test_update_acl_rest_bad_request(request_type=managed_kafka.UpdateAclRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"acl": {"name": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}}
    request = request_type(**request_init)
...
def test_update_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_update_acl") as post, mock.patch.object(
...
def test_delete_acl_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "pre_delete_acl") as pre:
        pre.assert_not_called()
...
def test_add_acl_entry_rest_bad_request(request_type=managed_kafka.AddAclEntryRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"acl": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}
    request = request_type(**request_init)
...
def test_add_acl_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_add_acl_entry") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.AddAclEntryRequest.pb(managed_kafka.AddAclEntryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = managed_kafka.AddAclEntryResponse.to_json(managed_kafka.AddAclEntryResponse())
        req.return_value.content = return_value
...
def test_remove_acl_entry_rest_bad_request(request_type=managed_kafka.RemoveAclEntryRequest):
    client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"acl": "projects/sample1/locations/sample2/clusters/sample3/acls/sample4"}
    request = request_type(**request_init)
...
def test_remove_acl_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ManagedKafkaRestInterceptor, "post_remove_acl_entry") as post, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = managed_kafka.RemoveAclEntryRequest.pb(managed_kafka.RemoveAclEntryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = managed_kafka.RemoveAclEntryResponse.to_json(managed_kafka.RemoveAclEntryResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = managed_kafka.RemoveAclEntryResponse(), metadata
...
def test_managed_kafka_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ManagedKafkaTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_managed_kafka_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.managedkafka_v1.services.managed_kafka.transports.ManagedKafkaTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.ManagedKafkaGrpcTransport, grpc_helpers), (transports.ManagedKafkaGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.ManagedKafkaGrpcTransport, transports.ManagedKafkaGrpcAsyncIOTransport])
...
def test_managed_kafka_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ManagedKafkaRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_acl_path():
    ...
    cluster = "whelk"
    acl = "octopus"
    expected = "projects/{project}/locations/{location}/clusters/{cluster}/acls/{acl}".format(
        project=project,
        location=location,
        cluster=cluster,
        acl=acl,
...
def test_consumer_group_path():
    ...
    actual = ManagedKafkaClient.consumer_group_path(project, location, cluster, consumer_group)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ManagedKafkaTransport, "_prep_wrapped_messages") as prep:
        client = ManagedKafkaClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ManagedKafkaClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

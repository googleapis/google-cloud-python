Python Client for Shopping Merchant Promotions
==============================================

|stable| |pypi| |versions|

`Shopping Merchant Promotions`_: Programmatically manage your Merchant Center Accounts.
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-shopping-merchant-promotions.svg
   :target: https://pypi.org/project/google-shopping-merchant-promotions/
.. _Shopping Merchant Promotions: https://developers.google.com/merchant/api
.. _Client Library Documentation: https://googleapis.dev/python/google-shopping-merchant-promotions/latest
...
3. `Enable the Shopping Merchant Promotions.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Shopping Merchant Promotions.:  https://developers.google.com/merchant/api
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-shopping-merchant-promotions/samples
...
.. code-block:: console
    ...
    pip install google-shopping-merchant-promotions
...
-  Read the `Client Library Documentation`_ for Shopping Merchant Promotions
   to see other available methods on the client.
-  Read the `Shopping Merchant Promotions Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Shopping Merchant Promotions Product documentation:  https://developers.google.com/merchant/api

...
def sample_get_promotion():
    # Create a client
    client = merchant_promotions_v1beta.PromotionsServiceClient()
    ...
    # Make the request
    response = client.get_promotion(request=request)

...
from google.shopping.merchant_promotions_v1 import gapic_version as package_version
...
class PromotionsServiceTransport(abc.ABC):
    """Abstract transport class for PromotionsService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.insert_promotion: gapic_v1.method.wrap_method(
                self.insert_promotion,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_promotion: gapic_v1.method.wrap_method(
                self.get_promotion,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_promotions: gapic_v1.method.wrap_method(
...
__all__ = ("PromotionsServiceTransport",)

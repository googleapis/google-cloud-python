...
class PromotionsServiceGrpcAsyncIOTransport(PromotionsServiceTransport):
    ...
    @property
    def insert_promotion(self) -> Callable[[promotions.InsertPromotionRequest], Awaitable[promotions.Promotion]]:
    ...
    @property
    def get_promotion(self) -> Callable[[promotions.GetPromotionRequest], Awaitable[promotions.Promotion]]:
    ...
    @property
    def list_promotions(self) -> Callable[[promotions.ListPromotionsRequest], Awaitable[promotions.ListPromotionsResponse]]:

...
class PromotionsServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[PromotionsServiceTransport]]
...
class PromotionsServiceClient(metaclass=PromotionsServiceClientMeta):
    ...
    def promotion_path(
        ...
        return "accounts/{account}/promotions/{promotion}".format(
            account=account,
            promotion=promotion,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = PromotionsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = PromotionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = PromotionsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PromotionsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or PromotionsServiceClient._get_api_endpoint(

...
class PromotionsServiceGrpcAsyncIOTransport(PromotionsServiceTransport):
    ...
    def insert_promotion(
        self,
    ) -> Callable[[promotions.InsertPromotionRequest], Awaitable[promotions.Promotion]]:
    ...
    def get_promotion(
        self,
    ) -> Callable[[promotions.GetPromotionRequest], Awaitable[promotions.Promotion]]:
    ...
    def list_promotions(
        ...
        [promotions.ListPromotionsRequest], Awaitable[promotions.ListPromotionsResponse]
    ]:

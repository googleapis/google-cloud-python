...
class _BasePromotionsServiceRestTransport(PromotionsServiceTransport):
    ...
    class _BaseGetPromotion:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePromotionsServiceRestTransport._BaseGetPromotion._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseInsertPromotion:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePromotionsServiceRestTransport._BaseInsertPromotion._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListPromotions:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BasePromotionsServiceRestTransport._BaseListPromotions._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BasePromotionsServiceRestTransport",)

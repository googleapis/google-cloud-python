...
from .transports.grpc import ProductInputsServiceGrpcTransport
from .transports.grpc_asyncio import ProductInputsServiceGrpcAsyncIOTransport
from .transports.rest import ProductInputsServiceRestTransport


class ProductInputsServiceClientMeta(type):
    """Metaclass for the ProductInputsService client.
...
class ProductInputsServiceClient(metaclass=ProductInputsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ProductInputsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ProductInputsServiceTransport:
        ...
        Returns:
            ProductInputsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def product_path(
        ...
        return "accounts/{account}/products/{product}".format(
            account=account,
            product=product,
        )
    ...
    def parse_product_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^accounts/(?P<account>.+?)/products/(?P<product>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def product_input_path(
        account: str,
        productinput: str,
    ) -> str:
        """Returns a fully-qualified product_input string."""
        return "accounts/{account}/productInputs/{productinput}".format(
            account=account,
            productinput=productinput,
        )

    @staticmethod
    def parse_product_input_path(path: str) -> Dict[str, str]:
        """Parses a product_input path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/productInputs/(?P<productinput>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ProductInputsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ProductInputsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ProductInputsServiceTransport, Callable[..., ProductInputsServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the product inputs service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ProductInputsServiceClient._read_environment_variables()
        self._client_cert_source = ProductInputsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ProductInputsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ProductInputsServiceTransport)
        if transport_provided:
            # transport is a ProductInputsServiceTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or ProductInputsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ProductInputsServiceTransport], Callable[..., ProductInputsServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.products_v1.ProductInputsServiceClient`.",
                    extra={
    ...
    def insert_product_input(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert_product_input():
                # Create a client
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1.types.InsertProductInputRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.insert_product_input]
    ...
    def update_product_input(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1.types.UpdateProductInputRequest, dict]):
                The request object. Request message for the
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("product_input.name", request.product_input.name),)),)
    ...
    def delete_product_input(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_product_input():
                # Create a client
                client = merchant_products_v1.ProductInputsServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1.types.DeleteProductInputRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_product_input]
    ...
    def __enter__(self) -> "ProductInputsServiceClient":
        return self

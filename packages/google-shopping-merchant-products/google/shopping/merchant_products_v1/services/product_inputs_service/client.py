...
from google.shopping.merchant_products_v1._compat import (
    get_api_endpoint,
...
class ProductInputsServiceClient(metaclass=ProductInputsServiceClientMeta):
    ...
    def parse_product_input_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/productInputs/(?P<productinput>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = get_universe_domain(
            ...
            default_universe=ProductInputsServiceClient._DEFAULT_UNIVERSE,
        )
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=ProductInputsServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

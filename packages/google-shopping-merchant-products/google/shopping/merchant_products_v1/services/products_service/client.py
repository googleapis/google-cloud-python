...
class ProductsServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[ProductsServiceTransport]]
...
class ProductsServiceClient(metaclass=ProductsServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ProductsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ProductsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = ProductsServiceClient._read_environment_variables()
        self._client_cert_source = ProductsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ProductsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ProductsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ProductsServiceTransport], Callable[..., ProductsServiceTransport]
            ] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.products_v1.ProductsServiceClient`.",
                    extra={
    ...
    def get_product(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1.types.GetProductRequest, dict]):
    ...
    def list_products(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_products_v1.types.ListProductsRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_products_v1.services.products_service.pagers.ListProductsPager:

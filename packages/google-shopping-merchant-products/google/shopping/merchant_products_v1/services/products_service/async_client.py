...
from google.shopping.merchant_products_v1.services.products_service import pagers
from google.shopping.merchant_products_v1.types import products, products_common
...
class ProductsServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(ProductsServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ProductsServiceClient.parse_common_billing_account_path)
    ...
    common_organization_path = staticmethod(ProductsServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ProductsServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ProductsServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ProductsServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ProductsServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ProductsServiceClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ProductsServiceTransport, Callable[..., ProductsServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.products_v1.ProductsServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_product():
                # Create a client
                client = merchant_products_v1.ProductsServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_products_v1.types.GetProductRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                product name is ``accounts/123/products/en~US~sku123``.
                A legacy local product name would be
                ``accounts/123/products/local~en~US~sku123``. Note: For
                calls to the v1beta version, the ``product`` section
                consists of:
        ...
        Returns:
            google.shopping.merchant_products_v1.types.Product:
    ...
    async def list_products(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_products_v1.types.ListProductsRequest, dict]]):
        ...
        Returns:
            google.shopping.merchant_products_v1.services.products_service.pagers.ListProductsAsyncPager:

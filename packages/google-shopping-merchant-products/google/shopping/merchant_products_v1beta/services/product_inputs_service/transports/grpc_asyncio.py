...
class ProductInputsServiceGrpcAsyncIOTransport(ProductInputsServiceTransport):
    ...
    @property
    def insert_product_input(self) -> Callable[[productinputs.InsertProductInputRequest], Awaitable[productinputs.ProductInput]]:
    ...
    @property
    def update_product_input(self) -> Callable[[productinputs.UpdateProductInputRequest], Awaitable[productinputs.ProductInput]]:
    ...
    @property
    def delete_product_input(self) -> Callable[[productinputs.DeleteProductInputRequest], Awaitable[empty_pb2.Empty]]:
...
__all__ = ("ProductInputsServiceGrpcAsyncIOTransport",)

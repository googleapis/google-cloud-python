...
from .base import DEFAULT_CLIENT_INFO, ProductInputsServiceTransport
...
class ProductInputsServiceGrpcTransport(ProductInputsServiceTransport):
    """gRPC backend transport for ProductInputsService.
    ...
    def insert_product_input(
        ...
        You must have a products data source to be able to
        insert a product. The unique identifier of the data
        source is passed as a query parameter in the request
        URL.

        If an input with the same contentLanguage, offerId, and
        dataSource already exists, this method replaces that
        entry.
...
__all__ = ("ProductInputsServiceGrpcTransport",)

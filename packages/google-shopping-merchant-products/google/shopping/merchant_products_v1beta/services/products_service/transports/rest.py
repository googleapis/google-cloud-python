...
class ProductsServiceRestTransport(ProductsServiceTransport):
    """REST backend transport for ProductsService.
    ...
    class _GetProduct(ProductsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/products/v1beta/{name=accounts/*/products/*}",
                },
            ]
            request, metadata = self._interceptor.pre_get_product(request, metadata)
            pb_request = products.GetProductRequest.pb(request)
    ...
    class _ListProducts(ProductsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/products/v1beta/{parent=accounts/*}/products",
                },
            ]
            request, metadata = self._interceptor.pre_list_products(request, metadata)
            pb_request = products.ListProductsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

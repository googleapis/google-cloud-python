...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.shopping.merchant_products_v1beta")  # type: ignore
    api_core.check_dependency_versions("google.shopping.merchant_products_v1beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.shopping.merchant_products_v1beta"

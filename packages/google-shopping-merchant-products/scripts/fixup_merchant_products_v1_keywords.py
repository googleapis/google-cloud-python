...
class merchant_productsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'delete_product_input': ('name', 'data_source', ),
        'get_product': ('name', ),
...
def fix_files(
    ...
    *,
    transformer=merchant_productsCallTransformer(),
):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the merchant_products client library.

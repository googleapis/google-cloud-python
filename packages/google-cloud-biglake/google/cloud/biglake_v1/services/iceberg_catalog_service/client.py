...
class IcebergCatalogServiceClient(metaclass=IcebergCatalogServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or IcebergCatalogServiceClient._get_api_endpoint(
    ...
    def update_iceberg_catalog(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("iceberg_catalog.name", request.iceberg_catalog.name),)),)

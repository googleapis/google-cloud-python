...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert AuthorizedCertificatesClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert AuthorizedCertificatesClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                AuthorizedCertificatesClient._use_client_cert_effective()
...
@mock.patch.object(
    AuthorizedCertificatesAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(AuthorizedCertificatesAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        AuthorizedCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        AuthorizedCertificatesClient._get_api_endpoint(None, None, default_universe, "always") == AuthorizedCertificatesClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AuthorizedCertificatesClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == AuthorizedCertificatesClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_list_authorized_certificates_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_authorized_certificates), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_authorized_certificates(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_transport_kind_grpc():
    transport = AuthorizedCertificatesClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = AuthorizedCertificatesAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = AuthorizedCertificatesAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = AuthorizedCertificatesClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_authorized_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AuthorizedCertificatesRestInterceptor, "post_list_authorized_certificates"
    ) as post, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "post_list_authorized_certificates_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "pre_list_authorized_certificates"
    ) as pre:
...
def test_get_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "post_get_authorized_certificate") as post, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "post_get_authorized_certificate_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "pre_get_authorized_certificate"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_authorized_certificate_rest_call_success(request_type):
    ...
    request_init["certificate"] = {
        ...
        "certificate_raw_data": {"public_certificate": "public_certificate_value", "private_key": "private_key_value"},
        "managed_certificate": {"last_renewal_time": {}, "status": 1},
        "visible_domain_mappings": ["visible_domain_mappings_value1", "visible_domain_mappings_value2"],
        "domain_mappings_count": 2238,
    }
...
def test_create_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AuthorizedCertificatesRestInterceptor, "post_create_authorized_certificate"
    ) as post, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "post_create_authorized_certificate_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "pre_create_authorized_certificate"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.AuthorizedCertificatesRestInterceptor, "post_update_authorized_certificate"
    ) as post, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "post_update_authorized_certificate_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AuthorizedCertificatesRestInterceptor, "pre_update_authorized_certificate"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_authorized_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.AuthorizedCertificatesRestInterceptor, "pre_delete_authorized_certificate") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize(
    ...
    [(transports.AuthorizedCertificatesGrpcTransport, grpc_helpers), (transports.AuthorizedCertificatesGrpcAsyncIOTransport, grpc_helpers_async)],
)

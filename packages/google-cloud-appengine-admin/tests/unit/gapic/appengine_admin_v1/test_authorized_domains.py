...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AuthorizedDomainsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert AuthorizedDomainsClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AuthorizedDomainsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert AuthorizedDomainsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                AuthorizedDomainsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        AuthorizedDomainsClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        AuthorizedDomainsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                AuthorizedDomainsClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(AuthorizedDomainsClient),
)
@mock.patch.object(
    AuthorizedDomainsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(AuthorizedDomainsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = AuthorizedDomainsClient._DEFAULT_UNIVERSE
    default_endpoint = AuthorizedDomainsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = AuthorizedDomainsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == AuthorizedDomainsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        AuthorizedDomainsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        AuthorizedDomainsClient._get_api_endpoint(
    ...
    assert (
        AuthorizedDomainsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        AuthorizedDomainsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        AuthorizedDomainsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        AuthorizedDomainsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        AuthorizedDomainsClient._get_universe_domain(None, None)
        == AuthorizedDomainsClient._DEFAULT_UNIVERSE
    )
...
def test_list_authorized_domains_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_authorized_domains
...
@pytest.mark.asyncio
async def test_list_authorized_domains_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_authorized_domains
...
def test_list_authorized_domains_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.AuthorizedDomainsRestInterceptor,

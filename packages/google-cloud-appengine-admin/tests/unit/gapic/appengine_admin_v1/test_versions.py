...
from google.cloud.appengine_admin_v1.services.versions import VersionsAsyncClient, VersionsClient, pagers, transports
...
def test_list_versions_rest_bad_request(request_type=appengine.ListVersionsRequest):
...
def test_list_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = appengine.ListVersionsResponse.to_json(appengine.ListVersionsResponse())
...
def test_create_version_rest_call_success(request_type):
    ...
    request_init["version"] = {
        ...
        "automatic_scaling": {
            ...
            "cpu_utilization": {"aggregation_window_length": {}, "target_utilization": 0.19540000000000002},
            ...
            "min_pending_latency": {},
            "request_utilization": {"target_request_count_per_second": 3320, "target_concurrent_requests": 2820},
            "disk_utilization": {
        ...
        "resources": {
            ...
            "disk_gb": 0.723,
            "memory_gb": 0.961,
            "volumes": [{"name": "name_value", "volume_type": "volume_type_value", "size_gb": 0.739}],
        ...
        "error_handlers": [{"error_code": 1, "static_file": "static_file_value", "mime_type": "mime_type_value"}],
        "libraries": [{"name": "name_value", "version": "version_value"}],
        "api_config": {"auth_fail_action": 1, "login": 1, "script": "script_value", "security_level": 1, "url": "url_value"},
        "env_variables": {},
        "build_env_variables": {},
        "default_expiration": {},
        "health_check": {
        ...
        "deployment": {
            ...
            "cloud_build_options": {"app_yaml_path": "app_yaml_path_value", "cloud_build_timeout": {}},
        },
        "version_url": "version_url_value",
        "endpoints_api_service": {"name": "name_value", "config_id": "config_id_value", "rollout_strategy": 1, "disable_trace_sampling": True},

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ApplicationsClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        ApplicationsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        ApplicationsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ApplicationsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                ApplicationsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ApplicationsClient),
)
@mock.patch.object(
    ApplicationsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ApplicationsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ApplicationsClient._DEFAULT_UNIVERSE
    default_endpoint = ApplicationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ApplicationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        ApplicationsClient._get_api_endpoint(
    ...
    assert (
        ...
        == ApplicationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ApplicationsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ApplicationsClient._get_api_endpoint(None, None, default_universe, "always")
        == ApplicationsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ApplicationsClient._get_api_endpoint(
    ...
    assert (
        ApplicationsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ApplicationsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ApplicationsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ApplicationsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ApplicationsClient._get_universe_domain(None, None)
        == ApplicationsClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_get_application_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_application
...
@pytest.mark.asyncio
async def test_create_application_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_application
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_application_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_application
            in client._client._transport._wrapped_methods
        )
...
def test_repair_application_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.repair_application in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.repair_application] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_repair_application_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.repair_application
            in client._client._transport._wrapped_methods
        )
...
async def test_repair_application_async(request_type, transport: str = "grpc_asyncio"):
    client = ApplicationsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc_asyncio():
    transport = ApplicationsAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = ApplicationsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_create_application_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.ApplicationsRestInterceptor,
...
def test_update_application_rest_bad_request(
    request_type=appengine.UpdateApplicationRequest,
):
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )

...
from google.cloud.appengine_admin_v1.services.applications import ApplicationsAsyncClient, ApplicationsClient, transports
...
def test__read_environment_variables():
    assert ApplicationsClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ApplicationsClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert ApplicationsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ApplicationsClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ApplicationsClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ApplicationsClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ApplicationsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ApplicationsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ApplicationsClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ApplicationsClient._get_client_cert_source(None, False) is None
    assert ApplicationsClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ApplicationsClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ApplicationsClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ApplicationsClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ApplicationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApplicationsClient))
@mock.patch.object(ApplicationsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApplicationsAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ApplicationsClient._DEFAULT_UNIVERSE
    default_endpoint = ApplicationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ApplicationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ApplicationsClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ApplicationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ApplicationsClient.DEFAULT_MTLS_ENDPOINT
    assert ApplicationsClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ApplicationsClient._get_api_endpoint(None, None, default_universe, "always") == ApplicationsClient.DEFAULT_MTLS_ENDPOINT
    assert ApplicationsClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == ApplicationsClient.DEFAULT_MTLS_ENDPOINT
    assert ApplicationsClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ApplicationsClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ApplicationsClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ApplicationsClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ApplicationsClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ApplicationsClient._get_universe_domain(None, None) == ApplicationsClient._DEFAULT_UNIVERSE
...
def test_applications_client_service_account_always_use_jwt(transport_class, transport_name):
...
@mock.patch.object(ApplicationsClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApplicationsClient))
@mock.patch.object(ApplicationsAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ApplicationsAsyncClient))
def test_applications_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (ApplicationsClient, transports.ApplicationsGrpcTransport, "grpc", grpc_helpers),
        (ApplicationsAsyncClient, transports.ApplicationsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (ApplicationsClient, transports.ApplicationsRestTransport, "rest", None),
    ],
)
def test_applications_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_applications_client_client_options_from_dict():
    with mock.patch("google.cloud.appengine_admin_v1.services.applications.transports.ApplicationsGrpcTransport.__init__") as grpc_transport:
...
def test_applications_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_repair_application_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApplicationsClient(
        ...
        # Ensure method has been cached
        assert client._transport.repair_application in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.repair_application] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_repair_application_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ApplicationsAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.repair_application in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.repair_application] = mock_rpc
...
def test_get_application_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{name=apps/*}" % client.transport._host, args[1])
...
def test_repair_application_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ApplicationsClient(
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ApplicationsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ApplicationsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_get_application_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_application), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = appengine.GetApplicationRequest()
...
def test_update_application_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.update_application), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = appengine.UpdateApplicationRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_repair_application_empty_call_grpc():
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.repair_application), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.repair_application(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = ApplicationsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ApplicationsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_repair_application_empty_call_grpc_asyncio():
    client = ApplicationsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.repair_application), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.repair_application(request=None)
...
def test_transport_kind_rest():
    transport = ApplicationsClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_application_rest_bad_request(request_type=appengine.GetApplicationRequest):
    client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_application_rest_interceptors(null_interceptor):
    transport = transports.ApplicationsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ApplicationsRestInterceptor(),
    )
    client = ApplicationsClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ApplicationsRestInterceptor, "post_get_application") as post, mock.patch.object(
        ...
        pb_message = appengine.GetApplicationRequest.pb(appengine.GetApplicationRequest())
...
def test_create_application_rest_bad_request(request_type=appengine.CreateApplicationRequest):
    client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_create_application_rest_call_success(request_type):
    ...
    request_init["application"] = {
        "name": "name_value",
        "id": "id_value",
        "dispatch_rules": [{"domain": "domain_value", "path": "path_value", "service": "service_value"}],
        "auth_domain": "auth_domain_value",
        "location_id": "location_id_value",
        "code_bucket": "code_bucket_value",
        ...
        "gcr_domain": "gcr_domain_value",
        "database_type": 1,
        "feature_settings": {"split_health_checks": True, "use_container_optimized_os": True},
    }
...
def test_create_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = appengine.CreateApplicationRequest.pb(appengine.CreateApplicationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_application_rest_bad_request(request_type=appengine.UpdateApplicationRequest):
    client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "apps/sample1"}
    request = request_type(**request_init)
...
def test_update_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = appengine.UpdateApplicationRequest.pb(appengine.UpdateApplicationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_repair_application_rest_bad_request(request_type=appengine.RepairApplicationRequest):
    client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "apps/sample1"}
    request = request_type(**request_init)
...
def test_repair_application_rest_call_success(request_type):
    client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_repair_application_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = appengine.RepairApplicationRequest.pb(appengine.RepairApplicationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_repair_application_empty_call_rest():
    client = ApplicationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_applications_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ApplicationsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_applications_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.appengine_admin_v1.services.applications.transports.ApplicationsTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.ApplicationsGrpcTransport, grpc_helpers), (transports.ApplicationsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_applications_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.ApplicationsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ApplicationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

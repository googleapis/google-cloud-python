...
class ApplicationsGrpcAsyncIOTransport(ApplicationsTransport):
    ...
    @property
    def get_application(self) -> Callable[[appengine.GetApplicationRequest], Awaitable[application.Application]]:
    ...
    @property
    def create_application(self) -> Callable[[appengine.CreateApplicationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_application(self) -> Callable[[appengine.UpdateApplicationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def repair_application(self) -> Callable[[appengine.RepairApplicationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.repair_application: self._wrap_method(

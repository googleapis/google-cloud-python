...
class ApplicationsTransport(abc.ABC):
    ...
    @property
    def get_application(self) -> Callable[[appengine.GetApplicationRequest], Union[application.Application, Awaitable[application.Application]]]:
        raise NotImplementedError()

    @property
    def create_application(
        self,
    ) -> Callable[[appengine.CreateApplicationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def update_application(
        self,
    ) -> Callable[[appengine.UpdateApplicationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def repair_application(
        self,
    ) -> Callable[[appengine.RepairApplicationRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

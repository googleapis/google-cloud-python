...
class ApplicationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[appengine.CreateApplicationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_application(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[appengine.GetApplicationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_repair_application(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[appengine.RepairApplicationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update_application(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[appengine.UpdateApplicationRequest, Sequence[Tuple[str, str]]]:

...
class ApplicationsClient(metaclass=ApplicationsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ApplicationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            ApplicationsClient._read_environment_variables()
        )
        self._client_cert_source = ApplicationsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ApplicationsClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[ApplicationsTransport], Callable[..., ApplicationsTransport]
            ] = (

...
class ApplicationsClient(metaclass=ApplicationsClientMeta):
    ...
    def transport(self) -> ApplicationsTransport:
        ...
        Returns:
            ApplicationsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ApplicationsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ApplicationsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ApplicationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ApplicationsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ApplicationsTransport, Callable[..., ApplicationsTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ApplicationsClient._read_environment_variables()
        self._client_cert_source = ApplicationsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ApplicationsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ApplicationsTransport)
        if transport_provided:
            ...
            self._transport = cast(ApplicationsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ApplicationsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ApplicationsTransport], Callable[..., ApplicationsTransport]] = (
                ApplicationsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ApplicationsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.appengine_v1.ApplicationsClient`.",
                    extra={

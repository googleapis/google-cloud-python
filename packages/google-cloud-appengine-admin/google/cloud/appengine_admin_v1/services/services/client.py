...
from google.cloud.appengine_admin_v1.types import appengine, network_settings, service
...
class ServicesClient(metaclass=ServicesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=ServicesClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.appengine_v1.ServicesClient`.",
                    extra={
    ...
    def list_services(
        ...
        *,
        ...
        if not isinstance(request, appengine.ListServicesRequest):
    ...
    def get_service(
        ...
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, appengine.GetServiceRequest):
    ...
    def update_service(
        ...
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, appengine.UpdateServiceRequest):
    ...
    def delete_service(
        ...
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, appengine.DeleteServiceRequest):

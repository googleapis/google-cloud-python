...
class ServicesGrpcAsyncIOTransport(ServicesTransport):
    ...
    def list_services(
        ...
        [appengine.ListServicesRequest], Awaitable[appengine.ListServicesResponse]
    ]:
    ...
    def get_service(
        self,
    ) -> Callable[[appengine.GetServiceRequest], Awaitable[service.Service]]:
    ...
    def update_service(
        self,
    ) -> Callable[[appengine.UpdateServiceRequest], Awaitable[operations.Operation]]:
    ...
    def delete_service(
        self,
    ) -> Callable[[appengine.DeleteServiceRequest], Awaitable[operations.Operation]]:

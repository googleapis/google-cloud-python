...
class ServicesGrpcAsyncIOTransport(ServicesTransport):
    ...
    @property
    def list_services(self) -> Callable[[appengine.ListServicesRequest], Awaitable[appengine.ListServicesResponse]]:
    ...
    @property
    def get_service(self) -> Callable[[appengine.GetServiceRequest], Awaitable[service.Service]]:
    ...
    @property
    def update_service(self) -> Callable[[appengine.UpdateServiceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_service(self) -> Callable[[appengine.DeleteServiceRequest], Awaitable[operations_pb2.Operation]]:

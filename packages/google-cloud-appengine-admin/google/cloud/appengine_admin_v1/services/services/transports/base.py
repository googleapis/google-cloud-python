...
class ServicesTransport(abc.ABC):
    ...
    def list_services(
        self,
    ) -> Callable[[appengine.ListServicesRequest], Union[appengine.ListServicesResponse, Awaitable[appengine.ListServicesResponse]]]:
        raise NotImplementedError()

    @property
    def get_service(self) -> Callable[[appengine.GetServiceRequest], Union[service.Service, Awaitable[service.Service]]]:
        raise NotImplementedError()

    @property
    def update_service(self) -> Callable[[appengine.UpdateServiceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_service(self) -> Callable[[appengine.DeleteServiceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
from .base import DEFAULT_CLIENT_INFO, DomainMappingsTransport


class _BaseDomainMappingsRestTransport(DomainMappingsTransport):
    """Base REST backend transport for DomainMappings.
    ...
    class _BaseCreateDomainMapping:
    ...
    class _BaseDeleteDomainMapping:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseUpdateDomainMapping:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseDomainMappingsRestTransport",)

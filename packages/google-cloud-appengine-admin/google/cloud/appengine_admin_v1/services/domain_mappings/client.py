...
class DomainMappingsClient(metaclass=DomainMappingsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DomainMappingsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DomainMappingsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DomainMappingsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DomainMappingsClient._get_api_endpoint(

...
from .base import DEFAULT_CLIENT_INFO, AuthorizedCertificatesTransport


class AuthorizedCertificatesGrpcTransport(AuthorizedCertificatesTransport):
    """gRPC backend transport for AuthorizedCertificates.

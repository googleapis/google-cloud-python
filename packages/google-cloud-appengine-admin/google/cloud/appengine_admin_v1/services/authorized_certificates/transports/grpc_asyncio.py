...
class AuthorizedCertificatesGrpcAsyncIOTransport(AuthorizedCertificatesTransport):
    ...
    def list_authorized_certificates(
        self,
    ) -> Callable[[appengine.ListAuthorizedCertificatesRequest], Awaitable[appengine.ListAuthorizedCertificatesResponse]]:
    ...
    @property
    def get_authorized_certificate(self) -> Callable[[appengine.GetAuthorizedCertificateRequest], Awaitable[certificate.AuthorizedCertificate]]:
    ...
    @property
    def create_authorized_certificate(self) -> Callable[[appengine.CreateAuthorizedCertificateRequest], Awaitable[certificate.AuthorizedCertificate]]:
    ...
    @property
    def update_authorized_certificate(self) -> Callable[[appengine.UpdateAuthorizedCertificateRequest], Awaitable[certificate.AuthorizedCertificate]]:
    ...
    @property
    def delete_authorized_certificate(self) -> Callable[[appengine.DeleteAuthorizedCertificateRequest], Awaitable[empty_pb2.Empty]]:

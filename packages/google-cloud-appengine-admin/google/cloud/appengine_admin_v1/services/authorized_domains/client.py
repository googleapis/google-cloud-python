...
class AuthorizedDomainsClient(metaclass=AuthorizedDomainsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AuthorizedDomainsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AuthorizedDomainsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AuthorizedDomainsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AuthorizedDomainsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AuthorizedDomainsClient._get_api_endpoint(
...
__all__ = ("AuthorizedDomainsClient",)

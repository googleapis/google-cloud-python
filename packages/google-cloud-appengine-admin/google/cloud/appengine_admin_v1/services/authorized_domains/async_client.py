...
class AuthorizedDomainsAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AuthorizedDomainsTransport, Callable[..., AuthorizedDomainsTransport]]] = "grpc_asyncio",
    ...
    async def list_authorized_domains(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_authorized_domains]

...
class AuthorizedDomainsAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = AuthorizedDomainsClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = AuthorizedDomainsClient._DEFAULT_UNIVERSE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = AuthorizedDomainsClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(AuthorizedDomainsAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AuthorizedDomainsAsyncClient: The constructed client.
        """
        sa_file_func = AuthorizedDomainsClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(AuthorizedDomainsAsyncClient, filename, *args, **kwargs)
    ...
    get_transport_class = AuthorizedDomainsClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the authorized domains async client.
        ...
        Args:
            ...
            transport (Optional[Union[str,AuthorizedDomainsTransport,Callable[..., AuthorizedDomainsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the AuthorizedDomainsTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.appengine_v1.AuthorizedDomainsAsyncClient`.",
                extra={
    ...
    async def list_authorized_domains(
        ...
        *,
        ...
        if not isinstance(request, appengine.ListAuthorizedDomainsRequest):

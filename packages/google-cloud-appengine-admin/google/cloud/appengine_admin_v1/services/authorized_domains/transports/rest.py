...
class AuthorizedDomainsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the AuthorizedDomainsRestTransport.

    .. code-block:: python
        class MyCustomAuthorizedDomainsInterceptor(AuthorizedDomainsRestInterceptor):
            def pre_list_authorized_domains(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_authorized_domains(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = AuthorizedDomainsRestTransport(interceptor=MyCustomAuthorizedDomainsInterceptor())
    ...
    def pre_list_authorized_domains(
        ...
        before they are sent to the AuthorizedDomains server.
        """
        return request, metadata
...
class AuthorizedDomainsRestStub:
...
class AuthorizedDomainsRestTransport(_BaseAuthorizedDomainsRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[AuthorizedDomainsRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[AuthorizedDomainsRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseAuthorizedDomainsRestTransport._BaseListAuthorizedDomains,
                    "_BaseListAuthorizedDomains__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
            ...
            # Return the response
            resp = appengine.ListAuthorizedDomainsResponse()
...
__all__ = ("AuthorizedDomainsRestTransport",)

...
from .base import DEFAULT_CLIENT_INFO, AuthorizedDomainsTransport
...
class AuthorizedDomainsGrpcAsyncIOTransport(AuthorizedDomainsTransport):
    ...
    @property
    def list_authorized_domains(self) -> Callable[[appengine.ListAuthorizedDomainsRequest], Awaitable[appengine.ListAuthorizedDomainsResponse]]:
        ...
        if "list_authorized_domains" not in self._stubs:
            self._stubs["list_authorized_domains"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_authorized_domains: self._wrap_method(

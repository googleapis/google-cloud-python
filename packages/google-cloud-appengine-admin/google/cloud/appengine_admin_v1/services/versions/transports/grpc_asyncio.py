...
class VersionsGrpcAsyncIOTransport(VersionsTransport):
    ...
    @property
    def list_versions(self) -> Callable[[appengine.ListVersionsRequest], Awaitable[appengine.ListVersionsResponse]]:
    ...
    @property
    def get_version(self) -> Callable[[appengine.GetVersionRequest], Awaitable[version.Version]]:
    ...
    @property
    def create_version(self) -> Callable[[appengine.CreateVersionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_version(self) -> Callable[[appengine.UpdateVersionRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_version(self) -> Callable[[appengine.DeleteVersionRequest], Awaitable[operations_pb2.Operation]]:

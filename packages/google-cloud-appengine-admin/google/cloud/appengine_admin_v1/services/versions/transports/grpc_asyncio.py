...
class VersionsGrpcAsyncIOTransport(VersionsTransport):
    ...
    def create_version(
        ...
        [appengine.CreateVersionRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_version(
        ...
        [appengine.UpdateVersionRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_version(
        ...
        [appengine.DeleteVersionRequest], Awaitable[operations_pb2.Operation]
    ]:

...
class VersionsGrpcAsyncIOTransport(VersionsTransport):
    ...
    def list_versions(
        ...
        [appengine.ListVersionsRequest], Awaitable[appengine.ListVersionsResponse]
    ]:
    ...
    def get_version(
        self,
    ) -> Callable[[appengine.GetVersionRequest], Awaitable[version.Version]]:
    ...
    def create_version(
        self,
    ) -> Callable[[appengine.CreateVersionRequest], Awaitable[operations.Operation]]:
    ...
    def update_version(
        self,
    ) -> Callable[[appengine.UpdateVersionRequest], Awaitable[operations.Operation]]:
    ...
    def delete_version(
        self,
    ) -> Callable[[appengine.DeleteVersionRequest], Awaitable[operations.Operation]]:

...
class FirewallAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FirewallTransport, Callable[..., FirewallTransport]]] = "grpc_asyncio",
    ...
    async def list_ingress_rules(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_ingress_rules]
    ...
    async def batch_update_ingress_rules(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_update_ingress_rules]
    ...
    async def create_ingress_rule(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_ingress_rule]
    ...
    async def get_ingress_rule(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_ingress_rule]
    ...
    async def update_ingress_rule(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_ingress_rule]
    ...
    async def delete_ingress_rule(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_ingress_rule]

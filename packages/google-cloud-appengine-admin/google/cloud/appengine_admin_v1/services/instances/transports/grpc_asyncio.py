...
class InstancesGrpcAsyncIOTransport(InstancesTransport):
    ...
    def list_instances(
        ...
        [appengine.ListInstancesRequest], Awaitable[appengine.ListInstancesResponse]
    ]:
    ...
    def get_instance(
        self,
    ) -> Callable[[appengine.GetInstanceRequest], Awaitable[instance.Instance]]:
    ...
    def delete_instance(
        ...
        [appengine.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def debug_instance(
        ...
        [appengine.DebugInstanceRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.debug_instance: gapic_v1.method_async.wrap_method(
                self.debug_instance,
                default_timeout=None,
                client_info=client_info,
            ),

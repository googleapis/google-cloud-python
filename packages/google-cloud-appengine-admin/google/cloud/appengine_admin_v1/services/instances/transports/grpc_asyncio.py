...
class InstancesGrpcAsyncIOTransport(InstancesTransport):
    ...
    @property
    def list_instances(self) -> Callable[[appengine.ListInstancesRequest], Awaitable[appengine.ListInstancesResponse]]:
    ...
    @property
    def get_instance(self) -> Callable[[appengine.GetInstanceRequest], Awaitable[instance.Instance]]:
    ...
    @property
    def delete_instance(self) -> Callable[[appengine.DeleteInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def debug_instance(self) -> Callable[[appengine.DebugInstanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.debug_instance: self._wrap_method(
                self.debug_instance,
                default_timeout=None,
                client_info=client_info,
            ),

...
class InstancesTransport(abc.ABC):
    ...
    def list_instances(
        self,
    ) -> Callable[[appengine.ListInstancesRequest], Union[appengine.ListInstancesResponse, Awaitable[appengine.ListInstancesResponse]]]:
        raise NotImplementedError()

    @property
    def get_instance(self) -> Callable[[appengine.GetInstanceRequest], Union[instance.Instance, Awaitable[instance.Instance]]]:
        raise NotImplementedError()

    @property
    def delete_instance(self) -> Callable[[appengine.DeleteInstanceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def debug_instance(self) -> Callable[[appengine.DebugInstanceRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

...
from .services.authorized_certificates import AuthorizedCertificatesAsyncClient, AuthorizedCertificatesClient
from .services.authorized_domains import AuthorizedDomainsAsyncClient, AuthorizedDomainsClient
...
from .types.certificate import AuthorizedCertificate, CertificateRawData, ManagedCertificate, ManagementStatus
from .types.deploy import CloudBuildOptions, ContainerInfo, Deployment, FileInfo, ZipInfo
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.appengine_admin_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.appengine_admin_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.appengine_admin_v1"

...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ServiceManagerClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ServiceManagerClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ServiceManagerClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ServiceManagerClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ServiceManagerClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ServiceManagerClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ServiceManagerClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert ServiceManagerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ServiceManagerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert ServiceManagerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ServiceManagerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(ServiceManagerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceManagerClient))
@mock.patch.object(ServiceManagerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ServiceManagerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ServiceManagerClient._DEFAULT_UNIVERSE
    default_endpoint = ServiceManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ServiceManagerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ServiceManagerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        ServiceManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ServiceManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServiceManagerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ServiceManagerClient._get_api_endpoint(None, None, default_universe, "always") == ServiceManagerClient.DEFAULT_MTLS_ENDPOINT
    assert (
        ServiceManagerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ServiceManagerClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ServiceManagerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ServiceManagerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ServiceManagerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ServiceManagerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ServiceManagerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ServiceManagerClient._get_universe_domain(None, None) == ServiceManagerClient._DEFAULT_UNIVERSE
...
def test_service_manager_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "servicemanagement.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://servicemanagement.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        (ServiceManagerClient, transports.ServiceManagerGrpcTransport, "grpc", grpc_helpers),
        (ServiceManagerAsyncClient, transports.ServiceManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_undelete_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.undelete_service] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_undelete_service_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.undelete_service in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.undelete_service] = mock_rpc
...
def test_list_service_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_service_configs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_service_configs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_service_configs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_service_configs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_service_configs] = mock_rpc
...
def test_list_service_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_service_configs), "__call__") as call:
        ...
        retry = retries.Retry()
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("service_name", ""),)),)
...
async def test_list_service_configs_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_service_configs), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_service_configs(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_service_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_service_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_service_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_service_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_service_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_service_config] = mock_rpc
...
def test_create_service_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_service_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_service_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_service_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_service_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_service_config] = mock_rpc
...
def test_submit_config_source_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.submit_config_source in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.submit_config_source] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_submit_config_source_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.submit_config_source in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.submit_config_source] = mock_rpc
...
def test_list_service_rollouts_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_service_rollouts in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_service_rollouts] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_service_rollouts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_service_rollouts in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_service_rollouts] = mock_rpc
...
async def test_list_service_rollouts_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_service_rollouts), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_service_rollouts(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_service_rollout_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_service_rollout in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_service_rollout] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_service_rollout_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_service_rollout in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_service_rollout] = mock_rpc
...
def test_create_service_rollout_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_service_rollout in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_service_rollout] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_service_rollout_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_service_rollout in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_service_rollout] = mock_rpc
...
def test_generate_config_report_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_config_report in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_config_report] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_config_report_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ServiceManagerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_config_report in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_config_report] = mock_rpc
...
def test_generate_config_report_flattened():
    ...
    with mock.patch.object(type(client.transport.generate_config_report), "__call__") as call:
        ...
        client.generate_config_report(
            new_config=any_pb2.Any(type_url="type.googleapis.com/google.protobuf.Empty"),
...
def test_list_service_configs_rest_required_fields(request_type=servicemanager.ListServiceConfigsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_service_configs._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_service_config_rest_required_fields(request_type=servicemanager.CreateServiceConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_service_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_submit_config_source_rest_required_fields(request_type=servicemanager.SubmitConfigSourceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).submit_config_source._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_service_rollouts_rest_required_fields(request_type=servicemanager.ListServiceRolloutsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_service_rollouts._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_service_rollout_rest_required_fields(request_type=servicemanager.GetServiceRolloutRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_service_rollout._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_service_rollout_rest_required_fields(request_type=servicemanager.CreateServiceRolloutRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_service_rollout._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_generate_config_report_rest_required_fields(request_type=servicemanager.GenerateConfigReportRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_config_report._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = ServiceManagerClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_services_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_services), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.ListServicesRequest()
...
def test_get_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.GetServiceRequest()
...
def test_create_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.CreateServiceRequest()
...
def test_delete_service_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_service), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.DeleteServiceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undelete_service_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.undelete_service), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.undelete_service(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.UndeleteServiceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_service_configs_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_service_configs), "__call__") as call:
        call.return_value = servicemanager.ListServiceConfigsResponse()
        client.list_service_configs(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_service_config_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_service_config), "__call__") as call:
        call.return_value = service_pb2.Service()
        client.get_service_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.GetServiceConfigRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_service_config_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_service_config), "__call__") as call:
        call.return_value = service_pb2.Service()
        client.create_service_config(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.CreateServiceConfigRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_submit_config_source_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.submit_config_source), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.submit_config_source(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.SubmitConfigSourceRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_service_rollouts_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.list_service_rollouts), "__call__") as call:
        call.return_value = servicemanager.ListServiceRolloutsResponse()
        client.list_service_rollouts(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.ListServiceRolloutsRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_service_rollout_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.get_service_rollout), "__call__") as call:
        call.return_value = resources.Rollout()
        client.get_service_rollout(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.GetServiceRolloutRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_service_rollout_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.create_service_rollout), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.create_service_rollout(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.CreateServiceRolloutRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_config_report_empty_call_grpc():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.generate_config_report), "__call__") as call:
        call.return_value = servicemanager.GenerateConfigReportResponse()
        client.generate_config_report(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = servicemanager.GenerateConfigReportRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ServiceManagerAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ServiceManagerAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undelete_service_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.undelete_service), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.undelete_service(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_service_configs_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_service_configs), "__call__") as call:
        ...
        await client.list_service_configs(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_service_config_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_service_config), "__call__") as call:
        ...
        await client.get_service_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_service_config_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_service_config), "__call__") as call:
        ...
        await client.create_service_config(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_submit_config_source_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.submit_config_source), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.submit_config_source(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_service_rollouts_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.list_service_rollouts), "__call__") as call:
        ...
        await client.list_service_rollouts(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_service_rollout_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.get_service_rollout), "__call__") as call:
        ...
        await client.get_service_rollout(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_service_rollout_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.create_service_rollout), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.create_service_rollout(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_generate_config_report_empty_call_grpc_asyncio():
    client = ServiceManagerAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.generate_config_report), "__call__") as call:
        ...
        await client.generate_config_report(request=None)
...
def test_transport_kind_rest():
    transport = ServiceManagerClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_services_rest_bad_request(request_type=servicemanager.ListServicesRequest):
...
def test_list_services_rest_interceptors(null_interceptor):
    transport = transports.ServiceManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ServiceManagerRestInterceptor(),
    )
    client = ServiceManagerClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_services") as post, mock.patch.object(
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = servicemanager.ListServicesResponse.to_json(servicemanager.ListServicesResponse())
        ...
        post_with_metadata.return_value = servicemanager.ListServicesResponse(), metadata
...
def test_get_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.ManagedService.to_json(resources.ManagedService())
        req.return_value.content = return_value
...
def test_create_service_rest_bad_request(request_type=servicemanager.CreateServiceRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_delete_service_rest_bad_request(request_type=servicemanager.DeleteServiceRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_undelete_service_rest_bad_request(request_type=servicemanager.UndeleteServiceRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_undelete_service_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_service_configs_rest_bad_request(request_type=servicemanager.ListServiceConfigsRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_list_service_configs_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_service_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_service_configs") as post, mock.patch.object(
        transports.ServiceManagerRestInterceptor, "post_list_service_configs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = servicemanager.ListServiceConfigsResponse.to_json(servicemanager.ListServiceConfigsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = servicemanager.ListServiceConfigsResponse(), metadata
...
def test_get_service_config_rest_bad_request(request_type=servicemanager.GetServiceConfigRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_service_config_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_service_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_config") as post, mock.patch.object(
        transports.ServiceManagerRestInterceptor, "post_get_service_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = json_format.MessageToJson(service_pb2.Service())
        req.return_value.content = return_value
...
def test_create_service_config_rest_bad_request(request_type=servicemanager.CreateServiceConfigRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_create_service_config_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    ...
    request_init["service_config"] = {
                ...
                "methods": [
                    {
                        ...
                        "options": [
                            {
                                "name": "name_value",
                                "value": {"type_url": "type.googleapis.com/google.protobuf.Duration", "value": b"\x08\x0c\x10\xdb\x07"},
                            }
                        ],
                        "syntax": 1,
                    }
        ...
        "documentation": {
            ...
            "pages": [{"name": "name_value", "content": "content_value", "subpages": {}}],
            "rules": [{"selector": "selector_value", "description": "description_value", "deprecation_description": "deprecation_description_value"}],
            ...
            "rules": [
                {
                    ...
                    "requirements": [{"provider_id": "provider_id_value", "audiences": "audiences_value"}],
                }
            ],
            "providers": [
                {
                    ...
                    "jwt_locations": [
                        {"header": "header_value", "query": "query_value", "cookie": "cookie_value", "value_prefix": "value_prefix_value"}
                    ],
                }
            ],
        },
            ...
            "rules": [
                {
                    ...
                    "allowed_request_extensions": ["allowed_request_extensions_value1", "allowed_request_extensions_value2"],
                    "allowed_response_extensions": ["allowed_response_extensions_value1", "allowed_response_extensions_value2"],
                }
            ]
        },
        "usage": {
            "requirements": ["requirements_value1", "requirements_value2"],
            "rules": [{"selector": "selector_value", "allow_unregistered_calls": True, "skip_service_control": True}],
            "producer_notification_channel": "producer_notification_channel_value",
        },
        "endpoints": [{"name": "name_value", "aliases": ["aliases_value1", "aliases_value2"], "target": "target_value", "allow_cors": True}],
        "control": {
            ...
            "method_policies": [
                {
                    "selector": "selector_value",
                    "request_policies": [
                        {"selector": "selector_value", "resource_permission": "resource_permission_value", "resource_type": "resource_type_value"}
                    ],
                }
            ],
        },
        "logs": [
            {
                "name": "name_value",
                "labels": [{"key": "key_value", "value_type": 1, "description": "description_value"}],
                "description": "description_value",
                "display_name": "display_name_value",
            }
        ],
        "metrics": [
            {
                ...
                "launch_stage": 6,
                "monitored_resource_types": ["monitored_resource_types_value1", "monitored_resource_types_value2"],
            }
        ],
        "monitored_resources": [
            {
        ...
        "billing": {"consumer_destinations": [{"monitored_resource": "monitored_resource_value", "metrics": ["metrics_value1", "metrics_value2"]}]},
        "logging": {
            "producer_destinations": [{"monitored_resource": "monitored_resource_value", "logs": ["logs_value1", "logs_value2"]}],
            "consumer_destinations": {},
        },
        "monitoring": {
            "producer_destinations": [{"monitored_resource": "monitored_resource_value", "metrics": ["metrics_value1", "metrics_value2"]}],
            "consumer_destinations": {},
        },
        "system_parameters": {
            "rules": [
                {
                    "selector": "selector_value",
                    "parameters": [{"name": "name_value", "http_header": "http_header_value", "url_query_parameter": "url_query_parameter_value"}],
                }
            ]
        },
        ...
        "publishing": {
            ...
            "codeowner_github_teams": ["codeowner_github_teams_value1", "codeowner_github_teams_value2"],
            ...
            "library_settings": [
                {
                    ...
                    "java_settings": {
                        ...
                        "common": {
                            ...
                            "destinations": [10],
                            "selective_gapic_generation": {"methods": ["methods_value1", "methods_value2"], "generate_omitted_as_internal": True},
                        },
                    },
                    "cpp_settings": {"common": {}},
                    "php_settings": {"common": {}},
                    ...
                    "dotnet_settings": {
                        ...
                        "renamed_services": {},
                        "renamed_resources": {},
                        "ignored_resources": ["ignored_resources_value1", "ignored_resources_value2"],
                        "forced_namespace_aliases": ["forced_namespace_aliases_value1", "forced_namespace_aliases_value2"],
                        "handwritten_signatures": ["handwritten_signatures_value1", "handwritten_signatures_value2"],
                    },
...
def test_create_service_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_create_service_config") as post, mock.patch.object(
        transports.ServiceManagerRestInterceptor, "post_create_service_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_submit_config_source_rest_bad_request(request_type=servicemanager.SubmitConfigSourceRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_submit_config_source_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_submit_config_source_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ServiceManagerRestInterceptor, "post_submit_config_source_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_service_rollouts_rest_bad_request(request_type=servicemanager.ListServiceRolloutsRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_list_service_rollouts_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_service_rollouts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_list_service_rollouts") as post, mock.patch.object(
        transports.ServiceManagerRestInterceptor, "post_list_service_rollouts_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = servicemanager.ListServiceRolloutsResponse.to_json(servicemanager.ListServiceRolloutsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = servicemanager.ListServiceRolloutsResponse(), metadata
...
def test_get_service_rollout_rest_bad_request(request_type=servicemanager.GetServiceRolloutRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_get_service_rollout_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_service_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_get_service_rollout") as post, mock.patch.object(
        transports.ServiceManagerRestInterceptor, "post_get_service_rollout_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = resources.Rollout.to_json(resources.Rollout())
        req.return_value.content = return_value
...
def test_create_service_rollout_rest_bad_request(request_type=servicemanager.CreateServiceRolloutRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"service_name": "sample1"}
    request = request_type(**request_init)
...
def test_create_service_rollout_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_service_rollout_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ServiceManagerRestInterceptor, "post_create_service_rollout_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_generate_config_report_rest_bad_request(request_type=servicemanager.GenerateConfigReportRequest):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_generate_config_report_rest_call_success(request_type):
    client = ServiceManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_generate_config_report_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ServiceManagerRestInterceptor, "post_generate_config_report") as post, mock.patch.object(
        transports.ServiceManagerRestInterceptor, "post_generate_config_report_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = servicemanager.GenerateConfigReportResponse.to_json(servicemanager.GenerateConfigReportResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = servicemanager.GenerateConfigReportResponse(), metadata
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_undelete_service_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_service_configs_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_service_config_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_service_config_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_submit_config_source_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_service_rollouts_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_service_rollout_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_service_rollout_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_config_report_empty_call_rest():
    client = ServiceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
@pytest.mark.parametrize(
    ...
    [(transports.ServiceManagerGrpcTransport, grpc_helpers), (transports.ServiceManagerGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_service_manager_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "servicemanagement.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://servicemanagement.googleapis.com:8000"
    )

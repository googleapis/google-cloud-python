...
@pytest.mark.parametrize("request_type", [servicemanager.EnableServiceRequest, dict,])
...
@pytest.mark.parametrize("request_type", [servicemanager.DisableServiceRequest, dict,])

    ...
    class FileType(proto.Enum):
        ...
        Values:
            ...
            FILE_DESCRIPTOR_SET_PROTO (4):
                ...
                test.proto -o out.pb
            PROTO_FILE (6):
                Uncompiled Proto file. Used for storage and
                display purposes only, currently server-side
                compilation is not supported. Should match the
                inputs to 'protoc' command used to generated
                FILE_DESCRIPTOR_SET_PROTO. A file of this type
                can only be included if at least one file of
                type FILE_DESCRIPTOR_SET_PROTO is included.
        """
        FILE_TYPE_UNSPECIFIED = 0
        SERVICE_CONFIG_YAML = 1
        OPEN_API_JSON = 2
...
class ChangeReport(proto.Message):
    ...
    Attributes:
        config_changes (MutableSequence[google.api.config_change_pb2.ConfigChange]):
            ...
            configurations. The changes will be
            alphabetically sorted based on the identifier of
            each change.
            A ConfigChange identifier is a dot separated
            path to the configuration. Example:
...
class Rollout(proto.Message):
    ...
    class TrafficPercentStrategy(proto.Message):
        ...
        One example of how to gradually rollout a new service

...
class WorkflowsServiceV2BetaAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = WorkflowsServiceV2BetaClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = WorkflowsServiceV2BetaClient._DEFAULT_UNIVERSE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            WorkflowsServiceV2BetaClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(WorkflowsServiceV2BetaAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            WorkflowsServiceV2BetaClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            WorkflowsServiceV2BetaAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return WorkflowsServiceV2BetaClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,WorkflowsServiceV2BetaTransport,Callable[..., WorkflowsServiceV2BetaTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the WorkflowsServiceV2BetaTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaAsyncClient`.",
                extra={
        ...
        **Note:** Before you can use this method, the *Life Sciences
        ...
        .. code-block:: python
            ...
            async def sample_run_pipeline():
                ...
                # Make the request
                operation = await client.run_pipeline(request=request)

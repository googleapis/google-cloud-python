...
from google.cloud.lifesciences_v2beta._compat import transcode_request
from google.cloud.lifesciences_v2beta.types import workflows

from .base import DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
from .rest_base import _BaseWorkflowsServiceV2BetaRestTransport
...
class WorkflowsServiceV2BetaRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the WorkflowsServiceV2BetaRestTransport.
    ...
    def pre_run_pipeline(
        ...
        before they are sent to the WorkflowsServiceV2Beta server.
        """
        return request, metadata
    ...
    def post_run_pipeline(
        ...
        after it is returned by the WorkflowsServiceV2Beta server but before
        it is returned to user code. This `post_run_pipeline` interceptor runs
        before the `post_run_pipeline_with_metadata` interceptor.
        """
        return response
    ...
    def post_run_pipeline_with_metadata(
        ...
        is returned by the WorkflowsServiceV2Beta server but before it is returned to user code.

        We recommend only using this `post_run_pipeline_with_metadata`
        interceptor in new development instead of the `post_run_pipeline` interceptor.
        When both interceptors are used, this `post_run_pipeline_with_metadata` interceptor runs after the
        `post_run_pipeline` interceptor. The (possibly modified) response returned by
        `post_run_pipeline` will be passed to
        `post_run_pipeline_with_metadata`.
        """
...
class WorkflowsServiceV2BetaRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: WorkflowsServiceV2BetaRestInterceptor


class WorkflowsServiceV2BetaRestTransport(_BaseWorkflowsServiceV2BetaRestTransport):
    """REST backend synchronous transport for WorkflowsServiceV2Beta.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[WorkflowsServiceV2BetaRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[WorkflowsServiceV2BetaRestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or WorkflowsServiceV2BetaRestInterceptor()
        ...
        if self._operations_client is None:
            http_options: Dict[str, List[Dict[str, str]]] = {
                "google.longrunning.Operations.CancelOperation": [
                    {
                        "method": "post",
                        "uri": "/v2beta/{name=projects/*/locations/*/operations/*}:cancel",
                        "body": "*",
                    },
                ],
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseWorkflowsServiceV2BetaRestTransport._BaseRunPipeline,
                    "_BaseRunPipeline__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.RunPipeline",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.run_pipeline",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
                        "rpcName": "RunPipeline",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.lifesciences_v2beta.WorkflowsServiceV2BetaAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
...
__all__ = ("WorkflowsServiceV2BetaRestTransport",)

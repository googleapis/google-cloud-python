...
from .base import DEFAULT_CLIENT_INFO, WorkflowsServiceV2BetaTransport
...
class WorkflowsServiceV2BetaGrpcTransport(WorkflowsServiceV2BetaTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            host (Optional[str]):
                 The hostname to connect to (default: 'lifesciences.googleapis.com').
    ...
    def run_pipeline(
        ...
        **Note:** Before you can use this method, the *Life Sciences
        ...
        if "run_pipeline" not in self._stubs:
            self._stubs["run_pipeline"] = self._logged_channel.unary_unary(

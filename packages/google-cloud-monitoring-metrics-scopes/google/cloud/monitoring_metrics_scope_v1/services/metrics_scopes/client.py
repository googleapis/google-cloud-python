...
class MetricsScopesClient(metaclass=MetricsScopesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = MetricsScopesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = MetricsScopesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = MetricsScopesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = MetricsScopesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or MetricsScopesClient._get_api_endpoint(

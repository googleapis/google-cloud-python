...
class MetricsScopesGrpcAsyncIOTransport(MetricsScopesTransport):
    ...
    @property
    def get_metrics_scope(self) -> Callable[[metrics_scopes.GetMetricsScopeRequest], Awaitable[metrics_scope.MetricsScope]]:
    ...
    def list_metrics_scopes_by_monitored_project(
        self,
    ) -> Callable[[metrics_scopes.ListMetricsScopesByMonitoredProjectRequest], Awaitable[metrics_scopes.ListMetricsScopesByMonitoredProjectResponse]]:
    ...
    @property
    def create_monitored_project(self) -> Callable[[metrics_scopes.CreateMonitoredProjectRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_monitored_project(self) -> Callable[[metrics_scopes.DeleteMonitoredProjectRequest], Awaitable[operations_pb2.Operation]]:

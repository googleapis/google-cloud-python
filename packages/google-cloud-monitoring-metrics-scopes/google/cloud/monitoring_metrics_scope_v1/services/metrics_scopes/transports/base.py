...
class MetricsScopesTransport(abc.ABC):
    ...
    def get_metrics_scope(
        self,
    ) -> Callable[[metrics_scopes.GetMetricsScopeRequest], Union[metrics_scope.MetricsScope, Awaitable[metrics_scope.MetricsScope]]]:
        raise NotImplementedError()
    ...
    def list_metrics_scopes_by_monitored_project(
        ...
        Union[metrics_scopes.ListMetricsScopesByMonitoredProjectResponse, Awaitable[metrics_scopes.ListMetricsScopesByMonitoredProjectResponse]],
    ]:
        raise NotImplementedError()
    ...
    def create_monitored_project(
        self,
    ) -> Callable[[metrics_scopes.CreateMonitoredProjectRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def delete_monitored_project(
        self,
    ) -> Callable[[metrics_scopes.DeleteMonitoredProjectRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
...
__all__ = ("MetricsScopesTransport",)

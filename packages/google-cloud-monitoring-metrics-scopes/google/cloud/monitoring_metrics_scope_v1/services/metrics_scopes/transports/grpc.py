...
class MetricsScopesGrpcTransport(MetricsScopesTransport):
    ...
    def get_metrics_scope(
        self,
    ) -> Callable[[metrics_scopes.GetMetricsScopeRequest], metrics_scope.MetricsScope]:
    ...
    def create_monitored_project(
        ...
        [metrics_scopes.CreateMonitoredProjectRequest], operations_pb2.Operation
    ]:
    ...
    def delete_monitored_project(
        ...
        [metrics_scopes.DeleteMonitoredProjectRequest], operations_pb2.Operation
    ]:

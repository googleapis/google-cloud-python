...
class MetricsScopesGrpcTransport(MetricsScopesTransport):
    """gRPC backend transport for MetricsScopes.
    ...
    @property
    def get_metrics_scope(self) -> Callable[[metrics_scopes.GetMetricsScopeRequest], metrics_scope.MetricsScope]:
        ...
        if "get_metrics_scope" not in self._stubs:
            self._stubs["get_metrics_scope"] = self._logged_channel.unary_unary(
    ...
    def list_metrics_scopes_by_monitored_project(
        self,
    ) -> Callable[[metrics_scopes.ListMetricsScopesByMonitoredProjectRequest], metrics_scopes.ListMetricsScopesByMonitoredProjectResponse]:
        ...
        if "list_metrics_scopes_by_monitored_project" not in self._stubs:
            self._stubs["list_metrics_scopes_by_monitored_project"] = self._logged_channel.unary_unary(
    ...
    @property
    def create_monitored_project(self) -> Callable[[metrics_scopes.CreateMonitoredProjectRequest], operations_pb2.Operation]:
        ...
        if "create_monitored_project" not in self._stubs:
            self._stubs["create_monitored_project"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_monitored_project(self) -> Callable[[metrics_scopes.DeleteMonitoredProjectRequest], operations_pb2.Operation]:
        ...
        if "delete_monitored_project" not in self._stubs:
            self._stubs["delete_monitored_project"] = self._logged_channel.unary_unary(

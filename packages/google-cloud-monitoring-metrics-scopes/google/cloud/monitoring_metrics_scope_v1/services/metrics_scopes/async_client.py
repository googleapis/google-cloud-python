...
class MetricsScopesAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = MetricsScopesClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    parse_metrics_scope_path = staticmethod(MetricsScopesClient.parse_metrics_scope_path)
    monitored_project_path = staticmethod(MetricsScopesClient.monitored_project_path)
    parse_monitored_project_path = staticmethod(MetricsScopesClient.parse_monitored_project_path)
    common_billing_account_path = staticmethod(MetricsScopesClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(MetricsScopesClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(MetricsScopesClient.common_folder_path)
    parse_common_folder_path = staticmethod(MetricsScopesClient.parse_common_folder_path)
    common_organization_path = staticmethod(MetricsScopesClient.common_organization_path)
    parse_common_organization_path = staticmethod(MetricsScopesClient.parse_common_organization_path)
    common_project_path = staticmethod(MetricsScopesClient.common_project_path)
    parse_common_project_path = staticmethod(MetricsScopesClient.parse_common_project_path)
    common_location_path = staticmethod(MetricsScopesClient.common_location_path)
    parse_common_location_path = staticmethod(MetricsScopesClient.parse_common_location_path)
    ...
    get_transport_class = MetricsScopesClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, MetricsScopesTransport, Callable[..., MetricsScopesTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.monitoring.metricsscope_v1.MetricsScopesAsyncClient`.",
                extra={
    ...
    async def get_metrics_scope(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_metrics_scope]
    ...
    async def list_metrics_scopes_by_monitored_project(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_metrics_scopes_by_monitored_project]
    ...
    async def create_monitored_project(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_monitored_project]
    ...
    async def delete_monitored_project(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_monitored_project]

...
class VehicleServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[VehicleServiceTransport]]
...
class VehicleServiceClient(metaclass=VehicleServiceClientMeta):
    ...
    def vehicle_path(
        ...
        return "providers/{provider}/vehicles/{vehicle}".format(
            provider=provider,
            vehicle=vehicle,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = VehicleServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = VehicleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = VehicleServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or VehicleServiceClient._get_api_endpoint(

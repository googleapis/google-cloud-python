...
class VehicleServiceTransport(abc.ABC):
    ...
    @property
    def create_vehicle(self) -> Callable[[vehicle_api.CreateVehicleRequest], Union[vehicles.Vehicle, Awaitable[vehicles.Vehicle]]]:
        raise NotImplementedError()

    @property
    def get_vehicle(self) -> Callable[[vehicle_api.GetVehicleRequest], Union[vehicles.Vehicle, Awaitable[vehicles.Vehicle]]]:
        raise NotImplementedError()

    @property
    def delete_vehicle(self) -> Callable[[vehicle_api.DeleteVehicleRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def update_vehicle(self) -> Callable[[vehicle_api.UpdateVehicleRequest], Union[vehicles.Vehicle, Awaitable[vehicles.Vehicle]]]:
        raise NotImplementedError()
    ...
    def update_vehicle_attributes(
        ...
        Union[vehicle_api.UpdateVehicleAttributesResponse, Awaitable[vehicle_api.UpdateVehicleAttributesResponse]],
    ]:
        raise NotImplementedError()
    ...
    def list_vehicles(
        self,
    ) -> Callable[[vehicle_api.ListVehiclesRequest], Union[vehicle_api.ListVehiclesResponse, Awaitable[vehicle_api.ListVehiclesResponse]]]:
        raise NotImplementedError()

    @property
    def search_vehicles(
        self,
    ) -> Callable[[vehicle_api.SearchVehiclesRequest], Union[vehicle_api.SearchVehiclesResponse, Awaitable[vehicle_api.SearchVehiclesResponse]]]:
        raise NotImplementedError()

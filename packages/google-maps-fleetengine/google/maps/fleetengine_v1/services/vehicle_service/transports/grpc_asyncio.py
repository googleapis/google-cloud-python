...
class VehicleServiceGrpcAsyncIOTransport(VehicleServiceTransport):
    ...
    @property
    def create_vehicle(self) -> Callable[[vehicle_api.CreateVehicleRequest], Awaitable[vehicles.Vehicle]]:
    ...
    @property
    def get_vehicle(self) -> Callable[[vehicle_api.GetVehicleRequest], Awaitable[vehicles.Vehicle]]:
    ...
    @property
    def delete_vehicle(self) -> Callable[[vehicle_api.DeleteVehicleRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def update_vehicle(self) -> Callable[[vehicle_api.UpdateVehicleRequest], Awaitable[vehicles.Vehicle]]:
    ...
    def update_vehicle_attributes(
        self,
    ) -> Callable[[vehicle_api.UpdateVehicleAttributesRequest], Awaitable[vehicle_api.UpdateVehicleAttributesResponse]]:
    ...
    @property
    def list_vehicles(self) -> Callable[[vehicle_api.ListVehiclesRequest], Awaitable[vehicle_api.ListVehiclesResponse]]:
    ...
    @property
    def search_vehicles(self) -> Callable[[vehicle_api.SearchVehiclesRequest], Awaitable[vehicle_api.SearchVehiclesResponse]]:

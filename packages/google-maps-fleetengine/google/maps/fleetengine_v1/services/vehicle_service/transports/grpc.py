...
class VehicleServiceGrpcTransport(VehicleServiceTransport):
    ...
    @property
    def create_vehicle(self) -> Callable[[vehicle_api.CreateVehicleRequest], vehicles.Vehicle]:
    ...
    @property
    def get_vehicle(self) -> Callable[[vehicle_api.GetVehicleRequest], vehicles.Vehicle]:
    ...
    @property
    def delete_vehicle(self) -> Callable[[vehicle_api.DeleteVehicleRequest], empty_pb2.Empty]:
    ...
    @property
    def update_vehicle(self) -> Callable[[vehicle_api.UpdateVehicleRequest], vehicles.Vehicle]:
    ...
    @property
    def update_vehicle_attributes(self) -> Callable[[vehicle_api.UpdateVehicleAttributesRequest], vehicle_api.UpdateVehicleAttributesResponse]:
    ...
    @property
    def list_vehicles(self) -> Callable[[vehicle_api.ListVehiclesRequest], vehicle_api.ListVehiclesResponse]:
    ...
    @property
    def search_vehicles(self) -> Callable[[vehicle_api.SearchVehiclesRequest], vehicle_api.SearchVehiclesResponse]:

...
class SearchTripsPager:
    ...
    :class:`google.maps.fleetengine_v1.types.SearchTripsResponse` object, and
    ...
    All the usual :class:`google.maps.fleetengine_v1.types.SearchTripsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.maps.fleetengine_v1.types.SearchTripsRequest):
                The initial request object.
            response (google.maps.fleetengine_v1.types.SearchTripsResponse):

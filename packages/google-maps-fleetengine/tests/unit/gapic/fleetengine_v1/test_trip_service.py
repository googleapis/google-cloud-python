...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert TripServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert TripServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert TripServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TripServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert TripServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert TripServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(TripServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TripServiceClient))
@mock.patch.object(TripServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TripServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TripServiceClient._DEFAULT_UNIVERSE
    default_endpoint = TripServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = TripServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert TripServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert TripServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == TripServiceClient.DEFAULT_MTLS_ENDPOINT
    assert TripServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert TripServiceClient._get_api_endpoint(None, None, default_universe, "always") == TripServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert TripServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert TripServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        TripServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert TripServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert TripServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert TripServiceClient._get_universe_domain(None, None) == TripServiceClient._DEFAULT_UNIVERSE
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = TripServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TripServiceAsyncClient, transports.TripServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    ],
)
@mock.patch.object(TripServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TripServiceClient))
@mock.patch.object(TripServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TripServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TripServiceAsyncClient, transports.TripServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (TripServiceClient, transports.TripServiceGrpcTransport, "grpc", "false"),
        (TripServiceAsyncClient, transports.TripServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    ],
)
@mock.patch.object(TripServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TripServiceClient))
@mock.patch.object(TripServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TripServiceAsyncClient))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TripServiceAsyncClient, transports.TripServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    ],
)
...
@pytest.mark.asyncio
async def test_create_trip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_trip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_trip] = mock_rpc
...
async def test_get_trip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_trip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_trip] = mock_rpc
...
def test_delete_trip(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        ...
        response = client.delete_trip(request)

        # Establish that the underlying gRPC stub method was called.
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        request = trip_api.DeleteTripRequest()
        assert args[0] == request
...
def test_delete_trip_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_trip_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_trip in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_trip] = mock_rpc
        request = {}
        client.delete_trip(request)
...
@pytest.mark.asyncio
async def test_delete_trip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TripServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_trip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_trip] = mock_rpc

        request = {}
        await client.delete_trip(request)
...
@pytest.mark.asyncio
async def test_delete_trip_async(transport: str = "grpc_asyncio", request_type=trip_api.DeleteTripRequest):
    client = TripServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        ...
        response = await client.delete_trip(request)
...
def test_delete_trip_flattened_error():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_trip_flattened_async():
    client = TripServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_trip(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_trip_flattened_error_async():
    client = TripServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_report_billable_trip_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.report_billable_trip in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.report_billable_trip] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_report_billable_trip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TripServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.report_billable_trip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.report_billable_trip] = mock_rpc
...
@pytest.mark.asyncio
async def test_search_trips_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TripServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_trips in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_trips] = mock_rpc
...
async def test_search_trips_async_pages():
    ...
    with mock.patch.object(type(client.transport.search_trips), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.search_trips(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_update_trip_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = TripServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_trip in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_trip] = mock_rpc
...
def test_transport_kind_grpc():
    transport = TripServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_trip_empty_call_grpc():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        call.return_value = None
        client.delete_trip(request=None)
...
def test_delete_trip_routing_parameters_request_1_grpc():
    client = TripServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        call.return_value = None
        client.delete_trip(request={"name": "providers/sample1"})
...
def test_report_billable_trip_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(type(client.transport.report_billable_trip), "__call__") as call:
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = trip_api.ReportBillableTripRequest(**{"name": "providers/sample1"})
...
def test_transport_kind_grpc_asyncio():
    transport = TripServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = TripServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_trip_empty_call_grpc_asyncio():
    client = TripServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_trip(request=None)
...
@pytest.mark.asyncio
async def test_delete_trip_routing_parameters_request_1_grpc_asyncio():
    client = TripServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.delete_trip), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        await client.delete_trip(request={"name": "providers/sample1"})
...
@pytest.mark.parametrize(
    ...
    [(transports.TripServiceGrpcTransport, grpc_helpers), (transports.TripServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

...
class GkeHubAsyncClient:
    ...
    **Membership management may be non-trivial:** it is recommended to
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = GkeHubClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(GkeHubAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            GkeHubAsyncClient: The constructed client.
        """
        sa_file_func = GkeHubClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(GkeHubAsyncClient, filename, *args, **kwargs)

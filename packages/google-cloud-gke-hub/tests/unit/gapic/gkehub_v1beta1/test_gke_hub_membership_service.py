...
def test_validate_exclusivity_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.validate_exclusivity
        ] = mock_rpc
        request = {}
...
def test_create_membership_rest_bad_request(
    transport: str = "rest", request_type=membership.CreateMembershipRequest
):
    client = GkeHubMembershipServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_membership_rest_bad_request(
    transport: str = "rest", request_type=membership.UpdateMembershipRequest
):
    client = GkeHubMembershipServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_generate_connect_manifest_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = membership.GenerateConnectManifestResponse.to_json(
            membership.GenerateConnectManifestResponse()
        )
...
def test_generate_connect_manifest_rest_bad_request(
    transport: str = "rest", request_type=membership.GenerateConnectManifestRequest
):
    client = GkeHubMembershipServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_validate_exclusivity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = membership.ValidateExclusivityResponse.to_json(
            membership.ValidateExclusivityResponse()
        )
...
def test_validate_exclusivity_rest_bad_request(
    transport: str = "rest", request_type=membership.ValidateExclusivityRequest
):
    client = GkeHubMembershipServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_generate_exclusivity_manifest_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = (
            membership.GenerateExclusivityManifestResponse.to_json(
                membership.GenerateExclusivityManifestResponse()
            )
        )
...
def test_generate_exclusivity_manifest_rest_bad_request(
    transport: str = "rest", request_type=membership.GenerateExclusivityManifestRequest
):
    client = GkeHubMembershipServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

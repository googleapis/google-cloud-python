...
def test_generate_connect_manifest_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateConnectManifest,
...
def test_validate_exclusivity_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseValidateExclusivity,
        "_BaseValidateExclusivity__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_generate_exclusivity_manifest_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateExclusivityManifest,
        "_BaseGenerateExclusivityManifest__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GkeHubMembershipServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert GkeHubMembershipServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert GkeHubMembershipServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                GkeHubMembershipServiceClient._use_client_cert_effective()
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    GkeHubMembershipServiceClient._use_client_cert_effective() is False
                )
...
def test_gke_hub_membership_service_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_gke_hub_membership_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_validate_exclusivity_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.validate_exclusivity in client._transport._wrapped_methods
        )
        ...
        client._transport._wrapped_methods[client._transport.validate_exclusivity] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_validate_exclusivity_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.validate_exclusivity
            in client._client._transport._wrapped_methods
        )
...
def test_generate_exclusivity_manifest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.generate_exclusivity_manifest
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_generate_exclusivity_manifest_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.generate_exclusivity_manifest
            in client._client._transport._wrapped_methods
        )
...
def test_list_memberships_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{parent=projects/*/locations/*}/memberships"
...
def test_get_membership_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/memberships/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_membership_rest_required_fields(
    request_type=membership.CreateMembershipRequest,
):
    transport_class = transports.GkeHubMembershipServiceRestTransport
...
def test_update_membership_rest_required_fields(
    request_type=membership.UpdateMembershipRequest,
):
    transport_class = transports.GkeHubMembershipServiceRestTransport
...
def test_validate_exclusivity_rest_required_fields(
    request_type=membership.ValidateExclusivityRequest,
):
    transport_class = transports.GkeHubMembershipServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).validate_exclusivity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present
    assert "intendedMembership" in jsonified_request
    assert (
        jsonified_request["intendedMembership"] == request_init["intended_membership"]
    )
...
def test_generate_exclusivity_manifest_rest_required_fields(
    request_type=membership.GenerateExclusivityManifestRequest,
):
    transport_class = transports.GkeHubMembershipServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).generate_exclusivity_manifest._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_memberships_rest_interceptors(null_interceptor):
    transport = transports.GkeHubMembershipServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.GkeHubMembershipServiceRestInterceptor(),
    )
    client = GkeHubMembershipServiceClient(transport=transport)
...
def test_generate_connect_manifest_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = membership.GenerateConnectManifestResponse.to_json(
            membership.GenerateConnectManifestResponse()
        )
        req.return_value.content = return_value
...
def test_validate_exclusivity_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = membership.ValidateExclusivityResponse.to_json(
            membership.ValidateExclusivityResponse()
        )
        req.return_value.content = return_value
...
def test_generate_exclusivity_manifest_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = membership.GenerateExclusivityManifestResponse.to_json(
            membership.GenerateExclusivityManifestResponse()
        )
        req.return_value.content = return_value
...
def test_get_iam_policy_rest_bad_request(
    ...
    request = request_type()
    request = json_format.ParseDict(
        {"resource": "projects/sample1/locations/sample2/memberships/sample3"}, request
    )
...
def test_get_iam_policy_rest(request_type):
    ...
    request_init = {
        "resource": "projects/sample1/locations/sample2/memberships/sample3"
    }
    request = request_type(**request_init)
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:

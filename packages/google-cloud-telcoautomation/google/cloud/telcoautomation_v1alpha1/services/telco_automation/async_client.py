...
from google.cloud.telcoautomation_v1alpha1.services.telco_automation import pagers
...
class TelcoAutomationAsyncClient:
    ...
    hydrated_deployment_path = staticmethod(TelcoAutomationClient.hydrated_deployment_path)
    parse_hydrated_deployment_path = staticmethod(TelcoAutomationClient.parse_hydrated_deployment_path)
    orchestration_cluster_path = staticmethod(TelcoAutomationClient.orchestration_cluster_path)
    parse_orchestration_cluster_path = staticmethod(TelcoAutomationClient.parse_orchestration_cluster_path)
    public_blueprint_path = staticmethod(TelcoAutomationClient.public_blueprint_path)
    parse_public_blueprint_path = staticmethod(TelcoAutomationClient.parse_public_blueprint_path)
    common_billing_account_path = staticmethod(TelcoAutomationClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(TelcoAutomationClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(TelcoAutomationClient.common_folder_path)
    parse_common_folder_path = staticmethod(TelcoAutomationClient.parse_common_folder_path)
    common_organization_path = staticmethod(TelcoAutomationClient.common_organization_path)
    parse_common_organization_path = staticmethod(TelcoAutomationClient.parse_common_organization_path)
    common_project_path = staticmethod(TelcoAutomationClient.common_project_path)
    parse_common_project_path = staticmethod(TelcoAutomationClient.parse_common_project_path)
    common_location_path = staticmethod(TelcoAutomationClient.common_location_path)
    parse_common_location_path = staticmethod(TelcoAutomationClient.parse_common_location_path)
    ...
    get_transport_class = TelcoAutomationClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, TelcoAutomationTransport, Callable[..., TelcoAutomationTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.telcoautomation_v1alpha1.TelcoAutomationAsyncClient`.",
                extra={
    ...
    async def list_orchestration_clusters(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListOrchestrationClustersRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_orchestration_clusters]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_orchestration_cluster():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.GetOrchestrationClusterRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.GetOrchestrationClusterRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.OrchestrationCluster:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_orchestration_cluster]
    ...
    async def create_orchestration_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.CreateOrchestrationClusterRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            orchestration_cluster (:class:`google.cloud.telcoautomation_v1alpha1.types.OrchestrationCluster`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.telcoautomation_v1alpha1.types.OrchestrationCluster` Orchestration cluster represents a GKE cluster with config controller and
                   TNA specific components installed on it.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_orchestration_cluster]
    ...
    async def delete_orchestration_cluster(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.DeleteOrchestrationClusterRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_orchestration_cluster]
    ...
    async def list_edge_slms(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListEdgeSlmsRequest, dict]]):
                The request object. Message for requesting list of
                EdgeSlms
            parent (:class:`str`):
                Required. Parent value for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_edge_slms]
    ...
    async def get_edge_slm(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.GetEdgeSlmRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.EdgeSlm:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_edge_slm]
    ...
    async def create_edge_slm(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.CreateEdgeSlmRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            edge_slm (:class:`google.cloud.telcoautomation_v1alpha1.types.EdgeSlm`):
                Required. The resource being created
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.telcoautomation_v1alpha1.types.EdgeSlm` EdgeSlm represents an SLM instance which manages the lifecycle of edge
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_edge_slm]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_edge_slm():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.DeleteEdgeSlmRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.DeleteEdgeSlmRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_edge_slm]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_blueprint():
                ...
                request = telcoautomation_v1alpha1.CreateBlueprintRequest(
                    parent="parent_value",
                    blueprint=blueprint,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.CreateBlueprintRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            blueprint (:class:`google.cloud.telcoautomation_v1alpha1.types.Blueprint`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_blueprint]
    ...
    async def update_blueprint(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.UpdateBlueprintRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_blueprint]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("blueprint.name", request.blueprint.name),)),)
    ...
    async def get_blueprint(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.GetBlueprintRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_blueprint]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_blueprint():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.DeleteBlueprintRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.DeleteBlueprintRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_blueprint]
    ...
    async def list_blueprints(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListBlueprintsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_blueprints]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_approve_blueprint():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.ApproveBlueprintRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ApproveBlueprintRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.approve_blueprint]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_propose_blueprint():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.ProposeBlueprintRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ProposeBlueprintRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.propose_blueprint]
    ...
    async def reject_blueprint(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.RejectBlueprintRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reject_blueprint]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_blueprint_revisions():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.ListBlueprintRevisionsRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListBlueprintRevisionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_blueprint_revisions]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_search_blueprint_revisions():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.SearchBlueprintRevisionsRequest(
                    parent="parent_value",
                    query="query_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.SearchBlueprintRevisionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_blueprint_revisions]
    ...
    async def search_deployment_revisions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.SearchDeploymentRevisionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_deployment_revisions]
    ...
    async def discard_blueprint_changes(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.DiscardBlueprintChangesRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.DiscardBlueprintChangesResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.discard_blueprint_changes]
    ...
    async def list_public_blueprints(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListPublicBlueprintsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_public_blueprints]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_public_blueprint():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.GetPublicBlueprintRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.GetPublicBlueprintRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.PublicBlueprint:
                A Blueprint contains a collection of
                kubernetes resources in the form of YAML
                files. The file contents of a blueprint
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_public_blueprint]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_deployment():
                ...
                request = telcoautomation_v1alpha1.CreateDeploymentRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.CreateDeploymentRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            deployment (:class:`google.cloud.telcoautomation_v1alpha1.types.Deployment`):
    ...
    async def update_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.UpdateDeploymentRequest, dict]]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_deployment():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.GetDeploymentRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.GetDeploymentRequest, dict]]):
    ...
    async def remove_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.RemoveDeploymentRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_deployment]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_deployments():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.ListDeploymentsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListDeploymentsRequest, dict]]):
    ...
    async def list_deployment_revisions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListDeploymentRevisionsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_deployment_revisions]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_discard_deployment_changes():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.DiscardDeploymentChangesRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.DiscardDeploymentChangesRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.DiscardDeploymentChangesResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.discard_deployment_changes]
    ...
    async def apply_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ApplyDeploymentRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.apply_deployment]
    ...
    async def compute_deployment_status(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ComputeDeploymentStatusRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.ComputeDeploymentStatusResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_deployment_status]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_rollback_deployment():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.RollbackDeploymentRequest(
                    name="name_value",
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.RollbackDeploymentRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.rollback_deployment]
    ...
    async def get_hydrated_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.GetHydratedDeploymentRequest, dict]]):
        ...
        Returns:
            google.cloud.telcoautomation_v1alpha1.types.HydratedDeployment:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_hydrated_deployment]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_hydrated_deployments():
                ...
                # Initialize request argument(s)
                request = telcoautomation_v1alpha1.ListHydratedDeploymentsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ListHydratedDeploymentsRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_hydrated_deployments]
    ...
    async def update_hydrated_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.UpdateHydratedDeploymentRequest, dict]]):
                The request object. Request object for ``UpdateHydratedDeployment``.
            hydrated_deployment (:class:`google.cloud.telcoautomation_v1alpha1.types.HydratedDeployment`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_hydrated_deployment]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("hydrated_deployment.name", request.hydrated_deployment.name),)),)
    ...
    async def apply_hydrated_deployment(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.telcoautomation_v1alpha1.types.ApplyHydratedDeploymentRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.apply_hydrated_deployment]

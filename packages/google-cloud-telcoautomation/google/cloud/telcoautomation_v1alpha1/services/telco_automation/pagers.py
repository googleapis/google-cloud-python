...
class ListOrchestrationClustersPager:
    ...
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListOrchestrationClustersResponse` object, and
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListOrchestrationClustersResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.telcoautomation_v1alpha1.types.ListOrchestrationClustersRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.ListOrchestrationClustersResponse):
...
class ListEdgeSlmsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListEdgeSlmsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``edge_slms`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListEdgeSlmsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.ListEdgeSlmsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.ListEdgeSlmsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListBlueprintsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListBlueprintsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``blueprints`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListBlueprintsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.ListBlueprintsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.ListBlueprintsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListBlueprintRevisionsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListBlueprintRevisionsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``blueprints`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListBlueprintRevisionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
...
class SearchBlueprintRevisionsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.SearchBlueprintRevisionsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``blueprints`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.SearchBlueprintRevisionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.SearchBlueprintRevisionsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.SearchBlueprintRevisionsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class SearchDeploymentRevisionsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.SearchDeploymentRevisionsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``deployments`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.SearchDeploymentRevisionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.SearchDeploymentRevisionsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.SearchDeploymentRevisionsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListPublicBlueprintsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListPublicBlueprintsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListPublicBlueprintsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
...
class ListDeploymentsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListDeploymentsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``deployments`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListDeploymentsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.ListDeploymentsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.ListDeploymentsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListDeploymentRevisionsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListDeploymentRevisionsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``deployments`` field.
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListDeploymentRevisionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.ListDeploymentRevisionsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.ListDeploymentRevisionsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListHydratedDeploymentsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.telcoautomation_v1alpha1.types.ListHydratedDeploymentsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.telcoautomation_v1alpha1.types.ListHydratedDeploymentsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.telcoautomation_v1alpha1.types.ListHydratedDeploymentsRequest):
                The initial request object.
            response (google.cloud.telcoautomation_v1alpha1.types.ListHydratedDeploymentsResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.

...
class TelcoAutomationRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_delete_blueprint_revision(
        self,
        request: telcoautomation.DeleteBlueprintRevisionRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[
        telcoautomation.DeleteBlueprintRevisionRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def post_delete_blueprint_revision(
        self, response: telcoautomation.Blueprint
    ) -> telcoautomation.Blueprint:
    ...
    def pre_delete_deployment(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[telcoautomation.DeleteDeploymentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_deployment_revision(
        self,
        request: telcoautomation.DeleteDeploymentRevisionRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[
        telcoautomation.DeleteDeploymentRevisionRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def post_delete_deployment_revision(
        self, response: telcoautomation.Deployment
    ) -> telcoautomation.Deployment:
    ...
    class _DeleteBlueprintRevision(TelcoAutomationRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_delete_blueprint_revision(
                request, metadata
            )
    ...
    class _DeleteDeploymentRevision(TelcoAutomationRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_delete_deployment_revision(
                request, metadata
            )

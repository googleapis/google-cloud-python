...
class IAMConnectorCredentialsServiceTransport(abc.ABC):
    """Abstract transport class for IAMConnectorCredentialsService."""

    AUTH_SCOPES = ("https://www.googleapis.com/auth/cloud-platform",)

    DEFAULT_HOST: str = "iamconnectorcredentials.googleapis.com"
...
__all__ = ("IAMConnectorCredentialsServiceTransport",)

...
from .rest_base import _BaseIAMConnectorCredentialsServiceRestTransport
...
class IAMConnectorCredentialsServiceRestInterceptor:
    """Interceptor for IAMConnectorCredentialsService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the IAMConnectorCredentialsServiceRestTransport.

    .. code-block:: python
        class MyCustomIAMConnectorCredentialsServiceInterceptor(IAMConnectorCredentialsServiceRestInterceptor):
        ...
        transport = IAMConnectorCredentialsServiceRestTransport(interceptor=MyCustomIAMConnectorCredentialsServiceInterceptor())
    ...
    def pre_finalize_credentials(
        ...
        before they are sent to the IAMConnectorCredentialsService server.
        """
        return request, metadata

    def post_finalize_credentials(
        self, response: connector_credentials.FinalizeCredentialsResponse
        ...
        after it is returned by the IAMConnectorCredentialsService server but before
    ...
    def post_finalize_credentials_with_metadata(
        self,
        response: connector_credentials.FinalizeCredentialsResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        connector_credentials.FinalizeCredentialsResponse,
        Sequence[Tuple[str, Union[str, bytes]]],
        ...
        is returned by the IAMConnectorCredentialsService server but before it is returned to user code.
...
class IAMConnectorCredentialsServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: IAMConnectorCredentialsServiceRestInterceptor


class IAMConnectorCredentialsServiceRestTransport(
    _BaseIAMConnectorCredentialsServiceRestTransport
):
    """REST backend synchronous transport for IAMConnectorCredentialsService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[IAMConnectorCredentialsServiceRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[IAMConnectorCredentialsServiceRestInterceptor]): Interceptor used
        ...
        self._interceptor = (
            interceptor or IAMConnectorCredentialsServiceRestInterceptor()
        )
    ...
    class _FinalizeCredentials(
        ...
        IAMConnectorCredentialsServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "IAMConnectorCredentialsServiceRestTransport.FinalizeCredentials"
            )
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.iamconnectorcredentials_v1alpha.IAMConnectorCredentialsServiceClient.FinalizeCredentials",
                    extra={
            ...
            # Send the request
            response = IAMConnectorCredentialsServiceRestTransport._FinalizeCredentials._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = connector_credentials.FinalizeCredentialsResponse()
            pb_resp = connector_credentials.FinalizeCredentialsResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = (
                        connector_credentials.FinalizeCredentialsResponse.to_json(
                            response
                        )
                    )
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.iamconnectorcredentials_v1alpha.IAMConnectorCredentialsServiceClient.finalize_credentials",
                    extra={
                        "serviceName": "google.cloud.iamconnectorcredentials.v1alpha.IAMConnectorCredentialsService",
                        "rpcName": "FinalizeCredentials",
    ...
    class _RetrieveCredentials(
        ...
        def __hash__(self):
            return hash(
                "IAMConnectorCredentialsServiceRestTransport.RetrieveCredentials"
            )
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.iamconnectorcredentials_v1alpha.IAMConnectorCredentialsServiceClient.RetrieveCredentials",
                    extra={
                        "serviceName": "google.cloud.iamconnectorcredentials.v1alpha.IAMConnectorCredentialsService",
            ...
            # Send the request
            response = IAMConnectorCredentialsServiceRestTransport._RetrieveCredentials._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.iamconnectorcredentials_v1alpha.IAMConnectorCredentialsServiceClient.retrieve_credentials",
                    extra={
                        "serviceName": "google.cloud.iamconnectorcredentials.v1alpha.IAMConnectorCredentialsService",
                        "rpcName": "RetrieveCredentials",
                        "metadata": http_response["headers"],
...
__all__ = ("IAMConnectorCredentialsServiceRestTransport",)

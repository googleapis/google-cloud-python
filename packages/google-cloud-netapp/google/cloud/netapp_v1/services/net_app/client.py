...
class NetAppClient(metaclass=NetAppClientMeta):
    ...
    def parse_active_directory_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/activeDirectories/(?P<active_directory>.+?)$", path)
    ...
    def parse_backup_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupVaults/(?P<backup_vault>.+?)/backups/(?P<backup>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_backup_policy_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupPolicies/(?P<backup_policy>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_backup_vault_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/backupVaults/(?P<backup_vault>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_kms_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/kmsConfigs/(?P<kms_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def quota_rule_path(
        ...
        """Returns a fully-qualified quota_rule string."""
        return "projects/{project}/locations/{location}/volumes/{volume}/quotaRules/{quota_rule}".format(
            project=project,
            location=location,
            volume=volume,
    ...
    @staticmethod
    def parse_quota_rule_path(path: str) -> Dict[str, str]:
        """Parses a quota_rule path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/volumes/(?P<volume>.+?)/quotaRules/(?P<quota_rule>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_replication_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/volumes/(?P<volume>.+?)/replications/(?P<replication>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_storage_pool_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/storagePools/(?P<storage_pool>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = NetAppClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, NetAppTransport, Callable[..., NetAppTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = NetAppClient._read_environment_variables()
        self._client_cert_source = NetAppClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = NetAppClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[NetAppTransport], Callable[..., NetAppTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.netapp_v1.NetAppClient`.",
                    extra={
    ...
    def update_storage_pool(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("storage_pool.name", request.storage_pool.name),)),)
    ...
    def validate_directory_service(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.validate_directory_service]
    ...
    def switch_active_replica_zone(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.switch_active_replica_zone]
    ...
    def update_active_directory(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("active_directory.name", request.active_directory.name),)),)
    ...
    def update_kms_config(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("kms_config.name", request.kms_config.name),)),)
    ...
    def update_replication(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("replication.name", request.replication.name),)),)
    ...
    def reverse_replication_direction(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reverse_replication_direction]
    ...
    def establish_peering(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.EstablishPeeringRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.establish_peering]
    ...
    def sync_replication(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.SyncReplicationRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.sync_replication]
    ...
    def update_backup_policy(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("backup_policy.name", request.backup_policy.name),)),)
    ...
    def list_quota_rules(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.ListQuotaRulesRequest, dict]):
        ...
        Returns:
            google.cloud.netapp_v1.services.net_app.pagers.ListQuotaRulesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_quota_rules]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListQuotaRulesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_quota_rule(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.GetQuotaRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_quota_rule]
    ...
    def create_quota_rule(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.CreateQuotaRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_quota_rule]
    ...
    def update_quota_rule(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.UpdateQuotaRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_quota_rule]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("quota_rule.name", request.quota_rule.name),)),)
    ...
    def delete_quota_rule(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.netapp_v1.types.DeleteQuotaRuleRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_quota_rule]

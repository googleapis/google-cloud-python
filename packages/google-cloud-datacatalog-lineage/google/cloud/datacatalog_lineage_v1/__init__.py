...
__lazy_modules__ = {
    "google.cloud.datacatalog_lineage_v1.services.lineage",
    "google.cloud.datacatalog_lineage_v1.types.lineage",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.datacatalog_lineage_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.datacatalog_lineage_v1")  # type: ignore

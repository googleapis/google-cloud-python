...
class datacatalog_lineageCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_lineage_event': ('parent', 'lineage_event', 'request_id', ),
        'create_process': ('parent', 'process', 'request_id', ),
        'create_run': ('parent', 'run', 'request_id', ),
        'delete_lineage_event': ('name', 'allow_missing', ),
        'delete_process': ('name', 'allow_missing', ),
        'delete_run': ('name', 'allow_missing', ),
        'get_lineage_event': ('name', ),
        'get_process': ('name', ),
        'get_run': ('name', ),

...
def test_list_workflows_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListWorkflows,
        "_BaseListWorkflows__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_get_workflow_rest_required_fields(request_type=workflows.GetWorkflowRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetWorkflow,
        "_BaseGetWorkflow__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_create_workflow_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateWorkflow,
        "_BaseCreateWorkflow__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("workflowId",))
...
def test_delete_workflow_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteWorkflow,
        "_BaseDeleteWorkflow__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_workflow_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateWorkflow,
        "_BaseUpdateWorkflow__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
from google.cloud.workflows_v1beta.services.workflows import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        WorkflowsClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        WorkflowsClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        WorkflowsClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                WorkflowsClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                WorkflowsClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(WorkflowsClient),
)
@mock.patch.object(
    WorkflowsAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(WorkflowsAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = WorkflowsClient._DEFAULT_UNIVERSE
    default_endpoint = WorkflowsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = WorkflowsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        WorkflowsClient._get_api_endpoint(
    ...
    assert (
        ...
        == WorkflowsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        WorkflowsClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        WorkflowsClient._get_api_endpoint(None, None, default_universe, "always")
        == WorkflowsClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        WorkflowsClient._get_api_endpoint(
    ...
    assert (
        WorkflowsClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        WorkflowsClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        WorkflowsClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        WorkflowsClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        WorkflowsClient._get_universe_domain(None, None)
        == WorkflowsClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_list_workflows_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_workflows
...
@pytest.mark.asyncio
async def test_get_workflow_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_workflow
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_workflow_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_workflow
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_workflow_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_workflow
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_workflow_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_workflow
            in client._client._transport._wrapped_methods
        )
...
def test_list_workflows_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/workflows"
...
def test_get_workflow_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/workflows/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_workflow_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{workflow.name=projects/*/locations/*/workflows/*}"
            % client.transport._host,
            args[1],
        )
...
def test_transport_kind_rest():
    transport = WorkflowsClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )

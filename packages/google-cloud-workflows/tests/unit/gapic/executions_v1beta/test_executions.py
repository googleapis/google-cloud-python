...
from google.cloud.workflows.executions_v1beta.services.executions import ExecutionsAsyncClient, ExecutionsClient, pagers, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert ExecutionsClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ExecutionsClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ExecutionsClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                ExecutionsClient._use_client_cert_effective()
...
def test_executions_client_client_options_from_dict():
    with mock.patch("google.cloud.workflows.executions_v1beta.services.executions.transports.ExecutionsGrpcTransport.__init__") as grpc_transport:
...
@pytest.mark.asyncio
async def test_list_executions_async(transport: str = "grpc_asyncio", request_type=executions.ListExecutionsRequest):
    client = ExecutionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_executions_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_executions), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(executions.ListExecutionsResponse())
        await client.list_executions(request)
...
async def test_list_executions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_executions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            executions.ListExecutionsResponse(
                executions=[
...
@pytest.mark.asyncio
async def test_create_execution_async(transport: str = "grpc_asyncio", request_type=executions.CreateExecutionRequest):
    client = ExecutionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_execution_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_execution), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(executions.Execution())
        await client.create_execution(request)
...
@pytest.mark.asyncio
async def test_get_execution_async(transport: str = "grpc_asyncio", request_type=executions.GetExecutionRequest):
    client = ExecutionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_cancel_execution_async(transport: str = "grpc_asyncio", request_type=executions.CancelExecutionRequest):
    client = ExecutionsAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = ExecutionsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = ExecutionsClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = ExecutionsClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_create_execution_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_execution), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = executions.CreateExecutionRequest()
...
def test_get_execution_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_execution), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = executions.GetExecutionRequest()
...
def test_cancel_execution_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.cancel_execution), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = executions.CancelExecutionRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = ExecutionsAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ExecutionsAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_executions_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ExecutionsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_executions_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.workflows.executions_v1beta.services.executions.transports.ExecutionsTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.ExecutionsGrpcTransport, grpc_helpers), (transports.ExecutionsGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_executions_host_no_port(transport_name):
    client = ExecutionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="workflowexecutions.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == ("workflowexecutions.googleapis.com:443")
...
def test_executions_host_with_port(transport_name):
    client = ExecutionsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="workflowexecutions.googleapis.com:8000"),
        transport=transport_name,
    )
...
def test_client_ctx():
    ...
    for transport in transports:
        client = ExecutionsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

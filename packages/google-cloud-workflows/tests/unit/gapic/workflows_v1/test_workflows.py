...
def test_get_location_field_headers():
    client = WorkflowsClient(credentials=_AnonymousCredentialsWithUniverseDomain())
...
async def test_get_location_field_headers_async():
    client = WorkflowsAsyncClient(credentials=_AnonymousCredentialsWithUniverseDomain())

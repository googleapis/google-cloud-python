...
class WorkflowsAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = WorkflowsClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            WorkflowsAsyncClient: The constructed client.
        """
        sa_file_func = WorkflowsClient.from_service_account_file.__func__  # type: ignore

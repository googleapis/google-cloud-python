...
__lazy_modules__ = {
    ...
    "google.cloud.workflows_v1beta.types.workflows",
}
...
api_core.check_python_version("google.cloud.workflows_v1beta")
api_core.check_dependency_versions("google.cloud.workflows_v1beta")

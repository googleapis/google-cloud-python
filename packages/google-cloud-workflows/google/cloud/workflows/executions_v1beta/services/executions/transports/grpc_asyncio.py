...
class ExecutionsGrpcAsyncIOTransport(ExecutionsTransport):
    ...
    @property
    def list_executions(self) -> Callable[[executions.ListExecutionsRequest], Awaitable[executions.ListExecutionsResponse]]:
    ...
    @property
    def create_execution(self) -> Callable[[executions.CreateExecutionRequest], Awaitable[executions.Execution]]:
    ...
    @property
    def get_execution(self) -> Callable[[executions.GetExecutionRequest], Awaitable[executions.Execution]]:
    ...
    @property
    def cancel_execution(self) -> Callable[[executions.CancelExecutionRequest], Awaitable[executions.Execution]]:

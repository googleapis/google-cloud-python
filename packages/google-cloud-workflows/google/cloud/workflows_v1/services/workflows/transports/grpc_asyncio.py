...
class WorkflowsGrpcAsyncIOTransport(WorkflowsTransport):
    ...
    @property
    def list_workflows(self) -> Callable[[workflows.ListWorkflowsRequest], Awaitable[workflows.ListWorkflowsResponse]]:
    ...
    @property
    def get_workflow(self) -> Callable[[workflows.GetWorkflowRequest], Awaitable[workflows.Workflow]]:
    ...
    @property
    def create_workflow(self) -> Callable[[workflows.CreateWorkflowRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_workflow(self) -> Callable[[workflows.DeleteWorkflowRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_workflow(self) -> Callable[[workflows.UpdateWorkflowRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_workflow_revisions(self) -> Callable[[workflows.ListWorkflowRevisionsRequest], Awaitable[workflows.ListWorkflowRevisionsResponse]]:

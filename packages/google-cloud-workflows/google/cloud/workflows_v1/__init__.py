...
__lazy_modules__ = {
    "google.cloud.workflows_v1.services.workflows",
    "google.cloud.workflows_v1.types.workflows",
}
...
api_core.check_python_version("google.cloud.workflows_v1")
api_core.check_dependency_versions("google.cloud.workflows_v1")

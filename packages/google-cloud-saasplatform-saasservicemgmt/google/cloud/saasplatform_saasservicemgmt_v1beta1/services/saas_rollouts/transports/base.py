...
class SaasRolloutsTransport(abc.ABC):
    """Abstract transport class for SaasRollouts."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_rollout: gapic_v1.method.wrap_method(
                self.update_rollout,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_rollout: gapic_v1.method.wrap_method(
                self.delete_rollout,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
            ...
            self.list_rollout_kinds: gapic_v1.method.wrap_method(
                self.list_rollout_kinds,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_rollout_kind: gapic_v1.method.wrap_method(
                self.get_rollout_kind,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.create_rollout_kind: gapic_v1.method.wrap_method(
                self.create_rollout_kind,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_rollout_kind: gapic_v1.method.wrap_method(
                self.update_rollout_kind,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_rollout_kind: gapic_v1.method.wrap_method(
                self.delete_rollout_kind,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,

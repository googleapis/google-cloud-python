    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=SaasRolloutsClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=SaasRolloutsClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=SaasRolloutsClient._DEFAULT_ENDPOINT_TEMPLATE,

...
##
# google-backstory documentation build configuration file
#
...
# documentation.
html_theme_options = {
    "description": "Google Client Libraries for google-backstory",
...
htmlhelp_basename = "google-backstory-doc"
...
latex_documents = [
    (
        root_doc,
        "google-backstory.tex",
        "google-backstory Documentation",
        author,
        "manual",
    )
]

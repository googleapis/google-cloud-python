...
class OracleDatabaseGrpcAsyncIOTransport(OracleDatabaseTransport):
    ...
    def list_cloud_exadata_infrastructures(
        self,
    ) -> Callable[[oracledatabase.ListCloudExadataInfrastructuresRequest], Awaitable[oracledatabase.ListCloudExadataInfrastructuresResponse]]:
        ...
        if "list_cloud_exadata_infrastructures" not in self._stubs:
            self._stubs["list_cloud_exadata_infrastructures"] = self._logged_channel.unary_unary(
    ...
    def get_cloud_exadata_infrastructure(
        self,
    ) -> Callable[[oracledatabase.GetCloudExadataInfrastructureRequest], Awaitable[exadata_infra.CloudExadataInfrastructure]]:
        ...
        if "get_cloud_exadata_infrastructure" not in self._stubs:
            self._stubs["get_cloud_exadata_infrastructure"] = self._logged_channel.unary_unary(
    ...
    def create_cloud_exadata_infrastructure(
        self,
    ) -> Callable[[oracledatabase.CreateCloudExadataInfrastructureRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_cloud_exadata_infrastructure" not in self._stubs:
            self._stubs["create_cloud_exadata_infrastructure"] = self._logged_channel.unary_unary(
    ...
    def delete_cloud_exadata_infrastructure(
        self,
    ) -> Callable[[oracledatabase.DeleteCloudExadataInfrastructureRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_cloud_exadata_infrastructure" not in self._stubs:
            self._stubs["delete_cloud_exadata_infrastructure"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_cloud_vm_clusters(self) -> Callable[[oracledatabase.ListCloudVmClustersRequest], Awaitable[oracledatabase.ListCloudVmClustersResponse]]:
    ...
    @property
    def get_cloud_vm_cluster(self) -> Callable[[oracledatabase.GetCloudVmClusterRequest], Awaitable[vm_cluster.CloudVmCluster]]:
    ...
    @property
    def create_cloud_vm_cluster(self) -> Callable[[oracledatabase.CreateCloudVmClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_cloud_vm_cluster(self) -> Callable[[oracledatabase.DeleteCloudVmClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_entitlements(self) -> Callable[[oracledatabase.ListEntitlementsRequest], Awaitable[oracledatabase.ListEntitlementsResponse]]:
    ...
    @property
    def list_db_servers(self) -> Callable[[oracledatabase.ListDbServersRequest], Awaitable[oracledatabase.ListDbServersResponse]]:
    ...
    @property
    def list_db_nodes(self) -> Callable[[oracledatabase.ListDbNodesRequest], Awaitable[oracledatabase.ListDbNodesResponse]]:
    ...
    @property
    def list_gi_versions(self) -> Callable[[oracledatabase.ListGiVersionsRequest], Awaitable[oracledatabase.ListGiVersionsResponse]]:
    ...
    @property
    def list_minor_versions(self) -> Callable[[minor_version.ListMinorVersionsRequest], Awaitable[minor_version.ListMinorVersionsResponse]]:
    ...
    @property
    def list_db_system_shapes(self) -> Callable[[oracledatabase.ListDbSystemShapesRequest], Awaitable[oracledatabase.ListDbSystemShapesResponse]]:
    ...
    def list_autonomous_databases(
        self,
    ) -> Callable[[oracledatabase.ListAutonomousDatabasesRequest], Awaitable[oracledatabase.ListAutonomousDatabasesResponse]]:
    ...
    @property
    def get_autonomous_database(self) -> Callable[[oracledatabase.GetAutonomousDatabaseRequest], Awaitable[autonomous_database.AutonomousDatabase]]:
    ...
    @property
    def create_autonomous_database(self) -> Callable[[oracledatabase.CreateAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_autonomous_database" not in self._stubs:
            self._stubs["create_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    @property
    def update_autonomous_database(self) -> Callable[[oracledatabase.UpdateAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "update_autonomous_database" not in self._stubs:
            self._stubs["update_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    @property
    def delete_autonomous_database(self) -> Callable[[oracledatabase.DeleteAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_autonomous_database" not in self._stubs:
            self._stubs["delete_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    @property
    def restore_autonomous_database(self) -> Callable[[oracledatabase.RestoreAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "restore_autonomous_database" not in self._stubs:
            self._stubs["restore_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    def generate_autonomous_database_wallet(
        self,
    ) -> Callable[[oracledatabase.GenerateAutonomousDatabaseWalletRequest], Awaitable[oracledatabase.GenerateAutonomousDatabaseWalletResponse]]:
        ...
        if "generate_autonomous_database_wallet" not in self._stubs:
            self._stubs["generate_autonomous_database_wallet"] = self._logged_channel.unary_unary(
    ...
    def list_autonomous_db_versions(
        self,
    ) -> Callable[[oracledatabase.ListAutonomousDbVersionsRequest], Awaitable[oracledatabase.ListAutonomousDbVersionsResponse]]:
        ...
        if "list_autonomous_db_versions" not in self._stubs:
            self._stubs["list_autonomous_db_versions"] = self._logged_channel.unary_unary(
    ...
    def list_autonomous_database_character_sets(
        self,
    ) -> Callable[[oracledatabase.ListAutonomousDatabaseCharacterSetsRequest], Awaitable[oracledatabase.ListAutonomousDatabaseCharacterSetsResponse]]:
        ...
        if "list_autonomous_database_character_sets" not in self._stubs:
            self._stubs["list_autonomous_database_character_sets"] = self._logged_channel.unary_unary(
    ...
    def list_autonomous_database_backups(
        self,
    ) -> Callable[[oracledatabase.ListAutonomousDatabaseBackupsRequest], Awaitable[oracledatabase.ListAutonomousDatabaseBackupsResponse]]:
        r"""Return a callable for the list autonomous database
        ...
        if "list_autonomous_database_backups" not in self._stubs:
            self._stubs["list_autonomous_database_backups"] = self._logged_channel.unary_unary(
    ...
    @property
    def stop_autonomous_database(self) -> Callable[[oracledatabase.StopAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def start_autonomous_database(self) -> Callable[[oracledatabase.StartAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def restart_autonomous_database(self) -> Callable[[oracledatabase.RestartAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "restart_autonomous_database" not in self._stubs:
            self._stubs["restart_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    @property
    def switchover_autonomous_database(self) -> Callable[[oracledatabase.SwitchoverAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "switchover_autonomous_database" not in self._stubs:
            self._stubs["switchover_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    @property
    def failover_autonomous_database(self) -> Callable[[oracledatabase.FailoverAutonomousDatabaseRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "failover_autonomous_database" not in self._stubs:
            self._stubs["failover_autonomous_database"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_odb_networks(self) -> Callable[[odb_network.ListOdbNetworksRequest], Awaitable[odb_network.ListOdbNetworksResponse]]:
    ...
    @property
    def get_odb_network(self) -> Callable[[odb_network.GetOdbNetworkRequest], Awaitable[odb_network.OdbNetwork]]:
    ...
    @property
    def create_odb_network(self) -> Callable[[gco_odb_network.CreateOdbNetworkRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_odb_network(self) -> Callable[[odb_network.DeleteOdbNetworkRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_odb_subnets(self) -> Callable[[odb_subnet.ListOdbSubnetsRequest], Awaitable[odb_subnet.ListOdbSubnetsResponse]]:
    ...
    @property
    def get_odb_subnet(self) -> Callable[[odb_subnet.GetOdbSubnetRequest], Awaitable[odb_subnet.OdbSubnet]]:
    ...
    @property
    def create_odb_subnet(self) -> Callable[[gco_odb_subnet.CreateOdbSubnetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_odb_subnet(self) -> Callable[[odb_subnet.DeleteOdbSubnetRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_exadb_vm_clusters(self) -> Callable[[oracledatabase.ListExadbVmClustersRequest], Awaitable[oracledatabase.ListExadbVmClustersResponse]]:
    ...
    @property
    def get_exadb_vm_cluster(self) -> Callable[[oracledatabase.GetExadbVmClusterRequest], Awaitable[exadb_vm_cluster.ExadbVmCluster]]:
    ...
    @property
    def create_exadb_vm_cluster(self) -> Callable[[oracledatabase.CreateExadbVmClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_exadb_vm_cluster(self) -> Callable[[oracledatabase.DeleteExadbVmClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_exadb_vm_cluster(self) -> Callable[[oracledatabase.UpdateExadbVmClusterRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def remove_virtual_machine_exadb_vm_cluster(
        self,
    ) -> Callable[[oracledatabase.RemoveVirtualMachineExadbVmClusterRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "remove_virtual_machine_exadb_vm_cluster" not in self._stubs:
            self._stubs["remove_virtual_machine_exadb_vm_cluster"] = self._logged_channel.unary_unary(
    ...
    def list_exascale_db_storage_vaults(
        ...
        [exascale_db_storage_vault.ListExascaleDbStorageVaultsRequest], Awaitable[exascale_db_storage_vault.ListExascaleDbStorageVaultsResponse]
    ]:
        ...
        if "list_exascale_db_storage_vaults" not in self._stubs:
            self._stubs["list_exascale_db_storage_vaults"] = self._logged_channel.unary_unary(
    ...
    def get_exascale_db_storage_vault(
        self,
    ) -> Callable[[exascale_db_storage_vault.GetExascaleDbStorageVaultRequest], Awaitable[exascale_db_storage_vault.ExascaleDbStorageVault]]:
        ...
        if "get_exascale_db_storage_vault" not in self._stubs:
            self._stubs["get_exascale_db_storage_vault"] = self._logged_channel.unary_unary(
    ...
    def create_exascale_db_storage_vault(
        self,
    ) -> Callable[[gco_exascale_db_storage_vault.CreateExascaleDbStorageVaultRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "create_exascale_db_storage_vault" not in self._stubs:
            self._stubs["create_exascale_db_storage_vault"] = self._logged_channel.unary_unary(
    ...
    def delete_exascale_db_storage_vault(
        self,
    ) -> Callable[[exascale_db_storage_vault.DeleteExascaleDbStorageVaultRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "delete_exascale_db_storage_vault" not in self._stubs:
            self._stubs["delete_exascale_db_storage_vault"] = self._logged_channel.unary_unary(
    ...
    def list_db_system_initial_storage_sizes(
        ...
        if "list_db_system_initial_storage_sizes" not in self._stubs:
            self._stubs["list_db_system_initial_storage_sizes"] = self._logged_channel.unary_unary(
    ...
    @property
    def list_databases(self) -> Callable[[database.ListDatabasesRequest], Awaitable[database.ListDatabasesResponse]]:
    ...
    @property
    def get_database(self) -> Callable[[database.GetDatabaseRequest], Awaitable[database.Database]]:
    ...
    def list_pluggable_databases(
        self,
    ) -> Callable[[pluggable_database.ListPluggableDatabasesRequest], Awaitable[pluggable_database.ListPluggableDatabasesResponse]]:
    ...
    @property
    def get_pluggable_database(self) -> Callable[[pluggable_database.GetPluggableDatabaseRequest], Awaitable[pluggable_database.PluggableDatabase]]:
    ...
    @property
    def list_db_systems(self) -> Callable[[db_system.ListDbSystemsRequest], Awaitable[db_system.ListDbSystemsResponse]]:
    ...
    @property
    def get_db_system(self) -> Callable[[db_system.GetDbSystemRequest], Awaitable[db_system.DbSystem]]:
    ...
    @property
    def create_db_system(self) -> Callable[[gco_db_system.CreateDbSystemRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_db_system(self) -> Callable[[db_system.DeleteDbSystemRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_db_versions(self) -> Callable[[db_version.ListDbVersionsRequest], Awaitable[db_version.ListDbVersionsResponse]]:
    ...
    def list_database_character_sets(
        self,
    ) -> Callable[[database_character_set.ListDatabaseCharacterSetsRequest], Awaitable[database_character_set.ListDatabaseCharacterSetsResponse]]:
        ...
        if "list_database_character_sets" not in self._stubs:
            self._stubs["list_database_character_sets"] = self._logged_channel.unary_unary(

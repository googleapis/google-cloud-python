...
class SecureSourceManagerClient(metaclass=SecureSourceManagerClientMeta):
    ...
    def branch_rule_path(
        ...
        return "projects/{project}/locations/{location}/repositories/{repository}/branchRules/{branch_rule}".format(
            project=project,
            location=location,
    ...
    def parse_branch_rule_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/repositories/(?P<repository>.+?)/branchRules/(?P<branch_rule>.+?)$",
            path,
        )
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=SecureSourceManagerClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def test_iam_permissions_repo(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.test_iam_permissions_repo
        ]
    ...
    def fetch_refs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.securesourcemanager_v1.types.FetchRefsRequest, dict]):
        ...
        Returns:
            google.cloud.securesourcemanager_v1.services.secure_source_manager.pagers.FetchRefsPager:
                Response message containing a list of
                git references.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_refs]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.FetchRefsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

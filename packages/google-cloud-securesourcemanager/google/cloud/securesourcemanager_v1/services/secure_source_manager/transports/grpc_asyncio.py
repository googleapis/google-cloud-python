...
class SecureSourceManagerGrpcAsyncIOTransport(SecureSourceManagerTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.get_iam_policy_repo: gapic_v1.method_async.wrap_method(
            ...
            self.set_iam_policy_repo: gapic_v1.method_async.wrap_method(
                self.set_iam_policy_repo,
                default_timeout=None,
                client_info=client_info,
            ),
            self.test_iam_permissions_repo: gapic_v1.method_async.wrap_method(

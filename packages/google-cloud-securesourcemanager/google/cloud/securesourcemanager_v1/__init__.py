...
__lazy_modules__ = {
    "google.cloud.securesourcemanager_v1.services.secure_source_manager",
    "google.cloud.securesourcemanager_v1.types.secure_source_manager",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.securesourcemanager_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.securesourcemanager_v1")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.securesourcemanager_v1"

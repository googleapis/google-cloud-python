...
from .base import DEFAULT_CLIENT_INFO, AuditManagerTransport
from .grpc import AuditManagerGrpcTransport
...
class AuditManagerGrpcAsyncIOTransport(AuditManagerTransport):
    """gRPC AsyncIO backend transport for AuditManager.
    ...
    def enroll_resource(
        ...
        [auditmanager.EnrollResourceRequest], Awaitable[auditmanager.Enrollment]
    ]:
        ...
        if "enroll_resource" not in self._stubs:
            self._stubs["enroll_resource"] = self._logged_channel.unary_unary(
                "/google.cloud.auditmanager.v1.AuditManager/EnrollResource",
                request_serializer=auditmanager.EnrollResourceRequest.serialize,
                response_deserializer=auditmanager.Enrollment.deserialize,
            )
        return self._stubs["enroll_resource"]
    ...
    def generate_audit_scope_report(
        ...
        Awaitable[auditmanager.AuditScopeReport],
    ]:
    ...
    def generate_audit_report(
        ...
        [auditmanager.GenerateAuditReportRequest], Awaitable[operations_pb2.Operation]
    ]:
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "generate_audit_report" not in self._stubs:
            self._stubs["generate_audit_report"] = self._logged_channel.unary_unary(
                "/google.cloud.auditmanager.v1.AuditManager/GenerateAuditReport",
                request_serializer=auditmanager.GenerateAuditReportRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["generate_audit_report"]
    ...
    def list_audit_reports(
        ...
        Returns:
            Callable[[~.ListAuditReportsRequest],
                    Awaitable[~.ListAuditReportsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_audit_reports" not in self._stubs:
            self._stubs["list_audit_reports"] = self._logged_channel.unary_unary(
                "/google.cloud.auditmanager.v1.AuditManager/ListAuditReports",
                request_serializer=auditmanager.ListAuditReportsRequest.serialize,
                response_deserializer=auditmanager.ListAuditReportsResponse.deserialize,
            )
        return self._stubs["list_audit_reports"]

    @property
    def get_audit_report(
        self,
    ) -> Callable[
        [auditmanager.GetAuditReportRequest], Awaitable[auditmanager.AuditReport]
    ]:
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_audit_report" not in self._stubs:
            self._stubs["get_audit_report"] = self._logged_channel.unary_unary(
                "/google.cloud.auditmanager.v1.AuditManager/GetAuditReport",
                request_serializer=auditmanager.GetAuditReportRequest.serialize,
                response_deserializer=auditmanager.AuditReport.deserialize,
            )
        return self._stubs["get_audit_report"]
    ...
    def get_resource_enrollment_status(
        ...
        Returns:
            Callable[[~.GetResourceEnrollmentStatusRequest],
                    Awaitable[~.ResourceEnrollmentStatus]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_resource_enrollment_statuses(
        ...
        Returns:
            Callable[[~.ListResourceEnrollmentStatusesRequest],
                    Awaitable[~.ListResourceEnrollmentStatusesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_controls(
        ...
        [auditmanager.ListControlsRequest], Awaitable[auditmanager.ListControlsResponse]
    ]:
        ...
        if "list_controls" not in self._stubs:
            self._stubs["list_controls"] = self._logged_channel.unary_unary(
                ...
                request_serializer=auditmanager.ListControlsRequest.serialize,
                response_deserializer=auditmanager.ListControlsResponse.deserialize,
            )
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.generate_audit_scope_report: self._wrap_method(
                self.generate_audit_scope_report,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.generate_audit_report: self._wrap_method(
                self.generate_audit_report,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_audit_reports: self._wrap_method(
            ...
            self.get_audit_report: self._wrap_method(
            ...
            self.get_resource_enrollment_status: self._wrap_method(
            ...
            self.list_resource_enrollment_statuses: self._wrap_method(
...
__all__ = ("AuditManagerGrpcAsyncIOTransport",)

...
class _BaseAuditManagerRestTransport(AuditManagerTransport):
    """Base REST backend transport for AuditManager.
    ...
    class _BaseEnrollResource:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{scope=folders/*/locations/*}:enrollResource",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1/{scope=projects/*/locations/*}:enrollResource",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1/{scope=organizations/*/locations/*}:enrollResource",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseGenerateAuditReport:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{scope=folders/*/locations/*}/auditReports:generate",
                    "body": "*",
                },
                {
                    "method": "post",
    ...
    class _BaseGenerateAuditScopeReport:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{scope=folders/*/locations/*}/auditScopeReports:generate",
                    "body": "*",
                },
                {
                    "method": "post",
    ...
    class _BaseGetAuditReport:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=folders/*/locations/*/auditReports/*}",
                },
                {
                    "method": "get",
    ...
    class _BaseGetResourceEnrollmentStatus:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=projects/*/locations/*/resourceEnrollmentStatuses/*}",
                },
                {
                    "method": "get",
                    "uri": "/v1/{name=folders/*/locations/*/resourceEnrollmentStatuses/*}",
                },
                {
                    "method": "get",
                    "uri": "/v1/{name=organizations/*/locations/*/resourceEnrollmentStatuses/*}",
                },
            ]
            return http_options
    ...
    class _BaseListAuditReports:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=organizations/*/locations/*}/auditReports",
                },
                {
                    "method": "get",
                    "uri": "/v1/{parent=folders/*/locations/*}/auditReports",
                },
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*}/auditReports",
                },
            ]
            return http_options
    ...
    class _BaseListControls:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=organizations/*/locations/*/standards/*}/controls",
                },
                {
                    "method": "get",
                    "uri": "/v1/{parent=folders/*/locations/*/standards/*}/controls",
                },
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*/standards/*}/controls",
                },
            ]
            return http_options
    ...
    class _BaseListResourceEnrollmentStatuses:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=organizations/*/locations/*}/resourceEnrollmentStatuses",
                },
                {
                    "method": "get",

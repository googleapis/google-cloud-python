...
class AuditManagerTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.generate_audit_scope_report: gapic_v1.method.wrap_method(
                self.generate_audit_scope_report,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.generate_audit_report: gapic_v1.method.wrap_method(
                self.generate_audit_report,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_audit_reports: gapic_v1.method.wrap_method(
                self.list_audit_reports,
            ...
            self.get_audit_report: gapic_v1.method.wrap_method(
                self.get_audit_report,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_resource_enrollment_status: gapic_v1.method.wrap_method(
                self.get_resource_enrollment_status,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.list_resource_enrollment_statuses: gapic_v1.method.wrap_method(
                self.list_resource_enrollment_statuses,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=10.0,
                    multiplier=1.3,
    ...
    def enroll_resource(
        ...
        Union[auditmanager.Enrollment, Awaitable[auditmanager.Enrollment]],
    ]:
        raise NotImplementedError()
    ...
    def generate_audit_scope_report(
        ...
        Union[auditmanager.AuditScopeReport, Awaitable[auditmanager.AuditScopeReport]],
    ]:
        raise NotImplementedError()
    ...
    def list_audit_reports(
        ...
        Union[
            ...
            Awaitable[auditmanager.ListAuditReportsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_audit_report(
        ...
        Union[auditmanager.AuditReport, Awaitable[auditmanager.AuditReport]],
    ]:
        raise NotImplementedError()
    ...
    def get_resource_enrollment_status(
        ...
        Union[
            ...
            Awaitable[auditmanager.ResourceEnrollmentStatus],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_resource_enrollment_statuses(
        ...
        Union[
            ...
            Awaitable[auditmanager.ListResourceEnrollmentStatusesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list_controls(
        ...
        Union[
            ...
            Awaitable[auditmanager.ListControlsResponse],
        ],
    ]:
        raise NotImplementedError()

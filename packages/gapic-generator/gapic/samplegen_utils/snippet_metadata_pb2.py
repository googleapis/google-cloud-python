...
ClientMethod = _reflection.GeneratedProtocolMessageType(
    "ClientMethod",
    (_message.Message,),
    {
...
ServiceClient = _reflection.GeneratedProtocolMessageType(
    "ServiceClient",
    (_message.Message,),
    {
...
ClientLibrary = _reflection.GeneratedProtocolMessageType(
    "ClientLibrary",
    (_message.Message,),
    {

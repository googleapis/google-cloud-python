...
class ListUsersPager:
    ...
    :class:`google.showcase_v1beta1.types.ListUsersResponse` object, and
    ...
    All the usual :class:`google.showcase_v1beta1.types.ListUsersResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
            method: Callable[..., identity.ListUsersResponse],
        ...
        Args:
            ...
            request (google.showcase_v1beta1.types.ListUsersRequest):
                The initial request object.
            response (google.showcase_v1beta1.types.ListUsersResponse):
    ...
    @property
    def pages(self) -> Iterator[identity.ListUsersResponse]:
    ...
    def __iter__(self) -> Iterator[identity.User]:
...
class ListUsersAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[identity.ListUsersResponse]],
            request: identity.ListUsersRequest,
            response: identity.ListUsersResponse,
            *,

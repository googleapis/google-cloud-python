...
def test__get_default_mtls_endpoint():
    ...
    assert MessagingClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(
        ...
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert MessagingClient._read_environment_variables() == (
            False,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert MessagingClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert MessagingClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                MessagingClient._use_client_cert_effective()
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = MessagingClient(credentials=cred)
...
def test__setup_request_id():
    ...
    request = MockRequest()
    MessagingClient._setup_request_id(request, "request_id", True)
    ...
    MessagingClient._setup_request_id(request, "request_id", False)
    assert re.match(r"[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12}", request.request_id)
...
async def test_create_room_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_room_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_room_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_room_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rooms_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_blurb_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_blurb_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_blurb_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_blurb_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_blurbs_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_search_blurbs_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_stream_blurbs_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_send_blurbs_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_connect_async(request_type, transport: str = 'grpc_asyncio'):
    client = MessagingAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_create_room_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = messaging.Room(), metadata
...
def test_get_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_get_room_with_metadata") as post_with_metadata, \
...
def test_update_room_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_update_room_with_metadata") as post_with_metadata, \
...
def test_list_rooms_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_list_rooms_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = messaging.ListRoomsResponse(), metadata
...
def test_create_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_create_blurb_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = messaging.Blurb(), metadata
...
def test_get_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_get_blurb_with_metadata") as post_with_metadata, \
...
def test_update_blurb_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_update_blurb_with_metadata") as post_with_metadata, \
...
def test_list_blurbs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_list_blurbs_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = messaging.ListBlurbsResponse(), metadata
...
def test_search_blurbs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_search_blurbs_with_metadata") as post_with_metadata, \
...
def test_stream_blurbs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.MessagingRestInterceptor, "post_stream_blurbs_with_metadata") as post_with_metadata, \
        ...
        post_with_metadata.return_value = messaging.StreamBlurbsResponse(), metadata

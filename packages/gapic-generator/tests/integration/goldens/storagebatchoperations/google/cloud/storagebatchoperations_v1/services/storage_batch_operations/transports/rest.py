    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomStorageBatchOperationsInterceptor(StorageBatchOperationsRestInterceptor):
            ...
            def pre_get_bucket_operation(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_bucket_operation(self, response):
                logging.log(f"Received response: {response}")
                return response
            ...
            def pre_list_bucket_operations(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_bucket_operations(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def post_get_bucket_operation(self, response: storage_batch_operations_types.BucketOperation) -> storage_batch_operations_types.BucketOperation:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the StorageBatchOperations server but before
        it is returned to user code. This `post_get_bucket_operation` interceptor runs
        before the `post_get_bucket_operation_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_bucket_operation_with_metadata(self, response: storage_batch_operations_types.BucketOperation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[storage_batch_operations_types.BucketOperation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_get_bucket_operation_with_metadata`
        interceptor in new development instead of the `post_get_bucket_operation` interceptor.
        When both interceptors are used, this `post_get_bucket_operation_with_metadata` interceptor runs after the
        `post_get_bucket_operation` interceptor. The (possibly modified) response returned by
        `post_get_bucket_operation` will be passed to
        `post_get_bucket_operation_with_metadata`.
        """
        return response, metadata
    ...
    def post_list_bucket_operations(self, response: storage_batch_operations.ListBucketOperationsResponse) -> storage_batch_operations.ListBucketOperationsResponse:
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the StorageBatchOperations server but before
        it is returned to user code. This `post_list_bucket_operations` interceptor runs
        before the `post_list_bucket_operations_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_bucket_operations_with_metadata(self, response: storage_batch_operations.ListBucketOperationsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[storage_batch_operations.ListBucketOperationsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_list_bucket_operations_with_metadata`
        interceptor in new development instead of the `post_list_bucket_operations` interceptor.
        When both interceptors are used, this `post_list_bucket_operations_with_metadata` interceptor runs after the
        `post_list_bucket_operations` interceptor. The (possibly modified) response returned by
        `post_list_bucket_operations` will be passed to
        `post_list_bucket_operations_with_metadata`.
        """
        return response, metadata
    ...
    class _CancelJob(_BaseStorageBatchOperationsRestTransport._BaseCancelJob, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseCancelJob._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )
    ...
    class _CreateJob(_BaseStorageBatchOperationsRestTransport._BaseCreateJob, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseCreateJob._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )
    ...
    class _DeleteJob(_BaseStorageBatchOperationsRestTransport._BaseDeleteJob, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseDeleteJob._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )
    ...
    class _GetBucketOperation(_BaseStorageBatchOperationsRestTransport._BaseGetBucketOperation, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseGetBucketOperation._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )
    ...
    class _GetJob(_BaseStorageBatchOperationsRestTransport._BaseGetJob, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseGetJob._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )
    ...
    class _ListBucketOperations(_BaseStorageBatchOperationsRestTransport._BaseListBucketOperations, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseListBucketOperations._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )
    ...
    class _ListJobs(_BaseStorageBatchOperationsRestTransport._BaseListJobs, StorageBatchOperationsRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                http_options,
                request,
                _BaseStorageBatchOperationsRestTransport._BaseListJobs._REQUIRED_FIELDS_DEFAULT_VALUES,
                False,
            )

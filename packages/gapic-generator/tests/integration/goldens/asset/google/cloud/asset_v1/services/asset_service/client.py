...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AssetServiceClient.DEFAULT_ENDPOINT
        return api_endpoint
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint = AssetServiceClient._read_environment_variables()
        ...
        self._api_endpoint = AssetServiceClient._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._use_mtls_endpoint)

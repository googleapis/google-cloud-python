...
class BaseConfigServiceV2AsyncClient:
    """Service for configuring sinks used to route log entries."""

    _client: BaseConfigServiceV2Client
    ...
    link_path = staticmethod(BaseConfigServiceV2Client.link_path)
    parse_link_path = staticmethod(BaseConfigServiceV2Client.parse_link_path)
    log_bucket_path = staticmethod(BaseConfigServiceV2Client.log_bucket_path)
    parse_log_bucket_path = staticmethod(BaseConfigServiceV2Client.parse_log_bucket_path)
    log_exclusion_path = staticmethod(BaseConfigServiceV2Client.log_exclusion_path)
    ...
    parse_log_sink_path = staticmethod(BaseConfigServiceV2Client.parse_log_sink_path)
    log_view_path = staticmethod(BaseConfigServiceV2Client.log_view_path)
    parse_log_view_path = staticmethod(BaseConfigServiceV2Client.parse_log_view_path)
    settings_path = staticmethod(BaseConfigServiceV2Client.settings_path)
    parse_settings_path = staticmethod(BaseConfigServiceV2Client.parse_settings_path)
    common_billing_account_path = staticmethod(BaseConfigServiceV2Client.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(BaseConfigServiceV2Client.parse_common_billing_account_path)
    common_folder_path = staticmethod(BaseConfigServiceV2Client.common_folder_path)
    parse_common_folder_path = staticmethod(BaseConfigServiceV2Client.parse_common_folder_path)
    common_organization_path = staticmethod(BaseConfigServiceV2Client.common_organization_path)
    parse_common_organization_path = staticmethod(BaseConfigServiceV2Client.parse_common_organization_path)
    common_project_path = staticmethod(BaseConfigServiceV2Client.common_project_path)
    parse_common_project_path = staticmethod(BaseConfigServiceV2Client.parse_common_project_path)
    common_location_path = staticmethod(BaseConfigServiceV2Client.common_location_path)
    parse_common_location_path = staticmethod(BaseConfigServiceV2Client.parse_common_location_path)
    ...
    get_transport_class = BaseConfigServiceV2Client.get_transport_class
    ...
    def __init__(self, *,
        ...
        """Instantiates the base config service v2 async client.
        ...
        """
        self._client = BaseConfigServiceV2Client(
    ...
    async def _list_views(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_views():
                ...
                # Make the request
                page_result = client._list_views(request=request)
    ...
    async def _get_view(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_view():
                ...
                # Make the request
                response = await client._get_view(request=request)
    ...
    async def _create_view(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_view():
                ...
                # Make the request
                response = await client._create_view(request=request)
    ...
    async def _update_view(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_view():
                ...
                # Make the request
                response = await client._update_view(request=request)
    ...
    async def _delete_view(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_view():
                ...
                # Make the request
                await client._delete_view(request=request)
    ...
    async def _list_sinks(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_sinks():
                ...
                # Make the request
                page_result = client._list_sinks(request=request)
    ...
    async def _get_sink(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_sink():
                ...
                # Make the request
                response = await client._get_sink(request=request)
    ...
    async def _create_sink(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_sink():
                ...
                # Make the request
                response = await client._create_sink(request=request)
    ...
    async def _update_sink(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_sink():
                ...
                # Make the request
                response = await client._update_sink(request=request)
    ...
    async def _delete_sink(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_sink():
                ...
                # Make the request
                await client._delete_sink(request=request)
    ...
    async def _create_link(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_link():
                ...
                # Make the request
                operation = await client._create_link(request=request)
    ...
    async def _delete_link(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_link():
                ...
                # Make the request
                operation = await client._delete_link(request=request)
    ...
    async def _list_links(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_links():
                ...
                # Make the request
                page_result = client._list_links(request=request)
    ...
    async def _get_link(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_link():
                ...
                # Make the request
                response = await client._get_link(request=request)
    ...
    async def _list_exclusions(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_exclusions():
                ...
                # Make the request
                page_result = client._list_exclusions(request=request)
    ...
    async def _get_exclusion(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_exclusion():
                ...
                # Make the request
                response = await client._get_exclusion(request=request)
    ...
    async def _create_exclusion(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_exclusion():
                ...
                # Make the request
                response = await client._create_exclusion(request=request)
    ...
    async def _update_exclusion(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_exclusion():
                ...
                # Make the request
                response = await client._update_exclusion(request=request)
    ...
    async def _delete_exclusion(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_exclusion():
                ...
                # Make the request
                await client._delete_exclusion(request=request)
    ...
    async def _get_cmek_settings(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_cmek_settings():
                ...
                # Make the request
                response = await client._get_cmek_settings(request=request)
    ...
    async def _update_cmek_settings(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_cmek_settings():
                ...
                # Make the request
                response = await client._update_cmek_settings(request=request)
    ...
    async def _get_settings(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_settings():
                ...
                # Make the request
                response = await client._get_settings(request=request)
    ...
    async def _update_settings(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_settings():
                ...
                # Make the request
                response = await client._update_settings(request=request)
    ...
    async def _copy_log_entries(self,
    ...
    async def __aenter__(self) -> "BaseConfigServiceV2AsyncClient":
        return self

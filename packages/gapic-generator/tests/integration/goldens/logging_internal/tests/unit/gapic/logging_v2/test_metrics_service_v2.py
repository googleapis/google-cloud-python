...
def test_base_metrics_service_v2_client_otel_channel_injection_enabled():
    mock_interceptor = mock.Mock()
    mock_obs = mock.Mock()
    mock_obs.get_otel_interceptor.return_value = mock_interceptor
    with (
        mock.patch(
            "google.cloud.logging_v2.services.metrics_service_v2.client._observability",
            mock_obs,
        ),
        mock.patch.object(
            transports.MetricsServiceV2GrpcTransport, "__init__", return_value=None
        ) as patched_transport_init,
    ):
        client = BaseMetricsServiceV2Client(transport="grpc")
...
def test_base_metrics_service_v2_client_otel_channel_injection_disabled():
    mock_obs = mock.Mock()
...
def test_metrics_service_v2_grpc_transport_channel_interceptors():
    mock_interceptor = mock.Mock()
...
def test_metrics_service_v2_grpc_transport_custom_channel_interceptors():
    mock_interceptor = mock.Mock()
...
def test_base_metrics_service_v2_async_client_otel_channel_injection_enabled():
    mock_interceptor = mock.Mock()
    mock_obs = mock.Mock()
    ...
    with (
        ...
        mock.patch.object(
            transports.MetricsServiceV2GrpcAsyncIOTransport, "__init__", return_value=None
        ) as patched_transport_init,
    ):
...
def test_base_metrics_service_v2_async_client_otel_channel_injection_disabled():
    mock_obs = mock.Mock()
...
def test_metrics_service_v2_grpc_asyncio_transport_channel_interceptors():
    mock_interceptor = mock.Mock()
    mock_channel = mock.Mock()
...
def test_metrics_service_v2_grpc_asyncio_transport_custom_channel_interceptors():
    mock_interceptor = mock.Mock()

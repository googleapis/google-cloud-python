...
def test_base_config_service_v2_client_otel_channel_injection_enabled():
    mock_obs = mock.Mock()
    ...
    with (
        ...
        client = BaseConfigServiceV2Client(transport="grpc")
...
def test_base_config_service_v2_client_otel_channel_injection_disabled():
    mock_obs = mock.Mock()

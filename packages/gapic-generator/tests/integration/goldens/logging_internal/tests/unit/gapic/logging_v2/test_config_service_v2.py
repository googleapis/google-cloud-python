...
async def test__list_views_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client._list_views(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test__list_sinks_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client._list_sinks(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test__list_links_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client._list_links(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test__list_exclusions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client._list_exclusions(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token

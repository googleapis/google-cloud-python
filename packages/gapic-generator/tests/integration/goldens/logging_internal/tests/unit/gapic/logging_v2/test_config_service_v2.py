...
def test_base_config_service_v2_async_client_otel_channel_injection_enabled():
    mock_interceptor = mock.Mock()
    mock_obs = mock.Mock()
...
def test_base_config_service_v2_async_client_otel_channel_injection_disabled():
    mock_obs = mock.Mock()

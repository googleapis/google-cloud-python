...
# [START logging_v2_generated_ConfigServiceV2__CreateExclusion_sync_internal]
...
def sample__create_exclusion():
    ...
    # Make the request
    response = client._create_exclusion(request=request)

    # Handle the response
    print(response)

# [END logging_v2_generated_ConfigServiceV2__CreateExclusion_sync_internal]

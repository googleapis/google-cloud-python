...
# [START logging_v2_generated_ConfigServiceV2__UpdateExclusion_sync_internal]
...
def sample__update_exclusion():
    ...
    # Make the request
    response = client._update_exclusion(request=request)

    # Handle the response
    print(response)

# [END logging_v2_generated_ConfigServiceV2__UpdateExclusion_sync_internal]

...
# [START logging_v2_generated_MetricsServiceV2_DeleteLogMetric_async_internal]
...
async def sample_delete_log_metric():
    ...
    # Make the request
    await client._delete_log_metric(request=request)


# [END logging_v2_generated_MetricsServiceV2_DeleteLogMetric_async_internal]

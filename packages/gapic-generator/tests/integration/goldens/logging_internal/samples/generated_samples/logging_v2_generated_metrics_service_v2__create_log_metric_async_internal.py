...
# [START logging_v2_generated_MetricsServiceV2__CreateLogMetric_async_internal]
...
async def sample__create_log_metric():
    ...
    # Make the request
    response = await client._create_log_metric(request=request)

    # Handle the response
    print(response)

# [END logging_v2_generated_MetricsServiceV2__CreateLogMetric_async_internal]

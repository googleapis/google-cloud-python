...
class ConfigServiceV2Client(metaclass=ConfigServiceV2ClientMeta):
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint = ConfigServiceV2Client._read_environment_variables()
        ...
        self._api_endpoint = ConfigServiceV2Client._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._use_mtls_endpoint)

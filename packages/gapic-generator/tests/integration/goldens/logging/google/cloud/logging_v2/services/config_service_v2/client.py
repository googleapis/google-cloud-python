...
class ConfigServiceV2Client(metaclass=ConfigServiceV2ClientMeta):
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=ConfigServiceV2Client._DEFAULT_UNIVERSE)
        ...
        if not transport_provided:
            ...
            if (
                ...
                isinstance(transport_init, type)
                and issubclass(transport_init, ConfigServiceV2GrpcAsyncIOTransport)
                and _observability is not None
                and (

...
class loggingCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'create_bucket_async': ('parent', 'bucket_id', 'bucket', ),
        'create_exclusion': ('parent', 'exclusion', ),
        'create_link': ('parent', 'link', 'link_id', ),

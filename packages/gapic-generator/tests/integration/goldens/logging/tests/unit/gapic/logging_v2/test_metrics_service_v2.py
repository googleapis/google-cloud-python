...
def test_metrics_service_v2_client_otel_channel_injection_enabled():
    ...
    with (
        ...
        client = MetricsServiceV2Client(transport="grpc")
...
def test_metrics_service_v2_client_otel_channel_injection_disabled():
    mock_obs = mock.Mock()
...
def test_metrics_service_v2_async_client_otel_channel_injection_enabled():
    mock_interceptor = mock.Mock()
    mock_obs = mock.Mock()
...
def test_metrics_service_v2_async_client_otel_channel_injection_disabled():
    mock_obs = mock.Mock()

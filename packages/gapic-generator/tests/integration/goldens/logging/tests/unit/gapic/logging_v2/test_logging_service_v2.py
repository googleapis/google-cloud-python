...
def test__get_default_mtls_endpoint():
    ...
    assert LoggingServiceV2Client._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_logging_service_v2_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env, request):

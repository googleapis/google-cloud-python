...
class CloudRedisClient(metaclass=CloudRedisClientMeta):
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=CloudRedisClient._DEFAULT_UNIVERSE)
        ...
        if not transport_provided:
            ...
            interceptors = []
            if (
                transport_init is CloudRedisGrpcTransport

...
from .base import SequenceServiceTransport, DEFAULT_CLIENT_INFO
...
class _BaseSequenceServiceRestTransport(SequenceServiceTransport):
    """Base REST backend transport for SequenceService.
    ...
    class _BaseAttemptSequence:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=sequences/*}',
                'body': '*',
            },
            ]
            return http_options

    class _BaseAttemptStreamingSequence:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=streamingSequences/*}:stream',
                'body': '*',
            },
            ]
            return http_options

    class _BaseCreateSequence:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/sequences',
                'body': 'sequence',
            },
            ]
            return http_options

    class _BaseCreateStreamingSequence:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/streamingSequences',
                'body': 'streaming_sequence',
            },
            ]
            return http_options

    class _BaseGetSequenceReport:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta1/{name=sequences/*/sequenceReport}',
            },
            ]
            return http_options

    class _BaseGetStreamingSequenceReport:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1beta1/{name=streamingSequences/*/streamingSequenceReport}',
            },
            ]
            return http_options
...
__all__=(
    '_BaseSequenceServiceRestTransport',
)

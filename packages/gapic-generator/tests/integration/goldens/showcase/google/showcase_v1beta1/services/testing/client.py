...
from .transports.base import TestingTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import TestingGrpcTransport
from .transports.grpc_asyncio import TestingGrpcAsyncIOTransport
from .transports.rest import TestingRestTransport
...
class TestingClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = TestingGrpcAsyncIOTransport
    _transport_registry["rest"] = TestingRestTransport
...
class TestingClient(metaclass=TestingClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TestingClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> TestingTransport:
        """Returns the transport used by the client instance.

        Returns:
            TestingTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def blueprint_path(session: str,test: str,blueprint: str,) -> str:
        """Returns a fully-qualified blueprint string."""
        return "sessions/{session}/tests/{test}/blueprints/{blueprint}".format(session=session, test=test, blueprint=blueprint, )

    @staticmethod
    def parse_blueprint_path(path: str) -> Dict[str,str]:
        """Parses a blueprint path into its component segments."""
        m = re.match(r"^sessions/(?P<session>.+?)/tests/(?P<test>.+?)/blueprints/(?P<blueprint>.+?)$", path)
    ...
    def parse_session_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^sessions/(?P<session>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def test_path(session: str,test: str,) -> str:
        """Returns a fully-qualified test string."""
        return "sessions/{session}/tests/{test}".format(session=session, test=test, )

    @staticmethod
    def parse_test_path(path: str) -> Dict[str,str]:
        """Parses a test path into its component segments."""
        m = re.match(r"^sessions/(?P<session>.+?)/tests/(?P<test>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TestingTransport, Callable[..., TestingTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the testing client.
        ...
        Args:
            ...
            transport (Optional[Union[str,TestingTransport,Callable[..., TestingTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the TestingTransport constructor.
        ...
        self._client_cert_source = TestingClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=TestingClient._DEFAULT_UNIVERSE)
        ...
        transport_provided = isinstance(transport, TestingTransport)
        if transport_provided:
            # transport is a TestingTransport instance.
            ...
            self._transport = cast(TestingTransport, transport)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_mtls_endpoint=TestingClient.DEFAULT_MTLS_ENDPOINT,
                default_endpoint_template=TestingClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[TestingTransport], Callable[..., TestingTransport]] = (
                TestingClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., TestingTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.showcase_v1beta1.TestingClient`.",
                    extra = {
    ...
    def create_session(self,
            request: Optional[Union[testing.CreateSessionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> testing.Session:
        r"""Creates a new testing session. Adding this comment with special
        ...
        .. code-block:: python
            ...
            def sample_create_session():
                # Create a client
                client = showcase_v1beta1.TestingClient()
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.CreateSessionRequest, dict]):
        ...
        Returns:
            google.showcase_v1beta1.types.Session:
        ...
        if not isinstance(request, testing.CreateSessionRequest):
    ...
    def get_session(self,
            request: Optional[Union[testing.GetSessionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.GetSessionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.GetSessionRequest):
    ...
    def list_sessions(self,
            request: Optional[Union[testing.ListSessionsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.ListSessionsRequest, dict]):
        ...
        Returns:
            google.showcase_v1beta1.services.testing.pagers.ListSessionsPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.ListSessionsRequest):
    ...
    def delete_session(self,
            request: Optional[Union[testing.DeleteSessionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.DeleteSessionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.DeleteSessionRequest):
    ...
    def report_session(self,
            request: Optional[Union[testing.ReportSessionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_report_session():
                ...
                # Make the request
                response = client.report_session(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.showcase_v1beta1.types.ReportSessionRequest, dict]):
        ...
        Returns:
            google.showcase_v1beta1.types.ReportSessionResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.ReportSessionRequest):
            request = testing.ReportSessionRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.report_session]
    ...
    def list_tests(self,
            request: Optional[Union[testing.ListTestsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.ListTestsRequest, dict]):
        ...
        Returns:
            google.showcase_v1beta1.services.testing.pagers.ListTestsPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.ListTestsRequest):
            request = testing.ListTestsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_tests]
    ...
    def delete_test(self,
            request: Optional[Union[testing.DeleteTestRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Union[google.showcase_v1beta1.types.DeleteTestRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.DeleteTestRequest):
            request = testing.DeleteTestRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_test]
    ...
    def verify_test(self,
            request: Optional[Union[testing.VerifyTestRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_verify_test():
                ...
                # Make the request
                response = client.verify_test(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.showcase_v1beta1.types.VerifyTestRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.showcase_v1beta1.types.VerifyTestResponse:

        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, testing.VerifyTestRequest):
            request = testing.VerifyTestRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.verify_test]
    ...
    def __enter__(self) -> "TestingClient":
        return self

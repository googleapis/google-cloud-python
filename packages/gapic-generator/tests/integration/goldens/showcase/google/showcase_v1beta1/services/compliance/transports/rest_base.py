...
class _BaseComplianceRestTransport(ComplianceTransport):
    """Base REST backend transport for Compliance.
    ...
    class _BaseRepeatDataBodyPatch:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseRepeatDataPathResource:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseRepeatDataPathTrailingResource:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseRepeatDataSimplePath:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

...
class IdentityAsyncClient:
    ...
    DEFAULT_ENDPOINT = IdentityClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = IdentityClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = IdentityClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = IdentityClient._DEFAULT_UNIVERSE

    user_path = staticmethod(IdentityClient.user_path)
    parse_user_path = staticmethod(IdentityClient.parse_user_path)
    common_billing_account_path = staticmethod(IdentityClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(IdentityClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(IdentityClient.common_folder_path)
    parse_common_folder_path = staticmethod(IdentityClient.parse_common_folder_path)
    common_organization_path = staticmethod(IdentityClient.common_organization_path)
    parse_common_organization_path = staticmethod(IdentityClient.parse_common_organization_path)
    common_project_path = staticmethod(IdentityClient.common_project_path)
    parse_common_project_path = staticmethod(IdentityClient.parse_common_project_path)
    common_location_path = staticmethod(IdentityClient.common_location_path)
    parse_common_location_path = staticmethod(IdentityClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IdentityAsyncClient: The constructed client.
        """
        sa_info_func = (
            IdentityClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(IdentityAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            IdentityClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(IdentityAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return IdentityClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> IdentityTransport:
        ...
        Returns:
            IdentityTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = IdentityClient.get_transport_class

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, IdentityTransport, Callable[..., IdentityTransport]]] = "grpc_asyncio",
            client_options: Optional[ClientOptions] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the identity async client.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.showcase_v1beta1.IdentityAsyncClient`.",
                extra = {
    ...
    async def create_user(self,
        ...
        Args:
            ...
            nickname (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            enable_notifications (:class:`bool`):
    ...
    async def list_users(self,
        ...
        Returns:
            google.showcase_v1beta1.services.identity.pagers.ListUsersAsyncPager:
    ...
    async def __aenter__(self) -> "IdentityAsyncClient":
        return self

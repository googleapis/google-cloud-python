...
class _BaseResumableUploadServiceRestTransport(ResumableUploadServiceTransport):
    """Base REST backend transport for ResumableUploadService.
...
__all__=(
    '_BaseResumableUploadServiceRestTransport',
)

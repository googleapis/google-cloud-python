...
class TestingAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            TestingClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(TestingAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            TestingClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(TestingAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.showcase_v1beta1.TestingAsyncClient`.",
                extra = {

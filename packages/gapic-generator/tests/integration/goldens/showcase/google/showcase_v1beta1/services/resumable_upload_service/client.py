...
class ResumableUploadServiceClientMeta(type):
    """Metaclass for the ResumableUploadService client.
    ...
    def get_transport_class(cls,
        ...
        ) -> Type[ResumableUploadServiceTransport]:
...
class ResumableUploadServiceClient(metaclass=ResumableUploadServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ResumableUploadServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ResumableUploadServiceTransport:
        ...
        Returns:
            ResumableUploadServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ResumableUploadServiceTransport, Callable[..., ResumableUploadServiceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the resumable upload service client.
        ...
        self._client_cert_source = ResumableUploadServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=ResumableUploadServiceClient._DEFAULT_UNIVERSE)
        ...
        transport_provided = isinstance(transport, ResumableUploadServiceTransport)
        if transport_provided:
            # transport is a ResumableUploadServiceTransport instance.
            ...
            self._transport = cast(ResumableUploadServiceTransport, transport)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_endpoint_template=ResumableUploadServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.showcase_v1beta1.ResumableUploadServiceClient`.",
                    extra = {
    ...
    def __enter__(self) -> "ResumableUploadServiceClient":
        return self

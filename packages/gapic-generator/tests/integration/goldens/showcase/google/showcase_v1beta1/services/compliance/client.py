...
from .transports.base import ComplianceTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import ComplianceGrpcTransport
from .transports.grpc_asyncio import ComplianceGrpcAsyncIOTransport
from .transports.rest import ComplianceRestTransport


class ComplianceClientMeta(type):
    """Metaclass for the Compliance client.
...
class ComplianceClient(metaclass=ComplianceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ComplianceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> ComplianceTransport:
        """Returns the transport used by the client instance.

        Returns:
            ComplianceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ComplianceTransport, Callable[..., ComplianceTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the compliance client.
        ...
        Args:
            ...
            transport (Optional[Union[str,ComplianceTransport,Callable[..., ComplianceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ComplianceTransport constructor.
        ...
        self._client_cert_source = ComplianceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=ComplianceClient._DEFAULT_UNIVERSE)
        ...
        transport_provided = isinstance(transport, ComplianceTransport)
        if transport_provided:
            # transport is a ComplianceTransport instance.
            ...
            self._transport = cast(ComplianceTransport, transport)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_mtls_endpoint=ComplianceClient.DEFAULT_MTLS_ENDPOINT,
                default_endpoint_template=ComplianceClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ComplianceTransport], Callable[..., ComplianceTransport]] = (
                ComplianceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ComplianceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.showcase_v1beta1.ComplianceClient`.",
                    extra = {
    ...
    def repeat_data_body(self,
            request: Optional[Union[compliance.RepeatRequest, dict]] = None,
            *,
        ...
        Returns:
            google.showcase_v1beta1.types.RepeatResponse:

        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compliance.RepeatRequest):
            request = compliance.RepeatRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_body]
    ...
    def repeat_data_body_info(self,
            request: Optional[Union[compliance.RepeatRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_body_info]
    ...
    def repeat_data_query(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_query]
    ...
    def repeat_data_simple_path(self,
            request: Optional[Union[compliance.RepeatRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""This method echoes the ComplianceData request. This method
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_simple_path]
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ...
                ("info.f_int32", request.info.f_int32),
                ("info.f_double", request.info.f_double),
                ("info.f_bool", request.info.f_bool),
                ("info.f_kingdom", request.info.f_kingdom),
            )),
        )
    ...
    def repeat_data_path_resource(self,
            request: Optional[Union[compliance.RepeatRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_path_resource]
    ...
    def repeat_data_path_trailing_resource(self,
            request: Optional[Union[compliance.RepeatRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_path_trailing_resource]
    ...
    def repeat_data_body_put(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_body_put]
    ...
    def repeat_data_body_patch(self,
            request: Optional[Union[compliance.RepeatRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.repeat_data_body_patch]
    ...
    def get_enum(self,
            request: Optional[Union[compliance.EnumRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compliance.EnumResponse:
        r"""This method requests an enum value from the server.
        ...
        Returns:
            google.showcase_v1beta1.types.EnumResponse:

        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compliance.EnumRequest):
            request = compliance.EnumRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_enum]
    ...
    def verify_enum(self,
            request: Optional[Union[compliance.EnumResponse, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> compliance.EnumResponse:
        r"""This method is used to verify that clients can
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compliance.EnumResponse):
            request = compliance.EnumResponse(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.verify_enum]

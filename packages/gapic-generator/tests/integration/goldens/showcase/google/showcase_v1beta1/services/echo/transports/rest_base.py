...
class _BaseEchoRestTransport(EchoTransport):
    """Base REST backend transport for Echo.
    ...
    class _BaseFailEchoWithDetails:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/echo:failWithDetails',
                'body': '*',
            },
            ]
            return http_options

    class _BasePagedExpand:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BasePagedExpandLegacyMapped:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

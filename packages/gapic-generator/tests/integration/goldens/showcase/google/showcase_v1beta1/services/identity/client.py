...
from .transports.base import IdentityTransport, DEFAULT_CLIENT_INFO
from .transports.grpc import IdentityGrpcTransport
from .transports.grpc_asyncio import IdentityGrpcAsyncIOTransport
from .transports.rest import IdentityRestTransport
...
class IdentityClient(metaclass=IdentityClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IdentityClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> IdentityTransport:
        """Returns the transport used by the client instance.

        Returns:
            IdentityTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, IdentityTransport, Callable[..., IdentityTransport]]] = None,
            client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
            client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
            ) -> None:
        """Instantiates the identity client.
        ...
        Args:
            ...
            transport (Optional[Union[str,IdentityTransport,Callable[..., IdentityTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the IdentityTransport constructor.
        ...
        self._client_cert_source = IdentityClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=IdentityClient._DEFAULT_UNIVERSE)
        ...
        transport_provided = isinstance(transport, IdentityTransport)
        if transport_provided:
            ...
            self._transport = cast(IdentityTransport, transport)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_universe=IdentityClient._DEFAULT_UNIVERSE,
                default_mtls_endpoint=IdentityClient.DEFAULT_MTLS_ENDPOINT,
                default_endpoint_template=IdentityClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[IdentityTransport], Callable[..., IdentityTransport]] = (
                IdentityClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., IdentityTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.showcase_v1beta1.IdentityClient`.",
                    extra = {
    ...
    def create_user(self,
            request: Optional[Union[identity.CreateUserRequest, dict]] = None,
            *,
        ...
        Args:
            ...
            age (int):
                ...
                This corresponds to the ``user.age`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            nickname (str):
                ...
                nickname. Ordinarily, proto3_optional should not be used
                on a ``string`` field. --)

                This corresponds to the ``user.nickname`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            enable_notifications (bool):
                Enables the receiving of notifications. The default is
                true if unset.

                (-- aip.dev/not-precedent: The default for the feature
                is true. Ordinarily, the default for a ``bool`` field
                should be false. --)

                This corresponds to the ``user.enable_notifications`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            height_feet (float):
                The height of the user in feet.
                This corresponds to the ``user.height_feet`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.showcase_v1beta1.types.User:
                A user.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [display_name, email, age, nickname, enable_notifications, height_feet]
        ...
        if not isinstance(request, identity.CreateUserRequest):
            ...
            if enable_notifications is not None:
                request.user.enable_notifications = enable_notifications
            if height_feet is not None:
                request.user.height_feet = height_feet
    ...
    def get_user(self,
            request: Optional[Union[identity.GetUserRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, identity.GetUserRequest):
    ...
    def update_user(self,
            request: Optional[Union[identity.UpdateUserRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, identity.UpdateUserRequest):
    ...
    def delete_user(self,
            request: Optional[Union[identity.DeleteUserRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, identity.DeleteUserRequest):
    ...
    def list_users(self,
            request: Optional[Union[identity.ListUsersRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Returns:
            google.showcase_v1beta1.services.identity.pagers.ListUsersPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, identity.ListUsersRequest):

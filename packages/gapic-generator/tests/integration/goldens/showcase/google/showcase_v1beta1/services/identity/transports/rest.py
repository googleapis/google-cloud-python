...
class IdentityRestInterceptor:
    """Interceptor for Identity.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the IdentityRestTransport.
    ...
    .. code-block:: python
        ...
        transport = IdentityRestTransport(interceptor=MyCustomIdentityInterceptor())
        client = IdentityClient(transport=transport)


    """
    def pre_create_user(self, request: identity.CreateUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.CreateUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_user(self, response: identity.User) -> identity.User:
    ...
    def post_create_user_with_metadata(self, response: identity.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_user

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Identity server but before it is returned to user code.
    ...
    def pre_delete_user(self, request: identity.DeleteUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.DeleteUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get_user(self, request: identity.GetUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.GetUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_user(self, response: identity.User) -> identity.User:
    ...
    def post_get_user_with_metadata(self, response: identity.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_user
    ...
    def pre_list_users(self, request: identity.ListUsersRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.ListUsersRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_users(self, response: identity.ListUsersResponse) -> identity.ListUsersResponse:
    ...
    def post_list_users_with_metadata(self, response: identity.ListUsersResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.ListUsersResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_users
    ...
    def pre_update_user(self, request: identity.UpdateUserRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.UpdateUserRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_user(self, response: identity.User) -> identity.User:
    ...
    def post_update_user_with_metadata(self, response: identity.User, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[identity.User, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_user
...
class IdentityRestTransport(_BaseIdentityRestTransport):
    """REST backend synchronous transport for Identity.
    ...
    def __init__(self, *,
       ...
       this library's repository. Thank you!
        ...
        Args:
            ...
            interceptor (Optional[IdentityRestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or IdentityRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _CreateUser(_BaseIdentityRestTransport._BaseCreateUser, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.CreateUser")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseCreateUser,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.CreateUser",
                    extra = {
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = identity.User.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityClient.create_user",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "CreateUser",
    ...
    class _DeleteUser(_BaseIdentityRestTransport._BaseDeleteUser, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.DeleteUser")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseDeleteUser,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.DeleteUser",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "DeleteUser",
                        "httpRequest": http_request,
    ...
    class _GetUser(_BaseIdentityRestTransport._BaseGetUser, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.GetUser")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseGetUser,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.GetUser",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "GetUser",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityClient.get_user",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "GetUser",
                        "metadata": http_response["headers"],
    ...
    class _ListUsers(_BaseIdentityRestTransport._BaseListUsers, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.ListUsers")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseListUsers,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.ListUsers",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "ListUsers",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = identity.ListUsersResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityClient.list_users",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "ListUsers",
                        "metadata": http_response["headers"],
    ...
    class _UpdateUser(_BaseIdentityRestTransport._BaseUpdateUser, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.UpdateUser")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseUpdateUser,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.UpdateUser",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "UpdateUser",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityClient.update_user",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "UpdateUser",
                        "metadata": http_response["headers"],
    ...
    class _ListLocations(_BaseIdentityRestTransport._BaseListLocations, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.ListLocations")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseListLocations,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.ListLocations",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.ListLocations",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetLocation(_BaseIdentityRestTransport._BaseGetLocation, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.GetLocation")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseGetLocation,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.GetLocation",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.GetLocation",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(_BaseIdentityRestTransport._BaseSetIamPolicy, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.SetIamPolicy")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseSetIamPolicy,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.SetIamPolicy",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(_BaseIdentityRestTransport._BaseGetIamPolicy, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.GetIamPolicy")
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.GetIamPolicy",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(_BaseIdentityRestTransport._BaseTestIamPermissions, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.TestIamPermissions")
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.TestIamPermissions",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseIdentityRestTransport._BaseListOperations, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.ListOperations")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseListOperations,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.ListOperations",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _GetOperation(_BaseIdentityRestTransport._BaseGetOperation, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.GetOperation")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseGetOperation,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.GetOperation",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.showcase_v1beta1.IdentityAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _DeleteOperation(_BaseIdentityRestTransport._BaseDeleteOperation, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.DeleteOperation")
        ...
        def __call__(self,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseIdentityRestTransport._BaseDeleteOperation,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.DeleteOperation",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",
    ...
    class _CancelOperation(_BaseIdentityRestTransport._BaseCancelOperation, IdentityRestStub):
        def __hash__(self):
            return hash("IdentityRestTransport.CancelOperation")
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.showcase_v1beta1.IdentityClient.CancelOperation",
                    extra = {
                        "serviceName": "google.showcase.v1beta1.Identity",

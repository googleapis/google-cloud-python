...
def test_iam_credentials_base_transport_wrap_method():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method", mock_wrap):
        ...
        with mock.patch.object(type(transport), "kind", new_callable=mock.PropertyMock) as mock_kind:
            ...
            with mock.patch(
                "google.iam.credentials_v1.services.iam_credentials.transports.base._WRAP_METHOD_SUPPORTS_TRACING",
                True,
            ):
                func = mock.Mock()
...
def test_iam_credentials_base_transport_wrap_async_method():
    mock_wrap = mock.Mock()
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method", mock_wrap):
        ...
        with mock.patch.object(type(transport), "kind", new_callable=mock.PropertyMock) as mock_kind:
            ...
            # Test modern google-api-core with tracing support
            with mock.patch(
                "google.iam.credentials_v1.services.iam_credentials.transports.base._ASYNC_WRAP_METHOD_SUPPORTS_TRACING",
                True,
            ):
                func = mock.Mock()

...
def test__get_api_endpoint():
    ...
    assert IAMCredentialsClient._get_api_endpoint(api_override, mock_client_cert_source, "always") == api_override
    assert IAMCredentialsClient._get_api_endpoint(None, mock_client_cert_source, "auto") == IAMCredentialsClient.DEFAULT_MTLS_ENDPOINT
    assert IAMCredentialsClient._get_api_endpoint(None, None, "auto") == IAMCredentialsClient.DEFAULT_ENDPOINT
    assert IAMCredentialsClient._get_api_endpoint(None, None, "always") == IAMCredentialsClient.DEFAULT_MTLS_ENDPOINT
    assert IAMCredentialsClient._get_api_endpoint(None, mock_client_cert_source, "always") == IAMCredentialsClient.DEFAULT_MTLS_ENDPOINT
    assert IAMCredentialsClient._get_api_endpoint(None, None, "never") == IAMCredentialsClient.DEFAULT_ENDPOINT

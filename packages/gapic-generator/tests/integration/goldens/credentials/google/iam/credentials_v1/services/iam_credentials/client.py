...
from google.iam.credentials_v1._compat import get_universe_domain, get_api_endpoint, get_default_mtls_endpoint
...
class IAMCredentialsClient(metaclass=IAMCredentialsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = IAMCredentialsClient._use_client_cert_effective()

...
See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.iosAppDataStreams.measurementProtocolSecrets/delete
for more information.
"""
# [START analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_delete]
...
def delete_measurement_protocol_secret(property_id, stream_id, secret_id):
    """Deletes the measurement protocol secret for the web data
    stream."""
...
# [END analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_delete]

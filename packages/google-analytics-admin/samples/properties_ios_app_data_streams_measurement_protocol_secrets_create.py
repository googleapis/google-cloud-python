...
See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.iosAppDataStreams.measurementProtocolSecrets/create
for more information.
"""
# [START analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_create]
...
def create_measurement_protocol_secret(property_id, stream_id):
    """Creates a measurement protocol secret for the iOS app data stream."""
...
# [END analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_create]

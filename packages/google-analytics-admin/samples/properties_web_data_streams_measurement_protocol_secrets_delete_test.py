...
import properties_web_data_streams_measurement_protocol_secrets_delete
...
def test_properties_web_data_streams_measurement_protocol_secrets_delete():
    ...
    with pytest.raises(Exception, match="403 The caller does not have permission"):
        properties_web_data_streams_measurement_protocol_secrets_delete.delete_measurement_protocol_secret(

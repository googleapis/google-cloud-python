...
protocol secrets for the iOS app data stream.

See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.iosAppDataStreams.measurementProtocolSecrets/list
for more information.
"""
# [START analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_list]
...
def list_measurement_protocol_secrets(property_id, stream_id):
    """Lists measurement protocol secrets for the iOS app data stream."""
    client = AnalyticsAdminServiceClient()
    results = client.list_measurement_protocol_secrets(
        parent=f"properties/{property_id}/iosAppDataStreams/{stream_id}"
    )
...
# [END analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_list]

...
# [START analyticsadmin_generated_admin_v1alpha_AnalyticsAdminService_UpdateIosAppDataStream_async]
from google.analytics import admin_v1alpha


async def sample_update_ios_app_data_stream():
    # Create a client
    ...
    # Make the request
    response = await client.update_ios_app_data_stream(request=request)

    # Handle the response
    print(response)

# [END analyticsadmin_generated_admin_v1alpha_AnalyticsAdminService_UpdateIosAppDataStream_async]

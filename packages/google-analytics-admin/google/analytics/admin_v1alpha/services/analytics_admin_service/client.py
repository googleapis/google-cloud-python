...
class AnalyticsAdminServiceClient(metaclass=AnalyticsAdminServiceClientMeta):
    ...
    def parse_calculated_metric_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/calculatedMetrics/(?P<calculated_metric>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_data_redaction_settings_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/dataStreams/(?P<data_stream>.+?)/dataRedactionSettings$", path)
        return m.groupdict() if m else {}
    ...
    def parse_display_video360_advertiser_link_proposal_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^properties/(?P<property>.+?)/displayVideo360AdvertiserLinkProposals/(?P<display_video_360_advertiser_link_proposal>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def parse_event_edit_rule_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/dataStreams/(?P<data_stream>.+?)/eventEditRules/(?P<event_edit_rule>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_reporting_data_annotation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/reportingDataAnnotations/(?P<reporting_data_annotation>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_rollup_property_source_link_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/rollupPropertySourceLinks/(?P<rollup_property_source_link>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_subproperty_event_filter_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/subpropertyEventFilters/(?P<sub_property_event_filter>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def parse_subproperty_sync_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/subpropertySyncConfigs/(?P<subproperty_sync_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def update_data_redaction_settings(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_data_redaction_settings]
    ...
    def get_data_redaction_settings(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_data_redaction_settings]
    ...
    def get_rollup_property_source_link(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_rollup_property_source_link]
    ...
    def list_rollup_property_source_links(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_rollup_property_source_links]
    ...
    def create_rollup_property_source_link(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_rollup_property_source_link]
    ...
    def delete_rollup_property_source_link(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_rollup_property_source_link]
    ...
    def create_subproperty_event_filter(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_subproperty_event_filter]
    ...
    def get_subproperty_event_filter(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_subproperty_event_filter]
    ...
    def list_subproperty_event_filters(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_subproperty_event_filters]
    ...
    def update_subproperty_event_filter(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_subproperty_event_filter]
    ...
    def delete_subproperty_event_filter(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_subproperty_event_filter]
    ...
    def create_reporting_data_annotation(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_reporting_data_annotation]
    ...
    def get_reporting_data_annotation(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_reporting_data_annotation]
    ...
    def list_reporting_data_annotations(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_reporting_data_annotations]
    ...
    def update_reporting_data_annotation(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_reporting_data_annotation]
    ...
    def delete_reporting_data_annotation(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_reporting_data_annotation]
    ...
    def list_subproperty_sync_configs(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_subproperty_sync_configs]
    ...
    def update_subproperty_sync_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_subproperty_sync_config]
    ...
    def get_subproperty_sync_config(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_subproperty_sync_config]
    ...
    def get_reporting_identity_settings(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_reporting_identity_settings]

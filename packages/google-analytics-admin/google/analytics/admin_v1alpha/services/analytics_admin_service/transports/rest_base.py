...
class _BaseAnalyticsAdminServiceRestTransport(AnalyticsAdminServiceTransport):
    ...
    class _BaseGetUserProvidedDataSettings:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = analytics_admin.GetUserProvidedDataSettingsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAnalyticsAdminServiceRestTransport._BaseGetUserProvidedDataSettings._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateReportingIdentitySettings:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = analytics_admin.UpdateReportingIdentitySettingsRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAnalyticsAdminServiceRestTransport._BaseUpdateReportingIdentitySettings._get_unset_required_fields(
                    query_params
                )
            )

Python Client for Cloud API Registry
====================================

|preview| |pypi| |versions|

`Cloud API Registry`_: 
...
.. |pypi| image:: https://img.shields.io/pypi/v/google-cloud-apiregistry.svg
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-apiregistry.svg
   :target: https://pypi.org/project/google-cloud-apiregistry/
.. _Cloud API Registry: https://docs.cloud.google.com/api-registry/
...
3. `Enable the Cloud API Registry.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud API Registry.:  https://docs.cloud.google.com/api-registry/
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-apiregistry/samples
...
.. code-block:: console
    ...
    pip install google-cloud-apiregistry
...
-  Read the `Client Library Documentation`_ for Cloud API Registry
   to see other available methods on the client.
-  Read the `Cloud API Registry Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud API Registry Product documentation:  https://docs.cloud.google.com/api-registry/

Python Client for Cloud API Registry API
========================================

|preview| |pypi| |versions|

`Cloud API Registry API`_: 
...
3. `Enable the Cloud API Registry API.`_
...
-  Read the `Client Library Documentation`_ for Cloud API Registry API
   to see other available methods on the client.
-  Read the `Cloud API Registry API Product documentation`_ to learn

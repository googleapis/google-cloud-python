...
class WorkstationCluster(proto.Message):
    ...
    Attributes:
        ...
        private_cluster_config (google.cloud.workstations_v1beta.types.WorkstationCluster.PrivateClusterConfig):
            ...
            workstation cluster.
        domain_config (google.cloud.workstations_v1beta.types.WorkstationCluster.DomainConfig):
        ...
        gateway_config (google.cloud.workstations_v1beta.types.WorkstationCluster.GatewayConfig):
...
class WorkstationConfig(proto.Message):
    ...
    Attributes:
        ...
        http_options (google.cloud.workstations_v1beta.types.WorkstationConfig.HttpOptions):
            Optional. HTTP options that customize the
            behavior of the workstation service's HTTP
            proxy.
        ...
        allowed_ports (MutableSequence[google.cloud.workstations_v1beta.types.WorkstationConfig.PortRange]):
            Optional. A list of
        ...
        grant_workstation_admin_role_on_create (bool):
            ...
            Defaults to false.
        enable_pushing_credentials (bool):
            Optional. Enables pushing user provided credentials to
            Workstations by calling workstations.pushCredentials. If
            application_default_credentials are supplied to
            pushCredentials, the provided token is returned when tools
            and applications running in the user container make a
            request for Default Application Credentials. Please note
            that any credentials supplied are made available to all
        ...
        class GceInstance(proto.Message):
            ...
            Attributes:
                ...
                reservation_affinity (google.cloud.workstations_v1beta.types.WorkstationConfig.Host.GceInstance.ReservationAffinity):
                    ...
                    instances. If SPECIFIC_RESERVATION is specified, Cloud
                    Workstations will only create VMs in the zone where the
                    reservation is located. This would affect availability since
                    the service will no longer be resilient to zonal outages. If
                    ANY_RESERVATION is specified, creating reservations in both
                    zones that the config creates VMs in will ensure higher
                    availability. **Important Considerations for Reservation
                    Affinity:**

                    - This feature is intended for advanced users and requires
                      familiarity with Google Compute Engine reservations.
                    - Using reservations incurs charges, regardless of
                      utilization.
                    - The resources in the pool will consume the specified
                      reservation. Take this into account when setting the pool
                      size.
            ...
            class BoostConfig(proto.Message):
                ...
                Attributes:
                    ...
                    reservation_affinity (google.cloud.workstations_v1beta.types.WorkstationConfig.Host.GceInstance.ReservationAffinity):
                        Optional.
                        `ReservationAffinity <https://cloud.google.com/compute/docs/instances/reserving-zonal-resources>`__
                        specifies a reservation that can be consumed to create boost
                        VM instances. If SPECIFIC_RESERVATION is specified, Cloud
                        Workstations will only create VMs in the zone where the
                        reservation is located. This would affect availability since
                        the service will no longer be resilient to zonal outages. If
                        ANY_RESERVATION is specified, creating reservations in both
                ...
                reservation_affinity: "WorkstationConfig.Host.GceInstance.ReservationAffinity" = proto.Field(
                    proto.MESSAGE,
                    number=6,
                    message="WorkstationConfig.Host.GceInstance.ReservationAffinity",
                )

            class ReservationAffinity(proto.Message):
                r"""ReservationAffinity is the configuration of the desired
                reservation from which instances can consume resources.

                Attributes:
                    consume_reservation_type (google.cloud.workstations_v1beta.types.WorkstationConfig.Host.GceInstance.ReservationAffinity.Type):
                        Optional. Corresponds to the type of
                    ...
                    values (MutableSequence[str]):
                        ...
                        reservation resources. Valid values are either
                        the name of a reservation in the same project or
                ...
                consume_reservation_type: "WorkstationConfig.Host.GceInstance.ReservationAffinity.Type" = proto.Field(
                    proto.ENUM,
                    number=1,
                    enum="WorkstationConfig.Host.GceInstance.ReservationAffinity.Type",
                )
                key: str = proto.Field(
                    proto.STRING,
                    number=2,
    ...
    class PersistentDirectory(proto.Message):
        ...
        Attributes:
            ...
            gce_hd (google.cloud.workstations_v1beta.types.WorkstationConfig.PersistentDirectory.GceHyperdiskBalancedHighAvailability):
                A PersistentDirectory backed by a Compute
        ...
        class GceHyperdiskBalancedHighAvailability(proto.Message):
            ...
            Attributes:
                ...
                source_snapshot (str):
                    ...
                    must be empty. Must be formatted as ext4 file system with no
                    partitions.
                reclaim_policy (google.cloud.workstations_v1beta.types.WorkstationConfig.PersistentDirectory.GceHyperdiskBalancedHighAvailability.ReclaimPolicy):
                    Optional. Whether the persistent disk should be deleted when
                    the workstation is deleted. Valid values are ``DELETE`` and
                    ``RETAIN``. Defaults to ``DELETE``.
                archive_timeout (google.protobuf.duration_pb2.Duration):
    ...
    class HttpOptions(proto.Message):
        ...
        Attributes:
            allowed_unauthenticated_cors_preflight_requests (bool):
                Optional. By default, the workstations
                service makes sure that all requests to the
                workstation are authenticated. CORS preflight
                requests do not include cookies or custom
                headers, and so are considered unauthenticated
                and blocked by the workstations service.
                Enabling this option allows these
                unauthenticated CORS preflight requests through
                to the workstation, where it becomes the
                responsibility of the destination server in the
                workstation to validate the request.
            disable_localhost_replacement (bool):
                Optional. By default, the workstations
                service replaces references to localhost,
                127.0.0.1, and 0.0.0.0 with the workstation's
                hostname in http responses from the workstation
                so that applications under development run
                properly on the workstation. This may intefere
                with some applications, and so this option
                allows that behavior to be disabled.
        """

        allowed_unauthenticated_cors_preflight_requests: bool = proto.Field(
            proto.BOOL,
            number=1,
        )
        disable_localhost_replacement: bool = proto.Field(
            proto.BOOL,
            number=2,
        )
    ...
    http_options: HttpOptions = proto.Field(
        proto.MESSAGE,
        number=21,
        message=HttpOptions,
    )
    ...
    enable_pushing_credentials: bool = proto.Field(
        proto.BOOL,
        number=30,
    )
...
class Workstation(proto.Message):
    ...
    Attributes:
        ...
        etag (str):
            ...
            make sure that the client has an up-to-date
            value before proceeding.
        persistent_directories (MutableSequence[google.cloud.workstations_v1beta.types.Workstation.WorkstationPersistentDirectory]):
            Optional. Directories to persist across
            workstation sessions.
        ...
        boost_configs (MutableSequence[google.cloud.workstations_v1beta.types.Workstation.WorkstationBoostConfig]):
            Output only. List of available boost
            configuration IDs that this workstation can be
            boosted up to.
        ...
        satisfies_pzi (bool):
            Output only. Reserved for future use.
        runtime_host (google.cloud.workstations_v1beta.types.Workstation.RuntimeHost):
            Optional. Output only. Runtime host for the workstation when
            in STATE_RUNNING.
        degraded (bool):
            Output only. Whether this workstation is in degraded mode,
            in which case it may require user action to restore full
            functionality. The
            [conditions][google.cloud.workstations.v1beta.Workstation.conditions]
            field contains detailed information about the status of the
            workstation.
        conditions (MutableSequence[google.rpc.status_pb2.Status]):
            Output only. Status conditions describing the
    ...
    class WorkstationBoostConfig(proto.Message):
        r"""Boost configuration for this workstation. This object is
        populated from the parent workstation configuration.

        Attributes:
            id (str):
                Output only. Boost configuration ID.
            running (bool):
                Output only. Whether or not the current
                workstation is actively boosted with this id.
        """
    ...
    class RuntimeHost(proto.Message):
        ...
        Attributes:
            gce_instance_host (google.cloud.workstations_v1beta.types.Workstation.RuntimeHost.GceInstanceHost):
                Specifies a Compute Engine instance as the
                host.
    ...
    boost_configs: MutableSequence[WorkstationBoostConfig] = proto.RepeatedField(
        proto.MESSAGE,
        number=16,
...
class PushCredentialsRequest(proto.Message):
    r"""Request message for PushCredentials.

    Attributes:
        workstation (str):
            Required. Name of the workstation for which
            the credentials should be pushed.
        application_default_credentials (google.cloud.workstations_v1beta.types.PushCredentialsRequest.OAuthToken):
            Optional. Credentials used by Cloud Client
            Libraries, Google API Client Libraries, and
            other tooling within the user conainer:
    ...
    class OAuthToken(proto.Message):
        ...
        Attributes:
            email (str):
                Optional. The email address encapsulated in
                the OAuth token.
            scopes (str):
                Optional. The scopes encapsulated in the
                OAuth token. See
            ...
            expire_time (google.protobuf.timestamp_pb2.Timestamp):
                Optional. The time the OAuth access token will expire. This
                should be the time the access token was generated plus the
                expires_in offset returned from the Access Token Response.
        """
    ...
    application_default_credentials: OAuthToken = proto.Field(
        proto.MESSAGE,
        number=2,
        message=OAuthToken,
    )
...
class PushCredentialsMetadata(proto.Message):
    r"""Metadata message for PushCredentials."""

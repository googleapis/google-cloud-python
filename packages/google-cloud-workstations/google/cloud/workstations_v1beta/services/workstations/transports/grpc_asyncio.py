...
class WorkstationsGrpcAsyncIOTransport(WorkstationsTransport):
    ...
    def get_workstation_cluster(
        ...
        if "get_workstation_cluster" not in self._stubs:
            self._stubs["get_workstation_cluster"] = self._logged_channel.unary_unary(
    ...
    def list_workstation_clusters(
        ...
        if "list_workstation_clusters" not in self._stubs:
            self._stubs["list_workstation_clusters"] = self._logged_channel.unary_unary(
    ...
    def get_workstation_config(
        ...
        if "get_workstation_config" not in self._stubs:
            self._stubs["get_workstation_config"] = self._logged_channel.unary_unary(
    ...
    def list_workstation_configs(
        ...
        if "list_workstation_configs" not in self._stubs:
            self._stubs["list_workstation_configs"] = self._logged_channel.unary_unary(
    ...
    def create_workstation_config(
        ...
        if "create_workstation_config" not in self._stubs:
            self._stubs["create_workstation_config"] = self._logged_channel.unary_unary(
    ...
    def update_workstation_config(
        ...
        if "update_workstation_config" not in self._stubs:
            self._stubs["update_workstation_config"] = self._logged_channel.unary_unary(
    ...
    def delete_workstation_config(
        ...
        if "delete_workstation_config" not in self._stubs:
            self._stubs["delete_workstation_config"] = self._logged_channel.unary_unary(
    ...
    def get_workstation(
        ...
        if "get_workstation" not in self._stubs:
            self._stubs["get_workstation"] = self._logged_channel.unary_unary(
    ...
    def list_workstations(
        ...
        if "list_workstations" not in self._stubs:
            self._stubs["list_workstations"] = self._logged_channel.unary_unary(
    ...
    def list_usable_workstations(
        ...
        if "list_usable_workstations" not in self._stubs:
            self._stubs["list_usable_workstations"] = self._logged_channel.unary_unary(
    ...
    def create_workstation(
        ...
        if "create_workstation" not in self._stubs:
            self._stubs["create_workstation"] = self._logged_channel.unary_unary(
    ...
    def update_workstation(
        ...
        if "update_workstation" not in self._stubs:
            self._stubs["update_workstation"] = self._logged_channel.unary_unary(
    ...
    def delete_workstation(
        ...
        if "delete_workstation" not in self._stubs:
            self._stubs["delete_workstation"] = self._logged_channel.unary_unary(
    ...
    def start_workstation(
        ...
        if "start_workstation" not in self._stubs:
            self._stubs["start_workstation"] = self._logged_channel.unary_unary(
    ...
    def stop_workstation(
        ...
        if "stop_workstation" not in self._stubs:
            self._stubs["stop_workstation"] = self._logged_channel.unary_unary(

...
class WorkstationsAsyncClient:
    ...
    parse_workstation_cluster_path = staticmethod(
        WorkstationsClient.parse_workstation_cluster_path
    )
    workstation_config_path = staticmethod(WorkstationsClient.workstation_config_path)
    parse_workstation_config_path = staticmethod(
        WorkstationsClient.parse_workstation_config_path
    )
    common_billing_account_path = staticmethod(
        WorkstationsClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        WorkstationsClient.parse_common_billing_account_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            WorkstationsClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            WorkstationsClient.from_service_account_file.__func__  # type: ignore
        )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.workstations_v1beta.WorkstationsAsyncClient`.",
                extra={
    ...
    async def get_workstation_cluster(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.GetWorkstationClusterRequest, dict]]):
    ...
    async def list_workstation_clusters(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.ListWorkstationClustersRequest, dict]]):
                The request object. Request message for
    ...
    async def create_workstation_cluster(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.CreateWorkstationClusterRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            workstation_cluster (:class:`google.cloud.workstations_v1beta.types.WorkstationCluster`):
    ...
    async def update_workstation_cluster(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.UpdateWorkstationClusterRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_workstation_cluster(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.DeleteWorkstationClusterRequest, dict]]):
    ...
    async def get_workstation_config(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.GetWorkstationConfigRequest, dict]]):
                The request object. Request message for
    ...
    async def list_workstation_configs(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.ListWorkstationConfigsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_usable_workstation_configs(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.ListUsableWorkstationConfigsRequest, dict]]):
                The request object. Request message for
    ...
    async def create_workstation_config(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.CreateWorkstationConfigRequest, dict]]):
                The request object. Message for creating a
    ...
    async def update_workstation_config(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.UpdateWorkstationConfigRequest, dict]]):
                The request object. Request message for
    ...
    async def get_workstation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.GetWorkstationRequest, dict]]):
    ...
    async def list_usable_workstations(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.ListUsableWorkstationsRequest, dict]]):
                The request object. Request message for
    ...
    async def create_workstation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.CreateWorkstationRequest, dict]]):
                The request object. Message for creating a
                CreateWorkstation.
            parent (:class:`str`):
                Required. Parent resource name.
    ...
    async def update_workstation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.UpdateWorkstationRequest, dict]]):
                The request object. Request message for
                UpdateWorkstation.
            workstation (:class:`google.cloud.workstations_v1beta.types.Workstation`):
    ...
    async def delete_workstation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.DeleteWorkstationRequest, dict]]):
                The request object. Request message for
                DeleteWorkstation.
            name (:class:`str`):
    ...
    async def stop_workstation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.StopWorkstationRequest, dict]]):
    ...
    async def generate_access_token(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.GenerateAccessTokenRequest, dict]]):
                The request object. Request message for
                GenerateAccessToken.
    ...
    async def push_credentials(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.workstations_v1beta.types.PushCredentialsRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.push_credentials
        ]
...
__all__ = ("WorkstationsAsyncClient",)

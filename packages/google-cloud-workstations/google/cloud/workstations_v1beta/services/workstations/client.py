...
from .transports.base import DEFAULT_CLIENT_INFO, WorkstationsTransport
...
class WorkstationsClient(metaclass=WorkstationsClientMeta):
    ...
    def workstation_path(
        ...
        return "projects/{project}/locations/{location}/workstationClusters/{workstation_cluster}/workstationConfigs/{workstation_config}/workstations/{workstation}".format(
            project=project,
            location=location,
    ...
    def parse_workstation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/workstationClusters/(?P<workstation_cluster>.+?)/workstationConfigs/(?P<workstation_config>.+?)/workstations/(?P<workstation>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def workstation_cluster_path(
        project: str,
        location: str,
        workstation_cluster: str,
    ) -> str:
        """Returns a fully-qualified workstation_cluster string."""
        return "projects/{project}/locations/{location}/workstationClusters/{workstation_cluster}".format(
            project=project,
            location=location,
            workstation_cluster=workstation_cluster,
        )
    ...
    def parse_workstation_cluster_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/workstationClusters/(?P<workstation_cluster>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def workstation_config_path(
        project: str,
        location: str,
        workstation_cluster: str,
        workstation_config: str,
        ...
        return "projects/{project}/locations/{location}/workstationClusters/{workstation_cluster}/workstationConfigs/{workstation_config}".format(
            project=project,
            location=location,
            workstation_cluster=workstation_cluster,
            workstation_config=workstation_config,
    ...
    def parse_workstation_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/workstationClusters/(?P<workstation_cluster>.+?)/workstationConfigs/(?P<workstation_config>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = WorkstationsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = WorkstationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = WorkstationsClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or WorkstationsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.workstations_v1beta.WorkstationsClient`.",
                    extra={
    ...
    def get_workstation_cluster(
        self,
        request: Optional[
            Union[workstations.GetWorkstationClusterRequest, dict]
        ] = None,
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.GetWorkstationClusterRequest, dict]):
    ...
    def list_workstation_clusters(
        self,
        request: Optional[
            Union[workstations.ListWorkstationClustersRequest, dict]
        ] = None,
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.ListWorkstationClustersRequest, dict]):
                The request object. Request message for
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_workstation_clusters
        ]
    ...
    def create_workstation_cluster(
        self,
        request: Optional[
            Union[workstations.CreateWorkstationClusterRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.CreateWorkstationClusterRequest, dict]):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_workstation_cluster
        ]
    ...
    def update_workstation_cluster(
        self,
        request: Optional[
            Union[workstations.UpdateWorkstationClusterRequest, dict]
        ] = None,
        *,
        workstation_cluster: Optional[workstations.WorkstationCluster] = None,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.UpdateWorkstationClusterRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_workstation_cluster
        ]
    ...
    def delete_workstation_cluster(
        self,
        request: Optional[
            Union[workstations.DeleteWorkstationClusterRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.DeleteWorkstationClusterRequest, dict]):
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_workstation_cluster
        ]
    ...
    def get_workstation_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.GetWorkstationConfigRequest, dict]):
                The request object. Request message for
    ...
    def list_workstation_configs(
        self,
        request: Optional[
            Union[workstations.ListWorkstationConfigsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.ListWorkstationConfigsRequest, dict]):
                The request object. Request message for
    ...
    def list_usable_workstation_configs(
        self,
        request: Optional[
            Union[workstations.ListUsableWorkstationConfigsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.ListUsableWorkstationConfigsRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_usable_workstation_configs
        ]
    ...
    def create_workstation_config(
        self,
        request: Optional[
            Union[workstations.CreateWorkstationConfigRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.CreateWorkstationConfigRequest, dict]):
                The request object. Message for creating a
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_workstation_config
        ]
    ...
    def update_workstation_config(
        self,
        request: Optional[
            Union[workstations.UpdateWorkstationConfigRequest, dict]
        ] = None,
        *,
        workstation_config: Optional[workstations.WorkstationConfig] = None,
        update_mask: Optional[field_mask_pb2.FieldMask] = None,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.UpdateWorkstationConfigRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_workstation_config
        ]
    ...
    def delete_workstation_config(
        self,
        request: Optional[
            Union[workstations.DeleteWorkstationConfigRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_workstation_config
        ]
    ...
    def get_workstation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.GetWorkstationRequest, dict]):
        ...
        Returns:
            google.cloud.workstations_v1beta.types.Workstation:
    ...
    def list_usable_workstations(
        self,
        request: Optional[
            Union[workstations.ListUsableWorkstationsRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.ListUsableWorkstationsRequest, dict]):
                The request object. Request message for
    ...
    def create_workstation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.CreateWorkstationRequest, dict]):
                The request object. Message for creating a
                CreateWorkstation.
            parent (str):
                Required. Parent resource name.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.workstations_v1beta.types.Workstation`
    ...
    def update_workstation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.UpdateWorkstationRequest, dict]):
                The request object. Request message for
                UpdateWorkstation.
            workstation (google.cloud.workstations_v1beta.types.Workstation):
    ...
    def delete_workstation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.DeleteWorkstationRequest, dict]):
                The request object. Request message for
                DeleteWorkstation.
            name (str):
    ...
    def stop_workstation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.StopWorkstationRequest, dict]):
    ...
    def generate_access_token(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.GenerateAccessTokenRequest, dict]):
                The request object. Request message for
                GenerateAccessToken.
            workstation (str):
    ...
    def push_credentials(
        self,
        request: Optional[Union[workstations.PushCredentialsRequest, dict]] = None,
        *,
        workstation: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Pushes credentials to a running workstation on behalf of a user.
        ...
        .. code-block:: python
            ...
            def sample_push_credentials():
                # Create a client
                client = workstations_v1beta.WorkstationsClient()

                # Initialize request argument(s)
                request = workstations_v1beta.PushCredentialsRequest(
                    workstation="workstation_value",
                )

                # Make the request
                operation = client.push_credentials(request=request)
        ...
        Args:
            request (Union[google.cloud.workstations_v1beta.types.PushCredentialsRequest, dict]):
                The request object. Request message for PushCredentials.
            workstation (str):
                Required. Name of the workstation for
                which the credentials should be pushed.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, workstations.PushCredentialsRequest):
            request = workstations.PushCredentialsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if workstation is not None:
                request.workstation = workstation
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.push_credentials]
        ...
        response = operation.from_gapic(
            ...
            self._transport.operations_client,
            workstations.Workstation,
            metadata_type=workstations.PushCredentialsMetadata,
        )

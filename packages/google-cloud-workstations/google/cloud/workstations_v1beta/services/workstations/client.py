...
class WorkstationsClient(metaclass=WorkstationsClientMeta):
    ...
    def update_workstation_cluster(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("workstation_cluster.name", request.workstation_cluster.name),)),)
    ...
    def update_workstation_config(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("workstation_config.name", request.workstation_config.name),)),)
    ...
    def update_workstation(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("workstation.name", request.workstation.name),)),)
    ...
    def generate_access_token(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("workstation", request.workstation),)),)

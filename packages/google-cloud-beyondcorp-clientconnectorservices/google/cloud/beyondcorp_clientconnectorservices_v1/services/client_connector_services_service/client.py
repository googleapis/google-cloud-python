...
from google.cloud.beyondcorp_clientconnectorservices_v1._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=ClientConnectorServicesServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

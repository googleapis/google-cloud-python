...
__lazy_modules__ = {
    ...
    "google.cloud.beyondcorp_clientconnectorservices_v1.types.client_connector_services_service",
}
...
api_core.check_python_version("google.cloud.beyondcorp_clientconnectorservices_v1")
api_core.check_dependency_versions("google.cloud.beyondcorp_clientconnectorservices_v1")

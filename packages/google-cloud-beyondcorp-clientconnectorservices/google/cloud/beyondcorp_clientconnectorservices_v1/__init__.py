...
from .services.client_connector_services_service import ClientConnectorServicesServiceAsyncClient, ClientConnectorServicesServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.beyondcorp_clientconnectorservices_v1"

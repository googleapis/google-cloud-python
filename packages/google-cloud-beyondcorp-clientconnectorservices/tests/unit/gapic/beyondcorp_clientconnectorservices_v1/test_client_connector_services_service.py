...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert ClientConnectorServicesServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert ClientConnectorServicesServiceClient._use_client_cert_effective() is False
...
@mock.patch.object(
    ClientConnectorServicesServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ClientConnectorServicesServiceClient)
)
@mock.patch.object(
    ClientConnectorServicesServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ClientConnectorServicesServiceAsyncClient),
)
def test__get_api_endpoint():
    ...
    assert (
        ClientConnectorServicesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == ClientConnectorServicesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert ClientConnectorServicesServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        ClientConnectorServicesServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == ClientConnectorServicesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ClientConnectorServicesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ClientConnectorServicesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
async def test_list_client_connector_services_async(
    transport: str = "grpc_asyncio", request_type=client_connector_services_service.ListClientConnectorServicesRequest
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_get_client_connector_service_async(
    transport: str = "grpc_asyncio", request_type=client_connector_services_service.GetClientConnectorServiceRequest
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_create_client_connector_service_async(
    transport: str = "grpc_asyncio", request_type=client_connector_services_service.CreateClientConnectorServiceRequest
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_update_client_connector_service_async(
    transport: str = "grpc_asyncio", request_type=client_connector_services_service.UpdateClientConnectorServiceRequest
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_delete_client_connector_service_async(
    transport: str = "grpc_asyncio", request_type=client_connector_services_service.DeleteClientConnectorServiceRequest
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_client_connector_services_rest_required_fields(request_type=client_connector_services_service.ListClientConnectorServicesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_client_connector_services._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_client_connector_service_rest_required_fields(request_type=client_connector_services_service.GetClientConnectorServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_client_connector_service._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_client_connector_service_rest_required_fields(request_type=client_connector_services_service.CreateClientConnectorServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_client_connector_service._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_client_connector_service_rest_required_fields(request_type=client_connector_services_service.UpdateClientConnectorServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_client_connector_service._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_client_connector_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{client_connector_service.name=projects/*/locations/*/clientConnectorServices/*}" % client.transport._host, args[1]
        )
...
def test_delete_client_connector_service_rest_required_fields(request_type=client_connector_services_service.DeleteClientConnectorServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_client_connector_service._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = ClientConnectorServicesServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ClientConnectorServicesServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ClientConnectorServicesServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ClientConnectorServicesServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_client_connector_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor, "post_list_client_connector_services"
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "post_list_client_connector_services_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "pre_list_client_connector_services"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_connector_services_service.ListClientConnectorServicesRequest.pb(
            client_connector_services_service.ListClientConnectorServicesRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_connector_services_service.ListClientConnectorServicesResponse.to_json(
            client_connector_services_service.ListClientConnectorServicesResponse()
        )
...
def test_get_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor, "post_get_client_connector_service"
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "post_get_client_connector_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "pre_get_client_connector_service"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_connector_services_service.GetClientConnectorServiceRequest.pb(
            client_connector_services_service.GetClientConnectorServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_create_client_connector_service_rest_call_success(request_type):
    ...
    request_init["client_connector_service"] = {
        ...
        "update_time": {},
        "display_name": "display_name_value",
        "ingress": {"config": {"transport_protocol": 1, "destination_routes": [{"address": "address_value", "netmask": "netmask_value"}]}},
...
def test_create_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor, "post_create_client_connector_service"
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "post_create_client_connector_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "pre_create_client_connector_service"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_connector_services_service.CreateClientConnectorServiceRequest.pb(
            client_connector_services_service.CreateClientConnectorServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_update_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor, "post_update_client_connector_service"
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "post_update_client_connector_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "pre_update_client_connector_service"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_connector_services_service.UpdateClientConnectorServiceRequest.pb(
            client_connector_services_service.UpdateClientConnectorServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_delete_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor, "post_delete_client_connector_service"
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "post_delete_client_connector_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor, "pre_delete_client_connector_service"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = client_connector_services_service.DeleteClientConnectorServiceRequest.pb(
            client_connector_services_service.DeleteClientConnectorServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
@pytest.mark.parametrize(
    "transport_class", [transports.ClientConnectorServicesServiceGrpcTransport, transports.ClientConnectorServicesServiceGrpcAsyncIOTransport]
)
...
async def test_get_location_field_headers_async():
    client = ClientConnectorServicesServiceAsyncClient(credentials=async_anonymous_credentials())

...
def test__get_client_cert_source():
    ...
    assert (
        ClientConnectorServicesServiceClient._get_client_cert_source(None, False)
        is None
    )
    assert (
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ClientConnectorServicesServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ClientConnectorServicesServiceClient),
)
@mock.patch.object(
    ClientConnectorServicesServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
...
def test_list_client_connector_services_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.list_client_connector_services
...
@pytest.mark.asyncio
async def test_list_client_connector_services_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_client_connector_services
...
def test_list_client_connector_services_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_client_connector_services(
...
def test_get_client_connector_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_client_connector_service
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_client_connector_service_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_client_connector_service
            in client._client._transport._wrapped_methods
        )
...
def test_create_client_connector_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.create_client_connector_service
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_create_client_connector_service_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_client_connector_service
            in client._client._transport._wrapped_methods
        )
...
def test_update_client_connector_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.update_client_connector_service
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_client_connector_service_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_client_connector_service
            in client._client._transport._wrapped_methods
        )
...
def test_delete_client_connector_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.delete_client_connector_service
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_client_connector_service_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_client_connector_service
            in client._client._transport._wrapped_methods
        )
...
def test_list_client_connector_services_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListClientConnectorServices,
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = client_connector_services_service.ListClientConnectorServicesResponse.pb(
                return_value
            )
...
def test_get_client_connector_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetClientConnectorService,
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = client_connector_services_service.ClientConnectorService.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_create_client_connector_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateClientConnectorService,
...
def test_update_client_connector_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateClientConnectorService,
...
def test_delete_client_connector_service_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteClientConnectorService,
...
def test_transport_kind_grpc_asyncio():
    transport = ClientConnectorServicesServiceAsyncClient.get_transport_class(
        "grpc_asyncio"
    )(credentials=async_anonymous_credentials())
...
def test_get_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = client_connector_services_service.ClientConnectorService.to_json(
            client_connector_services_service.ClientConnectorService()
        )
        req.return_value.content = return_value
...
def test_create_client_connector_service_rest_call_success(request_type):
    ...
    test_field = client_connector_services_service.CreateClientConnectorServiceRequest.meta.fields[
        "client_connector_service"
    ]
...
def test_update_client_connector_service_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = client_connector_services_service.UpdateClientConnectorServiceRequest.meta.fields[
        "client_connector_service"
    ]

...
Please run down the following list and make sure you've tried the usual "quick fixes":
  ...
  - Search the issues already opened: https://github.com/googleapis/python-videointelligence/issues
...
#### Environment details
  ...
  - `google-cloud-videointelligence` version: `pip show google-cloud-videointelligence`

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        VideoIntelligenceServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    VideoIntelligenceServiceClient._use_client_cert_effective() is False
                )
...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                VideoIntelligenceServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(VideoIntelligenceServiceClient),
)
@mock.patch.object(
    VideoIntelligenceServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(VideoIntelligenceServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VideoIntelligenceServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VideoIntelligenceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = VideoIntelligenceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        VideoIntelligenceServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        VideoIntelligenceServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        VideoIntelligenceServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        VideoIntelligenceServiceClient._get_universe_domain(None, None)
        == VideoIntelligenceServiceClient._DEFAULT_UNIVERSE
    )
...
def test_video_intelligence_service_client_from_service_account_info(
    ...
    with mock.patch.object(
        ...
        assert client.transport._host == (
            ...
            else "https://videointelligence.googleapis.com"
        )
...
def test_video_intelligence_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
@pytest.mark.asyncio
async def test_annotate_video_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.annotate_video
...
def test_annotate_video_rest_required_fields(
    request_type=video_intelligence.AnnotateVideoRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).annotate_video._get_unset_required_fields(jsonified_request)
...
def test_annotate_video_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta2/videos:annotate" % client.transport._host, args[1]
        )
...
def test_transport_kind_grpc_asyncio():
    transport = VideoIntelligenceServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = VideoIntelligenceServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_annotate_video_rest_bad_request(
    request_type=video_intelligence.AnnotateVideoRequest,
):
    client = VideoIntelligenceServiceClient(
...
def test_annotate_video_rest_interceptors(null_interceptor):
    transport = transports.VideoIntelligenceServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.VideoIntelligenceServiceRestInterceptor(),
    )
    client = VideoIntelligenceServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.VideoIntelligenceServiceRestInterceptor,
        ...
        pb_message = video_intelligence.AnnotateVideoRequest.pb(
            video_intelligence.AnnotateVideoRequest()
        )
...
def test_video_intelligence_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "videointelligence.googleapis.com:8000"
        if transport_name in ["grpc", "grpc_asyncio"]
        else "https://videointelligence.googleapis.com:8000"
    )

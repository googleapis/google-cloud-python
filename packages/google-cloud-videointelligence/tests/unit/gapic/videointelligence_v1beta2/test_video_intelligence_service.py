...
@pytest.mark.asyncio
async def test_annotate_video_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
def test_annotate_video_rest_bad_request(
    transport: str = "rest", request_type=video_intelligence.AnnotateVideoRequest
):
    client = VideoIntelligenceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_transport_kind(transport_name):
    transport = VideoIntelligenceServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )

...
from google.cloud.videointelligence_v1beta2.services.video_intelligence_service import (
...
def test__read_environment_variables():
    assert VideoIntelligenceServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert VideoIntelligenceServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert VideoIntelligenceServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert VideoIntelligenceServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert VideoIntelligenceServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert VideoIntelligenceServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert VideoIntelligenceServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert VideoIntelligenceServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                VideoIntelligenceServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert VideoIntelligenceServiceClient._get_client_cert_source(None, False) is None
    assert VideoIntelligenceServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert VideoIntelligenceServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert VideoIntelligenceServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert VideoIntelligenceServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(VideoIntelligenceServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VideoIntelligenceServiceClient))
@mock.patch.object(
    VideoIntelligenceServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VideoIntelligenceServiceAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VideoIntelligenceServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VideoIntelligenceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = VideoIntelligenceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert VideoIntelligenceServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        VideoIntelligenceServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == VideoIntelligenceServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert VideoIntelligenceServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        VideoIntelligenceServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == VideoIntelligenceServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        VideoIntelligenceServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == VideoIntelligenceServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert VideoIntelligenceServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert VideoIntelligenceServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        VideoIntelligenceServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert VideoIntelligenceServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert VideoIntelligenceServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert VideoIntelligenceServiceClient._get_universe_domain(None, None) == VideoIntelligenceServiceClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        VideoIntelligenceServiceClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = VideoIntelligenceServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (VideoIntelligenceServiceClient, "grpc"),
        (VideoIntelligenceServiceAsyncClient, "grpc_asyncio"),
        (VideoIntelligenceServiceClient, "rest"),
    ],
)
def test_video_intelligence_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "videointelligence.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://videointelligence.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.VideoIntelligenceServiceRestTransport, "rest"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VideoIntelligenceServiceClient, transports.VideoIntelligenceServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(VideoIntelligenceServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VideoIntelligenceServiceClient))
@mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VideoIntelligenceServiceClient, transports.VideoIntelligenceServiceRestTransport, "rest", "true"),
        (VideoIntelligenceServiceClient, transports.VideoIntelligenceServiceRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(VideoIntelligenceServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VideoIntelligenceServiceClient))
@mock.patch.object(
...
def test_video_intelligence_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (VideoIntelligenceServiceClient, transports.VideoIntelligenceServiceGrpcTransport, "grpc", grpc_helpers),
        (VideoIntelligenceServiceAsyncClient, transports.VideoIntelligenceServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (VideoIntelligenceServiceClient, transports.VideoIntelligenceServiceRestTransport, "rest", None),
    ],
)
...
def test_annotate_video_non_empty_request_with_auto_populated_field():
...
def test_annotate_video_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.annotate_video in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.annotate_video] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_annotate_video_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.annotate_video in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.annotate_video] = mock_rpc

        request = {}
        await client.annotate_video(request)
...
def test_annotate_video_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = VideoIntelligenceServiceClient(
...
def test_annotate_video_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta2/videos:annotate" % client.transport._host, args[1])
...
def test_transport_kind_grpc():
    transport = VideoIntelligenceServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_annotate_video_empty_call_grpc():
    client = VideoIntelligenceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.annotate_video), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.annotate_video(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = VideoIntelligenceServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = VideoIntelligenceServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_annotate_video_empty_call_grpc_asyncio():
    client = VideoIntelligenceServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.annotate_video), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.annotate_video(request=None)
...
def test_transport_kind_rest():
    transport = VideoIntelligenceServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_annotate_video_rest_bad_request(request_type=video_intelligence.AnnotateVideoRequest):
...
def test_annotate_video_rest_call_success(request_type):
    client = VideoIntelligenceServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_annotate_video_rest_interceptors(null_interceptor):
    transport = transports.VideoIntelligenceServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.VideoIntelligenceServiceRestInterceptor(),
    )
    client = VideoIntelligenceServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.VideoIntelligenceServiceRestInterceptor, "post_annotate_video"
    ) as post, mock.patch.object(
        transports.VideoIntelligenceServiceRestInterceptor, "post_annotate_video_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.VideoIntelligenceServiceRestInterceptor, "pre_annotate_video"
    ) as pre:
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_annotate_video_empty_call_rest():
    client = VideoIntelligenceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_video_intelligence_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.videointelligence_v1beta2.services.video_intelligence_service.transports.VideoIntelligenceServiceTransport.__init__"
    ) as Transport:
...
def test_video_intelligence_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.videointelligence_v1beta2.services.video_intelligence_service.transports.VideoIntelligenceServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.VideoIntelligenceServiceGrpcTransport, grpc_helpers), (transports.VideoIntelligenceServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize(
    "transport_class", [transports.VideoIntelligenceServiceGrpcTransport, transports.VideoIntelligenceServiceGrpcAsyncIOTransport]
)
...
def test_video_intelligence_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "videointelligence.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://videointelligence.googleapis.com:8000"
    )
...
def test_video_intelligence_service_client_transport_session_collision(transport_name):
    ...
    client1 = VideoIntelligenceServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = VideoIntelligenceServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize(
    ...
    [
        (VideoIntelligenceServiceClient, transports.VideoIntelligenceServiceGrpcTransport),
        (VideoIntelligenceServiceAsyncClient, transports.VideoIntelligenceServiceGrpcAsyncIOTransport),
    ],
)

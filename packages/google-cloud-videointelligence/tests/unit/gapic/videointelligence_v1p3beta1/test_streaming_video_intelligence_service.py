...
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.base import (
    _API_CORE_VERSION,
)
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.base import (
...
def test_transport_grpc_default():
    ...
    assert isinstance(
        client.transport, transports.StreamingVideoIntelligenceServiceGrpcTransport,
    )
...
def test_streaming_video_intelligence_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport.__init__"
    ) as Transport:
...
def test_streaming_video_intelligence_service_transport_create_channel_old_api_core(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@requires_api_core_lt_1_26_0
def test_streaming_video_intelligence_service_transport_create_channel_user_scopes(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.

...
class StreamingVideoIntelligenceServiceGrpcTransport(StreamingVideoIntelligenceServiceTransport):
    ...
    def streaming_annotate_video(
        self,
    ) -> Callable[[video_intelligence.StreamingAnnotateVideoRequest], video_intelligence.StreamingAnnotateVideoResponse]:
        ...
        if "streaming_annotate_video" not in self._stubs:
            self._stubs["streaming_annotate_video"] = self._logged_channel.stream_stream(

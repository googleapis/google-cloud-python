...
class StreamingVideoIntelligenceServiceClient(metaclass=StreamingVideoIntelligenceServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = StreamingVideoIntelligenceServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = StreamingVideoIntelligenceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, StreamingVideoIntelligenceServiceTransport, Callable[..., StreamingVideoIntelligenceServiceTransport]]] = None,
        ...
        self._client_cert_source = StreamingVideoIntelligenceServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = StreamingVideoIntelligenceServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, StreamingVideoIntelligenceServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(StreamingVideoIntelligenceServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or StreamingVideoIntelligenceServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[StreamingVideoIntelligenceServiceTransport], Callable[..., StreamingVideoIntelligenceServiceTransport]] = (
                StreamingVideoIntelligenceServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., StreamingVideoIntelligenceServiceTransport], transport)
            )
    ...
    def streaming_annotate_video(
        self,
        requests: Optional[Iterator[video_intelligence.StreamingAnnotateVideoRequest]] = None,
        *,

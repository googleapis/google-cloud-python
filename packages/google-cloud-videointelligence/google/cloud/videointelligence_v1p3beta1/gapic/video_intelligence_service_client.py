...
"""Accesses the google.cloud.videointelligence.v1p3beta1 VideoIntelligenceService API."""
...
class VideoIntelligenceServiceClient(object):
    ...
    def annotate_video(
        ...
        Returns:
            A :class:`~google.cloud.videointelligence_v1p3beta1.types._OperationFuture` instance.

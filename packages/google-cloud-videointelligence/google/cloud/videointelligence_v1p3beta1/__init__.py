...
from google.cloud.videointelligence_v1p3beta1 import types
...
class StreamingVideoIntelligenceServiceClient(
    streaming_video_intelligence_service_client.StreamingVideoIntelligenceServiceClient
):
    __doc__ = (
        streaming_video_intelligence_service_client.StreamingVideoIntelligenceServiceClient.__doc__
    )
    enums = enums

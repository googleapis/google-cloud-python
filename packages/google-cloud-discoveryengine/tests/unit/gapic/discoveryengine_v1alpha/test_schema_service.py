...
from google.cloud.discoveryengine_v1alpha.services.schema_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SchemaServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        SchemaServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        SchemaServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                SchemaServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    SchemaServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(SchemaServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SchemaServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = SchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        SchemaServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == SchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SchemaServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SchemaServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == SchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SchemaServiceClient._get_api_endpoint(
    ...
    assert (
        SchemaServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SchemaServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SchemaServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SchemaServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SchemaServiceClient._get_universe_domain(None, None)
        == SchemaServiceClient._DEFAULT_UNIVERSE
    )
...
def test_schema_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_list_schemas_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_schemas
            in client._client._transport._wrapped_methods
        )
...
async def test_list_schemas_async(request_type, transport: str = "grpc_asyncio"):
    client = SchemaServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_schema_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_schema
            in client._client._transport._wrapped_methods
        )
...
async def test_create_schema_async(request_type, transport: str = "grpc_asyncio"):
    client = SchemaServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_schema_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_schema
            in client._client._transport._wrapped_methods
        )
...
async def test_update_schema_async(request_type, transport: str = "grpc_asyncio"):
    client = SchemaServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_schema_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_schema
            in client._client._transport._wrapped_methods
        )
...
async def test_delete_schema_async(request_type, transport: str = "grpc_asyncio"):
    client = SchemaServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataStores/*/schemas/*}"
...
def test_list_schemas_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/dataStores/*}/schemas"
            % client.transport._host,
            args[1],
        )
...
def test_list_schemas_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = schema_service.ListSchemasResponse.to_json(
            schema_service.ListSchemasResponse()
        )
        req.return_value.content = return_value
        ...
        "field_configs": [
            {
                ...
                "schema_org_paths": [
                    "schema_org_paths_value1",
                    "schema_org_paths_value2",
                ],
            }
        ],
    }
...
def test_schema_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceTransport.__init__"
    ) as Transport:

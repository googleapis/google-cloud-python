...
from google.cloud.discoveryengine_v1alpha.services.schema_service import SchemaServiceAsyncClient, SchemaServiceClient, pagers, transports
...
def test__read_environment_variables():
    assert SchemaServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SchemaServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SchemaServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SchemaServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SchemaServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SchemaServiceClient._get_client_cert_source(None, False) is None
    assert SchemaServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SchemaServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert SchemaServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SchemaServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(SchemaServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SchemaServiceClient))
@mock.patch.object(SchemaServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SchemaServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SchemaServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SchemaServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SchemaServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SchemaServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SchemaServiceClient._get_api_endpoint(None, None, default_universe, "always") == SchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        SchemaServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SchemaServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SchemaServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SchemaServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SchemaServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SchemaServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SchemaServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SchemaServiceClient._get_universe_domain(None, None) == SchemaServiceClient._DEFAULT_UNIVERSE
...
@mock.patch.object(SchemaServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SchemaServiceClient))
@mock.patch.object(SchemaServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SchemaServiceAsyncClient))
def test_schema_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (SchemaServiceClient, transports.SchemaServiceGrpcTransport, "grpc", grpc_helpers),
        (SchemaServiceAsyncClient, transports.SchemaServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_schema_service_client_client_options_from_dict():
    with mock.patch("google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceGrpcTransport.__init__") as grpc_transport:
...
def test_list_schemas_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SchemaServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.list_schemas in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_schemas] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_schemas_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_schemas in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_schemas] = mock_rpc
...
def test_list_schemas_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_schemas), "__call__") as call:
        ...
        pager = client.list_schemas(request={}, retry=retry, timeout=timeout)
...
async def test_list_schemas_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_schemas), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_schemas(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_schema_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SchemaServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.create_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_schema] = mock_rpc
    ...
    with mock.patch.object(type(client.transport.create_schema), "__call__") as call:
        ...
        client.create_schema(
            ...
            schema=gcd_schema.Schema(
                struct_schema=struct_pb2.Struct(fields={"key_value": struct_pb2.Value(null_value=struct_pb2.NullValue.NULL_VALUE)})
            ),
            schema_id="schema_id_value",
        )
...
def test_update_schema_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = SchemaServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.update_schema), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.update_schema(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == schema_service.UpdateSchemaRequest()


def test_update_schema_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SchemaServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.update_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_schema] = mock_rpc
...
def test_delete_schema_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SchemaServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.delete_schema in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_schema] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_schema] = mock_rpc
...
def test_get_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/dataStores/*/schemas/*}" % client.transport._host, args[1])
...
def test_list_schemas_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/dataStores/*}/schemas" % client.transport._host, args[1])
...
def test_update_schema_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = SchemaServiceClient(
...
def test_transport_kind_grpc():
    transport = SchemaServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_schema_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.get_schema), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = schema_service.GetSchemaRequest()
...
def test_list_schemas_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.list_schemas), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = schema_service.ListSchemasRequest()
...
def test_create_schema_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.create_schema), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = schema_service.CreateSchemaRequest()
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_schema_empty_call_grpc():
    client = SchemaServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.update_schema), "__call__") as call:
        call.return_value = operations_pb2.Operation(name="operations/op")
        client.update_schema(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = schema_service.UpdateSchemaRequest()
...
def test_delete_schema_empty_call_grpc():
    ...
    with mock.patch.object(type(client.transport.delete_schema), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = schema_service.DeleteSchemaRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = SchemaServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SchemaServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_schema_empty_call_grpc_asyncio():
    client = SchemaServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.update_schema), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name="operations/spam"))
        await client.update_schema(request=None)
...
def test_transport_kind_rest():
    transport = SchemaServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_schema_rest_bad_request(request_type=schema_service.GetSchemaRequest):
...
def test_get_schema_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.SchemaServiceRestInterceptor, "post_get_schema") as post, mock.patch.object(
...
def test_list_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SchemaServiceRestInterceptor, "post_list_schemas") as post, mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = schema_service.ListSchemasResponse.to_json(schema_service.ListSchemasResponse())
        req.return_value.content = return_value
...
def test_create_schema_rest_bad_request(request_type=schema_service.CreateSchemaRequest):
    client = SchemaServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/dataStores/sample3"}
    request = request_type(**request_init)
        ...
        "field_configs": [
            {
                ...
                "schema_org_paths": ["schema_org_paths_value1", "schema_org_paths_value2"],
            }
        ],
    }
...
def test_update_schema_rest_bad_request(request_type=schema_service.UpdateSchemaRequest):
    client = SchemaServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_update_schema_rest_call_success(request_type):
    client = SchemaServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_delete_schema_rest_bad_request(request_type=schema_service.DeleteSchemaRequest):
    client = SchemaServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/dataStores/sample3/schemas/sample4"}
    request = request_type(**request_init)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_schema_empty_call_rest():
    client = SchemaServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_schema_service_base_transport():
    ...
    with mock.patch("google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceTransport.__init__") as Transport:
...
def test_schema_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.SchemaServiceGrpcTransport, grpc_helpers), (transports.SchemaServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

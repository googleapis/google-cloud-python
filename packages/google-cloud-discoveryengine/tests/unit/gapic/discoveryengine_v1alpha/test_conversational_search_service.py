...
from google.cloud.discoveryengine_v1alpha.types import conversational_search_service, search_service
from google.cloud.discoveryengine_v1alpha.types import conversation as gcd_conversation
from google.cloud.discoveryengine_v1alpha.types import answer, common
...
def test_conversational_search_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.conversational_search_service.transports.ConversationalSearchServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_converse_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataStores/*/conversations/*}:converse" % client.transport._host, args[1]
        )
...
def test_create_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/dataStores/*}/conversations" % client.transport._host, args[1])
...
def test_delete_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/dataStores/*/conversations/*}" % client.transport._host, args[1])
...
def test_update_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{conversation.name=projects/*/locations/*/dataStores/*/conversations/*}" % client.transport._host, args[1]
        )
...
def test_get_answer_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/dataStores/*/sessions/*/answers/*}" % client.transport._host, args[1])
        ...
        "messages": [
            {
                ...
                "reply": {
                    "reply": "reply_value",
                    "references": [{"uri": "uri_value", "anchor_text": "anchor_text_value", "start": 558, "end": 311}],
                    "summary": {
...
def test_conversational_search_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.conversational_search_service.transports.ConversationalSearchServiceTransport.__init__"
    ) as Transport:
...
def test_conversational_search_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.conversational_search_service.transports.ConversationalSearchServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

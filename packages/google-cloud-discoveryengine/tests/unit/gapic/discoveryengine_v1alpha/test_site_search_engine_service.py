...
async def test_set_uri_pattern_document_data_async(
    transport: str = "grpc_asyncio", request_type=site_search_engine_service.SetUriPatternDocumentDataRequest
):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_create_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites" % client.transport._host, args[1]
        )
...
def test_get_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1]
        )
...
def test_update_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{target_site.name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1]
        )
...
def test_set_uri_pattern_document_data_rest_required_fields(request_type=site_search_engine_service.SetUriPatternDocumentDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_uri_pattern_document_data._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_uri_pattern_document_data_rest_required_fields(request_type=site_search_engine_service.GetUriPatternDocumentDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_uri_pattern_document_data._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_uri_pattern_document_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_set_uri_pattern_document_data"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_set_uri_pattern_document_data_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_set_uri_pattern_document_data"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_uri_pattern_document_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_get_uri_pattern_document_data"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_get_uri_pattern_document_data_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_get_uri_pattern_document_data"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = site_search_engine_service.GetUriPatternDocumentDataResponse.to_json(

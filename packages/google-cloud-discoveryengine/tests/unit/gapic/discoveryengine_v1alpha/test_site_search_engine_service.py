...
def test_set_uri_pattern_document_data_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseSetUriPatternDocumentData,
        "_BaseSetUriPatternDocumentData__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_get_uri_pattern_document_data_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetUriPatternDocumentData,
        "_BaseGetUriPatternDocumentData__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

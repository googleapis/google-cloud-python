...
from google.cloud.discoveryengine_v1alpha.services.user_event_service import UserEventServiceAsyncClient, UserEventServiceClient, transports
...
def test_user_event_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.user_event_service.transports.UserEventServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_write_user_event_rest_call_success(request_type):
    ...
    request_init["user_event"] = {
        ...
        "panel": {"panel_id": "panel_id_value", "display_name": "display_name_value", "panel_position": 1508, "total_panels": 1286},
        "search_info": {"search_query": "search_query_value", "order_by": "order_by_value", "offset": 647},
        "completion_info": {"selected_suggestion": "selected_suggestion_value", "selected_position": 1821},
        "transaction_info": {
            "value": 0.541,
        ...
        "promotion_ids": ["promotion_ids_value1", "promotion_ids_value2"],
        "attributes": {},
        "media_info": {"media_progress_duration": {"seconds": 751, "nanos": 543}, "media_progress_percentage": 0.2641},
    }
...
def test_user_event_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.user_event_service.transports.UserEventServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

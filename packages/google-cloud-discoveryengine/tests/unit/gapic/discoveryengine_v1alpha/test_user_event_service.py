...
from google.cloud.discoveryengine_v1alpha.services.user_event_service import (
...
def test_user_event_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.user_event_service.transports.UserEventServiceTransport.__init__"
    ) as Transport:

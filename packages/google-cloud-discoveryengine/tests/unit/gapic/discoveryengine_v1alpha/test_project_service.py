...
from google.cloud.discoveryengine_v1alpha.services.project_service import (
...
def test_project_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.project_service.transports.ProjectServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_report_consent_change(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.report_consent_change), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_report_consent_change_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.report_consent_change
...
@pytest.mark.asyncio
async def test_report_consent_change_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.report_consent_change
            in client._client._transport._wrapped_methods
        )
...
def test_get_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*}" % client.transport._host, args[1]
        )
...
def test_provision_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*}:provision" % client.transport._host, args[1]
        )
...
def test_report_consent_change_rest_required_fields(
    request_type=project_service.ReportConsentChangeRequest,
):
    transport_class = transports.ProjectServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).report_consent_change._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_report_consent_change_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ProjectServiceRestInterceptor, "post_report_consent_change"
    ) as post, mock.patch.object(
        transports.ProjectServiceRestInterceptor, "pre_report_consent_change"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = project_service.ReportConsentChangeRequest.pb(
            project_service.ReportConsentChangeRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_report_consent_change_rest_bad_request(
    transport: str = "rest", request_type=project_service.ReportConsentChangeRequest
):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_report_consent_change_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{project=projects/*}:reportConsentChange"
...
def test_project_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.project_service.transports.ProjectServiceTransport.__init__"
    ) as Transport:
...
def test_project_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.discoveryengine_v1alpha.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

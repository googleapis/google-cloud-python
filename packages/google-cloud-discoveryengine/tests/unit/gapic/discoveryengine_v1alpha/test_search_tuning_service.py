...
from google.cloud.discoveryengine_v1alpha.services.search_tuning_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SearchTuningServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_train_custom_model_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.train_custom_model] = (
            mock_rpc
        )
        request = {}
...
def test_list_custom_models_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_custom_models] = (
            mock_rpc
        )
        request = {}
...
def test_list_custom_models_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = search_tuning_service.ListCustomModelsResponse.to_json(
            search_tuning_service.ListCustomModelsResponse()
        )
        req.return_value.content = return_value

...
from google.cloud.discoveryengine_v1alpha.services.recommendation_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        RecommendationServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RecommendationServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        RecommendationServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RecommendationServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        RecommendationServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        RecommendationServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )


def test__read_environment_variables():
    assert RecommendationServiceClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RecommendationServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert RecommendationServiceClient._use_client_cert_effective() is False
...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                RecommendationServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(RecommendationServiceClient),
)
@mock.patch.object(
    RecommendationServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(RecommendationServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = RecommendationServiceClient._DEFAULT_UNIVERSE
    default_endpoint = RecommendationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = RecommendationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == RecommendationServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        RecommendationServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        RecommendationServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        RecommendationServiceClient._get_universe_domain(None, None)
        == RecommendationServiceClient._DEFAULT_UNIVERSE
    )
...
def test_recommendation_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_recommendation_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [RecommendationServiceClient, RecommendationServiceAsyncClient]
)
@mock.patch.object(
    RecommendationServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RecommendationServiceClient),
)
@mock.patch.object(
    RecommendationServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(RecommendationServiceAsyncClient),
)
...
def test_recommendation_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_recommendation_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_recommendation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.recommendation_service.transports.RecommendationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_recommendation_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_recommend_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.recommend
...
def test_recommend_rest_required_fields(
    request_type=recommendation_service.RecommendRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).recommend._get_unset_required_fields(jsonified_request)
...
def test_recommend_rest_bad_request(
    request_type=recommendation_service.RecommendRequest,
):
    client = RecommendationServiceClient(
...
def test_recommend_rest_interceptors(null_interceptor):
    transport = transports.RecommendationServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.RecommendationServiceRestInterceptor(),
    )
    client = RecommendationServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.RecommendationServiceRestInterceptor, "post_recommend"
        ) as post,
        mock.patch.object(
            transports.RecommendationServiceRestInterceptor,
            "post_recommend_with_metadata",
        ) as post_with_metadata,
        mock.patch.object(
            transports.RecommendationServiceRestInterceptor, "pre_recommend"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = recommendation_service.RecommendRequest.pb(
            recommendation_service.RecommendRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = recommendation_service.RecommendResponse.to_json(
            recommendation_service.RecommendResponse()
        )
...
def test_recommendation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.recommendation_service.transports.RecommendationServiceTransport.__init__"
    ) as Transport:
...
def test_document_path():
    ...
    actual = RecommendationServiceClient.document_path(
...
def test_serving_config_path():
    ...
    actual = RecommendationServiceClient.serving_config_path(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.RecommendationServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = RecommendationServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

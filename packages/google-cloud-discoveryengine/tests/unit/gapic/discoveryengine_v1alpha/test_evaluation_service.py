...
from google.cloud.discoveryengine_v1alpha.services.evaluation_service import EvaluationServiceAsyncClient
from google.cloud.discoveryengine_v1alpha.services.evaluation_service import EvaluationServiceClient
...
def test__get_default_mtls_endpoint():
    ...
    assert EvaluationServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert EvaluationServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert EvaluationServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert EvaluationServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert EvaluationServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert EvaluationServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert EvaluationServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert EvaluationServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EvaluationServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EvaluationServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_api_endpoint():
    ...
    assert EvaluationServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EvaluationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EvaluationServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EvaluationServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EvaluationServiceClient._get_api_endpoint(None, None, default_universe, "always") == EvaluationServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EvaluationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EvaluationServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EvaluationServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EvaluationServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EvaluationServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EvaluationServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EvaluationServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert EvaluationServiceClient._get_universe_domain(None, None) == EvaluationServiceClient._DEFAULT_UNIVERSE
...
def test_evaluation_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.evaluation_service.transports.EvaluationServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_get_evaluation_async(transport: str = 'grpc_asyncio', request_type=evaluation_service.GetEvaluationRequest):
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_evaluations_async(transport: str = 'grpc_asyncio', request_type=evaluation_service.ListEvaluationsRequest):
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(evaluation_service.ListEvaluationsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_create_evaluation(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_evaluation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_evaluation_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_evaluation] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_evaluation_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EvaluationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_evaluation in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_evaluation] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_evaluation_async(transport: str = 'grpc_asyncio', request_type=evaluation_service.CreateEvaluationRequest):
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_evaluation_results_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_evaluation_results in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_evaluation_results] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_evaluation_results_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EvaluationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_evaluation_results in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_evaluation_results] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_evaluation_results_async(transport: str = 'grpc_asyncio', request_type=evaluation_service.ListEvaluationResultsRequest):
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(evaluation_service.ListEvaluationResultsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_evaluation_results_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, evaluation_service.ListEvaluationResultsResponse.EvaluationResult)
                   for i in results)
...
async def test_list_evaluation_results_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_evaluation_results(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_evaluation_rest_required_fields(request_type=evaluation_service.GetEvaluationRequest):
...
def test_get_evaluation_rest_unset_required_fields():
    transport = transports.EvaluationServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_evaluation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'name': 'projects/sample1/locations/sample2/evaluations/sample3'}
        ...
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/evaluations/*}" % client.transport._host, args[1])
...
def test_list_evaluations_rest_required_fields(request_type=evaluation_service.ListEvaluationsRequest):
    transport_class = transports.EvaluationServiceRestTransport
...
def test_list_evaluations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*}/evaluations" % client.transport._host, args[1])
...
def test_list_evaluations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(evaluation_service.ListEvaluationsResponse.to_json(x) for x in response)
...
def test_create_evaluation_rest_required_fields(request_type=evaluation_service.CreateEvaluationRequest):
    transport_class = transports.EvaluationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_evaluation._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_evaluation_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "evaluation", )))
...
def test_list_evaluation_results_rest_required_fields(request_type=evaluation_service.ListEvaluationResultsRequest):
    transport_class = transports.EvaluationServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_evaluation_results._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_evaluation_results_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", )) & set(("evaluation", )))
...
def test_list_evaluation_results_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'evaluation': 'projects/sample1/locations/sample2/evaluations/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{evaluation=projects/*/locations/*/evaluations/*}:listResults" % client.transport._host, args[1])
...
def test_list_evaluation_results_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(evaluation_service.ListEvaluationResultsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_evaluation_results_empty_call_grpc():
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = evaluation_service.ListEvaluationResultsResponse()
        client.list_evaluation_results(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_evaluation_results_empty_call_grpc_asyncio():
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_evaluation_results(request=None)
...
def test_get_evaluation_rest_bad_request(request_type=evaluation_service.GetEvaluationRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_get_evaluation") as post, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_get_evaluation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "pre_get_evaluation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = evaluation_service.GetEvaluationRequest.pb(evaluation_service.GetEvaluationRequest())
...
def test_list_evaluations_rest_bad_request(request_type=evaluation_service.ListEvaluationsRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_evaluations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_list_evaluations") as post, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_list_evaluations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "pre_list_evaluations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = evaluation_service.ListEvaluationsRequest.pb(evaluation_service.ListEvaluationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = evaluation_service.ListEvaluationsResponse.to_json(evaluation_service.ListEvaluationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = evaluation_service.ListEvaluationsResponse(), metadata
...
def test_create_evaluation_rest_bad_request(request_type=evaluation_service.CreateEvaluationRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_evaluation_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["evaluation"] = {'name': 'name_value', 'evaluation_spec': {'search_request': {'serving_config': 'serving_config_value', 'branch': 'branch_value', 'query': 'query_value', 'image_query': {'image_bytes': 'image_bytes_value'}, 'page_size': 951, 'page_token': 'page_token_value', 'offset': 647, 'data_store_specs': [{'data_store': 'data_store_value'}], 'filter': 'filter_value', 'canonical_filter': 'canonical_filter_value', 'order_by': 'order_by_value', 'user_info': {'user_id': 'user_id_value', 'user_agent': 'user_agent_value'}, 'language_code': 'language_code_value', 'region_code': 'region_code_value', 'facet_specs': [{'facet_key': {'key': 'key_value', 'intervals': [{'minimum': 0.764, 'exclusive_minimum': 0.18430000000000002, 'maximum': 0.766, 'exclusive_maximum': 0.1845}], 'restricted_values': ['restricted_values_value1', 'restricted_values_value2'], 'prefixes': ['prefixes_value1', 'prefixes_value2'], 'contains': ['contains_value1', 'contains_value2'], 'case_insensitive': True, 'order_by': 'order_by_value'}, 'limit': 543, 'excluded_filter_keys': ['excluded_filter_keys_value1', 'excluded_filter_keys_value2'], 'enable_dynamic_position': True}], 'boost_spec': {'condition_boost_specs': [{'condition': 'condition_value', 'boost': 0.551, 'boost_control_spec': {'field_name': 'field_name_value', 'attribute_type': 1, 'interpolation_type': 1, 'control_points': [{'attribute_value': 'attribute_value_value', 'boost_amount': 0.1306}]}}]}, 'params': {}, 'query_expansion_spec': {'condition': 1, 'pin_unexpanded_results': True}, 'spell_correction_spec': {'mode': 1}, 'user_pseudo_id': 'user_pseudo_id_value', 'content_search_spec': {'snippet_spec': {'max_snippet_count': 1840, 'reference_only': True, 'return_snippet': True}, 'summary_spec': {'summary_result_count': 2196, 'include_citations': True, 'ignore_adversarial_query': True, 'ignore_non_summary_seeking_query': True, 'ignore_low_relevant_content': True, 'model_prompt_spec': {'preamble': 'preamble_value'}, 'language_code': 'language_code_value', 'model_spec': {'version': 'version_value'}, 'use_semantic_chunks': True}, 'extractive_content_spec': {'max_extractive_answer_count': 2907, 'max_extractive_segment_count': 3006, 'return_extractive_segment_score': True, 'num_previous_segments': 2289, 'num_next_segments': 1843}, 'search_result_mode': 1, 'chunk_spec': {'num_previous_chunks': 2071, 'num_next_chunks': 1625}}, 'embedding_spec': {'embedding_vectors': [{'field_path': 'field_path_value', 'vector': [0.66, 0.661]}]}, 'ranking_expression': 'ranking_expression_value', 'ranking_expression_backend': 3, 'safe_search': True, 'user_labels': {}, 'natural_language_query_understanding_spec': {'filter_extraction_condition': 1, 'geo_search_query_detection_field_names': ['geo_search_query_detection_field_names_value1', 'geo_search_query_detection_field_names_value2']}, 'search_as_you_type_spec': {'condition': 1}, 'custom_fine_tuning_spec': {'enable_search_adaptor': True}, 'session': 'session_value', 'session_spec': {'query_id': 'query_id_value', 'search_result_persistence_count': 3328}, 'relevance_threshold': 1}, 'query_set_spec': {'sample_query_set': 'sample_query_set_value'}}, 'quality_metrics': {'doc_recall': {'top_1': 0.483, 'top_3': 0.485, 'top_5': 0.487, 'top_10': 0.531}, 'doc_precision': {}, 'doc_ndcg': {}, 'page_recall': {}, 'page_ndcg': {}}, 'state': 1, 'error': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'create_time': {'seconds': 751, 'nanos': 543}, 'end_time': {}, 'error_samples': {}}
...
def test_create_evaluation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_create_evaluation") as post, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_create_evaluation_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "pre_create_evaluation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = evaluation_service.CreateEvaluationRequest.pb(evaluation_service.CreateEvaluationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_evaluation(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_evaluation_results_rest_bad_request(request_type=evaluation_service.ListEvaluationResultsRequest):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'evaluation': 'projects/sample1/locations/sample2/evaluations/sample3'}
    request = request_type(**request_init)
...
def test_list_evaluation_results_rest_call_success(request_type):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_evaluation_results_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_list_evaluation_results") as post, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "post_list_evaluation_results_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EvaluationServiceRestInterceptor, "pre_list_evaluation_results") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = evaluation_service.ListEvaluationResultsRequest.pb(evaluation_service.ListEvaluationResultsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = evaluation_service.ListEvaluationResultsResponse.to_json(evaluation_service.ListEvaluationResultsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = evaluation_service.ListEvaluationResultsResponse(), metadata

        client.list_evaluation_results(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_evaluation_results_empty_call_rest():
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_evaluation_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.evaluation_service.transports.EvaluationServiceTransport.__init__') as Transport:
...
def test_evaluation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.evaluation_service.transports.EvaluationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_evaluation_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.evaluation_service.transports.EvaluationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EvaluationServiceTransport()
        adc.assert_called_once()
...
def test_branch_path():
    ...
    data_store = "whelk"
    branch = "octopus"
    expected = "projects/{project}/locations/{location}/dataStores/{data_store}/branches/{branch}".format(project=project, location=location, data_store=data_store, branch=branch, )
...
def test_evaluation_path():
    ...
    location = "octopus"
    evaluation = "oyster"
    expected = "projects/{project}/locations/{location}/evaluations/{evaluation}".format(project=project, location=location, evaluation=evaluation, )
...
def test_sample_query_path():
    ...
    actual = EvaluationServiceClient.sample_query_path(project, location, sample_query_set, sample_query)
    assert expected == actual
...
def test_sample_query_set_path():
    ...
    actual = EvaluationServiceClient.sample_query_set_path(project, location, sample_query_set)
    assert expected == actual
...
def test_serving_config_path():
    ...
    actual = EvaluationServiceClient.serving_config_path(project, location, data_store, serving_config)
    assert expected == actual
...
def test_session_path():
    ...
    actual = EvaluationServiceClient.session_path(project, location, data_store, session)
    assert expected == actual

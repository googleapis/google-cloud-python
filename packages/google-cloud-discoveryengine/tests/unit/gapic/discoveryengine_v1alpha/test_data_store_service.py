...
def test_data_store_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.data_store_service.transports.DataStoreServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_document_processing_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_document_processing_config), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_get_document_processing_config_async(
    transport: str = "grpc_asyncio", request_type=data_store_service.GetDocumentProcessingConfigRequest
):
    client = DataStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_update_document_processing_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_document_processing_config), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_update_document_processing_config_async(
    transport: str = "grpc_asyncio", request_type=data_store_service.UpdateDocumentProcessingConfigRequest
):
    client = DataStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_get_document_processing_config_rest_required_fields(request_type=data_store_service.GetDocumentProcessingConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_document_processing_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_document_processing_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataStores/*/documentProcessingConfig}" % client.transport._host, args[1]
        )
...
def test_update_document_processing_config_rest_required_fields(request_type=data_store_service.UpdateDocumentProcessingConfigRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_document_processing_config._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_document_processing_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{document_processing_config.name=projects/*/locations/*/dataStores/*/documentProcessingConfig}" % client.transport._host,
            args[1],
        )
...
def test_create_data_store_rest_call_success(request_type):
    ...
    request_init["data_store"] = {
        ...
        "acl_enabled": True,
        "workspace_config": {"type_": 1, "dasher_customer_id": "dasher_customer_id_value"},
...
def test_get_document_processing_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.DataStoreServiceRestInterceptor, "post_get_document_processing_config") as post, mock.patch.object(
        transports.DataStoreServiceRestInterceptor, "post_get_document_processing_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_document_processing_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.DataStoreServiceRestInterceptor, "post_update_document_processing_config"
    ) as post, mock.patch.object(
        transports.DataStoreServiceRestInterceptor, "post_update_document_processing_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.DataStoreServiceRestInterceptor, "pre_update_document_processing_config"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_data_store_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.data_store_service.transports.DataStoreServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

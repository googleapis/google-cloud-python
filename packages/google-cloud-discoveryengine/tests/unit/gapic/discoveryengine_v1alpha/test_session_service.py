...
from google.cloud.discoveryengine_v1alpha.services.session_service import SessionServiceAsyncClient, SessionServiceClient, pagers, transports
from google.cloud.discoveryengine_v1alpha.types import answer, conversational_search_service
...
def test__get_default_mtls_endpoint():
    ...
    assert SessionServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SessionServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SessionServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SessionServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SessionServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SessionServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SessionServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SessionServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SessionServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SessionServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SessionServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert SessionServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SessionServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(SessionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionServiceClient))
@mock.patch.object(SessionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SessionServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SessionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SessionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SessionServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        SessionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SessionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SessionServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SessionServiceClient._get_api_endpoint(None, None, default_universe, "always") == SessionServiceClient.DEFAULT_MTLS_ENDPOINT
    assert (
        SessionServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SessionServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert SessionServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SessionServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SessionServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SessionServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SessionServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SessionServiceClient._get_universe_domain(None, None) == SessionServiceClient._DEFAULT_UNIVERSE
...
def test_session_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SessionServiceAsyncClient, transports.SessionServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (SessionServiceClient, transports.SessionServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(SessionServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionServiceClient))
@mock.patch.object(SessionServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SessionServiceAsyncClient))
def test_session_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SessionServiceAsyncClient, transports.SessionServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (SessionServiceClient, transports.SessionServiceGrpcTransport, "grpc", "false"),
        (SessionServiceAsyncClient, transports.SessionServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_session_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [SessionServiceClient, SessionServiceAsyncClient])
@mock.patch.object(SessionServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SessionServiceClient))
@mock.patch.object(SessionServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(SessionServiceAsyncClient))
...
def test_session_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (SessionServiceClient, transports.SessionServiceGrpcTransport, "grpc", grpc_helpers),
        (SessionServiceAsyncClient, transports.SessionServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (SessionServiceClient, transports.SessionServiceRestTransport, "rest", None),
    ],
)
def test_session_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_session_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.session_service.transports.SessionServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = SessionServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_session_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    "request_type",
    [
        session_service.ListFilesRequest,
        dict,
    ],
)
def test_list_files(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_files), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = session_service.ListFilesResponse(
            next_page_token="next_page_token_value",
        )
...
def test_list_files_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.list_files), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == session_service.ListFilesRequest(
            parent="parent_value",
            filter="filter_value",
            page_token="page_token_value",
        )
...
async def test_list_files_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_files in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_files] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_files_async(transport: str = "grpc_asyncio", request_type=session_service.ListFilesRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_files_field_headers_async():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_files), "__call__") as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(session_service.ListFilesResponse())
        await client.list_files(request)
...
def test_list_files_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_files), "__call__") as call:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, session.FileMetadata) for i in results)
...
async def test_list_files_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_files), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        assert len(responses) == 6
        assert all(isinstance(i, session.FileMetadata) for i in responses)
...
async def test_list_files_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_files), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.list_files(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_session_rest_unset_required_fields():
    transport = transports.SessionServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1alpha/{parent=projects/*/locations/*/dataStores/*}/sessions" % client.transport._host, args[1])
...
def test_delete_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{name=projects/*/locations/*/dataStores/*/sessions/*}" % client.transport._host, args[1])
...
def test_update_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1alpha/{session.name=projects/*/locations/*/dataStores/*/sessions/*}" % client.transport._host, args[1])
...
def test_list_files_rest_required_fields(request_type=session_service.ListFilesRequest):
    transport_class = transports.SessionServiceRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = session_service.ListFilesResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, "request") as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = session_service.ListFilesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "projects/sample1/locations/sample2/collections/sample3/engines/sample4/sessions/sample5"}
        ...
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*/sessions/*}/files" % client.transport._host, args[1]
        )
...
def test_list_files_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(session_service.ListFilesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = SessionServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = SessionServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = SessionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = SessionServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SessionServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SessionServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_session_rest_bad_request(request_type=conversational_search_service.CreateSessionRequest):
    client = SessionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
                    ...
                    "references": [
                        {
                            ...
                            "structured_document_info": {"document": "document_value", "struct_data": {}},
                        }
                    ],
...
def test_create_session_rest_interceptors(null_interceptor):
    transport = transports.SessionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SessionServiceRestInterceptor(),
    )
    client = SessionServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionServiceRestInterceptor, "post_create_session") as post, mock.patch.object(
...
def test_delete_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionServiceRestInterceptor, "pre_delete_session") as pre:
        pre.assert_not_called()
...
def test_update_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionServiceRestInterceptor, "post_update_session") as post, mock.patch.object(
...
def test_get_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionServiceRestInterceptor, "post_get_session") as post, mock.patch.object(
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionServiceRestInterceptor, "post_list_sessions") as post, mock.patch.object(
...
def test_list_files_rest_bad_request(request_type=session_service.ListFilesRequest):
    client = SessionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/collections/sample3/engines/sample4/sessions/sample5"}
    request = request_type(**request_init)
...
def test_list_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SessionServiceRestInterceptor, "post_list_files") as post, mock.patch.object(
        transports.SessionServiceRestInterceptor, "post_list_files_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SessionServiceRestInterceptor, "pre_list_files"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.ListFilesRequest.pb(session_service.ListFilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_service.ListFilesResponse.to_json(session_service.ListFilesResponse())
        req.return_value.content = return_value
        ...
        pre.return_value = request, metadata
        post.return_value = session_service.ListFilesResponse()
        post_with_metadata.return_value = session_service.ListFilesResponse(), metadata
...
def test_session_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.SessionServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_session_service_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.discoveryengine_v1alpha.services.session_service.transports.SessionServiceTransport.__init__") as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.SessionServiceGrpcTransport, grpc_helpers), (transports.SessionServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
@pytest.mark.parametrize("transport_class", [transports.SessionServiceGrpcTransport, transports.SessionServiceGrpcAsyncIOTransport])
...
def test_session_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.SessionServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.SessionServiceGrpcTransport, transports.SessionServiceGrpcAsyncIOTransport])
def test_session_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_answer_path():
    ...
    actual = SessionServiceClient.answer_path(project, location, data_store, session, answer)
...
def test_parse_answer_path():
    ...
    path = SessionServiceClient.answer_path(**expected)
...
def test_chunk_path():
    ...
    actual = SessionServiceClient.chunk_path(project, location, data_store, branch, document, chunk)
    assert expected == actual
...
def test_parse_chunk_path():
    ...
    path = SessionServiceClient.chunk_path(**expected)

    # Check that the path construction is reversible.
    actual = SessionServiceClient.parse_chunk_path(path)
    assert expected == actual
...
def test_data_store_path():
    ...
    actual = SessionServiceClient.data_store_path(project, location, data_store)
    assert expected == actual
...
def test_parse_data_store_path():
    ...
    path = SessionServiceClient.data_store_path(**expected)

    # Check that the path construction is reversible.
    actual = SessionServiceClient.parse_data_store_path(path)
    assert expected == actual
...
def test_document_path():
    ...
    actual = SessionServiceClient.document_path(project, location, data_store, branch, document)
    assert expected == actual
...
def test_parse_document_path():
    ...
    path = SessionServiceClient.document_path(**expected)

    # Check that the path construction is reversible.
    actual = SessionServiceClient.parse_document_path(path)
    assert expected == actual
...
def test_session_path():
    ...
    actual = SessionServiceClient.session_path(project, location, data_store, session)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.SessionServiceTransport, "_prep_wrapped_messages") as prep:
        client = SessionServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = SessionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

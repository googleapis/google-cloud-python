...
from google.cloud.discoveryengine_v1alpha.services.session_service import (
...
def test_create_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSession,
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/dataStores/*}/sessions"
...
def test_delete_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSession,
...
def test_delete_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{name=projects/*/locations/*/dataStores/*/sessions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSession,
...
def test_update_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{session.name=projects/*/locations/*/dataStores/*/sessions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_get_session_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSession,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("includeAnswerDetails",))
...
def test_list_sessions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSessions,
...
def test_list_files_rest_required_fields(request_type=session_service.ListFilesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListFiles,
...
def test_list_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "parent": "projects/sample1/locations/sample2/collections/sample3/engines/sample4/sessions/sample5"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1alpha/{parent=projects/*/locations/*/collections/*/engines/*/sessions/*}/files"
            % client.transport._host,
            args[1],
        )
...
def test_list_files_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.SessionServiceRestInterceptor, "post_list_files"
        ) as post,
        mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.ListFilesRequest.pb(
            session_service.ListFilesRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_service.ListFilesResponse.to_json(
            session_service.ListFilesResponse()
        )
        req.return_value.content = return_value
...
def test_session_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1alpha.services.session_service.transports.SessionServiceTransport.__init__"
    ) as Transport:
...
def test_answer_path():
    ...
    actual = SessionServiceClient.answer_path(
...
def test_chunk_path():
    ...
    actual = SessionServiceClient.chunk_path(
...
def test_document_path():
    ...
    actual = SessionServiceClient.document_path(

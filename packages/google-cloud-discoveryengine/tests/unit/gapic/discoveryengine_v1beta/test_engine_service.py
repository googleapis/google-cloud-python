...
from google.cloud.discoveryengine_v1beta.services.engine_service import EngineServiceAsyncClient, EngineServiceClient, pagers, transports
...
def test_engine_service_client_client_options_from_dict():
    with mock.patch("google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceGrpcTransport.__init__") as grpc_transport:
...
def test_create_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/collections/*}/engines" % client.transport._host, args[1])
...
def test_delete_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}" % client.transport._host, args[1])
...
def test_update_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{engine.name=projects/*/locations/*/collections/*/engines/*}" % client.transport._host, args[1])
...
def test_pause_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:pause" % client.transport._host, args[1])
...
def test_resume_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:resume" % client.transport._host, args[1])
...
def test_tune_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:tune" % client.transport._host, args[1])
...
def test_pause_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EngineServiceRestInterceptor, "post_pause_engine") as post, mock.patch.object(
...
def test_resume_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.EngineServiceRestInterceptor, "post_resume_engine") as post, mock.patch.object(
...
def test_engine_service_base_transport():
    ...
    with mock.patch("google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceTransport.__init__") as Transport:
...
def test_engine_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

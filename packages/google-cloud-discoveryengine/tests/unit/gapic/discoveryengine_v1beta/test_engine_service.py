...
from google.cloud.discoveryengine_v1beta.services.engine_service import (
...
def test_engine_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.asyncio
async def test_pause_engine_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.pause_engine
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_resume_engine_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.resume_engine
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_tune_engine_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.tune_engine
            in client._client._transport._wrapped_methods
        )
...
def test_create_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/collections/*}/engines"
...
def test_delete_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{engine.name=projects/*/locations/*/collections/*/engines/*}"
            % client.transport._host,
            args[1],
        )
...
def test_pause_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BasePauseEngine,
...
def test_pause_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:pause"
            % client.transport._host,
            args[1],
        )
...
def test_resume_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseResumeEngine,
...
def test_resume_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:resume"
            % client.transport._host,
            args[1],
        )
...
def test_tune_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseTuneEngine,
...
def test_tune_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/collections/*/engines/*}:tune"
            % client.transport._host,
            args[1],
        )
...
def test_engine_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.engine_service.transports.EngineServiceTransport.__init__"
    ) as Transport:

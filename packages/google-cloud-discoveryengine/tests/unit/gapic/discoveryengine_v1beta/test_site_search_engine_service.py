...
from google.cloud.discoveryengine_v1beta.services.site_search_engine_service import SiteSearchEngineServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.site_search_engine_service import SiteSearchEngineServiceClient
from google.cloud.discoveryengine_v1beta.services.site_search_engine_service import pagers
from google.cloud.discoveryengine_v1beta.services.site_search_engine_service import transports
...
def test_site_search_engine_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1beta.services.site_search_engine_service.transports.SiteSearchEngineServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_sitemap(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_sitemap),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_sitemap(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_sitemap),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_fetch_sitemaps(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_sitemaps),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites" % client.transport._host, args[1])
...
def test_get_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1])
...
def test_update_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{target_site.name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1])
...
def test_create_sitemap_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "sitemap", )))
...
def test_create_sitemap_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/sitemaps" % client.transport._host, args[1])
...
def test_delete_sitemap_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/sitemaps/*}" % client.transport._host, args[1])
...
def test_fetch_sitemaps_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/sitemaps:fetch" % client.transport._host, args[1])
...
def test_create_sitemap_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_create_sitemap") as post, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_create_sitemap_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "pre_create_sitemap") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.create_sitemap(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_sitemap_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_delete_sitemap") as post, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_delete_sitemap_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "pre_delete_sitemap") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.delete_sitemap(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_sitemaps_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_fetch_sitemaps") as post, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_fetch_sitemaps_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "pre_fetch_sitemaps") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.fetch_sitemaps(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_site_search_engine_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1beta.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport.__init__') as Transport:
...
def test_site_search_engine_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1beta.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_site_search_engine_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1beta.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SiteSearchEngineServiceTransport()
        adc.assert_called_once()
...
def test_sitemap_path():
    ...
    data_store = "whelk"
    sitemap = "octopus"
    expected = "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine/sitemaps/{sitemap}".format(project=project, location=location, data_store=data_store, sitemap=sitemap, )

...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SiteSearchEngineServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SiteSearchEngineServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SiteSearchEngineServiceClient._use_client_cert_effective()
...
@mock.patch.object(
    SiteSearchEngineServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SiteSearchEngineServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        SiteSearchEngineServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        SiteSearchEngineServiceClient._get_api_endpoint(None, None, default_universe, "always") == SiteSearchEngineServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SiteSearchEngineServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == SiteSearchEngineServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_get_site_search_engine(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_site_search_engine), "__call__") as call:
...
async def test_batch_create_target_sites_async(
    transport: str = "grpc_asyncio", request_type=site_search_engine_service.BatchCreateTargetSitesRequest
):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_delete_target_site(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_target_site), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
async def test_list_target_sites_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_target_sites), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            site_search_engine_service.ListTargetSitesResponse(
                target_sites=[
...
async def test_list_target_sites_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_target_sites), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_target_sites(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_create_sitemap_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SiteSearchEngineServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_sitemap in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_sitemap] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_sitemap_async(transport: str = "grpc_asyncio", request_type=site_search_engine_service.CreateSitemapRequest):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_sitemap_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SiteSearchEngineServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_sitemap in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_sitemap] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_sitemap_async(transport: str = "grpc_asyncio", request_type=site_search_engine_service.DeleteSitemapRequest):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_fetch_sitemaps_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SiteSearchEngineServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_sitemaps in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_sitemaps] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_sitemaps_async(transport: str = "grpc_asyncio", request_type=site_search_engine_service.FetchSitemapsRequest):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.fetch_sitemaps), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(site_search_engine_service.FetchSitemapsResponse())
...
async def test_enable_advanced_site_search_async(
    transport: str = "grpc_asyncio", request_type=site_search_engine_service.EnableAdvancedSiteSearchRequest
):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
async def test_batch_verify_target_sites_async(
    transport: str = "grpc_asyncio", request_type=site_search_engine_service.BatchVerifyTargetSitesRequest
):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_fetch_domain_verification_status(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_domain_verification_status), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_fetch_domain_verification_status_async(
    transport: str = "grpc_asyncio", request_type=site_search_engine_service.FetchDomainVerificationStatusRequest
):
    client = SiteSearchEngineServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_fetch_domain_verification_status_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.fetch_domain_verification_status), "__call__") as call:
        ...
        retry = retries.Retry()
        timeout = 5
        expected_metadata = tuple(expected_metadata) + (gapic_v1.routing_header.to_grpc_metadata((("site_search_engine", ""),)),)
...
async def test_fetch_domain_verification_status_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_domain_verification_status), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            site_search_engine_service.FetchDomainVerificationStatusResponse(
                target_sites=[
...
async def test_fetch_domain_verification_status_async_pages():
    ...
    with mock.patch.object(type(client.transport.fetch_domain_verification_status), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.fetch_domain_verification_status(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_site_search_engine_rest_required_fields(request_type=site_search_engine_service.GetSiteSearchEngineRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_site_search_engine._get_unset_required_fields(
        jsonified_request
    )
...
def test_get_site_search_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1beta/{name=projects/*/locations/*/dataStores/*/siteSearchEngine}" % client.transport._host, args[1])
...
def test_create_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites" % client.transport._host, args[1]
        )
...
def test_batch_create_target_sites_rest_required_fields(request_type=site_search_engine_service.BatchCreateTargetSitesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_target_sites._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1]
        )
...
def test_update_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{target_site.name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}" % client.transport._host, args[1]
        )
...
def test_create_sitemap_rest_required_fields(request_type=site_search_engine_service.CreateSitemapRequest):
    transport_class = transports.SiteSearchEngineServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_sitemap._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_sitemap_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/sitemaps" % client.transport._host, args[1]
        )
...
def test_delete_sitemap_rest_required_fields(request_type=site_search_engine_service.DeleteSitemapRequest):
    transport_class = transports.SiteSearchEngineServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_sitemap._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_sitemap_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"name": "projects/sample1/locations/sample2/dataStores/sample3/siteSearchEngine/sitemaps/sample4"}
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/sitemaps/*}" % client.transport._host, args[1]
        )
...
def test_fetch_sitemaps_rest_required_fields(request_type=site_search_engine_service.FetchSitemapsRequest):
    transport_class = transports.SiteSearchEngineServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_sitemaps._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_sitemaps_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/sitemaps:fetch" % client.transport._host, args[1]
        )
...
def test_enable_advanced_site_search_rest_required_fields(request_type=site_search_engine_service.EnableAdvancedSiteSearchRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enable_advanced_site_search._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_disable_advanced_site_search_rest_required_fields(request_type=site_search_engine_service.DisableAdvancedSiteSearchRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).disable_advanced_site_search._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_batch_verify_target_sites_rest_required_fields(request_type=site_search_engine_service.BatchVerifyTargetSitesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_verify_target_sites._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_fetch_domain_verification_status_rest_required_fields(request_type=site_search_engine_service.FetchDomainVerificationStatusRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_domain_verification_status._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = SiteSearchEngineServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = SiteSearchEngineServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SiteSearchEngineServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SiteSearchEngineServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_site_search_engine_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_get_site_search_engine") as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_get_site_search_engine_with_metadata"
...
def test_create_target_site_rest_call_success(request_type):
    ...
    request_init["target_site"] = {
        ...
        "generated_uri_pattern": "generated_uri_pattern_value",
        "root_domain_uri": "root_domain_uri_value",
        "site_verification_info": {"site_verification_state": 1, "verify_time": {"seconds": 751, "nanos": 543}},
        "indexing_status": 1,
        "update_time": {},
...
def test_create_target_site_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_create_target_site_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_create_target_sites_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_batch_create_target_sites"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_batch_create_target_sites_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_batch_create_target_sites"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_target_site_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_get_target_site") as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_get_target_site_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_target_site_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_update_target_site_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_target_site_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_delete_target_site_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_target_sites_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_list_target_sites") as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_list_target_sites_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_sitemap_rest_bad_request(request_type=site_search_engine_service.CreateSitemapRequest):
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/dataStores/sample3/siteSearchEngine"}
    request = request_type(**request_init)
...
def test_create_sitemap_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/dataStores/sample3/siteSearchEngine"}
    request_init["sitemap"] = {"uri": "uri_value", "name": "name_value", "create_time": {"seconds": 751, "nanos": 543}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_sitemap_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_create_sitemap_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = site_search_engine_service.CreateSitemapRequest.pb(site_search_engine_service.CreateSitemapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_sitemap_rest_bad_request(request_type=site_search_engine_service.DeleteSitemapRequest):
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"name": "projects/sample1/locations/sample2/dataStores/sample3/siteSearchEngine/sitemaps/sample4"}
    request = request_type(**request_init)
...
def test_delete_sitemap_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_delete_sitemap_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = site_search_engine_service.DeleteSitemapRequest.pb(site_search_engine_service.DeleteSitemapRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_fetch_sitemaps_rest_bad_request(request_type=site_search_engine_service.FetchSitemapsRequest):
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {"parent": "projects/sample1/locations/sample2/dataStores/sample3/siteSearchEngine"}
    request = request_type(**request_init)
...
def test_fetch_sitemaps_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, "post_fetch_sitemaps") as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_fetch_sitemaps_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = site_search_engine_service.FetchSitemapsRequest.pb(site_search_engine_service.FetchSitemapsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = site_search_engine_service.FetchSitemapsResponse.to_json(site_search_engine_service.FetchSitemapsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = site_search_engine_service.FetchSitemapsResponse(), metadata
...
def test_enable_advanced_site_search_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_enable_advanced_site_search"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_enable_advanced_site_search_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_enable_advanced_site_search"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_disable_advanced_site_search_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_disable_advanced_site_search"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_disable_advanced_site_search_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_disable_advanced_site_search"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_recrawl_uris_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_recrawl_uris_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_batch_verify_target_sites_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_batch_verify_target_sites"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_batch_verify_target_sites_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_batch_verify_target_sites"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_fetch_domain_verification_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.SiteSearchEngineServiceRestInterceptor, "post_fetch_domain_verification_status"
    ) as post, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "post_fetch_domain_verification_status_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.SiteSearchEngineServiceRestInterceptor, "pre_fetch_domain_verification_status"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = site_search_engine_service.FetchDomainVerificationStatusResponse.to_json(
            site_search_engine_service.FetchDomainVerificationStatusResponse()
        )
        req.return_value.content = return_value
...
@pytest.mark.parametrize(
    ...
    [(transports.SiteSearchEngineServiceGrpcTransport, grpc_helpers), (transports.SiteSearchEngineServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_sitemap_path():
    ...
    actual = SiteSearchEngineServiceClient.sitemap_path(project, location, data_store, sitemap)

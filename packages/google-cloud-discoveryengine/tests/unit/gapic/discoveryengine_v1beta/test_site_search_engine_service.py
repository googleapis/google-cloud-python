...
def test_get_site_search_engine_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_site_search_engine] = (
            mock_rpc
        )
        request = {}
...
def test_create_target_site_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_target_site] = (
            mock_rpc
        )
        request = {}
...
def test_update_target_site_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.update_target_site] = (
            mock_rpc
        )
        request = {}
...
def test_delete_target_site_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.delete_target_site] = (
            mock_rpc
        )
        request = {}
...
def test_list_target_sites_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_target_sites] = (
            mock_rpc
        )
        request = {}
...
def test_get_site_search_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSiteSearchEngine,
...
def test_create_target_site_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateTargetSite,
...
def test_batch_create_target_sites_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateTargetSites,
...
def test_get_target_site_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetTargetSite,
...
def test_update_target_site_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateTargetSite,
...
def test_delete_target_site_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteTargetSite,
...
def test_list_target_sites_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListTargetSites,
...
def test_create_sitemap_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSitemap,
...
def test_delete_sitemap_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSitemap,
...
def test_fetch_sitemaps_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseFetchSitemaps,
...
def test_enable_advanced_site_search_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseEnableAdvancedSiteSearch,
...
def test_disable_advanced_site_search_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDisableAdvancedSiteSearch,
...
def test_recrawl_uris_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRecrawlUris,
...
def test_batch_verify_target_sites_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchVerifyTargetSites,
...
def test_fetch_domain_verification_status_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseFetchDomainVerificationStatus,

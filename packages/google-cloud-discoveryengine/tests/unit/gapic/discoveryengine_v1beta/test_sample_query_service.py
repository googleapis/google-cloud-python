...
async def test_get_sample_query_async(request_type, transport: str = "grpc_asyncio"):
    client = SampleQueryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_sample_queries_async(request_type, transport: str = "grpc_asyncio"):
    client = SampleQueryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_sample_queries_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_sample_queries(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_create_sample_query_async(request_type, transport: str = "grpc_asyncio"):
    client = SampleQueryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_sample_query_async(request_type, transport: str = "grpc_asyncio"):
    client = SampleQueryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_sample_query_async(request_type, transport: str = "grpc_asyncio"):
    client = SampleQueryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_sample_query_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetSampleQuery,
...
def test_list_sample_queries_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListSampleQueries,
...
def test_create_sample_query_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateSampleQuery,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("sampleQueryId",))
...
def test_update_sample_query_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateSampleQuery,
...
def test_delete_sample_query_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteSampleQuery,
...
def test_import_sample_queries_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseImportSampleQueries,

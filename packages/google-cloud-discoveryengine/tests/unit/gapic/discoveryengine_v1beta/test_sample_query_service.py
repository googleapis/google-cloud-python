...
def test_get_sample_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = sample_query.SampleQuery.to_json(
            sample_query.SampleQuery()
        )
...
def test_get_sample_query_rest_bad_request(
    transport: str = "rest", request_type=sample_query_service.GetSampleQueryRequest
):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_sample_queries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = (
            sample_query_service.ListSampleQueriesResponse.to_json(
                sample_query_service.ListSampleQueriesResponse()
            )
        )
...
def test_list_sample_queries_rest_bad_request(
    transport: str = "rest", request_type=sample_query_service.ListSampleQueriesRequest
):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_sample_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcd_sample_query.SampleQuery.to_json(
            gcd_sample_query.SampleQuery()
        )
...
def test_create_sample_query_rest_bad_request(
    transport: str = "rest", request_type=sample_query_service.CreateSampleQueryRequest
):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_sample_query_rest_bad_request(
    transport: str = "rest", request_type=sample_query_service.UpdateSampleQueryRequest
):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_sample_query_rest_bad_request(
    transport: str = "rest", request_type=sample_query_service.DeleteSampleQueryRequest
):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_import_sample_queries_rest_bad_request(
    transport: str = "rest", request_type=import_config.ImportSampleQueriesRequest
):
    client = SampleQueryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

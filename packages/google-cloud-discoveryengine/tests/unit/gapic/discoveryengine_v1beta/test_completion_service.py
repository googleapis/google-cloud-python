...
from google.cloud.discoveryengine_v1beta.services.completion_service import CompletionServiceAsyncClient
from google.cloud.discoveryengine_v1beta.services.completion_service import CompletionServiceClient
from google.cloud.discoveryengine_v1beta.services.completion_service import transports
...
def test_completion_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1beta.services.completion_service.transports.CompletionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_advanced_complete_query(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.advanced_complete_query),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_advanced_complete_query_rest_required_fields(request_type=completion_service.AdvancedCompleteQueryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).advanced_complete_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_advanced_complete_query_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("completionConfig", "query", )))
...
def test_advanced_complete_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.CompletionServiceRestInterceptor, "post_advanced_complete_query") as post, \
        mock.patch.object(transports.CompletionServiceRestInterceptor, "post_advanced_complete_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_advanced_complete_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.advanced_complete_query(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_completion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1beta.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_completion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1beta.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompletionServiceTransport()
        adc.assert_called_once()
...
def test_completion_config_path():
    ...
    location = "clam"
    data_store = "whelk"
    expected = "projects/{project}/locations/{location}/dataStores/{data_store}/completionConfig".format(project=project, location=location, data_store=data_store, )

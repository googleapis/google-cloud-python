...
from google.cloud.discoveryengine_v1beta.services.grounded_generation_service import (
    GroundedGenerationServiceAsyncClient,
    GroundedGenerationServiceClient,
    transports,
)
from google.cloud.discoveryengine_v1beta.types import grounded_generation_service, grounding
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert GroundedGenerationServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert GroundedGenerationServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                GroundedGenerationServiceClient._use_client_cert_effective()
...
@mock.patch.object(
    GroundedGenerationServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GroundedGenerationServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        GroundedGenerationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        GroundedGenerationServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == GroundedGenerationServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        GroundedGenerationServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == GroundedGenerationServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = GroundedGenerationServiceClient(credentials=cred)
...
def test_grounded_generation_service_client_get_transport_class():
    transport = GroundedGenerationServiceClient.get_transport_class()
...
@pytest.mark.parametrize("client_class", [GroundedGenerationServiceClient, GroundedGenerationServiceAsyncClient])
...
def test_grounded_generation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = GroundedGenerationServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_stream_generate_grounded_content(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.stream_generate_grounded_content), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = iter([grounded_generation_service.GenerateGroundedContentResponse()])
    ...
    for message in response:
        assert isinstance(message, grounded_generation_service.GenerateGroundedContentResponse)
...
def test_stream_generate_grounded_content_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.stream_generate_grounded_content in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.stream_generate_grounded_content] = mock_rpc
        request = [{}]
...
@pytest.mark.asyncio
async def test_stream_generate_grounded_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.stream_generate_grounded_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stream_generate_grounded_content] = mock_rpc
...
async def test_stream_generate_grounded_content_async(
    transport: str = "grpc_asyncio", request_type=grounded_generation_service.GenerateGroundedContentRequest
):
    client = GroundedGenerationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    ...
    with mock.patch.object(type(client.transport.stream_generate_grounded_content), "__call__") as call:
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[grounded_generation_service.GenerateGroundedContentResponse()])
...
def test_generate_grounded_content(request_type, transport: str = "grpc"):
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, grounded_generation_service.GenerateGroundedContentResponse)
...
def test_generate_grounded_content_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_grounded_content in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_grounded_content] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_grounded_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GroundedGenerationServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_grounded_content in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_grounded_content] = mock_rpc
...
def test_check_grounding_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_check_grounding_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.check_grounding in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_check_grounding_field_headers_async():
    client = GroundedGenerationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_generate_grounded_content_rest_required_fields(request_type=grounded_generation_service.GenerateGroundedContentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_grounded_content._get_unset_required_fields(
        jsonified_request
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = grounded_generation_service.GenerateGroundedContentResponse.pb(return_value)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = GroundedGenerationServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = GroundedGenerationServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = GroundedGenerationServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
    assert client is not None


# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_grounded_content_empty_call_grpc():
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.generate_grounded_content), "__call__") as call:
        call.return_value = grounded_generation_service.GenerateGroundedContentResponse()
        client.generate_grounded_content(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_grounding_empty_call_grpc():
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = GroundedGenerationServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = GroundedGenerationServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_generate_grounded_content_empty_call_grpc_asyncio():
    client = GroundedGenerationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport.generate_grounded_content), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(grounded_generation_service.GenerateGroundedContentResponse())
        await client.generate_grounded_content(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_check_grounding_empty_call_grpc_asyncio():
    client = GroundedGenerationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_transport_kind_rest():
    transport = GroundedGenerationServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_stream_generate_grounded_content_rest_error():
    client = GroundedGenerationServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")

    with pytest.raises(NotImplementedError) as not_implemented_error:
        client.stream_generate_grounded_content({})
    assert "Method StreamGenerateGroundedContent is not available over REST transport" in str(not_implemented_error.value)


def test_generate_grounded_content_rest_bad_request(request_type=grounded_generation_service.GenerateGroundedContentRequest):
    client = GroundedGenerationServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_generate_grounded_content_rest_call_success(request_type):
    client = GroundedGenerationServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_generate_grounded_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.GroundedGenerationServiceRestInterceptor, "post_generate_grounded_content"
    ) as post, mock.patch.object(
        transports.GroundedGenerationServiceRestInterceptor, "post_generate_grounded_content_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GroundedGenerationServiceRestInterceptor, "pre_generate_grounded_content"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = grounded_generation_service.GenerateGroundedContentRequest.pb(grounded_generation_service.GenerateGroundedContentRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = grounded_generation_service.GenerateGroundedContentResponse.to_json(
        ...
        post.return_value = grounded_generation_service.GenerateGroundedContentResponse()
        post_with_metadata.return_value = grounded_generation_service.GenerateGroundedContentResponse(), metadata
...
def test_check_grounding_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GroundedGenerationServiceRestInterceptor, "post_check_grounding") as post, mock.patch.object(
        transports.GroundedGenerationServiceRestInterceptor, "post_check_grounding_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_generate_grounded_content_empty_call_rest():
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_check_grounding_empty_call_rest():
    client = GroundedGenerationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_grounded_generation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceTransport.__init__"
    ) as Transport:
...
def test_grounded_generation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1beta.services.grounded_generation_service.transports.GroundedGenerationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    "transport_class", [transports.GroundedGenerationServiceGrpcTransport, transports.GroundedGenerationServiceGrpcAsyncIOTransport]
)
def test_grounded_generation_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_grounded_generation_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.GroundedGenerationServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_grounded_generation_service_client_transport_session_collision(transport_name):
    ...
    client1 = GroundedGenerationServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = GroundedGenerationServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_grounded_generation_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_parse_grounding_config_path():
    expected = {
        "project": "octopus",
        "location": "oyster",
        "grounding_config": "nudibranch",
    }
    path = GroundedGenerationServiceClient.grounding_config_path(**expected)
...
def test_serving_config_path():
    ...
    actual = GroundedGenerationServiceClient.serving_config_path(project, location, data_store, serving_config)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    # Check that the path construction is reversible.
    actual = GroundedGenerationServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_ctx():
    ...
    for transport in transports:
        client = GroundedGenerationServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

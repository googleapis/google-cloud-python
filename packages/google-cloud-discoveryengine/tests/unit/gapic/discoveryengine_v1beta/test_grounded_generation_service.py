...
def test_generate_grounded_content_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGenerateGroundedContent,
        "_BaseGenerateGroundedContent__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_check_grounding_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCheckGrounding,
        "_BaseCheckGrounding__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

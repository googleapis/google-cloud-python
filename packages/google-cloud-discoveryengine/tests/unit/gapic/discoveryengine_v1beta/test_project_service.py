...
from google.cloud.discoveryengine_v1beta.services.project_service import (
...
def test_project_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.project_service.transports.ProjectServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_provision_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{name=projects/*}:provision" % client.transport._host, args[1]
        )
...
def test_project_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.project_service.transports.ProjectServiceTransport.__init__"
    ) as Transport:
...
def test_project_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.discoveryengine_v1beta.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

...
def test_converse_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/dataStores/*/conversations/*}:converse" % client.transport._host, args[1]
        )
...
def test_update_conversation_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{conversation.name=projects/*/locations/*/dataStores/*/conversations/*}" % client.transport._host, args[1]
        )

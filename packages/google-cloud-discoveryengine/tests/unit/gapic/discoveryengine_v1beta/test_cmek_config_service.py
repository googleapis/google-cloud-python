...
from google.cloud.discoveryengine_v1beta.services.cmek_config_service import (
...
def test_cmek_config_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.cmek_config_service.transports.CmekConfigServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_update_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta/{config.name=projects/*/locations/*/cmekConfig}"
...
def test_get_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/cmekConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_list_cmek_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/cmekConfigs"
            % client.transport._host,
            args[1],
        )
...
def test_delete_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/cmekConfigs/*}"
            % client.transport._host,
            args[1],
        )
...
def test_cmek_config_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.cmek_config_service.transports.CmekConfigServiceTransport.__init__"
    ) as Transport:
...
def test_cmek_config_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.discoveryengine_v1beta.services.cmek_config_service.transports.CmekConfigServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None

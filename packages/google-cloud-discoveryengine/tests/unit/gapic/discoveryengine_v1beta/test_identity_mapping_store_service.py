...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = IdentityMappingStoreServiceClient(credentials=cred)
...
def test_identity_mapping_store_service_client_get_transport_class():
    transport = IdentityMappingStoreServiceClient.get_transport_class()
...
def test_identity_mapping_store_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.transports.IdentityMappingStoreServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_identity_mapping_store_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_identity_mapping_store_flattened_error():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_identity_mapping_store_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_identity_mapping_store_flattened_error():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_identity_mapping_store_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_identity_mapping_store_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_identity_mapping_store_flattened_error():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_import_identity_mappings_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_import_identity_mappings_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_purge_identity_mappings_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_purge_identity_mappings_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_identity_mappings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_identity_mappings] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_identity_mappings_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_identity_mappings_async_pages():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_list_identity_mapping_stores_field_headers_async():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_identity_mapping_stores_flattened_error():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_identity_mapping_stores_pager(transport_name: str = "grpc"):
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
...
@pytest.mark.asyncio
async def test_list_identity_mapping_stores_async_pages():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_identity_mapping_store_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = IdentityMappingStoreServiceClient(
...
def test_create_identity_mapping_store_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateIdentityMappingStore,
...
def test_create_identity_mapping_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.create_identity_mapping_store(**mock_args)
        ...
        assert path_template.validate(
            "%s/v1beta/{parent=projects/*/locations/*}/identityMappingStores"
...
def test_get_identity_mapping_store_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = IdentityMappingStoreServiceClient(
...
def test_get_identity_mapping_store_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetIdentityMappingStore,
...
def test_get_identity_mapping_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.get_identity_mapping_store(**mock_args)
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta/{name=projects/*/locations/*/identityMappingStores/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_identity_mapping_store_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = IdentityMappingStoreServiceClient(
...
def test_delete_identity_mapping_store_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteIdentityMappingStore,
...
def test_delete_identity_mapping_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_identity_mapping_store(**mock_args)
...
def test_import_identity_mappings_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = IdentityMappingStoreServiceClient(
...
def test_import_identity_mappings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseImportIdentityMappings,
...
def test_purge_identity_mappings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BasePurgeIdentityMappings,
...
def test_list_identity_mappings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListIdentityMappings,
...
def test_list_identity_mapping_stores_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = IdentityMappingStoreServiceClient(
...
def test_list_identity_mapping_stores_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListIdentityMappingStores,
...
def test_list_identity_mapping_stores_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_identity_mapping_stores(**mock_args)
...
def test_create_identity_mapping_store_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_identity_mapping_store_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_identity_mapping_store_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_identity_mappings_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_purge_identity_mappings_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_identity_mappings_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_identity_mapping_stores_empty_call_grpc():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_identity_mapping_store_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_identity_mapping_store_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_identity_mapping_store_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_identity_mappings_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_purge_identity_mappings_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_identity_mappings_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_identity_mapping_stores_empty_call_grpc_asyncio():
    client = IdentityMappingStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_transport_kind_rest():
    transport = IdentityMappingStoreServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_create_identity_mapping_store_rest_call_success(request_type):
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["identity_mapping_store"][field])):
                    del request_init["identity_mapping_store"][field][i][subfield]
            else:
                del request_init["identity_mapping_store"][field][subfield]
    request = request_type(**request_init)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_identity_mapping_store_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_identity_mapping_store_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_identity_mapping_store_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_identity_mappings_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_purge_identity_mappings_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_identity_mappings_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_identity_mapping_stores_empty_call_rest():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_identity_mapping_store_service_rest_lro_client():
    client = IdentityMappingStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_identity_mapping_store_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.transports.IdentityMappingStoreServiceTransport.__init__"
    ) as Transport:
...
def test_identity_mapping_store_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.transports.IdentityMappingStoreServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_identity_mapping_store_service_client_transport_session_collision(
    ...
    client2 = IdentityMappingStoreServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.create_identity_mapping_store._session
    session2 = client2.transport.create_identity_mapping_store._session
    assert session1 != session2
    session1 = client1.transport.get_identity_mapping_store._session
    session2 = client2.transport.get_identity_mapping_store._session
    assert session1 != session2
    session1 = client1.transport.delete_identity_mapping_store._session
    session2 = client2.transport.delete_identity_mapping_store._session
    assert session1 != session2
    session1 = client1.transport.import_identity_mappings._session
    session2 = client2.transport.import_identity_mappings._session
    assert session1 != session2
    session1 = client1.transport.purge_identity_mappings._session
    session2 = client2.transport.purge_identity_mappings._session
    assert session1 != session2
    session1 = client1.transport.list_identity_mappings._session
    session2 = client2.transport.list_identity_mappings._session
    assert session1 != session2
...
def test_parse_cmek_config_path():
    ...
    path = IdentityMappingStoreServiceClient.cmek_config_path(**expected)
...
def test_parse_crypto_keys_path():
    ...
    path = IdentityMappingStoreServiceClient.crypto_keys_path(**expected)
...
def test_parse_crypto_key_versions_path():
    ...
    path = IdentityMappingStoreServiceClient.crypto_key_versions_path(**expected)
...
def test_parse_identity_mapping_store_path():
    expected = {
        "project": "clam",
        "location": "whelk",
        "identity_mapping_store": "octopus",
    }
    path = IdentityMappingStoreServiceClient.identity_mapping_store_path(**expected)
...
def test_parse_location_path():
    ...
    path = IdentityMappingStoreServiceClient.location_path(**expected)
...
def test_parse_common_billing_account_path():
    ...
    path = IdentityMappingStoreServiceClient.common_billing_account_path(**expected)
...
def test_parse_common_folder_path():
    ...
    path = IdentityMappingStoreServiceClient.common_folder_path(**expected)
...
def test_parse_common_organization_path():
    ...
    path = IdentityMappingStoreServiceClient.common_organization_path(**expected)
...
def test_parse_common_project_path():
    ...
    path = IdentityMappingStoreServiceClient.common_project_path(**expected)
...
def test_parse_common_location_path():
    ...
    path = IdentityMappingStoreServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = IdentityMappingStoreServiceClient.parse_common_location_path(path)
    assert expected == actual

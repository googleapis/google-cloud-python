...
from google.cloud.discoveryengine_v1.services.control_service import (
    ControlServiceAsyncClient,
    ControlServiceClient,
    pagers,
    transports,
)
from google.cloud.discoveryengine_v1.types import common, control, control_service
...
def test_control_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.control_service.transports.ControlServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/dataStores/*}/controls"
...
def test_delete_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/dataStores/*/controls/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{control.name=projects/*/locations/*/dataStores/*/controls/*}"
            % client.transport._host,
            args[1],
        )
...
def test_control_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.control_service.transports.ControlServiceTransport.__init__"
    ) as Transport:

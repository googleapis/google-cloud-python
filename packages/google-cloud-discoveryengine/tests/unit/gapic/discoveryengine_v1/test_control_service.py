...
from google.cloud.discoveryengine_v1.services.control_service import ControlServiceAsyncClient, ControlServiceClient, pagers, transports
...
def test_control_service_client_client_options_from_dict():
    with mock.patch("google.cloud.discoveryengine_v1.services.control_service.transports.ControlServiceGrpcTransport.__init__") as grpc_transport:
...
def test_create_control_flattened():
    ...
    with mock.patch.object(type(client.transport.create_control), "__call__") as call:
        ...
        client.create_control(
            parent="parent_value",
            control=gcd_control.Control(boost_action=gcd_control.Control.BoostAction(fixed_boost=0.1174)),
            control_id="control_id_value",
        )
        ...
        assert arg == mock_val
        arg = args[0].control
        mock_val = gcd_control.Control(boost_action=gcd_control.Control.BoostAction(fixed_boost=0.1174))
        assert arg == mock_val
...
def test_create_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/dataStores/*}/controls" % client.transport._host, args[1])
...
def test_delete_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataStores/*/controls/*}" % client.transport._host, args[1])
...
def test_update_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{control.name=projects/*/locations/*/dataStores/*/controls/*}" % client.transport._host, args[1])
...
def test_control_service_base_transport():
    ...
    with mock.patch("google.cloud.discoveryengine_v1.services.control_service.transports.ControlServiceTransport.__init__") as Transport:
...
def test_control_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1.services.control_service.transports.ControlServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_document_path():
    ...
    actual = ControlServiceClient.document_path(project, location, data_store, branch, document)
    assert expected == actual

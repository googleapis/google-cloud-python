...
from google.cloud.discoveryengine_v1.services.project_service import (
...
def test_project_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.project_service.transports.ProjectServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_provision_project(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.provision_project), "__call__"
    ) as call:
...
def test_provision_project_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[
            client._transport.provision_project
        ] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_provision_project_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.provision_project
...
def test_provision_project_rest_required_fields(
    request_type=project_service.ProvisionProjectRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).provision_project._get_unset_required_fields(jsonified_request)
...
def test_provision_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*}:provision" % client.transport._host, args[1]
        )
...
def test_provision_project_rest_bad_request(
    request_type=project_service.ProvisionProjectRequest,
):
    client = ProjectServiceClient(
...
def test_provision_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pb_message = project_service.ProvisionProjectRequest.pb(
            project_service.ProvisionProjectRequest()
        )
...
def test_project_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.project_service.transports.ProjectServiceTransport.__init__"
    ) as Transport:

...
from google.cloud.discoveryengine_v1.services.cmek_config_service import CmekConfigServiceAsyncClient, CmekConfigServiceClient, transports
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CmekConfigServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CmekConfigServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CmekConfigServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        CmekConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        CmekConfigServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == CmekConfigServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CmekConfigServiceClient(credentials=cred)
...
def test_cmek_config_service_client_get_transport_class():
    transport = CmekConfigServiceClient.get_transport_class()
...
@pytest.mark.parametrize("client_class", [CmekConfigServiceClient, CmekConfigServiceAsyncClient])
...
def test_cmek_config_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = CmekConfigServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_update_cmek_config(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.update_cmek_config), "__call__") as call:
...
def test_list_cmek_configs(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_cmek_configs), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_cmek_configs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_cmek_configs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_cmek_configs in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_list_cmek_configs_field_headers_async():
    client = CmekConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_list_cmek_configs_flattened_error():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_cmek_config(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_cmek_config), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_cmek_config_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_cmek_config_field_headers_async():
    client = CmekConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_cmek_config_flattened_error():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_cmek_configs_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CmekConfigServiceClient(
...
def test_list_cmek_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.list_cmek_configs(**mock_args)
...
def test_delete_cmek_config_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CmekConfigServiceClient(
...
def test_delete_cmek_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_cmek_config(**mock_args)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = CmekConfigServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = CmekConfigServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = CmekConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_cmek_configs_empty_call_grpc():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_cmek_config_empty_call_grpc():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
def test_transport_kind_grpc_asyncio():
    transport = CmekConfigServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CmekConfigServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_cmek_configs_empty_call_grpc_asyncio():
    client = CmekConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_cmek_config_empty_call_grpc_asyncio():
    client = CmekConfigServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_transport_kind_rest():
    transport = CmekConfigServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_update_cmek_config_rest_bad_request(request_type=cmek_config_service.UpdateCmekConfigRequest):
    client = CmekConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_update_cmek_config_rest_call_success(request_type):
    ...
    test_field = cmek_config_service.UpdateCmekConfigRequest.meta.fields["config"]
...
def test_update_cmek_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CmekConfigServiceRestInterceptor, "post_update_cmek_config_with_metadata"
...
def test_get_cmek_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CmekConfigServiceRestInterceptor, "post_get_cmek_config") as post, mock.patch.object(
        transports.CmekConfigServiceRestInterceptor, "post_get_cmek_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_list_cmek_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CmekConfigServiceRestInterceptor, "post_list_cmek_configs") as post, mock.patch.object(
        transports.CmekConfigServiceRestInterceptor, "post_list_cmek_configs_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_delete_cmek_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.CmekConfigServiceRestInterceptor, "post_delete_cmek_config_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_cmek_configs_empty_call_rest():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_cmek_config_empty_call_rest():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cmek_config_service_rest_lro_client():
    client = CmekConfigServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_cmek_config_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.CmekConfigServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.CmekConfigServiceGrpcTransport, grpc_helpers), (transports.CmekConfigServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_cmek_config_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_cmek_config_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.CmekConfigServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_cmek_config_service_client_transport_session_collision(transport_name):
    ...
    client1 = CmekConfigServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = CmekConfigServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    assert session1 != session2
    session1 = client1.transport.list_cmek_configs._session
    session2 = client2.transport.list_cmek_configs._session
    assert session1 != session2
...
@pytest.mark.parametrize("transport_class", [transports.CmekConfigServiceGrpcTransport, transports.CmekConfigServiceGrpcAsyncIOTransport])
def test_cmek_config_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_parse_cmek_config_path():
    ...
    path = CmekConfigServiceClient.cmek_config_path(**expected)
...
def test_parse_crypto_keys_path():
    ...
    path = CmekConfigServiceClient.crypto_keys_path(**expected)
...
def test_parse_crypto_key_versions_path():
    ...
    path = CmekConfigServiceClient.crypto_key_versions_path(**expected)
...
def test_parse_location_path():
    ...
    path = CmekConfigServiceClient.location_path(**expected)
...
def test_parse_common_billing_account_path():
    ...
    path = CmekConfigServiceClient.common_billing_account_path(**expected)
...
def test_parse_common_folder_path():
    ...
    path = CmekConfigServiceClient.common_folder_path(**expected)
...
def test_parse_common_organization_path():
    ...
    path = CmekConfigServiceClient.common_organization_path(**expected)
...
def test_parse_common_project_path():
    ...
    path = CmekConfigServiceClient.common_project_path(**expected)
...
def test_parse_common_location_path():
    ...
    path = CmekConfigServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = CmekConfigServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_ctx():
    ...
    for transport in transports:
        client = CmekConfigServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

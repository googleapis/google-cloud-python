...
from google.cloud.discoveryengine_v1.services.schema_service import SchemaServiceAsyncClient
from google.cloud.discoveryengine_v1.services.schema_service import SchemaServiceClient
from google.cloud.discoveryengine_v1.services.schema_service import pagers
from google.cloud.discoveryengine_v1.services.schema_service import transports
...
def test_schema_service_client_client_options_from_dict():
    with mock.patch('google.cloud.discoveryengine_v1.services.schema_service.transports.SchemaServiceGrpcTransport.__init__') as grpc_transport:
...
def test_get_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/dataStores/*/schemas/*}" % client.transport._host, args[1])
...
def test_list_schemas_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/dataStores/*}/schemas" % client.transport._host, args[1])
...
def test_schema_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1.services.schema_service.transports.SchemaServiceTransport.__init__') as Transport:
...
def test_schema_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_schema_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1.services.schema_service.transports.SchemaServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SchemaServiceTransport()
        adc.assert_called_once()

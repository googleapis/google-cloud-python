...
from google.cloud.discoveryengine_v1.services.session_service import SessionServiceAsyncClient, SessionServiceClient, pagers, transports
from google.cloud.discoveryengine_v1.types import answer, assist_answer, conversational_search_service, safety
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

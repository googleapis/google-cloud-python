...
from google.cloud.discoveryengine_v1.services.recommendation_service import RecommendationServiceAsyncClient, RecommendationServiceClient, transports
from google.cloud.discoveryengine_v1.types import common, recommendation_service, user_event
...
def test_recommendation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_recommendation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceTransport.__init__"
    ) as Transport:
...
def test_recommendation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.discoveryengine_v1.services.recommendation_service.transports.RecommendationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

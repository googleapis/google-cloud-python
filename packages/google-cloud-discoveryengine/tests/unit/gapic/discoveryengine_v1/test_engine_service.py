...
from google.cloud.discoveryengine_v1.services.engine_service import (
    EngineServiceAsyncClient,
    EngineServiceClient,
    pagers,
    transports,
)
from google.cloud.discoveryengine_v1.types import common, engine, engine_service
...
def test_engine_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.engine_service.transports.EngineServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_engine_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_engine
        ...
        client.create_engine(
            ...
            engine=gcd_engine.Engine(
                chat_engine_config=gcd_engine.Engine.ChatEngineConfig(
                    agent_creation_config=gcd_engine.Engine.ChatEngineConfig.AgentCreationConfig(
...
@pytest.mark.asyncio
async def test_delete_engine_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_engine
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_engine_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_engine
            in client._client._transport._wrapped_methods
        )
...
async def test_get_engine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_engine
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_engines_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_engines
            in client._client._transport._wrapped_methods
        )
...
def test_create_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateEngine,
        "_BaseCreateEngine__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
    ...
    assert not set(unset_fields) - set(("engineId",))
...
def test_create_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/collections/*}/engines"
...
def test_delete_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteEngine,
        "_BaseDeleteEngine__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/collections/*/engines/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_engine_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateEngine,
        "_BaseUpdateEngine__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{engine.name=projects/*/locations/*/collections/*/engines/*}"
            % client.transport._host,
            args[1],
        )
...
def test_get_engine_rest_required_fields(request_type=engine_service.GetEngineRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetEngine,
        "_BaseGetEngine__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_engines_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListEngines,
        "_BaseListEngines__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_transport_kind_grpc_asyncio():
    transport = EngineServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
def test_transport_kind_rest():
    transport = EngineServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
...
def test_list_engines_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = engine_service.ListEnginesResponse.to_json(
            engine_service.ListEnginesResponse()
        )
        req.return_value.content = return_value
...
def test_engine_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.discoveryengine_v1.services.engine_service.transports.EngineServiceTransport.__init__"
    ) as Transport:

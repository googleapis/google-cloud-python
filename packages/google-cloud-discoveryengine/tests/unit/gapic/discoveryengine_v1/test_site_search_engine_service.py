...
def test_get_site_search_engine_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/dataStores/*/siteSearchEngine}"
...
def test_create_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/targetSites"
            % client.transport._host,
            args[1],
        )
...
def test_get_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_target_site_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{target_site.name=projects/*/locations/*/dataStores/*/siteSearchEngine/targetSites/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_sitemap_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/sitemaps"
            % client.transport._host,
            args[1],
        )
...
def test_delete_sitemap_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/dataStores/*/siteSearchEngine/sitemaps/*}"
            % client.transport._host,
            args[1],
        )
...
def test_fetch_sitemaps_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/dataStores/*/siteSearchEngine}/sitemaps:fetch"
            % client.transport._host,
            args[1],
        )

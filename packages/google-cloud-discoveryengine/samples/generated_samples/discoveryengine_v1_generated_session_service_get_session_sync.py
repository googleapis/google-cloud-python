...
# [START discoveryengine_v1_generated_SessionService_GetSession_sync]
...
def sample_get_session():
    # Create a client
    client = discoveryengine_v1.SessionServiceClient()
...
# [END discoveryengine_v1_generated_SessionService_GetSession_sync]

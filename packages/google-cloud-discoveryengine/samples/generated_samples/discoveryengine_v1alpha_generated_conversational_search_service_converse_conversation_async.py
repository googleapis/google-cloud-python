...
#
# Snippet for ConverseConversation
...
async def sample_converse_conversation():
    # Create a client
    client = discoveryengine_v1alpha.ConversationalSearchServiceAsyncClient()

    # Initialize request argument(s)
    request = discoveryengine_v1alpha.ConverseConversationRequest(
        name="name_value",
    )

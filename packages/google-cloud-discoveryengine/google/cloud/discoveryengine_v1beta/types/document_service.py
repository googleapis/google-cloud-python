...
class GetDocumentRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            `Document
            <google.cloud.discoveryengine.v1beta.Document>`__, such
            as
            ...
            <google.cloud.discoveryengine.v1beta.Document>`__ does
...
class ListDocumentsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            `Document
            <google.cloud.discoveryengine.v1beta.Document>`__s under
            this branch, regardless of whether or not this branch
            exists, a ``PERMISSION_DENIED`` error is returned.
        page_size (int):
            Maximum number of `Document
            <google.cloud.discoveryengine.v1beta.Document>`__s to
        ...
        page_token (str):
            ...
            <google.cloud.discoveryengine.v1beta.ListDocumentsResponse.next_page_token>`__,
...
class ListDocumentsResponse(proto.Message):
    ...
    Attributes:
        ...
        next_page_token (str):
            ...
            <google.cloud.discoveryengine.v1beta.ListDocumentsRequest.page_token>`__
...
class CreateDocumentRequest(proto.Message):
    ...
    Attributes:
        ...
        document_id (str):
            ...
            `Document
            <google.cloud.discoveryengine.v1beta.Document>`__, which
            ...
            `Document
            <google.cloud.discoveryengine.v1beta.Document>`__s with
            the same `parent
...
class UpdateDocumentRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            `Document
            <google.cloud.discoveryengine.v1beta.Document>`__ is not
            found, a new `Document
            <google.cloud.discoveryengine.v1beta.Document>`__ is be
            created.
...
class BatchGetDocumentsMetadataRequest(proto.Message):
    ...
    class UrisMatcher(proto.Message):
        ...
        <google.cloud.discoveryengine.v1beta.Document>`__s by exact uris.
    ...
    class FhirMatcher(proto.Message):
        r"""Matcher for the `Document
        <google.cloud.discoveryengine.v1beta.Document>`__s by FHIR resource
        names.
    ...
    class Matcher(proto.Message):
        r"""Matcher for the `Document
        <google.cloud.discoveryengine.v1beta.Document>`__s. Currently supports
    ...
    class DocumentMetadata(proto.Message):
        ...
        Attributes:
            ...
            last_refreshed_time (google.protobuf.timestamp_pb2.Timestamp):
                ...
                `Document
                <google.cloud.discoveryengine.v1beta.Document>`__ was
                last indexed.

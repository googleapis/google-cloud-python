...
class RecommendRequest(proto.Message):
    ...
    Attributes:
        ...
        user_event (google.cloud.discoveryengine_v1beta.types.UserEvent):
            ...
            <google.cloud.discoveryengine.v1beta.UserInfo.user_id>`__
        ...
        filter (str):
            ...
            * (launguage: ANY("en", "es")) AND NOT
            ...
            <google.cloud.discoveryengine.v1beta.RecommendRequest.params>`__
        ...
        params (MutableMapping[str, google.protobuf.struct_pb2.Value]):
            ...
            * ``returnDocument``: Boolean. If set to
            ...
            <google.cloud.discoveryengine.v1beta.RecommendResponse.RecommendationResult.document>`__.
            ...
            * ``returnScore``: Boolean. If set to true, the
            ...
            <google.cloud.discoveryengine.v1beta.RecommendResponse.RecommendationResult.metadata>`__.
...
class RecommendResponse(proto.Message):
    ...
    Attributes:
        ...
        validate_only (bool):
            ...
            <google.cloud.discoveryengine.v1beta.RecommendRequest.validate_only>`__
            was set.
    """

...
class Evaluation(proto.Message):
    ...
    process. It encapsulates the state of the evaluation and the resulting
    data.
    ...
    Attributes:
        name (str):
            ...
            `Evaluation
            <google.cloud.discoveryengine.v1beta.Evaluation>`__, in
            the format of
        ...
        quality_metrics (google.cloud.discoveryengine_v1beta.types.QualityMetrics):
            ...
            averaged across all `SampleQuery
            <google.cloud.discoveryengine.v1beta.SampleQuery>`__s in
            the `SampleQuerySet
        ...
        error (google.rpc.status_pb2.Status):
            ...
            evaluation. Only populated when the evaluation's state
            is FAILED.
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. Timestamp the
            `Evaluation
            <google.cloud.discoveryengine.v1beta.Evaluation>`__ was
            created at.
        ...
        error_samples (MutableSequence[google.rpc.status_pb2.Status]):
            Output only. A sample of errors encountered while
    ...
    class EvaluationSpec(proto.Message):
        ...
        Attributes:
            search_request (google.cloud.discoveryengine_v1beta.types.SearchRequest):
                ...
                supported; if any other fields are provided, an
...
class QualityMetrics(proto.Message):
    ...
    Attributes:
        doc_recall (google.cloud.discoveryengine_v1beta.types.QualityMetrics.TopkMetrics):
            ...
            * For a single
             `SampleQuery
            <google.cloud.discoveryengine.v1beta.SampleQuery>`__, If
            3 out  of 5 relevant documents are retrieved in the
        ...
        doc_precision (google.cloud.discoveryengine_v1beta.types.QualityMetrics.TopkMetrics):
            ...
            * For a single
             `SampleQuery
            <google.cloud.discoveryengine.v1beta.SampleQuery>`__, If
            4 out  of 5 retrieved documents in the top-5 are
        ...
        doc_ndcg (google.cloud.discoveryengine_v1beta.types.QualityMetrics.TopkMetrics):
            ...
            relevance  judgements (1 for relevant, 0 for not
            relevant):
            ...
            * Ideal DCG@3: 1/log2(1+1) + 1/log2(2+1) + 0/log2(3+1) =
            1.63
        ...
        page_recall (google.cloud.discoveryengine_v1beta.types.QualityMetrics.TopkMetrics):
            ...
            Recall is the fraction of relevant pages retrieved out
            ...
            * For a single
             `SampleQuery
            <google.cloud.discoveryengine.v1beta.SampleQuery>`__, if
            3 out  of 5 relevant pages are retrieved in the top-5,
            recall@5 = 3/5 = 0.6
        page_ndcg (google.cloud.discoveryengine_v1beta.types.QualityMetrics.TopkMetrics):
            Normalized discounted cumulative gain (NDCG) per page,
            ...
            Example (top-3):
             ...
             Suppose `SampleQuery
            <google.cloud.discoveryengine.v1beta.SampleQuery>`__
            with three retrieved pages (P1, P2, P3) and binary
            relevance judgements (1  for relevant, 0 for not
            relevant):

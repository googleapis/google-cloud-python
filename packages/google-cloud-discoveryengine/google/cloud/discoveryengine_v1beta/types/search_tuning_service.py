...
from google.cloud.discoveryengine_v1beta.types import custom_tuning_model, import_config
...
class ListCustomModelsResponse(proto.Message):
    ...
    Attributes:
        models (MutableSequence[google.cloud.discoveryengine_v1beta.types.CustomTuningModel]):

...
class AnswerQueryRequest(proto.Message):
    ...
    Attributes:
        ...
        grounding_spec (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.GroundingSpec):
            Optional. Grounding specification.
        answer_generation_spec (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.AnswerGenerationSpec):
            Answer generation specification.
        search_spec (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec):
            Search specification.
        query_understanding_spec (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.QueryUnderstandingSpec):
        ...
        asynchronous_mode (bool):
            ...
            <google.cloud.discoveryengine.v1beta.ConversationalSearchService.GetAnswer>`__
            or
    ...
    class SearchSpec(proto.Message):
        ...
        Attributes:
            search_params (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec.SearchParams):
                Search parameters.

                This field is a member of `oneof`_ ``input``.
            search_result_list (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec.SearchResultList):
                Search result list.
        ...
        class SearchParams(proto.Message):
            ...
            Attributes:
                ...
                natural_language_query_understanding_spec (google.cloud.discoveryengine_v1beta.types.SearchRequest.NaturalLanguageQueryUnderstandingSpec):
                    Optional. Specification to enable natural language
                    understanding capabilities for search requests.
            """
            ...
            natural_language_query_understanding_spec: search_service.SearchRequest.NaturalLanguageQueryUnderstandingSpec = proto.Field(
                proto.MESSAGE,
                number=8,
                message=search_service.SearchRequest.NaturalLanguageQueryUnderstandingSpec,
            )
        ...
        class SearchResultList(proto.Message):
            ...
            Attributes:
                search_results (MutableSequence[google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult]):
                    Search results.
            """
            ...
            class SearchResult(proto.Message):
                ...
                Attributes:
                    unstructured_document_info (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.UnstructuredDocumentInfo):
                        Unstructured document information.

                        This field is a member of `oneof`_ ``content``.
                    chunk_info (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.ChunkInfo):
                        Chunk information.
                ...
                class UnstructuredDocumentInfo(proto.Message):
                    ...
                    Attributes:
                        ...
                        title (str):
                            Title.
                        document_contexts (MutableSequence[google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.SearchSpec.SearchResultList.SearchResult.UnstructuredDocumentInfo.DocumentContext]):
    ...
    class QueryUnderstandingSpec(proto.Message):
        ...
        Attributes:
            query_classification_spec (google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpec):
        ...
        class QueryClassificationSpec(proto.Message):
            ...
            Attributes:
                types (MutableSequence[google.cloud.discoveryengine_v1beta.types.AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpec.Type]):
...
class AnswerQueryResponse(proto.Message):
    ...
    Attributes:
        answer (google.cloud.discoveryengine_v1beta.types.Answer):
            ...
            <google.cloud.discoveryengine.v1beta.AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.max_rephrase_steps>`__
            is greater than 1, use
            `Answer.name
            <google.cloud.discoveryengine.v1beta.Answer.name>`__ to
        ...
        session (google.cloud.discoveryengine_v1beta.types.Session):
            ...
            <google.cloud.discoveryengine.v1beta.AnswerQueryRequest>`__
            request.

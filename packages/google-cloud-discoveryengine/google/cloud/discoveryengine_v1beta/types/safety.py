...
class SafetyRating(proto.Message):
    ...
    Attributes:
        ...
        probability (google.cloud.discoveryengine_v1beta.types.SafetyRating.HarmProbability):
            Output only. Harm probability levels in the
            content.
        probability_score (float):
            Output only. Harm probability score.
        severity (google.cloud.discoveryengine_v1beta.types.SafetyRating.HarmSeverity):

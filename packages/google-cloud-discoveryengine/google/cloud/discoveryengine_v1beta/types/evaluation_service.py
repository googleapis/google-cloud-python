...
class GetEvaluationRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            If the requested
            `Evaluation
            <google.cloud.discoveryengine.v1beta.Evaluation>`__ does
...
class ListEvaluationsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            Maximum number of
            `Evaluation
            <google.cloud.discoveryengine.v1beta.Evaluation>`__s to
        ...
        page_token (str):
            ...
            <google.cloud.discoveryengine.v1beta.ListEvaluationsResponse.next_page_token>`__,
...
class ListEvaluationsResponse(proto.Message):
    ...
    Attributes:
        evaluations (MutableSequence[google.cloud.discoveryengine_v1beta.types.Evaluation]):
            The `Evaluation
            <google.cloud.discoveryengine.v1beta.Evaluation>`__s.
        next_page_token (str):
            A token that can be sent as
            `ListEvaluationsRequest.page_token
            <google.cloud.discoveryengine.v1beta.ListEvaluationsRequest.page_token>`__
...
class CreateEvaluationRequest(proto.Message):
    ...
    Attributes:
        ...
        evaluation (google.cloud.discoveryengine_v1beta.types.Evaluation):
            ...
            <google.cloud.discoveryengine.v1beta.Evaluation>`__ to
            create.
    """
...
class ListEvaluationResultsRequest(proto.Message):
    ...
    Attributes:
        ...
        page_token (str):
            ...
            <google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.next_page_token>`__,
            received from a previous
            `EvaluationService.ListEvaluationResults
            <google.cloud.discoveryengine.v1beta.EvaluationService.ListEvaluationResults>`__
            call. Provide this to retrieve the subsequent page.
...
class ListEvaluationResultsResponse(proto.Message):
    ...
    Attributes:
        evaluation_results (MutableSequence[google.cloud.discoveryengine_v1beta.types.ListEvaluationResultsResponse.EvaluationResult]):
            The
            `EvaluationResult
            <google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.EvaluationResult>`__s.
        next_page_token (str):
            A token that can be sent as
            `ListEvaluationResultsRequest.page_token
            <google.cloud.discoveryengine.v1beta.ListEvaluationResultsRequest.page_token>`__
            to retrieve the next page. If this field is omitted,
            there are no subsequent pages.
    """
    ...
    class EvaluationResult(proto.Message):
        ...
        `SampleQuery <google.cloud.discoveryengine.v1beta.SampleQuery>`__.

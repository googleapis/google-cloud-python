...
class ImportIdentityMappingsRequest(proto.Message):
    ...
    Attributes:
        inline_source (google.cloud.discoveryengine_v1beta.types.ImportIdentityMappingsRequest.InlineSource):
    ...
    class InlineSource(proto.Message):
        ...
        Attributes:
            identity_mapping_entries (MutableSequence[google.cloud.discoveryengine_v1beta.types.IdentityMappingEntry]):
...
class PurgeIdentityMappingsRequest(proto.Message):
    ...
    Attributes:
        inline_source (google.cloud.discoveryengine_v1beta.types.PurgeIdentityMappingsRequest.InlineSource):
...
class ListIdentityMappingStoresResponse(proto.Message):
    ...
    Attributes:
        identity_mapping_stores (MutableSequence[google.cloud.discoveryengine_v1beta.types.IdentityMappingStore]):

...
class Control(proto.Message):
    ...
    Attributes:
        ...
        synonyms_action (google.cloud.discoveryengine_v1beta.types.Control.SynonymsAction):
            ...
            This field is a member of `oneof`_ ``action``.
        promote_action (google.cloud.discoveryengine_v1beta.types.Control.PromoteAction):
    ...
    class BoostAction(proto.Message):
        ...
        Attributes:
            ...
            interpolation_boost_spec (google.cloud.discoveryengine_v1beta.types.Control.BoostAction.InterpolationBoostSpec):
        ...
        class InterpolationBoostSpec(proto.Message):
            ...
            Attributes:
                ...
                attribute_type (google.cloud.discoveryengine_v1beta.types.Control.BoostAction.InterpolationBoostSpec.AttributeType):
                ...
                interpolation_type (google.cloud.discoveryengine_v1beta.types.Control.BoostAction.InterpolationBoostSpec.InterpolationType):
                    Optional. The interpolation type to be
                    applied to connect the control points listed
                    below.
                control_points (MutableSequence[google.cloud.discoveryengine_v1beta.types.Control.BoostAction.InterpolationBoostSpec.ControlPoint]):
    ...
    class PromoteAction(proto.Message):
        ...
        Attributes:
            ...
            search_link_promotion (google.cloud.discoveryengine_v1beta.types.SearchLinkPromotion):

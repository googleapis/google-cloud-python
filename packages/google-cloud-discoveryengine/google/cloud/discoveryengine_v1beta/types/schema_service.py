...
class GetSchemaRequest(proto.Message):
    ...
    <google.cloud.discoveryengine.v1beta.SchemaService.GetSchema>`__ method.
...
class ListSchemasRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            ...
            <google.cloud.discoveryengine.v1beta.Schema>`__s to
            return. The service may return fewer than this value.

            If unspecified, at most 100
            `Schema <google.cloud.discoveryengine.v1beta.Schema>`__s
            are returned.
...
class CreateSchemaRequest(proto.Message):
    ...
    Attributes:
        ...
        schema (google.cloud.discoveryengine_v1beta.types.Schema):
            Required. The `Schema
            <google.cloud.discoveryengine.v1beta.Schema>`__ to
            create.
        schema_id (str):
...
class UpdateSchemaRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            <google.cloud.discoveryengine.v1beta.Schema>`__ is

...
class ServingConfigServiceClient(metaclass=ServingConfigServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.ServingConfigServiceClient`.",
                    extra={
    ...
    def update_serving_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.UpdateServingConfigRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_serving_config():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1beta.GetServingConfigRequest(
                    name="name_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_serving_configs():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1beta.ListServingConfigsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListServingConfigsRequest, dict]):

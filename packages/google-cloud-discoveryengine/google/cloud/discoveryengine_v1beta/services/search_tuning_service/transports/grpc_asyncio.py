...
class SearchTuningServiceGrpcAsyncIOTransport(SearchTuningServiceTransport):
    ...
    @property
    def train_custom_model(self) -> Callable[[search_tuning_service.TrainCustomModelRequest], Awaitable[operations_pb2.Operation]]:
        ...
        if "train_custom_model" not in self._stubs:
            self._stubs["train_custom_model"] = self._logged_channel.unary_unary(
    ...
    def list_custom_models(
        self,
    ) -> Callable[[search_tuning_service.ListCustomModelsRequest], Awaitable[search_tuning_service.ListCustomModelsResponse]]:
        ...
        if "list_custom_models" not in self._stubs:
            self._stubs["list_custom_models"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.train_custom_model: self._wrap_method(
                self.train_custom_model,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_custom_models: self._wrap_method(

...
class SearchServiceTransport(abc.ABC):
    ...
    @property
    def search(self) -> Callable[[search_service.SearchRequest], Union[search_service.SearchResponse, Awaitable[search_service.SearchResponse]]]:
        raise NotImplementedError()

    @property
    def search_lite(self) -> Callable[[search_service.SearchRequest], Union[search_service.SearchResponse, Awaitable[search_service.SearchResponse]]]:
        raise NotImplementedError()

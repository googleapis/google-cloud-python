    ...
    class _BaseSearch:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:search",
                    "body": "*",
                },
                {
                    "method": "post",
    ...
    class _BaseSearchLite:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:searchLite",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:searchLite",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:searchLite",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseSearchServiceRestTransport._BaseSearchLite._get_unset_required_fields(
                    query_params
                )
            )

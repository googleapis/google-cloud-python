...
class SearchPager:
    ...
    :class:`google.cloud.discoveryengine_v1beta.types.SearchResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1beta.types.SearchResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1beta.types.SearchRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1beta.types.SearchResponse):

    ...
    class _BaseGetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{resource=projects/*/locations/*/collections/*/engines/*}:getIamPolicy",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseEngineServiceRestTransport._BaseGetIamPolicy._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseSetIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{resource=projects/*/locations/*/collections/*/engines/*}:setIamPolicy",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseEngineServiceRestTransport._BaseSetIamPolicy._get_unset_required_fields(
                    query_params
                )
            )

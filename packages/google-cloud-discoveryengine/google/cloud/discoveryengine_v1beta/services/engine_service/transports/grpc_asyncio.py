...
class EngineServiceGrpcAsyncIOTransport(EngineServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.pause_engine: gapic_v1.method_async.wrap_method(
                self.pause_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resume_engine: gapic_v1.method_async.wrap_method(
                self.resume_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.tune_engine: gapic_v1.method_async.wrap_method(
                self.tune_engine,
                default_timeout=None,
                client_info=client_info,
            ),

    ...
    class _GetIamPolicy(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseEngineServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseEngineServiceRestTransport._BaseGetIamPolicy._get_query_params_json(
                transcoded_request
            )
    ...
    class _SetIamPolicy(
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request = _BaseEngineServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseEngineServiceRestTransport._BaseSetIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseEngineServiceRestTransport._BaseSetIamPolicy._get_query_params_json(
                transcoded_request
            )

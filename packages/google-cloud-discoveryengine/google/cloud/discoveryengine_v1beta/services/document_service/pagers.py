...
from google.cloud.discoveryengine_v1beta.types import document, document_service
...
class ListDocumentsPager:
    ...
    :class:`google.cloud.discoveryengine_v1beta.types.ListDocumentsResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1beta.types.ListDocumentsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1beta.types.ListDocumentsRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1beta.types.ListDocumentsResponse):

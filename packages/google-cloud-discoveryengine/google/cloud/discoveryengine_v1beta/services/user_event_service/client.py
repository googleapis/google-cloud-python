...
class UserEventServiceClient(metaclass=UserEventServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.UserEventServiceClient`.",
                    extra={
    ...
    def purge_user_events(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.PurgeUserEventsRequest, dict]):

...
class CompletionServiceClient(metaclass=CompletionServiceClientMeta):
    ...
    @staticmethod
    def completion_config_path(project: str,location: str,data_store: str,) -> str:
        """Returns a fully-qualified completion_config string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/completionConfig".format(project=project, location=location, data_store=data_store, )

    @staticmethod
    def parse_completion_config_path(path: str) -> Dict[str,str]:
        """Parses a completion_config path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/completionConfig$", path)
    ...
    def __init__(self, *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.CompletionServiceClient`.",
                    extra = {
    ...
    def advanced_complete_query(self,
        ...
        .. code-block:: python
            ...
            def sample_advanced_complete_query():
                # Create a client
                client = discoveryengine_v1beta.CompletionServiceClient()
                ...
                # Make the request
                response = client.advanced_complete_query(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.advanced_complete_query]
    ...
    def purge_suggestion_deny_list_entries(self,
        ...
        .. code-block:: python
            ...
            def sample_purge_suggestion_deny_list_entries():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1beta.PurgeSuggestionDenyListEntriesRequest(
                    parent="parent_value",
                )

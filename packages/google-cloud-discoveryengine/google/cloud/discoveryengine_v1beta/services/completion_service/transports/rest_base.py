    ...
    class _BaseRemoveSuggestion:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{completion_config=projects/*/locations/*/collections/*/engines/*/completionConfig}:removeSuggestion",
                    "body": "*",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = completion_service.RemoveSuggestionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseCompletionServiceRestTransport._BaseRemoveSuggestion._get_unset_required_fields(
                    query_params
                )
            )

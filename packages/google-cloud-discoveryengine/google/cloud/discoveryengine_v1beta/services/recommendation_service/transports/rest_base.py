...
from .base import DEFAULT_CLIENT_INFO, RecommendationServiceTransport


class _BaseRecommendationServiceRestTransport(RecommendationServiceTransport):
    """Base REST backend transport for RecommendationService.
    ...
    class _BaseRecommend:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseRecommendationServiceRestTransport._BaseRecommend._get_unset_required_fields(query_params))
...
__all__ = ("_BaseRecommendationServiceRestTransport",)

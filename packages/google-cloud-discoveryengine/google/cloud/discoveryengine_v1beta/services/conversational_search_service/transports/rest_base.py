    ...
    class _BaseStreamAnswerQuery:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:streamAnswer",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:streamAnswer",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1beta/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:streamAnswer",
                    "body": "*",
                },
            ]
            return http_options

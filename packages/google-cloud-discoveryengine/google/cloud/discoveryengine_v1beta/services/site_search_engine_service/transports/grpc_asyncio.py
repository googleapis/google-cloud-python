...
class SiteSearchEngineServiceGrpcAsyncIOTransport(SiteSearchEngineServiceTransport):
    ...
    def create_sitemap(
        ...
        if "create_sitemap" not in self._stubs:
            self._stubs["create_sitemap"] = self.grpc_channel.unary_unary(
    ...
    def delete_sitemap(
        ...
        if "delete_sitemap" not in self._stubs:
            self._stubs["delete_sitemap"] = self.grpc_channel.unary_unary(
    ...
    def fetch_sitemaps(
        ...
        if "fetch_sitemaps" not in self._stubs:
            self._stubs["fetch_sitemaps"] = self.grpc_channel.unary_unary(

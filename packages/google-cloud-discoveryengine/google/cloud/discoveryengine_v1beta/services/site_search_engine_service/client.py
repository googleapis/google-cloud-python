...
class SiteSearchEngineServiceClient(metaclass=SiteSearchEngineServiceClientMeta):
    ...
    def parse_sitemap_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine/sitemaps/(?P<sitemap>.+?)$", path
        )
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = SiteSearchEngineServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or SiteSearchEngineServiceClient._get_api_endpoint(

...
class SiteSearchEngineServiceClient(metaclass=SiteSearchEngineServiceClientMeta):
    ...
    def sitemap_path(
        ...
        return "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine/sitemaps/{sitemap}".format(
            project=project,
            location=location,
    ...
    def parse_sitemap_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine/sitemaps/(?P<sitemap>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def site_search_engine_path(
        project: str,
        location: str,
        data_store: str,
    ) -> str:
        """Returns a fully-qualified site_search_engine string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine".format(
            project=project,
            location=location,
            data_store=data_store,
        )
    ...
    def parse_site_search_engine_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def target_site_path(
        project: str,
        location: str,
        data_store: str,
        target_site: str,
        ...
        return "projects/{project}/locations/{location}/dataStores/{data_store}/siteSearchEngine/targetSites/{target_site}".format(
            project=project,
            location=location,
            data_store=data_store,
    ...
    def parse_target_site_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/siteSearchEngine/targetSites/(?P<target_site>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SiteSearchEngineServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                SiteSearchEngineServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = SiteSearchEngineServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SiteSearchEngineServiceClient._get_api_endpoint(
        ...
        *,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will
                be
                :class:`google.cloud.discoveryengine_v1beta.types.BatchCreateTargetSitesResponse`
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.batch_create_target_sites
        ]
        ...
        *,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will
                be
                :class:`google.cloud.discoveryengine_v1beta.types.EnableAdvancedSiteSearchResponse`
                Response message for
                `SiteSearchEngineService.EnableAdvancedSiteSearch
                <google.cloud.discoveryengine.v1beta.SiteSearchEngineService.EnableAdvancedSiteSearch>`__
                method.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.enable_advanced_site_search
        ]
        ...
        *,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will
                be
                :class:`google.cloud.discoveryengine_v1beta.types.DisableAdvancedSiteSearchResponse`
                Response message for
                `SiteSearchEngineService.DisableAdvancedSiteSearch
                <google.cloud.discoveryengine.v1beta.SiteSearchEngineService.DisableAdvancedSiteSearch>`__
                method.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.disable_advanced_site_search
        ]
        ...
        *,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will
                be
                :class:`google.cloud.discoveryengine_v1beta.types.RecrawlUrisResponse`
                Response message for
                `SiteSearchEngineService.RecrawlUris
                <google.cloud.discoveryengine.v1beta.SiteSearchEngineService.RecrawlUris>`__
                method.
        ...
        *,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will
                be
                :class:`google.cloud.discoveryengine_v1beta.types.BatchVerifyTargetSitesResponse`
                Response message for
                `SiteSearchEngineService.BatchVerifyTargetSites
                <google.cloud.discoveryengine.v1beta.SiteSearchEngineService.BatchVerifyTargetSites>`__
                method.
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.batch_verify_target_sites
        ]
    ...
    def fetch_domain_verification_status(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.fetch_domain_verification_status
        ]

...
class _BaseUserLicenseServiceRestTransport(UserLicenseServiceTransport):
    """Base REST backend transport for UserLicenseService.
    ...
    class _BaseBatchUpdateUserLicenses:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{parent=projects/*/locations/*/userStores/*}:batchUpdateUserLicenses",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = user_license_service.BatchUpdateUserLicensesRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseUserLicenseServiceRestTransport._BaseBatchUpdateUserLicenses._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListLicenseConfigsUsageStats:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{parent=projects/*/locations/*/userStores/*}/licenseConfigsUsageStats",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = user_license_service.ListLicenseConfigsUsageStatsRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseUserLicenseServiceRestTransport._BaseListLicenseConfigsUsageStats._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListUserLicenses:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{parent=projects/*/locations/*/userStores/*}/userLicenses",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = user_license_service.ListUserLicensesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseUserLicenseServiceRestTransport._BaseListUserLicenses._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseUserLicenseServiceRestTransport",)

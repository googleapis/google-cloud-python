...
from .grpc_asyncio import AssistantServiceGrpcAsyncIOTransport
from .rest import AssistantServiceRestInterceptor, AssistantServiceRestTransport
...
__all__ = (
    ...
    "AssistantServiceRestInterceptor",
)

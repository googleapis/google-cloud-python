...
class AssistantServiceClientMeta(type):
    """Metaclass for the AssistantService client.
    ...
    ) -> Type[AssistantServiceTransport]:
...
class AssistantServiceClient(metaclass=AssistantServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AssistantServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AssistantServiceTransport:
        ...
        Returns:
            AssistantServiceTransport: The transport used by the client
                instance.
        """
    ...
    def assistant_path(
        ...
        """Returns a fully-qualified assistant string."""
        return "projects/{project}/locations/{location}/collections/{collection}/engines/{engine}/assistants/{assistant}".format(
            project=project,
            location=location,
            collection=collection,
            engine=engine,
    ...
    @staticmethod
    def parse_assistant_path(path: str) -> Dict[str, str]:
        """Parses a assistant path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/collections/(?P<collection>.+?)/engines/(?P<engine>.+?)/assistants/(?P<assistant>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AssistantServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AssistantServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AssistantServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = AssistantServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AssistantServiceTransport)
        if transport_provided:
            # transport is a AssistantServiceTransport instance.
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AssistantServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AssistantServiceTransport],
                Callable[..., AssistantServiceTransport],
            ] = (
                AssistantServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AssistantServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.AssistantServiceClient`.",
                    extra={
    ...
    def stream_assist(
        ...
        *,
    ...
    ) -> Iterable[assistant_service.StreamAssistResponse]:
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.StreamAssistRequest, dict]):
        ...
        Returns:
            Iterable[google.cloud.discoveryengine_v1beta.types.StreamAssistResponse]:
                Response for the
                   [AssistantService.StreamAssist][google.cloud.discoveryengine.v1beta.AssistantService.StreamAssist]
                   method.
        ...
        rpc = self._transport._wrapped_methods[self._transport.stream_assist]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_assistant():
                ...
                # Make the request
                response = client.create_assistant(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateAssistantRequest, dict]):
                The request object. Request for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_assistant]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_assistant():
                ...
                # Make the request
                client.delete_assistant(request=request)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DeleteAssistantRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_assistant]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_assistant():
                ...
                # Make the request
                response = client.update_assistant(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.UpdateAssistantRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_assistant]
    ...
    def get_assistant(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetAssistantRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_assistant]
    ...
    def list_assistants(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListAssistantsRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.assistant_service.pagers.ListAssistantsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_assistants]
        ...
        response = pagers.ListAssistantsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "AssistantServiceClient":
        return self
...
__all__ = ("AssistantServiceClient",)

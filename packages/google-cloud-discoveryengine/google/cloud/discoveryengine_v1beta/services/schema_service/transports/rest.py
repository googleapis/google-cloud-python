        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.CreateSchema",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceClient.create_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "CreateSchema",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.DeleteSchema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceClient.delete_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "DeleteSchema",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.GetSchema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "GetSchema",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceClient.get_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "GetSchema",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.ListSchemas",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "ListSchemas",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceClient.list_schemas",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "ListSchemas",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.UpdateSchema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceClient.update_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "UpdateSchema",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1beta.SchemaServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1beta.SchemaServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1beta.SchemaService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

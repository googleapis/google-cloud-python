    ...
    class _BaseCreateSchema:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{parent=projects/*/locations/*/dataStores/*}/schemas",
                    "body": "schema",
                },
                {
                    "method": "post",
                    "uri": "/v1beta/{parent=projects/*/locations/*/collections/*/dataStores/*}/schemas",
                    "body": "schema",
                },
            ]
            return http_options
    ...
    class _BaseDeleteSchema:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta/{name=projects/*/locations/*/dataStores/*/schemas/*}",
                },
                {
                    "method": "delete",
                    "uri": "/v1beta/{name=projects/*/locations/*/collections/*/dataStores/*/schemas/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateSchema:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta/{schema.name=projects/*/locations/*/dataStores/*/schemas/*}",
                    "body": "schema",
                },
                {
                    "method": "patch",
                    "uri": "/v1beta/{schema.name=projects/*/locations/*/collections/*/dataStores/*/schemas/*}",
                    "body": "schema",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseSchemaServiceRestTransport._BaseUpdateSchema._get_unset_required_fields(
                    query_params
                )
            )

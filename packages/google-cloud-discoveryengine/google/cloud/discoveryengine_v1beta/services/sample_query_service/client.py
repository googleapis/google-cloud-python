...
from .transports.grpc import SampleQueryServiceGrpcTransport
from .transports.grpc_asyncio import SampleQueryServiceGrpcAsyncIOTransport
from .transports.rest import SampleQueryServiceRestTransport


class SampleQueryServiceClientMeta(type):
    """Metaclass for the SampleQueryService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SampleQueryServiceTransport]]
    _transport_registry["grpc"] = SampleQueryServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = SampleQueryServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = SampleQueryServiceRestTransport
...
class SampleQueryServiceClient(metaclass=SampleQueryServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SampleQueryServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SampleQueryServiceTransport:
        ...
        Returns:
            SampleQueryServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SampleQueryServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SampleQueryServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SampleQueryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SampleQueryServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SampleQueryServiceTransport, Callable[..., SampleQueryServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the sample query service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SampleQueryServiceClient._read_environment_variables()
        self._client_cert_source = SampleQueryServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SampleQueryServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SampleQueryServiceTransport)
        if transport_provided:
            # transport is a SampleQueryServiceTransport instance.
            ...
            self._transport = cast(SampleQueryServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or SampleQueryServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SampleQueryServiceTransport], Callable[..., SampleQueryServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.SampleQueryServiceClient`.",
                    extra={
    ...
    def get_sample_query(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetSampleQueryRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_sample_query]
    ...
    def list_sample_queries(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListSampleQueriesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_sample_queries]
        ...
        response = pagers.ListSampleQueriesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_sample_query(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateSampleQueryRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_sample_query]
    ...
    def update_sample_query(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.UpdateSampleQueryRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_sample_query]
    ...
    def delete_sample_query(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DeleteSampleQueryRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_sample_query]
    ...
    def import_sample_queries(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ImportSampleQueriesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_sample_queries]
    ...
    def __enter__(self) -> "SampleQueryServiceClient":
        return self
...
__all__ = ("SampleQueryServiceClient",)

...
class RankServiceClient(metaclass=RankServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, RankServiceTransport, Callable[..., RankServiceTransport]]
        ] = None,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=RankServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=RankServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=RankServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

...
class RankServiceClient(metaclass=RankServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = RankServiceClient._use_client_cert_effective()
    ...
    def rank(
        ...
        *,
        ...
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("ranking_config", request.ranking_config),)),)

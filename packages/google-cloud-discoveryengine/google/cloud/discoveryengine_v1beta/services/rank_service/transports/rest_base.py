...
class _BaseRankServiceRestTransport(RankServiceTransport):
    """Base REST backend transport for RankService.
    ...
    class _BaseRank:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseRankServiceRestTransport._BaseRank._get_unset_required_fields(query_params))
...
__all__ = ("_BaseRankServiceRestTransport",)

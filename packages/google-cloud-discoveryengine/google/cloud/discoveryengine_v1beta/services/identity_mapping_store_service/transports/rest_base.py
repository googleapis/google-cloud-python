    ...
    class _BaseCreateIdentityMappingStore:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{parent=projects/*/locations/*}/identityMappingStores",
    ...
    class _BaseDeleteIdentityMappingStore:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta/{name=projects/*/locations/*/identityMappingStores/*}",
                },
            ]
            return http_options
    ...
    class _BaseImportIdentityMappings:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{identity_mapping_store=projects/*/locations/*/identityMappingStores/*}:importIdentityMappings",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseListIdentityMappings:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{identity_mapping_store=projects/*/locations/*/identityMappingStores/*}:listIdentityMappings",
                },
            ]
            return http_options
    ...
    class _BasePurgeIdentityMappings:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta/{identity_mapping_store=projects/*/locations/*/identityMappingStores/*}:purgeIdentityMappings",
                    "body": "*",
                },
            ]
            return http_options

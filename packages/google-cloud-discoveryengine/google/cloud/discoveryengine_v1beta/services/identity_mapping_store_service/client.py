...
from .transports.grpc import IdentityMappingStoreServiceGrpcTransport
from .transports.grpc_asyncio import IdentityMappingStoreServiceGrpcAsyncIOTransport
from .transports.rest import IdentityMappingStoreServiceRestTransport


class IdentityMappingStoreServiceClientMeta(type):
    """Metaclass for the IdentityMappingStoreService client.
    ...
    ) -> Type[IdentityMappingStoreServiceTransport]:
...
class IdentityMappingStoreServiceClient(
    metaclass=IdentityMappingStoreServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IdentityMappingStoreServiceClient: The constructed client.
        """
    ...
    def transport(self) -> IdentityMappingStoreServiceTransport:
        ...
        Returns:
            IdentityMappingStoreServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = IdentityMappingStoreServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = IdentityMappingStoreServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = IdentityMappingStoreServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = IdentityMappingStoreServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, IdentityMappingStoreServiceTransport)
        if transport_provided:
            # transport is a IdentityMappingStoreServiceTransport instance.
            ...
            self._transport = cast(IdentityMappingStoreServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or IdentityMappingStoreServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                IdentityMappingStoreServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., IdentityMappingStoreServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.IdentityMappingStoreServiceClient`.",
                    extra={
    ...
    def create_identity_mapping_store(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_identity_mapping_store():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateIdentityMappingStoreRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            identity_mapping_store (google.cloud.discoveryengine_v1beta.types.IdentityMappingStore):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_identity_mapping_store
        ]
    ...
    def get_identity_mapping_store(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetIdentityMappingStoreRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_identity_mapping_store
        ]
    ...
    def delete_identity_mapping_store(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DeleteIdentityMappingStoreRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_identity_mapping_store
        ]
    ...
    def import_identity_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ImportIdentityMappingsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.import_identity_mappings]
    ...
    def purge_identity_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.PurgeIdentityMappingsRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.purge_identity_mappings]
    ...
    def list_identity_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListIdentityMappingsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.pagers.ListIdentityMappingsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_identity_mappings]
        ...
        response = pagers.ListIdentityMappingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def list_identity_mapping_stores(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_identity_mapping_stores():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListIdentityMappingStoresRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.pagers.ListIdentityMappingStoresPager:
                Response message for
                   [IdentityMappingStoreService.ListIdentityMappingStores][google.cloud.discoveryengine.v1beta.IdentityMappingStoreService.ListIdentityMappingStores]
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_identity_mapping_stores
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListIdentityMappingStoresPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def __enter__(self) -> "IdentityMappingStoreServiceClient":
        return self
...
__all__ = ("IdentityMappingStoreServiceClient",)

...
from google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service import (
    pagers,
)
...
class IdentityMappingStoreServiceAsyncClient:
    ...
    _client: IdentityMappingStoreServiceClient
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            IdentityMappingStoreServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            IdentityMappingStoreServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
    ...
    def transport(self) -> IdentityMappingStoreServiceTransport:
        ...
        Returns:
            IdentityMappingStoreServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,IdentityMappingStoreServiceTransport,Callable[..., IdentityMappingStoreServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the IdentityMappingStoreServiceTransport constructor.
        ...
        """
        self._client = IdentityMappingStoreServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient`.",
                extra={
                    "serviceName": "google.cloud.discoveryengine.v1beta.IdentityMappingStoreService",
    ...
    async def create_identity_mapping_store(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_identity_mapping_store():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.CreateIdentityMappingStoreRequest(
                ...
                # Make the request
                response = await client.create_identity_mapping_store(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.CreateIdentityMappingStoreRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            identity_mapping_store (:class:`google.cloud.discoveryengine_v1beta.types.IdentityMappingStore`):
                Required. The Identity Mapping Store
                to create.

                This corresponds to the ``identity_mapping_store`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.types.IdentityMappingStore:
        ...
        if identity_mapping_store is not None:
            request.identity_mapping_store = identity_mapping_store
        if identity_mapping_store_id is not None:
            request.identity_mapping_store_id = identity_mapping_store_id
    ...
    async def get_identity_mapping_store(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_identity_mapping_store():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.GetIdentityMappingStoreRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.get_identity_mapping_store(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.GetIdentityMappingStoreRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_identity_mapping_store(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_identity_mapping_store():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.DeleteIdentityMappingStoreRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.DeleteIdentityMappingStoreRequest, dict]]):
                The request object. Request message for
        ...
        response = operation_async.from_gapic(
            ...
            empty_pb2.Empty,
            metadata_type=identity_mapping_store_service.DeleteIdentityMappingStoreMetadata,
        )
    ...
    async def import_identity_mappings(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_import_identity_mappings():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.ImportIdentityMappingsRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.ImportIdentityMappingsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.discoveryengine_v1beta.types.ImportIdentityMappingsResponse` Response message for
                   [IdentityMappingStoreService.ImportIdentityMappings][google.cloud.discoveryengine.v1beta.IdentityMappingStoreService.ImportIdentityMappings]
        ...
        response = operation_async.from_gapic(
            response,
            self._client._transport.operations_client,
            identity_mapping_store_service.ImportIdentityMappingsResponse,
            metadata_type=identity_mapping_store_service.IdentityMappingEntryOperationMetadata,
        )
    ...
    async def purge_identity_mappings(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_purge_identity_mappings():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.PurgeIdentityMappingsRequest(
                    identity_mapping_store="identity_mapping_store_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.PurgeIdentityMappingsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_identity_mappings(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_identity_mappings():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.ListIdentityMappingsRequest(
                    identity_mapping_store="identity_mapping_store_value",
                )

                # Make the request
                page_result = client.list_identity_mappings(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.ListIdentityMappingsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.pagers.ListIdentityMappingsAsyncPager:
        ...
        response = pagers.ListIdentityMappingsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def list_identity_mapping_stores(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_identity_mapping_stores():
                # Create a client
                client = discoveryengine_v1beta.IdentityMappingStoreServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1beta.ListIdentityMappingStoresRequest(
                    parent="parent_value",
                )

                # Make the request
                page_result = client.list_identity_mapping_stores(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.ListIdentityMappingStoresRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.identity_mapping_store_service.pagers.ListIdentityMappingStoresAsyncPager:
                Response message for
                   [IdentityMappingStoreService.ListIdentityMappingStores][google.cloud.discoveryengine.v1beta.IdentityMappingStoreService.ListIdentityMappingStores]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListIdentityMappingStoresAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

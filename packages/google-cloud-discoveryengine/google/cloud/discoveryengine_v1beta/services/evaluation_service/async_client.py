...
class EvaluationServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return EvaluationServiceClient.from_service_account_info.__func__(
            EvaluationServiceAsyncClient, info, *args, **kwargs
        )  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            EvaluationServiceAsyncClient: The constructed client.
        """
        return EvaluationServiceClient.from_service_account_file.__func__(
            EvaluationServiceAsyncClient, filename, *args, **kwargs
        )  # type: ignore

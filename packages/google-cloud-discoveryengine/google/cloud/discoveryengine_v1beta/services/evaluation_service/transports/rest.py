...
class EvaluationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[evaluation_service.CreateEvaluationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_evaluation(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[evaluation_service.GetEvaluationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_evaluation_results(
        ...
        evaluation_service.ListEvaluationResultsRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def pre_list_evaluations(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[evaluation_service.ListEvaluationsRequest, Sequence[Tuple[str, str]]]:

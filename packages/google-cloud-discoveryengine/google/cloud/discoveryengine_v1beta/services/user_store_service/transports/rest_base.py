...
class _BaseUserStoreServiceRestTransport(UserStoreServiceTransport):
    """Base REST backend transport for UserStoreService.
    ...
    class _BaseGetUserStore:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{name=projects/*/locations/*/userStores/*}",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = user_store_service.GetUserStoreRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseUserStoreServiceRestTransport._BaseGetUserStore._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateUserStore:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta/{user_store.name=projects/*/locations/*/userStores/*}",
                    "body": "user_store",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = user_store_service.UpdateUserStoreRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseUserStoreServiceRestTransport._BaseUpdateUserStore._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseUserStoreServiceRestTransport",)

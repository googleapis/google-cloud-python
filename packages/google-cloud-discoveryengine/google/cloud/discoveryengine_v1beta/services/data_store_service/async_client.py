...
class DataStoreServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = DataStoreServiceClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            DataStoreServiceAsyncClient: The constructed client.
        """
        sa_file_func = DataStoreServiceClient.from_service_account_file.__func__  # type: ignore
    ...
    get_transport_class = DataStoreServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1beta.DataStoreServiceAsyncClient`.",
                extra={

...
class DataStoreServiceAsyncClient:
    ...
    async def create_data_store(self,
    ...
    async def list_data_stores(self,
    ...
    async def delete_data_store(self,
    ...
    async def update_data_store(self,

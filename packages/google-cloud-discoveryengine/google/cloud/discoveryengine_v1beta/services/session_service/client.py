...
class SessionServiceClient(metaclass=SessionServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or SessionServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.SessionServiceClient`.",
                    extra={
    ...
    def list_sessions(
        ...
        *,
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.session_service.pagers.ListSessionsPager:

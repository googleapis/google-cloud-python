...
class ProjectServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1beta.ProjectServiceAsyncClient`.",
                extra={
    ...
    async def provision_project(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1beta.types.ProvisionProjectRequest, dict]]):

...
class CmekConfigServiceGrpcAsyncIOTransport(CmekConfigServiceTransport):
    """gRPC AsyncIO backend transport for CmekConfigService.
    ...
    def list_cmek_configs(
        ...
        Returns:
            Callable[[~.ListCmekConfigsRequest],
                    Awaitable[~.ListCmekConfigsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_cmek_configs: self._wrap_method(
                self.list_cmek_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_cmek_config: self._wrap_method(

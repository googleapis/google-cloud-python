    ...
    class _BaseDeleteCmekConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta/{name=projects/*/locations/*/cmekConfigs/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetCmekConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{name=projects/*/locations/*/cmekConfig}",
                },
                {
                    "method": "get",
                    "uri": "/v1beta/{name=projects/*/locations/*/cmekConfigs/*}",
    ...
    class _BaseListCmekConfigs:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta/{parent=projects/*/locations/*}/cmekConfigs",
                },
            ]
            return http_options
    ...
    class _BaseUpdateCmekConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta/{config.name=projects/*/locations/*/cmekConfig}",
                    "body": "config",
                },
                {
                    "method": "patch",
                    "uri": "/v1beta/{config.name=projects/*/locations/*/cmekConfigs/*}",
                    "body": "config",
                },
            ]
            return http_options

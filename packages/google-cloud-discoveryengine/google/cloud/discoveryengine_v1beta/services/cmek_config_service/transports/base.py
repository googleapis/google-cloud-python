...
class CmekConfigServiceTransport(abc.ABC):
    """Abstract transport class for CmekConfigService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_cmek_configs: gapic_v1.method.wrap_method(
                self.list_cmek_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_cmek_config: gapic_v1.method.wrap_method(
                self.delete_cmek_config,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_cmek_config(
        ...
        Union[
            cmek_config_service.CmekConfig, Awaitable[cmek_config_service.CmekConfig]
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("CmekConfigServiceTransport",)

...
from .transports.grpc import LicenseConfigServiceGrpcTransport
from .transports.grpc_asyncio import LicenseConfigServiceGrpcAsyncIOTransport
from .transports.rest import LicenseConfigServiceRestTransport


class LicenseConfigServiceClientMeta(type):
    """Metaclass for the LicenseConfigService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[LicenseConfigServiceTransport]]
    _transport_registry["grpc"] = LicenseConfigServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = LicenseConfigServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = LicenseConfigServiceRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[LicenseConfigServiceTransport]:
...
class LicenseConfigServiceClient(metaclass=LicenseConfigServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            LicenseConfigServiceClient: The constructed client.
        """
    ...
    def transport(self) -> LicenseConfigServiceTransport:
        ...
        Returns:
            LicenseConfigServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def billing_account_license_config_path(
        billing_account: str,
        billing_account_license_config: str,
    ) -> str:
        """Returns a fully-qualified billing_account_license_config string."""
        return "billingAccounts/{billing_account}/billingAccountLicenseConfigs/{billing_account_license_config}".format(
            billing_account=billing_account,
            billing_account_license_config=billing_account_license_config,
        )

    @staticmethod
    def parse_billing_account_license_config_path(path: str) -> Dict[str, str]:
        """Parses a billing_account_license_config path into its component segments."""
        m = re.match(
            r"^billingAccounts/(?P<billing_account>.+?)/billingAccountLicenseConfigs/(?P<billing_account_license_config>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def license_config_path(
        project: str,
        location: str,
        license_config: str,
    ) -> str:
        """Returns a fully-qualified license_config string."""
        return "projects/{project}/locations/{location}/licenseConfigs/{license_config}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_license_config_path(path: str) -> Dict[str, str]:
        """Parses a license_config path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/licenseConfigs/(?P<license_config>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = LicenseConfigServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = LicenseConfigServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = LicenseConfigServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = LicenseConfigServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the license config service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            LicenseConfigServiceClient._read_environment_variables()
        )
        self._client_cert_source = LicenseConfigServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = LicenseConfigServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, LicenseConfigServiceTransport)
        if transport_provided:
            # transport is a LicenseConfigServiceTransport instance.
            ...
            self._transport = cast(LicenseConfigServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or LicenseConfigServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                LicenseConfigServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., LicenseConfigServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1beta.LicenseConfigServiceClient`.",
                    extra={
    ...
    def create_license_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_license_config():
                # Create a client
                client = discoveryengine_v1beta.LicenseConfigServiceClient()
                ...
                # Make the request
                response = client.create_license_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.CreateLicenseConfigRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_license_config]
    ...
    def update_license_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_license_config():
                # Create a client
                client = discoveryengine_v1beta.LicenseConfigServiceClient()
                ...
                # Make the request
                response = client.update_license_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.UpdateLicenseConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_license_config]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_license_config():
                ...
                # Make the request
                response = client.get_license_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.GetLicenseConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_license_config]
    ...
    def list_license_configs(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLicenseConfigsPager:
        r"""Lists all the
        [LicenseConfig][google.cloud.discoveryengine.v1beta.LicenseConfig]s
        ...
        .. code-block:: python
            ...
            def sample_list_license_configs():
                # Create a client
                client = discoveryengine_v1beta.LicenseConfigServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.ListLicenseConfigsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1beta.services.license_config_service.pagers.ListLicenseConfigsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_license_configs]
        ...
        response = pagers.ListLicenseConfigsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def distribute_license_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_distribute_license_config():
                # Create a client
                client = discoveryengine_v1beta.LicenseConfigServiceClient()
                ...
                # Make the request
                response = client.distribute_license_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.DistributeLicenseConfigRequest, dict]):
                The request object. Request message for
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.distribute_license_config
        ]
    ...
    def retract_license_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_retract_license_config():
                # Create a client
                client = discoveryengine_v1beta.LicenseConfigServiceClient()
                ...
                # Make the request
                response = client.retract_license_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1beta.types.RetractLicenseConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.retract_license_config]
    ...
    def __enter__(self) -> "LicenseConfigServiceClient":
        return self
...
__all__ = ("LicenseConfigServiceClient",)

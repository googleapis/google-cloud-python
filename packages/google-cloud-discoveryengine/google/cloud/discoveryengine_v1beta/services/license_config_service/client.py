...
from google.cloud.discoveryengine_v1beta._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=LicenseConfigServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=LicenseConfigServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=LicenseConfigServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

...
class LicenseConfigServiceTransport(abc.ABC):
    """Abstract transport class for LicenseConfigService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_license_config: gapic_v1.method.wrap_method(
                self.create_license_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_license_config: gapic_v1.method.wrap_method(
                self.update_license_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_license_config: gapic_v1.method.wrap_method(
                self.get_license_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_license_configs: gapic_v1.method.wrap_method(
                self.list_license_configs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.distribute_license_config: gapic_v1.method.wrap_method(
                self.distribute_license_config,
                default_timeout=None,
                client_info=client_info,
            ),
            self.retract_license_config: gapic_v1.method.wrap_method(
                self.retract_license_config,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def create_license_config(
        ...
        Union[
            ...
            Awaitable[gcd_license_config.LicenseConfig],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_license_config(
        ...
        Union[license_config.LicenseConfig, Awaitable[license_config.LicenseConfig]],
    ]:
        raise NotImplementedError()
    ...
    def list_license_configs(
        ...
        Union[
            ...
            Awaitable[license_config_service.ListLicenseConfigsResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def distribute_license_config(
        ...
        Union[
            ...
            Awaitable[license_config_service.DistributeLicenseConfigResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def retract_license_config(
        ...
        Union[
            ...
            Awaitable[license_config_service.RetractLicenseConfigResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("LicenseConfigServiceTransport",)

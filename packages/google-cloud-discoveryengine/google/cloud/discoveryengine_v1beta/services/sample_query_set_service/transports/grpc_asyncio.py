...
class SampleQuerySetServiceGrpcAsyncIOTransport(SampleQuerySetServiceTransport):
    """gRPC AsyncIO backend transport for SampleQuerySetService.
    ...
    def get_sample_query_set(
        ...
        return self._stubs["get_sample_query_set"]
    ...
    def list_sample_query_sets(
        ...
        Returns:
            Callable[[~.ListSampleQuerySetsRequest],
                    Awaitable[~.ListSampleQuerySetsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        return self._stubs["list_sample_query_sets"]
    ...
    def create_sample_query_set(
        ...
        return self._stubs["create_sample_query_set"]
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_sample_query_set: gapic_v1.method_async.wrap_method(
                self.get_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_sample_query_sets: gapic_v1.method_async.wrap_method(
                self.list_sample_query_sets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_sample_query_set: gapic_v1.method_async.wrap_method(
                self.create_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_sample_query_set: gapic_v1.method_async.wrap_method(
                self.update_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_sample_query_set: gapic_v1.method_async.wrap_method(
                self.delete_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
        }
...
__all__ = ("SampleQuerySetServiceGrpcAsyncIOTransport",)

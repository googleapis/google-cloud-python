...
from .base import SampleQuerySetServiceTransport, DEFAULT_CLIENT_INFO
...
class SampleQuerySetServiceGrpcAsyncIOTransport(SampleQuerySetServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_sample_query_set: self._wrap_method(
                self.get_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_sample_query_sets: self._wrap_method(
                self.list_sample_query_sets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_sample_query_set: self._wrap_method(
                self.create_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_sample_query_set: self._wrap_method(
                self.update_sample_query_set,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_sample_query_set: self._wrap_method(

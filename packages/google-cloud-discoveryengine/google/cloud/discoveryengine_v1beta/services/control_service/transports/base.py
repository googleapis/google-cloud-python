...
class ControlServiceTransport(abc.ABC):
    ...
    @property
    def create_control(self) -> Callable[[control_service.CreateControlRequest], Union[gcd_control.Control, Awaitable[gcd_control.Control]]]:
        raise NotImplementedError()
    ...
    @property
    def update_control(self) -> Callable[[control_service.UpdateControlRequest], Union[gcd_control.Control, Awaitable[gcd_control.Control]]]:
        raise NotImplementedError()

...
class Document(proto.Message):
    ...
    Attributes:
        ...
        content (google.cloud.discoveryengine_v1.types.Document.Content):
            ...
            can only be set and must be set if this document is
        ...
        Attributes:
            ...
            mime_type (str):
                ...
                * ``application/vnd.ms-excel.sheet.macroenabled.12``
                ...
                The following types are supported only if layout parser
                is enabled in the data store:
    ...
    class IndexStatus(proto.Message):
        ...
        Attributes:
            ...
            pending_message (str):
                Immutable. The message indicates the document index
                is in progress. If this field is populated, the document
                index is pending.
        """

    ...
    Attributes:
        ...
        filter (str):
            ...
            * ``userId``: Double quoted string. Specifying this will
            ...
            Note: This API only supports purging a max range of 30
            days.
            ...
            * Deleting specific eventType in a time range:
              ...
              ``eventTime > "2012-04-23T18:25:43.511Z"
              eventTime < "2012-04-23T18:30:43.511Z" eventType =
            "search"``
            ...
            * Deleting all events for a specific visitor in a time
            range:
              ...
              ``eventTime > "2012-04-23T18:25:43.511Z"
              eventTime < "2012-04-23T18:30:43.511Z" userPseudoId =
            "visitor1024"``

            * Deleting the past 30 days of events inside a
            DataStore:
    ...
    Attributes:
        gcs_source (google.cloud.discoveryengine_v1.types.GcsSource):
            ...
            * ``document_id``: One valid
            `Document.id
            <google.cloud.discoveryengine.v1.Document.id>`__ per
            line.

...
class UpdateConversationRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            `Conversation
            <google.cloud.discoveryengine.v1.Conversation>`__
...
class AnswerQueryRequest(proto.Message):
    ...
    Attributes:
        ...
        asynchronous_mode (bool):
            Deprecated: This field is deprecated. Streaming
            Answer API will be supported.
            ...
            calling `ConversationalSearchService.GetAnswer
    ...
    class SafetySpec(proto.Message):
        ...
        2. when safety_spec.enable is set and some safety_settings are
    ...
    class GroundingSpec(proto.Message):
        ...
        Attributes:
            include_grounding_supports (bool):
                ...
                grounding_supports in the answer. The default
                value is ``false``.

                When this field is set to ``true``, returned
                answer will have ``grounding_score`` and will
            ...
            class SearchResult(proto.Message):
                ...
                class UnstructuredDocumentInfo(proto.Message):
                    ...
                    class ExtractiveSegment(proto.Message):
                        ...
                        Answer generation will only use it if document_contexts is
                        empty. This is supposed to be shorter snippets.
...
class AnswerQueryResponse(proto.Message):
    ...
    Attributes:
        answer (google.cloud.discoveryengine_v1.types.Answer):
            ...
            `Answer.name
            <google.cloud.discoveryengine.v1.Answer.name>`__
        ...
        session (google.cloud.discoveryengine_v1.types.Session):
            ...
            set and valid in the `AnswerQueryRequest
...
class UpdateSessionRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            Indicates which fields in the provided
            `Session
            <google.cloud.discoveryengine.v1.Session>`__ to

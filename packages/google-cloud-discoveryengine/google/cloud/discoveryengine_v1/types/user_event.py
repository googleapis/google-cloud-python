...
class UserEvent(proto.Message):
    ...
    Attributes:
        ...
        conversion_type (str):
            ...
            name in lowercase letters or numbers separated by "-",
            such as "watch", "good-visit" etc.

            Do not set the field if
            `UserEvent.event_type
            <google.cloud.discoveryengine.v1.UserEvent.event_type>`__
            is not ``conversion``. This mixes the custom conversion
            event with predefined events like ``search``,
            ``view-item`` etc.
        user_pseudo_id (str):
            ...
            for this field.
        engine (str):
            The `Engine <google.cloud.discoveryengine.v1.Engine>`__
        ...
        data_store (str):
            The `DataStore
            <google.cloud.discoveryengine.v1.DataStore>`__ resource
            ...
            `UserEvent.engine
            <google.cloud.discoveryengine.v1.UserEvent.engine>`__ or
            `UserEvent.documents
        ...
        filter (str):
            ...
            `SearchRequest
            <google.cloud.discoveryengine.v1.SearchRequest>`__ may
...
class DocumentInfo(proto.Message):
    ...
    Attributes:
        id (str):
            The `Document
            <google.cloud.discoveryengine.v1.Document>`__ resource
            ID.
        ...
        uri (str):
            The `Document
            <google.cloud.discoveryengine.v1.Document>`__ URI - only
        ...
        conversion_value (float):
            ...
            were spent viewing a Document for the ``watch``
            conversion type.

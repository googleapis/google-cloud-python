...
class BigtableOptions(proto.Message):
    ...
    class Type(proto.Enum):
        ...
        `HBase
        Bytes.toBytes
        <https://hbase.apache.org/1.4/apidocs/org/apache/hadoop/hbase/util/Bytes.html>`__
    ...
    Attributes:
        ...
        auto_generate_ids (bool):
            ...
            * `GcsSource
            ...
            <google.cloud.discoveryengine.v1.GcsSource.data_schema>`__
            must be ``custom`` or ``csv``. Otherwise, an
            INVALID_ARGUMENT error is thrown.

            * `BigQuerySource
            <google.cloud.discoveryengine.v1.BigQuerySource>`__.
            `BigQuerySource.data_schema
            <google.cloud.discoveryengine.v1.BigQuerySource.data_schema>`__
            must be ``custom`` or ``csv``. Otherwise, an
            INVALID_ARGUMENT error is thrown.
        ...
        id_field (str):
            ...
            `auto_generate_ids
            <google.cloud.discoveryengine.v1.ImportDocumentsRequest.auto_generate_ids>`__

...
class RecommendRequest(proto.Message):
    ...
    Attributes:
        serving_config (str):
            ...
            <google.cloud.discoveryengine.v1.RecommendationService.Recommend>`__
            requests.
        user_event (google.cloud.discoveryengine_v1.types.UserEvent):
            ...
            <google.cloud.discoveryengine.v1.UserInfo.user_id>`__ to
            the same fixed ID for different users. If you are trying
            ...
            `UserEvent.user_info.user_id
            <google.cloud.discoveryengine.v1.UserInfo.user_id>`__
            unset.
        page_size (int):
        ...
        filter (str):
            ...
            * (language: ANY("en", "es")) AND NOT (categories:
            ANY("Movie"))  * (available: true) AND
               (language: ANY("en", "es")) OR (categories:
            ANY("Movie"))
            ...
            <google.cloud.discoveryengine.v1.RecommendRequest.params>`__
        ...
        params (MutableMapping[str, google.protobuf.struct_pb2.Value]):
            ...
            * ``returnDocument``: Boolean. If set to ``true``, the
            ...
            <google.cloud.discoveryengine.v1.RecommendResponse.RecommendationResult.document>`__.
            ...
            * ``returnScore``: Boolean. If set to true, the
            ...
            <google.cloud.discoveryengine.v1.RecommendResponse.RecommendationResult.metadata>`__.
...
class RecommendResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.cloud.discoveryengine_v1.types.RecommendResponse.RecommendationResult]):
        ...
        validate_only (bool):
            ...
            <google.cloud.discoveryengine.v1.RecommendRequest.validate_only>`__
            was set.
    """

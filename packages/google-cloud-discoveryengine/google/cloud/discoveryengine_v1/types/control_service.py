...
class UpdateControlRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            `Control
            <google.cloud.discoveryengine.v1.Control>`__ to
            update. The following are NOT supported:

            * `Control.name
            <google.cloud.discoveryengine.v1.Control.name>`__
            * `Control.solution_type
            <google.cloud.discoveryengine.v1.Control.solution_type>`__
    ...
    Attributes:
        ...
        filter (str):
            ...
            * List all the products under the parent branch
            if `filter
            <google.cloud.discoveryengine.v1.ListControlsRequest.filter>`__

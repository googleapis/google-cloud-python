...
class RankingRecord(proto.Message):
    ...
    `RankService.Rank <google.cloud.discoveryengine.v1.RankService.Rank>`__
    method.
    ...
    Attributes:
        ...
        title (str):
            ...
            At least one of
            `title
            <google.cloud.discoveryengine.v1.RankingRecord.title>`__
            or `content
            <google.cloud.discoveryengine.v1.RankingRecord.content>`__
        ...
        score (float):
            ...
            selected model. The score will be rounded to 2 decimal
            places. If the score is close to 0, it will be rounded
            to 0.0001 to avoid returning unset.
    """
...
class RankRequest(proto.Message):
    ...
    Attributes:
        ...
        query (str):
            The query to use.
        records (MutableSequence[google.cloud.discoveryengine_v1.types.RankingRecord]):

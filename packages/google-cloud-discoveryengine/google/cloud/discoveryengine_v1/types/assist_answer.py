...
class AssistAnswer(proto.Message):
    ...
    `AssistResponse <google.cloud.discoveryengine.v1.AssistResponse>`__.
    ...
    class Reply(proto.Message):
        ...
        Attributes:
            grounded_content (google.cloud.discoveryengine_v1.types.AssistantGroundedContent):
                Possibly grounded response text or media from the
                assistant.
...
class AssistantContent(proto.Message):
    ...
    Attributes:
        ...
        executable_code (google.cloud.discoveryengine_v1.types.AssistantContent.ExecutableCode):
            Code generated by the model that is meant to be
            executed.
        ...
        code_execution_result (google.cloud.discoveryengine_v1.types.AssistantContent.CodeExecutionResult):
            ...
            This field is a member of `oneof`_ ``data``.
        role (str):
            The producer of the content. Can be "model" or
            "user".
        thought (bool):
            Optional. Indicates if the part is thought from the
            model.
    """
    ...
    class Blob(proto.Message):
        ...
        Attributes:
            mime_type (str):
                Required. The media type (MIME type) of the generated
                data.
            data (bytes):
                Required. Raw bytes.
        """
    ...
    class ExecutableCode(proto.Message):
        r"""Code generated by the model that is meant to be executed by the
        model.

        Attributes:
            code (str):
                Required. The code content. Currently only supports
                Python.
        """
    ...
    class CodeExecutionResult(proto.Message):
        ...
        Attributes:
            ...
            output (str):
                Optional. Contains stdout when code execution is
                successful, stderr or other description otherwise.
        """
...
class AssistantGroundedContent(proto.Message):
    ...
    class TextGroundingMetadata(proto.Message):
        ...
        class Segment(proto.Message):
            ...
            Attributes:
                start_index (int):
                    Zero-based index indicating the start of the segment,
                    measured in bytes of a UTF-8 string (i.e. characters
                    encoded on multiple bytes have a length of more than
                    one).
                end_index (int):
        ...
        class Reference(proto.Message):
            ...
            class DocumentMetadata(proto.Message):
                ...
                Attributes:
                    ...
                    uri (str):
                        URI for the document. It may contain a URL that
                    ...
                    domain (str):
                        ...
                        website, in which case this will contain the domain name
                        of the target site.

...
class DataStoreServiceClient(metaclass=DataStoreServiceClientMeta):
    ...
    @staticmethod
    def identity_mapping_store_path(project: str,location: str,identity_mapping_store: str,) -> str:
        """Returns a fully-qualified identity_mapping_store string."""
        return "projects/{project}/locations/{location}/identityMappingStores/{identity_mapping_store}".format(project=project, location=location, identity_mapping_store=identity_mapping_store, )

...
class CompletionServiceTransport(abc.ABC):
    ...
    def import_suggestion_deny_list_entries(
        self,
    ) -> Callable[[import_config.ImportSuggestionDenyListEntriesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def purge_suggestion_deny_list_entries(
        self,
    ) -> Callable[[purge_config.PurgeSuggestionDenyListEntriesRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def import_completion_suggestions(
        self,
    ) -> Callable[[import_config.ImportCompletionSuggestionsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def purge_completion_suggestions(
        self,
    ) -> Callable[[purge_config.PurgeCompletionSuggestionsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

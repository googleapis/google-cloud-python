...
from .transports.base import CmekConfigServiceTransport, DEFAULT_CLIENT_INFO
...
class CmekConfigServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return CmekConfigServiceClient.from_service_account_info.__func__(CmekConfigServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            CmekConfigServiceAsyncClient: The constructed client.
        """
        return CmekConfigServiceClient.from_service_account_file.__func__(CmekConfigServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    async def update_cmek_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.UpdateCmekConfigRequest, dict]]):
                The request object. Request message for UpdateCmekConfig
                method. rpc.
            config (:class:`google.cloud.discoveryengine_v1.types.CmekConfig`):
    ...
    async def get_cmek_config(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.GetCmekConfigRequest, dict]]):
        ...
        Returns:
            google.cloud.discoveryengine_v1.types.CmekConfig:
    ...
    async def list_cmek_configs(self,
        ...
        .. code-block:: python
            ...
            async def sample_list_cmek_configs():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1.ListCmekConfigsRequest(
                    parent="parent_value",
                )
    ...
    async def delete_cmek_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_cmek_config():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1.DeleteCmekConfigRequest(
                    name="name_value",
                )

...
class CmekConfigServiceGrpcAsyncIOTransport(CmekConfigServiceTransport):
    ...
    @property
    def update_cmek_config(self) -> Callable[[cmek_config_service.UpdateCmekConfigRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_cmek_config(self) -> Callable[[cmek_config_service.GetCmekConfigRequest], Awaitable[cmek_config_service.CmekConfig]]:
    ...
    @property
    def list_cmek_configs(self) -> Callable[[cmek_config_service.ListCmekConfigsRequest], Awaitable[cmek_config_service.ListCmekConfigsResponse]]:
    ...
    @property
    def delete_cmek_config(self) -> Callable[[cmek_config_service.DeleteCmekConfigRequest], Awaitable[operations_pb2.Operation]]:

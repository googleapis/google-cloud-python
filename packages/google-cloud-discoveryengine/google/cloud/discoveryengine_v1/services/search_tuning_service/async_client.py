...
class SearchTuningServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            SearchTuningServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(SearchTuningServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            SearchTuningServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(SearchTuningServiceAsyncClient, filename, *args, **kwargs)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_train_custom_model():
                ...
                # Make the request
                operation = await client.train_custom_model(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.TrainCustomModelRequest, dict]]):
    ...
    async def list_custom_models(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ListCustomModelsRequest, dict]]):
                The request object. Request message for

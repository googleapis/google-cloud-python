...
class ListIdentityMappingsPager:
    ...
    :class:`google.cloud.discoveryengine_v1.types.ListIdentityMappingsResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.ListIdentityMappingsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1.types.ListIdentityMappingsRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1.types.ListIdentityMappingsResponse):
    ...
    def __aiter__(self) -> AsyncIterator[identity_mapping_store.IdentityMappingEntry]:
        async def async_generator():
            async for page in self.pages:
                for response in page.identity_mapping_entries:
                    yield response
...
class ListIdentityMappingStoresPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.discoveryengine_v1.types.ListIdentityMappingStoresResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.ListIdentityMappingStoresResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.discoveryengine_v1.types.ListIdentityMappingStoresRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1.types.ListIdentityMappingStoresResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
...
class ListIdentityMappingStoresAsyncPager:
    ...
    def __aiter__(self) -> AsyncIterator[identity_mapping_store.IdentityMappingStore]:
        async def async_generator():
            async for page in self.pages:
                for response in page.identity_mapping_stores:
                    yield response

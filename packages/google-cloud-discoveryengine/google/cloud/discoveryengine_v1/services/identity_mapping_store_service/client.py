...
class IdentityMappingStoreServiceClient(metaclass=IdentityMappingStoreServiceClientMeta):
    ...
    def parse_identity_mapping_store_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/identityMappingStores/(?P<identity_mapping_store>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = IdentityMappingStoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, IdentityMappingStoreServiceTransport, Callable[..., IdentityMappingStoreServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = IdentityMappingStoreServiceClient._read_environment_variables()
        self._client_cert_source = IdentityMappingStoreServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = IdentityMappingStoreServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        self._api_endpoint = self._api_endpoint or IdentityMappingStoreServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[IdentityMappingStoreServiceTransport], Callable[..., IdentityMappingStoreServiceTransport]] = (
                IdentityMappingStoreServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., IdentityMappingStoreServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1.IdentityMappingStoreServiceClient`.",
                    extra={
    ...
    def create_identity_mapping_store(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_identity_mapping_store]
    ...
    def get_identity_mapping_store(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_identity_mapping_store]
    ...
    def delete_identity_mapping_store(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_identity_mapping_store]
    ...
    def list_identity_mapping_stores(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_identity_mapping_stores]

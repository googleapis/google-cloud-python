...
class IdentityMappingStoreServiceRestInterceptor:
    """Interceptor for IdentityMappingStoreService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the IdentityMappingStoreServiceRestTransport.

    .. code-block:: python
        class MyCustomIdentityMappingStoreServiceInterceptor(IdentityMappingStoreServiceRestInterceptor):
            def pre_create_identity_mapping_store(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_identity_mapping_store(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_identity_mapping_store(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_identity_mapping_store(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_get_identity_mapping_store(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_identity_mapping_store(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_import_identity_mappings(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_import_identity_mappings(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_identity_mappings(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_identity_mappings(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_identity_mapping_stores(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_identity_mapping_stores(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_purge_identity_mappings(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_purge_identity_mappings(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = IdentityMappingStoreServiceRestTransport(interceptor=MyCustomIdentityMappingStoreServiceInterceptor())
    ...
    def pre_create_identity_mapping_store(
        ...
        before they are sent to the IdentityMappingStoreService server.
        """
        return request, metadata
    ...
    def post_create_identity_mapping_store(
        ...
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_create_identity_mapping_store` interceptor runs
        before the `post_create_identity_mapping_store_with_metadata` interceptor.
        """
        return response
    ...
    def post_create_identity_mapping_store_with_metadata(
        ...
        is returned by the IdentityMappingStoreService server but before it is returned to user code.

        We recommend only using this `post_create_identity_mapping_store_with_metadata`
        interceptor in new development instead of the `post_create_identity_mapping_store` interceptor.
        When both interceptors are used, this `post_create_identity_mapping_store_with_metadata` interceptor runs after the
        `post_create_identity_mapping_store` interceptor. The (possibly modified) response returned by
        `post_create_identity_mapping_store` will be passed to
    ...
    def post_delete_identity_mapping_store(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_delete_identity_mapping_store` interceptor runs
        before the `post_delete_identity_mapping_store_with_metadata` interceptor.
        """
        return response
    ...
    def post_delete_identity_mapping_store_with_metadata(
        ...
        We recommend only using this `post_delete_identity_mapping_store_with_metadata`
        interceptor in new development instead of the `post_delete_identity_mapping_store` interceptor.
        When both interceptors are used, this `post_delete_identity_mapping_store_with_metadata` interceptor runs after the
        `post_delete_identity_mapping_store` interceptor. The (possibly modified) response returned by
        `post_delete_identity_mapping_store` will be passed to
    ...
    def post_get_identity_mapping_store(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_get_identity_mapping_store` interceptor runs
        before the `post_get_identity_mapping_store_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_identity_mapping_store_with_metadata(
        ...
        We recommend only using this `post_get_identity_mapping_store_with_metadata`
        interceptor in new development instead of the `post_get_identity_mapping_store` interceptor.
        When both interceptors are used, this `post_get_identity_mapping_store_with_metadata` interceptor runs after the
        `post_get_identity_mapping_store` interceptor. The (possibly modified) response returned by
        `post_get_identity_mapping_store` will be passed to
    ...
    def post_import_identity_mappings(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_import_identity_mappings` interceptor runs
        before the `post_import_identity_mappings_with_metadata` interceptor.
        """
        return response
    ...
    def post_import_identity_mappings_with_metadata(
        ...
        We recommend only using this `post_import_identity_mappings_with_metadata`
        interceptor in new development instead of the `post_import_identity_mappings` interceptor.
        When both interceptors are used, this `post_import_identity_mappings_with_metadata` interceptor runs after the
        `post_import_identity_mappings` interceptor. The (possibly modified) response returned by
        `post_import_identity_mappings` will be passed to
    ...
    def post_list_identity_mappings(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_list_identity_mappings` interceptor runs
        before the `post_list_identity_mappings_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_identity_mappings_with_metadata(
        ...
        We recommend only using this `post_list_identity_mappings_with_metadata`
        interceptor in new development instead of the `post_list_identity_mappings` interceptor.
        When both interceptors are used, this `post_list_identity_mappings_with_metadata` interceptor runs after the
        `post_list_identity_mappings` interceptor. The (possibly modified) response returned by
        `post_list_identity_mappings` will be passed to
    ...
    def post_list_identity_mapping_stores(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_list_identity_mapping_stores` interceptor runs
        before the `post_list_identity_mapping_stores_with_metadata` interceptor.
        """
        return response
    ...
    def post_list_identity_mapping_stores_with_metadata(
        ...
        We recommend only using this `post_list_identity_mapping_stores_with_metadata`
        interceptor in new development instead of the `post_list_identity_mapping_stores` interceptor.
        When both interceptors are used, this `post_list_identity_mapping_stores_with_metadata` interceptor runs after the
        `post_list_identity_mapping_stores` interceptor. The (possibly modified) response returned by
        `post_list_identity_mapping_stores` will be passed to
    ...
    def post_purge_identity_mappings(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the IdentityMappingStoreService server but before
        it is returned to user code. This `post_purge_identity_mappings` interceptor runs
        before the `post_purge_identity_mappings_with_metadata` interceptor.
        """
        return response
    ...
    def post_purge_identity_mappings_with_metadata(
        ...
        We recommend only using this `post_purge_identity_mappings_with_metadata`
        interceptor in new development instead of the `post_purge_identity_mappings` interceptor.
        When both interceptors are used, this `post_purge_identity_mappings_with_metadata` interceptor runs after the
        `post_purge_identity_mappings` interceptor. The (possibly modified) response returned by
        `post_purge_identity_mappings` will be passed to
...
class IdentityMappingStoreServiceRestStub:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[IdentityMappingStoreServiceRestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or IdentityMappingStoreServiceRestInterceptor()
    ...
    class _CreateIdentityMappingStore(
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = gcd_identity_mapping_store.IdentityMappingStore()
            pb_resp = gcd_identity_mapping_store.IdentityMappingStore.pb(resp)
    ...
    class _GetIdentityMappingStore(
        ...
        def __call__(
            ...
            *,
            ...
            # Return the response
            resp = identity_mapping_store.IdentityMappingStore()
            pb_resp = identity_mapping_store.IdentityMappingStore.pb(resp)

...
from google.cloud.discoveryengine_v1.types import conversational_search_service, safety, search_service
...
class ConversationalSearchServiceClient(metaclass=ConversationalSearchServiceClientMeta):
    ...
    def parse_conversation_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/conversations/(?P<conversation>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ConversationalSearchServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ConversationalSearchServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ConversationalSearchServiceClient._get_api_endpoint(

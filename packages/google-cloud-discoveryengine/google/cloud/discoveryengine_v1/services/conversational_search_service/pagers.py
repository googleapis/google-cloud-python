...
from google.cloud.discoveryengine_v1.types import conversation, conversational_search_service, session
...
class ListConversationsPager:
    ...
    :class:`google.cloud.discoveryengine_v1.types.ListConversationsResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.ListConversationsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1.types.ListConversationsRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1.types.ListConversationsResponse):

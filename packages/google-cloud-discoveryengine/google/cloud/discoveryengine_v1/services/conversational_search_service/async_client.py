...
class ConversationalSearchServiceAsyncClient:
    ...
    assist_answer_path = staticmethod(ConversationalSearchServiceClient.assist_answer_path)
    parse_assist_answer_path = staticmethod(ConversationalSearchServiceClient.parse_assist_answer_path)
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1.ConversationalSearchServiceAsyncClient`.",
                extra = {
    ...
    async def converse_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ConverseConversationRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                should not be set.
            query (:class:`google.cloud.discoveryengine_v1.types.TextInput`):
    ...
    async def create_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.CreateConversationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversation (:class:`google.cloud.discoveryengine_v1.types.Conversation`):
    ...
    async def delete_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.DeleteConversationRequest, dict]]):
    ...
    async def update_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.UpdateConversationRequest, dict]]):
    ...
    async def get_conversation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.GetConversationRequest, dict]]):
    ...
    async def list_conversations(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.ListConversationsRequest, dict]]):
    ...
    async def answer_query(self,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.AnswerQueryRequest, dict]]):
                The request object. Request message for
    ...
    def stream_answer_query(self,
        ...
        Returns:
            AsyncIterable[google.cloud.discoveryengine_v1.types.AnswerQueryResponse]:
                Response message for
                   [ConversationalSearchService.AnswerQuery][google.cloud.discoveryengine.v1.ConversationalSearchService.AnswerQuery]
                   method.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stream_answer_query]

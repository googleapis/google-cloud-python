...
from google.cloud.discoveryengine_v1.types import project_service

from .base import DEFAULT_CLIENT_INFO, ProjectServiceTransport


class _BaseProjectServiceRestTransport(ProjectServiceTransport):
    """Base REST backend transport for ProjectService.
    ...
    class _BaseProvisionProject:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*}:provision",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = project_service.ProvisionProjectRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseProvisionProject._get_unset_required_fields(query_params))
...
__all__ = ("_BaseProjectServiceRestTransport",)

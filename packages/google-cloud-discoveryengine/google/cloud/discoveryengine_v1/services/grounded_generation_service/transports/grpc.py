...
class GroundedGenerationServiceGrpcTransport(GroundedGenerationServiceTransport):
    ...
    def stream_generate_grounded_content(
        self,
    ) -> Callable[[grounded_generation_service.GenerateGroundedContentRequest], grounded_generation_service.GenerateGroundedContentResponse]:
    ...
    def generate_grounded_content(
        ...
        if "generate_grounded_content" not in self._stubs:
            self._stubs["generate_grounded_content"] = self._logged_channel.unary_unary(
    ...
    @property
    def check_grounding(self) -> Callable[[grounded_generation_service.CheckGroundingRequest], grounded_generation_service.CheckGroundingResponse]:
...
__all__ = ("GroundedGenerationServiceGrpcTransport",)

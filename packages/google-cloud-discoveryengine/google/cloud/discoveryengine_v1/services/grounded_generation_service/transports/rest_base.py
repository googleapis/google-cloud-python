...
from .base import DEFAULT_CLIENT_INFO, GroundedGenerationServiceTransport


class _BaseGroundedGenerationServiceRestTransport(GroundedGenerationServiceTransport):
    """Base REST backend transport for GroundedGenerationService.
    ...
    class _BaseCheckGrounding:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{grounding_config=projects/*/locations/*/groundingConfigs/*}:check",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseGroundedGenerationServiceRestTransport._BaseCheckGrounding._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseGenerateGroundedContent:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{location=projects/*/locations/*}:generateGroundedContent",
                    "body": "*",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = grounded_generation_service.GenerateGroundedContentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseGroundedGenerationServiceRestTransport._BaseGenerateGroundedContent._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseStreamGenerateGroundedContent:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseGroundedGenerationServiceRestTransport",)

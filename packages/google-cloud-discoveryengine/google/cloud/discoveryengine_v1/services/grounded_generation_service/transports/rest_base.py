...
class _BaseGroundedGenerationServiceRestTransport(GroundedGenerationServiceTransport):
    ...
    class _BaseCheckGrounding:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseGroundedGenerationServiceRestTransport._BaseCheckGrounding._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGenerateGroundedContent:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = grounded_generation_service.GenerateGroundedContentRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseGroundedGenerationServiceRestTransport._BaseGenerateGroundedContent._get_unset_required_fields(
                    query_params
                )
            )

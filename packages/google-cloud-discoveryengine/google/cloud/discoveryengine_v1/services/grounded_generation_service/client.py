...
class GroundedGenerationServiceClient(metaclass=GroundedGenerationServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = GroundedGenerationServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or GroundedGenerationServiceClient._get_api_endpoint(

...
class GroundedGenerationServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[GroundedGenerationServiceTransport]]
...
class GroundedGenerationServiceClient(metaclass=GroundedGenerationServiceClientMeta):
    ...
    @staticmethod
    def grounding_config_path(
        project: str,
        location: str,
        grounding_config: str,
    ) -> str:
        """Returns a fully-qualified grounding_config string."""
        return "projects/{project}/locations/{location}/groundingConfigs/{grounding_config}".format(
            project=project,
            location=location,
    ...
    def parse_grounding_config_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/groundingConfigs/(?P<grounding_config>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = GroundedGenerationServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = GroundedGenerationServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or GroundedGenerationServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1.GroundedGenerationServiceClient`.",
                    extra={
    ...
    def stream_generate_grounded_content(
        self,
        requests: Optional[
            Iterator[grounded_generation_service.GenerateGroundedContentRequest]
        ] = None,
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.stream_generate_grounded_content
        ]
    ...
    def generate_grounded_content(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_grounded_content
        ]
...
__all__ = ("GroundedGenerationServiceClient",)

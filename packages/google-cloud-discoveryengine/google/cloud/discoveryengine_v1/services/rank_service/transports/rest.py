...
class RankServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_rank(
        self, request: rank_service.RankRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ...
    def post_rank_with_metadata(
        self, response: rank_service.RankResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]

...
class RankServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_rank(
        ...
        it is returned to user code. This `post_rank` interceptor runs
        before the `post_rank_with_metadata` interceptor.
        """
        return response
    ...
    def post_rank_with_metadata(
        ...
        is returned by the RankService server but before it is returned to user code.

        We recommend only using this `post_rank_with_metadata`
        interceptor in new development instead of the `post_rank` interceptor.
        When both interceptors are used, this `post_rank_with_metadata` interceptor runs after the
        `post_rank` interceptor. The (possibly modified) response returned by
        `post_rank` will be passed to
        `post_rank_with_metadata`.
        """
...
class RankServiceRestTransport(_BaseRankServiceRestTransport):
    """REST backend synchronous transport for RankService.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[RankServiceRestInterceptor]): Interceptor used
    ...
    class _Rank(_BaseRankServiceRestTransport._BaseRank, RankServiceRestStub):
        def __hash__(self):
            return hash("RankServiceRestTransport.Rank")
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseRankServiceRestTransport._BaseRank,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseRankServiceRestTransport._BaseCancelOperation,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseRankServiceRestTransport._BaseGetOperation,
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                request,
                required_fields_default_values=getattr(
                    _BaseRankServiceRestTransport._BaseListOperations,

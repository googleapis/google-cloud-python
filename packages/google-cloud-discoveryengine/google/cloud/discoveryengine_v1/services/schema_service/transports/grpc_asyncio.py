...
class SchemaServiceGrpcAsyncIOTransport(SchemaServiceTransport):
    ...
    @property
    def get_schema(self) -> Callable[[schema_service.GetSchemaRequest], Awaitable[schema.Schema]]:
    ...
    @property
    def list_schemas(self) -> Callable[[schema_service.ListSchemasRequest], Awaitable[schema_service.ListSchemasResponse]]:
    ...
    @property
    def create_schema(self) -> Callable[[schema_service.CreateSchemaRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def update_schema(self) -> Callable[[schema_service.UpdateSchemaRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_schema(self) -> Callable[[schema_service.DeleteSchemaRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_schema: self._wrap_method(
                self.update_schema,
                default_timeout=None,
                client_info=client_info,
            ),

...
class SchemaServiceGrpcAsyncIOTransport(SchemaServiceTransport):
    ...
    def create_schema(
        ...
        [schema_service.CreateSchemaRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def update_schema(
        ...
        [schema_service.UpdateSchemaRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def delete_schema(
        ...
        [schema_service.DeleteSchemaRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.update_schema: gapic_v1.method_async.wrap_method(
                self.update_schema,
                default_timeout=None,
                client_info=client_info,
            ),

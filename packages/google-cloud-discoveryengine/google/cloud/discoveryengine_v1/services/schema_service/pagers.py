...
class ListSchemasPager:
    ...
    :class:`google.cloud.discoveryengine_v1.types.ListSchemasResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.ListSchemasResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1.types.ListSchemasRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1.types.ListSchemasResponse):

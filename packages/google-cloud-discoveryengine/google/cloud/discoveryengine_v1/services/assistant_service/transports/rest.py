...
class AssistantServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_stream_assist(self, request: assistant_service.StreamAssistRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[assistant_service.StreamAssistRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_stream_assist_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for stream_assist
    ...
    class _StreamAssist(_BaseAssistantServiceRestTransport._BaseStreamAssist, AssistantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1.AssistantServiceClient.StreamAssist",
                    extra = {
            ...
            # Send the request
            response = AssistantServiceRestTransport._StreamAssist._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseAssistantServiceRestTransport._BaseCancelOperation, AssistantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1.AssistantServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1.AssistantService",
            ...
            # Send the request
            response = AssistantServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseAssistantServiceRestTransport._BaseGetOperation, AssistantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1.AssistantServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1.AssistantService",
            ...
            # Send the request
            response = AssistantServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1.AssistantServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1.AssistantService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseAssistantServiceRestTransport._BaseListOperations, AssistantServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1.AssistantServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1.AssistantService",
            ...
            # Send the request
            response = AssistantServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1.AssistantServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1.AssistantService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

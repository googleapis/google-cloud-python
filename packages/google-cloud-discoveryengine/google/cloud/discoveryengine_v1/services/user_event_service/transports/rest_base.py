...
from google.cloud.discoveryengine_v1.types import import_config, purge_config, user_event, user_event_service

from .base import DEFAULT_CLIENT_INFO, UserEventServiceTransport


class _BaseUserEventServiceRestTransport(UserEventServiceTransport):
    """Base REST backend transport for UserEventService.
    ...
    class _BaseCollectUserEvent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*/dataStores/*}/userEvents:collect",
                },
                {
                    "method": "get",
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserEventServiceRestTransport._BaseCollectUserEvent._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseImportUserEvents:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/dataStores/*}/userEvents:import",
                    "body": "*",
                },
                {
                    "method": "post",
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserEventServiceRestTransport._BaseImportUserEvents._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BasePurgeUserEvents:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/dataStores/*}/userEvents:purge",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/collections/*/dataStores/*}/userEvents:purge",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserEventServiceRestTransport._BasePurgeUserEvents._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseWriteUserEvent:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/dataStores/*}/userEvents:write",
                    "body": "user_event",
                },
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/collections/*/dataStores/*}/userEvents:write",
                    "body": "user_event",
                },
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/userEvents:write",
                    "body": "user_event",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserEventServiceRestTransport._BaseWriteUserEvent._get_unset_required_fields(query_params))
...
__all__ = ("_BaseUserEventServiceRestTransport",)

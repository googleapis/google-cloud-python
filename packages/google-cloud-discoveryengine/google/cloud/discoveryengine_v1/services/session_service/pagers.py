...
class ListSessionsPager:
    ...
    :class:`google.cloud.discoveryengine_v1.types.ListSessionsResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1.types.ListSessionsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1.types.ListSessionsRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1.types.ListSessionsResponse):

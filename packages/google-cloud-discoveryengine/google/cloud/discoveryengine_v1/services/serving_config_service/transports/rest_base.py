    ...
    class _BaseUpdateServingConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{serving_config.name=projects/*/locations/*/dataStores/*/servingConfigs/*}",
                    "body": "serving_config",
                },
                {
                    "method": "patch",
                    "uri": "/v1/{serving_config.name=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}",
                    "body": "serving_config",
                },
                {
                    "method": "patch",
                    "uri": "/v1/{serving_config.name=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}",
                    "body": "serving_config",
                },
            ]
            return http_options

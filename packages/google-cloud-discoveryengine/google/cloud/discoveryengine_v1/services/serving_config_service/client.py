        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1.ServingConfigServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_serving_config():
                # Create a client
                client = discoveryengine_v1.ServingConfigServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.UpdateServingConfigRequest, dict]):

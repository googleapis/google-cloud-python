...
from google.cloud.discoveryengine_v1.types import serving_config_service
...
class ServingConfigServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return ServingConfigServiceClient.from_service_account_info.__func__(
            ServingConfigServiceAsyncClient, info, *args, **kwargs
        )  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ServingConfigServiceAsyncClient: The constructed client.
        """
        return ServingConfigServiceClient.from_service_account_file.__func__(
            ServingConfigServiceAsyncClient, filename, *args, **kwargs
        )  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1.ServingConfigServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_serving_config():
                # Create a client
                client = discoveryengine_v1.ServingConfigServiceAsyncClient()

                # Initialize request argument(s)
                serving_config = discoveryengine_v1.ServingConfig()
                ...
                request = discoveryengine_v1.UpdateServingConfigRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1.types.UpdateServingConfigRequest, dict]]):
                The request object. Request for UpdateServingConfig
                method.
            serving_config (:class:`google.cloud.discoveryengine_v1.types.ServingConfig`):
        ...
        Returns:
            google.cloud.discoveryengine_v1.types.ServingConfig:

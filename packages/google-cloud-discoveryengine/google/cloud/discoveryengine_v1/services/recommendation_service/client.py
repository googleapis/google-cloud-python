...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RecommendationServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RecommendationServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RecommendationServiceClient._get_universe_domain(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1.RecommendationServiceClient`.",
                    extra={
    ...
    def recommend(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1.types.RecommendRequest, dict]):
        ...
        Returns:
            google.cloud.discoveryengine_v1.types.RecommendResponse:

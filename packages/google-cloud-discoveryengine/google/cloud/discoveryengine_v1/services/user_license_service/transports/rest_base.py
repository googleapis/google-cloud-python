...
class _BaseUserLicenseServiceRestTransport(UserLicenseServiceTransport):
    ...
    class _BaseBatchUpdateUserLicenses:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*/userStores/*}:batchUpdateUserLicenses',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserLicenseServiceRestTransport._BaseBatchUpdateUserLicenses._get_unset_required_fields(query_params))
    ...
    class _BaseListUserLicenses:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'get',
                'uri': '/v1/{parent=projects/*/locations/*/userStores/*}/userLicenses',
            },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseUserLicenseServiceRestTransport._BaseListUserLicenses._get_unset_required_fields(query_params))
...
__all__=(
    '_BaseUserLicenseServiceRestTransport',
)

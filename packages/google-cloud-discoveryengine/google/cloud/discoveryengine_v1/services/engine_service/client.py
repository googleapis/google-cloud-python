...
class EngineServiceClient(metaclass=EngineServiceClientMeta):
    ...
    def collection_path(
        ...
        return "projects/{project}/locations/{location}/collections/{collection}".format(
            project=project,
            location=location,
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = EngineServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or EngineServiceClient._get_api_endpoint(
    ...
    def update_engine(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("engine.name", request.engine.name),)),)

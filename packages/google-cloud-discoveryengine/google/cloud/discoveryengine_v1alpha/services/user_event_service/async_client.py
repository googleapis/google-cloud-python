...
class UserEventServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1alpha.UserEventServiceAsyncClient`.",
                extra={
    ...
    async def write_user_event(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.WriteUserEventRequest, dict]]):
    ...
    async def collect_user_event(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CollectUserEventRequest, dict]]):
    ...
    async def purge_user_events(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.PurgeUserEventsRequest, dict]]):
    ...
    async def import_user_events(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ImportUserEventsRequest, dict]]):

...
from google.cloud.discoveryengine_v1alpha.types import common, import_config, purge_config, user_event, user_event_service
...
class UserEventServiceClient(metaclass=UserEventServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.UserEventServiceClient`.",
                    extra={
    ...
    def write_user_event(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.WriteUserEventRequest, dict]):
    ...
    def collect_user_event(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.CollectUserEventRequest, dict]):
    ...
    def purge_user_events(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.PurgeUserEventsRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.discoveryengine_v1alpha.types.PurgeUserEventsResponse` Response of the PurgeUserEventsRequest. If the long running operation is
    ...
    def import_user_events(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ImportUserEventsRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.discoveryengine_v1alpha.types.ImportUserEventsResponse` Response of the ImportUserEventsRequest. If the long running

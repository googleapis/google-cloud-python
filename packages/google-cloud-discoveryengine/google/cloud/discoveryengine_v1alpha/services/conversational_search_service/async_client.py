...
class ConversationalSearchServiceAsyncClient:
    ...
    async def converse_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ConverseConversationRequest, dict]]):
            ...
            name (:class:`str`):
                ...
                should not be set.
            query (:class:`google.cloud.discoveryengine_v1alpha.types.TextInput`):
    ...
    async def create_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CreateConversationRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversation (:class:`google.cloud.discoveryengine_v1alpha.types.Conversation`):
    ...
    async def delete_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.DeleteConversationRequest, dict]]):
    ...
    async def update_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.UpdateConversationRequest, dict]]):
    ...
    async def get_conversation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetConversationRequest, dict]]):
    ...
    async def list_conversations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListConversationsRequest, dict]]):
    ...
    async def answer_query(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.AnswerQueryRequest, dict]]):
                The request object. Request message for
    ...
    async def get_answer(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetAnswerRequest, dict]]):

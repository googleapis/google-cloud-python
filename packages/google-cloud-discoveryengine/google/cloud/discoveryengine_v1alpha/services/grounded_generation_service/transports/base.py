...
class GroundedGenerationServiceTransport(abc.ABC):
    ...
    def check_grounding(
        ...
        Union[grounded_generation_service.CheckGroundingResponse, Awaitable[grounded_generation_service.CheckGroundingResponse]],
    ]:
        raise NotImplementedError()
...
__all__ = ("GroundedGenerationServiceTransport",)

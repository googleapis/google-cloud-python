...
class GroundedGenerationServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            GroundedGenerationServiceClient.from_service_account_info.__func__
        )  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            GroundedGenerationServiceClient.from_service_account_file.__func__
        )  # type: ignore
        return sa_file_func(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_check_grounding():
                # Create a client
                client = discoveryengine_v1alpha.GroundedGenerationServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CheckGroundingRequest, dict]]):

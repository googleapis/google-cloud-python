...
from .rest_base import _BaseEstimateBillingServiceRestTransport
...
class EstimateBillingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_estimate_data_size(self, request: estimate_billing_service.EstimateDataSizeRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[estimate_billing_service.EstimateDataSizeRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_estimate_data_size_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for estimate_data_size
...
class EstimateBillingServiceRestTransport(_BaseEstimateBillingServiceRestTransport):
    """REST backend synchronous transport for EstimateBillingService.
    ...
    class _EstimateDataSize(_BaseEstimateBillingServiceRestTransport._BaseEstimateDataSize, EstimateBillingServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceClient.EstimateDataSize",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
                        "rpcName": "EstimateDataSize",
            ...
            # Send the request
            response = EstimateBillingServiceRestTransport._EstimateDataSize._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceClient.estimate_data_size",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
                        "rpcName": "EstimateDataSize",
    ...
    class _CancelOperation(_BaseEstimateBillingServiceRestTransport._BaseCancelOperation, EstimateBillingServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceClient.CancelOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
            ...
            # Send the request
            response = EstimateBillingServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseEstimateBillingServiceRestTransport._BaseGetOperation, EstimateBillingServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
            ...
            # Send the request
            response = EstimateBillingServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceAsyncClient.GetOperation",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(_BaseEstimateBillingServiceRestTransport._BaseListOperations, EstimateBillingServiceRestStub):
        ...
        def __call__(self,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
            ...
            # Send the request
            response = EstimateBillingServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.EstimateBillingServiceAsyncClient.ListOperations",
                    extra = {
                        "serviceName": "google.cloud.discoveryengine.v1alpha.EstimateBillingService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

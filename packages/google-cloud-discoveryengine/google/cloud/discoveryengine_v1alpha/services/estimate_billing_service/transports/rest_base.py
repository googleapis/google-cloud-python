...
from .base import DEFAULT_CLIENT_INFO, EstimateBillingServiceTransport


class _BaseEstimateBillingServiceRestTransport(EstimateBillingServiceTransport):
    """Base REST backend transport for EstimateBillingService.
    ...
    class _BaseEstimateDataSize:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseEstimateBillingServiceRestTransport._BaseEstimateDataSize._get_unset_required_fields(query_params))
...
__all__ = ("_BaseEstimateBillingServiceRestTransport",)

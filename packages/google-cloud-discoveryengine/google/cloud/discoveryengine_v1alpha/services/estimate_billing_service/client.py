...
class EstimateBillingServiceClientMeta(type):
    """Metaclass for the EstimateBillingService client.
...
class EstimateBillingServiceClient(metaclass=EstimateBillingServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            EstimateBillingServiceClient: The constructed client.
        """
    ...
    def transport(self) -> EstimateBillingServiceTransport:
        ...
        Returns:
            EstimateBillingServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = EstimateBillingServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = EstimateBillingServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = EstimateBillingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = EstimateBillingServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, EstimateBillingServiceTransport, Callable[..., EstimateBillingServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the estimate billing service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EstimateBillingServiceClient._read_environment_variables()
        self._client_cert_source = EstimateBillingServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = EstimateBillingServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, EstimateBillingServiceTransport)
        if transport_provided:
            # transport is a EstimateBillingServiceTransport instance.
        ...
        self._api_endpoint = self._api_endpoint or EstimateBillingServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EstimateBillingServiceTransport], Callable[..., EstimateBillingServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.EstimateBillingServiceClient`.",
                    extra={
    ...
    def estimate_data_size(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_estimate_data_size():
                # Create a client
                client = discoveryengine_v1alpha.EstimateBillingServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.EstimateDataSizeRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.estimate_data_size]
    ...
    def __enter__(self) -> "EstimateBillingServiceClient":
        return self
...
__all__ = ("EstimateBillingServiceClient",)

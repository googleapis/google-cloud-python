        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.CreateSchema",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.create_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "CreateSchema",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.DeleteSchema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.delete_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "DeleteSchema",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.GetSchema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "GetSchema",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.get_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "GetSchema",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.ListSchemas",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "ListSchemas",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.list_schemas",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "ListSchemas",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.UpdateSchema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.update_schema",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "UpdateSchema",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.discoveryengine_v1alpha.SchemaServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.discoveryengine_v1alpha.SchemaServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.discoveryengine.v1alpha.SchemaService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,

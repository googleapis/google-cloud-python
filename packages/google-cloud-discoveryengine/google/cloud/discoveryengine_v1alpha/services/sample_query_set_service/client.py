...
class SampleQuerySetServiceClient(metaclass=SampleQuerySetServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SampleQuerySetServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                SampleQuerySetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = SampleQuerySetServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SampleQuerySetServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SampleQuerySetServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceClient`.",
                    extra={
    ...
    def get_sample_query_set(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.GetSampleQuerySetRequest, dict]):
    ...
    def list_sample_query_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ListSampleQuerySetsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.services.sample_query_set_service.pagers.ListSampleQuerySetsPager:
    ...
    def create_sample_query_set(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.CreateSampleQuerySetRequest, dict]):
                The request object. Request message for
    ...
    def update_sample_query_set(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.UpdateSampleQuerySetRequest, dict]):
                The request object. Request message for
    ...
    def delete_sample_query_set(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.DeleteSampleQuerySetRequest, dict]):
                The request object. Request message for
...
__all__ = ("SampleQuerySetServiceClient",)

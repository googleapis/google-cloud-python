...
class SampleQuerySetServiceAsyncClient:
    ...
    sample_query_set_path = staticmethod(
        SampleQuerySetServiceClient.sample_query_set_path
    )
    parse_sample_query_set_path = staticmethod(
        SampleQuerySetServiceClient.parse_sample_query_set_path
    )
    common_billing_account_path = staticmethod(
        SampleQuerySetServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        SampleQuerySetServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(SampleQuerySetServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        SampleQuerySetServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        SampleQuerySetServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        SampleQuerySetServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(SampleQuerySetServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        SampleQuerySetServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        SampleQuerySetServiceClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        SampleQuerySetServiceClient.parse_common_location_path
    )
    ...
    get_transport_class = SampleQuerySetServiceClient.get_transport_class
        ...
        *,
        ...
        transport: Optional[
            Union[
                ...
                Callable[..., SampleQuerySetServiceTransport],
            ]
        ] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1alpha.SampleQuerySetServiceAsyncClient`.",
                extra={
    ...
    async def get_sample_query_set(
        self,
        request: Optional[
            Union[sample_query_set_service.GetSampleQuerySetRequest, dict]
        ] = None,
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_sample_query_set():
                # Create a client
                client = discoveryengine_v1alpha.SampleQuerySetServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetSampleQuerySetRequest, dict]]):
                The request object. Request message for
                `SampleQuerySetService.GetSampleQuerySet
                <google.cloud.discoveryengine.v1alpha.SampleQuerySetService.GetSampleQuerySet>`__
                method.
            name (:class:`str`):
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.types.SampleQuerySet:
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_sample_query_set
        ]
    ...
    async def list_sample_query_sets(
        self,
        request: Optional[
            Union[sample_query_set_service.ListSampleQuerySetsRequest, dict]
        ] = None,
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_sample_query_sets():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListSampleQuerySetsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListSampleQuerySetsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.services.sample_query_set_service.pagers.ListSampleQuerySetsAsyncPager:
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_sample_query_sets
        ]
    ...
    async def create_sample_query_set(
        self,
        request: Optional[
            Union[sample_query_set_service.CreateSampleQuerySetRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            async def sample_create_sample_query_set():
                ...
                # Initialize request argument(s)
                sample_query_set = discoveryengine_v1alpha.SampleQuerySet()
                sample_query_set.display_name = "display_name_value"

                request = discoveryengine_v1alpha.CreateSampleQuerySetRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CreateSampleQuerySetRequest, dict]]):
                The request object. Request message for
                `SampleQuerySetService.CreateSampleQuerySet
                <google.cloud.discoveryengine.v1alpha.SampleQuerySetService.CreateSampleQuerySet>`__
                method.
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            sample_query_set (:class:`google.cloud.discoveryengine_v1alpha.types.SampleQuerySet`):
                Required. The
                `SampleQuerySet
                <google.cloud.discoveryengine.v1alpha.SampleQuerySet>`__
                to create.
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.create_sample_query_set
        ]
    ...
    async def update_sample_query_set(
        self,
        request: Optional[
            Union[sample_query_set_service.UpdateSampleQuerySetRequest, dict]
        ] = None,
        *,
        sample_query_set: Optional[gcd_sample_query_set.SampleQuerySet] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_sample_query_set():
                ...
                request = discoveryengine_v1alpha.UpdateSampleQuerySetRequest(
                    sample_query_set=sample_query_set,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.UpdateSampleQuerySetRequest, dict]]):
                The request object. Request message for
                `SampleQuerySetService.UpdateSampleQuerySet
                <google.cloud.discoveryengine.v1alpha.SampleQuerySetService.UpdateSampleQuerySet>`__
                method.
            sample_query_set (:class:`google.cloud.discoveryengine_v1alpha.types.SampleQuerySet`):
                Required. The sample query set to
                update.
                If the caller does not have permission
                to update the `SampleQuerySet
                <google.cloud.discoveryengine.v1alpha.SampleQuerySet>`__,
                regardless of whether or not it exists,
                a ``PERMISSION_DENIED`` error is
                returned.
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_sample_query_set
        ]
    ...
    async def delete_sample_query_set(
        self,
        request: Optional[
            Union[sample_query_set_service.DeleteSampleQuerySetRequest, dict]
        ] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_sample_query_set():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.DeleteSampleQuerySetRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.DeleteSampleQuerySetRequest, dict]]):
                The request object. Request message for
                `SampleQuerySetService.DeleteSampleQuerySet
                <google.cloud.discoveryengine.v1alpha.SampleQuerySetService.DeleteSampleQuerySet>`__
                method.
            name (:class:`str`):
                Required. Full resource name of
                `SampleQuerySet
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_sample_query_set
        ]
...
__all__ = ("SampleQuerySetServiceAsyncClient",)

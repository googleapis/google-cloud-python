...
from google.cloud.discoveryengine_v1alpha.types import custom_tuning_model, search_tuning_service
...
class SearchTuningServiceClient(metaclass=SearchTuningServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SearchTuningServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or SearchTuningServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.SearchTuningServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_train_custom_model():
                # Create a client
                client = discoveryengine_v1alpha.SearchTuningServiceClient()
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.TrainCustomModelRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_custom_models():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListCustomModelsRequest(
                    data_store="data_store_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ListCustomModelsRequest, dict]):
                The request object. Request message for

...
class SearchTuningServiceClient(metaclass=SearchTuningServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SearchTuningServiceTransport]] = None,
        ...
        if isinstance(transport, SearchTuningServiceTransport):
    ...
    def train_custom_model(
        ...
        *,
        ...
        # in a search_tuning_service.TrainCustomModelRequest.

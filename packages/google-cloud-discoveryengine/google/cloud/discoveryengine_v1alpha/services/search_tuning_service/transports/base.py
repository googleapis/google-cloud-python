...
class SearchTuningServiceTransport(abc.ABC):
    ...
    def train_custom_model(
        self,
    ) -> Callable[[search_tuning_service.TrainCustomModelRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()
    ...
    def list_custom_models(
        ...
        Union[search_tuning_service.ListCustomModelsResponse, Awaitable[search_tuning_service.ListCustomModelsResponse]],
    ]:
        raise NotImplementedError()

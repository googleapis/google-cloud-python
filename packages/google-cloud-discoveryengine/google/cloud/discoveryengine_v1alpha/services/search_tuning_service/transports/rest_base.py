...
class _BaseSearchTuningServiceRestTransport(SearchTuningServiceTransport):
    """Base REST backend transport for SearchTuningService.
    ...
    class _BaseListCustomModels:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSearchTuningServiceRestTransport._BaseListCustomModels._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseTrainCustomModel:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSearchTuningServiceRestTransport._BaseTrainCustomModel._get_unset_required_fields(query_params))
...
__all__ = ("_BaseSearchTuningServiceRestTransport",)

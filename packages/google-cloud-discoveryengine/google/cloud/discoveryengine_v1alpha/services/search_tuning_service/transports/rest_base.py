...
class _BaseSearchTuningServiceRestTransport(SearchTuningServiceTransport):
    ...
    class _BaseListCustomModels:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseSearchTuningServiceRestTransport._BaseListCustomModels._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseTrainCustomModel:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseSearchTuningServiceRestTransport._BaseTrainCustomModel._get_unset_required_fields(
                    query_params
                )
            )

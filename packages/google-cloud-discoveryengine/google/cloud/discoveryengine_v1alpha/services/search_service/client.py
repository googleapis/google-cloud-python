...
from google.cloud.discoveryengine_v1alpha.services.search_service import pagers
...
class SearchServiceClientMeta(type):
    """Metaclass for the SearchService client.
...
class SearchServiceClient(metaclass=SearchServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SearchServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SearchServiceTransport:
        ...
        Returns:
            SearchServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = SearchServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = SearchServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SearchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = SearchServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SearchServiceTransport, Callable[..., SearchServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,SearchServiceTransport,Callable[..., SearchServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SearchServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = SearchServiceClient._read_environment_variables()
        self._client_cert_source = SearchServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = SearchServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, SearchServiceTransport)
        if transport_provided:
            # transport is a SearchServiceTransport instance.
            ...
            self._transport = cast(SearchServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or SearchServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[SearchServiceTransport], Callable[..., SearchServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.SearchServiceClient`.",
                    extra={
    ...
    def search(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.SearchRequest, dict]):

...
class SearchServiceClient(metaclass=SearchServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SearchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, SearchServiceTransport, Callable[..., SearchServiceTransport]]
        ] = None,
        ...
        self._client_cert_source = SearchServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SearchServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SearchServiceClient._get_api_endpoint(

...
class SearchPager:
    ...
    :class:`google.cloud.discoveryengine_v1alpha.types.SearchResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1alpha.types.SearchResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1alpha.types.SearchRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1alpha.types.SearchResponse):

...
class ListChunksPager:
    ...
    :class:`google.cloud.discoveryengine_v1alpha.types.ListChunksResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1alpha.types.ListChunksResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1alpha.types.ListChunksRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1alpha.types.ListChunksResponse):
        ...
        """
        self._method = method
        self._request = chunk_service.ListChunksRequest(request)
    ...
    @property
    def pages(self) -> Iterator[chunk_service.ListChunksResponse]:
...
class ListChunksAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[chunk_service.ListChunksResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token

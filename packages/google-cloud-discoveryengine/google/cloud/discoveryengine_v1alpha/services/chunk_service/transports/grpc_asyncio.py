...
class ChunkServiceGrpcAsyncIOTransport(ChunkServiceTransport):
    ...
    @property
    def get_chunk(self) -> Callable[[chunk_service.GetChunkRequest], Awaitable[chunk.Chunk]]:
    ...
    @property
    def list_chunks(self) -> Callable[[chunk_service.ListChunksRequest], Awaitable[chunk_service.ListChunksResponse]]:

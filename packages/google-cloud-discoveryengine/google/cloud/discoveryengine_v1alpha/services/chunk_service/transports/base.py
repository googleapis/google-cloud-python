...
class ChunkServiceTransport(abc.ABC):
    ...
    @property
    def get_chunk(self) -> Callable[[chunk_service.GetChunkRequest], Union[chunk.Chunk, Awaitable[chunk.Chunk]]]:
        raise NotImplementedError()

    @property
    def list_chunks(
        self,
    ) -> Callable[[chunk_service.ListChunksRequest], Union[chunk_service.ListChunksResponse, Awaitable[chunk_service.ListChunksResponse]]]:
        raise NotImplementedError()

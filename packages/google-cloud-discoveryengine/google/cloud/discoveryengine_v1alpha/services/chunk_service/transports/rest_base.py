...
class _BaseChunkServiceRestTransport(ChunkServiceTransport):
    """Base REST backend transport for ChunkService.
    ...
    class _BaseGetChunk:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseChunkServiceRestTransport._BaseGetChunk._get_unset_required_fields(query_params))
    ...
    class _BaseListChunks:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseChunkServiceRestTransport._BaseListChunks._get_unset_required_fields(query_params))
...
__all__ = ("_BaseChunkServiceRestTransport",)

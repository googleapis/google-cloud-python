...
from .transports.base import DEFAULT_CLIENT_INFO, RecommendationServiceTransport
...
class RecommendationServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = RecommendationServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        return sa_info_func(RecommendationServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(RecommendationServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return RecommendationServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1alpha.RecommendationServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_recommend():
                # Create a client
                client = discoveryengine_v1alpha.RecommendationServiceAsyncClient()
                ...
                request = discoveryengine_v1alpha.RecommendRequest(
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.RecommendRequest, dict]]):
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.types.RecommendResponse:

...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.RecommendationServiceClient`.",
                    extra={
    ...
    def recommend(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.RecommendRequest, dict]):

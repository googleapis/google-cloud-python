...
class DataStoreServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get_document_processing_config(
        self, request: data_store_service.GetDocumentProcessingConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[data_store_service.GetDocumentProcessingConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_document_processing_config_with_metadata(
        self, response: document_processing_config.DocumentProcessingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[document_processing_config.DocumentProcessingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_document_processing_config
    ...
    def pre_update_document_processing_config(
        self, request: data_store_service.UpdateDocumentProcessingConfigRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[data_store_service.UpdateDocumentProcessingConfigRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_document_processing_config_with_metadata(
        self, response: gcd_document_processing_config.DocumentProcessingConfig, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[gcd_document_processing_config.DocumentProcessingConfig, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_document_processing_config
...
class DataStoreServiceRestTransport(_BaseDataStoreServiceRestTransport):
    ...
    def get_document_processing_config(
        self,
    ) -> Callable[[data_store_service.GetDocumentProcessingConfigRequest], document_processing_config.DocumentProcessingConfig]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def update_document_processing_config(
        self,
    ) -> Callable[[data_store_service.UpdateDocumentProcessingConfigRequest], gcd_document_processing_config.DocumentProcessingConfig]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast

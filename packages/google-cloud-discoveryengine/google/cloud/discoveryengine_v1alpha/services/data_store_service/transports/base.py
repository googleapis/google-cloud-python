...
class DataStoreServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_data_store: gapic_v1.method.wrap_method(
                self.create_data_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_data_store: gapic_v1.method.wrap_method(
                self.get_data_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_data_stores: gapic_v1.method.wrap_method(
                self.list_data_stores,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_data_store: gapic_v1.method.wrap_method(
                self.delete_data_store,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_data_store: gapic_v1.method.wrap_method(
    ...
    def get_document_processing_config(
        ...
        Union[document_processing_config.DocumentProcessingConfig, Awaitable[document_processing_config.DocumentProcessingConfig]],
    ]:
        raise NotImplementedError()
    ...
    def update_document_processing_config(
        ...
        Union[gcd_document_processing_config.DocumentProcessingConfig, Awaitable[gcd_document_processing_config.DocumentProcessingConfig]],
    ]:
        raise NotImplementedError()

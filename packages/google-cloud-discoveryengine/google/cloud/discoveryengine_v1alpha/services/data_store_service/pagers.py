...
class ListDataStoresPager:
    ...
    :class:`google.cloud.discoveryengine_v1alpha.types.ListDataStoresResponse` object, and
    ...
    All the usual :class:`google.cloud.discoveryengine_v1alpha.types.ListDataStoresResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.discoveryengine_v1alpha.types.ListDataStoresRequest):
                The initial request object.
            response (google.cloud.discoveryengine_v1alpha.types.ListDataStoresResponse):

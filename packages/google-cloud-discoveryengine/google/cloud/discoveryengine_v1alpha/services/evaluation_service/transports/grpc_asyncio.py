...
class EvaluationServiceGrpcAsyncIOTransport(EvaluationServiceTransport):
    ...
    @property
    def get_evaluation(self) -> Callable[[evaluation_service.GetEvaluationRequest], Awaitable[evaluation.Evaluation]]:
    ...
    @property
    def list_evaluations(self) -> Callable[[evaluation_service.ListEvaluationsRequest], Awaitable[evaluation_service.ListEvaluationsResponse]]:
    ...
    @property
    def create_evaluation(self) -> Callable[[evaluation_service.CreateEvaluationRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def list_evaluation_results(
        self,
    ) -> Callable[[evaluation_service.ListEvaluationResultsRequest], Awaitable[evaluation_service.ListEvaluationResultsResponse]]:

...
class EvaluationServiceClient(metaclass=EvaluationServiceClientMeta):
    ...
    @staticmethod
    def evaluation_path(project: str,location: str,evaluation: str,) -> str:
        """Returns a fully-qualified evaluation string."""
        return "projects/{project}/locations/{location}/evaluations/{evaluation}".format(project=project, location=location, evaluation=evaluation, )

    @staticmethod
    def parse_evaluation_path(path: str) -> Dict[str,str]:
        """Parses a evaluation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/evaluations/(?P<evaluation>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def sample_query_path(project: str,location: str,sample_query_set: str,sample_query: str,) -> str:
        """Returns a fully-qualified sample_query string."""
        return "projects/{project}/locations/{location}/sampleQuerySets/{sample_query_set}/sampleQueries/{sample_query}".format(project=project, location=location, sample_query_set=sample_query_set, sample_query=sample_query, )

    @staticmethod
    def parse_sample_query_path(path: str) -> Dict[str,str]:
        """Parses a sample_query path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sampleQuerySets/(?P<sample_query_set>.+?)/sampleQueries/(?P<sample_query>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def sample_query_set_path(project: str,location: str,sample_query_set: str,) -> str:
        """Returns a fully-qualified sample_query_set string."""
        return "projects/{project}/locations/{location}/sampleQuerySets/{sample_query_set}".format(project=project, location=location, sample_query_set=sample_query_set, )

    @staticmethod
    def parse_sample_query_set_path(path: str) -> Dict[str,str]:
        """Parses a sample_query_set path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/sampleQuerySets/(?P<sample_query_set>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = EvaluationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EvaluationServiceTransport, Callable[..., EvaluationServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = EvaluationServiceClient._read_environment_variables()
        self._client_cert_source = EvaluationServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = EvaluationServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[EvaluationServiceTransport], Callable[..., EvaluationServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.EvaluationServiceClient`.",
                    extra = {
    ...
    def get_evaluation(self,
        ...
        .. code-block:: python
            ...
            def sample_get_evaluation():
                # Create a client
                client = discoveryengine_v1alpha.EvaluationServiceClient()

                # Initialize request argument(s)
                request = discoveryengine_v1alpha.GetEvaluationRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.GetEvaluationRequest, dict]):
    ...
    def list_evaluations(self,
            request: Optional[Union[evaluation_service.ListEvaluationsRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_list_evaluations():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListEvaluationsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ListEvaluationsRequest, dict]):
                The request object. Request message for
    ...
    def create_evaluation(self,
            request: Optional[Union[evaluation_service.CreateEvaluationRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.CreateEvaluationRequest, dict]):
                The request object. Request message for
    ...
    def list_evaluation_results(self,
            request: Optional[Union[evaluation_service.ListEvaluationResultsRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            def sample_list_evaluation_results():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListEvaluationResultsRequest(
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ListEvaluationResultsRequest, dict]):
                The request object. Request message for

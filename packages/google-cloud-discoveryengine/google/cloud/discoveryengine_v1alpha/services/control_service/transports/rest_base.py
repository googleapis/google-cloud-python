...
class _BaseControlServiceRestTransport(ControlServiceTransport):
    """Base REST backend transport for ControlService.
    ...
    class _BaseCreateControl:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseControlServiceRestTransport._BaseCreateControl._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseDeleteControl:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseControlServiceRestTransport._BaseDeleteControl._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseGetControl:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseControlServiceRestTransport._BaseGetControl._get_unset_required_fields(query_params))
    ...
    class _BaseListControls:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseControlServiceRestTransport._BaseListControls._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateControl:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseControlServiceRestTransport._BaseUpdateControl._get_unset_required_fields(query_params))
...
__all__ = ("_BaseControlServiceRestTransport",)

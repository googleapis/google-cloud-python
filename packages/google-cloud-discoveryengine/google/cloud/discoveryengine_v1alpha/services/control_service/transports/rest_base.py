...
from google.cloud.discoveryengine_v1alpha.types import control, control_service
...
class _BaseControlServiceRestTransport(ControlServiceTransport):
    ...
    class _BaseCreateControl:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseControlServiceRestTransport._BaseCreateControl._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseDeleteControl:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseControlServiceRestTransport._BaseDeleteControl._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetControl:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseControlServiceRestTransport._BaseGetControl._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListControls:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseControlServiceRestTransport._BaseListControls._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateControl:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseControlServiceRestTransport._BaseUpdateControl._get_unset_required_fields(
                    query_params
                )
            )

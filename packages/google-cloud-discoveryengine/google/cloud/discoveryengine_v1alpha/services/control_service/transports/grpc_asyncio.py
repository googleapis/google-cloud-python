...
class ControlServiceGrpcAsyncIOTransport(ControlServiceTransport):
    ...
    @property
    def create_control(self) -> Callable[[control_service.CreateControlRequest], Awaitable[gcd_control.Control]]:
        ...
        if "create_control" not in self._stubs:
            self._stubs["create_control"] = self._logged_channel.unary_unary(
                ...
                response_deserializer=gcd_control.Control.deserialize,
            )
    ...
    @property
    def update_control(self) -> Callable[[control_service.UpdateControlRequest], Awaitable[gcd_control.Control]]:

...
class ControlServiceClient(metaclass=ControlServiceClientMeta):
    ...
    @staticmethod
    def control_path(project: str,location: str,data_store: str,control: str,) -> str:
        """Returns a fully-qualified control string."""
        return "projects/{project}/locations/{location}/dataStores/{data_store}/controls/{control}".format(project=project, location=location, data_store=data_store, control=control, )

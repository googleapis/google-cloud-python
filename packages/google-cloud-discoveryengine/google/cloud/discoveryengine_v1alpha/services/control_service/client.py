...
from google.cloud.discoveryengine_v1alpha.types import common, control, control_service
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=ControlServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

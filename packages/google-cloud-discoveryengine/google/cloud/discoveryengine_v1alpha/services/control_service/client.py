...
class ControlServiceClient(metaclass=ControlServiceClientMeta):
    ...
    def parse_control_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dataStores/(?P<data_store>.+?)/controls/(?P<control>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ControlServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or ControlServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.ControlServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_control():
                # Create a client
                client = discoveryengine_v1alpha.ControlServiceClient()

                # Initialize request argument(s)
                control = discoveryengine_v1alpha.Control()
                ...
                request = discoveryengine_v1alpha.CreateControlRequest(
                    parent="parent_value",
                    control=control,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_control():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.DeleteControlRequest(
                    name="name_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_control():
                ...
                request = discoveryengine_v1alpha.UpdateControlRequest(
                    control=control,
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.UpdateControlRequest, dict]):
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("control.name", request.control.name),)),)
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_control():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.GetControlRequest(
                    name="name_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_controls():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListControlsRequest(
                    parent="parent_value",
                )

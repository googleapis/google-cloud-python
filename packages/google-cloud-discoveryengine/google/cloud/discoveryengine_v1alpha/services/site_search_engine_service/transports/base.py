...
class SiteSearchEngineServiceTransport(abc.ABC):
    ...
    def set_uri_pattern_document_data(
        ...
        [site_search_engine_service.SetUriPatternDocumentDataRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]
    ]:
        raise NotImplementedError()
    ...
    def get_uri_pattern_document_data(
        ...
        Union[site_search_engine_service.GetUriPatternDocumentDataResponse, Awaitable[site_search_engine_service.GetUriPatternDocumentDataResponse]],
    ]:
        raise NotImplementedError()

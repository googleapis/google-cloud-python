...
class SampleQueryServiceAsyncClient:
    ...
    _client: SampleQueryServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = SampleQueryServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = SampleQueryServiceClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = SampleQueryServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SampleQueryServiceAsyncClient: The constructed client.
        """
        sa_info_func = (
            SampleQueryServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(SampleQueryServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            SampleQueryServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(SampleQueryServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return SampleQueryServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore

    @property
    def transport(self) -> SampleQueryServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            SampleQueryServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,SampleQueryServiceTransport,Callable[..., SampleQueryServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the SampleQueryServiceTransport constructor.
        ...
        """
        self._client = SampleQueryServiceClient(
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1alpha.SampleQueryServiceAsyncClient`.",
                extra={
    ...
    async def get_sample_query(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_sample_query():
                # Create a client
                client = discoveryengine_v1alpha.SampleQueryServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1alpha.GetSampleQueryRequest(
                    name="name_value",
                )

                # Make the request
                response = await client.get_sample_query(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetSampleQueryRequest, dict]]):
        ...
        if not isinstance(request, sample_query_service.GetSampleQueryRequest):
            request = sample_query_service.GetSampleQueryRequest(request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_sample_queries():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListSampleQueriesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListSampleQueriesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.services.sample_query_service.pagers.ListSampleQueriesAsyncPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sample_query_service.ListSampleQueriesRequest):
            request = sample_query_service.ListSampleQueriesRequest(request)
        ...
        response = pagers.ListSampleQueriesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def create_sample_query(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_sample_query():
                # Create a client
                client = discoveryengine_v1alpha.SampleQueryServiceAsyncClient()
                ...
                # Make the request
                response = await client.create_sample_query(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CreateSampleQueryRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            sample_query (:class:`google.cloud.discoveryengine_v1alpha.types.SampleQuery`):
                Required. The
                [SampleQuery][google.cloud.discoveryengine.v1alpha.SampleQuery]
                to create.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sample_query_service.CreateSampleQueryRequest):
            request = sample_query_service.CreateSampleQueryRequest(request)
        ...
        if sample_query is not None:
            request.sample_query = sample_query
        if sample_query_id is not None:
            request.sample_query_id = sample_query_id
    ...
    async def update_sample_query(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.UpdateSampleQueryRequest, dict]]):
                The request object. Request message for
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                provided imported 'simple query' to
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sample_query_service.UpdateSampleQueryRequest):
            request = sample_query_service.UpdateSampleQueryRequest(request)
    ...
    async def delete_sample_query(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_sample_query():
                # Create a client
                client = discoveryengine_v1alpha.SampleQueryServiceAsyncClient()

                # Initialize request argument(s)
                request = discoveryengine_v1alpha.DeleteSampleQueryRequest(
                    name="name_value",
                )

                # Make the request
                await client.delete_sample_query(request=request)

        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.DeleteSampleQueryRequest, dict]]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sample_query_service.DeleteSampleQueryRequest):
            request = sample_query_service.DeleteSampleQueryRequest(request)
    ...
    async def import_sample_queries(
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_import_sample_queries():
                # Create a client
                client = discoveryengine_v1alpha.SampleQueryServiceAsyncClient()

                # Initialize request argument(s)
                inline_source = discoveryengine_v1alpha.InlineSource()
                inline_source.sample_queries.query_entry.query = "query_value"

                request = discoveryengine_v1alpha.ImportSampleQueriesRequest(
                    inline_source=inline_source,
                    parent="parent_value",
                )

                # Make the request
                operation = await client.import_sample_queries(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ImportSampleQueriesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.discoveryengine_v1alpha.types.ImportSampleQueriesResponse` Response of the
                   [SampleQueryService.ImportSampleQueries][google.cloud.discoveryengine.v1alpha.SampleQueryService.ImportSampleQueries]
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, import_config.ImportSampleQueriesRequest):
            request = import_config.ImportSampleQueriesRequest(request)
        ...
        response = operation_async.from_gapic(
            ...
            import_config.ImportSampleQueriesResponse,
            metadata_type=import_config.ImportSampleQueriesMetadata,
        )

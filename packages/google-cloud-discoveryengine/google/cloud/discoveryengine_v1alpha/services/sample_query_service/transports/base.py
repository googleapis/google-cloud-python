...
class SampleQueryServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_sample_query: gapic_v1.method.wrap_method(
                self.get_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_sample_queries: gapic_v1.method.wrap_method(
                self.list_sample_queries,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_sample_query: gapic_v1.method.wrap_method(
                self.create_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_sample_query: gapic_v1.method.wrap_method(
                self.update_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_sample_query: gapic_v1.method.wrap_method(
                self.delete_sample_query,
                default_timeout=None,
                client_info=client_info,
            ),
            self.import_sample_queries: gapic_v1.method.wrap_method(
...
__all__ = ("SampleQueryServiceTransport",)

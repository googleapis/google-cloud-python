...
class _BaseSampleQueryServiceRestTransport(SampleQueryServiceTransport):
    """Base REST backend transport for SampleQueryService.
    ...
    class _BaseCreateSampleQuery:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/sampleQuerySets/*}/sampleQueries",
                    "body": "sample_query",
                },
            ]
            return http_options
    ...
    class _BaseDeleteSampleQuery:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1alpha/{name=projects/*/locations/*/sampleQuerySets/*/sampleQueries/*}",
                },
            ]
            return http_options
    ...
    class _BaseImportSampleQueries:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/sampleQuerySets/*}/sampleQueries:import",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdateSampleQuery:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{sample_query.name=projects/*/locations/*/sampleQuerySets/*/sampleQueries/*}",
                    "body": "sample_query",
                },
            ]
            return http_options
...
__all__ = ("_BaseSampleQueryServiceRestTransport",)

...
from .base import DEFAULT_CLIENT_INFO, AclConfigServiceTransport
...
class _BaseAclConfigServiceRestTransport(AclConfigServiceTransport):
    ...
    class _BaseGetAclConfig:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAclConfigServiceRestTransport._BaseGetAclConfig._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateAclConfig:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAclConfigServiceRestTransport._BaseUpdateAclConfig._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseAclConfigServiceRestTransport",)

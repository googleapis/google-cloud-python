...
class CompletionServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return CompletionServiceClient.from_service_account_info.__func__(
            CompletionServiceAsyncClient, info, *args, **kwargs
        )  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            CompletionServiceAsyncClient: The constructed client.
        """
        return CompletionServiceClient.from_service_account_file.__func__(
            CompletionServiceAsyncClient, filename, *args, **kwargs
        )  # type: ignore
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_complete_query():
                # Create a client
                client = discoveryengine_v1alpha.CompletionServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CompleteQueryRequest, dict]]):
    ...
    async def import_suggestion_deny_list_entries(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ImportSuggestionDenyListEntriesRequest, dict]]):
                The request object. Request message for
    ...
    async def purge_suggestion_deny_list_entries(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.PurgeSuggestionDenyListEntriesRequest, dict]]):
                The request object. Request message for
    ...
    async def import_completion_suggestions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ImportCompletionSuggestionsRequest, dict]]):
                The request object. Request message for
    ...
    async def purge_completion_suggestions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.PurgeCompletionSuggestionsRequest, dict]]):
                The request object. Request message for

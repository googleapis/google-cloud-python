...
class SessionServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return SessionServiceClient.from_service_account_info.__func__(
            SessionServiceAsyncClient, info, *args, **kwargs
        )  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            SessionServiceAsyncClient: The constructed client.
        """
        return SessionServiceClient.from_service_account_file.__func__(
            SessionServiceAsyncClient, filename, *args, **kwargs
        )  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.discoveryengine_v1alpha.SessionServiceAsyncClient`.",
                extra={
    ...
    async def create_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.CreateSessionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            session (:class:`google.cloud.discoveryengine_v1alpha.types.Session`):
    ...
    async def delete_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.DeleteSessionRequest, dict]]):
    ...
    async def update_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.UpdateSessionRequest, dict]]):
    ...
    async def get_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.GetSessionRequest, dict]]):
    ...
    async def list_sessions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListSessionsRequest, dict]]):
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.services.session_service.pagers.ListSessionsAsyncPager:
    ...
    async def list_files(
        self,
        request: Optional[Union[session_service.ListFilesRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Lists metadata for all files in the current session.
        ...
        .. code-block:: python
            ...
            async def sample_list_files():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListFilesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.discoveryengine_v1alpha.types.ListFilesRequest, dict]]):
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.services.session_service.pagers.ListFilesAsyncPager:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.ListFilesRequest):
            request = session_service.ListFilesRequest(request)

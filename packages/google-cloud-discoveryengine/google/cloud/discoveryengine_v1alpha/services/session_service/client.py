...
class SessionServiceClient(metaclass=SessionServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.SessionServiceClient`.",
                    extra={
    ...
    def list_sessions(
        ...
        *,
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.services.session_service.pagers.ListSessionsPager:
    ...
    def list_files(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ListFilesRequest, dict]):

...
class DocumentServiceGrpcAsyncIOTransport(DocumentServiceTransport):
    ...
    @property
    def get_document(self) -> Callable[[document_service.GetDocumentRequest], Awaitable[document.Document]]:
    ...
    @property
    def list_documents(self) -> Callable[[document_service.ListDocumentsRequest], Awaitable[document_service.ListDocumentsResponse]]:
    ...
    @property
    def create_document(self) -> Callable[[document_service.CreateDocumentRequest], Awaitable[gcd_document.Document]]:
    ...
    @property
    def update_document(self) -> Callable[[document_service.UpdateDocumentRequest], Awaitable[gcd_document.Document]]:
    ...
    @property
    def delete_document(self) -> Callable[[document_service.DeleteDocumentRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def import_documents(self) -> Callable[[import_config.ImportDocumentsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def purge_documents(self) -> Callable[[purge_config.PurgeDocumentsRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def get_processed_document(self) -> Callable[[document_service.GetProcessedDocumentRequest], Awaitable[document.ProcessedDocument]]:
        ...
        if "get_processed_document" not in self._stubs:
            self._stubs["get_processed_document"] = self._logged_channel.unary_unary(
    ...
    def batch_get_documents_metadata(
        self,
    ) -> Callable[[document_service.BatchGetDocumentsMetadataRequest], Awaitable[document_service.BatchGetDocumentsMetadataResponse]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.purge_documents: self._wrap_method(
                self.purge_documents,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_processed_document: self._wrap_method(
                self.get_processed_document,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_get_documents_metadata: self._wrap_method(

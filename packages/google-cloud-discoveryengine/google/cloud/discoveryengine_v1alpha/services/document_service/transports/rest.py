...
class DocumentServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_batch_get_documents_metadata(
        ...
        document_service.BatchGetDocumentsMetadataRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def pre_get_processed_document(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[document_service.GetProcessedDocumentRequest, Sequence[Tuple[str, str]]]:
...
class DocumentServiceRestTransport(DocumentServiceTransport):
    ...
    class _BatchGetDocumentsMetadata(DocumentServiceRestStub):
        def __hash__(self):
            return hash("BatchGetDocumentsMetadata")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/dataStores/*/branches/*}/batchGetDocumentsMetadata",
                },
                {
                    "method": "get",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/branches/*}/batchGetDocumentsMetadata",
                },
            ]
            request, metadata = self._interceptor.pre_batch_get_documents_metadata(
                request, metadata
            )
            pb_request = document_service.BatchGetDocumentsMetadataRequest.pb(request)
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/dataStores/*/branches/*}/documents",
                    "body": "document",
                },
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/branches/*}/documents",
                    "body": "document",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1alpha/{name=projects/*/locations/*/dataStores/*/branches/*/documents/*}",
                },
                {
                    "method": "delete",
                    "uri": "/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/branches/*/documents/*}",
                },
            ]
    ...
    class _GetProcessedDocument(DocumentServiceRestStub):
        def __hash__(self):
            return hash("GetProcessedDocument")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1alpha/{name=projects/*/locations/*/dataStores/*/branches/*/documents/*}:getProcessedDocument",
                },
                {
                    "method": "get",
                    "uri": "/v1alpha/{name=projects/*/locations/*/collections/*/dataStores/*/branches/*/documents/*}:getProcessedDocument",
                },
            ]
            request, metadata = self._interceptor.pre_get_processed_document(
                request, metadata
            )
            pb_request = document_service.GetProcessedDocumentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/dataStores/*/branches/*}/documents:import",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/branches/*}/documents:import",
                    "body": "*",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/dataStores/*/branches/*}/documents:purge",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1alpha/{parent=projects/*/locations/*/collections/*/dataStores/*/branches/*}/documents:purge",
                    "body": "*",
                },
            ]
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{document.name=projects/*/locations/*/dataStores/*/branches/*/documents/*}",
                    "body": "document",
                },
                {
                    "method": "patch",
                    "uri": "/v1alpha/{document.name=projects/*/locations/*/collections/*/dataStores/*/branches/*/documents/*}",
                    "body": "document",
                },
            ]
    ...
    class _CancelOperation(DocumentServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,

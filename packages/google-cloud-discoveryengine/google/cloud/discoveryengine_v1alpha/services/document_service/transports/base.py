...
class DocumentServiceTransport(abc.ABC):
    ...
    @property
    def get_document(self) -> Callable[[document_service.GetDocumentRequest], Union[document.Document, Awaitable[document.Document]]]:
        raise NotImplementedError()
    ...
    def list_documents(
        ...
        [document_service.ListDocumentsRequest], Union[document_service.ListDocumentsResponse, Awaitable[document_service.ListDocumentsResponse]]
    ]:
        raise NotImplementedError()

    @property
    def create_document(self) -> Callable[[document_service.CreateDocumentRequest], Union[gcd_document.Document, Awaitable[gcd_document.Document]]]:
        raise NotImplementedError()

    @property
    def update_document(self) -> Callable[[document_service.UpdateDocumentRequest], Union[gcd_document.Document, Awaitable[gcd_document.Document]]]:
        raise NotImplementedError()

    @property
    def delete_document(self) -> Callable[[document_service.DeleteDocumentRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]]:
        raise NotImplementedError()

    @property
    def import_documents(
        self,
    ) -> Callable[[import_config.ImportDocumentsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def purge_documents(self) -> Callable[[purge_config.PurgeDocumentsRequest], Union[operations_pb2.Operation, Awaitable[operations_pb2.Operation]]]:
        raise NotImplementedError()

    @property
    def get_processed_document(
        self,
    ) -> Callable[[document_service.GetProcessedDocumentRequest], Union[document.ProcessedDocument, Awaitable[document.ProcessedDocument]]]:
        raise NotImplementedError()
    ...
    def batch_get_documents_metadata(
        ...
        Union[document_service.BatchGetDocumentsMetadataResponse, Awaitable[document_service.BatchGetDocumentsMetadataResponse]],
    ]:
        raise NotImplementedError()

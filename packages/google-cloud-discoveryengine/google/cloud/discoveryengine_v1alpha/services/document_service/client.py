...
from google.cloud.discoveryengine_v1alpha.services.document_service import pagers
...
class DocumentServiceClient(metaclass=DocumentServiceClientMeta):
    ...
    `Document <google.cloud.discoveryengine.v1alpha.Document>`__
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = DocumentServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.discoveryengine_v1alpha.DocumentServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_document():
                ...
                request = discoveryengine_v1alpha.GetDocumentRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.GetDocumentRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_documents():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.ListDocumentsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ListDocumentsRequest, dict]):
                The request object. Request message for
    ...
    def create_document(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.CreateDocumentRequest, dict]):
                The request object. Request message for
                `DocumentService.CreateDocument
                <google.cloud.discoveryengine.v1alpha.DocumentService.CreateDocument>`__
                method.
            parent (str):
            ...
            document_id (str):
                ...
                <google.cloud.discoveryengine.v1alpha.CreateDocumentRequest.parent>`__.
    ...
    def update_document(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.UpdateDocumentRequest, dict]):
                The request object. Request message for
                `DocumentService.UpdateDocument
                <google.cloud.discoveryengine.v1alpha.DocumentService.UpdateDocument>`__
                method.
            document (google.cloud.discoveryengine_v1alpha.types.Document):
                ...
                `allow_missing
                <google.cloud.discoveryengine.v1alpha.UpdateDocumentRequest.allow_missing>`__
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_document():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.DeleteDocumentRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.DeleteDocumentRequest, dict]):
                The request object. Request message for
                `DocumentService.DeleteDocument
                <google.cloud.discoveryengine.v1alpha.DocumentService.DeleteDocument>`__
                method.
            name (str):
                Required. Full resource name of
                `Document
    ...
    def import_documents(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ImportDocumentsRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                be
                :class:`google.cloud.discoveryengine_v1alpha.types.ImportDocumentsResponse`
                Response of the `ImportDocumentsRequest
                <google.cloud.discoveryengine.v1alpha.ImportDocumentsRequest>`__.
    ...
    def purge_documents(
        ...
        *,
        ...
        `Document
        <google.cloud.discoveryengine.v1alpha.Document>`__s in a
        branch.

        This process is asynchronous. Depending on the number of
        `Document
        <google.cloud.discoveryengine.v1alpha.Document>`__s to
        be deleted, this operation can take hours to complete.
        Before the delete operation completes, some `Document
        <google.cloud.discoveryengine.v1alpha.Document>`__s
        ...
        <google.cloud.discoveryengine.v1alpha.PurgeDocumentsRequest.force>`__
        to false.
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.PurgeDocumentsRequest, dict]):
                The request object. Request message for
                `DocumentService.PurgeDocuments
                <google.cloud.discoveryengine.v1alpha.DocumentService.PurgeDocuments>`__
                method.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will
                be
                :class:`google.cloud.discoveryengine_v1alpha.types.PurgeDocumentsResponse`
                Response message for
                `DocumentService.PurgeDocuments
                <google.cloud.discoveryengine.v1alpha.DocumentService.PurgeDocuments>`__
    ...
    def get_processed_document(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_processed_document():
                # Create a client
                client = discoveryengine_v1alpha.DocumentServiceClient()
                ...
                # Make the request
                response = client.get_processed_document(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.GetProcessedDocumentRequest, dict]):
                The request object. Request message for
                `DocumentService.GetDocument
                <google.cloud.discoveryengine.v1alpha.DocumentService.GetDocument>`__
                method.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, document_service.GetProcessedDocumentRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_processed_document]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_batch_get_documents_metadata():
                ...
                # Initialize request argument(s)
                request = discoveryengine_v1alpha.BatchGetDocumentsMetadataRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.BatchGetDocumentsMetadataRequest, dict]):
                The request object. Request message for
                `DocumentService.BatchGetDocumentsMetadata
                <google.cloud.discoveryengine.v1alpha.DocumentService.BatchGetDocumentsMetadata>`__
                method.
            parent (str):
                Required. The parent branch resource
                name, such as
        ...
        Returns:
            google.cloud.discoveryengine_v1alpha.types.BatchGetDocumentsMetadataResponse:
                Response message for
                `DocumentService.BatchGetDocumentsMetadata
                <google.cloud.discoveryengine.v1alpha.DocumentService.BatchGetDocumentsMetadata>`__
                method.

...
class _BaseProjectServiceRestTransport(ProjectServiceTransport):
    ...
    class _BaseGetProject:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseGetProject._get_unset_required_fields(query_params))
    ...
    class _BaseProvisionProject:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{name=projects/*}:provision',
                'body': '*',
            },
            ]
            return http_options
    ...
    class _BaseReportConsentChange:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1alpha/{project=projects/*}:reportConsentChange',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = project_service.ReportConsentChangeRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseProjectServiceRestTransport._BaseReportConsentChange._get_unset_required_fields(query_params))

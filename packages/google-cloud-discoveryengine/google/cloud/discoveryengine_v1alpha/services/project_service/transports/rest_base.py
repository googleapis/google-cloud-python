...
class _BaseProjectServiceRestTransport(ProjectServiceTransport):
    ...
    class _BaseGetProject:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseProjectServiceRestTransport._BaseGetProject._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseReportConsentChange:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseProjectServiceRestTransport._BaseReportConsentChange._get_unset_required_fields(
                    query_params
                )
            )

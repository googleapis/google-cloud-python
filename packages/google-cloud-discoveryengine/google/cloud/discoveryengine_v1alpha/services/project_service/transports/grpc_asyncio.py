...
class ProjectServiceGrpcAsyncIOTransport(ProjectServiceTransport):
    ...
    @property
    def get_project(self) -> Callable[[project_service.GetProjectRequest], Awaitable[project.Project]]:
    ...
    @property
    def provision_project(self) -> Callable[[project_service.ProvisionProjectRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def report_consent_change(self) -> Callable[[project_service.ReportConsentChangeRequest], Awaitable[gcd_project.Project]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.provision_project: self._wrap_method(
                self.provision_project,
                default_timeout=None,
                client_info=client_info,
            ),
            self.report_consent_change: self._wrap_method(

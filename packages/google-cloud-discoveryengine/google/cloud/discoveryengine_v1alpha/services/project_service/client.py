...
class ProjectServiceClient(metaclass=ProjectServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ProjectServiceTransport]] = None,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_project():
                # Create a client
                client = discoveryengine_v1alpha.ProjectServiceClient()
        ...
        # in a project_service.GetProjectRequest.
    ...
    def provision_project(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a project_service.ProvisionProjectRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.provision_project]
    ...
    def report_consent_change(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_report_consent_change():
                # Create a client
                client = discoveryengine_v1alpha.ProjectServiceClient()
                ...
                # Make the request
                response = client.report_consent_change(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.discoveryengine_v1alpha.types.ReportConsentChangeRequest, dict]):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a project_service.ReportConsentChangeRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.report_consent_change]

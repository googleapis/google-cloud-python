...
class SearchUseCase(proto.Enum):
    ...
    Values:
        ...
        SEARCH_USE_CASE_SEARCH (1):
            ...
            non-empty `query
            <google.cloud.discoveryengine.v1alpha.SearchRequest.query>`__.
...
class FileOriginType(proto.Enum):
    r"""The origin of the file.
...
class CustomAttribute(proto.Message):
    ...
    Attributes:
        text (MutableSequence[str]):
            ...
            <google.cloud.discoveryengine.v1alpha.CustomAttribute.text>`__
            or
...
class UserInfo(proto.Message):
    ...
    Attributes:
        ...
        user_agent (str):
            ...
            <google.cloud.discoveryengine.v1alpha.UserEvent.direct_user_request>`__
            is set.
    """

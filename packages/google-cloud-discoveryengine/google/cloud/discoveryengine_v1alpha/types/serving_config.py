...
class ServingConfig(proto.Message):
    ...
    Attributes:
        ...
        ranking_expression (str):
            ...
            <google.cloud.discoveryengine.v1alpha.SearchRequest.ranking_expression>`__
        ...
        custom_fine_tuning_spec (google.cloud.discoveryengine_v1alpha.types.CustomFineTuningSpec):
            ...
            If
            `SearchRequest.custom_fine_tuning_spec
            <google.cloud.discoveryengine.v1alpha.SearchRequest.custom_fine_tuning_spec>`__
            is set, it has higher priority than the configs set
            here.
    ...
    class MediaConfig(proto.Message):
        ...
        * ``promote_fresh_content``: cutoff days for fresh content promotion.
        ...
        Can only be set if
        `SolutionType <google.cloud.discoveryengine.v1alpha.SolutionType>`__ is

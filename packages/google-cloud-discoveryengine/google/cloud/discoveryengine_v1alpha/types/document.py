...
class Document(proto.Message):
    ...
    class AclInfo(proto.Message):
        ...
        class AccessRestriction(proto.Message):
            ...
            document, user needs to have access to parent document.
...
class ProcessedDocument(proto.Message):
    ...
    Attributes:
        json_data (str):
            The JSON string representation of the processed
            document.

            This field is a member of `oneof`_ ``processed_data_format``.
        document (str):
            Required. Full resource name of the referenced document,
            in the format

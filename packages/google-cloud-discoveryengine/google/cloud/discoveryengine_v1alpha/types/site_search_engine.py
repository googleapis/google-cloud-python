...
class SiteSearchEngine(proto.Message):
    r"""SiteSearchEngine captures DataStore level site search persisting
    configurations. It is a singleton value per data store.

    Attributes:
        name (str):
            The fully qualified resource name of the site search
            engine. Format:
...
class TargetSite(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.discoveryengine_v1alpha.types.TargetSite.Type):
            The type of the target site, e.g., whether the site
            is to be included or excluded.
        exact_match (bool):
            Input only. If set to false, a uri_pattern is generated
            to include all pages whose address contains the
            ...
            provided_uri_pattern is always normalized to generate
        ...
        site_verification_info (google.cloud.discoveryengine_v1alpha.types.SiteVerificationInfo):
            Output only. Site ownership and validity verification
            status.
        indexing_status (google.cloud.discoveryengine_v1alpha.types.TargetSite.IndexingStatus):
            Output only. Indexing status.
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The target site's last updated time.
        failure_reason (google.cloud.discoveryengine_v1alpha.types.TargetSite.FailureReason):
    ...
    class Type(proto.Enum):
        ...
        Values:
            TYPE_UNSPECIFIED (0):
                ...
                <google.cloud.discoveryengine.v1alpha.TargetSite.Type.INCLUDE>`__.
            INCLUDE (1):
    ...
    class FailureReason(proto.Message):
        ...
        Attributes:
            quota_failure (google.cloud.discoveryengine_v1alpha.types.TargetSite.FailureReason.QuotaFailure):
        ...
        class QuotaFailure(proto.Message):
            ...
            Attributes:
                total_required_quota (int):
                    This number is an estimation on how much total quota
...
class SiteVerificationInfo(proto.Message):
    r"""Verification information for target sites in advanced site search.

    Attributes:
        site_verification_state (google.cloud.discoveryengine_v1alpha.types.SiteVerificationInfo.SiteVerificationState):
            Site verification state indicating the ownership and
            validity.

...
class DocumentProcessingConfig(proto.Message):
    ...
    `DataStore <google.cloud.discoveryengine.v1alpha.DataStore>`__. It's
    empty when `DataStore
    <google.cloud.discoveryengine.v1alpha.DataStore>`__ is created, which

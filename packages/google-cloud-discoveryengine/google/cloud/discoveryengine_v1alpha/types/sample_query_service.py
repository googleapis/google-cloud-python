...
class GetSampleQueryRequest(proto.Message):
    ...
    <google.cloud.discoveryengine.v1alpha.SampleQueryService.GetSampleQuery>`__
    method.
...
class ListSampleQueriesRequest(proto.Message):
    ...
    Attributes:
        ...
        page_token (str):
            ...
            <google.cloud.discoveryengine.v1alpha.ListSampleQueriesResponse.next_page_token>`__,
...
class CreateSampleQueryRequest(proto.Message):
    ...
    <google.cloud.discoveryengine.v1alpha.SampleQueryService.CreateSampleQuery>`__
    method.
...
class UpdateSampleQueryRequest(proto.Message):
    ...
    <google.cloud.discoveryengine.v1alpha.SampleQueryService.UpdateSampleQuery>`__
    method.
...
class DeleteSampleQueryRequest(proto.Message):
    ...
    <google.cloud.discoveryengine.v1alpha.SampleQueryService.DeleteSampleQuery>`__
    method.

...
class DataStore(proto.Message):
    ...
    Attributes:
        ...
        workspace_config (google.cloud.discoveryengine_v1alpha.types.WorkspaceConfig):
            ...
            <google.cloud.discoveryengine.v1alpha.DataStore.ContentConfig.GOOGLE_WORKSPACE>`__.
    ...
    class ContentConfig(proto.Enum):
        ...
        Values:
            ...
            NO_CONTENT (1):
                ...
                `Document.content
                <google.cloud.discoveryengine.v1alpha.Document.content>`__.
            CONTENT_REQUIRED (2):
            ...
            GOOGLE_WORKSPACE (4):
                ...
                the `WorkspaceConfig
                <google.cloud.discoveryengine.v1alpha.WorkspaceConfig>`__.
        """
        CONTENT_CONFIG_UNSPECIFIED = 0
        NO_CONTENT = 1
        CONTENT_REQUIRED = 2

...
class Evaluation(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            `Evaluation
            <google.cloud.discoveryengine.v1alpha.Evaluation>`__, in
            the format of
        ...
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            `Evaluation
            <google.cloud.discoveryengine.v1alpha.Evaluation>`__ was
            created at.
        ...
        Attributes:
            search_request (google.cloud.discoveryengine_v1alpha.types.SearchRequest):
                ...
                * `SearchRequest.serving_config
                <google.cloud.discoveryengine.v1alpha.SearchRequest.serving_config>`__
                * `SearchRequest.branch
                <google.cloud.discoveryengine.v1alpha.SearchRequest.branch>`__

                * `SearchRequest.canonical_filter
                <google.cloud.discoveryengine.v1alpha.SearchRequest.canonical_filter>`__
                * `SearchRequest.query_expansion_spec
                <google.cloud.discoveryengine.v1alpha.SearchRequest.query_expansion_spec>`__

                * `SearchRequest.spell_correction_spec
                <google.cloud.discoveryengine.v1alpha.SearchRequest.spell_correction_spec>`__
                * `SearchRequest.content_search_spec
                <google.cloud.discoveryengine.v1alpha.SearchRequest.content_search_spec>`__
    ...
    Attributes:
        ...
        page_recall (google.cloud.discoveryengine_v1alpha.types.QualityMetrics.TopkMetrics):
            ...
            * For a single
             `SampleQuery
            <google.cloud.discoveryengine.v1alpha.SampleQuery>`__,
            if 3 out  of 5 relevant pages are retrieved in the
            top-5, recall@5 = 3/5 = 0.6

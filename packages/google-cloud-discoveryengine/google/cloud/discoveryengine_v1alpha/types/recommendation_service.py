...
from google.cloud.discoveryengine_v1alpha.types import user_event as gcd_user_event
    ...
    Attributes:
        ...
        filter (str):
            ...
            - (launguage: ANY("en", "es")) AND NOT
              (categories: ANY("Movie"))  * (available:
              true) AND
        ...
        params (MutableMapping[str, google.protobuf.struct_pb2.Value]):
            ...
            - ``returnScore``: Boolean. If set to true, the
              ...
              Document conversion given    the user's
              context and history.
            ...
            - ``diversityLevel``: String. Default empty. If
              set to be non-empty, then    it needs to be
              one of:

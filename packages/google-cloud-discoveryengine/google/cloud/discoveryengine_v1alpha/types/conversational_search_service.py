...
class AnswerQueryRequest(proto.Message):
    ...
    Attributes:
        ...
        asynchronous_mode (bool):
            ...
            <google.cloud.discoveryengine.v1alpha.ConversationalSearchService.GetAnswer>`__
            or
...
class AnswerQueryResponse(proto.Message):
    ...
    Attributes:
        answer (google.cloud.discoveryengine_v1alpha.types.Answer):
            ...
            <google.cloud.discoveryengine.v1alpha.AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.max_rephrase_steps>`__
            is greater than 1, use
            `Answer.name
            <google.cloud.discoveryengine.v1alpha.Answer.name>`__ to
        ...
        session (google.cloud.discoveryengine_v1alpha.types.Session):
            ...
            <google.cloud.discoveryengine.v1alpha.AnswerQueryRequest>`__
            request.

...
class discoveryengineCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'check_grounding': ('grounding_config', 'answer_candidate', 'facts', 'grounding_spec', ),
        ...
        'create_data_store': ('parent', 'data_store', 'data_store_id', 'create_advanced_site_search', ),
        ...
        'rank': ('ranking_config', 'records', 'model', 'top_n', 'query', 'ignore_record_details_in_response', ),
        ...
        'resume_engine': ('name', ),
        'search': ('serving_config', 'branch', 'query', 'image_query', 'page_size', 'page_token', 'offset', 'data_store_specs', 'filter', 'canonical_filter', 'order_by', 'user_info', 'facet_specs', 'boost_spec', 'params', 'query_expansion_spec', 'spell_correction_spec', 'user_pseudo_id', 'content_search_spec', 'embedding_spec', 'ranking_expression', 'safe_search', 'user_labels', ),
        'train_custom_model': ('data_store', 'gcs_training_input', 'model_type', 'error_config', ),
        'tune_engine': ('name', ),

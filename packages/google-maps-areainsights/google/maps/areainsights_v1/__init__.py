...
__lazy_modules__ = {
    "google.maps.areainsights_v1.services.area_insights",
    "google.maps.areainsights_v1.types.area_insights_service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.maps.areainsights_v1")  # type: ignore
    api_core.check_dependency_versions("google.maps.areainsights_v1")  # type: ignore

...
class AreaInsightsGrpcAsyncIOTransport(AreaInsightsTransport):
    ...
    @property
    def compute_insights(self) -> Callable[[area_insights_service.ComputeInsightsRequest], Awaitable[area_insights_service.ComputeInsightsResponse]]:
...
__all__ = ("AreaInsightsGrpcAsyncIOTransport",)

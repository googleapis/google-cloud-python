...
class AreaInsightsAsyncClient:
    ...
    common_billing_account_path = staticmethod(AreaInsightsClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AreaInsightsClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(AreaInsightsClient.parse_common_organization_path)
    common_project_path = staticmethod(AreaInsightsClient.common_project_path)
    parse_common_project_path = staticmethod(AreaInsightsClient.parse_common_project_path)
    common_location_path = staticmethod(AreaInsightsClient.common_location_path)
    parse_common_location_path = staticmethod(AreaInsightsClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AreaInsightsTransport, Callable[..., AreaInsightsTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.maps.areainsights_v1.AreaInsightsAsyncClient`.",
                extra={
    ...
    async def compute_insights(
        self,
        request: Optional[Union[area_insights_service.ComputeInsightsRequest, dict]] = None,
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_insights]

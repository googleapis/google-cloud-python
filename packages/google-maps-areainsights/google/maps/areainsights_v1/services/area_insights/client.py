...
class AreaInsightsClient(metaclass=AreaInsightsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AreaInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AreaInsightsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AreaInsightsClient._get_universe_domain(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AreaInsightsTransport], Callable[..., AreaInsightsTransport]
            ] = (

...
from .transports.grpc import AreaInsightsGrpcTransport
from .transports.grpc_asyncio import AreaInsightsGrpcAsyncIOTransport
from .transports.rest import AreaInsightsRestTransport


class AreaInsightsClientMeta(type):
    """Metaclass for the AreaInsights client.
...
class AreaInsightsClient(metaclass=AreaInsightsClientMeta):
    ...
    DEFAULT_ENDPOINT = "areainsights.googleapis.com"
    DEFAULT_MTLS_ENDPOINT = _get_default_mtls_endpoint.__func__(DEFAULT_ENDPOINT)  # type: ignore

    _DEFAULT_ENDPOINT_TEMPLATE = "areainsights.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AreaInsightsClient: The constructed client.
        """
    ...
    def transport(self) -> AreaInsightsTransport:
        ...
        Returns:
            AreaInsightsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AreaInsightsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AreaInsightsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AreaInsightsClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AreaInsightsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AreaInsightsTransport, Callable[..., AreaInsightsTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the area insights client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AreaInsightsClient._read_environment_variables()
        self._client_cert_source = AreaInsightsClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AreaInsightsClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AreaInsightsTransport)
        if transport_provided:
            # transport is a AreaInsightsTransport instance.
            ...
            self._transport = cast(AreaInsightsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or AreaInsightsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AreaInsightsTransport], Callable[..., AreaInsightsTransport]] = (
                AreaInsightsClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AreaInsightsTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.maps.areainsights_v1.AreaInsightsClient`.",
                    extra={
    ...
    def compute_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.maps.areainsights_v1.types.ComputeInsightsRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.compute_insights]
    ...
    def __enter__(self) -> "AreaInsightsClient":
        return self

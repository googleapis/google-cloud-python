...
#
# Snippet for DeleteSupportEventSubscription
...
def sample_delete_support_event_subscription():
    # Create a client
    client = support_v2.SupportEventSubscriptionServiceClient()

    # Initialize request argument(s)
    request = support_v2.DeleteSupportEventSubscriptionRequest(
        name="name_value",
    )

    # Make the request
    response = client.delete_support_event_subscription(request=request)

...
class CaseServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(CaseServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(CaseServiceClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(CaseServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(CaseServiceClient.common_project_path)
    parse_common_project_path = staticmethod(CaseServiceClient.parse_common_project_path)
    common_location_path = staticmethod(CaseServiceClient.common_location_path)
    parse_common_location_path = staticmethod(CaseServiceClient.parse_common_location_path)
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CaseServiceTransport, Callable[..., CaseServiceTransport]]] = "grpc_asyncio",
    ...
    async def list_cases(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_cases]
    ...
    async def search_cases(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_cases]
    ...
    async def create_case(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_case]
    ...
    async def update_case(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_case]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("case.name", request.case.name),)),)
    ...
    async def escalate_case(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.escalate_case]
    ...
    async def close_case(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.close_case]
    ...
    async def search_case_classifications(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_case_classifications]

...
class ListCommentsPager:
    ...
    :class:`google.cloud.support_v2beta.types.ListCommentsResponse` object, and
    ...
    All the usual :class:`google.cloud.support_v2beta.types.ListCommentsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.support_v2beta.types.ListCommentsRequest):
                The initial request object.
            response (google.cloud.support_v2beta.types.ListCommentsResponse):

...
class CommentServiceClient(metaclass=CommentServiceClientMeta):
    ...
    def comment_path(
        ...
        return "organizations/{organization}/cases/{case}/comments/{comment}".format(
            organization=organization,
            case=case,
            comment=comment,
        )
    ...
    def parse_comment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/cases/(?P<case>.+?)/comments/(?P<comment>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CommentServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = CommentServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CommentServiceClient._get_api_endpoint(

...
from .rest_base import _BaseCommentServiceRestTransport
...
class CommentServiceRestInterceptor:
    """Interceptor for CommentService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the CommentServiceRestTransport.

    .. code-block:: python
        class MyCustomCommentServiceInterceptor(CommentServiceRestInterceptor):
        ...
        transport = CommentServiceRestTransport(interceptor=MyCustomCommentServiceInterceptor())
    ...
    def post_create_comment(self, response: gcs_comment.Comment) -> gcs_comment.Comment:
    ...
    def pre_get_comment(
        self, request: comment_service.GetCommentRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[comment_service.GetCommentRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_comment_with_metadata(
        self, response: comment.Comment, metadata: Sequence[Tuple[str, Union[str, bytes]]]
...
class CommentServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: CommentServiceRestInterceptor


class CommentServiceRestTransport(_BaseCommentServiceRestTransport):
    """REST backend synchronous transport for CommentService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[CommentServiceRestInterceptor] = None,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2beta.CommentServiceClient.CreateComment",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2beta.CommentServiceClient.create_comment",
                    extra={
                        "serviceName": "google.cloud.support.v2beta.CommentService",
                        "rpcName": "CreateComment",
    ...
    class _GetComment(_BaseCommentServiceRestTransport._BaseGetComment, CommentServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseCommentServiceRestTransport._BaseGetComment._get_http_options()

            request, metadata = self._interceptor.pre_get_comment(request, metadata)
            transcoded_request = _BaseCommentServiceRestTransport._BaseGetComment._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseCommentServiceRestTransport._BaseGetComment._get_query_params_json(transcoded_request)
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2beta.CommentServiceClient.ListComments",
                    extra={
                        "serviceName": "google.cloud.support.v2beta.CommentService",
            ...
            # Return the response
            resp = comment_service.ListCommentsResponse()
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2beta.CommentServiceClient.list_comments",
                    extra={
                        "serviceName": "google.cloud.support.v2beta.CommentService",
                        "rpcName": "ListComments",
                        "metadata": http_response["headers"],
    ...
    @property
    def get_comment(self) -> Callable[[comment_service.GetCommentRequest], comment.Comment]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
...
__all__ = ("CommentServiceRestTransport",)

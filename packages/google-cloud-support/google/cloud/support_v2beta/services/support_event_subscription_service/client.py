...
class SupportEventSubscriptionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.support_v2beta.SupportEventSubscriptionServiceClient`.",
                    extra={
    ...
    def create_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.CreateSupportEventSubscriptionRequest, dict]):
    ...
    def get_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.GetSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
    ...
    def list_support_event_subscriptions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.ListSupportEventSubscriptionsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.support_v2beta.services.support_event_subscription_service.pagers.ListSupportEventSubscriptionsPager:
    ...
    def update_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.UpdateSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
    ...
    def delete_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.DeleteSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
    ...
    def undelete_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.UndeleteSupportEventSubscriptionRequest, dict]):
                The request object. Request message for

...
class CaseAttachmentServiceClient(metaclass=CaseAttachmentServiceClientMeta):
    ...
    def parse_attachment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^organizations/(?P<organization>.+?)/cases/(?P<case>.+?)/attachments/(?P<attachment_id>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str,
                CaseAttachmentServiceTransport,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            CaseAttachmentServiceClient._read_environment_variables()
        )
        self._client_cert_source = CaseAttachmentServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CaseAttachmentServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CaseAttachmentServiceClient._get_api_endpoint(
    ...
    def list_attachments(
        self,
        request: Optional[
            Union[attachment_service.ListAttachmentsRequest, dict]
        ] = None,
        *,

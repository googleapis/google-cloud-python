...
from google.cloud.support_v2beta._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_mtls_endpoint=CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

...
from .transports.grpc_asyncio import CaseAttachmentServiceGrpcAsyncIOTransport
from .transports.rest import CaseAttachmentServiceRestTransport


class CaseAttachmentServiceClientMeta(type):
    """Metaclass for the CaseAttachmentService client.
...
class CaseAttachmentServiceClient(metaclass=CaseAttachmentServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CaseAttachmentServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CaseAttachmentServiceTransport:
        ...
        Returns:
            CaseAttachmentServiceTransport: The transport used by the client
                instance.
        """
    ...
    def attachment_path(
        ...
        return "organizations/{organization}/cases/{case}/attachments/{attachment_id}".format(
    ...
    def parse_attachment_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(r"^organizations/(?P<organization>.+?)/cases/(?P<case>.+?)/attachments/(?P<attachment_id>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = CaseAttachmentServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            _default_universe = CaseAttachmentServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(f"mTLS is not supported in any universe other than {_default_universe}.")
            api_endpoint = CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = CaseAttachmentServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CaseAttachmentServiceTransport, Callable[..., CaseAttachmentServiceTransport]]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,CaseAttachmentServiceTransport,Callable[..., CaseAttachmentServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CaseAttachmentServiceTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = CaseAttachmentServiceClient._read_environment_variables()
        self._client_cert_source = CaseAttachmentServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = CaseAttachmentServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, CaseAttachmentServiceTransport)
        if transport_provided:
            # transport is a CaseAttachmentServiceTransport instance.
            ...
            self._transport = cast(CaseAttachmentServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or CaseAttachmentServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[CaseAttachmentServiceTransport], Callable[..., CaseAttachmentServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.cloud.support_v2beta.CaseAttachmentServiceClient`.",
                    extra={
    ...
    def list_attachments(
        self,
        request: Optional[Union[attachment_service.ListAttachmentsRequest, dict]] = None,
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2beta.types.ListAttachmentsRequest, dict]):
        ...
        if not isinstance(request, attachment_service.ListAttachmentsRequest):
            request = attachment_service.ListAttachmentsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_attachments]
        ...
        response = pagers.ListAttachmentsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

...
class CaseAttachmentServiceGrpcAsyncIOTransport(CaseAttachmentServiceTransport):
    ...
    @property
    def list_attachments(self) -> Callable[[attachment_service.ListAttachmentsRequest], Awaitable[attachment_service.ListAttachmentsResponse]]:
    ...
    @property
    def get_attachment(self) -> Callable[[attachment_service.GetAttachmentRequest], Awaitable[attachment.Attachment]]:
...
__all__ = ("CaseAttachmentServiceGrpcAsyncIOTransport",)

...
class SupportEventSubscription(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.support_v2beta.types.SupportEventSubscription.State):
            Output only. The state of the subscription.
        failure_reason (google.cloud.support_v2beta.types.SupportEventSubscription.FailureReason):

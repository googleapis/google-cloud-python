...
from google.cloud.support_v2beta.types import escalation as gcs_escalation
...
class ListCasesRequest(proto.Message):
    ...
    Attributes:
        ...
        product_line (google.cloud.support_v2beta.types.ProductLine):
            The product line to request cases for. If
            unspecified, only Google Cloud cases will be
            returned.

            This field is a member of `oneof`_ ``_product_line``.
    """
    ...
    product_line: gcs_case.ProductLine = proto.Field(
        proto.ENUM,
        number=8,
        optional=True,
        enum=gcs_case.ProductLine,
    )
...
class ListCasesResponse(proto.Message):
    ...
    Attributes:
        cases (MutableSequence[google.cloud.support_v2beta.types.Case]):
...
class EscalateCaseRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            escalated.
        escalation (google.cloud.support_v2beta.types.Escalation):
...
class SearchCaseClassificationsRequest(proto.Message):
    ...
    Attributes:
        ...
        product (google.cloud.support_v2beta.types.Product):
            Optional. The product to return case
            classifications for.
    """
    ...
    product: gcs_case.Product = proto.Field(
        proto.MESSAGE,
        number=7,
        message=gcs_case.Product,
    )
...
class SearchCaseClassificationsResponse(proto.Message):
    ...
    Attributes:
        case_classifications (MutableSequence[google.cloud.support_v2beta.types.CaseClassification]):

...
from .types.comment_service import CreateCommentRequest, GetCommentRequest, ListCommentsRequest, ListCommentsResponse
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.support_v2beta")  # type: ignore
    api_core.check_dependency_versions("google.cloud.support_v2beta")  # type: ignore
else:  # pragma: NO COVER

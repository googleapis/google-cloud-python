...
class SupportEventSubscriptionServiceTransport(abc.ABC):
    """Abstract transport class for SupportEventSubscriptionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_support_event_subscription: gapic_v1.method.wrap_method(
                self.create_support_event_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_support_event_subscription: gapic_v1.method.wrap_method(
                self.get_support_event_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_support_event_subscriptions: gapic_v1.method.wrap_method(
                self.list_support_event_subscriptions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_support_event_subscription: gapic_v1.method.wrap_method(
                self.update_support_event_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_support_event_subscription: gapic_v1.method.wrap_method(
                self.delete_support_event_subscription,
                default_timeout=None,
                client_info=client_info,
            ),
            self.undelete_support_event_subscription: gapic_v1.method.wrap_method(
...
__all__ = ("SupportEventSubscriptionServiceTransport",)

...
from google.cloud.support_v2.services.support_event_subscription_service import pagers
...
class SupportEventSubscriptionServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.support_v2.SupportEventSubscriptionServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_support_event_subscription():
                ...
                support_event_subscription = support_v2.SupportEventSubscription()
                support_event_subscription.pub_sub_topic = "pub_sub_topic_value"

                request = support_v2.CreateSupportEventSubscriptionRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2.types.CreateSupportEventSubscriptionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            support_event_subscription (:class:`google.cloud.support_v2.types.SupportEventSubscription`):
        ...
        Returns:
            google.cloud.support_v2.types.SupportEventSubscription:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_support_event_subscription():
                ...
                # Initialize request argument(s)
                request = support_v2.GetSupportEventSubscriptionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2.types.GetSupportEventSubscriptionRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_support_event_subscriptions():
                ...
                # Initialize request argument(s)
                request = support_v2.ListSupportEventSubscriptionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2.types.ListSupportEventSubscriptionsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.support_v2.services.support_event_subscription_service.pagers.ListSupportEventSubscriptionsAsyncPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_support_event_subscription():
                ...
                request = support_v2.UpdateSupportEventSubscriptionRequest(
                    support_event_subscription=support_event_subscription,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2.types.UpdateSupportEventSubscriptionRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2.types.DeleteSupportEventSubscriptionRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_undelete_support_event_subscription():
                ...
                # Initialize request argument(s)
                request = support_v2.UndeleteSupportEventSubscriptionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.support_v2.types.UndeleteSupportEventSubscriptionRequest, dict]]):
                The request object. Request message for

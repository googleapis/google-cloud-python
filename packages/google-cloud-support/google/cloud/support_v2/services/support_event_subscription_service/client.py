...
from .transports.grpc import SupportEventSubscriptionServiceGrpcTransport
from .transports.grpc_asyncio import SupportEventSubscriptionServiceGrpcAsyncIOTransport
from .transports.rest import SupportEventSubscriptionServiceRestTransport


class SupportEventSubscriptionServiceClientMeta(type):
    """Metaclass for the SupportEventSubscriptionService client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[SupportEventSubscriptionServiceTransport]]
    _transport_registry["grpc"] = SupportEventSubscriptionServiceGrpcTransport
    ...
    ) -> Type[SupportEventSubscriptionServiceTransport]:
...
class SupportEventSubscriptionServiceClient(
    metaclass=SupportEventSubscriptionServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SupportEventSubscriptionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> SupportEventSubscriptionServiceTransport:
        ...
        Returns:
            SupportEventSubscriptionServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def support_event_subscription_path(
        organization: str,
        support_event_subscription: str,
    ) -> str:
        """Returns a fully-qualified support_event_subscription string."""
        return "organizations/{organization}/supportEventSubscriptions/{support_event_subscription}".format(
            organization=organization,
            support_event_subscription=support_event_subscription,
        )

    @staticmethod
    def parse_support_event_subscription_path(path: str) -> Dict[str, str]:
        """Parses a support_event_subscription path into its component segments."""
        m = re.match(
            r"^organizations/(?P<organization>.+?)/supportEventSubscriptions/(?P<support_event_subscription>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SupportEventSubscriptionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SupportEventSubscriptionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the support event subscription service client.
        ...
        transport_provided = isinstance(
            transport, SupportEventSubscriptionServiceTransport
        )
        if transport_provided:
            # transport is a SupportEventSubscriptionServiceTransport instance.
            ...
            self._transport = cast(SupportEventSubscriptionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SupportEventSubscriptionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                SupportEventSubscriptionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., SupportEventSubscriptionServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.support_v2.SupportEventSubscriptionServiceClient`.",
                    extra={
    ...
    def create_support_event_subscription(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_support_event_subscription():
                # Create a client
                ...
                # Make the request
                response = client.create_support_event_subscription(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.support_v2.types.CreateSupportEventSubscriptionRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_support_event_subscription
        ]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_support_event_subscription():
                ...
                # Make the request
                response = client.get_support_event_subscription(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.support_v2.types.GetSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_support_event_subscription
        ]
    ...
    def list_support_event_subscriptions(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_support_event_subscriptions():
                # Create a client
                client = support_v2.SupportEventSubscriptionServiceClient()
        ...
        Args:
            request (Union[google.cloud.support_v2.types.ListSupportEventSubscriptionsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.support_v2.services.support_event_subscription_service.pagers.ListSupportEventSubscriptionsPager:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_support_event_subscriptions
        ]
        ...
        response = pagers.ListSupportEventSubscriptionsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def update_support_event_subscription(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_support_event_subscription():
                # Create a client
                client = support_v2.SupportEventSubscriptionServiceClient()
                ...
                # Make the request
                response = client.update_support_event_subscription(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.support_v2.types.UpdateSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_support_event_subscription
        ]
    ...
    def delete_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2.types.DeleteSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_support_event_subscription
        ]
    ...
    def undelete_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2.types.UndeleteSupportEventSubscriptionRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.undelete_support_event_subscription
        ]
    ...
    def expunge_support_event_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2.types.ExpungeSupportEventSubscriptionRequest, dict]):
                The request object. Request message for

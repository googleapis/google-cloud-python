...
class CommentServiceGrpcAsyncIOTransport(CommentServiceTransport):
    ...
    @property
    def list_comments(self) -> Callable[[comment_service.ListCommentsRequest], Awaitable[comment_service.ListCommentsResponse]]:
    ...
    @property
    def create_comment(self) -> Callable[[comment_service.CreateCommentRequest], Awaitable[gcs_comment.Comment]]:
...
__all__ = ("CommentServiceGrpcAsyncIOTransport",)

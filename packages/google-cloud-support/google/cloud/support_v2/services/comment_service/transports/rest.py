...
class CommentServiceRestTransport(CommentServiceTransport):
    """REST backend transport for CommentService.
    ...
    class _CreateComment(CommentServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v2/{parent=projects/*/cases/*}/comments",
                    "body": "comment",
                },
                {
                    "method": "post",
                    "uri": "/v2/{parent=organizations/*/cases/*}/comments",
                    "body": "comment",
                },
            ]
            request, metadata = self._interceptor.pre_create_comment(request, metadata)
            pb_request = comment_service.CreateCommentRequest.pb(request)
    ...
    class _ListComments(CommentServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = comment_service.ListCommentsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)

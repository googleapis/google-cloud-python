        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2.CommentServiceClient.GetComment",
                    extra={
                        "serviceName": "google.cloud.support.v2.CommentService",
                        "rpcName": "GetComment",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2.CommentServiceClient.get_comment",
                    extra={
                        "serviceName": "google.cloud.support.v2.CommentService",
                        "rpcName": "GetComment",
                        "metadata": http_response["headers"],

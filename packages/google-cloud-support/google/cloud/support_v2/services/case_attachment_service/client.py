...
class CaseAttachmentServiceClient(metaclass=CaseAttachmentServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CaseAttachmentServiceTransport]] = None,
        ...
        if isinstance(transport, CaseAttachmentServiceTransport):
    ...
    def list_attachments(
        ...
        *,
        ...
        # in a attachment_service.ListAttachmentsRequest.

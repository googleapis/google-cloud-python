...
class CaseAttachmentServiceClient(metaclass=CaseAttachmentServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.support_v2.CaseAttachmentServiceClient`.",
                    extra={
    ...
    def list_attachments(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.support_v2.types.ListAttachmentsRequest, dict]):
    ...
    def get_attachment(
        ...
        *,
        ...
        r"""Retrieve an attachment associated with a support case.
        ...
        Args:
            request (Union[google.cloud.support_v2.types.GetAttachmentRequest, dict]):

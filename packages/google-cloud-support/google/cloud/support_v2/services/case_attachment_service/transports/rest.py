    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[CaseAttachmentServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.support_v2.CaseAttachmentServiceClient.GetAttachment",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.support_v2.CaseAttachmentServiceClient.get_attachment",
                    extra={
                        "serviceName": "google.cloud.support.v2.CaseAttachmentService",
                        "rpcName": "GetAttachment",
...
__all__ = ("CaseAttachmentServiceRestTransport",)

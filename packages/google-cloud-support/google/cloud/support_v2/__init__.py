...
from .services.case_attachment_service import CaseAttachmentServiceAsyncClient, CaseAttachmentServiceClient
...
from .types.comment_service import CreateCommentRequest, ListCommentsRequest, ListCommentsResponse
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.support_v2")  # type: ignore
    api_core.check_dependency_versions("google.cloud.support_v2")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.support_v2"

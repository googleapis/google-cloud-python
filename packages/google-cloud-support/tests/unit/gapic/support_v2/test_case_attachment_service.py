...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert CaseAttachmentServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CaseAttachmentServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CaseAttachmentServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CaseAttachmentServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        CaseAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    ...
    assert (
        CaseAttachmentServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == CaseAttachmentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_case_attachment_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.support_v2.services.case_attachment_service.transports.CaseAttachmentServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_list_attachments_async_pager():
    ...
    with mock.patch.object(type(client.transport.list_attachments), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async_pager = await client.list_attachments(
            request={},
        )
...
async def test_list_attachments_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_attachments), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_attachments(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_transport_kind_grpc():
    transport = CaseAttachmentServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CaseAttachmentServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CaseAttachmentServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CaseAttachmentServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_list_attachments_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "post_list_attachments") as post, mock.patch.object(
        transports.CaseAttachmentServiceRestInterceptor, "post_list_attachments_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.CaseAttachmentServiceRestInterceptor, "pre_list_attachments"
    ) as pre:
...
def test_case_attachment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.cloud.support_v2.services.case_attachment_service.transports.CaseAttachmentServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.CaseAttachmentServiceGrpcTransport, grpc_helpers), (transports.CaseAttachmentServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_attachment_path():
    ...
    case = "clam"
    attachment_id = "whelk"
    expected = "organizations/{organization}/cases/{case}/attachments/{attachment_id}".format(

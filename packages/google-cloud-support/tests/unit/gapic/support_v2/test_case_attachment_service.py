...
from google.cloud.support_v2.types import actor, attachment, attachment_service
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        CaseAttachmentServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        CaseAttachmentServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        CaseAttachmentServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        CaseAttachmentServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        CaseAttachmentServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        CaseAttachmentServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        CaseAttachmentServiceClient._get_client_cert_source(
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                CaseAttachmentServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(CaseAttachmentServiceClient),
)
@mock.patch.object(
    CaseAttachmentServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(CaseAttachmentServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CaseAttachmentServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = CaseAttachmentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        CaseAttachmentServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        CaseAttachmentServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        CaseAttachmentServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        CaseAttachmentServiceClient._get_universe_domain(None, None)
        == CaseAttachmentServiceClient._DEFAULT_UNIVERSE
    )
...
def test_case_attachment_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_case_attachment_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_case_attachment_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_case_attachment_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [CaseAttachmentServiceClient, CaseAttachmentServiceAsyncClient]
)
@mock.patch.object(
    CaseAttachmentServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CaseAttachmentServiceClient),
)
@mock.patch.object(
    CaseAttachmentServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CaseAttachmentServiceAsyncClient),
)
...
def test_case_attachment_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_case_attachment_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_case_attachment_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_attachments_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_attachments] = (
            mock_rpc
        )
        request = {}
...
@pytest.mark.asyncio
async def test_list_attachments_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_attachments
...
async def test_list_attachments_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_attachments), "__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            attachment_service.ListAttachmentsResponse(
...
def test_list_attachments_rest_required_fields(
    request_type=attachment_service.ListAttachmentsRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_attachments._get_unset_required_fields(jsonified_request)
...
def test_list_attachments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/cases/*}/attachments" % client.transport._host,
            args[1],
        )
...
def test_list_attachments_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            attachment_service.ListAttachmentsResponse.to_json(x) for x in response
        )
...
def test_get_attachment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=*/*/cases/*/attachments/*}" % client.transport._host, args[1]
        )
...
def test_list_attachments_rest_bad_request(
    request_type=attachment_service.ListAttachmentsRequest,
):
    client = CaseAttachmentServiceClient(
...
def test_list_attachments_rest_interceptors(null_interceptor):
    transport = transports.CaseAttachmentServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.CaseAttachmentServiceRestInterceptor(),
    )
    client = CaseAttachmentServiceClient(transport=transport)
    ...
    with (
        ...
        mock.patch.object(
            transports.CaseAttachmentServiceRestInterceptor, "post_list_attachments"
        ) as post,
        mock.patch.object(
            transports.CaseAttachmentServiceRestInterceptor,
        ...
        pb_message = attachment_service.ListAttachmentsRequest.pb(
            attachment_service.ListAttachmentsRequest()
        )
...
def test_get_attachment_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.CaseAttachmentServiceRestInterceptor, "post_get_attachment"
        ) as post,
        mock.patch.object(
            transports.CaseAttachmentServiceRestInterceptor,
        ...
        mock.patch.object(
            transports.CaseAttachmentServiceRestInterceptor, "pre_get_attachment"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = attachment_service.GetAttachmentRequest.pb(
            attachment_service.GetAttachmentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_case_attachment_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.support_v2.services.case_attachment_service.transports.CaseAttachmentServiceTransport.__init__"
    ) as Transport:
...
def test_case_attachment_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_attachment_path():
    ...
    attachment_id = "whelk"
    expected = (
        "organizations/{organization}/cases/{case}/attachments/{attachment_id}".format(
            organization=organization,
            case=case,
            attachment_id=attachment_id,
        )
    )
    actual = CaseAttachmentServiceClient.attachment_path(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.CaseAttachmentServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = CaseAttachmentServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

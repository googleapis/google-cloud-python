...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CaseServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CaseServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CaseServiceClient._use_client_cert_effective()
...
async def test_list_cases_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_cases), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_cases(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_search_cases_async_pages():
    ...
    with mock.patch.object(type(client.transport.search_cases), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.search_cases(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_search_case_classifications_async_pages():
    ...
    with mock.patch.object(type(client.transport.search_case_classifications), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.search_case_classifications(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_transport_kind_grpc():
    transport = CaseServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = CaseServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CaseServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CaseServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_get_case_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_get_case") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_get_case_with_metadata"
...
def test_list_cases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_list_cases") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_list_cases_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_search_cases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_search_cases") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_search_cases_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_create_case_rest_call_success(request_type):
    ...
    request_init["case"] = {
        ...
        "time_zone": "time_zone_value",
        "subscriber_email_addresses": ["subscriber_email_addresses_value1", "subscriber_email_addresses_value2"],
        "state": 1,
...
def test_create_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_create_case") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_create_case_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_update_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_update_case") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_update_case_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_escalate_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_escalate_case") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_escalate_case_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_close_case_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_close_case") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_close_case_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_search_case_classifications_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseServiceRestInterceptor, "post_search_case_classifications") as post, mock.patch.object(
        transports.CaseServiceRestInterceptor, "post_search_case_classifications_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.CaseServiceGrpcTransport, grpc_helpers), (transports.CaseServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)

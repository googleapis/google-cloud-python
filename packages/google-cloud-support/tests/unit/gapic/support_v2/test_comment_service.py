...
from google.cloud.support_v2.services.comment_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        CommentServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        CommentServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        CommentServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        CommentServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        CommentServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
    assert (
        CommentServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CommentServiceClient._read_environment_variables() == (
            True,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CommentServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert CommentServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                CommentServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        CommentServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        CommentServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                CommentServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                CommentServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(CommentServiceClient),
)
@mock.patch.object(
    CommentServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(CommentServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CommentServiceClient._DEFAULT_UNIVERSE
    default_endpoint = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = CommentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == CommentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CommentServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        CommentServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == CommentServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        CommentServiceClient._get_api_endpoint(
    ...
    assert (
        CommentServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        CommentServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        CommentServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        CommentServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        CommentServiceClient._get_universe_domain(None, None)
        == CommentServiceClient._DEFAULT_UNIVERSE
    )
...
def test_comment_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_comment_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_comment_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [CommentServiceClient, CommentServiceAsyncClient]
)
@mock.patch.object(
    CommentServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CommentServiceClient),
)
@mock.patch.object(
    CommentServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(CommentServiceAsyncClient),
)
...
def test_comment_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_comment_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_comment_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.support_v2.services.comment_service.transports.CommentServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_comment_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_list_comments_rest_required_fields(
    request_type=comment_service.ListCommentsRequest,
):
...
def test_list_comments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2/{parent=projects/*/cases/*}/comments" % client.transport._host,
            args[1],
        )
...
def test_list_comments_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            comment_service.ListCommentsResponse.to_json(x) for x in response
        )
...
def test_create_comment_rest_required_fields(
...
def test_get_comment_rest_required_fields(
    request_type=comment_service.GetCommentRequest,
):
    transport_class = transports.CommentServiceRestTransport
...
def test_get_comment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2/{name=*/*/cases/*/comments/*}" % client.transport._host, args[1]
        )
...
def test_list_comments_rest_bad_request(
    request_type=comment_service.ListCommentsRequest,
):
    client = CommentServiceClient(
...
def test_list_comments_rest_interceptors(null_interceptor):
    transport = transports.CommentServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.CommentServiceRestInterceptor(),
    )
    client = CommentServiceClient(transport=transport)
...
def test_create_comment_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.CommentServiceRestInterceptor,
...
def test_get_comment_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(path_template, "transcode") as transcode,
        mock.patch.object(
            transports.CommentServiceRestInterceptor, "post_get_comment"
        ) as post,
        mock.patch.object(
            transports.CommentServiceRestInterceptor, "post_get_comment_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
            transports.CommentServiceRestInterceptor, "pre_get_comment"
        ) as pre,
    ):
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = comment_service.GetCommentRequest.pb(
            comment_service.GetCommentRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_comment_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.support_v2.services.comment_service.transports.CommentServiceTransport.__init__"
    ) as Transport:
...
def test_comment_service_base_transport_with_credentials_file():
    ...
    with (
        ...
        mock.patch(
            "google.cloud.support_v2.services.comment_service.transports.CommentServiceTransport._prep_wrapped_messages"
        ) as Transport,
    ):
        Transport.return_value = None
...
def test_comment_path():
    ...
    case = "nudibranch"
    comment = "cuttlefish"
    expected = "organizations/{organization}/cases/{case}/comments/{comment}".format(
        organization=organization,
        case=case,
        comment=comment,
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.CommentServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = CommentServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

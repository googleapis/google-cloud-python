...
def test_list_comments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = comment_service.ListCommentsResponse.to_json(
            comment_service.ListCommentsResponse()
        )
...
def test_list_comments_rest_bad_request(
    transport: str = "rest", request_type=comment_service.ListCommentsRequest
):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_comment_rest_bad_request(
    transport: str = "rest", request_type=comment_service.CreateCommentRequest
):
    client = CommentServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_transport_kind(transport_name):
    transport = CommentServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )

...
from google.cloud.support_v2beta.services.case_service import CaseServiceAsyncClient, CaseServiceClient, pagers, transports
...
def test_create_case_rest_call_success(request_type):
    ...
    request_init["case"] = {
        ...
        "display_name": "display_name_value",
        "description": "description_value",
        "classification": {"id": "id_value", "display_name": "display_name_value", "product": {"product_line": 1}},
        "time_zone": "time_zone_value",

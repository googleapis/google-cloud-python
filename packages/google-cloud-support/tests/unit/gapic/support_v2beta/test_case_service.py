...
from google.cloud.support_v2beta.services.case_service import (
    CaseServiceAsyncClient,
    CaseServiceClient,
    pagers,
    transports,
)
from google.cloud.support_v2beta.types import actor, case, case_service, escalation
...
def test_case_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.support_v2beta.services.case_service.transports.CaseServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_case_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{name=projects/*/cases/*}" % client.transport._host, args[1]
        )
...
def test_list_cases_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*}/cases" % client.transport._host, args[1]
        )
...
def test_update_case_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{case.name=projects/*/cases/*}" % client.transport._host, args[1]
        )
...
def test_case_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.support_v2beta.services.case_service.transports.CaseServiceTransport.__init__"
    ) as Transport:
...
def test_case_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.support_v2beta.services.case_service.transports.CaseServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

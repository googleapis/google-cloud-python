...
def test_create_support_event_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{parent=*/*}/supportEventSubscriptions" % client.transport._host,
            args[1],
        )
...
def test_get_support_event_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{name=*/*/supportEventSubscriptions/*}" % client.transport._host,
            args[1],
        )
...
def test_update_support_event_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{support_event_subscription.name=*/*/supportEventSubscriptions/*}"

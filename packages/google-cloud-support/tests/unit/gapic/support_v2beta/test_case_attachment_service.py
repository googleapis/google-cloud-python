...
from google.cloud.support_v2beta.services.case_attachment_service import (
...
def test_case_attachment_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_attachments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*/cases/*}/attachments"
...
def test_get_attachment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{name=*/*/cases/*/attachments/*}" % client.transport._host,
            args[1],
        )
...
def test_case_attachment_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceTransport.__init__"
    ) as Transport:
...
def test_case_attachment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.support_v2beta.services.case_attachment_service.transports.CaseAttachmentServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

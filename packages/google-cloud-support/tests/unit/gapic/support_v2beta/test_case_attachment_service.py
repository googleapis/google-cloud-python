...
def test_get_attachment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CaseAttachmentServiceRestInterceptor, "post_get_attachment") as post, mock.patch.object(
        transports.CaseAttachmentServiceRestInterceptor, "post_get_attachment_with_metadata"
    ) as post_with_metadata, mock.patch.object(

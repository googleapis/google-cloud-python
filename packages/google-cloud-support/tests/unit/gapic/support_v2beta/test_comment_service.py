...
from google.cloud.support_v2beta.services.comment_service import CommentServiceAsyncClient, CommentServiceClient, pagers, transports
...
def test_get_comment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CommentServiceRestInterceptor, "post_get_comment") as post, mock.patch.object(

...
from google.cloud.support_v2beta.services.comment_service import (
...
def test_comment_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.support_v2beta.services.comment_service.transports.CommentServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_comments_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*/cases/*}/comments" % client.transport._host,
            args[1],
        )
...
def test_get_comment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{name=*/*/cases/*/comments/*}" % client.transport._host, args[1]
        )
...
def test_comment_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.support_v2beta.services.comment_service.transports.CommentServiceTransport.__init__"
    ) as Transport:
...
def test_comment_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.support_v2beta.services.comment_service.transports.CommentServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

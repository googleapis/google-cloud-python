...
from google.cloud.tpu_v1.services.tpu import TpuAsyncClient, TpuClient, pagers, transports
...
def test_list_tensor_flow_versions(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_tensor_flow_versions), "__call__") as call:
        # Designate an appropriate return value for the call.
...
async def test_list_tensor_flow_versions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_tensor_flow_versions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            cloud_tpu.ListTensorFlowVersionsResponse(
                tensorflow_versions=[

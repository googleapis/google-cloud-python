...
@pytest.mark.asyncio
async def test_reimage_node_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.reimage_node
            in client._client._transport._wrapped_methods
        )
...
async def test_reimage_node_async(request_type, transport: str = "grpc_asyncio"):
    client = TpuAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_tensor_flow_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.list_tensor_flow_versions
...
@pytest.mark.asyncio
async def test_list_tensor_flow_versions_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_tensor_flow_versions
            in client._client._transport._wrapped_methods
        )
...
def test_list_tensor_flow_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_tensor_flow_versions(
...
def test_get_tensor_flow_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_tensor_flow_version
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_get_tensor_flow_version_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_tensor_flow_version
            in client._client._transport._wrapped_methods
        )

...
from google.cloud.tpu_v2.services.tpu import TpuAsyncClient, TpuClient, pagers, transports
...
def test_tpu_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == ("tpu.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://tpu.googleapis.com")
...
def test_list_queued_resources_rest_required_fields(request_type=cloud_tpu.ListQueuedResourcesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_queued_resources._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_queued_resource_rest_required_fields(request_type=cloud_tpu.GetQueuedResourceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_queued_resource._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_queued_resource_rest_required_fields(request_type=cloud_tpu.CreateQueuedResourceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_queued_resource._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_delete_queued_resource_rest_required_fields(request_type=cloud_tpu.DeleteQueuedResourceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_queued_resource._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_reset_queued_resource_rest_required_fields(request_type=cloud_tpu.ResetQueuedResourceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_queued_resource._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_generate_service_identity_rest_required_fields(request_type=cloud_tpu.GenerateServiceIdentityRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_service_identity._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_accelerator_types_rest_required_fields(request_type=cloud_tpu.ListAcceleratorTypesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_accelerator_types._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_accelerator_type_rest_required_fields(request_type=cloud_tpu.GetAcceleratorTypeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_accelerator_type._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_runtime_versions_rest_required_fields(request_type=cloud_tpu.ListRuntimeVersionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_runtime_versions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_runtime_version_rest_required_fields(request_type=cloud_tpu.GetRuntimeVersionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_runtime_version._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_get_guest_attributes_rest_required_fields(request_type=cloud_tpu.GetGuestAttributesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_guest_attributes._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_transport_kind_rest():
    transport = TpuClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_list_nodes_rest_bad_request(request_type=cloud_tpu.ListNodesRequest):
    client = TpuClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_list_nodes_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_list_nodes") as post, mock.patch.object(
...
def test_get_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_get_node") as post, mock.patch.object(
...
def test_create_node_rest_call_success(request_type):
    ...
    request_init["node"] = {
        ...
        "network_configs": {},
        "cidr_block": "cidr_block_value",
        "service_account": {"email": "email_value", "scope": ["scope_value1", "scope_value2"]},
        "create_time": {"seconds": 751, "nanos": 543},
        "scheduling_config": {"preemptible": True, "reserved": True, "spot": True},
        "network_endpoints": [{"ip_address": "ip_address_value", "port": 453, "access_config": {"external_ip": "external_ip_value"}}],
        "health": 1,
        "labels": {},
        "metadata": {},
        ...
        "api_version": 1,
        "symptoms": [{"create_time": {}, "symptom_type": 1, "details": "details_value", "worker_id": "worker_id_value"}],
...
def test_list_queued_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_list_queued_resources") as post, mock.patch.object(
...
def test_get_queued_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_get_queued_resource") as post, mock.patch.object(
            ...
            "node_spec": [
                {
                    "parent": "parent_value",
                    "node_id": "node_id_value",
                    "multislice_params": {"node_count": 1070, "node_id_prefix": "node_id_prefix_value"},
                    "node": {
                        "name": "name_value",
                        "description": "description_value",
                        "accelerator_type": "accelerator_type_value",
...
def test_generate_service_identity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_generate_service_identity") as post, mock.patch.object(
...
def test_list_accelerator_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_list_accelerator_types") as post, mock.patch.object(
...
def test_get_accelerator_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_get_accelerator_type") as post, mock.patch.object(
...
def test_list_runtime_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_list_runtime_versions") as post, mock.patch.object(
...
def test_get_runtime_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_get_runtime_version") as post, mock.patch.object(
...
def test_get_guest_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TpuRestInterceptor, "post_get_guest_attributes") as post, mock.patch.object(
...
def test_tpu_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.TpuRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_tpu_host_with_port(transport_name):
    ...
    assert client.transport._host == ("tpu.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://tpu.googleapis.com:8000")

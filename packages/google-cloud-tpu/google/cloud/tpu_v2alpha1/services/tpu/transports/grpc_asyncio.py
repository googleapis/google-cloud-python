...
class TpuGrpcAsyncIOTransport(TpuTransport):
    ...
    @property
    def update_node(self) -> Callable[[cloud_tpu.UpdateNodeRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def perform_maintenance(self) -> Callable[[cloud_tpu.PerformMaintenanceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def list_queued_resources(self) -> Callable[[cloud_tpu.ListQueuedResourcesRequest], Awaitable[cloud_tpu.ListQueuedResourcesResponse]]:
    ...
    @property
    def get_queued_resource(self) -> Callable[[cloud_tpu.GetQueuedResourceRequest], Awaitable[cloud_tpu.QueuedResource]]:
    ...
    @property
    def create_queued_resource(self) -> Callable[[cloud_tpu.CreateQueuedResourceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def delete_queued_resource(self) -> Callable[[cloud_tpu.DeleteQueuedResourceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def reset_queued_resource(self) -> Callable[[cloud_tpu.ResetQueuedResourceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def perform_maintenance_queued_resource(
        self,
    ) -> Callable[[cloud_tpu.PerformMaintenanceQueuedResourceRequest], Awaitable[operations_pb2.Operation]]:
    ...
    @property
    def generate_service_identity(self) -> Callable[[cloud_tpu.GenerateServiceIdentityRequest], Awaitable[cloud_tpu.GenerateServiceIdentityResponse]]:
    ...
    @property
    def list_runtime_versions(self) -> Callable[[cloud_tpu.ListRuntimeVersionsRequest], Awaitable[cloud_tpu.ListRuntimeVersionsResponse]]:
    ...
    @property
    def get_runtime_version(self) -> Callable[[cloud_tpu.GetRuntimeVersionRequest], Awaitable[cloud_tpu.RuntimeVersion]]:
    ...
    @property
    def get_guest_attributes(self) -> Callable[[cloud_tpu.GetGuestAttributesRequest], Awaitable[cloud_tpu.GetGuestAttributesResponse]]:
    ...
    @property
    def list_reservations(self) -> Callable[[cloud_tpu.ListReservationsRequest], Awaitable[cloud_tpu.ListReservationsResponse]]:
    ...
    @property
    def simulate_maintenance_event(self) -> Callable[[cloud_tpu.SimulateMaintenanceEventRequest], Awaitable[operations_pb2.Operation]]:

...
__lazy_modules__ = {
    "google.cloud.tpu_v2.services.tpu",
    "google.cloud.tpu_v2.types.cloud_tpu",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.tpu_v2")  # type: ignore
    api_core.check_dependency_versions("google.cloud.tpu_v2")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.cloud.tpu_v2"

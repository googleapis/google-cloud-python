...
class TpuAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.tpu_v2.TpuAsyncClient`.",
                extra={
    ...
    async def update_node(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_node]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("node.name", request.node.name),)),)
    ...
    async def list_queued_resources(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.tpu_v2.types.ListQueuedResourcesRequest, dict]]):
                The request object. Request for
        ...
        Returns:
            google.cloud.tpu_v2.services.tpu.pagers.ListQueuedResourcesAsyncPager:
                Response for
                   [ListQueuedResources][google.cloud.tpu.v2.Tpu.ListQueuedResources].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_queued_resources]
    ...
    async def get_queued_resource(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.tpu_v2.types.GetQueuedResourceRequest, dict]]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_queued_resource]
    ...
    async def create_queued_resource(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.tpu_v2.types.CreateQueuedResourceRequest, dict]]):
                The request object. Request for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            queued_resource (:class:`google.cloud.tpu_v2.types.QueuedResource`):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_queued_resource]
    ...
    async def delete_queued_resource(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.tpu_v2.types.DeleteQueuedResourceRequest, dict]]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_queued_resource]
    ...
    async def reset_queued_resource(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.tpu_v2.types.ResetQueuedResourceRequest, dict]]):
                The request object. Request for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reset_queued_resource]
    ...
    async def generate_service_identity(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_service_identity]
    ...
    async def list_runtime_versions(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_runtime_versions]
    ...
    async def get_runtime_version(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_runtime_version]
    ...
    async def get_guest_attributes(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_guest_attributes]

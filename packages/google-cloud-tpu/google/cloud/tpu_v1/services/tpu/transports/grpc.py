...
class TpuGrpcTransport(TpuTransport):
    ...
    @property
    def reimage_node(self) -> Callable[[cloud_tpu.ReimageNodeRequest], operations_pb2.Operation]:
    ...
    @property
    def list_tensor_flow_versions(self) -> Callable[[cloud_tpu.ListTensorFlowVersionsRequest], cloud_tpu.ListTensorFlowVersionsResponse]:
    ...
    @property
    def get_tensor_flow_version(self) -> Callable[[cloud_tpu.GetTensorFlowVersionRequest], cloud_tpu.TensorFlowVersion]:

...
class TpuAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = TpuClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(TpuAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            TpuAsyncClient: The constructed client.
        """
        sa_file_func = TpuClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(TpuAsyncClient, filename, *args, **kwargs)

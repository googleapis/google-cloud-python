...
from .services.conference_records_service import ConferenceRecordsServiceAsyncClient, ConferenceRecordsServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.apps.meet_v2beta")  # type: ignore
    api_core.check_dependency_versions("google.apps.meet_v2beta")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.apps.meet_v2beta"

...
class Space(proto.Message):
    ...
    Virtual place where conferences are held. Only one active conference
    ...
    Attributes:
        ...
        meeting_code (str):
            ...
            maximum length is 128 characters. Can ONLY be used as alias
            of the space ID to get the space.
...
class ConferenceRecord(proto.Message):
    r"""`Developer
    Preview <https://developers.google.com/workspace/preview>`__. Single
    instance of a meeting held in a space.
    ...
    Attributes:
        ...
        expire_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. Server enforced expire time for
            when this conference record resource is deleted.
            The resource is deleted 30 days after the
            conference ends.
        space (str):
...
class Participant(proto.Message):
    r"""`Developer
    Preview <https://developers.google.com/workspace/preview>`__. User
    who attended or is attending a conference.
    ...
    Attributes:
        ...
        earliest_start_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. Time when the participant joined
...
class ParticipantSession(proto.Message):
    r"""`Developer
    Preview <https://developers.google.com/workspace/preview>`__. Refers
    to each unique join/leave session when a user joins a conference
    from a device. Note that any time a user joins the conference a new
    unique ID is assigned. That means if a user joins a space multiple
    times from the same device, they're assigned different IDs, and are
    ...
    Attributes:
        ...
        end_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. Timestamp when the user session
            ended. Unset if the user session hasn’t ended.
    """
...
class SignedinUser(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            user's first and last name. For a robot account,
            it's the admin specified device name. For
...
class Transcript(proto.Message):
    r"""`Developer
    Preview <https://developers.google.com/workspace/preview>`__.
    Metadata for a transcript generated from a conference. It refers to
    the ASR (Automatic Speech Recognition) result of user's speech
...
class TranscriptEntry(proto.Message):
    r"""`Developer
    Preview <https://developers.google.com/workspace/preview>`__. Single
    entry for one user’s speech during a transcript session.
    ...
    Attributes:
        ...
        participant (str):
            Output only. Refer to the participant who
            speaks.
        text (str):

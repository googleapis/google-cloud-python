...
class ConferenceRecordsServiceClient(metaclass=ConferenceRecordsServiceClientMeta):
    ...
    def get_smart_note(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2beta.types.GetSmartNoteRequest, dict]):
    ...
    def list_smart_notes(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2beta.types.ListSmartNotesRequest, dict]):
        ...
        Returns:
            google.apps.meet_v2beta.services.conference_records_service.pagers.ListSmartNotesPager:

...
class SpacesServiceGrpcAsyncIOTransport(SpacesServiceTransport):
    ...
    @property
    def connect_active_conference(self) -> Callable[[service.ConnectActiveConferenceRequest], Awaitable[service.ConnectActiveConferenceResponse]]:
    ...
    @property
    def create_member(self) -> Callable[[service.CreateMemberRequest], Awaitable[resource.Member]]:
    ...
    @property
    def get_member(self) -> Callable[[service.GetMemberRequest], Awaitable[resource.Member]]:
    ...
    @property
    def list_members(self) -> Callable[[service.ListMembersRequest], Awaitable[service.ListMembersResponse]]:
    ...
    @property
    def delete_member(self) -> Callable[[service.DeleteMemberRequest], Awaitable[empty_pb2.Empty]]:

...
class SpacesServiceAsyncClient:
    ...
    async def update_member(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.apps.meet_v2beta.types.UpdateMemberRequest, dict]]):
    ...
    async def batch_update_members(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.apps.meet_v2beta.types.BatchUpdateMembersRequest, dict]]):

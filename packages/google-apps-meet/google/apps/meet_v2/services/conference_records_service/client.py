...
class ConferenceRecordsServiceClient(metaclass=ConferenceRecordsServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                ConferenceRecordsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = ConferenceRecordsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ConferenceRecordsServiceClient._get_api_endpoint(

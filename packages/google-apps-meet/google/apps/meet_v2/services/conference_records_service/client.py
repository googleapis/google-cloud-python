...
class ConferenceRecordsServiceClient(metaclass=ConferenceRecordsServiceClientMeta):
    ...
    def participant_path(
        ...
        return "conferenceRecords/{conference_record}/participants/{participant}".format(
            conference_record=conference_record,
    ...
    def parse_participant_session_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^conferenceRecords/(?P<conference_record>.+?)/participants/(?P<participant>.+?)/participantSessions/(?P<participant_session>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ConferenceRecordsServiceClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ConferenceRecordsServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or ConferenceRecordsServiceClient._get_api_endpoint(
    ...
    def get_conference_record(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.GetConferenceRecordRequest, dict]):
    ...
    def list_conference_records(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListConferenceRecordsRequest, dict]):
    ...
    def get_participant(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.GetParticipantRequest, dict]):
    ...
    def list_participants(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListParticipantsRequest, dict]):
    ...
    def get_participant_session(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.GetParticipantSessionRequest, dict]):
    ...
    def list_participant_sessions(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListParticipantSessionsRequest, dict]):
    ...
    def get_recording(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.GetRecordingRequest, dict]):
    ...
    def list_recordings(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListRecordingsRequest, dict]):
    ...
    def get_transcript(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.GetTranscriptRequest, dict]):
    ...
    def list_transcripts(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListTranscriptsRequest, dict]):
    ...
    def get_transcript_entry(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.GetTranscriptEntryRequest, dict]):
    ...
    def list_transcript_entries(
        ...
        *,
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListTranscriptEntriesRequest, dict]):

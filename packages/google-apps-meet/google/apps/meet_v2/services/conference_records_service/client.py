...
class ConferenceRecordsServiceClient(metaclass=ConferenceRecordsServiceClientMeta):
    ...
    def smart_note_path(
        ...
        """Returns a fully-qualified smart_note string."""
        return "conferenceRecords/{conference_record}/smartNotes/{smart_note}".format(
            conference_record=conference_record,
            smart_note=smart_note,
        )

    @staticmethod
    def parse_smart_note_path(path: str) -> Dict[str, str]:
        """Parses a smart_note path into its component segments."""
        m = re.match(
            r"^conferenceRecords/(?P<conference_record>.+?)/smartNotes/(?P<smart_note>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=ConferenceRecordsServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def get_smart_note(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_smart_note():
                # Create a client
                client = meet_v2.ConferenceRecordsServiceClient()

                # Initialize request argument(s)
                request = meet_v2.GetSmartNoteRequest(
                    name="name_value",
                )

                # Make the request
                response = client.get_smart_note(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.apps.meet_v2.types.GetSmartNoteRequest, dict]):
        ...
        Returns:
            google.apps.meet_v2.types.SmartNote:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_smart_note]
    ...
    def list_smart_notes(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_smart_notes():
                # Create a client
                client = meet_v2.ConferenceRecordsServiceClient()

                # Initialize request argument(s)
                request = meet_v2.ListSmartNotesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.apps.meet_v2.types.ListSmartNotesRequest, dict]):
        ...
        Returns:
            google.apps.meet_v2.services.conference_records_service.pagers.ListSmartNotesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_smart_notes]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListSmartNotesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,

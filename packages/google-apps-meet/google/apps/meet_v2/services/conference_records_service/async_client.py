...
class ConferenceRecordsServiceAsyncClient:
    ...
    async def get_smart_note(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.apps.meet_v2.types.GetSmartNoteRequest, dict]]):
    ...
    async def list_smart_notes(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.apps.meet_v2.types.ListSmartNotesRequest, dict]]):
        ...
        Returns:
            google.apps.meet_v2.services.conference_records_service.pagers.ListSmartNotesAsyncPager:

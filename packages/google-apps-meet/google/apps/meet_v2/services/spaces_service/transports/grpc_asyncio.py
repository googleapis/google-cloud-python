...
class SpacesServiceGrpcAsyncIOTransport(SpacesServiceTransport):
    ...
    @property
    def create_space(self) -> Callable[[service.CreateSpaceRequest], Awaitable[resource.Space]]:
    ...
    @property
    def get_space(self) -> Callable[[service.GetSpaceRequest], Awaitable[resource.Space]]:
    ...
    @property
    def update_space(self) -> Callable[[service.UpdateSpaceRequest], Awaitable[resource.Space]]:
    ...
    @property
    def end_active_conference(self) -> Callable[[service.EndActiveConferenceRequest], Awaitable[empty_pb2.Empty]]:
...
__all__ = ("SpacesServiceGrpcAsyncIOTransport",)

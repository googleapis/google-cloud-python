        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.apps.meet_v2.SpacesServiceClient.BatchUpdateMembers",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.apps.meet_v2.SpacesServiceClient.batch_update_members",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "BatchUpdateMembers",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.apps.meet_v2.SpacesServiceClient.CreateMember",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.apps.meet_v2.SpacesServiceClient.create_member",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "CreateMember",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.apps.meet_v2.SpacesServiceClient.DeleteMember",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.apps.meet_v2.SpacesServiceClient.GetMember",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "GetMember",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.apps.meet_v2.SpacesServiceClient.get_member",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "GetMember",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.apps.meet_v2.SpacesServiceClient.ListMembers",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "ListMembers",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.apps.meet_v2.SpacesServiceClient.list_members",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "ListMembers",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.apps.meet_v2.SpacesServiceClient.UpdateMember",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.apps.meet_v2.SpacesServiceClient.update_member",
                    extra={
                        "serviceName": "google.apps.meet.v2.SpacesService",
                        "rpcName": "UpdateMember",
                        "metadata": http_response["headers"],

...
class SpacesServiceClient(metaclass=SpacesServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or SpacesServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, SpacesServiceTransport]] = None,
    ...
    def create_space(
        ...
        *,
        ...
        # in a service.CreateSpaceRequest.
    ...
    def update_space(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.UpdateSpaceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def end_active_conference(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a service.EndActiveConferenceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.

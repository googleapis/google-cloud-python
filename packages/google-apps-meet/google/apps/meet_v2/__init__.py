...
__lazy_modules__ = {
    "google.apps.meet_v2.services.conference_records_service",
    "google.apps.meet_v2.services.spaces_service",
    "google.apps.meet_v2.types.resource",
    "google.apps.meet_v2.types.service",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.apps.meet_v2")  # type: ignore
    api_core.check_dependency_versions("google.apps.meet_v2")  # type: ignore
    ...
    try:
        ...
        _package_label = "google.apps.meet_v2"

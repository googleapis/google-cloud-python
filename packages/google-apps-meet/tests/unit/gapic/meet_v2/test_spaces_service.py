...
def test__get_default_mtls_endpoint():
    ...
    assert (
        SpacesServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_api_endpoint():
    ...
    assert (
        SpacesServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == SpacesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SpacesServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        SpacesServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == SpacesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        SpacesServiceClient._get_api_endpoint(
    ...
    assert (
        SpacesServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        SpacesServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        SpacesServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        SpacesServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        SpacesServiceClient._get_universe_domain(None, None)
        == SpacesServiceClient._DEFAULT_UNIVERSE
    )

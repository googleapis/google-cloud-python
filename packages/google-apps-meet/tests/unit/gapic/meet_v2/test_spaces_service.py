...
from google.apps.meet_v2.services.spaces_service import SpacesServiceAsyncClient, SpacesServiceClient, transports
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert SpacesServiceClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SpacesServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SpacesServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SpacesServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        SpacesServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SpacesServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_spaces_service_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == ("meet.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://meet.googleapis.com")
...
@pytest.mark.parametrize("client_class", [SpacesServiceClient, SpacesServiceAsyncClient])
...
def test_spaces_service_client_client_options_from_dict():
    with mock.patch("google.apps.meet_v2.services.spaces_service.transports.SpacesServiceGrpcTransport.__init__") as grpc_transport:
        ...
        client = SpacesServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_end_active_conference_rest_required_fields(request_type=service.EndActiveConferenceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).end_active_conference._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = SpacesServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = SpacesServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = SpacesServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = SpacesServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = SpacesServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = SpacesServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_create_space_rest_bad_request(request_type=service.CreateSpaceRequest):
    client = SpacesServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_create_space_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.SpacesServiceRestInterceptor, "post_create_space") as post, mock.patch.object(
...
def test_get_space_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SpacesServiceRestInterceptor, "post_get_space") as post, mock.patch.object(
...
def test_update_space_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SpacesServiceRestInterceptor, "post_update_space") as post, mock.patch.object(
...
def test_end_active_conference_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.SpacesServiceRestInterceptor, "pre_end_active_conference") as pre:
        pre.assert_not_called()
...
def test_spaces_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.SpacesServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.SpacesServiceGrpcTransport, grpc_helpers), (transports.SpacesServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_spaces_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.SpacesServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_spaces_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "meet.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://meet.googleapis.com:8000"
    )
...
def test_client_ctx():
    ...
    for transport in transports:
        client = SpacesServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

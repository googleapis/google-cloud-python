...
class ListBucketsResponse(proto.Message):
    ...
    Attributes:
        buckets (MutableSequence[google.cloud.storage_client_v2.types.Bucket]):
            The list of items.
        next_page_token (str):
...
class ListNotificationConfigsResponse(proto.Message):
    ...
    Attributes:
        notification_configs (MutableSequence[google.cloud.storage_client_v2.types.NotificationConfig]):
            The list of items.
        next_page_token (str):
...
class ComposeObjectRequest(proto.Message):
    ...
    Attributes:
        destination (google.cloud.storage_client_v2.types.Object):
            Required. Properties of the resulting object.
        source_objects (MutableSequence[google.cloud.storage_client_v2.types.ComposeObjectRequest.SourceObject]):
        ...
        common_object_request_params (google.cloud.storage_client_v2.types.CommonObjectRequestParams):
            A set of parameters common to Storage API
            requests concerning an object.
        object_checksums (google.cloud.storage_client_v2.types.ObjectChecksums):
    ...
    class SourceObject(proto.Message):
        ...
        Attributes:
            ...
            generation (int):
                ...
                source.
            object_preconditions (google.cloud.storage_client_v2.types.ComposeObjectRequest.SourceObject.ObjectPreconditions):
...
class ReadObjectResponse(proto.Message):
    ...
    Attributes:
        checksummed_data (google.cloud.storage_client_v2.types.ChecksummedData):
...
class WriteObjectSpec(proto.Message):
    ...
    Attributes:
        resource (google.cloud.storage_client_v2.types.Object):
...
class WriteObjectRequest(proto.Message):
    ...
    Attributes:
        ...
        write_object_spec (google.cloud.storage_client_v2.types.WriteObjectSpec):
...
class CreateHmacKeyResponse(proto.Message):
    ...
    Attributes:
        metadata (google.cloud.storage_client_v2.types.HmacKeyMetadata):
            Key metadata.
...
class ListHmacKeysResponse(proto.Message):
    ...
    Attributes:
        hmac_keys (MutableSequence[google.cloud.storage_client_v2.types.HmacKeyMetadata]):
            The list of items.
        next_page_token (str):
            The continuation token, used to page through
            large result sets. Provide this value in a
...
class Bucket(proto.Message):
    ...
    Attributes:
        ...
        acl (MutableSequence[google.cloud.storage_client_v2.types.BucketAccessControl]):
            Access controls on the bucket. If
            iam_config.uniform_bucket_level_access is enabled on this
            bucket, requests to set, read, or modify acl is an error.
        default_object_acl (MutableSequence[google.cloud.storage_client_v2.types.ObjectAccessControl]):
            ...
            is an error.
        lifecycle (google.cloud.storage_client_v2.types.Bucket.Lifecycle):
            The bucket's lifecycle config. See
            [https://developers.google.com/storage/docs/lifecycle]Lifecycle
            Management] for more information.
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            Output only. The creation time of the bucket.
        cors (MutableSequence[google.cloud.storage_client_v2.types.Bucket.Cors]):
        ...
        website (google.cloud.storage_client_v2.types.Bucket.Website):
        ...
        versioning (google.cloud.storage_client_v2.types.Bucket.Versioning):
            The bucket's versioning config.
        logging (google.cloud.storage_client_v2.types.Bucket.Logging):
            The bucket's logging config, which defines
            the destination bucket and name prefix (if any)
            for the current bucket's logs.
        owner (google.cloud.storage_client_v2.types.Owner):
            Output only. The owner of the bucket. This is
            always the project team's owner group.
        encryption (google.cloud.storage_client_v2.types.Bucket.Encryption):
            Encryption config for a bucket.
        billing (google.cloud.storage_client_v2.types.Bucket.Billing):
            The bucket's billing config.
        retention_policy (google.cloud.storage_client_v2.types.Bucket.RetentionPolicy):
        ...
        iam_config (google.cloud.storage_client_v2.types.Bucket.IamConfig):
            The bucket's IAM config.
        satisfies_pzs (bool):
            Reserved for future use.
        custom_placement_config (google.cloud.storage_client_v2.types.Bucket.CustomPlacementConfig):
            Configuration that, if present, specifies the data placement
            for a
            [https://cloud.google.com/storage/docs/use-dual-regions][Dual
            Region].
        autoclass (google.cloud.storage_client_v2.types.Bucket.Autoclass):
            ...
            bucket.
        hierarchical_namespace (google.cloud.storage_client_v2.types.Bucket.HierarchicalNamespace):
        ...
        soft_delete_policy (google.cloud.storage_client_v2.types.Bucket.SoftDeletePolicy):
    ...
    class IamConfig(proto.Message):
        ...
        Attributes:
            uniform_bucket_level_access (google.cloud.storage_client_v2.types.Bucket.IamConfig.UniformBucketLevelAccess):
    ...
    class Lifecycle(proto.Message):
        ...
        Attributes:
            rule (MutableSequence[google.cloud.storage_client_v2.types.Bucket.Lifecycle.Rule]):
        ...
        class Rule(proto.Message):
            ...
            Attributes:
                action (google.cloud.storage_client_v2.types.Bucket.Lifecycle.Rule.Action):
                    The action to take.
                condition (google.cloud.storage_client_v2.types.Bucket.Lifecycle.Rule.Condition):
...
class BucketAccessControl(proto.Message):
    ...
    Attributes:
        ...
        domain (str):
            ...
            any.
        project_team (google.cloud.storage_client_v2.types.ProjectTeam):
...
class Object(proto.Message):
    ...
    Attributes:
        ...
        cache_control (str):
            ...
            ``public, max-age=3600``.
        acl (MutableSequence[google.cloud.storage_client_v2.types.ObjectAccessControl]):
        ...
        checksums (google.cloud.storage_client_v2.types.ObjectChecksums):
        ...
        customer_encryption (google.cloud.storage_client_v2.types.CustomerEncryption):
...
class ListObjectsResponse(proto.Message):
    ...
    Attributes:
        objects (MutableSequence[google.cloud.storage_client_v2.types.Object]):
            The list of items.

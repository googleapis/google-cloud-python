...
class StorageGrpcAsyncIOTransport(StorageTransport):
    ...
    def delete_notification_config(
        ...
        [storage.DeleteNotificationConfigRequest], Awaitable[empty_pb2.Empty]
    ]:
    ...
    def get_notification_config(
        ...
        [storage.GetNotificationConfigRequest], Awaitable[storage.NotificationConfig]
    ]:
    ...
    def create_notification_config(
        ...
        [storage.CreateNotificationConfigRequest], Awaitable[storage.NotificationConfig]
    ]:
    ...
    def get_service_account(
        ...
        [storage.GetServiceAccountRequest], Awaitable[storage.ServiceAccount]
    ]:
    ...
    def create_hmac_key(
        ...
        [storage.CreateHmacKeyRequest], Awaitable[storage.CreateHmacKeyResponse]
    ]:
    ...
    def delete_hmac_key(
        self,
    ) -> Callable[[storage.DeleteHmacKeyRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def get_hmac_key(
        self,
    ) -> Callable[[storage.GetHmacKeyRequest], Awaitable[storage.HmacKeyMetadata]]:
    ...
    def list_hmac_keys(
        ...
        [storage.ListHmacKeysRequest], Awaitable[storage.ListHmacKeysResponse]
    ]:
    ...
    def update_hmac_key(
        self,
    ) -> Callable[[storage.UpdateHmacKeyRequest], Awaitable[storage.HmacKeyMetadata]]:

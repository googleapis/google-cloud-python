...
class StorageGrpcTransport(StorageTransport):
    ...
    def delete_notification_config(
        self,
    ) -> Callable[[storage.DeleteNotificationConfigRequest], empty_pb2.Empty]:
    ...
    def get_notification_config(
        self,
    ) -> Callable[[storage.GetNotificationConfigRequest], storage.NotificationConfig]:
    ...
    def create_notification_config(
        ...
        [storage.CreateNotificationConfigRequest], storage.NotificationConfig
    ]:
    ...
    def get_service_account(
        self,
    ) -> Callable[[storage.GetServiceAccountRequest], storage.ServiceAccount]:
    ...
    def create_hmac_key(
        self,
    ) -> Callable[[storage.CreateHmacKeyRequest], storage.CreateHmacKeyResponse]:
    ...
    def delete_hmac_key(
        self,
    ) -> Callable[[storage.DeleteHmacKeyRequest], empty_pb2.Empty]:
    ...
    def get_hmac_key(
        self,
    ) -> Callable[[storage.GetHmacKeyRequest], storage.HmacKeyMetadata]:
    ...
    def list_hmac_keys(
        self,
    ) -> Callable[[storage.ListHmacKeysRequest], storage.ListHmacKeysResponse]:
    ...
    def update_hmac_key(
        self,
    ) -> Callable[[storage.UpdateHmacKeyRequest], storage.HmacKeyMetadata]:

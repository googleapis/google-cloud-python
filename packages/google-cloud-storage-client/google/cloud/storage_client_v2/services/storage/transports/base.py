...
class StorageTransport(abc.ABC):
    ...
    def get_notification_config(
        ...
        Union[storage.NotificationConfig, Awaitable[storage.NotificationConfig]],
    ]:
        raise NotImplementedError()
    ...
    def get_service_account(
        ...
        Union[storage.ServiceAccount, Awaitable[storage.ServiceAccount]],
    ]:
        raise NotImplementedError()
    ...
    def create_hmac_key(
        ...
        Union[storage.CreateHmacKeyResponse, Awaitable[storage.CreateHmacKeyResponse]],
    ]:
        raise NotImplementedError()
    ...
    def get_hmac_key(
        ...
        Union[storage.HmacKeyMetadata, Awaitable[storage.HmacKeyMetadata]],
    ]:
        raise NotImplementedError()
    ...
    def list_hmac_keys(
        ...
        Union[storage.ListHmacKeysResponse, Awaitable[storage.ListHmacKeysResponse]],
    ]:
        raise NotImplementedError()

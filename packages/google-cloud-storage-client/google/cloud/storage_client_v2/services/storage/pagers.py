...
class ListBucketsPager:
    ...
    :class:`google.cloud.storage_client_v2.types.ListBucketsResponse` object, and
    ...
    All the usual :class:`google.cloud.storage_client_v2.types.ListBucketsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.storage_client_v2.types.ListBucketsRequest):
                The initial request object.
            response (google.cloud.storage_client_v2.types.ListBucketsResponse):
...
class ListNotificationConfigsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.storage_client_v2.types.ListNotificationConfigsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.storage_client_v2.types.ListNotificationConfigsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.storage_client_v2.types.ListNotificationConfigsRequest):
                The initial request object.
            response (google.cloud.storage_client_v2.types.ListNotificationConfigsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListObjectsPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.storage_client_v2.types.ListObjectsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``objects`` field.
    ...
    All the usual :class:`google.cloud.storage_client_v2.types.ListObjectsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.storage_client_v2.types.ListObjectsRequest):
                The initial request object.
            response (google.cloud.storage_client_v2.types.ListObjectsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
...
class ListHmacKeysPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.storage_client_v2.types.ListHmacKeysResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``hmac_keys`` field.
    ...
    All the usual :class:`google.cloud.storage_client_v2.types.ListHmacKeysResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.storage_client_v2.types.ListHmacKeysRequest):
                The initial request object.
            response (google.cloud.storage_client_v2.types.ListHmacKeysResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """

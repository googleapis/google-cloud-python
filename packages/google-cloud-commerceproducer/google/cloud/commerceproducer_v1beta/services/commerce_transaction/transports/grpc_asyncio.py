...
class CommerceTransactionGrpcAsyncIOTransport(CommerceTransactionTransport):
    """gRPC AsyncIO backend transport for CommerceTransaction.
    ...
    def list_services(
        ...
        Awaitable[commerce_transaction.ListServicesResponse],
    ]:
    ...
    def get_service(
        self,
    ) -> Callable[[commerce_transaction.GetServiceRequest], Awaitable[service.Service]]:
    ...
    def list_private_offers(
        ...
        Returns:
            Callable[[~.ListPrivateOffersRequest],
                    Awaitable[~.ListPrivateOffersResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_private_offer(
        ...
        Awaitable[private_offer.PrivateOffer],
    ]:
    ...
    def resolve_amendment_target(
        ...
        Returns:
            Callable[[~.ResolveAmendmentTargetRequest],
                    Awaitable[~.ResolveAmendmentTargetResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def update_private_offer(
        ...
        Awaitable[gcc_private_offer.PrivateOffer],
    ]:
    ...
    def delete_private_offer(
        ...
        [commerce_transaction.DeletePrivateOfferRequest], Awaitable[empty_pb2.Empty]
    ]:
    ...
    def list_private_offer_documents(
        ...
        Returns:
            Callable[[~.ListPrivateOfferDocumentsRequest],
                    Awaitable[~.ListPrivateOfferDocumentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_private_offer_document(
        ...
        Awaitable[private_offer.PrivateOfferDocument],
    ]:
        ...
        Returns:
            Callable[[~.GetPrivateOfferDocumentRequest],
                    Awaitable[~.PrivateOfferDocument]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_standard_offers(
        ...
        Returns:
            Callable[[~.ListStandardOffersRequest],
                    Awaitable[~.ListStandardOffersResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_standard_offer(
        ...
        Awaitable[standard_offer.StandardOffer],
    ]:
    ...
    def get_sku(
        self,
    ) -> Callable[[commerce_transaction.GetSkuRequest], Awaitable[sku.Sku]]:
    ...
    def list_skus(
        ...
        Awaitable[commerce_transaction.ListSkusResponse],
    ]:
    ...
    def get_sku_group(
        ...
        [commerce_transaction.GetSkuGroupRequest], Awaitable[sku_group.SkuGroup]
    ]:
    ...
    def list_sku_groups(
        ...
        Awaitable[commerce_transaction.ListSkuGroupsResponse],
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.list_private_offers: self._wrap_method(
                self.list_private_offers,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_private_offer: self._wrap_method(
                self.get_private_offer,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.resolve_amendment_target: self._wrap_method(
                self.resolve_amendment_target,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.create_private_offer: self._wrap_method(
                self.create_private_offer,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_private_offer: self._wrap_method(
                self.update_private_offer,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.publish_private_offer: self._wrap_method(
                self.publish_private_offer,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.cancel_private_offer: self._wrap_method(
                self.cancel_private_offer,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_private_offer: self._wrap_method(
                self.delete_private_offer,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_private_offer_documents: self._wrap_method(
                self.list_private_offer_documents,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_private_offer_document: self._wrap_method(
                self.get_private_offer_document,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.create_private_offer_document: self._wrap_method(
                self.create_private_offer_document,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.update_private_offer_document: self._wrap_method(
                self.update_private_offer_document,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.delete_private_offer_document: self._wrap_method(
                self.delete_private_offer_document,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.list_standard_offers: self._wrap_method(
                self.list_standard_offers,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_standard_offer: self._wrap_method(
                self.get_standard_offer,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
                    multiplier=1.3,
            ...
            self.get_sku_group: self._wrap_method(
                self.get_sku_group,
                default_retry=retries.AsyncRetry(
                    initial=1.0,
                    maximum=10.0,
...
__all__ = ("CommerceTransactionGrpcAsyncIOTransport",)

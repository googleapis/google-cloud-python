...
- While logged into your GitHub account, navigate to the
  ``python-source-context`` `repo`_ on GitHub.

- Fork and clone the ``python-source-context`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-source-context`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-source-context``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-source-context.git hack-on-python-source-context
   $ cd hack-on-python-source-context
...
.. _repo: https://github.com/googleapis/python-source-context

...
class StreamedResultSet(object):
    ...
    def to_arrow_batches(self, max_chunk_size: int = 65536):
    ...
    def to_arrow(self, max_chunk_size: int = 65536):
        ...
        batches = list(self.to_arrow_batches(max_chunk_size=max_chunk_size))
        if not batches:
            if self._metadata is not None:
    ...
    def to_dataframe(self, max_chunk_size: int = 65536, **kwargs):
        ...
        """
        table = self.to_arrow(max_chunk_size=max_chunk_size)

            ...
            with self.__transport_lock:
                ...
                if self._channel_pool_options is not None:
                    if self._instance.emulator_host is not None:
                        ...
                        def channel_factory():
                            return grpc.insecure_channel(self._instance.emulator_host)
                    else:
                    ...
                    transport = SpannerGrpcTransport(
                        host=host, channel=self._channel_pool, client_info=client_info
                    )
            ...
            with (
                ...
                try:
                    ...
                    call_metadata, error_augmenter = self.with_error_augmentation(
                        self._next_nth_request, 1, pdml_metadata, span
                    )
                    ...
                    method = functools.partial(
                        api.execute_streaming_sql, metadata=pdml_metadata
                    )

...
class TestTransaction(OpenTelemetryBase):
    ...
    def test_execute_update_inline_begin_error_releases_lock(self, mock_region):
        database = _Database()
        database.spanner_api = self._make_spanner_api()
        database.spanner_api.execute_sql.side_effect = RuntimeError()
        session = _Session(database)
    ...
    def test_execute_update_wo_request_options_and_transaction_tag(self, mock_region):
        self._execute_update_helper(transaction_tag=None)
    ...
    def test_batch_update_inline_begin_error_releases_lock(self, mock_region):
        database = _Database()
        database.spanner_api = self._make_spanner_api()
        database.spanner_api.execute_batch_dml.side_effect = RuntimeError()
        session = _Session(database)
    ...
    def test_batch_update_wo_request_options_and_transaction_tag(self, mock_region):
        self._batch_update_helper(transaction_tag=None)

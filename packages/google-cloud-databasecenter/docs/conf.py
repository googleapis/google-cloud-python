...
##
# google-cloud-databasecenter documentation build configuration file
#
...
project = "google-cloud-databasecenter"
copyright = "2025, Google, LLC"
author = "Google APIs"
...
# documentation.
html_theme_options = {
    "description": "Google Cloud Client Libraries for google-cloud-databasecenter",
...
htmlhelp_basename = "google-cloud-databasecenter-doc"
...
latex_documents = [
    (
        root_doc,
        "google-cloud-databasecenter.tex",
        "google-cloud-databasecenter Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-databasecenter",
        "google-cloud-databasecenter Library",
        "APIs",
    )
]

...
class DatabaseCenterGrpcAsyncIOTransport(DatabaseCenterTransport):
    """gRPC AsyncIO backend transport for DatabaseCenter.
    ...
    def query_products(
        ...
        [service.QueryProductsRequest], Awaitable[service.QueryProductsResponse]
    ]:
        ...
        Returns:
            Callable[[~.QueryProductsRequest],
                    Awaitable[~.QueryProductsResponse]]:
    ...
    def aggregate_query_stats(
        ...
        Returns:
            Callable[[~.AggregateQueryStatsRequest],
                    Awaitable[~.AggregateQueryStatsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.aggregate_query_stats: self._wrap_method(
...
__all__ = ("DatabaseCenterGrpcAsyncIOTransport",)

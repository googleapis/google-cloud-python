...
__lazy_modules__ = {
    ...
    "google.cloud.accessapproval_v1.types.accessapproval",
}
...
if hasattr(api_core, "check_python_version") and hasattr(
    ...
    api_core.check_python_version("google.cloud.accessapproval_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.accessapproval_v1")  # type: ignore

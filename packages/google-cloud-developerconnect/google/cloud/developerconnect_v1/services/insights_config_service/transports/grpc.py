...
class InsightsConfigServiceGrpcTransport(InsightsConfigServiceTransport):
    """gRPC backend transport for InsightsConfigService.
    ...
    def list_insights_configs(
        ...
        r"""Return a callable for the list insights configs method over gRPC.

        Lists InsightsConfigs in a given project and
        location.

        Returns:
            Callable[[~.ListInsightsConfigsRequest],
        ...
        if "list_insights_configs" not in self._stubs:
            self._stubs["list_insights_configs"] = self._logged_channel.unary_unary(
                "/google.cloud.developerconnect.v1.InsightsConfigService/ListInsightsConfigs",
                request_serializer=insights_config.ListInsightsConfigsRequest.serialize,
                response_deserializer=insights_config.ListInsightsConfigsResponse.deserialize,
            )
        return self._stubs["list_insights_configs"]
    ...
    def create_insights_config(
        ...
        r"""Return a callable for the create insights config method over gRPC.

        Creates a new InsightsConfig in a given project and
        location.

        Returns:
            Callable[[~.CreateInsightsConfigRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "create_insights_config" not in self._stubs:
            self._stubs["create_insights_config"] = self._logged_channel.unary_unary(
                "/google.cloud.developerconnect.v1.InsightsConfigService/CreateInsightsConfig",
                request_serializer=gcd_insights_config.CreateInsightsConfigRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["create_insights_config"]
    ...
    def get_insights_config(
        ...
        r"""Return a callable for the get insights config method over gRPC.

        Gets details of a single Insight.

        Returns:
            Callable[[~.GetInsightsConfigRequest],
                    ~.InsightsConfig]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "get_insights_config" not in self._stubs:
            self._stubs["get_insights_config"] = self._logged_channel.unary_unary(
                "/google.cloud.developerconnect.v1.InsightsConfigService/GetInsightsConfig",
                request_serializer=insights_config.GetInsightsConfigRequest.serialize,
                response_deserializer=insights_config.InsightsConfig.deserialize,
            )
        return self._stubs["get_insights_config"]
    ...
    def update_insights_config(
        ...
        r"""Return a callable for the update insights config method over gRPC.

        Updates the parameters of a single InsightsConfig.

        Returns:
            Callable[[~.UpdateInsightsConfigRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "update_insights_config" not in self._stubs:
            self._stubs["update_insights_config"] = self._logged_channel.unary_unary(
                "/google.cloud.developerconnect.v1.InsightsConfigService/UpdateInsightsConfig",
                request_serializer=insights_config.UpdateInsightsConfigRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
        return self._stubs["update_insights_config"]
    ...
    def delete_insights_config(
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "delete_insights_config" not in self._stubs:
            self._stubs["delete_insights_config"] = self._logged_channel.unary_unary(
                "/google.cloud.developerconnect.v1.InsightsConfigService/DeleteInsightsConfig",
                request_serializer=insights_config.DeleteInsightsConfigRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def get_deployment_event(
        ...
        [insights_config.GetDeploymentEventRequest], insights_config.DeploymentEvent
    ]:
...
__all__ = ("InsightsConfigServiceGrpcTransport",)

...
from .transports.base import DEFAULT_CLIENT_INFO, DeveloperConnectTransport
...
class DeveloperConnectClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[DeveloperConnectTransport]]
...
class DeveloperConnectClient(metaclass=DeveloperConnectClientMeta):
    ...
    @staticmethod
    def account_connector_path(
        project: str,
        location: str,
        account_connector: str,
    ) -> str:
        """Returns a fully-qualified account_connector string."""
        return "projects/{project}/locations/{location}/accountConnectors/{account_connector}".format(
            project=project,
            location=location,
    ...
    def parse_account_connector_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/accountConnectors/(?P<account_connector>.+?)$",
            path,
        )
    ...
    def user_path(
        ...
        return "projects/{project}/locations/{location}/accountConnectors/{account_connector}/users/{user}".format(
            project=project,
            location=location,
            account_connector=account_connector,
            user=user,
    ...
    def parse_user_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/accountConnectors/(?P<account_connector>.+?)/users/(?P<user>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = DeveloperConnectClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DeveloperConnectClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DeveloperConnectClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DeveloperConnectClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or DeveloperConnectClient._get_api_endpoint(
    ...
    def create_git_repository_link(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.create_git_repository_link
        ]
    ...
    def delete_git_repository_link(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_git_repository_link
        ]
    ...
    def list_git_repository_links(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_git_repository_links
        ]
    ...
    def fetch_linkable_git_repositories(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.fetch_linkable_git_repositories
        ]
    ...
    def fetch_git_hub_installations(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.fetch_git_hub_installations
        ]

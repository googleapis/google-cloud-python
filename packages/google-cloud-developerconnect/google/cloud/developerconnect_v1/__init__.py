...
from .services.developer_connect import DeveloperConnectAsyncClient, DeveloperConnectClient
from .services.insights_config_service import InsightsConfigServiceAsyncClient, InsightsConfigServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.developerconnect_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.developerconnect_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.developerconnect_v1"

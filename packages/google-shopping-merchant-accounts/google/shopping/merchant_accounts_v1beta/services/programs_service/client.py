...
from .transports.grpc import ProgramsServiceGrpcTransport
from .transports.grpc_asyncio import ProgramsServiceGrpcAsyncIOTransport
from .transports.rest import ProgramsServiceRestTransport


class ProgramsServiceClientMeta(type):
    """Metaclass for the ProgramsService client.
...
class ProgramsServiceClient(metaclass=ProgramsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ProgramsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ProgramsServiceTransport:
        ...
        Returns:
            ProgramsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def program_path(
        ...
        """Returns a fully-qualified program string."""
        return "accounts/{account}/programs/{program}".format(
            account=account,
            program=program,
        )

    @staticmethod
    def parse_program_path(path: str) -> Dict[str, str]:
        """Parses a program path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/programs/(?P<program>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ProgramsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ProgramsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ProgramsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = ProgramsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ProgramsServiceTransport, Callable[..., ProgramsServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the programs service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ProgramsServiceClient._read_environment_variables()
        self._client_cert_source = ProgramsServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ProgramsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ProgramsServiceTransport)
        if transport_provided:
            # transport is a ProgramsServiceTransport instance.
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ProgramsServiceTransport], Callable[..., ProgramsServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1beta.ProgramsServiceClient`.",
                    extra={
    ...
    def get_program(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.GetProgramRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_program]
    ...
    def list_programs(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.ListProgramsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_programs]
        ...
        response = pagers.ListProgramsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def enable_program(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.EnableProgramRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.enable_program]
    ...
    def disable_program(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.DisableProgramRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.disable_program]
    ...
    def __enter__(self) -> "ProgramsServiceClient":
        return self

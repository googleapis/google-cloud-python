...
class ProgramsServiceClient(metaclass=ProgramsServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ProgramsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = ProgramsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or ProgramsServiceClient._get_api_endpoint(

...
class TermsOfServiceAgreementStateServiceClient(
    ...
    @staticmethod
    def terms_of_service_agreement_state_path(
        account: str,
        identifier: str,
    ) -> str:
        """Returns a fully-qualified terms_of_service_agreement_state string."""
        return "accounts/{account}/termsOfServiceAgreementStates/{identifier}".format(
            account=account,
    ...
    def parse_terms_of_service_agreement_state_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/termsOfServiceAgreementStates/(?P<identifier>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = TermsOfServiceAgreementStateServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or TermsOfServiceAgreementStateServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport_provided = isinstance(
            transport, TermsOfServiceAgreementStateServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                TermsOfServiceAgreementStateServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or TermsOfServiceAgreementStateServiceClient._get_api_endpoint(
    ...
    def get_terms_of_service_agreement_state(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_terms_of_service_agreement_state
        ]
    ...
    def retrieve_for_application_terms_of_service_agreement_state(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.retrieve_for_application_terms_of_service_agreement_state
        ]

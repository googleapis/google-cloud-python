...
class _BaseAutofeedSettingsServiceRestTransport(AutofeedSettingsServiceTransport):
    """Base REST backend transport for AutofeedSettingsService.
    ...
    class _BaseGetAutofeedSettings:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutofeedSettingsServiceRestTransport._BaseGetAutofeedSettings._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateAutofeedSettings:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseAutofeedSettingsServiceRestTransport._BaseUpdateAutofeedSettings._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params


__all__ = ("_BaseAutofeedSettingsServiceRestTransport",)

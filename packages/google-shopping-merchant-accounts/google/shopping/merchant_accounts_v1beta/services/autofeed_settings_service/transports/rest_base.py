...
class _BaseAutofeedSettingsServiceRestTransport(AutofeedSettingsServiceTransport):
    ...
    class _BaseGetAutofeedSettings:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAutofeedSettingsServiceRestTransport._BaseGetAutofeedSettings._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateAutofeedSettings:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseAutofeedSettingsServiceRestTransport._BaseUpdateAutofeedSettings._get_unset_required_fields(
                    query_params
                )
            )

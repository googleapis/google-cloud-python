...
class AccountTaxServiceAsyncClient:
    ...
    parse_account_tax_path = staticmethod(AccountTaxServiceClient.parse_account_tax_path)
    common_billing_account_path = staticmethod(AccountTaxServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(AccountTaxServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(AccountTaxServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(AccountTaxServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(AccountTaxServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(AccountTaxServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(AccountTaxServiceClient.common_project_path)
    parse_common_project_path = staticmethod(AccountTaxServiceClient.parse_common_project_path)
    common_location_path = staticmethod(AccountTaxServiceClient.common_location_path)
    parse_common_location_path = staticmethod(AccountTaxServiceClient.parse_common_location_path)
    ...
    get_transport_class = AccountTaxServiceClient.get_transport_class

    def __init__(
        self,
        *,
        credentials: Optional[ga_credentials.Credentials] = None,
        transport: Optional[Union[str, AccountTaxServiceTransport, Callable[..., AccountTaxServiceTransport]]] = "grpc_asyncio",
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.shopping.merchant.accounts_v1beta.AccountTaxServiceAsyncClient`.",
                extra={
    ...
    async def get_account_tax(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_account_tax]
    ...
    async def list_account_tax(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_account_tax]
    ...
    async def update_account_tax(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_account_tax]

...
class AccountTaxServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AccountTaxServiceTransport]]
...
class AccountTaxServiceClient(metaclass=AccountTaxServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AccountTaxServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AccountTaxServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AccountTaxServiceClient._get_api_endpoint(

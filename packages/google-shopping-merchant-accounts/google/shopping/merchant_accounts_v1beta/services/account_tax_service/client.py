...
from .transports.grpc import AccountTaxServiceGrpcTransport
from .transports.grpc_asyncio import AccountTaxServiceGrpcAsyncIOTransport
from .transports.rest import AccountTaxServiceRestTransport


class AccountTaxServiceClientMeta(type):
    """Metaclass for the AccountTaxService client.
...
class AccountTaxServiceClient(metaclass=AccountTaxServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AccountTaxServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AccountTaxServiceTransport:
        ...
        Returns:
            AccountTaxServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def account_tax_path(
        account: str,
        tax: str,
    ) -> str:
        """Returns a fully-qualified account_tax string."""
        return "accounts/{account}/accounttax/{tax}".format(
            account=account,
            tax=tax,
        )

    @staticmethod
    def parse_account_tax_path(path: str) -> Dict[str, str]:
        """Parses a account_tax path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/accounttax/(?P<tax>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = AccountTaxServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AccountTaxServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AccountTaxServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = AccountTaxServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, AccountTaxServiceTransport, Callable[..., AccountTaxServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the account tax service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AccountTaxServiceClient._read_environment_variables()
        self._client_cert_source = AccountTaxServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AccountTaxServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, AccountTaxServiceTransport)
        if transport_provided:
            # transport is a AccountTaxServiceTransport instance.
            ...
            self._transport = cast(AccountTaxServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or AccountTaxServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AccountTaxServiceTransport], Callable[..., AccountTaxServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1beta.AccountTaxServiceClient`.",
                    extra={
    ...
    def get_account_tax(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_account_tax():
                # Create a client
                client = merchant_accounts_v1beta.AccountTaxServiceClient()
                ...
                # Make the request
                response = client.get_account_tax(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.GetAccountTaxRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_account_tax]
    ...
    def list_account_tax(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.ListAccountTaxRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1beta.services.account_tax_service.pagers.ListAccountTaxPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_account_tax]
        ...
        response = pagers.ListAccountTaxPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_account_tax():
                ...
                # Make the request
                response = client.update_account_tax(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.UpdateAccountTaxRequest, dict]):
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [account_tax, update_mask]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of " "the individual field arguments should be set.")
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_account_tax]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("account_tax.name", request.account_tax.name),)),)
    ...
    def __enter__(self) -> "AccountTaxServiceClient":
        return self
...
__all__ = ("AccountTaxServiceClient",)

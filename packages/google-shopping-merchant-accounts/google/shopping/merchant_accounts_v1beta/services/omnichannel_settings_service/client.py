...
class OmnichannelSettingsServiceClient(metaclass=OmnichannelSettingsServiceClientMeta):
    ...
    def parse_omnichannel_setting_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/omnichannelSettings/(?P<omnichannel_setting>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = OmnichannelSettingsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or OmnichannelSettingsServiceClient._get_api_endpoint(
    ...
    def list_omnichannel_settings(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_omnichannel_settings
        ]
    ...
    def create_omnichannel_setting(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_omnichannel_setting
        ]
    ...
    def update_omnichannel_setting(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.update_omnichannel_setting
        ]
    ...
    def request_inventory_verification(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.request_inventory_verification
        ]

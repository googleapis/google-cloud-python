...
from .transports.grpc import OmnichannelSettingsServiceGrpcTransport
from .transports.grpc_asyncio import OmnichannelSettingsServiceGrpcAsyncIOTransport
from .transports.rest import OmnichannelSettingsServiceRestTransport


class OmnichannelSettingsServiceClientMeta(type):
    """Metaclass for the OmnichannelSettingsService client.
    ...
    ) -> Type[OmnichannelSettingsServiceTransport]:
...
class OmnichannelSettingsServiceClient(metaclass=OmnichannelSettingsServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OmnichannelSettingsServiceClient: The constructed client.
        """
    ...
    def transport(self) -> OmnichannelSettingsServiceTransport:
        ...
        Returns:
            OmnichannelSettingsServiceTransport: The transport used by the client
                instance.
        """
    ...
    @staticmethod
    def omnichannel_setting_path(
        account: str,
        omnichannel_setting: str,
    ) -> str:
        """Returns a fully-qualified omnichannel_setting string."""
        return "accounts/{account}/omnichannelSettings/{omnichannel_setting}".format(
            account=account,
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = OmnichannelSettingsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OmnichannelSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = OmnichannelSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = OmnichannelSettingsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, OmnichannelSettingsServiceTransport, Callable[..., OmnichannelSettingsServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the omnichannel settings service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OmnichannelSettingsServiceClient._read_environment_variables()
        self._client_cert_source = OmnichannelSettingsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = OmnichannelSettingsServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, OmnichannelSettingsServiceTransport)
        if transport_provided:
            # transport is a OmnichannelSettingsServiceTransport instance.
            ...
            self._transport = cast(OmnichannelSettingsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or OmnichannelSettingsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OmnichannelSettingsServiceTransport], Callable[..., OmnichannelSettingsServiceTransport]] = (
                OmnichannelSettingsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., OmnichannelSettingsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1beta.OmnichannelSettingsServiceClient`.",
                    extra={
    ...
    def get_omnichannel_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.GetOmnichannelSettingRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_omnichannel_setting]
    ...
    def list_omnichannel_settings(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListOmnichannelSettingsPager:
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.ListOmnichannelSettingsRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.shopping.merchant_accounts_v1beta.services.omnichannel_settings_service.pagers.ListOmnichannelSettingsPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_omnichannel_settings]
        ...
        response = pagers.ListOmnichannelSettingsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_omnichannel_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.CreateOmnichannelSettingRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_omnichannel_setting]
    ...
    def update_omnichannel_setting(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_omnichannel_setting():
                # Create a client
                client = merchant_accounts_v1beta.OmnichannelSettingsServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.UpdateOmnichannelSettingRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_omnichannel_setting]
    ...
    def request_inventory_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.RequestInventoryVerificationRequest, dict]):
                The request object. Request message for the
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.request_inventory_verification]
    ...
    def __enter__(self) -> "OmnichannelSettingsServiceClient":
        return self
...
__all__ = ("OmnichannelSettingsServiceClient",)

...
from .base import DEFAULT_CLIENT_INFO, OmnichannelSettingsServiceTransport
...
class OmnichannelSettingsServiceGrpcTransport(OmnichannelSettingsServiceTransport):
    """gRPC backend transport for OmnichannelSettingsService.
    ...
    def get_omnichannel_setting(
        ...
        Returns:
            Callable[[~.GetOmnichannelSettingRequest],
                    ~.OmnichannelSetting]:
        ...
        if "get_omnichannel_setting" not in self._stubs:
            self._stubs["get_omnichannel_setting"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/GetOmnichannelSetting",
                request_serializer=omnichannelsettings.GetOmnichannelSettingRequest.serialize,
                response_deserializer=omnichannelsettings.OmnichannelSetting.deserialize,
            )
        return self._stubs["get_omnichannel_setting"]
    ...
    def list_omnichannel_settings(
        ...
        Returns:
            Callable[[~.ListOmnichannelSettingsRequest],
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "list_omnichannel_settings" not in self._stubs:
            self._stubs["list_omnichannel_settings"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/ListOmnichannelSettings",
                request_serializer=omnichannelsettings.ListOmnichannelSettingsRequest.serialize,
                response_deserializer=omnichannelsettings.ListOmnichannelSettingsResponse.deserialize,
            )
    ...
    def create_omnichannel_setting(
        ...
        Returns:
            Callable[[~.CreateOmnichannelSettingRequest],
                    ~.OmnichannelSetting]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def update_omnichannel_setting(
        ...
        Returns:
            Callable[[~.UpdateOmnichannelSettingRequest],
                    ~.OmnichannelSetting]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def request_inventory_verification(
        ...
        Returns:
            Callable[[~.RequestInventoryVerificationRequest],
...
__all__ = ("OmnichannelSettingsServiceGrpcTransport",)

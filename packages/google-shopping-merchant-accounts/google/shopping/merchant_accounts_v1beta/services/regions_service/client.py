...
class RegionsServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RegionsServiceTransport]]
...
class RegionsServiceClient(metaclass=RegionsServiceClientMeta):
    ...
    def region_path(
        ...
        return "accounts/{account}/regions/{region}".format(
            account=account,
            region=region,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[RegionsServiceTransport], Callable[..., RegionsServiceTransport]
            ] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1beta.RegionsServiceClient`.",
                    extra={
    ...
    def get_region(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.GetRegionRequest, dict]):
    ...
    def create_region(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.CreateRegionRequest, dict]):
    ...
    def update_region(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.UpdateRegionRequest, dict]):
    ...
    def delete_region(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.DeleteRegionRequest, dict]):
    ...
    def list_regions(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1beta.types.ListRegionsRequest, dict]):

...
class RegionsServiceClient(metaclass=RegionsServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or RegionsServiceClient._get_api_endpoint(
    ...
    def update_region(
        ...
        *,
        ...
        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((("region.name", request.region.name),)),)

...
class CheckoutSettingsServiceClient(metaclass=CheckoutSettingsServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = CheckoutSettingsServiceClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or CheckoutSettingsServiceClient._get_api_endpoint(

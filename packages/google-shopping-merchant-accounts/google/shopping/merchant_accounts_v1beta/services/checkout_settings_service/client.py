...
class CheckoutSettingsServiceClient(metaclass=CheckoutSettingsServiceClientMeta):
    ...
    @staticmethod
    def checkout_settings_path(
        account: str,
        program: str,
    ) -> str:
        """Returns a fully-qualified checkout_settings string."""
        return "accounts/{account}/programs/{program}/checkoutSettings".format(
            account=account,
            program=program,
        )
    ...
    def parse_checkout_settings_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/programs/(?P<program>.+?)/checkoutSettings$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = CheckoutSettingsServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                CheckoutSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = CheckoutSettingsServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or CheckoutSettingsServiceClient._get_api_endpoint(
...
__all__ = ("CheckoutSettingsServiceClient",)

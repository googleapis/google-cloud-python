...
class _BaseHomepageServiceRestTransport(HomepageServiceTransport):
    ...
    class _BaseClaimHomepage:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseHomepageServiceRestTransport._BaseClaimHomepage._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetHomepage:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseHomepageServiceRestTransport._BaseGetHomepage._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUnclaimHomepage:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseHomepageServiceRestTransport._BaseUnclaimHomepage._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateHomepage:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseHomepageServiceRestTransport._BaseUpdateHomepage._get_unset_required_fields(
                    query_params
                )
            )

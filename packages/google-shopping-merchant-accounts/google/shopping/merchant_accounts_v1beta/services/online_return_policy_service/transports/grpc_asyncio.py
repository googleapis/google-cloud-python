...
class OnlineReturnPolicyServiceGrpcAsyncIOTransport(OnlineReturnPolicyServiceTransport):
    """gRPC AsyncIO backend transport for OnlineReturnPolicyService.
    ...
    def list_online_return_policies(
        ...
        Returns:
            Callable[[~.ListOnlineReturnPoliciesRequest],
                    Awaitable[~.ListOnlineReturnPoliciesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_online_return_policy: self._wrap_method(
                self.get_online_return_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_online_return_policies: self._wrap_method(
                self.list_online_return_policies,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_online_return_policy: self._wrap_method(
                self.create_online_return_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_online_return_policy: self._wrap_method(
                self.update_online_return_policy,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_online_return_policy: self._wrap_method(
...
__all__ = ("OnlineReturnPolicyServiceGrpcAsyncIOTransport",)

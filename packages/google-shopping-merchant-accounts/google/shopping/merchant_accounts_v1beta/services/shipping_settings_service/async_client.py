...
class ShippingSettingsServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = (
        ShippingSettingsServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    _DEFAULT_UNIVERSE = ShippingSettingsServiceClient._DEFAULT_UNIVERSE

    shipping_settings_path = staticmethod(
        ShippingSettingsServiceClient.shipping_settings_path
    )
    parse_shipping_settings_path = staticmethod(
        ShippingSettingsServiceClient.parse_shipping_settings_path
    )
    common_billing_account_path = staticmethod(
        ShippingSettingsServiceClient.common_billing_account_path
    )
    ...
    parse_common_folder_path = staticmethod(
        ShippingSettingsServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        ShippingSettingsServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        ShippingSettingsServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(
        ShippingSettingsServiceClient.common_project_path
    )
    parse_common_project_path = staticmethod(
        ShippingSettingsServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        ShippingSettingsServiceClient.common_location_path
    )
    parse_common_location_path = staticmethod(
        ShippingSettingsServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = ShippingSettingsServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(ShippingSettingsServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ShippingSettingsServiceAsyncClient: The constructed client.
        """
        sa_file_func = ShippingSettingsServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(
            ShippingSettingsServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return ShippingSettingsServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    async def get_shipping_settings(
        ...
        *,
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_shipping_settings
        ]
    ...
    async def insert_shipping_settings(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.insert_shipping_settings
        ]

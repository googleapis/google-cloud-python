...
class OmnichannelSettingsServiceClient(metaclass=OmnichannelSettingsServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.OmnichannelSettingsServiceClient`.",
                    extra={
    ...
    def get_omnichannel_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetOmnichannelSettingRequest, dict]):
    ...
    def list_omnichannel_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListOmnichannelSettingsRequest, dict]):
                The request object. Request message for the
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.pagers.ListOmnichannelSettingsPager:
    ...
    def create_omnichannel_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.CreateOmnichannelSettingRequest, dict]):
                The request object. Request message for the
    ...
    def update_omnichannel_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.UpdateOmnichannelSettingRequest, dict]):
                The request object. Request message for the
    ...
    def request_inventory_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.RequestInventoryVerificationRequest, dict]):
                The request object. Request message for the

...
class _BaseOnlineReturnPolicyServiceRestTransport(OnlineReturnPolicyServiceTransport):
    """Base REST backend transport for OnlineReturnPolicyService.
    ...
    class _BaseCreateOnlineReturnPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/accounts/v1/{parent=accounts/*}/onlineReturnPolicies",
    ...
    class _BaseDeleteOnlineReturnPolicy:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/accounts/v1/{name=accounts/*/onlineReturnPolicies/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetOnlineReturnPolicy:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
    ...
    class _BaseListOnlineReturnPolicies:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
...
__all__ = ("_BaseOnlineReturnPolicyServiceRestTransport",)

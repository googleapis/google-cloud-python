...
class OnlineReturnPolicyServiceGrpcTransport(OnlineReturnPolicyServiceTransport):
    """gRPC backend transport for OnlineReturnPolicyService.
    ...
    def get_online_return_policy(
        ...
        if "get_online_return_policy" not in self._stubs:
            self._stubs["get_online_return_policy"] = self._logged_channel.unary_unary(
                "/google.shopping.merchant.accounts.v1.OnlineReturnPolicyService/GetOnlineReturnPolicy",
                request_serializer=online_return_policy.GetOnlineReturnPolicyRequest.serialize,
                response_deserializer=online_return_policy.OnlineReturnPolicy.deserialize,
            )
        return self._stubs["get_online_return_policy"]

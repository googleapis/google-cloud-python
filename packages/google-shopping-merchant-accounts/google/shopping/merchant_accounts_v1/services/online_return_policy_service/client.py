...
class OnlineReturnPolicyServiceClient(metaclass=OnlineReturnPolicyServiceClientMeta):
    ...
    def parse_online_return_policy_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/onlineReturnPolicies/(?P<return_policy>.+?)$",
            path,
        )
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = OnlineReturnPolicyServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or OnlineReturnPolicyServiceClient._get_api_endpoint(
    ...
    def list_online_return_policies(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_online_return_policies
        ]
    ...
    def create_online_return_policy(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_online_return_policy
        ]
    ...
    def delete_online_return_policy(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_online_return_policy
        ]

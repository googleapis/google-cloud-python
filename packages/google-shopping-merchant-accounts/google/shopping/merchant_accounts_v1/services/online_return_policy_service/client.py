...
from .transports.rest import OnlineReturnPolicyServiceRestTransport


class OnlineReturnPolicyServiceClientMeta(type):
    """Metaclass for the OnlineReturnPolicyService client.
...
class OnlineReturnPolicyServiceClient(metaclass=OnlineReturnPolicyServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            OnlineReturnPolicyServiceClient: The constructed client.
        """
    ...
    def transport(self) -> OnlineReturnPolicyServiceTransport:
        ...
        Returns:
            OnlineReturnPolicyServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def online_return_policy_path(
        account: str,
        return_policy: str,
    ) -> str:
        """Returns a fully-qualified online_return_policy string."""
        return "accounts/{account}/onlineReturnPolicies/{return_policy}".format(
            account=account,
            return_policy=return_policy,
        )

    @staticmethod
    def parse_online_return_policy_path(path: str) -> Dict[str, str]:
        """Parses a online_return_policy path into its component segments."""
        m = re.match(r"^accounts/(?P<account>.+?)/onlineReturnPolicies/(?P<return_policy>.+?)$", path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = OnlineReturnPolicyServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = OnlineReturnPolicyServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = OnlineReturnPolicyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _get_universe_domain(client_universe_domain: Optional[str], universe_domain_env: Optional[str]) -> str:
        ...
        """
        universe_domain = OnlineReturnPolicyServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, OnlineReturnPolicyServiceTransport, Callable[..., OnlineReturnPolicyServiceTransport]]] = None,
        client_options: Optional[Union[client_options_lib.ClientOptions, dict]] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiates the online return policy service client.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = OnlineReturnPolicyServiceClient._read_environment_variables()
        self._client_cert_source = OnlineReturnPolicyServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = OnlineReturnPolicyServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, OnlineReturnPolicyServiceTransport)
        if transport_provided:
            # transport is a OnlineReturnPolicyServiceTransport instance.
            ...
            self._transport = cast(OnlineReturnPolicyServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or OnlineReturnPolicyServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[OnlineReturnPolicyServiceTransport], Callable[..., OnlineReturnPolicyServiceTransport]] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
                _LOGGER.debug(
                    "Created client `google.shopping.merchant.accounts_v1.OnlineReturnPolicyServiceClient`.",
                    extra={
    ...
    def get_online_return_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.GetOnlineReturnPolicyRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_online_return_policy]
    ...
    def list_online_return_policies(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_online_return_policies():
                # Create a client
                client = merchant_accounts_v1.OnlineReturnPolicyServiceClient()
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.ListOnlineReturnPoliciesRequest, dict]):
        ...
        Returns:
            google.shopping.merchant_accounts_v1.services.online_return_policy_service.pagers.ListOnlineReturnPoliciesPager:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_online_return_policies]
        ...
        response = pagers.ListOnlineReturnPoliciesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def create_online_return_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.CreateOnlineReturnPolicyRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_online_return_policy]
    ...
    def delete_online_return_policy(
        ...
        *,
        ...
        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.DeleteOnlineReturnPolicyRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_online_return_policy]
    ...
    def __enter__(self) -> "OnlineReturnPolicyServiceClient":
        return self
...
__all__ = ("OnlineReturnPolicyServiceClient",)

    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_endpoint_template=AccountsServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
    ...
    def create_test_account(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_test_account():
                # Create a client
                client = merchant_accounts_v1.AccountsServiceClient()
                ...
                # Make the request
                response = client.create_test_account(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.shopping.merchant_accounts_v1.types.CreateTestAccountRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_test_account]

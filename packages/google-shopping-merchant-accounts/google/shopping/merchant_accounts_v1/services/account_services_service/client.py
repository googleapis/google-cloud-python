...
class AccountServicesServiceClient(metaclass=AccountServicesServiceClientMeta):
    ...
    @staticmethod
    def account_service_path(
        account: str,
        service: str,
    ) -> str:
        """Returns a fully-qualified account_service string."""
        return "accounts/{account}/services/{service}".format(
            account=account,
            service=service,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AccountServicesServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                AccountServicesServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AccountServicesServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AccountServicesServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AccountServicesServiceClient._get_api_endpoint(
...
__all__ = ("AccountServicesServiceClient",)

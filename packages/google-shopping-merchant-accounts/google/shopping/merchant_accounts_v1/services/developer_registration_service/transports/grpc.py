...
class DeveloperRegistrationServiceGrpcTransport(DeveloperRegistrationServiceTransport):
    """gRPC backend transport for DeveloperRegistrationService.
...
__all__ = ("DeveloperRegistrationServiceGrpcTransport",)

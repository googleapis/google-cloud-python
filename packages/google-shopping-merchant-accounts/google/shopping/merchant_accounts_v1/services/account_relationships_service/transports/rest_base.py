...
class _BaseAccountRelationshipsServiceRestTransport(
    ...
    class _BaseGetAccountRelationship:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/accounts/v1/{name=accounts/*/relationships/*}",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = accountrelationships.GetAccountRelationshipRequest.pb(request)
    ...
    class _BaseListAccountRelationships:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/accounts/v1/{parent=accounts/*}/relationships",
                },
            ]
            return http_options
    ...
    class _BaseUpdateAccountRelationship:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/accounts/v1/{account_relationship.name=accounts/*/relationships/*}",
...
__all__ = ("_BaseAccountRelationshipsServiceRestTransport",)

...
class AutofeedSettingsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_autofeed_settings(
        ...
        it is returned to user code. This `post_get_autofeed_settings` interceptor runs
        before the `post_get_autofeed_settings_with_metadata` interceptor.
        """
        return response
    ...
    def post_get_autofeed_settings_with_metadata(
        ...
        is returned by the AutofeedSettingsService server but before it is returned to user code.

        We recommend only using this `post_get_autofeed_settings_with_metadata`
        interceptor in new development instead of the `post_get_autofeed_settings` interceptor.
        When both interceptors are used, this `post_get_autofeed_settings_with_metadata` interceptor runs after the
        `post_get_autofeed_settings` interceptor. The (possibly modified) response returned by
        `post_get_autofeed_settings` will be passed to
    ...
    def post_update_autofeed_settings(
        ...
        Override in a subclass to read or manipulate the response
        after it is returned by the AutofeedSettingsService server but before
        it is returned to user code. This `post_update_autofeed_settings` interceptor runs
        before the `post_update_autofeed_settings_with_metadata` interceptor.
        """
        return response
    ...
    def post_update_autofeed_settings_with_metadata(
        ...
        We recommend only using this `post_update_autofeed_settings_with_metadata`
        interceptor in new development instead of the `post_update_autofeed_settings` interceptor.
        When both interceptors are used, this `post_update_autofeed_settings_with_metadata` interceptor runs after the
        `post_update_autofeed_settings` interceptor. The (possibly modified) response returned by
        `post_update_autofeed_settings` will be passed to
...
class AutofeedSettingsServiceRestTransport(_BaseAutofeedSettingsServiceRestTransport):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[AutofeedSettingsServiceRestInterceptor]): Interceptor used
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseAutofeedSettingsServiceRestTransport._BaseGetAutofeedSettings,
                    "_BaseGetAutofeedSettings__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.AutofeedSettingsServiceClient.GetAutofeedSettings",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.AutofeedSettingsService",
                        "rpcName": "GetAutofeedSettings",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.AutofeedSettingsServiceClient.get_autofeed_settings",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.AutofeedSettingsService",
                        "rpcName": "GetAutofeedSettings",
        ...
        def __call__(
            ...
            *,
            ...
            transcoded_request, body, query_params = transcode_request(
                ...
                required_fields_default_values=getattr(
                    _BaseAutofeedSettingsServiceRestTransport._BaseUpdateAutofeedSettings,
                    "_BaseUpdateAutofeedSettings__REQUIRED_FIELDS_DEFAULT_VALUES",
                    None,
                ),
                rest_numeric_enums=True,
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.AutofeedSettingsServiceClient.UpdateAutofeedSettings",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.AutofeedSettingsService",
                        "rpcName": "UpdateAutofeedSettings",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.AutofeedSettingsServiceClient.update_autofeed_settings",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.AutofeedSettingsService",
                        "rpcName": "UpdateAutofeedSettings",
                        "metadata": http_response["headers"],
    ...
    def update_autofeed_settings(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._UpdateAutofeedSettings(

...
class AutofeedSettingsServiceGrpcAsyncIOTransport(AutofeedSettingsServiceTransport):
    ...
    @property
    def get_autofeed_settings(self) -> Callable[[autofeedsettings.GetAutofeedSettingsRequest], Awaitable[autofeedsettings.AutofeedSettings]]:
    ...
    @property
    def update_autofeed_settings(self) -> Callable[[autofeedsettings.UpdateAutofeedSettingsRequest], Awaitable[autofeedsettings.AutofeedSettings]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_autofeed_settings: self._wrap_method(
                self.get_autofeed_settings,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_autofeed_settings: self._wrap_method(

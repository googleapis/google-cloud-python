...
class AutofeedSettingsServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = AutofeedSettingsServiceClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(AutofeedSettingsServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AutofeedSettingsServiceAsyncClient: The constructed client.
        """
        sa_file_func = AutofeedSettingsServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(
            AutofeedSettingsServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return AutofeedSettingsServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.shopping.merchant.accounts_v1.AutofeedSettingsServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_autofeed_settings():
                # Create a client
                client = merchant_accounts_v1.AutofeedSettingsServiceAsyncClient()
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.GetAutofeedSettingsRequest, dict]]):
    ...
    async def update_autofeed_settings(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.shopping.merchant_accounts_v1.types.UpdateAutofeedSettingsRequest, dict]]):
                The request object. Request message for the ``UpdateAutofeedSettings``
                method.
            autofeed_settings (:class:`google.shopping.merchant_accounts_v1.types.AutofeedSettings`):

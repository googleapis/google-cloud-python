        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.EmailPreferencesServiceClient.GetEmailPreferences",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.EmailPreferencesServiceClient.get_email_preferences",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.EmailPreferencesService",
                        "rpcName": "GetEmailPreferences",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.EmailPreferencesServiceClient.UpdateEmailPreferences",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.EmailPreferencesService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.EmailPreferencesServiceClient.update_email_preferences",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.EmailPreferencesService",
                        "rpcName": "UpdateEmailPreferences",
                        "metadata": http_response["headers"],

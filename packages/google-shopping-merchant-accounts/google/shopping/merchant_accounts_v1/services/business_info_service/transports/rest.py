...
class BusinessInfoServiceRestInterceptor:
    """Interceptor for BusinessInfoService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the BusinessInfoServiceRestTransport.

    .. code-block:: python
        class MyCustomBusinessInfoServiceInterceptor(BusinessInfoServiceRestInterceptor):
            def pre_get_business_info(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_business_info(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_business_info(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_business_info(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = BusinessInfoServiceRestTransport(interceptor=MyCustomBusinessInfoServiceInterceptor())
    ...
    def pre_get_business_info(
        ...
        before they are sent to the BusinessInfoService server.
        """
        return request, metadata
...
class BusinessInfoServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: BusinessInfoServiceRestInterceptor


class BusinessInfoServiceRestTransport(_BaseBusinessInfoServiceRestTransport):
    """REST backend synchronous transport for BusinessInfoService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[BusinessInfoServiceRestInterceptor] = None,
        ...
        Args:
            ...
            interceptor (Optional[BusinessInfoServiceRestInterceptor]): Interceptor used
    ...
    class _GetBusinessInfo(
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.businessinfo.GetBusinessInfoRequest):
                    The request object. Request message for the ``GetBusinessInfo`` method.
            ...
            Returns:
                ~.businessinfo.BusinessInfo:
                    The ``BusinessInfo`` message contains essential
                information about a business.

                This message captures key business details such as
                physical address, customer service contacts, and
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.BusinessInfoServiceClient.GetBusinessInfo",
                    extra={
            ...
            # Return the response
            resp = businessinfo.BusinessInfo()
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.BusinessInfoServiceClient.get_business_info",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.BusinessInfoService",
                        "rpcName": "GetBusinessInfo",
    ...
    class _UpdateBusinessInfo(
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.businessinfo.UpdateBusinessInfoRequest):
                    The request object. Request message for the ``UpdateBusinessInfo`` method.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
                metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.BusinessInfoServiceClient.UpdateBusinessInfo",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.BusinessInfoService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.BusinessInfoServiceClient.update_business_info",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.BusinessInfoService",
                        "rpcName": "UpdateBusinessInfo",
                        "metadata": http_response["headers"],
...
__all__ = ("BusinessInfoServiceRestTransport",)

...
from .base import DEFAULT_CLIENT_INFO, TermsOfServiceServiceTransport
...
class TermsOfServiceServiceGrpcTransport(TermsOfServiceServiceTransport):
    """gRPC backend transport for TermsOfServiceService.
...
__all__ = ("TermsOfServiceServiceGrpcTransport",)

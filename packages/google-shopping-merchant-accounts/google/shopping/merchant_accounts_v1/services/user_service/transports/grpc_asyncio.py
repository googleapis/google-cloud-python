...
class UserServiceGrpcAsyncIOTransport(UserServiceTransport):
    ...
    @property
    def get_user(self) -> Callable[[user.GetUserRequest], Awaitable[user.User]]:
    ...
    @property
    def create_user(self) -> Callable[[gsma_user.CreateUserRequest], Awaitable[gsma_user.User]]:
    ...
    @property
    def delete_user(self) -> Callable[[user.DeleteUserRequest], Awaitable[empty_pb2.Empty]]:
    ...
    @property
    def update_user(self) -> Callable[[gsma_user.UpdateUserRequest], Awaitable[gsma_user.User]]:
    ...
    @property
    def list_users(self) -> Callable[[user.ListUsersRequest], Awaitable[user.ListUsersResponse]]:
...
__all__ = ("UserServiceGrpcAsyncIOTransport",)

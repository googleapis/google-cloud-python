...
class UserServiceGrpcAsyncIOTransport(UserServiceTransport):
    ...
    def create_user(
        self,
    ) -> Callable[[gsma_user.CreateUserRequest], Awaitable[gsma_user.User]]:
    ...
    def delete_user(
        self,
    ) -> Callable[[user.DeleteUserRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def update_user(
        self,
    ) -> Callable[[gsma_user.UpdateUserRequest], Awaitable[gsma_user.User]]:
    ...
    def list_users(
        self,
    ) -> Callable[[user.ListUsersRequest], Awaitable[user.ListUsersResponse]]:

...
from .base import DEFAULT_CLIENT_INFO, UserServiceTransport
...
class UserServiceGrpcTransport(UserServiceTransport):
    """gRPC backend transport for UserService.
...
__all__ = ("UserServiceGrpcTransport",)

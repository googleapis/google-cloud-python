...
class TermsOfServiceAgreementStateServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_terms_of_service_agreement_state(
        self, response: termsofserviceagreementstate.TermsOfServiceAgreementState
...
class TermsOfServiceAgreementStateServiceRestTransport(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[TermsOfServiceAgreementStateServiceRestInterceptor]): Interceptor used
            ...
            *,
            ...
            agreement state method over HTTP.
                ...
                Returns:
                    ...
                    will have an expiration date set in the
                    ...
                    to continue having a valid agreement. When accepting new
                    terms of services we expect third-party providers to
                    display the text associated with the given terms of
                    service agreement (the url to the file containing the
                    text is added in the Required message below as
                    [``tos_file_uri``][google.shopping.merchant.accounts.v1.Required.tos_file_uri]).
                    The actual acceptance of the terms of service is done by
                    calling accept on the
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.TermsOfServiceAgreementStateServiceClient.GetTermsOfServiceAgreementState",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.TermsOfServiceAgreementStateServiceClient.get_terms_of_service_agreement_state",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService",
                        "rpcName": "GetTermsOfServiceAgreementState",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.TermsOfServiceAgreementStateServiceClient.RetrieveForApplicationTermsOfServiceAgreementState",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.TermsOfServiceAgreementStateServiceClient.retrieve_for_application_terms_of_service_agreement_state",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService",
                        "rpcName": "RetrieveForApplicationTermsOfServiceAgreementState",
                        "metadata": http_response["headers"],
    ...
    def get_terms_of_service_agreement_state(
        ...
        return self._GetTermsOfServiceAgreementState(

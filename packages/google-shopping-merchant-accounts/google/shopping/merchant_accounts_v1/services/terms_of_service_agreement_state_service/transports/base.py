...
class TermsOfServiceAgreementStateServiceTransport(abc.ABC):
    """Abstract transport class for TermsOfServiceAgreementStateService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_terms_of_service_agreement_state: gapic_v1.method.wrap_method(
                self.get_terms_of_service_agreement_state,
                default_timeout=None,
                client_info=client_info,
            ),
            self.retrieve_for_application_terms_of_service_agreement_state: gapic_v1.method.wrap_method(
                self.retrieve_for_application_terms_of_service_agreement_state,
                default_timeout=None,
                client_info=client_info,
            ),
        }
    ...
    def get_terms_of_service_agreement_state(
        ...
        Union[termsofserviceagreementstate.TermsOfServiceAgreementState, Awaitable[termsofserviceagreementstate.TermsOfServiceAgreementState]],
    ]:
        raise NotImplementedError()

    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[LfpProvidersServiceRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.LfpProvidersServiceClient.FindLfpProviders",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.LfpProvidersServiceClient.find_lfp_providers",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.LfpProvidersService",
                        "rpcName": "FindLfpProviders",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.shopping.merchant.accounts_v1.LfpProvidersServiceClient.LinkLfpProvider",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.LfpProvidersService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.shopping.merchant.accounts_v1.LfpProvidersServiceClient.link_lfp_provider",
                    extra={
                        "serviceName": "google.shopping.merchant.accounts.v1.LfpProvidersService",
                        "rpcName": "LinkLfpProvider",
                        "metadata": http_response["headers"],

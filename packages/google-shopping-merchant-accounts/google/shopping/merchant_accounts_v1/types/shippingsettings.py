...
class ShippingSettings(proto.Message):
    r"""The Merchant Center account's `shipping
    settings <https://support.google.com/merchants/answer/6069284>`__.
    The ``ShippingSettings`` resource lets you retrieve and update the
    shipping settings of your advanced account and all its associated
    sub-accounts.

    Attributes:
        name (str):
            Identifier. The resource name of the shipping settings.
            Format: ``accounts/{account}/shippingSettings``. For
            example, ``accounts/123456/shippingSettings``.
        services (MutableSequence[google.shopping.merchant_accounts_v1.types.Service]):
            Optional. The target account's list of
            services.
        warehouses (MutableSequence[google.shopping.merchant_accounts_v1.types.Warehouse]):
            Optional. A list of warehouses which can be referred to in
            ``services``.
        etag (str):
            Required. This field helps avoid async issues. It ensures
            that the shipping setting data doesn't change between the
            ``get`` call and the ``insert`` call. The user should follow
            these steps:

            1. Set the etag field as an empty string for the initial
               shipping setting creation.

            2. After the initial creation, call the ``get`` method to
               obtain an etag and the current shipping setting data
               before calling ``insert``.

            3. Modify the shipping setting information.

            4. Call the ``insert`` method with the shipping setting
               information and the etag obtained in step 2.

            5. If the shipping setting data changes between step 2 and
               step 4, the insert request will fail because the etag
               changes every time the shipping setting data changes. In
               this case, the user should repeat steps 2-4 with the new
               etag.
    """
...
class Service(proto.Message):
    ...
    Attributes:
        ...
        currency_code (str):
            Required. The CLDR code of the currency to
            which this service applies. Must match that of
            the prices in rate groups.

            This field is a member of `oneof`_ ``_currency_code``.
        delivery_time (google.shopping.merchant_accounts_v1.types.DeliveryTime):
        ...
        rate_groups (MutableSequence[google.shopping.merchant_accounts_v1.types.RateGroup]):
        ...
        shipment_type (google.shopping.merchant_accounts_v1.types.Service.ShipmentType):
            Optional. Type of locations this service
            ships orders to.

            This field is a member of `oneof`_ ``_shipment_type``.
        minimum_order_value (google.shopping.type.types.Price):
            Optional. Minimum order value for this service. If set,
            indicates that customers will have to spend at least this
            amount. All prices within a service must have the same
            currency. Cannot be set together with
            ``minimum_order_value_table``.

            This field is a member of `oneof`_ ``_minimum_order_value``.
        minimum_order_value_table (google.shopping.merchant_accounts_v1.types.MinimumOrderValueTable):
            Optional. Table of per store minimum order values for the
            pickup fulfillment type. Cannot be set together with
            ``minimum_order_value``.

            This field is a member of `oneof`_ ``_minimum_order_value_table``.
        store_config (google.shopping.merchant_accounts_v1.types.Service.StoreConfig):
        ...
        loyalty_programs (MutableSequence[google.shopping.merchant_accounts_v1.types.Service.LoyaltyProgram]):
    ...
    class StoreConfig(proto.Message):
        r"""A list of stores your products are delivered from. This is
        only valid for the local delivery shipment type.


        .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html#oneofs-mutually-exclusive-fields

        Attributes:
            store_service_type (google.shopping.merchant_accounts_v1.types.Service.StoreConfig.StoreServiceType):
                Indicates whether all stores, or selected
                stores, listed by this business provide local
                delivery.
            ...
            cutoff_config (google.shopping.merchant_accounts_v1.types.Service.StoreConfig.CutoffConfig):
                Configs related to local delivery ends for
                the day.

                This field is a member of `oneof`_ ``_cutoff_config``.
            service_radius (google.shopping.merchant_accounts_v1.types.Distance):
        ...
        class StoreServiceType(proto.Enum):
            ...
            the business provide local delivery.
            ...
            Values:
                ...
                ALL_STORES (1):
                    ...
                    future, listed by this business provide local
                    delivery.
                SELECTED_STORES (2):
        ...
        class CutoffConfig(proto.Message):
            ...
            Attributes:
                local_cutoff_time (google.shopping.merchant_accounts_v1.types.Service.StoreConfig.CutoffConfig.LocalCutoffTime):
                ...
                no_delivery_post_cutoff (bool):
                    Businesses can opt-out of showing n+1 day local delivery
                    when they have a shipping service configured to n day local
    ...
    class LoyaltyProgram(proto.Message):
        ...
        Attributes:
            ...
            loyalty_program_tiers (MutableSequence[google.shopping.merchant_accounts_v1.types.Service.LoyaltyProgram.LoyaltyProgramTiers]):
                Optional. Loyalty program tier of this
                shipping service.
        """

        class LoyaltyProgramTiers(proto.Message):
            r"""Subset of a business's loyalty program.
...
class Distance(proto.Message):
    ...
    Attributes:
        ...
        unit (google.shopping.merchant_accounts_v1.types.Distance.Unit):
...
class Warehouse(proto.Message):
    ...
    Attributes:
        ...
        shipping_address (google.shopping.merchant_accounts_v1.types.Address):
            Required. Shipping address of the warehouse.

            This field is a member of `oneof`_ ``_shipping_address``.
        cutoff_time (google.shopping.merchant_accounts_v1.types.WarehouseCutoffTime):
        ...
        business_day_config (google.shopping.merchant_accounts_v1.types.BusinessDayConfig):
...
class DeliveryTime(proto.Message):
    ...
    Attributes:
        ...
        cutoff_time (google.shopping.merchant_accounts_v1.types.CutoffTime):
        ...
        transit_time_table (google.shopping.merchant_accounts_v1.types.TransitTable):
        ...
        handling_business_day_config (google.shopping.merchant_accounts_v1.types.BusinessDayConfig):
        ...
        transit_business_day_config (google.shopping.merchant_accounts_v1.types.BusinessDayConfig):
            The business days during which orders can be
            in-transit. If not provided, Monday to Friday
            business days will be assumed.

            This field is a member of `oneof`_ ``_transit_business_day_config``.
        warehouse_based_delivery_times (MutableSequence[google.shopping.merchant_accounts_v1.types.WarehouseBasedDeliveryTime]):
            ...
            time][google.shopping.merchant.accounts.v1.DeliveryTime]
            should be set.
    """
...
class BusinessDayConfig(proto.Message):
    ...
    Attributes:
        business_days (MutableSequence[google.shopping.merchant_accounts_v1.types.BusinessDayConfig.Weekday]):
...
class WarehouseBasedDeliveryTime(proto.Message):
    ...
    Attributes:
        carrier (str):
            ...
            `supported
            carriers <https://support.google.com/merchants/answer/7050921#zippy=%2Ccarrier-rates-au-de-uk-and-us-only>`__
...
class RateGroup(proto.Message):
    ...
    Attributes:
        ...
        single_value (google.shopping.merchant_accounts_v1.types.Value):
        ...
        main_table (google.shopping.merchant_accounts_v1.types.Table):
        ...
        subtables (MutableSequence[google.shopping.merchant_accounts_v1.types.Table]):
            Optional. A list of subtables referred to by ``main_table``.
            Can only be set if ``main_table`` is set.
        carrier_rates (MutableSequence[google.shopping.merchant_accounts_v1.types.CarrierRate]):
...
class Table(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            This field is a member of `oneof`_ ``_name``.
        row_headers (google.shopping.merchant_accounts_v1.types.Headers):
            Required. Headers of the table's rows.

            This field is a member of `oneof`_ ``_row_headers``.
        column_headers (google.shopping.merchant_accounts_v1.types.Headers):
        ...
        rows (MutableSequence[google.shopping.merchant_accounts_v1.types.Row]):
...
class TransitTable(proto.Message):
    ...
    Attributes:
        postal_code_group_names (MutableSequence[str]):
            ...
            [Region.name][google.shopping.merchant.accounts.v1.Region.name]
        ...
        rows (MutableSequence[google.shopping.merchant_accounts_v1.types.TransitTable.TransitTimeRow]):
    ...
    class TransitTimeRow(proto.Message):
        ...
        Attributes:
            values (MutableSequence[google.shopping.merchant_accounts_v1.types.TransitTable.TransitTimeRow.TransitTimeValue]):
...
class MinimumOrderValueTable(proto.Message):
    ...
    Attributes:
        store_code_set_with_movs (MutableSequence[google.shopping.merchant_accounts_v1.types.MinimumOrderValueTable.StoreCodeSetWithMov]):
...
class Headers(proto.Message):
    ...
    Attributes:
        ...
        locations (MutableSequence[google.shopping.merchant_accounts_v1.types.LocationIdSet]):
...
class Row(proto.Message):
    ...
    Attributes:
        cells (MutableSequence[google.shopping.merchant_accounts_v1.types.Value]):
...
class CarrierRate(proto.Message):
    ...
    ``single_value``. Supported carrier services are defined in
...
class InsertShippingSettingsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Required. The account for which this shipping setting will
            be inserted. If you are using an advanced account, you must
            specify the unique identifier of the sub-account for which
            you want to insert the shipping setting. Format:
            ``accounts/{ACCOUNT_ID}``
        shipping_setting (google.shopping.merchant_accounts_v1.types.ShippingSettings):

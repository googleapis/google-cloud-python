...
class Program(proto.Message):
    ...
    Programs provide a mechanism for adding functionality to a Merchant
    Center accounts. A typical example of this is the `Free product
    listings <https://support.google.com/merchants/answer/13889434>`__
    program, which enables products from a business's store to be shown
    ...
    Attributes:
        ...
        state (google.shopping.merchant_accounts_v1.types.Program.State):
        ...
        unmet_requirements (MutableSequence[google.shopping.merchant_accounts_v1.types.Program.Requirement]):
...
class ListProgramsResponse(proto.Message):
    ...
    Attributes:
        programs (MutableSequence[google.shopping.merchant_accounts_v1.types.Program]):

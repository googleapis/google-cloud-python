...
class CheckoutSettings(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            settings. Format:
            ``accounts/{account}/programs/{program}/checkoutSettings``
        uri_settings (google.shopping.merchant_accounts_v1.types.UriSettings):
        ...
        review_state (google.shopping.merchant_accounts_v1.types.CheckoutSettings.CheckoutReviewState):
        ...
        effective_uri_settings (google.shopping.merchant_accounts_v1.types.UriSettings):

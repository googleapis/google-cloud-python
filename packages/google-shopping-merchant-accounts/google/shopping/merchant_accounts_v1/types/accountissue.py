...
class AccountIssue(proto.Message):
    ...
    Attributes:
        ...
        severity (google.shopping.merchant_accounts_v1.types.AccountIssue.Severity):
            The overall severity of the issue.
        impacted_destinations (MutableSequence[google.shopping.merchant_accounts_v1.types.AccountIssue.ImpactedDestination]):
    ...
    class ImpactedDestination(proto.Message):
        ...
        Attributes:
            ...
            impacts (MutableSequence[google.shopping.merchant_accounts_v1.types.AccountIssue.ImpactedDestination.Impact]):
...
class ListAccountIssuesRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            ...
            value. If unspecified, at most 50 issues will be
...
class ListAccountIssuesResponse(proto.Message):
    ...
    Attributes:
        account_issues (MutableSequence[google.shopping.merchant_accounts_v1.types.AccountIssue]):

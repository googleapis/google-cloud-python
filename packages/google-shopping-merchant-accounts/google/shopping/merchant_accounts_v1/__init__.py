...
from .services.account_services_service import AccountServicesServiceAsyncClient, AccountServicesServiceClient
...
from .services.developer_registration_service import DeveloperRegistrationServiceAsyncClient, DeveloperRegistrationServiceClient
...
if hasattr(api_core, "check_python_version") and hasattr(api_core, "check_dependency_versions"):  # pragma: NO COVER
    api_core.check_python_version("google.shopping.merchant_accounts_v1")  # type: ignore
    api_core.check_dependency_versions("google.shopping.merchant_accounts_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.shopping.merchant_accounts_v1"

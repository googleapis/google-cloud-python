...
def sample_update_autofeed_settings():
    # Create a client
    client = merchant_accounts_v1.AutofeedSettingsServiceClient()

    # Initialize request argument(s)
    autofeed_settings = merchant_accounts_v1.AutofeedSettings()
    autofeed_settings.enable_products = True

    request = merchant_accounts_v1.UpdateAutofeedSettingsRequest(

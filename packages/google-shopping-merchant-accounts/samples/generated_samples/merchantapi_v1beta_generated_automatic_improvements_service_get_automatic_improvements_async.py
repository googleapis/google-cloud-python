...
#
# Snippet for GetAutomaticImprovements
...
async def sample_get_automatic_improvements():
    # Create a client
    client = merchant_accounts_v1beta.AutomaticImprovementsServiceAsyncClient()

    # Initialize request argument(s)
    request = merchant_accounts_v1beta.GetAutomaticImprovementsRequest(
        name="name_value",
    )

    # Make the request
    response = await client.get_automatic_improvements(request=request)

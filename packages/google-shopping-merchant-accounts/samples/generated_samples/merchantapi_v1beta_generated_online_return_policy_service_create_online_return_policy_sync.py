...
#
# Snippet for CreateOnlineReturnPolicy
...
# [START merchantapi_v1beta_generated_OnlineReturnPolicyService_CreateOnlineReturnPolicy_sync]
...
def sample_create_online_return_policy():
    # Create a client
    client = merchant_accounts_v1beta.OnlineReturnPolicyServiceClient()

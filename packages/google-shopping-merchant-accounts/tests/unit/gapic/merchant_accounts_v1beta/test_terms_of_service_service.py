...
from google.shopping.merchant_accounts_v1beta.types import termsofservice, termsofservicekind
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert TermsOfServiceServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert TermsOfServiceServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                TermsOfServiceServiceClient._use_client_cert_effective()
...
def test__get_api_endpoint():
    ...
    assert (
        TermsOfServiceServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        TermsOfServiceServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == TermsOfServiceServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
@pytest.mark.parametrize("client_class", [TermsOfServiceServiceClient, TermsOfServiceServiceAsyncClient])
...
def test_terms_of_service_service_client_client_options_from_dict():
    with mock.patch(
        ...
        client = TermsOfServiceServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
async def test_retrieve_latest_terms_of_service_async(
    transport: str = "grpc_asyncio", request_type=termsofservice.RetrieveLatestTermsOfServiceRequest
):
    client = TermsOfServiceServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_get_terms_of_service_rest_required_fields(request_type=termsofservice.GetTermsOfServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_terms_of_service._get_unset_required_fields(
        jsonified_request
    )
...
def test_retrieve_latest_terms_of_service_rest_required_fields(request_type=termsofservice.RetrieveLatestTermsOfServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).retrieve_latest_terms_of_service._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_accept_terms_of_service_rest_required_fields(request_type=termsofservice.AcceptTermsOfServiceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).accept_terms_of_service._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = TermsOfServiceServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = TermsOfServiceServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = TermsOfServiceServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = TermsOfServiceServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = TermsOfServiceServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = TermsOfServiceServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_terms_of_service_rest_bad_request(request_type=termsofservice.GetTermsOfServiceRequest):
    client = TermsOfServiceServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_terms_of_service_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.TermsOfServiceServiceRestInterceptor, "post_get_terms_of_service") as post, mock.patch.object(
        transports.TermsOfServiceServiceRestInterceptor, "post_get_terms_of_service_with_metadata"
...
def test_retrieve_latest_terms_of_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.TermsOfServiceServiceRestInterceptor, "post_retrieve_latest_terms_of_service"
    ) as post, mock.patch.object(
        transports.TermsOfServiceServiceRestInterceptor, "post_retrieve_latest_terms_of_service_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.TermsOfServiceServiceRestInterceptor, "pre_retrieve_latest_terms_of_service"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_accept_terms_of_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.TermsOfServiceServiceRestInterceptor, "pre_accept_terms_of_service") as pre:
        pre.assert_not_called()
...
def test_terms_of_service_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.TermsOfServiceServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.TermsOfServiceServiceGrpcTransport, grpc_helpers), (transports.TermsOfServiceServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_terms_of_service_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_terms_of_service_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.TermsOfServiceServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
@pytest.mark.parametrize("transport_class", [transports.TermsOfServiceServiceGrpcTransport, transports.TermsOfServiceServiceGrpcAsyncIOTransport])
def test_terms_of_service_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_ctx():
    ...
    for transport in transports:
        client = TermsOfServiceServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TermsOfServiceServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_get_terms_of_service_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_terms_of_service] = (
            mock_rpc
        )
        request = {}

...
from google.shopping.merchant_accounts_v1beta.services.checkout_settings_service import (
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CheckoutSettingsServiceClient(credentials=cred)
...
@pytest.mark.parametrize(
    ...
    [
        (CheckoutSettingsServiceClient, "grpc"),
        (CheckoutSettingsServiceAsyncClient, "grpc_asyncio"),
...
@pytest.mark.parametrize(
    ...
    [
        (transports.CheckoutSettingsServiceGrpcTransport, "grpc"),
        (transports.CheckoutSettingsServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
def test_checkout_settings_service_client_get_transport_class():
    transport = CheckoutSettingsServiceClient.get_transport_class()
    ...
    assert transport == transports.CheckoutSettingsServiceGrpcTransport
...
def test_checkout_settings_service_client_client_options_from_dict():
    with mock.patch(
...
def test_get_checkout_settings(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        call.return_value = checkoutsettings.CheckoutSettings(
            name="name_value",
            eligible_destinations=[types.Destination.DestinationEnum.SHOPPING_ADS],
            enrollment_state=checkoutsettings.CheckoutSettings.CheckoutEnrollmentState.INACTIVE,
            review_state=checkoutsettings.CheckoutSettings.CheckoutReviewState.IN_REVIEW,
            effective_enrollment_state=checkoutsettings.CheckoutSettings.CheckoutEnrollmentState.INACTIVE,
            effective_review_state=checkoutsettings.CheckoutSettings.CheckoutReviewState.IN_REVIEW,
        )
        response = client.get_checkout_settings(request)
...
def test_get_checkout_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_checkout_settings] = (
            mock_rpc
        )
        request = {}
...
async def test_get_checkout_settings_async(
    ...
    with mock.patch.object(
        ...
        response = await client.get_checkout_settings(request)
...
@pytest.mark.asyncio
async def test_get_checkout_settings_field_headers_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_checkout_settings_flattened_error():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_get_checkout_settings_flattened_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_get_checkout_settings_flattened_error_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_checkout_settings(
            checkoutsettings.GetCheckoutSettingsRequest(),
            name="name_value",
        )
...
def test_create_checkout_settings(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.create_checkout_settings(request)
...
async def test_create_checkout_settings_async(
    ...
    with mock.patch.object(
        ...
        response = await client.create_checkout_settings(request)
...
@pytest.mark.asyncio
async def test_create_checkout_settings_field_headers_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_checkout_settings_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.create_checkout_settings(
            parent="parent_value",
            checkout_settings=checkoutsettings.CheckoutSettings(name="name_value"),
        )
        ...
        assert arg == mock_val
        arg = args[0].checkout_settings
        mock_val = checkoutsettings.CheckoutSettings(name="name_value")
        assert arg == mock_val


def test_create_checkout_settings_flattened_error():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_create_checkout_settings_flattened_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_create_checkout_settings_flattened_error_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_checkout_settings(
            checkoutsettings.CreateCheckoutSettingsRequest(),
            parent="parent_value",
            checkout_settings=checkoutsettings.CheckoutSettings(name="name_value"),
        )
...
def test_update_checkout_settings(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        response = client.update_checkout_settings(request)
...
async def test_update_checkout_settings_async(
    ...
    with mock.patch.object(
        ...
        response = await client.update_checkout_settings(request)
...
def test_update_checkout_settings_field_headers():
    ...
    assert (
        "x-goog-request-params",
        "checkout_settings.name=name_value",
    ) in kw["metadata"]


@pytest.mark.asyncio
async def test_update_checkout_settings_field_headers_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_update_checkout_settings_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.update_checkout_settings(
            checkout_settings=checkoutsettings.CheckoutSettings(name="name_value"),
...
def test_update_checkout_settings_flattened_error():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_update_checkout_settings_flattened_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
@pytest.mark.asyncio
async def test_update_checkout_settings_flattened_error_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_checkout_settings(
            checkoutsettings.UpdateCheckoutSettingsRequest(),
            checkout_settings=checkoutsettings.CheckoutSettings(name="name_value"),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
        )
...
def test_delete_checkout_settings_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_checkout_settings_field_headers_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_delete_checkout_settings_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_checkout_settings_flattened_error():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_delete_checkout_settings_flattened_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_checkout_settings(
            name="name_value",
        )
...
@pytest.mark.asyncio
async def test_delete_checkout_settings_flattened_error_async():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_checkout_settings(
            checkoutsettings.DeleteCheckoutSettingsRequest(),
            name="name_value",
        )
...
def test_get_checkout_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetCheckoutSettings,
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = checkoutsettings.CheckoutSettings.pb(return_value)
...
def test_get_checkout_settings_rest_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        sample_request = {"name": "accounts/sample1/programs/sample2/checkoutSettings"}
        ...
        client.get_checkout_settings(**mock_args)
...
def test_create_checkout_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateCheckoutSettings,
...
def test_create_checkout_settings_rest_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {"parent": "accounts/sample1/programs/sample2"}
        ...
        client.create_checkout_settings(**mock_args)
...
def test_update_checkout_settings_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CheckoutSettingsServiceClient(
...
def test_update_checkout_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateCheckoutSettings,
...
def test_update_checkout_settings_rest_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.update_checkout_settings(**mock_args)
...
def test_update_checkout_settings_rest_flattened_error(transport: str = "rest"):
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_checkout_settings_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = CheckoutSettingsServiceClient(
...
def test_delete_checkout_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteCheckoutSettings,
...
def test_delete_checkout_settings_rest_flattened():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.delete_checkout_settings(**mock_args)
...
def test_transport_get_channel():
    ...
    transport = transports.CheckoutSettingsServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_get_checkout_settings_empty_call_grpc():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_checkout_settings_empty_call_grpc():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_checkout_settings_empty_call_grpc():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_checkout_settings_empty_call_grpc():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_checkout_settings_empty_call_grpc_asyncio():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(
        ...
        await client.get_checkout_settings(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_checkout_settings_empty_call_grpc_asyncio():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_checkout_settings(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_checkout_settings_empty_call_grpc_asyncio():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_checkout_settings(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_checkout_settings_empty_call_grpc_asyncio():
    client = CheckoutSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
def test_get_checkout_settings_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        post.return_value = checkoutsettings.CheckoutSettings()
        post_with_metadata.return_value = checkoutsettings.CheckoutSettings(), metadata
...
def test_create_checkout_settings_rest_call_success(request_type):
    ...
    request_init["checkout_settings"] = {
        ...
        "effective_enrollment_state": 1,
        "effective_review_state": 1,
    }
    ...
    for field, value in request_init["checkout_settings"].items():  # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime:  # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["checkout_settings"][field])):
                    del request_init["checkout_settings"][field][i][subfield]
            else:
                del request_init["checkout_settings"][field][subfield]
    request = request_type(**request_init)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_checkout_settings_empty_call_rest():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_checkout_settings_empty_call_rest():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_checkout_settings_empty_call_rest():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_checkout_settings_empty_call_rest():
    client = CheckoutSettingsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_checkout_settings_service_base_transport_error():
...
def test_checkout_settings_service_base_transport():
    # Instantiate the base transport.
    with mock.patch(
        "google.shopping.merchant_accounts_v1beta.services.checkout_settings_service.transports.CheckoutSettingsServiceTransport.__init__"
    ) as Transport:
...
def test_checkout_settings_service_base_transport_with_adc():
...
def test_checkout_settings_service_auth_adc():
...
def test_checkout_settings_service_transport_auth_adc(transport_class):
...
def test_checkout_settings_service_transport_auth_gdch_credentials(transport_class):
...
def test_checkout_settings_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = CheckoutSettingsServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = CheckoutSettingsServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.get_checkout_settings._session
    session2 = client2.transport.get_checkout_settings._session
    assert session1 != session2
    session1 = client1.transport.create_checkout_settings._session
    session2 = client2.transport.create_checkout_settings._session
    assert session1 != session2
    session1 = client1.transport.update_checkout_settings._session
    session2 = client2.transport.update_checkout_settings._session
    assert session1 != session2
    session1 = client1.transport.delete_checkout_settings._session
    session2 = client2.transport.delete_checkout_settings._session
    assert session1 != session2


def test_checkout_settings_service_grpc_transport_channel():
...
def test_checkout_settings_service_grpc_asyncio_transport_channel():
...
def test_checkout_settings_path():
    account = "squid"
    program = "clam"
    expected = "accounts/{account}/programs/{program}/checkoutSettings".format(
        account=account,
        program=program,
    )
    actual = CheckoutSettingsServiceClient.checkout_settings_path(account, program)
...
def test_parse_checkout_settings_path():
    ...
    path = CheckoutSettingsServiceClient.checkout_settings_path(**expected)

    # Check that the path construction is reversible.
    actual = CheckoutSettingsServiceClient.parse_checkout_settings_path(path)
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = CheckoutSettingsServiceClient.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = CheckoutSettingsServiceClient.common_billing_account_path(**expected)

    # Check that the path construction is reversible.
    actual = CheckoutSettingsServiceClient.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_folder_path():
    ...
    actual = CheckoutSettingsServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = CheckoutSettingsServiceClient.common_folder_path(**expected)

    # Check that the path construction is reversible.
    actual = CheckoutSettingsServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = CheckoutSettingsServiceClient.common_organization_path(organization)
    assert expected == actual
...
def test_parse_common_organization_path():
    ...
    path = CheckoutSettingsServiceClient.common_organization_path(**expected)

    # Check that the path construction is reversible.
    actual = CheckoutSettingsServiceClient.parse_common_organization_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = CheckoutSettingsServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = CheckoutSettingsServiceClient.common_project_path(**expected)

    # Check that the path construction is reversible.
    actual = CheckoutSettingsServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = CheckoutSettingsServiceClient.common_location_path(project, location)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = CheckoutSettingsServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = CheckoutSettingsServiceClient.parse_common_location_path(path)
    assert expected == actual

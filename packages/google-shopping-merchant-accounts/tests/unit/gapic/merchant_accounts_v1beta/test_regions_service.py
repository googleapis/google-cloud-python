...
from google.shopping.merchant_accounts_v1beta.services.regions_service import RegionsServiceAsyncClient, RegionsServiceClient, pagers, transports
...
def test_get_region_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/accounts/v1beta/{name=accounts/*/regions/*}" % client.transport._host, args[1])
...
def test_create_region_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{parent=accounts/*}/regions" % client.transport._host, args[1])
...
def test_update_region_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1beta/{region.name=accounts/*/regions/*}" % client.transport._host, args[1])
...
def test_regions_service_base_transport():
    ...
    with mock.patch("google.shopping.merchant_accounts_v1beta.services.regions_service.transports.RegionsServiceTransport.__init__") as Transport:

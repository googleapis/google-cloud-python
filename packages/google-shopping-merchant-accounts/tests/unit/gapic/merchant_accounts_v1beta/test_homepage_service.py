...
def test_homepage_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_accounts_v1beta.services.homepage_service.transports.HomepageServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_homepage_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1beta/{name=accounts/*/homepage}" % client.transport._host,
            args[1],
        )
...
def test_update_homepage_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1beta/{homepage.name=accounts/*/homepage}"
...
def test_homepage_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_accounts_v1beta.services.homepage_service.transports.HomepageServiceTransport.__init__"
    ) as Transport:

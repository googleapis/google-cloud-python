...
def test_get_user_rest_bad_request(
    transport: str = "rest", request_type=user.GetUserRequest
):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_user_rest_bad_request(
    transport: str = "rest", request_type=gsma_user.CreateUserRequest
):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_user_rest_bad_request(
    transport: str = "rest", request_type=user.DeleteUserRequest
):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_update_user_rest_bad_request(
    transport: str = "rest", request_type=gsma_user.UpdateUserRequest
):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = user.ListUsersResponse.to_json(
            user.ListUsersResponse()
        )
...
def test_list_users_rest_bad_request(
    transport: str = "rest", request_type=user.ListUsersRequest
):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,

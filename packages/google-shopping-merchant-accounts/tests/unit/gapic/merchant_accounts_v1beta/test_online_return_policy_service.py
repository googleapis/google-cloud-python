...
def test_get_online_return_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetOnlineReturnPolicy,
...
def test_list_online_return_policies_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListOnlineReturnPolicies,
...
def test_create_online_return_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateOnlineReturnPolicy,
...
def test_update_online_return_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateOnlineReturnPolicy,
        "_BaseUpdateOnlineReturnPolicy__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_online_return_policy_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseDeleteOnlineReturnPolicy,

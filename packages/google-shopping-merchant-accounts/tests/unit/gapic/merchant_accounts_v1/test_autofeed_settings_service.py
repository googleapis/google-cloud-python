...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AutofeedSettingsServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    AutofeedSettingsServiceClient._use_client_cert_effective() is False
                )
...
def test_get_autofeed_settings_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.get_autofeed_settings] = (
            mock_rpc
        )
        request = {}
...
def test_get_autofeed_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/autofeedSettings}"
...
def test_update_autofeed_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{autofeed_settings.name=accounts/*/autofeedSettings}"
            % client.transport._host,
            args[1],
        )

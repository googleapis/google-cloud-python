...
def test_get_checkout_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/programs/*/checkoutSettings}"
...
def test_create_checkout_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{parent=accounts/*/programs/*}/checkoutSettings"
            % client.transport._host,
            args[1],
        )
...
def test_update_checkout_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{checkout_settings.name=accounts/*/programs/*/checkoutSettings}"
            % client.transport._host,
            args[1],
        )

...
def test_get_homepage_rest_required_fields(request_type=homepage.GetHomepageRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetHomepage,
        "_BaseGetHomepage__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_update_homepage_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateHomepage,
        "_BaseUpdateHomepage__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_claim_homepage_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseClaimHomepage,
        "_BaseClaimHomepage__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_unclaim_homepage_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUnclaimHomepage,
        "_BaseUnclaimHomepage__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

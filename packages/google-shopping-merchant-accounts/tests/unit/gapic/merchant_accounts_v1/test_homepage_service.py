...
from google.shopping.merchant_accounts_v1.services.homepage_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        HomepageServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        HomepageServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        HomepageServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        HomepageServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        HomepageServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    )
    assert (
        HomepageServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    assert (
        HomepageServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        HomepageServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                HomepageServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(HomepageServiceClient),
)
@mock.patch.object(
    HomepageServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(HomepageServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = HomepageServiceClient._DEFAULT_UNIVERSE
    default_endpoint = HomepageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = HomepageServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        HomepageServiceClient._get_api_endpoint(
    ...
    assert (
        HomepageServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        HomepageServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == HomepageServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        HomepageServiceClient._get_api_endpoint(
    ...
    assert (
        HomepageServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        HomepageServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        HomepageServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        HomepageServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        HomepageServiceClient._get_universe_domain(None, None)
        == HomepageServiceClient._DEFAULT_UNIVERSE
    )
...
def test_homepage_service_client_from_service_account_info(
    client_class, transport_name
):
...
def test_homepage_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_homepage_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_homepage_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_homepage_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class", [HomepageServiceClient, HomepageServiceAsyncClient]
)
@mock.patch.object(
    HomepageServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(HomepageServiceClient),
)
@mock.patch.object(
    HomepageServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(HomepageServiceAsyncClient),
)
...
def test_homepage_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_homepage_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
async def test_get_homepage_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_homepage
...
async def test_update_homepage_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_homepage
            in client._client._transport._wrapped_methods
        )
...
async def test_claim_homepage_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.claim_homepage
            in client._client._transport._wrapped_methods
        )
...
async def test_unclaim_homepage_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.unclaim_homepage
            in client._client._transport._wrapped_methods
        )
...
def test_get_homepage_rest_required_fields(request_type=homepage.GetHomepageRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_homepage._get_unset_required_fields(jsonified_request)
...
def test_get_homepage_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/homepage}" % client.transport._host,
            args[1],
        )
...
def test_update_homepage_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_homepage._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_homepage_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{homepage.name=accounts/*/homepage}"
...
def test_claim_homepage_rest_required_fields(
    request_type=homepage.ClaimHomepageRequest,
):
    transport_class = transports.HomepageServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).claim_homepage._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_unclaim_homepage_rest_required_fields(
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).unclaim_homepage._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_homepage_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_accounts_v1.services.homepage_service.transports.HomepageServiceTransport.__init__"
    ) as Transport:
...
@pytest.mark.parametrize(
    ...
    [
        (transports.HomepageServiceGrpcTransport, grpc_helpers),
        (transports.HomepageServiceGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_homepage_service_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.HomepageServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = HomepageServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),

...
from google.shopping.merchant_accounts_v1.services.user_service import UserServiceAsyncClient, UserServiceClient, pagers, transports
...
def test_user_service_client_client_options_from_dict():
    with mock.patch("google.shopping.merchant_accounts_v1.services.user_service.transports.UserServiceGrpcTransport.__init__") as grpc_transport:
...
@pytest.mark.parametrize(
    "request_type",
    [
        user.VerifySelfRequest,
        dict,
    ],
)
def test_verify_self(request_type, transport: str = "grpc"):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        ...
        response = client.verify_self(request)
...
def test_verify_self_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        call.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client.verify_self(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == user.VerifySelfRequest(
            account="account_value",
        )


def test_verify_self_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = UserServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.verify_self in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.verify_self] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_verify_self_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = UserServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.verify_self in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.verify_self] = mock_rpc

        request = {}
        await client.verify_self(request)
...
@pytest.mark.asyncio
async def test_verify_self_async(transport: str = "grpc_asyncio", request_type=user.VerifySelfRequest):
    client = UserServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        ...
        response = await client.verify_self(request)
...
@pytest.mark.asyncio
async def test_verify_self_async_from_dict():
    await test_verify_self_async(request_type=dict)


def test_verify_self_field_headers():
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_verify_self_field_headers_async():
    client = UserServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_verify_self_flattened():
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        ...
        _, args, _ = call.mock_calls[0]
        arg = args[0].account
        mock_val = "account_value"
        assert arg == mock_val


def test_verify_self_flattened_error():
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_verify_self_flattened_async():
    client = UserServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.verify_self(
            account="account_value",
        )
...
@pytest.mark.asyncio
async def test_verify_self_flattened_error_async():
    client = UserServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_get_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate("%s/accounts/v1/{name=accounts/*/users/*}" % client.transport._host, args[1])
...
def test_create_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{parent=accounts/*}/users" % client.transport._host, args[1])
...
def test_update_user_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{user.name=accounts/*/users/*}" % client.transport._host, args[1])
...
def test_verify_self_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = UserServiceClient(
...
def test_verify_self_rest_required_fields(request_type=user.VerifySelfRequest):
    transport_class = transports.UserServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).verify_self._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_verify_self_rest_unset_required_fields():
    transport = transports.UserServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.verify_self._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("account",)))


def test_verify_self_rest_flattened():
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        client.verify_self(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/accounts/v1/{account=accounts/*}/users/me:verifySelf" % client.transport._host, args[1])


def test_verify_self_rest_flattened_error(transport: str = "rest"):
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind_grpc():
    transport = UserServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = UserServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_verify_self_empty_call_grpc():
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        call.return_value = user.User()
        client.verify_self(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = user.VerifySelfRequest()

        assert args[0] == request_msg


def test_transport_kind_grpc_asyncio():
    transport = UserServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = UserServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_verify_self_empty_call_grpc_asyncio():
    client = UserServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(type(client.transport.verify_self), "__call__") as call:
        ...
        await client.verify_self(request=None)
...
def test_create_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UserServiceRestInterceptor, "post_create_user") as post, mock.patch.object(
...
def test_delete_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UserServiceRestInterceptor, "pre_delete_user") as pre:
        pre.assert_not_called()
...
def test_update_user_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UserServiceRestInterceptor, "post_update_user") as post, mock.patch.object(
...
def test_list_users_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UserServiceRestInterceptor, "post_list_users") as post, mock.patch.object(
...
def test_verify_self_rest_bad_request(request_type=user.VerifySelfRequest):
    client = UserServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
...
def test_verify_self_rest_call_success(request_type):
    client = UserServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_verify_self_rest_interceptors(null_interceptor):
    transport = transports.UserServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.UserServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.UserServiceRestInterceptor, "post_verify_self") as post, mock.patch.object(
        transports.UserServiceRestInterceptor, "post_verify_self_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.UserServiceRestInterceptor, "pre_verify_self"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = user.VerifySelfRequest.pb(user.VerifySelfRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_verify_self_empty_call_rest():
    client = UserServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_user_service_base_transport():
    ...
    with mock.patch("google.shopping.merchant_accounts_v1.services.user_service.transports.UserServiceTransport.__init__") as Transport:
...
def test_user_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.shopping.merchant_accounts_v1.services.user_service.transports.UserServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [(transports.UserServiceGrpcTransport, grpc_helpers), (transports.UserServiceGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_user_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.verify_self._session
    session2 = client2.transport.verify_self._session
    assert session1 != session2

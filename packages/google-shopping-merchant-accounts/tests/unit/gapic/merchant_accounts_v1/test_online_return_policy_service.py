...
def test_online_return_policy_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_accounts_v1.services.online_return_policy_service.transports.OnlineReturnPolicyServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_online_return_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/onlineReturnPolicies/*}"
...
def test_list_online_return_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{parent=accounts/*}/onlineReturnPolicies"
            % client.transport._host,
            args[1],
        )
...
def test_online_return_policy_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_accounts_v1.services.online_return_policy_service.transports.OnlineReturnPolicyServiceTransport.__init__"
    ) as Transport:
...
def test_online_return_policy_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.shopping.merchant_accounts_v1.services.online_return_policy_service.transports.OnlineReturnPolicyServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None

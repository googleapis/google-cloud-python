...
def test_get_omnichannel_setting_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseGetOmnichannelSetting,
...
def test_get_omnichannel_setting_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/omnichannelSettings/*}"
...
def test_list_omnichannel_settings_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseListOmnichannelSettings,
...
def test_list_omnichannel_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{parent=accounts/*}/omnichannelSettings"
            % client.transport._host,
            args[1],
        )
...
def test_create_omnichannel_setting_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseCreateOmnichannelSetting,
...
def test_update_omnichannel_setting_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseUpdateOmnichannelSetting,
...
def test_update_omnichannel_setting_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{omnichannel_setting.name=accounts/*/omnichannelSettings/*}"
            % client.transport._host,
            args[1],
        )
...
def test_request_inventory_verification_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseRequestInventoryVerification,
...
def test_request_inventory_verification_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/omnichannelSettings/*}:requestInventoryVerification"
            % client.transport._host,
            args[1],
        )

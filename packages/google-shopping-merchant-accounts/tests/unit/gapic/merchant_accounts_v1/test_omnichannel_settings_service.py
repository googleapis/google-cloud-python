...
from google.shopping.merchant_accounts_v1.services.omnichannel_settings_service import (
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert OmnichannelSettingsServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert OmnichannelSettingsServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                OmnichannelSettingsServiceClient._use_client_cert_effective()
...
@mock.patch.object(
    OmnichannelSettingsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(OmnichannelSettingsServiceAsyncClient)
)
def test__get_api_endpoint():
    ...
    assert (
        OmnichannelSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        OmnichannelSettingsServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == OmnichannelSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        OmnichannelSettingsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == OmnichannelSettingsServiceClient.DEFAULT_MTLS_ENDPOINT
    )
...
@pytest.mark.parametrize("client_class", [OmnichannelSettingsServiceClient, OmnichannelSettingsServiceAsyncClient])
...
def test_omnichannel_settings_service_client_client_options_from_dict():
    with mock.patch(
        "google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = OmnichannelSettingsServiceClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_get_omnichannel_setting(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_omnichannel_setting), "__call__") as call:
...
def test_list_omnichannel_settings_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_omnichannel_settings), "__call__") as call:
        ...
        assert all(isinstance(i, omnichannelsettings.OmnichannelSetting) for i in results)
...
async def test_list_omnichannel_settings_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_omnichannel_settings), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            omnichannelsettings.ListOmnichannelSettingsResponse(
                omnichannel_settings=[
        ...
        assert all(isinstance(i, omnichannelsettings.OmnichannelSetting) for i in responses)
...
async def test_list_omnichannel_settings_async_pages():
    ...
    with mock.patch.object(type(client.transport.list_omnichannel_settings), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.list_omnichannel_settings(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
async def test_request_inventory_verification_async(
    transport: str = "grpc_asyncio", request_type=omnichannelsettings.RequestInventoryVerificationRequest
):
    client = OmnichannelSettingsServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_list_omnichannel_settings_rest_required_fields(request_type=omnichannelsettings.ListOmnichannelSettingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_omnichannel_settings._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_create_omnichannel_setting_rest_required_fields(request_type=omnichannelsettings.CreateOmnichannelSettingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_omnichannel_setting._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_update_omnichannel_setting_rest_required_fields(request_type=omnichannelsettings.UpdateOmnichannelSettingRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_omnichannel_setting._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_request_inventory_verification_rest_required_fields(request_type=omnichannelsettings.RequestInventoryVerificationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).request_inventory_verification._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_request_inventory_verification_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/accounts/v1/{name=accounts/*/omnichannelSettings/*}:requestInventoryVerification" % client.transport._host, args[1]
        )
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = OmnichannelSettingsServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = OmnichannelSettingsServiceClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = OmnichannelSettingsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = OmnichannelSettingsServiceAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = OmnichannelSettingsServiceAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = OmnichannelSettingsServiceClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_get_omnichannel_setting_rest_bad_request(request_type=omnichannelsettings.GetOmnichannelSettingRequest):
    client = OmnichannelSettingsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_get_omnichannel_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OmnichannelSettingsServiceRestInterceptor, "post_get_omnichannel_setting"
    ) as post, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "post_get_omnichannel_setting_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "pre_get_omnichannel_setting"
    ) as pre:
...
def test_list_omnichannel_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OmnichannelSettingsServiceRestInterceptor, "post_list_omnichannel_settings"
    ) as post, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "post_list_omnichannel_settings_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "pre_list_omnichannel_settings"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_create_omnichannel_setting_rest_call_success(request_type):
    ...
    request_init["omnichannel_setting"] = {
        ...
        "lfp_link": {"lfp_provider": "lfp_provider_value", "external_account_id": "external_account_id_value", "state": 1},
        "odo": {"uri": "uri_value", "state": 1},
        "about": {"uri": "uri_value", "state": 1},
        "inventory_verification": {"state": 1, "contact": "contact_value", "contact_email": "contact_email_value", "contact_state": 1},
    }
...
def test_create_omnichannel_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OmnichannelSettingsServiceRestInterceptor, "post_create_omnichannel_setting"
    ) as post, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "post_create_omnichannel_setting_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "pre_create_omnichannel_setting"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_omnichannel_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OmnichannelSettingsServiceRestInterceptor, "post_update_omnichannel_setting"
    ) as post, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "post_update_omnichannel_setting_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "pre_update_omnichannel_setting"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_request_inventory_verification_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.OmnichannelSettingsServiceRestInterceptor, "post_request_inventory_verification"
    ) as post, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "post_request_inventory_verification_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.OmnichannelSettingsServiceRestInterceptor, "pre_request_inventory_verification"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_omnichannel_settings_service_base_transport():
    ...
    with mock.patch(
        "google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport.__init__"
    ) as Transport:
...
def test_omnichannel_settings_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, "load_credentials_from_file", autospec=True) as load_creds, mock.patch(
        "google.shopping.merchant_accounts_v1.services.omnichannel_settings_service.transports.OmnichannelSettingsServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    "transport_class", [transports.OmnichannelSettingsServiceGrpcTransport, transports.OmnichannelSettingsServiceGrpcAsyncIOTransport]
)
def test_omnichannel_settings_service_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_omnichannel_settings_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.OmnichannelSettingsServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_omnichannel_settings_service_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_ctx():
    ...
    for transport in transports:
        client = OmnichannelSettingsServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)

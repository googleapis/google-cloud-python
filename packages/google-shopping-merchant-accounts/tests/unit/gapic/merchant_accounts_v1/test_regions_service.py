...
def test_get_region_rest_required_fields(request_type=regions.GetRegionRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetRegion,
        "_BaseGetRegion__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
...
def test_create_region_rest_required_fields(request_type=regions.CreateRegionRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateRegion,
        "_BaseCreateRegion__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
    ...
    assert not set(unset_fields) - set(("regionId",))
...
def test_batch_create_regions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchCreateRegions,
        "_BaseBatchCreateRegions__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_update_region_rest_required_fields(request_type=regions.UpdateRegionRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateRegion,
        "_BaseUpdateRegion__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_batch_update_regions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchUpdateRegions,
        "_BaseBatchUpdateRegions__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_delete_region_rest_required_fields(request_type=regions.DeleteRegionRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteRegion,
        "_BaseDeleteRegion__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_batch_delete_regions_rest_required_fields(
    ...
    default_values = getattr(
        transport_class._BaseBatchDeleteRegions,
        "_BaseBatchDeleteRegions__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request
...
def test_list_regions_rest_required_fields(request_type=regions.ListRegionsRequest):
    ...
    default_values = getattr(
        transport_class._BaseListRegions,
        "_BaseListRegions__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {
        k: v for k, v in default_values.items() if k not in jsonified_request

...
class CloudProductRegistryReadServiceTransport(abc.ABC):
    """Abstract transport class for CloudProductRegistryReadService."""

    AUTH_SCOPES = ()

    DEFAULT_HOST: str = "cloudproductregistry.googleapis.com"
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_product_suite: gapic_v1.method.wrap_method(
            ...
            self.list_product_suites: gapic_v1.method.wrap_method(
            ...
            self.get_logical_product: gapic_v1.method.wrap_method(
            ...
            self.list_logical_products: gapic_v1.method.wrap_method(
            ...
            self.get_logical_product_variant: gapic_v1.method.wrap_method(
            ...
            self.list_logical_product_variants: gapic_v1.method.wrap_method(
            ...
            self.lookup_entity: gapic_v1.method.wrap_method(
                self.lookup_entity,
                default_retry=retries.Retry(
                    initial=1.0,
                    maximum=10.0,
    ...
    def get_product_suite(
        ...
        Union[product_suite.ProductSuite, Awaitable[product_suite.ProductSuite]],
    ]:
        raise NotImplementedError()
    ...
    def get_logical_product(
        ...
        Union[
            logical_product.LogicalProduct, Awaitable[logical_product.LogicalProduct]
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("CloudProductRegistryReadServiceTransport",)

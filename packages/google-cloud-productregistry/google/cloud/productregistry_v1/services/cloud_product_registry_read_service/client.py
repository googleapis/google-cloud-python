...
from google.cloud.productregistry_v1._compat import (
    get_api_endpoint,
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = self._api_endpoint or get_api_endpoint(
            ...
            default_universe=CloudProductRegistryReadServiceClient._DEFAULT_UNIVERSE,
            default_mtls_endpoint=CloudProductRegistryReadServiceClient.DEFAULT_MTLS_ENDPOINT,
            default_endpoint_template=CloudProductRegistryReadServiceClient._DEFAULT_ENDPOINT_TEMPLATE,

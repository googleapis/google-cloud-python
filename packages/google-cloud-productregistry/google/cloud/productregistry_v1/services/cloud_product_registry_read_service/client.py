...
from .transports.grpc import CloudProductRegistryReadServiceGrpcTransport
from .transports.grpc_asyncio import CloudProductRegistryReadServiceGrpcAsyncIOTransport
from .transports.rest import CloudProductRegistryReadServiceRestTransport


class CloudProductRegistryReadServiceClientMeta(type):
    """Metaclass for the CloudProductRegistryReadService client.
    ...
    ) -> Type[CloudProductRegistryReadServiceTransport]:
...
class CloudProductRegistryReadServiceClient(
    metaclass=CloudProductRegistryReadServiceClientMeta
):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "cloudproductregistry.{UNIVERSE_DOMAIN}"
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CloudProductRegistryReadServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CloudProductRegistryReadServiceTransport:
        ...
        Returns:
            CloudProductRegistryReadServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def logical_product_path(
        logical_product: str,
    ) -> str:
        """Returns a fully-qualified logical_product string."""
        return "logicalProducts/{logical_product}".format(
            logical_product=logical_product,
        )

    @staticmethod
    def parse_logical_product_path(path: str) -> Dict[str, str]:
        """Parses a logical_product path into its component segments."""
        m = re.match(r"^logicalProducts/(?P<logical_product>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def logical_product_variant_path(
        logical_product: str,
        variant: str,
    ) -> str:
        """Returns a fully-qualified logical_product_variant string."""
        return "logicalProducts/{logical_product}/variants/{variant}".format(
            logical_product=logical_product,
            variant=variant,
        )

    @staticmethod
    def parse_logical_product_variant_path(path: str) -> Dict[str, str]:
        """Parses a logical_product_variant path into its component segments."""
        m = re.match(
            r"^logicalProducts/(?P<logical_product>.+?)/variants/(?P<variant>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def product_suite_path(
        product_suite: str,
    ) -> str:
        """Returns a fully-qualified product_suite string."""
        return "productSuites/{product_suite}".format(
            product_suite=product_suite,
        )

    @staticmethod
    def parse_product_suite_path(path: str) -> Dict[str, str]:
        """Parses a product_suite path into its component segments."""
        m = re.match(r"^productSuites/(?P<product_suite>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CloudProductRegistryReadServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CloudProductRegistryReadServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CloudProductRegistryReadServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CloudProductRegistryReadServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            CloudProductRegistryReadServiceClient._read_environment_variables()
        )
        self._client_cert_source = (
            CloudProductRegistryReadServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CloudProductRegistryReadServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CloudProductRegistryReadServiceTransport
        )
        if transport_provided:
            # transport is a CloudProductRegistryReadServiceTransport instance.
            ...
            self._transport = cast(CloudProductRegistryReadServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CloudProductRegistryReadServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CloudProductRegistryReadServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CloudProductRegistryReadServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.productregistry_v1.CloudProductRegistryReadServiceClient`.",
                    extra={
    ...
    def get_product_suite(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.productregistry_v1.types.GetProductSuiteRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_product_suite]
    ...
    def list_product_suites(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.productregistry_v1.types.ListProductSuitesRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_product_suites]
        ...
        response = pagers.ListProductSuitesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_logical_product(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_logical_product():
                # Create a client
                client = productregistry_v1.CloudProductRegistryReadServiceClient()
                ...
                # Make the request
                response = client.get_logical_product(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.productregistry_v1.types.GetLogicalProductRequest, dict]):
                The request object. Request message for
                GetLogicalProduct.
            name (str):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_logical_product]
    ...
    def list_logical_products(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLogicalProductsPager:
        ...
        Args:
            request (Union[google.cloud.productregistry_v1.types.ListLogicalProductsRequest, dict]):
                The request object. Request message for
                ListLogicalProducts.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_logical_products]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListLogicalProductsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_logical_product_variant(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.productregistry_v1.types.GetLogicalProductVariantRequest, dict]):
                The request object. Request message for
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_logical_product_variant
        ]
    ...
    def list_logical_product_variants(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListLogicalProductVariantsPager:
        ...
        Args:
            request (Union[google.cloud.productregistry_v1.types.ListLogicalProductVariantsRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_logical_product_variants
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListLogicalProductVariantsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def lookup_entity(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.productregistry_v1.types.LookupEntityRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.lookup_entity]
    ...
    def __enter__(self) -> "CloudProductRegistryReadServiceClient":
        return self

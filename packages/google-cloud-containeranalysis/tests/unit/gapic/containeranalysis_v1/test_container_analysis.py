...
def test__read_environment_variables():
    assert ContainerAnalysisClient._read_environment_variables() == (
        False,
        "auto",
        None,
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ContainerAnalysisClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert ContainerAnalysisClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                ContainerAnalysisClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        ContainerAnalysisClient._get_client_cert_source(
            mock_provided_cert_source, False
        )
        is None
    )
    assert (
        ContainerAnalysisClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                ContainerAnalysisClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(ContainerAnalysisClient),
)
@mock.patch.object(
    ContainerAnalysisAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(ContainerAnalysisAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ContainerAnalysisClient._DEFAULT_UNIVERSE
    default_endpoint = ContainerAnalysisClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = ContainerAnalysisClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == ContainerAnalysisClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        ContainerAnalysisClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        ContainerAnalysisClient._get_api_endpoint(
    ...
    assert (
        ContainerAnalysisClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        ContainerAnalysisClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        ContainerAnalysisClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        ContainerAnalysisClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        ContainerAnalysisClient._get_universe_domain(None, None)
        == ContainerAnalysisClient._DEFAULT_UNIVERSE
    )
...
def test_get_vulnerability_occurrences_summary_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.get_vulnerability_occurrences_summary
...
@pytest.mark.asyncio
async def test_get_vulnerability_occurrences_summary_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_vulnerability_occurrences_summary
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_export_sbom_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.export_sbom
            in client._client._transport._wrapped_methods
        )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{resource=projects/*/notes/*}:setIamPolicy" % client.transport._host,
            args[1],
        )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{resource=projects/*/notes/*}:getIamPolicy" % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{resource=projects/*/notes/*}:testIamPermissions"
...
def test_get_vulnerability_occurrences_summary_rest_required_fields(
    request_type=containeranalysis.GetVulnerabilityOccurrencesSummaryRequest,
):
    transport_class = transports.ContainerAnalysisRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_vulnerability_occurrences_summary._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = containeranalysis.VulnerabilityOccurrencesSummary.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_get_vulnerability_occurrences_summary_rest_unset_required_fields():
    ...
    unset_fields = (
        transport.get_vulnerability_occurrences_summary._get_unset_required_fields({})
    )
...
def test_get_vulnerability_occurrences_summary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*}/occurrences:vulnerabilitySummary"
            % client.transport._host,
            args[1],
        )


def test_get_vulnerability_occurrences_summary_rest_flattened_error(
    transport: str = "rest",
):
    client = ContainerAnalysisClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_export_sbom_rest_required_fields(
    request_type=containeranalysis.ExportSBOMRequest,
):
    transport_class = transports.ContainerAnalysisRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).export_sbom._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    transport = transports.ContainerAnalysisRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.ContainerAnalysisRestInterceptor(),
    )
    client = ContainerAnalysisClient(transport=transport)
    ...
    with mock.patch.object(
        ...
        transports.ContainerAnalysisRestInterceptor, "post_set_iam_policy"
    ) as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "post_set_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "pre_set_iam_policy"
    ) as pre:
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ContainerAnalysisRestInterceptor, "post_get_iam_policy"
    ) as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "post_get_iam_policy_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "pre_get_iam_policy"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ContainerAnalysisRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor,
        "post_test_iam_permissions_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_vulnerability_occurrences_summary_rest_bad_request(
    request_type=containeranalysis.GetVulnerabilityOccurrencesSummaryRequest,
):
    client = ContainerAnalysisClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_get_vulnerability_occurrences_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ContainerAnalysisRestInterceptor,
        "post_get_vulnerability_occurrences_summary",
    ) as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor,
        "post_get_vulnerability_occurrences_summary_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor,
        "pre_get_vulnerability_occurrences_summary",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = containeranalysis.GetVulnerabilityOccurrencesSummaryRequest.pb(
            containeranalysis.GetVulnerabilityOccurrencesSummaryRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = containeranalysis.VulnerabilityOccurrencesSummary.to_json(
            containeranalysis.VulnerabilityOccurrencesSummary()
        )
        req.return_value.content = return_value
...
def test_export_sbom_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ContainerAnalysisRestInterceptor, "post_export_sbom"
    ) as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "post_export_sbom_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "pre_export_sbom"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = containeranalysis.ExportSBOMRequest.pb(
            containeranalysis.ExportSBOMRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = containeranalysis.ExportSBOMResponse.to_json(
            containeranalysis.ExportSBOMResponse()
        )
        req.return_value.content = return_value

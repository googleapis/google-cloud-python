...
def test__get_api_endpoint():
    ...
    assert (
        ContainerAnalysisClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
    ...
    assert (
        ContainerAnalysisClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == ContainerAnalysisClient.DEFAULT_MTLS_ENDPOINT
    )
...
def test_container_analysis_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "containeranalysis.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://containeranalysis.googleapis.com"
        )
...
async def test_get_vulnerability_occurrences_summary_async(
    transport: str = "grpc_asyncio", request_type=containeranalysis.GetVulnerabilityOccurrencesSummaryRequest
):
    client = ContainerAnalysisAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_get_vulnerability_occurrences_summary_rest_required_fields(request_type=containeranalysis.GetVulnerabilityOccurrencesSummaryRequest):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_vulnerability_occurrences_summary._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_transport_kind_grpc():
    transport = ContainerAnalysisClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc_asyncio():
    transport = ContainerAnalysisAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = ContainerAnalysisAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = ContainerAnalysisClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    ) as transcode, mock.patch.object(transports.ContainerAnalysisRestInterceptor, "post_set_iam_policy") as post, mock.patch.object(
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ContainerAnalysisRestInterceptor, "post_get_iam_policy") as post, mock.patch.object(
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ContainerAnalysisRestInterceptor, "post_test_iam_permissions") as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "post_test_iam_permissions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
...
def test_get_vulnerability_occurrences_summary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.ContainerAnalysisRestInterceptor, "post_get_vulnerability_occurrences_summary"
    ) as post, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "post_get_vulnerability_occurrences_summary_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ContainerAnalysisRestInterceptor, "pre_get_vulnerability_occurrences_summary"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_export_sbom_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.ContainerAnalysisRestInterceptor, "post_export_sbom") as post, mock.patch.object(
...
@pytest.mark.parametrize(
    ...
    [(transports.ContainerAnalysisGrpcTransport, grpc_helpers), (transports.ContainerAnalysisGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_container_analysis_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        "containeranalysis.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://containeranalysis.googleapis.com:8000"
    )

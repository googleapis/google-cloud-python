...
class ContainerAnalysisAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = ContainerAnalysisClient.from_service_account_info.__func__  # type: ignore
        return sa_info_func(ContainerAnalysisAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            ContainerAnalysisAsyncClient: The constructed client.
        """
        sa_file_func = ContainerAnalysisClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(ContainerAnalysisAsyncClient, filename, *args, **kwargs)
    ...
    async def export_sbom(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.export_sbom
        ]

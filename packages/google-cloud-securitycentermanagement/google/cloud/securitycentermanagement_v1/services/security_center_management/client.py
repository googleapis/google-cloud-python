...
class SecurityCenterManagementClient(metaclass=SecurityCenterManagementClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = SecurityCenterManagementClient._get_client_cert_source(
        ...
        self._api_endpoint = self._api_endpoint or SecurityCenterManagementClient._get_api_endpoint(

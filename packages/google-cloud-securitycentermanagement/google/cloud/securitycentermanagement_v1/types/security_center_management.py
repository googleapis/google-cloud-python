...
class CustomConfig(proto.Message):
    ...
    Attributes:
        ...
        resource_selector (google.cloud.securitycentermanagement_v1.types.CustomConfig.ResourceSelector):
            Optional. The Cloud Asset Inventory resource
            types that the custom module operates on. For
            information about resource types, see [Supported
            asset
            types](https://cloud.google.com/asset-inventory/docs/supported-asset-types).
            Each custom module can specify up to 5 resource
            types.
    ...
    class CustomModuleValidationError(proto.Message):
        ...
        Attributes:
            ...
            field_path (str):
                ...
                format, to the field that failed validation.
                Omitted if no specific field is affected.

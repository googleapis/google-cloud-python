...
class GkeInferenceQuickstartClient(metaclass=GkeInferenceQuickstartClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = GkeInferenceQuickstartClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                GkeInferenceQuickstartClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = GkeInferenceQuickstartClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or GkeInferenceQuickstartClient._get_api_endpoint(
    ...
    def fetch_model_server_versions(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.fetch_model_server_versions
        ]
    ...
    def generate_optimized_manifest(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_optimized_manifest
        ]

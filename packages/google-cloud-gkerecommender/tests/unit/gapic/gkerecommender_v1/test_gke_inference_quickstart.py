...
def test__get_default_mtls_endpoint():
    ...
    assert GkeInferenceQuickstartClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert GkeInferenceQuickstartClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert GkeInferenceQuickstartClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert GkeInferenceQuickstartClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert GkeInferenceQuickstartClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi


def test__read_environment_variables():
    assert GkeInferenceQuickstartClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert GkeInferenceQuickstartClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert GkeInferenceQuickstartClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert GkeInferenceQuickstartClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert GkeInferenceQuickstartClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert GkeInferenceQuickstartClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert GkeInferenceQuickstartClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert GkeInferenceQuickstartClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert GkeInferenceQuickstartClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(GkeInferenceQuickstartClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeInferenceQuickstartClient))
@mock.patch.object(
    GkeInferenceQuickstartAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeInferenceQuickstartAsyncClient)
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = GkeInferenceQuickstartClient._DEFAULT_UNIVERSE
    default_endpoint = GkeInferenceQuickstartClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = GkeInferenceQuickstartClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert GkeInferenceQuickstartClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert (
        GkeInferenceQuickstartClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto")
        == GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
    )
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert (
        GkeInferenceQuickstartClient._get_api_endpoint(None, None, default_universe, "always") == GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        GkeInferenceQuickstartClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always")
        == GkeInferenceQuickstartClient.DEFAULT_MTLS_ENDPOINT
    )
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert GkeInferenceQuickstartClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        GkeInferenceQuickstartClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert GkeInferenceQuickstartClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert GkeInferenceQuickstartClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
def test_gke_inference_quickstart_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, "from_service_account_info") as factory:
        ...
        assert client.transport._host == (
            "gkerecommender.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://gkerecommender.googleapis.com"
        )
...
def test_gke_inference_quickstart_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_gke_inference_quickstart_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize(
    ...
    [
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartGrpcTransport, "grpc"),
        (GkeInferenceQuickstartAsyncClient, transports.GkeInferenceQuickstartGrpcAsyncIOTransport, "grpc_asyncio"),
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartRestTransport, "rest"),
    ],
)
@mock.patch.object(GkeInferenceQuickstartClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeInferenceQuickstartClient))
@mock.patch.object(
...
def test_gke_inference_quickstart_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartGrpcTransport, "grpc", "true"),
        (GkeInferenceQuickstartAsyncClient, transports.GkeInferenceQuickstartGrpcAsyncIOTransport, "grpc_asyncio", "true"),
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartGrpcTransport, "grpc", "false"),
        (GkeInferenceQuickstartAsyncClient, transports.GkeInferenceQuickstartGrpcAsyncIOTransport, "grpc_asyncio", "false"),
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartRestTransport, "rest", "true"),
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartRestTransport, "rest", "false"),
    ],
)
@mock.patch.object(GkeInferenceQuickstartClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(GkeInferenceQuickstartClient))
@mock.patch.object(
...
def test_gke_inference_quickstart_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [GkeInferenceQuickstartClient, GkeInferenceQuickstartAsyncClient])
@mock.patch.object(GkeInferenceQuickstartClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GkeInferenceQuickstartClient))
@mock.patch.object(GkeInferenceQuickstartAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GkeInferenceQuickstartAsyncClient))
def test_gke_inference_quickstart_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
def test_gke_inference_quickstart_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize(
    ...
    [
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartGrpcTransport, "grpc", grpc_helpers),
        (GkeInferenceQuickstartAsyncClient, transports.GkeInferenceQuickstartGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (GkeInferenceQuickstartClient, transports.GkeInferenceQuickstartRestTransport, "rest", None),
    ],
)
def test_gke_inference_quickstart_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_gke_inference_quickstart_client_client_options_from_dict():
    with mock.patch(
        ...
        client = GkeInferenceQuickstartClient(client_options={"api_endpoint": "squid.clam.whelk"})
...
def test_gke_inference_quickstart_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
@pytest.mark.asyncio
async def test_fetch_models_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_models in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_models] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_models_async(transport: str = "grpc_asyncio", request_type=gkerecommender.FetchModelsRequest):
    client = GkeInferenceQuickstartAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_fetch_models_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_models), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            gkerecommender.FetchModelsResponse(
                models=[
...
async def test_fetch_models_async_pages():
    ...
    with mock.patch.object(type(client.transport.fetch_models), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        async for page_ in (await client.fetch_models(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_fetch_model_servers_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_model_servers in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_fetch_model_servers_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GkeInferenceQuickstartAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_model_servers in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_model_servers] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_model_servers_async(transport: str = "grpc_asyncio", request_type=gkerecommender.FetchModelServersRequest):
    client = GkeInferenceQuickstartAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_fetch_model_servers_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_model_servers), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            gkerecommender.FetchModelServersResponse(
                model_servers=[
...
async def test_fetch_model_servers_async_pages():
    ...
    with mock.patch.object(type(client.transport.fetch_model_servers), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.fetch_model_servers(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_fetch_model_server_versions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_model_server_versions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_model_server_versions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_model_server_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GkeInferenceQuickstartAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_model_server_versions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_model_server_versions] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_model_server_versions_async(transport: str = "grpc_asyncio", request_type=gkerecommender.FetchModelServerVersionsRequest):
    client = GkeInferenceQuickstartAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_fetch_model_server_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.fetch_model_server_versions), "__call__") as call:
        ...
        retry = retries.Retry()
        timeout = 5
        pager = client.fetch_model_server_versions(request={}, retry=retry, timeout=timeout)
...
async def test_fetch_model_server_versions_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_model_server_versions), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            gkerecommender.FetchModelServerVersionsResponse(
                model_server_versions=[
...
async def test_fetch_model_server_versions_async_pages():
    ...
    with mock.patch.object(type(client.transport.fetch_model_server_versions), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.fetch_model_server_versions(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_fetch_profiles_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GkeInferenceQuickstartAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_profiles in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_profiles] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_profiles_async(transport: str = "grpc_asyncio", request_type=gkerecommender.FetchProfilesRequest):
    client = GkeInferenceQuickstartAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_fetch_profiles_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.fetch_profiles), "__call__", new_callable=mock.AsyncMock) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            gkerecommender.FetchProfilesResponse(
                profile=[
...
async def test_fetch_profiles_async_pages():
    ...
    with mock.patch.object(type(client.transport.fetch_profiles), "__call__", new_callable=mock.AsyncMock) as call:
        ...
        # Workaround issue in python 3.9 related to code coverage by adding `# pragma: no branch`
        # See https://github.com/googleapis/gapic-generator-python/pull/1174#issuecomment-1025132372
        async for page_ in (await client.fetch_profiles(request={})).pages:  # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_generate_optimized_manifest_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.generate_optimized_manifest in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_optimized_manifest] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_optimized_manifest_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GkeInferenceQuickstartAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_optimized_manifest in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_optimized_manifest] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_optimized_manifest_async(transport: str = "grpc_asyncio", request_type=gkerecommender.GenerateOptimizedManifestRequest):
    client = GkeInferenceQuickstartAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_fetch_benchmarking_data_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_benchmarking_data in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo"  # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_benchmarking_data] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_benchmarking_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = GkeInferenceQuickstartAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_benchmarking_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_benchmarking_data] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_benchmarking_data_async(transport: str = "grpc_asyncio", request_type=gkerecommender.FetchBenchmarkingDataRequest):
    client = GkeInferenceQuickstartAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(type(client.transport.fetch_benchmarking_data), "__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gkerecommender.FetchBenchmarkingDataResponse())
...
def test_fetch_models_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(gkerecommender.FetchModelsResponse.to_json(x) for x in response)
...
def test_fetch_model_servers_rest_required_fields(request_type=gkerecommender.FetchModelServersRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_model_servers._get_unset_required_fields(
        jsonified_request
    )
...
def test_fetch_model_servers_rest_unset_required_fields():
    transport = transports.GkeInferenceQuickstartRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_fetch_model_servers_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(gkerecommender.FetchModelServersResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_fetch_model_server_versions_rest_required_fields(request_type=gkerecommender.FetchModelServerVersionsRequest):
    transport_class = transports.GkeInferenceQuickstartRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_model_server_versions._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_fetch_model_server_versions_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(gkerecommender.FetchModelServerVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_fetch_profiles_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(gkerecommender.FetchProfilesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode("UTF-8")
            return_val.status_code = 200
...
def test_generate_optimized_manifest_rest_required_fields(request_type=gkerecommender.GenerateOptimizedManifestRequest):
    transport_class = transports.GkeInferenceQuickstartRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_optimized_manifest._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_fetch_benchmarking_data_rest_required_fields(request_type=gkerecommender.FetchBenchmarkingDataRequest):
    transport_class = transports.GkeInferenceQuickstartRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_benchmarking_data._get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = GkeInferenceQuickstartClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = GkeInferenceQuickstartClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = GkeInferenceQuickstartAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = GkeInferenceQuickstartAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = GkeInferenceQuickstartClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_fetch_models_rest_bad_request(request_type=gkerecommender.FetchModelsRequest):
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_fetch_models_rest_interceptors(null_interceptor):
    transport = transports.GkeInferenceQuickstartRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.GkeInferenceQuickstartRestInterceptor(),
    )
    client = GkeInferenceQuickstartClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_models") as post, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_models_with_metadata"
        ...
        pb_message = gkerecommender.FetchModelsRequest.pb(gkerecommender.FetchModelsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gkerecommender.FetchModelsResponse.to_json(gkerecommender.FetchModelsResponse())
...
def test_fetch_model_servers_rest_bad_request(request_type=gkerecommender.FetchModelServersRequest):
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_fetch_model_servers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_servers") as post, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_servers_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gkerecommender.FetchModelServersRequest.pb(gkerecommender.FetchModelServersRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gkerecommender.FetchModelServersResponse.to_json(gkerecommender.FetchModelServersResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gkerecommender.FetchModelServersResponse(), metadata
...
def test_fetch_model_server_versions_rest_bad_request(request_type=gkerecommender.FetchModelServerVersionsRequest):
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_fetch_model_server_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_server_versions"
    ) as post, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_model_server_versions_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "pre_fetch_model_server_versions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gkerecommender.FetchModelServerVersionsRequest.pb(gkerecommender.FetchModelServerVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gkerecommender.FetchModelServerVersionsResponse.to_json(gkerecommender.FetchModelServerVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gkerecommender.FetchModelServerVersionsResponse(), metadata
...
def test_fetch_profiles_rest_bad_request(request_type=gkerecommender.FetchProfilesRequest):
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_fetch_profiles_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_profiles") as post, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_profiles_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gkerecommender.FetchProfilesRequest.pb(gkerecommender.FetchProfilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gkerecommender.FetchProfilesResponse.to_json(gkerecommender.FetchProfilesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gkerecommender.FetchProfilesResponse(), metadata
...
def test_generate_optimized_manifest_rest_bad_request(request_type=gkerecommender.GenerateOptimizedManifestRequest):
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_generate_optimized_manifest_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        ...
        transports.GkeInferenceQuickstartRestInterceptor, "post_generate_optimized_manifest"
    ) as post, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "post_generate_optimized_manifest_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "pre_generate_optimized_manifest"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gkerecommender.GenerateOptimizedManifestRequest.pb(gkerecommender.GenerateOptimizedManifestRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gkerecommender.GenerateOptimizedManifestResponse.to_json(gkerecommender.GenerateOptimizedManifestResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gkerecommender.GenerateOptimizedManifestResponse(), metadata
...
def test_fetch_benchmarking_data_rest_bad_request(request_type=gkerecommender.FetchBenchmarkingDataRequest):
    client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
    # send a request that will satisfy transcoding
    request_init = {}
    request = request_type(**request_init)
...
def test_fetch_benchmarking_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_benchmarking_data") as post, mock.patch.object(
        transports.GkeInferenceQuickstartRestInterceptor, "post_fetch_benchmarking_data_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gkerecommender.FetchBenchmarkingDataRequest.pb(gkerecommender.FetchBenchmarkingDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gkerecommender.FetchBenchmarkingDataResponse.to_json(gkerecommender.FetchBenchmarkingDataResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gkerecommender.FetchBenchmarkingDataResponse(), metadata
...
def test_gke_inference_quickstart_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.GkeInferenceQuickstartTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")
...
@pytest.mark.parametrize(
    ...
    [(transports.GkeInferenceQuickstartGrpcTransport, grpc_helpers), (transports.GkeInferenceQuickstartGrpcAsyncIOTransport, grpc_helpers_async)],
)
def test_gke_inference_quickstart_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.GkeInferenceQuickstartGrpcTransport, transports.GkeInferenceQuickstartGrpcAsyncIOTransport])
def test_gke_inference_quickstart_grpc_transport_client_cert_source_for_mtls(transport_class):
...
def test_gke_inference_quickstart_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.GkeInferenceQuickstartRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_gke_inference_quickstart_host_no_port(transport_name):
    client = GkeInferenceQuickstartClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="gkerecommender.googleapis.com"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "gkerecommender.googleapis.com:443" if transport_name in ["grpc", "grpc_asyncio"] else "https://gkerecommender.googleapis.com"
...
def test_gke_inference_quickstart_host_with_port(transport_name):
    client = GkeInferenceQuickstartClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint="gkerecommender.googleapis.com:8000"),
        transport=transport_name,
    )
    assert client.transport._host == (
        "gkerecommender.googleapis.com:8000" if transport_name in ["grpc", "grpc_asyncio"] else "https://gkerecommender.googleapis.com:8000"
    )
...
@pytest.mark.parametrize("transport_class", [transports.GkeInferenceQuickstartGrpcTransport, transports.GkeInferenceQuickstartGrpcAsyncIOTransport])
def test_gke_inference_quickstart_transport_channel_mtls_with_client_cert_source(transport_class):
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.GkeInferenceQuickstartTransport, "_prep_wrapped_messages") as prep:
        client = GkeInferenceQuickstartClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_client_ctx():
    ...
    for transport in transports:
        client = GkeInferenceQuickstartClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (GkeInferenceQuickstartAsyncClient, transports.GkeInferenceQuickstartGrpcAsyncIOTransport),
    ],
)

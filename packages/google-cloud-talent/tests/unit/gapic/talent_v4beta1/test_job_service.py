...
def test_create_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v4beta1/{parent=projects/*/tenants/*}/jobs" % client.transport._host,
            args[1],
        )
...
def test_batch_create_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{parent=projects/*/tenants/*}/jobs:batchCreate"
...
def test_get_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{name=projects/*/tenants/*/jobs/*}" % client.transport._host,
            args[1],
        )
...
def test_update_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{job.name=projects/*/tenants/*/jobs/*}"
            % client.transport._host,
            args[1],
        )
...
def test_batch_update_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{parent=projects/*/tenants/*}/jobs:batchUpdate"
            % client.transport._host,
            args[1],
        )
...
def test_batch_delete_jobs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{parent=projects/*/tenants/*}/jobs:batchDelete"
            % client.transport._host,
            args[1],
        )

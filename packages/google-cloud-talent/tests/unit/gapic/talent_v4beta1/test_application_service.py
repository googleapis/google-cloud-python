...
@pytest.mark.parametrize(
    ...
    [
        (ApplicationServiceClient, "grpc"),
        (ApplicationServiceAsyncClient, "grpc_asyncio"),
    ],
)
...
def test_application_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_transport_kind(transport_name):
    transport = ApplicationServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.parametrize(
    ...
    [
        (ApplicationServiceClient, transports.ApplicationServiceGrpcTransport),
        (
            ApplicationServiceAsyncClient,
            transports.ApplicationServiceGrpcAsyncIOTransport,
        ),

...
from google.cloud.talent_v4beta1.services.tenant_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TenantServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "false"}):
        assert TenantServiceClient._read_environment_variables() == (
            False,
            "auto",
            None,
        )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TenantServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert TenantServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                TenantServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert (
        TenantServiceClient._get_client_cert_source(mock_provided_cert_source, False)
        is None
    )
    assert (
        TenantServiceClient._get_client_cert_source(mock_provided_cert_source, True)
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                TenantServiceClient._get_client_cert_source(None, True)
                is mock_default_cert_source
            )
            assert (
                TenantServiceClient._get_client_cert_source(
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(TenantServiceClient),
)
@mock.patch.object(
    TenantServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(TenantServiceAsyncClient),
)
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = TenantServiceClient._DEFAULT_UNIVERSE
    default_endpoint = TenantServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=default_universe
    )
    mock_universe = "bar.com"
    mock_endpoint = TenantServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    assert (
        ...
        == TenantServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TenantServiceClient._get_api_endpoint(None, None, default_universe, "auto")
        == default_endpoint
    )
    assert (
        TenantServiceClient._get_api_endpoint(None, None, default_universe, "always")
        == TenantServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        TenantServiceClient._get_api_endpoint(
    ...
    assert (
        TenantServiceClient._get_api_endpoint(None, None, mock_universe, "never")
        == mock_endpoint
    )
    assert (
        TenantServiceClient._get_api_endpoint(None, None, default_universe, "never")
        == default_endpoint
    )
...
def test__get_universe_domain():
    ...
    assert (
        TenantServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        TenantServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        TenantServiceClient._get_universe_domain(None, None)
        == TenantServiceClient._DEFAULT_UNIVERSE
    )
...
@pytest.mark.asyncio
async def test_create_tenant_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.create_tenant
...
async def test_get_tenant_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_tenant
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_update_tenant_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_tenant
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_tenant_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_tenant
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_tenants_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_tenants
            in client._client._transport._wrapped_methods
        )
...
def test_create_tenant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v4beta1/{parent=projects/*}/tenants" % client.transport._host, args[1]
        )
...
def test_get_tenant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{name=projects/*/tenants/*}" % client.transport._host, args[1]
        )
...
def test_update_tenant_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v4beta1/{tenant.name=projects/*/tenants/*}" % client.transport._host,
            args[1],
        )
...
def test_create_tenant_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TenantServiceRestInterceptor, "post_create_tenant_with_metadata"
...
def test_get_tenant_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TenantServiceRestInterceptor, "post_get_tenant_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_update_tenant_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TenantServiceRestInterceptor, "post_update_tenant_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(
...
def test_list_tenants_rest_interceptors(null_interceptor):
    ...
    with (
        ...
        mock.patch.object(
            transports.TenantServiceRestInterceptor, "post_list_tenants_with_metadata"
        ) as post_with_metadata,
        mock.patch.object(

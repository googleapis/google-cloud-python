...
from google.cloud.talent_v4beta1.services.completion import CompletionAsyncClient, CompletionClient, transports
...
def test__read_environment_variables():
    assert CompletionClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert CompletionClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "Unsupported"}):
        if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
            ...
            assert CompletionClient._read_environment_variables() == (
                False,
                "auto",
                None,
            )
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert CompletionClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert CompletionClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert CompletionClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert CompletionClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert CompletionClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                CompletionClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert CompletionClient._get_client_cert_source(None, False) is None
    assert CompletionClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert CompletionClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch("google.auth.transport.mtls.has_default_client_cert_source", return_value=True):
        with mock.patch("google.auth.transport.mtls.default_client_cert_source", return_value=mock_default_cert_source):
            assert CompletionClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert CompletionClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source


@mock.patch.object(CompletionClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CompletionClient))
@mock.patch.object(CompletionAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CompletionAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = CompletionClient._DEFAULT_UNIVERSE
    default_endpoint = CompletionClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = CompletionClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert CompletionClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert CompletionClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == CompletionClient.DEFAULT_MTLS_ENDPOINT
    assert CompletionClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert CompletionClient._get_api_endpoint(None, None, default_universe, "always") == CompletionClient.DEFAULT_MTLS_ENDPOINT
    assert CompletionClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == CompletionClient.DEFAULT_MTLS_ENDPOINT
    assert CompletionClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert CompletionClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        CompletionClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert CompletionClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert CompletionClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert CompletionClient._get_universe_domain(None, None) == CompletionClient._DEFAULT_UNIVERSE

    with pytest.raises(ValueError) as excinfo:
        CompletionClient._get_universe_domain("", None)
...
def test__add_cred_info_for_auth_errors(error_code, cred_info_json, show_cred_info):
    ...
    client = CompletionClient(credentials=cred)
...
def test_completion_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_completion_client_get_mtls_endpoint_and_cert_source(client_class):
    mock_client_cert_source = mock.Mock()
...
@mock.patch.object(CompletionClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CompletionClient))
@mock.patch.object(CompletionAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(CompletionAsyncClient))
def test_completion_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize(
    ...
    [
        (CompletionClient, transports.CompletionGrpcTransport, "grpc", grpc_helpers),
        (CompletionAsyncClient, transports.CompletionGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
        (CompletionClient, transports.CompletionRestTransport, "rest", None),
    ],
)
def test_completion_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_completion_client_client_options_from_dict():
    with mock.patch("google.cloud.talent_v4beta1.services.completion.transports.CompletionGrpcTransport.__init__") as grpc_transport:
...
def test_completion_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_complete_query_rest_unset_required_fields():
    transport = transports.CompletionRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_credentials_transport_error():
    ...
    options.api_key = "api_key"
    with pytest.raises(ValueError):
        client = CompletionClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_kind_grpc():
    transport = CompletionClient.get_transport_class("grpc")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "grpc"


def test_initialize_client_w_grpc():
    client = CompletionClient(credentials=ga_credentials.AnonymousCredentials(), transport="grpc")
...
def test_transport_kind_grpc_asyncio():
    transport = CompletionAsyncClient.get_transport_class("grpc_asyncio")(credentials=async_anonymous_credentials())
    assert transport.kind == "grpc_asyncio"


def test_initialize_client_w_grpc_asyncio():
    client = CompletionAsyncClient(credentials=async_anonymous_credentials(), transport="grpc_asyncio")
    assert client is not None
...
def test_transport_kind_rest():
    transport = CompletionClient.get_transport_class("rest")(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == "rest"


def test_complete_query_rest_bad_request(request_type=completion_service.CompleteQueryRequest):
    client = CompletionClient(credentials=ga_credentials.AnonymousCredentials(), transport="rest")
...
def test_complete_query_rest_interceptors(null_interceptor):
    transport = transports.CompletionRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CompletionRestInterceptor(),
    )
    client = CompletionClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, mock.patch.object(
        path_template, "transcode"
    ) as transcode, mock.patch.object(transports.CompletionRestInterceptor, "post_complete_query") as post, mock.patch.object(
        transports.CompletionRestInterceptor, "post_complete_query_with_metadata"
...
def test_completion_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.CompletionTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file="credentials.json")


def test_completion_base_transport():
    # Instantiate the base transport.
    with mock.patch("google.cloud.talent_v4beta1.services.completion.transports.CompletionTransport.__init__") as Transport:
...
@pytest.mark.parametrize(
    ...
    [(transports.CompletionGrpcTransport, grpc_helpers), (transports.CompletionGrpcAsyncIOTransport, grpc_helpers_async)],
)
...
def test_completion_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch("google.auth.transport.requests.AuthorizedSession.configure_mtls_channel") as mock_configure_mtls_channel:
        transports.CompletionRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_client_ctx():
    ...
    for transport in transports:
        client = CompletionClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize(
    ...
    [
        (CompletionClient, transports.CompletionGrpcTransport),
        (CompletionAsyncClient, transports.CompletionGrpcAsyncIOTransport),
    ],
)
